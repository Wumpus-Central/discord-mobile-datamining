...
export const ShopBlockType = {
  ...
  [9]: "SOCIAL_LAYER_STOREFRONT_PROMOTIONAL_BANNER",
  FRAMES_BANNER: 10,
  [10]: "FRAMES_BANNER",
  FRAMES_PRODUCT_SHELF: 11,
  [11]: "FRAMES_PRODUCT_SHELF",
  GAME_SERVER_HOSTING_BANNER: 12,
  [12]: "GAME_SERVER_HOSTING_BANNER",
};
