...
export const AdPlacement = {
  ...
  [1]: "DESKTOP_ACCOUNT_PANEL_AREA",
  MOBILE_HOME_DOCK_AREA: 2,
  [2]: "MOBILE_HOME_DOCK_AREA",
  QUEST_HOME_BANNER_DESKTOP: 3,
  [3]: "QUEST_HOME_BANNER_DESKTOP",
  QUEST_HOME_MOBILE_CAROUSEL: 4,
  [4]: "QUEST_HOME_MOBILE_CAROUSEL",
  VIDEO_MODAL_MOBILE: 5,
  [5]: "VIDEO_MODAL_MOBILE",
};
