...
export const QuestVariants = {
  ...
  FULL_EPISODE_VIDEO_QUEST: 35,
  [35]: "FULL_EPISODE_VIDEO_QUEST",
  MOBILE_ACTIVITY_QUEST: 36,
  [36]: "MOBILE_ACTIVITY_QUEST",
  QUEST_BAR_UNFURL: 37,
  [37]: "QUEST_BAR_UNFURL",
  NO_PREMIUM_ORBS_PERK: 38,
  [38]: "NO_PREMIUM_ORBS_PERK",
  NITRO_CONTROL_CTA: 39,
  [39]: "NITRO_CONTROL_CTA",
  NITRO_2_POINT_0_CTA: 40,
  [40]: "NITRO_2_POINT_0_CTA",
  ORBS_MULTIPLIER_QUEST: 41,
  [41]: "ORBS_MULTIPLIER_QUEST",
  XBOX_GAME_PASS_QUEST: 42,
  [42]: "XBOX_GAME_PASS_QUEST",
  CLOUD_GAMING_PROVIDER_NVIDIA: 43,
  [43]: "CLOUD_GAMING_PROVIDER_NVIDIA",
  RENEWABLE_END_DATE: 44,
  [44]: "RENEWABLE_END_DATE",
  EXCLUDE_FROM_FEATURED: 45,
  [45]: "EXCLUDE_FROM_FEATURED",
};
