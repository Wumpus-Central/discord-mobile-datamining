...
obj = {
  [obj.SIZE_16]: Object.freeze({ size: 16, status: 6, stroke: 2, offset: 0 }),
  [obj.SIZE_20]: Object.freeze({ size: 20, status: 6, stroke: 2, offset: 0 }),
  [obj.SIZE_24]: Object.freeze({ size: 24, status: 8, stroke: 3, offset: 0 }),
  [obj.SIZE_32]: Object.freeze({ size: 32, status: 10, stroke: 3, offset: 0 }),
  [obj.SIZE_40]: Object.freeze({ size: 40, status: 12, stroke: 4, offset: 0 }),
  [obj.SIZE_44]: Object.freeze({ size: 44, status: 12, stroke: 4, offset: 0 }),
  [obj.SIZE_48]: Object.freeze({ size: 48, status: 12, stroke: 4, offset: 0 }),
  [obj.SIZE_56]: Object.freeze({ size: 56, status: 14, stroke: 4, offset: 2 }),
  [obj.SIZE_72]: Object.freeze({ size: 72, status: 16, stroke: 6, offset: 4 }),
  [obj.SIZE_80]: Object.freeze({ size: 80, status: 16, stroke: 6, offset: 4 }),
  [obj.SIZE_96]: Object.freeze({ size: 96, status: 20, stroke: 8, offset: 6 }),
  [obj.SIZE_120]: Object.freeze({ size: 120, status: 24, stroke: 8, offset: 8 }),
  [obj.SIZE_152]: Object.freeze({ size: 152, status: 30, stroke: 10, offset: 10 }),
  [obj.DEPRECATED_SIZE_30]: Object.freeze({ size: 30, status: 0, stroke: 0, offset: 0 }),
  [obj.DEPRECATED_SIZE_60]: Object.freeze({ size: 60, status: 0, stroke: 0, offset: 0 }),
