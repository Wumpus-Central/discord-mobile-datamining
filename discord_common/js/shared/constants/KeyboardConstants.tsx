...
const items1 = [items, , , , , , , ];
const items2 = [_mod5229.Key.Tab, "tab"];
items1[1] = items2;
const items3 = [_mod5229.Key.ArrowDown, "down"];
items1[2] = items3;
const items4 = [_mod5229.Key.ArrowUp, "up"];
items1[3] = items4;
const items5 = [_mod5229.Key.ArrowLeft, "left"];
items1[4] = items5;
const items6 = [_mod5229.Key.ArrowRight, "right"];
items1[5] = items6;
const items7 = [_mod5229.Key.Home, "home"];
items1[6] = items7;
const items8 = [_mod5229.Key.End, "end"];
items1[7] = items8;
...
const result = obj132.fileFinishedImporting("../discord_common/js/shared/constants/KeyboardConstants.tsx");

export const KeyboardEventKey = _mod5229.Key;
export const FOCUS_SECTION_JUMP_KEY = _mod5229.Key.F6;
