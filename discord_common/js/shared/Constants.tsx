...
obj = { BRAINTREE: null, STRIPE: null, ADYEN: null };
obj = { KEY: window.GLOBAL_ENV.BRAINTREE_KEY, PAYMENT_GATEWAY: "braintree" };
obj.BRAINTREE = obj;
obj.STRIPE = { KEY: window.GLOBAL_ENV.STRIPE_KEY, PAYMENT_GATEWAY: "stripe" };
obj.ADYEN = { KEY: window.GLOBAL_ENV.ADYEN_KEY, PAYMENT_GATEWAY: "adyen" };
...
const obj1 = { KEY: window.GLOBAL_ENV.STRIPE_KEY, PAYMENT_GATEWAY: "stripe" };
const obj2 = { KEY: window.GLOBAL_ENV.ADYEN_KEY, PAYMENT_GATEWAY: "adyen" };
const items14 = [, , , , , , , , , , , , ];
