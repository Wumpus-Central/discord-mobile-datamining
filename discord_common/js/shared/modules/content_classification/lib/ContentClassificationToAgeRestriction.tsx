    ...
    if (data.type === obj.MINIMAL) {
      if (null != data.discord_classifications) {
        ...
        if (
          ...
          obj[1] = tmp29(503).hasAny(
            deserializeResult,
            tmp28(5069).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT,
          )
            ? AgeRestrictionStatus3.ADULT
            : AgeRestrictionStatus3.EVERYONE;
          tmp12 = obj;
          const hasAnyResult = tmp29(503).hasAny(
            deserializeResult,
            tmp28(5069).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT,
          );
        }
      ...
      if (
        ...
        obj[1] = tmp6(503).hasAny(
          deserializeResult1,
          tmp4(5069).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT,
        )
          ? AgeRestrictionStatus2.ADULT
          : AgeRestrictionStatus2.EVERYONE;
        tmp9 = obj;
        const hasAnyResult1 = tmp6(503).hasAny(
          deserializeResult1,
          tmp4(5069).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT,
        );
      }
      ...
      if (
        ...
        obj1[1] = tmp26(503).hasAny(
          deserializeResult2,
          tmp24(5069).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT,
        )
          ? AgeRestrictionStatus.ADULT
          : AgeRestrictionStatus.EVERYONE;
        tmp2 = obj1;
        const hasAnyResult2 = tmp26(503).hasAny(
          deserializeResult2,
          tmp24(5069).DiscordContentClassificationFlagMasks.RESTRICTED_TO_ADULT,
        );
      }
