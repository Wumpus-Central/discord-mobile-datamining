...
export const ImpressionNames = {
  ...
  ACCOUNT_REVERT_EXPLAINER: "impression_account_revert_explainer",
  ACCOUNT_REVERT_SUCCESS: "impression_account_revert_success",
  ...
  APP_LAUNCHER_BADGE: "impression_app_launcher_badge",
  ...
  APP_OAUTH2_LINK_EMBED: "impression_app_oauth2_link_embed",
  APPEAL_INGESTION_COLLECT_SIGNAL: "impression_appeal_ingestion_collect_signal",
  APPEAL_INGESTION_CONFIRM_SUBMISSION: "impression_appeal_ingestion_confirm_submission",
  APPEAL_INGESTION_REQUEST_SENT: "impression_appeal_ingestion_request_sent",
  APPEAL_INGESTION_SPAM: "impression_appeal_ingestion_spam",
  APPEAL_INGESTION_SPEED_BUMP: "impression_appeal_ingestion_speed_bump",
  APPEAL_INGESTION_THANKS: "impression_appeal_ingestion_thanks",
  ...
  AUDIO_DEVICE_MENU: "impression_audio_device_menu",
  AVATAR_UPLOAD: "impression_avatar_upload",
  BLOCK_USER_CONFIRMATION: "impression_block_user_confirmation",
  BOOST_SHOP_OPENED: "impression_boost_shop_opened",
  CALL_TILE_CONTEXT_MENU: "impression_call_tile_context_menu",
  ...
  CHAT_WALLPAPER_DM_CONTEXT_MENU_ENTRY_POINT: "impression_chat_wallpaper_dm_context_menu_entry_point",
  CHAT_WALLPAPER_DM_LIST_COACHMARK: "impression_chat_wallpaper_dm_list_coachmark",
  CHAT_WALLPAPER_PICKER_COACHMARK: "impression_chat_wallpaper_picker_coachmark",
  CHAT_WALLPAPER_WALLPAPER_OPTION: "impression_chat_wallpaper_wallpaper_option",
  CLIP_EDITOR_VIEWED: "impression_clip_editor_viewed",
  CLIP_GALLERY_VIEWED: "impression_clip_gallery_viewed",
  CLOUD_PLAY_CTA: "impression_cloud_play_cta",
  ...
  CONFETTI_POTION_MODAL: "impression_confetti_potion_modal",
  ...
  CUSTOM_THEME_SHARE: "impression_custom_theme_share",
  ...
  DM_LIST_KEBAB_MENU_SHOWN: "impression_dm_list_kebab_menu_shown",
  DM_LIST_RIGHT_CLICK_MENU_SHOWN: "impression_dm_list_right_click_menu_shown",
  DOUBLE_TAP_REACT_UPSELL: "impression_double_tap_react_upsell",
  ...
  GAME_ACCOUNT_LINK_RECURRING_UPSELL: "impression_game_account_link_recurring_upsell",
  GAME_COMMUNITY_MULTI_GUILD_UPSELL_CARD: "impression_game_community_multi_guild_upsell_card",
  ...
  GAME_SERVER_ACTIVITY_BUTTON: "impression_game_server_activity_button",
  GDM_SETTINGS_INVITES: "impression_gdm_settings_invites",
  GIFT_CARD_REDEMPTION_SUCCEEDED_MODAL: "impression_gift_card_redemption_succeeded_modal",
  GIFT_INTENT_ACTION_BUTTON: "impression_gift_intent_action_button",
  GIFT_INTENT_BADGE: "impression_gift_intent_badge",
  GIFT_INTENT_CARD: "impression_gift_intent_card",
  GIFT_INTENT_UNREAD_NOTIFICATION: "impression_gift_intent_unread_notification",
  GIFT_INTENT_USER_PROFILE_POPOUT: "impression_gift_intent_user_profile_popout",
  GIFT_OPTION_WISHLIST_BANNER_VIEWED: "impression_gift_option_wishlist_banner_viewed",
  GIFT_SELECTION_WISHLIST_SECTION_VIEWED: "impression_gift_selection_wishlist_section_viewed",
  GIFTING_BADGE_PROGRESS_BANNER: "impression_gifting_badge_progress_banner",
  GLOBAL_DISCOVERY: "impression_global_discovery",
  GLOBAL_DISCOVERY_APPS: "impression_global_discovery_apps",
  GO_LIVE_MODAL: "impression_go_live_modal",
  ...
  GUILD_HANGOUT_WINDOW: "impression_guild_hangout_window",
  GUILD_HANGOUT_WINDOW_ENTRY_POINT: "impression_guild_hangout_window_entry_point",
  GUILD_HANGOUT_WINDOW_MODAL: "impression_guild_hangout_window_modal",
  ...
  GUILD_SETTINGS_ACCESS: "impression_guild_settings_access",
  ...
  GUILD_SETTINGS_BOOST_PERKS: "impression_guild_settings_boost_perks",
  ...
  GUILD_SETTINGS_ENGAGEMENT: "impression_guild_settings_engagement",
  GUILD_SETTINGS_GUILD_THEME: "impression_guild_settings_guild_theme",
  GUILD_SETTINGS_INTEGRATION: "impression_guild_settings_integration",
  GUILD_SETTINGS_INVITES: "impression_guild_settings_invites",
  GUILD_SETTINGS_INVITES_V2: "impression_guild_settings_invites_v2",
  GUILD_SETTINGS_LANDING: "impression_guild_settings_landing",
  GUILD_SETTINGS_LAYOUT: "impression_guild_settings_layout",
  ...
  GUILD_SETTINGS_OFFICIAL_MESSAGES: "impression_guild_settings_official_messages",
  GUILD_SETTINGS_OVERVIEW: "impression_guild_settings_overview",
  GUILD_SETTINGS_PARTNER: "impression_guild_settings_partner",
  GUILD_SETTINGS_PROFILE: "impression_guild_settings_profile",
  ...
  GUILD_SETTINGS_TAG: "impression_guild_settings_tag",
  ...
  ICYMI_ONBOARDING_OVERVIEW: "impression_icymi_onboarding_overview",
  ICYMI_ONBOARDING_SELECT_GUILDS: "impression_icymi_onboarding_select_guilds",
  ICYMI_ONBOARDING_TOPICS: "impression_icymi_onboarding_topics",
  IGNORE_USER_CONFIRMATION: "impression_ignore_user_confirmation",
  INVITE_ACCEPT: "impression_invite_accept",
  INVITE_EMBED: "impression_invite_embed",
  LOCALIZED_PRICING_UPSELL_VIEWED: "impression_localized_pricing_upsell_viewed",
  MASKED_LINK_MODAL: "impression_masked_link_modal",
  MESSAGE_ALSO_SEND_TO_CHANNEL: "impression_message_also_send_to_channel",
  MESSAGES_EMPTY_NUX: "impression_messages_empty_nux",
  MOBILE_GO_LIVE_ACTION_SHEET: "impression_mobile_go_live_action_sheet",
  MODAL_ROOT_LEGACY: "impression_modal_root_legacy",
  ...
  SHOP_CARD: "impression_shop_card",
  SHOP_PRODUCT_DETAIL: "impression_shop_product_detail",
  ...
  STREAM_FEEDBACK_MODAL: "impression_stream_feedback_modal",
  THIRD_PARTY_PARTNER_PERK: "impression_third_party_partner_perk",
  TIERED_TENURE_BADGE_LEVEL_UP: "impression_tiered_tenure_badge_level_up",
  TIERED_TENURE_BADGE_MODAL: "impression_tiered_tenure_badge_modal",
  TRIAL_FOR_ALL_COACHTIP: "impression_trial_for_all_coachtip",
  TRIAL_NOTICE: "impression_trial_notice",
  ...
  USER_AGE_GATE_VERIFY: "impression_user_age_gate_verify",
  USER_AGE_VERIFICATION_RESET_CONFIRM: "impression_user_age_verification_reset_confirm",
  USER_AGE_VERIFICATION_RESET_OPTIONS: "impression_user_age_verification_reset_options",
  ...
  USER_RETURNED_HAPPENING_NOW: "impression_user_returned_happening_now",
  USER_SETTINGS_CONNECTIONS: "impression_user_settings_connections",
  USER_SETTINGS_SESSIONS: "impression_user_settings_sessions",
  ...
  VOICE_INVITE_EMBED: "impression_voice_invite_embed",
  VOICE_INVITE_SUGGESTIONS_ENTRYPOINT: "impression_voice_invite_suggestions_entrypoint",
  VOICE_INVITE_SUGGESTIONS_POPOVER: "impression_voice_invite_suggestions_popover",
  VOICE_USER_ACTIVITY_POPOUT: "impression_voice_user_activity_popout",
  WISHLIST_ITEM: "impression_wishlist_item",
};
export const NetworkActionNames = {
  ACCOUNT_REVERT: "network_action_account_revert",
  ...
  BILLING_IP_LOCATION_FETCH_ERROR: "network_action_billing_ip_location_fetch_error",
  ...
  DETECTABLE_NON_GAMES_FETCH: "network_action_detectable_non_games_fetch",
  ...
  GUILD_SPACE_FETCH: "network_action_guild_space_fetch",
  ...
  INVITE_FRIEND_MEMBERS_FETCH: "network_action_invite_friend_members_fetch",
  ...
  NITRO_WARP_CREATE_LICENSE: "network_action_nitro_warp_create_license",
  ...
  PASSWORD_VALIDATE: "network_action_password_validate",
  ...
  QUEST_VIDEO_PROGRESS: "network_action_quest_video_progress",
  ...
  USER_ONE_TIME_LOGIN: "network_action_user_one_time_login",
...
export const SpanTtiNames = { CHANNEL: "span_tti_channel" };
export const SpanComponentNames = { CHANNEL: "span_component_channel" };
export const SpanObservedNames = { LONG_FRAME: "span_observed_long_frame" };
