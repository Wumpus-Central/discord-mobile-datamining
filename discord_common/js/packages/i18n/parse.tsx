...
import _modDef17066 from "module_17066" /* 17066 */;
import closure_5 from "_slicedToArray" /* 32 */;
import FORMAT_RE from "FORMAT_RE" /* 17109 */;
...
class FormattedMessage {
  constructor(arg0, arg1, arg2) {
    ...
    tmp4 = new require("module_17066")(obj.message, arg1);
...
export const setUpdateRules = function setUpdateRules(arg0) {
  const rules = _require(17110).rules;
  _require = undefined;
  ...
  const f118649 = (arr, context, unsafeContext) => {
  ...
  _require = undefined;
  const obj3 = tDefault;
  _require = tDefault.parserFor(_require(17110).rules);
  const f118650 = (arg0, context, unsafeContext) => callback(arg0 + "\n\n", { inline: false, context, unsafeContext });
};
export const getMessage = function getMessage(str) {
  if (null == str) {
    ...
    if (null == f118649) {
      ...
      importDefault = undefined;
      let obj = tDefault;
      _require = obj.parserFor(_require(17111).default(rules));
      const obj2 = tDefault;
      importDefault = obj2.reactFor(tDefault.ruleOutput(rules, "react"));
      f118649 = (arr, context, unsafeContext) => {
        const hasItem = arr.includes("\n\n");
        let text = arr;
        if (hasItem) {
          text = `${arr}
    ...
    if (isMatch) {
      ...
      const tmp16 = new _modDef17066(obj.message, arg1);
