...
import FORMAT_RE from "FORMAT_RE" /* 16615 */;
...
class FormattedMessage {
  constructor(arg0, arg1, arg2) {
    ...
    tmp4 = new require("module_16572")(obj.message, arg1);
...
export const setUpdateRules = function setUpdateRules(arg0) {
  const rules = _require(16616).rules;
  _require = undefined;
  ...
  const f115619 = (arr, context, unsafeContext) => {
  ...
  _require = undefined;
  const obj3 = tDefault;
  _require = tDefault.parserFor(_require(16616).rules);
  const f115620 = (arg0, context, unsafeContext) => callback(arg0 + "\n\n", { inline: false, context, unsafeContext });
};
export const getMessage = function getMessage(str) {
  if (null == str) {
    ...
    if (null == f115619) {
      ...
      importDefault = undefined;
      let obj = tDefault;
      _require = obj.parserFor(_require(16617).default(rules));
      const obj2 = tDefault;
      importDefault = obj2.reactFor(tDefault.ruleOutput(rules, "react"));
      f115619 = (arr, context, unsafeContext) => {
        const hasItem = arr.includes("\n\n");
        let text = arr;
        if (hasItem) {
          text = `${arr}
    ...
    if (isMatch) {
      ...
      const tmp16 = new _modDef16572(obj.message, arg1);
