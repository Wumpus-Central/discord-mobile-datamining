...
prototype["completeOperation"] = function completeOperation(value, timings, nowResult) {
  if (this.completionCallbacks.length > 0) {
    ...
    obj = { queue: timings.timings.queueTimeNanoseconds / c2, execution: timings.timings.executionTimeNanoseconds / c2, materialization: timings.timings.materializationTimeNanoseconds / c2, ccTotal: timings.timings.totalTimeNanoseconds / c2, jsTotal: nowResult - value.started };
    obj.timings = obj;
