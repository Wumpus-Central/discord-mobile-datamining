// === Module 1962: fromDatabaseTransaction ===

// Module 1962 (fromDatabaseTransaction)
import combineKey from "combineKey" /* 1963 */;
...
prototype["putAll"] = function putAll(arr) {
  let Replace = arg1;
  if (arg1 === undefined) {
    Replace = prefix(1964).ConflictOptions.Replace;
  }
  const transaction = this.transaction;
  ...
  obj[2] = mapped;
  obj[3] = Replace === prefix(1964).ConflictOptions.Replace;
  transaction.add(obj);
};
