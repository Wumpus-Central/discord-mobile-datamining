...
import flatRestDefault from "../../../../_runtime/04857_flatRest.js";
...
({
  ...
  MediaTypes: metroRequire,
  ResolutionTypes: closure_7,
  MediaEngineContextTypes: closure_8,
  VIDEO_QUALITY_FRAMERATE: closure_9,
...
prototype["setHasActiveVideoOutputSink"] = function setHasActiveVideoOutputSink(arg0, arg1, arg2) {
  ...
  if (hasActiveVideoOutputSink !== hasActiveVideoOutputSink1) {
    self.emit(
      discord_common_BaseConnectionEvent.BaseConnectionEvent.ActiveSinksChange,
      arg0,
      hasActiveVideoOutputSink1,
    );
  }
};
...
export const BaseConnectionEvent = fn(4827).BaseConnectionEvent;
