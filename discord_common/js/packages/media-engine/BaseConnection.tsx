...
prototype["destroy"] = function destroy() {
  ...
  this.emit(require(4367) /* BaseConnectionEvent */.BaseConnectionEvent.Destroy, this);
...
prototype["setLocalVideoDisabled"] = function setLocalVideoDisabled(arg0, arg1) {
  ...
  this.emit(require(4367) /* BaseConnectionEvent */.BaseConnectionEvent.LocalVideoDisabled, arg0, arg1);
};
...
prototype["setHasActiveVideoOutputSink"] = function setHasActiveVideoOutputSink(arg0, arg1, arg2) {
  ...
  if (hasActiveVideoOutputSink !== hasActiveVideoOutputSink1) {
    self.emit(require(4367) /* BaseConnectionEvent */.BaseConnectionEvent.ActiveSinksChange, arg0, hasActiveVideoOutputSink1);
  }
};
...
prototype["getStreamParameters"] = function getStreamParameters() {
  return importDefault(4368)(this.videoStreamParameters);
};
...
prototype["setConnectionState"] = function setConnectionState(DISCONNECTED) {
  ...
  this.emit(require(4367) /* BaseConnectionEvent */.BaseConnectionEvent.ConnectionStateChange, this.connectionState);
};
prototype["updateVideoQuality"] = function updateVideoQuality(closure_8) {
  ...
  const tmp2 = importDefault(4368)(self.videoStreamParameters);
  if (null != quality) {
  ...
  tmp5.streamParameters = importDefault(4368)(self.videoStreamParameters);
  ...
  if (null != closure_8) {
    let obj = importDefault(4397)(tmp5, closure_8);
  } else {
    obj = {};
...
prototype["applyVideoQualityMode"] = function applyVideoQualityMode(mode) {
  ...
  if (this.context === constants2.DEFAULT) {
    ...
    videoQualityManager.setQualityOverwrite(require(4364) /* WantsVideoQuality */.VIDEO_QUALITY_MODES_TO_OVERWRITES[mode]);
