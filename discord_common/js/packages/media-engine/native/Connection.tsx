...
prototype["setSelfMute"] = function setSelfMute(selfMute) {
  ...
  this.emit(BaseConnectionEvent /* BaseConnectionEvent */.BaseConnectionEvent.Mute, selfMute);
};
...
prototype["setSelfDeaf"] = function setSelfDeaf(deaf) {
  ...
  this.emit(BaseConnectionEvent /* BaseConnectionEvent */.BaseConnectionEvent.Deafen, deaf);
};
...
prototype["setLocalMute"] = function setLocalMute(closure_0, flag) {
  ...
  this.emit(BaseConnectionEvent /* BaseConnectionEvent */.BaseConnectionEvent.LocalMute, closure_0, flag);
};
...
prototype["setDesktopEncodingOptions"] = function setDesktopEncodingOptions(result, resolution, frameRate) {
  ...
  if (!this.destroyed) {
    ...
    if (null != calcMaxBitrateFuncResult) {
      ...
      const VideoQuality = WantsVideoQuality /* WantsVideoQuality */.VideoQuality;
...
prototype["createInputModeOptions"] = function createInputModeOptions() {
  ...
  if (constants3.VOICE_ACTIVITY === inputMode) {
    ...
    const VADAggressiveness = VADAggressiveness /* VADAggressiveness */.VADAggressiveness;
...
prototype["getConnectionTransportOptions"] = function getConnectionTransportOptions() {
  ...
  let supportsFeatureResult = inject /* inject */.supportsFeature(constants8.VIDEO_EFFECTS);
...
prototype["mergeUsers"] = function mergeUsers(items4) {
  ...
  this.emit(BaseConnectionEvent /* BaseConnectionEvent */.BaseConnectionEvent.UsersMerged, items4);
};
