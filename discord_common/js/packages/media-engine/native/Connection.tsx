...
import cloneDeepDefault from "../../../../../_runtime/04828_cloneDeep.js";
import VideoCodecUtils from "../utils/VideoCodecUtils.tsx";
import transformStatsDefault from "transformStats.tsx";
import _modDef4875 from "../../../../../_runtime/metro/04875__.js";
import discord_common_VoiceEngine from "VoiceEngine.tsx";
import reduceDefault from "../../../../../_runtime/04877_reduce.js";
import _modDef4880 from "../../../../../_runtime/metro/04880__.js";
            ...
            if (0 === diff) {
              ...
              if (diff1 >= 0) {
                closure_0.emit(
                  ...
                  100 * _modDef4880(diff1 / (diff + diff1), 0, 1),
                );
...
prototype["getStats"] = function getStats() {
  ...
  if (this.connectionState === constants4.DISCONNECTED) {
    ...
    let obj = self(4872);
    resolved = self(4872)
      .timeout(promise, self(4821).STATS_INTERVAL)
      .catch((error) => {
