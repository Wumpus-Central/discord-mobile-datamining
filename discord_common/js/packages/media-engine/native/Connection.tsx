            ...
            if (0 === diff) {
              ...
              if (diff1 >= 0) {
                closure_0.emit(
                  ...
                  100 * _modDef4764(diff1 / (diff + diff1), 0, 1),
                );
                const tmp6 = _modDef4764(diff1 / (diff + diff1), 0, 1);
              }
            }
...
prototype["getStats"] = function getStats() {
  ...
  if (this.connectionState === constants4.DISCONNECTED) {
    ...
    let obj = self(4756);
    resolved = self(4756)
      .timeout(promise, self(4705).STATS_INTERVAL)
      .catch((error) => {
  ...
  return new Promise((fn, arg1) => {
    ...
    function _loop(iter) {
      ...
      if (-1 === findIndexResult) {
        ...
        const items = [];
        if (!_modDef4759(self.videoStreamParameters[findIndexResult], closure_1[findIndexResult])) {
          const obj = {};
