            ...
            if (0 === diff) {
              ...
              if (diff1 >= 0) {
                closure_0.emit(
                  ...
                  100 * _modDef4846(diff1 / (diff + diff1), 0, 1),
                );
                const tmp6 = _modDef4846(diff1 / (diff + diff1), 0, 1);
              }
            }
...
prototype["getStats"] = function getStats() {
  ...
  if (this.connectionState === constants4.DISCONNECTED) {
    ...
    let obj = self(4838);
    resolved = self(4838)
      .timeout(promise, self(4787).STATS_INTERVAL)
      .catch((error) => {
  ...
  return new Promise((fn, arg1) => {
    ...
    function _loop(iter) {
      ...
      if (-1 === findIndexResult) {
        ...
        const items = [];
        if (!_modDef4841(self.videoStreamParameters[findIndexResult], closure_1[findIndexResult])) {
          const obj = {};
