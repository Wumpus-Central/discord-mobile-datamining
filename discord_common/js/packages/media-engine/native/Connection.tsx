...
import cloneDeepDefault from "../../../../../_runtime/04646_cloneDeep.js";
...
import reduceDefault from "../../../../../_runtime/04695_reduce.js";
            ...
            if (0 === diff) {
              ...
              if (diff1 >= 0) {
                closure_0.emit(
                  ...
                  100 * _modDef4698(diff1 / (diff + diff1), 0, 1),
                );
                const tmp6 = _modDef4698(diff1 / (diff + diff1), 0, 1);
              }
            }
        ...
        if (null == transportInfo) {
          ...
          const codecCapabilities = voiceEngine.getCodecCapabilities((arg0) => {
            ...
            const encryptionModes = port.getEncryptionModes((arg0) => {
              ...
              const result = port.setOnSpeakingCallback(obj.handleSpeakingNative);
              ...
              if (obj.videoSupported) {
                port.setOnVideoCallback(obj.handleVideo);
              ...
              for (const item10173 of keys) {
                if (item10173 !== connectionTransportOptions.userId) {
                  let setSpeakingFlagsResult = connectionTransportOptions.setSpeakingFlags(
                    item10173,
                    connectionTransportOptions.localSpeakingFlags[item10173],
                  );
                }
                continue;
              }
...
prototype["getStats"] = function getStats() {
  ...
  if (this.connectionState === constants4.DISCONNECTED) {
    ...
    let obj = self(4690);
    resolved = self(4690)
      .timeout(promise, self(4639).STATS_INTERVAL)
      .catch((error) => {
  ...
  return new Promise((fn, arg1) => {
    ...
    function _loop(iter) {
      ...
      if (-1 === findIndexResult) {
        ...
        const items = [];
        if (!_modDef4693(self.videoStreamParameters[findIndexResult], closure_1[findIndexResult])) {
          let obj = {};
