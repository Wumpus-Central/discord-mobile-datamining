        ...
        if (null != rtp) {
          if (null != closure_0.stats) {
            ...
            if (0 === diff) {
              ...
              if (diff1 >= 0) {
                closure_0.emit(BaseConnectionEvent.BaseConnectionEvent.OutboundLossRate, 100 * _modDef4684(diff1 / (diff + diff1), 0, 1));
                const tmp6 = _modDef4684(diff1 / (diff + diff1), 0, 1);
              }
            }
  ...
  return new Promise((fn, arg1) => {
    ...
    function _loop(iter) {
      ...
      if (-1 === findIndexResult) {
        ...
        const items = [];
        if (!_modDef4679(self.videoStreamParameters[findIndexResult], closure_1[findIndexResult])) {
          let obj = {};
...
prototype["createInputModeOptions"] = function createInputModeOptions() {
  ...
  if (constants3.VOICE_ACTIVITY === inputMode) {
    let obj = { vadThreshold: self.vadThreshold, vadAutoThreshold: null, vadUseKrisp: null, vadLeading: null, vadTrailing: null, vadKrispActivationThreshold: null };
