...
export const RPCCommandSchemas = {
    ...
    request(string) {
      ...
      if (typeof ActionRowComponent === "function") {
        ...
        if (typeof ButtonComponent === "function") {
          ...
          const stringResult6 = string.string();
          obj1.custom_id = string.string().max(100).description("Developer-defined identifier for the button; max 100 characters");
  ...
  [helpers.RPCCommand.SHARE_CONTENT]: {
    request(string) {
      ...
      const stringResult7 = string.string();
      obj.content_type = string.string().valid("image/png", "image/jpeg", "image/gif", "image/webp", "video/mp4", "video/webm").required();
