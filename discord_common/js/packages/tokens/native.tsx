...
obj = {
  ...
  shadows: require("mapValues")(Shadows, (arg0) => {
    ...
    let shadowOffset = {
      resolve(isAndroid) {
        return f67934(f67934[isAndroid.theme].nativeStyles, isAndroid.isAndroid);
      }
    };
    f67934 = (shadowColorAndroid) => arg1 ? shadowColorAndroid.shadowColorAndroid : shadowColorAndroid.shadowColor;
    const shadowColor = {
      resolve(isAndroid) {
        return f67934(f67934[isAndroid.theme].nativeStyles, isAndroid.isAndroid);
      }
    };
    f67934 = (shadowOpacity) => shadowOpacity.shadowOpacity;
    f67934 = (shadowRadius) => shadowRadius.shadowRadius;
    f67934 = (elevation) => elevation.elevation;
    return {
      shadowOffset,
      shadowColor,
      shadowOpacity: {
