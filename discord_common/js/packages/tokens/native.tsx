...
obj = {
  ...
  shadows: require("mapValues")(Shadows, (arg0) => {
    ...
    let shadowOffset = {
      resolve(isAndroid) {
        return f67954(f67954[isAndroid.theme].nativeStyles, isAndroid.isAndroid);
      }
    };
    f67954 = (shadowColorAndroid) => arg1 ? shadowColorAndroid.shadowColorAndroid : shadowColorAndroid.shadowColor;
    const shadowColor = {
      resolve(isAndroid) {
        return f67954(f67954[isAndroid.theme].nativeStyles, isAndroid.isAndroid);
      }
    };
    f67954 = (shadowOpacity) => shadowOpacity.shadowOpacity;
    f67954 = (shadowRadius) => shadowRadius.shadowRadius;
    f67954 = (elevation) => elevation.elevation;
    return {
      shadowOffset,
      shadowColor,
      shadowOpacity: {
