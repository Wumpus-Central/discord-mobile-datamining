...
let obj = { Shadows: null };
obj = {
  SHADOW_BORDER: null,
  SHADOW_BUTTON_OVERLAY: null,
  SHADOW_HIGH: null,
  SHADOW_LEDGE: null,
  SHADOW_LOW: null,
  SHADOW_LOW_ACTIVE: null,
  SHADOW_LOW_HOVER: null,
  SHADOW_MEDIUM: null,
  SHADOW_MOBILE_CHATINPUT: null,
  SHADOW_MOBILE_NAVIGATOR_X: null,
  SHADOW_TOP_HIGH: null,
  SHADOW_TOP_LEDGE: null,
  SHADOW_TOP_LOW: null,
};
obj = {
...
obj.SHADOW_TOP_LEDGE = {
  ...
  [Themes.LIGHT]: {
    boxShadow:
      "0 -2px 0 0 hsl(none 0% 0% / 0.03), 0 -1.5px 0 0 hsl(none 0% 0% / 0.03), 0 -1px 0 0 hsl(none 0% 0% / 0.08)",
    filter: "drop-shadow(0 -1.5px 0 hsl(none 0% 0% / 0.12))",
    nativeStyles: {
      shadowOffset: { width: 0, height: -1.5 },
      shadowColor: "#000000",
