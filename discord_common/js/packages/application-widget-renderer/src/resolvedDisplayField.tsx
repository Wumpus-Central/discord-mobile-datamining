...
export const resolveTextComponentValues = function resolveTextComponentValues(subtitle_1, resolveFieldValue, numberFormat, arg3) {
  ...
  if (null == subtitle_1) {
    ...
    const items = [resolveFieldValue /* resolveFieldValue */.ResolvedValueType.STRING, resolveFieldValue /* resolveFieldValue */.ResolvedValueType.NUMBER];
    ...
    const items2 = [resolveFieldValue /* resolveFieldValue */.ResolvedValueType.MEDIA];
...
export const resolveStatComponentValues = function resolveStatComponentValues(fields, closure_1, closure_2, formatDurationNarrow, arg4) {
  ...
  if (null == fields) {
    ...
    const items1 = [resolveFieldValue /* resolveFieldValue */.ResolvedValueType.STRING];
...
export const resolveSingleStringOrSkeleton = function resolveSingleStringOrSkeleton(componentConfig, description, resolveFieldValue) {
  ...
  const items = [resolveFieldValue /* resolveFieldValue */.ResolvedValueType.STRING];
