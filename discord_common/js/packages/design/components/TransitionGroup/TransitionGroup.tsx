// === Module 4481: TransitionGroup/TransitionGroup ===
    ...
    memo = renderItem.useMemo(() => {
      ...
      function _loop() {
        ...
        if (null == value) {
          ...
          const obj2 = { item, children: renderItem(tmp2, item, MOUNTED, _cleanUp2), state: MOUNTED, cleanUp: _cleanUp2, renderItem };
        } else {
          if (value.item === item) {
          ...
          const obj3 = { item, children: renderItem(tmp2, item, state, value.cleanUp), state, cleanUp: value.cleanUp, renderItem };
          tmp6 = obj3;
        }
      }
