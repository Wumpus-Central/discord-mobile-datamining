// discord_common/js/packages/design/components/Rive/native/generated/OrbsIllustration_HandsRive.tsx
...
const artboardProperties = {
  "Bounties Illo Hands": { reducedMotion: "boolean" },
  "Orb shine": { reducedMotion: "boolean" },
};
...
export const OrbsIllustration_HandsRive = noop.forwardRef(
  function OrbsIllustration_HandsRiveWithBoundary(fallback, ref) {
