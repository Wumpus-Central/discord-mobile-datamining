...
import findLastIndexDefault from "../../../../_runtime/04858_findLastIndex.js";
...
export const getTimeUnit = function getTimeUnit(arg0, arg1) {
  ...
  if (null != tmp2) {
    ...
    const found = items.find((unit) => f80474(unit.unit));
    let unit = null;
    if (null != found) {
      unit = found.unit;
    }
