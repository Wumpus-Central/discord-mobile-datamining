...
import findLastIndexDefault from "../../../../_runtime/04525_findLastIndex.js";
import closure_3 from "../../../../_runtime/00005_asyncGeneratorStep.js";
import tryCatch from "../../../../_runtime/04524_tryCatch.js";
...
export const getTimeUnit = function getTimeUnit(arg0, arg1) {
  closure_0 = arg0;
  importDefault = arg1;
  const tmp2 = findLastIndexDefault(items, (unit) => f76583(unit.unit), items.findIndex((max) => {
    max = max.max;
  ...
  if (null != tmp2) {
    ...
    const found = arr.find((unit) => f76583(unit.unit));
    let unit = null;
    if (null != found) {
      unit = found.unit;
    }
...
export const getTimeAndUnit = function getTimeAndUnit(rounded, items) {
  ...
  if (null == rounded) {
    ...
    closure_0 = rounded;
    const f76583 = (arg0) => closure_0.includes(arg0);
    const tmp12 = f76583(4525)(items, (unit) => f76583(unit.unit), items.findIndex((max) => {
      max = max.max;
      let tmp = max.unit === closure_1_10.NONE;
      if (tmp) {
        tmp = closure_0 === max;
