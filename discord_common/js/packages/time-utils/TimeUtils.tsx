...
import findLastIndexDefault from "../../../../_runtime/04860_findLastIndex.js";
...
export const getTimeUnit = function getTimeUnit(arg0, arg1) {
  ...
  if (null != tmp2) {
    ...
    const found = items.find((unit) => f80544(unit.unit));
    let unit = null;
    if (null != found) {
      unit = found.unit;
    }
