...
import { MessageType, MessageType as MessageType2, MessageType as MessageType3, MessageType as MessageType4, MessageType as MessageType5, MessageType as MessageType6, MessageType as MessageType7 } from "../../../../../../../_runtime/metro/01307__.js";
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(userId, tag, writeUnknownFields) {
  ...
  if (userId.emailSettings) {
    ...
    const joined = closure_3.internalBinaryWrite(userId.emailSettings, tag.tag(2, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = closure_3.internalBinaryWrite(userId.emailSettings, tag.tag(2, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (userId.flags) {
    const UInt64Value = defineProperty.UInt64Value;
    const tagResult2 = tag.tag(6, _mod1307.WireType.LengthDelimited);
    const joined1 = UInt64Value.internalBinaryWrite(userId.flags, tag.tag(6, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = UInt64Value.internalBinaryWrite(userId.flags, tag.tag(6, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  ...
  while (iter !== undefined) {
    ...
    let tagResult4 = forkResult.tag(1, _mod1307.WireType.Bit64);
    let fixed64Result1 = tagResult4.fixed64(nextResult);
    let tagResult5 = tag.tag(2, _mod1307.WireType.LengthDelimited);
  ...
  if (0 !== userId.version) {
    tag.tag(5, _mod1307.WireType.Varint).uint32(userId.version);
    const tagResult6 = tag.tag(5, _mod1307.WireType.Varint);
  }
  if (userId.data) {
    const tagResult7 = tag.tag(7, _mod1307.WireType.LengthDelimited);
    const joined4 = items1.internalBinaryWrite(userId.data, tag.tag(7, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = items1.internalBinaryWrite(userId.data, tag.tag(7, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
...
prototype2["internalBinaryWrite"] = function internalBinaryWrite(categories, tag, writeUnknownFields) {
  ...
  while (iter !== undefined) {
    ...
    let tagResult2 = stringResult.tag(2, _mod1307.WireType.Varint);
...
prototype3["internalBinaryWrite"] = function internalBinaryWrite(mutedGames, tag, writeUnknownFields) {
  ...
  while (iter !== undefined) {
    ...
    let tagResult2 = fixed64Result.tag(2, _mod1307.WireType.Varint);
  ...
  if (mutedGames.declarativeSettings) {
    ...
    const joined1 = items11.internalBinaryWrite(mutedGames.declarativeSettings, tag.tag(2, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = items11.internalBinaryWrite(mutedGames.declarativeSettings, tag.tag(2, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype4["internalBinaryWrite"] = function internalBinaryWrite(versions, tag, writeUnknownFields) {
  ...
  while (iter !== undefined) {
    ...
    let tagResult2 = forkResult.tag(1, _mod1307.WireType.Varint);
...
prototype5["internalBinaryWrite"] = function internalBinaryWrite(toggle, tag, writeUnknownFields) {
  if (false !== toggle.toggle) {
    tag.tag(1, _mod1307.WireType.Varint).bool(toggle.toggle);
    const tagResult = tag.tag(1, _mod1307.WireType.Varint);
  }
  if (0 !== toggle.radio) {
    tag.tag(2, _mod1307.WireType.Varint).uint32(toggle.radio);
...
prototype6["internalBinaryWrite"] = function internalBinaryWrite(suppressEveryone, tag, writeUnknownFields) {
  ...
  if (false !== suppressEveryone.suppressEveryone) {
    tag.tag(1, _mod1307.WireType.Varint).bool(suppressEveryone.suppressEveryone);
    const tagResult = tag.tag(1, _mod1307.WireType.Varint);
  }
  if (0 !== suppressEveryone.messageNotifications) {
    tag.tag(2, _mod1307.WireType.Varint).uint32(suppressEveryone.messageNotifications);
    const tagResult1 = tag.tag(2, _mod1307.WireType.Varint);
  }
  if (false !== suppressEveryone.mobilePush) {
    tag.tag(3, _mod1307.WireType.Varint).bool(suppressEveryone.mobilePush);
  ...
  if (suppressEveryone.mute) {
    ...
    const joined = MuteNotificationSettings.internalBinaryWrite(suppressEveryone.mute, tag.tag(4, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = MuteNotificationSettings.internalBinaryWrite(suppressEveryone.mute, tag.tag(4, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  let num5 = 0;
  ...
  if (false !== suppressEveryone.suppressRoles) {
    tag.tag(6, _mod1307.WireType.Varint).bool(suppressEveryone.suppressRoles);
    const tagResult5 = tag.tag(6, _mod1307.WireType.Varint);
  }
  if (0 !== suppressEveryone.version) {
    tag.tag(7, _mod1307.WireType.Varint).uint32(suppressEveryone.version);
    const tagResult6 = tag.tag(7, _mod1307.WireType.Varint);
  }
  if (false !== suppressEveryone.hideMutedChannels) {
    tag.tag(8, _mod1307.WireType.Varint).bool(suppressEveryone.hideMutedChannels);
    const tagResult7 = tag.tag(8, _mod1307.WireType.Varint);
  }
  if (false !== suppressEveryone.muteScheduledEvents) {
    tag.tag(9, _mod1307.WireType.Varint).bool(suppressEveryone.muteScheduledEvents);
    const tagResult8 = tag.tag(9, _mod1307.WireType.Varint);
  }
  if (0 !== suppressEveryone.notifyHighlights) {
    tag.tag(10, _mod1307.WireType.Varint).uint32(suppressEveryone.notifyHighlights);
    const tagResult9 = tag.tag(10, _mod1307.WireType.Varint);
  }
  let onWrite = writeUnknownFields.writeUnknownFields;
  if (false !== onWrite) {
    if (1 == onWrite) {
...
prototype7["internalBinaryWrite"] = function internalBinaryWrite(channelId, tag, writeUnknownFields) {
  if ("0" !== channelId.channelId) {
    tag.tag(1, _mod1307.WireType.Bit64).fixed64(channelId.channelId);
    const tagResult = tag.tag(1, _mod1307.WireType.Bit64);
  }
  if (0 !== channelId.messageNotifications) {
    tag.tag(7, _mod1307.WireType.Varint).uint32(channelId.messageNotifications);
    const tagResult1 = tag.tag(7, _mod1307.WireType.Varint);
  }
  if (channelId.mute) {
    const MuteNotificationSettings = create3.MuteNotificationSettings;
    const tagResult2 = tag.tag(3, _mod1307.WireType.LengthDelimited);
    const joined = MuteNotificationSettings.internalBinaryWrite(channelId.mute, tag.tag(3, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = MuteNotificationSettings.internalBinaryWrite(channelId.mute, tag.tag(3, _mod1307.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== channelId.collapsed) {
    tag.tag(4, _mod1307.WireType.Varint).bool(channelId.collapsed);
