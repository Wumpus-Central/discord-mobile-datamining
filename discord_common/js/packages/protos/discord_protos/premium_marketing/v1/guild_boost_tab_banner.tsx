// discord_common/js/packages/protos/discord_protos/premium_marketing/v1/guild_boost_tab_banner.tsx
...
prototype = new prototype(
  "discord_protos.premium_marketing.v1.GuildBoostTabBanner",
  items,
  tmp,
  T,
  GuildBoostTabBanner$Type,
  prototype,
  items,
);
const size = fn(2);
