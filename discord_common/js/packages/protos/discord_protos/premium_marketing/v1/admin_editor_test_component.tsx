...
prototype["internalBinaryWrite"] = function internalBinaryWrite(deprecatedField, tag, writeUnknownFields) {
  if ("" !== deprecatedField.deprecatedField) {
    tag.tag(1, require("../../../../../../../_runtime/metro/01307__.js").WireType.LengthDelimited).string(deprecatedField.deprecatedField);
  ...
  if (deprecatedField.localizedTextField) {
    ...
    const joined = LocalizedString.internalBinaryWrite(deprecatedField.localizedTextField, tag.tag(2, require("../../../../../../../_runtime/metro/01307__.js").WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = LocalizedString.internalBinaryWrite(deprecatedField.localizedTextField, tag.tag(2, require("../../../../../../../_runtime/metro/01307__.js").WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("" !== deprecatedField.plainTextField) {
    tag.tag(3, require("../../../../../../../_runtime/metro/01307__.js").WireType.LengthDelimited).string(deprecatedField.plainTextField);
  ...
  if (deprecatedField.textareaField) {
    ...
    const joined1 = LocalizedString2.internalBinaryWrite(deprecatedField.textareaField, tag.tag(4, require("../../../../../../../_runtime/metro/01307__.js").WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = LocalizedString2.internalBinaryWrite(deprecatedField.textareaField, tag.tag(4, require("../../../../../../../_runtime/metro/01307__.js").WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (false !== deprecatedField.checkboxField) {
    tag.tag(5, require("../../../../../../../_runtime/metro/01307__.js").WireType.Varint).bool(deprecatedField.checkboxField);
    const tagResult4 = tag.tag(5, require("../../../../../../../_runtime/metro/01307__.js").WireType.Varint);
  }
  if ("" !== deprecatedField.assetField) {
    tag.tag(6, require("../../../../../../../_runtime/metro/01307__.js").WireType.LengthDelimited).string(deprecatedField.assetField);
