// === Module 10812: billing_settings_nitro_gift_banner ===
...
prototype["internalBinaryWrite"] = function internalBinaryWrite(assetUrl, tag, writeUnknownFields) {
  if ("" !== assetUrl.assetUrl) {
    tag.tag(1, _mod1186.WireType.LengthDelimited).string(assetUrl.assetUrl);
    const tagResult = tag.tag(1, _mod1186.WireType.LengthDelimited);
  }
  if ("" !== assetUrl.header) {
    tag.tag(2, _mod1186.WireType.LengthDelimited).string(assetUrl.header);
    const tagResult1 = tag.tag(2, _mod1186.WireType.LengthDelimited);
  }
  if ("" !== assetUrl.body) {
    tag.tag(3, _mod1186.WireType.LengthDelimited).string(assetUrl.body);
    const tagResult2 = tag.tag(3, _mod1186.WireType.LengthDelimited);
  }
  if ("" !== assetUrl.backgroundAssetUrl) {
    tag.tag(4, _mod1186.WireType.LengthDelimited).string(assetUrl.backgroundAssetUrl);
  ...
  if (assetUrl.gradient) {
    ...
    const joined = Gradient.internalBinaryWrite(assetUrl.gradient, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult = Gradient.internalBinaryWrite(assetUrl.gradient, tag.tag(5, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if ("" !== assetUrl.textColor) {
    tag.tag(6, _mod1186.WireType.LengthDelimited).string(assetUrl.textColor);
    const tagResult5 = tag.tag(6, _mod1186.WireType.LengthDelimited);
  }
  if ("" !== assetUrl.additionalTerms) {
    tag.tag(7, _mod1186.WireType.LengthDelimited).string(assetUrl.additionalTerms);
  ...
  if (assetUrl.asset) {
    ...
    const joined1 = ThemeAwareAsset.internalBinaryWrite(assetUrl.asset, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult1 = ThemeAwareAsset.internalBinaryWrite(assetUrl.asset, tag.tag(8, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.backgroundAsset) {
    ...
    const joined2 = ThemeAwareAsset2.internalBinaryWrite(assetUrl.backgroundAsset, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult2 = ThemeAwareAsset2.internalBinaryWrite(assetUrl.backgroundAsset, tag.tag(9, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.headerLocalized) {
    const LocalizedString = localized_string.LocalizedString;
    const tagResult9 = tag.tag(10, _mod1186.WireType.LengthDelimited);
    const joined3 = LocalizedString.internalBinaryWrite(assetUrl.headerLocalized, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult3 = LocalizedString.internalBinaryWrite(assetUrl.headerLocalized, tag.tag(10, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.bodyLocalized) {
    const LocalizedString2 = localized_string.LocalizedString;
    const tagResult10 = tag.tag(11, _mod1186.WireType.LengthDelimited);
    const joined4 = LocalizedString2.internalBinaryWrite(assetUrl.bodyLocalized, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult4 = LocalizedString2.internalBinaryWrite(assetUrl.bodyLocalized, tag.tag(11, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
  if (assetUrl.additionalTermsLocalized) {
    ...
    const joined5 = LocalizedString3.internalBinaryWrite(assetUrl.additionalTermsLocalized, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields).join();
    const internalBinaryWriteResult5 = LocalizedString3.internalBinaryWrite(assetUrl.additionalTermsLocalized, tag.tag(12, _mod1186.WireType.LengthDelimited).fork(), writeUnknownFields);
  }
