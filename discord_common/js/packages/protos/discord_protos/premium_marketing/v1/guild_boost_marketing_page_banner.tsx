// discord_common/js/packages/protos/discord_protos/premium_marketing/v1/guild_boost_marketing_page_banner.tsx
...
prototype = new prototype(
  "discord_protos.premium_marketing.v1.GuildBoostMarketingPageBanner",
  items,
  tmp,
  T,
  GuildBoostMarketingPageBanner$Type,
  prototype,
  items,
);
// ThrowIfThisInitialized (0x7c)
