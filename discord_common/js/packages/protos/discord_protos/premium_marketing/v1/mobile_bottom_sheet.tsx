...
class MobileBottomSheet$Type extends MessageType {
  constructor() {
    ...
    items[5] = {
      ...
      T() {
        const items = [
          "discord_protos.discord_users.v1.DismissibleContent",
          require("dismissible_content").DismissibleContent,
        ];
        return items;
      },
    };
...
prototype = new prototype(
  "discord_protos.premium_marketing.v1.MobileBottomSheet",
  items,
  tmp,
  T,
  MobileBottomSheet$Type,
  prototype,
  items,
);
const size = fn(2);
