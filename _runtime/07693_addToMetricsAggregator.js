// _runtime/07693_addToMetricsAggregator.js
import errorCallback from "07593_errorCallback.js";
import _mod7694 from "metro/07694__.js";
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = require("07624_getClient.js").getClient();
    const obj2 = getClient;
  }
  if (client) {
    const activeSpan = require("07602_spanTimeInputToSeconds.js").getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    if (require("metro/07625___SENTRY_DEBUG__.js").DEBUG_BUILD) {
    ...
    const globalSingleton = require("07598_getGlobalSingleton.js").getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod7694.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod7694.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, _mod7694.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, _mod7694.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    dependencyMap = arg1;
    ...
    if (typeof fn === "function") {
      ...
      return require("07631_createChildOrRootSpan.js").startSpanManual(obj, (arg0) => {
        const callback = arg0;
        return callback(table[10]).handleCallbackErrors(() => callback(), () => {
          ...
          closure_2(lib, lib(7694).DISTRIBUTION_METRIC_TYPE, closure_1_1, parsed, obj);
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = require("metro/07694__.js").DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
