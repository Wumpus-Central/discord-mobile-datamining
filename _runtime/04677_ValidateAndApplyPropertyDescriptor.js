// _runtime/04677_ValidateAndApplyPropertyDescriptor.js
import { isPropertyKey } from "04658_isPropertyKey.js";
import { Type } from "04678_Type.js";
...
export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__) {
  ...
  if (isPropertyKey(arg1)) {
    if (typeof flag !== "boolean") {
      ...
      throw tmp87;
    } else if (tmp(4662)(__Configurable__)) {
      __Set__ = arg4;
      if (undefined !== arg4) {
        if (!tmp(4662)(__Set__)) {
      ...
      if (undefined === __Set__) {
        ...
        if (tmp64) {
          if ("Undefined" === tmp3) {
            ...
            tmpResult = tmp(4666);
            const tmpResult1 = tmp(4667);
            const tmpResult2 = tmp(4668);
            if (tmp66) {
            ...
            tmp66 = tmp(4675)(__Configurable__);
          }
        }
        return tmp64;
      } else {
        ...
        if (tmpResult3(obj, __Set__)) {
          if (!__Set__["[[Configurable]]"]) {
            ...
            if ("[[Enumerable]]" in __Configurable__) {
              if (!tmp(4667)(__Configurable__["[[Enumerable]]"], __Set__["[[Enumerable]]"])) {
                return false;
              }
            }
            if (!tmp(4680)(__Configurable__)) {
              const tmpResult4 = tmp(4667);
              if (!tmpResult4(tmp26, tmp(4675)(__Set__))) {
                return false;
              }
              tmp26 = tmp(4675)(__Configurable__);
            }
            if (tmp(4675)(__Set__)) {
              if ("[[Get]]" in __Configurable__) {
                if (!tmp(4667)(__Configurable__["[[Get]]"], __Set__["[[Get]]"])) {
                  return false;
                }
              }
              if ("[[Set]]" in __Configurable__) {
                if (!tmp(4667)(__Configurable__["[[Set]]"], __Set__["[[Set]]"])) {
                  return false;
                }
              }
              ...
              if ("[[Value]]" in __Configurable__) {
                if (!tmp(4667)(__Configurable__["[[Value]]"], __Set__["[[Value]]"])) {
                  return false;
                }
              }
            }
          ...
          if ("Undefined" === tmp3) {
            ...
            if (!tmp(4666)(__Set__)) {
              if (tmp(4675)(__Set__)) {
                if (tmp(4666)(__Configurable__)) {
                  ...
                  const tmpResult6 = tmp(4666);
                  const tmpResult7 = tmp(4667);
                  const tmpResult8 = tmp(4668);
                  ...
                  let tmpResult6Result = tmp(4665)(tmpResult6, tmpResult7, tmpResult8, arg0, arg1, obj);
                  const tmpResult5 = tmp(4665);
                }
              }
              const tmpResult10 = tmp(4666);
              const tmpResult9 = tmp(4665);
              tmpResult6Result = tmpResult9(tmpResult10, tmp(4667), tmp(4668), arg0, arg1, __Configurable__);
              const tmpResult11 = tmp(4667);
            }
            let tmp50 = __Set__;
            if ("[[Configurable]]" in __Configurable__) {
            ...
            const tmpResult13 = tmp(4666);
            const tmpResult14 = tmp(4667);
            const tmpResult15 = tmp(4668);
            ...
            __Set__ = __Set__["[[Set]]"];
            obj1[3] = __Set__;
            tmpResult6Result = tmp(4665)(tmpResult13, tmpResult14, tmpResult15, arg0, arg1, obj1);
            const tmpResult12 = tmp(4665);
          }
        } else {
