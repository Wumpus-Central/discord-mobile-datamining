...
export const makeBrowserOfflineTransport = function makeBrowserOfflineTransport() {
  ...
  if (arg0 === undefined) {
    makeFetchTransport = require("00897_makeFetchTransport.js").makeFetchTransport;
  }
  _require = require("00682_registerSpanErrorInstrumentation.js").makeOfflineTransport(makeFetchTransport);
  return (arg0) => {
    let obj = {};
