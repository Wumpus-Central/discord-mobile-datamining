...
import _mod12913 from "metro/12913__.js";
import _mod12917 from "metro/12917__.js";
import _mod12918 from "metro/12918__.js";
import _mod12927 from "metro/12927__.js";
import _mod12939 from "metro/12939__.js";
  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/12917__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/12918__.js").DEBUG_BUILD) {
            const logger = require("metro/12890__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/12917__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const captureException = function captureException(arg0, captureContext) {
  const currentScope = _mod12917.getCurrentScope();
  return currentScope.captureException(arg0, _mod12939.parseEventHintOrCaptureContext(captureContext));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = _mod12927.DEFAULT_ENVIRONMENT;
  }
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod12904.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod12917.getCurrentScope();
    const client = _mod12917.getClient();
    if (client) {
    ...
    _mod12901.uuid4();
    const tmpResult = _mod12901;
  }
  let currentScope = require("metro/12917__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/12917__.js");
  let client = require("metro/12917__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/12917__.js");
  captureCheckInResult = require("metro/12901__.js").uuid4();
};
