// _runtime/05916_JSFPSMonitor.js
import _createClassDefault from "metro/05864__createClass.js";
import closure_2 from "metro/05863__classCallCheck.js";
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        error = new Error(JSFPSMonitor(5851).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      const obj = { minFPS: JSFPSMonitor(5917).roundToDecimalPlaces(self.minFPS, 1), maxFPS: null, averageFPS: null };
      const obj2 = JSFPSMonitor(5917);
      obj[1] = JSFPSMonitor(5917).roundToDecimalPlaces(self.maxFPS, 1);
