// _runtime/05536_map.js
import _slicedToArray from "_slicedToArray";
import { useMemo } from "noop";
import { hash } from "05524_hash.js";
import { items2 } from "05525_items2.js";
import { isNativeEvent } from "05537_isNativeEvent.js";
import { 05510__ } from "metro/05510__.js";
...
export const resolveInternalConfigProps = function resolveInternalConfigProps(useAnimated) {
  ...
  if (!disableReanimated) {
    result = undefined !== 05510__.Reanimated;
  }
  if (result) {
  ...
  while (tmp12 !== undefined) {
    ...
    if (!allowedNativeProps.has(first)) {
      ...
      if (!EMPTY_WHITE_LIST.has(tmp17)) {
        let tmp23 = tmp18;
        let tmp24 = tmp20;
        let PropsToFilter = tmp19(5525).PropsToFilter;
        let tmp25 = first;
    ...
    let tmp32 = tmp18;
    let tmp33 = tmp20;
    let Reanimated = tmp19(5510).Reanimated;
