// _runtime/06923_convertToHandlerTag.js
...
let items = [
  ...fn(6924).baseGestureHandlerWithDetectorProps,
  ...fn(6925).tapGestureHandlerProps,
  ...fn(6935).panGestureHandlerProps,
  ...fn(6935).panGestureHandlerCustomNativeProps,
  ...fn(6936).longPressGestureHandlerProps,
  ...fn(6937).forceTouchGestureHandlerProps,
  ...fn(6939).flingGestureHandlerProps,
  ...fn(6940).hoverGestureHandlerProps,
  ...fn(6941).nativeViewGestureHandlerProps,
];
