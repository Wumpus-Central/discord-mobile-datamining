// _runtime/09905_QRPolynomial.js
import _mod9906 from "metro/09906__.js";
...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const glogResult = _mod9906.glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - _mod9906.glog(getLength.get(0));
