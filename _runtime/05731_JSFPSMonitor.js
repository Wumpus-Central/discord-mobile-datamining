// _runtime/05731_JSFPSMonitor.js
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        const error = new Error(JSFPSMonitor(5666).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      obj[0] = JSFPSMonitor(5732).roundToDecimalPlaces(self.minFPS, 1);
      const obj2 = JSFPSMonitor(5732);
      obj[1] = JSFPSMonitor(5732).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5732);
      obj[2] = JSFPSMonitor(5732).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
