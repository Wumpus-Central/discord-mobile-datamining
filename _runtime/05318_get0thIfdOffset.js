// _runtime/05318_get0thIfdOffset.js
import _modDef5301 from "metro/05301__.js";
import _modDef5315 from "metro/05315__.js";
import IFD_TYPE_0TH2 from "05319_IFD_TYPE_0TH.js";
...
function readTag(byteLength, IFD_TYPE_0TH, sum, sum, byteOrder, arg5) {
  ...
  if (undefined !== _modDef5315.typeSizes[shortAt1]) {
    if (
      ...
      const longAt1 = _modDef5315.getLongAt(byteLength, sum + sum1, byteOrder);
      str = "<faulty value>";
      tmp21 = longAt1;
      if (
      ...
      const tmp4Result = _modDef5315;
    }
    let tmp34 = str;
    if (shortAt1 === _modDef5315.tagTypes.ASCII) {
    ...
    if (undefined !== IFD_TYPE_0THDefault[IFD_TYPE_0TH][shortAt]) {
      ...
      if (shortAt1 !== _modDef5315.tagTypes.RATIONAL) {
        if (shortAt1 !== _modDef5315.tagTypes.SRATIONAL) {
...
let obj = {
  1: null,
  2: _modDef5315.getByteAt,
  3: _modDef5315.getAsciiAt,
  4: _modDef5315.getShortAt,
  5: _modDef5315.getLongAt,
  7: _modDef5315.getRationalAt,
  9: null,
  10: _modDef5315.getUndefinedAt,
  13: null,
};
...
function readIfd(byteLength, IFD_TYPE_0TH, sum, sum, byteOrder, arg5) {
  ...
  if (_modDef5301.USE_THUMBNAIL) {
    if (tmp5 < byteLength.byteLength - tmp23Result.getTypeSize("LONG")) {
      const longAt = _modDef5315.getLongAt(byteLength, tmp5, byteOrder);
      let tmp26 = 0 !== longAt;
      if (tmp26) {
      ...
      const tmp23Result2 = _modDef5315;
    }
    tmp23Result = _modDef5315;
  }
  return obj3;
}
