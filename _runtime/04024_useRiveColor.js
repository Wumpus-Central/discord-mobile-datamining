...
const f28700 = (colorProperty) => colorProperty.colorProperty(arg1);
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(require(4019) /* useRiveProperty */.useRiveProperty(instance, FillColor, f28700), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
    if (undefined !== tmp5) {
      let RiveColor = require(4014) /* RiveColor */.RiveColor;
