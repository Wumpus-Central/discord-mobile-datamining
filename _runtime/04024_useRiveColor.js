// _runtime/04024_useRiveColor.js
import _slicedToArray from "_slicedToArray";
import { c } from "04006_c.js";
import { RiveColor } from "04014_RiveColor.js";
import { useRiveProperty } from "04019_useRiveProperty.js";

let require = arg1;
require("noop").useCallback;
const f28709 = (colorProperty) => colorProperty.colorProperty(arg1);
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(useRiveProperty.useRiveProperty(instance, FillColor, f28709), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
