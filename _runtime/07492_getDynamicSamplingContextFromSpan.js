// _runtime/07492_getDynamicSamplingContextFromSpan.js
import { addNonEnumerableProperty } from "07462_addNonEnumerableProperty.js";
import { baggageHeaderToDynamicSamplingContext } from "07469_baggageHeaderToDynamicSamplingContext.js";
import { getClient } from "07483_getClient.js";
import { 07493__ } from "metro/07493__.js";
const require = arg1;
...
arg5.getDynamicSamplingContextFromClient = function getDynamicSamplingContextFromClient(trace_id, getOptions) {
  ...
  let DEFAULT_ENVIRONMENT = options.environment;
  if (!DEFAULT_ENVIRONMENT) {
    DEFAULT_ENVIRONMENT = 07493__.DEFAULT_ENVIRONMENT;
  }
