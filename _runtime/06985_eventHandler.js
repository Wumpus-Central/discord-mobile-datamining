// === Module 6985: eventHandler ===

// Module 6985 (eventHandler)
import _mod6905 from "module_6905" /* 6905 */;
import TouchEventType from "TouchEventType" /* 6907 */;
...
handleStateChangeEvent.__closure = { flattenAndFilterEvent: fn(6967).flattenAndFilterEvent, State: fn(6905).State, runCallback: fn(6967).runCallback, CALLBACK_TYPE: fn(6920).CALLBACK_TYPE };
...
let obj = { flattenAndFilterEvent: fn(6967).flattenAndFilterEvent, State: fn(6905).State, runCallback: fn(6967).runCallback, CALLBACK_TYPE: fn(6920).CALLBACK_TYPE };
handleUpdateEvent.__closure = { flattenAndFilterEvent: fn(6967).flattenAndFilterEvent, runCallback: fn(6967).runCallback, CALLBACK_TYPE: fn(6920).CALLBACK_TYPE };
...
let obj2 = { flattenAndFilterEvent: fn(6967).flattenAndFilterEvent, runCallback: fn(6967).runCallback, CALLBACK_TYPE: fn(6920).CALLBACK_TYPE };
handleTouchEvent.__closure = { TouchEventType: fn(6907).TouchEventType, runCallback: fn(6967).runCallback, touchEventTypeToCallbackType: fn(6967).touchEventTypeToCallbackType };
...
const obj3 = { TouchEventType: fn(6907).TouchEventType, runCallback: fn(6967).runCallback, touchEventTypeToCallbackType: fn(6967).touchEventTypeToCallbackType };
eventHandler.__closure = { maybeExtractNativeEvent: fn(6967).maybeExtractNativeEvent, isEventForHandlerWithTag: fn(6967).isEventForHandlerWithTag, isStateChangeEvent: fn(6969).isStateChangeEvent, handleStateChangeEvent, isTouchEvent: fn(6969).isTouchEvent, handleTouchEvent, handleUpdateEvent };
