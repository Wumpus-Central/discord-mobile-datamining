// === Module 5470: Background ===

// Module 5470 (Background)
import registerAssetDefault from "registerAsset" /* 5471 */;
import registerAssetDefault2 from "registerAsset" /* 5472 */;
import registerAssetDefault3 from "registerAsset" /* 5473 */;
import registerAssetDefault4 from "registerAsset" /* 5474 */;
import registerAssetDefault5 from "registerAsset" /* 5475 */;

const items = [registerAssetDefault, registerAssetDefault2, registerAssetDefault3, registerAssetDefault4, registerAssetDefault5];
for (const key10025 in require("module_5476")) {
  let tmp2 = key10025;
  arg5[key10025] = require("module_5476")[key10025];
  continue;
}
