// _runtime/12640_extractRequestData.js
import addNonEnumerableProperty from "12565_addNonEnumerableProperty.js";
import getNumberOfUrlSegments from "12641_getNumberOfUrlSegments.js";
...
function headersToDict(arg0) {
  ...
  try {
    ...
    if (obj(12558).DEBUG_BUILD) {
      const logger = tmp4(12559).logger;
      logger.warn("Sentry failed extracting headers from a request object. If you see this, please file an issue.");
    }
    tmp4 = obj;
  }
