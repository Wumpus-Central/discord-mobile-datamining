// === Module 5861: useRecyclerViewController ===

// Module 5861 (useRecyclerViewController)
import closure_2 from "asyncGeneratorStep" /* 5862 */;
import closure_3 from "_slicedToArray" /* 5819 */;
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  dependencyMap = arg2;
  closure_2 = arg3;
  const unmountFlag = _require(5863).useUnmountFlag();
  let obj = _require(5863);
  ...
  _setTimeout = _require(5864).useUnmountAwareTimeout().setTimeout;
