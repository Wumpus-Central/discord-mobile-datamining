...
obj = { flattenAndFilterEvent: fn(6773).flattenAndFilterEvent, runCallback: fn(6773).runCallback, CALLBACK_TYPE: fn(6726).CALLBACK_TYPE };
...
obj = { TouchEventType: fn(6713).TouchEventType, runCallback: fn(6773).runCallback, touchEventTypeToCallbackType: fn(6773).touchEventTypeToCallbackType };
