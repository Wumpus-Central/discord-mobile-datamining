// _runtime/05237_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05244_AudioTypes.js";
import ImageTypes from "05245_ImageTypes.js";
import VideoTypes from "05246_VideoTypes.js";
import CompressedTypes from "05247_CompressedTypes.js";
import OtherTypes from "05248_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5238).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5238).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5238).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5238).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
