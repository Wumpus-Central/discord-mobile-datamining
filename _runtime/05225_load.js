// _runtime/05225_load.js
import _modDef5226 from "metro/05226__.js";
...
function loadView(byteLength) {
  ...
  function addPngTextTags(readTags) {
    if (flag) {
      ...
      if (closure_1.png) {
        objectAssignResult = _mod5227.objectAssign({}, closure_1.png, readTags);
      }
      closure_1.png = objectAssignResult;
      let objectAssignResult1 = readTags;
      if (closure_1.pngText) {
        objectAssignResult1 = _mod5227.objectAssign({}, closure_1.png, readTags);
      }
  ...
  let obj2 = require("metro/05229__.js");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("metro/05229__.js").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("metro/05230__.js").USE_JPEG) {
    flag4 = false;
  ...
  const parseAppMarkersResult = require("metro/05229__.js").parseAppMarkers(byteLength, flag2);
