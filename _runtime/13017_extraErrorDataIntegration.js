// _runtime/13017_extraErrorDataIntegration.js
import _mod12933 from "metro/12933__.js";
import _mod12934 from "metro/12934__.js";
import _mod12972 from "metro/12972__.js";
import setupIntegration from "metro/12983__.js";
        ...
        if (obj2.isError(obj.originalException)) {
          ...
          if (tmp7) {
            ...
            if (tmp4Result.isPlainObject(normalizeResult)) {
              const result = _mod12933.addNonEnumerableProperty(normalizeResult, "__sentry_skip_normalization__", true);
              obj3[tmp6] = normalizeResult;
              const tmp4Result2 = _mod12933;
            }
            let obj4 = {};
            const merged1 = Object.assign(contexts);
            obj4.contexts = obj3;
            tmp3 = obj4;
            tmp4Result = _mod12934;
          }
