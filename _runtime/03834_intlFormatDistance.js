// _runtime/03834_intlFormatDistance.js
import keys from "03720_keys.js";
import differenceInCalendarDays from "03703_differenceInCalendarDays.js";
import differenceInCalendarMonths from "03727_differenceInCalendarMonths.js";
import differenceInCalendarQuarters from "03728_differenceInCalendarQuarters.js";
import differenceInCalendarWeeks from "03730_differenceInCalendarWeeks.js";
import differenceInCalendarYears from "03731_differenceInCalendarYears.js";
import differenceInHours from "03733_differenceInHours.js";
import differenceInMinutes from "03738_differenceInMinutes.js";
import differenceInSeconds from "03744_differenceInSeconds.js";
...
export default function intlFormatDistance(arg0, arg1, unit) {
  ...
  if (absolute < keys.secondsInMinute) {
    ...
    if (absolute1 < tmp6(3720).secondsInHour) {
      num2 = differenceInMinutes.default(defaultResult1, defaultResult2);
      str = "minute";
    } else {
      const _Math7 = Math;
      const absolute2 = Math.abs(defaultResult3);
      if (absolute2 < tmp6(3720).secondsInDay) {
        const _Math = Math;
      ...
      if (absolute3 < tmp6(3720).secondsInWeek) {
        num2 = differenceInCalendarDays.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < tmp6(3720).secondsInMonth) {
        num2 = differenceInCalendarWeeks.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < tmp6(3720).secondsInQuarter) {
          num2 = differenceInCalendarMonths.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < tmp6(3720).secondsInYear) {
