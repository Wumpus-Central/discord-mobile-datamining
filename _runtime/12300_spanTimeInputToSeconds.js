// _runtime/12300_spanTimeInputToSeconds.js
...
import _mod12307 from "metro/12307__.js";
import _mod12309 from "metro/12309__.js";
import _mod12310 from "metro/12310__.js";
import _mod12311 from "metro/12311__.js";
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12312.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod12312.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod12301.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod12301.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
...
export const getActiveSpan = function getActiveSpan() {
  ...
  if (asyncContextStrategy.getActiveSpan) {
    ...
    const tmpResult = _mod12317;
    activeSpan = tmpResult._getSpanForScope(_mod12322.getCurrentScope());
