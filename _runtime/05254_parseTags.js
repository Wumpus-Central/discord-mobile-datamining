// _runtime/05254_parseTags.js
import getDataView from "05213_getDataView.js";
import _mod5255 from "metro/05255__.js";
...
function parseTags(buffer) {
  ...
  if (buffer.byteLength !== buffer.getUint32()) {
    ...
    const keys = Object.keys(_mod5255.iccProfile);
    for (let num = 0; num < keys.length; num = num + 1) {
      let tmp = keys[num];
      let tmp2 = require;
      let tmp3 = dependencyMap;
      let iter = _mod5255.iccProfile[tmp];
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (stringFromDataView1 === mluc) {
                  ...
                  if (1 === uint324) {
                    ...
                    if (_mod5255.iccTags[stringFromDataView]) {
