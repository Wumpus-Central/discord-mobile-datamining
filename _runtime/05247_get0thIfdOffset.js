// _runtime/05247_get0thIfdOffset.js
import _modDef5230 from "metro/05230__.js";
import _modDef5244 from "metro/05244__.js";
import IFD_TYPE_0TH2 from "05248_IFD_TYPE_0TH.js";
...
function readTag(byteLength, IFD_TYPE_0TH, sum, sum, byteOrder, arg5) {
  ...
  if (undefined !== _modDef5244.typeSizes[shortAt1]) {
    if (
      ...
      const longAt1 = _modDef5244.getLongAt(byteLength, sum + sum1, byteOrder);
      str = "<faulty value>";
      tmp21 = longAt1;
      if (
      ...
      const tmp4Result = _modDef5244;
    }
    let tmp34 = str;
    if (shortAt1 === _modDef5244.tagTypes.ASCII) {
    ...
    if (undefined !== IFD_TYPE_0THDefault[IFD_TYPE_0TH][shortAt]) {
      ...
      if (shortAt1 !== _modDef5244.tagTypes.RATIONAL) {
        if (shortAt1 !== _modDef5244.tagTypes.SRATIONAL) {
...
let obj = {
  1: null,
  2: _modDef5244.getByteAt,
  3: _modDef5244.getAsciiAt,
  4: _modDef5244.getShortAt,
  5: _modDef5244.getLongAt,
  7: _modDef5244.getRationalAt,
  9: null,
  10: _modDef5244.getUndefinedAt,
  13: null,
};
