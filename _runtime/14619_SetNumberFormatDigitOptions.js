// _runtime/14619_SetNumberFormatDigitOptions.js
import _mod14572 from "metro/14572__.js";
import GetNumberOption from "14575_GetNumberOption.js";
import DefaultNumberOption from "14576_DefaultNumberOption.js";
...
export const SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(
  ...
  _mod14572.invariant(hasItem, combined.concat(Array.from(set).join(", "), "."));
  ...
  if (flag) {
    if (tmp12) {
      ...
      if (undefined === DefaultNumberOptionResult) {
        _mod14572.invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      _mod14572.invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
