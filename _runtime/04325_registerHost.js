// _runtime/04325_registerHost.js
import { print } from "04326_print.js";
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4321).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4321).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4321).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4321).ACTIONS.REMOVE_PORTAL === type) {
