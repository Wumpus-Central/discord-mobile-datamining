// _runtime/14310_FormatNumericToString.js
import TEN from "14296_TEN.js";

const _mod14294 = tmp5(14294);
const GetUnsignedRoundingMode = tmp5(14311);
const ToRawPrecision = tmp5(14312);
const ToRawFixed = tmp5(14313);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14294.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14294.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
