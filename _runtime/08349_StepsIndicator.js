// _runtime/08349_StepsIndicator.js
import _mod8347 from "metro/08347__.js";
import _mod8348 from "metro/08348__.js";
import SliderTrackMark from "08350_SliderTrackMark.js";
import StepNumber from "08351_StepNumber.js";
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      ...
      let obj = { marginHorizontal: sliderWidth * _mod8347.constants.MARGIN_HORIZONTAL_PADDING };
    ...
    if ("web" === get_ActivityIndicator.Platform.OS) {
      ...
      obj = { width: tmp6(8347).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8348).styles.stepIndicatorElement, obj);
    } else {
