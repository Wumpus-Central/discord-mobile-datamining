              ...
              if (filename.filename) {
                if (!filename.module_metadata) {
                  (function ensureMetadataStacksAreParsed(closure_0) {
                    if (callback(818).GLOBAL_OBJ._sentryModuleMetadata) {
                      const _Object = Object;
                      const keys = Object.keys(callback(818).GLOBAL_OBJ._sentryModuleMetadata);
                      for (const item10026 of keys) {
                        ...
                        let tmp16 = callback(818).GLOBAL_OBJ._sentryModuleMetadata[item10026];
                        let obj = set;
...
arg5.getFilenameToMetadataMap = function getFilenameToMetadataMap(arg0) {
  const obj = {};
  if (_mod818.GLOBAL_OBJ._sentryModuleMetadata) {
    const _Object = Object;
    const keys = Object.keys(_mod818.GLOBAL_OBJ._sentryModuleMetadata);
    for (const item10026 of keys) {
      let tmp11 = require;
      let tmp12 = require;
      let tmp13 = dependencyMap;
      let tmp14 = dependencyMap;
      let tmp15 = _mod818.GLOBAL_OBJ._sentryModuleMetadata[item10026];
