// _runtime/04019_useRiveProperty.js
import _slicedToArray from "_slicedToArray";
import noop from "noop";
import { useDisposableMemo } from "04020_useDisposableMemo.js";
...
export const useRiveProperty = function useRiveProperty(instance, FillColor, f28709) {
  const _require = instance;
  const dependencyMap = FillColor;
  const callback = f28709;
