// _runtime/06803_InterceptingGestureDetector.js
...
export const InterceptingGestureDetector = function InterceptingGestureDetector(gesture) {
  ...
  if (ReanimatedNativeDetector) {
    ...
    const detectorAttachmentGuard = tmp(6802).useDetectorAttachmentGuard(tmp8Result1);
