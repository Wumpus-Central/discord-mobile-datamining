...
let items = [
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      let obj = arg0;
      if (!arg0) {
        obj = { email: "Array", id: "flexDirection", ip_address: "y", username: "HermesInternal" };
      }
      const self = this;
      this._user = obj;
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        Scope(842).updateSession(self._session, obj);
        const obj2 = Scope(842);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      Scope(841)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null, sampleRand: null };
      const obj2 = Scope(841);
      obj[0] = Scope(826).generateTraceId();
      const obj4 = Scope(826);
      obj[1] = Scope(828).safeMathRandom();
  ...
  },
  {
    ...
    value: function addBreadcrumb(message, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = Scope(835).dateTimestampInSeconds();
        const merged = Object.assign(message);
        if (message.message) {
          message = Scope(829).truncate(message.message, 2048);
          const tmp6Result = Scope(829);
        } else {
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, attributes: this._attributes, extra: this._extra, user: this._user, level: this._level, fingerprint: tmp, eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: Scope(841)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = Scope(843).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
  ...
  },
  {
    ...
    value: function captureException(arg0, event_id) {
      ...
      if (this._client) {
        ...
        if (Scope(820).DEBUG_BUILD) {
          const debug = Scope(821).debug;
