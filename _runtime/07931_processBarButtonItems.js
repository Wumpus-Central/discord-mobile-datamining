// _runtime/07931_processBarButtonItems.js
import ColorDefault from "05654_Color.js";
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const isSearchBarAvailableForCurrentPlatform = colors(4926).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = colors(4926).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      ...
      let tmp32Result = closure_12(colors(4926).ScreenStackHeaderLeftView, obj6);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj8.children = closure_10(colors(5645).HeaderTitle, obj9);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      headerTitleResult = closure_10(colors(5645).HeaderTitle, obj10);
    }
    const obj11 = { children: headerTitleResult };
    tmp38Result = closure_10(colors(4926).ScreenStackHeaderCenterView, obj11);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    const obj12 = { source };
    let tmp40Result = closure_10(colors(4926).ScreenStackHeaderBackButtonImage, obj12);
  } else {
    tmp40Result = null;
  }
  ...
  if (null != headerRightResult) {
    ...
    tmp42 = closure_10(colors(4926).ScreenStackHeaderRightView, obj13);
  }
  items7[2] = tmp42;
  let tmp44 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj14.children = closure_10(colors(4926).SearchBar, obj15);
    tmp44 = closure_10(colors(4926).ScreenStackHeaderSearchBarView, obj14);
  }
  items7[3] = tmp44;
  const obj16 = {
    ...
    largeTitleHideShadow: "gpt-5.6-luna",
    title: "GPT-5.6 Luna",
    titleColor: "openai",
    titleFontFamily: true,
    titleFontSize: "/assets/.cache/intl/ZGVzaWdu",
    titleFontWeight: null,
    topInsetEnabled: "86b91484df1ac0b8ccad956aae12b775",
    disableTopInsetApplication: "bg.messages.86b91484df1ac0b8ccad956aae12b775.compiled.messages",
    disableLeftInsetApplication: "jsona",
    disableRightInsetApplication: "gpt-6-astra",
    disableBottomInsetApplication: "GPT-6 Astra",
    translucent: "openai",
    children: true,
    headerLeftBarButtonItems: "/assets/.cache/intl/ZGVzaWdu",
    headerRightBarButtonItems: null,
    experimental_userInterfaceStyle: "72a624908b343db34ae78e6d520bec11",
  };
