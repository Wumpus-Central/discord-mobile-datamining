// _runtime/07009_convertToHandlerTag.js
...
let items = [
  ...fn(7010).baseGestureHandlerWithDetectorProps,
  ...fn(7011).tapGestureHandlerProps,
  ...fn(7021).panGestureHandlerProps,
  ...fn(7021).panGestureHandlerCustomNativeProps,
  ...fn(7022).longPressGestureHandlerProps,
  ...fn(7023).forceTouchGestureHandlerProps,
  ...fn(7025).flingGestureHandlerProps,
  ...fn(7026).hoverGestureHandlerProps,
  ...fn(7027).nativeViewGestureHandlerProps,
];
