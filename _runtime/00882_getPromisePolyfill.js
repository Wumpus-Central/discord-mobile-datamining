// _runtime/00882_getPromisePolyfill.js
...
import { valuePromise } from "00886_valuePromise.js";
import { items } from "00887_items.js";
...
arg5.polyfillPromise = function polyfillPromise() {
  if (require("00862_TurboModuleRegistry.js").ReactNativeLibraries.Utilities) {
    _require = tmp(886);
    tmp(883);
    tmp(885);
