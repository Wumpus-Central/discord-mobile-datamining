// _runtime/06997_RVLayoutManager.js
import _modDef6972 from "metro/06972__.js";
import _classCallCheck from "metro/06971__.js";
...
let items = [
  ...
  },
  {
    ...
    value: function getVisibleLayouts(bound1, arg1) {
      ...
      const findLastVisibleIndexResult = RVLayoutManager(6998).findLastVisibleIndex(
        this.layouts,
        arg1,
        this.horizontal,
      );
      if (-1 !== result) {
        if (-1 !== findLastVisibleIndexResult) {
          let EMPTY = new RVLayoutManager(6985).ConsecutiveNumbers(result, findLastVisibleIndexResult);
        }
        return EMPTY;
      }
      EMPTY = RVLayoutManager(6985).ConsecutiveNumbers.EMPTY;
      const obj2 = RVLayoutManager(6998);
    },
  },
  {
    key: "deleteLayout",
