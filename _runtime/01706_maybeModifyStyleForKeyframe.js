// _runtime/01706_maybeModifyStyleForKeyframe.js
...
import WebEasings from "01696_WebEasings.js";
import BaseAnimationBuilder from "01707_BaseAnimationBuilder.js";
import _mod1723 from "metro/01723__.js";
...
function setElementAnimation(cloneNodeResult, dummyAnimationConfig, arg2) {
  ...
  if (dummyAnimationConfig.animationType === require("metro/01662__.js").LayoutAnimationType.ENTERING) {
...
export const getReducedMotionFromConfig = function getReducedMotionFromConfig(entering) {
  if (entering.reduceMotionV) {
    ...
    if (_mod1662.ReduceMotion.Never === reduceMotionV) {
      return false;
    } else if (_mod1662.ReduceMotion.Always === reduceMotionV) {
      return true;
    } else {
...
export const handleLayoutTransition = function handleLayoutTransition(_componentDOMRef, processedConfig, easingY) {
  ...
  const TransitionGeneratorResult = tmp4(1725).TransitionGenerator(ENTRY_EXIT, easingY);
};
export const handleExitingAnimation = function handleExitingAnimation(offsetParent, processedConfig) {
  ...
  const snapshots2 = _mod1723.snapshots;
