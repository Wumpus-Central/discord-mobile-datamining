...
export const randomBytes = function randomBytes() {
  ...
  if (Hash(9286).crypto) {
    if (typeof Hash(9286).crypto.getRandomValues === "function") {
      const _crypto2 = Hash(9286).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(9286).crypto) {
    if (typeof Hash(9286).crypto.randomBytes === "function") {
      const _crypto = Hash(9286).crypto;
