    ...
    if (s.eq(10)) {
      ...
      if (Math.abs(tmp10) < 1500000000000000) {
        if (charAtResult >= 7) {
          ...
          const tmp36 = f111328(constructor2.minus(Decimal), constructor2.plus(Decimal), sum);
          times = tmp36.times;
...
const fn5 = function (arg0) {
  ...
  const tmp2 = f111328(this, constructor, 0, 1);
...
const fn14 = function (arg0) {
  ...
  if (self.s < 1) {
    ...
    if (self.eq(Decimal)) {
      ...
      constructor2 = f111328(ln(self, sum), ln(constructor, sum), sum);
      c2 = true;
...
const fn16 = function (arg0) {
  ...
  if (constructor.s) {
    if (self.s) {
      c2 = true;
      let minusResult = self.minus(f111328(self, tmp2, 0, 1).times(constructor));
      obj = f111328(self, tmp2, 0, 1);
    } else {
