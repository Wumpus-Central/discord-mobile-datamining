// _runtime/05283_get0thIfdOffset.js
import _modDef5266 from "metro/05266__.js";
import _modDef5280 from "metro/05280__.js";
import IFD_TYPE_0TH2 from "05284_IFD_TYPE_0TH.js";
...
function readTag(byteLength, IFD_TYPE_0TH, sum, sum, byteOrder, arg5) {
  ...
  if (undefined !== _modDef5280.typeSizes[shortAt1]) {
    if (
      ...
      const longAt1 = _modDef5280.getLongAt(byteLength, sum + sum1, byteOrder);
      str = "<faulty value>";
      tmp21 = longAt1;
      if (
      ...
      const tmp4Result = _modDef5280;
    }
    let tmp34 = str;
    if (shortAt1 === _modDef5280.tagTypes.ASCII) {
    ...
    if (undefined !== IFD_TYPE_0THDefault[IFD_TYPE_0TH][shortAt]) {
      ...
      if (shortAt1 !== _modDef5280.tagTypes.RATIONAL) {
        if (shortAt1 !== _modDef5280.tagTypes.SRATIONAL) {
...
let obj = {
  1: null,
  2: _modDef5280.getByteAt,
  3: _modDef5280.getAsciiAt,
  4: _modDef5280.getShortAt,
  5: _modDef5280.getLongAt,
  7: _modDef5280.getRationalAt,
  9: null,
  10: _modDef5280.getUndefinedAt,
  13: null,
};
