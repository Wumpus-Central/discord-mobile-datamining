...
let obj = { name: _mod1110.SDK_NAME, packages: null, version: null };
obj = { name: _mod1110.SDK_PACKAGE_NAME, version: _mod1110.SDK_VERSION };
let items = [obj];
obj[1] = items;
obj[2] = _mod1110.SDK_VERSION;
