// _runtime/14341_SetNumberFormatDigitOptions.js
import _mod14294 from "metro/14294__.js";
import GetNumberOption from "14297_GetNumberOption.js";
import DefaultNumberOption from "14298_DefaultNumberOption.js";
...
export const SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(
  ...
  if (flag) {
    if (tmp12) {
      ...
      if (undefined === DefaultNumberOptionResult) {
        _mod14294.invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      _mod14294.invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
