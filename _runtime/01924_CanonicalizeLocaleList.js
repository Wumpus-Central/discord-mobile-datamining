// _runtime/01924_CanonicalizeLocaleList.js
import expBCP47Syntax2 from "01925_expBCP47Syntax.js";
import _mod1926 from "metro/01926__.js";
              ...
              if (typeof tmp4 === "string") {
                ...
                if (isMatch1) {
                  ...
                  if (!tmp20) {
                    ...
                    if (-1 === (typeof call8 === "unknown" ? closure_7(tmp48) : call8(obj2, tmp48))) {
                      let call9 = push.call;
                    ...
                    let _RegExp = RegExp;
                    let call2 = join.call;
                    let RegExpResult = RegExp(`(?:${tmp17(1925).expExtSequences.source})+`, "i");
...
function InitializeNumberFormat(__getInternalProperties, arg1, arg2) {
  ...
  if (true === result["[[initializedIntlObject]]"]) {
    ...
    if (undefined !== localeMatcher) {
      ...
      str5 = StringResult;
      if (-1 === (typeof call3 === "unknown" ? closure_7(StringResult) : call3(obj9, StringResult))) {
    ...
    if (undefined !== style) {
      ...
      str9 = StringResult1;
      if (-1 === (typeof call4 === "unknown" ? closure_7(StringResult1) : call4(obj10, StringResult1))) {
    ...
    if (undefined !== currencyDisplay) {
      ...
      str17 = StringResult4;
      if (-1 === (typeof call5 === "unknown" ? closure_7(StringResult4) : call5(obj11, StringResult4))) {
...
function FormatNumber(numberFormat, diff) {
  ...
  const tmp10 =
    closure_15.NumberFormat["[[localeData]]"][result["[[dataLocale]]"]].symbols[prop] ||
  ...
  if (false === isFinite(diff)) {
    ...
    if (typeof call2 === "unknown") {
      let tmp2Result3 = hasOwnProperty("[[minimumSignificantDigits]]");
    } else {
    ...
    if (tmp2Result3) {
      ...
      if (typeof call3 === "unknown") {
        let tmp2Result4 = hasOwnProperty("[[maximumSignificantDigits]]");
      } else {
...
function InitializeDateTimeFormat(prototype, arg1, arg2) {
  ...
  if (true === result["[[initializedIntlObject]]"]) {
    ...
    if (undefined !== localeMatcher) {
      ...
      const call3 = closure_7.call;
      str4 = StringResult;
      if (-1 === (typeof call3 === "unknown" ? closure_7(StringResult) : call3(obj10, StringResult))) {
        const _RangeError4 = RangeError;
        const rangeError = new RangeError("'" + StringResult + "' is not an allowed value for `localeMatcher`");
        throw rangeError;
      }
    ...
    if ("[object Array]" !== (typeof call6 === "unknown" ? toString() : call6(formats))) {
      dateTimeFormats = _mod1926.createDateTimeFormats(formats);
    }
    obj10 = Object.create(List.prototype);
    List("basic", "best fit");
    ...
    if (undefined !== formatMatcher) {
      ...
      str15 = StringResult2;
      if (-1 === (typeof call7 === "unknown" ? closure_7(StringResult2) : call7(obj13, StringResult2))) {
        const _RangeError2 = RangeError;
...
function ToDateTimeOptions(arg0, any, date) {
  ...
  if (!tmp16) {
    ...
    const tmp17 =
      undefined === date.weekday && undefined === date.year && undefined === date.month && undefined === date.day;
  }
  let flag = true;
  if (!tmp16) {
    flag = false;
...
class List {
  constructor() {
    tmp = f24983(this, "length", { writable: true, value: 0 });
    if (!arguments.length) {
      return;
    } else {
      tmp3 = slice;
...
fn(obj.NumberFormat, "supportedLocalesOf", {
  configurable: true,
  writable: true,
  ...
  value() {
    ...
    for (const key10019 in obj11.Date) {
      ...
      if (!callResult) {
        ...
        let _Date = Date;
        let obj3 = { writable: true, configurable: true, value: obj11.Date[key10019] };
        let tmp5 = fn(Date.prototype, key10019, obj3);
        continue;
      }
      continue;
    }
    obj = { writable: true, configurable: true, value: obj11.Number.toLocaleString };
    obj2 = { writable: true, configurable: true, value: obj11.Date.toLocaleString };
  },
});
