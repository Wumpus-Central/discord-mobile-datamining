// _runtime/07489_NativeModules.js
...
const subs = require("module_7490").ProductType.subs;
const inapp = require("module_7490").ProductType.inapp;
...
export const isIosStorekit2 = require("module_7491").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    07491__.storekit1Mode();
    const obj4 = 07491__;
  } else if ("STOREKIT2_MODE" === str) {
    07491__.storekit2Mode();
    const obj3 = 07491__;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    07491__.storekitHybridMode();
    const obj2 = 07491__;
  }
};
export const initConnection = () => {
  const nativeModule = 07491__.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = 07491__.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      let closure_1 = tmp5;
      let closure_0 = tmp2;
      const obj3 = outer1_0(7491);
      const androidModule = obj3.getAndroidModule();
      yield androidModule.getItemsByType(outer1_7, outer1_0);
      closure_0 = arg1.map(outer1_0(7496).singleProductAndroidMap);
      const obj = outer1_0(7491);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      ...
      androidModuleType = outer1_0(7491).getAndroidModuleType();
      const obj10 = outer1_0(7491);
      const androidModule = outer1_0(7491).getAndroidModule();
      const outer1_1 = yield androidModule.getItemsByType(outer1_6, outer1_0);
      if ("android" === outer1_0) {
        return outer1_8(outer1_1, outer1_0(7490).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      const obj2 = outer1_0(7491);
      let closure_2 = yield obj2.fillProductsWithAdditionalData(dependencyMap);
      return outer1_8(closure_2, outer1_0(7490).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
