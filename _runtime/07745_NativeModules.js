// === Module 7745: NativeModules ===

// Module 7745 (NativeModules)
import _mod7747 from "module_7747" /* 7747 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 7753 */;
import NativeModulesAll from "NativeModules" /* 7754 */;
import fetchJsonOrThrowAll from "fetchJsonOrThrow" /* 7755 */;
import syncAll from "sync" /* 7756 */;
...
const subs = require("module_7746").ProductType.subs;
const inapp = require("module_7746").ProductType.inapp;
...
export const isIosStorekit2 = require("module_7747").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
