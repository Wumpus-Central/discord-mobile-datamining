// _runtime/07745_NativeModules.js
import _mod7747 from "metro/07747__.js";
import RNIapAmazonModuleAll from "07753_RNIapAmazonModule.js";
import NativeModulesAll from "07754_NativeModules.js";
import fetchJsonOrThrowAll from "07755_fetchJsonOrThrow.js";
import syncAll from "07756_sync.js";
...
const subs = require("metro/07746__.js").ProductType.subs;
const inapp = require("metro/07746__.js").ProductType.inapp;
...
export const isIosStorekit2 = require("metro/07747__.js").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod7747.storekit1Mode();
    const obj4 = _mod7747;
  } else if ("STOREKIT2_MODE" === str) {
    _mod7747.storekit2Mode();
    const obj3 = _mod7747;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod7747.storekitHybridMode();
    const obj2 = _mod7747;
  }
};
export const initConnection = () => {
  const nativeModule = _mod7747.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod7747.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      closure_1 = tmp5;
      closure_0 = tmp2;
      const obj3 = closure_1_0(7747);
      const androidModule = obj3.getAndroidModule();
      yield androidModule.getItemsByType(closure_1_7, closure_1_0);
      closure_0 = arg1.map(closure_1_0(7752).singleProductAndroidMap);
      const obj = closure_1_0(7747);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      ...
      androidModuleType = closure_1_0(7747).getAndroidModuleType();
      const obj10 = closure_1_0(7747);
      const androidModule = closure_1_0(7747).getAndroidModule();
      closure_1 = yield androidModule.getItemsByType(closure_1_6, closure_1_0);
      if ("android" === closure_1_0) {
        return closure_1_8(closure_1, closure_1_0(7746).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      const obj2 = closure_1_0(7747);
      dependencyMap = yield obj2.fillProductsWithAdditionalData(dependencyMap);
      return closure_1_8(dependencyMap, closure_1_0(7746).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
