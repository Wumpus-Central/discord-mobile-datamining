...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(_require(5633).SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = _require(1652).useSharedValue(0);
  const obj2 = _require(1652);
  const sharedValue2 = _require(1652).useSharedValue(_require(5633).SCROLLABLE_STATE.UNDETERMINED);
