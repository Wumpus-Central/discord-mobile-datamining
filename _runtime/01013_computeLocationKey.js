...
import __SENTRY_DEBUG__ from "metro/01007___SENTRY_DEBUG__.js";
...
function setupRouterSubscription(subscribe) {
  ...
  let tmp = arg4;
  if (tmp) {
    tmp = "pageload" === require("00682_registerSpanErrorInstrumentation.js").spanToJSON(arg4).op;
...
function patchSpanEnd(result2, _location, routes, basename, allRoutes, navigation) {
  ...
  if (!tmp2) {
    if (result2.end) {
      ...
      const result = require("00682_registerSpanErrorInstrumentation.js").addNonEnumerableProperty(result2, combined, true);
      let obj = registerSpanErrorInstrumentation;
    }
  }
}
...
export const createV6CompatibleWithSentryReactRouterRouting = function createV6CompatibleWithSentryReactRouterRouting(arg0, _6) {
      ...
      if (closure_6) {
        if (closure_7) {
          if (closure_8) {
            ...
            require("01005_getStatics.js").hoistNonReactStatics(SentryRoutes, arg0);
            return SentryRoutes;
          }
        }
      }
  ...
  if (require("metro/01007___SENTRY_DEBUG__.js").DEBUG_BUILD) {
    class SentryRoutes {
      constructor(arg0) {
        closure_0 = arg0;
        closure_1 = closure_1_9.useRef(true);
