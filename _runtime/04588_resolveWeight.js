...
fn(17).Image;
const NitroModules = fn(4558).NitroModules;
        ...
        if (arg0 === 1) {
          ...
          if (closure_0 instanceof ArrayBuffer) {
            ...
            if (uri) {
              ...
              const error = new Error("Invalid font asset: could not resolve require() ID " + closure_0 + ". Ensure 'ttf' is in metro.config.js assetExts.");
              throw error;
            }
          } else {
