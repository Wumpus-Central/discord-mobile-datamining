// _runtime/05305_HeaderBackButton.js
import _slicedToArray from "_slicedToArray";
import noop from "noop";
import get_ActivityIndicator from "get ActivityIndicator";
import jsxProd from "jsxProd";
import { createStandardNavigationFactories } from "01481_createStandardNavigationFactories.js";
import { registerAsset } from "05277_registerAsset.js";
import { HeaderButton } from "05311_HeaderButton.js";
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5306).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5306).ICON_MARGIN);
      }
    }
