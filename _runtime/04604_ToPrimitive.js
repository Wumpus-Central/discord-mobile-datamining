// _runtime/04604_ToPrimitive.js
import { apply } from "01421_apply.js";
import { isPrimitive } from "04605_isPrimitive.js";
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4607)(arg0) || tmp(4606)(arg0);
          const tmp15 = tmp(4607)(arg0) || tmp(4606)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
