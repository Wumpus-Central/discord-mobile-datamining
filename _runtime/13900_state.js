...
import _mod13884 from "metro/13884__.js";
import all from "13901_all.js";
import __core_js_shared__2 from "13902___core-js_shared__.js";
  ...
  if (!__core_js_shared__.state) {
    ...
    let fn = function t(facade) {
      if (call(facade, closure_6)) {
        const typeError = new tmp(13839).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(13895)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
...
if (!state) {
  ...
  const weakMap = new _mod13839.WeakMap();
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new _mod13839.TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
