// _runtime/07000_RVLayoutManager.js
...
let items = [
  ...
  },
  {
    ...
    value: function getVisibleLayouts(bound1, arg1) {
      ...
      const findLastVisibleIndexResult = RVLayoutManager(7001).findLastVisibleIndex(
        this.layouts,
        arg1,
        this.horizontal,
      );
      if (-1 !== result) {
        if (-1 !== findLastVisibleIndexResult) {
          let EMPTY = new RVLayoutManager(6988).ConsecutiveNumbers(result, findLastVisibleIndexResult);
        }
        return EMPTY;
      }
      EMPTY = RVLayoutManager(6988).ConsecutiveNumbers.EMPTY;
      const obj2 = RVLayoutManager(7001);
    },
  },
  {
    key: "deleteLayout",
