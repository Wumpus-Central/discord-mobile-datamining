// _runtime/13574_addLikelySubtags.js
import getInternalSlots2 from "13575_getInternalSlots.js";
import isStructurallyValidLanguageTag from "13640_isStructurallyValidLanguageTag.js";
...
let tmp2 = (() => {
  ...
  let obj = {
    get() {
      return Locale(13640).emitUnicodeLanguageId(Locale(13640).parseUnicodeLanguageId(closure_2.default(this).locale));
    },
    enumerable: false,
    configurable: true
  };
  ...
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(13640).parseUnicodeLanguageId(closure_2.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(13640).parseUnicodeLanguageId(closure_2.default(this).locale).script;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(13640).parseUnicodeLanguageId(closure_2.default(this).locale).region;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      ...
      if (Locale(13576).HasOwnProperty(defaultResult, "initializedLocale")) {
