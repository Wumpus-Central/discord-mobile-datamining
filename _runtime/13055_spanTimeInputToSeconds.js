// _runtime/13055_spanTimeInputToSeconds.js
...
import _mod13064 from "metro/13064__.js";
import _mod13065 from "metro/13065__.js";
import _mod13066 from "metro/13066__.js";
import _mod13067 from "metro/13067__.js";
import _mod13068 from "metro/13068__.js";
import _mod13069 from "metro/13069__.js";
import _mod13072 from "metro/13072__.js";
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod13067.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod13067.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod13056.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod13056.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
...
export const getActiveSpan = function getActiveSpan() {
  ...
  if (asyncContextStrategy.getActiveSpan) {
    ...
    activeSpan = tmpResult._getSpanForScope(_mod13077.getCurrentScope());
