// _runtime/07825_applyClientOptions.js
import isMatchingPattern from "07785_isMatchingPattern.js";
import _mod7813 from "metro/07813__.js";
...
function applyDebugIds(exception) {
  _require = require("07828_getFilenameToDebugIdMap.js").getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(7821).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(7821);
                }
