// _runtime/07243_ViewHolderCollection.js
import ViewHolder from "07241_ViewHolder.js";
import _slicedToArray from "metro/07187__.js";
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(7206).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7237).CompatView, { style: tmp19, children: null });
};
