// _runtime/07129_CardContainer.js
import Link from "01485_Link.js";
import _mod5716 from "metro/05716__.js";
import ModalPresentationContext from "07119_ModalPresentationContext.js";
import _mod7130 from "metro/07130__.js";
import CardA11yWrapper from "07131_CardA11yWrapper.js";
import _mod7132 from "metro/07132__.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5716.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5716;
  }
  closure_15 = tmp12;
