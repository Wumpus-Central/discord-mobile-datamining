// _runtime/06429_HeaderContainer.js
import Link from "01486_Link.js";
import _mod5943 from "metro/05943__.js";
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = {
                  title: require("metro/05943__.js").getHeaderTitle(tmp11, route.name),
                  href: buildHref(route.name, route.params),
                };
                tmp9 = obj2;
                const obj3 = require("metro/05943__.js");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("metro/06430__.js").forSlideRight;
                    } else {
                      forSlideUp = require("metro/06430__.js").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("metro/06430__.js").forSlideUp;
              }
            } else {
              forNoAnimation = require("metro/06430__.js").forNoAnimation;
            }
