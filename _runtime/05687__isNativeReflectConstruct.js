...
import get_ActivityIndicatorDefault from "get ActivityIndicator" /* 5695 */;
...
let closure_10 = { [arg1(5666).State.UNDETERMINED]: undefined, [arg1(5666).State.BEGAN]: "onBegan", [arg1(5666).State.FAILED]: "onFailed", [arg1(5666).State.CANCELLED]: "onCancelled", [arg1(5666).State.ACTIVE]: "onActivated", [arg1(5666).State.END]: "onEnded" };
