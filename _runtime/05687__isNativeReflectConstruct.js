// _runtime/05687__isNativeReflectConstruct.js
import map from "05664_map.js";
import transformIntoHandlerTags from "05691_transformIntoHandlerTags.js";
import _mod5692 from "metro/05692__.js";
import get_ActivityIndicatorDefault from "05695_get_ActivityIndicator.js";
...
let closure_10 = {
  [arg1(5666).State.UNDETERMINED]: undefined,
  [arg1(5666).State.BEGAN]: "onBegan",
  [arg1(5666).State.FAILED]: "onFailed",
  [arg1(5666).State.CANCELLED]: "onCancelled",
  [arg1(5666).State.ACTIVE]: "onActivated",
  [arg1(5666).State.END]: "onEnded",
};
