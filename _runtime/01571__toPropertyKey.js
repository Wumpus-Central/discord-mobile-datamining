// _runtime/01571__toPropertyKey.js
...
export const useDescriptors = function useDescriptors(state) {
  ...
  const navigationCache = state(1572).useNavigationCache({
    state,
    getState,
    navigation,
    setOptions: tmp2,
  ...
  function render(route, navigation, options, routeState) {
    ...
    const obj3 = {
      value,
      children: onAction(state(1526).NavigationProvider, { route, navigation, children: layoutResult }),
    };
