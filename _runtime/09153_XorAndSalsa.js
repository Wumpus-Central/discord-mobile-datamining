// _runtime/09153_XorAndSalsa.js
import _asyncLoop from "09154__asyncLoop.js";
import number from "09155_number.js";
import pbkdf2Init from "09157_pbkdf2Init.js";
import _mod9159 from "metro/09159__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod9159.sha256, B, B, obj2);
