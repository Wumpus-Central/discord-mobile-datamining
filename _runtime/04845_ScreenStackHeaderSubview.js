// _runtime/04845_ScreenStackHeaderSubview.js
import noopDefault from "00019_noop.js";
import get_controlledBottomTabsDefault from "04843_get_controlledBottomTabs.js";
import context from "04846_context.js";
import __INTERNAL_VIEW_CONFIGDefault from "metro/04849___INTERNAL_VIEW_CONFIG.js";
...
const forwardRefResult = noopDefault.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4842).isHeaderBarButtonsAvailableForCurrentPlatform) {
      let tmpResult = tmp(4847);
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4842).isHeaderBarButtonsAvailableForCurrentPlatform;
