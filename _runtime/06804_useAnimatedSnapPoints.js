// _runtime/06804_useAnimatedSnapPoints.js
...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: require("06631_DEFAULT_HANDLE_HEIGHT.js").INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: require("06631_DEFAULT_HANDLE_HEIGHT.js").INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: require("06644_normalizeSnapPoint.js").normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: require("06631_DEFAULT_HANDLE_HEIGHT.js").INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
  ...
  const derivedValue = require("01636_cancelAnimation.js").useDerivedValue(P, items);
  ...
  class N {
    constructor() {
      if (closure_4) {
        ...
        tmp = !length;
        if (length) {
          tmp = !items.find(/* F110792 */ function() { ... });
        }
        return !tmp;
      }
    }
  ...
  let items1 = [derivedValue, sharedValue, require("01636_cancelAnimation.js").useDerivedValue(N)];
  return items1;
};