// _runtime/04203_defaultOnError.js
import _mod4204 from "metro/04204__.js";
...
function defaultOnError(message) {
  return console.error("[" + _mod4204.RiveErrorType[message.type] + "] " + message.message);
}
...
export const RiveView = function RiveView(arg0) {
  ...
  const tmp18 = jsx(require("04181_NitroRiveView.js").NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
