// _runtime/05501_traverseAndConfigureRelations.js
import { tagMessage } from "05432_tagMessage.js";
import { isComposedGesture } from "05494_isComposedGesture.js";
const require = arg1;
...
function traverseAndConfigureRelations(gestures, map, set) {
  ...
  if (obj.isComposedGesture(gestures)) {
    ...
    gestures.gestureRelations = tmp(5494).prepareRelations(gestures.config, gestures.handlerTag);
...
arg5.configureRelations = function configureRelations(externalSimultaneousHandlers) {
  ...
  if (obj2.isComposedGesture(externalSimultaneousHandlers)) {
    ...
    if (externalSimultaneousHandlers.type === set(5486).ComposedGestureName.Simultaneous) {
