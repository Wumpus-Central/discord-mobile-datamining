...
const tmp2 = require("get BatchedBridge")("RCTText", () => require("00103_createViewConfig.js") /* createViewConfig */.createViewConfig(closure_2));
if (global.RN$Bridgeless) {
  let tmp3 = require("get BatchedBridge")("RCTVirtualText", () => require("00103_createViewConfig.js") /* createViewConfig */.createViewConfig(closure_3));
} else {
  tmp3 = tmp2;
...
if (javaScriptFlagGetter.enablePreparedTextLayout()) {
  tmp4 = require("get BatchedBridge")("RCTSelectableText", () => {
    let obj = require("00103_createViewConfig.js") /* createViewConfig */;
    obj = {};
