...
const tmp2 = require("get BatchedBridge")("RCTText", () => createViewConfig.createViewConfig(closure_2));
if (global.RN$Bridgeless) {
  let tmp3 = require("get BatchedBridge")("RCTVirtualText", () => createViewConfig.createViewConfig(closure_3));
} else {
  tmp3 = tmp2;
