// _runtime/09245_XorAndSalsa.js
import asyncGeneratorStep from "asyncGeneratorStep";
import { _asyncLoop } from "09246__asyncLoop.js";
import { pbkdf2Init } from "09249_pbkdf2Init.js";
import { _isNativeReflectConstruct } from "09251__isNativeReflectConstruct.js";
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9246).isLE) {
                callback(9246).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
