// _runtime/04033_defaultOnError.js
import _objectWithoutProperties from "_objectWithoutProperties";
import noop from "noop";
import { jsx } from "jsxProd";
import { NitroRiveView } from "04015_NitroRiveView.js";
...
function defaultOnError(message) {
  return console.error("[" + 04034__.RiveErrorType[message.type] + "] " + message.message);
}
