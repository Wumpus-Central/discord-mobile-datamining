// _runtime/06461_extraErrorDataIntegration.js
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (!tmp24) {
                if (typeof originalException.toJSON !== "disabledUntil") {
              ...
              if (callback(6399).DEBUG_BUILD) {
                const logger = callback(6371).logger;
