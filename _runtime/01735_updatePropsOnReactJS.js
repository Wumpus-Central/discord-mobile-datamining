// _runtime/01735_updatePropsOnReactJS.js
...
import { validateTransformOrigin } from "01736_validateTransformOrigin.js";
import { map } from "01737_map.js";
...
if (isJest.shouldBeUseWeb()) {
  function maybeThrowError() {
    if (!obj.isJest()) {
      const reanimatedError = new tmp(1645).ReanimatedError("`UpdatePropsManager` is not available on non-native platform.");
