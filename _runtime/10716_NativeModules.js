// _runtime/10716_NativeModules.js
import _mod10718 from "metro/10718__.js";
import RNIapAmazonModuleAll from "10724_RNIapAmazonModule.js";
import NativeModulesAll from "10725_NativeModules.js";
import fetchJsonOrThrowAll from "10726_fetchJsonOrThrow.js";
import syncAll from "10727_sync.js";
...
const subs = require("metro/10717__.js").ProductType.subs;
const inapp = require("metro/10717__.js").ProductType.inapp;
...
export const isIosStorekit2 = require("metro/10718__.js").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod10718.storekit1Mode();
    const obj4 = _mod10718;
  } else if ("STOREKIT2_MODE" === str) {
    _mod10718.storekit2Mode();
    const obj3 = _mod10718;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod10718.storekitHybridMode();
    const obj2 = _mod10718;
  }
};
export const initConnection = () => {
  const nativeModule = _mod10718.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod10718.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      closure_1 = tmp5;
      closure_0 = tmp2;
      const obj3 = closure_1_0(10718);
      const androidModule = obj3.getAndroidModule();
      yield androidModule.getItemsByType(closure_1_7, closure_1_0);
      closure_0 = arg1.map(closure_1_0(10723).singleProductAndroidMap);
      const obj = closure_1_0(10718);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function*() {
      ...
      androidModuleType = closure_1_0(10718).getAndroidModuleType();
      const obj10 = closure_1_0(10718);
      const androidModule = closure_1_0(10718).getAndroidModule();
      closure_1 = yield androidModule.getItemsByType(closure_1_6, closure_1_0);
      if ("android" === closure_1_0) {
        return closure_1_8(closure_1, closure_1_0(10717).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      const obj2 = closure_1_0(10718);
      dependencyMap = yield obj2.fillProductsWithAdditionalData(dependencyMap);
      return closure_1_8(dependencyMap, closure_1_0(10717).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
