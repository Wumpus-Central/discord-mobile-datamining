// === Module 10716: NativeModules ===

// Module 10716 (NativeModules)
import _mod10718 from "module_10718" /* 10718 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 10724 */;
import NativeModulesAll from "NativeModules" /* 10725 */;
import fetchJsonOrThrowAll from "fetchJsonOrThrow" /* 10726 */;
import syncAll from "sync" /* 10727 */;
...
const subs = require("module_10717").ProductType.subs;
const inapp = require("module_10717").ProductType.inapp;
...
export const isIosStorekit2 = require("module_10718").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
