// _runtime/05423_load.js
import _modDef5424 from "metro/05424__.js";
...
function loadView(byteLength) {
  ...
  let obj2 = require("metro/05427__.js");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("metro/05427__.js").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("metro/05428__.js").USE_JPEG) {
    flag4 = false;
  ...
  const parseAppMarkersResult = require("metro/05427__.js").parseAppMarkers(byteLength, flag2);
