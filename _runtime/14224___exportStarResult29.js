// _runtime/14224___exportStarResult29.js
...
export const ToRawPrecision = function ToRawPrecision(
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(14206).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(14206).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(14206).repeat("0", -num3 - 1)}${arr}`;
