// _runtime/05490_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05497_AudioTypes.js";
import ImageTypes from "05498_ImageTypes.js";
import VideoTypes from "05499_VideoTypes.js";
import CompressedTypes from "05500_CompressedTypes.js";
import OtherTypes from "05501_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5491).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5491).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5491).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5491).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
