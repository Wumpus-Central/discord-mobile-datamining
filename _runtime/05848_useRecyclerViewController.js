// === Module 5848: useRecyclerViewController ===

// Module 5848 (useRecyclerViewController)
import closure_2 from "asyncGeneratorStep" /* 5849 */;
import closure_3 from "_slicedToArray" /* 5806 */;
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  dependencyMap = arg2;
  closure_2 = arg3;
  const unmountFlag = _require(5850).useUnmountFlag();
  let obj = _require(5850);
  ...
  _setTimeout = _require(5851).useUnmountAwareTimeout().setTimeout;
