...
import _mod13088 from "metro/13088__.js";
  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/13066__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/13067__.js").DEBUG_BUILD) {
            const logger = require("metro/13039__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/13066__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const captureException = function captureException(arg0, captureContext) {
  const currentScope = _mod13066.getCurrentScope();
  return currentScope.captureException(arg0, _mod13088.parseEventHintOrCaptureContext(captureContext));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = _mod13076.DEFAULT_ENVIRONMENT;
  }
  ...
  if (tmp10) {
    _mod13062.updateSession(session1, { status: "exited" });
    const tmpResult2 = _mod13062;
  }
  endSession();
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod13053.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod13066.getCurrentScope();
    const client = _mod13066.getClient();
    if (client) {
    ...
    _mod13050.uuid4();
    const tmpResult = _mod13050;
  }
  let currentScope = require("metro/13066__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/13066__.js");
  let client = require("metro/13066__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/13066__.js");
  captureCheckInResult = require("metro/13050__.js").uuid4();
};
