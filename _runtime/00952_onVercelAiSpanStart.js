// _runtime/00952_onVercelAiSpanStart.js
import spanToJSON from "00816_spanToJSON.js";
import _mod953 from "metro/00953__.js";
import convertPromptToMessages from "00954_convertPromptToMessages.js";
    ...
    if (startsWithResult) {
      ...
      if (tmp17) {
        const attr6 = setAttribute.setAttribute(
          tmp3(955).GEN_AI_RESPONSE_MODEL_ATTRIBUTE,
          data[tmp3(undefined, 953).AI_MODEL_ID_ATTRIBUTE],
        );
      }
      ...
      tmp17 =
        data[tmp3(undefined, 953).AI_MODEL_ID_ATTRIBUTE] && !data[tmp3(undefined, 955).GEN_AI_RESPONSE_MODEL_ATTRIBUTE];
    }
  }
}
...
function processEndedVercelAiSpan(item10015) {
  ...
  if ("auto.vercelai.otel" === item10015.origin) {
    renameAttributeKey(
      data,
      _mod953.AI_USAGE_COMPLETION_TOKENS_ATTRIBUTE,
      _mod955.GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE,
    );
    renameAttributeKey(data, _mod953.AI_USAGE_PROMPT_TOKENS_ATTRIBUTE, _mod955.GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE);
    renameAttributeKey(
      data,
      _mod953.AI_USAGE_CACHED_INPUT_TOKENS_ATTRIBUTE,
      _mod955.GEN_AI_USAGE_INPUT_TOKENS_CACHED_ATTRIBUTE,
    );
    ...
    if (tmp35) {
      data[tmp29(955).GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE] =
        data[tmp29(undefined, 955).GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE] +
        data[tmp29(undefined, 955).GEN_AI_USAGE_INPUT_TOKENS_CACHED_ATTRIBUTE];
    }
    ...
    if (tmp2) {
      data["gen_ai.usage.total_tokens"] =
        data[tmp29(undefined, 955).GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE] +
        data[tmp29(undefined, 955).GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE];
    }
    ...
    if (isArray) {
      data[tmp29(953).AI_PROMPT_TOOLS_ATTRIBUTE] = tmp29(954).convertAvailableToolsToJsonString(
        data[tmp29(undefined, 953).AI_PROMPT_TOOLS_ATTRIBUTE],
      );
