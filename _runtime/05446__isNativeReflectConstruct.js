// _runtime/05446__isNativeReflectConstruct.js
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      let obj = ContinousBaseGesture(5428);
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5411).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(5411);
      }
      return tmp;
    }
  }
