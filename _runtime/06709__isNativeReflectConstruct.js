// === Module 6709: _isNativeReflectConstruct ===
...
import { Reanimated } from "module_6698" /* 6698 */;
...
const items = [
  {
    ...
    value: function render() {
      try {
        ...
        const _Error = Error;
        error = new Error(Wrap(6660).tagMessage("GestureDetector got more than one view as a child. If you want the gesture to work on multiple views, wrap them with a common parent and attach the gesture to that view."));
        throw error;
      }
    }
  }
