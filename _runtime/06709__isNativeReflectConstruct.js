// _runtime/06709__isNativeReflectConstruct.js
...
import _isNativeReflectConstructDefault2 from "06706__isNativeReflectConstruct.js";
import __INTERNAL_VIEW_CONFIGDefault from "metro/06710___INTERNAL_VIEW_CONFIG.js";
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(6623).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
