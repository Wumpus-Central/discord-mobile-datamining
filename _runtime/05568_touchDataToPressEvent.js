// _runtime/05568_touchDataToPressEvent.js
...
arg5.viewCenterToPressableEvent = (width) => {
  ...
  return { nativeEvent: { touches, changedTouches, identifier: 0, locationX, locationY, pageX: -1, pageY: -1, target: 0, timestamp, force: "r" } };
};