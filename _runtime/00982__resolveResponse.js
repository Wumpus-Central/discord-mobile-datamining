// _runtime/00982__resolveResponse.js
import isInstanceOf from "00824_isInstanceOf.js";
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  ...
  addHandler.maybeInstrument("fetch-body-resolved", () => {
    ...
    {
      callback(819).fill(callback(818).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  require("00847_addHandler.js").addHandler("fetch", arg0);
  let obj = addHandler;
  require("00847_addHandler.js").maybeInstrument("fetch", () => {
    let flag = callback;
