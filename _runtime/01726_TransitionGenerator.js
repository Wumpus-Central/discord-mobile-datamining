// _runtime/01726_TransitionGenerator.js
import TransitionType from "01694_TransitionType.js";
import convertAnimationObjectToKeyframes from "01696_convertAnimationObjectToKeyframes.js";
import findDescendantWithExitingAnimation from "01725_findDescendantWithExitingAnimation.js";
import LinearTransition from "01727_LinearTransition.js";
import SequencedTransition from "01728_SequencedTransition.js";
import FadingTransition from "01729_FadingTransition.js";
import JumpingTransition from "01730_JumpingTransition.js";
import prepareCurvedTransition from "01731_prepareCurvedTransition.js";
import _mod1732 from "metro/01732__.js";
...
export const TransitionGenerator = function TransitionGenerator(ENTRY_EXIT, easingY) {
  ...
  if (TransitionType.TransitionType.LINEAR === ENTRY_EXIT) {
    ...
    firstKeyframeObj = _mod1732.EntryExitTransition(`REA${tmp}`, easingY);
    const tmp3Result16 = _mod1732;
  }
