// _runtime/05412_HeaderBackButton.js
import createStandardNavigationFactories from "01501_createStandardNavigationFactories.js";
import registerAssetDefault from "05384_registerAsset.js";
import HeaderButton from "05418_HeaderButton.js";
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5413).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5413).ICON_MARGIN);
      }
    }
