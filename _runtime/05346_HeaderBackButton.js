// _runtime/05346_HeaderBackButton.js
import _slicedToArray from "_slicedToArray";
import noop from "noop";
import get_ActivityIndicator from "get ActivityIndicator";
import jsxProd from "jsxProd";
import { createStandardNavigationFactories } from "01500_createStandardNavigationFactories.js";
import { registerAsset } from "05318_registerAsset.js";
import { HeaderButton } from "05352_HeaderButton.js";
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(5347).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(5347).ICON_MARGIN);
      }
    }
