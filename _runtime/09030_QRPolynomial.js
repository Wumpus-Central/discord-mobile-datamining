// _runtime/09030_QRPolynomial.js
import { 09031__ } from "metro/09031__.js";
class QRPolynomial {
...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = 09031__;
      const glogResult = 09031__.glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - 09031__.glog(getLength.get(0));
