// _runtime/13368__isNativeReflectConstruct.js
...
let items = [
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items4 = [PaginationDot(13369).sliderPaginationDotContainer, ];
      if (!containerStyle) {
        containerStyle = {};
      }
      items4[1] = containerStyle;
      const items5 = [PaginationDot(13369).sliderPaginationDot, , , , ];
      if (!style) {
        style = {};
      }
      items5[1] = style;
