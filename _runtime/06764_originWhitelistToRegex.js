// _runtime/06764_originWhitelistToRegex.js
...
function originWhitelistToRegex(arg0) {
  return "^".concat(importDefault(6765)(arg0).replace(/\\\*/g, ".*"));
}
...
export const defaultRenderLoading = () => callback(closure_7, { style: importDefault(6766).loadingOrErrorView, children: callback(closure_8, {}) });
export const defaultRenderError = (arg0, arg1, arg2) => {
  let obj = { style: importDefault(6766).loadingOrErrorView, children: null };
  obj = { style: importDefault(6766).errorTextTitle, children: "Error loading page" };
  const items = [callback(closure_9, obj), , , ];
  obj = { style: importDefault(6766).errorText, children: "Domain: ".concat(arg0) };
  items[1] = callback(closure_9, obj);
  items[2] = callback(closure_9, { style: importDefault(6766).errorText, children: "Error Code: ".concat(arg1) });
  const obj1 = { style: importDefault(6766).errorText, children: "Error Code: ".concat(arg1) };
  items[3] = callback(closure_9, { style: importDefault(6766).errorText, children: "Description: ".concat(arg2) });
  obj[1] = items;
