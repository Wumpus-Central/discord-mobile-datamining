// _runtime/08250_offsetComparator.js
import extractOpacityDefault from "08179_extractOpacity.js";
import appendTransformPropsDefault from "08181_appendTransformProps.js";
import _modDef8251 from "metro/08251__.js";
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
    ...
    if (gradientUnits) {
      num12 = _modDef8251[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
