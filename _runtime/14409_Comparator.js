...
const entry = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(14385).safeRe;
    const t = Comparator(14385).t;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(14381)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
        self.semver = semver;
      }
...
const items = [
  ...
  },
  {
    ...
    value: function test(arg0) {
      const self = this;
      let tmp = arg0;
      Comparator(14384)("Comparator.test", arg0, this.options.loose);
      if (this.semver !== closure_3) {
        if (tmp !== tmp5) {
          if (typeof tmp === "string") {
            try {
              tmp = new Comparator(14381)(tmp, self.options);
            } catch (err) {
              return false;
            }
          }
          return Comparator(14407)(tmp, self.operator, self.semver, self.options);
        }
      }
      return true;
    },
    ...
    value: function intersects(value, arg1) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(14410)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(14410)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(14382)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(14407)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(14407)(self.semver, ">", value.semver, tmp45);
