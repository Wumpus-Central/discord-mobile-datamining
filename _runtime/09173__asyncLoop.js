...
export const randomBytes = function randomBytes() {
  ...
  if (Hash(9175).crypto) {
    if (typeof Hash(9175).crypto.getRandomValues === "function") {
      const _crypto2 = Hash(9175).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(9175).crypto) {
    if (typeof Hash(9175).crypto.randomBytes === "function") {
      const _crypto = Hash(9175).crypto;
