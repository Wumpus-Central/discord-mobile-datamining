// _runtime/16622__getAppleDeclaredAgeRangeStatus.js
import importDefaultResult from "module_16625";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16623).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16625").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16625").PlayAgeRangeDeclarationUserStatusString;