// _runtime/13766___exportStarResult29.js
...
import __exportStarResult11 from "13760___exportStarResult11.js";
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(13748).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(13748).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(13748).repeat("0", -num3 - 1)}${arr}`;
