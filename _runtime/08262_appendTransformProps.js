// _runtime/08262_appendTransformProps.js
import append from "08263_append.js";
import peg$SyntaxError from "08264_peg_SyntaxError.js";
import peg$SyntaxError2 from "08265_peg_SyntaxError.js";
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(8264);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(8263);
