// _runtime/01727_validateConfig.js
...
let fn = function n(userConfig, callback) {
  ...
  const fn = function c() {
    ...
    obj = {
      onFrame: userConfig(table[2]).isValidRubberBandConfig(obj)
  ...
  obj = {
    userConfig,
    isValidRubberBandConfig: require("01728_isValidRubberBandConfig.js").isValidRubberBandConfig,
    rubberBandDecay: require("01729_rubberBandDecay.js").rubberBandDecay,
    rigidDecay: require("01730_rigidDecay.js").rigidDecay,
    validateConfig,
    callback,
...
fn.__closure = {
  ...
  isValidRubberBandConfig: require("isValidRubberBandConfig").isValidRubberBandConfig,
