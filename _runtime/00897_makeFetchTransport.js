// _runtime/00897_makeFetchTransport.js
          ...
          try {
            ...
            if (0 === c5) {
              if (arg0 === 1) {
                ...
                obj1 = { body: null, method: "POST", referrerPolicy: "strict-origin", headers: null, keepalive: null };
                obj1[0] = length.body;
                obj1[3] = lib.headers;
                ...
                obj2[0] = closure_1_1(lib.url, obj1);
                return obj2;
              }
            } else if (1 === tmp9) {
              c4 = 0;
