// _runtime/08370_StepsIndicator.js
import _mod8368 from "metro/08368__.js";
import _mod8369 from "metro/08369__.js";
import SliderTrackMark from "08371_SliderTrackMark.js";
import StepNumber from "08372_StepNumber.js";
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      ...
      let obj = { marginHorizontal: sliderWidth * _mod8368.constants.MARGIN_HORIZONTAL_PADDING };
    ...
    if ("web" === get_ActivityIndicator.Platform.OS) {
      ...
      obj = { width: tmp6(8368).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8369).styles.stepIndicatorElement, obj);
    } else {
