// _runtime/05644__isNativeReflectConstruct.js
import map from "05621_map.js";
import transformIntoHandlerTags from "05648_transformIntoHandlerTags.js";
import _mod5649 from "metro/05649__.js";
import get_ActivityIndicatorDefault from "05652_get_ActivityIndicator.js";
...
let closure_10 = { [arg1(5623).State.UNDETERMINED]: undefined, [arg1(5623).State.BEGAN]: "onBegan", [arg1(5623).State.FAILED]: "onFailed", [arg1(5623).State.CANCELLED]: "onCancelled", [arg1(5623).State.ACTIVE]: "onActivated", [arg1(5623).State.END]: "onEnded" };
