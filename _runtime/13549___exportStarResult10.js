// _runtime/13549___exportStarResult10.js
import { __exportStarResult7 } from "13546___exportStarResult7.js";
const require = arg1;
...
arg5.IsWellFormedUnitIdentifier = function IsWellFormedUnitIdentifier(GetOptionResult3) {
  ...
  if (__exportStarResult7.IsSanctionedSimpleUnitIdentifier(str)) {
    ...
    if (2 !== parts.length) {
      ...
      [tmp3, tmp4] = parts;
      if (tmp(13546).IsSanctionedSimpleUnitIdentifier(tmp3)) {
        if (tmp(13546).IsSanctionedSimpleUnitIdentifier(tmp4)) {
          return true;
        }
      }
      return false;
