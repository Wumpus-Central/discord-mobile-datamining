...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      let obj1 = ScopeClass(7385);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(7385);
      ...
      let tmp3Result = tmp3(7397);
      tmp3Result = tmp3(7397);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      let obj = arg0;
      if (!arg0) {
        obj = { email: "Date", id: "isArray", ip_address: "isArray", username: "ty" };
      }
      const self = this;
      this._user = obj;
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(7398).updateSession(self._session, obj);
        const obj2 = ScopeClass(7398);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(7397)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(7397);
      obj[0] = ScopeClass(7385).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(7389).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(7397)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(7400).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(7385).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(7375).logger;
