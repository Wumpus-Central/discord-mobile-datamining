// _runtime/12620_applyClientOptions.js
import isMatchingPattern from "12580_isMatchingPattern.js";
...
function applyClientOptions(environment, environment2) {
  ...
  if (!DEFAULT_ENVIRONMENT) {
    DEFAULT_ENVIRONMENT = _mod12608.DEFAULT_ENVIRONMENT;
  }
...
function applyDebugIds(exception) {
  _require = require("12623_getFilenameToDebugIdMap.js").getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(12616).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(12616);
                }
