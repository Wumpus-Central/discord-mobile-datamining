// _runtime/01715_rigidDecay.js
import _mod1713 from "metro/01713__.js";
...
function rigidDecay(initialVelocity, lastTimestamp, deceleration) {
  ...
  const result1 = velocity * Math.exp(result * _mod1713.SLOPE_FACTOR);
  ...
  return absolute < _mod1713.VELOCITY_EPS;
}
rigidDecay.__closure = { SLOPE_FACTOR: fn(1713).SLOPE_FACTOR, VELOCITY_EPS: fn(1713).VELOCITY_EPS };
rigidDecay.__workletHash = 6356485112123;
rigidDecay.__initData = {
