// _runtime/07550_addToMetricsAggregator.js
...
import { dateTimestampInSeconds } from "07468_dateTimestampInSeconds.js";
import { getClient } from "07481_getClient.js";
import { createChildOrRootSpan } from "07488_createChildOrRootSpan.js";
import { __SENTRY_DEBUG__ } from "metro/07482___SENTRY_DEBUG__.js";
import { 07551__ } from "metro/07551__.js";
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07551__.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07551__.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, 07551__.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07551__.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    ...
    if (typeof fn === "function") {
      ...
      return _createChildOrRootSpan.startSpanManual(obj, (arg0) => {
        ...
        return callback(table[10]).handleCallbackErrors(() => callback(), () => {
          ...
          closure_2(lib, lib(7551).DISTRIBUTION_METRIC_TYPE, outer1_1, parsed, obj);
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _07551__.DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
