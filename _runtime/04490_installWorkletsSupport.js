// === Module 4490: installWorkletsSupport ===

// Module 4490 (installWorkletsSupport)
import reactNativeWorkletsCompat from "reactNativeWorkletsCompat" /* 4491 */;
import _mod4495 from "module_4495" /* 4495 */;
...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4495.NitroModules;
    const boxResult = NitroModules.box(_mod4495.NitroModules);
    require = boxResult;
