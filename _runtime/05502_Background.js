// === Module 5502: Background ===

// Module 5502 (Background)
import registerAssetDefault from "registerAsset" /* 5503 */;
import registerAssetDefault2 from "registerAsset" /* 5504 */;
import registerAssetDefault3 from "registerAsset" /* 5505 */;
import registerAssetDefault4 from "registerAsset" /* 5506 */;
import registerAssetDefault5 from "registerAsset" /* 5507 */;

const items = [registerAssetDefault, registerAssetDefault2, registerAssetDefault3, registerAssetDefault4, registerAssetDefault5];
for (const key10025 in require("module_5508")) {
  let tmp2 = key10025;
  arg5[key10025] = require("module_5508")[key10025];
  continue;
}
