// _runtime/01713_rubberBandDecay.js
import isValidRubberBandConfig from "01712_isValidRubberBandConfig.js";
...
function rubberBandDecay(current, lastTimestamp, deceleration) {
  ...
  const diff =
    velocity * Math.exp(result * isValidRubberBandConfig.SLOPE_FACTOR) - num2 * deceleration.rubberBandFactor;
...
rubberBandDecay.__closure = {
  SLOPE_FACTOR: require("isValidRubberBandConfig").SLOPE_FACTOR,
  DERIVATIVE_EPS: 0.1,
  VELOCITY_EPS: require("isValidRubberBandConfig").VELOCITY_EPS,
};
rubberBandDecay.__workletHash = 1153024330944;
rubberBandDecay.__initData = {
