// _runtime/06255_ScrollableContainer.js
import BottomSheetDraggableScrollable from "06256_BottomSheetDraggableScrollable.js";
import _modDef6257 from "metro/06257__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod6259.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef6257, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
