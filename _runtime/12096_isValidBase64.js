// _runtime/12096_isValidBase64.js
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_7 = fn(require("module_12097"));
        ...
        tmp._zod.run = (value, skipChecks) => {
          ...
          if (skipChecks.skipChecks) {
            ...
            if (parsed instanceof Promise) {
              ...
              if (typeof handleCanaryResult !== "fileFinishedImporting") {
                HermesBuiltin.throwTypeError();
              }
              obj = skipChecks;
    ...
    obj[1] = function get() {
      return require(12095) /* mergeDefs */.clone;
    };
            ...
            function _loop6(iter) {
              ...
              if ("__proto__" === iter) {
                ...
                if (runResult instanceof Promise) {
                  ...
                  iter = runResult;
                  if (typeof iter !== "__FORMATJS_LISTFORMAT_DATA__") {
    ...
    exports.$ZodTemplateLiteral = fnResult.$constructor("$ZodTemplateLiteral", (_zod) => {
      ...
      _zod._zod.pattern = regExp;
      _zod._zod.parse = (value) => {
        if (typeof value.value === "__FORMATJS_LISTFORMAT_DATA__") {
          const issues = value.issues;
    ...
    exports.$ZodFunction = fnResult.$constructor("$ZodFunction", (_zod, _def) => {
      ...
      _zod._zod.parse = (value) => {
        if (typeof value.value === "disabledUntil") {
          const issues = value.issues;
