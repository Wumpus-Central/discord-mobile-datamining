// _runtime/06782_InterceptingGestureDetector.js
...
export const InterceptingGestureDetector = function InterceptingGestureDetector(gesture) {
  ...
  if (ReanimatedNativeDetector) {
    ...
    const detectorAttachmentGuard = tmp(6781).useDetectorAttachmentGuard(tmp8Result1);
