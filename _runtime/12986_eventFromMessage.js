...
export const eventFromUnknownInput = function eventFromUnknownInput(getOptions, fn, name, data) {
  ...
  const result1 = _mod12937.addExceptionTypeValue(obj2, undefined, undefined);
  const result2 = _mod12937.addExceptionMechanism(obj2, data);
  const obj4 = {};
