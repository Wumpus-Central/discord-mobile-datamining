...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("module_13719");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13715).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13715).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(13718).parseUrlencoded(query);
          const tmpResult = tmp(13718);
        }
      }
      const obj = URLImpl(13715);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(13715).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13715).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13715);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13715).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13715);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13715).serializeHost(host);
        const obj3 = URLImpl(13715);
      } else {
        const obj = URLImpl(13715);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13715).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13715);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13715).serializeHost(tmp._url.host);
        const obj = URLImpl(13715);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13715).serializeInteger(tmp._url.port);
        const obj = URLImpl(13715);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(13715).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(13715);
        }
      }
    }
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        self._query._list = URLImpl(13718).parseUrlencoded(substr);
      }
    }
  },
  {
