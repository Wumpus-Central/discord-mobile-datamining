// _runtime/01020_walkErrorTree.js
const require = arg1;
    ...
    if (exceptions.length + 1 < arg1) {
      if (obj12.isString(tmp)) {
        ...
        if (null === nativePackageName) {
          const NATIVE2 = tmp28(998).NATIVE;
        ...
        let tmp28Result = tmp28(814);
        const _Error = Error;
        if (tmp28Result.isInstanceOf(tmp, Error)) {
          tmp28Result = tmp28(1021);
