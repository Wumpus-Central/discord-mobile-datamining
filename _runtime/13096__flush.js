...
import _mod13085 from "metro/13085__.js";
  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/13075__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/13076__.js").DEBUG_BUILD) {
            const logger = require("metro/13048__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/13075__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const captureException = function captureException(arg0, captureContext) {
  const currentScope = _mod13075.getCurrentScope();
  return currentScope.captureException(arg0, _mod13097.parseEventHintOrCaptureContext(captureContext));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = _mod13085.DEFAULT_ENVIRONMENT;
  }
  ...
  if (tmp10) {
    _mod13071.updateSession(session1, { status: "exited" });
    const tmpResult2 = _mod13071;
  }
  endSession();
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod13062.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod13075.getCurrentScope();
    const client = _mod13075.getClient();
    if (client) {
  ...
  let currentScope = require("metro/13075__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/13075__.js");
  let client = require("metro/13075__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/13075__.js");
  captureCheckInResult = require("metro/13059__.js").uuid4();
};
