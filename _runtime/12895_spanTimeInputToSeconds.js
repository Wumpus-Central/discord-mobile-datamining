// _runtime/12895_spanTimeInputToSeconds.js
...
import _mod12906 from "metro/12906__.js";
import _mod12907 from "metro/12907__.js";
import _mod12908 from "metro/12908__.js";
import _mod12909 from "metro/12909__.js";
  ...
  if (
    ...
    try {
      ...
      if (
        ...
        obj.op = attributes[_mod12905.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj.origin = attributes[_mod12905.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
        const tmp8 = spanTimeInputToSeconds(endTime);
        obj._metrics_summary = _mod12906.getMetricSummaryJsonForSpan(getSpanJSON);
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12907.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod12907.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod12896.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod12896.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
