// === Module 12961: initializeContext ===
...
function process(_zod, seen) {
  ...
  if (value) {
    ...
    obj = { schema: null, count: 1, cycle: "Array", path: "PAYMENT_REQUEST_CREATE_SUPPORTED_PAYMENT_METHODS_CONFIGURATION_MUST_INCLUDE_TYPE" };
    obj[0] = {};
    obj[3] = tmp4.path;
