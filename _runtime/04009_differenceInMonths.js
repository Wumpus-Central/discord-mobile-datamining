// _runtime/04009_differenceInMonths.js
import _typeof_mod from "metro/03811__.js";
...
import module_4010_mod from "metro/04010__.js";
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_4010.default(_typeof.default(date)) && 1 === absolute && 1 === compareAsc.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
