// _runtime/13102__flush.js
import _mod13054 from "metro/13054__.js";
import _mod13055 from "metro/13055__.js";
import _mod13065 from "metro/13065__.js";
import _mod13068 from "metro/13068__.js";
import _mod13077 from "metro/13077__.js";
import _mod13081 from "metro/13081__.js";
import _mod13082 from "metro/13082__.js";
import _mod13091 from "metro/13091__.js";
import _mod13103 from "metro/13103__.js";
  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/13081__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/13082__.js").DEBUG_BUILD) {
            const logger = require("metro/13054__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/13081__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const captureException = function captureException(arg0, captureContext) {
  const currentScope = _mod13081.getCurrentScope();
  return currentScope.captureException(arg0, _mod13103.parseEventHintOrCaptureContext(captureContext));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = _mod13091.DEFAULT_ENVIRONMENT;
  }
  ...
  if (tmp10) {
    _mod13077.updateSession(session1, { status: "exited" });
    const tmpResult2 = _mod13077;
  }
  endSession();
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod13068.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod13081.getCurrentScope();
    const client = _mod13081.getClient();
    if (client) {
    ...
    _mod13065.uuid4();
    const tmpResult = _mod13065;
  }
  let currentScope = require("metro/13081__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/13081__.js");
  let client = require("metro/13081__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/13081__.js");
  captureCheckInResult = require("metro/13065__.js").uuid4();
};
