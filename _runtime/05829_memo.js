...
({
  useCallback: closure_6,
  useImperativeHandle: error,
  useMemo: closure_8,
  useRef: c9,
  useState: c10,
...
const memoResult = memo(
  forwardRef(function BottomSheetModalComponent(name) {
    const _require = arg1;
    name = name.name;
    ...
    enablePanDownToClose(arg1, () => ({
      snapToIndex: closure_24,
      snapToPosition: closure_25,
      setToIndex: closure_26,
      setToPosition: closure_27,
      expand: closure_28,
      collapse: closure_29,
      close: closure_30,
      forceClose: closure_31,
      dismiss: closure_33,
      present: closure_32,
      minimize: closure_34,
      restore: closure_35,
