// _runtime/01789_SharedTransition.js
  ...
  },
  {
    ...
    value: function unregisterTransition(componentViewTag, flag) {
      ...
      if (this._defaultTransitionType === isWorkletFunction.SharedTransitionType.ANIMATION) {
        let SHARED_ELEMENT_TRANSITION_PROGRESS = tmp(1677).LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
      } else {
        SHARED_ELEMENT_TRANSITION_PROGRESS = tmp(1677).LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS;
      }
