// === Module 7475: supportsFetch ===

// Module 7475 (supportsFetch)
const require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in require(7364) /* getGlobalSingleton */.GLOBAL_OBJ) {
    try {
...
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "y") {
    ...
    if (isNativeFunction(require(7364) /* getGlobalSingleton */.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(7364).GLOBAL_OBJ.document;
      if (_document) {
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in require(7364) /* getGlobalSingleton */.GLOBAL_OBJ;
};