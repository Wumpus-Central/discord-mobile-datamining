...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      let obj1 = ScopeClass(6381);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(6381);
      ...
      let tmp3Result = tmp3(6393);
      tmp3Result = tmp3(6393);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      ...
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(6394).updateSession(self._session, obj);
        const obj2 = ScopeClass(6394);
      }
  ...
  },
  {
    ...
    value: function update(requestSession) {
      ...
      if (requestSession) {
        ...
        if (typeof requestSession !== "disabledUntil") {
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(6393)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(6393);
      obj[0] = ScopeClass(6381).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, arg1) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(6385).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      obj[12] = ScopeClass(6393)._getSpanForScope(self);
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(6396).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      ...
      obj[0] = ScopeClass(6381).generateSpanId();
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(6371).logger;
