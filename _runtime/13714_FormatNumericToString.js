// _runtime/13714_FormatNumericToString.js
import TEN from "13700_TEN.js";

const _mod13698 = tmp5(13698);
const GetUnsignedRoundingMode = tmp5(13715);
const ToRawPrecision = tmp5(13716);
const ToRawFixed = tmp5(13717);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod13698.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod13698.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
