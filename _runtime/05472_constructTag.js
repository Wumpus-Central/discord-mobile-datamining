// _runtime/05472_constructTag.js
...
import _modDef5444 from "metro/05444__.js";
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== PNG_CHUNK_TYPE_SIZE.TYPE_TEXT) {
    ...
    if (0 !== items2.length) {
      ...
      combined = "" + stringValueFromArray + " (" + _mod5425.getStringValueFromArray(items2) + ")";
  ...
  read(byteLength, arg1, arg2, arg3) {
    ...
    if (0 < arg1.length) {
      while (true) {
        ...
        let COMPRESSION_METHOD_NONE = require("metro/05425__.js").COMPRESSION_METHOD_NONE;
        ...
        let tmp38 = _require;
        if (tmp5 !== require("metro/05425__.js").COMPRESSION_METHOD_NONE) {
          if (!arg2) {
            let obj2 = {};
                  ...
                  try {
                    if (_modDef5428.USE_EXIF) {
                      if (isExifGroupTag(name, value)) {
                        const obj2 = { __exif: _modDef5444.read(decodeRawData(value), c10, closure_0).tags };
                        return obj2;
                      }
                    }
                    if (_modDef5428.USE_IPTC) {
                      if (isIptcGroupTag(name, value)) {
                        const obj3 = { __iptc: _modDef5456.read(decodeRawData(value), 0, closure_0) };
                        return obj3;
                      }
                    }
                    if (name) {
