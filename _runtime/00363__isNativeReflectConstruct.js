      ...
      if (!this._interpolation) {
        ...
        if (_config.outputRange) {
          if (typeof _config.outputRange[0] === "string") {
            ...
            AnimatedInterpolation(f67123[7])(_config.outputRange.length >= 2, "Bad output range");
            ...
            extrapolate = first.map((arg0, arg1) => {
              ...
              if (!easing) {
                easing = _undefined(f67123[6]).linear;
              }
              extrapolate = "extend";
        ...
        if (typeof _config.outputRange[0] === "object") {
          ...
          extrapolate = undefined;
          extrapolate = undefined;
          ({ outputRange: c0, inputRange: f67123, easing: easing2 } = obj);
          if (!easing2) {
            easing2 = AnimatedInterpolation(f67123[6]).linear;
          }
          easing = easing2;
          extrapolate = "extend";
          if (undefined !== obj.extrapolateLeft) {
          ...
          ({ outputRange: c0, inputRange: f67123, easing } = _config);
          if (!easing) {
            easing = AnimatedInterpolation(f67123[6]).linear;
          }
          extrapolate = "extend";
