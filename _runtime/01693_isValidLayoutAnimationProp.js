// _runtime/01693_isValidLayoutAnimationProp.js
...
import isAffineMatrixFlat from "01695_isAffineMatrixFlat.js";
    ...
    if (!isJest) {
      ...
      if (!factory) {
        if (!obj.isWorkletFunction(factory)) {
          const reanimatedError = new tmp5(1664).ReanimatedError(
    ...
    function transformationMatrixOnFrame(arg0, arg1) {
      ...
      const item = items1.forEach((arg0, arg1) => {
        ...
        return items.push(
          obj.addMatrices(
            ...
            obj2.scaleMatrix(lib(1695).subtractMatrices(lib.stopMatrices[arg0], lib.startMatrices[arg0]), tmp2),
          ),
        );
      });
      const items2 = [];
      ...
      arg0.current = obj4.flatten(
        obj5.multiplyMatrices(
          obj6.multiplyMatrices(tmp4, callback(1695).multiplyMatrices(tmp5, multiplyMatricesResult)),
          tmp3,
        ),
      );
