// _runtime/05162_OrdinaryDefineOwnProperty.js
...
import ValidateAndApplyPropertyDescriptor from "05165_ValidateAndApplyPropertyDescriptor.js";

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod5099(arg0)) {
    if (_mod5146(arg1)) {
      if (_mod5150(__Writable__)) {
        if (_mod1283) {
          ...
          return ValidateAndApplyPropertyDescriptor(arg0, arg1, _mod5164(arg0), __Writable__, tmp31);
