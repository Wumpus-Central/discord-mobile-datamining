// _runtime/05654_Color.js
import _mod5655 from "metro/05655__.js";
import _mod5659 from "metro/05659__.js";
...
function _loop(item10136) {
  ...
  if (closure_3.includes(item10136)) {
    ...
    channels = require("metro/05655__.js")[item10136].channels;
    Color.prototype[item10136] = function () {
      ...
      if (this.model === closure_0) {
        ...
        const rawResult = _mod5655[self.model][closure_0].raw(self.color);
        const _Array = Array;
        let tmp2 = rawResult;
