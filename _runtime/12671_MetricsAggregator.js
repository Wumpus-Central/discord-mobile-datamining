// _runtime/12671_MetricsAggregator.js
...
class MetricsAggregator {
  constructor(arg0) {
    ...
    tmp4 = closure_1;
    this._interval = setInterval(() => self._flush(), require("metro/12668__.js").DEFAULT_FLUSH_INTERVAL);
    if (this._interval.unref) {
      _interval = self._interval;
      unrefResult = _interval.unref();
    }
    random = Math.random();
    self._flushShift = Math.floor((random * require("metro/12668__.js").DEFAULT_FLUSH_INTERVAL) / 1000);
...
const items = [
  {
    ...
    value: function add(arg0, arg1, diff) {
      ...
      const bucketKey = MetricsAggregator(12672).getBucketKey(
        arg0,
      ...
      const result1 = MetricsAggregator(12576).updateMetricSummaryOnActiveSpan(
        arg0,
        sanitizeMetricKeyResult,
        diff,
        sanitizeUnitResult,
