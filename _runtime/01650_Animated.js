...
import controlEdgeToEdgeValues from "controlEdgeToEdgeValues" /* 1651 */;
...
export const KeyboardProvider = (enabled) => {
  ...
  sharedValue2 = _require(1652).useSharedValue(null);
  const obj5 = _require(1652);
  Animated = _require(1841).useEventHandlerRegistration(tmp3);
  const obj6 = _require(1841);
  closure_10 = _require(1841).useEventHandlerRegistration(tmp3);
  ...
  obj[3] = fn3;
  const obj9 = _require(1843);
  const animatedKeyboardHandler = _require(1843).useAnimatedKeyboardHandler(obj, []);
  ...
  obj3 = { ref: tmp3, enabled: first, navigationBarTranslucent: null, statusBarTranslucent: null, preserveEdgeToEdge: null, style: null, onKeyboardMoveReanimated: null, onKeyboardMoveStart: "Boolean", onKeyboardMove: "flag_mq", onKeyboardMoveInteractive: "<string:1980204637>", onKeyboardMoveEnd: "<string:1263826516>", onFocusedInputLayoutChangedReanimated: "<string:2255548443>", children: null };
  let tmp18 = fn;
  let tmp19 = fn;
  if (!fn) {
  ...
  obj3[9] = tmp11;
  obj3[10] = tmp11;
  obj3[11] = _require(1843).useFocusedInputLayoutHandler(obj1, []);
  obj3[12] = children;
  const items2 = [closure_10(closure_13, obj3), closure_10(Animated.View, { style: tmp10 })];
  obj2[1] = items2;
  return closure_11(_require(1845).KeyboardContext.Provider, obj2);
};