...
import controlEdgeToEdgeValues from "01651_controlEdgeToEdgeValues.js";
import { cancelAnimation } from "01652_cancelAnimation.js";
import { useEventHandlerRegistration } from "01841_useEventHandlerRegistration.js";
import { useAnimatedKeyboardHandler } from "01843_useAnimatedKeyboardHandler.js";
...
export const KeyboardProvider = (enabled) => {
  ...
  sharedValue2 = require("01652_cancelAnimation.js").useSharedValue(null);
  const obj5 = cancelAnimation;
  Animated = require("01841_useEventHandlerRegistration.js").useEventHandlerRegistration(tmp3);
  const obj6 = useEventHandlerRegistration;
  closure_10 = require("01841_useEventHandlerRegistration.js").useEventHandlerRegistration(tmp3);
  ...
  const animatedKeyboardHandler = require("01843_useAnimatedKeyboardHandler.js").useAnimatedKeyboardHandler(obj, []);
  ...
  obj3[9] = tmp11;
  obj3[10] = tmp11;
  obj3[11] = require("01843_useAnimatedKeyboardHandler.js").useFocusedInputLayoutHandler(obj1, []);
  obj3[12] = children;
  const items2 = [closure_10(closure_13, obj3), closure_10(Animated.View, { style: tmp10 })];
  obj2[1] = items2;
  return closure_11(require("01845_NOOP.js").KeyboardContext.Provider, obj2);
};
