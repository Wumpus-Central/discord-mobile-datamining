// _runtime/05496_map.js
import _slicedToArray from "_slicedToArray";
import { useMemo } from "noop";
import { hash } from "05484_hash.js";
import { items2 } from "05485_items2.js";
import { isNativeEvent } from "05497_isNativeEvent.js";
...
export const resolveInternalConfigProps = function resolveInternalConfigProps(useAnimated) {
  ...
  if (!disableReanimated) {
    result = undefined !== 05470__.Reanimated;
  }
  if (result) {
