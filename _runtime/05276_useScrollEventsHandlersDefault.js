// _runtime/05276_useScrollEventsHandlersDefault.js
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: _require(5250).SHEET_STATE, animatedHandleGestureState, State: _require(5277).State, animatedScrollableState, SCROLLABLE_STATE: _require(5250).SCROLLABLE_STATE, scrollTo: _require(1606).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj[0] = _require(1606).useWorkletCallback(E, items);
  const obj5 = _require(1606);
  class O {
    constructor(arg0, arg1) {
      y = scrollableRef.contentOffset.y;
      closure_1.value = y;
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: _require(5250).SHEET_STATE };
  O.__closure = obj1;
  ...
  obj[1] = _require(1606).useWorkletCallback(O, items1);
  const obj7 = _require(1606);
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: _require(5250).SCROLLABLE_STATE, scrollTo: _require(1606).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5250).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
  ...
  obj[2] = _require(1606).useWorkletCallback(fn2, items2);
  const obj9 = _require(1606);
  class C {
    constructor(arg0, arg1) {
      y = scrollableRef.contentOffset.y;
      tmp = closure_0;
  ...
  const obj11 = _require(1606);
  C.__closure = { animatedScrollableState, SCROLLABLE_STATE: _require(5250).SCROLLABLE_STATE, scrollTo: _require(1606).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5250).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
