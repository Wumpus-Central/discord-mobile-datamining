// _runtime/09129__isNativeReflectConstruct.js
...
let items = [
  {
    ...
    value: function update(B) {
      ...
      let view;
      const self = this;
      HashMD(9124).exists(this);
      ({ buffer, blockLen, view } = this);
      const toBytesResult = HashMD(9123).toBytes(B);
      let num = 0;
  ...
  },
  {
    ...
    value: function digestInto(content) {
      ...
      const self = this;
      HashMD(9124).exists(this);
      HashMD(9124).output(content, this);
      this.finished = true;
      ...
      self.process(view, 0);
      view = HashMD(9123).createView(content);
