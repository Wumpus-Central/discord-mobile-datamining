...
let items = [
  {
    ...
    value: function clone() {
      ...
      obj = { traceId: null, spanId: null };
      obj1 = ScopeClass(12569);
      obj[0] = obj1.generateTraceId();
      let obj2 = ScopeClass(12569);
      ...
      let tmp3Result = tmp3(12581);
      tmp3Result = tmp3(12581);
  ...
  },
  {
    ...
    value: function setUser(arg0) {
      let obj = arg0;
      if (!arg0) {
        obj = { email: "accessible", id: "includes", ip_address: "pos", username: "r" };
      }
      const self = this;
      this._user = obj;
      if (this._session) {
        obj = { user: null };
        obj[0] = arg0;
        ScopeClass(12582).updateSession(self._session, obj);
        const obj2 = ScopeClass(12582);
      }
  ...
  },
  {
    ...
    value: function clear() {
      ...
      ScopeClass(12581)._setSpanForScope(obj, undefined);
      obj._attachments = [];
      obj = { traceId: null };
      const obj2 = ScopeClass(12581);
      obj[0] = ScopeClass(12569).generateTraceId();
  ...
  },
  {
    ...
    value: function addBreadcrumb(arg0, num) {
      ...
      if (num <= 0) {
        ...
        obj[0] = ScopeClass(12573).dateTimestampInSeconds();
  ...
  },
  {
    ...
    value: function getScopeData() {
      const self = this;
      const obj = { breadcrumbs: this._breadcrumbs, attachments: this._attachments, contexts: this._contexts, tags: this._tags, extra: this._extra, user: this._user, level: this._level, fingerprint: tmp, eventProcessors: self._eventProcessors, propagationContext: self._propagationContext, sdkProcessingMetadata: self._sdkProcessingMetadata, transactionName: self._transactionName, span: ScopeClass(12581)._getSpanForScope(self) };
      return obj;
    }
  },
  {
    ...
    value: function setSDKProcessingMetadata(arg0) {
      this._sdkProcessingMetadata = ScopeClass(12584).merge(this._sdkProcessingMetadata, arg0, 2);
      return this;
    }
  },
  {
    ...
    value: function setPropagationContext(arg0) {
      const obj = { spanId: ScopeClass(12569).generateSpanId() };
      const merged = Object.assign(arg0);
      this._propagationContext = obj;
      return this;
    }
    ...
    value: function captureException(arg0, event_id) {
      if (event_id) {
        ...
        if (this._client) {
          ...
          const logger = ScopeClass(12559).logger;
          logger.warn("No client configured on scope - will not capture exception!");
          return event_id;
        }
      }
      obj = ScopeClass(12570);
      event_id = obj.uuid4();
    }
  },
  {
