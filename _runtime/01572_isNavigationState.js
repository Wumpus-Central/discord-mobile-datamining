// _runtime/01572_isNavigationState.js
...
import { PrivateValueStore } from "01502_PrivateValueStore.js";
import { isArrayEqual } from "01562_isArrayEqual.js";
import { useRegisterNavigator } from "01573_useRegisterNavigator.js";
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  const context = React.useContext(require("01539_context.js").NavigationRouteContext);
  const context1 = React.useContext(require("01530_ConsumedParamsContext.js").ConsumedParamsContext);
  let params;
  if (context != null) {
  ...
  const lazyValue = require("01521_useLazyValue.js").useLazyValue(() => {
  ...
  if (mapped.length) {
    ...
    const context2 = React.useContext(require("01515_get_getKey.js").NavigationStateContext);
    ...
    const context3 = React.useContext(require("01528_NavigationBuilderContext.js").NavigationBuilderContext);
    ...
    tmp51 = require("01562_isArrayEqual.js").isArrayEqual(tmp39.routeNames, mapped) && 0 === found.length;
  } else {
    let _Error = Error;
