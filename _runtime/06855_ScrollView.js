...
const jsx = fn(21).jsx;
let closure_11 = module_6768(ScrollView2, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6769).GestureDetectorType.Intercepting);
class ScrollView {
  constructor(arg0) {
...
const importDefaultResultResult = module_6768(RefreshControl, { disallowInterruption: true, shouldCancelWhenOutside: false }, fn(6769).GestureDetectorType.Virtual);

export const RefreshControl = importDefaultResultResult;
export { ScrollView };
export const Switch = module_6768(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });
