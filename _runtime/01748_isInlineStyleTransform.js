// _runtime/01748_isInlineStyleTransform.js
...
function getInlinePropsUpdate(viewDescriptors) {
  ...
  while (tmp2 !== undefined) {
    ...
    let obj2 = InlinePropManager(1701);
  ...
  obj,
  {
    ...
    value: function detachInlineProps() {
      if (this._inlinePropsMapperId) {
        InlinePropManager(1700).stopMapper(tmp._inlinePropsMapperId);
        const obj = InlinePropManager(1700);
      }
    }
  }
];
