// _runtime/09737_XorAndSalsa.js
import _asyncLoop from "09738__asyncLoop.js";
import pbkdf2Init from "09741_pbkdf2Init.js";
import _isNativeReflectConstruct from "09743__isNativeReflectConstruct.js";
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9738).isLE) {
                callback(9738).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
