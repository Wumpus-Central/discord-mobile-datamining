// _runtime/04631_enableScreens.js
import RNSModule from "RNSModule";

for (const key10015 in require("module_4633")) {
  let tmp3 = key10015;
  arg5[key10015] = require("module_4633")[key10015];
  continue;
}
