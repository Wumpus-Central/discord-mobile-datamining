// _runtime/12336_stringProcessor.js
...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(12335).process(_idmap, initializeContextResult);
    tmp2(12335).extractDefs(initializeContextResult, _idmap);
    return tmp2(12335).finalize(initializeContextResult, _idmap);
  }
