// _runtime/05493__isNativeReflectConstruct.js
...
import { transformIntoHandlerTags } from "05497_transformIntoHandlerTags.js";
import { 05498__ } from "metro/05498__.js";
...
let closure_10 = { [arg1(5472).State.UNDETERMINED]: undefined, [arg1(5472).State.BEGAN]: "onBegan", [arg1(5472).State.FAILED]: "onFailed", [arg1(5472).State.CANCELLED]: "onCancelled", [arg1(5472).State.ACTIVE]: "onActivated", [arg1(5472).State.END]: "onEnded" };
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          ...
          if (self.viewNode) {
            self.attachGestureHandler(require("05501_get_ActivityIndicator.js") /* get ActivityIndicator */(self.viewNode));
          } else {
            const _Error = Error;
