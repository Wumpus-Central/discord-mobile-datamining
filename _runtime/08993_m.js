      ...
      while (true) {
        while (!str3) {
                        ...
                        if ("friday" !== symbol2) {
                          ...
                          switch (iter.symbol) {
                            ...
                            case "useMemo":
                              ...
                              let byweekday = tmp47.byweekday;
                              let tmp48 = outer1_72;
                              let arr = byweekday.push(outer1_72[flag2]);
                              obj = iter;
                              let str19 = "comma";
                              continue;
                            break;
                              ...
                              while (true) {
                                if (flag) {
                                  if (flag2) {
                                    ...
                                    if (!obj.byweekday) {
                                      let items = [];
                                      tmp54.byweekday = items;
                                    }
                                    let byweekday1 = tmp54.byweekday;
                                    let tmp55 = outer1_72;
                                    let obj3 = outer1_72[flag2];
                                    let nthResult = obj3.nth(flag);
                                    arr = byweekday1.push(nthResult);
                                    obj = iter;
                                  } else {
                                    let tmp50 = obj;
                                    if (!obj.bymonthday) {
                                      let items1 = [];
                                      tmp50.bymonthday = items1;
                                    }
                                    let bymonthday = tmp50.bymonthday;
                                    let arr1 = bymonthday.push(flag);
                                    let str18 = "day(s)";
                                  ...
                                  if ("weekday(s)" === iter.symbol) {
                                    ...
                                    if (!obj.byweekday) {
                                      let tmp41 = outer1_72;
                                      let items2 = [outer1_72.MO, , , , ];
                                      let tmp42 = outer1_72;
                                      items2[1] = outer1_72.TU;
                                      let tmp43 = outer1_72;
                                      items2[2] = outer1_72.WE;
                                      let tmp44 = outer1_72;
                                      items2[3] = outer1_72.TH;
                                      let tmp45 = outer1_72;
                                      items2[4] = outer1_72.FR;
                                      tmp40.byweekday = items2;
                                      obj = iter;
                                    }
                                  } else {
                                    let str24 = "week(s)";
                                    if ("week(s)" === iter.symbol) {
                                      ...
                                      if (acceptNumberResult) {
                                        ...
                                        let num7 = 10;
                                        let parsed1 = parseInt(acceptNumberResult[0], 10);
                                        let items3 = [parsed1];
                                        obj.byweekno = items3;
                                        let str15 = "comma";
                                        let acceptResult2 = iter.accept("comma");
                                        obj = iter;
                                        if (acceptResult2) {
                                          let obj2 = obj;
                                          ...
                                          while (acceptNumberResult1) {
                                            ...
                                            let parsed2 = parseInt(acceptNumberResult1[0], 10);
                                            let arr2 = byweekno.push(parsed2);
                                            let acceptResult3 = obj2.accept("comma");
                                            obj = obj2;
                                            continue;
                                          }
                                          let _Error3 = Error;
                                          ...
                                          let text = `Unexpected symbol ${symbol4}`;
                                          let tmp30 = new.target;
                                          let str17 = "; expected monthday";
                                          let text1 = `Unexpected symbol ${symbol4}; expected monthday`;
                                          let tmp32 = new.target;
                                          let error = new Error(`Unexpected symbol ${symbol4}; expected monthday`);
                                          let tmp34 = error;
                                          throw error;
                                        }
                                      } else {
                                        let _Error2 = Error;
                                        let symbol3 = iter.symbol;
                                        let str13 = "Unexpected symbol ";
                                        let text2 = `Unexpected symbol ${symbol3}`;
                                        let tmp20 = new.target;
                                        let str14 = ", expected week number";
                                        let text3 = `Unexpected symbol ${symbol3}, expected week number`;
                                        let tmp22 = new.target;
                                        let error1 = new Error(`Unexpected symbol ${symbol3}, expected week number`);
                                        let tmp24 = error1;
                                        throw error1;
                                      }
                                    } else if (flag3) {
                            ...
                            case "applyScopeDataToEvent":
                              ...
                              while (true) {
                                if (flag) {
                                  if (flag2) {
                                    nextSymbolResult5 = iter.nextSymbol();
                                    tmp54 = obj;
                                    if (!obj.byweekday) {
                                      items = [];
                                      tmp54.byweekday = items;
                                    }
                                    byweekday1 = tmp54.byweekday;
                                    tmp55 = outer1_72;
                                    obj3 = outer1_72[flag2];
                                    nthResult = obj3.nth(flag);
                                    arr = byweekday1.push(nthResult);
                                    obj = iter;
                                  } else {
                                    tmp50 = obj;
                                    ...
                                    bymonthday = tmp50.bymonthday;
                                    arr1 = bymonthday.push(flag);
                                    str18 = "day(s)";
                                    acceptResult1 = iter.accept("day(s)");
                                    obj = iter;
                                  }
                                } else if (flag2) {
                                  nextSymbolResult6 = iter.nextSymbol();
                                } else {
                                  str12 = "weekday(s)";
                                  if ("weekday(s)" === iter.symbol) {
                                    nextSymbolResult7 = iter.nextSymbol();
                                    tmp40 = obj;
                                    obj = iter;
                                    if (!obj.byweekday) {
                                      tmp41 = outer1_72;
                                    ...
                                    str24 = "week(s)";
                                    if ("week(s)" === iter.symbol) {
                                      nextSymbolResult8 = iter.nextSymbol();
                                      acceptNumberResult = iter.acceptNumber();
                                      tmp18 = globalThis;
                                      if (acceptNumberResult) {
                                        tmp25 = obj;
                                        _parseInt = parseInt;
                                        num7 = 10;
                                        parsed1 = parseInt(acceptNumberResult[0], 10);
                                        items3 = [parsed1];
                                        obj.byweekno = items3;
                                        str15 = "comma";
                                        acceptResult2 = iter.accept("comma");
                                        obj = iter;
                                        if (acceptResult2) {
                                          obj2 = obj;
                                          acceptNumberResult1 = obj.acceptNumber();
                                          while (acceptNumberResult1) {
                                            tmp35 = obj;
                                            byweekno = obj.byweekno;
                                            _parseInt2 = parseInt;
                                            parsed2 = parseInt(acceptNumberResult1[0], 10);
                                            arr2 = byweekno.push(parsed2);
                                            acceptResult3 = obj2.accept("comma");
                                            obj = obj2;
                                            continue;
                                          }
                                          _Error3 = Error;
                                          symbol4 = obj2.symbol;
                                          str16 = "Unexpected symbol ";
                                          text = `Unexpected symbol ${symbol4}`;
                                          tmp30 = new.target;
                                          str17 = "; expected monthday";
                                          text1 = `Unexpected symbol ${symbol4}; expected monthday`;
                                          tmp32 = new.target;
                                          error = new Error(`Unexpected symbol ${symbol4}; expected monthday`);
                                          tmp34 = error;
                                          throw error;
                                        }
                                      } else {
                                        _Error2 = Error;
                                        symbol3 = iter.symbol;
                                        str13 = "Unexpected symbol ";
                                        text2 = `Unexpected symbol ${symbol3}`;
                                        tmp20 = new.target;
                                        str14 = ", expected week number";
                                        text3 = `Unexpected symbol ${symbol3}, expected week number`;
                                        tmp22 = new.target;
                                        error1 = new Error(`Unexpected symbol ${symbol3}, expected week number`);
                                        tmp24 = error1;
                                        throw error1;
                                      }
                                    } else if (flag3) {
                                      nextSymbolResult9 = iter.nextSymbol();
                                      tmp14 = obj;
                                      if (!obj.bymonth) {
                                        items4 = [];
                                        tmp14.bymonth = items4;
                                      }
                                      bymonth = tmp14.bymonth;
                                      arr3 = bymonth.push(flag3);
                                      obj = iter;
                                    }
                                  }
                                }
          ...
          switch (str4) {
                ...
                if (num11) {
                  ...
                  if ("until" === obj.symbol) {
                    ...
                    if (str6) {
                      ...
                      let tmp22 = new.target;
                      let tmp23 = str6;
                      let date1 = new str4.Date(str6);
                      let tmp25 = date1;
                      obj.until = date1;
                      tmp2 = obj;
                    } else {
                      let str9 = "Cannot parse until date:";
                      str10 = `Cannot parse until date:${obj2.text}`;
                      let tmp17 = new.target;
                      let tmp18 = new.target;
                      let error4 = new str4.Error(`Cannot parse until date:${obj2.text}`);
                      let tmp20 = error4;
                      throw error4;
                    }
                  } else {
            ...
            case "ROLE_HIGHLIGHT":
            break;
            case "STORE_LISTINGS_SKU":
            break;
            case "SKUTypes":
            break;
            case "COLLECTIBLES_SHOP_MOBILE_SHOP_ALL_MENU_ITEM":
            break;
            case "EMBED_LINKS":
            break;
            ...
            break;
            case "GAME_SERVER_POWERUP_SKU_ID":
            break;
            case "EFFECT_CLICK":
            break;
            case "CLICK_INTERNAL":
            break;
            case "_INTERNAL_FLAG_BUFFER_SIZE":
            break;
            case "INTERNAL":
            break;
        ...
        let tmp89 = globalThis;
        let _Error8 = Error;
        let tmp90 = new.target;
        let str27 = "Unexpected end";
        let tmp91 = new.target;
        let error6 = new Error("Unexpected end");
        let tmp93 = error6;
        throw error6;
      }
    }
