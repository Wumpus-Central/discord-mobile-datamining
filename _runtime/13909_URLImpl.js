...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13910).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13910).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = URLImpl(13913).parseUrlencoded(query);
          const tmpResult = URLImpl(13913);
        }
      }
      const obj = URLImpl(13910);
    },
  },
  {
    key: "origin",
    get() {
      return URLImpl(13910).serializeURLOrigin(this._url);
    },
  },
  {
    key: "protocol",
    ...
    set(arg0) {
      URLImpl(13910).basicURLParse(`${arg0}:`, { url: this._url, stateOverride: "scheme start" });
    },
  },
  {
    key: "username",
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13910).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13910);
      }
      obj = URLImpl(13910);
    },
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13910).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13910);
      }
      obj = URLImpl(13910);
    },
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13910).serializeHost(host);
        const obj3 = URLImpl(13910);
      } else {
        const obj = URLImpl(13910);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13910).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13910);
      }
    },
    set(arg0) {
      if (!this._url.cannotBeABaseURL) {
        const obj2 = { url: tmp._url, stateOverride: "host" };
        URLImpl(13910).basicURLParse(arg0, obj2);
        const obj = URLImpl(13910);
      }
    },
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13910).serializeHost(tmp._url.host);
        const obj = URLImpl(13910);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13910).serializeInteger(tmp._url.port);
        const obj = URLImpl(13910);
      }
      return str;
    },
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        URLImpl(13910).basicURLParse(substr, obj2);
        const obj = URLImpl(13910);
        self._query._list = URLImpl(13913).parseUrlencoded(substr);
        const obj3 = URLImpl(13913);
      }
    },
  },
  {
