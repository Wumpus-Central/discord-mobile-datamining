// _runtime/12430_JSONSchemaGenerator.js
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12428).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12428).extractDefs(self.ctx, _idmap);
      return _objectWithoutProperties(JSONSchemaGenerator(12428).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
