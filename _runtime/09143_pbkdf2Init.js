// _runtime/09143_pbkdf2Init.js
import asyncGeneratorStep from "asyncGeneratorStep";
import { _asyncLoop } from "09140__asyncLoop.js";
import { number } from "09141_number.js";
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9140).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9144).hmac;
    let obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9140).toBytes(B);
