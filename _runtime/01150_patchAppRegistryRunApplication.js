// _runtime/01150_patchAppRegistryRunApplication.js
import registerSpanErrorInstrumentation from "00814_registerSpanErrorInstrumentation.js";
import { fillTyped } from "01151_fillTyped.js";
...
function patchAppRegistryRunApplication(arg0) {
  const _require = arg0;
  AppRegistry = require("00994_TurboModuleRegistry.js").ReactNativeLibraries.AppRegistry;
  if (AppRegistry) {
    require("01151_fillTyped.js").fillTyped(AppRegistry, "runApplication", (arg0) => {
      closure_0 = arg0;
      return () => {
