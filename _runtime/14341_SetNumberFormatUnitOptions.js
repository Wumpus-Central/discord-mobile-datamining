// _runtime/14341_SetNumberFormatUnitOptions.js
import _mod14295 from "metro/14295__.js";
import GetOption from "14300_GetOption.js";
import IsWellFormedCurrencyCode from "14305_IsWellFormedCurrencyCode.js";
import IsWellFormedUnitIdentifier from "14306_IsWellFormedUnitIdentifier.js";
...
export const SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  _mod14295.invariant(result, "Malformed currency code", RangeError);
  let tmp10 = "currency" !== GetOptionResult;
  if (!tmp10) {
    tmp10 = undefined !== str;
  }
  _mod14295.invariant(tmp10, "currency cannot be undefined", TypeError);
  ...
  _mod14295.invariant(result1, "Invalid unit argument for Intl.NumberFormat()", RangeError);
  let tmp17 = "unit" !== GetOptionResult;
  if (!tmp17) {
    tmp17 = undefined !== GetOptionResult3;
  }
  _mod14295.invariant(tmp17, "unit cannot be undefined", TypeError);
