...
let fn = function n(toValue, userConfig, callback) {
  ...
  obj = {
    userConfig,
    checkIfConfigIsValid: require("01719_checkIfConfigIsValid.js").checkIfConfigIsValid,
    underDampedSpringCalculations: require("01719_checkIfConfigIsValid.js").underDampedSpringCalculations,
    criticallyDampedSpringCalculations: require("01719_checkIfConfigIsValid.js").criticallyDampedSpringCalculations,
    isAnimationTerminatingCalculation: require("01719_checkIfConfigIsValid.js").isAnimationTerminatingCalculation,
    calculateNewMassToMatchDuration: require("01719_checkIfConfigIsValid.js").calculateNewMassToMatchDuration,
    initialCalculations: require("01719_checkIfConfigIsValid.js").initialCalculations,
    scaleZetaToMatchClamps: require("01719_checkIfConfigIsValid.js").scaleZetaToMatchClamps,
    toValue,
    callback,
