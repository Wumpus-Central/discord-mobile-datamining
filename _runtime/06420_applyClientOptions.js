// _runtime/06420_applyClientOptions.js
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (environment.message) {
    environment.message = require(6380) /* isMatchingPattern */.truncate(environment.message, num);
    const obj = require(6380) /* isMatchingPattern */;
  }
  let value = iter;
  ...
  if (value) {
    iter.value = require(6380) /* isMatchingPattern */.truncate(iter.value, num);
    const obj2 = require(6380) /* isMatchingPattern */;
  }
  ...
  if (url) {
    request.url = require(6380) /* isMatchingPattern */.truncate(request.url, num);
    const obj3 = require(6380) /* isMatchingPattern */;
  }
}
function applyDebugIds(exception) {
  _require = _require(6423).getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(6416).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(6416);
                }
