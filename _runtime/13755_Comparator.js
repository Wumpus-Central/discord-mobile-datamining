...
class Comparator {
  constructor(arg0, arg1) {
    ...
    tmp2 = Comparator;
    tmp3 = closure_1;
    tmp4 = require("metro/13728__.js")(require);
    str = global;
    ...
    parts = str2.split(/\s+/);
    joined = parts.join(" ");
    tmp6 = require("metro/13730__.js")("comparator", joined, tmp4);
    self.options = tmp4;
    ...
    tmp8 = require("metro/13730__.js")("comp", self);
    return;
  }
}
let obj = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(13731).safeRe;
    const t = Comparator(13731).t;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(13727)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
...
const items = [
  ...
  },
  {
    ...
    value: function test(arg0) {
      const self = this;
      let tmp = arg0;
      Comparator(13730)("Comparator.test", arg0, this.options.loose);
      if (this.semver !== closure_3) {
        if (tmp !== tmp5) {
          if (typeof tmp === "string") {
            try {
              tmp = new tmp2(13727)(tmp, self.options);
            } catch (err) {
              return false;
            }
          }
          return tmp2(13753)(tmp, self.operator, self.semver, self.options);
        }
      }
      return true;
    },
    ...
    value: function intersects(value) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(13756)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(13756)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(13728)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(13753)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(13753)(self.semver, ">", value.semver, tmp45);
