// === Module 1786: checkSharedValueUsage ===

// Module 1786 (checkSharedValueUsage)
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import t from "t" /* 1647 */;
import updateProps from "updateProps" /* 1736 */;
import isAnimated from "isAnimated" /* 1782 */;
...
function styleUpdater(arg0, arg1, animations) {
  ...
  if (boxShadow) {
    _require(1787).processBoxShadow(obj);
    const obj3 = _require(1787);
  }
  obj = {};
  let flag2 = false;
  let flag3 = false;
  ...
  if (flag5) {
    ...
    if (flag4) {
      _require(1736).updateProps(arg0, obj);
      const obj8 = _require(1736);
    }
  } else {
    animations.isAnimationCancelled = true;
    animations.animations = [];
    let shallowEqualResult = _require(1782).shallowEqual(last, obj);
