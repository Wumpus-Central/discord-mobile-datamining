// _runtime/01786_checkSharedValueUsage.js
import get_ActivityIndicator from "00017_get_ActivityIndicator.js";
import t from "01647_t.js";
import updateProps from "01736_updateProps.js";
import isAnimated from "01782_isAnimated.js";
...
function styleUpdater(arg0, arg1, animations) {
  ...
  if (boxShadow) {
    require("01787_o.js").processBoxShadow(obj);
    const obj3 = o;
  }
  obj = {};
  let flag2 = false;
  ...
  if (flag5) {
    ...
    if (flag4) {
      require("01736_updateProps.js").updateProps(arg0, obj);
      const obj8 = updateProps;
    }
  } else {
    animations.isAnimationCancelled = true;
    animations.animations = [];
    let shallowEqualResult = require("01782_isAnimated.js").shallowEqual(last, obj);
    if (shallowEqualResult) {
      shallowEqualResult = !arg5;
    }
    if (!shallowEqualResult) {
      tmp19(1736).updateProps(arg0, obj, flag);
...
obj = {
  ...
  prepareAnimation,
  runAnimations,
  updatePropsJestWrapper: updateProps.updatePropsJestWrapper,
  shallowEqual: isAnimated.shallowEqual,
};
...
export const useAnimatedStyle = function useAnimatedStyle(fn, items, arg2, arg3) {
  ...
  callback(() => {
    ...
    if (obj2.isJest()) {
      ...
      obj = {
        jestStyleUpdater: null,
        shareableViewDescriptors: null,
        updater: null,
        remoteState: null,
        areAnimationsActive: null,
        jestAnimatedValues: null,
        adaptersArray: null,
      };
      ...
      if (isFirstRun) {
        ...
        const animationFrame = requestAnimationFrame(() => {
          ...
          obj = {
            styleUpdater: c8,
            shareableViewDescriptors: closure_1_9,
            updaterFn: fn,
            remoteState: closure_1_8,
            areAnimationsActive: closure_1_6,
            isAnimatedProps: closure_1_2,
          };
          fn.__closure = obj;
