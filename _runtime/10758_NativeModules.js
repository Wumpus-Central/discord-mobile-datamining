// _runtime/10758_NativeModules.js
import _mod10760 from "metro/10760__.js";
import RNIapAmazonModuleAll from "10766_RNIapAmazonModule.js";
import NativeModulesAll from "10767_NativeModules.js";
import fetchJsonOrThrowAll from "10768_fetchJsonOrThrow.js";
import syncAll from "10769_sync.js";
...
const subs = require("metro/10759__.js").ProductType.subs;
const inapp = require("metro/10759__.js").ProductType.inapp;
...
export const isIosStorekit2 = require("metro/10760__.js").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
