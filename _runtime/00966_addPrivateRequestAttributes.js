// _runtime/00966_addPrivateRequestAttributes.js
...
import handleResponseError from "00967_handleResponseError.js";
                        ...
                        if (!BooleanResult) {
                          if (!tmp12) {
                            ...
                            return tmp2Result.startSpan(obj, (setAttributes) => {
                              ...
                              return str(dependencyMap[9]).handleCallbackErrors(() => { ... }, () => { ... }, /* F119627 */ function() { ... }, () => { ... });
                            });
                          }
                        }
                        dependencyMap = closure_0;
                            ...
                            if (arg2.length > 0) {
                              if (typeof arg2[0] === "object") {
                                ...
                                if (BooleanResult) {
                                  if (!tmp12) {
                                    closure_0 = undefined;
                                    closure_0 = _self(/* F123774 */ function() { ... });
