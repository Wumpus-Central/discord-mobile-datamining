// _runtime/00897_getHttpSpanDetailsFromUrlObject.js
const require = arg1;
...
arg5.getHttpSpanDetailsFromUrlObject = function getHttpSpanDetailsFromUrlObject(hash, arg1, arg2, method) {
  ...
  if (arg4) {
    ...
    obj[str2] = str;
    obj[tmp(836).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = "route";
  }
  method = undefined;
  if (method != null) {
  ...
  if (method) {
    obj[tmp(836).SEMANTIC_ATTRIBUTE_HTTP_REQUEST_METHOD] = method.method.toUpperCase();
  ...
  if (hash) {
    ...
    if (!("isRelative" in hash)) {
      obj[tmp(836).SEMANTIC_ATTRIBUTE_URL_FULL] = hash.href;
      if (hash.port) {
