// _runtime/05952_Color.js
import _mod5953 from "metro/05953__.js";
import _mod5957 from "metro/05957__.js";
...
function _loop(item10136) {
  ...
  if (closure_3.includes(item10136)) {
    ...
    channels = require("metro/05953__.js")[item10136].channels;
    Color.prototype[item10136] = function () {
      ...
      if (this.model === closure_0) {
        ...
        const rawResult = _mod5953[self.model][closure_0].raw(self.color);
        const _Array = Array;
        let tmp2 = rawResult;
