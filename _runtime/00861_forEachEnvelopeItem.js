// _runtime/00861_forEachEnvelopeItem.js
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    ...
    let sentryCarrier = require("00822_getGlobalSingleton.js").getSentryCarrier(require("metro/00818__.js").GLOBAL_OBJ);
    if (sentryCarrier.encodePolyfill) {
    ...
    if (typeof tmp8[1] !== "string") {
      ...
      if (!(tmp10 instanceof Uint8Array)) {
        try {
          ...
          json = _JSON3.stringify(require("00862_normalize.js").normalize(tmp3));
          const obj = normalize;
        }
      }
    }
