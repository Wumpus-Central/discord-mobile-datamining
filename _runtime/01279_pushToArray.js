...
export default (arg0, allowEmptyArrays) => {
  if (allowEmptyArrays) {
    ...
    obj.addQueryPrefix = typeof allowEmptyArrays.addQueryPrefix === "boolean" ? allowEmptyArrays.addQueryPrefix : obj.addQueryPrefix;
    ...
    obj.charset = charset;
    obj.charsetSentinel = typeof allowEmptyArrays.charsetSentinel === "boolean" ? allowEmptyArrays.charsetSentinel : obj.charsetSentinel;
    ...
    obj.encodeDotInKeys = typeof allowEmptyArrays.encodeDotInKeys === "boolean" ? allowEmptyArrays.encodeDotInKeys : obj.encodeDotInKeys;
    obj.encoder = typeof allowEmptyArrays.encoder === "function" ? allowEmptyArrays.encoder : obj.encoder;
    obj.encodeValuesOnly = typeof allowEmptyArrays.encodeValuesOnly === "boolean" ? allowEmptyArrays.encodeValuesOnly : obj.encodeValuesOnly;
    obj.filter = filter;
    obj.format = format;
    obj.formatter = _mod1276.formatters[format];
    obj.serializeDate = typeof allowEmptyArrays.serializeDate === "function" ? allowEmptyArrays.serializeDate : obj.serializeDate;
    ...
    obj.sort = sort;
    obj.strictNullHandling = typeof allowEmptyArrays.strictNullHandling === "boolean" ? allowEmptyArrays.strictNullHandling : obj.strictNullHandling;
  } else {
