...
function withStyleAnimation(animations) {
  ...
  obj = { ColorProperties: _require(1649).ColorProperties, setPath, processColor: _require(1649).processColor, styleAnimations: animations, resolvePath, __DEV__: false, logger: _require(1610).logger, isValidLayoutAnimationProp: _require(1646).isValidLayoutAnimationProp, withTiming: _require(1657).withTiming };
  fn.__closure = obj;
