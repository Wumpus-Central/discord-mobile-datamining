...
function withStyleAnimation(animations) {
  ...
  obj = { ColorProperties: _require("01649_call.js").ColorProperties, setPath, processColor: _require("01649_call.js").processColor, styleAnimations: animations, resolvePath, __DEV__: false, logger: _require("01610_addLogBoxLog.js").logger, isValidLayoutAnimationProp: _require("01646_isValidLayoutAnimationProp.js").isValidLayoutAnimationProp, withTiming: _require("01657_t.js").withTiming };
  fn.__closure = obj;
