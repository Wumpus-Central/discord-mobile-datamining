...
let fn = function n(config, _animationToClamp) {
  ...
  obj = { _animationToClamp, config, recognizePrefixSuffix: _require(1693).recognizePrefixSuffix, logger: _require(1657).logger, getReduceMotionForAnimation: _require(1693).getReduceMotionForAnimation };
  fn.__closure = obj;
