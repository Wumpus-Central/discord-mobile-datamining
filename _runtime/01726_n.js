...
let fn = function n(config, _animationToClamp) {
  ...
  obj = { _animationToClamp, config, recognizePrefixSuffix: require("01693_isValidLayoutAnimationProp.js").recognizePrefixSuffix, logger: require("01657_addLogBoxLog.js").logger, getReduceMotionForAnimation: require("01693_isValidLayoutAnimationProp.js").getReduceMotionForAnimation };
  fn.__closure = obj;
