...
arg5.getGlobalScope = function getGlobalScope() {
  return require("00825_getGlobalSingleton.js") /* getGlobalSingleton */.getGlobalSingleton("globalScope", () => {
...
arg5.withIsolationScope = function withIsolationScope() {
  ...
  const obj2 = require("00841_getAsyncContextStrategy.js") /* getAsyncContextStrategy */;
};
