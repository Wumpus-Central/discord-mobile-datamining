// _runtime/01293_MessageLoader.js
  ...
  constructor(arg0, arg1) {
    ...
    if (closure_1.hot) {
      ...
      _loop = function _loop(arg0) {
        ...
        hot = hot.hot;
        hot.accept(hot, () =>
          closure_2_5(closure_0, undefined, undefined, function () {
            self = this;
            c2 = 0;
            c3 = 0;
            return (function* () {
    ...
    value: function getMessageValue(arg0, defaultLocale) {
      ...
      if (tmp2) {
        ...
        if (null != self.messages[defaultLocale][arg0]) {
          const internalIntlMessage = new MessageLoader(1292).InternalIntlMessage(tmp4, defaultLocale);
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            obj1 = { value: null, done: false };
            obj1[0] = Promise.all(
              closure_1_7.map((waitForDefaultLocale) => waitForDefaultLocale.waitForDefaultLocale()),
            );
            return obj1;
          }
        } else if (arg0 === 1) {
