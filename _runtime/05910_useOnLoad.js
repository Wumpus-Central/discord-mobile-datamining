// _runtime/05910_useOnLoad.js
import closure_2 from "metro/05863__slicedToArray.js";
...
export const useOnListLoad = (getDataLength) => {
  ...
  const requestAnimationFrame = _require(f80345[2]).useUnmountAwareAnimationFrame().requestAnimationFrame;
