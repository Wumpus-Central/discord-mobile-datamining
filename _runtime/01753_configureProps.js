...
import { 01667__ } from "metro/01667__.js";

function configureProps() {
  for (const key10008 in 01667__.PropsAllowlists.NATIVE_THREAD_PROPS_WHITELIST) {
    let tmp8 = key10008;
    let tmp9 = require;
    let tmp10 = dependencyMap;
    if (!(key10008 in 01667__.PropsAllowlists.UI_THREAD_PROPS_WHITELIST)) {
      continue;
    } else {
      let tmp = globalThis;
  ...
  const keys = Object.keys(01667__.PropsAllowlists.UI_THREAD_PROPS_WHITELIST);
  isReanimated3.jsiConfigureProps(keys, Object.keys(01667__.PropsAllowlists.NATIVE_THREAD_PROPS_WHITELIST));
}
...
export const addWhitelistedNativeProps = function addWhitelistedNativeProps(arg0) {
  const merged = Object.assign(01667__.PropsAllowlists.NATIVE_THREAD_PROPS_WHITELIST);
  const merged1 = Object.assign(arg0);
  01667__.PropsAllowlists.NATIVE_THREAD_PROPS_WHITELIST = {};
  if (Object.keys(01667__.PropsAllowlists.NATIVE_THREAD_PROPS_WHITELIST).length !== Object.keys(01667__.PropsAllowlists.NATIVE_THREAD_PROPS_WHITELIST).length) {
    configureProps();
  }
};
export const addWhitelistedUIProps = function addWhitelistedUIProps(arg0) {
  const merged = Object.assign(01667__.PropsAllowlists.UI_THREAD_PROPS_WHITELIST);
  const merged1 = Object.assign(arg0);
  01667__.PropsAllowlists.UI_THREAD_PROPS_WHITELIST = {};
  if (Object.keys(01667__.PropsAllowlists.UI_THREAD_PROPS_WHITELIST).length !== Object.keys(01667__.PropsAllowlists.UI_THREAD_PROPS_WHITELIST).length) {
    configureProps();
  }
};
