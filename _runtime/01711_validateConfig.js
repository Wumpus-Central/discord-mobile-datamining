...
let fn = function n(userConfig, callback) {
  ...
  obj = {
    userConfig,
    isValidRubberBandConfig: require("01712_isValidRubberBandConfig.js").isValidRubberBandConfig,
    rubberBandDecay: require("01713_rubberBandDecay.js").rubberBandDecay,
    rigidDecay: require("01714_rigidDecay.js").rigidDecay,
    validateConfig,
    callback,
