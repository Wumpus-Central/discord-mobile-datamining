// _runtime/01790_eulerToQuaternion.js
...
function adjustRotationToInterfaceOrientation(pitch) {
  ...
  } else if (interfaceOrientation === tmp(1659).InterfaceOrientation.ROTATION_270) {
    pitch.pitch = -roll;
    pitch.roll = pitch;
    const _Math = Math;
    pitch.yaw = yaw + Math.PI / 2;
  } else if (interfaceOrientation === tmp(1659).InterfaceOrientation.ROTATION_180) {
