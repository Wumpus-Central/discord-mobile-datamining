...
arg5.enableSyncToNative = function enableSyncToNative(globalScope) {
  ...
  if (!weakMap.has(globalScope)) {
    ...
    _require(1019).fillTyped(globalScope, "setUser", (arg0) => {
      closure_0 = arg0;
      return (arg0) => {
    ...
    let obj2 = _require(1019);
    _require(1019).fillTyped(globalScope, "setTag", (arg0) => {
      closure_0 = arg0;
      return (arg0, arg1) => {
        const NATIVE = callback(closure_2_1[1]).NATIVE;
    ...
    const obj3 = _require(1019);
    _require(1019).fillTyped(globalScope, "setTags", (arg0) => {
      closure_0 = arg0;
      return (arg0) => {
        closure_0 = arg0;
    ...
    const obj4 = _require(1019);
    _require(1019).fillTyped(globalScope, "setExtras", (arg0) => {
      closure_0 = arg0;
      return (arg0) => {
        closure_0 = arg0;
        const keys = Object.keys(arg0);
    ...
    const obj5 = _require(1019);
    _require(1019).fillTyped(globalScope, "setExtra", (arg0) => {
      closure_0 = arg0;
      return (arg0, arg1) => {
        const NATIVE = callback(closure_2_1[1]).NATIVE;
    ...
    const obj6 = _require(1019);
    _require(1019).fillTyped(globalScope, "addBreadcrumb", (arg0) => {
      closure_0 = arg0;
      return (level) => {
    ...
    const obj7 = _require(1019);
    _require(1019).fillTyped(globalScope, "clearBreadcrumbs", (arg0) => {
      closure_0 = arg0;
      return () => {
        const NATIVE = callback(closure_2_1[1]).NATIVE;
    ...
    const obj8 = _require(1019);
    _require(1019).fillTyped(globalScope, "setContext", (arg0) => {
      closure_0 = arg0;
      return (arg0, arg1) => {
        const NATIVE = callback(closure_2_1[1]).NATIVE;
