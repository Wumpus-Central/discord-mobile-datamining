// _runtime/01710_convertAnimationObjectToKeyframes.js
  ...
  while (tmp2 !== undefined) {
    ...
    for (const item10063 of entries1) {
      ...
      if ("easing" !== first) {
        ...
        let tmp40 = arr;
        if (arr in require("01711_getEasingByName.js").WebEasings) {
          str = arr;
        } else if (arr.name in tmp38(1711).WebEasings) {
          let tmp19 = arr;
          str = arr.name;
        }
        let tmp20 = _require;
        let tmp21 = str;
        let str2 = tmp38(1711).WebEasings[str];
