// _runtime/07886__isNativeReflectConstruct.js
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(7887), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(7889), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(7891), obj);
    items[3] = callback3(FeDropShadow(7880), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(7895), {}), callback3(FeDropShadow(7895), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(7893), obj);
    obj[0] = items;
