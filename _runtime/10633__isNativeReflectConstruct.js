// _runtime/10633__isNativeReflectConstruct.js
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return SVWeekdayParser(10473).createParsingComponentsAtWeekday(
        reference.reference,
        SVWeekdayParser(10634).WEEKDAY_DICTIONARY[formatted],
        str4,
      );
    },
  },
