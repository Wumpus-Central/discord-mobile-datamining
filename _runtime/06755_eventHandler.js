...
obj = { flattenAndFilterEvent: fn(6737).flattenAndFilterEvent, runCallback: fn(6737).runCallback, CALLBACK_TYPE: fn(6690).CALLBACK_TYPE };
...
obj = { TouchEventType: fn(6677).TouchEventType, runCallback: fn(6737).runCallback, touchEventTypeToCallbackType: fn(6737).touchEventTypeToCallbackType };
