// _runtime/05068_OrdinaryDefineOwnProperty.js
...
import _mod5070 from "metro/05070__.js";
import ValidateAndApplyPropertyDescriptor from "05071_ValidateAndApplyPropertyDescriptor.js";

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod5005(arg0)) {
    if (_mod5052(arg1)) {
      if (_mod5056(__Writable__)) {
        if (_mod1283) {
          ...
          return ValidateAndApplyPropertyDescriptor(arg0, arg1, _mod5070(arg0), __Writable__, tmp31);
