...
import applyClientOptions from "12384_applyClientOptions.js";
...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  let currentScope = require("12362_getClient.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = getClient;
  let client = require("12362_getClient.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = getClient;
  captureCheckInResult = require("12346_addContextToFrame.js").uuid4();
};