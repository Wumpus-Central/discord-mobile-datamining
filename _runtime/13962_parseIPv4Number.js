// _runtime/13962_parseIPv4Number.js
import Buffer from "00511_Buffer.js";
import error from "13963_error.js";
import _mod13964 from "metro/13964__.js";
import replaceByteInByteSequence from "13965_replaceByteInByteSequence.js";
  ...
  parse port(arg0, arg1) {
    ...
    if (obj.isASCIIDigit(arg0)) {
      ...
      if ("" !== self.buffer) {
        ...
        num6 = 2;
        num7 = 1;
        if (parsed > require("00002_set.js") - 1) {
          flag3 = true;
          self.parseError = true;
          tmp7 = closure_4;
          return closure_4;
      ...
      if (47 !== arg0) {
        ...
        if (undefined === closure_3[self.url.scheme]) {
          ...
          if (!tmp) {
            ...
            if (isASCIIHexResult) {
              tmp2Result = require("metro/13964__.js");
              num6 = 2;
    ...
    if (63 === arg0) {
      ...
      if (35 === arg0) {
        ...
        if (!tmp2) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmp3Result = require("metro/13964__.js");
            num4 = 2;
    ...
    if (!isNaN(arg0)) {
      ...
      if (0 === arg0) {
        ...
        if (!tmp4) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmpResult = require("metro/13964__.js");
            num3 = 2;
