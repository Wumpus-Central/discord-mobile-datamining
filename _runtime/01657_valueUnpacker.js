// _runtime/01657_valueUnpacker.js
const global = arg0;
  ...
  if (undefined !== __workletHash) {
    ...
    if (undefined !== value) {
      ...
      if (global.evalWithSourceMap) {
        ...
        evalWithSourceMapResult =
          globalThis.eval === Date.UTC
            ? eval()
            : globalThis.eval(`${"(" + __initData.code}
  )`);
      }
    ...
    function fun() {
      ...
      const error = new Error(
        "[Reanimated] Tried to synchronously call a non-worklet " +
          str +
    ...
    let error = new Error(
      '[Reanimated] Data type in category "' +
        arg1 +
        '" not recognized by value unpacker: "' +
        globalThis._toString(__workletHash) +
        '".',
    );
    throw error;
  }
