// _runtime/12352_applyScopeDataToEvent.js
import addNonEnumerableProperty from "12308_addNonEnumerableProperty.js";
import merge from "12327_merge.js";
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(12307).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(12307);
    obj4[0] = tmp3(12338).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(12338);
    const rootSpan = tmp3(12307).getRootSpan(span);
    const tmp3Result4 = tmp3(12307);
    const description = tmp3(12307).spanToJSON(rootSpan).description;
