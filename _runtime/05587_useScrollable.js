...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(_require(5572).SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = _require(1654).useSharedValue(0);
  const obj2 = _require(1654);
  const sharedValue2 = _require(1654).useSharedValue(_require(5572).SCROLLABLE_STATE.UNDETERMINED);
