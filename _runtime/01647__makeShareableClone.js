      ...
      if (undefined !== _mod1649.createReactDOMStyle) {
        if (undefined !== animatableRef.style) {
          if (typeof updatePropsDOM === "function") {
            ...
            const reactDOMStyle = _mod1649.createReactDOMStyle(obj4);
            const _Array = Array;
            const tmp36Result = _mod1649;
            if (tmp18) {
              reactDOMStyle.transform = _mod1649.createTransformValue(reactDOMStyle.transform);
              const tmp36Result3 = _mod1649;
            }
            let tmp19 = undefined !== _mod1649.createTextShadowValue;
            if (tmp19) {
            ...
            if (tmp19) {
              ...
              reactDOMStyle.textShadow = _mod1649.createTextShadowValue({ textShadowColor: null, textShadowOffset: null, textShadowRadius: null });
              const obj5 = { textShadowColor: null, textShadowOffset: null, textShadowRadius: null };
              const tmp36Result4 = _mod1649;
            }
            ...
            tmp18 = Array.isArray(reactDOMStyle.transform) && undefined !== _mod1649.createTransformValue;
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
