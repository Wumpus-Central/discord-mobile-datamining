// _runtime/07218_CardContainer.js
import Link from "01485_Link.js";
import _mod5801 from "metro/05801__.js";
import ModalPresentationContext from "07208_ModalPresentationContext.js";
import _mod7219 from "metro/07219__.js";
import CardA11yWrapper from "07220_CardA11yWrapper.js";
import _mod7221 from "metro/07221__.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5801.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5801;
  }
  closure_15 = tmp12;
