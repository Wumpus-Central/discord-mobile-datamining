// _runtime/14225_FormatNumericToString.js
import TEN from "14211_TEN.js";

const _mod14209 = tmp5(14209);
const GetUnsignedRoundingMode = tmp5(14226);
const ToRawPrecision = tmp5(14227);
const ToRawFixed = tmp5(14228);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14209.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14209.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
