// _runtime/10632__isNativeReflectConstruct.js
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ITWeekdayParser(10477).createParsingComponentsAtWeekday(
        reference.reference,
        ITWeekdayParser(10619).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
