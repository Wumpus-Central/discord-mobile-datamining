// _runtime/08464_appendTransformProps.js
import append from "08465_append.js";
import peg$SyntaxError from "08466_peg_SyntaxError.js";
import _mod8467 from "metro/08467__.js";
...
export const extractTransformSvgView = function extractTransformSvgView(transform) {
  if (typeof transform.transform === "string") {
    transform = _mod8467.parse(transform.transform);
  } else {
    transform = transform.transform;
  }
  return transform;
