// _runtime/07455_getCurrentHubShim.js
import { getClient } from "07374_getClient.js";
import { _flush } from "07395__flush.js";
import { addBreadcrumb } from "07420_addBreadcrumb.js";
const require = arg1;
const dependencyMap = arg6;
function getCurrentHubShim() {
  return {
    bindClient(arg0) {
      const currentScope = callback(7374).getCurrentScope();
      currentScope.setClient(arg0);
    },
    withScope: getClient.withScope,
    getClient() {
      return callback(7374).getClient();
    },
    ...
    getIntegration(id) {
      const client = callback(7374).getClient();
