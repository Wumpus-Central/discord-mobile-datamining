// _runtime/12308_addNonEnumerableProperty.js
import __SENTRY_DEBUG__ from "metro/12301___SENTRY_DEBUG__.js";
...
function addNonEnumerableProperty(arg0, arg1, arg2) {
  try {
    ...
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      const logger = tmp6(12302).logger;
...
arg5.fill = function fill(arg0, arg1, arg2) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (__SENTRY_DEBUG__.DEBUG_BUILD) {
        const logger = tmp7(12302).logger;
        const _HermesInternal = HermesInternal;
