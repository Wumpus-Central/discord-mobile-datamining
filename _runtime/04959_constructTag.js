// _runtime/04959_constructTag.js
import { getDataView } from "04912_getDataView.js";
import { 04919__ } from "metro/04919__.js";
const require = arg1;
const module = arg2;
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== 04919__.TYPE_TEXT) {
    combined = stringValueFromArray;
    if (0 !== items2.length) {
      const _HermesInternal = HermesInternal;
      combined = "" + stringValueFromArray + " (" + tmp4(4912).getStringValueFromArray(items2) + ")";
      const tmp4Result = tmp4(4912);
    }
  }
  obj = { name: combined, value: stringFromDataView, description: null };
  if (type === 04919__.TYPE_ITXT) {
    stringFromDataView = module(4945).decode("UTF-8", decompressResult);
    const obj5 = module(4945);
  }
