...
obj = { flattenAndFilterEvent: fn(6794).flattenAndFilterEvent, runCallback: fn(6794).runCallback, CALLBACK_TYPE: fn(6747).CALLBACK_TYPE };
...
obj = { TouchEventType: fn(6734).TouchEventType, runCallback: fn(6794).runCallback, touchEventTypeToCallbackType: fn(6794).touchEventTypeToCallbackType };
