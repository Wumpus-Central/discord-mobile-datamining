// _runtime/01739_validateTransformOrigin.js
    ...
    if (match) {
      while (true) {
        ...
        if ("left" !== formatted) {
          if ("right" !== formatted) {
            ...
            if (2 === num4) {
              ...
              let reanimatedError1 = new _mod1648.ReanimatedError(
        ...
        if (0 !== num4) {
          ...
          let reanimatedError3 = new _mod1648.ReanimatedError(
            "Transform-origin " + str + " can only be used for x-position",
          );
          throw reanimatedError3;
        } else {
          let num3 = "100%";
