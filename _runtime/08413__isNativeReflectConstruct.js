// _runtime/08413__isNativeReflectConstruct.js
...
import { extractOpacity } from "08415_extractOpacity.js";
import { keys } from "08416_keys.js";
import { _isNativeReflectConstruct } from "08423__isNativeReflectConstruct.js";
import { __INTERNAL_VIEW_CONFIG } from "metro/08421___INTERNAL_VIEW_CONFIG.js";
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(8417).extractTransformSvgView(tmp);
        const obj3 = self(8417);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8422)({ viewBox, preserveAspectRatio }));
