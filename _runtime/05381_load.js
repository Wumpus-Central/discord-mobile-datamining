// _runtime/05381_load.js
import _modDef5382 from "metro/05382__.js";
...
function loadView(byteLength) {
  ...
  let obj2 = require("metro/05385__.js");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("metro/05385__.js").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("metro/05386__.js").USE_JPEG) {
    flag4 = false;
  ...
  const parseAppMarkersResult = require("metro/05385__.js").parseAppMarkers(byteLength, flag2);
