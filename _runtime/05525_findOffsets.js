// _runtime/05525_findOffsets.js
import _mod5516 from "metro/05516__.js";
import _modDef5519 from "metro/05519__.js";
import get64BitValue from "05526_get64BitValue.js";
...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint321) {
      const obj4 = { type: "ftyp", majorBrand: _mod5516.getStringFromDataView(getUint32, contentOffset, 4), length };
      return obj4;
      ...
      const stringFromDataView = _mod5516.getStringFromDataView(getUint32, contentOffset, 4);
      ...
      if (1835365473 === uint321) {
        ...
        if (!tmp3) {
          ...
          const sum8 = sum7 + 2;
          obj17.itemName = _mod5516.getNullTerminatedStringFromDataView(getUint32, sum8);
        ...
        if (uint8 >= 2) {
          ...
          const sum12 = sum11 + 4;
          obj17.itemName = _mod5516.getNullTerminatedStringFromDataView(getUint32, sum12);
          const sum13 = sum12 + (obj17.itemName.length + 1);
          if (obj17.itemType === c4) {
            obj17.contentType = _mod5516.getNullTerminatedStringFromDataView(getUint32, sum13);
            const sum14 = sum13 + (obj17.contentType.length + 1);
            parseItemLocationBoxResult = obj17;
            if (sum + length > sum14) {
              obj17.contentEncoding = _mod5516.getNullTerminatedStringFromDataView(getUint32, sum14);
              const sum15 = obj17.contentEncoding.length + 1;
              parseItemLocationBoxResult = obj17;
              const tmp13Result3 = _mod5516;
            }
            const tmp13Result = _mod5516;
          } else {
            parseItemLocationBoxResult = obj17;
            if (obj17.itemType === c5) {
              obj17.itemUri = _mod5516.getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj17.itemUri.length + 1;
              parseItemLocationBoxResult = obj17;
              const tmp13Result4 = _mod5516;
            }
          }
        }
      } else {
