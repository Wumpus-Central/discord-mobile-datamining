// === Module 12249: initializeContext ===
...
function initializeContext(target) {
  ...
  if (metadata == null) {
    metadata = require(12247) /* $output */.globalRegistry;
  }
  obj[1] = metadata;
  obj[2] = str;
  let str2;
...
function process(_zod, seen) {
  ...
  if (value) {
    ...
    obj = { schema: null, count: 1, cycle: "Array", path: "CLIENT_MISSING_GATEWAY_CONFIGURATION" };
    obj[0] = {};
    obj[3] = tmp4.path;
