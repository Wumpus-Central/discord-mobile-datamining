              ...
              if ("Firefox" == text1) {
                ...
                if ("Safari" == text1) {
                  ...
                  if (tmp272) {
                    ...
                    if (!isMatch6) {
                      isMatch6 = /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|SRWare Iron|Vivaldi|Web)/.test(text1) && arr15[1];
                      const obj83 = /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|SRWare Iron|Vivaldi|Web)/;
                      const tmp279 = /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|SRWare Iron|Vivaldi|Web)/.test(text1) && arr15[1];
                    }
                    tmp272 = isMatch6;
