// _runtime/07477_NativeModules.js
...
export const getInstallSourceAndroid = () => {
  const InstallSourceAndroid = callback(7469).InstallSourceAndroid;
