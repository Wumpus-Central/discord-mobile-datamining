// _runtime/04923_parseTags.js
import { getDataView } from "04882_getDataView.js";
import { 04924__ } from "metro/04924__.js";
const require = arg1;
...
function parseTags(buffer) {
  ...
  if (buffer.byteLength !== buffer.getUint32()) {
    ...
    const keys = Object.keys(04924__.iccProfile);
    for (let num = 0; num < keys.length; num = num + 1) {
      let tmp = keys[num];
      let tmp2 = require;
      let tmp3 = dependencyMap;
      let iter = 04924__.iccProfile[tmp];
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (stringFromDataView1 === mluc) {
                  ...
                  if (1 === uint324) {
                    ...
                    if (04924__.iccTags[stringFromDataView]) {
