// _runtime/04053_useRiveColor.js
import _slicedToArray from "_slicedToArray";
import { c } from "04035_c.js";
import { RiveColor } from "04043_RiveColor.js";
import { useRiveProperty } from "04048_useRiveProperty.js";

let require = arg1;
require("noop").useCallback;
const f28801 = (colorProperty) => colorProperty.colorProperty(arg1);
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(useRiveProperty.useRiveProperty(instance, FillColor, f28801), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
