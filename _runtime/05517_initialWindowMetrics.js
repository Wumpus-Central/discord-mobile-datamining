// _runtime/05517_initialWindowMetrics.js
import _mod1631 from "metro/01631__.js";
import useFrameSize from "05494_useFrameSize.js";
...
if (null == require("metro/01631__.js").initialWindowMetrics) {
  ...
  initialWindowMetrics = require("metro/01631__.js").initialWindowMetrics;
}
class SafeAreaProviderCompat {
  constructor(arg0) {
    ({ children, style } = global);
    closure_2 = undefined;
    closure_2 = closure_2.useContext(require("metro/01631__.js").SafeAreaInsetsContext);
    obj = {
