// _runtime/07552_addToMetricsAggregator.js
...
import { createChildOrRootSpan } from "07490_createChildOrRootSpan.js";
import { __SENTRY_DEBUG__ } from "metro/07484___SENTRY_DEBUG__.js";
import { 07553__ } from "metro/07553__.js";
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07553__.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07553__.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, 07553__.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07553__.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    ...
    if (typeof fn === "function") {
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _07553__.DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
