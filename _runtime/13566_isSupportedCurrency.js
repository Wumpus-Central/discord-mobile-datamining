// _runtime/13566_isSupportedCurrency.js
import { _formatToParts } from "13483__formatToParts.js";
import { 13567__ } from "metro/13567__.js";
const require = arg1;
...
arg5.getSupportedCurrencies = function getSupportedCurrencies(locale) {
  const items = [];
  const currencies = 13567__.currencies;
