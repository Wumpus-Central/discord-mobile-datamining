// _runtime/08994_QRCode.js
import { QR8bitByte } from "08995_QR8bitByte.js";
import { QRRSBlock } from "08997_QRRSBlock.js";
import { QRBitBuffer } from "08999_QRBitBuffer.js";
import { QRPolynomial } from "09001_QRPolynomial.js";
import { 09000__ } from "metro/09000__.js";
class QRCode {
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = 09000__.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = 09000__.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = 09000__.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
