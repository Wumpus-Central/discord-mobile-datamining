// _runtime/07917_appendTransformProps.js
import append from "07918_append.js";
import peg$SyntaxError from "07919_peg_SyntaxError.js";
import _mod7920 from "metro/07920__.js";
...
export const extractTransformSvgView = function extractTransformSvgView(transform) {
  if (typeof transform.transform === "string") {
    transform = _mod7920.parse(transform.transform);
  } else {
    transform = transform.transform;
  }
  return transform;
