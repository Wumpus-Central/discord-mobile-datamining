// _runtime/08455_JSONSchemaGenerator.js
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(8453).process(arg0, this.ctx, tmp);
    },
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(8453).extractDefs(self.ctx, _idmap);
      return _objectWithoutProperties(JSONSchemaGenerator(8453).finalize(self.ctx, _idmap), closure_4);
    },
  },
];
