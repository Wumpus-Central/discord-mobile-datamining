...
export default function ScreenStack(arg0) {
  ...
  const context = noop.useContext(_mod5248.GHContext);
  const obj2 = {
  ...
  _modDef5247("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5247(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  return jsx(_mod5248.RNSScreensRefContext.Provider, { value: ref, children: null });
};