// _runtime/13846___exportStarResult29.js
import digitsToString from "13827_digitsToString.js";
...
export const ToRawPrecision = function ToRawPrecision(ZERO, minimumSignificantDigits, maximumSignificantDigits, result) {
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(13828).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(13828).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(13828).repeat("0", -num3 - 1)}${arr}`;
