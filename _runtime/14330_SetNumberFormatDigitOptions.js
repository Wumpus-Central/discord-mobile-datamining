// _runtime/14330_SetNumberFormatDigitOptions.js
...
export const SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(
  ...
  if (flag) {
    if (tmp12) {
      ...
      if (undefined === DefaultNumberOptionResult) {
        _mod14283.invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      _mod14283.invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
