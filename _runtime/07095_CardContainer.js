// _runtime/07095_CardContainer.js
import Link from "01484_Link.js";
import _mod5682 from "metro/05682__.js";
import ModalPresentationContext from "07085_ModalPresentationContext.js";
import _mod7096 from "metro/07096__.js";
import CardA11yWrapper from "07097_CardA11yWrapper.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5682.getHeaderTitle(options, route.name);
    href = tmp2Result1.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result2 = _mod5682;
  }
  closure_15 = tmp12;
  ...
  obj8.children = React4(_mod5682.HeaderHeightContext.Provider, obj9);
  obj7.children = React4(_mod5682.HeaderShownContext.Provider, obj8);
  obj6.children = React4(_mod5682.HeaderBackContext.Provider, obj7);
  ...
  obj.children = React4(_mod7098.Card, obj1);
