// _runtime/05399_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05406_AudioTypes.js";
import ImageTypes from "05407_ImageTypes.js";
import VideoTypes from "05408_VideoTypes.js";
import CompressedTypes from "05409_CompressedTypes.js";
import OtherTypes from "05410_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5400).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5400).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5400).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5400).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
