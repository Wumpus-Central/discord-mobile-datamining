// _runtime/13103_SessionFlusher.js
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(13056).dropUndefinedKeys(obj);
    },
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(13077).getIsolationScope();
        ...
        const obj = SessionFlusher(13077);
      }
    },
  },
  {
