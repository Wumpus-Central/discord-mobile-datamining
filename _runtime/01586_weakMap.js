...
export const NavigationContainer = importAllResult.forwardRef(function NavigationContainerInner(direction, ref) {
  ...
  if (tmp22) {
    ...
    obj2.ref = ref;
    obj1[1] = tmp23(tmp12(1486).BaseNavigationContainer, obj2);
    obj[1] = tmp23(tmp12(1583).LinkingContext.Provider, obj1);
    let tmp24 = obj;
  } else {
    obj3 = { value: null, children: null };
    obj3[0] = DefaultTheme;
    obj3[1] = fallback;
    obj[1] = tmp23(tmp12(1486).ThemeProvider, obj3);
    tmp24 = obj;
  }
