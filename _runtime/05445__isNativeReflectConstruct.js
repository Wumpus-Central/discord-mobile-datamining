// _runtime/05445__isNativeReflectConstruct.js
...
import { RNGestureHandlerModule } from "05435_RNGestureHandlerModule.js";
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          ...
          if (self.viewNode) {
            self.attachGestureHandler(require("05452_get_ActivityIndicator.js") /* get ActivityIndicator */(self.viewNode));
          } else {
            const _Error = Error;
