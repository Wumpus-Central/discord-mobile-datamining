// _runtime/09164_QRCode.js
import { QR8bitByte } from "09165_QR8bitByte.js";
import { QRRSBlock } from "09167_QRRSBlock.js";
import { QRBitBuffer } from "09169_QRBitBuffer.js";
import { QRPolynomial } from "09171_QRPolynomial.js";
import { 09170__ } from "metro/09170__.js";
class QRCode {
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = 09170__.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = 09170__.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = 09170__.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
