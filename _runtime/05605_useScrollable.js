// _runtime/05605_useScrollable.js
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(require("05590_GESTURE_SOURCE.js").SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = require("01654_cancelAnimation.js").useSharedValue(0);
  const obj2 = cancelAnimation;
  const sharedValue2 = require("01654_cancelAnimation.js").useSharedValue(require("05590_GESTURE_SOURCE.js").SCROLLABLE_STATE.UNDETERMINED);
