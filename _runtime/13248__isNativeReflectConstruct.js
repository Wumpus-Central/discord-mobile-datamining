// _runtime/13248__isNativeReflectConstruct.js
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      if (renderDots) {
        ...
        obj[12] = tmp11;
        obj[13] = tmp12;
        Pagination = jsx(Pagination(13249), { carouselRef: null, tappable: null, activeOpacity: null, color: null, containerStyle: null, style: null, inactiveColor: null, inactiveOpacity: null, inactiveScale: null, inactiveStyle: null, animatedDuration: null, animatedFriction: null, animatedTension: null, delayPressInDot: null });
        const _Array = Array;
        const tmp13 = jsx;
        const tmp16 = Pagination(13249);
        const items = [];
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (dotsLength) {
        if (dotsLength >= 2) {
          const items = [Pagination(13250).sliderPagination, , ];
          let str2 = "column";
          if (!tmp) {
            let str = "row";
