...
let fn = function t(toValue, userConfig, callback) {
  ...
  obj = { Easing: require("01706_linear.js").Easing, userConfig, toValue, callback, getReduceMotionForAnimation: require("01694_isValidLayoutAnimationProp.js").getReduceMotionForAnimation };
  fn.__closure = obj;
