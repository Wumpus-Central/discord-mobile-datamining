                ...
                if (1 === tmp5) {
                  if (arg0 === 1) {
                    ...
                    if (null == closure_131_2) {
                      c6 = 3;
                      const obj2 = { value: closure_4._loadLocale(closure_131_0), done: true };
                      return obj2;
                    } else {
                      ...
                      if (!initialized) {
                        c5 = 2;
                        c6 = 1;
                        const obj3 = { value: closure_131_2.current, done: false };
                        return obj3;
                      }
                    }
                  }
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            c1 = 1;
            c0 = 1;
            const obj1 = { value: Promise.all(closure_1_7.map((_loadLocale) => _loadLocale._loadLocale(closure_1_0))), done: false };
            return obj1;
          }
        } else if (arg0 === 1) {
          c0 = 3;
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            c1 = 1;
            c0 = 1;
            const obj1 = { value: Promise.all(closure_2_7.map((waitForDefaultLocale) => waitForDefaultLocale.waitForDefaultLocale())), done: false };
            return obj1;
          }
        } else if (arg0 === 1) {
          c0 = 3;
