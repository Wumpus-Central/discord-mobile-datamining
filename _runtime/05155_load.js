// _runtime/05155_load.js
import errorDefault from "05156_error.js";
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(5157).dataUriToBuffer(response));
        const obj5 = response(5157);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
