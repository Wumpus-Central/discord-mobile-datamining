// _runtime/14472_SetNumberFormatDigitOptions.js
import _mod14425 from "metro/14425__.js";
import GetNumberOption from "14428_GetNumberOption.js";
import DefaultNumberOption from "14429_DefaultNumberOption.js";
...
export const SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(
  ...
  if (flag) {
    if (tmp12) {
      ...
      if (undefined === DefaultNumberOptionResult) {
        _mod14425.invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      _mod14425.invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
