...
maybeUnpackValue.__closure = { Reanimated: require("metro/05704__.js").Reanimated };
...
export const bindSharedValues = function bindSharedValues(closure_1, closure_2) {
  ...
  if (undefined !== require("metro/05704__.js").Reanimated) {
    ...
    while (tmp27 !== undefined) {
      ...
      let Reanimated = require("metro/05704__.js").Reanimated;
