// _runtime/12365_createTransport.js
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(12346).envelopeItemTypeToDataCategory(arg1);
        const obj = items(12346);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(12346).serializeEnvelope(dependencyMap) };
          const obj2 = items(12346);
          ...
          if (arg0 instanceof items(12359).SentryError) {
