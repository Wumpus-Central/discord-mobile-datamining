// _runtime/07610_extraErrorDataIntegration.js
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (callback(7548).DEBUG_BUILD) {
                const logger = callback(7520).logger;
