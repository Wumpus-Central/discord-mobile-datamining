...
const jsx = fn(21).jsx;
let closure_9 = _modDef6870(ScrollView, { disallowInterruption: true, shouldCancelWhenOutside: false });
...
const tmp4 = _modDef6870(Switch, { shouldCancelWhenOutside: false, shouldActivateOnStart: true, disallowInterruption: true });

export const LegacyRefreshControl = tmp3;
export { LegacyScrollView };
export const LegacySwitch = tmp4;
export const LegacyTextInput = _modDef6870(TextInput);
export const LegacyDrawerLayoutAndroid = _modDef6870(DrawerLayoutAndroid, { disallowInterruption: true });
