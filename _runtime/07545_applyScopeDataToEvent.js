// _runtime/07545_applyScopeDataToEvent.js
import { addNonEnumerableProperty } from "07501_addNonEnumerableProperty.js";
import { merge } from "07520_merge.js";
const require = arg1;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(7500).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(7500);
    obj4[0] = tmp3(7531).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(7531);
    const rootSpan = tmp3(7500).getRootSpan(span);
    const tmp3Result4 = tmp3(7500);
    const description = tmp3(7500).spanToJSON(rootSpan).description;
