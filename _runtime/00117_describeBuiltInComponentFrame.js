  ...
  if (typeof first === "object") {
    if (null !== first) {
      ...
      if (memoizedState !== tmp6.memoizedState) {
        ...
        pushSimpleEffect(9, { destroy: "__initData" }, actionStateActionEffect.bind(null, queue, memoizedState), null);
      }
...
function updateSyncExternalStore(serializer, getSnapshot) {
  ...
  _null.flags = _null.flags | 2048;
  const lastEffect = { tag: 9, create: updateStoreInstance.bind(null, _null, queue, tmp3, getSnapshot), deps: null, inst: { destroy: "__initData" }, next: null };
  let updateQueue = _null.updateQueue;
  if (null === updateQueue) {
    obj2 = { lastEffect: null, events: null, stores: null, memoCache: null };
    _null.updateQueue = obj2;
...
function mountEffect(create, arg1) {
  ...
  obj2 = { tag: 9, create, deps: tmp4, inst: { destroy: "__initData" }, next: null };
  let updateQueue = _null.updateQueue;
  if (null === updateQueue) {
    const obj3 = { lastEffect: null, events: null, stores: null, memoCache: null };
    _null.updateQueue = obj3;
...
let closure_210 = {
  ...
  useImperativeHandle(cache, c165, arr) {
    ...
    obj2 = { tag: 5, create: imperativeHandleEffect.bind(null, c165, cache), deps: tmp6, inst: { destroy: "__initData" }, next: null };
    let updateQueue = _null.updateQueue;
    if (null === updateQueue) {
      const obj3 = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null.updateQueue = obj3;
  ...
  useLayoutEffect(create, arg1) {
    ...
    obj2 = { tag: 5, create, deps: tmp4, inst: { destroy: "__initData" }, next: null };
    let updateQueue = _null.updateQueue;
    if (null === updateQueue) {
      const obj3 = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null.updateQueue = obj3;
  ...
  useInsertionEffect(create, arg1) {
    ...
    obj2 = { tag: 3, create, deps: tmp4, inst: { destroy: "__initData" }, next: null };
    let updateQueue = _null.updateQueue;
    if (null === updateQueue) {
      const obj3 = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null.updateQueue = obj3;
  ...
  useSyncExternalStore(serializer, getSnapshot) {
    ...
    if (null === c278) {
      ...
      _null.flags = _null.flags | 8390656;
      obj6 = { tag: 9, create: subscribeToStore.bind(null, _null, obj4, serializer), deps: items2, inst: { destroy: "__initData" }, next: null };
      let updateQueue2 = _null.updateQueue;
      if (null === updateQueue2) {
      ...
      _null.flags = _null.flags | 2048;
      const obj8 = { tag: 9, create: updateStoreInstance.bind(null, _null, obj4, tmp4, getSnapshot), deps: null, inst: { destroy: "__initData" }, next: null };
