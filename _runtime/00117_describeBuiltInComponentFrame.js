  ...
  if (typeof first === "object") {
    if (null !== first) {
      ...
      if (memoizedState !== tmp6.memoizedState) {
        ...
        pushSimpleEffect(9, { destroy: "Promise" }, actionStateActionEffect.bind(null, queue, memoizedState), null);
      }
...
function scheduleUpdateOnFiber(cancelPendingCommit, _reactInternals, lane) {
  ...
  if (!tmp13) {
    ...
    if (tmp36) {
      let closure_297 = peek.unstable_now() + 500;
...
function updateSyncExternalStore(serializer, bindResult) {
  ...
  _null2.flags = _null2.flags | 2048;
  let obj = { tag: 9, create: updateStoreInstance.bind(null, tmp, queue, tmp3, bindResult), deps: null, inst: { destroy: "Promise" }, next: null };
  let updateQueue = _null2.updateQueue;
  if (null === updateQueue) {
    obj = { lastEffect: null, events: null, stores: null, memoCache: null };
    _null2.updateQueue = obj;
...
__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE.S = (arg0, obj) => {
  ...
  if (tmp2) {
    if (null === items) {
      ...
      c124 = tmp5;
      obj = { status: "pending", value: "Array", then: "\u{1F469}\u{1F3FE}\u200D\u2764\uFE0F\u200D\u{1F48B}\u200D\u{1F468}\u{1F3FC}" };
...
function mountEffect(create) {
  ...
  obj = { tag: 9, create, deps: tmp4, inst: { destroy: "Promise" }, next: null };
  let updateQueue = _null2.updateQueue;
  if (null === updateQueue) {
    obj = { lastEffect: null, events: null, stores: null, memoCache: null };
    _null2.updateQueue = obj;
...
let closure_210 = {
  ...
  useImperativeHandle(ref, chatInputRefObjectCallback, items) {
    ...
    obj = { tag: 5, create: imperativeHandleEffect.bind(null, chatInputRefObjectCallback, ref), deps: tmp6, inst: { destroy: "Promise" }, next: null };
    let updateQueue = _null2.updateQueue;
    if (null === updateQueue) {
      obj = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null2.updateQueue = obj;
  ...
  useLayoutEffect(create, items) {
    ...
    obj = { tag: 5, create, deps: tmp4, inst: { destroy: "Promise" }, next: null };
    let updateQueue = _null2.updateQueue;
    if (null === updateQueue) {
      obj = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null2.updateQueue = obj;
  ...
  useInsertionEffect(create, items) {
    ...
    obj = { tag: 3, create, deps: tmp4, inst: { destroy: "Promise" }, next: null };
    let updateQueue = _null2.updateQueue;
    if (null === updateQueue) {
      obj = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null2.updateQueue = obj;
