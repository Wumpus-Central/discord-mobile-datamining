...
function accumulateTwoPhaseDispatchesSingleSkipTarget(dispatchConfig) {
  ...
  if (dispatchConfig) {
    if (dispatchConfig.dispatchConfig.phasedRegistrationNames) {
      ...
      if (0 < items.length) {
        do {
          let tmp3Result2 = accumulateDirectionalDispatches$1(items[num4], "bubbled", dispatchConfig);
          num4 = num4 + 1;
          length = items.length;
        } while (num4 < length);
      }
...
function accumulateTwoPhaseDispatchesSingle$1(dispatchConfig) {
  ...
  if (phasedRegistrationNames) {
    ...
    if (0 < items.length) {
      do {
        let tmpResult2 = accumulateDirectionalDispatches$1(items[num4], "bubbled", dispatchConfig);
        num4 = num4 + 1;
        length = items.length;
      } while (num4 < length);
    }
...
function accumulateTwoPhaseDispatchesSingle(dispatchConfig) {
  ...
  if (phasedRegistrationNames) {
    ...
    if (0 < items.length) {
      do {
        let tmpResult2 = accumulateDirectionalDispatches(items[num4], "bubbled", dispatchConfig);
        num4 = num4 + 1;
        length = items.length;
      } while (num4 < length);
    }
...
function enqueueConcurrentHookUpdate(lanes, pending, pending, lane) {
  let tmp = lanes;
  c143 = tmp2 + 1;
  closure_142[+c143] = lanes;
  c143 = tmp3 + 1;
  ...
  if (typeof first === "object") {
    if (null !== first) {
      ...
      if (memoizedState !== tmp6.memoizedState) {
        ...
        pushSimpleEffect(9, { destroy: "max" }, actionStateActionEffect.bind(null, queue, memoizedState), null);
      }
    ...
    while (true) {
      if (5 === child.tag) {
        ...
        if (tmp9) {
          ...
          let obj3 = { node: cloneNodeWithNewProps(stateNode.node, obj.createAttributePayload(obj2, stateNode.canonical.viewConfig.validAttributes)), canonical: stateNode.canonical };
          tmp10 = obj3;
        }
          ...
          if (null !== _null5.child) {
            ...
            if (27 !== tag) {
              if (5 !== tag) {
                stateNode1 = null;
                if (1 === tag) {
                  stateNode1 = _null5.child.stateNode;
                }
              }
            }
            stateNode1 = getPublicInstance(_null5.child.stateNode);
          }
          try {
  ...
  if (arg1 !== closure_130) {
    ...
    if (null === _return) {
      ...
      if (undefined === value) {
        ...
        const result = weakMap.set(promise, obj3);
        value = obj3;
      }
      obj = value;
    }
      ...
      if (typeof ErrorResult1 === "object") {
        if (null !== ErrorResult1) {
          ...
          if (undefined === value7) {
            ...
            const result6 = closure_91.set(ErrorResult1, obj6);
            value7 = obj6;
          }
          obj = value7;
        }
        ...
        if (null === _return) {
          ...
          if (undefined === value8) {
            ...
            const result7 = closure_91.set(ErrorResult, obj9);
            value8 = obj9;
          }
        }
        arr = items3;
          ...
          if (typeof value === "object") {
            if (null !== value) {
              ...
              if (undefined === value) {
                ...
                let result = weakMap.set(value, obj3);
                value = obj3;
              }
              obj = value;
            }
...
function FiberRootNode(containerInfo, tag, arg2, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, nativeOnDefaultTransitionIndicator, formState) {
      ...
      if (tmp55) {
        ...
        if (tmp55 !== c50) {
          ...
          if (isArray(_dispatchListeners2)) {
            ...
            if (c50) {
              const pooled2 = closure_41.getPooled(obj5.responderTerminationRequest, c50, responderIgnoreScroll, arg3);
              ...
              if (tmp75) {
                const pooled3 = getPooled(obj5.responderTerminate, c50, responderIgnoreScroll, arg3);
                ...
                const pooled4 = getPooled(obj5.responderReject, tmp55, responderIgnoreScroll, arg3);
...
function updateSyncExternalStore(serializer, getSnapshot) {
  ...
  _null.flags = _null.flags | 2048;
  const lastEffect = { tag: 9, create: updateStoreInstance.bind(null, _null, queue, tmp3, getSnapshot), deps: null, inst: { destroy: "max" }, next: null };
  let updateQueue = _null.updateQueue;
  if (null === updateQueue) {
    obj2 = { lastEffect: null, events: null, stores: null, memoCache: null };
    _null.updateQueue = obj2;
...
__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE.S = (arg0, obj) => {
  ...
  if (tmp2) {
    if (null === items) {
      ...
      c124 = tmp5;
      { status: "pending", value: "Array", then: "\u{1F469}\u{1F3FF}\u200D\u2764\uFE0F\u200D\u{1F48B}\u200D\u{1F469}\u{1F3FE}" }.then = function then(arg0) {
        items.push(arg0);
      };
      obj2 = { status: "pending", value: "Array", then: "\u{1F469}\u{1F3FF}\u200D\u2764\uFE0F\u200D\u{1F48B}\u200D\u{1F469}\u{1F3FE}" };
    }
...
function mountEffect(create, arg1) {
  ...
  obj2 = { tag: 9, create, deps: tmp4, inst: { destroy: "max" }, next: null };
  let updateQueue = _null.updateQueue;
  if (null === updateQueue) {
    const obj3 = { lastEffect: null, events: null, stores: null, memoCache: null };
    _null.updateQueue = obj3;
...
let closure_210 = {
  ...
  useImperativeHandle(cache, c165, arr) {
    ...
    obj2 = { tag: 5, create: imperativeHandleEffect.bind(null, c165, cache), deps: tmp6, inst: { destroy: "max" }, next: null };
    let updateQueue = _null.updateQueue;
    if (null === updateQueue) {
      const obj3 = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null.updateQueue = obj3;
  ...
  useLayoutEffect(create, arg1) {
    ...
    obj2 = { tag: 5, create, deps: tmp4, inst: { destroy: "max" }, next: null };
    let updateQueue = _null.updateQueue;
    if (null === updateQueue) {
      const obj3 = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null.updateQueue = obj3;
  ...
  useInsertionEffect(create, arg1) {
    ...
    obj2 = { tag: 3, create, deps: tmp4, inst: { destroy: "max" }, next: null };
    let updateQueue = _null.updateQueue;
    if (null === updateQueue) {
      const obj3 = { lastEffect: null, events: null, stores: null, memoCache: null };
      _null.updateQueue = obj3;
  ...
  useSyncExternalStore(serializer, getSnapshot) {
    ...
    if (null === c278) {
      ...
      _null.flags = _null.flags | 8390656;
      obj6 = { tag: 9, create: subscribeToStore.bind(null, _null, obj4, serializer), deps: items2, inst: { destroy: "max" }, next: null };
      let updateQueue2 = _null.updateQueue;
      if (null === updateQueue2) {
      ...
      _null.flags = _null.flags | 2048;
      const obj8 = { tag: 9, create: updateStoreInstance.bind(null, _null, obj4, tmp4, getSnapshot), deps: null, inst: { destroy: "max" }, next: null };
