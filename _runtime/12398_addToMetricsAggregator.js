// _runtime/12398_addToMetricsAggregator.js
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = require("12329_getClient.js").getClient();
    const obj2 = getClient;
  }
  if (client) {
    const activeSpan = require("12307_spanTimeInputToSeconds.js").getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const globalSingleton = require("12303_getGlobalSingleton.js").getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  ...
  timing(arg0, arg1, fn) {
    ...
    if (typeof fn === "function") {
      ...
      return require("12336_createChildOrRootSpan.js").startSpanManual(obj, (arg0) => {
        const callback = arg0;
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = require("metro/12399__.js").DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
