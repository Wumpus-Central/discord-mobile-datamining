// _runtime/12153_initializeContext.js
const require = arg1;
let exports = arg5;
...
function initializeContext(target) {
  ...
  if (metadata == null) {
    metadata = require(12151) /* $output */.globalRegistry;
  }
  obj[1] = metadata;
  obj[2] = str;
  let str2;
...
function process(_zod, seen) {
  ...
  if (value) {
    ...
    obj = { schema: null, count: 1, cycle: "Array", path: "HOSTED_FIELDS_FIELD_NOT_PRESENT" };
    obj[0] = {};
    obj[3] = tmp4.path;
