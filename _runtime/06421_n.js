...
let obj = {
  ...
  setGestureHandlerConfig(handlerTag, closure_1) {
    ...
    let result = _require(6408).scheduleOperationToBeFlushed(() => {
...
const fn = function n(arg0, arg1) {
  const result = module(6406).updateGestureHandlerConfig(arg0, arg1);
  const obj = module(6406);
  module(6406).flushOperations();
};
...
obj[5] = function installUIRuntimeBindings() {
  return module(6406).installUIRuntimeBindings();
};
