// === Module 14125: ReanimatedNativeStackScreen ===
...
const jsx = fn(21).jsx;
let closure_7 = cancelAnimation.createAnimatedComponent(fn(5228).InnerScreen);
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  const safeAreaFrame = _mod1616.useSafeAreaFrame();
  let y = _mod1616.useSafeAreaInsets().top;
  ...
  const obj4 = { value: sharedValue, children: jsx(_modDef14127.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) };
  obj3.children = jsx(_modDef14126.Provider, { value: sharedValue, children: jsx(_modDef14127.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children }) });
