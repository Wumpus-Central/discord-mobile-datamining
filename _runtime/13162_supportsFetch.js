// _runtime/13162_supportsFetch.js
import _mod13051 from "metro/13051__.js";

require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in _mod13051.GLOBAL_OBJ) {
    try {
...
export const supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(_mod13051.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = _mod13051.GLOBAL_OBJ.document;
      if (_document) {
...
export const supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in _mod13051.GLOBAL_OBJ;
};
