// _runtime/14098___exportStarResult13.js
import digitsToString from "14083_digitsToString.js";
import __exportStarResult14 from "14099___exportStarResult14.js";
  ...
  if (timesResult.isZero()) {
    ...
    if (roundedNumber.isZero()) {
      ...
      if (floorResult1.eq(floorResult.minus(result))) {
        ...
        const items2 = [
          tmp2(14099).ComputeExponentForMagnitude(internalSlots, floorResult.plus(1)),
