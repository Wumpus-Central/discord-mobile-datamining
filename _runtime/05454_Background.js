// === Module 5454: Background ===

// Module 5454 (Background)
import registerAssetDefault from "registerAsset" /* 5455 */;
import registerAssetDefault2 from "registerAsset" /* 5456 */;
import registerAssetDefault3 from "registerAsset" /* 5457 */;
import registerAssetDefault4 from "registerAsset" /* 5458 */;
import registerAssetDefault5 from "registerAsset" /* 5459 */;

const items = [registerAssetDefault, registerAssetDefault2, registerAssetDefault3, registerAssetDefault4, registerAssetDefault5];
for (const key10025 in require("module_5460")) {
  let tmp2 = key10025;
  arg5[key10025] = require("module_5460")[key10025];
  continue;
}
