// _runtime/12838_isFullFinishedSpan.js
...
class SentrySpan {
  constructor() {
    ...
    obj[require("metro/12812__.js").SEMANTIC_ATTRIBUTE_SENTRY_OP] = obj.op;
...
let items = [
  ...
  },
  {
    ...
    value: function getSpanJSON() {
      ...
      obj[10] = SentrySpan(12813).getMetricSummaryJsonForSpan(this);
      obj[11] = this._attributes[SentrySpan(undefined, 12812).SEMANTIC_ATTRIBUTE_PROFILE_ID];
      obj[12] = this._attributes[SentrySpan(undefined, 12812).SEMANTIC_ATTRIBUTE_EXCLUSIVE_TIME];
      const obj4 = SentrySpan(12813);
      obj[13] = SentrySpan(12839).timedEventsToMeasurements(this._events);
    ...
    value: function _convertSpanToTransaction() {
      ...
      if (tmp6) {
        ...
        if (true !== self._sampled) {
          ...
          const mapped = found.map((arg0) => self(12802).spanToJSON(arg0));
          ...
          obj[0] = tmp3(12802).spanToTransactionTraceContext(self);
          obj[0] = obj;
          let substr = found1;
          ...
          obj2[0] = tmp3(12833).getDynamicSamplingContextFromSpan(self);
          const merged = Object.assign(tmp3Result4.dropUndefinedKeys(obj2));
          obj[6] = obj1;
          const tmp3Result5 = tmp3(12833);
          obj[7] = tmp3(12813).getMetricSummaryJsonForSpan(self);
          let tmp12 = tmp24;
          if (tmp24) {
