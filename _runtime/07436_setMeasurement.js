// _runtime/07436_setMeasurement.js
import { spanTimeInputToSeconds } from "07399_spanTimeInputToSeconds.js";
import { 07409__ } from "metro/07409__.js";
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (rootSpan) {
    ...
    obj = {};
    obj[07409__.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[07409__.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
