// _runtime/13148_MetricsAggregator.js
...
const entry = {
  ...
  value: function add(metricType, arg1, diff) {
    ...
    const bucketKey = MetricsAggregator(13149).getBucketKey(
      metricType,
    ...
    if (value) {
      num = 0;
      if (metricType === MetricsAggregator(13145).SET_METRIC_TYPE) {
    ...
    if (value) {
      ...
      const tmp15 = new MetricsAggregator(13150).METRIC_MAP[metricType](diff);
      obj7.metric = tmp15;
    ...
    const result1 = MetricsAggregator(13053).updateMetricSummaryOnActiveSpan(
      metricType,
      sanitizeMetricKeyResult,
      diff,
      sanitizeUnitResult,
    ...
    const tmp5Result = MetricsAggregator(13053);
  },
};
const items = [
  entry,
  ...
  },
  {
    ...
    value: function _flush() {
      ...
      if (this._forceFlush) {
        ...
        const obj = MetricsAggregator(13062);
      }
    },
  },
  {
