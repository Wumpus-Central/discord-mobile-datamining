// _runtime/07961__isNativeReflectConstruct.js
...
import { 07958__ } from "metro/07958__.js";
import { __INTERNAL_VIEW_CONFIG } from "metro/07963___INTERNAL_VIEW_CONFIG.js";
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = 07958__[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = 07958__[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
