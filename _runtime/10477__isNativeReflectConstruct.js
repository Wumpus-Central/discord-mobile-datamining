...
const items = [
  ...
  },
  {
    ...
    value: function mergeResults(arg0, start, text) {
      const parseDurationResult = ENMergeRelativeAfterDateRefiner(10445).parseDuration(text.text);
      ...
      return new ENMergeRelativeAfterDateRefiner(10449).ParsingResult(reference, index, "" + start.text + arg0 + text.text, relativeFromReference);
    }
  }
];
