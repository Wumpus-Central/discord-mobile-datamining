// _runtime/05213_constructTag.js
import getDataView from "05166_getDataView.js";
import _mod5173 from "metro/05173__.js";
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== _mod5173.TYPE_TEXT) {
    combined = stringValueFromArray;
    if (0 !== items2.length) {
      const _HermesInternal = HermesInternal;
      combined = "" + stringValueFromArray + " (" + tmp4(5166).getStringValueFromArray(items2) + ")";
      const tmp4Result = tmp4(5166);
    }
  }
  obj = { name: combined, value: stringFromDataView, description: null };
  if (type === _mod5173.TYPE_ITXT) {
    stringFromDataView = module(5199).decode("UTF-8", decompressResult);
    const obj5 = module(5199);
  }
