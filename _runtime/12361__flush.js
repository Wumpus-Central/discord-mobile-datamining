  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/12340__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/12341__.js").DEBUG_BUILD) {
            const logger = require("metro/12313__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/12340__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const captureException = function captureException(arg0, captureContext) {
  const currentScope = _mod12340.getCurrentScope();
  return currentScope.captureException(arg0, _mod12362.parseEventHintOrCaptureContext(captureContext));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = _mod12350.DEFAULT_ENVIRONMENT;
  }
  ...
  if (tmp10) {
    _mod12336.updateSession(session1, { status: "exited" });
    const tmpResult2 = _mod12336;
  }
  endSession();
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod12327.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod12340.getCurrentScope();
    const client = _mod12340.getClient();
    if (client) {
    ...
    _mod12324.uuid4();
    const tmpResult = _mod12324;
  }
  let currentScope = require("metro/12340__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/12340__.js");
  let client = require("metro/12340__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/12340__.js");
  captureCheckInResult = require("metro/12324__.js").uuid4();
};
