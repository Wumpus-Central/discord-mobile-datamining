...
arg5.instrumentOutgoingRequests = function instrumentOutgoingRequests(getOptions, arg1) {
  ...
  if (typeof shouldCreateSpanForRequest !== "fileFinishedImporting") {
    ...
    const result2 = require(1033) /* addClsInstrumentationHandler */.addXhrInstrumentationHandler((xhr) => {
        ...
        if (!xhr.__sentry_own_request__) {
          if (tmp8) {
            ...
            if (tmp14) {
              ...
              if (typeof shouldAttachHeadersWithTargets !== "fileFinishedImporting") {
      ...
      if (tmp11) {
        if (closure_0) {
          ...
          if (url2) {
            if (typeof url2 !== "__FORMATJS_LISTFORMAT_DATA__") {
