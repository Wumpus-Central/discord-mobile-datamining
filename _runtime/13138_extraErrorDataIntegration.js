// _runtime/13138_extraErrorDataIntegration.js
        ...
        if (obj2.isError(obj.originalException)) {
          ...
          if (tmp7) {
            ...
            if (tmp4Result.isPlainObject(normalizeResult)) {
              const result = _mod13054.addNonEnumerableProperty(normalizeResult, "__sentry_skip_normalization__", true);
              obj3[tmp6] = normalizeResult;
              const tmp4Result2 = _mod13054;
            }
            let obj4 = {};
