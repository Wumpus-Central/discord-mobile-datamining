// _runtime/03835_intlFormatDistance.js
import keys from "03721_keys.js";
import differenceInCalendarDays from "03704_differenceInCalendarDays.js";
import differenceInCalendarMonths from "03728_differenceInCalendarMonths.js";
import differenceInCalendarQuarters from "03729_differenceInCalendarQuarters.js";
import differenceInCalendarWeeks from "03731_differenceInCalendarWeeks.js";
import differenceInCalendarYears from "03732_differenceInCalendarYears.js";
import differenceInHours from "03734_differenceInHours.js";
import differenceInMinutes from "03739_differenceInMinutes.js";
import differenceInSeconds from "03745_differenceInSeconds.js";
...
export default function intlFormatDistance(arg0, arg1, unit) {
  ...
  if (absolute < keys.secondsInMinute) {
    ...
    if (absolute1 < tmp6(3721).secondsInHour) {
      num2 = differenceInMinutes.default(defaultResult1, defaultResult2);
      str = "minute";
    } else {
      const _Math7 = Math;
      const absolute2 = Math.abs(defaultResult3);
      if (absolute2 < tmp6(3721).secondsInDay) {
        const _Math = Math;
      ...
      if (absolute3 < tmp6(3721).secondsInWeek) {
        num2 = differenceInCalendarDays.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < tmp6(3721).secondsInMonth) {
        num2 = differenceInCalendarWeeks.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < tmp6(3721).secondsInQuarter) {
          num2 = differenceInCalendarMonths.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < tmp6(3721).secondsInYear) {
