  ...
  },
  {
    ...
    value: function unregisterTransition(componentViewTag) {
      ...
      if (this._defaultTransitionType === require("module_1663").SharedTransitionType.ANIMATION) {
        let SHARED_ELEMENT_TRANSITION_PROGRESS = require("module_1663").LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
      } else {
        SHARED_ELEMENT_TRANSITION_PROGRESS = require("module_1663").LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS;
      }
      ...
      const tmpResult = require("module_1752");
    }
  },
  {
    key: "getReduceMotion",
