// _runtime/01775_SharedTransition.js
...
const items = [
  ...
  },
  {
    ...
    value: function unregisterTransition(componentViewTag) {
      ...
      if (this._defaultTransitionType === require("metro/01663__.js").SharedTransitionType.ANIMATION) {
        let SHARED_ELEMENT_TRANSITION_PROGRESS =
          require("metro/01663__.js").LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
      } else {
        SHARED_ELEMENT_TRANSITION_PROGRESS =
          require("metro/01663__.js").LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS;
      }
      const result = require("metro/01752__.js").updateLayoutAnimations(
        componentViewTag,
        SHARED_ELEMENT_TRANSITION_PROGRESS,
        undefined,
        undefined,
      ...
      const tmpResult = require("metro/01752__.js");
    },
  },
  {
    key: "getReduceMotion",
...
const entry1 = {
  ...
  value: function custom(arg0) {
    ...
    obj._reduceMotion = require("metro/01663__.js").ReduceMotion.System;
