// _runtime/05372__isNativeReflectConstruct.js
...
import { RNGestureHandlerModule } from "05362_RNGestureHandlerModule.js";
import { transformIntoHandlerTags } from "05376_transformIntoHandlerTags.js";
...
let closure_12 = { [arg1(5358).State.UNDETERMINED]: undefined, [arg1(5358).State.BEGAN]: "onBegan", [arg1(5358).State.FAILED]: "onFailed", [arg1(5358).State.CANCELLED]: "onCancelled", [arg1(5358).State.ACTIVE]: "onActivated", [arg1(5358).State.END]: "onEnded" };
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          ...
          if (self.viewNode) {
            self.attachGestureHandler(require("05379_get_ActivityIndicator.js") /* get ActivityIndicator */(self.viewNode));
          } else {
            const _Error = Error;
