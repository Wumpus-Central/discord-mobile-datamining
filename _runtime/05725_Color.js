// _runtime/05725_Color.js
import _mod5726 from "metro/05726__.js";
import _mod5730 from "metro/05730__.js";
...
function _loop(item10136) {
  ...
  if (closure_3.includes(item10136)) {
    ...
    channels = require("metro/05726__.js")[item10136].channels;
    Color.prototype[item10136] = function () {
      ...
      if (this.model === closure_0) {
        ...
        const rawResult = _mod5726[self.model][closure_0].raw(self.color);
        const _Array = Array;
        let tmp2 = rawResult;
