...
function visit(arg0, __sentry_skip_normalization__) {
  ...
  if (arg4 === undefined) {
    memoBuilderResult = require(7409) /* memoBuilder */.memoBuilder();
    let obj = require(7409) /* memoBuilder */;
  }
      ...
      if (str.startsWith("[object ")) {
        if (__sentry_skip_normalization__.__sentry_skip_normalization__) {
          ...
          if (0 === num) {
            ...
            const convertToPlainObjectResult = require(7369) /* addNonEnumerableProperty */.convertToPlainObject(__sentry_skip_normalization__);
            let num6 = 0;
