// _runtime/12872_spanTimeInputToSeconds.js
...
import _mod12879 from "metro/12879__.js";
import _mod12881 from "metro/12881__.js";
import _mod12882 from "metro/12882__.js";
import _mod12883 from "metro/12883__.js";
import _mod12884 from "metro/12884__.js";
import _mod12885 from "metro/12885__.js";
import _mod12886 from "metro/12886__.js";
import _mod12889 from "metro/12889__.js";
  ...
  if (
    ...
    try {
      ...
      if (
        ...
        obj.op = attributes[_mod12882.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj.origin = attributes[_mod12882.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
        const tmp8 = spanTimeInputToSeconds(endTime);
        obj._metrics_summary = _mod12883.getMetricSummaryJsonForSpan(getSpanJSON);
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12884.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod12884.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod12873.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod12873.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
