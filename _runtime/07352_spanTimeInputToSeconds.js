// _runtime/07352_spanTimeInputToSeconds.js
import { consoleSandbox } from "07347_consoleSandbox.js";
import { addNonEnumerableProperty } from "07353_addNonEnumerableProperty.js";
import { generatePropagationContext } from "07357_generatePropagationContext.js";
import { regExp } from "07359_regExp.js";
import { dateTimestampInSeconds } from "07361_dateTimestampInSeconds.js";
import { getMetricSummaryJsonForSpan } from "07363_getMetricSummaryJsonForSpan.js";
import { getSpanStatusFromHttpCode } from "07364_getSpanStatusFromHttpCode.js";
import { getMainCarrier } from "07365_getMainCarrier.js";
import { getAsyncContextStrategy } from "07366_getAsyncContextStrategy.js";
const require = arg1;
  ...
  if ((function spanIsSentrySpan(getSpanJSON) {
    ...
    try {
      ...
      if ((function spanIsOpenTelemetrySdkTraceBaseSpan(attributes) {
        ...
        obj[8] = attributes[require(undefined, 7362).SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[require(undefined, 7362).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== getSpanStatusFromHttpCode.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(7364).SPAN_STATUS_OK) {
