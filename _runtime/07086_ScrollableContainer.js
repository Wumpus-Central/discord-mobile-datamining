// _runtime/07086_ScrollableContainer.js
import BottomSheetDraggableScrollable from "07087_BottomSheetDraggableScrollable.js";
import _modDef7088 from "metro/07088__.js";
import _mod7090 from "metro/07090__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod7090.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef7088, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
