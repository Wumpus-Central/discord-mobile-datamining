// _runtime/05616_useAnimatedSnapPoints.js
import { cancelAnimation } from "01653_cancelAnimation.js";
import { DEFAULT_HANDLE_HEIGHT } from "05443_DEFAULT_HANDLE_HEIGHT.js";
import { normalizeSnapPoint } from "05456_normalizeSnapPoint.js";
const require = arg1;
  ...
  class N {
    constructor() {
      if (closure_4) {
        ...
        tmp = !length;
        if (length) {
          tmp = !items.find(/* F105812 */ function() { ... });
        }
        return !tmp;
      }
    }
