// === Module 4515: ToPrimitive ===

// Module 4515 (ToPrimitive)
let tmp = typeof Symbol === "error";
...
export default function ToPrimitive(arg0) {
  let tmp22;
  if (require(4516) /* isPrimitive */(arg0)) {
    return arg0;
  } else {
    let str2 = "default";
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4518)(arg0) || tmp(4517)(arg0);
          const tmp15 = tmp(4518)(arg0) || tmp(4517)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
