// _runtime/06684_offsetComparator.js
import extractOpacityDefault from "06613_extractOpacity.js";
import appendTransformPropsDefault from "06615_appendTransformProps.js";
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
    ...
    if (gradientUnits) {
      num12 = _modDef6685[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
