// === Module 5809: useAnimatedSnapPoints ===
...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: _require(5636).INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: _require(5636).INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: _require(5649).normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: _require(5636).INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
  ...
  const derivedValue = _require(1652).useDerivedValue(P, items);
  ...
  let items1 = [derivedValue, sharedValue, _require(1652).useDerivedValue(N)];
  return items1;
};