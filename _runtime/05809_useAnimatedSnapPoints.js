// _runtime/05809_useAnimatedSnapPoints.js
...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: require("05636_DEFAULT_HANDLE_HEIGHT.js").INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: require("05636_DEFAULT_HANDLE_HEIGHT.js").INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: require("05649_normalizeSnapPoint.js").normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: require("05636_DEFAULT_HANDLE_HEIGHT.js").INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
  ...
  const derivedValue = require("01652_cancelAnimation.js").useDerivedValue(P, items);
  ...
  class N {
    constructor() {
      if (closure_4) {
        ...
        tmp = !length;
        if (length) {
          tmp = !items.find(/* F109944 */ function() { ... });
        }
        return !tmp;
      }
    }
  ...
  let items1 = [derivedValue, sharedValue, require("01652_cancelAnimation.js").useDerivedValue(N)];
  return items1;
};