...
function reducer(arg0, type) {
  ...
  if (portalName(4248).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4248).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4248).ACTIONS.ADD_UPDATE_PORTAL === type) {
