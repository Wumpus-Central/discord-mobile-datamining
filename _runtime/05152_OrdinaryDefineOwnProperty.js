// _runtime/05152_OrdinaryDefineOwnProperty.js
...
import ValidateAndApplyPropertyDescriptor from "05155_ValidateAndApplyPropertyDescriptor.js";

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod5089(arg0)) {
    if (_mod5136(arg1)) {
      if (_mod5140(__Writable__)) {
        if (_mod1283) {
          ...
          return ValidateAndApplyPropertyDescriptor(arg0, arg1, _mod5154(arg0), __Writable__, tmp31);
