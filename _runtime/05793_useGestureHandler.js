// _runtime/05793_useGestureHandler.js
...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: require("05652_LegacyBaseButton.js").State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj[1] = require("01653_cancelAnimation.js").useWorkletCallback(U, items1);
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: require("05625_GESTURE_SOURCE.js").GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  C.__workletHash = 10682034812271;
  C.__initData = closure_4;
  const items2 = [state, gestureSource, source, onEnd];
  obj[2] = require("01653_cancelAnimation.js").useWorkletCallback(C, items2);
  ...
  obj[3] = require("01653_cancelAnimation.js").useWorkletCallback(T, items3);
  return obj;
};