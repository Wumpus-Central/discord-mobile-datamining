// _runtime/05273_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05280_AudioTypes.js";
import ImageTypes from "05281_ImageTypes.js";
import VideoTypes from "05282_VideoTypes.js";
import CompressedTypes from "05283_CompressedTypes.js";
import OtherTypes from "05284_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5274).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5274).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5274).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5274).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
