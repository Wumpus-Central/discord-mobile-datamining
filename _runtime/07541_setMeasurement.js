// _runtime/07541_setMeasurement.js
import { spanTimeInputToSeconds } from "07504_spanTimeInputToSeconds.js";
import { 07514__ } from "metro/07514__.js";
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (rootSpan) {
    ...
    obj = {};
    obj[07514__.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[07514__.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
