// _runtime/12274_addNonEnumerableProperty.js
import __SENTRY_DEBUG__ from "metro/12267___SENTRY_DEBUG__.js";
import isInstanceOf from "12275_isInstanceOf.js";
import _htmlElementAsString from "12276__htmlElementAsString.js";
import isMatchingPattern from "12277_isMatchingPattern.js";
...
arg5.fill = function fill(arg0, arg1, arg2) {
  if (arg1 in arg0) {
    ...
    try {
      ...
      if (__SENTRY_DEBUG__.DEBUG_BUILD) {
        const logger = tmp7(12268).logger;
        const _HermesInternal = HermesInternal;
