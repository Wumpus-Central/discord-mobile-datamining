// === Module 5703: getHandler ===

// Module 5703 (getHandler)
import tagMessage from "tagMessage" /* 5657 */;
...
function getHandler(arg0, onBegin) {
  ...
  } else if (tmp(5673).CALLBACK_TYPE.CHANGE === arg0) {
...
obj = { TouchEventType: require("module_5660").TouchEventType, CALLBACK_TYPE: require("_isNativeReflectConstruct").CALLBACK_TYPE };
