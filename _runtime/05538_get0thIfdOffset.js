// _runtime/05538_get0thIfdOffset.js
import _modDef5521 from "metro/05521__.js";
import _modDef5535 from "metro/05535__.js";
import IFD_TYPE_0TH2 from "05539_IFD_TYPE_0TH.js";
...
function readTag(byteLength, IFD_TYPE_0TH, sum, sum, byteOrder, arg5) {
  ...
  if (undefined !== _modDef5535.typeSizes[shortAt1]) {
    if (
      ...
      const longAt1 = _modDef5535.getLongAt(byteLength, sum + sum1, byteOrder);
      str = "<faulty value>";
      tmp21 = longAt1;
      if (
      ...
      const tmp4Result = _modDef5535;
    }
    let tmp34 = str;
    if (shortAt1 === _modDef5535.tagTypes.ASCII) {
    ...
    if (undefined !== IFD_TYPE_0THDefault[IFD_TYPE_0TH][shortAt]) {
      ...
      if (shortAt1 !== _modDef5535.tagTypes.RATIONAL) {
        if (shortAt1 !== _modDef5535.tagTypes.SRATIONAL) {
...
let obj = {
  1: null,
  2: _modDef5535.getByteAt,
  3: _modDef5535.getAsciiAt,
  4: _modDef5535.getShortAt,
  5: _modDef5535.getLongAt,
  7: _modDef5535.getRationalAt,
  9: null,
  10: _modDef5535.getUndefinedAt,
  13: null,
};
...
function readIfd(byteLength, IFD_TYPE_0TH, sum, sum, byteOrder, arg5) {
  ...
  if (_modDef5521.USE_THUMBNAIL) {
    if (tmp5 < byteLength.byteLength - tmp23Result.getTypeSize("LONG")) {
      const longAt = _modDef5535.getLongAt(byteLength, tmp5, byteOrder);
      let tmp26 = 0 !== longAt;
      if (tmp26) {
      ...
      const tmp23Result2 = _modDef5535;
    }
    tmp23Result = _modDef5535;
  }
  return obj3;
}
