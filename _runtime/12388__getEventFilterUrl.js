// _runtime/12388__getEventFilterUrl.js
...
import setupIntegration from "metro/12369__.js";
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod12341.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + _mod12324.getEventDescription(tmp));
      const tmp6Result = _mod12324;
    }
    return null;
  }
}
      ...
      if (tmp10) {
        if (
          ...
          if (_mod12341.DEBUG_BUILD) {
            ...
            logger6.warn(
              "Event dropped due to being internal Sentry Error.\nEvent: " + _mod12324.getEventDescription(type),
            );
            flag6 = true;
          }
        }
        ...
        if (_mod12341.DEBUG_BUILD) {
          ...
          logger5.warn(
            "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " +
              _mod12324.getEventDescription(type),
          );
          flag6 = true;
        }
      } else {
        ...
        if (flag2) {
          ...
          if ("transaction" === type.type) {
            ...
            if (items3.length) {
              ...
              if (result) {
                result = _mod12322.stringMatchesSomePattern(transaction, items3);
              }
              flag3 = result;
            }
          }
          if (flag3) {
            ...
            if (items1.length) {
              ...
              let result1 = tmp16;
              if (result1) {
                result1 = _mod12322.stringMatchesSomePattern(tmp16, items1);
              }
              flag4 = result1;
            }
            if (flag4) {
              ...
              if (_mod12341.DEBUG_BUILD) {
                ...
                const eventDescription = _mod12324.getEventDescription(type);
              ...
              if (items.length) {
                ...
                let result2 = !tmp21;
                if (tmp21) {
                  result2 = _mod12322.stringMatchesSomePattern(tmp21, items);
                }
                flag5 = result2;
              }
              flag6 = false;
              if (!flag5) {
                ...
                if (_mod12341.DEBUG_BUILD) {
                  const logger = _mod12313.logger;
                  const eventDescription1 = _mod12324.getEventDescription(type);
