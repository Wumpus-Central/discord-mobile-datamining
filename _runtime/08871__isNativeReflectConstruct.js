// _runtime/08871__isNativeReflectConstruct.js
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f116446);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f116446);
    ...
    f116446 = undefined;
    f116446 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8874").NONE, require("module_8874").INVERT, require("module_8874").MONOCHROME, require("module_8874").POSTERIZE, require("module_8874").FALSE, require("module_8874").MAXIMUMCOMPONENT, require("module_8874").MINIMUMCOMPONENT, require("module_8874").CHROME, require("module_8874").FADE, require("module_8874").INSTANT, require("module_8874").MONO, require("module_8874").NOIR, require("module_8874").PROCESS, require("module_8874").TONAL, require("module_8874").TRANSFER, require("module_8874").SEPIA];
...
const items4 = [require("module_8875").CLEARKEY, require("module_8875").FAIRPLAY, require("module_8875").WIDEVINE, require("module_8875").PLAYREADY];
...
const items8 = [require("module_8894").SRT, require("module_8894").TTML, require("module_8894").VTT];
...
export const TextTrackType = require("module_8894");
export const FilterType = require("module_8874");
export const DRMType = require("module_8875");