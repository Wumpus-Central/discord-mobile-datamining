// _runtime/13493___exportStarResult13.js
import e from "e";
import digitsToString from "digitsToString";
import { __exportStarResult14 } from "13494___exportStarResult14.js";
import { __exportStarResult21 } from "13495___exportStarResult21.js";
  ...
  if (timesResult.isZero()) {
    ...
    if (roundedNumber.isZero()) {
      ...
      if (floorResult1.eq(floorResult.minus(result))) {
        ...
        const items2 = [tmp2(13494).ComputeExponentForMagnitude(internalSlots, floorResult.plus(1)), floorResult.plus(1).toNumber()];
        return items2;
      }
