// _runtime/04892_isAVI.js
import { getFileChunk } from "04884_getFileChunk.js";
import { 04885__ } from "metro/04885__.js";
const require = arg1;
...
arg5.isAVI = function isAVI(fileChunk) {
  ...
  const FileTypes = 04885__.FileTypes;
...
arg5.isMP4 = function isMP4(fileChunk, excludeSimilarTypes) {
  ...
  if (!checkByFileTypeResult) {
    ...
    if (!excludeSimilarTypes) {
      const fileChunk1 = tmp(4884).getFileChunk(fileChunk);
      const FileTypes2 = tmp(4885).FileTypes;
      tmp8 = FileTypes2.checkByFileType(fileChunk1, "m4v") && tmp(4884).isftypStringIncluded(fileChunk1);
      const tmp10 = FileTypes2.checkByFileType(fileChunk1, "m4v") && tmp(4884).isftypStringIncluded(fileChunk1);
    }
