...
const entry = {
  ...
  value: function clone() {
    ...
    obj = { traceId: null, spanId: null };
    let obj1 = ScopeClass(12900);
    obj.traceId = obj1.generateTraceId();
    let obj2 = ScopeClass(12900);
    obj.spanId = obj2.generateSpanId();
...
let items = [
  ...
  },
  {
    ...
    value: function clear() {
      ...
      obj.traceId = ScopeClass(12900).generateTraceId();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      const obj = {
        ...
        span: ScopeClass(12912)._getSpanForScope(self),
      };
      return obj;
    },
  },
