// _runtime/04932_decodeXPValue.js
...
obj = { name: "XResolution", description: require("metro/04933__.js").XResolution };
obj[282] = obj;
obj = { name: "YResolution", description: require("metro/04933__.js").YResolution };
obj[283] = obj;
obj[286] = {
  name: "XPosition",
  description(arg0) {
...
obj[296] = { name: "ResolutionUnit", description: require("metro/04933__.js").ResolutionUnit };
obj[318] = {
  name: "WhitePoint",
  description(arr) {
    const mapped = arr.map((item, index) => "" + item[0] + "/" + item[1]);
    return mapped.join(", ");
  }
};
obj[319] = {
...
obj[339] = {
  ...
  description(arr) {
    ...
    if (Array.isArray(arr)) {
      const mapped = arr.map((item, index) => table[item] || "Unknown");
      str = mapped.join(", ");
    }
    return str;
  }
...
const obj1 = { name: "ResolutionUnit", description: require("metro/04933__.js").ResolutionUnit };
obj[50778] = { name: "CalibrationIlluminant1", description: require("metro/04933__.js").LightSource };
const obj2 = { name: "CalibrationIlluminant1", description: require("metro/04933__.js").LightSource };
obj[50779] = { name: "CalibrationIlluminant2", description: require("metro/04933__.js").LightSource };
obj[50941] = {
