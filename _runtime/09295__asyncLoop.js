...
export const randomBytes = function randomBytes() {
  ...
  if (Hash(9297).crypto) {
    if (typeof Hash(9297).crypto.getRandomValues === "function") {
      const _crypto2 = Hash(9297).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(9297).crypto) {
    if (typeof Hash(9297).crypto.randomBytes === "function") {
      const _crypto = Hash(9297).crypto;
