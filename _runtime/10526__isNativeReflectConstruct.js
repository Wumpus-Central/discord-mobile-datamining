// _runtime/10526__isNativeReflectConstruct.js
...
import parseYear from "10527_parseYear.js";
...
const regExp = new RegExp(
  "(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(este|esta|passado|pr[o\u00F3]ximo)\\s*)?(" +
    repeatedTimeunitPattern.matchAnyPattern(parseYear.WEEKDAY_DICTIONARY) +
...
const items = [
  ...
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      const tmp4 = PTWeekdayParser(10527).WEEKDAY_DICTIONARY[formatted];
      if (undefined === tmp4) {
        return null;
      } else {
        ...
        return tmp2(10473).createParsingComponentsAtWeekday(reference.reference, tmp4, str5);
      }
      const str = arg1[2];
