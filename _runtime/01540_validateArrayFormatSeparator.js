            ...
            if (undefined !== arg1) {
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!encode) {
                    items1 = [closure_0, "[", length, "]"];
                    length = items1.join("");
                    items[arraySpreadResult] = length;
                    let items2 = items;
                  } else if (items1.strict) {
                    let encodeURIComponentResult = closure_0(1541)(closure_0);
                  } else {
                    const _encodeURIComponent4 = encodeURIComponent;
                    encodeURIComponentResult = encodeURIComponent(closure_0);
                  }
                  ...
                  if (!items1.encode) {
                    ...
                    let encodeURIComponentResult3 = closure_0(1541)(closure_0);
                  } else {
                    const _encodeURIComponent = encodeURIComponent;
                    encodeURIComponentResult3 = encodeURIComponent(closure_0);
                  }
                }
              } else {
                tmp = encode;
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!closure_0.encode) {
                    ...
                    let encodeURIComponentResult2 = closure_0(1541)(closure_0);
                  } else {
                    const _encodeURIComponent = encodeURIComponent;
                    encodeURIComponentResult2 = encodeURIComponent(closure_0);
                  }
                }
              } else {
                tmp = items1;
              ...
              if (!closure_0.skipNull) {
                ...
                if (0 === arg0.length) {
                  if (!closure_0.encode) {
                    ...
                    let encodeURIComponentResult1 = closure_0(1541)(closure_0);
                  } else {
                    const _encodeURIComponent2 = encodeURIComponent;
                    encodeURIComponentResult1 = encodeURIComponent(closure_0);
                  }
                } else {
                  const items2 = [arg0, ];
                  if (!closure_0.encode) {
...
export const stringifyUrl = (request, merged) => {
  ...
  const json = exports.stringify(Object.assign(exports.parse(exports.extract(request.url), { sort: false }), request.query), merged);
  let combined = json;
  if (json) {
  ...
  if (!request.fragmentIdentifier) {
    const _HermesInternal3 = HermesInternal;
    return "" + tmp4 + combined + str2;
  } else {
    const fragmentIdentifier = request.fragmentIdentifier;
    if (merged[closure_4]) {
      if (!merged.encode) {
...
export const exclude = (navTTISurface, arg1, arg2) => {
  closure_0 = arg1;
  return exports.pick(navTTISurface, Array.isArray(arg1) ? ((arg0) => !closure_0.includes(arg0)) : ((arg0, arg1) => !closure_0(arg0, arg1)), arg2);
};