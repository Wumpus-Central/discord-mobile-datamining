...
import code from "03896_code.js";
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("03655_getDefaultOptions.js").getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3897).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3897).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3897).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
