// _runtime/01546_prepareConfigResources.js
import findFocusedRoute from "01511_findFocusedRoute.js";
import validateArrayFormatSeparatorAll from "01540_validateArrayFormatSeparator.js";
import _mod1545 from "metro/01545__.js";
import arrayStartsWith from "01549_arrayStartsWith.js";
...
function getStaticSegmentPattern(arg0) {
  return Array.from(arg0, (str) => {
    ...
    return "(?:" + path(1547)(str) + "|" + path(1547)(encodeURIComponentResult) + ")";
  }).join("");
}
...
function createConfigItem(screen, items1, items2, parse, arg4) {
  ...
  function _loop2(screen) {
    const patternParts = _mod1545.getPatternParts(path);
    items = [
