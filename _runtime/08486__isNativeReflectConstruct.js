// _runtime/08486__isNativeReflectConstruct.js
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(8487), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(8489), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(8491), obj);
    items[3] = callback3(FeDropShadow(8480), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(8495), {}), callback3(FeDropShadow(8495), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(8493), obj);
    obj[0] = items;
