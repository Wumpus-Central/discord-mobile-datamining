...
export const METRIC_MAP = { [require(7460).COUNTER_METRIC_TYPE]: _moduleResult, [require(7460).GAUGE_METRIC_TYPE]: _moduleResult1, [require(7460).DISTRIBUTION_METRIC_TYPE]: _moduleResult2, [require(7460).SET_METRIC_TYPE]: _moduleResult3 };
