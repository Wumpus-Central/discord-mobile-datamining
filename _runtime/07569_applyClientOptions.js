// _runtime/07569_applyClientOptions.js
import { isMatchingPattern } from "07529_isMatchingPattern.js";
import { getFilenameToDebugIdMap } from "07572_getFilenameToDebugIdMap.js";
import { 07557__ } from "metro/07557__.js";
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (!DEFAULT_ENVIRONMENT) {
    DEFAULT_ENVIRONMENT = 07557__.DEFAULT_ENVIRONMENT;
  }
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(7565).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(7565);
                }
