// _runtime/01581_createStandardNavigationFactories.js
...
export const createStandardNavigationFactories = function createStandardNavigationFactories(arg0, arg1, arg2) {
  ...
  if ("standard" !== type) {
    ...
    obj[0] = require("01486_BaseNavigationContainer.js").createNavigatorFactory(
    ...
    obj[1] = require("01486_BaseNavigationContainer.js").createScreenFactory();
    return obj;
  }
};
