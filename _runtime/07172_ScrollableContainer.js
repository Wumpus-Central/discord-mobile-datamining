// _runtime/07172_ScrollableContainer.js
import BottomSheetDraggableScrollable from "07173_BottomSheetDraggableScrollable.js";
import _modDef7174 from "metro/07174__.js";
import _mod7176 from "metro/07176__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod7176.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef7174, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
