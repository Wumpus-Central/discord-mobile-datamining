// _runtime/07991_processBarButtonItems.js
import ColorDefault from "05691_Color.js";
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const isSearchBarAvailableForCurrentPlatform = colors(4958).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = colors(4958).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      ...
      let tmp32Result = closure_12(colors(4958).ScreenStackHeaderLeftView, obj6);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj8.children = closure_10(colors(5682).HeaderTitle, obj9);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      headerTitleResult = closure_10(colors(5682).HeaderTitle, obj10);
    }
    const obj11 = { children: headerTitleResult };
    tmp38Result = closure_10(colors(4958).ScreenStackHeaderCenterView, obj11);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    const obj12 = { source };
    let tmp40Result = closure_10(colors(4958).ScreenStackHeaderBackButtonImage, obj12);
  } else {
    tmp40Result = null;
  }
  ...
  if (null != headerRightResult) {
    ...
    tmp42 = closure_10(colors(4958).ScreenStackHeaderRightView, obj13);
  }
  items7[2] = tmp42;
  let tmp44 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj14.children = closure_10(colors(4958).SearchBar, obj15);
    tmp44 = closure_10(colors(4958).ScreenStackHeaderSearchBarView, obj14);
  }
  items7[3] = tmp44;
  const obj16 = {
    ...
    headerRightBarButtonItems: "APEX_EXPERIMENT_SESSION_OVERRIDE_CREATE",
