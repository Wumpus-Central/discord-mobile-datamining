...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_12989")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(12990).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(12990).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(12991)("hyphen replace", str);
        let str3 = str.replace(tmp11(12992).safeRe[tmp11(undefined, 12992).t.COMPARATORTRIM], tmp11(12992).comparatorTrimReplace);
        tmp11(12991)("comparator trim", str3);
        let str5 = str3.replace(tmp11(12992).safeRe[tmp11(undefined, 12992).t.TILDETRIM], tmp11(12992).tildeTrimReplace);
        tmp11(12991)("tilde trim", str5);
        const str7 = str5.replace(tmp11(12992).safeRe[tmp11(undefined, 12992).t.CARETTRIM], tmp11(12992).caretTrimReplace);
        tmp11(12991)("caret trim", str7);
  ...
  },
  {
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp !== "ge") {
          try {
            tmp = new Range(12988)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(12991)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13016).ANY) {
