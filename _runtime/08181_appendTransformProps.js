// _runtime/08181_appendTransformProps.js
import append from "08182_append.js";
import peg$SyntaxError from "08183_peg_SyntaxError.js";
import peg$SyntaxError2 from "08184_peg_SyntaxError.js";
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(8183);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(8182);
