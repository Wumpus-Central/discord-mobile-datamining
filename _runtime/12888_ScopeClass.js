...
const entry = {
  ...
  value: function clone() {
    ...
    obj = { traceId: null, spanId: null };
    let obj1 = ScopeClass(12877);
    obj.traceId = obj1.generateTraceId();
    let obj2 = ScopeClass(12877);
...
let items = [
  ...
  },
  {
    ...
    value: function clear() {
      ...
      obj.traceId = ScopeClass(12877).generateTraceId();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      const obj = {
        ...
        span: ScopeClass(12889)._getSpanForScope(self),
      };
      return obj;
    },
  },
