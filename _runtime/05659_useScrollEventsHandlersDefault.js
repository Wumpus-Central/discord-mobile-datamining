// _runtime/05659_useScrollEventsHandlersDefault.js
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = {
    animatedSheetState,
    SHEET_STATE: require("05633_GESTURE_SOURCE.js").SHEET_STATE,
    animatedHandleGestureState,
    State: require("05660_LegacyBaseButton.js").State,
    animatedScrollableState,
    SCROLLABLE_STATE: require("05633_GESTURE_SOURCE.js").SCROLLABLE_STATE,
    isLockingScroll: sharedValue1,
    scrollTo: require("01652_cancelAnimation.js").scrollTo,
    scrollableRef,
  ...
  obj[0] = require("01652_cancelAnimation.js").useWorkletCallback(E, items);
  ...
  obj[1] = require("01652_cancelAnimation.js").useWorkletCallback(O, items1);
  ...
  obj2 = {
    ...
    ANIMATION_STATE: require("05633_GESTURE_SOURCE.js").ANIMATION_STATE,
    rootScrollableContentOffsetY: animatedScrollableContentOffsetY,
  };
  fn2.__closure = obj2;
  ...
  obj[2] = require("01652_cancelAnimation.js").useWorkletCallback(fn2, items2);
  ...
  obj[3] = require("01652_cancelAnimation.js").useWorkletCallback(C, items3);
  return obj;
};
