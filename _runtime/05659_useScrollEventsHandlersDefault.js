// === Module 5659: useScrollEventsHandlersDefault ===
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  let obj2 = _require(1652);
  const sharedValue1 = obj2.useSharedValue(false);
  let obj3 = _require(1652);
  const fn = function _() {
  ...
  obj = { animatedSheetState, SHEET_STATE: _require(5633).SHEET_STATE, animatedHandleGestureState, State: _require(5660).State, animatedScrollableState, SCROLLABLE_STATE: _require(5633).SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: _require(1652).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj[0] = _require(1652).useWorkletCallback(E, items);
  const obj6 = _require(1652);
  class O {
    constructor(arg0, arg1) {
      y = scrollableRef.contentOffset.y;
      closure_1.value = y;
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: _require(5633).SHEET_STATE };
  O.__closure = obj1;
  ...
  obj[1] = _require(1652).useWorkletCallback(O, items1);
  const obj8 = _require(1652);
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: _require(5633).SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: _require(1652).scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: _require(5633).ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
  ...
  obj[2] = _require(1652).useWorkletCallback(fn2, items2);
  const obj10 = _require(1652);
  class C {
    constructor(arg0, arg1) {
      y = scrollableRef.contentOffset.y;
      tmp = closure_0;
  ...
  obj[3] = _require(1652).useWorkletCallback(C, items3);
  return obj;
};