...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: _require("05368_Directions.js").State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj[1] = _require("01606_cancelAnimation.js").useWorkletCallback(U, items1);
  const obj4 = _require("01606_cancelAnimation.js");
  class C {
    constructor(arg0) {
      if (closure_2.value === closure_0) {
        tmp3 = source;
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: _require("05341_GESTURE_SOURCE.js").GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  C.__workletHash = 10682034812271;
  C.__initData = closure_4;
  const items2 = [state, gestureSource, source, onEnd];
  obj[2] = _require("01606_cancelAnimation.js").useWorkletCallback(C, items2);
  ...
  obj1 = { gestureSource, source, state, GESTURE_SOURCE: _require("05341_GESTURE_SOURCE.js").GESTURE_SOURCE, onFinalize };
  T.__closure = obj1;
  T.__workletHash = 9696716573416;
  T.__initData = closure_5;
  const items3 = [state, gestureSource, source, onFinalize];
  obj[3] = _require("01606_cancelAnimation.js").useWorkletCallback(T, items3);
  return obj;
};