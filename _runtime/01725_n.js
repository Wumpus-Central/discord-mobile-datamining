...
let fn = function n(config, _animationToClamp) {
  ...
  obj = { _animationToClamp, config, recognizePrefixSuffix: _require(1692).recognizePrefixSuffix, logger: _require(1656).logger, getReduceMotionForAnimation: _require(1692).getReduceMotionForAnimation };
  fn.__closure = obj;
