// _runtime/01725_n.js
import { isValidLayoutAnimationProp } from "01692_isValidLayoutAnimationProp.js";
const require = arg1;
...
let fn = function n(config, _animationToClamp) {
  ...
  const fn = function u() {
    ...
    if (undefined !== config.max) {
      strippedValue1 = config(1692).recognizePrefixSuffix(tmp3.max).strippedValue;
      const obj2 = config(1692);
    }
    obj = {
      isHigherOrder: true,
      ...
      reduceMotion: config(1692).getReduceMotionForAnimation(config.reduceMotion),
    };
    return obj;
  };
  obj = {
    _animationToClamp,
    config,
    recognizePrefixSuffix: require("01692_isValidLayoutAnimationProp.js").recognizePrefixSuffix,
    logger: require("01656_addLogBoxLog.js").logger,
    getReduceMotionForAnimation: require("01692_isValidLayoutAnimationProp.js").getReduceMotionForAnimation,
  };
  fn.__closure = obj;
