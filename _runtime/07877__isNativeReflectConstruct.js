// _runtime/07877__isNativeReflectConstruct.js
...
import { extractFont } from "07797_extractFont.js";
import { _isNativeReflectConstruct } from "07874__isNativeReflectConstruct.js";
import { __INTERNAL_VIEW_CONFIG } from "metro/07878___INTERNAL_VIEW_CONFIG.js";
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(7791).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
