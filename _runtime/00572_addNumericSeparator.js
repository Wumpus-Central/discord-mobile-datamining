// _runtime/00572_addNumericSeparator.js
import _mod573 from "metro/00573__.js";
import { 00573__ } from "metro/00573__.js";
...
let custom = null;
if (isSymbol(_mod573.custom)) {
  custom = _mod573.custom;
}
                    ...
                    if (custom) {
                      if (typeof cause[custom] === "function") {
                        ...
                        if (00573__) {
                          obj = { depth: null };
                          obj[0] = num5 - num7;
                          return typeError1(573)(cause, obj);
                        }
                      }
                    }
                    if ("symbol" !== customInspect) {
