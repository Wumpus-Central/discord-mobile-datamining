...
import controlEdgeToEdgeValues from "01652_controlEdgeToEdgeValues.js";
import { cancelAnimation } from "01653_cancelAnimation.js";
import { useEventHandlerRegistration } from "01842_useEventHandlerRegistration.js";
import { useAnimatedKeyboardHandler } from "01844_useAnimatedKeyboardHandler.js";
...
export const KeyboardProvider = (enabled) => {
  ...
  sharedValue2 = require("01653_cancelAnimation.js").useSharedValue(null);
  ...
  const animatedKeyboardHandler = require("01844_useAnimatedKeyboardHandler.js").useAnimatedKeyboardHandler(obj, []);
  ...
  obj3[9] = tmp11;
  obj3[10] = tmp11;
  obj3[11] = require("01844_useAnimatedKeyboardHandler.js").useFocusedInputLayoutHandler(obj1, []);
  obj3[12] = children;
  const items2 = [closure_10(closure_13, obj3), closure_10(Animated.View, { style: tmp10 })];
  obj2[1] = items2;
  return closure_11(require("01846_NOOP.js").KeyboardContext.Provider, obj2);
};