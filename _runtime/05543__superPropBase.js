// _runtime/05543__superPropBase.js
...
export default function _superPropBase(arg0, key10009) {
  ...
  if (!(typeof call === "unknown" ? hasOwnProperty(key10009) : call(arg0, key10009))) {
    let tmp4 = require("05541__getPrototypeOf.js") /* _getPrototypeOf */(arg0);
    tmp = tmp4;
    if (null !== tmp4) {
      while (true) {
        ...
        if (typeof call2 === "unknown" ? hasOwnProperty2(key10009) : call2(tmp4, key10009)) {
          ...
          tmp4 = require("05541__getPrototypeOf.js") /* _getPrototypeOf */(tmp4);
          tmp = tmp4;
          if (null === tmp4) {
            break;
          }
