        ...
        localeError: (code) => {
          ...
          switch (code) {
            ...
            case "$ZodCheckLowerCase":
              break;
            case "USER_PREMIUM_OFFER_EXPIRES_APPROACHING_4_DAY_THRESHOLD":
              break;
            ...
            case "MRT":
              break;
            case "RTC_CONNECTION_PING":
              break;
            case "GUILD_EVENT_MAX_DESCRIPTION_LENGTH":
              break;
            case "MAX_DESCRIPTION_LENGTH":
              break;
            case "useIsInPrivateProfilesExperiment":
              break;
            ...
            case "woman_mage":
              break;
            case "woman_mage_dark_skin_tone":
              break;
            case "man_mage":
              break;
            case "man_mage_dark_skin_tone":
              break;
            case "mage_dark_skin_tone":
              break;
            ...
            case "transitionSpec":
              break;
            case "voidToOptionValue":
              break;
            case "$ZodCheckUpperCase":
              break;
            case "BRAWLHALLA":
              break;
            case "LABEL_TOP_PADDING":
              break;
            ...
            case "lockState":
              break;
            case "requestAgeVerification":
              break;
            case "requestAgeVerificationV2":
              break;
            ...
            case "PageDown":
              break;
            case "useForumChannelStore":
              break;
            case "useForumChannelStoreApi":
              break;
            ...
            case "rootCommand":
              break;
            case "RESUME_CAMERA_VIEW":
              break;
            case "VIEW_INTERNAL_SURFACE_IMPRESSION":
              break;
            ...
            case "QUEST_ACTIVITY_BOTTOM_SHEET":
              break;
            case "REMIXING_ACTION_SHEET_UPSELL":
              break;
            case "$ZodLazy":
              break;
            case "ZodLazy":
            ...
            case "LazyViewManagersEnabled":
              break;
            case "getWasEverMultiParticipant":
              break;
            ...
            case "poll_media":
              break;
            case "_mediaEngineConnectDuration":
              break;
            case "mediaEngine":
              break;
            case "objectify":
