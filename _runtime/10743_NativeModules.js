// _runtime/10743_NativeModules.js
...
export const getInstallSourceAndroid = () => {
  const InstallSourceAndroid = callback(10735).InstallSourceAndroid;
