// _runtime/00722_getDynamicSamplingContextFromSpan.js
import addNonEnumerableProperty from "00687_addNonEnumerableProperty.js";
import baggageHeaderToDynamicSamplingContext from "00700_baggageHeaderToDynamicSamplingContext.js";
import dsnFromString from "00702_dsnFromString.js";
  ...
  if (client) {
    ...
    if (rootSpan[_frozenDsc]) {
      ...
      if (result) {
        ...
        obj[4] = tmp(702).extractOrgIdFromClient(client);
...
arg5.getDynamicSamplingContextFromClient = function getDynamicSamplingContextFromClient(trace_id, getOptions) {
  ...
  let DEFAULT_ENVIRONMENT = options.environment;
  if (!DEFAULT_ENVIRONMENT) {
    DEFAULT_ENVIRONMENT = _mod723.DEFAULT_ENVIRONMENT;
  }
  const obj = {
