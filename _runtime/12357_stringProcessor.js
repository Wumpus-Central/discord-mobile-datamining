// _runtime/12357_stringProcessor.js
...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(12356).process(_idmap, initializeContextResult);
    tmp2(12356).extractDefs(initializeContextResult, _idmap);
    return tmp2(12356).finalize(initializeContextResult, _idmap);
  }
