// _runtime/04955_parseBezierKnot.js
...
obj = {
  ...
  path(dataView, sum) {
    const items = [_modDef4932.getShortAt(dataView, sum)];
    return items;
  }
};
let closure_4 = {
  ...
  [obj.CLIPBOARD]: {
    ...
    path: function parseClipboard(dataView, sum) {
      const longAt = _modDef4932.getLongAt(dataView, sum);
      let num = -1;
      let num2 = -1;
      if (longAt >>> 31 === 0) {
        num2 = 1;
      }
      const obj = _modDef4932;
      ...
      let tmp4Result = tmp4(4915);
      const obj4 = getDataView;
      tmp4Result = tmp4(4915);
      ...
      const longAt3 = _modDef4932.getLongAt(dataView, sum2);
      let num5 = num;
      if (longAt3 >>> 31 === 0) {
        num5 = 1;
      }
      const tmpResult1 = _modDef4932;
      ...
      const longAt4 = _modDef4932.getLongAt(dataView, sum3);
      if (longAt4 >>> 31 === 0) {
        num = 1;
      }
      const tmpResult2 = _modDef4932;
