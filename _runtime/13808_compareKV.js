// _runtime/13808_compareKV.js
import e from "01281_e.js";
import emitUnicodeLanguageId from "13807_emitUnicodeLanguageId.js";
import _mod13809 from "metro/13809__.js";
...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants.length) {
      ...
      obj[1] = items;
      const str = _mod13809.languageAlias[emitUnicodeLanguageId.emitUnicodeLanguageId(undefined, obj)];
      while (!str) {
        num3 = num3 + 1;
        tmp = lang;
      }
      obj = { lang: null, script: null, region: null, variants: null };
      const result = tmp2(13810).parseUnicodeLanguageId(str.split(tmp2(13810).SEPARATOR));
      obj[0] = result.lang;
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      obj[3] = [];
      const str2 = _mod13809.languageAlias[emitUnicodeLanguageId.emitUnicodeLanguageId(undefined, obj)];
      tmp9 = tmp;
      if (str2) {
        obj1 = { lang: null, script: null, region: null, variants: null };
        const result1 = tmp10(13810).parseUnicodeLanguageId(str2.split(tmp10(13810).SEPARATOR));
  ...
  if (tmp9.region) {
    ...
    obj2[2] = [];
    const str3 = _mod13809.languageAlias[emitUnicodeLanguageId.emitUnicodeLanguageId(undefined, obj2)];
    tmp13 = tmp9;
    if (str3) {
      const obj3 = { lang: null, script: null, region: null, variants: null };
      const result2 = tmp14(13810).parseUnicodeLanguageId(str3.split(tmp14(13810).SEPARATOR));
      obj3[0] = result2.lang;
  ...
  const str4 = _mod13809.languageAlias[emitUnicodeLanguageId.emitUnicodeLanguageId(undefined, obj4)];
  let tmp19 = tmp13;
  if (str4) {
    const obj5 = { lang: null, script: null, region: null, variants: null };
    const result3 = tmp17(13810).parseUnicodeLanguageId(str4.split(tmp17(13810).SEPARATOR));
    obj5[0] = result3.lang;
  ...
  if (tmp19.region) {
    ...
    const str6 = tmp17(13809).territoryAlias[formatted];
    let tmp22;
    if (str6) {
      ...
      obj6[2] = [];
      const str8 = tmp17(13811).likelySubtags[tmp17(undefined, 13807).emitUnicodeLanguageId(undefined, obj6)];
      tmp22 = first;
      if (str8) {
        const region = tmp17(13810).parseUnicodeLanguageId(str8.split(tmp17(13810).SEPARATOR)).region;
        let tmp24 = region;
        if (region) {
  ...
  if (tmp19.script) {
    ...
    if (tmp17(13809).scriptAlias[tmp19.script]) {
      tmp19.script = tmp17(13809).scriptAlias[tmp19.script];
    }
  ...
  if (tmp19.variants.length) {
    for (let num7 = 0; num7 < tmp19.variants.length; num7 = num7 + 1) {
      ...
      let tmp29 = num7;
      if (_mod13809.variantAlias[formatted2]) {
        let tmp30 = tmp27(13809).variantAlias[formatted2];
        if (tmp27(13810).isUnicodeVariantSubtag(tmp30)) {
          tmp19.variants[num7] = tmp30;
        } else if (tmp27(13810).isUnicodeLanguageSubtag(tmp30)) {
          tmp19.lang = tmp30;
        }
      }
    }
