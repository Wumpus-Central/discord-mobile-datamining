// _runtime/01645_runWorkletOnJS.js
import ReanimatedModule2 from "01646_ReanimatedModule.js";
import _mod1663 from "metro/01663__.js";
import freezeObjectInDev from "01668_freezeObjectInDev.js";
import module_1641_mod from "metro/01641__.js";
    ...
    if (module_1641) {
      ...
      if (1 === closure_1_5.length) {
        ...
        queueMicrotask(() => {
          closure_0 = queue;
          queue = [];
          const ReanimatedModule = closure_1(1646).ReanimatedModule;
          fn = function n() {
          ...
          fn.__initData = __initData;
          ReanimatedModule.scheduleOnUI(closure_1(1668).makeShareableCloneRecursive(fn));
        });
      }
    }
  };
}
runOnUI.__closure = { __DEV__: false, SHOULD_BE_USE_WEB: module_1641, isWorkletFunction: _mod1663.isWorkletFunction, IS_JEST: module_1641, ReanimatedModule: ReanimatedModule2.ReanimatedModule, makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive, callMicrotasks: callMicrotasksOnUIThread };
...
let obj = { __DEV__: false, SHOULD_BE_USE_WEB: module_1641, isWorkletFunction: _mod1663.isWorkletFunction, IS_JEST: module_1641, ReanimatedModule: ReanimatedModule2.ReanimatedModule, makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive, callMicrotasks: callMicrotasksOnUIThread };
runOnUIImmediately.__closure = { __DEV__: false, SHOULD_BE_USE_WEB: module_1641, isWorkletFunction: _mod1663.isWorkletFunction, ReanimatedModule: ReanimatedModule2.ReanimatedModule, makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive };
...
function runOnJS(__remoteFunction) {
  if (!module_1641) {
    if (globalThis._WORKLET) {
      ...
      obj = _scheduleRemoteFunctionOnJS(1663);
    }
  }
  return () => {
    const items = [...arguments];
...
let obj2 = { __DEV__: false, SHOULD_BE_USE_WEB: module_1641, isWorkletFunction: _mod1663.isWorkletFunction, ReanimatedModule: ReanimatedModule2.ReanimatedModule, makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive };
runOnJS.__closure = { SHOULD_BE_USE_WEB: module_1641, isWorkletFunction: _mod1663.isWorkletFunction, runWorkletOnJS, makeShareableCloneOnUIRecursive: freezeObjectInDev.makeShareableCloneOnUIRecursive };
