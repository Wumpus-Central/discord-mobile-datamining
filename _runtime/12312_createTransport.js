// _runtime/12312_createTransport.js
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(12293).envelopeItemTypeToDataCategory(arg1);
        const obj = items(12293);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(12293).serializeEnvelope(dependencyMap) };
          const obj2 = items(12293);
          ...
          if (arg0 instanceof items(12306).SentryError) {
