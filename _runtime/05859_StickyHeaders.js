// === Module 5859: StickyHeaders ===

// Module 5859 (StickyHeaders)
import noopDefault from "noop" /* 19 */;
import closure_2 from "_slicedToArray" /* 5806 */;
...
export const StickyHeaders = (stickyHeaderIndices) => {
  ...
  tmp3Result = tmp3(() => {
    ...
    if (-1 !== currentStickyIndex) {
      tmpResult = null;
      if (tmp4 < data.length) {
        obj1 = { index: null, item: null, renderItem: null, layout: null, refHolder: null, extraData: null, trailingItem: "accessibilityRole", target: 0., hidden: 0., inverted: 0. };
        obj1[0] = tmp4;
        obj1[1] = tmp6[tmp4];
        obj1[2] = renderItem;
