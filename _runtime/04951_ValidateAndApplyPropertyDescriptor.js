// _runtime/04951_ValidateAndApplyPropertyDescriptor.js
...
import DefineOwnProperty from "04939_DefineOwnProperty.js";
import IsDataDescriptor from "04940_IsDataDescriptor.js";
import SameValue from "04941_SameValue.js";
import FromPropertyDescriptor from "04942_FromPropertyDescriptor.js";
...
import IsGenericDescriptor from "04954_IsGenericDescriptor.js";

export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__, arg4) {
  const tmp3 = _mod4952(arg0);
  if (undefined !== arg0) {
    if (!_mod4885(arg0)) {
      const tmp6 = new _mod1281("Assertion failed: O must be undefined or an Object");
      throw tmp6;
    }
  }
  if (_mod4932(arg1)) {
    if (typeof flag !== "boolean") {
      const tmp88 = new _mod1281("Assertion failed: extensible must be a Boolean");
      throw tmp88;
    } else if (_mod4936(__Configurable__)) {
      let prop = arg4;
      if (undefined !== arg4) {
        if (!_mod4936(prop)) {
          const tmp20 = new _mod1281("Assertion failed: current must be a Property Descriptor, or undefined");
          throw tmp20;
        }
      }
      if (undefined === prop) {
