// _runtime/05701_useGestureCallbacks.js
import isGestureEnabled from "05685_isGestureEnabled.js";
import useGestureEventHandler from "05702_useGestureEventHandler.js";
...
arg5.useGestureCallbacks = function useGestureCallbacks(handlerTag, disableReanimated) {
  ...
  if (!disableReanimated.disableReanimated) {
    const Reanimated = tmp(5660).Reanimated;
    let handler;
    if (Reanimated != null) {
      handler = Reanimated.useHandler(memoizedGestureCallbacks);
    }
    const tmpResult = tmp(5704);
