// _runtime/05710_HeaderBackButton.js
import Link from "01484_Link.js";
import _modDef5682 from "metro/05682__.js";
import HeaderIcon from "05711_HeaderIcon.js";
import HeaderButton from "05716_HeaderButton.js";
...
obj = { flexDirection: "row", alignItems: "flex-start", marginEnd: fn(5711).ICON_MARGIN };
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1 = { source: _modDef5682, tintColor, style: null };
