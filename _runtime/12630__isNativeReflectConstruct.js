...
let items = [
  {
    ...
    value: function eventFromException(arg0, arg1) {
      const result = ServerRuntimeClient(12631).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
      result.level = "error";
      const obj = ServerRuntimeClient(12631);
      return ServerRuntimeClient(12595).resolvedSyncPromise(result);
    }
  },
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12595);
      return obj.resolvedSyncPromise(ServerRuntimeClient(12631).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12598).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12598);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        obj[0] = release;
        obj[1] = tmp;
        const sessionFlusher = new tmp2(12624).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12599).DEBUG_BUILD) {
        const logger = tmp2(12571).logger;
    ...
    value: function captureCheckIn(checkInId) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12632);
          ...
          if (ServerRuntimeClient(12599).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12571).logger;
          ...
          if (ServerRuntimeClient(12599).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12571).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      obj = ServerRuntimeClient(12582);
      checkInId = obj.uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12593)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let tmpResult = tmp(12576);
        ...
        const tmpResult1 = ServerRuntimeClient(12607);
        if (_getSpanForScopeResult) {
