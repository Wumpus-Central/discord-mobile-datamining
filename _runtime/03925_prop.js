...
if (Intl.ListFormat) {
  ...
  if (typeof Intl.ListFormat.__addLocaleData === "function") {
    ...
    obj[0] = { end: "{0} \uBC0F {1}", middle: "{0}, {1}", pair: "{0} \uBC0F {1}", start: "{0}, {1}" };
    obj[1] = { end: "{0} \uBC0F {1}", middle: "{0}, {1}", pair: "{0} \uBC0F {1}", start: "{0}, {1}" };
    obj[2] = { end: "{0} \uBC0F {1}", middle: "{0}, {1}", pair: "{0} \uBC0F {1}", start: "{0}, {1}" };
    obj[0] = obj;
    const obj1 = { long: null, narrow: null, short: null };
    obj1[0] = { end: "{0} \uB610\uB294 {1}", middle: "{0}, {1}", pair: "{0} \uB610\uB294 {1}", start: "{0}, {1}" };
    obj1[1] = { end: "{0} \uB610\uB294 {1}", middle: "{0}, {1}", pair: "{0} \uB610\uB294 {1}", start: "{0}, {1}" };
    obj1[2] = { end: "{0} \uB610\uB294 {1}", middle: "{0}, {1}", pair: "{0} \uB610\uB294 {1}", start: "{0}, {1}" };
    obj[1] = obj1;
