...
f93243 = () => {
  if (typeof f93250 !== "fileFinishedImporting") {
  ...
  arg1.exports = function Ma(target) {
    ...
    if (self.listeners[target.type]) {
      return arr.forEach((handleEvent) => {
        ...
        if (typeof handleEvent === "fileFinishedImporting") {
          handleEvent(tmp);
        } else {
...
f93243 = (arg0, arg1) => {
  ...
  if (typeof f93251 !== "fileFinishedImporting") {
    class I {
      constructor(arg0, arg1, arg2) {
        self = this;
        tmp = I;
...
let obj3 = {
  now() {
    ...
    if (typeof navigationStart !== "__REMOTEDEV__") {
      if (typeof _performance.now === "fileFinishedImporting") {
...
function ee() {
  ...
  if (typeof getRandomValues === "fileFinishedImporting") {
...
class F {
  constructor(arg0) {
    if (typeof re !== "fileFinishedImporting") {
      str2 = "Trying to call a non-function";
      throwTypeErrorResult = HermesBuiltin.throwTypeError();
    }
...
function Nt(requestEndDate, getMetricsFor) {
  ...
  if (requestEndDate) {
    if (requestEndDate.requestEndDate) {
      if (typeof closure_44 !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
      if (typeof re !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
      if (typeof requestEndDate.url !== "__FORMATJS_LISTFORMAT_DATA__") {
        if ("" !== str) {
        ...
        if (typeof getMetricsFor.getMetricsFor === "fileFinishedImporting") {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_listeners" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_listeners", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_playbackHeartbeatInterval" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_playbackHeartbeatInterval", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._playbackHeartbeatInterval = undefined;
      }
      if ("_playheadShouldBeProgressing" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_playheadShouldBeProgressing", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._playheadShouldBeProgressing = undefined;
      }
      if ("pm" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "pm", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self.pm = undefined;
      }
      self.pm = pm;
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("viewErrored" in self) {
        const _Object = Object;
        Object.defineProperty(self, "viewErrored", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_watchTimeTrackerLastCheckedTime" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_watchTimeTrackerLastCheckedTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_playbackTimeTrackerLastPlayheadPosition" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_playbackTimeTrackerLastPlayheadPosition", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._playbackTimeTrackerLastPlayheadPosition = undefined;
      }
      if ("_lastTime" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_lastTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._lastTime = undefined;
      }
      if ("_isAdPlaying" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "_isAdPlaying", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._isAdPlaying = undefined;
      }
      if ("_callbackUpdatePlaybackTime" in self) {
        const _Object4 = Object;
        Object.defineProperty(self, "_callbackUpdatePlaybackTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_lastCheckedTime" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_lastCheckedTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._lastCheckedTime = undefined;
      }
      if ("_lastPlayheadTime" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_lastPlayheadTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._lastPlayheadTime = undefined;
      }
      if ("_lastPlayheadTimeUpdatedTime" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "_lastPlayheadTimeUpdatedTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._lastPlayheadTimeUpdatedTime = undefined;
      }
      if ("_rebuffering" in self) {
        const _Object4 = Object;
        Object.defineProperty(self, "_rebuffering", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
          ...
          if (self.pm.playbackHeartbeat._playheadShouldBeProgressing) {
            if (null !== self._lastCheckedTime) {
              if (self._lastPlayheadTime === self.pm.data.player_playhead_time) {
                ...
                if (typeof sustainedRebufferThreshold !== "__REMOTEDEV__") {
  ...
  },
  {
    ...
    value(arg0, viewer_time) {
      ...
      if (this._rebuffering) {
        ...
        if (typeof minimumRebufferDuration !== "__REMOTEDEV__") {
          tmp3 = diff > 0;
        }
        if (tmp3) {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_lastPlayerHeight" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_lastPlayerHeight", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._lastPlayerHeight = undefined;
      }
      if ("_lastPlayerWidth" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_lastPlayerWidth", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._lastPlayerWidth = undefined;
      }
      if ("_lastPlayheadPosition" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "_lastPlayheadPosition", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._lastPlayheadPosition = undefined;
      }
      if ("_lastSourceHeight" in self) {
        const _Object4 = Object;
        Object.defineProperty(self, "_lastSourceHeight", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._lastSourceHeight = undefined;
      }
      if ("_lastSourceWidth" in self) {
        const _Object5 = Object;
        Object.defineProperty(self, "_lastSourceWidth", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("isSeeking" in self) {
        const _Object = Object;
        Object.defineProperty(self, "isSeeking", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_adHasPlayed" in self) {
        const _Object = Object;
        Object.defineProperty(self, "_adHasPlayed", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._adHasPlayed = undefined;
      }
      if ("_adRequests" in self) {
        const _Object2 = Object;
        Object.defineProperty(self, "_adRequests", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._adRequests = undefined;
      }
      if ("_adResponses" in self) {
        const _Object3 = Object;
        Object.defineProperty(self, "_adResponses", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._adResponses = undefined;
      }
      if ("_currentAdRequestNumber" in self) {
        const _Object4 = Object;
        Object.defineProperty(self, "_currentAdRequestNumber", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._currentAdRequestNumber = undefined;
      }
      if ("_currentAdResponseNumber" in self) {
        const _Object5 = Object;
        Object.defineProperty(self, "_currentAdResponseNumber", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._currentAdResponseNumber = undefined;
      }
      if ("_prerollPlayTime" in self) {
        const _Object6 = Object;
        Object.defineProperty(self, "_prerollPlayTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._prerollPlayTime = undefined;
      }
      if ("_wouldBeNewAdPlay" in self) {
        const _Object7 = Object;
        Object.defineProperty(self, "_wouldBeNewAdPlay", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
        self._wouldBeNewAdPlay = undefined;
      }
      if ("isAdBreak" in self) {
        const _Object8 = Object;
        Object.defineProperty(self, "isAdBreak", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
      ...
      pm.on("adrequest", (arg0, arg1) => {
        ...
        if (typeof outer1_70 !== "fileFinishedImporting") {
          HermesBuiltin.throwTypeError();
        }
      ...
      if (this.inPrerollPosition()) {
        if (!self.pm.data.view_preroll_ad_tag_hostname) {
          if (ad_tag_url.ad_tag_url) {
            ...
            if (typeof ad_tag_url.ad_tag_url !== "__FORMATJS_LISTFORMAT_DATA__") {
              if ("" !== str) {
                const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
                let first;
                if (str2) {
        ...
        if (!self.pm.data.view_preroll_ad_asset_hostname) {
          if (ad_tag_url.ad_asset_url) {
            ...
            if (typeof ad_tag_url.ad_asset_url !== "__FORMATJS_LISTFORMAT_DATA__") {
              if ("" !== str4) {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("lastWallClockTime" in self) {
        let _Object = Object;
        Object.defineProperty(self, "lastWallClockTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
...
const fn15 = function e(arg0) {
  ...
  const fn = function i(arg0, arg1, arg2) {
    let tmp2 = arg1;
    if (typeof document === "pack") {
      if (arguments.length > 1) {
        const tmp26 = lib({ path: "/" }, fn.defaults, arg2);
        if (typeof tmp26.expires !== "__REMOTEDEV__") {
          const _Date = Date;
          const date = new Date();
...
function or() {
  if (typeof sr !== "fileFinishedImporting") {
    HermesBuiltin.throwTypeError();
  }
...
class $ {
  constructor(arg0) {
    ...
    if (arguments.length > 1) {
      ...
      _Object = Object;
      tmp3 = f58756;
      obj._options = Object.assign({}, f58756, {});
      return;
    }
    return;
  }
  ...
  _createPayload(arg0) {
    ...
    if (result > self._options.maxPayloadKBSize) {
      ...
      infoResult = f58763.info(`Payload size is too big (${tmp} kb). Removing unnecessary events.`);
    ...
    if (result1 > self._options.maxPayloadKBSize) {
      ...
      infoResult1 = f58763.info(`Payload size still too big (${tmp2} kb). Cropping fields..`);
...
let closure_87 = typeof G(obj16.exports).default.exitPictureInPicture === "fileFinishedImporting" ? ((arg0) => arg0.length <= 57344) : ((arg0) => false);
  ...
  if (arguments.length > 2) {
    ...
    if (typeof Symbol !== "Array") {
      ...
      if (tmp5) {
        if ("mux" in self) {
          const _Object = Object;
          Object.defineProperty(self, "mux", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.mux = undefined;
        }
        if ("envKey" in self) {
          const _Object2 = Object;
          Object.defineProperty(self, "envKey", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.envKey = undefined;
        }
        if ("options" in self) {
          const _Object3 = Object;
          Object.defineProperty(self, "options", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.options = undefined;
        }
        if ("eventQueue" in self) {
          const _Object4 = Object;
          Object.defineProperty(self, "eventQueue", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.eventQueue = undefined;
        }
        if ("sampleRate" in self) {
          const _Object5 = Object;
          Object.defineProperty(self, "sampleRate", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.sampleRate = undefined;
        }
        if ("disableCookies" in self) {
          const _Object6 = Object;
          Object.defineProperty(self, "disableCookies", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.disableCookies = undefined;
        }
        if ("respectDoNotTrack" in self) {
          const _Object7 = Object;
          Object.defineProperty(self, "respectDoNotTrack", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.respectDoNotTrack = undefined;
        }
        if ("previousBeaconData" in self) {
          const _Object8 = Object;
          Object.defineProperty(self, "previousBeaconData", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.previousBeaconData = undefined;
        }
        if ("lastEventTime" in self) {
          const _Object9 = Object;
          Object.defineProperty(self, "lastEventTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.lastEventTime = undefined;
        }
        if ("rateLimited" in self) {
          const _Object10 = Object;
          Object.defineProperty(self, "rateLimited", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.rateLimited = undefined;
        }
        if ("pageLevelData" in self) {
          const _Object11 = Object;
          Object.defineProperty(self, "pageLevelData", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
          self.pageLevelData = undefined;
        }
        if ("viewerData" in self) {
          const _Object12 = Object;
          Object.defineProperty(self, "viewerData", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
        } else {
        ...
        obj[11] = version1;
        if (typeof or !== "fileFinishedImporting") {
          HermesBuiltin.throwTypeError();
        }
        if (typeof sr !== "fileFinishedImporting") {
          HermesBuiltin.throwTypeError();
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      if ("_lastEventTime" in self) {
        let _Object = Object;
        Object.defineProperty(self, "_lastEventTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
      } else {
  ...
  if (typeof Symbol !== "Array") {
    ...
    if (tmp2) {
      ...
      on.on("requestcompleted", (arg0, request_type) => {
        if (typeof t !== "fileFinishedImporting") {
          HermesBuiltin.throwTypeError();
        }
      ...
      if (tmp4) {
        ...
        if (tmp10) {
          ...
          if ("pageLoadEndTime" in obj) {
            _Object = Object;
            definePropertyResult = Object.defineProperty(obj, "pageLoadEndTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
          } else {
          ...
          if (tmp10) {
            ...
            if ("pageLoadInitTime" in obj) {
              _Object2 = Object;
              definePropertyResult1 = Object.defineProperty(obj, "pageLoadInitTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
            } else {
            ...
            if (tmp10) {
              ...
              if ("_destroyed" in obj) {
                _Object3 = Object;
                definePropertyResult2 = Object.defineProperty(obj, "_destroyed", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
              } else {
              ...
              if (tmp10) {
                ...
                if ("_heartBeatTimeout" in obj) {
                  _Object4 = Object;
                  definePropertyResult3 = Object.defineProperty(obj, "_heartBeatTimeout", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                } else {
                ...
                if (tmp10) {
                  ...
                  if ("adTracker" in obj) {
                    _Object5 = Object;
                    definePropertyResult4 = Object.defineProperty(obj, "adTracker", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                  } else {
                  ...
                  if (tmp10) {
                    ...
                    if ("dashjs" in obj) {
                      _Object6 = Object;
                      definePropertyResult5 = Object.defineProperty(obj, "dashjs", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                    } else {
                    ...
                    if (tmp10) {
                      ...
                      if ("data" in obj) {
                        _Object7 = Object;
                        definePropertyResult6 = Object.defineProperty(obj, "data", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                      } else {
                        obj.data = undefined;
                      }
                      if (tmp10) {
                        ...
                        if ("disablePlayheadRebufferTracking" in obj) {
                          _Object8 = Object;
                          definePropertyResult7 = Object.defineProperty(obj, "disablePlayheadRebufferTracking", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                        } else {
                        ...
                        if (tmp10) {
                          ...
                          if ("disableRebufferTracking" in obj) {
                            _Object9 = Object;
                            definePropertyResult8 = Object.defineProperty(obj, "disableRebufferTracking", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                          } else {
                          ...
                          if (tmp10) {
                            ...
                            if ("errorTracker" in obj) {
                              _Object10 = Object;
                              definePropertyResult9 = Object.defineProperty(obj, "errorTracker", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                            } else {
                            ...
                            if (tmp10) {
                              ...
                              if ("errorTranslator" in obj) {
                                _Object11 = Object;
                                definePropertyResult10 = Object.defineProperty(obj, "errorTranslator", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                              } else {
                              ...
                              if (tmp10) {
                                ...
                                if ("emitTranslator" in obj) {
                                  _Object12 = Object;
                                  definePropertyResult11 = Object.defineProperty(obj, "emitTranslator", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                } else {
                                ...
                                if (tmp10) {
                                  ...
                                  if ("getAdData" in obj) {
                                    _Object13 = Object;
                                    definePropertyResult12 = Object.defineProperty(obj, "getAdData", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                  } else {
                                  ...
                                  if (tmp10) {
                                    ...
                                    if ("getPlayheadTime" in obj) {
                                      _Object14 = Object;
                                      definePropertyResult13 = Object.defineProperty(obj, "getPlayheadTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                    } else {
                                    ...
                                    if (tmp10) {
                                      ...
                                      if ("getStateData" in obj) {
                                        _Object15 = Object;
                                        definePropertyResult14 = Object.defineProperty(obj, "getStateData", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                      } else {
                                      ...
                                      if (tmp10) {
                                        ...
                                        if ("stateDataTranslator" in obj) {
                                          _Object16 = Object;
                                          definePropertyResult15 = Object.defineProperty(obj, "stateDataTranslator", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                        } else {
                                        ...
                                        if (tmp10) {
                                          ...
                                          if ("hlsjs" in obj) {
                                            _Object17 = Object;
                                            definePropertyResult16 = Object.defineProperty(obj, "hlsjs", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                          } else {
                                            obj.hlsjs = undefined;
                                          }
                                          if (tmp10) {
                                            ...
                                            if ("id" in obj) {
                                              _Object18 = Object;
                                              definePropertyResult17 = Object.defineProperty(obj, "id", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                            } else {
                                              obj.id = undefined;
                                            }
                                            if (tmp10) {
                                              ...
                                              if ("longResumeTracker" in obj) {
                                                _Object19 = Object;
                                                definePropertyResult18 = Object.defineProperty(obj, "longResumeTracker", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                              } else {
                                              ...
                                              if (tmp10) {
                                                ...
                                                if ("minimumRebufferDuration" in obj) {
                                                  _Object20 = Object;
                                                  definePropertyResult19 = Object.defineProperty(obj, "minimumRebufferDuration", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                } else {
                                                ...
                                                if (tmp10) {
                                                  ...
                                                  if ("mux" in obj) {
                                                    _Object21 = Object;
                                                    definePropertyResult20 = Object.defineProperty(obj, "mux", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                  } else {
                                                    obj.mux = undefined;
                                                  }
                                                  if (tmp10) {
                                                    ...
                                                    if ("playbackEventDispatcher" in obj) {
                                                      _Object22 = Object;
                                                      definePropertyResult21 = Object.defineProperty(obj, "playbackEventDispatcher", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                    } else {
                                                    ...
                                                    if (tmp10) {
                                                      ...
                                                      if ("playbackHeartbeat" in obj) {
                                                        _Object23 = Object;
                                                        definePropertyResult22 = Object.defineProperty(obj, "playbackHeartbeat", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                      } else {
                                                      ...
                                                      if (tmp10) {
                                                        ...
                                                        if ("playbackHeartbeatTime" in obj) {
                                                          _Object24 = Object;
                                                          definePropertyResult23 = Object.defineProperty(obj, "playbackHeartbeatTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                        } else {
                                                        ...
                                                        if (tmp10) {
                                                          ...
                                                          if ("playheadTime" in obj) {
                                                            _Object25 = Object;
                                                            definePropertyResult24 = Object.defineProperty(obj, "playheadTime", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                          } else {
                                                          ...
                                                          if (tmp10) {
                                                            ...
                                                            if ("seekingTracker" in obj) {
                                                              _Object26 = Object;
                                                              definePropertyResult25 = Object.defineProperty(obj, "seekingTracker", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                            } else {
                                                            ...
                                                            if (tmp10) {
                                                              ...
                                                              if ("sustainedRebufferThreshold" in obj) {
                                                                _Object27 = Object;
                                                                definePropertyResult26 = Object.defineProperty(obj, "sustainedRebufferThreshold", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                              } else {
                                                              ...
                                                              if (tmp10) {
                                                                ...
                                                                if ("watchTimeTracker" in obj) {
                                                                  _Object28 = Object;
                                                                  definePropertyResult27 = Object.defineProperty(obj, "watchTimeTracker", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                                } else {
                                                                ...
                                                                if (tmp10) {
                                                                  ...
                                                                  if ("currentFragmentPDT" in obj) {
                                                                    _Object29 = Object;
                                                                    definePropertyResult28 = Object.defineProperty(obj, "currentFragmentPDT", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                                  } else {
                                                                  ...
                                                                  if (tmp10) {
                                                                    ...
                                                                    if ("currentFragmentStart" in obj) {
                                                                      _Object30 = Object;
                                                                      definePropertyResult29 = Object.defineProperty(obj, "currentFragmentStart", { value: "IconComponent", enumerable: "Show debug log overlay in collectibles shop", configurable: null, writable: "\u2714\uFE0F" });
                                                                    } else {
                                                                    ...
                                                                    f58763.level = merged.debug ? c34 : c36;
                                                                    ...
                                                                    if (tmp10) {
                                                                      ...
                                                                      if (typeof window !== "Array") {
                                                                        _window2 = window;
                                                                        if (typeof window.addEventListener !== "disabledUntil") {
                                                                          _window3 = window;
                                                                          if (typeof window.removeEventListener !== "disabledUntil") {
                                                                            fn2 = function f() {
...
const items11 = [
    ...
    value(arg0) {
      ...
      if (this.data.view_id) {
        ...
        if (merged.video_source_url) {
          ...
          if (typeof merged.video_source_url !== "__FORMATJS_LISTFORMAT_DATA__") {
            if ("" !== str) {
              const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
              let first;
              if (str2) {
  ...
  },
  {
    ...
    value() {
      ...
      if (typeof this.stateDataTranslator !== "disabledUntil") {
        try {
          ...
          ((mux, id, hlsjs, arg3, Hls) => {
            ...
            if (closure_47.exists()) {
              ...
              const fn = function f(arg0, arg1) {
                ...
                if (typeof outer1_52 !== "fileFinishedImporting") {
                  HermesBuiltin.throwTypeError();
                }
                if (stats) {
                  ...
                  obj3[4] = responseEnd;
                  if (typeof outer1_44 !== "fileFinishedImporting") {
                    HermesBuiltin.throwTypeError();
                  }
                  if (typeof outer1_45 !== "fileFinishedImporting") {
                    HermesBuiltin.throwTypeError();
                  }
                  if (typeof url !== "__FORMATJS_LISTFORMAT_DATA__") {
                    ...
                    obj3[6] = items[0];
                    if (typeof outer1_53 !== "fileFinishedImporting") {
                      HermesBuiltin.throwTypeError();
                    }
                    let tmp20;
                    if (networkDetails) {
                      if (typeof networkDetails.getAllResponseHeaders !== "disabledUntil") {
              ...
              const fn2 = function g(arg0, level) {
                ...
                if (stats) {
                  ...
                  let obj = {};
                  ({ bytesLoaded, requestStart, responseStart, responseEnd } = obj);
                  if (typeof s !== "fileFinishedImporting") {
                    HermesBuiltin.throwTypeError();
                  }
                  ...
                  if (typeof details.url !== "__FORMATJS_LISTFORMAT_DATA__") {
                    if ("" !== str) {
                      const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
                      let first;
                      if (str2) {
              ...
              const fn3 = function k(arg0, details) {
                ...
                if (stats) {
                  ...
                  if (typeof details.details.url !== "__FORMATJS_LISTFORMAT_DATA__") {
                    if ("" !== str) {
                      const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
                      let first;
                      if (str2) {
              ...
              const fn4 = function h(arg0, arg1) {
                ...
                if (stats) {
                  ...
                  if (!networkDetails) {
                    ...
                    if (typeof networkDetails.responseURL !== "__FORMATJS_LISTFORMAT_DATA__") {
                      if ("" !== str3) {
  ...
  },
  {
    ...
    value() {
      ...
      if (this.hlsjs) {
        ...
        let tmp = hlsjs;
        if (hlsjs) {
          tmp = typeof hlsjs._stopMuxMonitor === "fileFinishedImporting";
        }
        if (tmp) {
          hlsjs._stopMuxMonitor();
        }
    ...
    value(dashjs) {
      ...
      if (dashjs.dashjs) {
        if (self.dashjs) {
          ...
          if (typeof Ct !== "fileFinishedImporting") {
            HermesBuiltin.throwTypeError();
          }
          const id = self.id;
          const log2 = mux.log;
          if (dashjs) {
            if (dashjs.on) {
              ...
              const fn = function s(arg0) {
                ...
                if (typeof data.url !== "__FORMATJS_LISTFORMAT_DATA__") {
                  if ("" !== str) {
                    const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
                    let first;
                    if (str2) {
                  ...
                  obj[6] = items[0];
                  obj[7] = str;
                  if (typeof o !== "fileFinishedImporting") {
                    HermesBuiltin.throwTypeError();
                  }
              ...
              if (tmp4 >= 4) {
                ...
                dashjs.on("initFragmentLoaded", (fragmentModel) => {
                  ...
                  let tmp = null;
                  if (typeof fragmentModel.getRequests !== "disabledUntil") {
              ...
              let closure_10 = { video: "Array", audio: "accessibilityRole", totalBitrate: "height" };
              const fn4 = function x(newQuality) {
                ...
                if (typeof newQuality.newQuality === "Object") {
                  ...
                  if ("audio" === mediaType) {
                    ...
                    if (found) {
                      if (typeof found.bitrate !== "__REMOTEDEV__") {
                        obj = {};
                        outer1_48(obj, found);
                        obj = { codec: null };
                        ...
                        let tmp6;
                        if (closure_10.video) {
                          if (typeof tmp22.video.bitrate !== "__REMOTEDEV__") {
                            if (tmp22.video.width) {
                              if (tmp22.video.height) {
                                ...
                                if (sum !== tmp22.totalBitrate) {
                                  ...
                                  if (typeof outer1_55 !== "fileFinishedImporting") {
                                    HermesBuiltin.throwTypeError();
                                  }
              ...
              const fn5 = function v(arg0) {
                ...
                if (typeof request.url !== "__FORMATJS_LISTFORMAT_DATA__") {
                  if ("" !== str) {
                    const str2 = str.match(/^(([^:\/?#]+):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/) || [][4];
                    let first;
                    if (str2) {
              ...
              const fn6 = function p(error) {
                ...
                if (27 === code) {
                  ...
                  if (typeof request.url !== "__FORMATJS_LISTFORMAT_DATA__") {
                    ...
                    if (typeof tmp20 !== "fileFinishedImporting") {
                      HermesBuiltin.throwTypeError();
                    }
  ...
  },
  {
    ...
    value() {
      ...
      if (this.dashjs) {
        ...
        let tmp = dashjs;
        if (dashjs) {
          tmp = typeof dashjs._stopMuxMonitor === "fileFinishedImporting";
        }
        if (tmp) {
          dashjs._stopMuxMonitor();
        }
...
class Ve {
  ...
  processLine(arg0) {
    ...
    if (typeof Ii !== "fileFinishedImporting") {
    ...
    if (2 !== items1.length) {
                ...
                if (c111 === first) {
                  ...
                  if (c112 === first) {
                    ...
                    if (c113 === first) {
                      tmp40 = Li;
                      arr5 = items1[1];
                      if (typeof Li !== "fileFinishedImporting") {
                      ...
                      tmp10 = Me;
                      if (typeof Me !== "fileFinishedImporting") {
      ...
      tmp31 = _t;
      str10 = items1[1];
      if (typeof _t !== "fileFinishedImporting") {
  ...
  if (arr.indexOf("=") > -1) {
    ...
    if (parts.length > 0) {
      while (true) {
        ...
        let tmp9 = num;
        let tmp10 = merged;
        if (typeof Ai !== "fileFinishedImporting") {
...
function ne(key10009) {
  ...
  } else if (typeof key10009 === "fileFinishedImporting") {
...
let merged = Object.assign(ne, {
  ...
  monitor(videoElement, arg1) {
    ...
    let closure_0 = ne;
    let merged = arg1;
    if (typeof se !== "fileFinishedImporting") {
      HermesBuiltin.throwTypeError();
    }
    if (videoElement) {
      ...
      if (tmp7) {
        ...
        if (defineProperty) {
          ...
          obj[1] = function getStateData() {
            ...
            let source = self.dashjs && typeof self.dashjs.getSource === "fileFinishedImporting";
            if (source) {
              const dashjs = self.dashjs;
            ...
            if (closure_2.getStartDate) {
              if (tmp > 0) {
                ...
                if (startDate) {
                  if (typeof startDate.getTime !== "disabledUntil") {
          ...
          defineProperty.mux.swapElement = (nodeName) => {
            if (typeof outer1_31 !== "fileFinishedImporting") {
              HermesBuiltin.throwTypeError();
            }
            if (nodeName) {
              if (undefined !== nodeName.nodeName) {
  ...
  destroyMonitor(videoElement) {
    ...
    if (videoElement) {
      ...
      if (tmp5) {
        ...
        if (first) {
          if (first.mux) {
            if (typeof first.mux.destroy === "fileFinishedImporting") {
              const mux = first.mux;
              mux.destroy();
            }
          }
    ...
    getComputedStyle: function dt(arg0, arg1) {
      ...
      if (arg0) {
        ...
        if (arg1) {
          ...
          if (GResult1.default) {
            str = "";
            if (typeof tmp2.default.getComputedStyle !== "disabledUntil") {
              let hasItem = weakMap;
              if (weakMap) {
