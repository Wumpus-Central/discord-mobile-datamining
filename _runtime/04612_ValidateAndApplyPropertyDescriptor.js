// _runtime/04612_ValidateAndApplyPropertyDescriptor.js
import { isPropertyKey } from "04593_isPropertyKey.js";
import { Type } from "04613_Type.js";
...
export default function ValidateAndApplyPropertyDescriptor(arg0, arg1, flag, __Configurable__) {
  ...
  if (isPropertyKey(arg1)) {
    if (typeof flag !== "boolean") {
      ...
      throw tmp87;
    } else if (tmp(4597)(__Configurable__)) {
      __Set__ = arg4;
      if (undefined !== arg4) {
        if (!tmp(4597)(__Set__)) {
      ...
      if (undefined === __Set__) {
        ...
        if (tmp64) {
          if ("Undefined" === tmp3) {
            ...
            tmp66 = tmp(4610)(__Configurable__);
          }
        }
        return tmp64;
      } else {
        ...
        if (tmpResult3(obj, __Set__)) {
          if (!__Set__["[[Configurable]]"]) {
            ...
            if ("[[Enumerable]]" in __Configurable__) {
              if (!tmp(4602)(__Configurable__["[[Enumerable]]"], __Set__["[[Enumerable]]"])) {
                return false;
              }
            }
            if (!tmp(4615)(__Configurable__)) {
              const tmpResult4 = tmp(4602);
              if (!tmpResult4(tmp26, tmp(4610)(__Set__))) {
                return false;
              }
              tmp26 = tmp(4610)(__Configurable__);
            }
            if (tmp(4610)(__Set__)) {
              if ("[[Get]]" in __Configurable__) {
                if (!tmp(4602)(__Configurable__["[[Get]]"], __Set__["[[Get]]"])) {
                  return false;
                }
              }
              if ("[[Set]]" in __Configurable__) {
                if (!tmp(4602)(__Configurable__["[[Set]]"], __Set__["[[Set]]"])) {
                  return false;
                }
              }
              ...
              if ("[[Value]]" in __Configurable__) {
                if (!tmp(4602)(__Configurable__["[[Value]]"], __Set__["[[Value]]"])) {
                  return false;
                }
              }
            }
          ...
          if ("Undefined" === tmp3) {
            ...
            if (!tmp(4601)(__Set__)) {
              if (tmp(4610)(__Set__)) {
                if (tmp(4601)(__Configurable__)) {
                  ...
                  const tmpResult6 = tmp(4601);
                  const tmpResult7 = tmp(4602);
                  const tmpResult8 = tmp(4603);
                  ...
                  let tmpResult6Result = tmp(4600)(tmpResult6, tmpResult7, tmpResult8, arg0, arg1, obj);
                  const tmpResult5 = tmp(4600);
                }
              }
              const tmpResult10 = tmp(4601);
              const tmpResult9 = tmp(4600);
              tmpResult6Result = tmpResult9(tmpResult10, tmp(4602), tmp(4603), arg0, arg1, __Configurable__);
              const tmpResult11 = tmp(4602);
            }
            let tmp50 = __Set__;
            if ("[[Configurable]]" in __Configurable__) {
            ...
            const tmpResult13 = tmp(4601);
            const tmpResult14 = tmp(4602);
            const tmpResult15 = tmp(4603);
            ...
            __Set__ = __Set__["[[Set]]"];
            obj1[3] = __Set__;
            tmpResult6Result = tmp(4600)(tmpResult13, tmpResult14, tmpResult15, arg0, arg1, obj1);
            const tmpResult12 = tmp(4600);
          }
        } else {
