// _runtime/06260_ScrollableContainer.js
import BottomSheetDraggableScrollable from "06261_BottomSheetDraggableScrollable.js";
import _modDef6262 from "metro/06262__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod6264.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef6262, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
