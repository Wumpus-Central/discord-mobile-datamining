// _runtime/10512__isNativeReflectConstruct.js
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp(
        "(?:dans|en|pour|pendant|de)\\s*(" + FRTimeUnitWithinFormatParser(10508).TIME_UNITS_PATTERN + ")(?=\\W|$)",
        "i",
      );
      return regExp;
    },
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ParsingComponents.createRelativeFromReference(
        reference.reference,
        FRTimeUnitWithinFormatParser(10508).parseDuration(arg1[1]),
      );
    },
  },
];
