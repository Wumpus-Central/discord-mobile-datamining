// _runtime/08386_originWhitelistToRegex.js
import _modDef8387 from "metro/08387__.js";
import _modDef8388 from "metro/08388__.js";
...
export const defaultRenderLoading = () =>
  closure_1_10(React5, { style: _modDef8388.loadingOrErrorView, children: closure_1_10(React6, {}) });
export const defaultRenderError = (arg0, arg1, arg2) => {
  let obj = { style: _modDef8388.loadingOrErrorView, children: null };
  obj = { style: _modDef8388.errorTextTitle, children: "Error loading page" };
  const items = [closure_1_10(React7, obj), , ,];
  obj = { style: _modDef8388.errorText, children: "Domain: ".concat(arg0) };
  items[1] = closure_1_10(React7, obj);
  items[2] = closure_1_10(React7, { style: _modDef8388.errorText, children: "Error Code: ".concat(arg1) });
  const obj1 = { style: _modDef8388.errorText, children: "Error Code: ".concat(arg1) };
