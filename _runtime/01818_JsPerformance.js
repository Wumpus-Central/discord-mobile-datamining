...
function JsPerformance(smoothingFrames) {
  ...
  obj1 = { style: closure_16.text, animatedProps: sharedValue(1795).useAnimatedProps(fn), editable: false };
