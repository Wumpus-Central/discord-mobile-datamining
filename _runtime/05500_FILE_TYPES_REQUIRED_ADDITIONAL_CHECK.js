// _runtime/05500_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05507_AudioTypes.js";
import ImageTypes from "05508_ImageTypes.js";
import VideoTypes from "05509_VideoTypes.js";
import CompressedTypes from "05510_CompressedTypes.js";
import OtherTypes from "05511_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5501).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5501).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5501).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5501).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
