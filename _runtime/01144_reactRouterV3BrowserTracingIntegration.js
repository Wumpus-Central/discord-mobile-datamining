  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f104965 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f104965, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f117063 = (name) => {
            ...
            obj[f104965(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            result = obj.startBrowserTracingNavigationSpan(f117063, obj);
          };
