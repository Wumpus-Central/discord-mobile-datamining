  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f103021 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f103021, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f114912 = (name) => {
            ...
            obj[f103021(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f114912, obj);
          };
