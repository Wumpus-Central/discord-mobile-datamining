  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f102616 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f102616, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f114490 = (name) => {
            ...
            obj[f102616(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f114490, obj);
          };
