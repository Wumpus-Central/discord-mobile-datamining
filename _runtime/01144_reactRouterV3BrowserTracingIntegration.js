  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f102143 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f102143, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f113930 = (name) => {
            ...
            obj[f102143(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f113930, obj);
          };
