  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f103417 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f103417, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f115350 = (name) => {
            ...
            obj[f103417(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f115350, obj);
          };
