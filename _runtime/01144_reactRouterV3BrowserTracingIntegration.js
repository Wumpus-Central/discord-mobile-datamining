  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f105261 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f105261, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f117384 = (name) => {
            ...
            obj[f105261(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            result = obj.startBrowserTracingNavigationSpan(f117384, obj);
          };
