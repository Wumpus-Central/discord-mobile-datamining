  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f105219 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f105219, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f117340 = (name) => {
            ...
            obj[f105219(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            result = obj.startBrowserTracingNavigationSpan(f117340, obj);
          };
