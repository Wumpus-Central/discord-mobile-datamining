  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f105420 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f105420, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f117557 = (name) => {
            ...
            obj[f105420(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            result = obj.startBrowserTracingNavigationSpan(f117557, obj);
          };
