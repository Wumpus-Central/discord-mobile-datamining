  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f103056 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f103056, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f114952 = (name) => {
            ...
            obj[f103056(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f114952, obj);
          };
