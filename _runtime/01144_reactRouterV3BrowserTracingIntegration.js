  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f104674 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f104674, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f116759 = (name) => {
            ...
            obj[f104674(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            result = obj.startBrowserTracingNavigationSpan(f116759, obj);
          };
