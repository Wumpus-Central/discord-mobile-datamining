  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f103283 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f103283, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f115204 = (name) => {
            ...
            obj[f103283(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f115204, obj);
          };
