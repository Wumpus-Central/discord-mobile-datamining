  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f102370 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f102370, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f114153 = (name) => {
            ...
            obj[f102370(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            const result = obj.startBrowserTracingNavigationSpan(f114153, obj);
          };
