  ...
  obj.afterAllSetup = function afterAllSetup(arg0) {
    ...
    if (_location) {
      ...
      f104458 = (name) => {
        ...
        result = obj.startBrowserTracingPageLoadSpan(f104458, obj);
      };
      let pathname;
      ...
      pathname.listen((action) => {
        ...
        if (!tmp) {
          const f116522 = (name) => {
            ...
            obj[f104458(pathname[1]).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = str;
            result = obj.startBrowserTracingNavigationSpan(f116522, obj);
          };
