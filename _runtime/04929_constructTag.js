// _runtime/04929_constructTag.js
import { getDataView } from "04882_getDataView.js";
import { 04889__ } from "metro/04889__.js";
const require = arg1;
const module = arg2;
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== 04889__.TYPE_TEXT) {
    combined = stringValueFromArray;
    if (0 !== items2.length) {
      const _HermesInternal = HermesInternal;
      combined = "" + stringValueFromArray + " (" + tmp4(4882).getStringValueFromArray(items2) + ")";
      const tmp4Result = tmp4(4882);
    }
  }
  obj = { name: combined, value: stringFromDataView, description: null };
  if (type === 04889__.TYPE_ITXT) {
    stringFromDataView = module(4915).decode("UTF-8", decompressResult);
    const obj5 = module(4915);
  }
