// _runtime/01754_updatePropsOnReactJS.js
...
import { validateTransformOrigin } from "01755_validateTransformOrigin.js";
import { map } from "01756_map.js";
...
if (isJest.shouldBeUseWeb()) {
  function maybeThrowError() {
    if (!obj.isJest()) {
      const reanimatedError = new tmp(1664).ReanimatedError("`UpdatePropsManager` is not available on non-native platform.");
