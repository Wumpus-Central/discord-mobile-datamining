// _runtime/12564_spanTimeInputToSeconds.js
  ...
  if (
    ...
    try {
      ...
      if (
        ...
        obj[8] = attributes[_mod12574.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[_mod12574.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== getSpanStatusFromHttpCode.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(12576).SPAN_STATUS_OK) {
