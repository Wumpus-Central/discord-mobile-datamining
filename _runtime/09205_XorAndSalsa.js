// _runtime/09205_XorAndSalsa.js
import asyncGeneratorStep from "asyncGeneratorStep";
import { _asyncLoop } from "09206__asyncLoop.js";
import { pbkdf2Init } from "09209_pbkdf2Init.js";
import { _isNativeReflectConstruct } from "09211__isNativeReflectConstruct.js";
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9206).isLE) {
                callback(9206).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
