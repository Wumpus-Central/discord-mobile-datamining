// _runtime/14198_addLikelySubtags.js
import getInternalSlots from "14199_getInternalSlots.js";
import isStructurallyValidLanguageTag from "14264_isStructurallyValidLanguageTag.js";
    ...
    if (region) {
      ...
      if (tmp4) {
        ...
        if (result) {
          ...
          obj = { lang: null, script: "Array", region: "isArray", variants: -11665405 };
          obj[0] = "und";
          obj[3] = variants;
        }
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(locale) {
          ...
          if (tmp2) {
            ...
            obj = { variants: null };
            obj[0] = [];
            const result = callback(14264).emitUnicodeLanguageId(
              obj.__assign(obj1.__assign({}, callback(14264).parseUnicodeLanguageId(tmp2)), obj),
            );
            const parseUnicodeLocaleIdResult = callback(14264).parseUnicodeLocaleId(locale);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            obj = { lang: null, variants: null };
            obj[0] = lang;
            obj[1] = [];
            if (tmp(callback(14264).emitUnicodeLanguageId(obj)) === result) {
              ...
              obj1 = { lang: null };
              const obj2 = { lang: null, script: "Array", region: "isArray", variants: -11665405 };
              obj2[0] = lang;
              obj2[3] = variants;
              obj1[0] = obj2;
  ...
  let obj = {
    get() {
      return Locale(14264).emitUnicodeLanguageId(Locale(14264).parseUnicodeLanguageId(closure_2.default(this).locale));
    },
    enumerable: false,
    configurable: true,
  };
  ...
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14264).parseUnicodeLanguageId(closure_2.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14264).parseUnicodeLanguageId(closure_2.default(this).locale).script;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14264).parseUnicodeLanguageId(closure_2.default(this).locale).region;
    },
    enumerable: false,
    configurable: true,
  });
