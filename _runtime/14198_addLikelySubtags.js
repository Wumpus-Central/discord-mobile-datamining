// === Module 14198: addLikelySubtags ===

// Module 14198 (addLikelySubtags)
import getInternalSlots from "getInternalSlots" /* 14199 */;
import isStructurallyValidLanguageTag from "isStructurallyValidLanguageTag" /* 14264 */;
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(locale) {
          ...
          if (tmp2) {
            ...
            obj = { variants: null };
            obj[0] = [];
            const result = callback(14264).emitUnicodeLanguageId(obj.__assign(obj1.__assign({}, callback(14264).parseUnicodeLanguageId(tmp2)), obj));
