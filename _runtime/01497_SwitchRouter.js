// _runtime/01497_SwitchRouter.js
import BaseRouter3 from "01493_BaseRouter.js";
  ...
  obj.getStateForRouteNamesChange = function getStateForRouteNamesChange(index, arg1) {
    ...
    const mapped = routeNames.map((name) => {
      ...
      if (found == null) {
        ...
        obj.key = "" + name + "-" + index(1494).nanoid();
        obj.params = dependencyMap[name];
        found = obj;
        const obj2 = index(1494);
      }
      return found;
    });
  ...
  obj.getStateForAction = function getStateForAction(history, type, arg2) {
            ...
            if ("REPLACE_PARAMS" !== type) {
              if ("GO_BACK" === type) {
                ...
                if (-1 === findIndexResult) {
                  ...
                  const paramsFromAction = _mod1498.createParamsFromAction(obj7);
                  let tmp12 = tmp88;
    ...
    if (-1 === findIndexResult1) {
      ...
      if (null == history.routes[findIndexResult1]) {
        ...
        params = _mod1498.createParamsFromAction(obj21);
      }
    }
  };
  return obj;
