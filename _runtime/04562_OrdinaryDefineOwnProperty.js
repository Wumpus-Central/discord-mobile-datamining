// _runtime/04562_OrdinaryDefineOwnProperty.js
import { isObject } from "04499_isObject.js";

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (isObject(arg0)) {
    if (tmp(4546)(arg1)) {
      if (tmp(4550)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4551)(tmp30);
          }
          return tmp(4565)(arg0, arg1, tmp(4564)(arg0), __Writable__, tmp31);
        } else if (tmp(4563)(__Writable__)) {
          ...
          return tmp(4555)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
