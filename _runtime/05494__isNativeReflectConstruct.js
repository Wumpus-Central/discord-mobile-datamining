// _runtime/05494__isNativeReflectConstruct.js
...
import { transformIntoHandlerTags } from "05498_transformIntoHandlerTags.js";
import { 05499__ } from "metro/05499__.js";
...
let closure_10 = { [arg1(5473).State.UNDETERMINED]: undefined, [arg1(5473).State.BEGAN]: "onBegan", [arg1(5473).State.FAILED]: "onFailed", [arg1(5473).State.CANCELLED]: "onCancelled", [arg1(5473).State.ACTIVE]: "onActivated", [arg1(5473).State.END]: "onEnded" };
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          ...
          if (self.viewNode) {
            self.attachGestureHandler(require("05502_get_ActivityIndicator.js") /* get ActivityIndicator */(self.viewNode));
          } else {
            const _Error = Error;
