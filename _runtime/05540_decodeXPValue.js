// _runtime/05540_decodeXPValue.js
...
obj[282] = { name: "XResolution", description: fn(5541).XResolution };
const obj2 = { name: "XResolution", description: fn(5541).XResolution };
obj[283] = { name: "YResolution", description: fn(5541).YResolution };
obj[286] = {
  name: "XPosition",
  description(arg0) {
...
const obj3 = { name: "YResolution", description: fn(5541).YResolution };
obj[296] = { name: "ResolutionUnit", description: fn(5541).ResolutionUnit };
obj[318] = {
  name: "WhitePoint",
  description(arr) {
...
const obj4 = { name: "ResolutionUnit", description: fn(5541).ResolutionUnit };
obj[50778] = { name: "CalibrationIlluminant1", description: fn(5541).LightSource };
const obj5 = { name: "CalibrationIlluminant1", description: fn(5541).LightSource };
obj[50779] = { name: "CalibrationIlluminant2", description: fn(5541).LightSource };
obj[50941] = {
