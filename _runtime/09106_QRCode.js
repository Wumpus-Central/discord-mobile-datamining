// _runtime/09106_QRCode.js
import { QR8bitByte } from "09107_QR8bitByte.js";
import { QRRSBlock } from "09109_QRRSBlock.js";
import { QRBitBuffer } from "09111_QRBitBuffer.js";
import { QRPolynomial } from "09113_QRPolynomial.js";
import { 09112__ } from "metro/09112__.js";
class QRCode {
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = 09112__.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = 09112__.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = 09112__.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
