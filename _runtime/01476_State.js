...
import get_ActivityIndicatorDefault from "get ActivityIndicator" /* 1477 */;
import InternetReachabilityDefault from "InternetReachability" /* 1479 */;
...
class State {
  constructor(arg0) {
    ...
    this._nativeEventSubscription = eventEmitter.addListener(require("module_1480").DEVICE_CONNECTIVITY_EVENT, this._handleNativeStateUpdate);
