// _runtime/13248_supportsFetch.js
import _mod13137 from "metro/13137__.js";

require = arg1;
const dependencyMap = arg6;
function supportsFetch() {
  if ("fetch" in _mod13137.GLOBAL_OBJ) {
    try {
...
export const supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    ...
    if (isNativeFunction(_mod13137.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
...
export const supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in _mod13137.GLOBAL_OBJ;
};
