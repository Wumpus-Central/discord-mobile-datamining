// _runtime/01154_DEFAULT_FORMAT_CONFIG.js
import _mod1155 from "metro/01155__.js";
import dataFormatterCache2 from "01156_dataFormatterCache.js";
...
export function makeDataFormatters(items, formatConfig) {
  ...
  return {
    formatDate(arg0, format) {
      const formatConfigOptions = _mod1155.resolveFormatConfigOptions(closure_1.date, format);
    ...
    formatDuration(arg0, format) {
      const formatConfigOptions = _mod1155.resolveFormatConfigOptions(closure_1.time, format);
      const dataFormatterCache = dataFormatterCache2.dataFormatterCache;
      let merged = formatConfigOptions;
      if (flag) {
        const _Object = Object;
    ...
    formatNumber(result2, parseNumberSkeletonResult) {
      const formatConfigOptions = _mod1155.resolveFormatConfigOptions(closure_1.number, parseNumberSkeletonResult);
      const dataFormatterCache = dataFormatterCache2.dataFormatterCache;
      let merged = formatConfigOptions;
      if (flag) {
        const _Object = Object;
    ...
    formatList(arg0, format) {
      const formatConfigOptions = _mod1155.resolveFormatConfigOptions(closure_1.list, format);
      const dataFormatterCache = dataFormatterCache2.dataFormatterCache;
      let merged = formatConfigOptions;
      if (flag) {
        const _Object = Object;
    ...
    formatRelativeTime(arg0, day, format) {
      const formatConfigOptions = _mod1155.resolveFormatConfigOptions(closure_1.relativeTime, format);
      const dataFormatterCache = dataFormatterCache2.dataFormatterCache;
      let merged = formatConfigOptions;
      if (flag) {
        const _Object = Object;
