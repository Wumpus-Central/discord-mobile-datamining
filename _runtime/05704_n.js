...
let obj = {
  createGestureHandler(closure_0, handlerTag, config) {
    ...
    const result = require("05691_transformIntoHandlerTags.js").scheduleOperationToBeFlushed(() => {
  ...
  setGestureHandlerConfig(handlerTag, closure_1) {
    ...
    let result = require("05691_transformIntoHandlerTags.js").scheduleOperationToBeFlushed(() => {
