// _runtime/04970_mapItemAppearanceToNativeProp.js
import bottomTabsDebugLog from "04964_bottomTabsDebugLog.js";
...
export default function TabsScreen(onWillAppear) {
  ...
  obj3.children = jsx(ref(4937).Freeze, { freeze: flag, placeholder: tmp7.placeholder, children: tmp7.children });
  return jsx(ref1(4971), {
    collapsable: false,
    style: null,
    onWillAppear: callback,
    onDidAppear: callback1,
