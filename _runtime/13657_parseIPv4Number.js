// _runtime/13657_parseIPv4Number.js
import { Buffer } from "00511_Buffer.js";
import { error } from "13658_error.js";
import { replaceByteInByteSequence } from "13660_replaceByteInByteSequence.js";
import { 13659__ } from "metro/13659__.js";
const require = arg1;
      ...
      if (47 !== arg0) {
        ...
        if (undefined === closure_3[self.url.scheme]) {
          ...
          if (!tmp) {
            ...
            if (isASCIIHexResult) {
              tmp2Result = require("module_13659");
              num6 = 2;
    ...
    if (63 === arg0) {
      ...
      if (35 === arg0) {
        ...
        if (!tmp2) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmp3Result = require("module_13659");
            num4 = 2;
    ...
    if (!isNaN(arg0)) {
      ...
      if (0 === arg0) {
        ...
        if (!tmp4) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmpResult = require("module_13659");
            num3 = 2;
