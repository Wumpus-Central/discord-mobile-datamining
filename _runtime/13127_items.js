...
_mod13126("XRANGE", 20, combined17);
obj.XRANGE = 20;
...
_mod13126("XRANGELOOSE", 21, combined18);
obj.XRANGELOOSE = 21;
...
items1[21] = regExp43;
const combined19 = "(^|[^\\d])(\\d{1," + _mod13125.MAX_SAFE_COMPONENT_LENGTH + "})(?:\\.(\\d{1," + _mod13125.MAX_SAFE_COMPONENT_LENGTH + "}))?(?:\\.(\\d{1," + _mod13125.MAX_SAFE_COMPONENT_LENGTH + "}))?";
const tmp104 = ((items2) => {
  let str = items2;
  while (tmp2 !== undefined) {
    let tmp5 = _slicedToArray(tmp3, 2);
...
_mod13126("COERCEPLAIN", 22, combined19);
obj.COERCEPLAIN = 22;
...
_mod13126("COERCE", 23, combined20);
obj.COERCE = 23;
...
_mod13126("COERCERTL", 25, items2[obj.COERCE]);
obj.COERCERTL = 25;
...
_mod13126("COERCERTLFULL", 26, items2[obj.COERCEFULL]);
...
_mod13126("TILDETRIM", 28, combined21);
obj.TILDETRIM = 28;
...
_mod13126("TILDELOOSE", 30, combined23);
obj.TILDELOOSE = 30;
...
_mod13126("CARETTRIM", 32, combined24);
obj.CARETTRIM = 32;
...
_mod13126("CARETLOOSE", 34, combined26);
obj.CARETLOOSE = 34;
...
_mod13126("COMPARATORLOOSE", 35, combined27);
...
_mod13126("COMPARATOR", 36, combined28);
obj.COMPARATOR = 36;
...
_mod13126("COMPARATORTRIM", 37, combined29);
...
_mod13126("HYPHENRANGE", 38, combined30);
obj.HYPHENRANGE = 38;
...
_mod13126("HYPHENRANGELOOSE", 39, combined31);
...
_mod13126("GTE0PRE", 42, "^\\s*>=\\s*0\\.0\\.0-0\\s*$");
obj.GTE0PRE = 42;
