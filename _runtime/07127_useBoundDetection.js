// _runtime/07127_useBoundDetection.js
...
export const useBoundDetection = function useBoundDetection(recyclerViewManager, arg1) {
  ...
  const _requestAnimationFrame = require("07124_useUnmountAwareTimeout.js").useUnmountAwareAnimationFrame().requestAnimationFrame;
  let num = 0;
