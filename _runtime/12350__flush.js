...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  let currentScope = _require(12329).getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = _require(12329);
  let client = _require(12329).getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = _require(12329);
  captureCheckInResult = _require(12313).uuid4();
};