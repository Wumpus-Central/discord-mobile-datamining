// _runtime/00534_pushToArray.js
import _mod531 from "metro/00531__.js";
import items5 from "00533_items.js";
import getSideChannel from "00535_getSideChannel.js";
import { items } from "00533_items.js";
import { getSideChannel } from "00535_getSideChannel.js";
...
function stringify(
  ...
  if (typeof fn2 === "function") {
    ...
    if (parts1 instanceof Date) {
      ...
      str2 = parts1;
      if (tmp5) {
        str2 = require("00533_items.js").maybeMap(parts1, (arg0) => {
          let tmp = arg0;
