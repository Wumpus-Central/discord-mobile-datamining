// _runtime/09150_QRCode.js
import { QR8bitByte } from "09151_QR8bitByte.js";
import { QRRSBlock } from "09153_QRRSBlock.js";
import { QRBitBuffer } from "09155_QRBitBuffer.js";
import { QRPolynomial } from "09157_QRPolynomial.js";
import { 09156__ } from "metro/09156__.js";
class QRCode {
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = 09156__.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = 09156__.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = 09156__.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
