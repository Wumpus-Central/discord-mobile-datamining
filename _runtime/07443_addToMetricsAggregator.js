// _runtime/07443_addToMetricsAggregator.js
import "errorCallback";
import __SENTRY_DEBUG__ from "__SENTRY_DEBUG__";
import { getGlobalSingleton } from "07348_getGlobalSingleton.js";
...
import { createChildOrRootSpan } from "07381_createChildOrRootSpan.js";
import { __SENTRY_DEBUG__ } from "metro/07375___SENTRY_DEBUG__.js";
import { 07444__ } from "metro/07444__.js";
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07444__.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07444__.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, 07444__.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07444__.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    ...
    if (typeof fn === "function") {
      ...
      return _createChildOrRootSpan.startSpanManual(obj, (arg0) => {
        ...
        return callback(table[10]).handleCallbackErrors(() => callback(), () => {
          ...
          closure_2(lib, lib(7444).DISTRIBUTION_METRIC_TYPE, outer1_1, parsed, obj);
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _07444__.DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
