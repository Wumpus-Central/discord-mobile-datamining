// _runtime/07646_applyClientOptions.js
...
function applyDebugIds(exception) {
  _require = require("07649_getFilenameToDebugIdMap.js").getFilenameToDebugIdMap(arg1);
  try {
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = callback(7642).normalize(data.data, callback, dependencyMap);
                  data = obj;
                  const obj3 = callback(7642);
                }
