// _runtime/15059__isNativeReflectConstruct.js
...
import importDefaultResult3 from "09875_emptyFunction.js";
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        obj3[3] = lineCap;
        obj3[4] = mapped1;
        tmp23Result = tmp23(tmp24(8453).Path, obj3);
      }
      ...
      if (tmp23Result) {
        ...
        obj4[3] = fillLineCap;
        obj4[4] = mapped;
        tmp23Result = tmp23(tmp24(8453).Path, obj4);
      }
      items[1] = tmp23Result;
      items[2] = renderCapResult;
      obj2[3] = items;
      obj1[2] = closure_7(CircularProgress(8453).G, obj2);
      const items1 = [closure_6(CircularProgress(8453).Svg, obj1)];
