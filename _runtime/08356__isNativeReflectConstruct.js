// === Module 8356: _isNativeReflectConstruct ===

// Module 8356 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractFontDefault from "extractFont" /* 8276 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8278 */;
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8353 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8357 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(8270).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
