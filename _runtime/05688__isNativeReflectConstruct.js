...
import { getDistanceForDirection } from "05691_getDistanceForDirection.js";
import { findLastIndex } from "05706_findLastIndex.js";
...
function getProgressFromGesture(interpolate, width, options) {
  ...
  if (undefined !== gestureDirection) {
    ...
    let gestureDirection2 = CardStack(5704).ModalTransition.gestureDirection;
  } else {
    gestureDirection2 = CardStack(5704).DefaultTransition.gestureDirection;
  }
}
class CardStack {
  constructor(arg0) {
...
let obj = {
  ...
  value: function render() {
    ...
    children[1] = closure_9(CardStack(5707).MaybeScreenContainer, obj2);
    let tmp23 = null;
    if (someResult) {
      tmp23 = tmp15Result;
    }
    children[2] = tmp23;
    return closure_10(CardStack(5659).Background, { children });
  }
};
let items = [obj];
obj = {
