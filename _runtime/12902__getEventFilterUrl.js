// _runtime/12902__getEventFilterUrl.js
import _mod12827 from "metro/12827__.js";
import _mod12836 from "metro/12836__.js";
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod12855.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + _mod12838.getEventDescription(tmp));
      const tmp6Result = _mod12838;
    }
    return null;
  }
}
        ...
        if (_mod12855.DEBUG_BUILD) {
          ...
          logger5.warn(
            "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " +
              _mod12838.getEventDescription(type),
          );
          flag6 = true;
        }
      } else {
