// _runtime/07084_ScrollableContainer.js
import BottomSheetDraggableScrollable from "07085_BottomSheetDraggableScrollable.js";
import _modDef7086 from "metro/07086__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod7088.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef7086, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
