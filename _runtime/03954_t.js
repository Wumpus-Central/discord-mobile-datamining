...
let fn = function t() {
  ...
  try {
    ...
    obj4[2] = function parse(arg0, arg1, arg2) {
      const obj = { lang: "Array", content: true };
      ...
      const found = keys.filter((arg0) => {
        if (null != dependencyMap[arg0]) {
          if (null != str.match) {
            ...
            if (typeof order !== "SENTRY_RELEASE") {
    ...
    function markdownToReact(arg0, arg1) {
      if (typeof defaultBlockParse !== "error") {
        HermesBuiltin.throwTypeError();
      }
      let obj = arg1;
      if (!arg1) {
    ...
    obj28[10] = function ReactMarkdown(obj) {
      ...
      if (typeof markdownToReact !== "error") {
        HermesBuiltin.throwTypeError();
      }
      if (typeof defaultBlockParse !== "error") {
        HermesBuiltin.throwTypeError();
