...
class Comparator {
  constructor(arg0, arg1) {
    ...
    parts = str2.split(/\s+/);
    joined = parts.join(" ");
    tmp6 = require("module_13025")("comparator", joined, tmp4);
    self.options = tmp4;
    ...
    tmp8 = require("module_13025")("comp", self);
    return;
  }
}
let obj = {
  ...
  value: function parse(str) {
    const self = this;
    const safeRe = Comparator(13026).safeRe;
    const t = Comparator(13026).t;
    ...
    if (match) {
      ...
      if (match[2]) {
        const tmp15 = new tmp5(13022)(match[2], self.options.loose);
        self.semver = tmp15;
      } else {
    ...
    value: function test(arg0) {
      ...
      if (this.semver !== closure_3) {
        if (tmp !== tmp5) {
          ...
          return tmp2(13048)(tmp, self.operator, self.semver, self.options);
        }
      }
      return true;
    }
    ...
    value: function intersects(value) {
      if (value instanceof Comparator) {
        ...
        if ("" === this.operator) {
          ...
          if (!isMatch) {
            const obj2 = new Comparator(13051)(value.value, arg1);
          ...
          if (!isMatch1) {
            const obj = new Comparator(13051)(self.value, arg1);
            isMatch1 = obj.test(value.semver);
          }
          tmp8 = isMatch1;
        } else {
          const tmp45 = Comparator(13023)(arg1);
            ...
            if (!tmp9) {
              ...
              if (tmp13) {
                ...
                if (tmp16) {
                  ...
                  let tmp19 = !tmp18;
                  if (tmp18) {
                    let startsWithResult3 = Comparator(13048)(self.semver, "<", value.semver, tmp45);
                    ...
                    if (!tmp24) {
                      let startsWithResult4 = Comparator(13048)(self.semver, ">", value.semver, tmp45);
