...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  obj = { value: sharedValue, children: jsx(_modDef14641.Provider, { ref, onTransitionProgressReanimated: null, onHeaderHeightChangeReanimated: null }) };
  obj1 = { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children };
  obj.children = jsx(_modDef14642.Provider, { value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 }, children: children.children });
  return <closure_7 value={sharedValue}>{jsx(_modDef14641.Provider, { ref, onTransitionProgressReanimated: null, onHeaderHeightChangeReanimated: null })}</closure_7>;
});
