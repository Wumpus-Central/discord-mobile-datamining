...
export const installWorkletsSupport = function installWorkletsSupport() {
  try {
    const NitroModules = _mod4562.NitroModules;
    const boxResult = NitroModules.box(_mod4562.NitroModules);
    require = boxResult;
