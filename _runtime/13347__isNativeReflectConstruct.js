// _runtime/13347__isNativeReflectConstruct.js
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      const items6 = [ParallaxImage(13348).image, style, { position: "relative" }, obj];
      obj3.style = items6;
  ...
  },
  {
    ...
    get() {
      ...
      if (!tmp) {
        ...
        obj[0] = ParallaxImage(13348).loaderContainer;
  ...
  },
  {
    ...
    value: function render() {
      ...
      const items = [this.props.containerStyle, self(13348).container];
      obj[2] = items;
