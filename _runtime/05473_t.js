// _runtime/05473_t.js
import { tagMessage } from "05471_tagMessage.js";
import { 05472__ } from "metro/05472__.js";
const require = arg1;
...
function create(handlerTag) {
  ...
  obj = { wrappedSetGestureState: fn, handlerTag, State: _05472__.State };
  fn.__closure = obj;
  ...
  S.__closure = { wrappedSetGestureState: fn, handlerTag, State: _05472__.State };
  ...
  const obj1 = { wrappedSetGestureState: fn, handlerTag, State: _05472__.State };
  fn3.__closure = { wrappedSetGestureState: fn, handlerTag, State: _05472__.State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = closure_6;
  obj[4] = fn3;
  return obj;
}
obj = { wrappedSetGestureState: fn, State: require("module_5472").State };
