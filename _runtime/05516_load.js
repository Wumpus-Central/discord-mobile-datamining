...
function loadView(byteLength) {
  ...
  let obj2 = require("module_5520");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("module_5520").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("module_5521").USE_JPEG) {
    flag4 = false;
  ...
  const parseAppMarkersResult = require("module_5520").parseAppMarkers(byteLength, flag2);
