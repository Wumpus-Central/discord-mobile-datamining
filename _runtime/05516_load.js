// _runtime/05516_load.js
import _modDef5517 from "metro/05517__.js";
import _mod5518 from "metro/05518__.js";
...
function load(response) {
  ...
  if (typeof response === "string") {
    ...
    if (obj2.test(response)) {
      ...
      if (obj3.test(response)) {
        let resolved = Promise.resolve(response(5518).dataUriToBuffer(response));
        const obj5 = response(5518);
      } else {
        let obj7 = then;
        if (then === undefined) {
          obj7 = {};
...
function loadView(byteLength) {
  let obj = response;
  if (response === undefined) {
    obj = { expanded: false, async: false, includeUnknown: false, domParser: "padding" };
  }
  ...
  function addPngTextTags(readTags) {
    if (flag) {
      ...
      if (closure_1.png) {
        objectAssignResult3 = _mod5518.objectAssign({}, closure_1.png, readTags);
      }
      closure_1.png = objectAssignResult3;
      let objectAssignResult4 = readTags;
      if (closure_1.pngText) {
        objectAssignResult4 = _mod5518.objectAssign({}, closure_1.png, readTags);
      }
  ...
  let obj2 = require("metro/05520__.js");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("metro/05520__.js").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("metro/05521__.js").USE_JPEG) {
    flag4 = false;
        ...
        if (readResult11 instanceof Promise) {
          items1.push(readResult11.then(function addIccTags(icc) {
            if (flag) {
              ...
              closure_1 = _mod5518.objectAssign({}, closure_1, icc);
            }
          }));
          flag9 = true;
        } else if (flag) {
  ...
  const parseAppMarkersResult = require("metro/05520__.js").parseAppMarkers(byteLength, flag2);
...
export default { load, loadView, errors: _modDef5517 };
export const errors = _modDef5517;
export { load };
export { loadView };