// _runtime/13742_Deflate.js
import _mod13741 from "metro/13741__.js";
import ZStream from "13743_ZStream.js";
import flush_block_only from "13744_flush_block_only.js";
import _mod13745 from "metro/13745__.js";
import _mod13749 from "metro/13749__.js";
...
export { Deflate };
export const deflate = function deflate(arg0, Deflate) {
  const arr = Deflate(Deflate);
  arr.push(arg0, true);
  if (arr.err) {
    let msg = arr.msg;
    if (!msg) {
      msg = _mod13745[arr.err];
    }
    throw msg;
  } else {
    return arr.result;
...
export const deflateRaw = function deflateRaw(arg0, Deflate) {
  let obj = Deflate;
  if (!Deflate) {
    obj = {};
  }
...
export const gzip = function gzip(arg0, Deflate) {
  let obj = Deflate;
  if (!Deflate) {
    obj = {};
  }
