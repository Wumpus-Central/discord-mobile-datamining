// _runtime/05810_Color.js
import _mod5811 from "metro/05811__.js";
import _mod5815 from "metro/05815__.js";
...
function _loop(item10136) {
  ...
  if (closure_3.includes(item10136)) {
    ...
    channels = require("metro/05811__.js")[item10136].channels;
    Color.prototype[item10136] = function () {
      ...
      if (this.model === closure_0) {
        ...
        const rawResult = _mod5811[self.model][closure_0].raw(self.color);
        const _Array = Array;
        let tmp2 = rawResult;
