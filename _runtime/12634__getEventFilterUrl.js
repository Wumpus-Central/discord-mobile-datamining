// _runtime/12634__getEventFilterUrl.js
import __SENTRY_DEBUG__ from "metro/12587___SENTRY_DEBUG__.js";
import setupIntegration from "12615_setupIntegration.js";
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + tmp6(12570).getEventDescription(tmp));
      const tmp6Result = tmp6(12570);
    }
    return null;
  }
}
