// _runtime/01627_KeyboardChatScrollView.js
import KeyboardAvoidingView from "01843_KeyboardAvoidingView.js";
import OverKeyboardView from "01872_OverKeyboardView.js";
...
for (const key10017 in require("metro/01636__.js")) {
  arg5[key10017] = require("metro/01636__.js")[key10017];
  continue;
}
...
for (const key10025 in require("metro/01832__.js")) {
  arg5[key10025] = require("metro/01832__.js")[key10025];
  continue;
}
...
for (const key10033 in require("metro/01830__.js")) {
  arg5[key10033] = require("metro/01830__.js")[key10033];
  continue;
}
for (const key10037 in require("metro/01836__.js")) {
  arg5[key10037] = require("metro/01836__.js")[key10037];
  continue;
}
