...
for (const key10017 in require("module_1636")) {
  arg5[key10017] = require("module_1636")[key10017];
  continue;
}
...
for (const key10025 in require("module_1832")) {
  arg5[key10025] = require("module_1832")[key10025];
  continue;
}
...
for (const key10033 in require("module_1830")) {
  arg5[key10033] = require("module_1830")[key10033];
  continue;
}
for (const key10037 in require("module_1836")) {
  arg5[key10037] = require("module_1836")[key10037];
  continue;
}
