// _runtime/07014__isNativeReflectConstruct.js
...
function getDistanceFromOptions(width, gestureDirection) {
  ...
  if (gestureDirection) {
    return CardStack(7019).getDistanceForDirection(width, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    return tmp3(7019).getDistanceForDirection(width, gestureDirection, arg2);
  }
}
