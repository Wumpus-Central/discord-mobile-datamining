// _runtime/01800_JsPerformance.js
...
function JsPerformance(smoothingFrames) {
  ...
  let sharedValue;
  let dependencyMap;
  let obj = sharedValue(1777);
  sharedValue = obj.useSharedValue(null);
  let obj1 = sharedValue(1777);
  ...
  obj1 = { style: closure_16.text, animatedProps: sharedValue(1777).useAnimatedProps(fn), editable: false };
