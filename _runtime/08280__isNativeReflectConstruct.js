// _runtime/08280__isNativeReflectConstruct.js
import noopAll from "00019_noop.js";
import _inheritsDefault from "00098__inherits.js";
import _isNativeReflectConstructDefault from "08233__isNativeReflectConstruct.js";
import __INTERNAL_VIEW_CONFIGDefault from "metro/08281___INTERNAL_VIEW_CONFIG.js";
...
const items = [
  {
    ...
    value: function render() {
      ...
      let obj = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: self(8222).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
      [tmp2, tmp3] = parts;
      const tmp6 = self(8222).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(8222).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(8222).alignEnum[tmp2] || "xMidYMid";
