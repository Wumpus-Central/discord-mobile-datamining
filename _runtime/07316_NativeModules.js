// _runtime/07316_NativeModules.js
...
export const setup = () => {
  ...
  if ("STOREKIT1_MODE" === str) {
    07318__.storekit1Mode();
    const obj4 = 07318__;
  } else if ("STOREKIT2_MODE" === str) {
    07318__.storekit2Mode();
    const obj3 = 07318__;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    07318__.storekitHybridMode();
    const obj2 = 07318__;
  }
};
export const initConnection = () => {
  const nativeModule = 07318__.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = 07318__.getAndroidModule();
