// _runtime/00873_isErrorEvent.js
    ...
    if (obj2.checkOrSetAlreadyCaught(arg0)) {
      ...
      self._process(() => {
        ...
        return self
          ...
          .then((arg0) => closure_3._captureEvent(arg0, closure_0, closure_2))
          .then((arg0) => arg0);
      }, "error");
      return obj.event_id;
    }
...
let items = [
  obj,
  {
    ...
    value: function captureMessage(arg0, arg1, arg2, arg3) {
      ...
      self._process(
        () => eventFromMessageResult.then((arg0) => closure_3._captureEvent(arg0, closure_2, closure_1)),
        str,
      );
      return obj.event_id;
    },
...
items[15] = {
  ...
  value: function sendEvent(arg0) {
    ...
    let eventEnvelope = callback(self[16]).createEventEnvelope(
      arg0,
      self._dsn,
...
items[16] = {
  ...
  value: function sendSession(attrs) {
    ...
    self.sendEnvelope(
      callback(860).createSessionEnvelope(attrs, self._dsn, self._options._metadata, self._options.tunnel),
    );
  },
};
items[17] = {
