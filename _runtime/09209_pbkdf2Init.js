// _runtime/09209_pbkdf2Init.js
import asyncGeneratorStep from "asyncGeneratorStep";
import { _asyncLoop } from "09206__asyncLoop.js";
import { number } from "09207_number.js";
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9206).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9210).hmac;
    let obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9206).toBytes(B);
