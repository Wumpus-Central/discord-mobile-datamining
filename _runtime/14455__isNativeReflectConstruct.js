// _runtime/14455__isNativeReflectConstruct.js
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4870).ScreenContext.Provider, { value: closure_8, children: children.children });
}
