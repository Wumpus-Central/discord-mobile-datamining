// _runtime/01177_init.js
import NativeModules from "00998_NativeModules.js";
...
export const wrap = function wrap(displayName, profilerProps) {
  ...
  if (obj.isWeb()) {
    let ReactNativeProfiler = tmp3(1132).Profiler;
  } else {
    ReactNativeProfiler = tmp3(1184).ReactNativeProfiler;
  }
  return (arg0) => {
    let prop;
    if (null != profilerProps) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            const callback = tmp3;
            c3 = 1;
            const client = closure_1_0(814).getClient();
            if (client) {
              dependencyMap = 2;
              c4 = 1;
        ...
        const debug = callback(814).debug;
...
export const withScope = function withScope(arg0) {
  const _require = arg0;
  return require("00814_registerSpanErrorInstrumentation.js").withScope((arg0) => {
    try {
