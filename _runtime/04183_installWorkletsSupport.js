// _runtime/04183_installWorkletsSupport.js
import _mod4184 from "../discord_app/modules/gesture_handlers/native/reactNativeWorkletsCompat.js";
import getInstalledNitro from "04188_getInstalledNitro.js";
...
arg5.installWorkletsSupport = function installWorkletsSupport() {
  try {
    ...
    obj[3] = fn3;
    const result = _mod4184.registerCustomSerializable(obj);
  } catch (err) {
  }
};