// _runtime/08303__isNativeReflectConstruct.js
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [
      callback3(FeDropShadow(8304), { in: str, stdDeviation: props.stdDeviation }),
      callback3(FeDropShadow(8306), { dx, dy, result: "offsetblur" }),
      ,
      ,
    ];
