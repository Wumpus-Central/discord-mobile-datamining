// _runtime/01481_InternetReachability.js
  ...
  constructor(arg0, arg1) {
    ...
    this._checkInternetReachability = () => {
      ...
      new Promise((arg0, arg1) => {
        const timeout = setTimeout(() => callback("timedout"), self._configuration.reachabilityRequestTimeout);
      });
      function cancel() {
      ...
      obj[0] = Promise.race(items).then((result) => {
        const _configuration = closure_0._configuration;
        return _configuration.reachabilityTest(result);
      }).then((result) => {
        result = closure_0._setIsInternetReachable(result);
