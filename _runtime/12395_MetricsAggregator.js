// _runtime/12395_MetricsAggregator.js
...
const entry = {
  ...
  value: function add(metricType, arg1, diff) {
    ...
    const bucketKey = MetricsAggregator(12396).getBucketKey(
      metricType,
    ...
    if (value) {
      num = 0;
      if (metricType === MetricsAggregator(12392).SET_METRIC_TYPE) {
    ...
    if (value) {
      ...
      const tmp15 = new MetricsAggregator(12397).METRIC_MAP[metricType](diff);
      obj7.metric = tmp15;
    ...
    const result1 = MetricsAggregator(12300).updateMetricSummaryOnActiveSpan(
      metricType,
      sanitizeMetricKeyResult,
      diff,
      sanitizeUnitResult,
    ...
    const tmp5Result = MetricsAggregator(12300);
  },
};
const items = [
  entry,
  ...
  },
  {
    ...
    value: function _flush() {
      ...
      if (this._forceFlush) {
        ...
        const obj = MetricsAggregator(12309);
      }
    },
  },
  {
