  ...
  if (Array.isArray(created.choices)) {
    ...
    if (recordOutputs) {
      ...
      if (flatResult.length > 0) {
        const obj6 = {};
        const _JSON2 = JSON;
        obj6[ANTHROPIC_AI_RESPONSE_TIMESTAMP_ATTRIBUTE.GEN_AI_RESPONSE_TOOL_CALLS_ATTRIBUTE] =
...
export const setCommonResponseAttributes = function setCommonResponseAttributes(
  ...
  obj3[ANTHROPIC_AI_RESPONSE_TIMESTAMP_ATTRIBUTE.OPENAI_RESPONSE_TIMESTAMP_ATTRIBUTE] = new Date(
