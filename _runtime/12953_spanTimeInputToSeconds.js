// _runtime/12953_spanTimeInputToSeconds.js
...
import _mod12962 from "metro/12962__.js";
import _mod12963 from "metro/12963__.js";
import _mod12964 from "metro/12964__.js";
import _mod12965 from "metro/12965__.js";
import _mod12966 from "metro/12966__.js";
import _mod12967 from "metro/12967__.js";
import _mod12970 from "metro/12970__.js";
import _mod12975 from "metro/12975__.js";
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12965.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod12965.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod12954.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod12954.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
...
export const getActiveSpan = function getActiveSpan() {
  ...
  if (asyncContextStrategy.getActiveSpan) {
    ...
    const tmpResult = _mod12970;
    activeSpan = tmpResult._getSpanForScope(_mod12975.getCurrentScope());
...
export const updateMetricSummaryOnActiveSpan = function updateMetricSummaryOnActiveSpan(
  ...
  if (asyncContextStrategy.getActiveSpan) {
    ...
    const tmpResult = _mod12970;
    activeSpan = tmpResult._getSpanForScope(_mod12975.getCurrentScope());
    const tmpResult3 = _mod12975;
  }
  if (activeSpan) {
    const tmpResult4 = _mod12964;
