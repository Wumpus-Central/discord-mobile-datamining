// _runtime/09171_QRPolynomial.js
import { 09172__ } from "metro/09172__.js";
class QRPolynomial {
...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = 09172__;
      const glogResult = 09172__.glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - 09172__.glog(getLength.get(0));
