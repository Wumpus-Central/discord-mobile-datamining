// _runtime/03708_format.js
import isValid from "03658_isValid.js";
import subMilliseconds from "03709_subMilliseconds.js";
import _typeof from "metro/03476__typeof.js";
import G from "03710_G.js";
import dateLongFormatter from "03721_dateLongFormatter.js";
import getTimezoneOffsetInMilliseconds from "03639_getTimezoneOffsetInMilliseconds.js";
import toInteger from "03480_toInteger.js";
import requiredArgs from "03477_requiredArgs.js";
import code from "03722_code.js";
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("03481_getDefaultOptions.js").getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3723).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3723).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3723).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
