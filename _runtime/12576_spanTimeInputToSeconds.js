// _runtime/12576_spanTimeInputToSeconds.js
import consoleSandbox from "12571_consoleSandbox.js";
import addNonEnumerableProperty from "12577_addNonEnumerableProperty.js";
import generatePropagationContext from "12581_generatePropagationContext.js";
import regExp from "12583_regExp.js";
import dateTimestampInSeconds from "12585_dateTimestampInSeconds.js";
import _mod12586 from "metro/12586__.js";
import getMetricSummaryJsonForSpan from "12587_getMetricSummaryJsonForSpan.js";
import getSpanStatusFromHttpCode from "12588_getSpanStatusFromHttpCode.js";
import getMainCarrier from "12589_getMainCarrier.js";
import getAsyncContextStrategy from "12590_getAsyncContextStrategy.js";
  ...
  if (
    ...
    try {
      ...
      if (
        ...
        obj[8] = attributes[_mod12586.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[_mod12586.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== getSpanStatusFromHttpCode.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(12588).SPAN_STATUS_OK) {
