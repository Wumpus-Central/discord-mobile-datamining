// _runtime/05494_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05501_AudioTypes.js";
import ImageTypes from "05502_ImageTypes.js";
import VideoTypes from "05503_VideoTypes.js";
import CompressedTypes from "05504_CompressedTypes.js";
import OtherTypes from "05505_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5495).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5495).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5495).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5495).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
