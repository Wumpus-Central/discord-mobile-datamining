...
export const randomBytes = function randomBytes() {
  ...
  if (Hash(9962).crypto) {
    if (typeof Hash(9962).crypto.getRandomValues === "function") {
      const _crypto2 = Hash(9962).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(9962).crypto) {
    if (typeof Hash(9962).crypto.randomBytes === "function") {
      const _crypto = Hash(9962).crypto;
