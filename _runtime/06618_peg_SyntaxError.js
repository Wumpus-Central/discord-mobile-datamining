// _runtime/06618_peg_SyntaxError.js
    ...
    if (this.location) {
      ...
      if (parts) {
        ...
        if ("".length <= length) {
          ...
          repeat = " ".repeat;
          text2 = ` ${" ".repeat(tmp10)}`;
          str6 = `${require("../discord_app/index.native.tsx")}`;
        }
        ...
        if ("".length <= diff1) {
          ...
          repeat2 = " ".repeat;
          text4 = ` ${" ".repeat(tmp18)}`;
          str13 = `${require("../discord_app/index.native.tsx")}`;
        }
        length6 = "".length;
        str15 = "";
        if ("".length <= tmp12) {
          ...
          repeat3 = "^".repeat;
          text5 = `^${"^".repeat(tmp20)}`;
          str15 = `${require("../discord_app/index.native.tsx")}`;
        }
