// _runtime/06839_VirtualDetector.js
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("metro/06838__.js").useInterceptingDetectorContext();
      ...
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = {
            ...
            viewRef: "a",
            userSelect: "Array",
            touchAction: "useTranslateAnimation",
            enableContextMenu: "r",
          };
          ({
  ...
  let obj = require("metro/06838__.js");
};
