...
class AnimatedSubtraction {
  constructor(arg0, arg1, arg2) {
    self = this;
    tmp = _isNativeReflectConstruct(this, AnimatedSubtraction);
    items = [];
    items[0] = importDefault;
    tmp2 = __esModule;
    obj = __esModule(AnimatedSubtraction);
    tmp3 = __esModule;
...
require("_inherits")(AnimatedSubtraction, require("_isNativeReflectConstruct"));
let items = [
  {
    key: "__makeNative",
