// _runtime/04745_ToPrimitive.js
import apply from "01417_apply.js";
import isPrimitive from "04746_isPrimitive.js";
    ...
    if (!closure_2) {
      {
        ...
        if (tmp16) {
          tmp16 = tmp(4748)(arg0) || tmp(4747)(arg0);
          const tmp15 = tmp(4748)(arg0) || tmp(4747)(arg0);
        }
        let str8 = str2;
        if (tmp16) {
          str8 = "string";
