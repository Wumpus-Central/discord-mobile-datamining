// _runtime/01682_freezeObjectInDev.js
import weakMap from "01683_weakMap.js";
      ...
      get(arg0, arg1) {
        if ("_isReanimatedSharedValue" !== arg1) {
          if ("__remoteFunction" !== arg1) {
            ...
            const reanimatedError = new callback(1663).ReanimatedError(
                            ...
                            const fn = function s() {
                              if (closure_1_9.includes(name)) {
                                ...
                                if (undefined === tmp10) {
                                  ...
                                  const reanimatedError = new name(stack[3]).ReanimatedError(
                                ...
                                const _HermesInternal = HermesInternal;
                                const reanimatedError1 = new name(stack[3]).ReanimatedError(
...
export const makeShareable = isJest
