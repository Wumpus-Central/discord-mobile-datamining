// _runtime/05651_useScrollEventsHandlersDefault.js
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj[0] = require("01653_cancelAnimation.js").useWorkletCallback(E, items);
  ...
  obj[1] = require("01653_cancelAnimation.js").useWorkletCallback(O, items1);
