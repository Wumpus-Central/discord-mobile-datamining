...
export default function ScreenStack(arg0) {
  ...
  const context = noop.useContext(_mod5240.GHContext);
  const obj2 = {
  ...
  _modDef5239("GHWrapper" !== context.name && undefined !== goBackGesture, "Cannot detect GestureDetectorProvider in a screen that uses `goBackGesture`. Make sure your navigator is wrapped in GestureDetectorProvider.");
  _modDef5239(undefined !== goBackGesture && null === ref && undefined === currentScreenId, "Custom Screen Transition require screensRefs and currentScreenId to be provided.");
  ...
  obj4.children = jsx(_modDef5241, {});
  obj3.children = <context gestureDetectorBridge={noop.useRef({
    stackUseEffectCallback(ref1) {

    }
  })} goBackGesture={goBackGesture} transitionAnimation={transitionAnimation} screenEdgeGesture={null} screensRefs={null} currentScreenId={null}>{null}</context>;
  return jsx(_mod5240.RNSScreensRefContext.Provider, { value: ref, children: null });
};