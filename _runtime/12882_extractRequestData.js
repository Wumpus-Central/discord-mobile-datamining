...
import _mod12885 from "metro/12885__.js";
          ...
          if (undefined !== body) {
            if (obj6.isString(body)) {
              ...
              if (obj.isPlainObject(body)) {
                ...
                let _HermesInternal = HermesInternal;
                json = _mod12810.truncate("" + body, 1024);
              }
            }
            obj6 = _mod12808;
          }
