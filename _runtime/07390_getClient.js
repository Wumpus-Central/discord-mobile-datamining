...
arg5.getClient = function getClient() {
  ...
  const asyncContextStrategy = require(7382) /* getAsyncContextStrategy */.getAsyncContextStrategy(mainCarrier);
...
arg5.getGlobalScope = function getGlobalScope() {
  return require(7364) /* getGlobalSingleton */.getGlobalSingleton("globalScope", () => {
...
arg5.getTraceContextFromScope = function getTraceContextFromScope(getPropagationContext) {
  ...
  return require(7369) /* addNonEnumerableProperty */.dropUndefinedKeys({ trace_id, span_id, parent_span_id });
};
arg5.withIsolationScope = function withIsolationScope() {
  ...
  const obj2 = require(7382) /* getAsyncContextStrategy */;
};
