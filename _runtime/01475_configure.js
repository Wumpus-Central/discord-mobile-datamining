...
import 01476__ from "metro/01476__.js";
import { State } from "01477_State.js";
import { 01476__ } from "metro/01476__.js";
...
function configure(arg0) {
  const obj = {};
  const merged = Object.assign(01476__);
...
function fetch(arg0) {
  ...
  if (!c8) {
    ...
    const tmp7 = new State(module_1476);
    c8 = tmp7;
    obj = tmp7;
  }
