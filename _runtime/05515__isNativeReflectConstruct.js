// _runtime/05515__isNativeReflectConstruct.js
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          ...
          if (self.viewNode) {
            self.attachGestureHandler(require("05523_get_ActivityIndicator.js") /* get ActivityIndicator */(self.viewNode));
          } else {
            const _Error = Error;
