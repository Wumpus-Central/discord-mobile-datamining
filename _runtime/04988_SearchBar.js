// _runtime/04988_SearchBar.js
import _modDef4989 from "metro/04989__.js";
...
export default function SearchBar(ref) {
  ...
  const imperativeHandle = noop.useImperativeHandle(ref.ref, () => ({
    ...
    toggleCancelButton(arg0) {
      closure_0 = arg0;
      closure_1_1((arg0) => {
        const Commands = ref(4989).Commands;
  ...
  if (ref(4981).isSearchBarAvailableForCurrentPlatform) {
    ref = ref.ref;
