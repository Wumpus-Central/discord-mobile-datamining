...
export const parse = (str, arg1) => {
  _require = undefined;
  const arrayFormat = require("metro/05539__.js")({ arrayFormat: "none" }, arg1).arrayFormat;
...
export const stringify = (arg0, arg1) => {
  _require = arg0;
  const tmp = require("metro/05539__.js")({ encode: true, strict: true, arrayFormat: "none" }, arg1);
  dependencyMap = tmp;
  closure_129_0 = tmp;
    ...
    let fn = (arg0, arg1, arg2) => {
      if (null === arg1) {
        if (!closure_0.encode) {
          ...
          let encodeURIComponentResult = _mod5538(arg0);
        } else {
      ...
      "bracket" === arrayFormat
        ? (arg0, arg1) => {
            if (null === arg1) {
              ...
              let encodeURIComponentResult2 = _mod5538(arg0);
            } else {
              const _encodeURIComponent = encodeURIComponent;
    ...
    const mapped = sorted.map((item) => {
      ...
      if (undefined === closure_0[item]) {
        ...
        if (!items.encode) {
          ...
          let encodeURIComponentResult = closure_0(5538)(item);
        } else {
          const _encodeURIComponent3 = encodeURIComponent;
        ...
        if (Array.isArray(arr)) {
          ...
          if (!tmp.encode) {
            ...
            let encodeURIComponentResult1 = closure_0(5538)(arr);
          } else {
            const _encodeURIComponent2 = encodeURIComponent;
            encodeURIComponentResult1 = encodeURIComponent(arr);
          }
        } else if (tmp.strict) {
          let encodeURIComponentResult2 = closure_0(5538)(item);
        } else {
          const _encodeURIComponent = encodeURIComponent;
