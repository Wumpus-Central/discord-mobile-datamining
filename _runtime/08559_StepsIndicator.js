// _runtime/08559_StepsIndicator.js
import _mod8557 from "metro/08557__.js";
import _mod8558 from "metro/08558__.js";
import SliderTrackMark from "08560_SliderTrackMark.js";
import StepNumber from "08561_StepNumber.js";
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      let fontSize = _mod8557.constants.STEP_NUMBER_TEXT_FONT_SMALL;
    } else {
      fontSize = _mod8557.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8558.styles.stepsIndicator;
      let tmp6 = require;
    } else {
      const _Object = Object;
      const obj = { marginHorizontal: sliderWidth * _mod8557.constants.MARGIN_HORIZONTAL_PADDING };
      stepsIndicator = Object.assign({}, _mod8558.styles.stepsIndicator, obj);
      tmp6 = require;
    }
    const obj2 = { stepIndicatorContainerStyle: stepsIndicator, stepIndicatorElementStyle: null };
    if ("web" === get_ActivityIndicator.Platform.OS) {
      const _Object2 = Object;
      const obj3 = { width: tmp6(8557).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8558).styles.stepIndicatorElement, obj3);
    } else {
      stepIndicatorElement = tmp6(8558).styles.stepIndicatorElement;
    }
