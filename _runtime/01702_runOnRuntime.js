// _runtime/01702_runOnRuntime.js
...
runOnRuntime.__closure = {
  __DEV__: false,
  SHOULD_BE_USE_WEB: isJest.shouldBeUseWeb(),
  isWorkletFunction: isWorkletFunction.isWorkletFunction,
  makeShareableCloneOnUIRecursive: freezeObjectInDev.makeShareableCloneOnUIRecursive,
  ReanimatedModule: ReanimatedModule2.ReanimatedModule,
  makeShareableCloneRecursive: freezeObjectInDev.makeShareableCloneRecursive,
};
runOnRuntime.__workletHash = 14671185280560;
runOnRuntime.__initData = {
...
export const createWorkletRuntime = function createWorkletRuntime(arg0, initializer) {
  ...
  obj = {
    registerReanimatedError: __reanimatedLoggerConfig(1663).registerReanimatedError,
    registerLoggerConfig: __reanimatedLoggerConfig(1656).registerLoggerConfig,
    config: globalThis.__reanimatedLoggerConfig,
    setupCallGuard: __reanimatedLoggerConfig(1654).setupCallGuard,
    setupConsole: __reanimatedLoggerConfig(1654).setupConsole,
    initializer,
  };
  fn.__closure = obj;
