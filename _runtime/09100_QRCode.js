// _runtime/09100_QRCode.js
import { QR8bitByte } from "09101_QR8bitByte.js";
import { QRRSBlock } from "09103_QRRSBlock.js";
import { QRBitBuffer } from "09105_QRBitBuffer.js";
import { QRPolynomial } from "09107_QRPolynomial.js";
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = 09106__.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = 09106__.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = 09106__.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
