// _runtime/14183__isNativeReflectConstruct.js
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4837).ScreenContext.Provider, { value: closure_8, children: children.children });
};