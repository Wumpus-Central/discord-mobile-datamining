// _runtime/09212__isNativeReflectConstruct.js
...
let items = [
  {
    ...
    value: function update(B) {
      ...
      let view;
      const self = this;
      HashMD(9207).exists(this);
      ({ buffer, blockLen, view } = this);
      const toBytesResult = HashMD(9206).toBytes(B);
      let num = 0;
  ...
  },
  {
    ...
    value: function digestInto(content) {
      ...
      const self = this;
      HashMD(9207).exists(this);
      HashMD(9207).output(content, this);
      this.finished = true;
      ...
      self.process(view, 0);
      view = HashMD(9206).createView(content);
