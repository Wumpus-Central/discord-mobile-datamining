// _runtime/13035_items.js
import { SemVer } from "13007_SemVer.js";
import { Comparator } from "13021_Comparator.js";
import { Range } from "13022_Range.js";
import { Range } from "13024_Range.js";
    ...
    if (1 === arg0.length) {
      ...
      if (arg0[0].semver === Comparator.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(13021).ANY) {
            return true;
          }
        }
      }
