// _runtime/13696_formatToParts.js
import digitsToString from "13674_digitsToString.js";
import _mod13697 from "metro/13697__.js";
import e from "01281_e.js";

let closure_2 = e.__importDefault(digitsToString);
const regExp = new RegExp("^".concat(_mod13697.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod13697.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(13692).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(13698).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(13694).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
