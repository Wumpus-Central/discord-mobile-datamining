    ...
    if (0 === state.strm.avail_in) {
      ...
      if (0 === avail_in) {
        ...
        if (1 === strm.state.wrap) {
          ...
          strm.adler = tmp15(13658)(strm.adler, _window, avail_in, sum1);
        }
...
function DeflateState() {
  ...
  const buf16 = new _mod13651.Buf16(1146);
  obj.dyn_ltree = buf16;
  const buf161 = new _mod13651.Buf16(122);
  obj.dyn_dtree = buf161;
  const buf162 = new _mod13651.Buf16(78);
  obj.bl_tree = buf162;
                ...
                if (num2 <= 9) {
                  if (strategy >= 0) {
                    if (strategy <= 4) {
                      ...
                      const buf8 = new _mod13651.Buf8(2 * obj.w_size);
                      obj.window = buf8;
                      const buf16 = new _mod13651.Buf16(obj.hash_size);
                      obj.head = buf16;
                      const buf161 = new _mod13651.Buf16(obj.w_size);
                      obj.prev = buf161;
                      obj.lit_bufsize = 1 << memLevel + 6;
                      obj.pending_buf_size = 4 * obj.lit_bufsize;
                      const buf81 = new _mod13651.Buf8(obj.pending_buf_size);
            ...
            if (state.input) {
              ...
              if (42 === state8.status) {
                if (2 === state8.wrap) {
                  ...
                  if (state8.gzhead) {
                    ...
                    if (state8.gzhead.hcrc) {
                      state.adler = _mod13658(state.adler, state8.pending_buf, state8.pending, 0);
                    }
                    state8.gzindex = 0;
                    state8.status = 69;
              ...
              if (69 === state8.status) {
                if (state8.gzhead.extra) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      while (state8.gzindex < (65535 & state8.gzhead.extra.length)) {
                        if (state8.pending !== state8.pending_buf_size) {
                          ...
                          if (tmp36) {
                            state.adler = _mod13658(state.adler, state8.pending_buf, state8.pending - tmp35, tmp35);
                          }
                      ...
                      if (tmp29) {
                        state.adler = _mod13658(state.adler, state8.pending_buf, state8.pending - pending, pending);
                      }
                      state = state.state;
                      let avail_out = state.pending;
                  ...
                  if (tmp40) {
                    state.adler = _mod13658(state.adler, state8.pending_buf, state8.pending - pending2, pending2);
                  }
                ...
                if (state8.gzhead.name) {
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp46) {
                        state.adler = _mod13658(state.adler, state8.pending_buf, state8.pending - pending3, tmp44);
                      }
                      ...
                      if (0 !== avail_out3) {
                        let obj8 = _mod13651;
                        let arraySetResult1 = obj8.arraySet(state.output, state3.pending_buf, state3.pending_out, avail_out3, state.next_out);
                    ...
                    if (tmp52) {
                      state.adler = _mod13658(state.adler, state8.pending_buf, state8.pending - pending4, pending4);
                    }
                    if (0 === num46) {
                      state8.gzindex = 0;
                      state8.status = 91;
                ...
                if (state8.gzhead.comment) {
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (tmp58) {
                        state.adler = _mod13658(state.adler, state8.pending_buf, state8.pending - pending5, tmp56);
                      }
                      ...
                      if (0 !== avail_out4) {
                        let obj9 = _mod13651;
                        let arraySetResult2 = obj9.arraySet(state.output, state4.pending_buf, state4.pending_out, avail_out4, state.next_out);
                    ...
                    if (tmp64) {
                      state.adler = _mod13658(state.adler, state8.pending_buf, state8.pending - pending6, pending6);
                    }
                    if (0 === num53) {
                      state8.status = 103;
                    }
        ...
        if (1 !== wrap) {
          if (!state.lookahead) {
            ...
            if (length >= state.w_size) {
              ...
              const buf8 = new _mod13651.Buf8(state.w_size);
              const obj = _mod13651;
