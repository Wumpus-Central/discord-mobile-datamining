// _runtime/13654_flush_block_only.js
import _mod13651 from "metro/13651__.js";
import _mod13655 from "metro/13655__.js";
import StaticTreeDesc from "13656_StaticTreeDesc.js";
                ...
                if (state8.gzhead.name) {
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (0 !== avail_out3) {
                        let obj8 = _mod13651;
                        let arraySetResult1 = obj8.arraySet(
                          state.output,
                          state3.pending_buf,
                          state3.pending_out,
                          avail_out3,
                ...
                if (state8.gzhead.comment) {
                  ...
                  while (true) {
                    ...
                    if (state8.pending !== state8.pending_buf_size) {
                      ...
                      if (0 !== avail_out4) {
                        let obj9 = _mod13651;
                        let arraySetResult2 = obj9.arraySet(
                          state.output,
                          state4.pending_buf,
                          state4.pending_out,
                          avail_out4,
