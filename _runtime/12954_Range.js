...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_12926")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(12927).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(12927).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(12928)("hyphen replace", str);
        let str3 = str.replace(tmp11(12929).safeRe[tmp11(undefined, 12929).t.COMPARATORTRIM], tmp11(12929).comparatorTrimReplace);
        tmp11(12928)("comparator trim", str3);
        let str5 = str3.replace(tmp11(12929).safeRe[tmp11(undefined, 12929).t.TILDETRIM], tmp11(12929).tildeTrimReplace);
        tmp11(12928)("tilde trim", str5);
        const str7 = str5.replace(tmp11(12929).safeRe[tmp11(undefined, 12929).t.CARETTRIM], tmp11(12929).caretTrimReplace);
        tmp11(12928)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp !== "__FORMATJS_LISTFORMAT_DATA__") {
          try {
            tmp = new Range(12925)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(12928)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(12953).ANY) {
