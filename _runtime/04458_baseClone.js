  ...
  if (!arg2) {
    {
      if (_isObject(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4459)(arr);
          obj = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4460)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(621)(arr)) {
            return tmp32(4461)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (obj[tmp11]) {
                  tmp14 = tmp32(4475)(arr, tmp11, tmp);
                  obj = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4465);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4469)(obj, arr));
                } else {
                  tmp32Result = tmp32(4473);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4474)(obj, arr));
                }
