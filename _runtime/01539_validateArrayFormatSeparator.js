// _runtime/01539_validateArrayFormatSeparator.js
    ...
    if ("index" === arrayFormat) {
      ...
      if ("comma" !== arrayFormat) {
        if ("separator" !== arrayFormat) {
          return "bracket-separator" === arrayFormat
            ? (str, str2, arg2) => {
                obj = /(\[\])$/;
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!encode) {
                    ...
                    let encodeURIComponentResult = closure_0(1540)(closure_0);
                  } else {
                  ...
                  if (!items1.encode) {
                    ...
                    let encodeURIComponentResult3 = closure_0(1540)(closure_0);
                  } else {
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!closure_0.encode) {
                    ...
                    let encodeURIComponentResult2 = closure_0(1540)(closure_0);
                  } else {
                    const _encodeURIComponent = encodeURIComponent;
              ...
              if (!closure_0.skipNull) {
                ...
                if (0 === arg0.length) {
                  if (!closure_0.encode) {
                    ...
                    let encodeURIComponentResult1 = closure_0(1540)(closure_0);
                  } else {
                    const _encodeURIComponent2 = encodeURIComponent;
...
export const stringifyUrl = (request, merged) => {
  ...
  const json = exports.stringify(
    Object.assign(exports.parse(exports.extract(request.url), { sort: false }), request.query),
    merged,
  );
  let combined = json;
  if (json) {
