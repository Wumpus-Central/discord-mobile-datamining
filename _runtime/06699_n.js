...
let obj = {
  createGestureHandler(closure_0, handlerTag, config) {
    ...
    const result = require("06686_transformIntoHandlerTags.js").scheduleOperationToBeFlushed(() => {
  ...
  setGestureHandlerConfig(handlerTag, closure_1) {
    ...
    let result = require("06686_transformIntoHandlerTags.js").scheduleOperationToBeFlushed(() => {
...
const fn = function n(arg0, arg1) {
  const result = module(6684).updateGestureHandlerConfig(arg0, arg1);
  const obj = module(6684);
  module(6684).flushOperations();
};
obj = {
...
obj[5] = function installUIRuntimeBindings() {
  return module(6684).installUIRuntimeBindings();
};
