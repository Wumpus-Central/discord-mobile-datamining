// _runtime/07355_CardContainer.js
import Link from "01485_Link.js";
import _mod5936 from "metro/05936__.js";
import ModalPresentationContext from "07345_ModalPresentationContext.js";
import _mod7356 from "metro/07356__.js";
import CardA11yWrapper from "07357_CardA11yWrapper.js";
import _mod7358 from "metro/07358__.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5936.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5936;
  }
  closure_15 = tmp12;
