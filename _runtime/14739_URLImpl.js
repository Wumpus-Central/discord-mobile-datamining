...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(14740).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(14740).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = URLImpl(14743).parseUrlencoded(query);
          const tmpResult = URLImpl(14743);
        }
      }
      const obj = URLImpl(14740);
    },
  },
  {
    key: "origin",
    get() {
      return URLImpl(14740).serializeURLOrigin(this._url);
    },
  },
  {
    key: "protocol",
    ...
    set(arg0) {
      URLImpl(14740).basicURLParse(`${arg0}:`, { url: this._url, stateOverride: "scheme start" });
    },
  },
  {
    key: "username",
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14740).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(14740);
      }
      obj = URLImpl(14740);
    },
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(14740).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(14740);
      }
      obj = URLImpl(14740);
    },
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(14740).serializeHost(host);
        const obj3 = URLImpl(14740);
      } else {
        const obj = URLImpl(14740);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(14740).serializeInteger(host.port)}`;
        const obj2 = URLImpl(14740);
      }
    },
    set(arg0) {
      if (!this._url.cannotBeABaseURL) {
        const obj2 = { url: tmp._url, stateOverride: "host" };
        URLImpl(14740).basicURLParse(arg0, obj2);
        const obj = URLImpl(14740);
      }
    },
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(14740).serializeHost(tmp._url.host);
        const obj = URLImpl(14740);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(14740).serializeInteger(tmp._url.port);
        const obj = URLImpl(14740);
      }
      return str;
    },
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        URLImpl(14740).basicURLParse(substr, obj2);
        const obj = URLImpl(14740);
        self._query._list = URLImpl(14743).parseUrlencoded(substr);
        const obj3 = URLImpl(14743);
      }
    },
  },
  {
