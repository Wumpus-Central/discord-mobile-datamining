// _runtime/14208_digitsToString.js
let self = this;
...
function taylorSeries(constructor, arg1, timesResult, constructor2, arg4) {
  ...
  while (true) {
    ...
    let tmp4Result = f115745(timesResult2, tmp20, precision, 1);
...
const fn14 = function () {
  ...
  if (this.isFinite()) {
    if (self.isZero()) {
      ...
      constructor.precision = precision;
      constructor.rounding = rounding;
      const tmp9 = f115745(self.sinh(), self.cosh(), precision, rounding);
  ...
  if (this.isFinite()) {
    if (self.e < 0) {
      ...
      if (Math.max(sdResult, precision) < 2 * -self.e - 1) {
        ...
        constructor.precision = precision;
        constructor.rounding = rounding;
        timesResult = f115745(plusResult, constructor1.minus(self), diff + precision, 1)
          .ln()
          .times(0.5);
...
obj.toJSON = fn43;
obj.valueOf = fn43;
const f115745 = (s, s2, arg2, rounding, arg4, arg5) => {
  let num13;
  let tmp21;
  let tmp27;
          ...
          if (re18.test(substr2)) {
            ...
            if (tmp42 < 0) {
              ...
              if (tmp24) {
                tmp49 = f115745;
                num21 = 4;
                obj2 = f115745(self, tmp27, 4 * tmp26);
              }
              constructor1 = obj2;
              if (!tmp22) {
                flag3 = true;
