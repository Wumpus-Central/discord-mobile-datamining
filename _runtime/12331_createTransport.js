// _runtime/12331_createTransport.js
import { makePromiseBuffer } from "12332_makePromiseBuffer.js";
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(12312).envelopeItemTypeToDataCategory(arg1);
        const obj = items(12312);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(12312).serializeEnvelope(dependencyMap) };
          const obj2 = items(12312);
          ...
          if (arg0 instanceof items(12325).SentryError) {
