// _runtime/06431_eventFromMessage.js
...
export const eventFromMessage = function eventFromMessage(arg0, message, arg2, event_id) {
    ...
    if (event_id) {
      if (event_id.syntheticException) {
        ...
        if (arr.length) {
          ...
          obj[0] = items;
          obj.exception = obj;
          const result = require(6382) /* addContextToFrame */.addExceptionMechanism(obj, { synthetic: true });
          const obj5 = require(6382) /* addContextToFrame */;
        }
  ...
  obj6 = require(6378) /* isInstanceOf */;
};
export const eventFromUnknownInput = function eventFromUnknownInput(getOptions, arg1, name, data) {
  ...
  let obj1 = require(6378) /* isInstanceOf */;
  if (obj1.isError(name)) {
    ...
    if (tmp2Result.isPlainObject(name)) {
      ...
      if (tmp12) {
        ...
        const result = require(6377) /* addNonEnumerableProperty */.extractExceptionKeysForMessage(name);
        const obj6 = require(6377) /* addNonEnumerableProperty */;
        ...
        obj7 = require(6378) /* isInstanceOf */;
      }
    } else {
  ...
  const result1 = require(6382) /* addContextToFrame */.addExceptionTypeValue(obj2, undefined, undefined);
  const obj11 = require(6382) /* addContextToFrame */;
  const result2 = require(6382) /* addContextToFrame */.addExceptionMechanism(obj2, data);
  const obj3 = {};
