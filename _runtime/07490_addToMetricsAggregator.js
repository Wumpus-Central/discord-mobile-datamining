// _runtime/07490_addToMetricsAggregator.js
import "errorCallback";
import __SENTRY_DEBUG__ from "__SENTRY_DEBUG__";
import { getGlobalSingleton } from "07395_getGlobalSingleton.js";
import { spanTimeInputToSeconds } from "07399_spanTimeInputToSeconds.js";
import { dateTimestampInSeconds } from "07408_dateTimestampInSeconds.js";
import { getClient } from "07421_getClient.js";
import { createChildOrRootSpan } from "07428_createChildOrRootSpan.js";
import { __SENTRY_DEBUG__ } from "metro/07422___SENTRY_DEBUG__.js";
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07491__.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07491__.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, 07491__.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07491__.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    ...
    if (typeof fn === "function") {
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _07491__.DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
