// _runtime/08062_offsetComparator.js
import extractOpacityDefault from "07991_extractOpacity.js";
import appendTransformPropsDefault from "07993_appendTransformProps.js";
import _modDef8063 from "metro/08063__.js";
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
    ...
    if (gradientUnits) {
      num12 = _modDef8063[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
