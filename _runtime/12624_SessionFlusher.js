// _runtime/12624_SessionFlusher.js
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12577).dropUndefinedKeys(obj);
    },
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12598).getIsolationScope();
        ...
        const obj = SessionFlusher(12598);
      }
    },
  },
  {
