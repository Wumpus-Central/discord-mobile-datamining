// _runtime/14342_SetNumberFormatDigitOptions.js
import _mod14295 from "metro/14295__.js";
import GetNumberOption from "14298_GetNumberOption.js";
import DefaultNumberOption from "14299_DefaultNumberOption.js";
import GetOption from "14300_GetOption.js";

require = arg1;
const dependencyMap = arg6;
const set = new Set([1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1000, 2000, 2500, 5000]);

export const SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(
  internalSlots,
  result1,
  ...
  _mod14295.invariant(hasItem, combined.concat(Array.from(set).join(", "), "."));
  const arr = Array.from(set);
  GetOptionResult1 = GetOption.GetOption(
    result1,
    "roundingPriority",
    "string",
  ...
  internalSlots.trailingZeroDisplay = GetOption.GetOption(
    result1,
    "trailingZeroDisplay",
    "string",
    ["auto", "stripIfInteger"],
  ...
  if (flag) {
    if (tmp12) {
      ...
      if (undefined === DefaultNumberOptionResult) {
        _mod14295.invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      _mod14295.invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
