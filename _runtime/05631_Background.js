// === Module 5631: Background ===

// Module 5631 (Background)
import registerAssetDefault from "registerAsset" /* 5632 */;
import registerAssetDefault2 from "registerAsset" /* 5633 */;
import registerAssetDefault3 from "registerAsset" /* 5634 */;
import registerAssetDefault4 from "registerAsset" /* 5635 */;
import registerAssetDefault5 from "registerAsset" /* 5636 */;

const items = [registerAssetDefault, registerAssetDefault2, registerAssetDefault3, registerAssetDefault4, registerAssetDefault5];
for (const key10025 in require("module_5637")) {
  let tmp2 = key10025;
  arg5[key10025] = require("module_5637")[key10025];
  continue;
}
