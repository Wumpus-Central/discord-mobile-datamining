...
export const Card = function Card(shadowEnabled) {
  ...
  let merged = Object.assign(
    flag2(6044).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }),
  );
  ...
  const items13 = [
    tmp27,
    gesture(flag2(6045).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children }),
  ];
  obj5[3] = items13;
