// _runtime/08247_processBarButtonItems.js
import ColorDefault from "05943_Color.js";
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const tmpResult = colors(8248);
  let fontSize;
  [tmp10, tmp11, tmp12] = colors(8248).processFonts(items3);
  if ("fontSize" in tmp4) {
    fontSize = tmp4.fontSize;
  }
  const tmp9 = _slicedToArray(colors(8248).processFonts(items3), 3);
  const headerTitle1 = colors(5934).getHeaderTitle({ title, headerTitle }, route.name);
  if ("color" in tmp6) {
  ...
  const isSearchBarAvailableForCurrentPlatform = colors(5201).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = colors(5201).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      ...
      let tmp32Result = closure_12(colors(5201).ScreenStackHeaderLeftView, obj11);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj13.children = closure_10(colors(5934).HeaderTitle, obj14);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      headerTitleResult = closure_10(colors(5934).HeaderTitle, obj15);
    }
    const obj16 = { children: headerTitleResult };
    tmp38Result = closure_10(colors(5201).ScreenStackHeaderCenterView, obj16);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    const obj17 = { source };
    let tmp40Result = closure_10(colors(5201).ScreenStackHeaderBackButtonImage, obj17);
  } else {
    tmp40Result = null;
  }
  ...
  if (null != headerRightResult) {
    ...
    tmp42 = closure_10(colors(5201).ScreenStackHeaderRightView, obj18);
  }
  items7[2] = tmp42;
  let tmp44 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj19.children = closure_10(colors(5201).SearchBar, obj20);
    tmp44 = closure_10(colors(5201).ScreenStackHeaderSearchBarView, obj19);
  }
  items7[3] = tmp44;
  const obj21 = {
    ...
    largeTitleHideShadow: "By-line Title",
    title: true,
    ...
    disableTopInsetApplication: "Contact",
