      ...
      return {
        localeError: (code) => {
          ...
          switch (str) {
            ...
            break;
            case "View":
              str = concat(divisor, " \u06A9\u0627 \u0645\u0636\u0627\u0639\u0641 \u06C1\u0648\u0646\u0627 \u0686\u0627\u06C1\u06CC\u06D2");
              return str;
            case "w":
            break;
            case "WireType":
            ...
            case "H":
              ...
              if (obj.test(code.expected)) {
                ...
                let combined = "\u063A\u0644\u0637 \u0627\u0646 \u067E\u0679: instanceof " + code.expected + " \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u0627\u060C " + tmp50 + " \u0645\u0648\u0635\u0648\u0644 \u06C1\u0648\u0627";
              } else {
                const _HermesInternal14 = HermesInternal;
                combined = "\u063A\u0644\u0637 \u0627\u0646 \u067E\u0679: " + expected + " \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u0627\u060C " + tmp50 + " \u0645\u0648\u0635\u0648\u0644 \u06C1\u0648\u0627";
              }
              return combined;
            case "HT":
            break;
            ...
            case "INTERACTIONS":
              ...
              if (tmp30) {
                ...
                let str38 = tmp30.unit;
                if (str38 == null) {
                  str38 = "\u0639\u0646\u0627\u0635\u0631";
                }
                const _HermesInternal12 = HermesInternal;
                let combined2 = "\u0628\u06C1\u062A \u0628\u0691\u0627: " + str31 + " \u06A9\u06D2 " + str30 + str + " " + str38 + " \u06C1\u0648\u0646\u06D2 \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u06D2";
            ...
            case "woman_gesturing_no":
              ...
              if (tmp18) {
                ...
                let combined3 = "\u0628\u06C1\u062A \u0686\u06BE\u0648\u0679\u0627: " + origin + " \u06A9\u06D2 " + str22 + str1 + " " + tmp18.unit + " \u06C1\u0648\u0646\u06D2 \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u06D2";
              } else {
                const _HermesInternal9 = HermesInternal;
                combined3 = "\u0628\u06C1\u062A \u0686\u06BE\u0648\u0679\u0627: " + origin + " \u06A9\u0627 " + str22 + str1 + " \u06C1\u0648\u0646\u0627 \u0645\u062A\u0648\u0642\u0639 \u062A\u06BE\u0627";
              }
              return combined3;
            ...
            case "man_gesturing_no":
              if ("starts_with" === code.format) {
                ...
                str = "\u063A\u0644\u0637 \u0633\u0679\u0631\u0646\u06AF: \"" + code.prefix + "\" \u0633\u06D2 \u0634\u0631\u0648\u0639 \u06C1\u0648\u0646\u0627 \u0686\u0627\u06C1\u06CC\u06D2";
              } else if ("ends_with" === code.format) {
                const _HermesInternal7 = HermesInternal;
                str = "\u063A\u0644\u0637 \u0633\u0679\u0631\u0646\u06AF: \"" + code.suffix + "\" \u067E\u0631 \u062E\u062A\u0645 \u06C1\u0648\u0646\u0627 \u0686\u0627\u06C1\u06CC\u06D2";
              } else if ("includes" === code.format) {
                const _HermesInternal6 = HermesInternal;
                str = "\u063A\u0644\u0637 \u0633\u0679\u0631\u0646\u06AF: \"" + code.includes + "\" \u0634\u0627\u0645\u0644 \u06C1\u0648\u0646\u0627 \u0686\u0627\u06C1\u06CC\u06D2";
              } else if ("regex" === code.format) {
                const _HermesInternal5 = HermesInternal;
                str = "\u063A\u0644\u0637 \u0633\u0679\u0631\u0646\u06AF: \u067E\u06CC\u0679\u0631\u0646 " + code.pattern + " \u0633\u06D2 \u0645\u06CC\u0686 \u06C1\u0648\u0646\u0627 \u0686\u0627\u06C1\u06CC\u06D2";
              } else {
            ...
            case "I":
              ...
              let combined4 = "" + code.origin + " \u0645\u06CC\u06BA \u063A\u0644\u0637 \u06A9\u06CC";
              return combined4;
            case "InternalCard":
            break;
            case "ter":
            ...
            case "al":
              ...
              let combined5 = "" + code.origin + " \u0645\u06CC\u06BA \u063A\u0644\u0637 \u0648\u06CC\u0644\u06CC\u0648";
              return combined5;
            ...
            case "cat":
              ...
              combined4 = "" + code.origin + " \u0645\u06CC\u06BA \u063A\u0644\u0637 \u06A9\u06CC";
              return combined4;
            case "tio":
            break;
            case "io":
            ...
            case "GuildEventModeratorAction":
              ...
              combined5 = "" + code.origin + " \u0645\u06CC\u06BA \u063A\u0644\u0637 \u0648\u06CC\u0644\u06CC\u0648";
              return combined5;
