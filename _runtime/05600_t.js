...
const fn2 = function _(arg0) {
  const ACTIVE = 05494__.State.ACTIVE;
...
obj = { setGestureState: fn, State: require("module_5494").State };
fn2.__closure = obj;
...
const fn3 = function n(arg0) {
  const FAILED = 05494__.State.FAILED;
  if (typeof fn !== "function") {
    HermesBuiltin.throwTypeError();
  }
  const _globalThis = globalThis;
...
fn3.__closure = { setGestureState: fn, State: require("module_5494").State };
...
const obj1 = { setGestureState: fn, State: require("module_5494").State };
fn4.__closure = { setGestureState: fn, State: require("module_5494").State };
