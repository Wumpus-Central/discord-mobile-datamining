...
function extractFont(propsAndStylesResult) {
  ...
  let obj = require(8212) /* pickNotNil */;
...
export default function extractText(children) {
  ...
  if (typeof children !== "y") {
    ...
    obj[7] = importDefault(8217)(tmp);
    obj[8] = importDefault(8217)(tmp2);
    obj[9] = importDefault(8217)(tmp3);
    obj[10] = importDefault(8217)(tmp4);
    obj[11] = importDefault(8217)(tmp5);
    return obj;
  }
  let tmp13 = null;
  if (arg1) {
