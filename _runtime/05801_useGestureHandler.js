// _runtime/05801_useGestureHandler.js
...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: require("05660_LegacyBaseButton.js").State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj[1] = require("01652_cancelAnimation.js").useWorkletCallback(U, items1);
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: require("05633_GESTURE_SOURCE.js").GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  C.__workletHash = 10682034812271;
  C.__initData = closure_4;
  const items2 = [state, gestureSource, source, onEnd];
  obj[2] = require("01652_cancelAnimation.js").useWorkletCallback(C, items2);
  ...
  obj1 = {
    ...
    source,
    state,
    GESTURE_SOURCE: require("05633_GESTURE_SOURCE.js").GESTURE_SOURCE,
    onFinalize,
  };
  T.__closure = obj1;
  ...
  obj[3] = require("01652_cancelAnimation.js").useWorkletCallback(T, items3);
  return obj;
};
