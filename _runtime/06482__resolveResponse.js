// _runtime/06482__resolveResponse.js
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  require(6369) /* addHandler */.addHandler("fetch-body-resolved", arg0);
  let obj = require(6369) /* addHandler */;
  require(6369) /* addHandler */.maybeInstrument("fetch-body-resolved", () => {
    const callback = closure_5;
    {
      callback(6377).fill(callback(6372).GLOBAL_OBJ, "fetch", (arg0) => {
        let closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  _require(6369).addHandler("fetch", arg0);
  let obj = _require(6369);
  _require(6369).maybeInstrument("fetch", () => {
    let flag = callback;
