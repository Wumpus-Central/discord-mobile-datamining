// _runtime/07498_NativeModules.js
...
export const getInstallSourceAndroid = () => {
  const InstallSourceAndroid = callback(7490).InstallSourceAndroid;
