// _runtime/01722_setElementAnimation.js
...
import BaseAnimationBuilder from "01723_BaseAnimationBuilder.js";
import weakMap from "01739_weakMap.js";
...
function setElementAnimation(dummy, dummyAnimationConfig, arg2) {
  ...
  if (dummyAnimationConfig.animationType === require("01678_isWorkletFunction.js").LayoutAnimationType.ENTERING) {
  ...
  if (!(animationName in require("01709_TransitionType.js").Animations)) {
...
arg5.handleExitingAnimation = function handleExitingAnimation(offsetParent, processedConfig) {
  ...
  const snapshots = require("01739_weakMap.js").snapshots;
  ...
  require("01739_weakMap.js").setElementPosition(cloneNodeResult, rect);
