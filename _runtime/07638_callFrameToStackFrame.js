// _runtime/07638_callFrameToStackFrame.js
import { createStackParser } from "07523_createStackParser.js";
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  if (replaced) {
    filenameIsInAppResult = tmp4(7636).filenameIsInApp(replaced);
    const tmp4Result = tmp4(7636);
  }
