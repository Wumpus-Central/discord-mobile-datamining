// _runtime/12424_stringProcessor.js
import _slicedToArray from "_slicedToArray";
import { mergeDefs } from "12365_mergeDefs.js";
...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(12423).process(_idmap, initializeContextResult);
    tmp2(12423).extractDefs(initializeContextResult, _idmap);
    return tmp2(12423).finalize(initializeContextResult, _idmap);
  }
