// _runtime/14250_FormatNumericToString.js
import TEN from "14236_TEN.js";

const _mod14234 = tmp5(14234);
const GetUnsignedRoundingMode = tmp5(14251);
const ToRawPrecision = tmp5(14252);
const ToRawFixed = tmp5(14253);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14234.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14234.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
