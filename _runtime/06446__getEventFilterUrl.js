// _runtime/06446__getEventFilterUrl.js
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (require(6399) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      const logger = tmp6(6371).logger;
      const _HermesInternal = HermesInternal;
      logger.error("Cannot extract url for event " + tmp6(6382).getEventDescription(tmp));
      const tmp6Result = tmp6(6382);
    }
    return null;
  }
}
