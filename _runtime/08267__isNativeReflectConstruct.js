...
const items = [
  {
    ...
    value: function render() {
      ...
      [tmp2, tmp3] = parts;
      obj[5] = self(8209).meetOrSliceTypes[tmp3] || 0;
      const tmp6 = self(8209).meetOrSliceTypes[tmp3] || 0;
      obj[6] = self(8209).alignEnum[tmp2] || "xMidYMid";
      ...
      const tmp7 = self(8209).alignEnum[tmp2] || "xMidYMid";
      const tmp11 = importDefault(8268);
