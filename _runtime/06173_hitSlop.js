// _runtime/06173_hitSlop.js
import _mod6145 from "metro/06145__.js";
import touchDataToPressEvent from "06174_touchDataToPressEvent.js";
import StateMachineEvent2 from "06177_StateMachineEvent.js";
...
export default function _default(pressRetentionOffset) {
  ...
  closure_28 = closure_6(() => {
    if (ref5.current == null) {
      tmp.current = _mod6145.isKeyboardDismissingTap(closure_18);
    }
  }, items5);
