// _runtime/14030__isNativeReflectConstruct.js
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4756).ScreenContext.Provider, { value: closure_8, children: children.children });
};