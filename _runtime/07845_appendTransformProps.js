// _runtime/07845_appendTransformProps.js
import { append } from "07846_append.js";
import { peg$SyntaxError } from "07847_peg_SyntaxError.js";
import { peg$SyntaxError } from "07848_peg_SyntaxError.js";
const require = arg1;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(7847);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(7846);
