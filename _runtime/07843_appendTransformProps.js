// _runtime/07843_appendTransformProps.js
import { append } from "07844_append.js";
import { peg$SyntaxError } from "07845_peg_SyntaxError.js";
import { peg$SyntaxError } from "07846_peg_SyntaxError.js";
const require = arg1;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(7845);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(7844);
