// _runtime/07640_createEventEnvelope.js
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(7644).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(7644);
  }
