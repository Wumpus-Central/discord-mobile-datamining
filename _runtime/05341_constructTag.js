// _runtime/05341_constructTag.js
import _mod5294 from "metro/05294__.js";
import _modDef5297 from "metro/05297__.js";
import PNG_CHUNK_TYPE_SIZE from "05301_PNG_CHUNK_TYPE_SIZE.js";
import _modDef5313 from "metro/05313__.js";
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== PNG_CHUNK_TYPE_SIZE.TYPE_TEXT) {
    ...
    if (0 !== items2.length) {
      ...
      combined = "" + stringValueFromArray + " (" + _mod5294.getStringValueFromArray(items2) + ")";
  ...
  read(byteLength, arg1, arg2, arg3) {
    ...
    if (0 < arg1.length) {
      while (true) {
        ...
        let COMPRESSION_METHOD_NONE = require("metro/05294__.js").COMPRESSION_METHOD_NONE;
        ...
        let tmp38 = _require;
        if (tmp5 !== require("metro/05294__.js").COMPRESSION_METHOD_NONE) {
          if (!arg2) {
            obj = {};
