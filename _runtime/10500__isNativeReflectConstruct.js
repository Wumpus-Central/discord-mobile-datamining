// _runtime/10500__isNativeReflectConstruct.js
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp(
        "(?:in|f\u00FCr|w\u00E4hrend)\\s*(" + DETimeUnitWithinFormatParser(10492).TIME_UNITS_PATTERN + ")(?=\\W|$)",
        "i",
      );
      return regExp;
    },
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ParsingComponents.createRelativeFromReference(
        reference.reference,
        DETimeUnitWithinFormatParser(10492).parseDuration(arg1[1]),
      );
    },
  },
];
