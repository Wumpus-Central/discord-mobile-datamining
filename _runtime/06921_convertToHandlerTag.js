// _runtime/06921_convertToHandlerTag.js
import _mod6900 from "metro/06900__.js";
...
function convertToHandlerTag(handlerTag) {
  if (typeof handlerTag === "number") {
    return handlerTag;
  } else if (handlerTag instanceof _mod6918.BaseGesture) {
...
let items = [
  ...fn(6922).baseGestureHandlerWithDetectorProps,
  ...fn(6923).tapGestureHandlerProps,
  ...fn(6933).panGestureHandlerProps,
  ...fn(6933).panGestureHandlerCustomNativeProps,
  ...fn(6934).longPressGestureHandlerProps,
  ...fn(6935).forceTouchGestureHandlerProps,
  ...fn(6937).flingGestureHandlerProps,
  ...fn(6938).hoverGestureHandlerProps,
  ...fn(6939).nativeViewGestureHandlerProps,
];
...
export const useWebEventHandlers = function useWebEventHandlers() {
  return React4({
    onGestureHandlerEvent(nativeEvent) {
      const result = _mod6900.onGestureHandlerEvent(nativeEvent.nativeEvent);
    },
