// === Module 6921: convertToHandlerTag ===
...
let items = [...fn(6922).baseGestureHandlerWithDetectorProps, ...fn(6923).tapGestureHandlerProps, ...fn(6933).panGestureHandlerProps, ...fn(6933).panGestureHandlerCustomNativeProps, ...fn(6934).longPressGestureHandlerProps, ...fn(6935).forceTouchGestureHandlerProps, ...fn(6937).flingGestureHandlerProps, ...fn(6938).hoverGestureHandlerProps, ...fn(6939).nativeViewGestureHandlerProps];
