// _runtime/12841_forEachEnvelopeItem.js
...
import { normalize } from "12842_normalize.js";
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    ...
    let encodePolyfill = dependencyMap;
    if (!require("12798_getGlobalSingleton.js").GLOBAL_OBJ.__SENTRY__) {
      const _TextEncoder = TextEncoder;
      const textEncoder = new TextEncoder();
    ...
    if (typeof tmp8[1] !== "string") {
      ...
      if (!(tmp10 instanceof Uint8Array)) {
        try {
          ...
          json = _JSON3.stringify(require("12842_normalize.js").normalize(tmp3));
          const obj = normalize;
        }
      }
    }
