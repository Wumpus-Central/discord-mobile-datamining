// _runtime/07969_processBarButtonItems.js
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const isSearchBarAvailableForCurrentPlatform = colors(4957).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = colors(4957).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      ...
      let tmp32Result = closure_12(colors(4957).ScreenStackHeaderLeftView, obj6);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj8.children = closure_10(colors(5681).HeaderTitle, obj9);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      headerTitleResult = closure_10(colors(5681).HeaderTitle, obj10);
    }
    const obj11 = { children: headerTitleResult };
    tmp38Result = closure_10(colors(4957).ScreenStackHeaderCenterView, obj11);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    const obj12 = { source };
    let tmp40Result = closure_10(colors(4957).ScreenStackHeaderBackButtonImage, obj12);
  } else {
    tmp40Result = null;
  }
  ...
  if (null != headerRightResult) {
    ...
    tmp42 = closure_10(colors(4957).ScreenStackHeaderRightView, obj13);
  }
  items7[2] = tmp42;
  let tmp44 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj14.children = closure_10(colors(4957).SearchBar, obj15);
    tmp44 = closure_10(colors(4957).ScreenStackHeaderSearchBarView, obj14);
  }
  items7[3] = tmp44;
  const obj16 = {
    ...
    headerRightBarButtonItems: "surface-high",
