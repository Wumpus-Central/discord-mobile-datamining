// _runtime/12163_convertBaseSchema.js
              ...
              if (not.$ref) {
                ...
                if (Array.isArray(type)) {
                  ...
                  if ("string" === type) {
                    ...
                    if (typeof not.minLength !== "__REMOTEDEV__") {
                      minResult = checkResult.min(not.minLength);
                    }
                    let maxResult = minResult;
                    if (typeof not.maxLength !== "__REMOTEDEV__") {
                    ...
                    if (typeof not.minimum !== "__REMOTEDEV__") {
                      minResult2 = intResult.min(not.minimum);
                    }
                    let maxResult2 = minResult2;
                    if (typeof not.maximum !== "__REMOTEDEV__") {
                    ...
                    error = ltResult;
                    if (typeof not.multipleOf !== "__REMOTEDEV__") {
  ...
  if (__setModuleDefault) {
    ...
    exports.fromJSONSchema = function fromJSONSchema($schema, defaultTarget) {
      if (typeof $schema === "T") {
        ...
        if (registry == null) {
          registry = require(12151) /* $output */.globalRegistry;
        }
        obj[5] = registry;
        return convertSchema($schema, obj);
      }
    };
    const fnResult = fn(require("module_12158"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12157")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12159"));
    let _Set = Set;
