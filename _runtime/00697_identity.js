// _runtime/00697_identity.js
import is from "00698_is.js";
...
function createWithEqualityFnImpl(arg0, arg1) {
  ...
  function useBoundStoreWithEqualityFn(arg0) {
    ...
    const syncExternalStoreWithSelector = callback(store[1]).useSyncExternalStoreWithSelector(
      store.subscribe,
      store.getState,
