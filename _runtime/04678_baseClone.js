// _runtime/04678_baseClone.js
import assignValue from "04687_assignValue.js";
        ...
        if (tmp10) {
          ...
          if (tmp32(536)(arr)) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4685);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4689)(obj, arr));
                } else {
                  tmp32Result = tmp32(4693);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4694)(obj, arr));
                }
