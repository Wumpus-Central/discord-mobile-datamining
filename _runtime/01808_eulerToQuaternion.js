// _runtime/01808_eulerToQuaternion.js
...
function adjustRotationToInterfaceOrientation(pitch) {
  ...
  } else if (interfaceOrientation === tmp(1677).InterfaceOrientation.ROTATION_270) {
    pitch.pitch = -roll;
    pitch.roll = pitch;
    const _Math = Math;
    pitch.yaw = yaw + Math.PI / 2;
  } else if (interfaceOrientation === tmp(1677).InterfaceOrientation.ROTATION_180) {
...
export const useAnimatedSensor = function useAnimatedSensor(arg0, adjustToInterfaceOrientation) {
  ...
  obj = {
    sensor: require("01696_isReanimated3.js").initializeSensor(arg0, tmp13),
    unregister() {},
    isAvailable: false,
    config: tmp13,
  };
