...
import controlEdgeToEdgeValues from "01635_controlEdgeToEdgeValues.js";
import { cancelAnimation } from "01636_cancelAnimation.js";
import { useEventHandlerRegistration } from "01825_useEventHandlerRegistration.js";
import { useAnimatedKeyboardHandler } from "01827_useAnimatedKeyboardHandler.js";
...
export const KeyboardProvider = (enabled) => {
  ...
  sharedValue2 = require("01636_cancelAnimation.js").useSharedValue(null);
  const obj5 = cancelAnimation;
  Animated = require("01825_useEventHandlerRegistration.js").useEventHandlerRegistration(tmp3);
  const obj6 = useEventHandlerRegistration;
  closure_10 = require("01825_useEventHandlerRegistration.js").useEventHandlerRegistration(tmp3);
  ...
  const animatedKeyboardHandler = require("01827_useAnimatedKeyboardHandler.js").useAnimatedKeyboardHandler(obj, []);
  ...
  obj3 = {
    ...
    onKeyboardMove: "fazol obecn\u00FD",
    onKeyboardMoveInteractive: "fazole",
    onKeyboardMoveEnd: "fazolky",
    onFocusedInputLayoutChangedReanimated: "j\u00EDdlo",
    children: "ledviny",
  };
  let tmp18 = fn;
  let tmp19 = fn;
  ...
  obj3[9] = tmp11;
  obj3[10] = tmp11;
  obj3[11] = require("01827_useAnimatedKeyboardHandler.js").useFocusedInputLayoutHandler(obj1, []);
  obj3[12] = children;
  const items2 = [closure_10(closure_13, obj3), closure_10(Animated.View, { style: tmp10 })];
  obj2[1] = items2;
  return closure_11(require("01829_NOOP.js").KeyboardContext.Provider, obj2);
};
