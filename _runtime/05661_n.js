...
let obj = {
  createGestureHandler(closure_0, handlerTag, config) {
    ...
    const result = require("05648_transformIntoHandlerTags.js").scheduleOperationToBeFlushed(() => {
  ...
  setGestureHandlerConfig(handlerTag, closure_1) {
    ...
    let result = require("05648_transformIntoHandlerTags.js").scheduleOperationToBeFlushed(() => {
...
const fn = function n(arg0, arg1) {
  const result = module(5646).updateGestureHandlerConfig(arg0, arg1);
  const obj = module(5646);
  module(5646).flushOperations();
};
...
obj[5] = function installUIRuntimeBindings() {
  return module(5646).installUIRuntimeBindings();
};
