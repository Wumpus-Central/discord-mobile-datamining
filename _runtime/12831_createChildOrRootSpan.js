// _runtime/12831_createChildOrRootSpan.js
import _mod12812 from "metro/12812__.js";
import getClient from "12824_getClient.js";
import hasTracingEnabled from "12829_hasTracingEnabled.js";
...
export const continueTrace = (arg0, arg1) => {
  const _require = arg1;
  const mainCarrier = require("12815_getMainCarrier.js").getMainCarrier();
  const obj = getMainCarrier;
  const tmp = _require;
  const asyncContextStrategy = require("12816_getAsyncContextStrategy.js").getAsyncContextStrategy(mainCarrier);
...
export const startNewTrace = function startNewTrace(arg0) {
  const _require = arg0;
  return require("12824_getClient.js").withScope((setPropagationContext) => {
...
export const startSpanManual = function startSpanManual(experimental) {
  ...
  let obj = getMainCarrier;
  let mainCarrier = obj.getMainCarrier();
  let asyncContextStrategy = require("12816_getAsyncContextStrategy.js").getAsyncContextStrategy(mainCarrier);
