// _runtime/05346_constructTag.js
import _mod5299 from "metro/05299__.js";
import _modDef5302 from "metro/05302__.js";
import PNG_CHUNK_TYPE_SIZE from "05306_PNG_CHUNK_TYPE_SIZE.js";
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== PNG_CHUNK_TYPE_SIZE.TYPE_TEXT) {
    ...
    if (0 !== items2.length) {
      ...
      combined = "" + stringValueFromArray + " (" + _mod5299.getStringValueFromArray(items2) + ")";
  ...
  read(byteLength, arg1, arg2, arg3) {
    ...
    if (0 < arg1.length) {
      while (true) {
        ...
        let COMPRESSION_METHOD_NONE = require("metro/05299__.js").COMPRESSION_METHOD_NONE;
        ...
        let tmp38 = _require;
        if (tmp5 !== require("metro/05299__.js").COMPRESSION_METHOD_NONE) {
          if (!arg2) {
            let obj2 = {};
                  ...
                  try {
                    if (_modDef5302.USE_EXIF) {
                      if (isExifGroupTag(name, value)) {
                        const obj2 = { __exif: _modDef5318.read(decodeRawData(value), c10, closure_0).tags };
                        return obj2;
                      }
                    }
                    if (_modDef5302.USE_IPTC) {
                      if (isIptcGroupTag(name, value)) {
                        const obj3 = { __iptc: _modDef5330.read(decodeRawData(value), 0, closure_0) };
                        return obj3;
                      }
                    }
                    if (name) {
