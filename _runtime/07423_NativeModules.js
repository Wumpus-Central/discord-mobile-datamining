// _runtime/07423_NativeModules.js
...
export const setup = () => {
  ...
  if ("STOREKIT1_MODE" === str) {
    07425__.storekit1Mode();
    const obj4 = 07425__;
  } else if ("STOREKIT2_MODE" === str) {
    07425__.storekit2Mode();
    const obj3 = 07425__;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    07425__.storekitHybridMode();
    const obj2 = 07425__;
  }
};
export const initConnection = () => {
  const nativeModule = 07425__.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = 07425__.getAndroidModule();
