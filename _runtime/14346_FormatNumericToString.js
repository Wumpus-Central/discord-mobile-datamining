// _runtime/14346_FormatNumericToString.js
import TEN from "14332_TEN.js";

const _mod14330 = tmp5(14330);
const GetUnsignedRoundingMode = tmp5(14347);
const ToRawPrecision = tmp5(14348);
const ToRawFixed = tmp5(14349);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14330.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14330.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
