// _runtime/06856_ScrollableContainer.js
import BottomSheetDraggableScrollable from "06857_BottomSheetDraggableScrollable.js";
import _modDef6858 from "metro/06858__.js";
import _mod6860 from "metro/06860__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    obj = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod6860.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef6858, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
