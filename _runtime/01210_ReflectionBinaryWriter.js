// _runtime/01210_ReflectionBinaryWriter.js
    ...
    value: function message(tag, arg1, internalBinaryWrite, arg3, arg4) {
      if (undefined !== arg4) {
        internalBinaryWrite.internalBinaryWrite(
          arg4,
          tag.tag(arg3, ReflectionBinaryWriter(1192).WireType.LengthDelimited).fork(),
          arg1,
        );
        const joined = tag.join();
  ...
  },
  {
    ...
    value: function packed(tag, arg1, no, arg3) {
      ...
      if (arg3.length) {
        ...
        const self = this;
        obj.assert(
          arg1 !== ReflectionBinaryWriter(1201).ScalarType.BYTES &&
            arg1 !== ReflectionBinaryWriter(1201).ScalarType.STRING,
        );
