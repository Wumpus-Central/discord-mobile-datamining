// _runtime/07157_ViewHolderCollection.js
import ViewHolder from "07155_ViewHolder.js";
...
export const ViewHolderCollection = (data) => {
  ...
  closure_17 = data(7120).useRecyclerViewContext();
  const items = [width];
  extraData(() => {
    if (first > 0) {
      if (closure_17 != null) {
  ...
  obj2.children = size;
  return jsx(data(7151).CompatView, { style: tmp19, children: null });
};
