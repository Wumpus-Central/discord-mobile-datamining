      ...
      return {
        localeError: (code) => {
          ...
          switch (str) {
            ...
            break;
            case "TP":
              let expected2 = str[expected];
              if (expected2 == null) {
                expected2 = code.expected;
              }
              ...
              if (isMatch) {
                ...
                let combined1 = "\u7121\u52B9\u306A\u5165\u529B: instanceof " + code.expected + "\u304C\u671F\u5F85\u3055\u308C\u307E\u3057\u305F\u304C\u3001" + tmp49 + "\u304C\u5165\u529B\u3055\u308C\u307E\u3057\u305F";
              } else {
                let _HermesInternal16 = HermesInternal;
                combined1 = "\u7121\u52B9\u306A\u5165\u529B: " + expected2 + "\u304C\u671F\u5F85\u3055\u308C\u307E\u3057\u305F\u304C\u3001" + tmp49 + "\u304C\u5165\u529B\u3055\u308C\u307E\u3057\u305F";
              }
              return combined1;
            case "P":
              str = closure_2;
            ...
            case "pl":
              ...
              if (isMatch) {
                ...
                combined1 = "\u7121\u52B9\u306A\u5165\u529B: instanceof " + code.expected + "\u304C\u671F\u5F85\u3055\u308C\u307E\u3057\u305F\u304C\u3001" + tmp49 + "\u304C\u5165\u529B\u3055\u308C\u307E\u3057\u305F";
              } else {
