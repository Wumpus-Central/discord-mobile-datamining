// === Module 12593: createChildOrRootSpan ===
...
export const continueTrace = (arg0, arg1) => {
  const _require = arg1;
  const mainCarrier = _require(12577).getMainCarrier();
  const obj = _require(12577);
  const tmp = _require;
  const asyncContextStrategy = _require(12578).getAsyncContextStrategy(mainCarrier);
...
export const startNewTrace = function startNewTrace(arg0) {
  const _require = arg0;
  return _require(12586).withScope((setPropagationContext) => {
...
export const startSpanManual = function startSpanManual(experimental) {
  ...
  let obj = _require(12577);
  let mainCarrier = obj.getMainCarrier();
  let asyncContextStrategy = _require(12578).getAsyncContextStrategy(mainCarrier);
