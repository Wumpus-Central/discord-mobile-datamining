// _runtime/01208_ReflectionBinaryWriter.js
  ...
  },
  {
    ...
    value: function mapEntry(tag, arg1, no, match, arg4) {
      ...
      if (ReflectionBinaryWriter(1199).ScalarType.INT32 !== K) {
        if (ReflectionBinaryWriter(1199).ScalarType.FIXED32 !== K) {
          if (ReflectionBinaryWriter(1199).ScalarType.UINT32 !== K) {
            if (ReflectionBinaryWriter(1199).ScalarType.SFIXED32 !== K) {
              if (ReflectionBinaryWriter(1199).ScalarType.SINT32 !== K) {
                let parsed = match;
                if (ReflectionBinaryWriter(1199).ScalarType.BOOL === K) {
                  let tmp6 = "true" == match;
                  if (!tmp6) {
                    tmp6 = "false" == match;
                  }
                  ReflectionBinaryWriter(1195).assert(tmp6);
                  parsed = "true" == match;
                  const tmpResult = ReflectionBinaryWriter(1195);
                }
              }
              const self = this;
              const self2 = this;
              ...
              if ("scalar" === kind) {
                ...
                self.scalar(tag, ReflectionBinaryWriter(1199).ScalarType.INT32, 2, arg4, true);
    ...
    value: function message(tag, arg1, internalBinaryWrite, arg3, arg4) {
      if (undefined !== arg4) {
        internalBinaryWrite.internalBinaryWrite(
          arg4,
          tag.tag(arg3, ReflectionBinaryWriter(1190).WireType.LengthDelimited).fork(),
          arg1,
        );
        const joined = tag.join();
  ...
  },
  {
    ...
    value: function packed(tag, arg1, no, arg3) {
      ...
      if (arg3.length) {
        ...
        const self = this;
        obj.assert(
          arg1 !== ReflectionBinaryWriter(1199).ScalarType.BYTES &&
            arg1 !== ReflectionBinaryWriter(1199).ScalarType.STRING,
        );
  ...
  },
  {
    ...
    value: function scalarInfo(arg0, byteLength) {
      ...
      if (ReflectionBinaryWriter(1199).ScalarType.INT32 !== arg0) {
        if (ReflectionBinaryWriter(1199).ScalarType.STRING === arg0) {
          let tmp12 = tmp3;
          if (!tmp3) {
            tmp12 = !byteLength.length;
          }
          Bit64 = ReflectionBinaryWriter(1190).WireType.LengthDelimited;
          str = "string";
          tmp5 = tmp12;
        } else if (ReflectionBinaryWriter(1199).ScalarType.BOOL === arg0) {
          ...
          tmp5 = tmp4;
          Bit64 = Varint;
          if (ReflectionBinaryWriter(1199).ScalarType.UINT32 !== arg0) {
            if (ReflectionBinaryWriter(1199).ScalarType.DOUBLE === arg0) {
              Bit64 = ReflectionBinaryWriter(1190).WireType.Bit64;
              str = "double";
              tmp5 = tmp4;
            } else if (ReflectionBinaryWriter(1199).ScalarType.FLOAT === arg0) {
              Bit64 = ReflectionBinaryWriter(1190).WireType.Bit32;
              str = "float";
              tmp5 = tmp4;
            } else if (ReflectionBinaryWriter(1199).ScalarType.INT64 === arg0) {
              let isZeroResult = tmp3;
              if (!tmp3) {
                const PbLong3 = ReflectionBinaryWriter(1193).PbLong;
              ...
              tmp5 = isZeroResult;
              Bit64 = Varint;
            } else if (ReflectionBinaryWriter(1199).ScalarType.UINT64 === arg0) {
              let isZeroResult1 = tmp3;
              if (!tmp3) {
                const PbULong2 = ReflectionBinaryWriter(1193).PbULong;
              ...
              tmp5 = isZeroResult1;
              Bit64 = Varint;
            } else if (ReflectionBinaryWriter(1199).ScalarType.FIXED64 === arg0) {
              let isZeroResult2 = tmp3;
              if (!tmp3) {
                const PbULong = ReflectionBinaryWriter(1193).PbULong;
              ...
              str = "fixed64";
              tmp5 = isZeroResult2;
            } else if (ReflectionBinaryWriter(1199).ScalarType.BYTES === arg0) {
              let tmp8 = tmp3;
              if (!tmp3) {
              ...
              str = "bytes";
              tmp5 = tmp8;
            } else if (ReflectionBinaryWriter(1199).ScalarType.FIXED32 === arg0) {
              Bit64 = ReflectionBinaryWriter(1190).WireType.Bit32;
              str = "fixed32";
              tmp5 = tmp4;
            } else if (ReflectionBinaryWriter(1199).ScalarType.SFIXED32 === arg0) {
              Bit64 = ReflectionBinaryWriter(1190).WireType.Bit32;
              str = "sfixed32";
              tmp5 = tmp4;
            } else if (ReflectionBinaryWriter(1199).ScalarType.SFIXED64 === arg0) {
              let isZeroResult3 = tmp3;
              if (!tmp3) {
                const PbLong2 = ReflectionBinaryWriter(1193).PbLong;
              ...
              tmp5 = tmp4;
              Bit64 = Varint;
              if (ReflectionBinaryWriter(1199).ScalarType.SINT32 !== arg0) {
                tmp5 = tmp4;
                Bit64 = Varint;
                if (ReflectionBinaryWriter(1199).ScalarType.SINT64 === arg0) {
                  let isZeroResult4 = tmp3;
                  if (!tmp3) {
                    const PbLong = ReflectionBinaryWriter(1193).PbLong;
