// _runtime/04123_useRiveColor.js
import _slicedToArray from "_slicedToArray";
import { c } from "04105_c.js";
import { RiveColor } from "04113_RiveColor.js";
import { useRiveProperty } from "04118_useRiveProperty.js";
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(useRiveProperty.useRiveProperty(instance, FillColor, f29087), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
