// _runtime/01278_pushToArray.js
import _mod1275 from "metro/01275__.js";
import arrayToObject from "01277_arrayToObject.js";
import _mod1279 from "metro/01279__.js";
...
function stringify(
  ...
  if (undefined !== value4) {
    while (true) {
      ...
      let value6 = value4.get(closure_9);
      num2 = num3;
      if (undefined !== value6) {
        num = num3;
        value4 = value6;
...
export default (arg0, allowEmptyArrays) => {
  if (allowEmptyArrays) {
    ...
    if (undefined !== allowEmptyArrays.format) {
      ...
      const formatters = _mod1275.formatters;
    ...
    if (undefined === allowEmptyArrays.allowDots) {
      let allowDots = true === allowEmptyArrays.encodeDotInKeys || obj2.allowDots;
      const tmp15 = true === allowEmptyArrays.encodeDotInKeys || obj2.allowDots;
    } else {
      allowDots = allowEmptyArrays.allowDots;
    }
    obj = {
      addQueryPrefix:
        typeof allowEmptyArrays.addQueryPrefix === "boolean" ? allowEmptyArrays.addQueryPrefix : obj2.addQueryPrefix,
      allowDots,
    ...
    if (typeof allowEmptyArrays.allowEmptyArrays === "boolean") {
      ...
      allowEmptyArrays = obj2.allowEmptyArrays;
    }
    obj.allowEmptyArrays = allowEmptyArrays;
    obj.arrayFormat = arrayFormat;
    obj.charset = charset;
    obj.charsetSentinel =
      typeof allowEmptyArrays.charsetSentinel === "boolean" ? allowEmptyArrays.charsetSentinel : obj2.charsetSentinel;
    ...
    obj.encodeDotInKeys =
      typeof allowEmptyArrays.encodeDotInKeys === "boolean" ? allowEmptyArrays.encodeDotInKeys : obj2.encodeDotInKeys;
    obj.encoder = typeof allowEmptyArrays.encoder === "function" ? allowEmptyArrays.encoder : obj2.encoder;
    obj.encodeValuesOnly =
      typeof allowEmptyArrays.encodeValuesOnly === "boolean"
        ? allowEmptyArrays.encodeValuesOnly
        : obj2.encodeValuesOnly;
    obj.filter = filter;
    obj.format = format;
    obj.formatter = _mod1275.formatters[format];
    obj.serializeDate =
      typeof allowEmptyArrays.serializeDate === "function" ? allowEmptyArrays.serializeDate : obj2.serializeDate;
    ...
    if (typeof obj2.filter === "function") {
      let found = obj2.filter("", arg0);
    } else {
      found = arg0;
      if (isArray(obj2.filter)) {
        let filter1 = obj2.filter;
        found = arg0;
      }
    }
    if (typeof found === "object") {
      if (null !== found) {
        ...
        if (obj2.sort) {
          const sorted = filter1.sort(obj2.sort);
        }
        const items = [];
        ...
        const joined = items.join(obj2.delimiter);
        let str8 = "";
        let str9 = "";
        if (true === obj2.addQueryPrefix) {
          str9 = "?";
        }
        if (!obj2.charsetSentinel) {
          if (joined.length > 0) {
            str8 = str9 + joined;
          }
          return str8;
        } else if ("iso-8859-1" === obj2.charset) {
