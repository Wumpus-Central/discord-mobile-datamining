...
function instrumentReactRouter(f108154, arg1, arg2, location) {
  ...
  if (arg1) {
    if (location.location) {
      ...
      if (require("00889_feedbackAsyncIntegration.js").WINDOW.location) {
    ...
    if (pathname) {
      ...
      obj[0] = tmp5;
      obj = {};
      obj[require("00682_registerSpanErrorInstrumentation.js").SEMANTIC_ATTRIBUTE_SENTRY_OP] = "pageload";
      let _HermesInternal = HermesInternal;
      obj[require("00682_registerSpanErrorInstrumentation.js").SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = "auto.pageload.react." + arg4;
      obj[require("00682_registerSpanErrorInstrumentation.js").SEMANTIC_ATTRIBUTE_SENTRY_SOURCE] = tmp6;
      obj[1] = obj;
...
export const withSentryRouting = function withSentryRouting(displayName) {
  ...
  require("01005_getStatics.js").hoistNonReactStatics(WrappedRoute, displayName);
  return WrappedRoute;
};