// _runtime/14116___exportStarResult21.js
...
arg5.FormatNumericToString = function FormatNumericToString(roundingType, timesResult) {
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      let ToRawPrecisionResult = tmp5(14118).ToRawPrecision(
        ZERO,
      ...
      ToRawPrecisionResult = tmp5(14119).ToRawFixed(
        ZERO,
      ...
      const ToRawPrecisionResult1 = tmp5(14118).ToRawPrecision(
        ZERO,
        roundingType.minimumSignificantDigits,
        roundingType.maximumSignificantDigits,
        result,
      );
      let ToRawFixedResult = tmp5(14119).ToRawFixed(
        ZERO,
        roundingType.minimumFractionDigits,
        roundingType.maximumFractionDigits,
        roundingType.roundingIncrement,
