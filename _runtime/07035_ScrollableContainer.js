// _runtime/07035_ScrollableContainer.js
import BottomSheetDraggableScrollable from "07036_BottomSheetDraggableScrollable.js";
import _modDef7037 from "metro/07037__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod7039.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef7037, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
