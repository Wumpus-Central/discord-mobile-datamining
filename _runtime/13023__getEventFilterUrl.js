// _runtime/13023__getEventFilterUrl.js
...
import setupIntegration from "metro/13004__.js";
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod12976.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + _mod12959.getEventDescription(tmp));
      const tmp6Result = _mod12959;
    }
    return null;
  }
}
        ...
        if (_mod12976.DEBUG_BUILD) {
          ...
          logger5.warn(
            "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " +
              _mod12959.getEventDescription(type),
          );
          flag6 = true;
        }
      } else {
