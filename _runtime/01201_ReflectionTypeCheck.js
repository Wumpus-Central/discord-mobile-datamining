// _runtime/01201_ReflectionTypeCheck.js
  ...
  },
  {
    ...
    value: function scalar(flag, arg1, arg2) {
      if (ReflectionTypeCheck(1199).ScalarType.UINT64 !== arg1) {
        if (ReflectionTypeCheck(1199).ScalarType.FIXED64 !== arg1) {
          if (ReflectionTypeCheck(1199).ScalarType.INT64 !== arg1) {
            if (ReflectionTypeCheck(1199).ScalarType.SFIXED64 !== arg1) {
              if (ReflectionTypeCheck(1199).ScalarType.SINT64 !== arg1) {
                if (ReflectionTypeCheck(1199).ScalarType.BOOL === arg1) {
                  return typeof flag === "boolean";
                } else if (ReflectionTypeCheck(1199).ScalarType.STRING === arg1) {
                  return typeof flag === "string";
                } else if (ReflectionTypeCheck(1199).ScalarType.BYTES === arg1) {
                  const _Uint8Array = Uint8Array;
                  return flag instanceof Uint8Array;
                } else {
                  if (ReflectionTypeCheck(1199).ScalarType.DOUBLE !== arg1) {
                    if (ReflectionTypeCheck(1199).ScalarType.FLOAT !== arg1) {
      ...
      } else if (ReflectionTypeCheck(1199).LongType.NUMBER === arg2) {
  ...
  },
  {
    ...
    value: function mapKeys(arg0, INT32, arg2) {
      ...
      if (ReflectionTypeCheck(1199).ScalarType.INT32 !== INT32) {
        if (ReflectionTypeCheck(1199).ScalarType.FIXED32 !== INT32) {
          if (ReflectionTypeCheck(1199).ScalarType.SFIXED32 !== INT32) {
            if (ReflectionTypeCheck(1199).ScalarType.SINT32 !== INT32) {
              if (ReflectionTypeCheck(1199).ScalarType.UINT32 !== INT32) {
                if (ReflectionTypeCheck(1199).ScalarType.BOOL === INT32) {
                  ...
                  return self.scalars(keys, INT32, arg2, ReflectionTypeCheck(1199).LongType.STRING);
                }
              }
            }
          }
