// _runtime/05711_HeaderBackButton.js
import Link from "01484_Link.js";
import _modDef5683 from "metro/05683__.js";
import HeaderIcon from "05712_HeaderIcon.js";
import HeaderButton from "05717_HeaderButton.js";
...
obj = { flexDirection: "row", alignItems: "flex-start", marginEnd: fn(5712).ICON_MARGIN };
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1 = { source: _modDef5683, tintColor, style: null };
