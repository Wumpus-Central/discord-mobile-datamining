// _runtime/07888_appendTransformProps.js
import { append } from "07889_append.js";
import { peg$SyntaxError } from "07890_peg_SyntaxError.js";
import { peg$SyntaxError } from "07891_peg_SyntaxError.js";
const require = arg1;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(7890);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(7889);
