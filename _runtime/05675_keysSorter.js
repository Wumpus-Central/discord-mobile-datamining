...
export const parse = (str, arg1) => {
  _require = undefined;
  const arrayFormat = require("module_5677")({ arrayFormat: "none" }, arg1).arrayFormat;
...
export const stringify = (arg0, arg1) => {
  _require = arg0;
  const tmp = require("module_5677")({ encode: true, strict: true, arrayFormat: "none" }, arg1);
  dependencyMap = tmp;
  closure_129_0 = tmp;
