// _runtime/10039_XorAndSalsa.js
import _asyncLoop from "10040__asyncLoop.js";
import number from "10041_number.js";
import pbkdf2Init from "10043_pbkdf2Init.js";
import _mod10045 from "metro/10045__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod10045.sha256, B, B, obj2);
