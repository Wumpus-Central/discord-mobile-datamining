// _runtime/01145_computeLocationKey.js
import registerSpanErrorInstrumentation from "00814_registerSpanErrorInstrumentation.js";
import __SENTRY_DEBUG__ from "metro/01139___SENTRY_DEBUG__.js";
import pickSplat from "01146_pickSplat.js";
...
function setupRouterSubscription(subscribe) {
  ...
  let tmp = arg4;
  if (tmp) {
    tmp = "pageload" === require("00814_registerSpanErrorInstrumentation.js").spanToJSON(arg4).op;
...
function patchSpanEnd(result2, _location, routes, basename, allRoutes, navigation) {
  ...
  if (!tmp2) {
    if (result2.end) {
      ...
      const result = require("00814_registerSpanErrorInstrumentation.js").addNonEnumerableProperty(result2, combined, true);
      let obj = registerSpanErrorInstrumentation;
    }
  }
}
...
export const createV6CompatibleWithSentryReactRouterRouting = function createV6CompatibleWithSentryReactRouterRouting(arg0, _6) {
      ...
      if (closure_6) {
        if (closure_7) {
          if (closure_8) {
            ...
            require("01137_getStatics.js").hoistNonReactStatics(SentryRoutes, arg0);
            return SentryRoutes;
          }
        }
      }
  ...
  if (require("metro/01139___SENTRY_DEBUG__.js").DEBUG_BUILD) {
    class SentryRoutes {
      constructor(arg0) {
        closure_0 = arg0;
        closure_1 = closure_1_9.useRef(true);
...
export const createV6CompatibleWrapCreateBrowserRouter = function createV6CompatibleWrapCreateBrowserRouter(arg0, _6) {
  ...
  fn = arg0;
  if (require("metro/01139___SENTRY_DEBUG__.js").DEBUG_BUILD) {
    const debug = require("00814_registerSpanErrorInstrumentation.js").debug;
    const _HermesInternal = HermesInternal;
