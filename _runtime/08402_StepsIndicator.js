// _runtime/08402_StepsIndicator.js
import _mod8400 from "metro/08400__.js";
import _mod8401 from "metro/08401__.js";
import SliderTrackMark from "08403_SliderTrackMark.js";
import StepNumber from "08404_StepNumber.js";
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo = currentValue.useMemo(() => {
    if (options.length > 9) {
      ...
      fontSize = _mod8400.constants.STEP_NUMBER_TEXT_FONT_BIG;
    }
    return { fontSize };
  }, items);
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      let stepsIndicator = _mod8401.styles.stepsIndicator;
      let tmp6 = require;
    } else {
