...
function measureFabric(arg0) {
  if (globalThis._WORKLET) {
    const tmp3 = arg0();
    if (-1 === tmp3) {
      const logger4 = require("01610_addLogBoxLog.js") /* addLogBoxLog */.logger;
      ...
      if (null === _measureFabricResult) {
        const logger3 = require("01610_addLogBoxLog.js") /* addLogBoxLog */.logger;
        ...
        const logger2 = require("01610_addLogBoxLog.js") /* addLogBoxLog */.logger;
