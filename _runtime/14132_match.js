// _runtime/14132_match.js
import { ResolveLocale } from "14133_ResolveLocale.js";
import { LookupSupportedLocales } from "14145_LookupSupportedLocales.js";
const require = arg1;
...
arg5.match = function match(arg0, arg1, arg2, algorithm) {
  const _require = arg2;
  const result = require("14144_CanonicalizeLocaleList.js").CanonicalizeLocaleList(arg0);
  let str;
  if (null != algorithm) {
  ...
  return require("14133_ResolveLocale.js").ResolveLocale(arg1, result, { localeMatcher: str }, [], {}, () => closure_0)
    .locale;
};
let obj = {
  enumerable: true,
