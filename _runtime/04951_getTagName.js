// _runtime/04951_getTagName.js
import _slicedToArray from "_slicedToArray";
import { getDataView } from "04912_getDataView.js";
import { 04929__ } from "metro/04929__.js";
  ...
  read(arg0, arg1) {
    ...
    if (0 < arg0.length) {
      ...
      if (stringFromDataView === c4) {
        ...
        if (tmp10(4952)[shortAt]) {
          try {
            obj.description = tmp10(4952)[shortAt].description(dataView1);
            if (!name) {
              name = tmp10(4952)[shortAt].name;
            }
            obj[name] = obj;
            const obj6 = tmp10(4952)[shortAt];
          } catch (err) {
