// _runtime/05879_HeaderBackButton.js
import Link from "01485_Link.js";
import _modDef5851 from "metro/05851__.js";
import HeaderIcon from "05880_HeaderIcon.js";
import HeaderButton from "05885_HeaderButton.js";
...
let obj = {
  ...
  labelWrapper: { flexDirection: "row", alignItems: "flex-start", marginEnd: fn(5880).ICON_MARGIN },
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    const obj5 = { source: _modDef5851, tintColor, style: null };
