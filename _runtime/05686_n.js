// _runtime/05686_n.js
import _mod5642 from "metro/05642__.js";
...
export const useReanimatedEventHandler = function useReanimatedEventHandler(handlerTag, memoizedGestureCallbacks, handler, changeEventCalculator, fillInDefaultValues) {
  ...
  fn.__closure = { lastUpdateEventMap: mutable, eventHandler: require("05685_handleStateChangeEvent.js").eventHandler, handlerTag, workletizedHandlers: tmp, changeEventCalculator, fillInDefaultValues };
  ...
  let Reanimated = require("metro/05642__.js").Reanimated;
  let event;
  if (Reanimated != null) {
