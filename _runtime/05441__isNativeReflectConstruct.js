// _runtime/05441__isNativeReflectConstruct.js
...
class Swipeable {
  constructor(arg0) {
    ...
    obj = { dragX: value, rowTranslation: null, rowState: 0, leftWidth: "call", rightOffset: "backgroundColor", rowWidth: "y" };
...
let items = [
  obj,
  {
    ...
    value: function render() {
      ...
      items8[2] = callback3(self(5386).TapGestureHandler, obj8);
      obj7[2] = items8;
      obj6.children = callback4(RN.View, obj7);
      return callback3(self(5398).PanGestureHandler, obj6);
    }
  }
];
