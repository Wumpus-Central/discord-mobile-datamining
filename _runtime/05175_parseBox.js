// _runtime/05175_parseBox.js
import getDataView from "05166_getDataView.js";
import parseItemLocationBox from "05176_parseItemLocationBox.js";
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5166).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5166);
            }
          }
        }
      } else {
