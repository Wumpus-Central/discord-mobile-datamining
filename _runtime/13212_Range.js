...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("module_13184")(require);
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13185).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13185).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13186)("hyphen replace", str);
        let str3 = str.replace(tmp11(13187).safeRe[tmp11(undefined, 13187).t.COMPARATORTRIM], tmp11(13187).comparatorTrimReplace);
        tmp11(13186)("comparator trim", str3);
        let str5 = str3.replace(tmp11(13187).safeRe[tmp11(undefined, 13187).t.TILDETRIM], tmp11(13187).tildeTrimReplace);
        tmp11(13186)("tilde trim", str5);
        const str7 = str5.replace(tmp11(13187).safeRe[tmp11(undefined, 13187).t.CARETTRIM], tmp11(13187).caretTrimReplace);
        tmp11(13186)("caret trim", str7);
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13183)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
    ...
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          ...
          let tmp5 = Range(13186)(arg0[num2].semver);
          let tmp6 = num2;
          if (arg0[num2].semver !== Range(13211).ANY) {
