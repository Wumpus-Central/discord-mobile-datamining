// _runtime/14100___exportStarResult21.js
import getMultiInternalSlots from "14084_getMultiInternalSlots.js";
import TEN from "14086_TEN.js";
...
arg5.FormatNumericToString = function FormatNumericToString(roundingType, timesResult) {
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      let ToRawPrecisionResult = tmp5(14102).ToRawPrecision(
        ZERO,
      ...
      ToRawPrecisionResult = tmp5(14103).ToRawFixed(
        ZERO,
      ...
      const ToRawPrecisionResult1 = tmp5(14102).ToRawPrecision(
        ZERO,
        roundingType.minimumSignificantDigits,
        roundingType.maximumSignificantDigits,
        result,
      );
      let ToRawFixedResult = tmp5(14103).ToRawFixed(
        ZERO,
        roundingType.minimumFractionDigits,
        roundingType.maximumFractionDigits,
        roundingType.roundingIncrement,
