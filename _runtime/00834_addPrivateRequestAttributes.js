// _runtime/00834_addPrivateRequestAttributes.js
import getSpanStatusFromHttpCode from "00705_getSpanStatusFromHttpCode.js";
import captureCheckIn from "00734_captureCheckIn.js";
import _mod823 from "metro/00823__.js";
import handleResponseError from "00835_handleResponseError.js";
                        ...
                        if (!BooleanResult) {
                          if (!tmp12) {
                            ...
                            return tmp2Result.startSpan(obj, (setAttributes) => {
                              ...
                              return str(dependencyMap[9]).handleCallbackErrors(() => { ... }, () => { ... }, /* F120238 */ function() { ... }, () => { ... });
                            });
                          }
                        }
                        dependencyMap = closure_0;
