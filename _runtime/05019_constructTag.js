// _runtime/05019_constructTag.js
import { getDataView } from "04972_getDataView.js";
import { 04979__ } from "metro/04979__.js";
const require = arg1;
const module = arg2;
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== 04979__.TYPE_TEXT) {
    combined = stringValueFromArray;
    if (0 !== items2.length) {
      const _HermesInternal = HermesInternal;
      combined = "" + stringValueFromArray + " (" + tmp4(4972).getStringValueFromArray(items2) + ")";
      const tmp4Result = tmp4(4972);
    }
  }
  obj = { name: combined, value: stringFromDataView, description: null };
  if (type === 04979__.TYPE_ITXT) {
    stringFromDataView = module(5005).decode("UTF-8", decompressResult);
    const obj5 = module(5005);
  }
