...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("metro/14000__.js");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13996).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13996).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(13999).parseUrlencoded(query);
          const tmpResult = tmp(13999);
        }
      }
      const obj = URLImpl(13996);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(13996).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13996).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13996);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13996).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13996);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13996).serializeHost(host);
        const obj3 = URLImpl(13996);
      } else {
        const obj = URLImpl(13996);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13996).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13996);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13996).serializeHost(tmp._url.host);
        const obj = URLImpl(13996);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13996).serializeInteger(tmp._url.port);
        const obj = URLImpl(13996);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(13996).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(13996);
        }
      }
    }
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        self._query._list = URLImpl(13999).parseUrlencoded(substr);
      }
    }
  },
  {
