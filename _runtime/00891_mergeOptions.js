...
function Form(onSubmitError) {
  ...
  f107846 = screenshotInput(function*(arg0) {
    if (c6 === 2) {
      c6 = 3;
  ...
  c46 = 8;
  obj = { class: "form", onSubmit: fn2(() => f71280, items1) };
...
function Dialog(onFormSubmitted) {
  ...
  const tmp2 = fn2(() => {
    obj = { __html: null };
    const _document = f71280(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document2 = f71280(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document3 = f71280(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document4 = f71280(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document5 = f71280(merged[2]).GLOBAL_OBJ.document;
    const elementNS4 = _document5.createElementNS("http://www.w3.org/2000/svg", "defs");
    const _document6 = f71280(merged[2]).GLOBAL_OBJ.document;
    ...
    const _document7 = f71280(merged[2]).GLOBAL_OBJ.document;
