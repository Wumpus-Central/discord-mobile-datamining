...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  let currentScope = require("07624_getClient.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = getClient;
  let client = require("07624_getClient.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = getClient;
  captureCheckInResult = require("07608_addContextToFrame.js").uuid4();
};