// _runtime/07170_ScrollableContainer.js
import BottomSheetDraggableScrollable from "07171_BottomSheetDraggableScrollable.js";
import _modDef7172 from "metro/07172__.js";
import _mod7174 from "metro/07174__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod7174.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef7172, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
