// _runtime/08502__isNativeReflectConstruct.js
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [
      callback3(FeDropShadow(8503), { in: str, stdDeviation: props.stdDeviation }),
      callback3(FeDropShadow(8505), { dx, dy, result: "offsetblur" }),
      ,
      ,
    ];
