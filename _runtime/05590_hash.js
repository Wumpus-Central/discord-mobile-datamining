// _runtime/05590_hash.js
import _mod5576 from "metro/05576__.js";
import items2 from "05591_items2.js";
...
function maybeUnpackValue(enabled) {
  const Reanimated = _mod5576.Reanimated;
...
maybeUnpackValue.__closure = { Reanimated: require("metro/05576__.js").Reanimated };
...
function getEnabledSharedValues(Reanimated) {
  if (undefined === _mod5576.Reanimated) {
    return [];
  } else {
    if (tmpResult.isComposedGesture(Reanimated)) {
      ...
      Reanimated = tmp(5576).Reanimated;
...
export const bindSharedValues = function bindSharedValues(closure_1, closure_2) {
  ...
  if (undefined !== require("metro/05576__.js").Reanimated) {
    ...
    while (tmp27 !== undefined) {
      ...
      let Reanimated = require("metro/05576__.js").Reanimated;
      if (Reanimated.isSharedValue(tmp7)) {
        let tmp13 = tmp9;
        let tmp14 = tmp11;
        let Reanimated2 = tmp10(5576).Reanimated;
        let tmp15 = tmp7;
        let tmp16 = tmp6;
...
export const unbindSharedValues = function unbindSharedValues(closure_1, closure_2) {
  if (undefined !== require("metro/05576__.js").Reanimated) {
    ...
    function _loop(iter) {
      const callback = iter;
      const Reanimated = callback(5576).Reanimated;
      if (Reanimated.isSharedValue(iter)) {
        ...
        dependencyMap = sum;
        const Reanimated2 = callback(5576).Reanimated;
        const fn = function t() {
