    ...
    value: function update(str) {
      ...
      if (0 === encodeResult.length) {
        ...
        if (_classPrivateFieldBase(self, closure_16)[closure_16] + length < 32) {
          ...
          const result = obj3.set(encodeResult.subarray(0, length), _classPrivateFieldBase(self, closure_16)[closure_16]);
          ...
          if (_classPrivateFieldBase(self, closure_16)[closure_16] > 0) {
            ...
            const result1 = obj.set(encodeResult.subarray(0, 32 - _classPrivateFieldBase(self, closure_16)[closure_16]), _classPrivateFieldBase(self, closure_16)[closure_16]);
            ...
            _classPrivateFieldBase(self, closure_10)[closure_10] = BigInt.asUintN(64, (asUintNResult << 31n & closure_7 | asUintNResult >> diff) * c2);
            ...
            const asUintNResult1 = BigInt.asUintN(64, _classPrivateFieldBase(self, closure_11)[closure_11] + tmp36 * c3);
            const _BigInt20 = BigInt;
            _classPrivateFieldBase(self, closure_11)[closure_11] = BigInt.asUintN(64, (asUintNResult1 << 31n & closure_7 | asUintNResult1 >> diff) * c2);
            ...
            const asUintNResult2 = BigInt.asUintN(64, _classPrivateFieldBase(self, closure_12)[closure_12] + tmp47 * c3);
            const _BigInt30 = BigInt;
            _classPrivateFieldBase(self, closure_12)[closure_12] = BigInt.asUintN(64, (asUintNResult2 << 31n & closure_7 | asUintNResult2 >> diff) * c2);
            ...
            const asUintNResult3 = BigInt.asUintN(64, _classPrivateFieldBase(self, closure_13)[closure_13] + tmp58 * c3);
            const _BigInt40 = BigInt;
            _classPrivateFieldBase(self, closure_13)[closure_13] = BigInt.asUintN(64, (asUintNResult3 << 31n & closure_7 | asUintNResult3 >> diff) * c2);
