...
const entry = {
  ...
  value: function reset() {
    ...
    _classPrivateFieldBase(self, closure_13)[closure_13] = BigInt.asUintN(
      64,
      _classPrivateFieldBase(self, closure_9)[closure_9] - c2,
    );
    ...
    value: function update(str) {
      ...
      if (0 === encodeResult.length) {
        ...
        if (0 === _classPrivateFieldBase(self, closure_16)[closure_16]) {
          ...
          _classPrivateFieldBase(self, closure_14)[closure_14] = uint8Array;
          const tmp128Result = _classPrivateFieldBase(self, closure_14);
        }
        if (_classPrivateFieldBase(self, closure_16)[closure_16] + length < 32) {
          ...
          const tmp128Result6 = _classPrivateFieldBase(self, closure_16);
          tmp128Result6[closure_16] = tmp128Result6[closure_16] + length;
          return self;
        } else {
          let num4 = 0;
          if (_classPrivateFieldBase(self, closure_16)[closure_16] > 0) {
            ...
            const tmp17 =
              BigInt(tmp12[0]) | (BigInt(tmp12[1]) << 8n) | (BigInt(tmp12[2]) << 16n) | (BigInt(tmp12[3]) << 24n);
            const bigint5 = 40n;
            ...
            const tmp128Result7 = _classPrivateFieldBase(self, closure_10);
            ...
            const tmp32 =
              BigInt(memory[8]) | (BigInt(memory[9]) << 8n) | (BigInt(memory[10]) << 16n) | (BigInt(memory[11]) << 24n);
            const _BigInt17 = BigInt;
            const tmp33 =
              BigInt(memory[8]) |
              (BigInt(memory[9]) << 8n) |
              (BigInt(memory[10]) << 16n) |
              (BigInt(memory[11]) << 24n) |
              (BigInt(memory[12]) << 32n);
            ...
            const tmp128Result8 = _classPrivateFieldBase(self, closure_11);
            ...
            const tmp43 =
              BigInt(memory2[16]) |
              (BigInt(memory2[17]) << 8n) |
              (BigInt(memory2[18]) << 16n) |
              (BigInt(memory2[19]) << 24n);
            ...
            const tmp128Result9 = _classPrivateFieldBase(self, closure_12);
            ...
            const tmp54 =
              BigInt(memory3[24]) |
              (BigInt(memory3[25]) << 8n) |
              (BigInt(memory3[26]) << 16n) |
              (BigInt(memory3[27]) << 24n);
            ...
            _classPrivateFieldBase(self, closure_16)[closure_16] = 0;
            const tmp128Result10 = _classPrivateFieldBase(self, closure_13);
          }
          const diff1 = tmp - 32;
          const bigint10 = 8n;
          const bigint11 = 16n;
          ...
          if (num4 <= diff1) {
            do {
              ...
              let asUintNResult4 = BigInt.asUintN(
                64,
                _classPrivateFieldBase(self, closure_10)[closure_10] + tmp75 * c3,
              );
              let _BigInt50 = BigInt;
              tmp78[closure_10] = BigInt.asUintN(
                64,
                (((asUintNResult4 << 31n) & closure_7) | (asUintNResult4 >> diff2)) * c2,
              );
              let sum = sum3 + 8;
              ...
              let asUintNResult5 = BigInt.asUintN(
                64,
                _classPrivateFieldBase(self, closure_11)[closure_11] + tmp91 * c3,
              );
              let _BigInt60 = BigInt;
              tmp93[closure_11] = BigInt.asUintN(
                64,
                (((asUintNResult5 << 31n) & closure_7) | (asUintNResult5 >> diff2)) * c2,
              );
              let sum1 = sum + 8;
              ...
              let asUintNResult6 = BigInt.asUintN(
                64,
                _classPrivateFieldBase(self, closure_12)[closure_12] + tmp103 * c3,
              );
              let _BigInt70 = BigInt;
              tmp105[closure_12] = BigInt.asUintN(
                64,
                (((asUintNResult6 << 31n) & closure_7) | (asUintNResult6 >> diff2)) * c2,
              );
              let sum2 = sum1 + 8;
              ...
              let asUintNResult7 = BigInt.asUintN(
                64,
                _classPrivateFieldBase(self, closure_13)[closure_13] + tmp115 * c3,
              );
              let _BigInt80 = BigInt;
              tmp117[closure_13] = BigInt.asUintN(
                64,
                (((asUintNResult7 << 31n) & closure_7) | (asUintNResult7 >> diff2)) * c2,
              );
              sum3 = sum2 + 8;
  ...
  },
  {
    ...
    value: function digest() {
      ...
      if (_classPrivateFieldBase(this, closure_15)[closure_15] >= 32) {
        ...
        const asUintNResult1 = BigInt.asUintN(
          64,
          BigInt.asUintN(64, sum2 ^ ((((asUintNResult << 31n) & closure_7) | (asUintNResult >> diff)) * c2)) * c2 + c5,
        );
        ...
        const asUintNResult3 = BigInt.asUintN(
          ...
          BigInt.asUintN(
            ...
            BigInt.asUintN(
              64,
              BigInt.asUintN(64, sum2 ^ ((((asUintNResult << 31n) & closure_7) | (asUintNResult >> diff)) * c2)) * c2 +
                c5,
            ) ^
              ((((asUintNResult2 << 31n) & closure_7) | (asUintNResult2 >> diff)) * c2),
          ) *
                ...
                BigInt.asUintN(
                  ...
                  BigInt.asUintN(
                    ...
                    BigInt.asUintN(
                      ...
                      BigInt.asUintN(
                        64,
                        sum2 ^ ((((asUintNResult << 31n) & closure_7) | (asUintNResult >> diff)) * c2),
                      ) *
                        c2 +
                        c5,
                    ) ^
                  ...
                  ((((asUintNResult4 << 31n) & closure_7) | (asUintNResult4 >> diff)) * c2),
              ) *
                c2 +
                c5,
            ) ^
              ((((asUintNResult6 << 31n) & closure_7) | (asUintNResult6 >> diff)) * c2),
          ) *
            c2 +
            c5,
        );
        const asUintNResult5 = BigInt.asUintN(
          64,
          BigInt.asUintN(
            64,
            BigInt.asUintN(
              ...
              BigInt.asUintN(
                ...
                BigInt.asUintN(
                  64,
                  BigInt.asUintN(64, sum2 ^ ((((asUintNResult << 31n) & closure_7) | (asUintNResult >> diff)) * c2)) *
                    c2 +
                    c5,
                ) ^
                  ((((asUintNResult2 << 31n) & closure_7) | (asUintNResult2 >> diff)) * c2),
      ...
      if (0 <= tmp3 - 8) {
        do {
          ...
          let tmp49 =
            sum3 ^ BigInt.asUintN(64, (((asUintNResult8 << 31n) & closure_7) | (asUintNResult8 >> tmp35)) * c2);
      ...
      if (sum4 <= tmp3) {
        ...
        const _BigInt34 = BigInt;
        const tmp70 =
          BigInt((tmp2[num4 + 1] << 8) | tmp2[num4]) | (BigInt((tmp2[num4 + 3] << 8) | tmp2[num4 + 2]) << 16n);
        const _BigInt35 = BigInt;
        const tmp73 =
          tmp37 ^
          BigInt.asUintN(
            64,
            (BigInt((tmp2[num4 + 1] << 8) | tmp2[num4]) |
              (BigInt((tmp2[num4 + 3] << 8) | tmp2[num4 + 2]) << 16n) |
              (BigInt(0) << 32n) |
              (BigInt(0) << 48n)) *
              c2,
          );
