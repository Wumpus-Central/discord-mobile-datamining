// _runtime/07726_createTransport.js
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(7707).envelopeItemTypeToDataCategory(arg1);
        const obj = items(7707);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: items(7707).serializeEnvelope(dependencyMap) };
          const obj2 = items(7707);
          ...
          if (arg0 instanceof items(7720).SentryError) {
