// _runtime/13686___exportStarResult10.js
import __exportStarResult7 from "13683___exportStarResult7.js";
...
arg5.IsWellFormedUnitIdentifier = function IsWellFormedUnitIdentifier(GetOptionResult3) {
  ...
  if (__exportStarResult7.IsSanctionedSimpleUnitIdentifier(str)) {
    ...
    if (2 !== parts.length) {
      ...
      [tmp3, tmp4] = parts;
      if (tmp(13683).IsSanctionedSimpleUnitIdentifier(tmp3)) {
        if (tmp(13683).IsSanctionedSimpleUnitIdentifier(tmp4)) {
          return true;
        }
      }
      return false;
