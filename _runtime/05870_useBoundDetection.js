// _runtime/05870_useBoundDetection.js
...
export const useBoundDetection = function useBoundDetection(recyclerViewManager, arg1) {
  ...
  const _requestAnimationFrame = require("05867_useUnmountAwareTimeout.js").useUnmountAwareAnimationFrame().requestAnimationFrame;
  let num = 0;
