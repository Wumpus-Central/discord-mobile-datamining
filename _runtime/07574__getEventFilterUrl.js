// _runtime/07574__getEventFilterUrl.js
import setupIntegration from "setupIntegration";
import { __SENTRY_DEBUG__ } from "metro/07527___SENTRY_DEBUG__.js";
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      const logger = tmp6(7499).logger;
      const _HermesInternal = HermesInternal;
      logger.error("Cannot extract url for event " + tmp6(7510).getEventDescription(tmp));
      const tmp6Result = tmp6(7510);
    }
    return null;
  }
}
