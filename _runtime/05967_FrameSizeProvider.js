// _runtime/05967_FrameSizeProvider.js
import _modDef1507 from "metro/01507__.js";
import _mod5969 from "metro/05969__.js";
...
const __react_navigation__elements_contexts = fn(5968);
...
export const FrameSizeProvider = function FrameSizeProvider(initialFrame) {
  ...
  noop.useRef(size);
  noop.useRef(new Set());
  let tmp2 = _modDef1507(() => ref.current);
