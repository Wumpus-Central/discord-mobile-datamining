// _runtime/12600_isFullFinishedSpan.js
...
class SentrySpan {
  constructor() {
    ...
    obj[require("metro/12574__.js").SEMANTIC_ATTRIBUTE_SENTRY_OP] = obj.op;
  ...
  },
  {
    ...
    value: function getSpanJSON() {
      ...
      obj = {
        ...
        op: this._attributes[SentrySpan(undefined, 12574).SEMANTIC_ATTRIBUTE_SENTRY_OP],
        parent_span_id: this._parentSpanId,
        span_id: this._spanId,
        start_timestamp: this._startTime,
        status: SentrySpan(12564).getStatusMessage(this._status),
        timestamp: null,
        trace_id: null,
        origin: _attributes[SentrySpan(undefined, 12574).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN],
