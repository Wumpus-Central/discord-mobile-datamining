// _runtime/13086_items.js
import { SemVer } from "13058_SemVer.js";
import { Comparator } from "13072_Comparator.js";
import { Range } from "13073_Range.js";
import { Range } from "13075_Range.js";
    ...
    if (1 === arg0.length) {
      ...
      if (arg0[0].semver === Comparator.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(13072).ANY) {
            return true;
          }
        }
      }
