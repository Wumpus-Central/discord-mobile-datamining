// _runtime/05963_HeaderBackButton.js
import Link from "01485_Link.js";
import _modDef5935 from "metro/05935__.js";
import HeaderIcon from "05964_HeaderIcon.js";
import HeaderButton from "05969_HeaderButton.js";
...
let obj = {
  ...
  labelWrapper: { flexDirection: "row", alignItems: "flex-start", marginEnd: fn(5964).ICON_MARGIN },
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    const obj5 = { source: _modDef5935, tintColor, style: null };
