// === Module 5963: HeaderBackButton ===

// Module 5963 (HeaderBackButton)
import Link from "Link" /* 1485 */;
import _modDef5935 from "module_5935" /* 5935 */;
import HeaderIcon from "HeaderIcon" /* 5964 */;
import HeaderButton from "HeaderButton" /* 5969 */;
...
let c9 = 24;
let obj = { container: { paddingHorizontal: 0, minWidth: StyleSheet.hairlineWidth, marginVertical: 3, marginHorizontal: 11 }, label: { fontSize: 17, letterSpacing: 0.35 }, labelWrapper: { flexDirection: "row", alignItems: "flex-start", marginEnd: fn(5964).ICON_MARGIN }, icon: { width: 24, marginEnd: 3 }, iconWithLabel: {}, iconMaskContainer: { flex: 1, flexDirection: "row", justifyContent: "center" }, iconMaskFillerRect: { flex: 1, backgroundColor: "#000" }, iconMask: { height: 21, width: 13, marginStart: -14.5, marginVertical: 12, alignSelf: "center" }, flip: { transform: "scaleX(-1)" } };
