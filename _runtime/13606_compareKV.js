...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants.length) {
      ...
      obj[1] = items;
      const str = 13607__.languageAlias[require(undefined, 13605) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      while (!str) {
        num3 = num3 + 1;
        tmp = lang;
      }
      obj = { lang: null, script: null, region: null, variants: null };
      const result = tmp2(13608).parseUnicodeLanguageId(str.split(tmp2(13608).SEPARATOR));
      obj[0] = result.lang;
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      obj[3] = [];
      const str2 = 13607__.languageAlias[require(undefined, 13605) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj)];
      tmp9 = tmp;
      if (str2) {
        const obj1 = { lang: null, script: null, region: null, variants: null };
        const result1 = tmp10(13608).parseUnicodeLanguageId(str2.split(tmp10(13608).SEPARATOR));
  ...
  if (tmp9.region) {
    ...
    obj2[2] = [];
    const str3 = 13607__.languageAlias[require(undefined, 13605) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj2)];
    tmp13 = tmp9;
    if (str3) {
      const obj3 = { lang: null, script: null, region: null, variants: null };
      const result2 = tmp14(13608).parseUnicodeLanguageId(str3.split(tmp14(13608).SEPARATOR));
      obj3[0] = result2.lang;
  ...
  const str4 = 13607__.languageAlias[require(undefined, 13605) /* emitUnicodeLanguageId */.emitUnicodeLanguageId(undefined, obj4)];
  let tmp19 = tmp13;
  if (str4) {
    const obj5 = { lang: null, script: null, region: null, variants: null };
    const result3 = tmp17(13608).parseUnicodeLanguageId(str4.split(tmp17(13608).SEPARATOR));
    obj5[0] = result3.lang;
  ...
  if (tmp19.region) {
    ...
    const str6 = tmp17(13607).territoryAlias[formatted];
    let tmp22;
    if (str6) {
      ...
      obj6[2] = [];
      const str8 = tmp17(13609).likelySubtags[tmp17(undefined, 13605).emitUnicodeLanguageId(undefined, obj6)];
      tmp22 = first;
      if (str8) {
        const region = tmp17(13608).parseUnicodeLanguageId(str8.split(tmp17(13608).SEPARATOR)).region;
        let tmp24 = region;
        if (region) {
  ...
  if (tmp19.script) {
    ...
    if (tmp17(13607).scriptAlias[tmp19.script]) {
      tmp19.script = tmp17(13607).scriptAlias[tmp19.script];
    }
  ...
  if (tmp19.variants.length) {
    for (let num7 = 0; num7 < tmp19.variants.length; num7 = num7 + 1) {
      ...
      let tmp29 = num7;
      if (13607__.variantAlias[formatted2]) {
        let tmp30 = tmp27(13607).variantAlias[formatted2];
        if (tmp27(13608).isUnicodeVariantSubtag(tmp30)) {
          tmp19.variants[num7] = tmp30;
        } else if (tmp27(13608).isUnicodeLanguageSubtag(tmp30)) {
          tmp19.lang = tmp30;
        }
      }
    }
