// _runtime/01823_applyStyle.js
import _mod1738 from "metro/01738__.js";
...
function applyStyleForTopScreen(screenTransition, arg1) {
  ...
  _mod1738.updateProps(obj, topScreenStyleResult, undefined);
}
applyStyleForTopScreen.__closure = { createViewDescriptor: createViewDescriptorPaper, updateProps: _mod1738.updateProps };
...
function applyStyleForBelowTopScreen(screenTransition, value) {
  ...
  _mod1738.updateProps(obj, belowTopScreenStyleResult, undefined);
}
let obj = { createViewDescriptor: createViewDescriptorPaper, updateProps: _mod1738.updateProps };
applyStyleForBelowTopScreen.__closure = { createViewDescriptor: createViewDescriptorPaper, updateProps: _mod1738.updateProps };
...
function applyStyle(screenTransition, value) {
  if (typeof applyStyleForTopScreen === "function") {
    ...
    if (typeof applyStyleForBelowTopScreen === "function") {
      ...
      obj3.value = items1;
      const belowTopScreenStyleResult = screenTransition.screenTransition.belowTopScreenStyle(value, screenTransition.screenDimensions);
      _mod1738.updateProps(obj3, belowTopScreenStyleResult, undefined);
      const tmp5Result = _mod1738;
    } else {
