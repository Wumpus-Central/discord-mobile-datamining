// _runtime/05735_traverseAndConfigureRelations.js
import tagMessage from "05666_tagMessage.js";
import { isComposedGesture } from "05728_isComposedGesture.js";
...
function traverseAndConfigureRelations(gestures, map, set) {
  ...
  if (obj.isComposedGesture(gestures)) {
    ...
    gestures.gestureRelations = tmp(5728).prepareRelations(gestures.config, gestures.handlerTag);
...
arg5.configureRelations = function configureRelations(externalSimultaneousHandlers) {
  ...
  if (obj2.isComposedGesture(externalSimultaneousHandlers)) {
    ...
    if (externalSimultaneousHandlers.type === set(5720).ComposedGestureName.Simultaneous) {
