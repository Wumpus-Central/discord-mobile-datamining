// _runtime/12349_extractRequestData.js
import addNonEnumerableProperty from "12274_addNonEnumerableProperty.js";
import getNumberOfUrlSegments from "12350_getNumberOfUrlSegments.js";
...
function winterCGHeadersToDict(arr) {
  ...
  try {
    ...
    if (obj(12267).DEBUG_BUILD) {
      const logger = tmp3(12268).logger;
...
function headersToDict(arg0) {
  ...
  try {
    ...
    if (obj(12267).DEBUG_BUILD) {
      const logger = tmp4(12268).logger;
      logger.warn("Sentry failed extracting headers from a request object. If you see this, please file an issue.");
    }
    tmp4 = obj;
  }
