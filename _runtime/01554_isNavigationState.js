// _runtime/01554_isNavigationState.js
...
import { useLazyValue } from "01503_useLazyValue.js";
import { NavigationBuilderContext } from "01510_NavigationBuilderContext.js";
import { ConsumedParamsContext } from "01512_ConsumedParamsContext.js";
import { context } from "01521_context.js";
import { isArrayEqual } from "01544_isArrayEqual.js";
import { useRegisterNavigator } from "01555_useRegisterNavigator.js";
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  if (mapped.length) {
    ...
    const context2 = React.useContext(_require("01497_get_getKey.js") /* get getKey */.NavigationStateContext);
    ...
    if (null != tmp43) {
          ...
          if (isNavigationState(context.params.state)) {
            if (!tmp5) {
              ...
              if (null != tmp61) {
                ...
                const CommonActions = tmp30(1485).CommonActions;
          ...
          if (typeof context.params.screen === "string") {
            ...
            if ("lastUnhandled" === UNSTABLE_routeNamesChangeBehavior.UNSTABLE_routeNamesChangeBehavior) {
              if (!mapped.includes(context.params.screen)) {
                ...
                tmp67 = null == tmp66 || tmp34(1556)(tmp66, tmp43);
              }
            }
      ...
      const tmp75 = tmp34(1502)(() => {
        let tmp = callback2();
        if (!callback1(tmp)) {
          tmp = closure_30;
        }
        return StackRouter(1501).deepFreeze(tmp);
      });
      tmp30Result = tmp30(1508);
      ...
      obj8[0] = tmp58;
      obj8[1] = eventEmitter;
      const focusEvents = tmp30(1559).useFocusEvents(obj8);
      const items5 = [eventEmitter, tmp58];
      const effect3 = obj9.useEffect(() => {
        eventEmitter.emit({ type: "state", data: { state: closure_34 } });
      }, items5);
      const tmp30Result1 = tmp30(1559);
      const childListeners = tmp30(1504).useChildListeners();
      ({ listeners, addListener } = childListeners);
      const tmp30Result2 = tmp30(1504);
      const keyedChildListeners = tmp30(1505).useKeyedChildListeners();
      ({ keyedListeners, addKeyedListener } = keyedChildListeners);
      const tmp30Result3 = tmp30(1505);
      ...
      obj9[6] = obj10;
      obj9[7] = eventEmitter;
      const onAction = tmp30(1560).useOnAction(obj9);
      const tmp30Result4 = tmp30(1560);
      ...
      obj11[2] = tmp75;
      obj11[3] = tmp35;
      const onRouteFocus = tmp30(1562).useOnRouteFocus(obj11);
      let closure_41 = obj9.useContext(tmp30(1513).UnhandledActionContext);
      const tmp30Result5 = tmp30(1562);
      const tmp85 = tmp34(1502)((type) => {
        if ("lastUnhandled" === UNSTABLE_routeNamesChangeBehavior.UNSTABLE_routeNamesChangeBehavior) {
      ...
      obj12[6] = lazyValue;
      const navigationHelpers = tmp30(1563).useNavigationHelpers(obj12);
      const tmp30Result6 = tmp30(1563);
      const obj13 = { navigation: null, focusedListeners: null };
      obj13[0] = navigationHelpers;
      obj13[1] = listeners.focus;
      const focusedListenersChildrenAdapter = tmp30(1564).useFocusedListenersChildrenAdapter(obj13);
      const tmp30Result7 = tmp30(1564);
      const obj14 = { getState: null, getStateListeners: null };
      obj14[0] = tmp75;
      obj14[1] = keyedListeners.getState;
      const onGetState = tmp30(1565).useOnGetState(obj14);
      const tmp30Result8 = tmp30(1565);
      ...
      let descriptors = tmp30(1566).useDescriptors(obj15);
      descriptors = descriptors.descriptors;
      const tmp30Result9 = tmp30(1566);
      const obj16 = { state: null, navigation: null, descriptors: null };
      obj16[0] = tmp58;
      obj16[1] = navigationHelpers;
      obj16[2] = descriptors;
      const currentRender = tmp30(1570).useCurrentRender(obj16);
      const tmp30Result10 = tmp30(1570);
      ...
      obj17[3] = descriptors;
      obj17[4] = tmp30(1571).useComponent((arg0) => {
        let tmpResult = arg0;
        ...
        obj2[1] = outer1_7(StackRouter(1551).PreventRemoveProvider, { children: tmpResult });
        obj1[2] = outer1_7(StackRouter(1522).FocusedRouteKeyContext.Provider, obj2);
        obj[1] = outer1_7(StackRouter(1572).NavigationStateListenerProvider, obj1);
        obj[1] = outer1_7(StackRouter(1546).NavigationHelpersContext.Provider, obj);
        return outer1_7(StackRouter(1549).NavigationMetaContext.Provider, obj);
      });
      return obj17;
    }
    let everyResult;
