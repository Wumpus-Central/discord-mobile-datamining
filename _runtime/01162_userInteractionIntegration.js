// _runtime/01162_userInteractionIntegration.js
        ...
        if (elementId) {
          ...
          if (currentReactNativeTracingIntegration.state.currentRoute) {
              ...
              if (tmp18) {
                ...
                debug7.warn(
                  "[" +
                    ...
                    tmp(814).spanToJSON(activeSpan).description +
                    " exists on the scope.",
                );
            ...
            const attr = startIdleSpanResult.setAttribute(
              tmp(814).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN,
              tmp(1155).SPAN_ORIGIN_MANUAL_INTERACTION,
            );
