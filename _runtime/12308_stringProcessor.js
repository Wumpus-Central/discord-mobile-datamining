// _runtime/12308_stringProcessor.js
import _slicedToArray from "_slicedToArray";
import { mergeDefs } from "12249_mergeDefs.js";
import { initializeContext } from "12307_initializeContext.js";
...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(12307).process(_idmap, initializeContextResult);
    tmp2(12307).extractDefs(initializeContextResult, _idmap);
    return tmp2(12307).finalize(initializeContextResult, _idmap);
  }
