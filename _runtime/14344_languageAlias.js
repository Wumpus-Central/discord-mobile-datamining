// _runtime/14344_languageAlias.js

export const languageAlias = {
  "aa-saaho": "ssy",
  aam: "aas",
  aar: "aa",
  abk: "ab",
...
export const scriptAlias = { Qaai: "Zinh" };
export const variantAlias = { heploc: "alalc97", polytoni: "polyton" };
