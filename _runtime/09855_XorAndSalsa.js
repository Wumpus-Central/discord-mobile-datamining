// _runtime/09855_XorAndSalsa.js
import _asyncLoop from "09856__asyncLoop.js";
import pbkdf2Init from "09859_pbkdf2Init.js";
import _isNativeReflectConstruct from "09861__isNativeReflectConstruct.js";
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9856).isLE) {
                callback(9856).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
