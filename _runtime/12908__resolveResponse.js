// _runtime/12908__resolveResponse.js
import addHandler from "12795_addHandler.js";
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  ...
  addHandler.maybeInstrument("fetch-body-resolved", () => {
    ...
    {
      callback(12803).fill(callback(12798).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  require("12795_addHandler.js").addHandler("fetch", arg0);
  let obj = addHandler;
  require("12795_addHandler.js").maybeInstrument("fetch", () => {
    let flag = callback;
