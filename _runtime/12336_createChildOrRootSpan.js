// === Module 12336: createChildOrRootSpan ===
...
export const continueTrace = (arg0, arg1) => {
  const _require = arg1;
  const mainCarrier = _require(12320).getMainCarrier();
  const obj = _require(12320);
  const tmp = _require;
  const asyncContextStrategy = _require(12321).getAsyncContextStrategy(mainCarrier);
...
export const startNewTrace = function startNewTrace(arg0) {
  const _require = arg0;
  return _require(12329).withScope((setPropagationContext) => {
...
export const startSpanManual = function startSpanManual(experimental) {
  ...
  let obj = _require(12320);
  let mainCarrier = obj.getMainCarrier();
  let asyncContextStrategy = _require(12321).getAsyncContextStrategy(mainCarrier);
