// _runtime/04647_baseClone.js
import assignValue from "04656_assignValue.js";
        ...
        if (tmp10) {
          ...
          if (tmp32(536)(arr)) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4654);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4658)(obj, arr));
                } else {
                  tmp32Result = tmp32(4662);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4663)(obj, arr));
                }
