// _runtime/12370__getEventFilterUrl.js
...
import setupIntegration from "metro/12351__.js";
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod12323.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + _mod12306.getEventDescription(tmp));
      const tmp6Result = _mod12306;
    }
    return null;
  }
}
    ...
    processEvent(type, arg1, getOptions) {
      ...
      if (tmp10) {
        if (
          ...
          let flag6 = true;
          if (_mod12323.DEBUG_BUILD) {
            const logger6 = _mod12295.logger;
            const _HermesInternal6 = HermesInternal;
            logger6.warn(
              "Event dropped due to being internal Sentry Error.\nEvent: " + _mod12306.getEventDescription(type),
            );
            flag6 = true;
          }
        }
      ...
      if (flag) {
        flag6 = true;
        if (_mod12323.DEBUG_BUILD) {
          const logger5 = _mod12295.logger;
          const _HermesInternal5 = HermesInternal;
          logger5.warn(
            "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " +
              _mod12306.getEventDescription(type),
          );
          flag6 = true;
        }
      } else {
        ...
        if (flag2) {
          flag6 = true;
          if (_mod12323.DEBUG_BUILD) {
            const logger4 = _mod12295.logger;
          ...
          if ("transaction" === type.type) {
            ...
            if (items3.length) {
              ...
              if (result) {
                result = _mod12304.stringMatchesSomePattern(transaction, items3);
              }
              flag3 = result;
            }
          }
          if (flag3) {
            ...
            if (items1.length) {
              ...
              let result1 = tmp16;
              if (result1) {
                result1 = _mod12304.stringMatchesSomePattern(tmp16, items1);
              }
              flag4 = result1;
            }
            if (flag4) {
              ...
              if (_mod12323.DEBUG_BUILD) {
                ...
                const eventDescription = _mod12306.getEventDescription(type);
              ...
              if (items.length) {
                ...
                let result2 = !tmp21;
                if (tmp21) {
                  result2 = _mod12304.stringMatchesSomePattern(tmp21, items);
                }
                flag5 = result2;
              }
              flag6 = false;
              if (!flag5) {
                ...
                if (_mod12323.DEBUG_BUILD) {
                  const logger = _mod12295.logger;
                  const eventDescription1 = _mod12306.getEventDescription(type);
