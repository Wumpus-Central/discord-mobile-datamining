// _runtime/05524_load.js
import _modDef5525 from "metro/05525__.js";
...
function loadView(byteLength) {
  ...
  let obj2 = require("metro/05528__.js");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("metro/05528__.js").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("metro/05529__.js").USE_JPEG) {
    flag4 = false;
  ...
  const parseAppMarkersResult = require("metro/05528__.js").parseAppMarkers(byteLength, flag2);
