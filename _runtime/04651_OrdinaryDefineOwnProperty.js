// _runtime/04651_OrdinaryDefineOwnProperty.js
import { isObject } from "04588_isObject.js";

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (isObject(arg0)) {
    if (tmp(4635)(arg1)) {
      if (tmp(4639)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4640)(tmp30);
          }
          return tmp(4654)(arg0, arg1, tmp(4653)(arg0), __Writable__, tmp31);
        } else if (tmp(4652)(__Writable__)) {
          ...
          return tmp(4644)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
