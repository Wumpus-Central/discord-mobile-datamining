// _runtime/01784_checkSharedValueUsage.js
import noop from "noop";
import { Platform } from "get ActivityIndicator";
import isJest from "isJest";
import { t } from "01645_t.js";
import { updateProps } from "01734_updateProps.js";
import { isAnimated } from "01780_isAnimated.js";
import { o } from "01785_o.js";
...
function styleUpdater(arg0, arg1, animations) {
  ...
  if (flag5) {
    ...
    if (!shallowEqualResult) {
      tmp19(1734).updateProps(arg0, obj, flag);
      const tmp19Result = tmp19(1734);
    }
