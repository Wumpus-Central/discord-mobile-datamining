// _runtime/09323_QRPolynomial.js
import _mod9324 from "metro/09324__.js";
...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = _mod9324;
      const glogResult = _mod9324.glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - _mod9324.glog(getLength.get(0));
