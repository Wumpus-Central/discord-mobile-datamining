// _runtime/13544_text.js
import __core_js_shared__ from "__core-js_shared__";
import { call } from "13509_call.js";
import { all } from "13512_all.js";
import { state } from "13547_state.js";

let closure_5 = require("call")("".slice);
let closure_6 = require("call")("".replace);
let closure_7 = require("call")([].join);
const metroImportAll = require("getOwnPropertyDescriptor") && !require("module_13490")(() => 8 !== defineProperty(() => {

}, "length", { value: 8 }).length);
const tmp = require("getOwnPropertyDescriptor") && !require("module_13490")(() => 8 !== defineProperty(() => {
...
const fn = (toString, toString2) => {
  ...
  let tmp9 = !tmp8;
  if (tmp8) {
    tmp9 = tmp6(13546).CONFIGURABLE && toString.name !== text2;
    const tmp10 = tmp6(13546).CONFIGURABLE && toString.name !== text2;
  }
  if (tmp9) {
    if (tmp6(13489)) {
  ...
  try {
    if (arg2) {
      if (tmp6(13509)(arg2, "constructor")) {
        if (arg2.constructor) {
          if (tmp6(13489)) {
            defineProperty(toString, "prototype", { writable: false });
          }
        }
        const enforceResult = tmp6(13547).enforce(toString);
        if (!tmp6(13509)(enforceResult, "source")) {
          let str11 = "";
