// _runtime/08350_SliderTrackMark.js
...
export const SliderTrackMark = function SliderTrackMark(arg0) {
  ...
  let obj = { style: _mod8348.styles.trackMarkContainer, children: null };
  ...
  if (thumbImage) {
    jsxResult1 = null;
    if (isTrue) {
      obj = { style: _mod8348.styles.thumbImageContainer, testID: "sliderTrackMark-thumbImage", children: null };
      const obj1 = { source: thumbImage, style: _mod8348.styles.thumbImage };
      obj.children = <get ActivityIndicator.Image source={thumbImage} style={_mod8348.styles.thumbImage} />;
      jsxResult1 = <get ActivityIndicator.View style={_mod8348.styles.thumbImageContainer} testID="sliderTrackMark-thumbImage">{null}</get ActivityIndicator.View>;
    }
  }
  items[1] = jsxResult1;
  obj.children = items;
