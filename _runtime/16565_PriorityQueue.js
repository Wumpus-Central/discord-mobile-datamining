// _runtime/16565_PriorityQueue.js
...
const items = [
  {
    ...
    value: function enqueue(arg0, arg1) {
      ...
      _queue1.splice(PriorityQueue(16566).default(self._queue, obj, (priority, priority2) => priority2.priority - priority.priority), 0, obj);
    }
  },
  {
    key: "dequeue",
