// _runtime/06993_RVLayoutManager.js
...
let items = [
  ...
  },
  {
    ...
    value: function getVisibleLayouts(bound1, arg1) {
      ...
      const findLastVisibleIndexResult = RVLayoutManager(6994).findLastVisibleIndex(
        this.layouts,
        arg1,
        this.horizontal,
      );
      if (-1 !== result) {
        if (-1 !== findLastVisibleIndexResult) {
          let EMPTY = new RVLayoutManager(6981).ConsecutiveNumbers(result, findLastVisibleIndexResult);
        }
        return EMPTY;
      }
      EMPTY = RVLayoutManager(6981).ConsecutiveNumbers.EMPTY;
      const obj2 = RVLayoutManager(6994);
    },
  },
  {
    key: "deleteLayout",
