// _runtime/05172_keysSorter.js
import { 05174__ } from "metro/05174__.js";
const require = arg1;
...
arg5.stringify = (arg0, arg1) => {
  ...
  const tmp = _05174__({ encode: true, strict: true, arrayFormat: "none" }, arg1);
  dependencyMap = tmp;
  _require = tmp;
  ...
  if ("index" === arrayFormat) {
    let fn = (arg0, arg1, arg2) => {
      if (null === arg1) {
        if (!lib.encode) {
          ...
          let encodeURIComponentResult = lib(5173)(arg0);
        } else {
    ...
    fn = "bracket" === arrayFormat ? ((arg0, arg1) => {
      if (null === arg1) {
        ...
        let encodeURIComponentResult2 = lib(5173)(arg0);
      } else {
        const _encodeURIComponent = encodeURIComponent;
      ...
      if (undefined === lib[arg0]) {
        ...
        if (Array.isArray(arr)) {
          ...
          if (!tmp.encode) {
            ...
            let encodeURIComponentResult1 = lib(5173)(arr);
          } else {
            const _encodeURIComponent2 = encodeURIComponent;
