// _runtime/07262_CardContainer.js
import Link from "01485_Link.js";
import _mod5843 from "metro/05843__.js";
import ModalPresentationContext from "07252_ModalPresentationContext.js";
import _mod7263 from "metro/07263__.js";
import CardA11yWrapper from "07264_CardA11yWrapper.js";
import _mod7265 from "metro/07265__.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5843.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5843;
  }
  closure_15 = tmp12;
