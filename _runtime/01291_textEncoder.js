  ...
  },
  {
    ...
    value: function update(str) {
      ...
      if (0 === encodeResult.length) {
        ...
        const tmp130 = callback(self, closure_15);
        tmp130[closure_15] = tmp130[closure_15] + length;
        if (0 === callback(self, closure_16)[closure_16]) {
          const _Uint8Array = Uint8Array;
          let tmp128Result = callback(self, closure_14);
          const uint8Array = new Uint8Array(32);
          tmp128Result[closure_14] = uint8Array;
        }
        if (callback(self, closure_16)[closure_16] + length < 32) {
          const obj3 = callback(self, closure_14)[closure_14];
          const result = obj3.set(encodeResult.subarray(0, length), callback(self, closure_16)[closure_16]);
          tmp128Result = callback(self, closure_16);
          tmp128Result[closure_16] = tmp128Result[closure_16] + length;
          return self;
        } else {
          let num4 = 0;
          if (callback(self, closure_16)[closure_16] > 0) {
            const obj = callback(self, closure_14)[closure_14];
            const result1 = obj.set(encodeResult.subarray(0, 32 - callback(self, closure_16)[closure_16]), callback(self, closure_16)[closure_16]);
            const tmp12 = callback(self, closure_14)[closure_14];
            const _BigInt = BigInt;
            const _BigInt2 = BigInt;
            const subarrayResult1 = encodeResult.subarray(0, 32 - callback(self, closure_16)[closure_16]);
            const bigint = 8n;
            ...
            const asUintNResult = BigInt.asUintN(64, callback(self, closure_10)[closure_10] + tmp21 * c3);
            const bigint8 = 31n;
            const bigint9 = 64n;
            const diff = 64n - 31n;
            const _BigInt10 = BigInt;
            callback(self, closure_10)[closure_10] = BigInt.asUintN(64, (asUintNResult << 31n & closure_7 | asUintNResult >> diff) * c2);
            const memory = self.memory;
            const _BigInt11 = BigInt;
            const _BigInt12 = BigInt;
            const tmp128Result1 = callback(self, closure_10);
            ...
            const asUintNResult1 = BigInt.asUintN(64, callback(self, closure_11)[closure_11] + tmp36 * c3);
            const _BigInt20 = BigInt;
            callback(self, closure_11)[closure_11] = BigInt.asUintN(64, (asUintNResult1 << 31n & closure_7 | asUintNResult1 >> diff) * c2);
            const memory2 = self.memory;
            const _BigInt21 = BigInt;
            const _BigInt22 = BigInt;
            const tmp128Result2 = callback(self, closure_11);
            ...
            const asUintNResult2 = BigInt.asUintN(64, callback(self, closure_12)[closure_12] + tmp47 * c3);
            const _BigInt30 = BigInt;
            callback(self, closure_12)[closure_12] = BigInt.asUintN(64, (asUintNResult2 << 31n & closure_7 | asUintNResult2 >> diff) * c2);
            const memory3 = self.memory;
            const _BigInt31 = BigInt;
            const _BigInt32 = BigInt;
            const tmp128Result3 = callback(self, closure_12);
            ...
            const asUintNResult3 = BigInt.asUintN(64, callback(self, closure_13)[closure_13] + tmp58 * c3);
            const _BigInt40 = BigInt;
            callback(self, closure_13)[closure_13] = BigInt.asUintN(64, (asUintNResult3 << 31n & closure_7 | asUintNResult3 >> diff) * c2);
            num4 = 32 - callback(self, closure_16)[closure_16];
            callback(self, closure_16)[closure_16] = 0;
            const tmp128Result4 = callback(self, closure_13);
          }
          const diff1 = tmp - 32;
          const bigint10 = 8n;
          const bigint11 = 16n;
          ...
          if (num4 <= diff1) {
            do {
              ...
              let tmp105 = callback(self, closure_12);
              let _BigInt69 = BigInt;
              let asUintNResult6 = BigInt.asUintN(64, callback(self, closure_12)[closure_12] + tmp103 * c3);
              ...
              let tmp117 = callback(self, closure_13);
              let _BigInt79 = BigInt;
              let asUintNResult7 = BigInt.asUintN(64, callback(self, closure_13)[closure_13] + tmp115 * c3);
  ...
  },
  {
    ...
    value: function digest() {
      ...
      if (callback(this, closure_15)[closure_15] >= 32) {
        const tmp10 = callback(self, closure_10)[closure_10];
        const bigint = 1n;
        const bigint2 = 64n;
        const tmp14 = callback(self, closure_11)[closure_11];
        const bigint3 = 7n;
        const sum = (tmp10 << 1n & closure_7 | tmp10 >> 64n - 1n) + (tmp14 << 7n & closure_7 | tmp14 >> 64n - 7n);
        const tmp17 = callback(self, closure_12)[closure_12];
        const bigint4 = 12n;
        const sum1 = sum + (tmp17 << 12n & closure_7 | tmp17 >> 64n - 12n);
        const tmp20 = callback(self, closure_13)[closure_13];
        const bigint5 = 18n;
        const sum2 = sum1 + (tmp20 << 18n & closure_7 | tmp20 >> 64n - 18n);
        const _BigInt2 = BigInt;
        const asUintNResult = BigInt.asUintN(64, callback(self, closure_10)[closure_10] * c3);
        const bigint6 = 31n;
        const diff = 64n - 31n;
        const _BigInt3 = BigInt;
        const _BigInt4 = BigInt;
        const _BigInt5 = BigInt;
        const asUintNResult2 = BigInt.asUintN(64, callback(self, closure_11)[closure_11] * c3);
        const _BigInt6 = BigInt;
        const _BigInt7 = BigInt;
        const asUintNResult1 = BigInt.asUintN(64, BigInt.asUintN(64, sum2 ^ (asUintNResult << 31n & closure_7 | asUintNResult >> diff) * c2) * c2 + c5);
        const _BigInt8 = BigInt;
        const asUintNResult4 = BigInt.asUintN(64, callback(self, closure_12)[closure_12] * c3);
        const _BigInt9 = BigInt;
        const _BigInt10 = BigInt;
        ...
        const _BigInt11 = BigInt;
        const asUintNResult6 = BigInt.asUintN(64, callback(self, closure_13)[closure_13] * c3);
        const _BigInt12 = BigInt;
        const _BigInt13 = BigInt;
        ...
        const _BigInt = BigInt;
        asUintNResult7 = BigInt.asUintN(64, callback(self, closure_9)[closure_9] + c6);
      }
      let sum3 = asUintNResult7 + BigInt(callback(self, closure_15)[closure_15]);
      let num3 = 0;
      let tmp37 = sum3;
      let num4 = 0;
      if (0 <= tmp3 - 8) {
