    ...
    value: function update(str) {
      ...
      if (0 === encodeResult.length) {
        ...
        if (subarrayResult(self, subarrayResult)[subarrayResult] + length < 32) {
          ...
          subarrayResult = subarrayResult(self, closure_14)[closure_14].set(
            subarrayResult,
            subarrayResult(self, subarrayResult)[subarrayResult],
          );
          ...
          if (subarrayResult(self, subarrayResult)[subarrayResult] > 0) {
            ...
            const result = obj.set(
              encodeResult.subarray(0, 32 - subarrayResult(self, subarrayResult)[subarrayResult]),
              subarrayResult(self, subarrayResult)[subarrayResult],
            );
            ...
            subarrayResult(self, closure_10)[closure_10] = BigInt.asUintN(
              64,
            ...
            subarrayResult(self, closure_11)[closure_11] = BigInt.asUintN(
              64,
            ...
            subarrayResult(self, closure_12)[closure_12] = BigInt.asUintN(
              64,
            ...
            subarrayResult(self, closure_13)[closure_13] = BigInt.asUintN(
              64,
          ...
          if (num4 <= diff1) {
            do {
              ...
              subarrayResult[closure_12] = BigInt.asUintN(
                64,
                (((subarrayResult << 31n) & closure_7) | (subarrayResult >> diff2)) * c2,
              );
              ...
              subarrayResult[closure_13] = BigInt.asUintN(
                64,
                (((subarrayResult << 31n) & closure_7) | (subarrayResult >> diff2)) * c2,
              );
          ...
          if (tmp67 < subarrayResult) {
            ...
            subarrayResult = tmp66(self, closure_14)[closure_14].set(
              subarrayResult,
              tmp66(self, closure_16)[closure_16],
            );
