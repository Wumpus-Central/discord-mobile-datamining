// _runtime/05690_Color.js
import _mod5691 from "metro/05691__.js";
...
function _loop(item10136) {
  ...
  if (closure_3.includes(item10136)) {
    ...
    channels = require("metro/05691__.js")[item10136].channels;
    Color.prototype[item10136] = function () {
      ...
      if (this.model === closure_0) {
        ...
        const rawResult = _mod5691[self.model][closure_0].raw(self.color);
        const _Array = Array;
        let tmp2 = rawResult;
