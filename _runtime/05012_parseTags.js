// _runtime/05012_parseTags.js
import { getDataView } from "04971_getDataView.js";
import { 05013__ } from "metro/05013__.js";
const require = arg1;
...
function parseTags(buffer) {
  ...
  if (buffer.byteLength !== buffer.getUint32()) {
    ...
    const keys = Object.keys(05013__.iccProfile);
    for (let num = 0; num < keys.length; num = num + 1) {
      let tmp = keys[num];
      let tmp2 = require;
      let tmp3 = dependencyMap;
      let iter = 05013__.iccProfile[tmp];
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (stringFromDataView1 === mluc) {
                  ...
                  if (1 === uint324) {
                    ...
                    if (05013__.iccTags[stringFromDataView]) {
