// _runtime/12511_stringProcessor.js
...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(12510).process(_idmap, initializeContextResult);
    tmp2(12510).extractDefs(initializeContextResult, _idmap);
    return tmp2(12510).finalize(initializeContextResult, _idmap);
  }
