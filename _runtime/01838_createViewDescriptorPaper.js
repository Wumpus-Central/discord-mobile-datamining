// _runtime/01838_createViewDescriptorPaper.js
import updateProps from "01753_updateProps.js";
...
createViewDescriptorFabric.__initData = {
...
function applyStyleForTopScreen(screenTransition) {
  ...
  obj[0] = items;
  const topScreenStyleResult = screenTransition.screenTransition.topScreenStyle(
    arg1,
    screenTransition.screenDimensions,
  );
...
applyStyleForTopScreen.__initData = {
...
function applyStyleForBelowTopScreen(screenTransition, arg1) {
  ...
  obj[0] = items;
  const belowTopScreenStyleResult = screenTransition.screenTransition.belowTopScreenStyle(
    arg1,
    screenTransition.screenDimensions,
  );
...
applyStyleForBelowTopScreen.__initData = {
