// _runtime/00820_onVercelAiSpanStart.js
...
function processEndedVercelAiSpan(item10015) {
  ...
  if ("auto.vercelai.otel" === item10015.origin) {
    renameAttributeKey(
      data,
      _mod821.AI_USAGE_COMPLETION_TOKENS_ATTRIBUTE,
      _mod823.GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE,
    );
    renameAttributeKey(data, _mod821.AI_USAGE_PROMPT_TOKENS_ATTRIBUTE, _mod823.GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE);
    renameAttributeKey(
      data,
      _mod821.AI_USAGE_CACHED_INPUT_TOKENS_ATTRIBUTE,
      _mod823.GEN_AI_USAGE_INPUT_TOKENS_CACHED_ATTRIBUTE,
    );
