// _runtime/05036_load.js
import errorDefault from "05037_error.js";
  ...
  if (typeof response === "string") {
    ...
    if (obj1.test(response)) {
      ...
      if (obj2.test(response)) {
        let resolved = Promise.resolve(response(5038).dataUriToBuffer(response));
        const obj5 = response(5038);
      } else {
        obj2 = then;
        if (then === undefined) {
          obj2 = {};
