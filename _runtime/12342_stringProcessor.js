// _runtime/12342_stringProcessor.js
import _slicedToArray from "_slicedToArray";
import { mergeDefs } from "12283_mergeDefs.js";
import { initializeContext } from "12341_initializeContext.js";
...
export const toJSONSchema = function toJSONSchema(_idmap, uri) {
  ...
  if (tmp) {
    ...
    tmp2(12341).process(_idmap, initializeContextResult);
    tmp2(12341).extractDefs(initializeContextResult, _idmap);
    return tmp2(12341).finalize(initializeContextResult, _idmap);
  }
...
export const objectProcessor = (_zod, io, properties, path) => {
  ...
  for (const key10015 in shape) {
    ...
    obj.path = items;
    arg2.properties[key10015] = _initializeContext.process(shape[key10015], arg1, obj);
    continue;
  }
  ...
  if ("never" === type) {
    ...
    if (def.catchall) {
      ...
      obj.path = items2;
      properties.additionalProperties = _initializeContext.process(def.catchall, io, obj);
    }
