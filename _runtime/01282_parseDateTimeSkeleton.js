// _runtime/01282_parseDateTimeSkeleton.js
...
arg5.parseDateTimeSkeleton = function parseDateTimeSkeleton(closure_2) {
  const obj = {};
  const replaced = closure_2.replace(obj, (arg0) => {
    let first = arg0[0];
    switch (first) {
      case "s":
      break;
