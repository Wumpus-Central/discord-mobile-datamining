// _runtime/05454__isNativeReflectConstruct.js
...
import { transformIntoHandlerTags } from "05458_transformIntoHandlerTags.js";
import { 05459__ } from "metro/05459__.js";
...
let closure_10 = { [arg1(5433).State.UNDETERMINED]: undefined, [arg1(5433).State.BEGAN]: "onBegan", [arg1(5433).State.FAILED]: "onFailed", [arg1(5433).State.CANCELLED]: "onCancelled", [arg1(5433).State.ACTIVE]: "onActivated", [arg1(5433).State.END]: "onEnded" };
  ...
  let items = [
    {
      ...
      value: function componentDidMount() {
        ...
        if (someResult) {
          ...
          if (self.viewNode) {
            self.attachGestureHandler(require("05462_get_ActivityIndicator.js") /* get ActivityIndicator */(self.viewNode));
          } else {
            const _Error = Error;
