// _runtime/00975_asString.js
import _mod836 from "metro/00836__.js";
import _mod955 from "metro/00955__.js";
import truncateTextByBytes from "00958_truncateTextByBytes.js";
import _mod976 from "metro/00976__.js";
...
function baseRequestAttributes(arg0, arg1, arg2, kwargs, temperature, ls_temperature) {
  ...
  let obj = {};
  obj[_mod955.GEN_AI_SYSTEM_ATTRIBUTE] = asString(str);
  obj[_mod955.GEN_AI_OPERATION_NAME_ATTRIBUTE] = arg2;
  obj[_mod955.GEN_AI_REQUEST_MODEL_ATTRIBUTE] = asString(arg1);
  obj[_mod836.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = _mod976.LANGCHAIN_ORIGIN;
  if ("kwargs" in kwargs) {
  ...
  if (!Number.isNaN(NumberResult)) {
    obj[tmp(955).GEN_AI_REQUEST_TEMPERATURE_ATTRIBUTE] = NumberResult;
  }
  let max_tokens;
  if (temperature != null) {
  ...
  if (!Number.isNaN(NumberResult1)) {
    obj[tmp(955).GEN_AI_REQUEST_MAX_TOKENS_ATTRIBUTE] = NumberResult1;
  }
  let top_p;
  if (temperature != null) {
  ...
  if (!Number.isNaN(NumberResult2)) {
    obj[tmp(955).GEN_AI_REQUEST_TOP_P_ATTRIBUTE] = NumberResult2;
  }
  ...
  if (!Number.isNaN(NumberResult3)) {
    obj[tmp(955).GEN_AI_REQUEST_FREQUENCY_PENALTY_ATTRIBUTE] = NumberResult3;
  }
  ...
  if (!Number.isNaN(NumberResult4)) {
    obj[tmp(955).GEN_AI_REQUEST_PRESENCE_PENALTY_ATTRIBUTE] = NumberResult4;
  }
  ...
  if (tmp20) {
    ...
    if (null != BooleanResult) {
      obj[tmp(955).GEN_AI_REQUEST_STREAM_ATTRIBUTE] = BooleanResult;
    }
  }
      ...
      if (arr.length > 0) {
        const mapped = arr.flat().map((_getType) => {
          ...
          if (typeof _getType === "function") {
            ...
            let tmp31 = callback(976).ROLE_MAP[formatted];
            if (tmp31 == null) {
              tmp31 = formatted;
            }
            ...
            if (name) {
              ...
              let tmp26 = callback(976).ROLE_MAP[formatted1];
              if (tmp26 == null) {
                tmp26 = formatted1;
              }
              ...
              let tmp21 = callback(976).ROLE_MAP[formatted2];
              if (tmp21 == null) {
                tmp21 = formatted2;
              }
              ...
              let tmp15 = callback(976).ROLE_MAP[formatted3];
              if (tmp15 == null) {
                tmp15 = formatted3;
              }
              ...
              if (1 === _getType.lc) {
                if (_getType.kwargs) {
                  ...
                  let tmp8 = callback(976).ROLE_MAP[formatted4];
                  if (tmp8 == null) {
                    tmp8 = formatted4;
                  }
        ...
        if (null != mapped.length) {
          tmpResult[_mod955.GEN_AI_REQUEST_MESSAGES_ORIGINAL_LENGTH_ATTRIBUTE] = length;
        }
        ...
        if (null != tmp10) {
          tmpResult[tmp12(955).GEN_AI_REQUEST_MESSAGES_ATTRIBUTE] = tmp10;
        }
  ...
  if (closure_0) {
    ...
    if (Array.isArray(arr)) {
      if (arr.length > 0) {
        ...
        if (null != arr.length) {
          tmp2Result[_mod955.GEN_AI_REQUEST_MESSAGES_ORIGINAL_LENGTH_ATTRIBUTE] = length;
        }
        ...
        if (null != tmp9) {
          tmp2Result[tmp11(955).GEN_AI_REQUEST_MESSAGES_ATTRIBUTE] = tmp9;
        }
        tmp10 = setIfDefined;
        tmp11 = require;
      }
  ...
  if (generations) {
    ...
    if (Array.isArray(generations.generations)) {
      ...
      if (found.length > 0) {
        ...
        if (null != tmp6) {
          obj[_mod955.GEN_AI_RESPONSE_FINISH_REASONS_ATTRIBUTE] = tmp6;
        }
      }
      ...
      if (flag2) {
        ...
        if (found1.length > 0) {
          ...
          if (null != tmp14) {
            obj[_mod955.GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = tmp14;
          }
        }
    ...
    if (llmOutput) {
      ...
      if (tokenUsage) {
        ...
        if (!Number.isNaN(NumberResult)) {
          obj[_mod955.GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE] = NumberResult;
        }
        if (typeof setNumberIfDefined !== "function") {
          HermesBuiltin.throwTypeError();
        }
        ...
        if (!Number.isNaN(NumberResult1)) {
          obj[tmp28(955).GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE] = NumberResult1;
        }
        if (typeof setNumberIfDefined !== "function") {
          HermesBuiltin.throwTypeError();
        }
        ...
        if (!Number.isNaN(NumberResult2)) {
          obj[tmp28(955).GEN_AI_USAGE_TOTAL_TOKENS_ATTRIBUTE] = NumberResult2;
        }
      } else if (usage) {
        if (typeof setNumberIfDefined !== "function") {
          HermesBuiltin.throwTypeError();
        ...
        if (!Number.isNaN(NumberResult3)) {
          obj[_mod955.GEN_AI_USAGE_INPUT_TOKENS_ATTRIBUTE] = NumberResult3;
        }
        if (typeof setNumberIfDefined !== "function") {
          HermesBuiltin.throwTypeError();
        }
        ...
        if (!Number.isNaN(NumberResult4)) {
          obj[tmp17(955).GEN_AI_USAGE_OUTPUT_TOKENS_ATTRIBUTE] = NumberResult4;
        }
        ...
        if (sum > 0) {
          ...
          if (!Number.isNaN(NumberResult7)) {
            obj[tmp17(955).GEN_AI_USAGE_TOTAL_TOKENS_ATTRIBUTE] = NumberResult7;
          }
        }
        if (undefined !== usage.cache_creation_input_tokens) {
          ...
          if (!Number.isNaN(NumberResult8)) {
            obj[tmp17(955).GEN_AI_USAGE_CACHE_CREATION_INPUT_TOKENS_ATTRIBUTE] = NumberResult8;
          }
        }
        if (undefined !== usage.cache_read_input_tokens) {
          ...
          if (!Number.isNaN(NumberResult9)) {
            obj[tmp17(955).GEN_AI_USAGE_CACHE_READ_INPUT_TOKENS_ATTRIBUTE] = NumberResult9;
          }
        }
      }
    }
    ...
    if (model_name) {
      ...
      if (null != model_name) {
        obj[_mod955.GEN_AI_RESPONSE_MODEL_ATTRIBUTE] = model_name;
      }
    }
    let id;
    if (llmOutput2 != null) {
    ...
    if (id) {
      ...
      if (null != id) {
        obj[_mod955.GEN_AI_RESPONSE_ID_ATTRIBUTE] = id;
      }
    }
    let stop_reason;
    if (llmOutput2 != null) {
    ...
    if (stop_reason) {
      ...
      if (null != tmp53) {
        obj[_mod955.GEN_AI_RESPONSE_STOP_REASON_ATTRIBUTE] = tmp53;
      }
    }
    return obj;
  }
