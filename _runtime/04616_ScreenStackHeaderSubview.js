// _runtime/04616_ScreenStackHeaderSubview.js
import _objectWithoutProperties from "_objectWithoutProperties";
import get_ActivityIndicator from "get ActivityIndicator";
import { jsx } from "jsxProd";
import { context } from "04617_context.js";
import { __INTERNAL_VIEW_CONFIG } from "metro/04620___INTERNAL_VIEW_CONFIG.js";
...
const forwardRefResult = require("noop").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4613).isHeaderBarButtonsAvailableForCurrentPlatform) {
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4613).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4614).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4619), {});
});
forwardRefResult.displayName = "ScreenStackHeaderConfig";
const styles = StyleSheet.create({ headerSubview: { flexDirection: "row", alignItems: "center", justifyContent: "center" }, headerSubviewCenter: { flexDirection: "row", alignItems: "center", justifyContent: "center", flexShrink: 1 }, headerConfig: { position: "absolute", width: "100%", flexDirection: "row", justifyContent: "space-between", alignItems: "channel" } });
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = require("04614_get_controlledBottomTabs.js") /* get controlledBottomTabs */.experiment.synchronousHeaderSubviewUpdatesEnabled;
...
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = require("04614_get_controlledBottomTabs.js") /* get controlledBottomTabs */.experiment.synchronousHeaderSubviewUpdatesEnabled;
