// _runtime/01696_isReanimated3.js
import runWorkletOnJS from "01659_runWorkletOnJS.js";
import ReanimatedModule3 from "01660_ReanimatedModule.js";
import freezeObjectInDev from "01682_freezeObjectInDev.js";
import addCompilerSafeGetAndSet from "01689_addCompilerSafeGetAndSet.js";
import SensorContainer from "01698_SensorContainer.js";
import createMapperRegistry from "01700_createMapperRegistry.js";
import runOnRuntime from "01702_runOnRuntime.js";
import controlEdgeToEdgeValues from "01697_controlEdgeToEdgeValues.js";
...
export const getViewProp = function getViewProp(arg0, arg1, arg2) {
  ...
  if (obj.isFabric()) {
    if (!arg2) {
      const reanimatedError = new tmp(1663).ReanimatedError(
