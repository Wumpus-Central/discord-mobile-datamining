// === Module 1696: isReanimated3 ===

// Module 1696 (isReanimated3)
import runWorkletOnJS from "runWorkletOnJS" /* 1659 */;
import ReanimatedModule3 from "ReanimatedModule" /* 1660 */;
import freezeObjectInDev from "freezeObjectInDev" /* 1682 */;
import addCompilerSafeGetAndSet from "addCompilerSafeGetAndSet" /* 1689 */;
import SensorContainer from "SensorContainer" /* 1698 */;
import createMapperRegistry from "createMapperRegistry" /* 1700 */;
import runOnRuntime from "runOnRuntime" /* 1702 */;
import controlEdgeToEdgeValues from "controlEdgeToEdgeValues" /* 1697 */;
...
export const getViewProp = function getViewProp(arg0, arg1, arg2) {
  ...
  if (obj.isFabric()) {
    if (!arg2) {
      const reanimatedError = new tmp(1663).ReanimatedError("Function `getViewProp` requires a component to be passed as an argument on Fabric.");
