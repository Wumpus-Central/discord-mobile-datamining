// _runtime/13558_text.js
import __core_js_shared__ from "__core-js_shared__";
import { call } from "13523_call.js";
import { all } from "13526_all.js";
import { state } from "13561_state.js";

let closure_5 = require("call")("".slice);
let closure_6 = require("call")("".replace);
let closure_7 = require("call")([].join);
const metroImportAll = require("getOwnPropertyDescriptor") && !require("module_13504")(() => 8 !== defineProperty(() => {

}, "length", { value: 8 }).length);
const tmp = require("getOwnPropertyDescriptor") && !require("module_13504")(() => 8 !== defineProperty(() => {
...
const fn = (toString, toString2) => {
  ...
  let tmp9 = !tmp8;
  if (tmp8) {
    tmp9 = tmp6(13560).CONFIGURABLE && toString.name !== text2;
    const tmp10 = tmp6(13560).CONFIGURABLE && toString.name !== text2;
  }
  if (tmp9) {
    if (tmp6(13503)) {
  ...
  try {
    if (arg2) {
      if (tmp6(13523)(arg2, "constructor")) {
        if (arg2.constructor) {
          if (tmp6(13503)) {
            defineProperty(toString, "prototype", { writable: false });
          }
        }
        const enforceResult = tmp6(13561).enforce(toString);
        if (!tmp6(13523)(enforceResult, "source")) {
          let str11 = "";
