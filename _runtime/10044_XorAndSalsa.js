// _runtime/10044_XorAndSalsa.js
import _asyncLoop from "10045__asyncLoop.js";
import number from "10046_number.js";
import pbkdf2Init from "10048_pbkdf2Init.js";
import _mod10050 from "metro/10050__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod10050.sha256, B, B, obj2);
                  ...
                  const u32Result1 = _asyncLoop.u32(uint8Array);
                  if (onProgress) {
                    const result2 = 2 * N * p;
                    const _Math = Math;
                    const _Math2 = Math;
...
function scryptOutput(B, dkLen, arr, arr2, arr3) {
  ...
  arr2.fill(0);
  arr3.fill(0);
  return pbkdf2Init.pbkdf2(_mod10050.sha256, B, arr, { c: 1, dkLen });
}
let closure_7 = async function _scryptAsync(arg0) {
  if (c12 === 2) {
    c12 = 3;
    ...
    try {
      ...
      if (0 === c11) {
        if (arg0 === 1) {
          ...
          closure_135_12 = async function _loop() {
            if (c3 === 2) {
              c3 = 3;
              throw new TypeError("Generator functions may not be called on executing generators");
            } else if (tmp4 === 3) {
                  ...
                  if (arg0 === 1) {
                    ...
                    const obj4 = {
                      value: closure_0(tmp2[1]).asyncLoop(closure_2_1 - 1, closure_2_11, async () => {
                                ...
                                let num = 0;
                                do {
                                  dependencyMap[sum1 + num] = dependencyMap[sum5 + 16 * (2 * c2 - 1) + num];
                                  num = num + 1;
                                } while (num < 16);
                                let sum4 = sum;
                                let num2 = 0;
                                if (0 < c2) {
                                  do {
                                    let tmp14 = closure_3_3(dependencyMap, sum1, dependencyMap, sum5, dependencyMap, sum4);
                                    let sum2 = sum1;
                                    let tmp17 = sum4;
                                    if (0 < num2) {
                                      sum2 = sum1 + 16;
                                    ...
                                    let sum3 = sum5 + 16;
                                    let tmp7Result = closure_3_3(dependencyMap, tmp17, dependencyMap, sum3, dependencyMap, sum2);
                                    num2 = num2 + 1;
                                    sum4 = sum4 + 16;
                                    sum5 = sum3 + 16;
                                    sum1 = sum2;
                  ...
                  if (arg0 === 1) {
                    ...
                    const obj6 = {
                      value: closure_0(tmp2[1]).asyncLoop(closure_129_1, closure_129_11, async () => {
                                ...
                                if (0 < closure_2_5) {
                                  do {
                                    closure_2_9[num] = closure_2_7[closure_1_0 + num] ^ dependencyMap[tmp3 * closure_2_5 + num];
                                    num = num + 1;
                                    tmp = closure_2_7;
                                    tmp2 = closure_1_0;
                                ...
                                let num2 = 0;
                                do {
                                  tmp[sum + num2] = closure_2_9[16 * (2 * c2 - 1) + num2];
                                  num2 = num2 + 1;
                                } while (num2 < 16);
                                let sum3 = tmp2;
                                let num3 = 0;
                                ...
                                if (0 < c2) {
                                  do {
                                    let tmp20 = closure_3_3(tmp, sum, closure_2_9, num4, tmp, sum3);
                                    let sum1 = sum;
                                    let tmp23 = sum3;
                                    if (0 < num3) {
                                      sum1 = sum + 16;
                                    ...
                                    let sum2 = num4 + 16;
                                    let tmp13Result = closure_3_3(tmp, tmp23, closure_2_9, sum2, tmp, sum1);
                                    num3 = num3 + 1;
                                    sum3 = sum3 + 16;
                                    num4 = sum2 + 16;
                                    sum = sum1;
...
export const scrypt = function scrypt(B, B, arg2) {
  ...
  V.fill(0);
  tmp2.fill(0);
  return pbkdf2Init.pbkdf2(_mod10050.sha256, B, B, { c: 1, dkLen: tmp.dkLen });
};
