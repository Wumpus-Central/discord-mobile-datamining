// _runtime/13224_items.js
import { SemVer } from "13196_SemVer.js";
import { Comparator } from "13210_Comparator.js";
import { Range } from "13211_Range.js";
import { Range } from "13213_Range.js";
    ...
    if (1 === arg0.length) {
      ...
      if (arg0[0].semver === Comparator.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(13210).ANY) {
            return true;
          }
        }
      }
