// _runtime/13158_BrowserMetricsAggregator.js
...
const entry = {
  ...
  value: function add(metricType, arg1, diff) {
    ...
    const bucketKey = BrowserMetricsAggregator(13155).getBucketKey(
      metricType,
    ...
    if (value) {
      num = 0;
      if (metricType === BrowserMetricsAggregator(13151).SET_METRIC_TYPE) {
    ...
    if (value) {
      ...
      const tmp16 = new BrowserMetricsAggregator(13156).METRIC_MAP[metricType](diff);
      obj7.metric = tmp16;
    ...
    const result1 = BrowserMetricsAggregator(13059).updateMetricSummaryOnActiveSpan(
      metricType,
      sanitizeMetricKeyResult,
      diff,
      sanitizeUnitResult,
    ...
    const tmp5Result = BrowserMetricsAggregator(13059);
  },
};
const items = [
  entry,
