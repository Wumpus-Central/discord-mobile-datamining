...
if (Intl.ListFormat) {
  ...
  if (typeof Intl.ListFormat.__addLocaleData === "function") {
    ...
    obj[0] = { end: "{0} \u0438 {1}", middle: "{0}, {1}", pair: "{0} \u0438 {1}", start: "{0}, {1}" };
    obj[1] = { end: "{0} \u0438 {1}", middle: "{0}, {1}", pair: "{0}, {1}", start: "{0}, {1}" };
    ...
    obj2[1] = { end: "{0}, {1}", middle: "{0}, {1}", pair: "{0} \u0438 {1}", start: "{0}, {1}" };
    obj2[2] = { end: "{0}, {1}", middle: "{0}, {1}", pair: "{0} \u0438 {1}", start: "{0}, {1}" };
    obj[2] = obj2;
    obj[0] = obj;
