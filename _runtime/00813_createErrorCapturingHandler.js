// _runtime/00813_createErrorCapturingHandler.js
import captureError from "00812_captureError.js";
...
arg5.wrapAllMCPHandlers = function wrapAllMCPHandlers(arg0) {
  let prompt = "tool";
  prompt(687).fill(arg0, "tool", (arg0) => {
    closure_0 = arg0;
  ...
  prompt = "resource";
  const obj = prompt(687);
  prompt(687).fill(arg0, "resource", (arg0) => {
    closure_0 = arg0;
    return function (arg0) {
      let self = this;
      const substr = [...arguments].slice();
