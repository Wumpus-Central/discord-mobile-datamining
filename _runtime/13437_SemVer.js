...
class SemVer {
  constructor(arg0, arg1) {
    ...
    tmp2 = SemVer;
    tmp3 = closure_1;
    tmp4 = require("module_13438")(require);
    ...
    if (version.length > require("module_13439").MAX_LENGTH) {
      tmp28 = globalThis;
      ...
      tmp29 = new.target;
      tmp30 = new.target;
      typeError1 = new TypeError("version is longer than " + require("module_13439").MAX_LENGTH + " characters");
      tmp32 = typeError1;
      throw typeError1;
    } else {
      str13 = "SemVer";
      tmp38 = require("module_13440")("SemVer", version, tmp4);
      self.options = tmp4;
      ...
      if (match) {
        ...
        self.minor = +match[2];
        self.patch = +match[3];
        if (self.major <= require("module_13439").MAX_SAFE_INTEGER) {
          num = 0;
          if (self.major >= 0) {
            if (self.minor <= require("module_13439").MAX_SAFE_INTEGER) {
              if (self.minor >= 0) {
                if (self.patch <= require("module_13439").MAX_SAFE_INTEGER) {
                  if (self.patch >= 0) {
                    if (match[4]) {
                      str2 = match[4];
                      str3 = ".";
