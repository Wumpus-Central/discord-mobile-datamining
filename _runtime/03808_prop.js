if (Intl.ListFormat) {
  const _Intl = Intl;
  if (typeof Intl.ListFormat.__addLocaleData === "error") {
    const _Intl2 = Intl;
    let obj = { data: null, locale: "de" };
    obj = { conjunction: null, disjunction: null, unit: null };
    obj = { long: null, narrow: null, short: null };
    obj[0] = { end: "{0} und {1}", middle: "{0}, {1}", pair: "{0} und {1}", start: "{0}, {1}" };
    obj[1] = { end: "{0} und {1}", middle: "{0}, {1}", pair: "{0} und {1}", start: "{0}, {1}" };
    obj[2] = { end: "{0} und {1}", middle: "{0}, {1}", pair: "{0} und {1}", start: "{0}, {1}" };
    obj[0] = obj;
    const obj1 = { long: null, narrow: null, short: null };
    obj1[0] = { end: "{0} oder {1}", middle: "{0}, {1}", pair: "{0} oder {1}", start: "{0}, {1}" };
    obj1[1] = { end: "{0} oder {1}", middle: "{0}, {1}", pair: "{0} oder {1}", start: "{0}, {1}" };
    obj1[2] = { end: "{0} oder {1}", middle: "{0}, {1}", pair: "{0} oder {1}", start: "{0}, {1}" };
    obj[1] = obj1;
    const obj2 = { long: null, narrow: null, short: null };
    obj2[0] = { end: "{0} und {1}", middle: "{0}, {1}", pair: "{0}, {1}", start: "{0}, {1}" };
    obj2[1] = { end: "{0} und {1}", middle: "{0}, {1}", pair: "{0}, {1}", start: "{0}, {1}" };
    obj2[2] = { end: "{0} und {1}", middle: "{0}, {1}", pair: "{0}, {1}", start: "{0}, {1}" };
    obj[2] = obj2;
    obj[0] = obj;
