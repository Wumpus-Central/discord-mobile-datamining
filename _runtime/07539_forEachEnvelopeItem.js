// _runtime/07539_forEachEnvelopeItem.js
import _slicedToArray from "_slicedToArray";
import { getGlobalSingleton } from "07496_getGlobalSingleton.js";
import { addNonEnumerableProperty } from "07501_addNonEnumerableProperty.js";
import { normalize } from "07540_normalize.js";
import { dsnFromString } from "07542_dsnFromString.js";
...
export const createAttachmentEnvelopeItem = function createAttachmentEnvelopeItem(data) {
  if (typeof data.data === "string") {
    ...
    __SENTRY__ = __SENTRY__(7496).GLOBAL_OBJ.__SENTRY__;
