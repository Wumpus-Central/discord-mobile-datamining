// _runtime/09794_pbkdf2Init.js
import _asyncLoop from "09791__asyncLoop.js";
import number from "09792_number.js";
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9791).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9795).hmac;
    let obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9791).toBytes(B);
