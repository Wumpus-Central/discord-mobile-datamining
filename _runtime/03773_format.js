// _runtime/03773_format.js
import isValid from "03723_isValid.js";
import subMilliseconds from "03774_subMilliseconds.js";
import _typeof from "metro/03541__typeof.js";
import G from "03775_G.js";
import dateLongFormatter from "03786_dateLongFormatter.js";
import getTimezoneOffsetInMilliseconds from "03704_getTimezoneOffsetInMilliseconds.js";
import toInteger from "03545_toInteger.js";
import requiredArgs from "03542_requiredArgs.js";
import code from "03787_code.js";
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("03546_getDefaultOptions.js").getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3788).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3788).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3788).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
