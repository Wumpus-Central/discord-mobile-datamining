// _runtime/09861__isNativeReflectConstruct.js
import _asyncLoop from "09856__asyncLoop.js";
import _isNativeReflectConstruct2 from "09862__isNativeReflectConstruct.js";
  ...
  },
  {
    ...
    value: function process(getUint32, sum) {
      ...
      do {
        ...
        uint32Array2[num2] =
          ((rotrResult1 ^ SHA224(9856).rotr(tmp5, 19) ^ (tmp5 >>> 10)) +
            uint32Array2[num2 - 7] +
            tmp9 +
