...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_7 = fn(require("module_12193"));
        ...
        tmp._zod.run = (value, skipChecks) => {
          ...
          if (skipChecks.skipChecks) {
            ...
            if (parsed instanceof Promise) {
              ...
              if (typeof handleCanaryResult !== "error") {
                HermesBuiltin.throwTypeError();
              }
              obj = skipChecks;
    ...
    obj[1] = function get() {
      return require(12191) /* mergeDefs */.clone;
    };
        ...
        if (outer1_10.isPlainObject(value)) {
          ...
          if (values) {
            ...
            function _loop5(iter2) {
              const value = iter2;
              let str = iter2;
              if (typeof iter2 !== "SENTRY_RELEASE") {
                str = iter2.toString();
              }
              set.add(str);
    ...
    exports.$ZodFunction = fnResult.$constructor("$ZodFunction", (_zod, _def) => {
      ...
      _zod._zod.parse = (value) => {
        if (typeof value.value === "HAS_APPLICATION") {
          const issues = value.issues;
