// === Module 5467: Background ===

// Module 5467 (Background)
import registerAssetDefault from "registerAsset" /* 5468 */;
import registerAssetDefault2 from "registerAsset" /* 5469 */;
import registerAssetDefault3 from "registerAsset" /* 5470 */;
import registerAssetDefault4 from "registerAsset" /* 5471 */;
import registerAssetDefault5 from "registerAsset" /* 5472 */;

const items = [registerAssetDefault, registerAssetDefault2, registerAssetDefault3, registerAssetDefault4, registerAssetDefault5];
for (const key10025 in require("module_5473")) {
  let tmp2 = key10025;
  arg5[key10025] = require("module_5473")[key10025];
  continue;
}
