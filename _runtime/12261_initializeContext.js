// === Module 12261: initializeContext ===
...
function process(_zod, seen) {
  ...
  if (value) {
    ...
    obj = { schema: null, count: 1, cycle: "Array", path: "default" };
    obj[0] = {};
    obj[3] = tmp4.path;
...
arg5.createToJSONSchemaMethod = (arg0) => {
  ...
  return (arg0) => {
    ...
    obj.processors = obj;
    const tmp2 = initializeContext(obj);
...
arg5.createStandardJSONSchemaMethod = (arg0, arg1) => {
  ...
  return (target) => {
    ...
    obj.io = closure_1;
    obj.processors = obj;
    const tmpResult = initializeContext(obj);
