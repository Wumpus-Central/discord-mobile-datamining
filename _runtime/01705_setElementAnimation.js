...
function setElementAnimation(dummy, dummyAnimationConfig, arg2) {
  ...
  if (dummyAnimationConfig.animationType === require("01661_isWorkletFunction.js").LayoutAnimationType.ENTERING) {
  ...
  if (!(animationName in require("01692_TransitionType.js").Animations)) {
...
arg5.handleExitingAnimation = function handleExitingAnimation(offsetParent, processedConfig) {
  ...
  const snapshots = require("01722_weakMap.js").snapshots;
  ...
  require("01722_weakMap.js").setElementPosition(cloneNodeResult, rect);
