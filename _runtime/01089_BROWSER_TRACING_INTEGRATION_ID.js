// _runtime/01089_BROWSER_TRACING_INTEGRATION_ID.js
...
export const browserTracingIntegration = () => {
  ...
  document = require("01025_ignoreNextOnError.js").WINDOW.document;
  obj = {};
        ...
        if (c25) {
          let result2 = tmp(tmp2[3]).addHistoryInstrumentationHandler((to) => {
            ...
            obj = {
              name: pathname,
              attributes: {
                [tmp3(814).SEMANTIC_ATTRIBUTE_SENTRY_SOURCE]: "url",
                [tmp3(814).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN]: "auto.navigation.browser",
              },
            };
            ...
            function registerInteractionTransaction() {
              ...
              if (closure_5) {
                const attr = obj1.setAttribute(
                  emit(814).SEMANTIC_ATTRIBUTE_SENTRY_IDLE_SPAN_FINISH_REASON,
