// _runtime/07759_addToMetricsAggregator.js
import errorCallback from "07659_errorCallback.js";
import _mod7760 from "metro/07760__.js";
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = require("07690_getClient.js").getClient();
    const obj2 = getClient;
  }
  if (client) {
    const activeSpan = require("07668_spanTimeInputToSeconds.js").getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const globalSingleton = require("07664_getGlobalSingleton.js").getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  ...
  timing(arg0, arg1, fn) {
    ...
    if (typeof fn === "function") {
      ...
      return require("07697_createChildOrRootSpan.js").startSpanManual(obj, (arg0) => {
        const callback = arg0;
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = require("metro/07760__.js").DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
