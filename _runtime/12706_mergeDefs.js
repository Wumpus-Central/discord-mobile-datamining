      ...
      return {
        localeError: (code) => {
          ...
          switch (str) {
            ...
            case "diffClamp":
            break;
            case "badgeColorSecondary":
            break;
            case "getParser":
            break;
            case "getParserWithoutLinks":
            break;
            case "INCOMING_FRIEND_REQUESTS":
            break;
            case "INCOMING_FRIEND_REQUESTS_ACCEPTED":
            break;
            ...
            break;
            case "INTERNAL_UPDATE_URL":
            break;
            case "gzhead":
            break;
            case "headMetaDescKeywords":
            break;
            case "isSpotifyParty":
            break;
            case "PartyBadge":
            ...
            case "isConnected":
            break;
            case "isConnectedOrOverlay":
            break;
            case "HandRequestSpeakListIcon":
            break;
            case "_$esjava$s":
            break;
            ...
            break;
            case "STATUS_MAX_LENGTH":
            break;
            case "HUB_PROGRESS":
            break;
            case "HUB_PROGRESS_ACTION_SHEET_ID":
            break;
            ...
            case "tagInverted":
            break;
            case "getCachedMessageIds":
            break;
            case "getCachedMessageIdsForChannel":
            break;
            ...
            case "APP_BACKGROUND":
            break;
            case "BACKGROUND_BASE_LOW":
            break;
            case "BACKGROUND_BASE_LOWER":
            break;
            case "BASE":
            break;
            case "flag_kh":
            ...
            case "#71368a":
            break;
            case "captureOverrides":
            break;
            case "#95a5a6":
            break;
            case "escapeStringForRegex":
            break;
            ...
            case "ZodArray":
            break;
            case "hasPaymentSourceForSKUId":
            break;
            case "hasPaymentSourceForSKUIds":
            break;
