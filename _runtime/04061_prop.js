...
if (Intl.ListFormat) {
  ...
  if (typeof Intl.ListFormat.__addLocaleData === "function") {
    ...
    obj1[0] = { end: "{0} lub {1}", middle: "{0}, {1}", pair: "{0} lub {1}", start: "{0}, {1}" };
    obj1[1] = { end: "{0} lub {1}", middle: "{0}, {1}", pair: "{0} lub {1}", start: "{0}, {1}" };
    obj1[2] = { end: "{0} lub {1}", middle: "{0}, {1}", pair: "{0} lub {1}", start: "{0}, {1}" };
    obj[1] = obj1;
    const obj2 = { long: null, narrow: null, short: null };
    obj2[0] = { end: "{0} i {1}", middle: "{0}, {1}", pair: "{0} i {1}", start: "{0}, {1}" };
    obj2[1] = { end: "{0} i {1}", middle: "{0}, {1}", pair: "{0} i {1}", start: "{0}, {1}" };
