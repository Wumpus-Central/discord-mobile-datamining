// _runtime/01686_ReanimatedFlatList.js
...
import isReactRendering from "01792_isReactRendering.js";
...
export const ReanimatedFlatList = isReactRendering.componentWithRef((skipEnteringExitingAnimations, ref) => {
  ...
  if (undefined !== skipEnteringExitingAnimations.skipEnteringExitingAnimations) {
    ...
    obj[2] = tmp7;
    tmp5Result = jsx(require("01791__isNativeReflectConstruct.js").LayoutAnimationConfig, { skipEntering: true, skipExiting: true, children: null });
  }
  return tmp5Result;
});