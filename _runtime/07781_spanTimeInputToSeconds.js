// _runtime/07781_spanTimeInputToSeconds.js
import consoleSandbox from "07776_consoleSandbox.js";
import addNonEnumerableProperty from "07782_addNonEnumerableProperty.js";
import generatePropagationContext from "07786_generatePropagationContext.js";
import regExp from "07788_regExp.js";
import dateTimestampInSeconds from "07790_dateTimestampInSeconds.js";
import _mod7791 from "metro/07791__.js";
import getMetricSummaryJsonForSpan from "07792_getMetricSummaryJsonForSpan.js";
import getSpanStatusFromHttpCode from "07793_getSpanStatusFromHttpCode.js";
import getMainCarrier from "07794_getMainCarrier.js";
import getAsyncContextStrategy from "07795_getAsyncContextStrategy.js";
  ...
  if ((function spanIsSentrySpan(getSpanJSON) {
    ...
    try {
      ...
      if ((function spanIsOpenTelemetrySdkTraceBaseSpan(attributes) {
        ...
        obj[8] = attributes[_mod7791.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[_mod7791.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== getSpanStatusFromHttpCode.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(7793).SPAN_STATUS_OK) {
