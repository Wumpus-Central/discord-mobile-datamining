// _runtime/07269_CardContainer.js
import Link from "01485_Link.js";
import _mod5850 from "metro/05850__.js";
import ModalPresentationContext from "07259_ModalPresentationContext.js";
import _mod7270 from "metro/07270__.js";
import CardA11yWrapper from "07271_CardA11yWrapper.js";
import _mod7272 from "metro/07272__.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5850.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7270.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7270;
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5850.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5850;
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5850.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5850.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5850.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7272.Card, obj5);
