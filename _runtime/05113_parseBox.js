// _runtime/05113_parseBox.js
import getDataView from "05104_getDataView.js";
import parseItemLocationBox from "05114_parseItemLocationBox.js";
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5104).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5104);
            }
          }
        }
      } else {
