      ...
      return {
        localeError: (code) => {
          ...
          switch (code) {
            ...
            case "ZodDate":
              code = closure_2;
              let expected = code[code.expected];
              if (expected == null) {
                expected = code.expected;
              }
              const parsedTypeResult = closure_2.parsedType(code.input);
              let tmp52 = code[parsedTypeResult];
              if (tmp52 == null) {
                tmp52 = parsedTypeResult;
              }
              if (obj.test(code.expected)) {
                const _HermesInternal17 = HermesInternal;
                let combined = "Ge\u00E7ersiz de\u011Fer: beklenen instanceof " + code.expected + ", al\u0131nan " + tmp52;
              } else {
                const _HermesInternal16 = HermesInternal;
                combined = "Ge\u00E7ersiz de\u011Fer: beklenen " + expected + ", al\u0131nan " + tmp52;
              }
              return combined;
            case "D":
            break;
            ...
            case "MarkupParserNodeTypeError":
              ...
              if (tmp20) {
                ...
                let combined3 = "\u00C7ok k\u00FC\u00E7\u00FCk: beklenen " + origin + " " + str22 + str1 + " " + tmp20.unit;
              } else {
            ...
            case "BOT_HTTP_INTERACTIONS":
              ...
              let combined5 = "Tan\u0131nmayan anahtar" + str5 + ": " + joinValuesResult;
              return combined5;
            case "H":
            break;
            case "HT":
              let _HermesInternal2 = HermesInternal;
              let combined6 = "" + code.origin + " i\u00E7inde ge\u00E7ersiz anahtar";
              return combined6;
            case "TP":
            break;
            case "P":
            ...
            case "NSFW_SPACE_WARNING_MODAL_CLICKED":
              ...
              let combined7 = "" + code.origin + " i\u00E7inde ge\u00E7ersiz de\u011Fer";
              return combined7;
            case "rm":
            break;
            case "m":
            ...
            case "DEFAULT_STEP_RESOLUTION":
              ...
              str = " i\u00E7inde ge\u00E7ersiz de\u011Fer";
              combined7 = "" + code.origin + " i\u00E7inde ge\u00E7ersiz de\u011Fer";
              return combined7;
            ...
            case "USER_LOGIN":
              ...
              combined5 = "Tan\u0131nmayan anahtar" + str5 + ": " + joinValuesResult;
              return combined5;
            case "USER_LOGIN_FLOW":
            break;
            case "WANT_TO_PLAY_GAMES":
              _HermesInternal2 = HermesInternal;
              combined6 = "" + code.origin + " i\u00E7inde ge\u00E7ersiz anahtar";
              return combined6;
            case "_$esjava$limit":
            break;
