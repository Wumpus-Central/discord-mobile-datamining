// _runtime/16626__getAppleDeclaredAgeRangeStatus.js
import importDefaultResult from "module_16629";
...
export const setAgeRangeThresholds = (arg0) => {
  const ageRangeThresholdManager = callback(16627).ageRangeThresholdManager;
...
export const PlayAgeRangeDeclarationUserStatus = require("module_16629").PlayAgeRangeDeclarationUserStatus;
export const PlayAgeRangeDeclarationUserStatusString = require("module_16629").PlayAgeRangeDeclarationUserStatusString;