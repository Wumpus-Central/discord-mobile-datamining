// _runtime/07563_createEventEnvelope.js
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    const obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(7567).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(7567);
  }
