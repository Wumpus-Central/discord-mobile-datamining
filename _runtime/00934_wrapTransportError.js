// _runtime/00934_wrapTransportError.js
...
export const wrapTransportOnMessage = function wrapTransportOnMessage(closure_0, closure_02) {
  ...
  if (closure_0.onmessage) {
    require("00819_addNonEnumerableProperty.js").fill(closure_0, "onmessage", (arg0) => {
      closure_0 = arg0;
...
export const wrapTransportSend = function wrapTransportSend(closure_0, closure_02) {
  const _require = closure_02;
  if (closure_0.send) {
    require("00819_addNonEnumerableProperty.js").fill(closure_0, "send", (arg0) => {
      closure_0 = arg0;
