// _runtime/05439_findOffsets.js
import _mod5430 from "metro/05430__.js";
import _modDef5433 from "metro/05433__.js";
import get64BitValue from "05440_get64BitValue.js";
...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint321) {
      const obj4 = { type: "ftyp", majorBrand: _mod5430.getStringFromDataView(getUint32, contentOffset, 4), length };
      return obj4;
      ...
      const stringFromDataView = _mod5430.getStringFromDataView(getUint32, contentOffset, 4);
      ...
      if (1835365473 === uint321) {
        ...
        if (!tmp3) {
          ...
          const sum8 = sum7 + 2;
          obj17.itemName = _mod5430.getNullTerminatedStringFromDataView(getUint32, sum8);
        ...
        if (uint8 >= 2) {
          ...
          const sum12 = sum11 + 4;
          obj17.itemName = _mod5430.getNullTerminatedStringFromDataView(getUint32, sum12);
          const sum13 = sum12 + (obj17.itemName.length + 1);
          if (obj17.itemType === c4) {
            obj17.contentType = _mod5430.getNullTerminatedStringFromDataView(getUint32, sum13);
            const sum14 = sum13 + (obj17.contentType.length + 1);
            parseItemLocationBoxResult = obj17;
            if (sum + length > sum14) {
              obj17.contentEncoding = _mod5430.getNullTerminatedStringFromDataView(getUint32, sum14);
              const sum15 = obj17.contentEncoding.length + 1;
              parseItemLocationBoxResult = obj17;
              const tmp13Result3 = _mod5430;
            }
            const tmp13Result = _mod5430;
          } else {
            parseItemLocationBoxResult = obj17;
            if (obj17.itemType === c5) {
              obj17.itemUri = _mod5430.getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj17.itemUri.length + 1;
              parseItemLocationBoxResult = obj17;
              const tmp13Result4 = _mod5430;
            }
          }
        }
      } else {
