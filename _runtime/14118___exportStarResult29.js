// _runtime/14118___exportStarResult29.js
import digitsToString from "14099_digitsToString.js";
...
export const ToRawPrecision = function ToRawPrecision(
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(14100).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(14100).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(14100).repeat("0", -num3 - 1)}${arr}`;
