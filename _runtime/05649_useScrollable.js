// _runtime/05649_useScrollable.js
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(require("05634_GESTURE_SOURCE.js").SCROLLABLE_TYPE.UNDETERMINED);
  ...
  const sharedValue2 = require("01652_cancelAnimation.js").useSharedValue(
    require("05634_GESTURE_SOURCE.js").SCROLLABLE_STATE.UNDETERMINED,
  );
