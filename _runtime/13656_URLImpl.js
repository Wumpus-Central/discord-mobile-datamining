...
class URLImpl {
  constructor(arg0, arg1) {
    ...
    if (null === basicURLParseResult1) {
      ...
      tmp7Result = require("module_13661");
      items = [];
      items[0] = str;
...
let items = [
  {
    key: "href",
    get() {
      return URLImpl(13657).serializeURL(this._url);
    },
    set(arg0) {
      const basicURLParseResult = URLImpl(13657).basicURLParse(arg0);
      if (null === basicURLParseResult) {
        ...
        if (null !== query) {
          self._query._list = tmp(13660).parseUrlencoded(query);
          const tmpResult = tmp(13660);
        }
      }
      const obj = URLImpl(13657);
      tmp = URLImpl;
    }
  },
  {
    key: "origin",
    get() {
      return URLImpl(13657).serializeURLOrigin(this._url);
    }
  },
  {
    key: "protocol",
  ...
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13657).setTheUsername(this._url, arg0);
        const tmpResult = URLImpl(13657);
      }
    }
  },
  {
    ...
    set(arg0) {
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        URLImpl(13657).setThePassword(this._url, arg0);
        const tmpResult = URLImpl(13657);
      }
    }
  },
  {
    ...
    get() {
      ...
      if (null === host.host) {
        ...
        host = host.host;
        let serializeHostResult = URLImpl(13657).serializeHost(host);
        const obj3 = URLImpl(13657);
      } else {
        const obj = URLImpl(13657);
        const text = `${obj.serializeHost(host.host)}:`;
        serializeHostResult = `${obj.serializeHost(host.host)}:${URLImpl(13657).serializeInteger(host.port)}`;
        const obj2 = URLImpl(13657);
      }
    },
    set(arg0) {
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.host) {
        str = URLImpl(13657).serializeHost(tmp._url.host);
        const obj = URLImpl(13657);
      }
      return str;
    },
  ...
  },
  {
    ...
    get() {
      ...
      if (null !== this._url.port) {
        str = URLImpl(13657).serializeInteger(tmp._url.port);
        const obj = URLImpl(13657);
      }
      return str;
    },
    set(arg0) {
      ...
      if (!obj.cannotHaveAUsernamePasswordPort(this._url)) {
        if ("" === arg0) {
          ...
          obj[0] = self._url;
          URLImpl(13657).basicURLParse(arg0, obj);
          const tmpResult = URLImpl(13657);
        }
      }
    }
  ...
  },
  {
    ...
    set(str) {
      ...
      if ("" === str) {
        ...
        self._query._list = URLImpl(13660).parseUrlencoded(substr);
      }
    }
  },
  {
