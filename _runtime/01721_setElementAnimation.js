// _runtime/01721_setElementAnimation.js
...
import BaseAnimationBuilder from "01722_BaseAnimationBuilder.js";
import weakMap from "01738_weakMap.js";
...
function setElementAnimation(dummy, dummyAnimationConfig, arg2) {
  ...
  if (dummyAnimationConfig.animationType === require("01677_isWorkletFunction.js").LayoutAnimationType.ENTERING) {
  ...
  if (!(animationName in require("01708_TransitionType.js").Animations)) {
...
arg5.handleExitingAnimation = function handleExitingAnimation(offsetParent, processedConfig) {
  ...
  require("01738_weakMap.js").setElementPosition(cloneNodeResult, rect);
