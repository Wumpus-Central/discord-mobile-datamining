// _runtime/05641__isNativeReflectConstruct.js
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5625).isRemoteDebuggingEnabled();
        obj = ContinousBaseGesture(5625);
      }
      return tmp;
    }
  }
