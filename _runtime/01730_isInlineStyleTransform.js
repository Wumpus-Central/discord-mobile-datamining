// _runtime/01730_isInlineStyleTransform.js
...
function getInlinePropsUpdate(viewDescriptors) {
  ...
  while (tmp2 !== undefined) {
    ...
    let obj2 = InlinePropManager(1683);
  ...
  obj,
  {
    ...
    value: function detachInlineProps() {
      if (this._inlinePropsMapperId) {
        InlinePropManager(1682).stopMapper(tmp._inlinePropsMapperId);
        const obj = InlinePropManager(1682);
      }
    }
  }
];
