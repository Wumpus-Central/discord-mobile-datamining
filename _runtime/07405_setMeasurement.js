...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (activeSpan) {
    rootSpan = require(7368) /* spanTimeInputToSeconds */.getRootSpan(activeSpan);
    const obj3 = require(7368) /* spanTimeInputToSeconds */;
  }
  if (rootSpan) {
    if (require(7391) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      const logger = tmp9(7363).logger;
      const _HermesInternal = HermesInternal;
      logger.log("[Measurement] Setting measurement on root span: " + arg0 + " = " + arg1 + " " + arg2);
    }
    obj = {};
    obj[require(7378).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[require(7378).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
