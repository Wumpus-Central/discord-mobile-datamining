// _runtime/12876__getEventFilterUrl.js
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod12829.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + _mod12812.getEventDescription(tmp));
      const tmp6Result = _mod12812;
    }
    return null;
  }
}
        ...
        if (_mod12829.DEBUG_BUILD) {
          ...
          logger5.warn(
            "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " +
              _mod12812.getEventDescription(type),
          );
          flag6 = true;
        }
      } else {
