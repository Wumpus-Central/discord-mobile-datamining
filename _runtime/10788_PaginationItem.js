...
export const PaginationItem = (animValue) => {
  ...
  size = { horizontal, height: size, width: num, index, animValue: iter, count, interpolate: iter(count[3]).interpolate, Extrapolation: iter(count[3]).Extrapolation };
  fn.__closure = size;
  fn.__workletHash = 1536479533103;
  fn.__initData = __initData;
  let items = [iter, index, count, horizontal];
  let obj = { onPress, accessibilityLabel, accessibilityRole: "button", accessibilityHint: null, accessibilityState: null, children: null };
  let str = "";
