...
let fn = function n(toValue, userConfig, callback) {
  ...
  const fn = function u() {
    let obj = { damping: 10, mass: 1, stiffness: 100, overshootClamping: false, restDisplacementThreshold: 0.01, restSpeedThreshold: 2, velocity: 0, duration: 2000, dampingRatio: 0.5, reduceMotion: "children", clamp: "delete" };
  ...
  obj = { userConfig, checkIfConfigIsValid: require("01736_checkIfConfigIsValid.js").checkIfConfigIsValid, underDampedSpringCalculations: require("01736_checkIfConfigIsValid.js").underDampedSpringCalculations, criticallyDampedSpringCalculations: require("01736_checkIfConfigIsValid.js").criticallyDampedSpringCalculations, isAnimationTerminatingCalculation: require("01736_checkIfConfigIsValid.js").isAnimationTerminatingCalculation, calculateNewMassToMatchDuration: require("01736_checkIfConfigIsValid.js").calculateNewMassToMatchDuration, initialCalculations: require("01736_checkIfConfigIsValid.js").initialCalculations, scaleZetaToMatchClamps: require("01736_checkIfConfigIsValid.js").scaleZetaToMatchClamps, toValue, callback, getReduceMotionForAnimation: require("01693_isValidLayoutAnimationProp.js").getReduceMotionForAnimation };
  fn.__closure = obj;
