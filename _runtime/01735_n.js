// _runtime/01735_n.js
import { isValidLayoutAnimationProp } from "01693_isValidLayoutAnimationProp.js";
const require = arg1;
...
let fn = function n(toValue, userConfig, callback) {
    ...
    obj = {
      ...
      onStart(toValue, current, arg2, lastTimestamp) {
        ...
        if (lastTimestamp) {
          ...
          } = obj(closure_1_1[1]).initialCalculations(mass, tmp));
  ...
  obj = {
    userConfig,
    checkIfConfigIsValid: require("01736_checkIfConfigIsValid.js").checkIfConfigIsValid,
    underDampedSpringCalculations: require("01736_checkIfConfigIsValid.js").underDampedSpringCalculations,
    criticallyDampedSpringCalculations: require("01736_checkIfConfigIsValid.js").criticallyDampedSpringCalculations,
    isAnimationTerminatingCalculation: require("01736_checkIfConfigIsValid.js").isAnimationTerminatingCalculation,
    calculateNewMassToMatchDuration: require("01736_checkIfConfigIsValid.js").calculateNewMassToMatchDuration,
    initialCalculations: require("01736_checkIfConfigIsValid.js").initialCalculations,
    scaleZetaToMatchClamps: require("01736_checkIfConfigIsValid.js").scaleZetaToMatchClamps,
    toValue,
    callback,
    getReduceMotionForAnimation: require("01693_isValidLayoutAnimationProp.js").getReduceMotionForAnimation,
  };
  fn.__closure = obj;
...
fn.__closure = {
  ...
  checkIfConfigIsValid: require("checkIfConfigIsValid").checkIfConfigIsValid,
  underDampedSpringCalculations: require("checkIfConfigIsValid").underDampedSpringCalculations,
  criticallyDampedSpringCalculations: require("checkIfConfigIsValid").criticallyDampedSpringCalculations,
  isAnimationTerminatingCalculation: require("checkIfConfigIsValid").isAnimationTerminatingCalculation,
  calculateNewMassToMatchDuration: require("checkIfConfigIsValid").calculateNewMassToMatchDuration,
  initialCalculations: require("checkIfConfigIsValid").initialCalculations,
  scaleZetaToMatchClamps: require("checkIfConfigIsValid").scaleZetaToMatchClamps,
  getReduceMotionForAnimation: require("isValidLayoutAnimationProp").getReduceMotionForAnimation,
};
