...
let fn = function n(toValue, userConfig, callback) {
  ...
  obj = { userConfig, checkIfConfigIsValid: _require(1736).checkIfConfigIsValid, underDampedSpringCalculations: _require(1736).underDampedSpringCalculations, criticallyDampedSpringCalculations: _require(1736).criticallyDampedSpringCalculations, isAnimationTerminatingCalculation: _require(1736).isAnimationTerminatingCalculation, calculateNewMassToMatchDuration: _require(1736).calculateNewMassToMatchDuration, initialCalculations: _require(1736).initialCalculations, scaleZetaToMatchClamps: _require(1736).scaleZetaToMatchClamps, toValue, callback, getReduceMotionForAnimation: _require(1693).getReduceMotionForAnimation };
  fn.__closure = obj;
