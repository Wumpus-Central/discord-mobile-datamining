// _runtime/13235_extraErrorDataIntegration.js
        ...
        if (obj2.isError(obj.originalException)) {
          ...
          if (tmp7) {
            ...
            if (tmp4Result.isPlainObject(normalizeResult)) {
              const result = _mod13151.addNonEnumerableProperty(normalizeResult, "__sentry_skip_normalization__", true);
              obj3[tmp6] = normalizeResult;
              const tmp4Result2 = _mod13151;
            }
            let obj4 = {};
