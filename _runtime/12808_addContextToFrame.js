// _runtime/12808_addContextToFrame.js
import addNonEnumerableProperty from "12803_addNonEnumerableProperty.js";
import isMatchingPattern from "12806_isMatchingPattern.js";
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.pre_context = substr.map((arg0) => callback(12806).snipLine(arg0, 0));
    const _Math5 = Math;
    ...
    lineno.post_context = substr1.map((arg0) => callback(12806).snipLine(arg0, 0));
