// _runtime/04691_ScreenStackHeaderSubview.js
import noopDefault from "00019_noop.js";
import get_controlledBottomTabsDefault from "04689_get_controlledBottomTabs.js";
import context from "04692_context.js";
import __INTERNAL_VIEW_CONFIGDefault from "metro/04695___INTERNAL_VIEW_CONFIG.js";
...
const forwardRefResult = noopDefault.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4688).isHeaderBarButtonsAvailableForCurrentPlatform) {
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4688).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4689).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4694), {});
});
