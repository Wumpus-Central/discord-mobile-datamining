// _runtime/09093_XorAndSalsa.js
import asyncGeneratorStep from "asyncGeneratorStep";
import { _asyncLoop } from "09094__asyncLoop.js";
import { pbkdf2Init } from "09097_pbkdf2Init.js";
import { _isNativeReflectConstruct } from "09099__isNativeReflectConstruct.js";
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9094).isLE) {
                callback(9094).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
