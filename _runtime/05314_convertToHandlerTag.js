// _runtime/05314_convertToHandlerTag.js
...
function convertToHandlerTag(handlerTag) {
  if (typeof handlerTag === "Object") {
    return handlerTag;
  } else if (handlerTag instanceof require(5316) /* _isNativeReflectConstruct */.BaseGesture) {
...
export const useWebEventHandlers = function useWebEventHandlers() {
  const obj = {
    onGestureHandlerEvent(nativeEvent) {
      const result = callback(5279).onGestureHandlerEvent(nativeEvent.nativeEvent);
    },
