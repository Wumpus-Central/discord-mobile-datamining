// _runtime/12622_createTransport.js
import { makePromiseBuffer } from "12623_makePromiseBuffer.js";
const require = arg1;
  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(12603).envelopeItemTypeToDataCategory(arg1);
        const obj = items(12603);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss
          .add(() => {
            const obj = { body: items(12603).serializeEnvelope(dependencyMap) };
            const obj2 = items(12603);
            return dependencyMap(obj).then(
              ...
              (arg0) => {
                ...
                items(table[1]).forEachEnvelopeItem(table, (arg0, arg1) => {
                  ...
                  network_error.recordDroppedEvent(
                    network_error,
                    closure_2_0(closure_2_1[1]).envelopeItemTypeToDataCategory(arg1),
                    tmp,
                  );
                });
                throw arg0;
          ...
          .then(
            (arg0) => arg0,
            (arg0) => {
              if (arg0 instanceof items(12616).SentryError) {
