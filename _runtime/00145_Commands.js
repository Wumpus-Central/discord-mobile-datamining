...
obj = {
  ...
  textShadowColor: require("result").colorAttribute,
  maxLength: true,
  selectTextOnFocus: true,
  textShadowRadius: true,
  underlineColorAndroid: require("result").colorAttribute,
  textDecorationLine: true,
  submitBehavior: true,
  textAlignVertical: true,
  fontStyle: true,
  textShadowOffset: true,
  selectionColor: require("result").colorAttribute,
  selectionHandleColor: require("result").colorAttribute,
  placeholderTextColor: require("result").colorAttribute,
  ...
  keyboardType: true,
  multiline: true,
  color: require("result").colorAttribute,
  autoComplete: true,
  numberOfLines: true,
  letterSpacing: true,
  returnKeyLabel: true,
  fontSize: true,
  onKeyPress: true,
  cursorColor: require("result").colorAttribute,
  text: true,
