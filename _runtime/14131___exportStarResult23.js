// _runtime/14131___exportStarResult23.js
...
import match from "14132_match.js";
...
arg5.InitializeNumberFormat = function InitializeNumberFormat(arg0, arg1, arg2, arg3) {
  ...
  if ("currency" === style) {
    ...
    if ("compact" === GetOptionResult1) {
      internalSlots.compactDisplay = tmp(14105).GetOption(
        result1,
        "compactDisplay",
        "string",
        ["short", "long"],
    ...
    internalSlots.useGrouping = tmp(14107).GetStringOrBooleanOption(
      result1,
      "useGrouping",
      ["min2", "auto", "always"],
      "always",
    ...
    internalSlots.signDisplay = tmp(14105).GetOption(
      result1,
      "signDisplay",
      "string",
