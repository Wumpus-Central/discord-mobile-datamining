// _runtime/12942__getEventFilterUrl.js
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod12895.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + _mod12878.getEventDescription(tmp));
      const tmp6Result = _mod12878;
    }
    return null;
  }
}
        ...
        if (_mod12895.DEBUG_BUILD) {
          ...
          logger5.warn(
            "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " +
              _mod12878.getEventDescription(type),
          );
          flag6 = true;
        }
      } else {
