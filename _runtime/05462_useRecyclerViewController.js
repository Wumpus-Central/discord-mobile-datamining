// _runtime/05462_useRecyclerViewController.js
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  const unmountFlag = _require(5464).useUnmountFlag();
  let obj = _require(5464);
  ...
  _setTimeout = _require(5465).useUnmountAwareTimeout().setTimeout;
            ...
            if (tmp < obj.getDataLength()) {
              ...
              function performScrollStep(arg0) {
                ...
                if (outer2_3.current) {
                  ...
                  if (typeof finishScrollToIndex !== "fileFinishedImporting") {
