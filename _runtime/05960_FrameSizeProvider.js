// _runtime/05960_FrameSizeProvider.js
import _modDef1506 from "metro/01506__.js";
import _mod5962 from "metro/05962__.js";
...
const __react_navigation__elements_contexts = fn(5961);
...
export const FrameSizeProvider = function FrameSizeProvider(initialFrame) {
  ...
  noop.useRef(size);
  noop.useRef(new Set());
  let tmp2 = _modDef1506(() => ref.current);
