...
arg5.useScrollHandler = (arg0, onScroll, onScrollBeginDrag, onScrollEndDrag) => {
  ...
  if (arg0 === undefined) {
    useScrollEventsHandlersDefault = _require(6654).useScrollEventsHandlersDefault;
  }
  _require = onScroll;
  ...
  const tmp3Result = _require(1636);
  fn2.__closure = { handleOnBeginDrag: workletNoop2, onScrollBeginDrag, runOnJS: _require(1636).runOnJS };
  ...
  const obj2 = { handleOnBeginDrag: workletNoop2, onScrollBeginDrag, runOnJS: _require(1636).runOnJS };
  O.__closure = { handleOnEndDrag: workletNoop3, onScrollEndDrag, runOnJS: _require(1636).runOnJS };
