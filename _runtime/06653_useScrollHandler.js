// _runtime/06653_useScrollHandler.js
...
arg5.useScrollHandler = (arg0, onScroll, onScrollBeginDrag, onScrollEndDrag) => {
  ...
  if (arg0 === undefined) {
    useScrollEventsHandlersDefault = require("06654_useScrollEventsHandlersDefault.js").useScrollEventsHandlersDefault;
  }
  _require = onScroll;
  ...
  fn2.__closure = {
    ...
    onScrollBeginDrag,
    runOnJS: require("01636_cancelAnimation.js").runOnJS,
  };
