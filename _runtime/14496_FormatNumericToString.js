// _runtime/14496_FormatNumericToString.js
import TEN from "14482_TEN.js";

const _mod14480 = tmp5(14480);
const GetUnsignedRoundingMode = tmp5(14497);
const ToRawPrecision = tmp5(14498);
const ToRawFixed = tmp5(14499);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14480.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14480.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
