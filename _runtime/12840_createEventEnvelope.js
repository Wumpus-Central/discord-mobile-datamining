// _runtime/12840_createEventEnvelope.js
import forEachEnvelopeItem from "12841_forEachEnvelopeItem.js";
import __SENTRY_DEBUG__ from "metro/12796___SENTRY_DEBUG__.js";
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(12844).dsnToString(dsn);
    tmp9 = obj1;
