// _runtime/13689___exportStarResult13.js
import digitsToString from "13674_digitsToString.js";
import __exportStarResult14 from "13690___exportStarResult14.js";
import __exportStarResult21 from "13691___exportStarResult21.js";
  ...
  if (timesResult.isZero()) {
    ...
    if (roundedNumber.isZero()) {
      ...
      if (floorResult1.eq(floorResult.minus(result))) {
        ...
        const items2 = [tmp2(13690).ComputeExponentForMagnitude(internalSlots, floorResult.plus(1)), floorResult.plus(1).toNumber()];
        return items2;
      }
