  ...
  if (this.isFinite()) {
    if (self.e < 0) {
      ...
      if (Math.max(sdResult, precision) < 2 * -self.e - 1) {
        ...
        constructor.precision = precision;
        constructor.rounding = rounding;
        timesResult = f118718(plusResult, constructor2.minus(self), diff + precision, 1).ln().times(0.5);
              ...
              if (0 != tmp12) {
                ...
                if (e <= constructor.maxE + 1) {
                  if (e >= constructor.minE - 1) {
                    ...
                    if (d) {
                      sum = precision + 10;
                      const tmp55Result = naturalExponential(constructor1.times(naturalLogarithm(constructor2, sum + bound)), sum);
