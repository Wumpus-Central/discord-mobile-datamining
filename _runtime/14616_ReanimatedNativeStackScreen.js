// _runtime/14616_ReanimatedNativeStackScreen.js
import _mod1614 from "metro/01614__.js";
import cancelAnimation2 from "01636_cancelAnimation.js";
import _modDef14617 from "metro/14617__.js";
import _modDef14618 from "metro/14618__.js";
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  obj = {
    value: sharedValue,
    children: jsx(_modDef14617.Provider, {
      ref,
  ...
  obj.children = jsx(_modDef14618.Provider, {
    value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 },
    children: children.children,
  });
  return (
    <closure_7 value={sharedValue}>
      {jsx(_modDef14617.Provider, { ref, onTransitionProgressReanimated: null, onHeaderHeightChangeReanimated: null })}
    </closure_7>
  );
});
