// === Module 1056: extractNetworkProtocol ===
...
export const startAndEndSpan = function startAndEndSpan(activeSpan, sum, sum1, arg3) {
  ...
  if (arg3 == null) {
    ...
    const start_timestamp = _require(814).spanToJSON(activeSpan).start_timestamp;
    ...
    const tmp6 = _require;
    return _require(814).withActiveSpan(activeSpan, () => {
      let obj = sum(sum1[1]);
      obj = { startTime: sum };
