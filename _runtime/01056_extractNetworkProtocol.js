// _runtime/01056_extractNetworkProtocol.js
...
export const listenForWebVitalReportEvents = function listenForWebVitalReportEvents(on, arg1) {
  const _require = arg1;
  c2 = false;
  require("01057_onHidden.js").onHidden(() => {
    let tmp = !c2;
    if (!c2) {
      tmp = closure_1;
    }
...
export const startAndEndSpan = function startAndEndSpan(activeSpan, sum, sum1, arg3) {
  ...
  if (arg3 == null) {
    ...
    const start_timestamp = require("00814_registerSpanErrorInstrumentation.js").spanToJSON(activeSpan).start_timestamp;
    ...
    const tmp6 = _require;
    return require("00814_registerSpanErrorInstrumentation.js").withActiveSpan(activeSpan, () => {
      let obj = sum(sum1[1]);
      obj = { startTime: sum };
...
export const startStandaloneWebVitalSpan = function startStandaloneWebVitalSpan(arg0) {
  ...
  if (client) {
    ...
    try {
      ...
      obj[4] = replayId;
      obj[5] = transaction;
      const _navigator = tmp(1036).WINDOW.navigator;
      let userAgent;
      if (_navigator != null) {
