// _runtime/05766_useAnimatedSnapPoints.js
...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: require("05593_DEFAULT_HANDLE_HEIGHT.js").INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: require("05593_DEFAULT_HANDLE_HEIGHT.js").INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: require("05606_normalizeSnapPoint.js").normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: require("05593_DEFAULT_HANDLE_HEIGHT.js").INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
  ...
  class N {
    constructor() {
      if (closure_4) {
        ...
        tmp = !length;
        if (length) {
          tmp = !items.find(/* F107815 */ function() { ... });
        }
        return !tmp;
      }
    }
