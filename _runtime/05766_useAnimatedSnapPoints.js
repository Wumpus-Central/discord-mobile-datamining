// === Module 5766: useAnimatedSnapPoints ===
...
arg5.useAnimatedSnapPoints = (snapPoints, containerHeight, contentHeight, handleHeight, arg4, enableDynamicSizing, maxDynamicContentSize) => {
  ...
  obj = { containerHeight, INITIAL_CONTAINER_HEIGHT: _require(5593).INITIAL_CONTAINER_HEIGHT, INITIAL_SNAP_POINT: _require(5593).INITIAL_SNAP_POINT, snapPoints, normalizeSnapPoint: _require(5606).normalizeSnapPoint, enableDynamicSizing, handleHeight, INITIAL_HANDLE_HEIGHT: _require(5593).INITIAL_HANDLE_HEIGHT, contentHeight, maxDynamicContentSize, dynamicSnapPointIndex: sharedValue };
  P.__closure = obj;
  ...
  const derivedValue = _require(1654).useDerivedValue(P, items);
  ...
  let items1 = [derivedValue, sharedValue, _require(1654).useDerivedValue(N)];
  return items1;
};