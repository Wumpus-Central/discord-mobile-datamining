...
import _isNativeReflectConstruct2 from "10588__isNativeReflectConstruct.js";
...
const items = [
  {
    ...
    value: function innerPatternString(arg0) {
      return (
        "(?:\u0437|\u0456\u0437)?\\s*(" +
        UKMonthNameLittleEndianParser(10586).ORDINAL_NUMBER_PATTERN +
        ")(?:\\s{0,3}(?:\u043F\u043E|-|\u2013|\u0434\u043E)?\\s{0,3}(" +
        UKMonthNameLittleEndianParser(10586).ORDINAL_NUMBER_PATTERN +
        "))?(?:-|\\/|\\s{0,3}(?:of)?\\s{0,3})(" +
        UKMonthNameLittleEndianParser(10432).matchAnyPattern(UKMonthNameLittleEndianParser(10586).MONTH_DICTIONARY) +
        ")(?:(?:-|\\/|,?\\s{0,3})(" +
        UKMonthNameLittleEndianParser(10586).YEAR_PATTERN +
        "(?![^\\s]\\d)))?"
      );
    },
  },
