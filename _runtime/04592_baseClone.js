  ...
  if (!arg2) {
    {
      if (isObject(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4593)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4594)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(621)(arr)) {
            return tmp32(4595)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (obj[tmp11]) {
                  tmp14 = tmp32(4609)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4599);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4603)(obj, arr));
                } else {
                  tmp32Result = tmp32(4607);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4608)(obj, arr));
                }
