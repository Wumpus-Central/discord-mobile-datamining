      ...
      while (true) {
        ...
        while (!str3) {
          ...
          switch (symbol) {
            ...
            case "vol":
            break;
            case "VIRTUAL_CURRENCY_SET_BALANCE_PILL_OVERLAY":
            break;
            case "OVERLAY_V3_DISABLED":
            break;
            case "ACCEPT_QUEST":
            break;
            case "QUESTS_ENROLL":
            ...
            case "SKU":
            break;
            case "getChatInputHeightAnimationTiming":
            break;
            case "disableAppCollectionsCache":
            break;
            case "ACCOUNT_DELETE":
            break;
            case "DELETE":
            ...
            case "isFavorite":
            break;
            case "isFavoriteEmojiWithoutFetchingLatest":
            break;
            case "money_bag":
            break;
            case "baggage_claim":
            break;
            case "claimBountyReward":
            break;
            case "isTypedArray":
            break;
            ...
            break;
            case "PRESS_SET_STATUS":
            break;
            case "STATUS_POSITIVE_TEXT":
            break;
            case "TEXT_NODE":
            break;
            case "DEV_SESSION_KEY":
            break;
            case "ACCOUNT_POPOUT":
            break;
            case "POP":
            ...
            break;
            case "_recordingOptions":
            break;
            case "shouldShowWarning":
            break;
            case "getKeyboardIsOpen":
            break;
            case "numExtraKeys":
            break;
            case "isCollectibleQuestRewardPremiumExtendable":
            break;
            case "loginWebAuthn":
            break;
            case "hnj":
            ...
            case "SPAN_STATUS_OK":
            break;
            case "onPressPronouns":
            break;
            case "unsafeContext":
            break;
            case "MCP_NOTIFICATION_ORIGIN_VALUE":
            break;
            case "EXPRESSION_PICKER_SOUNDBOARD_SOUNDS_LOADED":
            break;
            case "SOUNDBOARD_SOUND":
            break;
            case "LOADED_NOT_FOUND":
            break;
            case "UNDERLINE":
            break;
            ...
            break;
            case "DISPLAY_NAME_STYLES_FONT_FAMILY_MAP":
            break;
            ...
            case "krispEnabled":
            break;
            case "lastDismissedOutboundPromotionStartDate":
            break;
            case "Aj9ruN":
            break;
            case "parallaxLayout":
        ...
        if (freq2 >= obj3.HOURLY) {
          ...
          if (freq2 >= constants.SECONDLY) {
            ...
            if (!tmp26) {
              ...
              if (typeof tmp56 !== "error") {
                HermesBuiltin.throwTypeError();
              }
              if (typeof tmp22 !== "error") {
                HermesBuiltin.throwTypeError();
              }
              if (typeof tmp23 !== "error") {
                HermesBuiltin.throwTypeError();
              }
              let tmp29 = !tmp28;
              if (null != bysecond) {
