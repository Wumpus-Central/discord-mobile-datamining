// _runtime/05310_findOffsets.js
import _mod5301 from "metro/05301__.js";
import _modDef5304 from "metro/05304__.js";
import get64BitValue from "05311_get64BitValue.js";
      ...
      if (1835365473 === uint321) {
        ...
        if (uint8 >= 2) {
          ...
          if (obj17.itemType === c4) {
            obj17.contentType = _mod5301.getNullTerminatedStringFromDataView(getUint32, sum13);
            const sum14 = sum13 + (obj17.contentType.length + 1);
            parseItemLocationBoxResult = obj17;
            if (sum + length > sum14) {
              obj17.contentEncoding = _mod5301.getNullTerminatedStringFromDataView(getUint32, sum14);
              const sum15 = obj17.contentEncoding.length + 1;
              parseItemLocationBoxResult = obj17;
              const tmp13Result3 = _mod5301;
            }
            const tmp13Result = _mod5301;
          } else {
            parseItemLocationBoxResult = obj17;
            if (obj17.itemType === c5) {
              obj17.itemUri = _mod5301.getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj17.itemUri.length + 1;
              parseItemLocationBoxResult = obj17;
              const tmp13Result4 = _mod5301;
            }
          }
        }
      } else {
