...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5316).HeaderShownContext);
  let num5 = React.useContext(num6(5316).HeaderHeightContext);
  const context1 = React.useContext(num6(5316).HeaderBackContext);
  let obj3 = num6(5316);
  ...
  callback = obj2.useCallback(num6(8618).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4690).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4690).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5316).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5316);
  ...
  let eventResult;
  const headerConfigProps = num6(8619).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  obj15[1] = closure_10(num6(5316).HeaderBackContext.Provider, obj16);
  items5[2] = closure_10(num6(5316).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = closure_11(num6(5316).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(8621).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4690).ScreenStackItem, obj4);
