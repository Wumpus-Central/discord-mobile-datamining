// _runtime/04706_ScreenStackHeaderSubview.js
import _objectWithoutProperties from "_objectWithoutProperties";
import get_ActivityIndicator from "get ActivityIndicator";
import { jsx } from "jsxProd";
import { context } from "04707_context.js";
import { __INTERNAL_VIEW_CONFIG } from "metro/04710___INTERNAL_VIEW_CONFIG.js";
...
const forwardRefResult = require("noop").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4703).isHeaderBarButtonsAvailableForCurrentPlatform) {
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4703).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4704).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4709), {});
});
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = require("04704_get_controlledBottomTabs.js") /* get controlledBottomTabs */.experiment.synchronousHeaderSubviewUpdatesEnabled;
...
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = require("04704_get_controlledBottomTabs.js") /* get controlledBottomTabs */.experiment.synchronousHeaderSubviewUpdatesEnabled;
