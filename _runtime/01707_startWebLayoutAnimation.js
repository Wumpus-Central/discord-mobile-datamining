...
import TransitionType from "01708_TransitionType.js";
...
function startWebLayoutAnimation(props, _componentDOMRef, ENTERING, easingY) {
  ...
  if (entering) {
    ...
    let flag =
      !(animationWithInitialValues in tmp(1708).Animations) &&
      !(ENTERING === tmp(1677).LayoutAnimationType.LAYOUT || tmp5 || undefined !== entering.initialValues);
    if (flag) {
