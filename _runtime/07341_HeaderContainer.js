// _runtime/07341_HeaderContainer.js
import Link from "01485_Link.js";
import _mod5936 from "metro/05936__.js";
...
export const HeaderContainer = function HeaderContainer(getFocusedRoute) {
  ...
  closure_6 = noop.useContext(_mod5936.HeaderBackContext);
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = {
                  title: require("metro/05936__.js").getHeaderTitle(tmp11, route.name),
                  href: buildHref(route.name, route.params),
                };
                tmp9 = obj2;
                const obj3 = require("metro/05936__.js");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("metro/07342__.js").forSlideRight;
                    } else {
                      forSlideUp = require("metro/07342__.js").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("metro/07342__.js").forSlideUp;
              }
            } else {
              forNoAnimation = require("metro/07342__.js").forNoAnimation;
            }
