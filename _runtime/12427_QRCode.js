// _runtime/12427_QRCode.js
import QR8bitByte from "12428_QR8bitByte.js";
import QRRSBlock from "12430_QRRSBlock.js";
import QRBitBuffer from "12432_QRBitBuffer.js";
import _mod12433 from "metro/12433__.js";
import QRPolynomial from "12434_QRPolynomial.js";
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod12433.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod12433.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod12433.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
