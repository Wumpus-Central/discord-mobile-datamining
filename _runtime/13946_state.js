// _runtime/13946_state.js
import _mod13885 from "metro/13885__.js";
import __core_js_shared__ from "13901___core-js_shared__.js";
import call from "13908_call.js";
import _mod13930 from "metro/13930__.js";
import all from "13947_all.js";
import __core_js_shared__2 from "13948___core-js_shared__.js";
  ...
  if (!__core_js_shared__.state) {
    ...
    let fn = function t(facade) {
      if (call(facade, closure_6)) {
        const typeError = new tmp(13885).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(13941)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
...
if (!state) {
  ...
  const weakMap = new _mod13885.WeakMap();
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new _mod13885.TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
