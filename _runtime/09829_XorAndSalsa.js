// _runtime/09829_XorAndSalsa.js
import _asyncLoop from "09830__asyncLoop.js";
import pbkdf2Init from "09833_pbkdf2Init.js";
import _isNativeReflectConstruct from "09835__isNativeReflectConstruct.js";
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9830).isLE) {
                callback(9830).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
