// _runtime/07537_setMeasurement.js
import { spanTimeInputToSeconds } from "07500_spanTimeInputToSeconds.js";
import { 07510__ } from "metro/07510__.js";
import { __SENTRY_DEBUG__ } from "metro/07523___SENTRY_DEBUG__.js";
const require = arg1;
...
arg5.setMeasurement = function setMeasurement(arg0, arg1, arg2) {
  ...
  if (rootSpan) {
    if (__SENTRY_DEBUG__.DEBUG_BUILD) {
      const logger = tmp9(7495).logger;
      const _HermesInternal = HermesInternal;
      logger.log("[Measurement] Setting measurement on root span: " + arg0 + " = " + arg1 + " " + arg2);
    }
    obj = {};
    obj[07510__.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = arg1;
    obj[07510__.SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_UNIT] = arg2;
