// _runtime/08582_appendTransformProps.js
import append from "08583_append.js";
import peg$SyntaxError from "08584_peg_SyntaxError.js";
import _mod8585 from "metro/08585__.js";
...
export const extractTransformSvgView = function extractTransformSvgView(transform) {
  if (typeof transform.transform === "string") {
    transform = _mod8585.parse(transform.transform);
  } else {
    transform = transform.transform;
  }
  return transform;
