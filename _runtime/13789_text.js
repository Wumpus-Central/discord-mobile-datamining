...
import call2 from "13754_call.js";
import all from "13757_all.js";
import state from "13792_state.js";
import closure_2 from "13790___core-js_shared__.js";

let closure_5 = call("".slice);
let closure_6 = call("".replace);
let closure_7 = call([].join);
let closure_8 = getOwnPropertyDescriptor && !_mod13735(() => 8 !== defineProperty(() => {

}, "length", { value: 8 }).length);
const tmp = getOwnPropertyDescriptor && !_mod13735(() => 8 !== defineProperty(() => {
...
const fn = (toString, toString2) => {
  ...
  let tmp9 = !tmp8;
  if (tmp8) {
    tmp9 = tmp6(13791).CONFIGURABLE && toString.name !== text2;
    const tmp10 = tmp6(13791).CONFIGURABLE && toString.name !== text2;
  }
  if (tmp9) {
    if (tmp6(13734)) {
  ...
  try {
    if (arg2) {
      if (tmp6(13754)(arg2, "constructor")) {
        if (arg2.constructor) {
          if (tmp6(13734)) {
            defineProperty(toString, "prototype", { writable: false });
          }
        }
        const enforceResult = tmp6(13792).enforce(toString);
        if (!tmp6(13754)(enforceResult, "source")) {
          let str11 = "";
