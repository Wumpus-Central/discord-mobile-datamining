// === Module 5567: constructTag ===

// Module 5567 (constructTag)
import _mod5520 from "module_5520" /* 5520 */;
import _modDef5523 from "module_5523" /* 5523 */;
import PNG_CHUNK_TYPE_SIZE from "PNG_CHUNK_TYPE_SIZE" /* 5527 */;
  ...
  read(byteLength, arg1, arg2, arg3) {
    ...
    if (0 < arg1.length) {
      while (true) {
        ...
        let COMPRESSION_METHOD_NONE = require("module_5520").COMPRESSION_METHOD_NONE;
        ...
        let tmp38 = _require;
        if (tmp5 !== require("module_5520").COMPRESSION_METHOD_NONE) {
          if (!arg2) {
            let obj2 = {};
