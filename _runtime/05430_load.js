// _runtime/05430_load.js
import _modDef5431 from "metro/05431__.js";
...
function loadView(byteLength) {
  ...
  let obj2 = require("metro/05434__.js");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("metro/05434__.js").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("metro/05435__.js").USE_JPEG) {
    flag4 = false;
  ...
  const parseAppMarkersResult = require("metro/05434__.js").parseAppMarkers(byteLength, flag2);
