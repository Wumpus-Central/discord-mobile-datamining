// _runtime/04791_OrdinaryDefineOwnProperty.js
...
export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (isObject(arg0)) {
    if (tmp(4775)(arg1)) {
      if (tmp(4779)(__Writable__)) {
        if (tmp(542)) {
          const tmp30 = tmp(542)(arg0, arg1);
          let tmp31 = tmp30;
          if (tmp30) {
            tmp31 = tmp(4780)(tmp30);
          }
          return tmp(4794)(arg0, arg1, tmp(4793)(arg0), __Writable__, tmp31);
        } else if (tmp(4792)(__Writable__)) {
          ...
          return tmp(4784)(arg0[arg1], __Writable__["[[Value]]"]);
        }
      } else {
