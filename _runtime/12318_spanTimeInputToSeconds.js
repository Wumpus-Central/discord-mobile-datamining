// _runtime/12318_spanTimeInputToSeconds.js
import _mod12313 from "metro/12313__.js";
import _mod12319 from "metro/12319__.js";
import generatePropagationContext from "12323_generatePropagationContext.js";
import _mod12325 from "metro/12325__.js";
import _mod12327 from "metro/12327__.js";
import _mod12328 from "metro/12328__.js";
import _mod12329 from "metro/12329__.js";
import _mod12330 from "metro/12330__.js";
import _mod12331 from "metro/12331__.js";
import _mod12332 from "metro/12332__.js";
import _mod12335 from "metro/12335__.js";
import _mod12340 from "metro/12340__.js";
  ...
  if (typeof getTime === "number") {
    ...
    if (Array.isArray(getTime)) {
      ...
      if (getTime instanceof Date) {
        ...
        sum = _mod12327.timestampInSeconds();
      }
    }
  }
  return sum;
  ...
  if (
    ...
    try {
      ...
      if (
        ...
        obj3.op = attributes[_mod12328.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj3.origin = attributes[_mod12328.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
        const tmp8 = spanTimeInputToSeconds(endTime);
        obj3._metrics_summary = _mod12329.getMetricSummaryJsonForSpan(getSpanJSON);
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12330.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod12330.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod12319.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod12319.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
    const tmp3Result = _mod12319;
  }
};
export const getActiveSpan = function getActiveSpan() {
  ...
  if (asyncContextStrategy.getActiveSpan) {
    ...
    const tmpResult = _mod12335;
    activeSpan = tmpResult._getSpanForScope(_mod12340.getCurrentScope());
...
export const spanToTraceContext = function spanToTraceContext(spanContext) {
  ...
  return _mod12319.dropUndefinedKeys({ parent_span_id, span_id, trace_id: trace_id.traceId });
};
export const spanToTraceHeader = function spanToTraceHeader(spanContext) {
  ...
  return _mod12325.generateSentryTraceHeader(traceId, spanId, 1 === spanContext.spanContext().traceFlags);
};
export const spanToTransactionTraceContext = function spanToTransactionTraceContext(spanContext) {
  ...
  return _mod12319.dropUndefinedKeys({ parent_span_id, span_id, trace_id, data, op, status, origin });
};
