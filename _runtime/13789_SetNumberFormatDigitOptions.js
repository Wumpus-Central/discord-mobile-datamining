// _runtime/13789_SetNumberFormatDigitOptions.js
...
export const SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(
  ...
  _mod13742.invariant(hasItem, combined.concat(Array.from(set).join(", "), "."));
  ...
  if (flag) {
    if (tmp12) {
      ...
      if (undefined === DefaultNumberOptionResult) {
        _mod13742.invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      _mod13742.invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
