// _runtime/metro/05155__.js
import _modDef5133 from "05133__.js";
import _modDef5152 from "05152__.js";
import styleDefault from "../05157_style.js";
...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  dependencyMap = flag5.useContext(screenId(5153).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(5156).isIOS26OrHigher;
  }
  _modDef5152(
    isIOS26OrHigher,
  ...
  if (screenId(5156).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(screenId(5160).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(screenId(5162).FooterComponent, obj7);
  }
