...
const regExp = new RegExp(
  "(questo|ultimo|scorso|prossimo|dopo\\s*questo|questa|ultima|scorsa|prossima\\s*questa)\\s*(" +
    repeatedTimeunitPattern.matchAnyPattern(_mod10730.TIME_UNIT_DICTIONARY) +
    ")(?=\\s*)(?=\\W|$)",
  "i",
);
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      if ("prossimo" != formatted) {
        if (!formatted.startsWith("dopo")) {
          ...
          const obj4 = {};
          obj4[tmp3] = -1;
          const ParsingComponents = ITRelativeDateFormatParser(10564).ParsingComponents;
          return ParsingComponents.createRelativeFromReference(createParsingComponents.reference, obj4);
        }
      }
      const ParsingComponents2 = ITRelativeDateFormatParser(10564).ParsingComponents;
