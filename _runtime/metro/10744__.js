  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if ("last" !== formatted) {
        ...
        const ParsingComponents = ENTimeUnitCasualRelativeFormatParser(10563).ParsingComponents;
        return ParsingComponents.createRelativeFromReference(reference.reference, reverseDurationResult);
      }
      reverseDurationResult = ENTimeUnitCasualRelativeFormatParser(10562).reverseDuration(parseDurationResult);
    },
  },
];
