// _runtime/metro/05100__.js
import getFileChunk from "../05097_getFileChunk.js";
import _mod5098 from "05098__.js";
import isAAC from "../05101_isAAC.js";
import is7Z from "../05102_is7Z.js";
import isAVIF from "../05103_isAVIF.js";
import isBLEND from "../05104_isBLEND.js";
import isAVI from "../05105_isAVI.js";
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = _mod5098.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = _mod5098.FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5098.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let tmp25 = tmp20;
        let tmp26 = tmp22;
        let FileTypes3 = tmp21(5098).FileTypes;
        let tmp27 = item10079;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5098.FileTypes;
