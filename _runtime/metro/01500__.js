...
import CommonActions2 from "../01489_CommonActions.js";
...
export const BaseNavigationContainer = noop.forwardRef(function BaseNavigationContainer(onReady, arg1) {
  ...
  obj2 = require("01502__.js");
  const syncState = require("01504__.js").useSyncState(() => {
  ...
  const tmpResult = require("01504__.js");
  const lazyValue = require("01507__.js").useLazyValue(() => {
  ...
  const tmpResult6 = require("01507__.js");
  const childListeners = require("01508__.js").useChildListeners();
  ({ listeners: c12, addListener } = childListeners);
  const tmpResult7 = require("01508__.js");
  const keyedChildListeners = require("01509__.js").useKeyedChildListeners();
  ...
  isReady = tmp20;
  const tmpResult8 = require("01509__.js");
  eventEmitter = require("01512__.js").useEventEmitter();
  const tmpResult9 = require("01512__.js");
  const optionsGetters = require("01513__.js").useOptionsGetters({});
  ...
  const tmpResult10 = require("01513__.js");
  ...
  obj9.children = scheduleUpdate(require("01519__.js").EnsureSingleNavigator, { children: scheduleUpdate(require("ThemeProvider").ThemeProvider, { value: theme, children }) });
