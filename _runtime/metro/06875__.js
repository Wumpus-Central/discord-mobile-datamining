...
// Module 6875
import tagMessage2 from "tagMessage" /* 6761 */;
import touchDataToPressEvent from "touchDataToPressEvent" /* 6857 */;
import StateMachineEvent2 from "StateMachineEvent" /* 6860 */;
import GestureObjects2 from "GestureObjects" /* 6876 */;
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6857).gestureToPressableEvent(handlerTag));
