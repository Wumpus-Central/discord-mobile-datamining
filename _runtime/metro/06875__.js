...
import handlerIDToTag2 from "../06852_handlerIDToTag.js";
...
import ghQueueMicrotask from "../06880_ghQueueMicrotask.js";
import ActionType from "../06881_ActionType.js";
...
let closure_10 = {
  [fn(6854).State.UNDETERMINED]: undefined,
  [fn(6854).State.BEGAN]: "onBegan",
  [fn(6854).State.FAILED]: "onFailed",
  [fn(6854).State.CANCELLED]: "onCancelled",
  [fn(6854).State.ACTIVE]: "onActivated",
  [fn(6854).State.END]: "onEnded",
};
