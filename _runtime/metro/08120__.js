...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5801).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08125__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08125__.js");
  const invalidPreventRemoveError = require("08126__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08126__.js");
  const modalRouteKeys = require("08127__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05801__.js").SafeAreaProviderCompat, obj4);
};
