...
export const createAttachmentEnvelopeItem = function createAttachmentEnvelopeItem(data) {
  if (typeof data.data === "string") {
    ...
    __SENTRY__ = __SENTRY__(12314).GLOBAL_OBJ.__SENTRY__;
    ...
    const items = [_mod12319.dropUndefinedKeys(obj3), data1];
    return items;
  }
};
...
export const createEventEnvelopeHeaders = function createEventEnvelopeHeaders(event_id, sdk, arg2, url) {
  ...
  let tmp4 = arg2 && url;
  if (tmp4) {
    const obj3 = { dsn: _mod12360.dsnToString(url) };
    tmp4 = obj3;
  }
  ...
  if (event_id.sdkProcessingMetadata && event_id.sdkProcessingMetadata.dynamicSamplingContext) {
    ...
    obj4.trace = _mod12319.dropUndefinedKeys(obj6);
    tmp8 = obj4;
  }
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    function readJson() {
      ...
      if (_mod12314.GLOBAL_OBJ.__SENTRY__) {
        if (_mod12314.GLOBAL_OBJ.__SENTRY__.decodePolyfill) {
          const __SENTRY__ = _mod12314.GLOBAL_OBJ.__SENTRY__;
    ...
    let encodePolyfill = dependencyMap;
    if (!require("12314__.js").GLOBAL_OBJ.__SENTRY__) {
      const _TextEncoder = TextEncoder;
      const encoder = new TextEncoder();
      ...
      if (typeof json === "string") {
        ...
        if (_mod12314.GLOBAL_OBJ.__SENTRY__) {
          if (_mod12314.GLOBAL_OBJ.__SENTRY__.encodePolyfill) {
            const __SENTRY__2 = _mod12314.GLOBAL_OBJ.__SENTRY__;
