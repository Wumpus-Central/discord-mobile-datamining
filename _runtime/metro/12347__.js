...
export const continueTrace = (arg0, arg1) => {
  _require = arg1;
  const mainCarrier = require("12331__.js").getMainCarrier();
  const obj = require("12331__.js");
  const tmp = _require;
  const asyncContextStrategy = require("12332__.js").getAsyncContextStrategy(mainCarrier);
  if (asyncContextStrategy.continueTrace) {
    ...
    return tmp(12340).withScope((setPropagationContext) => {
      const result = setPropagationContext.setPropagationContext(
        _mod12325.propagationContextFromHeaders(dependencyMap, _slicedToArray),
      );
      return closure_0();
    });
  }
  const obj2 = require("12332__.js");
};
export const startInactiveSpan = function startInactiveSpan(experimental) {
  _require = experimental;
  let mainCarrier = require("12331__.js").getMainCarrier();
  let obj = require("12331__.js");
  const tmp3 = _require;
  const tmp4 = obj4;
  let asyncContextStrategy = require("12332__.js").getAsyncContextStrategy(mainCarrier);
  ...
  let obj2 = require("12332__.js");
};
export const startNewTrace = function startNewTrace(arg0) {
  _require = arg0;
  return require("12340__.js").withScope((setPropagationContext) => {
      ...
      return undefined !== createChildOrRootSpan
        ...
        : ((fn) => fn())(() => {
            ...
            if (sentryNonRecordingSpan.onlyIfParent) {
              ...
              return tmp(12348).handleCallbackErrors(
