...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  let tmp3 = new require("module_14103")(arg0, arg3);
  const tmp4 = new require("module_14132")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14123);
    let tmpResult = tmp(14128);
    const tmpResult3 = tmp(14124);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14124);
      tmpResult = tmp(14127);
      tmpResult4 = tmp(14123);
  ...
  if (require("module_14134")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
