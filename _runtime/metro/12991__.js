...
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      return obj.resolvedSyncPromise(
        ServerRuntimeClient(12992).eventFromMessage(
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new ServerRuntimeClient(12985).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (ServerRuntimeClient(12960).DEBUG_BUILD) {
  ...
  },
  {
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      ...
      const obj = ServerRuntimeClient(12943);
    },
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        ...
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = ServerRuntimeClient(12937).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = ServerRuntimeClient(12937);
        } else {
          spanToTraceContextResult = ServerRuntimeClient(12959).getTraceContextFromScope(arg0);
          const tmpResult3 = ServerRuntimeClient(12959);
        }
