...
let items = [
  ...
  },
  {
    ...
    value: function render() {
      ...
      } else if (resizeMode === Video(8655).contain) {
        ScaleNone = viewManagerConfig.Constants.ScaleAspectFit;
      } else if (resizeMode === Video(8655).cover) {
...
let items1 = [
  _modDef8657.NONE,
  _modDef8657.INVERT,
  _modDef8657.MONOCHROME,
  _modDef8657.POSTERIZE,
  _modDef8657.FALSE,
  _modDef8657.MAXIMUMCOMPONENT,
  _modDef8657.MINIMUMCOMPONENT,
  _modDef8657.CHROME,
  _modDef8657.FADE,
  _modDef8657.INSTANT,
  _modDef8657.MONO,
