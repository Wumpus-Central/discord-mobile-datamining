...
import AbstractTimeExpressionParser from "../09909_AbstractTimeExpressionParser.js";
...
const entry = {
  ...
  value: function patternFlags() {
    return UKTimeExpressionParser(10049).REGEX_PARTS.flags;
  },
};
let items = [
  entry,
  ...
  },
  {
    ...
    value: function primarySuffix() {
      return (
        ...
        UKTimeExpressionParser(10049).REGEX_PARTS.rightBoundary
      );
    },
  },
  {
        ...
        if (first.endsWith("\u0432\u0435\u0447\u043E\u0440\u0430")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", UKTimeExpressionParser(9900).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", UKTimeExpressionParser(9900).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
