...
import SHEET_FIT_TO_CONTENTS from "SHEET_FIT_TO_CONTENTS" /* 4934 */;
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (enabled) {
    if (_mod4929.isNativePlatformSupported) {
      ...
      obj.fullScreenSwipeEnabled = _mod4938.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      obj.synchronousShadowStateUpdatesEnabled = get_controlledBottomTabsDefault.experiment.synchronousScreenUpdatesEnabled;
      obj.androidResetScreenShadowStateOnOrientationChangeEnabled = get_controlledBottomTabsDefault.experiment.androidResetScreenShadowStateOnOrientationChangeEnabled;
      obj.ios26AllowInteractionsDuringTransition = get_controlledBottomTabsDefault.experiment.ios26AllowInteractionsDuringTransition;
      ...
      if (isNativeStack) {
        ...
        tmp33Result = jsx(_modDef4940.Provider, { value: null, children: null });
      }
