...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      "(?:\u0437|\u0456\u0437)?\\s*(" +
      UKMonthNameLittleEndianParser(10735).ORDINAL_NUMBER_PATTERN +
      ")(?:\\s{0,3}(?:\u043F\u043E|-|\u2013|\u0434\u043E)?\\s{0,3}(" +
      UKMonthNameLittleEndianParser(10735).ORDINAL_NUMBER_PATTERN +
      "))?(?:-|\\/|\\s{0,3}(?:of)?\\s{0,3})(" +
      UKMonthNameLittleEndianParser(10581).matchAnyPattern(UKMonthNameLittleEndianParser(10735).MONTH_DICTIONARY) +
      ")(?:(?:-|\\/|,?\\s{0,3})(" +
      UKMonthNameLittleEndianParser(10735).YEAR_PATTERN +
      "(?![^\\s]\\d)))?"
    );
  },
};
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start.imply(
            "year",
            UKMonthNameLittleEndianParser(10582).findYearClosestToRef(
