// _runtime/metro/05451__.js
import _mod5432 from "05432__.js";
import _modDef5437 from "05437__.js";
import get0thIfdOffset from "../05452_get0thIfdOffset.js";
import IFD_TYPE_0TH from "../05453_IFD_TYPE_0TH.js";
...
export default {
  read(getUint16, c5, arg2) {
    ...
    if (undefined !== ifd[c3]) {
      ...
      objectAssignResult = _mod5432.objectAssign(
        ifd,
    ...
    if (undefined !== objectAssignResult[c4]) {
      ...
      objectAssignResult3 = _mod5432.objectAssign(
        objectAssignResult,
        tmp3Result8.readIfd(
          getUint16,
    ...
    if (undefined !== objectAssignResult3[c5]) {
      ...
      objectAssignResult4 = _mod5432.objectAssign(
        objectAssignResult3,
