// _runtime/metro/05444__.js
import _mod5425 from "05425__.js";
import _modDef5430 from "05430__.js";
import get0thIfdOffset from "../05445_get0thIfdOffset.js";
import IFD_TYPE_0TH from "../05446_IFD_TYPE_0TH.js";
...
export default {
  read(getUint16, c5, arg2) {
    ...
    if (undefined !== ifd[c3]) {
      ...
      objectAssignResult = _mod5425.objectAssign(
        ifd,
    ...
    if (undefined !== objectAssignResult[c4]) {
      ...
      objectAssignResult3 = _mod5425.objectAssign(
        objectAssignResult,
        tmp3Result8.readIfd(
          getUint16,
    ...
    if (undefined !== objectAssignResult3[c5]) {
      ...
      objectAssignResult4 = _mod5425.objectAssign(
        objectAssignResult3,
