...
function withScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = AsyncContextStack(12953).getDefaultCurrentScope();
    const tmpResult = AsyncContextStack(12953);
    stack = new _moduleResult(defaultCurrentScope, AsyncContextStack(12953).getDefaultIsolationScope());
    const tmpResult2 = AsyncContextStack(12953);
  }
...
function withIsolationScope(arg0) {
  ...
  return stack.withScope(() => {
    ...
    if (!stack) {
      const defaultCurrentScope = AsyncContextStack(12953).getDefaultCurrentScope();
      const tmp2Result = AsyncContextStack(12953);
      stack = new closure_2_3(defaultCurrentScope, AsyncContextStack(12953).getDefaultIsolationScope());
      const tmp2Result2 = AsyncContextStack(12953);
    }
    sentryCarrier.stack = stack;
  ...
  return {
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = AsyncContextStack(12953).getDefaultCurrentScope();
        const tmpResult = AsyncContextStack(12953);
        stack = new closure_1_3(defaultCurrentScope, AsyncContextStack(12953).getDefaultIsolationScope());
        const tmpResult2 = AsyncContextStack(12953);
      }
      sentryCarrier.stack = stack;
