  ...
  if (fetchData.fetchData) {
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              ...
              obj = { code: setHttpStatus(12943).SPAN_STATUS_ERROR, message: "internal_error" };
              obj10.setStatus(obj);
            }
            endResult = obj10.end();
            delete tmp2[tmp];
    ...
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj1[setHttpStatus(12941).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj1[setHttpStatus(12941).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj.attributes = obj1;
        let startInactiveSpanResult = setHttpStatus(12960).startInactiveSpan(obj);
