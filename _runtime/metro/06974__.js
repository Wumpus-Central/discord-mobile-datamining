...
fn.__closure = { ANIMATION_CONFIGS: fn(6956).ANIMATION_CONFIGS, ANIMATION_METHOD: fn(6956).ANIMATION_METHOD, withTiming: fn(1637).withTiming, withSpring: fn(1637).withSpring };
