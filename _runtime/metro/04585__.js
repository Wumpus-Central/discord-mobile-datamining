...
export const MemoryRouter = Component2(4589).MemoryRouter;
export const Prompt = Component2(4589).Prompt;
export const Redirect = Component2(4589).Redirect;
export const Route = Component2(4589).Route;
export const Router = Component2(4589).Router;
export const StaticRouter = Component2(4589).StaticRouter;
export const Switch = Component2(4589).Switch;
export const generatePath = Component2(4589).generatePath;
export const matchPath = Component2(4589).matchPath;
export const useHistory = Component2(4589).useHistory;
export const useLocation = Component2(4589).useLocation;
export const useParams = Component2(4589).useParams;
export const useRouteMatch = Component2(4589).useRouteMatch;
export const withRouter = Component2(4589).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4589).matchPath(_location.pathname, obj2);
          const obj = Component2(4589);
        }
