...
for (const key10013 in require("10504__.js")) {
  arg5[key10013] = require("10504__.js")[key10013];
  continue;
}
...
for (const key10025 in require("10518__.js")) {
  arg5[key10025] = require("10518__.js")[key10025];
  continue;
}
for (const key10029 in require("10519__.js")) {
  arg5[key10029] = require("10519__.js")[key10029];
  continue;
}
...
for (const key10037 in require("10520__.js")) {
  arg5[key10037] = require("10520__.js")[key10037];
  continue;
}
