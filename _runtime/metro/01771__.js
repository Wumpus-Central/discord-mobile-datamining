  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      fn.__closure = {
        delayFunction,
        delay,
        withSequence: SequencedTransition(1709).withSequence,
        withTiming: SequencedTransition(1709).withTiming,
        reverse: reversed,
        config,
        callback: callbackV,
      };
