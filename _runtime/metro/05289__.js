...
obj = { name: "GPSLatitude", description: fn(5288).getCalculatedGpsValue };
obj[2] = obj;
obj[3] = {
...
const obj1 = { name: "GPSLongitude", description: fn(5288).getCalculatedGpsValue };
obj[27] = { name: "GPSProcessingMethod", description: fn(5288).getEncodedString };
const obj2 = { name: "GPSProcessingMethod", description: fn(5288).getEncodedString };
