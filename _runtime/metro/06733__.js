...
function create(handlerTag) {
  ...
  obj = { wrappedSetGestureState, handlerTag, State: require("06732__.js").State };
  wrappedSetGestureState.__closure = obj;
  ...
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("06732__.js").State };
  ...
  const obj1 = { wrappedSetGestureState, handlerTag, State: require("06732__.js").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("06732__.js").State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = __initData4;
  obj.end = fn3;
  return obj;
}
obj = { wrappedSetGestureState, State: fn(6732).State };
