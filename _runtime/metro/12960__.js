...
function withScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = AsyncContextStack(12966).getDefaultCurrentScope();
    const tmpResult = AsyncContextStack(12966);
    stack = new _moduleResult(defaultCurrentScope, AsyncContextStack(12966).getDefaultIsolationScope());
    const tmpResult2 = AsyncContextStack(12966);
  }
...
function withIsolationScope(arg0) {
  ...
  return stack.withScope(() => {
    ...
    if (!stack) {
      const defaultCurrentScope = AsyncContextStack(12966).getDefaultCurrentScope();
      const tmp2Result = AsyncContextStack(12966);
      stack = new closure_2_3(defaultCurrentScope, AsyncContextStack(12966).getDefaultIsolationScope());
      const tmp2Result2 = AsyncContextStack(12966);
    }
    sentryCarrier.stack = stack;
  ...
  return {
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = AsyncContextStack(12966).getDefaultCurrentScope();
        const tmpResult = AsyncContextStack(12966);
        stack = new closure_1_3(defaultCurrentScope, AsyncContextStack(12966).getDefaultIsolationScope());
        const tmpResult2 = AsyncContextStack(12966);
      }
      sentryCarrier.stack = stack;
