...
import validateTransformOrigin from "../01740_validateTransformOrigin.js";
...
if (module_1641.shouldBeUseWeb()) {
  ...
  const obj3 = {
    processColorsInProps: _mod1681.processColorsInProps,
...
if (module_1641.shouldBeUseWeb()) {
  function maybeThrowError() {
    if (!obj.isJest()) {
      const reanimatedError = new require("01649__.js").ReanimatedError(
        "`UpdatePropsManager` is not available on non-native platform.",
      );
      throw reanimatedError;
    }
    obj = require("01641__.js");
  }
  const _Proxy = Proxy;
  const obj7 = {
    get: maybeThrowError,
