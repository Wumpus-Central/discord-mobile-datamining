...
export const createEventEnvelope = function createEventEnvelope(type, url, sdk, arg3) {
  ...
  const eventEnvelopeHeaders = _mod12971.createEventEnvelopeHeaders(type, sdkMetadataForEnvelopeHeader, arg3, url);
  delete tmp[tmp2];
...
export const createSessionEnvelope = function createSessionEnvelope(toJSON, url, sdk, arg3) {
  ...
  let tmp6 = arg3 && url;
  if (tmp6) {
    const obj4 = { dsn: _mod12974.dsnToString(url) };
    tmp6 = obj4;
    const tmpResult = _mod12974;
  }
