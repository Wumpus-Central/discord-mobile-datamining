...
import state from "../14577_state.js";
import prop from "14575__.js";

let closure_5 = _mod14523("".slice);
let closure_6 = _mod14523("".replace);
let closure_7 = _mod14523([].join);
let closure_8 = _mod14519 && !_mod14520(() => 8 !== defineProperty(() => {}, "length", { value: 8 }).length);
const tmp = _mod14519 && !_mod14520(() => 8 !== defineProperty(() => {}, "length", { value: 8 }).length);
...
const fn = (toString, toString2, arg2) => {
  ...
  let tmp9 = !tmp8;
  if (tmp8) {
    tmp9 = _mod14576.CONFIGURABLE && toString.name !== text2;
    const tmp10 = _mod14576.CONFIGURABLE && toString.name !== text2;
  }
  if (tmp9) {
    if (_mod14519) {
  ...
  try {
    if (arg2) {
      if (_mod14539(arg2, "constructor")) {
        ...
        if (!_mod14539(enforceResult, "source")) {
          let str11 = "";
