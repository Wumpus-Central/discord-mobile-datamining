...
let obj = {
  default: fn(7262).DefaultTransition,
  fade: fn(7262).ModalFadeTransition,
  fade_from_bottom: fn(7262).FadeFromBottomAndroid,
  fade_from_right: fn(7262).FadeFromRightAndroid,
  none: fn(7262).DefaultTransition,
  reveal_from_bottom: fn(7262).RevealFromBottomAndroid,
  scale_from_center: fn(7262).ScaleFromCenterAndroid,
  slide_from_left: fn(7262).SlideFromLeftIOS,
  slide_from_right: fn(7262).SlideFromRightIOS,
  slide_from_bottom: fn(7262).BottomSheetAndroid,
};
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7264).forModalPresentationIOS ||
