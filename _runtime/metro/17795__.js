...
import emptyFunction_mod from "10222__.js";
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = timestampProducer(CircularProgress(8807).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = timestampProducer(CircularProgress(8807).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(8807).G, obj3);
      const items1 = [timestampProducer(CircularProgress(8807).Svg, size2)];
