...
const entry = {
  ...
  value: function captureException(arg0, arg1, arg2) {
    const self = this;
    closure_1 = arg2;
    const uuid4Result = BaseClient(13065).uuid4();
    const obj = BaseClient(13065);
    if (obj2.checkOrSetAlreadyCaught(arg0)) {
      if (BaseClient(13082).DEBUG_BUILD) {
        const logger = BaseClient(13054).logger;
        logger.log(c4);
      }
      return uuid4Result;
    } else {
...
let items = [
  entry,
  {
    ...
    value: function captureMessage(arg0, arg1, arg2, arg3) {
      const self = this;
      closure_1 = arg3;
      const obj = { event_id: BaseClient(13065).uuid4() };
      const merged = Object.assign(arg2);
      const obj2 = BaseClient(13065);
      let StringResult = arg0;
      if (!obj3.isParameterizedString(arg0)) {
        const _String = String;
        StringResult = String(arg0);
      }
      obj3 = BaseClient(13061);
  ...
  },
  {
    ...
    value: function captureSession(release) {
      if (typeof release.release !== "string") {
        ...
        BaseClient(13077).updateSession(release, { init: false });
        const obj = BaseClient(13077);
      }
    },
  },
  {
  ...
  },
  {
    ...
    value: function flush(arg0) {
      ...
      if (_transport) {
        ...
        nextPromise = BaseClient(13078).resolvedSyncPromise(true);
        const obj = BaseClient(13078);
      }
      return nextPromise;
    },
  },
  ...
  },
  {
    ...
    value: function addIntegration(arg0) {
      BaseClient(13110).setupIntegration(this, arg0, this._integrations);
      if (!this._integrations[arg0.name]) {
        const items = [arg0];
        const result = BaseClient(13110).afterSetupIntegrations(this, items);
        const tmpResult = BaseClient(13110);
      }
      const obj = BaseClient(13110);
    },
  },
  {
    key: "sendEvent",
    value: function sendEvent(arg0) {
      ...
      let eventEnvelope = BaseClient(13097).createEventEnvelope(
        arg0,
        self._dsn,
      ...
      for (const item10025 of tmp3) {
        let obj3 = BaseClient(13098);
        let obj4 = BaseClient(13098);
  ...
  },
  {
    ...
    value: function sendSession(arg0) {
      this.sendEnvelope(
        BaseClient(13097).createSessionEnvelope(arg0, this._dsn, this._options._metadata, this._options.tunnel),
      );
    },
  },
  {
  ...
  },
  {
    ...
    value: function sendEnvelope(arg0) {
      ...
      if (BaseClient(13082).DEBUG_BUILD) {
        let logger = BaseClient(13054).logger;
        logger.error("Transport disabled");
      }
      nextPromise = BaseClient(13078).resolvedSyncPromise({});
      const tmp2Result = BaseClient(13078);
    },
  },
  {
    ...
    value: function _setupIntegrations() {
      ...
      this._integrations = BaseClient(13110).setupIntegrations(this, integrations);
      const obj = BaseClient(13110);
      const result = BaseClient(13110).afterSetupIntegrations(this, integrations);
    },
  },
  {
    ...
    value: function _updateSessionFromEvent(status, level) {
      ...
      if (tmp9) {
        ...
        const self = this;
        obj3.errors = errors;
        BaseClient(13077).updateSession(status, obj3);
  ...
  },
  {
    ...
    value: function _isClientDoneProcessing(arg0) {
      const self = this;
      closure_0 = arg0;
      return new BaseClient(13078).SyncPromise((arg0) => {
        closure_0 = arg0;
        c1 = 0;
      ...
      return currentScope(self[15])
        ...
        .then((contexts) => {
          if (null === contexts) {
            ...
            const obj = { trace: BaseClient(13081).getTraceContextFromScope(currentScope) };
            const merged = Object.assign(contexts.contexts);
            contexts.contexts = obj;
            const obj2 = BaseClient(13081);
            const obj4 = {
              dynamicSamplingContext: BaseClient(13090).getDynamicSamplingContextFromScope(self, currentScope),
            };
  ...
  },
  {
    ...
    value: function _processEvent(type, arg1, arg2) {
      ...
      if (undefined !== sampleRate) {
        const parseSampleRateResult = str(13094).parseSampleRate(sampleRate);
        let obj = str(13094);
      }
      if (undefined === type) {
        if (typeof parseSampleRateResult === "number") {
          ...
          if (Math.random() > parseSampleRateResult) {
            ...
            let sentryError = new str(13111).SentryError(
              "Discarding event because it's not included in the random sample (sampling rate = " + sampleRate + ")",
              "log",
            );
            return str(13078).rejectedSyncPromise(sentryError);
          }
        }
      }
      str = "replay";
      ...
      let nextPromise = self
        ...
        .then((result) => {
          if (null === result) {
            ...
            let sentryError = new BaseClient(13111).SentryError(
            ...
            if (obj.isThenable(promise)) {
              let nextPromise = promise.then(
                (result) => {
                  if (!obj.isPlainObject(result)) {
                    if (null !== result) {
                      const sentryError = new str(13111).SentryError(combined);
                      throw sentryError;
                    }
                  }
                  return result;
                ...
                (arg0) => {
                  const sentryError = new str(13111).SentryError("" + closure_0 + " rejected with " + arg0);
                  throw sentryError;
                },
              );
            } else {
              ...
              if (!obj2.isPlainObject(promise)) {
                nextPromise = promise;
                if (null !== promise) {
                  const sentryError1 = new BaseClient(13111).SentryError(combined);
                  throw sentryError1;
                }
              }
              obj2 = BaseClient(13061);
            }
            return nextPromise;
          }
        });
      return self
        ...
        .then((sdkProcessingMetadata) => {
          if (null === sdkProcessingMetadata) {
            ...
            const _HermesInternal = HermesInternal;
            const sentryError = new BaseClient(13111).SentryError(
        ...
        .then(null, (originalException) => {
          if (originalException instanceof BaseClient(13111).SentryError) {
  ...
  },
  {
    ...
    value: function _flushOutcomes() {
      ...
      if (0 !== _clearOutcomesResult.length) {
        const DEBUG_BUILD = BaseClient(13082).DEBUG_BUILD;
        if (self._dsn) {
          if (DEBUG_BUILD) {
            const logger4 = BaseClient(13054).logger;
            logger4.log("Sending outcomes:", _clearOutcomesResult);
          }
          let tunnel = self._options.tunnel;
          if (tunnel) {
            tunnel = BaseClient(13101).dsnToString(self._dsn);
            const tmpResult2 = BaseClient(13101);
          }
          self.sendEnvelope(BaseClient(13112).createClientReportEnvelope(_clearOutcomesResult, tunnel));
          const tmpResult = BaseClient(13112);
        } else if (DEBUG_BUILD) {
          const logger3 = BaseClient(13054).logger;
          logger3.log("No dsn provided, will not send outcomes");
        }
      } else if (BaseClient(13082).DEBUG_BUILD) {
        const logger2 = BaseClient(13054).logger;
