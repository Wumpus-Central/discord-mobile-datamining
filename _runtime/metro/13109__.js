...
_inherits(ServerRuntimeClient, _mod13105.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(13110).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(13110);
    return ServerRuntimeClient(13074).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(13074);
      return obj.resolvedSyncPromise(ServerRuntimeClient(13110).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(13077).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(13077);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new ServerRuntimeClient(13103).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (ServerRuntimeClient(13078).DEBUG_BUILD) {
        const logger = ServerRuntimeClient(13050).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(13111);
          ...
          if (ServerRuntimeClient(13078).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(13050).logger;
      ...
      checkInId = ServerRuntimeClient(13061).uuid4();
      const obj = ServerRuntimeClient(13061);
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(13072)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = ServerRuntimeClient(13055).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = ServerRuntimeClient(13055);
        } else {
          spanToTraceContextResult = ServerRuntimeClient(13077).getTraceContextFromScope(arg0);
          const tmpResult3 = ServerRuntimeClient(13077);
        }
        const tmpResult4 = ServerRuntimeClient(13086);
        if (_getSpanForScopeResult) {
