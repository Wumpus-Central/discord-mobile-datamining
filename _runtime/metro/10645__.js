...
const regExp = new RegExp(
  "(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(este|esta|pasado|pr[o\u00F3]ximo)\\s*)?(" +
    repeatedTimeunitPattern.matchAnyPattern(_mod10646.WEEKDAY_DICTIONARY) +
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (undefined === tmp4) {
        ...
        return ESWeekdayParser(10529).createParsingComponentsAtWeekday(reference.reference, tmp4, str5);
      }
    },
  },
];
