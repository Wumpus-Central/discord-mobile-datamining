// _runtime/metro/05030__.js
import _modDef5008 from "05008__.js";
import _modDef5027 from "05027__.js";
import styleDefault from "../05032_style.js";
...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  dependencyMap = flag5.useContext(screenId(5028).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(5031).isIOS26OrHigher;
  }
  _modDef5027(
    isIOS26OrHigher,
  ...
  if (screenId(5031).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(screenId(5035).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(screenId(5037).FooterComponent, obj7);
  }
