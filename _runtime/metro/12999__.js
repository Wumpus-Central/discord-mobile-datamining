...
import __SENTRY_DEBUG__ from "12939__.js";
  ...
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      return obj.resolvedSyncPromise(
        ServerRuntimeClient(13000).eventFromMessage(
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new ServerRuntimeClient(12993).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (ServerRuntimeClient(12968).DEBUG_BUILD) {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        ...
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = ServerRuntimeClient(12945).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = ServerRuntimeClient(12945);
        } else {
          spanToTraceContextResult = ServerRuntimeClient(12967).getTraceContextFromScope(arg0);
          const tmpResult3 = ServerRuntimeClient(12967);
        }
