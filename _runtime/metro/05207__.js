...
export default function TabsHost(arg0) {
  ...
  return jsx(_modDef5213, { style: null, navStateRequest, onTabSelected: _mod5212.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null });
};