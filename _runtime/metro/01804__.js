...
const interpolateColorsHSV = function o(arg0, items, h, useCorrectedHSVInterpolation) {
  ...
  if (undefined !== useCorrectedHSVInterpolation) {
    ...
    return tmpResult6.hsvToColor(interpolateResult, interpolateResult1, interpolateResult2, tmpResult5.interpolate(arg0, items, h.a, _mod1805.Extrapolation.CLAMP));
  }
  items = [];
  items[0] = items[0];
  h = h.h;
