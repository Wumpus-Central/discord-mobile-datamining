...
import convertLrgbToOklabDefault from "../01806_convertLrgbToOklab.js";
...
const interpolateColorsHSV = function o(arg0, arg1, h, useCorrectedHSVInterpolation) {
  ...
  if (undefined !== useCorrectedHSVInterpolation) {
    ...
    return tmpResult2.hsvToColor(
      ...
      interpolateResult1,
      interpolateResult2,
      tmpResult1.interpolate(arg0, arg1, h.a, _mod1805.Extrapolation.CLAMP),
    );
  }
  const items = [arg1[0]];
  h = h.h;
...
const fn5 = function n(arg0, arg1, l, arg3) {
  ...
  ({ r, g, b, alpha } = convert.toRgb({
    ...
    alpha: _mod1805.interpolate(arg0, arg1, l.alpha, _mod1805.Extrapolation.CLAMP),
  }));
...
const color = {
  processColor: _mod1679.processColor,
  red: _mod1679.red,
  green: _mod1679.green,
  blue: _mod1679.blue,
  opacity: _mod1679.opacity,
};
fn6.__closure = color;
