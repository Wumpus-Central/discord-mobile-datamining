...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("L" === arg1) {
      return _createSuperInternal(4226).mapValue(_createSuperInternal(4226).parseNumericPattern(_createSuperInternal(4227).numericPatterns.month, arg0), valueCallback);
    } else if ("LL" === arg1) {
