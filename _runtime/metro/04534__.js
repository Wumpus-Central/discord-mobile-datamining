// _runtime/metro/04534__.js
import ArtboardByIndex from "../04523_ArtboardByIndex.js";
...
export const useViewModelInstance = function useViewModelInstance(arg0, instanceName) {
  ...
  const disposableMemo = require("04527__.js").useDisposableMemo(
    () => {
      if (closure_0) {
