...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5850).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08168__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08168__.js");
  const invalidPreventRemoveError = require("08169__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08169__.js");
  const modalRouteKeys = require("08170__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05850__.js").SafeAreaProviderCompat, obj4);
};
