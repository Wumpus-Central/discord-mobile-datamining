...
import emptyFunction_mod from "10120__.js";
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = timestampProducer(CircularProgress(8689).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = timestampProducer(CircularProgress(8689).Path, obj5);
      }
