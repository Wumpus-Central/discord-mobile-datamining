// _runtime/metro/14507__.js
import digitsToString2 from "../14485_digitsToString.js";
import GetUnsignedRoundingMode from "../14503_GetUnsignedRoundingMode.js";
import ToRawFixed from "../14505_ToRawFixed.js";
import S_UNICODE_REGEX from "../14508_S_UNICODE_REGEX.js";
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (!tmp3) {
    if ("decimal" !== style) {
      if ("unit" !== style) {
        ...
        if (tmp17) {
          const arr5 =
            numbers.currency[numberingSystem] || numbers.numbers.currency[first][currencyDisplay.currencySign];
          let str27 = arr5;
          if (arr5.indexOf(";") < 0) {
  ...
  if (0 < parts4.length) {
    ...
    value = value(14509).digitMapping[numberingSystem];
