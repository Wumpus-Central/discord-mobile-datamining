...
function create(handlerTag) {
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6074").State };
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("module_6074").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6074").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("module_6074").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6074").State };
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("module_6074").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("module_6074").State };
