...
function create(handlerTag) {
  ...
  wrappedSetGestureState.__closure = { wrappedSetGestureState, handlerTag, State: require("06898__.js").State };
  ...
  const obj2 = { wrappedSetGestureState, handlerTag, State: require("06898__.js").State };
  fn2.__closure = { wrappedSetGestureState, handlerTag, State: require("06898__.js").State };
  ...
  const obj3 = { wrappedSetGestureState, handlerTag, State: require("06898__.js").State };
  S.__closure = { wrappedSetGestureState, handlerTag, State: require("06898__.js").State };
  ...
  const obj4 = { wrappedSetGestureState, handlerTag, State: require("06898__.js").State };
  fn3.__closure = { wrappedSetGestureState, handlerTag, State: require("06898__.js").State };
