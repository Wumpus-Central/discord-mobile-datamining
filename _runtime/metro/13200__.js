...
class BaseClient {
  constructor(arg0) {
    ...
    if (self._dsn) {
      ...
      envelopeEndpointWithUrlEncodedAuth = tmp5Result.getEnvelopeEndpointWithUrlEncodedAuth(
        self._dsn,
        global.tunnel,
        sdk,
      );
...
const entry = {
  ...
  value: function captureException(arg0, arg1, arg2) {
    const self = this;
    closure_1 = arg2;
    const uuid4Result = BaseClient(13156).uuid4();
    const obj = BaseClient(13156);
    if (obj2.checkOrSetAlreadyCaught(arg0)) {
      if (BaseClient(13173).DEBUG_BUILD) {
        const logger = BaseClient(13145).logger;
        logger.log(c4);
      }
      return uuid4Result;
    } else {
...
let items = [
  entry,
  {
    ...
    value: function captureMessage(arg0, arg1, arg2, arg3) {
      const self = this;
      closure_1 = arg3;
      const obj = { event_id: BaseClient(13156).uuid4() };
      const merged = Object.assign(arg2);
      const obj2 = BaseClient(13156);
      let StringResult = arg0;
      if (!obj3.isParameterizedString(arg0)) {
        const _String = String;
        StringResult = String(arg0);
      }
      obj3 = BaseClient(13152);
  ...
  },
  {
    ...
    value: function captureSession(release) {
      if (typeof release.release !== "string") {
        ...
        BaseClient(13168).updateSession(release, { init: false });
        const obj = BaseClient(13168);
      }
    },
  },
  {
  ...
  },
  {
    ...
    value: function flush(arg0) {
      ...
      if (_transport) {
        ...
        nextPromise = BaseClient(13169).resolvedSyncPromise(true);
        const obj = BaseClient(13169);
      }
      return nextPromise;
    },
  },
  ...
  },
  {
    ...
    value: function addIntegration(arg0) {
      BaseClient(13201).setupIntegration(this, arg0, this._integrations);
      if (!this._integrations[arg0.name]) {
        const items = [arg0];
        const result = BaseClient(13201).afterSetupIntegrations(this, items);
        const tmpResult = BaseClient(13201);
      }
      const obj = BaseClient(13201);
    },
  },
  {
    key: "sendEvent",
    value: function sendEvent(arg0) {
      ...
      let eventEnvelope = BaseClient(13188).createEventEnvelope(
        arg0,
        self._dsn,
      ...
      for (const item10025 of tmp3) {
        let obj3 = BaseClient(13189);
        let obj4 = BaseClient(13189);
  ...
  },
  {
    ...
    value: function sendSession(arg0) {
      this.sendEnvelope(
        BaseClient(13188).createSessionEnvelope(arg0, this._dsn, this._options._metadata, this._options.tunnel),
      );
    },
  },
  {
  ...
  },
  {
    ...
    value: function sendEnvelope(arg0) {
      ...
      if (BaseClient(13173).DEBUG_BUILD) {
        let logger = BaseClient(13145).logger;
        logger.error("Transport disabled");
      }
      nextPromise = BaseClient(13169).resolvedSyncPromise({});
      const tmp2Result = BaseClient(13169);
    },
  },
  {
    ...
    value: function _setupIntegrations() {
      ...
      this._integrations = BaseClient(13201).setupIntegrations(this, integrations);
      const obj = BaseClient(13201);
      const result = BaseClient(13201).afterSetupIntegrations(this, integrations);
    },
  },
  {
    ...
    value: function _updateSessionFromEvent(status, level) {
      ...
      if (tmp9) {
        ...
        const self = this;
        obj3.errors = errors;
        BaseClient(13168).updateSession(status, obj3);
  ...
  },
  {
    ...
    value: function _isClientDoneProcessing(arg0) {
      const self = this;
      closure_0 = arg0;
      return new BaseClient(13169).SyncPromise((arg0) => {
        closure_0 = arg0;
        c1 = 0;
  ...
  },
  {
    ...
    value: function _prepareEvent(type, integrations) {
      ...
      return currentScope(self[15])
        .prepareEvent(options, type, integrations, currentScope, self, isolationScope)
        .then((contexts) => {
          if (null === contexts) {
            return contexts;
          } else {
            const obj = { trace: BaseClient(13172).getTraceContextFromScope(currentScope) };
            const merged = Object.assign(contexts.contexts);
            contexts.contexts = obj;
            const obj2 = BaseClient(13172);
            const obj4 = {
              dynamicSamplingContext: BaseClient(13181).getDynamicSamplingContextFromScope(self, currentScope),
            };
  ...
  },
  {
    ...
    value: function _captureEvent(arg0) {
      ...
      return this._processEvent(arg0, obj, arg2).then(
  ...
  },
  {
    ...
    value: function _processEvent(type, arg1, arg2) {
      ...
      if (undefined !== sampleRate) {
        const parseSampleRateResult = str(13185).parseSampleRate(sampleRate);
        let obj = str(13185);
      }
      if (undefined === type) {
        if (typeof parseSampleRateResult === "number") {
          ...
          if (Math.random() > parseSampleRateResult) {
            ...
            let sentryError = new str(13202).SentryError(
              "Discarding event because it's not included in the random sample (sampling rate = " + sampleRate + ")",
              "log",
            );
            return str(13169).rejectedSyncPromise(sentryError);
          }
        }
      }
      str = "replay";
      ...
      const _prepareEventResult = self._prepareEvent(
        type,
        arg1,
        arg2,
        type.sdkProcessingMetadata || {}.capturedSpanIsolationScope,
      );
      const tmp5 = type.sdkProcessingMetadata || {};
      let nextPromise = self
        ._prepareEvent(type, arg1, arg2, type.sdkProcessingMetadata || {}.capturedSpanIsolationScope)
        .then((result) => {
          if (null === result) {
            self.recordDroppedEvent("event_processor", str, dependencyMap);
            let sentryError = new BaseClient(13202).SentryError(
            ...
            if (obj.isThenable(promise)) {
              let nextPromise = promise.then(
                (result) => {
                  if (!obj.isPlainObject(result)) {
                    if (null !== result) {
                      const sentryError = new str(13202).SentryError(combined);
                      throw sentryError;
                    }
                  }
                  return result;
                ...
                (arg0) => {
                  const sentryError = new str(13202).SentryError("" + closure_0 + " rejected with " + arg0);
                  throw sentryError;
                },
              );
            } else {
              ...
              if (!obj2.isPlainObject(promise)) {
                nextPromise = promise;
                if (null !== promise) {
                  const sentryError1 = new BaseClient(13202).SentryError(combined);
                  throw sentryError1;
                }
              }
              obj2 = BaseClient(13152);
            }
            return nextPromise;
          }
        });
      return self
        ...
        .then((sdkProcessingMetadata) => {
          if (null === sdkProcessingMetadata) {
            ...
            const _HermesInternal = HermesInternal;
            const sentryError = new BaseClient(13202).SentryError(
              "" + closure_6 + " returned `null`, will not send event.",
              "log",
            );
            throw sentryError;
          } else {
            ...
            if (closure_5) {
              ...
              const diff =
                ((sdkProcessingMetadata.sdkProcessingMetadata &&
                  sdkProcessingMetadata.sdkProcessingMetadata.spanCountBeforeProcessing) ||
                  0) - num2;
              if (diff > 0) {
        ...
        .then(null, (originalException) => {
          if (originalException instanceof BaseClient(13202).SentryError) {
  ...
  },
  {
    ...
    value: function _flushOutcomes() {
      ...
      if (0 !== _clearOutcomesResult.length) {
        const DEBUG_BUILD = BaseClient(13173).DEBUG_BUILD;
        if (self._dsn) {
          if (DEBUG_BUILD) {
            const logger4 = BaseClient(13145).logger;
            logger4.log("Sending outcomes:", _clearOutcomesResult);
          }
          let tunnel = self._options.tunnel;
          if (tunnel) {
            tunnel = BaseClient(13192).dsnToString(self._dsn);
            const tmpResult2 = BaseClient(13192);
          }
          self.sendEnvelope(BaseClient(13203).createClientReportEnvelope(_clearOutcomesResult, tunnel));
          const tmpResult = BaseClient(13203);
        } else if (DEBUG_BUILD) {
          const logger3 = BaseClient(13145).logger;
          logger3.log("No dsn provided, will not send outcomes");
        }
      } else if (BaseClient(13173).DEBUG_BUILD) {
        const logger2 = BaseClient(13145).logger;
