...
import COUNTER_METRIC_TYPE from "COUNTER_METRIC_TYPE" /* 12392 */;
import __SENTRY_DEBUG__ from "module_12294" /* 12294 */;
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("module_12309").timestampInSeconds();
      c4 = timestampInSecondsResult;
      let obj = require("module_12309");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("module_12329").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
