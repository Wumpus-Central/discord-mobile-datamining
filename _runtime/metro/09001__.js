...
import _mod9002 from "09002__.js";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = require("08935__.js").util;
    ...
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = {
        input: require("../08997_initializeContext.js").createStandardJSONSchemaMethod(_standard, "input"),
        output: require("../08997_initializeContext.js").createStandardJSONSchemaMethod(_standard, "output"),
      };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = require("../08997_initializeContext.js").createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
