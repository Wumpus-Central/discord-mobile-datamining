...
export const PbLong = require("module_1193").PbLong;
export const PbULong = require("module_1193").PbULong;
...
export const isOneofGroup = require("module_1202").isOneofGroup;
export const setOneofValue = require("module_1202").setOneofValue;
export const getOneofValue = require("module_1202").getOneofValue;
export const clearOneofValue = require("module_1202").clearOneofValue;
export const getSelectedOneofValue = require("module_1202").getSelectedOneofValue;
export const listEnumValues = require("module_1213").listEnumValues;
export const listEnumNames = require("module_1213").listEnumNames;
export const listEnumNumbers = require("module_1213").listEnumNumbers;
export const isEnumObject = require("module_1213").isEnumObject;
