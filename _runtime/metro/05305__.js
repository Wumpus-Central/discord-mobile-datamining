...
import iccTags from "../05306_iccTags.js";
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (1 === uint324) {
                  ...
                  if (tmp25(5306).iccTags[stringFromDataView]) {
                    ...
                    obj[tmp25(5306).iccTags[stringFromDataView].name] = obj3;
                  } else {
