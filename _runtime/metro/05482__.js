...
export default {
  get(buffer, Compression, arg2) {
    ...
    if (prop) {
      ...
      require("05430__.js").deferInit(Compression, "base64", function () {
        return require("05430__.js").getBase64Image(this.image);
      });
      const obj = require("05430__.js");
    }
    return Compression;
  },
};
