...
let obj = {
  default: fn(7125).DefaultTransition,
  fade: fn(7125).ModalFadeTransition,
  fade_from_bottom: fn(7125).FadeFromBottomAndroid,
  fade_from_right: fn(7125).FadeFromRightAndroid,
  none: fn(7125).DefaultTransition,
  reveal_from_bottom: fn(7125).RevealFromBottomAndroid,
  scale_from_center: fn(7125).ScaleFromCenterAndroid,
  slide_from_left: fn(7125).SlideFromLeftIOS,
  slide_from_right: fn(7125).SlideFromRightIOS,
  slide_from_bottom: fn(7125).BottomSheetAndroid,
};
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7127).forModalPresentationIOS ||
