...
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      return obj.resolvedSyncPromise(
        ServerRuntimeClient(13108).eventFromMessage(
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new ServerRuntimeClient(13101).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (ServerRuntimeClient(13076).DEBUG_BUILD) {
  ...
  },
  {
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      ...
      const obj = ServerRuntimeClient(13059);
    },
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        ...
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = ServerRuntimeClient(13053).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = ServerRuntimeClient(13053);
        } else {
          spanToTraceContextResult = ServerRuntimeClient(13075).getTraceContextFromScope(arg0);
          const tmpResult3 = ServerRuntimeClient(13075);
        }
