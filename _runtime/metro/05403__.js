// _runtime/metro/05403__.js
import _mod5404 from "05404__.js";

const _mod5405 = tmp5(5405);
require = arg1;
...
export const detectFile = function detectFile(uint8Array, chunkSize) {
  ...
  const fileChunk = _mod5404.getFileChunk(uint8Array, num3);
  if (0 !== fileChunk.length) {
    const items = [];
    const items1 = [];
    for (const key10027 in _mod5405.FileTypes) {
      let _Object4 = Object;
      let call2 = hasOwnProperty2.call;
      let tmp23 = require;
      let FileTypes5 = _mod5405.FileTypes;
    ...
    if (0 !== items.length) {
      ...
      const FileTypes4 = _mod5405.FileTypes;
