...
let obj = { default: fn(7260).DefaultTransition, fade: fn(7260).ModalFadeTransition, fade_from_bottom: fn(7260).FadeFromBottomAndroid, fade_from_right: fn(7260).FadeFromRightAndroid, none: fn(7260).DefaultTransition, reveal_from_bottom: fn(7260).RevealFromBottomAndroid, scale_from_center: fn(7260).ScaleFromCenterAndroid, slide_from_left: fn(7260).SlideFromLeftIOS, slide_from_right: fn(7260).SlideFromRightIOS, slide_from_bottom: fn(7260).BottomSheetAndroid };
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 = cardStyleInterpolator === CardStack(7262).forModalPresentationIOS || "forModalPresentationIOS" === cardStyleInterpolator.name;
                let tmp10 = !tmp9;
                if (tmp9) {
