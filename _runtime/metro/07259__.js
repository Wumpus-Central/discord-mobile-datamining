...
let obj = {
  default: fn(7260).DefaultTransition,
  fade: fn(7260).ModalFadeTransition,
  fade_from_bottom: fn(7260).FadeFromBottomAndroid,
  fade_from_right: fn(7260).FadeFromRightAndroid,
  none: fn(7260).DefaultTransition,
  reveal_from_bottom: fn(7260).RevealFromBottomAndroid,
  scale_from_center: fn(7260).ScaleFromCenterAndroid,
  slide_from_left: fn(7260).SlideFromLeftIOS,
  slide_from_right: fn(7260).SlideFromRightIOS,
  slide_from_bottom: fn(7260).BottomSheetAndroid,
};
...
function getDistanceFromOptions(size, gestureDirection, arg2) {
  ...
  if (gestureDirection1) {
    return CardStack(7264).getDistanceForDirection(size, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(7260).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(7260).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(7264).getDistanceForDirection(size, gestureDirection, arg2);
  }
}
...
const entry = {
  ...
  value: function render() {
    ...
    const obj2 = {
      ...
      contentHeight: headerHeights[state.routes[state.index].key],
        ...
        if (typeof getIsModal === "function") {
          ...
          if (!tmp16) {
            ...
            if (typeof getIsModalPresentation === "function") {
              let tmp20 = cardStyleInterpolator === CardStack(7262).forModalPresentationIOS;
              if (!tmp20) {
                tmp20 = "forModalPresentationIOS" === cardStyleInterpolator.name;
              }
              if (tmp20) {
          ...
          obj.children = React6(CardStack(7267).CardContainer, obj3);
          return React6(CardStack(7266).MaybeScreen, obj, key.key);
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
    ...
    items2[1] = renderHeader(CardStack(7266).MaybeScreenContainer, obj4);
    obj.children = items2;
...
const entry1 = {
  ...
  value: function getDerivedStateFromProps(routes, routes2) {
    ...
    const modalRouteKeys = CardStack(7276).getModalRouteKeys(items1, {});
      ...
      if (tmp8) {
        ...
        if (index !== arg2.length - 1) {
          ...
          if ("default" !== str2) {
            ...
            ModalTransition = CardStack(7260).ModalFadeTransition;
          } else {
            if ("modal" !== options.presentation) {
              if (!hasItem1) {
                ModalTransition = CardStack(7260).DefaultTransition;
              }
            }
            ModalTransition = CardStack(7260).ModalTransition;
          }
          ...
          if (undefined !== cardStyleInterpolator) {
            ...
            if (undefined === cardOverlayEnabled) {
              ...
              if (!tmp38) {
                if (typeof getIsModalPresentation === "function") {
                  let tmp42 = cardStyleInterpolator === CardStack(7262).forModalPresentationIOS;
                  if (!tmp42) {
            ...
            if (str10 == null) {
              ...
              if (tmp43) {
                if (typeof getIsModalPresentation === "function") {
                  str10 = "screen";
                  if (cardStyleInterpolator !== CardStack(7262).forModalPresentationIOS) {
            ...
            forNoAnimation = CardStack(7262).forNoAnimation;
          }
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7262).forModalPresentationIOS ||
                  "forModalPresentationIOS" === cardStyleInterpolator.name;
                let tmp10 = !tmp9;
                if (tmp9) {
                  let tmp7Result = tmp7(7277);
                  tmp10 =
                    diff !==
