...
import ScrollableContainer from "../06947_ScrollableContainer.js";
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const scrollHandler1 = _mod6737.useScrollHandler(
      scrollEventsHandlersHook,
      onScroll,
      onScrollBeginDrag,
      onScrollEndDrag,
    ...
    const scrollableSetter = _mod6737.useScrollableSetter(
      scrollableRef,
      SCROLLVIEW,
