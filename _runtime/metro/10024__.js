...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RURelativeDateFormatParser(9884).matchAnyPattern(RURelativeDateFormatParser(10013).TIME_UNIT_DICTIONARY) +
      ")"
    );
  },
};
    ...
    value: function innerExtract(createParsingComponents, arg1) {
      ...
      if ("\u043D\u0430 \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0439" != formatted) {
        if ("\u0432 \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u043C" != formatted) {
          ...
          const obj = {};
          obj[str3] = -1;
          const ParsingComponents = RURelativeDateFormatParser(9887).ParsingComponents;
          return ParsingComponents.createRelativeFromReference(createParsingComponents.reference, obj);
        }
      }
      const ParsingComponents2 = RURelativeDateFormatParser(9887).ParsingComponents;
