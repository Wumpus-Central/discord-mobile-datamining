...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14388).emitUnicodeLanguageId(
              obj.__assign(Locale(1161).__assign({}, Locale(14388).parseUnicodeLanguageId(tmp2)), obj3),
            );
            ...
            if (closure_1_6(Locale(14388).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = Locale(14388).emitUnicodeLocaleId(
              ...
              if (region) {
                ...
                if (closure_1_6(Locale(14388).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = Locale(14388).emitUnicodeLocaleId(
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14388).emitUnicodeLanguageId(
        Locale(14388).parseUnicodeLanguageId(module_14323.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
