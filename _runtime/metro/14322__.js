...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  _require = arg3;
  let tmp3 = new require("14285__.js")(arg0, arg3);
  const tmp4 = new require("14314__.js")(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(14305);
    let tmpResult = tmp(14310);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(14306);
      tmpResult = tmp(14309);
      tmpResult4 = tmp(14305);
  ...
  if (require("14316__.js")(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
