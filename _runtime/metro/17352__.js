...
function LookupMatcher(arg0, arg1) {
  ...
  if (undefined !== tmp) {
    ...
    if (StringResult !== String(tmp2)) {
      obj["[[extension]]"] = str.match(re21)[0];
    ...
    if (!callResult) {
      ...
      if (0 < arg3.length) {
        do {
          ...
          let str12 = str11;
          let tmp27 = tmp24;
          if (typeof call4 === "unknown" ? hasOwnProperty(`${"[[" + tmp18}]]`) : call4(__localeMatcher__, `${"[[" + tmp18}]]`)) {
...
function InitializeNumberFormat(__getInternalProperties, arg1, arg2) {
  ...
  if (true === result["[[initializedIntlObject]]"]) {
    ...
    for (const key10032 in undefined) {
      ...
      if (tmp134) {
        if (!tmp134) {
          ...
          let obj1 = { value: undefined[key10032], enumerable: true, writable: true, configurable: true };
    ...
    ({ [[locale]]: tmp5["[[locale]]"], [[nu]]: tmp5["[[numberingSystem]]"], [[dataLocale]]: tmp5["[[dataLocale]]"], [[dataLocale]]: tmp35 } = ResolveLocale(closure_15.NumberFormat["[[availableLocales]]"], tmp131, obj, closure_15.NumberFormat["[[relevantExtensionKeys]]"], prop));
    const tmp34 = ResolveLocale(closure_15.NumberFormat["[[availableLocales]]"], tmp131, obj, closure_15.NumberFormat["[[relevantExtensionKeys]]"], prop);
...
function FormatNumber(numberFormat, diff) {
  ...
  if (false === isFinite(diff)) {
    ...
    if (!num3) {
      ...
      const sum2 = replaced + (text2 + tmp20Result);
...
function InitializeDateTimeFormat(prototype, arg1, arg2) {
  ...
  if (true === result["[[initializedIntlObject]]"]) {
    ...
    const tmp25 = ResolveLocale(DateTimeFormat["[[availableLocales]]"], tmp96, obj, DateTimeFormat["[[relevantExtensionKeys]]"], prop);
    ...
    for (const key10081 in undefined) {
      ...
      if (tmp107) {
        if (!tmp107) {
          ...
          let obj3 = { value: undefined[key10081], enumerable: true, writable: true, configurable: true };
          let tmp41 = fn(obj2, key10081, obj3);
          continue;
        }
        continue;
      } else {
    ...
    if ("basic" === str15) {
      let tmp65 = calculateScore(obj2, dateTimeFormats);
    } else {
      tmp65 = calculateScore(obj2, dateTimeFormats, true);
    }
    const keys = Object.keys();
    if (keys !== undefined) {
      while (keys[-1] !== undefined) {
      ...
      if (keys !== undefined) {
        ...
        while (tmp12 !== undefined) {
          ...
          if (!(typeof call4 === "unknown" ? hasOwnProperty(tmp12) : call4(closure_35, tmp12))) {
            ...
            let _Math = Math;
            let _Math2 = Math;
            let bound = Math.max(Math.min((typeof call3 === "unknown" ? closure_7(tmp14) : call3(items, tmp14)) - tmp16, 2), -2);
            let tmp18 = tmp2;
            if (arg2) {
      ...
      for (const key10051 in obj) {
        ...
        if (tmp10) {
          if (!tmp10) {
            ...
            obj.value = obj[key10051];
            let tmp7 = fn(obj, key10051, obj);
            continue;
          }
          continue;
        } else {
  ...
  if (callResult) {
    ...
    if (undefined !== tmp11) {
      if (null == tmp11) {
        ...
        obj = Object.create(tmp42.prototype);
        ...
        if (tmp7["[[initializedNumberFormat]]"]) {
          ...
          if (0 < items.length) {
            do {
              let call3 = hasOwnProperty.call;
              let text = `${"[[" + arr[num]}]]`;
              if (typeof call3 === "unknown" ? hasOwnProperty(`${"[[" + arr[num]}]]`) : call3(tmp7, `${"[[" + arr[num]}]]`)) {
...
let obj1 = { configurable: true, writable: true, value: typeof call === "unknown" ? tmp5(NumberFormat) : call(supportedLocalesOf, NumberFormat) };
let obj2 = { configurable: true, get: GetFormatNumber };
let obj3 = {
  configurable: true,
  writable: true,
  value() {
...
let obj4 = { configurable: true, writable: true, value: DateTimeFormatConstructor };
...
const obj8 = { Number: {}, Date: {} };
obj.__localeSensitiveProtos = obj8;
obj8.Number.toLocaleString = function() {
  const self = this;
...
obj8.Date.toLocaleString = function() {
  const self = this;
  const call = toString.call;
...
obj8.Date.toLocaleDateString = function() {
  const self = this;
  const call = toString.call;
  if ("[object Date]" !== (typeof call === "unknown" ? toString() : call(self))) {
    const _TypeError = TypeError;
...
obj8.Date.toLocaleTimeString = function() {
  const self = this;
  const call = toString.call;
  if ("[object Date]" !== (typeof call === "unknown" ? toString() : call(self))) {
    const _TypeError = TypeError;
...
fn(obj, "__applyLocaleSensitivePrototypes", {
  ...
  configurable: true,
  value() {
    obj = { writable: true, configurable: true, value: obj8.Number.toLocaleString };
