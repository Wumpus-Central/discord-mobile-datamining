...
import state from "../13850_state.js";
import prop from "13848__.js";

let closure_5 = _mod13796("".slice);
let closure_6 = _mod13796("".replace);
let closure_7 = _mod13796([].join);
let closure_8 = _mod13792 && !_mod13793(() => 8 !== defineProperty(() => {}, "length", { value: 8 }).length);
const tmp = _mod13792 && !_mod13793(() => 8 !== defineProperty(() => {}, "length", { value: 8 }).length);
...
const fn = (toString, toString2, arg2) => {
  ...
  let tmp9 = !tmp8;
  if (tmp8) {
    tmp9 = _mod13849.CONFIGURABLE && toString.name !== text2;
    const tmp10 = _mod13849.CONFIGURABLE && toString.name !== text2;
  }
  if (tmp9) {
    if (_mod13792) {
  ...
  try {
    if (arg2) {
      if (_mod13812(arg2, "constructor")) {
        ...
        if (!_mod13812(enforceResult, "source")) {
          let str11 = "";
