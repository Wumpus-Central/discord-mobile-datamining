...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5936).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08252__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08252__.js");
  const invalidPreventRemoveError = require("08253__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08253__.js");
  const modalRouteKeys = require("08254__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05936__.js").SafeAreaProviderCompat, obj4);
};
