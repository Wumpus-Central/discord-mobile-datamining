...
export const useChatKeyboard = function useChatKeyboard(animatedRef, inverted) {
  ...
  const fn2 = function s(height) {
    if (!freeze.value) {
      ...
      if (visibleMinimumPaddingFraction >= 1) {
        num3 = _mod1867.getMinimumPaddingAbsorbed(blankSpace.value, extraContentPadding.value);
        const tmp5Result = _mod1867;
      }
  ...
  let obj9 = require("01831__.js");
  fn2.__closure = {
    freeze,
    targetKeyboardHeight: sharedValue3,
    closing: sharedValue4,
    getEffectiveHeight: require("01867__.js").getEffectiveHeight,
    offset,
    isScrollAtEnd: require("01867__.js").isScrollAtEnd,
    scroll: offset2,
    layout,
    size,
    inverted,
    getVisibleMinimumPaddingFraction: require("01867__.js").getVisibleMinimumPaddingFraction,
    blankSpace,
    getMinimumPaddingAbsorbed: require("01867__.js").getMinimumPaddingAbsorbed,
    extraContentPadding,
    getScrollEffective: require("01867__.js").getScrollEffective,
    ...
    if (!freeze.value) {
      ...
      if (inverted) {
        if (-1 !== height.duration) {
          const effectiveHeight = _mod1867.getEffectiveHeight(height.height, sharedValue3.value, offset);
          const result =
            _mod1867.getMinimumPaddingAbsorbed(blankSpace.value, extraContentPadding.value) * sharedValue5.value;
  ...
  fn3.__closure = {
    ...
    scrollTo: require("cancelAnimation").scrollTo,
    scrollViewRef: animatedRef,
    shouldShiftContent: require("01867__.js").shouldShiftContent,
    closing: sharedValue4,
    clampScrollIfNeeded,
    scroll: offset2,
    clampedScrollTarget: require("01867__.js").clampedScrollTarget,
    actualOpenShift: sharedValue6,
  };
