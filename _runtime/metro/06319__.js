// _runtime/metro/06319__.js
import _mod19 from "00019__.js";
import jsxProd from "../react/00021_jsxProd.js";
import CompatView from "../06320_CompatView.js";
import _mod6321 from "06321__.js";
import CompatScroller from "../06322_CompatScroller.js";
...
export const useSecondaryProps = function useSecondaryProps(ListHeaderComponent) {
  ...
  let tmp7 = ListEmptyComponentStyle(() => {
    ...
    if (ListHeaderComponent) {
      ...
      obj.style = items;
      obj.children = _mod6321.getValidComponent(tmp);
  ...
  let obj2 = {
    ...
    renderEmpty: ListEmptyComponentStyle(() => {
      if (ListEmptyComponent) {
        const validComponent = _mod6321.getValidComponent(tmp);
  ...
  obj2.renderStickyHeaderBackdrop = ListEmptyComponentStyle(() => {
    ...
    if (backdropComponent) {
      ...
      obj.children = _mod6321.getValidComponent(backdropComponent1);
