// _runtime/metro/14275__.js
import _mod14276 from "14276__.js";
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            let obj = { variants: [] };
            const result = Locale(14341).emitUnicodeLanguageId(
              obj.__assign(obj1.__assign({}, Locale(14341).parseUnicodeLanguageId(tmp2)), obj),
            );
            ...
            if (closure_1_6(Locale(14341).emitUnicodeLanguageId(obj)) === result) {
              ...
              obj1.lang = obj2;
              let emitUnicodeLocaleIdResult = Locale(14341).emitUnicodeLocaleId(
              ...
              if (region) {
                ...
                if (closure_1_6(Locale(14341).emitUnicodeLanguageId(obj3)) === result) {
                  ...
                  obj4.lang = obj5;
                  emitUnicodeLocaleIdResult = Locale(14341).emitUnicodeLocaleId(
  ...
  let obj = {
    get() {
      return Locale(14341).emitUnicodeLanguageId(
        Locale(14341).parseUnicodeLanguageId(module_14276.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
