...
import getUTCWeekYear from "../03718_getUTCWeekYear.js";
import startOfUTCWeek from "../03479_startOfUTCWeek.js";
...
let items = [
  {
    ...
    value: function parse(arg0, arg1, ordinalNumber) {
      ...
      if ("Y" === arg1) {
        return _createSuperInternal(3784).mapValue(_createSuperInternal(3784).parseNDigits(4, arg0), valueCallback);
      } else if ("Yo" === arg1) {
        return _createSuperInternal(3784).mapValue(ordinalNumber.ordinalNumber(arg0, { unit: "year" }), valueCallback);
      } else {
  ...
  },
  {
    ...
    value: function set(setUTCFullYear, era, isTwoDigitYear, firstWeekContainsDate) {
      if (isTwoDigitYear.isTwoDigitYear) {
        setUTCFullYear.setUTCFullYear(_createSuperInternal(3784).normalizeTwoDigitYear(isTwoDigitYear.year, tmp), 0, firstWeekContainsDate.firstWeekContainsDate);
