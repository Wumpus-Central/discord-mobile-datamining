...
import _mod14723 from "14723__.js";
import state from "../14724_state.js";
import prop from "14722__.js";

let closure_5 = _mod14670("".slice);
let closure_6 = _mod14670("".replace);
let closure_7 = _mod14670([].join);
let closure_8 = _mod14666 && !_mod14667(() => 8 !== defineProperty(() => {}, "length", { value: 8 }).length);
const tmp = _mod14666 && !_mod14667(() => 8 !== defineProperty(() => {}, "length", { value: 8 }).length);
...
const fn = (toString, toString2, arg2) => {
  ...
  let tmp9 = !tmp8;
  if (tmp8) {
    tmp9 = _mod14723.CONFIGURABLE && toString.name !== text2;
    const tmp10 = _mod14723.CONFIGURABLE && toString.name !== text2;
  }
  if (tmp9) {
    if (_mod14666) {
  ...
  try {
    if (arg2) {
      if (_mod14686(arg2, "constructor")) {
        ...
        if (!_mod14686(enforceResult, "source")) {
          let str11 = "";
