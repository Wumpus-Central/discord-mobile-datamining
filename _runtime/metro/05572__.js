...
export default {
  get(buffer, Compression, arg2) {
    ...
    if (prop) {
      ...
      require("05520__.js").deferInit(Compression, "base64", function () {
        return require("05520__.js").getBase64Image(this.image);
      });
      const obj = require("05520__.js");
    }
    return Compression;
  },
};
