...
arg5.default = {
  read(byteLength, sum) {
    ...
    if (sum + 9 + 1 <= byteLength.byteLength) {
      const byteAt1 = _modDef4927.getByteAt(byteLength, sum + 9);
    ...
    if (sum + 10 + 1 <= byteLength.byteLength) {
      const byteAt2 = _modDef4927.getByteAt(byteLength, sum + 10);
    ...
    if (sum + 11 + 1 <= byteLength.byteLength) {
      const byteAt3 = _modDef4927.getByteAt(byteLength, sum + 11);
    ...
    if (sum + 12 + 1 <= byteLength.byteLength) {
      const byteAt4 = _modDef4927.getByteAt(byteLength, sum + 12);
