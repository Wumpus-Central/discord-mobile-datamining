  ...
  parse(str) {
        ...
        if (joined !== tmp5) {
          ...
          if (tmp33 !== tmp80Result) {
            if (typeof peg$c4 === "function") {
              obj = { type: "messageTextElement", value: tmp33 };
              tmp44 = obj;
            } else {
              throw new TypeError("Trying to call a non-function");
            }
                    ...
                    if (re6.test(str.charAt(closure_70))) {
                      ...
                      if (num === diff) {
                        ...
                        if (closure_70 >= closure_71) {
                          ...
                          let arr5 = closure_72.push(tmp73);
                          str8 = tmp80Result;
                        }
                      }
                    }
                            ...
                            if (joined2 !== tmp130) {
                              ...
                              if (tmp137 !== tmp129) {
                                if (typeof peg$c21 === "function") {
                                  obj = { type: `${tmp95}Format`, style: null };
                                  let tmp139 = tmp137;
                                  if (tmp137) {
                                    tmp139 = tmp137[2];
                                  }
                                      ...
                                      if (peg$parse_() !== tmp119) {
                                        ...
                                        if (tmp159 !== tmp119) {
                                          if (typeof peg$c24 === "function") {
                                            obj1 = { type: tmp159.type, ordinal: false, offset: tmp159.offset || 0, options: tmp159.options };
                                            let tmp149 = obj1;
                                            let tmp161 = tmp119;
                                            if (tmp149 === tmp119) {
                                                    ...
                                                    if (peg$parse_() !== tmp119) {
                                                      ...
                                                      if (tmp180 !== tmp119) {
                                                        if (typeof peg$c27 === "function") {
                                                          const obj2 = { type: tmp180.type, ordinal: true, offset: tmp180.offset || 0, options: tmp180.options };
                                                          let tmp170 = obj2;
                                                          if (tmp170 !== tmp119) {
                                                            tmp161 = tmp119;
                                                            tmp149 = tmp170;
                                                                  ...
                                                                  if (peg$parse_() !== tmp119) {
                                                                    ...
                                                                    if (str11 !== tmp203) {
                                                                      if (typeof peg$c30 === "function") {
                                                                        obj3 = { type: "selectFormat", options: str11 };
                                                                      } else {
                                                                        throw new TypeError("Trying to call a non-function");
                                                                      }
                                                                    } else {
                                ...
                                if (peg$parse_() !== tmp90) {
                                  ...
                                  if (tmp212 !== tmp90) {
                                    if (typeof peg$c14 === "function") {
                                      const obj4 = { type: "argumentElement", id: tmp56, format: null };
                                      let tmp218 = tmp89;
                                      if (tmp89) {
                                        tmp218 = tmp89[2];
                                      }
                ...
                if (peg$parse_() !== tmp3) {
                  ...
                  if (items2 !== tmp18) {
                    if (typeof peg$c1 === "function") {
                      obj = { type: "messageFormatPattern", elements: items2 };
                      tmp38 = obj;
                    } else {
                      throw new TypeError("Trying to call a non-function");
                    }
                    ...
                    if (peg$parse_() !== tmp3) {
                      ...
                      if (tmp42 !== tmp3) {
                        if (typeof peg$c33 === "function") {
                          obj = { type: "optionalFormatPattern", selector: substr, value: tmp38 };
                          let tmp4 = obj;
                        } else {
                          throw new TypeError("Trying to call a non-function");
                        }
            ...
            if (re40.test(str.charAt(closure_70))) {
              ...
              if (0 === diff) {
                ...
                if (closure_70 >= closure_71) {
                  ...
                  let arr1 = closure_72.push(tmp20);
                  charAtResult1 = obj;
                }
              }
            }
              ...
              if (re43.test(str.charAt(closure_70))) {
                ...
                if (0 === diff) {
                  ...
                  if (closure_70 >= closure_71) {
                    ...
                    let arr3 = closure_72.push(tmp39);
                    charAtResult2 = obj;
                  }
                }
              }
    ...
    if (tmp8) {
      if (closure_70 >= offset) {
        ...
        let arr = closure_72.push({ type: "end", description: "end of input" });
      }
    }
    ...
    let obj2 = { message: combined, expected: arr, found: charAtResult1, offset, line, column, name: "SyntaxError" };
    throw obj2;
  }
};
