...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const webWiewLogic = current(onShouldStartLoadWithRequest2[4]).useWebWiewLogic({
    onNavigationStateChange,
    onLoad,
    onError,
    ...
    onShouldStartLoadWithRequestCallback: tmp18,
  });
  ...
  const items3 = [require("08451__.js").container, require("08451__.js").webView, style];
  const items4 = [require("08451__.js").container, containerStyle];
