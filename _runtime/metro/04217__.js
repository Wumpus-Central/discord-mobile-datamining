...
import throwProtectedError from "../04162_throwProtectedError.js";
import parsers from "../04219_parsers.js";
...
import dateLongFormatter_mod from "../04160_dateLongFormatter.js";
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("03920__.js").getDefaultOptions();
  let locale1;
  if (null != locale) {
