        ...
        if (typeof nodes[v0] === "string") {
          ...
          if (first === builder(originalMessage[6]).FormatJsNodeType.Pound) {
            ...
            if (tmp98(originalMessage[6]).FormatJsNodeType.Argument === first) {
              ...
              let obj = { Builder: builder.constructor, nodes: tmp2[2], locales, dataFormatters, formatConfig, values, currentPluralValue, keyPrefix: null };
              const _HermesInternal5 = HermesInternal;
              obj.keyPrefix = "" + keyPrefix + "." + v0;
              const tmp49 = v0(obj);
              if (null != tmp2[3]) {
                obj = { Builder: obj6.constructor, nodes: tmp40, locales: tmp43, dataFormatters, formatConfig, values, currentPluralValue, keyPrefix: null };
              ...
              if (null == tmp104) {
                ...
                obj = { builder, nodes: tmp104, locales, dataFormatters, formatConfig, values, currentPluralValue: null, keyPrefix: null };
                let num2 = 0;
                if (null != tmp103) {
                  num2 = tmp103;
                }
