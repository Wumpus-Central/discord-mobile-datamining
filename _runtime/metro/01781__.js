...
export const useAnimatedGestureHandler = function useAnimatedGestureHandler(handlers, items10) {
  _require = handlers;
  const handler = require("01782__.js").useHandler(handlers, items10);
  ...
  let event = fn;
  if (!useWeb) {
    event = require("01784__.js").useEvent(fn, ["onGestureHandlerStateChange", "onGestureHandlerEvent"], tmp4);
    const tmpResult = require("01784__.js");
  }
  return event;
};
