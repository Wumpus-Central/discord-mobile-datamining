...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("07750__.js").container, require("07750__.js").webView, style];
  const items4 = [require("07750__.js").container, containerStyle];
