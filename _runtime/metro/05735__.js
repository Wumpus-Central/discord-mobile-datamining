...
export const Header = function Header(layout) {
  const rect = require("01614__.js").useSafeAreaInsets();
  const obj = require("01614__.js");
  ...
  const defaultHeaderHeight = require("05733__.js").getDefaultHeaderHeight(layout, tmp9, headerStatusBarHeight);
  if (!headerStyle) {
    headerStyle = {};
  }
  ...
  if (!tmp7) {
    ...
    if ("left" === str) {
      ...
      if (headerSearchBarOptions) {
        ...
        const obj25 = { source: require("05715__.js"), tintColor: text };
