...
import emptyFunction_mod from "10015__.js";
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = timestampProducer(CircularProgress(8586).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = timestampProducer(CircularProgress(8586).Path, obj5);
      }
