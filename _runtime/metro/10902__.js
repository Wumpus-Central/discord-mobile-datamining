...
import REGEX_PARTS from "../10903_REGEX_PARTS.js";
  ...
  entry,
  {
    ...
    value: function innerPattern(option) {
      ...
      if (option.option.forwardDate) {
        let _RegExp1 = new _RegExp(closure_6, RUTimeUnitWithinFormatParser(10903).REGEX_PARTS.flags);
      } else {
  ...
  },
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ParsingComponents.createRelativeFromReference(
        reference.reference,
        RUTimeUnitWithinFormatParser(10903).parseDuration(arg1[1]),
      );
    },
  },
];
