...
import throwProtectedError from "../03940_throwProtectedError.js";
import parsers from "../03997_parsers.js";
...
import dateLongFormatter from "../03938_dateLongFormatter.js";
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("03698__.js").getDefaultOptions();
  locale = undefined;
  if (null != locale) {
