...
import emptyFunction from "09966__.js";
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = timestampProducer(CircularProgress(8542).Path, obj1);
      }
      ...
      if (tmp23Result) {
        ...
        tmp23Result = timestampProducer(CircularProgress(8542).Path, obj2);
      }
      items[1] = tmp23Result;
      items[2] = renderCapResult;
      obj.children = items;
      size1.children = React5(CircularProgress(8542).G, obj);
      const items1 = [timestampProducer(CircularProgress(8542).Svg, size1)];
