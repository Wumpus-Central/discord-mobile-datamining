...
export const createEventEnvelope = function createEventEnvelope(type, url, sdk, arg3) {
  ...
  const eventEnvelopeHeaders = _mod13098.createEventEnvelopeHeaders(type, sdkMetadataForEnvelopeHeader, arg3, url);
  delete tmp[tmp2];
...
export const createSessionEnvelope = function createSessionEnvelope(toJSON, url, sdk, arg3) {
  ...
  let tmp6 = arg3 && url;
  if (tmp6) {
    const obj4 = { dsn: _mod13101.dsnToString(url) };
    tmp6 = obj4;
    const tmpResult = _mod13101;
  }
