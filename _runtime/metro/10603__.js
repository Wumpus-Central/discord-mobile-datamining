...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10464).matchAnyPattern(RUWeekdayParser(10593).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10491).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10593).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
