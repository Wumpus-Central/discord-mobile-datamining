...
// Module 7358
import PanGestureHandler from "PanGestureHandler" /* 7338 */;
...
export const Card = function Card(shadowEnabled) {
  ...
  let merged = Object.assign(flag2(7361).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
