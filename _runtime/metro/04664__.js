...
import parse_mod from "04665__.js";
import AsyncMode from "../04667_AsyncMode.js";
import module_4669_mod from "04669__.js";
...
let module_4669 = module_4669_mod;
if (module_4669) {
  if (typeof module_4669 === "object") {
    if ("default" in module_4669) {
      module_4669 = module_4669.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F127879 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4669(fn, displayName);
};