...
const regExp = new RegExp(
  "(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(?:ce)\\s*)?(" +
    repeatedTimeunitPattern.matchAnyPattern(_mod9957.WEEKDAY_DICTIONARY) +
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (undefined === tmp4) {
        ...
        return FRWeekdayParser(9922).createParsingComponentsAtWeekday(reference.reference, tmp4, str4);
      }
    },
  },
];
