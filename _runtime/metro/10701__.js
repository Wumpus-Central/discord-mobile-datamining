  ...
  entry,
  {
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (index[3]) {
        ...
        start5.assign("year", ENMonthNameParser(10690).parseYear(index[3]));
      } else {
        const start4 = parsingResult.start;
        start4.imply("year", ENMonthNameParser(10692).findYearClosestToRef(createParsingResult.refDate, 1, tmp10));
      }
