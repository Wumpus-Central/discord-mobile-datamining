  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n() {
        ...
        obj.scale = delayFunction(delay, obj3.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(1, obj4)));
        const items = [obj];
        obj.transform = items;
        obj.animations = obj;
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(translateY) {
        ...
        obj4 = { duration: 0.15 * duration };
        obj.translateY = delayFunction(delay, obj3.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(0, obj4)));
        const items = [obj];
        obj.transform = items;
        obj.animations = obj;
        const obj5 = { transform: null };
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(translateX) {
        ...
        const withTimingResult2 = delayFunction(1708).withTiming(10, obj3);
        obj4 = { duration: 0.15 * duration };
        obj.translateX = delayFunction(delay, obj3.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(0, obj4)));
        const items = [obj];
        obj.transform = items;
        obj.animations = obj;
        const obj5 = { transform: null };
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n() {
        ...
        obj.scale = delayFunction(delay, obj3.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(0, obj4)));
        const items = [obj];
        obj.transform = items;
        obj.animations = obj;
        const obj5 = { transform: null };
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(windowHeight) {
        ...
        obj4 = { duration: 0.55 * duration };
        obj.translateY = delayFunction(delay, obj3.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(windowHeight.windowHeight, obj4)));
        const items = [obj];
        obj.transform = items;
        obj.animations = obj;
        const obj5 = { transform: null };
  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(windowWidth) {
        ...
        const withTimingResult2 = delayFunction(1708).withTiming(20, obj3);
        obj4 = { duration: 0.55 * duration };
        obj.translateX = delayFunction(delay, obj3.withSequence(withTimingResult, withTimingResult1, withTimingResult2, delayFunction(1708).withTiming(-windowWidth.windowWidth, obj4)));
        const items = [obj];
        obj.transform = items;
        obj.animations = obj;
        const obj5 = { transform: null };
