...
import handlerIDToTag2 from "../06896_handlerIDToTag.js";
...
import ghQueueMicrotask from "../06924_ghQueueMicrotask.js";
import ActionType from "../06925_ActionType.js";
...
let closure_10 = {
  [fn(6898).State.UNDETERMINED]: undefined,
  [fn(6898).State.BEGAN]: "onBegan",
  [fn(6898).State.FAILED]: "onFailed",
  [fn(6898).State.CANCELLED]: "onCancelled",
  [fn(6898).State.ACTIVE]: "onActivated",
  [fn(6898).State.END]: "onEnded",
};
