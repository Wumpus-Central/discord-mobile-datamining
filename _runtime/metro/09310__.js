// _runtime/metro/09310__.js
import QR8bitByte from "../09311_QR8bitByte.js";
import QRRSBlock from "../09313_QRRSBlock.js";
import QRBitBuffer from "../09315_QRBitBuffer.js";
import _mod9316 from "09316__.js";
import QRPolynomial from "../09317_QRPolynomial.js";
...
prototype.setupPositionAdjustPattern = function () {
  const self = this;
  const patternPosition = _mod9316.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function (arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9316.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function (arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9316.getBCHTypeInfo((this.errorCorrectLevel << 3) | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
