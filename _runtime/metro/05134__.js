...
import get_synchronousScreenUpdatesEnabledDefault from "../05124_get_synchronousScreenUpdatesEnabled.js";
import _mod5133 from "05133__.js";
import _modDef5135 from "05135__.js";
import animatedComponentDefault from "../05136_animatedComponent.js";
import _mod5137 from "05137__.js";
import SHEET_FIT_TO_CONTENTS from "../05138_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05139_DelayedFreeze.js";
import _mod5141 from "05141__.js";
import _modDef5142 from "05142__.js";
...
const jsx = fn(21).jsx;
const __INTERNAL_VIEW_CONFIG = Animated.createAnimatedComponent(_modDef5135);
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  const previous = _mod5137.usePrevious(activityState.activityState);
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5133;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5133.freezeEnabled();
    const tmp2Result6 = _mod5133;
  }
  ...
  if (enabled) {
    if (_mod5133.isNativePlatformSupported) {
      ...
      const sheetInitialDetentIndex1 = SHEET_FIT_TO_CONTENTS.resolveSheetInitialDetentIndex(
        num3,
        sheetAllowedDetents1.length - 1,
      );
      ...
      obj4.fullScreenSwipeEnabled = _mod5141.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      obj4.synchronousShadowStateUpdatesEnabled =
        get_synchronousScreenUpdatesEnabledDefault.experiment.synchronousScreenUpdatesEnabled;
      obj4.androidResetScreenShadowStateOnOrientationChangeEnabled =
        get_synchronousScreenUpdatesEnabledDefault.experiment.androidResetScreenShadowStateOnOrientationChangeEnabled;
      obj4.iosOrientationInheritanceFixEnabled =
        get_synchronousScreenUpdatesEnabledDefault.experiment.iosOrientationInheritanceFixEnabled;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5142.Provider, { value: null, children: null });
      }
