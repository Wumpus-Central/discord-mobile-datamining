...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10521).matchAnyPattern(RUWeekdayParser(10650).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10548).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10650).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
