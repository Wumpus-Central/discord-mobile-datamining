...
import PanGestureHandler from "../06426_PanGestureHandler.js";
import _mod6440 from "06440__.js";
import _mod6441 from "06441__.js";
import _mod6447 from "06447__.js";
...
export const Card = function Card(shadowEnabled) {
  ...
  let tmp11 = num(1507)(() => {
    ...
    if (ref.current) {
      ...
      if (typeof getAnimateToValue === "function") {
        if (closing) {
          let num3 = _mod6440.getDistanceForDirection(layout, gestureDirection, "rtl" === direction);
        } else {
          num3 = 0;
        }
        if (tmp7 === num3) {
          if (ref2.current === num3) {
            ...
            if (tmp24) {
              gesture.setValue(_mod6440.getDistanceForDirection(layout, gestureDirection, "rtl" === direction));
              const obj4 = { closing };
              closure_34(obj4);
            }
          }
  ...
  let merged = Object.assign(
    flag2(6449).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }),
  );
