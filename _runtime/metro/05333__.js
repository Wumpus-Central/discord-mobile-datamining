...
import _modDef5334 from "05334__.js";
import calculateGPSValueDefault from "../05336_calculateGPSValue.js";
    ...
    for (const key10002 in arg0) {
      ...
      let item = arr2.forEach((attributes) => {
        ...
        if (typeof attributes.value === "object") {
          ParseError(5298).objectAssign(tmp3, parseNodeChildrenAsTags(attributes.value));
