...
const regExp1 = new RegExp(
  "(" + _mod10773.TIME_UNITS_NO_ABBR_PATTERN + ")\\s{0,5}(?:ago|before|earlier)(?=\\W|$)",
  "i",
);
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (parseDurationResult) {
        const ParsingComponents = ENTimeUnitAgoFormatParser(10777).ParsingComponents;
        relativeFromReference = ParsingComponents.createRelativeFromReference(
          reference.reference,
          ENTimeUnitAgoFormatParser(10776).reverseDuration(parseDurationResult),
        );
      }
