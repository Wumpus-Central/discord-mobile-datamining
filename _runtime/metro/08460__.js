...
import extractResponderDefault from "extractResponder" /* 8463 */;
import _modDef8468 from "module_8468" /* 8468 */;
import reducedDefault from "reduced" /* 8469 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8461).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8461).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8480);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8464).extractTransformSvgView(tmp);
      const obj3 = Svg(8464);
    }
    obj = {};
    ...
    obj.children = jsx(_modDef8470, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8468, {});
  }
};
let items = [entry];
