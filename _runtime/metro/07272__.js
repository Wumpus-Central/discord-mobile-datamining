// _runtime/metro/07272__.js
import PanGestureHandler from "../07252_PanGestureHandler.js";
import _mod7266 from "07266__.js";
import _mod7267 from "07267__.js";
import _mod7273 from "07273__.js";
...
export const Card = function Card(shadowEnabled) {
  ...
  let tmp11 = num(1506)(() => {
    ...
    if (ref.current) {
      ...
      if (typeof getAnimateToValue === "function") {
        if (closing) {
          let num3 = _mod7266.getDistanceForDirection(layout, gestureDirection, "rtl" === direction);
        } else {
          num3 = 0;
        }
        if (tmp7 === num3) {
          if (ref2.current === num3) {
            ...
            if (tmp24) {
              gesture.setValue(_mod7266.getDistanceForDirection(layout, gestureDirection, "rtl" === direction));
              const obj4 = { closing };
              closure_34(obj4);
            }
          }
  ...
  let merged = Object.assign(
    flag2(7275).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }),
  );
