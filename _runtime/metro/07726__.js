// _runtime/metro/07726__.js
import _mod32 from "00032__.js";
import _objectWithoutProperties2 from "00109__objectWithoutProperties.js";
import _mod7728 from "07728__.js";
import _mod7730 from "07730__.js";
import _mod7731 from "07731__.js";
import 07727__ from "07727__.js";
import noop from "00019__.js";
import get_ActivityIndicator from "00017__.js";
import jsxProd from "../react/00021_jsxProd.js";

const _slicedToArray = module_7727(_mod32);
const _objectWithoutProperties = module_7727(_objectWithoutProperties2);
...
const __INTERNAL_VIEW_CONFIG = module_7727(_mod7728);
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === SLIDER_DEFAULT_INITIAL_VALUE) {
    SLIDER_DEFAULT_INITIAL_VALUE = _mod7730.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (undefined === lowerLimit) {
    ...
    const obj = { web: num, default: _mod7730.constants.LIMIT_MIN_VALUE };
  ...
  if (undefined === upperLimit) {
    ...
    const obj2 = { web: num2, default: _mod7730.constants.LIMIT_MAX_VALUE };
  ...
  if (null == SLIDER_DEFAULT_INITIAL_VALUE2) {
    SLIDER_DEFAULT_INITIAL_VALUE2 = _mod7730.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (!num3) {
    DEFAULT_STEP_RESOLUTION = _mod7730.constants.DEFAULT_STEP_RESOLUTION;
  }
  ...
  if ("ios" === get_ActivityIndicator.Platform.OS) {
    let defaultSlider = _mod7731.styles.defaultSlideriOS;
    let tmp24 = require;
  } else {
    tmp24 = require;
    defaultSlider = _mod7731.styles.defaultSlider;
  }
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = jsxProd.jsx(tmp24(7732).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
