...
import __INTERNAL_VIEW_CONFIGDefault from "04697___INTERNAL_VIEW_CONFIG.js";
...
export default importDefaultResult.forwardRef(function SearchBar(autoCapitalize, ref) {
  ...
  if (ref(4688).isSearchBarAvailableForCurrentPlatform) {
    let obj = {};
