...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5843).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08163__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08163__.js");
  const invalidPreventRemoveError = require("08164__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08164__.js");
  const modalRouteKeys = require("08165__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05843__.js").SafeAreaProviderCompat, obj4);
};
