      ...
      if (NumberResult >= 0) {
        if (NumberResult <= 3) {
          ...
          if (0 !== timezoneOffset) {
            ...
            let str7 = "-";
            const defaultResult6 = module_4154.default(module_3915.default(absolute / 60), 2);
            if (timezoneOffset < 0) {
              str7 = "+";
            }
            const combined = "".concat(str7);
            const combined1 = combined.concat(defaultResult6, ":");
            str6 = combined1.concat(module_4154.default(absolute % 60, 2));
            const defaultResult7 = module_4154.default(absolute % 60, 2);
          }
          const concat = "".concat;
