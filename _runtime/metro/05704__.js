...
export const Header = function Header(layout) {
  ...
  const defaultHeaderHeight = require("module_5702").getDefaultHeaderHeight(layout, tmp9, headerStatusBarHeight);
  if (!headerStyle) {
    headerStyle = {};
  }
  ...
  if (!tmp7) {
    ...
    if ("left" === str) {
      ...
      if (headerSearchBarOptions) {
        ...
        const obj18 = { source: require("module_5684"), tintColor: text };
