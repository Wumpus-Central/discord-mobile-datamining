...
let obj = {
  default: fn(7129).DefaultTransition,
  fade: fn(7129).ModalFadeTransition,
  fade_from_bottom: fn(7129).FadeFromBottomAndroid,
  fade_from_right: fn(7129).FadeFromRightAndroid,
  none: fn(7129).DefaultTransition,
  reveal_from_bottom: fn(7129).RevealFromBottomAndroid,
  scale_from_center: fn(7129).ScaleFromCenterAndroid,
  slide_from_left: fn(7129).SlideFromLeftIOS,
  slide_from_right: fn(7129).SlideFromRightIOS,
  slide_from_bottom: fn(7129).BottomSheetAndroid,
};
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7131).forModalPresentationIOS ||
