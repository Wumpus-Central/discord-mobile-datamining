...
// Module 7128
import PanGestureHandler from "PanGestureHandler" /* 7108 */;
...
export const Card = function Card(shadowEnabled) {
  ...
  let merged = Object.assign(flag2(7131).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }));
