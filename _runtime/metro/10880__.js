...
const regExp = new RegExp(
  "(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:il\\s*?)?(?:(questa|l'ultima|scorsa|prossima)\\s*)?(" +
    repeatedTimeunitPattern.matchAnyPattern(_mod10867.WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ITWeekdayParser(10725).createParsingComponentsAtWeekday(
        reference.reference,
        ITWeekdayParser(10867).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
