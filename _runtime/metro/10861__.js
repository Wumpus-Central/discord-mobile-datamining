...
const chrono = new require("10671__.js").Chrono(createCasualConfiguration());
...
obj7.parsers = items;
obj7.refiners = [];
const chrono1 = new require("10671__.js").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj7, true));
