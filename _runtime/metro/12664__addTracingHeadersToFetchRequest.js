// _runtime/metro/12664__addTracingHeadersToFetchRequest.js
import errorCallback from "../12555_errorCallback.js";
import SyncPromise from "../12583_SyncPromise.js";
import hasTracingEnabled from "../12591_hasTracingEnabled.js";
import getTraceData from "../12630_getTraceData.js";
import closure_2 from "../00850__toArray.js";
import __SENTRY_DEBUG__ from "12558___SENTRY_DEBUG__.js";
import consoleSandbox from "../12559_consoleSandbox.js";
...
export const instrumentFetchRequest = function instrumentFetchRequest(fetchData) {
  ...
  if (fetchData.fetchData) {
        ...
        if (__span) {
          if (arg3[__span]) {
            if (endResult.response) {
              setHttpStatus = setHttpStatus(12576).setHttpStatus;
              ...
              const setHttpStatusResult = setHttpStatus(12576);
            } else if (endResult.error) {
              obj = { code: null, message: "internal_error" };
              obj[0] = setHttpStatus(12576).SPAN_STATUS_ERROR;
              obj10.setStatus(obj);
            }
            endResult = obj10.end();
            delete tmp2[tmp];
    ...
    if (tmp7) {
      const host = setHttpStatus(12641).parseUrl(tmp7).host;
      const setHttpStatusResult2 = setHttpStatus(12641);
    }
    const activeSpan = setHttpStatus(12564).getActiveSpan();
    if (hasTracingEnabledResult) {
      if (activeSpan) {
        ...
        obj1[3] = tmp7;
        obj1[4] = host;
        obj1[setHttpStatus(12574).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN] = str;
        obj1[setHttpStatus(12574).SEMANTIC_ATTRIBUTE_SENTRY_OP] = "http.client";
        obj[1] = obj1;
        let startInactiveSpanResult = setHttpStatus(12593).startInactiveSpan(obj);
        const setHttpStatusResult4 = setHttpStatus(12593);
      }
      ...
      if (arg2(endResult.fetchData.url)) {
        ...
        setHttpStatusResult5 = setHttpStatus(12591);
        const tmp13 = _addTracingHeadersToFetchRequest;
      }
      return startInactiveSpanResult;
    }
    startInactiveSpanResult = new setHttpStatus(12592).SentryNonRecordingSpan();
    const setHttpStatusResult3 = setHttpStatus(12564);
  }
};