// _runtime/metro/05460__.js
import _wrapNativeSuperDefault from "00158__wrapNativeSuper.js";
import _modDef5461 from "05461__.js";
import calculateGPSValueDefault from "../05463_calculateGPSValue.js";
    ...
    for (const key10002 in arg0) {
      ...
      let item = arr2.forEach((attributes) => {
        ...
        if (typeof attributes.value === "object") {
          ParseError(5425).objectAssign(tmp3, parseNodeChildrenAsTags(attributes.value));
