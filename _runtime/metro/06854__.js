...
import _mod6646 from "06646__.js";
import _mod6653 from "06653__.js";
import _mod6855 from "06855__.js";
import ScrollableContainer from "../06856_ScrollableContainer.js";
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    closure_3 = tmp6;
    let obj = _mod6646;
    scrollHandler = obj.useScrollHandler(
      scrollEventsHandlersHook,
      onScroll,
      onScrollBeginDrag,
      onScrollEndDrag,
    ...
    const tmp4Result1 = _mod6646;
    const scrollableSetter = _mod6646.useScrollableSetter(
      scrollableRef,
      SCROLLVIEW,
