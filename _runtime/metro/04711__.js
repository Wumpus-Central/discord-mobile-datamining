// _runtime/metro/04711__.js
import _objectWithoutProperties from "_objectWithoutProperties";
import importDefaultResult from "noop";
import { View } from "get ActivityIndicator";
import { jsx } from "jsxProd";
import { __INTERNAL_VIEW_CONFIG } from "04712___INTERNAL_VIEW_CONFIG.js";
...
export default importDefaultResult.forwardRef(function SearchBar(autoCapitalize, ref) {
  ...
  if (ref(4703).isSearchBarAvailableForCurrentPlatform) {
    let obj = {};
