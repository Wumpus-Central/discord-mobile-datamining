// _runtime/metro/14201__.js
import _mod14202 from "14202__.js";
import _mod14203 from "14203__.js";
import _mod14267 from "14267__.js";
...
function addLikelySubtags(arr3) {
  ...
  if (script) {
    if (region) {
      ...
      const tmp4 = _mod14267.likelySubtags[_mod14267.emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = _mod14267.parseUnicodeLanguageId(tmp4);
        ...
        if (result) {
          ...
          obj = { lang: "und", script: "Array", region: "options", variants };
        }
        parseUnicodeLocaleIdResult.lang = obj;
        return _mod14267.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj1 = { lang, script, variants: [] };
    const tmp5 = _mod14267.likelySubtags[_mod14267.emitUnicodeLanguageId(undefined, obj1)];
    if (tmp5) {
      const result1 = _mod14267.parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = _mod14267.likelySubtags[_mod14267.emitUnicodeLanguageId(undefined, obj4)];
    if (tmp6) {
      const result2 = _mod14267.parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = _mod14267.likelySubtags[lang];
  if (!tmp7) {
    const obj7 = { lang: "und", script, variants: [] };
    tmp7 = _mod14267.likelySubtags[_mod14267.emitUnicodeLanguageId(undefined, obj7)];
  }
  if (tmp7) {
    const result3 = _mod14267.parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
let tmp2 = (() => {
        ...
        if (undefined === arg0) {
          ...
          if (typeof arg0 === "object") {
            ...
            if (defaultResult) {
              ...
              tmp105 = result;
              str29 = "string";
              obj1.hc = closure_0(closure_1[2]).GetOption(
                result,
                "hourCycle",
                "string",
                ["h11", "h12", "h23", "h24"],
              ...
              str30 = "caseFirst";
              tmp108 = result;
              obj1.kf = closure_0(closure_1[2]).GetOption(
                result,
                "caseFirst",
                "string",
                ["upper", "lower", "false"],
              ...
              parseUnicodeLocaleIdResult = closure_0(closure_1[3]).parseUnicodeLocaleId(
                Intl.getCanonicalLocales(
                  closure_0(closure_1[3]).emitUnicodeLocaleId(
                    obj.__assign(obj2.__assign({}, closure_0(closure_1[3]).parseUnicodeLocaleId(locale)), obj),
                  ),
                )[0],
              );
              ...
              tmp153 = closure_0;
              tmp154 = closure_1;
              obj2.locale = Intl.getCanonicalLocales(
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            let obj = { variants: [] };
            const result = Locale(14267).emitUnicodeLanguageId(
              obj.__assign(obj1.__assign({}, Locale(14267).parseUnicodeLanguageId(tmp2)), obj),
            );
            const parseUnicodeLocaleIdResult = Locale(14267).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            obj = { lang, variants: [] };
            if (closure_1_6(Locale(14267).emitUnicodeLanguageId(obj)) === result) {
              Locale(1162);
              ...
              obj1 = { lang: null };
              const obj2 = { lang, script: "Array", region: "options", variants };
              obj1.lang = obj2;
              let emitUnicodeLocaleIdResult = Locale(14267).emitUnicodeLocaleId(
              ...
              if (region) {
                ...
                if (closure_1_6(Locale(14267).emitUnicodeLanguageId(obj3)) === result) {
                  ...
                  obj4.lang = obj5;
                  emitUnicodeLocaleIdResult = Locale(14267).emitUnicodeLocaleId(
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (closure_1_6(Locale(14267).emitUnicodeLanguageId(obj6)) === result) {
  ...
  let obj = {
    get() {
      return Locale(14267).emitUnicodeLanguageId(
        Locale(14267).parseUnicodeLanguageId(module_14202.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
