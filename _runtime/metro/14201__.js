      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            let obj = { variants: [] };
            const result = Locale(14267).emitUnicodeLanguageId(obj.__assign(obj1.__assign({}, Locale(14267).parseUnicodeLanguageId(tmp2)), obj));
            ...
            if (closure_1_6(Locale(14267).emitUnicodeLanguageId(obj)) === result) {
              ...
              obj1.lang = obj2;
              let emitUnicodeLocaleIdResult = Locale(14267).emitUnicodeLocaleId(tmp3Result.__assign(tmp3Result.__assign({}, parseUnicodeLocaleIdResult), obj1));
              ...
              if (region) {
                ...
                if (closure_1_6(Locale(14267).emitUnicodeLanguageId(obj3)) === result) {
                  ...
                  obj4.lang = obj5;
                  emitUnicodeLocaleIdResult = Locale(14267).emitUnicodeLocaleId(tmp3Result1.__assign(Locale(1162).__assign({}, parseUnicodeLocaleIdResult), obj4));
              ...
              if (script) {
                ...
                if (closure_1_6(Locale(14267).emitUnicodeLanguageId(obj6)) === result) {
                  ...
                  obj7.lang = obj8;
                  emitUnicodeLocaleIdResult = Locale(14267).emitUnicodeLocaleId(tmp3Result3.__assign(Locale(1162).__assign({}, parseUnicodeLocaleIdResult), obj7));
