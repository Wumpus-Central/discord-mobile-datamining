...
let obj = {
  default: fn(6431).DefaultTransition,
  fade: fn(6431).ModalFadeTransition,
  fade_from_bottom: fn(6431).FadeFromBottomAndroid,
  fade_from_right: fn(6431).FadeFromRightAndroid,
  none: fn(6431).DefaultTransition,
  reveal_from_bottom: fn(6431).RevealFromBottomAndroid,
  scale_from_center: fn(6431).ScaleFromCenterAndroid,
  slide_from_left: fn(6431).SlideFromLeftIOS,
  slide_from_right: fn(6431).SlideFromRightIOS,
  slide_from_bottom: fn(6431).BottomSheetAndroid,
};
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(6433).forModalPresentationIOS ||
