...
let obj = { default: fn(6431).DefaultTransition, fade: fn(6431).ModalFadeTransition, fade_from_bottom: fn(6431).FadeFromBottomAndroid, fade_from_right: fn(6431).FadeFromRightAndroid, none: fn(6431).DefaultTransition, reveal_from_bottom: fn(6431).RevealFromBottomAndroid, scale_from_center: fn(6431).ScaleFromCenterAndroid, slide_from_left: fn(6431).SlideFromLeftIOS, slide_from_right: fn(6431).SlideFromRightIOS, slide_from_bottom: fn(6431).BottomSheetAndroid };
...
function getDistanceFromOptions(size, gestureDirection, arg2) {
  ...
  if (gestureDirection1) {
    return CardStack(6435).getDistanceForDirection(size, gestureDirection.gestureDirection, arg2);
  } else {
    let presentation;
    if (gestureDirection != null) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(6431).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(6431).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
    ...
    return tmp3(6435).getDistanceForDirection(size, gestureDirection, arg2);
  }
}
...
const entry = {
  ...
  value: function render() {
        ...
        if (typeof getIsModal === "function") {
          ...
          if (!tmp16) {
            ...
            if (typeof getIsModalPresentation === "function") {
              let tmp20 = cardStyleInterpolator === CardStack(6433).forModalPresentationIOS;
              if (!tmp20) {
                tmp20 = "forModalPresentationIOS" === cardStyleInterpolator.name;
              }
              if (tmp20) {
          ...
          obj.children = React6(CardStack(6438).CardContainer, obj3);
          return React6(CardStack(6437).MaybeScreen, obj, key.key);
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
    ...
    items2[1] = renderHeader(CardStack(6437).MaybeScreenContainer, obj4);
    obj.children = items2;
...
const entry1 = {
  ...
  value: function getDerivedStateFromProps(routes, routes2) {
    ...
    const modalRouteKeys = CardStack(6447).getModalRouteKeys(items1, {});
      ...
      if (tmp8) {
        ...
        if (index !== arg2.length - 1) {
          ...
          if ("default" !== str2) {
            ...
            ModalTransition = CardStack(6431).ModalFadeTransition;
          } else {
            if ("modal" !== options.presentation) {
              if (!hasItem1) {
                ModalTransition = CardStack(6431).DefaultTransition;
              }
            }
            ModalTransition = CardStack(6431).ModalTransition;
          }
          ...
          if (undefined !== cardStyleInterpolator) {
            ...
            if (undefined === cardOverlayEnabled) {
              ...
              if (!tmp38) {
                if (typeof getIsModalPresentation === "function") {
                  let tmp42 = cardStyleInterpolator === CardStack(6433).forModalPresentationIOS;
                  if (!tmp42) {
            ...
            if (str10 == null) {
              ...
              if (tmp43) {
                if (typeof getIsModalPresentation === "function") {
                  str10 = "screen";
                  if (cardStyleInterpolator !== CardStack(6433).forModalPresentationIOS) {
            ...
            forNoAnimation = CardStack(6433).forNoAnimation;
          }
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 = cardStyleInterpolator === CardStack(6433).forModalPresentationIOS || "forModalPresentationIOS" === cardStyleInterpolator.name;
                let tmp10 = !tmp9;
                if (tmp9) {
                  let tmp7Result = tmp7(6448);
