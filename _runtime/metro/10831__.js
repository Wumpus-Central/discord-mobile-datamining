...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10692).matchAnyPattern(RUWeekdayParser(10821).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10719).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10821).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
