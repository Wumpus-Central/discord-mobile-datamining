// _runtime/metro/10831__.js
import AbstractTimeExpressionParser from "../10712_AbstractTimeExpressionParser.js";
...
const entry = {
  ...
  value: function patternFlags() {
    return RUTimeExpressionParser(10827).REGEX_PARTS.flags;
  },
};
let items = [
  entry,
  ...
  },
  {
    ...
    value: function primarySuffix() {
      return (
        ...
        RUTimeExpressionParser(10827).REGEX_PARTS.rightBoundary
      );
    },
  },
  {
        ...
        if (first.endsWith("\u0432\u0435\u0447\u0435\u0440\u0430")) {
          ...
          if (value >= 6) {
            if (value < 12) {
              ...
              fnResult.assign("meridiem", RUTimeExpressionParser(10703).Meridiem.PM);
            }
          }
          if (value < 6) {
            fnResult.assign("meridiem", RUTimeExpressionParser(10703).Meridiem.AM);
          }
        }
        const first1 = arg1[0];
