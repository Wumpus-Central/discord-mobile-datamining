...
let closure_6 = "(?:(?:\u043F\u0440\u0438\u0431\u043B\u0438\u0437\u043D\u043E|\u043E\u0440\u0456\u0454\u043D\u0442\u043E\u0432\u043D\u043E)\\s*(?:~\\s*)?)?(" + _mod10049.TIME_UNITS_PATTERN + ")" + _mod10049.REGEX_PARTS.rightBoundary;
...
const entry = {
  ...
  value: function patternLeftBoundary() {
    return UKTimeUnitWithinFormatParser(10049).REGEX_PARTS.leftBoundary;
  }
};
const items = [
  entry,
  {
    ...
    value: function innerPattern(option) {
      ...
      if (option.option.forwardDate) {
        ...
        _RegExp1 = new _RegExp(combined, UKTimeUnitWithinFormatParser(10049).REGEX_PARTS.flags);
      }
      return _RegExp1;
    }
  },
  {
    ...
    value: function innerExtract(reference, arg1) {
      const ParsingComponents = UKTimeUnitWithinFormatParser(9898).ParsingComponents;
      return ParsingComponents.createRelativeFromReference(reference.reference, UKTimeUnitWithinFormatParser(10049).parseDuration(arg1[1]));
    }
  }
];
