// _runtime/metro/14249__.js
import SymbolResult1 from "../14250_SymbolResult1.js";
import URLImpl from "../14251_URLImpl.js";
import _ from "../14258__.js";
      ...
      obj,
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].href = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].protocol = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].username = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].password = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].host = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].hostname = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].port = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].pathname = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].search = URL(14258).USVString(arg0, {
      ...
      },
      {
        ...
        get() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self(14250).getSameObject(self, "searchParams", () =>
                self(closure_1_2[2]).tryWrapperForImpl(self[self(undefined, closure_1_2[2]).implSymbol].searchParams),
              );
            }
          }
          const typeError = new TypeError("Illegal invocation");
      ...
      },
      {
        ...
        set(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              obj = URL(14258);
              self[URL(undefined, 14250).implSymbol].hash = URL(14258).USVString(arg0, {
