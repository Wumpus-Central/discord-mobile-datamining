    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start2.assign("year", ENMonthNameLittleEndianParser(10580).parseYear(index[4]));
        } else {
        ...
        if (index[2]) {
          ...
          const result1 = ENMonthNameLittleEndianParser(10580).parseOrdinalNumberPattern(index[2]);
