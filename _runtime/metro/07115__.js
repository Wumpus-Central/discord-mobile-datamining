// _runtime/metro/07115__.js
import _modDef7116 from "07116__.js";
...
class TouchableHighlight {
  constructor(arg0) {
    ...
    tmp3Result.onStateChange = (arg0, arg1) => {
      if (arg1 === TouchableHighlight(7116).TOUCHABLE_STATE.BEGAN) {
        ...
        tmp3 =
          arg1 !== TouchableHighlight(7116).TOUCHABLE_STATE.UNDETERMINED &&
          arg1 !== TouchableHighlight(7116).TOUCHABLE_STATE.MOVED_OUTSIDE;
      }
    };
