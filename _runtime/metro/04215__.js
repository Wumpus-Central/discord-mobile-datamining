...
import throwProtectedError from "../04160_throwProtectedError.js";
import parsers from "../04217_parsers.js";
import code_mod from "04159__.js";
import subMilliseconds_mod from "../04146_subMilliseconds.js";
import _typeof_mod from "03913__.js";
import assign_mod from "../04163_assign.js";
import dateLongFormatter_mod from "../04158_dateLongFormatter.js";
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("03918__.js").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3917.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3917.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4216).DateToSystemTimezoneSetter();
