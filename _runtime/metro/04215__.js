...
// Module 4215
import throwProtectedError from "throwProtectedError" /* 4160 */;
import parsers from "parsers" /* 4217 */;
...
import dateLongFormatter_mod from "dateLongFormatter" /* 4158 */;
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("module_3918").getDefaultOptions();
  let locale1;
  if (null != locale) {
