...
import _mod9989 from "09989__.js";
...
const regExp = new RegExp(
  "(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:op\\s*?)?(?:(deze|vorige|volgende)\\s*(?:week\\s*)?)?(" +
    repeatedTimeunitPattern.matchAnyPattern(_mod9989.WEEKDAY_DICTIONARY) +
    ")(?=\\W|$)",
  "i",
);
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return NLWeekdayParser(9922).createParsingComponentsAtWeekday(
        reference.reference,
        NLWeekdayParser(9989).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
