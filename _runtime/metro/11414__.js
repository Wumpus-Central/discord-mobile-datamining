...
export const useIAP = () => {
  const iAPContext = require("11415__.js").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("11400__.js").requestPurchase,
    requestSubscription: require("11400__.js").requestSubscription,
  };
};
