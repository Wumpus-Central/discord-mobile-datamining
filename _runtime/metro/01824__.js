...
const fn2 = function t(translationX, width) {
  let obj = { transform: null };
  obj = { translateX: 0.3 * (translationX.translationX - width.width) };
  const items = [obj];
  obj.transform = items;
  return obj;
};
...
obj.belowTopScreenStyle = fn4;
obj = { topScreenStyle: null, belowTopScreenStyle: null };
const fn5 = function c(translateY) {
  let obj = { transform: null };
  obj = { translateY: translateY.translationY };
  const items = [obj];
  obj.transform = items;
  return obj;
};
...
obj.topScreenStyle = fn5;
const fn6 = function _(translationY, height) {
  let obj = { transform: null };
  obj = { translateY: 0.3 * (translationY.translationY - height.height) };
  const items = [obj];
  obj.transform = items;
  return obj;
};
...
obj.belowTopScreenStyle = fn6;
const obj1 = { topScreenStyle: null, belowTopScreenStyle: null };
...
obj6.belowTopScreenStyle = T;
obj5.SwipeRightFade = obj6;

export const ScreenTransition = obj5;
