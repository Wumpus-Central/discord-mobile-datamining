// _runtime/metro/06867__.js
import _modDef38 from "00038__.js";
import cancelAnimation2 from "../01637_cancelAnimation.js";
import value22 from "../06865_value2.js";
import DEFAULT_HANDLE_HEIGHT from "../06868_DEFAULT_HANDLE_HEIGHT.js";
import normalizeSnapPoint from "../06881_normalizeSnapPoint.js";
import LegacyBaseButton from "../06892_LegacyBaseButton.js";
...
class BottomSheet {
  constructor(arg0, arg1) {
    ...
    if (undefined === DEFAULT_ENABLE_CONTENT_PANNING_GESTURE) {
      ...
      DEFAULT_ENABLE_CONTENT_PANNING_GESTURE = animationConfigs(
        DEFAULT_ANIMATE_ON_MOUNT[5],
    ...
    if (undefined === DEFAULT_OVER_DRAG_RESISTANCE_FACTOR) {
      ...
      DEFAULT_OVER_DRAG_RESISTANCE_FACTOR = animationConfigs(
        DEFAULT_ANIMATE_ON_MOUNT[5],
    ...
    if (undefined === DEFAULT_ENABLE_BLUR_KEYBOARD_ON_GESTURE) {
      ...
      DEFAULT_ENABLE_BLUR_KEYBOARD_ON_GESTURE = animationConfigs(
        DEFAULT_ANIMATE_ON_MOUNT[5],
    ...
    if (undefined === DEFAULT_KEYBOARD_INCLUDE_BOTTOM_OFFSET) {
      ...
      DEFAULT_KEYBOARD_INCLUDE_BOTTOM_OFFSET = animationConfigs(
        DEFAULT_ANIMATE_ON_MOUNT[5],
    ...
    obj1 = {
      ...
      INITIAL_HANDLE_HEIGHT: tmp33(tmp34[5]).INITIAL_HANDLE_HEIGHT,
    ...
    obj75 = {
      ...
      interpolate: tmp33(tmp34[4]).interpolate,
      animatedPosition: sharedValue2,
      Extrapolation: tmp33(tmp34[4]).Extrapolation,
      android_keyboardInputMode: DEFAULT_KEYBOARD_INPUT_MODE,
      KEYBOARD_INPUT_MODE: tmp33(tmp34[8]).KEYBOARD_INPUT_MODE,
    ...
    obj80 = {
      ...
      KEYBOARD_BLUR_BEHAVIOR: tmp33(tmp34[8]).KEYBOARD_BLUR_BEHAVIOR,
      KEYBOARD_STATE: tmp33(tmp34[8]).KEYBOARD_STATE,
      animatedContentGestureState: sharedValue10,
      State: tmp33(tmp34[7]).State,
    ...
    obj82 = {
      ...
      print: tmp33(tmp34[9]).print,
      BottomSheet: closure_40,
      normalizeSnapPoint: tmp33(tmp34[9]).normalizeSnapPoint,
      animatedContainerHeight: derivedValue,
      isLayoutCalculated: derivedValue4,
      animatedNextPosition: sharedValue3,
      isForcedClosing: sharedValue8,
      isInTemporaryPosition: sharedValue7,
      runOnUI: tmp33(tmp34[4]).runOnUI,
      animateToPosition: workletCallback2,
      ANIMATION_SOURCE: tmp33(tmp34[8]).ANIMATION_SOURCE,
    };
    ...
    closure_87 = tmp85;
    tmp86 = DEFAULT_DYNAMIC_SIZING(fn, () => ({
    ...
    obj85 = {
      ...
      keyboardBlurBehavior: DEFAULT_KEYBOARD_BLUR_BEHAVIOR,
      KEYBOARD_BLUR_BEHAVIOR: tmp33(tmp34[8]).KEYBOARD_BLUR_BEHAVIOR,
      getKeyboardAnimationConfigs: tmp33(tmp34[9]).getKeyboardAnimationConfigs,
    ...
    class La {
      constructor(arg0) {
        ...
        if (tmp3) {
          tmp8 =
            _contentGestureState !== tmp(tmp2[7]).State.END &&
            _contentGestureState !== tmp(tmp2[7]).State.UNDETERMINED &&
            _contentGestureState !== tmp(tmp2[7]).State.CANCELLED;
          if (!tmp8) {
            tmp9 =
              _handleGestureState !== tmp(tmp2[7]).State.END &&
              _handleGestureState !== tmp(tmp2[7]).State.UNDETERMINED &&
              _handleGestureState !== tmp(tmp2[7]).State.CANCELLED;
            tmp8 = tmp9;
          }
          tmp3 = !tmp8;
        }
