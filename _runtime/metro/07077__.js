...
import _mod7078 from "07078__.js";
import ScrollableContainer from "../07079_ScrollableContainer.js";
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const scrollHandler1 = _mod6869.useScrollHandler(
      scrollEventsHandlersHook,
      onScroll,
      onScrollBeginDrag,
      onScrollEndDrag,
    ...
    const scrollableSetter = _mod6869.useScrollableSetter(
      scrollableRef,
      SCROLLVIEW,
