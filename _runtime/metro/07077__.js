...
import PanGestureHandler from "../07057_PanGestureHandler.js";
...
export const Card = function Card(shadowEnabled) {
  ...
  let merged = Object.assign(
    flag2(7080).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }),
  );
