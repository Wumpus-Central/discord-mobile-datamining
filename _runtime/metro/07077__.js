...
class StackView {
  constructor() {
    ...
    obj = {
      routes: [],
      previousState: "y",
      openingRouteKeys: 0.25,
      closingRouteKeys: null,
      replacingRouteKeys: "MASTERPASS_POPUP_MISSING_REQUIRED_PARAMETERS",
      descriptors: "Masterpass popup failed to return all required parameters needed to continue tokenization.",
    };
          ...
          children(arg0) {
            ...
            return self(closure_0(state[12]).HeaderShownContext.Consumer, {
              children(isParentHeaderShown) {
                ...
                return jsx(StackView(7087).CardStack, {
