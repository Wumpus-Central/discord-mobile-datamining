...
import handlerIDToTag2 from "../06730_handlerIDToTag.js";
...
import ghQueueMicrotask from "../06758_ghQueueMicrotask.js";
import ActionType from "../06759_ActionType.js";
...
let closure_10 = {
  [fn(6732).State.UNDETERMINED]: undefined,
  [fn(6732).State.BEGAN]: "onBegan",
  [fn(6732).State.FAILED]: "onFailed",
  [fn(6732).State.CANCELLED]: "onCancelled",
  [fn(6732).State.ACTIVE]: "onActivated",
  [fn(6732).State.END]: "onEnded",
};
