...
_inherits(SvgImage, _modDef8598);
const entry = {
  key: "render",
  value: function render() {
    ...
    const size = { x, y, width, height, onLoad: props.onLoad, meetOrSlice: SvgImage(8587).meetOrSliceTypes[tmp3] || 0, align: null, src: null };
    [tmp2, tmp3] = parts;
    const tmp6 = SvgImage(8587).meetOrSliceTypes[tmp3] || 0;
    size.align = SvgImage(8587).alignEnum[tmp2] || "xMidYMid";
    ...
    const tmp7 = SvgImage(8587).alignEnum[tmp2] || "xMidYMid";
    const merged = Object.assign(SvgImage(8589).withoutXY(this, props));
