// _runtime/metro/05054__.js
const module = arg2;
const dependencyMap = arg6;
arg5.default = {
  read(dataView, sum) {
    let obj = _module(5055);
    ...
    let tmp8;
    if (5 <= shortAt) {
      const shortAt1 = tmp(5055).getShortAt(dataView, sum + 3);
      const obj2 = { value: null, description: null };
      obj2[0] = shortAt1;
      const _HermesInternal = HermesInternal;
      obj2[1] = "" + shortAt1 + "px";
      tmp8 = obj2;
      const tmpResult1 = tmp(5055);
    }
    obj1[1] = tmp8;
    let tmp11;
    if (7 <= shortAt) {
      const shortAt2 = tmp(5055).getShortAt(dataView, sum + 5);
