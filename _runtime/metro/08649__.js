...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("08652__.js").container, require("08652__.js").webView, style];
  const items4 = [require("08652__.js").container, containerStyle];
