...
import handlerIDToTag2 from "../06764_handlerIDToTag.js";
import tagMessage from "../06765_tagMessage.js";
import _mod6782 from "06782__.js";
...
import ActionType from "../06793_ActionType.js";
...
let closure_10 = {
  [fn(6766).State.UNDETERMINED]: undefined,
  [fn(6766).State.BEGAN]: "onBegan",
  [fn(6766).State.FAILED]: "onFailed",
  [fn(6766).State.CANCELLED]: "onCancelled",
  [fn(6766).State.ACTIVE]: "onActivated",
  [fn(6766).State.END]: "onEnded",
};
