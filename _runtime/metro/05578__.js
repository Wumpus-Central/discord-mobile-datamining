...
export default {
  get(buffer, Compression, arg2) {
    ...
    if (prop) {
      ...
      require("05526__.js").deferInit(Compression, "base64", function () {
        return require("05526__.js").getBase64Image(this.image);
      });
      const obj = require("05526__.js");
    }
    return Compression;
  },
};
