...
applyProgressToMatrix.__closure = {
  addMatrices: _mod1679.addMatrices,
  scaleMatrix: _mod1679.scaleMatrix,
  subtractMatrices: _mod1679.subtractMatrices,
};
    ...
    function transformationMatrixOnFrame(arg0, arg1) {
      ...
      arg0.current = obj4.flatten(
        obj5.multiplyMatrices(
          obj6.multiplyMatrices(tmp4, stopMatrices(1679).multiplyMatrices(tmp5, multiplyMatricesResult)),
          tmp3,
        ),
      );
      ...
      if (reduceMotion.reduceMotion) {
        ...
        if (obj.isColor(current)) {
          ...
          if (tmp3Result.isColor(current)) {
            const tmp3Result13 = fn(1680);
            closure_129_4 = tmp3Result13.toLinearSpace(fn(1680).convertToRGBA(reduceMotion.current));
            const tmp3Result14 = fn(1680);
            const tmp3Result15 = fn(1680);
            closure_129_3 = tmp3Result15.toLinearSpace(fn(1680).convertToRGBA(current));
            if (reduceMotion.toValue) {
              const tmp3Result17 = fn(1680);
              closure_129_5 = tmp3Result17.toLinearSpace(fn(1680).convertToRGBA(reduceMotion.toValue));
              const tmp3Result18 = fn(1680);
            }
            const tmp3Result16 = fn(1680);
          }
          ...
          tmp3Result = fn(1680);
          fn(1680).clampRGBA(items);
          const tmp3Result19 = fn(1680);
          const tmp3Result20 = fn(1680);
          reduceMotion.current = tmp3Result20.rgbaArrayToRGBAColor(fn(1680).toGammaSpace(items));
          reduceMotion.onFrame = colorOnFrame;
          const tmp3Result21 = fn(1680);
        } else {
          if (tmp3Result22.isAffineMatrixFlat(current)) {
            reduceMotion.startMatrices = fn(1679).decomposeMatrixIntoMatricesAndAngles(current);
            const tmp3Result23 = fn(1679);
            reduceMotion.stopMatrices = fn(1679).decomposeMatrixIntoMatricesAndAngles(reduceMotion.toValue);
            const _Object = Object;
              ...
              if (typeof colorOnFrame === "function") {
                if (typeof current === "string") {
                  ...
                  if (match) {
                    ...
                    const reanimatedError = new fn(1648).ReanimatedError("Couldn't parse animation value.");
                    throw reanimatedError;
                  }
                } else {
                ...
                if (typeof colorOnFrame === "function") {
                  if (typeof str3 === "string") {
                    ...
                    if (match1) {
                      ...
                      const reanimatedError1 = new fn(1648).ReanimatedError("Couldn't parse animation value.");
                      ...
                      if (typeof colorOnFrame === "function") {
                        if (typeof str7 === "string") {
                          ...
                          if (match2) {
                            ...
                            const reanimatedError2 = new fn(1648).ReanimatedError("Couldn't parse animation value.");
...
decorateAnimation.__closure = {
  ...
  isColor: _mod1680.isColor,
  toLinearSpace: _mod1680.toLinearSpace,
  convertToRGBA: _mod1680.convertToRGBA,
  clampRGBA: _mod1680.clampRGBA,
  rgbaArrayToRGBAColor: _mod1680.rgbaArrayToRGBAColor,
  toGammaSpace: _mod1680.toGammaSpace,
  decomposeMatrixIntoMatricesAndAngles: _mod1679.decomposeMatrixIntoMatricesAndAngles,
  applyProgressToMatrix,
  applyProgressToNumber,
  getRotationMatrix: _mod1679.getRotationMatrix,
  multiplyMatrices: _mod1679.multiplyMatrices,
  flatten: _mod1679.flatten,
  isAffineMatrixFlat: _mod1679.isAffineMatrixFlat,
};
                            ...
                            if (typeof colorOnFrame === "function") {
                              if (typeof str7 === "string") {
                                ...
                                if (match2) {
                                  ...
                                  const reanimatedError2 = new fn(1648).ReanimatedError(
