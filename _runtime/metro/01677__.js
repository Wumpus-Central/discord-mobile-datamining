    ...
    if (!module_1640) {
      ...
      if (!factory) {
        if (!obj.isWorkletFunction(factory)) {
          const reanimatedError = new _mod1648.ReanimatedError("The easing function is not a worklet. Please make sure you import `Easing` from react-native-reanimated.");
