// _runtime/metro/09891__.js
import ENDefaultConfiguration2 from "../09892_ENDefaultConfiguration.js";
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      } else if (!(extractResult instanceof ParsingContext(9898).ParsingComponents)) {
