...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10698).matchAnyPattern(RUWeekdayParser(10827).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10725).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10827).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
