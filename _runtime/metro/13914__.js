// _runtime/metro/13914__.js
import _mod13908 from "13908__.js";
import URLSearchParamsImpl from "../13915_URLSearchParamsImpl.js";
                ...
                for (const item10039 of ownKeysResult) {
                  ...
                  if (!ownPropertyDescriptor) {
                    ...
                    if (!tmp17.enumerable) {
                      ...
                      obj3 = closure_0(c2[5]);
                      obj1[USVStringResult] = obj3.USVString(first[tmp15], {
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(
                URLSearchParams(13916).USVString(arguments[0], {
                  context: "Failed to execute 'append' on 'URLSearchParams': parameter 1",
                }),
              );
              const obj = URLSearchParams(13916);
              items.push(
                URLSearchParams(13916).USVString(arguments[1], {
