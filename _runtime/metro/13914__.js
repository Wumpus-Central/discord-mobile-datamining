...
// Module 13914
import _mod13908 from "module_13908" /* 13908 */;
import URLSearchParamsImpl from "URLSearchParamsImpl" /* 13915 */;
...
let obj = {
  next: {
    value: function next() {
      const tmp3 = this[_mod13908.iterInternalSymbol];
      ({ kind, index } = tmp3);
      const arr = Array.from(tmp3.target[_mod13908.implSymbol]);
      if (index >= arr.length) {
        return { value: "HermesInternal", done: null };
      } else {
        tmp3.index = index + 1;
        [tmp7, tmp8] = arr[index].map(_mod13908.tryWrapperForImpl);
        if ("key" === kind) {
          let tmp4 = tmp7;
        } else if ("value" === kind) {
          tmp4 = tmp8;
...
let closure_6 = Object.create(_mod13908.IteratorPrototype, obj);
let obj2 = {
  _mixedIntoPredicates: [],
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod13908.implSymbol)) {
        if (arg0[_mod13908.implSymbol] instanceof URLSearchParamsImpl.implementation) {
          return true;
        }
      }
  ...
  convert(arg0) {
    ...
    if (_exports.is(arg0)) {
      return _mod13908.implForWrapper(arg0);
    } else {
  ...
  createDefaultIterator(self, key) {
    ...
    Object.defineProperty(obj2, _mod13908.iterInternalSymbol, obj);
    return obj2;
  },
  create(arg0, arg1, arg2) {
    if (undefined === arg0[_mod13908.ctorRegistrySymbol]) {
      const _Error2 = Error;
      const error = new Error("Internal error: invalid global object");
      throw error;
    } else {
      const _URLSearchParams = arg0[_mod13908.ctorRegistrySymbol].URLSearchParams;
  ...
  createImpl(arg0, arg1, arg2) {
    ...
    return _mod13908.implForWrapper(obj2);
  },
  _internalSetup(arg0) {
  ...
  setup(wrapper, arg1) {
    ...
    Object.defineProperty(wrapper, _mod13908.implSymbol, obj2);
    wrapper[_mod13908.implSymbol][_mod13908.wrapperSymbol] = wrapper;
    if (URLSearchParamsImpl.init) {
      URLSearchParamsImpl.init(wrapper[_mod13908.implSymbol], obj);
  ...
  install(arg0) {
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(URLSearchParams(13916).USVString(arguments[0], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 1" }));
              const obj = URLSearchParams(13916);
              items.push(URLSearchParams(13916).USVString(arguments[1], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 2" }));
              const tmp12 = self[URLSearchParams(undefined, 13908).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13916).USVString(arguments[0], { context: "Failed to execute 'delete' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13908).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13916).USVString(arguments[0], { context: "Failed to execute 'get' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13908).implSymbol];
                const get = tmp6.get;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13916).USVString(arguments[0], { context: "Failed to execute 'getAll' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(13916);
                const tmp11 = self[URLSearchParams(undefined, 13908).implSymbol];
                const getAll = tmp11.getAll;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return URLSearchParams(13908).tryWrapperForImpl(HermesBuiltin.apply(items1, tmp11));
              }
            }
          }
          const typeError1 = new TypeError("Illegal invocation");
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13916).USVString(arguments[0], { context: "Failed to execute 'has' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13908).implSymbol];
                const has = tmp6.has;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 2) {
                ...
                const items = [];
                items.push(URLSearchParams(13916).USVString(arguments[0], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(13916);
                items.push(URLSearchParams(13916).USVString(arguments[1], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 2" }));
                const tmp12 = self[URLSearchParams(undefined, 13908).implSymbol];
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return HermesBuiltin.apply(items1, tmp12);
      ...
      },
      {
        ...
        value: function sort() {
          ...
          if (this) {
            const _exports = module.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 13908).implSymbol].sort();
            }
          }
      ...
      },
      {
        ...
        value: function toString() {
          ...
          if (this) {
            const _exports = module.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 13908).implSymbol].toString();
            }
          }
          const typeError = new TypeError("Illegal invocation");
          throw typeError;
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                const arr2 = Array.from(self[URLSearchParams(undefined, 13908).implSymbol]);
                let num2 = 0;
                let tmp11 = arr2;
                if (0 < arr2.length) {
                  do {
                    let arr = tmp11[num2];
                    let tmp6 = _slicedToArray(arr.map(URLSearchParams(13908).tryWrapperForImpl), 2);
                    [tmp7, tmp8] = tmp6;
                    call = call.call;
                    ...
                    let _Array = Array;
                    arr3 = Array.from(self[URLSearchParams(undefined, 13908).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr3;
    ...
    if (undefined === arg0[URLSearchParams(undefined, 13908).ctorRegistrySymbol]) {
      let _Object = Object;
      const ctorRegistrySymbol = tmp3(13908).ctorRegistrySymbol;
      class URLSearchParams {
        constructor() {
          tmp = closure_3(this, URLSearchParams);
          first = arguments[0];
    ...
    arg0[URLSearchParams(undefined, 13908).ctorRegistrySymbol].URLSearchParams = tmp;
