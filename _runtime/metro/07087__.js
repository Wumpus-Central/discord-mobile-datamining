...
let obj = {
  default: fn(7088).DefaultTransition,
  fade: fn(7088).ModalFadeTransition,
  fade_from_bottom: fn(7088).FadeFromBottomAndroid,
  fade_from_right: fn(7088).FadeFromRightAndroid,
  none: fn(7088).DefaultTransition,
  reveal_from_bottom: fn(7088).RevealFromBottomAndroid,
  scale_from_center: fn(7088).ScaleFromCenterAndroid,
  slide_from_left: fn(7088).SlideFromLeftIOS,
  slide_from_right: fn(7088).SlideFromRightIOS,
  slide_from_bottom: fn(7088).BottomSheetAndroid,
};
...
const entry = {
  ...
  value: function render() {
    ...
    obj2.children = items3.map((key, index) => {
      ...
      if (typeof getInterpolationIndex === "function") {
        ...
        if (typeof getIsModal === "function") {
          ...
          obj.children = React6(CardStack(7095).CardContainer, obj);
    ...
    items2[1] = renderHeader(CardStack(7094).MaybeScreenContainer, obj2);
    obj.children = items2;
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7090).forModalPresentationIOS ||
