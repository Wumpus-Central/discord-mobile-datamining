...
import SINGLE_ITEM from "../10889_SINGLE_ITEM.js";
import handlerOffsetDirection from "../10892_handlerOffsetDirection.js";
import round from "../10905_round.js";
...
export const useCarouselController = function useCarouselController(size) {
  ...
  const globalState = require("10896__.js").useGlobalState();
