// _runtime/metro/07018__.js
import tagMessage2 from "../06904_tagMessage.js";
import touchDataToPressEvent from "../07000_touchDataToPressEvent.js";
import StateMachineEvent2 from "../07003_StateMachineEvent.js";
import GestureObjects2 from "../07019_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(7000).gestureToPressableEvent(handlerTag));
