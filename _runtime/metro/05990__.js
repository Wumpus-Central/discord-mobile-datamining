...
import FrameSizeProvider from "FrameSizeProvider" /* 5967 */;
    ...
    obj = {
      ...
      render(onLayout) {
            ...
            if (closure_2) {
              ...
              tmp2Result = jsx(_mod1616.SafeAreaProvider, { initialMetrics: initialWindowMetrics, style, onLayout, children });
            }
            return tmp2Result;
          }
    };
