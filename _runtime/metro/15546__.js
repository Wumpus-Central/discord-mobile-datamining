...
export default function _regeneratorRuntime() {
        ...
        if ("throw" !== tmp.type) {
          ...
          if (value) {
            ...
            if ("object" == obj.default(value)) {
              ...
              if (callResult) {
                let nextPromise = closure_1.resolve(value.__await).then(
                  (result) => {
          ...
          nextPromise = closure_1.resolve(value).then(
            (value) => {
              iter.value = value;
              closure_0(iter);
            },
  ...
  try {
    ...
    if (!tmp9) {
      ...
      GeneratorFunctionPrototype.prototype = delegate;
      class GeneratorFunction {
        constructor() {
          return;
        }
      ...
      tmp(delegate, "constructor", tmp13);
      const obj1 = { value: GeneratorFunction, configurable: true };
      ...
      delegate.isGeneratorFunction = (fn) => {
      ...
      delegate.awrap = (__await) => ({ __await });
      const result = defineIteratorMethods(AsyncIterator.prototype);
      tmp7(AsyncIterator.prototype, tmp4, function () {
        return this;
      });
      delegate.AsyncIterator = AsyncIterator;
      delegate.async = (arg0, fn, arg2, arg3, arg4) => {
        let _Promise = arg4;
        if (undefined === arg4) {
          _Promise = Promise;
        }
      ...
      const result1 = defineIteratorMethods(delegate);
      tmp7(delegate, tmp5, "Generator");
      tmp7(delegate, tmp3, function () {
        return this;
      });
      tmp7(delegate, "toString", () => "[object Generator]");
      delegate.keys = (arg0) => {
        ...
        delegateYield(next, resultName, nextLoc) {
          if (next) {
            if (next[closure_3]) {
              ...
              delegate = { iterator: tmp3, resultName, nextLoc };
          ...
          delegate = delegate(45);
          const typeError = new TypeError(delegate.default(next) + " is not iterable");
          throw typeError;
        },
      };
