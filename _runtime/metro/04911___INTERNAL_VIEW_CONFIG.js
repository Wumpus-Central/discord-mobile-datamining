// _runtime/metro/04911___INTERNAL_VIEW_CONFIG.js
...
let obj = {
  uiViewClassName: "RNSTabsScreen",
  directEventTypes: {
    topLifecycleStateChange: { registrationName: "onLifecycleStateChange" },
    topWillAppear: { registrationName: "onWillAppear" },
    topDidAppear: { registrationName: "onDidAppear" },
    topWillDisappear: { registrationName: "onWillDisappear" },
    topDidDisappear: { registrationName: "onDidDisappear" },
  },
...
obj = {
  ...
  imageIconResource: { process: resolveAssetSource },
  tabBarItemBadgeTextColor: result.colorAttribute,
  tabBarItemBadgeBackgroundColor: result.colorAttribute,
  standardAppearance: true,
  scrollEdgeAppearance: true,
  iconType: true,
  iconImageSource: null,
  iconResourceName: true,
  selectedIconImageSource: null,
