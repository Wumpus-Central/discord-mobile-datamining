...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13471)(arg0, arg3);
  const tmp4 = new _require(13500)(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(13491);
    let tmpResult = tmp(13496);
    tmpResult = tmp(13492);
    closure_2 = tmpResult;
    let str3 = ">=";
    let str = ">";
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13492);
      tmpResult = tmp(13495);
      tmpResult1 = tmp(13491);
  ...
  if (_require(13502)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
