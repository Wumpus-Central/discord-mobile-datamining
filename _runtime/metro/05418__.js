...
import _modDef5419 from "05419__.js";
import calculateGPSValueDefault from "../05421_calculateGPSValue.js";
    ...
    for (const key10002 in arg0) {
      ...
      let item = arr2.forEach((attributes) => {
        ...
        if (typeof attributes.value === "object") {
          ParseError(5383).objectAssign(tmp3, parseNodeChildrenAsTags(attributes.value));
