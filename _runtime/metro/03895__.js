...
import throwProtectedError from "../03910_throwProtectedError.js";
import 03845__ from "03845__.js";
import subMilliseconds from "../03896_subMilliseconds.js";
import _typeof from "03663__.js";
import G from "../03897_G.js";
import dateLongFormatter from "../03908_dateLongFormatter.js";
import 03826__ from "03826__.js";
import 03667__ from "03667__.js";
import requiredArgs from "../03664_requiredArgs.js";
import code from "03909__.js";

if (!module_3845) {
  let obj = { default: module_3845 };
  let tmp3 = obj;
} else {
  tmp3 = module_3845;
}
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("03668__.js").getDefaultOptions();
  locale = undefined;
  if (null != locale) {
          ...
          if (locale.localize) {
            if (locale.formatLong) {
              ...
              if (module_3845.default(defaultResult3)) {
                _typeof = locale.default(defaultResult3, module_3826.default(defaultResult3));
