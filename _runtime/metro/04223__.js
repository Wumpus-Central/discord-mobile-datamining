  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("Y" === arg1) {
      ...
      return _createSuperInternal(4221).mapValue(
        _createSuperInternal(4221).parseNDigits(arg1.length, arg0),
        valueCallback,
      );
    }
  },
    ...
    value: function set(setUTCFullYear, era, isTwoDigitYear, firstWeekContainsDate) {
      if (isTwoDigitYear.isTwoDigitYear) {
        setUTCFullYear.setUTCFullYear(
          _createSuperInternal(4221).normalizeTwoDigitYear(isTwoDigitYear.year, tmp),
          0,
