...
import { __INTERNAL_VIEW_CONFIG } from "04671___INTERNAL_VIEW_CONFIG.js";
...
export default importDefaultResult.forwardRef(function SearchBar(autoCapitalize, ref) {
  ...
  if (ref(4662).isSearchBarAvailableForCurrentPlatform) {
    let obj = {};
