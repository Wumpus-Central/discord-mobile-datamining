...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      UKWeekdayParser(10464).matchAnyPattern(UKWeekdayParser(10618).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return UKWeekdayParser(10491).createParsingComponentsAtWeekday(
        reference.reference,
        UKWeekdayParser(10618).WEEKDAY_DICTIONARY[arg1[2].toLocaleLowerCase()],
        str2,
      );
    },
  },
