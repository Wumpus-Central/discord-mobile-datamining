          ...
          if (typeof cause === "number") {
            ...
            if (tmp5 !== cause) {
              ...
              if (typeof call6 === "unknown") {
                let tmp13Result3 = replace(tmp16, "$&_");
              } else {
                tmp13Result3 = call6(tmp12, tmp16, "$&_");
              }
              const tmp18 = /_$/;
              if (typeof call5 === "unknown") {
                let tmp13Result4 = replace(tmp18, "");
              } else {
  ...
  if (tmp2) {
    ...
    if (toStringTag1) {
      ...
      if (typeof cause === "object") {
        let tmp6 = toStringTag1 in cause;
        if (!tmp6) {
          tmp6 = undefined !== cause[toStringTag1];
        }
        tmp5 = tmp6;
      }
      tmp4 = !tmp5;
...
function inspect_(cause, maxStringLength, arg2, arr) {
  ...
  if (typeof call3 === "unknown") {
    let tmpResult5 = closure_35("maxStringLength");
  } else {
  ...
  if (typeof call4 === "unknown") {
    let tmpResult6 = closure_35("customInspect");
  } else {
  ...
  if (typeof call5 === "unknown") {
    let tmpResult7 = closure_35("indent");
  } else {
  ...
  if (typeof call6 === "unknown") {
    let tmpResult8 = closure_35("numericSeparator");
  } else {
        ...
        if (typeof cause === "object") {
          ...
          if (tmp198) {
            ...
            if (toStringTag1) {
              ...
              if (typeof cause === "object") {
                tmp201 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                const tmp202 = toStringTag1 in cause || undefined !== cause[toStringTag1];
              }
              tmp200 = !tmp201;
            }
            tmp198 = tmp200;
      ...
      if (typeof cause === "function") {
        ...
        if (tmp33) {
          ...
          if (toStringTag1) {
            ...
            if (typeof cause === "object") {
              tmp36 = toStringTag1 in cause || undefined !== cause[toStringTag1];
              const tmp37 = toStringTag1 in cause || undefined !== cause[toStringTag1];
            }
            tmp35 = !tmp36;
          }
          tmp33 = tmp35;
        ...
        if (flag) {
          ...
          if (tmp52) {
            ...
            if (toStringTag1) {
              ...
              if (typeof cause === "object") {
                tmp55 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                const tmp56 = toStringTag1 in cause || undefined !== cause[toStringTag1];
              }
              tmp54 = !tmp55;
            }
            tmp52 = tmp54;
  ...
  ${tmp21}`;
            ...
            if (tmp57) {
              ...
              if (toStringTag1) {
                ...
                if (typeof cause === "object") {
                  tmp60 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                  const tmp61 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                }
                tmp59 = !tmp60;
              }
              tmp57 = tmp59;
                  ...
                  const fn2 = (cause, arg1) => {
                    if (!closure_0) {
                      ...
                      if (!closure_0) {
                        ...
                        arr = arr2;
                        arr4 = arr2.push(closure_0);
                      }
                    } else {
                      const call = slice.call;
                      let arr5 = arr;
                      arr = typeof call === "unknown" ? slice() : call(arr5);
                      arr5 = arr.push(closure_0);
                    }
                  };
  ...
  ${prev2}`;
                ...
                if (tmp63) {
                  ...
                  if (toStringTag1) {
                    let tmp66 = tmp62;
                    if (typeof cause === "object") {
                      tmp66 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                      const tmp67 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                    }
                    tmp65 = !tmp66;
                  }
                  tmp63 = tmp65;
                ...
                if (tmp63) {
                  ...
                  if (tmp68) {
                    ...
                    if (toStringTag1) {
                      let tmp71 = tmp62;
                      if (typeof cause === "object") {
                        tmp71 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                        const tmp72 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                      }
                      tmp70 = !tmp71;
                    }
                    tmp68 = tmp70;
                  ...
                  if (tmp68) {
                    ...
                    if (tmp73) {
                      ...
                      if (toStringTag1) {
                        let tmp76 = tmp62;
                        if (typeof cause === "object") {
                          tmp76 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                          const tmp77 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                        }
                        tmp75 = !tmp76;
                      }
                      tmp73 = tmp75;
                      ...
                      if (typeof globalThis === "undefined") {
                        ...
                        if (tmp79) {
                          ...
                          if (toStringTag1) {
                            let tmp82 = tmp62;
                            if (typeof cause === "object") {
                              tmp82 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                              const tmp83 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                            }
                            tmp81 = !tmp82;
                          }
                          tmp79 = tmp81;
                        ...
                        if (!tmp79) {
                          ...
                          if (tmp84) {
                            ...
                            if (toStringTag1) {
                              if (typeof cause === "object") {
                                tmp62 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                                const tmp87 = toStringTag1 in cause || undefined !== cause[toStringTag1];
                              }
                              tmp86 = !tmp62;
                            }
                            tmp84 = tmp86;
