...
import reducedDefault from "reduced" /* 7922 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(7914).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(7914).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef7933);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(7917).extractTransformSvgView(tmp);
      const obj3 = Svg(7917);
    }
    const obj4 = {};
    ...
    obj4.children = jsx(_modDef7923, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef7921, {});
  }
};
let items = [entry];
