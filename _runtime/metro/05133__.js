...
import _modDef5134 from "05134__.js";
import animatedComponentDefault from "../05135_animatedComponent.js";
import _mod5136 from "05136__.js";
import SHEET_FIT_TO_CONTENTS from "../05137_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05138_DelayedFreeze.js";
import _mod5140 from "05140__.js";
import _modDef5141 from "05141__.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5132;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5132.freezeEnabled();
    const tmp2Result6 = _mod5132;
  }
  ...
  if (enabled) {
    if (_mod5132.isNativePlatformSupported) {
      ...
      obj4.fullScreenSwipeEnabled = _mod5140.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5141.Provider, { value: null, children: null });
      }
