...
import { SemVer } from "../13116_SemVer.js";
import { Comparator } from "../13144_Comparator.js";
import { Range } from "../13145_Range.js";
import { Range } from "../13147_Range.js";
...
export default (arg0, arg1, arg2, arg3) => {
  ...
  if (">" === arg2) {
    let dependencyMap = tmp(13136);
    let tmpResult = tmp(13141);
    tmpResult = tmp(13137);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13137);
      tmpResult = tmp(13140);
      tmpResult1 = tmp(13136);
