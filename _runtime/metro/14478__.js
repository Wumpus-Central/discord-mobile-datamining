...
function addLikelySubtags(arr3) {
  ...
  if (script) {
    if (region) {
      ...
      const tmp4 = _mod14544.likelySubtags[_mod14544.emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = _mod14544.parseUnicodeLanguageId(tmp4);
        ...
        return _mod14544.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = _mod14544.likelySubtags[_mod14544.emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = _mod14544.parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = _mod14544.likelySubtags[_mod14544.emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = _mod14544.parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = _mod14544.likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = _mod14544.likelySubtags[_mod14544.emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = _mod14544.parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            if (closure_1_6(Locale(14544).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = Locale(14544).emitUnicodeLocaleId(tmp3Result.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj5));
              const __assignResult = Locale(1161).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (closure_1_6(Locale(14544).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = Locale(14544).emitUnicodeLocaleId(tmp3Result7.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (closure_1_6(Locale(14544).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = Locale(14544).emitUnicodeLocaleId(tmp3Result9.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj11));
