...
import _modDef7930 from "07930__.js";
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, r } = props);
    const merged = Object.assign(Circle(7916).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.r = r;
    const obj2 = Circle(7916);
    const obj3 = {
      ref(arg0) {
