...
import handlerIDToTag2 from "../06770_handlerIDToTag.js";
import tagMessage from "../06771_tagMessage.js";
import _mod6788 from "06788__.js";
import RNGestureHandlerModuleDefault from "../06795_RNGestureHandlerModule.js";
import transformIntoHandlerTags from "../06797_transformIntoHandlerTags.js";
import ghQueueMicrotask from "../06798_ghQueueMicrotask.js";
import ActionType from "../06799_ActionType.js";
...
let closure_10 = {
  [fn(6772).State.UNDETERMINED]: undefined,
  [fn(6772).State.BEGAN]: "onBegan",
  [fn(6772).State.FAILED]: "onFailed",
  [fn(6772).State.CANCELLED]: "onCancelled",
  [fn(6772).State.ACTIVE]: "onActivated",
  [fn(6772).State.END]: "onEnded",
};
