...
import "module_12926";
import consoleSandbox from "12927__.js";
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = _mod12934.isInstanceOf(headers, Request);
        const tmpResult = _mod12934;
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = _mod12934.isInstanceOf(headers, Headers);
        const tmpResult2 = _mod12934;
      }
