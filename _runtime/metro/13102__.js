...
export const createTransport = function createTransport(bufferSize, arg1) {
  ...
  if (arg2 === undefined) {
    ...
    promiseBuffer = require("13103__.js").makePromiseBuffer(num);
    let obj = require("13103__.js");
  }
  closure_3 = {};
  return {
    send(arg0) {
            ...
            (arg0) => {
              if (arg0 instanceof _mod13096.SentryError) {
                ...
                if (typeof recordEnvelopeLoss === "function") {
                  ...
                  _mod13083.forEachEnvelopeItem(closure_1, (arg0, arg1) => {
                    if ("event" === arg1) {
                      const _Array = Array;
                      let tmp4;
                      if (Array.isArray(arg0)) {
                  ...
                  const tmpResult = _mod13083;
                  return _mod13063.resolvedSyncPromise({});
                } else {
                  throw new TypeError("Trying to call a non-function");
                }
              } else {
