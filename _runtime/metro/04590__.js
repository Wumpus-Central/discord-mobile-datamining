...
import parse_mod from "04591__.js";
import AsyncMode from "../04593_AsyncMode.js";
import module_4595_mod from "04595__.js";
...
let module_4595 = module_4595_mod;
if (module_4595) {
  if (typeof module_4595 === "object") {
    if ("default" in module_4595) {
      module_4595 = module_4595.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F128395 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4595(fn, displayName);
};