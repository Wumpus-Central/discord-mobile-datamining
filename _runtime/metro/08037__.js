...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5719).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08042__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08042__.js");
  const invalidPreventRemoveError = require("08043__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08043__.js");
  const modalRouteKeys = require("08044__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05719__.js").SafeAreaProviderCompat, obj4);
};
