...
if (!module_3917) {
  const obj7 = { default: module_3917 };
  let tmp15 = obj7;
} else {
  tmp15 = module_3917;
}
...
export default function format(arg0, arg1, locale) {
  ...
  if (defaultResult1 >= 1) {
    if (defaultResult1 <= 7) {
      ...
      const defaultResult2 = module_3917.default(num4);
      if (defaultResult2 >= 0) {
        if (defaultResult2 <= 6) {
          if (locale1.localize) {
            if (locale1.formatLong) {
              const defaultResult3 = _typeof.default(arg0);
              if (module_4095.default(defaultResult3)) {
                _typeof = locale1.default(defaultResult3, module_4076.default(defaultResult3));
