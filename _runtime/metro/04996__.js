...
export default function TabsHost(arg0) {
  ...
  return jsx(_modDef5002, { style: null, navStateRequest, onTabSelected: _mod5001.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null });
};