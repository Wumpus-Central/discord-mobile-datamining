// _runtime/metro/17268__.js
import extend from "../17270_extend.js";
import SyntaxError from "../17271_SyntaxError.js";
import StringFormat from "../17273_StringFormat.js";
import defineProperty from "17269__.js";
import "module_17269";
  ...
  constructor(arg0, arg1, arg2) {
    ...
    if (__parseResult) {
      ...
      if ("messageFormatPattern" === __parseResult.type) {
        ...
        obj = { value: null };
        obj.value = this._resolveLocale(require);
        str2 = "_locale";
...
obj1.value = defineProperty.objCreate(null);
defineProperty.defineProperty(MessageFormat, "__localeData__", obj1);
