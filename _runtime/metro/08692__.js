...
const entry = {
  ...
  value: function render() {
    ...
    if (patternContentUnits) {
      num2 = Pattern(8684)[patternContentUnits];
    }
    ...
    const merged1 = Object.assign(Pattern(8619)({ viewBox, preserveAspectRatio }));
