  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(translateX) {
        ...
        const obj2 = {
          opacity: delayFunction(delay, delayFunction(1709).withTiming(1, { duration })),
          transform: null,
        };
        ...
        obj7.skewX = delayFunction(
          delay,
          obj8.withSequence(
            withTimingResult,
            withTimingResult1,
            delayFunction(1709).withTiming("0deg", { duration: 0.15 * duration }),
          ),
        );
        items[1] = obj7;
      ...
      fn.__closure = {
        delayFunction,
        delay,
        withTiming: LightSpeedOutLeft(1709).withTiming,
        duration,
        animation,
        config: tmp2[1],
        withSequence: LightSpeedOutLeft(1709).withSequence,
        initialValues,
        callback: callbackV,
      };
