// _runtime/metro/04975__.js
import get_synchronousScreenUpdatesEnabledDefault from "../04965_get_synchronousScreenUpdatesEnabled.js";
import _mod4974 from "04974__.js";
import _modDef4976 from "04976__.js";
import animatedComponentDefault from "../04977_animatedComponent.js";
import _mod4978 from "04978__.js";
import SHEET_FIT_TO_CONTENTS from "../04979_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../04980_DelayedFreeze.js";
import _mod4982 from "04982__.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (enabled) {
    if (_mod4974.isNativePlatformSupported) {
      ...
      obj.fullScreenSwipeEnabled = _mod4982.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef4983.Provider, { value: null, children: null });
      }
