...
import _mod14639 from "14639__.js";
import e from "../01161_e.js";

function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod14639.parseUnicodeLocaleId(arr3);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      const obj = { lang, script, region, variants: [] };
      const tmp4 = _mod14639.likelySubtags[_mod14639.emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = _mod14639.parseUnicodeLanguageId(tmp4);
        ...
        if (result) {
          ...
          const tmpResult = e;
          obj2.variants = tmpResult.__spreadArray(e.__spreadArray([], variants, true), result.variants, true);
          let obj3 = obj2;
          const tmpResult8 = e;
        } else {
        ...
        return _mod14639.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = _mod14639.likelySubtags[_mod14639.emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = _mod14639.parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
      if (result1) {
        ...
        obj5.region = region;
        const tmpResult9 = e;
        obj5.variants = tmpResult9.__spreadArray(e.__spreadArray([], items, true), result1.variants, true);
        let obj6 = obj5;
        const tmpResult10 = e;
      } else {
  ...
  if (region) {
    ...
    const tmp6 = _mod14639.likelySubtags[_mod14639.emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = _mod14639.parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
      if (result2) {
        ...
        const tmpResult11 = e;
        obj8.variants = tmpResult11.__spreadArray(e.__spreadArray([], items1, true), result2.variants, true);
        let obj9 = obj8;
        const tmpResult12 = e;
      } else {
  ...
  let tmp7 = _mod14639.likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = _mod14639.likelySubtags[_mod14639.emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = _mod14639.parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
    ...
    if (result3) {
      ...
      const tmpResult13 = e;
      obj11.variants = tmpResult13.__spreadArray(e.__spreadArray([], items2, true), result3.variants, true);
      let tmp14 = obj11;
      const tmpResult14 = e;
    } else {
      obj11.lang = "und";
...
const module_14574 = e.__importDefault(_mod14574);
...
let tmp2 = (() => {
        ...
        if (undefined === arg0) {
          ...
          if (typeof arg0 === "object") {
            ...
            if (defaultResult) {
              ...
              invariantResult = closure_0(closure_1[2]).invariant(
              ...
              invariantResult1 = closure_0(closure_1[2]).invariant(
                closure_0(closure_1[3]).isStructurallyValidLanguageTag(locale),
              ...
              if (tmp33) {
                ...
                invariantResult2 = closure_0(closure_1[2]).invariant(
                  closure_0(closure_1[3]).isUnicodeLanguageSubtag(GetOptionResult),
              ...
              if (tmp44) {
                ...
                invariantResult3 = closure_0(closure_1[2]).invariant(
                  closure_0(closure_1[3]).isUnicodeScriptSubtag(GetOptionResult1),
              ...
              if (tmp54) {
                ...
                invariantResult4 = closure_0(closure_1[2]).invariant(
                  closure_0(closure_1[3]).isUnicodeRegionSubtag(GetOptionResult2),
              ...
              tmp93 = result;
              str26 = "string";
              GetOptionResult5 = closure_0(closure_1[2]).GetOption(
                result,
                "firstDayOfWeek",
                "string",
                undefined,
              ...
              tmp105 = result;
              str29 = "string";
              obj5.hc = closure_0(closure_1[2]).GetOption(
                result,
                "hourCycle",
                "string",
                ["h11", "h12", "h23", "h24"],
              ...
              str30 = "caseFirst";
              tmp108 = result;
              obj5.kf = closure_0(closure_1[2]).GetOption(
                result,
                "caseFirst",
                "string",
                ["upper", "lower", "false"],
              ...
              tmp116 = result;
              str34 = "string";
              GetOptionResult7 = closure_0(closure_1[2]).GetOption(
                result,
                "numberingSystem",
                "string",
                undefined,
              ...
              tmp123 = closure_0;
              tmp124 = closure_1;
              parseUnicodeLocaleIdResult = closure_0(closure_1[3]).parseUnicodeLocaleId(
                Intl.getCanonicalLocales(
                  closure_0(closure_1[3]).emitUnicodeLocaleId(
                    obj.__assign(obj2.__assign({}, closure_0(closure_1[3]).parseUnicodeLocaleId(locale)), obj1),
                  ),
                )[0],
              );
              ...
              for (let num5 = 0; num5 < prop.length; num5 = num5 + 1) {
                ...
                if (undefined !== tmp147) {
                  ...
                  invariantResult6 = closure_0(closure_1[2]).invariant(
                    typeof tmp147 === "string",
                    "Value for ".concat(tmp133, " must be a string"),
                  );
                  if (tmp137) {
                    tmp137[1] = tmp147;
                    tmp138 = tmp147;
              ...
              tmp153 = closure_0;
              tmp154 = closure_1;
              obj6.locale = Intl.getCanonicalLocales(
                closure_0(closure_1[3]).emitUnicodeLocaleId(parseUnicodeLocaleIdResult),
              )[0];
              ({
                locale: tmp16.locale,
                ca: tmp16.calendar,
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14639).emitUnicodeLanguageId(
              obj.__assign(Locale(1161).__assign({}, Locale(14639).parseUnicodeLanguageId(tmp2)), obj3),
            );
            const parseUnicodeLocaleIdResult = Locale(14639).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (closure_1_6(Locale(14639).emitUnicodeLanguageId(obj4)) === result) {
              const tmp3Result = Locale(1161);
              const tmp3Result6 = Locale(1161);
              if (undefined === variants) {
                variants = [];
              }
              if (!lang) {
              ...
              const obj6 = { lang, script: "Array", region: "paddingHorizontal", variants };
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = Locale(14639).emitUnicodeLocaleId(
                tmp3Result.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj5),
              );
              const __assignResult = Locale(1161).__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (closure_1_6(Locale(14639).emitUnicodeLanguageId(obj7)) === result) {
                  const tmp3Result7 = Locale(1161);
                  let items = variants;
                  const tmp3Result8 = Locale(1161);
                  if (undefined === variants) {
                    items = [];
                  }
                  let str2 = lang;
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = Locale(14639).emitUnicodeLocaleId(
                    tmp3Result7.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj8),
                  );
                  const __assignResult1 = Locale(1161).__assign({}, parseUnicodeLocaleIdResult);
                }
              }
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (closure_1_6(Locale(14639).emitUnicodeLanguageId(obj10)) === result) {
                  const tmp3Result9 = Locale(1161);
                  let items1 = variants;
                  const tmp3Result10 = Locale(1161);
                  if (undefined === variants) {
                    items1 = [];
                  }
                  let str = lang;
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = Locale(14639).emitUnicodeLocaleId(
                    tmp3Result9.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj11),
                  );
                  const __assignResult2 = Locale(1161).__assign({}, parseUnicodeLocaleIdResult);
                }
              }
            }
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14639).emitUnicodeLanguageId(
        Locale(14639).parseUnicodeLanguageId(module_14574.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
  ...
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_14574.default(this).calendar;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_14574.default(this).collation;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_14574.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_14574.default(this).numeric;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_14574.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14639).parseUnicodeLanguageId(module_14574.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14639).parseUnicodeLanguageId(module_14574.default(this).locale).script;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14639).parseUnicodeLanguageId(module_14574.default(this).locale).region;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_14574.default(this);
      if (Locale(14575).HasOwnProperty(defaultResult, "initializedLocale")) {
