...
import COUNTER_METRIC_TYPE from "../13024_COUNTER_METRIC_TYPE.js";
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("12941__.js").timestampInSeconds();
      c4 = timestampInSecondsResult;
      let obj = require("12941__.js");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("12961__.js").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
