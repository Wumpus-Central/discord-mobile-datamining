...
import _modDef5091 from "05091__.js";
import _modDef5110 from "05110__.js";
import styleDefault from "../05115_style.js";
...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  dependencyMap = flag5.useContext(screenId(5111).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(5114).isIOS26OrHigher;
  }
  _modDef5110(
    isIOS26OrHigher,
  ...
  if (screenId(5114).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(screenId(5118).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(screenId(5120).FooterComponent, obj7);
  }
