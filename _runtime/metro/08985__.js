  ...
  if (__setModuleDefault) {
    ...
    exports.default = function default_1() {
      if (typeof error === "function") {
        ...
        obj = { string: { unit: "\u0E15\u0E31\u0E27\u0E2D\u0E31\u0E01\u0E29\u0E23", verb: "\u0E04\u0E27\u0E23\u0E21\u0E35" }, file: { unit: "\u0E44\u0E1A\u0E15\u0E4C", verb: "\u0E04\u0E27\u0E23\u0E21\u0E35" }, array: { unit: "\u0E23\u0E32\u0E22\u0E01\u0E32\u0E23", verb: "\u0E04\u0E27\u0E23\u0E21\u0E35" }, set: { unit: "\u0E23\u0E32\u0E22\u0E01\u0E32\u0E23", verb: "\u0E04\u0E27\u0E23\u0E21\u0E35" } };
          ...
          switch (code.code) {
            ...
            case "too_big":
              ...
              if (tmp27) {
                ...
                let combined2 = "\u0E40\u0E01\u0E34\u0E19\u0E01\u0E33\u0E2B\u0E19\u0E14: " + str28 + " \u0E04\u0E27\u0E23\u0E21\u0E35" + str27 + " " + str + " " + str35;
              } else {
                let str29 = str28;
                if (str28 == null) {
                  str29 = "\u0E04\u0E48\u0E32";
            ...
            case "too_small":
              ...
              if (tmp15) {
                ...
                let combined3 = "\u0E19\u0E49\u0E2D\u0E22\u0E01\u0E27\u0E48\u0E32\u0E01\u0E33\u0E2B\u0E19\u0E14: " + origin + " \u0E04\u0E27\u0E23\u0E21\u0E35" + str18 + " " + str1 + " " + tmp15.unit;
              } else {
                const _HermesInternal10 = HermesInternal;
                combined3 = "\u0E19\u0E49\u0E2D\u0E22\u0E01\u0E27\u0E48\u0E32\u0E01\u0E33\u0E2B\u0E19\u0E14: " + origin + " \u0E04\u0E27\u0E23\u0E21\u0E35" + str18 + " " + str1;
              }
              return combined3;
            case "invalid_format":
