...
import parse_mod from "04668__.js";
import AsyncMode from "../04670_AsyncMode.js";
import module_4672_mod from "04672__.js";
...
let module_4672 = module_4672_mod;
if (module_4672) {
  if (typeof module_4672 === "object") {
    if ("default" in module_4672) {
      module_4672 = module_4672.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F128052 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4672(fn, displayName);
};