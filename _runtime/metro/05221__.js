...
import get_synchronousScreenUpdatesEnabledDefault from "../05211_get_synchronousScreenUpdatesEnabled.js";
import _mod5220 from "05220__.js";
import _modDef5222 from "05222__.js";
import animatedComponentDefault from "../05223_animatedComponent.js";
import _mod5224 from "05224__.js";
import SHEET_FIT_TO_CONTENTS from "../05225_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05226_DelayedFreeze.js";
import _mod5228 from "05228__.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5220;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5220.freezeEnabled();
    const tmp2Result6 = _mod5220;
  }
  ...
  if (enabled) {
    if (_mod5220.isNativePlatformSupported) {
      ...
      obj4.fullScreenSwipeEnabled = _mod5228.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5229.Provider, { value: null, children: null });
      }
