...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13179)(arg0, arg3);
  const tmp4 = new _require(13208)(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(13199);
    let tmpResult = tmp(13204);
    tmpResult = tmp(13200);
    closure_2 = tmpResult;
    let str3 = ">=";
    let str = ">";
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13200);
      tmpResult = tmp(13203);
      tmpResult1 = tmp(13199);
  ...
  if (_require(13210)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
