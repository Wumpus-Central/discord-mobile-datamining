...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  dependencyMap = flag5.useContext(screenId(5248).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(5251).isIOS26OrHigher;
  }
  _modDef5247(
    isIOS26OrHigher,
  ...
  if (screenId(5251).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(screenId(5255).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(screenId(5257).FooterComponent, obj7);
  }
