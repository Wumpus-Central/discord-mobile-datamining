...
import _mod8345 from "08345__.js";
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === lowerLimit) {
    ...
    let obj = { web: num, default: _mod8347.constants.LIMIT_MIN_VALUE };
  ...
  if (undefined === upperLimit) {
    ...
    obj = { web: num2, default: _mod8347.constants.LIMIT_MAX_VALUE };
  ...
  if (defaultResult.StepMarker) {
    ...
    obj3.isLTR = tmp3;
    let jsxResult = jsxProd.jsx(tmp24(8349).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
