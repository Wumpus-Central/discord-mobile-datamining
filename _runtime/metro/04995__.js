...
export default function TabsHost(arg0) {
  ...
  return jsx(_modDef5001, { style: null, navStateRequest, onTabSelected: _mod5000.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null });
};