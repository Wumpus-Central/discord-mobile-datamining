// _runtime/metro/08553__.js
import _mod32 from "00032__.js";
import _objectWithoutProperties2 from "00109__objectWithoutProperties.js";
import _mod8555 from "08555__.js";
import _mod8557 from "08557__.js";
import _mod8558 from "08558__.js";
import 08554__ from "08554__.js";
import noop from "00019__.js";
import get_ActivityIndicator from "00017__.js";
import jsxProd from "../react/00021_jsxProd.js";

const _slicedToArray = module_8554(_mod32);
const _objectWithoutProperties = module_8554(_objectWithoutProperties2);
...
const __INTERNAL_VIEW_CONFIG = module_8554(_mod8555);
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === SLIDER_DEFAULT_INITIAL_VALUE) {
    SLIDER_DEFAULT_INITIAL_VALUE = _mod8557.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (undefined === lowerLimit) {
    ...
    const obj = { web: num, default: _mod8557.constants.LIMIT_MIN_VALUE };
  ...
  if (undefined === upperLimit) {
    ...
    const obj2 = { web: num2, default: _mod8557.constants.LIMIT_MAX_VALUE };
  ...
  if (null == SLIDER_DEFAULT_INITIAL_VALUE2) {
    SLIDER_DEFAULT_INITIAL_VALUE2 = _mod8557.constants.SLIDER_DEFAULT_INITIAL_VALUE;
  }
  ...
  if (!num3) {
    DEFAULT_STEP_RESOLUTION = _mod8557.constants.DEFAULT_STEP_RESOLUTION;
  }
  ...
  if ("ios" === get_ActivityIndicator.Platform.OS) {
    let defaultSlider = _mod8558.styles.defaultSlideriOS;
    let tmp24 = require;
  } else {
    tmp24 = require;
    defaultSlider = _mod8558.styles.defaultSlider;
  }
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = jsxProd.jsx(tmp24(8559).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
