...
export const continueTrace = (arg0, arg1) => {
  _require = arg1;
  const mainCarrier = require("12845__.js").getMainCarrier();
  const obj = require("12845__.js");
  const tmp = _require;
  const asyncContextStrategy = require("12846__.js").getAsyncContextStrategy(mainCarrier);
  if (asyncContextStrategy.continueTrace) {
    ...
    return tmp(12854).withScope((setPropagationContext) => {
      const result = setPropagationContext.setPropagationContext(
        _mod12839.propagationContextFromHeaders(dependencyMap, _slicedToArray),
      );
      return closure_0();
    });
  }
  const obj2 = require("12846__.js");
};
export const startInactiveSpan = function startInactiveSpan(experimental) {
  _require = experimental;
  spanArguments = require("12845__.js");
  let mainCarrier = spanArguments.getMainCarrier();
  let asyncContextStrategy = require("12846__.js").getAsyncContextStrategy(mainCarrier);
  ...
  let obj2 = require("12846__.js");
  tmp3 = _require;
  tmp4 = spanArguments;
};
export const startNewTrace = function startNewTrace(arg0) {
  _require = arg0;
  return require("12854__.js").withScope((setPropagationContext) => {
      ...
      return undefined !== createChildOrRootSpan
        ...
        : ((fn) => fn())(() => {
            ...
            if (sentryNonRecordingSpan.onlyIfParent) {
              ...
              return tmp(12862).handleCallbackErrors(
