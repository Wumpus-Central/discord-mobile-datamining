...
import _mod6259 from "06259__.js";
import ScrollableContainer from "../06260_ScrollableContainer.js";
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const scrollHandler1 = _mod6050.useScrollHandler(
      scrollEventsHandlersHook,
      onScroll,
      onScrollBeginDrag,
      onScrollEndDrag,
    ...
    const scrollableSetter = _mod6050.useScrollableSetter(
      scrollableRef,
      SCROLLVIEW,
