// _runtime/metro/04276__extends.js
...
export const MemoryRouter = Component2(4280).Redirect;
export const Prompt = Component2(4280).Redirect;
export const Redirect = Component2(4280).Redirect;
export const Route = Component2(4280).Route;
export const Router = Component2(4280).Router;
export const StaticRouter = Component2(4280).StaticRouter;
export const Switch = Component2(4280).Switch;
export const generatePath = Component2(4280).generatePath;
export const matchPath = Component2(4280).matchPath;
export const useHistory = Component2(4280).useHistory;
export const useLocation = Component2(4280).useLocation;
export const useParams = Component2(4280).useParams;
export const useRouteMatch = Component2(4280).useRouteMatch;
export const withRouter = Component2(4280).withRouter;
