...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5938).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("07341__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("07341__.js");
  const invalidPreventRemoveError = require("07342__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("07342__.js");
  const modalRouteKeys = require("07343__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05938__.js").SafeAreaProviderCompat, obj4);
};
