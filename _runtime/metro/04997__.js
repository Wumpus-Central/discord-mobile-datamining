...
import _modDef4994 from "04994__.js";
...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  dependencyMap = flag5.useContext(screenId(4995).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(4998).isIOS26OrHigher;
  }
  _modDef4994(
    isIOS26OrHigher,
  ...
  let tmp11Result = tmp11(4999);
  if (screenId(4998).isIOS26OrHigher) {
    obj1 = { edges: {}, children };
    tmp19Result = tmp19(screenId(5002).SafeAreaView, obj1);
  }
  obj.children = tmp19Result;
  obj.children = closure_4(tmp11Result, obj);
  const items1 = [closure_4(screenId(4985).EdgeInsetApplicationContext.Provider, obj), ,];
  ...
  if (tmp19Result) {
    ...
    tmp19Result = tmp19(screenId(5004).FooterComponent, obj3);
  }
