...
let fn = () => {
  ...
  function set$1(isValid, Date, module_3922) {
    if (isValid.isValid()) {
      const _isNaN = isNaN;
      if (!isNaN(module_3922)) {
        ({ _d, _isUTC } = isValid);
        if ("Milliseconds" === Date) {
          if (_isUTC) {
            _d.setUTCMilliseconds(module_3922);
          } else {
            _d.setMilliseconds(module_3922);
          }
        } else if ("Seconds" === Date) {
          if (_isUTC) {
            _d.setUTCSeconds(module_3922);
          } else {
            _d.setSeconds(module_3922);
          }
        } else if ("Minutes" === Date) {
          if (_isUTC) {
            _d.setUTCMinutes(module_3922);
          } else {
            _d.setMinutes(module_3922);
          }
        } else if ("Hours" === Date) {
          if (_isUTC) {
            _d.setUTCHours(module_3922);
          } else {
            _d.setHours(module_3922);
          }
        } else if ("Date" === Date) {
          if (_isUTC) {
            _d.setUTCDate(module_3922);
          } else {
            _d.setDate(module_3922);
          }
          ...
          if (29 === dateResult) {
            if (1 === monthResult) {
              const result = module_3922 % 4;
              let tmp7 = result === 0;
              if (result === 0) {
                tmp7 = module_3922 % 100 !== 0;
              }
              if (!tmp7) {
                tmp7 = module_3922 % 400 === 0;
              }
              let num7 = 28;
            }
            if (_isUTC) {
              _d.setUTCFullYear(module_3922, monthResult, num7);
            } else {
              _d.setFullYear(module_3922, monthResult, num7);
            }
          }
          num7 = dateResult;
        }
    ...
    if (arg2) {
      if ("MMM" === arg1) {
        ...
        const tmp18 =
          typeof call6 === "unknown"
            ? closure_1_35(toLocaleLowerCaseResult)
      ...
      if ("MMM" === arg1) {
        ...
        let tmp7 =
          typeof call === "unknown"
            ? closure_1_35(toLocaleLowerCaseResult)
            : call(_longMonthsParse, toLocaleLowerCaseResult);
        if (-1 !== tmp7) {
          tmp9 = tmp7;
        } else {
  ...
  function handleStrictParse$1(toLocaleLowerCase, arg1, arg2) {
    ...
    if (arg2) {
      ...
      if ("dddd" === arg1) {
        ...
        let tmp16 =
          typeof call7 === "unknown"
            ? closure_1_35(toLocaleLowerCaseResult)
            : call7(_weekdaysParse3, toLocaleLowerCaseResult);
        if (-1 === tmp16) {
        ...
        let tmp6 =
          typeof call === "unknown"
            ? closure_1_35(toLocaleLowerCaseResult)
            : call(_minWeekdaysParse, toLocaleLowerCaseResult);
        if (-1 === tmp6) {
          const call2 = closure_1_35.call;
          ...
          const tmp7 =
            typeof call2 === "unknown"
              ? closure_1_35(toLocaleLowerCaseResult)
              : call2(_weekdaysParse, toLocaleLowerCaseResult);
          tmp6 = tmp7;
          if (-1 === tmp7) {
            const call3 = closure_1_35.call;
      ...
      if (_f._f !== tmp.RFC_2822) {
        ...
        if (0 < length) {
          while (true) {
            ...
            if (typeof call === "unknown" ? hasOwnProperty(str7) : call(re14, str7)) {
              let regExp = re14[str7](_f._strict, _f._locale);
            } else {
              let _RegExp = RegExp;
  ...
  function createLocalOrUTC(_d, arg1, arg2, arg3, _isUTC) {
    ...
    if (!tmp7) {
      ...
      const obj = { _isAMomentObject: true, _isUTC, _useUTC: _isUTC, _l: tmp6, _i: _d, _f: tmp4, _strict: tmp3 };
