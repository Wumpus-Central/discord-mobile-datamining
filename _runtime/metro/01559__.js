// _runtime/metro/01559__.js
import deepFreeze from "../01506_deepFreeze.js";
import _modDef1507 from "01507__.js";
import context12 from "../01527_context1.js";
import _mod1549 from "01549__.js";
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  dependencyMap = require("01560__.js").useRegisterNavigator();
  const context = noop.useContext(require("01526__.js").NavigationRouteContext);
  ...
  let obj = require("01560__.js");
  const lazyValue = require("01508__.js").useLazyValue(() => {
  ...
  if (mapped.length) {
        ...
        if (ref2.current) {
          if (callback(ref2.current)) {
            ...
            if (callback1(ref2.current)) {
              ...
              current = lazyValue.getRehydratedState(ref2.current, obj2);
            }
            items[1] = current;
            items[2] = false;
            items[3] = undefined;
    ...
    if (null != tmp43) {
      ...
      closure_41 = noop.useContext(tmp30(1518).UnhandledActionContext);
    ...
    const tmp30Result26 = require("01549__.js");
    rehydratedState = tmp39;
    if (!tmp51) {
