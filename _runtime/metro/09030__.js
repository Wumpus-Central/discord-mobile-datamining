...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_10 = fn(require("09029__.js"));
    ...
    let obj = {
      enumerable: true,
      get() {
        return require("09029__.js").clone;
      },
    };
      ...
      _zod.implement = (fn) => {
        ...
        if (typeof fn !== "function") {
          ...
          return function () {
            ...
            let parsed = items;
            if (_def._def.input) {
              parsed = _mod9027.parse(_def._def.input, items);
            }
            const applyResult = Reflect.apply(_def, this, parsed);
            let parsed1 = applyResult;
            if (_def._def.output) {
              parsed1 = _mod9027.parse(_def._def.output, applyResult);
            }
            return parsed1;
          };
        }
                  ...
                  if (0 === c5) {
                    ...
                    if (1 === tmp5) {
                      if (arg0 === 1) {
                        ...
                        c5 = 2;
                        c6 = 1;
                        const obj2 = { value: _self(9027).parseAsync(self._def.input, closure_130_0), done: false };
                        return obj2;
                      } else {
                      ...
                      if (3 === tmp5) {
                        if (arg0 === 1) {
                          ...
                          if (self._def.output) {
                            ...
                            c6 = 1;
                            const obj5 = {
                              value: _self(9027).parseAsync(self._def.output, closure_130_2),
                              done: false,
                            };
                            return obj5;
                          } else {
                      ...
                      c6 = 3;
                      const obj6 = { value: tmp6, done: true };
                      return obj6;
                    }
                    closure_130_1 = tmp12;
                    const _Reflect = Reflect;
                    c5 = 3;
                    c6 = 1;
                    const obj7 = { value: Reflect.apply(closure_131_0, closure_4, closure_130_1), done: false };
                    return obj7;
                  }
                } catch (tmp26) {
                  c6 = tmp;
