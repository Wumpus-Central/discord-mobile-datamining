...
import COUNTER_METRIC_TYPE from "../13029_COUNTER_METRIC_TYPE.js";
import __SENTRY_DEBUG__ from "12931__.js";
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("12946__.js").timestampInSeconds();
      ...
      return require("12966__.js").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
