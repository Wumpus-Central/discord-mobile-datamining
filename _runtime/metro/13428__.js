...
export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13391)(arg0, arg3);
  const tmp4 = new _require(13420)(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(13411);
    let tmpResult = tmp(13416);
    tmpResult = tmp(13412);
    closure_2 = tmpResult;
    let str3 = ">=";
    let str = ">";
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13412);
      tmpResult = tmp(13415);
      tmpResult1 = tmp(13411);
  ...
  if (_require(13422)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
