// _runtime/metro/11303__.js
import _mod11305 from "11305__.js";
import RNIapAmazonModuleAll from "../11311_RNIapAmazonModule.js";
import _modAll11312 from "11312__.js";
import _modAll11313 from "11313__.js";
import syncAll from "../11314_sync.js";
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      ...
      closure_128_0 = value.map(tmp2(11310).singleProductAndroidMap);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      ...
      await tmp2(11305).fillProductsWithAdditionalData(closure_128_2);
      closure_128_2 = value;
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if ("sku" in closure_0) {
            ...
            c1 = 3;
            const obj4 = { value: closure_1_5.buyItemByType(closure_0.sku, str7), done: true };
            return obj4;
          } else {
            const _Error2 = Error;
