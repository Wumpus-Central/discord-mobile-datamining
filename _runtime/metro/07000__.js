...
// Module 7000
import PlatformConfig from "PlatformConfig" /* 6973 */;
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  dependencyMap = arg2;
  const unmountFlag = require("module_7002").useUnmountFlag();
  let obj = require("module_7002");
  ...
  _setTimeout = require("module_7003").useUnmountAwareTimeout().setTimeout;
  let obj2 = require("module_7003");
