...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      UKWeekdayParser(10780).matchAnyPattern(UKWeekdayParser(10934).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return UKWeekdayParser(10807).createParsingComponentsAtWeekday(
        reference.reference,
        UKWeekdayParser(10934).WEEKDAY_DICTIONARY[arg1[2].toLocaleLowerCase()],
        str2,
      );
    },
  },
