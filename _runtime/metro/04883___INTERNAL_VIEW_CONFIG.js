// _runtime/metro/04883___INTERNAL_VIEW_CONFIG.js
...
let obj = {
  ...
  directEventTypes: {
    ...
    topPressHeaderBarButtonItem: { registrationName: "onPressHeaderBarButtonItem" },
    topPressHeaderBarButtonMenuItem: { registrationName: "onPressHeaderBarButtonMenuItem" },
  },
...
obj = {
  ...
  largeTitleBackgroundColor: result.colorAttribute,
  largeTitleHideShadow: true,
  largeTitleColor: result.colorAttribute,
  translucent: true,
  title: true,
  titleFontFamily: true,
  titleFontSize: true,
  titleFontWeight: true,
  titleColor: result.colorAttribute,
  ...
  consumeRightInset: true,
  consumeBottomInset: true,
