...
import validateTransformOrigin from "../01739_validateTransformOrigin.js";
import ComponentRegistry2 from "../01740_ComponentRegistry.js";
...
if (module_1640.shouldBeUseWeb()) {
  ...
  const obj3 = {
    processColorsInProps: _mod1680.processColorsInProps,
...
if (module_1640.shouldBeUseWeb()) {
  function maybeThrowError() {
    if (!obj.isJest()) {
      const reanimatedError = new require("01648__.js").ReanimatedError(
        "`UpdatePropsManager` is not available on non-native platform.",
      );
      throw reanimatedError;
    }
    obj = require("01640__.js");
  }
  const _Proxy = Proxy;
  const obj7 = {
    get: maybeThrowError,
