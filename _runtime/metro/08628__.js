...
import _mod8630 from "08630__.js";
import _mod8632 from "08632__.js";
import _mod8633 from "08633__.js";
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = jsxProd.jsx(tmp24(8634).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
