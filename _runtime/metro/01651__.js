...
if (!module_1640.isJest()) {
  ...
  const entry1 = {
    ...
    value: function createWorkletRuntime(arg0, arg1) {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("createWorkletRuntime is not available in JSReanimated.");
  ...
  const entry2 = {
    ...
    value: function scheduleOnRuntime() {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("scheduleOnRuntime is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[2] = entry2;
  const entry3 = {
    ...
    value: function registerEventHandler(arg0, arg1, arg2) {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("registerEventHandler is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[3] = entry3;
  const entry4 = {
    ...
    value: function unregisterEventHandler(arg0) {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("unregisterEventHandler is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[4] = entry4;
  const entry5 = {
    ...
    value: function enableLayoutAnimations() {
        if (obj.isWeb()) {
          const logger3 = JSReanimated(1641).logger;
          logger3.warn("Layout Animations are not supported on web yet.");
        } else {
          if (tmpResult.isJest()) {
            const logger2 = JSReanimated(1641).logger;
            logger2.warn("Layout Animations are no-ops when using Jest.");
          } else {
            const tmpResult2 = JSReanimated(1640);
            const logger = JSReanimated(1641).logger;
            ...
            isChromeDebuggerResult = JSReanimated(1640).isChromeDebugger();
          }
          tmpResult = JSReanimated(1640);
        }
        obj = JSReanimated(1640);
      }
  };
  items[5] = entry5;
  const entry6 = {
  ...
  const entry12 = {
    ...
    value: function initializeSensor(arg0, arg1) {
        ...
        if (JSReanimated(1662).SensorType.ACCELEROMETER === arg0) {
          const _window5 = window;
          const accelerometer = new window.Accelerometer(obj);
          return accelerometer;
        } else if (JSReanimated(1662).SensorType.GYROSCOPE === arg0) {
          const _window4 = window;
          const gyroscope = new window.Gyroscope(obj);
          return gyroscope;
        } else if (JSReanimated(1662).SensorType.GRAVITY === arg0) {
          const _window3 = window;
          const gravitySensor = new window.GravitySensor(obj);
          return gravitySensor;
        } else if (JSReanimated(1662).SensorType.MAGNETIC_FIELD === arg0) {
          const _window2 = window;
          const magnetometer = new window.Magnetometer(obj);
          return magnetometer;
        } else if (JSReanimated(1662).SensorType.ROTATION === arg0) {
          const _window = window;
  ...
  const entry14 = {
    ...
    value: function getSettledUpdates() {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("`getSettledUpdates` is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[14] = entry14;
  ...
  const entry16 = {
    ...
    value: function getViewProp(arg0, arg1, arg2, arg3) {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("getViewProp is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[16] = entry16;
  const entry17 = {
    ...
    value: function configureProps() {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("configureProps is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[17] = entry17;
  const entry18 = {
    ...
    value: function executeOnUIRuntimeSync(arg0) {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("`executeOnUIRuntimeSync` is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[18] = entry18;
  const entry19 = {
    ...
    value: function markNodeAsRemovable(arg0) {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("markNodeAsRemovable is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[19] = entry19;
  const entry20 = {
    ...
    value: function unmarkNodeAsRemovable(arg0) {
        const reanimatedError = new JSReanimated(1648).ReanimatedError("unmarkNodeAsRemovable is not available in JSReanimated.");
        throw reanimatedError;
      }
  };
  items[20] = entry20;
...
mockedRequestAnimationFrame = fn(1652).mockedRequestAnimationFrame;