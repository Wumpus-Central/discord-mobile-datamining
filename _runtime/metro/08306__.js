// _runtime/metro/08306__.js
import _mod32 from "00032__.js";
import _objectWithoutProperties2 from "00109__objectWithoutProperties.js";
import _mod8308 from "08308__.js";
import _mod8310 from "08310__.js";
import _mod8311 from "08311__.js";
import 08307__ from "08307__.js";
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (undefined === lowerLimit) {
    ...
    let obj = { web: num, default: _mod8310.constants.LIMIT_MIN_VALUE };
  ...
  if (undefined === upperLimit) {
    ...
    obj = { web: num2, default: _mod8310.constants.LIMIT_MAX_VALUE };
  ...
  if (defaultResult.StepMarker) {
    ...
    obj3.isLTR = tmp3;
    let jsxResult = jsxProd.jsx(tmp24(8312).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
