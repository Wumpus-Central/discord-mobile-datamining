...
export const useScrollHandler = () => {
  ...
  if (scrollEventsHandlersHook === undefined) {
    useScrollEventsHandlersDefault = require("06982__.js").useScrollEventsHandlersDefault;
  }
  _require = onScroll;
