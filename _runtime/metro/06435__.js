...
let obj = {
  default: fn(6436).DefaultTransition,
  fade: fn(6436).ModalFadeTransition,
  fade_from_bottom: fn(6436).FadeFromBottomAndroid,
  fade_from_right: fn(6436).FadeFromRightAndroid,
  none: fn(6436).DefaultTransition,
  reveal_from_bottom: fn(6436).RevealFromBottomAndroid,
  scale_from_center: fn(6436).ScaleFromCenterAndroid,
  slide_from_left: fn(6436).SlideFromLeftIOS,
  slide_from_right: fn(6436).SlideFromRightIOS,
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(6438).forModalPresentationIOS ||
