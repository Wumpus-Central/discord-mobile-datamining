...
export default function TabsHost(arg0) {
  ...
  return jsx(_modDef5127, { style: null, navStateRequest, onTabSelected: _mod5126.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null });
};