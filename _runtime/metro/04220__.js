// _runtime/metro/04220__.js
import throwProtectedError from "../04165_throwProtectedError.js";
import parsers from "../04222_parsers.js";
...
import dateLongFormatter_mod from "../04163_dateLongFormatter.js";
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("03923__.js").getDefaultOptions();
  let locale1;
  if (null != locale) {
