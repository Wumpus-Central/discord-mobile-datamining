// _runtime/metro/14272__.js
import SymbolResult1 from "../14266_SymbolResult1.js";
import URLSearchParamsImpl from "../14273_URLSearchParamsImpl.js";
import _ from "../14274__.js";
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(
                URLSearchParams(14274).USVString(arguments[0], {
                  context: "Failed to execute 'append' on 'URLSearchParams': parameter 1",
                }),
              );
              obj = URLSearchParams(14274);
              items.push(
                URLSearchParams(14274).USVString(arguments[1], {
