...
import emptyFunction_mod from "10137__.js";
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = timestampProducer(CircularProgress(8732).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = timestampProducer(CircularProgress(8732).Path, obj5);
      }
