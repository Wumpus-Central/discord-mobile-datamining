// _runtime/metro/04274__extends.js
...
export const MemoryRouter = Component2(4278).Redirect;
export const Prompt = Component2(4278).Redirect;
export const Redirect = Component2(4278).Redirect;
export const Route = Component2(4278).Route;
export const Router = Component2(4278).Router;
export const StaticRouter = Component2(4278).StaticRouter;
export const Switch = Component2(4278).Switch;
export const generatePath = Component2(4278).generatePath;
export const matchPath = Component2(4278).matchPath;
export const useHistory = Component2(4278).useHistory;
export const useLocation = Component2(4278).useLocation;
export const useParams = Component2(4278).useParams;
export const useRouteMatch = Component2(4278).useRouteMatch;
export const withRouter = Component2(4278).withRouter;
