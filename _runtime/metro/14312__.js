...
export default (num, arg1) => {
  if (num instanceof _mod14285) {
    ...
    if (typeof StringResult !== "string") {
      ...
      if (obj.rtl) {
        const safeRe2 = _mod14289.safeRe;
        const t2 = _mod14289.t;
      ...
      if (null === match2) {
        ...
        return _mod14284("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};
