      ...
      const fn = function n(originX) {
        ...
        const size = {
          originX: delayFunction(
            delay,
            delayFunction(1708).withTiming(originX.targetOriginX, { duration: num, easing: obj.easingX }),
          ),
          originY: null,
          width: null,
          height: null,
        ...
        size.originY = delayFunction(
          delay,
          delayFunction(1708).withTiming(originX.targetOriginY, { duration: num, easing: obj.easingY }),
        );
        ...
        size.height = delayFunction(
          delay,
          delayFunction(1708).withTiming(originX.targetHeight, { duration: num, easing: obj.easingHeight }),
        );
        obj.animations = size;
