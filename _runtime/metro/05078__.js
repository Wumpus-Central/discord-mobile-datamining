...
export default function TabsHost(arg0) {
  ...
  return jsx(_modDef5084, { style: null, navStateRequest, onTabSelected: _mod5083.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null });
};