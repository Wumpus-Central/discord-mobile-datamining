// _runtime/metro/06205__.js
import _modDef6206 from "06206__.js";
...
class TouchableHighlight {
  constructor(arg0) {
    ...
    tmp3Result.onStateChange = (arg0, arg1) => {
      if (arg1 === TouchableHighlight(6206).TOUCHABLE_STATE.BEGAN) {
        ...
        tmp3 =
          arg1 !== TouchableHighlight(6206).TOUCHABLE_STATE.UNDETERMINED &&
          arg1 !== TouchableHighlight(6206).TOUCHABLE_STATE.MOVED_OUTSIDE;
      }
    };
