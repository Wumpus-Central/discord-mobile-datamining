...
import extractResponderDefault from "extractResponder" /* 8814 */;
import _modDef8819 from "module_8819" /* 8819 */;
import reducedDefault from "reduced" /* 8820 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8812).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8812).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8831);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8815).extractTransformSvgView(tmp);
      const obj3 = Svg(8815);
    }
    const obj4 = {};
    ...
    obj4.children = jsx(_modDef8821, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8819, {});
  }
};
let items = [entry];
