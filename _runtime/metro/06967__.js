...
import tagMessage2 from "../06853_tagMessage.js";
import touchDataToPressEvent from "../06949_touchDataToPressEvent.js";
import StateMachineEvent2 from "../06952_StateMachineEvent.js";
import GestureObjects2 from "../06968_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6949).gestureToPressableEvent(handlerTag));
