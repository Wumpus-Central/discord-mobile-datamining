...
fn = function n(userConfig, fn) {
  ...
  fn.__closure = { userConfig, isValidRubberBandConfig: require("module_1713").isValidRubberBandConfig, rubberBandDecay: require("rubberBandDecay").rubberBandDecay, rigidDecay: require("rigidDecay").rigidDecay, validateConfig, callback: fn, getReduceMotionForAnimation: require("module_1677").getReduceMotionForAnimation };
