// _runtime/metro/01712__.js
import _mod1648 from "01648__.js";
import rubberBandDecay from "../01714_rubberBandDecay.js";
import rigidDecay from "../01715_rigidDecay.js";
...
function validateConfig(clamp) {
  if (clamp.clamp) {
    ...
    if (Array.isArray(clamp.clamp)) {
      ...
      const reanimatedError1 = new _mod1648.ReanimatedError(
  ...
  if (clamp.velocityFactor <= 0) {
    ...
    const reanimatedError2 = new _mod1648.ReanimatedError(
    ...
    if (!clamp.clamp) {
      const reanimatedError3 = new _mod1648.ReanimatedError(
...
fn = function n(userConfig, fn) {
  ...
  fn.__closure = {
    userConfig,
    isValidRubberBandConfig: require("01713__.js").isValidRubberBandConfig,
...
fn.__closure = {
  ...
  isValidRubberBandConfig: fn(1713).isValidRubberBandConfig,
  rubberBandDecay: fn(1714).rubberBandDecay,
  rigidDecay: fn(1715).rigidDecay,
  validateConfig,
