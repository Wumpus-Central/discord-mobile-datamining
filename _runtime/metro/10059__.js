...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      UKWeekdayParser(9895).matchAnyPattern(UKWeekdayParser(10049).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return UKWeekdayParser(9922).createParsingComponentsAtWeekday(
        reference.reference,
        UKWeekdayParser(10049).WEEKDAY_DICTIONARY[arg1[2].toLocaleLowerCase()],
        str2,
      );
    },
  },
