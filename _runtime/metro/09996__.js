// _runtime/metro/09996__.js
import QR8bitByte from "../09997_QR8bitByte.js";
import QRRSBlock from "../09999_QRRSBlock.js";
import QRBitBuffer from "../10001_QRBitBuffer.js";
...
prototype.setupPositionAdjustPattern = function () {
  const self = this;
  const patternPosition = _mod10002.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function (arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10002.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function (arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10002.getBCHTypeInfo((this.errorCorrectLevel << 3) | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
