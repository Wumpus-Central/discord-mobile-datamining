// _runtime/metro/04352__.js
import callDispose from "../04332_callDispose.js";
...
export const useRiveFile = function useRiveFile(src, arg1) {
  ...
  let uri;
  let riveFile;
  [tmp2, c1] = _slicedToArray(str2({ riveFile: "HermesInternal", isLoading: null, error: "button" }), 2);
