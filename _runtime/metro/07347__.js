...
let obj = {
  default: fn(7348).DefaultTransition,
  fade: fn(7348).ModalFadeTransition,
  fade_from_bottom: fn(7348).FadeFromBottomAndroid,
  fade_from_right: fn(7348).FadeFromRightAndroid,
  none: fn(7348).DefaultTransition,
  reveal_from_bottom: fn(7348).RevealFromBottomAndroid,
  scale_from_center: fn(7348).ScaleFromCenterAndroid,
  slide_from_left: fn(7348).SlideFromLeftIOS,
  slide_from_right: fn(7348).SlideFromRightIOS,
  slide_from_bottom: fn(7348).BottomSheetAndroid,
};
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7350).forModalPresentationIOS ||
