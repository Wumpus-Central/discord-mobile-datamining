// _runtime/metro/11324__.js
import _mod11326 from "11326__.js";
import RNIapAmazonModuleAll from "../11332_RNIapAmazonModule.js";
import _modAll11333 from "11333__.js";
import _modAll11334 from "11334__.js";
import syncAll from "../11335_sync.js";
...
const subs = fn(11325).ProductType.subs;
const inapp = fn(11325).ProductType.inapp;
...
export const IapAndroid = _modAll11333;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11334;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11326).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11326.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11326.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11326.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11326.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11326.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11326).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = value.map(tmp2(11331).singleProductAndroidMap);
      return tmp2(11326).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11326).getAndroidModuleType();
      const androidModule = tmp2(11326).getAndroidModule();
      await androidModule.getItemsByType(closure_1_6, skus);
      closure_128_1 = value;
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11325).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      await tmp2(11326).fillProductsWithAdditionalData(closure_128_2);
      closure_128_2 = value;
      return addSubscriptionPlatform(closure_128_2, tmp2(11325).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11326).getAndroidModule();
            ...
            const androidModule1 = v3(11326).getAndroidModule();
