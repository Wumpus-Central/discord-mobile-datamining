...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5717).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08036__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08036__.js");
  const invalidPreventRemoveError = require("08037__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08037__.js");
  const modalRouteKeys = require("08038__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05717__.js").SafeAreaProviderCompat, obj4);
};
