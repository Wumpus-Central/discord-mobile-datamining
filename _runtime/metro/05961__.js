...
export const Header = function Header(layout) {
  const rect = require("01615__.js").useSafeAreaInsets();
  const obj = require("01615__.js");
  ...
  const defaultHeaderHeight = require("05959__.js").getDefaultHeaderHeight(layout, tmp9, headerStatusBarHeight);
  if (!headerStyle) {
    headerStyle = {};
  }
  ...
  if (!tmp7) {
    ...
    if ("left" === str) {
      ...
      if (headerSearchBarOptions) {
        ...
        const obj25 = { source: require("05941__.js"), tintColor: text };
