...
const entry = {
  ...
  value: function render() {
    ...
    if (patternContentUnits) {
      num2 = Pattern(8881)[patternContentUnits];
    }
    ...
    const merged1 = Object.assign(Pattern(8816)({ viewBox, preserveAspectRatio }));
