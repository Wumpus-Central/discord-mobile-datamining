// _runtime/metro/11400__.js
import _mod11402 from "11402__.js";
import RNIapAmazonModuleAll from "../11408_RNIapAmazonModule.js";
import _modAll11409 from "11409__.js";
import _modAll11410 from "11410__.js";
import syncAll from "../11411_sync.js";
...
const subs = fn(11401).ProductType.subs;
const inapp = fn(11401).ProductType.inapp;
...
export const IapAndroid = _modAll11409;
export const IapAmazon = RNIapAmazonModuleAll;
export const IapIos = _modAll11410;
export const IapIosSk2 = syncAll;
export const isIosStorekit2 = fn(11402).isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod11402.storekit1Mode();
  } else if ("STOREKIT2_MODE" === str) {
    _mod11402.storekit2Mode();
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod11402.storekitHybridMode();
  }
};
export const initConnection = () => {
  const nativeModule = _mod11402.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod11402.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      closure_1 = tmp5;
      const androidModule = tmp2(11402).getAndroidModule();
      await androidModule.getItemsByType(closure_1_7, skus);
      closure_128_0 = value.map(tmp2(11407).singleProductAndroidMap);
      return tmp2(11402).fillProductsWithAdditionalData(closure_128_0);
    });
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      const androidModuleType = tmp2(11402).getAndroidModuleType();
      const androidModule = tmp2(11402).getAndroidModule();
      await androidModule.getItemsByType(closure_1_6, skus);
      closure_128_1 = value;
      if ("android" === androidModuleType) {
        return addSubscriptionPlatform(closure_128_1, tmp2(11401).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp34) {
        const _Error = Error;
      ...
      await tmp2(11402).fillProductsWithAdditionalData(closure_128_2);
      closure_128_2 = value;
      return addSubscriptionPlatform(closure_128_2, tmp2(11401).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
    ...
    if (v3 === 2) {
      ...
      try {
        ...
        if (arg0 === 1) {
          ...
          if (importAll) {
            const androidModule = v3(11402).getAndroidModule();
            ...
            const androidModule1 = v3(11402).getAndroidModule();
