// _runtime/metro/13220__.js
import { SemVer } from "../13183_SemVer.js";
import { Comparator } from "../13211_Comparator.js";
import { Range } from "../13212_Range.js";
import { Range } from "../13214_Range.js";
...
export default (arg0, arg1, arg2, arg3) => {
  ...
  if (">" === arg2) {
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13204);
      tmpResult = tmp(13207);
      tmpResult1 = tmp(13203);
