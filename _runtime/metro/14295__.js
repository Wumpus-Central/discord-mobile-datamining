// _runtime/metro/14295__.js
import _mod14293 from "14293__.js";
import _mod14294 from "14294__.js";
...
obj.t = obj2;
const items3 = [["\\s", 1], ,];
const items4 = ["\\d", _mod14293.MAX_LENGTH];
items3[1] = items4;
const items5 = ["[a-zA-Z0-9-]", _mod14293.MAX_SAFE_BUILD_LENGTH];
items3[2] = items5;
_mod14294("NUMERICIDENTIFIER", 0, "0|[1-9]\\d*");
...
_mod14294("NUMERICIDENTIFIERLOOSE", 1, "\\d+");
...
_mod14294("NONNUMERICIDENTIFIER", 2, combined);
...
_mod14294("MAINVERSION", 3, combined1);
obj2.MAINVERSION = 3;
items2[3] = combined1;
...
const combined2 =
  "(" +
  items2[obj2.NUMERICIDENTIFIERLOOSE] +
  ")\\.(" +
  items2[obj2.NUMERICIDENTIFIERLOOSE] +
  ")\\.(" +
  items2[obj2.NUMERICIDENTIFIERLOOSE] +
...
_mod14294("MAINVERSIONLOOSE", 4, combined2);
...
_mod14294("PRERELEASEIDENTIFIER", 5, combined3);
...
_mod14294("PRERELEASEIDENTIFIERLOOSE", 6, combined4);
...
_mod14294("PRERELEASE", 7, combined5);
obj2.PRERELEASE = 7;
items2[7] = combined5;
...
items1[7] = regExp15;
const combined6 =
  "(?:-?(" + items2[obj2.PRERELEASEIDENTIFIERLOOSE] + "(?:\\." + items2[obj2.PRERELEASEIDENTIFIERLOOSE] + ")*))";
const tmp35 = ((items2) => {
  let str = items2;
  while (tmp2 !== undefined) {
    let tmp5 = _slicedToArray(tmp3, 2);
...
_mod14294("PRERELEASELOOSE", 8, combined6);
...
_mod14294("BUILDIDENTIFIER", 9, combined7);
...
_mod14294("FULLPLAIN", 11, combined9);
obj2.FULLPLAIN = 11;
items2[11] = combined9;
...
items1[12] = regExp25;
const combined11 =
  "[v=\\s]*" + items2[obj2.MAINVERSIONLOOSE] + items2[obj2.PRERELEASELOOSE] + "?" + items2[obj2.BUILD] + "?";
const tmp60 = ((items2) => {
  let str = items2;
  while (tmp2 !== undefined) {
    let tmp5 = _slicedToArray(tmp3, 2);
...
_mod14294("LOOSEPLAIN", 13, combined11);
obj2.LOOSEPLAIN = 13;
...
_mod14294("XRANGEIDENTIFIERLOOSE", 16, combined13);
...
_mod14294("XRANGEIDENTIFIER", 17, combined14);
...
const combined15 =
  "[v=\\s]*(" +
  items2[obj2.XRANGEIDENTIFIER] +
  ")(?:\\.(" +
  items2[obj2.XRANGEIDENTIFIER] +
  ")(?:\\.(" +
  items2[obj2.XRANGEIDENTIFIER] +
  ")(?:" +
  items2[obj2.PRERELEASE] +
  ")?" +
  items2[obj2.BUILD] +
  "?)?)?";
const tmp84 = ((items2) => {
...
_mod14294("XRANGEPLAIN", 18, combined15);
obj2.XRANGEPLAIN = 18;
...
const combined16 =
  "[v=\\s]*(" +
  items2[obj2.XRANGEIDENTIFIERLOOSE] +
  ")(?:\\.(" +
  items2[obj2.XRANGEIDENTIFIERLOOSE] +
  ")(?:\\.(" +
  items2[obj2.XRANGEIDENTIFIERLOOSE] +
  ")(?:" +
  items2[obj2.PRERELEASELOOSE] +
  ")?" +
  items2[obj2.BUILD] +
  "?)?)?";
const tmp89 = ((items2) => {
...
_mod14294("XRANGEPLAINLOOSE", 19, combined16);
...
const combined19 =
  "(^|[^\\d])(\\d{1," +
  _mod14293.MAX_SAFE_COMPONENT_LENGTH +
  "})(?:\\.(\\d{1," +
  _mod14293.MAX_SAFE_COMPONENT_LENGTH +
  "}))?(?:\\.(\\d{1," +
  _mod14293.MAX_SAFE_COMPONENT_LENGTH +
...
_mod14294("COERCEFULL", 24, sum1);
obj2.COERCEFULL = 24;
items2[24] = sum1;
const regExp48 = new RegExp(sum1, undefined);
items[24] = regExp48;
const regExp49 = new RegExp(
  ((items2) => {
    let str = items2;
    while (tmp2 !== undefined) {
      let tmp5 = _slicedToArray(tmp3, 2);
...
_mod14294("COERCERTL", 25, items2[obj2.COERCE]);
obj2.COERCERTL = 25;
items2[25] = items2[obj2.COERCE];
const regExp50 = new RegExp(tmp124, "g");
items[25] = regExp50;
const regExp51 = new RegExp(
  ((items2) => {
    let str = items2;
    while (tmp2 !== undefined) {
      let tmp5 = _slicedToArray(tmp3, 2);
...
_mod14294("LONETILDE", 27, "(?:~>?)");
obj2.LONETILDE = 27;
items2[27] = "(?:~>?)";
const regExp54 = new RegExp("(?:~>?)", undefined);
items[27] = regExp54;
const regExp55 = new RegExp(
  ((items2) => {
    let str = items2;
    while (tmp2 !== undefined) {
      let tmp5 = _slicedToArray(tmp3, 2);
...
_mod14294("TILDETRIM", 28, combined21);
obj2.TILDETRIM = 28;
items2[28] = combined21;
const regExp56 = new RegExp(combined21, "g");
items[28] = regExp56;
const regExp57 = new RegExp(
  ((items2) => {
    let str = items2;
    while (tmp2 !== undefined) {
      let tmp5 = _slicedToArray(tmp3, 2);
...
_mod14294("LONECARET", 31, "(?:\\^)");
obj2.LONECARET = 31;
items2[31] = "(?:\\^)";
const regExp62 = new RegExp("(?:\\^)", undefined);
items[31] = regExp62;
const regExp63 = new RegExp(
  ((items2) => {
    let str = items2;
    while (tmp2 !== undefined) {
      let tmp5 = _slicedToArray(tmp3, 2);
...
_mod14294("CARETTRIM", 32, combined24);
obj2.CARETTRIM = 32;
items2[32] = combined24;
const regExp64 = new RegExp(combined24, "g");
items[32] = regExp64;
const regExp65 = new RegExp(
  ((items2) => {
    let str = items2;
    while (tmp2 !== undefined) {
      let tmp5 = _slicedToArray(tmp3, 2);
...
items1[36] = regExp73;
const combined29 =
  "(\\s*)" + items2[obj2.GTLT] + "\\s*(" + items2[obj2.LOOSEPLAIN] + "|" + items2[obj2.XRANGEPLAIN] + ")";
const tmp178 = ((items2) => {
  let str = items2;
  while (tmp2 !== undefined) {
    let tmp5 = _slicedToArray(tmp3, 2);
