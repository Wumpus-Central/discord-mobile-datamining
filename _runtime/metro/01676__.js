...
applyProgressToMatrix.__closure = {
  addMatrices: _mod1678.addMatrices,
  scaleMatrix: _mod1678.scaleMatrix,
  subtractMatrices: _mod1678.subtractMatrices,
};
    ...
    function transformationMatrixOnFrame(arg0, arg1) {
      ...
      arg0.current = obj4.flatten(
        obj5.multiplyMatrices(
          obj6.multiplyMatrices(tmp4, stopMatrices(1678).multiplyMatrices(tmp5, multiplyMatricesResult)),
          tmp3,
        ),
      );
      ...
      if (reduceMotion.reduceMotion) {
        ...
        if (obj.isColor(current)) {
          ...
          if (tmp3Result.isColor(current)) {
            const tmp3Result13 = fn(1679);
            closure_129_4 = tmp3Result13.toLinearSpace(fn(1679).convertToRGBA(reduceMotion.current));
            const tmp3Result14 = fn(1679);
            const tmp3Result15 = fn(1679);
            closure_129_3 = tmp3Result15.toLinearSpace(fn(1679).convertToRGBA(current));
            if (reduceMotion.toValue) {
              const tmp3Result17 = fn(1679);
              closure_129_5 = tmp3Result17.toLinearSpace(fn(1679).convertToRGBA(reduceMotion.toValue));
              const tmp3Result18 = fn(1679);
            }
            const tmp3Result16 = fn(1679);
          }
          ...
          const tmp3Result19 = fn(1679);
          const tmp3Result20 = fn(1679);
          reduceMotion.current = tmp3Result20.rgbaArrayToRGBAColor(fn(1679).toGammaSpace(items));
          reduceMotion.onFrame = colorOnFrame;
          const tmp3Result21 = fn(1679);
        } else {
...
decorateAnimation.__closure = {
  ...
  isColor: _mod1679.isColor,
  toLinearSpace: _mod1679.toLinearSpace,
  convertToRGBA: _mod1679.convertToRGBA,
  clampRGBA: _mod1679.clampRGBA,
  rgbaArrayToRGBAColor: _mod1679.rgbaArrayToRGBAColor,
  toGammaSpace: _mod1679.toGammaSpace,
  decomposeMatrixIntoMatricesAndAngles: _mod1678.decomposeMatrixIntoMatricesAndAngles,
  applyProgressToMatrix,
  applyProgressToNumber,
  getRotationMatrix: _mod1678.getRotationMatrix,
  multiplyMatrices: _mod1678.multiplyMatrices,
  flatten: _mod1678.flatten,
  isAffineMatrixFlat: _mod1678.isAffineMatrixFlat,
};
                            ...
                            if (typeof colorOnFrame === "function") {
                              if (typeof str7 === "string") {
                                ...
                                if (match2) {
                                  ...
                                  const reanimatedError2 = new fn(1647).ReanimatedError(
...
let cancelAnimationWeb = function cancelAnimationNative(current) {
  ...
  if (globalThis._WORKLET) {
    ...
    const obj2 = { sharedValue: current };
    fn.__closure = obj2;
