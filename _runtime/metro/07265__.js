...
import PanGestureHandler from "../07245_PanGestureHandler.js";
import _mod7259 from "07259__.js";
import _mod7260 from "07260__.js";
import _mod7266 from "07266__.js";
...
export const Card = function Card(shadowEnabled) {
  ...
  let tmp11 = num(1506)(() => {
    ...
    if (ref.current) {
      ...
      if (typeof getAnimateToValue === "function") {
        if (closing) {
          let num3 = _mod7259.getDistanceForDirection(layout, gestureDirection, "rtl" === direction);
        } else {
          num3 = 0;
        }
        if (tmp7 === num3) {
          if (ref2.current === num3) {
            ...
            if (tmp24) {
              gesture.setValue(_mod7259.getDistanceForDirection(layout, gestureDirection, "rtl" === direction));
              const obj4 = { closing };
              closure_34(obj4);
            }
          }
  ...
  let merged = Object.assign(
    flag2(7268).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }),
  );
