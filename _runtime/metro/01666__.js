...
import { mockedRequestAnimationFrame } from "../01667_mockedRequestAnimationFrame.js";
...
if (!isJest.isJest()) {
  ...
  isJest[1] = function createWorkletRuntime(arg0, arg1) {
    const reanimatedError = new JSReanimated(1663).ReanimatedError(
