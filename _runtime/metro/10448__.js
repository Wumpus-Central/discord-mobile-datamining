...
const regExp = new RegExp(
  "(" + _mod10431.TIME_UNITS_PATTERN + ")\\s{0,5}(?:later|after|from now|henceforth|forward|out)(?=(?:\\W|$))",
  "i",
);
const regExp1 = new RegExp(
  "(" + _mod10431.TIME_UNITS_NO_ABBR_PATTERN + ")\\s{0,5}(later|after|from now)(?=\\W|$)",
  "i",
);
