...
import state from "../14644_state.js";
import prop from "14642__.js";

let closure_5 = _mod14590("".slice);
let closure_6 = _mod14590("".replace);
let closure_7 = _mod14590([].join);
let closure_8 = _mod14586 && !_mod14587(() => 8 !== defineProperty(() => {}, "length", { value: 8 }).length);
const tmp = _mod14586 && !_mod14587(() => 8 !== defineProperty(() => {}, "length", { value: 8 }).length);
...
const fn = (toString, toString2, arg2) => {
  ...
  let tmp9 = !tmp8;
  if (tmp8) {
    tmp9 = _mod14643.CONFIGURABLE && toString.name !== text2;
    const tmp10 = _mod14643.CONFIGURABLE && toString.name !== text2;
  }
  if (tmp9) {
    if (_mod14586) {
  ...
  try {
    if (arg2) {
      if (_mod14606(arg2, "constructor")) {
        ...
        if (!_mod14606(enforceResult, "source")) {
          let str11 = "";
