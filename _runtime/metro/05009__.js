...
import _mod5008 from "05008__.js";
import _modDef5010 from "05010__.js";
import animatedComponentDefault from "../05011_animatedComponent.js";
import _mod5012 from "05012__.js";
import SHEET_FIT_TO_CONTENTS from "../05013_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05014_DelayedFreeze.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5008;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5008.freezeEnabled();
    const tmp2Result6 = _mod5008;
  }
  ...
  if (enabled) {
    if (_mod5008.isNativePlatformSupported) {
      ...
      obj4.fullScreenSwipeEnabled = _mod5016.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5017.Provider, { value: null, children: null });
      }
