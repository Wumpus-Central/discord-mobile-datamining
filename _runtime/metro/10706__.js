  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (parseDurationResult) {
        ...
        relativeFromReference = ParsingComponents.createRelativeFromReference(reference.reference, ENTimeUnitAgoFormatParser(10693).reverseDuration(parseDurationResult));
      }
