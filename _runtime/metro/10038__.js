...
const regExp = new RegExp(
  "(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(este|esta|pasado|pr[o\u00F3]ximo)\\s*)?(" +
    repeatedTimeunitPattern.matchAnyPattern(_mod10039.WEEKDAY_DICTIONARY) +
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (undefined === tmp4) {
        ...
        return ESWeekdayParser(9922).createParsingComponentsAtWeekday(reference.reference, tmp4, str5);
      }
    },
  },
];
