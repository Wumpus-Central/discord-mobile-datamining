...
export default noop.forwardRef(function ScreenStackItem(unstable_sheetFooter, arg1) {
  ...
  obj = { value: obj1.useEdgeInsetApplication(flag, flag2, flag3).nextContextValue, children: closure_5(tmp10(4954), { contentStyle, style: container, stackPresentation, children }) };
  const items1 = [closure_5(screenId(4942).EdgeInsetApplicationContext.Provider, obj), , ];
  obj = {};
  const merged1 = Object.assign(headerConfig);
  items1[1] = closure_5(screenId(4941).ScreenStackHeaderConfig, obj);
  let tmp18Result = "formSheet" === stackPresentation && unstable_sheetFooter;
  if (tmp18Result) {
    obj1 = { children: unstable_sheetFooter() };
    tmp18Result = closure_5(screenId(4957).FooterComponent, obj1);
  }
  ...
  return closure_5(_modDef4930, obj2);
});