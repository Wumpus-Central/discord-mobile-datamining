...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUTimeUnitCasualRelativeFormatParser(10909).TIME_UNITS_PATTERN +
      ")"
    );
  },
};
  ...
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if ("\u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0435" !== formatted) {
        ...
        const ParsingComponents = RUTimeUnitCasualRelativeFormatParser(10783).ParsingComponents;
        return ParsingComponents.createRelativeFromReference(reference.reference, reverseDurationResult);
      }
      reverseDurationResult = RUTimeUnitCasualRelativeFormatParser(10782).reverseDuration(parseDurationResult);
    },
  },
];
