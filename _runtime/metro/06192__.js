...
import tagMessage2 from "../06078_tagMessage.js";
...
import GestureObjects2 from "../06193_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6174).gestureToPressableEvent(handlerTag));
        let obj = hitSlop(6174);
      }
    };
