// _runtime/metro/05491__.js
import _mod5488 from "05488__.js";
import _mod5489 from "05489__.js";
import _mod5492 from "05492__.js";
import is7Z from "../05493_is7Z.js";
import _mod5494 from "05494__.js";
import _mod5495 from "05495__.js";
import _mod5496 from "05496__.js";
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      hasOwnProperty = Object.prototype.hasOwnProperty;
      let call = hasOwnProperty.call;
      let FileTypes = _mod5489.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      let tmp21 = require;
      let FileTypes2 = _mod5489.FileTypes;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5489.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let FileTypes3 = tmp21(5489).FileTypes;
    ...
    fileChunk = _mod5488.getFileChunk(fileChunk, num2);
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5489.FileTypes;
