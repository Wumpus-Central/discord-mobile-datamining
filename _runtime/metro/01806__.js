...
import _mod1807 from "01807__.js";
import convertLrgbToOklabDefault from "../01808_convertLrgbToOklab.js";
...
const interpolateColorsHSV = function o(arg0, items, h, useCorrectedHSVInterpolation) {
  ...
  if (undefined !== useCorrectedHSVInterpolation) {
    ...
    return tmpResult6.hsvToColor(
      ...
      interpolateResult1,
      interpolateResult2,
      tmpResult5.interpolate(arg0, items, h.a, _mod1807.Extrapolation.CLAMP),
    );
  }
  items = [];
  items[0] = items[0];
...
interpolateColorsHSV.__closure = {
  interpolate: _mod1807.interpolate,
  Extrapolation: _mod1807.Extrapolation,
  hsvToColor: _mod1681.hsvToColor,
};
...
const fn5 = function n(arg0, items, l, arg3) {
  ...
  ({ r, g, b, alpha } = convert.toRgb({
    ...
    alpha: _mod1807.interpolate(arg0, items, l.alpha, _mod1807.Extrapolation.CLAMP),
  }));
...
const color = {
  processColor: _mod1681.processColor,
  red: _mod1681.red,
  green: _mod1681.green,
  blue: _mod1681.blue,
  opacity: _mod1681.opacity,
};
fn6.__closure = color;
