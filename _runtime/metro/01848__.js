...
export default forwardRef((bottomOffset, arg1) => {
  ...
  const reanimatedFocusedInput = require("01832__.js").useReanimatedFocusedInput();
  const input = reanimatedFocusedInput.input;
  const update = reanimatedFocusedInput.update;
  const obj10 = require("01832__.js");
  ...
  let height = require("01832__.js").useWindowDimensions().height;
  ...
  const obj17 = require("01832__.js");
  M.__closure = {
    enabled: flag2,
    layout: sharedValue8,
    ...
    scrollDistanceWithRespectToSnapPoints: require("01850__.js").scrollDistanceWithRespectToSnapPoints,
  ...
  const items10 = [tmp34];
  require("01832__.js").useFocusedInputHandler({ onSelectionChange: tmp34 }, items10);
  const obj22 = require("01832__.js");
  ...
  require("01851__.js").useSmoothKeyboardHandler(obj24, items11);
  ...
  const obj23 = require("01851__.js");
  class De {
    constructor() {
      return input.value;
    }
