...
export default forwardRef((bottomOffset, arg1) => {
  ...
  const reanimatedFocusedInput = require("module_1832").useReanimatedFocusedInput();
  const input = reanimatedFocusedInput.input;
  const update = reanimatedFocusedInput.update;
  const obj10 = require("module_1832");
  ...
  let height = require("module_1832").useWindowDimensions().height;
  ...
  const obj17 = require("module_1832");
  M.__closure = { enabled: flag2, layout: sharedValue8, scrollViewTarget: sharedValue, height, keyboardHeight: sharedValue3, bottomOffset: num, interpolate: require("cancelAnimation").interpolate, initialKeyboardSize: sharedValue6, scrollDistanceWithRespectToSnapPoints: require("module_1850").scrollDistanceWithRespectToSnapPoints, scrollPosition: sharedValue1, snapToOffsets, scrollTo: require("cancelAnimation").scrollTo, scrollViewAnimatedRef: animatedRef, scrollViewPageY: sharedValue13 };
  ...
  closure_35 = tmp32;
  const items8 = [tmp32];
  const tmp33 = animatedRef(() => _mod1850.debounce(closure_35, 200), items8);
  closure_36 = tmp33;
  class N {
    constructor(arg0) {
      iter = closure_23;
  ...
  const items10 = [tmp34];
  require("module_1832").useFocusedInputHandler({ onSelectionChange: tmp34 }, items10);
  const obj22 = require("module_1832");
  ...
  require("module_1851").useSmoothKeyboardHandler(obj24, items11);
  ...
  const obj23 = require("module_1851");
  class De {
    constructor() {
      return input.value;
    }
