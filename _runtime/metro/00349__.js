...
class ScrollView {
  constructor(arg0) {
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (measureLayout, arg1, _preventNegativeScrollOffset) => {
      ...
      if (null != f107619._innerView.nativeInstance) {
        if (typeof measureLayout === "number") {
          ...
          obj.measureLayout(measureLayout, tmp4(renderElement.findNodeHandle(f107619)), f107619._textInputFocusError, f107619._inputMeasureAndScrollToKeyboard);
        } else {
          measureLayout.measureLayout(f107619._innerView.nativeInstance, f107619._inputMeasureAndScrollToKeyboard, f107619._textInputFocusError);
        }
      }
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      ...
      tmp5 = null != result && nativeEvent.target !== result && f107619._softKeyboardIsDetached() && f107619._keyboardIsDismissible() && tmp;
    };
