...
class ScrollView {
  constructor(arg0) {
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (measureLayout, arg1, _preventNegativeScrollOffset) => {
      ...
      if (null != f110324._innerView.nativeInstance) {
        if (typeof measureLayout === "number") {
          ...
          obj.measureLayout(measureLayout, tmp4(renderElement.findNodeHandle(f110324)), f110324._textInputFocusError, f110324._inputMeasureAndScrollToKeyboard);
        } else {
          measureLayout.measureLayout(f110324._innerView.nativeInstance, f110324._inputMeasureAndScrollToKeyboard, f110324._textInputFocusError);
        }
      }
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      ...
      tmp5 = null != result && nativeEvent.target !== result && f110324._softKeyboardIsDetached() && f110324._keyboardIsDismissible() && tmp;
    };
