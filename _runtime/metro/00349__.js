...
class ScrollView {
  constructor(arg0) {
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (measureLayout, arg1, _preventNegativeScrollOffset) => {
      ...
      if (null != f110209._innerView.nativeInstance) {
        if (typeof measureLayout === "number") {
          ...
          obj.measureLayout(measureLayout, tmp4(renderElement.findNodeHandle(f110209)), f110209._textInputFocusError, f110209._inputMeasureAndScrollToKeyboard);
        } else {
          measureLayout.measureLayout(f110209._innerView.nativeInstance, f110209._inputMeasureAndScrollToKeyboard, f110209._textInputFocusError);
        }
      }
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      ...
      tmp5 = null != result && nativeEvent.target !== result && f110209._softKeyboardIsDetached() && f110209._keyboardIsDismissible() && tmp;
    };
