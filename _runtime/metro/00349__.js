...
class ScrollView {
  constructor(arg0) {
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (measureLayout, arg1, _preventNegativeScrollOffset) => {
      ...
      if (null != f108605._innerView.nativeInstance) {
        if (typeof measureLayout === "number") {
          ...
          obj.measureLayout(measureLayout, tmp4(renderElement.findNodeHandle(f108605)), f108605._textInputFocusError, f108605._inputMeasureAndScrollToKeyboard);
        } else {
          measureLayout.measureLayout(f108605._innerView.nativeInstance, f108605._inputMeasureAndScrollToKeyboard, f108605._textInputFocusError);
        }
      }
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      ...
      tmp5 = null != result && nativeEvent.target !== result && f108605._softKeyboardIsDetached() && f108605._keyboardIsDismissible() && tmp;
    };
