...
class ScrollView {
  constructor(arg0) {
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (measureLayout, arg1, _preventNegativeScrollOffset) => {
      ...
      if (null != f107870._innerView.nativeInstance) {
        if (typeof measureLayout === "number") {
          ...
          obj.measureLayout(
            measureLayout,
            tmp4(renderElement.findNodeHandle(f107870)),
            f107870._textInputFocusError,
            f107870._inputMeasureAndScrollToKeyboard,
          );
        } else {
          measureLayout.measureLayout(
            f107870._innerView.nativeInstance,
            f107870._inputMeasureAndScrollToKeyboard,
            f107870._textInputFocusError,
          );
        }
    ...
    f107870 = (arg0) =>
      Object.assign(arg0, {
        getScrollResponder: f107870.getScrollResponder,
        getScrollableNode: f107870.getScrollableNode,
        getInnerViewNode: f107870.getInnerViewNode,
        getInnerViewRef: f107870.getInnerViewRef,
        getNativeScrollRef: f107870.getNativeScrollRef,
        scrollTo: f107870.scrollTo,
        scrollToEnd: f107870.scrollToEnd,
        flashScrollIndicators: f107870.flashScrollIndicators,
        scrollResponderZoomTo: f107870.scrollResponderZoomTo,
        scrollResponderScrollNativeHandleToKeyboard: f107870.scrollResponderScrollNativeHandleToKeyboard,
      });
    closure_1 = undefined;
    obj1 = {
      getForwardingRef: c2(closure_4[29])((arg0) => {
    ...
    tmp3Result._isAnimating = () => {
      const _performance = ScrollView.performance;
      return (
        _performance.now() - f107870._lastMomentumScrollEndTime < 16 ||
        f107870._lastMomentumScrollEndTime < f107870._lastMomentumScrollBeginTime
      );
    };
    ...
    tmp3Result._handleScrollShouldSetResponder = () =>
      true !== f107870.props.disableScrollViewPanResponder && f107870._isTouching;
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      ...
      tmp5 =
        ...
        f107870._softKeyboardIsDetached() &&
        f107870._keyboardIsDismissible() &&
        tmp;
    };
