...
class ScrollView {
  constructor(arg0) {
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (measureLayout, arg1, _preventNegativeScrollOffset) => {
      ...
      if (null != f109312._innerView.nativeInstance) {
        if (typeof measureLayout === "number") {
          ...
          obj.measureLayout(measureLayout, tmp4(renderElement.findNodeHandle(f109312)), f109312._textInputFocusError, f109312._inputMeasureAndScrollToKeyboard);
        } else {
          measureLayout.measureLayout(f109312._innerView.nativeInstance, f109312._inputMeasureAndScrollToKeyboard, f109312._textInputFocusError);
        }
      }
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      ...
      tmp5 = null != result && nativeEvent.target !== result && f109312._softKeyboardIsDetached() && f109312._keyboardIsDismissible() && tmp;
    };
