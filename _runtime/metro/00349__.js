...
class ScrollView {
  constructor(arg0) {
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (measureLayout, arg1, _preventNegativeScrollOffset) => {
      ...
      if (null != f109454._innerView.nativeInstance) {
        if (typeof measureLayout === "number") {
          ...
          obj.measureLayout(measureLayout, tmp4(renderElement.findNodeHandle(f109454)), f109454._textInputFocusError, f109454._inputMeasureAndScrollToKeyboard);
        } else {
          measureLayout.measureLayout(f109454._innerView.nativeInstance, f109454._inputMeasureAndScrollToKeyboard, f109454._textInputFocusError);
        }
      }
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      ...
      tmp5 = null != result && nativeEvent.target !== result && f109454._softKeyboardIsDetached() && f109454._keyboardIsDismissible() && tmp;
    };
