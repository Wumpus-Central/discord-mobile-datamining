...
class ScrollView {
  constructor(arg0) {
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (measureLayout, arg1, _preventNegativeScrollOffset) => {
      ...
      if (null != f109906._innerView.nativeInstance) {
        if (typeof measureLayout === "number") {
          ...
          obj.measureLayout(measureLayout, tmp4(renderElement.findNodeHandle(f109906)), f109906._textInputFocusError, f109906._inputMeasureAndScrollToKeyboard);
        } else {
          measureLayout.measureLayout(f109906._innerView.nativeInstance, f109906._inputMeasureAndScrollToKeyboard, f109906._textInputFocusError);
        }
      }
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      ...
      tmp5 = null != result && nativeEvent.target !== result && f109906._softKeyboardIsDetached() && f109906._keyboardIsDismissible() && tmp;
    };
