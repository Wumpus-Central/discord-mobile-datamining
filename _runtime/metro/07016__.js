...
import tagMessage2 from "../06902_tagMessage.js";
import touchDataToPressEvent from "../06998_touchDataToPressEvent.js";
import StateMachineEvent2 from "../07001_StateMachineEvent.js";
import GestureObjects2 from "../07017_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6998).gestureToPressableEvent(handlerTag));
        let obj = hitSlop(6998);
      }
    };
