// _runtime/metro/06696__.js
import handlerIDToTag2 from "../06673_handlerIDToTag.js";
...
import ActionType from "../06702_ActionType.js";
...
let closure_10 = {
  [fn(6675).State.UNDETERMINED]: undefined,
  [fn(6675).State.BEGAN]: "onBegan",
  [fn(6675).State.FAILED]: "onFailed",
  [fn(6675).State.CANCELLED]: "onCancelled",
  [fn(6675).State.ACTIVE]: "onActivated",
  [fn(6675).State.END]: "onEnded",
};
