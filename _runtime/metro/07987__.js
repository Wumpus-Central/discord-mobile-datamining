...
const entry = {
  ...
  value: function render() {
    ...
    const tmp3Result = Pattern(7909)(patternTransform);
    const size = {
      x,
      y,
      width,
    ...
    if (patternContentUnits) {
      num2 = Pattern(7979)[patternContentUnits];
    }
    ...
    const tmp3 = Pattern(7909);
    const merged = Object.assign(size);
    const merged1 = Object.assign(Pattern(7914)({ viewBox, preserveAspectRatio }));
    obj.children = children;
    return jsx(Pattern(7988), {
      ref(arg0) {
        return self.refMethod(arg0);
      },
    });
