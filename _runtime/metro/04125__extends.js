// _runtime/metro/04125__extends.js
...
export const MemoryRouter = Component2(4129).Redirect;
export const Prompt = Component2(4129).Redirect;
export const Redirect = Component2(4129).Redirect;
export const Route = Component2(4129).Route;
export const Router = Component2(4129).Router;
export const StaticRouter = Component2(4129).StaticRouter;
export const Switch = Component2(4129).Switch;
export const generatePath = Component2(4129).generatePath;
export const matchPath = Component2(4129).matchPath;
export const useHistory = Component2(4129).useHistory;
export const useLocation = Component2(4129).useLocation;
export const useParams = Component2(4129).useParams;
export const useRouteMatch = Component2(4129).useRouteMatch;
export const withRouter = Component2(4129).withRouter;
