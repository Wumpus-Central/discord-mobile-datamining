...
function withScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = AsyncContextStack(13074).getDefaultCurrentScope();
    const tmpResult = AsyncContextStack(13074);
    stack = new _moduleResult(defaultCurrentScope, AsyncContextStack(13074).getDefaultIsolationScope());
    const tmpResult2 = AsyncContextStack(13074);
  }
...
function withIsolationScope(arg0) {
  ...
  return stack.withScope(() => {
    ...
    if (!stack) {
      const defaultCurrentScope = AsyncContextStack(13074).getDefaultCurrentScope();
      const tmp2Result = AsyncContextStack(13074);
      stack = new closure_2_3(defaultCurrentScope, AsyncContextStack(13074).getDefaultIsolationScope());
      const tmp2Result2 = AsyncContextStack(13074);
    }
    sentryCarrier.stack = stack;
  ...
  return {
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = AsyncContextStack(13074).getDefaultCurrentScope();
        const tmpResult = AsyncContextStack(13074);
        stack = new closure_1_3(defaultCurrentScope, AsyncContextStack(13074).getDefaultIsolationScope());
        const tmpResult2 = AsyncContextStack(13074);
      }
      sentryCarrier.stack = stack;
