...
// Module 13355
import Comparator from "Comparator" /* 13346 */;


export default (arg0, arg1, arg2, arg3) => {
  let obj;
  let _require = arg3;
  const tmp3 = new _require(13318)(arg0, arg3);
  const tmp4 = new _require(13347)(arg1, arg3);
  if (">" === arg2) {
    dependencyMap = tmp(13338);
    let tmpResult = tmp(13343);
    tmpResult = tmp(13339);
    closure_2 = tmpResult;
    let str3 = ">=";
    let str = ">";
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13339);
      tmpResult = tmp(13342);
      tmpResult1 = tmp(13338);
  ...
  if (_require(13349)(tmp3, tmp4, arg3)) {
    return false;
  } else {
    let num = 0;
    let num3 = 0;
