...
import get0thIfdOffset from "../05450_get0thIfdOffset.js";
import IFD_TYPE_0TH from "../05451_IFD_TYPE_0TH.js";
...
export default {
  read(buffer, c5, arg2) {
    let iter;
    const byteOrder = _modDef5435.getByteOrder(buffer, c5);
    const obj2 = get0thIfdOffset;
    const ifd = obj2.readIfd(
      buffer,
      IFD_TYPE_0TH.IFD_TYPE_MPF,
      c5,
      get0thIfdOffset.get0thIfdOffset(buffer, c5, byteOrder),
      byteOrder,
      arg2,
    );
    if (ifd.MPEntry) {
      ...
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let result = num13 * c3;
          let obj4 = _modDef5447;
          let typeSize = obj4.getTypeSize("LONG");
          if (byteOrder === _modDef5435.LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
          ...
          if (0 !== num13) {
            ...
            let deferInitResult = obj15.deferInit(items[num13], "base64", function () {
              return _mod5430.getBase64Image(this.image);
            });
            num13 = num13 + 1;
            let _Math2 = Math;
          }
        ...
        const typeSize4 = _modDef5447.getTypeSize("LONG");
        if (byteOrder === _modDef5435.LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
