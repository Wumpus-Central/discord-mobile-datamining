...
import module_9890_mod from "09890__.js";
...
let module_9890 = module_9890_mod;
const nativeComponent = module_9890.getNativeComponent();
let module_9890 = module_9890_mod;
      ...
      if (typeof toIsoWithTimeZoneOffset === "function") {
        ...
        if (typeof getTimezoneOffsetInMinutes === "function") {
          ...
          if (typeof getStyle === "function") {
            ...
            const modal = require("09892__.js").useModal(obj2);
            let tmp16 = null;
            if (!date.modal) {
              const obj4 = {};
