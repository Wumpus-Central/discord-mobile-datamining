// _runtime/metro/06732__.js
import handlerIDToTag2 from "../06709_handlerIDToTag.js";
...
import transformIntoHandlerTags from "../06736_transformIntoHandlerTags.js";
import ghQueueMicrotask from "../06737_ghQueueMicrotask.js";
import ActionType from "../06738_ActionType.js";
...
let closure_10 = {
  [fn(6711).State.UNDETERMINED]: undefined,
  [fn(6711).State.BEGAN]: "onBegan",
  [fn(6711).State.FAILED]: "onFailed",
  [fn(6711).State.CANCELLED]: "onCancelled",
  [fn(6711).State.ACTIVE]: "onActivated",
  [fn(6711).State.END]: "onEnded",
};
