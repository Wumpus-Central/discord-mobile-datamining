...
export const NativeStackView = function NativeStackView(state) {
  ...
  let obj = require("module_7920");
  const setNextDismissedKey = obj.useDismissedRouteError(state).setNextDismissedKey;
  const invalidPreventRemoveError = require("module_7921").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("module_7921");
  const modalRouteKeys = require("module_7922").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("module_5631").SafeAreaProviderCompat, obj);
};