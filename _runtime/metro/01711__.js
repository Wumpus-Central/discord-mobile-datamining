...
fn = function n(userConfig, callback) {
  ...
  let obj = { userConfig, isValidRubberBandConfig: require("module_1712").isValidRubberBandConfig, rubberBandDecay: require("rubberBandDecay").rubberBandDecay, rigidDecay: require("rigidDecay").rigidDecay, validateConfig, callback, getReduceMotionForAnimation: require("module_1676").getReduceMotionForAnimation };
  fn.__closure = obj;
