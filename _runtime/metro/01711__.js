...
fn = function n(config, _animationToClamp) {
    ...
    const obj3 = {
      ...
      onFrame: function clampOnFrame(arg0, arg1) {
        if (undefined === previousAnimation.current) {
          ...
          const result = _mod1678.recognizePrefixSuffix(previousAnimation.current);
  ...
  fn.__closure = {
    _animationToClamp,
    config,
    recognizePrefixSuffix: require("01678__.js").recognizePrefixSuffix,
    logger: require("01642__.js").logger,
...
fn.__closure = {
  ...
  recognizePrefixSuffix: fn(1678).recognizePrefixSuffix,
