// _runtime/metro/09083__.js
import _mod9079 from "09079__.js";
import _mod9080 from "09080__.js";
import _mod9084 from "09084__.js";
import _mod9085 from "09085__.js";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_10 = fn(require("09082__.js"));
    ...
    let obj = {
      enumerable: true,
      get() {
        return require("09082__.js").clone;
      },
    };
      ...
      _zod.implement = (fn) => {
        ...
        if (typeof fn !== "function") {
          ...
          return function () {
            ...
            let parsed = items;
            if (_def._def.input) {
              parsed = _mod9080.parse(_def._def.input, items);
            }
            const applyResult = Reflect.apply(_def, this, parsed);
            let parsed1 = applyResult;
            if (_def._def.output) {
              parsed1 = _mod9080.parse(_def._def.output, applyResult);
            }
            return parsed1;
          };
        }
