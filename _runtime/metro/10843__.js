...
export const horizontalStackLayout = function horizontalStackLayout() {
  ...
  __closure = { screen, modeConfig: __closure, getCommonVariables, getCommonStyles, interpolate: __closure(1636).interpolate, Extrapolation: __closure(1636).Extrapolation };
...
export const useHorizontalStackLayout = function useHorizontalStackLayout() {
  ...
  fn.__closure = { screen, modeConfig: obj, getCommonVariables, getCommonStyles, interpolate: obj(obj[2]).interpolate, Extrapolation: obj(obj[2]).Extrapolation };
  fn.__workletHash = 13118376883684;
  fn.__initData = __initData;
  obj.layout = fn;
  obj.config = tmp;
