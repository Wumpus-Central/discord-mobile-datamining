// _runtime/metro/07221__.js
import PanGestureHandler from "../07201_PanGestureHandler.js";
import _mod7215 from "07215__.js";
import _mod7216 from "07216__.js";
import _mod7222 from "07222__.js";
...
export const Card = function Card(shadowEnabled) {
  ...
  let tmp11 = num(1506)(() => {
    ...
    if (ref.current) {
      ...
      if (typeof getAnimateToValue === "function") {
        if (closing) {
          let num3 = _mod7215.getDistanceForDirection(layout, gestureDirection, "rtl" === direction);
        } else {
          num3 = 0;
        }
        if (tmp7 === num3) {
          if (ref2.current === num3) {
            ...
            if (tmp24) {
              gesture.setValue(_mod7215.getDistanceForDirection(layout, gestureDirection, "rtl" === direction));
              const obj4 = { closing };
              closure_34(obj4);
            }
          }
  ...
  let merged = Object.assign(
    flag2(7224).gestureActivationCriteria({ layout, direction, gestureDirection, gestureResponseDistance }),
  );
