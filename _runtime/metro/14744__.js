// _runtime/metro/14744__.js
import _mod14738 from "14738__.js";
import URLSearchParamsImpl from "../14745_URLSearchParamsImpl.js";
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(
                URLSearchParams(14746).USVString(arguments[0], {
                  context: "Failed to execute 'append' on 'URLSearchParams': parameter 1",
                }),
              );
              const obj = URLSearchParams(14746);
              items.push(
                URLSearchParams(14746).USVString(arguments[1], {
