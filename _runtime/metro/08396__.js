// _runtime/metro/08396__.js
import _mod8392 from "08392__.js";
import _mod8393 from "08393__.js";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_10 = fn(require("08395__.js"));
    ...
    let obj = {
      enumerable: true,
      get() {
        return require("08395__.js").clone;
      },
    };
      ...
      _zod.implement = (fn) => {
        ...
        if (typeof fn !== "function") {
          ...
          return function () {
            ...
            let parsed = items;
            if (_def._def.input) {
              parsed = _mod8393.parse(_def._def.input, items);
            }
            const applyResult = Reflect.apply(_def, this, parsed);
            let parsed1 = applyResult;
            if (_def._def.output) {
              parsed1 = _mod8393.parse(_def._def.output, applyResult);
            }
            return parsed1;
          };
        }
