// _runtime/metro/14256__.js
import SymbolResult1 from "../14250_SymbolResult1.js";
import URLSearchParamsImpl from "../14257_URLSearchParamsImpl.js";
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(
                URLSearchParams(14258).USVString(arguments[0], {
                  context: "Failed to execute 'append' on 'URLSearchParams': parameter 1",
                }),
              );
              obj = URLSearchParams(14258);
              items.push(
                URLSearchParams(14258).USVString(arguments[1], {
