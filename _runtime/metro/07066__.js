...
let obj = {
  default: fn(7067).DefaultTransition,
  fade: fn(7067).ModalFadeTransition,
  fade_from_bottom: fn(7067).FadeFromBottomAndroid,
  fade_from_right: fn(7067).FadeFromRightAndroid,
  none: fn(7067).DefaultTransition,
  reveal_from_bottom: fn(7067).RevealFromBottomAndroid,
  scale_from_center: fn(7067).ScaleFromCenterAndroid,
  slide_from_left: fn(7067).SlideFromLeftIOS,
  slide_from_right: fn(7067).SlideFromRightIOS,
  slide_from_bottom: fn(7067).BottomSheetAndroid,
};
...
const entry = {
  ...
  value: function render() {
    ...
    obj2.children = items3.map((key, index) => {
      ...
      if (typeof getInterpolationIndex === "function") {
        ...
        if (typeof getIsModal === "function") {
          ...
          obj.children = React6(CardStack(7074).CardContainer, obj);
    ...
    items2[1] = renderHeader(CardStack(7073).MaybeScreenContainer, obj2);
    obj.children = items2;
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7069).forModalPresentationIOS ||
