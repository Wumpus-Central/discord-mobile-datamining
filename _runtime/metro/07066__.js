...
import handlerIDToTag from "../06987_handlerIDToTag.js";
import transformIntoHandlerTags from "../07014_transformIntoHandlerTags.js";
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("07067__.js").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      return () => {
        closure_0(7051).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(7051);
        closure_0(6987).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
