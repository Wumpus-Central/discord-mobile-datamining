...
const entry = {
  ...
  value: function render() {
    ...
    if (patternContentUnits) {
      num2 = Pattern(8655)[patternContentUnits];
    }
    ...
    const merged1 = Object.assign(Pattern(8590)({ viewBox, preserveAspectRatio }));
