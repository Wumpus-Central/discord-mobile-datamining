...
const entry = {
  ...
  value: function parse(arg0, arg1) {
    if ("X" === arg1) {
      return _createSuperInternal(4223).parseTimezonePattern(_createSuperInternal(4224).timezonePatterns.basicOptionalMinutes, arg0);
    } else if ("XX" === arg1) {
      return _createSuperInternal(4223).parseTimezonePattern(_createSuperInternal(4224).timezonePatterns.basic, arg0);
    } else if ("XXXX" === arg1) {
      return _createSuperInternal(4223).parseTimezonePattern(_createSuperInternal(4224).timezonePatterns.basicOptionalSeconds, arg0);
    } else if ("XXXXX" === arg1) {
      return _createSuperInternal(4223).parseTimezonePattern(_createSuperInternal(4224).timezonePatterns.extendedOptionalSeconds, arg0);
    } else {
      return _createSuperInternal(4223).parseTimezonePattern(_createSuperInternal(4224).timezonePatterns.extended, arg0);
    }
  }
};
let items = [
