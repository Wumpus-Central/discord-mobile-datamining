...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08164__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08164__.js");
  const invalidPreventRemoveError = require("08165__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08165__.js");
  const modalRouteKeys = require("08166__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05848__.js").SafeAreaProviderCompat, obj4);
};
