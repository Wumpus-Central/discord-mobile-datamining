...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("module_8577").container, require("module_8577").webView, style];
  const items4 = [require("module_8577").container, containerStyle];
