...
import throwProtectedError from "../03973_throwProtectedError.js";
import parsers from "../04030_parsers.js";
import code_mod from "03972__.js";
...
import dateLongFormatter_mod from "../03971_dateLongFormatter.js";
import module_3889_mod from "03889__.js";
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("03731__.js").getDefaultOptions();
  let locale1;
  if (null != locale) {
