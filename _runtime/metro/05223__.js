...
export default function TabsScreen(arg0) {
  ...
  const result = _mod5226.parseAndroidIconToNativeProps(icon);
  const tmp5Result = _mod5226;
  const result1 = _mod5226.parseAndroidIconToNativeProps(selectedIcon);
  ...
  return jsx(_modDef5225, { collapsable: false, style: null, ref });
}
