...
import _modDef8755 from "08755__.js";
...
_inherits(G, _modDef8756);
const entry = {
  key: "render",
  value: function render() {
    const self = this;
    const props = this.props;
    const propsAndStylesResult = G(8747).propsAndStyles(props);
    const tmp5 = extractPropsDefault(propsAndStylesResult, this);
    const obj = G(8747);
    const extractFontResult = G(8754).extractFont(propsAndStylesResult);
