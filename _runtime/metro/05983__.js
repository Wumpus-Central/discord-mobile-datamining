...
import FrameSizeProvider from "FrameSizeProvider" /* 5960 */;
    ...
    obj = {
      ...
      render(onLayout) {
            ...
            if (closure_2) {
              ...
              tmp2Result = jsx(_mod1615.SafeAreaProvider, { initialMetrics: initialWindowMetrics, style, onLayout, children });
            }
            return tmp2Result;
          }
    };
