// _runtime/metro/04109__extends.js
...
export const MemoryRouter = Component2(4113).Redirect;
export const Prompt = Component2(4113).Redirect;
export const Redirect = Component2(4113).Redirect;
export const Route = Component2(4113).Route;
export const Router = Component2(4113).Router;
export const StaticRouter = Component2(4113).StaticRouter;
export const Switch = Component2(4113).Switch;
export const generatePath = Component2(4113).generatePath;
export const matchPath = Component2(4113).matchPath;
export const useHistory = Component2(4113).useHistory;
export const useLocation = Component2(4113).useLocation;
export const useParams = Component2(4113).useParams;
export const useRouteMatch = Component2(4113).useRouteMatch;
export const withRouter = Component2(4113).withRouter;
