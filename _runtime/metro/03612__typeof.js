// _runtime/metro/03612__typeof.js
...
obj = {
  ...
  value: function parse(arg0, arg1) {
    if ("x" === arg1) {
      return _createSuperInternal(3580).parseTimezonePattern(_createSuperInternal(3581).timezonePatterns.basicOptionalMinutes, arg0);
    } else if ("xx" === arg1) {
      return _createSuperInternal(3580).parseTimezonePattern(_createSuperInternal(3581).timezonePatterns.basic, arg0);
    } else if ("xxxx" === arg1) {
      return _createSuperInternal(3580).parseTimezonePattern(_createSuperInternal(3581).timezonePatterns.basicOptionalSeconds, arg0);
    } else if ("xxxxx" === arg1) {
      return _createSuperInternal(3580).parseTimezonePattern(_createSuperInternal(3581).timezonePatterns.extendedOptionalSeconds, arg0);
    } else {
      return _createSuperInternal(3580).parseTimezonePattern(_createSuperInternal(3581).timezonePatterns.extended, arg0);
    }
  }
};
let items = [
