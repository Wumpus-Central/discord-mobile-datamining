...
import emptyFunction_mod from "09319__.js";
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = timestampProducer(CircularProgress(7901).Path, obj4);
      }
      ...
      if (tmp23Result3) {
        ...
        tmp23Result3 = timestampProducer(CircularProgress(7901).Path, obj5);
      }
      items[1] = tmp23Result3;
      items[2] = renderCapResult;
      obj3.children = items;
      size2.children = React5(CircularProgress(7901).G, obj3);
      const items1 = [timestampProducer(CircularProgress(7901).Svg, size2)];
