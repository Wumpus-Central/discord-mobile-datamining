// _runtime/metro/03869__typeof.js
import Parser2 from "../03848_Parser.js";
import setUTCISODay from "../03870_setUTCISODay.js";
    ...
    if ("i" !== arg1) {
      if ("ii" !== arg1) {
        if ("io" === arg1) {
          ...
          if ("iii" === arg1) {
            return _createSuperInternal(3850).mapValue(ordinalNumber.day(arg0, { width: "abbreviated", context: "formatting" }) || ordinalNumber.day(arg0, { width: "short", context: "formatting" }) || ordinalNumber.day(arg0, { width: "narrow", context: "formatting" }), valueCallback);
          } else if ("iiiii" === arg1) {
            return _createSuperInternal(3850).mapValue(ordinalNumber.day(arg0, { width: "narrow", context: "formatting" }), valueCallback);
          } else if ("iiiiii" === arg1) {
            return _createSuperInternal(3850).mapValue(ordinalNumber.day(arg0, { width: "short", context: "formatting" }) || ordinalNumber.day(arg0, { width: "narrow", context: "formatting" }), valueCallback);
          } else {
            return _createSuperInternal(3850).mapValue(ordinalNumber.day(arg0, { width: "wide", context: "formatting" }) || ordinalNumber.day(arg0, { width: "abbreviated", context: "formatting" }) || ordinalNumber.day(arg0, { width: "short", context: "formatting" }) || ordinalNumber.day(arg0, { width: "narrow", context: "formatting" }), valueCallback);
          }
        }
      }
    }
