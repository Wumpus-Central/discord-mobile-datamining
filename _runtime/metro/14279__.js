  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = SemVer(14284).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = SemVer(14284);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = SemVer(14284).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = SemVer(14284);
      }
