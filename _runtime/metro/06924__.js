...
import handlerIDToTag2 from "../06901_handlerIDToTag.js";
...
import ActionType from "../06930_ActionType.js";
...
let closure_10 = {
  [fn(6903).State.UNDETERMINED]: undefined,
  [fn(6903).State.BEGAN]: "onBegan",
  [fn(6903).State.FAILED]: "onFailed",
  [fn(6903).State.CANCELLED]: "onCancelled",
  [fn(6903).State.ACTIVE]: "onActivated",
  [fn(6903).State.END]: "onEnded",
};
