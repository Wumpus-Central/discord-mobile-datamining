// _runtime/metro/14760__.js
import _mod14761 from "14761__.js";
...
let value = (() => {
  ...
  const entry1 = {
    ...
    value: function supportedLocalesOf(items, arg1) {
      ...
      return _mod14761.LookupSupportedLocales(Array.from(ListFormat.availableLocales), canonicalLocales);
    },
  };
  let items1 = [
    entry1,
