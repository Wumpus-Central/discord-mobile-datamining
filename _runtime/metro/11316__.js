// _runtime/metro/11316__.js
import _mod11318 from "11318__.js";
import RNIapAmazonModuleAll from "../11324_RNIapAmazonModule.js";
import _modAll11325 from "11325__.js";
import _modAll11326 from "11326__.js";
import syncAll from "../11327_sync.js";
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      ...
      closure_128_0 = value.map(tmp2(11323).singleProductAndroidMap);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      ...
      await tmp2(11318).fillProductsWithAdditionalData(closure_128_2);
      closure_128_2 = value;
