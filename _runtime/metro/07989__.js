...
function SceneView(arg0) {
  ...
  const callback = obj2.useCallback(num6(7990).debounce(tmp18, 100), []);
  ...
  let eventResult;
  const headerConfigProps = num6(7991).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(7991);
  obj14.children = closure_10(num6(5682).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5682).HeaderShownContext.Provider, obj14);
  obj7.children = items5;
  obj6.children = closure_11(num6(5682).HeaderHeightContext.Provider, obj7);
  obj4.children = closure_10(num6(7993).AnimatedHeaderHeightContext.Provider, obj6);
  obj3.children = closure_10(num6(4958).ScreenStackItem, obj4);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  let obj = require("07994__.js");
  const setNextDismissedKey = obj.useDismissedRouteError(state).setNextDismissedKey;
  const invalidPreventRemoveError = require("07995__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("07995__.js");
  const modalRouteKeys = require("07996__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05682__.js").SafeAreaProviderCompat, obj);
};
