// _runtime/metro/04208__extends.js
...
export const MemoryRouter = Component2(4212).Redirect;
export const Prompt = Component2(4212).Redirect;
export const Redirect = Component2(4212).Redirect;
export const Route = Component2(4212).Route;
export const Router = Component2(4212).Router;
export const StaticRouter = Component2(4212).StaticRouter;
export const Switch = Component2(4212).Switch;
export const generatePath = Component2(4212).generatePath;
export const matchPath = Component2(4212).matchPath;
export const useHistory = Component2(4212).useHistory;
export const useLocation = Component2(4212).useLocation;
export const useParams = Component2(4212).useParams;
export const useRouteMatch = Component2(4212).useRouteMatch;
export const withRouter = Component2(4212).withRouter;
