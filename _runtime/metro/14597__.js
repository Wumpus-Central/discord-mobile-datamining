// _runtime/metro/14597__.js
import _mod14591 from "14591__.js";
import URLSearchParamsImpl from "../14598_URLSearchParamsImpl.js";
...
let obj2 = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod14591.implSymbol)) {
        if (arg0[_mod14591.implSymbol] instanceof URLSearchParamsImpl.implementation) {
          return true;
        }
      }
  ...
  setup(wrapper, arg1) {
    ...
    if (URLSearchParamsImpl.init) {
      URLSearchParamsImpl.init(wrapper[_mod14591.implSymbol], obj);
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(
                URLSearchParams(14599).USVString(arguments[0], {
                  context: "Failed to execute 'append' on 'URLSearchParams': parameter 1",
                }),
              );
              const obj = URLSearchParams(14599);
              items.push(
                URLSearchParams(14599).USVString(arguments[1], {
              ...
              if (arguments.length < 1) {
                ...
                if (0 < arr2.length) {
                  do {
                    ...
                    let _Array = Array;
                    arr3 = Array.from(self[URLSearchParams(undefined, 14591).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr3;
