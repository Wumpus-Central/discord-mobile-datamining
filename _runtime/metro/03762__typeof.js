// _runtime/metro/03762__typeof.js
    ...
    if ("D" !== arg1) {
      if ("DD" !== arg1) {
        if ("Do" === arg1) {
          ...
          return _createSuperInternal(3748).parseNDigits(arg1.length, arg0);
        }
      }
    }
    return _createSuperInternal(3748).parseNumericPattern(_createSuperInternal(3749).numericPatterns.dayOfYear, arg0);
  }
};
let items = [
  obj,
  {
    ...
    value: function validate(getUTCFullYear) {
      ...
      let tmp2 = arg1 >= 1;
      if (_createSuperInternal(3748).isLeapYearIndex(uTCFullYear)) {
        if (tmp2) {
          tmp2 = arg1 <= 366;
        }
        let tmp3 = tmp2;
