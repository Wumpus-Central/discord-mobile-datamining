...
import ButtonComponentDefault from "../06988_ButtonComponent.js";
...
import 07006__ from "07006__.js";
...
class InnerBaseButton {
  constructor(arg0) {
    ...
    tmp3Result.handleEvent = (nativeEvent) => {
      ...
      let tmp18 = state !== InnerBorderlessButton(6898).State.ACTIVE || pointerInside || undefined === closure_0.longPressTimeout;
      if (tmp18) {
