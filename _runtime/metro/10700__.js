...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10561).matchAnyPattern(RUWeekdayParser(10690).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10588).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10690).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
