    ...
    if (!module_1641) {
      ...
      if (!factory) {
        if (!obj.isWorkletFunction(factory)) {
          const reanimatedError = new _mod1649.ReanimatedError("The easing function is not a worklet. Please make sure you import `Easing` from react-native-reanimated.");
