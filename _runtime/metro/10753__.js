...
const regExp = new RegExp(
  "(?:(?:\\,|\\(|\\\uFF08)\\s*)?(?:(?:ce)\\s*)?(" +
    repeatedTimeunitPattern.matchAnyPattern(_mod10754.WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      const tmp4 = FRWeekdayParser(10754).WEEKDAY_DICTIONARY[formatted];
      if (undefined === tmp4) {
        return null;
      } else {
        ...
        return FRWeekdayParser(10719).createParsingComponentsAtWeekday(reference.reference, tmp4, str4);
      }
    },
  },
];
