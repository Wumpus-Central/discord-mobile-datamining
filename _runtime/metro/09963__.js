  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod9959.MODE_NUMBER === arg0) {
          return 10;
        } else if (_mod9959.MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (_mod9959.MODE_8BIT_BYTE !== arg0) {
            if (_mod9959.MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod9959.MODE_NUMBER === arg0) {
        ...
        return 11;
      } else if (_mod9959.MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (_mod9959.MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
