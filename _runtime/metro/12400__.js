  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = _mod12302.isInstanceOf(headers, Request);
        const tmpResult = _mod12302;
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = _mod12302.isInstanceOf(headers, Headers);
