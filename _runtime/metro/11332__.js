...
export const useIAP = () => {
  const iAPContext = require("11333__.js").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("11318__.js").requestPurchase,
    requestSubscription: require("11318__.js").requestSubscription,
  };
};
