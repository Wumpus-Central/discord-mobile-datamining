// _runtime/metro/17451__.js
import _possibleConstructorReturn from "00093__possibleConstructorReturn.js";
import _mod17452 from "17452__.js";
import Events from "../17456_Events.js";
...
class PQueue {
  constructor(arg0) {
    ...
    obj = {
      ...
      autoStart: true,
      queueClass: closure_0(closure_1[7]).default,
    };
  ...
  },
  {
    ...
    set(_concurrency) {
      ...
      const typeError = new TypeError(
        "Expected `concurrency` to be a number from 1 and up, got `" + _concurrency + "` (" + typeof _concurrency + ")",
      );
      throw typeError;
    },
  },
                    ...
                    if (set === 2) {
                      ...
                      try {
                        ...
                        if (arg0 === 1) {
                          ...
                          set = 3;
                          obj = { value: set.add(closure_0, closure_0), done: true };
                          return obj;
                        }
                      } catch (tmp7) {
                        set = tmp;
