// _runtime/metro/03765__typeof.js
...
obj = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("e" !== arg1) {
      if ("ee" !== arg1) {
        if ("eo" === arg1) {
          return _createSuperInternal(3748).mapValue(ordinalNumber.ordinalNumber(arg0, { unit: "day" }), valueCallback);
        } else if ("eee" === arg1) {
    ...
    return _createSuperInternal(3748).mapValue(_createSuperInternal(3748).parseNDigits(arg1.length, arg0), valueCallback);
  }
};
let items = [
  obj,
