...
function pathToRegexp(source, items, arg2) {
  ...
  if (source instanceof RegExp) {
    ...
    if (match) {
      ...
      if (0 < match.length) {
        do {
          obj = { name: num3, prefix: null, delimiter: null, optional: false, repeat: false, partial: false, asterisk: false, pattern: null };
