...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(clone, arg1) {
      ...
      const obj = _mod13052;
      obj2.endTimestamp = 1000 * _mod13068.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(errorCallback) {
  _mod13052.addHandler("fetch-body-resolved", errorCallback);
  _mod13052.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(13060).fill(closure_0(13055).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(13052);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(13068).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(13068);
            const obj4 = closure_3_0(13061);
            if (tmp5) {
              error.stack = stack.stack;
              const result = closure_3_0(13060).addNonEnumerableProperty(error, "framesToPop", 1);
              const tmpResult = closure_3_0(13060);
            }
            throw error;
          });
        };
      });
      const obj = closure_0(13060);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(errorCallback, arg1) {
  _require = arg1;
  require("13052__.js").addHandler("fetch", errorCallback);
  let obj = require("13052__.js");
  require("13052__.js").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod13060.fill(_mod13055.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
