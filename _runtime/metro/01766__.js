  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(targetOriginX) {
        ...
        for (const item10093 of keys2) {
          ...
          if ("transform" === item10093) {
            ...
            initialValues[tmp29] = delayFunction(
              initialValues,
              obj4.withSequence(obj6.withTiming(tmp.initialValues[tmp29], { duration: 0 }), tmp.animations[tmp29]),
            );
          }
          continue;
        }
      ...
      fn.__closure = {
        ...
        delayFunction,
        delay,
        withSequence: EntryExitTransition(1708).withSequence,
        withTiming: EntryExitTransition(1708).withTiming,
        exitingDuration: duration,
        logger: EntryExitTransition(1640).logger,
        callback: callbackV,
      };
