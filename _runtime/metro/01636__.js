...
let closure_13 = cancelAnimation.createAnimatedComponent(
  Animated.createAnimatedComponent(fn(1628).KeyboardControllerView),
);
...
export const KeyboardProvider = (enabled) => {
  ...
  closure_4 = require("01827__.js").useAnimatedValue(0);
  let obj = require("01827__.js");
  closure_5 = require("01827__.js").useAnimatedValue(0);
  let obj2 = require("01827__.js");
  ...
  Animated = require("01827__.js").useEventHandlerRegistration(tmp3);
  const obj6 = require("01827__.js");
  const obj7 = require("01827__.js");
  ...
  let items = [enabled];
  const setInputHandlers = require("01827__.js").useEventHandlerRegistration(tmp3);
  ...
  const obj9 = require("01829__.js");
  const animatedKeyboardHandler = require("01829__.js").useAnimatedKeyboardHandler(obj10, []);
  ...
  const obj11 = require("01829__.js");
  closure_5(() => {
    if (closure_0) {
  ...
  obj14.onFocusedInputLayoutChangedReanimated = require("01829__.js").useFocusedInputLayoutHandler(obj12, []);
