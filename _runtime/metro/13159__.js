...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(errorCallback) {
  _mod13046.addHandler("fetch-body-resolved", errorCallback);
        ...
        return () => {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            if (tmp5) {
              ...
              const result = closure_3_0(13054).addNonEnumerableProperty(error, "framesToPop", 1);
              const tmpResult = closure_3_0(13054);
            }
            throw error;
          });
        };
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(errorCallback, arg1) {
  _require = arg1;
  require("13046__.js").addHandler("fetch", errorCallback);
  let obj = require("13046__.js");
  require("13046__.js").maybeInstrument("fetch", () => {
    let flag = closure_0;
