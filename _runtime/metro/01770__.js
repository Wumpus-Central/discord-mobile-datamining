    ...
    tmp3Result.build = () => {
      ...
      const fn = function e(originX) {
        ...
        size.originX = delayFunction(
          delay,
          obj2.withSequence(withTimingResult, delayFunction(1708).withTiming(originX.targetOriginX, obj)),
        );
        ...
        size.originY = delayFunction(
          delay,
          tmp3Result10.withSequence(withTimingResult1, delayFunction(1708).withTiming(originX.targetOriginY, obj)),
        );
        ...
        size.width = delayFunction(
          delay,
          tmp3Result13.withSequence(withTimingResult2, delayFunction(1708).withTiming(originX.targetWidth, obj)),
        );
        ...
        size.height = delayFunction(
          delay,
          tmp3Result16.withSequence(withTimingResult3, delayFunction(1708).withTiming(originX.targetHeight, obj)),
        );
        obj.animations = size;
