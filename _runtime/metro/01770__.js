...
for (const key10019 in require("01771__.js")) {
  let tmp4 = key10019;
  arg5[key10019] = require("01771__.js")[key10019];
  continue;
}
for (const key10023 in require("01782__.js")) {
  let tmp5 = key10023;
  arg5[key10023] = require("01782__.js")[key10023];
  continue;
}
