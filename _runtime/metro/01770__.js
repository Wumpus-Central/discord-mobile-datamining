  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function e(originX) {
        ...
        size.originY = delayFunction(delay, tmp3Result.withSequence(withTimingResult1, delayFunction(1708).withTiming(originX.targetOriginY, obj)));
        ...
        size.width = delayFunction(delay, tmp3Result3.withSequence(withTimingResult2, delayFunction(1708).withTiming(originX.targetWidth, obj)));
        ...
        size.height = delayFunction(delay, tmp3Result6.withSequence(withTimingResult3, delayFunction(1708).withTiming(originX.targetHeight, obj)));
        obj.animations = size;
        obj.callback = callbackV;
        return obj;
      };
      __closure = { delayFunction, delay, withSequence: SequencedTransition(1708).withSequence, withTiming: SequencedTransition(1708).withTiming, reverse: reversed, config: __closure, callback: callbackV };
