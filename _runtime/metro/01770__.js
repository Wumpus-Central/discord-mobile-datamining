    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(originX) {
        ...
        size.originY = delayFunction(
          delay,
          obj4.withSequence(withTimingResult, delayFunction(1710).withTiming(originX.targetOriginY, obj6)),
        );
      ...
      fn.__closure = {
        delayFunction,
        delay,
        withTiming: JumpingTransition(1710).withTiming,
        config,
        withSequence: JumpingTransition(1710).withSequence,
        halfDuration: result,
        Easing: JumpingTransition(1690).Easing,
        callback: callbackV,
      };
