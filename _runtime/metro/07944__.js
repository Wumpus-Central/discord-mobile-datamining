...
import _modDef7945 from "07945__.js";
...
_inherits(FeComposite, _modDef7940);
const entry = {
  key: "render",
  value: function render() {
    ...
    const merged = Object.assign(FeComposite(7939).extractFilter(this.props));
    const obj2 = FeComposite(7939);
    const merged1 = Object.assign(FeComposite(7939).extractFeComposite(this.props));
    return (
      <tmp
