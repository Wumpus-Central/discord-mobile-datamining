...
function addLikelySubtags(arr3) {
  const parseUnicodeLocaleIdResult = _mod14630.parseUnicodeLocaleId(arr3);
  ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
  if (script) {
    if (region) {
      const obj = { lang, script, region, variants: [] };
      const tmp4 = _mod14630.likelySubtags[_mod14630.emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = _mod14630.parseUnicodeLanguageId(tmp4);
        ...
        return _mod14630.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = _mod14630.likelySubtags[_mod14630.emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = _mod14630.parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = _mod14630.likelySubtags[_mod14630.emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = _mod14630.parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = _mod14630.likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = _mod14630.likelySubtags[_mod14630.emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = _mod14630.parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
const module_14565 = e.__importDefault(_mod14565);
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14630).emitUnicodeLanguageId(
              obj.__assign(Locale(1161).__assign({}, Locale(14630).parseUnicodeLanguageId(tmp2)), obj3),
            );
            const parseUnicodeLocaleIdResult = Locale(14630).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (closure_1_6(Locale(14630).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = Locale(14630).emitUnicodeLocaleId(
              ...
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (closure_1_6(Locale(14630).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = Locale(14630).emitUnicodeLocaleId(
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (closure_1_6(Locale(14630).emitUnicodeLanguageId(obj10)) === result) {
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14630).emitUnicodeLanguageId(
        Locale(14630).parseUnicodeLanguageId(module_14565.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
  ...
  Object.defineProperty(Locale.prototype, "calendar", {
    get() {
      return module_14565.default(this).calendar;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "collation", {
    get() {
      return module_14565.default(this).collation;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "caseFirst", {
    get() {
      return module_14565.default(this).caseFirst;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "numeric", {
    get() {
      return module_14565.default(this).numeric;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "numberingSystem", {
    get() {
      return module_14565.default(this).numberingSystem;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "language", {
    get() {
      return Locale(14630).parseUnicodeLanguageId(module_14565.default(this).locale).lang;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "script", {
    get() {
      return Locale(14630).parseUnicodeLanguageId(module_14565.default(this).locale).script;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "region", {
    get() {
      return Locale(14630).parseUnicodeLanguageId(module_14565.default(this).locale).region;
    },
    enumerable: false,
    configurable: true,
  });
  Object.defineProperty(Locale.prototype, "firstDayOfWeek", {
    get() {
      const defaultResult = module_14565.default(this);
      if (Locale(14566).HasOwnProperty(defaultResult, "initializedLocale")) {
