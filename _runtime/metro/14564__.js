...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14630).emitUnicodeLanguageId(obj.__assign(Locale(1161).__assign({}, Locale(14630).parseUnicodeLanguageId(tmp2)), obj3));
            ...
            if (closure_1_6(Locale(14630).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = Locale(14630).emitUnicodeLocaleId(tmp3Result.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj5));
              ...
              if (region) {
                ...
                if (closure_1_6(Locale(14630).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = Locale(14630).emitUnicodeLocaleId(tmp3Result7.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                if (closure_1_6(Locale(14630).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = Locale(14630).emitUnicodeLocaleId(tmp3Result9.__assign(Locale(1161).__assign({}, parseUnicodeLocaleIdResult), obj11));
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14630).emitUnicodeLanguageId(Locale(14630).parseUnicodeLanguageId(module_14565.default(this).locale));
    },
    enumerable: false,
    configurable: true
  });
