// _runtime/metro/16601__.js
import _modDef16602 from "16602__.js";
...
function captureRef(current, options) {
  if (ViewShot(16602)) {
    ...
    return ViewShot(16602).captureRef(tmp15, options);
  } else {
    const _Error = Error;
...
function releaseCapture(str) {
  if (typeof str === "string") {
    ViewShot(16602).releaseCapture(str);
    const obj = ViewShot(16602);
  }
}
...
export const captureScreen = function captureScreen(options) {
  if (ViewShot(16602)) {
    ...
    return ViewShot(16602).captureScreen(options);
  } else {
    const _Error = Error;
    const error = new Error(
      "react-native-view-shot: NativeModules.RNViewShot is undefined. Make sure the library is linked on the native side.",
