...
import cloneObject_mod from "../04094_cloneObject.js";
...
export default function formatDistanceStrict(arg0, arg1, locale) {
  ...
  if (locale.formatDistance) {
    ...
    if (isNaN(defaultResult1)) {
      ...
      const result1 = (diff - (module_4008.default(defaultResult5) - module_4008.default(defaultResult4))) / c9;
      let unit;
      if (null != locale) {
        unit = locale.unit;
      }
      ...
      const defaultResult6 = module_4008.default(defaultResult5);
    }
  } else {
