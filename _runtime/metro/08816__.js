  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (points) => {
      ...
      if (points) {
        ...
        points.d = "M" + Polygon(8817)(points) + "z";
      }
      if (closure_0.root) {
...
const entry = {
  ...
  value: function render() {
    ...
    if (points) {
      const _HermesInternal = HermesInternal;
      combined = "M" + Polygon(8817)(points) + "z";
    }
    obj.d = combined;
    const merged = Object.assign(props);
    return jsx(Polygon(8812), { ref: this.refMethod, d: null });
  },
};
let items = [entry];
