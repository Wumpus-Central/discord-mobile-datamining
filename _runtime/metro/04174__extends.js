// _runtime/metro/04174__extends.js
...
export const MemoryRouter = Component2(4178).Redirect;
export const Prompt = Component2(4178).Redirect;
export const Redirect = Component2(4178).Redirect;
export const Route = Component2(4178).Route;
export const Router = Component2(4178).Router;
export const StaticRouter = Component2(4178).StaticRouter;
export const Switch = Component2(4178).Switch;
export const generatePath = Component2(4178).generatePath;
export const matchPath = Component2(4178).matchPath;
export const useHistory = Component2(4178).useHistory;
export const useLocation = Component2(4178).useLocation;
export const useParams = Component2(4178).useParams;
export const useRouteMatch = Component2(4178).useRouteMatch;
export const withRouter = Component2(4178).withRouter;
