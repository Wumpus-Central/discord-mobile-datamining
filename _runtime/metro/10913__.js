...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10774).matchAnyPattern(RUWeekdayParser(10903).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10801).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10903).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
