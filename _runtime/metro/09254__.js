// _runtime/metro/09254__.js
import _mod9250 from "09250__.js";
import QRPolynomial from "../09255_QRPolynomial.js";
import _mod9256 from "09256__.js";
...
const obj = {
  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (_mod9250.MODE_NUMBER === arg0) {
          return 10;
        } else if (tmp20(9250).MODE_ALPHA_NUM === arg0) {
          return 9;
        } else {
          if (tmp20(9250).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(9250).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (_mod9250.MODE_NUMBER === arg0) {
        return 12;
      } else if (tmp13(9250).MODE_ALPHA_NUM === arg0) {
        return 11;
      } else if (tmp13(9250).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(9250).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (_mod9250.MODE_NUMBER === arg0) {
        return 14;
      } else if (tmp6(9250).MODE_ALPHA_NUM === arg0) {
        return 13;
      } else if (tmp6(9250).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(9250).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
