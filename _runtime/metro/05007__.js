...
import get_synchronousScreenUpdatesEnabledDefault from "../04997_get_synchronousScreenUpdatesEnabled.js";
import _mod5006 from "05006__.js";
import _modDef5008 from "05008__.js";
import animatedComponentDefault from "../05009_animatedComponent.js";
import _mod5010 from "05010__.js";
import SHEET_FIT_TO_CONTENTS from "../05011_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05012_DelayedFreeze.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5006;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5006.freezeEnabled();
    const tmp2Result6 = _mod5006;
  }
  ...
  if (enabled) {
    if (_mod5006.isNativePlatformSupported) {
      ...
      obj4.fullScreenSwipeEnabled = _mod5014.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5015.Provider, { value: null, children: null });
      }
