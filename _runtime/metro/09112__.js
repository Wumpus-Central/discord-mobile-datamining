  ...
  if (__setModuleDefault) {
    ...
    exports.default = function default_1() {
      if (typeof error === "function") {
        ...
        obj = { string: { unit: "tecken", verb: "att ha" }, file: { unit: "bytes", verb: "att ha" }, array: { unit: "objekt", verb: "att inneh\u00E5lla" }, set: { unit: "objekt", verb: "att inneh\u00E5lla" } };
          ...
          switch (code.code) {
            ...
            case "too_big":
              ...
              if (tmp27) {
                ...
                let combined2 = "F\u00F6r stor(t): f\u00F6rv\u00E4ntade " + str32 + " att ha " + str31 + str + " " + str38;
              } else {
                let str33 = str32;
                if (str32 == null) {
                  str33 = "v\u00E4rdet";
