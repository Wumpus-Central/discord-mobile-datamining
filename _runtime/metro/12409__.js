...
import __SENTRY_DEBUG__ from "12312__.js";
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("12327__.js").timestampInSeconds();
      c4 = timestampInSecondsResult;
      let obj = require("12327__.js");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("12347__.js").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
