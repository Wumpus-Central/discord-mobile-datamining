...
export const useIAP = () => {
  const iAPContext = require("11217__.js").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("11202__.js").requestPurchase,
    requestSubscription: require("11202__.js").requestSubscription,
  };
};
