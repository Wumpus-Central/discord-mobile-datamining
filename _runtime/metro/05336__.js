...
import _modDef5337 from "05337__.js";
import calculateGPSValueDefault from "../05339_calculateGPSValue.js";
    ...
    for (const key10002 in arg0) {
      ...
      let item = arr2.forEach((attributes) => {
        ...
        if (typeof attributes.value === "object") {
          ParseError(5301).objectAssign(tmp3, parseNodeChildrenAsTags(attributes.value));
