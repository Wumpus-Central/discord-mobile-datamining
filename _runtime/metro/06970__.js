...
import PlatformConfig from "../06943_PlatformConfig.js";
import asyncGeneratorStep from "06971__.js";
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  dependencyMap = arg2;
  const unmountFlag = require("06972__.js").useUnmountFlag();
  let obj = require("06972__.js");
  ...
  _setTimeout = require("06973__.js").useUnmountAwareTimeout().setTimeout;
  let obj2 = require("06973__.js");
                  ...
                  if (data) {
                    if (data.length > 0) {
                      ...
                      if (!engagedIndices.includes(closure_129_2)) {
                        const obj3 = { index: closure_129_2, animated };
                        c3 = 2;
                        c4 = 1;
                        const obj4 = { value: closure_1_13.scrollToIndex(obj3), done: false };
                        return obj4;
                      }
                    }
                  }
