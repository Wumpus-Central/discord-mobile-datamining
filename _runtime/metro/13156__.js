...
function withScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = AsyncContextStack(13162).getDefaultCurrentScope();
    const tmpResult = AsyncContextStack(13162);
    stack = new _moduleResult(defaultCurrentScope, AsyncContextStack(13162).getDefaultIsolationScope());
    const tmpResult2 = AsyncContextStack(13162);
  }
...
function withIsolationScope(arg0) {
  ...
  return stack.withScope(() => {
    ...
    if (!stack) {
      const defaultCurrentScope = AsyncContextStack(13162).getDefaultCurrentScope();
      const tmp2Result = AsyncContextStack(13162);
      stack = new closure_2_3(defaultCurrentScope, AsyncContextStack(13162).getDefaultIsolationScope());
      const tmp2Result2 = AsyncContextStack(13162);
    }
    sentryCarrier.stack = stack;
  ...
  return {
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = AsyncContextStack(13162).getDefaultCurrentScope();
        const tmpResult = AsyncContextStack(13162);
        stack = new closure_1_3(defaultCurrentScope, AsyncContextStack(13162).getDefaultIsolationScope());
        const tmpResult2 = AsyncContextStack(13162);
      }
      sentryCarrier.stack = stack;
