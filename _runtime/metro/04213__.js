...
import throwProtectedError from "../04158_throwProtectedError.js";
import parsers from "../04215_parsers.js";
import code_mod from "04157__.js";
import subMilliseconds_mod from "../04144_subMilliseconds.js";
import _typeof_mod from "03911__.js";
import assign_mod from "../04161_assign.js";
import dateLongFormatter_mod from "../04156_dateLongFormatter.js";
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("03916__.js").getDefaultOptions();
  let locale1;
  if (null != locale) {
  ...
  if (locale1.match) {
    ...
    const defaultResult1 = module_3915.default(num2);
    if (defaultResult1 >= 1) {
      if (defaultResult1 <= 7) {
        let weekStartsOn;
        if (null != locale) {
        ...
        const defaultResult2 = module_3915.default(num5);
        if (defaultResult2 >= 0) {
          if (defaultResult2 <= 6) {
            if ("" === str) {
              if ("" === closure_2) {
              ...
              const dateToSystemTimezoneSetter = new tmp2(4214).DateToSystemTimezoneSetter();
