...
// Module 4213
import throwProtectedError from "throwProtectedError" /* 4158 */;
import parsers from "parsers" /* 4215 */;
...
import dateLongFormatter_mod from "dateLongFormatter" /* 4156 */;
...
export default function parse(arg0, arg1, arg2, locale) {
  ...
  const defaultOptions = require("module_3916").getDefaultOptions();
  let locale1;
  if (null != locale) {
