...
import _mod13864 from "13864__.js";
import URLSearchParamsImpl from "../13871_URLSearchParamsImpl.js";
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(
                URLSearchParams(13872).USVString(arguments[0], {
                  context: "Failed to execute 'append' on 'URLSearchParams': parameter 1",
                }),
              );
              const obj = URLSearchParams(13872);
              items.push(
                URLSearchParams(13872).USVString(arguments[1], {
