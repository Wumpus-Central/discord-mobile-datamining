...
import BottomSheetContext from "../06880_BottomSheetContext.js";
...
export default function _default(children) {
  ...
  const gestureHandler = _mod6874.useGestureHandler(
  ...
  const gestureHandler1 = _mod6874.useGestureHandler(
