...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      ...
      closure_128_0 = value.map(tmp2(11190).singleProductAndroidMap);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      ...
      await tmp2(11185).fillProductsWithAdditionalData(closure_128_2);
      closure_128_2 = value;
        ...
        if (arg0 === 1) {
          ...
          if ("skus" in closure_0) {
            if (closure_0.skus.length) {
              ...
              c1 = 3;
              obj = { value: closure_1_4.buyItemByType(inapp, skus, undefined, -1, obfuscatedAccountIdAndroid, obfuscatedProfileIdAndroid, [], c0), done: true };
              return obj;
            }
          }
          const _Error = Error;
        ...
        if (arg0 === 1) {
          ...
          if ("subscriptionOffers" in closure_0) {
            if (0 !== closure_0.subscriptionOffers.length) {
              ...
              c1 = 3;
              obj = { value: closure_1_4.buyItemByType(subs, mapped, purchaseTokenAndroid, replacementModeAndroid, obfuscatedAccountIdAndroid, obfuscatedProfileIdAndroid, mapped1, c0), done: true };
              return obj;
            }
          }
          const _Error = Error;
