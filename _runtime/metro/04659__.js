...
export const MemoryRouter = Component2(4663).MemoryRouter;
export const Prompt = Component2(4663).Prompt;
export const Redirect = Component2(4663).Redirect;
export const Route = Component2(4663).Route;
export const Router = Component2(4663).Router;
export const StaticRouter = Component2(4663).StaticRouter;
export const Switch = Component2(4663).Switch;
export const generatePath = Component2(4663).generatePath;
export const matchPath = Component2(4663).matchPath;
export const useHistory = Component2(4663).useHistory;
export const useLocation = Component2(4663).useLocation;
export const useParams = Component2(4663).useParams;
export const useRouteMatch = Component2(4663).useRouteMatch;
export const withRouter = Component2(4663).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4663).matchPath(_location.pathname, obj2);
          const obj = Component2(4663);
        }
