...
import styleDefault from "style" /* 5029 */;
...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  const effect = obj2.useEffect(() => {
    _modDef5024(false, "Dynamically changing header's visibility in modals will result in remounting the screen and losing all local state.");
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(5028).isIOS26OrHigher;
  }
  _modDef5024(isIOS26OrHigher, "[RNScreens] Using both `blurEffect` and `scrollEdgeEffects` simultaneously may cause overlapping effects.");
