...
import _modDef5335 from "05335__.js";
import calculateGPSValueDefault from "../05337_calculateGPSValue.js";
    ...
    for (const key10002 in arg0) {
      ...
      let item = arr2.forEach((attributes) => {
        ...
        if (typeof attributes.value === "object") {
          ParseError(5299).objectAssign(tmp3, parseNodeChildrenAsTags(attributes.value));
