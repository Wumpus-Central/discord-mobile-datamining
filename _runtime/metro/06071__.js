...
export const useScrollHandler = () => {
  ...
  if (scrollEventsHandlersHook === undefined) {
    useScrollEventsHandlersDefault = require("06072__.js").useScrollEventsHandlersDefault;
  }
  _require = onScroll;
