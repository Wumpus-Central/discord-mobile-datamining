// _runtime/metro/04887__.js
import { getFileChunk } from "../04884_getFileChunk.js";
import { 04885__ } from "04885__.js";
const self = this;
let self2 = this;
if (this) {
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = 04885__.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = 04885__.FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = 04885__.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
    ...
    const FileTypes4 = 04885__.FileTypes;
