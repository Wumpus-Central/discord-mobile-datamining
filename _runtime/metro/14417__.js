...
import _mod14483 from "14483__.js";
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(14483).emitUnicodeLanguageId(
              obj.__assign(Locale(1161).__assign({}, Locale(14483).parseUnicodeLanguageId(tmp2)), obj3),
            );
            ...
            if (closure_1_6(Locale(14483).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = Locale(14483).emitUnicodeLocaleId(
              ...
              if (region) {
                ...
                if (closure_1_6(Locale(14483).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = Locale(14483).emitUnicodeLocaleId(
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(14483).emitUnicodeLanguageId(
        Locale(14483).parseUnicodeLanguageId(module_14418.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
