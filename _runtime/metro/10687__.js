...
import ENDefaultConfiguration2 from "../10688_ENDefaultConfiguration.js";
...
const entry1 = {
  ...
  value: function executeParser(debug, pattern) {
    ...
    if (match) {
      ...
      } else if (!(extractResult instanceof ParsingContext(10694).ParsingComponents)) {
...
const items2 = [
  entry2,
  {
    ...
    value: function createParsingResult(sum, match, extractResult, date) {
      ...
      return new ParsingContext(10694).ParsingResult(
        self.reference,
        sum,
        substr,
        parsingComponents,
