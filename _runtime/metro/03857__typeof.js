// _runtime/metro/03857__typeof.js
import Parser2 from "../03846_Parser.js";
import setUTCWeek from "../03858_setUTCWeek.js";
import startOfUTCWeek from "../03543_startOfUTCWeek.js";
...
let items = [
  {
    ...
    value: function parse(arg0, arg1, ordinalNumber) {
      if ("w" === arg1) {
        return _createSuperInternal(3848).parseNumericPattern(_createSuperInternal(3849).numericPatterns.week, arg0);
      } else if ("wo" === arg1) {
        return ordinalNumber.ordinalNumber(arg0, { unit: "week" });
      } else {
        return _createSuperInternal(3848).parseNDigits(arg1.length, arg0);
      }
    }
  },
  {
