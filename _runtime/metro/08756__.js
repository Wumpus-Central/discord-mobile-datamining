...
import _modDef8757 from "08757__.js";
...
const entry = {
  ...
  value: function render() {
    ...
    const obj = {};
    ({ cx, cy, r } = props);
    const merged = Object.assign(Circle(8743).extract(this, props));
    obj.cx = cx;
    obj.cy = cy;
    obj.r = r;
    const obj2 = Circle(8743);
    const obj3 = {
      ref(arg0) {
