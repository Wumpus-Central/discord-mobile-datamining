// _runtime/metro/05258__.js
import _modDef5259 from "05259__.js";
import _modDef5260 from "05260__.js";
    ...
    if (tmp < byteLength.byteLength) {
      while (true) {
        ...
        if (byteLength.getUint8(tmp) !== 28) {
          ...
          obj.name = combined;
          obj.value = items;
          obj.description = getTagDescription(_modDef5259.iptc[uint16], items, obj, encoding);
          let tmp17 = _modDef5259.iptc[uint16] && _modDef5259.iptc[uint16].repeatable;
          if (tmp17) {
            obj.repeatable = true;
          }
          let tmp18 = _modDef5259.iptc[uint16] && undefined !== _modDef5259.iptc[uint16].encoding_name;
          if (tmp18) {
            let obj4 = _modDef5259.iptc[uint16];
