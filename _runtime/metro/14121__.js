  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = SemVer(14126).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = SemVer(14126);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = SemVer(14126).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = SemVer(14126);
      }
