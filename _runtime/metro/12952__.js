...
export default (arg0, arg1) => {
  if (arg0 instanceof require(12925) /* SemVer */) {
    ...
    if (typeof StringResult === "__FORMATJS_LISTFORMAT_DATA__") {
      return null;
    } else {
      let obj = arg1;
      if (!arg1) {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(12929).safeRe;
        const t2 = tmp(12929).t;
      ...
      if (null === match2) {
        ...
        return require(12924) /* SemVer */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};