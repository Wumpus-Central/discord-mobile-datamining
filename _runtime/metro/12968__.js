...
function withScope(arg0) {
  ...
  if (!stack) {
    const defaultCurrentScope = AsyncContextStack(12974).getDefaultCurrentScope();
    const tmpResult = AsyncContextStack(12974);
    stack = new _moduleResult(defaultCurrentScope, AsyncContextStack(12974).getDefaultIsolationScope());
    const tmpResult2 = AsyncContextStack(12974);
  }
...
function withIsolationScope(arg0) {
  ...
  return stack.withScope(() => {
    ...
    if (!stack) {
      const defaultCurrentScope = AsyncContextStack(12974).getDefaultCurrentScope();
      const tmp2Result = AsyncContextStack(12974);
      stack = new closure_2_3(defaultCurrentScope, AsyncContextStack(12974).getDefaultIsolationScope());
      const tmp2Result2 = AsyncContextStack(12974);
    }
    sentryCarrier.stack = stack;
  ...
  return {
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = AsyncContextStack(12974).getDefaultCurrentScope();
        const tmpResult = AsyncContextStack(12974);
        stack = new closure_1_3(defaultCurrentScope, AsyncContextStack(12974).getDefaultIsolationScope());
        const tmpResult2 = AsyncContextStack(12974);
      }
      sentryCarrier.stack = stack;
