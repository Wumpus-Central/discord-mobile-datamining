...
import emptyFunction from "04658__.js";
import warning from "../01108_warning.js";
import invariant_mod from "../01109_invariant.js";
                ...
                if (typeof resolveToLocation === "function") {
                  ...
                  if (typeof normalizeToLocation === "function") {
                    ...
                    if (typeof tmpResult === "string") {
                      const tmp5Result = Component2(1102);
...
export const MemoryRouter = Component2(4661).MemoryRouter;
export const Prompt = Component2(4661).Prompt;
export const Redirect = Component2(4661).Redirect;
export const Route = Component2(4661).Route;
export const Router = Component2(4661).Router;
export const StaticRouter = Component2(4661).StaticRouter;
export const Switch = Component2(4661).Switch;
export const generatePath = Component2(4661).generatePath;
export const matchPath = Component2(4661).matchPath;
export const useHistory = Component2(4661).useHistory;
export const useLocation = Component2(4661).useLocation;
export const useParams = Component2(4661).useParams;
export const useRouteMatch = Component2(4661).useRouteMatch;
export const withRouter = Component2(4661).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4661).matchPath(_location.pathname, obj2);
          const obj = Component2(4661);
        }
