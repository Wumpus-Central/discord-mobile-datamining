// _runtime/metro/03739__typeof.js
...
obj = {
  ...
  value: function parse(arg0, arg1) {
    if ("x" === arg1) {
      return _createSuperInternal(3707).parseTimezonePattern(_createSuperInternal(3708).timezonePatterns.basicOptionalMinutes, arg0);
    } else if ("xx" === arg1) {
      return _createSuperInternal(3707).parseTimezonePattern(_createSuperInternal(3708).timezonePatterns.basic, arg0);
    } else if ("xxxx" === arg1) {
      return _createSuperInternal(3707).parseTimezonePattern(_createSuperInternal(3708).timezonePatterns.basicOptionalSeconds, arg0);
    } else if ("xxxxx" === arg1) {
      return _createSuperInternal(3707).parseTimezonePattern(_createSuperInternal(3708).timezonePatterns.extendedOptionalSeconds, arg0);
    } else {
      return _createSuperInternal(3707).parseTimezonePattern(_createSuperInternal(3708).timezonePatterns.extended, arg0);
    }
  }
};
let items = [
