...
// Module 5120
import RNSLog2 from "RNSLog" /* 5121 */;
...
export default function TabsHost(arg0) {
  ...
  const obj2 = { style: null, navStateRequest, onTabSelected: _mod5125.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null };
  ...
  return jsx(_modDef5126, { style: null, navStateRequest, onTabSelected: _mod5125.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null });
};