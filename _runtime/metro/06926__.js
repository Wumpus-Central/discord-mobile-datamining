// _runtime/metro/06926__.js
import handlerIDToTag2 from "../06903_handlerIDToTag.js";
...
import transformIntoHandlerTags from "../06930_transformIntoHandlerTags.js";
import ghQueueMicrotask from "../06931_ghQueueMicrotask.js";
import ActionType from "../06932_ActionType.js";
...
let closure_10 = {
  [fn(6905).State.UNDETERMINED]: undefined,
  [fn(6905).State.BEGAN]: "onBegan",
  [fn(6905).State.FAILED]: "onFailed",
  [fn(6905).State.CANCELLED]: "onCancelled",
  [fn(6905).State.ACTIVE]: "onActivated",
  [fn(6905).State.END]: "onEnded",
};
