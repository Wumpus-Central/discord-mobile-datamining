...
function withScope(arg0) {
  const mainCarrier = AsyncContextStack(13072).getMainCarrier();
  const obj = AsyncContextStack(13072);
  const sentryCarrier = AsyncContextStack(13072).getSentryCarrier(mainCarrier);
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = AsyncContextStack(13080).getDefaultCurrentScope();
    const tmpResult = AsyncContextStack(13080);
    stack = new _moduleResult(defaultCurrentScope, AsyncContextStack(13080).getDefaultIsolationScope());
    const tmpResult2 = AsyncContextStack(13080);
  }
...
function withIsolationScope(arg0) {
  ...
  let stack = sentryCarrier.stack;
  if (!stack) {
    const defaultCurrentScope = tmp(13080).getDefaultCurrentScope();
    const tmpResult = tmp(13080);
    stack = new closure_3(defaultCurrentScope, tmp(13080).getDefaultIsolationScope());
    const tmpResult2 = tmp(13080);
  }
  sentryCarrier.stack = stack;
  return stack.withScope(() => {
    const mainCarrier = AsyncContextStack(13072).getMainCarrier();
    ...
    if (!stack) {
      const defaultCurrentScope = AsyncContextStack(13080).getDefaultCurrentScope();
      const tmp2Result = AsyncContextStack(13080);
      stack = new closure_2_3(defaultCurrentScope, AsyncContextStack(13080).getDefaultIsolationScope());
      const tmp2Result2 = AsyncContextStack(13080);
    }
    sentryCarrier.stack = stack;
...
export function getStackAsyncContextStrategy() {
  return {
    ...
    withSetIsolationScope(arg0, arg1) {
      closure_0 = arg1;
      let mainCarrier = closure_0(13072).getMainCarrier();
      let obj = closure_0(13072);
      let sentryCarrier = closure_0(13072).getSentryCarrier(mainCarrier);
      let stack = sentryCarrier.stack;
      if (!stack) {
        let defaultCurrentScope = tmp(13080).getDefaultCurrentScope();
        const tmpResult = tmp(13080);
        stack = new closure_3(defaultCurrentScope, tmp(13080).getDefaultIsolationScope());
        const tmpResult2 = tmp(13080);
      }
    ...
    getCurrentScope() {
      ...
      if (!stack) {
        const defaultCurrentScope = AsyncContextStack(13080).getDefaultCurrentScope();
        const tmpResult = AsyncContextStack(13080);
        stack = new closure_1_3(defaultCurrentScope, AsyncContextStack(13080).getDefaultIsolationScope());
        const tmpResult2 = AsyncContextStack(13080);
      }
      sentryCarrier.stack = stack;
