...
const memoResult = memo(function BottomSheetRefreshControlComponent(arg0) {
  ...
  dependencyMap = tmp4;
  let obj = scrollableGesture(6646);
  ...
  obj = { animatedScrollableState: iter, SCROLLABLE_STATE: scrollableGesture(6642).SCROLLABLE_STATE };
  fn.__closure = obj;
  ...
  if (tmp7) {
    ...
    let tmp8Result = jsx(scrollableGesture(6669).GestureDetector, { gesture: tmp7, children: null });
  } else {
    const obj2 = {};
