// _runtime/metro/07068__.js
import handlerIDToTag from "../06989_handlerIDToTag.js";
...
export const useGesture = function useGesture(Fling, clonedAndRemappedConfig) {
  ...
  if (clonedAndRemappedConfig.disableReanimated !== jsEventHandler(() => config.disableReanimated, [])) {
    ...
    const gestureCallbacks = require("07069__.js").useGestureCallbacks(tmp2, clonedAndRemappedConfig);
    ...
    handlerTag(() => {
      ...
      return () => {
        closure_0(7053).unbindSharedValues(dependencyMap, handlerTag);
        const obj = closure_0(7053);
        closure_0(6989).unregisterGesture(handlerTag);
      };
    }, items3);
    return tmpResult2;
  }
