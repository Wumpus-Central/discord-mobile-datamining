...
obj[33434] = { name: "ExposureTime", description: fn2(5455).ExposureTime };
const obj2 = { name: "ExposureTime", description: fn2(5455).ExposureTime };
obj[33437] = { name: "FNumber", description: fn2(5455).FNumber };
const obj3 = { name: "FNumber", description: fn2(5455).FNumber };
obj[34850] = { name: "ExposureProgram", description: fn2(5455).ExposureProgram };
obj[34856] = {
  name: "OECF",
  description() {
...
const obj4 = { name: "ExposureProgram", description: fn2(5455).ExposureProgram };
obj[37121] = { name: "ComponentsConfiguration", description: fn2(5455).ComponentsConfiguration };
const obj5 = { name: "ComponentsConfiguration", description: fn2(5455).ComponentsConfiguration };
obj[37377] = { name: "ShutterSpeedValue", description: fn2(5455).ShutterSpeedValue };
const obj6 = { name: "ShutterSpeedValue", description: fn2(5455).ShutterSpeedValue };
obj[37378] = { name: "ApertureValue", description: fn2(5455).ApertureValue };
obj[37381] = {
...
const obj7 = { name: "ApertureValue", description: fn2(5455).ApertureValue };
obj[37383] = { name: "MeteringMode", description: fn2(5455).MeteringMode };
const obj8 = { name: "MeteringMode", description: fn2(5455).MeteringMode };
obj[37384] = { name: "LightSource", description: fn2(5455).LightSource };
obj[37385] = {
  name: "Flash",
  description(arg0) {
...
const obj9 = { name: "LightSource", description: fn2(5455).LightSource };
obj[37386] = { name: "FocalLength", description: fn2(5455).FocalLength };
obj[37394] = {
...
const obj10 = { name: "FocalLength", description: fn2(5455).FocalLength };
obj[37510] = { name: "UserComment", description: fn(5457).getEncodedString };
obj[37888] = {
...
const obj11 = { name: "UserComment", description: fn(5457).getEncodedString };
obj[40961] = { name: "ColorSpace", description: fn2(5455).ColorSpace };
obj[41484] = {
...
const obj12 = { name: "ColorSpace", description: fn2(5455).ColorSpace };
obj[41488] = { name: "FocalPlaneResolutionUnit", description: fn2(5455).FocalPlaneResolutionUnit };
obj[41492] = {
...
const obj13 = { name: "FocalPlaneResolutionUnit", description: fn2(5455).FocalPlaneResolutionUnit };
obj[41985] = { name: "CustomRendered", description: fn2(5455).CustomRendered };
const obj14 = { name: "CustomRendered", description: fn2(5455).CustomRendered };
obj[41986] = { name: "ExposureMode", description: fn2(5455).ExposureMode };
const obj15 = { name: "ExposureMode", description: fn2(5455).ExposureMode };
obj[41987] = { name: "WhiteBalance", description: fn2(5455).WhiteBalance };
obj[41988] = {
...
const obj16 = { name: "WhiteBalance", description: fn2(5455).WhiteBalance };
obj[41989] = { name: "FocalLengthIn35mmFilm", description: fn2(5455).FocalLengthIn35mmFilm };
const obj17 = { name: "FocalLengthIn35mmFilm", description: fn2(5455).FocalLengthIn35mmFilm };
obj[41990] = { name: "SceneCaptureType", description: fn2(5455).SceneCaptureType };
obj[41991] = {
  name: "GainControl",
  description(arg0) {
    let str = "None";
...
const obj18 = { name: "SceneCaptureType", description: fn2(5455).SceneCaptureType };
obj[41992] = { name: "Contrast", description: fn2(5455).Contrast };
const obj19 = { name: "Contrast", description: fn2(5455).Contrast };
obj[41993] = { name: "Saturation", description: fn2(5455).Saturation };
const obj20 = { name: "Saturation", description: fn2(5455).Saturation };
obj[41994] = { name: "Sharpness", description: fn2(5455).Sharpness };
obj[41995] = {
