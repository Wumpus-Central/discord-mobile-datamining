...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = require("12899__.js").util;
    ...
    let closure_8 = fn(_mod12966);
    let closure_9 = fn(_mod12967);
    let closure_10 = fn(_mod12968);
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = {
        input: require("../12961_initializeContext.js").createStandardJSONSchemaMethod(_standard, "input"),
        output: require("../12961_initializeContext.js").createStandardJSONSchemaMethod(_standard, "output"),
      };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = require("../12961_initializeContext.js").createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
    ...
    exports.ZodObject = fnResult.$constructor("ZodObject", (_zod) => {
      ...
      let util = require("12899__.js").util;
