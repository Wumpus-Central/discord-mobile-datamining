// _runtime/metro/05079__.js
import getFileChunk from "../05076_getFileChunk.js";
import _mod5077 from "05077__.js";
import isAAC from "../05080_isAAC.js";
import is7Z from "../05081_is7Z.js";
import isAVIF from "../05082_isAVIF.js";
import isBLEND from "../05083_isBLEND.js";
import isAVI from "../05084_isAVI.js";
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      let FileTypes = _mod5077.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      ...
      let FileTypes2 = _mod5077.FileTypes;
      let tmp24 = items2;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5077.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let tmp25 = tmp20;
        let tmp26 = tmp22;
        let FileTypes3 = tmp21(5077).FileTypes;
        let tmp27 = item10079;
    ...
    const FileTypes4 = _mod5077.FileTypes;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5077.FileTypes;
