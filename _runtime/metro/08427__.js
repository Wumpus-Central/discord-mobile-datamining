...
import _mod8431 from "08431__.js";
import _mod8432 from "08432__.js";
import 08428__ from "08428__.js";
...
export default value.default.forwardRef(function SliderComponent(onSlidingComplete, ref) {
  ...
  if (defaultResult.StepMarker) {
    ...
    obj9.isLTR = tmp3;
    let jsxResult = jsxProd.jsx(tmp24(8433).StepsIndicator, { options: arr, sliderWidth: tmp17, currentValue: tmp15, renderStepNumber: null, thumbImage: null, StepMarker: null, isLTR: null });
  } else {
    jsxResult = null;
  }
