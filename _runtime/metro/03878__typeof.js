// _runtime/metro/03878__typeof.js
...
obj = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("y" === arg1) {
      ...
      return _createSuperInternal(3879).mapValue(
        _createSuperInternal(3879).parseNDigits(arg1.length, arg0),
        valueCallback,
      );
    }
  },
  ...
  },
  {
    ...
    value: function set(setUTCFullYear, era, isTwoDigitYear) {
      if (isTwoDigitYear.isTwoDigitYear) {
        setUTCFullYear.setUTCFullYear(_createSuperInternal(3879).normalizeTwoDigitYear(isTwoDigitYear.year, tmp), 0, 1);
