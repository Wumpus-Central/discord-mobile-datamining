...
import "module_12931";
import consoleSandbox from "12932__.js";
  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = _mod12939.isInstanceOf(headers, Request);
        const tmpResult = _mod12939;
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = _mod12939.isInstanceOf(headers, Headers);
        const tmpResult2 = _mod12939;
      }
