...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(clone, arg1) {
      ...
      const obj = { endTimestamp: 1000 * _mod12940.timestampInSeconds(), response };
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(errorCallback) {
  _mod12924.addHandler("fetch-body-resolved", errorCallback);
      ...
      closure_0(12932).fill(closure_0(12927).GLOBAL_OBJ, "fetch", (arg0) => {
        ...
        return () => {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj.endTimestamp = 1000 * closure_3_0(12940).timestampInSeconds();
            obj.error = error;
            ...
            if (tmp5) {
              ...
              const result = closure_3_0(12932).addNonEnumerableProperty(error, "framesToPop", 1);
              const tmpResult = closure_3_0(12932);
            }
            throw error;
          });
        };
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(errorCallback, arg1) {
  _require = arg1;
  require("12924__.js").addHandler("fetch", errorCallback);
  let obj = require("12924__.js");
  require("12924__.js").maybeInstrument("fetch", () => {
    let flag = closure_0;
