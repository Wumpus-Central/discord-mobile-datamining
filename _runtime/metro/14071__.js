...
import LRUCache from "../14072_LRUCache.js";
    ...
    value: function parseRange(str) {
      ...
      if (value) {
        ...
        let str3 = str.replace(
          tmp11(14046).safeRe[tmp11(undefined, 14046).t.COMPARATORTRIM],
          tmp11(14046).comparatorTrimReplace,
        );
        tmp11(14045)("comparator trim", str3);
        const str5 = str3.replace(
          tmp11(14046).safeRe[tmp11(undefined, 14046).t.TILDETRIM],
          tmp11(14046).tildeTrimReplace,
        );
        tmp11(14045)("tilde trim", str5);
        let str7 = str5.replace(
          tmp11(14046).safeRe[tmp11(undefined, 14046).t.CARETTRIM],
          tmp11(14046).caretTrimReplace,
        );
          ...
          if (typeof parseComparator === "function") {
            ...
            if (typeof replaceCarets === "function") {
                ...
                if (typeof replaceCaret === "function") {
                  ...
                  return item.replace(tmp6, (arg0, str, str2, str3, arg4) => {
                    ...
                    if (typeof closure_2_9 === "function") {
                      ...
                      options(14045)("caret return", str3);
                      return str3;
                    } else {
                      throw new TypeError("Trying to call a non-function");
                    }
              ...
              if (typeof replaceTildes === "function") {
                  ...
                  if (typeof replaceTilde === "function") {
                    ...
                    return item.replace(tmp5, (arg0, str, str2, str3, arg4) => {
                      ...
                      if (typeof closure_2_9 === "function") {
                          ...
                          if (typeof closure_2_9 === "function") {
                            ...
                            if (tmp6) {
                              ...
                              if (tmp7) {
                                ...
                                options(14045)("replaceTilde pr", arg4);
                                const _HermesInternal2 = HermesInternal;
                                str3 =
                                  ">=" +
                                  str +
                        ...
                        options(14045)("tilde return", str3);
                        return str3;
                      } else {
                        throw new TypeError("Trying to call a non-function");
                      }
                ...
                Range(14045)("tildes", str7);
                if (typeof replaceXRanges === "function") {
                  Range(14045)("replaceXRanges", str7, options);
                    ...
                    if (typeof replaceXRange === "function") {
                      ...
                      return str.replace(tmp5, (arg0, arg1, str, str2, str3, arg5) => {
                        ...
                        if (typeof closure_2_9 === "function") {
                          ...
                          options(14045)("xRange return", combined);
                          return combined;
                        } else {
                          throw new TypeError("Trying to call a non-function");
                        }
                  ...
                  Range(14045)("xrange", str10);
                  if (typeof replaceStars === "function") {
                    Range(14045)("replaceStars", str10, options);
                    const replaced = str10.trim().replace(Range(14046).safeRe[Range(undefined, 14046).t.STAR], "");
                    Range(14045)("stars", replaced);
                    return replaced;
                  } else {
                    throw new TypeError("Trying to call a non-function");
                  }
