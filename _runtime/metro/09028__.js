  ...
  getLengthInBits(arg0, arg1) {
    if (1 <= arg1) {
      if (arg1 < 10) {
        if (09024__.MODE_NUMBER === arg0) {
          ...
          if (tmp20(9024).MODE_8BIT_BYTE !== arg0) {
            if (tmp20(9024).MODE_KANJI !== arg0) {
              const _Error4 = Error;
    ...
    if (arg1 < 27) {
      if (09024__.MODE_NUMBER === arg0) {
        ...
        return 11;
      } else if (tmp13(9024).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp13(9024).MODE_KANJI === arg0) {
        return 10;
      } else {
        const _Error3 = Error;
      ...
      if (09024__.MODE_NUMBER === arg0) {
        ...
        return 13;
      } else if (tmp6(9024).MODE_8BIT_BYTE === arg0) {
        return 16;
      } else if (tmp6(9024).MODE_KANJI === arg0) {
        return 12;
      } else {
        const _Error2 = Error;
