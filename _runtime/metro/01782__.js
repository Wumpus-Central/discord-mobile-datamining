...
export const useAnimatedGestureHandler = function useAnimatedGestureHandler(handlers, items10) {
  _require = handlers;
  const handler = require("01783__.js").useHandler(handlers, items10);
  ...
  let event = fn;
  if (!useWeb) {
    event = require("01785__.js").useEvent(fn, ["onGestureHandlerStateChange", "onGestureHandlerEvent"], tmp4);
    const tmpResult = require("01785__.js");
  }
  return event;
};
