...
export const forSlideLeft = function forSlideLeft(next) {
  ...
  return {
    leftButtonStyle: { transform: items2 },
    rightButtonStyle: { transform: items2 },
    titleStyle: { transform: items2 },
    backgroundStyle: { transform: items2 },
  };
};
...
export const forSlideUp = function forSlideUp(next) {
  ...
  obj2.translateY = React(
    progress.interpolate({ inputRange: [0, 1], outputRange: [0, 1], extrapolate: "clamp" }),
    num,
  ).interpolate(obj3);
  const items1 = [obj2];
  return {
    leftButtonStyle: { transform: items1 },
    rightButtonStyle: { transform: items1 },
    titleStyle: { transform: items1 },
    backgroundStyle: { transform: items1 },
  };
};
