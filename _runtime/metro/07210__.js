...
let obj = {
  default: fn(7211).DefaultTransition,
  fade: fn(7211).ModalFadeTransition,
  fade_from_bottom: fn(7211).FadeFromBottomAndroid,
  fade_from_right: fn(7211).FadeFromRightAndroid,
  none: fn(7211).DefaultTransition,
  reveal_from_bottom: fn(7211).RevealFromBottomAndroid,
  scale_from_center: fn(7211).ScaleFromCenterAndroid,
  slide_from_left: fn(7211).SlideFromLeftIOS,
  slide_from_right: fn(7211).SlideFromRightIOS,
  slide_from_bottom: fn(7211).BottomSheetAndroid,
};
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7213).forModalPresentationIOS ||
