...
import parse_mod from "04663__.js";
import AsyncMode from "../04665_AsyncMode.js";
import module_4667_mod from "04667__.js";
...
let module_4667 = module_4667_mod;
if (module_4667) {
  if (typeof module_4667 === "object") {
    if ("default" in module_4667) {
      module_4667 = module_4667.default;
    }
  }
}
let c9 = 1073741823;
  ...
  class t {
    constructor() {
      ...
      tmp2.emitter = {
        ...
        off(arg0) {
              closure_0 = arg0;
              closure_1 = closure_1.filter(/* F128884 */ function() { ... });
            },
        get() {
              return value;
            },
...
export const withRouter = function withRouter(displayName) {
  ...
  return module_4667(fn, displayName);
};