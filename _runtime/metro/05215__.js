...
export default function TabsHost(arg0) {
  ...
  const obj2 = { style: null, navStateRequest, onTabSelected: _mod5220.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null };
  ...
  return jsx(_modDef5221, { style: null, navStateRequest, onTabSelected: _mod5220.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null });
};