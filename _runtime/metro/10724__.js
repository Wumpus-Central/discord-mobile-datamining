...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      UKWeekdayParser(10560).matchAnyPattern(UKWeekdayParser(10714).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return UKWeekdayParser(10587).createParsingComponentsAtWeekday(
        reference.reference,
        UKWeekdayParser(10714).WEEKDAY_DICTIONARY[arg1[2].toLocaleLowerCase()],
        str2,
      );
    },
  },
