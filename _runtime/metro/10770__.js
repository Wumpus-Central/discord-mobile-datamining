...
// Module 10770
import alphaNum from "alphaNum" /* 10762 */;
...
const items = [
  entry,
  {
    ...
    value: function extract(reference, arg1) {
      ...
      if (undefined !== tmp3) {
        parsingComponentsAtWeekday = JPWeekdayWithParenthesesParser(10719).createParsingComponentsAtWeekday(reference.reference, tmp3);
      }
