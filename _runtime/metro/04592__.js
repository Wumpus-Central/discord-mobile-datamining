...
import _mod4593 from "04593__.js";
...
export const useRiveProperty = function useRiveProperty(instance, FillColor, f31439) {
  closure_0 = instance;
  closure_1 = FillColor;
  closure_2 = f31439;
  let tmp = hasOwnProperty(undefined);
  const items = [instance, FillColor];
  const disposableMemo = _mod4593.useDisposableMemo(
    () => {
      if (closure_0) {
