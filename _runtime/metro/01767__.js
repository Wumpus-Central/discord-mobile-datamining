  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(targetOriginX) {
            ...
            if (Array.isArray(tmp2.animations.transform)) {
              ...
              let item = transform.forEach((item, index) => {
                ...
                for (const item10011 of keys) {
                  ...
                  let obj3 = {};
                  obj3[item10011] = delayFunction(
                    delay,
                    obj.withSequence(arg0[item10011], obj2.withTiming(num, { duration: 0 })),
                  );
        ...
        for (const item10093 of keys2) {
          if ("transform" === item10093) {
            ...
            if (Array.isArray(tmp.animations.transform)) {
              ...
              let item1 = transform1.forEach((item, index) => {
                ...
                for (const item10011 of keys) {
                  ...
                  let obj3 = {};
                  let obj4 = { duration };
                  obj3[item10011] = delayFunction(sum, obj.withSequence(obj2.withTiming(num, obj4), arg0[item10011]));
                  let arr = transform.push(obj3);
                  continue;
                }
              });
            ...
            obj[item10093] = delayFunction(
              obj,
              obj5.withSequence(
                obj6.withTiming(tmp.initialValues[item10093], { duration: 0 }),
                tmp.animations[item10093],
              ),
            );
          }
          continue;
        ...
        size.originY = delayFunction(
          sum1,
          delayFunction(callbackV[6]).withTiming(targetOriginX.targetOriginY, { duration }),
        );
        ...
        size.width = delayFunction(
          sum2,
          delayFunction(callbackV[6]).withTiming(targetOriginX.targetWidth, { duration }),
        );
        ...
        size.height = delayFunction(
          sum3,
          delayFunction(callbackV[6]).withTiming(targetOriginX.targetHeight, { duration }),
        );
      ...
      fn.__closure = {
        ...
        delayFunction,
        delay,
        withSequence: EntryExitTransition(1709).withSequence,
        withTiming: EntryExitTransition(1709).withTiming,
        exitingDuration: duration,
        logger: EntryExitTransition(1641).logger,
        callback: callbackV,
      };
