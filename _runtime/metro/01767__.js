  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(originX) {
        ...
        const size = {
          originX: delayFunction(
            delay,
            delayFunction(1710).withTiming(originX.targetOriginX, { duration: num, easing: obj.easingX }),
          ),
          originY: null,
          width: null,
          height: null,
        ...
        size.originY = delayFunction(
          delay,
          delayFunction(1710).withTiming(originX.targetOriginY, { duration: num, easing: obj.easingY }),
        );
        const obj4 = { duration: num, easing: obj.easingY };
        const obj5 = delayFunction(1710);
        size.width = delayFunction(
          delay,
          delayFunction(1710).withTiming(originX.targetWidth, { duration: num, easing: obj.easingWidth }),
        );
        const obj6 = { duration: num, easing: obj.easingWidth };
        const obj7 = delayFunction(1710);
        size.height = delayFunction(
          delay,
          delayFunction(1710).withTiming(originX.targetHeight, { duration: num, easing: obj.easingHeight }),
        );
        obj.animations = size;
      ...
      fn.__closure = {
        delayFunction,
        delay,
        withTiming: CurvedTransition(1710).withTiming,
        duration: num,
        easing,
        callback: callbackV,
      };
