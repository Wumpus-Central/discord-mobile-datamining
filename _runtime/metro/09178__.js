...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    let closure_10 = fn(require("09177__.js"));
    ...
    let obj = {
      enumerable: true,
      get() {
        return require("09177__.js").clone;
      },
    };
      ...
      _zod.implement = (fn) => {
        ...
        if (typeof fn !== "function") {
          ...
          return function () {
            ...
            let parsed = items;
            if (_def._def.input) {
              parsed = _mod9175.parse(_def._def.input, items);
            }
            const applyResult = Reflect.apply(_def, this, parsed);
            let parsed1 = applyResult;
            if (_def._def.output) {
              parsed1 = _mod9175.parse(_def._def.output, applyResult);
            }
            return parsed1;
          };
        }
