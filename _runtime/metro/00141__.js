// _runtime/metro/00141__.js
import _possibleConstructorReturnDefault from "00093__possibleConstructorReturn.js";
import _modDef124 from "00124__.js";
...
_inherits(ReadOnlyElement, require("00131__.js"));
const items = [
  {
    ...
    get() {
      return ReadOnlyElement(131).getChildNodes(
        this,
        (nodeType) => nodeType.nodeType === require("00131__.js").ELEMENT_NODE,
      ).length;
    },
  },
  {
    ...
    get() {
      ...
      return obj.createHTMLCollection(
        ReadOnlyElement(131).getChildNodes(
          this,
          (nodeType) => nodeType.nodeType === require("00131__.js").ELEMENT_NODE,
        ),
      );
  ...
  },
  {
    key: "nodeType",
    get() {
      return require("00131__.js").ELEMENT_NODE;
    },
  },
  {
    key: "nodeValue",
  ...
  },
  {
    ...
    value: function hasPointerCapture(nativeElementReference) {
      ...
      if (hasPointerCaptureResult) {
        hasPointerCaptureResult = require("NativeDOMCxx").hasPointerCapture(
...
export const getBoundingClientRect = function _getBoundingClientRect(c5, includeTransform) {
  ...
  if (null != nativeElementReference) {
    const boundingClientRect = require("NativeDOMCxx").getBoundingClientRect(
      nativeElementReference,
      includeTransform.includeTransform,
    );
    const tmp12 = new _modDef124(
      boundingClientRect[0],
      boundingClientRect[1],
      boundingClientRect[2],
      boundingClientRect[3],
