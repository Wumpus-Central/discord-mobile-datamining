...
export const createEventEnvelopeHeaders = function createEventEnvelopeHeaders(event_id, sdk, arg2, url) {
  ...
  let tmp4 = arg2 && url;
  if (tmp4) {
    const obj3 = { dsn: _mod13095.dsnToString(url) };
    tmp4 = obj3;
  }
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    function readJson() {
      ...
      if (_mod13049.GLOBAL_OBJ.__SENTRY__) {
        if (_mod13049.GLOBAL_OBJ.__SENTRY__.decodePolyfill) {
          const __SENTRY__ = _mod13049.GLOBAL_OBJ.__SENTRY__;
    ...
    let encodePolyfill = dependencyMap;
    if (!require("13049__.js").GLOBAL_OBJ.__SENTRY__) {
      const _TextEncoder = TextEncoder;
      const encoder = new TextEncoder();
  ...
  function append(json) {
    if (typeof sum === "string") {
      if (typeof json === "string") {
        ...
        if (_mod13049.GLOBAL_OBJ.__SENTRY__) {
          if (_mod13049.GLOBAL_OBJ.__SENTRY__.encodePolyfill) {
            const __SENTRY__2 = _mod13049.GLOBAL_OBJ.__SENTRY__;
