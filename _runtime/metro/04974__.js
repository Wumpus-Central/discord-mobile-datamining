...
import get_synchronousScreenUpdatesEnabledDefault from "../04964_get_synchronousScreenUpdatesEnabled.js";
import _mod4973 from "04973__.js";
import _modDef4975 from "04975__.js";
import animatedComponentDefault from "../04976_animatedComponent.js";
import _mod4977 from "04977__.js";
import SHEET_FIT_TO_CONTENTS from "../04978_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../04979_DelayedFreeze.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (enabled) {
    if (_mod4973.isNativePlatformSupported) {
      ...
      obj.fullScreenSwipeEnabled = _mod4981.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      obj.iosOrientationInheritanceFixEnabled =
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef4982.Provider, { value: null, children: null });
      }
