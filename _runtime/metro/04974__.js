...
import { readTag } from "../04949_readTag.js";
import { importDefaultResult1 } from "../04950_importDefaultResult1.js";
const require = arg1;
const module = arg2;
    ...
    if (ifd.MPEntry) {
      ...
      if (0 < Math.ceil(ifd.MPEntry.value.length / c3)) {
        while (true) {
          ...
          let obj3 = module(4946);
          let typeSize = obj3.getTypeSize("LONG");
          let tmp10 = num13;
          if (byteOrder === module(4934).LITTLE_ENDIAN) {
            let num17 = 0;
            let num18 = 0;
            let num19 = 0;
            if (0 < typeSize) {
        ...
        const typeSize4 = module(4946).getTypeSize("LONG");
        if (byteOrder === module(4934).LITTLE_ENDIAN) {
          let num30 = 0;
          let num31 = 0;
          let num32 = 0;
