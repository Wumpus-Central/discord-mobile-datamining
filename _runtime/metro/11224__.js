...
export const useIAP = () => {
  const iAPContext = require("11225__.js").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("11210__.js").requestPurchase,
    requestSubscription: require("11210__.js").requestSubscription,
  };
};
