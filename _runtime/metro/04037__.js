...
ExtendedYearParser.prototype = Object.create(prototype, {
  constructor: { value: ExtendedYearParser, writable: true, configurable: true },
});
if (Parser) {
...
const entry = {
  ...
  value: function parse(arg0, arg1) {
    if ("u" === arg1) {
      let parseNDigitsSignedResult = _createSuperInternal(4033).parseNDigitsSigned(4, arg0);
    } else {
      parseNDigitsSignedResult = _createSuperInternal(4033).parseNDigitsSigned(arg1.length, arg0);
    }
