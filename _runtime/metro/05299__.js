...
import _modDef5300 from "05300__.js";
import calculateGPSValueDefault from "../05302_calculateGPSValue.js";
...
function parseNodeAsSimpleRdfDescription(attributes, key10005) {
  ...
  ParseError(5264).objectAssign(obj, obj, obj);
...
function parseNodeAsStructureRdfDescription(value, key10005) {
  ...
  if (undefined !== value.value["rdf:Description"]) {
    ...
    ParseError(5264).objectAssign(obj.attributes, obj);
