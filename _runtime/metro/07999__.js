...
import extractPropsDefault from "../07916_extractProps.js";
import extractFontDefault from "../07923_extractFont.js";
import _modDef7925 from "07925__.js";
import _modDef8002 from "08002__.js";
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(
        ...
        Text(7917).pickNotNil(extractFontDefault(propsAndStylesResult, true)),
      );
      if (closure_0.root) {
        const root = closure_0.root;
        root.setNativeProps(propsAndStylesResult);
      }
      const obj2 = Text(7917);
    };
    return tmp3Result;
  }
}
