...
import get_synchronousScreenUpdatesEnabledDefault from "../04998_get_synchronousScreenUpdatesEnabled.js";
import _mod5007 from "05007__.js";
import _modDef5009 from "05009__.js";
import animatedComponentDefault from "../05010_animatedComponent.js";
import _mod5011 from "05011__.js";
import SHEET_FIT_TO_CONTENTS from "../05012_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05013_DelayedFreeze.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5007;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5007.freezeEnabled();
    const tmp2Result6 = _mod5007;
  }
  ...
  if (enabled) {
    if (_mod5007.isNativePlatformSupported) {
      ...
      obj4.fullScreenSwipeEnabled = _mod5015.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5016.Provider, { value: null, children: null });
      }
