// _runtime/metro/04597__.js
import c from "../04579_c.js";
import _mod4592 from "04592__.js";
import _slicedToArray from "00032__.js";

const RiveColor2 = tmp(4587);
require = fn;
fn(19).useCallback;
const f31439 = (colorProperty, arg1) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(FillColor, instance) {
  const cResult = c.c(8);
  const tmp4 = _slicedToArray(_mod4592.useRiveProperty(instance, FillColor, f31439), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
