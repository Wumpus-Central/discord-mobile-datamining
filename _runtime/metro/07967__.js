...
function SceneView(arg0) {
  ...
  const callback = obj2.useCallback(num6(7968).debounce(tmp18, 100), []);
  ...
  let eventResult;
  const headerConfigProps = num6(7969).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(7969);
  obj14.children = closure_10(num6(5681).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5681).HeaderShownContext.Provider, obj14);
  obj7.children = items5;
  obj6.children = closure_11(num6(5681).HeaderHeightContext.Provider, obj7);
  obj4.children = closure_10(num6(7971).AnimatedHeaderHeightContext.Provider, obj6);
  obj3.children = closure_10(num6(4957).ScreenStackItem, obj4);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  let obj = require("07972__.js");
  const setNextDismissedKey = obj.useDismissedRouteError(state).setNextDismissedKey;
  const invalidPreventRemoveError = require("07973__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("07973__.js");
  const modalRouteKeys = require("07974__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05681__.js").SafeAreaProviderCompat, obj);
};
