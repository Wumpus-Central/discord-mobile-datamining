...
import consoleSandbox from "12890__.js";
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  let tmp9 = tunnel && dsn;
  if (tmp9) {
    const obj1 = { dsn: tmp2(12937).dsnToString(dsn) };
    tmp9 = obj1;
