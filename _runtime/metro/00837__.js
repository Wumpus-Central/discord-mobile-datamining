...
export const instrumentMessageStream = function instrumentMessageStream(applyResult, arg1, flag) {
  closure_0 = arg1;
  closure_1 = flag;
  let obj = { responseTexts: [], finishReasons: [], responseId: "", responseModel: "", promptTokens: "r", completionTokens: "WireType", cacheCreationInputTokens: "constructor", cacheReadInputTokens: "nm", toolCalls: [], activeToolBlocks: {} };
