...
export const Header = function Header(layout) {
  ...
  const defaultHeaderHeight = require("05822__.js").getDefaultHeaderHeight(layout, tmp9, headerStatusBarHeight);
  if (!headerStyle) {
    headerStyle = {};
  }
  ...
  if (!tmp7) {
    ...
    if ("left" === str) {
      ...
      if (headerSearchBarOptions) {
        ...
        const obj25 = { source: require("05804__.js"), tintColor: text };
