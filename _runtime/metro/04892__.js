...
import warnOnceDefault from "../04874_warnOnce.js";
...
export default importAllResult.forwardRef(function ScreenStackItem(unstable_sheetFooter, ref) {
  ...
  dependencyMap = flag4.useContext(screenId(4890).RNSScreensRefContext);
  ...
  if (tmp18Result) {
    ...
    tmp18Result = tmp18(tmp2(4896).FooterComponent, obj1);
  }
