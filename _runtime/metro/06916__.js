...
const memoResult = memo(function BottomSheetRefreshControlComponent(arg0) {
  ...
  dependencyMap = tmp4;
  let obj = scrollableGesture(6703);
  ...
  obj = { animatedScrollableState: iter, SCROLLABLE_STATE: scrollableGesture(6699).SCROLLABLE_STATE };
  fn.__closure = obj;
  ...
  if (tmp7) {
    ...
    let tmp8Result = jsx(scrollableGesture(6726).GestureDetector, { gesture: tmp7, children: null });
  } else {
    const obj2 = {};
