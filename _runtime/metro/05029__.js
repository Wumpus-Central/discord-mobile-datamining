// _runtime/metro/05029__.js
import _modDef5007 from "05007__.js";
import _modDef5026 from "05026__.js";
import styleDefault from "../05031_style.js";
...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  dependencyMap = flag5.useContext(screenId(5027).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(5030).isIOS26OrHigher;
  }
  _modDef5026(
    isIOS26OrHigher,
  ...
  if (screenId(5030).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(screenId(5034).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(screenId(5036).FooterComponent, obj7);
  }
