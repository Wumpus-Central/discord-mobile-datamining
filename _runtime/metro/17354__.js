    ...
    obj.pattern = str.replace(obj, (str) => {
      switch (str.charAt(0)) {
        case "E":
          ...
          obj.weekday = closure_2.weekday[diff];
          return "{weekday}";
        case "e":
          diff = str.length - 1;
          obj.weekday = closure_2.weekday[diff];
        ...
        case "M":
          ...
          obj.month = closure_2.month[diff1];
          return "{month}";
        case "L":
          diff1 = str.length - 1;
          obj.month = closure_2.month[diff1];
  ...
  if (keys !== undefined) {
    ...
    while (keys[tmp] !== undefined) {
      ...
      if (hasOwnPropertyResult) {
        ...
        if (!regex.test(str4)) {
          obj = {};
          obj.pattern = str4.replace(obj, (str) => {
            switch (str.charAt(0)) {
              case "E":
                let diff = str.length - 1;
                obj.weekday = closure_2.weekday[diff];
      ...
      if (0 < items2.length) {
        do {
          ...
          if (!regex.test(str9)) {
            obj = {};
            closure_129_0 = obj;
            obj.pattern = str9.replace(obj, (str) => {
              switch (str.charAt(0)) {
                case "E":
                  let diff = str.length - 1;
                  obj.weekday = closure_2.weekday[diff];
    ...
    while (keys1[0] !== undefined) {
      ...
      if (hasOwnPropertyResult1) {
        ...
        if (!regex.test(str15)) {
          let obj1 = {};
          closure_130_0 = obj1;
          obj1.pattern = str15.replace(obj, (str) => {
            switch (str.charAt(0)) {
              case "E":
                let diff = str.length - 1;
                obj.weekday = closure_2.weekday[diff];
    ...
    while (keys2[0] !== undefined) {
      ...
      if (hasOwnPropertyResult2) {
        ...
        if (!regex.test(str21)) {
          let obj2 = {};
          closure_131_0 = obj2;
          obj2.pattern = str21.replace(obj, (str) => {
            switch (str.charAt(0)) {
              case "E":
                let diff = str.length - 1;
                obj.weekday = closure_2.weekday[diff];
