...
export const Header = function Header(layout) {
  ...
  const defaultHeaderHeight = require("05666__.js").getDefaultHeaderHeight(layout, tmp9, headerStatusBarHeight);
  if (!headerStyle) {
    headerStyle = {};
  }
  ...
  if (!tmp7) {
    ...
    if ("left" === str) {
      ...
      if (headerSearchBarOptions) {
        ...
        const obj18 = { source: require("05648__.js"), tintColor: text };
