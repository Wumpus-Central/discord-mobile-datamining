// _runtime/metro/13571__.js
import _createClass from "00042__createClass.js";
import LRUCache from "../13572_LRUCache.js";
    ...
    value: function parseRange(str) {
      ...
      if (value) {
        ...
        let str3 = str.replace(
          tmp11(13546).safeRe[tmp11(undefined, 13546).t.COMPARATORTRIM],
          tmp11(13546).comparatorTrimReplace,
        );
        tmp11(13545)("comparator trim", str3);
        const str5 = str3.replace(
          tmp11(13546).safeRe[tmp11(undefined, 13546).t.TILDETRIM],
          tmp11(13546).tildeTrimReplace,
        );
        tmp11(13545)("tilde trim", str5);
        let str7 = str5.replace(
          tmp11(13546).safeRe[tmp11(undefined, 13546).t.CARETTRIM],
          tmp11(13546).caretTrimReplace,
        );
