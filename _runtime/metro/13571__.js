...
import LRUCache from "LRUCache" /* 13572 */;
  ...
  },
  {
    ...
    value: function parseRange(str) {
      ...
      if (FLAG_INCLUDE_PRERELEASE) {
        FLAG_INCLUDE_PRERELEASE = self(13544).FLAG_INCLUDE_PRERELEASE;
      }
      let FLAG_LOOSE = self.options.loose;
      if (FLAG_LOOSE) {
        FLAG_LOOSE = self(13544).FLAG_LOOSE;
      }
      ...
      if (value) {
        ...
        tmp11(13545)("hyphen replace", str);
        let str3 = str.replace(tmp11(13546).safeRe[tmp11(undefined, 13546).t.COMPARATORTRIM], tmp11(13546).comparatorTrimReplace);
        tmp11(13545)("comparator trim", str3);
        const str5 = str3.replace(tmp11(13546).safeRe[tmp11(undefined, 13546).t.TILDETRIM], tmp11(13546).tildeTrimReplace);
        tmp11(13545)("tilde trim", str5);
        let str7 = str5.replace(tmp11(13546).safeRe[tmp11(undefined, 13546).t.CARETTRIM], tmp11(13546).caretTrimReplace);
        tmp11(13545)("caret trim", str7);
        let parts = str7.split(" ");
        let mapped = parts.map((item) => {
          const options = self.options;
          if (typeof parseComparator === "function") {
            Range(13545)("comp", item, options);
            if (typeof replaceCarets === "function") {
              const parts = item.trim().split(/\s+/);
              const mapped = parts.map((item) => {
                if (typeof replaceCaret === "function") {
                  closure_0 = item;
                  self(13545)("caret", item, options);
                  const safeRe = self(13546).safeRe;
                  const t = self(13546).t;
                  if (options.loose) {
                  ...
                  return item.replace(tmp6, (arg0, str, str2, str3, arg4) => {
                    options(13545)("caret", closure_0, arg0, str, str2, str3, arg4);
                    if (typeof closure_2_9 === "function") {
                      ...
                      options(13545)("caret return", str3);
                      return str3;
                    } else {
                      throw new TypeError("Trying to call a non-function");
                    }
              ...
              if (typeof replaceTildes === "function") {
                ...
                const mapped1 = parts1.map((item) => {
                  if (typeof replaceTilde === "function") {
                    ...
                    return item.replace(tmp5, (arg0, str, str2, str3, arg4) => {
                      options(13545)("tilde", closure_0, arg0, str, str2, str3, arg4);
                      if (typeof closure_2_9 === "function") {
                        let tmp5 = !str;
                        if (str) {
                          tmp5 = "x" === str.toLowerCase();
                          ...
                          if (typeof closure_2_9 === "function") {
                            ...
                            if (tmp6) {
                              ...
                              if (tmp7) {
                                ...
                                options(13545)("replaceTilde pr", arg4);
                                const _HermesInternal2 = HermesInternal;
                        ...
                        options(13545)("tilde return", str3);
                        return str3;
                      } else {
                        throw new TypeError("Trying to call a non-function");
                      }
                ...
                Range(13545)("tildes", str7);
                if (typeof replaceXRanges === "function") {
                  Range(13545)("replaceXRanges", str7, options);
                  ...
                  const mapped2 = parts2.map((item) => {
                    if (typeof replaceXRange === "function") {
                      ...
                      return str.replace(tmp5, (arg0, arg1, str, str2, str3, arg5) => {
                        let combined = arg0;
                        str = arg1;
                        options(13545)("xRange", str, arg0, arg1, str, str2, str3, arg5);
                        if (typeof closure_2_9 === "function") {
                          let tmp6 = !str;
                          if (str) {
                          ...
                          options(13545)("xRange return", combined);
                          return combined;
                        } else {
                          throw new TypeError("Trying to call a non-function");
                        }
                  ...
                  Range(13545)("xrange", str10);
                  if (typeof replaceStars === "function") {
                    Range(13545)("replaceStars", str10, options);
                    const replaced = str10.trim().replace(Range(13546).safeRe[Range(undefined, 13546).t.STAR], "");
                    Range(13545)("stars", replaced);
                    return replaced;
                  } else {
                    throw new TypeError("Trying to call a non-function");
                  }
        ...
        let mapped1 = parts1.map((item) => {
          ...
          if (typeof replaceGTE0 === "function") {
            Range(13545)("replaceGTE0", item, options);
            const t = Range(13546).t;
            return item.trim().replace(Range(13546).safeRe[options.includePrerelease ? t.GTE0PRE : t.GTE0], "");
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        });
        ...
        if (loose) {
          found = mapped1.filter((item) => {
            Range(13545)("loose invalid filter", item, self.options);
            return item.match(Range(13546).safeRe[Range(undefined, 13546).t.COMPARATORLOOSE]);
          });
        }
        tmp11(13545)("range list", found);
        const _Map = Map;
        const map = new Map();
        let mapped2 = found.map((item) => new Range(13570)(item, self.options));
    ...
    value: function test(prerelease) {
      ...
      if (prerelease) {
        ...
        if (typeof tmp === "string") {
          try {
            tmp = new Range(13542)(tmp, self.options);
          } catch (err) {
            return false;
          }
        }
...
function testSet(arg0, prerelease, options) {
  ...
  if (prerelease.prerelease.length) {
    if (!options.includePrerelease) {
      ...
      if (0 < arg0.length) {
        while (true) {
          let tmp5 = Range(13545)(arg0[num2].semver);
          if (arg0[num2].semver !== Range(13570).ANY) {
