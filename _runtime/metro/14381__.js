...
import URLSearchParamsImpl from "../14382_URLSearchParamsImpl.js";
  ...
  next: {
    value: function next() {
      ...
      if (index >= arr.length) {
        ...
        tmp3.index = index + 1;
        [tmp7, tmp8] = _slicedToArray(arr[index].map(_mod14375.tryWrapperForImpl), 2);
        if ("key" === kind) {
          let tmp4 = tmp7;
        } else if ("value" === kind) {
          tmp4 = tmp8;
...
let closure_6 = Object.create(_mod14375.IteratorPrototype, exports);
exports = {
  _mixedIntoPredicates: [],
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod14375.implSymbol)) {
        if (arg0[_mod14375.implSymbol] instanceof URLSearchParamsImpl.implementation) {
          return true;
        }
      }
  ...
  createDefaultIterator(self, key) {
    ...
    value.value = value;
    Object.defineProperty(value, _mod14375.iterInternalSymbol, value);
    return value;
  },
  ...
  setup(wrapper, arg1) {
    ...
    if (URLSearchParamsImpl.init) {
      URLSearchParamsImpl.init(wrapper[_mod14375.implSymbol], obj);
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(
                URLSearchParams(14383).USVString(arguments[0], {
                  context: "Failed to execute 'append' on 'URLSearchParams': parameter 1",
                }),
              );
              obj = URLSearchParams(14383);
              items.push(
                URLSearchParams(14383).USVString(arguments[1], {
              ...
              if (arguments.length < 1) {
                ...
                if (0 < arr.length) {
                  do {
                    ...
                    let _Array = Array;
                    arr = Array.from(self[URLSearchParams(undefined, 14375).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr;
