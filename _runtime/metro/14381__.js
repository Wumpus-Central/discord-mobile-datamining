...
let items = [
  ...
  },
  {
    ...
    value: function compare(tmp2Result) {
      const self = this;
      SemVer(14384)("SemVer.compare", this.version, this.options, tmp2Result);
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      let compareIdentifiersResult = SemVer(14386).compareIdentifiers(self.major, tmpResult.major);
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = SemVer(14386).compareIdentifiers(self.minor, tmpResult.minor);
        const tmp3Result = SemVer(14386);
      }
      if (!compareIdentifiersResult) {
        compareIdentifiersResult = SemVer(14386).compareIdentifiers(self.patch, tmpResult.patch);
        const tmp3Result2 = SemVer(14386);
      }
  ...
  },
  {
    ...
    value: function comparePre(tmp2Result) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14384)("prerelease compare", num3, tmp3, tmp4);
  ...
  },
  {
    ...
    value: function compareBuild(dependencyMap) {
      ...
      while (true) {
        ...
        let tmp10 = SemVer(14384)("build compare", num, tmp3, tmp4);
        let tmp11 = undefined === tmp3;
        if (tmp11) {
          if (undefined === tmp4) {
            break;
