...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10573).matchAnyPattern(RUWeekdayParser(10702).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10600).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10702).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
