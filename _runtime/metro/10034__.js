...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(9895).matchAnyPattern(RUWeekdayParser(10024).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(9922).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10024).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
