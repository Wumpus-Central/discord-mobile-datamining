...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("08330__.js").container, require("08330__.js").webView, style];
  const items4 = [require("08330__.js").container, containerStyle];
