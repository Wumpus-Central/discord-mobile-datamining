...
import TransitionGenerator from "TransitionGenerator" /* 1725 */;
...
function startWebLayoutAnimation(props, _componentDOMRef, ENTERING, easingY) {
  ...
  if (entering) {
    ...
    let flag = !(animationWithInitialValues in TransitionType.Animations) && !(ENTERING === _mod1662.LayoutAnimationType.LAYOUT || tmp5 || undefined !== entering.initialValues);
    if (flag) {
