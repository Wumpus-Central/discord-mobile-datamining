...
export const MemoryRouter = Component2(4588).MemoryRouter;
export const Prompt = Component2(4588).Prompt;
export const Redirect = Component2(4588).Redirect;
export const Route = Component2(4588).Route;
export const Router = Component2(4588).Router;
export const StaticRouter = Component2(4588).StaticRouter;
export const Switch = Component2(4588).Switch;
export const generatePath = Component2(4588).generatePath;
export const matchPath = Component2(4588).matchPath;
export const useHistory = Component2(4588).useHistory;
export const useLocation = Component2(4588).useLocation;
export const useParams = Component2(4588).useParams;
export const useRouteMatch = Component2(4588).useRouteMatch;
export const withRouter = Component2(4588).withRouter;
    ...
    if (typeof resolveToLocation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        if (replaced) {
          ...
          matchPathResult = Component2(4588).matchPath(_location.pathname, obj2);
          const obj = Component2(4588);
        }
