// _runtime/metro/07104__.js
import tagMessage2 from "../06990_tagMessage.js";
...
import GestureObjects2 from "../07105_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(7086).gestureToPressableEvent(handlerTag));
