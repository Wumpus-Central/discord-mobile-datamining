...
_inherits(ServerRuntimeClient, _mod13200.BaseClient);
const entry = {
  key: "eventFromException",
  value: function eventFromException(arg0, arg1) {
    const result = ServerRuntimeClient(13205).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
    result.level = "error";
    const obj = ServerRuntimeClient(13205);
    return ServerRuntimeClient(13169).resolvedSyncPromise(result);
  }
};
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(13169);
      return obj.resolvedSyncPromise(ServerRuntimeClient(13205).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(13172).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(13172);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new ServerRuntimeClient(13198).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (ServerRuntimeClient(13173).DEBUG_BUILD) {
        const logger = ServerRuntimeClient(13145).logger;
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(13206);
          ...
          if (ServerRuntimeClient(13173).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(13145).logger;
      ...
      checkInId = ServerRuntimeClient(13156).uuid4();
      const obj = ServerRuntimeClient(13156);
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(13167)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = ServerRuntimeClient(13150).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = ServerRuntimeClient(13150);
        } else {
          spanToTraceContextResult = ServerRuntimeClient(13172).getTraceContextFromScope(arg0);
          const tmpResult3 = ServerRuntimeClient(13172);
        }
        const tmpResult4 = ServerRuntimeClient(13181);
        if (_getSpanForScopeResult) {
