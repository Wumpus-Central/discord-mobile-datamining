...
import handlerIDToTag2 from "../06760_handlerIDToTag.js";
import tagMessage from "../06761_tagMessage.js";
import _mod6778 from "06778__.js";
...
import ActionType from "../06789_ActionType.js";
...
let closure_10 = {
  [fn(6762).State.UNDETERMINED]: undefined,
  [fn(6762).State.BEGAN]: "onBegan",
  [fn(6762).State.FAILED]: "onFailed",
  [fn(6762).State.CANCELLED]: "onCancelled",
  [fn(6762).State.ACTIVE]: "onActivated",
  [fn(6762).State.END]: "onEnded",
};
