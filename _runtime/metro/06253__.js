...
import ScrollableContainer from "../06255_ScrollableContainer.js";
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const scrollHandler1 = _mod6045.useScrollHandler(
      scrollEventsHandlersHook,
      onScroll,
      onScrollBeginDrag,
      onScrollEndDrag,
    ...
    const scrollableSetter = _mod6045.useScrollableSetter(
      scrollableRef,
      SCROLLVIEW,
