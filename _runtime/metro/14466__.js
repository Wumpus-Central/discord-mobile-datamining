// _runtime/metro/14466__.js
import _mod14460 from "14460__.js";
import URLSearchParamsImpl from "../14467_URLSearchParamsImpl.js";
  ...
  next: {
    value: function next() {
      ...
      if (index >= arr.length) {
        ...
        tmp3.index = index + 1;
        [tmp7, tmp8] = _slicedToArray(arr[index].map(_mod14460.tryWrapperForImpl), 2);
        if ("key" === kind) {
          let tmp4 = tmp7;
        } else if ("value" === kind) {
          tmp4 = tmp8;
...
let closure_6 = Object.create(_mod14460.IteratorPrototype, exports);
exports = {
  _mixedIntoPredicates: [],
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, _mod14460.implSymbol)) {
        if (arg0[_mod14460.implSymbol] instanceof URLSearchParamsImpl.implementation) {
          return true;
        }
      }
  ...
  createDefaultIterator(self, key) {
    ...
    value.value = value;
    Object.defineProperty(value, _mod14460.iterInternalSymbol, value);
    return value;
  },
  ...
  setup(wrapper, arg1) {
    ...
    Object.defineProperty(wrapper, _mod14460.implSymbol, obj);
    wrapper[_mod14460.implSymbol][_mod14460.wrapperSymbol] = wrapper;
    if (URLSearchParamsImpl.init) {
      URLSearchParamsImpl.init(wrapper[_mod14460.implSymbol], obj);
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(
                URLSearchParams(14468).USVString(arguments[0], {
                  context: "Failed to execute 'append' on 'URLSearchParams': parameter 1",
                }),
              );
              obj = URLSearchParams(14468);
              items.push(
                URLSearchParams(14468).USVString(arguments[1], {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                let arr = Array.from(self[URLSearchParams(undefined, 14460).implSymbol]);
                let num2 = 0;
                let tmp11 = arr;
                if (0 < arr.length) {
                  do {
                    ...
                    let _Array = Array;
                    arr = Array.from(self[URLSearchParams(undefined, 14460).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr;
