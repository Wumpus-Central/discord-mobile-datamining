// _runtime/metro/06187__.js
import tagMessage2 from "../06073_tagMessage.js";
import touchDataToPressEvent from "../06169_touchDataToPressEvent.js";
import StateMachineEvent2 from "../06172_StateMachineEvent.js";
import GestureObjects2 from "../06188_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6169).gestureToPressableEvent(handlerTag));
        let obj = hitSlop(6169);
      }
    };
