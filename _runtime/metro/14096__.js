...
import LRUCache from "../14097_LRUCache.js";
    ...
    value: function parseRange(str) {
      ...
      if (value) {
        ...
        let str3 = str.replace(
          tmp11(14071).safeRe[tmp11(undefined, 14071).t.COMPARATORTRIM],
          tmp11(14071).comparatorTrimReplace,
        );
        tmp11(14070)("comparator trim", str3);
        const str5 = str3.replace(
          tmp11(14071).safeRe[tmp11(undefined, 14071).t.TILDETRIM],
          tmp11(14071).tildeTrimReplace,
        );
        tmp11(14070)("tilde trim", str5);
        let str7 = str5.replace(
          tmp11(14071).safeRe[tmp11(undefined, 14071).t.CARETTRIM],
          tmp11(14071).caretTrimReplace,
        );
          ...
          if (typeof parseComparator === "function") {
            ...
            if (typeof replaceCarets === "function") {
                ...
                if (typeof replaceCaret === "function") {
                  ...
                  return item.replace(tmp6, (arg0, str, str2, str3, arg4) => {
                    ...
                    if (typeof closure_2_9 === "function") {
                      ...
                      options(14070)("caret return", str3);
                      return str3;
                    } else {
                      throw new TypeError("Trying to call a non-function");
                    }
              ...
              if (typeof replaceTildes === "function") {
                  ...
                  if (typeof replaceTilde === "function") {
                    ...
                    return item.replace(tmp5, (arg0, str, str2, str3, arg4) => {
                      ...
                      if (typeof closure_2_9 === "function") {
                          ...
                          if (typeof closure_2_9 === "function") {
                            ...
                            if (tmp6) {
                              ...
                              if (tmp7) {
                                ...
                                options(14070)("replaceTilde pr", arg4);
                                const _HermesInternal2 = HermesInternal;
                                str3 =
                                  ">=" +
                                  str +
                        ...
                        options(14070)("tilde return", str3);
                        return str3;
                      } else {
                        throw new TypeError("Trying to call a non-function");
                      }
                ...
                Range(14070)("tildes", str7);
                if (typeof replaceXRanges === "function") {
                  Range(14070)("replaceXRanges", str7, options);
                    ...
                    if (typeof replaceXRange === "function") {
                      ...
                      return str.replace(tmp5, (arg0, arg1, str, str2, str3, arg5) => {
                        ...
                        if (typeof closure_2_9 === "function") {
                          ...
                          options(14070)("xRange return", combined);
                          return combined;
                        } else {
                          throw new TypeError("Trying to call a non-function");
                        }
                  ...
                  Range(14070)("xrange", str10);
                  if (typeof replaceStars === "function") {
                    Range(14070)("replaceStars", str10, options);
                    const replaced = str10.trim().replace(Range(14071).safeRe[Range(undefined, 14071).t.STAR], "");
                    Range(14070)("stars", replaced);
                    return replaced;
                  } else {
                    throw new TypeError("Trying to call a non-function");
                  }
