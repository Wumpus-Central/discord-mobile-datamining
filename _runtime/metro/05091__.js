// _runtime/metro/05091__.js
import get_synchronousScreenUpdatesEnabledDefault from "../05081_get_synchronousScreenUpdatesEnabled.js";
import _mod5090 from "05090__.js";
import _modDef5092 from "05092__.js";
import animatedComponentDefault from "../05093_animatedComponent.js";
import _mod5094 from "05094__.js";
import SHEET_FIT_TO_CONTENTS from "../05095_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05096_DelayedFreeze.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5090;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5090.freezeEnabled();
    const tmp2Result6 = _mod5090;
  }
  ...
  if (enabled) {
    if (_mod5090.isNativePlatformSupported) {
      ...
      obj4.fullScreenSwipeEnabled = _mod5098.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5099.Provider, { value: null, children: null });
      }
