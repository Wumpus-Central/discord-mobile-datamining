  ...
  },
  {
    ...
    value: function getSpanJSON() {
      ...
      const obj = {
        ...
        op: this._attributes[SentrySpan(undefined, 12812).SEMANTIC_ATTRIBUTE_SENTRY_OP],
        parent_span_id: this._parentSpanId,
        span_id: this._spanId,
        start_timestamp: this._startTime,
        status: SentrySpan(12802).getStatusMessage(this._status),
        timestamp: null,
        trace_id: null,
        origin: _attributes[SentrySpan(undefined, 12812).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN],
