...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = require("12568__.js").util;
    ...
    const fnResult = fn(_mod12568);
    let closure_7 = fn(stringProcessor);
    let closure_8 = fn(_mod12635);
    let closure_9 = fn(_mod12636);
    let closure_10 = fn(_mod12637);
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: require("../12630_initializeContext.js").createStandardJSONSchemaMethod(_standard, "input"), output: require("../12630_initializeContext.js").createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = require("../12630_initializeContext.js").createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
    ...
    exports.ZodObject = fnResult.$constructor("ZodObject", (_zod) => {
      ...
      let util = require("12568__.js").util;
