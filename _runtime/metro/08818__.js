...
const entry = {
  ...
  value: function render() {
    ...
    if (patternContentUnits) {
      num2 = Pattern(8810)[patternContentUnits];
    }
    ...
    const merged1 = Object.assign(Pattern(8745)({ viewBox, preserveAspectRatio }));
