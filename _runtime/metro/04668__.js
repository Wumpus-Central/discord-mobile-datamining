...
import { __INTERNAL_VIEW_CONFIG } from "04669___INTERNAL_VIEW_CONFIG.js";
...
export default importDefaultResult.forwardRef(function SearchBar(autoCapitalize, ref) {
  ...
  if (ref(4660).isSearchBarAvailableForCurrentPlatform) {
    let obj = {};
