// _runtime/metro/03927__.js
import throwProtectedError from "../03942_throwProtectedError.js";
import 03877__ from "03877__.js";
import subMilliseconds from "../03928_subMilliseconds.js";
import _typeof from "03695__.js";
import G from "../03929_G.js";
import dateLongFormatter from "../03940_dateLongFormatter.js";
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("03700__.js").getDefaultOptions();
  locale = undefined;
  if (null != locale) {
          ...
          if (locale.localize) {
            if (locale.formatLong) {
              ...
              if (module_3877.default(defaultResult3)) {
                _typeof = locale.default(defaultResult3, module_3858.default(defaultResult3));
