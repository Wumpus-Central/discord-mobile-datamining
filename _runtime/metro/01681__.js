// _runtime/metro/01681__.js
import runOnRuntime_mod from "../01682_runOnRuntime.js";
...
const shareable = runOnRuntime.makeShareable({
  transparent: 0,
...
let runOnRuntime = runOnRuntime_mod;
const shareable1 = runOnRuntime.makeShareable([
  "backgroundColor",
  "borderBottomColor",
  "borderColor",
  "borderLeftColor",
            ...
            if (match2) {
              ...
              if (match3) {
                ...
                if (match4) {
                  ...
                  tmp6 =
                    Number.parseInt(
                      match4[1] + match4[1] + match4[2] + match4[2] + match4[3] + match4[3] + match4[4] + match4[4],
                      16,
                    ) >>> 0;
                } else {
                  const hsl = obj.hsl;
...
processColor.__closure = { processColorInitially, IS_ANDROID: module_1641 };
...
function toLinearSpace(tmp3Result14) {
  let num = exponent;
