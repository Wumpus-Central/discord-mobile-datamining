...
import _mod14227 from "14227__.js";
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            let obj = { variants: [] };
            const result = Locale(14292).emitUnicodeLanguageId(
              obj.__assign(obj1.__assign({}, Locale(14292).parseUnicodeLanguageId(tmp2)), obj),
            );
            ...
            if (closure_1_6(Locale(14292).emitUnicodeLanguageId(obj)) === result) {
              ...
              obj1.lang = obj2;
              let emitUnicodeLocaleIdResult = Locale(14292).emitUnicodeLocaleId(
              ...
              if (region) {
                ...
                if (closure_1_6(Locale(14292).emitUnicodeLanguageId(obj3)) === result) {
                  ...
                  obj4.lang = obj5;
                  emitUnicodeLocaleIdResult = Locale(14292).emitUnicodeLocaleId(
  ...
  let obj = {
    get() {
      return Locale(14292).emitUnicodeLanguageId(
        Locale(14292).parseUnicodeLanguageId(module_14227.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
