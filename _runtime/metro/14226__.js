...
function addLikelySubtags(arr3) {
  ...
  if (script) {
    if (region) {
      ...
      const tmp4 = _mod14292.likelySubtags[_mod14292.emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = _mod14292.parseUnicodeLanguageId(tmp4);
        ...
        if (result) {
          ...
          obj = { lang: "und", script: "Array", region: "channel", variants };
        }
        parseUnicodeLocaleIdResult.lang = obj;
        return _mod14292.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj1 = { lang, script, variants: [] };
    const tmp5 = _mod14292.likelySubtags[_mod14292.emitUnicodeLanguageId(undefined, obj1)];
    if (tmp5) {
      const result1 = _mod14292.parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = _mod14292.likelySubtags[_mod14292.emitUnicodeLanguageId(undefined, obj4)];
    if (tmp6) {
      const result2 = _mod14292.parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = _mod14292.likelySubtags[lang];
  if (!tmp7) {
    const obj7 = { lang: "und", script, variants: [] };
    tmp7 = _mod14292.likelySubtags[_mod14292.emitUnicodeLanguageId(undefined, obj7)];
  }
  if (tmp7) {
    const result3 = _mod14292.parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            let obj = { variants: [] };
            const result = Locale(14292).emitUnicodeLanguageId(obj.__assign(obj1.__assign({}, Locale(14292).parseUnicodeLanguageId(tmp2)), obj));
            const parseUnicodeLocaleIdResult = Locale(14292).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            obj = { lang, variants: [] };
            if (closure_1_6(Locale(14292).emitUnicodeLanguageId(obj)) === result) {
              Locale(1162);
              ...
              obj1 = { lang: null };
              const obj2 = { lang, script: "Array", region: "channel", variants };
              obj1.lang = obj2;
              let emitUnicodeLocaleIdResult = Locale(14292).emitUnicodeLocaleId(tmp3Result.__assign(tmp3Result.__assign({}, parseUnicodeLocaleIdResult), obj1));
              const __assignResult = tmp3Result.__assign({}, parseUnicodeLocaleIdResult);
            } else {
              if (region) {
                const obj3 = { lang, region, variants: [] };
                if (closure_1_6(Locale(14292).emitUnicodeLanguageId(obj3)) === result) {
                  ...
                  obj4.lang = obj5;
                  emitUnicodeLocaleIdResult = Locale(14292).emitUnicodeLocaleId(tmp3Result1.__assign(Locale(1162).__assign({}, parseUnicodeLocaleIdResult), obj4));
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (closure_1_6(Locale(14292).emitUnicodeLanguageId(obj6)) === result) {
                  ...
                  obj7.lang = obj8;
                  emitUnicodeLocaleIdResult = Locale(14292).emitUnicodeLocaleId(tmp3Result3.__assign(Locale(1162).__assign({}, parseUnicodeLocaleIdResult), obj7));
