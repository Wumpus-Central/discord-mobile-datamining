...
import _modDef5449 from "05449__.js";
...
export default {
  read(dataView, sum) {
    ...
    let tmp4;
    if (8 <= shortAt) {
      const byteAt = _modDef5449.getByteAt(dataView, sum + 7);
    ...
    let tmp6;
    if (3 <= shortAt) {
      const byteAt1 = _modDef5449.getByteAt(dataView, sum + 2);
      const obj3 = { value: byteAt1, description: "" + byteAt1 };
      tmp6 = obj3;
      const tmpResult4 = _modDef5449;
    }
    const obj4 = {
