// _runtime/metro/04204__extends.js
...
class e {
  ...
  render() {
    ...
    return closure_2.createElement(require("_extends").Router, obj);
  }
}
...
export const MemoryRouter = Component2(4208).Redirect;
export const Prompt = Component2(4208).Redirect;
export const Redirect = Component2(4208).Redirect;
export const Route = Component2(4208).Route;
export const Router = Component2(4208).Router;
export const StaticRouter = Component2(4208).StaticRouter;
export const Switch = Component2(4208).Switch;
export const generatePath = Component2(4208).generatePath;
export const matchPath = Component2(4208).matchPath;
export const useHistory = Component2(4208).useHistory;
export const useLocation = Component2(4208).useLocation;
export const useParams = Component2(4208).useParams;
export const useRouteMatch = Component2(4208).useRouteMatch;
export const withRouter = Component2(4208).withRouter;
...
export const NavLink = forwardRef2((aria_current) => {
  ...
  return str2.createElement(Component2(str[5]).__RouterContext.Consumer, null, (location) => {
    ...
    return <closure_1_11 {......tmp26Result} />;
  });
});