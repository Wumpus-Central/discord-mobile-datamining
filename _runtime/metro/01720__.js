// _runtime/metro/01720__.js
import _mod1678 from "01678__.js";
import _mod1721 from "01721__.js";
...
fn = function n(toValue, userConfig, callback) {
    ...
    let obj3 = {
      ...
      onStart(toValue, current, arg2, lastTimestamp) {
        ...
        if (lastTimestamp) {
          ...
          ({
            zeta: toValue.zeta,
            omega0: toValue.omega0,
            omega1: toValue.omega1,
          } = closure_0(1721).initialCalculations(mass, tmp));
  ...
  let obj = require("01678__.js");
  fn.__closure = {
    userConfig,
    checkIfConfigIsValid: require("01721__.js").checkIfConfigIsValid,
    underDampedSpringCalculations: require("01721__.js").underDampedSpringCalculations,
    criticallyDampedSpringCalculations: require("01721__.js").criticallyDampedSpringCalculations,
    isAnimationTerminatingCalculation: require("01721__.js").isAnimationTerminatingCalculation,
    calculateNewMassToMatchDuration: require("01721__.js").calculateNewMassToMatchDuration,
    initialCalculations: require("01721__.js").initialCalculations,
    scaleZetaToMatchClamps: require("01721__.js").scaleZetaToMatchClamps,
    toValue,
    callback,
    getReduceMotionForAnimation: require("01678__.js").getReduceMotionForAnimation,
  };
...
fn.__closure = {
  defineAnimation: fn(1678).defineAnimation,
  checkIfConfigIsValid: fn(1721).checkIfConfigIsValid,
  underDampedSpringCalculations: fn(1721).underDampedSpringCalculations,
  criticallyDampedSpringCalculations: fn(1721).criticallyDampedSpringCalculations,
  isAnimationTerminatingCalculation: fn(1721).isAnimationTerminatingCalculation,
  calculateNewMassToMatchDuration: fn(1721).calculateNewMassToMatchDuration,
  initialCalculations: fn(1721).initialCalculations,
  scaleZetaToMatchClamps: fn(1721).scaleZetaToMatchClamps,
  getReduceMotionForAnimation: fn(1678).getReduceMotionForAnimation,
};
