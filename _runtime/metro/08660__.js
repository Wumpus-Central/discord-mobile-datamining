...
const entry = {
  ...
  value: function render() {
    ...
    if (patternContentUnits) {
      num2 = Pattern(8652)[patternContentUnits];
    }
    ...
    const merged1 = Object.assign(Pattern(8587)({ viewBox, preserveAspectRatio }));
