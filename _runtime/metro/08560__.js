// _runtime/metro/08560__.js
import _possibleConstructorReturnDefault from "00093__possibleConstructorReturn.js";
import _modDef8480 from "08480__.js";
import _modDef8561 from "08561__.js";
...
const entry = {
  ...
  value: function render() {
    ...
    let match = str;
    if (str) {
      match = str.match(Use(8472).idPattern);
    }
    let tmp4 = match;
    if (match) {
      tmp4 = match[1];
    ...
    const merged = Object.assign(Use(8471).withoutXY(this, props));
