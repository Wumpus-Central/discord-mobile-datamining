...
import _mod1722 from "01722__.js";
import findDescendantWithExitingAnimation from "../01723_findDescendantWithExitingAnimation.js";
import TransitionGenerator from "../01724_TransitionGenerator.js";
...
function startWebLayoutAnimation(props, _componentDOMRef, ENTERING, easingY) {
  ...
  if (entering) {
    ...
    let flag =
      ...
      !(ENTERING === _mod1661.LayoutAnimationType.LAYOUT || tmp5 || undefined !== entering.initialValues);
    if (flag) {
