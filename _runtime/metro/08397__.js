// _runtime/metro/08397__.js
import _mod8392 from "08392__.js";
import _mod8395 from "08395__.js";
import _mod8398 from "08398__.js";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(_mod8392);
    let closure_4 = fn(_mod8398);
    let closure_5 = fn(_mod8395);
      ...
      _zod._zod.check = (value) => {
        ...
        if (!pattern.test(value.value)) {
          ...
          const obj = {
            ...
            format: "regex",
            input: value.value,
            pattern: closure_1.pattern.toString(),
            inst,
            continue: !closure_1.abort,
          };
          issues.push(obj);
