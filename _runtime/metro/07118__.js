...
class TouchableOpacity {
  constructor() {
    ...
    tmp3Result.onStateChange = (arg0, arg1) => {
      if (arg1 === TouchableOpacity(7116).TOUCHABLE_STATE.BEGAN) {
        ...
        tmp3 =
          arg1 !== TouchableOpacity(7116).TOUCHABLE_STATE.UNDETERMINED &&
          arg1 !== TouchableOpacity(7116).TOUCHABLE_STATE.MOVED_OUTSIDE;
      }
    };
    return tmp3Result;
  }
