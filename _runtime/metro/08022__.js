...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5716).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08027__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08027__.js");
  const invalidPreventRemoveError = require("08028__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08028__.js");
  const modalRouteKeys = require("08029__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05716__.js").SafeAreaProviderCompat, obj4);
};
