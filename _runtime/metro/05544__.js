...
const obj = {
  ...
  2: { name: "GPSLatitude", description: fn(5543).getCalculatedGpsValue },
  3: {
...
const obj3 = { name: "GPSLatitude", description: fn(5543).getCalculatedGpsValue };
obj[4] = { name: "GPSLongitude", description: fn(5543).getCalculatedGpsValue };
obj[5] = {
  name: "GPSAltitudeRef",
  description(arg0) {
    let str = "Sea level";
...
const obj4 = { name: "GPSLongitude", description: fn(5543).getCalculatedGpsValue };
obj[27] = { name: "GPSProcessingMethod", description: fn(5543).getEncodedString };
const obj5 = { name: "GPSProcessingMethod", description: fn(5543).getEncodedString };
obj[28] = { name: "GPSAreaInformation", description: fn(5543).getEncodedString };
obj[30] = {
