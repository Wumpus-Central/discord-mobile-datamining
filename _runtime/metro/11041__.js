...
export const horizontalStackLayout = function horizontalStackLayout() {
  ...
  fn.__closure = {
    ...
    getCommonVariables,
    getCommonStyles,
    interpolate: modeConfig(1637).interpolate,
    Extrapolation: modeConfig(1637).Extrapolation,
  };
...
export const useHorizontalStackLayout = function useHorizontalStackLayout() {
  ...
  fn.__closure = {
    ...
    getCommonVariables,
    getCommonStyles,
    interpolate: modeConfig(obj2[2]).interpolate,
    Extrapolation: modeConfig(obj2[2]).Extrapolation,
  };
  fn.__workletHash = 13118376883684;
  fn.__initData = __initData;
  obj3.layout = fn;
