  ...
  if (tmp4) {
    ...
    if (!headers) {
      ...
      if (typeof Request !== "undefined") {
        ...
        isInstanceOfResult = _mod13152.isInstanceOf(headers, Request);
        const tmpResult = _mod13152;
      }
      let headers1;
    ...
    if (headers) {
      ...
      if (typeof Headers !== "undefined") {
        ...
        isInstanceOfResult1 = _mod13152.isInstanceOf(headers, Headers);
        const tmpResult2 = _mod13152;
      }
