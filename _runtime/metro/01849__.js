...
export const useSmoothKeyboardHandler = (handler, items11) => {
  ...
  __closure = { IS_ANDROID_ELEVEN_OR_HIGHER_OR_IOS: sharedValue1, persistedHeight: sharedValue2, TELEGRAM_ANDROID_TIMING_CONFIG: sharedValue2, target: sharedValue, animatedKeyboardHeight: sharedValue3 };
  ...
  __closure.onEnd = O;
  require("module_1830").useKeyboardHandler(__closure, items11);
};