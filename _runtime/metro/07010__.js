// _runtime/metro/07010__.js
import handlerIDToTag2 from "../06987_handlerIDToTag.js";
...
import ActionType from "../07016_ActionType.js";
...
let closure_10 = {
  [fn(6989).State.UNDETERMINED]: undefined,
  [fn(6989).State.BEGAN]: "onBegan",
  [fn(6989).State.FAILED]: "onFailed",
  [fn(6989).State.CANCELLED]: "onCancelled",
  [fn(6989).State.ACTIVE]: "onActivated",
  [fn(6989).State.END]: "onEnded",
};
