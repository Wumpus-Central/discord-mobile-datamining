...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10560).matchAnyPattern(RUWeekdayParser(10689).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10587).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10689).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
