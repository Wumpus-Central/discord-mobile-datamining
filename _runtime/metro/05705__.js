...
export const Header = function Header(layout) {
  ...
  const defaultHeaderHeight = require("05703__.js").getDefaultHeaderHeight(layout, tmp9, headerStatusBarHeight);
  if (!headerStyle) {
    headerStyle = {};
  }
  ...
  if (!tmp7) {
    ...
    if ("left" === str) {
      ...
      if (headerSearchBarOptions) {
        ...
        const obj18 = { source: require("05685__.js"), tintColor: text };
