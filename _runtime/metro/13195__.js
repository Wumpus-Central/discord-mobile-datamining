...
let items = [
  entry,
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      return obj.resolvedSyncPromise(
        ServerRuntimeClient(13196).eventFromMessage(
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        const sessionFlusher = new ServerRuntimeClient(13189).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (ServerRuntimeClient(13164).DEBUG_BUILD) {
  ...
  },
  {
    ...
    value: function captureCheckIn(checkInId, arg1, arg2) {
      ...
      const obj = ServerRuntimeClient(13147);
    },
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        ...
        if (_getSpanForScopeResult) {
          let spanToTraceContextResult = ServerRuntimeClient(13141).spanToTraceContext(_getSpanForScopeResult);
          const tmpResult = ServerRuntimeClient(13141);
        } else {
          spanToTraceContextResult = ServerRuntimeClient(13163).getTraceContextFromScope(arg0);
          const tmpResult3 = ServerRuntimeClient(13163);
        }
