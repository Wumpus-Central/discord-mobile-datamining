// _runtime/metro/14751__.js
import _mod14752 from "14752__.js";
...
let value = (() => {
  ...
  const entry1 = {
    ...
    value: function supportedLocalesOf(items, arg1) {
      ...
      return _mod14752.LookupSupportedLocales(Array.from(ListFormat.availableLocales), canonicalLocales);
    },
  };
  let items1 = [
    entry1,
...
try {
  ...
  let _Object = Object;
  Object.defineProperty(value.prototype.constructor, "length", {
    value: 0,
    writable: false,
    enumerable: false,
    configurable: true,
  ...
  let _Object2 = Object;
  Object.defineProperty(value.supportedLocalesOf, "length", {
    value: 1,
    writable: false,
    enumerable: false,
    configurable: true,
