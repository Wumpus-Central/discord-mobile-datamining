...
// Module 8732
import extractOpacityDefault from "extractOpacity" /* 8734 */;
import extractResponderDefault from "extractResponder" /* 8735 */;
import _modDef8740 from "module_8740" /* 8740 */;
import reducedDefault from "reduced" /* 8741 */;
  ...
  constructor() {
    ...
    tmp3Result.toDataURL = (arg0, arg1) => {
      if (arg0) {
        ...
        Svg(8733).default.toDataURL(tmp4, arg1, arg0);
        const _default = Svg(8733).default;
      }
    };
    return tmp3Result;
  }
}
_inherits(Svg, _modDef8752);
const entry = {
  key: "render",
  value: function render() {
    ...
    if (transform) {
      ...
      tmp.transform = Svg(8736).extractTransformSvgView(tmp);
      const obj3 = Svg(8736);
    }
    const obj4 = {};
    ...
    obj4.children = jsx(_modDef8742, { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
    return jsx(_modDef8740, {});
  }
};
let items = [entry];
