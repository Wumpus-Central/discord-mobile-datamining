// _runtime/metro/05748__.js
import _modDef5749 from "05749__.js";
...
const entry = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5749).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
...
let items = [
  ...
  },
  {
    ...
    value: function renderLottieView() {
      ...
      const parsePossibleSourcesResult = LottieView(5750).parsePossibleSources(source);
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(_modDef5749, { ref: self.captureRef });
        }
      }
      speed = self.props.speed;
      let obj = LottieView(5750);
    },
  },
  {
    key: "render",
