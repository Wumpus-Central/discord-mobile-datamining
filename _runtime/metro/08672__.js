...
import _modDef8675 from "08675__.js";
...
_isNativeReflectConstruct = fn(8673);
const jsx = fn(21).jsx;
class Text {
  constructor() {
    self = this;
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const propsAndStylesResult = Text(8589).propsAndStyles(matrix);
      const obj = Text(8589);
      const merged = Object.assign(
        propsAndStylesResult,
        Text(8590).pickNotNil(extractFontDefault(propsAndStylesResult, true)),
      );
      if (closure_0.root) {
        const root = closure_0.root;
        root.setNativeProps(propsAndStylesResult);
      }
      const obj2 = Text(8590);
    };
    return tmp3Result;
  }
}
_inherits(Text, _modDef8598);
const entry = {
  key: "render",
