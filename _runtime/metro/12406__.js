...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(clone, arg1) {
      ...
      const obj = _mod12293;
      obj2.endTimestamp = 1000 * _mod12309.timestampInSeconds();
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(errorCallback) {
  _mod12293.addHandler("fetch-body-resolved", errorCallback);
  _mod12293.maybeInstrument("fetch-body-resolved", () => {
    closure_0 = closure_5;
    {
      closure_0(12301).fill(closure_0(12296).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj = closure_3_0(12293);
            const obj2 = {};
            const merged = Object.assign(obj);
            obj2.endTimestamp = 1000 * closure_3_0(12309).timestampInSeconds();
            obj2.error = error;
            obj.triggerHandlers("fetch", obj2);
            const obj3 = closure_3_0(12309);
            const obj4 = closure_3_0(12302);
            if (tmp5) {
              error.stack = stack.stack;
              const result = closure_3_0(12301).addNonEnumerableProperty(error, "framesToPop", 1);
              const tmpResult = closure_3_0(12301);
            }
            throw error;
          });
        };
      });
      const obj = closure_0(12301);
    }
  });
};
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(errorCallback, arg1) {
  _require = arg1;
  require("12293__.js").addHandler("fetch", errorCallback);
  let obj = require("12293__.js");
  require("12293__.js").maybeInstrument("fetch", () => {
    let flag = closure_0;
    ...
    if (!flag) {
      _mod12301.fill(_mod12296.GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
          const items = [...arguments];
          const error = new Error();
