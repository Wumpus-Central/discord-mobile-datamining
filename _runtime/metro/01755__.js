  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n() {
        ...
        obj3.scale = delayFunction(
          ...
          obj4.withSequence(
            ...
            withTimingResult1,
            withTimingResult2,
            delayFunction(1709).withTiming(1, { duration: 0.15 * duration }),
          ),
        );
        const items = [obj3];
      ...
      fn.__closure = {
        delayFunction,
        delay,
        withSequence: BounceOutRight(1709).withSequence,
        withTiming: BounceOutRight(1709).withTiming,
        duration,
        initialValues,
        callback: callbackV,
      };
      ...
      const fn = function n(translateY) {
        ...
        obj3.translateY = delayFunction(
          ...
          obj4.withSequence(
            ...
            withTimingResult1,
            withTimingResult2,
            delayFunction(1709).withTiming(0, { duration: 0.15 * duration }),
          ),
        );
        const items = [obj3];
        obj2.transform = items;
      ...
      const fn = function n() {
        ...
        obj3.scale = delayFunction(
          ...
          obj4.withSequence(
            ...
            withTimingResult1,
            withTimingResult2,
            delayFunction(1709).withTiming(0, { duration: 0.55 * duration }),
          ),
        );
        const items = [obj3];
        obj2.transform = items;
      ...
      const fn = function n(windowHeight) {
        ...
        obj3.translateY = delayFunction(
          ...
          obj4.withSequence(
            ...
            withTimingResult1,
            withTimingResult2,
            delayFunction(1709).withTiming(windowHeight.windowHeight, { duration: 0.55 * duration }),
          ),
        );
        const items = [obj3];
        obj2.transform = items;
      ...
      const fn = function n(windowWidth) {
        ...
        obj3.translateX = delayFunction(
          ...
          obj4.withSequence(
            ...
            withTimingResult1,
            withTimingResult2,
            delayFunction(1709).withTiming(-windowWidth.windowWidth, { duration: 0.55 * duration }),
          ),
        );
        const items = [obj3];
        obj2.transform = items;
