...
import readTag from "../05058_readTag.js";
import importDefaultResult1 from "../05059_importDefaultResult1.js";
  ...
  read(byteLength) {
    ...
    if (LevelInfo) {
      ...
      if (sum1 + 7 <= byteLength.byteLength) {
        ...
        const int16 = byteLength.getInt16(sum2, byteOrder === tmp3(5043).LITTLE_ENDIAN);
        obj1 = { value: null, description: null };
        obj1[0] = int16;
        obj1[1] = "" + -0.5 * int16;
        obj.RollAngle = obj1;
        const sum3 = sum1 + tmp17.PITCH_ANGLE;
        const int161 = byteLength.getInt16(sum3, byteOrder === tmp3(5043).LITTLE_ENDIAN);
