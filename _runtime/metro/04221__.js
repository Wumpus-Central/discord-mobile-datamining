...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("Y" === arg1) {
      ...
      return _createSuperInternal(4219).mapValue(
        _createSuperInternal(4219).parseNDigits(arg1.length, arg0),
        valueCallback,
      );
    }
  },
    ...
    value: function set(setUTCFullYear, era, isTwoDigitYear, firstWeekContainsDate) {
      if (isTwoDigitYear.isTwoDigitYear) {
        setUTCFullYear.setUTCFullYear(
          _createSuperInternal(4219).normalizeTwoDigitYear(isTwoDigitYear.year, tmp),
          0,
