...
import _mod14199 from "14199__.js";
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            let obj = { variants: [] };
            const result = Locale(14264).emitUnicodeLanguageId(
              obj.__assign(obj1.__assign({}, Locale(14264).parseUnicodeLanguageId(tmp2)), obj),
            );
  ...
  let obj = {
    get() {
      return Locale(14264).emitUnicodeLanguageId(
        Locale(14264).parseUnicodeLanguageId(module_14199.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
