...
export const useIAP = () => {
  const iAPContext = require("10519__.js").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("10504__.js").requestPurchase,
    requestSubscription: require("10504__.js").requestSubscription,
  };
};
