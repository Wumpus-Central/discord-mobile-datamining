...
import SymbolResult1 from "../14027_SymbolResult1.js";
import URLSearchParamsImpl from "../14034_URLSearchParamsImpl.js";
import _ from "../14035__.js";
...
obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, SymbolResult1.implSymbol)) {
        if (arg0[tmp(undefined, 14027).implSymbol] instanceof tmp(14034).implementation) {
          return true;
        }
      }
  ...
  setup(wrapper) {
    ...
    if (URLSearchParamsImpl.init) {
      tmp2(14034).init(wrapper[tmp2(undefined, 14027).implSymbol], obj);
      const tmp2Result = tmp2(14034);
    }
    return wrapper;
  },
  install(arg0) {
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return URLSearchParams(14027).tryWrapperForImpl(HermesBuiltin.apply(items1, tmp11));
              }
            }
          }
          const typeError1 = new TypeError("Illegal invocation");
      ...
      },
      {
        ...
        value: function sort() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 14027).implSymbol].sort();
            }
          }
      ...
      },
      {
        ...
        value: function toString() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 14027).implSymbol].toString();
            }
          }
          const typeError = new TypeError("Illegal invocation");
          throw typeError;
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                let arr = Array.from(self[URLSearchParams(undefined, 14027).implSymbol]);
                let num2 = 0;
                let tmp11 = arr;
                if (0 < arr.length) {
                  do {
                    ...
                    let tmp5 = callback2;
                    let tmp6 = callback2(arr.map(URLSearchParams(14027).tryWrapperForImpl), 2);
                    [tmp7, tmp8] = tmp6;
                    let call = fn.call;
                    let tmp9 = num2;
                    ...
                    let _Array = Array;
                    arr = Array.from(self[tmp3(undefined, 14027).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr;
    ...
    if (undefined === arg0[URLSearchParams(undefined, 14027).ctorRegistrySymbol]) {
      let _Object = Object;
      const ctorRegistrySymbol = tmp3(14027).ctorRegistrySymbol;
      class URLSearchParams {
        constructor() {
          tmp = closure_3(this, URLSearchParams);
          first = arguments[0];
