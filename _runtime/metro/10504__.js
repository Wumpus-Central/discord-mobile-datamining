...
import RNIapAmazonModuleAll from "../10512_RNIapAmazonModule.js";
import _modAll10513 from "10513__.js";
import _modAll10514 from "10514__.js";
import syncAll from "../10515_sync.js";
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      ...
      closure_128_0 = value.map(tmp2(10511).singleProductAndroidMap);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = asyncGeneratorStep(async () => {
      ...
      await tmp2(10506).fillProductsWithAdditionalData(closure_128_2);
      closure_128_2 = value;
