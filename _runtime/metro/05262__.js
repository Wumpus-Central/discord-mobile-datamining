...
import _modDef5263 from "05263__.js";
import calculateGPSValueDefault from "../05265_calculateGPSValue.js";
...
function parseNodeAsSimpleRdfDescription(attributes, key10005) {
  ...
  ParseError(5227).objectAssign(obj, obj, obj);
...
function parseNodeAsStructureRdfDescription(value, key10005) {
  ...
  if (undefined !== value.value["rdf:Description"]) {
    ...
    ParseError(5227).objectAssign(obj.attributes, obj);
