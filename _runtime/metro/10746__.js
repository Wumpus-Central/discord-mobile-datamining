...
const chrono = new require("10556__.js").Chrono(createCasualConfiguration());
...
obj4.parsers = items;
obj4.refiners = [];
const chrono1 = new require("10556__.js").Chrono(includeCommonConfiguration.includeCommonConfiguration(obj4, true));
