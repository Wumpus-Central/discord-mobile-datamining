...
const regExp1 = new RegExp(
  "(this|last|past|next|after|\\+|-)\\s*(" + _mod10674.TIME_UNITS_NO_ABBR_PATTERN + ")(?=\\W|$)",
  "i",
);
    ...
    value: function innerExtract(reference, arg1) {
      ...
      if (parseDurationResult) {
        if ("last" !== formatted) {
          ...
          const ParsingComponents = ENTimeUnitCasualRelativeFormatParser(10678).ParsingComponents;
          return ParsingComponents.createRelativeFromReference(reference.reference, reverseDurationResult);
        }
        reverseDurationResult = ENTimeUnitCasualRelativeFormatParser(10677).reverseDuration(parseDurationResult);
      } else {
        return null;
      }
    },
