  ...
  autodetect.push({
    ...
    test() {
      ...
      if (typeof type$p === "function") {
        ...
        tmp6 = f109168[typeof call === "unknown" ? toString(arr2) : call(toString, arr2)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    },
    ...
    return autodetect.push({
      ...
      test() {
        ...
        if (typeof type$p === "function") {
          ...
          tmp7 = f109168[typeof call === "unknown" ? toString(arr2) : call(toString, arr2)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      },
          ...
          if (3 !== arr2.length) {
            if (4 === arr2.length) {
              if (typeof tmp4 === "function") {
                ...
                const tmp9 = f109168[typeof call2 === "unknown" ? toString2(tmp8) : call2(toString2, tmp8)] || "object";
              } else {
                throw new TypeError("Trying to call a non-function");
              }
            }
    ...
    if (obj17[first]) {
      if (typeof type$p === "function") {
        ...
        if (typeof tmp13 === "function") {
          ...
          tmp21 = f109168[typeof call2 === "unknown" ? toString2(arg1) : call2(toString2, arg1)] || "object";
    ...
    function setColors(items) {
      ...
      if (items) {
        if (typeof type$p === "function") {
          ...
          const call = toString.call;
          brewer =
            "string" === (f109168[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object");
        ...
        if (null !== sum1) {
          ...
          if (typeof type$p === "function") {
            ...
            if ("array" === tmp29) {
              ...
              tmp31 = f109168[typeof call2 === "unknown" ? toString2(substr) : call2(toString2, substr)] || "object";
            } else {
              throw new TypeError("Trying to call a non-function");
            }
            ...
            tmp29 = f109168[typeof call === "unknown" ? toString(substr) : call(toString, substr)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
      ...
      const item = values.forEach((item) => {
        ...
        if (c0) {
          if (typeof type$p === "function") {
            ...
            const call = toString.call;
            tmp2 =
              "object" === (f109168[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object");
