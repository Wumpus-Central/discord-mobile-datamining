    ...
    function setColors(items) {
      ...
      if (items) {
        if (typeof type$p === "function") {
          ...
          const call = toString.call;
          brewer =
            "string" === (f107636[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object");
                ...
                while (bound > closure_5[num11]) {
                  ...
                  if (bound > tmp35) {
                    ...
                    if (bound < closure_5[sum1]) {
                      interpolateResult = chroma$k.interpolate(
                        substr[num11],
                        substr[sum1],
      ...
      const item = values.forEach((item) => {
        ...
        if (c0) {
          if (typeof type$p === "function") {
            ...
            const call = toString.call;
            tmp2 =
              "object" === (f107636[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object");
