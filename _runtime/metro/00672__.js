    ...
    function setColors(items) {
      ...
      if (items) {
        if (typeof type$p === "function") {
          ...
          const call = toString.call;
          brewer =
            "string" === (f107605[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object");
      ...
      const item = values.forEach((item) => {
        ...
        if (c0) {
          if (typeof type$p === "function") {
            ...
            const call = toString.call;
            tmp2 =
              "object" === (f107605[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object");
