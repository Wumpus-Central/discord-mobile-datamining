...
let fn = function n() {
  ...
  function unpack(arg0, arg1) {
    ...
    if (arg0.length >= 3) {
      ...
      if (typeof type$p === "function") {
        ...
        mapped = arg0[0];
        tmp4 = f107636[typeof call === "unknown" ? toString(first) : call(toString, first)] || "object";
      } else {
  ...
  obj = {
    ...
    test() {
      ...
      if (typeof type$p === "function") {
        ...
        tmp6 = f107636[typeof call === "unknown" ? toString(arr2) : call(toString, arr2)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    }
    ...
    if (typeof last === "function") {
      ...
      if (items.length >= 2) {
        ...
        if (typeof type$p === "function") {
          ...
          str = formatted;
          tmp9 = f107636[typeof call === "unknown" ? toString(tmp6) : call(toString, tmp6)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    if (typeof last === "function") {
      ...
      if (items.length >= 2) {
        ...
        if (typeof type$p === "function") {
          ...
          str = formatted;
          tmp13 = f107636[typeof call === "unknown" ? toString(tmp10) : call(toString, tmp10)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    obj = {
      ...
      test() {
        ...
        if (typeof type$p === "function") {
          ...
          tmp7 = f107636[typeof call === "unknown" ? toString(arr2) : call(toString, arr2)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
          ...
          if (3 !== arr2.length) {
            if (4 === arr2.length) {
              if (typeof tmp4 === "function") {
                ...
                const tmp9 = f107636[typeof call2 === "unknown" ? toString2(tmp8) : call2(toString2, tmp8)] || "object";
              } else {
                throw new TypeError("Trying to call a non-function");
              }
            }
  ...
  obj14.lch = lch;
  obj14.hcl = lch;
  obj14.num = (num, num2, arg2) => {
    const numResult = num.num();
    return Color(numResult + arg2 * (num2.num() - numResult), "num");
  };
  obj14.hcg = (hsl, hsl2, arg2) => _hsx(hsl, hsl2, arg2, "hcg");
  obj14.hsi = (hsl, hsl2, arg2) => _hsx(hsl, hsl2, arg2, "hsi");
  obj14.hsl = (hsl, hsl2, arg2) => _hsx(hsl, hsl2, arg2, "hsl");
  obj14.hsv = (hsl, hsl2, arg2) => _hsx(hsl, hsl2, arg2, "hsv");
  obj14.oklab = (oklab, oklab2, arg2) => {
  ...
  obj14.oklch = (hsl, hsl2, arg2) => _hsx(hsl, hsl2, arg2, "oklch");
  pow = Math.pow;
  sqrt = Math.sqrt;
  PI = Math.PI;
  cos = Math.cos;
    ...
    function setColors(items) {
      ...
      if (items) {
        if (typeof type$p === "function") {
          const _Object = Object;
          const call = toString.call;
          brewer = "string" === (f107636[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object");
          const tmp4 = f107636[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
      ...
      if (typeof type$p === "function") {
        ...
        tmp10 = f107636[typeof call2 === "unknown" ? toString2(arr2) : call2(toString2, arr2)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    }
        ...
        if (null !== sum1) {
          ...
          if (typeof type$p === "function") {
            ...
            if ("array" === tmp29) {
              ...
              tmp31 = f107636[typeof call2 === "unknown" ? toString2(substr) : call2(toString2, substr)] || "object";
            } else {
              throw new TypeError("Trying to call a non-function");
            }
            ...
            tmp29 = f107636[typeof call === "unknown" ? toString(substr) : call(toString, substr)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
      ...
      if (arguments.length) {
        ...
        if (arr.length === substr.length) {
          if (closure_10 !== closure_11) {
            ...
            if (0 < arr.length) {
              do {
                arr = closure_5.push((arr[num4] - closure_10) / (closure_11 - closure_10));
                num4 = num4 + 1;
                length2 = arr.length;
              } while (num4 < length2);
            }
        ...
        for (let num2 = 0; num2 < length; num2 = num2 + 1) {
          arr = closure_5.push(num2 / (length - 1));
        }
        if (arr.length > 2) {
    ...
    fn.padding = (arg0) => {
      if (null != arg0) {
        if (typeof type$p === "function") {
          ...
          items = tmp6;
          let tmp = fn;
          tmp5 = f107636[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
        ...
        if (items) {
          if (items.length > 2) {
            ...
            if (1 <= items.length ? 1 < items.length : 1 > items.length) {
              do {
                diff = num2 - 1;
                arr = items2.push(0.5 * (items[diff] + items[num2]));
                if (tmp2) {
                  diff = num2 + 1;
                }
                num2 = diff;
  ...
  blend.normal = (arg0, arg1) => {
    obj = closure_2_206(arg1);
    const rgbResult = closure_2_206(arg1).rgb();
    return closure_2_206.rgb(f107636(rgbResult, closure_2_206(arg0).rgb()));
  };
      ...
      const item = values.forEach((item) => {
        ...
        if (c0) {
          if (typeof type$p === "function") {
            const _Object = Object;
            const call = toString.call;
            tmp2 = "object" === (f107636[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object");
            const tmp6 = f107636[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
      ...
      if (1 === num) {
        ...
        if ("e" === str.substr(0, 1)) {
          ...
          for (let num21 = 1; num21 < num; num21 = num21 + 1) {
            let arr2 = items1.push(min + num21 / num * (max - min));
          }
          items1.push(max);
          ...
          if (min <= 0) {
            ...
            for (let num20 = 1; num20 < num; num20 = num20 + 1) {
              let arr5 = items1.push(pow(10, result + num20 / num * (result1 - result)));
            }
            items1.push(max);
          }
          ...
          for (let num19 = 1; num19 < num; num19 = num19 + 1) {
            ...
            if (tmp43 === result2) {
              let arr8 = items1.push(sorted[tmp43]);
            } else {
              let diff = result2 - tmp43;
              let arr9 = items1.push(sorted[tmp43] * (1 - diff) + sorted[tmp43 + 1] * diff);
            }
          }
          items1.push(max);
          ...
          for (let num3 = 1; num3 < num; num3 = num3 + 1) {
            let arr12 = items2.push(min + num3 / num * (max - min));
          }
          items2.push(max);
          let num5 = 0;
          do {
            ...
            for (let num11 = 0; num11 < num; num11 = num11 + 1) {
              array1[num11] = array1[num11] * (1 / array[num11]);
            }
            let num12 = 0;
            flag = false;
            if (0 < num) {
              flag = true;
              while (array1[num12] === items2[num12]) {
                let sum = num12 + 1;
                num12 = sum;
                flag = false;
                if (sum >= num) {
          ...
          for (let num14 = 0; num14 < length; num14 = num14 + 1) {
            arr2 = obj[array[num14]];
            let arr14 = arr2.push(sorted[num14]);
          }
          const items3 = [];
          for (let num15 = 0; num15 < num; num15 = num15 + 1) {
            let arr15 = items3.push(obj[num15][0]);
            let arr16 = items3.push(obj[num15][obj[num15].length - 1]);
          }
          ...
          for (let num18 = 1; num18 < sorted1.length; num18 = num18 + 2) {
            ...
            if (!isNaNResult) {
              let arr18 = items1.push(tmp36);
            }
          }
        }
        return items1;
      }
      tmp4 = f107636[typeof call === "unknown" ? toString(analyzeResult) : call(toString, analyzeResult)] || "object";
    } else {
      throw new TypeError("Trying to call a non-function");
    }
  }
  ...
  chroma$k.bezier = (arr) => {
    ...
    if (2 === mapped.length) {
      ...
      [f107636, type$p, type$p, last] = mapped3;
      fn = function a(arg0) {
        closure_0 = arg0;
        const items = [0, 1, 2];
      ...
      fn.hue = (arg0) => {
        if (null == arg0) {
          ...
          if (typeof type$p === "function") {
            ...
            tmp8 = fn;
            tmp3 = f107636[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
