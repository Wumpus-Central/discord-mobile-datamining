...
let fn = function n() {
  ...
  function unpack(arg0, arg1) {
    ...
    if (arg0.length >= 3) {
      ...
      if (typeof type$p === "function") {
        ...
        mapped = arg0[0];
        tmp4 = f109636[typeof call === "unknown" ? toString(first) : call(toString, first)] || "object";
      } else {
  ...
  autodetect.push({
    ...
    test() {
      ...
      if (typeof type$p === "function") {
        ...
        tmp6 = f109636[typeof call === "unknown" ? toString(arr2) : call(toString, arr2)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    },
    ...
    if (typeof last === "function") {
      ...
      if (items.length >= 2) {
        ...
        if (typeof type$p === "function") {
          ...
          str = formatted;
          tmp9 = f109636[typeof call === "unknown" ? toString(tmp6) : call(toString, tmp6)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    test(arg0) {
      ...
      if (!items.length) {
        if (typeof type$p === "function") {
          ...
          tmp8 = f109636[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
    ...
    if (typeof last === "function") {
      ...
      if (items.length >= 2) {
        ...
        if (typeof type$p === "function") {
          ...
          str = formatted;
          tmp13 = f109636[typeof call === "unknown" ? toString(tmp10) : call(toString, tmp10)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
  ...
  function lab2rgb_1() {
    ...
    if (typeof lab_xyz === "function") {
      if (result > obj10.t1) {
        ...
        result1 = obj10.t2 * (result - obj10.t0);
      }
    ...
    return autodetect.push({
      ...
      test() {
        ...
        if (typeof type$p === "function") {
          ...
          tmp7 = f109636[typeof call === "unknown" ? toString(arr2) : call(toString, arr2)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      },
    ...
    test() {
      ...
      if (1 === items.length) {
        ...
        if (typeof type$p === "function") {
          ...
          tmp8 = f109636[typeof call === "unknown" ? toString(first) : call(toString, first)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
          ...
          if (3 !== arr2.length) {
            if (4 === arr2.length) {
              if (typeof tmp4 === "function") {
                ...
                const tmp9 = f109636[typeof call2 === "unknown" ? toString2(tmp8) : call2(toString2, tmp8)] || "object";
              } else {
                throw new TypeError("Trying to call a non-function");
              }
            }
    ...
    if (obj17[first]) {
      if (typeof type$p === "function") {
        ...
        if (typeof tmp13 === "function") {
          ...
          tmp21 = f109636[typeof call2 === "unknown" ? toString2(arg1) : call2(toString2, arg1)] || "object";
        ...
        tmp17 = f109636[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    } else {
    ...
    function setColors(items) {
      ...
      if (items) {
        if (typeof type$p === "function") {
          ...
          const call = toString.call;
          brewer =
            "string" === (f109636[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object");
          const tmp4 = f109636[typeof call === "unknown" ? toString(items) : call(toString, items)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      }
      ...
      if (typeof type$p === "function") {
        ...
        tmp10 = f109636[typeof call2 === "unknown" ? toString2(arr2) : call2(toString2, arr2)] || "object";
      } else {
        throw new TypeError("Trying to call a non-function");
      }
    }
        ...
        if (null !== sum1) {
          ...
          if (typeof type$p === "function") {
            ...
            if ("array" === tmp29) {
              ...
              tmp31 = f109636[typeof call2 === "unknown" ? toString2(substr) : call2(toString2, substr)] || "object";
            } else {
              throw new TypeError("Trying to call a non-function");
            }
            ...
            tmp29 = f109636[typeof call === "unknown" ? toString(substr) : call(toString, substr)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
    ...
    fn.padding = (arg0) => {
      if (null != arg0) {
        if (typeof type$p === "function") {
          ...
          items = tmp6;
          let tmp = fn;
          tmp5 = f109636[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
        } else {
          throw new TypeError("Trying to call a non-function");
        }
      } else {
  ...
  f109636 = (arg0, arg1) => {
    const items = [f109636(arg0[0], arg1[0]), f109636(arg0[1], arg1[1]), f109636(arg0[2], arg1[2])];
    return items;
  };
  blend.normal = (arg0, arg1) => {
    const obj = closure_2_206(arg1);
    const rgbResult = closure_2_206(arg1).rgb();
    return closure_2_206.rgb(f109636(rgbResult, closure_2_206(arg0).rgb()));
  };
      ...
      const item = values.forEach((item) => {
        ...
        if (c0) {
          if (typeof type$p === "function") {
            ...
            const call = toString.call;
            tmp2 =
              "object" === (f109636[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object");
            const tmp6 = f109636[typeof call === "unknown" ? toString(item) : call(toString, item)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
  ...
  function limits(dependencyMap, arg1, arg2) {
    ...
    if (typeof type$p === "function") {
      ...
      tmp4 = f109636[typeof call === "unknown" ? toString(dependencyMap) : call(toString, dependencyMap)] || "object";
    } else {
      throw new TypeError("Trying to call a non-function");
    }
  }
  ...
  chroma$k.bezier = (arr) => {
    ...
    if (2 === mapped.length) {
      ...
      [f109636, type$p, type$p, last] = mapped3;
      fn = function a(arg0) {
        closure_0 = arg0;
        const items = [0, 1, 2];
        return Color(
      ...
      fn.hue = (arg0) => {
        if (null == arg0) {
          ...
          if (typeof type$p === "function") {
            ...
            tmp8 = fn;
            tmp3 = f109636[typeof call === "unknown" ? toString(arg0) : call(toString, arg0)] || "object";
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
