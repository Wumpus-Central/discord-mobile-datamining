...
// Module 13136
import GLOBAL_OBJ from "module_13137" /* 13137 */;

const require = globalThis.__r;

function consoleSandbox(fn) {
  if ("console" in console(13137).GLOBAL_OBJ) {
    console = tmp(13137).GLOBAL_OBJ.console;
    dependencyMap = {};
...
export const logger = GLOBAL_OBJ.getGlobalSingleton("logger", function makeLogger() {
  ...
  if (require("module_13135").DEBUG_BUILD) {
