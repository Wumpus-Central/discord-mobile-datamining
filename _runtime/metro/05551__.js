...
import calculateGPSValueDefault from "../05554_calculateGPSValue.js";
    ...
    for (const key10002 in arg0) {
      ...
      let item = arr2.forEach((attributes) => {
        ...
        if (typeof attributes.value === "object") {
          ParseError(5516).objectAssign(tmp3, parseNodeChildrenAsTags(attributes.value));
