...
export default {
  read(dataView, sum) {
    ...
    let tmp4;
    if (8 <= shortAt) {
      const byteAt = _modDef5535.getByteAt(dataView, sum + 7);
      const obj2 = { value: byteAt, description: "" + byteAt };
      tmp4 = obj2;
      const tmpResult = _modDef5535;
    }
    let tmp6;
    if (3 <= shortAt) {
      const byteAt1 = _modDef5535.getByteAt(dataView, sum + 2);
      const obj3 = { value: byteAt1, description: "" + byteAt1 };
      tmp6 = obj3;
      const tmpResult4 = _modDef5535;
    }
    const obj4 = {
