...
import deepFreeze from "../01505_deepFreeze.js";
import _modDef1506 from "01506__.js";
import context12 from "../01526_context1.js";
import _mod1548 from "01548__.js";
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  dependencyMap = require("01559__.js").useRegisterNavigator();
  const context = noop.useContext(require("01525__.js").NavigationRouteContext);
  ...
  if (mapped.length) {
    ...
    if (null != tmp43) {
      ...
      closure_41 = noop.useContext(tmp30(1517).UnhandledActionContext);
    ...
    const tmp30Result26 = require("01548__.js");
    rehydratedState = tmp39;
    if (!tmp51) {
