...
const entry = {
  ...
  value: function parse(arg0, arg1, ordinalNumber) {
    ...
    if ("M" === arg1) {
      return _createSuperInternal(4153).mapValue(_createSuperInternal(4153).parseNumericPattern(_createSuperInternal(4154).numericPatterns.month, arg0), valueCallback);
    } else if ("MM" === arg1) {
