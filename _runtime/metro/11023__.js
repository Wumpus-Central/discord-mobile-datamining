...
import handlerOffsetDirection from "../11011_handlerOffsetDirection.js";
import round from "../11024_round.js";
...
export const useCarouselController = function useCarouselController(size) {
  ...
  const globalState = require("11015__.js").useGlobalState();
