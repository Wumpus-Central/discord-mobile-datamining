...
import extractPropsDefault from "../07924_extractProps.js";
import extractFontDefault from "../07931_extractFont.js";
import _modDef7933 from "07933__.js";
import _modDef8010 from "08010__.js";
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(
        ...
        Text(7925).pickNotNil(extractFontDefault(propsAndStylesResult, true)),
      );
      if (closure_0.root) {
        const root = closure_0.root;
        root.setNativeProps(propsAndStylesResult);
      }
      const obj2 = Text(7925);
    };
    return tmp3Result;
  }
}
