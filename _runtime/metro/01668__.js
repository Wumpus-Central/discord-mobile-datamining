...
if (!isJest.isJest()) {
  ...
  isJest[1] = function createWorkletRuntime(arg0, arg1) {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("createWorkletRuntime is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[1] = isJest;
  const obj1 = { key: "scheduleOnRuntime", value: null };
  obj1[1] = function scheduleOnRuntime() {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("scheduleOnRuntime is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[2] = obj1;
  let obj2 = { key: "registerEventHandler", value: null };
  obj2[1] = function registerEventHandler(arg0, arg1, arg2) {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("registerEventHandler is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[3] = obj2;
  const obj3 = { key: "unregisterEventHandler", value: null };
  obj3[1] = function unregisterEventHandler(arg0) {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("unregisterEventHandler is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[4] = obj3;
  ...
  obj13[1] = function getSettledUpdates() {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("`getSettledUpdates` is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[14] = obj13;
  ...
  obj15[1] = function getViewProp(arg0, arg1, arg2, arg3) {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("getViewProp is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[16] = obj15;
  const obj16 = { key: "configureProps", value: null };
  obj16[1] = function configureProps() {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("configureProps is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[17] = obj16;
  const obj17 = { key: "executeOnUIRuntimeSync", value: null };
  obj17[1] = function executeOnUIRuntimeSync(arg0) {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("`executeOnUIRuntimeSync` is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[18] = obj17;
  const obj18 = { key: "markNodeAsRemovable", value: null };
  obj18[1] = function markNodeAsRemovable(arg0) {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("markNodeAsRemovable is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[19] = obj18;
  const obj19 = { key: "unmarkNodeAsRemovable", value: null };
  obj19[1] = function unmarkNodeAsRemovable(arg0) {
    const reanimatedError = new JSReanimated(1665).ReanimatedError("unmarkNodeAsRemovable is not available in JSReanimated.");
    throw reanimatedError;
  };
  items[20] = obj19;
