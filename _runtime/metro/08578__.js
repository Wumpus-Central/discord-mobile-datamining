...
let items = [
  ...
  },
  {
    ...
    value: function render() {
      ...
      } else if (resizeMode === Video(8579).contain) {
        ScaleNone = viewManagerConfig.Constants.ScaleAspectFit;
      } else if (resizeMode === Video(8579).cover) {
...
let items1 = [
  _modDef8581.NONE,
  _modDef8581.INVERT,
  _modDef8581.MONOCHROME,
  _modDef8581.POSTERIZE,
  _modDef8581.FALSE,
  _modDef8581.MAXIMUMCOMPONENT,
  _modDef8581.MINIMUMCOMPONENT,
  _modDef8581.CHROME,
  _modDef8581.FADE,
  _modDef8581.INSTANT,
  _modDef8581.MONO,
