...
export const MemoryRouter = Component2(4310).Redirect;
export const Prompt = Component2(4310).Redirect;
export const Redirect = Component2(4310).Redirect;
export const Route = Component2(4310).Route;
export const Router = Component2(4310).Router;
export const StaticRouter = Component2(4310).StaticRouter;
export const Switch = Component2(4310).Switch;
export const generatePath = Component2(4310).generatePath;
export const matchPath = Component2(4310).matchPath;
export const useHistory = Component2(4310).useHistory;
export const useLocation = Component2(4310).useLocation;
export const useParams = Component2(4310).useParams;
export const useRouteMatch = Component2(4310).useRouteMatch;
export const withRouter = Component2(4310).withRouter;
