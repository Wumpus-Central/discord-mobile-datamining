// _runtime/metro/00156__.js
import _modDef154 from "00154__.js";
import _modDef157 from "00157__.js";
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      return new require("ReactNativeStartupTiming")({
        startTime,
          ...
          if ("object" === typeof arg1) {
            ...
            if (typeof getMarkTimeForMeasure === "function") {
              ...
              if (null == tmp21) {
                ...
                tmp35 = new tmp35(
                  "Failed to execute 'measure' on 'Performance': The mark '" + StringResult3 + "' does not exist.",
                  "SyntaxError",
                );
                throw tmp35;
              } else {
