...
let obj = {
  default: fn(7118).DefaultTransition,
  fade: fn(7118).ModalFadeTransition,
  fade_from_bottom: fn(7118).FadeFromBottomAndroid,
  fade_from_right: fn(7118).FadeFromRightAndroid,
  none: fn(7118).DefaultTransition,
  reveal_from_bottom: fn(7118).RevealFromBottomAndroid,
  scale_from_center: fn(7118).ScaleFromCenterAndroid,
  slide_from_left: fn(7118).SlideFromLeftIOS,
  slide_from_right: fn(7118).SlideFromRightIOS,
  slide_from_bottom: fn(7118).BottomSheetAndroid,
};
...
function getDistanceFromOptions(size, gestureDirection, arg2) {
  ...
  if (gestureDirection) {
    ...
    if ("modal" === presentation) {
      gestureDirection = CardStack(7118).ModalTransition.gestureDirection;
      let tmp3 = CardStack;
    } else {
      tmp3 = CardStack;
      gestureDirection = CardStack(7118).DefaultTransition.gestureDirection;
    }
    let animation;
    if (gestureDirection != null) {
        ...
        if (typeof getIsModal === "function") {
          ...
          if (!tmp16) {
            ...
            if (typeof getIsModalPresentation === "function") {
              let tmp20 = cardStyleInterpolator === CardStack(7120).forModalPresentationIOS;
              if (!tmp20) {
                tmp20 = "forModalPresentationIOS" === cardStyleInterpolator.name;
              }
              if (tmp20) {
        ...
        if (index !== arg2.length - 1) {
          ...
          if ("default" !== str2) {
            ...
            if ("modal" !== options.presentation) {
              if (!hasItem1) {
                ModalTransition = CardStack(7118).DefaultTransition;
              }
            }
            ModalTransition = CardStack(7118).ModalTransition;
          }
          ...
          if (undefined !== cardStyleInterpolator) {
            ...
            if (undefined === cardOverlayEnabled) {
              ...
              if (!tmp38) {
                if (typeof getIsModalPresentation === "function") {
                  let tmp42 = cardStyleInterpolator === CardStack(7120).forModalPresentationIOS;
                  if (!tmp42) {
            ...
            if (str10 == null) {
              ...
              if (tmp43) {
                if (typeof getIsModalPresentation === "function") {
                  str10 = "screen";
                  if (cardStyleInterpolator !== CardStack(7120).forModalPresentationIOS) {
            ...
            forNoAnimation = CardStack(7120).forNoAnimation;
          }
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7120).forModalPresentationIOS ||
