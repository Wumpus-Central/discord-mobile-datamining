...
let obj = { default: fn(7118).DefaultTransition, fade: fn(7118).ModalFadeTransition, fade_from_bottom: fn(7118).FadeFromBottomAndroid, fade_from_right: fn(7118).FadeFromRightAndroid, none: fn(7118).DefaultTransition, reveal_from_bottom: fn(7118).RevealFromBottomAndroid, scale_from_center: fn(7118).ScaleFromCenterAndroid, slide_from_left: fn(7118).SlideFromLeftIOS, slide_from_right: fn(7118).SlideFromRightIOS, slide_from_bottom: fn(7118).BottomSheetAndroid };
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 = cardStyleInterpolator === CardStack(7120).forModalPresentationIOS || "forModalPresentationIOS" === cardStyleInterpolator.name;
                let tmp10 = !tmp9;
                if (tmp9) {
