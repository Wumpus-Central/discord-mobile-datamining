// _runtime/metro/13734__.js
import _mod13735 from "13735__.js";
import _mod13736 from "13736__.js";
...
function addLikelySubtags(arr3) {
  ...
  if (script) {
    if (region) {
      ...
      const tmp4 = _mod13800.likelySubtags[_mod13800.emitUnicodeLanguageId(undefined, obj)];
      if (tmp4) {
        const result = _mod13800.parseUnicodeLanguageId(tmp4);
        ...
        return _mod13800.emitUnicodeLocaleId(parseUnicodeLocaleIdResult);
      }
    }
  }
  if (script) {
    const obj4 = { lang, script, variants: [] };
    const tmp5 = _mod13800.likelySubtags[_mod13800.emitUnicodeLanguageId(undefined, obj4)];
    if (tmp5) {
      const result1 = _mod13800.parseUnicodeLanguageId(tmp5);
      let items = variants;
      if (undefined === variants) {
        items = [];
      }
  ...
  if (region) {
    ...
    const tmp6 = _mod13800.likelySubtags[_mod13800.emitUnicodeLanguageId(undefined, obj7)];
    if (tmp6) {
      const result2 = _mod13800.parseUnicodeLanguageId(tmp6);
      let items1 = variants;
      if (undefined === variants) {
        items1 = [];
      }
  ...
  let tmp7 = _mod13800.likelySubtags[lang];
  if (!tmp7) {
    const obj10 = { lang: "und", script, variants: [] };
    tmp7 = _mod13800.likelySubtags[_mod13800.emitUnicodeLanguageId(undefined, obj10)];
  }
  if (tmp7) {
    const result3 = _mod13800.parseUnicodeLanguageId(tmp7);
    let items2 = variants;
    if (undefined === variants) {
      items2 = [];
    }
...
let tmp2 = (() => {
      ...
      try {
        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            const obj3 = { variants: [] };
            const result = Locale(13800).emitUnicodeLanguageId(
              obj.__assign(Locale(1161).__assign({}, Locale(13800).parseUnicodeLanguageId(tmp2)), obj3),
            );
            const parseUnicodeLocaleIdResult = Locale(13800).parseUnicodeLocaleId(arr3);
            ({ lang, script, region, variants } = parseUnicodeLocaleIdResult.lang);
            const obj4 = { lang, variants: [] };
            if (closure_1_6(Locale(13800).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = Locale(13800).emitUnicodeLocaleId(
              ...
              if (region) {
                const obj7 = { lang, region, variants: [] };
                if (closure_1_6(Locale(13800).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = Locale(13800).emitUnicodeLocaleId(
              ...
              if (script) {
                ...
                emitUnicodeLocaleIdResult = arr3;
                if (closure_1_6(Locale(13800).emitUnicodeLanguageId(obj10)) === result) {
  ...
  Object.defineProperty(Locale.prototype, "baseName", {
    get() {
      return Locale(13800).emitUnicodeLanguageId(
        Locale(13800).parseUnicodeLanguageId(module_13735.default(this).locale),
      );
    },
    enumerable: false,
    configurable: true,
