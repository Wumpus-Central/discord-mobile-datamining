// _runtime/metro/06824__.js
import tagMessage2 from "../06710_tagMessage.js";
...
import GestureObjects2 from "../06825_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6806).gestureToPressableEvent(handlerTag));
