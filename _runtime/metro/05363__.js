...
export const isMP4 = function isMP4(fileChunk, excludeSimilarTypes) {
  ...
  if (!checkByFileTypeResult) {
    ...
    if (!excludeSimilarTypes) {
      const fileChunk1 = _mod5355.getFileChunk(fileChunk);
      const FileTypes2 = _mod5356.FileTypes;
      tmp8 = FileTypes2.checkByFileType(fileChunk1, "m4v") && _mod5355.isftypStringIncluded(fileChunk1);
      const tmp10 = FileTypes2.checkByFileType(fileChunk1, "m4v") && _mod5355.isftypStringIncluded(fileChunk1);
    }
