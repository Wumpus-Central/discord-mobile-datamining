...
let items = [
  entry,
  {
    ...
    value: function captureMessage(arg0, arg1, arg2, arg3) {
      const self = this;
      closure_1 = arg3;
      const obj = { event_id: BaseClient(12808).uuid4() };
      const merged = Object.assign(arg2);
      const obj2 = BaseClient(12808);
      let StringResult = arg0;
      if (!obj3.isParameterizedString(arg0)) {
        const _String = String;
        StringResult = String(arg0);
      }
      obj3 = BaseClient(12804);
  ...
  },
  {
    ...
    value: function captureSession(release) {
      if (typeof release.release !== "string") {
        ...
        BaseClient(12820).updateSession(release, { init: false });
        const obj = BaseClient(12820);
      }
    },
  },
  {
  ...
  },
  {
    ...
    value: function flush(arg0) {
      ...
      if (_transport) {
        ...
        nextPromise = BaseClient(12821).resolvedSyncPromise(true);
        const obj = BaseClient(12821);
      }
      return nextPromise;
    },
  },
  ...
  },
  {
    ...
    value: function addIntegration(arg0) {
      BaseClient(12853).setupIntegration(this, arg0, this._integrations);
  ...
  },
  {
    ...
    value: function sendEvent(arg0) {
      ...
      let eventEnvelope = BaseClient(12840).createEventEnvelope(
        arg0,
        self._dsn,
      ...
      for (const item10025 of tmp3) {
        let obj3 = BaseClient(12841);
        let obj4 = BaseClient(12841);
  ...
  },
  {
    ...
    value: function sendSession(arg0) {
      this.sendEnvelope(
        BaseClient(12840).createSessionEnvelope(arg0, this._dsn, this._options._metadata, this._options.tunnel),
      );
    },
  },
  {
  ...
  },
  {
    ...
    value: function _setupIntegrations() {
      ...
      this._integrations = BaseClient(12853).setupIntegrations(this, integrations);
      const obj = BaseClient(12853);
      const result = BaseClient(12853).afterSetupIntegrations(this, integrations);
    },
  },
  {
  ...
  },
  {
    ...
    value: function _isClientDoneProcessing(arg0) {
      const self = this;
      closure_0 = arg0;
      return new BaseClient(12821).SyncPromise((arg0) => {
        closure_0 = arg0;
        c1 = 0;
      ...
      return currentScope(self[15])
        ...
        .then((contexts) => {
          if (null === contexts) {
            ...
            let obj = { trace: BaseClient(12824).getTraceContextFromScope(currentScope) };
            const merged = Object.assign(contexts.contexts);
            contexts.contexts = obj;
            const obj2 = BaseClient(12824);
            obj = { dynamicSamplingContext: BaseClient(12833).getDynamicSamplingContextFromScope(self, currentScope) };
  ...
  },
  {
    ...
    value: function _processEvent(type, arg1, arg2) {
      ...
      if (undefined !== sampleRate) {
        const parseSampleRateResult = str(12837).parseSampleRate(sampleRate);
        let obj = str(12837);
      }
      if (undefined === type) {
        if (typeof parseSampleRateResult === "number") {
          ...
          if (Math.random() > parseSampleRateResult) {
            ...
            let sentryError = new str(12854).SentryError(
              "Discarding event because it's not included in the random sample (sampling rate = " + sampleRate + ")",
              "log",
            );
            return str(12821).rejectedSyncPromise(sentryError);
          }
        }
      }
      str = "replay";
      ...
      let nextPromise = self
        ...
        .then((result) => {
          if (null === result) {
            ...
            let sentryError = new BaseClient(12854).SentryError(
            ...
            if (obj.isThenable(promise)) {
              let nextPromise = promise.then(
                (result) => {
                  if (!obj.isPlainObject(result)) {
                    if (null !== result) {
                      const sentryError = new str(12854).SentryError(combined);
                      throw sentryError;
                    }
                  }
                  return result;
                ...
                (arg0) => {
                  const sentryError = new str(12854).SentryError("" + closure_0 + " rejected with " + arg0);
                  throw sentryError;
                },
              );
            } else {
              ...
              if (!obj2.isPlainObject(promise)) {
                nextPromise = promise;
                if (null !== promise) {
                  const sentryError1 = new BaseClient(12854).SentryError(combined);
                  throw sentryError1;
                }
              }
              obj2 = BaseClient(12804);
            }
            return nextPromise;
          }
        });
      return self
        ...
        .then((sdkProcessingMetadata) => {
          if (null === sdkProcessingMetadata) {
            ...
            const _HermesInternal = HermesInternal;
            const sentryError = new BaseClient(12854).SentryError(
        ...
        .then(null, (originalException) => {
          if (originalException instanceof BaseClient(12854).SentryError) {
            throw originalException;
          } else {
            const obj = { data: { __sentry__: true }, originalException };
            self.captureException(originalException, obj);
            const _HermesInternal = HermesInternal;
            const sentryError = new tmp(12854).SentryError(
