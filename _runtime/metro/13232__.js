...
import COUNTER_METRIC_TYPE from "../13233_COUNTER_METRIC_TYPE.js";
import __SENTRY_DEBUG__ from "13135__.js";
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("13150__.js").timestampInSeconds();
      c4 = timestampInSecondsResult;
      let obj = require("13150__.js");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("13170__.js").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
