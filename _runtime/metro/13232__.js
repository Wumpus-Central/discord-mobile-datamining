...
import { Comparator } from "../13223_Comparator.js";
import { Range } from "../13224_Range.js";
import { Range } from "../13226_Range.js";
...
export default (arg0, arg1, arg2, arg3) => {
  ...
  if (">" === arg2) {
    let dependencyMap = tmp(13215);
    let tmpResult = tmp(13220);
    tmpResult = tmp(13216);
    ...
    str = "<";
    if ("<" === arg2) {
      dependencyMap = tmp(13216);
      tmpResult = tmp(13219);
      tmpResult1 = tmp(13215);
