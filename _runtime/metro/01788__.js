...
import _mod1738 from "01738__.js";
import _mod1784 from "01784__.js";
import o from "../01789_o.js";
...
function styleUpdater(shareableViewDescriptors, fn, c8, sharedValue) {
  ...
  if (flag5) {
    ...
    if (flag4) {
      require("01738__.js").updateProps(shareableViewDescriptors, obj2);
      const obj8 = require("01738__.js");
    }
  } else {
    styleUpdater.isAnimationCancelled = true;
    styleUpdater.animations = [];
    let shallowEqualResult = require("01784__.js").shallowEqual(last, obj);
...
styleUpdater.__closure = {
  ...
  isAnimated: _mod1784.isAnimated,
  prepareAnimation,
  runAnimations,
  updateProps: _mod1738.updateProps,
  shallowEqual: _mod1784.shallowEqual,
};
...
jestStyleUpdater.__closure = {
  ...
  prepareAnimation,
  runAnimations,
  updatePropsJestWrapper: _mod1738.updatePropsJestWrapper,
  shallowEqual: _mod1784.shallowEqual,
};
...
export const useAnimatedStyle = function useAnimatedStyle(fn, items, arg2, arg3) {
  ...
  if (arg2) {
    workletsHash = require("01784__.js").buildWorkletsHash(items1);
    let obj2 = require("01784__.js");
  }
  sharedValue = require("01790__.js").useSharedValue(true);
