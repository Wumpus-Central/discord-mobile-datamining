// _runtime/metro/05031__.js
import _modDef5009 from "05009__.js";
import _modDef5028 from "05028__.js";
import styleDefault from "../05033_style.js";
...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  dependencyMap = flag5.useContext(screenId(5029).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(5032).isIOS26OrHigher;
  }
  _modDef5028(
    isIOS26OrHigher,
  ...
  if (screenId(5032).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(screenId(5036).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(screenId(5038).FooterComponent, obj7);
  }
