...
let fn = () => {
  ...
  function checkOverflow(preparseResult) {
    ...
    if (tmp) {
      ...
      if (null == preparseResult._pf) {
        const obj1 = { empty: false, unusedTokens: [], unusedInput: [], overflow: -2, charsLeftOver: 0, nullInput: false, invalidEra: null, invalidMonth: null, invalidFormat: false, userInvalidated: false, iso: false, parsedDateParts: [], era: null, meridiem: null, rfc2822: false, weekdayMismatch: false };
      ...
      if (null == preparseResult._pf) {
        const obj2 = { empty: false, unusedTokens: [], unusedInput: [], overflow: -2, charsLeftOver: 0, nullInput: false, invalidEra: null, invalidMonth: null, invalidFormat: false, userInvalidated: false, iso: false, parsedDateParts: [], era: null, meridiem: null, rfc2822: false, weekdayMismatch: false };
  ...
  function configFromStringAndFormat(_f) {
    ...
    if (_f._f !== c2.ISO_8601) {
      if (_f._f !== tmp.RFC_2822) {
          ...
          while (true) {
            ...
            if (obj[str7]) {
              ...
              if (first) {
                ...
                if (null == _pf) {
                  obj1 = { empty: false, unusedTokens: [], unusedInput: [], overflow: -2, charsLeftOver: 0, nullInput: false, invalidEra: null, invalidMonth: null, invalidFormat: false, userInvalidated: false, iso: false, parsedDateParts: [], era: null, meridiem: null, rfc2822: false, weekdayMismatch: false };
                  _f._pf = obj1;
                }
              ...
              if (tmp25) {
                if (null == _f._pf) {
                  let obj2 = { empty: false, unusedTokens: [], unusedInput: [], overflow: -2, charsLeftOver: 0, nullInput: false, invalidEra: null, invalidMonth: null, invalidFormat: false, userInvalidated: false, iso: false, parsedDateParts: [], era: null, meridiem: null, rfc2822: false, weekdayMismatch: false };
                  _f._pf = obj2;
                }
        ...
        if (tmp39) {
          if (null == _f._pf) {
            const obj6 = { empty: false, unusedTokens: [], unusedInput: [], overflow: -2, charsLeftOver: 0, nullInput: false, invalidEra: null, invalidMonth: null, invalidFormat: false, userInvalidated: false, iso: false, parsedDateParts: [], era: null, meridiem: null, rfc2822: false, weekdayMismatch: false };
            _f._pf = obj6;
          }
      ...
      if (typeof self !== "number") {
        ...
        if (isNaN(+self)) {
          ...
          if (match) {
            ...
            if (!isFiniteResult) {
              obj = { y: 0, d: 0, h: null, m: null, s: null, ms: null };
            ...
            if (match1) {
              ...
              let obj1 = { y: num6 * num5, M: null, w: null, d: null, h: null, m: null, s: null };
              let parsed1 = str9;
              if (match1[3]) {
                ...
                if (add.isValid()) {
                  if (obj1.isValid()) {
                    ...
                    if (add.isBefore(date)) {
                      ...
                      obj2.months = diff + 12 * (date.year() - add.year());
                      ...
                      const tmp22 = +date;
                      add = add.clone().add;
                      date = add(obj2.months, "M");
                      obj2.milliseconds = tmp22 - +date;
                      const cloneResult1 = add.clone();
                    } else {
                      const diff1 = add.month() - date.month();
                      const monthResult1 = add.month();
                      obj2.months = diff1 + 12 * (add.year() - date.year());
                      const yearResult1 = add.year();
                      const cloneResult2 = date.clone();
                      if (addResult1.isAfter(add)) {
                        obj2.months = obj2.months - 1;
                      }
                      addResult1 = date.clone().add(obj2.months, "M");
                      const tmp17 = +add;
                      obj2.milliseconds = tmp17 - +date.clone().add(obj2.months, "M");
