...
import { SymbolResult1 } from "../13713_SymbolResult1.js";
import { URLSearchParamsImpl } from "../13720_URLSearchParamsImpl.js";
...
obj = {
  value: function next() {
    ...
    let tmp7;
    let tmp8;
    const tmp3 = this[require(undefined, 13713) /* SymbolResult1 */.iterInternalSymbol];
    ({ kind, index } = tmp3);
    const arr = Array.from(tmp3.target[require(undefined, 13713) /* SymbolResult1 */.implSymbol]);
    if (index >= arr.length) {
      return { value: "HermesInternal", done: null };
    } else {
      tmp3.index = index + 1;
      [tmp7, tmp8] = _slicedToArray(arr[index].map(tmp(13713).tryWrapperForImpl), 2);
      if ("key" === kind) {
        let tmp4 = tmp7;
      } else if ("value" === kind) {
        tmp4 = tmp8;
...
obj = {
  ...
  is(arg0) {
    if (arg0) {
      if (obj.hasOwn(arg0, SymbolResult1.implSymbol)) {
        if (arg0[tmp(undefined, 13713).implSymbol] instanceof tmp(13720).implementation) {
          return true;
        }
      }
  ...
  create(arg0, arg1, arg2) {
    if (undefined === arg0[require(undefined, 13713) /* SymbolResult1 */.ctorRegistrySymbol]) {
      const _Error2 = Error;
      const error = new Error("Internal error: invalid global object");
      throw error;
    } else {
      const _URLSearchParams = arg0[tmp(undefined, 13713).ctorRegistrySymbol].URLSearchParams;
  ...
  setup(wrapper) {
    ...
    wrapper[require(undefined, 13713) /* SymbolResult1 */.implSymbol][SymbolResult1.wrapperSymbol] = wrapper;
    if (URLSearchParamsImpl.init) {
      tmp2(13720).init(wrapper[tmp2(undefined, 13713).implSymbol], obj);
      const tmp2Result = tmp2(13720);
    }
    return wrapper;
  },
  install(arg0) {
        ...
        if (this) {
          ...
          if (_exports.is(self)) {
            if (arguments.length < 2) {
              ...
              const items = [];
              items.push(URLSearchParams(13721).USVString(arguments[0], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 1" }));
              const obj = URLSearchParams(13721);
              items.push(URLSearchParams(13721).USVString(arguments[1], { context: "Failed to execute 'append' on 'URLSearchParams': parameter 2" }));
              const tmp12 = self[URLSearchParams(undefined, 13713).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13721).USVString(arguments[0], { context: "Failed to execute 'delete' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13713).implSymbol];
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13721).USVString(arguments[0], { context: "Failed to execute 'get' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13713).implSymbol];
                const get = tmp6.get;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13721).USVString(arguments[0], { context: "Failed to execute 'getAll' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(13721);
                const tmp11 = self[URLSearchParams(undefined, 13713).implSymbol];
                const getAll = tmp11.getAll;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return URLSearchParams(13713).tryWrapperForImpl(HermesBuiltin.apply(items1, tmp11));
              }
            }
          }
          const typeError1 = new TypeError("Illegal invocation");
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const items = [];
                items.push(URLSearchParams(13721).USVString(arguments[0], { context: "Failed to execute 'has' on 'URLSearchParams': parameter 1" }));
                const tmp6 = self[URLSearchParams(undefined, 13713).implSymbol];
                const has = tmp6.has;
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 2) {
                ...
                const items = [];
                items.push(URLSearchParams(13721).USVString(arguments[0], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 1" }));
                const obj = URLSearchParams(13721);
                items.push(URLSearchParams(13721).USVString(arguments[1], { context: "Failed to execute 'set' on 'URLSearchParams': parameter 2" }));
                const tmp12 = self[URLSearchParams(undefined, 13713).implSymbol];
                const items1 = [];
                HermesBuiltin.arraySpread(items, 0);
                return HermesBuiltin.apply(items1, tmp12);
      ...
      },
      {
        ...
        value: function sort() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 13713).implSymbol].sort();
            }
          }
      ...
      },
      {
        ...
        value: function toString() {
          ...
          if (this) {
            const _exports = closure_1.exports;
            if (_exports.is(self)) {
              return self[URLSearchParams(undefined, 13713).implSymbol].toString();
            }
          }
          const typeError = new TypeError("Illegal invocation");
          throw typeError;
          ...
          if (this) {
            ...
            if (_exports.is(self)) {
              if (arguments.length < 1) {
                ...
                const _Array2 = Array;
                let arr = Array.from(self[URLSearchParams(undefined, 13713).implSymbol]);
                let num2 = 0;
                let tmp11 = arr;
                if (0 < arr.length) {
                  do {
                    ...
                    let tmp5 = callback;
                    let tmp6 = callback(arr.map(URLSearchParams(13713).tryWrapperForImpl), 2);
                    [tmp7, tmp8] = tmp6;
                    let call = fn.call;
                    let tmp9 = num2;
                    ...
                    let _Array = Array;
                    arr = Array.from(self[tmp3(undefined, 13713).implSymbol]);
                    num2 = num2 + 1;
                    tmp11 = arr;
    ...
    if (undefined === arg0[URLSearchParams(undefined, 13713).ctorRegistrySymbol]) {
      let _Object = Object;
      const ctorRegistrySymbol = tmp3(13713).ctorRegistrySymbol;
      class URLSearchParams {
        constructor() {
          tmp = outer2_3(this, URLSearchParams);
          first = arguments[0];
    ...
    arg0[URLSearchParams(undefined, 13713).ctorRegistrySymbol].URLSearchParams = tmp;
