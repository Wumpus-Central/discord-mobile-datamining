...
import TouchEventType from "TouchEventType" /* 6991 */;
import _mod7004 from "module_7004" /* 7004 */;

const useMemo = _mod19.useMemo;
function getHandler(arg0, onBegin) {
  if (_mod7004.CALLBACK_TYPE.BEGAN === arg0) {
    return onBegin.onBegin;
  } else if (_mod7004.CALLBACK_TYPE.START === arg0) {
    return onBegin.onActivate;
  } else if (_mod7004.CALLBACK_TYPE.UPDATE === arg0) {
    return onBegin.onUpdate;
  } else if (_mod7004.CALLBACK_TYPE.END === arg0) {
    return onBegin.onDeactivate;
  } else if (_mod7004.CALLBACK_TYPE.FINALIZE === arg0) {
    return onBegin.onFinalize;
  } else if (_mod7004.CALLBACK_TYPE.TOUCHES_DOWN === arg0) {
    return onBegin.onTouchesDown;
  } else if (_mod7004.CALLBACK_TYPE.TOUCHES_MOVE === arg0) {
    return onBegin.onTouchesMove;
  } else if (_mod7004.CALLBACK_TYPE.TOUCHES_UP === arg0) {
    return onBegin.onTouchesUp;
  } else if (_mod7004.CALLBACK_TYPE.TOUCHES_CANCEL === arg0) {
    return onBegin.onTouchesCancel;
  }
}
getHandler.__closure = { CALLBACK_TYPE: _mod7004.CALLBACK_TYPE };
...
function touchEventTypeToCallbackType(arg0) {
  if (TouchEventType.TouchEventType.TOUCHES_DOWN === arg0) {
    return _mod7004.CALLBACK_TYPE.TOUCHES_DOWN;
  } else if (TouchEventType.TouchEventType.TOUCHES_MOVE === arg0) {
    return _mod7004.CALLBACK_TYPE.TOUCHES_MOVE;
  } else if (TouchEventType.TouchEventType.TOUCHES_UP === arg0) {
    return _mod7004.CALLBACK_TYPE.TOUCHES_UP;
  } else if (TouchEventType.TouchEventType.TOUCHES_CANCEL === arg0) {
    return _mod7004.CALLBACK_TYPE.TOUCHES_CANCEL;
  } else {
    return _mod7004.CALLBACK_TYPE.UNDEFINED;
  }
}
let obj = { CALLBACK_TYPE: _mod7004.CALLBACK_TYPE };
touchEventTypeToCallbackType.__closure = { TouchEventType: TouchEventType.TouchEventType, CALLBACK_TYPE: _mod7004.CALLBACK_TYPE };
