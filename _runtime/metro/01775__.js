    ...
    value: function setShouldAnimateExiting() {
      ...
      if (1 === hasOwnProperty.count(this.props.children)) {
        ...
        if (findNodeHandleResult) {
          const result = LayoutAnimationConfig(1681).setShouldAnimateExitingForTag(findNodeHandleResult, !self.props.skipExiting);
          const tmpResult = LayoutAnimationConfig(1681);
        }
