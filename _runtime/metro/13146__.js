...
import COUNTER_METRIC_TYPE from "../13147_COUNTER_METRIC_TYPE.js";
...
export const metrics = {
  ...
  timing(arg0, name, fn) {
    ...
    if (typeof fn === "function") {
      let timestampInSecondsResult = require("13064__.js").timestampInSeconds();
      c4 = timestampInSecondsResult;
      let obj = require("13064__.js");
      const obj3 = { op: "metrics.timing", name, startTime: timestampInSecondsResult, onlyIfParent: true };
      return require("13084__.js").startSpanManual(obj3, (arg0) => {
        closure_0 = arg0;
