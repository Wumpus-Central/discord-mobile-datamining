...
export default (arg0, arg1) => {
  if (arg0 instanceof require(12988) /* SemVer */) {
    ...
    if (typeof StringResult === "ge") {
      ...
      if (obj.rtl) {
        const safeRe2 = tmp(12992).safeRe;
        const t2 = tmp(12992).t;
      ...
      if (null === match2) {
        ...
        return require(12987) /* SemVer */("" + match2[2] + "." + match2[3] || "0" + "." + match2[4] || "0" + str2 + str4, obj);
      }
    }
  }
};