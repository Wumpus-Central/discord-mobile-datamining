// _runtime/metro/04904___INTERNAL_VIEW_CONFIG.js
...
let obj = {
  uiViewClassName: "RNSTabsHost",
  directEventTypes: { topNativeFocusChange: { registrationName: "onNativeFocusChange" } },
  validAttributes: null,
};
obj = {
  tabBarHidden: true,
  nativeContainerBackgroundColor: result.colorAttribute,
  tabBarBackgroundColor: result.colorAttribute,
  ...
  tabBarItemTitleFontColor: result.colorAttribute,
  tabBarItemTitleFontColorActive: result.colorAttribute,
  tabBarItemIconColor: result.colorAttribute,
  tabBarItemIconColorActive: result.colorAttribute,
  tabBarItemActiveIndicatorColor: result.colorAttribute,
  tabBarItemActiveIndicatorEnabled: true,
  tabBarItemRippleColor: result.colorAttribute,
  tabBarItemLabelVisibilityMode: true,
  tabBarTintColor: result.colorAttribute,
