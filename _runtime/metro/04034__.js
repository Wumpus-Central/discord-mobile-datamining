...
const entry = {
  ...
  value: function parse(arg0, arg1) {
    if ("X" === arg1) {
      return _createSuperInternal(4003).parseTimezonePattern(
        _createSuperInternal(4004).timezonePatterns.basicOptionalMinutes,
        arg0,
      );
    } else if ("XX" === arg1) {
      ...
      return _createSuperInternal(4003).parseTimezonePattern(
        _createSuperInternal(4004).timezonePatterns.basicOptionalSeconds,
        arg0,
      );
    } else if ("XXXXX" === arg1) {
      return _createSuperInternal(4003).parseTimezonePattern(
        _createSuperInternal(4004).timezonePatterns.extendedOptionalSeconds,
        arg0,
      );
    } else {
      return _createSuperInternal(4003).parseTimezonePattern(
        _createSuperInternal(4004).timezonePatterns.extended,
        arg0,
      );
    }
  },
