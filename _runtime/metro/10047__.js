// _runtime/metro/10047__.js
import now from "../09908_now.js";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    _inherits(UKCasualTimeParser, _mod10040.AbstractParserWithLeftRightBoundaryChecking);
    const entry = {
                  ...
                  if (!str2.endsWith("\u0437\u0440\u0430\u043D\u043A\u0443")) {
                    if (str2.endsWith("\u043E\u043F\u0456\u0432\u0434\u043D\u0456")) {
                      ...
                      if (str2.match(/наступної\s*ночі/)) {
                        ...
                        UKCasualTimeParser(9890).assignSimilarDate(parsingComponents, date);
