...
export const BaseNavigationContainer = noop.forwardRef(function BaseNavigationContainer(onReady, arg1) {
  ...
  obj2 = require("module_1503");
  const syncState = require("module_1505").useSyncState(() => {
  ...
  const tmpResult = require("module_1505");
  ...
  const tmpResult6 = require("module_1508");
  const childListeners = require("module_1509").useChildListeners();
  ({ listeners: c12, addListener } = childListeners);
  const tmpResult7 = require("module_1509");
  const keyedChildListeners = require("module_1510").useKeyedChildListeners();
  ...
  isReady = tmp20;
  const tmpResult8 = require("module_1510");
  eventEmitter = require("module_1513").useEventEmitter();
  const tmpResult9 = require("module_1513");
  const optionsGetters = require("module_1514").useOptionsGetters({});
  ...
  const tmpResult10 = require("module_1514");
  ...
  obj9.children = scheduleUpdate(require("module_1520").EnsureSingleNavigator, { children: scheduleUpdate(require("ThemeProvider").ThemeProvider, { value: theme, children }) });
