...
import CommonActions2 from "../01490_CommonActions.js";
...
export const BaseNavigationContainer = noop.forwardRef(function BaseNavigationContainer(onReady, arg1) {
  ...
  obj2 = require("01503__.js");
  const syncState = require("01505__.js").useSyncState(() => {
  ...
  const tmpResult = require("01505__.js");
  ...
  const tmpResult6 = require("01508__.js");
  const childListeners = require("01509__.js").useChildListeners();
  ({ listeners: c12, addListener } = childListeners);
  const tmpResult7 = require("01509__.js");
  const keyedChildListeners = require("01510__.js").useKeyedChildListeners();
  ...
  isReady = tmp20;
  const tmpResult8 = require("01510__.js");
  eventEmitter = require("01513__.js").useEventEmitter();
  const tmpResult9 = require("01513__.js");
  const optionsGetters = require("01514__.js").useOptionsGetters({});
  ...
  const tmpResult10 = require("01514__.js");
  ...
  obj9.children = scheduleUpdate(require("01520__.js").EnsureSingleNavigator, { children: scheduleUpdate(require("ThemeProvider").ThemeProvider, { value: theme, children }) });
