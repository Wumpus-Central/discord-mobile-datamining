...
export const continueTrace = (arg0, arg1) => {
  _require = arg1;
  const mainCarrier = require("13154__.js").getMainCarrier();
  const obj = require("13154__.js");
  const tmp = _require;
  const asyncContextStrategy = require("13155__.js").getAsyncContextStrategy(mainCarrier);
  if (asyncContextStrategy.continueTrace) {
    ...
    return tmp(13163).withScope((setPropagationContext) => {
      const result = setPropagationContext.setPropagationContext(
        _mod13148.propagationContextFromHeaders(dependencyMap, _slicedToArray),
      );
      return closure_0();
    });
  }
  const obj2 = require("13155__.js");
};
export const startInactiveSpan = function startInactiveSpan(experimental) {
  _require = experimental;
  let mainCarrier = require("13154__.js").getMainCarrier();
  let obj = require("13154__.js");
  const tmp3 = _require;
  const tmp4 = obj4;
  let asyncContextStrategy = require("13155__.js").getAsyncContextStrategy(mainCarrier);
  ...
  let obj2 = require("13155__.js");
};
export const startNewTrace = function startNewTrace(arg0) {
  _require = arg0;
  return require("13163__.js").withScope((setPropagationContext) => {
      ...
      return undefined !== createChildOrRootSpan
        ...
        : ((fn) => fn())(() => {
            ...
            if (sentryNonRecordingSpan.onlyIfParent) {
              ...
              return tmp(13171).handleCallbackErrors(
