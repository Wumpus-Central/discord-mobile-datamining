...
const combined =
  "(?:on\\s*?)?(" +
  _mod10526.ORDINAL_NUMBER_PATTERN +
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          parsingComponents.imply(
            "year",
            NLMonthNameMiddleEndianParser(10433).findYearClosestToRef(createParsingComponents.refDate, result, tmp3),
          );
        }
        if (index[2]) {
