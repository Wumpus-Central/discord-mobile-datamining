// _runtime/metro/16931__.js
import _modDef16932 from "16932__.js";
...
function captureRef(current, options) {
  if (ViewShot(16932)) {
    ...
    return ViewShot(16932).captureRef(tmp15, options);
  } else {
    const _Error = Error;
...
function releaseCapture(str) {
  if (typeof str === "string") {
    ViewShot(16932).releaseCapture(str);
    const obj = ViewShot(16932);
  }
}
...
export const captureScreen = function captureScreen(options) {
  if (ViewShot(16932)) {
    ...
    return ViewShot(16932).captureScreen(options);
  } else {
    const _Error = Error;
    const error = new Error(
      "react-native-view-shot: NativeModules.RNViewShot is undefined. Make sure the library is linked on the native side.",
