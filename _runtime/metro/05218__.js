// _runtime/metro/05218__.js
import get_synchronousScreenUpdatesEnabledDefault from "../05208_get_synchronousScreenUpdatesEnabled.js";
import _mod5217 from "05217__.js";
import _modDef5219 from "05219__.js";
import animatedComponentDefault from "../05220_animatedComponent.js";
import _mod5221 from "05221__.js";
import SHEET_FIT_TO_CONTENTS from "../05222_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05223_DelayedFreeze.js";
import _mod5225 from "05225__.js";
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5217;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5217.freezeEnabled();
    const tmp2Result6 = _mod5217;
  }
  ...
  if (enabled) {
    if (_mod5217.isNativePlatformSupported) {
      ...
      obj4.fullScreenSwipeEnabled = _mod5225.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5226.Provider, { value: null, children: null });
      }
