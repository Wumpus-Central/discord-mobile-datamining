...
import rubberBandDecay from "../01715_rubberBandDecay.js";
import rigidDecay from "../01716_rigidDecay.js";
...
function validateConfig(clamp) {
  ...
  if (clamp.velocityFactor <= 0) {
    ...
    const reanimatedError2 = new _mod1649.ReanimatedError(
    ...
    if (!clamp.clamp) {
      const reanimatedError3 = new _mod1649.ReanimatedError(
...
fn = function n(userConfig, fn) {
  ...
  fn.__closure = {
    userConfig,
    isValidRubberBandConfig: require("01714__.js").isValidRubberBandConfig,
...
fn.__closure = {
  ...
  isValidRubberBandConfig: fn(1714).isValidRubberBandConfig,
  rubberBandDecay: fn(1715).rubberBandDecay,
  rigidDecay: fn(1716).rigidDecay,
  validateConfig,
