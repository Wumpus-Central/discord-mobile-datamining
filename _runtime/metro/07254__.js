...
let obj = {
  default: fn(7255).DefaultTransition,
  fade: fn(7255).ModalFadeTransition,
  fade_from_bottom: fn(7255).FadeFromBottomAndroid,
  fade_from_right: fn(7255).FadeFromRightAndroid,
  none: fn(7255).DefaultTransition,
  reveal_from_bottom: fn(7255).RevealFromBottomAndroid,
  scale_from_center: fn(7255).ScaleFromCenterAndroid,
  slide_from_left: fn(7255).SlideFromLeftIOS,
  slide_from_right: fn(7255).SlideFromRightIOS,
  slide_from_bottom: fn(7255).BottomSheetAndroid,
};
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7257).forModalPresentationIOS ||
