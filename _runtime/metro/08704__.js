...
import extractFontDefault from "../08628_extractFont.js";
import _modDef8630 from "08630__.js";
import _modDef8707 from "08707__.js";
  ...
  constructor() {
    ...
    tmp3Result.setNativeProps = (matrix) => {
      ...
      const merged = Object.assign(
        ...
        Text(8622).pickNotNil(extractFontDefault(propsAndStylesResult, true)),
      );
      if (closure_0.root) {
        const root = closure_0.root;
        root.setNativeProps(propsAndStylesResult);
      }
      const obj2 = Text(8622);
    };
    return tmp3Result;
  }
}
