    ...
    tmp3Result.build = () => {
      ...
      const fn = function t(originX) {
        ...
        size.opacity = delayFunction(
          delay,
          obj3.withSequence(withTimingResult, delayFunction(1709).withTiming(1, { duration: result })),
        );
      ...
      fn.__closure = {
        delayFunction,
        delay,
        withSequence: FadingTransition(1709).withSequence,
        withTiming: FadingTransition(1709).withTiming,
        halfDuration: result,
        withDelay: FadingTransition(1709).withDelay,
        callback: callbackV,
      };
