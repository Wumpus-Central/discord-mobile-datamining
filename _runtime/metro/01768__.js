  ...
  constructor() {
    ...
    tmp3Result.build = () => {
      ...
      const fn = function n(originX) {
        ...
        size.originY = delayFunction(delay, obj4.withSequence(withTimingResult, delayFunction(1708).withTiming(originX.targetOriginY, obj)));
      ...
      __closure = { delayFunction, delay, withTiming: JumpingTransition(1708).withTiming, config: __closure, withSequence: JumpingTransition(1708).withSequence, halfDuration: result, Easing: JumpingTransition(1688).Easing, callback: callbackV };
