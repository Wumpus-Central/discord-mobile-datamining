// _runtime/metro/06095__.js
import handlerIDToTag2 from "../06072_handlerIDToTag.js";
import tagMessage from "../06073_tagMessage.js";
import _mod6090 from "06090__.js";
...
import ActionType from "../06101_ActionType.js";
...
let closure_10 = {
  [fn(6074).State.UNDETERMINED]: undefined,
  [fn(6074).State.BEGAN]: "onBegan",
  [fn(6074).State.FAILED]: "onFailed",
  [fn(6074).State.CANCELLED]: "onCancelled",
  [fn(6074).State.ACTIVE]: "onActivated",
  [fn(6074).State.END]: "onEnded",
};
