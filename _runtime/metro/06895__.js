...
const memoResult = memo(function BottomSheetRefreshControlComponent(arg0) {
  ...
  dependencyMap = tmp4;
  let obj = scrollableGesture(6682);
  ...
  obj = { animatedScrollableState: iter, SCROLLABLE_STATE: scrollableGesture(6678).SCROLLABLE_STATE };
  fn.__closure = obj;
  ...
  if (tmp7) {
    ...
    let tmp8Result = jsx(scrollableGesture(6705).GestureDetector, { gesture: tmp7, children: null });
  } else {
    const obj2 = {};
