...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    exports.instanceof = function _instanceof(Class, enc) {
      ...
      const util = require("12645__.js").util;
    ...
    exports.ZodType = fnResult.$constructor("ZodType", (_standard, def) => {
      ...
      obj = { input: require("../12707_initializeContext.js").createStandardJSONSchemaMethod(_standard, "input"), output: require("../12707_initializeContext.js").createStandardJSONSchemaMethod(_standard, "output") };
      obj[0] = obj;
      let merged = Object.assign(_standard["~standard"], obj);
      _standard.toJSONSchema = require("../12707_initializeContext.js").createToJSONSchemaMethod(_standard, {});
      _standard.def = def;
    ...
    exports.ZodObject = fnResult.$constructor("ZodObject", (_zod) => {
      ...
      let util = require("12645__.js").util;
