...
import handlerIDToTag2 from "../06767_handlerIDToTag.js";
import tagMessage from "../06768_tagMessage.js";
import _mod6785 from "06785__.js";
...
import ghQueueMicrotask from "../06795_ghQueueMicrotask.js";
import ActionType from "../06796_ActionType.js";
...
let closure_10 = {
  [fn(6769).State.UNDETERMINED]: undefined,
  [fn(6769).State.BEGAN]: "onBegan",
  [fn(6769).State.FAILED]: "onFailed",
  [fn(6769).State.CANCELLED]: "onCancelled",
  [fn(6769).State.ACTIVE]: "onActivated",
  [fn(6769).State.END]: "onEnded",
};
