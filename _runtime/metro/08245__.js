...
function SceneView(arg0) {
  ...
  obj12.children = closure_11(num6(5934).HeaderHeightContext.Provider, obj13);
...
export const NativeStackView = function NativeStackView(state) {
  ...
  const setNextDismissedKey = require("08250__.js").useDismissedRouteError(state).setNextDismissedKey;
  let obj = require("08250__.js");
  const invalidPreventRemoveError = require("08251__.js").useInvalidPreventRemoveError(descriptors);
  const obj2 = require("08251__.js");
  const modalRouteKeys = require("08252__.js").getModalRouteKeys(state.routes, descriptors);
  ...
  return closure_10(require("05934__.js").SafeAreaProviderCompat, obj4);
};
