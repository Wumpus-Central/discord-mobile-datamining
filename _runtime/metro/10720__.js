...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      RUWeekdayParser(10581).matchAnyPattern(RUWeekdayParser(10710).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return RUWeekdayParser(10608).createParsingComponentsAtWeekday(
        reference.reference,
        RUWeekdayParser(10710).WEEKDAY_DICTIONARY[formatted],
        str3,
      );
    },
  },
