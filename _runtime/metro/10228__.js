...
import SINGLE_ITEM from "../10213_SINGLE_ITEM.js";
import handlerOffsetDirection from "../10216_handlerOffsetDirection.js";
import round from "../10229_round.js";
...
export const useCarouselController = function useCarouselController(size) {
  ...
  const globalState = require("10220__.js").useGlobalState();
