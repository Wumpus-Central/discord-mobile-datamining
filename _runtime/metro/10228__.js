...
import SINGLE_ITEM from "SINGLE_ITEM" /* 10213 */;
import handlerOffsetDirection from "handlerOffsetDirection" /* 10216 */;
import round from "round" /* 10229 */;
...
export const useCarouselController = function useCarouselController(size) {
  ...
  const globalState = require("module_10220").useGlobalState();
