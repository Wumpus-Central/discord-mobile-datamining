...
import get0thIfdOffset from "../05318_get0thIfdOffset.js";
import IFD_TYPE_0TH from "../05319_IFD_TYPE_0TH.js";
...
export default {
  read(getUint16, c5, arg2) {
    ...
    if (undefined !== ifd[c3]) {
      ...
      objectAssignResult = _mod5298.objectAssign(
        ifd,
    ...
    if (undefined !== objectAssignResult[c4]) {
      ...
      objectAssignResult3 = _mod5298.objectAssign(
        objectAssignResult,
        tmp3Result8.readIfd(
          getUint16,
    ...
    if (undefined !== objectAssignResult3[c5]) {
      ...
      objectAssignResult4 = _mod5298.objectAssign(
        objectAssignResult3,
