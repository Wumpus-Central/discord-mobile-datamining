...
import alphaNum from "../10844_alphaNum.js";
...
const items = [
  entry,
  {
    ...
    value: function extract(reference, arg1) {
      const tmp3 = JPWeekdayWithParenthesesParser(10844).WEEKDAY_OFFSET[arg1.groups.weekday];
      let parsingComponentsAtWeekday = null;
      if (undefined !== tmp3) {
        parsingComponentsAtWeekday = JPWeekdayWithParenthesesParser(10801).createParsingComponentsAtWeekday(
          reference.reference,
          tmp3,
        );
      }
