...
fn.__closure = {
  ANIMATION_CONFIGS: fn(6046).ANIMATION_CONFIGS,
  ANIMATION_METHOD: fn(6046).ANIMATION_METHOD,
  withTiming: fn(1638).withTiming,
  withSpring: fn(1638).withSpring,
};
