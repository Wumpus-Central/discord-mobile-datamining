// _runtime/metro/07012__.js
import handlerIDToTag2 from "../06989_handlerIDToTag.js";
import tagMessage from "../06990_tagMessage.js";
import _mod7007 from "07007__.js";
import RNGestureHandlerModuleDefault from "../07014_RNGestureHandlerModule.js";
...
import ActionType from "../07018_ActionType.js";
...
let closure_10 = {
  [fn(6991).State.UNDETERMINED]: undefined,
  [fn(6991).State.BEGAN]: "onBegan",
  [fn(6991).State.FAILED]: "onFailed",
  [fn(6991).State.CANCELLED]: "onCancelled",
  [fn(6991).State.ACTIVE]: "onActivated",
  [fn(6991).State.END]: "onEnded",
};
