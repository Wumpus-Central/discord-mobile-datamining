...
import tagMessage2 from "../06731_tagMessage.js";
import touchDataToPressEvent from "../06827_touchDataToPressEvent.js";
import StateMachineEvent2 from "../06830_StateMachineEvent.js";
import GestureObjects2 from "../06846_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6827).gestureToPressableEvent(handlerTag));
