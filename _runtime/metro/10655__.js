...
let closure_6 =
  ...
  _mod10656.TIME_UNITS_PATTERN +
  ")" +
  _mod10656.REGEX_PARTS.rightBoundary;
    ...
    value: function innerPattern(option) {
      ...
      if (option.option.forwardDate) {
        ...
        const combined =
          ...
          closure_6;
        _RegExp = new _RegExp(combined, UKTimeUnitWithinFormatParser(10656).REGEX_PARTS.flags);
      }
      return _RegExp;
    },
  },
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ParsingComponents.createRelativeFromReference(
        reference.reference,
        UKTimeUnitWithinFormatParser(10656).parseDuration(arg1[1]),
      );
    },
  },
];
