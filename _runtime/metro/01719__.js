// _runtime/metro/01719__.js
import _mod1677 from "01677__.js";
import _mod1720 from "01720__.js";
...
fn = function n(toValue, userConfig, callback) {
    ...
    let obj3 = {
      ...
      onStart(toValue, current, arg2, lastTimestamp) {
        ...
        if (lastTimestamp) {
          ...
          } = closure_0(1720).initialCalculations(mass, tmp));
  ...
  let obj = require("01677__.js");
  fn.__closure = {
    userConfig,
    checkIfConfigIsValid: require("01720__.js").checkIfConfigIsValid,
    underDampedSpringCalculations: require("01720__.js").underDampedSpringCalculations,
    criticallyDampedSpringCalculations: require("01720__.js").criticallyDampedSpringCalculations,
    isAnimationTerminatingCalculation: require("01720__.js").isAnimationTerminatingCalculation,
    calculateNewMassToMatchDuration: require("01720__.js").calculateNewMassToMatchDuration,
    initialCalculations: require("01720__.js").initialCalculations,
    scaleZetaToMatchClamps: require("01720__.js").scaleZetaToMatchClamps,
    toValue,
    callback,
    getReduceMotionForAnimation: require("01677__.js").getReduceMotionForAnimation,
  };
...
fn.__closure = {
  defineAnimation: fn(1677).defineAnimation,
  checkIfConfigIsValid: fn(1720).checkIfConfigIsValid,
  underDampedSpringCalculations: fn(1720).underDampedSpringCalculations,
  criticallyDampedSpringCalculations: fn(1720).criticallyDampedSpringCalculations,
  isAnimationTerminatingCalculation: fn(1720).isAnimationTerminatingCalculation,
  calculateNewMassToMatchDuration: fn(1720).calculateNewMassToMatchDuration,
  initialCalculations: fn(1720).initialCalculations,
  scaleZetaToMatchClamps: fn(1720).scaleZetaToMatchClamps,
  getReduceMotionForAnimation: fn(1677).getReduceMotionForAnimation,
};
