...
import REGEX_PARTS from "../10593_REGEX_PARTS.js";
  ...
  entry,
  {
    ...
    value: function innerPattern(option) {
      ...
      if (option.option.forwardDate) {
        _RegExp = new _RegExp(closure_6, RUTimeUnitWithinFormatParser(10593).REGEX_PARTS.flags);
      } else {
        const _HermesInternal = HermesInternal;
        const combined =
          "(?:\u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435|\u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0438)\\s*" +
          closure_6;
        _RegExp = new _RegExp(combined, RUTimeUnitWithinFormatParser(10593).REGEX_PARTS.flags);
      }
      return _RegExp;
    },
  },
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return ParsingComponents.createRelativeFromReference(
        reference.reference,
        RUTimeUnitWithinFormatParser(10593).parseDuration(arg1[1]),
      );
    },
  },
];
