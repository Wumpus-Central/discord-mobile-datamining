...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      "(?:\u0437|\u0456\u0437)?\\s*(" +
      UKMonthNameLittleEndianParser(10591).ORDINAL_NUMBER_PATTERN +
      ")(?:\\s{0,3}(?:\u043F\u043E|-|\u2013|\u0434\u043E)?\\s{0,3}(" +
      UKMonthNameLittleEndianParser(10591).ORDINAL_NUMBER_PATTERN +
      "))?(?:-|\\/|\\s{0,3}(?:of)?\\s{0,3})(" +
      UKMonthNameLittleEndianParser(10437).matchAnyPattern(UKMonthNameLittleEndianParser(10591).MONTH_DICTIONARY) +
      ")(?:(?:-|\\/|,?\\s{0,3})(" +
      UKMonthNameLittleEndianParser(10591).YEAR_PATTERN +
      "(?![^\\s]\\d)))?"
    );
  },
};
    ...
    value: function innerExtract(createParsingResult, index) {
      ...
      if (result > 31) {
        ...
        if (index[4]) {
          ...
          start.imply(
            "year",
            UKMonthNameLittleEndianParser(10438).findYearClosestToRef(
