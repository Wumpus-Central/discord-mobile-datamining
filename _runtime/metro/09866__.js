// _runtime/metro/09866__.js
import QR8bitByte from "../09867_QR8bitByte.js";
import QRRSBlock from "../09869_QRRSBlock.js";
import QRBitBuffer from "../09871_QRBitBuffer.js";
...
prototype.setupPositionAdjustPattern = function () {
  const self = this;
  const patternPosition = _mod9872.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function (arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9872.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function (arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9872.getBCHTypeInfo((this.errorCorrectLevel << 3) | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
