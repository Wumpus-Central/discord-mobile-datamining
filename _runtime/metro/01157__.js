        ...
        if (typeof nodes[v0] === "string") {
          ...
          if (first === builder(originalMessage[6]).FormatJsNodeType.Pound) {
            ...
            if (tmp98(originalMessage[6]).FormatJsNodeType.Argument === first) {
              ...
              const obj2 = { Builder: builder.constructor, nodes: tmp2[2], locales, dataFormatters, formatConfig, values, currentPluralValue, keyPrefix: null };
              const _HermesInternal5 = HermesInternal;
              obj2.keyPrefix = "" + keyPrefix + "." + v0;
              const tmp49 = v0(obj2);
              if (null != tmp2[3]) {
                const obj3 = { Builder: obj6.constructor, nodes: tmp40, locales: tmp43, dataFormatters, formatConfig, values, currentPluralValue, keyPrefix: null };
                const _HermesInternal6 = HermesInternal;
                obj3.keyPrefix = "" + keyPrefix + "." + v0 + "-control";
                let items1 = v0(obj3);
              } else {
                items1 = [];
              }
              ...
              if (null == tmp26) {
                ...
                const obj4 = { builder, nodes: tmp26, locales, dataFormatters, formatConfig, values, keyPrefix: null };
                const _HermesInternal3 = HermesInternal;
                obj4.keyPrefix = "" + keyPrefix + "." + v0;
                keyPrefix(obj4);
              }
              ...
              if (null == tmp104) {
                ...
                let obj = { builder, nodes: tmp104, locales, dataFormatters, formatConfig, values, currentPluralValue: null, keyPrefix: null };
                let num2 = 0;
                if (null != tmp103) {
                  num2 = tmp103;
                }
