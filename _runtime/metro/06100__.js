// _runtime/metro/06100__.js
import handlerIDToTag2 from "../06077_handlerIDToTag.js";
import tagMessage from "../06078_tagMessage.js";
import _mod6095 from "06095__.js";
...
import ghQueueMicrotask from "../06105_ghQueueMicrotask.js";
import ActionType from "../06106_ActionType.js";
...
let closure_10 = {
  [fn(6079).State.UNDETERMINED]: undefined,
  [fn(6079).State.BEGAN]: "onBegan",
  [fn(6079).State.FAILED]: "onFailed",
  [fn(6079).State.CANCELLED]: "onCancelled",
  [fn(6079).State.ACTIVE]: "onActivated",
  [fn(6079).State.END]: "onEnded",
};
