...
export default forwardRef((bottomOffset, arg1) => {
  ...
  const reanimatedFocusedInput = require("01830__.js").useReanimatedFocusedInput();
  const input = reanimatedFocusedInput.input;
  const update = reanimatedFocusedInput.update;
  const obj10 = require("01830__.js");
  ...
  let height = require("01830__.js").useWindowDimensions().height;
  ...
  obj = {
    ...
    scrollDistanceWithRespectToSnapPoints: require("01848__.js").scrollDistanceWithRespectToSnapPoints,
  ...
  const obj17 = require("01830__.js");
  const items10 = [tmp34];
  require("01830__.js").useFocusedInputHandler({ onSelectionChange: tmp34 }, items10);
  const obj22 = require("01830__.js");
  ...
  require("01849__.js").useSmoothKeyboardHandler(obj3, items11);
  const items12 = [update, tmp31];
  const tmp37 = num2(
    flag2(function* (arg0, value) {
      if (c3 === 2) {
        c3 = 3;
        throw new TypeError("Generator functions may not be called on executing generators");
      } else if (tmp4 === 3) {
  ...
  const obj23 = require("01849__.js");
  class De {
    constructor() {
      return input.value;
    }
