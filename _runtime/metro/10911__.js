...
const items = [
  entry,
  {
    ...
    value: function innerPattern(arg0) {
      const regExp = new RegExp(this.innerPatternString(arg0), AbstractParserWithLeftRightBoundaryChecking(10909).REGEX_PARTS.flags);
      return regExp;
    }
  },
  {
...
const entry1 = {
  key: "innerPattern",
  value: function innerPattern(arg0) {
    const combined = "" + this.innerPatternString(arg0) + AbstractParserWithLeftRightBoundaryChecking(10909).REGEX_PARTS.rightBoundary;
