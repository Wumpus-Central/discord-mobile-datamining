...
export const useIAP = () => {
  const iAPContext = require("10530__.js").useIAPContext();
  ...
  return {
    ...
    requestPurchase: require("10515__.js").requestPurchase,
    requestSubscription: require("10515__.js").requestSubscription,
  };
};
