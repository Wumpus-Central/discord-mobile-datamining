...
import ScrollableContainer from "../06950_ScrollableContainer.js";
...
export const createBottomSheetScrollableComponent = function createBottomSheetScrollableComponent(
  ...
  return closure_4((overScrollMode, arg1) => {
    ...
    const scrollHandler1 = _mod6740.useScrollHandler(
      scrollEventsHandlersHook,
      onScroll,
      onScrollBeginDrag,
      onScrollEndDrag,
    ...
    const scrollableSetter = _mod6740.useScrollableSetter(
      scrollableRef,
      SCROLLVIEW,
