// _runtime/metro/01693__.js
import _mod1642 from "01642__.js";
import _mod1663 from "01663__.js";
import linear from "../01690_linear.js";
import TransitionType from "../01694_TransitionType.js";
import maybeModifyStyleForKeyframe from "../01707_maybeModifyStyleForKeyframe.js";
import BaseAnimationBuilder from "../01708_BaseAnimationBuilder.js";
import _mod1724 from "01724__.js";
import findDescendantWithExitingAnimation from "../01725_findDescendantWithExitingAnimation.js";
import TransitionGenerator from "../01726_TransitionGenerator.js";
...
function startWebLayoutAnimation(props, _componentDOMRef, ENTERING, easingY) {
  ...
  if (entering) {
    ...
    let flag =
      ...
      !(ENTERING === _mod1663.LayoutAnimationType.LAYOUT || tmp5 || undefined !== entering.initialValues);
    if (flag) {
