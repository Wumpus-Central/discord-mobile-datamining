...
function streamHandler(clone) {
  ...
  try {
    !(function resolveResponse(clone, arg1) {
      ...
      const obj = { endTimestamp: 1000 * _mod12904.timestampInSeconds(), response };
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(errorCallback) {
  _mod12888.addHandler("fetch-body-resolved", errorCallback);
      ...
      closure_0(12896).fill(closure_0(12891).GLOBAL_OBJ, "fetch", (arg0) => {
        ...
        return () => {
          ...
          return stack.apply(stack(dependencyMap[5]).GLOBAL_OBJ, items).then(function(result) {
            ...
            obj.endTimestamp = 1000 * closure_3_0(12904).timestampInSeconds();
            obj.error = error;
            ...
            if (tmp5) {
              ...
              const result = closure_3_0(12896).addNonEnumerableProperty(error, "framesToPop", 1);
              const tmpResult = closure_3_0(12896);
            }
            throw error;
          });
        };
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(errorCallback, arg1) {
  _require = arg1;
  require("12888__.js").addHandler("fetch", errorCallback);
  let obj = require("12888__.js");
  require("12888__.js").maybeInstrument("fetch", () => {
    let flag = closure_0;
