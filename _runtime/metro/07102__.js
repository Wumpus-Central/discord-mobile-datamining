// _runtime/metro/07102__.js
import tagMessage2 from "../06988_tagMessage.js";
...
import GestureObjects2 from "../07103_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(7084).gestureToPressableEvent(handlerTag));
