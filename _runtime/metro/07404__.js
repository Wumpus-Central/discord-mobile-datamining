// _runtime/metro/07404__.js
import _mod7406 from "07406__.js";
import _extends from "07405__.js";
...
if (_extends) {
  ...
  if (_module1) {
    ...
    function matchSorter(valueResult, query, arg2) {
      ...
      return fn(
        valueResult.reduce(function reduceItemsToRanked(arr, rankedValue, index) {
          let str3;
          arr = constants;
          closure_1 = obj;
          if (constants) {
            ...
            reduced = {
              rankedValue,
              rank: getMatchRanking(rankedValue, tmp, tmp2),
              keyIndex: -1,
              keyThreshold: tmp2.threshold,
            };
          }
