// _runtime/metro/05497__.js
import _mod5498 from "05498__.js";

const _mod5499 = tmp5(5499);
require = arg1;
...
export const detectFile = function detectFile(uint8Array, chunkSize) {
  ...
  const fileChunk = _mod5498.getFileChunk(uint8Array, num3);
  if (0 !== fileChunk.length) {
    const items = [];
    const items1 = [];
    for (const key10027 in _mod5499.FileTypes) {
      let _Object4 = Object;
      let call2 = hasOwnProperty2.call;
      let tmp23 = require;
      let FileTypes5 = _mod5499.FileTypes;
    ...
    if (0 !== items.length) {
      ...
      const FileTypes4 = _mod5499.FileTypes;
