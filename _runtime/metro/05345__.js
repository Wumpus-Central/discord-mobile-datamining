  ...
  read(byteLength, arg1, arg2, arg3) {
    ...
    if (LevelInfo) {
      ...
      if (sum1 + 7 <= byteLength.byteLength) {
        ...
        const int16 = byteLength.getInt16(sum2, byteOrder === _modDef5306.LITTLE_ENDIAN);
        const obj5 = { value: int16, description: "" + -0.5 * int16 };
        obj3.RollAngle = obj5;
        const sum3 = sum1 + tmp17.PITCH_ANGLE;
        const int161 = byteLength.getInt16(sum3, byteOrder === _modDef5306.LITTLE_ENDIAN);
