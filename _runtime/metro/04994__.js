...
import _mod4999 from "04999__.js";
import _modDef5000 from "05000__.js";
...
export default function TabsHost(arg0) {
  ...
  const obj2 = {
    style: null,
    navStateRequest,
    onTabSelected: _mod4999.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected,
