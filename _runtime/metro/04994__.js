...
export default function TabsHost(arg0) {
  ...
  return jsx(_modDef5000, { style: null, navStateRequest, onTabSelected: _mod4999.useTabsHost({ componentNodeRef: ref, onTabSelected }).onTabSelected, nativeContainerBackgroundColor: null, ref: null });
};