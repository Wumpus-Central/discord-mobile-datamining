...
let obj = {
  default: fn(7122).DefaultTransition,
  fade: fn(7122).ModalFadeTransition,
  fade_from_bottom: fn(7122).FadeFromBottomAndroid,
  fade_from_right: fn(7122).FadeFromRightAndroid,
  none: fn(7122).DefaultTransition,
  reveal_from_bottom: fn(7122).RevealFromBottomAndroid,
  scale_from_center: fn(7122).ScaleFromCenterAndroid,
  slide_from_left: fn(7122).SlideFromLeftIOS,
  slide_from_right: fn(7122).SlideFromRightIOS,
  slide_from_bottom: fn(7122).BottomSheetAndroid,
};
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7124).forModalPresentationIOS ||
