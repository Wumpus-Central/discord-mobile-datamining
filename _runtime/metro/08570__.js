...
const forwardRefResult = forwardRef((overScrollMode, arg1) => {
  ...
  const items3 = [require("08573__.js").container, require("08573__.js").webView, style];
  const items4 = [require("08573__.js").container, containerStyle];
