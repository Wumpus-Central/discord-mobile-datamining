// _runtime/metro/05405__.js
import _mod5402 from "05402__.js";
import _mod5403 from "05403__.js";
import _mod5406 from "05406__.js";
import is7Z from "../05407_is7Z.js";
import _mod5408 from "05408__.js";
import _mod5409 from "05409__.js";
...
if (self2) {
  ...
  exports.validateFileType = function validateFileType(fileChunk, arr, chunkSize) {
    ...
    for (const item10023 of items1) {
      ...
      hasOwnProperty = Object.prototype.hasOwnProperty;
      let call = hasOwnProperty.call;
      let FileTypes = _mod5403.FileTypes;
      if (typeof call === "unknown") {
    ...
    for (const item10079 of combined) {
      let tmp21 = require;
      let FileTypes2 = _mod5403.FileTypes;
      items2 = items2.concat(FileTypes2.getSignaturesByName(item10079));
      let FILE_TYPES_REQUIRED_ADDITIONAL_CHECK = _mod5403.FILE_TYPES_REQUIRED_ADDITIONAL_CHECK;
      if (FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.includes(item10079.toLowerCase())) {
        let FileTypes3 = tmp21(5403).FileTypes;
    ...
    fileChunk = _mod5402.getFileChunk(fileChunk, num2);
    const FileTypes4 = _mod5403.FileTypes;
    ...
    if (detectSignatureResult) {
      if (items3.length > 0) {
        ...
        if (found.length > 0) {
          const FileTypes5 = _mod5403.FileTypes;
