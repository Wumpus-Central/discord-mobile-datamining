// _runtime/metro/10122__.js
import QR8bitByte from "../10123_QR8bitByte.js";
import QRRSBlock from "../10125_QRRSBlock.js";
import QRBitBuffer from "../10127_QRBitBuffer.js";
import _mod10128 from "10128__.js";
import QRPolynomial from "../10129_QRPolynomial.js";
...
prototype.setupPositionAdjustPattern = function () {
  const self = this;
  const patternPosition = _mod10128.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function (arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod10128.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    if (!arg0) {
...
prototype.setupTypeInfo = function (arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod10128.getBCHTypeInfo((this.errorCorrectLevel << 3) | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    if (!arg0) {
