...
let obj = {
  default: fn(7346).DefaultTransition,
  fade: fn(7346).ModalFadeTransition,
  fade_from_bottom: fn(7346).FadeFromBottomAndroid,
  fade_from_right: fn(7346).FadeFromRightAndroid,
  none: fn(7346).DefaultTransition,
  reveal_from_bottom: fn(7346).RevealFromBottomAndroid,
  scale_from_center: fn(7346).ScaleFromCenterAndroid,
  slide_from_left: fn(7346).SlideFromLeftIOS,
  slide_from_right: fn(7346).SlideFromRightIOS,
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7348).forModalPresentationIOS ||
