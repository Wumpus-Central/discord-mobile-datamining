// _runtime/metro/05220__.js
import get_synchronousScreenUpdatesEnabledDefault from "../05210_get_synchronousScreenUpdatesEnabled.js";
import _mod5219 from "05219__.js";
import _modDef5221 from "05221__.js";
import animatedComponentDefault from "../05222_animatedComponent.js";
import _mod5223 from "05223__.js";
import SHEET_FIT_TO_CONTENTS from "../05224_SHEET_FIT_TO_CONTENTS.js";
import DelayedFreezeDefault from "../05225_DelayedFreeze.js";
...
const jsx = fn(21).jsx;
const __INTERNAL_VIEW_CONFIG = Animated.createAnimatedComponent(_modDef5221);
...
const forwardRefResult = noop.forwardRef(function InnerScreen(activityState, arg1) {
  ...
  const previous = _mod5223.usePrevious(activityState.activityState);
  ...
  if (undefined === enabled) {
    ...
    const tmp2Result = _mod5219;
  }
  let freezeOnBlur = activityState.freezeOnBlur;
  if (undefined === freezeOnBlur) {
    freezeOnBlur = _mod5219.freezeEnabled();
    const tmp2Result6 = _mod5219;
  }
  ...
  if (enabled) {
    if (_mod5219.isNativePlatformSupported) {
      ...
      obj4.fullScreenSwipeEnabled = _mod5227.parseBooleanToOptionalBooleanNativeProp(fullScreenSwipeEnabled);
      let num7;
      ...
      if (isNativeStack) {
        ...
        tmp31Result = jsx(_modDef5228.Provider, { value: null, children: null });
      }
