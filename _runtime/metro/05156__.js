...
import _modDef5153 from "05153__.js";
import styleDefault from "../05158_style.js";
...
export default noop.forwardRef(function ScreenStackItem(arg0, arg1) {
  ...
  dependencyMap = flag5.useContext(screenId(5154).RNSScreensRefContext);
  ...
  if (isIOS26OrHigher) {
    isIOS26OrHigher = screenId(5157).isIOS26OrHigher;
  }
  _modDef5153(
    isIOS26OrHigher,
  ...
  if (screenId(5157).isIOS26OrHigher) {
    ...
    tmp19Result = tmp19(screenId(5161).SafeAreaView, obj5);
  }
  ...
  if (tmp19Result2) {
    ...
    tmp19Result2 = tmp19(screenId(5163).FooterComponent, obj7);
  }
