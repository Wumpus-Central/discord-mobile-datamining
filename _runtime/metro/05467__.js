// _runtime/metro/05467__.js
import _wrapNativeSuperDefault from "00158__wrapNativeSuper.js";
import _modDef5468 from "05468__.js";
import calculateGPSValueDefault from "../05470_calculateGPSValue.js";
    ...
    for (const key10002 in arg0) {
      ...
      let item = arr2.forEach((attributes) => {
        ...
        if (typeof attributes.value === "object") {
          ParseError(5432).objectAssign(tmp3, parseNodeChildrenAsTags(attributes.value));
