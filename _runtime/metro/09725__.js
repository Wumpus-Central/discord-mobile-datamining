// _runtime/metro/09725__.js
import _mod17 from "00017__.js";
import jsxProd from "../react/00021_jsxProd.js";
import noop from "00019__.js";
import 09726__ from "09726__.js";

({ useCallback: c2, useEffect: c3, useRef: closure_4 } = noop);
const NativeEventEmitter = _mod17.NativeEventEmitter;
const jsx = jsxProd.jsx;
const nativeComponent = module_9726.getNativeComponent();
const nativeModule = module_9726.getNativeModule();
      ...
      if (typeof toIsoWithTimeZoneOffset === "function") {
        ...
        if (typeof getTimezoneOffsetInMinutes === "function") {
          ...
          if (typeof getStyle === "function") {
            ...
            obj.props = obj;
            obj.id = current;
            const modal = require("09728__.js").useModal(obj);
            let tmp16 = null;
            if (!date.modal) {
              obj = {};
