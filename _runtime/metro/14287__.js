        ...
        tmp4 = (function removeLikelySubtags(arr3) {
          ...
          if (tmp2) {
            ...
            if (closure_1_6(Locale(14353).emitUnicodeLanguageId(obj4)) === result) {
              ...
              obj5.lang = obj6;
              let emitUnicodeLocaleIdResult = Locale(14353).emitUnicodeLocaleId(tmp3Result.__assign(Locale(1160).__assign({}, parseUnicodeLocaleIdResult), obj5));
              ...
              if (region) {
                ...
                if (closure_1_6(Locale(14353).emitUnicodeLanguageId(obj7)) === result) {
                  ...
                  obj8.lang = obj9;
                  emitUnicodeLocaleIdResult = Locale(14353).emitUnicodeLocaleId(tmp3Result7.__assign(Locale(1160).__assign({}, parseUnicodeLocaleIdResult), obj8));
              ...
              if (script) {
                ...
                if (closure_1_6(Locale(14353).emitUnicodeLanguageId(obj10)) === result) {
                  ...
                  obj11.lang = obj12;
                  emitUnicodeLocaleIdResult = Locale(14353).emitUnicodeLocaleId(tmp3Result9.__assign(Locale(1160).__assign({}, parseUnicodeLocaleIdResult), obj11));
