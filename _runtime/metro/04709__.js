// _runtime/metro/04709__.js
import _mod4705 from "04705__.js";
import ACTIONS from "../04706_ACTIONS.js";
import PortalHost from "../04707_PortalHost.js";
import registerHost from "../04710_registerHost.js";
...
const memoResult = memo((rootHostName) => {
  ...
  items[1] = flag;
  obj2.children = items;
  obj.children = hasOwnProperty(_mod4705.PortalStateContext.Provider, obj2);
  return React4(_mod4705.PortalDispatchContext.Provider, obj);
});
