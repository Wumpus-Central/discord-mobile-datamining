...
import tagMessage2 from "../06768_tagMessage.js";
import touchDataToPressEvent from "../06864_touchDataToPressEvent.js";
import StateMachineEvent2 from "../06867_StateMachineEvent.js";
import GestureObjects2 from "../06883_GestureObjects.js";
  ...
  const tmp18 = onHoverOut(() => {
    ...
    const fn = function n(handlerTag) {
      ...
      if (closure_2) {
        ...
        tmp5(hitSlop(6864).gestureToPressableEvent(handlerTag));
