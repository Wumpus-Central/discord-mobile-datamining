...
let obj = {
  default: fn(7029).DefaultTransition,
  fade: fn(7029).ModalFadeTransition,
  fade_from_bottom: fn(7029).FadeFromBottomAndroid,
  fade_from_right: fn(7029).FadeFromRightAndroid,
  none: fn(7029).DefaultTransition,
  reveal_from_bottom: fn(7029).RevealFromBottomAndroid,
  scale_from_center: fn(7029).ScaleFromCenterAndroid,
  slide_from_left: fn(7029).SlideFromLeftIOS,
  slide_from_right: fn(7029).SlideFromRightIOS,
  slide_from_bottom: fn(7029).BottomSheetAndroid,
};
...
const entry = {
  ...
  value: function render() {
    ...
    obj2.children = items3.map((key, index) => {
      ...
      if (typeof getInterpolationIndex === "function") {
        ...
        if (typeof getIsModal === "function") {
          ...
          obj.children = React6(CardStack(7036).CardContainer, obj);
    ...
    items2[1] = renderHeader(CardStack(7035).MaybeScreenContainer, obj2);
    obj.children = items2;
          ...
          if (undefined === detachPreviousScreen) {
            ...
            if (tmp11) {
              ...
              if (typeof getIsModalPresentation !== "function") {
                ...
                let tmp7 = CardStack;
                let tmp9 =
                  cardStyleInterpolator === CardStack(7031).forModalPresentationIOS ||
