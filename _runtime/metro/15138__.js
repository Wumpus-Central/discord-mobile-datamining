...
import emptyFunction from "09945__.js";
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        tmp23Result = timestampProducer(CircularProgress(8521).Path, obj1);
      }
      ...
      if (tmp23Result) {
        ...
        tmp23Result = timestampProducer(CircularProgress(8521).Path, obj2);
      }
      items[1] = tmp23Result;
      items[2] = renderCapResult;
      obj.children = items;
      size1.children = React5(CircularProgress(8521).G, obj);
      const items1 = [timestampProducer(CircularProgress(8521).Svg, size1)];
