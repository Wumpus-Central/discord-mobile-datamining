...
const entry = {
  ...
  value: function innerPatternString(arg0) {
    return (
      ...
      UKWeekdayParser(10565).matchAnyPattern(UKWeekdayParser(10719).WEEKDAY_DICTIONARY) +
...
const items = [
  entry,
  {
    ...
    value: function innerExtract(reference, arg1) {
      ...
      return UKWeekdayParser(10592).createParsingComponentsAtWeekday(
        reference.reference,
        UKWeekdayParser(10719).WEEKDAY_DICTIONARY[arg1[2].toLocaleLowerCase()],
        str2,
      );
    },
  },
