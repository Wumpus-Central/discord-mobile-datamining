// _runtime/13558___exportStarResult10.js
import { __exportStarResult7 } from "13555___exportStarResult7.js";
const require = arg1;
...
arg5.IsWellFormedUnitIdentifier = function IsWellFormedUnitIdentifier(GetOptionResult3) {
  ...
  if (__exportStarResult7.IsSanctionedSimpleUnitIdentifier(str)) {
    ...
    if (2 !== parts.length) {
      ...
      [tmp3, tmp4] = parts;
      if (tmp(13555).IsSanctionedSimpleUnitIdentifier(tmp3)) {
        if (tmp(13555).IsSanctionedSimpleUnitIdentifier(tmp4)) {
          return true;
        }
      }
      return false;
