// _runtime/05709_hash.js
import _mod5695 from "metro/05695__.js";
import items2 from "05710_items2.js";
...
function getEnabledSharedValues(Reanimated) {
  if (undefined === _mod5695.Reanimated) {
    ...
    if (tmpResult.isComposedGesture(Reanimated)) {
      ...
      Reanimated = tmp(5695).Reanimated;
...
export const bindSharedValues = function bindSharedValues(closure_1, closure_2) {
  ...
  if (undefined !== require("metro/05695__.js").Reanimated) {
    ...
    while (tmp27 !== undefined) {
      ...
      let Reanimated = require("metro/05695__.js").Reanimated;
      if (Reanimated.isSharedValue(tmp7)) {
        let tmp13 = tmp9;
        let tmp14 = tmp11;
        let Reanimated2 = tmp10(5695).Reanimated;
        let tmp15 = tmp7;
        let tmp16 = tmp6;
...
export const unbindSharedValues = function unbindSharedValues(closure_1, closure_2) {
  if (undefined !== require("metro/05695__.js").Reanimated) {
    ...
    function _loop(iter) {
      const callback = iter;
      const Reanimated = callback(5695).Reanimated;
      if (Reanimated.isSharedValue(iter)) {
        ...
        dependencyMap = sum;
        const Reanimated2 = callback(5695).Reanimated;
        const fn = function t() {
