// _runtime/06185_getMatchRanking.js
import regExp from "06187_regExp.js";
import _extends from "metro/06186__extends.js";
...
if (_extends) {
  ...
  if (_module1) {
    ...
    function matchSorter(valueResult, query, arg2) {
      ...
      return fn(
        valueResult.reduce(function reduceItemsToRanked(arr) {
          let str3;
          arr = closure_2;
          if (closure_2) {
            const items = [];
