// _runtime/09047_QRPolynomial.js
import { 09048__ } from "metro/09048__.js";
class QRPolynomial {
...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = 09048__;
      const glogResult = 09048__.glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - 09048__.glog(getLength.get(0));
