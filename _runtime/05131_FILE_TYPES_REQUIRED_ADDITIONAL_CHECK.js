// _runtime/05131_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05138_AudioTypes.js";
import ImageTypes from "05139_ImageTypes.js";
import VideoTypes from "05140_VideoTypes.js";
import CompressedTypes from "05141_CompressedTypes.js";
import OtherTypes from "05142_OtherTypes.js";
    ...
    value: function detectTypeByAdditionalCheck(fileChunk, found) {
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          let str6 = "flv";
          if (!FileTypes(5132).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (tmp8(5132).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!tmp8(5132).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
