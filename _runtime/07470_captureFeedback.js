...
arg5.captureFeedback = function captureFeedback(arg0) {
  ...
  if (arg2 === undefined) {
    currentScope = require(7390) /* getClient */.getCurrentScope();
    const obj3 = require(7390) /* getClient */;
  }
  obj = { contexts: null, type: "feedback", level: "info", tags: null };
  obj = { feedback: null };
  ({ message, name, email, url, source, associatedEventId, tags } = arg0);
  obj[0] = require(7369) /* addNonEnumerableProperty */.dropUndefinedKeys({ contact_email: email, name, message, url, source, associated_event_id: associatedEventId });
  obj[0] = obj;
  obj[3] = tags;
  ...
  if (!client) {
    ...
    const tmp3Result = require(7390) /* getClient */;
  }
  if (client) {
