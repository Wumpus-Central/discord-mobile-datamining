// _runtime/09248_QRCode.js
import QR8bitByte from "09249_QR8bitByte.js";
import QRRSBlock from "09251_QRRSBlock.js";
import QRBitBuffer from "09253_QRBitBuffer.js";
import _mod9254 from "metro/09254__.js";
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = _mod9254.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = _mod9254.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = _mod9254.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
