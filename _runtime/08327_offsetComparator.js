// _runtime/08327_offsetComparator.js
import extractOpacityDefault from "08256_extractOpacity.js";
import appendTransformPropsDefault from "08258_appendTransformProps.js";
import _modDef8328 from "metro/08328__.js";
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
    ...
    if (gradientUnits) {
      num12 = _modDef8328[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
