// _runtime/04256_registerHost.js
import { print } from "04257_print.js";
const require = arg1;
...
function reducer(arg0, type) {
  ...
  if (portalName(4252).ACTIONS.REGISTER_HOST === type) {
    ...
    return obj;
  } else if (tmp4(4252).ACTIONS.DEREGISTER_HOST === type) {
    const hostName3 = type.hostName;
    delete tmp[tmp2];
    return obj;
  } else if (tmp4(4252).ACTIONS.ADD_UPDATE_PORTAL === type) {
    ...
    return obj;
  } else if (tmp4(4252).ACTIONS.REMOVE_PORTAL === type) {
