// _runtime/04679_baseClone.js
import assignValue from "04688_assignValue.js";
        ...
        if (tmp10) {
          ...
          if (tmp32(536)(arr)) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4686);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4690)(obj, arr));
                } else {
                  tmp32Result = tmp32(4694);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4695)(obj, arr));
                }
