// _runtime/05357_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05364_AudioTypes.js";
import ImageTypes from "05365_ImageTypes.js";
import VideoTypes from "05366_VideoTypes.js";
import CompressedTypes from "05367_CompressedTypes.js";
import OtherTypes from "05368_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5358).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5358).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5358).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5358).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
