// === Module 5524: useRecyclerViewController ===
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  const unmountFlag = _require(5526).useUnmountFlag();
  let obj = _require(5526);
  ...
  _setTimeout = _require(5527).useUnmountAwareTimeout().setTimeout;
            ...
            if (tmp < obj.getDataLength()) {
              ...
              function performScrollStep(arg0) {
                ...
                if (outer2_3.current) {
                  ...
                  if (typeof finishScrollToIndex !== "error") {
