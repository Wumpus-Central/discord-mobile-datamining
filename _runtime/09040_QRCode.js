// _runtime/09040_QRCode.js
import { QR8bitByte } from "09041_QR8bitByte.js";
import { QRRSBlock } from "09043_QRRSBlock.js";
import { QRBitBuffer } from "09045_QRBitBuffer.js";
import { QRPolynomial } from "09047_QRPolynomial.js";
import { 09046__ } from "metro/09046__.js";
class QRCode {
...
prototype.setupPositionAdjustPattern = function() {
  const self = this;
  const patternPosition = 09046__.getPatternPosition(this.typeNumber);
...
prototype.setupTypeNumber = function(arg0) {
  let num2;
  const self = this;
  const bCHTypeNumber = 09046__.getBCHTypeNumber(this.typeNumber);
  let num = 0;
  do {
    let tmp2 = !arg0;
    let tmp3 = num;
...
prototype.setupTypeInfo = function(arg0, arg1) {
  let num2;
  const self = this;
  const bCHTypeInfo = 09046__.getBCHTypeInfo(this.errorCorrectLevel << 3 | arg1);
  let num = 0;
  do {
    let tmp3 = !arg0;
    let tmp4 = num;
