// _runtime/08794__isNativeReflectConstruct.js
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f115979);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f115979);
    ...
    f115979 = undefined;
    f115979 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8797").NONE, require("module_8797").INVERT, require("module_8797").MONOCHROME, require("module_8797").POSTERIZE, require("module_8797").FALSE, require("module_8797").MAXIMUMCOMPONENT, require("module_8797").MINIMUMCOMPONENT, require("module_8797").CHROME, require("module_8797").FADE, require("module_8797").INSTANT, require("module_8797").MONO, require("module_8797").NOIR, require("module_8797").PROCESS, require("module_8797").TONAL, require("module_8797").TRANSFER, require("module_8797").SEPIA];
...
const items4 = [require("module_8798").CLEARKEY, require("module_8798").FAIRPLAY, require("module_8798").WIDEVINE, require("module_8798").PLAYREADY];
...
const items8 = [require("module_8817").SRT, require("module_8817").TTML, require("module_8817").VTT];
...
export const TextTrackType = require("module_8817");
export const FilterType = require("module_8797");
export const DRMType = require("module_8798");