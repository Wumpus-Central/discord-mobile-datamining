// _runtime/10822_leftThreshold.js
import cancelAnimation from "01637_cancelAnimation.js";
import _mod10823 from "metro/10823__.js";
...
function _default(hitSlop) {
  ...
  let fn2 = function p(arg0, arg1) {
    ...
    if (!tmp2) {
      ...
      if (tmp12) {
        if (arg0 > 0) {
          let RIGHT = _mod10823.SwipeDirection.LEFT;
        } else {
          RIGHT = _mod10823.SwipeDirection.RIGHT;
        }
      ...
      if (arg1 > 0) {
        let LEFT = _mod10823.SwipeDirection.RIGHT;
      } else {
        LEFT = _mod10823.SwipeDirection.LEFT;
      }
