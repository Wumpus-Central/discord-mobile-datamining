// _runtime/13703__isNativeReflectConstruct.js
...
export default function ReanimatedScreenProvider(children) {
  return jsx(ReanimatedScreenWrapper(4605).ScreenContext.Provider, { value: closure_8, children: children.children });
};