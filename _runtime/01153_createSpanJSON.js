// _runtime/01153_createSpanJSON.js
...
function createSpanJSON(span_id) {
  ...
  obj[1] = trace_id;
  obj = {
    [tmp(814).SEMANTIC_ATTRIBUTE_SENTRY_OP]: span_id.op,
    [tmp(814).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN]: span_id.origin,
  };
...
arg5.setSpanDurationAsMeasurementOnSpan = function setSpanDurationAsMeasurementOnSpan(
  ...
  if (tmp4) {
    ...
    obj[tmp(814).SEMANTIC_ATTRIBUTE_SENTRY_MEASUREMENT_VALUE] = result;
...
arg5.getBundleStartTimestampMs = function getBundleStartTimestampMs() {
  ...
  if (__BUNDLE_START_TIME__) {
    ...
    if (tmp(813).RN_GLOBAL_OBJ.nativePerformanceNow) {
      const _Date = Date;
