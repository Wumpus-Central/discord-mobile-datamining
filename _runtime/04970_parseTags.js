// _runtime/04970_parseTags.js
import { getDataView } from "04929_getDataView.js";
import { 04971__ } from "metro/04971__.js";
const require = arg1;
...
function parseTags(buffer) {
  ...
  if (buffer.byteLength !== buffer.getUint32()) {
    ...
    const keys = Object.keys(04971__.iccProfile);
    for (let num = 0; num < keys.length; num = num + 1) {
      let tmp = keys[num];
      let tmp2 = require;
      let tmp3 = dependencyMap;
      let iter = 04971__.iccProfile[tmp];
              ...
              if (stringFromDataView1 === desc) {
                ...
                if (stringFromDataView1 === mluc) {
                  ...
                  if (1 === uint324) {
                    ...
                    if (04971__.iccTags[stringFromDataView]) {
