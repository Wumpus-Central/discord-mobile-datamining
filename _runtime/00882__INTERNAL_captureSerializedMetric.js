// _runtime/00882__INTERNAL_captureSerializedMetric.js
...
import createMetricContainerEnvelopeItem from "00883_createMetricContainerEnvelopeItem.js";
  ...
  if (client) {
    ...
    if (beforeSendMetricResult) {
      ...
      const merged3 = Object.assign(
        tmp17(880).serializeAttributes(beforeSendMetricResult.attributes, "skip-undefined"),
      );
      obj1[7] = obj2;
