// _runtime/10212_QRCode.js
import QRCode_mod from "metro/10213__.js";
import module_10217_mod from "metro/10217__.js";
import emptyFunction from "metro/10222__.js";
import noop_mod from "metro/00019__.js";
import QRCodeSvg_mod from "10225_QRCodeSvg.js";
...
QRCode = tmp3;
let module_10217 = module_10217_mod;
if (!module_10217) {
  let obj2 = { default: module_10217 };
  let tmp5 = obj2;
} else {
  tmp5 = module_10217;
}
...
const forwardRefResult = noop.forwardRef((obj, ref) => {
  ...
  const _default1 = new QRCode.default(-1, module_10217.default[level]);
