...
export const makeMutable = _mod1675.makeMutable;
export const createWorkletRuntime = _mod1688.createWorkletRuntime;
export const runOnRuntime = _mod1688.runOnRuntime;
...
export const getViewProp = function getViewProp(arg0, arg1, arg2) {
  ...
  if (obj.isFabric()) {
    if (!arg2) {
      const reanimatedError = new tmp(1649).ReanimatedError("Function `getViewProp` requires a component to be passed as an argument on Fabric.");
      throw reanimatedError;
    }
  }
  obj = require("metro/01641__.js");
  tmp = _require;
