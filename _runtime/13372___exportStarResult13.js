// _runtime/13372___exportStarResult13.js
import e from "e";
import digitsToString from "digitsToString";
import { __exportStarResult14 } from "13373___exportStarResult14.js";
  ...
  if (timesResult.isZero()) {
    ...
    if (roundedNumber.isZero()) {
      ...
      if (floorResult1.eq(floorResult.minus(result))) {
        ...
        const items2 = [tmp2(13373).ComputeExponentForMagnitude(internalSlots, floorResult.plus(1)), floorResult.plus(1).toNumber()];
        return items2;
      }
