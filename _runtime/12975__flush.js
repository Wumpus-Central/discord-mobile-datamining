  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/12954__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/12955__.js").DEBUG_BUILD) {
            const logger = require("metro/12927__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/12954__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const captureException = function captureException(arg0, captureContext) {
  const currentScope = _mod12954.getCurrentScope();
  return currentScope.captureException(arg0, _mod12976.parseEventHintOrCaptureContext(captureContext));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = _mod12964.DEFAULT_ENVIRONMENT;
  }
  ...
  if (tmp10) {
    _mod12950.updateSession(session1, { status: "exited" });
    const tmpResult2 = _mod12950;
  }
  endSession();
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod12941.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod12954.getCurrentScope();
    const client = _mod12954.getClient();
    if (client) {
    ...
    _mod12938.uuid4();
    const tmpResult = _mod12938;
  }
  let currentScope = require("metro/12954__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/12954__.js");
  let client = require("metro/12954__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/12954__.js");
  captureCheckInResult = require("metro/12938__.js").uuid4();
};
