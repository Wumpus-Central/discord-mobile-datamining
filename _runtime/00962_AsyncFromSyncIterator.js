// _runtime/00962_AsyncFromSyncIterator.js
...
import items2 from "00961_items.js";
          ...
          try {
            if (arg0 === 1) {
              ...
              while (true) {
                ...
                if (closure_5) {
                  ...
                  if (closure_2.finishReasons.length) {
                    ...
                    obj1[store(955).GEN_AI_RESPONSE_FINISH_REASONS_ATTRIBUTE] = JSON.stringify(closure_2.finishReasons);
                  ...
                  if (length2) {
                    ...
                    obj2[store(955).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts2.join("");
                  ...
                  if (items1.length > 0) {
                    ...
                    let _JSON4 = JSON;
                    throwTypeErrorResult = items1;
                    obj3[store(955).GEN_AI_RESPONSE_TOOL_CALLS_ATTRIBUTE] = JSON.stringify(items1);
              ...
              if (closure_5) {
                ...
                const obj4 = {};
                obj4[store(955).GEN_AI_RESPONSE_STREAMING_ATTRIBUTE] = true;
                store.setAttributes(obj4);
                if (closure_2.finishReasons.length) {
                  const obj5 = {};
                  const _JSON = JSON;
                  obj5[store(955).GEN_AI_RESPONSE_FINISH_REASONS_ATTRIBUTE] = JSON.stringify(closure_2.finishReasons);
                ...
                if (length) {
                  ...
                  obj6[store(955).GEN_AI_RESPONSE_TEXT_ATTRIBUTE] = responseTexts.join("");
                ...
                if (items1.length > 0) {
                  obj7 = {};
                  const _JSON2 = JSON;
                  obj7[store(955).GEN_AI_RESPONSE_TOOL_CALLS_ATTRIBUTE] = JSON.stringify(items1);
