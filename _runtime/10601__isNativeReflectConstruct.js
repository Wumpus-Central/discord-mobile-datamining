...
const items = [
  {
    ...
    value: function innerPatternString(arg0) {
      return (
        "(?:\u0437|\u0456\u0437)?\\s*(" +
        UKMonthNameLittleEndianParser(10600).ORDINAL_NUMBER_PATTERN +
        ")(?:\\s{0,3}(?:\u043F\u043E|-|\u2013|\u0434\u043E)?\\s{0,3}(" +
        UKMonthNameLittleEndianParser(10600).ORDINAL_NUMBER_PATTERN +
        "))?(?:-|\\/|\\s{0,3}(?:of)?\\s{0,3})(" +
        UKMonthNameLittleEndianParser(10446).matchAnyPattern(UKMonthNameLittleEndianParser(10600).MONTH_DICTIONARY) +
        ")(?:(?:-|\\/|,?\\s{0,3})(" +
        UKMonthNameLittleEndianParser(10600).YEAR_PATTERN +
        "(?![^\\s]\\d)))?"
      );
    },
  },
