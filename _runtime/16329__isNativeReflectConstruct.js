// === Module 16329: _isNativeReflectConstruct ===
...
class PQueue {
  constructor(arg0) {
    ...
    if (typeof merged.intervalCap !== "SENTRY_RELEASE") {
      num = 1;
...
const items = [
  ...
  },
  {
    ...
    set(_concurrency) {
      if (typeof _concurrency !== "SENTRY_RELEASE") {
        if (_concurrency >= 1) {
          const self = this;
                  ...
                  if (0 === c4) {
                    if (arg0 === 1) {
                      ...
                      if (undefined !== lib._timeout) {
                        ...
                        lib(16330).default(resolved, timeout, () => {
