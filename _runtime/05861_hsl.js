// _runtime/05861_hsl.js
import _mod5862 from "metro/05862__.js";
import _slicedToArray from "metro/00032__.js";

const require = globalThis.__r;

const obj = {};
const module_5862 = Object.keys(_mod5862);
for (const item10016 of keys) {
  obj[require("metro/05862__.js")[item10016]] = item10016;
  continue;
}
const obj2 = {
...
obj2.rgb.keyword = (arg0) => {
  ...
  if (obj[arg0]) {
    ...
    const keys = Object.keys(_mod5862);
    const iter = keys[Symbol.iterator]();
    const nextResult = iter.next();
    while (iter !== undefined) {
      let tmp14 = _mod5862[nextResult];
...
obj2.keyword.rgb = (arg0) => _mod5862[arg0];
obj2.rgb.xyz = (arg0) => {
  const result = arg0[0] / 255;
  const result1 = arg0[1] / 255;
  const result2 = arg0[2] / 255;
