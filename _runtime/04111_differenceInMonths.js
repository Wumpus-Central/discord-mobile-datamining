...
if (!module_4112) {
  const obj5 = { default: module_4112 };
  let tmp11 = obj5;
} else {
  tmp11 = module_4112;
}
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_4112.default(_typeof.default(date)) && 1 === absolute && 1 === compareAsc.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
