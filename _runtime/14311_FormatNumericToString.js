// === Module 14311: FormatNumericToString ===

// Module 14311 (FormatNumericToString)
import TEN from "TEN" /* 14297 */;

const _mod14295 = tmp5(14295);
const GetUnsignedRoundingMode = tmp5(14312);
const ToRawPrecision = tmp5(14313);
const ToRawFixed = tmp5(14314);
require = arg1;
...
export const FormatNumericToString = function FormatNumericToString(roundingType, timesResult) {
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14295.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14295.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
  ...
  _mod14295.invariant(timesResult.isFinite(), "NumberFormatDigitInternalSlots value is not finite");
  let str = "positive";
