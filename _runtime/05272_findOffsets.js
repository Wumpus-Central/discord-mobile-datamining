// _runtime/05272_findOffsets.js
import _mod5263 from "metro/05263__.js";
import _modDef5266 from "metro/05266__.js";
import get64BitValue from "05273_get64BitValue.js";
...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint321) {
      const obj1 = { type: "ftyp", majorBrand: _mod5263.getStringFromDataView(getUint32, contentOffset, 4), length };
      return obj1;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = _mod5263.getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = _mod5263;
            }
          }
        }
      } else {
