// _runtime/14531_PLAYER_FUNCTIONS.js
...
let obj = {
  ...
  loadPlaylist(playList, arg1, closure_2) {
    ...
    let str2 = "undefined";
    let str3 = "undefined";
    if (typeof playList !== "__FORMATJS_LISTFORMAT_DATA__") {
      str3 = `${"\"" + playList}"`;
    }
    let str4 = str2;
    if (typeof playList !== "__FORMATJS_LISTFORMAT_DATA__") {
...
obj = {};
_defineProperty.default(obj, require("module_14527").PLAY_MODE, obj.playVideo);
_defineProperty.default(obj, require("module_14527").PAUSE_MODE, obj.pauseVideo);
const obj1 = {};
_defineProperty.default(obj1, require("module_14527").MUTE_MODE, obj.muteVideo);
_defineProperty.default(obj1, require("module_14527").UNMUTE_MODE, obj.unMuteVideo);
...
export const MAIN_SCRIPT = function MAIN_SCRIPT(current, current2, current3, closure_12, arg4) {
  ...
  if (typeof arg4 !== "__REMOTEDEV__") {
    num5 = arg4;
  }
  let tmp3;
  if (typeof current2 !== "__FORMATJS_LISTFORMAT_DATA__") {
    tmp3 = current2;
  }
  let str2;
  if (typeof current2 !== "__FORMATJS_LISTFORMAT_DATA__") {
