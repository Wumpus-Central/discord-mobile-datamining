// _runtime/05134_parseBox.js
import getDataView from "05125_getDataView.js";
import parseItemLocationBox from "05135_parseItemLocationBox.js";
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(5125).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(5125);
            }
          }
        }
      } else {
