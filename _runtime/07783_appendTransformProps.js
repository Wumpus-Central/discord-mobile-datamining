// _runtime/07783_appendTransformProps.js
import { append } from "07784_append.js";
import { peg$SyntaxError } from "07785_peg_SyntaxError.js";
import { peg$SyntaxError } from "07786_peg_SyntaxError.js";
const require = arg1;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(7785);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(7784);
