// _runtime/05297_load.js
import _modDef5298 from "metro/05298__.js";
import _mod5299 from "metro/05299__.js";
...
function loadView(byteLength) {
  ...
  let obj2 = require("metro/05301__.js");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("metro/05301__.js").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("metro/05302__.js").USE_JPEG) {
    flag4 = false;
  ...
  const parseAppMarkersResult = require("metro/05301__.js").parseAppMarkers(byteLength, flag2);
