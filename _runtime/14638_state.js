...
if (!_mod14639) {
  if (!_mod14593.state) {
    ...
    let fn = function t(facade, arg1) {
      if (require("metro/14600__.js")(facade, closure_6)) {
        const typeError = new _mod14577.TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        _mod14633(facade, closure_6, arg1);
        return arg1;
      }
    };
    let fn4 = fn;
    let fn2 = function n(arg0) {
      return require("metro/14600__.js")(arg0, closure_6) ? arg0[closure_6] : {};
    };
    let fn5 = fn2;
    let fn3 = function u(arg0) {
      return require("metro/14600__.js")(arg0, closure_6);
    };
    let fn6 = fn3;
  }
  const obj = {
