// _runtime/07826_applyScopeDataToEvent.js
import addNonEnumerableProperty from "07782_addNonEnumerableProperty.js";
import merge from "07801_merge.js";
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(7781).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(7781);
    obj4[0] = tmp3(7812).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(7812);
    const rootSpan = tmp3(7781).getRootSpan(span);
    const tmp3Result4 = tmp3(7781);
    const description = tmp3(7781).spanToJSON(rootSpan).description;
