...
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8091 */;
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(8102), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(8104), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(8106), obj);
    items[3] = callback3(FeDropShadow(8095), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(8110), {}), callback3(FeDropShadow(8110), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(8108), obj);
    obj[0] = items;
