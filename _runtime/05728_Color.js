// _runtime/05728_Color.js
import _mod5729 from "metro/05729__.js";
import _mod5733 from "metro/05733__.js";
...
function _loop(item10136) {
  ...
  if (closure_3.includes(item10136)) {
    ...
    channels = require("metro/05729__.js")[item10136].channels;
    Color.prototype[item10136] = function () {
      ...
      if (this.model === closure_0) {
        ...
        const rawResult = _mod5729[self.model][closure_0].raw(self.color);
        const _Array = Array;
        let tmp2 = rawResult;
