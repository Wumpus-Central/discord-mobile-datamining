...
import useSharedValue from "01805_useSharedValue.js";
import getVal from "01822_getVal.js";
import convertLrgbToOklabDefault from "01823_convertLrgbToOklab.js";
...
const fn = function o(arg0, arg1, h, useCorrectedHSVInterpolation) {
  ...
  if (undefined !== useCorrectedHSVInterpolation) {
    ...
    let tmpResult = getVal;
    const interpolateResult1 = tmpResult.interpolate(arg0, arg1, h.s, getVal.Extrapolation.CLAMP);
    tmpResult = getVal;
    const interpolateResult2 = tmpResult.interpolate(arg0, arg1, h.v, getVal.Extrapolation.CLAMP);
    const tmpResult1 = getVal;
    const tmpResult2 = call;
    return tmpResult2.hsvToColor(
      interpolateResult,
      interpolateResult1,
      interpolateResult2,
      tmpResult1.interpolate(arg0, arg1, h.a, getVal.Extrapolation.CLAMP),
    );
  }
  const items = [arg1[0]];
  h = h.h;
...
let obj = { interpolate: getVal.interpolate, Extrapolation: getVal.Extrapolation, hsvToColor: call.hsvToColor };
fn.__closure = obj;
...
const fn4 = function a(arg0, arg1, arg2, gamma) {
  ...
  if (1 === num) {
    ...
    const _Math5 = Math;
    const _Math6 = Math;
    rgbaColorResult = tmp6Result.rgbaColor(
      rounded,
      rounded1,
      Math.round(255 * Math.pow(interpolateResult2, 1 / num)),
      interpolateResult3,
    );
  }
...
obj = {
  toLinearSpace: fn2,
  interpolate: getVal.interpolate,
  Extrapolation: getVal.Extrapolation,
  rgbaColor: call.rgbaColor,
  toGammaSpace: fn3,
};
fn4.__closure = obj;
...
const fn5 = function n(arg0, arg1, l) {
  ...
  ({ r, g, b, alpha } = convert.toRgb({
    l: interpolateResult,
    a: interpolateResult1,
    b: interpolateResult2,
    alpha: getVal.interpolate(arg0, arg1, l.alpha, getVal.Extrapolation.CLAMP),
  }));
  const toRgbResult = convert.toRgb({
    l: interpolateResult,
    a: interpolateResult1,
    b: interpolateResult2,
    alpha: getVal.interpolate(arg0, arg1, l.alpha, getVal.Extrapolation.CLAMP),
...
fn6.__closure = {
  processColor: call.processColor,
  red: call.red,
  green: call.green,
  blue: call.blue,
...
fn8.__closure = { _splitColorsIntoChannels: fn6, RGBtoHSV: call.RGBtoHSV };
...
let obj2 = { _splitColorsIntoChannels: fn6, RGBtoHSV: call.RGBtoHSV };
...
function interpolateColor(arg0, arg1, arg2) {
  ...
  if ("HSV" === str) {
    ...
    obj1 = { l: null, a: null, b: null, alpha: null };
    ({
      ch1: obj2[0],
      ch2: obj2[1],
      ch3: obj2[2],
    ...
    const reanimatedError = new t.ReanimatedError(
      "Invalid color space provided: " + str + ". Supported values are: ['RGB', 'HSV', 'LAB'].",
    );
    throw reanimatedError;
  }
}
interpolateColor.__closure = {
  interpolateColorsHSV: fn,
  getInterpolateHSV: fn8,
  interpolateColorsRGB: fn4,
  getInterpolateRGB: fn7,
  interpolateColorsLAB: fn5,
  getInterpolateLAB: fn9,
};
...
export const Extrapolate = getVal.Extrapolation;
