...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      status,
      checkInId: closure_2,
      duration: monitorSlug(12811).timestampInSeconds() - closure_3,
    };
  ...
  let currentScope = require("12824_getClient.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = getClient;
  let client = require("12824_getClient.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = getClient;
  captureCheckInResult = require("12808_addContextToFrame.js").uuid4();
};
