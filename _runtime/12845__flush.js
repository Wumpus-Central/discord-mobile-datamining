  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/12824__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/12825__.js").DEBUG_BUILD) {
            const logger = require("metro/12797__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/12824__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod12811.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod12824.getCurrentScope();
    const client = _mod12824.getClient();
    if (client) {
  ...
  let currentScope = require("metro/12824__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/12824__.js");
  let client = require("metro/12824__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/12824__.js");
  captureCheckInResult = require("metro/12808__.js").uuid4();
};
