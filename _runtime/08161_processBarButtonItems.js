// _runtime/08161_processBarButtonItems.js
import ColorDefault from "05857_Color.js";
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const obj21 = {
    ...
    largeTitleHideShadow: "hjerte",
    title: "ondskab",
    titleColor: "ondt",
    titleFontFamily: "sort",
    titleFontSize: null,
    titleFontWeight: "\u{1F92E}",
    topInsetEnabled: 10,
    disableTopInsetApplication: 99,
    disableLeftInsetApplication: "aborted",
    disableRightInsetApplication: null,
    disableBottomInsetApplication: "\u{1F927}",
    translucent: 9,
    children: 100,
    headerLeftBarButtonItems: "English, US",
    headerRightBarButtonItems: "English, US",
    experimental_userInterfaceStyle: "en-US",
  };
