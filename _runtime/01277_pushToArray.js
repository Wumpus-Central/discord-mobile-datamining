      ...
      if (null !== found) {
        ...
        if (0 < filter1.length) {
          while (true) {
            ...
            if (!skipNulls) {
              ({ allowEmptyArrays: allowEmptyArrays2, strictNullHandling, skipNulls: skipNulls2, encodeDotInKeys } = obj2);
              let encoder = null;
              if (obj2.encode) {
                encoder = obj2.encoder;
              }
              let tmp30Result = stringify(tmp27, tmp26, tmp79, tmp20, allowEmptyArrays2, strictNullHandling, skipNulls2, encodeDotInKeys, encoder, obj2.filter, obj2.sort, obj2.allowDots, obj2.serializeDate, obj2.format, obj2.formatter, obj2.encodeValuesOnly, obj2.charset, tmp25);
