// _runtime/14627_SetNumberFormatUnitOptions.js
import _mod14581 from "metro/14581__.js";
...
export const SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  _mod14581.invariant(result, "Malformed currency code", RangeError);
  let tmp10 = "currency" !== GetOptionResult;
  if (!tmp10) {
    tmp10 = undefined !== str;
  }
  _mod14581.invariant(tmp10, "currency cannot be undefined", TypeError);
  ...
  _mod14581.invariant(result1, "Invalid unit argument for Intl.NumberFormat()", RangeError);
  let tmp17 = "unit" !== GetOptionResult;
  if (!tmp17) {
    tmp17 = undefined !== GetOptionResult3;
  }
  _mod14581.invariant(tmp17, "unit cannot be undefined", TypeError);
