// _runtime/13114_eventFromMessage.js
import _mod13060 from "metro/13060__.js";
import _mod13061 from "metro/13061__.js";
import _mod13065 from "metro/13065__.js";
import _mod13099 from "metro/13099__.js";
    ...
    if (event_id) {
      if (event_id.syntheticException) {
        ...
        if (arr.length) {
          ...
          obj2.values = items;
          obj.exception = obj2;
          const result = _mod13065.addExceptionMechanism(obj, { synthetic: true });
        }
...
export const eventFromUnknownInput = function eventFromUnknownInput(getOptions, fn, name, data) {
  ...
  if (obj2.isError(name)) {
    ...
    if (tmp2Result.isPlainObject(name)) {
      ...
      const obj = { __serialized__: _mod13099.normalizeToSize(name, normalizeDepth) };
      let tmp12;
      ...
      if (tmp12) {
        ...
        const result = _mod13060.extractExceptionKeysForMessage(name);
  ...
  const result1 = _mod13065.addExceptionTypeValue(obj5, undefined, undefined);
  const result2 = _mod13065.addExceptionMechanism(obj5, data);
  const obj9 = {};
