// _runtime/08286_offsetComparator.js
import extractOpacityDefault from "08215_extractOpacity.js";
import appendTransformPropsDefault from "08217_appendTransformProps.js";
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
    ...
    if (gradientUnits) {
      num12 = _modDef8287[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
