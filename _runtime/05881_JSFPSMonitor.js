// _runtime/05881_JSFPSMonitor.js
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        error = new Error(JSFPSMonitor(5816).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      const obj = { minFPS: JSFPSMonitor(5882).roundToDecimalPlaces(self.minFPS, 1), maxFPS: null, averageFPS: null };
      const obj2 = JSFPSMonitor(5882);
      obj[1] = JSFPSMonitor(5882).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5882);
      obj[2] = JSFPSMonitor(5882).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    }
  }
];
