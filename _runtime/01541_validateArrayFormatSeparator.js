// _runtime/01541_validateArrayFormatSeparator.js
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!encode) {
                    ...
                    let encodeURIComponentResult = closure_0(1542)(closure_0);
                  } else {
                  ...
                  if (!items1.encode) {
                    ...
                    let encodeURIComponentResult3 = closure_0(1542)(closure_0);
                  } else {
              ...
              if (!closure_0.skipNull) {
                ...
                if (null === arg1) {
                  ...
                  if (!closure_0.encode) {
                    ...
                    let encodeURIComponentResult2 = closure_0(1542)(closure_0);
                  } else {
                    const _encodeURIComponent = encodeURIComponent;
              ...
              if (!closure_0.skipNull) {
                ...
                if (0 === arg0.length) {
                  if (!closure_0.encode) {
                    ...
                    let encodeURIComponentResult1 = closure_0(1542)(closure_0);
                  } else {
                    const _encodeURIComponent2 = encodeURIComponent;
