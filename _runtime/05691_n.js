...
export const useReanimatedEventHandler = function useReanimatedEventHandler(handlerTag, memoizedGestureCallbacks, handler, changeEventCalculator, fillInDefaultValues) {
  ...
  fn.__closure = { lastUpdateEventMap: mutable, eventHandler: require("05690_handleStateChangeEvent.js").eventHandler, handlerTag, workletizedHandlers: tmp, changeEventCalculator, fillInDefaultValues };
  ...
  let Reanimated = require("metro/05647__.js").Reanimated;
  let event;
  if (Reanimated != null) {
