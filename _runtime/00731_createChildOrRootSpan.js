// _runtime/00731_createChildOrRootSpan.js
...
export const continueTrace = (arg0, arg1) => {
  let _require = arg1;
  let mainCarrier = require("00690_getGlobalSingleton.js").getMainCarrier();
  let obj = getGlobalSingleton;
  let asyncContextStrategy = require("00706_getAsyncContextStrategy.js").getAsyncContextStrategy(mainCarrier);
...
export const startNewTrace = function startNewTrace(arg0) {
  const _require = arg0;
  return require("00713_getClient.js").withScope((setPropagationContext) => {
    const obj = { traceId: callback(closure_1_1[11]).generateTraceId(), sampleRand: null };
    const obj2 = callback(closure_1_1[11]);
    obj[1] = callback(closure_1_1[12]).safeMathRandom();
    const result = setPropagationContext.setPropagationContext(obj);
...
export const startSpan = function startSpan(experimental) {
  ...
  let obj = getGlobalSingleton;
  const mainCarrier = obj.getMainCarrier();
  const asyncContextStrategy = require("00706_getAsyncContextStrategy.js").getAsyncContextStrategy(mainCarrier);
...
export const suppressTracing = function suppressTracing(arg0) {
  const _require = arg0;
  const mainCarrier = require("00690_getGlobalSingleton.js").getMainCarrier();
