// _runtime/07531_addContextToFrame.js
import { addNonEnumerableProperty } from "07526_addNonEnumerableProperty.js";
import { isMatchingPattern } from "07529_isMatchingPattern.js";
const require = arg1;
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.pre_context = substr.map((arg0) => callback(7529).snipLine(arg0, 0));
    const _Math5 = Math;
    ...
    lineno.post_context = substr1.map((arg0) => callback(7529).snipLine(arg0, 0));
