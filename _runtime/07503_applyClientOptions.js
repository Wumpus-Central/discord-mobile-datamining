// _runtime/07503_applyClientOptions.js
import { isMatchingPattern } from "07463_isMatchingPattern.js";
import { getFilenameToDebugIdMap } from "07506_getFilenameToDebugIdMap.js";
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(7499).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(7499);
                }
