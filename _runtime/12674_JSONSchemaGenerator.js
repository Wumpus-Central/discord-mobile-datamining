// _runtime/12674_JSONSchemaGenerator.js
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12672).process(arg0, this.ctx, tmp);
    }
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12672).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(12672).finalize(self.ctx, _idmap), closure_4);
    }
  }
];
