// _runtime/01865_useChatKeyboard.js
const require = arg1;
const module = arg2;
...
arg5.useChatKeyboard = function useChatKeyboard(animatedRef, inverted) {
  ...
  obj = {
    ...
    layout,
    scroll: offset2,
    scrollTo: _require(keyboardLiftBehavior[0]).scrollTo,
  ...
  const fn2 = function s(height) {
    if (!freeze.value) {
      ...
      const effectiveHeight = animatedRef(keyboardLiftBehavior[3]).getEffectiveHeight(
        height.height,
        sharedValue3.value,
        offset,
      );
  ...
  obj1 = {
    ...
    getEffectiveHeight: _require(keyboardLiftBehavior[3]).getEffectiveHeight,
    offset,
    isScrollAtEnd: _require(keyboardLiftBehavior[3]).isScrollAtEnd,
    scroll: offset2,
    layout,
    size,
    inverted,
    getVisibleMinimumPaddingFraction: _require(keyboardLiftBehavior[3]).getVisibleMinimumPaddingFraction,
    blankSpace,
    getMinimumPaddingAbsorbed: _require(keyboardLiftBehavior[3]).getMinimumPaddingAbsorbed,
    extraContentPadding,
    getScrollEffective: _require(keyboardLiftBehavior[3]).getScrollEffective,
    ...
    if (!freeze.value) {
      ...
      if (inverted) {
        if (-1 !== height.duration) {
          ...
          effectiveHeight = animatedRef(keyboardLiftBehavior[3]).getEffectiveHeight(
            height.height,
            sharedValue3.value,
            offset,
          );
          ...
          effectiveHeight =
            animatedRef(keyboardLiftBehavior[3]).getMinimumPaddingAbsorbed(
              blankSpace.value,
        ...
        const effectiveHeight1 = animatedRef(keyboardLiftBehavior[3]).getEffectiveHeight(
          height.height,
          sharedValue3.value,
          offset,
        );
        const obj = animatedRef(keyboardLiftBehavior[3]);
        const result =
          animatedRef(keyboardLiftBehavior[3]).getMinimumPaddingAbsorbed(blankSpace.value, extraContentPadding.value) *
          sharedValue5.value;
        const obj2 = animatedRef(keyboardLiftBehavior[3]);
  ...
  obj2 = {
    ...
    scrollTo: _require(keyboardLiftBehavior[0]).scrollTo,
    scrollViewRef: animatedRef,
    shouldShiftContent: _require(keyboardLiftBehavior[3]).shouldShiftContent,
    closing: sharedValue4,
    clampScrollIfNeeded: fn,
    scroll: offset2,
    clampedScrollTarget: _require(keyboardLiftBehavior[3]).clampedScrollTarget,
    actualOpenShift: sharedValue6,
  };
  fn3.__closure = obj2;
