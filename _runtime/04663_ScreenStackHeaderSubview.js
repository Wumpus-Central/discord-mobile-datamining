// _runtime/04663_ScreenStackHeaderSubview.js
import _objectWithoutProperties from "_objectWithoutProperties";
import get_ActivityIndicator from "get ActivityIndicator";
import { jsx } from "jsxProd";
import { context } from "04664_context.js";
import { __INTERNAL_VIEW_CONFIG } from "metro/04667___INTERNAL_VIEW_CONFIG.js";
...
const forwardRefResult = require("noop").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4660).isHeaderBarButtonsAvailableForCurrentPlatform) {
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4660).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4661).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4666), {});
});
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = require("04661_get_controlledBottomTabs.js") /* get controlledBottomTabs */.experiment.synchronousHeaderSubviewUpdatesEnabled;
...
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = require("04661_get_controlledBottomTabs.js") /* get controlledBottomTabs */.experiment.synchronousHeaderSubviewUpdatesEnabled;
