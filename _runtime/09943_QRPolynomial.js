// _runtime/09943_QRPolynomial.js
import _mod9944 from "metro/09944__.js";
...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const glogResult = _mod9944.glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - _mod9944.glog(getLength.get(0));
