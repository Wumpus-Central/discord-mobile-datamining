...
export const randomBytes = function randomBytes() {
  ...
  if (Hash(10047).crypto) {
    if (typeof Hash(10047).crypto.getRandomValues === "function") {
      const _crypto2 = Hash(10047).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(10047).crypto) {
    if (typeof Hash(10047).crypto.randomBytes === "function") {
      const _crypto = Hash(10047).crypto;
