...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint321) {
      const obj1 = { type: "ftyp", majorBrand: _mod5227.getStringFromDataView(getUint32, contentOffset, 4), length };
      return obj1;
      ...
      if ("prof" === stringFromDataView) {
        const obj4 = { offset: contentOffset + 4, length: getUint32.getUint32(contentOffset + 4), chunkNumber: 1, chunksTotal: 1 };
        const tmp47 = obj4;
      }
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = _mod5227.getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = _mod5227;
            }
          }
        }
      } else {
