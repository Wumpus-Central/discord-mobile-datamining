// _runtime/01192_binaryReadOptions.js
  ...
  entry,
  {
    ...
    value: function skip(arg0) {
      ...
      if (BinaryReader(1191).WireType.Varint === arg0) {
        ...
        if (BinaryReader(1191).WireType.Bit64 === arg0) {
          self.pos = self.pos + 4;
        } else if (BinaryReader(1191).WireType.Bit32 !== arg0) {
          if (BinaryReader(1191).WireType.LengthDelimited === arg0) {
            self.pos = self.pos + self.uint32();
          } else if (BinaryReader(1191).WireType.StartGroup === arg0) {
            const tmp8 = self.tag()[1];
            if (tmp8 !== BinaryReader(1191).WireType.EndGroup) {
              do {
