// _runtime/07436_productSk2Map.js
import { 07424__ } from "metro/07424__.js";
const require = arg1;
...
arg5.subscriptionSk2Map = (subscription) => {
  ...
  const obj = { platform: 07424__.SubscriptionPlatform.ios, title: displayName, productId: String(id), description, type: "subs", price: String(price), localizedPrice: displayPrice, currency, subscriptionPeriodNumberIOS: null, subscriptionPeriodUnitIOS: null, introductoryPriceAsAmountIOS: null, introductoryPricePaymentModeIOS: null, introductoryPriceNumberOfPeriodsIOS: null, introductoryPriceSubscriptionPeriodIOS: null };
