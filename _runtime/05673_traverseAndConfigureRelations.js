// _runtime/05673_traverseAndConfigureRelations.js
import tagMessage from "05604_tagMessage.js";
import { isComposedGesture } from "05666_isComposedGesture.js";
...
function traverseAndConfigureRelations(gestures, map, set) {
  ...
  if (obj.isComposedGesture(gestures)) {
    ...
    gestures.gestureRelations = tmp(5666).prepareRelations(gestures.config, gestures.handlerTag);
...
arg5.configureRelations = function configureRelations(externalSimultaneousHandlers) {
  ...
  if (obj2.isComposedGesture(externalSimultaneousHandlers)) {
    ...
    if (externalSimultaneousHandlers.type === set(5658).ComposedGestureName.Simultaneous) {
