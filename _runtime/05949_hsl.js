...
const obj = {};
const module_5950 = Object.keys(_mod5950);
for (const item10016 of keys) {
  obj[require("metro/05950__.js")[item10016]] = item10016;
  continue;
}
const obj2 = {
...
obj2.rgb.keyword = (arg0) => {
  ...
  if (obj[arg0]) {
    ...
    const keys = Object.keys(_mod5950);
    const iter = keys[Symbol.iterator]();
    const nextResult = iter.next();
    while (iter !== undefined) {
      let tmp14 = _mod5950[nextResult];
...
obj2.keyword.rgb = (arg0) => _mod5950[arg0];
obj2.rgb.xyz = (arg0) => {
  const result = arg0[0] / 255;
  const result1 = arg0[1] / 255;
  const result2 = arg0[2] / 255;
