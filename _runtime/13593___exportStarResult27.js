// _runtime/13593___exportStarResult27.js
import { getMultiInternalSlots } from "13547_getMultiInternalSlots.js";
import { __exportStarResult4 } from "13552___exportStarResult4.js";
const require = arg1;
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(13557).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(13558).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
