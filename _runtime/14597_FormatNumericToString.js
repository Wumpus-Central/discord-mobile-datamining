// _runtime/14597_FormatNumericToString.js
import TEN from "14583_TEN.js";

const _mod14581 = tmp5(14581);
const GetUnsignedRoundingMode = tmp5(14598);
const ToRawPrecision = tmp5(14599);
const ToRawFixed = tmp5(14600);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14581.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14581.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
