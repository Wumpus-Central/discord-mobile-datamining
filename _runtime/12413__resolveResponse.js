// _runtime/12413__resolveResponse.js
...
export const addFetchEndInstrumentationHandler = function addFetchEndInstrumentationHandler(arg0) {
  ...
  addHandler.maybeInstrument("fetch-body-resolved", () => {
    ...
    {
      callback(12308).fill(callback(12303).GLOBAL_OBJ, "fetch", (arg0) => {
        closure_0 = arg0;
        return () => {
...
export const addFetchInstrumentationHandler = function addFetchInstrumentationHandler(arg0, arg1) {
  const _require = arg1;
  require("12300_addHandler.js").addHandler("fetch", arg0);
  let obj = addHandler;
  require("12300_addHandler.js").maybeInstrument("fetch", () => {
    let flag = callback;
