// _runtime/05139_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05146_AudioTypes.js";
import ImageTypes from "05147_ImageTypes.js";
import VideoTypes from "05148_VideoTypes.js";
import CompressedTypes from "05149_CompressedTypes.js";
import OtherTypes from "05150_OtherTypes.js";
...
let items = [
  {
    ...
    value: function getInfoByName(key10027) {
      return FileTypes(5137).fetchFromObject(FileTypes, key10027.toUpperCase());
    },
  },
  {
    key: "getSignaturesByName",
    value: function getSignaturesByName(item10079) {
      return FileTypes(5137).fetchFromObject(FileTypes, item10079.toUpperCase()).signatures;
    },
  },
  {
    key: "detectSignature",
    ...
    value: function detectTypeByAdditionalCheck(fileChunk, found) {
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          let str6 = "flv";
          if (!FileTypes(5140).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (tmp8(5140).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!tmp8(5140).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        const result = FileTypes(5137).findMatroskaDocTypeElements(fileChunk);
        let str2 = "mkv";
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (tmp3(5140).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
        ...
        if (
          ...
          if (FileTypes(5137).isAvifStringIncluded(fileChunk)) {
            str = "avif";
          }
        }
        return str;
