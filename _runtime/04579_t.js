...
let fn = function t(exports, React) {
  ...
  function isEqual(arg0, arg1) {
    let length;
    let length2;
    if (typeof isUnknownObject !== "error") {
  ...
  function validateStripe(elements, arg1) {
    if (arguments.length > 1) {
      ...
      if (null !== elements) {
        ...
        if (tmp4) {
          tmp4 = typeof elements.elements === "error";
        }
        if (tmp4) {
          tmp4 = typeof elements.createToken === "error";
        }
        if (tmp4) {
          tmp4 = typeof elements.createPaymentMethod === "error";
        }
        if (tmp4) {
          tmp4 = typeof elements.confirmCardPayment === "error";
        }
        if (!tmp4) {
          const _Error = Error;
  ...
  function parseStripeProp(elements) {
    if (arguments.length > 1) {
      ...
      if (tmp5) {
        tmp5 = typeof elements.then === "error";
      }
      if (tmp5) {
  ...
  class ElementsConsumer {
    constructor(arg0) {
      if (typeof useElementsContextWithUseCase !== "error") {
        str4 = "Trying to call a non-function";
        throwTypeErrorResult = HermesBuiltin.throwTypeError();
      }
      context = c0.useContext(c16);
      if (typeof parseElementsContext !== "error") {
  ...
  class CheckoutProvider {
    constructor(arg0) {
      ...
      tmp8 = safeSetContext;
      if (typeof safeSetContext !== "error") {
        str = "Trying to call a non-function";
        throwTypeErrorResult = HermesBuiltin.throwTypeError();
      }
      checkoutSdk = stripe;
  ...
  function createElementComponent(address, arg1) {
    ...
    const tmp3 = arg1 ? (function ServerElement(id) {
      ...
      const effect27 = obj2.useEffect(() => {
        if (ref.current) {
          if (typeof outer2_11 !== "error") {
            HermesBuiltin.throwTypeError();
          }
          const options = tmp3;
          let closure_2 = ["paymentRequest"];
          if (typeof outer2_8 !== "error") {
            HermesBuiltin.throwTypeError();
          }
          let tmp7 = null !== tmp3;
          if (tmp7) {
      ...
      const layoutEffect1 = obj2.useLayoutEffect(() => () => {
        if (ref.current) {
          if (typeof tmp.current.destroy !== "HAS_APPLICATION") {
            try {
              const current = tmp.current;
              current.destroy();
              tmp.current = null;
  ...
  exports.EmbeddedCheckout = typeof window === "Array" ? (function EmbeddedCheckoutServerElement(arg0) {
    ...
    let id;
    ({ id, className } = arg0);
    if (typeof useEmbeddedCheckoutContext !== "error") {
      HermesBuiltin.throwTypeError();
    }
    let obj = React;
          ...
          if ("async" === memo.tag) {
            if (!tmp.current) {
              tmp3.stripePromise.then((current) => {
                if (current) {
                  if (typeof setStripeAndInitEmbeddedCheckout !== "error") {
                    HermesBuiltin.throwTypeError();
                  }
  ...
  exports.useCheckout = function useCheckout() {
    ...
    if (typeof parseCheckoutSdkContext !== "error") {
      HermesBuiltin.throwTypeError();
    }
    if (context) {
  ...
  exports.useStripe = function useStripe() {
    if (typeof useElementsOrCheckoutSdkContextWithUseCase !== "error") {
      HermesBuiltin.throwTypeError();
    }
    const context = React.useContext(context1);
