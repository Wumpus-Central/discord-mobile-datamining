// _runtime/03924_differenceInMonths.js
import _typeof_mod from "metro/03726__.js";
import differenceInCalendarMonths_mod from "03912_differenceInCalendarMonths.js";
import compareAsc_mod from "03902_compareAsc.js";
import requiredArgs_mod from "03727_requiredArgs.js";
import module_3925_mod from "metro/03925__.js";
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_3925.default(_typeof.default(date)) && 1 === absolute && 1 === compareAsc.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
