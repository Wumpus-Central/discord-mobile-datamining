// _runtime/04430_createJSONStorage.js
...
export function devtools(arg0) {
  ...
  return (arg0, arg1, setState) => {
    ...
    const tmp2 = obj(closure_1, closure_1_2);
    closure_5 = tmp2;
    try {
      ...
      if (__REDUX_DEVTOOLS_EXTENSION__) {
        const tmp9 = ((store, connect, name) => {
          if (undefined === store) {
            obj = { type: "untracked", connection: null };
              ...
              lib(type.state, (arg0) => {
                if (undefined === closure_4) {
                  ...
                  if (null != closure_6) {
                    ...
                    let mapped = closure_1_4.get(name.name);
                    if (mapped) {
                      const _Object = Object;
                      const _Object2 = Object;
