// _runtime/07950__isNativeReflectConstruct.js
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(7951), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(7953), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(7955), obj);
    items[3] = callback3(FeDropShadow(7944), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(7959), {}), callback3(FeDropShadow(7959), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(7957), obj);
    obj[0] = items;
