// _runtime/05557_initialWindowMetrics.js
import _mod1630 from "metro/01630__.js";
import useFrameSize from "05534_useFrameSize.js";
...
if (null == require("metro/01630__.js").initialWindowMetrics) {
  ...
  initialWindowMetrics = require("metro/01630__.js").initialWindowMetrics;
}
class SafeAreaProviderCompat {
  constructor(arg0) {
    ({ children, style } = global);
    closure_2 = undefined;
    closure_2 = closure_2.useContext(require("metro/01630__.js").SafeAreaInsetsContext);
    obj = {
