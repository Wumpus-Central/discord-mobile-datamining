...
export default function normalizeColor(num) {
  if (typeof num === "number") {
    ...
    if (undefined === obj) {
      ...
      const tmp81 = commaSeparatedCall(
        "[-+]?\\d*\\.?\\d+",
        "[-+]?\\d*\\.?\\d+",
        "[-+]?\\d*\\.?\\d+",
        "[-+]?\\d*\\.?\\d+",
      ...
      const tmp92 = commaSeparatedCall(
        "[-+]?\\d*\\.?\\d+",
        "[-+]?\\d*\\.?\\d+%",
        "[-+]?\\d*\\.?\\d+%",
        "[-+]?\\d*\\.?\\d+",
              ...
              if (match) {
                ...
                if (match1) {
                  ...
                  if (match2) {
                    ...
                    tmp8 =
                      parseInt(
                        match2[1] + match2[1] + match2[2] + match2[2] + match2[3] + match2[3] + match2[4] + match2[4],
                        16,
                      ) >>> 0;
                  } else {
                    let hsl = tmp73.hsl;
