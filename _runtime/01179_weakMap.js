...
arg5.enableSyncToNative = function enableSyncToNative(globalScope) {
  ...
  if (!weakMap.has(globalScope)) {
    ...
    require("01151_fillTyped.js").fillTyped(globalScope, "setUser", (arg0) => {
      closure_0 = arg0;
      return (arg0) => {
    ...
    let obj2 = fillTyped;
    require("01151_fillTyped.js").fillTyped(globalScope, "setTag", (arg0) => {
      closure_0 = arg0;
      return (arg0, arg1) => {
        const NATIVE = callback(closure_2_1[1]).NATIVE;
    ...
    require("01151_fillTyped.js").fillTyped(globalScope, "setTags", (arg0) => {
      closure_0 = arg0;
      return (arg0) => {
        closure_0 = arg0;
    ...
    require("01151_fillTyped.js").fillTyped(globalScope, "setExtras", (arg0) => {
      closure_0 = arg0;
      return (arg0) => {
        closure_0 = arg0;
        const keys = Object.keys(arg0);
    ...
    require("01151_fillTyped.js").fillTyped(globalScope, "setExtra", (arg0) => {
      closure_0 = arg0;
      return (arg0, arg1) => {
        const NATIVE = callback(closure_2_1[1]).NATIVE;
    ...
    require("01151_fillTyped.js").fillTyped(globalScope, "addBreadcrumb", (arg0) => {
      closure_0 = arg0;
      return (level) => {
    ...
    require("01151_fillTyped.js").fillTyped(globalScope, "clearBreadcrumbs", (arg0) => {
      closure_0 = arg0;
      return () => {
        const NATIVE = callback(closure_2_1[1]).NATIVE;
    ...
    require("01151_fillTyped.js").fillTyped(globalScope, "setContext", (arg0) => {
      closure_0 = arg0;
      return (arg0, arg1) => {
        const NATIVE = callback(closure_2_1[1]).NATIVE;
