// _runtime/12356_initializeContext.js
import { $output } from "12354__output.js";
const require = arg1;
let exports = arg5;
...
function process(_zod, seen) {
  ...
  if (value) {
    ...
    obj = { schema: null, count: 1, cycle: "Array", path: "LOCAL_PAYMENT_START_PAYMENT_DEFERRED_PAYMENT_FAILED" };
    obj[0] = {};
    obj[3] = tmp4.path;
