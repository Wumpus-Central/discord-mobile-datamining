...
const subs = require("metro/07708__.js").ProductType.subs;
const inapp = require("metro/07708__.js").ProductType.inapp;
...
export const isIosStorekit2 = require("metro/07709__.js").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
...
export const initConnection = () => {
  const nativeModule = _mod7709.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod7709.getAndroidModule();
