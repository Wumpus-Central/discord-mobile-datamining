// _runtime/01474_configure.js
import StateDefault from "01476_State.js";
import _modAll1481 from "metro/01481__.js";
import closure_3 from "metro/00032__slicedToArray.js";
import noop from "00019_noop.js";
import { Platform } from "00017_get_ActivityIndicator.js";
import closure_7 from "metro/01475__.js";
...
function useNetInfo(arg0) {
  if (arg0) {
    ...
    if (closure_8) {
      ...
      const tmp13 = new tmp(1476)(obj);
      closure_8 = tmp13;
    }
    obj2 = closure_8;
    tmp = importDefault;
  }
  obj = { type: _modAll1481.NetInfoStateType.unknown, isConnected: null, isInternetReachable: null, details: null };
...
let c10 = false;
let closure_11 = [];
for (const key10038 in require("metro/01481__.js")) {
  let tmp3 = key10038;
  arg5[key10038] = require("metro/01481__.js")[key10038];
  continue;
}
