// _runtime/12631_stringProcessor.js
import mergeDefs from "12572_mergeDefs.js";
import initializeContext from "12630_initializeContext.js";
...
export const objectProcessor = (_zod, io, properties, path) => {
  ...
  for (const key10015 in shape) {
    ...
    obj.path = items;
    arg2.properties[key10015] = require("12630_initializeContext.js").process(shape[key10015], arg1, obj);
    continue;
  }
  ...
  if ("never" === type) {
    ...
    if (def.catchall) {
      ...
      obj.path = items2;
      properties.additionalProperties = require("12630_initializeContext.js").process(def.catchall, io, obj);
    }
