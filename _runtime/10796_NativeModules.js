// === Module 10796: NativeModules ===

// Module 10796 (NativeModules)
import _mod10798 from "module_10798" /* 10798 */;
import RNIapAmazonModuleAll from "RNIapAmazonModule" /* 10804 */;
import NativeModulesAll from "NativeModules" /* 10805 */;
import fetchJsonOrThrowAll from "fetchJsonOrThrow" /* 10806 */;
import syncAll from "sync" /* 10807 */;
...
const subs = require("module_10797").ProductType.subs;
const inapp = require("module_10797").ProductType.inapp;
...
export const isIosStorekit2 = require("module_10798").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
