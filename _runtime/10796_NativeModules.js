// _runtime/10796_NativeModules.js
import _mod10798 from "metro/10798__.js";
import RNIapAmazonModuleAll from "10804_RNIapAmazonModule.js";
import NativeModulesAll from "10805_NativeModules.js";
import fetchJsonOrThrowAll from "10806_fetchJsonOrThrow.js";
import syncAll from "10807_sync.js";
...
const subs = require("metro/10797__.js").ProductType.subs;
const inapp = require("metro/10797__.js").ProductType.inapp;
...
export const isIosStorekit2 = require("metro/10798__.js").isIosStorekit2;
export const setup = () => {
  let obj = arg0;
  if (arg0 === undefined) {
    obj = {};
  ...
  if ("STOREKIT1_MODE" === str) {
    _mod10798.storekit1Mode();
    const obj4 = _mod10798;
  } else if ("STOREKIT2_MODE" === str) {
    _mod10798.storekit2Mode();
    const obj3 = _mod10798;
  } else if ("STOREKIT_HYBRID_MODE" === str) {
    _mod10798.storekitHybridMode();
    const obj2 = _mod10798;
  }
};
export const initConnection = () => {
  const nativeModule = _mod10798.getNativeModule();
...
export const flushFailedPurchasesCachedAsPendingAndroid = () => {
  const androidModule = _mod10798.getAndroidModule();
...
export const getProducts = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function* () {
      ...
      closure_0 = arg1.map(closure_1_0(10803).singleProductAndroidMap);
      const obj = closure_1_0(10798);
...
export const getSubscriptions = (skus) => {
  ...
  if (length) {
    closure_1 = callback(function* () {
      ...
      const androidModule = closure_1_0(10798).getAndroidModule();
      closure_1 = yield androidModule.getItemsByType(closure_1_6, closure_1_0);
      if ("android" === closure_1_0) {
        return closure_1_8(closure_1, closure_1_0(10797).SubscriptionPlatform.android);
      }
      if ("amazon" !== tmp35) {
        const _Error = Error;
      ...
      return closure_1_8(dependencyMap, closure_1_0(10797).SubscriptionPlatform.amazon);
    });
    let rejectResult = (function android() {
      const self = this;
      const apply = closure_1.apply;
