...
function Form(onSubmitError) {
  ({ options, defaultEmail, defaultName, onSubmit: f105252, onSubmitSuccess } = onSubmitError);
  ...
  closure_15 = fn2(() => f69984, items);
  f105252 = undefined;
  f105252 = screenshotInput((arg0) => {
    closure_0 = arg0;
    c5 = 0;
    c6 = 0;
    closure_4 = 0;
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (3 === tmp8) {
              ...
              closure_4 = closure_3;
              if (messageLabel) {
                const debug = f105252(onSubmitSuccess[2]).debug;
  ...
  f105252 = function(arg0) {
    const self = this;
    const apply = f105252.apply;
  ...
  c46 = 8;
  obj = { class: "form", onSubmit: tmp13(() => f69984, items1) };
