// _runtime/05268_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05275_AudioTypes.js";
import ImageTypes from "05276_ImageTypes.js";
import VideoTypes from "05277_VideoTypes.js";
import CompressedTypes from "05278_CompressedTypes.js";
import OtherTypes from "05279_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5269).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5269).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5269).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5269).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
