// _runtime/12667_getCurrentHubShim.js
import getClient from "12586_getClient.js";
import _flush from "12607__flush.js";
import addBreadcrumb from "12632_addBreadcrumb.js";
...
function getCurrentHubShim() {
  return {
    bindClient(arg0) {
      const currentScope = callback(12586).getCurrentScope();
      currentScope.setClient(arg0);
    },
    withScope: getClient.withScope,
    getClient() {
      return callback(12586).getClient();
    },
    ...
    getIntegration(id) {
      const client = callback(12586).getClient();
