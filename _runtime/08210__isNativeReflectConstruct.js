// === Module 8210: _isNativeReflectConstruct ===
...
let items = [
  {
    ...
    value: function render() {
      ...
      const tmp5 = importDefault(8211)(propsAndStylesResult, this);
      const obj2 = self(8218);
      const tmp4 = importDefault;
      if (typeof hasProps !== "error") {
