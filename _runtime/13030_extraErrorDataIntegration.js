// _runtime/13030_extraErrorDataIntegration.js
        ...
        if (obj2.isError(obj.originalException)) {
          ...
          if (tmp7) {
            ...
            if (tmp4Result.isPlainObject(normalizeResult)) {
              const result = _mod12946.addNonEnumerableProperty(normalizeResult, "__sentry_skip_normalization__", true);
              obj3[tmp6] = normalizeResult;
              const tmp4Result2 = _mod12946;
            }
            let obj4 = {};
