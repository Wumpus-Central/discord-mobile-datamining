...
export const randomBytes = function randomBytes() {
  ...
  if (Hash(9275).crypto) {
    if (typeof Hash(9275).crypto.getRandomValues === "function") {
      const _crypto2 = Hash(9275).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(9275).crypto) {
    if (typeof Hash(9275).crypto.randomBytes === "function") {
      const _crypto = Hash(9275).crypto;
