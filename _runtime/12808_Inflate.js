// _runtime/12808_Inflate.js
import { 12803__ } from "metro/12803__.js";
const require = arg1;
...
class Inflate {
  constructor(arg0) {
    ...
    if (this instanceof Inflate) {
      ...
      if (inflateInit2Result !== require("module_12812").Z_OK) {
        tmp19 = globalThis;
        _Error = Error;
        tmp20 = new.target;
        tmp21 = new.target;
        error = new Error(require("module_12803")[inflateInit2Result]);
        tmp23 = error;
        throw error;
      } else {
        tmp14 = new.target;
    ...
    if (this.ended) {
      ...
      if (arg1 === ~~arg1) {
        ...
        if (true === arg1) {
          tmp5 = closure_0;
          tmp6 = closure_1;
          Z_NO_FLUSH = require("module_12812").Z_FINISH;
        } else {
          tmp3 = closure_0;
          tmp4 = closure_1;
          Z_NO_FLUSH = require("module_12812").Z_NO_FLUSH;
        }
        tmp7 = Z_NO_FLUSH;
      }
    }
  ...
  onEnd(arg0) {
    ...
    tmp = closure_0;
    tmp2 = closure_1;
    if (arg0 === require("module_12812").Z_OK) {
      str = "string";
