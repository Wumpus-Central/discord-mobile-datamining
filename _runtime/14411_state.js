...
import _mod14406 from "metro/14406__.js";
import _mod14412 from "metro/14412__.js";
...
if (!_mod14412) {
  if (!_mod14366.state) {
    ...
    let fn = function t(facade, arg1) {
      if (require("metro/14373__.js")(facade, closure_6)) {
        const typeError = new _mod14350.TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        _mod14406(facade, closure_6, arg1);
        return arg1;
      }
    };
    let fn4 = fn;
    let fn2 = function n(arg0) {
      return require("metro/14373__.js")(arg0, closure_6) ? arg0[closure_6] : {};
    };
    let fn5 = fn2;
    let fn3 = function u(arg0) {
      return require("metro/14373__.js")(arg0, closure_6);
    };
    let fn6 = fn3;
  }
  const obj = {
