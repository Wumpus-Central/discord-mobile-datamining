...
function create(handlerTag) {
  ...
  let obj = { wrappedSetGestureState: fn, handlerTag, State: require("metro/06383__.js").State };
  fn.__closure = obj;
  ...
  obj = { wrappedSetGestureState: fn, handlerTag, State: require("metro/06383__.js").State };
  fn2.__closure = obj;
  ...
  S.__closure = { wrappedSetGestureState: fn, handlerTag, State: require("metro/06383__.js").State };
  ...
  obj1 = { wrappedSetGestureState: fn, handlerTag, State: require("metro/06383__.js").State };
  fn3.__closure = { wrappedSetGestureState: fn, handlerTag, State: require("metro/06383__.js").State };
  fn3.__workletHash = 6198601582791;
  fn3.__initData = closure_6;
  obj[4] = fn3;
  return obj;
}
obj = { wrappedSetGestureState: fn, State: require("metro/06383__.js").State };
