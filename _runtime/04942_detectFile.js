...
arg5.detectFile = function detectFile(uint8Array, chunkSize) {
  ...
  if (0 !== fileChunk.length) {
    const items = [];
    const items1 = [];
    for (const key10027 in 04944__.FileTypes) {
      let tmp22 = key10027;
      let _Object4 = Object;
      let call2 = hasOwnProperty2.call;
      let tmp23 = require;
      let tmp24 = dependencyMap;
      let FileTypes5 = 04944__.FileTypes;
    ...
    if (0 !== items.length) {
      ...
      const FileTypes4 = 04944__.FileTypes;
