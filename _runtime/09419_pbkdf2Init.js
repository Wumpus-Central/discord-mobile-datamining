// _runtime/09419_pbkdf2Init.js
import _asyncLoop from "09416__asyncLoop.js";
import number from "09417_number.js";
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9416).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9420).hmac;
    let obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9416).toBytes(B);
