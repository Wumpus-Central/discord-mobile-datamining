// _runtime/05488__isNativeReflectConstruct.js
...
let items = [
  ...
  },
  {
    ...
    value: function initialize() {
      const self = this;
      let obj = ContinousBaseGesture(5489);
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5472).isRemoteDebuggingEnabled();
        const obj = ContinousBaseGesture(5472);
      }
      return tmp;
    }
  }
