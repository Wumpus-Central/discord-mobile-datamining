// === Module 14502: FormatNumericToString ===

// Module 14502 (FormatNumericToString)
import TEN from "TEN" /* 14488 */;

const _mod14486 = tmp5(14486);
const GetUnsignedRoundingMode = tmp5(14503);
const ToRawPrecision = tmp5(14504);
const ToRawFixed = tmp5(14505);
require = arg1;
...
export const FormatNumericToString = function FormatNumericToString(roundingType, timesResult) {
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14486.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14486.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
  ...
  _mod14486.invariant(timesResult.isFinite(), "NumberFormatDigitInternalSlots value is not finite");
  let str = "positive";
