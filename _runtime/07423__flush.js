...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  function finishCheckIn(status) {
    ...
    obj[3] = monitorSlug(7389).timestampInSeconds() - closure_3;
    const obj2 = monitorSlug(7389);
    const currentScope = monitorSlug(7402).getCurrentScope();
    const obj3 = monitorSlug(7402);
    const client = monitorSlug(7402).getClient();
    if (client) {
      if (client.captureCheckIn) {
