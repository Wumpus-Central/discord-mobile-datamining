// _runtime/01828_KeyboardController.js
import importDefaultResult from "00005_asyncGeneratorStep.js";
import { KeyboardEvents, KeyboardEvents as KeyboardEvents2 } from "01626_nativeEventEmitter.js";
        ...
        if (arg0 === 1) {
          ...
          const promise = new Promise((arg0) => {
            ...
            if (c2) {
              ...
              const KeyboardEvents = callback(1626).KeyboardEvents;
              dependencyMap = KeyboardEvents.addListener("keyboardDidHide", () => {
                callback(undefined);
                closure_1.remove();
              });
              const KeyboardControllerNative = callback(1626).KeyboardControllerNative;
