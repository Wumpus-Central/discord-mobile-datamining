// === Module 6350: Background ===

// Module 6350 (Background)
import registerAssetDefault from "registerAsset" /* 6351 */;
import registerAssetDefault2 from "registerAsset" /* 6352 */;
import registerAssetDefault3 from "registerAsset" /* 6353 */;
import registerAssetDefault4 from "registerAsset" /* 6354 */;
import registerAssetDefault5 from "registerAsset" /* 6355 */;

const items = [registerAssetDefault, registerAssetDefault2, registerAssetDefault3, registerAssetDefault4, registerAssetDefault5];
for (const key10025 in require("module_6356")) {
  let tmp2 = key10025;
  arg5[key10025] = require("module_6356")[key10025];
  continue;
}
