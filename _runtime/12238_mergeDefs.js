        ...
        localeError: (code) => {
          ...
          switch (code) {
            ...
            case "u":
              ...
              let tmp50 = code[parsedTypeResult];
              if (tmp50 == null) {
            ...
            case "DateParser":
              ...
              if (tmp19) {
                ...
                let combined3 = "Terlalu kecil: dijangka " + origin + " " + tmp19.verb + " " + str17 + code.minimum.toString() + " " + tmp19.unit;
              } else {
            ...
            case "Err":
              ...
              let combined5 = "Kunci tidak dikenali: " + joinValuesResult;
              return combined5;
            case "ro":
            break;
            case "or":
              let _HermesInternal2 = HermesInternal;
              let combined6 = "Kunci tidak sah dalam " + code.origin;
              return combined6;
            ...
            case "HT":
              ...
              let combined7 = "Nilai tidak sah dalam " + code.origin;
              return combined7;
            case "TP":
            break;
            case "P":
            ...
            case "startCollectors":
              ...
              combined5 = "Kunci tidak dikenali: " + joinValuesResult;
              return combined5;
            case "FormSubmitErrorType":
            break;
            case "person_walking_facing_right_tone5":
              _HermesInternal2 = HermesInternal;
              combined6 = "Kunci tidak sah dalam " + code.origin;
              return combined6;
            ...
            case "onPermissionsChanged":
              ...
              str = "Nilai tidak sah dalam ";
              combined7 = "Nilai tidak sah dalam " + code.origin;
              return combined7;
