// _runtime/00579_RequestBase.js
import _createForOfIteratorHelper from "00529__createForOfIteratorHelper.js";
import _mod573 from "metro/00573__.js";
  ...
  abort() {
    ...
    if (this._aborted) {
      ...
      if (self.req) {
        tmp2 = closure_0;
        tmp3 = closure_1;
        obj = require("metro/00573__.js");
        tmp4 = globalThis;
        _process = process;
        str = "v13.0.0";
        if (obj.gte(process.version, "v13.0.0")) {
          tmp2Result = require("metro/00573__.js");
          _process2 = process;
          str2 = "v14.0.0";
