// _runtime/13107_SessionFlusher.js
...
const items = [
  entry,
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(13060).dropUndefinedKeys(obj);
    },
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(13081).getIsolationScope();
        ...
        const obj = SessionFlusher(13081);
      }
    },
  },
  {
