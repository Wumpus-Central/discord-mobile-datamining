// _runtime/04858_isAAC.js
import { getFileChunk } from "04854_getFileChunk.js";
import { 04855__ } from "metro/04855__.js";
const require = arg1;
...
arg5.isAAC = function isAAC(fileChunk, excludeSimilarTypes) {
  ...
  const FileTypes = 04855__.FileTypes;
  ...
  if (!checkByFileTypeResult) {
    ...
    if (!excludeSimilarTypes) {
      const fileChunk1 = tmp(4854).getFileChunk(fileChunk);
      const FileTypes2 = tmp(4855).FileTypes;
