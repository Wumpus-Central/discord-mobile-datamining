// _runtime/07136_CardContainer.js
import Link from "01485_Link.js";
import _mod5719 from "metro/05719__.js";
import ModalPresentationContext from "07126_ModalPresentationContext.js";
import _mod7137 from "metro/07137__.js";
import CardA11yWrapper from "07138_CardA11yWrapper.js";
import _mod7139 from "metro/07139__.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5719.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5719;
  }
  closure_15 = tmp12;
