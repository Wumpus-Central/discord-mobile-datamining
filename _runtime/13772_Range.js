// _runtime/13772_Range.js
import _createClass from "metro/00042__createClass.js";
import LRUCache from "13773_LRUCache.js";
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("metro/13744__.js")(require);
    ...
    value: function parseRange(str) {
      ...
      if (value) {
        ...
        let str3 = str.replace(
          tmp11(13747).safeRe[tmp11(undefined, 13747).t.COMPARATORTRIM],
          tmp11(13747).comparatorTrimReplace,
        );
        tmp11(13746)("comparator trim", str3);
        let str5 = str3.replace(
          tmp11(13747).safeRe[tmp11(undefined, 13747).t.TILDETRIM],
          tmp11(13747).tildeTrimReplace,
        );
        tmp11(13746)("tilde trim", str5);
        const str7 = str5.replace(
          tmp11(13747).safeRe[tmp11(undefined, 13747).t.CARETTRIM],
          tmp11(13747).caretTrimReplace,
        );
