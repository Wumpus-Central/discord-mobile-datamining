// _runtime/04043_differenceInMonths.js
...
import module_4044_mod from "metro/04044__.js";
...
if (!module_4044) {
  const obj5 = { default: module_4044 };
  let tmp11 = obj5;
} else {
  tmp11 = module_4044;
}
...
export default function differenceInMonths(date, friendsSince) {
  ...
  if (absolute >= 1) {
    ...
    tmp11 = module_4044.default(_typeof.default(date)) && 1 === absolute && 1 === compareAsc.default(date, defaultResult2);
  }
  let num4 = 0;
  if (0 !== num) {
    num4 = num;
