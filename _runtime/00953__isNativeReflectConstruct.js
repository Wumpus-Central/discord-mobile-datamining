// _runtime/00953__isNativeReflectConstruct.js
...
function addNetworkBreadcrumb(isEnabled, name) {
  ...
  if (isEnabledResult) {
    ...
    if (isSentryRequestUrlResult) {
      obj = registerSpanErrorInstrumentation;
      isSentryRequestUrlResult = obj.isSentryRequestUrl(name.name, require("00682_registerSpanErrorInstrumentation.js").getClient());
