// _runtime/07036_CardContainer.js
import Link from "01484_Link.js";
import _mod5645 from "metro/05645__.js";
import ModalPresentationContext from "07026_ModalPresentationContext.js";
import _mod7037 from "metro/07037__.js";
import CardA11yWrapper from "07038_CardA11yWrapper.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5645.getHeaderTitle(options, route.name);
    href = tmp2Result1.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result2 = _mod5645;
  }
  closure_15 = tmp12;
  ...
  obj8.children = React4(_mod5645.HeaderHeightContext.Provider, obj9);
  obj7.children = React4(_mod5645.HeaderShownContext.Provider, obj8);
  obj6.children = React4(_mod5645.HeaderBackContext.Provider, obj7);
  ...
  obj.children = React4(_mod7039.Card, obj1);
