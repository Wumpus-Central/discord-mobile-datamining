// _runtime/13536___exportStarResult26.js
import { getMultiInternalSlots } from "13489_getMultiInternalSlots.js";
import { __exportStarResult3 } from "13492___exportStarResult3.js";
import { __exportStarResult4 } from "13494___exportStarResult4.js";
const require = arg1;
...
arg5.SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(internalSlots, result1, minimumFractionDigits, arg3, GetOptionResult1) {
  ...
  if (flag2) {
    if (tmp11) {
      internalSlots.minimumSignificantDigits = tmp2(13493).DefaultNumberOption(minimumSignificantDigits, 1, 21, 1);
      internalSlots.maximumSignificantDigits = tmp2(13493).DefaultNumberOption(maximumSignificantDigits, internalSlots.minimumSignificantDigits, 21, 21);
    } else {
  ...
  if (flag) {
    if (tmp12) {
      const DefaultNumberOptionResult = tmp2(13493).DefaultNumberOption(minimumFractionDigits, 0, 100, undefined);
      const DefaultNumberOptionResult1 = tmp2(13493).DefaultNumberOption(maximumFractionDigits, 0, 100, undefined);
      if (undefined === DefaultNumberOptionResult) {
        tmp2(13489).invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      tmp2(13489).invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
      const _RangeError = RangeError;
      tmp2(13489).invariant(internalSlots.maximumFractionDigits === internalSlots.minimumFractionDigits, "With roundingIncrement > 1, maximumFractionDigits and minimumFractionDigits must be equal.", RangeError);
    }
  }
