// _runtime/13980_state.js
import _mod13919 from "metro/13919__.js";
import __core_js_shared__ from "13935___core-js_shared__.js";
import call from "13942_call.js";
import _mod13964 from "metro/13964__.js";
import all from "13981_all.js";
import __core_js_shared__2 from "13982___core-js_shared__.js";
  ...
  if (!__core_js_shared__.state) {
    ...
    let fn = function t(facade) {
      if (call(facade, closure_6)) {
        const typeError = new tmp(13919).TypeError("Object already initialized");
        throw typeError;
      } else {
        arg1.facade = facade;
        tmp(13975)(facade, tmp3, arg1);
        return arg1;
      }
      tmp3 = closure_6;
    };
...
if (!state) {
  ...
  const weakMap = new _mod13919.WeakMap();
...
fn4 = function t(facade) {
  if (state.has(facade)) {
    const typeError = new _mod13919.TypeError("Object already initialized");
    throw typeError;
  } else {
    arg1.facade = facade;
