// === Module 5896: useRecyclerViewController ===

// Module 5896 (useRecyclerViewController)
import closure_2 from "asyncGeneratorStep" /* 5897 */;
import closure_3 from "_slicedToArray" /* 5854 */;
...
export const useRecyclerViewController = function useRecyclerViewController(recyclerViewManager, arg1, arg2, arg3) {
  ...
  dependencyMap = arg2;
  closure_2 = arg3;
  const unmountFlag = _require(5898).useUnmountFlag();
  let obj = _require(5898);
  ...
  _setTimeout = _require(5899).useUnmountAwareTimeout().setTimeout;
