        ...
        while (true) {
          while (!str3) {
            ...
            switch (obj.symbol) {
                  ...
                  if (obj.accept("comma")) {
                    ...
                    if ("last" === symbol2) {
                      ...
                      if ("nth" === symbol2) {
                        ...
                        let parsed = parseInt(obj.value[1], num11);
                        if (parsed >= num) {
                          if (parsed <= num10) {
              ...
              case "file":
                while (true) {
                  if (num12) {
                    ...
                    let str7 = "until";
                    if ("until" === obj.symbol) {
                      let symbol = globalThis;
                      let _Date = Date;
                      str5 = Date.parse(obj.text);
                      if (str5) {
                        symbol = symbol.Date;
                        let tmp21 = new.target;
                        let tmp22 = new.target;
                        let tmp23 = str5;
                        symbol = new symbol(str5);
                        let tmp25 = symbol;
                        obj.until = symbol;
                        tmp2 = obj;
                      } else {
                        ...
                        let error3 = new Error("Cannot parse until date:" + obj.text);
                        let tmp20 = error3;
                        throw error3;
                      }
                    } else {
              ...
              case "DEVELOPER_GIFT":
              break;
              case "GIFTABLE_CURRENCIES":
              break;
              case "SURFING_WAKEBOARDING":
              break;
              case "GUILD_FOLDER_CREATE_LOCAL":
              break;
              case "LOCAL_ACTIVITY_UPDATE":
              break;
              ...
              case "PROMPT_SEEN":
              break;
              case "_connectMediaEngineWithEndpoint":
              break;
                ...
                if (obj.nextSymbol()) {
                  ...
                  if ("until" === obj.symbol) {
                    ...
                    if (parsed2) {
                      ...
                      let tmp74 = parsed2;
                      let date1 = new Date(parsed2);
                      let tmp76 = date1;
                      obj.until = date1;
                      tmp2 = obj;
                    } else {
                      let _Error7 = Error;
                      let str24 = "Cannot parse until date:";
                      let tmp68 = new.target;
                      let tmp69 = new.target;
                      let error4 = new Error("Cannot parse until date:" + obj.text);
                      let tmp71 = error4;
                      throw error4;
                    }
                  } else {
              ...
              case "RATIONAL":
              break;
              case "available_video_decoders":
              break;
              case "_decoder":
              break;
              case "decoder":
              break;
              case "showInstantInviteActionSheet":
              break;
              case "showInstantInviteActionSheetForChannel":
              break;
          ...
          let tmp82 = globalThis;
          let _Error9 = Error;
          let tmp83 = new.target;
          let str26 = "Unexpected end";
