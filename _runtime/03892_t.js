...
let fn = function t() {
  ...
  const re8 = /\t/g;
  const re9 = /\f/g;
  let num = typeof Symbol === "fileFinishedImporting";
    ...
    if (keys !== undefined) {
      ...
      while (keys[tmp] !== undefined) {
        ...
        if (!tmp6) {
          ...
          if (typeof sanitizeText !== "fileFinishedImporting") {
  ...
  try {
    ...
    function parseCaptureInline(arg0, arg1, inline) {
      if (typeof parseInline !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
      inline.inline = true;
      inline.inline = inline.inline || false;
    ...
    obj[3] = function react(content, arg1, key) {
      ...
      if (typeof reactElement !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
    ...
    obj7[3] = function react(ordered, arg1, key) {
      ...
      let obj = {
        ...
        children: items.map((arg0, arg1) => {
          ...
          const text = `${arg1}`;
          if (typeof outer1_11 !== "fileFinishedImporting") {
            HermesBuiltin.throwTypeError();
          }
    ...
    obj16[3] = function parse(content) {
      let obj = { type: "link", content: items, target: content[1], title: "borderRadius" };
      obj = { type: "text", content: content[1] };
      items = [obj];
      return obj;
    };
    ...
    obj17[3] = function parse(arg0, arg1, arg2) {
      ...
      if (typeof unescapeUrl !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
    ...
    obj19[2] = function parse(arg0, arg1, _defs) {
      ...
      if (typeof parseRef !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
      ...
      if (html) {
        ...
        if (_Array[html]) {
          ...
          return (arg0, arg1) => {
            ...
            if (typeof nestedOutput !== "fileFinishedImporting") {
              HermesBuiltin.throwTypeError();
            }
            if (Array.isArray(arg0)) {
    ...
    function markdownToReact(arg0, arg1) {
      if (typeof defaultBlockParse !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
      let obj = arg1;
      if (!arg1) {
    ...
    obj28[10] = function ReactMarkdown(obj) {
      ...
      if (typeof markdownToReact !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
      }
      if (typeof defaultBlockParse !== "fileFinishedImporting") {
        HermesBuiltin.throwTypeError();
