// _runtime/05925_JSFPSMonitor.js
import _createClassDefault from "metro/05873__createClass.js";
import closure_2 from "metro/05872__classCallCheck.js";
...
const items = [
  ...
  },
  {
    ...
    value: function startTracking() {
      ...
      if (0 !== this.startTime) {
        const _Error = Error;
        error = new Error(JSFPSMonitor(5860).ErrorMessages.fpsMonitorAlreadyRunning);
        throw error;
      } else {
        const _Date = Date;
  ...
  },
  {
    ...
    value: function stopAndGetData() {
      ...
      const obj = { minFPS: JSFPSMonitor(5926).roundToDecimalPlaces(self.minFPS, 1), maxFPS: null, averageFPS: null };
      const obj2 = JSFPSMonitor(5926);
      obj[1] = JSFPSMonitor(5926).roundToDecimalPlaces(self.maxFPS, 1);
      const obj3 = JSFPSMonitor(5926);
      obj[2] = JSFPSMonitor(5926).roundToDecimalPlaces(self.averageFPS, 1);
      return obj;
    },
  },
];
