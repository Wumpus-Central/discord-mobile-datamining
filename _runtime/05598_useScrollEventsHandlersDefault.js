// _runtime/05598_useScrollEventsHandlersDefault.js
import { cancelAnimation } from "01654_cancelAnimation.js";
import { useBottomSheetInternal } from "05579_useBottomSheetInternal.js";
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: require("05572_GESTURE_SOURCE.js").SHEET_STATE, animatedHandleGestureState, State: require("05599_LegacyBaseButton.js").State, animatedScrollableState, SCROLLABLE_STATE: require("05572_GESTURE_SOURCE.js").SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: require("01654_cancelAnimation.js").scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj[0] = require("01654_cancelAnimation.js").useWorkletCallback(E, items);
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: require("05572_GESTURE_SOURCE.js").SHEET_STATE };
  O.__closure = obj1;
  ...
  obj[1] = require("01654_cancelAnimation.js").useWorkletCallback(O, items1);
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: require("05572_GESTURE_SOURCE.js").SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: require("01654_cancelAnimation.js").scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: require("05572_GESTURE_SOURCE.js").ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
  ...
  obj[2] = require("01654_cancelAnimation.js").useWorkletCallback(fn2, items2);
  ...
  obj[3] = require("01654_cancelAnimation.js").useWorkletCallback(C, items3);
  return obj;
};