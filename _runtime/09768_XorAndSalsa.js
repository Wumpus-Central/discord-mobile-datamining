// _runtime/09768_XorAndSalsa.js
import _asyncLoop from "09769__asyncLoop.js";
import pbkdf2Init from "09772_pbkdf2Init.js";
import _isNativeReflectConstruct from "09774__isNativeReflectConstruct.js";
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9769).isLE) {
                callback(9769).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
