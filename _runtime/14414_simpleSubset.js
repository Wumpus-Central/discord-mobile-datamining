// _runtime/14414_simpleSubset.js
import _mod14386 from "metro/14386__.js";
import Comparator from "14400_Comparator.js";
...
function simpleSubset(arg0, item10015, includePrerelease) {
  ...
  if (arg0 === item10015) {
    ...
    if (set.size > 1) {
      ...
      if (tmp) {
        if (tmp2) {
          const tmp46 = _mod14386(tmp.semver, tmp2.semver, includePrerelease);
          if (tmp46 > 0) {
            return null;
          } else {
            let tmp39 = tmp46;
...
function higherGT(semver, semver2, includePrerelease) {
  if (semver) {
    const tmp4 = _mod14386(semver.semver, semver2.semver, includePrerelease);
    let tmp5 = semver;
    if (tmp4 <= 0) {
      if (tmp4 < 0) {
        let tmp6 = semver2;
...
export default (arg0, arg1) => {
  ...
  if (arg0 === arg1) {
    ...
    const tmp22 = new _mod14401(arg0, obj);
    const tmp27 = new _mod14401(arg1, obj);
    let flag = false;
