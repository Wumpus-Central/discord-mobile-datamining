// _runtime/04918_OrdinaryDefineOwnProperty.js
...
import ValidateAndApplyPropertyDescriptor from "04921_ValidateAndApplyPropertyDescriptor.js";

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4855(arg0)) {
    if (_mod4902(arg1)) {
      if (_mod4906(__Writable__)) {
        if (_mod1284) {
          ...
          return ValidateAndApplyPropertyDescriptor(arg0, arg1, _mod4920(arg0), __Writable__, tmp31);
