// _runtime/00725_isFullFinishedSpan.js
...
class SentrySpan {
  constructor() {
    ...
    obj[require("metro/00704__.js").SEMANTIC_ATTRIBUTE_SENTRY_OP] = obj.op;
  ...
  },
  {
    ...
    value: function getSpanJSON() {
      ...
      const obj = {
        ...
        status: SentrySpan(684).getStatusMessage(this._status),
        timestamp: null,
        trace_id: null,
        origin: _attributes[SentrySpan(undefined, 704).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN],
        profile_id: this._attributes[SentrySpan(undefined, 704).SEMANTIC_ATTRIBUTE_PROFILE_ID],
        exclusive_time: this._attributes[SentrySpan(undefined, 704).SEMANTIC_ATTRIBUTE_EXCLUSIVE_TIME],
        measurements: null,
        is_segment: null,
        segment_id: null,
        links: null,
