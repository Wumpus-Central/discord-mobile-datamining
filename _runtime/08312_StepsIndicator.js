// _runtime/08312_StepsIndicator.js
import _mod8310 from "metro/08310__.js";
import _mod8311 from "metro/08311__.js";
import SliderTrackMark from "08313_SliderTrackMark.js";
import StepNumber from "08314_StepNumber.js";
...
export const StepsIndicator = function StepsIndicator(options) {
  ...
  const memo1 = currentValue.useMemo(() => {
    if ("web" === get_ActivityIndicator.Platform.OS) {
      ...
      let obj = { marginHorizontal: sliderWidth * _mod8310.constants.MARGIN_HORIZONTAL_PADDING };
    ...
    if ("web" === get_ActivityIndicator.Platform.OS) {
      ...
      obj = { width: tmp6(8310).constants.THUMB_SIZE, justifyContent: "space-between" };
      let stepIndicatorElement = Object.assign({}, tmp6(8311).styles.stepIndicatorElement, obj);
    } else {
