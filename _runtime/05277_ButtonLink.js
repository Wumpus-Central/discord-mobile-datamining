...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(5269)(color);
      str4 = tmp9(5269)(color).darken(0.71).string();
      const darkenResult = tmp9(5269)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
    obj10 = Color(color);
