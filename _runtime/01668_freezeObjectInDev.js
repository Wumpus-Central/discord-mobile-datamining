// _runtime/01668_freezeObjectInDev.js
      ...
      get(arg0, arg1) {
        if ("_isReanimatedSharedValue" !== arg1) {
          if ("__remoteFunction" !== arg1) {
            ...
            const reanimatedError = new require("metro/01649__.js").ReanimatedError(
                            ...
                            if (ArrayBuffer.isView(__workletContextObjectFactory)) {
                              ...
                              const fn = function s() {
                                if (closure_9.includes(name)) {
                                  ...
                                  const _HermesInternal = HermesInternal;
                                  const reanimatedError1 = new require("metro/01649__.js").ReanimatedError(
...
export const makeShareable = module_1641
