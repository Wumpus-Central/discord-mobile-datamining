                          ...
                          const fn = function s() {
                            if (closure_9.includes(name)) {
                              if (undefined === global[name]) {
                                ...
                                const reanimatedError = new require("module_1649").ReanimatedError("[Reanimated] Constructor for `" + name + "` not found.");
                                throw reanimatedError;
                              } else {
                              ...
                              const _HermesInternal = HermesInternal;
                              const reanimatedError1 = new require("module_1649").ReanimatedError("[Reanimated] Invalid array view name `" + name + "`.");
