// _runtime/08552_peg_SyntaxError.js
  ...
  format(arg0) {
    ...
    if (this.location) {
      ...
      if (self.location.source) {
        offsetResult = start;
        if (typeof self.location.source.offset !== "disabledUntil") {
  ...
  parse: function peg$parse(str) {
                    ...
                    if (tmp16Result4 !== tmp13) {
                      ...
                      if (tmp16Result5 !== tmp13) {
                        ...
                        if (tmp16Result6 !== tmp13) {
                          ...
                          if (tmp38 !== tmp13) {
                            tmp2();
                            if (typeof peg$f1 !== "fileFinishedImporting") {
        ...
        if (tmp58 !== tmp13) {
          ...
          if (tmp67 !== tmp13) {
            ...
            if (tmp74 !== tmp13) {
              ...
              if (typeof peg$f2 !== "fileFinishedImporting") {
                throwTypeErrorResult = HermesBuiltin.throwTypeError();
              }
              if (null == tmp66Result) {
                obj = { translate: null };
        ...
        if (tmp97 !== tmp13) {
          ...
          if (throwTypeErrorResult !== tmp13) {
            ...
            if (throwTypeErrorResult !== tmp13) {
              ...
              if (typeof peg$f3 !== "fileFinishedImporting") {
                throwTypeErrorResult = HermesBuiltin.throwTypeError();
              }
              throwTypeErrorResult = null;
          ...
          if (throwTypeErrorResult !== tmp13) {
            ...
            if (throwTypeErrorResult !== tmp13) {
              ...
              if (throwTypeErrorResult !== tmp13) {
                ...
                if (typeof peg$f5 !== "fileFinishedImporting") {
                  throwTypeErrorResult = HermesBuiltin.throwTypeError();
                }
            ...
            if (throwTypeErrorResult !== tmp13) {
              ...
              if (typeof peg$f4 !== "fileFinishedImporting") {
                throwTypeErrorResult = HermesBuiltin.throwTypeError();
              }
              throwTypeErrorResult = null;
              if (null !== throwTypeErrorResult) {
        ...
        if (throwTypeErrorResult !== tmp13) {
          ...
          if (throwTypeErrorResult !== tmp13) {
            ...
            if (throwTypeErrorResult !== tmp13) {
              ...
              if (typeof peg$f6 !== "fileFinishedImporting") {
                throwTypeErrorResult = HermesBuiltin.throwTypeError();
              }
        ...
        if (throwTypeErrorResult !== tmp13) {
          ...
          if (throwTypeErrorResult !== tmp13) {
            ...
            if (throwTypeErrorResult !== tmp13) {
              ...
              if (typeof peg$f7 !== "fileFinishedImporting") {
                throwTypeErrorResult = HermesBuiltin.throwTypeError();
              }
    ...
    function peg$parseNUM() {
      ...
      if (tmp41 !== tmp72) {
        ...
        if (typeof peg$f8 !== "fileFinishedImporting") {
    ...
    function peg$parsestart() {
      ...
      if (tmp3 !== obj) {
        ...
        let closure_51 = tmp;
        if (typeof peg$f0 !== "fileFinishedImporting") {
