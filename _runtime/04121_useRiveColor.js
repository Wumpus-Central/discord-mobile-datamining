// _runtime/04121_useRiveColor.js
import _slicedToArray from "_slicedToArray";
import { c } from "04103_c.js";
import { RiveColor } from "04111_RiveColor.js";
import { useRiveProperty } from "04116_useRiveProperty.js";

let require = arg1;
require("noop").useCallback;
const f29113 = (colorProperty) => colorProperty.colorProperty(arg1);
...
export const useRiveColor = function useRiveColor(FillColor, instance) {
  ...
  const tmp4 = callback(useRiveProperty.useRiveProperty(instance, FillColor, f29113), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
