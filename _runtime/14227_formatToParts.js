// _runtime/14227_formatToParts.js
import digitsToString from "14205_digitsToString.js";
import _mod14228 from "metro/14228__.js";
import e from "01162_e.js";

let closure_2 = e.__importDefault(digitsToString);
const regExp = new RegExp("^".concat(_mod14228.S_UNICODE_REGEX.source));
const regExp1 = new RegExp("".concat(_mod14228.S_UNICODE_REGEX.source, "$"));
const re5 = /[#0](?:[\.,][#0]+)*/g;
...
export default function formatToParts(magnitude, numbers, arg2, currencyDisplay) {
  ...
  if (0 < parts4.length) {
    ...
    let formattedString = fn(14223).GetUnsignedRoundingMode(currencyDisplay.roundingMode, tmp42);
    fn = undefined;
    ...
    fn = fn(14229).digitMapping[numberingSystem];
    ...
    if (undefined === substr1) {
      if ("scientific" === notation) {
        ...
        if (roundedNumber2.isFinite()) {
          ...
          formattedString = fn(14225).ToRawFixed(_default, 0, 0, roundingIncrement, formattedString).formattedString;
