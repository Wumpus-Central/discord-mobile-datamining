// _runtime/01707_maybeModifyStyleForKeyframe.js
...
import WebEasings from "01697_WebEasings.js";
import BaseAnimationBuilder from "01708_BaseAnimationBuilder.js";
import _mod1724 from "metro/01724__.js";
...
function setElementAnimation(cloneNodeResult, dummyAnimationConfig, arg2) {
  ...
  if (dummyAnimationConfig.animationType === require("metro/01663__.js").LayoutAnimationType.ENTERING) {
...
export const getReducedMotionFromConfig = function getReducedMotionFromConfig(entering) {
  if (entering.reduceMotionV) {
    ...
    if (_mod1663.ReduceMotion.Never === reduceMotionV) {
      return false;
    } else if (_mod1663.ReduceMotion.Always === reduceMotionV) {
      return true;
    } else {
...
export const handleLayoutTransition = function handleLayoutTransition(_componentDOMRef, processedConfig, easingY) {
  ...
  const TransitionGeneratorResult = tmp4(1726).TransitionGenerator(ENTRY_EXIT, easingY);
};
