// _runtime/07525_spanTimeInputToSeconds.js
import { consoleSandbox } from "07520_consoleSandbox.js";
import { addNonEnumerableProperty } from "07526_addNonEnumerableProperty.js";
import { generatePropagationContext } from "07530_generatePropagationContext.js";
import { regExp } from "07532_regExp.js";
import { dateTimestampInSeconds } from "07534_dateTimestampInSeconds.js";
import { getMetricSummaryJsonForSpan } from "07536_getMetricSummaryJsonForSpan.js";
import { getSpanStatusFromHttpCode } from "07537_getSpanStatusFromHttpCode.js";
  ...
  if ((function spanIsSentrySpan(getSpanJSON) {
    ...
    try {
      ...
      if ((function spanIsOpenTelemetrySdkTraceBaseSpan(attributes) {
        ...
        obj[8] = attributes[require(undefined, 7535).SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj[9] = attributes[require(undefined, 7535).SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== getSpanStatusFromHttpCode.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== tmp(7537).SPAN_STATUS_OK) {
