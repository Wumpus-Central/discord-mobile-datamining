// _runtime/04831_ScreenStackHeaderSubview.js
import noopDefault from "00019_noop.js";
import get_controlledBottomTabsDefault from "04829_get_controlledBottomTabs.js";
import context from "04832_context.js";
import __INTERNAL_VIEW_CONFIGDefault from "metro/04835___INTERNAL_VIEW_CONFIG.js";
...
const forwardRefResult = noopDefault.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4828).isHeaderBarButtonsAvailableForCurrentPlatform) {
      let tmpResult = tmp(4833);
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4828).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4829).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4834), {});
});
