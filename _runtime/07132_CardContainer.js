// _runtime/07132_CardContainer.js
import Link from "01485_Link.js";
import _mod5717 from "metro/05717__.js";
import ModalPresentationContext from "07122_ModalPresentationContext.js";
import _mod7133 from "metro/07133__.js";
import CardA11yWrapper from "07134_CardA11yWrapper.js";
import _mod7135 from "metro/07135__.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5717.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5717;
  }
  closure_15 = tmp12;
