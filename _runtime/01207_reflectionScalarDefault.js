// _runtime/01207_reflectionScalarDefault.js
import _mod1193 from "metro/01193__.js";
import ScalarType from "01199_ScalarType.js";
import reflectionLongConvert from "01204_reflectionLongConvert.js";
  ...
  if (ScalarType.ScalarType.BOOL === T) {
    ...
    if (ScalarType.ScalarType.UINT64 !== T) {
      if (ScalarType.ScalarType.FIXED64 !== T) {
        ...
        return reflectionLongConvert.reflectionLongConvert(_mod1193.PbLong.ZERO, STRING);
      }
    }
    return reflectionLongConvert.reflectionLongConvert(_mod1193.PbULong.ZERO, STRING);
  }
};
