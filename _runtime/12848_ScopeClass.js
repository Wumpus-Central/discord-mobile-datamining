...
const entry = {
  ...
  value: function clone() {
    ...
    obj = { traceId: null, spanId: null };
    let obj1 = ScopeClass(12837);
    obj.traceId = obj1.generateTraceId();
    let obj2 = ScopeClass(12837);
...
let items = [
  ...
  },
  {
    ...
    value: function clear() {
      ...
      obj.traceId = ScopeClass(12837).generateTraceId();
  ...
  },
  {
    ...
    value: function getScopeData() {
      ...
      const obj = {
        ...
        span: ScopeClass(12849)._getSpanForScope(self),
      };
      return obj;
    },
  },
