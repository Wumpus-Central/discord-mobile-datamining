// _runtime/04921_parseBox.js
import { getDataView } from "04912_getDataView.js";
import { parseItemLocationBox } from "04922_parseItemLocationBox.js";
const require = arg1;
const module = arg2;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(4912).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(4912);
            }
          }
        }
      } else {
