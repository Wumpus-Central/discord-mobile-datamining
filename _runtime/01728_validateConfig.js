...
let fn = function n(userConfig, callback) {
  ...
  obj = { userConfig, isValidRubberBandConfig: require("01729_isValidRubberBandConfig.js").isValidRubberBandConfig, rubberBandDecay: require("01730_rubberBandDecay.js").rubberBandDecay, rigidDecay: require("01731_rigidDecay.js").rigidDecay, validateConfig, callback, getReduceMotionForAnimation: require("01693_isValidLayoutAnimationProp.js").getReduceMotionForAnimation };
  fn.__closure = obj;
