...
export const addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.pre_context = substr.map((item) => require("metro/00697__.js").snipLine(item, 0));
    const _Math5 = Math;
    ...
    lineno.post_context = substr1.map((item) => require("metro/00697__.js").snipLine(item, 0));
  }
};
