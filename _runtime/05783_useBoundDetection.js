// _runtime/05783_useBoundDetection.js
...
export const useBoundDetection = function useBoundDetection(recyclerViewManager, arg1) {
  ...
  const _requestAnimationFrame = require("05780_useUnmountAwareTimeout.js").useUnmountAwareAnimationFrame().requestAnimationFrame;
  let num = 0;
