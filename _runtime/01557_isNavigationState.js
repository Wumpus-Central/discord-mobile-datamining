// _runtime/01557_isNavigationState.js
...
import { PrivateValueStore } from "01487_PrivateValueStore.js";
import { isArrayEqual } from "01547_isArrayEqual.js";
import { useRegisterNavigator } from "01558_useRegisterNavigator.js";
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  const context = React.useContext(require("01524_context.js").NavigationRouteContext);
  const context1 = React.useContext(require("01515_ConsumedParamsContext.js").ConsumedParamsContext);
  let params;
  if (context != null) {
  ...
  const lazyValue = require("01506_useLazyValue.js").useLazyValue(() => {
  ...
  if (mapped.length) {
    ...
    const context2 = React.useContext(require("01500_get_getKey.js").NavigationStateContext);
    ...
    const context3 = React.useContext(require("01513_NavigationBuilderContext.js").NavigationBuilderContext);
    ...
    tmp51 = require("01547_isArrayEqual.js").isArrayEqual(tmp39.routeNames, mapped) && 0 === found.length;
  } else {
    let _Error = Error;
