// _runtime/12345_addToMetricsAggregator.js
import errorCallback from "12245_errorCallback.js";
import _mod12346 from "metro/12346__.js";
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = require("12276_getClient.js").getClient();
    const obj2 = getClient;
  }
  if (client) {
    const activeSpan = require("12254_spanTimeInputToSeconds.js").getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    if (require("metro/12277___SENTRY_DEBUG__.js").DEBUG_BUILD) {
    ...
    const globalSingleton = require("12250_getGlobalSingleton.js").getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  ...
  timing(arg0, arg1, fn) {
    ...
    if (typeof fn === "function") {
      ...
      return require("12283_createChildOrRootSpan.js").startSpanManual(obj, (arg0) => {
        const callback = arg0;
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = require("metro/12346__.js").DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
