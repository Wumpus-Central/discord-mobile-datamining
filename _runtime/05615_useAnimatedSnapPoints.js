// _runtime/05615_useAnimatedSnapPoints.js
import { cancelAnimation } from "01653_cancelAnimation.js";
import { DEFAULT_HANDLE_HEIGHT } from "05442_DEFAULT_HANDLE_HEIGHT.js";
import { normalizeSnapPoint } from "05455_normalizeSnapPoint.js";
const require = arg1;
  ...
  class N {
    constructor() {
      if (closure_4) {
        ...
        tmp = !length;
        if (length) {
          tmp = !items.find(/* F105883 */ function() { ... });
        }
        return !tmp;
      }
    }
