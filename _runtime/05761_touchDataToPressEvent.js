// === Module 5761: touchDataToPressEvent ===
...
arg5.gestureToPressableEvent = (handlerTag) => {
  ...
  nativeEvent = { touches: items, changedTouches: items1, identifier: nativeEvent.identifier, locationX: handlerTag.x, locationY: handlerTag.y, pageX: handlerTag.absoluteX, pageY: handlerTag.absoluteY, target: 0, timestamp, force: "Array" };
  items = [nativeEvent];
  items1 = [nativeEvent];
  return { nativeEvent };
};
