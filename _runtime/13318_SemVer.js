...
class SemVer {
  constructor(arg0, arg1) {
    ...
    tmp2 = SemVer;
    tmp3 = closure_1;
    tmp4 = require("metro/13319__.js")(require);
    ...
    if (version.length > require("metro/13320__.js").MAX_LENGTH) {
      tmp28 = globalThis;
      ...
      tmp29 = new.target;
      tmp30 = new.target;
      typeError1 = new TypeError("version is longer than " + require("metro/13320__.js").MAX_LENGTH + " characters");
      tmp32 = typeError1;
      throw typeError1;
    } else {
      str13 = "SemVer";
      tmp38 = require("metro/13321__.js")("SemVer", version, tmp4);
      self.options = tmp4;
      ...
      if (match) {
        ...
        self.minor = +match[2];
        self.patch = +match[3];
        if (self.major <= require("metro/13320__.js").MAX_SAFE_INTEGER) {
          num = 0;
          if (self.major >= 0) {
            if (self.minor <= require("metro/13320__.js").MAX_SAFE_INTEGER) {
              if (self.minor >= 0) {
                if (self.patch <= require("metro/13320__.js").MAX_SAFE_INTEGER) {
                  if (self.patch >= 0) {
                    if (match[4]) {
                      str2 = match[4];
                      str3 = ".";
...
let items = [
  ...
  },
  {
    ...
    value: function compare(tmp2Result) {
      const self = this;
      SemVer(13321)("SemVer.compare", this.version, this.options, tmp2Result);
  ...
  },
  {
    ...
    value: function compareMain(tmp2Result) {
      ...
      let compareIdentifiersResult = SemVer(13323).compareIdentifiers(self.major, tmpResult.major);
      if (!compareIdentifiersResult) {
        let tmp3Result = tmp3(13323);
        compareIdentifiersResult = tmp3Result.compareIdentifiers(self.minor, tmpResult.minor);
      }
      if (!compareIdentifiersResult) {
        tmp3Result = tmp3(13323);
  ...
  },
  {
    ...
    value: function comparePre(tmp2Result) {
      ...
      while (true) {
        ...
        let tmp8 = tmp3;
        let tmp9 = tmp4;
        let tmp10 = SemVer(13321)("prerelease compare", num3, tmp3, tmp4);
  ...
  },
  {
    ...
    value: function compareBuild(arg0) {
      ...
      while (true) {
        ...
        let tmp8 = tmp3;
        let tmp9 = tmp4;
        let tmp10 = SemVer(13321)("build compare", num, tmp3, tmp4);
        let tmp11 = undefined === tmp3;
        let tmp12 = num;
        if (tmp11) {
          if (undefined === tmp4) {
