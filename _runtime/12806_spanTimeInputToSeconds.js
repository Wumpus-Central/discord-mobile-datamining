// _runtime/12806_spanTimeInputToSeconds.js
...
import _mod12817 from "metro/12817__.js";
import _mod12818 from "metro/12818__.js";
import _mod12819 from "metro/12819__.js";
import _mod12820 from "metro/12820__.js";
import _mod12823 from "metro/12823__.js";
  ...
  if (
    ...
    try {
      ...
      if (
        ...
        obj.op = attributes[_mod12816.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj.origin = attributes[_mod12816.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
        const tmp8 = spanTimeInputToSeconds(endTime);
        obj._metrics_summary = _mod12817.getMetricSummaryJsonForSpan(getSpanJSON);
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12818.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod12818.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod12807.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod12807.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
