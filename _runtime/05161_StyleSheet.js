...
export default function Header(children) {
  ...
  const context = React.useContext(importDefault(5162));
  if (undefined === layout) {
  ...
  if (headerBackground) {
    ...
    if (!headerTransparent) {
      ...
      obj4[0] = items;
      headerBackgroundResult = tmp15(importDefault(5165), obj4);
    }
  }
  ...
  tmp8 = importDefault(5159)(layout, undefined !== modal && modal, headerStatusBarHeight);
