// _runtime/09347_XorAndSalsa.js
import _asyncLoop from "09348__asyncLoop.js";
import pbkdf2Init from "09351_pbkdf2Init.js";
import _isNativeReflectConstruct from "09353__isNativeReflectConstruct.js";
        ...
        try {
          ...
          if (0 === c11) {
            if (arg0 === 1) {
              ...
              if (!callback(9348).isLE) {
                callback(9348).byteSwap32(B32);
              }
              v0 = function* _loop() {
                if (c3 === 2) {
                  c3 = 3;
