// _runtime/11025_NativeModules.js
...
export const getInstallSourceAndroid = () => {
  const InstallSourceAndroid = callback(11017).InstallSourceAndroid;
