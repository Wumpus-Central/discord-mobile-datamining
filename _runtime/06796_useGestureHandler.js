...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: _require(6655).State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj[1] = _require(1636).useWorkletCallback(U, items1);
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: _require(6628).GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  C.__workletHash = 10682034812271;
  C.__initData = closure_4;
  const items2 = [state, gestureSource, source, onEnd];
  obj[2] = _require(1636).useWorkletCallback(C, items2);
  ...
  obj1 = { gestureSource, source, state, GESTURE_SOURCE: _require(6628).GESTURE_SOURCE, onFinalize };
  T.__closure = obj1;
  T.__workletHash = 9696716573416;
  T.__initData = closure_5;
  const items3 = [state, gestureSource, source, onFinalize];
  obj[3] = _require(1636).useWorkletCallback(T, items3);
  return obj;
};