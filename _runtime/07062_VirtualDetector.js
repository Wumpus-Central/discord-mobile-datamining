// _runtime/07062_VirtualDetector.js
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("metro/07061__.js").useInterceptingDetectorContext();
      ...
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = {
            ...
            viewRef: "a",
            userSelect: "_distance",
            touchAction: "a",
            enableContextMenu: "isArray",
          };
          ({
  ...
  let obj = require("metro/07061__.js");
};
