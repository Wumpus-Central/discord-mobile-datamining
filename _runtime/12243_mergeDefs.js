          ...
          switch (code) {
            ...
            case "A":
              if ("regex" === code.format) {
                ...
                let combined = "Nieprawid\u0142owy ci\u0105g znak\u00F3w: musi odpowiada\u0107 wzorcowi " + code.pattern;
              } else {
                ...
                combined = "Nieprawid\u0142ow(y/a/e) " + format;
              }
              return combined;
            case "ay":
            break;
            ...
            case "E":
              ...
              if (obj.test(code.expected)) {
                let combined1 = "Nieprawid\u0142owe dane wej\u015Bciowe: oczekiwano instanceof " + code.expected + ", otrzymano " + tmp53;
              } else {
                const _HermesInternal15 = HermesInternal;
                combined1 = "Nieprawid\u0142owe dane wej\u015Bciowe: oczekiwano " + expected + ", otrzymano " + tmp53;
              }
              return combined1;
            case "Err":
            break;
            case "ro":
              if (1 === code.values.length) {
                ...
                let combined2 = "Nieprawid\u0142owe dane wej\u015Bciowe: oczekiwano " + closure_2.stringifyPrimitive(code.values[0]);
              } else {
                const _HermesInternal13 = HermesInternal;
                combined2 = "Nieprawid\u0142owa opcja: oczekiwano jednej z warto\u015Bci " + closure_2.joinValues(code.values, "|");
              }
              return combined2;
            case "or":
            break;
            case "SEMANTIC_ATTRIBUTE_SENTRY_SOURCE":
              ...
              if (tmp32) {
                ...
                let str37 = tmp32.unit;
                if (str37 == null) {
                  str37 = "element\u00F3w";
                }
                const _HermesInternal12 = HermesInternal;
                let combined3 = "Za du\u017Ca warto\u015B\u0107: oczekiwano, \u017Ce " + str31 + " b\u0119dzie mie\u0107 " + str30 + str + " " + str37;
              } else {
                let str32 = str31;
                if (str31 == null) {
                  str32 = "warto\u015B\u0107";
                ...
                combined3 = "Zbyt du\u017C(y/a/e): oczekiwano, \u017Ce " + str32 + " b\u0119dzie wynosi\u0107 " + str30 + code.maximum.toString();
              }
              return combined3;
            ...
            case "H":
              ...
              let str20 = code.origin;
              if (tmp19) {
                if (str20 == null) {
                  str20 = "warto\u015B\u0107";
                }
                const str1 = code.minimum.toString();
                let str26 = tmp19.unit;
                if (str26 == null) {
                  str26 = "element\u00F3w";
                }
                const _HermesInternal10 = HermesInternal;
                let combined4 = "Za ma\u0142a warto\u015B\u0107: oczekiwano, \u017Ce " + str20 + " b\u0119dzie mie\u0107 " + str19 + str1 + " " + str26;
              } else {
                let str21 = str20;
                if (str20 == null) {
                  str21 = "warto\u015B\u0107";
                ...
                combined4 = "Zbyt ma\u0142(y/a/e): oczekiwano, \u017Ce " + str21 + " b\u0119dzie wynosi\u0107 " + str19 + code.minimum.toString();
              }
              return combined4;
            case "HT":
            break;
            case "TP":
              if ("starts_with" === code.format) {
                ...
                combined = "Nieprawid\u0142owy ci\u0105g znak\u00F3w: musi zaczyna\u0107 si\u0119 od \"" + code.prefix + "\"";
              } else if ("ends_with" === code.format) {
                const _HermesInternal7 = HermesInternal;
                combined = "Nieprawid\u0142owy ci\u0105g znak\u00F3w: musi ko\u0144czy\u0107 si\u0119 na \"" + code.suffix + "\"";
              } else if ("includes" === code.format) {
                const _HermesInternal6 = HermesInternal;
                combined = "Nieprawid\u0142owy ci\u0105g znak\u00F3w: musi zawiera\u0107 \"" + code.includes + "\"";
              }
            break;
            case "P":
            break;
            ...
            case "rm":
              ...
              let combined5 = "Nierozpoznane klucze" + str3 + ": " + joinValuesResult;
              return combined5;
            case "m":
            break;
            case "me":
              code = globalThis;
              let combined6 = "Nieprawid\u0142owy klucz w " + code.origin;
              return combined6;
            case "mes":
            break;
            case "I":
            ...
            case "ter":
              ...
              let combined7 = "Nieprawid\u0142owa warto\u015B\u0107 w " + code.origin;
              return combined7;
            case "na":
            break;
            case "al":
            ...
            case "dd":
              if ("regex" === code.format) {
                ...
                combined = "Nieprawid\u0142owy ci\u0105g znak\u00F3w: musi odpowiada\u0107 wzorcowi " + code.pattern;
              } else {
            ...
            case "ba":
              code = globalThis;
              combined6 = "Nieprawid\u0142owy klucz w " + code.origin;
              return combined6;
            case "back":
            break;
            case "background":
              ...
              str = "Nieprawid\u0142owa warto\u015B\u0107 w ";
              combined7 = "Nieprawid\u0142owa warto\u015B\u0107 w " + code.origin;
              return combined7;
            ...
            case "hashKey":
              ...
              combined5 = "Nierozpoznane klucze" + str3 + ": " + joinValuesResult;
              return combined5;
            case "bhd":
            break;
