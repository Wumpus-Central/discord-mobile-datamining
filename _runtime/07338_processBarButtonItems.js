// _runtime/07338_processBarButtonItems.js
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  const isSearchBarAvailableForCurrentPlatform = colors(5204).isSearchBarAvailableForCurrentPlatform;
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = colors(5204).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  if (null != headerLeftResult) {
    ...
    if ("center" === headerTitleAlign) {
      ...
      let tmp32Result = closure_12(colors(5204).ScreenStackHeaderLeftView, obj11);
    } else {
      if (typeof headerTitle === "function") {
        ...
        obj13.children = closure_10(colors(5938).HeaderTitle, obj14);
      }
  ...
  if ("center" === headerTitleAlign) {
    if (typeof headerTitle !== "function") {
      ...
      headerTitleResult = closure_10(colors(5938).HeaderTitle, obj15);
    }
    const obj16 = { children: headerTitleResult };
    tmp38Result = closure_10(colors(5204).ScreenStackHeaderCenterView, obj16);
  }
  ...
  if (undefined !== headerBackIcon) {
    ...
    const obj17 = { source };
    let tmp40Result = closure_10(colors(5204).ScreenStackHeaderBackButtonImage, obj17);
  } else {
    tmp40Result = null;
  }
  ...
  if (null != headerRightResult) {
    ...
    tmp42 = closure_10(colors(5204).ScreenStackHeaderRightView, obj18);
  }
  items7[2] = tmp42;
  let tmp44 = null;
  if (isSearchBarAvailableForCurrentPlatform2) {
    ...
    obj19.children = closure_10(colors(5204).SearchBar, obj20);
    tmp44 = closure_10(colors(5204).ScreenStackHeaderSearchBarView, obj19);
  }
  items7[3] = tmp44;
  const obj21 = {
    ...
    largeTitleHideShadow: "Reference Number",
    title: true,
    ...
    disableTopInsetApplication: "By-line",
    ...
    headerRightBarButtonItems: "By-line Title",
