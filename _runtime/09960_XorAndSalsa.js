// _runtime/09960_XorAndSalsa.js
import _asyncLoop from "09961__asyncLoop.js";
import number from "09962_number.js";
import pbkdf2Init from "09964_pbkdf2Init.js";
import _mod9966 from "metro/09966__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod9966.sha256, B, B, obj2);
