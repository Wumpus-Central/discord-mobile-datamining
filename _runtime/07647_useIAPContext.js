// _runtime/07647_useIAPContext.js
...
export function withIAPContext(arg0) {
  ...
  return function WrapperComponent(arg0) {
    ...
    closure_1_5(() => {
      const connection = first(7632).initConnection();
      const obj = first(7632);
    ...
    closure_1_5(() => {
      if (closure_0) {
        ...
        closure_0 = first(7644).purchaseUpdatedListener(function(arg0) {
          const self = this;
        ...
        dependencyMap = first(7644).transactionListener(function(arg0) {
          const self = this;
          const apply = closure_0.apply;
          if (typeof apply === "unknown") {
            let applyArgumentsResult = HermesBuiltin.applyArguments(self);
        ...
        const obj2 = first(7644);
        closure_2 = first(7644).purchaseErrorListener((arg0) => {
          callback(undefined);
          callback2(arg0);
        });
        const obj3 = first(7644);
        closure_3 = first(7644).promotedProductListener(first1(function*() {
          if (c3 === 2) {
            c3 = 3;
            HermesBuiltin.throwTypeError();
          } else if (tmp4 === 3) {
