// _runtime/07473_NativeModules.js
...
export const getInstallSourceAndroid = () => {
  const InstallSourceAndroid = callback(7465).InstallSourceAndroid;
