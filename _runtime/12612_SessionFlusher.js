// _runtime/12612_SessionFlusher.js
...
const items = [
  ...
  },
  {
    ...
    value: function getSessionAggregates() {
      ...
      return SessionFlusher(12565).dropUndefinedKeys(obj);
    },
  },
  {
    key: "close",
  ...
  },
  {
    ...
    value: function incrementSessionStatusCount() {
      const self = this;
      if (this._isEnabled) {
        const isolationScope = SessionFlusher(12586).getIsolationScope();
        ...
        const obj = SessionFlusher(12586);
      }
    },
  },
  {
