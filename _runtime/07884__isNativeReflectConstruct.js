// _runtime/07884__isNativeReflectConstruct.js
...
import { extractOpacity } from "07886_extractOpacity.js";
import { keys } from "07887_keys.js";
import { _isNativeReflectConstruct } from "07894__isNativeReflectConstruct.js";
...
let items = [
  {
    ...
    value: function render() {
      ...
      if (transform) {
        ...
        tmp.transform = self(7888).extractTransformSvgView(tmp);
        const obj3 = self(7888);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(7893)({ viewBox, preserveAspectRatio }));
