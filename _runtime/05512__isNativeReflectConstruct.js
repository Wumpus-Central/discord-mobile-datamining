// _runtime/05512__isNativeReflectConstruct.js
...
let obj = { source: "ip", progress: null, speed: true, loop: false, autoPlay: false, enableMergePathsAndroidForKitKatAndAbove: false, enableSafeModeAndroid: true, cacheComposition: false, useNativeLooping: "contain", resizeMode: null, colorFilters: [], textFiltersAndroid: [], textFiltersIOS: true };
obj[12] = [];
class LottieView {
  constructor(arg0) {
    self = this;
...
obj = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5513).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
    ...
    value: function renderLottieView() {
      ...
      if (duration) {
        if (parsePossibleSourcesResult.sourceJson) {
          ...
          return jsx(importDefault(5513), { ref: null });
        }
      }
