// _runtime/07353_CardContainer.js
import Link from "01485_Link.js";
import _mod5934 from "metro/05934__.js";
import ModalPresentationContext from "07343_ModalPresentationContext.js";
import _mod7354 from "metro/07354__.js";
import CardA11yWrapper from "07355_CardA11yWrapper.js";
import _mod7356 from "metro/07356__.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  let num = noop.useContext(_mod5934.HeaderHeightContext);
  let tmp4 = focused;
  if (focused) {
    tmp4 = false !== scene.descriptor.options.keyboardHandlingEnabled;
  }
  let obj2 = Link;
  const keyboardManager = _mod7354.useKeyboardManager({ enabled: tmp4, focused });
  ({ onPageChangeStart: c10, onPageChangeCancel: c11, onPageChangeConfirm: c12 } = keyboardManager);
  const tmp2Result = _mod7354;
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5934.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5934;
  }
  closure_15 = tmp12;
  ...
  obj12.children = React4(_mod5934.HeaderHeightContext.Provider, obj13);
  obj11.children = React4(_mod5934.HeaderShownContext.Provider, obj12);
  obj10.children = React4(_mod5934.HeaderBackContext.Provider, obj11);
  ...
  obj4.children = React4(_mod7356.Card, obj5);
