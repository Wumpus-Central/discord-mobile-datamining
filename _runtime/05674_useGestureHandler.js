...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: _require(5533).State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: _require(5506).GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  ...
  obj1 = { gestureSource, source, state, GESTURE_SOURCE: _require(5506).GESTURE_SOURCE, onFinalize };
  T.__closure = obj1;
