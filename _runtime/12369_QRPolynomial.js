...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = require(12370);
      const glogResult = require(12370).glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - require(12370).glog(getLength.get(0));
