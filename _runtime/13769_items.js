// _runtime/13769_items.js
import SemVer from "13741_SemVer.js";
import Comparator from "13755_Comparator.js";
import Range from "13756_Range.js";
import Range2 from "13758_Range.js";
    ...
    if (1 === arg0.length) {
      ...
      if (arg0[0].semver === Comparator.ANY) {
        if (1 === item10015.length) {
          if (item10015[0].semver === tmp6(13755).ANY) {
            return true;
          }
        }
      }
