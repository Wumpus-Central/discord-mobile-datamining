// _runtime/13698_isStructurallyValidLanguageTag.js
import emitUnicodeLanguageId from "13699_emitUnicodeLanguageId.js";
import compareKV from "13700_compareKV.js";
import __exportStarResult2 from "13703___exportStarResult2.js";
import __exportStarResult1 from "13704___exportStarResult1.js";
import e from "01281_e.js";
import { parseUnicodeLanguageId } from "13702_parseUnicodeLanguageId.js";
  ...
  if (undefined === items) {
    ...
    if (0 < arr3.length) {
      do {
        ...
        let emitUnicodeLocaleIdResult = emitUnicodeLanguageId.emitUnicodeLocaleId(compareKV.CanonicalizeUnicodeLocaleId(parseUnicodeLanguageId /* parseUnicodeLanguageId */.parseUnicodeLocaleId(arr3[num3])));
        let tmp4 = num3;
