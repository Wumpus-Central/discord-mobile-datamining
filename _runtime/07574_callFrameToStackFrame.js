// _runtime/07574_callFrameToStackFrame.js
import { createStackParser } from "07459_createStackParser.js";
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  if (replaced) {
    filenameIsInAppResult = tmp4(7572).filenameIsInApp(replaced);
    const tmp4Result = tmp4(7572);
  }
