      ...
      return {
        localeError: (code) => {
          ...
          switch (code) {
            ...
            case "serializeDate":
              code = globalThis;
              code = "Neveljavno \u0161tevilo: mora biti ve\u010Dkratnik " + code.divisor;
              return code;
            ...
            case "H":
              ...
              let combined5 = "Neveljavna vrednost v " + code.origin;
              return combined5;
            case "HT":
            break;
            case "TP":
            ...
            case "_applyCombination":
              ...
              str = "Neveljavna vrednost v ";
              combined5 = "Neveljavna vrednost v " + code.origin;
              return combined5;
            case "ly":
            break;
            case "grandma_tone3":
