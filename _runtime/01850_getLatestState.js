// _runtime/01850_getLatestState.js
...
export const useKeyboardState = function useKeyboardState(arg0) {
  ...
  const tmp2 = callback(callback3(() => {
    ...
    const obj = {};
    const KeyboardController = tmp(1845).KeyboardController;
    const merged = Object.assign(KeyboardController.state());
    const KeyboardController2 = tmp(1845).KeyboardController;
  ...
  callback2(() => {
    ...
    let obj = {};
    let KeyboardController = tmp(1845).KeyboardController;
    let merged = Object.assign(KeyboardController.state());
    let KeyboardController2 = tmp(1845).KeyboardController;
    obj.isVisible = KeyboardController2.isVisible();
    tmp(tmp(obj));
    return () => {
