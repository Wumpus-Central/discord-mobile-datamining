// _runtime/04728_ScreenStackHeaderSubview.js
import _objectWithoutProperties from "_objectWithoutProperties";
import get_ActivityIndicator from "get ActivityIndicator";
import { jsx } from "jsxProd";
import { context } from "04729_context.js";
...
const forwardRefResult = require("noop").forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4725).isHeaderBarButtonsAvailableForCurrentPlatform) {
      let tmpResult = tmp(4730);
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4725).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4726).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4731), {});
});
...
export const ScreenStackHeaderBackButtonImage = (arg0) => {
  ...
  obj[2] = require("04726_get_controlledBottomTabs.js") /* get controlledBottomTabs */.experiment.synchronousHeaderSubviewUpdatesEnabled;
...
export const ScreenStackHeaderRightView = (style) => {
  ...
  obj.type = "right";
  obj.synchronousShadowStateUpdatesEnabled = require("04726_get_controlledBottomTabs.js") /* get controlledBottomTabs */.experiment.synchronousHeaderSubviewUpdatesEnabled;
