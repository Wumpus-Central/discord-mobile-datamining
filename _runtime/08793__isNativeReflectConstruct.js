// _runtime/08793__isNativeReflectConstruct.js
...
let items1 = [require("module_8796").NONE, require("module_8796").INVERT, require("module_8796").MONOCHROME, require("module_8796").POSTERIZE, require("module_8796").FALSE, require("module_8796").MAXIMUMCOMPONENT, require("module_8796").MINIMUMCOMPONENT, require("module_8796").CHROME, require("module_8796").FADE, require("module_8796").INSTANT, require("module_8796").MONO, require("module_8796").NOIR, require("module_8796").PROCESS, require("module_8796").TONAL, require("module_8796").TRANSFER, require("module_8796").SEPIA];
...
const items4 = [require("module_8797").CLEARKEY, require("module_8797").FAIRPLAY, require("module_8797").WIDEVINE, require("module_8797").PLAYREADY];
...
const items8 = [require("module_8816").SRT, require("module_8816").TTML, require("module_8816").VTT];
...
export const TextTrackType = require("module_8816");
export const FilterType = require("module_8796");
export const DRMType = require("module_8797");