// _runtime/08087__isNativeReflectConstruct.js
...
import _isNativeReflectConstructDefault2 from "08084__isNativeReflectConstruct.js";
import __INTERNAL_VIEW_CONFIGDefault from "metro/08088___INTERNAL_VIEW_CONFIG.js";
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(8001).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
