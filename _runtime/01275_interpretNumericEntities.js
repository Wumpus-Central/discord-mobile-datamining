// _runtime/01275_interpretNumericEntities.js
import arrayToObject from "01276_arrayToObject.js";
        ...
        if (0 < parts.length) {
          while (true) {
            if (num10 !== num4) {
                      ...
                      if (obj.comma) {
                        if (substr.indexOf(",") > -1) {
                          ...
                          maybeMapResult = obj12.maybeMap(parts1, (arg0) =>
                            obj.decoder(arg0, obj.decoder, c1, "value"),
                          );
              ...
              let tmp43 = typeof call === "unknown" ? hasOwnProperty(tmp30) : call(obj5, tmp30);
              if (tmp43) {
