// _runtime/01328_ReflectionBinaryWriter.js
    ...
    value: function message(tag, arg1, internalBinaryWrite) {
      if (undefined !== arg4) {
        internalBinaryWrite.internalBinaryWrite(
          arg4,
          tag.tag(arg3, ReflectionBinaryWriter(1310).WireType.LengthDelimited).fork(),
          arg1,
        );
  ...
  },
  {
    ...
    value: function packed(tag, arg1, no, arg3) {
      ...
      if (arg3.length) {
        ...
        const self = this;
        obj.assert(
          arg1 !== ReflectionBinaryWriter(1319).ScalarType.BYTES &&
            arg1 !== ReflectionBinaryWriter(1319).ScalarType.STRING,
        );
