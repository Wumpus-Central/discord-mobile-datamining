...
function withStyleAnimation(animations) {
  ...
  obj = { ColorProperties: _require(1695).ColorProperties, setPath, processColor: _require(1695).processColor, styleAnimations: animations, resolvePath, __DEV__: false, logger: _require(1656).logger, isValidLayoutAnimationProp: _require(1692).isValidLayoutAnimationProp, withTiming: _require(1703).withTiming };
  fn.__closure = obj;
