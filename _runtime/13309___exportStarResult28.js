// _runtime/13309___exportStarResult28.js
import e from "e";
...
export const ToRawFixed = function ToRawFixed(ZERO, minimumFractionDigits, maximumFractionDigits, roundingIncrement, result) {
  ...
  result = require(13302) /* __exportStarResult11 */.ApplyUnsignedRoundingMode(ZERO, timesResult2, timesResult4, result);
  ...
  if (0 !== maximumFractionDigits) {
    ...
    if (str2.length <= maximumFractionDigits) {
      sum = require(13290) /* getMultiInternalSlots */.repeat("0", maximumFractionDigits - length2 + 1) + str2;
