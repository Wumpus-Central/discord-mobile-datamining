// _runtime/08355_NativeStackViewInner.js
import _slicedToArray from "_slicedToArray";
import noop from "noop";
import get_ActivityIndicator from "get ActivityIndicator";
import jsxProd from "jsxProd";
import { Link } from "01481_Link.js";
import { enableScreens } from "04601_enableScreens.js";
import { Background } from "05659_Background.js";
import { StyleSheet } from "08357_StyleSheet.js";
import { 08356__ } from "metro/08356__.js";
...
function SceneView(arg0) {
  ...
  let obj3 = React;
  const context = React.useContext(tmp(5659).HeaderShownContext);
  let num2 = React.useContext(tmp(5659).HeaderHeightContext);
  let num3 = 0;
  const context1 = React.useContext(tmp(5659).HeaderBackContext);
  if (!context) {
  ...
  if (previousDescriptor) {
    obj = { title: null };
    obj[0] = tmp(5659).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    tmp18 = obj;
    const tmpResult3 = tmp(5659);
  }
