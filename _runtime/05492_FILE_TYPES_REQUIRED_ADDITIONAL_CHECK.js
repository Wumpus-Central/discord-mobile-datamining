// _runtime/05492_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05499_AudioTypes.js";
import ImageTypes from "05500_ImageTypes.js";
import VideoTypes from "05501_VideoTypes.js";
import CompressedTypes from "05502_CompressedTypes.js";
import OtherTypes from "05503_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5493).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5493).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5493).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5493).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
