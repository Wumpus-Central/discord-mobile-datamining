// _runtime/12327__isNativeReflectConstruct.js
import isErrorEvent from "12323_isErrorEvent.js";
...
import __SENTRY_DEBUG__ from "metro/12267___SENTRY_DEBUG__.js";
...
let items = [
  {
    ...
    value: function eventFromException(arg0, arg1) {
      const result = ServerRuntimeClient(12328).eventFromUnknownInput(this, this._options.stackParser, arg0, arg1);
      result.level = "error";
      const obj = ServerRuntimeClient(12328);
      return ServerRuntimeClient(12292).resolvedSyncPromise(result);
    }
  },
  {
    ...
    value: function eventFromMessage(arg0) {
      ...
      const obj = ServerRuntimeClient(12292);
      return obj.resolvedSyncPromise(ServerRuntimeClient(12328).eventFromMessage(this._options.stackParser, arg0, str, arg2, this._options.attachStacktrace));
    }
  },
  {
    ...
    value: function captureException(arg0, arg1, arg2) {
      ...
      if (this._options.autoSessionTracking) {
        if (self._sessionFlusher) {
          const isolationScope = ServerRuntimeClient(12295).getIsolationScope();
          ...
          const obj = ServerRuntimeClient(12295);
        }
      }
  ...
  },
  {
    ...
    value: function initSessionFlusher() {
      ...
      if (release) {
        ...
        obj[0] = release;
        obj[1] = tmp;
        const sessionFlusher = new tmp2(12321).SessionFlusher(self, obj);
        self._sessionFlusher = sessionFlusher;
      } else if (tmp2(12296).DEBUG_BUILD) {
        const logger = tmp2(12268).logger;
    ...
    value: function captureCheckIn(checkInId) {
      if ("checkInId" in checkInId) {
        ...
        if (this._isEnabled()) {
          ...
          const obj5 = ServerRuntimeClient(12329);
          ...
          if (ServerRuntimeClient(12296).DEBUG_BUILD) {
            const logger2 = ServerRuntimeClient(12268).logger;
          ...
          if (ServerRuntimeClient(12296).DEBUG_BUILD) {
            const logger = ServerRuntimeClient(12268).logger;
            logger.warn("SDK not enabled, will not capture checkin.");
          }
          return checkInId;
        }
      }
      obj = ServerRuntimeClient(12279);
      checkInId = obj.uuid4();
    }
  },
  {
  ...
  },
  {
    ...
    value: function _getTraceInfoFromScope(arg0) {
      if (arg0) {
        const _getSpanForScopeResult = ServerRuntimeClient(12290)._getSpanForScope(arg0);
        if (_getSpanForScopeResult) {
          let tmpResult = tmp(12273);
        ...
        const tmpResult1 = ServerRuntimeClient(12304);
        if (_getSpanForScopeResult) {
