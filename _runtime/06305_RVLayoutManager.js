// _runtime/06305_RVLayoutManager.js
...
let items = [
  ...
  },
  {
    ...
    value: function getVisibleLayouts(bound1, arg1) {
      ...
      const findLastVisibleIndexResult = RVLayoutManager(6306).findLastVisibleIndex(
        this.layouts,
        arg1,
        this.horizontal,
      );
      if (-1 !== result) {
        if (-1 !== findLastVisibleIndexResult) {
          let EMPTY = new RVLayoutManager(6293).ConsecutiveNumbers(result, findLastVisibleIndexResult);
        }
        return EMPTY;
      }
      EMPTY = RVLayoutManager(6293).ConsecutiveNumbers.EMPTY;
      const obj2 = RVLayoutManager(6306);
    },
  },
  {
    key: "deleteLayout",
