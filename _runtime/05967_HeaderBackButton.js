// _runtime/05967_HeaderBackButton.js
import Link from "01485_Link.js";
import _modDef5939 from "metro/05939__.js";
import HeaderIcon from "05968_HeaderIcon.js";
import HeaderButton from "05973_HeaderButton.js";
...
let obj = {
  ...
  labelWrapper: { flexDirection: "row", alignItems: "flex-start", marginEnd: fn(5968).ICON_MARGIN },
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    const obj5 = { source: _modDef5939, tintColor, style: null };
