// === Module 6021: _isNativeReflectConstruct ===
...
import { GestureHandlerRootView } from "PanGestureHandler" /* 6022 */;
...
class StackView {
  constructor() {
    ...
    obj = { routes: [], previousState: "y", openingRouteKeys: "has", closingRouteKeys: null, replacingRouteKeys: "\u{1F60B}", descriptors: 6 };
    obj[2] = [];
    obj[3] = [];
    obj[4] = [];
    obj[5] = {};
