// _runtime/04421_processRelativeTime.js
import _mod4418 from "metro/04418__.js";
...
if (typeof exports === "object") {
  if (undefined !== module) {
    if (typeof require === "function") {
      ...
      obj2.months = "Januar_Februar_M\u00E4rz_April_Mai_Juni_Juli_August_September_Oktober_November_Dezember".split(
        "_",
      );
      ...
      const obj3 = {
        ...
        s: "ein paar Sekunden",
        ss: "%d Sekunden",
        m: processRelativeTime2,
        mm: "%d Minuten",
        h: processRelativeTime2,
        hh: "%d Stunden",
        d: processRelativeTime2,
        dd: processRelativeTime2,
        w: processRelativeTime2,
        ww: "%d Wochen",
        M: processRelativeTime2,
        MM: processRelativeTime2,
        y: processRelativeTime2,
        yy: processRelativeTime2,
      };
...
if (typeof globalThis.define === "function") {
  if (globalThis.define.amd) {
    globalThis.define(["../moment"], function t(defineLocale) {
      ...
      return defineLocale.defineLocale("de", {
