// === Module 6020: _isNativeReflectConstruct ===
...
import { GestureHandlerRootView } from "PanGestureHandler" /* 6021 */;
...
class StackView {
  constructor() {
    ...
    obj = { routes: [], previousState: "y", openingRouteKeys: "column", closingRouteKeys: "hidden", replacingRouteKeys: "BULK_ACK", descriptors: null };
    obj[2] = [];
    obj[3] = [];
    obj[4] = [];
    obj[5] = {};
