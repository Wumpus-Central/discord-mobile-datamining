// _runtime/06020__isNativeReflectConstruct.js
...
import { GestureHandlerRootView } from "06021_PanGestureHandler.js";
...
class StackView {
  constructor() {
    ...
    obj = {
      routes: [],
      previousState: "y",
      openingRouteKeys: "column",
      closingRouteKeys: "hidden",
      replacingRouteKeys: "BULK_ACK",
      descriptors: null,
    };
    obj[2] = [];
    obj[3] = [];
