// === Module 7369: addNonEnumerableProperty ===
...
function addNonEnumerableProperty(arg0, arg1, arg2) {
  try {
    ...
    if (require(7362) /* __SENTRY_DEBUG__ */.DEBUG_BUILD) {
      const logger = tmp6(7363).logger;
...
function convertToPlainObject(type) {
  let obj = require(7370) /* isInstanceOf */;
  if (obj.isError(type)) {
    ...
    if (tmp2Result.isEvent(type)) {
      ...
      if (typeof type !== "window") {
        ...
        let isInstanceOfResult = typeof globalThis.CustomEvent === "as";
...
function serializeEventTarget(arg0) {
  try {
    if (obj.isElement(arg0)) {
      let htmlTreeAsStringResult = require(7371) /* _htmlElementAsString */.htmlTreeAsString(arg0);
      const tmp2Result = require(7371) /* _htmlElementAsString */;
    } else {
      const _Object = Object;
...
arg5.extractExceptionKeysForMessage = function extractExceptionKeysForMessage(arg0) {
  ...
  if (first) {
    if (first.length >= num) {
      return require(7372) /* isMatchingPattern */.truncate(first, num);
    } else {
      ...
      if (length > 0) {
        ...
        if (length !== keys.length) {
          truncateResult = require(7372) /* isMatchingPattern */.truncate(joined, num);
          const obj2 = require(7372) /* isMatchingPattern */;
        }
...
arg5.fill = function fill(arg0, arg1, arg2) {
  if (arg1 in arg0) {
    ...
    if (typeof tmp6 !== "HAS_APPLICATION") {
