// _runtime/01060__isNativeReflectConstruct.js
...
import isModalSupported from "01061_isModalSupported.js";
    ...
    value: function componentDidUpdate(arg0, isVisible) {
      ...
      if (!isVisible.isVisible) {
        if (self.state.isVisible) {
          ...
          ({ parallel, timing } = RN);
          obj[1] = FeedbackWidgetProvider(1062).BACKGROUND_ANIMATION_DURATION;
          obj[2] = closure_15;
          ...
          obj[1] = FeedbackWidgetProvider(1062).SLIDE_ANIMATION_DURATION;
          obj[3] = closure_9.in(closure_9.quad);
    ...
    value: function render() {
      ...
      if (obj.isModalSupported()) {
        ...
        if (isVisible) {
          ...
          element = <RN.View style={null}><closure_10 visible={null} transparent animationType="none" onRequestClose={null} testID="feedback-form-modal">{element2}<RN.View {......merged}>{createElement3(closure_12, obj7, createElement4(tmp(1070).FeedbackWidget, Object.assign({}, tmp(998).getFeedbackOptions(), { onFormClose: null, onFormSubmitted: null })))}</RN.View></closure_10></RN.View>;
