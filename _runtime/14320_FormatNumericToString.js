// _runtime/14320_FormatNumericToString.js
import TEN from "14306_TEN.js";

const _mod14304 = tmp5(14304);
const GetUnsignedRoundingMode = tmp5(14321);
const ToRawPrecision = tmp5(14322);
const ToRawFixed = tmp5(14323);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14304.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14304.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
