// _runtime/06711__isNativeReflectConstruct.js
import noopAll from "00019_noop.js";
import _inheritsDefault from "00098__inherits.js";
import _isNativeReflectConstructDefault from "06631__isNativeReflectConstruct.js";
import __INTERNAL_VIEW_CONFIGDefault from "metro/06712___INTERNAL_VIEW_CONFIG.js";
...
const items = [
  {
    ...
    value: function render() {
      ...
      let match = str;
      if (str) {
        match = str.match(self(6623).idPattern);
      }
      let tmp4 = match;
      if (match) {
        tmp4 = match[1];
