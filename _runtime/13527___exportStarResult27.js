// _runtime/13527___exportStarResult27.js
import { getMultiInternalSlots } from "13481_getMultiInternalSlots.js";
import { __exportStarResult4 } from "13486___exportStarResult4.js";
const require = arg1;
...
arg5.SetNumberFormatUnitOptions = function SetNumberFormatUnitOptions(internalSlots, result1) {
  ...
  if (!result) {
    result = tmp4(13491).IsWellFormedCurrencyCode(str);
  }
  ...
  if (!result1) {
    result1 = tmp4(13492).IsWellFormedUnitIdentifier(GetOptionResult3);
  }
