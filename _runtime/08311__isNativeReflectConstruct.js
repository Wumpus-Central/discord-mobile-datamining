// === Module 8311: _isNativeReflectConstruct ===

// Module 8311 (_isNativeReflectConstruct)
import noopAll from "noop" /* 19 */;
import _inheritsDefault from "_inherits" /* 98 */;
import extractFontDefault from "extractFont" /* 8231 */;
import _isNativeReflectConstructDefault from "_isNativeReflectConstruct" /* 8233 */;
import _isNativeReflectConstructDefault2 from "_isNativeReflectConstruct" /* 8308 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 8312 */;
...
let items = [
  {
    ...
    value: function render() {
      ...
      let match = href;
      if (href) {
        match = href.match(TextPath(8225).idPattern);
      }
      let tmp5 = match;
      if (match) {
        tmp5 = match[1];
