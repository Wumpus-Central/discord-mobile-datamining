// _runtime/05457__isNativeReflectConstruct.js
...
const items = [
  {
    ...
    value: function render() {
      try {
        ...
        const _Error = Error;
        const error = new Error(Wrap(5411).tagMessage("GestureDetector got more than one view as a child. If you want the gesture to work on multiple views, wrap them with a common parent and attach the gesture to that view."));
        throw error;
      }
    }
  }
