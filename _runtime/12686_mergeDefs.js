      ...
      return {
        localeError: (code) => {
          ...
          switch (code) {
            ...
            break;
            case "u":
              let parsedTypeResult = obj.parsedType(code.input);
              let tmp46 = code[parsedTypeResult];
              if (tmp46 == null) {
                tmp46 = parsedTypeResult;
              }
              let obj2 = /^[A-Z]/;
              let isMatch = obj2.test(code.expected);
              if (isMatch) {
                let _HermesInternal17 = HermesInternal;
                let combined = "Ugyldig input: forventet instanceof " + code.expected + ", fikk " + tmp46;
              } else {
                let _HermesInternal16 = HermesInternal;
                combined = "Ugyldig input: forventet " + expected + ", fikk " + tmp46;
              }
              return combined;
            case "tt":
              code = closure_2;
            ...
            case "D":
              ...
              if (tmp28) {
                ...
                let str32 = tmp28.unit;
                if (str32 == null) {
                  str32 = "elementer";
                }
                const _HermesInternal13 = HermesInternal;
                let combined1 = "For stor(t): forventet " + str26 + " til \u00E5 ha " + str25 + str + " " + str32;
                ...
                combined1 = "For stor(t): forventet " + str27 + " til \u00E5 ha " + str25 + code.maximum.toString();
            ...
            case "at":
              ...
              if (tmp16) {
                ...
                let combined2 = "For lite(n): forventet " + origin + " til \u00E5 ha " + str19 + str1 + " " + tmp16.unit;
              } else {
            ...
            case "serializeEnd":
              if ("starts_with" === code.format) {
                ...
                combined3 = "Ugyldig streng: m\u00E5 ende med \"" + code.suffix + "\"";
              } else if ("includes" === code.format) {
                const _HermesInternal7 = HermesInternal;
                combined3 = "Ugyldig streng: m\u00E5 inneholde \"" + code.includes + "\"";
              } else if ("regex" === code.format) {
                const _HermesInternal6 = HermesInternal;
                combined3 = "Ugyldig streng: m\u00E5 matche m\u00F8nsteret " + code.pattern;
              } else {
            ...
            case "H":
              ...
              str = "Ugyldig verdi i ";
              let combined4 = "Ugyldig verdi i " + code.origin;
              return combined4;
            case "HT":
            break;
            case "TP":
            ...
            case "alignItemsAtEnd":
              parsedTypeResult = obj.parsedType(code.input);
              tmp46 = code[parsedTypeResult];
              if (tmp46 == null) {
                tmp46 = parsedTypeResult;
              }
              obj2 = /^[A-Z]/;
              ...
              if (isMatch) {
                ...
                combined = "Ugyldig input: forventet instanceof " + code.expected + ", fikk " + tmp46;
              } else {
