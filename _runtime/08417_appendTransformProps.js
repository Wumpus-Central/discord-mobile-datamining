// _runtime/08417_appendTransformProps.js
import { append } from "08418_append.js";
import { peg$SyntaxError } from "08419_peg_SyntaxError.js";
import { peg$SyntaxError } from "08420_peg_SyntaxError.js";
const require = arg1;
...
function transformToMatrix(arg0, arr) {
  ...
  if (arr) {
    ...
    if (Array.isArray(arr)) {
      ...
      try {
        tmp3Result = tmp3(8419);
        const parsed = tmp3Result.parse(arr);
        const tmp3Result1 = tmp3(8418);
