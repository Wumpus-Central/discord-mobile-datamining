// _runtime/05275_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05282_AudioTypes.js";
import ImageTypes from "05283_ImageTypes.js";
import VideoTypes from "05284_VideoTypes.js";
import CompressedTypes from "05285_CompressedTypes.js";
import OtherTypes from "05286_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5276).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5276).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5276).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5276).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
