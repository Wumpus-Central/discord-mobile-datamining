// _runtime/07430_getDynamicSamplingContextFromSpan.js
import { addNonEnumerableProperty } from "07400_addNonEnumerableProperty.js";
import { baggageHeaderToDynamicSamplingContext } from "07407_baggageHeaderToDynamicSamplingContext.js";
import { getClient } from "07421_getClient.js";
import { 07431__ } from "metro/07431__.js";
const require = arg1;
...
arg5.getDynamicSamplingContextFromClient = function getDynamicSamplingContextFromClient(trace_id, getOptions) {
  ...
  let DEFAULT_ENVIRONMENT = options.environment;
  if (!DEFAULT_ENVIRONMENT) {
    DEFAULT_ENVIRONMENT = 07431__.DEFAULT_ENVIRONMENT;
  }
