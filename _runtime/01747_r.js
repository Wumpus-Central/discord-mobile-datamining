...
import JEST_WORKER_ID from "01748_JEST_WORKER_ID.js";
import ValueProcessorTarget from "01749_ValueProcessorTarget.js";
...
processColorNumber.__closure = {
  processColorInitially: fn(1680).processColorInitially,
  IS_ANDROID: fn(1748).IS_ANDROID,
};
        ...
        if (tmp8) {
          ...
          if (isDynamicColorObjectIOS(semantic)) {
            if (JEST_WORKER_ID.IS_IOS) {
              ...
              const reanimatedError = new _mod1648.ReanimatedError(obj2.dynamicNotAvailableOnPlatform());
              throw reanimatedError;
            }
          }
          if (null === tmp13) {
            const reanimatedError1 = new _mod1648.ReanimatedError(obj2.invalidColor(semantic));
...
processColor.__closure = {
  processColorNumber,
  ValueProcessorTarget: fn(1749).ValueProcessorTarget,
  isPlatformColorObject,
  isDynamicColorObjectIOS,
  IS_IOS: fn(1748).IS_IOS,
  ERROR_MESSAGES: obj2,
  ...
  if (typeof arr === "number") {
    ...
    if (typeof fn === "function") {
      ...
      if (tmp2) {
        ...
        const reanimatedError1 = new _mod1648.ReanimatedError(obj2.invalidProcessedColor(arr));
        throw reanimatedError1;
      }
    } else {
      throw new TypeError("Trying to call a non-function");
