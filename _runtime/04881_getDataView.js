...
arg5.default = {
  isWebpFile(dataView) {
    let tmp = dataView;
    if (tmp) {
      tmp = require(4868) /* getDataView */.getStringFromDataView(dataView, 0, 4) === "RIFF";
      const obj = require(4868) /* getDataView */;
    }
    if (tmp) {
      tmp = require(4868) /* getDataView */.getStringFromDataView(dataView, 8, 4) === "WEBP";
      const obj2 = require(4868) /* getDataView */;
    }
    return tmp;
  },
