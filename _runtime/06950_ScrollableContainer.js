// _runtime/06950_ScrollableContainer.js
import BottomSheetDraggableScrollable from "06951_BottomSheetDraggableScrollable.js";
import _modDef6952 from "metro/06952__.js";
import _mod6954 from "metro/06954__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod6954.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef6952, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
