// _runtime/14338_FormatNumericToString.js
import TEN from "14324_TEN.js";

const _mod14322 = tmp5(14322);
const GetUnsignedRoundingMode = tmp5(14339);
const ToRawPrecision = tmp5(14340);
const ToRawFixed = tmp5(14341);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod14322.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod14322.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
