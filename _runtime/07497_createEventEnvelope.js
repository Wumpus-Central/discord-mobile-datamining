// _runtime/07497_createEventEnvelope.js
import __SENTRY_DEBUG__ from "__SENTRY_DEBUG__";
import consoleSandbox from "consoleSandbox";
import { forEachEnvelopeItem } from "07498_forEachEnvelopeItem.js";
...
export const createSpanEnvelope = function createSpanEnvelope(arg0, getDsn) {
  ...
  if (tmp9) {
    const obj1 = { dsn: null };
    obj1[0] = beforeSendSpan(7501).dsnToString(dsn);
    tmp9 = obj1;
    const tmp2Result = beforeSendSpan(7501);
  }
