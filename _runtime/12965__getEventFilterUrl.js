// _runtime/12965__getEventFilterUrl.js
import _mod12890 from "metro/12890__.js";
import _mod12899 from "metro/12899__.js";
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod12918.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + _mod12901.getEventDescription(tmp));
      const tmp6Result = _mod12901;
    }
    return null;
  }
}
        ...
        if (_mod12918.DEBUG_BUILD) {
          ...
          logger5.warn(
            "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " +
              _mod12901.getEventDescription(type),
          );
          flag6 = true;
        }
      } else {
