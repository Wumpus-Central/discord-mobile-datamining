// _runtime/04225_useRiveColor.js
import c from "04207_c.js";
import RiveColor2 from "04215_RiveColor.js";
import useRiveProperty from "04220_useRiveProperty.js";
import closure_2 from "metro/00032__slicedToArray.js";

require = arg1;
require("noop").useCallback;
const f29608 = (colorProperty) => colorProperty.colorProperty(arg1);

export const useRiveColor = function useRiveColor(FillColor, instance) {
  let obj = c;
  const cResult = obj.c(8);
  const tmp4 = callback(useRiveProperty.useRiveProperty(instance, FillColor, f29608), 3);
  [tmp5, tmp6] = tmp4;
  require = tmp6;
  if (cResult[0] !== tmp5) {
    let fromIntResult;
