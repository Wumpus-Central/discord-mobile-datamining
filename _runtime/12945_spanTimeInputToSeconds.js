// _runtime/12945_spanTimeInputToSeconds.js
...
import _mod12956 from "metro/12956__.js";
import _mod12957 from "metro/12957__.js";
import _mod12958 from "metro/12958__.js";
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12957.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod12957.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod12946.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod12946.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
...
export const getActiveSpan = function getActiveSpan() {
  ...
  if (asyncContextStrategy.getActiveSpan) {
    ...
    activeSpan = tmpResult._getSpanForScope(_mod12967.getCurrentScope());
