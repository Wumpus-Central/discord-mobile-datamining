// === Module 13843: parseIPv4Number ===

// Module 13843 (parseIPv4Number)
import Buffer from "Buffer" /* 511 */;
import error from "error" /* 13844 */;
import _mod13845 from "module_13845" /* 13845 */;
import replaceByteInByteSequence from "replaceByteInByteSequence" /* 13846 */;
      ...
      if (47 !== arg0) {
        ...
        if (undefined === closure_3[self.url.scheme]) {
          ...
          if (!tmp) {
            ...
            if (isASCIIHexResult) {
              tmp2Result = require("module_13845");
              num6 = 2;
    ...
    if (63 === arg0) {
      ...
      if (35 === arg0) {
        ...
        if (!tmp2) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmp3Result = require("module_13845");
            num4 = 2;
    ...
    if (!isNaN(arg0)) {
      ...
      if (0 === arg0) {
        ...
        if (!tmp4) {
          ...
          isASCIIHexResult = obj.isASCIIHex(self.input[self.pointer + 1]);
          if (isASCIIHexResult) {
            tmpResult = require("module_13845");
            num3 = 2;
