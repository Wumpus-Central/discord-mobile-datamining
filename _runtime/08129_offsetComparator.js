// _runtime/08129_offsetComparator.js
import extractOpacityDefault from "08058_extractOpacity.js";
import appendTransformPropsDefault from "08060_appendTransformProps.js";
...
export default function extractGradient(arg0, arg1) {
  ...
  if (id) {
    ...
    if (gradientUnits) {
      num12 = _modDef8130[gradientUnits];
    }
    if (!num12) {
      num12 = 0;
    }
