...
function defaultOnError(message) {
  return console.error("[" + require(4005).RiveErrorType[message.type] + "] " + message.message);
}

export const RiveView = function RiveView(arg0) {
  let hybridRef;
  let onError;
  let obj = _require(4006);
  ...
  const tmp18 = jsx(_require(3986).NitroRiveView, {});
  cResult[12] = tmp5;
  cResult[13] = tmp14;
  cResult[14] = tmp15;
  cResult[15] = tmp18;
