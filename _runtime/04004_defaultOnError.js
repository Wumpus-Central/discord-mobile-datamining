// _runtime/04004_defaultOnError.js
import _objectWithoutProperties from "_objectWithoutProperties";
import noop from "noop";
import { jsx } from "jsxProd";
import { NitroRiveView } from "03986_NitroRiveView.js";
...
function defaultOnError(message) {
  return console.error("[" + 04005__.RiveErrorType[message.type] + "] " + message.message);
}
