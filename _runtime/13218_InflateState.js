              ...
              if (3 !== mode) {
                      ...
                      if (!(1024 & state.flags)) {
                        ...
                        if (length4) {
                          ...
                          if (512 & state.flags) {
                            ...
                            state.check = _mod13215(check7, tmp16, length4, tmp592);
                          }
                          diff3 = tmp12 - length4;
                          sum7 = tmp14 + length4;
                          ...
                          if (4096 & state.flags) {
                            ...
                            if (0 !== tmp12) {
                              ...
                              if (512 & state.flags) {
                                ...
                                state.check = _mod13215(check9, tmp16, sum8, tmp596);
                              }
                              ...
                              if (state.last) {
                                ...
                                if (tmp605 >= 3) {
                                  ...
                                  if (0 === tmp390) {
                                    ...
                                    if (c7) {
                                      let buf32 = new assign.Buf32(512);
                                      let buf321 = new assign.Buf32(32);
                                      let num79 = 0;
                                      do {
                                        sum66 = num79 + 1;
                                        state.lens[num79] = 8;
                    ...
                    if (2048 & state.flags) {
                      ...
                      if (0 !== tmp515) {
                        ...
                        if (512 & state.flags) {
                          ...
                          state.check = _mod13215(check8, tmp16, sum74, tmp516);
                        }
                ...
                if (1024 & state.flags) {
                  ...
                  if (512 & state.flags) {
                    ...
                    num100 = _mod13215(check6, tmp2, 2, 0);
                    state.check = num100;
                  }
                } else if (state.head) {
