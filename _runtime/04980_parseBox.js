// _runtime/04980_parseBox.js
import { getDataView } from "04971_getDataView.js";
import { parseItemLocationBox } from "04981_parseItemLocationBox.js";
const require = arg1;
const module = arg2;
...
function parseBox(getUint32, sum) {
  ...
  if (length >= 8) {
    ...
    if (1718909296 === uint321) {
      ...
      const stringFromDataView = getDataView.getStringFromDataView(getUint32, contentOffset, 4);
      ...
      if (1835365473 === uint321) {
        ...
        const obj13 = parseItemLocationBox;
        ...
        if (uint8 >= 2) {
          ...
          if (obj10.itemType === c4) {
            ...
            if (obj10.itemType === c5) {
              obj10.itemUri = tmp13(4971).getNullTerminatedStringFromDataView(getUint32, sum13);
              const sum16 = obj10.itemUri.length + 1;
              parseItemLocationBoxResult = obj10;
              const tmp13Result1 = tmp13(4971);
            }
          }
        }
      } else {
