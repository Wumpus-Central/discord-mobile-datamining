// _runtime/03642_dayPeriodEnumToHours.js
import { keys } from "03513_keys.js";
import { 03643__ } from "metro/03643__.js";
const require = arg1;
...
arg5.parseAnyDigitsSigned = function parseAnyDigitsSigned(str) {
  const match = str.match(03643__.numericPatterns.anyDigitsSigned);
  let tmp2 = null;
  if (match) {
    const obj = { value: null, rest: null };
...
arg5.parseNDigits = function parseNDigits(length, str) {
  if (1 === length) {
    const match = str.match(03643__.numericPatterns.singleDigit);
    let tmp20 = null;
    if (match) {
    ...
    const match1 = str.match(03643__.numericPatterns.twoDigits);
    let tmp15 = null;
    if (match1) {
    ...
    const match2 = str.match(03643__.numericPatterns.threeDigits);
    let tmp10 = null;
    if (match2) {
    ...
    const match3 = str.match(03643__.numericPatterns.fourDigits);
    let tmp5 = null;
    if (match3) {
...
arg5.parseNDigitsSigned = function parseNDigitsSigned(length, str) {
  if (1 === length) {
    const match = str.match(03643__.numericPatterns.singleDigitSigned);
    let tmp20 = null;
    if (match) {
      let obj = { value: null, rest: null };
      const _parseInt5 = parseInt;
    ...
    const match1 = str.match(03643__.numericPatterns.twoDigitsSigned);
    let tmp15 = null;
    if (match1) {
      obj = { value: null, rest: null };
      const _parseInt4 = parseInt;
    ...
    const match2 = str.match(03643__.numericPatterns.threeDigitsSigned);
    let tmp10 = null;
    if (match2) {
      const obj1 = { value: null, rest: null };
      const _parseInt3 = parseInt;
    ...
    const match3 = str.match(03643__.numericPatterns.fourDigitsSigned);
    let tmp5 = null;
    if (match3) {
      const obj2 = { value: null, rest: null };
      const _parseInt2 = parseInt;
