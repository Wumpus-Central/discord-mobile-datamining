// === Module 5954: _isNativeReflectConstruct ===

// Module 5954 (_isNativeReflectConstruct)
import noopDefault from "noop" /* 19 */;
import __INTERNAL_VIEW_CONFIGDefault from "__INTERNAL_VIEW_CONFIG" /* 5955 */;
...
let obj = { source: "disabled", progress: null, speed: true, loop: false, autoPlay: false, enableMergePathsAndroidForKitKatAndAbove: false, enableSafeModeAndroid: true, cacheComposition: false, useNativeLooping: "contain", resizeMode: null, colorFilters: [], textFiltersAndroid: [], textFiltersIOS: true };
obj[12] = [];
class LottieView {
  constructor(arg0) {
    self = this;
...
obj = {
  ...
  value: function play(arg0, arg1) {
    let num = arg0;
    const Commands = LottieView(5955).Commands;
    if (arg0 == null) {
      num = -1;
    }
    let num2 = arg1;
