// _runtime/01703_runOnRuntime.js
...
export const createWorkletRuntime = function createWorkletRuntime(arg0, initializer) {
  ...
  obj = {
    registerReanimatedError: __reanimatedLoggerConfig(1664).registerReanimatedError,
    registerLoggerConfig: __reanimatedLoggerConfig(1657).registerLoggerConfig,
    config: globalThis.__reanimatedLoggerConfig,
    setupCallGuard: __reanimatedLoggerConfig(1655).setupCallGuard,
    setupConsole: __reanimatedLoggerConfig(1655).setupConsole,
    initializer,
  };
  fn.__closure = obj;
