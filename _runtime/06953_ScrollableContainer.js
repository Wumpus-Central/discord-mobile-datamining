// _runtime/06953_ScrollableContainer.js
import BottomSheetDraggableScrollable from "06954_BottomSheetDraggableScrollable.js";
import _modDef6955 from "metro/06955__.js";
import _mod6957 from "metro/06957__.js";
...
export const ScrollableContainer = fn(19).forwardRef(function ScrollableContainer(arg0, ref) {
  ...
  if (onRefresh) {
    const obj3 = {
      ...
      progressViewOffset,
      onRefresh,
      style: _mod6957.styles.container,
      children: tmp6,
    };
    tmp2Result = jsx(_modDef6955, {
      scrollableGesture: nativeGesture,
      refreshing,
      progressViewOffset,
      onRefresh,
