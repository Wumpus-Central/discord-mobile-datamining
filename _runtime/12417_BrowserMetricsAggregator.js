// _runtime/12417_BrowserMetricsAggregator.js
...
const entry = {
  ...
  value: function add(metricType, arg1, diff) {
    ...
    const bucketKey = BrowserMetricsAggregator(12414).getBucketKey(
      metricType,
    ...
    if (value) {
      num = 0;
      if (metricType === BrowserMetricsAggregator(12410).SET_METRIC_TYPE) {
    ...
    if (value) {
      ...
      const tmp16 = new BrowserMetricsAggregator(12415).METRIC_MAP[metricType](diff);
      obj7.metric = tmp16;
    ...
    const result1 = BrowserMetricsAggregator(12318).updateMetricSummaryOnActiveSpan(
      metricType,
      sanitizeMetricKeyResult,
      diff,
      sanitizeUnitResult,
    ...
    const tmp5Result = BrowserMetricsAggregator(12318);
  },
};
const items = [
  entry,
