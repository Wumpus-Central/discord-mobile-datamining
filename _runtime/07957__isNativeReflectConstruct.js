// _runtime/07957__isNativeReflectConstruct.js
...
import { __INTERNAL_VIEW_CONFIG } from "metro/07959___INTERNAL_VIEW_CONFIG.js";
...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = 07954__[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = 07954__[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
