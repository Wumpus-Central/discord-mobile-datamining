        ...
        localeError: (code) => {
          ...
          switch (code) {
            ...
            case "SEMANTIC_ATTRIBUTE_SENTRY_SOURCE":
              ...
              let tmp22 = dependencyMap[code.origin];
              if (tmp22 == null) {
                tmp22 = null;
              }
              ({ origin, minimum } = code);
              ...
              if (tmp22) {
                ...
                let combined3 = "Tro malgranda: atendi\u011Dis ke " + origin + " havu " + str20 + str1 + " " + tmp22.unit;
              } else {
            ...
            case "INTERACTIONS":
              ...
              let combined5 = "Nekonata" + str4 + " \u015Dlosilo" + str3 + ": " + joinValuesResult;
              return combined5;
            case "NSFW_SPACE_WARNING_MODAL_CLICKED":
            break;
            case "woman_genie":
              let _HermesInternal2 = HermesInternal;
              let combined6 = "Nevalida \u015Dlosilo en " + code.origin;
              return combined6;
            case "man_genie":
            break;
            case "genie":
            ...
            case "GIFT_CODE_RESOLVED":
              ...
              let combined7 = "Nevalida valoro en " + code.origin;
              return combined7;
            case "RESOLVED":
            break;
