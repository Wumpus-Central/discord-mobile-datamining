// _runtime/06741_handleStateChangeEvent.js
import _mod6661 from "metro/06661__.js";
import _mod6663 from "metro/06663__.js";
import _isNativeReflectConstruct from "06676__isNativeReflectConstruct.js";
...
let obj = {
  ...
  State: require("metro/06661__.js").State,
...
function handleTouchEvent(eventType) {
  if (eventType.eventType !== _mod6663.TouchEventType.UNDETERMINED) {
    let tmpResult = tmp(6723);
    tmpResult = tmp(6723);
...
obj = {
  TouchEventType: require("metro/06663__.js").TouchEventType,
  runCallback: require("isGestureEnabled").runCallback,
