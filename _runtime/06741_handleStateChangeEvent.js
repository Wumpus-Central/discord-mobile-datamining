// === Module 6741: handleStateChangeEvent ===

// Module 6741 (handleStateChangeEvent)
import _mod6661 from "module_6661" /* 6661 */;
import _mod6663 from "module_6663" /* 6663 */;
...
let obj = { flattenAndFilterEvent: require("isGestureEnabled").flattenAndFilterEvent, State: require("module_6661").State, runCallback: require("isGestureEnabled").runCallback, CALLBACK_TYPE: require("_isNativeReflectConstruct").CALLBACK_TYPE };
...
obj = { TouchEventType: require("module_6663").TouchEventType, runCallback: require("isGestureEnabled").runCallback, touchEventTypeToCallbackType: require("isGestureEnabled").touchEventTypeToCallbackType };
