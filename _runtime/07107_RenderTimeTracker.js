// _runtime/07107_RenderTimeTracker.js
import _modDef7109 from "metro/07109__.js";
import _classCallCheck from "metro/07108__.js";
...
const entry = {
  ...
  value: function startTracking() {
    ...
    let trackAverageRenderTimeForOffsetProjection =
      RenderTimeTracker(7114).PlatformConfig.trackAverageRenderTimeForOffsetProjection;
...
const items = [
  ...
  },
  {
    ...
    value: function getAverageRenderTime() {
      const self = this;
      if (RenderTimeTracker(7114).PlatformConfig.trackAverageRenderTimeForOffsetProjection) {
        const _Math = Math;
        const _Math2 = Math;
        const _Math3 = Math;
...
export const RenderTimeTracker = _modDef7109(RenderTimeTracker, items);
