      ...
      return {
        localeError: (arg0) => {
          switch ("\u041D\u044F\u043F\u0440\u0430\u0432\u0456\u043B\u044C\u043D\u0430\u0435 \u0437\u043D\u0430\u0447\u044D\u043D\u043D\u0435 \u045E ") {
            ...
            case "append":
            break;
            case "appendAndIncrementStats":
            break;
            case "VOICE_CARD":
            break;
            case "UNAUTHORIZED":
            break;
            case "UNAUTHORIZED_FOR_APPLICATION":
            break;
            case "APPLICATION_COMMAND_OPTIONAL_OPTION_ADDED":
            break;
            case "COMMAND_OPTION":
            break;
            case "OPTIONAL_OPTION_ADDED":
            break;
            case "ADDED":
            break;
            case "FAVORITES_GUILD_DISMISSIBLE_CONTENT":
            break;
            case "DISMISSIBLE_CONTENT_SHOWN":
            break;
            case "DISMISSIBLE_CONTENT_SHOWN_BEFORE_CONNECTION_OPEN":
            break;
            ...
            break;
            case "SEARCH_QUERY_BY_SEARCH_FILTER":
            break;
            case "SEARCH_FILTERS_BY_TAB":
            break;
            case "TAB_LABEL_TEXT_FOCUSED":
            break;
            case "_$esjava$s":
            break;
