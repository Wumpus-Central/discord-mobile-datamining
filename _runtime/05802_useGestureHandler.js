// _runtime/05802_useGestureHandler.js
...
arg5.useGestureHandler = (source, state, gestureSource, onStart, onChange, onEnd, onFinalize) => {
  ...
  obj = { state, State: require("05661_LegacyBaseButton.js").State, gestureSource, source, onStart };
  R.__closure = obj;
  ...
  obj = { gestureSource, source, state, GESTURE_SOURCE: require("05634_GESTURE_SOURCE.js").GESTURE_SOURCE, onEnd };
  C.__closure = obj;
  ...
  obj1 = {
    ...
    source,
    state,
    GESTURE_SOURCE: require("05634_GESTURE_SOURCE.js").GESTURE_SOURCE,
    onFinalize,
  };
  T.__closure = obj1;
