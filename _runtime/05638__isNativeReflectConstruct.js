// _runtime/05638__isNativeReflectConstruct.js
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5622).isRemoteDebuggingEnabled();
        obj = ContinousBaseGesture(5622);
      }
      return tmp;
    }
  }
