  ...
  obj = {
    send(arg0) {
      ...
      bufferSize(table[1]).forEachEnvelopeItem(arg0, (arg0, arg1) => {
        const result = items(7419).envelopeItemTypeToDataCategory(arg1);
        const obj = items(7419);
      ...
      if (0 === items.length) {
        ...
        return recordEnvelopeLoss.add(() => {
          const obj = { body: null };
          obj[0] = items(7419).serializeEnvelope(dependencyMap);
          const obj2 = items(7419);
          ...
          if (arg0 instanceof items(7432).SentryError) {
