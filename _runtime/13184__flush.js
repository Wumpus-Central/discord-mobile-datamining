...
import _mod13185 from "metro/13185__.js";
  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/13163__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/13164__.js").DEBUG_BUILD) {
            const logger = require("metro/13136__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/13163__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const captureException = function captureException(arg0, captureContext) {
  const currentScope = _mod13163.getCurrentScope();
  return currentScope.captureException(arg0, _mod13185.parseEventHintOrCaptureContext(captureContext));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = _mod13173.DEFAULT_ENVIRONMENT;
  }
  ...
  if (tmp10) {
    _mod13159.updateSession(session1, { status: "exited" });
    const tmpResult2 = _mod13159;
  }
  endSession();
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod13150.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod13163.getCurrentScope();
    const client = _mod13163.getClient();
    if (client) {
    ...
    _mod13147.uuid4();
    const tmpResult = _mod13147;
  }
  let currentScope = require("metro/13163__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/13163__.js");
  let client = require("metro/13163__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/13163__.js");
  captureCheckInResult = require("metro/13147__.js").uuid4();
};
