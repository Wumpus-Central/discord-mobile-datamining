// _runtime/04917_OrdinaryDefineOwnProperty.js
...
import _mod4919 from "metro/04919__.js";
import ValidateAndApplyPropertyDescriptor from "04920_ValidateAndApplyPropertyDescriptor.js";

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4854(arg0)) {
    if (_mod4901(arg1)) {
      if (_mod4905(__Writable__)) {
        if (_mod1284) {
          ...
          return ValidateAndApplyPropertyDescriptor(arg0, arg1, _mod4919(arg0), __Writable__, tmp31);
