// _runtime/01596_createStandardNavigationFactories.js
import closure_3 from "metro/00109__objectWithoutProperties.js";
import closure_4 from "00019_noop.js";
import { jsx } from "react/00021_jsxProd.js";
import { BaseNavigationContainer } from "01501_BaseNavigationContainer.js";
...
export const createStandardNavigationFactories = function createStandardNavigationFactories(arg0, arg1, arg2) {
  ...
  if ("standard" !== type) {
    ...
    obj[0] = require("01501_BaseNavigationContainer.js").createNavigatorFactory(
      function StandardNavigationNavigator(UNSTABLE_routeNamesChangeBehavior) {
        ...
        if (!("preloadedRoutes" in navigationBuilder.state)) {
          ...
          obj = {};
          const routes2 = closure_1_4.useMemo(
            () => ({ index: navigationBuilder.state.index, routes: closure_2 }),
            items,
          ).routes;
    ...
    obj[1] = require("01501_BaseNavigationContainer.js").createScreenFactory();
    return obj;
  }
};
