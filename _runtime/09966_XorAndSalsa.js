// _runtime/09966_XorAndSalsa.js
import _asyncLoop from "09967__asyncLoop.js";
import number from "09968_number.js";
import pbkdf2Init from "09970_pbkdf2Init.js";
import _mod9972 from "metro/09972__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod9972.sha256, B, B, obj2);
