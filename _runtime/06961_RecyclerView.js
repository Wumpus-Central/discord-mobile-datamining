// _runtime/06961_RecyclerView.js
import ErrorMessages from "06959_ErrorMessages.js";
import areDimensionsNotEqual from "06999_areDimensionsNotEqual.js";
import WarningMessages from "07002_WarningMessages.js";
import CompatView from "07012_CompatView.js";
import StickyHeaders from "07015_StickyHeaders.js";
import ScrollAnchor from "07017_ScrollAnchor.js";
import _slicedToArray from "metro/06962__.js";
import _objectWithoutProperties from "metro/06968__.js";
...
class RecyclerViewComponent {
  constructor(arg0, arg1) {
    ...
    tmp27 = onCommitLayoutEffect(() => {
      if (ref.current) {
        if (ref2.current) {
          const size = areDimensionsNotEqual.measureParentSize(ref.current);
          ...
          const size1 = {
            width: horizontal ? size.width : size2.width,
            height: horizontal ? size2.height : size.height,
          };
          let diff = tmp7;
          if (closure_35) {
            diff = tmp7;
