// _runtime/14367__isNativeReflectConstruct.js
  ...
  },
  {
    ...
    value: function render() {
      ...
      if (backgroundColor) {
        ...
        obj3[3] = lineCap;
        obj3[4] = mapped1;
        tmp23Result = tmp23(tmp24(7876).Path, obj3);
      }
      ...
      if (tmp23Result) {
        ...
        obj4[3] = fillLineCap;
        obj4[4] = mapped;
        tmp23Result = tmp23(tmp24(7876).Path, obj4);
      }
      items[1] = tmp23Result;
      items[2] = renderCapResult;
      obj2[3] = items;
      obj1[2] = closure_7(CircularProgress(7876).G, obj2);
      const items1 = [closure_6(CircularProgress(7876).Svg, obj1), ];
