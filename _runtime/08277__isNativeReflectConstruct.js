...
const items = [
  {
    ...
    value: function render() {
      ...
      if (undefined !== maskUnits) {
        num = importDefault(8274)[maskUnits];
      }
      obj[4] = num;
      let num2 = 1;
      if (undefined !== maskContentUnits) {
        num2 = importDefault(8274)[maskContentUnits];
      }
      obj[5] = num2;
      let str;
      if (props != null) {
      ...
      const tmp5 = self;
      const tmp8 = importDefault(8279);
      const merged = Object.assign(self(8211).withoutXY(this, props));
