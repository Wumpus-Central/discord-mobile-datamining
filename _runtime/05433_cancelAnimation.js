// _runtime/05433_cancelAnimation.js
...
try {
  ...
  if (!setGestureState) {
    const fn = function t() {
      console.warn(toArray.tagMessage("Please use newer version of react-native-reanimated in order to control state of the gestures."));
    };
