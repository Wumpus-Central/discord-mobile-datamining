// _runtime/05201_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05208_AudioTypes.js";
import ImageTypes from "05209_ImageTypes.js";
import VideoTypes from "05210_VideoTypes.js";
import CompressedTypes from "05211_CompressedTypes.js";
import OtherTypes from "05212_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5202).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5202).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5202).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5202).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
