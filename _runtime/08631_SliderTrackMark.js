// _runtime/08631_SliderTrackMark.js
import _mod19 from "metro/00019__.js";
import _mod8629 from "metro/08629__.js";
...
export const SliderTrackMark = function SliderTrackMark(arg0) {
  ...
  if (thumbImage) {
    jsxResult1 = null;
    if (isTrue) {
      const obj3 = { style: _mod8629.styles.thumbImageContainer, testID: "sliderTrackMark-thumbImage", children: null };
      const obj4 = { source: thumbImage, style: _mod8629.styles.thumbImage };
      obj3.children = <get ActivityIndicator.Image source={thumbImage} style={_mod8629.styles.thumbImage} />;
      jsxResult1 = <get ActivityIndicator.View style={_mod8629.styles.thumbImageContainer} testID="sliderTrackMark-thumbImage">{null}</get ActivityIndicator.View>;
    }
  }
  items[1] = jsxResult1;
  obj2.children = items;
