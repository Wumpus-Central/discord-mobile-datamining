// _runtime/00983__isFetchSupported.js
import _mod818 from "metro/00818__.js";

require = arg1;
const dependencyMap = arg6;
function _isFetchSupported() {
  if ("fetch" in _mod818.GLOBAL_OBJ) {
    try {
...
arg5.supportsHistory = function supportsHistory() {
  return "history" in _mod818.GLOBAL_OBJ && _mod818.GLOBAL_OBJ.history;
};
arg5.supportsNativeFetch = function supportsNativeFetch() {
  if (typeof globalThis.EdgeRuntime === "string") {
    return true;
  } else if (_isFetchSupported()) {
    if (isNativeFunction(_mod818.GLOBAL_OBJ.fetch)) {
      return true;
    } else {
      let flag2 = false;
      const _document = tmp5(818).GLOBAL_OBJ.document;
      if (_document) {
...
arg5.supportsReportingObserver = function supportsReportingObserver() {
  return "ReportingObserver" in _mod818.GLOBAL_OBJ;
};
