// _runtime/05535_map.js
import _slicedToArray from "_slicedToArray";
import { useMemo } from "noop";
import { hash } from "05523_hash.js";
import { items2 } from "05524_items2.js";
import { isNativeEvent } from "05536_isNativeEvent.js";
import { 05509__ } from "metro/05509__.js";
...
export const resolveInternalConfigProps = function resolveInternalConfigProps(useAnimated) {
  ...
  if (!disableReanimated) {
    result = undefined !== 05509__.Reanimated;
  }
  if (result) {
  ...
  while (tmp12 !== undefined) {
    ...
    if (!allowedNativeProps.has(first)) {
      ...
      if (!EMPTY_WHITE_LIST.has(tmp17)) {
        let tmp23 = tmp18;
        let tmp24 = tmp20;
        let PropsToFilter = tmp19(5524).PropsToFilter;
        let tmp25 = first;
    ...
    let tmp32 = tmp18;
    let tmp33 = tmp20;
    let Reanimated = tmp19(5509).Reanimated;
