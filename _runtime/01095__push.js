...
export const makeBrowserOfflineTransport = function makeBrowserOfflineTransport() {
  ...
  if (arg0 === undefined) {
    makeFetchTransport = require("01029_makeFetchTransport.js").makeFetchTransport;
  }
  _require = require("00814_registerSpanErrorInstrumentation.js").makeOfflineTransport(makeFetchTransport);
  return (arg0) => {
    let obj = {};
