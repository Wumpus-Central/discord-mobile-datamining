// _runtime/05304__isNativeReflectConstruct.js
...
let obj = {
  ...
  value: function componentDidMount() {
    console.warn(ForceTouchFallback(5281).tagMessage("ForceTouchGestureHandler is not available on this platform. Please use ForceTouchGestureHandler.forceTouchAvailable to conditionally render other components that would provide a fallback behavior specific to your usecase"));
  }
};
const items = [
  obj,
