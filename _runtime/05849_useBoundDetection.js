// _runtime/05849_useBoundDetection.js
...
export const useBoundDetection = function useBoundDetection(recyclerViewManager, arg1) {
  ...
  const _requestAnimationFrame = require("05846_useUnmountAwareTimeout.js").useUnmountAwareAnimationFrame().requestAnimationFrame;
  let num = 0;
