// _runtime/05532_useScrollEventsHandlersDefault.js
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: require("05506_GESTURE_SOURCE.js").SHEET_STATE, animatedHandleGestureState, State: require("05533_LegacyBaseButton.js").State, animatedScrollableState, SCROLLABLE_STATE: require("05506_GESTURE_SOURCE.js").SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: require("01654_cancelAnimation.js").scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
  ...
  obj1 = { scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, rootScrollableContentOffsetY: animatedScrollableContentOffsetY, animatedSheetState, SHEET_STATE: require("05506_GESTURE_SOURCE.js").SHEET_STATE };
  O.__closure = obj1;
  ...
  obj2 = { animatedScrollableState, SCROLLABLE_STATE: require("05506_GESTURE_SOURCE.js").SCROLLABLE_STATE, isLockingScroll: sharedValue1, scrollTo: require("01654_cancelAnimation.js").scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue, animatedAnimationState, ANIMATION_STATE: require("05506_GESTURE_SOURCE.js").ANIMATION_STATE, rootScrollableContentOffsetY: animatedScrollableContentOffsetY };
  fn2.__closure = obj2;
