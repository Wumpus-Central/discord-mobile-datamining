// _runtime/00827_addContextToFrame.js
import addNonEnumerableProperty from "00819_addNonEnumerableProperty.js";
import isMatchingPattern from "00829_isMatchingPattern.js";
import { safeDateNow } from "00828_safeDateNow.js";
...
arg5.addContextToFrame = function addContextToFrame(arr, lineno) {
  ...
  if (undefined !== lineno.lineno) {
    ...
    lineno.pre_context = substr.map((arg0) => callback(829).snipLine(arg0, 0));
    const _Math5 = Math;
    ...
    lineno.post_context = substr1.map((arg0) => callback(829).snipLine(arg0, 0));
...
arg5.uuid4 = function uuid4() {
  ...
  if (arg0 === undefined) {
    tmp = (function getCrypto() {
      const GLOBAL_OBJ = lib(818).GLOBAL_OBJ;
  ...
  try {
    ...
    if (randomUUID) {
      let obj = safeDateNow;
      return require("00828_safeDateNow.js").withRandomSafeContext(() => lib.randomUUID()).replace(/-/g, "");
    } else {
      let str3 = c2;
      if (!c2) {
      ...
      return str3.replace(/[018]/g, (arg0) => {
        const obj = lib(828);
        return arg0 ^ (15 & 16 * lib(828).safeMathRandom()) >> arg0 / 4.toString(16);
      });
    }
  } catch (err) {
  }
