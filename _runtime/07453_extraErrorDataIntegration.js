// === Module 7453: extraErrorDataIntegration ===
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, arg1, arg2) {
            try {
              ...
              if (!tmp24) {
                if (typeof originalException.toJSON !== "HAS_APPLICATION") {
              ...
              if (callback(7391).DEBUG_BUILD) {
                const logger = callback(7363).logger;
