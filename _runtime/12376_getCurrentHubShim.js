// _runtime/12376_getCurrentHubShim.js
import getClient from "12295_getClient.js";
import _flush from "12316__flush.js";
import addBreadcrumb from "12341_addBreadcrumb.js";
...
function getCurrentHubShim() {
  return {
    bindClient(arg0) {
      const currentScope = callback(12295).getCurrentScope();
      currentScope.setClient(arg0);
    },
    withScope: getClient.withScope,
    getClient() {
      return callback(12295).getClient();
    },
    ...
    getIntegration(id) {
      const client = callback(12295).getClient();
