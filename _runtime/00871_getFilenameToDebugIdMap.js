// _runtime/00871_getFilenameToDebugIdMap.js
...
function getFilenameToDebugIdMap(arg0) {
  const _require = arg0;
  const _sentryDebugIds = require("metro/00818__.js").GLOBAL_OBJ._sentryDebugIds;
  const _debugIds = require("metro/00818__.js").GLOBAL_OBJ._debugIds;
  if (!_sentryDebugIds) {
    if (!_debugIds) {
      return {};
    }
