// _runtime/07444_applyScopeDataToEvent.js
import { addNonEnumerableProperty } from "07400_addNonEnumerableProperty.js";
import { merge } from "07419_merge.js";
const require = arg1;
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(7399).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(7399);
    obj4[0] = tmp3(7430).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(7430);
    const rootSpan = tmp3(7399).getRootSpan(span);
    const tmp3Result4 = tmp3(7399);
    const description = tmp3(7399).spanToJSON(rootSpan).description;
