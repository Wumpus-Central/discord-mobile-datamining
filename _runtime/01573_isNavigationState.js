...
import { useLazyValue } from "01522_useLazyValue.js";
import { NavigationBuilderContext } from "01529_NavigationBuilderContext.js";
import { ConsumedParamsContext } from "01531_ConsumedParamsContext.js";
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  if (mapped.length) {
    ...
    const context2 = React.useContext(_require("01516_get_getKey.js") /* get getKey */.NavigationStateContext);
