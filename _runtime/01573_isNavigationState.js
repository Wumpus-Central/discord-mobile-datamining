// _runtime/01573_isNavigationState.js
import useEffectDefault from "01521_useEffect.js";
...
import { PrivateValueStore } from "01503_PrivateValueStore.js";
import { isArrayEqual } from "01563_isArrayEqual.js";
import { useRegisterNavigator } from "01574_useRegisterNavigator.js";
...
export const useNavigationBuilder = function useNavigationBuilder(StackRouter, UNSTABLE_routeNamesChangeBehavior) {
  ...
  const context = React.useContext(require("01540_context.js").NavigationRouteContext);
  const context1 = React.useContext(require("01531_ConsumedParamsContext.js").ConsumedParamsContext);
  let params;
  if (context != null) {
  ...
  const lazyValue = require("01522_useLazyValue.js").useLazyValue(() => {
  ...
  if (mapped.length) {
    ...
    const context2 = React.useContext(require("01516_get_getKey.js").NavigationStateContext);
    ...
    const context3 = React.useContext(require("01529_NavigationBuilderContext.js").NavigationBuilderContext);
    ...
    if (null != tmp43) {
      ...
      closure_41 = obj9.useContext(tmp30(1532).UnhandledActionContext);
      ...
      obj17[4] = tmp30(1590).useComponent((arg0) => {
        ...
        obj1 = { state: rehydratedState, getState: navigationHelpers.getState, children: closure_1_7(StackRouter(1541).FocusedRouteKeyContext.Provider, { value: rehydratedState.routes[rehydratedState.index].key, children: closure_1_7(StackRouter(1570).PreventRemoveProvider, { children: tmpResult }) }) };
        obj[1] = closure_1_7(StackRouter(1591).NavigationStateListenerProvider, obj1);
        obj[1] = closure_1_7(StackRouter(1565).NavigationHelpersContext.Provider, obj);
        return closure_1_7(StackRouter(1568).NavigationMetaContext.Provider, obj);
      });
      return obj17;
    }
    let everyResult;
    ...
    tmp51 = require("01563_isArrayEqual.js").isArrayEqual(tmp39.routeNames, mapped) && 0 === found.length;
  } else {
    let _Error = Error;
