...
export const Card = function Card(shadowEnabled) {
  ...
  const items13 = [
    tmp27,
    gesture(flag2(7029).CardContent, { enabled: pageOverflowEnabled, layout, style: contentStyle, children }),
  ];
  obj5[3] = items13;
