// _runtime/04951_OrdinaryDefineOwnProperty.js
...
import _mod4953 from "metro/04953__.js";
import ValidateAndApplyPropertyDescriptor from "04954_ValidateAndApplyPropertyDescriptor.js";

export default function OrdinaryDefineOwnProperty(arg0, arg1, __Writable__) {
  if (_mod4888(arg0)) {
    if (_mod4935(arg1)) {
      if (_mod4939(__Writable__)) {
        if (_mod1283) {
          ...
          return ValidateAndApplyPropertyDescriptor(arg0, arg1, _mod4953(arg0), __Writable__, tmp31);
