// _runtime/05238_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05245_AudioTypes.js";
import ImageTypes from "05246_ImageTypes.js";
import VideoTypes from "05247_VideoTypes.js";
import CompressedTypes from "05248_CompressedTypes.js";
import OtherTypes from "05249_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5239).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5239).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5239).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5239).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
