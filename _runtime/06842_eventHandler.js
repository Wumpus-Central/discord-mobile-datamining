// _runtime/06842_eventHandler.js
import _mod6762 from "metro/06762__.js";
import TouchEventType from "06764_TouchEventType.js";
...
handleStateChangeEvent.__closure = {
  flattenAndFilterEvent: fn(6824).flattenAndFilterEvent,
  State: fn(6762).State,
  runCallback: fn(6824).runCallback,
  CALLBACK_TYPE: fn(6777).CALLBACK_TYPE,
};
...
handleTouchEvent.__closure = {
  TouchEventType: fn(6764).TouchEventType,
  runCallback: fn(6824).runCallback,
  touchEventTypeToCallbackType: fn(6824).touchEventTypeToCallbackType,
};
...
eventHandler.__closure = {
  maybeExtractNativeEvent: fn(6824).maybeExtractNativeEvent,
  isEventForHandlerWithTag: fn(6824).isEventForHandlerWithTag,
  isStateChangeEvent: fn(6826).isStateChangeEvent,
  handleStateChangeEvent,
  isTouchEvent: fn(6826).isTouchEvent,
  handleTouchEvent,
  handleUpdateEvent,
};
