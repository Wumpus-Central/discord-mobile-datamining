...
obj = { flattenAndFilterEvent: fn(6723).flattenAndFilterEvent, runCallback: fn(6723).runCallback, CALLBACK_TYPE: fn(6676).CALLBACK_TYPE };
...
obj = { TouchEventType: fn(6663).TouchEventType, runCallback: fn(6723).runCallback, touchEventTypeToCallbackType: fn(6723).touchEventTypeToCallbackType };
