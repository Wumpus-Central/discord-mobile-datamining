// _runtime/13040_MetricsAggregator.js
...
const entry = {
  ...
  value: function add(metricType, arg1, diff) {
    ...
    const bucketKey = MetricsAggregator(13041).getBucketKey(
      metricType,
    ...
    if (value) {
      num = 0;
      if (metricType === MetricsAggregator(13037).SET_METRIC_TYPE) {
    ...
    if (value) {
      ...
      const tmp15 = new MetricsAggregator(13042).METRIC_MAP[metricType](diff);
      obj7.metric = tmp15;
    ...
    const result1 = MetricsAggregator(12945).updateMetricSummaryOnActiveSpan(
      metricType,
      sanitizeMetricKeyResult,
      diff,
      sanitizeUnitResult,
    ...
    const tmp5Result = MetricsAggregator(12945);
  },
};
const items = [
  entry,
  ...
  },
  {
    ...
    value: function _flush() {
      ...
      if (this._forceFlush) {
        ...
        const obj = MetricsAggregator(12954);
      }
    },
  },
  {
