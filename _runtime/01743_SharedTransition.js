...
const items = [
        ...
        if (!self._defaultTransitionType) {
          if (self._customAnimationFactory) {
            if (!self._customProgressAnimation) {
              self._defaultTransitionType = obj(1631).SharedTransitionType.ANIMATION;
            }
          }
          self._defaultTransitionType = obj(1631).SharedTransitionType.PROGRESS_ANIMATION;
        }
        if (self._defaultTransitionType === obj(1631).SharedTransitionType.ANIMATION) {
          let SHARED_ELEMENT_TRANSITION_PROGRESS = obj(1631).LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
        } else {
          SHARED_ELEMENT_TRANSITION_PROGRESS = obj(1631).LayoutAnimationType.SHARED_ELEMENT_TRANSITION_PROGRESS;
        }
        obj = obj(1720);
  ...
  },
  {
    ...
    value: function unregisterTransition(componentViewTag, flag) {
      ...
      if (this._defaultTransitionType === require(1631) /* isWorkletFunction */.SharedTransitionType.ANIMATION) {
      ...
      const result = require(1720) /* updateLayoutAnimations */.updateLayoutAnimations(componentViewTag, SHARED_ELEMENT_TRANSITION_PROGRESS, undefined, undefined, flag);
...
obj = {
  ...
  value: function custom(arg0) {
    ...
    obj._reduceMotion = require(1631) /* isWorkletFunction */.ReduceMotion.System;
