// _runtime/12963_JSONSchemaGenerator.js
...
const items = [
  ...
  },
  {
    ...
    value: function process(arg0) {
      ...
      return JSONSchemaGenerator(12961).process(arg0, this.ctx, tmp);
    },
  },
  {
    key: "emit",
    value: function emit(_idmap, cycles) {
      ...
      JSONSchemaGenerator(12961).extractDefs(self.ctx, _idmap);
      return callback(JSONSchemaGenerator(12961).finalize(self.ctx, _idmap), closure_4);
    },
  },
];
