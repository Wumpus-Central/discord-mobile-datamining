// _runtime/07253_HeaderContainer.js
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = {
                  title: require("metro/05848__.js").getHeaderTitle(tmp11, route.name),
                  href: buildHref(route.name, route.params),
                };
                tmp9 = obj2;
                const obj3 = require("metro/05848__.js");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("metro/07254__.js").forSlideRight;
                    } else {
                      forSlideUp = require("metro/07254__.js").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("metro/07254__.js").forSlideUp;
              }
            } else {
              forNoAnimation = require("metro/07254__.js").forNoAnimation;
            }
