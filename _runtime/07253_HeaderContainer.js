        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = { title: require("module_5848").getHeaderTitle(tmp11, route.name), href: buildHref(route.name, route.params) };
                tmp9 = obj2;
                const obj3 = require("module_5848");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("module_7254").forSlideRight;
                    } else {
                      forSlideUp = require("module_7254").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("module_7254").forSlideUp;
              }
            } else {
              forNoAnimation = require("module_7254").forNoAnimation;
            }
