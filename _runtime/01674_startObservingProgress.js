// === Module 1674: startObservingProgress ===

// Module 1674 (startObservingProgress)
import _mod1663 from "module_1663" /* 1663 */;
import _mod1675 from "module_1675" /* 1675 */;
import resolvePath from "resolvePath" /* 1677 */;
...
module_1641 = module_1641.isAndroid();
function startObservingProgress(arg0, addListener, arg2) {
  closure_0 = arg0;
  _require = addListener;
  dependencyMap = arg2 === require("module_1663").LayoutAnimationType.SHARED_ELEMENT_TRANSITION;
  addListener.addListener(arg0 + 1000000000, () => {
    map._notifyAboutProgress(closure_0, value2.value, closure_2);
  });
}
startObservingProgress.__closure = { LayoutAnimationType: _mod1663.LayoutAnimationType, TAG_OFFSET: 1000000000 };
      ...
      withStyleAnimationResult.callback = (arg0) => {
        if (arg0) {
          ...
          if (typeof stopObservingProgress === "function") {
            ...
            global._notifyAboutEnd(closure_0, value2 === _mod1663.LayoutAnimationType.EXITING);
            const tmp10 = value2 === _mod1663.LayoutAnimationType.EXITING;
          } else {
            throw new TypeError("Trying to call a non-function");
          }
        }
...
let obj = { LayoutAnimationType: _mod1663.LayoutAnimationType, TAG_OFFSET: 1000000000 };
createLayoutAnimationManager.__closure = { LayoutAnimationType: _mod1663.LayoutAnimationType, makeMutableUI: _mod1675.makeMutableUI, stopObservingProgress, withStyleAnimation: resolvePath.withStyleAnimation, startObservingProgress, IS_ANDROID: module_1641 };
