// _runtime/01207_ReflectionBinaryReader.js
          ...
          if (value) {
            ...
            if (repeat) {
              ...
              if (tmp5 == ReflectionBinaryReader(1191).WireType.LengthDelimited) {
                if (T != ReflectionBinaryReader(1200).ScalarType.STRING) {
                  if (T != ReflectionBinaryReader(1200).ScalarType.BYTES) {
    ...
    value: function mapEntry(V, pos, arg2) {
      ...
      if (pos.pos < sum) {
        ...
        if (V.K == ReflectionBinaryReader(1200).ScalarType.BOOL) {
          ...
          str1 = self.scalar(pos, V.K, ReflectionBinaryReader(1200).LongType.STRING);
        }
  ...
  },
  {
    ...
    value: function scalar(int32, arg1, STRING) {
      if (ReflectionBinaryReader(1200).ScalarType.INT32 === arg1) {
        return int32.int32();
      } else if (ReflectionBinaryReader(1200).ScalarType.STRING === arg1) {
        return int32.string();
      } else if (ReflectionBinaryReader(1200).ScalarType.BOOL === arg1) {
        return int32.bool();
      } else if (ReflectionBinaryReader(1200).ScalarType.DOUBLE === arg1) {
        return int32.double();
      } else if (ReflectionBinaryReader(1200).ScalarType.FLOAT === arg1) {
        return int32.float();
      } else if (ReflectionBinaryReader(1200).ScalarType.INT64 === arg1) {
        return ReflectionBinaryReader(1205).reflectionLongConvert(int32.int64(), STRING);
      } else if (ReflectionBinaryReader(1200).ScalarType.UINT64 === arg1) {
        return ReflectionBinaryReader(1205).reflectionLongConvert(int32.uint64(), STRING);
      } else if (ReflectionBinaryReader(1200).ScalarType.FIXED64 === arg1) {
        return ReflectionBinaryReader(1205).reflectionLongConvert(int32.fixed64(), STRING);
      } else if (ReflectionBinaryReader(1200).ScalarType.FIXED32 === arg1) {
        return int32.fixed32();
      } else if (ReflectionBinaryReader(1200).ScalarType.BYTES === arg1) {
        return int32.bytes();
      } else if (ReflectionBinaryReader(1200).ScalarType.UINT32 === arg1) {
        return int32.uint32();
      } else if (ReflectionBinaryReader(1200).ScalarType.SFIXED32 === arg1) {
        return int32.sfixed32();
      } else if (ReflectionBinaryReader(1200).ScalarType.SFIXED64 === arg1) {
        return ReflectionBinaryReader(1205).reflectionLongConvert(int32.sfixed64(), STRING);
      } else if (ReflectionBinaryReader(1200).ScalarType.SINT32 === arg1) {
        return int32.sint32();
      } else if (ReflectionBinaryReader(1200).ScalarType.SINT64 === arg1) {
        return ReflectionBinaryReader(1205).reflectionLongConvert(int32.sint64(), STRING);
      }
    },
  },
];
