// _runtime/10607__isNativeReflectConstruct.js
...
const items = [
  {
    ...
    value: function innerPatternString(arg0) {
      return (
        "((?:\u0432|\u0443)\\s*)?(" +
        UkMonthNameParser(10450).matchAnyPattern(UkMonthNameParser(10604).MONTH_DICTIONARY) +
        ")\\s*(?:[,-]?\\s*(" +
        UkMonthNameParser(10604).YEAR_PATTERN +
        ")?)?(?=[^\\s\\w]|\\s+[^0-9]|\\s+$|$)"
      );
    },
  },
