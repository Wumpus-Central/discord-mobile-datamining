// === Module 6379: HeaderBackButton ===

// Module 6379 (HeaderBackButton)
import createStandardNavigationFactories from "createStandardNavigationFactories" /* 1501 */;
import registerAssetDefault from "registerAsset" /* 6351 */;
import HeaderButton from "HeaderButton" /* 6385 */;
...
export const HeaderBackButton = function HeaderBackButton(accessibilityLabel) {
  ...
  if (backImage) {
    ...
    obj1[2] = items1;
    backImageResult = tmp9(tmp2(6380).HeaderIcon, obj1);
  }
  ...
  if ("minimal" !== displayMode) {
    ...
    if (titleLayout) {
      ...
      if (screenLayout) {
        ...
        diff = result - (c9 + tmp2(6380).ICON_MARGIN);
      }
    }
