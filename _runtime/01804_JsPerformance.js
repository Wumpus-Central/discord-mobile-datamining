// _runtime/01804_JsPerformance.js
...
import _isNativeReflectConstruct from "metro/01672__.js";

function JsPerformance(smoothingFrames) {
  smoothingFrames = smoothingFrames.smoothingFrames;
  let sharedValue;
  dependencyMap = undefined;
  sharedValue = sharedValue(1781).useSharedValue(null);
  sharedValue(1781);
  if (typeof createCircularDoublesBuffer === "function") {
    ...
    const obj5 = { style: closure_16.text, animatedProps: tmp(1781).useAnimatedProps(fn), editable: false };
    obj4.children = closure_5(closure_8, obj5);
    return closure_5(closure_4, obj4);
  } else {
    throw new TypeError("Trying to call a non-function");
  }
  const obj = sharedValue(1781);
  tmp = sharedValue;
}
