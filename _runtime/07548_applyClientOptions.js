// _runtime/07548_applyClientOptions.js
import { isMatchingPattern } from "07508_isMatchingPattern.js";
import { getFilenameToDebugIdMap } from "07551_getFilenameToDebugIdMap.js";
import { 07536__ } from "metro/07536__.js";
const require = arg1;
...
function applyClientOptions(environment, environment2) {
  ...
  if (!DEFAULT_ENVIRONMENT) {
    DEFAULT_ENVIRONMENT = 07536__.DEFAULT_ENVIRONMENT;
  }
          ...
          if (breadcrumbs) {
            ...
            if (breadcrumbs) {
              ...
              obj[0] = breadcrumbs.map((data) => {
                ...
                if (data) {
                  obj = { data: null };
                  obj[0] = dependencyMap(7544).normalize(data.data, dependencyMap, dependencyMap);
                  data = obj;
                  const obj3 = dependencyMap(7544);
                }
