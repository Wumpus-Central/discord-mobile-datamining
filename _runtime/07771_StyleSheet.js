...
function SceneView(arg0) {
  ...
  let obj2 = React;
  const context = React.useContext(num6(5467).HeaderShownContext);
  let num5 = React.useContext(num6(5467).HeaderHeightContext);
  const context1 = React.useContext(num6(5467).HeaderBackContext);
  let obj3 = num6(5467);
  ...
  callback = obj2.useCallback(num6(7772).debounce(tmp18, 100), []);
  let tmp21 = "usesNewAndroidHeaderHeightImplementation" in tmp8(4830).compatibilityFlags;
  if (tmp21) {
    tmp21 = true === tmp8(4830).compatibilityFlags.usesNewAndroidHeaderHeightImplementation;
  }
  callback = 0;
  let num8 = 0;
  if (null == header) {
  ...
  if (previousDescriptor) {
    title = tmp8(5467).getHeaderTitle(previousDescriptor.options, previousDescriptor.route.name);
    const tmp8Result2 = tmp8(5467);
  ...
  let eventResult;
  const headerConfigProps = num6(7773).useHeaderConfigProps(obj);
  if (null == header) {
  ...
  const tmp8Result3 = num6(7773);
  obj15[1] = closure_10(num6(5467).HeaderBackContext.Provider, { value: memo1, children: descriptor.render() });
  items5[2] = closure_10(num6(5467).HeaderShownContext.Provider, obj15);
  obj8[1] = items5;
  obj7[1] = tmp38(num6(5467).HeaderHeightContext.Provider, obj8);
  obj4[52] = closure_10(num6(7775).AnimatedHeaderHeightContext.Provider, obj7);
  obj3[2] = closure_10(num6(4830).ScreenStackItem, obj4);
