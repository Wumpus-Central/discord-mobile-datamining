...
function loadView(byteLength) {
  ...
  let obj2 = require("module_5432");
  ({ fileType, fileDataOffset, jfifDataOffset, tiffHeaderOffset, iptcDataOffset, xmpChunks, iccChunks, mpfDataOffset, pngHeaderOffset, pngTextChunks, pngChunkOffsets, vp8xChunkOffset, gifHeaderOffset } = require("module_5432").parseAppMarkers(byteLength, flag2));
  let flag4 = false;
  if (require("module_5433").USE_JPEG) {
    flag4 = false;
  ...
  const parseAppMarkersResult = require("module_5432").parseAppMarkers(byteLength, flag2);
