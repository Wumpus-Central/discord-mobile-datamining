// _runtime/08920__isNativeReflectConstruct.js
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f116698);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f116698);
    ...
    f116698 = undefined;
    f116698 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8923").NONE, require("module_8923").INVERT, require("module_8923").MONOCHROME, require("module_8923").POSTERIZE, require("module_8923").FALSE, require("module_8923").MAXIMUMCOMPONENT, require("module_8923").MINIMUMCOMPONENT, require("module_8923").CHROME, require("module_8923").FADE, require("module_8923").INSTANT, require("module_8923").MONO, require("module_8923").NOIR, require("module_8923").PROCESS, require("module_8923").TONAL, require("module_8923").TRANSFER, require("module_8923").SEPIA];
...
const items4 = [require("module_8924").CLEARKEY, require("module_8924").FAIRPLAY, require("module_8924").WIDEVINE, require("module_8924").PLAYREADY];
...
const items8 = [require("module_8943").SRT, require("module_8943").TTML, require("module_8943").VTT];
...
export const TextTrackType = require("module_8943");
export const FilterType = require("module_8923");
export const DRMType = require("module_8924");