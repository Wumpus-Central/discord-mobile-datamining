// _runtime/01626_KeyboardChatScrollView.js
import KeyboardAvoidingView from "01842_KeyboardAvoidingView.js";
import OverKeyboardView from "01871_OverKeyboardView.js";
...
for (const key10017 in require("metro/01635__.js")) {
  arg5[key10017] = require("metro/01635__.js")[key10017];
  continue;
}
...
for (const key10025 in require("metro/01831__.js")) {
  arg5[key10025] = require("metro/01831__.js")[key10025];
  continue;
}
...
for (const key10033 in require("metro/01829__.js")) {
  arg5[key10033] = require("metro/01829__.js")[key10033];
  continue;
}
for (const key10037 in require("metro/01835__.js")) {
  arg5[key10037] = require("metro/01835__.js")[key10037];
  continue;
}
