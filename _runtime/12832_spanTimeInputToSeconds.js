// _runtime/12832_spanTimeInputToSeconds.js
...
import _mod12839 from "metro/12839__.js";
import _mod12841 from "metro/12841__.js";
import _mod12842 from "metro/12842__.js";
import _mod12843 from "metro/12843__.js";
import _mod12844 from "metro/12844__.js";
import _mod12845 from "metro/12845__.js";
import _mod12846 from "metro/12846__.js";
import _mod12849 from "metro/12849__.js";
  ...
  if (
    ...
    try {
      ...
      if (
        ...
        obj.op = attributes[_mod12842.SEMANTIC_ATTRIBUTE_SENTRY_OP];
        obj.origin = attributes[_mod12842.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN];
        const tmp8 = spanTimeInputToSeconds(endTime);
        obj._metrics_summary = _mod12843.getMetricSummaryJsonForSpan(getSpanJSON);
...
function getStatusMessage(code) {
  if (code) {
    if (code.code !== _mod12844.SPAN_STATUS_UNSET) {
      let str = "ok";
      if (code.code !== _mod12844.SPAN_STATUS_OK) {
...
export const addChildSpanToSpan = function addChildSpanToSpan(parentSpan, sentrySpan) {
  ...
  const result = _mod12833.addNonEnumerableProperty(sentrySpan, _sentryRootSpan, tmp2);
  if (parentSpan[_sentryChildSpans]) {
    ...
    const result1 = _mod12833.addNonEnumerableProperty(parentSpan, _sentryChildSpans, set);
