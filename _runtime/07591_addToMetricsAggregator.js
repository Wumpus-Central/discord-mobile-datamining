// _runtime/07591_addToMetricsAggregator.js
...
import { createChildOrRootSpan } from "07529_createChildOrRootSpan.js";
import { __SENTRY_DEBUG__ } from "metro/07523___SENTRY_DEBUG__.js";
import { 07592__ } from "metro/07592__.js";
...
export const metrics = {
  increment(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07592__.COUNTER_METRIC_TYPE, arg1, parsed, arg3);
  },
  distribution(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07592__.DISTRIBUTION_METRIC_TYPE, arg1, parsed, arg3);
  },
  set(arg0, arg1, arg2, arg3) {
    addToMetricsAggregator(arg0, 07592__.SET_METRIC_TYPE, arg1, arg2, arg3);
  },
  gauge(arg0, arg1, joined) {
    ...
    addToMetricsAggregator(arg0, 07592__.GAUGE_METRIC_TYPE, arg1, parsed, arg3);
  },
  timing(arg0, arg1, fn) {
    const _require = arg0;
    ...
    if (typeof fn === "function") {
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = _07592__.DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
