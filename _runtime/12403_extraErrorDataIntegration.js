// _runtime/12403_extraErrorDataIntegration.js
import _mod12319 from "metro/12319__.js";
import _mod12320 from "metro/12320__.js";
import _mod12358 from "metro/12358__.js";
        ...
        if (obj2.isError(obj.originalException)) {
          const tmp7 = (function _extractErrorData(originalException, dependencyMap, maxValueLength) {
            try {
              ...
              if (num(12341).DEBUG_BUILD) {
                const logger = num(12313).logger;
          ...
          if (tmp7) {
            ...
            if (tmp4Result.isPlainObject(normalizeResult)) {
              const result = _mod12319.addNonEnumerableProperty(normalizeResult, "__sentry_skip_normalization__", true);
              obj3[tmp6] = normalizeResult;
              const tmp4Result2 = _mod12319;
            }
            let obj4 = {};
            const merged1 = Object.assign(contexts);
            obj4.contexts = obj3;
            tmp3 = obj4;
            tmp4Result = _mod12320;
          }
