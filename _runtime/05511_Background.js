// === Module 5511: Background ===

// Module 5511 (Background)
import registerAssetDefault from "registerAsset" /* 5512 */;
import registerAssetDefault2 from "registerAsset" /* 5513 */;
import registerAssetDefault3 from "registerAsset" /* 5514 */;
import registerAssetDefault4 from "registerAsset" /* 5515 */;
import registerAssetDefault5 from "registerAsset" /* 5516 */;

const items = [registerAssetDefault, registerAssetDefault2, registerAssetDefault3, registerAssetDefault4, registerAssetDefault5];
for (const key10025 in require("module_5517")) {
  let tmp2 = key10025;
  arg5[key10025] = require("module_5517")[key10025];
  continue;
}
