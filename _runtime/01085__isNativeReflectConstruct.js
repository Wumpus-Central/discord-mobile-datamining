// _runtime/01085__isNativeReflectConstruct.js
...
function addNetworkBreadcrumb(isEnabled, name) {
  ...
  if (isEnabledResult) {
    ...
    if (isSentryRequestUrlResult) {
      obj = registerSpanErrorInstrumentation;
      isSentryRequestUrlResult = obj.isSentryRequestUrl(name.name, require("00814_registerSpanErrorInstrumentation.js").getClient());
