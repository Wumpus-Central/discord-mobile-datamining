// _runtime/01725_TransitionGenerator.js
import TransitionType from "01693_TransitionType.js";
import convertAnimationObjectToKeyframes from "01695_convertAnimationObjectToKeyframes.js";
import findDescendantWithExitingAnimation from "01724_findDescendantWithExitingAnimation.js";
import LinearTransition from "01726_LinearTransition.js";
import SequencedTransition from "01727_SequencedTransition.js";
import FadingTransition from "01728_FadingTransition.js";
import JumpingTransition from "01729_JumpingTransition.js";
import prepareCurvedTransition from "01730_prepareCurvedTransition.js";
import _mod1731 from "metro/01731__.js";
...
export const TransitionGenerator = function TransitionGenerator(ENTRY_EXIT, easingY) {
  ...
  if (TransitionType.TransitionType.LINEAR === ENTRY_EXIT) {
    ...
    firstKeyframeObj = _mod1731.EntryExitTransition(`REA${tmp}`, easingY);
    const tmp3Result16 = _mod1731;
  }
