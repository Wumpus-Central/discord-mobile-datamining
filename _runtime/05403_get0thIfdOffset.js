// _runtime/05403_get0thIfdOffset.js
import _modDef5386 from "metro/05386__.js";
import _modDef5400 from "metro/05400__.js";
import IFD_TYPE_0TH2 from "05404_IFD_TYPE_0TH.js";
...
function readTag(byteLength, IFD_TYPE_0TH, sum, sum, byteOrder, arg5) {
  ...
  if (undefined !== _modDef5400.typeSizes[shortAt1]) {
    if (
      ...
      const longAt1 = _modDef5400.getLongAt(byteLength, sum + sum1, byteOrder);
      str = "<faulty value>";
      tmp21 = longAt1;
      if (
      ...
      const tmp4Result = _modDef5400;
    }
    let tmp34 = str;
    if (shortAt1 === _modDef5400.tagTypes.ASCII) {
    ...
    if (undefined !== IFD_TYPE_0THDefault[IFD_TYPE_0TH][shortAt]) {
      ...
      if (shortAt1 !== _modDef5400.tagTypes.RATIONAL) {
        if (shortAt1 !== _modDef5400.tagTypes.SRATIONAL) {
...
let obj = {
  1: null,
  2: _modDef5400.getByteAt,
  3: _modDef5400.getAsciiAt,
  4: _modDef5400.getShortAt,
  5: _modDef5400.getLongAt,
  7: _modDef5400.getRationalAt,
  9: null,
  10: _modDef5400.getUndefinedAt,
  13: null,
};
...
function readIfd(byteLength, IFD_TYPE_0TH, sum, sum, byteOrder, arg5) {
  ...
  if (_modDef5386.USE_THUMBNAIL) {
    if (tmp5 < byteLength.byteLength - tmp23Result.getTypeSize("LONG")) {
      const longAt = _modDef5400.getLongAt(byteLength, tmp5, byteOrder);
      let tmp26 = 0 !== longAt;
      if (tmp26) {
      ...
      const tmp23Result2 = _modDef5400;
    }
    tmp23Result = _modDef5400;
  }
  return obj3;
}
