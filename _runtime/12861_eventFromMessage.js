// _runtime/12861_eventFromMessage.js
...
export const eventFromUnknownInput = function eventFromUnknownInput(getOptions, fn, name, data) {
  ...
  const result1 = _mod12812.addExceptionTypeValue(obj2, undefined, undefined);
  const result2 = _mod12812.addExceptionMechanism(obj2, data);
  const obj4 = {};
