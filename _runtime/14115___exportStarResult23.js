// _runtime/14115___exportStarResult23.js
import CanonicalizeLocaleList from "14079_CanonicalizeLocaleList.js";
import __exportStarResult2 from "14081___exportStarResult2.js";
import getMultiInternalSlots from "14084_getMultiInternalSlots.js";
import __exportStarResult4 from "14089___exportStarResult4.js";
import match from "14116_match.js";
...
arg5.InitializeNumberFormat = function InitializeNumberFormat(arg0, arg1, arg2, arg3) {
  ...
  if ("currency" === style) {
    ...
    if ("compact" === GetOptionResult1) {
      internalSlots.compactDisplay = tmp(14089).GetOption(
        result1,
        "compactDisplay",
        "string",
        ["short", "long"],
    ...
    internalSlots.useGrouping = tmp(14091).GetStringOrBooleanOption(
      result1,
      "useGrouping",
      ["min2", "auto", "always"],
      "always",
    ...
    internalSlots.signDisplay = tmp(14089).GetOption(
      result1,
      "signDisplay",
      "string",
