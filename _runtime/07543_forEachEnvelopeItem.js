// _runtime/07543_forEachEnvelopeItem.js
import _slicedToArray from "_slicedToArray";
import { getGlobalSingleton } from "07500_getGlobalSingleton.js";
import { addNonEnumerableProperty } from "07505_addNonEnumerableProperty.js";
import { normalize } from "07544_normalize.js";
import { dsnFromString } from "07546_dsnFromString.js";
...
export const createAttachmentEnvelopeItem = function createAttachmentEnvelopeItem(data) {
  if (typeof data.data === "string") {
    ...
    __SENTRY__ = __SENTRY__(7500).GLOBAL_OBJ.__SENTRY__;
