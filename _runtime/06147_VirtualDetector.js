// _runtime/06147_VirtualDetector.js
...
export const VirtualDetector = function VirtualDetector(children) {
  _require = children;
  const interceptingDetectorContext = require("metro/06146__.js").useInterceptingDetectorContext();
      ...
      if (-1 !== first) {
        if (obj.gesture.config.dispatchesAnimatedEvents) {
          ...
          obj = {
            ...
            userSelect: -42.799,
            touchAction: -38.306,
            enableContextMenu: "<string:328531971>",
          };
          ({
  ...
  let obj = require("metro/06146__.js");
};
