// _runtime/00579_defaultOptions.js
...
function replaceGetterValues(arg0) {
  ...
  return function(closure_1_1, keys) {
    let tmp2;
    let tmp = keys;
    if (closure_1_3.length > 0) {
      ...
      if (0 < closure_1_3.length) {
        ...
        tmp = tmp2[2];
        closure_1_3.splice(num2, 1);
      }
    }
    const self = this;
    const call = fn.call;
    return typeof call === "unknown" ? fn(closure_1_1, tmp) : call(self, closure_1_1, tmp);
  };
}
