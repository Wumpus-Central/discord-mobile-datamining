// _runtime/09283_XorAndSalsa.js
import _asyncLoop from "09284__asyncLoop.js";
import number from "09285_number.js";
import pbkdf2Init from "09287_pbkdf2Init.js";
import _mod9289 from "metro/09289__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod9289.sha256, B, B, obj2);
