// _runtime/08458__isNativeReflectConstruct.js
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(8459), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(8461), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(8463), obj);
    items[3] = callback3(FeDropShadow(8452), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(8467), {}), callback3(FeDropShadow(8467), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(8465), obj);
    obj[0] = items;
