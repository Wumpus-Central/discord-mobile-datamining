...
arg5.ResolveLocale = function ResolveLocale(arg0, arg1, localeMatcher) {
  ...
  if ("lookup" === localeMatcher.localeMatcher) {
    const _Array2 = Array;
    let LookupMatcherResult = require("13420_LookupMatcher.js") /* LookupMatcher */.LookupMatcher(Array.from(arg0), arg1, arg5);
    let tmp5 = require;
    let tmp7 = require;
  } else {
    const _Array = Array;
    tmp5 = require;
    tmp7 = require;
    LookupMatcherResult = require("13425_BestFitMatcher.js") /* BestFitMatcher */.BestFitMatcher(Array.from(arg0), arg1, arg5);
  }
  ...
  if (LookupMatcherResult.extension) {
    let keywords = tmp7(13426).UnicodeExtensionComponents(LookupMatcherResult.extension).keywords;
  } else {
    keywords = [];
  }
  const items = [];
  ...
  if (0 < arg3.length) {
    do {
      ...
      let invariantResult = require("13421_isMatched.js") /* isMatched */.invariant(isArray, "keyLocaleData for ".concat(str, " must be an array"));
      let first = items1[0];
      ...
      let invariantResult1 = require("13421_isMatched.js") /* isMatched */.invariant(tmp19, "value must be a string or undefined");
      ...
      let invariantResult2 = tmp14(13421).invariant(tmp24, "optionsValue must be a string or undefined");
      let str3 = tmp23;
      if (typeof tmp23 === "string") {
        let formatted = str.toLowerCase();
        str3 = tmp14(13427).CanonicalizeUValue(formatted, tmp23);
        if ("" === str3) {
          str3 = "true";
        }
      }
  ...
  let result = locale;
  if (items.length > 0) {
    result = tmp5(13428).InsertUnicodeExtensionAndCanonicalize(locale, [], items);
  }
  obj.locale = result;
  return obj;
};