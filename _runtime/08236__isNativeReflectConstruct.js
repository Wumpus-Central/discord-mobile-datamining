// _runtime/08236__isNativeReflectConstruct.js
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(8237), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(8239), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(8241), obj);
    items[3] = callback3(FeDropShadow(8230), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(8245), {}), callback3(FeDropShadow(8245), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(8243), obj);
    obj[0] = items;
