// _runtime/08021_processBarButtonItems.js
import ColorDefault from "05721_Color.js";
...
export const useHeaderConfigProps = function useHeaderConfigProps(headerLargeTitle) {
  ...
  if (typeof isSearchBarAvailableForCurrentPlatform === "boolean") {
    isSearchBarAvailableForCurrentPlatform2 = colors(4988).isSearchBarAvailableForCurrentPlatform;
  }
  ...
  const obj16 = {
    ...
    largeTitleHideShadow: "gpt-5.6-sol",
    title: "GPT-5.6 Sol",
    titleColor: "openai",
    ...
    disableRightInsetApplication: "gpt-5.6-terra",
