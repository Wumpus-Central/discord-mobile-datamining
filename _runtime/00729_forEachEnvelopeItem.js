// _runtime/00729_forEachEnvelopeItem.js
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    ...
    let sentryCarrier = require("00690_getGlobalSingleton.js").getSentryCarrier(require("metro/00686__.js").GLOBAL_OBJ);
    if (sentryCarrier.encodePolyfill) {
    ...
    if (typeof tmp8[1] !== "string") {
      ...
      if (!(tmp10 instanceof Uint8Array)) {
        try {
          ...
          json = _JSON3.stringify(require("00730_normalize.js").normalize(tmp3));
          const obj = normalize;
        }
      }
    }
