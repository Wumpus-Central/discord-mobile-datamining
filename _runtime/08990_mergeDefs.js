          ...
          switch (code.code) {
            ...
            case "D":
              ...
              if (obj.test(code.expected)) {
                ...
                let combined =
                  "Noto\u2018g\u2018ri kirish: kutilgan instanceof " + code.expected + ", qabul qilingan " + tmp49;
              } else {
            ...
            case "useDeferredValue":
              ...
              if (tmp20) {
                ...
                let combined3 =
                  "Juda kichik: kutilgan " + origin + " " + str22 + str + " " + tmp20.unit + " " + tmp20.verb;
              } else {
