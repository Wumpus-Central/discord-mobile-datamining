// _runtime/01686_runOnRuntime.js
...
export const createWorkletRuntime = function createWorkletRuntime(arg0, initializer) {
  ...
  obj = {
    registerReanimatedError: __reanimatedLoggerConfig(1647).registerReanimatedError,
    registerLoggerConfig: __reanimatedLoggerConfig(1640).registerLoggerConfig,
    config: globalThis.__reanimatedLoggerConfig,
    setupCallGuard: __reanimatedLoggerConfig(1638).setupCallGuard,
    setupConsole: __reanimatedLoggerConfig(1638).setupConsole,
    initializer,
  };
  fn.__closure = obj;
