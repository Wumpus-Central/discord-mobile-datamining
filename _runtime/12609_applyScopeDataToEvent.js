// _runtime/12609_applyScopeDataToEvent.js
import addNonEnumerableProperty from "12565_addNonEnumerableProperty.js";
import merge from "12584_merge.js";
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(12564).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(12564);
    obj4[0] = tmp3(12595).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(12595);
    const rootSpan = tmp3(12564).getRootSpan(span);
    const tmp3Result4 = tmp3(12564);
    const description = tmp3(12564).spanToJSON(rootSpan).description;
