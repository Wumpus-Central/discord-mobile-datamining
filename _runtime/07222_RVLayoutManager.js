// === Module 7222: RVLayoutManager ===

// Module 7222 (RVLayoutManager)
import _modDef7197 from "module_7197" /* 7197 */;
import _classCallCheck from "module_7196" /* 7196 */;
...
let items = [
  ...
  },
  {
    ...
    value: function getVisibleLayouts(bound1, arg1) {
      ...
      const findLastVisibleIndexResult = RVLayoutManager(7223).findLastVisibleIndex(this.layouts, arg1, this.horizontal);
      if (-1 !== result) {
