// _runtime/01024__lazyLoadIntegration.js
        ...
        try {
          ...
          if (0 === table) {
            if (arg0 === 1) {
              ...
              element = undefined;
              table = undefined;
              Sentry = callback(1025).WINDOW.Sentry;
              if (!Sentry) {
                Sentry = {};
              }
              callback(1025).WINDOW.Sentry = Sentry;
              if (table[callback]) {
                ...
                const _document = tmp54(1025).WINDOW.document;
                element = <script />;
                ...
                const currentScript = tmp54(1025).WINDOW.document.currentScript;
                let head = tmp54(1025).WINDOW.document.body;
                if (!head) {
                  head = tmp54(1025).WINDOW.document.head;
                }
                if (!head) {
                  let parentElement;
