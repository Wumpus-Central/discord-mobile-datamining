// _runtime/14534_InsertUnicodeExtensionAndCanonicalize.js
import _mod14527 from "metro/14527__.js";
import CanonicalizeUnicodeLocaleId from "14535_CanonicalizeUnicodeLocaleId.js";
...
export const InsertUnicodeExtensionAndCanonicalize = function InsertUnicodeExtensionAndCanonicalize(arr, arg1, arg2) {
  let length;
  _mod14527.invariant(-1 === arr.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
  let num = 0;
  let str = "-u";
  let str2 = "-u";
  if (0 < arg1.length) {
