  ...
  if (!arg2) {
    {
      if (isObject(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4562)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4563)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(621)(arr)) {
            return tmp32(4564)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (obj[tmp11]) {
                  tmp14 = tmp32(4578)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arg4) {
            ...
            if (!tmp2) {
              ...
              if (!tmp) {
                if (tmp2) {
                  let tmp32Result = tmp32(4568);
                  let tmp32ResultResult = tmp32Result(arr, tmp32(4572)(obj, arr));
                } else {
                  tmp32Result = tmp32(4576);
                  tmp32ResultResult = tmp32Result(arr, tmp32(4577)(obj, arr));
                }
