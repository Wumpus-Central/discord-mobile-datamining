// _runtime/09959_XorAndSalsa.js
import _asyncLoop from "09960__asyncLoop.js";
import number from "09961_number.js";
import pbkdf2Init from "09963_pbkdf2Init.js";
import _mod9965 from "metro/09965__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod9965.sha256, B, B, obj2);
