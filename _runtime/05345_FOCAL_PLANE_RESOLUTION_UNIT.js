// === Module 5345: FOCAL_PLANE_RESOLUTION_UNIT ===
                          ...
                          if (exif.file) {
                            ...
                            if (arg1) {
                              if (exif.exif) {
                                ...
                                let flag = false;
                                if (value4) {
                                  FocalLength35efl = { value: value4, description: require("module_5317").FocalLengthIn35mmFilm(value4) };
                                  FocalLength35efl.FocalLength35efl = FocalLength35efl;
                                  flag = true;
                                  const obj3 = require("module_5317");
                                }
