// _runtime/14045_Range.js
import _createClass from "metro/00042__createClass.js";
import LRUCache from "14046_LRUCache.js";
...
class Range {
  constructor(arg0, arg1) {
    ...
    tmp3 = Range;
    tmp4 = closure_1;
    tmp5 = require("metro/14017__.js")(require);
    ...
    value: function parseRange(str) {
      ...
      if (value) {
        ...
        let str3 = str.replace(
          tmp11(14020).safeRe[tmp11(undefined, 14020).t.COMPARATORTRIM],
          tmp11(14020).comparatorTrimReplace,
        );
        tmp11(14019)("comparator trim", str3);
        let str5 = str3.replace(
          tmp11(14020).safeRe[tmp11(undefined, 14020).t.TILDETRIM],
          tmp11(14020).tildeTrimReplace,
        );
        tmp11(14019)("tilde trim", str5);
        const str7 = str5.replace(
          tmp11(14020).safeRe[tmp11(undefined, 14020).t.CARETTRIM],
          tmp11(14020).caretTrimReplace,
        );
