// _runtime/08877__isNativeReflectConstruct.js
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f116540);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f116540);
    ...
    f116540 = undefined;
    f116540 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8880").NONE, require("module_8880").INVERT, require("module_8880").MONOCHROME, require("module_8880").POSTERIZE, require("module_8880").FALSE, require("module_8880").MAXIMUMCOMPONENT, require("module_8880").MINIMUMCOMPONENT, require("module_8880").CHROME, require("module_8880").FADE, require("module_8880").INSTANT, require("module_8880").MONO, require("module_8880").NOIR, require("module_8880").PROCESS, require("module_8880").TONAL, require("module_8880").TRANSFER, require("module_8880").SEPIA];
...
const items4 = [require("module_8881").CLEARKEY, require("module_8881").FAIRPLAY, require("module_8881").WIDEVINE, require("module_8881").PLAYREADY];
...
const items8 = [require("module_8900").SRT, require("module_8900").TTML, require("module_8900").VTT];
...
export const TextTrackType = require("module_8900");
export const FilterType = require("module_8880");
export const DRMType = require("module_8881");