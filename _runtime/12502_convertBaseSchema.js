// _runtime/12502_convertBaseSchema.js
import _slicedToArray from "_slicedToArray";
import { $output } from "12490__output.js";
...
if (self2) {
  ...
  if (__setModuleDefault) {
    ...
    const fnResult = fn(require("module_12497"));
    let obj = {};
    let merged = Object.assign(fn(require("module_12496")));
    const merged1 = Object.assign(fnResult);
    obj.iso = fn(require("module_12498"));
    let _Set = Set;
