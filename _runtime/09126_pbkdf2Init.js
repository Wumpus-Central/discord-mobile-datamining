// _runtime/09126_pbkdf2Init.js
import asyncGeneratorStep from "asyncGeneratorStep";
import { _asyncLoop } from "09123__asyncLoop.js";
import { number } from "09124_number.js";
...
function pbkdf2Init(sha256, B, B, arg3) {
  ...
  if (c < 1) {
    ...
    const toBytesResult = tmp(9123).toBytes(B);
    const uint8Array = new Uint8Array(dkLen);
    const hmac = tmp(9127).hmac;
    let obj = hmac.create(sha256, toBytesResult);
    const toBytesResult1 = tmp(9123).toBytes(B);
