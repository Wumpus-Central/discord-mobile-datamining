...
let obj = {
  createGestureHandler(closure_0, handlerTag, config) {
    ...
    const result = require("05630_transformIntoHandlerTags.js").scheduleOperationToBeFlushed(() => {
  ...
  setGestureHandlerConfig(handlerTag, closure_1) {
    ...
    let result = require("05630_transformIntoHandlerTags.js").scheduleOperationToBeFlushed(() => {
