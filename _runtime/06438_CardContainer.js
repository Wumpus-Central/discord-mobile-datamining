// _runtime/06438_CardContainer.js
import Link from "01485_Link.js";
import _mod5938 from "metro/05938__.js";
import ModalPresentationContext from "06428_ModalPresentationContext.js";
import _mod6439 from "metro/06439__.js";
import CardA11yWrapper from "06440_CardA11yWrapper.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5938.getHeaderTitle(options, route.name);
    href = tmp2Result5.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result6 = _mod5938;
  }
  closure_15 = tmp12;
