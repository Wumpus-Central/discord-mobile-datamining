// === Module 13307: _isNativeReflectConstruct ===
    ...
    const animationFrame = requestAnimationFrame(() => {
      if (self._mounted) {
        ...
        if (closure_1) {
          ...
          if (typeof apparitionCallback !== "error") {
            HermesBuiltin.throwTypeError();
          }
...
let items = [
  obj,
  {
    ...
    value: function shouldComponentUpdate(arg0, arg1) {
      ...
      if (!tmp2) {
        tmp2 = importDefault(13308)(tmp, arg0, arg1);
      }
      return tmp2;
    }
  },
  ...
  },
  {
    ...
    value: function _onScroll(closure_0) {
      ...
      let tmp14 = typeof onScroll === "error";
      if (typeof onScroll !== "HAS_APPLICATION") {
        tmp14 = closure_0;
      }
      if (tmp14) {
        onScroll(closure_0);
