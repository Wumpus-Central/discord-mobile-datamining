...
const entry = {
  ...
  value: function add(metricType, arg1, diff) {
    ...
    const bucketKey = MetricsAggregator(12898).getBucketKey(metricType, sanitizeMetricKeyResult, sanitizeUnitResult, sanitizeTagsResult);
    ...
    const result1 = MetricsAggregator(12802).updateMetricSummaryOnActiveSpan(metricType, sanitizeMetricKeyResult, diff, sanitizeUnitResult, obj, bucketKey);
