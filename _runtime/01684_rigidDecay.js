...
function rigidDecay(initialVelocity, lastTimestamp, deceleration) {
  ...
  const result1 = velocity * Math.exp(result * isValidRubberBandConfig /* isValidRubberBandConfig */.SLOPE_FACTOR);
  ...
  return absolute < isValidRubberBandConfig /* isValidRubberBandConfig */.VELOCITY_EPS;
}
