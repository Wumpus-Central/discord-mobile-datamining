// _runtime/06973_traverseAndConfigureRelations.js
...
function traverseAndConfigureRelations(gestures, map, set) {
  ...
  if (obj.isComposedGesture(gestures)) {
    ...
    gestures.gestureRelations = tmp(6966).prepareRelations(gestures.config, gestures.handlerTag);
