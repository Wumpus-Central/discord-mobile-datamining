...
import G from "03805_G.js";
import dateLongFormatter from "03816_dateLongFormatter.js";
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("03576_getDefaultOptions.js").getDefaultOptions();
  locale = undefined;
  if (null != locale) {
