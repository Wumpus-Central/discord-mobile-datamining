// _runtime/14329_digitsToString.js
let self = this;
...
function taylorSeries(constructor, arg1, timesResult, constructor1, arg4) {
  ...
  while (true) {
    ...
    let tmp4Result = f117268(timesResult2, tmp20, precision, 1);
  ...
  if (this.isFinite()) {
    if (self.e < 0) {
      ...
      if (Math.max(sdResult, precision) < 2 * -self.e - 1) {
        ...
        constructor.precision = precision;
        constructor.rounding = rounding;
        timesResult = f117268(plusResult, constructor2.minus(self), diff + precision, 1)
          .ln()
          .times(0.5);
...
obj2.toJSON = fn43;
obj2.valueOf = fn43;
const f117268 = (s, s2, arg2, rounding, arg4, arg5) => {
  let num13;
  let tmp21;
  let tmp27;
