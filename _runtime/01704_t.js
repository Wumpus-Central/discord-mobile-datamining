...
let fn = function t(toValue, userConfig, callback) {
  ...
  obj = { Easing: require("01705_linear.js").Easing, userConfig, toValue, callback, getReduceMotionForAnimation: require("01693_isValidLayoutAnimationProp.js").getReduceMotionForAnimation };
  fn.__closure = obj;
