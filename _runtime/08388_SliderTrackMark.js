// _runtime/08388_SliderTrackMark.js
import noop2 from "00019_noop.js";
import styles from "08386_styles.js";
import 08382__ from "metro/08382__.js";
...
export const SliderTrackMark = function SliderTrackMark(arg0) {
  ...
  if (thumbImage) {
    ...
    if (isTrue) {
      ...
      obj1[0] = tmp2(8386).styles.thumbImageContainer;
      const obj2 = { source: null, style: null };
      obj2[0] = thumbImage;
      obj2[1] = tmp2(8386).styles.thumbImage;
