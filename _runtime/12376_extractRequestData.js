// _runtime/12376_extractRequestData.js
import _mod12294 from "metro/12294__.js";
import _mod12295 from "metro/12295__.js";
import _mod12301 from "metro/12301__.js";
import _mod12302 from "metro/12302__.js";
...
import _mod12378 from "metro/12378__.js";
  ...
  let item = include.forEach((item) => {
    if ("headers" === item) {
      ...
      if (!include.includes("ip")) {
        const ipHeaderNames = _mod12378.ipHeaderNames;
      ...
      if (!cookies) {
        ...
        if (cookie) {
          cookie = _mod12379.parseCookie(tmp21.cookie);
        }
        cookies = cookie;
      }
      if (!cookies) {
...
export const addNormalizedRequestDataToEvent = function addNormalizedRequestDataToEvent(
  ...
  if (obj.request) {
    ...
    if (obj2.includes("cookies")) {
      ...
      if (!cookies) {
        ...
        if (obj4.cookie) {
          parseCookieResult = _mod12379.parseCookie(obj4.cookie);
        }
  ...
  if (obj.ip) {
    ...
    if (ipAddress) {
      ipAddress = _mod12378.getClientIPAddress(normalizedRequest.headers);
    }
    if (!ipAddress) {
...
export const addRequestDataToEvent = function addRequestDataToEvent(request, request, include) {
  ...
  if (obj.ip) {
    ...
    if (ip) {
      ip = _mod12378.getClientIPAddress(request.headers);
    }
    if (!ip) {
      ip = request.ip;
    }
...
export const httpRequestToRequestData = function httpRequestToRequestData(headers) {
  ...
  return _mod12301.dropUndefinedKeys(request);
};
