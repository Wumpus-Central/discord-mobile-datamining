// _runtime/05272_FILE_TYPES_REQUIRED_ADDITIONAL_CHECK.js
import AudioTypes from "05279_AudioTypes.js";
import ImageTypes from "05280_ImageTypes.js";
import VideoTypes from "05281_VideoTypes.js";
import CompressedTypes from "05282_CompressedTypes.js";
import OtherTypes from "05283_OtherTypes.js";
      ...
      if (
        ...
        if (!mapped.includes("heic")) {
          ...
          if (!FileTypes(5273).isFLV(fileChunk)) {
            let str8 = "mp4";
            if (FileTypes(5273).isM4V(fileChunk)) {
              str8 = "mp4";
              if (!FileTypes(5273).isHEIC(fileChunk)) {
                str8 = "m4v";
              }
            }
            str6 = str8;
        ...
        if ("mkv" !== result) {
          let str4;
          if ("webm" === result) {
            if (FileTypes(5273).isWEBM(fileChunk)) {
              str4 = "webm";
            }
          }
          str2 = str4;
