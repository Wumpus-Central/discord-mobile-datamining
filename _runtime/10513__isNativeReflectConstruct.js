...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp("(?:les?|la|l'|du|des?)\\s*(" + FRTimeUnitAgoFormatParser(10508).NUMBER_PATTERN + ")?(?:\\s*(prochaine?s?|derni[e\u00E8]re?s?|pass[\u00E9e]e?s?|pr[\u00E9e]c[\u00E9e]dents?|suivante?s?))?\\s*(" + FRTimeUnitAgoFormatParser(10446).matchAnyPattern(FRTimeUnitAgoFormatParser(10508).TIME_UNIT_DICTIONARY) + ")(?:\\s*(prochaine?s?|derni[e\u00E8]re?s?|pass[\u00E9e]e?s?|pr[\u00E9e]c[\u00E9e]dents?|suivante?s?))?", "i");
      return regExp;
    }
  },
  {
    ...
    value: function innerExtract(reference) {
      let num = 1;
      if (arg1[1]) {
        num = FRTimeUnitAgoFormatParser(10508).parseNumberPattern(arg1[1]);
      }
      const obj = {};
      obj[FRTimeUnitAgoFormatParser(10508).TIME_UNIT_DICTIONARY[arg1[3].toLowerCase(arg1[3])]] = num;
