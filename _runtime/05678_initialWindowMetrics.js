// _runtime/05678_initialWindowMetrics.js
import _mod1614 from "metro/01614__.js";
import useFrameSize from "05655_useFrameSize.js";
...
if (null == require("metro/01614__.js").initialWindowMetrics) {
  ...
  initialWindowMetrics = require("metro/01614__.js").initialWindowMetrics;
}
class SafeAreaProviderCompat {
  constructor(arg0) {
    ({ children, style } = global);
    closure_2 = undefined;
    closure_2 = closure_2.useContext(require("metro/01614__.js").SafeAreaInsetsContext);
    obj = {
