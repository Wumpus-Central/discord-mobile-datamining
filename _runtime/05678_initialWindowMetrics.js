// === Module 5678: initialWindowMetrics ===

// Module 5678 (initialWindowMetrics)
import _mod1614 from "module_1614" /* 1614 */;
import useFrameSize from "useFrameSize" /* 5655 */;
...
if (null == require("module_1614").initialWindowMetrics) {
  ...
  initialWindowMetrics = require("module_1614").initialWindowMetrics;
}
class SafeAreaProviderCompat {
  constructor(arg0) {
    ({ children, style } = global);
    closure_2 = undefined;
    closure_2 = closure_2.useContext(require("module_1614").SafeAreaInsetsContext);
    obj = {
