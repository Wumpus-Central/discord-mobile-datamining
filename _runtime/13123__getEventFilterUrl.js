// _runtime/13123__getEventFilterUrl.js
...
function _getEventFilterUrl(arg0) {
  try {
    ...
    if (_mod13076.DEBUG_BUILD) {
      ...
      logger.error("Cannot extract url for event " + _mod13059.getEventDescription(tmp));
      const tmp6Result = _mod13059;
    }
    return null;
  }
}
        ...
        if (_mod13076.DEBUG_BUILD) {
          ...
          logger5.warn(
            "Event dropped due to being matched by `ignoreErrors` option.\nEvent: " +
              _mod13059.getEventDescription(type),
          );
          flag6 = true;
        }
      } else {
