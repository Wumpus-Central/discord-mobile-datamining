// _runtime/05452_decodeXPValue.js
...
obj[255] = {
  ...
  description(arg0) {
    return (
      { 0: "Full-resolution image", 1: "Reduced-resolution image", 2: "Single page of multi-page image" }[arg0] ||
      "Unknown"
    );
  },
};
obj[263] = {
  ...
  description(arg0) {
    return (
      { 1: "No dithering or halftoning", 2: "Ordered dither or halfton", 3: "Randomized dither" }[arg0] || "Unknown"
    );
  },
};
obj[266] = {
...
obj[282] = { name: "XResolution", description: fn(5453).XResolution };
const obj2 = { name: "XResolution", description: fn(5453).XResolution };
obj[283] = { name: "YResolution", description: fn(5453).YResolution };
obj[286] = {
  name: "XPosition",
  description(arg0) {
...
const obj3 = { name: "YResolution", description: fn(5453).YResolution };
obj[296] = { name: "ResolutionUnit", description: fn(5453).ResolutionUnit };
obj[318] = {
  name: "WhitePoint",
  description(arr) {
...
const obj4 = { name: "ResolutionUnit", description: fn(5453).ResolutionUnit };
obj[50778] = { name: "CalibrationIlluminant1", description: fn(5453).LightSource };
const obj5 = { name: "CalibrationIlluminant1", description: fn(5453).LightSource };
obj[50779] = { name: "CalibrationIlluminant2", description: fn(5453).LightSource };
obj[50941] = {
