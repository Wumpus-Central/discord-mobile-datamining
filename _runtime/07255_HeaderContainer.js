// _runtime/07255_HeaderContainer.js
import Link from "01485_Link.js";
import _mod5850 from "metro/05850__.js";
        ...
        if (options.headerMode === tmp) {
          if (tmp3) {
            ...
            if (tmp8) {
              ...
              if (tmp8) {
                const obj2 = {
                  title: require("metro/05850__.js").getHeaderTitle(tmp11, route.name),
                  href: buildHref(route.name, route.params),
                };
                tmp9 = obj2;
                const obj3 = require("metro/05850__.js");
              }
              tmp10 = tmp9;
            }
                ...
                if ("vertical" !== gestureDirection) {
                  if ("vertical-inverted" !== gestureDirection) {
                    if ("horizontal-inverted" === gestureDirection) {
                      let forSlideUp = require("metro/07256__.js").forSlideRight;
                    } else {
                      forSlideUp = require("metro/07256__.js").forSlideLeft;
                    }
                  }
                }
                forSlideUp = require("metro/07256__.js").forSlideUp;
              }
            } else {
              forNoAnimation = require("metro/07256__.js").forNoAnimation;
            }
