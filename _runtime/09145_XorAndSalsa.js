// _runtime/09145_XorAndSalsa.js
import _asyncLoop from "09146__asyncLoop.js";
import number from "09147_number.js";
import pbkdf2Init from "09149_pbkdf2Init.js";
import _mod9151 from "metro/09151__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod9151.sha256, B, B, obj);
...
function scryptOutput(B, dkLen, arr, arr2, arr3) {
  ...
  arr2.fill(0);
  arr3.fill(0);
  return pbkdf2Init.pbkdf2(_mod9151.sha256, B, arr, { c: 1, dkLen });
}
...
export const scrypt = function scrypt(B, B, arg2) {
  ...
  V.fill(0);
  tmp2.fill(0);
  return pbkdf2Init.pbkdf2(_mod9151.sha256, B, B, { c: 1, dkLen: tmp.dkLen });
};
