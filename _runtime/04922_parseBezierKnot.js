// _runtime/04922_parseBezierKnot.js
...
obj = {
  ...
  path(dataView, sum) {
    const items = [04899__.getShortAt(dataView, sum)];
    return items;
  }
};
let closure_4 = {
  ...
  [obj.CLIPBOARD]: {
    ...
    path: function parseClipboard(dataView, sum) {
      const longAt = 04899__.getLongAt(dataView, sum);
      let num = -1;
      let num2 = -1;
      if (longAt >>> 31 === 0) {
        num2 = 1;
      ...
      const longAt3 = 04899__.getLongAt(dataView, sum2);
      let num5 = num;
      if (longAt3 >>> 31 === 0) {
        num5 = 1;
      }
      const tmpResult1 = 04899__;
      ...
      const longAt4 = 04899__.getLongAt(dataView, sum3);
      if (longAt4 >>> 31 === 0) {
        num = 1;
      }
      const tmpResult2 = 04899__;
