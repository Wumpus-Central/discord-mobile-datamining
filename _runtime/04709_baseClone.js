// _runtime/04709_baseClone.js
import assignValue from "04718_assignValue.js";
  ...
  if (!fn) {
    {
      if (require("metro/00521__.js")(arr)) {
        ...
        if (tmp10) {
          const tmp18 = tmp32(4710)(arr);
          closure_4 = tmp18;
          let tmp14 = tmp18;
          if (!tmp) {
            return tmp32(4711)(arr, tmp18);
          }
        } else {
          ...
          if (tmp32(536)(arr)) {
            return tmp32(4712)(arr, tmp);
          } else {
            if (tmp11 != "[object Object]") {
              if (tmp11 != "[object Arguments]") {
                if (closure_2[tmp11]) {
                  tmp14 = tmp32(4726)(arr, tmp11, tmp);
                  closure_4 = tmp14;
                } else {
                  obj = arr;
                  if (!arr) {
