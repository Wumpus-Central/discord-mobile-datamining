// _runtime/06643_useScrollable.js
...
export const useScrollable = () => {
  ...
  const sharedValue = obj.useSharedValue(require("06628_GESTURE_SOURCE.js").SCROLLABLE_TYPE.UNDETERMINED);
  const sharedValue1 = require("01636_cancelAnimation.js").useSharedValue(0);
  const obj2 = cancelAnimation;
  const sharedValue2 = require("01636_cancelAnimation.js").useSharedValue(
    require("06628_GESTURE_SOURCE.js").SCROLLABLE_STATE.UNDETERMINED,
  );
  const obj3 = cancelAnimation;
  const sharedValue3 = require("01636_cancelAnimation.js").useSharedValue(false);
