// _runtime/05078_parseBezierKnot.js
import getDataView from "05038_getDataView.js";
import _modDef5055 from "metro/05055__.js";
...
function parseBezierKnot(dataView) {
  ...
  do {
    ...
    tmp6Result = tmp6(5038);
    let text1 = `${str3.toString(2)}.`;
    let tmp6Result1 = tmp6(5038);
...
obj = {
  ...
  path(dataView, sum) {
    const items = [_modDef5055.getShortAt(dataView, sum)];
    return items;
  }
};
let closure_4 = {
  ...
  [obj.CLIPBOARD]: {
    ...
    path: function parseClipboard(dataView, sum) {
      const longAt = _modDef5055.getLongAt(dataView, sum);
      let num = -1;
      let num2 = -1;
      if (longAt >>> 31 === 0) {
        num2 = 1;
      }
      const obj = _modDef5055;
      ...
      let tmp4Result = tmp4(5038);
      const obj4 = getDataView;
      tmp4Result = tmp4(5038);
      ...
      const longAt3 = _modDef5055.getLongAt(dataView, sum2);
      let num5 = num;
      if (longAt3 >>> 31 === 0) {
        num5 = 1;
      }
      const tmpResult1 = _modDef5055;
      ...
      const longAt4 = _modDef5055.getLongAt(dataView, sum3);
      if (longAt4 >>> 31 === 0) {
        num = 1;
      }
      const tmpResult2 = _modDef5055;
