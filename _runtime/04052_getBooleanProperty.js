// _runtime/04052_getBooleanProperty.js
...
export const useRiveBoolean = function useRiveBoolean(reducedMotion, instance) {
  ...
  [tmp3, tmp4, tmp5] = callback(require("04049_useRiveProperty.js") /* useRiveProperty */.useRiveProperty(instance, reducedMotion, getBooleanProperty), 3);
  if (cResult[0] === tmp5) {
    if (cResult[1] === tmp4) {
      if (cResult[2] === tmp3) {
        let tmp6 = cResult[3];
