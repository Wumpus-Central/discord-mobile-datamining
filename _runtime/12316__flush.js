...
export const withMonitor = function withMonitor(monitorSlug) {
  ...
  let currentScope = require("12295_getClient.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = getClient;
  let client = require("12295_getClient.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = getClient;
  captureCheckInResult = require("12279_addContextToFrame.js").uuid4();
};