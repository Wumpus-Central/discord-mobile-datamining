...
let items = [
  entry,
  {
    ...
    value: function assert(arg0, arg1, PbLong) {
      if (!arg0) {
        const typeofJsonValueResult = ReflectionJsonReader(1188).typeofJsonValue(PbLong);
          ...
          if ("map" == obj.kind) {
            if (null === tmp9) {
              ...
              for (const item10165 of entries1) {
                ...
                let str3 = self.scalar(first, obj.K, ReflectionJsonReader(1200).LongType.STRING, obj.name);
  ...
  },
  {
    ...
    value: function _enum(arg0, str, arg2, arg3) {
      ...
      if ("google.protobuf.NullValue" == arg0[0]) {
        const _HermesInternal = HermesInternal;
        ReflectionJsonReader(1196).assert(null === " only accepts null.", "Unable to parse field " + self.info.typeName + "#" + arg2 + ", enum " + arg0[0] + " only accepts null.");
      ...
      if (null === str) {
        ...
        const obj2 = ReflectionJsonReader(1196);
      }
    }
  },
  {
    ...
    value: function scalar(flag, arg1, STRING, arg3) {
      try {
        if (ReflectionJsonReader(1200).ScalarType.DOUBLE !== arg1) {
          if (ReflectionJsonReader(1200).ScalarType.FLOAT !== arg1) {
            if (ReflectionJsonReader(1200).ScalarType.INT32 !== arg1) {
              if (ReflectionJsonReader(1200).ScalarType.FIXED32 !== arg1) {
                if (ReflectionJsonReader(1200).ScalarType.SFIXED32 !== arg1) {
                  if (ReflectionJsonReader(1200).ScalarType.SINT32 !== arg1) {
                    if (ReflectionJsonReader(1200).ScalarType.UINT32 !== arg1) {
                      if (ReflectionJsonReader(1200).ScalarType.INT64 !== arg1) {
                        if (ReflectionJsonReader(1200).ScalarType.SFIXED64 !== arg1) {
                          if (ReflectionJsonReader(1200).ScalarType.SINT64 !== arg1) {
                            if (ReflectionJsonReader(1200).ScalarType.FIXED64 !== arg1) {
                              if (ReflectionJsonReader(1200).ScalarType.UINT64 !== arg1) {
                                if (ReflectionJsonReader(1200).ScalarType.BOOL === arg1) {
                                  if (null === flag) {
                                    return false;
                                  } else if (typeof flag === "boolean") {
                                    return flag;
                                  }
                                } else if (ReflectionJsonReader(1200).ScalarType.STRING === arg1) {
                                  if (null === flag) {
                                    return "";
                                ...
                                } else if (ReflectionJsonReader(1200).ScalarType.BYTES === arg1) {
                                  if (null !== flag) {
                                    if ("" !== flag) {
                                      if (typeof flag === "string") {
                                        return ReflectionJsonReader(1189).base64decode(flag);
                                      }
                                    }
                                  }
                            ...
                            if (null === flag) {
                              return ReflectionJsonReader(1205).reflectionLongConvert(ReflectionJsonReader(1194).PbULong.ZERO, STRING);
                            } else {
                              const PbULong = ReflectionJsonReader(1194).PbULong;
                              return ReflectionJsonReader(1205).reflectionLongConvert(PbULong.from(flag), STRING);
                            }
                          }
                        }
                      }
                      if (null === flag) {
                        return ReflectionJsonReader(1205).reflectionLongConvert(ReflectionJsonReader(1194).PbLong.ZERO, STRING);
                      } else {
                        const PbLong = ReflectionJsonReader(1194).PbLong;
                        return ReflectionJsonReader(1205).reflectionLongConvert(PbLong.from(flag), STRING);
                      }
                    }
                  }
                }
            ...
            if (null === flag) {
              ...
              if (undefined !== NumberResult) {
                if (arg1 == ReflectionJsonReader(1200).ScalarType.UINT32) {
                  ReflectionJsonReader(1196).assertUInt32(NumberResult);
                  const tmp3Result12 = ReflectionJsonReader(1196);
                } else {
                  ReflectionJsonReader(1196).assertInt32(NumberResult);
                  const tmp3Result13 = ReflectionJsonReader(1196);
                }
                return NumberResult;
              }
            }
          ...
          if (typeof flag === "string") {
            ...
            if (Number.isNaN(NumberResult1)) {
              ...
              if (Number.isFinite(tmp26)) {
                if (arg1 == ReflectionJsonReader(1200).ScalarType.FLOAT) {
                  ReflectionJsonReader(1196).assertFloat32(tmp26);
                  const tmp3Result14 = ReflectionJsonReader(1196);
                }
