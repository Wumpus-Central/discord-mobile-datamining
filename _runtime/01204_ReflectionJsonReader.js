// _runtime/01204_ReflectionJsonReader.js
  ...
  },
  {
    ...
    value: function _enum(arg0, str, arg2, arg3) {
      ...
      if ("google.protobuf.NullValue" == arg0[0]) {
        const _HermesInternal = HermesInternal;
        ReflectionJsonReader(1196).assert(
                ...
                if (ReflectionJsonReader(1200).ScalarType.SFIXED32 !== arg1) {
                  if (ReflectionJsonReader(1200).ScalarType.SINT32 !== arg1) {
                    if (ReflectionJsonReader(1200).ScalarType.UINT32 !== arg1) {
                      if (ReflectionJsonReader(1200).ScalarType.INT64 !== arg1) {
                        if (ReflectionJsonReader(1200).ScalarType.SFIXED64 !== arg1) {
                          if (ReflectionJsonReader(1200).ScalarType.SINT64 !== arg1) {
                            ...
                            if (null === flag) {
                              return ReflectionJsonReader(1205).reflectionLongConvert(
                                ReflectionJsonReader(1194).PbULong.ZERO,
                                STRING,
                              );
                            } else {
                      ...
                      if (null === flag) {
                        return ReflectionJsonReader(1205).reflectionLongConvert(
                          ReflectionJsonReader(1194).PbLong.ZERO,
                          STRING,
                        );
                      } else {
