// === Module 8200: _isNativeReflectConstruct ===
...
let items = [
  {
    ...
    value: function render() {
      ...
      let num2 = NaN;
      if (null != opacity) {
        num2 = importDefault(8202)(opacity);
      }
      obj = {};
      let flag = false;
      if (!isNaN(num2)) {
      ...
      importDefault(8203)(tmp, tmp, this);
      ...
      if (transform) {
        ...
        tmp.transform = self(8204).extractTransformSvgView(tmp);
        const obj3 = self(8204);
      }
      obj = {};
      ...
      const merged4 = Object.assign(tmp21(8209)({ viewBox, preserveAspectRatio }));
      obj.children = jsx(importDefault(8210), { children, style: merged2, font, fill, fillOpacity, fillRule, stroke, strokeWidth, strokeOpacity, strokeDasharray, strokeDashoffset, strokeLinecap, strokeLinejoin, strokeMiterlimit, onLayout });
      return jsx(importDefault(8208), {});
    }
  }
];
