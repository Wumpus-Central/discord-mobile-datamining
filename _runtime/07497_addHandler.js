// _runtime/07497_addHandler.js
import { __SENTRY_DEBUG__ } from "metro/07498___SENTRY_DEBUG__.js";
const require = arg1;
  ...
  if (tmp8) {
    ...
    if (iter !== undefined) {
      try {
        ...
        if (__SENTRY_DEBUG__.DEBUG_BUILD) {
          const logger = tmp19(7499).logger;
          logger.error(tmp2 + tmp6 + tmp3 + tmp19(7502).getFunctionName(tmp7) + tmp4, tmp18);
          const tmp19Result = tmp19(7502);
        }
      }
    }
