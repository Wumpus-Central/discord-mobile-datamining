...
import _modDef439 from "metro/00439__.js";
...
export const createVirtualCollectionView = function createVirtualCollectionView(arg0, initial) {
      ...
      onModeChange(mode) {
        if (mode.mode !== defaultHiddenStyle.VirtualViewMode.Hidden) {
          ...
          obj.SpacerView = React.forwardRef(function SpacerView_withRef(itemCount, ref) {
            ...
            return closure_1_8(
              closure_1_6(() => virtualItemCount(closure_2[3]).createHiddenVirtualView(spacerStyle(itemCount)), items),
              { ref },
            );
          });
          closure_2(obj);
  ...
  return function VirtualCollectionView(children) {
    ...
    const merged = Object.assign(
      children,
      Object.assign({ children: 0, items: 0, itemToKey: 0, removeClippedSubviews: 0, testID: 0 }),
    );
