// _runtime/05334_ButtonLink.js
import "noop";
import get_ActivityIndicator from "get ActivityIndicator";
import { jsx } from "jsxProd";
import { createStandardNavigationFactories } from "01500_createStandardNavigationFactories.js";
import { Color } from "05326_Color.js";
import { Animated } from "05335_Animated.js";
import { Text } from "05336_Text.js";
...
function ButtonBase(variant) {
  ...
  if ("plain" === str) {
    ...
    let str4 = "white";
    if (!obj10.isDark()) {
      const obj2 = tmp9(5326)(color);
      str4 = tmp9(5326)(color).darken(0.71).string();
      const darkenResult = tmp9(5326)(color).darken(0.71);
    }
    tmp5 = str4;
    str3 = color;
    obj10 = Color(color);
