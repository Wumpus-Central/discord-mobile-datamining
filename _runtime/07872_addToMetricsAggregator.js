// _runtime/07872_addToMetricsAggregator.js
import errorCallback from "07772_errorCallback.js";
import _mod7873 from "metro/07873__.js";
...
function addToMetricsAggregator(arg0, SET_METRIC_TYPE, arg2, arg3, arg4) {
  ...
  if (!client) {
    client = require("07803_getClient.js").getClient();
    const obj2 = getClient;
  }
  if (client) {
    const activeSpan = require("07781_spanTimeInputToSeconds.js").getActiveSpan();
    let rootSpan;
    if (activeSpan) {
    ...
    const globalSingleton = require("07777_getGlobalSingleton.js").getGlobalSingleton("globalMetricsAggregators", () => {
...
export const metrics = {
  ...
  timing(arg0, arg1, fn) {
    ...
    if (typeof fn === "function") {
      ...
      return require("07810_createChildOrRootSpan.js").startSpanManual(obj, (arg0) => {
        const callback = arg0;
      ...
      obj.unit = str;
      const DISTRIBUTION_METRIC_TYPE = require("metro/07873__.js").DISTRIBUTION_METRIC_TYPE;
      let parsed = fn;
      if (typeof fn === "string") {
