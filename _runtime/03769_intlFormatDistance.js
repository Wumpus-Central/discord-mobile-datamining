// _runtime/03769_intlFormatDistance.js
import keys from "03655_keys.js";
import differenceInCalendarDays from "03638_differenceInCalendarDays.js";
import differenceInCalendarMonths from "03662_differenceInCalendarMonths.js";
import differenceInCalendarQuarters from "03663_differenceInCalendarQuarters.js";
import differenceInCalendarWeeks from "03665_differenceInCalendarWeeks.js";
import differenceInCalendarYears from "03666_differenceInCalendarYears.js";
import differenceInHours from "03668_differenceInHours.js";
import differenceInMinutes from "03673_differenceInMinutes.js";
import differenceInSeconds from "03679_differenceInSeconds.js";
...
export default function intlFormatDistance(arg0, arg1, unit) {
  ...
  if (absolute < keys.secondsInMinute) {
    ...
    if (absolute1 < tmp6(3655).secondsInHour) {
      num2 = differenceInMinutes.default(defaultResult1, defaultResult2);
      str = "minute";
    } else {
      const _Math7 = Math;
      const absolute2 = Math.abs(defaultResult3);
      if (absolute2 < tmp6(3655).secondsInDay) {
        const _Math = Math;
      ...
      if (absolute3 < tmp6(3655).secondsInWeek) {
        num2 = differenceInCalendarDays.default(defaultResult1, defaultResult2);
        if (num2) {
          const _Math3 = Math;
          str = "day";
      ...
      if (absolute4 < tmp6(3655).secondsInMonth) {
        num2 = differenceInCalendarWeeks.default(defaultResult1, defaultResult2);
        str = "week";
      } else {
        const _Math8 = Math;
        const absolute5 = Math.abs(defaultResult3);
        if (absolute5 < tmp6(3655).secondsInQuarter) {
          num2 = differenceInCalendarMonths.default(defaultResult1, defaultResult2);
          str = "month";
        } else {
          const _Math5 = Math;
          const absolute6 = Math.abs(defaultResult3);
          if (absolute6 < tmp6(3655).secondsInYear) {
