// _runtime/07074_CardContainer.js
import Link from "01484_Link.js";
import _mod5681 from "metro/05681__.js";
import ModalPresentationContext from "07064_ModalPresentationContext.js";
import _mod7075 from "metro/07075__.js";
import CardA11yWrapper from "07076_CardA11yWrapper.js";
...
export const CardContainer = noop.memo(function CardContainerInner(active) {
  ...
  if (previousScene) {
    ...
    headerTitle = _mod5681.getHeaderTitle(options, route.name);
    href = tmp2Result1.useLinkBuilder().buildHref(route.name, route.params);
    tmp8 = href;
    tmp9 = headerTitle;
    const tmp2Result2 = _mod5681;
  }
  closure_15 = tmp12;
  ...
  obj8.children = React4(_mod5681.HeaderHeightContext.Provider, obj9);
  obj7.children = React4(_mod5681.HeaderShownContext.Provider, obj8);
  obj6.children = React4(_mod5681.HeaderBackContext.Provider, obj7);
  ...
  obj.children = React4(_mod7077.Card, obj1);
