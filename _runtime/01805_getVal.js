...
function internalInterpolate(arg0, arg1, extrapolateLeft) {
  ...
  if (rightEdgeInput - leftEdgeInput == 0) {
    ...
    let tmp10 = arg0;
    const sum =
      leftEdgeOutput + ((arg0 - leftEdgeInput) / (rightEdgeInput - leftEdgeInput)) * (rightEdgeOutput - leftEdgeOutput);
    let num = -1;
