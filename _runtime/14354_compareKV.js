...
function canonicalizeUnicodeLanguageId(lang) {
  ...
  if (lang.variants.length) {
    ...
    if (0 < variants.length) {
      ...
      const result = _mod14356.parseUnicodeLanguageId(str.split(_mod14356.SEPARATOR));
  ...
  if (tmp.script) {
    ...
    if (tmp.region) {
      ...
      if (str2) {
        ...
        const result1 = _mod14356.parseUnicodeLanguageId(str2.split(_mod14356.SEPARATOR));
  ...
  if (tmp9.region) {
    ...
    if (str3) {
      ...
      const result2 = _mod14356.parseUnicodeLanguageId(str3.split(_mod14356.SEPARATOR));
  ...
  if (str4) {
    ...
    const result3 = _mod14356.parseUnicodeLanguageId(str4.split(_mod14356.SEPARATOR));
  ...
  if (tmp19.region) {
    ...
    if (str6) {
      ...
      tmp22 = first;
      if (str8) {
        const region = _mod14356.parseUnicodeLanguageId(str8.split(_mod14356.SEPARATOR)).region;
        let tmp24 = region;
        if (region) {
  ...
  if (tmp19.variants.length) {
    for (let num7 = 0; num7 < tmp19.variants.length; num7 = num7 + 1) {
      ...
      if (languageAlias.variantAlias[formatted2]) {
        ...
        if (_mod14356.isUnicodeVariantSubtag(tmp30)) {
          tmp19.variants[num7] = tmp30;
        } else if (_mod14356.isUnicodeLanguageSubtag(tmp30)) {
          tmp19.lang = tmp30;
        }
      }
    }
