// _runtime/01684_runOnRuntime.js
...
export const createWorkletRuntime = function createWorkletRuntime(arg0, initializer) {
  ...
  const ReanimatedModule = __reanimatedLoggerConfig(1642).ReanimatedModule;
  let obj = __reanimatedLoggerConfig(1664);
  const fn = function l() {
  ...
  obj = { registerReanimatedError: __reanimatedLoggerConfig(1645).registerReanimatedError, registerLoggerConfig: __reanimatedLoggerConfig(1638).registerLoggerConfig, config: globalThis.__reanimatedLoggerConfig, setupCallGuard: __reanimatedLoggerConfig(1636).setupCallGuard, setupConsole: __reanimatedLoggerConfig(1636).setupConsole, initializer };
  fn.__closure = obj;
