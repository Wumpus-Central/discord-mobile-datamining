...
export const instrumentMessageStream = function instrumentMessageStream(applyResult, arg1, flag) {
  let closure_0 = arg1;
  let closure_1 = flag;
  let obj = { responseTexts: [], finishReasons: [], responseId: "", responseModel: "", promptTokens: "r", completionTokens: "View", cacheCreationInputTokens: "__packager_asset", cacheReadInputTokens: "ml", toolCalls: "<string:1081435070>", activeToolBlocks: "<string:3456778499>" };
  obj[8] = [];
  obj[9] = {};
