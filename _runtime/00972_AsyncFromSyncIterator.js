...
export const instrumentMessageStream = function instrumentMessageStream(applyResult, arg1, flag) {
  let closure_0 = arg1;
  let closure_1 = flag;
  let obj = { responseTexts: [], finishReasons: [], responseId: "", responseModel: "", promptTokens: "r", completionTokens: "View", cacheCreationInputTokens: "lj", cacheReadInputTokens: "jsxs", toolCalls: "<string:1081803952>", activeToolBlocks: "<string:3161076227>" };
  obj[8] = [];
  obj[9] = {};
