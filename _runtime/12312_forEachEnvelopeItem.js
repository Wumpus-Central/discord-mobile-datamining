// _runtime/12312_forEachEnvelopeItem.js
import getGlobalSingleton from "12269_getGlobalSingleton.js";
import addNonEnumerableProperty from "12274_addNonEnumerableProperty.js";
import dsnFromString from "12315_dsnFromString.js";
import closure_2 from "metro/00032__slicedToArray.js";
import { normalize } from "12313_normalize.js";
...
export const createAttachmentEnvelopeItem = function createAttachmentEnvelopeItem(data) {
  if (typeof data.data === "string") {
    ...
    __SENTRY__ = __SENTRY__(12269).GLOBAL_OBJ.__SENTRY__;
...
export const parseEnvelope = function parseEnvelope(arr) {
  if (typeof arr !== "string") {
    ...
    let encodePolyfill = dependencyMap;
    if (!require("12269_getGlobalSingleton.js").GLOBAL_OBJ.__SENTRY__) {
      const _TextEncoder = TextEncoder;
      const textEncoder = new TextEncoder();
    ...
    if (typeof tmp8[1] !== "string") {
      ...
      if (!(tmp10 instanceof Uint8Array)) {
        try {
          ...
          json = _JSON3.stringify(require("12313_normalize.js").normalize(tmp3));
          const obj = normalize;
        }
      }
    }
