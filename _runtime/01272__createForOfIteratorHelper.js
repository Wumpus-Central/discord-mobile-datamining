// _runtime/01272__createForOfIteratorHelper.js
import _mod1274 from "metro/01274__.js";
import defaultOptions from "01320_defaultOptions.js";
import ResponseBase from "01321_ResponseBase.js";
import Emitter from "01322_Emitter.js";
import RequestBase from "01323_RequestBase.js";
import _mod1324 from "metro/01324__.js";
import _createForOfIteratorHelper_mod from "metro/01273__.js";
      ...
      try {
        ...
        try {
          ...
          if (error) {
            ...
            error.status = status;
            self.callback(error, obj3);
          } else {
            self.callback(null, tmp8);
          }
        } catch (error) {
        }
      } catch (tmp29) {
...
if (0 < items.length) {
  do {
    str2 = items[num2];
    _mod1324.prototype[str2.toLowerCase()] = function(arg0, arg1) {
...
_mod1324.prototype.del = _mod1324.prototype.delete;
...
export const serialize = { "application/x-www-form-urlencoded": _mod1274.stringify, "application/json": defaultOptions };
export const parse = { "application/x-www-form-urlencoded": parseString, "application/json": JSON.parse };
export { Response };
export const agent = () => new str2(1324)();
