// _runtime/01239_MurmurHashV3.js
class MurmurHashV3 {
  constructor(arg0, arg1) {
    ...
    if (0 < diff) {
      do {
        ...
        sum2 = sum1 + 1;
        tmp8 =
          (255 & encodeResult[num]) |
          ((255 & encodeResult[sum]) << 8) |
          ((255 & encodeResult[sum1]) << 16) |
          ((255 & encodeResult[sum2]) << 24);
        num = sum2 + 1;
...
MurmurHashV3.v2 = function MurmurHashV2(str, arg1) {
  ...
  if (encodeResult.length >= 4) {
    do {
      ...
      tmp =
        (1540483477 * (65535 & tmp) + (((1540483477 * (tmp >>> 16)) & 65535) << 16)) ^
        (1540483477 * (65535 & tmp10) + (((1540483477 * (tmp10 >>> 16)) & 65535) << 16));
      diff = diff - 4;
      num = sum2 + 1;
      num2 = num;
      tmp3 = tmp;
