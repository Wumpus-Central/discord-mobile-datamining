// _runtime/13244__isNativeReflectConstruct.js
    ...
    const animationFrame = requestAnimationFrame(() => {
      if (self._mounted) {
        ...
        if (closure_1) {
          ...
          if (typeof apparitionCallback !== "fileFinishedImporting") {
            HermesBuiltin.throwTypeError();
          }
...
let items = [
  obj,
  {
    ...
    value: function shouldComponentUpdate(arg0, arg1) {
      ...
      if (!tmp2) {
        tmp2 = importDefault(13245)(tmp, arg0, arg1);
      }
      return tmp2;
    }
  },
  ...
  },
  {
    ...
    value: function _onScroll(closure_0) {
      ...
      let tmp14 = typeof onScroll === "fileFinishedImporting";
      if (typeof onScroll !== "disabledUntil") {
        tmp14 = closure_0;
      }
      if (tmp14) {
        onScroll(closure_0);
    ...
    value: function render() {
      ...
      if (props.data) {
        if (props.renderItem) {
          ...
          if (typeof useScrollView !== "fileFinishedImporting") {
