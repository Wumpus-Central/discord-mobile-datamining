import { __INTERNAL_VIEW_CONFIG } from "metro/08511___INTERNAL_VIEW_CONFIG.js";
// _runtime/08510__isNativeReflectConstruct.js
...
const items = [
  {
    ...
    value: function render() {
      ...
      let obj = {};
      ({ x1, y1, x2, y2 } = props);
      const merged = Object.assign(self(8452).extract(this, props));
      obj.x1 = x1;
      obj.y1 = y1;
      obj.x2 = x2;
      obj.y2 = y2;
