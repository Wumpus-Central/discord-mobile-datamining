// _runtime/13707_match.js
import { ResolveLocale } from "13708_ResolveLocale.js";
import { LookupSupportedLocales } from "13720_LookupSupportedLocales.js";
const require = arg1;
...
arg5.match = function match(arg0, arg1, arg2, algorithm) {
  const _require = arg2;
  const result = require("13719_CanonicalizeLocaleList.js").CanonicalizeLocaleList(arg0);
  let str;
  if (null != algorithm) {
  ...
  return require("13708_ResolveLocale.js").ResolveLocale(arg1, result, { localeMatcher: str }, [], {}, () => closure_0).locale;
};
let obj = {
  enumerable: true,
  get() {
