// _runtime/05867_useBoundDetection.js
...
export const useBoundDetection = function useBoundDetection(recyclerViewManager, arg1) {
  ...
  const _requestAnimationFrame = require("05864_useUnmountAwareTimeout.js").useUnmountAwareAnimationFrame().requestAnimationFrame;
  let num = 0;
