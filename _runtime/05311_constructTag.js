// _runtime/05311_constructTag.js
import _mod5264 from "metro/05264__.js";
import _modDef5267 from "metro/05267__.js";
import PNG_CHUNK_TYPE_SIZE from "05271_PNG_CHUNK_TYPE_SIZE.js";
import _modDef5283 from "metro/05283__.js";
import _modDef5295 from "metro/05295__.js";
...
function constructTag(decompressResult, type, items2, items1) {
  ...
  if (type !== PNG_CHUNK_TYPE_SIZE.TYPE_TEXT) {
    ...
    if (0 !== items2.length) {
      ...
      combined = "" + stringValueFromArray + " (" + _mod5264.getStringValueFromArray(items2) + ")";
  ...
  read(byteLength, arg1, arg2, arg3) {
    ...
    if (0 < arg1.length) {
      while (true) {
        ...
        let COMPRESSION_METHOD_NONE = require("metro/05264__.js").COMPRESSION_METHOD_NONE;
        ...
        let tmp38 = _require;
        if (tmp5 !== require("metro/05264__.js").COMPRESSION_METHOD_NONE) {
          if (!arg2) {
            obj = {};
