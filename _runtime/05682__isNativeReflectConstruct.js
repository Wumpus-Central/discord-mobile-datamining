// _runtime/05682__isNativeReflectConstruct.js
...
let items = [
  ...
  },
  {
    ...
    get() {
      ...
      if (tmp) {
        tmp = !ContinousBaseGesture(5666).isRemoteDebuggingEnabled();
        obj = ContinousBaseGesture(5666);
      }
      return tmp;
    },
  },
