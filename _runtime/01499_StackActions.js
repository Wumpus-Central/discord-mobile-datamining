// _runtime/01499_StackActions.js
import BaseRouter2 from "01493_BaseRouter.js";
import nanoid from "01494_nanoid.js";
import _mod1498 from "metro/01498__.js";
        ...
        if (-1 === index4) {
          ...
          if (routeNames5.includes(type.payload.name)) {
            ...
            if (found) {
              ...
              const paramsFromAction = _mod1498.createParamsFromAction(obj3);
              ...
              const tmp135Result = _mod1498;
            } else {
              const obj7 = { action: type, routeParamList };
              key = _mod1500.createRouteFromAction(obj7);
              const tmp135Result2 = _mod1500;
            }
            const obj9 = {};
                ...
                if (routeNames4.includes(type.payload.name)) {
                  ...
                  if (-1 === num3) {
                    ...
                    if (found1) {
                      ...
                      const paramsFromAction2 = _mod1498.createParamsFromAction(obj20);
                      ...
                      const tmp43Result = _mod1498;
                    } else {
                      const obj22 = { action: type, routeParamList };
                      routeFromAction = _mod1500.createRouteFromAction(obj22);
                      const tmp43Result2 = _mod1500;
                    }
