// _runtime/07512_callFrameToStackFrame.js
import { createStackParser } from "07397_createStackParser.js";
...
arg5.callFrameToStackFrame = function callFrameToStackFrame(location, str) {
  ...
  if (replaced) {
    filenameIsInAppResult = tmp4(7510).filenameIsInApp(replaced);
    const tmp4Result = tmp4(7510);
  }
