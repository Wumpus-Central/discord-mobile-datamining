// _runtime/01640_overrideLogFunctionImplementation.js
import runWorkletOnJS from "01645_runWorkletOnJS.js";
import _mod1649 from "metro/01649__.js";
import mockedRequestAnimationFrame from "01653_mockedRequestAnimationFrame.js";
import module_1641_mod from "metro/01641__.js";
import get_ActivityIndicator_mod from "metro/01642__.js";

let module_1641 = module_1641_mod;
let closure_3 = module_1641.isJest();
let module_1641 = module_1641_mod;
module_1641.shouldBeUseWeb();
let module_1641 = module_1641_mod;
module_1641 = module_1641.isChromeDebugger();
let __initData = {
...
function overrideLogFunctionImplementation() {
  ...
  fn.__closure = {
    ...
    logToLogBoxAndConsole: get_ActivityIndicator.logToLogBoxAndConsole,
  };
...
overrideLogFunctionImplementation.__closure = {
  replaceLoggerImplementation: get_ActivityIndicator.replaceLoggerImplementation,
  runOnJS: runWorkletOnJS.runOnJS,
  logToLogBoxAndConsole: get_ActivityIndicator.logToLogBoxAndConsole,
};
...
if (module_1641) {
  ...
  _module5.executeOnUIRuntimeSync(_mod1649.registerReanimatedError)();
...
setupCallGuard.__closure = {
  callGuardDEV,
  runOnJS: runWorkletOnJS.runOnJS,
  reportFatalErrorOnJS: _mod1649.reportFatalErrorOnJS,
};
...
function setupConsole() {
  if (!module_1641) {
    const console = {
      assert: runWorkletOnJS.runOnJS(fromEntriesResult.assert),
      debug: null,
      log: null,
      warn: null,
      error: null,
...
let obj4 = { callGuardDEV, runOnJS: runWorkletOnJS.runOnJS, reportFatalErrorOnJS: _mod1649.reportFatalErrorOnJS };
setupConsole.__closure = {
  IS_CHROME_DEBUGGER: module_1641,
  runOnJS: runWorkletOnJS.runOnJS,
...
let obj5 = { IS_CHROME_DEBUGGER: module_1641, runOnJS: runWorkletOnJS.runOnJS, capturableConsole: fromEntriesResult };
    ...
    if (ReanimatedModule) {
      ...
      const fn = function o() {
        if (typeof closure_8 === "function") {
          ...
          closure_10();
          if (!closure_4) {
            closure_1(1645).setupMicrotasks();
      ...
      let obj2 = {
        setupCallGuard,
        setupConsole,
        SHOULD_BE_USE_WEB: module_1641,
        setupMicrotasks: runWorkletOnJS.setupMicrotasks,
