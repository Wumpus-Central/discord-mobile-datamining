// === Module 1640: overrideLogFunctionImplementation ===

// Module 1640 (overrideLogFunctionImplementation)
import runWorkletOnJS from "runWorkletOnJS" /* 1645 */;
import _mod1649 from "module_1649" /* 1649 */;
import mockedRequestAnimationFrame from "mockedRequestAnimationFrame" /* 1653 */;
import module_1641_mod from "module_1641" /* 1641 */;
import get_ActivityIndicator_mod from "module_1642" /* 1642 */;
...
setupCallGuard.__closure = { callGuardDEV, runOnJS: runWorkletOnJS.runOnJS, reportFatalErrorOnJS: _mod1649.reportFatalErrorOnJS };
...
setupConsole.__closure = { IS_CHROME_DEBUGGER: module_1641, runOnJS: runWorkletOnJS.runOnJS, capturableConsole: fromEntriesResult };
...
export const initializeUIRuntime = function initializeUIRuntime(ReanimatedModule) {
  if (!obj.isWeb()) {
    if (ReanimatedModule) {
      ...
      let obj2 = { setupCallGuard, setupConsole, SHOULD_BE_USE_WEB: module_1641, setupMicrotasks: runWorkletOnJS.setupMicrotasks, setupRequestAnimationFrame };
      fn.__closure = obj2;
