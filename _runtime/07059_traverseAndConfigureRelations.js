// _runtime/07059_traverseAndConfigureRelations.js
...
function traverseAndConfigureRelations(gestures, map, set) {
  ...
  if (obj.isComposedGesture(gestures)) {
    ...
    gestures.gestureRelations = tmp(7052).prepareRelations(gestures.config, gestures.handlerTag);
