// _runtime/03772_format.js
import isValid from "03722_isValid.js";
import subMilliseconds from "03773_subMilliseconds.js";
import _typeof from "metro/03540__typeof.js";
import G from "03774_G.js";
import dateLongFormatter from "03785_dateLongFormatter.js";
import getTimezoneOffsetInMilliseconds from "03703_getTimezoneOffsetInMilliseconds.js";
import toInteger from "03544_toInteger.js";
import requiredArgs from "03541_requiredArgs.js";
import code from "03786_code.js";
...
export default function format(arg0, arg1, locale) {
  ...
  const defaultOptions = require("03545_getDefaultOptions.js").getDefaultOptions();
  locale = undefined;
  if (null != locale) {
              ...
              if (isValid.default(defaultResult3)) {
                ...
                const mapped1 = match1.map((arg0) => {
                  ...
                  if ("''" === arg0) {
                    ...
                    if (!tmp9) {
                      tmp9 = !callback(3787).isProtectedWeekYearToken(str);
                    }
                    if (!tmp9) {
                      const _String = String;
                      callback(3787).throwProtectedError(str, dependencyMap, String(callback));
                    }
                    let tmp18 = null != tmp7 && tmp7.useAdditionalDayOfYearTokens;
                    if (!tmp18) {
                      tmp18 = !callback(3787).isProtectedDayOfYearToken(str);
                    }
                    if (!tmp18) {
