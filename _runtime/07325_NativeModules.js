// _runtime/07325_NativeModules.js
...
export const getInstallSourceAndroid = () => {
  const InstallSourceAndroid = callback(7317).InstallSourceAndroid;
