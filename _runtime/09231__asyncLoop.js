...
export const randomBytes = function randomBytes() {
  ...
  if (Hash(9233).crypto) {
    if (typeof Hash(9233).crypto.getRandomValues === "function") {
      const _crypto2 = Hash(9233).crypto;
      const _Uint8Array = Uint8Array;
  ...
  if (Hash(9233).crypto) {
    if (typeof Hash(9233).crypto.randomBytes === "function") {
      const _crypto = Hash(9233).crypto;
