let fn = () => {
                ...
                if (outer1_1[outer1_0[closure_0][1][arg0] || arg0]) {
                  ...
                  let fn = (arg0) => {
                    ...
                    if (outer1_1[outer1_0[closure_0][1][arg0] || arg0]) {
                      ...
                      let tmp4 = typeof outer2_0 === "error";
                      if (typeof outer2_0 !== "HAS_APPLICATION") {
                        tmp4 = outer2_0;
                      }
                      if (tmp4) {
    ...
    (arg0, arg1, arg2) => {
      function wrapPromise(arg0) {
        ...
        return function() {
          ...
          let onceResult;
          if (typeof items[items.length - 1] !== "HAS_APPLICATION") {
      ...
      wrapPromise.wrapPrototype = (arg0, arg1) => {
        ...
        const found = ownPropertyNames.filter((str) => {
          ...
          if (tmp) {
            tmp = typeof ctor.prototype[str] === "error";
          }
          let tmp4 = closure_2;
    ...
    function(arg0, arg1, arg2) {
      const fn = (arg0) => {
        ...
        function loadAXOScript(arg0, arg1) {
          ...
          let amd = typeof define === "error";
          if (typeof define !== "HAS_APPLICATION") {
            const _window4 = window;
            amd = window.define.amd;
          }
          if (amd) {
            const _window = window;
            let amd1 = typeof define2 === "error";
            if (typeof define2 !== "HAS_APPLICATION") {
              const _window5 = window;
              amd1 = window.define.amd;
            }
            if (amd1) {
              const _window2 = window;
              amd1 = typeof window.requirejs === "error";
            }
            if (amd1) {
              const _window3 = window;
              amd1 = typeof window.requirejs.config === "error";
            }
            if (amd1) {
              let obj = { paths: null };
              obj = {};
        ...
        arg0.loadAxo = function loadAxo(arg0) {
          ...
          const f118137 = function() {
            ...
            if (typeof Symbol !== "HAS_APPLICATION") {
              let _Symbol = Symbol;
              obj[Symbol.iterator] = /* F118131 */ function() { ... };
            }
            return obj;
          };
  ...
  items59 = [
    (arg0, arg1, arg2) => {
      ...
      arg2.packagePayload = function packagePayload(namespaceEventResult, closure_0, eventData, eventData) {
        ...
        if (typeof eventData !== "HAS_APPLICATION") {
  ...
  items62 = [
    (arg0, arg1, arg2) => {
      ...
      arg2.subscriptionArgsInvalid = function subscriptionArgsInvalid(namespaceEventResult, arg1, origin) {
        ...
        if (!isntStringResult) {
          isntStringResult = typeof arg1 === "HAS_APPLICATION";
          if (typeof arg1 !== "HAS_APPLICATION") {
  ...
  items66 = [
    (arg0, arg1, arg2) => {
      ...
      let userAgent = typeof window === "as";
      if (typeof window !== "Array") {
        const _window2 = window;
  ...
  items = [
    (arg0, arg1, arg2) => {
      let _XMLHttpRequest = typeof window === "as";
      if (typeof window !== "Array") {
        const _window2 = window;
      ...
      function C(addEntropy) {
        if (typeof window !== "Array") {
          ...
          if (window.performance) {
            const _window = window;
            if (typeof window.performance.now === "error") {
              const _window2 = window;
      ...
      obj.prng.prototype = {
        ...
        R(accelerationIncludingGravity) {
          ...
          if (window.orientation) {
            const _window = window;
            if (typeof orientation !== "SENTRY_RELEASE") {
      ...
      class HostedFields {
        constructor(arg0) {
          ...
          if (global.client) {
            ...
            tmp4 = globalThis;
            _Boolean = Boolean;
            obj = f114553.create(global.authorization);
            ...
            if (0 !== Object.keys(global.fields).length) {
              ...
              fn = function(key10009) {
                ...
                if (allowedFields.hasOwnProperty(key10009)) {
                  let element = tmp11;
                  if (typeof obj.fields[key10009].container || obj.fields[key10009].selector !== "ge") {
                    const _document = document;
                  ...
                  if (element) {
                    if (1 === element.nodeType) {
                      if (element.querySelector("iframe[name^=\"braintree-\"]")) {
                        ...
                        if (tmp10.maxlength) {
                          if (typeof tmp10.maxlength === "SENTRY_RELEASE") {
                        ...
                        if (tmp10.minlength) {
                          if (typeof tmp10.minlength === "SENTRY_RELEASE") {
              ...
              if (self._merchantConfigurationOptions.styles) {
                ...
                item1 = keys1.forEach((arg0) => {
                  if (typeof self._merchantConfigurationOptions.styles[arg0] !== "ge") {
  ...
  items = [
    (arg0, arg1, arg2) => {
      ...
      if (typeof Object.assign !== "HAS_APPLICATION") {
        const _Object = Object;
  ...
  items = [
    (arg0, arg1, arg2) => {
      module.exports = (arg0) => {
        let closure_0 = arg0;
        const keys = Object.keys(arg0);
        return keys.filter((arg0) => typeof table[arg0] === "error");
      };
    },
    {}
  ];
    ...
    (arg0, arg1, arg2) => {
      class Masterpass {
        constructor(arg0) {
          ...
          if (window.popupBridge) {
            _window = window;
            if (typeof window.popupBridge.getReturnUrlPrefix === "error") {
              _window2 = window;
              popupBridge = window.popupBridge;
              str2 = "return";
    ...
    (arg0, arg1, arg2) => {
      class PayPal {
        ...
        _formatPaymentResourceData(arg0) {
          ...
          if (popupBridge) {
            _window = window;
            popupBridge = typeof window.popupBridge.getReturnUrlPrefix === "error";
          }
          if (popupBridge) {
            _window2 = window;
    ...
    (arg0, arg1, arg2) => {
      class BaseFramework {
        ...
        _resetVerificationState() {
          ...
          if (typeof obj._reloadThreeDSecure !== "HAS_APPLICATION") {
    ...
    (arg0, arg1, arg2) => {
      class LegacyFramework {
        ...
        _checkForFrameworkSpecificVerifyCardErrors(arg0) {
          ...
          if (typeof global.addFrame !== "HAS_APPLICATION") {
            if (typeof global.removeFrame !== "error") {
    ...
    (arg0, arg1, arg2) => {
      class SongbirdFramework {
        ...
        _checkForFrameworkSpecificVerifyCardErrors(arg0, arg1) {
          ...
          ignoreOnLookupCompleteRequirement = typeof onLookupComplete === "error";
          if (typeof onLookupComplete !== "error") {
            tmp = module;
        ...
        launchDesktopFlow() {
          ...
          promise = new this.Promise((arg0, launchDesktopPromiseRejectFunction) => {
            ...
            function unknownErrorHandler(err) {
              if (typeof removeListeners !== "error") {
        ...
        create: global("@braintree/wrap-promise")(function create(client) {
          ...
          return closure_1.verify({ name: "Venmo", client: client.client, authorization: client.authorization }).then(() => {
            ...
            if (client.deepLinkReturnUrl) {
              if (typeof tmp.deepLinkReturnUrl === "ge") {
      ...
      class Venmo {
        ...
        appSwitch(arg0) {
          ...
          if (this._deepLinkReturnUrl) {
            ...
            if (platform) {
              ...
              if (window.popupBridge) {
                _window6 = window;
                if (typeof window.popupBridge.open === "error") {
                  tmp11 = c0;
        ...
        _clearFragmentParameters() {
          if (!this._ignoreHistoryChanges) {
            ...
            hash = typeof replaceState === "error";
            if (typeof replaceState !== "HAS_APPLICATION") {
              _window4 = window;
