// _runtime/14566_ReanimatedNativeStackScreen.js
import _mod1614 from "metro/01614__.js";
import cancelAnimation2 from "01636_cancelAnimation.js";
import _modDef14567 from "metro/14567__.js";
import _modDef14568 from "metro/14568__.js";
...
const forwardRefResult = noop.forwardRef((children, ref) => {
  ...
  obj = {
    value: sharedValue,
    children: jsx(_modDef14567.Provider, {
      ref,
  ...
  obj.children = jsx(_modDef14568.Provider, {
    value: { progress: sharedValue1, closing: sharedValue2, goingForward: sharedValue3 },
    children: children.children,
  });
  return (
    <closure_7 value={sharedValue}>
      {jsx(_modDef14567.Provider, { ref, onTransitionProgressReanimated: null, onHeaderHeightChangeReanimated: null })}
    </closure_7>
  );
});
