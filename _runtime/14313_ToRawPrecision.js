// _runtime/14313_ToRawPrecision.js
import digitsToString2 from "14294_digitsToString.js";
import _mod14295 from "metro/14295__.js";
import TEN from "14297_TEN.js";
import ApplyUnsignedRoundingMode from "14307_ApplyUnsignedRoundingMode.js";
import e from "01160_e.js";
...
export const ToRawPrecision = function ToRawPrecision(
  ...
  let timesResult;
  if (ZERO.isZero()) {
    let repeatResult = _mod14295.repeat("0", maximumSignificantDigits);
  ...
  if (roundingMagnitude >= maximumSignificantDigits - 1) {
    let sum = repeatResult + tmp16(14295).repeat("0", roundingMagnitude - maximumSignificantDigits + 1);
    ...
    tmp16(14295).invariant(roundingMagnitude < 0, "e should be less than 0");
    sum = `0.${tmp16(14295).repeat("0", -num3 - 1)}${arr}`;
