// _runtime/08934__isNativeReflectConstruct.js
...
class Video {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f116844);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f116844);
    ...
    f116844 = undefined;
    f116844 = _isNativeReflectConstruct((arg0) => {
      let closure_0 = arg0;
      let c2 = 0;
      let c1 = 0;
...
let items1 = [require("module_8937").NONE, require("module_8937").INVERT, require("module_8937").MONOCHROME, require("module_8937").POSTERIZE, require("module_8937").FALSE, require("module_8937").MAXIMUMCOMPONENT, require("module_8937").MINIMUMCOMPONENT, require("module_8937").CHROME, require("module_8937").FADE, require("module_8937").INSTANT, require("module_8937").MONO, require("module_8937").NOIR, require("module_8937").PROCESS, require("module_8937").TONAL, require("module_8937").TRANSFER, require("module_8937").SEPIA];
...
const items4 = [require("module_8938").CLEARKEY, require("module_8938").FAIRPLAY, require("module_8938").WIDEVINE, require("module_8938").PLAYREADY];
...
const items8 = [require("module_8957").SRT, require("module_8957").TTML, require("module_8957").VTT];
...
export const TextTrackType = require("module_8957");
export const FilterType = require("module_8937");
export const DRMType = require("module_8938");