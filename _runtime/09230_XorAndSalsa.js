// _runtime/09230_XorAndSalsa.js
import _asyncLoop from "09231__asyncLoop.js";
import number from "09232_number.js";
import pbkdf2Init from "09234_pbkdf2Init.js";
import _mod9236 from "metro/09236__.js";
            ...
            if (dkLen >= 0) {
              if (dkLen <= 137438953440) {
                ...
                if (result1 > maxmem) {
                  ...
                  const pbkdf2Result = pbkdf2Init.pbkdf2(_mod9236.sha256, B, B, obj);
