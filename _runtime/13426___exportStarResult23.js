// _runtime/13426___exportStarResult23.js
import { CanonicalizeLocaleList } from "13390_CanonicalizeLocaleList.js";
import { __exportStarResult2 } from "13392___exportStarResult2.js";
import { getMultiInternalSlots } from "13395_getMultiInternalSlots.js";
import { __exportStarResult4 } from "13400___exportStarResult4.js";
import { match } from "13427_match.js";
const require = arg1;
...
arg5.InitializeNumberFormat = function InitializeNumberFormat(arg0, arg1, arg2, arg3) {
  ...
  const result2 = tmp(13441).SetNumberFormatUnitOptions(internalSlots, result1);
  ...
  if ("currency" === style) {
    if ("standard" === GetOptionResult1) {
      ...
      let num2 = tmp(13415).CurrencyDigits(internalSlots.currency, obj);
      let num3 = num2;
    }
    const result3 = tmp(13442).SetNumberFormatDigitOptions(internalSlots, result1, num3, num2, GetOptionResult1);
    let str6 = "auto";
    if ("compact" === GetOptionResult1) {
      internalSlots.compactDisplay = tmp(13400).GetOption(result1, "compactDisplay", "string", ["short", "long"], "short");
      str6 = "min2";
    }
    internalSlots.useGrouping = tmp(13402).GetStringOrBooleanOption(result1, "useGrouping", ["min2", "auto", "always"], "always", false, str6);
    internalSlots.signDisplay = tmp(13400).GetOption(result1, "signDisplay", "string", ["auto", "never", "always", "exceptZero", "negative"], "auto");
    return arg0;
  }
  num2 = 3;
  if ("percent" === style) {
