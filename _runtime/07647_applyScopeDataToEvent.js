// _runtime/07647_applyScopeDataToEvent.js
import addNonEnumerableProperty from "07603_addNonEnumerableProperty.js";
import merge from "07622_merge.js";
...
arg5.applyScopeDataToEvent = function applyScopeDataToEvent(extra) {
  ...
  if (span) {
    ...
    obj3[0] = tmp3(7602).spanToTraceContext(span);
    const merged8 = Object.assign(extra.contexts);
    extra.contexts = obj3;
    const obj4 = { dynamicSamplingContext: null };
    const tmp3Result2 = tmp3(7602);
    obj4[0] = tmp3(7633).getDynamicSamplingContextFromSpan(span);
    const merged9 = Object.assign(extra.sdkProcessingMetadata);
    extra.sdkProcessingMetadata = obj4;
    const tmp3Result3 = tmp3(7633);
    const rootSpan = tmp3(7602).getRootSpan(span);
    const tmp3Result4 = tmp3(7602);
    const description = tmp3(7602).spanToJSON(rootSpan).description;
