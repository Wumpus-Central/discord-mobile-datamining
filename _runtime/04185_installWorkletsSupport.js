// _runtime/04185_installWorkletsSupport.js
import _mod4186 from "../discord_app/modules/gesture_handlers/native/reactNativeWorkletsCompat.js";
import getInstalledNitro from "04190_getInstalledNitro.js";
...
arg5.installWorkletsSupport = function installWorkletsSupport() {
  try {
    ...
    obj[3] = fn3;
    const result = _mod4186.registerCustomSerializable(obj);
  } catch (err) {
  }
};