// _runtime/09857__isNativeReflectConstruct.js
import _asyncLoop from "09852__asyncLoop.js";
import _isNativeReflectConstruct2 from "09858__isNativeReflectConstruct.js";
  ...
  },
  {
    ...
    value: function process(getUint32, sum) {
      ...
      do {
        ...
        uint32Array2[num2] =
          ((rotrResult1 ^ SHA224(9852).rotr(tmp5, 19) ^ (tmp5 >>> 10)) +
            uint32Array2[num2 - 7] +
            tmp9 +
