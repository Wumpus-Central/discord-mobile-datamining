// _runtime/13758_FormatNumericToString.js
import TEN from "13744_TEN.js";

const _mod13742 = tmp5(13742);
const GetUnsignedRoundingMode = tmp5(13759);
const ToRawPrecision = tmp5(13760);
const ToRawFixed = tmp5(13761);
require = arg1;
  ...
  if (timesResult.isZero()) {
    ...
    if ("significantDigits" === roundingType) {
      ...
      if ("morePrecision" === roundingType.roundingType) {
        ...
        _mod13742.invariant("lessPrecision" === roundingType.roundingType, "Invalid roundingType");
    ...
    if (integerDigitsCount < minimumIntegerDigits) {
      sum = _mod13742.repeat("0", minimumIntegerDigits - integerDigitsCount) + substr;
    }
    if ("negative" !== str2) {
