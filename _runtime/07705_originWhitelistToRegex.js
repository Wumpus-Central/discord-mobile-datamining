// _runtime/07705_originWhitelistToRegex.js
import noop from "noop";
import "noop";
import get_ActivityIndicator from "get ActivityIndicator";
import jsxProd from "jsxProd";
import { 07706__ } from "metro/07706__.js";
...
function originWhitelistToRegex(arg0) {
  return "^".concat(07706__(arg0).replace(/\\\*/g, ".*"));
}
...
export const defaultRenderLoading = () => callback(closure_7, { style: require("07707_get_ActivityIndicator.js") /* get ActivityIndicator */.loadingOrErrorView, children: callback(closure_8, {}) });
export const defaultRenderError = (arg0, arg1, arg2) => {
  let obj = { style: require("07707_get_ActivityIndicator.js") /* get ActivityIndicator */.loadingOrErrorView, children: null };
  obj = { style: require("07707_get_ActivityIndicator.js") /* get ActivityIndicator */.errorTextTitle, children: "Error loading page" };
  const items = [callback(closure_9, obj), , , ];
  obj = { style: require("07707_get_ActivityIndicator.js") /* get ActivityIndicator */.errorText, children: "Domain: ".concat(arg0) };
  items[1] = callback(closure_9, obj);
  items[2] = callback(closure_9, { style: require("07707_get_ActivityIndicator.js") /* get ActivityIndicator */.errorText, children: "Error Code: ".concat(arg1) });
  const obj1 = { style: require("07707_get_ActivityIndicator.js") /* get ActivityIndicator */.errorText, children: "Error Code: ".concat(arg1) };
  items[3] = callback(closure_9, { style: require("07707_get_ActivityIndicator.js") /* get ActivityIndicator */.errorText, children: "Description: ".concat(arg2) });
  obj[1] = items;
