...
fn = function n(userConfig, callback) {
  ...
  let obj = { userConfig, isValidRubberBandConfig: _require(1730).isValidRubberBandConfig, rubberBandDecay: _require(1731).rubberBandDecay, rigidDecay: _require(1732).rigidDecay, validateConfig, callback, getReduceMotionForAnimation: _require(1694).getReduceMotionForAnimation };
  fn.__closure = obj;
