          ...
          switch (str) {
            ...
            case "pon":
              ...
              if (obj.test(code.expected)) {
                ...
                let combined = "Ongeldige invoer: verwacht instanceof " + code.expected + ", ontving " + tmp56;
              } else {
                const _HermesInternal15 = HermesInternal;
                combined = "Ongeldige invoer: verwacht " + expected + ", ontving " + tmp56;
              }
              return combined;
            case "one":
            break;
            ...
            case "loadIfNecessary":
              ...
              let str40 = code.origin;
              if (tmp34) {
                if (str40 == null) {
                  str40 = "waarde";
                }
                str = code.maximum.toString();
                let str48 = tmp34.unit;
                if (str48 == null) {
                  str48 = "elementen";
                }
                let combined2 = "Te " + str36 + ": verwacht dat " + str40 + " " + str35 + str + " " + str48 + " " + tmp34.verb;
              } else {
                let str41 = str40;
                if (str40 == null) {
                  str41 = "waarde";
                ...
                combined2 = "Te " + str36 + ": verwacht dat " + str41 + " " + str35 + code.maximum.toString() + " is";
              }
              return combined2;
            ...
            case "ANDROID_NOTIFICATION_LIGHTS":
              ...
              if (tmp20) {
                ...
                let combined3 = "Te " + str21 + ": verwacht dat " + origin + " " + str20 + str1 + " " + tmp20.unit + " " + tmp20.verb;
              } else {
                const _HermesInternal10 = HermesInternal;
                combined3 = "Te " + str21 + ": verwacht dat " + origin + " " + str20 + str1 + " is";
              }
              return combined3;
            case "L":
            break;
            ...
            case "STREAM":
              ...
              str = "Onbekende key";
              let combined5 = `Onbekende key` + str4 + ": " + joinValuesResult;
              return combined5;
            case "STREAMING":
            break;
            case "$ZodCheckMaxLength":
              let _HermesInternal2 = HermesInternal;
              let combined6 = "Ongeldige key in " + code.origin;
              return combined6;
            case "kMaxLength":
            break;
            case "eng":
            ...
            case "el":
              ...
              let combined7 = "Ongeldige waarde in " + code.origin;
              return combined7;
            case "li":
            break;
            case "lim":
            ...
            case "startCol":
              ...
              str = "Onbekende key";
              combined5 = `Onbekende key` + str4 + ": " + joinValuesResult;
              return combined5;
            case "startCollectors":
            break;
            case "FormSubmitErrorType":
              _HermesInternal2 = HermesInternal;
              combined6 = "Ongeldige key in " + code.origin;
              return combined6;
            ...
            case "abandonPermissions":
              ...
              combined7 = "Ongeldige waarde in " + code.origin;
              return combined7;
