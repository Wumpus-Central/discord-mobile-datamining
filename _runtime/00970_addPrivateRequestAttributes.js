// _runtime/00970_addPrivateRequestAttributes.js
import _mod955 from "metro/00955__.js";
import truncateTextByBytes from "00958_truncateTextByBytes.js";
import contentUnionToMessages from "00972_contentUnionToMessages.js";
...
function addPrivateRequestAttributes(setAttributes, config) {
  ...
  if (tmp33) {
    obj = {};
    obj[_mod955.GEN_AI_REQUEST_MESSAGES_ORIGINAL_LENGTH_ATTRIBUTE] = items.length;
    const _JSON = JSON;
    obj[_mod955.GEN_AI_REQUEST_MESSAGES_ATTRIBUTE] = JSON.stringify(truncateTextByBytes.truncateGenAiMessages(items));
