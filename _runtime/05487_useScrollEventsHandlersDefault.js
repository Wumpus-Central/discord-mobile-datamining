// _runtime/05487_useScrollEventsHandlersDefault.js
import { cancelAnimation } from "01653_cancelAnimation.js";
import { GESTURE_SOURCE } from "05461_GESTURE_SOURCE.js";
import { useBottomSheetInternal } from "05468_useBottomSheetInternal.js";
import { LegacyBaseButton } from "05488_LegacyBaseButton.js";
const require = arg1;
...
arg5.useScrollEventsHandlersDefault = (scrollableRef, scrollableContentOffsetY, lockableScrollableContentOffsetY) => {
  ...
  obj = { animatedSheetState, SHEET_STATE: _GESTURE_SOURCE.SHEET_STATE, animatedHandleGestureState, State: _LegacyBaseButton.State, animatedScrollableState, SCROLLABLE_STATE: _GESTURE_SOURCE.SCROLLABLE_STATE, scrollTo: _cancelAnimation.scrollTo, scrollableRef, scrollableContentOffsetY, _lockableScrollableContentOffsetY: sharedValue };
  E.__closure = obj;
