// _runtime/09001_QRPolynomial.js
import { 09002__ } from "metro/09002__.js";
class QRPolynomial {
...
QRPolynomial.prototype = {
  ...
  mod(getLength) {
    ...
    if (length - getLength.getLength() < 0) {
      ...
      const obj4 = 09002__;
      const glogResult = 09002__.glog(self.get(0));
      const _Array2 = Array;
      const diff = glogResult - 09002__.glog(getLength.get(0));
