// === Module 8245: _isNativeReflectConstruct ===
...
let obj = {
  ...
  value: function render() {
    ...
    ({ dx, dy, result } = props);
    const items = [callback3(FeDropShadow(8246), { in: str, stdDeviation: props.stdDeviation }), callback3(FeDropShadow(8248), { dx, dy, result: "offsetblur" }), , , ];
    obj = { floodColor: self.props.floodColor, floodOpacity: self.props.floodOpacity };
    items[2] = callback3(FeDropShadow(8250), obj);
    items[3] = callback3(FeDropShadow(8239), { in2: "offsetblur", operator: "in" });
    obj = { result, children: null };
    const items1 = [callback3(FeDropShadow(8254), {}), callback3(FeDropShadow(8254), { in: str })];
    obj[1] = items1;
    items[4] = callback4(FeDropShadow(8252), obj);
    obj[0] = items;
