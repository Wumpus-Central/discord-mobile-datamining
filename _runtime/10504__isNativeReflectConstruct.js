// _runtime/10504__isNativeReflectConstruct.js
...
const items = [
  {
    ...
    value: function innerPattern() {
      const regExp = new RegExp(
        "(?:in|f\u00FCr|w\u00E4hrend)\\s*(" + DETimeUnitWithinFormatParser(10496).TIME_UNITS_PATTERN + ")(?=\\W|$)",
        "i",
      );
      return regExp;
    },
  },
  {
    ...
    value: function innerExtract(reference) {
      ...
      return ParsingComponents.createRelativeFromReference(
        reference.reference,
        DETimeUnitWithinFormatParser(10496).parseDuration(arg1[1]),
      );
    },
  },
];
