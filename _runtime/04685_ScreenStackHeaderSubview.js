// === Module 4685: ScreenStackHeaderSubview ===
...
const forwardRefResult = noopDefault.forwardRef((disableLeftInsetApplication, ref) => {
  ...
  if (headerLeftBarButtonItems) {
    if (tmp(4682).isHeaderBarButtonsAvailableForCurrentPlatform) {
      let tmpResult = tmp(4687);
  ...
  let isHeaderBarButtonsAvailableForCurrentPlatform = tmp(4682).isHeaderBarButtonsAvailableForCurrentPlatform;
  ...
  obj.synchronousShadowStateUpdatesEnabled = result1(4683).experiment.synchronousHeaderConfigUpdatesEnabled;
  return jsx(result1(4688), {});
});
