// _runtime/09146__isNativeReflectConstruct.js
...
let items = [
  {
    ...
    value: function update(B) {
      ...
      let view;
      const self = this;
      HashMD(9141).exists(this);
      ({ buffer, blockLen, view } = this);
      const toBytesResult = HashMD(9140).toBytes(B);
      let num = 0;
  ...
  },
  {
    ...
    value: function digestInto(content) {
      ...
      const self = this;
      HashMD(9141).exists(this);
      HashMD(9141).output(content, this);
      this.finished = true;
      ...
      self.process(view, 0);
      view = HashMD(9140).createView(content);
