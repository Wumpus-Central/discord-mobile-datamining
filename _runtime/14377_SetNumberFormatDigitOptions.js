// _runtime/14377_SetNumberFormatDigitOptions.js
import _mod14330 from "metro/14330__.js";
import GetNumberOption from "14333_GetNumberOption.js";
import DefaultNumberOption from "14334_DefaultNumberOption.js";
...
export const SetNumberFormatDigitOptions = function SetNumberFormatDigitOptions(
  ...
  if (flag) {
    if (tmp12) {
      ...
      if (undefined === DefaultNumberOptionResult) {
        _mod14330.invariant(undefined !== DefaultNumberOptionResult1, "maximumFractionDigits must be defined");
        const _Math2 = Math;
  ...
  if (!flag2) {
    ...
    if (tmp10) {
      ...
      _mod14330.invariant("fractionDigits" === internalSlots.roundingType, "Invalid roundingType", TypeError);
