          ...
          switch (code) {
            ...
            case "H":
              ...
              if (obj.test(code.expected)) {
                ...
                let combined =
                  "Nevalida enigo: atendi\u011Dis instanceof " + code.expected + ", ricevi\u011Dis " + tmp55;
              } else {
            ...
            case "NSFW_SERVER_INVITE_EMBED":
              ...
              if (tmp22) {
                ...
                let combined3 =
                  "Tro malgranda: atendi\u011Dis ke " + origin + " havu " + str20 + str1 + " " + tmp22.unit;
              } else {
