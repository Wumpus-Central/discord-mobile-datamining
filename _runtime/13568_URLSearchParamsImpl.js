// _runtime/13568_URLSearchParamsImpl.js
...
let obj = {
  ...
  value: function _updateSteps() {
    const self = this;
    if (null !== this._url) {
      let serializeUrlencodedResult = URLSearchParamsImpl(13566).serializeUrlencoded(self._list);
      if ("" === serializeUrlencodedResult) {
        serializeUrlencodedResult = null;
      }
      self._url._url.query = serializeUrlencodedResult;
      const obj = URLSearchParamsImpl(13566);
    }
  }
};
let items = [
...
items[9] = {
  ...
  value: function toString() {
    return URLSearchParamsImpl(13566).serializeUrlencoded(this._list);
  }
};
