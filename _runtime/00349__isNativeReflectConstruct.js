...
class ScrollView {
  constructor(arg0) {
    ...
    f106836 = (arg0) =>
      Object.assign(arg0, {
        getScrollResponder: f106836.getScrollResponder,
        getScrollableNode: f106836.getScrollableNode,
        getInnerViewNode: f106836.getInnerViewNode,
        getInnerViewRef: f106836.getInnerViewRef,
        getNativeScrollRef: f106836.getNativeScrollRef,
        scrollTo: f106836.scrollTo,
        scrollToEnd: f106836.scrollToEnd,
        flashScrollIndicators: f106836.flashScrollIndicators,
        scrollResponderZoomTo: f106836.scrollResponderZoomTo,
        scrollResponderScrollNativeHandleToKeyboard: f106836.scrollResponderScrollNativeHandleToKeyboard,
      });
    closure_1 = undefined;
    obj1 = {
      getForwardingRef: require("areInputsEqual")((arg0) => {
    ...
    tmp3Result._isAnimating = () => {
      const _performance = f106836.performance;
      return (
        _performance.now() - f106836._lastMomentumScrollEndTime < 16 ||
        f106836._lastMomentumScrollEndTime < f106836._lastMomentumScrollBeginTime
      );
    };
    ...
    tmp3Result._handleScrollShouldSetResponder = () =>
      true !== f106836.props.disableScrollViewPanResponder && f106836._isTouching;
