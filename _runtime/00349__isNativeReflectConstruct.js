...
class ScrollView {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f101664);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f101664);
    ...
    tmp3Result.getScrollResponder = () => f101664;
    tmp3Result.getScrollableNode = () => {
      obj = obj(outer1_4[8]);
      return obj.findNodeHandle(f101664.getNativeScrollRef());
    };
    tmp3Result.getInnerViewNode = () => {
      obj = obj(outer1_4[8]);
      return obj.findNodeHandle(f101664._innerView.nativeInstance);
    };
    ...
    tmp3Result.scrollResponderZoomTo = (animated) => {
      ...
      if ("animated" in animated) {
        f101664._animated = animated.animated;
        delete tmp[tmp2];
    ...
    tmp3Result._handleScroll = (arg0) => {
      f101664._observedScrollSinceBecomingResponder = true;
      if (f101664.props.onScroll) {
    ...
    tmp3Result._handleLayout = (nativeEvent) => {
      let obj = f101664;
      if (true === f101664.props.invertStickyHeaders) {
    ...
    tmp3Result._handleContentOnLayout = (arg0) => {
      if (f101664.props.onContentSizeChange) {
        const props = f101664.props;
    ...
    f101664 = (arg0) => Object.assign(arg0, { getScrollResponder: f101664.getScrollResponder, getScrollableNode: f101664.getScrollableNode, getInnerViewNode: f101664.getInnerViewNode, getInnerViewRef: f101664.getInnerViewRef, getNativeScrollRef: f101664.getNativeScrollRef, scrollTo: f101664.scrollTo, scrollToEnd: f101664.scrollToEnd, flashScrollIndicators: f101664.flashScrollIndicators, scrollResponderZoomTo: f101664.scrollResponderZoomTo, scrollResponderScrollNativeHandleToKeyboard: f101664.scrollResponderScrollNativeHandleToKeyboard });
    f101664 = undefined;
    obj1 = {
      getForwardingRef: require("areInputsEqual")((arg0) => {
            let closure_0 = arg0;
    ...
    tmp3Result.scrollResponderKeyboardWillShow = (endCoordinates) => {
      f101664._keyboardMetrics = endCoordinates.endCoordinates;
      if (f101664.props.onKeyboardWillShow) {
        const props = f101664.props;
        props.onKeyboardWillShow(endCoordinates);
      }
    };
    tmp3Result.scrollResponderKeyboardWillHide = (arg0) => {
      f101664._keyboardMetrics = null;
      if (f101664.props.onKeyboardWillHide) {
        const props = tmp.props;
    ...
    tmp3Result.scrollResponderKeyboardDidShow = (endCoordinates) => {
      f101664._keyboardMetrics = endCoordinates.endCoordinates;
      if (f101664.props.onKeyboardDidShow) {
        const props = f101664.props;
    ...
    tmp3Result.scrollResponderKeyboardDidHide = (arg0) => {
      f101664._keyboardMetrics = null;
      if (f101664.props.onKeyboardDidHide) {
        const props = tmp.props;
        props.onKeyboardDidHide(arg0);
      }
    };
    tmp3Result._handleMomentumScrollBegin = (arg0) => {
      const _performance = f101664.performance;
      f101664._lastMomentumScrollBeginTime = _performance.now();
      if (f101664.props.onMomentumScrollBegin) {
        const props = f101664.props;
    ...
    tmp3Result._handleMomentumScrollEnd = (arg0) => {
      ...
      const _performance = f101664.performance;
      f101664._lastMomentumScrollEndTime = _performance.now();
      if (f101664.props.onMomentumScrollEnd) {
        const props = f101664.props;
    ...
    tmp3Result._handleScrollBeginDrag = (arg0) => {
      ...
      if ("on-drag" === f101664.props.keyboardDismissMode) {
        outer1_2(outer1_4[15])();
      }
      if (f101664.props.onScrollBeginDrag) {
    ...
    tmp3Result._handleScrollEndDrag = (nativeEvent) => {
      ...
      let _isAnimatingResult = f101664._isAnimating();
      ...
      if (f101664.props.onScrollEndDrag) {
        const props = tmp.props;
    ...
    tmp3Result._isAnimating = () => {
      const _performance = f101664.performance;
      return _performance.now() - f101664._lastMomentumScrollEndTime < 16 || f101664._lastMomentumScrollEndTime < f101664._lastMomentumScrollBeginTime;
    };
    tmp3Result._handleResponderGrant = (arg0) => {
      f101664._observedScrollSinceBecomingResponder = false;
      if (f101664.props.onResponderGrant) {
        const props = obj.props;
        props.onResponderGrant(arg0);
      }
      f101664._becameResponderWhileAnimating = f101664._isAnimating();
    };
    tmp3Result._handleResponderReject = () => {

    };
    tmp3Result._handleResponderRelease = (nativeEvent) => {
      f101664._isTouching = 0 !== nativeEvent.nativeEvent.touches.length;
      if (f101664.props.onResponderRelease) {
        const props = obj.props;
    ...
    tmp3Result._handleResponderTerminationRequest = () => !f101664._observedScrollSinceBecomingResponder;
    tmp3Result._handleScrollShouldSetResponder = () => true !== f101664.props.disableScrollViewPanResponder && f101664._isTouching;
    tmp3Result._handleStartShouldSetResponder = (target) => {
      if (true === f101664.props.disableScrollViewPanResponder) {
        return false;
      } else {
    ...
    tmp3Result._softKeyboardIsDetached = () => {
      let tmp = null != f101664._keyboardMetrics;
      if (tmp) {
        tmp = 0 === f101664._keyboardMetrics.height;
      }
      return tmp;
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      f101664._isTouching = 0 !== nativeEvent.nativeEvent.touches.length;
      const keyboardShouldPersistTaps = f101664.props.keyboardShouldPersistTaps;
      let tmp = !keyboardShouldPersistTaps;
      if (keyboardShouldPersistTaps) {
        tmp = "never" === keyboardShouldPersistTaps;
      }
