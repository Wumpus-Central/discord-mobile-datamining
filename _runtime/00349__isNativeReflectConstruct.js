...
class ScrollView {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f102627);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f102627);
    ...
    tmp3Result.getScrollResponder = () => f102627;
    tmp3Result.getScrollableNode = () => {
      obj = obj(outer1_4[8]);
      return obj.findNodeHandle(f102627.getNativeScrollRef());
    };
    tmp3Result.getInnerViewNode = () => {
      obj = obj(outer1_4[8]);
      return obj.findNodeHandle(f102627._innerView.nativeInstance);
    };
    tmp3Result.getInnerViewRef = () => f102627._innerView.nativeInstance;
    tmp3Result.getNativeScrollRef = () => f102627._scrollView.nativeInstance;
    tmp3Result.scrollTo = (num) => {
      ...
      const nativeScrollRef = f102627.getNativeScrollRef();
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (num, arg1, _preventNegativeScrollOffset) => {
      ...
      f102627._additionalScrollOffset = num;
      f102627._preventNegativeScrollOffset = _preventNegativeScrollOffset;
      if (null != f102627._innerView.nativeInstance) {
        if (typeof num === "number") {
    ...
    tmp3Result.scrollResponderZoomTo = (animated) => {
      ...
      if ("animated" in animated) {
        f102627._animated = animated.animated;
        delete tmp[tmp2];
    ...
    tmp3Result._handleScroll = (arg0) => {
      f102627._observedScrollSinceBecomingResponder = true;
      if (f102627.props.onScroll) {
    ...
    tmp3Result._handleLayout = (nativeEvent) => {
      let obj = f102627;
      if (true === f102627.props.invertStickyHeaders) {
    ...
    tmp3Result._handleContentOnLayout = (arg0) => {
      if (f102627.props.onContentSizeChange) {
        const props = f102627.props;
    ...
    f102627 = (arg0) => Object.assign(arg0, { getScrollResponder: f102627.getScrollResponder, getScrollableNode: f102627.getScrollableNode, getInnerViewNode: f102627.getInnerViewNode, getInnerViewRef: f102627.getInnerViewRef, getNativeScrollRef: f102627.getNativeScrollRef, scrollTo: f102627.scrollTo, scrollToEnd: f102627.scrollToEnd, flashScrollIndicators: f102627.flashScrollIndicators, scrollResponderZoomTo: f102627.scrollResponderZoomTo, scrollResponderScrollNativeHandleToKeyboard: f102627.scrollResponderScrollNativeHandleToKeyboard });
    f102627 = undefined;
    obj1 = {
      getForwardingRef: require("areInputsEqual")((arg0) => {
            let closure_0 = arg0;
    ...
    tmp3Result.scrollResponderKeyboardWillShow = (endCoordinates) => {
      f102627._keyboardMetrics = endCoordinates.endCoordinates;
      if (f102627.props.onKeyboardWillShow) {
        const props = f102627.props;
        props.onKeyboardWillShow(endCoordinates);
      }
    };
    tmp3Result.scrollResponderKeyboardWillHide = (arg0) => {
      f102627._keyboardMetrics = null;
      if (f102627.props.onKeyboardWillHide) {
        const props = tmp.props;
    ...
    tmp3Result.scrollResponderKeyboardDidShow = (endCoordinates) => {
      f102627._keyboardMetrics = endCoordinates.endCoordinates;
      if (f102627.props.onKeyboardDidShow) {
        const props = f102627.props;
    ...
    tmp3Result.scrollResponderKeyboardDidHide = (arg0) => {
      f102627._keyboardMetrics = null;
      if (f102627.props.onKeyboardDidHide) {
        const props = tmp.props;
        props.onKeyboardDidHide(arg0);
      }
    };
    tmp3Result._handleMomentumScrollBegin = (arg0) => {
      const _performance = f102627.performance;
      f102627._lastMomentumScrollBeginTime = _performance.now();
      if (f102627.props.onMomentumScrollBegin) {
        const props = f102627.props;
    ...
    tmp3Result._handleMomentumScrollEnd = (arg0) => {
      ...
      const _performance = f102627.performance;
      f102627._lastMomentumScrollEndTime = _performance.now();
      if (f102627.props.onMomentumScrollEnd) {
        const props = f102627.props;
    ...
    tmp3Result._handleScrollBeginDrag = (arg0) => {
      ...
      if ("on-drag" === f102627.props.keyboardDismissMode) {
        outer1_2(outer1_4[15])();
      }
      if (f102627.props.onScrollBeginDrag) {
    ...
    tmp3Result._handleScrollEndDrag = (nativeEvent) => {
      ...
      let _isAnimatingResult = f102627._isAnimating();
      ...
      if (f102627.props.onScrollEndDrag) {
        const props = tmp.props;
    ...
    tmp3Result._isAnimating = () => {
      const _performance = f102627.performance;
      return _performance.now() - f102627._lastMomentumScrollEndTime < 16 || f102627._lastMomentumScrollEndTime < f102627._lastMomentumScrollBeginTime;
    };
    tmp3Result._handleResponderGrant = (arg0) => {
      f102627._observedScrollSinceBecomingResponder = false;
      if (f102627.props.onResponderGrant) {
        const props = obj.props;
        props.onResponderGrant(arg0);
      }
      f102627._becameResponderWhileAnimating = f102627._isAnimating();
    };
    tmp3Result._handleResponderReject = () => {

    };
    tmp3Result._handleResponderRelease = (nativeEvent) => {
      f102627._isTouching = 0 !== nativeEvent.nativeEvent.touches.length;
      if (f102627.props.onResponderRelease) {
        const props = obj.props;
    ...
    tmp3Result._handleResponderTerminationRequest = () => !f102627._observedScrollSinceBecomingResponder;
    tmp3Result._handleScrollShouldSetResponder = () => true !== f102627.props.disableScrollViewPanResponder && f102627._isTouching;
    tmp3Result._handleStartShouldSetResponder = (target) => {
      if (true === f102627.props.disableScrollViewPanResponder) {
        return false;
      } else {
    ...
    tmp3Result._softKeyboardIsDetached = () => {
      let tmp = null != f102627._keyboardMetrics;
      if (tmp) {
        tmp = 0 === f102627._keyboardMetrics.height;
      }
      return tmp;
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      f102627._isTouching = 0 !== nativeEvent.nativeEvent.touches.length;
      const keyboardShouldPersistTaps = f102627.props.keyboardShouldPersistTaps;
      let tmp = !keyboardShouldPersistTaps;
      if (keyboardShouldPersistTaps) {
        tmp = "never" === keyboardShouldPersistTaps;
      }
