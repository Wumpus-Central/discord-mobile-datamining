...
class ScrollView {
  constructor(arg0) {
    self = this;
    tmp = closure_7(this, f106836);
    items = [];
    items[0] = global;
    tmp2 = closure_9;
    obj = closure_9(f106836);
    tmp3 = closure_8;
    ...
    tmp3Result.getScrollResponder = () => f106836;
    tmp3Result.getScrollableNode = () => {
      obj = obj(closure_1_4[8]);
      return obj.findNodeHandle(f106836.getNativeScrollRef());
    };
    tmp3Result.getInnerViewNode = () => {
      obj = obj(closure_1_4[8]);
      return obj.findNodeHandle(f106836._innerView.nativeInstance);
    };
    tmp3Result.getInnerViewRef = () => f106836._innerView.nativeInstance;
    tmp3Result.getNativeScrollRef = () => f106836._scrollView.nativeInstance;
    tmp3Result.scrollTo = (num) => {
      ...
      const nativeScrollRef = f106836.getNativeScrollRef();
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (num, arg1, _preventNegativeScrollOffset) => {
      ...
      f106836._additionalScrollOffset = num;
      f106836._preventNegativeScrollOffset = _preventNegativeScrollOffset;
      if (null != f106836._innerView.nativeInstance) {
        if (typeof num === "number") {
    ...
    tmp3Result.scrollResponderZoomTo = (animated) => {
      ...
      if ("animated" in animated) {
        f106836._animated = animated.animated;
        delete tmp[tmp2];
    ...
    tmp3Result._handleScroll = (arg0) => {
      f106836._observedScrollSinceBecomingResponder = true;
      if (f106836.props.onScroll) {
    ...
    tmp3Result._handleLayout = (nativeEvent) => {
      obj = f106836;
      if (true === f106836.props.invertStickyHeaders) {
    ...
    tmp3Result._handleContentOnLayout = (arg0) => {
      if (f106836.props.onContentSizeChange) {
        const props = f106836.props;
    ...
    f106836 = (arg0) => Object.assign(arg0, { getScrollResponder: f106836.getScrollResponder, getScrollableNode: f106836.getScrollableNode, getInnerViewNode: f106836.getInnerViewNode, getInnerViewRef: f106836.getInnerViewRef, getNativeScrollRef: f106836.getNativeScrollRef, scrollTo: f106836.scrollTo, scrollToEnd: f106836.scrollToEnd, flashScrollIndicators: f106836.flashScrollIndicators, scrollResponderZoomTo: f106836.scrollResponderZoomTo, scrollResponderScrollNativeHandleToKeyboard: f106836.scrollResponderScrollNativeHandleToKeyboard });
    closure_1 = undefined;
    obj1 = {
      getForwardingRef: require("areInputsEqual")((arg0) => {
            closure_0 = arg0;
    ...
    tmp3Result.scrollResponderKeyboardWillShow = (endCoordinates) => {
      f106836._keyboardMetrics = endCoordinates.endCoordinates;
      if (f106836.props.onKeyboardWillShow) {
        const props = f106836.props;
        props.onKeyboardWillShow(endCoordinates);
      }
    };
    tmp3Result.scrollResponderKeyboardWillHide = (arg0) => {
      f106836._keyboardMetrics = null;
      if (f106836.props.onKeyboardWillHide) {
        const props = tmp.props;
    ...
    tmp3Result.scrollResponderKeyboardDidShow = (endCoordinates) => {
      f106836._keyboardMetrics = endCoordinates.endCoordinates;
      if (f106836.props.onKeyboardDidShow) {
        const props = f106836.props;
    ...
    tmp3Result.scrollResponderKeyboardDidHide = (arg0) => {
      f106836._keyboardMetrics = null;
      if (f106836.props.onKeyboardDidHide) {
        const props = tmp.props;
        props.onKeyboardDidHide(arg0);
      }
    };
    tmp3Result._handleMomentumScrollBegin = (arg0) => {
      const _performance = f106836.performance;
      f106836._lastMomentumScrollBeginTime = _performance.now();
      if (f106836.props.onMomentumScrollBegin) {
        const props = f106836.props;
    ...
    tmp3Result._handleMomentumScrollEnd = (arg0) => {
      ...
      const _performance = f106836.performance;
      f106836._lastMomentumScrollEndTime = _performance.now();
      if (f106836.props.onMomentumScrollEnd) {
        const props = f106836.props;
    ...
    tmp3Result._handleScrollBeginDrag = (arg0) => {
      ...
      if ("on-drag" === f106836.props.keyboardDismissMode) {
        closure_1_2(closure_1_4[15])();
      }
      if (f106836.props.onScrollBeginDrag) {
    ...
    tmp3Result._handleScrollEndDrag = (nativeEvent) => {
      ...
      let _isAnimatingResult = f106836._isAnimating();
      ...
      if (f106836.props.onScrollEndDrag) {
        const props = tmp.props;
    ...
    tmp3Result._isAnimating = () => {
      const _performance = f106836.performance;
      return _performance.now() - f106836._lastMomentumScrollEndTime < 16 || f106836._lastMomentumScrollEndTime < f106836._lastMomentumScrollBeginTime;
    };
    tmp3Result._handleResponderGrant = (arg0) => {
      f106836._observedScrollSinceBecomingResponder = false;
      if (f106836.props.onResponderGrant) {
        const props = obj.props;
        props.onResponderGrant(arg0);
      }
      f106836._becameResponderWhileAnimating = f106836._isAnimating();
    };
    tmp3Result._handleResponderReject = () => {

    };
    tmp3Result._handleResponderRelease = (nativeEvent) => {
      f106836._isTouching = 0 !== nativeEvent.nativeEvent.touches.length;
      if (f106836.props.onResponderRelease) {
        const props = obj.props;
    ...
    tmp3Result._handleResponderTerminationRequest = () => !f106836._observedScrollSinceBecomingResponder;
    tmp3Result._handleScrollShouldSetResponder = () => true !== f106836.props.disableScrollViewPanResponder && f106836._isTouching;
    tmp3Result._handleStartShouldSetResponder = (target) => {
      if (true === f106836.props.disableScrollViewPanResponder) {
        return false;
      } else {
    ...
    tmp3Result._softKeyboardIsDetached = () => {
      let tmp = null != f106836._keyboardMetrics;
      if (tmp) {
        tmp = 0 === f106836._keyboardMetrics.height;
      }
      return tmp;
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      f106836._isTouching = 0 !== nativeEvent.nativeEvent.touches.length;
      const keyboardShouldPersistTaps = f106836.props.keyboardShouldPersistTaps;
      let tmp = !keyboardShouldPersistTaps;
      if (keyboardShouldPersistTaps) {
        tmp = "never" === keyboardShouldPersistTaps;
      }
