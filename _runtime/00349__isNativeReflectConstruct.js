...
class ScrollView {
  constructor(arg0) {
    self = this;
    tmp = _isNativeReflectConstruct(this, f102583);
    items = [];
    items[0] = global;
    tmp2 = _isNativeReflectConstruct;
    obj = _isNativeReflectConstruct(f102583);
    ...
    tmp3Result.getScrollResponder = () => f102583;
    tmp3Result.getScrollableNode = () => {
      obj = obj(outer1_4[8]);
      return obj.findNodeHandle(f102583.getNativeScrollRef());
    };
    tmp3Result.getInnerViewNode = () => {
      obj = obj(outer1_4[8]);
      return obj.findNodeHandle(f102583._innerView.nativeInstance);
    };
    tmp3Result.getInnerViewRef = () => f102583._innerView.nativeInstance;
    tmp3Result.getNativeScrollRef = () => f102583._scrollView.nativeInstance;
    tmp3Result.scrollTo = (num) => {
      ...
      const nativeScrollRef = f102583.getNativeScrollRef();
    ...
    tmp3Result.scrollResponderScrollNativeHandleToKeyboard = (num, arg1, _preventNegativeScrollOffset) => {
      ...
      f102583._additionalScrollOffset = num;
      f102583._preventNegativeScrollOffset = _preventNegativeScrollOffset;
      if (null != f102583._innerView.nativeInstance) {
        if (typeof num === "number") {
    ...
    tmp3Result.scrollResponderZoomTo = (animated) => {
      ...
      if ("animated" in animated) {
        f102583._animated = animated.animated;
        delete tmp[tmp2];
    ...
    tmp3Result._handleScroll = (arg0) => {
      f102583._observedScrollSinceBecomingResponder = true;
      if (f102583.props.onScroll) {
    ...
    tmp3Result._handleLayout = (nativeEvent) => {
      let obj = f102583;
      if (true === f102583.props.invertStickyHeaders) {
    ...
    tmp3Result._handleContentOnLayout = (arg0) => {
      if (f102583.props.onContentSizeChange) {
        const props = f102583.props;
    ...
    f102583 = (arg0) => Object.assign(arg0, { getScrollResponder: f102583.getScrollResponder, getScrollableNode: f102583.getScrollableNode, getInnerViewNode: f102583.getInnerViewNode, getInnerViewRef: f102583.getInnerViewRef, getNativeScrollRef: f102583.getNativeScrollRef, scrollTo: f102583.scrollTo, scrollToEnd: f102583.scrollToEnd, flashScrollIndicators: f102583.flashScrollIndicators, scrollResponderZoomTo: f102583.scrollResponderZoomTo, scrollResponderScrollNativeHandleToKeyboard: f102583.scrollResponderScrollNativeHandleToKeyboard });
    f102583 = undefined;
    obj1 = {
      getForwardingRef: require("areInputsEqual")((arg0) => {
            let closure_0 = arg0;
    ...
    tmp3Result.scrollResponderKeyboardWillShow = (endCoordinates) => {
      f102583._keyboardMetrics = endCoordinates.endCoordinates;
      if (f102583.props.onKeyboardWillShow) {
        const props = f102583.props;
        props.onKeyboardWillShow(endCoordinates);
      }
    };
    tmp3Result.scrollResponderKeyboardWillHide = (arg0) => {
      f102583._keyboardMetrics = null;
      if (f102583.props.onKeyboardWillHide) {
        const props = tmp.props;
    ...
    tmp3Result.scrollResponderKeyboardDidShow = (endCoordinates) => {
      f102583._keyboardMetrics = endCoordinates.endCoordinates;
      if (f102583.props.onKeyboardDidShow) {
        const props = f102583.props;
    ...
    tmp3Result.scrollResponderKeyboardDidHide = (arg0) => {
      f102583._keyboardMetrics = null;
      if (f102583.props.onKeyboardDidHide) {
        const props = tmp.props;
        props.onKeyboardDidHide(arg0);
      }
    };
    tmp3Result._handleMomentumScrollBegin = (arg0) => {
      const _performance = f102583.performance;
      f102583._lastMomentumScrollBeginTime = _performance.now();
      if (f102583.props.onMomentumScrollBegin) {
        const props = f102583.props;
    ...
    tmp3Result._handleMomentumScrollEnd = (arg0) => {
      ...
      const _performance = f102583.performance;
      f102583._lastMomentumScrollEndTime = _performance.now();
      if (f102583.props.onMomentumScrollEnd) {
        const props = f102583.props;
    ...
    tmp3Result._handleScrollBeginDrag = (arg0) => {
      ...
      if ("on-drag" === f102583.props.keyboardDismissMode) {
        outer1_2(outer1_4[15])();
      }
      if (f102583.props.onScrollBeginDrag) {
    ...
    tmp3Result._handleScrollEndDrag = (nativeEvent) => {
      ...
      let _isAnimatingResult = f102583._isAnimating();
      ...
      if (f102583.props.onScrollEndDrag) {
        const props = tmp.props;
    ...
    tmp3Result._isAnimating = () => {
      const _performance = f102583.performance;
      return _performance.now() - f102583._lastMomentumScrollEndTime < 16 || f102583._lastMomentumScrollEndTime < f102583._lastMomentumScrollBeginTime;
    };
    tmp3Result._handleResponderGrant = (arg0) => {
      f102583._observedScrollSinceBecomingResponder = false;
      if (f102583.props.onResponderGrant) {
        const props = obj.props;
        props.onResponderGrant(arg0);
      }
      f102583._becameResponderWhileAnimating = f102583._isAnimating();
    };
    tmp3Result._handleResponderReject = () => {

    };
    tmp3Result._handleResponderRelease = (nativeEvent) => {
      f102583._isTouching = 0 !== nativeEvent.nativeEvent.touches.length;
      if (f102583.props.onResponderRelease) {
        const props = obj.props;
    ...
    tmp3Result._handleResponderTerminationRequest = () => !f102583._observedScrollSinceBecomingResponder;
    tmp3Result._handleScrollShouldSetResponder = () => true !== f102583.props.disableScrollViewPanResponder && f102583._isTouching;
    tmp3Result._handleStartShouldSetResponder = (target) => {
      if (true === f102583.props.disableScrollViewPanResponder) {
        return false;
      } else {
    ...
    tmp3Result._softKeyboardIsDetached = () => {
      let tmp = null != f102583._keyboardMetrics;
      if (tmp) {
        tmp = 0 === f102583._keyboardMetrics.height;
      }
      return tmp;
    };
    ...
    tmp3Result._handleTouchEnd = (nativeEvent) => {
      f102583._isTouching = 0 !== nativeEvent.nativeEvent.touches.length;
      const keyboardShouldPersistTaps = f102583.props.keyboardShouldPersistTaps;
      let tmp = !keyboardShouldPersistTaps;
      if (keyboardShouldPersistTaps) {
        tmp = "never" === keyboardShouldPersistTaps;
      }
