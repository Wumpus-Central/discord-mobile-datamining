...
class ScrollView {
  constructor(arg0) {
    ...
    f106619 = (arg0) =>
      Object.assign(arg0, {
        getScrollResponder: f106619.getScrollResponder,
        getScrollableNode: f106619.getScrollableNode,
        getInnerViewNode: f106619.getInnerViewNode,
        getInnerViewRef: f106619.getInnerViewRef,
        getNativeScrollRef: f106619.getNativeScrollRef,
        scrollTo: f106619.scrollTo,
        scrollToEnd: f106619.scrollToEnd,
        flashScrollIndicators: f106619.flashScrollIndicators,
        scrollResponderZoomTo: f106619.scrollResponderZoomTo,
        scrollResponderScrollNativeHandleToKeyboard: f106619.scrollResponderScrollNativeHandleToKeyboard,
      });
    closure_1 = undefined;
    obj1 = {
      getForwardingRef: require("areInputsEqual")((arg0) => {
    ...
    tmp3Result._isAnimating = () => {
      const _performance = f106619.performance;
      return (
        _performance.now() - f106619._lastMomentumScrollEndTime < 16 ||
        f106619._lastMomentumScrollEndTime < f106619._lastMomentumScrollBeginTime
      );
    };
    ...
    tmp3Result._handleScrollShouldSetResponder = () =>
      true !== f106619.props.disableScrollViewPanResponder && f106619._isTouching;
