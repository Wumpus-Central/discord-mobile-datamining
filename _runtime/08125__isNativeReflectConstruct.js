// _runtime/08125__isNativeReflectConstruct.js
import noopAll from "00019_noop.js";
import _inheritsDefault from "00098__inherits.js";
import _isNativeReflectConstructDefault from "08076__isNativeReflectConstruct.js";
import __INTERNAL_VIEW_CONFIGDefault from "metro/08126___INTERNAL_VIEW_CONFIG.js";
...
const items = [
  {
    ...
    value: function render() {
      ...
      let obj = {};
      ({ x1, y1, x2, y2 } = props);
      const merged = Object.assign(self(8067).extract(this, props));
      obj.x1 = x1;
      obj.y1 = y1;
      obj.x2 = x2;
      obj.y2 = y2;
