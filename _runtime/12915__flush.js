...
import _mod12916 from "metro/12916__.js";
  ...
  if (c1 === 2) {
    ...
    try {
      ...
      if (arg0 === 1) {
        ...
        const client = require("metro/12894__.js").getClient();
        if (client) {
          client.flush(closure_0);
        } else {
          if (require("metro/12895__.js").DEBUG_BUILD) {
            const logger = require("metro/12867__.js").logger;
            logger.warn("Cannot flush events. No client defined.");
          }
          const resolved = Promise.resolve(false);
        }
        c1 = 3;
        const obj3 = require("metro/12894__.js");
      }
    } catch (tmp8) {
      c1 = tmp;
      throw tmp8;
...
export const captureException = function captureException(arg0, captureContext) {
  const currentScope = _mod12894.getCurrentScope();
  return currentScope.captureException(arg0, _mod12916.parseEventHintOrCaptureContext(captureContext));
};
...
export const startSession = function startSession(arg0) {
  ...
  if (undefined === environment) {
    environment = _mod12904.DEFAULT_ENVIRONMENT;
  }
...
export const withMonitor = function withMonitor(monitorSlug, arg1, arg2) {
  ...
  function finishCheckIn(status) {
    const obj = {
      ...
      duration: _mod12881.timestampInSeconds() - closure_3,
    };
    const currentScope = _mod12894.getCurrentScope();
    const client = _mod12894.getClient();
    if (client) {
    ...
    _mod12878.uuid4();
    const tmpResult = _mod12878;
  }
  let currentScope = require("metro/12894__.js").getCurrentScope();
  let obj = { monitorSlug, status: "in_progress" };
  let obj2 = require("metro/12894__.js");
  let client = require("metro/12894__.js").getClient();
  if (client) {
    if (client.captureCheckIn) {
  ...
  let obj3 = require("metro/12894__.js");
  captureCheckInResult = require("metro/12878__.js").uuid4();
};
