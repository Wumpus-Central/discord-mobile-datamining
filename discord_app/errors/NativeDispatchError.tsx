  ...
  get: function displayMessage() {
    ...
    if (null == this.code) {
      ...
      if (DispatchErrorCodes.DISK_LOW === code) {
        ...
        if (tmp32.NOT_DIRECTORY !== code) {
          if (tmp32.DISK_PERMISSION_DENIED !== code) {
            if (tmp32.INVALID_DRIVE === code) {
              ...
              obj1 = { path: null };
              obj1[0] = path;
              return intl5.formatToPlainString(require(1114) /* getSystemLocale */.t["08L2TG"], obj1);
            } else if (tmp32.APPLICATION_LOCK_FAILED === code) {
              const intl4 = require(1114) /* getSystemLocale */.intl;
              return intl4.string(require(1114) /* getSystemLocale */.t.RDYCUV);
            } else if (tmp32.DISK_FULL === code) {
              const intl3 = require(1114) /* getSystemLocale */.intl;
              return intl3.string(require(1114) /* getSystemLocale */.t.mojtDJ);
            } else {
              if (tmp32.API_ERROR !== code) {
                if (tmp32.MAX_REQUEST_RETRIES_EXCEEDED !== code) {
                  ...
                  obj[0] = "" + self.code;
                  return intl.formatToPlainString(require(1114) /* getSystemLocale */.t.r477WB, obj);
                }
              }
              const intl2 = require(1114) /* getSystemLocale */.intl;
              return intl2.string(require(1114) /* getSystemLocale */.t.OXD41D);
            }
          }
        }
        ...
        obj2[0] = path;
        return intl6.formatToPlainString(require(1114) /* getSystemLocale */.t.EjWbO6, obj2);
      }
    }
  },
  set: undefined
