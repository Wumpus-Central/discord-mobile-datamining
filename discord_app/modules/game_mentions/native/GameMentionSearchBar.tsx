...
const memoResult = importAllResult.memo(function GameMentionSearchBar() {
  ...
  const items = [callback(GameControllerIcon.GameControllerIcon, { size: "sm", style: tmp.icon }), ];
  const obj2 = { variant: null, color: "mobile-text-heading-primary", children: "@game" };
  obj2[0] = useGameMentionSearchBarHeight.GAME_MENTION_SEARCH_BAR_TITLE_VARIANT;
  items[1] = callback(Text.Text, obj2);
  obj[1] = items;
  const items1 = [callback2(View, obj), ];
  const obj3 = { style: tmp.description, variant: null, color: "text-muted", children: null };
  obj3[1] = useGameMentionSearchBarHeight.GAME_MENTION_SEARCH_BAR_DESCRIPTION_VARIANT;
