...
export default {
  openGameProfileModal(arg0) {
    ...
    obj.openLazy(asyncRequireImpl /* asyncRequireImpl */(9195, dependencyMap.paths), "game-profile-" + gameId, obj, stackingBehavior);
  },
  returnToGameProfile(gameId) {
    ...
    obj2.openLazy(asyncRequireImpl /* asyncRequireImpl */(9195, dependencyMap.paths), "game-profile-" + gameId, { gameId, source, initialScrollOffset });
  },
