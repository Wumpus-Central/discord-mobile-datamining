...
export default function getGameProfileWebsiteData(category) {
  ...
  if (ThirdPartyGameApplicationWebsiteCategory.ThirdPartyGameApplicationWebsiteCategory.OFFICIAL === category) {
    ...
    obj[1] = arg1;
    obj[0] = jsx(tmp(10453).GlobeEarthIcon, { size: "md", color: null });
    obj[1] = tmp(9201).GameProfileTrackActionActions.WebsiteLink;
    ...
    obj2[1] = arg1;
    obj1[0] = jsx(tmp(8118).XNeutralIcon, { size: "md", color: null });
    obj1[1] = tmp(9201).GameProfileTrackActionActions.XLink;
    ...
    obj4[1] = arg1;
    obj3[0] = jsx(tmp(11648).YoutubeNeutralIcon, { size: "md", color: null });
    obj3[1] = tmp(9201).GameProfileTrackActionActions.YouTubeLink;
    ...
    obj6[1] = arg1;
    obj5[0] = jsx(tmp(8120).FacebookNeutralIcon, { size: "md", color: null });
    obj5[1] = tmp(9201).GameProfileTrackActionActions.FacebookLink;
    ...
    obj8[1] = arg1;
    obj7[0] = jsx(tmp(8122).InstagramNeutralIcon, { size: "md", color: null });
    obj7[1] = tmp(9201).GameProfileTrackActionActions.InstagramLink;
    ...
    obj10[1] = arg1;
    obj9[0] = jsx(tmp(12107).BlueskyNeutralIcon, { size: "md", color: null });
    obj9[1] = tmp(9201).GameProfileTrackActionActions.BlueskyLink;
    ...
    obj12[1] = arg1;
    obj11[0] = jsx(tmp(12109).RedditNeutralIcon, { size: "md", color: null });
    obj11[1] = tmp(9201).GameProfileTrackActionActions.RedditLink;
    ...
    obj13[1] = arg1;
    obj[0] = jsx(tmp(12111).TwitchNeutralIcon, { size: "md", color: null });
    obj[1] = tmp(9201).GameProfileTrackActionActions.TwitchLink;
