...
export default function getGameProfileStoreWebsiteData(category) {
  ...
  if (ThirdPartyGameApplicationWebsiteCategory.ThirdPartyGameApplicationWebsiteCategory.STEAM === category) {
    ...
    obj[1] = tmp(9201).GameProfileTrackActionActions.SteamStoreLink;
    ...
    obj[1] = tmp(9201).GameProfileTrackActionActions.EpicStoreLink;
    ...
    obj1[1] = tmp(9201).GameProfileTrackActionActions.RobloxStoreLink;
    ...
    obj2[1] = tmp(9201).GameProfileTrackActionActions.BattlenetStoreLink;
    ...
    obj3[1] = tmp(9201).GameProfileTrackActionActions.RiotStoreLink;
    ...
    obj4[1] = tmp(9201).GameProfileTrackActionActions.MinecraftStoreLink;
    ...
    obj[1] = tmp(9201).GameProfileTrackActionActions.XboxGamePassStoreLink;
