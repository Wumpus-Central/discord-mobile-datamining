...
function GameProfileShopCarouselContent(trackAction) {
  ...
  if (0 !== stateFromStoresArray.length) {
    ...
    const items2 = [closure_6(closeModal(4570).Text, obj1)];
    ...
    obj2.icon = closure_6(closeModal(7223).ChevronSmallRightIcon, { size: "sm" });
    obj2.onPress = tmp6;
    items2[1] = closure_6(closeModal(4989).Button, obj2);
    obj.children = items2;
    ...
    const obj3 = {
      ...
      snapToInterval: closeModal(8797).COLLECTIBLES_SHOP_CARD_WIDTH + closeModal(8797).COLLECTIBLES_SHOP_CARD_GAP,
    };
    items3[1] = closure_6(closeModal(8906).FlashList, obj3, collectionId);
    obj.children = items3;
