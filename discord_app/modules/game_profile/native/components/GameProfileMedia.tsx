...
obj.mediaItem = { maxWidth: fn(8167).MEDIA_ITEM_MAX_WIDTH, maxHeight: fn(8167).MEDIA_ITEM_MAX_HEIGHT, borderRadius: nativeDefault.radii.lg, overflow: "hidden" };
