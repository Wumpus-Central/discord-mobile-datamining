...
createStyles.mediaItem = { maxWidth: fn(8844).MEDIA_ITEM_MAX_WIDTH, maxHeight: fn(8844).MEDIA_ITEM_MAX_HEIGHT, borderRadius: nativeDefault.radii.lg, overflow: "hidden" };
