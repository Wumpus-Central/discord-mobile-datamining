...
createStyles.mediaItem = { maxWidth: fn(8719).MEDIA_ITEM_MAX_WIDTH, maxHeight: fn(8719).MEDIA_ITEM_MAX_HEIGHT, borderRadius: nativeDefault.radii.lg, overflow: "hidden" };
...
export default function GameProfileMedia(game) {
  ...
  if (0 !== memo1.length) {
    ...
    obj = { ref, showsHorizontalScrollIndicator: false, style: null, contentContainerStyle: null, decelerationRate: "fast", snapToOffsets: null, snapToStart: false, snapToEnd: false, onMomentumScrollEnd: null, children: null };
