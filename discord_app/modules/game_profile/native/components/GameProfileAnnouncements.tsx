...
function EmbedAnnouncementCard(message) {
  ...
  if (null == embedSource) {
    ...
    if (tmp11Result) {
      ...
      tmp11Result = React7(Text_Text.Text, obj7);
    }
    ...
    if (tmp13Result) {
      ...
      if (tmp11Result6) {
        ...
        tmp11Result6 = React7(hasOwnProperty, obj10);
      }
      ...
      tmp13Result = closure_1_10(timestampProducer, obj9);
    }
    ...
    if (tmp11Result7) {
      ...
      obj13.children = React7(ImageWithPlaceholder.ImageWithPlaceholder, obj14);
      tmp11Result7 = React7(timestampProducer, obj13);
    }
    ...
    if (tmp11Result8) {
      ...
      tmp11Result8 = React7(Text_Text.Text, obj15);
    }
    ...
    if (tmp11Result10) {
      ...
      tmp11Result10 = React7(hasOwnProperty, obj18);
    }
    ...
    if (tmp13Result2) {
      ...
      const items6 = [React7(ReactionIcon.ReactionIcon, obj22)];
      let tmp45 = null != obj15;
      if (tmp45) {
        tmp45 = obj15.locale === util.intl.currentLocale;
      }
      if (!tmp45) {
      ...
      items6[1] = React7(Text_Text.Text, obj24);
      obj21.children = items6;
      tmp13Result2 = closure_1_10(timestampProducer, obj21);
    }
...
function MessageAnnouncementCard(message) {
  ...
  if (tmp10Result) {
    ...
    const items3 = [React7(ReactionIcon.ReactionIcon, obj14)];
    let tmp33 = null != obj15;
    if (tmp33) {
      tmp33 = obj15.locale === util.intl.currentLocale;
    }
    if (!tmp33) {
    ...
    items3[1] = React7(Text_Text.Text, obj16);
    obj13.children = items3;
    tmp10Result = closure_1_10(timestampProducer, obj13);
  }
...
let closure_16 = noop.memo(() => {
  ...
  const obj2 = {
    ...
    children: Array.from({ length: 3 }, (arg0, index) => React7(closure_15, { index, isWindowLarge }, index)),
  };
  ...
  if (null != channelId) {
    ...
    if (0 !== messages.length) {
      ...
      obj3.children = messages.map((message) =>
        React7(closure_20, { message, onPress, guildId, channelId }, message.id),
      );
