...
import calculateSteamReviewScoreDescription2 from "calculateSteamReviewScoreDescription" /* 8851 */;
import GameProfileReviewUtils from "GameProfileReviewUtils" /* 8852 */;
...
function SteamReviewRow(url) {
  ...
  const obj2 = url(8852);
  const items2 = [closure_7(url(8820).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }), closure_7(url(4635).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
