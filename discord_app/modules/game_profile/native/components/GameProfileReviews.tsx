...
function SteamReviewRow(url) {
  ...
  const items2 = [
    closure_7(url(8817).SteamNeutralIcon, obj1),
    closure_7(url(4632).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title }),
  ];
  obj.children = items2;
  ...
  obj3.children = url(8849).getSteamReviewScoreDescriptionIntl(result);
  const items4 = [closure_7(url(4632).Text, obj3)];
  ...
  if (tmp12Result) {
    ...
    tmp12Result = closure_7(tmp6(4632).Text, obj4);
...
function OpenCriticReview(url) {
  ...
  const items1 = [closure_7(url(4632).Text, obj)];
  ...
  if (null != tier) {
    ...
    if (topCriticRating > 0) {
      ...
      if (num > 0) {
        ...
        const items4 = [closure_7(trackAction(8856), obj7)];
        ...
        obj8.children = closure_7(tmp11(4632).Text, obj9);
  ...
  if (topCriticRating <= 0) {
    ...
    if (null == tier) {
      ...
      tmp12Result = closure_7(tmp11(4632).Text, obj10);
    }
  } else {
    tmp12Result = null;
  }
...
createStyles.steamRatingContainer = {
  flexDirection: "row",
  alignItems: "flex-end",
  flexShrink: 1,
...
createStyles.opencriticTopCriticRatingContainer = {
  position: "absolute",
  top: 0,
  left: 1,
  right: 0,
