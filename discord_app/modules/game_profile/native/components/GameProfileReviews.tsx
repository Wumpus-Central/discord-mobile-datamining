...
import calculateSteamReviewScoreDescription2 from "calculateSteamReviewScoreDescription" /* 8861 */;
import GameProfileReviewUtils from "GameProfileReviewUtils" /* 8862 */;
...
function SteamReviewRow(url) {
  ...
  const obj2 = url(8862);
  const items2 = [closure_7(url(8829).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }), closure_7(url(4634).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
