...
import calculateSteamReviewScoreDescription2 from "calculateSteamReviewScoreDescription" /* 8793 */;
import GameProfileReviewUtils from "GameProfileReviewUtils" /* 8794 */;
...
function SteamReviewRow(url) {
  ...
  const items2 = [closure_7(url(8764).SteamNeutralIcon, obj1), closure_7(url(4601).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
  obj.children = items2;
