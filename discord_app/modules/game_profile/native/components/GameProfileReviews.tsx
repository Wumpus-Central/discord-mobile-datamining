...
import calculateSteamReviewScoreDescription2 from "calculateSteamReviewScoreDescription" /* 8961 */;
import GameProfileReviewUtils from "GameProfileReviewUtils" /* 8962 */;
...
function SteamReviewRow(url) {
  ...
  const obj2 = url(8962);
  const items2 = [closure_7(url(8925).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }), closure_7(url(4718).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
