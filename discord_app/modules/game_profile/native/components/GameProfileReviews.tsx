...
import calculateSteamReviewScoreDescription2 from "calculateSteamReviewScoreDescription" /* 8877 */;
import GameProfileReviewUtils from "GameProfileReviewUtils" /* 8878 */;
...
function SteamReviewRow(url) {
  ...
  const obj2 = url(8878);
  const items2 = [closure_7(url(8841).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }), closure_7(url(4636).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
