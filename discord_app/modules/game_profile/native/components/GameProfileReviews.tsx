...
function SteamReviewRow(url) {
  ...
  const obj2 = url(9082);
  const items2 = [
    closure_7(url(9045).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }),
  ...
  if (topCriticRating <= 0) {
    ...
    if (null == tier) {
      const obj14 = {
        ...
        color: tmp11(9082).getSteamReviewScoreDescriptionColor(tmp11(2019).SteamReviewScoreDescription.NO_USER_REVIEWS),
        children: null,
      };
