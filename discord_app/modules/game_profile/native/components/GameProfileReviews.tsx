...
function SteamReviewRow(url) {
  ...
  const items2 = [closure_7(url(8817).SteamNeutralIcon, obj1), closure_7(url(4632).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
  obj.children = items2;
