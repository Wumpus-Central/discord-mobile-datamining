...
import calculateSteamReviewScoreDescription2 from "calculateSteamReviewScoreDescription" /* 8756 */;
import GameProfileReviewUtils from "GameProfileReviewUtils" /* 8757 */;
...
function SteamReviewRow(url) {
  ...
  const items2 = [closure_7(url(8727).SteamNeutralIcon, obj1), closure_7(url(4570).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
  obj.children = items2;
