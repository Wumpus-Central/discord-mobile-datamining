...
import calculateSteamReviewScoreDescription2 from "calculateSteamReviewScoreDescription" /* 8848 */;
import GameProfileReviewUtils from "GameProfileReviewUtils" /* 8849 */;
...
function SteamReviewRow(url) {
  ...
  const obj2 = url(8849);
  const items2 = [closure_7(url(8817).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }), closure_7(url(4632).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
