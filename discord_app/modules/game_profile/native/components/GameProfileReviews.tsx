...
import calculateSteamReviewScoreDescription2 from "calculateSteamReviewScoreDescription" /* 9000 */;
import GameProfileReviewUtils from "GameProfileReviewUtils" /* 9001 */;
...
function SteamReviewRow(url) {
  ...
  const obj2 = url(9001);
  const items2 = [closure_7(url(8964).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }), closure_7(url(4752).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title })];
