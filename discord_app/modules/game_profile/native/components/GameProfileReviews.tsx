...
function SteamReviewRow(url) {
  ...
  if (tmp12Result) {
    ...
    tmp12Result = tmp12(tmp6(4299).Text, obj4);
...
function OpenCriticReview(url) {
  ...
  if (opencritic == null) {
    opencritic = { topCriticRating: "Array", topCriticRatingCount: "call", tier: "useStateFromStores" };
  }
  ...
  const items1 = [callback(url(4299).Text, obj), ];
  ...
  if (null != tier) {
    ...
    if (topCriticRating > 0) {
      ...
      if (num > 0) {
        ...
        obj8[1] = tmp12(tmp11(4299).Text, obj9);
  ...
  if (topCriticRating <= 0) {
    ...
    if (null == tier) {
      ...
      tmp12Result = tmp12(tmp11(4299).Text, obj10);
    }
  } else {
    tmp12Result = null;
  }
...
export default function GameProfileReviews(arg0) {
  ...
  if (null == game) {
    ...
    const items = [callback(tmp2(4299).Text, obj), ];
