...
function SteamReviewRow(url) {
  ...
  const obj2 = url(8878);
  const items2 = [
    closure_7(url(8841).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }),
    closure_7(url(4636).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title }),
  ];
  ...
  if (tmp12Result) {
    ...
    tmp12Result = closure_7(tmp2(4636).Text, obj8);
  ...
  if (null != tier) {
    ...
    if (topCriticRating > 0) {
      ...
      if (num > 0) {
        ...
        const items4 = [closure_7(trackAction(8885), obj11)];
        ...
        obj12.children = closure_7(tmp11(4636).Text, obj13);
  ...
  if (topCriticRating <= 0) {
    ...
    if (null == tier) {
      const obj14 = {
        ...
        color: tmp11(8878).getSteamReviewScoreDescriptionColor(tmp11(1935).SteamReviewScoreDescription.NO_USER_REVIEWS),
        children: null,
      };
      const intl4 = tmp11(1115).intl;
      obj14.children = intl4.string(tmp11(1115).t["0xYzpO"]);
      tmp12Result2 = closure_7(tmp11(4636).Text, obj14);
