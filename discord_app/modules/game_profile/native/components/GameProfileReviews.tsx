...
function SteamReviewRow(url) {
  ...
  const obj2 = url(9007);
  const items2 = [
    closure_7(url(8970).SteamNeutralIcon, { size: "sm", color: trackAction(576).colors.ICON_STRONG }),
    closure_7(url(4753).Text, { variant: "heading-sm/medium", color: "mobile-text-heading-primary", children: title }),
  ];
  ...
  if (topCriticRating <= 0) {
    ...
    if (null == tier) {
      const obj14 = {
        ...
        color: tmp11(9007).getSteamReviewScoreDescriptionColor(tmp11(2019).SteamReviewScoreDescription.NO_USER_REVIEWS),
        children: null,
      };
