...
export default function GameProfileNavigationHeader(game) {
  ...
  sharedValue = game(4373).useSharedValue(num);
  ...
  const animatedStyle = game(4373).useAnimatedStyle(fn);
  const tmp3Result = game(4373);
  ...
  const animatedStyle1 = game(4373).useAnimatedStyle(fn2);
  ...
  if (null != name) {
    ...
    const items4 = [closure_7(tmp3(4632).Heading, obj7), ];
    let l30Rank;
    if (game != null) {
    ...
    if (tmp13Result) {
      ...
      const items5 = [closure_7(application(8841), obj9), ];
      const obj10 = { style: null, children: null };
      const items6 = [StyleSheet.absoluteFill, animatedStyle1];
      obj10.style = items6;
      const obj11 = { rank: game.l30Rank };
      obj10.children = closure_7(application(8841), obj11);
      items5[1] = closure_7(application(4373).View, obj10);
    ...
    if (tmp15Result2) {
      ...
      tmp15Result2 = closure_7(application(4373).View, obj12);
    }
