...
export default function GameProfileNavigationHeader(game) {
  ...
  if (null != name) {
    ...
    if (tmp13Result) {
      ...
      const items5 = [closure_7(application(8866), obj9), ];
      const obj10 = { style: null, children: null };
      const items6 = [StyleSheet.absoluteFill, animatedStyle1];
      obj10.style = items6;
      const obj11 = { rank: game.l30Rank };
      obj10.children = closure_7(application(8866), obj11);
      items5[1] = closure_7(application(4376).View, obj10);
    ...
    if (tmp15Result2) {
      ...
      tmp15Result2 = closure_7(application(4376).View, obj12);
    }
