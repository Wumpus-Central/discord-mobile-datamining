// === Module 9259: GameProfileNavigationHeader ===
...
export default function GameProfileNavigationHeader(game) {
  ...
  sharedValue = game(4559).useSharedValue(num);
  ...
  const animatedStyle = game(4559).useAnimatedStyle(fn);
  const tmp3Result = game(4559);
  ...
  const animatedStyle1 = game(4559).useAnimatedStyle(fn2);
  ...
  if (null != name) {
    ...
    const items2 = [closure_7(tmp3(9260).BackgroundBlurFill, {}), ];
    ...
    const items4 = [closure_7(tmp3(4823).Heading, obj7), ];
    let l30Rank;
    if (game != null) {
    ...
    if (tmp13Result) {
      ...
      const items5 = [closure_7(application(9066), obj9), ];
      const obj10 = { style: null, children: null };
      const items6 = [StyleSheet.absoluteFill, animatedStyle1];
      obj10.style = items6;
      const obj11 = { rank: game.l30Rank };
      obj10.children = closure_7(application(9066), obj11);
      items5[1] = closure_7(application(4559).View, obj10);
    ...
    if (tmp15Result2) {
      ...
      tmp15Result2 = closure_7(application(4559).View, obj12);
    }
