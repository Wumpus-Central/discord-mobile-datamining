// === Module 9188: GameProfileNavigationHeader ===
...
export default function GameProfileNavigationHeader(game) {
  ...
  sharedValue = game(4493).useSharedValue(num);
  ...
  const animatedStyle = game(4493).useAnimatedStyle(fn);
  const tmp3Result = game(4493);
  ...
  const animatedStyle1 = game(4493).useAnimatedStyle(fn2);
  ...
  if (null != name) {
    ...
    const items2 = [closure_7(tmp3(9189).BackgroundBlurFill, {}), ];
    ...
    if (tmp15Result) {
      ...
      obj4.source = obj5;
      obj4.style = tmp.icon;
      tmp15Result = closure_7(closure_4, obj4);
    }
    ...
    const items4 = [closure_7(tmp3(4753).Heading, obj7), ];
    let l30Rank;
    if (game != null) {
    ...
    if (tmp13Result) {
      ...
      const items5 = [closure_7(application(8995), obj9), ];
      const obj10 = { style: null, children: null };
      const items6 = [StyleSheet.absoluteFill, animatedStyle1];
      obj10.style = items6;
      const obj11 = { rank: game.l30Rank };
      obj10.children = closure_7(application(8995), obj11);
      items5[1] = closure_7(application(4493).View, obj10);
    ...
    if (tmp15Result2) {
      ...
      tmp15Result2 = closure_7(application(4493).View, obj12);
    }
    items3[2] = tmp15Result2;
    obj3.children = items3;
    items2[1] = closure_8(closure_5, obj3);
    obj2.children = items2;
    tmp13Result2 = closure_8(closure_5, obj2);
  }
  return tmp13Result2;
};