...
export default function GameProfileNavigationHeader(game) {
  ...
  if (null != name) {
    ...
    const items4 = [closure_7(tmp3(4601).Heading, obj4), ];
    let l30Rank;
    if (game != null) {
    ...
    if (tmp13Result) {
      ...
      const items5 = [closure_7(application(8786), obj6), ];
      const obj7 = { style: null, children: null };
      const items6 = [StyleSheet.absoluteFill, animatedStyle1];
      obj7.style = items6;
      const obj8 = { rank: game.l30Rank };
      obj7.children = closure_7(application(8786), obj8);
      items5[1] = closure_7(application(4341).View, obj7);
    ...
    if (tmp15Result) {
      ...
      tmp15Result = closure_7(application(4341).View, obj9);
    }
