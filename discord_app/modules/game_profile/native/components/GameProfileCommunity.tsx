...
export default function GameProfileCommunityServer(closeModal) {
  ...
  if (null != invite) {
    if (null != invite.guild) {
      ...
      const obj8 = { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: fromInviteGuildResult.name };
      ...
      const obj10 = { variant: "text-sm/medium", color: "text-default", lineClamp: 2, children: fromInviteGuildResult.description };
