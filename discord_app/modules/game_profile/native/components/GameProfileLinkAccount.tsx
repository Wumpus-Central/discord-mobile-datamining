...
let c9 = 48;
fn(4636);
let obj = { card: null, cardImagesContainer: null, ellipseGroup: null, ellipse: null, cardImageApplication: null, userAvatar: null, cardContent: null, cardText: null, skeletonCardImage: null, skeletonUserAvatar: null, skeletonEllipse: null, skeletonCardContent: null, skeletonAnimationRoot: null, skeletonCardImagesContainerSmall: null, skeletonCardContentHeading: null, skeletonCardContentBody: null, skeletonCardContentBodySecondary: null };
obj = { borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, padding: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_16 };
obj.card = obj;
...
let obj4 = { gap: nativeDefault.space.PX_4, alignSelf: "center", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingHorizontal: nativeDefault.space.PX_24 };
            ...
            if (!hasAlreadyLinked) {
              if (fetched) {
                ...
                if (null != iconSource) {
                  ...
                  const obj7 = { size: trackAction(tmp3[15]).AvatarSizes.LARGE_48, user: stateFromStores, guildId: "Array", style: tmp.userAvatar };
                ...
                const obj9 = { variant: "heading-md/semibold", color: "mobile-text-heading-primary", style: tmp.cardText, children: null };
