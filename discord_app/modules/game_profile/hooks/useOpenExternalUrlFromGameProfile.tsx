    ...
    if (c4 === 2) {
      ...
      try {
        ...
        if (0 === c3) {
          ...
          if (1 === tmp5) {
            ...
            if (null != closure_129_2) {
              ...
              c4 = 3;
              obj = { value: closure_130_0(closure_130_2[4]).buildXboxGamePassStoreDeepLinkUrl(decodeURIComponent(closure_129_2)), done: true };
              return obj;
            }
          }
          c4 = 3;
        ...
        if (closure_129_0.hostname === closure_130_0(closure_130_2[4]).XBOX_GAME_PASS_STORE_HOSTNAME) {
          ...
          c3 = 2;
          c4 = 1;
          const obj5 = { value: obj4.isProtocolRegistered(closure_130_0(closure_130_2[4]).XBOX_GAME_PASS_PROTOCOL), done: false };
          return obj5;
        }
      } catch (tmp37) {
        c4 = tmp;
