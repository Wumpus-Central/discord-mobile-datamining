...
let items = [
  fn(8815).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8815).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8815).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8815).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8815).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8815).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8815).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
