...
let items = [
  fn(8959).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8959).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8959).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8959).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8959).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8959).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8959).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
