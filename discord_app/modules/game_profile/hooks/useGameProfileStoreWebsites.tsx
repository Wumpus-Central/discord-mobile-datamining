...
let items = [
  fn(8689).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8689).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8689).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8689).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8689).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8689).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8689).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          let obj = {
