...
let items = [
  fn(8920).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8920).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8920).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8920).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8920).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8920).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8920).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
