...
let items = [
  fn(8836).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8836).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8836).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8836).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8836).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8836).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8836).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
