...
let items = [
  fn(8134).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8134).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8134).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8134).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8134).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8134).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8134).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
