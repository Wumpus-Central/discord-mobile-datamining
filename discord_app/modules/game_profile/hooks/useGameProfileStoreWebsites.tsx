...
let items = [
  fn(8960).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8960).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8960).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8960).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8960).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8960).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8960).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
