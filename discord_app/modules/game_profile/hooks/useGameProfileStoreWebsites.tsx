...
let items = [
  fn(8824).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8824).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8824).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8824).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8824).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8824).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8824).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
