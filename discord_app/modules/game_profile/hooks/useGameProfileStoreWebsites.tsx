...
let items = [
  fn(8965).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8965).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8965).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8965).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8965).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8965).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8965).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
