...
let items = [
  fn(8142).ThirdPartyGameApplicationWebsiteCategory.EPICGAMES,
  fn(8142).ThirdPartyGameApplicationWebsiteCategory.STEAM,
  fn(8142).ThirdPartyGameApplicationWebsiteCategory.ROBLOX,
  fn(8142).ThirdPartyGameApplicationWebsiteCategory.BATTLENET,
  fn(8142).ThirdPartyGameApplicationWebsiteCategory.RIOT,
  fn(8142).ThirdPartyGameApplicationWebsiteCategory.MINECRAFT,
];
const size = fn(2);
      ...
      if (null != id1) {
        ...
        if (!someResult) {
          someResult = found.some(
            (category) => category.category === steamWebsiteUrl(8142).ThirdPartyGameApplicationWebsiteCategory.STEAM,
          );
        }
        if (!someResult) {
          const obj = {
