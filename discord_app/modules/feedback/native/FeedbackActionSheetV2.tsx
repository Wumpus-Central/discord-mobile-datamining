...
import RatingSelectorDefault from "RatingSelector" /* 11661 */;
...
export default function FeedbackActionSheetV2(optionsTree) {
  ...
  closure_5 = tmp5;
  let obj1 = _modDef12;
  const tmp7 = _slicedToArray(ref.useState(obj1.shuffle(optionsTree.map((problemOptions) => {
    const obj = {};
  ...
  if (null == first2) {
    ...
    if (null != ratingBody) {
      ...
      tmp35 = closure_7(tmp20(4570).Text, obj);
    }
    const items2 = [tmp35, , ];
    ...
    if (!hideDontShowAgainCheckbox) {
      ...
      tmp37Result = tmp37(tmp20(5618).TableCheckboxRow, obj1);
    }
    obj2 = { children: null };
    ...
    if (first2 !== first.GOOD) {
      if (null == first4) {
        ...
        obj4.children = closure_7(tmp20(5701).TableRowGroup, obj5);
        ...
        items3[1] = closure_7(tmp20(4989).Button, obj6);
    ...
    if (tmp23) {
      ...
      obj8.children = closure_7(tmp20(5701).TableRowGroup, obj9);
      ...
      items4[1] = closure_7(tmp20(4989).Button, obj10);
  ...
  if (showHeaderCloseButton) {
    const obj13 = { onPress };
    tmp40Result = tmp40(tmp20(7212).ActionSheetCloseButton, obj13);
  }
  obj12.trailing = tmp40Result;
  obj11.header = closure_7(optionsTree(7163).BottomSheetTitleHeader, obj12);
  ...
  obj11.children = closure_7(optionsTree(6641).BottomSheetScrollView, obj14);
  return closure_7(optionsTree(7164).BottomSheet, obj11);
};