...
import _modDef11112 from "../../../../_runtime/metro/11112__.js";
import _modDef11117 from "../../../../_runtime/metro/11117__.js";
    ...
    <closure_3 style={tmp2.ratings}>
      {mapped.map((rating) => {
        ...
        if (null != rating) {
          ...
          obj.children = jsx(textLabels(8047).RowButton, {
            accessibilityRole: "button",
            accessibilityLabel: getLabel(),
            accessibilityState: null,
            onPress: null,
          ...
          tmp14Result = jsx(
            textLabels(5428).PressableOpacity,
            {
              accessibilityRole: "button",
              accessibilityLabel: getLabel(),
              accessibilityState: null,
