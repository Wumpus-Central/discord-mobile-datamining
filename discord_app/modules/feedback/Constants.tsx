...
const items = [
  preloaded_user_settings.InAppFeedbackType.VIDEO_BACKGROUND,
  preloaded_user_settings.InAppFeedbackType.STREAM,
  preloaded_user_settings.InAppFeedbackType.ACTIVITY,
  preloaded_user_settings.InAppFeedbackType.VOICE,
  preloaded_user_settings.InAppFeedbackType.IN_APP_REPORTS,
  preloaded_user_settings.InAppFeedbackType.SEARCH_RESULTS,
...
export const AudioFeedbackOption = {
  FREEFORM: "FREEFORM",
  NO_AUDIO: "NO_AUDIO",
  ...
  TOO_QUIET: "TOO_QUIET",
  TOO_LOUD: "TOO_LOUD",
  TOO_QUIET_OR_LOUD: "TOO_QUIET_OR_LOUD",
  CUTTING: "CUTTING",
  DELAYED: "DELAYED",
  BACKGROUND_NOISE: "BACKGROUND_NOISE",
  UNABLE_TO_FIND_DEVICE: "UNABLE_TO_FIND_DEVICE",
  UNABLE_TO_FIND_INPUT_DEVICE: "UNABLE_TO_FIND_INPUT_DEVICE",
  UNABLE_TO_FIND_OUTPUT_DEVICE: "UNABLE_TO_FIND_OUTPUT_DEVICE",
  TROUBLE_WITH_SPEAKERPHONE: "TROUBLE_WITH_SPEAKERPHONE",
  COMPLAINTS: "COMPLAINTS",
  NO_GAME_AUDIO: "NO_GAME_AUDIO",
};
export const VideoFeedbackOption = {
  FREEFORM: "FREEFORM",
  NO_VIDEO: "NO_VIDEO",
  FREEZING_OR_HITCHING: "FREEZING_OR_HITCHING",
  BLURRY_OR_PIXELATED: "BLURRY_OR_PIXELATED",
  UNABLE_TO_ENABLE_DEVICE: "UNABLE_TO_ENABLE_DEVICE",
  DESYNC: "DESYNC",
};
export const VideoBackgroundFeedbackOption = {
  OUTLINE_FUZZY_OR_HALO: "OUTLINE_FUZZY_OR_HALO",
  INACCURATE_BACKGROUND_DETECTION: "INACCURATE_BACKGROUND_DETECTION",
  FLICKERING_ARTIFACTS: "FLICKERING_ARTIFACTS",
  LAG_ON_MOVEMENT: "LAG_ON_MOVEMENT",
};
export const StreamFeedbackOption = {
  FREEFORM: "FREEFORM",
