...
FeedbackConfig[FeedbackType.ACTIVITY] = {
  ...
  hotspot: fn(7316).HotspotLocations.POST_ACTIVITY_FEEDBACK,
...
FeedbackConfig[FeedbackType.IN_APP_REPORTS] = {
  ...
  hotspot: fn(7316).HotspotLocations.IN_APP_REPORTS_FEEDBACK,
...
FeedbackConfig[FeedbackType.VIBEGRATIONS] = {
  ...
  hotspot: fn(7316).HotspotLocations.VIBEGRATIONS_FEEDBACK,
