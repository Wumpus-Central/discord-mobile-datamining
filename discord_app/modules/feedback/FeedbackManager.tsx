...
obj2[FeedbackType.ACTIVITY] = {
  ...
  hotspot: fn(7320).HotspotLocations.POST_ACTIVITY_FEEDBACK,
...
obj2[FeedbackType.IN_APP_REPORTS] = {
  ...
  hotspot: fn(7320).HotspotLocations.IN_APP_REPORTS_FEEDBACK,
...
obj2[FeedbackType.VIBEGRATIONS] = {
  ...
  hotspot: fn(7320).HotspotLocations.VIBEGRATIONS_FEEDBACK,
