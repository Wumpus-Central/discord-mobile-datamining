...
FeedbackConfig[FeedbackType.ACTIVITY] = {
  cooldown: 0,
  chance: 0.5,
  group: FeedbackGroup.AV,
  hotspot: fn(7227).HotspotLocations.POST_ACTIVITY_FEEDBACK,
...
FeedbackConfig[FeedbackType.IN_APP_REPORTS] = {
  cooldown: 172800000,
  chance: 0.5,
  group: FeedbackGroup.SAFETY,
  hotspot: fn(7227).HotspotLocations.IN_APP_REPORTS_FEEDBACK,
...
FeedbackConfig[FeedbackType.VIBEGRATIONS] = {
  cooldown: 3600000,
  chance: 1,
  group: FeedbackGroup.BUILDER,
  hotspot: fn(7227).HotspotLocations.VIBEGRATIONS_FEEDBACK,
