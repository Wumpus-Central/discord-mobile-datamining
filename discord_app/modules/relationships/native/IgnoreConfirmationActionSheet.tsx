// === Module 10602: IgnoredInformationTable ===
...
const memoResult = importAllResult.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    obj9[0] = tmp4(4445).getName(stateFromStores1, channelId, stateFromStores);
    ...
    obj13[2] = closure_13(tmp7(5286).TableRow, obj14);
    obj12[1] = closure_13(tmp7(5620).TableRowGroup, obj13);
    ...
    obj18[3] = tmp3;
    obj18[4] = tmp3;
    const items9 = [closure_13(tmp7(4666).Button, obj18), ];
    ...
    obj4[0] = items8;
    obj[4] = closure_14(tmp7(5311).BottomSheetScrollView, obj4);
    obj[1] = closure_13(tmp7(5309).BottomSheet, obj);
    tmp12Result = tmp12(tmp7(5581).AnalyticsLocationProvider, obj);
    const tmp20 = stateFromStores1;
    const tmp4Result = tmp4(4445);
  }
  return tmp12Result;
});
