...
function IgnoredInformationTable() {
  ...
  obj[1] = items.map((icon) => {
    ...
    return callback2(callback(5413).TableRow, obj, arg1);
  });
...
const memoResult = importAllResult.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  const items = [channelId(5787).IGNORE_CONFIRMATION_ACTION_SHEET];
  let obj = userId(589);
  ...
  if (null != stateFromStores) {
    ...
    obj9[0] = tmp4(4533).getName(stateFromStores1, channelId, stateFromStores);
    obj8[4] = intl.format(tmp7(1236).t["WrQD/Y"], obj9);
    items7[1] = closure_13(tmp7(4340).Text, obj8);
    ...
    items7[2] = closure_13(tmp7(4340).Text, obj10);
    obj2[1] = items7;
    ...
    obj14[3] = closure_13(tmp7(4340).Text, obj16);
    ...
    obj13[2] = closure_13(tmp7(5413).TableRow, obj14);
    obj12[1] = closure_13(tmp7(5806).TableRowGroup, obj13);
    ...
    obj18[3] = tmp3;
    obj18[4] = tmp3;
    const items9 = [closure_13(tmp7(4754).Button, obj18), ];
    ...
    obj21[0] = function articleLink() {
      channelId(4312).hideActionSheet();
      const obj = channelId(4312);
      const articleURL = channelId(1993).getArticleURL(constants3.STEALTH_REMEDIATION_FEATURE_GUIDE);
      const obj2 = channelId(1993);
      channelId(4058).openURL(articleURL);
    };
    obj19[4] = intl8.format(tmp7(1236).t.iX9qtL, obj21);
    items9[1] = closure_13(tmp7(4340).Text, obj19);
    obj17[1] = items9;
    items8[3] = closure_14(stateFromStores, obj17);
    obj4[0] = items8;
    obj[4] = closure_14(tmp7(5438).BottomSheetScrollView, obj4);
    obj[1] = closure_13(tmp7(5436).BottomSheet, obj);
    tmp12Result = tmp12(tmp7(5767).AnalyticsLocationProvider, obj);
