...
import registerAssetDefault2 from "../../../../_runtime/08898_registerAsset.js";
...
function IgnoredInformationTable() {
  return callback2(TableRowGroupTitle.TableRowGroup, {
    ...
    children: items.map((icon) => {
      ...
      return callback2(callback(5599).TableRow, obj, arg1);
    }),
  });
}
let c4 = importAllResult;
({ BLOCK_CONFIRMATION_ACTION_SHEET_KEY: c9, RESTRICTION_CONFIRMATION_ACTION_SHEET_HEIGHT: c10 } =
...
const memoResult = importAllResult.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  items = [channelId(5973).IGNORE_CONFIRMATION_ACTION_SHEET];
  let obj = userId(589);
  ...
  if (null != stateFromStores) {
    ...
    obj14[5] = function onPress() {
      ...
      obj = {
        ...
        channelId,
        onSuccess: closure_3,
        impressionName: userId(closure_1_2[32]).ImpressionNames.BLOCK_USER_CONFIRMATION,
      };
      obj3.openLazy(userId(closure_1_2[31])(closure_1_2[30], closure_1_2.paths), closure_1_9, obj, "replaceTopSheet");
    };
    obj13[2] = closure_13(tmp7(5599).TableRow, obj14);
    obj12[1] = closure_13(tmp7(5992).TableRowGroup, obj13);
    ...
    obj18[2] = function onPress() {
      ...
      channelId(closure_1_2[34])
        .ignoreUser(userId, channelId(closure_1_2[19]).IGNORE_CONFIRMATION_ACTION_SHEET, channelId)
        .then(() => {
          if (closure_3 != null) {
            tmp();
          }
      ...
      const ignoreUserResult = channelId(closure_1_2[34]).ignoreUser(
        userId,
        channelId(closure_1_2[19]).IGNORE_CONFIRMATION_ACTION_SHEET,
        channelId,
      );
    ...
    obj4[0] = items8;
    obj[4] = closure_14(tmp7(5624).BottomSheetScrollView, obj4);
    obj[1] = closure_13(tmp7(5622).BottomSheet, obj);
    tmp12Result = tmp12(tmp7(5953).AnalyticsLocationProvider, obj);
