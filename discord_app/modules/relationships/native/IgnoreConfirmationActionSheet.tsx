...
import _modDef4713 from "../../../../_runtime/metro/04713__.js";
...
import _modDef8458 from "../../../../_runtime/metro/08458__.js";
  ...
  return map1(TableRowGroup.TableRowGroup, {
    ...
    children: items.map((icon, index) => {
      const obj = {
        ...
        icon: closure_1_13(native.Icon, { size: native.Icon.Sizes.MEDIUM, source: icon.icon }),
        label: icon.text(),
...
export default noop.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    function handleClose() {
      channelId(1241).track(constants2.USER_REMEDIATION_ACTION, {
        action: constants.DISMISS_IGNORE,
    ...
    const obj11 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(7214) };
    ...
    const obj13 = { username: tmp4(4909).getName(stateFromStores1, channelId, stateFromStores) };
    obj12.children = intl.format(tmp7(1115).t["WrQD/Y"], obj13);
    items7[1] = closure_13(tmp7(4753).Text, obj12);
    const obj14 = {
      style: tmp.subTitle,
    ...
    items7[2] = closure_13(tmp7(4753).Text, obj14);
    ...
    const obj19 = { size: tmp7(1177).Icon.Sizes.MEDIUM, source: tmp4(8192), color: tmp.destructiveIcon.color };
    ...
    obj18.subLabel = closure_13(tmp7(4753).Text, obj20);
    ...
    obj17.children = closure_13(tmp7(5824).TableRow, obj18);
    obj16.children = closure_13(tmp7(5906).TableRowGroup, obj17);
    ...
    obj22.onPress = function onPress() {
      _undefined(true);
      RelationshipActionCreatorsDefault.ignoreUser(
        userId,
        AnalyticsLocationDefault.IGNORE_CONFIRMATION_ACTION_SHEET,
        channelId,
      ).then(() => {
        if (onSuccess != null) {
          tmp();
      ...
      const ignoreUserResult = RelationshipActionCreatorsDefault.ignoreUser(
        userId,
        AnalyticsLocationDefault.IGNORE_CONFIRMATION_ACTION_SHEET,
        channelId,
      );
    ...
    obj22.disabled = tmp3;
    obj22.loading = tmp3;
    const items9 = [closure_13(tmp7(5187).Button, obj22)];
    const obj23 = {
      onPress: handleClose,
      style: null,
    ...
    items9[1] = closure_13(tmp7(4753).Text, obj23);
    obj21.children = items9;
    items8[3] = closure_14(stateFromStores, obj21);
    obj8.children = items8;
    obj4.children = closure_14(tmp7(6871).BottomSheetScrollView, obj8);
    obj3.children = closure_13(tmp7(7397).BottomSheet, obj4);
    tmp12Result = closure_13(tmp7(7409).AnalyticsLocationProvider, obj3);
