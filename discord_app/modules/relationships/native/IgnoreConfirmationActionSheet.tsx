...
export default noop.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    function handleClose() {
      channelId(1240).track(constants2.USER_REMEDIATION_ACTION, {
    ...
    const obj9 = {
      ...
      animate: false,
      size: tmp7(1176).AvatarSizes.XLARGE,
      style: tmp.avatar,
    };
    ...
    tmp12Result = closure_13(tmp7(7265).AnalyticsLocationProvider, obj3);
