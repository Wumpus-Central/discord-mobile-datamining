...
const memoResult = importAllResult.memo(function IgnoreConfirmationActionSheet(userId) {
  ...
  const items = [channelId(5669).IGNORE_CONFIRMATION_ACTION_SHEET];
  let obj = userId(589);
  ...
  if (null != stateFromStores) {
    ...
    obj13[2] = closure_13(tmp7(5354).TableRow, obj14);
    obj12[1] = closure_13(tmp7(5688).TableRowGroup, obj13);
    ...
    obj21[0] = function articleLink() {
      ...
      channelId(3981).openURL(articleURL);
    };
    ...
    obj4[0] = items8;
    obj[4] = closure_14(tmp7(5379).BottomSheetScrollView, obj4);
    obj[1] = closure_13(tmp7(5377).BottomSheet, obj);
    tmp12Result = tmp12(tmp7(5649).AnalyticsLocationProvider, obj);
