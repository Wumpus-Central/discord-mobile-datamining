...
const memoResult = importAllResult.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    if (!stateFromStores1) {
      ...
      obj12[2] = tmp13(tmp7(5354).TableRow, obj13);
      obj11[1] = tmp13(tmp7(5688).TableRowGroup, obj12);
    ...
    obj15[0] = items10;
    obj[4] = callback3(tmp7(5379).BottomSheetScrollView, obj15);
    obj[1] = closure_14(tmp7(5377).BottomSheet, obj);
    tmp13Result = tmp13(tmp7(5649).AnalyticsLocationProvider, obj);
