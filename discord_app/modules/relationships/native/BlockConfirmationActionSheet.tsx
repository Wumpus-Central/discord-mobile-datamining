...
let items = [
  {
    ...
    text() {
      ...
      return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.fjFJFV);
    },
    subtext() {
      const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
      return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["8SIMPz"]);
    },
    a11yLabel() {
      const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
      return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.qHsrGS);
    }
  },
,
...
items[1] = {
  ...
  text() {
    const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.QCrmqS);
  },
  subtext() {
    const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.TKDMoN);
  },
  a11yLabel() {
    const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.WR1Mbe);
  }
};
let obj8 = {
  icon: require("registerAsset"),
...
items[2] = {
  ...
  text() {
    const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["lkm/a8"]);
  },
  subtext() {
    const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["8j3qaC"]);
  },
  a11yLabel() {
    const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.lfrNw0);
  }
};
let obj9 = {
  icon: require("registerAsset"),
...
const memoResult = importAllResult.memo(function BlockConfirmationActionSheet(userId) {
  ...
  const items = [channelId(5630).IGNORE_CONFIRMATION_ACTION_SHEET];
  const tmp4 = channelId(5610);
  ...
  if (null != stateFromStores) {
    ...
    obj8[0] = tmp2(4474).getName(stateFromStores2, channelId, stateFromStores);
    obj7[4] = intl.format(tmp7(1236).t.CIbzHR, obj8);
    items9[1] = closure_14(tmp7(4281).Text, obj7);
    ...
    items9[2] = closure_14(tmp7(4281).Text, obj9);
    obj2[1] = items9;
    ...
    if (!stateFromStores1) {
      ...
      obj12[2] = tmp13(tmp7(5315).TableRow, obj13);
      obj11[1] = tmp13(tmp7(5649).TableRowGroup, obj12);
    ...
    obj17[4] = tmp6;
    obj17[5] = tmp6;
    const items11 = [closure_14(tmp7(4695).Button, obj17), ];
    ...
    obj19[0] = function articleLink() {
      channelId(4253).hideActionSheet();
      const obj = channelId(4253);
      const articleURL = channelId(1945).getArticleURL(constants2.STEALTH_REMEDIATION_FEATURE_GUIDE);
      const obj2 = channelId(1945);
      channelId(3982).openURL(articleURL);
    };
    obj18[3] = intl8.format(tmp7(1236).t.CpTgBn, obj19);
    items11[1] = closure_14(tmp7(4281).Text, obj18);
    obj16[1] = items11;
    items10[3] = callback3(c5, obj16);
    obj15[0] = items10;
    obj[4] = callback3(tmp7(5340).BottomSheetScrollView, obj15);
    obj[1] = closure_14(tmp7(5338).BottomSheet, obj);
    tmp13Result = tmp13(tmp7(5610).AnalyticsLocationProvider, obj);
