...
export default noop.memo(function BlockConfirmationActionSheet(userId) {
  ...
  if (null != stateFromStores) {
    ...
    if (!stateFromStores1) {
      ...
      obj17.children = closure_14(tmp7(5775).TableRow, obj18);
      obj16.children = closure_14(tmp7(5857).TableRowGroup, obj17);
    ...
    obj22.onPress = function onPress() {
      ...
      obj.blockUser(userId, { location: AnalyticsLocationDefault.BLOCK_CONFIRMATION_ACTION_SHEET }).then(() => {
        ...
        const tmpResult = channelId(4689);
      });
    ...
    tmp13Result2 = closure_14(tmp7(7358).AnalyticsLocationProvider, obj4);
    let tmp2Result = tmp2(4874);
  }
  return tmp13Result2;
});
