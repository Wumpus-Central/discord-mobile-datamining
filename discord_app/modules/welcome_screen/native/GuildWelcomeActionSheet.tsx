...
export default function GuildWelcomeActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    if (null != welcomeScreen) {
      ...
      obj1 = { style: tmp.guildIcon, guild: stateFromStores, size: onHide(12788).Sizes.MEDIUM, textScale: 2 };
      const items9 = [closure_17(onHide(12788), obj1), , , ,];
      ...
      items9[1] = closure_17(tmp2(4632).Text, obj2);
      const obj4 = {
      ...
      items9[2] = closure_17(tmp2(4632).Text, obj4);
      ...
      items9[3] = closure_17(tmp2(4632).Text, obj5);
      ...
      tmp12 = closure_17(tmp2(7300).ActionSheet, obj);
