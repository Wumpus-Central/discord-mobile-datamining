...
export const GAME_SERVER_TOS = { [require("../../../discord_common/js/shared/shared-constants/GameServerProviderType.tsx").GameServerProviderType.SHOCKBYTE]: "https://shockbyte.com/legal/acceptable-use-policy" };
