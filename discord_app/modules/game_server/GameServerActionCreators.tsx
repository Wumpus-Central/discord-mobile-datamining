// === Module 12482: GameServerActionCreators ===
...
import GameServerMocks from "GameServerMocks" /* 12484 */;
import GameServerStatus from "GameServerStatus" /* 12485 */;
import regionResponseToRegionDefault from "regionResponseToRegion" /* 12487 */;
import LocaleStore from "LocaleStore" /* 2025 */;
import UserStore from "UserStore" /* 1371 */;
import OwnedGameServersStore from "OwnedGameServersStore" /* 12483 */;
...
export const fetchGameServerCatalog = function fetchGameServerCatalog(guild_id) {
  ...
  if (flag) {
    ...
    let obj = { locale: LocaleStore.locale, guild_id, include_unpublished_products: flag2, include_unpublished_collection: flag2 };
    request.query = obj;
...
export const fetchGameServerInstructions = function fetchGameServerInstructions(guildId, skuId) {
  _require = guildId;
  require("StoreUtils");
  const request = { url: closure_8.STOREFRONT_PRODUCT_BY_SKU_ID(skuId), query: null, rejectWithError: true, retries: 3 };
...
export const wakeGameServer = function wakeGameServer(guildId, arg1) {
  ...
  return HTTP.post({ url: closure_8.GAME_SERVER_WAKE(guildId, arg1), rejectWithError: true }).then((body) => {
    const obj = { type: "GAME_SERVER_UPDATE_INSTANCE_SUCCESS", guildId, instance: gameServerResponseToInstanceDefault(body.body) };
    obj.dispatch(obj);
  });
};