// === Module 12042: fetchGameServerCatalog ===
...
import closure_5 from "handleGameServerUpsert" /* 12043 */;
import { GAME_SERVER_COLLECTION_ID } from "str11" /* 4268 */;
...
export const optimisticallyMarkGameServerResizing = function optimisticallyMarkGameServerResizing(arg0) {
  ...
  if (null != found) {
    ...
    obj.status = _require(12045).GameServerStatus.STARTING;
    obj[2] = obj;
    obj.dispatch(obj);
  }
};
