...
items4 = [...items1.map((item, index) => item.cost)];
const items5 = [obj, , , , , , , , , , , ];
...
items6 = [...items1.map((item, index) => item.cost)];
items5[1] = obj;
...
items7 = [...items1.map((item, index) => item.cost)];
items5[2] = obj;
const items8 = [...items1.map((item, index) => item.cost)];
...
const items9 = [...items1.map((item, index) => item.cost)];
...
const items10 = [...items1.map((item, index) => item.cost)];
...
const items11 = [...items1.map((item, index) => item.cost)];
...
const items12 = [...items1.map((item, index) => item.cost)];
...
const items13 = [...items1.map((item, index) => item.cost)];
...
const items14 = [...items1.map((item, index) => item.cost)];
...
const items15 = [...items1.map((item, index) => item.cost)];
...
const items16 = [...items1.map((item, index) => item.cost)];
...
const result = obj132.fileFinishedImporting("modules/game_server/mocks/GameServerMocks.tsx");
