        ...
        if (obj.isImageFile(filename)) {
          ...
          if (tmp8Result.isVideoFile(tmp7)) {
            ...
            if (tmp8Result.isAudioFile(tmp7)) {
              ...
              obj2[2] = tmp6;
              let tmp17 = callback;
              obj2[3] = callback(tmp8(9693).CirclePlayIcon, { size: "lg", color: "background-brand", secondaryColor: "white" });
              let str5 = null;
              if (isForward) {
                str5 = "forward";
              }
              ...
              obj2[3] = callback(tmp8(9698).FileIcon, obj3);
              let str4 = null;
              if (isForward) {
                str4 = "forward";
              }
