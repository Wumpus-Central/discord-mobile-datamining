...
let size = {
  shape: fn(8276).CutoutShape.RoundedRect,
  x: fn(5896).ImageSizes[fn(undefined, 5896).GuildIconSizes.NORMAL] - -6 - 24,
  y: -6,
  width: 24,
  height: 24,
...
export default function AlertNotification(notification) {
  ...
  obj5.children = closure_5(channel(8048).WarningIcon, {
