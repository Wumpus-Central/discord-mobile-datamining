...
let size = {
  shape: fn(8268).CutoutShape.RoundedRect,
  x: fn(5891).ImageSizes[fn(undefined, 5891).GuildIconSizes.NORMAL] - -6 - 24,
  y: -6,
  width: 24,
  height: 24,
...
export default function AlertNotification(notification) {
  ...
  obj5.children = closure_5(channel(8040).WarningIcon, {
