...
let size = {
  shape: fn(9093).CutoutShape.RoundedRect,
  x: fn(5796).ImageSizes[fn(undefined, 5796).GuildIconSizes.NORMAL] - -6 - 24,
  y: -6,
  width: 24,
  height: 24,
...
export default function AlertNotification(notification) {
  ...
  obj5.children = closure_5(channel(8865).WarningIcon, {
