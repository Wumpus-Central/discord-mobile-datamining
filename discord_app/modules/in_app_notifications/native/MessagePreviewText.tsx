...
function EmbedMediaThumbnail(media) {
  ...
  const obj = {
    style: null,
    children: React6(FastImageDefault, { source: { uri: url }, style: tmp.embedMedia, resizeMode: "contain" }),
  };
...
export default function MessagePreviewText(message) {
  ...
  const previewableMediaText = usePreviewableMediaText.usePreviewableMediaText({
    previewableMedia,
