...
export const ConfirmationToast = function ConfirmationToast(reaction) {
  ...
  let obj2 = notificationGestureY(4145);
  class A {
    constructor() {
      value = c1.get();
  ...
  obj = { animatedValue: sharedValue, interpolate: notificationGestureY(4145).interpolate, notificationGestureY, PAN_INPUT_RANGE: closure_5, extrapolateConfig: closure_4 };
  A.__closure = obj;
  ...
  if (null != animated) {
    ...
    let str = "";
    const emojiURL = getEmojiURL(5340);
    if (null == animated.id) {
