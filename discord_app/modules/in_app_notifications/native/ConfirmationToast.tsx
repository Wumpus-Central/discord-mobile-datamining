// discord_app/modules/in_app_notifications/native/ConfirmationToast.tsx
import "noop";
...
export const ConfirmationToast = function ConfirmationToast(reaction) {
  ...
  let obj2 = notificationGestureY(4116);
  class A {
    constructor() {
      value = c1.get();
  ...
  obj = { animatedValue: sharedValue, interpolate: notificationGestureY(4116).interpolate, notificationGestureY, PAN_INPUT_RANGE: closure_5, extrapolateConfig: closure_4 };
  A.__closure = obj;
