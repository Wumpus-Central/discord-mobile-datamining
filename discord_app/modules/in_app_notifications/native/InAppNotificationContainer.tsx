...
export default function InAppNotificationContainer(notification) {
  ...
  let obj6 = { startY: sharedValue2, notificationGestureY: sharedValue, velocityY: sharedValue1, runOnJS: notification(channelId[7]).runOnJS, setPanning: tmp11[1] };
  class K {
    constructor(arg0) {
  ...
  let fn = function q(translationY) {
    ...
    const obj3 = spring;
    const result1 = sharedValue.set(obj3.withSpring(0, { damping: 10, mass: 1, stiffness: 100, velocity: sharedValue1.get() }, "animate-always"));
