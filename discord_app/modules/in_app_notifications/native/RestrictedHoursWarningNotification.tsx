...
export default noop.memo(function RestrictedHoursWarningNotification(notification) {
  ...
  let obj = {
    ...
    children: jsx(notification(11572).ThemeDarkIcon, { size: "sm", color: type(576).colors.WHITE }),
  };
  ...
  let obj3 = {
    icon: (
      <View style={closure_9().iconContainer}>
        {jsx(notification(11572).ThemeDarkIcon, { size: "sm", color: type(576).colors.WHITE })}
      </View>
    ),
    header: memo,
    children: jsx(notification(4718).Text, {
