      ...
      if (!dependencyMap) {
        if (1 === arr.length) {
          ...
          if (message(10070).PreviewableMediaTypes.IMAGE === type) {
            ...
            return obj;
          } else if (message(10070).PreviewableMediaTypes.VIDEO === type) {
            ...
            return obj1;
          } else if (message(10070).PreviewableMediaTypes.AUDIO === type) {
            ...
            return obj3;
          } else if (message(10070).PreviewableMediaTypes.FILE === type) {
            ...
            return obj5;
          } else if (message(10070).PreviewableMediaTypes.STICKER === type) {
            ...
            return obj7;
          } else if (message(10070).PreviewableMediaTypes.VOICE_MESSAGE === type) {
            ...
            return obj9;
          } else if (message(10070).PreviewableMediaTypes.GIF === type) {
