// discord_app/modules/in_app_notifications/native/MessageReplyInput.tsx
import set from "set";
...
function AnimatedChatInputReplyBar(replying) {
  ...
  let obj = replying(1367);
  const tmp3 = createCacheKey();
  sharedValue = replying(4083).useSharedValue(0);
  ...
  obj = { interpolate: replying(4083).interpolate, sv: sharedValue, REPLY_BAR_HEIGHT: 40 };
  fn.__closure = obj;
  fn.__workletHash = 878601267127;
  fn.__initData = closure_13;
  const animatedStyle = replying(4083).useAnimatedStyle(fn);
  ...
  obj[1] = closure_10(tmp(10260).ChatInputReplyBar, { pendingReply, pendingReplyAuthor, onToggleReplyMention, chatInputFloatingOverride: true });
  return closure_10(sharedValue(4083).View, obj);
}
