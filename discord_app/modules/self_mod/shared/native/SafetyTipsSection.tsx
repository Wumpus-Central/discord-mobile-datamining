...
export default function SafetyTipsContainer(children) {
  ...
  obj[1] = callback(safetyTips(5936).SafetyBookletSpotIllustration, {});
  ...
  if (showHeader) {
    ...
    showHeader = tmp5(tmp3(4281).Text, obj);
  }
  obj = { spacing: 16, children: null };
  const obj1 = { spacing: 8, align: "center", justify: "center", children: null };
  const items1 = [showHeader, callback(safetyTips(4281).Text, { style: tmp.text, accessibilityRole: "header", variant: "text-md/medium", color: "text-default", children: children.description })];
  obj1[3] = items1;
  items[1] = closure_5(safetyTips(4693).Stack, obj1);
  ...
  obj[1] = items;
  return closure_5(safetyTips(4693).Stack, obj);
};