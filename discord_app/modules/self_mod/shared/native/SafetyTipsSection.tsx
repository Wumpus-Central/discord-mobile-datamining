...
export default function SafetyTipsContainer(children) {
  ...
  const tmp = closure_6();
  let obj = { style: tmp.image, children: closure_4(safetyTips(5773).SafetyBookletSpotIllustration, {}) };
  ...
  if (showHeader) {
    ...
    showHeader = closure_4(tmp3(4632).Text, obj);
  }
  ...
  items[1] = closure_5(safetyTips(5054).Stack, obj1);
  ...
  obj.children = items;
  return closure_5(safetyTips(5054).Stack, obj);
}
