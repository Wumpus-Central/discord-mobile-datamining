...
export default function SafetyTipsContainer(children) {
  ...
  const tmp = closure_6();
  let obj = { style: tmp.image, children: closure_4(safetyTips(5706).SafetyBookletSpotIllustration, {}) };
  ...
  if (showHeader) {
    ...
    showHeader = closure_4(tmp3(4570).Text, obj);
  }
  obj = { spacing: 16, children: null };
  const obj1 = { spacing: 8, align: "center", justify: "center", children: null };
  const items1 = [
    showHeader,
    closure_4(safetyTips(4570).Text, {
      style: tmp.text,
  ...
  items[1] = closure_5(safetyTips(4987).Stack, obj1);
  ...
  obj.children = items;
  return closure_5(safetyTips(4987).Stack, obj);
}
