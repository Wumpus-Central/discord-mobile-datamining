...
export default function SafetyTipsContainer(children) {
  ...
  const tmp = closure_6();
  const items = [
    closure_4(View, { style: tmp.image, children: closure_4(safetyTips(10919).SafetyBookletSpotIllustration, {}) }),
    ,
  ];
  if (showHeader) {
