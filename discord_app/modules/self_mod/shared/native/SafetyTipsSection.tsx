// === Module 11643: SafetyTipsSection ===
...
export default function SafetyTipsContainer(children) {
  ...
  const tmp = closure_6();
  const items = [closure_4(View, { style: tmp.image, children: closure_4(safetyTips(5911).SafetyBookletSpotIllustration, {}) }), , ];
  if (showHeader) {
    const obj2 = { style: tmp.text, variant: "heading-xl/semibold", children: null };
    const intl = tmp3(1115).intl;
    obj2.children = intl.string(tmp3(1115).t.eAbVfS);
    showHeader = closure_4(tmp3(4753).Text, obj2);
  }
  const obj3 = { spacing: 16, children: null };
  const obj4 = { spacing: 8, align: "center", justify: "center", children: null };
  const items1 = [showHeader, closure_4(safetyTips(4753).Text, { style: tmp.text, accessibilityRole: "header", variant: "text-md/medium", color: "text-default", children: children.description })];
  obj4.children = items1;
  items[1] = closure_5(safetyTips(5185).Stack, obj4);
  const obj = { style: tmp.image, children: closure_4(safetyTips(5911).SafetyBookletSpotIllustration, {}) };
  ...
  obj3.children = items;
  return closure_5(safetyTips(5185).Stack, obj3);
};