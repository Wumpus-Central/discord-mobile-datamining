// === Module 10425: SafetyTipsContainer ===
...
export default function SafetyTipsContainer(children) {
  ...
  const tmp = callback2();
  let obj = { style: tmp.image, children: callback(safetyTips(6136).SafetyBookletSpotIllustration, {}) };
  ...
  if (showHeader) {
    ...
    showHeader = tmp5(tmp3(4376).Text, obj);
  }
  obj = { spacing: 16, children: null };
  obj1 = { spacing: 8, align: "center", justify: "center", children: null };
  const items1 = [showHeader, callback(safetyTips(4376).Text, { style: tmp.text, accessibilityRole: "header", variant: "text-md/medium", color: "text-default", children: children.description })];
  obj1[3] = items1;
  items[1] = closure_5(safetyTips(4813).Stack, obj1);
  ...
  obj[1] = items;
  return closure_5(safetyTips(4813).Stack, obj);
};