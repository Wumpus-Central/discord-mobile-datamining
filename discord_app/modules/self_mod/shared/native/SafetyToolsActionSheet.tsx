...
import _modDef11495 from "../../../../../_runtime/metro/11495__.js";
...
export default function SafetyToolsActionSheet(channelId) {
  ...
  const memo = recipientId.useMemo(() => {
    ...
    obj2.icon = importDefault(stateFromStores1 ? 7042 : 7040);
    if (stateFromStores1) {
