// === Module 11409: SafetyToolsAboutActionSheet ===
...
export default function SafetyToolsAboutScreen(channelId) {
  ...
  const callback = disabled.useCallback(() => {
    ...
    obj = { channelId, warningId, warningType, senderId: recipientId, cta: SafetyWarningUtils.CtaEventTypes.USER_SAFETY_TOOLS_ABOUT_SAFETY_ALERTS_DISMISS, isNudgeWarning };
