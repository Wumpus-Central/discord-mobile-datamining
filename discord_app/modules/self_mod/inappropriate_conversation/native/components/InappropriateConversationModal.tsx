...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items2 = [callback2(trackAnalyticsEvent(4755).Button, obj3), ];
  ...
  items2[1] = callback2(trackAnalyticsEvent(4755).Button, obj4);
  obj2[1] = items2;
