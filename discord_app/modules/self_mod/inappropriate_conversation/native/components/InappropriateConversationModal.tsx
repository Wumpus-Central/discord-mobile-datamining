// === Module 16101: InappropriateConversationModal ===
...
import TakeActionScreenDefault from "TakeActionScreen" /* 16102 */;
...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items2 = [closure_13(trackAnalyticsEvent(5271).Button, obj6), ];
  ...
  items2[1] = closure_13(trackAnalyticsEvent(5271).Button, obj7);
  obj5.children = items2;
