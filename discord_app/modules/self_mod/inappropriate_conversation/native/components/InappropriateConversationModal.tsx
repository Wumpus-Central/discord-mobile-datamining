...
function IntroScreen(arg0) {
  ...
  let obj2 = require("../../../../../design/components/Navigator/native/useNavigation.native.tsx") /* useNavigation */;
  _slicedToArray = obj2.useNavigation();
  obj = { style: tmp.container, children: null };
  const items1 = [callback2(require("../../../../../design/assets/native.tsx") /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  obj1[3] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.sSMgC6);
  const items2 = [callback2(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj1), ];
  obj2 = { variant: "text-md/medium", style: tmp.takeoverDescription, children: null };
  const intl2 = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj2[2] = intl2.format(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.q2QrTY, { username: name });
  items2[1] = callback2(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj2);
  obj[1] = items2;
  ...
  obj4[2] = intl3.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t["+o4Q7e"]);
  obj4[4] = function onPress() {
    callback(outer1_0(outer1_2[15]).CtaEventTypes.USER_TAKEOVER_MODAL_TAKE_ACTION);
  };
  const items3 = [callback2(require("../../../../../design/components/Button/native/Button.native.tsx") /* Button */.Button, obj4), ];
  const obj5 = { variant: "secondary", size: "lg", text: null, grow: true, onPress: null };
  const intl4 = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj5[2] = intl4.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.xLkGzP);
  obj5[4] = function onPress() {
    callback(outer1_0(outer1_2[15]).CtaEventTypes.USER_TAKEOVER_MODAL_SAFETY_TIPS);
  };
  items3[1] = callback2(require("../../../../../design/components/Button/native/Button.native.tsx") /* Button */.Button, obj5);
  obj3[1] = items3;
...
function TakeActionScreen(arg0) {
  ...
  const intl = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[3] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t["mWO+ys"]);
  ...
  const intl2 = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[2] = intl2.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.S0XtKF);
  items[1] = callback2(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj1);
  obj[1] = items;
  const items1 = [callback3(closure_7, obj), callback2(require("TakeActionScreen.tsx"), { senderId, channelId, isReported, setReported, trackAnalyticsEvent })];
  obj[1] = items1;
  return callback3(closure_7, obj);
}
function SafetyTipsScreen() {
  ...
  const intl = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[1] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.DJMZX6);
  const tmp2 = require("../../../shared/native/SafetyTipsSection.tsx");
...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items2 = [callback2(trackAnalyticsEvent(4695).Button, obj3), ];
  ...
  items2[1] = callback2(trackAnalyticsEvent(4695).Button, obj4);
  obj2[1] = items2;
