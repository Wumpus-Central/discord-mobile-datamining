...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items1 = [closure_13(trackAnalyticsEvent(4632).Text, obj), ];
  const obj1 = { variant: "text-md/medium", style: tmp.takeoverDescription, children: null };
  const intl2 = trackAnalyticsEvent(1114).intl;
  obj1.children = intl2.string(trackAnalyticsEvent(1114).t.uicS5l);
  items1[1] = closure_13(trackAnalyticsEvent(4632).Text, obj1);
  obj.children = items1;
  ...
  const items2 = [closure_13(trackAnalyticsEvent(5056).Button, obj3), ];
  ...
  items2[1] = closure_13(trackAnalyticsEvent(5056).Button, obj4);
