...
function IntroScreen(arg0) {
  ...
  let obj2 = useNavigation /* useNavigation */;
  _slicedToArray = obj2.useNavigation();
  obj = { style: tmp.container, children: null };
  const items1 = [callback2(AccountAgeTier10LargeBadge /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  obj1[3] = intl.string(getSystemLocale /* getSystemLocale */.t.sSMgC6);
  const items2 = [callback2(Text /* Text */.Text, obj1), ];
  obj2 = { variant: "text-md/medium", style: tmp.takeoverDescription, children: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj2[2] = intl2.format(getSystemLocale /* getSystemLocale */.t.q2QrTY, { username: name });
  items2[1] = callback2(Text /* Text */.Text, obj2);
  obj[1] = items2;
...
function TakeActionScreen(arg0) {
  ...
  const intl = getSystemLocale /* getSystemLocale */.intl;
  obj[3] = intl.string(getSystemLocale /* getSystemLocale */.t["mWO+ys"]);
  const items = [callback2(Text /* Text */.Text, obj), ];
  const obj1 = { variant: "text-md/medium", style: tmp.takeoverDescription, children: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj1[2] = intl2.string(getSystemLocale /* getSystemLocale */.t.S0XtKF);
...
function SafetyTipsScreen() {
  ...
  const intl = getSystemLocale /* getSystemLocale */.intl;
  obj[1] = intl.string(getSystemLocale /* getSystemLocale */.t.DJMZX6);
