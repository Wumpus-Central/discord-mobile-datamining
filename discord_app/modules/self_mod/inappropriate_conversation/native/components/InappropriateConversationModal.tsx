...
function TakeActionScreen(arg0) {
  ...
  obj.children = items;
  const items1 = [closure_1_14(React5, obj), map1(TakeActionScreenDefault, { senderId, channelId, isReported, setReported, trackAnalyticsEvent })];
  obj.children = items1;
...
function SafetyTipsScreen() {
  ...
  obj.safetyTips = closure_1_12().map((children, index) => closure_1_13(Text_Text.Text, { variant: "text-sm/medium", children }, index));
...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items1 = [closure_13(trackAnalyticsEvent(4602).Text, obj), ];
  const obj1 = { variant: "text-md/medium", style: tmp.takeoverDescription, children: null };
  const intl2 = trackAnalyticsEvent(1114).intl;
  obj1.children = intl2.string(trackAnalyticsEvent(1114).t.uicS5l);
  items1[1] = closure_13(trackAnalyticsEvent(4602).Text, obj1);
  obj.children = items1;
  ...
  const items2 = [closure_13(trackAnalyticsEvent(5026).Button, obj3), ];
  ...
  items2[1] = closure_13(trackAnalyticsEvent(5026).Button, obj4);
...
fn(4606);
let createStyles = { container: null, warningText: null, ctaContainer: null, takeoverHeader: null, takeoverDescription: null, safetyTips: null };
createStyles = { display: "flex", alignItems: "center", justifyContent: "center", padding: nativeDefault.space.PX_32, gap: nativeDefault.space.PX_16, height: "100%" };
createStyles.container = createStyles;
createStyles.warningText = { marginBottom: nativeDefault.space.PX_16, display: "flex", alignItems: "center", gap: nativeDefault.space.PX_4 };
let obj1 = { marginBottom: nativeDefault.space.PX_16, display: "flex", alignItems: "center", gap: nativeDefault.space.PX_4 };
createStyles.ctaContainer = { display: "flex", alignItems: "center", alignSelf: "stretch", gap: nativeDefault.space.PX_16 };
