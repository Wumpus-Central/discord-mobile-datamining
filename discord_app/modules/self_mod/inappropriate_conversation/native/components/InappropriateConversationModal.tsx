...
import TakeActionButtonsDefault from "TakeActionButtons" /* 15349 */;
...
function CrisisTextLineScreen(trackAnalyticsEvent) {
  ...
  const items2 = [callback2(trackAnalyticsEvent(4879).Button, obj3), ];
  ...
  items2[1] = callback2(trackAnalyticsEvent(4879).Button, obj4);
  obj2[1] = items2;
