...
function IntroScreen(arg0) {
  ...
  const items1 = [callback2(require(5936) /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  const items2 = [callback2(require(4281) /* Text */.Text, obj1), ];
  ...
  items2[1] = callback2(require(4281) /* Text */.Text, obj2);
  obj[1] = items2;
  ...
  const items3 = [callback2(require(4695) /* Button */.Button, obj4), ];
  ...
  items3[1] = callback2(require(4695) /* Button */.Button, obj5);
  obj3[1] = items3;
...
function SafetyTipsScreen() {
  ...
  const tmp2 = importDefault(10272);
