...
export default function TakeActionButtons(senderId) {
  ...
  if (shouldShowHelplineLink) {
    const obj9 = { variant: "secondary", size: "lg", icon: tmp15(setReported[25]), text: null, grow: true, onPress: null };
    ...
    const obj11 = { variant: "secondary", size: "lg", icon: tmp15(setReported[26]), text: null, grow: true, onPress: null };
