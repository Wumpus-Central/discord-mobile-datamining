...
function handleChannelSelect(channelId) {
  ...
  if (null == channelId) {
        ...
        if (null != channel) {
          if (channel.isDM()) {
            ...
            if (flag3) {
              ...
              obj[3] = channelId;
              tmp4(16173).showTakeoverModal(obj);
              flag3 = true;
              const tmp4Result1 = tmp4(16173);
            }
            return flag3;
          }
        }
    ...
    obj6 = require(10143) /* InappropriateConversationExperiment */;
  }
}
function handleChannelUpdates(channels) {
  channels = channels.channels;
  let currentlySelectedChannelId;
  let obj = currentlySelectedChannelId(10143);
      ...
      if (null == currentlySelectedChannelId) {
        ...
        if (null == found) {
          ...
          if (!tmp6) {
            ...
            obj[3] = found.id;
            tmp(16173).showTakeoverModal(obj);
            flag3 = true;
            const tmpResult1 = tmp(16173);
          }
          return flag3;
        }
      }
