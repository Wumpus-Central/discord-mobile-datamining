        ...
        if (null != channel) {
          if (channel.isDM()) {
            ...
            if (flag3) {
              ...
              obj[3] = channelId;
              tmp4(16290).showTakeoverModal(obj);
              flag3 = true;
      ...
      if (null == currentlySelectedChannelId) {
        ...
        if (null == found) {
          ...
          if (!tmp6) {
            ...
            obj[3] = found.id;
            tmp(16290).showTakeoverModal(obj);
            flag3 = true;
            const tmpResult1 = tmp(16290);
          }
          return flag3;
        }
      }
