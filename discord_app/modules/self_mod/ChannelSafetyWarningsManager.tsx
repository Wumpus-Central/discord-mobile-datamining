// === Module 16840: handleChannelSelect ===
        ...
        if (null != channel) {
          if (channel.isDM()) {
            ...
            if (flag3) {
              ...
              obj[3] = channelId;
              tmp4(16841).showTakeoverModal(obj);
              flag3 = true;
              const tmp4Result1 = tmp4(16841);
            }
            return flag3;
          }
        }
      ...
      if (null == currentlySelectedChannelId) {
        ...
        if (null == found) {
          ...
          if (!tmp6) {
            ...
            obj[3] = found.id;
            tmp(16841).showTakeoverModal(obj);
            flag3 = true;
