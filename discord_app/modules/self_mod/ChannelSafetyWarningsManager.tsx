// === Module 17145: handleChannelSelect ===
        ...
        if (null != channel) {
          if (channel.isDM()) {
            ...
            if (flag3) {
              ...
              obj[3] = channelId;
              tmp4(17146).showTakeoverModal(obj);
              flag3 = true;
              const tmp4Result1 = tmp4(17146);
            }
            return flag3;
          }
        }
      ...
      if (null == currentlySelectedChannelId) {
        ...
        if (null == found) {
          ...
          if (!tmp6) {
            ...
            obj[3] = found.id;
            tmp(17146).showTakeoverModal(obj);
            flag3 = true;
            const tmpResult1 = tmp(17146);
          }
          return flag3;
        }
      }
