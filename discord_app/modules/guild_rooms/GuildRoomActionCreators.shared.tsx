            ...
            if (1 === tmp4) {
              ...
              if (arg0 === 1) {
                ...
                if (callback2 !== callback) {
                  ...
                  let obj18 = callback(8342);
                  let tmp67 = callback;
                  let tmp68 = dependencyMap;
                  let fireSurveyActionResult = obj18.fireSurveyAction(callback(8349).SurveyActionTypes.GUILD_ROOM_JOINED);
                  let tmp70 = users;
                  users = users.users;
...
function _createGuildRoomNote() {
  ...
  const tmp = callback((arg0, arg1, arg2, arg3) => {
    ...
    return (function*(arg0, arg1, arg2, arg3) {
      ...
      obj1[0] = callback(12902).GuildRoomObjectTypes.NOTE;
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            lib = arg1;
            dependencyMap = callback(12901).serverGuildRoomToClient(lib.body);
            const obj5 = callback(12901);
