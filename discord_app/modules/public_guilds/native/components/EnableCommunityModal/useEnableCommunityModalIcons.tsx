...
Object.defineProperty(prototype, "safetyCheck", {
  get: function safetyCheck() {
    if (obj.isThemeDark(this.theme)) {
      let tmpResult = require("../../../../../../_runtime/metro/17784__.js");
    } else {
      tmpResult = require("../../../../../../_runtime/metro/17785__.js");
    }
    return tmpResult;
  },
  set: undefined,
...
Object.defineProperty(prototype, "finishingTouches", {
  get: function finishingTouches() {
    if (obj.isThemeDark(this.theme)) {
      let tmpResult = require("../../../../../../_runtime/metro/17790__.js");
    } else {
      tmpResult = require("../../../../../../_runtime/metro/17791__.js");
    }
    return tmpResult;
  },
  set: undefined,
