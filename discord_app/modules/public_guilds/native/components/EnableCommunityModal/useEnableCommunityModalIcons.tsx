...
Object.defineProperty(prototype, "safetyCheck", {
  get: function safetyCheck() {
    if (obj.isThemeDark(this.theme)) {
      let tmpResult = require("../../../../../../_runtime/metro/17878__.js");
    } else {
      tmpResult = require("../../../../../../_runtime/metro/17879__.js");
    }
    return tmpResult;
  },
  set: undefined,
...
Object.defineProperty(prototype, "finishingTouches", {
  get: function finishingTouches() {
    if (obj.isThemeDark(this.theme)) {
      let tmpResult = require("../../../../../../_runtime/metro/17884__.js");
    } else {
      tmpResult = require("../../../../../../_runtime/metro/17885__.js");
    }
    return tmpResult;
  },
  set: undefined,
...
Object.defineProperty(prototype, "close", {
  get: function close() {
    return require("../../../../../../_runtime/metro/07102__.js");
  },
  set: undefined,
});
const size = fn(2);
