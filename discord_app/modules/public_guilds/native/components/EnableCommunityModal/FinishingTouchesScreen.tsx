...
export default function FinishingTouchesScreen() {
  ...
  const callback1 = obj.useCallback((features) => {
    ...
    if (null != everyoneRole) {
      ...
      first(9132).saveGuild(features.id, obj);
  ...
  obj = { headerRef: ref, currentStep: tmp2(17758).EnableCommunityModalSteps.STEP_3, onSuccess: callback1, disableNextStep: !first1, buttonText: null, children: null };
  ...
  const items2 = [closure_16(guild(4601).Text, obj1), , , ];
  ...
  items2[2] = closure_16(guild(4601).Heading, obj3);
  ...
  items2[3] = closure_16(guild(4601).Text, obj4);
  obj.children = items2;
  ...
  obj10.children = closure_16(guild(7252).TableSwitchRow, obj11);
  items4[1] = closure_16(tmp4Result, obj10);
  obj9.children = items4;
  const items5 = [closure_17(guild(5737).TableRowGroup, obj9), ];
  ...
  obj13.children = closure_16(guild(7252).TableSwitchRow, obj14);
  items5[1] = closure_16(guild(5737).TableRowGroup, obj13);
  obj5.children = items5;
  items3[1] = closure_17(guild(5023).Stack, obj5);
  ...
  items3[2] = closure_16(guild(4601).Text, obj15);
  obj.children = items3;
  return closure_17(guild(17758).EnableCommunityModalScreen, obj);
};