...
export default function FinishingTouchesScreen() {
  ...
  let obj4 = {
    headerRef: ref,
    currentStep: guild(17780).EnableCommunityModalSteps.STEP_3,
    onSuccess: callback1,
  ...
  const items2 = [
    closure_16(guild(4632).Text, obj6),
  ...
  obj21.typesOfGuilds = defaultMessageNotifications(2024).getArticleURL(
