// === Module 11980: PublicGuildAnnouncementProfile ===
...
import PublicGuildsUtils from "PublicGuildsUtils" /* 8379 */;
...
export default function PublicGuildAnnouncementProfile() {
  ...
  const items1 = [React4(native.Icon, { source: _modDef11981, disableColor: true }), ];
