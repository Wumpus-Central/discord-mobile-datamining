...
export default function PublicGuildAnnouncementProfile() {
  ...
  let obj3 = isPublicSystemMessage /* isPublicSystemMessage */;
  ...
  obj4[3] = intl2.string(getSystemLocale /* getSystemLocale */.t.BUZ0sl);
  ...
  obj5[3] = intl3.string(getSystemLocale /* getSystemLocale */.t.w5beJH);
  items[3] = callback(Text /* Text */.Text, obj5);
  obj[1] = items;
