...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [callback(markAsDismissed(4251).Text, obj3), callback(markAsDismissed(1297).Checkbox, { selected: true })];
  obj2[1] = items1;
  ...
  items2[1] = callback(markAsDismissed(4251).Text, obj4);
  ...
  items2[3] = callback(markAsDismissed(4251).Text, obj5);
  ...
  items2[5] = callback(markAsDismissed(4665).Button, obj6);
  obj[1] = items2;
  obj[1] = callback2(markAsDismissed(5325).BottomSheetScrollView, obj);
