// === Module 9740: MediaPostThumbnailActionSheet ===
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  items2[5] = callback(markAsDismissed(4666).Button, obj6);
  obj[1] = items2;
  obj[1] = callback2(markAsDismissed(5311).BottomSheetScrollView, obj);
