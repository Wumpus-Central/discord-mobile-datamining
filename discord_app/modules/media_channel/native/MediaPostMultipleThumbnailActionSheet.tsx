// === Module 10265: MediaPostMultipleThumbnailActionSheet ===
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4556).Text, obj3), closure_5(markAsDismissed(1178).Checkbox, { selected: true })];
