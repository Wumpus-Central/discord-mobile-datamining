...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4601).Text, obj3), closure_5(markAsDismissed(1178).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4601).Text, obj4);
  ...
  items2[3] = closure_5(markAsDismissed(4601).Text, obj5);
  ...
  items2[5] = closure_5(markAsDismissed(5025).Button, obj6);
  obj.children = items2;
