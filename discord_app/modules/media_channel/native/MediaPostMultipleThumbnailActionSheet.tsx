...
fn(4606);
let createStyles = { container: null, topContainer: null, setAsThumbnailContainer: null, contentContainer: null, title: null, description: null };
createStyles = { flex: 1, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH, padding: 24 };
createStyles.container = createStyles;
createStyles.topContainer = { flex: 1, width: "100%", paddingVertical: 40, paddingHorizontal: 12, backgroundColor: nativeDefault.colors.TEXT_FEEDBACK_WARNING, borderRadius: nativeDefault.radii.sm };
let obj1 = { flex: 1, width: "100%", paddingVertical: 40, paddingHorizontal: 12, backgroundColor: nativeDefault.colors.TEXT_FEEDBACK_WARNING, borderRadius: nativeDefault.radii.sm };
createStyles.setAsThumbnailContainer = { flex: 1, flexDirection: "row", padding: 12, width: "100%", backgroundColor: nativeDefault.colors.BACKGROUND_MOD_NORMAL, borderRadius: nativeDefault.radii.sm, alignItems: "center", justifyContent: "space-between" };
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [closure_5(markAsDismissed(4602).Text, obj3), closure_5(markAsDismissed(1178).Checkbox, { selected: true })];
  ...
  items2[1] = closure_5(markAsDismissed(4602).Text, obj4);
  ...
  items2[3] = closure_5(markAsDismissed(4602).Text, obj5);
  ...
  items2[5] = closure_5(markAsDismissed(5026).Button, obj6);
  obj.children = items2;
  obj.children = closure_6(markAsDismissed(6698).BottomSheetScrollView, obj);
