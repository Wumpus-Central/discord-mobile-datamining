// === Module 10136: MediaPostThumbnailActionSheet ===
...
export default function MediaPostThumbnailActionSheet(markAsDismissed) {
  ...
  const items1 = [callback(markAsDismissed(4440).Text, obj3), callback(markAsDismissed(1297).Checkbox, { selected: true })];
  obj2[1] = items1;
  ...
  items2[1] = callback(markAsDismissed(4440).Text, obj4);
  ...
  items2[3] = callback(markAsDismissed(4440).Text, obj5);
  ...
  items2[5] = callback(markAsDismissed(4879).Button, obj6);
  obj[1] = items2;
  obj[1] = callback2(markAsDismissed(5571).BottomSheetScrollView, obj);
