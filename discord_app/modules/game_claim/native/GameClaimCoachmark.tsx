...
import importDefaultResult1 from "importDefaultResult1" /* 15744 */;
import importDefaultResult1Default from "importDefaultResult1" /* 15744 */;
import fetchUnclaimedGames from "fetchUnclaimedGames" /* 15745 */;
...
const memoResult = importAllResult.memo((arg0) => {
  ...
  if (null == coverImageUrl) {
    ...
    obj[3] = callback2(tmp2(5519).XSmallIcon, { size: "sm", color: "text-default" });
    const items = [callback2(tmp2(5036).PressableOpacity, obj), , , , ];
    obj1 = { imageSrc: null };
    ...
    obj6[3] = callback2(tmp2(8691).LinkExternalSmallIcon, { size: "xs", color: "white" });
    ...
    obj5[1] = callback2(tmp2(4896).Button, obj6);
    items[4] = callback2(View, obj5);
    obj[2] = items;
    return callback3(tmp2(5569).Card, obj);
  }
