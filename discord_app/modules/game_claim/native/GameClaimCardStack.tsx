...
export default function GameClaimCardStack(uri) {
  ...
  obj1[1] = callback(closure_3, { style: tmp.addIconWrapper, children: callback(require("../../../design/components/Icon/native/redesign/generated/PlusSmallIcon.tsx") /* PlusSmallIcon */.PlusSmallIcon, { size: "sm", color: "text-brand" }) });
