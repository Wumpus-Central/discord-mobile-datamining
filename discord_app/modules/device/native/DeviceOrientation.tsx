// === Module 8549: handleOrientationChange ===
...
import importDefaultResult from "get ActivityIndicator" /* 8550 */;
...
export const restoreDefaultOrientation = function restoreDefaultOrientation() {
  ...
  if (!tmpResult.isAndroid()) {
    if (tmpResult1.isIOS()) {
      tmp(4425).getSystemVersionMajor() >= 16;
