// === Module 9042: handleOrientationChange ===
...
import importDefaultResult from "get ActivityIndicator" /* 9043 */;
...
export const restoreDefaultOrientation = function restoreDefaultOrientation() {
  ...
  if (!tmpResult.isAndroid()) {
    if (tmpResult1.isIOS()) {
      tmp(4359).getSystemVersionMajor() >= 16;
      const tmpResult2 = tmp(4359);
    }
    tmpResult1 = tmp(500);
  }
  importDefaultResult.ignoreAutoRotate(false);
