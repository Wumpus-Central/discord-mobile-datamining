...
export const logDeviceState = function logDeviceState(thermalState) {
  if (null !== thermalState) {
    const logger2 = _getDeviceState /* _getDeviceState */.logger;
    logger2.info("Device State Information:");
    const logger3 = _getDeviceState /* _getDeviceState */.logger;
    const _HermesInternal = HermesInternal;
    logger3.info("- Thermal State: " + thermalState.thermalState);
    const logger4 = _getDeviceState /* _getDeviceState */.logger;
    const _HermesInternal2 = HermesInternal;
    logger4.info("- Battery Level: " + 100 * thermalState.batteryLevel + "%");
    const logger5 = _getDeviceState /* _getDeviceState */.logger;
    let str6 = "Disabled";
    ...
    const logger = _getDeviceState /* _getDeviceState */.logger;
