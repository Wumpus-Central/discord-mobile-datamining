...
function ContactSyncNameInputScreen() {
  ...
  return <View onNext={onNext} onRemoveName={function onRemoveName() {
    return onNext(null);
...
createStyles = { flex: 1, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, justifyContent: "center", paddingTop: fn(5732).NAV_BAR_HEIGHT + 32 };
