...
createStyles = { paddingTop: fn(5732).NAV_BAR_HEIGHT + 32 };
createStyles.container = createStyles;
createStyles.redesignContainer = { flex: 1, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, paddingTop: fn(5732).NAV_BAR_HEIGHT + 32 };
