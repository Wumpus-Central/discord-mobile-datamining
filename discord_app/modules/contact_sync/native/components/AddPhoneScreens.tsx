// === Module 12208: AddPhoneScreen ===

// Module 12208 (AddPhoneScreen)
import ThemesDefault from "Themes" /* 712 */;
import AddPhoneDefault from "AddPhone" /* 7738 */;
...
export const AddPhoneScreen = function AddPhoneScreen() {
  ...
  const items = [callback2(_require(4444).Text, obj), ];
