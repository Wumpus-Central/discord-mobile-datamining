// === Module 12174: AddPhoneScreen ===

// Module 12174 (AddPhoneScreen)
import ThemesDefault from "Themes" /* 712 */;
import AddPhoneDefault from "AddPhone" /* 7717 */;
...
export const AddPhoneScreen = function AddPhoneScreen() {
  ...
  const items = [callback2(_require(4442).Text, obj), ];
