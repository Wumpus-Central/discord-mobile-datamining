          ...
          if (closure_2) {
            if (null != closure_0) {
              if (null != closure_1) {
                ...
                c7 = 2;
                c8 = 1;
                const obj6 = { value: ContactSyncUtils.getContacts(closure_1), done: false };
                return obj6;
              }
            }
          }
...
export default function ContactSyncSettings() {
  ...
  if (isStaffResult) {
    ...
    const obj5 = {
      ...
      value: true,
      onValueChange: tmp(12159).adminDeleteContactSync,
    };
  ...
  if (null != contactSyncAccount) {
    ...
    const items3 = [closure_10(tmp(8045).FormDivider, {})];
    ...
    obj8.trailing = closure_10(tmp(8045).FormRow.Arrow, obj9);
    ...
    items3[1] = closure_10(tmp(8045).FormRow, obj8);
  ...
  obj11.children = intl4.format(contactSyncAccount(1115).t.BoR0dO, {
    onClick: contactSyncAccount(12159).handleOpenLearnMoreLink,
  });
  ...
  const items5 = [
    closure_10(contactSyncAccount(8045).FormSwitchRow, obj15),
    closure_10(contactSyncAccount(8045).FormDivider, {}),
  ];
