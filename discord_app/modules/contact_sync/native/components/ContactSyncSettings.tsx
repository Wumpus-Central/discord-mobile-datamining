...
export default function ContactSyncSettings() {
  ...
  if (isStaffResult) {
    ...
    const obj5 = {
      ...
      value: true,
      onValueChange: tmp(12810).adminDeleteContactSync,
    };
  ...
  if (null != contactSyncAccount) {
    ...
    obj8.trailing = closure_10(tmp(8716).FormRow.Arrow, obj9);
    ...
    items3[1] = closure_10(tmp(8716).FormRow, obj8);
  ...
  obj11.children = intl4.format(contactSyncAccount(1114).t.BoR0dO, {
    onClick: contactSyncAccount(12810).handleOpenLearnMoreLink,
  });
  ...
  const items5 = [
    closure_10(contactSyncAccount(8716).FormSwitchRow, obj15),
