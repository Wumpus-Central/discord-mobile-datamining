...
export default function ContactSyncSettings() {
  ...
  if (isStaffResult) {
    ...
    const obj5 = {
      ...
      value: true,
      onValueChange: tmp(12177).adminDeleteContactSync,
    };
  ...
  if (null != contactSyncAccount) {
    ...
    const items3 = [closure_10(tmp(8053).FormDivider, {})];
    ...
    obj8.trailing = closure_10(tmp(8053).FormRow.Arrow, obj9);
    ...
    items3[1] = closure_10(tmp(8053).FormRow, obj8);
  ...
  obj11.children = intl4.format(contactSyncAccount(1115).t.BoR0dO, {
    onClick: contactSyncAccount(12177).handleOpenLearnMoreLink,
  });
  ...
  const items5 = [
    closure_10(contactSyncAccount(8053).FormSwitchRow, obj15),
    closure_10(contactSyncAccount(8053).FormDivider, {}),
  ];
