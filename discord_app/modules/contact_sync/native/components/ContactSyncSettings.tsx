...
export default function ContactSyncSettings() {
  ...
  if (isStaffResult) {
    obj = { children: null };
    obj1 = { label: "STAFF ONLY - Find your friends deletion", value: true, onValueChange: tmp(12710).adminDeleteContactSync };
    const items1 = [closure_10(tmp(8626).FormSwitchRow, obj1), closure_10(tmp(8626).FormDivider, {})];
    obj.children = items1;
  ...
  items2[1] = closure_10(contactSyncAccount(8626).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
    let obj3 = { children: null };
    const items3 = [closure_10(tmp(8626).FormDivider, {}), ];
    ...
    obj4.trailing = closure_10(tmp(8626).FormRow.Arrow, obj5);
    ...
    items3[1] = closure_10(tmp(8626).FormRow, obj4);
  ...
  obj.children = items2;
  const items4 = [closure_12(contactSyncAccount(8626).FormSection, obj), , , ];
  const obj7 = { children: null };
  const intl4 = tmp(1114).intl;
  const hasFlagResult1 = contactSyncAccount(1384).hasFlag(setting, constants2.FIND_BY_EMAIL);
  obj7.children = intl4.format(contactSyncAccount(1114).t.BoR0dO, { onClick: contactSyncAccount(12710).handleOpenLearnMoreLink });
  items4[1] = closure_10(contactSyncAccount(8626).FormHint, obj7);
  const obj9 = { children: null };
  const intl5 = tmp(1114).intl;
  obj9.children = intl5.string(contactSyncAccount(1114).t.cW1nr9);
  items4[2] = closure_10(contactSyncAccount(8626).FormHint, obj9);
  ...
  const items5 = [closure_10(contactSyncAccount(8626).FormSwitchRow, obj11), closure_10(contactSyncAccount(8626).FormDivider, {}), ];
  ...
  items5[2] = closure_10(contactSyncAccount(8626).FormSwitchRow, obj12);
  obj10.children = items5;
  items4[3] = closure_12(contactSyncAccount(8626).FormSection, obj10);
