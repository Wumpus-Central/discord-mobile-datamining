...
export default function ContactSyncSettings() {
  ...
  obj7[0] = intl4.format(contactSyncAccount(1114).t.BoR0dO, {
  ...
  const items5 = [
    callback2(contactSyncAccount(8593).FormSwitchRow, obj11),
    callback2(contactSyncAccount(8593).FormDivider, {}),
  ];
