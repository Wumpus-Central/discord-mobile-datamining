...
export default function ContactSyncSettings() {
  ...
  if (isStaffResult) {
    obj = { children: null };
    obj1 = { label: "STAFF ONLY - Find your friends deletion", value: true, onValueChange: tmp(12684).adminDeleteContactSync };
    const items1 = [closure_10(tmp(8598).FormSwitchRow, obj1), closure_10(tmp(8598).FormDivider, {})];
    obj.children = items1;
  ...
  items2[1] = closure_10(contactSyncAccount(8598).FormSwitchRow, obj2);
  tmp10Result = null;
  if (null != contactSyncAccount) {
    let obj3 = { children: null };
    const items3 = [closure_10(tmp(8598).FormDivider, {}), ];
    ...
    obj4.trailing = closure_10(tmp(8598).FormRow.Arrow, obj5);
    ...
    items3[1] = closure_10(tmp(8598).FormRow, obj4);
  ...
  obj7.children = intl4.format(contactSyncAccount(1114).t.BoR0dO, { onClick: contactSyncAccount(12684).handleOpenLearnMoreLink });
  items4[1] = closure_10(contactSyncAccount(8598).FormHint, obj7);
  const obj9 = { children: null };
  const intl5 = tmp(1114).intl;
  obj9.children = intl5.string(contactSyncAccount(1114).t.cW1nr9);
  items4[2] = closure_10(contactSyncAccount(8598).FormHint, obj9);
  ...
  const items5 = [closure_10(contactSyncAccount(8598).FormSwitchRow, obj11), closure_10(contactSyncAccount(8598).FormDivider, {}), ];
  ...
  items5[2] = closure_10(contactSyncAccount(8598).FormSwitchRow, obj12);
