...
export default function ContactSyncSettings() {
  ...
  if (isStaffResult) {
    ...
    obj1 = {
      ...
      value: true,
      onValueChange: tmp(12680).adminDeleteContactSync,
    };
  ...
  obj7.children = intl4.format(contactSyncAccount(1114).t.BoR0dO, {
    onClick: contactSyncAccount(12680).handleOpenLearnMoreLink,
  });
  ...
  const items5 = [
    closure_10(contactSyncAccount(8593).FormSwitchRow, obj11),
    closure_10(contactSyncAccount(8593).FormDivider, {}),
  ];
