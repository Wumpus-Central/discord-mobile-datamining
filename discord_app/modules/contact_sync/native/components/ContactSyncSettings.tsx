...
export default function ContactSyncSettings() {
  ...
  if (isStaffResult) {
    obj = { children: null };
    obj1 = { label: "STAFF ONLY - Find your friends deletion", value: true, onValueChange: tmp(12773).adminDeleteContactSync };
  ...
  obj7.children = intl4.format(contactSyncAccount(1114).t.BoR0dO, { onClick: contactSyncAccount(12773).handleOpenLearnMoreLink });
  ...
  const items5 = [closure_10(contactSyncAccount(8684).FormSwitchRow, obj11), closure_10(contactSyncAccount(8684).FormDivider, {}), ];
