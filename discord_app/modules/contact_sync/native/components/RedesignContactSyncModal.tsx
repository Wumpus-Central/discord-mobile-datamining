      ...
      asyncGeneratorStep(async () => {
        if (c3 === 2) {
          ...
          try {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj4 = { value: tmp2(12746).startContactSync(closure_129_3), done: false };
            return obj4;
          } catch (tmp2) {
            c3 = tmp;
            throw tmp2;
  ...
  const effect1 = obj2.useEffect(() => {
    if (openSettingsSheet) {
      ...
      ActionSheetActionCreatorsDefault.openLazy(
        asyncRequireImpl(12757, dependencyMap.paths),
...
function ContactSyncNameInputScreen(navigateToLandingPage) {
  ...
  obj.children = closure_16(loading(12767), obj);
