...
function SuggestionRow(suggestion) {
  ...
  return callback(suggestion(8231).TableCheckboxRow, obj);
}
...
export default function ContactSyncSuggestions(friendSuggestions) {
  ...
  first = tmp4[0];
  React = tmp4[1];
  let obj3 = friendSuggestions(4671);
  ...
  obj[1] = memo;
  obj[2] = callback1;
  const items5 = [callback(friendSuggestions(7638).FlashList, obj), , ];
  ...
  obj2[4] = items;
  items5[1] = callback(onSubmit(4676), obj2);
  ...
  obj4[4] = !someResult;
  obj3[1] = callback(friendSuggestions(4665).Button, obj4);
