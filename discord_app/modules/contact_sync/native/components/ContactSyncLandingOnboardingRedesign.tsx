...
createStyles = { flex: 1, justifyContent: "center", alignItems: "center", textAlign: "center", marginTop: -nativeDefault.space.PX_32 - fn(5732).NAV_BAR_HEIGHT };
...
export default function ContactSyncLandingOnboardingRedesign(onNext) {
  ...
  items1[1] = closure_8(onNext(4601).Text, obj1);
  ...
  items1[2] = closure_8(onNext(4601).Text, obj2);
  ...
  obj3.children = closure_8(onNext(5025).Button, obj4);
