...
const prop = fn(15286).HCAPTCHA_DIFFICULTY_OPTIONS;
const options = prop.map((label) => ({ name: label.label, value: label.value }));
let items = [fn(15287).CaptchaDeciderType.HCAPTCHA_RQDATA, fn(15287).CaptchaDeciderType.SMITE_RQDATA];
const set = new Set(items);
const prop1 = fn(15286).CAPTCHA_DECIDER_TYPE_OPTIONS;
