...
const memoResult1 = importAllResult.memo((useTier0UpsellContent) => {
  ...
  if (isSectionNitroLocked) {
    ...
    isSectionNitroLocked = callback(require(9541) /* PremiumUpsellGradientBackground */.PremiumUpsellGradientBackground, obj);
  }
  ...
  if ("" !== label) {
    ...
    obj[3] = label;
    tmp6 = callback(require(4251) /* Text */.Text, obj);
  }
  items[1] = tmp6;
  obj[1] = items;
