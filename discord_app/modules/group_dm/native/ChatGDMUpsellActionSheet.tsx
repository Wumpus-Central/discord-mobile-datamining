...
export default function ChatGDMUpsellActionSheet(onClick) {
  ...
  obj = { source: _modDef11675, resizeMode: "contain" };
  ...
  const items2 = [closure_5(onClick(5025).Button, obj3)];
  ...
  obj4.children = closure_5(onClick(5025).Button, obj5);
  ...
  const items3 = [closure_5(onClick(4601).Text, obj7), ,];
  ...
  items3[1] = closure_5(onClick(4601).Text, obj8);
  ...
  items4[1] = closure_5(onClick(4601).Text, obj12);
  obj10.children = items4;
  const items5 = [closure_6(View, obj10)];
  const obj13 = { style: tmp.secondInnerContainer, children: null };
  const obj11 = { style: tmp.item, children: closure_5(onClick(11676).TimerIcon, { size: "sm" }) };
  ...
  items6[1] = closure_5(onClick(4601).Text, obj15);
  obj13.children = items6;
  items5[1] = closure_6(View, obj13);
  obj9.children = items5;
  items3[2] = closure_6(View, obj9);
  obj6.children = items3;
  obj.children = closure_6(onClick(6677).BottomSheetScrollView, obj6);
