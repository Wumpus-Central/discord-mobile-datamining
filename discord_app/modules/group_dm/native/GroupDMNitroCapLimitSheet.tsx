// === Module 11927: GroupDMNitroCapLimitSheet ===
...
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11928 */;
import useGroupDMNitroUpsellActionDefault from "useGroupDMNitroUpsellAction" /* 11929 */;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  const groupDMNitroAudience = _location(11922).useGroupDMNitroAudience();
  importDefault = tmp6;
  ...
  let obj2 = _location(11922);
  obj4.acquisitionStrategy = _location(11922).GroupDMNitroAcquisitionStrategy.CHECKOUT;
  ...
  const items3 = [closure_11(_location(4823).Text, obj6), , ];
  ...
  items3[1] = closure_11(_location(4823).Text, obj8);
  ...
  obj11.text = intl3.string(_location(11922).getGroupDMNitroCapCTAMessage(groupDMNitroAudience));
  const tmp2Result = _location(11922);
  obj11.icon = closure_11(_location(9016).NitroWheelIcon, { style: tmp.nitroWheelIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: "custom" });
  ...
  obj11.onPress = tmp16;
  const items4 = [closure_11(_location(5271).Button, obj11), ];
  ...
  items4[1] = closure_11(_location(5271).Button, obj14);
  obj10.children = items4;
  items3[2] = closure_12(View, obj10);
  obj5.children = items3;
  obj13.children = closure_12(View, obj5);
  return closure_11(_location(7481).BottomSheet, obj13);
};