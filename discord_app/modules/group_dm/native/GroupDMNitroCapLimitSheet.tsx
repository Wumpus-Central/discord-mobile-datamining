// === Module 11847: GroupDMNitroCapLimitSheet ===
...
import PremiumMarketingUtil from "PremiumMarketingUtil" /* 11848 */;
...
export default function GroupDMNitroCapLimitSheet(location) {
  ...
  obj11.icon = closure_11(_location(8940).NitroWheelIcon, { style: tmp.nitroWheelIcon, color: nativeDefault.unsafe_rawColors.WHITE, size: "custom" });
