...
fn(4560);
let createStyles = { wrapper: null, pill: null, iconContainer: null, trailing: null, gradientClip: null, border: null, text: null };
createStyles = { backgroundColor: nativeDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND, paddingHorizontal: nativeDefault.space.PX_16, paddingTop: nativeDefault.space.PX_8, paddingBottom: nativeDefault.space.PX_16 };
createStyles.wrapper = createStyles;
createStyles.pill = { flexDirection: "row", alignItems: "center", paddingVertical: nativeDefault.space.PX_12, paddingHorizontal: nativeDefault.space.PX_12, backgroundColor: nativeDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND };
let obj1 = { flexDirection: "row", alignItems: "center", paddingVertical: nativeDefault.space.PX_12, paddingHorizontal: nativeDefault.space.PX_12, backgroundColor: nativeDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND };
createStyles.iconContainer = { width: nativeDefault.modules.mobile.TABLE_ROW_ICON_SIZE, alignItems: "center", justifyContent: "center", marginEnd: nativeDefault.modules.mobile.TABLE_ROW_PADDING };
let obj2 = { width: nativeDefault.modules.mobile.TABLE_ROW_ICON_SIZE, alignItems: "center", justifyContent: "center", marginEnd: nativeDefault.modules.mobile.TABLE_ROW_PADDING };
...
export default function GroupDMNitroCapBanner(showLeadingIcon) {
  ...
  obj1.style = items2;
  const obj2 = { style: null, useAngle: true, angle: 110.47, colors: usePremiumPrimaryGradientColorsDefault(), locations };
