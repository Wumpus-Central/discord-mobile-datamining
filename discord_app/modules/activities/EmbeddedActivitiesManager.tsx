          ...
          if (null != currentUser) {
            ...
            if (tmp55 != null) {
              ...
              if (activity != null) {
                ...
                release_phase =
                  activity.client_platform_config[getPlatformDefault(undefined, tmp4Result14.getOS(tmp4Result14))]
                    .release_phase;
                const tmp54Result = getPlatformDefault;
              }
            }
...
let closure_32 = async function _trackFrameSessionStartFailed(arg0) {
  if (c7 === 2) {
    c7 = 3;
      ...
      if (0 === c6) {
        if (arg0 === 1) {
          ...
          if (null != tmp52) {
            ...
            c7 = 1;
            const obj6 = {
              value: activityLaunchErrorUtils.getActivityLaunchErrorInfo(closure_1, closure_0),
              done: false,
            };
            return obj6;
          } else {
        ...
        const obj8 = closure_133_1(closure_133_2[19]);
        obj7.raw_thermal_state = closure_133_1(closure_133_2[18]).getRawThermalState();
        ...
        obj8.track(closure_133_15.ACTIVITY_SESSION_JOIN_FAILED, obj7);
        closure_133_31(closure_132_0, closure_133_0(closure_133_2[31]).MetricEvents.FRAME_SESSION_JOIN_FAILED);
        const obj2 = closure_133_1(closure_133_2[18]);
      }
      c7 = 3;
...
({
  ...
  Endpoints: closure_17,
  RTCConnectionStates: closure_18,
  ComponentActions: closure_19,
  ApplicationFlags: closure_20,
} = Constants);
let dependencyMap = {};
  ...
  constructor() {
    ...
    applyArgumentsResult.handleSelectedChannelUpdate = function handleSelectedChannelUpdate() {
      ...
      while (iter !== undefined) {
        ...
        let obj2 = applyArgumentsResult(4458);
        ...
        const item = embeddedActivitiesForChannel.forEach((userIds) => {
          ...
          if (userIds.has(closure_0)) {
            const selfEmbeddedActivityForChannel = EmbeddedActivitiesStore.getSelfEmbeddedActivityForChannel(
              embeddedActivityLocationUtils.getEmbeddedActivityLocationChannelId(userIds.location),
            );
          ...
          if (0 === c5) {
            ...
            if (1 === getChannel) {
                ...
                if (undefined !== closure_131_5) {
                  ...
                  if (!set.has(type)) {
                    ...
                    if (getChannel !== closure_131_1) {
                      c5 = 2;
                      c6 = 1;
                      const obj5 = { value: getChannel(6584).fetchApplication(closure_131_1), done: false };
                      return obj5;
                    }
                  } else {
              ...
              if (arg0 === 1) {
                ...
                obj25 = applyArgumentsResult(8801);
              }
            } else {
              if (3 === getChannel) {
                if (arg0 === 1) {
                  ...
                  if (null == getChannel(8757)(obj9)) {
                    const obj11 = { guildId: closure_131_8, force: true };
                    c5 = 4;
                    c6 = 1;
                    const obj12 = { value: applyArgumentsResult(8782).fetchShelf(obj11), done: false };
                    return obj12;
                  }
                }
              ...
              if (dependencyMap > 0) {
                ...
                c5 = 6;
                c6 = 1;
                const obj20 = { value: applyArgumentsResult(8824).maybeJoinEmbeddedActivity(obj18), done: false };
                return obj20;
              } else {
                const obj21 = {
                ...
                c5 = 5;
                c6 = 1;
                const obj22 = { value: getChannel(10741)(obj21), done: false };
                return obj22;
              }
            }
            ...
            if (tmp56(supported_platforms)) {
              ...
              c5 = 3;
              c6 = 1;
              const obj24 = { value: applyArgumentsResult(8782).fetchShelf(obj23), done: false };
              return obj24;
            } else {
    ...
    if (null != currentUser) {
      ...
      if (tmp27 != null) {
        ...
        if (activity != null) {
          ...
          release_phase =
            activity.client_platform_config[getPlatformDefault(undefined, tmp2Result5.getOS(tmp2Result5))]
              .release_phase;
    ...
    if (null != currentUser) {
      ...
      if (tmp13 != null) {
        ...
        if (activity != null) {
          ...
          release_phase =
            activity.client_platform_config[getPlatformDefault(undefined, obj2.getOS(obj2))].release_phase;
