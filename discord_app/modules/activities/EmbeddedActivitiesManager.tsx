...
import getURLForApplication from "getURLForApplication" /* 9603 */;
import getShelfItemDataDefault from "getShelfItemData" /* 9611 */;
import ThermalUtilsDefault from "ThermalUtils" /* 9612 */;
import tryLaunchAsFrame from "tryLaunchAsFrame" /* 9614 */;
import pendingFrameLaunch from "pendingFrameLaunch" /* 9615 */;
import EmbeddedActivityLocationKind from "EmbeddedActivityLocationKind" /* 9616 */;
  ...
  if (c7 === 2) {
    ...
    try {
      ...
      if (0 === c6) {
        ...
        closure_132_8 = value;
        const obj2 = { channel_id: closure_132_2, guild_id: null, application_id: null, raw_thermal_state: null, is_activity_start: null, channel_type: null, location_stack: null, error_type: null, error_status: null, error_code: null, source: null, embedded_activity_location_kind: null };
...
export const trackFrameSessionStart = function trackFrameSessionStart(applicationId, analyticsContext) {
  ...
  if (null != tmp4) {
    ...
    if (null != currentUser) {
      ...
      const obj3 = { location_stack: analyticsLocations2, channel_id: channelId, channel_type: null, guild_id: null, application_id: null, instance_id: null, initial_media_session_id: null, activity_user_session_id: null, raw_thermal_state: null, is_activity_start: null, shelf_rank: null, shelf_sorted_rank: null, activities_infra_version: null, embedded_activity_location_kind: null };
      let type1;
      if (channel != null) {
        type1 = channel.type;
      }
