...
import getURLForApplicationDefault from "getURLForApplication" /* 9393 */;
import getPlatformDefault from "getPlatform" /* 9603 */;
import ContentClassificationEmbeddedActivityFilterExperiment2 from "ContentClassificationEmbeddedActivityFilterExperiment" /* 9698 */;
...
const isVoiceEmbeddedActivityDefault = combined(9693);
require = fn;
...
function updateEmbeddedActivities(content_classification) {
  ...
  if (null != tmp3) {
    const embeddedActivityLocationChannelId = application_id(4451).getEmbeddedActivityLocationChannelId(_location);
    ...
    mapped.some((item) => application_id(14344).isActivityParticipantCurrentUserCurrentSession(item));
      ...
      if (_location.id === value9.location.id) {
        if (application_id === value9.applicationId) {
          if (someResult) {
            ...
            const embeddedActivityLocationChannelId1 = application_id(4451).getEmbeddedActivityLocationChannelId(_location);
            if (null != embeddedActivityLocationChannelId1) {
              ...
              let str5 = application_id(4451).getEmbeddedActivityLocationGuildId(_location);
              if (str5 == null) {
                str5 = "0";
              }
              ...
              const tmp76Result4 = application_id(4451);
            }
            const tmp76Result = application_id(4451);
          } else {
            const _Array = Array;
            Array.from(value9.userIds);
          }
          map.delete(value9.applicationId);
          const ComponentDispatch = application_id(1110).ComponentDispatch;
      ...
      if (sessionId === AuthenticationStore.getSessionId()) {
        ...
        if (null != tmp36) {
          if (null != AuthenticationStore.getSessionId()) {
            ...
            if (id1 !== _location.id) {
              const embeddedActivityLocationChannelId2 = application_id(4451).getEmbeddedActivityLocationChannelId(_location);
              ...
              const tmp76Result5 = application_id(4451);
            }
          }
        }
        tmp78 = null == found;
    ...
    const obj19 = application_id(4451);
  }
}
