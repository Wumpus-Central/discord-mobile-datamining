...
function updateEmbeddedActivities(content_classification) {
  ...
  if (null != tmp3) {
    ...
    mapped.some((item) => application_id(14091).isActivityParticipantCurrentUserCurrentSession(item));
      ...
      if (_location.id === value9.location.id) {
        if (application_id === value9.applicationId) {
          if (someResult) {
            ...
            const embeddedActivityLocationChannelId1 = application_id(4266).getEmbeddedActivityLocationChannelId(_location);
            if (null != embeddedActivityLocationChannelId1) {
              ...
              let str5 = application_id(4266).getEmbeddedActivityLocationGuildId(_location);
              if (str5 == null) {
                str5 = "0";
              }
              ...
              const tmp76Result4 = application_id(4266);
            }
            const tmp76Result = application_id(4266);
          } else {
            const _Array = Array;
      ...
      if (sessionId === AuthenticationStore.getSessionId()) {
        ...
        if (null != tmp36) {
          if (null != AuthenticationStore.getSessionId()) {
            ...
            if (id1 !== _location.id) {
              const embeddedActivityLocationChannelId2 = application_id(4266).getEmbeddedActivityLocationChannelId(_location);
              ...
              const tmp76Result5 = application_id(4266);
            }
          }
        }
        tmp78 = null == found;
