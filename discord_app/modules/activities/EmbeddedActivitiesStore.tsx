...
function updateEmbeddedActivities(content_classification) {
  ...
  const tmp3 = importDefault(10659)(application_id);
  if (null != tmp3) {
      ...
      if (_location.id === value1.location.id) {
        if (application_id === value1.applicationId) {
          if (someResult) {
            ...
            if (null == value3) {
              if (typeof ActivityBucket !== "error") {
    ...
    if (someResult) {
      if (sessionId === obj3.getSessionId()) {
        ...
        const tmp36 = combined(10659)(application_id);
        if (null != tmp36) {
              ...
              if (null != currentUser.getCurrentUser()) {
                ...
                if (tmp76Result2.shouldOpenActivityInPopoutWindow()) {
                  ...
                  if (embeddedActivityLocationChannelId2 === channelId.getChannelId()) {
                    if (!combined(10617)(embeddedActivityLocationChannelId2)) {
    ...
    const someResult1 = mapped.some((userId) => application_id(13206).isActivityParticipantCurrentUserCurrentSession(userId));
  }
}
...
prototype["getItems"] = function getItems(arg0) {
  const self = this;
  const ContentClassificationEmbeddedActivityFilterExperiment = require(10713) /* apexExperiment */.ContentClassificationEmbeddedActivityFilterExperiment;
    ...
    if ("all" !== arg0) {
      if ("visible" === arg0) {
        ...
        if (cachedVisible == null) {
          ...
          const found = items.filter((contentClassification) => !callback(10714).isAgeRestrictedClassificationReference(contentClassification.contentClassification));
        ...
        if (cachedHidden == null) {
          const items1 = self.items;
          const found1 = items1.filter((contentClassification) => callback(10714).isAgeRestrictedClassificationReference(contentClassification.contentClassification));
...
prototype2["getConnectedActivityChannelId"] = function getConnectedActivityChannelId() {
  if (null != c29) {
    return require(3873) /* getEmbeddedActivityLocationChannelId */.getEmbeddedActivityLocationChannelId(c29);
  }
};
...
obj = {
  ...
  EMBEDDED_ACTIVITY_LAUNCH_START: function handleEmbeddedActivityLaunchStart(applicationId) {
    ...
    if (commandOrigin === require(6879) /* ApplicationCommandSectionType */.CommandOrigin.APP_DMS_ENTRY_POINT_COMMAND_BUTTON) {
  ...
  EMBEDDED_ACTIVITY_FETCH_SHELF_SUCCESS: function handleEmbeddedActivityFetchShelfSuccess(arg0) {
    ...
    importDefault = importDefault(8359)(obj.getOS());
  ...
  CHANNEL_SELECT: function handleChannelSelect(arg0) {
    if (null != c29) {
      const embeddedActivityLocationChannelId = require(3873) /* getEmbeddedActivityLocationChannelId */.getEmbeddedActivityLocationChannelId(c29);
