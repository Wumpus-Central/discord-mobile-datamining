// === Module 9640: EmbeddedActivityView ===
...
const memoResult = noop.memo(function EmbeddedActivityViewInner(portraitSafeAreasConfig) {
  ...
  if (null == currentEmbeddedActivity) {
    ...
    let tmp5Result = layoutMode(9642);
  ...
  obj1 = { orientationLockState: stateFromStores, showLoadingIndicator: tmp22, setShowLoadingStateForLockingOrientation: tmp9, application: tmp4, setOrientationLockState: layoutMode(9639).setOrientationLockState };
  ...
  if (null != currentEmbeddedActivity) {
    tmp28Result = null;
    if (null != id) {
      const obj2 = { wakeLockKey: "EmbeddedActivities", showLoadingIndicator: tmp22, isResetting: tmp25, children: null };
      const obj3 = {
        onActivityCrash() {
              setIsResetting(true);
      ...
      obj2.children = closure_13(tmp2(9647), obj3);
      tmp28Result = closure_13(BaseActivityView, obj2);
