...
const memoResult = noop.memo(function EmbeddedActivityViewInner(portraitSafeAreasConfig) {
  ...
  if (null == currentEmbeddedActivity) {
    ...
    const discordEnvQueryParams = layoutMode(9882).getDiscordEnvQueryParams();
    ...
    const tmp5Result = layoutMode(9882);
  }
  ...
  const obj5 = {
    ...
    application: tmp4,
    setOrientationLockState: layoutMode(9879).setOrientationLockState,
  };
  ...
  if (null != currentEmbeddedActivity) {
    ...
    if (null != id) {
      ...
      obj7.allowPopups = layoutMode(9895).allowPopups(tmp4);
      obj7.isPipOrGridMode = layoutMode === constants.PIP || layoutMode === constants.GRID;
      obj7.webViewKey = layoutMode(9753).EMBEDDED_ACTIVITY_WEB_VIEW_KEY;
      if (tmp26) {
      ...
      const tmp5Result2 = layoutMode(9895);
    }
  }
  return tmp28Result;
});
