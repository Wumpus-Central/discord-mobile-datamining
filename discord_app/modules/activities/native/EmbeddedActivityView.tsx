...
const memoResult = noop.memo(function EmbeddedActivityViewInner(portraitSafeAreasConfig) {
  ...
  if (null == currentEmbeddedActivity) {
    ...
    const discordEnvQueryParams = layoutMode(9724).getDiscordEnvQueryParams();
    ...
    const tmp5Result = layoutMode(9724);
  }
  ...
  const obj5 = {
    ...
    application: tmp4,
    setOrientationLockState: layoutMode(9721).setOrientationLockState,
  };
  ...
  if (null != currentEmbeddedActivity) {
    ...
    if (null != id) {
      ...
      obj7.allowPopups = layoutMode(9737).allowPopups(tmp4);
      obj7.isPipOrGridMode = layoutMode === constants.PIP || layoutMode === constants.GRID;
      obj7.webViewKey = layoutMode(9575).EMBEDDED_ACTIVITY_WEB_VIEW_KEY;
      if (tmp26) {
      ...
      const tmp5Result2 = layoutMode(9737);
    }
  }
  return tmp28Result;
});
