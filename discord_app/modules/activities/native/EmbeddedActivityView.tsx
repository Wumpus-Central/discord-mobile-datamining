...
const memoResult = noop.memo(function EmbeddedActivityViewInner(portraitSafeAreasConfig) {
  ...
  if (null == currentEmbeddedActivity) {
    ...
    const discordEnvQueryParams = layoutMode(9731).getDiscordEnvQueryParams();
    ...
    const tmp5Result = layoutMode(9731);
  }
  ...
  const obj5 = {
    ...
    application: tmp4,
    setOrientationLockState: layoutMode(9728).setOrientationLockState,
  };
  ...
  if (null != currentEmbeddedActivity) {
    ...
    if (null != id) {
      ...
      obj7.allowPopups = layoutMode(9744).allowPopups(tmp4);
      obj7.isPipOrGridMode = layoutMode === constants.PIP || layoutMode === constants.GRID;
      obj7.webViewKey = layoutMode(9582).EMBEDDED_ACTIVITY_WEB_VIEW_KEY;
      if (tmp26) {
      ...
      const tmp5Result2 = layoutMode(9744);
    }
  }
  return tmp28Result;
});
