...
import openActivityShareLinkModal from "../openActivityShareLinkModal.native.tsx";
...
export default function ActivityShareLinkModal(applicationId) {
  ...
  const tmp = first3();
  const items = [first1];
  const stateFromStores = applicationId(linkId[12]).useStateFromStores(items, () =>
    first1.getConnectedActivityChannelId(),
  );
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null != first3) {
                ...
                c3 = 1;
                let obj4 = {
                  value: Promise.all(first1.map(tmp2(10433).getOrResolveChannelIdFromDestinationId)),
                  done: false,
                };
                return obj4;
              } else {
            ...
            closure_128_1 = tmp2(14025).resolveActivityShareMessageContent(
              closure_129_3,
              closure_129_14,
              closure_129_12,
            );
                      ...
                      if (0 === c2) {
                        if (arg0 === 1) {
                          ...
                          if (null != channel) {
                            ...
                            c1 = 1;
                            const obj7 = {
                              value: obj2.sendMessage(closure_0, closure_2_1(7090).parse(channel, c1), false, obj6),
                              done: false,
                            };
                            return obj7;
                          }
  ...
  obj7.headerTitle = function headerTitle(children) {
    return closure_2_12(HeaderShared.GenericHeaderTitle, {
