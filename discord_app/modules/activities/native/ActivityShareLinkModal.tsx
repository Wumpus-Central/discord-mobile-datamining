          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null != first3) {
                ...
                c3 = 1;
                let obj1 = {
                  value: Promise.all(first1.map(tmp2(11074).getOrResolveChannelIdFromDestinationId)),
                  done: false,
                };
                return obj1;
              } else {
            ...
            closure_128_1 = tmp2(14540).resolveActivityShareMessageContent(
              closure_129_3,
              closure_129_14,
              closure_129_12,
            );
                    ...
                    try {
                      ...
                      if (0 === c2) {
                        if (arg0 === 1) {
                          ...
                          if (null != channel) {
                            let obj1 = closure_2_1(7529);
                            let obj2 = closure_2_1(7754);
