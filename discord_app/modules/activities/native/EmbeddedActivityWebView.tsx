...
import useStableSafeAreaInsets from "useStableSafeAreaInsets" /* 9812 */;
import createWebviewHtmlFileDefault from "createWebviewHtmlFile" /* 9815 */;
                ...
                if (0 === c4) {
                  if (arg0 === 1) {
                    ...
                    if (null != applicationId) {
                      const nonTestModeUrlForApplication = getURLForApplication.getNonTestModeUrlForApplication(applicationId);
                  ...
                  if (0 === c8) {
                    if (arg0 === 1) {
                      ...
                      if (null != memo) {
                        ...
                        c8 = 2;
                        c9 = 1;
                        const obj6 = { value: memo.injectJavaScript(getPostMessageJavaScriptDefault(obj4)), done: false };
                        return obj6;
                      }
                    }
                  } else {
