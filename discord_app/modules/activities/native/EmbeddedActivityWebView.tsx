...
import WebView from "../../../../_runtime/07738_WebView.js";
...
class BaseActivityWebView {
  constructor(arg0) {
    ...
    first = hadInvalidUrlError(
      applicationId.useState(() => require()),
      1,
    )[0];
          ...
          try {
            ...
            if (0 === c6) {
              if (arg0 === 1) {
                ...
                c6 = 1;
                c7 = 1;
                const obj5 = { value: createWebviewHtmlFileDefault(obj4), done: false };
                return obj5;
              }
            } else if (arg0 === 1) {
              c7 = 3;
    ...
    callback2 = obj2.useCallback(() => {
      ...
      AnalyticsUtilsDefault.track(constants2.ACTIVITY_WEB_VIEW_CONTENT_PROCESS_TERMINATED, {
            ...
            if (c5 === 2) {
              ...
              try {
                ...
                if (0 === c4) {
                  ...
                  closure_130_2 = items;
                  closure_1_31(
                    closure_130_2.map((item) => "^" + closure_1_1(closure_1_3[28])(item).replace(/\\\*/g, ".*")),
                  );
                  closure_1_29(true);
                }
                c5 = 3;
                  ...
                  if (0 === c8) {
                    if (arg0 === 1) {
                      ...
                      if (null != memo) {
                        ...
                        c9 = 1;
                        const obj6 = {
                          value: memo.injectJavaScript(getPostMessageJavaScriptDefault(obj4)),
                          done: false,
                        };
                        return obj6;
                      }
...
export default function EmbeddedActivityWebView(channelId) {
  ...
  const merged = Object.assign(
    channelId,
    Object.assign({ channelId: 0, currentEmbeddedActivity: 0, applicationId: 0 }),
  );
