// === Module 13979: openActivityDMLauncher ===
      ...
      if (0 === c7) {
        ...
        if (2 === tmp5) {
          ...
          if (arg0 === 1) {
            ...
            c7 = 4;
            c8 = 1;
            const obj7 = { value: obj6.getCustomActivityLinkParams(closure_133_0, closure_133_3, closure_133_2), done: false };
            return obj7;
          }
        } else if (4 === tmp5) {
          if (arg0 === 1) {
            ...
            if (closure_133_4) {
              ...
              if (bestActiveInput != null) {
                ...
                obj9 = { application: closure_133_5, initialRouteName: closure_134_4.APPLICATION_VIEW, customId, referrerId: closure_133_1 };
                obj8.context = obj9;
                bestActiveInput.openCustomKeyboard(obj8);
              }
            } else {
              const obj10 = { targetApplicationId: closure_133_0, locationObject: {}, channelId: closure_133_7, analyticsLocations: null, commandOrigin: null, referrerId: null, customId: null };
