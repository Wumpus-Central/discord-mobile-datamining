  ...
  if (c6 === 2) {
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (tmp10) {
          const hasApplicationFlagResult = closure_132_0(closure_132_2[12]).hasApplicationFlag(
            closure_131_4,
            closure_132_6.EMBEDDED_RELEASED,
          );
