// === Module 10714: getOrFetchApplicationForLaunch ===
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              obj2[0] = callback2(10715)(callback, callback2);
              return obj2;
            }
          } else if (2 === tmp7) {
            c6 = 0;
            ...
            if (null != dependencyMap) {
              PRIVATE_CHANNEL = callback(10700).EmbeddedActivityLocationKind.GUILD_CHANNEL;
            } else {
              PRIVATE_CHANNEL = callback(10700).EmbeddedActivityLocationKind.PRIVATE_CHANNEL;
            }
            obj2 = callback2(709);
            ...
            const aPIError = new callback(4278).APIError(closure_4);
            obj3[5] = aPIError;
            ...
            if (1 === tmp5) {
              if (arg0 === 1) {
                ...
                const promise = new Promise((arg0) => {
                  ...
                  const channel = closure_1_4.getChannel(_undefined(4015).getEmbeddedActivityLocationChannelId(_location));
                  if (null != value) {
                    if (null != channel) {
                      if (dependencyMap != null) {
                        dependencyMap();
                      }
                      _undefined2(10717)(tmp, channel, () => {
