...
import { getOrFetchApplicationCommandIndexForTarget as closure_4 } from "../application_commands/ApplicationCommandIndexStore.tsx";
import addApplication from "../applications/ApplicationStore.tsx";
import getParticipants from "../calls/ChannelRTCStore.tsx";
import initialize from "../popout-window/PopoutWindowStore.native.tsx";
...
import { SUPPORTED_ACTIVITY_IN_TEXT_CHANNEL_TYPES as closure_16 } from "Constants.tsx";
import { ActivityPanelModes } from "panel/ActivityPanelConstants.tsx";
import ME from "../../Constants.tsx";
import { INSTALL_LESS_APP_IDS } from "../applications/ApplicationConstants.tsx";
        ...
        try {
          ...
          if (0 === type) {
            ...
            if (arg0 === 1) {
              ...
              canLaunchFrameResult = null != application;
              ...
              c15 = 1;
              const windowOpen = closure_1_7.getWindowOpen(closure_1_23.ACTIVITY_POPOUT);
              ...
              if (obj18.tryLaunchAsFrame(obj2)) {
                ...
                obj3 = callback(closure_1_2[23]).stashPendingFrameLaunch(callback2, obj3);
                c15 = 0;
                c17 = 3;
                ...
                obj5[2] = closure_1_14;
                obj4[9] = obj5;
                closure_1_1(closure_1_2[25]).dispatch(obj4);
                c5 = callback;
                if (callback == null) {
                  c5 = undefined;
                }
                ...
                obj6[0] = callback(closure_1_1, c5);
                return obj6;
              }
              obj32 = channel;
            }
              ...
              if (!(closure_26 instanceof callback2(8726))) {
                if (!(closure_26 instanceof callback2(4274))) {
                  if (!(closure_26 instanceof callback2(4808))) {
                    let tmp148 = new callback2(4274)(closure_26);
                  }
                  obj7[6] = tmp148;
            ...
            if (arg0 === 1) {
              ...
              if (null != id) {
                ...
                callback2(8768)(obj10);
                const tmp255 = callback2(8768);
              }
              if (dependencyMap) {
                if (null != callback) {
                  if ((function isSupportedChannelType(c1, c16) {
                    ...
                    const result = _undefined(_null[31]).isActivityInTextSupportedForChannel(type);
                    if (tmp2) {
                ...
                let tmp96 = closure_1_1(closure_1_2[27]);
                tmp96 = new tmp96(closure_1_1(closure_1_2[27]).Reasons.INVALID_CHANNEL);
                throw tmp96;
              } else {
              ...
              if (arg0 === 1) {
                ...
                if (null == currentUser) {
                  ...
                  const promise = new Promise((arg0, arg1) => {
                    closure_0 = arg0;
                    closure_1 = arg1;
                    let obj = { channel: closure_13, guild };
          ...
          if (0 === c4) {
            ...
            if (arg0 === 1) {
              ...
              if (null == closure_7) {
                ...
                obj4[0] = callback2(8735)(closure_7, callback2);
                return obj4;
              }
            }
          } else {
                    ...
                    if (null == callback2) {
                      ...
                      if (null == sessionId) {
                        ...
                        if (channel !== callback(11130).EmbeddedActivityLaunchability.CAN_LAUNCH) {
                          ...
                          } else if (channel === callback(11130).EmbeddedActivityLaunchability.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS) {
            ...
            if (null != sessionId) {
              closure_14 = callback2(8724)(sessionId.id);
...
function stopEmbeddedActivity(showFeedback) {
  ...
  if (null != embeddedActivityLocationChannelId) {
    ...
    const found = embeddedActivitiesForChannel.find((item, index) => item.applicationId === applicationId);
    if (null != found) {
      if (null != id) {
        if ("" !== id) {
          ...
          if (selectedParticipantId === tmp6Result.getEmbeddedActivityParticipantId(obj)) {
            const participant = _modDef8666.selectParticipant(embeddedActivityLocationChannelId, null);
            const tmp2Result = _modDef8666;
          }
          tmp6Result = applicationId(4777);
        }
      }
    }
  }
  const obj4 = applicationId(4011);
}
function _fetchDeveloperApplications() {
  ...
  const tmp = callback(function*() {
    ...
    if (1 === tmp7) {
      ...
      dependencyMap = applications.map((item, index) => closure_8.createFromServer(item));
          ...
          if (0 === c8) {
            ...
            if (1 === tmp7) {
              if (arg0 === 1) {
                ...
                const mapped = shelfActivities.map((item, index) => _undefined.getApplication(item.application_id));
              ...
              if (arg0 === 1) {
                ...
                if (null != c5) {
                  callback2(shelfActivities[25]).unsubscribe("EMBEDDED_ACTIVITY_FETCH_SHELF_FAIL", c5);
                  c5 = undefined;
              ...
              obj16[0] = closure_10;
              obj16[1] = closure_11.map((item, index) => c8.createFromServer(item));
              c7 = 0;
              c9 = 3;
              const obj17 = { value: null, done: true };
              obj17[0] = obj16;
        ...
        try {
          ...
          if (0 === c3) {
            ...
            if (arg0 === 1) {
              ...
              obj5[0] = obj1.ensurePrivateChannel(dependencyMap).then((result) => {
                const channel = closure_1_10.getChannel(result);
                if (null == channel) {
                  const _Error = Error;
                  ...
                  obj2.sendInvite(result, code.code, c3, c4, content);
                }
              });
              return obj5;
            }
        ...
        try {
          ...
          if (0 === c8) {
            if (arg0 === 1) {
              ...
              obj1[1] = callback;
              callback2(closure_1_2[25]).dispatch(obj1);
              c7 = 2;
              guild_id = callback2;
              if (callback2 == null) {
                guild_id = undefined;
              ...
              c9 = 1;
              const obj2 = { value: null, done: false };
              obj2[0] = closure_1_40(callback, guild_id);
              return obj2;
            }
          } else if (1 === tmp9) {
            c7 = 0;
            ...
            if (!(closure_6 instanceof callback2(8726))) {
              if (!(closure_6 instanceof callback2(4274))) {
                if (!(closure_6 instanceof callback2(4808))) {
                  let tmp63 = new callback2(4274)(closure_6);
                }
                obj4[6] = tmp63;
                dispatch(obj4);
                c7 = 0;
...
let result = require("obj132").fileFinishedImporting("modules/activities/EmbeddedActivitiesActionCreators.tsx");
