...
import showActivitiesInvalidPermissionsAlert from "showActivitiesInvalidPermissionsAlert" /* 9623 */;
      ...
      if (0 === c3) {
                ...
                try {
                  ...
                  if (0 === v1) {
                    if (arg0 === 1) {
                      ...
                      const obj1 = { applicationId: applicationId.applicationId, activityChannelId, locationObject: {}, analyticsLocations, componentId, sectionName, inviterUserId };
                      v1 = 1;
                      c0 = 1;
        ...
        if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            if (null == closure_129_9) {
              ...
              c3 = 2;
              c4 = 1;
              let obj2 = { value: obj4.fetchApplication(closure_129_1), done: false };
              return obj2;
            }
          }
        } else if (arg0 === 1) {
        ...
        if (null != closure_129_8) {
          if (null != closure_129_9) {
            ...
            obj4 = { userId: id, application: closure_129_9, channelId: closure_129_0, currentUser, isActivitiesEnabledForCurrentPlatform: null, ChannelStore: null, VoiceStateStore: null, PermissionStore: null, GuildStore: null };
