...
class BaseActivityPanelPIPView {
  constructor(arg0) {
    ...
    class J {
      constructor() {
        ...
        obj = {
          pipX: x,
          pipY: point.y,
          width: closure_10.width,
          height: closure_10.height,
    ...
    obj = {
      pipState,
      getClampedPIPPosition: require("MIN_PIP_TOSS_VELOCITY").getClampedPIPPosition,
      ...
      REDUCED_MOTION_TIMING: closure_19,
...
let closure_22 = {
  code: "function transitionComplete_ActivityPanelPIPViewTsx2(finished=false){const{transitionState,TransitionStates,runOnJS,transitionCleanUp}=this.__closure;if(finished&&transitionState===TransitionStates.YEETED){runOnJS(transitionCleanUp)();}}",
};
let closure_23 = {
...
const memoResult = importAllResult.memo((transitionState) => {
  ...
  const stateFromStoresObject =
    require("../../../../../discord_common/js/packages/flux/index.tsx").useStateFromStoresObject(items, () => {
      ...
      const obj = {
        channelId: lib(_undefined[29]).getEmbeddedActivityLocationChannelId(connectedActivityLocation),
        activity: store.getSelfEmbeddedActivityForLocation(connectedActivityLocation),
      };
      return obj;
    });
  ...
  return activity.useMemo(() => {
    obj = {
      ...
      context: transitionCleanUp(_undefined[30]),
      children: closure_1_18(transitionCleanUp(_undefined[31]), obj),
    };
    obj = {
      channel: stateFromStores1,
      layoutMode: closure_1_9.PIP,
      portraitSafeAreasConfig: closure_1_15,
