...
export default function usePIPAvoidanceSpecs(safeArea) {
  ...
  obj = { cheapWorkletShallowEqual: _cheapWorkletShallowEqual.cheapWorkletShallowEqual, getPIPBottomOffsetForPIPMode: sharedValue(16000), getAdjustedBottomOffsets: sharedValue(16104), updateSharedValueIfChanged: sharedValue(10336), pipAvoidanceSpecs: sharedValue };
  fn2.__closure = obj;
