...
export default function usePIPAvoidanceSpecs(safeArea) {
  ...
  obj = { cheapWorkletShallowEqual: require("../../../../reanimated/native/cheapWorkletShallowEqual.tsx").cheapWorkletShallowEqual, getPIPBottomOffsetForPIPMode: sharedValue(16126), getAdjustedBottomOffsets: sharedValue(16231), updateSharedValueIfChanged: sharedValue(10561), pipAvoidanceSpecs: sharedValue };
  fn2.__closure = obj;
