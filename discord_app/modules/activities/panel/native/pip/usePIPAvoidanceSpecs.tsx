...
export default function usePIPAvoidanceSpecs(safeArea) {
  ...
  obj = { cheapWorkletShallowEqual: _cheapWorkletShallowEqual.cheapWorkletShallowEqual, getPIPBottomOffsetForPIPMode: sharedValue(16076), getAdjustedBottomOffsets: sharedValue(16181), updateSharedValueIfChanged: sharedValue(10303), pipAvoidanceSpecs: sharedValue };
  fn2.__closure = obj;
