...
export default function usePIPAvoidanceSpecs(safeArea) {
  ...
  obj = { cheapWorkletShallowEqual: require("../../../../reanimated/native/cheapWorkletShallowEqual.tsx").cheapWorkletShallowEqual, getPIPBottomOffsetForPIPMode: sharedValue(16402), getAdjustedBottomOffsets: sharedValue(16505), updateSharedValueIfChanged: sharedValue(10911), pipAvoidanceSpecs: sharedValue };
  fn2.__closure = obj;
