...
export default noop.memo(function ActivityInviteSheetRow(row) {
  ...
  if (require("InstantInviteUtils").RowTypes.DM !== type) {
      ...
      if (require("InstantInviteUtils").RowTypes.GROUP_DM === type) {
        ...
        if (null == guild) {
          ...
          if (null != guild.icon) {
            ...
            obj1.source = tmp5Result1.makeSource(onPressAvatar(tmp3[17]).getGuildIconURL({ id: null, icon: null, size: 32 }));
    ...
    const obj5 = { start, end, icon: tmp14, label: str2, trailing: null, onPress: null, disabled: null, accessibilityActions: null, onAccessibilityAction: null };
  ...
  obj7.children = jsx(require("native").Avatar, { source: avatarSource, size: require("native").AvatarSizes.REFRESH_MEDIUM_32 });
