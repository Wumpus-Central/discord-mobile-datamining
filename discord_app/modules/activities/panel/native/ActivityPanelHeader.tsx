...
import get_ActivityIndicator from "module_15951";
...
function useBaseActivityPanelHeaderContent(landscape) {
  ...
  obj[0] = landscape(15946).MorphablePanelModes.PANEL;
  obj[2] = pipState;
  obj[4] = wrapperOffset;
  obj[5] = callback;
  obj[0] = setMode(15946)(obj);
  obj[1] = memo;
  obj[2] = memo1;
  obj[3] = tmp;
  return obj;
...
class BaseActivityPanelContent {
  constructor(arg0) {
    ...
    if (hasConnectedActivity) {
      ...
      tmp7 = jsxs;
      items = [, , ];
      items[0] = jsx(require("module_15950"), {});
...
let closure_19 = importAllResult.memo(function ActivityPanelHeaderContentInner(wrapperOffset) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(tmp5(15956), obj1);
  }
  items3[1] = tmp8Result;
  let tmp20 = null;
  if (landscape) {
...
const memoResult = importAllResult.memo(() => {
  ...
  c0 = tmp2;
  const context = importAllResult.useContext(wrapperDimensions(15940));
