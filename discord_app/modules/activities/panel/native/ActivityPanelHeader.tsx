...
function useBaseActivityPanelHeaderContent(landscape) {
  ...
  obj = { mode: landscape(17055).MorphablePanelModes.PANEL, panGestureEnabled: true, pipState, swipeRequiresPop: true, wrapperOffset, onPanMinimizeGestureEnd: callback, disableHorizontalSafeAreas: true };
  obj.gesture = setMode(17055)(obj);
