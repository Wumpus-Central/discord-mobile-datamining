...
class BaseActivityPanelFocusedView {
  constructor(arg0) {
    ...
    obj = {
      ...
      wrapperOffset,
      transitionState,
      TransitionStates: transitionState(closure_2[19]).TransitionStates,
      runOnJS: transitionState(closure_2[18]).runOnJS,
      transitionCleanUp,
      reduceMotion: stateFromStores,
      withTiming: transitionState(closure_2[20]).withTiming,
