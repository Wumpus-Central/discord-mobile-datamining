...
class BaseActivityPanelFocusedView {
  constructor(arg0) {
    ...
    items4 = [, ];
    items4[0] = jsx(require("module_4054").View, { style: items3, pointerEvents: "none" });
    ...
    obj4[1] = tmp15;
    items5 = [, ];
    items5[0] = tmp14(require("module_4054").View, obj4);
    items5[1] = header;
    obj3[4] = items5;
...
export const useBaseActivityPanelFocusedView = function useBaseActivityPanelFocusedView(context) {
  ...
  const tmp = isWindowLandscape(1581)();
  c0 = tmp;
