...
class BaseActivityPanelFocusedView {
  constructor(arg0) {
    ...
    items4 = [, ];
    items4[0] = jsx(require("../../../reanimated/ReanimatedRexport.tsx").View, { style: items3, pointerEvents: "none" });
