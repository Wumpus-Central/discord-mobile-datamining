...
class BaseActivityPanelFocusedView {
  constructor(arg0) {
    ...
    items4 = [, ];
    items4[0] = jsx(require("module_4162").View, { style: items3, pointerEvents: "none" });
    ...
    obj4[1] = tmp15;
    items5 = [, ];
    items5[0] = tmp14(require("module_4162").View, obj4);
    items5[1] = header;
    obj3[4] = items5;
