...
export default function ActivityInviteSheet(activity) {
  ...
  obj.header = closure_13(activity(7222).BottomSheetTitleHeader, obj1);
  if (null != tmp6) {
    const obj2 = { style: tmp.emptyState, Illustration: tmp11(9940).AppCrash, title: tmp6 };
    ...
    const obj5 = { size: "md", isRound: true, onChange: tmp11(9938).searchInviteSuggestions, placeholder: null };
    const intl2 = tmp11(1114).intl;
    obj5.placeholder = intl2.string(tmp11(1114).t.iI1gMg);
    obj4.children = closure_13(tmp11(7123).SearchField, obj5);
    ...
    if (tmp16) {
      ...
      tmp17Result = closure_13(tmp2(17110), obj7);
    }
  ...
  obj.children = closure_13(activity(7223).BottomSheet, obj);
  return closure_13(activity(7235).AnalyticsLocationProvider, obj);
};