...
export default noop.memo(function MinimizeActivityButton(arg0) {
  ...
  if (undefined !== activityName) {
    if ("" !== activityName) {
      ...
      obj = { icon: _modDef11249, accessibilityLabel: null, onPress: null, text: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1, shrink: true };
      const intl2 = setMode(1114).intl;
      obj.accessibilityLabel = intl2.string(setMode(1114).t.brPQ5U);
      obj.onPress = callback;
      obj.text = activityName;
      obj.children = jsx(setMode(5026).Button, { icon: _modDef11249, accessibilityLabel: null, onPress: null, text: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1, shrink: true });
      let tmp3 = <View icon={_modDef11249} accessibilityLabel={null} onPress={null} text={null} size="sm" variant="secondary-overlay" maxFontSizeMultiplier={1} shrink />;
    }
    return tmp3;
  }
  obj = { icon: _modDef11249, accessibilityLabel: null, onPress: null, size: "sm", variant: "secondary-overlay", maxFontSizeMultiplier: 1 };
