...
import SecureFramesPersistedStore from "SecureFramesPersistedStore.tsx";
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          const obj7 = {
            public_key: closure_130_19(key),
            signature: closure_130_19(signature),
            key_version: closure_129_0,
          };
          request.body = obj7;
          c5 = 3;
          c6 = 1;
...
export const getUserVerificationFooterText = function getUserVerificationFooterText(arg0) {
  ...
  if (isCurrentUserKeyPersistent) {
    const obj5 = {
      ...
      helpArticle: HelpdeskUtilsDefault.getArticleURL(constants3.END_TO_END_ENCRYPTION),
    };
...
export const showSecureFramesKeyInconsistentAlert = function showSecureFramesKeyInconsistentAlert(arg0) {
  ...
  const result = SecureFramesTracking.trackE2EEUserVerificationFailed({
    userId,
    channelId,
    keyVersion,
    reason: constants.OTHER_USER_INCONSISTENT_KEYS,
  });
