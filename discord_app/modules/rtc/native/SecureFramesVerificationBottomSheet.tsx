...
({
  ...
  EPOCH_AUTHENTICATOR_LENGTH: closure_7,
...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const readableSecureFramesFingerprint = onShareClick(9171).useReadableSecureFramesFingerprint({
  ...
  const obj4 = {
    title: null,
    leading: closure_8(onShareClick(6619).ActionSheetCloseButton, { onPress: callback1 }),
    trailing: null,
  };
  const obj5 = {
    style: tmp.share,
    hitSlop: 8,
    onPress: callback,
    disabled: null == readableSecureFramesFingerprint,
  ...
  obj9.children = closure_8(onShareClick(5409).LockIcon, {
    style: tmp.icon,
    color: readableSecureFramesFingerprint(576).colors.TEXT_SUBTLE,
  });
  const items1 = [
    closure_8(View, obj9),
    closure_8(onShareClick(4832).Text, {
  ...
  items2[2] = closure_8(tmp2(4832).Text, {
    style: tmp.footer,
