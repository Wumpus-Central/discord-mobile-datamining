// === Module 9169: SecureFramesVerificationBottomSheet ===
...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const readableSecureFramesFingerprint = onShareClick(9160).useReadableSecureFramesFingerprint({ fingerprintBase64: epochAuthenticator, chunkSize, desiredLength });
  ...
  const obj4 = { title: null, leading: closure_8(onShareClick(6614).ActionSheetCloseButton, { onPress: callback1 }), trailing: null };
  ...
  obj4.trailing = closure_8(onShareClick(5428).PressableOpacity, obj5);
  obj3.header = closure_8(onShareClick(6565).BottomSheetTitleHeader, obj4);
  ...
  const obj = onShareClick(9160);
  let obj2 = { fingerprintBase64: epochAuthenticator, chunkSize, desiredLength };
  const tmp2 = onShareClick;
  obj9.children = closure_8(onShareClick(5402).LockIcon, { style: tmp.icon, color: readableSecureFramesFingerprint(576).colors.TEXT_SUBTLE });
  ...
  const items2 = [closure_9(onShareClick(5272).Stack, obj8), , ];
  ...
  if (tmp7Result) {
    ...
    tmp7Result = closure_8(tmp10(9170), obj13);
  }
  obj12.trailing = tmp7Result;
  obj12.chunks = readableSecureFramesFingerprint;
  obj12.columns = columns;
  items2[1] = closure_8(readableSecureFramesFingerprint(9167), obj12);
  ...
  return closure_8(onShareClick(6566).BottomSheet, obj3);
};