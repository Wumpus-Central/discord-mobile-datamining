...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const obj1 = { title: null, leading: closure_8(onShareClick(7301).ActionSheetCloseButton, { onPress: callback1 }), trailing: null };
  ...
  obj2.children = closure_8(onShareClick(4632).Text, obj3);
  obj1.trailing = closure_8(onShareClick(5204).PressableOpacity, obj2);
  obj.header = closure_8(onShareClick(7252).BottomSheetTitleHeader, obj1);
  const obj4 = { style: tmp.content, children: null };
  const obj5 = { spacing: 8, justify: "center", align: "center", direction: "vertical", children: null };
  const obj6 = { style: tmp.iconContainer, children: closure_8(onShareClick(5176).LockIcon, { style: tmp.icon, color: readableSecureFramesFingerprint(576).colors.TEXT_SUBTLE }) };
  const items1 = [closure_8(View, obj6), closure_8(onShareClick(4632).Text, { variant: "heading-xl/bold", color: "mobile-text-heading-primary", children: title }), closure_8(onShareClick(4632).Text, { style: tmp.subtitle, variant: "text-md/medium", color: "text-default", children: subtitle })];
  obj5.children = items1;
  const items2 = [closure_9(onShareClick(5054).Stack, obj5), , ];
  ...
  if (tmp7Result) {
    ...
    tmp7Result = closure_8(tmp10(9297), obj10);
  }
  obj9.trailing = tmp7Result;
  obj9.chunks = readableSecureFramesFingerprint;
  obj9.columns = columns;
  items2[1] = closure_8(readableSecureFramesFingerprint(9294), obj9);
  ...
  return closure_8(onShareClick(7253).BottomSheet, obj);
};