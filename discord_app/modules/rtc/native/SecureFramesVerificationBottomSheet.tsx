// === Module 9987: SecureFramesVerificationBottomSheet ===
...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const readableSecureFramesFingerprint = onShareClick(9978).useReadableSecureFramesFingerprint({ fingerprintBase64: epochAuthenticator, chunkSize, desiredLength });
  ...
  const obj4 = { title: null, leading: closure_8(onShareClick(7443).ActionSheetCloseButton, { onPress: callback1 }), trailing: null };
  ...
  obj4.trailing = closure_8(onShareClick(5339).PressableOpacity, obj5);
  obj3.header = closure_8(onShareClick(7394).BottomSheetTitleHeader, obj4);
  ...
  const obj = onShareClick(9978);
  let obj2 = { fingerprintBase64: epochAuthenticator, chunkSize, desiredLength };
  const tmp2 = onShareClick;
  obj9.children = closure_8(onShareClick(5313).LockIcon, { style: tmp.icon, color: readableSecureFramesFingerprint(576).colors.TEXT_SUBTLE });
  ...
  if (tmp7Result) {
    ...
    tmp7Result = closure_8(tmp10(9988), obj13);
  }
  obj12.trailing = tmp7Result;
  obj12.chunks = readableSecureFramesFingerprint;
  obj12.columns = columns;
  items2[1] = closure_8(readableSecureFramesFingerprint(9985), obj12);
  ...
  return closure_8(onShareClick(7395).BottomSheet, obj3);
};