...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const readableSecureFramesFingerprint = onShareClick(9160).useReadableSecureFramesFingerprint({
  ...
  const obj4 = {
    title: null,
    leading: closure_8(onShareClick(6614).ActionSheetCloseButton, { onPress: callback1 }),
    trailing: null,
  };
  const obj5 = {
    style: tmp.share,
  ...
  obj9.children = closure_8(onShareClick(5402).LockIcon, {
    style: tmp.icon,
    color: readableSecureFramesFingerprint(576).colors.TEXT_SUBTLE,
  });
  const items1 = [
    closure_8(View, obj9),
    closure_8(onShareClick(4825).Text, {
  ...
  items2[2] = closure_8(tmp2(4825).Text, {
    style: tmp.footer,
