...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const readableSecureFramesFingerprint = onShareClick(9396).useReadableSecureFramesFingerprint({
  ...
  const obj4 = {
    title: null,
    leading: closure_8(onShareClick(7394).ActionSheetCloseButton, { onPress: callback1 }),
    trailing: null,
  };
  const obj5 = {
    style: tmp.share,
  ...
  obj9.children = closure_8(onShareClick(5264).LockIcon, {
    style: tmp.icon,
    color: readableSecureFramesFingerprint(576).colors.TEXT_SUBTLE,
  });
  const items1 = [
    closure_8(View, obj9),
    closure_8(onShareClick(4718).Text, {
  ...
  if (tmp7Result) {
    ...
    tmp7Result = closure_8(tmp10(9406), obj13);
  }
  ...
  items2[2] = closure_8(tmp2(4718).Text, {
    style: tmp.footer,
