...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const readableSecureFramesFingerprint = onShareClick(10062).useReadableSecureFramesFingerprint({
  ...
  const obj4 = {
    title: null,
    leading: closure_8(onShareClick(7531).ActionSheetCloseButton, { onPress: callback1 }),
    trailing: null,
  };
  const obj5 = {
    style: tmp.share,
  ...
  obj9.children = closure_8(onShareClick(5401).LockIcon, {
    style: tmp.icon,
  ...
  if (tmp7Result) {
    ...
    tmp7Result = closure_8(tmp10(10072), obj13);
  }
