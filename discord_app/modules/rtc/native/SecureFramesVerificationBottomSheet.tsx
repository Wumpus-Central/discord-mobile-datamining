...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  obj1 = { title: null, leading: callback(onShareClick(7176).ActionSheetCloseButton, { onPress: callback1 }), trailing: null };
  ...
  const obj6 = { style: tmp.iconContainer, children: callback(onShareClick(6890).LockIcon, { style: tmp.icon, color: readableSecureFramesFingerprint(712).colors.TEXT_SUBTLE }) };
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(tmp10(9724), obj10);
  }
  obj9[1] = tmp7Result;
