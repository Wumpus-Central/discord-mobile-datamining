// === Module 9878: SecureFramesVerificationBottomSheet ===
...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  obj1 = { title: null, leading: callback(onShareClick(5998).ActionSheetCloseButton, { onPress: callback1 }), trailing: null };
  ...
  obj1[2] = callback(onShareClick(5076).PressableOpacity, obj2);
  obj[1] = callback(onShareClick(5629).BottomSheetTitleHeader, obj1);
  const obj4 = { style: tmp.content, children: null };
  const obj5 = { spacing: 8, justify: "center", align: "center", direction: "vertical", children: null };
  const obj6 = { style: tmp.iconContainer, children: callback(onShareClick(5048).LockIcon, { style: tmp.icon, color: readableSecureFramesFingerprint(709).colors.TEXT_SUBTLE }) };
  ...
  if (tmp7Result) {
    ...
    tmp7Result = tmp7(tmp10(9879), obj10);
  }
  obj9[1] = tmp7Result;
  obj9[2] = readableSecureFramesFingerprint;
  obj9[3] = closure_6;
  items2[1] = callback(readableSecureFramesFingerprint(9876), obj9);
  ...
  return callback(onShareClick(5630).BottomSheet, obj);
};