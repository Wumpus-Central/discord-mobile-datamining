...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const readableSecureFramesFingerprint = onShareClick(9287).useReadableSecureFramesFingerprint({
  ...
  obj9.children = closure_8(onShareClick(5176).LockIcon, {
    style: tmp.icon,
  ...
  if (tmp7Result) {
    ...
    tmp7Result = closure_8(tmp10(9297), obj13);
  }
