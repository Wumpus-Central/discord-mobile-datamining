...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  const obj1 = {
    title: null,
    leading: closure_8(onShareClick(7301).ActionSheetCloseButton, { onPress: callback1 }),
    trailing: null,
  };
  let obj2 = {
    style: tmp.share,
  ...
  const obj6 = {
    ...
    children: closure_8(onShareClick(5176).LockIcon, {
      style: tmp.icon,
  ...
  const items1 = [
    closure_8(View, obj6),
    closure_8(onShareClick(4632).Text, {
  ...
  items2[2] = closure_8(tmp2(4632).Text, {
    style: tmp.footer,
