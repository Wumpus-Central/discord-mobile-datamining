...
export default function SecureFramesVerificationBottomSheet(onShareClick) {
  ...
  obj1 = {
    title: null,
    leading: callback(onShareClick(7199).ActionSheetCloseButton, { onPress: callback1 }),
    trailing: null,
  };
  let obj2 = {
    style: tmp.share,
  ...
  const obj6 = {
    ...
    children: callback(onShareClick(5095).LockIcon, {
      style: tmp.icon,
  ...
  const items1 = [
    callback(View, obj6),
    callback(onShareClick(4556).Text, {
  ...
  items2[2] = callback(tmp2(4556).Text, {
    style: tmp.footer,
