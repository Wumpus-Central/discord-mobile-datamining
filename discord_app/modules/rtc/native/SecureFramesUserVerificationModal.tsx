...
export default function SecureFramesUserVerificationModal(userId) {
  ...
  const isUserSecureFramesVerified = obj6.useIsUserSecureFramesVerified({ userId, channelId, userKey: fingerprintUserKey });
  ...
  obj2 = { accessibilityRole: "button", accessibilityLabel: null, androidRippleConfig: null, hitSlop: 8, onPress: null, children: null };
