  ...
  if (c4 === 2) {
    ...
    try {
      ...
      if (0 === c3) {
        ...
        closure_129_3 = value;
        value = {
          fingerprint: closure_130_1(closure_130_2[8]).fromByteArray(closure_129_3),
          fingerprintUserKey: closure_129_1,
        };
        c4 = 3;
...
let closure_9 = fn(10051).SECURE_FRAMES_GENERATE_FINGERPRINT_VERSION;
