...
export default {
  openSecureFramesStreamVerification(streamKey, channelId) {
    ...
    obj.openLazy(asyncRequireImpl(9288, dependencyMap.paths), closure_6, obj);
  },
  openSecureFramesUserVerificationModal(id, id2, arg2) {
    if (arg2()) {
      ...
      obj[0] = id;
      obj[1] = id2;
      obj.pushLazy(asyncRequireImpl(9278, dependencyMap.paths), obj, closure_7);
    }
  },
  ...
  handleSecureFramesUserVerificationLink(arg0) {
    ...
    if (null != channelId) {
      if (null != channel) {
        ...
        obj[2] = guildId;
        obj[3] = fingerprint;
        ACTION_SHEET_HEIGHT_HALF.openLazy(asyncRequireImpl(9291, dependencyMap.paths), closure_5, obj);
