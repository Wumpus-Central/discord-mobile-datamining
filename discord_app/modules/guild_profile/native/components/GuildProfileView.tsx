...
import utils_getDevicePixelRatioDefault from "utils/getDevicePixelRatio" /* 10097 */;
import guild_profile_GuildProfileUtils from "guild_profile/GuildProfileUtils" /* 10098 */;
import GuildProfileHeaderDefault from "GuildProfileHeader" /* 10099 */;
import GuildProfileGamesDefault from "GuildProfileGames" /* 10101 */;
import GuildProfileTraitsDefault from "GuildProfileTraits" /* 10108 */;
...
export default function GuildProfileView(guildProfile) {
  ...
  if (tmp5Result) {
    ...
    tmp5Result = closure_8(guildProfile(4823).Text, obj3);
  }
