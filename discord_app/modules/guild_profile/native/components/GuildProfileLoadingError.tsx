...
export default function GuildProfileLoadingError(onPress) {
  let obj = GuildProfileBackground /* GuildProfileBackground */;
  const styles = obj.useStyles();
  let obj1 = map /* map */;
  obj = { style: styles.container, children: null };
  const token = obj1.useToken(Themes.colors.BACKGROUND_BASE_LOWEST);
  obj = { style: styles.colorBanner, start: null, end: null, colors: null };
  const tmp2 = useTheme();
  obj[1] = GuildProfileBackground /* GuildProfileBackground */.DiagonalGradient.START;
  obj[2] = GuildProfileBackground /* GuildProfileBackground */.DiagonalGradient.END;
  let obj4 = GuildProfileBackground /* GuildProfileBackground */;
  obj[3] = obj4.getBackgroundForProfile(tmp2, token);
  const items = [callback(LinearGradient, obj), , ];
  ...
  obj4[1] = Themes.colors.TEXT_FEEDBACK_WARNING;
  obj3[1] = callback(WarningIcon /* WarningIcon */.WarningIcon, obj4);
  ...
  obj6[2] = intl.string(getSystemLocale /* getSystemLocale */.t.DmIUGK);
  const items1 = [callback(Text /* Text */.Text, obj6), ];
  ...
  obj7[3] = intl2.string(getSystemLocale /* getSystemLocale */.t.s1fAEw);
  const obj8 = { size: "sm", color: null };
  obj8[1] = Themes.colors.TEXT_FEEDBACK_WARNING;
  const items2 = [callback(WarningIcon /* WarningIcon */.WarningIcon, obj8), ];
  const obj9 = { variant: "text-sm/normal", color: "text-feedback-warning", children: null };
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj9[2] = intl3.string(getSystemLocale /* getSystemLocale */.t.tmGHjc);
  items2[1] = callback(Text /* Text */.Text, obj9);
  obj7[4] = items2;
  items1[1] = callback2(PressableBase /* PressableBase */.PressableOpacity, obj7);
  obj5[1] = items1;
