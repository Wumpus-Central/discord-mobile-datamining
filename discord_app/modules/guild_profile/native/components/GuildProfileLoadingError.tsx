...
export default function GuildProfileLoadingError(onPress) {
  let obj = require(8466) /* GuildProfileBackground */;
  ...
  obj[1] = require(8466) /* GuildProfileBackground */.DiagonalGradient.START;
  obj[2] = require(8466) /* GuildProfileBackground */.DiagonalGradient.END;
  let obj4 = require(8466) /* GuildProfileBackground */;
  obj[3] = obj4.getBackgroundForProfile(tmp2, token);
  const items = [callback(importDefault(4615), obj), , ];
  ...
  obj3[1] = callback(require(7634) /* WarningIcon */.WarningIcon, obj4);
  ...
  const items1 = [callback(require(4189) /* Text */.Text, obj6), ];
  ...
  const items2 = [callback(require(7634) /* WarningIcon */.WarningIcon, obj8), ];
  ...
  obj7[4] = items2;
  items1[1] = callback2(require(4721) /* PressableBase */.PressableOpacity, obj7);
  obj5[1] = items1;
