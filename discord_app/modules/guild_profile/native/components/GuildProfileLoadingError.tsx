...
export default function GuildProfileLoadingError(onPress) {
  let obj = require(9173) /* GuildProfileBackground */;
  ...
  obj[1] = require(9173) /* GuildProfileBackground */.DiagonalGradient.START;
  obj[2] = require(9173) /* GuildProfileBackground */.DiagonalGradient.END;
  let obj4 = require(9173) /* GuildProfileBackground */;
  obj[3] = obj4.getBackgroundForProfile(tmp2, token);
  const items = [callback(importDefault(4706), obj), , ];
  ...
  obj3[1] = callback(require(7772) /* WarningIcon */.WarningIcon, obj4);
  ...
  const items1 = [callback(require(4281) /* Text */.Text, obj6), ];
  ...
  const items2 = [callback(require(7772) /* WarningIcon */.WarningIcon, obj8), ];
  ...
  obj7[4] = items2;
  items1[1] = callback2(require(4812) /* PressableBase */.PressableOpacity, obj7);
  obj5[1] = items1;
