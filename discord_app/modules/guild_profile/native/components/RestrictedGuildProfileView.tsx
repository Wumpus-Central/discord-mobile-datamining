...
export default function RestrictedGuildProfileView() {
  ...
  obj3[0] = require(5570) /* GuildIconSizes */.GuildIconSizes.XXLARGE;
  obj3[3] = styles.restrictedAcronym;
  obj2[1] = callback(importDefault(5570), obj3);
  ...
  const items1 = [callback(require(4189) /* Text */.Text, obj5), ];
  ...
  items1[1] = callback(require(4189) /* Text */.Text, obj6);
  obj4[1] = items1;
