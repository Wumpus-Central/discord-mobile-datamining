...
export default function NewTermsModal() {
  ...
  let obj = memo(5453);
  obj.useNavigatorBackPressHandler(memo(4877).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [callback3(tmp6(4441).Text, obj3), , , , , , ];
    ...
    items2[1] = callback3(tmp6(4441).Text, obj4);
    ...
    items2[3] = callback3(tmp6(4441).Text, obj8);
    ...
    items2[4] = callback3(tmp6(4441).Text, obj10);
    ...
    items2[5] = callback3(tmp6(4441).Text, obj12);
    ...
    items2[6] = callback3(tmp6(4441).Text, obj14);
    obj2[3] = items2;
    ...
    obj15[1] = callback3(tmp6(4880).Button, obj16);
    ...
    items3[2] = callback3(tmp2(8988), obj17);
    obj[1] = items3;
    tmp10 = callback4(closure_6, obj);
    const tmp2Result = tmp2(8988);
  }
  return tmp10;
};