...
export default function NewTermsModal() {
  ...
  let obj = memo(5276);
  obj.useNavigatorBackPressHandler(memo(4711).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [callback3(tmp6(4299).Text, obj3), , , , , , ];
    ...
    items2[1] = callback3(tmp6(4299).Text, obj4);
    ...
    items2[3] = callback3(tmp6(4299).Text, obj8);
    ...
    items2[4] = callback3(tmp6(4299).Text, obj10);
    ...
    items2[5] = callback3(tmp6(4299).Text, obj12);
    ...
    items2[6] = callback3(tmp6(4299).Text, obj14);
    obj2[3] = items2;
    ...
    obj15[1] = callback3(tmp6(4714).Button, obj16);
