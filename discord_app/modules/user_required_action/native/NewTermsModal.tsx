...
createStyles.stickyFooter = { paddingHorizontal: nativeDefault.space.PX_16, paddingVertical: nativeDefault.space.PX_16, marginTop: nativeDefault.space.PX_24, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, borderTopWidth: 1, borderTopColor: nativeDefault.colors.BORDER_SUBTLE };
...
export default function NewTermsModal() {
  ...
  let obj = memo(5644);
  obj.useNavigatorBackPressHandler(memo(4986).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [closure_12(tmp6(4570).Text, obj3), , , , , , ];
    ...
    items2[1] = closure_12(tmp6(4570).Text, obj4);
    ...
    items2[2] = closure_12(tmp6(4570).Text, obj6);
    ...
    items2[3] = closure_12(tmp6(4570).Text, obj8);
    ...
    items2[4] = closure_12(tmp6(4570).Text, obj10);
    ...
    items2[5] = closure_12(tmp6(4570).Text, obj12);
    ...
    items2[6] = closure_12(tmp6(4570).Text, obj14);
    ...
    obj15.children = closure_12(tmp6(4989).Button, obj16);
    ...
    items3[2] = closure_12(tmp2(9082), obj17);
    obj.children = items3;
