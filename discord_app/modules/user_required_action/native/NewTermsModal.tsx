...
export default function NewTermsModal() {
  ...
  let obj = memo(5275);
  obj.useNavigatorBackPressHandler(memo(4709).BackPressHandler.minimize);
  ...
  if (null != memo) {
    ...
    const items2 = [callback3(tmp6(4298).Text, obj3), , , , , , ];
    ...
    items2[1] = callback3(tmp6(4298).Text, obj4);
    ...
    items2[3] = callback3(tmp6(4298).Text, obj8);
    ...
    items2[4] = callback3(tmp6(4298).Text, obj10);
    ...
    items2[5] = callback3(tmp6(4298).Text, obj12);
    ...
    items2[6] = callback3(tmp6(4298).Text, obj14);
    obj2[3] = items2;
    ...
    obj15[1] = callback3(tmp6(4712).Button, obj16);
    ...
    items3[2] = callback3(tmp2(8997), obj17);
    obj[1] = items3;
    tmp10 = callback4(closure_6, obj);
    const tmp2Result = tmp2(8997);
  }
  return tmp10;
};