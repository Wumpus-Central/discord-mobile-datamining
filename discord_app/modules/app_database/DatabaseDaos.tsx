...
class DatabaseDaos extends Store {
  constructor() {
    ...
    closure_129_0 = (database) => {
      const guildEntityDao = new applyArgumentsResult(2072).GuildEntityDao(
        "guild_channels",
        applyArgumentsResult(2072).TableId.KvCache,
        database,
      );
    ...
    closure_130_0 = (database) => {
      const guildDao = new applyArgumentsResult(2072).GuildDao(
        "guild_channels_temp",
        applyArgumentsResult(2072).TableId.KvCache,
        database,
      );
    ...
    closure_131_0 = (database) => {
      const dao = new applyArgumentsResult(2072).Dao(
        "basic_channels",
        applyArgumentsResult(2072).TableId.KvCache,
        database,
      );
    ...
    closure_136_0 = (database) => {
      const entityDao = new applyArgumentsResult(2072).EntityDao(
        "guilds",
        applyArgumentsResult(2072).TableId.KvCache,
        database,
      );
    ...
    closure_139_0 = (database) => {
      const messageDao = new applyArgumentsResult(2072).MessageDao(
        "messages",
        applyArgumentsResult(2072).TableId.Messages,
        database,
      );
      return messageDao;
    };
