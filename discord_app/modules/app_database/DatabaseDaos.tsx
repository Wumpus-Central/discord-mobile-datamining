...
class DatabaseDaos extends Store {
  constructor() {
    ...
    closure_129_0 = (database) => {
      const guildEntityDao = new applyArgumentsResult(1988).GuildEntityDao(
        "guild_channels",
        applyArgumentsResult(1988).TableId.KvCache,
        database,
      );
    ...
    closure_130_0 = (database) => {
      const guildDao = new applyArgumentsResult(1988).GuildDao(
        "guild_channels_temp",
        applyArgumentsResult(1988).TableId.KvCache,
        database,
      );
    ...
    closure_131_0 = (database) => {
      const dao = new applyArgumentsResult(1988).Dao(
        "basic_channels",
        applyArgumentsResult(1988).TableId.KvCache,
        database,
      );
    ...
    closure_136_0 = (database) => {
      const entityDao = new applyArgumentsResult(1988).EntityDao(
        "guilds",
        applyArgumentsResult(1988).TableId.KvCache,
        database,
      );
    ...
    closure_139_0 = (database) => {
      const messageDao = new applyArgumentsResult(1988).MessageDao(
        "messages",
        applyArgumentsResult(1988).TableId.Messages,
        database,
      );
      return messageDao;
    };
