...
class DatabaseDaos extends Store {
  constructor() {
    ...
    closure_129_0 = (database) => {
      const guildEntityDao = new applyArgumentsResult(1987).GuildEntityDao(
        "guild_channels",
        applyArgumentsResult(1987).TableId.KvCache,
        database,
      );
    ...
    closure_130_0 = (database) => {
      const guildDao = new applyArgumentsResult(1987).GuildDao(
        "guild_channels_temp",
        applyArgumentsResult(1987).TableId.KvCache,
        database,
      );
    ...
    closure_131_0 = (database) => {
      const dao = new applyArgumentsResult(1987).Dao(
        "basic_channels",
        applyArgumentsResult(1987).TableId.KvCache,
        database,
      );
    ...
    closure_136_0 = (database) => {
      const entityDao = new applyArgumentsResult(1987).EntityDao(
        "guilds",
        applyArgumentsResult(1987).TableId.KvCache,
        database,
      );
    ...
    closure_139_0 = (database) => {
      const messageDao = new applyArgumentsResult(1987).MessageDao(
        "messages",
        applyArgumentsResult(1987).TableId.Messages,
        database,
      );
      return messageDao;
    };
