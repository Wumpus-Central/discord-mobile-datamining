...
class DatabaseDaos extends Store {
  constructor() {
    ...
    closure_129_0 = (database) => {
      const guildEntityDao = new applyArgumentsResult(2071).GuildEntityDao(
        "guild_channels",
        applyArgumentsResult(2071).TableId.KvCache,
        database,
      );
    ...
    closure_130_0 = (database) => {
      const guildDao = new applyArgumentsResult(2071).GuildDao(
        "guild_channels_temp",
        applyArgumentsResult(2071).TableId.KvCache,
        database,
      );
    ...
    closure_131_0 = (database) => {
      const dao = new applyArgumentsResult(2071).Dao(
        "basic_channels",
        applyArgumentsResult(2071).TableId.KvCache,
        database,
      );
    ...
    closure_136_0 = (database) => {
      const entityDao = new applyArgumentsResult(2071).EntityDao(
        "guilds",
        applyArgumentsResult(2071).TableId.KvCache,
        database,
      );
    ...
    closure_139_0 = (database) => {
      const messageDao = new applyArgumentsResult(2071).MessageDao(
        "messages",
        applyArgumentsResult(2071).TableId.Messages,
        database,
      );
      return messageDao;
    };
