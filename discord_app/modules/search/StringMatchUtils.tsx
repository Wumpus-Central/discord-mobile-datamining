...
let result = obj132.fileFinishedImporting("modules/search/StringMatchUtils.tsx");

export const calculateJaroWinklerSimilarity = function calculateJaroWinklerSimilarity(c0, item) {
  let obj = arg2;
  if (arg2 == null) {
    obj = {};
  }
  ...
  if (undefined !== caseSensitive) {
    if (caseSensitive) {
      let tmp2 = calculateJaroWinklerDistance(calculateJaroWinklerDistance, item);
    }
    return tmp2;
  }
  const formatted = calculateJaroWinklerDistance.toLowerCase();
