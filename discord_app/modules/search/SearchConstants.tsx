...
export const SEARCH_QUERY_BY_SEARCH_FILTER = {
  [obj.Media]: { has: ["image", "video"] },
  [obj.File]: { has: ["file"] },
  [obj.Messages]: {},
  [obj.Link]: { has: ["link"] },
  [obj.Pins]: { pinned: true },
};
...
export const SEARCH_TABS_TO_SEARCH_QUERY_LIMITS = {
  [obj.MEDIA]: 15,
  [obj.MESSAGES]: 15,
  [obj.PINS]: 15,
  [obj.LINKS]: 10,
...
export const SEARCH_TYPE_TO_SEARCH_INITIAL_TABS = {
  [SearchTypes.THREAD]: items11,
  [SearchTypes.CHANNEL]: items7,
  [SearchTypes.GUILD_CHANNEL]: items9,
  [SearchTypes.GUILD]: items5,
  [SearchTypes.DMS]: items3,
};
export const SEARCH_TYPE_TO_SEARCH_RESULT_TABS = {
  [SearchTypes.THREAD]: items12,
  [SearchTypes.CHANNEL]: items8,
  [SearchTypes.GUILD_CHANNEL]: items10,
  [SearchTypes.GUILD]: items6,
  [SearchTypes.DMS]: items4,
};
export const SearchHistoryItemTypes = {
  GUILD_TEXT_CHANNEL: "guild_text_channel",
  GUILD_VOICE_CHANNEL: "guild_voice_channel",
  GROUP_DM: "group_dm",
  DM: "dm",
  TEXT: "text",
};
export const SearchListItemTypes = {
  DM: "dm",
  GENERIC: "generic",
  GROUP_DM: "group_dm",
  GUILD_TEXT_CHANNEL: "guild_text_channel",
  ...
  FILE: "file",
  LINK: "link",
  FILE_OR_LINK_PLACEHOLDER: "file_or_link_placeholder",
  SECTION: "section",
...
export const SearchQuerySource = {
