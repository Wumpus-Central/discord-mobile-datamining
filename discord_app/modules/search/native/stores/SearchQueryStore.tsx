...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (isObfuscatedResult) {
    ...
    let channelName;
    if (null != channel) {
      channelName = obj(4980).computeChannelName(channel, UserStore, RelationshipStore);
      const obj2 = obj(4980);
    }
    if (null == channelName) {
      let items1 = [];
