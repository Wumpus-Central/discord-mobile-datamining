...
import SearchQueryTagManagerDefault from "SearchQueryTagManager.tsx";
...
const prototype = function SearchQueryStateManager(type) {
  ...
  if (isObfuscatedResult) {
    ...
    let channelName;
    if (null != channel) {
      channelName = obj(4910).computeChannelName(channel, UserStore, RelationshipStore);
      const obj2 = obj(4910);
    }
    if (null == channelName) {
      let items1 = [];
      ...
      const obj3 = {
        ...
        searchTokenType: constants2.FILTER_IN,
        text: null,
        channelId: null,
        location: null,
      };
