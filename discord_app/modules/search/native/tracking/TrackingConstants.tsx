...
obj = {
  ...
  [SearchTabs.PINS]: obj.PINS,
  [SearchTabs.LINKS]: obj.LINKS,
  [SearchTabs.FILES]: obj.FILES,
  [SearchTabs.MESSAGES]: obj.MESSAGES,
  [SearchTabs.PEOPLE]: obj.PEOPLE,
...
export const SearchFilterAddLocations = {
  ...
  CLIENT_AUTO_ADD: "client_auto_add",
  SEARCH_INPUT_PLAINTEXT: "search_input_plaintext",
};
