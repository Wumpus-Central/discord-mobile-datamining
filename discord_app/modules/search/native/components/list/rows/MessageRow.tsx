// === Module 16253: GuildChannelMessageRowHeader ===
...
import PollBadgeDefault from "PollBadge" /* 16255 */;
...
function GuildChannelMessageRowHeader(channel) {
  ...
  if (isSystemDMResult) {
    ...
    obj4[0] = tmp6(8933).Types.SYSTEM_DM;
    isSystemDMResult = tmp10(tmp6(8933), obj4);
    const tmp6Result = tmp6(8933);
  }
...
function PrivateChannelMessageRowLabel(message) {
  ...
  if (isSystemDMResult) {
    ...
    obj2[0] = channel(8933).Types.SYSTEM_DM;
    isSystemDMResult = tmp9(channel(8933), obj2);
    const tmp13 = channel(8933);
  }
  ...
  if (message.hasFlag(MessageFlags.SUPPRESS_NOTIFICATIONS)) {
    ...
    tmp9Result = tmp9(tmp4(12948).BellZIcon, obj4);
  }
  items3[2] = tmp9Result;
  tmp9Result = null;
  if (message.isPoll()) {
    ...
    tmp9Result = tmp9(channel(16255), obj5);
  }
  items3[3] = tmp9Result;
  obj[1] = items3;
  return closure_12(closure_4, obj);
...
function GuildChannelMessageRowLabel(arg0) {
  ...
  if ("username" === stateFromStores) {
    ...
    if (message.hasFlag(MessageFlags.SUPPRESS_NOTIFICATIONS)) {
      ...
      tmp21Result = tmp21(tmp2(12948).BellZIcon, obj5);
    }
