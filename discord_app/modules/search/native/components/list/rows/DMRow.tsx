  ...
  const memo = obj.useMemo(() => {
    ...
    if (!bot) {
      ...
      if (isOwner) {
        ...
        const obj1 = { size: native.Icon.Sizes.REFRESH_SMALL_16, source: _modDef9823, disableColor: true };
      ...
      if (tmp4Result) {
        ...
        const obj3 = { size: native.Icon.Sizes.REFRESH_SMALL_16, source: _modDef13578, disableColor: true };
