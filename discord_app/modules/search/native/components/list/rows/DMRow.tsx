  ...
  const memo = obj.useMemo(() => {
    ...
    if (!bot) {
      ...
      if (isOwner) {
        ...
        const obj5 = { size: native.Icon.Sizes.REFRESH_SMALL_16, source: _modDef9920, disableColor: true };
      ...
      if (tmp4Result3) {
        ...
        const obj7 = { size: native.Icon.Sizes.REFRESH_SMALL_16, source: _modDef13859, disableColor: true };
