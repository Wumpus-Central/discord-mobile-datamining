  ...
  const memo = obj.useMemo(() => {
    ...
    if (!bot) {
      ...
      if (isOwner) {
        ...
        const obj5 = { size: native.Icon.Sizes.REFRESH_SMALL_16, source: _modDef9904, disableColor: true };
      ...
      if (tmp4Result3) {
        ...
        const obj7 = { size: native.Icon.Sizes.REFRESH_SMALL_16, source: _modDef13614, disableColor: true };
