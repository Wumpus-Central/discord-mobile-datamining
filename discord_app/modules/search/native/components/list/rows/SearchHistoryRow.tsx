...
function SearchHistoryTextRow(searchContext) {
  ...
  obj.icon = closure_10(View, { style: tmp.iconContainer, children: closure_10(searchContext(7065).MagnifyingGlassIcon, { size: "sm", color: "interactive-text-default" }) });
  return closure_10(searchContext(16687).SearchListRow, obj);
}
function SearchHistoryGroupDMRow(searchContext) {
  ...
  let tmp8Result = null;
  if (null != stateFromStores) {
    obj = { channel: stateFromStores, onPress: callback, accessibilityActions: memo, onAccessibilityAction: callback1, trailing: tmp9 };
...
function SearchHistoryDMRow(searchContext) {
  ...
  let tmp8Result = null;
  if (null != stateFromStores) {
    obj = { user: stateFromStores, onPress: callback, accessibilityActions: memo, onAccessibilityAction: callback1, trailing: tmp9 };
...
function SearchHistoryGuildVoiceChannelRow(searchContext) {
  ...
  let tmp6 = null;
  if (null != stateFromStores) {
    obj = { channel: stateFromStores, voiceStates: speakerVoiceStates, speakerVoiceStates, trailing: null, onPress: null };
...
function SearchHistoryGuildTextChannelRow(searchContext) {
  ...
  let tmp9Result = null;
  if (null != stateFromStores) {
    obj = { channel: stateFromStores, lastMessageId: stateFromStores1, onPress: callback, accessibilityActions: memo, onAccessibilityAction: callback1, trailing: tmp10 };
...
obj = { paddingHorizontal: 8, paddingVertical: 4, borderRadius: nativeDefault.radii.lg, overflow: "hidden", margin: 2, flexDirection: "row", alignItems: "center", backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWEST };
obj.tag = obj;
