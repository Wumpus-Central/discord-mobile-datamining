...
function SearchHistoryRemoveIcon(searchContext) {
  ...
  return closure_10(searchContext(5339).PressableHighlight, {
    onPress: callback,
    accessibilityRole: "button",
    unstable_pressDelay: 130,
    style: { marginLeft: 16 },
    hitSlop: { bottom: 16, left: 16, right: 16, top: 16 },
    children: closure_10(searchContext(5897).XSmallIcon, { size: "sm", color: "interactive-text-default" }),
  });
}
function SearchHistoryTextRow(searchContext) {
  ...
  const items1 = [
    mapped,
    closure_10(searchContext(4752).Text, {
      lineClamp: 1,
  ...
  obj3.icon = closure_10(View, {
    ...
    children: closure_10(searchContext(7296).MagnifyingGlassIcon, { size: "sm", color: "interactive-text-default" }),
  });
  return closure_10(searchContext(17122).SearchListRow, obj3);
}
...
const SearchHistoryItemTypes = fn(8122).SearchHistoryItemTypes;
const jsxProd = fn(21);
