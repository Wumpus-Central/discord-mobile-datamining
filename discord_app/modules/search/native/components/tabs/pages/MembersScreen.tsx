// === Module 16500: SearchableMembersScreen ===
...
import closure_11 from "setAutocompleteOptions" /* 12156 */;
import closure_12 from "prototype" /* 12129 */;
import MessageEmbedTypes from "MessageEmbedTypes" /* 7632 */;
import { SearchResultContentEntityTypes as closure_15 } from "SearchEntrypointAnalyticsLocations" /* 7631 */;
  ...
  if (null != messageTabCountsErrorText) {
    ...
    if (stateFromStores5) {
      if (null != stateFromStores4) {
        ...
        obj1[3] = guildId;
        obj1[5] = tmp.userList;
        tmp25 = jsx(tmp2(11408), { onUserPress: null, onUserLongPress: null, channelId: null, guildId: null, disableStickySections: true, listStyleOverride: null, isNameplatedList: true, canShowDisplayNameStylesFont: true });
      }
    }
...
function ThreadMembersScreen(searchContext) {
  ...
  if (!stateFromStores) {
    if (obj2.useStateFromStores(items1, () => closure_1_12.isInitialSearchQuery(searchContext) && !closure_1_12.isTagsEmpty(searchContext), items2)) {
      ...
      let tmp7 = jsx(channelId(16502), { channelId: null, guildId: null, onUserPress: null, disableStickySections: true });
...
const memoResult = importAllResult.memo(function MembersScreen(searchContext) {
  ...
  if (constants.CHANNEL === type) {
    ...
    obj[1] = jsx(_modDef11979, { channelId: null, disableStickySections: true, listStyleOverride: null, onUserPress: null });
