...
export default noop.memo(function MediaScreen(searchContext) {
  ...
  const searchMessagesLoadingState = searchContext(16791).useSearchMessagesLoadingState(obj);
  ...
  const onPressMediaItem = searchContext(16734).useOnPressMediaItem({
    searchContext,
