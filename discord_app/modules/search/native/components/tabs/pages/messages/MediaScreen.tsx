...
export default noop.memo(function MediaScreen(searchContext) {
  ...
  const searchMessagesLoadingState = searchContext(16734).useSearchMessagesLoadingState(obj);
  ...
  const onPressMediaItem = searchContext(16677).useOnPressMediaItem({
    searchContext,
