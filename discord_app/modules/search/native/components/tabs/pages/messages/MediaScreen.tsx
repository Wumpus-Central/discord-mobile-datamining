...
export default noop.memo(function MediaScreen(searchContext) {
  ...
  const onPressMediaItem = searchContext(16645).useOnPressMediaItem({
    searchContext,
