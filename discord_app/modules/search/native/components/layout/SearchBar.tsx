...
const memoResult = importAllResult.memo(
  importAllResult.forwardRef((searchContext, ref) => {
    ...
    stateFromStores = searchContext(stateFromStores[14]).useStateFromStores(
      items,
      () => closure_1_9.getTags(searchContext),
      items1,
    );
    ...
    const effect = ref.useEffect(
      () =>
        setSuggestionsDismissed(stateFromStores[16]).subscribeTextInputValue(searchContext, (arg0, arg1, arg2) => {
          let tmp = arg2;
          if (!arg2) {
            tmp = null == arg0;
          }
    ...
    const memo2 = ref.useMemo(
      () => () => {
        ...
        if (!obj.isQueryStringEmpty(trimmed)) {
          closure_1_1(closure_1_2[17]).updateSearchQuery(tmp2, (markExplicitSearchSubmitted) =>
