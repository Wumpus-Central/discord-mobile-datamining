...
getChatInputMaxHeightWorklet.__closure = {
  getKeyboardStateWorklet: fn(12274).getKeyboardStateWorklet,
  KeyboardTypes: fn(1610).KeyboardTypes,
  getWindowDimensionsWorklet: fn(12275).getWindowDimensionsWorklet,
  MAX_HEIGHT: 200,
...
getChatInputHeightAnimationTimingWorklet.__closure = {
  ...
  withTiming: fn(4723).withTiming,
  timingFastDuration: fn(4726).timingFastDuration,
  Easing: fn(4458).Easing,
};
