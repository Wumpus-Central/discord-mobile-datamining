...
getChatInputMaxHeightWorklet.__closure = {
  getKeyboardStateWorklet: fn(12183).getKeyboardStateWorklet,
  KeyboardTypes: fn(1610).KeyboardTypes,
  getWindowDimensionsWorklet: fn(12184).getWindowDimensionsWorklet,
  MAX_HEIGHT: 200,
...
getChatInputHeightAnimationTimingWorklet.__closure = {
  ...
  withTiming: fn(4641).withTiming,
  timingFastDuration: fn(4644).timingFastDuration,
