...
let obj = {
  getKeyboardStateWorklet: fn(12102).getKeyboardStateWorklet,
  KeyboardTypes: fn(1609).KeyboardTypes,
  getWindowDimensionsWorklet: fn(12103).getWindowDimensionsWorklet,
  MAX_HEIGHT: 200,
...
obj = {
  ...
  withTiming: fn(4606).withTiming,
  timingFastDuration: fn(4609).timingFastDuration,
  Easing: fn(4341).Easing,
};
