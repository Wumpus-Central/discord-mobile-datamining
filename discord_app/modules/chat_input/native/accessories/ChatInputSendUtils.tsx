    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (arg0 === 1) {
          ...
          const obj2 = { applicationId: closure_129_0.applicationId, channel: params.channel, commandIntegrationTypes: closure_129_0.integration_types };
          c3 = 3;
          c4 = 1;
          const obj3 = { value: obj7.installApplicationOnDemandIfNeeded(obj2), done: false };
          return obj3;
        }
      } else {
        if (2 === tmp5) {
          if (arg0 === 1) {
            ...
            if (tmp20) {
              const obj5 = { text: closure_129_5.content, parsedMessage: "Array", tts: closure_129_5.tts, source: null, params };
              closure_130_15(obj5);
            }
          }
        } else if (arg0 === 1) {
          ...
          obj = { command: closure_129_0, optionValues: closure_129_1, context: null, maxSizeCallback: null };
          obj1 = closure_130_0(closure_130_2[33]);
          obj7 = { channel, type: "channel" };
          obj.context = obj1.getCommandContext(obj7);
          obj.maxSizeCallback = closure_130_17;
          c3 = 2;
          c4 = 1;
          const obj8 = { value: closure_130_1(closure_130_2[32])(obj), done: false };
          return obj8;
        }
        c4 = 3;
        return { value: "HermesInternal", done: null };
      ...
      if (null != tmp2) {
        ...
        if (null != uploads) {
          if (obj4.shouldShowAddMediaToOriginalPostModal(uploads, channel.id)) {
            ...
            params(4573).openLazy(tmp19(1896)(12091, tmp20.paths), "add-media-to-original-forum-post", obj);
