// === Module 11895: renderChatInputSendButton ===

// Module 11895 (renderChatInputSendButton)
import ThemesDefault from "Themes" /* 712 */;
import map from "map" /* 4165 */;
import _modDef4184 from "module_4184" /* 4184 */;
import useChatInputFloatingWidthDefault from "useChatInputFloatingWidth" /* 11900 */;
...
import { CHAT_INPUT_FLOATING_BOUNCE_ENTER_DELAY_MS as closure_8 } from "TextAreaCta" /* 11602 */;
...
function FloatingSlot(arg0) {
  ...
  return jsx(_modDef4184.View, { style, children });
}
...
let closure_12 = importAllResult.memo((type) => {
  ...
  if (type === constants.BUTTON_SEND_VOICE_MESSAGE || type === constants.BUTTON_SEND_VOICE_MESSAGE_DISABLED) {
    ...
    obj[0] = isOnCooldown;
    obj[1] = channelId;
    let tmp7Result = tmp7(tmp3(11896), obj);
  } else {
    ...
    tmp3Result = tmp3(11880);
    obj1[4] = tmp(4389).SendMessageIcon;
