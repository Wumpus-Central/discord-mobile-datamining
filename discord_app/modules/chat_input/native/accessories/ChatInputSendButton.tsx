...
import VoiceMessageButtonDefault from "VoiceMessageButton" /* 12406 */;
...
const forwardRefResult = noop.forwardRef((channel, arg1) => {
  ...
  if (stateFromStores) {
    ...
    if (canSendVoiceMessage) {
      ...
      obj9.disabled = !tmp12;
      tmp15Result = jsx(onSendMessage(12390), { active: true, style: null, activeStyle: null, activeIconStyle: null, IconComponent: null, accessibilityLabel: null, onPress: null, disabled: null });
