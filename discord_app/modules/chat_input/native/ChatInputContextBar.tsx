...
import createCacheKey from "createCacheKey";
import { registerAsset } from "../../../../_runtime/08391_registerAsset.js";
...
function ChatInputReplyBarNoAuthor(onCancelReplying) {
  ...
  if (obj.useMobileVisualRefreshConfig({ location: "ChatInputContextBar" }).chatInputFloating) {
    ...
    obj1[1] = callback(tmp(4827).PressableOpacity, obj2);
    ...
    obj4[5] = items1;
    tmp7Result = tmp7(tmp(4827).PressableOpacity, obj4);
  }
  return tmp7Result;
}
class ChatInputReplyBar {
  constructor(arg0) {
    ...
    f84305 = tmpResult4.useDisplayNameStylesFont({ displayNameStyles: tmp10 });
...
function ChatInputEditBar(onCancelEditing) {
  ...
  tmp7Result = tmp7(tmp(4827).PressableOpacity, obj);
