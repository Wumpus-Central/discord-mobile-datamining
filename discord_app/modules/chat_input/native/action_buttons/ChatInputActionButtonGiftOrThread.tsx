// === Module 11813: renderChatInputActionButtonGiftAndThread ===

// Module 11813 (renderChatInputActionButtonGiftAndThread)
import ThemesDefault from "Themes" /* 712 */;
import FadeTransitionItemDefault from "FadeTransitionItem" /* 11814 */;
...
function renderChatInputActionButtonGiftAndThread(arg0, styleButton, state, cleanup) {
  ...
  if (shouldShowThread) {
    ...
    obj[3] = onPress(11805).ThreadPlusIcon;
    obj[4] = function onPress(arg0) {
      return onPress(arg0, closure_1_5.THREAD);
    };
    obj[5] = styleButton;
    let tmpResult = tmp(tmp2(11807), obj);
    const tmp2Result = tmp2(11807);
  } else {
...
const memoResult = importAllResult.memo(function ChatInputActionButtonGiftOrThread(arg0) {
  ...
  obj = { style: callback(token, _require(4101).useToken(ThemesDefault.modules.mobile.CHAT_INPUT_ACTION_BUTTON_MARGIN)).container, children: null };
  ...
  obj[1] = jsx(_require(4108).TransitionGroup, { items: memo, renderItem: renderChatInputActionButtonGiftAndThread, getItemKey: getChatInputActionButtonGiftAndThreadKey });
