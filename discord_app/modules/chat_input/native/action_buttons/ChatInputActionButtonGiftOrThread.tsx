...
import _modDef11402 from "ChatInputActionButton.tsx";
import FadeTransitionItemDefault from "ChatInputActionButtonTransitionItem.tsx";
import _modDef11411 from "ChatInputActionButtonGift.tsx";
...
const memoResult = importAllResult.memo(function ChatInputActionButtonGiftOrThread(arg0) {
  ...
  let items = [arg0];
  const obj2 = map;
  { style: callback(token, require("../../../../design/tokens/native/useToken.tsx").useToken(ThemesDefault.modules.mobile.CHAT_INPUT_ACTION_BUTTON_MARGIN)).container, children: null };
  ...
  obj[1] = jsx(require("../../../../design/components/TransitionGroup/TransitionGroup.tsx").TransitionGroup, { items: memo, renderItem: renderChatInputActionButtonGiftAndThread, getItemKey: getChatInputActionButtonGiftAndThreadKey });
