// === Module 11529: renderChatInputActionButtonGiftAndThread ===
...
function renderChatInputActionButtonGiftAndThread(arg0, styleButton, state, cleanup) {
  ...
  if (shouldShowThread) {
    ...
    obj[3] = onPress(11521).ThreadPlusIcon;
    obj[4] = function onPress(arg0) {
      return onPress(arg0, outer1_5.THREAD);
    };
    obj[5] = styleButton;
    let tmpResult = tmp(tmp2(11523), obj);
    ...
    obj[4] = styleButton;
    tmpResult = tmp(tmp2(11532), obj);
  }
  obj[2] = tmpResult;
  return jsx(importDefault(11530), { cleanup, state, children: null }, arg0);
}
...
const memoResult = importAllResult.memo(function ChatInputActionButtonGiftOrThread(arg0) {
  ...
  obj[1] = jsx(_require(4600).TransitionGroup, { items: memo, renderItem: renderChatInputActionButtonGiftAndThread, getItemKey: getChatInputActionButtonGiftAndThreadKey });
