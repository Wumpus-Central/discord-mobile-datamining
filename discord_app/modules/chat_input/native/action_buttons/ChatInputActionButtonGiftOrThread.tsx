// === Module 11748: renderChatInputActionButtonGiftAndThread ===

// Module 11748 (renderChatInputActionButtonGiftAndThread)
import ThemesDefault from "Themes" /* 712 */;
import FadeTransitionItemDefault from "FadeTransitionItem" /* 11749 */;
import importAllResult from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import { ChatInputActionType } from "TextAreaCta" /* 11472 */;
...
function renderChatInputActionButtonGiftAndThread(arg0, styleButton, state, cleanup) {
  ...
  if (shouldShowThread) {
    ...
    obj[3] = onPress(11740).ThreadPlusIcon;
    obj[4] = function onPress(arg0) {
      return onPress(arg0, closure_1_5.THREAD);
    };
    obj[5] = styleButton;
    let tmpResult = tmp(tmp2(11742), obj);
...
const memoResult = importAllResult.memo(function ChatInputActionButtonGiftOrThread(arg0) {
  ...
  let items = [arg0];
  const obj2 = _require(4166);
  obj = { style: callback(token, _require(4166).useToken(ThemesDefault.modules.mobile.CHAT_INPUT_ACTION_BUTTON_MARGIN)).container, children: null };
  ...
  obj[1] = jsx(_require(4173).TransitionGroup, { items: memo, renderItem: renderChatInputActionButtonGiftAndThread, getItemKey: getChatInputActionButtonGiftAndThreadKey });
