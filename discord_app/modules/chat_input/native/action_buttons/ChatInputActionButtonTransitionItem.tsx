...
function BounceTransitionItem(state) {
  ...
  obj[0] = state !== require("../../../../design/components/TransitionGroup/TransitionGroup.tsx") /* wrapChildrenDefault */.TransitionStates.YEETED;
  obj[1] = state !== require("../../../../design/components/TransitionGroup/TransitionGroup.tsx") /* wrapChildrenDefault */.TransitionStates.ENTERED;
  obj[2] = bounceEnterDelayMs;
  obj[3] = cleanup;
  const tmp = require("useChatInputFloatingBounce.tsx");
  ({ isInteractive, animatedStyle } = require("useChatInputFloatingBounce.tsx")(obj));
  obj = { style: items };
  ...
  return jsx(require("../../../reanimated/ReanimatedRexport.tsx").View, { pointerEvents: str, accessibilityElementsHidden: !isInteractive, importantForAccessibility: null });
}
