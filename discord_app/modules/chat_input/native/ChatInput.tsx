...
const forwardRefResult = noop.forwardRef((channel, ref) => {
      ...
      handleBlur(nativeEvent) {
        ...
        if (current3 != null) {
          obj = {
            focused: false,
            text: str,
            selectionStart: tmp3.state.current.selectionStart,
            selectionEnd: tmp3.state.current.selectionEnd,
          };
      ...
      handleChangeContentSize(nativeEvent) {
        ...
        if (!obj.getIsChatInputHeightWorkletEnabled()) {
          ...
          const result = textFieldHeight.set(
            channel(12031).getChatInputHeightAnimationTiming(height, sharedValue.get()),
          );
      ...
      handleMaxHeightChanged() {
        if (!obj.getIsChatInputHeightWorkletEnabled()) {
          ...
          if (0 !== textFieldContentSize) {
            const textFieldHeight = closure_1_13.state.current.textFieldHeight;
            const result = textFieldHeight.set(
              channel(12031).getChatInputHeightAnimationTiming(textFieldContentSize, sharedValue.get()),
            );
      ...
      if (constants.PHOTOS === arg1) {
        ...
        if (tmp.APPS === arg1) {
          ...
          let obj6 = {
            ...
            onSelectFiles(items) {
              closure_0(10635).addImagesFromPicker(
  ...
  items21[10] = closure_37(screenIndex(12405), {
  ...
  items21[13] = closure_37(screenIndex(12432), {
    buttonRef: ref,
