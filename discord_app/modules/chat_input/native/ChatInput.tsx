...
const forwardRefResult = noop.forwardRef((channel, ref) => {
  ...
  ({ placeholder, accessibilityLabel } = screenIndex(12241)({
    channel,
    isReadonly: !editable,
    isCreatingThread: null != threadCreationCallback,
  }));
  const tmp48 = screenIndex(12241)({
    channel,
    isReadonly: !editable,
    isCreatingThread: null != threadCreationCallback,
  });
      ...
      handleChangeContentSize(nativeEvent) {
        ...
        if (!obj.getIsChatInputHeightWorkletEnabled()) {
          ...
          const result = textFieldHeight.set(
            channel(12288).getChatInputHeightAnimationTiming(height, sharedValue.get()),
          );
      ...
      handleMaxHeightChanged() {
        if (!obj.getIsChatInputHeightWorkletEnabled()) {
          ...
          if (0 !== textFieldContentSize) {
            const textFieldHeight = closure_1_13.state.current.textFieldHeight;
            const result = textFieldHeight.set(
              channel(12288).getChatInputHeightAnimationTiming(textFieldContentSize, sharedValue.get()),
            );
          ...
          if (0 === c3) {
            ...
            if (1 === tmp5) {
              if (arg0 === 1) {
                ...
                if (closure_1_13.state.current.focused) {
                  if (closure_1_13.props.current.canUpload) {
                    ...
                    c4 = 1;
                    const obj6 = {
                      value: closure_0(5356).getImageDimensionsIfMissing(closure_129_0, closure_129_1, closure_129_2),
                      done: false,
                    };
                    return obj6;
                  }
              ...
              const size = {
                ...
                platform: closure_0(5346).UploadPlatform.REACT_NATIVE,
                id: null,
              };
    ...
    obj.handlePressAction = function handlePressAction(arg0, arg1, current2) {
      if (constants.PHOTOS === arg1) {
        ...
        if (keyboardType === channel(1610).KeyboardTypes.APP_LAUNCHER) {
          ...
          const keyboardType1 = channel(4625).getKeyboardType();
          ...
          const tmp42Result = channel(4625);
        }
        ...
        if (constants.APPS === arg1) {
          ...
          const appDMApplication = channel(12453).getAppDMApplication(closure_1_13.props.current.channel);
          let name;
          ...
          const obj20 = {
            ...
            onSelectFiles(items) {
              closure_0(10901).addImagesFromPicker(
                closure_1_13.props.current.channel.id,
                items,
                closure_0(5346).UploadOrigin.IMAGE_PICKER,
              );
            },
      ...
      channel(10901).handleAttachFile({
        ...
        onSelectFiles(items) {
          closure_0(10901).addImagesFromPicker(
            ...
            items,
            closure_0(5346).UploadOrigin.FILE_ATTACHMENT,
          );
        },
      });
    };
  ...
  if (editable) {
    ...
    tmp66Result = closure_37(tmp6(12492), obj7);
  ...
  const items19 = [
    closure_37(screenIndex(12508), obj9),
    closure_37(screenIndex(12510), {
      keyboardType: tmp43,
  ...
  if (editable) {
    ...
    let tmp66Result17 = closure_37(tmp6(12511), obj12);
  ...
  if (!result1) {
    ...
    tmp66Result18 = closure_37(tmp(12518).ChatInputScrimGradient, obj14);
  }
  ...
  if (tmp22) {
    ...
    tmp66Result20 = closure_37(tmp6(12520), obj16);
  ...
  if (result1) {
    ...
    tmp66Result21 = closure_37(tmp(12518).ChatInputScrimGradient, obj18);
  }
  const items22 = [tmp66Result21, ,];
  let tmp66Result22 = null;
  if (null == threadCreationCallback) {
    let obj19 = { channel, screenIndex };
    tmp66Result22 = closure_37(tmp6(12221), obj19);
  }
  ...
  if (tmpResult57.isIOS()) {
    ...
    tmp66Result23 = closure_37(tmp6(12524), obj20);
  }
  ...
  if (isResourceChannel) {
    let obj21 = { channel };
    tmp66Result24 = closure_37(tmp6(12540), obj21, channel.id);
  }
  ...
  if (tmp23) {
    ...
    tmp66Result25 = closure_37(tmp6(12641), obj22);
  }
  ...
  if (tmp43 !== channel(1610).KeyboardTypes.EXPRESSION) {
    ...
    tmp66Result26 = closure_37(tmp6(12643), obj23);
  }
  items21[9] = tmp66Result26;
  items21[10] = closure_37(screenIndex(12663), {
  ...
  if (tmp66Result27) {
    ...
    tmp66Result27 = closure_37(tmp(12683).EmojiSuggestionBarLarge, obj28);
  }
  ...
  if (editable) {
    ...
    obj35.children = closure_37(tmp6(12688), obj38);
  ...
  if (tmp66Result30) {
    ...
    tmp66Result30 = closure_37(tmp(12689).EmojiSuggestionBarSmall, obj39);
  }
  ...
  if (null != refreshChatInputCoachmark) {
    ...
    tmp66Result31 = closure_37(tmp6(12242), obj40);
    const tmp6Result12 = tmp6(12242);
  }
  items21[12] = tmp66Result31;
  items21[13] = closure_37(screenIndex(12690), {
    buttonRef: ref,
  ...
  if (null == threadCreationCallback) {
    ...
    tmp66Result32 = closure_37(tmp6(12691), obj41);
  }
