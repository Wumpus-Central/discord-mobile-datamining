...
const forwardRefResult = noop.forwardRef((channel, ref) => {
  ...
  const items19 = [closure_37(tmp5Result, obj6), closure_37(screenIndex(12382), { keyboardType: tmp42, onSelectKeyboard: memo1.handleToggleKeyboard, ref: tmp55.chatInputCover })];
