...
const forwardRefResult = noop.forwardRef((channel, ref) => {
        ...
        if (arg0 === 1) {
          ...
          if (closure_1_13.state.current.focused) {
            if (closure_1_13.props.current.canUpload) {
              ...
              c3 = 2;
              c4 = 1;
              return { value: obj1.getImageDimensionsIfMissing(closure_129_0, closure_129_1, closure_129_2), done: false };
            }
          }
          c4 = 3;
        }
  ...
  const items19 = [closure_37(tmp5Result, obj6), closure_37(screenIndex(12346), { keyboardType: tmp42, onSelectKeyboard: memo1.handleToggleKeyboard, ref: tmp55.chatInputCover })];
