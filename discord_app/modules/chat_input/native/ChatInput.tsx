...
const forwardRefResult = noop.forwardRef((channel, ref) => {
  ...
  let obj1 = channel(4425);
  const gradientValue = obj1.useGradientValue(channel(4425).GradientPercentage.END);
  ...
  const tmpResult2 = channel(12057);
  ...
  const tmpResult3 = channel(12057);
  ...
  if (null == threadCreationCallback) {
    ...
    const tmpResult13 = tmp(9637);
  }
  const tmpResult12 = channel(4343);
  ...
  ({ placeholder, accessibilityLabel } = screenIndex(12077)(obj));
  const tmp47 = screenIndex(12077)(obj);
  function ze() {
  ...
  const tmpResult15 = channel(4343);
  obj = { disabled: !editable };
  const refreshChatInputCoachmark = channel(12078).useRefreshChatInputCoachmark(obj);
  const tmpResult16 = channel(12078);
  const canUseScheduledMessages = channel(7917).useCanUseScheduledMessages();
  const tmpResult17 = channel(7917);
  const items10 = [memo1];
  ...
  const scheduledMessageDraftCoachmarkState = channel(12079).useScheduledMessageDraftCoachmarkState(obj1);
  ...
  const tmp55 = screenIndex(12080)(obj2);
  ...
  memo1 = obj9.useMemo(() => {
      ...
      handleChangeContentSize(nativeEvent) {
        ...
        if (!obj.getIsChatInputHeightWorkletEnabled()) {
          ...
          const result = textFieldHeight.set(
            channel(12124).getChatInputHeightAnimationTiming(height, sharedValue.get()),
          );
      ...
      handleMaxHeightChanged() {
        if (!obj.getIsChatInputHeightWorkletEnabled()) {
          ...
          if (0 !== textFieldContentSize) {
            const textFieldHeight = closure_1_13.state.current.textFieldHeight;
            const result = textFieldHeight.set(
              channel(12124).getChatInputHeightAnimationTiming(textFieldContentSize, sharedValue.get()),
            );
    ...
    obj.handlePressAction = function handlePressAction(arg0, arg1, current2) {
      if (constants.PHOTOS === arg1) {
        ...
        if (keyboardType === channel(1609).KeyboardTypes.APP_LAUNCHER) {
          ...
          const keyboardType1 = channel(4474).getKeyboardType();
          ...
          const tmp42Result = channel(4474);
        }
        ...
        if (constants.APPS === arg1) {
          ...
          const appDMApplication = channel(12289).getAppDMApplication(closure_1_13.props.current.channel);
          let name;
          ...
          let obj6 = {
            ...
            onSelectFiles(items) {
              closure_0(10724).addImagesFromPicker(
                closure_1_13.props.current.channel.id,
                items,
                closure_0(5179).UploadOrigin.IMAGE_PICKER,
              );
            },
            draftType: registerViewTag.ChannelMessage,
          };
          channel(10724).handleViewAllDialog(obj6);
          const obj10 = channel(10724);
        } else if (constants.CAMERA === arg1) {
          obj5 = channel(4574);
          const result5 = obj5.triggerHapticFeedback(channel(4574).HapticFeedbackTypes.IMPACT_LIGHT);
          obj6 = channel(10724);
          const obj7 = {
            channel: closure_1_13.props.current.channel,
          ...
          obj1 = channel(4574);
          const result7 = obj1.triggerHapticFeedback(channel(4574).HapticFeedbackTypes.IMPACT_LIGHT);
          obj2 = channel(1115);
          if (obj2.isAndroid()) {
            let tmp5Result = channel(4472);
            tmp5Result.dismissKeyboard();
          }
          tmp5Result = channel(10724);
    ...
    obj.handlePollsPress = function handlePollsPress() {
      ...
      const result = obj.triggerHapticFeedback(channel(4574).HapticFeedbackTypes.IMPACT_LIGHT);
      obj = {
      ...
      channel(12290).openCreatePollModal(obj);
    };
      ...
      obj = {
        ...
        onSelectFiles(items) {
          closure_0(10724).addImagesFromPicker(
            ...
            items,
            closure_0(5179).UploadOrigin.FILE_ATTACHMENT,
          );
        },
      };
      channel(10724).handleAttachFile(obj);
    };
    obj.handlePressExpression = function handlePressExpression(context) {
      let obj = channel(10422);
  ...
  const tmpResult19 = channel(12079);
  if (editable) {
    obj4 = {
  ...
  obj6.customKeyboard = channel(12345).PORTAL_KEYBOARD_PLACEHOLDER_INSTANCE;
  ...
  const tmp66 = closure_37(screenIndex(12327), obj3);
  if (editable) {
    const obj8 = {
    ...
    tmp65Result = closure_37(tmp5(12347), obj8);
    const tmp5Result1 = tmp5(12347);
  } else {
    tmp65Result = null;
  }
  ...
  if (!result1) {
    ...
    tmp65Result1 = closure_37(tmp(12354).ChatInputScrimGradient, obj10);
  }
  ...
  if (tmp21) {
    ...
    tmp65Result3 = closure_37(tmp5(12356), obj12);
    const tmp5Result2 = tmp5(12356);
  }
  ...
  if (isResourceChannel) {
    let obj17 = { channel };
    tmp65Result7 = closure_37(tmp5(12375), obj17, channel.id);
  }
  ...
  if (tmp22) {
    ...
    tmp65Result8 = closure_37(tmp5(12476), obj18);
  }
  ...
  if (tmp42 !== channel(1609).KeyboardTypes.EXPRESSION) {
    ...
    tmp65Result9 = closure_37(tmp5(12478), obj19);
  }
  items21[9] = tmp65Result9;
  items21[10] = closure_37(screenIndex(12498), {
  ...
  if (enabled) {
    ...
    enabled = closure_37(tmp(12518).EmojiSuggestionBarLarge, obj24);
  }
  items26[1] = enabled;
  ...
  if (editable) {
    ...
    obj30.children = closure_37(tmp5(12523), obj32);
    tmp65Result11 = closure_37(tmp76, obj30);
    const tmp5Result4 = tmp5(12523);
  }
  ...
  if (enabled2) {
    ...
    enabled2 = closure_37(tmp(12524).EmojiSuggestionBarSmall, obj33);
  }
  items24[3] = enabled2;
  obj21.children = closure_38(closure_39, { children: items24 });
  items21[11] = closure_37(screenIndex(12500), obj21);
  ...
  if (null != refreshChatInputCoachmark) {
    ...
    tmp65Result12 = closure_37(tmp5(12078), obj34);
    const tmp5Result5 = tmp5(12078);
  }
  items21[12] = tmp65Result12;
  items21[13] = closure_37(screenIndex(12525), {
    buttonRef: ref,
  ...
  if (null == threadCreationCallback) {
    ...
    tmp65Result13 = closure_37(tmp5(12526), obj35);
  }
