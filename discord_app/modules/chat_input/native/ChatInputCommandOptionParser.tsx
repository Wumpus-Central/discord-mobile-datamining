// === Module 11563: findGameMentionTokens ===
...
import registerAssetDefault from "registerAsset" /* 8040 */;
...
export const getChannelHighlightNodes = function getChannelHighlightNodes(channel, arg1) {
  ...
  const _require = arg1;
  let items = [];
  dependencyMap = _require(11565).getChannels(channel);
  c3 = 0;
  function _loop4() {
    let arr = lib;
