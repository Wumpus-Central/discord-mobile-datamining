...
export default noop.memo(function ChatInputGuardSpamMessageRequest(channel) {
  ...
  obj = {
    ...
    onError() {
      ...
      obj.icon = navigation(5647);
      obj.open(obj);
    },
    onRejectSuccess: callback
  };
  const messageRequestActions = channel(12512).useMessageRequestActions(obj);
  ...
  return jsx(navigation(12518), { type: "button-action", message: null, subtext: null, buttonPrimaryText: null, buttonPrimaryOnPress: null, buttonPrimaryDisabled: null, buttonPrimaryLoading: null, buttonPrimaryVariant: "destructive", buttonSecondaryText: null, buttonSecondaryOnPress: null, buttonSecondaryDisabled: null, buttonSecondaryLoading: null });
});