  ...
  if ("simple-action" === type.type) {
    ...
    if (null != actionLabel) {
      if (null != actionOnPress) {
        ...
        if (actionIcon == null) {
          ...
          actionIcon = tmp7(tmp9(9748).ArrowSmallRightIcon, obj2);
        }
        obj1[1] = actionIcon;
        obj1[3] = actionOnPress;
        let tmp7Result = tmp7(tmp9(7817).IconButton, obj1);
      }
      obj[6] = tmp7Result;
    ...
    if (null != buttonSecondaryText) {
      ...
      if (null != buttonSecondaryOnPress) {
        ...
        items2[1] = tmp13(tmp14(4777).Button, obj9);
        obj8[0] = items2;
        tmp16Result = tmp16(tmp14(8726).TwinButtons, obj8);
      }
    }
    ...
    if (null != countdown2) {
      ...
      obj11[0] = items3;
      obj11[1] = countdown2;
      tmp13Result = tmp13(tmp(9743), obj11);
    }
...
export const ChatInputGuardContainer = function ChatInputGuardContainer(screenIndex) {
  ...
  let tmp11 = null;
  if (chatInputFloating) {
    tmp11 = callback(tmp4(11707).ChatInputScrimGradient, {});
  }
  const items2 = [tmp11, ];
  ...
  let tmp15 = null;
  if (tmp3) {
    tmp15 = callback(tmp(4911), { absolute: true, wide: true, tall: true, mix: true });
  }
