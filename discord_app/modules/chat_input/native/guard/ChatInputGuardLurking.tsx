// === Module 12713: ChatInputGuardLurking ===

// Module 12713 (ChatInputGuardLurking)
import preloaded_user_settings from "preloaded_user_settings" /* 1186 */;
import AppAnalyticsUtilsDefault from "AppAnalyticsUtils" /* 4937 */;
import GuildActionCreatorsDefault from "GuildActionCreators" /* 5739 */;
import GuildDiscoveryUtilsAll from "GuildDiscoveryUtils" /* 7586 */;
import HubProgressActionCreators from "HubProgressActionCreators" /* 10092 */;
import showChannelFollowingActionSheet from "showChannelFollowingActionSheet" /* 11592 */;
...
export default noop.memo(function ChatInputGuardLurking(channel) {
  ...
  if (type === constants2.DIRECTORY_ENTRY) {
    ...
    let tmp15Result = jsx(guildId(12706), { type: "button-action", message: null, buttonSecondaryText: null, buttonSecondaryOnPress: null, buttonPrimaryText: null, buttonPrimaryOnPress: null });
    const tmp14 = guildId(12706);
  } else {
    ...
    tmp15Result = jsx(guildId(12706), obj4);
    const tmp17 = guildId(12706);
  }
  return tmp15Result;
});