    ...
    chatInputRefObject = {
      ...
      closeCustomKeyboard() {
        ...
        if (keyboardType !== chatInputProps(ref[22]).KeyboardTypes.SYSTEM) {
          ...
          obj = { type: tmp(tmp2[22]).KeyboardTypes.SYSTEM };
      ...
      openSystemKeyboard() {
        ...
        if (!keyboardIsOpen) {
          ...
          obj = { type: tmp(tmp2[22]).KeyboardTypes.SYSTEM, context: { keyboardWillOpen: true } };
          tmpResult.setKeyboardType(obj);
