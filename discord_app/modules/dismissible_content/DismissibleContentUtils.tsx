    ...
    try {
      ...
      if (0 === c3) {
        if (arg0 === 1) {
          ...
          c2 = 1;
          const obj5 = {
            value: markVersionedDismissibleContentAsDismissed(
              closure_0,
              require("VersionedDismissibleContentUtils").getVersionedDismissibleContentCurrentVersion(closure_0),
              closure_1,
            ),
            done: false,
          };
...
let c14 = 2592000000;
let items = [
  fn(2028).DismissibleContent.ACCOUNT_LINK_INVITE_FRIENDS,
  fn(2028).DismissibleContent.AUTOCLIPPING_ACCOUNT_PANEL_COACHMARK,
];
...
export const getDismissedRecurringDismissibleContentState = function getDismissedRecurringDismissibleContentState(id) {
  ...
  if (obj.isVersionedDismissibleContent(id)) {
    num = VersionedDismissibleContentUtils.getVersionedDismissibleContentCurrentVersion(id);
    const tmp2Result = VersionedDismissibleContentUtils;
  }
  const obj2 = {
    lastDismissedVersion: num,
    lastDismissedAtMs: null,
    lastDismissedObjectId: null,
    numTimesDismissed: null,
  };
...
export const UNSAFE_removeTimeRecurringGuildDismissedContent = function UNSAFE_removeTimeRecurringGuildDismissedContent(
  ...
  return UserSettingsProtoActionCreators.updateGuildDismissedContent(arg0, stateFromStores, {
    dismissed: false,
    lastDismissedVersion: 0,
    lastDismissedAtMs: "0",
    lastDismissedObjectId: "0",
    ...
    if (tmp2) {
      ...
      if (!obj.disableNewUserDismissibleContent(closure_0)) {
        ...
        flag2 =
          ...
          null != guildDismissedContentState[closure_0] &&
          true === guildDismissedContentState[closure_0].dismissed;
        const tmp8 =
          null != guildDismissedContentState &&
          null != guildDismissedContentState[closure_0] &&
          true === guildDismissedContentState[closure_0].dismissed;
...
export const requestMarkDismissibleContentAsShown = function requestMarkDismissibleContentAsShown(
  ...
  if (!hasUserHitDCCapResult) {
    ...
    obj3.onAdded = function onAdded(found) {
      guildId = undefined;
      if (guildId != null) {
        guildId = guildId.guildId;
      }
