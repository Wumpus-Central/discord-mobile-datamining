    ...
    handleToggleDismissState: useCallback(() => {
      ...
      if (obj2.isVersionedDismissibleContent(closure_0)) {
        ...
        const versionedDismissibleContentCurrentVersion =
          objResult.getVersionedDismissibleContentCurrentVersion(closure_0);
            ...
            if (objResult13.isSingleUseGuildDismissibleContent(closure_0)) {
              ...
              if (objResult17.isTimeRecurringGuildDismissibleContent(closure_0)) {
                if (null == stateFromStores) {
                  ...
                  if (tmp24) {
                    num3 = num4 - num3;
                    const result13 = objResult20.UNSAFE_removeTimeRecurringGuildDismissedContent(
                      closure_0,
                      stateFromStores,
                      num3,
                    );
                    ...
                    const result14 = objResult20.UNSAFE_addTimeRecurringGuildDismissedContent(
                      closure_0,
                      stateFromStores,
                      num4,
                    );
                ...
                if (objResult21.isSnowflakeBoundGuildDismissibleContent(closure_0)) {
                  if (null == stateFromStores) {
                    ...
                    if (tmp9) {
                      num = num2 - num;
                      const result16 = objResult24.UNSAFE_removeSnowflakeBoundGuildDismissedContent(
                        closure_0,
                        stateFromStores,
                        num,
                      );
