...
const items = [
  ...
  dismissible_content.DismissibleContent.NUX_GUILD_CHANNEL_EXPLAINER,
  dismissible_content.DismissibleContent.SUPER_REACTION_TOGGLE_EDUCATION_MOBILE,
  dismissible_content.DismissibleContent.SUPER_REACTION_TOGGLE_EDUCATION_DESKTOP,
  ...
  dismissible_content.DismissibleContent.WHATS_NEW_APP_STYLES_JUNE_2024_NITRO_BADGE,
  dismissible_content.DismissibleContent.WHATS_NEW_REFERRAL_PROGRAM_NITRO_BADGE,
  dismissible_content.DismissibleContent.WHATS_NEW_SERVER_PROFILE_FLIP,
  dismissible_content.DismissibleContent.WHATS_NEW_SERVER_PROFILE_BADGE,
  dismissible_content.DismissibleContent.ICYMI_ALPHA_UPSELL,
  dismissible_content.DismissibleContent.PASSWORDLESS_UPSELL,
  dismissible_content.DismissibleContent.CHANNEL_LINKED_LOBBY_EDUCATION_TOOLTIP,
  ...
  dismissible_content.DismissibleContent.RESTRICTED_ACCOUNTS_SETTING_NOTICE,
  dismissible_content.DismissibleContent.SOUNDMOJI_BADGE,
  dismissible_content.DismissibleContent.TRIAL_NUX_EMOJI_BUTTON,
  dismissible_content.DismissibleContent.TRIAL_NUX_EMOJI_PICKER,
  ...
  dismissible_content.DismissibleContent.OVERLAY_OOP_WELCOME_BACKGROUND_NUX,
  dismissible_content.DismissibleContent.OVERLAY_OOP_WELCOME_BACKGROUND_SWITCH_FROM_IP_NUX,
  dismissible_content.DismissibleContent.OVERLAY_OOP_WELCOME_NUX,
  dismissible_content.DismissibleContent.OVERLAY_OOP_WELCOME_SWITCH_FROM_IP_NUX,
  dismissible_content.DismissibleContent.REVERSE_TRIAL_NITRO_TAB_BADGE_V2,
  ...
  dismissible_content.DismissibleContent.RING_USER_TO_VC_NEW_BADGE,
  dismissible_content.DismissibleContent.CUSTOM_THEME_ENTRYPOINT_NEW_BADGE,
  dismissible_content.DismissibleContent.GUILD_SETTINGS_GUILD_THEME_NEW_BADGE,
  dismissible_content.DismissibleContent.CUSTOM_THEME_ENTRYPOINT_GRADIENT,
  dismissible_content.DismissibleContent.MOBILE_BOGO_PROMOTION_ACTION_SHEET,
  dismissible_content.DismissibleContent.GOOGLE_PLAY_PRICE_CHANGE_ACTION_SHEET,
  dismissible_content.DismissibleContent.DISPLAY_NAME_STYLES_FLYWHEEL_MOBILE_NEW_BADGE_PROFILE_PAGE,
  dismissible_content.DismissibleContent.DISPLAY_NAME_STYLES_FLYWHEEL_NEW_BADGE_PROFILE_PAGE,
  dismissible_content.DismissibleContent.BOGO_2025_NITRO_TAB_BADGE,
  dismissible_content.DismissibleContent.BOGO_2025_ANNOUNCEMENT_MODAL,
  ...
  dismissible_content.DismissibleContent.GAME_SERVER_HOSTING_PORTKEY_TOS,
  dismissible_content.DismissibleContent.GAME_SERVER_HOSTING_NEW_BADGE,
  dismissible_content.DismissibleContent.GAME_SERVER_GAME_DETECTION_UPSELL_NEW_BADGE,
  dismissible_content.DismissibleContent.GAME_SERVER_HOSTING_IN_SHOP_DETECTION_NEW_BADGE,
  dismissible_content.DismissibleContent.DISPLAY_NAME_STYLES_FLYWHEEL_EDIT_PROFILE_NEW_BADGE,
  ...
  dismissible_content.DismissibleContent.EMPTY_GAME_SERVER_TAB,
