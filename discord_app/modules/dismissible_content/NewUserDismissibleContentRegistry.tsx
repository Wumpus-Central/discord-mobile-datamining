...
const dependencyMap = {
  ...
  [fn(1944).DismissibleContent.WHATS_NEW_APP_STYLES_JUNE_2024_NITRO_BADGE]: 0,
  [fn(1944).DismissibleContent.WHATS_NEW_REFERRAL_PROGRAM_NITRO_BADGE]: 0,
  [fn(1944).DismissibleContent.WHATS_NEW_SERVER_PROFILE_FLIP]: 0,
  [fn(1944).DismissibleContent.WHATS_NEW_SERVER_PROFILE_BADGE]: 0,
  [fn(1944).DismissibleContent.WHATS_NEW_TENURE_BADGE_REWARD]: 0,
  [fn(1944).DismissibleContent.FRACTIONAL_NITRO_DURATION_LEFT_PILL]: 0,
  [fn(1944).DismissibleContent.TRIAL_NUX_EMOJI_BUTTON]: 0,
  [fn(1944).DismissibleContent.TRIAL_NUX_EMOJI_PICKER]: 0,
  [fn(1944).DismissibleContent.TRIAL_NUX_STREAM_COACH_MARK]: 0,
  [fn(1944).DismissibleContent.OVERLAY_OOP_SETTINGS_NUX]: 0,
  [fn(1944).DismissibleContent.OVERLAY_OOP_WELCOME_NUX]: 0,
  [fn(1944).DismissibleContent.OVERLAY_OOP_WELCOME_BACKGROUND_NUX]: 0,
  [fn(1944).DismissibleContent.OVERLAY_OOP_WELCOME_SWITCH_FROM_IP_NUX]: 0,
  [fn(1944).DismissibleContent.OVERLAY_OOP_WELCOME_BACKGROUND_SWITCH_FROM_IP_NUX]: 0,
