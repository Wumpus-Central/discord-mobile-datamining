...
export const setMessageGroupSpacing = function setMessageGroupSpacing() {
  ...
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_SET_MESSAGE_GROUP_SPACING", messageGroupSpacing: tmp });
};
...
export const resetToDefault = function resetToDefault() {
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_RESET_TO_DEFAULT" });
};
export const enableKeyboardMode = function enableKeyboardMode() {
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_KEYBOARD_MODE_ENABLE" });
  const obj = require("../../Dispatcher.tsx");
  require("../../utils/AnalyticsUtils.tsx").track(AnalyticEvents.KEYBOARD_MODE_TOGGLED, { enabled: true });
};
export const disableKeyboardMode = function disableKeyboardMode() {
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_KEYBOARD_MODE_DISABLE" });
  const obj = require("../../Dispatcher.tsx");
  require("../../utils/AnalyticsUtils.tsx").track(AnalyticEvents.KEYBOARD_MODE_TOGGLED, { enabled: false });
};
export const toggleDesaturateUserColors = function toggleDesaturateUserColors() {
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_DESATURATE_ROLES_TOGGLE" });
};
export const toggleColorblindMode = function toggleColorblindMode() {
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_COLORBLIND_TOGGLE" });
};
export const forcedColorsModalSeen = function forcedColorsModalSeen() {
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_FORCED_COLORS_MODAL_SEEN" });
};
export const keyboardNavigationExplainerModalSeen = function keyboardNavigationExplainerModalSeen() {
  require("../../Dispatcher.tsx").dispatch({ type: "KEYBOARD_NAVIGATION_EXPLAINER_MODAL_SEEN" });
};
...
export const setRoleStyle = function setRoleStyle(roleStyle) {
  ...
  require("../../utils/AnalyticsUtils.tsx").track(AnalyticEvents.ROLE_STYLE_SETTING_UPDATED, obj);
};
export const setOfficialMessageStyle = function setOfficialMessageStyle(officialMessageStyle) {
  ...
  require("../../utils/AnalyticsUtils.tsx").track(AnalyticEvents.OFFICIAL_MESSAGE_STYLE_SETTING_UPDATED, obj);
};
...
export const toggleSubmitButton = function toggleSubmitButton() {
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_SUBMIT_BUTTON_TOGGLE" });
};
export const toggleSyncProfileThemeWithUserTheme = function toggleSyncProfileThemeWithUserTheme() {
  require("../../Dispatcher.tsx").dispatch({ type: "ACCESSIBILITY_SYNC_PROFILE_THEME_WITH_USER_THEME_TOGGLE" });
};
