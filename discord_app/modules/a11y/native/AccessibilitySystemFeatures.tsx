...
export default {
  ...
  handleReduceMotionChanged(arg0) {
    ...
    if (null != tmp5) {
      ...
      u(tmp(13780).accessibilityPreferencesSharedValue, obj);
      const tmp7 = u;
    }
  },
  ...
  handlePreferredColorSchemeChanged(colorScheme) {
    ...
    if ("dark" === colorScheme) {
      ...
      if (null != tmp21) {
        let obj = {};
        obj[tmp21] = false;
        u(tmp19(13780).accessibilityPreferencesSharedValue, obj);
        const tmp24 = u;
      }
      ...
      if (null != tmp10) {
        const obj1 = {};
        obj1[tmp10] = false;
        u(tmp8(13780).accessibilityPreferencesSharedValue, obj1);
        const tmp13 = u;
      }
      ...
      if (null != tmp16) {
        const obj2 = {};
        obj2[tmp16] = true;
        u(tmp8(13780).accessibilityPreferencesSharedValue, obj2);
        const tmp41 = u;
      }
      ...
      if (null != tmp35) {
        obj = {};
        obj[tmp35] = false;
        u(tmp33(13780).accessibilityPreferencesSharedValue, obj);
        const tmp2 = u;
      }
      ...
      if (null != tmp5) {
        const obj3 = {};
        obj3[tmp5] = false;
        u(tmp33(13780).accessibilityPreferencesSharedValue, obj3);
        const tmp38 = u;
      }
  ...
  handleAccessibilityStoreChanged() {
    ...
    if (null != tmp6) {
      ...
      u(tmp4(13780).accessibilityPreferencesSharedValue, obj);
      const tmp8 = u;
    }
    ...
    if (null != tmp24) {
      const obj1 = {};
      obj1[tmp24] = tmp22;
      u(tmp4(13780).accessibilityPreferencesSharedValue, obj1);
      const tmp26 = u;
    }
    ...
    if (null != tmp30) {
      const obj2 = {};
      obj2[tmp30] = tmp28;
      u(tmp4(13780).accessibilityPreferencesSharedValue, obj2);
      const tmp32 = u;
    }
  },
