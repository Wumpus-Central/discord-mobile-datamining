...
import _modDef15983 from "../messages/Test.messages.js";
import _modDef16015 from "../messages/SecondTest.messages.js";
...
function LocaleInfo() {
  ...
  const first = tmp[0];
  [tmp4, require] = noop.useState(_modDef4416.locale);
  const items1 = [first];
  const effect = noop.useEffect(() => {
    const timerId = setTimeout(() => {
      closure_1_0(_modDef4416.locale());
    }, 0);
  }, items1);
  const tmp3 = _slicedToArray(noop.useState(_modDef4416.locale), 2);
