// === Module 8452: isValidImageAttachment ===
...
function isValidImageAttachment(filename) {
  ...
  if (null == filename) {
    ...
    let tmp = require(4443) /* urlMatchesFileExtension */.isImageFile(filename.filename) && null != height;
    if (tmp) {
      tmp = height > 0;
    }
    if (tmp) {
  ...
  if (null != width.width) {
    if (width.width > 0) {
      if (null != width.height) {
        if (width.height > 0) {
          const enabledHarmTypesForMessage = require(5789) /* getEligibleHarmTypesConfigsForContext */.getEnabledHarmTypesForMessage(closure_0);
          const obj12 = require(5789) /* getEligibleHarmTypesConfigsForContext */;
          let obj = { type: null, media: null };
          obj[0] = require(5794) /* ContentHarmTypeChannel */.ObscuredMediaTypes.Attachment;
          obj[1] = width;
          const result = require(5789) /* getEligibleHarmTypesConfigsForContext */.isMediaObscuredForHarmTypes(obj, enabledHarmTypesForMessage);
          const obj13 = require(5789) /* getEligibleHarmTypesConfigsForContext */;
          const isVideoFileResult = require(4443) /* urlMatchesFileExtension */.isVideoFile(width.filename);
          if (null != width.proxy_url) {
            ...
            if (isVideoFileResult) {
              obj = { uri: null, messageId: null, guildId: null, channelId: null, videoURI: null, filename: null, mediaIndex: null, width: null, height: null, sourceURI: null, contentType: null, description: null, accessoryType: "attachment", spoiler: null, flags: null, obscure: null, placeholder: null, contentScanVersion: null, mediaViewIndex: null, attachmentId: null };
              obj[0] = mobileOptimizedSrc;
              obj[1] = closure_0.id;
              obj[2] = closure_02;
              obj[3] = closure_0.channel_id;
              obj[4] = url;
              obj[5] = tmp(8118)(width);
              obj[6] = index;
              ...
              obj[13] = tmp39Result.hasFlag(num3, constants.IS_SPOILER);
              obj[14] = width.flags;
              obj[15] = result;
              ({ placeholder: obj10[16], content_scan_version: obj10[17] } = width);
              obj[18] = arg4;
              obj[19] = width.id;
              return obj;
            } else {
              const obj1 = { uri: null, messageId: null, guildId: null, channelId: null, filename: null, mediaIndex: null, width: null, height: null, sourceURI: null, contentType: null, description: null, accessoryType: "attachment", spoiler: null, flags: null, obscure: null, placeholder: null, contentScanVersion: null, mediaViewIndex: null, attachmentId: null };
              obj1[0] = mobileOptimizedSrc;
              obj1[1] = closure_0.id;
              obj1[2] = closure_02;
              obj1[3] = closure_0.channel_id;
              obj1[4] = tmp(8118)(width);
              obj1[5] = index;
              ...
              obj1[12] = tmp39Result.hasFlag(num, constants.IS_SPOILER);
              obj1[13] = width.flags;
              obj1[14] = result;
              ...
              obj2.uri = url;
              const formatted = tmp(8118)(width).toLowerCase();
              const str3 = tmp(8118)(width);
              const tmp11 = constants;
              const endsWithResult = formatted.endsWith(".webp");
              const formatted1 = tmp(8118)(width).toLowerCase();
              const endsWithResult1 = formatted1.endsWith(".avif");
              const str5 = tmp(8118)(width);
              let num2 = width.flags;
              if (num2 == null) {
                num2 = 0;
              }
              if (tmp39Result1.hasFlag(num2, tmp11.IS_ANIMATED)) {
                const _URL2 = URL;
          ...
          url = width.url;
          const obj15 = require(4443) /* urlMatchesFileExtension */;
        }
      }
    }
  }
...
function extractMediaFromEmbed(image, closure_0, contentMessage, arg3, closure_02) {
  ...
  if (null != thumbnail) {
    if (null == image.video) {
      ...
      const hasSpoilerEmbeds = importDefault(7999)(closure_0, obj).hasSpoilerEmbeds;
      let obj2 = require(5789) /* getEligibleHarmTypesConfigsForContext */;
      const enabledHarmTypesForMessage = obj2.getEnabledHarmTypesForMessage(closure_0);
      let obj3 = require(5789) /* getEligibleHarmTypesConfigsForContext */;
      obj = { type: null, media: null };
      obj[0] = require(5794) /* ContentHarmTypeChannel */.ObscuredMediaTypes.Embed;
      obj[1] = image;
      ...
      const effectiveVideoProvider = tmp16Result.getEffectiveVideoProvider(name, url);
      const result1 = require(7853) /* frozen */.shouldPlayVideoInline(effectiveVideoProvider);
      let tmp27 = result1;
      if (result1) {
        tmp27 = null != image.video;
      }
      if (null != undefined) {
        if (!result1) {
          obj2 = { uri: null, messageId: null, guildId: null, channelId: null, mediaIndex: null, videoURI: null, embedURI: null, width: null, height: null, isGIFV: null, sourceURI: null, embedProviderName: null, accessoryType: "embed", noCarousel: null, spoiler: null, flags: null, contentScanVersion: null, contentType: null, obscure: null, thumbnail: null };
      ...
      if ("video" !== image.type) {
        const obj4 = { uri: null, messageId: null, guildId: null, channelId: null, mediaIndex: null, width: null, height: null, sourceURI: null, accessoryType: "embed", noCarousel: null, spoiler: null, flags: null, obscure: null, contentScanVersion: null, contentType: null };
      ...
      if (null == image.thumbnail) {
        ...
        if (!tmp27) {
          ...
          let obj6 = { uri: null, guildId: null, spoiler: null, flags: null, obscure: null, contentScanVersion: null, contentType: null, sourceURI: null, messageId: null, noCarousel: null, mediaIndex: null, accessoryType: "embed", width: null, height: null, channelId: null, embedURI: null, embedProviderName: null, disableDownload: true };
          ...
          if (null != proxyURL3) {
            ...
            if ("" !== proxyURL3) {
              ...
              if (!tmp36) {
                str1 = proxyURL3;
                if (str29) {
                  const searchParams10 = url3.searchParams;
            ...
            if (str34) {
              const searchParams11 = url3.searchParams;
              str34 = "true";
              proxyURL3 = searchParams11.append("animated", "true");
              if (str29) {
                const searchParams12 = url3.searchParams;
                proxyURL3 = "webp";
          ...
          obj6[15] = str1;
          obj6[16] = effectiveVideoProvider;
        ...
        let obj7 = { uri: null, guildId: null, spoiler: null, flags: null, obscure: null, contentScanVersion: null, contentType: null, messageId: null, noCarousel: null, mediaIndex: null, accessoryType: "embed", channelId: null, sourceURI: null, width: null, height: null };
      ...
      tmp13 = importDefault;
      const tmp16Result1 = require(7853) /* frozen */;
    } else {
...
function toMediaSourceFromUnfurledMedia(id, guild_id, media, description, spoiler) {
  ...
  let width;
  let width2;
  let obj = require(8012) /* transformToRowGeneratedComponent */;
  const unfurledMediaItemType = obj.getUnfurledMediaItemType(media);
  if (unfurledMediaItemType === require(8028) /* MediaGalleryItemType */.MediaGalleryItemType.VISUAL_PLACEHOLDER) {
    return null;
  } else {
    ...
    const tmp4 = unfurledMediaItemType === tmp(8028).MediaGalleryItemType.VIDEO;
    let str;
    if (tmp4) {
      str = "png";
    }
    ...
    let tmpResult = tmp(5789);
    const enabledHarmTypesForMessage = tmpResult.getEnabledHarmTypesForMessage(id);
    tmpResult = tmp(5789);
    obj = { type: null, media: null };
    obj[0] = tmp(5794).ObscuredMediaTypes.GenericMedia;
    obj[1] = media;
    obj = { messageId: null, guildId: null, channelId: null, uri: null, sourceURI: null, width: null, height: null, contentType: null, description: null, spoiler: null, obscure: null, contentScanVersion: null, accessoryType: "component", mediaIndex: 0 };
    obj[0] = id.id;
    obj[1] = guild_id;
    obj[2] = id.channel_id;
...
function handleDownloadError() {
  ...
  obj[0] = intl.string(require(1236) /* getSystemLocale */.t.cV3alD);
  const intl2 = require(1236) /* getSystemLocale */.intl;
  obj[1] = intl2.string(require(1236) /* getSystemLocale */.t.r4Zjzv);
  obj.show(obj);
}
...
export const extractMediaFromMessageComponents = function extractMediaFromMessageComponents(getContentMessage, contentMessage, closure_0) {
  if (0 === contentMessage.components.length) {
    ...
    let items = [];
    const obj2 = require(4477) /* flattenComponents */;
    const items1 = [];
    HermesBuiltin.arraySpread(require(4477) /* flattenComponents */.flattenComponents(contentMessage.components).values(), 0);
    ...
    while (iter !== undefined) {
      ...
      if (require(1906) /* PermissionOverwriteType */.ComponentType.MEDIA_GALLERY === type) {
        let tmp9 = nextResult;
        items = tmp4.items;
        let tmp10 = items;
        let tmp11 = items;
        ...
        let tmp29 = tmp5;
        let tmp30 = tmp7;
        if (tmp6(1906).ComponentType.THUMBNAIL === type) {
...
export const extractMediaSourcesFromEmbed = function extractMediaSourcesFromEmbed(arg0, contentMessage, images, index, guild_id) {
  ...
  const hasSpoilerEmbeds = importDefault(7999)(arg0, { contentMessage }).hasSpoilerEmbeds;
  ...
  return images.map((width) => {
    ...
    obj = { type: lib(tmp6[6]).ObscuredMediaTypes.Embed, media: tmp8 };
    const tmp10 = lib(index[5]).getMediaObscuredReasonFromBitmask(obj, enabledHarmTypesForMessage).length > 0;
    obj = { uri: mobileOptimizedSrc, messageId: lib.id, guildId: presentAddedFriendToast, channelId: lib.channel_id, mediaIndex: index, width: width.width, height: width.height, sourceURI: width.url, accessoryType: "embed", noCarousel: false, spoiler: hasSpoilerEmbeds, flags: tmp8.flags, obscure: tmp10, contentScanVersion: content_scan_version, contentType: width.contentType };
    const items = [obj, { uri: str, messageId: lib.id, guildId: presentAddedFriendToast, channelId: lib.channel_id, mediaIndex: index, width: width.width, height: width.height, sourceURI: width.url, accessoryType: "embed", noCarousel: false, spoiler: hasSpoilerEmbeds, contentType: width.contentType, flags: images.flags, obscure: tmp10, contentScanVersion: content_scan_version }];
    return items;
  });
};
export const extractMediaSourcesFromComponent = function extractMediaSourcesFromComponent(id, components, guild_id, tmp10Result3, componentMediaIndex) {
  ...
  let obj = _require(4477);
  const value = obj.flattenComponents(components).get(tmp10Result3);
  if (null == value) {
    return null;
  } else {
    const type = value.type;
    if (tmp(1906).ComponentType.MEDIA_GALLERY === type) {
      let num2 = 0;
      ...
      const mapped = items.map((media) => {
        let tmp = outer1_11(closure_0, closure_1, media.media, media.description, media.spoiler);
        if (null == tmp) {
          tmp = null;
          if (arg1 < closure_2) {
      ...
      return obj;
    } else if (tmp(1906).ComponentType.THUMBNAIL === type) {
      ...
      if (isValidImageAttachment(tmp)) {
        ...
        if (tmp5) {
          ...
          if (isVideoFileResult) {
            let tmp7 = require;
            let tmp8 = dependencyMap;
            let obj = require(4443) /* urlMatchesFileExtension */;
...
export const useSelectedMediaSource = function useSelectedMediaSource(syncer) {
  ...
  const tmp = importDefault(8453)(syncer.index);
  importDefault = tmp;
...
export const downloadMediaAsset = function downloadMediaAsset(mediaUrl, VIDEO) {
  ...
  return MediaManager.downloadMediaAsset(mediaUrl, VIDEO).then(() => {
    ...
    } else if (tmp2(tmp3[18]).MediaType.GIF === tmp) {
      tmp2Result = tmp2(tmp3[19]);
      tmp2Result.presentGifSaved();
    } else if (tmp2(tmp3[18]).MediaType.VIDEO === tmp) {
      tmp2(tmp3[19]).presentVideoSaved();
      const tmp2Result1 = tmp2(tmp3[19]);
    }
    const MediaViewerAnalytics = tmp2(tmp3[20]).MediaViewerAnalytics;
    ...
    if (6 === match.length) {
      ...
      if (null != match[1]) {
        ...
        if (null != tmp2) {
          tmp4 = null;
          if (null != tmp3) {
            const obj = { videoId: null, clip: null, clipt: null };
            obj[0] = tmp;
            obj[1] = tmp2;
            obj[2] = tmp3;
            tmp4 = obj;
...
export const getVideoSourceType = function getVideoSourceType(source) {
  ...
  if (null != source.portal) {
    ...
    obj2 = require(8455) /* MediaPlayerManager */;
  }
...
export const isAnimatedWebpSource = function isAnimatedWebpSource(sourceURI) {
  ...
  if (result) {
    result = require(4443) /* urlMatchesFileExtension */.urlMatchesFileExtension(sourceURI.sourceURI, closure_6);
    const obj = require(4443) /* urlMatchesFileExtension */;
  }
  if (result) {
    const _URL = URL;
...
export const isAnimatedAvifSource = function isAnimatedAvifSource(sourceURI) {
  let result = null != sourceURI.sourceURI && null != sourceURI.uri;
  if (result) {
    result = require(4443) /* urlMatchesFileExtension */.urlMatchesFileExtension(sourceURI.sourceURI, closure_7);
    const obj = require(4443) /* urlMatchesFileExtension */;
  }
  if (result) {
    const _URL = URL;
...
export const isGIFSource = function isGIFSource(sourceURI) {
  return require(4443) /* urlMatchesFileExtension */.urlMatchesFileExtension(sourceURI.sourceURI, require(691) /* keys */.GIF_RE_IOS);
};
export const isAnimatedImageSource = function isAnimatedImageSource(source) {
  let result = require(4443) /* urlMatchesFileExtension */.urlMatchesFileExtension(source.sourceURI, require(691) /* keys */.GIF_RE_IOS);
  if (!result) {
    let result1 = null != source.sourceURI && null != source.uri;
    if (result1) {
      let tmpResult = tmp(4443);
