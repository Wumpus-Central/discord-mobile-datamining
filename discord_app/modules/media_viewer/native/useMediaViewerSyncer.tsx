...
let closure_12 = {
  code: "function useMediaViewerSyncerTsx2(){const{thumbnailsScrolling,SCROLLING_DRAG}=this.__closure;thumbnailsScrolling.set(thumbnailsScrolling.get()&~SCROLLING_DRAG);}",
};
let closure_13 = {
...
let closure_14 = {
  code: "function useMediaViewerSyncerTsx4(){const{thumbnailsScrolling,SCROLLING_MOMENTUM,swipeSource}=this.__closure;thumbnailsScrolling.set(thumbnailsScrolling.get()|SCROLLING_MOMENTUM);swipeSource.set('thumbnails');}",
};
let closure_15 = {
  code: "function useMediaViewerSyncerTsx5(){const{thumbnailsScrolling,SCROLLING_MOMENTUM}=this.__closure;thumbnailsScrolling.set(thumbnailsScrolling.get()&~SCROLLING_MOMENTUM);}",
};
let closure_16 = {
  code: "function useMediaViewerSyncerTsx6(){const{thumbnailsAnimateTo,variableWidthThumbnailsEnabled,runOnJS,scrollVarWidthThumbnails,scrollTo,ref,thumbnailSize}=this.__closure;if(thumbnailsAnimateTo.get()<0)return;if(variableWidthThumbnailsEnabled){runOnJS(scrollVarWidthThumbnails)(thumbnailsAnimateTo.get());}else{scrollTo(ref,thumbnailsAnimateTo.get()*thumbnailSize,0,true);}}",
};
let closure_17 = {
  code: "function useMediaViewerSyncerTsx7(){const{viewerScrolling,thumbnailsIndex,viewerPos,variableWidthThumbnailsEnabled,runOnJS,lerpScrollVarWidthThumbnails,scrollTo,ref,thumbnailSize}=this.__closure;if(viewerScrolling.get()===0)return;else if(thumbnailsIndex.get()!==viewerPos.get()){if(variableWidthThumbnailsEnabled){runOnJS(lerpScrollVarWidthThumbnails)(viewerPos.get());}else{scrollTo(ref,viewerPos.get()*thumbnailSize,0,false);}}}",
};
let closure_18 = {
  code: "function useMediaViewerSyncerTsx8(){const{thumbnailsScrolling,interpolate,viewerPos,interpolateInput,interpolateOutput}=this.__closure;return thumbnailsScrolling.get()>0?0:-interpolate(viewerPos.get(),interpolateInput,interpolateOutput,'clamp');}",
};
let closure_19 = {
  code: "function useMediaViewerSyncerTsx9(){const{viewerScrolling,headerBufferSize,margin,withSpring}=this.__closure;return{width:viewerScrolling.get()>0?headerBufferSize+margin.get():withSpring(headerBufferSize+margin.get(),{overshootClamping:true})};}",
};
let closure_20 = {
  code: "function useMediaViewerSyncerTsx10(){const{viewerScrolling,footerBufferSize,margin,withSpring}=this.__closure;return{width:viewerScrolling.get()>0?footerBufferSize+margin.get():withSpring(footerBufferSize+margin.get(),{overshootClamping:true})};}",
};
let closure_21 = {
  code: "function useMediaViewerSyncerTsx11(){const{interpolate,viewerPos,index}=this.__closure;return interpolate(viewerPos.get(),[index-1,index,index+1],[0.4,1,0.4],'clamp');}",
};
let closure_22 = {
  code: "function useMediaViewerSyncerTsx13(){const{thumbnailsScrolling,THUMBNAIL_MIN_WIDTH,interpolate,viewerPos,index,sourceWidth}=this.__closure;return thumbnailsScrolling.get()>0?THUMBNAIL_MIN_WIDTH:interpolate(viewerPos.get(),[index-1,index,index+1],[THUMBNAIL_MIN_WIDTH,sourceWidth,THUMBNAIL_MIN_WIDTH],'clamp');}",
};
let closure_23 = {
  code: "function useMediaViewerSyncerTsx14(){const{viewerScrolling,_width,withSpring,THUMBNAIL_HEIGHT,opacity}=this.__closure;return{width:viewerScrolling.get()>0?_width.get():withSpring(_width.get(),{overshootClamping:true}),height:THUMBNAIL_HEIGHT,opacity:opacity.get()};}",
};
let closure_24 = { code: "function useMediaViewerSyncerTsx15(){const{zoomed}=this.__closure;return!zoomed.get();}" };
let closure_25 = {
  code: "function useMediaViewerSyncerTsx16(){const{thumbnailsAnimateTo,scrollTo,ref,screenWidth}=this.__closure;if(thumbnailsAnimateTo.get()===-1)return;scrollTo(ref,thumbnailsAnimateTo.get()*screenWidth,0,false);}",
};
let closure_26 = {
  code: "function useMediaViewerSyncerTsx17(){const{thumbnailsScrolling,viewerScrolling,thumbnailsAnimateTo,scrollTo,ref,thumbnailsIndex,screenWidth}=this.__closure;if(thumbnailsScrolling.get()===0||viewerScrolling.get()>0||thumbnailsAnimateTo.get()!==-1)return;scrollTo(ref,thumbnailsIndex.get()*screenWidth,0,false);}",
};
let closure_27 = {
  code: "function useMediaViewerSyncerTsx18(){const{viewerScrolling,SCROLLING_DRAG,swipeSource}=this.__closure;viewerScrolling.set(viewerScrolling.get()|SCROLLING_DRAG);swipeSource.set('viewer');}",
};
let closure_28 = {
  code: "function useMediaViewerSyncerTsx19(){const{viewerScrolling,SCROLLING_DRAG}=this.__closure;viewerScrolling.set(viewerScrolling.get()&~SCROLLING_DRAG);}",
};
let closure_29 = {
  code: "function useMediaViewerSyncerTsx20(offsetX){const{viewerPos,screenWidth,swipeSource,resolveSelectedIndex,maxIndex,selectedIndex,runOnJS,onSelectedIndexChange}=this.__closure;viewerPos.set(offsetX/screenWidth);if(swipeSource.get()!=='viewer')return;const nearest=resolveSelectedIndex({offsetX:offsetX,pageSize:screenWidth,maxIndex:maxIndex});if(nearest==null||selectedIndex.get()===nearest)return;selectedIndex.set(nearest);runOnJS(onSelectedIndexChange)();}",
};
let closure_30 = {
  code: "function useMediaViewerSyncerTsx21(){const{viewerScrolling,SCROLLING_MOMENTUM,swipeSource}=this.__closure;viewerScrolling.set(viewerScrolling.get()|SCROLLING_MOMENTUM);swipeSource.set('viewer');}",
};
let closure_31 = {
  code: "function useMediaViewerSyncerTsx22(){const{viewerScrolling,SCROLLING_MOMENTUM}=this.__closure;viewerScrolling.set(viewerScrolling.get()&~SCROLLING_MOMENTUM);}",
};
let closure_32 = {
  code: "function isSpuriousContentSizeReset_useMediaViewerSyncerTsx23(offsetX){const{IS_ANDROID,contentSizeLastChangedAt,selectedIndex}=this.__closure;return IS_ANDROID&&Date.now()-contentSizeLastChangedAt.get()<500&&offsetX===0&&selectedIndex.get()!==0;}",
};
let closure_33 = {
  code: "function useMediaViewerSyncerTsx24(event){const{onScrollWorklets}=this.__closure;onScrollWorklets.onEndDrag();onScrollWorklets.onScroll(event.contentOffset.x);}",
};
let closure_34 = {
  code: "function useMediaViewerSyncerTsx25(event){const{isSpuriousContentSizeReset,scrollTo,ref,selectedIndex,screenWidth,viewerScrolling,thumbnailsScrolling,thumbnailsAnimateTo,onScrollWorklets}=this.__closure;if(isSpuriousContentSizeReset(event.contentOffset.x)){scrollTo(ref,selectedIndex.get()*screenWidth,event.contentOffset.y,false);return;}if(viewerScrolling.get()===0&&thumbnailsScrolling.get()===0&&thumbnailsAnimateTo.get()===-1)return;onScrollWorklets.onScroll(event.contentOffset.x);}",
};
let closure_35 = {
  code: "function useMediaViewerSyncerTsx26(event){const{isSpuriousContentSizeReset,onScrollWorklets}=this.__closure;if(!isSpuriousContentSizeReset(event.contentOffset.x)){onScrollWorklets.onScroll(event.contentOffset.x);}onScrollWorklets.onMomentumEnd();}",
};
let closure_36 = {
  code: "function useMediaViewerSyncerTsx27(){const{index,selectedIndex}=this.__closure;return index===selectedIndex.get();}",
};
let closure_37 = {
  code: "function useMediaViewerSyncerTsx28(result,previous){const{runOnJS,setVisible}=this.__closure;if(previous==null||previous===result)return;runOnJS(setVisible)(result);}",
};
let size = fn(2);
...
export const useMediaViewerSyncer = function useMediaViewerSyncer(sources) {
  ...
  memo = memo.useMemo(() => {
    const obj = {
      selectedIndex: ReanimatedRexport.makeMutable(initialIndex),
      thumbnailsIndex: null,
      thumbnailsScrolling: null,
      thumbnailsAnimateTo: null,
      viewerPos: null,
      viewerScrolling: null,
      zoomed: null,
      swipeSource: null,
    };
  ...
  return memo.useMemo(() => {
    ...
    if (0 < sources.length) {
      do {
        ...
        if (null != size) {
          ...
          let sum =
            num2 +
            (Math.max(Math.min(size.width * (timestampProducer / size.height), React5), React6) + 2 * hasOwnProperty);
          let num3 = 0;
          if (0 !== num) {
            let _Math3 = Math;
    ...
    function onSelectedIndexChange() {
      if ("thumbnails" === swipeSource.get()) {
        ...
        MediaViewerAnalytics.markActionPerformed(
          sources(onEndReached[4]).IncrementableMediaViewerActions.THUMBNAIL_SWIPE,
        );
      } else if ("viewer" === swipeSource.get()) {
        const MediaViewerAnalytics3 = sources(onEndReached[4]).MediaViewerAnalytics;
        MediaViewerAnalytics3.markActionPerformed(
          sources(onEndReached[4]).IncrementableMediaViewerActions.VIEWER_SWIPE,
        );
      }
      const MediaViewerAnalytics2 = sources(onEndReached[4]).MediaViewerAnalytics;
      MediaViewerAnalytics2.markActionPerformed(
        sources(onEndReached[4]).IncrementableMediaViewerActions.SELECTED_ITEM_CHANGE,
      );
    }
    let selectedIndex = memo.selectedIndex;
    ({
      thumbnailsIndex: onEndReachedThreshold,
      thumbnailsScrolling: memo,
      thumbnailsAnimateTo: closure_5,
      viewerPos: closure_6,
      viewerScrolling: closure_7,
      zoomed,
    } = memo);
    ...
    return {
      ...
      useThumbnailsProps(onSelect, maxIndex) {
        ...
        N.__closure = {
          ...
          swipeSource,
          maxIndex,
          thumbnailsIndex: mapped,
          thumbnailsAnimateTo: derivedValue2,
          selectedIndex: animatedRef,
          viewerScrolling: diff1,
          thumbnailsScrolling: mapped1,
          runOnJS: arr(selectedIndex[5]).runOnJS,
        ...
        V.__closure = {
          ...
          variableWidthThumbnailsEnabled,
          runOnJS: arr(selectedIndex[5]).runOnJS,
          scrollVarWidthThumbnails: callback1,
          scrollTo: arr(selectedIndex[5]).scrollTo,
          ref: animatedRef,
          thumbnailSize: onSelect,
        };
        ...
        U.__closure = {
          ...
          variableWidthThumbnailsEnabled,
          runOnJS: arr(selectedIndex[5]).runOnJS,
          lerpScrollVarWidthThumbnails: callback2,
          scrollTo: arr(selectedIndex[5]).scrollTo,
          ref: animatedRef,
          thumbnailSize: onSelect,
        };
        ...
        mapped1 = onSelect.map((item) => {
          ...
          if (null != size) {
            ...
            const _Math2 = Math;
            num =
              (Math.max(Math.min(size.width * (diff / size.height), diff1), THUMBNAIL_MIN_WIDTH) -
                THUMBNAIL_MIN_WIDTH) /
              2;
          }
          return num;
        ...
        ee.__closure = {
          thumbnailsScrolling: mapped1,
          interpolate: arr(selectedIndex[5]).interpolate,
          viewerPos,
          interpolateInput: mapped,
          interpolateOutput: mapped1,
        };
        ...
        te.__closure = {
          ...
          margin: derivedValue2,
          withSpring: arr(selectedIndex[10]).withSpring,
        };
        ...
        const callback3 = React.useCallback((width, index) => {
          ...
          fn2.__closure = {
            thumbnailsScrolling: mapped1,
            THUMBNAIL_MIN_WIDTH,
            interpolate: onSelect(animatedRef[5]).interpolate,
            viewerPos,
            index,
            sourceWidth: bound,
          };
          ...
          fn3.__closure = {
            viewerScrolling: diff1,
            _width: derivedValue1,
            withSpring: onSelect(animatedRef[10]).withSpring,
            THUMBNAIL_HEIGHT: diff,
      ...
      useViewerProps() {
        ...
        fn.__closure = {
          thumbnailsAnimateTo: isSpuriousContentSizeReset,
          scrollTo: arr(selectedIndex[5]).scrollTo,
          ref: animatedRef,
          screenWidth: width,
        };
        ...
        fn2.__closure = {
          thumbnailsScrolling: sharedValue,
          viewerScrolling,
          thumbnailsAnimateTo: isSpuriousContentSizeReset,
          scrollTo: arr(selectedIndex[5]).scrollTo,
          ref: animatedRef,
          thumbnailsIndex: memo,
          screenWidth: width,
        };
        ...
        memo = React.useMemo(() => {
          ...
          fn3.__closure = {
            ...
            screenWidth: width,
            swipeSource,
            resolveSelectedIndex: sources(onEndReached[11]).resolveSelectedIndex,
            maxIndex: diff,
            selectedIndex,
            runOnJS: sources(onEndReached[5]).runOnJS,
            onSelectedIndexChange,
          };
        ...
        isSpuriousContentSizeReset.__closure = {
          IS_ANDROID: onSelectedIndexChange,
          contentSizeLastChangedAt: sharedValue,
          selectedIndex,
        };
        ...
        const obj10 = {
          onBeginDrag: memo.onBeginDrag,
          onEndDrag: null,
          onScroll: null,
          onMomentumBegin: null,
          onMomentumEnd: null,
        };
