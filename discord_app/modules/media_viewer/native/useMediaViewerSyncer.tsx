...
({
  THUMBNAIL_MARGIN: c5,
  THUMBNAIL_HEIGHT: closure_6,
  THUMBNAIL_MAX_WIDTH: error,
  THUMBNAIL_MIN_WIDTH: closure_8,
  THUMBNAIL_WIDTH_MARGIN: c9,
} = THUMBNAIL_MARGIN);
...
export const useMediaViewerSyncer = function useMediaViewerSyncer(sources) {
  ...
  memo = memo.useMemo(() => {
    const obj = {
      selectedIndex: sources(onEndReached[5]).makeMutable(initialIndex),
  ...
  return memo.useMemo(() => {
    ...
    if (0 < arr.length) {
      do {
        ...
        if (null != size) {
          ...
          let sum =
            num2 +
            (Math.max(Math.min(size.width * (closure_1_6 / size.height), closure_1_7), closure_1_8) + 2 * closure_1_5);
          let num3 = 0;
          if (0 !== num) {
            let _Math3 = Math;
    ...
    function onSelectedIndexChange() {
      ...
      MediaViewerAnalytics2.markActionPerformed(
        arr(selectedIndex[4]).IncrementableMediaViewerActions.SELECTED_ITEM_CHANGE,
      );
    }
    ...
    return {
      ...
      useThumbnailsProps(onSelect, maxIndex) {
        ...
        obj1 = {
          variableWidthThumbnailsEnabled: c11,
          thumbnailScrollPositions: closure_1,
        ...
        U.__closure = {
          ...
          viewerPos: diff,
          variableWidthThumbnailsEnabled: c11,
          runOnJS: onSelect(selectedIndex[5]).runOnJS,
          lerpScrollVarWidthThumbnails: callback2,
          scrollTo: onSelect(selectedIndex[5]).scrollTo,
          ref: animatedRef,
          thumbnailSize: onSelect,
        };
        ...
        ee.__closure = {
          thumbnailsScrolling: mapped1,
          interpolate: onSelect(selectedIndex[5]).interpolate,
          viewerPos: diff,
        ...
        te.__closure = {
          ...
          withSpring: onSelect(selectedIndex[10]).withSpring,
        };
        ...
        const callback3 = closure_1_4.useCallback((width, index) => {
          ...
          obj = {
            thumbnailsScrolling: mapped1,
            THUMBNAIL_MIN_WIDTH: closure_1_8,
      ...
      useViewerProps() {
        ...
        memo = closure_1_4.useMemo(() => {
          ...
          obj = {
            viewerPos: closure_1_6,
            screenWidth: width,
            swipeSource: closure_1_9,
            resolveSelectedIndex: arr(selectedIndex[11]).resolveSelectedIndex,
            maxIndex: closure_2,
            selectedIndex: diff,
            runOnJS: arr(selectedIndex[5]).runOnJS,
            onSelectedIndexChange: closure_1_10,
          };
          fn3.__closure = obj;
