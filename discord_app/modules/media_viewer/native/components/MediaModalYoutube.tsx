...
export default noop.memo((visible) => {
  ...
  noop = undefined;
  let tmp4 = _slicedToArray(noop.useState(visible(8325).PlayerState.UNREADY), 2);
  ...
  if (null == youtubeVideoIdFromURI) {
    ...
    return ref(tmp7(8325), obj, youtubeVideoIdFromURI.videoId);
  }
});
