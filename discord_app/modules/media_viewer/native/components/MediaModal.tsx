...
import MediaModalTiktok from "MediaModalTiktok" /* 8445 */;
import MediaModalWebVideoFile from "MediaModalWebVideoFile" /* 8455 */;
  ...
  const callback3 = flag2.useCallback(() => {
    if (flag2) {
      ...
      if (null != selectedMediaSource) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(8483, dependencyMap.paths), "MediaShareActionSheet", obj2);
      }
    }
  }, items5);
