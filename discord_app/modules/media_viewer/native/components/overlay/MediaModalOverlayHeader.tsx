...
import MediaViewerOverlayButtonFavoriteGIFDefault from "MediaViewerOverlayButtonFavoriteGIF" /* 13096 */;
    ...
    if (!disableMediaOverlayButton) {
      const obj13 = {
        ...
        children(ref) {
              ...
              if (obj2.isAndroid()) {
                let tmp2Result = closure_1_6(isModalOpen(13097).MoreVerticalIcon, { size: "md", color: "interactive-text-active" });
              } else {
