// === Module 9243: AcceptRequestConfirmationModal ===
...
export default function AcceptRequestConfirmationModal(onConfirm) {
  ...
  const items = [callback(onConfirm(4251).Text, obj), ];
  ...
  items[1] = callback(onConfirm(4251).Text, obj1);
  obj[1] = items;
  obj[4] = callback2(View, obj);
  return callback(importDefault(4684), obj);
};