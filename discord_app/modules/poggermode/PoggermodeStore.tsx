...
function updateCombo(userId) {
  ...
  if (decayInterval == null) {
    decayInterval = new obj(4140).Interval();
  }
...
prototype["getComboScore"] = function getComboScore(arg0, arg1) {
  ...
  let num = 0;
  if (null != value) {
    num = require(7199) /* getComboShakeIntensity */.getComboScore(value);
    const obj = require(7199) /* getComboShakeIntensity */;
  }
  return num;
};
...
prototype["getUserComboShakeIntensity"] = function getUserComboShakeIntensity(id, throwTypeErrorResult, arg2, LEVEL_4) {
  ...
  let num = 0;
  if (null != userCombo) {
    num = require(7199) /* getComboShakeIntensity */.getComboShakeIntensity(userCombo, LEVEL_4) * arg2;
    const obj = require(7199) /* getComboShakeIntensity */;
  }
  return num;
};
          ...
          if (tmp.screenshakeEnabledLocations[constants.MENTION]) {
            if (null != mentions) {
              if (null != mentions.find((id) => id.id === id)) {
                if (null != value) {
                  let num2 = id(7199).getComboShakeIntensity(value, LEVEL_4.LEVEL_4);
                  if (num2 == null) {
                    num2 = 0.001;
                  }
                  let result = num2;
