...
export default function GuildActionSheetTabItems(guild) {
  ...
  obj6.icon = closure_12(guild(9568).BoostGemIcon, {
  ...
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = closure_12(tmp(8265).IconButton, obj8);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = closure_12(tmp(8265).IconButton, obj10);
  }
  items2[3] = canAccessSettings;
  obj4.children = items2;
  return closure_13(guild(5736).ButtonGroup, obj4);
}
