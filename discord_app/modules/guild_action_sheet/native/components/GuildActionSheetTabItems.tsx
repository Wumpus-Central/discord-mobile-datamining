...
export default function GuildActionSheetTabItems(guild) {
  ...
  obj1.icon = closure_12(guild(9445).BoostGemIcon, obj2);
  ...
  const items2 = [closure_12(guild(8150).IconButton, obj1), , , ];
  if (shouldRenderInviteResult) {
    ...
    obj3.icon = tmp3(10101);
    obj3.onPress = function onPress() {
      ActionSheetActionCreatorsDefault.hideActionSheet();
      closure_2();
    };
    shouldRenderInviteResult = closure_12(tmp(8150).IconButton, obj3);
  }
  ...
  obj4.icon = stateFromStores(8001);
  obj4.onPress = function onPress() {
    ActionSheetActionCreatorsDefault.hideActionSheet();
    NotificationSettingsModalActionCreatorsDefault.open(guild.id);
  };
  items2[2] = closure_12(guild(8150).IconButton, obj4);
  if (canAccessSettings) {
    ...
    canAccessSettings = closure_12(tmp(8150).IconButton, obj5);
  }
  items2[3] = canAccessSettings;
  obj.children = items2;
  return closure_13(guild(5483).ButtonGroup, obj);
};