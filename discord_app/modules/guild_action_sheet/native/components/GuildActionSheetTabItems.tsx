...
export default function GuildActionSheetTabItems(guild) {
  ...
  let obj3 = guild(9278);
  obj6.icon = closure_12(guild(8678).BoostGemIcon, {
  ...
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = closure_12(tmp(7363).IconButton, obj8);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = closure_12(tmp(7363).IconButton, obj10);
  }
  items2[3] = canAccessSettings;
  obj4.children = items2;
  return closure_13(guild(5745).ButtonGroup, obj4);
}
