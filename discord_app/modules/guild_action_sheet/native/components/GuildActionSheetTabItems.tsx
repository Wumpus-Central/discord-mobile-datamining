...
export default function GuildActionSheetTabItems(guild) {
  ...
  let obj3 = guild(9267);
  obj6.icon = closure_12(guild(8670).BoostGemIcon, {
  ...
  if (shouldRenderInviteResult) {
    ...
    shouldRenderInviteResult = closure_12(tmp(7358).IconButton, obj8);
  }
  ...
  if (canAccessSettings) {
    ...
    canAccessSettings = closure_12(tmp(7358).IconButton, obj10);
  }
  items2[3] = canAccessSettings;
  obj4.children = items2;
  return closure_13(guild(5740).ButtonGroup, obj4);
}
