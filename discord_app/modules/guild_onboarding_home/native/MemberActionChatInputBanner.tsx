...
import registerAssetDefault from "registerAsset" /* 11364 */;
import newMemberActionFromServer from "newMemberActionFromServer" /* 11853 */;
...
function ActionChannelInfo(action) {
  ...
  return closure_12(action(4376).Text, obj1);
}
  ...
  if (null != stateFromStores) {
    ...
    if (null != name) {
      ...
      if (null != tmp5Result1.getByName(tmp5Result2.convertSurrogateToName(name, false))) {
        ...
        obj3[2] = name;
        tmp2Result = tmp2(tmp3(4376).Text, obj3);
      }
      tmp5Result2 = tmp5(4038);
    }
  }
  return tmp2Result;
}
