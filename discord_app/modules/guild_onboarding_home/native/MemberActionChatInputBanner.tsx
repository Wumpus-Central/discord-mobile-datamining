...
function ChannelActionEmoji(emoji) {
  ...
  const obj = {
    ...
    children: closure_12(id(1177).Icon, { size: id(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef12056 }),
  };
  ...
  if (null == channelAction) {
    ...
    function renderAction() {
      ...
      if (null != channelAction) {
        ...
        if (completed) {
          const obj6 = { disableColor: true, size: native.Icon.Sizes.MEDIUM, source: _modDef12541 };
