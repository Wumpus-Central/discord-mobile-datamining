...
import _modDef12629 from "../../../../_runtime/metro/12629__.js";
...
function ActionChannelInfo(action) {
  ...
  return closure_12(action(4825).Text, obj4);
}
function ChannelActionEmoji(emoji) {
  ...
  const obj = {
    ...
    children: closure_12(id(1177).Icon, { size: id(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef12146 }),
  };
  ...
  const obj2 = { size: id(1177).Icon.Sizes.REFRESH_SMALL_16, source: _modDef12146 };
  ...
  if (null != stateFromStores) {
    ...
    if (null != name) {
      ...
      if (null != tmp5Result5.getByName(tmp5Result6.convertSurrogateToName(name, false))) {
        ...
        tmp2Result = closure_12(tmp3(4825).Text, obj6);
      }
...
function MemberActionChatInputBanner(channel) {
  ...
  G.__closure = {
    ...
    height: sharedValue,
    withDelay: channel(channelAction[23]).withDelay,
    completed,
    withTiming: channel(channelAction[24]).withTiming,
    DECELERATED_EASING: channel(channelAction[16]).DECELERATED_EASING,
  };
  ...
  if (null == channelAction) {
    ...
    function renderAction() {
      ...
      if (null != channelAction) {
        ...
        if (completed) {
          const obj6 = { disableColor: true, size: native.Icon.Sizes.MEDIUM, source: _modDef12632 };
        ...
        function renderNextAction() {
          ...
          if (null != nextMemberAction) {
            ...
            obj.onPress = function onPress() {
              return channel(channelAction[27]).transitionTo(
            ...
            const obj8 = { size: native.Icon.Sizes.REFRESH_SMALL_16, style: closure_1.icon, source: _modDef12629 };
...
const __initData = {
  code: "function MemberActionChatInputBannerTsx1(){const{useReducedMotion,height,withDelay,completed,withTiming,DECELERATED_EASING}=this.__closure;if(useReducedMotion){return{height:height.get()};}return{height:withDelay(completed?800:200,withTiming(height.get(),{duration:400,easing:DECELERATED_EASING}))};}",
};
const __initData2 = {
  code: "function MemberActionChatInputBannerTsx2(){const{useReducedMotion,nextHeight,withDelay,isViewAction,completed,withTiming,DECELERATED_EASING}=this.__closure;if(useReducedMotion){return{height:nextHeight.get()};}return{height:withDelay(!isViewAction&&completed?1200:0,withTiming(nextHeight.get(),{duration:400,easing:DECELERATED_EASING}))};}",
};
const memoResult = noop.memo((channel) => {
  channel = channel.channel;
  const canSeeOnboardingHome = channel(7555).useCanSeeOnboardingHome(channel.guild_id);
  const obj = channel(7555);
