...
export default function NewMemberActionsCompleted(arg0) {
  ...
  fn.__closure = {
    withDelay: sharedValue(4374).withDelay,
    withTiming: sharedValue(4639).withTiming,
  ...
  const effect1 = noop.useEffect(() => {
    const timerId = setTimeout(
      () => closure_1_1(4841).popWithKey(sharedValue(12428).NEW_MEMBER_ACTION_COMPLETE_MODAL_KEY),
      2500,
    );
  }, []);
