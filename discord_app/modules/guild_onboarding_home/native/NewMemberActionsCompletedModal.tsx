...
export default function NewMemberActionsCompleted(arg0) {
  ...
  obj = { withDelay: sharedValue(4341).withDelay, withTiming: sharedValue(4606).withTiming, barWidth: sharedValue };
  fn.__closure = obj;
  ...
  const effect1 = noop.useEffect(() => {
    const timerId = setTimeout(
      () => closure_1_1(4808).popWithKey(sharedValue(12355).NEW_MEMBER_ACTION_COMPLETE_MODAL_KEY),
      2500,
    );
  }, []);
  ...
  const items1 = [closure_5(sharedValue(4601).Text, obj1)];
