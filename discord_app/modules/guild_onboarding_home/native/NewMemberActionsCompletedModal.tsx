// === Module 17788: NewMemberActionsCompletedModal ===
...
export default function NewMemberActionsCompleted(arg0) {
  ...
  fn.__closure = { withDelay: sharedValue(4493).withDelay, withTiming: sharedValue(4758).withTiming, barWidth: sharedValue };
  fn.__workletHash = 7643178959760;
  fn.__initData = __initData;
  const animatedStyle = obj2.useAnimatedStyle(fn);
  const effect1 = noop.useEffect(() => {
    const timerId = setTimeout(() => closure_1_1(4960).popWithKey(sharedValue(12543).NEW_MEMBER_ACTION_COMPLETE_MODAL_KEY), 2500);
  }, []);
