...
export default function NewMemberActionsCompleted(arg0) {
  ...
  obj = { withDelay: sharedValue(4343).withDelay, withTiming: sharedValue(4607).withTiming, barWidth: sharedValue };
  fn.__closure = obj;
  ...
  const effect1 = noop.useEffect(() => {
    const timerId = setTimeout(
      () => closure_1_1(4809).popWithKey(sharedValue(12378).NEW_MEMBER_ACTION_COMPLETE_MODAL_KEY),
      2500,
    );
  }, []);
  ...
  const items1 = [closure_5(sharedValue(4602).Text, obj1)];
