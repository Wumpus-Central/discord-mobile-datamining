...
export default function NewMemberActionsCompleted(arg0) {
  ...
  fn.__closure = {
    withDelay: sharedValue(4458).withDelay,
    withTiming: sharedValue(4723).withTiming,
  ...
  const effect1 = noop.useEffect(() => {
    const timerId = setTimeout(
      () => closure_1_1(4925).popWithKey(sharedValue(12528).NEW_MEMBER_ACTION_COMPLETE_MODAL_KEY),
      2500,
    );
  }, []);
