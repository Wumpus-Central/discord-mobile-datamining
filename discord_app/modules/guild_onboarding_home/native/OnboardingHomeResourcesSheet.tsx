...
export default function OnboardingHomeResourcesSheet(guildId) {
  ...
  obj[0] = jsx(guildId(5687).ActionSheetRow.Group, { hasIcons: true, children: null });
  return jsx(guildId(5685).ActionSheet, { hasIcons: true, children: null });
};