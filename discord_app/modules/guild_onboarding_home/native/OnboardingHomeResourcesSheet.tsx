// === Module 15519: OnboardingHomeResourcesSheet ===
...
export default function OnboardingHomeResourcesSheet(guildId) {
  ...
  obj[0] = jsx(guildId(5619).ActionSheetRow.Group, { hasIcons: true, children: null });
  return jsx(guildId(5617).ActionSheet, { hasIcons: true, children: null });
};