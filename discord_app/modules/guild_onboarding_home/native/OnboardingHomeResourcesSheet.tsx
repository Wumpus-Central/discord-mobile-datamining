// === Module 16997: OnboardingHomeResourcesSheet ===
...
require = fn;
let closure_3 = fn(16995).ONBOARDING_HOME_RESOURCES_SHEET_KEY;
const jsx = fn(21).jsx;
let size = fn(2);
...
export default function OnboardingHomeResourcesSheet(guildId) {
  ...
  importDefault = guildId(4526).useToken(nativeDefault.modules.mobile.TABLE_ROW_ICON_SIZE);
  let obj = guildId(4526);
  let obj2 = { children: null };
  const arr = useResourceChannelsDefault(guildId);
  obj2.children = jsx(guildId(7532).ActionSheetRow.Group, {
    hasIcons: true,
  ...
  return jsx(guildId(7530).ActionSheet, { children: null });
};