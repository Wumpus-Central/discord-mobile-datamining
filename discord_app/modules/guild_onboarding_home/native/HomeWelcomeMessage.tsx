...
const createCacheKey = { marginHorizontal: 12, marginVertical: 16, borderRadius: ThemesDefault.radii.sm, padding: 2, display: "flex", flexDirection: "column" };
...
const result = require("obj132").fileFinishedImporting("modules/guild_onboarding_home/native/HomeWelcomeMessage.tsx");
...
export default function HomeWelcomeMessage(guildId) {
  ...
  const stateFromStores1 = obj1.useStateFromStores(items1, () => closure_1_7.getWelcomeMessage(guildId));
    ...
    if (null != stateFromStores) {
      if (null != stateFromStores2) {
        ...
        if (null != stateFromStores2.avatarDecoration) {
          ...
          items6[2] = callback(tmp7Result, obj3);
          ...
          const items7 = [callback(tmp2(tmp3[19]).Text, obj7), ];
          ...
          if (tmp16) {
            ...
            obj8[1] = tmp.icon;
            obj8[2] = tmp7(tmp3[21]);
            tmp17Result = callback(tmp2(tmp3[17]).Icon, obj8);
          }
          ...
          obj11[1] = items9;
          items8[1] = callback(tmp2(tmp3[19]).Text, obj11);
          obj5[1] = items8;
          obj4[4] = callback(View, obj5);
          items6[3] = callback(tmp7Result, obj4);
          obj1[1] = items6;
          obj[3] = callback(View, obj1);
          ...
          items10[1] = obj14;
          obj13[0] = items10;
          tmp17Result = callback(View, obj13);
        }
