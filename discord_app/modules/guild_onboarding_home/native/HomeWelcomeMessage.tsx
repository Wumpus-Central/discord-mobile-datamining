...
export default function HomeWelcomeMessage(guildId) {
  ...
  const stateFromStores1 = guildId(stateFromStores2[8]).useStateFromStores(items1, () =>
    ...
    if (null != stateFromStores) {
      if (null != stateFromStores2) {
        ...
        if (null != stateFromStores2.avatarDecoration) {
          ...
          items6[1] = closure_8(View, obj7);
          const obj8 = {
            style: tmp.avatar,
            user: stateFromStores2,
            size: tmp2(tmp3[17]).AvatarSizes.NORMAL,
            disableStatus: true,
          };
          items6[2] = closure_8(tmp7(tmp3[16]), obj8);
          const obj9 = {
          ...
          const items7 = [closure_8(tmp2(tmp3[19]).Text, obj12)];
          ...
          if (tmp16) {
            ...
            tmp17Result = closure_8(tmp2(tmp3[17]).Icon, obj13);
          }
          items7[1] = tmp17Result;
          obj11.children = items7;
          const items8 = [closure_9(View, obj11)];
          let username = name;
          if (name == null) {
          ...
          items8[1] = closure_8(tmp2(tmp3[19]).Text, obj16);
          obj10.children = items8;
          obj9.children = closure_9(View, obj10);
          items6[3] = closure_8(tmp7Result3, obj9);
          obj6.children = items6;
          obj5.children = closure_9(View, obj6);
          return closure_8(tmp18, obj5);
        } else {
