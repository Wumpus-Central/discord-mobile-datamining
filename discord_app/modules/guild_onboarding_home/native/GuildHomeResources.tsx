...
function ResourceChannelRow(channelId) {
  ...
  const forumPostMediaProperties = channelId(7323).useForumPostMediaProperties(firstResult, false);
  const obj5 = channelId(7323);
  let length;
  const firstMediaIsEmbed = channelId(7323).useFirstMediaIsEmbed(firstResult, false);
  ...
  if (null != stateFromStores) {
    if (stateFromStores1) {
      ...
      if (tmp19Result) {
        ...
        tmp19Result = closure_12(tmp2(4832).Text, obj10);
      ...
      if (!(null == description || 0 === description.length)) {
        ...
        tmp19Result4 = closure_12(tmp2(4832).Text, obj12);
        ...
        if (null != firstResult) {
          ...
          if (!blocked) {
            ...
            if (null != first) {
              ...
              obj17.embedLeftBorderColor = tmp2(7323).getEmbedColor(firstResult, flag);
              let id;
              if (firstResult != null) {
                id = firstResult.id;
              }
              ...
              tmp19Result6 = closure_12(tmp2(11491).ForumPostMediaThumbnail, obj17);
              const tmp2Result2 = tmp2(7323);
            }
          }
        }
      }
      ...
      return closure_13(tmp2(5435).PressableOpacity, obj7);
    }
  }
  return null;
}
...
export default function GuildHomeResources(guildId) {
  ...
  if (0 === arr.length) {
    ...
    items[2] = closure_12(guildId(5281).Button, obj5);
    obj2.children = items;
