...
import _modDef16733 from "../../../../_runtime/metro/16733__.js";
  ...
  if (null != stateFromStores) {
    if (stateFromStores1) {
      ...
      if (tmp19Result) {
        ...
        tmp19Result = closure_12(tmp2(4636).Text, obj10);
      ...
      if (!(null == description || 0 === description.length)) {
        ...
        tmp19Result4 = closure_12(tmp2(4636).Text, obj12);
        ...
        if (null != firstResult) {
          ...
          if (!blocked) {
            ...
            if (null != first) {
              ...
              tmp19Result6 = closure_12(tmp2(12160).ForumPostMediaThumbnail, obj17);
