// === Module 16001: ResourceChannelRow ===

// Module 16001 (ResourceChannelRow)
import ThemesDefault from "Themes" /* 712 */;
import useResourceChannelsDefault from "useResourceChannels" /* 15995 */;
...
function ResourceChannelRow(channelId) {
  ...
  if (null != stateFromStores) {
    if (stateFromStores1) {
      ...
      const items4 = [callback(tmp2(4440).Text, obj2), , ];
      ...
      if (!(null == description || 0 === description.length)) {
        ...
        obj5[5] = tmp10(4434).parse(description, true, { guildId: null, channelId: null });
        tmp19Result = tmp19(tmp2(4440).Text, obj5);
        const obj6 = { guildId: null, channelId: null };
        const tmp10Result1 = tmp10(4434);
      }
        ...
        if (null != firstResult) {
          ...
          if (!blocked) {
            ...
            if (null != first) {
              ...
              tmp19Result2 = tmp19(tmp2(11670).ForumPostMediaThumbnail, obj9);
            }
          }
        }
      }
      ...
      obj[2] = items5;
      return closure_13(tmp2(5015).PressableOpacity, obj);
    }
  }
  return null;
}
...
export default function GuildHomeResources(guildId) {
  ...
  if (0 === arr.length) {
    ...
    const items = [callback(guildId(4440).Text, obj), , ];
    ...
    items[2] = callback(guildId(4879).Button, obj2);
    obj[1] = items;
