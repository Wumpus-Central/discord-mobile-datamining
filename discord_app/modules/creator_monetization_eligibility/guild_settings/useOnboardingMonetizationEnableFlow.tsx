// === Module 18250: useOnboardingMonetizationEnableFlow ===
...
export default function useOnboardingMonetizationEnableFlow(features) {
  ...
  if (tmp28) {
    ...
    const obj5 = { requestCooldownDuration, creatorRevenuePolicyUrl: tmp9(2108).getArticleURL(constants2.CREATOR_POLICY) };
