...
export const useCanSeeCreatorMonetizationOnboardingV2Upsell = function useCanSeeCreatorMonetizationOnboardingV2Upsell(
  ...
  const guildRoleSubscriptionSettingsVisibility = _require(
    stateFromStores[5],
  ).useGuildRoleSubscriptionSettingsVisibility(stateFromStores);
...
export const canSeeCreatorMonetizationOnboardingV2Upsell = function canSeeCreatorMonetizationOnboardingV2Upsell(arg0) {
  ...
  if (null == guild) {
    ...
    if (null == currentUser) {
      ...
      let tmp5 =
        guildRoleSubscriptionSettingsVisibility === guild(7260).GuildRoleSubscriptionSettingsVisibility.VISIBLE;
