...
export default function useCreateCreatorMonetizationAcceptTermsRequest(arg0, arg1) {
  ...
  isExpeditedOnboardingGuild =
    require("CreatorMonetizationEligibilityExperimentUtils.tsx").useIsExpeditedOnboardingGuild(stateFromStores);
  obj = { canSubmitAcceptance: null, error: null, loading: null, submitAcceptTermsRequest: null };
  let obj2 = set;
  const items1 = [closure_9];
  const items2 = [stateFromStores];
  obj[0] = require("../../../discord_common/js/packages/flux/index.tsx").useStateFromStores(
    items1,
    () => {
