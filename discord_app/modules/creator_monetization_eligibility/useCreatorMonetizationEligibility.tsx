...
let closure_6 = fn(17476).CreatorMonetizationApplicationState;
const size = fn(2);
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            c6 = 1;
            const obj5 = {
              value: CreatorMonetizationEligibilityActionCreatorsAll.getCreatorMonetizationEligibility(closure_0),
              done: false,
            };
            return obj5;
          }
          ...
          if (2 === tmp8) {
            ...
            const tmp45 = new closure_0(4732)(closure_129_1);
            tmp4(tmp45);
            c4 = 0;
            closure_1(false);
            c6 = 3;
            ...
            closure_129_0 = value;
            const obj6 = {
              isEligibleForMonetization: closure_129_0.sufficient,
              hasSufficientMembers: closure_129_0.size,
              hasEnabled2FA: closure_129_0.mfa,
              meetsServerAgeRequirement: closure_129_0.age,
              meetsOwnerAgeRequirement: closure_129_0.owner_age,
              noRecentViolations: closure_129_0.safe_environment,
              weeklyCommunicators: closure_129_0.engagement_healthy,
              hasMemberRetention: closure_129_0.retention_healthy,
              notNSFW: null,
              canApply: null,
