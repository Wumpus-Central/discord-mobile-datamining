...
createCacheKey = {
  position: "absolute",
  top: ThemesDefault.space.PX_4,
  right: ThemesDefault.space.PX_4,
  zIndex: 1,
  alignItems: "center",
  justifyContent: "center",
  padding: ThemesDefault.space.PX_6,
...
export default function AddToWishlistItemCard(sku) {
  ...
  callback = wishlistAnalyticsContext.useCallback(() => {
    ...
    obj = {
      ...
      pointerEvents: "none",
      children: closure_1_8(sku(analyticsLocations[10]).HeartOutlineIcon, {
        size: "sm",
        color: wishlistId(analyticsLocations[7]).colors.ICON_OVERLAY_LIGHT,
      }),
    };
            ...
            if (arg0 === 1) {
              ...
              if (closure_1_6) {
                ...
                if (null != surface) {
                  ...
                  obj1[1] = v0;
                  ({
                    wishlistOwnerId: obj9[2],
                    surface: obj9[3],
                    positionInSection: obj9[4],
                    itemSource: obj9[5],
                  } = tmp28);
