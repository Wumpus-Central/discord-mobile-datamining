...
export default function WishlistItemCard(arg0) {
  ...
  require("../../slayer_storefront/experiments/SocialLayerStorefrontMobilePurchasingExperiment.tsx") /* apexExperiment */;
  ...
  if (SKUProductLines.COLLECTIBLES === productLine) {
    ...
    return jsx(require("CollectiblesWishlistItemCard.tsx"), { sku: null, isOwned: null, source: null, wishlistOwnerId: null });
  } else if (tmp5.PREMIUM === productLine) {
    obj = { sku: null, source: null };
    obj[0] = sku;
    obj[1] = source;
    const merged2 = Object.assign(merged);
    return jsx(require("PremiumWishlistItemCard.tsx"), { sku: null, source: null });
    ...
    if (tmp4) {
      ...
      tmp6 = jsx(require("SocialLayerStorefrontWishlistItemCard.tsx"), { sku: null, isOwned: null, source: null, wishlistOwnerId: null });
      const tmp9 = require("SocialLayerStorefrontWishlistItemCard.tsx");
    }
    return tmp6;
  } else {
    return null;
