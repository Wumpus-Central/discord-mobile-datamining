// === Module 9129: WishlistItemCardBase ===
...
import useWishlistHooks from "useWishlistHooks" /* 9132 */;
...
function SourceIcon(toastText) {
  ...
  const obj = {
    ...
    children: closure_5(toastText(9130).HeartIcon, { color: nativeDefault.colors.INTERACTIVE_ICON_DEFAULT, size: "md" })
  };
...
export default function WishlistItemCardBase(username) {
  ...
  if (tmp14Result3) {
    ...
    const obj10 = { color: nativeDefault.colors.CONTROL_OVERLAY_SECONDARY_TEXT_DEFAULT, size: "custom", style: { width: 18, height: 18 } };
  ...
  if (tmp14Result4) {
    ...
    tmp14Result4 = hasOwnProperty(SourceIcon, obj11);
  }
