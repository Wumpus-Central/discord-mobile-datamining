...
const prototype = function BaseWishlistItemRecord(arg0) {
  ...
  ({
    sku_id: tmp.skuId,
    sku_product_line: tmp.skuProductLine,
    sku_name: tmp.skuName,
...
prototype["fromServer"] = function fromServer(sku) {
  ...
  if (typeof prototype === "function") {
    ...
    ({
      sku_id: tmp10.skuId,
      sku_product_line: tmp10.skuProductLine,
      sku_name: tmp10.skuName,
      is_owned: tmp10.isOwned,
      gifter_user_id: tmp10.gifterUserId,
      sku: tmp10.sku,
      added_at: tmp10.addedAt,
    } = obj);
    return tmp10;
  } else {
