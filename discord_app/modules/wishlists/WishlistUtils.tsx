...
require = fn;
let closure_4 = fn(9140).isCollectiblesWishlistItemRecord;
let closure_5 = fn(9141).isPremiumWishlistItemRecord;
const isSKUWishlistItemRecord = fn(9142).isSKUWishlistItemRecord;
