...
require = fn;
let closure_4 = fn(9136).isCollectiblesWishlistItemRecord;
let closure_5 = fn(9137).isPremiumWishlistItemRecord;
const isSKUWishlistItemRecord = fn(9138).isSKUWishlistItemRecord;
