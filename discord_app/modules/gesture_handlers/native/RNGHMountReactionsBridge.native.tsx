...
export const installRNGHMountReactionsBridge = function installRNGHMountReactionsBridge() {
  if (!c3) {
    const RNGHMountReactionsEffectExperiment = require("RNGHMountReactionsEffectExperiment.tsx") /* RNGHMountReactionsEffectExperiment */.RNGHMountReactionsEffectExperiment;
