...
import _modDef2235 from "../MobileGoLiveActionSheet.messages.js";
...
export default noop.memo(function MobileGoLiveActionSheet() {
  ...
  const goLiveUpsellVariant = guildPremiumTier(callback[21]).useConfig({
  ...
  if (tmp11) {
    ...
    const obj11 = {
      ...
      children: closure_18.map((value) => {
        ...
        if (null != maxSettingsForPreset) {
          ...
          str2 = intl2.formatToPlainString(_modDef2235.ibH7vy, maxSettingsForPreset);
        }
        ...
        if (null != maxSettingsForPreset1) {
          ...
          formatToPlainStringResult = intl4.formatToPlainString(_modDef2235.fN0UQY, maxSettingsForPreset1);
        }
        ...
        if (null != maxSettingsForPreset2) {
          ...
          str = intl6.formatToPlainString(_modDef2235.q4gYBi, maxSettingsForPreset2);
        }
        obj8.subLabel = str;
    ...
    if (tmp18Result) {
      ...
      obj12.children = closure_14(tmp7(tmp2[44]), obj13);
    ...
    if (tmp18Result2) {
      ...
      obj14.children = closure_14(tmp7(tmp2[46]), obj15);
    ...
    obj23.children = closure_15(tmp(tmp2[38]).SafeAreaPaddingView, obj7);
