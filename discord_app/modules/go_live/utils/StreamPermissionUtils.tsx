...
export const useCanWatchStream = function useCanWatchStream(stateFromStores) {
  ...
  return require("../../../../discord_common/js/packages/flux/index.tsx").useStateFromStoresArray(items, () => canWatchStream(closure_0, closure_1_8, closure_1_6, closure_1_7, closure_1_3));
};
