...
function ConversationListItemBase(conversation) {
  ...
  stateFromStores = obj1.useStateFromStores(items, () => ConversationsStore.getHydratedMessages(conversation.channelId, conversation.id), items1);
  ...
  obj2.children = intl.formatToPlainString(conversation(stateFromStores[15]).t.poZZGL, { count: conversation.messageCount });
...
const createStyles = { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: nativeDefault.space.PX_8, paddingBottom: nativeDefault.space.PX_8 };
