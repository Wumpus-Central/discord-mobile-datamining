...
export default function ConversationPreviewMessage(message) {
  ...
  const stateFromStores1 = message(setting[9]).useStateFromStores(
    items1,
  ...
  if ("username" === stateFromStores) {
    ...
    const isRoleStyleAndRoleColorsEligibleForERC = tmp2Result2.useIsRoleStyleAndRoleColorsEligibleForERC(
      guildId,
      message.author.id,
      stateFromStores,
