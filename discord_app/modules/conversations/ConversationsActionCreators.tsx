...
import ConversationExperiments from "ConversationExperiments.tsx";
      ...
      try {
        ...
        if (0 === c7) {
          ...
          if (1 === tmp7) {
            if (arg0 === 1) {
              ...
              if (obj15.isTopicalNavEnabled(closure_132_1, "fetch_channel_conversations")) {
                ...
                if (!closure_133_4.isListFetchPending(closure_132_0, closure_132_8)) {
                  ...
                  obj2.isJump = isJump;
                  obj4.dispatch(obj2);
                  const obj3 = { limit: closure_132_4 };
                  closure_132_9 = obj3;
                  ...
                  const request = {
                    url: closure_133_7.CHANNEL_CONVERSATIONS(closure_132_0),
                    query: closure_132_9,
                    oldFormErrors: true,
            ...
            const obj5 = { type: "CONVERSATIONS_FETCH_FAILURE", channelId: closure_132_0, requestKey: closure_132_8 };
            obj2.dispatch(obj5);
            if (closure_132_6) {
              const _Error = Error;
...
let closure_10 = async function _fetchConversationMessages() {
  closure_1 = arg1;
  closure_3 = arg3;
  c9 = 0;
  c10 = 0;
        ...
        if (0 === c9) {
          ...
          if (1 === tmp7) {
            ...
            obj4 = {
              ...
              channelId: closure_133_0,
              conversationId: closure_133_1,
              full: closure_133_2,
            };
            obj1.dispatch(obj4);
          } else if (arg0 === 1) {
            ...
            const obj5 = {
              ...
              channelId: closure_133_0,
              conversationId: closure_133_1,
              messages: closure_133_3.body.messages,
              messageReferences: closure_133_3.body.reference_messages,
              fullyHydrated: closure_133_2,
            };
