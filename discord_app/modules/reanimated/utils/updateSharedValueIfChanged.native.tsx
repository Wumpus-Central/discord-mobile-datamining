...
import _mod4187 from "../ReanimatedRexport.tsx";
...
let obj = { runOnUI: _mod4187.runOnUI, updateSharedValueIfChanged: "Array" };
fn.__closure = obj;
...
fn2 = function u(get) {
  if (globalThis._WORKLET) {
    ...
    fn2(4187).runOnUI(fn2)(get, arg1);
    const obj = fn2(4187);
  }
};
obj = { runOnUI: _mod4187.runOnUI, updateSharedValueArrayIfChanged: "Array" };
fn2.__closure = obj;
...
fn2.__closure = { runOnUI: _mod4187.runOnUI };
...
const obj1 = { runOnUI: _mod4187.runOnUI };
