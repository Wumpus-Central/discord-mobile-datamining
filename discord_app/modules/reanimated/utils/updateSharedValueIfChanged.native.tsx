...
let obj = { runOnUI: require("module_4083").runOnUI, updateSharedValueIfChanged: "Array" };
fn.__closure = obj;
...
obj = { runOnUI: require("module_4083").runOnUI, updateSharedValueArrayIfChanged: "Array" };
fn2.__closure = obj;
