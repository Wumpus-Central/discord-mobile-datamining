...
let obj = { runOnUI: _mod4115.runOnUI, updateSharedValueIfChanged: "a" };
fn.__closure = obj;
...
obj = { runOnUI: _mod4115.runOnUI, updateSharedValueArrayIfChanged: "a" };
fn2.__closure = obj;
