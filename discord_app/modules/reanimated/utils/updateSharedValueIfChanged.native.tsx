...
import _mod4120 from "../ReanimatedRexport.tsx";
...
let obj = { runOnUI: _mod4120.runOnUI, updateSharedValueIfChanged: "a" };
fn.__closure = obj;
...
fn2 = function u(get) {
  if (globalThis._WORKLET) {
    ...
    fn2(4120).runOnUI(fn2)(get, arg1);
    const obj = fn2(4120);
  }
};
obj = { runOnUI: _mod4120.runOnUI, updateSharedValueArrayIfChanged: "a" };
fn2.__closure = obj;
...
fn2.__closure = { runOnUI: _mod4120.runOnUI };
...
const obj1 = { runOnUI: _mod4120.runOnUI };
