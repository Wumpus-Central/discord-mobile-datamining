...
let obj = { runOnUI: require("module_4145").runOnUI, updateSharedValueIfChanged: "r" };
fn.__closure = obj;
...
obj = { runOnUI: require("module_4145").runOnUI };
fn.__closure = obj;
...
fn2 = function u(get) {
  if (globalThis._WORKLET) {
    ...
    fn2(4145).runOnUI(fn2)(get, arg1);
    const obj = fn2(4145);
  }
};
obj = { runOnUI: require("module_4145").runOnUI, updateSharedValueArrayIfChanged: "r" };
fn2.__closure = obj;
...
fn2.__closure = { runOnUI: require("module_4145").runOnUI };
...
const obj1 = { runOnUI: require("module_4145").runOnUI };
