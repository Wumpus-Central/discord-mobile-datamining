...
let obj = { runOnUI: require("module_4116").runOnUI, updateSharedValueIfChanged: "Array" };
fn.__closure = obj;
...
obj = { runOnUI: require("module_4116").runOnUI };
fn.__closure = obj;
...
fn2 = function u(get) {
  if (globalThis._WORKLET) {
    ...
    fn2(4116).runOnUI(fn2)(get, arg1);
    const obj = fn2(4116);
  }
};
obj = { runOnUI: require("module_4116").runOnUI, updateSharedValueArrayIfChanged: "Array" };
fn2.__closure = obj;
...
fn2.__closure = { runOnUI: require("module_4116").runOnUI };
...
const obj1 = { runOnUI: require("module_4116").runOnUI };
