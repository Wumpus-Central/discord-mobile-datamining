// === Module 7838: StageChannelActionCreators ===
...
import StageInstanceActionCreators from "StageInstanceActionCreators" /* 7846 */;
...
const useStageSpeakingForCurrentUser = obj(5729);
const StageChannelUtils = obj(7840);
require = fn;
