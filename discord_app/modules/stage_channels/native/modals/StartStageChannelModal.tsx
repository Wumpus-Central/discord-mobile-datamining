// === Module 9257: StartStageChannelModal ===
...
export default noop.forwardRef((channel, arg1) => {
      ...
      try {
        ...
        if (0 === c4) {
            ...
            if ("" !== first1) {
              if (null != first2) {
                ...
                if (null != memo) {
                  c4 = 3;
                  c5 = 1;
                  const obj8 = { value: tmp66(7838).editStage(channel, first1, first2), done: false };
                  return obj8;
                } else {
                  obj5 = tmp66(7838);
                  c4 = 2;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp66;
            const aPIError = new closure_0(4731).APIError(closure_128_1);
            ...
            if (2 === tmp7) {
              if (arg0 === 1) {
                ...
                if (tmp8) {
                  tmp66(6632).hideHotspot(closure_0(6629).HotspotLocations.LIVE_STAGE_NOTIFICATION_BADGE);
                  const obj2 = tmp66(6632);
                }
              }
            } else if (arg0 === 1) {
              c5 = 3;
  ...
  const imperativeHandle = first2.useImperativeHandle(arg1, () => ({
    renderRightButton: function RightButton() {
      ...
      obj.source = require("module_6505");
      obj.onPress = onPress;
