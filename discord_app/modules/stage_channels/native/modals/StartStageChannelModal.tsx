...
const createStyles = { padding: 12, width: "100%", borderRadius: nativeDefault.radii.xs, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWEST, marginBottom: 16 };
...
let obj3 = { backgroundColor: nativeDefault.colors.BACKGROUND_BRAND, paddingHorizontal: 4, paddingVertical: 2, marginStart: 8, borderRadius: nativeDefault.radii.xs };
...
let obj4 = { marginTop: 16, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH, borderRadius: nativeDefault.radii.sm };
...
export default noop.forwardRef((channel, arg1) => {
            ...
            if ("" !== first1) {
              if (null != first2) {
                ...
                if (null != memo) {
                  c4 = 3;
                  c5 = 1;
                  let obj1 = { value: tmp66(8484).editStage(channel, first1, first2), done: false };
                  return obj1;
                } else {
                  const obj5 = tmp66(8484);
                  c4 = 2;
                  c5 = 1;
          ...
          if (1 === tmp7) {
            ...
            if (2 === tmp7) {
              if (arg0 === 1) {
                ...
                if (tmp8) {
                  obj1 = tmp66(7289);
                  obj1.hideHotspot(closure_0(7286).HotspotLocations.LIVE_STAGE_NOTIFICATION_BADGE);
                }
              }
            } else if (arg0 === 1) {
              c5 = 3;
  ...
  items5[6] = current(require("StageChannelAgeVerificationNotice"), { onConfirmPress, style: tmp.ageVerificationNotice, channelId: channel.id });
