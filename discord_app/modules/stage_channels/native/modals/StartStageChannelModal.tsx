...
export default noop.forwardRef((channel, arg1) => {
      ...
      try {
        ...
        if (0 === c4) {
            ...
            if ("" !== first1) {
              if (null != first2) {
                ...
                if (null != memo) {
                  c4 = 3;
                  c5 = 1;
                  const obj8 = { value: tmp66(8673).editStage(channel, first1, first2), done: false };
                  return obj8;
                } else {
                  obj5 = tmp66(8673);
                  c4 = 2;
          ...
          if (1 === tmp7) {
            dependencyMap = 0;
            closure_128_1 = tmp66;
            const aPIError = new closure_0(4657).APIError(closure_128_1);
  ...
  const imperativeHandle = first2.useImperativeHandle(arg1, () => ({
    renderRightButton: function RightButton() {
      ...
      obj.source = require("../../../../../_runtime/metro/07336__.js");
      obj.onPress = onPress;
