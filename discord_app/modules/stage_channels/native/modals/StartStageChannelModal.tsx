...
import _modDef7203 from "../../../../../_runtime/metro/07203__.js";
...
export default noop.forwardRef((channel, arg1) => {
            ...
            if ("" !== first1) {
              if (null != first2) {
                ...
                if (null != memo) {
                  c4 = 3;
                  c5 = 1;
                  const obj8 = { value: tmp66(8547).editStage(channel, first1, first2), done: false };
                  return obj8;
                } else {
                  obj5 = tmp66(8547);
                  c4 = 2;
  ...
  const imperativeHandle = first2.useImperativeHandle(arg1, () => ({
    renderRightButton: function RightButton() {
      ...
      obj.source = require("../../../../../_runtime/metro/07203__.js");
      obj.onPress = onPress;
