...
export default function StartStageChannelEventActionSheet(channel) {
          ...
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                ...
                c5 = 1;
                const obj2 = {
                  value: tmp33Result.startStage(channel, importAll, constants.GUILD_ONLY, false),
                  done: false,
                };
                return obj2;
              }
  ...
  obj6.children = closure_13(channel(5025).Button, {
    text: stringResult3,
    onPress: handleSave,
    disabled: "" === value,
    loading: tmp8,
  ...
  return closure_13(channel(7202).BottomSheet, {
    keyboardShouldPersistTaps: "always",
    children: closure_14(channel(7175).SafeAreaPaddingView, obj2),
  });
}
