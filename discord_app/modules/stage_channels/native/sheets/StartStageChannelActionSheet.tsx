...
export default function StartStageChannelEventActionSheet(channel) {
  ...
  items1[1] = closure_13(channel(4570).Text, obj);
  ...
  items1[2] = closure_13(channel(4570).Text, obj1);
  obj.children = items1;
  let stringResult2;
  ...
  items2[1] = closure_13(channel(6620).TextInput, obj3);
  ...
  if (null != obj2) {
    ...
    tmp15Result = closure_13(tmp2(4570).Text, obj5);
  }
  ...
  obj6.children = closure_13(channel(4989).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result) {
    ...
    tmp15Result = closure_13(tmp2(4570).Text, obj8);
  }
  const obj4 = {
    onConfirmPress() {
      return stateFromStores(_undefined[17]).hideActionSheet(closure_1_10);
  ...
  return closure_13(channel(7164).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7137).SafeAreaPaddingView, obj2) });
};