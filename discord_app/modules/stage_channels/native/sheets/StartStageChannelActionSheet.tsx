...
export default function StartStageChannelEventActionSheet(channel) {
  ...
  const shouldAgeVerifyToSpeakForCurrentUser = channel(5122).useShouldAgeVerifyToSpeakForCurrentUser(channel.id);
  ...
  obj2[2] = items2;
  return callback(channel(5377).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(5311).SafeAreaPaddingView, obj2) });
};