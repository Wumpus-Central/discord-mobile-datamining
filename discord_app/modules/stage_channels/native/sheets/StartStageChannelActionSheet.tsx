...
export default function StartStageChannelEventActionSheet(channel) {
  ...
  items1[1] = closure_13(channel(4601).Text, obj);
  ...
  items1[2] = closure_13(channel(4601).Text, obj1);
  obj.children = items1;
  let stringResult2;
  ...
  items2[1] = closure_13(channel(6656).TextInput, obj3);
  ...
  if (null != obj2) {
    ...
    tmp15Result = closure_13(tmp2(4601).Text, obj5);
  }
  ...
  obj6.children = closure_13(channel(5025).Button, { text: stringResult3, onPress: handleSave, disabled: "" === value, loading: tmp8, accessibilityHint: stringResult2 });
  ...
  if (tmp15Result) {
    ...
    tmp15Result = closure_13(tmp2(4601).Text, obj8);
  }
  const obj4 = {
    onConfirmPress() {
      return stateFromStores(_undefined[17]).hideActionSheet(closure_1_10);
  ...
  return closure_13(channel(7202).BottomSheet, { keyboardShouldPersistTaps: "always", children: closure_14(channel(7175).SafeAreaPaddingView, obj2) });
};