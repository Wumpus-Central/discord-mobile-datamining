...
export default function StartStageChannelEventActionSheet(channel) {
          ...
          if (noop === 1) {
            ...
            if ("" !== importAll.trim()) {
              ...
              if (null != stateFromStores) {
                c4 = 3;
                c5 = 1;
                const obj6 = { value: tmp45(8547).editStage(channel, importAll, constants.GUILD_ONLY), done: false };
                return obj6;
              } else {
                const tmp33Result2 = tmp45(8547);
                c4 = 2;
                c5 = 1;
                const obj7 = {
  ...
  if (null != obj3) {
    ...
    tmp15Result = closure_13(tmp2(4636).Text, obj10);
  }
  ...
  obj11.children = closure_13(channel(5062).Button, {
    text: stringResult3,
    onPress: handleSave,
    disabled: "" === value,
    loading: tmp8,
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = closure_13(tmp2(4636).Text, obj13);
  }
  const obj12 = {
    text: stringResult3,
    onPress: handleSave,
  ...
  return closure_13(channel(7264).BottomSheet, {
    keyboardShouldPersistTaps: "always",
    children: closure_14(channel(7237).SafeAreaPaddingView, obj7),
  });
}
