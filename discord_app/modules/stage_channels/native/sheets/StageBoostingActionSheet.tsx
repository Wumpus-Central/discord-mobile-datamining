...
export default function StageBoostingActionSheet(channel) {
  ...
  if (stateFromStores2) {
    ...
    maybeApplyNoTextColorForLightCustomTheme = tmp(5148).useStageParticipantsCount(channel.id, tmp(5142).StageChannelParticipantNamedIndex.AUDIENCE);
    stateFromStores2(4730)(() => {
    ...
    if (tmp9) {
      ...
      tmp23Result = tmp23(tmp(4714).Button, obj3);
    }
