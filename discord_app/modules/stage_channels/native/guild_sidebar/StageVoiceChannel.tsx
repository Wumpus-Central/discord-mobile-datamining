...
import VoiceUsersDefault from "VoiceUsers" /* 16231 */;
import ChannelInfoDefault from "ChannelInfo" /* 16337 */;
...
export default noop.memo((channel) => {
  ...
  if (null != channel.userLimit) {
    ...
    obj3.channelInfo = jsx(ChannelInfoDefault, { channel, isChannelSelected: selected, isChannelCollapsed: collapsed, enableConnectedUserLimit: null, voiceStates: null });
    ...
    if (tmp12Result) {
      ...
      obj6.children = jsx(VoiceUsersDefault, { channel, collapsed, voiceStates: arr3, audienceCount: stageParticipantsCount });
