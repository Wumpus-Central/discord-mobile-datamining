...
const createCacheKey = { minHeight: 56, minWidth: 56, alignItems: "center", justifyContent: "center", borderRadius: 28, backgroundColor: require("result").ACTION_BAR_BUTTON_BACKGROUND };
...
const result = require("obj132").fileFinishedImporting("modules/stage_channels/native/components/LabeledActionBarButton.tsx");
...
export const LabeledActionButton = function LabeledActionButton(children) {
  ...
  let obj = { accessibilityRole: "button", disabled, style: tmp3.pressable };
  ...
  if (tmp4Result) {
    ...
    obj4[0] = source;
    obj4[1] = imageStyle;
    tmp4Result = callback(closure_2, obj4);
  }
  ...
  if (null != label) {
    ...
    obj5[1] = items4;
    obj5[2] = label;
    tmp4Result = callback(Button.LegacyText, obj5);
  }
  items3[1] = tmp4Result;
  ...
  if (tmp4Result1) {
    ...
    obj6[0] = source;
    obj6[1] = imageStyle;
    tmp4Result1 = callback(closure_2, obj6);
  }
  items3[2] = tmp4Result1;
  obj3[1] = items3;
  const items5 = [callback2(closure_3, obj3), children.children];
  obj1[1] = items5;
