...
import _modDef8538 from "../../../../../_runtime/metro/08538__.js";
...
export const MusicMuteButton = function MusicMuteButton(arg0) {
  ...
  if (!obj2.useShowStageMusicMuteButton(channel.id)) {
    ...
    const obj3 = {
      ...
      source: importDefault(stateFromStores ? 10047 : 10048),
      IconComponent: null,
      imageStyle: null,
      onPress: null,
      isSmallSize: null,
...
export const RequestToSpeakListButton = function RequestToSpeakListButton(channel) {
  ...
  function handleOpenAudienceList() {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10055, dependencyMap.paths), closure_10, {
  ...
  const stageParticipantsCount = channel(5517).useStageParticipantsCount(
    channel.id,
    channel(5511).StageChannelParticipantNamedIndex.REQUESTED_TO_SPEAK_ONLY,
  );
...
export const ChatButton = function ChatButton(channel) {
  ...
  tmp7Result = closure_12(openChat(9640).NotifiedActionButton, obj6);
