...
import _modDef10272 from "../../../../../_runtime/metro/10272__.js";
import _modDef10273 from "../../../../../_runtime/metro/10273__.js";
import _modDef10274 from "../../../../../_runtime/metro/10274__.js";
...
class StageChannelCallHeader {
  constructor(arg0) {
    ...
    stageParticipantsCount = obj2.useStageParticipantsCount(
      channel.id,
      channel(closure_2[27]).StageChannelParticipantNamedIndex.AUDIENCE,
    );
    ...
    items3[1] = tmp13(tmp5(tmp3[29]).Text, {
...
export default noop.memo((onOpenRTCDebugOverlay) => {
  ...
  const items = [
    closure_1_12(HideStageChannelCallIcon, { channel, fullscreenStream }),
    closure_1_12(StageChannelCallHeader, { channel }),
    ,
    ,
    ,
    ,
  ...
  if (speaker) {
    ...
    speaker = closure_1_12(MusicMuteButton, obj2);
  }
  items[2] = speaker;
  if (fullscreenStream) {
    const obj3 = { channel };
    fullscreenStream = closure_1_12(ChannelCallHeaderButtons.GridButton, obj3);
  }
  ...
  items[6] = closure_1_12(StageSettingsButton, {
