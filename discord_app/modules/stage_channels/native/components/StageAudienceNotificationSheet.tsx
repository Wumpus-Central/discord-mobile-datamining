...
import _modDef8946 from "../../../../../_runtime/metro/08946__.js";
import _modDef8968 from "../../../../../_runtime/metro/08968__.js";
import _modDef8969 from "../../../../../_runtime/metro/08969__.js";
import _modDef8970 from "../../../../../_runtime/metro/08970__.js";
import _modDef8971 from "../../../../../_runtime/metro/08971__.js";
...
function BulletIcon(source) {
  const tmp = closure_9();
  const obj = {
    style: tmp.headerBulletIconContainer,
    children: React5(native.Icon, {
      source: source.source,
      size: native.Icon.Sizes.MEDIUM,
      style: tmp.headerBulletIconComponent,
    }),
  };
...
export default function StageAudienceNotificationSheet(channelId) {
  ...
  if (privacy_level === constants.PUBLIC) {
    ...
    obj16.label = closure_7(tmp2(4823).Text, obj18);
    tmp6Result = closure_7(tmp2(8947).FormRow, obj16);
  }
