...
export const useModeratorOverlayChannelState = function useModeratorOverlayChannelState(id) {
  const _require = id;
  dependencyMap = callback((dismissOverlay) => dismissOverlay.dismissOverlay, require("../../../../../_runtime/04076_isIterable.js").shallow);
  const items = [!callback((overlayDismissedChannelIds) => overlayDismissedChannelIds.overlayDismissedChannelIds, require("../../../../../_runtime/04076_isIterable.js").shallow).has(id), () => callback(closure_0)];
  return items;
};