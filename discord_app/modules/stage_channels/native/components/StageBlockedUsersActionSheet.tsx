...
export default function StageBlockedUsersActionSheet(channel) {
  ...
  obj2[2] = callback2(channel(5311).SafeAreaPaddingView, obj);
  ...
  const tmp4 = callback2(channel(5311).SafeAreaPaddingView, obj);
  ...
  const items3 = [callback(onAccept(7931), obj3), callback(View, { style: { height: tmp2[0] } })];
  obj2[3] = items3;
  return callback2(channel(5377).BottomSheet, obj2);
};