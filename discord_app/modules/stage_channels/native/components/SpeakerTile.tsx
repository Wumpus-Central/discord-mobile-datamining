    ...
    if (stateFromStores.type === ParticipantTypes.USER) {
      ...
      if (isScreenLandscape) {
        ...
        const obj9 = {
          ...
          speakingColor: tmp9,
          animate: true,
          size: tmp4(tmp3[18]).AvatarSizes.XLARGE,
          isStageCall: true,
          avatarStyle: null,
        };
        ...
        return closure_8(tmp4(tmp3[15]).PressableOpacity, obj3);
      }
    }
  }
  return null;
