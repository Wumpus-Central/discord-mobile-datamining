...
function ManageSelfSpeakerRow(channel) {
  ...
  const tmp8 =
    useAudienceRequestToSpeakStateDefault(stateFromStores, id) === channel(4869).RequestToSpeakStates.ON_STAGE;
  importDefault = tmp8;
...
export default function RequestToSpeakActionSheet(channelId) {
  ...
  const stageParticipantsCount = channelId(5601).useStageParticipantsCount(
    channelId,
    channelId(5595).StageChannelParticipantNamedIndex.ALL_REQUESTED_TO_SPEAK,
  );
