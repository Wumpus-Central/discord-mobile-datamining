// === Module 9854: GlobalStageChannelStatus ===
    ...
    if (null != channel) {
      if (null != guild) {
        ...
        if (tmp7) {
          ...
          const obj5 = { style: activeSpeakerIcon, size: tmp8(1177).Icon.Sizes.REFRESH_SMALL_16, source: tmp8(5325).getChannelIconWithGuild(channel, guild) };
