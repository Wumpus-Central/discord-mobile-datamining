...
export default function StageViewWithPrompts(arg0) {
  ...
  const items1 = [
    callback(StageSparkleInnerDefault, obj),
    callback(Text.Text, {
      style: tmp.title,
    ...
    callback(Text.Text, { style: tmp.body, variant: "text-sm/medium", color: "text-overlay-light", children: body }),
    callback(closure_4, { style: tmp.prompts, children }),
  ];
  obj[3] = items1;
