...
import _modDef7172 from "../../../../../_runtime/metro/07172__.js";
...
export default function StageSectionHeader(collapsed) {
  ...
  let obj = { withTiming: collapsed(4575).withTiming, collapsed };
  fn.__closure = obj;
  ...
  obj2.children = items;
  const items1 = [closure_5(collapsed(4570).Text, obj2), ,];
  ...
  const obj5 = {
    style: animatedStyle,
    children: closure_6(collapsed(1178).Icon, { source: _modDef7172, style: tmp.collapseIcon }),
  };
