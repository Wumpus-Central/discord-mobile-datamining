...
export default function StageSectionHeader(collapsed) {
  ...
  obj = { withTiming: collapsed(4303).withTiming, collapsed };
  fn.__closure = obj;
  ...
  const items1 = [callback(collapsed(4298).Text, { variant: "text-md/semibold", color: "text-overlay-light", accessibilityRole: "header", children: items }), , ];
