// === Module 10959: StageSectionHeader ===
...
export default function StageSectionHeader(collapsed) {
  ...
  obj = { withTiming: collapsed(4256).withTiming, collapsed };
  fn.__closure = obj;
  ...
  const items1 = [callback(collapsed(4251).Text, { variant: "text-md/semibold", color: "text-overlay-light", accessibilityRole: "header", children: items }), , ];
  ...
  obj5[0] = importDefault(5571);
  obj5[1] = tmp.collapseIcon;
  obj4[1] = closure_6(collapsed(1297).Icon, obj5);
  obj3[1] = closure_6(importDefault(4116).View, obj4);
