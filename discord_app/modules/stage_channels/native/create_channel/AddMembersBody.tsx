...
export default function AddMembersBody(pendingAdditions) {
  ...
  obj2.children = closure_16(pendingAdditions(9885), obj3);
  ...
  if (null != inputDesc) {
    ...
    obj4.children = closure_16(guild(4632).Text, obj5);
  ...
  if ("" !== str) {
    if (0 === items2.length) {
      if (0 === membersRows.length) {
        ...
        const obj9 = { Illustration: guild(9890).NoResultsAlt, style: null, bodyStyle: null, body: null };
  ...
  obj12.contentContainerStyle = { paddingHorizontal: pendingAdditions(576).space.PX_16, paddingBottom: pendingAdditions(576).space.PX_16 + pendingAdditions(7084)(obj).insets.bottom };
  ...
  const obj13 = { paddingHorizontal: pendingAdditions(576).space.PX_16, paddingBottom: pendingAdditions(576).space.PX_16 + pendingAdditions(7084)(obj).insets.bottom };
};