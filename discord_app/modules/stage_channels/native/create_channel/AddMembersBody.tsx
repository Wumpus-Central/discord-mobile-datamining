...
export default function AddMembersBody(pendingAdditions) {
  ...
  obj12.contentContainerStyle = { paddingHorizontal: pendingAdditions(576).space.PX_16, paddingBottom: pendingAdditions(576).space.PX_16 + pendingAdditions(6995)(obj).insets.bottom };
  ...
  const obj13 = { paddingHorizontal: pendingAdditions(576).space.PX_16, paddingBottom: pendingAdditions(576).space.PX_16 + pendingAdditions(6995)(obj).insets.bottom };
};