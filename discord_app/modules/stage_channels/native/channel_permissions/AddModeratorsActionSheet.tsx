...
export default function AddModeratorsActionSheet(channel) {
  ...
  if (null == stateFromStores) {
    ...
    if (channel.canSkip) {
      ...
      obj4.header = jsx(tmp4(7482).BottomSheetTitleHeader, obj2);
      ...
      obj5.children = jsx(tmp7(9936), { inActionSheet: true, channel, guild: stateFromStores, permission: tmp4(2052).MODERATE_STAGE_CHANNEL_PERMISSIONS, pendingAdditions, setPendingAdditions: tmp2[1] });
      obj4.children = <View style={tmp.container}>{null}</View>;
      return jsx(tmp4(7483).BottomSheet, { scrollable: true, header: null, startExpanded: true, children: null });
    }
