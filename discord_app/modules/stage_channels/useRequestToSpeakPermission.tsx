// === Module 10881: useRequestToSpeakPermission ===
...
export const useRequestToSpeakPermission = function useRequestToSpeakPermission(id) {
  ...
  const canEveryoneRoleResult = stateFromStores(4030).canEveryoneRole(Permissions.REQUEST_TO_SPEAK, stateFromStores);
  const obj2 = stateFromStores(4030);
