...
export default function StickerPickerListRow(stickers) {
  ...
  if (nativeRow === undefined) {
    nativeRow = stickers(1363).isAndroid();
    let obj = stickers(1363);
  }
  c12 = undefined;
  ...
  if (nativeRow) {
    ...
    try {
      ...
      return closure_8(isSectionNitroLocked(10531), obj7);
    } catch (tmp26) {
        ...
        let tmp8 = (function _loop() {
          ...
          if (undefined === stickers[c12]) {
            ...
            const obj3 = {
              sticker: tmp2,
              size,
              animated: stickers(4975).shouldAnimateSticker(closure_8, tmp2.id === id),
              opaque: isSendableStickerResult,
            };
            const items1 = [closure_8(isSectionNitroLocked(10304), obj3, c12)];
            let tmp17 = null;
            if (tmp11) {
