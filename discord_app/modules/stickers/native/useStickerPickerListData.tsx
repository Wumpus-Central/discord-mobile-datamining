...
require = fn;
let useStickerPickerStore = fn(10655).useStickerPickerStore;
...
let closure_10 = fn(10570).PREMIUM_UPSELL_SECTION_DIVIDER_HEIGHT + fn(10570).PREMIUM_UPSELL_SECTION_DIVIDER_MARGIN;
const size = fn(2);
