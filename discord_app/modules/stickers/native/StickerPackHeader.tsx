...
import { registerAsset } from "../../../../_runtime/09853_registerAsset.js";
import { registerAsset } from "../../../../_runtime/09854_registerAsset.js";
...
const memoResult = importAllResult.memo((withDescription) => {
  ...
  if (null != onPress) {
    ...
    obj10[1] = onPress;
    obj10[3] = tmp2Result;
    let tmp4Result = tmp4(tmp6(4797).PressableOpacity, obj10);
  } else {
