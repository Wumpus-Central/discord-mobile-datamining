...
import { registerAsset } from "../../../../_runtime/09972_registerAsset.js";
import { registerAsset } from "../../../../_runtime/09973_registerAsset.js";
...
const memoResult = importAllResult.memo((withDescription) => {
  ...
  if (null != onPress) {
    ...
    obj10[1] = onPress;
    obj10[3] = tmp2Result;
    let tmp4Result = tmp4(tmp6(4846).PressableOpacity, obj10);
  } else {
