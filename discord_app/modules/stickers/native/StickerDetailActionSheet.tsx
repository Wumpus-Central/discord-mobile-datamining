...
function UnavailableStickerDetail(arg0) {
  ...
  const callback = obj1.useCallback(() => {
    if (null != stickerAssetUrl) {
      ...
      obj.openLazy(asyncRequireImpl(10494, dependencyMap.paths), "StickerOptionsActionSheet", obj, "stack");
    }
  }, items1);
...
createStyles = { marginLeft: 0, marginTop: nativeDefault.space.PX_16, marginBottom: nativeDefault.space.PX_16, backgroundColor: nativeDefault.colors.BORDER_SUBTLE };
