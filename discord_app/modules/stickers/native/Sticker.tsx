...
import NativeLottieViewDefault from "NativeLottieView" /* 7908 */;
...
export default function Sticker(opaque) {
  ...
  } else if (sticker.format_type === tmp(5212).StickerFormat.APNG) {
    tmpResult = tmp(4852);
