...
let obj2 = {
  ...
  headerContainer: { flexDirection: "row", justifyContent: "space-between", marginBottom: 8 },
  informationHeader: { lineHeight: 20 },
  informationContentContainer: { flexDirection: "row" },
  informationContent: { lineHeight: 20 },
  informationContentDescription: { flex: 1, marginLeft: 5 },
};
      ...
      renderItem(children) {
        ...
        const items = [
          React4(Text_Text.Text, {
            style: closure_0.informationContent,
        ...
        const obj3 = {
          ...
          variant: "text-md/medium",
          color: "text-default",
          children: children.item.description,
        };
        const items1 = [,];
...
export const doesStickerPackHavePopoutInformation = function doesStickerPackHavePopoutInformation(stickerPack) {
  ...
  if (obj.isStickerPackAnimated(stickerPack)) {
    ...
    obj2.description = intl.string(util.t.W11rMa);
    items.push(obj2);
  }
