...
import registerAssetDefault from "../../../../../_runtime/10362_registerAsset.js";
import registerAssetDefault2 from "../../../../../_runtime/10363_registerAsset.js";
import registerAssetDefault3 from "../../../../../_runtime/10364_registerAsset.js";
...
export default function StickersPremiumUpsellAlert(arg0) {
  ...
  const tmp5 = analyticsLocations(8187)(PREMIUM_MONTH_TIER_2.PREMIUM_MONTH_TIER_2);
  let priceString;
  if (tmp5 != null) {
    priceString = tmp5.priceString;
  }
  analyticsLocations = tmp3(5921)().analyticsLocations;
  ...
  const tmp3Result = analyticsLocations(4915);
  obj[3] = callback(Button.Icon, { source: analyticsLocations(7732) });
  ...
  obj1 = { source: analyticsLocations(7732) };
  const items2 = [callback(closure_5, { source: analyticsLocations(10365), style: tmp.imageHeader }), , ];
  ...
  const obj3 = { source: analyticsLocations(10365), style: tmp.imageHeader };
