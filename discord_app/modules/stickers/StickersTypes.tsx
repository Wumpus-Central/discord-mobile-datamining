...
export const isAnimatedSticker = function isAnimatedSticker(arg0) {
  return arg0 !== require("../../../discord_common/js/packages/design/components/Stickers/StickerTypes.tsx") /* MetaStickerType */.StickerFormat.PNG;
};
export const isCustomSticker = function isCustomSticker(arg0) {
  return arg0 !== require("../../../discord_common/js/packages/design/components/Stickers/StickerTypes.tsx") /* MetaStickerType */.MetaStickerType.STANDARD;
};
