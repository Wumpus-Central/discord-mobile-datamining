...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const items2 = [closure_5(iconSize(4632).Text, obj1), closure_5(iconSize(6711).CircleErrorIcon, { size: "xs", color: "text-default" })];
  obj.children = items2;
  const items3 = [closure_6(View, obj), closure_5(iconSize(4632).Text, { variant: "text-sm/normal", color: "text-default", children: provisionalAccountExplanationText })];
  obj.children = items3;
  return closure_6(iconSize(5688).Card, obj);
};
export const UserProfileProvisionalAccountExplainerCard = function UserProfileProvisionalAccountExplainerCard(iconSize) {
  ...
  obj.titleIcon = closure_5(iconSize(6711).CircleErrorIcon, { size: "xs", color: "text-default" });
  obj.children = closure_5(iconSize(4632).Text, { variant: "text-md/normal", color: "text-default", children: provisionalAccountExplanationText });
