...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const provisionalAccountExplanationText = iconSize(12880).useProvisionalAccountExplanationText({
    userId,
  ...
  const items2 = [
    ...
    closure_5(iconSize(6847).CircleErrorIcon, { size: "xs", color: "text-default" }),
  ];
