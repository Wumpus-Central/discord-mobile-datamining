...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const items2 = [
    closure_5(iconSize(4556).Text, obj1),
    closure_5(iconSize(6610).CircleErrorIcon, { size: "xs", color: "text-default" }),
  ];
  obj.children = items2;
  const items3 = [
    closure_6(View, obj),
    closure_5(iconSize(4556).Text, {
...
export const UserProfileProvisionalAccountExplainerCard = function UserProfileProvisionalAccountExplainerCard(
  ...
  obj.children = closure_5(iconSize(4556).Text, {
