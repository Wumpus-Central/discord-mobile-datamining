...
export const ChatProvisionalAccountExplainerCard = function ChatProvisionalAccountExplainerCard(iconSize) {
  ...
  const provisionalAccountExplanationText = iconSize(12871).useProvisionalAccountExplanationText({
    userId,
  ...
  const items2 = [
    closure_5(iconSize(4718).Text, obj4),
    closure_5(iconSize(6803).CircleErrorIcon, { size: "xs", color: "text-default" }),
  ];
  obj3.children = items2;
  const items3 = [
    closure_6(View, obj3),
    closure_5(iconSize(4718).Text, {
...
export const UserProfileProvisionalAccountExplainerCard = function UserProfileProvisionalAccountExplainerCard(
  ...
  obj2.children = closure_5(iconSize(4718).Text, {
