...
function StoreGuildIcon(guildId) {
  ...
  obj = { guild: stateFromStores, size: guildId(5634).GuildIconSizes.XSMALL };
...
fn(4605);
let createStyles = { container: null, title: null, description: null, card: null, cardInfo: null, statusRow: null, guildSummary: null, chevron: null, buttonsContainer: null };
...
createStyles.card = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_SUBTLE, borderRadius: nativeDefault.radii.md, padding: nativeDefault.space.PX_16, marginBottom: nativeDefault.space.PX_24, flexDirection: "row", alignItems: "center", justifyContent: "space-between" };
let obj3 = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_SUBTLE, borderRadius: nativeDefault.radii.md, padding: nativeDefault.space.PX_16, marginBottom: nativeDefault.space.PX_24, flexDirection: "row", alignItems: "center", justifyContent: "space-between" };
createStyles.cardInfo = { flex: 1, marginRight: nativeDefault.space.PX_12 };
let obj4 = { flex: 1, marginRight: nativeDefault.space.PX_12 };
createStyles.statusRow = { flexDirection: "row", alignItems: "center", marginTop: nativeDefault.space.PX_4, paddingBottom: 2 };
...
export default function BaseUpsellActionSheet(toastContent) {
  ...
  const items1 = [closure_7(toastContent(4601).Text, obj), closure_7(toastContent(4601).Text, { style: tmp.description, variant: "text-md/medium", color: "text-default", children: subtitle }), closure_7(GuildCard, { guildIds: affectedGuildIds, direction, onPress: onCardPress }), ];
  ...
  items2[1] = closure_7(toastContent(5025).Button, obj3);
