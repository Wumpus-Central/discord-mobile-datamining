...
import SignPostIcon2 from "SignPostIcon" /* 13929 */;
  ...
  return {
    ...
    [closure_0(closure_2[43]).AST_KEY.CHANNEL]: {
      react(iconType, output, textColor) {
        ...
        obj = { themedColor: obj(576).colors.MENTION_FOREGROUND, source: obj(5109).getChannelMentionIcon(str), size: null, style: null };
        const fontScale = closure_1_4.getFontScale();
        if (fontScale < 1) {
