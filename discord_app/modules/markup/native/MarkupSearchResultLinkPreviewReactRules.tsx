...
export const createSearchResultLinkPreviewReactRules = function createSearchResultLinkPreviewReactRules() {
  let obj = require("MarkupMessagePreviewReactRules.tsx") /* defaultReactFn */;
  obj = { iconColor: "mobile-text-heading-primary", iconSize: "xs", channelIconSize: require("../../../design/void/native.tsx") /* Button */.IconSizes.SMALL_14, customEmojiSize: 16 };
