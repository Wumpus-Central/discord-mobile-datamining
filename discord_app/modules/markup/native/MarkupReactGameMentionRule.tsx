// === Module 13845: MarkupReactGameMentionRule ===
...
class MarkupGameMention {
  constructor(arg0) {
    ...
    if (null == gameMentionData) {
      ...
      if (!state.noStyleAndInteraction) {
        fn = () => {
          const obj = { gameId, gameProfileModalChecks: { shouldOpenGameProfile: true, gameId }, source: GameProfileAnalyticUtils.GameProfileSources.GameMention, sourceUserId: state.authorId };
...
createStyles = { backgroundColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.xs, paddingHorizontal: 2 };
