...
import t_mod from "../../../_runtime/metro/01929__.js";
...
obj.commandMention = {
  ...
  parse(arg0, arg1, returnMentionIds) {
    if (returnMentionIds.returnMentionIds) {
      ...
      obj2 = {
        type: "commandMention",
        channelId: returnMentionIds.channelId,
        commandId: arg0[2],
        commandName: arg0[1],
        commandKey: "" + arg0[2] + mapped.join(""),
        content: null,
      };
...
let apply = apply_mod;
const omitResult = apply.omit(importDefaultResult3Result, [
  "inlineCode",
  "codeBlock",
  "br",
  "blockQuote",
...
let apply = apply_mod;
const omitResult1 = apply.omit(importDefaultResult3Result, [
  "inlineCode",
  "codeBlock",
  "br",
  "blockQuote",
...
const omitResult2 = apply.omit(importDefaultResult3Result, [
  "codeBlock",
  "br",
  "mention",
  "channel",
...
let apply = apply_mod;
const omitResult5 = apply.omit(importDefaultResult3Result, [
  "codeBlock",
  "br",
  "attachmentLink",
  "mention",
...
export default {
  ...
  AUTO_MODERATION_SYSTEM_MESSAGE_RULES: combineMarkupRules(items2),
  NATIVE_SEARCH_RESULT_LINK_RULES: apply.omit(importDefaultResult3Result, ["codeBlock", "br", "inlineCode"]),
};
