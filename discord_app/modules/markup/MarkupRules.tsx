...
import validateContentTypesDefault from "MarkupLinkRule.tsx";
...
function hydrateUserMention(everyoneOrHere, channelId) {
  ...
  const obj = {
    ...
    viewingChannelId: channelId.viewingChannelId,
    guildId: null,
    parsedUserId: null,
    roleName: null,
    content: null,
...
let obj = {
  newline: importDefaultResult.defaultRules.newline,
  paragraph: importDefaultResult.defaultRules.paragraph,
  escape: null,
  blockQuote: null,
  link: null,
  autolink: null,
...
obj3.match = importDefaultResult.inlineRegex(
...
const obj18 = {
  order: importDefaultResult.defaultRules.u.order,
  requiredFirstCharacters: ["~"],
  match: null,
  parse: null,
};
...
const omitResult = importDefaultResult4.omit(importDefaultResult3Result, [
  "inlineCode",
  "codeBlock",
  "br",
  "blockQuote",
...
const omitResult1 = importDefaultResult4.omit(importDefaultResult3Result, [
  "inlineCode",
  "codeBlock",
  "br",
  "blockQuote",
...
const omitResult2 = importDefaultResult4.omit(importDefaultResult3Result, [
  "codeBlock",
  "br",
  "mention",
  "channel",
...
const omitResult5 = importDefaultResult4.omit(importDefaultResult3Result, [
  "codeBlock",
  "br",
  "attachmentLink",
  "mention",
          ...
          if (0 !== parseDepth.highlightWord.length) {
            ...
            if (-1 === index) {
              ...
              if (-1 === tmp7) {
                ...
                const items = [
                  arr,
                  parseDepth.highlightWord,
                  substr,
                  arr.substring(tmp7 + parseDepth.highlightWord.length),
                ];
                return items;
              }
            }
...
const obj23 = {
  RULES: importDefaultResult3Result,
  CHANNEL_TOPIC_RULES: omitResult,
  VOICE_CHANNEL_STATUS_RULES: omitResult1,
  EMBED_TITLE_RULES: omitResult2,
  INLINE_REPLY_RULES: omitResult3,
  GUILD_VERIFICATION_FORM_RULES: omitResult4,
  GUILD_EVENT_RULES: omitResult6,
  PROFILE_BIO_RULES: omitResult5,
  AUTO_MODERATION_SYSTEM_MESSAGE_RULES: importDefaultResult12(items2),
  NATIVE_SEARCH_RESULT_LINK_RULES: omitResult7,
};
