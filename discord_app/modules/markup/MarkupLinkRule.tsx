...
import errorDefault from "../../../_runtime/05087_error.js";
...
function isSuspiciousUrl(url) {
  if (obj.isSuspiciousCodedLink(url)) {
    ...
    if (null == value) {
      const sanitizeWhitespaceResult = UnicodeSanitizationUtils.sanitizeWhitespace(url);
      const obj3 = { whitespaceSanitized: sanitizeWhitespaceResult, fullySanitized: null };
      const tmpResult = UnicodeSanitizationUtils;
      obj3.fullySanitized = UnicodeSanitizationUtils.sanitizeUnicodeConfusables(sanitizeWhitespaceResult);
      const result = closure_4.set(url, obj3);
      value = obj3;
      const tmpResult2 = UnicodeSanitizationUtils;
    }
...
let items1 = [
  fn(5080).AST_KEY.TEXT,
  fn(5080).AST_KEY.UNDERLINE,
  fn(5080).AST_KEY.STRONG,
  fn(5080).AST_KEY.ITALICS,
  fn(5080).AST_KEY.STRIKETHROUGH,
  fn(5080).AST_KEY.INLINE_CODE,
  fn(5080).AST_KEY.SPOILER,
  fn(5080).AST_KEY.LINE_BREAK,
  fn(5080).AST_KEY.TIMESTAMP,
];
...
const items5 = [
  ...
  fn(5080).AST_KEY.LINE_BREAK,
  fn(5080).AST_KEY.TIMESTAMP,
  fn(5080).AST_KEY.EMOJI,
  fn(5080).AST_KEY.CUSTOM_EMOJI,
  fn(5080).AST_KEY.LIST,
  fn(5080).AST_KEY.HEADING,
  fn(5080).AST_KEY.BLOCK_QUOTE,
            ...
            if (null != tmp38) {
              if (null != validateContentTypes(rules(value4.fullySanitized, obj12), items1)) {
                ...
                if (0 === str4.trim().length) {
                  ...
                  const obj17 = {
                    content: _modDef4336.parserFor(pickResult)(value3.whitespaceSanitized, obj12),
                    target: tmp48.target,
