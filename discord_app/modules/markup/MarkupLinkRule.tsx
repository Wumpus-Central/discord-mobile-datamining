...
import errorDefault from "../../../_runtime/05054_error.js";
...
let items1 = [
  fn(5047).AST_KEY.TEXT,
  fn(5047).AST_KEY.UNDERLINE,
  fn(5047).AST_KEY.STRONG,
  fn(5047).AST_KEY.ITALICS,
  fn(5047).AST_KEY.STRIKETHROUGH,
  fn(5047).AST_KEY.INLINE_CODE,
  fn(5047).AST_KEY.SPOILER,
  fn(5047).AST_KEY.LINE_BREAK,
  fn(5047).AST_KEY.TIMESTAMP,
];
...
const items5 = [
  ...
  fn(5047).AST_KEY.LINE_BREAK,
  fn(5047).AST_KEY.TIMESTAMP,
  fn(5047).AST_KEY.EMOJI,
  fn(5047).AST_KEY.CUSTOM_EMOJI,
  fn(5047).AST_KEY.LIST,
  fn(5047).AST_KEY.HEADING,
  fn(5047).AST_KEY.BLOCK_QUOTE,
