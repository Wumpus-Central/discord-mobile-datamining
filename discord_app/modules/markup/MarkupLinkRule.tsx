...
import errorDefault from "../../../_runtime/05309_error.js";
...
let items1 = [
  fn(5302).AST_KEY.TEXT,
  fn(5302).AST_KEY.UNDERLINE,
  fn(5302).AST_KEY.STRONG,
  fn(5302).AST_KEY.ITALICS,
  fn(5302).AST_KEY.STRIKETHROUGH,
  fn(5302).AST_KEY.INLINE_CODE,
  fn(5302).AST_KEY.SPOILER,
  fn(5302).AST_KEY.LINE_BREAK,
  fn(5302).AST_KEY.TIMESTAMP,
];
...
const items5 = [
  ...
  fn(5302).AST_KEY.LINE_BREAK,
  fn(5302).AST_KEY.TIMESTAMP,
  fn(5302).AST_KEY.EMOJI,
  fn(5302).AST_KEY.CUSTOM_EMOJI,
  fn(5302).AST_KEY.LIST,
  fn(5302).AST_KEY.HEADING,
  fn(5302).AST_KEY.BLOCK_QUOTE,
            ...
            if (null != tmp41) {
              if (null != validateContentTypes(rules(value4.fullySanitized, obj12), items1)) {
                ...
                if (0 === str4.trim().length) {
                  ...
                  const obj17 = {
                    content: _modDef1930.parserFor(pickResult)(value3.whitespaceSanitized, obj12),
                    target: tmp51.target,
