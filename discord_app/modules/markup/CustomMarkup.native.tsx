...
function createNotifCenterV2MessagePreviewRules(closure_28, closure_28, roleStyle) {
  ...
  let obj = {};
  obj = {};
  const merged = Object.assign(parseLink.RULES[require(undefined, 4732) /* AST_KEY */.AST_KEY.MENTION]);
  obj.react = tmp[require(undefined, 4732) /* AST_KEY */.AST_KEY.MENTION].react;
  obj[AST_KEY.AST_KEY.MENTION] = obj;
  obj = {};
  const merged1 = Object.assign(parseLink.RULES[require(undefined, 4732) /* AST_KEY */.AST_KEY.CHANNEL_MENTION]);
  obj.react = tmp[require(undefined, 4732) /* AST_KEY */.AST_KEY.CHANNEL_MENTION].react;
  obj[AST_KEY.AST_KEY.CHANNEL_MENTION] = obj;
  const obj1 = {};
  const merged2 = Object.assign(parseLink.RULES[require(undefined, 4732) /* AST_KEY */.AST_KEY.ITALICS]);
