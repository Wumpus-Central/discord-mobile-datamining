...
function createRules(arg0) {
  ...
  obj[AST_KEY /* AST_KEY */.AST_KEY.BLOCK_QUOTE] = obj3;
  items[2] = obj;
...
function createNotifCenterV2MessagePreviewRules(closure_28, closure_28, roleStyle) {
  ...
  obj[AST_KEY /* AST_KEY */.AST_KEY.MENTION] = obj;
  obj = {};
  ...
  obj[AST_KEY /* AST_KEY */.AST_KEY.CHANNEL_MENTION] = obj;
  const obj1 = {};
  ...
  obj[AST_KEY /* AST_KEY */.AST_KEY.ITALICS] = obj1;
  items[1] = obj;
  return combineMarkupRules(items);
}
...
export const createWidgetMessageRules = function createWidgetMessageRules() {
  ...
  obj = {};
  const merged = Object.assign(parseLink.RULES[require(undefined, 4715) /* AST_KEY */.AST_KEY.MENTION]);
  obj.react = MarkupText /* MarkupText */.plainMentionRenderer;
  obj[AST_KEY /* AST_KEY */.AST_KEY.MENTION] = obj;
  obj = {};
  const merged1 = Object.assign(parseLink.RULES.spoiler);
  obj.react = MarkupText /* MarkupText */.plainSpoilerRenderer;
  obj[AST_KEY /* AST_KEY */.AST_KEY.SPOILER] = obj;
  items[1] = obj;
  return combineMarkupRules(items);
};
export const getWidgetMessageRules = function getWidgetMessageRules() {
  ...
  const obj1 = {};
  const merged1 = Object.assign(parseLink.RULES.spoiler);
  obj1.react = MarkupText /* MarkupText */.plainSpoilerRenderer;
  obj[AST_KEY /* AST_KEY */.AST_KEY.SPOILER] = obj1;
  items[1] = obj;
