...
import markup_ChannelUtils from "markup/ChannelUtils" /* 5059 */;
...
function handleUnknownChannel(guildId, channelId, messageId, guildIdFromChannelId, combined1) {
  ...
  let obj = { type: "channelMention", guildId, channelId, messageId, originalLink: combined1, inContent: null, content: null };
  let tmp2 = null;
  if (null != guild) {
    let id;
    if (guild != null) {
    ...
    if (channel.isMentionable) {
      ...
      if (null == guild) {
        if (channel.isDm) {
          ...
          const obj1 = { type: "text", content: obj19.truncateText(channel.name, 32) };
          ...
          const obj4 = { type: "link", content: null, target: null, title: "WireType" };
          const obj5 = { type: "text", content: combined1 };
          const items4 = [obj5];
          obj4.content = items4;
          obj4.target = combined1;
          obj6 = obj4;
        } else {
        ...
        const obj8 = { type: "guild", guildId: guild.id, content: StringUtils.truncateText(guild.name, 32), icon: null };
        ...
        const obj10 = { type: "text", content: StringUtils.truncateText(channel.name, 32) };
      ...
      const obj20 = { type: "text", content: "#" + channel.name };
      return obj20;
    }
  } else {
...
obj = {
  ...
  parse(arg0, arg1, channelId) {
    ...
    if (null == tmp3) {
      let obj = { type: "link", content: null, target: null, title: "WireType" };
