// === Module 17321: IntegrationsSettingsWebhooksOverview ===
...
import WebhooksActionCreatorsDefault from "WebhooksActionCreators" /* 17323 */;
...
import WebhooksStore from "WebhooksStore" /* 17322 */;
...
prototype["renderWebhooks"] = function renderWebhooks() {
  ...
  const items = [closure_18(webhookType(4753).Text, { variant: "text-sm/medium", color: "text-muted", children: helpText }), , ];
  ...
  items[1] = tmp4Result;
  if (0 === found.length) {
    const obj2 = { Illustration: webhookType(17326).WebhookEmpty, title: null };
    ...
    items[2] = closure_18(webhookType(5906).TableRowGroup, obj3);
    obj4.children = items;
...
WebhooksOverview.contextType = fn(4467).ThemeContext;
let closure_26 = [];
const size = fn(2);
