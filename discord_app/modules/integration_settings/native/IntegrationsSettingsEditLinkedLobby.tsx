...
export default function EditLinkedLobby(channel) {
  ...
  const analyticsLocations = numScreensToPop(navigation[8])(
      ...
      if (null != stateFromStores) {
        ...
        const obj2 = {
          ...
          usernameHook(children, arg1) {
            return callback1(
              channel(navigation[16]).Text,
              { onPress, variant: "text-sm/semibold", color: "text-strong", children },
              arg1,
            );
          },
          linkedAtDate: date,
  ...
  if (null != getOrFetchApplication) {
    ...
    if (tmp20Result) {
      ...
      tmp20Result = closure_8(closure_7, obj13);
    }
