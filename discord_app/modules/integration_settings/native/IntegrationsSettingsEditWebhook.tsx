...
prototype["render"] = function render() {
  ...
  const tmp2Result = closure_11(webhookId(4636).Text, {
  ...
  if (null != token) {
    ...
    obj9.children = closure_11(tmp3(5693).TableRow, obj10);
    tmp2Result4 = closure_11(tmp3(5775).TableRowGroup, obj9);
  ...
  obj.children = closure_12(webhookId(5060).Stack, obj2);
