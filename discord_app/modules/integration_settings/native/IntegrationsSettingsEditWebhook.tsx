...
import IconLabelBlockDefault from "../../../components_native/common/IconLabelBlock.tsx";
...
({
  Endpoints: closure_7,
  NON_USER_BOT_DISCRIMINATOR: closure_8,
  ...
  constructor() {
    ...
    applyArgumentsResult.handleSave = function handleSave() {
      ...
      if (navigation.state.hasChanges) {
        ...
        WebhooksActionCreatorsDefault.update(guildId, webhookId, obj)
          .then(() => {
            navigation.pop();
          })
          .catch((error) => {
    ...
    applyArgumentsResult.handleConfirmDeleteWebhook = function handleConfirmDeleteWebhook() {
      ...
      WebhooksActionCreatorsDefault.delete(guildId, webhookId)
        .then(() => {
          navigation.pop();
        })
        .catch(() => {
...
prototype["render"] = function render() {
  ...
  closure_11(webhookId(4602).Text, { variant: "text-sm/medium", color: "text-link", children: stringResult });
  ...
  items1[1] = closure_11(webhookId(6677).TextInput, obj2);
  ...
  obj3.children = closure_11(webhookId(5656).TableRow, obj4);
  items1[2] = closure_11(webhookId(5738).TableRowGroup, obj3);
  ...
  if (null != token) {
    ...
    obj6.children = closure_11(tmp3(5656).TableRow, obj7);
    tmp2Result1 = closure_11(tmp3(5738).TableRowGroup, obj6);
  ...
  obj8.children = closure_11(webhookId(5656).TableRow, obj9);
  items1[4] = closure_11(webhookId(5738).TableRowGroup, obj8);
  obj.children = items1;
  obj.children = closure_12(webhookId(5024).Stack, obj);
