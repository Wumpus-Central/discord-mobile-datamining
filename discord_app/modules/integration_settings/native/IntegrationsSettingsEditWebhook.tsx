  ...
  constructor() {
    ...
    applyArgumentsResult.handleSave = function handleSave() {
      if (navigation.state.hasChanges) {
        ...
        WebhooksActionCreatorsDefault.update(guildId, webhookId, obj2)
          .then(() => {
            navigation.pop();
          })
          .catch((error) => {
...
prototype["render"] = function render() {
  ...
  const tmp2Result = closure_11(webhookId(4823).Text, {
  ...
  if (null != token) {
    ...
    obj9.children = closure_11(tmp3(5908).TableRow, obj10);
    tmp2Result4 = closure_11(tmp3(5990).TableRowGroup, obj9);
  ...
  obj.children = closure_12(webhookId(5269).Stack, obj2);
...
export default function ConnectedEditWebhook(arg0) {
  ...
  const items = [
    closure_1_11(EditWebhook, { navigation: useNavigation.useNavigation() }),
