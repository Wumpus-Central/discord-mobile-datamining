...
export const useContentClassificationVisibility = function useContentClassificationVisibility(arg0, isPrivate) {
  ...
  if (null != arg0) {
    ...
    obj[0] = tmp(4788).ContentClassificationVariant.MINIMAL;
    obj[1] = arg0;
    const result = tmp(4788).contentClassificationToAgeRestriction(obj);
    if (result === tmp(4790).AgeRestrictionStatus.ADULT) {
      if (true !== tmp4) {
        let DISPLAY = obj.BLOCK_UNDERAGE;
      } else {
