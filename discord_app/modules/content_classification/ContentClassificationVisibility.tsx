// === Module 11581: ContentClassificationVisibility ===
...
export const useContentClassificationVisibility = function useContentClassificationVisibility(arg0, isPrivate) {
  ...
  if (null != arg0) {
    obj = { type: null, data: null };
    obj[0] = tmp(5006).ContentClassificationVariant.MINIMAL;
    obj[1] = arg0;
    const result = tmp(5006).contentClassificationToAgeRestriction(obj);
    if (result === tmp(5008).AgeRestrictionStatus.ADULT) {
      if (true !== tmp4) {
        let DISPLAY = obj.BLOCK_UNDERAGE;
      } else {
