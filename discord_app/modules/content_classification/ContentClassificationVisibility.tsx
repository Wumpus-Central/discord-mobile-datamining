// === Module 11509: ContentClassificationVisibility ===
...
export const useContentClassificationVisibility = function useContentClassificationVisibility(arg0, isPrivate) {
  ...
  if (null != arg0) {
    obj = { type: null, data: null };
    obj[0] = tmp(4940).ContentClassificationVariant.MINIMAL;
    obj[1] = arg0;
    const result = tmp(4940).contentClassificationToAgeRestriction(obj);
    if (result === tmp(4942).AgeRestrictionStatus.ADULT) {
      if (true !== tmp4) {
        let DISPLAY = obj.BLOCK_UNDERAGE;
      } else {
