...
import PlayIcon2 from "PlayIcon" /* 7714 */;
import PauseIcon from "PauseIcon" /* 7716 */;
...
function PiPControls(message) {
  ...
  const obj4 = { disabled: !visible, style: null, onPress: callback, accessible: true, accessibilityRole: "button", accessibilityLabel: stringResult, children: closure_15(message(5935).ArrowLargeLeftIcon, { size: "sm" }) };
  const items3 = [, ];
