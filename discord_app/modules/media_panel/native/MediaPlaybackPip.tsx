  ...
  if (null != message) {
    if (null != contentMessage) {
      if (null != activeMediaPlayerSource) {
        ...
        const tmp14 = closure_15(tmp2(4601).Text, obj);
        obj = {
        ...
        if (memo) {
          ...
          const items3 = [closure_15(tmp2(17319).Marquee, obj3)];
          const obj4 = {
            start: { x: 0, y: 0 },
            end: { x: 1, y: 0 },
          ...
          items3[1] = closure_15(tmp4(5037), obj4);
        ...
        if (tmp13Result) {
          ...
          tmp13Result = closure_15(tmp2(4601).Text, obj5);
        }
...
function PiPControls(message) {
  ...
  let obj = { withTiming: message(4606).withTiming, visible };
  fn.__closure = obj;
  ...
  const obj1 = {
    ...
    children: closure_15(message(5678).ArrowLargeLeftIcon, { size: "sm" }),
  };
  const items3 = [,];
  ...
  const obj2 = {
    ...
    children: closure_15(message(4558).XLargeIcon, { size: "sm" }),
  };
  const items4 = [,];
  ...
  obj.children = items2;
  return closure_16(visible(4341).View, obj);
}
