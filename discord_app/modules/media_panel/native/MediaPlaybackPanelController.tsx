...
const require = fn;
const MediaPlaybackPanelModes = fn(14912).MediaPlaybackPanelModes;
const ActivityPanelModes = fn(9396).ActivityPanelModes;
let MorphablePanelModes = fn(12616).MorphablePanelModes;
const jsx = fn(21).jsx;
let __initData = {
...
export default function MediaPlaybackPanelController(children) {
  ...
  const stateFromStores = sharedValue(sharedValue1[13]).useStateFromStores(
    items2,
    () => sharedValue5.getActivityPanelMode() === wrapperOffset.PIP,
  );
