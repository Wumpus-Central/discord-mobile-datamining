...
function getLatestActiveOutboundPromotionStartDate() {
  ...
  const values = Object.values(
    dependencyMap[require(undefined, 8489) /* CountryListMode */.PromotionTypes.THIRD_PARTY_OUTBOUND],
  );
...
Object.defineProperty(prototype, "outboundRecurringPromotions", {
  get: function outboundRecurringPromotions() {
    return Object.values(
      dependencyMap[require(undefined, 8489) /* CountryListMode */.PromotionTypes.THIRD_PARTY_OUTBOUND_RECURRING],
    );
  },
  set: undefined,
});
...
const promotionsStore = new PromotionsStore(dispatcherDefault, {
  ...
  OUTBOUND_PROMOTION_NOTICE_DISMISS: function handleDismissOutboundPromotionNotice() {
    if (
      0 ===
      Object.values(dependencyMap[require(undefined, 8489) /* CountryListMode */.PromotionTypes.THIRD_PARTY_OUTBOUND])
        .length
    ) {
      return false;
    } else {
