...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  obj3.properties = {
    component_type: helpArticleLinkProps(10871).MarketingComponentType.MARKETING_PAGE_BANNER,
  ...
  const formatStringWithCommonPremiumParams = helpArticleLinkProps(13515).useFormatStringWithCommonPremiumParams(
    bannerFields.body,
  );
  const tmp4Result = helpArticleLinkProps(13515);
  helpArticleLinkProps = helpArticleLinkProps(13515).getHelpArticleLinkProps(
  ...
  const items2 = [
    tmp12Result,
    closure_5(helpArticleLinkProps(4632).Text, {
  ...
  if (tmp12Result3) {
    ...
    tmp12Result3 = closure_5(tmp4(4632).Text, obj11);
  }
