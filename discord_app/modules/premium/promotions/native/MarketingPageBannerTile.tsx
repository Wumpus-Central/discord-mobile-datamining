...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  obj3.properties = {
    component_type: helpArticleLinkProps(10191).MarketingComponentType.MARKETING_PAGE_BANNER,
  ...
  const formatStringWithCommonPremiumParams = helpArticleLinkProps(12953).useFormatStringWithCommonPremiumParams(
    bannerFields.body,
  );
  const tmp4Result = helpArticleLinkProps(12953);
  helpArticleLinkProps = helpArticleLinkProps(12953).getHelpArticleLinkProps(
