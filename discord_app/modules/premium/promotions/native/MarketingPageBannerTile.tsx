...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  obj3.properties = {
    component_type: helpArticleLinkProps(10203).MarketingComponentType.MARKETING_PAGE_BANNER,
  ...
  const items2 = [
    tmp12Result,
    closure_5(helpArticleLinkProps(4832).Text, {
  ...
  if (tmp12Result3) {
    ...
    tmp12Result3 = closure_5(tmp4(4832).Text, obj11);
  }
