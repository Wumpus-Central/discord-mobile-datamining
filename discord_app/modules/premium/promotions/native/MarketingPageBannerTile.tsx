...
export default function MarketingPageBannerTile(bannerFields) {
  ...
  obj3.properties = {
    component_type: helpArticleLinkProps(10891).MarketingComponentType.MARKETING_PAGE_BANNER,
  ...
  const formatStringWithCommonPremiumParams = helpArticleLinkProps(13539).useFormatStringWithCommonPremiumParams(
    bannerFields.body,
  );
  const tmp4Result = helpArticleLinkProps(13539);
  helpArticleLinkProps = helpArticleLinkProps(13539).getHelpArticleLinkProps(
  ...
  if (tmp12Result) {
    ...
    tmp12Result = closure_5(closure_3, obj7);
  }
  const items2 = [
    tmp12Result,
    closure_5(helpArticleLinkProps(4636).Text, {
  ...
  if (tmp12Result3) {
    ...
    tmp12Result3 = closure_5(tmp4(4636).Text, obj11);
  }
  ...
  if (tmp12Result4) {
    ...
    obj12.children = closure_5(NitroUpsellButtonDefault, obj13);
    tmp12Result4 = closure_5(closure_4, obj12);
  }
