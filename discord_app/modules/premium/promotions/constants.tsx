...
export const PromotionTypes = {
  ...
  BOGO: 1,
  [1]: "BOGO",
  THIRD_PARTY_DIRECT_FULFILLMENT: 2,
  [2]: "THIRD_PARTY_DIRECT_FULFILLMENT",
  THIRD_PARTY_INBOUND: 3,
  [3]: "THIRD_PARTY_INBOUND",
  THIRD_PARTY_OUTBOUND: 4,
  [4]: "THIRD_PARTY_OUTBOUND",
  MARKETING_MOMENT: 5,
  [5]: "MARKETING_MOMENT",
  GIFT_PROMOTION: 6,
  [6]: "GIFT_PROMOTION",
  THIRD_PARTY_OUTBOUND_RECURRING: 7,
  [7]: "THIRD_PARTY_OUTBOUND_RECURRING",
};
