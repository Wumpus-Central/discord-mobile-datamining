...
export default function storeListingToGuildPowerup(arr, powerup_metadata) {
  ...
  if (null != category_type) {
    ...
    if (null != powerup_metadata) {
      let obj = { title: powerup_metadata.summary, skuId: powerup_metadata.sku.id, cost: powerup_metadata.boost_price, dependencies: null, animatedImageUrl: null, staticImageUrl: null, storeRemovalDate: null, deactivationCooldownPeriodDays: null };
