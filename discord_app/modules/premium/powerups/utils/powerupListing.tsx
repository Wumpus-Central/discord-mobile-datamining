    ...
    if (-1 !== findIndexResult2) {
      ...
      if (findIndexResult2 !== findIndexResult1 + 1) {
        ...
        items1.splice(
          ...
          0,
          _slicedToArray(items1.splice(findIndexResult2, 1), 1)[0],
        );
        tmp10 = items1;
      }
    }
...
let items = [
  fn(4453).GUILD_TAGS_BADGE_PACK_CREEPY_CRAWLIES_POWERUP_SKU_ID,
  fn(4453).GUILD_TAGS_BADGE_PACK_PETS_POWERUP_SKU_ID,
  fn(4453).GUILD_TAGS_BADGE_PACK_PLANT_POWERUP_SKU_ID,
  fn(4453).GUILD_TAGS_BADGE_PACK_FLEX_POWERUP_SKU_ID,
];
