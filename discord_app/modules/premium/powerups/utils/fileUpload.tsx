...
export const useShouldShowFileUploadRollback = function useShouldShowFileUploadRollback(guildId, location) {
  ...
  const stateFromStores = _require("../../../../../discord_common/js/packages/flux/index.tsx").useStateFromStores(items, () => outer1_3.getStateForGuild(closure_0));
  let tmp4;
  ...
  const tmp5 = require("../hooks/usePowerupActiveStatus.tsx")(guildId, tmp4);
  let tmp6 = _require("../experiments/FileUpload250MbPowerupExperiment.tsx").useFileUpload250MbPowerupRollbackEnabled(guildId, location) && null != tmp4 && null != tmp4.storeRemovalDate;
  if (tmp6) {
