// === Module 12058: useShouldShowFileUploadRollback ===
...
export const useShouldShowFileUploadRollback = function useShouldShowFileUploadRollback(guildId, location) {
  ...
  let tmp6 = _require(4307).useFileUpload250MbPowerupRollbackEnabled(guildId, location) && null != tmp4 && null != tmp4.storeRemovalDate;
  if (tmp6) {
