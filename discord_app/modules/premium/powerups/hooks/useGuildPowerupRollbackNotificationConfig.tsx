  ...
  if (tmpResult.useShouldShowGuildThemeRollback(guildId, useGuildPowerupNewPerkMarketingVersion)) {
    ...
    if (null != tmp4) {
      ...
      if (null != storeRemovalDate) {
        ...
        const obj2 = {
          dismissibleContent: tmp(2029).DismissibleContent.GUILD_THEME_POWERUP_ROLLBACK_NOTIFICATION,
          title: null,
          description: null,
        };
...
export const getGuildThemeRollbackNotificationConfig = function getGuildThemeRollbackNotificationConfig(
  storeRemovalDate,
) {
