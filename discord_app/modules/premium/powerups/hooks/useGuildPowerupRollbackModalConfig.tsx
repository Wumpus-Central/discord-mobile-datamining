      ...
      if (flag) {
        if (null != title) {
          if (null != storeRemovalDate) {
            ...
            const obj = {
              dismissibleContent: dismissible_content.DismissibleContent.FILE_UPLOAD_POWERUP_ROLLBACK_MODAL,
              header: null,
              bodies: null,
            ...
            obj.header = "" + title.title + " " + intl.formatToPlainString(_modDef2512["6e2ry1"], obj2);
