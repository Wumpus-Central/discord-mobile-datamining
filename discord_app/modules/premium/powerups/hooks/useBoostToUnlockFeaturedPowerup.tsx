...
let items = [obj, , , , , ,];
obj = { skuId: fn(4467).GUILD_POWERUP_LEVEL_2_SKU_ID, threshold: 2 };
items[1] = obj;
obj = { skuId: fn(4467).GUILD_POWERUP_LEVEL_3_SKU_ID, threshold: 2 };
items[2] = obj;
items[3] = { skuId: fn(4467).GUILD_POWERUP_TAG_SKU_ID, threshold: 1 };
const obj1 = { skuId: fn(4467).GUILD_POWERUP_TAG_SKU_ID, threshold: 1 };
items[4] = { skuId: fn(4467).GUILD_POWERUP_ROLE_COLOR_SKU_ID, threshold: 1 };
const obj2 = { skuId: fn(4467).GUILD_POWERUP_ROLE_COLOR_SKU_ID, threshold: 1 };
items[5] = { skuId: fn(4467).GUILD_TAGS_BADGE_PACK_FLEX_POWERUP_SKU_ID, threshold: 1 };
const obj3 = { skuId: fn(4467).GUILD_TAGS_BADGE_PACK_FLEX_POWERUP_SKU_ID, threshold: 1 };
