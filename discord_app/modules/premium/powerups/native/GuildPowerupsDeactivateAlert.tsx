// === Module 12019: GuildPowerupsDeactivateAlert ===
...
import useGuildPowerupOnDeactivateDefault from "useGuildPowerupOnDeactivate" /* 12020 */;
import useDeactivateWarningTextDefault from "useDeactivateWarningText" /* 12021 */;
...
export default function GuildPowerupsDeactivateAlert(arg0) {
  ...
  let obj = _require(12022);
  const logPowerupModalOpened = obj.useLogPowerupModalOpened(guildId, powerup, _require(12022).ModalType.DEACTIVATE);
  ...
  const tmp8 = View;
  obj[1] = callback(_require(7641).CircleErrorIcon, { color: ThemesDefault.colors.INTERACTIVE_ICON_DEFAULT, size: "custom", style: { width: 40, height: 40 } });
  ...
  if (tmp7Result) {
    ...
    obj4[3] = error;
    tmp7Result = tmp7(tmp5(4441).Text, obj4);
  }
  ...
  items[1] = callback(_require(4815).AlertActionButton, obj6, "deactivate");
  const obj7 = {
    onPress() {
  ...
  items[2] = callback(_require(4815).AlertActionButton, obj7, "cancel");
  obj5[0] = items;
  obj[3] = closure_5(_require(4815).AlertActions, obj5);
