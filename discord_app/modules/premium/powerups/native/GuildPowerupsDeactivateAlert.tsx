// === Module 11758: GuildPowerupsDeactivateAlert ===
...
import useGuildPowerupOnDeactivateDefault from "useGuildPowerupOnDeactivate" /* 11759 */;
import useDeactivateWarningTextDefault from "useDeactivateWarningText" /* 11760 */;
...
export default function GuildPowerupsDeactivateAlert(arg0) {
  ...
  let obj = _require(11761);
  const logPowerupModalOpened = obj.useLogPowerupModalOpened(guildId, powerup, _require(11761).ModalType.DEACTIVATE);
  ...
  const tmp8 = View;
  obj[1] = callback(_require(8113).CircleErrorIcon, { color: ThemesDefault.colors.INTERACTIVE_ICON_DEFAULT, size: "custom", style: { width: 40, height: 40 } });
  ...
  if (tmp7Result) {
    ...
    obj4[3] = error;
    tmp7Result = tmp7(tmp5(4739).Text, obj4);
  }
  ...
  items[1] = callback(_require(4667).AlertActionButton, obj6, "deactivate");
  const obj7 = {
    onPress() {
  ...
  items[2] = callback(_require(4667).AlertActionButton, obj7, "cancel");
  obj5[0] = items;
  obj[3] = closure_5(_require(4667).AlertActions, obj5);
