...
export default function GuildPowerupsDeactivateAlert(arg0) {
  ...
  const tmp8 = View;
  obj[1] = callback(_CircleErrorIcon.CircleErrorIcon, { color: ThemesDefault.colors.INTERACTIVE_ICON_DEFAULT, size: "custom", style: { width: 40, height: 40 } });
  ...
  if (tmp7Result) {
    ...
    obj4[3] = error;
    tmp7Result = tmp7(tmp5(4734).Text, obj4);
  }
