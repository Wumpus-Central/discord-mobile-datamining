...
import GuildPowerupsDisabledWarningDefault from "GuildPowerupsDisabledWarning" /* 12803 */;
...
function GuildPowerupsBottomSheetFooter(arg0) {
  ...
  if (tmp4) {
    ...
    if (tmp14) {
      ...
      const intl = util.intl;
      obj2.children = intl.string(_modDef2514["jo5++h"]);
    ...
    if (showConfigureButton) {
      ...
      obj4.text = intl2.string(_modDef2514.g5Ds69);
      obj4.onPress = tmp10;
