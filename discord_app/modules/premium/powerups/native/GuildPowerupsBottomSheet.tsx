...
import GuildPowerupsDisabledWarningDefault from "GuildPowerupsDisabledWarning" /* 12688 */;
...
function GuildPowerupsBottomSheetHeader(arg0) {
  ...
  if (powerup.type === constants.LEVEL) {
    ...
    let tmp15 = React6(GuildPowerupsBoostGemDefault, obj2);
    let tmp14 = React6;
    ...
    tmp14 = React6;
    tmp15 = React6(GuildPowerupsImageDefault, obj6);
  }
...
function GuildPowerupsBottomSheetBody(powerup) {
  ...
  if (constants.PERK === type) {
    ...
    if (tmp5Result) {
      ...
      const items1 = [React6(CircleInformationIcon.CircleInformationIcon, obj4), ];
...
function GuildPowerupsBottomSheetFooter(arg0) {
  ...
  if (tmp4) {
    ...
    if (tmp14) {
      ...
      const intl = util.intl;
      obj2.children = intl.string(_modDef2429["jo5++h"]);
    ...
    if (tmp21) {
      ...
      tmp21 = React6(GuildPowerupsDisabledWarningDefault, obj3);
    }
    items[1] = tmp21;
    if (showConfigureButton) {
      const obj4 = { variant: "primary", text: null, onPress: null };
      const intl2 = util.intl;
      obj4.text = intl2.string(_modDef2429.g5Ds69);
      obj4.onPress = tmp10;
