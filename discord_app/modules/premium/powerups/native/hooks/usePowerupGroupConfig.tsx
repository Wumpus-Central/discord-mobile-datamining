...
import _modDef12554 from "../../../../../../discord_assets/assets/powerups/badge-packs/group-static.png.js";
import _modDef12555 from "../../../../../../discord_assets/assets/powerups/badge-packs/group-animated.png.js";
...
export default function usePowerupGroupConfig(arg0, arg1) {
  ...
  return noop.useMemo(() => {
    if ("guildTagsBadgePacks" === group.group) {
      ...
      obj = { staticUrl: _modDef12554, animatedUrl: _modDef12555 };
      obj.image = obj;
      let stringResult;
      if (!stateFromStores) {
