...
import _modDef12643 from "../../../../../../discord_assets/assets/powerups/badge-packs/group-static.png.js";
import _modDef12644 from "../../../../../../discord_assets/assets/powerups/badge-packs/group-animated.png.js";
...
export default function usePowerupGroupConfig(arg0, arg1) {
  ...
  return noop.useMemo(() => {
    if ("guildTagsBadgePacks" === group.group) {
      ...
      obj = { staticUrl: _modDef12643, animatedUrl: _modDef12644 };
      obj.image = obj;
      let stringResult;
      if (!stateFromStores) {
