...
export default function GuildPowerupsMultiPerkBottomSheet(guildId) {
  ...
  if (null != tmp4) {
    ...
    obj.children = items;
    obj.children = closure_5(guildId(6677).BottomSheetScrollView, obj);
    tmp6Result = closure_4(guildId(7202).BottomSheet, obj);
