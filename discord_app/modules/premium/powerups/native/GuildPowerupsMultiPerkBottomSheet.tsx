// === Module 11716: GuildPowerupsMultiPerkCard ===
...
import useGuildPowerupOnShowDeactivateDefault from "useGuildPowerupOnShowDeactivate" /* 11708 */;
import useGuildPowerupColorConfigDefault from "useGuildPowerupColorConfig" /* 11717 */;
import usePowerupGroupConfigDefault from "usePowerupGroupConfig" /* 11718 */;
...
function GuildPowerupsMultiPerkCard(arg0) {
  ...
  const items4 = [closure_4(_require(4734).Text, { variant: "heading-md/semibold", color: useGuildPowerupColorConfigDefault(result).textColor, children: powerup.title }), ];
...
export default function GuildPowerupsMultiPerkBottomSheet(guildId) {
  ...
  if (null != tmp4) {
    ...
    const items = [callback(tmp2(11721), { title: null, description: null }), , ];
