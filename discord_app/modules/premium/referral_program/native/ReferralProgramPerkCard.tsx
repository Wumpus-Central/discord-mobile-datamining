...
import _modDef6571 from "../../../../../discord_assets/assets/mana/asset-library/generated/Orb3dIllustration-2x.png.js";
...
export const ReferralProgramPerkCard = function ReferralProgramPerkCard() {
  ...
  let callback = noop.useCallback(() => {
    ...
    ActionSheetActionCreatorsDefault.openLazy(
      asyncRequireImpl(13707, dependencyMap.paths),
  ...
  if (!useAltReferralCardArt) {
    ...
    let tmp5Result2 = _modDef6571;
  } else if (tmp11 === tmp2(13705).ReferralRewardType.DISCOUNT) {
    tmp5Result2 = _modDef6157;
  }
