...
import _modDef6438 from "../../../../../discord_assets/assets/mana/asset-library/generated/Orb3dIllustration-2x.png.js";
...
export const ReferralProgramPerkCard = function ReferralProgramPerkCard() {
  ...
  let callback = noop.useCallback(() => {
    ...
    ActionSheetActionCreatorsDefault.openLazy(
      asyncRequireImpl(13541, dependencyMap.paths),
  ...
  if (!useAltReferralCardArt) {
    ...
    const items5 = [closure_11(tmp2(4634).Text, obj11), ,];
    ...
    if (null != tmp11) {
      ...
      items5[1] = closure_11(tmp2(4634).Text, obj13);
      if (isEligibleForIncentive) {
      ...
      obj26.children = closure_11(tmp2(5060).Button, obj27);
    ...
    let tmp5Result2 = _modDef6438;
  } else if (tmp11 === tmp2(13539).ReferralRewardType.DISCOUNT) {
    tmp5Result2 = _modDef6024;
  }
  const tmp2Result = tmp2(13548);
};
