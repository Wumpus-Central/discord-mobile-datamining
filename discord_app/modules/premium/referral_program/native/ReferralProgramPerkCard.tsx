...
import _modDef6435 from "../../../../../discord_assets/assets/mana/asset-library/generated/Orb3dIllustration-2x.png.js";
...
export const ReferralProgramPerkCard = function ReferralProgramPerkCard() {
  ...
  const callback = noop.useCallback(() => {
    ...
    ActionSheetActionCreatorsDefault.openLazy(
      asyncRequireImpl(13530, dependencyMap.paths),
  ...
  if (!useAltReferralCardArt) {
    ...
    const items4 = [closure_10(tmp2(4635).Text, obj10), ,];
    ...
    if (null != tmp12) {
      ...
      if (tmp11 === tmp2(13527).MAX_REFERRALS_SENT) {
      ...
      items4[1] = closure_10(tmp2(4635).Text, obj12);
      if (isEligibleForIncentive) {
      ...
      obj25.children = closure_10(tmp2(5059).Button, obj26);
    ...
    let tmp5Result2 = _modDef6435;
  } else if (tmp12 === tmp2(13528).ReferralRewardType.DISCOUNT) {
    tmp5Result2 = _modDef6023;
  }
