...
import _modDef12979 from "../../../../../discord_assets/assets/mana/asset-library/generated/Orb3dIllustration-2x.png.js";
...
export const ReferralProgramPerkCard = function ReferralProgramPerkCard() {
  ...
  let callback = noop.useCallback(() => {
    ...
    ActionSheetActionCreatorsDefault.openLazy(
      asyncRequireImpl(12981, dependencyMap.paths),
  ...
  if (!useAltReferralCardArt) {
    ...
    const items5 = [closure_11(tmp2(4832).Text, obj11), ,];
    ...
    if (null != tmp11) {
      ...
      items5[1] = closure_11(tmp2(4832).Text, obj13);
      if (isEligibleForIncentive) {
    ...
    let tmp5Result2 = _modDef12979;
  } else if (tmp11 === tmp2(12978).ReferralRewardType.DISCOUNT) {
    tmp5Result2 = _modDef12722;
  }
  const tmp2Result = tmp2(12990);
};
