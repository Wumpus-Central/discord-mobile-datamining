...
import _modDef12976 from "../../../../../discord_assets/assets/premium/referral_program/referralTrial.png.js";
...
export default function ProgressWheel(arg0) {
  ...
  if (tmp9) {
    const obj4 = { source: _modDef12975, style: tmp.glowImage };
