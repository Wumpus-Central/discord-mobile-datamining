...
import _modDef13711 from "../../../../../discord_assets/assets/premium/referral_program/referralTrial.png.js";
...
export default function ProgressWheel(arg0) {
  ...
  if (tmp9) {
    const obj4 = { source: _modDef13710, style: tmp.glowImage };
