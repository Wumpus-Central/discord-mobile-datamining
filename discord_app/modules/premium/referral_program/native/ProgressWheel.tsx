...
import _modDef13551 from "../../../../../discord_assets/assets/premium/referral_program/referralTrial.png.js";
...
export default function ProgressWheel(arg0) {
  ...
  if (tmp9) {
    const obj4 = { source: _modDef13550, style: tmp.glowImage };
