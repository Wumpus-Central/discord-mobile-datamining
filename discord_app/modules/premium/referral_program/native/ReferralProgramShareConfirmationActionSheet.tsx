...
function SharedUser(user) {
  ...
  obj6.icon = closure_5(user(5121).ChatIcon, {
    size: "xs",
...
export default function ReferralProgramShareConfirmationActionSheet(trialCreationResult) {
  ...
  obj = {
    ...
    header: closure_5(tmp5(7201).BottomSheetTitleHeader, { title: null }),
    children: null,
  };
  obj = { children: null };
  ...
  items[2] = closure_5(tmp5(4601).Text, {
