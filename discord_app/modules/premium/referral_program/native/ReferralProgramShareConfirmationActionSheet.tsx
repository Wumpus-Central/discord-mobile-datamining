// === Module 13452: ReferralProgramShareConfirmationActionSheet ===
...
function SharedUser(user) {
  ...
  obj6.icon = closure_5(user(5071).ChatIcon, { size: "xs", color: nativeDefault.colors.CONTROL_SECONDARY_TEXT_DEFAULT });
...
export default function ReferralProgramShareConfirmationActionSheet(trialCreationResult) {
  ...
  obj = { startExpanded: true, contentStyles: tmp.content, header: closure_5(tmp5(7149).BottomSheetTitleHeader, { title: null }), children: null };
  obj = { children: null };
  obj1 = { style: tmp.headerAsset, children: closure_5(tmp5(5692).FistBumpSpotIllustration, {}) };
  const items = [closure_5(View, obj1), closure_5(tmp5(4556).Text, { variant: "heading-lg/bold", color: "mobile-text-heading-primary", style: tmp.header, children: stringResult }), , ];
  ...
  items[2] = closure_5(tmp5(4556).Text, { variant: "text-md/medium", color: "text-default", style: tmp.subheader, children: intl3.format(tmp5(1114).t.AwGSWl, obj) });
