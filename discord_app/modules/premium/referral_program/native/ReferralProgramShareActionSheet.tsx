...
import makeUserListPillDataDefault from "../../../main_tabs_v2/native/shared_components/user_list/makeUserListPillData.tsx";
import ReferralProgramShareActionSheetUtils from "ReferralProgramShareActionSheetUtils.tsx";
...
export default function ReferralProgramShareActionSheet() {
  ...
  const analyticsLocations = stateFromStores(selectedUserIds[19])(
    stateFromStores(selectedUserIds[20]).PREMIUM_MARKETING_REFERALL_PROGRAM_SHARE_MODAL,
  ).analyticsLocations;
  _require = asyncGeneratorStep(async (arg0) => {
    ...
    if (1 === tmp7) {
      ...
      stateFromStores(first[23]).openLazy(
        closure_0(first[25])(first[24], first.paths),
        "referral-program-share-action-sheet",
        { selectedUsers: closure_129_0, trialCreationResult: closure_129_1 },
      );
      c3 = 0;
  ...
  items16[1] = tmp42;
  items16[2] = hasError(require("UsersFastList").UsersFastList, {
    ref,
    inActionSheet: true,
    sections: memo4,
