// === Module 13458: RewardGrantNotice ===
...
function OrbsGrantNotice(nRewardsGranted) {
  ...
  obj = { initialRenderedBalance: 0, balance: nRewardsGranted.nRewardsGranted * hasOwnProperty, style: tmp.balancePillOverride };
...
createStyles = { flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_4, marginTop: nativeDefault.space.PX_8, alignSelf: "flex-start" };
createStyles.container = createStyles;
createStyles.orbsPillContainer = { flexDirection: "row", alignItems: "center", marginTop: nativeDefault.space.PX_8, alignSelf: "flex-start" };
