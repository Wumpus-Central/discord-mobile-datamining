// === Module 14256: ProductCatalog ===

// Module 14256 (ProductCatalog)
import LoggerDefault from "Logger" /* 3 */;
import user from "user" /* 1380 */;
import EntitlementFeatureNames from "EntitlementFeatureNames" /* 8099 */;
import PremiumFeatureUtils from "PremiumFeatureUtils" /* 9479 */;
import SKUListingDefault from "SKUListing" /* 14258 */;
import DenormalizedPerksReadExperimentDefault from "DenormalizedPerksReadExperiment" /* 14259 */;
import PremiumConstants from "PremiumConstants" /* 1374 */;
import PremiumSKUFeature_mod from "PremiumSKUFeature" /* 14257 */;
...
export const canUserUse = function canUserUse(COLLECTIBLES, isPremiumWithFractionalPremiumOnly, arg2) {
  ...
  if (null != value) {
    ...
    if (null != perks) {
      ...
      if (config !== closure_0(14259).DenormalizedPerksReadConfig.CONTROL) {
        ...
        if (config === closure_0(14259).DenormalizedPerksReadConfig.DUAL_READ_RETURN_NEW) {
