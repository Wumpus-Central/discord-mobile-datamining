...
import _modDef15060 from "../../../../_runtime/metro/15060__.js";
...
export default function PremiumTabBadge() {
  ...
  const result = obj5.useIsDismissibleContentDismissed_UNSAFE(
  ...
  if (trialId === closure_6) {
    ...
    if (!tmp7) {
      ...
      tmp12Result = _slicedToArray(
        tmpResult5.useSelectedSnowflakeBoundDismissibleContent(prop, str2, undefined, true),
        2,
      );
      if (null != promotionMarketingComponent) {
        if ("premiumTab" === promotionMarketingComponent.properties.properties.oneofKind) {
