...
import usePromotionMarketingComponent from "usePromotionMarketingComponent" /* 13379 */;
...
function OfferBadge(componentId) {
  ...
  if (acked) {
    ...
    const obj3 = { source: _modDef15011, size: native.Icon.Sizes.EXTRA_SMALL, color: tmp4.icon.color, style: tmp4.icon };
    ...
    if (!tmp7) {
      ...
      if (tmp7) {
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          obj4.style = items4;
          obj5 = { source: _modDef15011, size: native.Icon.Sizes.EXTRA_SMALL, color: intl.icon.color, style: intl.icon };
