...
import { registerAsset } from "../../../../_runtime/14106_registerAsset.js";
    ...
    if (!tmp7) {
      ...
      if (tmp7) {
        ...
        if (premiumDiscountOffer.hasAcknowledged()) {
          ...
          tmp41 = callback2(LinearGradient, obj7);
          const tmp40 = LinearGradient;
        }
      } else {
        tmp47Result = null;
