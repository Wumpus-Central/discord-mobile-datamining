...
const memoResult = require("noop").memo(function PremiumTrialOfferActionSheetContent(onConfirm) {
  ...
  obj3[3] = intl7.formatToPlainString(getSystemLocale /* getSystemLocale */.t.q8eMc0, { displayName: displayNameFromSku, duration: intervalDuration });
  ...
  obj5[1] = intl8.formatToPlainString(getSystemLocale /* getSystemLocale */.t.xASjq5, { duration: intervalDuration });
