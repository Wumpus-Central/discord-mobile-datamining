...
import _modDef11600 from "../../../../../_runtime/metro/11600__.js";
import _modDef11601 from "../../../../../_runtime/metro/11601__.js";
...
export default function GiftCodeRedeemError(children) {
  ...
  if (theme.dark) {
    let tmp9Result = _modDef11600;
  } else {
    tmp9Result = _modDef11601;
  }
