...
export default function GiftBoxAnimation(giftStyle) {
  ...
  if (null == giftStyle) {
    ...
    const withResult1 = match
      .with(PremiumGiftStyles.SNOWGLOBE, () => callback(11449))
      .with(PremiumGiftStyles.BOX, () => callback(11450));
    const withResult2 = match
      .with(PremiumGiftStyles.SNOWGLOBE, () => callback(11449))
      .with(PremiumGiftStyles.BOX, () => callback(11450))
      .with(PremiumGiftStyles.CUP, () => callback(11451));
    const withResult3 = match
      .with(PremiumGiftStyles.SNOWGLOBE, () => callback(11449))
      .with(PremiumGiftStyles.BOX, () => callback(11450))
      .with(PremiumGiftStyles.CUP, () => callback(11451))
      .with(PremiumGiftStyles.STANDARD_BOX, () => callback(10834));
    const withResult4 = match
      .with(PremiumGiftStyles.SNOWGLOBE, () => callback(11449))
      .with(PremiumGiftStyles.BOX, () => callback(11450))
      .with(PremiumGiftStyles.CUP, () => callback(11451))
      .with(PremiumGiftStyles.STANDARD_BOX, () => callback(10834))
      .with(PremiumGiftStyles.COFFEE, () => callback(10843));
    const withResult5 = match
      ...
      .with(PremiumGiftStyles.STANDARD_BOX, () => callback(10834))
      .with(PremiumGiftStyles.COFFEE, () => callback(10843))
      .with(PremiumGiftStyles.CHEST, () => callback(10840));
    const withResult6 = match
      ...
      .with(PremiumGiftStyles.COFFEE, () => callback(10843))
      .with(PremiumGiftStyles.CHEST, () => callback(10840))
      .with(PremiumGiftStyles.CAKE, () => callback(10837));
    const withResult7 = match
      ...
      .with(PremiumGiftStyles.CHEST, () => callback(10840))
      .with(PremiumGiftStyles.CAKE, () => callback(10837))
      .with(PremiumGiftStyles.SEASONAL_STANDARD_BOX, () => callback(10846));
    const withResult8 = match
      ...
      .with(PremiumGiftStyles.CAKE, () => callback(10837))
      .with(PremiumGiftStyles.SEASONAL_STANDARD_BOX, () => callback(10846))
      .with(PremiumGiftStyles.SEASONAL_CAKE, () => callback(10849));
    const withResult9 = match
      ...
      .with(PremiumGiftStyles.SEASONAL_STANDARD_BOX, () => callback(10846))
      .with(PremiumGiftStyles.SEASONAL_CAKE, () => callback(10849))
      .with(PremiumGiftStyles.SEASONAL_CHEST, () => callback(10852));
    const withResult10 = match
      ...
      .with(PremiumGiftStyles.SEASONAL_CAKE, () => callback(10849))
      .with(PremiumGiftStyles.SEASONAL_CHEST, () => callback(10852))
      .with(PremiumGiftStyles.SEASONAL_COFFEE, () => callback(10855));
