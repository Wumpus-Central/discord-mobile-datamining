...
function AnimatedImage(arg0) {
  ...
  const stateFromStores = shouldAnimate(aPNGPlayerControls[8]).useStateFromStores(
    items,
...
let size = {
  ...
  border: { borderBottomColor: nativeDefault.colors.BORDER_SUBTLE, borderBottomWidth: 1 },
  overflow: "hidden",
};
obj3.preview = size;
