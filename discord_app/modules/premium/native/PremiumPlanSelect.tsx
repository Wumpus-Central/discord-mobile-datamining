// === Module 13542: PremiumPlanSelect ===
...
import _modDef13546 from "module_13546" /* 13546 */;
...
function PlanSection(showBoostOnlyLabels) {
  ...
  if (shouldShowModernBoostFlow) {
    ...
    let tmp7Result = closure_31(shouldShowModernBoostFlow(5687).TableRowGroup, obj);
  } else {
    obj = { children: mapped };
