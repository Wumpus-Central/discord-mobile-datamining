...
import _modDef13810 from "../../../../_runtime/metro/13810__.js";
...
function PlanRow(plan) {
  ...
  if (null == plan.premiumTier) {
    let tmp7Result = require("../../../../_runtime/metro/13808__.js");
  } else if (0 !== plan.numPremiumGuild) {
    if (plan.premiumTier === closure_20.TIER_1) {
      tmp7Result = require("../../../../_runtime/metro/13812__.js");
    } else {
      tmp7Result = require("../../../../_runtime/metro/13813__.js");
    }
  } else {
    const premiumTier = plan.premiumTier;
    if (closure_20.TIER_0 === premiumTier) {
      tmp7Result = require("../../../../_runtime/metro/13809__.js");
    } else if (closure_20.TIER_1 === premiumTier) {
      tmp7Result = require("../../../../_runtime/metro/13810__.js");
    } else if (closure_20.TIER_2 === premiumTier) {
      tmp7Result = require("../../../../_runtime/metro/13811__.js");
    }
  }
...
function PlanSection(showBoostOnlyLabels) {
  ...
  if (shouldShowModernBoostFlow) {
    ...
    let tmp7Result = closure_31(shouldShowModernBoostFlow(5904).TableRowGroup, obj2);
  } else {
          ...
          obj13.onPurchaseComplete = function onPurchaseComplete(paymentGateway) {
            ...
            if (paymentGateway.paymentGateway === constants.APPLE_ADVANCED_COMMERCE) {
              ...
              if (null == premiumTypeSubscription) {
                ...
                closure_1(4959).popWithKey(premiumTypeSubscription(7654).PREMIUM_KEY);
                if (navigation.canGoBack()) {
                  navigation.goBack();
                }
                const tmpResult = closure_1(4959);
              } else {
                const obj3 = {
                  importer() {
                ...
                closure_1(5109).openLazy(obj3);
                const tmpResult2 = closure_1(5109);
              }
            }
            let obj = closure_1(5109);
          };
          v3 = 3;
          c7 = 1;
