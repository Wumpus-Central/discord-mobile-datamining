...
let closure_10 = createStyles.createStyles((arg0) => {
  ...
  obj = { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, paddingTop: nativeDefault.space.PX_16, paddingBottom: arg0 + nativeDefault.space.PX_16, paddingHorizontal: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_8 };
...
export default function PremiumGiftSuccess() {
  ...
  const effect = noop.useEffect(() => {
    ...
    if (tmp) {
      ...
      const result = obj.markSnowflakeBoundDismissibleContentAsDismissed(dismissible_content.DismissibleContent.GIFTING_PROMOTION_REMINDER, stateFromStores, obj);
    }
  }, items1);
