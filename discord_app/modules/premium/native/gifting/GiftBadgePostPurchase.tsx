...
import _modDef2582 from "../../gifting/GiftingBadge.messages.js";
...
function PostPurchaseFooter(onSendGift) {
  ...
  obj2.icon = closure_10(onSendGift(11387).GiftIcon, {
    size: "sm",
...
function LevelUpScreen(arg0) {
  ...
  if (tmp10Result2) {
    ...
    obj11.children = intl2.format(_modDef2582["6QVlxw"], obj12);
  ...
  if (null == stateFromStores) {
    ...
    if (1 === tmp10) {
      ...
      if (null != name) {
        ...
        str = intl.formatToPlainString(_modDef2582.bwyQt8, obj6);
      }
