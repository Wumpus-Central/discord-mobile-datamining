// === Module 10445: PremiumGiftPlanSelectPromotionDetails ===
...
import createTextStyleDefault from "createTextStyle" /* 5413 */;
import usePremiumFeaturesDefault from "usePremiumFeatures" /* 8157 */;
import useThemeAndReducedMotionAwareAssetUrl from "useThemeAndReducedMotionAwareAssetUrl" /* 10446 */;
import usePremiumProductPricingStringDefault from "usePremiumProductPricingString" /* 10447 */;
import useShouldShowGiftingPromotionDecoDefault from "useShouldShowGiftingPromotionDeco" /* 10448 */;
import AnimatedImageDefault from "AnimatedImage" /* 10452 */;
...
const memoResult = importAllResult.memo(function PremiumGiftFeaturesCard(variant) {
  ...
  const themeAndReducedMotionAwareAssetUrl1 = _require(10446).useThemeAndReducedMotionAwareAssetUrl(backgroundAsset);
  let tmp9 = null != claimableRewards;
  if (tmp9) {
    tmp9 = 1 === claimableRewards.length;
  }
  const tmp10 = callback4(tmp9);
  const tmp2Result = _require(10446);
  ...
  if (tmp16) {
    ...
    obj[2] = obj1;
    tmp22 = callback2(tmp11(5445), obj);
  }
  const items2 = [tmp22, ];
  obj2 = { premiumType, opacity: null, style: null };
  let num3 = 1;
  tmp11Result = tmp11(8027);
  if (tmp16) {
    num3 = 0.82;
  }
  obj2[1] = num3;
  ...
  if (promotionalButton) {
    ...
    if (tmp29) {
      ...
      obj3[2] = isSelected;
      obj3[3] = callback;
      tmp29 = callback2(tmp11(10449), obj3);
    }
    const items4 = [tmp29, ];
    ...
    if (tmp31) {
      ...
      obj4[2] = obj6;
      tmp31 = callback2(tmp11(5445), obj4);
    }
    ...
    obj8[0] = premiumType;
    tmp20Result = callback2(tmp11(8287), obj8);
  }
  ...
  if (!promotionalButton) {
    ...
    items6[2] = tmp33(tmp2(4441).Text, obj10);
    ...
    items6[3] = tmp33(tmp2(4441).Text, obj12);
    ...
    obj13[4] = obj[str];
    items6[4] = tmp33(tmp11(8294), obj13);
    ...
    obj17[2] = onPress;
    obj16[1] = tmp33(tmp2(4880).Button, obj17);
