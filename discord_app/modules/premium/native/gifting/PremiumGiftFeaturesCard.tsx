...
const memoResult = importAllResult.memo(function PremiumGiftFeaturesCard(variant) {
  ...
  if (tmp16) {
    ...
    obj[2] = obj1;
    tmp22 = callback2(tmp11(5236), obj);
  }
  const items2 = [tmp22, ];
  const obj2 = { premiumType, opacity: null, style: null };
  let num3 = 1;
  let tmp11Result = tmp11(8101);
  if (tmp16) {
    num3 = 0.82;
  }
  obj2[1] = num3;
  ...
  if (promotionalButton) {
    ...
    if (tmp30) {
      ...
      obj3[2] = isSelected;
      obj3[3] = callback;
      tmp30 = callback2(tmp11(9961), obj3);
    }
    const items4 = [tmp30, ];
    ...
    if (tmp32) {
      ...
      obj4[2] = obj6;
      tmp32 = callback2(tmp11(5236), obj4);
    }
  ...
  if (!promotionalButton) {
    ...
    if (!showGiftPrice) {
      ...
      obj11[4] = obj[str];
      items6[4] = tmp34(tmp11(8556), obj11);
