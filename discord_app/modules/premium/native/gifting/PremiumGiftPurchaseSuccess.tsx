...
export default function PremiumGiftSuccessBody(giftCodeRecord) {
  ...
  obj.children = closure_8(giftCodeURL(10958), { giftStyle });
  ...
  items1[1] = closure_8(giftCodeRecord(4632).Text, obj);
  ...
  items1[2] = closure_8(giftCodeRecord(4632).Text, obj1);
  ...
  const items2 = [closure_8(giftCodeRecord(4632).Text, obj4), closure_8(giftCodeRecord(9031).InputButton, { text: giftCodeURL, icon: giftCodeURL(4584), iconPosition: "end", onPress: callback })];
  ...
  items1[4] = closure_8(giftCodeRecord(4632).Text, obj6);
