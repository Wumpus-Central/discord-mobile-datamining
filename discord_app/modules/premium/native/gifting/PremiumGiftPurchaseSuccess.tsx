...
export default function PremiumGiftSuccessBody(giftCodeRecord) {
  ...
  obj.children = closure_8(giftCodeURL(10919), { giftStyle });
  ...
  items1[1] = closure_8(giftCodeRecord(4602).Text, obj);
  ...
  items1[2] = closure_8(giftCodeRecord(4602).Text, obj1);
  ...
  const items2 = [closure_8(giftCodeRecord(4602).Text, obj4), closure_8(giftCodeRecord(8992).InputButton, { text: giftCodeURL, icon: giftCodeURL(4554), iconPosition: "end", onPress: callback })];
  ...
  items1[4] = closure_8(giftCodeRecord(4602).Text, obj6);
