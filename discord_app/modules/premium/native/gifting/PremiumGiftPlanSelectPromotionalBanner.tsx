...
let closure_6 = createCacheKey.createStyles(() => {
  let obj = {
    gradient: { minHeight: 60 },
    bannerImage: { position: "absolute", top: 0, left: 0, right: 0, width: "100%", aspectRatio: 5 },
    content: null,
    heading: null,
    subheading: null,
    logoContainer: null,
    logoContainerLargeTilted: null,
    logo: null,
    logoLargeTilted: null,
  };
  obj = {
    minHeight: 60,
    ...
    paddingStart: ThemesDefault.space.PX_24,
    paddingEnd: 120,
  };
  obj[2] = obj;
  obj[3] = {};
...
const memoResult = importAllResult.memo(
  function PremiumGiftPlanSelectPromotionalBanner(giftPlanSelectionCardBannerComponent) {
    ...
    const themeAndReducedMotionAwareAssetUrl = obj.useThemeAndReducedMotionAwareAssetUrl(
      giftPlanSelectionCardBannerComponent.mobileBannerAsset,
    );
    obj1 = useThemeAndReducedMotionAwareAssetUrl;
    const themeAndReducedMotionAwareAssetUrl1 = obj1.useThemeAndReducedMotionAwareAssetUrl(
      giftPlanSelectionCardBannerComponent.avatarAsset,
      true,
    );
    obj = {
      style: tmp.gradient,
    ...
    if (tmp12Result) {
      let logoLargeTilted =
        giftPlanSelectionCardBannerComponent.assetVariant ===
        create.GiftPlanSelectionCardBanner_AssetVariant.LARGE_TILTED;
