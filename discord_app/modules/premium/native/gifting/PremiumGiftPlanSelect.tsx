...
let closure_17 = createCacheKey.createStyles((width) => {
  ...
  obj[1] = obj;
  obj[2] = { color: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.BACKGROUND_BASE_LOW };
  obj[3] = { position: "absolute", width, height: arg1 / 1.75 };
  obj[4] = { width };
  const obj2 = { width, backgroundColor: null };
  let obj5 = require("../../../../../_runtime/00689_n.js")("#000000");
  const obj1 = { color: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.BACKGROUND_BASE_LOW };
  ...
  obj[7] = { textAlign: "center", marginTop: arg2 ? space.PX_16 : space.PX_12, marginHorizontal: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_24 };
  const space2 = tmp(712).space;
  const obj3 = { textAlign: "center", marginTop: arg2 ? space.PX_16 : space.PX_12, marginHorizontal: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_24 };
  obj[8] = { textAlign: "center", marginTop: arg2 ? space2.PX_16 : space2.PX_12, marginHorizontal: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_24 };
  ...
  const obj4 = { textAlign: "center", marginTop: arg2 ? space2.PX_16 : space2.PX_12, marginHorizontal: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_24 };
  obj[13] = { padding: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_16 };
  obj[14] = { width: 24, height: 24, tintColor: "white" };
  const obj6 = { padding: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_16 };
  obj[15] = { marginTop: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_16, marginHorizontal: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_16 };
  return obj;
});
