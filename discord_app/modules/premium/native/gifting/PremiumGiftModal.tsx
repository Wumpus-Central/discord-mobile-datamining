...
let obj2 = {
  [PLAN_SELECT]: fn(11005).PaymentFlowStep.SKU_SELECT,
  [REWARD_SELECT]: fn(11005).PaymentFlowStep.REWARD_SKU_SELECT,
  [CUSTOMIZATION]: fn(11005).PaymentFlowStep.PLAN_SELECT,
  [SUCCESS]: fn(11005).PaymentFlowStep.CONFIRM,
  [GIFTING_BADGE]: fn(11005).PaymentFlowStep.CONFIRM,
};
