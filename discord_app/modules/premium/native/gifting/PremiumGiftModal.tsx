...
obj = {
  [PLAN_SELECT]: fn(10791).PaymentFlowStep.SKU_SELECT,
  [REWARD_SELECT]: fn(10791).PaymentFlowStep.REWARD_SKU_SELECT,
  [CUSTOMIZATION]: fn(10791).PaymentFlowStep.PLAN_SELECT,
  [SUCCESS]: fn(10791).PaymentFlowStep.CONFIRM,
  [GIFTING_BADGE]: fn(10791).PaymentFlowStep.CONFIRM,
};
