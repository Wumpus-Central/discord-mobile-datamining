...
obj = { [PLAN_SELECT]: fn(10791).PaymentFlowStep.SKU_SELECT, [REWARD_SELECT]: fn(10791).PaymentFlowStep.REWARD_SKU_SELECT, [CUSTOMIZATION]: fn(10791).PaymentFlowStep.PLAN_SELECT, [SUCCESS]: fn(10791).PaymentFlowStep.CONFIRM, [GIFTING_BADGE]: fn(10791).PaymentFlowStep.CONFIRM };
...
export default function PremiumGiftModal(analyticsLocations) {
  ...
  if (initialRoute != null) {
    ...
    if (tmp11Result6.isPremiumGiftingSupported()) {
      ...
      obj7.children = jsx(analyticsLocation(onDismiss[25]).NativeGiftContextProvider, { basePurchaseAnalytics: tmp4, recipientUserId, onClose: callback, setCurrentAnalyticsStep: tmp22, premiumType, planInterval, initialOrder: order, children: null });
