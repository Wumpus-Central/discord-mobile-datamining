...
function RewardPreview(arg0) {
  ...
  if (isNameplateRecord(collectiblesItem)) {
    ...
    let obj8 = getNameplateData /* getNameplateData */;
    ...
    obj3[0] = currentUser;
    obj3[2] = Button /* Button */.AvatarSizes.SMALL;
    obj2[1] = callback(Button /* Button */.Avatar, obj3);
    ...
    obj4[2] = intl2.string(getSystemLocale /* getSystemLocale */.t.Rh4oem);
    ...
    if (isAvatarDecorationRecord(collectiblesItem)) {
      ...
      obj7[0] = Button /* Button */.AvatarSizes.NORMAL;
      ...
      obj8[3] = intl.string(getSystemLocale /* getSystemLocale */.t.Rh4oem);
      items1[2] = callback(Text /* Text */.Text, obj8);
      obj5[0] = items1;
