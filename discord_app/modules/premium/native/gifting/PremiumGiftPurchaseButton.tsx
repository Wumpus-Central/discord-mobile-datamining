// === Module 11321: PremiumGiftPurchaseButton ===
...
import useShouldShowGiftingPromotionDecoDefault from "useShouldShowGiftingPromotionDeco" /* 11018 */;
...
export default function PremiumGiftPurchaseButton(defaultSelection) {
  ...
  const isGiftingBadgeComplexArtEnabled = defaultSelection(11010).useIsGiftingBadgeComplexArtEnabled(`PremiumGiftPurchaseButton${str}`);
