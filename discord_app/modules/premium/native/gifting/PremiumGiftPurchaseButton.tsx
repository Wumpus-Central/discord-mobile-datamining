...
function RewardPreview(arg0) {
  ...
  const tmp3 = callback3(importDefault(5310)().insets.bottom);
  if (isNameplateRecord(collectiblesItem)) {
    ...
    if (isAvatarDecorationRecord(collectiblesItem)) {
      ...
      items1[2] = callback(require(4281) /* Text */.Text, obj8);
      obj5[0] = items1;
...
export default function PremiumGiftPurchaseButton(defaultSelection) {
  ...
  let c9;
  let c10;
  let tmp3 = callback3(importDefault(5310)().insets.bottom);
  ...
  c9 = tmp10;
  const tmp11 = importDefault(9960)();
  let tmp12 = tmp11;
  if (tmp11) {
