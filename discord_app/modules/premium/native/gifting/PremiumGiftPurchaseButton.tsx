...
function RewardPreview(arg0) {
  ...
  const tmp3 = callback3(require("../../../safe_area/useSafeAreaInsetsKeyboardAware.native.tsx")().insets.bottom);
  if (isNameplateRecord(collectiblesItem)) {
    ...
    let tmpResult = tmp(9308);
    let obj8 = require("../../../collectibles/nameplates/utils.tsx") /* getNameplateData */;
    ...
    obj3[0] = currentUser;
    obj3[2] = require("../../../../design/void/native.tsx") /* Button */.AvatarSizes.SMALL;
    obj2[1] = callback(require("../../../../design/void/native.tsx") /* Button */.Avatar, obj3);
    ...
    obj4[2] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.Rh4oem);
    ...
    if (isAvatarDecorationRecord(collectiblesItem)) {
      ...
      obj7[0] = require("../../../../design/void/native.tsx") /* Button */.AvatarSizes.NORMAL;
      obj7[1] = collectiblesItem.asset;
      obj6[1] = callback(tmp(10034), obj7);
      ...
      obj8[3] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.Rh4oem);
      items1[2] = callback(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj8);
      obj5[0] = items1;
      tmp7Result = callback2(closure_13, obj5);
      const tmp7 = callback2;
      const tmp8 = closure_13;
      const tmpResult1 = tmp(10034);
    }
  }
  return tmp7Result;
}
...
let closure_15 = createCacheKey.createStyles((arg0) => {
  ...
  obj.borderRadius = require("../../../../../discord_common/js/packages/tokens/native.tsx").radii.sm;
  obj.overflow = "hidden";
  obj[2] = obj;
  obj[3] = { flex: 1, marginStart: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_8 };
  obj[4] = { position: "absolute", top: 0, left: 0, right: 0, bottom: 0, opacity: 1 };
  const obj1 = { flex: 1, marginStart: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_8 };
  obj[5] = { width: 58, height: 58, marginStart: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_8 };
  ...
  const obj2 = { width: 58, height: 58, marginStart: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_8 };
  obj[8] = { flexDirection: "row", alignItems: "center", gap: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_16 };
  obj[9] = { flex: 1, flexDirection: "row", alignItems: "center", height: 52 };
  const obj4 = {};
  const merged2 = Object.assign(closure_4.absoluteFillObject);
  obj4.borderRadius = require("../../../../../discord_common/js/packages/tokens/native.tsx").radii.sm;
  obj4.top = require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_4;
  obj4.bottom = require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_4;
  obj4.start = require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_4;
  obj4.end = require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_4;
  obj4.marginStart = require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_12;
  obj[10] = obj4;
  obj[11] = { flex: 1 };
  const obj3 = { flexDirection: "row", alignItems: "center", gap: require("../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_16 };
  obj[12] = { position: "absolute", left: 0, right: 0, top: 0, bottom: 0, borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").radii.sm, overflow: "hidden" };
  return obj;
});
...
export default function PremiumGiftPurchaseButton(defaultSelection) {
  ...
  let c9;
  let c10;
  let tmp3 = callback3(require("../../../safe_area/useSafeAreaInsetsKeyboardAware.native.tsx")().insets.bottom);
  let obj = defaultSelection(1480);
  importDefault = obj.useNavigation();
  let obj1 = defaultSelection(9529);
  ...
  let obj3 = defaultSelection(7342);
  ...
  c9 = tmp10;
  const tmp11 = require("../../gifting/native/hooks/useShouldShowGiftingPromotionDeco.tsx")();
  let tmp12 = tmp11;
  if (tmp11) {
    tmp12 = null == selectedGiftingPromotionReward;
  }
  c10 = tmp12;
  const GiftingBadgeExperiment = tmp4(9496).GiftingBadgeExperiment;
  ...
  const themeAndReducedMotionAwareAssetUrl = defaultSelection(9958).useThemeAndReducedMotionAwareAssetUrl(prop);
  const tmp4Result1 = defaultSelection(9958);
  let asset;
  if (stateFromStores1 != null) {
    asset = stateFromStores1.asset;
  }
  const themeAndReducedMotionAwareAssetUrl1 = defaultSelection(9958).useThemeAndReducedMotionAwareAssetUrl(asset);
  let first;
  if (product != null) {
  ...
  if (tmp12) {
    if (tmp9) {
      ...
      if (tmp32Result) {
        ...
        obj3[2] = obj4;
        tmp32Result = tmp32(tmp(5236), obj3);
      }
      ...
      if (tmp32Result) {
        let inAppFlowImageLargeTilted = assetVariant === tmp4(7284).GiftCustomizationBanner_AssetVariant.LARGE_TILTED;
      ...
      items6[2] = callback(tmp4(4281).Text, obj7);
      obj[1] = items6;
    ...
    if (!tmp12) {
      ...
      obj9[0] = tmp(1945).getArticleURL(HelpdeskArticles.PAID_TERMS);
      obj8[1] = intl4.format(tmp4(1236).t.hYoGUM, obj9);
      tmp38 = callback(tmp4(4281).Text, obj8);
      const tmpResult1 = tmp(1945);
    }
    items8[1] = tmp38;
    ...
    obj10[4] = fn;
    items8[2] = callback(tmp4(4695).Button, obj10);
    obj[1] = items8;
    ...
    if (tmp11) {
      if (null != selectedGiftingPromotionReward) {
        ...
        if (!tmp10) {
          ...
          obj14[2] = tmp28(tmp4(9591).PencilIcon, { size: "sm" });
          ...
          tmp28Result = tmp28(tmp4(7672).IconButton, obj14);
        }
  ...
  if (GiftingBadgeExperiment.useConfig({ location: "PremiumGiftPurchaseButton" }).enabled) {
    ...
    if (null != nextTier) {
      ...
      obj15[3] = tmp(5630).PREMIUM_GIFT_CUSTOMIZATION;
      tmp26Result = callback(tmp(9963), obj15);
      const tmp26 = callback;
      const tmpResult2 = tmp(9963);
    }
  }
};