...
import PremiumGiftingGogoPromotionExperimentDefault from "../../gifting/experiments/PremiumGiftingGogoPromotionExperiment.tsx";
...
export default function PremiumGiftPurchaseButton(defaultSelection) {
  ...
  const isGiftingBadgeComplexArtEnabled = defaultSelection(10896).useIsGiftingBadgeComplexArtEnabled(
