...
export default function PremiumGiftPurchaseButton(defaultSelection) {
  ...
  let obj1 = defaultSelection(10704);
  ...
  if (tmp11) {
    if (tmp8) {
      ...
      tmp22Result = closure_9(tmp(10759), obj4);
  ...
  if (tmp15) {
    if (tmp10) {
      if (null != selectedGiftingPromotionReward) {
        ...
        obj6.subtitle = name;
        const items5 = [closure_9(tmp4(10759).PremiumGiftPromotionCollectibleRewardDetails, obj6)];
  ...
  if (GiftingBadgeExperiment.useConfig({ location: "PremiumGiftPurchaseButton" }).enabled) {
    ...
    if (null != nextTier) {
      ...
      tmp22Result = closure_9(tmp(10761), obj7);
