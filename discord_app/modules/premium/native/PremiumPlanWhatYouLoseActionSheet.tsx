...
createStyles.item = { marginBottom: 16, borderRadius: nativeDefault.radii.sm, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWEST, padding: 16 };
createStyles.itemLabel = { marginTop: 8 };
createStyles.footer = { paddingHorizontal: 16 };
createStyles.button = { marginBottom: 8 };
let obj2 = { marginBottom: 16, borderRadius: nativeDefault.radii.sm, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWEST, padding: 16 };
...
export default function PremiumPlanWhatYouLoseActionSheet(arg0) {
  ...
  const memo = analyticsLocations.useMemo(() => {
    if (PremiumTypes.TIER_0 === premiumTypeFromSubscription) {
      let obj = { imageSource: _modDef13436, text: null };
      const intl7 = util.intl;
      obj.text = intl7.format(util.t["0hUHi6"], {});
      const items = [obj, ];
      obj = { imageSource: _modDef13437, text: null };
