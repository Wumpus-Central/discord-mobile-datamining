// === Module 7656: launchPremiumPlanSelect ===
...
import PremiumModal from "PremiumModal" /* 7657 */;
...
export const launchPremiumPlanSelect = function launchPremiumPlanSelect(isBoostPurchaseFlow) {
  ...
  if (null != navigation) {
    ...
    const obj3 = flag2(4960);
    obj3.pushLazy(asyncRequireImpl(7657, dependencyMap.paths), obj4, PremiumModal.PREMIUM_KEY);
    const tmp7 = asyncRequireImpl(7657, dependencyMap.paths);
  }
