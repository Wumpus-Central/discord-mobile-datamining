...
import _modDef3196 from "../premium_group/PremiumGroup.messages.js";
...
function AccountCreditTier(arg0) {
  ...
  if (hasPremiumGroup) {
    ...
    let stringResult = intl3.string(_modDef3196["5asczk"]);
  } else {
...
let size = {
  width: fn(7503).GameIconImageSize[fn(undefined, 7503).GameIconSizes.SMALL],
  height: fn(7503).GameIconImageSize[fn(undefined, 7503).GameIconSizes.SMALL],
  alignItems: "center",
