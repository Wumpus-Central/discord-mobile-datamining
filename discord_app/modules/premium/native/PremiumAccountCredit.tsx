...
import _modDef3077 from "../premium_group/PremiumGroup.messages.js";
...
function AccountCreditTier(arg0) {
  ...
  if (hasPremiumGroup) {
    ...
    let stringResult = intl3.string(_modDef3077["5asczk"]);
  } else {
...
let size = {
  width: fn(7286).GameIconImageSize[fn(undefined, 7286).GameIconSizes.SMALL],
  height: fn(7286).GameIconImageSize[fn(undefined, 7286).GameIconSizes.SMALL],
  alignItems: "center",
