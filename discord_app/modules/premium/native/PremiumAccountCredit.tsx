...
import _modDef3160 from "../premium_group/PremiumGroup.messages.js";
...
function AccountCreditTier(arg0) {
  ...
  if (hasPremiumGroup) {
    ...
    let stringResult = intl3.string(_modDef3160["5asczk"]);
  } else {
...
let size = {
  width: fn(7368).GameIconImageSize[fn(undefined, 7368).GameIconSizes.SMALL],
  height: fn(7368).GameIconImageSize[fn(undefined, 7368).GameIconSizes.SMALL],
  alignItems: "center",
