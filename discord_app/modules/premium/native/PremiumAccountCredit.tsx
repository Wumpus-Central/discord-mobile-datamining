...
import _modDef3075 from "../premium_group/PremiumGroup.messages.js";
...
function AccountCreditTier(arg0) {
  ...
  if (hasPremiumGroup) {
    ...
    let stringResult = intl3.string(_modDef3075["5asczk"]);
  } else {
...
let size = {
  width: fn(7282).GameIconImageSize[fn(undefined, 7282).GameIconSizes.SMALL],
  height: fn(7282).GameIconImageSize[fn(undefined, 7282).GameIconSizes.SMALL],
  alignItems: "center",
