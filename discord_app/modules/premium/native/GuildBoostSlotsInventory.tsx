// === Module 13773: GuildBoostSlotsInventory ===
...
import SubscriptionPlaceholderPattern from "SubscriptionPlaceholderPattern" /* 13775 */;
...
function GuildBoostSlot(guildBoostSlot) {
  ...
  if (null == guildBoostSlot.guild) {
    ...
    if (null != guildBoostSlot.cooldownEndsAt) {
      ...
      tmp6Result = closure_11(GuildBoostSlotCooldown, obj4);
    }
    ...
    if (!guildBoostSlot.isOnCooldown()) {
      ...
      obj5.children = closure_11(guildBoostSlot(4753).Text, obj6);
      tmp6Result2 = closure_11(guildBoostSlot(5341).PressableOpacity, obj5);
    }
...
function UnusedGuildBoostSlots(unusedSlots) {
  ...
  if (found1.length > 0) {
    ...
    obj4.children = closure_11(found(4753).Text, obj5);
  ...
  const items = [
    ...
    found.map((cooldownEndsAt, index) => {
      ...
      if (null != cooldownEndsAt.cooldownEndsAt) {
        ...
        tmpResult = closure_2_11(GuildBoostSlotCooldown, obj2);
      }
...
function BoostedGuildInfo(guild) {
  ...
  if (null != guild) {
    ...
    const obj7 = { source: _modDef13774, style: tmp.guildInfoRowIcon };
...
function BoostedGuild(arg0) {
  ...
  items3[2] = closure_11(guildBoostSlots(13779), { guild: stateFromStores, theme: stateFromStores1 });
...
export default function GuildBoostSlotsInventory() {
  ...
  const effect = noop.useEffect(() => {
    ...
    const guildBoostSlots = valueResult(4654).fetchGuildBoostSlots();
  }, []);
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      if (found.length > 0) {
        ...
        const items3 = [closure_11(tmp3(4753).Text, obj7), found.map((guildId) => closure_2_11(BoostedGuild, { guildId, guildBoostSlots: valueResult[guildId] }, guildId))];
        obj6.children = items3;
