...
import SubscriptionPlaceholderPattern from "SubscriptionPlaceholderPattern" /* 13579 */;
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      if (found.length > 0) {
        ...
        const items3 = [closure_11(tmp3(4601).Text, obj2), found.map((guildId) => closure_2_11(BoostedGuild, { guildId, guildBoostSlots: valueResult[guildId] }, guildId))];
        obj1.children = items3;
