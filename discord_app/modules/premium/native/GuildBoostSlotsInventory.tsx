...
import _modDef13705 from "../../../../_runtime/metro/13705__.js";
...
function GuildBoostSlot(guildBoostSlot) {
  ...
  if (null == guildBoostSlot.guild) {
    ...
    if (!guildBoostSlot.isOnCooldown()) {
      ...
      obj5.children = closure_11(guildBoostSlot(4718).Text, obj6);
      tmp6Result2 = closure_11(guildBoostSlot(5292).PressableOpacity, obj5);
    }
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      if (found.length > 0) {
        ...
        const items3 = [
          closure_11(tmp3(4718).Text, obj7),
          found.map((guildId) =>
