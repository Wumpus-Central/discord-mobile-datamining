...
let closure_13 = createStyles.createStyles((arg0) => {
  let headerComponent = { container: null, headerComponent: null, image: null, title: null, description: null, button: null, imageContainer: null, imageOverlayText: null, imageOverlayTextContainer: null, pillTextContainer: null };
  headerComponent = { backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH, borderRadius: nativeDefault.radii.sm, width: frozen[arg0].width };
  const merged = Object.assign(nativeDefault.shadows.SHADOW_LOW);
  headerComponent.container = headerComponent;
  headerComponent = { width: "100%", borderTopLeftRadius: nativeDefault.radii.sm, borderTopRightRadius: nativeDefault.radii.sm, overflow: "hidden" };
  headerComponent.headerComponent = headerComponent;
  headerComponent.image = { width: "100%", borderTopLeftRadius: nativeDefault.radii.sm, borderTopRightRadius: nativeDefault.radii.sm };
  ...
  const obj1 = { width: "100%", borderTopLeftRadius: nativeDefault.radii.sm, borderTopRightRadius: nativeDefault.radii.sm };
  ...
  headerComponent.imageOverlayTextContainer = { position: "absolute", bottom: "10%", borderRadius: nativeDefault.radii.round, backgroundColor: nativeDefault.colors.BACKGROUND_MOD_STRONG, paddingHorizontal: 12, paddingVertical: 4, justifyContent: "center", alignItems: "center" };
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  customProfile = { customProfile: null, clientThemes: null, serverBoosts: null, greyServerBoosts: null, customAppIcons: null, emoji: null, customSounds: null, sticker: null, earlyAccess: null, memberPricing: null, largeUploads: null, hdVideo: null, superReactions: null, entranceSounds: null, badge: null, greyBadge: null, xboxGamePass: null };
  ...
  customProfile.imageSrc = _modDef13485;
  ...
  obj10.title = intl22.formatToPlainString(subscriptionPlansLoaded(1114).t.jqhAdL, { premiumMaxSize: maxFileSizeForPremiumType });
  const intl23 = subscriptionPlansLoaded(1114).intl;
  obj10.description = intl23.formatToPlainString(subscriptionPlansLoaded(1114).t["HI+cfm"], { premiumMaxSize: maxFileSizeForPremiumType });
  obj10.imageSrc = _modDef13495;
  ...
  obj16.imageSrc = { uri: _modDef13501 };
  ...
  obj16.bodyComponent = closure_9(subscriptionPlansLoaded(4632).Text, obj18);
