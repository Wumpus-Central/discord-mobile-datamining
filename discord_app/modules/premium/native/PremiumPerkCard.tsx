...
import _modDef13502 from "../../../../discord_assets/assets/images/perks/xbox_game_pass.jpg.js";
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj14.title = intl22.formatToPlainString(subscriptionPlansLoaded(1114).t.jqhAdL, {
    premiumMaxSize: maxFileSizeForPremiumType,
  });
  const intl23 = subscriptionPlansLoaded(1114).intl;
  obj14.description = intl23.formatToPlainString(subscriptionPlansLoaded(1114).t["HI+cfm"], {
    premiumMaxSize: maxFileSizeForPremiumType,
  });
