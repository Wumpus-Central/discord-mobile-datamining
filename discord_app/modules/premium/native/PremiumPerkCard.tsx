...
import registerAssetDefault from "../../../../_runtime/13046_registerAsset.js";
import registerAssetDefault2 from "../../../../_runtime/13047_registerAsset.js";
import registerAssetDefault3 from "../../../../_runtime/13048_registerAsset.js";
import registerAssetDefault4 from "../../../../_runtime/13049_registerAsset.js";
import registerAssetDefault5 from "../../../../_runtime/13050_registerAsset.js";
import registerAssetDefault6 from "../../../../_runtime/13051_registerAsset.js";
import registerAssetDefault7 from "../../../../_runtime/13052_registerAsset.js";
import registerAssetDefault8 from "../../../../_runtime/13053_registerAsset.js";
import registerAssetDefault9 from "../../../../_runtime/13054_registerAsset.js";
import registerAssetDefault10 from "../../../../_runtime/13055_registerAsset.js";
import registerAssetDefault11 from "../../../../_runtime/13056_registerAsset.js";
import registerAssetDefault12 from "../../../../_runtime/13057_registerAsset.js";
import registerAssetDefault13 from "../../../../_runtime/13058_registerAsset.js";
import registerAssetDefault14 from "../../../../_runtime/13059_registerAsset.js";
import registerAssetDefault15 from "../../../../_runtime/13060_registerAsset.js";
import registerAssetDefault16 from "../../../../_runtime/13061_registerAsset.js";
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj2[2] = imageStyle;
      imageSrc = callback(tmp6(4444).Text, obj2);
      obj1[1] = imageSrc;
    ...
    if (null != description) {
      ...
      obj4[1] = description;
      let tmp21 = callback(tmp6(4444).Text, obj4);
    } else {
      tmp21 = null;
    ...
    obj8[0] = items5;
    obj8[3] = title;
    items4[2] = callback(tmp6(4444).Text, obj8);
    ...
    if (tmp29Result) {
      ...
      obj10[1] = tmp29(tmp6(4896).Button, obj11);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[3] = callback(subscriptionPlansLoaded(4444).Text, obj18);
  obj[16] = obj16;
  return obj;
};