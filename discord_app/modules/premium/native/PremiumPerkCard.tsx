...
import registerAssetDefault from "../../../../_runtime/12970_registerAsset.js";
import registerAssetDefault2 from "../../../../_runtime/12971_registerAsset.js";
import registerAssetDefault3 from "../../../../_runtime/12972_registerAsset.js";
import registerAssetDefault4 from "../../../../_runtime/12973_registerAsset.js";
import registerAssetDefault5 from "../../../../_runtime/12974_registerAsset.js";
import registerAssetDefault6 from "../../../../_runtime/12975_registerAsset.js";
import registerAssetDefault7 from "../../../../_runtime/12976_registerAsset.js";
import registerAssetDefault8 from "../../../../_runtime/12977_registerAsset.js";
import registerAssetDefault9 from "../../../../_runtime/12978_registerAsset.js";
import registerAssetDefault10 from "../../../../_runtime/12979_registerAsset.js";
import registerAssetDefault11 from "../../../../_runtime/12980_registerAsset.js";
import registerAssetDefault12 from "../../../../_runtime/12981_registerAsset.js";
import registerAssetDefault13 from "../../../../_runtime/12982_registerAsset.js";
import registerAssetDefault14 from "../../../../_runtime/12983_registerAsset.js";
import registerAssetDefault15 from "../../../../_runtime/12984_registerAsset.js";
import registerAssetDefault16 from "../../../../_runtime/12985_registerAsset.js";
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj2[2] = imageStyle;
      imageSrc = callback(tmp6(4440).Text, obj2);
      obj1[1] = imageSrc;
    ...
    if (null != description) {
      ...
      obj4[1] = description;
      let tmp21 = callback(tmp6(4440).Text, obj4);
    } else {
      tmp21 = null;
    ...
    obj8[0] = items5;
    obj8[3] = title;
    items4[2] = callback(tmp6(4440).Text, obj8);
    ...
    if (tmp29Result) {
      ...
      obj10[1] = tmp29(tmp6(4879).Button, obj11);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[3] = callback(subscriptionPlansLoaded(4440).Text, obj18);
  obj[16] = obj16;
  return obj;
};