...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  customProfile.imageSrc = _modDef13452;
  ...
  obj16.imageSrc = { uri: _modDef13468 };
  ...
  obj16.bodyComponent = closure_9(subscriptionPlansLoaded(4602).Text, obj18);
