...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    ...
    if (tmp26) {
      ...
      tmp26 = callback(importDefault(12615), obj7);
    }
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[1] = { uri: importDefault(12614) };
  ...
  const obj17 = { uri: importDefault(12614) };
