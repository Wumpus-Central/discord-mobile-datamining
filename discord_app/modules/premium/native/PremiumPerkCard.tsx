...
import registerAssetDefault from "../../../../_runtime/12896_registerAsset.js";
import registerAssetDefault2 from "../../../../_runtime/12897_registerAsset.js";
import registerAssetDefault3 from "../../../../_runtime/12898_registerAsset.js";
import registerAssetDefault4 from "../../../../_runtime/12899_registerAsset.js";
import registerAssetDefault5 from "../../../../_runtime/12900_registerAsset.js";
import registerAssetDefault6 from "../../../../_runtime/12901_registerAsset.js";
import registerAssetDefault7 from "../../../../_runtime/12902_registerAsset.js";
import registerAssetDefault8 from "../../../../_runtime/12903_registerAsset.js";
import registerAssetDefault9 from "../../../../_runtime/12904_registerAsset.js";
import registerAssetDefault10 from "../../../../_runtime/12905_registerAsset.js";
import registerAssetDefault11 from "../../../../_runtime/12906_registerAsset.js";
import registerAssetDefault12 from "../../../../_runtime/12907_registerAsset.js";
import registerAssetDefault13 from "../../../../_runtime/12908_registerAsset.js";
import registerAssetDefault14 from "../../../../_runtime/12909_registerAsset.js";
import registerAssetDefault15 from "../../../../_runtime/12910_registerAsset.js";
import registerAssetDefault16 from "../../../../_runtime/12911_registerAsset.js";
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj2[2] = imageStyle;
      imageSrc = callback(tmp6(4376).Text, obj2);
      obj1[1] = imageSrc;
    ...
    if (null != description) {
      ...
      obj4[1] = description;
      let tmp21 = callback(tmp6(4376).Text, obj4);
    } else {
      tmp21 = null;
    ...
    obj8[0] = items5;
    obj8[3] = title;
    items4[2] = callback(tmp6(4376).Text, obj8);
    ...
    if (tmp29Result) {
      ...
      obj10[1] = tmp29(tmp6(4815).Button, obj11);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[3] = callback(subscriptionPlansLoaded(4376).Text, obj18);
  obj[16] = obj16;
  return obj;
};