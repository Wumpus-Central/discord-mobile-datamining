...
import { registerAsset } from "../../../../_runtime/12623_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12624_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12625_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12626_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12627_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12628_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12629_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12630_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12631_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12632_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12633_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12634_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12635_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12636_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12637_registerAsset.js";
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj2[2] = imageStyle;
      imageSrc = callback(tmp6(4298).Text, obj2);
      obj1[1] = imageSrc;
    ...
    if (null != description) {
      ...
      obj4[1] = description;
      let tmp21 = callback(tmp6(4298).Text, obj4);
    } else {
      tmp21 = null;
    ...
    obj8[0] = items5;
    obj8[3] = title;
    items4[2] = callback(tmp6(4298).Text, obj8);
    ...
    if (tmp29Result) {
      ...
      obj10[1] = tmp29(tmp6(4712).Button, obj11);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  obj16[3] = callback(subscriptionPlansLoaded(4298).Text, obj18);
  obj[16] = obj16;
  return obj;
};