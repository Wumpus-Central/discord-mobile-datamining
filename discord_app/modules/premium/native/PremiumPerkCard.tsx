...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  let customProfile = subscriptionPlansLoaded(13421);
  ...
  customProfile.imageSrc = _modDef13422;
  ...
  obj16.imageSrc = { uri: _modDef13438 };
