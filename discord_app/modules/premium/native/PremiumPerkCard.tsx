...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  customProfile.imageSrc = _modDef13445;
  ...
  obj16.imageSrc = { uri: _modDef13461 };
  ...
  obj16.bodyComponent = closure_9(subscriptionPlansLoaded(4570).Text, obj18);
