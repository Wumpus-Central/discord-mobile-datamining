...
import registerAssetDefault from "registerAsset" /* 12854 */;
import registerAssetDefault2 from "registerAsset" /* 12855 */;
import registerAssetDefault3 from "registerAsset" /* 12856 */;
import registerAssetDefault4 from "registerAsset" /* 12857 */;
import registerAssetDefault5 from "registerAsset" /* 12858 */;
import registerAssetDefault6 from "registerAsset" /* 12859 */;
import registerAssetDefault7 from "registerAsset" /* 12860 */;
import registerAssetDefault8 from "registerAsset" /* 12861 */;
import registerAssetDefault9 from "registerAsset" /* 12862 */;
import registerAssetDefault10 from "registerAsset" /* 12863 */;
import registerAssetDefault11 from "registerAsset" /* 12864 */;
import registerAssetDefault12 from "registerAsset" /* 12865 */;
import registerAssetDefault13 from "registerAsset" /* 12866 */;
import registerAssetDefault14 from "registerAsset" /* 12867 */;
import registerAssetDefault15 from "registerAsset" /* 12868 */;
import registerAssetDefault16 from "registerAsset" /* 12869 */;
import metadataDefault from "metadata" /* 12870 */;
import PillTextDefault from "PillText" /* 12871 */;
...
export default function PremiumPerkCard(variant) {
  ...
  if (null != imageSrc) {
    if (null != imageOverlayText) {
      ...
      obj2[2] = imageStyle;
      imageSrc = callback(tmp6(4734).Text, obj2);
      obj1[1] = imageSrc;
    ...
    if (null != description) {
      ...
      obj4[1] = description;
      let tmp21 = callback(tmp6(4734).Text, obj4);
    } else {
      tmp21 = null;
    ...
    obj8[0] = items5;
    obj8[3] = title;
    items4[2] = callback(tmp6(4734).Text, obj8);
    ...
    if (tmp29Result) {
      ...
      obj10[1] = tmp29(tmp6(4745).Button, obj11);
...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  const callback = React.useCallback(() => {
    obj = subscriptionPlansLoaded(7360);
