...
export const usePremiumPerkCard = function usePremiumPerkCard() {
  ...
  customProfile.imageSrc = _modDef13494;
  ...
  obj16.imageSrc = { uri: _modDef13510 };
  ...
  obj16.bodyComponent = closure_9(subscriptionPlansLoaded(4601).Text, obj18);
