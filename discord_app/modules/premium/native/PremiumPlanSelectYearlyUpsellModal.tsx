...
const result = require("obj132").fileFinishedImporting("modules/premium/native/PremiumPlanSelectYearlyUpsellModal.tsx");
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj2[0] = tmp.header;
    const intl = productId(1236).intl;
    obj3 = { discountPercentage: null, planName: null };
    obj3[0] = formatPercentResult;
    tmp5Result = productId(4039);
    obj3[1] = tmp5Result.getPremiumTypeDisplayName(premiumTier);
    obj2[2] = intl.format(productId(1236).t.LQCVfK, obj3);
    items2[1] = callback2(productId(1297).LegacyText, obj2);
    const obj4 = { style: null, children: null };
    obj4[0] = tmp.description;
    const intl2 = productId(1236).intl;
    const obj5 = { discountPercentage: null };
    obj5[0] = formatPercentResult;
    obj4[1] = intl2.format(productId(1236).t["7chOVL"], obj5);
    items2[2] = callback2(productId(1297).LegacyText, obj4);
    const obj6 = { style: null, children: null };
    obj6[0] = tmp.upsellButton;
    const obj7 = { variant: "active", text: null, onPress: null, disabled: null, loading: null };
    const intl3 = productId(1236).intl;
    const obj8 = { price: null };
    obj8[0] = orderPriceString;
    obj7[1] = intl3.formatToPlainString(productId(1236).t.Qvq6GE, obj8);
    ...
    obj6[1] = callback2(productId(4745).Button, obj7);
    ...
    const intl4 = productId(1236).intl;
    obj10[1] = intl4.string(productId(1236).t.YwEyQM);
    ...
    obj9[1] = callback2(productId(4745).Button, obj10);
    items2[4] = callback2(closure_6, obj9);
    const obj11 = { style: null, children: null };
    obj11[0] = tmp.cancelButton;
    const obj12 = { variant: "tertiary", text: null, onPress: null };
    const intl5 = productId(1236).intl;
    obj12[1] = intl5.string(productId(1236).t.cpT0Cq);
    obj12[2] = onClose;
    obj11[1] = callback2(productId(4745).Button, obj12);
