...
createStyles.color = fn(5491).DARK_WHITE_500_LIGHT_BLACK_500;
createStyles.header = createStyles;
createStyles.description = { alignSelf: "center", textAlign: "center", paddingBottom: 32, color: fn(5491).DARK_WHITE_500_LIGHT_BLACK_500 };
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj1 = { style: tmp.image, source: _modDef13629 };
    ...
    obj6.children = closure_11(productId(5025).Button, obj7);
    ...
    obj9.children = closure_11(productId(5025).Button, obj10);
    ...
    obj11.children = closure_11(productId(5025).Button, obj12);
