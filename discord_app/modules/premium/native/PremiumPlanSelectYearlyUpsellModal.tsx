...
obj2.description = {
  ...
  textAlign: "center",
  paddingBottom: 32,
  color: fn(5529).DARK_WHITE_500_LIGHT_BLACK_500,
};
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj12.children = closure_11(productId(5062).Button, obj13);
    ...
    obj15.children = closure_11(productId(5062).Button, obj16);
    ...
    obj17.children = closure_11(productId(5062).Button, obj18);
