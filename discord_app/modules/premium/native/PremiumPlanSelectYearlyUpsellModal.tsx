...
obj2.description = {
  ...
  textAlign: "center",
  paddingBottom: 32,
  color: fn(5744).DARK_WHITE_500_LIGHT_BLACK_500,
};
...
export default function PremiumPlanSelectYearlyUpsellModal(arg0) {
  ...
  if (null == premiumTier || null == orderPriceString) {
    ...
    obj9.planName = productId(4481).getPremiumTypeDisplayName(premiumTier);
    ...
    obj12.children = closure_11(productId(5271).Button, obj13);
    ...
    obj15.children = closure_11(productId(5271).Button, obj16);
    ...
    obj17.children = closure_11(productId(5271).Button, obj18);
