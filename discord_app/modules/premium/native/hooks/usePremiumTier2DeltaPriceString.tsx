          ...
          if (currencyCode.currencyCode !== stateFromStores.currencyCode) {
            ...
            if (diff > 0) {
              if (diff < currencyCode.price) {
                ...
                obj1 = { priceString: tmp4(7286).formatPrice(result, currencyCode.currencyCode, { convertToMajorUnits: false }), failure: null };
                obj2 = obj1;
      ...
      if (null == availablePlanForItems) {
        ...
        if (null != addOnPrice) {
          if (addOnPrice.majorUnits > 0) {
              ...
              if (null != tmp17) {
                if (0 !== tmp17.numPremiumGuild) {
                  ...
                  if (null != addOnPrice1) {
                    ...
                    if (diff1 > 0) {
                      const obj4 = { priceString: tmp4(7286).formatPrice(diff1, addOnPrice.currency, { convertToMajorUnits: false }), failure: null };
            ...
            const obj5 = { priceString: tmp4(7286).formatPrice(addOnPrice.majorUnits, addOnPrice.currency, { convertToMajorUnits: false }), failure: null };
