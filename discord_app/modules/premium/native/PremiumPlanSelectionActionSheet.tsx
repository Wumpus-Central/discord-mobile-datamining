...
function PlanOption(premiumItem) {
  ...
  if (null != checkoutPlanDiscountPrices) {
    formatRateResult = tmp4(7567).formatRate(
  ...
  if (!tmp14) {
    ...
    if (null != formatRateResult) {
      ...
      if (null != discountOffer) {
        ...
        if (null == premiumItem.selectedPremiumType) {
          ...
          tmp33Result4 = closure_35(tmp4(4825).Text, obj19);
        }
      }
    }
    ...
    if (tmp33Result5) {
      ...
      tmp33Result5 = closure_35(tmp4(4825).Text, obj21);
    }
    ...
    closure_35(tmp4(4825).Text, obj23);
  }
  formatRateResult1 = premiumItem(7567).formatRate(
    regularPrice,
                    ...
                    value: closure_2_14(
                      find.map((planId) => {
                        ...
                        obj.sku_id = obj2.castPremiumSubscriptionAsSkuId(
                          closure_1_1(4483).getSkuIdForPlan(planId.planId),
                        );
