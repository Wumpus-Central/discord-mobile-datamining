...
function PlanOption(premiumItem) {
  ...
  formatRateResult1 = premiumItem(7234).formatRate(regularPrice, dependencyMap[premiumItem.basePlanId].interval, dependencyMap[premiumItem.basePlanId].intervalCount);
}
