...
import useIsEligibleForBogoOffer from "useIsEligibleForBogoOffer" /* 10777 */;
...
function PlanOption(premiumItem) {
  ...
  if (tmp14) {
    ...
    obj = { price: tmp4(7286).formatPrice(0, USD, { minimumFractionDigits: 0, maximumFractionDigits: 0 }) };
  ...
  const tmp4Result2 = premiumItem(7286);
  if (first > 0) {
  ...
  const items3 = [closure_35(premiumItem(4601).Text, obj4), ];
  ...
  items4[1] = closure_35(premiumItem(4601).Text, obj10);
  ...
  if (!tmp14) {
    ...
    if (null != formatRateResult) {
      ...
      if (null != discountOffer) {
        ...
        if (null == premiumItem.selectedPremiumType) {
          ...
          tmp33Result = closure_35(tmp4(4601).Text, obj12);
        }
      }
    }
    ...
    if (tmp33Result1) {
      ...
      tmp33Result1 = closure_35(tmp4(4601).Text, obj14);
    }
    ...
    closure_35(tmp4(4601).Text, obj16);
  }
  formatRateResult1 = premiumItem(7286).formatRate(regularPrice, dependencyMap[premiumItem.basePlanId].interval, dependencyMap[premiumItem.basePlanId].intervalCount);
}
