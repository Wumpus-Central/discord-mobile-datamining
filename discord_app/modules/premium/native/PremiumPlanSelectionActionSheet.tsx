...
import useIsEligibleForBogoOffer from "useIsEligibleForBogoOffer" /* 10950 */;
...
function PlanOption(premiumItem) {
  ...
  formatRateResult1 = premiumItem(7430).formatRate(regularPrice, dependencyMap[premiumItem.basePlanId].interval, dependencyMap[premiumItem.basePlanId].intervalCount);
}
