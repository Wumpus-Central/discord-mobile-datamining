...
import useIsEligibleForBogoOffer from "useIsEligibleForBogoOffer" /* 10739 */;
...
function PlanOption(premiumItem) {
  ...
  if (tmp14) {
    ...
    obj = { price: tmp4(7248).formatPrice(0, USD, { minimumFractionDigits: 0, maximumFractionDigits: 0 }) };
  ...
  const tmp4Result2 = premiumItem(7248);
  if (first > 0) {
  ...
  const items3 = [closure_35(premiumItem(4570).Text, obj4), ];
  ...
  items4[1] = closure_35(premiumItem(4570).Text, obj10);
  ...
  if (!tmp14) {
    ...
    if (null != formatRateResult) {
      ...
      if (null != discountOffer) {
        ...
        if (null == premiumItem.selectedPremiumType) {
          ...
          tmp33Result = closure_35(tmp4(4570).Text, obj12);
        }
      }
    }
    ...
    if (tmp33Result1) {
      ...
      tmp33Result1 = closure_35(tmp4(4570).Text, obj14);
    }
    ...
    closure_35(tmp4(4570).Text, obj16);
  }
  formatRateResult1 = premiumItem(7248).formatRate(regularPrice, dependencyMap[premiumItem.basePlanId].interval, dependencyMap[premiumItem.basePlanId].intervalCount);
}
