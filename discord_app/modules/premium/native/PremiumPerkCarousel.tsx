...
// Module 13459 (PremiumPerkCarousel)
import PremiumPerkCard from "PremiumPerkCard" /* 13416 */;
...
export default function PremiumPerkCarousel(arg0) {
  ...
  const obj1 = {
    ...
    pageIndictor: false,
    scrollViewProps: { overScrollMode: "always", snapToInterval: width + 8 + 0.2, snapToStart: true, snapToAlignment: "start", decelerationRate: "normal" },
