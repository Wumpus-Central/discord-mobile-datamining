...
export const reset = function reset() {
  ...
  batchUpdates.batchUpdates(() => {
    ...
    outer1_6.setState({ productId: "", initiatedPurchaseFromNewFlow: false, isPaymentSuccess: false, mobileWebRedirectCheckoutStatus: str, onPaymentSuccess: "disabled", onPaymentDismiss: "r" });
  });
};