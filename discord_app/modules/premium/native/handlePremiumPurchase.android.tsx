    ...
    if (1 === tmp10) {
        ...
        closure_130_20 = (function getOfferId(arg0, arg1, arg2, dependencyMap, offerIds) {
          ...
          if (null != offerIds) {
            if (null != arg2) {
              ...
              const tmp9 = premiumSubscription(7354).DiscountIdToProductOfferId[dependencyMap.discountId];
              let tmp10;
              if (tmp9 != null) {
                tmp10 = tmp9[arg0];
              }
          ...
          if (arg1) {
            ...
            if (arg0 === premiumSubscription(7354).ProductIds.PREMIUM_TIER_2_MONTHLY) {
              BOGO_OFFER_ID = premiumSubscription(7354).BOGO_OFFER_ID;
            }
          }
      ...
      (function showPurchaseErrorModal(combined) {
        ...
        if (!(combined instanceof premiumSubscription(4540).BillingError)) {
          billingError = new premiumSubscription(4540).BillingError(combined);
        }
        if (tmpResult.isSpendingLimitError(billingError)) {
          const result = premiumSubscription(10854).showSpendingLimitReachedAlert();
          const tmpResult2 = premiumSubscription(10854);
        } else {
          const intl = premiumSubscription(1115).intl;
          let tmp8 = billingError.code !== premiumSubscription(4319).ErrorCodes.UNKNOWN;
          if (tmp8) {
        ...
        tmpResult = premiumSubscription(10854);
      })(closure_130_23);
