        ...
        if (0 === c6) {
          ...
          if (1 === tmp10) {
            if (premiumSubscription === 1) {
              ...
              let obj2 = { isGift: closure_130_6, analyticsLoadId: closure_130_2, analyticsLocation: closure_130_3, analyticsLocations: closure_130_4 };
              basePurchaseFlowAnalyticsFields = premiumSubscription(premiumDiscountOffer[21]).getBasePurchaseFlowAnalyticsFields(obj2);
