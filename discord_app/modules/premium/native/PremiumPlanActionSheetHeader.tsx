...
import _modDef6848 from "../../../../_runtime/metro/06848__.js";
import _modDef6849 from "../../../../_runtime/metro/06849__.js";
import _modDef6850 from "../../../../_runtime/metro/06850__.js";
import _modDef6851 from "../../../../_runtime/metro/06851__.js";
...
import _modDef8685 from "../../../../_runtime/metro/08685__.js";
...
export default function PremiumPlanActionSheetHeader(arg0) {
  ...
  if (!tmp13Result) {
    ...
    if (TIER_0.TIER_0 === premiumType) {
      let tmp13Result8 = _modDef6850;
    } else if (TIER_0.TIER_1 === premiumType) {
      tmp13Result8 = _modDef6851;
    } else if (TIER_0.TIER_2 === premiumType) {
      tmp13Result8 = _modDef6852;
    }
    ...
    if (TIER_0.TIER_0 === premiumType) {
      let tmp13Result10 = _modDef8680;
    } else if (TIER_0.TIER_1 === premiumType) {
      tmp13Result10 = _modDef10167;
    } else if (TIER_0.TIER_2 === premiumType) {
      tmp13Result10 = _modDef8685;
    }
    ...
    if (TIER_0.TIER_0 === premiumType) {
      let tmp13Result12 = _modDef6848;
    } else {
      tmp13Result12 = null;
      if (TIER_0.TIER_1 !== premiumType) {
        if (TIER_0.TIER_2 === premiumType) {
          tmp13Result12 = _modDef6849;
        }
      }
    }
