// === Module 6792: PremiumPlanActionSheetHeader ===
...
export default function PremiumPlanActionSheetHeader(arg0) {
  ...
  require(3901) /* getPremiumPlanItem */;
  ...
  obj[6] = require(3901) /* getPremiumPlanItem */.getPremiumTypeDisplayName(premiumType);
  if (TIER_0.TIER_0 === premiumType) {
    let tmp13Result = tmp13(6794);
  } else {
    tmp13Result = null;
    if (tmp15.TIER_1 !== premiumType) {
      if (tmp15.TIER_2 === premiumType) {
        tmp13Result = tmp13(6795);
      }
    }
  }
  if (!tmp13Result) {
    ...
    tmp13Result = tmp13(5207);
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result1 = tmp13(6796);
    } else if (tmp15.TIER_1 === premiumType) {
      tmp13Result1 = tmp13(6797);
    } else if (tmp15.TIER_2 === premiumType) {
      tmp13Result1 = tmp13(6798);
    }
    ...
    if (tmp2) {
      ...
      obj2[1] = trialOffer;
      obj2[2] = premiumType;
      tmp22Result = tmp22(tmp6(6799).PremiumPill, obj2);
    }
    ...
    if (tmp10) {
      ...
      obj3[2] = premiumType;
      tmp22Result = tmp22(tmp6(6799).PremiumPill, obj3);
    }
    items1[2] = tmp22Result;
    obj[1] = items1;
    items[1] = tmp12(View, obj);
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result3 = tmp13(7239);
    } else if (tmp15.TIER_1 === premiumType) {
      tmp13Result3 = tmp13(7240);
    } else if (tmp15.TIER_2 === premiumType) {
      tmp13Result3 = tmp13(7241);
    }
    ...
    tmp13Result2 = tmp13(5207);
    const tmp21 = View;
  } else {
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result5 = tmp13(6794);
    } else {
      tmp13Result5 = null;
      if (tmp15.TIER_1 !== premiumType) {
        if (tmp15.TIER_2 === premiumType) {
          tmp13Result5 = tmp13(6795);
        }
      }
    }
    const obj5 = { source: null };
    obj5[0] = tmp13Result5;
    closure_7(tmp13(5207), obj5);
    const tmp13Result4 = tmp13(5207);
