...
export default function PremiumPlanActionSheetHeader(arg0) {
  ...
  require(3931) /* getPremiumPlanItem */;
  ...
  obj[6] = require(3931) /* getPremiumPlanItem */.getPremiumTypeDisplayName(premiumType);
  ...
  if (!tmp13Result) {
    ...
    tmp13Result = tmp13(5236);
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result1 = tmp13(6808);
    } else if (tmp15.TIER_1 === premiumType) {
      tmp13Result1 = tmp13(6809);
    } else if (tmp15.TIER_2 === premiumType) {
      tmp13Result1 = tmp13(6810);
    }
    ...
    if (tmp2) {
      ...
      obj2[1] = trialOffer;
      obj2[2] = premiumType;
      tmp22Result = tmp22(tmp6(6811).PremiumPill, obj2);
    }
    ...
    if (tmp10) {
      ...
      obj3[2] = premiumType;
      tmp22Result = tmp22(tmp6(6811).PremiumPill, obj3);
    }
    items1[2] = tmp22Result;
    obj[1] = items1;
    items[1] = tmp12(View, obj);
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result3 = tmp13(7251);
    } else if (tmp15.TIER_1 === premiumType) {
      tmp13Result3 = tmp13(7252);
    } else if (tmp15.TIER_2 === premiumType) {
      tmp13Result3 = tmp13(7253);
    }
    ...
    tmp13Result2 = tmp13(5236);
    const tmp21 = View;
  } else {
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result5 = tmp13(6806);
    } else {
      tmp13Result5 = null;
      if (tmp15.TIER_1 !== premiumType) {
        if (tmp15.TIER_2 === premiumType) {
          tmp13Result5 = tmp13(6807);
        }
      }
    }
    const obj5 = { source: null };
    obj5[0] = tmp13Result5;
    closure_7(tmp13(5236), obj5);
    const tmp13Result4 = tmp13(5236);
