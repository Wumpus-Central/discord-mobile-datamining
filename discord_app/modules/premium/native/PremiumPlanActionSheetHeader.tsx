// === Module 7185: PremiumPlanActionSheetHeader ===
...
import { getPremiumGradientColor } from "items" /* 7186 */;
...
export default function PremiumPlanActionSheetHeader(arg0) {
  ...
  if (!tmp13Result) {
    ...
    tmp13Result = tmp13(5501);
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result1 = tmp13(7189);
    } else if (tmp15.TIER_1 === premiumType) {
      tmp13Result1 = tmp13(7190);
    ...
    if (tmp2) {
      ...
      obj2[1] = trialOffer;
      obj2[2] = premiumType;
      tmp22Result = tmp22(tmp6(7192).PremiumPill, obj2);
    }
    ...
    if (tmp10) {
      ...
      obj3[2] = premiumType;
      tmp22Result = tmp22(tmp6(7192).PremiumPill, obj3);
    }
    items1[2] = tmp22Result;
    obj[1] = items1;
    items[1] = tmp12(View, obj);
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result3 = tmp13(8365);
    } else if (tmp15.TIER_1 === premiumType) {
      tmp13Result3 = tmp13(10713);
    } else if (tmp15.TIER_2 === premiumType) {
      tmp13Result3 = tmp13(8370);
    }
    ...
    tmp13Result2 = tmp13(5501);
    const tmp21 = View;
  } else {
    if (tmp15.TIER_0 === premiumType) {
      let tmp13Result5 = tmp13(7187);
    } else {
      tmp13Result5 = null;
      if (tmp15.TIER_1 !== premiumType) {
        if (tmp15.TIER_2 === premiumType) {
          tmp13Result5 = tmp13(7188);
        }
      }
    }
    const obj5 = { source: null };
    obj5[0] = tmp13Result5;
    closure_7(tmp13(5501), obj5);
    const tmp13Result4 = tmp13(5501);
