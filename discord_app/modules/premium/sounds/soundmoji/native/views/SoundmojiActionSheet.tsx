// === Module 12191: SoundmojiActionSheet ===

// Module 12191 (SoundmojiActionSheet)
import nativeDefault from "native" /* 576 */;
import getSoundmojiASTFromString from "getSoundmojiASTFromString" /* 5224 */;
...
export default function SoundmojiActionSheet(guildId) {
  ...
  if (null != memo) {
    ...
    if (tmp4Result) {
      ...
      obj4.name = str;
      tmp4Result = closure_5(channelId(tmp6[8]), obj4);
    ...
    tmp4Result2 = closure_5(guildId(messageId[7]).BottomSheet, obj);
  }
  return tmp4Result2;
};