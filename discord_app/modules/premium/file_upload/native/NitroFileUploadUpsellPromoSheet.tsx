...
export default function NitroFileUploadUpsellPromoSheet(markAsDismissed) {
  ...
  obj.title = intl.string(require("module_2496")["Uty2/X"]);
  const intl2 = markAsDismissed(callback[11]).intl;
  obj.description = intl2.string(require("module_2496").VAgI8Q);
  ...
  obj1.text = intl3.string(require("module_2496").mRy6sO);
