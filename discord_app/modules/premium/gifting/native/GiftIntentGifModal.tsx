  ...
  if (c4 === 2) {
    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            if (closure_129_4) {
              ...
              let obj7 = closure_130_1(closure_130_2[11]);
              let obj2 = { location: closure_130_9.GIFTING };
              c3 = 2;
              c4 = 1;
              let obj3 = { value: obj6.sendMessage(id2, obj7.parse(closure_129_0, closure_129_2), true, obj2), done: false };
              return obj3;
            }
          }
        } else if (2 === tmp5) {
        ...
        c3 = 3;
        c4 = 1;
        obj7 = { value: obj2.sendMessage(id, obj3.parse(closure_129_0, closure_129_3.url), true, obj6), done: false };
        return obj7;
      }
    } catch (tmp33) {
      c4 = tmp;
...
function GiftIntentGifModalBody(channelId) {
  ...
  const obj3 = { bottomSheetRef: gif.useRef(null), channelId, guildId: null, initialQuery: null, inActionSheet: false, contentHorizontalPadding: null, selectedGifSrc: null, keyboardDismissMode: "on-drag", onPressGIF: null };
  let guild_id;
...
createStyles.messageContainer = { paddingHorizontal: nativeDefault.space.PX_16, paddingBottom: nativeDefault.space.PX_8 };
...
createStyles.footer = { gap: nativeDefault.space.PX_8, paddingHorizontal: nativeDefault.space.PX_16, paddingTop: nativeDefault.space.PX_8 };
