...
import _modDef16979 from "../../../../../../discord_assets/assets/gifting/new_gifting_badges.png.js";
...
function HasBadgeCoachmark(markAsDismissed) {
  ...
  const items3 = [closure_8(markAsDismissed(4570).Text, obj3)];
  ...
  obj5.children = closure_8(markAsDismissed(4989).Button, obj6);
...
function NewBadgeCoachmark(markAsDismissed) {
  ...
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.graphicContainer, children: null };
  const obj1 = { source: { uri: _modDef16979 }, style: tmp.newBadgeImage };
  ...
  const items3 = [closure_8(markAsDismissed(4570).Text, obj4)];
  ...
  items3[1] = closure_8(markAsDismissed(4570).Text, obj5);
  ...
  obj7.icon = closure_8(markAsDismissed(11062).GiftIcon, {
    size: "sm",
    color: nativeDefault.colors.CONTROL_PRIMARY_TEXT_DEFAULT,
  });
  obj7.onPress = callback;
  obj6.children = closure_8(markAsDismissed(4989).Button, obj7);
