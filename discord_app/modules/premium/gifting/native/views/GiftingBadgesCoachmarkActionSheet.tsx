...
import _modDef17148 from "../../../../../../discord_assets/assets/gifting/new_gifting_badges.png.js";
...
function HasBadgeCoachmark(markAsDismissed) {
  ...
  const isGiftingBadgeComplexArtEnabled = markAsDismissed(10888).useIsGiftingBadgeComplexArtEnabled(
    "GiftingBadgesCoachmarkActionSheet",
  );
  let obj = markAsDismissed(10888);
  const giftingBadgeTierIconUrl = markAsDismissed(10888).getGiftingBadgeTierIconUrl(
    currentTier,
...
function NewBadgeCoachmark(markAsDismissed) {
  ...
  obj10.icon = closure_8(markAsDismissed(11183).GiftIcon, {
    size: "sm",
