...
import _modDef17188 from "../../../../../../discord_assets/assets/gifting/new_gifting_badges.png.js";
...
function HasBadgeCoachmark(markAsDismissed) {
  ...
  const isGiftingBadgeComplexArtEnabled = markAsDismissed(10896).useIsGiftingBadgeComplexArtEnabled(
    "GiftingBadgesCoachmarkActionSheet",
  );
  let obj = markAsDismissed(10896);
  const giftingBadgeTierIconUrl = markAsDismissed(10896).getGiftingBadgeTierIconUrl(
    currentTier,
...
function NewBadgeCoachmark(markAsDismissed) {
  ...
  obj10.icon = closure_8(markAsDismissed(11191).GiftIcon, {
    size: "sm",
