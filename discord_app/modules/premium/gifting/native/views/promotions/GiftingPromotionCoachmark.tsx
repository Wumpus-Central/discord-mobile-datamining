...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  let obj1 = markAsDismissed(10089);
  let asset;
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp18Result) {
        ...
        obj1[1] = tmp18(tmp2(4340).Text, obj2);
      ...
      obj6[2] = tmp16;
      items4[3] = tmp18(tmp2(4754).Button, obj6);
      obj[1] = items4;
      ...
      if (tmp2Result1.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj7[1] = tmp18(tmp2(9432).APNGPlayer, obj8);
