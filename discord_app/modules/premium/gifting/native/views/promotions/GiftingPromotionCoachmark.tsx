...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  analyticsLocations = analyticsLocations(5610)(analyticsLocations(5630).GIFTING_PROMOTION_COACHMARK).analyticsLocations;
