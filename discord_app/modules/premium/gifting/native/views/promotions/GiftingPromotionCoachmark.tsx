  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp19Result) {
        ...
        tmp19Result = closure_11(tmp11(11023), obj5);
      }
      ...
      const items5 = [closure_11(markAsDismissed(4753).Heading, obj7)];
      const obj8 = {
        style: tmp.text,
      ...
      items5[1] = closure_11(markAsDismissed(4753).Text, obj8);
      ...
      obj9.icon = closure_11(markAsDismissed(11305).GiftIcon, obj10);
      const intl = markAsDismissed(1115).intl;
      obj9.text = intl.string(markAsDismissed(1115).t.Ve9Ge6);
      obj9.onPress = tmp17;
      items4[3] = closure_11(markAsDismissed(5187).Button, obj9);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj11.children = closure_11(markAsDismissed(9094).APNGPlayer, obj12);
      ...
      tmp19Result4 = closure_11(tmp11(5806), obj13);
