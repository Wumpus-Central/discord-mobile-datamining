  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp18Result) {
        ...
        obj1[1] = tmp18(tmp2(4444).Text, obj2);
      ...
      if (tmp2Result1.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj8[1] = tmp18(tmp2(8485).APNGPlayer, obj9);
      ...
      tmp18Result1 = tmp18(tmp10(5461), obj10);
