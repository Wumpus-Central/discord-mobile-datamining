// === Module 17477: GiftingPromotionCoachmark ===
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const themeAndReducedMotionAwareAssetUrl = markAsDismissed(11095).useThemeAndReducedMotionAwareAssetUrl(asset);
  let obj2 = markAsDismissed(11095);
  ...
  const tickingFormattedLimitedOfferTimeLeft = markAsDismissed(11096).useTickingFormattedLimitedOfferTimeLeft(endDate);
  importDefault = tmp10;
  ...
  const tmp2Result3 = markAsDismissed(11096);
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp19Result) {
        ...
        tmp19Result = closure_11(tmp11(11099), obj5);
      }
      ...
      const items5 = [closure_11(markAsDismissed(4823).Heading, obj7), ];
      const obj8 = { style: tmp.text, variant: "text-md/normal", color: "text-subtle", children: coachmarkComponent.body };
      items5[1] = closure_11(markAsDismissed(4823).Text, obj8);
      ...
      obj9.icon = closure_11(markAsDismissed(11381).GiftIcon, obj10);
      const intl = markAsDismissed(1115).intl;
      obj9.text = intl.string(markAsDismissed(1115).t.Ve9Ge6);
      obj9.onPress = tmp17;
      items4[3] = closure_11(markAsDismissed(5271).Button, obj9);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj11.children = closure_11(markAsDismissed(9165).APNGPlayer, obj12);
      ...
      tmp19Result4 = closure_11(tmp11(5890), obj13);
