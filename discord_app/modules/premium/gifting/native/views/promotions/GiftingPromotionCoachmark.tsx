// === Module 17500: GiftingPromotionCoachmark ===
...
export default function GiftingPromotionCoachmarkActionSheet(arg0) {
  ...
  const themeAndReducedMotionAwareAssetUrl = markAsDismissed(11101).useThemeAndReducedMotionAwareAssetUrl(asset);
  let obj2 = markAsDismissed(11101);
  ...
  const tickingFormattedLimitedOfferTimeLeft = markAsDismissed(11102).useTickingFormattedLimitedOfferTimeLeft(endDate);
  importDefault = tmp10;
  ...
  const tmp2Result3 = markAsDismissed(11102);
  ...
  if (null != coachmarkComponent) {
    ...
    if (null == themeAndReducedMotionAwareAssetUrl) {
      ...
      if (tmp19Result) {
        ...
        tmp19Result = closure_11(tmp11(11105), obj5);
      }
      ...
      const items5 = [closure_11(markAsDismissed(4825).Heading, obj7), ];
      const obj8 = { style: tmp.text, variant: "text-md/normal", color: "text-subtle", children: coachmarkComponent.body };
      items5[1] = closure_11(markAsDismissed(4825).Text, obj8);
      ...
      obj9.icon = closure_11(markAsDismissed(11387).GiftIcon, obj10);
      const intl = markAsDismissed(1115).intl;
      obj9.text = intl.string(markAsDismissed(1115).t.Ve9Ge6);
      obj9.onPress = tmp17;
      items4[3] = closure_11(markAsDismissed(5273).Button, obj9);
      ...
      if (tmp2Result4.isAndroid()) {
        if (!stateFromStores) {
          ...
          obj11.children = closure_11(markAsDismissed(9169).APNGPlayer, obj12);
      ...
      tmp19Result4 = closure_11(tmp11(5892), obj13);
