...
createCacheKey[1] = {
  ...
  padding: ThemesDefault.space.PX_8,
  marginInlineEnd: ThemesDefault.space.PX_8,
};
...
const result = require("set").fileFinishedImporting(
  "modules/premium/gifting/native/views/GiftingBadgeProgressBanner.tsx",
);
...
export default function GiftingBadgeProgressBanner(arg0) {
  ...
  obj2[1] = intl.formatToPlainString(messagesProxyDefault["0+xfd9"], {
