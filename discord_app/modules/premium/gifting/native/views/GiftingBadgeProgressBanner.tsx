...
const createCacheKey = { flexDirection: "row", alignItems: "center", padding: ThemesDefault.space.PX_8, backgroundColor: ThemesDefault.colors.BACKGROUND_SURFACE_HIGH, borderRadius: ThemesDefault.radii.sm, borderWidth: 1, borderStyle: "solid", borderColor: ThemesDefault.colors.BORDER_MUTED };
...
const result = require("obj132").fileFinishedImporting("modules/premium/gifting/native/views/GiftingBadgeProgressBanner.tsx");
...
export default function GiftingBadgeProgressBanner(arg0) {
  ...
  if (tmp10Result) {
    ...
    obj1[0] = nextTierIcon;
    tmp10Result = callback(GiftingBadgeIconDefault, obj1);
  }
  obj[1] = tmp10Result;
