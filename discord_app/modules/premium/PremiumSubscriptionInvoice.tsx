// === Module 13343: PremiumSubscriptionInvoice ===
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          const obj2 = { items: null, payment_source_id: null, trial_id: null, code: null, apply_entitlements: null, currency: null, renewal: null, metadata: null, load_id: null };
        ...
        if (null != payment_sources) {
          ...
          const obj5 = { type: "SUBSCRIPTION_PREVIEW_CHECKOUT_CONTEXT_UPDATE", checkoutContext: closure_129_11.checkoutContext, paymentSourceId: closure_129_1 };
          obj.dispatch(obj5);
        }
        c4 = 0;
        c6 = 3;
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          const obj2 = { items: mapped, payment_source_id: closure_129_2, renewal: closure_129_3, apply_entitlements: closure_129_5, currency: closure_129_4, user_discount_offer_id: closure_129_8, load_id: closure_129_9 };
          closure_129_10 = obj2;
          c4 = 1;
          const HTTP = closure_130_0(closure_130_2[7]).HTTP;
        ...
        if (tmp11) {
          obj = closure_130_1(closure_130_2[8]);
          const obj6 = { type: "SUBSCRIPTION_PREVIEW_CHECKOUT_CONTEXT_UPDATE", checkoutContext: closure_129_12.checkoutContext, paymentSourceId: closure_129_2 };
          obj.dispatch(obj6);
        }
        c4 = 0;
        c6 = 3;
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          const obj2 = { gift: true, payment_source_id: closure_129_0, sku_subscription_plan_id: closure_129_2, currency: closure_129_3, load_id: closure_129_4 };
          closure_129_6 = obj2;
    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (arg0 === 1) {
          ...
          const HTTP = closure_130_0(closure_130_2[7]).HTTP;
          const obj2 = { url: closure_130_12.BILLING_SUBSCRIPTION_INVOICE(closure_129_0), oldFormErrors: true, rejectWithError: false };
          c3 = 2;
          c4 = 1;
