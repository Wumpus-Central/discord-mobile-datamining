// === Module 7776: createSubscriptionInvoicePreview ===
...
import closure_11 from "createFromServer" /* 4052 */;
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              const result = callback(4043).coerceExistingItemsToNewItemInterval(callback);
              callback = result;
            ...
            c4 = 0;
            constants = c3;
            const billingError = new callback(4278).BillingError(constants);
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw arg1;
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            closure_13 = c3;
            const billingError = new callback(4278).BillingError(closure_13);
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw arg1;
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            closure_8 = c3;
            const billingError = new callback(4278).BillingError(closure_8);
            throw billingError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw arg1;
