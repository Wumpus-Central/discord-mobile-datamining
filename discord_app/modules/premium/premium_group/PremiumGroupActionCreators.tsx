// === Module 13490: PremiumGroupActionCreators ===
    ...
    try {
      ...
      if (0 === c4) {
        ...
        if (null != body) {
          ...
          obj5 = { subscriptionId: body.subscription_id, memberType: body.member_type, subscriptionStatus: body.subscription_status, currentPeriodEnd: null };
          const _Date = Date;
    ...
    if (c7 === 2) {
      ...
      try {
        ...
        if (0 === c6) {
          ...
          const obj5 = { invitedUsers: closure_130_1.body.invited_users, ineligibleUsers: closure_130_1.body.ineligible_users };
          c5 = 0;
          c7 = 3;
    ...
    if (c8 === 2) {
      ...
      try {
        ...
        if (0 === c7) {
          ...
          let obj4 = closure_132_1(closure_132_2[4]);
          obj4 = { type: "PREMIUM_GROUP_REMOVE_INVITE_FAILURE", subscriptionGroupMemberId: closure_131_1, errorCode: null, subscriptionId: null };
          ...
          closure_131_2 = value;
          obj = closure_132_1(closure_132_2[4]);
          const obj7 = { type: "PREMIUM_GROUP_REMOVE_INVITE_SUCCESS", subscriptionId: closure_131_0, subscriptionGroupMemberId: closure_131_1 };
          obj.dispatch(obj7);
          c6 = 0;
          c8 = 3;
