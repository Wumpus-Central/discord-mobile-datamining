...
function PremiumFeatureUpsellPill(featureName) {
  ...
  if (featureName(7925).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE === featureName) {
    ...
    obj2 = {
      maxFileSize: tmp(4264).getMaxFileSizeForPremiumType(tmp7),
  ...
  const tmp11Result = useTier0UpsellContent(10057)(
  ...
  if (mobileEmojiPickerUpsellRestyleEnabledForFeature) {
    ...
    items1[1] = closure_12(tmp(4602).Text, obj7);
    ...
    const obj9 = { source: tmp10(useTier0UpsellContent ? 10058 : 10054), style: tmp4.nitroWheel, disableColor: true };
    closure_12(tmp(1178).Icon, obj9);
  }
  tmp10 = useTier0UpsellContent;
  const tmp11 = useTier0UpsellContent(10057);
}
...
createStyles = { withSpring: fn(5025).withSpring, springStandard: fn(5029).springStandard };
