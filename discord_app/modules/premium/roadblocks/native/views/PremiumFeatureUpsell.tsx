...
function PremiumFeatureUpsellPill(featureName) {
  ...
  if (!mobileEmojiPickerUpsellRestyleEnabledForFeature) {
    mobileEmojiPickerUpsellRestyleEnabledForFeature = tmp(9451).getMobileStickerPickerUpsellRestyleEnabledForFeature(
      featureName,
  ...
  if (mobileEmojiPickerUpsellRestyleEnabledForFeature) {
    ...
    const obj13 = {
      ...
      shrink: true,
      style: tmp4.button,
      size: tmp(1176).ButtonSizes.XSMALL,
...
export default function PremiumFeatureUpsell(shouldShow) {
  ...
  return closure_12(ref(analyticsLocations[31]), {
