...
function PremiumFeatureUpsellPill(featureName) {
  ...
  if (!mobileEmojiPickerUpsellRestyleEnabledForFeature) {
    mobileEmojiPickerUpsellRestyleEnabledForFeature = tmp(9475).getMobileStickerPickerUpsellRestyleEnabledForFeature(
      featureName,
  ...
  if (featureName(7973).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE === featureName) {
    ...
    const obj7 = {
      maxFileSize: tmp(4297).getMaxFileSizeForPremiumType(tmp7),
  ...
  const tmp11Result = tmp11(
    ...
    featureName(10116).getAnalyticsPage(featureName),
  );
  ...
  const tmpResult6 = featureName(10116);
}
