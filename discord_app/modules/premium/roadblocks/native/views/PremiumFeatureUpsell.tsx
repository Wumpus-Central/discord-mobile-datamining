...
function PremiumFeatureUpsellPill(featureName) {
  ...
  if (featureName(7955).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE === featureName) {
    ...
    obj2 = {
      maxFileSize: tmp(4294).getMaxFileSizeForPremiumType(tmp7),
  ...
  const tmp11Result = useTier0UpsellContent(10096)(
  ...
  if (mobileEmojiPickerUpsellRestyleEnabledForFeature) {
    ...
    items1[1] = closure_12(tmp(4632).Text, obj7);
    ...
    const obj9 = { source: tmp10(useTier0UpsellContent ? 10097 : 10093), style: tmp4.nitroWheel, disableColor: true };
    closure_12(tmp(1178).Icon, obj9);
  }
  tmp10 = useTier0UpsellContent;
  const tmp11 = useTier0UpsellContent(10096);
}
...
createStyles = { withSpring: fn(5055).withSpring, springStandard: fn(5059).springStandard };
