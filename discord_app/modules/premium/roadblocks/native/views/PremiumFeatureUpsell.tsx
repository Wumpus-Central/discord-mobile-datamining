...
export default function PremiumFeatureUpsell(shouldShow) {
  ...
  return closure_12(ref(analyticsLocations[31]), { useReducedMotion: false, item: tmp8, entering: animationEnterExit, exiting: animationEnterExit, renderItem: callback });
};