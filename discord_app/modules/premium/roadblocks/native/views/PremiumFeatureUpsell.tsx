...
function PremiumFeatureUpsellPill(featureName) {
  ...
  dependencyMap = tmp4;
  let obj2 = featureName(10036);
  let mobileEmojiPickerUpsellRestyleEnabledForFeature = obj2.getMobileEmojiPickerUpsellRestyleEnabledForFeature(
    featureName,
    "native.PremiumFeatureUpsell",
  );
  if (!mobileEmojiPickerUpsellRestyleEnabledForFeature) {
    let tmpResult = tmp(9391);
    mobileEmojiPickerUpsellRestyleEnabledForFeature = tmpResult.getMobileStickerPickerUpsellRestyleEnabledForFeature(
      featureName,
      "native.PremiumFeatureUpsell",
    );
  }
  ...
  if (featureName(7904).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE === featureName) {
    ...
    obj2 = {
      maxFileSize: tmp(4262).getMaxFileSizeForPremiumType(tmp7),
  ...
  const tmp11Result = useTier0UpsellContent(10037)(
    useTier0UpsellContent,
    premiumUpsellConfig.onViewAllPerks,
    PREMIUM_UPSELL_FILE_UPLOAD,
  );
  ...
  if (mobileEmojiPickerUpsellRestyleEnabledForFeature) {
    ...
    items1[1] = closure_12(tmp(4601).Text, obj7);
    ...
    const obj8 = {
      ...
      shrink: true,
      style: tmp4.button,
      size: tmp(1178).ButtonSizes.XSMALL,
    ...
    const obj9 = { source: tmp10(useTier0UpsellContent ? 10038 : 10033), style: tmp4.nitroWheel, disableColor: true };
    closure_12(tmp(1178).Icon, obj9);
  }
  tmp10 = useTier0UpsellContent;
  const tmp11 = useTier0UpsellContent(10037);
}
...
createStyles = { withSpring: fn(5024).withSpring, springStandard: fn(5028).springStandard };
