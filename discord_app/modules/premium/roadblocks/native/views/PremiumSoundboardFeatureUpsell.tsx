...
let closure_5 = createCacheKey.createStyles((arg0) => {
  ...
  obj = {
    position: "absolute",
    bottom: arg0 + ThemesDefault.space.PX_12,
    left: 0,
    right: 0,
...
export default function PremiumSoundboardFeatureUpsell(shouldShow) {
  let obj = {
    style: callback(keys.EXPRESSION_FOOTER_HEIGHT + useSafeAreaInsetsDefault().bottom).container,
    children: null,
  };
  obj = {
  ...
  obj[1] = jsx(PremiumFeatureUpsellPillDefault, {
    shouldShow: shouldShow.shouldShow,
    featureName: EntitlementFeatureNames.EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE,
  });
  return (
