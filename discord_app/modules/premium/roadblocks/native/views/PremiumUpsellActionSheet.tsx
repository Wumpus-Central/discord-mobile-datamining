...
export default function PremiumUpsellActionSheet(onDismiss) {
  ...
  obj.description = intl2.formatToPlainString(legacyProps(tmp3[23]).t["fc+8uy"], { nitroTierName: premiumTypeDisplayName });
  ...
  obj2.description = intl4.formatToPlainString(legacyProps(tmp3[23]).t["uukIF/"], { nitroTierName: premiumTypeDisplayName });
  ...
  obj9.description = intl9.formatToPlainString(legacyProps(tmp3[23]).t.uGkSY2, { nitroTierName: premiumTypeDisplayName });
  ...
  obj21.description = intl21.formatToPlainString(legacyProps(tmp3[23]).t["4nlpei"], { fps: ApplicationStreamFPS.FPS_60 });
  ...
  const obj23 = { colors: null, start: legacyProps(tmp3[38]).HorizontalGradient.START, end: legacyProps(tmp3[38]).HorizontalGradient.END };
  ...
  let mobileEmojiPickerUpsellRestyleEnabledForFeature = legacyProps(tmp3[50]).getMobileEmojiPickerUpsellRestyleEnabledForFeature(featureName, "native.PremiumUpsellActionSheet");
