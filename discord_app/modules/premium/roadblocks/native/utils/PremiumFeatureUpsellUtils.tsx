// === Module 8898: isSoundboardSectionNitroLocked ===
...
export const getUpsellType = function getUpsellType(featureName) {
  ...
  } else if (tmp(8597).EntitlementFeatureNames.SOUNDBOARD_EVERYWHERE === featureName) {
    return tmp(691).UpsellTypes.SOUNDBOARD;
  } else if (tmp(8597).EntitlementFeatureNames.CLIENT_THEMES === featureName) {
  ...
  } else if (tmp(8597).EntitlementFeatureNames.SAVED_MESSAGES === featureName) {
    return tmp(691).UpsellTypes.FOR_LATER;
  } else if (tmp(8597).EntitlementFeatureNames.SCHEDULED_MESSAGES === featureName) {
