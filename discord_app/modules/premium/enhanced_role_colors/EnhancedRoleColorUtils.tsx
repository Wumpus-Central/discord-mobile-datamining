...
export const extractColorStringsFromServerColors = function extractColorStringsFromServerColors(colors) {
  ...
  if (null != colors.secondary_color) {
    int2hexResult1 = require("../../../../discord_common/js/shared/utils/ColorUtils.tsx") /* int2hslRaw */.int2hex(colors.secondary_color);
  ...
  if (null != colors.tertiary_color) {
    int2hexResult2 = require("../../../../discord_common/js/shared/utils/ColorUtils.tsx") /* int2hslRaw */.int2hex(colors.tertiary_color);
