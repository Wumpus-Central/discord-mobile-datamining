...
export const TieredTenureBadgePerkCard = function TieredTenureBadgePerkCard() {
  ...
  let obj1 = tieredTenureBadgeData(11318);
  ...
  let obj4 = tieredTenureBadgeData(11292);
  let id;
  ...
  if (null == tieredTenureBadgeData) {
    ...
    const items2 = [closure_7(tmp(4632).Text, obj3), ];
    obj4 = { variant: "heading-md/medium", color: "text-muted", style: tmp6.tenureRequirements, children: tmp(11317).getTenureBadgeRequirementString(tieredTenureBadgeData.id, tieredTenureBadgeData.tenureReqNumMonths) };
    items2[1] = closure_7(tmp(4632).Text, obj4);
    ...
    if (tmp30Result) {
      ...
      tmp30Result = closure_7(tmp(4632).Text, obj5);
    }
    ...
    obj9.source = obj10;
    obj8.children = closure_7(stateFromStores(5668), obj9);
