...
export const usePremiumDiscountOffer = function usePremiumDiscountOffer() {
  ...
  let values = Object.values(offerIds(5679).DiscountIdToProductOfferId[closure_4]);
  let tmp5 = null;
  if (0 !== values.length) {
    let tmp6 = null;
  ...
  tmp4 = importDefault(6263)(closure_4);
  values = Object.values(tmp(5679).DiscountIdToProductOfferId[closure_5]);
  let tmp8 = null;
  if (0 !== values.length) {
    let tmp9 = null;
    if (values.every((arg0) => offerIds.has(arg0))) {
