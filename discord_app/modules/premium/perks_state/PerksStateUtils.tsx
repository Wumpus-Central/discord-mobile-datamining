// === Module 1927: parseServerPerkConfigKind ===

// Module 1927 (parseServerPerkConfigKind)
import fromStringAll from "fromString" /* 503 */;
import PerkConfigType from "PerkConfigType" /* 1928 */;
...
function parseServerPerkConfigKind(kind) {
  if (null != kind.kind) {
    ...
    if (PerkConfigType.PerkConfigType.INCREASED_FILE_UPLOAD_SIZE === type) {
      ...
      obj[0] = tmp(1928).PerkConfigType.INCREASED_FILE_UPLOAD_SIZE;
      obj[1] = kind.kind.max_size;
      return obj;
    } else if (tmp(1928).PerkConfigType.INCREASED_GUILD_LIMIT === type) {
      obj = { type: null, maxGuilds: null };
      obj[0] = tmp(1928).PerkConfigType.INCREASED_GUILD_LIMIT;
