...
({
  ...
  MAX_ATTACHMENT_SIZE,
  GuildFeatures,
  MAX_STAGE_VIDEO_USER_LIMIT_TIER01,
  BITRATE_MAX,
...
const obj2 = {
  ...
  PREMIUM_YEAR_TIER_0: "1024422698568122368",
  ...
  PREMIUM_GROUP_MONTH: "1432523012455792640",
};
const items3 = [, , , , , , , , , ,];
({
  PREMIUM_MONTH_TIER_0: arr4[0],
  PREMIUM_YEAR_TIER_0: arr4[1],
  PREMIUM_MONTH_TIER_1: arr4[2],
  PREMIUM_YEAR_TIER_1: arr4[3],
  PREMIUM_MONTH_TIER_2: arr4[4],
  PREMIUM_3_MONTH_TIER_2: arr4[5],
  PREMIUM_6_MONTH_TIER_2: arr4[6],
  PREMIUM_YEAR_TIER_2: arr4[7],
...
const frozen7 = Object.freeze({
  "520373071933079552": { id: "520373071933079552", skus: items13 },
  "902329034132684800": { id: "902329034132684800", skus: items14 },
  "983601860436819968": { id: "983601860436819968", skus: items15 },
  "983601860436819969": { id: "983601860436819969", skus: items16 },
  "984244797441048577": { id: "984244797441048577", skus: items17 },
  "1004850445463584768": { id: "1004850445463584768", skus: items18 },
  "1070132870233980928": { id: "1070132870233980928", skus: items19 },
  "1073698058383917056": { id: "1073698058383917056", skus: items20 },
  "1268347360493174784": { id: "1268347360493174784", skus: items21 },
  "1161363847311785984": { id: "1161363847311785984", skus: items22 },
});
const obj28 = {
...
const obj29 = {
  [BoostedGuildTiers.NONE]: obj28[BoostedGuildTiers.NONE],
  [BoostedGuildTiers.TIER_1]: obj28[BoostedGuildTiers.NONE] + obj28[BoostedGuildTiers.TIER_1],
  [BoostedGuildTiers.TIER_2]:
    obj28[BoostedGuildTiers.NONE] + obj28[BoostedGuildTiers.TIER_1] + obj28[BoostedGuildTiers.TIER_2],
  [BoostedGuildTiers.TIER_3]:
    obj28[BoostedGuildTiers.NONE] +
    obj28[BoostedGuildTiers.TIER_1] +
    obj28[BoostedGuildTiers.TIER_2] +
    obj28[BoostedGuildTiers.TIER_3],
};
const obj30 = {
...
const obj27 = {
  [obj.TIER_0]: obj26.PREMIUM_TIER_0,
  [obj.TIER_1]: obj26.PREMIUM_TIER_1,
  [obj.TIER_2]: obj26.PREMIUM_TIER_2,
  [obj.GUILD]: obj26.GUILD_BOOST,
};
...
const frozen9 = Object.freeze({
  [BoostedGuildTiers.NONE]: {
    features: [],
    limits: {
      emoji: set8.DEFAULT_EMOJI_SLOTS,
      bitrate: BITRATE_MAX,
      fileSize: MAX_ATTACHMENT_SIZE,
      screenShareQualityFramerate: 30,
      screenShareQualityResolution: "720p",
      soundboardSounds: obj30[BoostedGuildTiers.NONE],
      stickers: obj29[BoostedGuildTiers.NONE],
      stageVideoUsers: MAX_STAGE_VIDEO_USER_LIMIT_TIER01,
    },
  },
  [BoostedGuildTiers.TIER_1]: {
    features: items23,
    limits: {
      emoji: 100,
      bitrate: 128000,
      ...
      screenShareQualityResolution: "720p",
      soundboardSounds: obj30[BoostedGuildTiers.TIER_1],
      stickers: obj29[BoostedGuildTiers.TIER_1],
      stageVideoUsers: MAX_STAGE_VIDEO_USER_LIMIT_TIER01,
    },
  },
  [BoostedGuildTiers.TIER_2]: {
    ...
    limits: {
      ...
      soundboardSounds: obj30[BoostedGuildTiers.TIER_2],
      stickers: obj29[BoostedGuildTiers.TIER_2],
  ...
  [BoostedGuildTiers.TIER_3]: {
    ...
    limits: {
      ...
      screenShareQualityFramerate: 60,
      screenShareQualityResolution: "1080p",
      soundboardSounds: obj30[BoostedGuildTiers.TIER_3],
      stickers: obj29[BoostedGuildTiers.TIER_3],
...
const frozen10 = Object.freeze({
  [obj35.HIGH_STREAMING_QUALITY]: obj.TIER_2,
  [obj35.MID_STREAMING_QUALITY]: obj.TIER_1,
});
...
const obj38 = {
  ...
  PREMIUM_TENURE_36_MONTH: "premium_tenure_36_month_v2",
...
const obj39 = {};
const obj40 = {
  id: obj38.PREMIUM_TENURE_1_MONTH,
...
obj39[obj38.PREMIUM_TENURE_3_MONTH] = {
  id: obj38.PREMIUM_TENURE_3_MONTH,
  nameUnformatted: getSystemLocale.t["rI1/3H"],
  nameUnformattedNitro: getSystemLocale.t.xJNb5C,
...
obj39[obj38.PREMIUM_TENURE_6_MONTH] = {
  id: obj38.PREMIUM_TENURE_6_MONTH,
  nameUnformatted: getSystemLocale.t.VkhVKS,
  nameUnformattedNitro: getSystemLocale.t["4scBFY"],
...
obj39[obj38.PREMIUM_TENURE_12_MONTH] = {
  id: obj38.PREMIUM_TENURE_12_MONTH,
  nameUnformatted: getSystemLocale.t.gzUfNS,
  nameUnformattedNitro: getSystemLocale.t["83Jw2B"],
...
obj39[obj38.PREMIUM_TENURE_24_MONTH] = {
  id: obj38.PREMIUM_TENURE_24_MONTH,
  nameUnformatted: getSystemLocale.t.fuwTPm,
  nameUnformattedNitro: getSystemLocale.t.vRSCKv,
...
obj39[obj38.PREMIUM_TENURE_36_MONTH] = {
  id: obj38.PREMIUM_TENURE_36_MONTH,
  nameUnformatted: getSystemLocale.t.qNhNk4,
  nameUnformattedNitro: getSystemLocale.t.mV86tk,
...
obj39[obj38.PREMIUM_TENURE_60_MONTH] = {
  id: obj38.PREMIUM_TENURE_60_MONTH,
  nameUnformatted: getSystemLocale.t["wvX+eD"],
  nameUnformattedNitro: getSystemLocale.t.WcsLxW,
...
obj39[obj38.PREMIUM_TENURE_72_MONTH] = {
  id: obj38.PREMIUM_TENURE_72_MONTH,
  nameUnformatted: getSystemLocale.t["/menIw"],
  nameUnformattedNitro: getSystemLocale.t["Z/qgMK"],
...
export const PremiumOfferTypes = {
  PREMIUM_TRIAL: 0,
  [0]: "PREMIUM_TRIAL",
  PREMIUM_DISCOUNT: 1,
  [1]: "PREMIUM_DISCOUNT",
...
export const PremiumUpsellTypes = {
  ...
  EMOJI_PICKER_EMOJI_CLICKED: "emoji_picker_emoji_clicked",
  EMOJI_PICKER_STICKER_CLICKED: "emoji_picker_sticker_clicked",
  EMOJI_PICKER_REACTION_EMOJI_CLICKED: "emoji_picker_reaction_emoji_clicked",
  EMOJI_PICKER_SUPER_REACTION_EMOJI_CLICKED: "emoji_picker_super_reaction_emoji_clicked",
  EMOJI_PICKER_STATUS_EMOJI_CLICKED: "emoji_picker_status_emoji_clicked",
  EMOJI_PICKER_TOP_SERVER_EMOJI_CLICKED: "emoji_picker_top_server_emoji_clicked",
  EMOJI_PICKER_NEWLY_ADDED_EMOJI_CLICKED: "emoji_picker_newly_added_emoji_clicked",
  EMOJI_AUTOSUGGEST_CLICKED: "emoji_autosuggest_clicked",
  EMOJI_AUTOCOMPLETE_INLINE: "emoji_autocomplete_inline",
  EMOJI_AUTOCOMPLETE_MODAL: "emoji_autocomplete_modal",
  EMOJI_IN_MESSAGE_HOVER: "emoji_in_message_hover",
  EMOJI_IN_REACTION_HOVER: "emoji_in_reaction_hover",
  ...
  GIFT_STREAM_QUALITY_INDICATOR: "gift_stream_quality_indicator",
  MESSAGE_LENGTH_UPSELL: "message_length_upsell",
  MESSAGE_LENGTH_IN_EDITOR_UPSELL: "message_length_in_editor_upsell",
  CUSTOM_PROFILE_UPSELL: "custom profiles upsell modal",
  CUSTOM_PROFILE_TRY_OUT_UPSELL: "try out custom profile in settings upsell",
  VIDEO_BACKGROUNDS_MODAL: "video backgrounds modal",
  VIDEO_BACKGROUNDS_INLINE: "video backgrounds inline",
  GUILD_CAP_INLINE_SERVER_LIST: "guild_cap_inline_server_list",
  GUILD_PREMIUM_UPSELL_MODAL: "premium guild premium upsell modal",
  GUILD_CAP_INLINE_INVITE_MODAL: "guild_cap_inline_invite_modal",
  GUILD_CAP_MODAL_UPSELL: "guild_cap_modal_upsell",
  PREMIUM_GUILD_IDENTITY_MODAL: "premium guild identity upsell alert",
  CUSTOM_PROFILE_SETTINGS_BANNER_BUTTON: "custom profiles settings banner upsell",
  STICKER_PICKER_UPSELL: "sticker_picker_upsell",
  ANIMATED_AVATAR_PREVIEW_GIF_MODAL: "animated avatar preview gif modal",
  ANIMATED_USER_AVATAR_MODAL: "animated user avatar upsell modal",
  UPLOAD_ERROR_UPSELL: "upload error upsell",
  PREMIUM_GUILD_MEMBER_PROFILE_UPSELL_INLINE: "premium guild member profile upsell inline",
  CONCURRENT_ACTIVITIES: "Concurrent Activities",
  PREMIUM_UNCANCEL_WINBACK_MODAL_VIEWED: "premium_uncancel_winback_modal_viewed",
  ANIMATED_VIDEO_BACKGROUND_NEW_PRESET: "animated_video_background_new_preset",
  LOW_PRICE_EXPERIMENT_TOOLTIP: "low_price_experiment_tooltip",
  PREMIUM_PROFILE_BADGE_UPSELL: "premium_profile_badge_upsell",
  AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_EMOJI: "emoji",
  AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_PROFILE_CUSTOMIZATION: "profile customization",
  AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_HD_STREAMING: "hd streaming",
  AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_LARGER_FILE_UPLOADS: "larger file uploads",
  AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_BOGO: "bogo",
  VOICE_CHANNEL_EFFECTS_UPSELL: "voice_channel_effects_upsell",
  VOICE_CHANNEL_EFFECTS_BAR_EMOJI_UPSELL: "Voice Channel Effect Bar Emoji Upsell",
  VOICE_CHANNEL_EFFECTS_TOGGLE_CLICKED: "voice_channel_effects_toggle_clicked",
  VOICE_CHANNEL_EFFECTS_TOGGLE_CLICKED_EXPANDED: "voice_channel_effects_toggle_clicked_expanded",
  PROFILE_EFFECTS_INLINE_SETTINGS: "profile_effects_inline_settings",
  PROFILE_EFFECTS_INLINE_SETTINGS_MOBILE: "profile_effects_inline_settings_mobile",
  HIGH_VIDEO_QUALITY_UPSELL: "high_video_quality_upsell",
  PREMIUM_PROFILE_TRY_IT_OUT: "premium_profile_try_it_out",
  BURST_REACTION_RAIL_UPSELL: "burst_reaction_rail_upsell",
  BURST_REACTION_UPSELL: "burst_reaction_upsell",
  BURST_REACTION_QUICK_ACTION_UPSELL: "burst_reaction_quick_action_upsell",
  BURST_REACTION_CONTEXT_MENU_UPSELL: "burst_reaction_context_menu_upsell",
  PREMIUM_CLIENT_THEME_TRY_IT_OUT: "premium_client_theme_try_it_out",
  ...
  COLLECTIBLES_PREMIUM_MARKETING_PAGE_UPSELL: "collectibles_premium_marketing_page_upsell",
  CLIPS_GUILD_SIDEBAR_COACHMARK_PREMIUM_EARLY_ACCESS_UPSELL:
    "clips_guild_sidebar_coachmark_premium_early_access_upsell",
  CLIPS_GO_LIVE_PREMIUM_EARLY_ACCESS_ROADBLOCK_UPSELL: "clips_go_live_premium_early_access_roadblock_upsell",
  CUSTOM_NOTIFICATION_SOUNDS_UPSELL: "custom_notification_sounds_upsell",
  CUSTOM_NOTIFICATION_SOUNDS_SETTINGS_UPSELL: "custom_notification_sounds_settings_inline_upsell",
  HD_STREAMING_VIEWER_UPSELL: "hd_streaming_viewer_upsell",
  FOR_LATER_MODAL_UPSELL: "for_later_modal_upsell",
  SCHEDULED_MESSAGES_MODAL_UPSELL: "scheduled_messages_modal_upsell",
  TRY_IT_OUT_MODAL_UPSELL: "try_it_out_modal_upsell",
  ANIMATED_BANNER_MODAL_UPSELL: "animated_banner_modal_upsell",
  ANIMATED_AVATAR_MODAL_UPSELL: "animated_avatar_modal_upsell",
  PROFILE_EFFECT_MODAL_UPSELL: "profile_effect_modal_upsell",
  AVATAR_DECORATION_MODAL_UPSELL: "avatar_decoration_modal_upsell",
  NAMEPLATE_MODAL_UPSELL: "nameplate_modal_upsell",
  RECENT_AVATARS_ROADBLOCK_UPSELL: "recent_avatars_roadblock_upsell",
  ...
  LARGER_FILE_UPLOAD_UPSELL: "larger_file_upload_upsell",
  ANIMATED_EMOJI_UPSELL: "animated_emoji_upsell",
  CLIENT_THEMES_UPSELL: "client_themes_upsell",
  CUSTOM_THEMES_UPSELL: "custom_themes_upsell",
...
export const PremiumFeatureHelperActions = {
  ...
  HELPER_UNCOLLAPSED: "helper_uncollapsed",
  UNLOCK_EMOJI_CLICKED: "unlock_emoji_clicked",
  CUSTOM_PROFILES_CLICKED: "custom_profiles_clicked",
  SERVER_BOOSTS_CLICKED: "server_boosts_clicked",
  HELPER_DISMISSED: "premium_feature_helper_dismissed",
  HELPER_RENDERED: "premium_feature_helper_rendered",
};
export const PremiumFeatureHelperSteps = {
  EMOJI_TUTORIAL_STARTED: "emoji_tutorial_started",
  EMOJI_INTRO_VIEWED: "emoji_intro_viewed",
  EMOJI_PROMPT_VIEWED: "emoji_prompt_viewed",
  CUSTOM_PROFILE_TUTORIAL_STARTED: "custom_profile_tutorial_started",
  CUSTOM_PROFILE_AVATAR_INTRO_VIEWED: "custom_profile_avatar_intro_viewed",
  ...
  CUSTOM_PROFILE_THEME_INTRO_VIEWED: "custom_profile_theme_intro_viewed",
  SERVER_PROFILE_INTRO_VIEWED: "server_profile_intro_viewed",
  SERVER_BOOST_TUTORIAL_STARTED: "server_boost_tutorial_started",
  BOOST_INTRO_VIEWED: "boost_intro_viewed",
  BOOST_PROMPT_VIEWED: "boost_prompt_viewed",
};
export const BoostingUpsellAction = { BOOST: "boost", DISMISS: "dismiss" };
export const ReferralTrialsAnalyticSteps = {
  BADGE_TOOLTIP_VIEWED: "share_nitro_bagde_tooltip_viewed",
  BADGE_CLICKED: "share_nitro_badge_clicked",
  FLOW_STARTED: "share_nitro_flow_started",
...
export const GiftingOrigin = {
  DM_CHANNEL: 0,
  [0]: "DM_CHANNEL",
  SHOP_PAGE: 1,
  [1]: "SHOP_PAGE",
  USER_PROFILE_WISHLIST: 2,
  [2]: "USER_PROFILE_WISHLIST",
  DM_CHANNEL_WISHLIST: 3,
  [3]: "DM_CHANNEL_WISHLIST",
  GUILD_CHANNEL: 4,
  [4]: "GUILD_CHANNEL",
  BADGE_DIRECTORY: 5,
  [5]: "BADGE_DIRECTORY",
...
export const FRACTIONAL_PREMIUM_SKU_INTERVAL_COUNTS = {
  [set7.FractionalPremiumSKUs.PREMIUM_TIER_2_1_HOUR]: items33,
  [set7.FractionalPremiumSKUs.PREMIUM_TIER_2_1_DAY]: items34,
  [set7.FractionalPremiumSKUs.PREMIUM_TIER_2_3_DAY]: items35,
};
