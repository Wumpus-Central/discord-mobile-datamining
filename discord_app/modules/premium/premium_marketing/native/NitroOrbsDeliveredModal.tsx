...
export default function NitroOrbsDeliveredModal(arg0) {
  ...
  if (tmp7Result) {
    ...
    obj5.children = closure_11(onClose(7394).ActionSheetCloseButton, obj6);
    ...
    const items5 = [closure_11(onClose(4718).Text, obj10), ];
    ...
    items5[1] = closure_11(onClose(4718).Text, obj12);
    ...
    const items6 = [closure_11(onClose(5144).Button, obj15), ];
    ...
    items6[1] = closure_11(onClose(5144).Button, obj16);
    obj14.children = items6;
    items3[2] = closure_12(View, obj14);
    rect.children = items3;
    tmp7Result = closure_12(onClose(7319).SafeAreaPaddingView, rect);
  }
  items2[2] = tmp7Result;
  obj.children = items2;
