...
export const generateGuildPermissionSpec = function generateGuildPermissionSpec(showCreatorMonetizationAnalyticsPermission) {
  ...
  const intl = getSystemLocale.intl;
  obj[0] = intl.string(getSystemLocale.t["mYck+B"]);
  require = tmp;
  ...
  const intl2 = getSystemLocale.intl;
  obj[0] = intl2.string(getSystemLocale.t.Ny49TN);
  require = tmp;
  ...
  obj[0] = intl3.string(getSystemLocale.t.cKobO5);
  require = tmp;
  ...
  obj1[0] = intl4.string(getSystemLocale.t["46Ra1b"]);
  require = tmp;
  ...
  obj2[0] = intl5.string(getSystemLocale.t["rrh/W6"]);
  require = tmp;
  ...
  obj4[0] = intl7.string(getSystemLocale.t.b8lplT);
  const items7 = [, ];
  ...
  obj5[0] = intl8.string(getSystemLocale.t["3uI5CX"]);
