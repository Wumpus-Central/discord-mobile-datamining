...
export default function BlockedDomainActionSheet(url) {
  ...
  const items = [callback(require(6790) /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  obj[3] = items;
  const items1 = [callback2(require(4602) /* Stack */.Stack, obj), callback(require(12310) /* URLCallout */.URLCallout, { url: url.url }), ];
