...
export default function BlockedDomainActionSheet(url) {
  ...
  const items = [callback(require("../../../../design/assets/native.tsx") /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  obj1[4] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["2B3wj8"]);
  ...
  obj2[2] = intl2.format(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.jnHyYU, {});
  items[2] = callback(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj2);
  obj[3] = items;
  const items1 = [callback2(require("../../../../design/components/Stack/native/Stack.native.tsx") /* Stack */.Stack, obj), callback(require("../../../safety_common/native/URLCallout.tsx") /* URLCallout */.URLCallout, { url: url.url }), ];
  const obj3 = { grow: true, text: null, onPress: null };
  const intl3 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj3[1] = intl3.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["/g10LC"]);
