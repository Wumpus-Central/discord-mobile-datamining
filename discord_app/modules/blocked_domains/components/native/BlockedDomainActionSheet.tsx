...
export default function BlockedDomainActionSheet(url) {
  ...
  const items = [callback(AccountAgeTier10LargeBadge /* AccountAgeTier10LargeBadge */.TrafficConeSpotIllustration, {}), , ];
  ...
  obj1[4] = intl.string(getSystemLocale /* getSystemLocale */.t["2B3wj8"]);
  items[1] = callback(Text /* Text */.Text, obj1);
  const obj2 = { style: tmp.warningMessage, variant: "text-md/medium", children: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj2[2] = intl2.format(getSystemLocale /* getSystemLocale */.t.jnHyYU, {});
  items[2] = callback(Text /* Text */.Text, obj2);
  obj[3] = items;
  const items1 = [callback2(Stack /* Stack */.Stack, obj), callback(URLCallout /* URLCallout */.URLCallout, { url: url.url }), ];
  const obj3 = { grow: true, text: null, onPress: null };
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj3[1] = intl3.string(getSystemLocale /* getSystemLocale */.t["/g10LC"]);
