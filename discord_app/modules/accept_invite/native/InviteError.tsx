...
import { registerAsset } from "../../../../_runtime/12083_registerAsset.js";
...
function InviteErrorBase(invite) {
  ...
  const tmp4Result = importDefault(obj.isThemeDark(useTheme()) ? 12080 : 12081);
  let code;
  if (inviteError != null) {
...
function InviteDisabledError(onPressClose) {
  ...
  if (null == guild) {
    ...
    obj3[1] = guildIconURL;
    obj3[2] = onPressClose(5779).GuildIconSizes.XLARGE;
    ...
    items1[1] = callback(onPressClose(4299).Text, obj4);
    ...
    items1[3] = callback(onPressClose(4714).Button, obj7);
    obj[0] = items1;
