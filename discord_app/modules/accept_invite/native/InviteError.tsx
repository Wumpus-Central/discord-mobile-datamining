...
function InviteErrorBase(invite) {
  ...
  const tmp4Result = importDefault(obj.isThemeDark(useTheme()) ? 12010 : 12011);
  let code;
  if (inviteError != null) {
...
function InviteDisabledError(onPressClose) {
  ...
  if (null == guild) {
    ...
    obj3[1] = guildIconURL;
    obj3[2] = onPressClose(5719).GuildIconSizes.XLARGE;
    ...
    items1[1] = callback(onPressClose(4298).Text, obj4);
    ...
    items1[2] = callback(onPressClose(4298).Text, obj5);
    ...
    items1[3] = callback(onPressClose(4712).Button, obj7);
    obj[0] = items1;
