...
function InviteDestinationIcon(invite) {
  ...
  if (null != invite.guild) {
    ...
    obj[0] = tmp.avatar;
    obj[1] = invite.guild;
    obj[2] = require("../../guild/native/GuildInviteIcon.tsx").Sizes.LARGE;
    tmp2Result = tmp2(require("../../guild/native/GuildInviteIcon.tsx"), obj);
    const tmp9 = require("../../guild/native/GuildInviteIcon.tsx");
  }
}
function InviteHeader(invite) {
  invite = invite.invite;
  const tmp = createCacheKey();
  let obj = require("../../instant_invite/InviteTypeUtils.tsx") /* InviteTypes */;
  ...
  if (tmp2Result.isFriendInvite(invite)) {
    ...
    obj = { username: null };
    obj[0] = require("../../../utils/UserUtils.tsx").getFormattedName(invite.inviter);
    name = intl.formatToPlainString(tmp2(1236).t["4aF92R"], obj);
    const obj5 = require("../../../utils/UserUtils.tsx");
  }
  let tmp9 = null;
  if (null != name) {
    ...
    const items = [callback2(require("../../guild/native/GuildBadge.tsx"), obj1), ];
    ...
    obj2[3] = name;
    items[1] = callback2(tmp2(4281).Heading, obj2);
    obj[1] = items;
...
function InviteJoinContext(invite) {
  ...
  if (obj.isFriendInvite(invite)) {
    ...
    obj = { username: null };
    obj[0] = isGuildMember(4124).getFormattedName(invite.inviter);
    let formatResult = intl7.format(tmp3(1236).t.Quj7HX, obj);
    const obj11 = isGuildMember(4124);
  } else {
    let tmp3Result = tmp3(7115);
    ...
    if (!shouldShowInviter(invite, invite.isGuildMember)) {
      ...
      if (id !== closure_11) {
        ...
        if (null != tmp2.onlineCount) {
          ...
          obj2[2] = intl.format(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["LC+S+m"], obj3);
        ...
        if (null != tmp2.memberCount) {
          ...
          obj6[2] = intl2.format(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.zRl6XR, obj7);
          items2[1] = callback2(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj6);
          obj4[0] = items2;
...
export default function InviteDetails(invite) {
  ...
  items2[4] = callback2(require("InviteRolesList.tsx"), { invite, style: tmp.rolesList });
  ...
  if (tmp8Result) {
    ...
    const items3 = [tmp10(tmp4(8879).GuildEventCardHeader, obj5), , ];
    const obj6 = { event: null };
    obj6[0] = guild_scheduled_event;
    items3[1] = tmp10(tmp4(8879).GuildEventCardMetaInfo, obj6);
    const obj7 = { event: null };
    obj7[0] = guild_scheduled_event;
    items3[2] = tmp10(tmp4(8879).GuildEventCardGuildInfo, obj7);
    obj4[1] = items3;
  ...
  if (null != stateFromStores) {
    userAvatarSource = require("../../../utils/AvatarUtils.tsx").getUserAvatarSource(stateFromStores, false, 20);
    const tmp15Result = require("../../../utils/AvatarUtils.tsx");
  }
  let tmp10Result;
  if (null != userAvatarSource) {
    const obj8 = { source: null, variant: "entity" };
    obj8[0] = userAvatarSource;
    tmp10Result = tmp10(tmp4(4695).Button.Icon, obj8);
  }
  if (null != stateFromStores) {
  ...
  const items4 = [callback2(invite(4695).Button, { icon: tmp10Result, variant: "primary", size: "lg", text: tmp24, accessibilityLabel: stringResult, onPress: handleAcceptInvitePress, loading: tmp3 === constants2.ACCEPT, disabled: tmp3 === constants2.ACCEPT }), ];
  ...
  items4[1] = callback2(invite(4695).Button, {
    variant: "secondary",
    size: "lg",
    text: stringResult1,
  ...
  obj12[0] = items4;
  items2[6] = closure_13(invite(5117).ButtonGroup, obj12);
  obj11[0] = items2;
