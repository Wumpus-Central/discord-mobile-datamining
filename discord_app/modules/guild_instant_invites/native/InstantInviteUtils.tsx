...
export const useInviteActions = function useInviteActions(invite) {
  ...
  obj[1] = onInviteRevoked(9625).share;
  obj[2] = function action() {
    onInviteRevoked(9632)(() => {
  ...
  obj[1] = onInviteRevoked(9625).copy;
  obj[2] = function action() {
    if (c3) {
      ...
      tmpResult = tmp(5696);
      tmpResult.copy(onInviteRevoked(7158)(invite.code));
  ...
  obj1[1] = onInviteRevoked(9625).revoke;
