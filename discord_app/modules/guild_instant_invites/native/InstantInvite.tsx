...
import memoResult1Default from "../../guild_settings/native/DetailedGuildIdentityUserRow.tsx";
...
export const LinkedChannelInvite = function LinkedChannelInvite(channel) {
    ...
    callback(channel(8811).ContextMenu, {
      ...
      children(ref) {
        ...
        const obj = {
          size: "sm",
          variant: "secondary",
          icon: canUnlinkLobbyChannel(10899).more,
          accessibilityLabel: null,
          ref: null,
        };
        const intl = channel(1233).intl;
  ...
  obj4[1] = tmp15Result;
  items4[2] = callback(channel(4927).Stack, {
