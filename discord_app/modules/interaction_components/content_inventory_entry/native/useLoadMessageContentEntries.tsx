...
import transformContentInventoryEntryMessageComponent from "transformContentInventoryEntryMessageComponent" /* 8192 */;
...
new fn(9097).PromiseDeduper();
const promiseDeduper = new fn(9097).PromiseDeduper();
const promiseDeduper1 = new fn(9097).PromiseDeduper();
const size = fn(2);
