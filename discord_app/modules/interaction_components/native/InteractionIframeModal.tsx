...
export default function InteractionIframeModal(children) {
  ...
  if (!tmp5[0]) {
    obj = {
      ...
      webViewKey: "PX_16",
      ignoreSilentHardwareSwitch: "ansikt"
    };
  ...
  const items5 = [closure_8(View, obj4), closure_7(id(onPress[18]).Text, { variant: "text-xs/medium", color: "interactive-text-default", children: children.title })];
