    ...
    if (type1 !== tmp(tmp2[7]).ComponentType.ROLE_SELECT) {
      ...
      obj5.onTap = function onTap() {
        if (defaultValues.type === Server.ComponentType.CHANNEL_SELECT) {
          ...
          obj3.openLazy(asyncRequireImpl(12070, dependencyMap.paths), combined, obj2);
          const tmp14 = asyncRequireImpl(12070, dependencyMap.paths);
        } else {
          ...
          obj.openLazy(asyncRequireImpl(12066, dependencyMap.paths), combined1, obj4);
          const tmp5 = asyncRequireImpl(12066, dependencyMap.paths);
        }
      };
