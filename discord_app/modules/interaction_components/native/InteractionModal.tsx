...
class InteractionModal {
  constructor(arg0) {
    ...
    obj3 = { style: tmp.titleView, children: jsx(closure_0(closure_2[11]).Text, { variant: "heading-xl/semibold", color: "mobile-text-heading-primary", children: global.title }) };
...
createStyles.modalContent = { flexGrow: 1, paddingHorizontal: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_16 };
let obj1 = { flexGrow: 1, paddingHorizontal: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_16 };
createStyles.header = { flexDirection: "row", marginBottom: nativeDefault.space.PX_16, paddingHorizontal: nativeDefault.space.PX_16 };
createStyles.titleView = { flex: 1 };
let obj2 = { flexDirection: "row", marginBottom: nativeDefault.space.PX_16, paddingHorizontal: nativeDefault.space.PX_16 };
