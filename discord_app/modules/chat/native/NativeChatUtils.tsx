...
obj = {
  scrollTo(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp5(10942).Commands;
  ...
  scrollToBottom(arg0, arg1) {
    if (null != arg0) {
      if (obj.isIOS()) {
        ...
        const Commands = tmp2(10942).Commands;
  ...
  scrollIntoView(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp4(10942).Commands;
  ...
  updateRows(arg0, rows) {
    ...
    if (null != arg0) {
      if (obj7.isIOS()) {
        let tmp35Result = tmp35(4165);
        if (tmp35Result.isFabric()) {
          tmp35Result = tmp35(10943);
          ...
          const Commands = tmp35(10942).Commands;
          const _JSON3 = JSON;
      ...
      if (null != tmp2) {
        ...
        const andIncrementChangesetIdForChat1 = tmp35(10943).getAndIncrementChangesetIdForChat(arg0);
        ...
        const tmp35Result2 = tmp35(10943);
      }
      obj7 = set;
    }
  },
    ...
    if (null != arg0) {
      if (obj5.isIOS()) {
        ...
        if (tmp7Result.isFabric()) {
          const Commands = tmp7(10942).Commands;
          tmp7Result = tmp7(10943);
      ...
      if (null != tmp2) {
        ...
        DCDChatManager.clearRows(tmp2, tmp7(10943).getAndIncrementChangesetIdForChat(arg0));
        const tmp7Result2 = tmp7(10943);
      }
      obj5 = set;
    }
  },
    ...
    if (null != arg0) {
      if (obj.isIOS()) {
        if (tmpResult.isFabric()) {
          const Commands = tmp(10942).Commands;
