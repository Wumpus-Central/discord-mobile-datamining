...
obj = {
  scrollTo(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp5(11008).Commands;
  ...
  scrollToBottom(arg0, arg1) {
    if (null != arg0) {
      if (obj.isIOS()) {
        ...
        const Commands = tmp2(11008).Commands;
  ...
  scrollIntoView(arg0, arg1, arg2) {
    if (null != arg0) {
      ...
      if (obj2.isIOS()) {
        ...
        const Commands = tmp4(11008).Commands;
  ...
  updateRows(arg0, rows) {
    ...
    if (null != arg0) {
      if (obj7.isIOS()) {
        let tmp35Result = tmp35(4039);
        if (tmp35Result.isFabric()) {
          tmp35Result = tmp35(11009);
          ...
          const Commands = tmp35(11008).Commands;
          const _JSON3 = JSON;
      ...
      if (null != tmp2) {
        ...
        const andIncrementChangesetIdForChat1 = tmp35(11009).getAndIncrementChangesetIdForChat(arg0);
        ...
        const tmp35Result2 = tmp35(11009);
      }
      obj7 = set;
    }
  },
    ...
    if (null != arg0) {
      if (obj5.isIOS()) {
        ...
        if (tmp7Result.isFabric()) {
          const Commands = tmp7(11008).Commands;
      ...
      if (null != tmp2) {
        ...
        DCDChatManager.clearRows(tmp2, tmp7(11009).getAndIncrementChangesetIdForChat(arg0));
        const tmp7Result2 = tmp7(11009);
      }
      obj5 = set;
    }
  },
    ...
    if (null != arg0) {
      if (obj.isIOS()) {
        if (tmpResult.isFabric()) {
          const Commands = tmp(11008).Commands;
