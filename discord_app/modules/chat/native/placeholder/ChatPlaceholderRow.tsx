...
obj = { paddingLeft: nativeDefault.space.PX_12, paddingTop: fn(12670).CHAT_PLACEHOLDER_ROW_MARGIN_TOP, flexDirection: "row" };
obj.row = obj;
...
let obj2 = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_MUTED, height: fn(12670).CHAT_PLACEHOLDER_ROW_LINE_HEIGHT, borderRadius: nativeDefault.radii.sm };
obj.placeholderBody = { marginTop: fn(12670).CHAT_PLACEHOLDER_ROW_LINE_MARGIN_TOP, width: "100%" };
let closure_5 = createStyles.createStyles(obj);
let obj3 = { marginTop: fn(12670).CHAT_PLACEHOLDER_ROW_LINE_MARGIN_TOP, width: "100%" };
size = fn(2);
