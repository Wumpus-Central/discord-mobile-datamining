...
export const ChannelHeaderLoadingIndicator = function ChannelHeaderLoadingIndicator() {
  ...
  fn.__closure = { useReducedMotion: stateFromStores, withRepeat: stateFromStores(4566).withRepeat, withSequence: stateFromStores(4566).withSequence, withTiming: stateFromStores(4837).withTiming, Easing: stateFromStores(4566).Easing };
  ...
  items3[1] = closure_13(stateFromStores(4832).Text, obj7);
