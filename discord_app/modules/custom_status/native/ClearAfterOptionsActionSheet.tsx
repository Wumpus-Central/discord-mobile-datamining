// === Module 12089: ClearAfterOptionsActionSheet ===
...
export default function ClearAfterOptionsActionSheet(arg0) {
  ...
  obj[1] = callback2(require(5308) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj);
  ...
  obj[4] = ClearAfterOptions.map((value) => {
    ...
    obj[1] = callback2(12090)(value);
    return callback3(callback(7782).TableRadioRow, obj, value);
  });
  const items = [callback2(require(7783) /* context */.TableRadioGroup, obj), ];
  ...
  obj[2] = items;
  return callback3(require(5309) /* Background */.BottomSheet, obj);
};