...
let result = obj132.fileFinishedImporting("modules/custom_status/utils/formatClearAfterOption.tsx");
...
export default function formatClearAfterOption(arg0) {
  if (ClearAfterValues.TODAY === arg0) {
    ...
    if (isSameDayResult) {
      ...
      formatTimeResult = intl9.formatToPlainString(getSystemLocale.t.DN91Jz, obj);
    }
    ...
    if (isSameDayResult1) {
      ...
      formatTimeResult1 = intl7.formatToPlainString(getSystemLocale.t.DN91Jz, obj);
    }
    ...
    if (isSameDayResult2) {
      ...
      formatTimeResult2 = intl5.formatToPlainString(getSystemLocale.t.DN91Jz, obj1);
    }
    ...
    if (isSameDayResult3) {
      ...
      formatTimeResult3 = intl3.formatToPlainString(getSystemLocale.t.DN91Jz, obj2);
    }
