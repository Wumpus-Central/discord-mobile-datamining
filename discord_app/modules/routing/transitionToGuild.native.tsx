// === Module 6151: transitionToGuild ===

// Module 6151 (transitionToGuild)
import set from "set" /* 2 */;
import ME from "ME" /* 676 */;
import transitionTo from "transitionTo" /* 1222 */;
import LayoutAnimation from "LayoutAnimation" /* 5561 */;
import getChannelIdForGuildTransition from "getChannelIdForGuildTransition" /* 6029 */;
...
export const transitionToGuild = function transitionToGuild(guildId) {
  ...
  const result = LayoutAnimation.DeprecatedLayoutAnimation({ duration: 0, create: "r", update: "container", delete: "description" });
