...
export const transitionToChannel = function transitionToChannel(id, openTextInVoiceIfVoiceChannel) {
  ...
  if (null != channel) {
    const guildIdForGenericRedirect = useGuildIdForChannelRoute /* useGuildIdForChannelRoute */.getGuildIdForGenericRedirect(channel);
    const obj3 = useGuildIdForChannelRoute /* useGuildIdForChannelRoute */;
...
export const transitionToThread = function transitionToThread(channel, arg1) {
  ...
  let obj = useGuildIdForChannelRoute /* useGuildIdForChannelRoute */;
...
export const tryTransitionToThreadMessage = function tryTransitionToThreadMessage(parentChannelId, threadId, messageId) {
  ...
  if (null != channel) {
    ...
    if (null != channel1) {
      const guildIdForGenericRedirect1 = useGuildIdForChannelRoute /* useGuildIdForChannelRoute */.getGuildIdForGenericRedirect(channel1);
      const obj7 = useGuildIdForChannelRoute /* useGuildIdForChannelRoute */;
      const tmp20 = importDefault;
      ChannelActionCreators.preload(channel1.guild_id, channel1.id);
      const obj8 = ChannelActionCreators;
      obj = { openChannel: true };
      const obj9 = transitionTo /* transitionTo */;
