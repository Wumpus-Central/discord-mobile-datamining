...
export const transitionToChannel = function transitionToChannel(id, openTextInVoiceIfVoiceChannel) {
  ...
  if (null != channel) {
    const guildIdForGenericRedirect = require("useGuildIdForChannelRoute.tsx") /* useGuildIdForChannelRoute */.getGuildIdForGenericRedirect(channel);
    const obj3 = require("useGuildIdForChannelRoute.tsx") /* useGuildIdForChannelRoute */;
    const tmp7 = importDefault;
    require("../../actions/ChannelActionCreators.tsx").preload(channel.guild_id, channel.id);
    const obj4 = require("../../actions/ChannelActionCreators.tsx");
    const obj = { openChannel: true };
    const obj5 = require("router_utils.tsx") /* transitionTo */;
...
export const transitionToThread = function transitionToThread(channel, arg1) {
  require("../../../_runtime/metro/00038__.js")(null != channel.parent_id, "Thread must have a parent ID.");
  let obj = require("useGuildIdForChannelRoute.tsx") /* useGuildIdForChannelRoute */;
  const guildIdForGenericRedirect = obj.getGuildIdForGenericRedirect(channel);
  obj = { openChannel: true };
  const obj2 = require("router_utils.tsx") /* transitionTo */;
...
export const tryTransitionToThreadMessage = function tryTransitionToThreadMessage(parentChannelId, threadId, messageId) {
  ...
  if (null != channel) {
    ...
    const obj3 = require("useGuildIdForChannelRoute.tsx") /* useGuildIdForChannelRoute */;
    obj = { openChannel: true };
    const obj4 = require("router_utils.tsx") /* transitionTo */;
    ...
    if (null != channel1) {
      const guildIdForGenericRedirect1 = require("useGuildIdForChannelRoute.tsx") /* useGuildIdForChannelRoute */.getGuildIdForGenericRedirect(channel1);
      const obj7 = require("useGuildIdForChannelRoute.tsx") /* useGuildIdForChannelRoute */;
      const tmp20 = importDefault;
      require("../../actions/ChannelActionCreators.tsx").preload(channel1.guild_id, channel1.id);
      const obj8 = require("../../actions/ChannelActionCreators.tsx");
      obj = { openChannel: true };
      const obj9 = require("router_utils.tsx") /* transitionTo */;
...
export const transitionToStaticChannelRoute = function transitionToStaticChannelRoute(guildId, GUILD_HOME) {
  let obj = require("router_utils.tsx") /* transitionTo */;
  obj = { openChannel: true };
  const merged = Object.assign(arg2);
