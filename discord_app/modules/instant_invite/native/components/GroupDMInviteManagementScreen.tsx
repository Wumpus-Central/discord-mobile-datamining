// === Module 9834: GroupDMInviteManagement ===
...
import closure_8 from "createFromServer" /* 7905 */;
import normalizeChannelPropertyForCompare from "normalizeChannelPropertyForCompare" /* 8168 */;
...
function GroupDMInviteManagement(channelId) {
  ...
  if (tmp3[0]) {
    let tmp14 = jsx(channelId(5928).SceneLoadingIndicator, {});
...
const memoResult = importAllResult.memo(function GroupDMInviteManagementScreen(channelId) {
  ...
  return jsx(channelId(5889).Navigator, { screens: memo, initialRouteName: constants.INSTANT_INVITES_MANAGEMENT });
});
