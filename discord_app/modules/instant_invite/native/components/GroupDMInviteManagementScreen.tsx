// === Module 10381: GroupDMInviteManagementScreen ===
...
import InstantInviteDefault from "InstantInvite" /* 10382 */;
...
function GroupDMInviteManagement(channelId) {
  ...
  if (tmp3[0]) {
    let tmp14 = jsx(channelId(6455).SceneLoadingIndicator, {});
  } else if (0 === first.length) {
    let obj2 = { lightSource: tmp4(10400), darkSource: tmp4(10401), title: null, body: null };
    ...
    tmp14 = jsx(channelId(1177).EmptyState, { lightSource: tmp4(10400), darkSource: tmp4(10401), title: null, body: null });
  } else {
...
const ChannelSettingsStore = fn(8078);
...
export default noop.memo(function GroupDMInviteManagementScreen(channelId) {
  ...
  return jsx(channelId(6416).Navigator, { screens: memo, initialRouteName: constants.INSTANT_INVITES_MANAGEMENT });
});