...
import InstantInviteDefault from "InstantInvite" /* 10393 */;
...
function GroupDMInviteManagement(channelId) {
  ...
  if (tmp3[0]) {
    let tmp14 = jsx(channelId(6460).SceneLoadingIndicator, {});
  } else if (0 === first.length) {
    let obj2 = { lightSource: tmp4(10411), darkSource: tmp4(10412), title: null, body: null };
    ...
    tmp14 = jsx(channelId(1177).EmptyState, { lightSource: tmp4(10411), darkSource: tmp4(10412), title: null, body: null });
  } else {
...
const ChannelSettingsStore = fn(8086);
