// === Module 10195: InstantInviteEmptyState ===

// Module 10195 (InstantInviteEmptyState)
import nativeDefault from "native" /* 576 */;
import FreeFormTextInputDefault from "FreeFormTextInput" /* 7268 */;
...
export default function _default(link) {
  ...
  const obj3 = { containerStyle: tmp.emptyStateContainer, imageStyle: tmp.emptyStateArt, titleStyle: tmp.emptyStateTitle, source: _modDef10196, title: null, body: null };
  ...
  obj6.children = closure_5(stateFromStores(7708).SettingsIcon, {});
  items2[1] = closure_5(stateFromStores(5425).PressableOpacity, obj6);
  ...
  if (null == stateFromStores) {
    ...
    items1[3] = closure_5(tmp2(5271).Button, obj8);
