...
import registerAssetDefault from "registerAsset" /* 12507 */;
import registerAssetDefault2 from "registerAsset" /* 12508 */;
...
export default function GuildInviteActionSheet(arg0) {
  ...
  obj = { scrollable: true, startExpanded: true, header: callback2(_require(5573).BottomSheetTitleHeader, obj), contentStyles: tmp.content, children: null };
