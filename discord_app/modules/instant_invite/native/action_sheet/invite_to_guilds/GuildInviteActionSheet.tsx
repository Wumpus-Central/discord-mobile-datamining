...
function GuildList(recipientId) {
  ...
  if (0 === arr.length) {
    ...
    obj = { paddingTop: num, paddingBottom: source(7033)().insets.bottom + source(576).space.PX_16 };
    ...
    return closure_6(tmp(11223).UserProfileStackedActionSheetSectionList, obj);
  }
