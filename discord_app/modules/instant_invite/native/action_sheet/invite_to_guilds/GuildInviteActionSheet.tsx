...
import { registerAsset } from "../../../../../../_runtime/12377_registerAsset.js";
import { registerAsset } from "../../../../../../_runtime/12378_registerAsset.js";
...
function GuildList(recipientId) {
  ...
  if (0 === arr.length) {
    ...
    obj[0] = num;
    obj[1] = source(5295)().insets.bottom + source(712).space.PX_16;
    obj[1] = obj;
    obj[2] = items;
    ...
    return closure_6(tmp(9357).UserProfileStackedActionSheetSectionList, obj);
  }
