...
export default function SelectInviteRolesActionSheet(assignableRoles) {
  ...
  const callback2 = first.useCallback((arg0, arg1) => {
    assignableRoles = tmp;
    const obj = {
      label: closure_5(selectedRoleIds(onSave[9]), {
      ...
      trailing: closure_5(assignableRoles(onSave[8]).FormRow.Checkbox, {
  ...
  const obj4 = {
    scrollable: true,
    header: closure_5(assignableRoles(onSave[13]).BottomSheetTitleHeader, obj3),
    startExpanded: true,
    children: null,
  };
  const obj5 = {
