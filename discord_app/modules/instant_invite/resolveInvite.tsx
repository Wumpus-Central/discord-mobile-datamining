...
export default function resolveInvite(inviteKey, _location, inviteInstanceId) {
  ...
  if (map.has(inviteKey)) {
    ...
    obj = { inputValue, with_counts: true, with_expiration: true, guild_scheduled_event_id: guildScheduledEventId, target_channel_id: targetChannelId, target_message_id: targetMessageId, with_permissions: true, with_games: null, with_guild_experiments: null };
    let withGames;
    if (inviteInstanceId != null) {
    ...
    const request = { url: closure_7.INVITE(baseCode), query: obj, oldFormErrors: true, trackedActionData: null, rejectWithError: false };
    obj1 = {
    ...
    const cleanupPromise = value.then((body) => {
      ...
      if (null != closure_1) {
        ...
        let obj = { resolved: true, guild_id: id, channel_id: null, channel_type: null, inviter_id: null, code: null, input_value: null, location: null, authenticated: null, size_total: null, size_online: null, destination_user_id: null, invite_type: null, user_is_member: null, invite_instance_id: null };
        let id1 = null;
      ...
      if (null != closure_1) {
        let obj = { resolved: false, code: baseCode, input_value: null, location: null, authenticated: null, user_banned: null, error_code: null, error_message: null };
        let inputValue;
        if (inviteInstanceId != null) {
          inputValue = inviteInstanceId.inputValue;
        }
