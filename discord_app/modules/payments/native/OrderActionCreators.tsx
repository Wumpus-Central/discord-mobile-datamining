...
let closure_12 = async function _getOrCreateOrder() {
  ...
  await "PX_16";
  await closure_130_7({ isGift: closure_129_4, status: closure_130_4.DRAFT, skuId: closure_129_0, createdAfter: closure_129_6 });
  closure_129_9 = value;
  ...
  const obj7 = { paymentGateway: closure_129_1, recipientUserId: closure_129_2, isGift: closure_129_4, giftInfo: closure_129_5, orderLineItems: null, externalGatewayFacet: closure_129_8 };
...
let closure_15 = async function _updateOrder() {
  ...
  closure_129_6 = closure_3;
  closure_130_0(closure_130_2[5]);
  const obj5 = { tags: { source: "OrderActionCreators_updateOrder" }, extra: { orderId: closure_129_0, giftInfo: closure_129_1 } };
