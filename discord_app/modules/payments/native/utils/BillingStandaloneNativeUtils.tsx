// === Module 7157: emitMWRCSentryErrorOnFailure ===
...
import MOBILE_WEB_REDIRECT_CHECKOUT_ERROR_TAG from "MOBILE_WEB_REDIRECT_CHECKOUT_ERROR_TAG" /* 7158 */;
...
export const goToStandaloneNitroManagementFromMobileApp = function goToStandaloneNitroManagementFromMobileApp(premium_external_management, loadId, arg2, arg3) {
  ...
  dependencyMap = arg2;
  CustomCheckoutFlow = arg3;
  const obj = _require(7159);
  const tmp = _require;
  if (obj2.isMetaQuest()) {
    let result = obj3.BILLING_MANAGE_SUBSCRIPTION_WITH_FLOW_TYPE(CustomCheckoutFlow.META_QUEST_WEB_REDIRECT_CHECKOUT, loadId);
  } else {
    result = obj3.BILLING_MANAGE_SUBSCRIPTION_WITH_DEEP_LINK(tmp(688).LinkingTypes.MOBILE_WEB_REDIRECT_CHECKOUT, loadId);
  }
