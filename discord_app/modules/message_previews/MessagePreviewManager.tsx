// === Module 15319: MessagePreviewManager ===

// Module 15319 (MessagePreviewManager)
import LoggerDefault from "Logger" /* 3 */;
import _modDef12 from "module_12" /* 12 */;
import RemoteFetchData from "RemoteFetchData" /* 15320 */;
...
class MessagePreviewManager extends tmp3 {
  constructor() {
    ...
    applyArgumentsResult.remoteTick = obj.debounce(closure_4(async () => {
      if (c8 === 2) {
        c8 = 3;
...
prototype["fetchDms"] = function fetchDms(nextWants) {
  ...
  if (0 === nextWantsResult.length) {
    ...
    resolved = nextWants.try(nextWantsResult, asyncGeneratorStep(async () => {
      if (c3 === 2) {
        c3 = 3;
        throw new TypeError("Generator functions may not be called on executing generators");
      } else if (tmp4 === 3) {
