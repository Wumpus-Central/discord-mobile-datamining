...
export const getSummaryFeedbackReasons = function getSummaryFeedbackReasons() {
  ...
  obj[1] = intl.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.wwXl5h);
  const items = [obj, , , , , ];
  obj = { value: obj.TOO_GENERIC, label: null };
  const intl2 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[1] = intl2.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["t+6knu"]);
  items[1] = obj;
  obj = { value: obj.TOO_MANY, label: null };
  const intl3 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[1] = intl3.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.xnKDnv);
  items[2] = obj;
  const obj1 = { value: obj.INACCURATE, label: null };
  const intl4 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[1] = intl4.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.JW5VFj);
  items[3] = obj1;
  const obj2 = { value: obj.NOT_USEFUL, label: null };
  const intl5 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj2[1] = intl5.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.ZtCNiY);
  items[4] = obj2;
  const obj3 = { value: obj.OTHER, label: null };
  const intl6 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj3[1] = intl6.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.BufsKk);
  items[5] = obj3;
  return items;
};