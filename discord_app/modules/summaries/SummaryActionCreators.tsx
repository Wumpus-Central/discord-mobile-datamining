      ...
      if (0 === c7) {
        ...
        if (arg0 === 1) {
          ...
          if (0 === substr.length) {
            ...
            const obj5 = { type: "REQUEST_CHANNEL_SUMMARIES_BULK", channelIds: closure_131_0, requestedAt: closure_131_3 };
        ...
        const obj8 = { type: "RECEIVE_CHANNEL_SUMMARIES_BULK", requestedAt: closure_131_3, receivedAt: null, summaries: null, requestArgs: null, error: null };
        const _Date = Date;
