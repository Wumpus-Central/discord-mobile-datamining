      ...
      try {
        ...
        if (0 === c6) {
          ...
          const obj4 = {
            ...
            summary: closure_130_3,
            error: closure_130_2,
            requestedAt: closure_130_1,
            receivedAt: null,
          };
          const _Date = Date;
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          if (SummaryStore.shouldFetchChannelAffinities()) {
            ...
            c6 = 1;
            const obj2 = {
              value: HTTP.get({ url: "/users/@me/affinities/channels", rejectWithError: false }),
              done: false,
            };
            return obj2;
          } else {
