...
import closure_7 from "handleQuickSwitcherUpdate" /* 10455 */;
      ...
      if (c8 === 2) {
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (1 === dispatchResult1) {
              c6 = 0;
              const aPIError = new callback(4342).APIError(closure_5);
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (2 === tmp7) {
              summaries = 0;
              c7 = _undefined;
              aPIError = new substr(4342).APIError(c7);
            } else if (arg0 === 1) {
              constants = 3;
              throw arg1;
            } else if (arg0 === 2) {
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            c4 = 0;
            callback = closure_3;
            const aPIError = new lib(4342).APIError(callback);
            throw aPIError;
          } else if (arg0 === 1) {
            c6 = 3;
            throw arg1;
