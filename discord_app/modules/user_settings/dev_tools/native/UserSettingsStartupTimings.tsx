...
export default function UserSettingsStartupTimings() {
  ...
  const onPress = obj.useCallback(first1(function*() {
    if (c3 === 2) {
      c3 = 3;
  ...
  obj.ListHeaderComponent = function ListHeaderComponent() {
    ...
    const obj24 = { title: "Share Timings", hasIcons: true, children: React6(TableRow.TableRow, { icon: React6(ShareIcon.ShareIcon, {}), label: "Copy timings to clipboard.", arrow: true, onPress }) };
  ...
  obj.children = closure_8(require("module_8964").FlashList, obj);
