...
let result = require("set").fileFinishedImporting(
  "modules/user_settings/dev_tools/native/UserSettingsStartupTimings.tsx",
);
...
export default function UserSettingsStartupTimings() {
  ...
  const lastTrackedAppUiViewed2Properties =
    require("../../../tti_analytics/native/TTIAnalyticsUtils.tsx").getLastTrackedAppUiViewed2Properties();
  num = undefined;
  ...
  obj[1] = function ListHeaderComponent() {
    ...
    const items1 = [
      "Native: ",
      callback(lastTrackedAppUiViewed2Properties, {
        color: "text-brand",
        children: "" + result + "s (" + Math.round((closure_7 / num) * 100) + "%)",
      }),
    ];
    obj1[0] = items1;
    ...
    const items3 = [
      ...
      callback(lastTrackedAppUiViewed2Properties, {
        color: "text-brand",
        children: "" + result1 + "s (" + Math.round((closure_11 / num) * 100) + "%)",
      }),
    ];
    obj3[0] = items3;
    ...
    const items4 = [
      ...
      callback(lastTrackedAppUiViewed2Properties, {
        color: "text-brand",
        children: "" + result2 + "s (" + Math.round((callback / num) * 100) + "%)",
      }),
    ];
    obj5[0] = items4;
    ...
    const items5 = [
      ...
      callback(lastTrackedAppUiViewed2Properties, {
        color: "text-brand",
        children: "" + result3 + "s (" + Math.round((callback2 / num) * 100) + "%)",
      }),
    ];
    obj7[0] = items5;
    ...
    const items6 = [
      ...
      callback(lastTrackedAppUiViewed2Properties, {
        color: "text-brand",
        children: "" + result4 + "s (" + Math.round((closure_10 / num) * 100) + "%)",
      }),
    ];
    obj9[0] = items6;
    ...
    const items7 = [
      "TTI (first contentful paint): ",
      callback(lastTrackedAppUiViewed2Properties, { color: "text-brand", children: str }),
    ];
    obj11[0] = items7;
    ...
    const items8 = [
      "Cached Messages Render: ",
      callback(lastTrackedAppUiViewed2Properties, { color: "text-brand", children: str3 }),
    ];
    obj12[0] = items8;
    ...
    const items9 = [
      "Latest Messages Render: ",
      callback(lastTrackedAppUiViewed2Properties, { color: "text-brand", children: str5 }),
    ];
    obj17[0] = items9;
    ...
    const items10 = [
      callback2(lastTrackedAppUiViewed2Properties, { children: ["\u2615", " - Java / Kotlin"] }),
      callback2(lastTrackedAppUiViewed2Properties, { children: ["\u{1F3A8}", " - React render"] }),
      callback2(lastTrackedAppUiViewed2Properties, { children: ["\u{1F4BE}", " - CacheStore"] }),
      callback2(lastTrackedAppUiViewed2Properties, { children: ["\u{1F9A5}", " - Slow Store Update / Handler"] }),
      callback2(lastTrackedAppUiViewed2Properties, { children: ["\u{1F3C3}", " - Startup Event"] }),
      callback2(lastTrackedAppUiViewed2Properties, { children: ["\u{1F310}", " - Socket Event"] }),
    ];
    obj20[0] = items10;
    ...
    obj24[2] = callback(lib(5599).TableRow, {
      icon: callback(lib(12779).ShareIcon, {}),
