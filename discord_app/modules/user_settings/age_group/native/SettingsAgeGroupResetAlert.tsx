...
export default function SettingsAgeGroupResetAlert() {
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              obj1[0] = outer1_0(12840).resetAgeVerification();
              return obj1;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
            let obj2 = outer1_0(3893);
  ...
  obj[0] = intl.string(_handleConfirm(2743)["bD//cU"]);
  const intl2 = _require(1236).intl;
  obj[1] = intl2.string(_handleConfirm(2743).FbTAmI);
  obj = { children: null };
  let obj1 = {
    variant: "destructive",
  ...
  obj1[2] = intl3.string(_handleConfirm(2743).V822Mp);
  const items = [callback(_require(4537).AlertActionButton, obj1, "confirm"), ];
  let obj2 = { variant: "secondary", text: null };
  const intl4 = _require(1236).intl;
  obj2[1] = intl4.string(_require(1236).t["ETE/oC"]);
  items[1] = callback(_require(4537).AlertActionButton, obj2, "cancel");
  obj[0] = items;
  obj[2] = callback2(_require(4537).AlertActions, obj);
