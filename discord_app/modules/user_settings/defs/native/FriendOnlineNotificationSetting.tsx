...
const toggle = createToggle.createToggle({
  useTitle() {
    ...
    return intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["uvIi/4"]);
  },
  useDescription() {
    const intl = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.E6O06k);
  },
  ...
  usePredicate: function useExperiment() {
    return require("../../../notifications/friend_online/FriendOnlineNotificationExperiment.tsx") /* apexExperiment */.useFriendOnlineNotificationExperiment("tabsV2Settings").showSettingsToggle;
  }
});
const obj = {
  useTitle() {
