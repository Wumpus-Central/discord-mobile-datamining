...
import { PHONE_VERIFICATION_MODAL_KEY as closure_4 } from "PHONE_VERIFICATION_MODAL_KEY" /* 8664 */;
...
createToggle = {
  ...
  onPress: function onAccountPhoneSettingPress() {
    ...
    obj.pushLazy(asyncRequireImpl(8663, dependencyMap.paths), obj, closure_4);
  },
  withArrow: true
};
