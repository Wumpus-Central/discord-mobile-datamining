...
obj = {
  useTitle() {
    ...
    return intl.string(getSystemLocale /* getSystemLocale */.t["7qKDrE"]);
  },
...
obj = {
  ...
  getComponent() {
    return UserSettingsConfirmPasswordWrapped /* UserSettingsConfirmPasswordWrapped */.UserSettingsConfirmPasswordWrapped;
  }
};
