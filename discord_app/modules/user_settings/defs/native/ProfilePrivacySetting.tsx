...
const radio = createToggle.createRadio({
  ...
  onValueChange(arg0) {
    ...
    if (obj.getIsInPrivateProfilesExperiment("ProfilePrivacySetting")) {
      const profileToActivityUpsell = computeAffectedGuilds.computeProfileToActivityUpsell(setting, NumberResult);
      if (null != profileToActivityUpsell) {
        ...
        ACTION_SHEET_HEIGHT_HALFDefault.openLazy(asyncRequireImpl(14209, dependencyMap.paths), "ProfileToActivityPrivacyUpsellActionSheet", obj);
      }
      const tmp2Result = computeAffectedGuilds;
    }
  },
  useOptions() {
...
const result = obj132.fileFinishedImporting("modules/user_settings/defs/native/ProfilePrivacySetting.tsx");
