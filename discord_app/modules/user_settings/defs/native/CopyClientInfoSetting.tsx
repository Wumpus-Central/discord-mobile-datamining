...
function getClientInfo() {
  ...
  let tmp;
  if (overrides != null) {
    tmp = overrides[require(undefined, 11115) /* setBuildOverrideForBranch */.DEVICE_FIELD];
  }
  let str2 = "N/A";
...
function ClientClientInfoActionSheet() {
  ...
  obj[2] = function onPress() {
    callback(5609).copy(callback2().appVersion);
    const obj = callback(5609);
    const result = callback(3955).presentCopiedToClipboard();
  };
  const items = [callback(require(5619) /* ActionSheetRowIcon */.ActionSheetRow, obj), , , , , , ];
  ...
  obj1[2] = function onPress() {
    callback(5609).copy(callback2().buildNumber);
    const obj = callback(5609);
    const result = callback(3955).presentCopiedToClipboard();
  };
  items[1] = callback(require(5619) /* ActionSheetRowIcon */.ActionSheetRow, obj1);
  ...
  obj2[2] = function onPress() {
    callback(5609).copy(callback2().releaseChannel);
    const obj = callback(5609);
    const result = callback(3955).presentCopiedToClipboard();
  };
  items[2] = callback(require(5619) /* ActionSheetRowIcon */.ActionSheetRow, obj2);
  ...
  obj3[2] = function onPress() {
    callback(5609).copy(callback2().manifest);
    const obj = callback(5609);
    const result = callback(3955).presentCopiedToClipboard();
  };
  items[3] = callback(require(5619) /* ActionSheetRowIcon */.ActionSheetRow, obj3);
  ...
  obj4[2] = function onPress() {
    callback(5609).copy(callback2().buildOverride);
    const obj = callback(5609);
    const result = callback(3955).presentCopiedToClipboard();
  };
  items[4] = callback(require(5619) /* ActionSheetRowIcon */.ActionSheetRow, obj4);
  let obj7 = require(4119) /* isFabric */;
  let tmp4Result = null;
  if (obj7.isFabric()) {
    const obj5 = { label: "React Native New Architecture", subLabel: "Enabled", onPress: null };
    obj5[2] = function onPress() {
      callback(5609).copy("React Native New Architecture is enabled.");
      const obj = callback(5609);
      const result = callback(3955).presentCopiedToClipboard();
    };
    tmp4Result = tmp4(tmp2(5619).ActionSheetRow, obj5);
  }
  items[5] = tmp4Result;
  tmp4Result = null;
  if (tmp2Result.isFabric()) {
    ...
    obj6[2] = function onPress() {
      ...
      let tmpResult = tmp(5609);
      tmpResult.copy(combined);
      tmpResult = tmp(3955);
      const result = tmpResult.presentCopiedToClipboard();
    };
    tmp4Result = tmp4(tmp2(5619).ActionSheetRow, obj6);
  }
  items[6] = tmp4Result;
  const items1 = [closure_5(require(5619) /* ActionSheetRowIcon */.ActionSheetRow.Group, { hasIcons: false, children: items }), ];
  ...
  obj8[2] = function onPress() {
    ...
    callback(5609).copy(combined);
    const obj3 = callback(5609);
    const result = callback(3955).presentCopiedToClipboard();
  };
  obj7[1] = callback(require(5619) /* ActionSheetRowIcon */.ActionSheetRow, obj8);
  items1[1] = callback(require(5619) /* ActionSheetRowIcon */.ActionSheetRow.Group, obj7);
  obj[2] = items1;
  return closure_5(require(5617) /* ActionSheet */.ActionSheet, obj);
}
