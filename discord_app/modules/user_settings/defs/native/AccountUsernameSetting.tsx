...
import useCurrentUserHasAutomodQuarantinedProfile from "useCurrentUserHasAutomodQuarantinedProfile" /* 11406 */;
...
createToggle = {
  ...
  getComponent() {
    return require(14331) /* UsernameStatusMessage */.default;
  }
};
