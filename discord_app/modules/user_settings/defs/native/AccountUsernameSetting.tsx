...
import useCurrentUserHasAutomodQuarantinedProfile from "useCurrentUserHasAutomodQuarantinedProfile" /* 11444 */;
...
createToggle = {
  ...
  getComponent() {
    return require(14364) /* UsernameStatusMessage */.default;
  }
};
