...
const toggle = createToggle.createToggle({
  useTitle() {
    ...
    return intl.string(require(1236) /* getSystemLocale */.t.IQO6Bi);
  },
  useDescription() {
    const intl = require(1236) /* getSystemLocale */.intl;
    return intl.string(require(1236) /* getSystemLocale */.t.TUKMak);
  },
  ...
  onValueChange(arg0) {
    const tmp = callback();
    const sanitizedActivityRestrictedGuilds = require(5922) /* getSanitizedRestrictedGuilds */.getSanitizedActivityRestrictedGuilds();
    if (arg0) {
