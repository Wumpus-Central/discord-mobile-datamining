...
const toggle = createToggle.createToggle({
  useTitle() {
    ...
    return intl.string(getSystemLocale /* getSystemLocale */.t.IQO6Bi);
  },
  useDescription() {
    const intl = getSystemLocale /* getSystemLocale */.intl;
    return intl.string(getSystemLocale /* getSystemLocale */.t.TUKMak);
  },
  ...
  onValueChange(arg0) {
    const tmp = callback();
    const sanitizedActivityRestrictedGuilds = getSanitizedRestrictedGuilds /* getSanitizedRestrictedGuilds */.getSanitizedActivityRestrictedGuilds();
    if (arg0) {
