...
createToggle = {
  ...
  useValue: function useDataToImproveDiscordSettingValue() {
    ...
    return initialize /* initialize */.useStateFromStores(items, () => hasConsented.hasConsented(constants.USAGE_STATISTICS));
  },
  onValueChange: function handleUsageStatisticsChange(arg0) {
    if (arg0) {
      ...
      const intl = getSystemLocale /* getSystemLocale */.intl;
      obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t.OdPCbN);
      const intl2 = getSystemLocale /* getSystemLocale */.intl;
      obj[1] = intl2.string(getSystemLocale /* getSystemLocale */.t.MGWabA);
      const intl3 = getSystemLocale /* getSystemLocale */.intl;
      obj[2] = intl3.string(getSystemLocale /* getSystemLocale */.t["D3+rU4"]);
      const intl4 = getSystemLocale /* getSystemLocale */.intl;
      obj[3] = intl4.string(getSystemLocale /* getSystemLocale */.t.kYpG0u);
