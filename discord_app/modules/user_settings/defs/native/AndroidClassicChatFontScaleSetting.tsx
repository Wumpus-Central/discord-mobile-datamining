...
const toggle = createToggle.createToggle({
  ...
  onValueChange: function onClassicChatFontScaleChange(arg0) {
    const _require = arg0;
    return require("../../../../../discord_common/js/shared/utils/ReactBatchUpdates.native.tsx").batchUpdates(() => useFontScaleStore.setState({ isClassicChatFontScaleEnabled: closure_0 }));
  },
