...
createToggle = {
  ...
  useOptions() {
    return React.useMemo(() => {
      let obj = {
        value: callback(1187).GuildActivityStatusRestrictionDefaultV2.ACTIVITY_STATUS_OFF,
        label: null,
        subLabel: null,
      };
      ...
      const items = [obj, ,];
      obj = {
        value: callback(1187).GuildActivityStatusRestrictionDefaultV2.ACTIVITY_STATUS_ON_FOR_LARGE_GUILDS,
        label: null,
        subLabel: null,
      };
