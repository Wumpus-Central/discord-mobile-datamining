...
createToggle = {
  ...
  useOptions() {
    return React.useMemo(() => {
      let obj = {
        value: callback(1305).GuildActivityStatusRestrictionDefaultV2.ACTIVITY_STATUS_OFF,
        label: null,
        subLabel: null,
      };
      ...
      const items = [obj, ,];
      obj = {
        value: callback(1305).GuildActivityStatusRestrictionDefaultV2.ACTIVITY_STATUS_ON_FOR_LARGE_GUILDS,
        label: null,
        subLabel: null,
      };
    ...
    if (obj.getIsInActivityPrivacyUpsellExperiment("ActivityPrivacyDefaultSharingSetting")) {
      ...
      if (null != affectedGuilds) {
        ...
        ACTION_SHEET_HEIGHT_HALFDefault.openLazy(
          tmp2(2008)(15750, dependencyMap.paths),
