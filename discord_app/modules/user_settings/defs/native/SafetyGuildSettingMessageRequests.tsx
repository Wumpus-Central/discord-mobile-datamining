...
createToggle = {
  ...
  useValue() {
    ...
    const defaultGuildsRestricted = require(14786) /* useDefaultGuildsRestricted */.useDefaultGuildsRestricted();
    ...
    const tmp6 = selectedGuildId2 !== closure_6 || !require(13975) /* useParentalControlledExplicitContentSettings */.useIsParentallyControlled();
    let tmp7 = !tmp6;
    if (tmp6) {
    ...
    const obj3 = require(13975) /* useParentalControlledExplicitContentSettings */;
