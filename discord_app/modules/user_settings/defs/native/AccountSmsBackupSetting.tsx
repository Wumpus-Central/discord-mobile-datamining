...
let closure_6 = apply.debounce(function toggleSMS(user) {
  ...
  if (user.mfaSMSEnabled) {
    ...
    const formatted = intl2.string(getSystemLocale /* getSystemLocale */.t["CIGa+7"]).toUpperCase();
    const intl3 = getSystemLocale /* getSystemLocale */.intl;
    const str2 = intl2.string(getSystemLocale /* getSystemLocale */.t["CIGa+7"]);
    let obj = { onSubmit: null, title: null, placeholder: null, closeOnSuccess: true };
    const formatted1 = intl3.string(getSystemLocale /* getSystemLocale */.t.wlfmlR).toUpperCase();
    obj[0] = MFAActionCreators.disableSMS;
    obj[1] = formatted1;
    obj[2] = formatted;
    showUserSettingsInputAlert(obj);
    const str3 = intl3.string(getSystemLocale /* getSystemLocale */.t.wlfmlR);
  } else {
    if (null != user) {
      if (null != user.phone) {
        const intl = getSystemLocale /* getSystemLocale */.intl;
        const formatted2 = intl.string(getSystemLocale /* getSystemLocale */.t.DZQe23).toUpperCase();
        const str = intl.string(getSystemLocale /* getSystemLocale */.t.DZQe23);
        obj = { title: null };
        obj[0] = formatted2;
    ...
    obj1[0] = ChangePhoneReason /* ChangePhoneReason */.ChangePhoneReason.USER_SETTINGS_UPDATE;
    obj.pushLazy(asyncRequireImpl /* asyncRequireImpl */(8327, dependencyMap.paths), obj1, closure_5);
    const tmp5 = asyncRequireImpl /* asyncRequireImpl */(8327, dependencyMap.paths);
  }
}, 200);
apply = {
  useTitle() {
    const intl = getSystemLocale /* getSystemLocale */.intl;
    return intl.string(getSystemLocale /* getSystemLocale */.t.uHAJ5v);
  },
  ...
  useIsDisabled: function useAccountSMSBackupSettingIsDisabled() {
    ...
    if (null != stateFromStores) {
      sMSBackupDisabledMessage = getSMSBackupDisabledMessage /* getSMSBackupDisabledMessage */.getSMSBackupDisabledMessage(stateFromStores);
      const tmpResult = getSMSBackupDisabledMessage /* getSMSBackupDisabledMessage */;
    }
