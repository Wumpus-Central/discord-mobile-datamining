...
createToggle = {
  ...
  useTrailing() {
    return require(14340) /* useSyncedModeThemeName */.useSyncedModeThemeName(SystemTheme.LIGHT);
  },
  screen: createToggle
};
createToggle = {
  ...
  getComponent() {
    return require(14341) /* SettingsAppearanceLightModeThemePickerScreen */.default;
  }
};
