...
createToggle = {
  ...
  useTrailing() {
    return require(14440) /* useSyncedModeThemeName */.useSyncedModeThemeName(SystemTheme.LIGHT);
  },
  screen: createToggle
};
createToggle = {
  ...
  getComponent() {
    return require(14441) /* SettingsAppearanceLightModeThemePickerScreen */.default;
  }
};
