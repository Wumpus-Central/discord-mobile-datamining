...
createToggle = {
  ...
  useTrailing() {
    return require(14407) /* useSyncedModeThemeName */.useSyncedModeThemeName(SystemTheme.LIGHT);
  },
  screen: createToggle
};
createToggle = {
  ...
  getComponent() {
    return require(14408) /* SettingsAppearanceLightModeThemePickerScreen */.default;
  }
};
