...
function FamilyCenter() {
  ...
  const items3 = [
    closure_14(ref, {
      ...
      children: closure_14(familyCenterInitialized(9944).SegmentedControl, { state: segmentedControlState }),
    }),
  ];
  ...
  if (isLoading) {
    ...
    tmp14Result = closure_14(tmp4(12767).SegmentedControlPages, obj13);
  }
