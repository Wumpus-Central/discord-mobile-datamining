...
function FamilyCenter() {
  ...
  const items3 = [
    closure_14(ref, {
      ...
      children: closure_14(familyCenterInitialized(9897).SegmentedControl, { state: segmentedControlState }),
    }),
  ];
  ...
  if (isLoading) {
    ...
    tmp14Result = closure_14(tmp4(12873).SegmentedControlPages, obj13);
  }
