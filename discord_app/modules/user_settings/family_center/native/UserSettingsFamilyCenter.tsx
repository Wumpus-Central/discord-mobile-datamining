...
function FamilyCenter() {
  ...
  let obj1 = familyCenterInitialized(8770);
  ...
  let obj3 = familyCenterInitialized(9922);
  ...
  obj.page = closure_15(isLoading(14961), {});
  const items1 = [obj];
  ...
  obj1.page = closure_15(isLoading(15001), {});
  items1[1] = obj1;
  obj.items = items1;
  ...
  obj3 = { value: tmp3(isLoading(7285).FAMILY_CENTER).analyticsLocations, children: null };
  ...
  const items3 = [
    closure_15(ref, {
      ...
      children: closure_15(familyCenterInitialized(9923).SegmentedControl, { state: segmentedControlState }),
    }),
  ];
  ...
  if (isLoading) {
    ...
    tmp14Result = closure_15(tmp4(12745).SegmentedControlPages, obj7);
  }
  ...
  obj3.children = obj4;
  tmp14Result = closure_15(tmp4(7265).AnalyticsLocationProvider, obj3);
  const obj5 = {
    style: tmp.segmentedControlContainer,
    children: closure_15(familyCenterInitialized(9923).SegmentedControl, { state: segmentedControlState }),
  };
