...
export default function FamilyCenterParentalControlsSettings() {
  ...
  if (isFamilyCenterV3Enabled) {
    ...
    obj4.children = closure_9(require("FamilyCenterParentalControlsScreenTime"), obj5);
    obj3.children = closure_9(tmp2(tmp3[22]).SafeAreaPaddingView, obj4);
    ...
    obj7.children = closure_9(tmp2(tmp3[24]).SegmentedControl, obj8);
    const items3 = [closure_9(id, obj7)];
    ...
    obj11.children = closure_9(tmp2(tmp3[25]).SegmentedControlPages, obj12);
    obj10.children = closure_9(tmp2(tmp3[22]).SafeAreaPaddingView, obj11);
    obj9.children = closure_9(closure_6, obj10);
    items3[1] = closure_9(id, obj9);
