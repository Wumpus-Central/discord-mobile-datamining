...
export default function UserSettingsVoiceOutputOptions() {
  ...
  const items4 = [closure_9(stateFromStores1(5656).TableRow, obj), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = closure_9(tmp2(5656).TableRow, obj3);
    const tmp11Result = VolumeSliderDefault;
  }
  items4[1] = tmp9Result;
  obj.children = items4;
  return closure_10(stateFromStores1(10069).UserSettingsTableRowGroup, obj);
};