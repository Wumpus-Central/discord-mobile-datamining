// === Module 10006: UserSettingsVoiceOutputOptions ===
...
export default function UserSettingsVoiceOutputOptions() {
  ...
  const items4 = [callback(stateFromStores1(5564).TableRow, obj), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = tmp9(tmp2(5564).TableRow, obj3);
  }
  items4[1] = tmp9Result;
  obj[2] = items4;
  return closure_10(stateFromStores1(10000).UserSettingsTableRowGroup, obj);
};