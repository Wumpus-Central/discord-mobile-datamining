...
export default function UserSettingsVoiceProcessing() {
  ...
  obj[0] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["6I6GUv"]);
  obj = { label: null, value: null, onValueChange: null };
  const intl2 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[0] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.iWTwu6);
  obj[1] = echoCancellation;
  obj[2] = require("UserSettingsVoiceUtils.tsx") /* handleAutomaticGainControlChange */.handleEchoCancellationChange;
  obj[2] = callback(require("../../../../design/components/TableRow/native/TableSwitchRow.native.tsx") /* TableSwitchRow */.TableSwitchRow, obj);
  const items1 = [callback(require("UserSettingsVoice.tsx") /* UserSettingsVoice */.UserSettingsTableRowGroup, obj), callback(VoiceProcessingOptions, {}), ];
  const obj1 = { label: null, subLabel: null, value: null, onValueChange: null };
  const intl3 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[0] = intl3.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.cUMdH0);
  const intl4 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[1] = intl4.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["6EjbvA"]);
  obj1[2] = automaticGainControl;
  obj1[3] = require("UserSettingsVoiceUtils.tsx") /* handleAutomaticGainControlChange */.handleAutomaticGainControlChange;
  const items2 = [callback(require("../../../../design/components/TableRow/native/TableSwitchRow.native.tsx") /* TableSwitchRow */.TableSwitchRow, obj1), ];
  ...
  items1[2] = closure_6(require("UserSettingsVoice.tsx") /* UserSettingsVoice */.UserSettingsTableRowGroup, { hasIcons: false, children: items2 });
  obj3[0] = items1;
