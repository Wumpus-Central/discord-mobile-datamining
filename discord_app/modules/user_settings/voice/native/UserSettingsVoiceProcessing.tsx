...
export default function UserSettingsVoiceProcessing() {
  ...
  obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t["6I6GUv"]);
  obj = { label: null, value: null, onValueChange: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj[0] = intl2.string(getSystemLocale /* getSystemLocale */.t.iWTwu6);
  obj[1] = echoCancellation;
  obj[2] = handleAutomaticGainControlChange /* handleAutomaticGainControlChange */.handleEchoCancellationChange;
  obj[2] = callback(TableSwitchRow /* TableSwitchRow */.TableSwitchRow, obj);
  const items1 = [callback(UserSettingsVoice /* UserSettingsVoice */.UserSettingsTableRowGroup, obj), callback(VoiceProcessingOptions, {}), ];
  const obj1 = { label: null, subLabel: null, value: null, onValueChange: null };
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj1[0] = intl3.string(getSystemLocale /* getSystemLocale */.t.cUMdH0);
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj1[1] = intl4.string(getSystemLocale /* getSystemLocale */.t["6EjbvA"]);
  obj1[2] = automaticGainControl;
  obj1[3] = handleAutomaticGainControlChange /* handleAutomaticGainControlChange */.handleAutomaticGainControlChange;
  const items2 = [callback(TableSwitchRow /* TableSwitchRow */.TableSwitchRow, obj1), ];
  ...
  items1[2] = closure_6(UserSettingsVoice /* UserSettingsVoice */.UserSettingsTableRowGroup, { hasIcons: false, children: items2 });
  obj3[0] = items1;
