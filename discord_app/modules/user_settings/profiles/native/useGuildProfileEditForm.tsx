// === Module 14264: useGuildProfileEditForm ===
...
import { IGNORE_GUILD_IDS } from "handleFormOpen" /* 8002 */;
...
export default function useGuildProfileEditForm() {
  ...
  const memo = pendingThemeColors.useMemo(() => {
    const delayedCall = new stateFromStores(pendingNickname[11]).DelayedCall(200, () => {
      callback2(709).wait(callback(8956).resetAllPending);
    });
    return delayedCall;
  }, []);
  const items3 = [memo];
      ...
      return (function*() {
        ...
        if (!closure_1_15) {
          if (null != closure_1_0) {
            ...
            obj1[4] = closure_1_12;
            guildMemberChangesForUpdateRequest = closure_1_0(10753).getGuildMemberChangesForUpdateRequest(obj1);
            let avatarId = guildMemberChangesForUpdateRequest;
            guildMemberChangesForUpdateRequest = closure_1_0;
            guildMemberChangesForUpdateRequest = dependencyMap;
            const obj16 = closure_1_0(10753);
            ...
            let bannerOriginalMd5 = closure_1_0(10753).getProfileChangesForUpdateRequest(obj2, id);
            dependencyMap = true;
            c3 = false;
            ...
            if (Object.keys(guildMemberChangesForUpdateRequest).length > 0) {
              ...
              obj3[0] = closure_1_0(8956).saveGuildIdentityChanges(id1, guildMemberChangesForUpdateRequest);
              return obj3;
            }
            const obj18 = closure_1_0(10753);
          }
        }
        ...
        if (1 === tmp6) {
          if (arg0 === 1) {
            ...
            if (v0.ok) {
              ...
              if (null != avatar) {
                guildMemberChangesForUpdateRequest = v0;
                guildMemberChangesForUpdateRequest = closure_1_0(14222).showGenericGuildProfileUpdateFailureToast(v0.body.avatar);
                c3 = true;
                const obj15 = closure_1_0(14222);
              }
            }
