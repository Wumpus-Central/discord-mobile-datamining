      ...
      try {
          ...
          if (arg0 === 1) {
            ...
            if (stateFromStores) {
              ...
              if (Object.keys(accountUpdateForUpdateRequest).length > 0) {
                c6 = 1;
                c7 = 1;
                let obj1 = { value: pendingChanges(7057).saveProfileAndAccountChanges(accountUpdateForUpdateRequest), done: false };
                return obj1;
              } else {
                ...
                if (Object.keys(profileChangesForUpdateRequest).length > 0) {
                  ...
                  c6 = 2;
                  c7 = 1;
                  let obj2 = { value: pendingChanges(8252).saveProfileChanges(closure_131_8, undefined, bannerOriginalMd5), done: false };
                  return obj2;
                } else {
                  ...
                  c6 = 3;
                  c7 = 1;
                  const obj5 = { value: pendingChanges(14659).updateBadgeSettings(obj4), done: false };
                  return obj5;
                }
              }
          ...
          if (arg0 === 1) {
            ...
            if (ok) {
              ...
              if (undefined !== closure_132_0.pendingAvatar) {
                ...
                const result = pendingChanges(7061).trackUserAvatarUpdated(obj7);
          ...
          if (arg0 === 1) {
            ...
            if (ok2) {
              ...
              if (null != firstFieldErrorMessage) {
                let obj17 = pendingChanges(14658);
        ...
        if (Object.keys(primaryGuildChangesForUpdateRequest).length > 0) {
          ...
          if (undefined !== primaryGuildId) {
            c6 = 8;
            c7 = 1;
            obj18 = { value: pendingChanges(13967).adoptGuildIdentity(primaryGuildId, null !== primaryGuildId), done: false };
            return obj18;
          }
        }
      } catch (tmp192) {
