        ...
        try {
          ...
          if (0 === c6) {
            if (arg0 === 1) {
              ...
              if (stateFromStores) {
                ...
                const accountUpdateForUpdateRequest =
                  pendingChanges(11239).getAccountUpdateForUpdateRequest(pendingChanges);
                closure_131_0 = accountUpdateForUpdateRequest;
                const obj26 = pendingChanges(11239);
                profileChangesForUpdateRequest =
                  pendingChanges(11239).getProfileChangesForUpdateRequest(pendingChanges);
                const obj27 = pendingChanges(11239);
                primaryGuildChangesForUpdateRequest =
                  pendingChanges(11239).getPrimaryGuildChangesForUpdateRequest(pendingChanges);
                closure_131_3 = true;
                closure_131_4 = false;
                ...
                if (Object.keys(accountUpdateForUpdateRequest).length > 0) {
                  ...
                  c7 = 1;
                  const obj6 = {
                    value: pendingChanges(7094).saveProfileAndAccountChanges(accountUpdateForUpdateRequest),
                    done: false,
                  };
                  return obj6;
                } else {
                  ...
                  if (Object.keys(profileChangesForUpdateRequest).length > 0) {
                    ...
                    c7 = 1;
                    const obj8 = {
                      value: pendingChanges(8296).saveProfileChanges(closure_131_8, undefined, bannerOriginalMd5),
                      done: false,
                    };
                    return obj8;
                  } else {
            ...
            if (arg0 === 1) {
              ...
              if (ok) {
                ...
                if (null != username) {
                  ...
                  if (null != avatar) {
                    const result3 = pendingChanges(14719).showGenericProfileUpdateFailureToast(
            ...
            if (3 === tmp7) {
              ...
              if (!tmp140) {
                ...
                const result10 = pendingChanges(14719).showGenericProfileUpdateFailureToast(
          ...
          if (Object.keys(primaryGuildChangesForUpdateRequest).length > 0) {
            ...
            if (undefined !== primaryGuildId) {
              ...
              c7 = 1;
              const obj41 = {
                value: pendingChanges(14020).adoptGuildIdentity(primaryGuildId, null !== primaryGuildId),
                done: false,
              };
              return obj41;
            }
