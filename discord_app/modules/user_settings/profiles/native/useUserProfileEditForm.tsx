...
export default function useUserProfileEditForm() {
  ...
  const stateFromStoresObject = obj.useStateFromStoresObject(items, () => ({
    ...
    tryItOutChanges: store.getTryItOutChanges(),
              ...
              if (0 === user) {
                if (arg0 === 1) {
                  ...
                  if (closure_1_1) {
                    ...
                    throwTypeErrorResult = closure_1_0;
                    profileChangesForUpdateRequest = closure_1_0(closure_1_2[10]).getProfileChangesForUpdateRequest(
                      closure_1_0,
                    );
                    throwTypeErrorResult = closure_1_0;
                    throwTypeErrorResult = closure_1_2;
                    ...
                    if (Object.keys(throwTypeErrorResult).length > 0) {
                      ...
                      if (Object.keys(profileChangesForUpdateRequest).length > 0) {
                        ...
                        obj2[0] = closure_1_0(closure_1_2[14]).saveProfileChanges(
                          closure_8,
                          undefined,
                          bannerOriginalMd5,
                        );
                        ...
                        if (throwTypeErrorResult) {
                          ...
                          throwTypeErrorResult = closure_1_1;
                          throwTypeErrorResult = closure_1_2;
                          throwTypeErrorResult = closure_1_1(closure_1_2[8]).dispatch({
                  ...
                  if (ok) {
                    ...
                    if (null != username) {
                      ...
                      if (null != avatar) {
                        ...
                        throwTypeErrorResult = closure_1_0(closure_1_2[13]).showGenericProfileUpdateFailureToast(
                          closure_5.body.avatar,
                        );
                        _true = true;
                ...
                if (3 === tmp7) {
                  ...
                  if (!throwTypeErrorResult) {
                    ...
                    throwTypeErrorResult = closure_1_2;
                    throwTypeErrorResult = closure_1_0(closure_1_2[13]).showGenericProfileUpdateFailureToast(
                      intl.string(closure_1_0(closure_1_2[22]).t["84MExs"]),
                    );
  ...
  obj = {
    ...
    handleSubmitAvatarDecoration: React.useCallback(
      callback(function* () {
        if (c3 === 2) {
          c3 = 3;
