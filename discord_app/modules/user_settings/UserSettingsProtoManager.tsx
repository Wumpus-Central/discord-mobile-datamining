...
export default {
  init() {
    importDefault(1343)[UserSettingsTypes.PRELOADED_USER_SETTINGS] = importDefault(13635);
    const tmp = importDefault(1343);
    importDefault(1343)[UserSettingsTypes.FRECENCY_AND_FAVORITES_SETTINGS] = importDefault(13636);
