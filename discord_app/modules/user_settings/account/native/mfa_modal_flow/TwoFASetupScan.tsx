...
export default function TwoFASetupScan(totpSecret) {
  ...
  callback = React.useCallback(() => {
    dependencyMap(true);
    totpSecret(5677).copy(totpSecret.replace(/[^a-zA-Z0-9]/g, ""));
  }, items);
  let obj = totpSecret(13947);
  ...
  items2[3] = callback2(totpSecret(4827).PressableOpacity, obj2);
  obj[2] = items2;
  obj4[0] = closure_5(totpSecret(5311).SafeAreaPaddingView, obj);
  return callback2(totpSecret(13943).TwoFASetupModalScreen, obj4);
};