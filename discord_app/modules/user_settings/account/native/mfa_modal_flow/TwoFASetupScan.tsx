...
export default function TwoFASetupScan(totpSecret) {
  ...
  callback = React.useCallback(() => {
    dependencyMap(true);
    totpSecret(5949).copy(totpSecret.replace(/[^a-zA-Z0-9]/g, ""));
  }, items);
  let obj = totpSecret(14359);
  ...
  items2[2] = callback2(totpSecret(4444).Text, { variant: "text-md/bold", style: { textAlign: "center" }, children: totpSecret });
  ...
  items2[3] = callback2(totpSecret(5036).PressableOpacity, obj2);
  obj[2] = items2;
  obj4[0] = closure_5(totpSecret(5521).SafeAreaPaddingView, obj);
  return callback2(totpSecret(14355).TwoFASetupModalScreen, obj4);
};