// === Module 13835: TwoFASetupLanding ===
...
export default function TwoFASetupLanding() {
  ...
  items[1] = callback(require(4189) /* Text */.Heading, obj3);
  ...
  return callback(require(13832) /* TwoFAModalSetupSections */.TwoFASetupModalScreen, obj);
};