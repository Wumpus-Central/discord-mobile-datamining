...
import registerAssetDefault from "../../../../../../_runtime/14616_registerAsset.js";
...
const result = require("set").fileFinishedImporting(
  "modules/user_settings/account/native/mfa_modal_flow/TwoFASetupLanding.tsx",
);
...
export default function TwoFASetupLanding() {
  ...
  obj4[2] = intl2.format(getSystemLocale.t.A7Aehw, {
