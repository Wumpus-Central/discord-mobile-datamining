...
export default function TwoFASetupModal(initialRouteName) {
  ...
  let obj = {
    ...
    screens: useInitialValueDefault(() => {
      let obj = totpSecret(7022);
      totpSecret = obj.generateTotpSecret();
      obj = {};
      obj = {
        headerLeft: totpSecret(5675).getHeaderCloseButton(closure_1(14835).close),
        headerTitle() {
          return closure_1_6(totpSecret(14838).PageMarker, {
      ...
      obj1.headerLeft = totpSecret(5675).getHeaderCloseButton(closure_1(14835).close);
...
export const TwoFASetupModalScreen = function TwoFASetupModalScreen(children) {
  ...
  if (name === TwoFAModalSetupSections.ENTER_CODE) {
    ...
    obj1 = closure_6(tmp2(5026).Button, obj1);
    obj.children = obj1;
    closure_6(tmp2(7196).SafeAreaPaddingView, obj);
  }
};
