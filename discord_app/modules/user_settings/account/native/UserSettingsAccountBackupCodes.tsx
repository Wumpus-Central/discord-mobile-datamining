...
function CodeRow(code) {
  ...
  if (showCheckMark) {
    ...
    tmp2Result = closure_6(code(7147).CheckmarkSmallIcon, obj);
  }
...
export default function UserSettingsAccountBackupCodes(headerLabel) {
  ...
  const items2 = [
    headerLabel.map((children, index) =>
      closure_1_6(stateFromStores(4570).Text, { variant: "text-sm/medium", children }, index),
    ),
    ,
    ,
  ];
  ...
  if (tmp10Result) {
    ...
    tmp10Result = closure_6(tmp3(5701).TableRowGroup, obj1);
  }
  ...
  if (tmp10Result) {
    ...
    tmp10Result = closure_6(tmp3(5701).TableRowGroup, obj2);
  }
  ...
  if (tmp10Result1) {
    ...
    obj4.label = closure_6(tmp3(4570).Text, obj5);
    ...
    obj3.children = closure_6(tmp3(5619).TableRow, obj4);
    tmp10Result1 = closure_6(tmp3(5701).TableRowGroup, obj3);
  }
  tmp6 = closure_8();
  items2[3] = tmp10Result1;
  obj.children = items2;
  return closure_6(ScrollView, { children: closure_7(stateFromStores(4987).Stack, obj) });
}
