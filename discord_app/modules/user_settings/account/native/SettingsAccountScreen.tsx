// === Module 15027: SettingsAccountScreen ===
...
import SettingsAccountHeaderDefault from "SettingsAccountHeader" /* 15054 */;
...
function PasswordlessUpsell() {
  ...
  obj6.source = require("module_15030");
  ...
  obj12.onPress = function onPress() {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(15031, dependencyMap.paths), { navigation, initialRouteName: WebAuthnScreens.REGISTER, showNav: true });
  };
...
function AccountTwoFALabel() {
  ...
  closure_1 = tmp5;
  let obj = first(504);
  const isUserVerified = first(15052).useIsUserVerified();
  ...
  items3[1] = closure_10(first(5992).TableRowGroupTitle, obj4);
...
function AccountStatusLabel() {
  ...
  const t = util.t;
  return closure_1_10(TableRowGroup.TableRowGroupTitle, { title: intl.string(isTinyBroncoSettingsEnabled ? t.GI2mea : t["16r9jm"]) });
}
