// === Module 13836: PasswordlessUpsell ===
...
function PasswordlessUpsell() {
  ...
  obj3[0] = _require(13839);
  obj3[2] = tmp.upsellImagePasswordless;
  obj2[1] = callback2(importDefault(5207), obj3);
  ...
  const items2 = [callback2(_require(4666).Button, obj9), callback2(View, {})];
  obj8[1] = items2;
  ...
  obj[1] = callback2(_require(5288).Card, obj);
...
function AccountSecurityPage() {
  const node = importAllResult.useMemo(() => {
    ...
    obj[1] = callback2(13863);
    return obj.createList(obj);
  }, []);
  return callback2(importDefault(13760), { node });
}
function AccountStandingPage() {
  return callback2(require(13866) /* AutomatedUnderageAppealStatus */.default, { visible: true });
}
...
const memoResult = importAllResult.memo(() => {
  ...
  const tmp5Result = require(8535) /* useSegmentedControlState */;
  ...
  const items1 = [callback2(View, { style: tmp.controlContainer, onLayout: callback, children: callback2(require(8941) /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) }), ];
  const obj4 = { style: tmp.controlContainer, onLayout: callback, children: callback2(require(8941) /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) };
  items1[1] = callback2(View, { style: tmp.pageContainer, children: callback2(require(8939) /* SegmentedControlPage */.SegmentedControlPages, { state: segmentedControlState }) });
  obj3[0] = items1;
