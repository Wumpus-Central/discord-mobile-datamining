...
function PasswordlessUpsell() {
  ...
  obj6.source = require("../../../../../_runtime/metro/14192__.js");
  ...
  obj12.onPress = function onPress() {
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14193, dependencyMap.paths), {
      navigation,
...
function AccountStatusLabel() {
  ...
  const t = util.t;
  return closure_1_10(TableRowGroup.TableRowGroupTitle, {
