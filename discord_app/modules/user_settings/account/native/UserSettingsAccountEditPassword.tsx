...
prototype["render"] = function render() {
  ...
  if (hasBannerText) {
    ...
    obj[1] = tmp2(require("UserSettingsAccountUnverifiedHeader.tsx"), {});
  ...
  if (showForcedPasswordUpdate) {
    ...
    obj1[0] = require("../../../../../_runtime/13928_registerAsset.js");
    obj1[1] = tmp.image;
    ...
    obj2[3] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.geta79);
    items1[1] = tmp2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj2);
    ...
    obj3[3] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["37iHbZ"]);
    items1[2] = tmp2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj3);
    obj[1] = items1;
  ...
  if (!showForcedPasswordUpdate) {
    ...
    obj5[3] = intl3.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.geta79);
    const items2 = [tmp2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj5), ];
    ...
    obj6[3] = intl4.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.x5tG4V);
    items2[1] = tmp2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj6);
    obj4[1] = items2;
  ...
  const items3 = [closure_12(require("../../../../design/components/TextInput/native/TextInput.native.tsx") /* TextInput */.TextInput, obj7), , ];
  ...
  obj8[8] = handleSubmit;
  items3[1] = closure_12(require("../../../../design/components/TextInput/native/TextInput.native.tsx") /* TextInput */.TextInput, obj8);
  const obj9 = { text: null, onPress: null, loading: null, disabled: null };
  const intl5 = tmp16(1236).intl;
  obj9[0] = intl5.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["FRep5/"]);
  ...
  obj9[3] = submitting;
  items3[2] = closure_12(require("../../../../design/components/Button/native/Button.native.tsx") /* Button */.Button, obj9);
  obj11[1] = items3;
  items[3] = closure_13(require("../../../../design/components/Stack/native/Stack.native.tsx") /* Stack */.Stack, obj11);
  obj[1] = items;
