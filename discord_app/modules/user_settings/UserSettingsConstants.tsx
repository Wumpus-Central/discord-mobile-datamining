...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "PX_8", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: false, errorCallbacks: false, loaded: false, loading: "channel", triggeredMigrations: "IconComponent", offlineEditDataVersion: "Boolean" };
  obj[4] = [];
  obj[5] = [];
  return obj;
};
