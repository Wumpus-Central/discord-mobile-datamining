...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "ct", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: false, errorCallbacks: false, loaded: false, loading: "accessibilityRole", triggeredMigrations: "<string:3359703042>", offlineEditDataVersion: "<string:1090519580>" };
  obj[4] = [];
  obj[5] = [];
  return obj;
};
