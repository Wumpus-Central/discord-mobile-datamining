...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "flex", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: [], errorCallbacks: [], loaded: false, loading: "category", triggeredMigrations: "NEUTRAL_96", offlineEditDataVersion: "convertToPlainObject" };
  return obj;
};
