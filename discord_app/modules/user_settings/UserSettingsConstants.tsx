...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "PX_8", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: false, errorCallbacks: false, loaded: false, loading: "accessible", triggeredMigrations: "y", offlineEditDataVersion: "GAME_POPOUT" };
  obj[4] = [];
  obj[5] = [];
  return obj;
};
