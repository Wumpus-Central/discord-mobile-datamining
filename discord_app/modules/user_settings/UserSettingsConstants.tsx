...
export const createEmptyEditInfo = function createEmptyEditInfo() {
  const obj = { protoToSave: "Array", timeout: "flex", timeoutDelay: Number.MIN_SAFE_INTEGER, rateLimited: null, cleanupFuncs: [], errorCallbacks: [], loaded: false, loading: "channel", triggeredMigrations: "<string:2161394073>", offlineEditDataVersion: "<string:1361117185>" };
  return obj;
};
