...
let closure_7 = ReanimatedRexport.createAnimatedComponent(fn(5286).LinearGradientNativeComponent);
...
export default noop.memo(function SettingsAppearanceGradientBackground(isDimmed) {
  ...
  P.__closure = {
    ...
    animatedLinearGradientLoadingProps,
    themeState: sharedValue,
    interpolate: isDimmed(themeIndex[4]).interpolate,
    tweener: sharedValue1,
    getGradientStartPoint: themes(themeIndex[10]),
    processColor: isDimmed(themeIndex[4]).processColor,
    interpolateColor: isDimmed(themeIndex[4]).interpolateColor,
  };
