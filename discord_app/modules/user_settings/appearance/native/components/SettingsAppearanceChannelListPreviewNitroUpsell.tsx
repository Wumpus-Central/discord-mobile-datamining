// === Module 15638: SettingsAppearanceChannelListPreviewNitroUpsell ===
...
function SettingsAppearanceChannelListPreviewNitroUpsellComponent(theme) {
  ...
  let obj = theme(4559);
  fn.__closure = { theme, ThemeTypes, StyleSheet, withSpring: theme(5270).withSpring, springStandard: theme(5274).springStandard };
  fn.__workletHash = 16911565077998;
  fn.__initData = __initData2;
  const animatedStyle = obj.useAnimatedStyle(fn);
  const obj2 = { theme, ThemeTypes, StyleSheet, withSpring: theme(5270).withSpring, springStandard: theme(5274).springStandard };
  analyticsLocations = analyticsLocations(7493)(analyticsLocations(7513).CLIENT_THEMES_EDITOR).analyticsLocations;
  ...
  items1[1] = closure_10(theme(5271).Button, obj5);
...
animationEntering.__closure = { withSpring: fn(5270).withSpring, springStandard: fn(5274).springStandard };
...
let obj = { withSpring: fn(5270).withSpring, springStandard: fn(5274).springStandard };
animationExiting.__closure = { withSpring: fn(5270).withSpring, springStandard: fn(5274).springStandard };
...
let obj2 = { withSpring: fn(5270).withSpring, springStandard: fn(5274).springStandard };
size = fn(2);
