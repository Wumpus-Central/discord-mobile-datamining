// === Module 14404: SettingsAppearanceChannelListPreviewNitroUpsellComponent ===
...
function SettingsAppearanceChannelListPreviewNitroUpsellComponent(theme) {
  ...
  obj = { theme, ThemeTypes: closure_9, StyleSheet, withSpring: theme(4665).withSpring, springStandard: theme(4669).springStandard };
  fn.__closure = obj;
  fn.__workletHash = 16911565077998;
  fn.__initData = closure_18;
  const animatedStyle = obj.useAnimatedStyle(fn);
  analyticsLocations = analyticsLocations(5581)(analyticsLocations(5601).CLIENT_THEMES_EDITOR).analyticsLocations;
  ...
  obj2[3] = callback;
  items1[1] = callback(theme(4666).Button, obj2);
  obj[1] = items1;
...
function animationEntering(value) {
  ...
  obj[0] = require(4665) /* CONFIG_NEVER_ANIMATE */.withSpring(value, require(4669) /* SUBTLE_SPRING */.springStandard);
  return obj;
}
...
function animationExiting(value, cleanUp) {
  ...
  obj[0] = _require(4665).withSpring(value, _require(4669).springStandard, "respect-motion-settings", fn);
  return obj;
}
...
const memoResult = importAllResult.memo(function SettingsAppearanceChannelListPreviewNitroUpsell(visible) {
  ...
  obj[4] = callback;
  return closure_10(importDefault(8751), obj);
});
