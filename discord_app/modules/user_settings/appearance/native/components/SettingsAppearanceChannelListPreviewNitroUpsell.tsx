...
function SettingsAppearanceChannelListPreviewNitroUpsellComponent(theme) {
  ...
  obj = { theme, ThemeTypes: closure_9, StyleSheet, withSpring: theme(4711).withSpring, springStandard: theme(4715).springStandard };
  fn.__closure = obj;
  fn.__workletHash = 16911565077998;
  fn.__initData = closure_18;
  const animatedStyle = obj.useAnimatedStyle(fn);
  analyticsLocations = analyticsLocations(5668)(analyticsLocations(5688).CLIENT_THEMES_EDITOR).analyticsLocations;
  ...
  obj2[3] = callback;
  items1[1] = callback(theme(4712).Button, obj2);
  obj[1] = items1;
...
const memoResult = importAllResult.memo(function SettingsAppearanceChannelListPreviewNitroUpsell(visible) {
  ...
  obj[4] = callback;
  return closure_10(AnimatedRenderItem, obj);
});
