...
obj = { borderRadius: nativeDefault.radii.lg, borderWidth: StyleSheet.hairlineWidth, padding: HAPPENING_NOW_CARD_PADDING, paddingRight: HAPPENING_NOW_CARD_PADDING_RIGHT, marginRight: HAPPENING_NOW_CARD_MARGIN_RIGHT, height: HAPPENING_NOW_CARD_HEIGHT, flexDirection: "row", alignItems: "center" };
obj.card = obj;
obj.cardBadgeWrapper = { position: "absolute", top: 0, right: 0 };
const createStyles = { height: HAPPENING_NOW_CONTENT_HEIGHT, minWidth: HAPPENING_NOW_CONTENT_HEIGHT, marginRight: nativeDefault.space.PX_12, borderRadius: nativeDefault.radii.md, position: "relative" };
...
const obj2 = { height: "100%", backgroundColor: nativeDefault.colors.CARD_SECONDARY_BG, borderRadius: nativeDefault.radii.sm };
...
export default function ActivityCardItem(arg0) {
  ...
  obj.style = items2;
  const obj1 = { style: tmp4.cardImageAssetBackground, children: closure_5(substr(num3[11]), { style: tmp4.cardImageAsset, source: image }) };
  ...
  const items7 = [closure_6(closure_3, obj3), closure_5(require("HappeningNowCard").HappeningNowCardHeader, { animated: true, style: animatedStyles.headerPrimary, children: title }), closure_5(require("HappeningNowCard").HappeningNowCardSubtitle, { animated: true, style: animatedStyles.headerSecondary, children: subtitle })];
  obj6.children = items7;
  items3[1] = closure_6(closure_3, obj6);
  const obj9 = { style: tmp4.cardBadgeWrapper, children: null };
  const obj10 = { style: null, children: closure_5(closure_7, { style: animatedStyles.activityIcon, size: require("native").Icon.Sizes.REFRESH_SMALL_16, resizeMode: "stretch", source: substr("activity" === kind ? num3[15] : num3[16]) }) };
