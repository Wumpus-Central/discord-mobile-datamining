...
import closure_4 from "../../../LocaleStore.tsx";
...
obj[3] = {
  ...
  borderBottomLeftRadius: ThemesDefault.radii.md,
};
const obj2 = {
  display: "flex",
  alignItems: "center",
...
obj[8] = {
  ...
  justifyContent: "center",
  marginLeft: -4,
  height: require("Button").AVATAR_SIZE_MAP[require("Button").AvatarSizes.XSMALL_20],
  minWidth: require("Button").AVATAR_SIZE_MAP[require("Button").AvatarSizes.XSMALL_20],
...
export default function ActivityCardItem(arg0) {
  ...
  obj = {
    style: items2,
    children: callback(closure_3, { style: tmp4.cardImageAssetBackground, children: callback(substr(num3[11]), obj2) }),
  };
  items2 = [,];
  ...
  const items7 = [
    ...
    callback(_require(num3[14]).HappeningNowCardHeader, {
      animated: true,
      style: animatedStyles.headerPrimary,
      children: title,
    }),
    callback(_require(num3[14]).HappeningNowCardSubtitle, {
      animated: true,
  ...
  obj10[1] = callback(closure_7, {
    style: animatedStyles.activityIcon,
    size: _require(num3[6]).Icon.Sizes.REFRESH_SMALL_16,
    resizeMode: "stretch",
