...
fn(4606);
let createStyles = {
  channelItemContainer: null,
  channelItemLeft: null,
...
createStyles.channelItemAvatar = {
...
export default function ChannelRowItem(isUnread) {
  ...
  if (null == preview) {
    ...
    tmp5Result = React4(tmp6(4602).Text, animatedStyles);
