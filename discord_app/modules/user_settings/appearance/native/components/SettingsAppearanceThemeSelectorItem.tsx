...
import SynchronizeIconNativeDefault from "SynchronizeIconNative" /* 15360 */;
...
function GradientThemeBackground(arg0) {
  ...
  if (isThemeLocked) {
    const obj3 = { source: _modDef15359, style: tmp4.lock };
...
createStyles.themeSelectorItemContainer = { width: SettingsAppearanceConstants.THEME_ITEM_WIDTH, height: SettingsAppearanceConstants.THEME_ITEM_HEIGHT };
createStyles.themeSelectorItem = { borderRadius: nativeDefault.radii.sm, padding: SettingsAppearanceConstants.THEME_ITEM_PADDING };
