// === Module 15556: SettingsAppearanceThemeSelectorItem ===
...
import SynchronizeIconNativeDefault from "SynchronizeIconNative" /* 15558 */;
...
function GradientThemeBackground(arg0) {
  ...
  if (isThemeLocked) {
    const obj6 = { source: _modDef15557, style: tmp4.lock };
