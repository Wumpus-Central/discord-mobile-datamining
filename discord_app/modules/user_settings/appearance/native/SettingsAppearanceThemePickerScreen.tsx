...
function ThemePicker(defaultIndex) {
  ...
  items = [navigation];
  stateFromStores = tmp3Result.useStateFromStores(items, () => defaultIndex(isPreview[24]).isThemeLight(navigation.systemTheme) ? _undefined.LIGHT : _undefined.DARK);
  ...
  if ("nitro" === themeSelector) {
    obj2 = { themes: mobileThemes, currentThemeIndex: themeIndex, isPreview, isSynced, defaultIndex, deviceWidth: rounded, animatedStyles: obj1, hasOnyxNux, onThemeSelected: callback3 };
