// === Module 14468: AuthorizedAppScreen ===
...
export default function AuthorizedAppScreen() {
  let obj = settingNavigationRoute(7087);
  ...
  return jsx(stackNavigation(14469), { oauth2Token: settingNavigationRoute.params.oauth2Token });
};