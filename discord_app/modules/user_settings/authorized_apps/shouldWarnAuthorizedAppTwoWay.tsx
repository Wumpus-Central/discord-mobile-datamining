...
export default function isAuthorizedAppTwoWay(arg0) {
  let hasItem = set /* set */.ConsoleOAuthApplications.XBOX_APPLICATION_ID === arg0;
  if (!hasItem) {
    const PLAYSTATION_APPLICATION_IDS = set /* set */.ConsoleOAuthApplicationsSets.PLAYSTATION_APPLICATION_IDS;
...
export const useShouldWarnAuthorizedAppTwoWay = function useShouldWarnAuthorizedAppTwoWay(id) {
  let hasItem = set /* set */.ConsoleOAuthApplications.XBOX_APPLICATION_ID === id;
  if (!hasItem) {
    const PLAYSTATION_APPLICATION_IDS = set /* set */.ConsoleOAuthApplicationsSets.PLAYSTATION_APPLICATION_IDS;
