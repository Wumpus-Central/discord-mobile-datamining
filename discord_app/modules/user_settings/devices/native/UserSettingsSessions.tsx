...
import { registerAsset } from "../../../../../_runtime/10811_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/11519_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/14074_registerAsset.js";
...
function UserSettingsSessions() {
  ...
  if (null == currentSession) {
    ...
    obj1[2] = tmp21Result;
    const items1 = [callback2(tmp2(5634).TableRowGroup, obj1), , ];
    if (otherSessions.length > 0) {
      ...
      obj3[2] = items2;
      tmp20Result = tmp20(tmp2(5634).TableRowGroup, obj3);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result = tmp21(tmp2(5300).TableRow, obj4);
    }
    items1[2] = tmp21Result;
    obj[2] = items1;
    tmp20Result = tmp20(tmp2(4663).Stack, obj);
  }
  ...
  obj6[1] = items3;
  obj5[1] = callback3(otherSessions(5257).SafeAreaPaddingView, obj6);
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
      if ("" !== trimmed) {
        if ("ios" !== trimmed) {
          if ("android" !== trimmed) {
            if ("horizon os" === trimmed) {
              ...
              obj[0] = os;
              obj[1] = registerAsset;
              obj[2] = session(14075).VrHeadsetIcon;
              let tmp9 = session;
        ...
        obj[0] = os;
        obj[1] = registerAsset;
        obj[2] = session(8270).MobilePhoneIcon;
        tmp9 = session;
        tmp10 = importDefault;
      }
      ...
      if (!current) {
        formatDateResult = tmp9(13859).formatDate(session.approx_last_used_time);
        const tmp9Result = tmp9(13859);
      }
      ...
      if (!current) {
        ...
        tmp18 = callback2(tmp9(4797).PressableOpacity, obj1);
      }
      ...
      obj9[0] = callback2(tmp9(5300).TableRow.Icon, obj10);
      obj9[1] = tmp20Result;
      ...
      obj9[3] = tmp18;
      return callback2(tmp9(5300).TableRow, obj9);
    }
  }
