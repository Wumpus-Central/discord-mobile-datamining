...
function UserSettingsSessions() {
  ...
  if (null == currentSession) {
    ...
    const items1 = [closure_10(otherSessions(5999).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      ...
      let tmp20Result = closure_11(otherSessions(5999).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      tmp21Result2 = closure_10(otherSessions(5917).TableRow, obj8);
    }
    items1[2] = tmp21Result2;
    obj4.children = items1;
    tmp20Result2 = closure_11(otherSessions(5279).Stack, obj4);
  }
...
function SessionInfo(session) {
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
      ...
      const items1 = [closure_10(tmp9(4832).Text, obj8), ];
      ...
      if (tmp22Result) {
        ...
        const items2 = [closure_10(tmp9(4832).Text, obj10), ];
      ...
      if (tmp20Result3) {
        ...
        obj14.children = closure_10(tmp9(4832).Text, obj15);
      ...
      if (tmp20Result4) {
        ...
        obj16.children = closure_10(tmp9(4832).Text, obj17);
