// === Module 15285: UserSettingsSessions ===
...
import _modDef12597 from "module_12597" /* 12597 */;
import AuthSessionsActionCreators from "AuthSessionsActionCreators" /* 15286 */;
...
const _modDef7323 = tmp10(7323);
require = fn;
function UserSettingsSessions() {
  const tmp = closure_13();
  let authSessions = otherSessions(15033).useAuthSessions();
  ({ currentSession, otherSessions } = authSessions);
  const obj = otherSessions(15033);
  ...
  if (null == currentSession) {
    ...
    const intl5 = otherSessions(1115).intl;
    obj5.title = intl5.string(otherSessions(1115).t.LLS19o);
    ...
    const items1 = [closure_10(otherSessions(5990).TableRowGroup, obj5), , ];
    if (otherSessions.length > 0) {
      const obj7 = { title: null, hasIcons: true, children: null };
      const intl = otherSessions(1115).intl;
      obj7.title = intl.string(otherSessions(1115).t.xx1MWc);
      const items2 = [otherSessions.map((session) => closure_1_10(SessionInfo, { session }, session.id_hash)), closure_10(UnknownLegacySessionsInfo, {})];
      obj7.children = items2;
      let tmp20Result = closure_11(otherSessions(5990).TableRowGroup, obj7);
    } else {
      let mfaEnabled;
    ...
    if (otherSessions.length > 0) {
      ...
      const intl2 = otherSessions(1115).intl;
      obj8.label = intl2.string(otherSessions(1115).t.cLmmeY);
      const intl3 = otherSessions(1115).intl;
      obj8.subLabel = intl3.string(otherSessions(1115).t.OTXyaf);
      obj8.onPress = function onPress() {
        return AuthSessionsActionCreators.logOutSessions(otherSessions.map((id_hash) => id_hash.id_hash));
      };
      tmp21Result2 = closure_10(otherSessions(5908).TableRow, obj8);
    }
    items1[2] = tmp21Result2;
    obj4.children = items1;
    tmp20Result2 = closure_11(otherSessions(5269).Stack, obj4);
  }
  ...
  const intl4 = otherSessions(1115).intl;
  obj11.children = intl4.string(otherSessions(1115).t.zZp618);
  const items3 = [closure_10(otherSessions(4823).Text, obj11), tmp20Result2];
  obj10.children = items3;
  obj9.children = closure_11(otherSessions(7454).SafeAreaPaddingView, obj10);
...
function SessionInfo(session) {
  ...
  if (null !== trimmed) {
    if (undefined !== trimmed) {
        ...
        if ("ios" !== trimmed) {
          if ("android" !== trimmed) {
            if ("horizon os" === trimmed) {
              const obj2 = { text: os, iconSource: _modDef10406, IconComponent: session(15288).VrHeadsetIcon };
              let tmp9 = session;
              let obj = obj2;
            } else {
              obj = { text: os, iconSource: _modDef15287, IconComponent: session(9237).ScreenIcon };
              tmp9 = session;
            }
          }
        }
        const obj3 = { text: os, iconSource: _modDef10406, IconComponent: session(7289).MobilePhoneIcon };
        tmp9 = session;
        obj = obj3;
      }
      ...
      if (!current) {
        formatDateResult = tmp9(15033).formatDate(session.approx_last_used_time);
        const tmp9Result = tmp9(15033);
      }
      ...
      if (!current) {
        ...
        const obj5 = { style: tmp.logoutButton, source: _modDef7323 };
        obj4.children = closure_10(tmp9(1177).Icon, obj5);
        tmp18 = closure_10(tmp9(5425).PressableOpacity, obj4);
      }
      ...
      const items1 = [closure_10(tmp9(4823).Text, obj8), ];
      ...
      if (tmp22Result) {
        ...
        const items2 = [closure_10(tmp9(4823).Text, obj10), ];
        const obj11 = { variant: "text-md/semibold", children: found[1] };
        items2[1] = closure_10(tmp9(4823).Text, obj11);
        obj9.children = items2;
        tmp22Result = closure_11(closure_12, obj9);
      }
      ...
      obj12.icon = closure_10(tmp9(5908).TableRow.Icon, obj13);
      ...
      if (tmp20Result3) {
        ...
        obj14.children = closure_10(tmp9(4823).Text, obj15);
        tmp20Result3 = closure_10(closure_6, obj14);
      }
      ...
      if (tmp20Result4) {
        ...
        obj16.children = closure_10(tmp9(4823).Text, obj17);
        tmp20Result4 = closure_10(closure_6, obj16);
      }
      ...
      return closure_10(tmp9(5908).TableRow, obj12);
    }
  }
  ...
  obj19.iconSource = _modDef15287;
  obj19.IconComponent = session(9237).ScreenIcon;
  tmp9 = session;
  obj = obj19;
}
function UnknownLegacySessionsInfo() {
  ...
  obj2.icon = closure_10(require("TableRow").TableRow.Icon, { variant: "translucent", source: _modDef12597 });
