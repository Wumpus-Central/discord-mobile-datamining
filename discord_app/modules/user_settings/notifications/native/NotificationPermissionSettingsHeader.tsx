...
export default function NotificationPermissionSettingsHeader() {
  ...
  let obj = canSeePushNotificationNudge(12441);
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj2.children = closure_11(tmp2(9091).BellSlashIcon, obj3);
    ...
    items1[1] = closure_11(tmp2(4570).Text, obj4);
    ...
    items1[2] = closure_11(tmp2(4570).Text, obj5);
    ...
    obj7.onPress = tmp6;
    obj6.children = closure_11(tmp2(4989).Button, obj7);
    items1[3] = closure_11(View, obj6);
    obj1.children = items1;
    obj.children = closure_12(View, obj1);
    obj.children = closure_11(tmp2(5621).Card, obj);
