// === Module 14885: NotificationPermissionSettingsHeader ===
...
export default function NotificationPermissionSettingsHeader() {
  const tmp = callback3();
  let obj = canSeePushNotificationNudge(11975);
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj2[1] = callback(tmp2(9887).BellSlashIcon, obj3);
    ...
    items1[2] = callback(tmp2(4376).Text, obj5);
    ...
    obj7[2] = tmp6;
    obj6[1] = callback(tmp2(4815).Button, obj7);
    items1[3] = callback(View, obj6);
    obj1[1] = items1;
    obj[2] = callback2(View, obj1);
    obj[1] = callback(tmp2(5482).Card, obj);
