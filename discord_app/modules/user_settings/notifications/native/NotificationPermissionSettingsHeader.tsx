...
export default function NotificationPermissionSettingsHeader() {
  ...
  let obj = canSeePushNotificationNudge(11840);
  ...
  if (canSeePushNotificationNudge) {
    ...
    obj2[1] = callback(tmp2(9777).BellSlashIcon, obj3);
    ...
    items1[2] = callback(tmp2(4340).Text, obj5);
    ...
    obj7[2] = tmp6;
    obj6[1] = callback(tmp2(4754).Button, obj7);
    items1[3] = callback(View, obj6);
    obj1[1] = items1;
    obj[2] = callback2(View, obj1);
    obj[1] = callback(tmp2(5415).Card, obj);
