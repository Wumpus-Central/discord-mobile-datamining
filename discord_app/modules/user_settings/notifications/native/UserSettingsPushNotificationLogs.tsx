...
export default function UserSettingsPushNotificationLogs() {
  ...
  let items1 = [
    closure_7(defaultValue(7102).SearchField, {
      size: "md",
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj1 = { value: tmp5(10261)(), done: false };
            return obj1;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          closure_128_0 = value;
          obj = tmp2(8426);
          const obj3 = { message: tmp5(10262)(closure_128_0, false) };
  ...
  obj.children = closure_7(defaultValue(9122).ShareIcon, {});
  items1[1] = closure_7(defaultValue(5173).PressableOpacity, obj);
  obj.children = items1;
  ...
  items2[1] = closure_7(defaultValue(8943).FlashList, obj1);
  obj.children = items2;
