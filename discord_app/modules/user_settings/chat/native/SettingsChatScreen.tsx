...
function VideoUploadQualityNitroUpsell() {
  ...
  obj3.children = intl.format(require("util").t["Up+hSO"], {
  ...
  if (!stateFromStores) {
    ...
    items2[1] = closure_9(tmp(4753).Text, obj8);
    obj6.children = items2;
    obj5.children = closure_10(View, obj6);
    obj4.children = closure_9(tmp(5826).Card, obj5);
...
export default function SettingsChatScreen(route) {
  ...
  const node = noop.useMemo(() => {
    ...
    const items6 = [, ,];
    ({
      EMOJI_REACTIONS_ON_MESSAGES: arr7[0],
      CHAT_EMOJI_EMOTICONS: arr7[1],
      INLINE_EMOJI_SUGGESTIONS: arr7[2],
    } = MobileUserSettings);
