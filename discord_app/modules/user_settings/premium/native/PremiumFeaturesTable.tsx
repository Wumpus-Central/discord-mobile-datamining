...
function CheckIcon() {
  ...
  obj = { source: _modDef13504, color: obj.isThemeDark(useThemeDefault()) ? unsafe_rawColors.WHITE : unsafe_rawColors.PRIMARY_860, size: native.IconSizes.SMALL };
...
createStyles.themedHighlightedCell = { backgroundColor: fn(5455).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
...
let obj3 = { icon: null };
let obj2 = { backgroundColor: fn(5455).PREMIUM_FEATURES_TABLE_HIGHLIGHTED_CELL_BG };
