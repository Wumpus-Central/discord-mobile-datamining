...
createStyles.themedBackground = { backgroundColor: fn(5522).DARK_PRIMARY_700_LIGHT_WHITE_500 };
let obj2 = { backgroundColor: fn(5522).DARK_PRIMARY_700_LIGHT_WHITE_500 };
createStyles.backButtonBackground = { backgroundColor: fn(5522).TIER_0_MARKETING_PAGE_BACK_BUTTON_BG };
