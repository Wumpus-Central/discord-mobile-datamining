...
let createStyles = {
  ...
  arrowIcon: null,
  backButton: null,
  sectionWithTopMargin: null,
  sectionWithPadding: null,
  sectionWidth: null,
  accountCreditContainer: null,
  accountCreditContainerWithSpacing: null,
...
createStyles.themedBackground = { backgroundColor: fn(5491).DARK_PRIMARY_700_LIGHT_WHITE_500 };
let obj2 = { backgroundColor: fn(5491).DARK_PRIMARY_700_LIGHT_WHITE_500 };
createStyles.backButtonBackground = { backgroundColor: fn(5491).TIER_0_MARKETING_PAGE_BACK_BUTTON_BG };
...
export default function PremiumMarketingPage(userHasSubscription) {
  ...
  promotionMarketingComponent = tmpResult.usePromotionMarketingComponent(
