...
import ReferralProgramUtils from "ReferralProgramUtils" /* 8108 */;
import MarketingPageBannerTileDefault from "MarketingPageBannerTile" /* 13474 */;
...
import PremiumPerkCarouselDefault from "PremiumPerkCarousel" /* 13535 */;
...
function NitroHomeHeader(arg0) {
  ...
  obj1 = { style: tmp.backButtonWrapper, onPress: callback, children: closure_17(onClose(5678).ArrowLargeLeftIcon, { size: "md", color: "white" }) };
  const items1 = [closure_17(onClose(5173).PressableOpacity, obj1), , ];
  ...
  items1[1] = closure_17(onClose(4601).Text, obj2);
  if (mobileNitroManageSubscriptionsSettingsExperiment) {
    ...
    const obj4 = {
      ...
      onPress() {
          const obj = { current_component: constants.YOUR_NITRO_HOME, next_component: constants.YOUR_NITRO_PLAN, interaction_component: "header_settings_icon" };
          obj.track(constants.NITRO_HOME_NAVIGATION, obj);
          navigation.push(constants3.PREMIUM_MANAGE_PLAN);
        },
      children: closure_17(onClose(7432).SettingsIcon, { size: "md", color: "white" })
    };
    tmp11Result = closure_17(onClose(5173).PressableOpacity, obj4);
  }
  ...
  if (tmp11Result) {
    const obj5 = { style: tmp.pillParent, children: closure_17(onClose(13491).PremiumReferralTrialPill, { hasExtraMargin: true }) };
...
function NewTab(arg0) {
  ...
  const promotionMarketingComponent = obj2.usePromotionMarketingComponent(require("MarketingComponentType").MarketingComponentType.MARKETING_PAGE_BANNER);
  ...
  obj = { ref, contentContainerStyle: null, showsVerticalScrollIndicator: false, onScrollEndDrag: callback, onMomentumScrollEnd: callback, scrollEventThrottle: 0, children: null };
  ...
  if (tmp12) {
    ...
    obj1.width = tmp2(13492).PERK_CARD_SIZES[tmp2(undefined, 13492).PerkCardVariant.WIDE].width;
    obj.style = obj1;
  ...
  if (isEligibleSenderForReferralProgram) {
    obj2 = { onLayout: useScrollToSectionDefault(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM), children: closure_17(tmp2(13519).ReferralProgramPerkCard, {}) };
...
function PerksTab(extraBottomHeight) {
  ...
  obj = { contentContainerStyle: null, showsVerticalScrollIndicator: false, onScrollEndDrag: callback, onMomentumScrollEnd: callback, scrollEventThrottle: 0, children: null };
...
let obj1 = { headerContainer: { display: "flex", flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 8, justifyContent: "space-between", gap: 8 }, contentContainer: { display: "flex", flexDirection: "column" }, backButtonWrapper: null, headerText: null, pillParent: null };
...
fn(4605);
createStyles = { featureCardsContainer: { display: "flex", flexDirection: "column", rowGap: 16, alignItems: "center", paddingTop: 24 }, marketingBannerCard: null };
const alphaResult = n(nativeDefault.unsafe_rawColors.PLUM_24).alpha(0.6);
createStyles.marketingBannerCard = { backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH, borderRadius: nativeDefault.radii.sm };
...
export default function PremiumNitroHome(onClose) {
  ...
  const commonTriggerPoint = obj.useCommonTriggerPoint(bottom(13487).OpenNitroTriggerPoint);
  let obj1 = bottom(7437);
  ...
  let tmp6Result = tmp6(13537);
  let tmpResult1 = bottom(4456);
  const tmp6ResultResult = tmp6Result(tmp21.endsAt, bottom(13537).CountDownMessageTypes.ENDS_IN);
  ...
  const effect2 = obj4.useEffect(() => {
    if (!obj.UNSAFE_isDismissibleContentDismissed(dismissible_content.DismissibleContent.MOBILE_NITRO_HOME_SETTINGS_BADGE)) {
      ...
      const result = tmpResult.UNSAFE_markDismissibleContentAsDismissed(dismissible_content.DismissibleContent.MOBILE_NITRO_HOME_SETTINGS_BADGE);
    }
    tmpResult = DismissibleContentUnsafeUtils;
    if (!tmpResult.UNSAFE_isDismissibleContentDismissed(dismissible_content.DismissibleContent.REFERRAL_TRIAL_MOBILE_NITRO_HOME_BADGE)) {
  ...
  tmp6Result = tmp6(5637);
  obj5.source = navigation(13538);
  const items8 = [closure_17(tmp6Result, obj5), closure_17(NitroHomeHeader, { onClose: onClose.onClose, subscription: stateFromStores1 }), , , ];
  let tmp26Result = tmp21.fractionalState !== FractionalPremiumStates.NONE && !isInReverseTrial;
  if (tmp26Result) {
    obj6 = { countdownText: tmp6ResultResult };
    tmp26Result = closure_17(tmp6(13539), obj6);
  }
  ...
  if (!isThemeDarkResult) {
    ...
    items12[1] = obj12;
    obj11.style = items12;
    tmp26Result1 = closure_17(tmp6(5037), obj11);
  }
  items11[1] = tmp26Result1;
  const obj10 = { style: tmp5.segmentedControlActual, onLayout: callback, children: closure_17(bottom(9863).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" }) };
  if (tmpResult4.isAndroid()) {
    ...
    tmp26Result2 = closure_17(tmp6(5014), obj15);
    const tmp6Result1 = tmp6(5014);
  }
  items11[2] = tmp26Result2;
  obj9.children = items11;
  items8[4] = closure_18(navigation(4341).View, obj9);
