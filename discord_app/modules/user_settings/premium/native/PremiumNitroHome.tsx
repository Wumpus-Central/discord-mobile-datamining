...
function NitroHomeHeader(arg0) {
  ...
  obj1 = {
    ...
    onPress: callback,
    children: callback2(tmp2(5628).ArrowLargeLeftIcon, { size: "md", color: "white" }),
  };
  ...
  if (tmp11Result) {
    ...
    obj5[1] = tmp11(tmp2(13415).PremiumReferralTrialPill, { hasExtraMargin: true });
...
function NewTab(arg0) {
  ...
  if (tmp12) {
    ...
    obj1[0] = tmp2(13416).PERK_CARD_SIZES[tmp2(undefined, 13416).PerkCardVariant.WIDE].width;
    obj[0] = obj1;
  ...
  if (isEligibleSenderForReferralProgram) {
    ...
    obj2[1] = tmp15(tmp2(13443).ReferralProgramPerkCard, {});
...
export default function PremiumNitroHome(onClose) {
  ...
  const items9 = [callback2(bottom(12616).SegmentedControlPages, { state: segmentedControlState })];
  if (tmp26Result) {
    obj8 = { style: null };
  ...
  const items11 = [
    callback2(c5, {
      ...
      onLayout: callback,
      children: callback2(bottom(9793).SegmentedControl, {
  ...
  const obj10 = {
    style: tmp5.segmentedControlActual,
    onLayout: callback,
    children: callback2(bottom(9793).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" }),
  };
