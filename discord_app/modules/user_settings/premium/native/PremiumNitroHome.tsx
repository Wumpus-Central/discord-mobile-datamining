...
function NitroHomeHeader(arg0) {
  ...
  obj1 = {
    ...
    onPress: callback,
    children: closure_17(onClose(5678).ArrowLargeLeftIcon, { size: "md", color: "white" }),
  };
  ...
  if (tmp11Result) {
    const obj5 = {
      ...
      children: closure_17(onClose(13491).PremiumReferralTrialPill, { hasExtraMargin: true }),
    };
...
export default function PremiumNitroHome(onClose) {
  ...
  promotionMarketingComponent = bottom(13428).usePromotionMarketingComponent(
    tmp(10812).MarketingComponentType.PREMIUM_TAB,
  );
  ...
  const items11 = [
    closure_17(c5, {
      ...
      onLayout: callback,
      children: closure_17(bottom(9863).SegmentedControl, {
