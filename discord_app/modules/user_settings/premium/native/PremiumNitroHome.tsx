...
import ReferralProgramUtils from "ReferralProgramUtils" /* 8275 */;
...
import MarketingPageBannerTileDefault from "MarketingPageBannerTile" /* 13632 */;
import PremiumPerkCarouselDefault from "PremiumPerkCarousel" /* 13658 */;
...
function NitroHomeHeader(arg0) {
  ...
  if (tmp11Result2) {
    const obj9 = { style: tmp.pillParent, children: closure_17(onClose(13604).PremiumReferralTrialPill, { hasExtraMargin: true }) };
...
function NewTab(arg0) {
  ...
  if (isEligibleSenderForReferralProgram) {
    const obj8 = { onLayout: useScrollToSectionDefault(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM), children: closure_17(tmp2(13641).ReferralProgramPerkCard, {}) };
