// === Module 13295: NitroHomeHeader ===

// Module 13295 (NitroHomeHeader)
import ThemesDefault from "Themes" /* 709 */;
import frozenDefault from "frozen" /* 13299 */;
import useScrollToSectionDefault from "useScrollToSection" /* 13320 */;
...
import closure_9 from "zustandStore" /* 13296 */;
import { NitroHomeSectionId } from "zustandStore" /* 13296 */;
...
function NitroHomeHeader(arg0) {
  ...
  obj1 = { style: tmp.backButtonWrapper, onPress: callback, children: callback2(tmp2(5507).ArrowLargeLeftIcon, { size: "md", color: "white" }) };
...
function NewTab(arg0) {
  ...
  let obj2 = _require(13235);
  const promotionMarketingComponent = obj2.usePromotionMarketingComponent(_require(10736).MarketingComponentType.MARKETING_PAGE_BANNER);
  ...
  const items1 = [tmp12, callback2(_require(13322).TieredTenureBadgePerkCard, {}), , , , , ];
...
export default function PremiumNitroHome(onClose) {
  ...
  promotionMarketingComponent = bottom(13235).usePromotionMarketingComponent(tmp(10736).MarketingComponentType.PREMIUM_TAB);
  ...
  const items11 = [callback2(c5, { style: tmp5.segmentedControlActual, onLayout: callback, children: callback2(bottom(9784).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" }) }), , ];
  ...
  const obj10 = { style: tmp5.segmentedControlActual, onLayout: callback, children: callback2(bottom(9784).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" }) };
