...
import MarketingPageBannerTileDefault from "MarketingPageBannerTile" /* 13477 */;
import PremiumPerkCarouselDefault from "PremiumPerkCarousel" /* 13502 */;
...
function NitroHomeHeader(arg0) {
  ...
  obj1 = { style: tmp.backButtonWrapper, onPress: callback, children: closure_17(onClose(5679).ArrowLargeLeftIcon, { size: "md", color: "white" }) };
  const items1 = [closure_17(onClose(5174).PressableOpacity, obj1), , ];
  ...
  items1[1] = closure_17(onClose(4602).Text, obj2);
  if (mobileNitroManageSubscriptionsSettingsExperiment) {
    ...
    const obj4 = {
      ...
      children: closure_17(onClose(7453).SettingsIcon, { size: "md", color: "white" })
    };
    tmp11Result = closure_17(onClose(5174).PressableOpacity, obj4);
  }
  ...
  if (tmp11Result) {
    const obj5 = { style: tmp.pillParent, children: closure_17(onClose(13449).PremiumReferralTrialPill, { hasExtraMargin: true }) };
...
function NewTab(arg0) {
  ...
  if (tmp12) {
    ...
    obj1.width = tmp2(13450).PERK_CARD_SIZES[tmp2(undefined, 13450).PerkCardVariant.WIDE].width;
    obj.style = obj1;
  ...
  if (isEligibleSenderForReferralProgram) {
    obj2 = { onLayout: useScrollToSectionDefault(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM), children: closure_17(tmp2(13486).ReferralProgramPerkCard, {}) };
...
export default function PremiumNitroHome(onClose) {
  ...
  const commonTriggerPoint = obj.useCommonTriggerPoint(bottom(13506).OpenNitroTriggerPoint);
  let obj1 = bottom(7458);
  ...
  let tmp6Result = tmp6(13509);
  let tmpResult1 = bottom(4458);
  const tmp6ResultResult = tmp6Result(tmp21.endsAt, bottom(13509).CountDownMessageTypes.ENDS_IN);
  ...
  tmp6Result = tmp6(5638);
  obj5.source = navigation(13510);
  ...
  if (tmp26Result) {
    ...
    tmp26Result = closure_17(tmp6(13511), obj6);
  }
  ...
  if (!isThemeDarkResult) {
    ...
    items12[1] = obj12;
    obj11.style = items12;
    tmp26Result1 = closure_17(tmp6(5038), obj11);
  }
  items11[1] = tmp26Result1;
  const obj10 = { style: tmp5.segmentedControlActual, onLayout: callback, children: closure_17(bottom(9884).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" }) };
  if (tmpResult4.isAndroid()) {
    ...
    tmp26Result2 = closure_17(tmp6(5015), obj15);
    const tmp6Result1 = tmp6(5015);
  }
  items11[2] = tmp26Result2;
  obj9.children = items11;
  items8[4] = closure_18(navigation(4343).View, obj9);
