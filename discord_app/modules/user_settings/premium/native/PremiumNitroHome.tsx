// === Module 13307: NitroHomeHeader ===

// Module 13307 (NitroHomeHeader)
import ThemesDefault from "Themes" /* 709 */;
import frozenDefault from "frozen" /* 13311 */;
import useScrollToSectionDefault from "useScrollToSection" /* 13332 */;
...
import closure_9 from "zustandStore" /* 13308 */;
import { NitroHomeSectionId } from "zustandStore" /* 13308 */;
...
function NitroHomeHeader(arg0) {
  ...
  obj1 = { style: tmp.backButtonWrapper, onPress: callback, children: callback2(tmp2(5508).ArrowLargeLeftIcon, { size: "md", color: "white" }) };
...
function NewTab(arg0) {
  ...
  let obj2 = _require(13247);
  const promotionMarketingComponent = obj2.usePromotionMarketingComponent(_require(10740).MarketingComponentType.MARKETING_PAGE_BANNER);
  ...
  const items1 = [tmp12, callback2(_require(13334).TieredTenureBadgePerkCard, {}), , , , , ];
...
function PerksTab(extraBottomHeight) {
  ...
  obj[0] = intl.string(_require(1233).t.DOb6x0);
...
export default function PremiumNitroHome(onClose) {
  ...
  promotionMarketingComponent = bottom(13247).usePromotionMarketingComponent(tmp(10740).MarketingComponentType.PREMIUM_TAB);
  ...
  const items11 = [callback2(c5, { style: tmp5.segmentedControlActual, onLayout: callback, children: callback2(bottom(9788).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" }) }), , ];
  ...
  const obj10 = { style: tmp5.segmentedControlActual, onLayout: callback, children: callback2(bottom(9788).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" }) };
