...
function NitroHomeHeader(arg0) {
  ...
  obj1 = {
    ...
    onPress: callback,
    children: closure_17(tmp2(5628).ArrowLargeLeftIcon, { size: "md", color: "white" }),
  };
  ...
  if (tmp11Result) {
    const obj5 = {
      ...
      children: tmp11(tmp2(13415).PremiumReferralTrialPill, { hasExtraMargin: true }),
    };
...
function NewTab(arg0) {
  ...
  if (isEligibleSenderForReferralProgram) {
    obj2 = {
      ...
      children: tmp15(tmp2(13443).ReferralProgramPerkCard, {}),
    };
  ...
  const effect2 = obj4.useEffect(() => {
    if (
      ...
      const result = tmpResult.UNSAFE_markDismissibleContentAsDismissed(
        tmp(1943).DismissibleContent.MOBILE_NITRO_HOME_SETTINGS_BADGE,
      );
    }
    tmpResult = tmp(4380);
    if (
      ...
      const result1 = tmp(4380).UNSAFE_markDismissibleContentAsDismissed(
        tmp(1943).DismissibleContent.REFERRAL_TRIAL_MOBILE_NITRO_HOME_BADGE,
      );
