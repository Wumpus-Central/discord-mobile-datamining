...
function NitroHomeHeader(arg0) {
  ...
  const items1 = [
    closure_17(onClose(5341).PressableOpacity, {
      style: tmp.backButtonWrapper,
      onPress: callback,
      children: closure_17(onClose(5847).ArrowLargeLeftIcon, { size: "md", color: "white" }),
    }),
    ,
  ];
  const obj6 = {
  ...
  if (tmp11Result2) {
    const obj9 = {
      ...
      children: closure_17(onClose(13673).PremiumReferralTrialPill, { hasExtraMargin: true }),
    };
...
function NewTab(arg0) {
  ...
  if (isEligibleSenderForReferralProgram) {
    const obj8 = {
      ...
      children: closure_17(tmp2(13710).ReferralProgramPerkCard, {}),
    };
...
export default function PremiumNitroHome(onClose) {
  ...
  promotionMarketingComponent = bottom(13695).usePromotionMarketingComponent(
    tmp(11005).MarketingComponentType.PREMIUM_TAB,
  );
  ...
  const items8 = [
    closure_17(navigation(5806), obj18),
  ...
  const items11 = [
    closure_17(c5, {
      ...
      onLayout: callback,
      children: closure_17(bottom(9897).SegmentedControl, {
