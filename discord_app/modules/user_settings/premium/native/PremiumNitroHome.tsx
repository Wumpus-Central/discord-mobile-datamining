...
function NitroHomeHeader(arg0) {
  ...
  if (mobileNitroManageSubscriptionsSettingsExperiment) {
    ...
    obj4[2] = tmp11(tmp2(6013).SettingsIcon, { size: "md", color: "white" });
  ...
  if (tmp11Result) {
    ...
    obj5[1] = tmp11(tmp2(12695).PremiumReferralTrialPill, { hasExtraMargin: true });
...
function NewTab(arg0) {
  ...
  if (tmp12) {
    ...
    obj1 = { width: null };
    let tmp8Result = tmp8(7756);
    obj1[0] = tmp2(12696).PERK_CARD_SIZES[tmp2(undefined, 12696).PerkCardVariant.WIDE].width;
    obj[0] = obj1;
  ...
  if (isEligibleSenderForReferralProgram) {
    ...
    obj2[1] = tmp15(tmp2(12723).ReferralProgramPerkCard, {});
    tmp15Result = tmp15(closure_5, obj2);
  }
  items1[2] = tmp15Result;
  tmp8Result = tmp8(12696);
...
export default function PremiumNitroHome(onClose) {
  ...
  let obj = bottom(12690);
  const commonTriggerPoint = obj.useCommonTriggerPoint(bottom(12691).OpenNitroTriggerPoint);
  let obj1 = bottom(6021);
  ...
  const tmp21 = navigation(6862)();
  let obj7 = bottom(8168);
  const isInReverseTrial = obj7.useIsInReverseTrial();
  let obj8 = bottom(12736);
  ...
  let tmp6Result = tmp6(12737);
  let tmpResult1 = bottom(1363);
  const tmp6ResultResult = tmp6Result(tmp21.endsAt, bottom(12737).CountDownMessageTypes.ENDS_IN);
  ...
  let tmpResult2 = bottom(8164);
  promotionMarketingComponent = bottom(7645).usePromotionMarketingComponent(tmp(7649).MarketingComponentType.PREMIUM_TAB);
  ...
  if (tmp26Result) {
    ...
    tmp26Result = tmp26(tmp6(12739), obj6);
  }
  items8[2] = tmp26Result;
  obj7 = { style: tmp5.tabContent, children: null };
  const items9 = [callback2(bottom(9567).SegmentedControlPages, { state: segmentedControlState }), ];
  if (tmp26Result) {
    obj8 = { style: null };
  ...
  obj10[2] = callback2(bottom(9147).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" });
  ...
  obj9[2] = items11;
  items8[4] = closure_18(navigation(4042).View, obj9);
  obj4[1] = items8;
