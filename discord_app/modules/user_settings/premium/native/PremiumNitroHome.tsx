...
function NitroHomeHeader(arg0) {
  ...
  const items1 = [
    closure_17(onClose(5292).PressableOpacity, {
      style: tmp.backButtonWrapper,
      onPress: callback,
      children: closure_17(onClose(5798).ArrowLargeLeftIcon, { size: "md", color: "white" }),
    }),
    ,
  ];
  const obj6 = {
  ...
  if (mobileNitroManageSubscriptionsSettingsExperiment) {
    ...
    const obj8 = {
      ...
      children: closure_17(onClose(7576).SettingsIcon, { size: "md", color: "white" }),
    };
    tmp11Result = closure_17(onClose(5292).PressableOpacity, obj8);
  }
  ...
  if (tmp11Result2) {
    const obj9 = {
      ...
      children: closure_17(onClose(13604).PremiumReferralTrialPill, { hasExtraMargin: true }),
    };
...
function NewTab(arg0) {
  ...
  if (isEligibleSenderForReferralProgram) {
    const obj8 = {
      ...
      children: closure_17(tmp2(13641).ReferralProgramPerkCard, {}),
    };
...
function PerksTab(extraBottomHeight) {
  ...
  if (fractionalState === FractionalPremiumStates.FP_ONLY) {
    ...
    items4[2] = closure_17(tmp9(13658), obj5);
...
export default function PremiumNitroHome(onClose) {
  ...
  promotionMarketingComponent = bottom(13626).usePromotionMarketingComponent(
    tmp(10985).MarketingComponentType.PREMIUM_TAB,
  );
  ...
  const items8 = [
    closure_17(navigation(5757), obj18),
  ...
  if (tmp26Result) {
    ...
    tmp26Result = closure_17(tmp6(13667), obj19);
  }
  ...
  const items11 = [
    closure_17(c5, {
      ...
      onLayout: callback,
      children: closure_17(bottom(10038).SegmentedControl, {
  ...
  if (!isThemeDarkResult) {
    ...
    items12[1] = obj25;
    obj24.style = items12;
    tmp26Result5 = closure_17(tmp6(5156), obj24);
  }
  ...
  if (tmpResult10.isAndroid()) {
    ...
    tmp26Result6 = closure_17(tmp6(5131), obj28);
