...
import MarketingPageBannerTileDefault from "MarketingPageBannerTile" /* 13527 */;
import PremiumPerkCarouselDefault from "PremiumPerkCarousel" /* 13553 */;
...
function NitroHomeHeader(arg0) {
  ...
  if (tmp11Result2) {
    const obj9 = { style: tmp.pillParent, children: closure_17(onClose(13499).PremiumReferralTrialPill, { hasExtraMargin: true }) };
...
function NewTab(arg0) {
  ...
  if (isEligibleSenderForReferralProgram) {
    const obj8 = { onLayout: useScrollToSectionDefault(ref, scrollToSectionId).createSectionLayoutHandler(NitroHomeSectionId.REFERRAL_PROGRAM), children: closure_17(tmp2(13536).ReferralProgramPerkCard, {}) };
