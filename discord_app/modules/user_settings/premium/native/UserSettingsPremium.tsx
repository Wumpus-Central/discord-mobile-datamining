...
export default function UserSettingsPremium(applicationId) {
    ...
    if (closure_12) {
      ...
      const timeout = setTimeout(() => {
        ...
        obj = {
          ...
          iap_product_missing: String(null == product.getProduct(closure_0(7488).ProductIds.PREMIUM_TIER_2_MONTHLY)),
  ...
  if (tmp28) {
    ...
    if (null != premiumFeatureCardOrder) {
      obj5 = {
        applicationId,
        userHasSubscription: tmp30Result2,
      ...
      if (tmp30Result2) {
        ...
        tmp30Result1 = jsx(PremiumSubscriptionDetailsDefault, {
          style: tmp.subscriptionHeader,
          onClickManagePremiumGuild: handleLearnMorePremiumGuild,
          subscription: tmp9,
        });
      ...
      tmp30Result = jsx(PremiumMarketingPageDefault, {
        applicationId,
        userHasSubscription: tmp30Result2,
        subscriptionDetails: null,
        billingInfo: null,
