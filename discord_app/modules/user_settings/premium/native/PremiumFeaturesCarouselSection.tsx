...
function PremiumFeaturesCarousel(arg0) {
  ...
  if (!onEndReached(1608).isThumbstickScrollDevice) {
    if (!isScreenReaderEnabled) {
      ...
      let tmp19 = closure_10(currentIndex(10827), obj);
    }
    let items3 = [tmp19, ];
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  const items2 = [closure_10(analyticsLocations(4601).Text, obj), closure_10(PremiumFeaturesCarousel, { width: tmp4[0], onEndReached: callback })];
  obj.children = items2;
  return closure_11(closure_6, obj);
};
