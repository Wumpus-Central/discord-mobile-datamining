...
import _modDef12996 from "../../../../../_runtime/metro/12996__.js";
import _modDef12997 from "../../../../../_runtime/metro/12997__.js";
import _modDef12998 from "../../../../../_runtime/metro/12998__.js";
...
function PremiumFeaturesCarousel(arg0) {
  ...
  if (!onEndReached(1609).isThumbstickScrollDevice) {
    ...
    items3[1] = tmp17(onEndReached(1177).CarouselPagination, obj4);
...
export default function PremiumFeaturesCarouselSection(style) {
  ...
  const items2 = [
    closure_10(analyticsLocations(4825).Text, obj3),
