...
export default function usePremiumFeatures(arg0) {
  ...
  return noop.useMemo(() => {
    ...
    items2[1] = obj;
    const obj1 = { IconComponent: UploadIcon.UploadIcon, label: null, premiumTypes: null, premiumGroupRoles: null, availableOnFractional: true };
    ...
    items2[2] = obj1;
    const obj3 = { IconComponent: ReactionIcon.ReactionIcon, label: null, premiumTypes: null, premiumGroupRoles: null, availableOnFractional: true };
    ...
    items2[3] = obj3;
    const obj4 = { IconComponent: SuperReactionIcon.SuperReactionIcon, label: null, premiumTypes: null, premiumGroupRoles: null, availableOnFractional: true };
    ...
    items2[4] = obj4;
    obj5 = { IconComponent: NitroWheelIcon.NitroWheelIcon, label: null, premiumTypes: null, premiumGroupRoles: null, availableOnFractional: true };
    ...
    items2[5] = obj5;
    const obj6 = { IconComponent: ScreenStreamIcon.ScreenStreamIcon, label: null, premiumTypes: null, premiumGroupRoles: null, availableOnFractional: true };
    ...
    items2[7] = obj7;
    const obj9 = { IconComponent: BoostGemIcon.BoostGemIcon, label: null, premiumTypes: null, premiumGroupRoles: null, availableOnFractional: false };
    ...
    items2[8] = obj9;
    const obj11 = { IconComponent: UserSquareIcon.UserSquareIcon, label: null, premiumTypes: null, premiumGroupRoles: null, availableOnFractional: true };
