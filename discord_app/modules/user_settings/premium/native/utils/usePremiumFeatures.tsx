...
const result = require("SubscriptionStatusTypes").fileFinishedImporting("modules/user_settings/premium/native/utils/usePremiumFeatures.tsx");
...
export default function usePremiumFeatures(arg0) {
  ...
  return React.useMemo(() => {
    ...
    obj[3] = items4;
    items2[1] = obj;
    const obj1 = { IconComponent: callback(UNSPECIFIED[7]).UploadIcon, label: null, premiumTypes: null, premiumGroupRoles: null, availableOnFractional: true };
    ...
    obj7[1] = intl8.formatToPlainString(flag(UNSPECIFIED[6]).HVCRVf, { numBoosts: outer1_4 });
    ...
    obj9[1] = intl9.formatToPlainString(callback(UNSPECIFIED[5]).t.DbkNFj, { numBoosts: outer1_4 });
