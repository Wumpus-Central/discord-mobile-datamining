...
import { getTableDividerWidth } from "../../../../design/components/TableRow/native/TableRowConstants.tsx";
import { CustomCheckoutFlow } from "../../../payments/PaymentConstants.tsx";
...
function ManagePlanHeader() {
  ...
  obj = {
    ...
    children: callback3(require("../../../../design/components/Icon/native/redesign/generated/ArrowLargeLeftIcon.tsx").ArrowLargeLeftIcon, { size: "md" })
  };
  const items = [callback3(require("../../../../design/void/Pressables/native/Pressables.tsx").PressableOpacity, obj), , ];
  obj1 = { variant: "redesign/heading-18/bold", accessibilityRole: "header", children: null };
  const intl = require("../../../../intl/index.native.tsx").intl;
  obj1[2] = intl.string(require("../../../../intl/index.native.tsx").t["1bX7Tx"]);
...
function SubscriptionAndBillingInfo(subscription) {
  ...
  subscription(stateFromStores2[28]);
  let obj = { subscriptionId: subscription.id, renewal: true, applyEntitlements: true, analyticsLocations, analyticsLocation: analyticsLocations(stateFromStores2[29]).PREMIUM_SUBSCRIPTION_DETAILS };
    ...
    if (subscription.isOnPlatformMatchingExternalPaymentGateway) {
      if (null != subscription.paymentGatewayPlanId) {
        if ("" !== subscription.paymentGatewayPlanId) {
          return closure_1_18.getProduct(subscription.paymentGatewayPlanId);
        }
      }
      const _Error = Error;
  ...
  const callback = tmp4Result.useNavigation();
  ...
  const stateFromStores3 = tmp4(tmp2[30]).useStateFromStores(items3, () => state.getState());
    ...
    if ("start_fetching_update" !== first2) {
      if ("fetching_update" !== tmp) {
        ...
        obj[3] = function onSuccessCallback() {
          ...
          analyticsLocations(stateFromStores2[38]);
          const obj = { load_id: closure_7, location_stack: null, custom_checkout_flow: null };
          const items = [...closure_1, analyticsLocations(stateFromStores2[29]).MOBILE_APP_MANAGE_PREMIUM_SUBSCRIPTION_CTA];
          obj[1] = items;
  ...
  if (null == first) {
        ...
        if (statusFromInvoice !== constants2.PAST_DUE) {
          if (null != subscription.renewalMutations) {
            ...
            if (!subscription.hasExternalPlanChange) {
              ...
              items6[1] = callback3(tmp4(tmp2[23]).Text, obj4);
              obj3[1] = items6;
              const items7 = [callback2(tmp41, obj3), , ];
              ...
              items7[1] = callback3(tmp(tmp2[52]), obj6);
              ...
              const items8 = [callback3(tmp4(tmp2[23]).Text, obj8), ];
              ...
              const items9 = [callback3(tmp4(tmp2[23]).Text, obj10), , ];
              ...
              items9[1] = callback3(tmp4(tmp2[23]).Text, obj11);
              items9[2] = null != memo && memo;
              obj9[1] = items9;
              items8[1] = callback2(tmp41, obj9);
              obj7[1] = items8;
              items7[2] = callback2(tmp41, obj7);
              obj2[1] = items7;
              return callback2(tmp41, obj2);
            }
            ...
            obj13[1] = items10;
            const items11 = [callback2(c8, obj13), ];
            ...
            obj23[1] = items15;
            items12[3] = callback2(c8, obj23);
            obj16[1] = items12;
            items11[1] = callback2(c8, obj16);
            obj12[1] = items11;
            return callback2(c8, obj12);
          }
        }
      }
    }
    ...
    obj29[1] = items16;
    const items17 = [callback2(c8, obj29), ];
    ...
    obj28[2] = items17;
    const items18 = [callback2(closure_7, obj28), ];
    ...
    if (isOnPlatformMatchingExternalPaymentGateway) {
          ...
          try {
            ...
            if (0 === c1) {
              if (arg0 === 1) {
                ...
                closure_1_8(true);
                c3 = 1;
                obj1 = subscription(stateFromStores2[48]);
                c1 = 2;
                c4 = 1;
                obj1 = { value: null, done: false };
                obj1[0] = obj1.onResubscribeClick(subscription);
                return obj1;
              }
            } else if (1 === tmp7) {
              c3 = 0;
      ...
      obj34[4] = tmp21;
      obj34[5] = tmp21;
      obj33[1] = callback3(tmp4(tmp2[47]).Button, obj34);
      isOnPlatformMatchingExternalPaymentGateway = callback3(tmp48, obj33);
    }
    items18[1] = isOnPlatformMatchingExternalPaymentGateway;
    obj27[1] = items18;
    const items19 = [callback2(c8, obj27), ];
    ...
    obj37[1] = items21;
    items20[1] = callback2(c8, obj37);
    obj35[1] = items20;
    items19[1] = callback2(c8, obj35);
    obj26[1] = items19;
    return callback2(c8, obj26);
  }
...
function FractionalPremiumCredits(durationText) {
  ...
  if (hasUnactivatedUnits) {
    if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
      ...
      let tmp8Result = callback3(Text.Text, obj12);
    }
    items4[1] = tmp8Result;
    obj10[1] = items4;
    items3[1] = callback2(closure_8, obj10);
    obj4[4] = items3;
    const items5 = [callback2(PressableCard.Card, obj4), , ];
    const obj13 = { style: null, children: null };
    obj13[0] = tmp3.dividerContainer;
    const obj14 = { style: null };
    obj14[0] = tmp3.divider;
    obj13[1] = callback3(closure_8, obj14);
    items5[1] = callback3(closure_8, obj13);
    ...
    if (hasUnactivatedUnits) {
      if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
        ...
        obj17[1] = intl6.string(getSystemLocale.t["hT6i/0"]);
        const items6 = [callback3(Text.Text, obj17), ];
        ...
        if (tmp8Result) {
          ...
          obj18[2] = intl7.format(getSystemLocale.t["0Vwb/l"], obj19);
          tmp8Result = callback3(Text.Text, obj18);
        }
        const obj20 = { children: null };
        items6[1] = tmp8Result;
        obj20[0] = items6;
        let tmp8Result2 = callback2(closure_8, obj20);
      }
      ...
      if (hasUnactivatedUnits) {
        if (fractionalPremiumInfo.fractionalState === constants3.NONE) {
          ...
          obj21[1] = callback3(Text.Text, obj22);
          let tmp8Result1 = callback3(closure_8, obj21);
        }
        const obj23 = { children: null };
        items7[1] = tmp8Result1;
        obj16[1] = items7;
        obj15[4] = callback2(closure_8, obj16);
        items5[2] = callback3(tmp13, obj15);
        obj23[0] = items5;
        items1[2] = callback2(closure_8, obj23);
        obj[1] = items1;
        items[1] = callback2(closure_8, obj);
        obj[1] = items;
      ...
      obj24[1] = callback3(Text.Text, obj25);
      tmp8Result1 = callback3(closure_8, obj24);
    }
    const obj26 = { variant: "text-md/semibold", style: null, children: null };
    obj26[1] = tmp3.fpTimeRemaining;
    const intl5 = getSystemLocale.intl;
    obj26[2] = intl5.string(getSystemLocale.t["3G0CTC"]);
    tmp8Result2 = callback3(Text.Text, obj26);
  }
  ...
  tmp8Result = callback3(Text.Text, obj27);
}
...
let createCacheKey = { backgroundColor: ThemesDefault.colors.BACKGROUND_BASE_LOW, height: "100%" };
...
let closure_35 = createCacheKey.createStyles((arg0) => {
  ...
  let obj = { backgroundColor: ThemesDefault.colors.BACKGROUND_SURFACE_HIGH, borderRadius: ThemesDefault.radii.lg, overflow: "hidden" };
  obj[1] = obj;
  obj[2] = { padding: 16 };
...
let result = require("obj132").fileFinishedImporting("modules/user_settings/premium/native/PremiumManagePlan.tsx");
...
export default function PremiumManagePlan() {
  ...
  useMountLayoutEffectDefault(() => {
    ...
    tmp5 = closure_14.isLoadedForPremiumSKUs() || closure_14.isFetchingForPremiumSKUs();
  });
  ...
  const callback = obj2.useCallback((nativeEvent) => {
    navigation(dependencyMap[66]);
    const obj = { nativeEvent: nativeEvent.nativeEvent, trackedType: "your_nitro_plan", hasTrackedScrolledToBottom: closure_1 };
    return obj.trackIfScrolledToBottom(obj);
  }, []);
  const tmp4Result = tmp4(589);
  ...
  items5[1] = { height: num };
  const items6 = [callback(tmp2Result, { blurAmount: 0.2, style: items5, blurTheme: tmp4Result.useThemeContext().theme }), ];
  ...
  const items8 = [callback(ManagePlanHeader, {}), ];
  ...
  if (tmp29Result) {
    ...
    tmp29Result = callback(tmp2(9327), obj4);
  }
  ...
  if (tmp29Result1) {
    ...
    obj5[0] = tmp12;
    obj5[1] = tmp12.fractionalState === constants3.FP_ONLY;
    obj5[2] = tmp17;
    obj5[3] = unactivatedFractionalPremiumDurationString;
    obj5[4] = currentPeriodEnd;
    obj5[5] = tmp15Result;
    tmp29Result1 = callback(FractionalPremiumCredits, obj5);
  }
  ...
  if (tmp27Result) {
    ...
    obj7[1] = function onClickManagePremiumGuild() {
      ...
      let obj = callback(dependencyMap[69]);
      obj.setSection(closure_1_22.GUILD_BOOSTING);
      obj = { destinationPane: closure_1_22.GUILD_BOOSTING };
      const result = navigation(dependencyMap[70]).trackUserSettingsPaneViewed(obj);
      if (null != found) {
        arr.navigate(closure_1_22.GUILD_BOOSTING, undefined, { pop: true });
      } else {
        arr = arr.push(closure_1_22.GUILD_BOOSTING);
      }
      const obj2 = navigation(dependencyMap[70]);
    };
    obj7[2] = tmp10;
    const items10 = [callback(tmp2(7880), obj7), ];
    obj8 = { style: null, subscription: null };
    obj8[0] = tmp.billingInfo;
    obj8[1] = tmp10;
    items10[1] = callback(tmp2(7920), obj8);
    obj6[0] = items10;
    tmp27Result = callback2(closure_8, obj6);
  }
  ...
  obj9[4] = flag;
  items9[5] = callback(tmp2Result, obj9);
  ...
  items9[6] = callback(CheckIconDefault, obj10);
  obj1[1] = items9;
  items8[1] = callback2(closure_8, obj1);
  obj[4] = items8;
  items6[1] = callback2(closure_9, obj);
  obj[1] = items6;
  return callback2(closure_8, obj);
};
