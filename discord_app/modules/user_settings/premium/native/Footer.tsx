...
import useOpenPremiumMarketingPaymentDefault from "useOpenPremiumMarketingPayment" /* 13851 */;
...
export default function Footer(showSubscribeButton) {
  ...
  items2[1] = React4(tmp2Result, { style: easterEggSpacing, source: _modDef13852 });
  obj.children = items2;
