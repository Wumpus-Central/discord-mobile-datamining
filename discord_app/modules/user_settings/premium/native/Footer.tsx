...
export default function Footer(showSubscribeButton) {
  ...
  const tmp = callback2();
  importDefault(12544)(importDefault(5539).PREMIUM_MARKETING_FOOTER);
  ...
  const tmp4 = importDefault(12544);
  if (!showSubscribeButton) {
    easterEggSpacing = tmp.easterEggSpacing;
  }
  const tmp2Result = importDefault(5145);
  items2[1] = tmp14(tmp2Result, { style: easterEggSpacing, source: importDefault(12545) });
  obj[1] = items2;
