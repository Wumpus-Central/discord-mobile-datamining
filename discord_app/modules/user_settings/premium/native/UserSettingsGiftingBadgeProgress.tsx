...
function GiftingBadgeIntro(analyticsLocation) {
  ...
  importDefault = tmp;
  dependencyMap = analyticsLocation(11004).useIsGiftingBadgeComplexArtEnabled(UserSettingsGiftingBadgeProgress);
  let obj = analyticsLocation(11004);
  ...
  if (null != stateFromStores) {
    ...
    obj7.icon = closure_9(tmp2(11299).GiftIcon, obj8);
...
let closure_8 = fn(8461).getSingleRequirementThreshold;
const jsxProd = fn(21);
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  const stateFromStoresObject = analyticsLocation(504).useStateFromStoresObject(items, () => {
    singleRequirementProgress = singleRequirementProgress.getSingleRequirementProgress(
      analyticsLocation(_undefined[11]).BadgeId.GIFTING,
    );
    let num;
    ...
    const obj2 = {
      badgeProgress: num,
      currentTier: singleRequirementProgress.getCurrentTier(analyticsLocation(_undefined[11]).BadgeId.GIFTING),
      nextTier: singleRequirementProgress.getNextTier(analyticsLocation(_undefined[11]).BadgeId.GIFTING),
      giftsRemaining: singleRequirementProgress.getRemainingToNextTier(
        analyticsLocation(_undefined[11]).BadgeId.GIFTING,
      ),
      tiers: null,
    };
    const badgeById = obj.getBadgeById(analyticsLocation(_undefined[11]).BadgeId.GIFTING);
    let tiers;
    if (badgeById != null) {
      tiers = badgeById.tiers;
    }
  ...
  const isGiftingBadgeComplexArtEnabled = analyticsLocation(11004).useIsGiftingBadgeComplexArtEnabled(
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(11004).getGiftingBadgeProgressPercent(
      badgeProgress,
      currentTier,
      nextTier,
    );
    const tmp7Result = tmp7(11004);
    let giftingBadgeTierIconUrl = tmp7(11004).getGiftingBadgeTierIconUrl(currentTier, isGiftingBadgeComplexArtEnabled);
    const tmp7Result3 = tmp7(11004);
    const giftingBadgeTierIconUrl1 = tmp7(11004).getGiftingBadgeTierIconUrl(nextTier, isGiftingBadgeComplexArtEnabled);
    if (null != nextTier) {
    ...
    if (tmp13) {
      ...
      tmp13 = closure_9(tmp4(11009), obj9);
    }
    let items1 = [tmp13, ,];
    const obj10 = {
    ...
    if (tmp15Result) {
      ...
      tmp15Result = closure_9(tmp4(11009), obj11);
    }
    ...
    obj19.icon = closure_9(tmp7(11299).GiftIcon, obj20);
    ...
    if (tmp11Result) {
      ...
      items7[1] = closure_9(tmp7(4752).Text, obj27);
  ...
  let obj2 = analyticsLocation(11004);
}
