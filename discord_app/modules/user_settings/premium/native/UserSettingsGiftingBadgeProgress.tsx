...
let closure_12 = createStyles.createStyles(() => {
  ...
  obj = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_MUTED, borderRadius: nativeDefault.radii.md, padding: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_16 };
  obj.wrapper = obj;
  ...
  const obj3 = { height: 6, borderRadius: nativeDefault.radii.round, backgroundColor: nativeDefault.colors.BACKGROUND_MOD_NORMAL, overflow: "hidden" };
  ...
  const obj4 = { height: 6, borderRadius: nativeDefault.radii.round, backgroundColor: nativeDefault.unsafe_rawColors.BRAND_500 };
  ...
  const obj5 = { flexDirection: "row", justifyContent: "flex-end", alignItems: "center", minHeight: nativeDefault.space.PX_16, marginTop: nativeDefault.space.PX_4 };
  ...
  const obj7 = { flexDirection: "row", flexWrap: "wrap", justifyContent: "center", paddingVertical: nativeDefault.space.PX_4 };
  ...
  const obj8 = { width: "33.33%", alignItems: "center", justifyContent: "center", padding: nativeDefault.space.PX_8, gap: nativeDefault.space.PX_8 };
  ...
  const obj9 = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_MUTED, borderRadius: nativeDefault.radii.md, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
  ...
  const obj12 = { flexDirection: "row", flexWrap: "wrap", justifyContent: "center", paddingVertical: nativeDefault.space.PX_4, paddingHorizontal: nativeDefault.space.PX_16 };
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  const stateFromStoresObject = obj.useStateFromStoresObject(items, () => {
    ...
    obj = { badgeProgress: num, currentTier: obj.getCurrentTier(analyticsLocation(_undefined[10]).BadgeId.GIFTING), nextTier: obj.getNextTier(analyticsLocation(_undefined[10]).BadgeId.GIFTING), giftsRemaining: obj.getRemainingToNextTier(analyticsLocation(_undefined[10]).BadgeId.GIFTING), tiers: null };
    const badgeById = obj.getBadgeById(analyticsLocation(_undefined[10]).BadgeId.GIFTING);
    let tiers;
    if (badgeById != null) {
      tiers = badgeById.tiers;
    }
  ...
  if (0 === badgeProgress) {
    ...
    if (tmp14) {
      ...
      tmp14 = closure_9(tmp4(10838), obj5);
    }
    let items1 = [tmp14, , ];
    const obj6 = { style: tmp.progressTitleText, variant: "text-md/medium", color: "text-strong", children: formatToPlainStringResult };
    items1[1] = closure_9(tmp7(4602).Text, obj6);
    ...
    if (tmp16Result) {
      ...
      tmp16Result = closure_9(tmp4(10838), obj7);
    }
    ...
    obj12.children = closure_9(tmp7(4602).Text, obj14);
    ...
    obj15.icon = closure_9(tmp7(11125).GiftIcon, obj16);
    ...
    items5[1] = closure_9(tmp7(5026).Button, obj15);
    ...
    const items6 = [closure_9(tmp7(4602).Text, obj19), ];
    if (tmp11Result) {
    ...
    if (tmp11Result) {
      ...
      const obj22 = {
        ...
        children: tiers.map((key) => {
              ...
              const items1 = [tmp6, ];
              obj = { style: badgeItem.badgeCopy, children: null };
              let str = key.name;
              if (str == null) {
                str = "";
              }
      ...
      const items7 = [closure_9(closure_6, obj22), ];
      ...
      items7[1] = closure_9(tmp7(4602).Text, obj23);
