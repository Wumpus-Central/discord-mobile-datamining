...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  const isGiftingBadgeComplexArtEnabled = analyticsLocation(10896).useIsGiftingBadgeComplexArtEnabled(
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(10896).getGiftingBadgeProgressPercent(
      badgeProgress,
      currentTier,
      nextTier,
    );
    ...
    if (tmp15Result) {
      ...
      tmp15Result = closure_9(tmp4(10901), obj11);
    }
    ...
    if (tmp11Result) {
      ...
      items7[1] = closure_9(tmp7(4636).Text, obj27);
