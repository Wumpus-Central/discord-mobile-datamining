...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  const stateFromStoresObject = obj.useStateFromStoresObject(items, () => {
    ...
    obj = {
      badgeProgress: num,
      currentTier: obj.getCurrentTier(analyticsLocation(_undefined[10]).BadgeId.GIFTING),
      nextTier: obj.getNextTier(analyticsLocation(_undefined[10]).BadgeId.GIFTING),
      giftsRemaining: obj.getRemainingToNextTier(analyticsLocation(_undefined[10]).BadgeId.GIFTING),
      tiers: null,
    };
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(13624).getGiftingBadgeProgressPercent(
      badgeProgress,
      currentTier,
      nextTier,
    );
