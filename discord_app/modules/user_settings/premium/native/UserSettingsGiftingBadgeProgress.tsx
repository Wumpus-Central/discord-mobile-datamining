...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  if (0 === badgeProgress) {
    ...
    if (tmp14) {
      ...
      obj5[2] = { margin: 4 };
      tmp14 = callback2(tmp(10087), obj5);
    }
    let items1 = [tmp14, , ];
    ...
    items1[1] = callback2(tmp7(4340).Text, obj6);
    ...
    if (tmp16Result) {
      ...
      obj7[2] = { margin: 4 };
      tmp16Result = tmp16(tmp(10087), obj7);
    }
    ...
    obj12[1] = callback2(tmp7(4340).Text, obj14);
    ...
    obj15[1] = callback2(tmp7(9620).GiftIcon, obj16);
    ...
    items5[1] = callback2(tmp7(4754).Button, obj15);
    ...
    const items6 = [callback2(tmp7(4340).Text, obj19), ];
    if (tmp11Result) {
    ...
    if (tmp11Result) {
      ...
      items7[1] = tmp16(tmp7(4340).Text, obj23);
      obj21[0] = items7;
