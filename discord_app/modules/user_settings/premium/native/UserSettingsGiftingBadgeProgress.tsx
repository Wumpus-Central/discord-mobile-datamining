...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(12721).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
    if (null != nextTier) {
    ...
    if (tmp16Result) {
      ...
      obj7[2] = { margin: 4 };
      tmp16Result = tmp16(tmp(9927), obj7);
    }
    ...
    obj15[1] = callback2(tmp7(9464).GiftIcon, obj16);
    ...
    items5[1] = callback2(tmp7(4665).Button, obj15);
