// === Module 13835: UserSettingsGiftingBadgeProgress ===
...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  const isGiftingBadgeComplexArtEnabled = analyticsLocation(11004).useIsGiftingBadgeComplexArtEnabled(UserSettingsGiftingBadgeProgress);
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(11004).getGiftingBadgeProgressPercent(badgeProgress, currentTier, nextTier);
