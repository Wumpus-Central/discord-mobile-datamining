...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  const isGiftingBadgeComplexArtEnabled = analyticsLocation(11086).useIsGiftingBadgeComplexArtEnabled(
  ...
  if (0 === badgeProgress) {
    ...
    const giftingBadgeProgressPercent = tmp7(11086).getGiftingBadgeProgressPercent(
      badgeProgress,
      currentTier,
      nextTier,
    );
    ...
    if (tmp15Result) {
      ...
      tmp15Result = closure_9(tmp4(11091), obj11);
    }
    ...
    if (tmp11Result) {
      ...
      items7[1] = closure_9(tmp7(4823).Text, obj27);
