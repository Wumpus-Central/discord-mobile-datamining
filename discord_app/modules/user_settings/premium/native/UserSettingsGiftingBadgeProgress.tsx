...
export default function UserSettingsGiftingBadgeProgress(analyticsLocation) {
  ...
  if (0 === badgeProgress) {
    ...
    if (tmp16Result) {
      ...
      tmp16Result = closure_9(tmp4(10877), obj7);
    }
    ...
    obj12.children = closure_9(tmp7(4632).Text, obj14);
    ...
    obj15.icon = closure_9(tmp7(11164).GiftIcon, obj16);
    ...
    items5[1] = closure_9(tmp7(5056).Button, obj15);
    ...
    const items6 = [closure_9(tmp7(4632).Text, obj19), ];
    if (tmp11Result) {
    ...
    if (tmp11Result) {
      ...
      items7[1] = closure_9(tmp7(4632).Text, obj23);
