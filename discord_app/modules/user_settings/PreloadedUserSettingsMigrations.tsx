...
let items = [
  ...
  },
  {
    ...
    run(userContent) {
      ...
      if (!hasHiddenHotspotResult) {
        const HotspotStore = tmp(5729).HotspotStore;
        hasHiddenHotspotResult = HotspotStore.hasHiddenHotspot(tmp(5729).HotspotLocations.HUB_SECOND_EMAIL_CONNECTION_UPSELL);
      }
      let flag = false;
      if (hasHiddenHotspotResult) {
