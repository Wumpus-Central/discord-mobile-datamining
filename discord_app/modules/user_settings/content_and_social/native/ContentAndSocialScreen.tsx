...
import TinyBroncoSettingsNoticesLazy from "TinyBroncoSettingsNoticesLazy" /* 14940 */;
import SafetyGuildSettingGuildSelect from "SafetyGuildSettingGuildSelect" /* 16016 */;
...
export const DiscordPermissionsPage = function DiscordPermissionsPage() {
  ...
  const memo = noop.useMemo(() => {
    ...
    if (!allServersOptionSelected) {
      const items11 = [];
      HermesBuiltin.arraySpread(SafetyGuildSettingGuildSelect.GUILD_SPECIFIC_SETTINGS, HermesBuiltin.arraySpread(items6, 0));
      tmp9 = items11;
    ...
    obj18.helpArticle = HelpdeskUtilsDefault.getArticleURL(HelpdeskArticles.STEALTH_REMEDIATION_FEATURE_GUIDE);
