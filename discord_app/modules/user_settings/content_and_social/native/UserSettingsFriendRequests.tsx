...
export default function UserSettingsFriendRequests() {
  ...
  const items1 = [closure_7(setting(7214).TableSwitchRow, obj), , ];
  ...
  items1[1] = closure_7(setting(7214).TableSwitchRow, obj1);
  ...
  items1[2] = closure_7(setting(7214).TableSwitchRow, obj2);
  obj.children = items1;
  obj.children = closure_8(setting(5701).TableRowGroup, obj);
