...
export default function AgeConfirmationNotice() {
  ...
  const effect = noop.useEffect(() => {
    const result = sensitiveContentFilterHelpArticle(14963).trackSafetySettingsNoticeAnalytics(
  ...
  const callback = noop.useCallback(() => {
    ...
    const result1 = sensitiveContentFilterHelpArticle(14963).trackSafetySettingsNoticeAnalytics(
      constants2.AGE_CONFIRMATION_NOTICE,
  ...
  obj4.button = jsx(sensitiveContentFilterHelpArticle(5186).Button, {
    variant: "secondary",
    size: "sm",
    text: null,
    onPress: null,
