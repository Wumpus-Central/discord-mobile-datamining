...
export default function AgeConfirmationNotice() {
  let obj = sensitiveContentFilterHelpArticle(7315);
  ...
  const callback = noop.useCallback(() => {
    onPress(8439);
    const obj = { entryPoint: sensitiveContentFilterHelpArticle(8441).AgeVerificationModalEntryPoint.CONTENT_AND_SOCIAL_NOTICE };
  ...
  obj1.button = jsx(sensitiveContentFilterHelpArticle(4989).Button, { variant: "secondary", size: "sm", text: null, onPress: null });
