...
export default function AgeConfirmationNotice() {
  ...
  const effect = noop.useEffect(() => {
    const result = sensitiveContentFilterHelpArticle(14775).trackSafetySettingsNoticeAnalytics(
  ...
  const callback = noop.useCallback(() => {
    ...
    const result = obj.showAgeVerificationGetStartedModal({
      entryPoint: sensitiveContentFilterHelpArticle(8531).AgeVerificationModalEntryPoint.CONTENT_AND_SOCIAL_NOTICE,
    });
    const obj2 = {
      entryPoint: sensitiveContentFilterHelpArticle(8531).AgeVerificationModalEntryPoint.CONTENT_AND_SOCIAL_NOTICE,
    };
    const result1 = sensitiveContentFilterHelpArticle(14775).trackSafetySettingsNoticeAnalytics(
      constants2.AGE_CONFIRMATION_NOTICE,
  ...
  obj2.style = obj3;
  const obj4 = {
    messageType: sensitiveContentFilterHelpArticle(1176).HelpMessageTypes.INFO,
  ...
  obj4.button = jsx(sensitiveContentFilterHelpArticle(5056).Button, {
    variant: "secondary",
    size: "sm",
    text: null,
    onPress: null,
  ...
  obj2.children = jsx(sensitiveContentFilterHelpArticle(1176).HelpMessage, {
    messageType: sensitiveContentFilterHelpArticle(1176).HelpMessageTypes.INFO,
    borderRadius: nativeDefault.radii.lg,
    button: null,
    children: null,
