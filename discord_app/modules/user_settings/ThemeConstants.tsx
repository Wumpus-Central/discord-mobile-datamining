...
const obj2 = { [preloaded_user_settings.Theme.UNSET]: ThemeTypes.DARK, [preloaded_user_settings.Theme.DARK]: ThemeTypes.DARK, [preloaded_user_settings.Theme.DARKER]: ThemeTypes.DARK, [preloaded_user_settings.Theme.LIGHT]: ThemeTypes.LIGHT, [preloaded_user_settings.Theme.MIDNIGHT]: ThemeTypes.DARK };
const obj3 = { [preloaded_user_settings.Theme.UNSET]: ThemeTypes.DARKER, [preloaded_user_settings.Theme.DARK]: ThemeTypes.DARK, [preloaded_user_settings.Theme.DARKER]: ThemeTypes.DARKER, [preloaded_user_settings.Theme.LIGHT]: ThemeTypes.LIGHT, [preloaded_user_settings.Theme.MIDNIGHT]: ThemeTypes.MIDNIGHT };
const obj4 = { [preloaded_user_settings.Theme.UNSET]: ThemeTypes.DARKER, [preloaded_user_settings.Theme.DARK]: ThemeTypes.DARKER, [preloaded_user_settings.Theme.DARKER]: ThemeTypes.DARKER, [preloaded_user_settings.Theme.LIGHT]: ThemeTypes.LIGHT, [preloaded_user_settings.Theme.MIDNIGHT]: ThemeTypes.MIDNIGHT };
