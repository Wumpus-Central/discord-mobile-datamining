...
const obj2 = {
  [create.Theme.UNSET]: ThemeTypes.DARK,
  [create.Theme.DARK]: ThemeTypes.DARK,
  [create.Theme.DARKER]: ThemeTypes.DARK,
  [create.Theme.LIGHT]: ThemeTypes.LIGHT,
  [create.Theme.MIDNIGHT]: ThemeTypes.DARK,
};
const obj3 = {
  [create.Theme.UNSET]: ThemeTypes.DARKER,
  [create.Theme.DARK]: ThemeTypes.DARK,
  [create.Theme.DARKER]: ThemeTypes.DARKER,
  [create.Theme.LIGHT]: ThemeTypes.LIGHT,
  [create.Theme.MIDNIGHT]: ThemeTypes.MIDNIGHT,
};
const obj4 = {
  [create.Theme.UNSET]: ThemeTypes.DARKER,
  [create.Theme.DARK]: ThemeTypes.DARKER,
  [create.Theme.DARKER]: ThemeTypes.DARKER,
  [create.Theme.LIGHT]: ThemeTypes.LIGHT,
  [create.Theme.MIDNIGHT]: ThemeTypes.MIDNIGHT,
};
