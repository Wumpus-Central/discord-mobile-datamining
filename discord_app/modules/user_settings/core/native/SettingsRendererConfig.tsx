...
const frozen = Object.freeze({
  [PROFILE_CUSTOMIZATION]: routeDefault,
  [ACCOUNT]: routeDefault2,
  [ACCOUNT_USERNAME]: routeDefault3,
  [ACCOUNT_DISPLAY_NAME]: routeDefault4,
  [ACCOUNT_EMAIL]: pressableDefault,
  [ACCOUNT_PHONE]: pressableDefault2,
  [ACCOUNT_AGE_GROUP_ADULT]: _modDef14374,
  ...
  [VOICE_SENSITIVITY]: _modDef14846,
  [OUTPUT_VOLUME]: volumeSliderDefault,
  [STREAM_OUTPUT_VOLUME]: volumeSliderDefault2,
  [SOUNDBOARD_VOLUME]: volumeSliderDefault3,
  [ANDROID_MOBILE_OVERLAY]: toggleDefault14,
  [NOISE_SUPPRESSION_KRISP]: radioDefault3,
  [NOISE_SUPPRESSION]: toggleDefault15,
  [ECHO_CANCELLATION]: toggleDefault16,
  [SIDECHAIN_COMPRESSION]: toggleDefault17,
  ...
  [ANDROID_CLASSIC_CHAT_FONT_SCALE]: toggleDefault22,
  [DMS_MESSAGE_PREVIEWS]: radioDefault5,
  [DMS_HAPPENING_NOW_CARDS]: toggleDefault23,
  [EXACT_SEARCH_RESULT_COUNTS]: toggleDefault24,
  [GAME_MENTIONS_AUTOCOMPLETE]: toggleDefault25,
  [FAVORITES_GUILD_TOGGLE]: toggleDefault26,
  ...
  [SHOW_LINK_DECORATIONS]: useShowLinkDecorationsSettingValueDefault,
  [SHOW_ON_OFF_INDICATORS]: useEnableSwitchIconsSettingValueDefault,
  [CONTRAST_MODE]: sliderDefault2,
  [REDUCE_SATURATION]: sliderDefault3,
  [SYNC_PROFILE_COLORS]: toggleDefault29,
  [ENABLE_REDUCED_MOTION]: toggleDefault30,
  [SYNC_REDUCED_MOTION_WITH_DEVICE]: toggleDefault31,
  ...
  [VIDEO_UPLOAD_QUALITY]: radioDefault7,
  [DATA_SAVING_MODE]: toggleDefault36,
  [SAVE_CAMERA_UPLOADS_TO_DEVICE]: toggleDefault37,
  [EMBED_AND_LINK_PREVIEWS]: toggleDefault38,
  [EMOJI_REACTIONS_ON_MESSAGES]: toggleDefault39,
  [CHAT_EMOJI_EMOTICONS]: toggleDefault40,
  ...
  [CUSTOM_STATUS_NOTIFICATIONS]: onChangeDefault2,
  [IOS_NATIVE_PHONE_INTEGRATION]: toggleDefault44,
  [ANDROID_MESSAGE_NOTIFICATIONS]: useAndroidMessageNotificationsSettingValueDefault,
  [ANDROID_NOTIFICATION_LIGHTS]: toggleDefault45,
  [ANDROID_NOTIFICATION_VIBRATIONS]: toggleDefault46,
  [ANDROID_NOTIFICATION_SOUNDS]: toggleDefault47,
  [IN_APP_MESSAGE_SOUNDS]: toggleDefault48,
  [FRIEND_STREAM_NOTIFICATIONS]: toggleDefault49,
  [FRIEND_ANNIVERSARY_NOTIFICATIONS]: toggleDefault50,
  [VOICE_ACTIVITY_NOTIFICATIONS]: toggleDefault51,
  [FRIEND_ONLINE_NOTIFICATIONS]: toggleDefault52,
  [FRIEND_GAMING_ACTIVITY_NOTIFICATIONS]: toggleDefault53,
  [PROFILE_UPDATES_NOTIFICATIONS]: toggleDefault54,
  [SERVER_TRENDING_NOTIFICATIONS]: toggleDefault55,
  ...
  [APP_VERSION]: _modDef15155,
  [DEVICE_INFO]: _modDef15157,
  ...
  [INTERNAL_BUILD_ACTIVE]: _modDef15340,
  ...
  [PARENTAL_CONTROLS_DATA_USAGE_QUESTS]: toggleDefault78,
  [PARENTAL_CONTROLS_DATA_USAGE_QUESTS_3P]: toggleDefault79,
  [ACTIVITY_PRIVACY_SHARE_MY_ACTIVITY]: toggleDefault80,
  [ACTIVITY_PRIVACY_DEFAULT_SHARING]: radioDefault11,
  [FRIEND_REQUEST_NOTES]: toggleDefault81,
  [NOTIFY_FRIENDS_ON_COME_ONLINE]: toggleDefault82,
  [NOTIFY_FRIENDS_ON_PROFILE_UPDATE]: toggleDefault83,
});
const obj = {
  [PROFILE_CUSTOMIZATION]: routeDefault,
  [ACCOUNT]: routeDefault2,
