...
function UserListItem(userId) {
  ...
  if (tmp8Result) {
    obj = { user: null, guildId: "Array", size: "function pnpm_presetsTs1(event){return{transform:[{translateX:event.translationX}]};}" };
...
export default function SettingsSecureFramesScreen() {
  ...
  obj2[0] = getCurrentUserSigningKey.getSecureFramesHelpdeskArticle();
