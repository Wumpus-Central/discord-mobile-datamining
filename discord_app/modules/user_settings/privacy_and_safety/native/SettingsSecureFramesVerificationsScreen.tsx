...
function VerificationListItem(userId) {
  ...
  obj.start = start;
  obj.end = end;
  obj = { onPress: callback, children: jsx(userId(5730).XSmallIcon, {}) };
  obj.trailing = jsx(userId(5173).PressableHighlight, { onPress: callback, children: jsx(userId(5730).XSmallIcon, {}) });
  return jsx(userId(5655).TableRow, { onPress: callback, children: jsx(userId(5730).XSmallIcon, {}) });
}
...
function ClearVerificationsListFooter(userId) {
  ...
  return jsx(userId(5655).TableRow, { variant: "text-xs/medium", color: "text-subtle", children: null });
}
...
export default function SettingsSecureFramesVerificationsScreen() {
  ...
  obj.children = jsx(userId(8943).FlashList, { keyExtractor, getItemType, renderItem, data: memo, contentContainerStyle: tmp.listContent, ListFooterComponent: null });
