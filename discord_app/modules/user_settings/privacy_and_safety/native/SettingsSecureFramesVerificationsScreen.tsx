...
function VerificationListItem(userId) {
  ...
  obj.start = start;
  obj.end = end;
  obj = { onPress: callback, children: jsx(userId(5731).XSmallIcon, {}) };
  obj.trailing = jsx(userId(5174).PressableHighlight, { onPress: callback, children: jsx(userId(5731).XSmallIcon, {}) });
  return jsx(userId(5656).TableRow, { onPress: callback, children: jsx(userId(5731).XSmallIcon, {}) });
}
...
function ClearVerificationsListFooter(userId) {
  ...
  return jsx(userId(5656).TableRow, { variant: "text-xs/medium", color: "text-subtle", children: null });
}
...
export default function SettingsSecureFramesVerificationsScreen() {
  ...
  obj.children = jsx(userId(8964).FlashList, { keyExtractor, getItemType, renderItem, data: memo, contentContainerStyle: tmp.listContent, ListFooterComponent: null });
