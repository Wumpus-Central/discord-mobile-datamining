// === Module 15452: VerificationListItem ===
...
function VerificationListItem(userId) {
  ...
  obj[2] = start;
  obj[3] = end;
  obj = { onPress: callback, children: jsx(userId(5551).XSmallIcon, {}) };
  obj[4] = jsx(userId(5068).PressableHighlight, { onPress: callback, children: jsx(userId(5551).XSmallIcon, {}) });
  return jsx(userId(5599).TableRow, { onPress: callback, children: jsx(userId(5551).XSmallIcon, {}) });
}
...
function ClearVerificationsListFooter(userId) {
  ...
  obj[0] = jsx(userId(4474).Text, { variant: "text-md/semibold", color: "text-feedback-critical", children: null });
...
export default function SettingsSecureFramesVerificationsScreen() {
  ...
  dependencyMap = navigation(4322).getFormattedName(stateFromStores, false);
  ...
  secureFramesUserVerifiedKeys = userId(15449).useSecureFramesUserVerifiedKeys(userId);
