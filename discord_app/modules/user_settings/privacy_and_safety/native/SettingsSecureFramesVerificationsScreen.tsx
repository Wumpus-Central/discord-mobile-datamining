...
function VerificationListItem(userId) {
  ...
  obj.start = start;
  obj.end = end;
  obj = { onPress: callback, children: jsx(userId(5694).XSmallIcon, {}) };
  obj.trailing = jsx(userId(5137).PressableHighlight, { onPress: callback, children: jsx(userId(5694).XSmallIcon, {}) });
  return jsx(userId(5619).TableRow, { onPress: callback, children: jsx(userId(5694).XSmallIcon, {}) });
}
...
function ClearVerificationsListFooter(userId) {
  ...
  return jsx(userId(5619).TableRow, { variant: "text-xs/medium", color: "text-subtle", children: null });
}
...
export default function SettingsSecureFramesVerificationsScreen() {
  ...
  obj.children = jsx(userId(8906).FlashList, { keyExtractor, getItemType, renderItem, data: memo, contentContainerStyle: tmp.listContent, ListFooterComponent: null });
