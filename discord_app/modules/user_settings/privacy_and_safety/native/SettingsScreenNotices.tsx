...
let items = [
  { order: 100, predicate: fn(7702).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault },
  ,
  ,
];
...
items[1] = {
  order: 150,
  predicate: fn(14932).shouldShowTinyBroncoUnconfirmedNotice,
  Component: fn(14932).ContentFiltersUnconfirmedNotice,
};
const obj7 = {
  order: 150,
  predicate: fn(14932).shouldShowTinyBroncoUnconfirmedNotice,
