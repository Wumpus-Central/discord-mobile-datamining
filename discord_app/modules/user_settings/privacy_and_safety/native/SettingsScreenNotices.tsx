...
let items = [
  { order: 100, predicate: fn(7699).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault },
  ,
  ,
];
...
items[1] = {
  order: 150,
  predicate: fn(14916).shouldShowTinyBroncoUnconfirmedNotice,
  Component: fn(14916).ContentFiltersUnconfirmedNotice,
};
const obj7 = {
  order: 150,
  predicate: fn(14916).shouldShowTinyBroncoUnconfirmedNotice,
