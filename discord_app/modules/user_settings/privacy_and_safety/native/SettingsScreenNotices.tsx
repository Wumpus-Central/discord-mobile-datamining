...
let items = [
  { order: 100, predicate: fn(7007).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault },
  ,
  ,
];
...
items[1] = {
  order: 150,
  predicate: fn(14327).shouldShowTinyBroncoUnconfirmedNotice,
  Component: fn(14327).ContentFiltersUnconfirmedNotice,
};
const obj7 = {
  order: 150,
  predicate: fn(14327).shouldShowTinyBroncoUnconfirmedNotice,
