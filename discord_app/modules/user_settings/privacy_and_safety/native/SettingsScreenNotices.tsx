...
let items = [
  { order: 100, predicate: fn(7695).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault },
  ,
  ,
];
const obj3 = { order: 100, predicate: fn(7695).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault };
items[1] = {
  order: 150,
  predicate: fn(14905).shouldShowTinyBroncoUnconfirmedNotice,
  Component: fn(14905).ContentFiltersUnconfirmedNotice,
};
const obj4 = {
  order: 150,
  predicate: fn(14905).shouldShowTinyBroncoUnconfirmedNotice,
...
const obj7 = { order: 100, predicate: fn(7695).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault };
items1[1] = {
  order: 200,
  predicate() {
    let isFeatureAgeGatedResult = RegionalFeatureConfigUtils.isFeatureAgeGated(
