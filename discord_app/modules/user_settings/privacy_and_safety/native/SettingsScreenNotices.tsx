...
let items = [
  { order: 100, predicate: fn(7706).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault },
  ,
  ,
];
...
items[1] = {
  order: 150,
  predicate: fn(14940).shouldShowTinyBroncoUnconfirmedNotice,
  Component: fn(14940).ContentFiltersUnconfirmedNotice,
};
const obj7 = {
  order: 150,
  predicate: fn(14940).shouldShowTinyBroncoUnconfirmedNotice,
