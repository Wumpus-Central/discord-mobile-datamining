...
let items = [
  { order: 100, predicate: fn(7788).isParentallyControlled, Component: FamilyCenterSettingsNoticeDefault },
  ,
  ,
];
...
items[1] = {
  order: 150,
  predicate: fn(15034).shouldShowTinyBroncoUnconfirmedNotice,
  Component: fn(15034).ContentFiltersUnconfirmedNotice,
};
const obj7 = {
  order: 150,
  predicate: fn(15034).shouldShowTinyBroncoUnconfirmedNotice,
