...
import QuestCardPreview from "QuestCardPreview" /* 15172 */;
import QuestEmbedPreview from "QuestEmbedPreview" /* 15174 */;
...
export default function SettingsQuestPreviewScreen() {
  ...
  const segmentedControlState = params(questId[13]).useSegmentedControlState({ items: memo, pageWidth: tmp18, defaultIndex: 0, onPageChange: tmp5Result[1] });
