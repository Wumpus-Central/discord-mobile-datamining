...
export const QuestCardPreview = function QuestCardPreview(quest) {
  quest = quest.quest;
  return jsx(quest(11408).QuestContentImpressionTrackerNative, {
    questOrQuests: quest,
    questContent: quest(5337).QuestContent.INTERNAL_PREVIEW_TOOL,
    sourceQuestContent: quest(5337).QuestContent.INTERNAL_PREVIEW_TOOL,
