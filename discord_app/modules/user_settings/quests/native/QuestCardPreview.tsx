...
export const QuestCardPreview = function QuestCardPreview(quest) {
  quest = quest.quest;
  return jsx(quest(11568).QuestContentImpressionTrackerNative, {
    questOrQuests: quest,
    questContent: quest(5398).QuestContent.INTERNAL_PREVIEW_TOOL,
    sourceQuestContent: quest(5398).QuestContent.INTERNAL_PREVIEW_TOOL,
