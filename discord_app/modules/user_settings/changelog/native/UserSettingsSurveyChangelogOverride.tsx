...
import closure_7 from "handleUserSettingsProtoStoreChange" /* 4771 */;
import closure_8 from "fetchSurveyIfNeeded" /* 9874 */;
...
function SurveyInfo() {
  ...
  const items1 = [callback2(_TableRowInner.TableRow, obj), ];
  let str;
  if (null == tmp2) {
    str = "No survey data";
  }
  ...
  obj[3] = fn;
  items1[1] = callback2(_TableRowInner.TableRow, obj);
  obj1[2] = items1;
  return closure_10(_TableRowGroupTitle.TableRowGroup, obj1);
}
