...
import ConnectionsTracking from "ConnectionsTracking.tsx";
...
function EmptyStateCard(platform) {
  ...
  const obj1 = {
    style: items2,
    children: closure_6(platform(connectionBackgroundColor[13]).Icon, {
      style: tmp.icon,
      source: memo,
      resizeMode: "contain",
      disableColor: true,
...
export default function ConnectionsEmptyStateUpsell() {
  const tmp = closure_8();
  let obj = emptyStatePlatforms(7517);
  ...
  const items3 = [
    closure_6(emptyStatePlatforms(4987).Stack, {
      spacing: 16,
      justify: "center",
      direction: "horizontal",
      children: memo.map((platform) => closure_1_6(EmptyStateCard, { platform }, platform.type)),
    }),
  ];
  const obj4 = { spacing: 16, justify: "center", direction: "horizontal", children: null };
  const items4 = [
    memo1.map((platform) => closure_1_6(EmptyStateCard, { platform }, platform.type)),
    closure_6(OtherConnectionsCard, { count: emptyStatePlatforms.length - 5 }),
  ];
  obj4.children = items4;
  items3[1] = closure_7(emptyStatePlatforms(4987).Stack, obj4);
  obj2.children = items3;
  const items5 = [closure_7(emptyStatePlatforms(4987).Stack, obj2)];
  ...
  const items6 = [closure_6(emptyStatePlatforms(4570).Text, obj7)];
  ...
  items6[1] = closure_6(emptyStatePlatforms(4570).Text, obj8);
  obj6.children = items6;
  items5[1] = closure_7(emptyStatePlatforms(4987).Stack, obj6);
