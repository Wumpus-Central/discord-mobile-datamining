...
import _modDef3132 from "../../../application_account_linking/ApplicationAccountLinking.messages.js";
...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    const obj7 = {
      ...
      size: tmp(5887).GuildIconSizes.SMALL,
    ...
    items5[1] = closure_14(tmp(4823).Text, obj10);
    ...
    obj13 = closure_14(tmp(5271).Button, obj13);
...
prototype["render"] = function render() {
  ...
  if (migrationExperimentEnabled) {
    ...
    let name = intl.format(_modDef3132.Glhokn, obj2);
  } else {
    name = account.name;
  }
  const obj3 = {
