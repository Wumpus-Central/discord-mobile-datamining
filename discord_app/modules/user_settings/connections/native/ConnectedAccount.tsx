...
import _modDef3098 from "../../../application_account_linking/ApplicationAccountLinking.messages.js";
...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    const obj7 = {
      ...
      size: tmp(5803).GuildIconSizes.SMALL,
    ...
    items5[1] = closure_14(tmp(4753).Text, obj10);
    ...
    obj13 = closure_14(tmp(5187).Button, obj13);
