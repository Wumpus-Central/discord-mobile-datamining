...
function Integration(integration) {
  ...
  if (!tmp7) {
    ...
    if (tmp12) {
      ...
      tmp12 = closure_14(tmp(4570).Text, obj);
    }
    ...
    obj2 = { guild: integration.guild, size: tmp(5598).GuildIconSizes.SMALL, style: legacyClassComponentStyles.integrationGuildIcon };
    ...
    const items5 = [closure_14(tmp(4570).Text, obj4), ];
    ...
    items5[1] = closure_14(tmp(4570).Text, obj5);
    ...
    obj7 = closure_14(tmp(4989).Button, obj7);
    obj6.children = obj7;
...
prototype["renderMetadata"] = function renderMetadata() {
  ...
  if (0 === redditMetadataItems.length) {
    ...
    if (true !== hasMetadata) {
      ...
      items1[1] = closure_14(tmp2(4570).Text, obj3);
    ...
    const items3 = [closure_14(View, obj12), closure_14(tmp2(5137).PressableOpacity, obj9)];
...
prototype["render"] = function render() {
  ...
  obj3 = { style: tmp.deleteConnectionIcon, source: _modDef7006 };
