...
export default function ConnectedApplicationIdentity(identity) {
  ...
  const legacyClassComponentStyles = require("createStyles").useLegacyClassComponentStyles(
    require("ConnectedAccount").readStyles,
  );
  ...
  _require = str((connection_visible) => {
    ...
    return (function* (arg0) {
      ...
      yield token(application[16]).updateApplicationIdentityConfig(
