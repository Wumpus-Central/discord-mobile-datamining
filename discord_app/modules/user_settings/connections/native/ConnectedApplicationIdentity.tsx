// === Module 14962: ConnectedApplicationIdentity ===
...
export default function ConnectedApplicationIdentity(identity) {
  ...
  _require = str((connection_visible) => {
    ...
    return (function*(arg0) {
      ...
      yield obj1.updateApplicationIdentityConfig(connection_visible.application_id, connection_visible.provider_issued_user_id, obj1);
      if (1 === tmp7) {
        c3 = 0;
  ...
  if (null == application) {
    ...
    obj = { accessible: true, accessibilityLabel: application.name, style: null, size: null, source: null, disableColor: true };
    const items3 = [, ];
