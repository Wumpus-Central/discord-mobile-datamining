...
export const TwoWayLinkError = function TwoWayLinkError(arg0) {
  ...
  const tmp = callback3();
  const items = [callback(closure_3, { source: importDefault(10470), style: callback3().image }), callback(require(4281) /* Text */.Text, { variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", style: twoWayLinkStyles.title, children: title }), callback(require(4281) /* Text */.Text, { variant: "text-md/normal", color: "text-default", style: twoWayLinkStyles.body, children: body })];
  obj[1] = items;
  ...
  items1[1] = callback(require(5272) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj4);
  obj[1] = items1;
