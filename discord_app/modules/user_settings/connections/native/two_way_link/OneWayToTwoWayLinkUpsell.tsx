...
fn(4636);
let createStyles = { container: null, header: null, titleContainer: null, title: null, body: null, newContainer: null, reconnectButton: null };
createStyles = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_NORMAL, margin: 16, padding: 12, borderRadius: nativeDefault.radii.sm };
...
export const OneWayToTwoWayLinkUpsell = function OneWayToTwoWayLinkUpsell(newIndicatorDismissibleContent) {
  ...
  const items1 = [closure_6(SelectedDismissibleContentDefault, obj1), closure_6(newIndicatorDismissibleContent(4632).Text, { style: tmp.title, variant: "text-md/semibold", children: title })];
  obj.children = items1;
  const items2 = [closure_7(View, obj), img];
  obj.children = items2;
  const items3 = [closure_7(View, obj), closure_6(newIndicatorDismissibleContent(4632).Text, { style: tmp.body, variant: "text-sm/medium", children: body }), ];
  ...
  obj4.children = closure_6(newIndicatorDismissibleContent(5056).Button, obj5);
