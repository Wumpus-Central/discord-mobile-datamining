...
export const OneWayToTwoWayLinkUpsell = function OneWayToTwoWayLinkUpsell(newIndicatorDismissibleContent) {
  ...
  const items1 = [closure_6(SelectedDismissibleContentDefault, obj1), closure_6(newIndicatorDismissibleContent(4602).Text, { style: tmp.title, variant: "text-md/semibold", children: title })];
  obj.children = items1;
  const items2 = [closure_7(View, obj), img];
  obj.children = items2;
  const items3 = [closure_7(View, obj), closure_6(newIndicatorDismissibleContent(4602).Text, { style: tmp.body, variant: "text-sm/medium", children: body }), ];
