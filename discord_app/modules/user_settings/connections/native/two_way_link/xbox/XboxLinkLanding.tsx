...
import _modDef9314 from "../../../../../../../discord_assets/assets/connections/xbox_link_landing.png.js";
...
export default function XboxLinkLanding() {
  ...
  obj.onNext = callback;
  obj.valueProps = memo;
  return jsx(navigation(9315).TwoWayLinkLanding, {
    platformType: constants2.XBOX,
    img: memo1,
    imgStyle: tmp.image,
    headerConnect: null,
