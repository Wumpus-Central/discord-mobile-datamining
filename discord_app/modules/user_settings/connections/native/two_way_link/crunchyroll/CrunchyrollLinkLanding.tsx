...
export default function CrunchyrollLinkLanding() {
  ...
  obj = { platformType: constants2.CRUNCHYROLL, img: _modDef9306, imgStyle: closure_8().image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null };
  ...
  obj.onNext = callback;
  obj.valueProps = memo;
  return jsx(navigation(9257).TwoWayLinkLanding, { platformType: constants2.CRUNCHYROLL, img: _modDef9306, imgStyle: closure_8().image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null });
};