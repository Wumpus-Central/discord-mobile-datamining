...
export default function CrunchyrollLinkLanding() {
  ...
  obj = { platformType: constants2.CRUNCHYROLL, img: _modDef9343, imgStyle: closure_8().image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null };
  ...
  obj.onNext = callback;
  obj.valueProps = memo;
  return jsx(navigation(9294).TwoWayLinkLanding, { platformType: constants2.CRUNCHYROLL, img: _modDef9343, imgStyle: closure_8().image, headerConnect: null, body: null, learnMoreLink: null, onNext: null, valueProps: null });
};