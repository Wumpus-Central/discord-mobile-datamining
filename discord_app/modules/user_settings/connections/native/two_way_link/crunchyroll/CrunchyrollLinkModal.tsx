...
export default function CrunchyrollLinkModal(locationStack) {
  ...
  const memo = React.useMemo(() => {
    function onClose() {
      return callback(9260).hideModal();
    }
    function blank() {
      return null;
    }
    let obj = {
      ...
      render() {
        return callback2(callback(9263), {});
      }
    };
    obj = {
      headerLeft: blank,
      ...
      render() {
        return callback2(callback(9265), {});
      }
    };
    obj = {
      headerLeft: blank,
      ...
      render(arg0) {
        ...
        return callback2(callback(9267), { callbackCode, callbackState });
      }
    };
    return {
  ...
  const accountLinkStepTracking = twoWayLinkStyles(9248).useAccountLinkStepTracking(PlatformTypes.CRUNCHYROLL, locationStack.locationStack);
  ...
  return jsx(twoWayLinkStyles(5960).Navigator, { onStateChange: accountLinkStepTracking, screens: memo, initialRouteName: constants.LANDING, headerBackTitle: null });
};