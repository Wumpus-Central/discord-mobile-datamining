...
export default function UserSettingsDesignSystemText() {
  ...
  obj.children = jsx(Stack_Stack.Stack, { spacing: nativeDefault.space.PX_24, style: { paddingHorizontal: token }, children: null });
  return <ScrollView spacing={nativeDefault.space.PX_24} style={{ paddingHorizontal: token }}>{null}</ScrollView>;
};