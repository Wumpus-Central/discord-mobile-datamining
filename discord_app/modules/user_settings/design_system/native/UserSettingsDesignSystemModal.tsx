...
function DemoModal() {
  const navigatorScreens = Navigator.useNavigatorScreens(() => {
    ...
    const obj2 = {
      ...
      headerTitle() {
        return closure_1_7(closure_1_0(5936).NavigatorHeader, {
      ...
      render(arg0, arg1) {
        ...
        return closure_7(closure_13, {
          ...
          onSecondaryAction: closure_1(5039).pop,
...
function SwitchesScreen(onAction) {
  ...
  obj.footer = closure_7(parts(10458).ModalFloatingAction, {
