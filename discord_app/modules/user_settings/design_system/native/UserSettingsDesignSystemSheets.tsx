...
import _modDef5828 from "../../../../../discord_assets/assets/mana/asset-library/generated/BugSpotIllustration-2x.png.js";
...
function DemoActionSheet() {
  ...
  if (first) {
    ...
    tmp14Result = React5(tmp15(9750).ActionSheetHeaderPressableText, obj);
  }
  obj.leading = tmp14Result;
  tmp14Result = tmp2;
  if (tmp2) {
    obj = { onPress: NOOP };
    tmp14Result = React5(tmp15(7212).ActionSheetCloseButton, obj);
  }
