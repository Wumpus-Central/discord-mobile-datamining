...
export default function UserSettingsDesignSystemExperimentalButtons() {
  ...
  obj3[1] = callback(TwinButtons /* TwinButtons */.HeaderButton, obj5);
  obj2[3] = callback(closure_3, obj3);
  const items = [callback(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj2), , , , , , ];
  ...
  const items1 = [callback(TwinButtons /* TwinButtons */.InputButton, obj8), ];
  const obj9 = {
    onPress() {
  ...
  items1[1] = callback(TwinButtons /* TwinButtons */.InputButton, obj9);
  obj7[1] = items1;
  obj6[3] = callback2(Stack /* Stack */.Stack, obj7);
  items[1] = callback(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj6);
  ...
  obj11[0] = items2;
  obj10[3] = callback2(TwinButtons /* TwinButtons */.TwinButtons, obj11);
  items[2] = callback(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj10);
  ...
  obj17[1] = callback(Text /* Text */.Text, { variant: "text-md/semibold", children: "This is a custom button" });
  obj16[1] = callback(closure_3, obj17);
  obj15[1] = callback(TwinButtons /* TwinButtons */.PressableScale, obj16);
  obj14[3] = callback(closure_3, obj15);
  items[3] = callback(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj14);
  ...
  items[4] = callback(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj18);
  ...
  obj20[4] = callback(RowButtonWrapper /* RowButtonWrapper */.RowButton, obj21);
  obj19[1] = callback(LinearGradient, obj20);
  items[5] = callback(ManaContext /* ManaContext */.ThemeContextProvider, obj19);
  ...
  items[6] = callback(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj22);
  obj1[2] = items;
  obj[1] = callback2(Stack /* Stack */.Stack, obj1);
  ...
  items3[1] = callback(TwinButtons /* TwinButtons */.CollapsibleFloatingActionButton, obj23);
  obj[0] = items3;
