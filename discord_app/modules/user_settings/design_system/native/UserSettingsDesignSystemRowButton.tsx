...
export default function UserSettingsDesignSystemRowButton() {
  ...
  obj[0] = obj1;
  const items = [callback(Text /* Text */.Text, { variant: "text-sm/normal", children: "Row Button Row Buttons are full-width, high-emphasis buttons that are used as primary CTAs in a page." }), callback(Text /* Text */.Text, { variant: "text-sm/normal", children: "Only stack up to 2 Row Buttons in a row to to prevent decision fatigue." })];
  obj[1] = items;
  obj[1] = callback2(Stack /* Stack */.Stack, obj);
  obj[2] = callback(closure_3, {});
  const items1 = [callback(Form /* Form */.FormSection, obj), ];
  ...
  const items2 = [callback(RowButtonWrapper /* RowButtonWrapper */.RowButton, obj4), , , , , , ];
  ...
  items2[1] = callback(RowButtonWrapper /* RowButtonWrapper */.RowButton, obj5);
  const obj6 = { variant: "secondary", icon: null, label: "Secondary Row Button", onPress: null };
  obj6[1] = registerAsset;
  obj6[3] = function onPress() {

  };
  items2[2] = callback(RowButtonWrapper /* RowButtonWrapper */.RowButton, obj6);
  ...
  items2[3] = callback(RowButtonWrapper /* RowButtonWrapper */.RowButton, obj7);
  ...
  items2[4] = callback(RowButtonWrapper /* RowButtonWrapper */.RowButton, obj8);
  ...
  obj9[0] = callback(RowButtonWrapper /* RowButtonWrapper */.RowButton.Icon, obj10);
  obj9[3] = function onPress() {

  };
  items2[5] = callback(RowButtonWrapper /* RowButtonWrapper */.RowButton, obj9);
  ...
  items2[6] = callback(RowButtonWrapper /* RowButtonWrapper */.RowButton, obj11);
  obj3[0] = items2;
  obj2[1] = callback2(Stack /* Stack */.Stack, obj3);
