...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  fn.__closure = {
    withSpring: showBackdrop(5280).withSpring,
    showBackdrop,
    SUBTLE_SPRING: showBackdrop(5284).SUBTLE_SPRING,
  };
  ...
  if (showBackdrop) {
    ...
    const items2 = [closure_6(tmp8(5267).Backdrop, obj6)];
    ...
    obj8.children = closure_7(tmp8(4832).Text, obj9);
    obj7.children = closure_6(tmp8(5919).Card, obj8);
    items2[1] = closure_6(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = closure_7(tmp8(5262).Dialog, obj5);
  }
