...
export default function UserSettingsDesignSystemBackdrop() {
  ...
  fn.__closure = {
    withSpring: showBackdrop(5059).withSpring,
    showBackdrop,
    SUBTLE_SPRING: showBackdrop(5063).SUBTLE_SPRING,
  };
  ...
  if (showBackdrop) {
    ...
    const items2 = [closure_6(tmp8(5046).Backdrop, obj6)];
    ...
    obj8.children = closure_7(tmp8(4634).Text, obj9);
    obj7.children = closure_6(tmp8(5693).Card, obj8);
    items2[1] = closure_6(closure_5, obj7);
    obj5.children = items2;
    showBackdrop = closure_7(tmp8(5041).Dialog, obj5);
  }
