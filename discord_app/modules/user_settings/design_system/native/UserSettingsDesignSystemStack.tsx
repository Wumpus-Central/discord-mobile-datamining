...
export default function UserSettingsDesignSystemStack() {
  ...
  const items = [callback(Text /* Text */.Text, { variant: "text-lg/bold", children: "Basic Example" }), callback(Text /* Text */.Text, { variant: "text-md/medium", color: "text-subtle", children: "By default, stacks are vertical and have a spacing of 8." }), ];
  const obj3 = { children: null };
  const items1 = [callback(StackBlock, {}), callback(StackBlock, {})];
  obj3[0] = items1;
  items[2] = callback2(Stack /* Stack */.Stack, obj3);
  obj2[0] = items;
  obj1[0] = callback2(Stack /* Stack */.Stack, obj2);
  const items2 = [callback(PressableCard /* PressableCard */.Card, obj1), , ];
  const obj4 = { children: null };
  const obj5 = { children: null };
  const items3 = [callback(Text /* Text */.Text, { variant: "text-lg/bold", children: "Spacing" }), callback(Text /* Text */.Text, { variant: "text-md/medium", color: "text-subtle", children: "You can control the spacing with the spacing prop. The spacing prop uses our 4px-based spacing scale. By default, stacks are vertical and have a spacing of 8." }), ];
  const obj6 = { spacing: 24, children: null };
  const items4 = [callback(StackBlock, {}), callback(StackBlock, {})];
  obj6[1] = items4;
  items3[2] = callback2(Stack /* Stack */.Stack, obj6);
  obj5[0] = items3;
  obj4[0] = callback2(Stack /* Stack */.Stack, obj5);
  items2[1] = callback(PressableCard /* PressableCard */.Card, obj4);
  const obj7 = { children: null };
  const obj8 = { children: null };
  const items5 = [callback(Text /* Text */.Text, { variant: "text-lg/bold", children: "Horizontal" }), callback(Text /* Text */.Text, { variant: "text-md/medium", color: "text-subtle", children: "You can control the direction with the direction prop. The direction prop can be either horizontal or vertical." }), ];
  const obj9 = { direction: "horizontal", children: null };
  const items6 = [callback(StackBlock, {}), callback(StackBlock, {})];
  obj9[1] = items6;
  items5[2] = callback2(Stack /* Stack */.Stack, obj9);
  obj8[0] = items5;
  obj7[0] = callback2(Stack /* Stack */.Stack, obj8);
  items2[2] = callback(PressableCard /* PressableCard */.Card, obj7);
  obj[1] = items2;
