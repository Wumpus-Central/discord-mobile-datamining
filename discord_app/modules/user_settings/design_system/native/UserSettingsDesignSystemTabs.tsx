// === Module 14919: UserSettingsDesignSystemTabs ===
...
const result = require("obj132").fileFinishedImporting("modules/user_settings/design_system/native/UserSettingsDesignSystemTabs.tsx");
...
export default function UserSettingsDesignSystemTabs() {
  ...
  if (first2) {
    ...
    obj[1] = items1;
    tmp20Result = callback2(first(11938), obj);
  }
  obj1 = { children: null };
  obj2 = { spacing: 24, children: null };
  items2[1] = tmp20Result;
  const items3 = [callback(closure_5, { children: items2 }), callback2(first(11785).SegmentedControlPages, { state: segmentedControlState }), , ];
  ...
  obj3[2] = items4;
  items3[2] = callback(first(4733).Stack, obj3);
  const obj6 = { children: null };
  const items5 = [callback2(first(7178).TableSwitchRow, { start: true, label: "Enable Grow", value: first1, onValueChange: tmp4[1] }), callback2(first(7178).TableSwitchRow, { label: "Enable Counts", value: tmp7, onValueChange: tmp8 }), callback2(first(7178).TableSwitchRow, { end: true, label: "Enable Overflow Gradient", value: first2, onValueChange: tmp9[1] })];
  obj6[0] = items5;
  items3[3] = callback(closure_5, obj6);
  obj2[1] = items3;
  obj[2] = callback(first(4733).Stack, obj2);
