...
export default function UserSettingsDesignSystemTabs() {
  ...
  const items2 = [callback2(first(12614).Tabs, { state: segmentedControlState, grow: first1 })];
  ...
  const items3 = [
    ...
    callback2(first(12616).SegmentedControlPages, { state: segmentedControlState }),
    ,
  ];
  ...
  const items5 = [
    callback2(first(7201).TableSwitchRow, { start: true, label: "Enable Grow", value: first1, onValueChange: tmp4[1] }),
    callback2(first(7201).TableSwitchRow, { label: "Enable Counts", value: tmp7, onValueChange: tmp8 }),
    callback2(first(7201).TableSwitchRow, {
      end: true,
