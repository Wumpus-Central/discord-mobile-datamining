...
export default function UserSettingsDesignSystemTabs() {
  ...
  if (first2) {
    ...
    tmp20Result = closure_8(tmp18(12257), obj5);
  }
  ...
  const items3 = [
    ...
    closure_8(require("SegmentedControlPages").SegmentedControlPages, { state: segmentedControlState }),
    ,
  ];
  ...
  const items5 = [
    closure_8(require("TableSwitchRow").TableSwitchRow, {
      start: true,
      label: "Enable Grow",
      value: first1,
      onValueChange: tmp4[1],
    }),
    closure_8(require("TableSwitchRow").TableSwitchRow, { label: "Enable Counts", value: tmp7, onValueChange: tmp8 }),
    closure_8(require("TableSwitchRow").TableSwitchRow, {
      end: true,
