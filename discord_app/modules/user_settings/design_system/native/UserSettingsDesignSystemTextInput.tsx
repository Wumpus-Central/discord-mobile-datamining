...
function Sample(children) {
  const tmp = callback4();
  return callback2(PressableCard.Card, {
    shadow: "low",
    style: callback4().sample,
    children: callback2(Stack.Stack, { spacing: 24, children: children.children }),
  });
}
...
function GhostInputActionSheet() {
  ...
  const items = [
    callback2(RedesignBottomSheetTitleHeaderBase.BottomSheetTitleHeader, { title: "Ghost Input - Centered" }),
  ];
  obj = { style: { padding: 12 }, children: null };
  obj = {
    children: callback2(GhostInputUsername, {
      placeholder: "@wumpus",
...
function GhostInputActionSheetLeftAligned() {
  let obj = { children: null };
  const items = [
    callback2(RedesignBottomSheetTitleHeaderBase.BottomSheetTitleHeader, { title: "Ghost Input - Left Aligned" }),
  ];
  obj = { style: { padding: 12 }, children: null };
  obj = {
    children: callback2(GhostInputUsername, {
...
const result = require("set").fileFinishedImporting(
  "modules/user_settings/design_system/native/UserSettingsDesignSystemTextInput.tsx",
);
...
export default function UserSettingsDesignSystemTextInput() {
  ...
  obj = { children: null };
  const items = [
    callback2(TextInput.TextInput, {
      label: "Input Label",
      placeholder: "Placeholder text",
      description: "Descriptions give context for the input.",
      errorMessage: "Error messages communicate invalid states.",
    }),
    callback2(TextArea.TextArea, { label: "Text Area", maxLength: 100, placeholder: "Multiline inputs use TextArea" }),
    callback2(TextInput.TextInput, {
      label: "Password",
  ...
  obj[0] = items;
  const items1 = [
    callback3(Sample, obj),
    callback2(Text.Text, { variant: "heading-lg/bold", children: "Sizing" }),
    callback2(Text.Text, {
      variant: "text-md/normal",
      children:
        "All inputs except TextArea accept a size prop, either sm, md, or lg. By default, inputs will use the large variant.",
    }),
    ,
    ,
    ,
  ...
  obj1 = { children: null };
  const items2 = [
    callback2(TextInput.TextInput, { label: "Small", size: "sm" }),
    callback2(TextInput.TextInput, { label: "Medium", size: "md" }),
    callback2(TextInput.TextInput, { label: "Large (default)" }),
  ];
  obj1[0] = items2;
  items1[3] = callback3(Sample, obj1);
  items1[4] = callback2(Text.Text, { variant: "heading-lg/bold", children: "Attachments" });
  items1[5] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      "Inputs can have either text and icon attachments, either on the leading or trailing edge. If both text and icon are given for a single side, the icon will take precedence.",
  });
  ...
  items1[7] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      "Text attachments should be kept as short as possible to preserve space for the user to see their input value while editing.",
  });
  items1[8] = callback2(Text.Text, { variant: "heading-lg/bold", children: "Pressable Attachments" });
  items1[9] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
  ...
  items1[11] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      "Note that the props do not allow for changing the styling of the pressable. Styling is instead handled by the Input itself.",
  });
  items1[12] = callback2(Text.Text, { variant: "heading-lg/bold", children: "Rounding" });
  items1[13] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
  ...
  items1[16] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      'The status prop communicates the overall state of the input. Setting status to "error" will render a red ring around the input. Note that errorMessage will always be displayed regardless of status.',
  });
  const obj10 = { children: null };
  const items5 = [
    callback2(InputUsername, { defaultValue: "a space" }),
    callback2(TextArea.TextArea, {
      label: "About me",
      maxLength: 100,
  ...
  items1[20] = callback2(Sample, {
    children: callback2(TextField.TextField, { defaultValue: "Clear this text", isClearable: true }),
  });
  items1[21] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
  ...
  items1[24] = callback2(Sample, {
    children: callback2(TextInput.TextInput, { defaultValue: "Can't edit this value", isDisabled: true }),
  });
  items1[25] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      "The isDisabled prop prevents users from interacting with an input in any way. The input container will be visually dimmed.",
  });
  items1[26] = callback2(Text.Text, { variant: "heading-lg/bold", children: "Max Length" });
  items1[27] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
  ...
  items1[28] = callback2(Sample, {
    children: callback2(TextArea.TextArea, { label: "Limited length", maxLength: 124 }),
  });
  items1[29] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      "Exceeding the maxLength will prevent the user from inputting any more text for the value until it has been shortened under the maximum length.",
  });
  items1[30] = callback2(Text.Text, { variant: "heading-lg/bold", children: "Ghost Inputs (Deprecated)" });
  items1[31] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      "GhostInput is deprecated and should not be used in new work; prefer TextInput. It is a minimal version of TextInput with no container shape, intended for cases where a single input is the primary focus of the surrounding area.",
  });
  ...
  items1[36] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      "SplitTextInput is a special TextInput extension that is primarily used for inputs that require selecting a prefix value.",
  });
  const obj18 = { children: null };
  const items6 = [
    callback2(SplitTextInput.SplitTextInput, {
      label: "Small",
      size: "sm",
      placeholder: "Placeholder",
      leadingText: "Click",
      leadingPressableProps: { accessibilityLabel: "Click" },
    }),
    callback2(SplitTextInput.SplitTextInput, {
      label: "Medium",
      size: "md",
      placeholder: "Placeholder",
      leadingText: "Me",
      leadingPressableProps: { accessibilityLabel: "Me" },
    }),
    callback2(SplitTextInput.SplitTextInput, {
      label: "Large",
      size: "lg",
      placeholder: "Placeholder",
      leadingText: "Here",
      leadingPressableProps: { accessibilityLabel: "Here" },
    }),
  ];
  obj18[0] = items6;
  items1[37] = callback3(Sample, obj18);
  items1[38] = callback2(Text.Text, { variant: "heading-lg/bold", children: "Data Types" });
  items1[39] = callback2(Text.Text, {
    variant: "text-md/normal",
    children:
      "Many special input types will have their own components. All inputs use a similar interface and support roughly the same set of props for styling and functionality. Examples will be added as these different types get implemented.",
  });
  obj[2] = items1;
