...
export default function UserSettingsDesignSystemButton() {
  ...
  obj12[0] = items4;
  items1[3] = callback3(_require(4733).Stack, obj12);
  const obj15 = { children: null };
  const obj16 = { style: tmp.container, children: null };
  const items5 = [callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "Overlay buttons" }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "Overlay buttons are meant to be used overlayed on top of an image or background color. They do not change colors with the theme." })];
  obj16[1] = items5;
  ...
  obj15[0] = items6;
  items1[4] = callback3(_require(4733).Stack, obj15);
  const obj18 = { children: null };
  const obj19 = { style: tmp.container, children: null };
  const items7 = [callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "Custom color icons" }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "If a button needs to have an icon which has its own custom color, then create your own Button.Icon to pass as the icon prop." })];
  obj19[1] = items7;
  const items8 = [callback3(_require(4733).Stack, obj19), ];
  ...
  obj21[1] = callback2(_require(4745).Button, obj22);
  ...
  const obj28 = { style: tmp.container, children: callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "Buttons with various text lengths" }) };
  obj30[1] = callback2(_require(4745).Button, {
    onPress() {
  ...
  obj27[0] = items10;
  items1[6] = callback3(_require(4733).Stack, obj27);
  const obj38 = { children: null };
  const obj39 = { style: tmp.container, children: null };
  const items12 = [callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "Toggling button states" }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "Use the useToggleButtonProps hook or the useToggleIconButtonProps hook to toggle a button between two states." }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "This hook changes the button presentation and adds some important accessibility attributes for a toggle button." })];
  obj39[1] = items12;
  const items13 = [callback3(_require(4733).Stack, obj39), ];
  const obj40 = { children: null };
  const obj36 = { style: tmp.buttonContainer, children: callback2(_require(4745).Button, obj37) };
  ...
  obj38[0] = items13;
  items1[7] = callback3(_require(4733).Stack, obj38);
  const obj43 = { children: null };
  const obj44 = { style: tmp.container, children: null };
  const items15 = [callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "Hierarchical icon buttons" }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "While the primary variants of IconButton are supported, these should be used very rarely." }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "An icon button usually has a secondary function and should use the secondary variants." })];
  obj44[1] = items15;
  ...
  obj49[0] = items18;
  items1[10] = callback3(_require(4733).Stack, obj49);
  const obj52 = { children: null };
  const obj53 = { style: tmp.container, children: null };
  const items19 = [callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "Image buttons" }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "Image buttons are rereserved for more branded buttons, like social media sharing buttons." })];
  obj53[1] = items19;
  const items20 = [callback3(_require(4733).Stack, obj53), ];
  ...
  obj52[0] = items20;
  items1[11] = callback3(_require(4733).Stack, obj52);
  const obj61 = { spacing: 24, children: null };
  const obj62 = { style: tmp.container, children: null };
  const items25 = [callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "IconButton with a label" }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "Icon buttons with a label require a different combination of props and will only appear in the 'lg' size." }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "It is highly recommended that a list of these buttons appear wrapped in a ScrollView, so that they will horizontally scroll when there are many buttons, when the text is longer through internationalization, or the text is larger through OS font size settings." })];
  obj62[1] = items25;
  ...
  obj66[3] = items27;
  obj65[2] = callback3(_require(4733).Stack, obj66);
  ...
  obj84[2] = items32;
  items31[1] = callback3(_require(6687).ButtonGroup, obj84);
  obj82[1] = items31;
  items1[14] = callback3(_require(4733).Stack, obj82);
  const obj85 = { children: null };
  const obj86 = { style: tmp.container, children: null };
  const items33 = [callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "Light Profile Themes" }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "All buttons as they appear on a light profile theme" })];
  obj86[1] = items33;
  const items34 = [callback3(_require(4733).Stack, obj86), ];
  ...
  items34[1] = callback2(_require(4104).ThemeContextProvider, obj87);
  obj85[0] = items34;
  items1[15] = callback3(_require(4733).Stack, obj85);
  obj91 = { children: null };
  obj92 = { style: tmp.container, children: null };
  const items36 = [callback2(_require(4734).Text, { variant: "heading-lg/bold", children: "Dark Profile Themes" }), callback2(_require(4734).Text, { variant: "text-sm/normal", children: "All buttons as they appear on a dark profile theme" })];
  obj92[1] = items36;
