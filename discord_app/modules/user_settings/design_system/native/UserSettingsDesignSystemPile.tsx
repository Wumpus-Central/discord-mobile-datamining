...
let items1 = [
  fn(5669).GuildIconSizes.XSMALL,
  fn(5669).GuildIconSizes.SMALL_32,
  fn(5669).GuildIconSizes.NORMAL,
  fn(5669).GuildIconSizes.LARGE,
  fn(5669).GuildIconSizes.XLARGE,
];
...
export default function UserSettingsDesignSystemPile() {
  ...
  items[4] = hasOwnProperty(SampleCard, {
    ...
    children: items1.map((size) => {
      const obj = { children: null };
      items = [
        closure_5(size(4635).Text, { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() }),
      ];
      const obj2 = { variant: "text-md/medium", color: "text-subtle", children: size.toLowerCase() };
      items[1] = closure_5(size(12753).GuildIconPile, {
        size,
        names: names2,
        totalCount: 128,
