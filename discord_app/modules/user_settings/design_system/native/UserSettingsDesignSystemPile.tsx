...
let items1 = [
  fn(5598).GuildIconSizes.XSMALL,
  fn(5598).GuildIconSizes.SMALL_32,
  fn(5598).GuildIconSizes.NORMAL,
  fn(5598).GuildIconSizes.LARGE,
  fn(5598).GuildIconSizes.XLARGE,
];
...
export default function UserSettingsDesignSystemPile() {
  ...
  obj = {
    ...
    children: items.map((children) => {
      ...
      items = [closure_5(size(4570).Text, obj)];
      ...
      items[1] = closure_5(size(13057).AvatarPile, obj);
      obj.children = items;
  ...
  items[2] = hasOwnProperty(SampleCard, {
    ...
    children: items.map((children) => {
      ...
      items[1] = closure_5(size(14205).AvatarDuoPile, obj);
      obj.children = items;
      return closure_6(size(4987).Stack, obj, children);
    }),
  });
  ...
  items[4] = hasOwnProperty(SampleCard, {
    ...
    children: items1.map((size) => {
      ...
      items[1] = closure_5(size(12648).GuildIconPile, obj);
      obj.children = items;
