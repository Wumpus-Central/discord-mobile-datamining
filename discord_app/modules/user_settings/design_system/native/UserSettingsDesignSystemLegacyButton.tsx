...
let items = [
  {
    look: fn(1177).ButtonLooks.FILLED,
    color: fn(1177).ButtonColors.BRAND,
    size: fn(1177).ButtonSizes.LARGE,
    shrink: false,
    count: 1,
  },
  ,
...
items[1] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.BRAND,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 116,
};
let obj2 = {
...
items[3] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.BRAND,
  size: fn(1177).ButtonSizes.SMALL,
  shrink: false,
  count: 5,
};
let obj4 = {
...
items[5] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.BRAND,
  size: fn(1177).ButtonSizes.XSMALL,
  shrink: false,
  count: 4,
};
let obj6 = {
...
items[7] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.GREEN,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 1,
};
...
items[11] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.GREY,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 10,
};
...
items[16] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.LIGHTGREY,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 2,
};
...
items[18] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.PRIMARY,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 2,
};
...
items[21] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.RED,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 8,
};
...
items[24] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.TRANSPARENT,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 8,
};
...
items[28] = {
  look: fn(1177).ButtonLooks.FILLED,
  color: fn(1177).ButtonColors.WHITE,
  size: fn(1177).ButtonSizes.SMALL,
  shrink: false,
  count: 1,
};
...
items[30] = {
  look: fn(1177).ButtonLooks.LINK,
  color: fn(1177).ButtonColors.LINK,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 3,
};
...
items[36] = {
  look: fn(1177).ButtonLooks.OUTLINED,
  color: fn(1177).ButtonColors.BRAND,
  size: fn(1177).ButtonSizes.MEDIUM,
  shrink: false,
  count: 2,
