...
function ComparisonRow(entry) {
  ...
  if (null != redesignVariant) {
    ...
    const items5 = [tmp9(tmp4(4338).Text, { variant: "text-xxs/medium", color: "text-muted", children: "mana" }), ];
    ...
    obj6[1] = tmp9(tmp4(4338).Text, { variant: "text-xs/medium", color: "text-muted", children: "no mapping" });
