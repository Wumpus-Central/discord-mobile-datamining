...
function ComparisonRow(entry) {
  ...
  const obj3 = {
    look: entry.look,
    color: entry.color,
    size: Button.ButtonSizes.MEDIUM,
    shrink: true,
    text: combined,
    textStyle: null,
    onPress: null,
...
let obj = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.BRAND,
  size: require("Button").ButtonSizes.LARGE,
  shrink: false,
  count: 1,
};
let items = [obj, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , ,];
obj = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.BRAND,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 116,
};
items[1] = obj;
...
items[3] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.BRAND,
  size: require("Button").ButtonSizes.SMALL,
  shrink: false,
  count: 5,
};
obj1 = {
...
items[5] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.BRAND,
  size: require("Button").ButtonSizes.XSMALL,
  shrink: false,
  count: 4,
};
let obj3 = {
...
items[7] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.GREEN,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 1,
};
...
items[11] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.GREY,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 10,
};
...
items[16] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.LIGHTGREY,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 2,
};
...
items[18] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.PRIMARY,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 2,
};
...
items[21] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.RED,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 8,
};
...
items[24] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.TRANSPARENT,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 8,
};
...
items[28] = {
  look: require("Button").ButtonLooks.FILLED,
  color: require("Button").ButtonColors.WHITE,
  size: require("Button").ButtonSizes.SMALL,
  shrink: false,
  count: 1,
};
...
items[29] = {
  look: require("Button").ButtonLooks.LINK,
  color: require("Button").ButtonColors.BRAND,
  size: require("Button").ButtonSizes.XSMALL,
  shrink: true,
  count: 1,
...
items[30] = {
  look: require("Button").ButtonLooks.LINK,
  color: require("Button").ButtonColors.LINK,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 3,
};
...
items[36] = {
  look: require("Button").ButtonLooks.OUTLINED,
  color: require("Button").ButtonColors.BRAND,
  size: require("Button").ButtonSizes.MEDIUM,
  shrink: false,
  count: 2,
...
obj39[2] = {
  backgroundColor: ThemesDefault.unsafe_rawColors.PRIMARY_600,
...
export default function UserSettingsDesignSystemLegacyButton() {
  ...
  items = [
    callback2(Text.Text, { variant: "heading-xl/bold", children: "Migration Mapping" }),
    callback2(Text.Text, {
  ...
  const items2 = [
    callback2(Text.Text, { variant: "heading-xl/bold", children: "Legacy Button Audit" }),
    callback2(Text.Text, {
      variant: "text-sm/normal",
      color: "text-muted",
