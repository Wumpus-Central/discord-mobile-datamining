...
import _modDef6079 from "../../../../../discord_assets/assets/mana/asset-library/generated/AvatarCapExample-2x.png.js";
...
function Content() {
  ...
  const memo = obj.useMemo(() => {
    ...
    const obj2 = { type: "image", src: { uri: _modDef6079 }, aspectRatio: first5 };
    obj.graphic = obj2;
  ...
  const items4 = [
    first5(visible(first1[11]).TableSwitchRow, {
      label: "Enable Bottom Position",
      value: first2,
      onValueChange: tmp6[1],
    }),
    first5(visible(first1[11]).TableSwitchRow, { label: "Enable Button", value: first3, onValueChange: tmp13[1] }),
  ];
  ...
  items3[5] = first5(visible(first1[11]).TableSwitchRow, {
    label: "Enable Blur Background",
    value: first1,
    onValueChange: tmp4[1],
  });
  items3[6] = first5(visible(first1[11]).TableSwitchRow, {
