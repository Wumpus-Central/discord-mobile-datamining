...
import _modDef4792 from "../../../../../_runtime/metro/04792__.js";
      ...
      let mapped = Array.from(obj).map(() => {
        ...
        return Array.from({ length }).map((item, index) => {
          const obj = {
            ...
            variant: ,
