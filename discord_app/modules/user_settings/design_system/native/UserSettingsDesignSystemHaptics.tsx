...
export default function UserSettingsDesignSystemHaptics() {
  ...
  const items = [callback(Text.Text, { variant: "text-lg/bold", children: "Semantic Types" }), callback(Text.Text, { variant: "text-md/medium", color: "text-subtle", children: "Existing haptic types with platform-specific remapping for the best feel." }), ];
  ...
  const items1 = [callback(PressableCard.Card, obj), , , , ];
