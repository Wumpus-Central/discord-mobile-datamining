...
export default {
        ...
        if (null == obj[XBOX]) {
          ...
          resolved = new Promise((arg0) => {
            ...
            obj2.onConfirm = function onConfirm() {
              const result = closure_0(4649).UNSAFE_markDismissibleContentAsDismissed(
                closure_0(2028).DismissibleContent.CONSOLE_PTT_DISABLE_ALERT,
              );
              closure_0();
            };
  ...
  showSelfDismissableAlert(reconnectPlatformType) {
    ...
    obj2.body = jsx(reconnectPlatformType(10140).SelfDismissibleAlertBody, {
      body,
      errorCodeMessage,
