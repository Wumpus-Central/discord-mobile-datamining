// === Module 9460: game_console/GameConsoleActionCreators ===
...
let closure_4 = async function _transferToPlaystationWithAlert(arg0, arg1, arg2) {
  ...
  return (async (arg0, value, arg2) => {
    ...
    if (1 === tmp8) {
      ...
      obj2.body = intl2.formatToPlainString(closure_132_0(closure_132_2[3]).t["6ZyNH/"], { deviceName: closure_131_0.name });
