...
function DeviceOption(children) {
  ...
  obj = { style: tmp.deviceIcon, source: _modDef9548 };
...
function EmptyState() {
  ...
  obj = { source: _modDef9549, style: tmp.emptyArt };
  const items = [closure_1_12(React6, obj), , ];
...
fn(4606);
let createStyles = { container: { padding: 16, justifyContent: "center", paddingBottom: 90 }, loading: { minHeight: 56 }, footerContainer: null, radioItem: null, deviceIcon: null, deviceOption: null, deviceText: null, emptyContainer: null, emptyArt: null, emptyHeader: null, emptyBody: null, infoBox: null };
...
createStyles.radioItem = { backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH, borderRadius: nativeDefault.radii.xs, padding: 16 };
...
export default function GameConsoleListActionSheet(arg0) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj1 = { value: tmp4(9546).transferToPlaystationWithAlert(require, stateFromStores[_slicedToArray], importDefault), done: false };
            return obj1;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
  ...
  const stateFromStores2 = obj2.useStateFromStores(items2, () => GameConsoleStore.getLastSelectedDeviceByPlatform(require));
