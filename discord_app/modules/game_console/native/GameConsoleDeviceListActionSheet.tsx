...
import _modDef9252 from "../../../../_runtime/metro/09252__.js";
import _modDef9253 from "../../../../_runtime/metro/09253__.js";
...
function DeviceOption(children) {
  ...
  const items = [
    closure_1_12(React6, { style: tmp.deviceIcon, source: _modDef9252 }),
...
let obj2 = {
  ...
  footerContainer: { padding: 16, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH, paddingBottom: 16 },
  radioItem: null,
  deviceIcon: null,
  deviceOption: null,
  deviceText: null,
...
export default function GameConsoleListActionSheet(arg0) {
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            const obj4 = {
              value: tmp4(9250).transferToPlaystationWithAlert(require, stateFromStores[_slicedToArray], importDefault),
              done: false,
            };
            return obj4;
          }
  ...
  stateFromStores = require("initialize").useStateFromStores(items, () =>
    GameConsoleStore.getDevicesForPlatform(require),
  );
  let obj = require("initialize");
  const items1 = [GameConsoleStore];
  const stateFromStores1 = require("initialize").useStateFromStores(items1, () =>
    GameConsoleStore.getFetchingDevices(require),
  );
