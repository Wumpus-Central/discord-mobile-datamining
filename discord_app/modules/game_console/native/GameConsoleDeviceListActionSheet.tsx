...
function DeviceOption(children) {
  ...
  obj = { style: tmp.deviceIcon, source: _modDef9587 };
...
function EmptyState() {
  ...
  obj = { source: _modDef9588, style: tmp.emptyArt };
  const items = [closure_1_12(React6, obj), , ];
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            v1 = 1;
            dependencyMap = 1;
            const obj1 = { value: tmp4(9585).transferToPlaystationWithAlert(require, stateFromStores[_slicedToArray], importDefault), done: false };
            return obj1;
          }
        } else if (arg0 === 1) {
          dependencyMap = 3;
