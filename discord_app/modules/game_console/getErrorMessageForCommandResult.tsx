...
export default function getErrorMessageForCommandResult(arg0, arg1, code) {
  ...
  if ("failed" === arg1) {
    ...
    if (constants.CONSOLE_DEVICE_COMMUNICATION_RESTRICTED === code) {
      ...
      obj[0] = intl7.string(getSystemLocale /* getSystemLocale */.t["GSZ+HI"]);
      const intl8 = getSystemLocale /* getSystemLocale */.intl;
      obj = { deviceType: null };
      obj[0] = platform;
      obj[1] = intl8.formatToPlainString(getSystemLocale /* getSystemLocale */.t["cYX/3E"], obj);
      let obj7 = obj;
      ...
      obj2[0] = platform;
      obj1[0] = intl5.formatToPlainString(getSystemLocale /* getSystemLocale */.t.akd6Sx, obj2);
      const intl6 = getSystemLocale /* getSystemLocale */.intl;
      const obj3 = { deviceName: null };
      obj3[0] = name;
      obj1[1] = intl6.formatToPlainString(getSystemLocale /* getSystemLocale */.t.RyOvpJ, obj3);
      obj7 = obj1;
    } else {
      if (tmp2.CONSOLE_DEVICE_UNVAILABLE_FROM_OTHER_USERS === code) {
        ...
        obj5[0] = platform;
        obj4[0] = intl3.formatToPlainString(getSystemLocale /* getSystemLocale */.t.M6Vzat, obj5);
        const intl4 = getSystemLocale /* getSystemLocale */.intl;
        const obj6 = { deviceName: null };
        obj6[0] = name;
        obj4[1] = intl4.formatToPlainString(getSystemLocale /* getSystemLocale */.t.InKtnC, obj6);
        obj7 = obj4;
        ...
        obj7[0] = intl12.string(getSystemLocale /* getSystemLocale */.t.QL1y93);
        const intl13 = getSystemLocale /* getSystemLocale */.intl;
        const obj8 = { deviceName: null };
        obj8[0] = name;
        obj7[1] = intl13.formatToPlainString(getSystemLocale /* getSystemLocale */.t["6ZyNH/"], obj8);
      }
      obj = { title: null, body: null, isAccountLinkError: true };
      const intl = getSystemLocale /* getSystemLocale */.intl;
      obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t.QL1y93);
      const intl2 = getSystemLocale /* getSystemLocale */.intl;
      const obj9 = { deviceType: null };
      obj9[0] = platform;
      obj[1] = intl2.formatToPlainString(getSystemLocale /* getSystemLocale */.t.D18eZu, obj9);
      obj7 = obj;
    }
  } else {
    let tmp = null;
    if ("n/a" === arg1) {
      ...
      if (code.code === constants.CONSOLE_DEVICE_PASSCODE_UNLOCK_REQUIRED) {
        ...
        obj11[0] = tmp16;
        obj10[0] = intl10.formatToPlainString(getSystemLocale /* getSystemLocale */.t.KchfhO, obj11);
        const intl11 = getSystemLocale /* getSystemLocale */.intl;
        let obj12 = { deviceName: null };
        obj12[0] = tmp17;
        obj10[1] = intl11.formatToPlainString(getSystemLocale /* getSystemLocale */.t["21ndz7"], obj12);
        tmp19 = obj10;
      }
      tmp = tmp19;
    }
    if (null != tmp) {
      ...
      obj13[1] = code.code;
      tmp.errorCodeMessage = intl9.format(getSystemLocale /* getSystemLocale */.t["1Bi9Cf"], obj13);
    }
    return tmp;
  }
};