...
export default function getErrorMessageForCommandResult(arg0, arg1, code) {
  ...
  if ("failed" === arg1) {
    ...
    if (constants.CONSOLE_DEVICE_COMMUNICATION_RESTRICTED === code) {
      ...
      obj[0] = intl7.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["GSZ+HI"]);
      const intl8 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
      obj = { deviceType: null };
      obj[0] = platform;
      obj[1] = intl8.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["cYX/3E"], obj);
      let obj7 = obj;
      ...
      obj2[0] = platform;
      obj1[0] = intl5.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.akd6Sx, obj2);
      const intl6 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
      const obj3 = { deviceName: null };
      obj3[0] = name;
      obj1[1] = intl6.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.RyOvpJ, obj3);
      obj7 = obj1;
    } else {
      if (tmp2.CONSOLE_DEVICE_UNVAILABLE_FROM_OTHER_USERS === code) {
        ...
        obj5[0] = platform;
        obj4[0] = intl3.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.M6Vzat, obj5);
        const intl4 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
        const obj6 = { deviceName: null };
        obj6[0] = name;
        obj4[1] = intl4.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.InKtnC, obj6);
        obj7 = obj4;
        ...
        obj7[0] = intl12.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.QL1y93);
        const intl13 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
        const obj8 = { deviceName: null };
        obj8[0] = name;
        obj7[1] = intl13.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["6ZyNH/"], obj8);
      }
      obj = { title: null, body: null, isAccountLinkError: true };
      const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
      obj[0] = intl.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.QL1y93);
      const intl2 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
      const obj9 = { deviceType: null };
      obj9[0] = platform;
      obj[1] = intl2.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.D18eZu, obj9);
      obj7 = obj;
    }
  } else {
    let tmp = null;
    if ("n/a" === arg1) {
      ...
      if (code.code === constants.CONSOLE_DEVICE_PASSCODE_UNLOCK_REQUIRED) {
        ...
        obj11[0] = tmp16;
        obj10[0] = intl10.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.KchfhO, obj11);
        const intl11 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
        let obj12 = { deviceName: null };
        obj12[0] = tmp17;
        obj10[1] = intl11.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["21ndz7"], obj12);
        tmp19 = obj10;
      }
      tmp = tmp19;
    }
    if (null != tmp) {
      ...
      obj12 = require("../../utils/HelpdeskUtils.tsx");
      obj13[0] = obj12.getSubmitRequestURL();
      obj13[1] = code.code;
      tmp.errorCodeMessage = intl9.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t["1Bi9Cf"], obj13);
    }
    return tmp;
  }
};