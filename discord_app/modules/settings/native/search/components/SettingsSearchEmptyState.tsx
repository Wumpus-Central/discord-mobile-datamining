...
const memoResult = importAllResult.memo(function SettingsSearchEmptyState() {
  ...
  const items = [callback(getNoResultsAltSource /* getNoResultsAltSource */.NoResultsAlt, { resizeMode: "contain" }), ];
  ...
  obj[2] = intl.string(getSystemLocale /* getSystemLocale */.t.zihbmv);
  const items1 = [callback(Text /* Text */.Text, obj), ];
  const obj1 = { variant: "text-xs/medium", color: "text-muted", children: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj1[2] = intl2.string(getSystemLocale /* getSystemLocale */.t.XclvsB);
