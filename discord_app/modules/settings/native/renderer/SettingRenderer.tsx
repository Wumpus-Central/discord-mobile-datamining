...
function DisabledActionDescriptionWithLink(children) {
  ...
  const tmp4 = closure_1_14(Text_Text.Text, {
...
let closure_26 = noop.memo((arg0) => {
  ...
  if (null != IconComponent) {
    const obj3 = { IconComponent, variant };
    tmp11Result = closure_14(tmp(5690).TableRow.Icon, obj3);
  }
  obj2.icon = tmp11Result;
  let tmp11Result2 = null;
  if (null != trailing) {
    const obj4 = { text: trailing };
    tmp11Result2 = closure_14(tmp(5690).TableRow.TrailingText, obj4);
  }
...
let closure_27 = noop.memo((arg0) => {
  ...
  obj2.subLabel = closure_1_14(View, {
...
let closure_28 = noop.memo((useTrailing) => {
  ...
  const items7 = [
    closure_14(onSlidingComplete(num2[21]).Text, { variant: "text-md/semibold", children: title }),
    trailing,
  ];
  ...
  const items9 = [
    closure_16(onSlidingComplete(num2[33]).Stack, {
  ...
  obj6.startIcon = closure_14(onSlidingComplete(num2[37]).PressableOpacity, {
    accessible: false,
    onPress: callback6,
    children: startIcon,
  });
  obj6.endIcon = closure_14(onSlidingComplete(num2[37]).PressableOpacity, {
    accessible: false,
    onPress: callback5,
    children: endIcon,
  });
