// === Module 14696: SettingListItemHighlight ===
...
export default noop.memo((start) => {
  ...
  let fn = function _() {
    ...
    obj.opacity = obj1.withSequence(withDelayResult, withTimingResult, timing.withTiming(0, obj, "respect-motion-settings", fn));
    return obj;
  };
  let obj = { withSequence: start(clearSelectedSearchResult[6]).withSequence, withDelay: start(clearSelectedSearchResult[6]).withDelay, withTiming: start(clearSelectedSearchResult[7]).withTiming, Easing: start(clearSelectedSearchResult[6]).Easing, runOnJS: start(clearSelectedSearchResult[6]).runOnJS, clearSelectedSearchResult };
  fn.__closure = obj;
