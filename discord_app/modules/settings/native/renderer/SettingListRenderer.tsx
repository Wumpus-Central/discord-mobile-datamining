// === Module 15049: SettingListRenderer ===

// Module 15049 (SettingListRenderer)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4823 */;
import TableRowGroup from "TableRowGroup" /* 5990 */;
import SettingRenderer from "SettingRenderer" /* 15051 */;
import SettingRendererUtils from "SettingRendererUtils" /* 15052 */;
import SettingsSearchEmptyStateDefault from "SettingsSearchEmptyState" /* 15060 */;
...
const ListItemType = fn(11806).ListItemType;
const jsx = fn(21).jsx;
...
const memoResult = noop.memo((node) => {
  ...
  node(15056).useAutoScrollToSearchResultSetting(ref, memo, node.scrollTarget);
  ...
  obj2.children = jsx(node(9073).FlashList, { ref, ListHeaderComponent: node.ListHeaderComponent, contentContainerStyle: null, scrollIndicatorInsets: null, keyExtractor: null, renderItem: null, data: null, getItemType: null });
