...
export const openAddMembersActionSheet = function openAddMembersActionSheet(closure_0) {
  ...
  obj2.openLazy(asyncRequireImpl /* asyncRequireImpl */(8926, dependencyMap.paths), "channel-add-members-" + closure_0.id, obj);
};
export const openChannelMembersActionSheet = function openChannelMembersActionSheet(id, guild_id) {
  ...
  obj2.openLazy(asyncRequireImpl /* asyncRequireImpl */(10987, dependencyMap.paths), "channel-members-" + id, obj);
};