...
export const openAddMembersActionSheet = function openAddMembersActionSheet(stateFromStores) {
  ...
  obj2.openLazy(asyncRequireImpl(9922, dependencyMap.paths), "channel-add-members-" + stateFromStores.id, {
...
export const openChannelMembersActionSheet = function openChannelMembersActionSheet(id, guild_id) {
  ...
  const obj2 = ActionSheetActionCreatorsDefault;
  obj2.openLazy(asyncRequireImpl(11947, dependencyMap.paths), "channel-members-" + id, {
    channelId: id,
    guildId: guild_id,
  });
};
