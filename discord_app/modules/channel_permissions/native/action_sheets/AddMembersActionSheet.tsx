...
class AddMembersBody {
  constructor(arg0) {
    ...
    obj33.data = items6;
    obj34 = {
      paddingHorizontal: tmp8(tmp9[13]).space.PX_16,
      paddingBottom: tmp8(tmp9[13]).space.PX_16 + pendingAdditions(closure_3[15])(obj1).insets.bottom,
    };
...
export default function AddMembersActionSheet(channel) {
  ...
  if (null == stateFromStores) {
    ...
    if (channel.canSkip) {
      ...
      obj4.header = closure_17(tmp4(7480).BottomSheetTitleHeader, obj2);
      ...
      return closure_17(tmp4(7481).BottomSheet, obj4);
    }
