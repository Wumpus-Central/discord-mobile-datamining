...
export default function ChannelAccessInfo(guild) {
  ...
  if (null != first) {
    ...
    function renderCounts(MEMBERS, length, arg2, GroupIcon) {
      if (0 === length) {
        ...
        items[1] = React6(tmp4(4602).Text, obj5);
        obj3.children = items;
  ...
  obj.children = items6;
  items2[1] = closure_9(guild(5174).PressableOpacity, obj);
