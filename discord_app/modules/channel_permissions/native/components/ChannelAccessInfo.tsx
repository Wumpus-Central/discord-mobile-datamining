...
export default function ChannelAccessInfo(guild) {
  ...
  if (null != first) {
    ...
    function renderCounts(MEMBERS, length, arg2, GroupIcon) {
      if (0 === length) {
        ...
        items[1] = React6(tmp4(4601).Text, obj5);
        obj3.children = items;
  ...
  obj.children = items6;
  items2[1] = closure_9(guild(5173).PressableOpacity, obj);
