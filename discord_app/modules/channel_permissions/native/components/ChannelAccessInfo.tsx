// === Module 11683: ChannelAccessInfo ===
...
export default function ChannelAccessInfo(guild) {
  ...
  const existingMembers = guild(8588).getExistingMembers(memberIds, channel, guild, channel.accessPermissions);
  ...
  if (null != first) {
    ...
    channel(11682);
    const items5 = [renderCounts(MEMBERS, existingMembers.length, 0, tmp2(4769).GroupIcon), ];
