...
export default function ChannelAccessInfo(guild) {
  ...
  const existingMembers = guild(8919).getExistingMembers(memberIds, channel, guild, channel.accessPermissions);
  ...
  if (null != first) {
    ...
    channel(8930);
    items5[1] = renderCounts(ROLES, stateFromStoresArray.length, 0, tmp2(8928).ShieldUserIcon);
    obj6[0] = items5;
  }
