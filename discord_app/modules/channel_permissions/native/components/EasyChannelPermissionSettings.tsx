  ...
  closure_7 = async function _togglePrivateChannel() {
    if (dependencyMap === 2) {
      ...
      try {
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (!tmp7) {
              ...
              dependencyMap = 1;
              const obj1 = {
                value: tmp21(9770).grantUserChannelAccess(accessPermissions, accessPermissions),
                done: false,
              };
              return obj1;
            }
        ...
        v2 = 2;
        dependencyMap = 1;
        const obj3 = { value: tmp2(9771).savePermissionUpdates(closure_129_0.id, items), done: false };
        return obj3;
      } catch (tmp16) {
        dependencyMap = tmp;
        throw tmp16;
