...
function RemoveIcon(item) {
  ...
  if (null != channelId) {
    ...
    tmp3Result = closure_7(item(5292).PressableOpacity, obj);
  }
  return tmp3Result;
}
...
function MemberItem(arg0) {
  ...
  if (item.rowType === RowType.OWNER) {
    const obj3 = { size: native.Icon.Sizes.REFRESH_SMALL_16, source: _modDef9998, disableColor: true, style: tmp.ownerIcon };
