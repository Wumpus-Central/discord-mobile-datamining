...
const result = obj132.fileFinishedImporting("modules/channel_permissions/ChannelPermissionsConstants.tsx");
...
export const getChannelPermissionSpecMap = function getChannelPermissionSpecMap(type, arg1, createPostsDisabled) {
  ...
  obj = { [str]: obj };
  obj[1] = M2iEy3;
  ({ VIEW_CHANNEL: obj[2], MANAGE_CHANNELS } = constants4);
  if (type === constants.GUILD_CATEGORY) {
  ...
  obj[1] = ydL28i;
  obj[2] = constants4.MANAGE_CHANNELS;
  ...
  obj1[1] = hOMXOv;
  obj1[2] = constants4.MANAGE_ROLES;
  obj[str2] = obj1;
  ...
  obj2[1] = CYBZry;
  obj2[2] = constants4.MANAGE_WEBHOOKS;
  obj[str3] = obj2;
  ...
  obj3[1] = lUCs1n;
  obj3[2] = constants4.CREATE_INSTANT_INVITE;
  obj[str4] = obj3;
  ...
  obj4[1] = WQ6zpT;
  obj4[2] = constants4.SEND_MESSAGES;
  obj[str5] = obj4;
  ...
  obj7[1] = WK9r7F;
  obj7[2] = constants4.ATTACH_FILES;
  obj[str7] = obj7;
  ...
  obj8[1] = PVjR1Y;
  obj8[2] = constants4.ADD_REACTIONS;
  obj[str8] = obj8;
  ...
  obj9[1] = Qc5vOr;
  obj9[2] = constants4.USE_EXTERNAL_EMOJIS;
  obj[str9] = obj9;
  ...
  obj10[1] = VF4fZZ;
  obj10[2] = constants4.USE_EXTERNAL_STICKERS;
  obj[str10] = obj10;
  ...
  if (type === constants.GUILD_CATEGORY) {
    let prop = tmp10(1236).t["HOhg/B"];
  } else if (type === constants.GUILD_STAGE_VOICE) {
    prop = tmp10(1236).t.rZn1oO;
  } else {
    prop = tmp10(1236).t["6IUSdt"];
  }
  obj11[1] = prop;
  obj11[2] = constants4.MENTION_EVERYONE;
  obj[str11] = obj11;
  ...
  if (constants.GUILD_CATEGORY === type) {
    let v5R9nYh = tmp8(1236).t["5R9nYh"];
  } else if (constants.GUILD_ANNOUNCEMENT === type) {
    ...
    v5R9nYh = intl20.format(tmp8(1236).t.XRxOo0, obj13);
  } else {
    v5R9nYh = tmp8(1236).t["SeA+G9"];
  }
  obj12[1] = v5R9nYh;
  obj12[2] = constants4.MANAGE_MESSAGES;
  obj[str12] = obj12;
  ...
  if (type === constants.GUILD_CATEGORY) {
    let gmbD87 = tmp10(1236).t.gmbD87;
  } else {
    gmbD87 = tmp10(1236).t["0l2EjL"];
  }
  obj14[1] = gmbD87;
  obj14[2] = constants4.PIN_MESSAGES;
  obj[str13] = obj14;
  ...
  obj15[1] = Ha1xbw;
  obj15[2] = constants4.BYPASS_SLOWMODE;
  obj[str14] = obj15;
  ...
  obj16[1] = qEbw4W;
  obj16[2] = constants4.MANAGE_OFFICIAL_MESSAGES;
  obj[str15] = obj16;
  ...
  obj17[1] = RqCc7i;
  obj17[2] = constants4.READ_MESSAGE_HISTORY;
  obj[str16] = obj17;
  ...
  obj18[1] = CpakGz;
  obj18[2] = constants4.SEND_TTS_MESSAGES;
  obj[str17] = obj18;
  ...
  obj19[1] = ReG3gG;
  obj19[2] = constants4.USE_APPLICATION_COMMANDS;
  obj[str18] = obj19;
  ...
  obj20[1] = BhEo9V;
  obj20[2] = constants4.SEND_VOICE_MESSAGES;
  obj[str19] = obj20;
  ...
  if (arg1) {
    if (GUILD_CATEGORY2 === type) {
      let XcrieN = tmp8(1236).t.XcrieN;
    } else if (constants.GUILD_STAGE_VOICE === type) {
      XcrieN = tmp8(1236).t.SOFNhP;
    } else {
      if (constants.GUILD_TEXT !== type) {
        if (constants.GUILD_FORUM !== type) {
          if (constants.GUILD_MEDIA !== type) {
            XcrieN = tmp8(1236).t.j4AyO8;
          }
        }
      }
      XcrieN = tmp8(1236).t.LsS8xT;
    }
  } else if (GUILD_CATEGORY2 === type) {
    XcrieN = tmp8(1236).t.stA0Hl;
  } else if (constants.GUILD_STAGE_VOICE === type) {
    XcrieN = tmp8(1236).t["G9+Qie"];
  } else {
    if (constants.GUILD_TEXT !== type) {
      if (constants.GUILD_FORUM !== type) {
        if (constants.GUILD_MEDIA !== type) {
          XcrieN = tmp8(1236).t.HvG8uR;
        }
      }
    }
    XcrieN = tmp8(1236).t["QU/Rw8"];
  }
  obj22[1] = XcrieN;
  obj22[2] = constants4.CONNECT;
  obj[str21] = obj22;
  ...
  if (constants.GUILD_CATEGORY === type) {
    let iXhS6R = tmp8(1236).t.iXhS6R;
  } else if (constants.GUILD_STAGE_VOICE === type) {
    iXhS6R = tmp8(1236).t.a8n741;
  } else {
    if (constants.GUILD_TEXT !== type) {
      if (constants.GUILD_FORUM !== type) {
        if (constants.GUILD_MEDIA !== type) {
          iXhS6R = tmp8(1236).t["568E6d"];
        }
      }
    }
    iXhS6R = tmp8(1236).t["+VXsJI"];
  }
  obj23[1] = iXhS6R;
  obj23[2] = constants4.SPEAK;
  obj[str22] = obj23;
  ...
  obj25[1] = RyEwla;
  obj25[2] = constants4.USE_EMBEDDED_ACTIVITIES;
  obj[str24] = obj25;
  ...
  obj26[1] = qPUPip;
  obj26[2] = constants4.USE_EXTERNAL_APPS;
  obj[str25] = obj26;
  ...
  obj27[2] = constants4.USE_SOUNDBOARD;
  obj[str26] = obj27;
  ...
  obj31[2] = constants4.USE_EXTERNAL_SOUNDS;
  obj[str27] = obj31;
  ...
  if (constants.GUILD_CATEGORY === type) {
    let fUYPly = tmp8(1236).t.fUYPly;
  } else if (constants.GUILD_STAGE_VOICE === type) {
    fUYPly = tmp8(1236).t.BJKqsW;
  } else {
    if (constants.GUILD_TEXT !== type) {
      if (constants.GUILD_FORUM !== type) {
        if (constants.GUILD_MEDIA !== type) {
          fUYPly = tmp8(1236).t.s2eihY;
        }
      }
    }
    fUYPly = tmp8(1236).t["3GJwsc"];
  }
  obj32[1] = fUYPly;
  obj32[2] = constants4.USE_VAD;
  obj[str28] = obj32;
  ...
  obj33[2] = constants4.PRIORITY_SPEAKER;
  obj[str29] = obj33;
  ...
  obj37[1] = KYDG2K;
  obj37[2] = constants4.MUTE_MEMBERS;
  obj[str30] = obj37;
  ...
  if (constants.GUILD_CATEGORY === type) {
    let amZ5vn = tmp8(1236).t.amZ5vn;
  } else {
    if (constants.GUILD_TEXT !== type) {
      if (constants.GUILD_FORUM !== type) {
        if (constants.GUILD_MEDIA !== type) {
          amZ5vn = tmp8(1236).t.UAdIxo;
        }
      }
    }
    amZ5vn = tmp8(1236).t["d+i1nX"];
  }
  obj38[1] = amZ5vn;
  obj38[2] = constants4.DEAFEN_MEMBERS;
  obj[str31] = obj38;
  ...
  obj39[1] = cbdQy2;
  obj39[2] = constants4.MOVE_MEMBERS;
  obj[str32] = obj39;
  ...
  obj40[1] = uzlYFE;
  obj40[2] = constants4.REQUEST_TO_SPEAK;
  obj[str33] = obj40;
  ...
  if (constants.GUILD_CATEGORY === type) {
    let S31soU = tmp8(1236).t.S31soU;
  } else {
    if (constants.GUILD_FORUM !== type) {
      if (constants.GUILD_MEDIA !== type) {
        S31soU = tmp8(1236).t.yvan0j;
      }
    }
    S31soU = tmp8(1236).t["XLi/jG"];
  }
  obj41[1] = S31soU;
  obj41[2] = constants4.MANAGE_THREADS;
  obj[str34] = obj41;
  ...
  if (type === constants.GUILD_CATEGORY) {
    let prop2 = tmp10(1236).t["+M1yLj"];
  } else {
    prop2 = tmp10(1236).t["5SDtGB"];
  }
  obj42[1] = prop2;
  obj42[2] = constants4.CREATE_PUBLIC_THREADS;
  obj[str35] = obj42;
  ...
  obj43[1] = Chg2zd;
  obj43[2] = constants4.CREATE_PRIVATE_THREADS;
  obj[str36] = obj43;
  ...
  obj44[1] = XTnrPH;
  obj44[2] = constants4.SEND_MESSAGES_IN_THREADS;
  obj[str37] = obj44;
  ...
  if (type === constants.GUILD_CATEGORY) {
    let CP2sz4 = tmp10(1236).t.CP2sz4;
  } else {
    CP2sz4 = tmp10(1236).t["4pO/TY"];
  }
  obj45[1] = CP2sz4;
  obj45[2] = constants4.MANAGE_EVENTS;
  obj[str38] = obj45;
  ...
  obj46[1] = sPoBLa;
  obj46[2] = constants4.CREATE_EVENTS;
  obj[str39] = obj46;
  ...
  obj47[2] = constants4.SET_VOICE_CHANNEL_STATUS;
  obj[str40] = obj47;
  return obj;
};