...
class MessageCacheStats {
  constructor() {
    merged = Object.assign({
      channelsFetchStarted: null,
      channelsFetchedWithLocalMessages: null,
      channelsFetchedNetwork: null,
      fetchLogs: null,
    });
    set = new Set();
    merged[0] = set;
...
prototype["recordChannelFetchedNetwork"] = function recordChannelFetchedNetwork(
  channelId,
  timestamp,
  before,
  after,
