...
import _modDef8087 from "../../../../../_runtime/metro/08087__.js";
...
function ShareActivityLogsButton() {
  ...
  let obj = {
    onPress: callback,
    icon: collapsedCategories(TableRowIcon.TableRowIcon, { IconComponent: WrenchIcon.WrenchIcon, source: _modDef8087 }),
    label: null,
    trailing: null,
  };
  let intl = util.intl;
