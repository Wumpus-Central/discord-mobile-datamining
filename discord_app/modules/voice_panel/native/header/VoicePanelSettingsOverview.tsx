...
function ShareActivityLogsButton() {
  ...
  let obj = { onPress: callback, icon: collapsedCategories(TableRowIcon.TableRowIcon, { IconComponent: WrenchIcon.WrenchIcon, source: _modDef8762 }), label: null, trailing: null };
  let intl = util.intl;
