  ...
  if (obj2.useShowStageMusicMuteButton(channelId)) {
    ...
    if (speaker) {
      ...
      obj = {
        ...
        icon: importDefault(stateFromStores ? 9942 : 9944),
        onPress() {
...
let closure_32 = noop.memo((isHeaderHidden) => {
  ...
  obj = { withSpring: isHeaderHidden(focused[21]).withSpring, showHeaderBlur: derivedValue, HEADER_CHANGE_PHYSICS: createStyles };
  fn3.__closure = obj;
...
export default noop.memo(function VoicePanelHeader(wrapperOffset) {
  ...
  obj = { calculateVoicePanelHeaderSpecs: gestureState(channelId[39]), safeArea, edgeGutter: token, mode, VoicePanelModes, gestureState, connected, EDGE_GUTTER };
  he.__closure = obj;
  ...
  obj3 = { calculateVoicePanelHeaderSpecs: gestureState(channelId[39]), safeArea, edgeGutter: token, withTiming: wrapperOffset(channelId[40]).withTiming, isHeaderHidden: derivedValue1, OPACITY_TIMING, withSpring: wrapperOffset(channelId[21]).withSpring, MODE_CHANGE_PHYSICS: DOWN };
  Se.__closure = obj3;
