    ...
    const obj3 = {
      ...
      children: availableDevices.map((deviceId) => {
        const obj = {
          ...
          icon: closure_1_11(availableDevices(5828).TableRowIcon, {
            source: availableDevices(9904).audioDeviceToIconMap[deviceId.simpleDeviceType],
          }),
          label: null,
          subLabel: null,
        };
        ...
        return closure_1_11(availableDevices(5905).TableRadioRow, obj, deviceId.deviceId);
      }),
    };
...
function VoicePanelAudioConsoleSection(channel) {
  ...
  const tmp8 = !channel(4576).useIsDismissibleContentDismissed_UNSAFE(
    channel(2027).DismissibleContent.DONUT_MOBILE_NUX,
  );
