    ...
    const obj3 = {
      ...
      children: availableDevices.map((deviceId) => {
        const obj = {
          ...
          icon: closure_1_11(availableDevices(5699).TableRowIcon, {
            source: availableDevices(9236).audioDeviceToIconMap[deviceId.simpleDeviceType],
          }),
          label: null,
          subLabel: null,
        };
        ...
        return closure_1_11(availableDevices(5776).TableRadioRow, obj, deviceId.deviceId);
      }),
    };
...
function VoicePanelAudioConsoleSection(channel) {
  ...
  const tmp8 = !channel(4460).useIsDismissibleContentDismissed_UNSAFE(
