    ...
    const obj3 = {
      ...
      children: availableDevices.map((deviceId) => {
        const obj = {
          ...
          icon: closure_1_11(availableDevices(5918).TableRowIcon, {
            source: availableDevices(9086).audioDeviceToIconMap[deviceId.simpleDeviceType],
          }),
          label: null,
          subLabel: null,
        };
        ...
        return closure_1_11(availableDevices(5995).TableRadioRow, obj, deviceId.deviceId);
      }),
    };
...
function VoicePanelAudioConsoleSection(channel) {
  ...
  const tmp8 = !channel(4651).useIsDismissibleContentDismissed_UNSAFE(
