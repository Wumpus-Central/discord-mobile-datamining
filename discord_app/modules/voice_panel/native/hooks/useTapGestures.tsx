...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    const Gesture3 = current(6899).Gesture;
    ...
    const Gesture4 = current(6899).Gesture;
    ...
    fn3.__closure = {
      runOnJS: current(4493).runOnJS,
      triggerHapticFeedback: current(4725).triggerHapticFeedback,
      HapticFeedbackTypes: current(4725).HapticFeedbackTypes,
      handleEvent,
    };
