...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    const Gesture3 = current(6760).Gesture;
    ...
    const Gesture4 = current(6760).Gesture;
    ...
    fn3.__closure = {
      ...
      triggerHapticFeedback: current(4607).triggerHapticFeedback,
      HapticFeedbackTypes: current(4607).HapticFeedbackTypes,
      handleEvent,
    };
