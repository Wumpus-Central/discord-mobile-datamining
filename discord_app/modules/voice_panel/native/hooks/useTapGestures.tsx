...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    const Gesture3 = current(6848).Gesture;
    ...
    const Gesture4 = current(6848).Gesture;
    ...
    fn3.__closure = {
      runOnJS: current(4458).runOnJS,
      triggerHapticFeedback: current(4690).triggerHapticFeedback,
      HapticFeedbackTypes: current(4690).HapticFeedbackTypes,
      handleEvent,
    };
