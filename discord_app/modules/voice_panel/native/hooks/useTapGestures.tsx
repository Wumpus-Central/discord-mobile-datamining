...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    const Gesture3 = current(6073).Gesture;
    ...
    const Gesture4 = current(6073).Gesture;
    ...
    fn3.__closure = {
      runOnJS: current(4566).runOnJS,
      triggerHapticFeedback: current(4801).triggerHapticFeedback,
      HapticFeedbackTypes: current(4801).HapticFeedbackTypes,
      handleEvent,
    };
