...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    obj = { runOnJS: current(4343).runOnJS, handleEvent };
    fn.__closure = obj;
    ...
    const Gesture3 = current(6726).Gesture;
    ...
    const obj1 = { runOnJS: current(4343).runOnJS, handleEvent };
    const Gesture4 = current(6726).Gesture;
    ...
    fn3.__closure = {
      runOnJS: current(4343).runOnJS,
      triggerHapticFeedback: current(4574).triggerHapticFeedback,
      HapticFeedbackTypes: current(4574).HapticFeedbackTypes,
      handleEvent,
    };
