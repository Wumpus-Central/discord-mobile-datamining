...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    const Gesture3 = current(6983).Gesture;
    ...
    const Gesture4 = current(6983).Gesture;
    ...
    fn3.__closure = {
      runOnJS: current(4559).runOnJS,
      triggerHapticFeedback: current(4795).triggerHapticFeedback,
      HapticFeedbackTypes: current(4795).HapticFeedbackTypes,
      handleEvent,
    };
