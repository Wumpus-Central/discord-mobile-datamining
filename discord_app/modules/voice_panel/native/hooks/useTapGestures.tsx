...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    const Gesture3 = current(6763).Gesture;
    ...
    const Gesture4 = current(6763).Gesture;
    ...
    fn3.__closure = {
      runOnJS: current(4374).runOnJS,
      triggerHapticFeedback: current(4606).triggerHapticFeedback,
      HapticFeedbackTypes: current(4606).HapticFeedbackTypes,
      handleEvent,
    };
