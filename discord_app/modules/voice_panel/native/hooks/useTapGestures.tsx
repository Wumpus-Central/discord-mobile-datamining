...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    const Gesture3 = current(6766).Gesture;
    ...
    const Gesture4 = current(6766).Gesture;
    ...
    fn3.__closure = {
      runOnJS: current(4376).runOnJS,
      triggerHapticFeedback: current(4608).triggerHapticFeedback,
      HapticFeedbackTypes: current(4608).HapticFeedbackTypes,
      handleEvent,
    };
