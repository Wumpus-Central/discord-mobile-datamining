...
export default function useTapGestures(onSingleTap) {
  ...
  return noop.useMemo(() => {
    ...
    const Gesture3 = current(6068).Gesture;
    ...
    const Gesture4 = current(6068).Gesture;
    ...
    fn3.__closure = {
      runOnJS: current(4563).runOnJS,
      triggerHapticFeedback: current(4797).triggerHapticFeedback,
      HapticFeedbackTypes: current(4797).HapticFeedbackTypes,
      handleEvent,
    };
