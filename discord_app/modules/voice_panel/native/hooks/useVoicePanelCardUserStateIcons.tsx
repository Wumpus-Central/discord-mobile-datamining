// === Module 17581: useVoicePanelCardUserStateIcons ===
...
import VoicePanelFloatingCTAUtils from "VoicePanelFloatingCTAUtils" /* 17529 */;
...
export default function useVoicePanelCardUserStateIcons(type, id, guildId) {
  ...
  if (showTileVolumeIndicator) {
    showTileVolumeIndicator = 0 === tmp2Result(tmp13, tmp4(4812).MediaEngineContextTypes.STREAM).effectiveVolume;
  }
  if (showTileVolumeIndicator) {
  ...
  callback1 = obj.useCallback(() => {
    const obj2 = {
      ...
      icon() {
        return stateFromStores1(type(6854).CircleErrorIcon, { size: "xs", color: id(576).colors.STATUS_WARNING });
      },
      content: null
    };
    const intl = type(_null[16]).intl;
    obj2.content = intl.string(type(_null[16]).t.HFwRpk);
      ...
      if (closure_0 === ParticipantTypes.STREAM) {
        ...
        if (null != muteDeafenIconState) {
          let obj5 = {
            ...
            onPress() {
                    if (closure_0(9946).MuteDeafenIconState.DEAFENED_SERVER === muteDeafenIconState) {
                      ...
                      closure_1(4455).open(obj2);
                      const obj7 = closure_1(4455);
                    } else if (closure_0(9946).MuteDeafenIconState.DEAFENED === muteDeafenIconState) {
                      const obj4 = { key: null, content: null };
                      const _HermesInternal3 = HermesInternal;
                      obj4.key = "" + id + "-status";
                      const intl3 = closure_0(1115).intl;
                      obj4.content = intl3.string(closure_0(1115).t.NjmiOL);
                      closure_1(4455).open(obj4);
                      const obj5 = closure_1(4455);
                    } else if (closure_0(9946).MuteDeafenIconState.MUTED_SERVER === muteDeafenIconState) {
                      const obj6 = { key: null, content: null };
                      const _HermesInternal2 = HermesInternal;
                      obj6.key = "" + id + "-status";
                      const intl2 = closure_0(1115).intl;
                      obj6.content = intl2.string(closure_0(1115).t.uLddbQ);
                      closure_1(4455).open(obj6);
                      const obj3 = closure_1(4455);
                    } else if (closure_0(9946).MuteDeafenIconState.MUTED_LOCAL === muteDeafenIconState) {
                      const obj8 = { key: null, content: null };
                      const _HermesInternal = HermesInternal;
                      obj8.key = "" + id + "-status";
                      const intl = closure_0(1115).intl;
                      obj8.content = intl.string(closure_0(1115).t.Q8Uzof);
                      closure_1(4455).open(obj8);
                      const obj = closure_1(4455);
                    } else if (closure_0(9946).MuteDeafenIconState.MUTED === muteDeafenIconState) {
                      ...
                      closure_1(4455).open(obj10);
                      const obj9 = closure_1(4455);
                    }
                  }
          };
          items1.push(obj5);
