// === Module 17570: useVoicePanelCardUserStateIcons ===
...
export default function useVoicePanelCardUserStateIcons(type, id, guildId) {
  ...
  callback1 = obj.useCallback(() => {
    const obj2 = {
      ...
      icon() {
        return stateFromStores1(type(6852).CircleErrorIcon, { size: "xs", color: id(576).colors.STATUS_WARNING });
      },
      content: null
    };
      ...
      if (closure_0 === ParticipantTypes.STREAM) {
        ...
        if (null != muteDeafenIconState) {
          let obj5 = {
            ...
            onPress() {
                    if (closure_0(9940).MuteDeafenIconState.DEAFENED_SERVER === muteDeafenIconState) {
                    ...
                    } else if (closure_0(9940).MuteDeafenIconState.DEAFENED === muteDeafenIconState) {
                    ...
                    } else if (closure_0(9940).MuteDeafenIconState.MUTED_SERVER === muteDeafenIconState) {
                    ...
                    } else if (closure_0(9940).MuteDeafenIconState.MUTED_LOCAL === muteDeafenIconState) {
                    ...
                    } else if (closure_0(9940).MuteDeafenIconState.MUTED === muteDeafenIconState) {
