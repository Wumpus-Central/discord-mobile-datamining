...
export default function useVoicePanelCardUserStateIcons(type, id, guildId) {
  ...
  callback1 = obj.useCallback(() => {
    ...
    const obj = {
      ...
      icon() {
        return stateFromStores1(type(6681).CircleErrorIcon, { size: "xs", color: id(576).colors.STATUS_WARNING });
      },
      content: null
    };
          ...
          let obj2 = {
            ...
            onPress() {
                    if (closure_0(9210).MuteDeafenIconState.DEAFENED_SERVER === muteDeafenIconState) {
                      ...
                      closure_1(4305).open(obj);
                      const obj7 = closure_1(4305);
                    } else if (closure_0(9210).MuteDeafenIconState.DEAFENED === muteDeafenIconState) {
                    ...
                    } else if (closure_0(9210).MuteDeafenIconState.MUTED_SERVER === muteDeafenIconState) {
                      let obj2 = closure_1(4305);
                      ...
                      obj2.open(obj1);
                    } else if (closure_0(9210).MuteDeafenIconState.MUTED_LOCAL === muteDeafenIconState) {
                      obj = closure_1(4305);
