...
export default function useVoicePanelCardUserStateIcons(type, id, guildId) {
  ...
  callback1 = obj.useCallback(() => {
    const obj2 = {
      ...
      icon() {
        return stateFromStores1(type(6721).CircleErrorIcon, { size: "xs", color: id(576).colors.STATUS_WARNING });
      },
      content: null
    };
        ...
        if (null != muteDeafenIconState) {
          let obj5 = {
            ...
            onPress() {
                    ...
                    } else if (closure_0(9274).MuteDeafenIconState.DEAFENED === muteDeafenIconState) {
                    ...
                    } else if (closure_0(9274).MuteDeafenIconState.MUTED_SERVER === muteDeafenIconState) {
                    ...
                    } else if (closure_0(9274).MuteDeafenIconState.MUTED_LOCAL === muteDeafenIconState) {
                    ...
                    } else if (closure_0(9274).MuteDeafenIconState.MUTED === muteDeafenIconState) {
