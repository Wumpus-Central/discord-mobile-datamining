// === Module 17710: VoicePanelPIPContent ===
...
import useProfileTileGradientDefault from "useProfileTileGradient" /* 8595 */;
...
import VoicePanelCardLayoutManager from "VoicePanelCardLayoutManager" /* 12608 */;
import VideoActionCreators from "VideoActionCreators" /* 17548 */;
import VoicePanelStreamOutputSinkStack from "VoicePanelStreamOutputSinkStack" /* 17625 */;
...
function User(participantId) {
  ...
  const surfaceDirectRendererExperiment = participantId(9771).useSurfaceDirectRendererExperiment(id1, { location: "VoicePanelPIPContent" });
  ...
  if (canRenderParticipantVideo) {
    ...
    if (null != user1) {
      const obj9 = { source: tmp3(9183).getCachedSourceFromURI(user1.getAvatarURL(guildId, 80, false)), size: null, avatarDecoration: null };
...
function Stream(participantId) {
  ...
  const surfaceDirectRendererExperiment = participantId(9771).useSurfaceDirectRendererExperiment(stateFromStoresObject.userId, { location: "VoicePanelPIPContent.Stream" });
