// === Module 16957: VoicePanelPIPContent ===
...
import VoicePanelCardLayoutManager from "VoicePanelCardLayoutManager" /* 11743 */;
import VideoActionCreators from "VideoActionCreators" /* 16795 */;
import VoicePanelStreamOutputSinkStack from "VoicePanelStreamOutputSinkStack" /* 16872 */;
...
function User(participantId) {
  ...
  const surfaceDirectRendererExperiment = participantId(8873).useSurfaceDirectRendererExperiment(id1, { location: "VoicePanelPIPContent" });
  ...
  if (canRenderParticipantVideo) {
    ...
    if (null != user1) {
      const obj9 = { source: tmp3(8281).getCachedSourceFromURI(user1.getAvatarURL(guildId, 80, false)), size: null, avatarDecoration: null };
...
function Stream(participantId) {
  ...
  const surfaceDirectRendererExperiment = participantId(8873).useSurfaceDirectRendererExperiment(stateFromStoresObject.userId, { location: "VoicePanelPIPContent.Stream" });
