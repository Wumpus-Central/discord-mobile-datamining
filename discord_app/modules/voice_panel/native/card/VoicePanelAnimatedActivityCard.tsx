...
function VoicePanelAnimatedActivityCardInner(applicationId) {
  ...
  const stateFromStoresObject = applicationId(504).useStateFromStoresObject(
    items4,
    () => ({
      gridOrientationLockState: EmbeddedActivitiesStore.getGridOrientationLockStateForApp(applicationId),
      focusedOrientationLockState: EmbeddedActivitiesStore.getOrientationLockStateForApp(applicationId),
    }),
    items5,
  );
  ...
  if (null != stateFromStores1) {
    ...
    embeddedActivityParticipantId = tmp8(9699).getEmbeddedActivityParticipantId({
      applicationId: null,
      instanceId: null,
    });
  ...
  ve.__closure = {
    runOnJS: applicationId(4561).runOnJS,
  ...
  fe.__closure = {
    ...
    ACTIVITY_LOCKED_ASPECT_RATIO: guild_id,
  ...
  if (null == stateFromStores) {
    ...
    if (tmp21) {
      ...
      const obj15 = {
        ...
        activityItem: activityShelfItemData,
