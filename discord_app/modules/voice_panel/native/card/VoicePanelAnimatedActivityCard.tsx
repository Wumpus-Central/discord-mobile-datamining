...
function VoicePanelAnimatedActivityCardInner(applicationId) {
  ...
  let obj2 = { runOnJS: applicationId(4343).runOnJS, handleTargetAspectRatioParams: callback1, gridOrientationLockState, hasJoined: tmp21, updateNotJoinedActivityDimensions: callback2 };
  class Te {
    constructor() {
      num = 0;
      if (IS_IOS) {
