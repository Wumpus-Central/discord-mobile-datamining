// === Module 17606: VoicePanelAnimatedActivityCard ===
...
function VoicePanelAnimatedActivityCardInner(applicationId) {
  ...
  if (null != stateFromStores1) {
    ...
    embeddedActivityParticipantId = tmp8(9616).getEmbeddedActivityParticipantId({ applicationId: null, instanceId: null });
