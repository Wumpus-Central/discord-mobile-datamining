...
import _modDef17246 from "module_17246" /* 17246 */;
import _modDef17247 from "module_17247" /* 17247 */;
...
let closure_27 = noop.memo((participant) => {
  ...
  let obj = { controlsHidden, FLOATING_BAR_HEIGHT: v28, VOICE_PANEL_CARD_INNER_PADDING, withSpring: participant(5024).withSpring, MODE_CHANGE_PHYSICS };
  fn.__closure = obj;
  ...
  obj = { icon: guildId(17248), onPress: callback, style: animatedStyle, layout, accessibilityLabel: null };
  ...
  if (showGameTag) {
    if (null != gameRecord) {
      if (!tmp8) {
        ...
        let tmp12 = closure_16(tmp(17252), obj);
      }
      return tmp12;
    }
  }
  tmp12 = closure_16(tmp(9253), { userId, textColor });
  const tmp4 = gameRecord(8748);
});
