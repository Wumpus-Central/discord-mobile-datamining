...
const memoResult = importAllResult.memo(function VoicePanelCard(cleanUp) {
  ...
  const obj8 = {
    isRinging: tmp8,
    avatarURI: "r",
    avatarDecoration: "channel",
    layout: 0.,
    layoutPhysics:
