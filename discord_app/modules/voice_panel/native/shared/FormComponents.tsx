...
let obj2 = {
  ...
  iconWrapper: {
    marginLeft: 8,
    padding: 6,
    backgroundColor: nativeDefault.colors.MOBILE_VOICE_PANEL_BADGE_BACKGROUND,
...
export const MemberRowItem = function MemberRowItem(user) {
  ...
  const items1 = [id];
  const stateFromStores = user(flag[16]).useStateFromStores(items1, () =>
    StreamerApplicationSelectors.getStreamerActivityByUserId(id, PresenceStore),
  );
