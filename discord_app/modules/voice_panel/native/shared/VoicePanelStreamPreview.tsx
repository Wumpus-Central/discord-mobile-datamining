...
obj = { backgroundColor: nativeDefault.colors.BACKGROUND_SCRIM, borderRadius: nativeDefault.radii.sm, marginHorizontal: nativeDefault.space.PX_16 };
...
export const VoicePanelStreamPreview = function VoicePanelStreamPreview(mode) {
  ...
  const stateFromStores = obj.useStateFromStores(items, () => {
    ...
    if (tmp2) {
      tmp2 = null == ApplicationStreamingStore.getStreamerActiveStreamMetadataForStream(StreamKeyUtils.encodeStreamKey(stream));
    }
    return tmp2;
  }, items1);
  let obj1 = mode(4343);
  ...
  obj = { mode, withTiming: mode(4607).withTiming, OPACITY_TIMING };
  T.__closure = obj;
  ...
  if (null != previewUrl) {
    ...
    tmp14 = closure_6(tmp2(4343).Image, obj1);
  }
  const items2 = [tmp14, ];
  ...
  if (stateFromStores) {
    ...
    obj4.children = closure_6(tmp8(4602).Text, obj5);
  ...
  items2[1] = closure_6(stream(7146), obj3);
  obj.children = items2;
