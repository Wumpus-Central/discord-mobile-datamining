...
function ActivityButton(participant) {
  ...
  const items1 = [closure_9(participant(8907).HeaderButton, obj), closure_9(QuestActivityButtonDefault, { applicationId: participant.applicationId })];
  obj.children = items1;
