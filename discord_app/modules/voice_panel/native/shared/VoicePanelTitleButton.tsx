...
import _modDef17354 from "../../../../../_runtime/metro/17354__.js";
...
function ChannelButtonIcons() {
  ...
  const items = [
    ...
    React7(BaseTextButton.BaseTextButton.Icon, { source: _modDef7256 }),
  ];
  obj.children = items;
...
function ActivityButton(participant) {
  ...
  const items1 = [
    closure_9(participant(9060).HeaderButton, obj3),
