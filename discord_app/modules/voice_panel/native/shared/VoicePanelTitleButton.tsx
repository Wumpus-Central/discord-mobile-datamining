...
import _modDef7249 from "../../../../../_runtime/metro/07249__.js";
...
function ChannelButtonIcons() {
  ...
  const items = [
    ...
    React7(BaseTextButton.BaseTextButton.Icon, { source: _modDef7249 }),
  ];
  obj.children = items;
...
function ActivityButton(participant) {
  ...
  const items1 = [
    closure_9(participant(9034).HeaderButton, obj3),
