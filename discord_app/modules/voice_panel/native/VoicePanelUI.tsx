...
function AnimatedWrapper(children) {
  ...
  fn3.__closure = {
    ...
    wrapperDimensions,
    updateSharedValueIfChanged: height(11488),
    wrapperOffset,
    getMaxPanelWidth: wrapperOffset(17191).getMaxPanelWidth,
    getPanelX: wrapperOffset(17191).getPanelX,
    roundToNearestPixel: height(11126),
    windowDimensions,
  };
  ...
  obj16.children = closure_21(height(7176), {
...
export default noop.memo(function VoicePanelUI() {
  ...
  const sharedValue4 = channelId(4373).useSharedValue({
    absoluteXStart: 0,
    absoluteYStart: 0,
    cancel: false,
    active: false,
  ...
  if (tmp6[0]) {
    ...
    const items9 = [closure_21(channelId(7259).LayerScope, obj27)];
    ...
    obj30.children = closure_21(channelId(6756).GestureDetector, obj31);
    obj29.children = closure_21(tmp2(7176), obj30);
    items9[1] = closure_21(channelId(6756).GestureDetector, obj29);
    ...
    obj22.children = lockScrolling(channelId(7259).LayerScope, obj23);
    tmp37 = closure_21(channelId(7265).AnalyticsLocationProvider, obj22);
