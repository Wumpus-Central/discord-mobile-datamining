...
import PanelSizeUtils from "PanelSizeUtils" /* 17162 */;
...
function AnimatedWrapper(children) {
  ...
  __closure = { useReducedMotion, wrapperDimensions, wrapperOffset, connected, mode, VoicePanelModes: animatedStyle1, runOnJS: wrapperOffset(4343).runOnJS, updateSourceTrackingView: height(9701).updateSourceTrackingView, withSpring: wrapperOffset(5025).withSpring, DRAWER_SPRING_PHYSICS_GESTURE_ACTIVE, DRAWER_SIZE_PHYSICS: obj2 };
  ...
  obj1 = { computeBorderRadii, mode, connected, wrapperDimensions, withSpring: wrapperOffset(5025).withSpring, BORDER_RADIUS_PHYSICS: windowDimensions, VoicePanelModes: animatedStyle1, styles: tmp3 };
  M.__closure = obj1;
...
scrollViewLayoutTransition.__closure = { withSpring: fn(5025).withSpring, LAYOUT_PHYSICS, EMBEDDED_ACTIVITY_ORIENTATION_UPDATE_SAFE_LAYOUT_PHYSICS: __closure };
...
let obj1 = { withSpring: fn(5025).withSpring, LAYOUT_PHYSICS, EMBEDDED_ACTIVITY_ORIENTATION_UPDATE_SAFE_LAYOUT_PHYSICS: __closure };
...
export default noop.memo(function VoicePanelUI() {
  ...
  __closure = { cheapWorkletShallowEqual: channelId(9586).cheapWorkletShallowEqual, VoicePanelModes, runOnJS: channelId(4343).runOnJS, setPanelFullscreen: callback, setPanelOpen: callback1, setPanelPIP: callback2 };
