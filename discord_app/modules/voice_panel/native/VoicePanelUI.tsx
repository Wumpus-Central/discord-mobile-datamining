...
import PanelSizeUtils from "PanelSizeUtils" /* 17173 */;
...
function AnimatedWrapper(children) {
  ...
  __closure = { useReducedMotion, wrapperDimensions, wrapperOffset, connected, mode, VoicePanelModes: animatedStyle1, runOnJS: wrapperOffset(4341).runOnJS, updateSourceTrackingView: height(9680).updateSourceTrackingView, withSpring: wrapperOffset(5024).withSpring, DRAWER_SPRING_PHYSICS_GESTURE_ACTIVE, DRAWER_SIZE_PHYSICS: obj2 };
  ...
  obj1 = { computeBorderRadii, mode, connected, wrapperDimensions, withSpring: wrapperOffset(5024).withSpring, BORDER_RADIUS_PHYSICS: windowDimensions, VoicePanelModes: animatedStyle1, styles: tmp3 };
  M.__closure = obj1;
...
scrollViewLayoutTransition.__closure = { withSpring: fn(5024).withSpring, LAYOUT_PHYSICS, EMBEDDED_ACTIVITY_ORIENTATION_UPDATE_SAFE_LAYOUT_PHYSICS: __closure };
...
let obj1 = { withSpring: fn(5024).withSpring, LAYOUT_PHYSICS, EMBEDDED_ACTIVITY_ORIENTATION_UPDATE_SAFE_LAYOUT_PHYSICS: __closure };
...
export default noop.memo(function VoicePanelUI() {
  ...
  __closure = { cheapWorkletShallowEqual: channelId(9565).cheapWorkletShallowEqual, VoicePanelModes, runOnJS: channelId(4341).runOnJS, setPanelFullscreen: callback, setPanelOpen: callback1, setPanelPIP: callback2 };
        ...
        if (!gestureState.get().active) {
          if (!gestureState.get().cancel) {
            ...
            if (flag) {
              ...
              obj = { absoluteXStart: absoluteX, absoluteYStart: absoluteY + closure_1_0.get(), cancel: false, active: true, requiresPop: gestureState.get().requiresPop };
