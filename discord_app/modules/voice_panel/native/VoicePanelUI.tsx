...
function AnimatedWrapper(children) {
  ...
  fn3.__closure = {
    cheapWorkletShallowEqual: wrapperOffset(9649).cheapWorkletShallowEqual,
    VoicePanelModes: animatedStyle1,
    wrapperDimensions,
    updateSharedValueIfChanged: height(11508),
    wrapperOffset,
    getMaxPanelWidth: wrapperOffset(17325).getMaxPanelWidth,
    getPanelX: wrapperOffset(17325).getPanelX,
    roundToNearestPixel: height(11152),
    windowDimensions,
  };
  ...
  fn4.__closure = {
    ...
    updateSourceTrackingView: height(9761).updateSourceTrackingView,
    withSpring: wrapperOffset(5061).withSpring,
  ...
  obj16.children = closure_21(height(7187), {
...
export default noop.memo(function VoicePanelUI() {
  ...
  fn2.__closure = {
    cheapWorkletShallowEqual: channelId(9649).cheapWorkletShallowEqual,
    VoicePanelModes,
          ...
          if (lockScrolling.get()) {
            ...
            if (!gestureState.get().requiresPop) {
              ...
              if (merged1 > 180) {
                ...
                channelId(4376).runOnJS(channelId(4608).triggerHapticFeedback)(
                  channelId(4608).HapticFeedbackTypes.IMPACT_MEDIUM,
                );
                diff = result;
  ...
  if (tmp6[0]) {
    ...
    const items9 = [closure_21(channelId(7270).LayerScope, obj27)];
    ...
    obj30.children = closure_21(channelId(6766).GestureDetector, obj31);
    obj29.children = closure_21(tmp2(7187), obj30);
    items9[1] = closure_21(channelId(6766).GestureDetector, obj29);
    ...
    obj22.children = lockScrolling(channelId(7270).LayerScope, obj23);
    tmp37 = closure_21(channelId(7276).AnalyticsLocationProvider, obj22);
