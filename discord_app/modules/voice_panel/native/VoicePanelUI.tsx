...
function AnimatedWrapper(children) {
  ...
  fn3.__closure = {
    cheapWorkletShallowEqual: wrapperOffset(9733).cheapWorkletShallowEqual,
    VoicePanelModes: animatedStyle1,
    wrapperDimensions,
    updateSharedValueIfChanged: height(11606),
    wrapperOffset,
    getMaxPanelWidth: wrapperOffset(17455).getMaxPanelWidth,
    getPanelX: wrapperOffset(17455).getPanelX,
    roundToNearestPixel: height(11245),
    windowDimensions,
  };
  ...
  fn4.__closure = {
    ...
    mode,
    VoicePanelModes: animatedStyle1,
    runOnJS: wrapperOffset(4458).runOnJS,
    updateSourceTrackingView: height(9855).updateSourceTrackingView,
    withSpring: wrapperOffset(5143).withSpring,
  ...
  obj16.children = closure_21(height(7269), {
...
export default noop.memo(function VoicePanelUI() {
  ...
  const sharedValue4 = channelId(4458).useSharedValue({
    absoluteXStart: 0,
    absoluteYStart: 0,
    cancel: false,
    active: false,
  ...
  fn2.__closure = {
    cheapWorkletShallowEqual: channelId(9733).cheapWorkletShallowEqual,
    VoicePanelModes,
    runOnJS: channelId(4458).runOnJS,
          ...
          if (lockScrolling.get()) {
            ...
            if (!gestureState.get().requiresPop) {
              ...
              if (merged1 > 180) {
                ...
                channelId(4458).runOnJS(channelId(4690).triggerHapticFeedback)(
                  channelId(4690).HapticFeedbackTypes.IMPACT_MEDIUM,
                );
                diff = result;
          ...
          if (velocityY > 0) {
            if (connected.get()) {
              if (gestureState.get().requiresPop) {
                ...
                channelId(4458).runOnJS(closure_1_15)(setMode.PIP);
                closure_1(11606)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
                obj4 = channelId(4458);
              }
            } else {
  ...
  Ae.__closure = {
    ...
    scrollPosition,
    scrollTo: channelId(4458).scrollTo,
  ...
  if (tmp6[0]) {
    ...
    const items9 = [closure_21(channelId(7352).LayerScope, obj27)];
    ...
    obj30.children = closure_21(channelId(6848).GestureDetector, obj31);
    obj29.children = closure_21(tmp2(7269), obj30);
    items9[1] = closure_21(channelId(6848).GestureDetector, obj29);
    ...
    obj22.children = lockScrolling(channelId(7352).LayerScope, obj23);
    tmp37 = closure_21(channelId(7358).AnalyticsLocationProvider, obj22);
