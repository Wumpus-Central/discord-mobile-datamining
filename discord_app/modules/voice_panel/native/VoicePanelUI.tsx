...
function AnimatedWrapper(children) {
  ...
  let connected;
  let animatedStyle1;
  const height = wrapperOffset(9773).useGlobalStatusIndicatorState().height;
  let tmp3 = closure_31();
  dependencyMap = tmp3;
  const context = connected.useContext(height(12529));
  ...
  const derivedValue = wrapperOffset(4493).useDerivedValue(fn);
  obj4 = wrapperOffset(17568);
  const pIPState = obj4.usePIPState();
  let obj3 = wrapperOffset(4493);
    ...
    if (!obj.cheapWorkletShallowEqual(safeAreaState, tmp3)) {
      ...
      if (modeToSet !== VoicePanelModes.PIP) {
        ...
        if (modeToSet === VoicePanelModes.PANEL) {
          ...
          tmp16(11621)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
        }
      }
    }
  ...
  let obj5 = wrapperOffset(4493);
  fn3.__closure = {
    cheapWorkletShallowEqual: wrapperOffset(9670).cheapWorkletShallowEqual,
    VoicePanelModes: animatedStyle1,
    wrapperDimensions,
    updateSharedValueIfChanged: height(11621),
    wrapperOffset,
    getMaxPanelWidth: wrapperOffset(17555).getMaxPanelWidth,
    getPanelX: wrapperOffset(17555).getPanelX,
    roundToNearestPixel: height(11265),
    windowDimensions,
  };
  ...
  const fn4 = function b() {
    ...
    obj4 = {
      translateX: obj3.withSpring(sum1, wrapperOffset.get().gestureActive ? closure_17 : obj4, str2, VoicePanelUITsx31),
    };
    const items = [obj4];
    ...
    items[1] = {
      translateY: tmp11Result.withSpring(
        sum,
        wrapperOffset.get().gestureActive ? closure_17 : obj4,
        str,
        VoicePanelUITsx31,
      ),
    };
  ...
  fn4.__closure = {
    ...
    mode,
    VoicePanelModes: animatedStyle1,
    runOnJS: wrapperOffset(4493).runOnJS,
    updateSourceTrackingView: height(9703).updateSourceTrackingView,
    withSpring: wrapperOffset(5186).withSpring,
  ...
  if (!wrapperOffset(5086).isStable) {
    class Y {
      constructor() {
    ...
    const obj12 = { runOnJS: tmp(4493).runOnJS, log };
    fn5.__closure = obj12;
    fn5.__workletHash = 5206450827682;
    fn5.__initData = __initData21;
    const animatedReaction1 = tmp(4493).useAnimatedReaction(Y, fn5);
    ...
    const obj14 = { runOnJS: tmp(4493).runOnJS, log };
    T.__closure = obj14;
    T.__workletHash = 7760779241631;
    T.__initData = __initData23;
    const animatedReaction2 = tmp(4493).useAnimatedReaction(H, T);
    let tmpResult2 = tmp(4493);
  }
  ...
  const tmp4Result = height(7320);
  obj16.children = closure_21(height(7320), {
    style: wrapperSurfaceStyles,
    layout: layoutTransition,
    children: children.children,
  });
  obj15.children = closure_21(height(7320), obj16);
...
const POP_RESISTANCE = fn(12531).POP_RESISTANCE;
const jsxProd = fn(21);
...
layoutTransition.__closure = { withSpring: fn(5186).withSpring, LAYOUT_PHYSICS };
...
let obj = { withSpring: fn(5186).withSpring, LAYOUT_PHYSICS };
scrollViewLayoutTransition.__closure = {
  withSpring: fn(5186).withSpring,
  LAYOUT_PHYSICS,
...
const __initData4 = {
  code: "function VoicePanelUITsx7(mode,previous){const{VoicePanelModes,updateSharedValueIfChanged,gestureState}=this.__closure;if(mode===VoicePanelModes.DISMISSED&&previous!==VoicePanelModes.DISMISSED){updateSharedValueIfChanged(gestureState,{cancel:false,active:false});}}",
};
const __initData5 = {
...
const __initData7 = {
  code: "function onBeginDrag_VoicePanelUITsx18(event){const{scrollPosition,dragScrolling}=this.__closure;scrollPosition.set(event.contentOffset.y);dragScrolling.set(true);}",
};
const __initData8 = {
...
const __initData12 = {
  code: "function VoicePanelUITsx23(mode,previous){const{VoicePanelModes,lockScrolling}=this.__closure;if(previous==null||mode===previous)return;if(mode===VoicePanelModes.PANEL&&previous===VoicePanelModes.PIP){lockScrolling.set(false);}else if(mode===VoicePanelModes.PIP){lockScrolling.set(true);}}",
};
const __initData13 = {
...
let closure_61 = {
  code: "function VoicePanelUITsx31(finished){const{mode,VoicePanelModes,runOnJS,updateSourceTrackingView}=this.__closure;if(finished&&mode.get()!==VoicePanelModes.DISMISSED){runOnJS(updateSourceTrackingView)();}}",
};
const __initData19 = {
  code: "function VoicePanelUITsx32(){const{computeBorderRadii,mode,connected,wrapperDimensions,withSpring,BORDER_RADIUS_PHYSICS,VoicePanelModes,styles}=this.__closure;const borderRadius=computeBorderRadii({mode:mode.get(),connected:connected.get()});return{width:wrapperDimensions.get().drawerWidth,height:wrapperDimensions.get().drawerHeight,borderRadius:withSpring(borderRadius,BORDER_RADIUS_PHYSICS),pointerEvents:mode.get()===VoicePanelModes.PANEL?'auto':'none',backgroundColor:connected.get()?'transparent':styles.maskDefaultBackground.backgroundColor};}",
};
const __initData20 = {
  code: "function VoicePanelUITsx33(){const{windowDimensions}=this.__closure;return windowDimensions.get();}",
};
const __initData21 = {
  code: "function VoicePanelUITsx34(value){const{runOnJS,log}=this.__closure;runOnJS(log)('Window dimensions changed:',JSON.stringify(value));}",
};
const __initData22 = {
  code: "function VoicePanelUITsx35(){const{wrapperDimensions}=this.__closure;return wrapperDimensions.get();}",
};
const __initData23 = {
  code: "function VoicePanelUITsx36(value){const{runOnJS,log}=this.__closure;runOnJS(log)('Wrapper dimensions changed:',JSON.stringify(value));}",
};
const DrawerShadeOpacityPhysics = { mass: 0.6, damping: 30, stiffness: 400, overshootClamping: true };
const __initData24 = {
  code: "function VoicePanelUITsx37(){const{withSpring,opacity,DrawerShadeOpacityPhysics}=this.__closure;return{opacity:withSpring(opacity.get(),DrawerShadeOpacityPhysics),pointerEvents:opacity.get()===0?'none':'auto'};}",
};
let closure_70 = noop.memo((onPress) => {
  ...
  let obj = opacity(4493);
  fn.__closure = { withSpring: opacity(5186).withSpring, opacity, DrawerShadeOpacityPhysics };
...
export default noop.memo(function VoicePanelUI() {
  ...
  const sharedValue = channelId(4493).useSharedValue(0);
  closure_129_21 = sharedValue;
  let obj = channelId(4493);
  const sharedValue1 = channelId(4493).useSharedValue(false);
  closure_129_22 = sharedValue1;
  obj2 = channelId(4493);
  const sharedValue2 = channelId(4493).useSharedValue(false);
  closure_129_23 = sharedValue2;
  let obj3 = channelId(4493);
  const sharedValue3 = channelId(4493).useSharedValue({ start: 0, end: VOICE_PANEL_CHUNK_DIVISOR });
  ...
  const animatedRef = channelId(4493).useAnimatedRef();
  closure_129_28 = animatedRef;
  let obj6 = channelId(4493);
  const sharedValue4 = channelId(4493).useSharedValue({
    absoluteXStart: 0,
    absoluteYStart: 0,
    cancel: false,
    active: false,
  ...
  const obj8 = channelId(4493);
  fn2.__closure = {
    cheapWorkletShallowEqual: channelId(9670).cheapWorkletShallowEqual,
    VoicePanelModes,
    runOnJS: channelId(4493).runOnJS,
    setPanelFullscreen: callback,
    setPanelOpen: callback1,
    setPanelPIP: callback2,
  };
  ...
  const obj12 = channelId(4493);
  Ve.__closure = { runOnJS: channelId(4493).runOnJS, handleFocusChange: callback3 };
  ...
  const memo1 = noop.useMemo(() => {
      ...
      if (connected.get()) {
        if (mode.get() !== setMode.PIP) {
          if (controlsSpecs.get().mode === wrapperDimensions.HIDDEN) {
            channelId(4493).runOnJS(showControls)({ debounce: true });
            obj2 = channelId(4493);
          } else {
            channelId(4493).runOnJS(hideControls)({ debounce: true });
            const obj = channelId(4493);
          }
        }
      }
    };
    ...
    const fn2 = function u(arg0) {
      if (!gestureState.get().cancel) {
        closure_1(11621)(wrapperOffset, { x: 0, y: 0 });
    ...
    const fn3 = function c(state, fail) {
      if (state.state === channelId(6899).State.BEGAN) {
        if (!gestureState.get().active) {
          if (!gestureState.get().cancel) {
            ...
            if (mode.get() === setMode.PANEL) {
              ...
              flag = false;
              if (tmp12) {
                channelId(4493).runOnJS(closure_1(17570))();
                flag = true;
                const tmpResult = channelId(4493);
              }
            }
            const tmp25 = closure_1(11621);
            if (flag) {
              ...
              obj2 = {
                ...
                cancel: false,
                active: true,
                requiresPop: gestureState.get().requiresPop,
              };
        ...
        if (merged1 !== setMode.PIP) {
          ...
          if (lockScrolling.get()) {
            ...
            if (!gestureState.get().requiresPop) {
              ...
              closure_1(11621)(wrapperOffset, point);
            } else {
              const _Math = Math;
              ...
              if (merged1 > 180) {
                ...
                const obj6 = channelId(4493);
                channelId(4493).runOnJS(channelId(4725).triggerHapticFeedback)(
                  channelId(4725).HapticFeedbackTypes.IMPACT_MEDIUM,
                );
                diff = result;
                const runOnJSResult = channelId(4493).runOnJS(channelId(4725).triggerHapticFeedback);
              }
            }
          ...
          closure_1(11621)(wrapperOffset, point1);
          const tmp7 = closure_1(11621);
        }
      }
    };
    ...
    const fn5 = function s() {
      ...
      closure_1(11621)(gestureState, { cancel: false, active: false });
      closure_1(11621)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
    };
    ...
    const fn6 = function n(velocityY) {
      if (!gestureState.get().cancel) {
        ...
        if (mode.get() === setMode.PIP) {
          ...
          const result = channelId(17564).calculatePIPPositionFromVelocity(obj6);
          ({ pipX, pipY } = result);
          const obj7 = { pipX, pipY };
          closure_1(11621)(wrapperDimensions, obj7);
          closure_1(11621)(wrapperOffset, { gestureActive: false });
          const obj5 = channelId(17564);
          ...
          if (velocityY > 0) {
            if (connected.get()) {
              if (gestureState.get().requiresPop) {
                ...
                channelId(4493).runOnJS(closure_1_15)(setMode.PIP);
                closure_1(11621)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
                obj4 = channelId(4493);
              }
            } else {
              ...
              if (wrapperOffset.get().y > 0.2 * diff) {
                closure_1(11621)(wrapperOffset, { gestureActive: false });
                channelId(4493).runOnJS(dismissPanel)();
                const obj3 = channelId(4493);
              } else {
                closure_1(11621)(wrapperOffset, { gestureActive: false, x: 0, y: 0 });
                const result2 = lockScrolling.set(false);
              }
    ...
    fn6.__closure = {
      ...
      setMode,
      lockScrolling,
      MIN_DISMISS_MOVE_PERCENTAGE: 0.2,
      dismissPanel,
    };
  ...
  const obj13 = { runOnJS: channelId(4493).runOnJS, handleFocusChange: callback3 };
  ...
  const obj14 = channelId(4493);
  Ae.__closure = {
    lockScrolling: sharedValue1,
    isSnappingBack: sharedValue2,
    scrollPosition,
    scrollTo: channelId(4493).scrollTo,
  ...
  const animatedReaction3 = channelId(4493).useAnimatedReaction(Te, Me);
  const obj17 = channelId(4493);
  const token = channelId(4458).useToken(nativeDefault.modules.mobile.VOICE_PANEL_GUTTER);
  closure_129_31 = token;
  const obj18 = channelId(4458);
  class Ye {
    constructor() {
  ...
  const derivedValue = channelId(4493).useDerivedValue(ke);
  ...
  if (tmp6[0]) {
    ...
    const items6 = [closure_21(tmp2(17571), {}), ,];
    ...
    const items7 = [closure_21(tmp2(17573), {}), , ,];
    ...
    obj27.children = closure_21(tmp2(17575), obj28);
    const items8 = [closure_21(channelId(7403).LayerScope, obj27)];
    ...
    const items9 = [closure_21(tmp2(17607), obj33), closure_21(tmp2(17636), {})];
    obj32.children = items9;
    obj31.children = lockScrolling(closure_32, obj32);
    obj30.children = closure_21(channelId(6899).GestureDetector, obj31);
    obj29.children = closure_21(tmp2(7320), obj30);
    items8[1] = closure_21(channelId(6899).GestureDetector, obj29);
    obj26.children = items8;
    items7[1] = lockScrolling(AnimatedWrapper, obj26);
    items7[2] = closure_21(tmp2(17640), {});
    const obj34 = { gestureState: sharedValue4 };
    items7[3] = closure_21(tmp2(17645), obj34);
    obj25.children = items7;
    items6[2] = lockScrolling(tmp2Result, obj25);
    obj23.children = items6;
    obj22.children = lockScrolling(channelId(7403).LayerScope, obj23);
    tmp35 = closure_21(channelId(7409).AnalyticsLocationProvider, obj22);
