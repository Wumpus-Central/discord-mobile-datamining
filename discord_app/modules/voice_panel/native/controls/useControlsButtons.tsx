// === Module 16762: useControlsButtons ===

// Module 16762 (useControlsButtons)
import PTTButton from "PTTButton" /* 16763 */;
import ConnectButtonDefault from "ConnectButton" /* 16766 */;
import ChatButtonDefault from "ChatButton" /* 16772 */;
import DisconnectCancelButtonDefault from "DisconnectCancelButton" /* 16774 */;
import VideoButtonRiveDefault from "VideoButtonRive" /* 16776 */;
import SoundboardButtonDefault from "SoundboardButton" /* 16778 */;
import MobilePhoneShareIconDefault from "MobilePhoneShareIcon" /* 16780 */;
import VoicePanelDrawerToggleButtonDefault from "VoicePanelDrawerToggleButton" /* 16783 */;
...
export default function useControlsButtons() {
  const context = treatment.useContext(safeArea(11839));
  const windowDimensions = context.windowDimensions;
  safeArea = context.safeArea;
  const tmp2 = safeArea(16618)(context.channelId);
  dependencyMap = tmp2;
  ...
  const tmp5 = safeArea(8569)(derivedValue);
  closure_5 = tmp5;
  ...
  return treatment.useMemo(() => {
    ...
    const mapped = (function getButtons(closure_2, stateFromStores, treatment) {
      ...
      if (closure_2) {
        ...
        if (treatment === callback(16682).MobileGoLiveEntrypointTreatment.SCREENSHARE_REPLACES_CHAT) {
        ...
        if (treatment === tmp10(16682).MobileGoLiveEntrypointTreatment.SCREENSHARE_REPLACES_SOUNDBOARD) {
