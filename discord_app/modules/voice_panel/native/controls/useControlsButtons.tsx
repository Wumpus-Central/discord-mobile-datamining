...
export default function useControlsButtons() {
  ...
  fn.__closure = {
    getControlsDefaultWidth: windowDimensions(12431).getControlsDefaultWidth,
    windowDimensions,
    safeArea,
  };
  ...
  return treatment.useMemo(() => {
    ...
    const mapped = (function getButtons(dependencyMap, stateFromStores, treatment) {
      ...
      if (dependencyMap) {
        ...
        if (treatment === _true(17347).MobileGoLiveEntrypointTreatment.SCREENSHARE_REPLACES_SOUNDBOARD) {
