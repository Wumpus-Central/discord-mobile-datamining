...
export default function useControlsButtons() {
  ...
  fn.__closure = {
    getControlsDefaultWidth: windowDimensions(12414).getControlsDefaultWidth,
    windowDimensions,
    safeArea,
  };
  ...
  return treatment.useMemo(() => {
    ...
    const mapped = (function getButtons(dependencyMap, stateFromStores, treatment) {
      ...
      if (dependencyMap) {
        ...
        if (treatment === _true(17250).MobileGoLiveEntrypointTreatment.SCREENSHARE_REPLACES_SOUNDBOARD) {
