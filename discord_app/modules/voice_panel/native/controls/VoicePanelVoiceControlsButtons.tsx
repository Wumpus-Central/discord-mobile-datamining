...
import SoundboardIcon from "SoundboardIcon" /* 12621 */;
...
export const DeafenSwitch = function DeafenSwitch() {
  ...
  obj.icon = jsx(TableRowIcon.TableRowIcon, { IconComponent: HeadphonesSlashIcon.HeadphonesSlashIcon, source: _modDef17199 });
  const intl = util.intl;
  ...
  return jsx(TableSwitchRow.TableSwitchRow, { IconComponent: HeadphonesSlashIcon.HeadphonesSlashIcon, source: _modDef17199 });
};
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj.icon = jsx(channelId(5662).TableRowIcon, { IconComponent: channelId(10199).VideoIcon, source: stateFromStores(10041) });
  ...
  return jsx(channelId(7273).TableSwitchRow, { IconComponent: channelId(10199).VideoIcon, source: stateFromStores(10041) });
};
