...
import registerAssetDefault3 from "../../../../../_runtime/11230_registerAsset.js";
...
import registerAssetDefault4 from "../../../../../_runtime/16932_registerAsset.js";
import registerAssetDefault5 from "../../../../../_runtime/16933_registerAsset.js";
...
import voiceSettings from "../../../video_calls/native/ChannelCallUtils.tsx";
...
import { SelfStreamAndVideoAlertType as closure_15 } from "../../../calls/HideSelfStreamAndVideoConstants.tsx";
...
export const GameConsoles = function GameConsoles(arg0) {
  ...
  if (arr.length > 0) {
    ...
    obj[2] = arr.map((account) =>
      closure_1_17(closure_1_18, { account, channel: closure_0, connected: closure_1 }, account.type),
    );
...
export const ActivitiesButton = function ActivitiesButton(openTab) {
  ...
  const callback = React.useCallback(() => {
    ...
    const timerId = setTimeout(() => {
      callback({
        tab: "app_launcher",
        source: closure_1_0(closure_1_2[28]).VoicePanelTabAnalyticsSources.VOICE_CONTROLS,
      });
    }, 200);
  }, items);
...
export const ScreenshareButton = function ScreenshareButton(channel) {
  ...
  return jsx(onPress(5607).TableRow, {
    disabled: !isFeatureEnabled,
    onPress: callback,
    icon: jsx(onPress(5613).TableRowIcon, { source: imgSource }),
    label: text,
  });
};
...
export const DeafenSwitch = function DeafenSwitch() {
  ...
  obj[0] = jsx(TableRowIcon.TableRowIcon, {
    IconComponent: HeadphonesSlashIcon.HeadphonesSlashIcon,
    source: registerAssetDefault5,
  });
  const intl = getSystemLocale.intl;
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj[0] = jsx(channelId(5613).TableRowIcon, {
    IconComponent: channelId(10215).VideoIcon,
    source: stateFromStores(10063),
  });
  ...
  return jsx(channelId(6001).TableSwitchRow, {
    IconComponent: channelId(10215).VideoIcon,
    source: stateFromStores(10063),
  });
};
...
export const VoiceSettingsButton = function VoiceSettingsButton(guildId) {
  ...
  obj[1] = jsx(guildId(5613).TableRowIcon, {
    IconComponent: guildId(6249).SettingsIcon,
