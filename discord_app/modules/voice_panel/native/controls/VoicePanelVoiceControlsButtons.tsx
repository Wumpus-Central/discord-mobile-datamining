...
export const ActivitiesButton = function ActivitiesButton(openTab) {
  ...
  obj = { IconComponent: openTab(5156).AppsIcon };
  obj.icon = jsx(openTab(5661).TableRowIcon, { IconComponent: openTab(5156).AppsIcon });
  const intl = openTab(1114).intl;
  obj.label = intl.string(openTab(1114).t.aeuOoh);
  return jsx(openTab(5655).TableRow, { IconComponent: openTab(5156).AppsIcon });
};
export const ChatButton = function ChatButton(openTab) {
  ...
  let obj = { onPress: callback, icon: null, label: null };
  obj = { IconComponent: openTab(5121).ChatIcon };
  obj.icon = jsx(openTab(5661).TableRowIcon, { IconComponent: openTab(5121).ChatIcon });
  const intl = openTab(1114).intl;
  obj.label = intl.string(openTab(1114).t["5KxXrK"]);
  return jsx(openTab(5655).TableRow, { IconComponent: openTab(5121).ChatIcon });
};
...
export const DeafenSwitch = function DeafenSwitch() {
  ...
  obj = { IconComponent: HeadphonesSlashIcon.HeadphonesSlashIcon, source: _modDef17210 };
  obj.icon = jsx(TableRowIcon.TableRowIcon, { IconComponent: HeadphonesSlashIcon.HeadphonesSlashIcon, source: _modDef17210 });
  const intl = util.intl;
  ...
  return jsx(TableSwitchRow.TableSwitchRow, { IconComponent: HeadphonesSlashIcon.HeadphonesSlashIcon, source: _modDef17210 });
};
  ...
  if (!tmp5) {
    ...
    if (canInviteMembers) {
      ...
      if (channel.connected) {
        ...
        obj = { IconComponent: GroupPlusIcon.GroupPlusIcon, source: _modDef10071 };
        obj.icon = jsx(TableRowIcon.TableRowIcon, { IconComponent: GroupPlusIcon.GroupPlusIcon, source: _modDef10071 });
        const intl = util.intl;
        obj.label = intl.string(util.t["f1+QIK"]);
        obj.trailing = jsx(TableRowArrow.TableRowArrow, {});
        tmp8 = jsx(TableRow.TableRow, { IconComponent: GroupPlusIcon.GroupPlusIcon, source: _modDef10071 });
      }
    }
  }
  return tmp8;
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj = { icon: null, accessibilityHint: null, value: null, onValueChange: null, label: null, subLabel: null };
  obj = { IconComponent: channelId(10180).VideoIcon, source: stateFromStores(10020) };
  obj.icon = jsx(channelId(5661).TableRowIcon, { IconComponent: channelId(10180).VideoIcon, source: stateFromStores(10020) });
  ...
  return jsx(channelId(7252).TableSwitchRow, { IconComponent: channelId(10180).VideoIcon, source: stateFromStores(10020) });
};
export const HideSelfVideo = function HideSelfVideo() {
  ...
  if (tmp3[0]) {
    ...
    obj = { IconComponent: tmp5(9447).UserSquareIcon };
    obj.icon = jsx(tmp5(5661).TableRowIcon, { IconComponent: tmp5(9447).UserSquareIcon });
    obj.value = !tmp4;
    ...
    tmp6 = jsx(tmp5(7252).TableSwitchRow, { IconComponent: tmp5(9447).UserSquareIcon });
  }
  return tmp6;
};
export const LeaveActivitiesButton = function LeaveActivitiesButton() {
  let obj = { icon: null, label: null, onPress: null };
  obj = { source: _modDef11445 };
  obj.icon = jsx(TableRowIcon.TableRowIcon, { source: _modDef11445 });
  const intl = util.intl;
  ...
  return jsx(TableRow.TableRow, { source: _modDef11445 });
};
...
export const ToggleShowActivitiesDebugOverlay = function ToggleShowActivitiesDebugOverlay() {
  ...
  obj = { icon: null, value: null, onValueChange: null, label: null };
  obj = { source: _modDef8697 };
  obj.icon = jsx(TableRowIcon.TableRowIcon, { source: _modDef8697 });
  obj.value = stateFromStores;
  ...
  return jsx(TableSwitchRow.TableSwitchRow, { source: _modDef8697 });
};
export const VoiceSettingsButton = function VoiceSettingsButton(guildId) {
  ...
  obj = { IconComponent: guildId(7432).SettingsIcon, source: _modDef17209 };
  obj.icon = jsx(guildId(5661).TableRowIcon, { IconComponent: guildId(7432).SettingsIcon, source: _modDef17209 });
  ...
  return jsx(guildId(5655).TableRow, { IconComponent: guildId(7432).SettingsIcon, source: _modDef17209 });
};
