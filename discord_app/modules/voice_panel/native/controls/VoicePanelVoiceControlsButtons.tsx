...
import _modDef11405 from "../../../../../_runtime/metro/11405__.js";
...
export const ScreenshareButton = function ScreenshareButton(channel) {
  ...
  return jsx(onPress(5619).TableRow, {
    disabled: !isFeatureEnabled,
    onPress: callback,
    icon: jsx(onPress(5625).TableRowIcon, { source: imgSource }),
    label: text,
  });
};
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj.icon = jsx(channelId(5625).TableRowIcon, {
    IconComponent: channelId(10142).VideoIcon,
    source: stateFromStores(9982),
  });
  ...
  return jsx(channelId(7214).TableSwitchRow, {
    IconComponent: channelId(10142).VideoIcon,
    source: stateFromStores(9982),
  });
};
