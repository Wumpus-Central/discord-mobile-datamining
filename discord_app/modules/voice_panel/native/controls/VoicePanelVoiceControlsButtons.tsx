...
import registerAssetDefault3 from "../../../../../_runtime/11010_registerAsset.js";
...
import registerAssetDefault4 from "../../../../../_runtime/16697_registerAsset.js";
import registerAssetDefault5 from "../../../../../_runtime/16698_registerAsset.js";
...
export const ScreenshareButton = function ScreenshareButton(channel) {
  ...
  return jsx(onPress(5599).TableRow, {
    disabled: !isFeatureEnabled,
    onPress: callback,
    icon: jsx(onPress(5605).TableRowIcon, { source: imgSource }),
    label: text,
  });
};
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj[0] = jsx(channelId(5605).TableRowIcon, {
    IconComponent: channelId(10193).VideoIcon,
    source: stateFromStores(10041),
  });
  ...
  return jsx(channelId(5993).TableSwitchRow, {
    IconComponent: channelId(10193).VideoIcon,
    source: stateFromStores(10041),
  });
};
...
export const VoiceSettingsButton = function VoiceSettingsButton(guildId) {
  ...
  obj[1] = jsx(guildId(5605).TableRowIcon, {
    IconComponent: guildId(6240).SettingsIcon,
