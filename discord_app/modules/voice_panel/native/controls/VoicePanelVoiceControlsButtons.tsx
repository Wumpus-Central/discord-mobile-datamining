...
import _modDef17362 from "../../../../../_runtime/metro/17362__.js";
import _modDef17363 from "../../../../../_runtime/metro/17363__.js";
...
export const ActivitiesButton = function ActivitiesButton(openTab) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(openTab(5699).TableRowIcon, { IconComponent: openTab(5193).AppsIcon }),
    label: null,
  };
  const intl = openTab(1115).intl;
  obj.label = intl.string(openTab(1115).t.aeuOoh);
  return jsx(openTab(5693).TableRow, {
    onPress: callback,
    icon: jsx(openTab(5699).TableRowIcon, { IconComponent: openTab(5193).AppsIcon }),
    label: null,
  });
...
export const ChatButton = function ChatButton(openTab) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(openTab(5699).TableRowIcon, { IconComponent: openTab(5158).ChatIcon }),
    label: null,
  };
  const intl = openTab(1115).intl;
...
export const ScreenshareButton = function ScreenshareButton(channel) {
  ...
  return jsx(onPress(5693).TableRow, {
    disabled: !isFeatureEnabled,
    onPress: callback,
    icon: jsx(onPress(5699).TableRowIcon, { source: imgSource }),
    label: text,
  });
};
  ...
  if (!tmp5) {
    ...
    if (canInviteMembers) {
      ...
      if (channel.connected) {
        ...
        const obj3 = { IconComponent: GroupPlusIcon.GroupPlusIcon, source: _modDef10151 };
        obj2.icon = jsx(TableRowIcon.TableRowIcon, {
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj2.icon = jsx(channelId(5699).TableRowIcon, {
    IconComponent: channelId(10259).VideoIcon,
    source: stateFromStores(10101),
  });
  ...
  return jsx(channelId(7314).TableSwitchRow, {
    icon: null,
    accessibilityHint: null,
    value: null,
    onValueChange: null,
...
export const LeaveActivitiesButton = function LeaveActivitiesButton() {
  ...
  return jsx(TableRow.TableRow, {
    icon: jsx(TableRowIcon.TableRowIcon, { source: _modDef11527 }),
    label: null,
    onPress: null,
  });
};
...
export const VoiceSettingsButton = function VoiceSettingsButton(guildId) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(guildId(5699).TableRowIcon, { IconComponent: guildId(7494).SettingsIcon, source: _modDef17362 }),
    label: null,
    subLabel: null,
    trailing: null,
  };
  ...
  return jsx(guildId(5693).TableRow, {
    onPress: callback,
    icon: jsx(guildId(5699).TableRowIcon, { IconComponent: guildId(7494).SettingsIcon, source: _modDef17362 }),
    label: null,
    subLabel: null,
