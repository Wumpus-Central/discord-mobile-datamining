...
import _modDef17228 from "../../../../../_runtime/metro/17228__.js";
...
export const ActivitiesButton = function ActivitiesButton(openTab) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(openTab(5692).TableRowIcon, { IconComponent: openTab(5187).AppsIcon }),
    label: null,
  };
  const intl = openTab(1114).intl;
  obj.label = intl.string(openTab(1114).t.aeuOoh);
  return jsx(openTab(5686).TableRow, {
    onPress: callback,
    icon: jsx(openTab(5692).TableRowIcon, { IconComponent: openTab(5187).AppsIcon }),
    label: null,
  });
...
export const ChatButton = function ChatButton(openTab) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(openTab(5692).TableRowIcon, { IconComponent: openTab(5152).ChatIcon }),
    label: null,
  };
  const intl = openTab(1114).intl;
  ...
  if (!tmp5) {
    ...
    if (canInviteMembers) {
      ...
      if (channel.connected) {
        ...
        const obj3 = { IconComponent: GroupPlusIcon.GroupPlusIcon, source: _modDef10130 };
        obj2.icon = jsx(TableRowIcon.TableRowIcon, {
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj2.icon = jsx(channelId(5692).TableRowIcon, {
...
export const LeaveActivitiesButton = function LeaveActivitiesButton() {
  ...
  return jsx(TableRow.TableRow, {
    icon: jsx(TableRowIcon.TableRowIcon, { source: _modDef11507 }),
    label: null,
    onPress: null,
  });
};
...
export const VoiceSettingsButton = function VoiceSettingsButton(guildId) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(guildId(5692).TableRowIcon, { IconComponent: guildId(7483).SettingsIcon, source: _modDef17227 }),
    label: null,
    subLabel: null,
    trailing: null,
  };
  ...
  return jsx(guildId(5686).TableRow, {
    onPress: callback,
    icon: jsx(guildId(5692).TableRowIcon, { IconComponent: guildId(7483).SettingsIcon, source: _modDef17227 }),
    label: null,
    subLabel: null,
