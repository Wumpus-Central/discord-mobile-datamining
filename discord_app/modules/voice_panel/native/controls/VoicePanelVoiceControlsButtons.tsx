...
import _modDef17209 from "../../../../../_runtime/metro/17209__.js";
import _modDef17210 from "../../../../../_runtime/metro/17210__.js";
...
export const ScreenshareButton = function ScreenshareButton(channel) {
  ...
  return jsx(onPress(5655).TableRow, {
    disabled: !isFeatureEnabled,
    onPress: callback,
    icon: jsx(onPress(5661).TableRowIcon, { source: imgSource }),
    label: text,
  });
};
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj.icon = jsx(channelId(5661).TableRowIcon, {
    IconComponent: channelId(10180).VideoIcon,
    source: stateFromStores(10020),
  });
  ...
  return jsx(channelId(7252).TableSwitchRow, {
    IconComponent: channelId(10180).VideoIcon,
    source: stateFromStores(10020),
  });
};
