...
import _modDef17684 from "../../../../../_runtime/metro/17684__.js";
import _modDef17685 from "../../../../../_runtime/metro/17685__.js";
...
export const ActivitiesButton = function ActivitiesButton(openTab) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(openTab(5916).TableRowIcon, { IconComponent: openTab(5366).AppsIcon }),
    label: null,
  };
  const intl = openTab(1115).intl;
  obj.label = intl.string(openTab(1115).t.aeuOoh);
  return jsx(openTab(5910).TableRow, {
    onPress: callback,
    icon: jsx(openTab(5916).TableRowIcon, { IconComponent: openTab(5366).AppsIcon }),
    label: null,
  });
...
export const ChatButton = function ChatButton(openTab) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(openTab(5916).TableRowIcon, { IconComponent: openTab(5377).ChatIcon }),
    label: null,
  };
  const intl = openTab(1115).intl;
...
export const ScreenshareButton = function ScreenshareButton(channel) {
  ...
  return jsx(onPress(5910).TableRow, {
    disabled: !isFeatureEnabled,
    onPress: callback,
    icon: jsx(onPress(5916).TableRowIcon, { source: imgSource }),
    label: text,
  });
};
  ...
  if (!tmp5) {
    ...
    if (canInviteMembers) {
      ...
      if (channel.connected) {
        ...
        const obj3 = { IconComponent: GroupPlusIcon.GroupPlusIcon, source: _modDef10348 };
        obj2.icon = jsx(TableRowIcon.TableRowIcon, {
...
export const HideNonVideoParticipants = function HideNonVideoParticipants(channelId) {
  ...
  obj2.icon = jsx(channelId(5916).TableRowIcon, {
    IconComponent: channelId(10456).VideoIcon,
    source: stateFromStores(10299),
  });
  ...
  return jsx(channelId(7533).TableSwitchRow, {
    icon: null,
    accessibilityHint: null,
    value: null,
    onValueChange: null,
...
export const LeaveActivitiesButton = function LeaveActivitiesButton() {
  ...
  return jsx(TableRow.TableRow, {
    icon: jsx(TableRowIcon.TableRowIcon, { source: _modDef11722 }),
    label: null,
    onPress: null,
  });
};
...
export const VoiceSettingsButton = function VoiceSettingsButton(guildId) {
  ...
  const obj = {
    onPress: callback,
    icon: jsx(guildId(5916).TableRowIcon, { IconComponent: guildId(7710).SettingsIcon, source: _modDef17684 }),
    label: null,
    subLabel: null,
    trailing: null,
  };
  ...
  return jsx(guildId(5910).TableRow, {
    onPress: callback,
    icon: jsx(guildId(5916).TableRowIcon, { IconComponent: guildId(7710).SettingsIcon, source: _modDef17684 }),
    label: null,
    subLabel: null,
