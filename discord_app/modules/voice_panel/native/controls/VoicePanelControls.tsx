...
let closure_25 = importAllResult.memo((openTab) => {
  ...
  let handlePress;
  const tmp = callback2();
  const tmp2 = require("useDrawerToggle.tsx")(openTab.openTab);
  ({ handlePress, accessibilityLabel, ariaHidden } = tmp2);
  return callback(closure_5, { style: tmp.actionSheetDragHandleWrapper, children: callback(require("../../../../design/components/experimental/native.tsx") /* TwinButtons */.ActionSheetDragHandle, { onPress: handlePress, overlay: true, accessibilityLabel, "aria-hidden": ariaHidden }) });
});
...
const memoResult = importAllResult.memo(function VoicePanelControls(gestureState) {
  ...
  const tmp12 = isScreenReaderEnabled1(15981)(channelId);
  let obj2 = sharedValue1(16016);
  ...
  let tmp15 = isScreenReaderEnabled1(16143)();
  closure_12 = tmp15;
  ...
  const tmp28 = isScreenReaderEnabled1(16039)();
  c14 = tmp28;
  ...
  const tmp33 = isScreenReaderEnabled1(14956)({ ignoreKeyboard: true });
  dependencyMap = tmp33;
  ...
  const items5 = [callback(isScreenReaderEnabled1(16144), { wrapperSpecs: sharedValue1 }), callback(closure_37, { channelId, wrapperSpecs: sharedValue1, controlsSpecs, accessoryHeights: tmp15, gestureState }), ];
  ...
  const tmp46 = isScreenReaderEnabled1(16041);
  let MIDNIGHT;
  if (tmp5) {
    if (tmp12) {
      if (!tmp39[0]) {
  ...
  const items7 = [callback(sharedValue1(16120).VoicePanelVisualEffectView, { matchAppTheme: tmp50 }), callback(closure_39, { openTab: callback, wrapperSpecs: sharedValue1, sharedTab: sharedValue })];
  obj11[1] = items7;
  const items8 = [closure_20(sharedValue1(3997).ThemeContextProvider, obj11), callback(tmp4(16145), { wrapperSpecs: sharedValue1, tab: first, sharedTab: sharedValue, gestureSpecs: sharedValue2, openTab: callback }), ];
  tmpResult = tmp(1577);
