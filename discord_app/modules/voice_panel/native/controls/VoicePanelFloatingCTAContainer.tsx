...
function FloatingCTA(trailing) {
  ...
  obj[0] = jsx(RowButtonWrapper.RowButton, {
...
class VoicePanelFloatingCTAContainer {
  constructor(arg0) {
    ...
    class A {
      constructor() {
        ...
        obj = {
          ...
          marginLeft: -1 * require("t")(controlsDefaultWidth / 2),
          opacity: null,
          transform: null,
        };
    ...
    obj = {
      getControlsDefaultWidth: require("VOICE_PANEL_DRAWER_MAX_WIDTH").getControlsDefaultWidth,
      windowDimensions,
      safeArea,
      state,
      TransitionStates: require("ManaContext").TransitionStates,
      controlsSpecs,
      roundToNearestPixel: require("t"),
      withSpring: require("CONFIG_NEVER_ANIMATE").withSpring,
      OPACITY_CHANGE_PHYSICS: closure_12,
      runOnJS: require("../../../reanimated/ReanimatedRexport.tsx").runOnJS,
      cleanUp,
      wrapperSpecs,
...
let closure_14 = {
  code: "function VoicePanelFloatingCTAContainerTsx2(finished){const{state,TransitionStates,runOnJS,cleanUp}=this.__closure;if(finished&&state===TransitionStates.YEETED){runOnJS(cleanUp)();}}",
};
...
export const getFloatingCTATotalViewHeight = function getFloatingCTATotalViewHeight() {
  return (
    useIsMobileVisualRefreshExperimentEnabled.resolveRefreshToken(ThemesDefault.modules.mobile.TABLE_ROW_HEIGHT) + 16
  );
};
