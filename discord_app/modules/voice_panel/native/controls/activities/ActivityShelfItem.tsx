...
import getItemSubtitleForMaxPlayers from "getItemSubtitleForMaxPlayers" /* 12288 */;
...
import _modDef17356 from "module_17356" /* 17356 */;
...
function ActivityActionOverlay(arg0) {
  ...
  items[1] = timestampProducer(ActivityShelfItemSummaryDefault, { channelId: id1, applicationId: id, applicationName: name, submitting: useLaunchingActivityButtonStateDefault({ applicationId, context, launchingComponentId }).submitting });
  obj2.children = items;
...
export default function ActivityShelfItem(arg0) {
  ...
  if (tmp11) {
    ...
    if (isTestModeForApplication) {
      ...
      const obj10 = { size: native.Icon.Sizes.REFRESH_SMALL_16, source: _modDef17356, color: tmp.developerIconColor.color };
