    ...
    if (null != stateFromStores) {
      if (canManageGuildEventResult) {
        if (!tmp12) {
          ...
          const tmp7Result2 = tmp7(9814);
          obj.eventTimeData = tmp7(9697).getEventTimeData(scheduled_start_time);
          ...
          obj1 = { IconComponent: tmp7(9817).CalendarIcon, variant: "translucent" };
          obj.icon = jsx(tmp7(8628).RowButton.Icon, { IconComponent: tmp7(9817).CalendarIcon, variant: "translucent" });
          obj.label = name;
          ...
          obj3.onPress = tmp20;
          obj3.children = jsx(tmp7(5694).XSmallIcon, { color: "interactive-icon-default" });
          obj.trailing = (
          ...
          const tmp21 = obj;
          const tmp7Result3 = tmp7(9697);
        }
      }
    }
  }
  closure_130_0 = stateFromStores;
  tmpResultResult = setShowFloatingCTA(9812)(guild_id, id1, nextRecurrenceIdInEvent);
  const tmp26 = setShowFloatingCTA(17071)(obj.useContext(setShowFloatingCTA(12302)).channelId);
  ...
  if (null != stateFromStores) {
    if (tmp26) {
      if (stateFromStores1) {
        ...
        const obj5 = { IconComponent: tmp7(10064).GroupPlusIcon, variant: "translucent" };
        obj4.icon = jsx(tmp7(8628).RowButton.Icon, {
          IconComponent: tmp7(10064).GroupPlusIcon,
          variant: "translucent",
        });
        obj4.onPress = tmp29;
        const tmp30 = obj4;
