// === Module 16276: useFloatingCTAProps ===
...
import showSoundboardSoundPickerActionSheet from "showSoundboardSoundPickerActionSheet" /* 16281 */;
import _slicedToArray from "_slicedToArray" /* 32 */;
import noop from "noop" /* 19 */;
import { Pressable } from "get ActivityIndicator" /* 17 */;
import getParticipants from "getParticipants" /* 4773 */;
import initialize from "initialize" /* 16277 */;
...
function getBadConnectionCTAProps(arg0) {
  ...
  obj = { IconComponent: _require(8074).CircleErrorIcon, variant: "translucent" };
  obj[2] = jsx(_require(8086).RowButton.Icon, { IconComponent: _require(8074).CircleErrorIcon, variant: "translucent" });
  ...
  obj[4] = jsx(_require(6368).XSmallIcon, { color: "interactive-icon-default" });
