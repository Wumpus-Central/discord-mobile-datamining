...
export default function VoicePanelNsfwAlert(guildId) {
  ...
  const items = [closure_5(guildId(4956).AlertActionButton, obj1, "confirm"), ];
  const obj2 = {
    variant: "secondary",
    onPress() {
  ...
  items[1] = closure_5(guildId(4956).AlertActionButton, obj2, "add-profile-picture");
  obj.children = items;
  obj.actions = closure_6(guildId(4956).AlertActions, obj);
  return closure_5(guildId(4956).AlertModal, obj);
};
