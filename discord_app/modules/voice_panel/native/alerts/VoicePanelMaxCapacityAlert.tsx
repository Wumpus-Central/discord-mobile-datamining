...
export default function VoicePanelMaxCapacityAlert(channelId) {
  ...
  obj.onPress = channelId(4955).useDismissModalCallback();
  obj.actions = jsx(channelId(4955).AlertActionButton, { variant: "secondary", text: null, onPress: null });
  return jsx(channelId(4955).AlertModal, { variant: "secondary", text: null, onPress: null });
};
