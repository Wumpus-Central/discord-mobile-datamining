// === Module 16301: RedesignDiscoverabilityLanding ===
...
export default function RedesignDiscoverabilityLanding(onNext) {
  ...
  obj[1] = require(5144) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT + 32;
  ...
  obj3[2] = importDefault(11867);
  items[3] = callback(importDefault(5145), obj3);
  ...
  items1[2] = intl4.format(require(1236) /* getSystemLocale */.t.VcSQ4n, {
    learnMoreHook(arg0, arg1) {
      ...
      obj[0] = callback(11785).handleOpenLearnMoreLink;
      obj[3] = arg0;
      return callback2(callback(4189).Text, obj, arg1);
    }
  });
  obj4[3] = items1;
  items[4] = callback2(require(4189) /* Text */.Text, obj4);
  ...
  items[6] = callback(require(4604) /* Button */.Button, obj7);
  obj[3] = items;
