// === Module 16365: RedesignDiscoverabilityLanding ===
...
export default function RedesignDiscoverabilityLanding(onNext) {
  ...
  obj[1] = require(5206) /* NAV_BAR_HEIGHT */.NAV_BAR_HEIGHT + 32;
  ...
  obj3[2] = importDefault(11963);
  items[3] = callback(importDefault(5207), obj3);
  ...
  items1[2] = intl4.format(require(1236) /* getSystemLocale */.t.VcSQ4n, {
    learnMoreHook(arg0, arg1) {
      ...
      obj[0] = callback(11887).handleOpenLearnMoreLink;
      obj[3] = arg0;
  ...
  items[6] = callback(require(4666) /* Button */.Button, obj7);
  obj[3] = items;
