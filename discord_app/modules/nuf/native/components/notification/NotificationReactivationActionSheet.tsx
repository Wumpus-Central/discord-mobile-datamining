// === Module 16765: NotificationReactivationActionSheet ===

// Module 16765 (NotificationReactivationActionSheet)
import ThemesDefault from "Themes" /* 712 */;
import registerAssetDefault from "registerAsset" /* 16766 */;
...
export default function NotificationReactivationActionSheet(location) {
  ...
  items2[1] = callback(_location(4739).Text, obj1);
  ...
  items2[2] = callback(_location(4739).Text, obj2);
  ...
  obj4[1] = callback;
  const items3 = [callback(_location(4750).Button, obj4), ];
  ...
  obj5[1] = callback1;
  items3[1] = callback(_location(4750).Button, obj5);
  obj3[1] = items3;
  items2[3] = callback2(_location(6723).ButtonGroup, obj3);
  obj[1] = items2;
  obj[0] = callback2(closure_4, obj);
  return callback(_location(6988).BottomSheet, obj);
};