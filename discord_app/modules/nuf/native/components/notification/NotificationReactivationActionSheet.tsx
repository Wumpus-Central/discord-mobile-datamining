...
import _modDef17551 from "../../../../../../_runtime/metro/17551__.js";
...
export default function NotificationReactivationActionSheet(location) {
  ...
  obj = { style: tmp.image, source: _modDef17551, resizeMode: "contain" };
  ...
  items2[1] = closure_8(_location(4601).Text, obj1);
  ...
  items2[2] = closure_8(_location(4601).Text, obj2);
  ...
  const items3 = [closure_8(_location(5025).Button, obj4)];
  ...
  items3[1] = closure_8(_location(5025).Button, obj5);
  obj3.children = items3;
  items2[3] = closure_9(_location(5483).ButtonGroup, obj3);
  obj.children = items2;
