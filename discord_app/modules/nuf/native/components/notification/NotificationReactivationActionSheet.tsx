...
import _modDef17542 from "../../../../../../_runtime/metro/17542__.js";
...
export default function NotificationReactivationActionSheet(location) {
  ...
  obj = { style: tmp.image, source: _modDef17542, resizeMode: "contain" };
  ...
  items2[1] = closure_8(_location(4602).Text, obj1);
  ...
  items2[2] = closure_8(_location(4602).Text, obj2);
  ...
  const items3 = [closure_8(_location(5026).Button, obj4)];
  ...
  items3[1] = closure_8(_location(5026).Button, obj5);
  obj3.children = items3;
  items2[3] = closure_9(_location(5484).ButtonGroup, obj3);
  obj.children = items2;
