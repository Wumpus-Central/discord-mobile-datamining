// === Module 16369: NotificationReactivationActionSheet ===
...
export default function NotificationReactivationActionSheet(location) {
  ...
  obj4[1] = callback;
  const items3 = [callback(_location(4666).Button, obj4), ];
  ...
  obj5[1] = callback1;
  items3[1] = callback(_location(4666).Button, obj5);
  obj3[1] = items3;
  items2[3] = callback2(_location(5088).ButtonGroup, obj3);
  obj[1] = items2;
  obj[0] = callback2(closure_4, obj);
  return callback(_location(5309).BottomSheet, obj);
};