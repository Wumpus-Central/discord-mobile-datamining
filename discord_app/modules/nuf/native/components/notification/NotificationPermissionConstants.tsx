...
export const EventActionType = {
  SKIP_STEP: "skip_step",
  ALLOW_TO_REQUEST: "allow_to_request",
  REQUEST: "request",
  TO_SETTINGS: "to_settings",
  REQUEST_PROVISIONAL: "request_provisional",
  DISMISS: "dismiss",
};
export const EventActionLocation = {
  ALERT: "alert",
...
export const NotificationNudgeSurface = {
  ...
  POST_REACTION_BANNER: "post_reaction_banner",
  NOTIFICATION_SETTINGS_PERMISSION_HEADER: "notification_settings_permission_header",
  GUILD_OPEN_BOTTOM_SHEET: "guild_open_bottom_sheet",
  CALL_DISCONNECT_BOTTOM_SHEET: "call_disconnect_bottom_sheet",
};
