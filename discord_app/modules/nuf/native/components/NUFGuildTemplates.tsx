      ...
      if (c4 === 2) {
        ...
        try {
          ...
          if (0 === c3) {
            ...
            const guildProgress = callback(11834).createGuildProgress(callback);
            callback2(9551)();
            const obj6 = callback(11834);
            const result = callback2(12062).closeCreateGuildOnboardingModal();
            const obj7 = callback2(12062);
            const result1 = callback(12098).showInstantInviteModal(callback);
            const obj8 = callback(12098);
...
export default function NUFGuildTemplates() {
  ...
  obj[0] = React.useMemo(() => {
    ...
    obj[4] = obj2.getHeaderCloseButton(() => {
      callback(12037).trackNUFStep(constants2.STEP_GUILD_TEMPLATE, constants2.STEP_FRIEND_LIST, { skip: true });
      const obj = callback(12037);
      callback(1222).transitionTo(fallbackRoute.fallbackRoute);
      const obj2 = callback(1222);
      const result = callback2(12062).closeCreateGuildOnboardingModal();
    });
    obj[5] = function render() {
      return callback3(callback2(12064), { trigger: constants.NUF });
    };
    ...
    obj = {
      ...
      render(guildTemplate) {
        return callback3(callback2(12066), { guildTemplate: guildTemplate.guildTemplate, trigger: constants.NUF });
      }
    };
    ...
    obj[constants.CREATE_SERVER] = {
      ...
      render(arg0, arg1) {
        ...
        return callback3(callback2(11704), obj);
      }
    };
    obj2 = {
      ...
      render() {
        ...
        obj[1] = callback2(12062).closeCreateGuildModal;
        return callback3(callback2(12069), obj);
      }
    };
    ...
    obj[constants.ACCEPT_INVITE] = {
      ...
      render(code) {
        ...
        obj[1] = callback2(12062).closeCreateGuildModal;
        return callback3(callback2(12070), obj);
      }
    };
    const obj3 = {
      impressionName: callback(503).ImpressionNames.GUILD_ADD_ACCEPT_INVITE,
    ...
    obj[constants.CHANNEL_PROMPT] = {
      ...
      render(guildId) {
        ...
        return callback3(callback2(12099), obj);
      }
    };
    ...
    obj5[6] = function render() {
      return callback3(callback2(12081), { isNestedNavigator: true });
    };
