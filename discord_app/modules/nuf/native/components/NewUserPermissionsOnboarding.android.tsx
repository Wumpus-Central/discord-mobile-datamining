// === Module 11861: NewUserPermissionsOnboarding ===
...
const createCacheKey = { paddingTop: 80 + require("NAV_BAR_HEIGHT").NAV_BAR_HEIGHT };
...
const result = require("obj132").fileFinishedImporting("modules/nuf/native/components/NewUserPermissionsOnboarding.android.tsx");
...
export default function NewUserPermissionsOnboarding(showSkip) {
  ...
  if (flag) {
    ...
    obj8[1] = intl2.string(getSystemLocale.t["5Wxrcd"]);
    obj8[2] = onDontAllow;
    obj7[1] = callback(Button.Button, obj8);
    flag = callback(closure_2, obj7);
  }
  const obj9 = { children: null };
  items1[3] = flag;
  obj2[1] = items1;
  obj1[1] = callback(closure_2, obj2);
  items[1] = callback(closure_2, obj1);
  obj9[0] = items;
  obj[1] = callback(closure_2, obj9);
