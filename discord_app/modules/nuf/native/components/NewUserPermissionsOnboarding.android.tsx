...
export default function NewUserPermissionsOnboarding(showSkip) {
  ...
  const items1 = [callback(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { style: tmp.alertTitle, variant: "heading-lg/bold", color: "text-default", children: title }), callback(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { style: tmp.alertSubtitle, variant: "text-sm/medium", color: "text-default", children: subtitle }), , ];
  ...
  obj6[2] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["2nYlT2"]);
  obj6[3] = onAllow;
  obj6[4] = loading;
  ...
  if (flag) {
    ...
    obj8[2] = onDontAllow;
    obj7[1] = tmp4(tmp6(4695).Button, obj8);
    flag = tmp4(tmp5, obj7);
  }
