...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj.style = items1;
    obj.children = closure_7(tmp4(5627).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4601).Text, obj2)];
    ...
    items2[1] = closure_7(tmp4(4601).Text, obj3);
    ...
    const items4 = [closure_7(tmp4(4601).Text, obj5)];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(14959).ConnectGuardianCard, {
    ...
    obj8.children = closure_7(tmp4(5025).Button, obj10);
