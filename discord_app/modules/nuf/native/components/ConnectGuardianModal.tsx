...
export default function ConnectGuardianModal(route) {
  ...
  if ("gate" !== connectGuardianGate.state) {
    ...
    obj.style = items1;
    obj.children = closure_7(tmp4(5628).ActivityIndicator, {});
    ...
    const items2 = [closure_7(tmp4(4602).Text, obj2)];
    ...
    items2[1] = closure_7(tmp4(4602).Text, obj3);
    ...
    const items4 = [closure_7(tmp4(4602).Text, obj5)];
    ({ linkCode: obj9.linkCode, expiresAt: obj9.expiresAt, refresh: obj9.onRefresh } = connectGuardianGate);
    items4[1] = closure_7(tmp4(14936).ConnectGuardianCard, {
    ...
    obj8.children = closure_7(tmp4(5026).Button, obj10);
