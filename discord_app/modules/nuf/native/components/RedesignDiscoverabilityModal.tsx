// === Module 17869: RedesignDiscoverabilityModal ===
...
import SkipHeaderButtonDefault from "SkipHeaderButton" /* 12953 */;
...
function DiscoverabilityNameScene(onComplete) {
  ...
  obj.children = jsx(allowPhone(12954), { onNext: callback, loading: false, initialName: null });
...
obj2.container = { flex: 1, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, justifyContent: "center", paddingBottom: 44, paddingTop: fn(5901).NAV_BAR_HEIGHT + 32 };
