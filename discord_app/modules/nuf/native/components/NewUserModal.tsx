// === Module 17866: NewUserModal ===

// Module 17866 (NewUserModal)
import nativeDefault from "native" /* 576 */;
import NewUserUtils from "NewUserUtils" /* 17864 */;
...
export default function NewUserModal(arg0) {
  ...
  const onComplete = noop.useCallback((flag) => {
    ...
    nextOnboardingStep.then((onboardingStepIndex) => {
      ...
      if (continueNavigation) {
        if (null != ref.current) {
          closure_0(17864).continueToNextStep(onboardingStepIndex, tmp3.current);
          const obj2 = closure_0(17864);
        }
      }
      first(4960).popWithKey(closure_0(17865).NEW_USER_MODAL_KEY);
      const obj = first(4960);
    });
  }, items);
  ...
  const items1 = [
    closure_6(Navigator.Screen, {
      ...
      getComponent() {
        return closure_0(16341).RedesignNotificationScreen;
      },
    ...
    closure_6(Navigator.Screen, {
      name: "choose-avatar",
      getComponent() {
        return closure_0(17868).default;
      },
      options() {
        return {
          headerRight(arg0) {
            ...
            obj.onPress = function onPress() {
              ...
              closure_2_0(5111).openAlert("skip-avatar-upload", closure_2_6(lazyResult, {
                onConfirm() {
                  return closure_0(true);
                }
              }));
            };
            return closure_6(first(12953), obj);
          }
        };
      },
      initialParams: { onComplete }
    ...
    closure_6(Navigator.Screen, {
      ...
      getComponent() {
        return closure_0(12942).ContactSyncOnboardingModal;
      },
      initialParams: { onComplete }
    }),
    closure_6(Navigator.Screen, {
      ...
      options: { headerShown: false },
      getComponent() {
        return closure_0(17869).default;
      },
      initialParams: { onComplete }
    }),
    closure_6(Navigator.Screen, {
