...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4832).Text, obj3), , , , , , ,];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = closure_7(tmp4(6621).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4832).Text, obj8);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = closure_7(ref(6360), obj11);
