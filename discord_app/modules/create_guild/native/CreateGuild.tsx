...
export default function CreateGuild(arg0) {
  ...
  items1[2] = closure_7(ref(11262), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
