...
export default function CreateGuild(arg0) {
  ...
  const items1 = [closure_7(isScreenReaderEnabled(4823).Text, obj3), , , , , , , ];
  ...
  items1[1] = closure_7(isScreenReaderEnabled(4823).Text, obj4);
  items1[2] = closure_7(ref(12133), { iconBackgroundColor: tmp.contentContainer.backgroundColor, style: tmp.iconUploader, onPress: onIconPress, icon: guild.icon });
  ...
  items1[3] = closure_7(isScreenReaderEnabled(6934).TextInput, obj6);
  if (tmp9Result) {
    ...
    tmp9Result = closure_7(tmp4(7531).TableSwitchRow, obj7);
  }
  items1[4] = tmp9Result;
  ...
  items1[5] = closure_7(isScreenReaderEnabled(4823).Text, obj8);
  ...
  items1[6] = closure_7(isScreenReaderEnabled(5271).Button, obj10);
  ...
  if (null == firstFieldErrorMessage1) {
    ...
    if (null != message) {
      ...
      if ("" !== message1) {
        ...
        tmp9Result2 = closure_7(ref(7270), obj11);
        const tmp12Result = ref(7270);
      }
    }
  }
  items1[7] = tmp9Result2;
  obj.children = closure_8(isScreenReaderEnabled(5269).Stack, { children: items1 });
