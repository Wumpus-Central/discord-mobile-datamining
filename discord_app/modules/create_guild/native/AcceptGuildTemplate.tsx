...
function GuildTemplateResolved(guildTemplate) {
  ...
  const items1 = [
    closure_11(guildTemplate(4718).Text, obj3),
    closure_11(guildTemplate(4718).Text, {
  ...
  if (found.length > 0) {
    ...
    const items5 = [closure_11(tmp2(4718).Text, obj17), ,];
    ...
    items5[1] = closure_11(tmp2(4718).Text, obj18);
    ...
    children: _modDef12(channels.channels)
      ...
      .map((children) => {
        ...
        if (isGuildVocalChannelType(type)) {
          let tmp10Result = _modDef9958;
        } else if (type === constants2.GUILD_CATEGORY) {
          tmp10Result = _modDef12046;
        } else {
          tmp10Result = _modDef12047;
        }
