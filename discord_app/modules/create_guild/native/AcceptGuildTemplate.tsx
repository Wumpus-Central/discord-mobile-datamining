...
function GuildTemplateResolved(guildTemplate) {
  ...
  const items1 = [
    closure_11(guildTemplate(4635).Text, obj3),
    closure_11(guildTemplate(4635).Text, {
  ...
  if (found.length > 0) {
    ...
    const items5 = [closure_11(tmp2(4635).Text, obj17), ,];
    ...
    items5[1] = closure_11(tmp2(4635).Text, obj18);
    ...
    children: _modDef12(channels.channels)
      ...
      .map((children) => {
        ...
        if (isGuildVocalChannelType(type)) {
          let tmp10Result = _modDef9845;
        } else if (type === constants2.GUILD_CATEGORY) {
          tmp10Result = _modDef11938;
        } else {
          tmp10Result = _modDef11939;
        }
