...
function GuildTemplateResolved(guildTemplate) {
  ...
  const items1 = [
    closure_11(guildTemplate(4752).Text, obj3),
    closure_11(guildTemplate(4752).Text, {
  ...
  if (found.length > 0) {
    ...
    const items5 = [closure_11(tmp2(4752).Text, obj17), ,];
    ...
    items5[1] = closure_11(tmp2(4752).Text, obj18);
