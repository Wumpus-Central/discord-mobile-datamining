...
export default function AcceptInviteContainer(code) {
                    ...
                    try {
                      ...
                      if (0 === c5) {
                        if (arg0 === 1) {
                          ...
                          if (null != closure_0) {
                            if (obj2.isGuildScheduledEventInviteEmbed(closure_0)) {
                              let prop;
                              if (closure_0 != null) {
                              ...
                              if (null == prop) {
                                ...
                                closure_1();
                                const result = closure_2_0(dependencyMap[17]).transitionToEventDetailsFromInvite(prop);
                                c6 = 3;
                              ...
                              if (tmp11Result2.isRoleSubscriptionInvite(closure_0)) {
                                if (null != id) {
                                  c4 = 1;
                                  c5 = 2;
                                  c6 = 1;
                                  const obj7 = {
                                    value: v1(dependencyMap[18]).performRoleSubscriptionUpsellRedirect(id),
                                    done: false,
                                  };
                                  return obj7;
                                }
                              }
                              tmp11Result2 = closure_2_0(dependencyMap[16]);
                            }
                            obj2 = closure_2_0(dependencyMap[16]);
                          } else {
                            closure_1();
                          }
                          c6 = 3;
  ...
  obj4.children = jsx(code(inviteInstanceId[23]).ThemeContextProvider, {
    theme: ThemeTypes.DARK,
    children: jsx(onPressClose(inviteInstanceId[21]), { code, onPressClose, onPressJoin: callback1 }),
  });
