...
export default function CreateGuildContainer(onCreate) {
  ...
  const merged = Object.assign(
    onCreate,
    Object.assign({ onCreate: 0, guildTemplate: 0, autoFocus: 0, onHubGuildInfoSet: 0, isCommunityIntent: 0 }),
  );
  let name;
  let first1;
  c7 = undefined;
  ...
  const callback = first1.useCallback(
    isCommunityIntent(function* (arg0, value) {
      if (c3 === 2) {
        c3 = 3;
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null != onHubGuildInfoSet) {
                ...
                c5 = 1;
                const obj1 = {
                  value: obj9.createGuildFromTemplate(first, first1, guildTemplate, isCommunityIntent, first2),
                  done: false,
                };
                return obj1;
              }
