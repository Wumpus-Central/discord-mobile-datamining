...
let obj2 = {
  contentContainer: { flex: 1, marginTop: fn(5899).NAV_BAR_HEIGHT },
...
export default function CreationIntent(arg0) {
  ...
  if (closure_14) {
    ...
    items4[1] = closure_11(trigger(12578), obj10);
    obj8.children = items4;
    let tmp16 = obj8;
    const tmp12Result = trigger(12578);
  } else {
    ...
    items5[1] = closure_11(trigger(12578), obj11);
    obj8.children = items5;
    tmp16 = obj8;
    const tmp12Result2 = trigger(12578);
  }
