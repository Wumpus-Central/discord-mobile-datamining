...
export default function CreationIntent(arg0) {
  ...
  if (closure_14) {
    ...
    let tmp12Result = tmp12(10089);
    obj7[0] = tmp2(6790).WorldIllocon;
    ...
    tmp12Result = tmp12(10089);
    obj8[0] = tmp2(6790).ChairIllocon;
  ...
  obj4[1] = callback2(require(5558) /* TableRowGroupTitle */.TableRowGroup, tmp16);
  ...
  items3[2] = callback(require(4189) /* Text */.Text, obj9);
  obj[1] = items3;
