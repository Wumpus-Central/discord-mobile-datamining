...
import ListSelectionItemDefault from "ListSelectionItem.tsx";
import NewUserAnalyticsUtils from "../../../nuf/native/NewUserAnalyticsUtils.tsx";
import CreateGuildIcons from "../CreateGuildIcons.tsx";
    ...
    closure_14(trigger(5060).Button, {
      ...
      onPress() {
        if (constants3.NUF === trigger) {
          NewUserAnalyticsUtils.trackNUFStep(constants4.STEP_GUILD_TEMPLATE, constants4.STEP_GUILD_JOIN, {
            skip: false,
          });
...
({
  ...
  NUXGuildTemplatesAnalytics: closure_11,
...
let obj2 = {
  flex: { flex: 1 },
  contentContainer: { marginTop: fn(5768).NAV_BAR_HEIGHT },
...
export default function GuildTemplates(trigger) {
  ...
  const obj6 = {
    hasIcons: true,
    children: closure_14(GuildTemplatesItem, { guildTemplate: first[constants.CREATE], onGuildTemplatePress }),
  };
  ...
  const items4 = [
    closure_14(GuildTemplatesItem, { guildTemplate: first[constants.GAMING], onGuildTemplatePress }),
    closure_14(GuildTemplatesItem, { guildTemplate: first[constants.SCHOOL_CLUB], onGuildTemplatePress }),
    closure_14(GuildTemplatesItem, { guildTemplate: first[constants.STUDY], onGuildTemplatePress }),
    closure_14(GuildTemplatesItem, { guildTemplate: first[constants.FRIENDS], onGuildTemplatePress }),
    closure_14(GuildTemplatesItem, { guildTemplate: first[constants.CREATORS], onGuildTemplatePress }),
    closure_14(GuildTemplatesItem, { guildTemplate: first[constants.LOCAL_COMMUNITY], onGuildTemplatePress }),
  ];
  ...
  const items5 = [
    ...
    closure_14(GuildTemplatesJoinFooter, { trigger, onHeightChange: callback }),
  ];
