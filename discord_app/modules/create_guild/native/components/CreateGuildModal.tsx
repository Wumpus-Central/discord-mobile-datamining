...
export default function CreateGuildModal(channel) {
  ...
  obj.screens = isWindowSmall.useMemo(() => {
    ...
    impressionProperties.headerLeft = obj2.getHeaderCloseButton(
    ...
    impressionProperties = {
      ...
      render(guildTemplate) {
        return closure_1_10(closure_1(12805), {
    ...
    impressionProperties[constants.ACCEPT_INVITE] = {
      ...
      render(code) {
        obj = { code: code.code, onPressClose: closure_1(12801).closeCreateGuildModal };
