// === Module 9952: createUseCollectiblesShopStyles ===
    ...
    if (null == backgroundColors) {
      ...
      if (0 === backgroundColors.length) {
        ...
        if (0 === buttonColors.length) {
          ...
          if (1 === stateFromStores) {
            ...
            obj7[2] = confettiColors.map((toHsl) => {
              ...
              let s;
              ({ h, s, l } = toHsl.toHsl());
              return outer1_1(outer1_2[3])({ h, s: s * stateFromStores, l });
            });
          }
          return obj7;
        } else {
          if (1 !== buttonColors.length) {
            ...
            [tmp44, tmp45, tmp46] = outer1_3(tmpResult.getValueInColorGradientByPercentage(items1, items2, 50), 3);
            const obj13 = { r: null, g: null, b: null };
            obj13[0] = tmp44;
            obj13[1] = tmp45;
            obj13[2] = tmp46;
            const tmp43 = outer1_3(tmpResult.getValueInColorGradientByPercentage(items1, items2, 50), 3);
            obj12[2] = outer1_1(tmp2[3])(obj13).isLight() ? tmp39.dark : tmp39.light;
            const obj36 = outer1_1(tmp2[3])(obj13);
          }
        ...
        if (1 !== backgroundColors.length) {
          ...
          [tmp9, tmp10, tmp11] = outer1_3(tmpResult.getValueInColorGradientByPercentage(items3, items4, 50), 3);
          const obj16 = { r: null, g: null, b: null };
          obj16[0] = tmp9;
          obj16[1] = tmp10;
          obj16[2] = tmp11;
          obj5 = outer1_1(tmp2[3])(obj16);
          obj15[3] = obj5.setAlpha(0.4);
          [obj7, obj8] = backgroundColors;
          const tmp8 = outer1_3(tmpResult.getValueInColorGradientByPercentage(items3, items4, 50), 3);
          ...
          [tmp16, tmp17, tmp18] = outer1_3(tmp(tmp2[2]).getValueInColorGradientByPercentage(items5, items6, 50), 3);
          const obj17 = { r: null, g: null, b: null };
          obj17[0] = tmp16;
          obj17[1] = tmp17;
          obj17[2] = tmp18;
          obj10 = outer1_1(tmp2[3])(obj17);
          obj15[4] = obj10.isLight() ? tmp39.dark : tmp39.light;
          const tmp15 = outer1_3(tmp(tmp2[2]).getValueInColorGradientByPercentage(items5, items6, 50), 3);
        }
