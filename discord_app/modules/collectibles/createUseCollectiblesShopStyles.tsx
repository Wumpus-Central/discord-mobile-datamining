      ...
      if (0 === backgroundColors.length) {
        ...
        if (0 === buttonColors.length) {
          ...
          if (1 !== buttonColors.length) {
            ...
            const tmp43 = _slicedToArray(UserProfileGradientUtils.getValueInColorGradientByPercentage(items1, items2, 50), 3);
        ...
        if (1 !== backgroundColors.length) {
          ...
          const tmp8 = _slicedToArray(UserProfileGradientUtils.getValueInColorGradientByPercentage(items3, items4, 50), 3);
