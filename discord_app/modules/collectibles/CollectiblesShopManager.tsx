...
function flushCollections() {
  ...
  for (const item10019 of tmp4) {
    ...
    let obj2 = {
      collectionIds: item10019,
      includeUnpublishedCollections: tmp,
      includeUnpublishedProducts: tmp,
      includePricing: tmp2,
    };
  ...
  requestCollections(items, arg1) {
    ...
    while (iter !== undefined) {
      ...
      if (tmp3) {
        ...
        if (flag2) {
          hasPricingCoverageResult = StorefrontCollectionStore.hasPricingCoverage(tmp2);
        }
