...
export const ShopCategory = function ShopCategory(category) {
  ...
  const filteredAndSortedProducts = category(15182).useFilteredAndSortedProducts({
  ...
  const collectiblesShopDeepLinkProps = category(15937).useCollectiblesShopDeepLinkProps({
  ...
  const scrollToInitialIndexOnce = obj7.useScrollToInitialIndexOnce({
    ...
    flashListRef: ref,
    afterMs: category(15939).INITIAL_SCROLL_DELAY_MS,
  ...
  items4[1] = ref(filteredAndSortedProducts, {
    ...
    children: ref(category(7319).ChevronSmallRightIcon, { size: "sm", color: "white" }),
  });
