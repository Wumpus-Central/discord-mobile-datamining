...
export const ShopCategory = function ShopCategory(category) {
  ...
  const filteredAndSortedProducts = category(14604).useFilteredAndSortedProducts({
  ...
  const collectiblesShopDeepLinkProps = category(15426).useCollectiblesShopDeepLinkProps({
  ...
  const scrollToInitialIndexOnce = obj7.useScrollToInitialIndexOnce({
    ...
    flashListRef: ref,
    afterMs: category(15430).INITIAL_SCROLL_DELAY_MS,
  ...
  items4[1] = ref(filteredAndSortedProducts, {
    ...
    children: ref(category(6630).ChevronSmallRightIcon, { size: "sm", color: "white" }),
  });
