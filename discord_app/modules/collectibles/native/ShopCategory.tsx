...
export const ShopCategory = function ShopCategory(category) {
  ...
  const filteredAndSortedProducts = category(15350).useFilteredAndSortedProducts({
  ...
  const collectiblesShopDeepLinkProps = category(16143).useCollectiblesShopDeepLinkProps({
  ...
  const scrollToInitialIndexOnce = obj7.useScrollToInitialIndexOnce({
    ...
    flashListRef: ref,
    afterMs: category(16147).INITIAL_SCROLL_DELAY_MS,
  ...
  items4[1] = ref(filteredAndSortedProducts, {
    ...
    children: ref(category(7456).ChevronSmallRightIcon, { size: "sm", color: "white" }),
  });
