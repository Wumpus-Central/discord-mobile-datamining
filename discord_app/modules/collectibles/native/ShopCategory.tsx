...
export const ShopCategory = function ShopCategory(category) {
  ...
  const tmp4Result = category(9347);
  ...
  obj9[5] = callback;
  obj9[8] = category(9344).COLLECTIBLES_SHOP_CARD_WIDTH + 12;
  obj9[10] = HeaderAndFooterSpacing;
  obj9[11] = HeaderAndFooterSpacing;
  obj9[12] = Spacing;
  obj9[13] = productIndex;
  items5[1] = ref(category(7745).FlashList, obj9);
  obj2[1] = items5;
  obj1[1] = collectiblesAnalyticsContext(filteredAndSortedProducts, obj2);
  return ref(category(9347).CollectiblesAnalyticsProvider, obj1);
};