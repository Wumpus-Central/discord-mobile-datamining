...
export const ShopCategory = function ShopCategory(category) {
  ...
  const filteredAndSortedProducts = category(15402).useFilteredAndSortedProducts({
  ...
  const collectiblesShopDeepLinkProps = category(16196).useCollectiblesShopDeepLinkProps({
  ...
  const scrollToInitialIndexOnce = obj7.useScrollToInitialIndexOnce({
    ...
    flashListRef: ref,
    afterMs: category(16200).INITIAL_SCROLL_DELAY_MS,
  ...
  items4[1] = ref(filteredAndSortedProducts, {
    ...
    children: ref(category(7540).ChevronSmallRightIcon, { size: "sm", color: "white" }),
  });
