...
export const ShopCategory = function ShopCategory(category) {
  ...
  const filteredAndSortedProducts = category(15156).useFilteredAndSortedProducts({
  ...
  const collectiblesShopDeepLinkProps = category(15904).useCollectiblesShopDeepLinkProps({
  ...
  const scrollToInitialIndexOnce = obj7.useScrollToInitialIndexOnce({
    ...
    flashListRef: ref,
    afterMs: category(15906).INITIAL_SCROLL_DELAY_MS,
