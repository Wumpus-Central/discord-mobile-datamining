...
function FramePreviewOverrideSection() {
  ...
  if ("loading" === tmp3) {
    ...
    const str3 = "Showing \"" + frameKey + "\" \u00B7 " + length + " layer" + str4;
  }
  tmp4 = callback2((clear) => clear.clear);
}
...
const result = require("obj132").fileFinishedImporting("modules/collectibles/native/tooling/CollectiblesTool.tsx");
...
export default function _default() {
  ...
  const effect = React.useEffect(() => {
    if ("" !== str.trim()) {
      if (closure_0) {
        const product = closure_1_7.getProduct(str);
        const categoryForProduct = closure_1_7.getCategoryForProduct(str);
        if (null != product) {
  ...
  const obj10 = { value: tmp13[0], onChangeText: tmp13[1], placeholder: "Enter product SKU ID (e.g., 1366494385482502184)", returnKeyType: "done", style: null };
  ...
  if (tmp18Result) {
    ...
    obj12[1] = items8;
    tmp18Result = callback3(tmp2(tmp3[10]).Text, obj12);
  }
  ...
  if (tmp18Result) {
    ...
    obj13[1] = items9;
    tmp18Result = callback3(tmp2(tmp3[10]).Text, obj13);
  }
  ...
  if (tmp20Result) {
    ...
    obj14[2] = items11;
    tmp20Result = callback4(tmp2(tmp3[10]).Text, obj14);
  }
  ...
  if (null != first) {
    if (null != tmp16[0]) {
      ...
      obj20[0] = first;
      obj19[1] = callback3(UnpurchasedCollectiblesShopCardV2, obj20);
      const items13 = [callback3(closure_6, obj19), ];
      const obj21 = { pillStyle: null, text: "Show Collectibles Modal", onPress: null };
      obj21[0] = tmp.previewButton;
      obj21[2] = function onPress() {
        if (null != first) {
          str(first[16]);
          const obj = { product: null, useCategoryImage: true };
          obj[0] = tmp;
          obj.open(obj);
        }
      };
      items13[1] = callback3(tmp2(tmp3[11]).BaseTextButton, obj21);
      obj18[0] = items13;
      tmp20Result = callback4(closure_6, obj18);
    }
    items12[1] = tmp20Result;
    obj15[1] = items12;
    items5[2] = callback4(closure_6, obj15);
    items5[3] = callback3(FramePreviewOverrideSection, {});
    obj[2] = items5;
    obj[1] = callback4(closure_5, obj);
    return callback3(closure_6, obj);
  }
  const obj16 = { style: tmp.sectionHeader, children: callback3(_require(first[10]).Text, obj17) };
  tmp20Result = callback3(closure_6, { style: tmp.placeholder, children: callback4(_require(first[10]).Text, obj23) });
  const obj22 = { style: tmp.placeholder, children: callback4(_require(first[10]).Text, obj23) };
};