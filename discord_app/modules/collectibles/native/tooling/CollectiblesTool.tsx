...
function FramePreviewOverrideSection() {
  ...
  if ("loading" === tmp3) {
    ...
    obj[1] = callback3(_require("../../../../design/components/Text/native/Text.tsx").Text, obj);
    ...
    obj2[1] = items1;
    obj2[2] = "Loading\u2026";
    items[2] = callback3(_require("../../../../design/components/Text/native/Text.tsx").Text, obj2);
    const obj3 = { pillStyle: null, text: "Load from device", onPress: null };
    obj3[0] = tmp.secondaryButton;
    obj3[2] = function onPress() {
      callback();
    };
    items[3] = callback3(_require("../../../../design/components/Button/native/BaseTextButton.native.tsx").BaseTextButton, obj3);
    let tmp13Result = null != tmp2;
    if (tmp13Result) {
      const obj4 = { pillStyle: null, text: "Clear override", onPress: null };
      obj4[0] = tmp.secondaryButton;
      obj4[2] = tmp4;
      tmp13Result = callback3(_require("../../../../design/components/Button/native/BaseTextButton.native.tsx").BaseTextButton, obj4);
    }
    items[4] = tmp13Result;
    obj[1] = items;
...
function UnpurchasedCollectiblesShopCardV2(arg0) {
  ...
  return callback3(require("../CollectiblesShopCardV2.tsx"), obj, tmp2);
}
