...
class GiftingFlowSection {
  constructor(arg0) {
    ...
    if (null == product) {
      ...
      tmp8 = c0;
      tmp9 = closure_2;
      return jsx(c0(closure_2[14]).Text, {
        variant: "text-xs/normal",
        color: "text-muted",
        children: "Enter a valid product SKU ID above to preview the gift screens.",
      });
    } else {
      ...
      if (null != currentUser) {
        obj = {
          code: "devtools-collectibles-gift",
          user: null,
          sku_id: null,
          uses: 1,
          max_uses: 1,
...
export default function _default() {
  ...
  const obj7 = {
    ...
    children: closure_14(require("Text/Text").Text, {
  ...
  const items4 = [
    closure_14(closure_6, obj7),
    closure_14(require("ShopSkipCategoriesFilter").ShopSkipCategoriesFilter, {}),
  ];
  ...
  const items7 = [
    closure_14(require("Text/Text").Text, {
  ...
  if (tmp18Result) {
    ...
    obj17.style = items8;
    tmp18Result = closure_14(tmp2(tmp3[14]).Text, obj17);
  }
  ...
  if (tmp18Result2) {
    ...
    obj18.style = items9;
    tmp18Result2 = closure_14(tmp2(tmp3[14]).Text, obj18);
  }
  ...
  if (tmp20Result) {
    ...
    tmp20Result = closure_15(tmp2(tmp3[14]).Text, obj19);
  }
  ...
  if (null != product) {
    if (null != tmp16[0]) {
      ...
      const obj25 = { product };
      obj24.children = closure_14(UnpurchasedCollectiblesShopCardV2, obj25);
      ...
      items13[1] = closure_14(tmp2(tmp3[15]).BaseTextButton, obj26);
      const obj27 = { product };
  ...
  const obj28 = {
    ...
    children: closure_15(require("Text/Text").Text, {
      variant: "text-sm/normal",
