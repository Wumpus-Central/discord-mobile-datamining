...
import _mod9005 from "../../virtual_currency/hooks/index.tsx";
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    let tmp9Result = closure_6(onPressViewBadge(5675), obj3);
    ...
    tmp9Result = closure_6(tmp2(8456).VideoComponent, obj5);
      ...
      [closure_9.ROOT]: {
        ...
        headerRight() {
          return timestampProducer(BalanceWidgetPill.BalanceWidgetPill, {
            ...
            balance: _mod9005.useFetchVirtualCurrencyBalance().balance,
          });
        },
        title: "",
      },
