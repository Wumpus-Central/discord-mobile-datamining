...
import _mod8989 from "../../virtual_currency/hooks/index.tsx";
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    let tmp9Result = closure_6(onPressViewBadge(5673), obj3);
    ...
    tmp9Result = closure_6(tmp2(8437).VideoComponent, obj5);
      ...
      [closure_9.ROOT]: {
        ...
        headerRight() {
          return timestampProducer(BalanceWidgetPill.BalanceWidgetPill, {
            ...
            balance: _mod8989.useFetchVirtualCurrencyBalance().balance,
          });
        },
        title: "",
      },
