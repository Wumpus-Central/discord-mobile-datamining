...
import _mod9089 from "../../virtual_currency/hooks/index.tsx";
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    let tmp9Result = closure_6(onPressViewBadge(5757), obj3);
    ...
    tmp9Result = closure_6(tmp2(8539).VideoComponent, obj5);
      ...
      [closure_9.ROOT]: {
        ...
        headerRight() {
          return timestampProducer(BalanceWidgetPill.BalanceWidgetPill, {
            ...
            balance: _mod9089.useFetchVirtualCurrencyBalance().balance,
          });
        },
        title: "",
      },
