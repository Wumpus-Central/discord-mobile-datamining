...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  obj6[0] = obj7;
  obj6[1] = tmp.orbBadge;
  const items4 = [tmp13(tmp12(5268), obj6), ];
  ...
  const items5 = [tmp13(modalKey(4299).Text, obj10), ];
  ...
  items5[1] = tmp13(modalKey(4299).Text, obj11);
  obj9[1] = items5;
  ...
  items3[1] = tmp13(modalKey(5328).SafeAreaPaddingView, obj4);
  obj[1] = items3;
