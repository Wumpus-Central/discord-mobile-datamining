...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    let tmp13 = tmp9;
    const tmp15 = onPressViewBadge(5308);
  } else {
  ...
  obj6[0] = obj7;
  obj6[1] = tmp.orbBadge;
  const items4 = [tmp13(tmp12(5308), obj6), ];
  ...
  items3[1] = tmp13(modalKey(5368).SafeAreaPaddingView, obj4);
  obj[1] = items3;
