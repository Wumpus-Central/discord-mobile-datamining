...
import _mod8978 from "../../virtual_currency/hooks/index.tsx";
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    let tmp9Result = closure_6(onPressViewBadge(5672), obj3);
    ...
    tmp9Result = closure_6(tmp2(8428).VideoComponent, obj5);
      ...
      [closure_9.ROOT]: {
        ...
        headerRight() {
          return timestampProducer(BalanceWidgetPill.BalanceWidgetPill, {
            ...
            balance: _mod8978.useFetchVirtualCurrencyBalance().balance,
          });
        },
        title: "",
      },
