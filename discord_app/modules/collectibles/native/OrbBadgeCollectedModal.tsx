// === Module 12016: OrbBadgeCollectedRootScreen ===
...
function OrbBadgeCollectedRootScreen(modalKey) {
  ...
  if (stateFromStores) {
    ...
    const obj1 = { uri: null };
    obj1[0] = onPressViewBadge(11107);
    obj[0] = obj1;
    obj[1] = tmp.background;
    let tmp9Result = tmp9(onPressViewBadge(5207), obj);
    let tmp12 = onPressViewBadge;
    let tmp13 = tmp9;
    const tmp15 = onPressViewBadge(5207);
  } else {
    const obj2 = { source: null, poster: null, style: null, resizeMode: "contain", muted: true, pauseWhileAppInactive: true, paused: false };
    const obj3 = { uri: null };
    obj3[0] = onPressViewBadge(11108);
    obj2[0] = obj3;
    obj2[1] = onPressViewBadge(11107);
    obj2[2] = tmp.background;
    tmp9Result = tmp9(tmp2(8477).VideoComponent, obj2);
  ...
  obj6[0] = obj7;
  obj6[1] = tmp.orbBadge;
  const items4 = [tmp13(tmp12(5207), obj6), ];
  ...
  items3[1] = tmp13(modalKey(5243).SafeAreaPaddingView, obj4);
  obj[1] = items3;
