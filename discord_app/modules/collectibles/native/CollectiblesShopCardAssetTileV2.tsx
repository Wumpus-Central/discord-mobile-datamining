...
import _modDef9084 from "../../../../discord_assets/assets/orbs/orb_profile_badge_icon-2x.png.js";
  ...
  if (product.type === cardWidth(1890).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      ...
      if (cardWidth(1890).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = {
          profileFrame: first,
          previewWidth: cardWidth(9004).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32,
          previewHeight,
