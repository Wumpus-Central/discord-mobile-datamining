...
import _modDef9129 from "../../../../discord_assets/assets/orbs/orb_profile_badge_icon-2x.png.js";
  ...
  if (product.type === cardWidth(1973).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      ...
      if (cardWidth(1973).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj9 = {
          profileFrame: first,
          previewWidth: cardWidth(9049).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32,
          previewHeight,
