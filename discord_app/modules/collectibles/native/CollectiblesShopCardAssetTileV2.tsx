...
import _modDef8970 from "../../../../discord_assets/assets/orbs/orb_profile_badge_icon-2x.png.js";
  ...
  if (product.type === cardWidth(1889).CollectiblesItemType.BUNDLE) {
    ...
    if (ALL.has(product.skuId)) {
      ...
      if (cardWidth(1889).CollectiblesItemType.AVATAR_DECORATION === type) {
        ...
        const obj6 = {
          profileFrame: first,
          previewWidth: cardWidth(8890).COLLECTIBLES_SHOP_CARD_WIDTH - nativeDefault.space.PX_32,
          previewHeight,
