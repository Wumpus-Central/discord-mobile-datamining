// === Module 9220: CollectiblesShopCardVariants ===

// Module 9220 (CollectiblesShopCardVariants)
import nativeDefault from "native" /* 576 */;
import CheckmarkSmallIcon from "CheckmarkSmallIcon" /* 7464 */;
import useProductPurchaseState from "useProductPurchaseState" /* 9197 */;
import useIsVariantColorLightDefault from "useIsVariantColorLight" /* 9221 */;
import PlusSmallIcon from "PlusSmallIcon" /* 9222 */;
...
export default noop.memo(function CardProductVariants(product) {
  ...
  const tmp = closure_6();
  defaultVariantIndex = defaultVariantIndex(9121).useDefaultVariantIndex(product);
  const obj = defaultVariantIndex(9121);
