...
export default function PersonalizationDisclaimerActionSheet() {
  ...
  obj1[3] = callback(require(7765) /* LinkExternalSmallIcon */.LinkExternalSmallIcon, obj2);
  ...
  items1[1] = callback(require(4695) /* Button */.Button, obj3);
  obj[0] = items1;
  items[1] = callback2(require(5117) /* ButtonGroup */.ButtonGroup, obj);
  obj[1] = items;
