...
export default function PersonalizationDisclaimerActionSheet() {
  ...
  obj[4] = intl.string(getSystemLocale /* getSystemLocale */.t.euks4U);
  ...
  obj1[3] = callback(LinkExternalSmallIcon /* LinkExternalSmallIcon */.LinkExternalSmallIcon, obj2);
  const items1 = [callback(Button /* Button */.Button, obj1), ];
  const obj3 = { variant: "tertiary", size: "lg", text: null, onPress: null };
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj3[2] = intl3.string(getSystemLocale /* getSystemLocale */.t.WAI6xu);
  obj3[3] = function onPress() {
    return callback(4253).hideActionSheet();
  };
  items1[1] = callback(Button /* Button */.Button, obj3);
  obj[0] = items1;
  items[1] = callback2(ButtonGroup /* ButtonGroup */.ButtonGroup, obj);
  obj[1] = items;
