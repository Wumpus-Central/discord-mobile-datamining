...
createCacheKey = {
  ...
  heroBannerContainer: createCacheKey,
...
export default function _default(heroBlock) {
  ...
  const filteredAndSortedProducts = heroBlock(14902).useFilteredAndSortedProducts({
    products: memo,
  ...
  if (undefined === stateFromStores) {
    ...
    if (!tmp4) {
      ...
      obj[0] = tmpResult1.useTrackProductCardImpression(
      ...
      if (tmp4) {
        ...
        obj14[6] = function onPress() {
          ...
          navigation.navigate(closure_1_9.COLLECTIBLES_SHOP_VIEW_ALL_CATEGORY_ITEMS, {
            category: stateFromStores,
            analyticsContext: closure_3,
          });
        };
