...
export default function _default(heroBlock) {
  ...
  const filteredAndSortedProducts = heroBlock(15402).useFilteredAndSortedProducts({
    products: memo,
    ...
    if (!tmp4) {
      ...
      if (tmp24Result) {
        ...
        if (tmp4) {
          ...
          tmp22Result = closure_11(tmp6(5283), obj8);
        }
        ...
        items3[2] = closure_11(tmp6(5283), obj12);
      ...
      if (tmp4) {
        ...
        if (tmp22Result6) {
          ...
          tmp22Result6 = closure_11(tmp(4823).Text, obj15);
        }
        ...
        if (tmp22Result7) {
          ...
          tmp22Result7 = closure_11(tmp(4823).Text, obj16);
        }
        ...
        if (isEligibleForQuests) {
          ...
          isEligibleForQuests = closure_11(tmp(5271).Button, obj19);
        }
        ...
        const obj28 = {
          ...
          children: closure_11(tmp(7540).ChevronSmallRightIcon, { size: "sm", color: "white" }),
        };
        items9[1] = closure_11(tmp25, obj28);
        obj24.children = items9;
        obj20.children = closure_13(tmp25, obj24);
        tmp24Result2 = closure_11(tmp(5425).PressableOpacity, obj20, stateFromStores.storeListingId);
      }
      ...
      if (tmp4) {
        ...
        let tmp22Result9 = closure_11(tmp6(16213), obj30);
        ...
        if (0 === filteredAndSortedProducts.length) {
          ...
          tmp22Result10 = closure_11(tmp(9073).FlashList, obj34);
        }
