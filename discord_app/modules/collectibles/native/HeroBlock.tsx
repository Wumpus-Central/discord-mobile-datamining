...
export default function _default(heroBlock) {
  ...
  const filteredAndSortedProducts = heroBlock(15336).useFilteredAndSortedProducts({
    products: memo,
    ...
    if (!tmp4) {
      ...
      if (tmp4) {
        ...
        const obj28 = {
          ...
          children: closure_11(tmp(7449).ChevronSmallRightIcon, { size: "sm", color: "white" }),
        };
        items9[1] = closure_11(tmp25, obj28);
        obj24.children = items9;
        obj20.children = closure_13(tmp25, obj24);
        tmp24Result2 = closure_11(tmp(5334).PressableOpacity, obj20, stateFromStores.storeListingId);
      }
      ...
      if (tmp4) {
        ...
        let tmp22Result9 = closure_11(tmp6(16143), obj30);
        ...
        if (0 === filteredAndSortedProducts.length) {
          ...
          tmp22Result10 = closure_11(tmp(8996).FlashList, obj34);
        }
