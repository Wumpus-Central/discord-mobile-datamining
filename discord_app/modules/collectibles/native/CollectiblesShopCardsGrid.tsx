...
function ShopCardGridItem(index) {
  ...
  return jsx(CollectiblesAnalyticsContext.CollectiblesAnalyticsProvider, {
    newValue: memo,
    children: jsx(CollectiblesShopCardV2Default, {
      unpublishedAt,
      product,
      cardWidth,
      preferVCPrice,
...
export default function CollectiblesShopCardsGrid(accessibilityLabel) {
  ...
  obj2.contentContainerStyle = {
    gap: products(9124).COLLECTIBLES_SHOP_CARD_GAP,
    paddingTop,
    paddingBottom,
