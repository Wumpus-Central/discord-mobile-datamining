// === Module 16237: CollectiblesShopCardsGrid ===
...
let obj2 = { rowContainer: { flexDirection: "row", gap: fn(9124).COLLECTIBLES_SHOP_CARD_GAP } };
...
export default function CollectiblesShopCardsGrid(accessibilityLabel) {
  ...
  const cardLayout = products(16236).useCardLayout();
  ...
  let obj = products(16236);
  obj2.contentContainerStyle = { gap: products(9124).COLLECTIBLES_SHOP_CARD_GAP, paddingTop, paddingBottom, width: cardLayout.rowWidth, alignSelf: "center" };
