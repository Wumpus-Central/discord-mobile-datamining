...
export default function _default(arg0) {
  ...
  collectiblesAnalyticsContext = onRenderFirstOrbsItem(
    collectiblesAnalyticsContext[7],
  ).useCollectiblesAnalyticsContext();
  let obj = onRenderFirstOrbsItem(collectiblesAnalyticsContext[7]);
  const collectiblesShopDeepLinkProps = onRenderFirstOrbsItem(
    collectiblesAnalyticsContext[8],
  ).useCollectiblesShopDeepLinkProps({});
  ...
  const obj5 = {
    style: { marginTop: 42 },
    Illustration: onRenderFirstOrbsItem(collectiblesAnalyticsContext[13]).NoResults,
    body: null,
  };
  ...
  obj4.children = jsx(onRenderFirstOrbsItem(collectiblesAnalyticsContext[12]).EmptyState, {
    style: { marginTop: 42 },
    Illustration: onRenderFirstOrbsItem(collectiblesAnalyticsContext[13]).NoResults,
    body: null,
  });
