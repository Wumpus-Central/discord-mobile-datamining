...
export default function ProductPurchaseSuccessModal(stageCollectibleChangeForEditProfile) {
  ...
  if (useCategoryImage) {
    ...
    const items5 = [tmp30(closure_8, obj11)];
    ...
    if (tmp2(1973).CollectiblesItemType.BUNDLE === type) {
      ...
      if (tmp29Result) {
        ...
        ({
          firstAvatarDecoration: obj34.deco,
          firstProfileEffect: obj34.pfx,
          firstNameplate: obj34.nameplate,
        } = shopProductItems);
      ...
      let tmp29Result2 = tmp29(closure_8, obj16);
    ...
    obj29.children = tmp30(closure_8, obj30);
    items6[2] = tmp30(closure_8, obj29);
    rect.children = items6;
    items3[1] = closure_13(tmp2(7454).SafeAreaPaddingView, rect);
