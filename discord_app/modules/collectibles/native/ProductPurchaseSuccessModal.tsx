...
let closure_16 = createStyles.createStyles((arg0) => {
  ...
  const obj1 = { flexDirection: "row", justifyContent: "center", alignItems: "center", flex: num, marginTop: null, marginHorizontal: null };
  let str = 0;
  if (arg0 === CollectiblesItemType.CollectiblesItemType.AVATAR_DECORATION) {
    str = "20%";
  }
  ...
  if (flag) {
    if (arg0 === CollectiblesItemType.CollectiblesItemType.AVATAR_DECORATION) {
      const obj2 = { shadowColor: nativeDefault.unsafe_rawColors.PRIMARY_630, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 1, shadowRadius: 60, elevation: 24 };
      let obj7 = obj2;
    }
    const merged = Object.assign(obj7);
    obj.preview = obj1;
    obj.previewBundle = { flex: 1, justifyContent: "flex-start", alignItems: "center", minHeight: 250 };
    const obj3 = { paddingTop: nativeDefault.space.PX_24, minHeight: null, flexDirection: "column", alignItems: "center", justifyContent: "flex-start", gap: null };
    let str2;
    if (arg0 === CollectiblesItemType.CollectiblesItemType.AVATAR_DECORATION) {
      str2 = "32%";
    }
    ...
    obj.footer = obj5;
    const obj6 = { flexDirection: "row", gap: nativeDefault.space.PX_12, paddingVertical: nativeDefault.space.PX_16, marginHorizontal: nativeDefault.space.PX_24, borderRadius: nativeDefault.radii.round };
    obj.cta = obj6;
    return obj;
  }
  obj7 = {};
...
export default function ProductPurchaseSuccessModal(stageCollectibleChangeForEditProfile) {
  ...
  obj = { interpolate: tmp2(4341).interpolate, springInput: sharedValue, isProfilePreview: tmp12 };
  fn.__closure = obj;
  ...
  obj = { interpolate: tmp2(4341).interpolate, springInput: sharedValue };
  fn2.__closure = obj;
  ...
  handleUseNow = require("useHandleUseNow").useHandleUseNow({ product, onSuccess, stageCollectibleChangeForEditProfile: stageCollectibleChangeForEditProfile.stageCollectibleChangeForEditProfile });
  ...
  if (useCategoryImage) {
    ...
    if (showOrbBalancePill) {
      ...
      showOrbBalancePill = tmp31(tmp2(11162).BalanceWidgetPill, obj8);
    }
    ...
    if (tmp2(1889).CollectiblesItemType.BUNDLE === type) {
      ...
      if (tmp30Result) {
        const obj13 = { deco: null, pfx: null, nameplate: null, previewAssets: null, disableStaticBackground: true, size: "large", targetSize: null };
    ...
    if (null != renderMessages) {
      ...
      const items10 = [tmp31(tmp2(4601).Text, obj19), ];
    ...
    if (canUseNow) {
      const obj27 = { loading: isApplying, disabled: isApplying, onPress: handleUseNow, text: null, size: "lg", grow: true };
