...
import _modDef17424 from "../../../../discord_assets/assets/collectibles/frames/announcement_sheet_frame.png.js";
import _modDef17425 from "../../../../discord_assets/assets/collectibles/frames/ea/announcement_key_1.png.js";
...
export default function CollectiblesMobileAnnouncementActionSheet(markAsDismissed) {
  ...
  items3[1] = closure_9(markAsDismissed(4753).Text, obj5);
  const obj6 = { style: tmp.featureRows, children: null };
  const obj7 = { icon: closure_9(markAsDismissed(5911).PaintIllocon, { size: 32 }), text: null };
  ...
  const obj8 = { icon: closure_9(markAsDismissed(5911).HeartIllocon, { size: 32 }), text: null };
  ...
  const obj9 = { icon: closure_9(markAsDismissed(5911).ShopIllocon, { size: 32 }), text: null };
  ...
  items3[3] = closure_9(markAsDismissed(5187).Button, obj10);
