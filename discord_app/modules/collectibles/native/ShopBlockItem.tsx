...
export default function _default(block) {
  ...
  if (block(stateFromStores1[7]).ShopBlockType.HERO === type) {
    ...
    obj1.children = <View key={memo} style={tmp.shopBlockSpacing}>{null}</View>;
    ...
    obj5.children = jsx(stateFromStores(tmp3[11]), { feedBlock: block, screen, preferVCPrice, disableBundleStaticBackground: true }, memo);
