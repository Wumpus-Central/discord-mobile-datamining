...
import CollectiblesBadges from "CollectiblesBadges" /* 8864 */;
...
export const EditCollectiblesListItemNone = function EditCollectiblesListItemNone(asDefault) {
  ...
  obj = { source: _modDef13199, size: native.IconSizes.LARGE };
...
export const EditCollectiblesListItemShop = function EditCollectiblesListItemShop(analyticsSource) {
  ...
  obj = { source: analyticsLocations(13200), size: analyticsSource(1178).IconSizes.LARGE };
  ...
  items1[1] = closure_7(analyticsSource(4570).Text, obj);
