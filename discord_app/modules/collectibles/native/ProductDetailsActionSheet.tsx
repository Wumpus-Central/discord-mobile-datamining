...
function PreviewProfileTrigger(handlePreviewPress) {
  ...
  obj3.children = closure_13(handlePreviewPress(7082).EyeIcon, {
    size: "md",
...
function ManagedProductDetailsActionSheetInner(skuId) {
  ...
  const collectiblesShopProduct = skuId(9029).useCollectiblesShopProduct(skuId, {
    needsCategory: false,
...
let size = {
  width: fn(5067).MEDIUM_BUTTON_HEIGHT,
  height: fn(5067).MEDIUM_BUTTON_HEIGHT,
  alignItems: "center",
