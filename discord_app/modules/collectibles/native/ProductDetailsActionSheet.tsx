...
function PreviewProfileTrigger(handlePreviewPress) {
  ...
  dependencyMap = tmp;
  let obj = handlePreviewPress(3997);
  const theme = obj.useThemeContext().theme;
  const isThemeLightResult = handlePreviewPress(4131).isThemeLight(theme);
  ...
  obj[4] = callback3(handlePreviewPress(8308).EyeIcon, obj);
...
export default function ProductDetailsActionSheet(shopAnalyticsContext) {
  ...
  return callback3(require("../CollectiblesAnalyticsContext.tsx") /* context */.CollectiblesAnalyticsProvider, obj);
};