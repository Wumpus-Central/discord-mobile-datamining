// === Module 7615: ProductDetailsActionSheet ===
...
import ShopStandalonePdpMobileExperiment from "ShopStandalonePdpMobileExperiment" /* 7612 */;
...
function PreviewProfileTrigger(handlePreviewPress) {
  ...
  obj3.children = closure_13(handlePreviewPress(6384).EyeIcon, { size: "md", color: onTrackPress(576).colors.INTERACTIVE_ICON_DEFAULT });
...
function ManagedProductDetailsActionSheetInner(skuId) {
  ...
  const collectiblesShopProduct = skuId(8331).useCollectiblesShopProduct(skuId, { needsCategory: false, seedCategoryStore: true });
...
let size = { width: fn(5279).MEDIUM_BUTTON_HEIGHT, height: fn(5279).MEDIUM_BUTTON_HEIGHT, alignItems: "center", justifyContent: "center", borderRadius: nativeDefault.radii.round, borderWidth: 1, borderColor: nativeDefault.colors.CONTROL_SECONDARY_BORDER_DEFAULT };
