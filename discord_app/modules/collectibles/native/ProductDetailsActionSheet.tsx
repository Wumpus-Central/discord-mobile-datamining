// === Module 8177: ProductDetailsActionSheet ===
...
let closure_19 = noop.forwardRef((product, arg1) => {
  ...
  const items8 = [tmp40, closure_13(analyticsLocations(ref[40]), { selectedProduct, size: "md", onTrackPress: trackPdpClick })];
  ...
  items9[2] = closure_13(analyticsLocations(ref[41]), { product: selectedProduct, handlePreviewPress: callback, onTrackPress: trackPdpClick, onBundleActiveItemChange: tmp39 });
  items9[3] = closure_13(analyticsLocations(ref[42]), { product: selectedProduct, onTrackPress: trackPdpClick });
  items9[4] = closure_13(analyticsLocations(ref[43]), { product, selectedVariantIndex: tmp14, disabled: tmp56, onVariantSelect: tmp15 });
