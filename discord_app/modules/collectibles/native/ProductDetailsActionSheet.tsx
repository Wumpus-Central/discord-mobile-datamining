...
function PreviewProfileTrigger(handlePreviewPress) {
  ...
  obj3.children = closure_13(handlePreviewPress(7164).EyeIcon, {
    size: "md",
...
function ManagedProductDetailsActionSheetInner(skuId) {
  ...
  const collectiblesShopProduct = skuId(9113).useCollectiblesShopProduct(skuId, {
    needsCategory: false,
...
let size = {
  width: fn(5149).MEDIUM_BUTTON_HEIGHT,
  height: fn(5149).MEDIUM_BUTTON_HEIGHT,
  alignItems: "center",
