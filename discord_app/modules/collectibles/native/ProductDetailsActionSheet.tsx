// === Module 8525: ProductDetailsActionSheet ===
...
import ShopStandalonePdpMobileExperiment from "ShopStandalonePdpMobileExperiment" /* 8522 */;
...
function PreviewProfileTrigger(handlePreviewPress) {
  ...
  obj3.children = closure_13(handlePreviewPress(7301).EyeIcon, { size: "md", color: onTrackPress(576).colors.INTERACTIVE_ICON_DEFAULT });
...
function ManagedProductDetailsActionSheetInner(skuId) {
  ...
  const collectiblesShopProduct = skuId(9233).useCollectiblesShopProduct(skuId, { needsCategory: false, seedCategoryStore: true });
...
let size = { width: fn(5278).MEDIUM_BUTTON_HEIGHT, height: fn(5278).MEDIUM_BUTTON_HEIGHT, alignItems: "center", justifyContent: "center", borderRadius: nativeDefault.radii.round, borderWidth: 1, borderColor: nativeDefault.colors.CONTROL_SECONDARY_BORDER_DEFAULT };
...
let closure_19 = noop.forwardRef((product, arg1) => {
  ...
  const imperativeHandle = trackPdpClick.useImperativeHandle(arg1, () => ({
    scrollToEnd() {
