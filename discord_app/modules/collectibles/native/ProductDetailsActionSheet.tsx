...
function PreviewProfileTrigger(handlePreviewPress) {
  ...
  obj3.children = closure_13(handlePreviewPress(7299).EyeIcon, {
    size: "md",
...
function ManagedProductDetailsActionSheetInner(skuId) {
  ...
  const collectiblesShopProduct = skuId(9229).useCollectiblesShopProduct(skuId, {
    needsCategory: false,
...
let size = {
  width: fn(5276).MEDIUM_BUTTON_HEIGHT,
  height: fn(5276).MEDIUM_BUTTON_HEIGHT,
  alignItems: "center",
