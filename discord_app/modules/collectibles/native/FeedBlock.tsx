...
export default function _default(feedBlock) {
  ...
  obj = {
    value: stateFromStores1(7265)(stateFromStores1(7285).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations,
    children: null,
  };
  ...
  const items6 = [
    ...
    closure_11(stateFromStores1(15915), {
