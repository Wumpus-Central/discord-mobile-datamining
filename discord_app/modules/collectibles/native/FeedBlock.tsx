...
export default function _default(feedBlock) {
  ...
  const filteredAndSortedProducts = feedBlock(15350).useFilteredAndSortedProducts({
  ...
  const obj5 = {
    value: stateFromStores1(7409)(stateFromStores1(7429).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations,
    children: null,
  };
  ...
  const items6 = [
    ...
    closure_11(stateFromStores1(16160), {
