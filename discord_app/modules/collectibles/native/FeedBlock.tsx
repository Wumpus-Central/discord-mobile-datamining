...
export default function _default(feedBlock) {
  ...
  let tmp6 = stateFromStores1(14674)();
  dependencyMap = tmp6;
  ...
  obj = { value: stateFromStores1(5953)(stateFromStores1(5973).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations, children: null };
  ...
  if (isPersonalized) {
    ...
    isPersonalized = tmp12(tmp(5068).PressableOpacity, obj3);
  }
  ...
  obj1[1] = items5;
  const items6 = [closure_12(closure_5, obj1), callback(stateFromStores1(15422), { products: filteredAndSortedProducts, loadingCardsNum: 36, preferVCPrice, accessibilityLabel: stringResult, disableBundleStaticBackground }), ];
  ...
  if (screen === constants.ORBS) {
    if (stateFromStores2) {
      ...
      if (tmpResult.isAndroid()) {
        ...
        tmp12Result = tmp12(tmp5(5493), obj11);
        const tmp5Result1 = tmp5(5493);
      }
      tmpResult = tmp(500);
    }
  } else {
    ...
    return tmp12(tmp(5953).AnalyticsLocationProvider, obj);
  }
};