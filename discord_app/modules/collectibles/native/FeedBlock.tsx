...
export default function _default(feedBlock) {
  ...
  const filteredAndSortedProducts = feedBlock(14579).useFilteredAndSortedProducts({
  ...
  const obj5 = {
    value: stateFromStores1(6578)(stateFromStores1(6598).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations,
    children: null,
  };
  ...
  if (isPersonalized) {
    ...
    isPersonalized = closure_11(tmp(5428).PressableOpacity, obj9);
  }
  ...
  if (screen !== constants.ORBS) {
    ...
    tmp12Result = closure_11(tmp(5274).Button, obj10);
  }
  items5[1] = tmp12Result;
  obj7.children = items5;
  const items6 = [
    closure_12(closure_5, obj7),
    closure_11(stateFromStores1(15414), {
  ...
  if (screen === constants.ORBS) {
    if (stateFromStores2) {
      ...
      if (tmpResult.isAndroid()) {
        ...
        tmp12Result2 = closure_11(tmp5(8264), obj16);
        ...
        tmp12Result2 = closure_11(tmp5(5894), obj17);
    ...
    return closure_11(tmp(6578).AnalyticsLocationProvider, obj5);
  }
  const tmp10 = stateFromStores1(6578);
}
