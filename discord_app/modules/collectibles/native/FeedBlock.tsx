...
export default function _default(feedBlock) {
  ...
  const filteredAndSortedProducts = feedBlock(15281).useFilteredAndSortedProducts({
  ...
  const obj5 = {
    value: stateFromStores1(7358)(stateFromStores1(7378).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations,
    children: null,
  };
  ...
  if (isPersonalized) {
    ...
    obj9.children = closure_11(tmp(4676).CircleInformationIcon, { size: "xs" });
    isPersonalized = closure_11(tmp(5292).PressableOpacity, obj9);
  }
  ...
  if (screen !== constants.ORBS) {
    ...
    tmp12Result = closure_11(tmp(5144).Button, obj10);
  }
  items5[1] = tmp12Result;
  obj7.children = items5;
  const items6 = [
    closure_12(closure_5, obj7),
    closure_11(stateFromStores1(16067), {
  ...
  if (screen === constants.ORBS) {
    if (stateFromStores2) {
      ...
      if (tmpResult.isAndroid()) {
        ...
        tmp12Result2 = closure_11(tmp5(9050), obj16);
        ...
        tmp12Result2 = closure_11(tmp5(5757), obj17);
    ...
    return closure_11(tmp(7358).AnalyticsLocationProvider, obj5);
  }
  const tmp10 = stateFromStores1(7358);
}
