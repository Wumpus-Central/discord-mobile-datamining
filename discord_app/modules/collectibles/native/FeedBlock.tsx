...
export default function _default(feedBlock) {
  ...
  obj = { value: stateFromStores1(7265)(stateFromStores1(7285).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations, children: null };
  ...
  if (isPersonalized) {
    ...
    obj3.children = closure_11(tmp(4591).CircleInformationIcon, { size: "xs" });
    isPersonalized = closure_11(tmp(5204).PressableOpacity, obj3);
  }
  ...
  if (screen !== constants.ORBS) {
    ...
    tmp12Result = closure_11(tmp(5056).Button, obj4);
  }
  items5[1] = tmp12Result;
  obj1.children = items5;
  const items6 = [closure_12(closure_5, obj1), closure_11(stateFromStores1(15915), { products: filteredAndSortedProducts, loadingCardsNum: 36, preferVCPrice, accessibilityLabel: stringResult, disableBundleStaticBackground }), ];
  ...
  if (screen === constants.ORBS) {
    if (stateFromStores2) {
      ...
      if (tmpResult.isAndroid()) {
        ...
        tmp5Result = tmp5(8936);
        obj10.url = tmp5(15924);
        ...
        const obj12 = { uri: tmp5(15924) };
        obj11.source = obj12;
        obj11.style = feedFooterOrbImage.feedFooterOrbImage;
        tmp12Result = closure_11(tmp5(5668), obj11);
        const tmp5Result1 = tmp5(5668);
      }
      tmpResult = tmp(1150);
    }
  } else {
    ...
    return closure_11(tmp(7265).AnalyticsLocationProvider, obj);
  }
