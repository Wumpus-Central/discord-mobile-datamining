...
export default function _default(feedBlock) {
  ...
  const filteredAndSortedProducts = feedBlock(15166).useFilteredAndSortedProducts({
  ...
  const obj5 = {
    value: stateFromStores1(7269)(stateFromStores1(7289).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations,
    children: null,
  };
  ...
  if (isPersonalized) {
    ...
    obj9.children = closure_11(tmp(4594).CircleInformationIcon, { size: "xs" });
    isPersonalized = closure_11(tmp(5207).PressableOpacity, obj9);
  }
  ...
  if (screen !== constants.ORBS) {
    ...
    tmp12Result = closure_11(tmp(5059).Button, obj10);
  }
  items5[1] = tmp12Result;
  obj7.children = items5;
  const items6 = [
    closure_12(closure_5, obj7),
    closure_11(stateFromStores1(15930), {
  ...
  if (screen === constants.ORBS) {
    if (stateFromStores2) {
      ...
      if (tmpResult.isAndroid()) {
        ...
        tmp12Result2 = closure_11(tmp5(8939), obj16);
        ...
        tmp12Result2 = closure_11(tmp5(5672), obj17);
    ...
    return closure_11(tmp(7269).AnalyticsLocationProvider, obj5);
  }
  const tmp10 = stateFromStores1(7269);
}
