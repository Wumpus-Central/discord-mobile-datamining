...
export default function _default(feedBlock) {
  ...
  const filteredAndSortedProducts = feedBlock(14604).useFilteredAndSortedProducts({
  ...
  const obj5 = {
    value: stateFromStores1(6583)(stateFromStores1(6603).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations,
    children: null,
  };
  ...
  const items4 = [closure_11(feedBlock(4832).Heading, { variant: "heading-lg/semibold", children: stringResult })];
  if (isPersonalized) {
    const obj9 = {
      onPress() {
  ...
  const items7 = [closure_11(feedBlock(4832).Text, obj12), ,];
