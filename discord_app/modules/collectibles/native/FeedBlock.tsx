...
export default function _default(feedBlock) {
  ...
  const filteredAndSortedProducts = feedBlock(15411).useFilteredAndSortedProducts({
  ...
  const obj5 = {
    value: stateFromStores1(7495)(stateFromStores1(7515).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations,
    children: null,
  };
  ...
  const items6 = [
    ...
    closure_11(stateFromStores1(16235), {
