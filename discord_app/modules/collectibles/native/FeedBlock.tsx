...
export default function _default(feedBlock) {
  ...
  obj = { value: stateFromStores1(7214)(stateFromStores1(7234).COLLECTIBLES_SHOP_POPULAR_PICKS).analyticsLocations, children: null };
  ...
  const items6 = [closure_12(closure_5, obj1), closure_11(stateFromStores1(15906), { products: filteredAndSortedProducts, loadingCardsNum: 36, preferVCPrice, accessibilityLabel: stringResult, disableBundleStaticBackground }), ];
