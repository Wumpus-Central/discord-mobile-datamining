...
import _modDef11106 from "../../../../discord_assets/assets/collectibles/previews/sample_profile_small.png.js";
...
export default function CollectiblesShopCheckoutDetails(recipientUser) {
  ...
  if (flag3) {
    ...
    obj1.children = closure_7(tmp3(4602).Text, obj2);
