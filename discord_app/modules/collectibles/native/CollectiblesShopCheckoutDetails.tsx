...
import _modDef11172 from "../../../../discord_assets/assets/collectibles/previews/sample_profile_small.png.js";
...
export default function CollectiblesShopCheckoutDetails(recipientUser) {
  ...
  if (flag3) {
    ...
    obj5.children = closure_7(tmp3(4636).Text, obj6);
