...
import _modDef11278 from "../../../../discord_assets/assets/collectibles/previews/sample_profile_small.png.js";
...
function CollectibleProductPreview(arg0) {
  ...
  const obj = {
    style: null,
    children: React5(CollectibleProductPreviewContent, {
      product,
      width: num,
      height: 55,
...
export default function CollectiblesShopCheckoutDetails(recipientUser) {
  ...
  if (flag3) {
    ...
    obj5.children = closure_7(tmp3(4752).Text, obj6);
