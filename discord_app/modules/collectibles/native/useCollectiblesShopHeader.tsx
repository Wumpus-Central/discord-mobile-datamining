...
import CheckmarkSmallIcon3 from "CheckmarkSmallIcon" /* 7147 */;
...
function CollectiblesShopHeaderRight(currentScreen) {
  ...
  const memo = noop.useMemo(() => {
    ...
    obj.action = function action() {
      ...
      obj.analyticsSource = stateFromStores(7196).COLLECTIBLES_SHOP_MOBILE_FEATURED_PAGE_MENU_ITEM;
    ...
    obj.action = function action() {
      ...
      obj.analyticsLocations = items;
      obj.analyticsSource = stateFromStores(7196).COLLECTIBLES_SHOP_MOBILE_SHOP_ALL_MENU_ITEM;
    ...
    obj.action = function action() {
      ...
      obj.analyticsLocations = items;
      obj.analyticsSource = stateFromStores(7196).COLLECTIBLES_SHOP_MOBILE_ORBS_MENU_ITEM;
