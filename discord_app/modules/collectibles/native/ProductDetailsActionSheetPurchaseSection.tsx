...
import closure_6 from "../CollectiblesPurchaseStore.tsx";
        ...
        if (skuId.skuId === closure_1_7.ORB_PROFILE_BADGE) {
          ...
          if (ALL.has(tmp6.skuId)) {
            ...
            obj1 = {
              ...
              orbBalancePriorToPurchase: null,
...
export default function ProductDetailsActionSheetPurchaseSection(product) {
  ...
  if (tmp21Result) {
    ...
    const items6 = [
      callback2(tmp5(tmp3[50]).Defs, obj4),
      callback2(tmp5(tmp3[50]).Rect, { x: "0", y: "0", width: "100", height: "100", fill: "url(#frameEAVignette)" }),
    ];
    obj3[4] = items6;
