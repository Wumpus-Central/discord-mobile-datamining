    ...
    ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(13466, dependencyMap.paths), {
      ...
      onCheckoutSuccess(arg0) {
        ...
        if (product.skuId === constants.ORB_PROFILE_BADGE) {
          ...
          product(4960).pushLazy(balance(1980)(13470, dependencyMap.paths), obj3, modalKey);
          const tmp4Result = product(4960);
        } else {
          ...
          if (ALL.has(product.skuId)) {
            ...
            let flag;
            const tmp4Result3 = product(4724);
            if (first != null) {
              flag = first.consumed;
            }
            if (flag == null) {
            ...
            obj4.onPressExplorePerks = function onPressExplorePerks() {
              ...
              product(4724).hideActionSheet();
            };
            obj4.onPressViewCredits = function onPressViewCredits() {
              navigation.navigate(constants2.PREMIUM_MANAGE_PLAN);
              product(4724).hideActionSheet();
            };
            tmp4Result3.openLazy(balance(1980)(13471, dependencyMap.paths), "FractionalNitroCollectedActionSheet", obj4);
            const tmp10 = balance(1980)(13471, dependencyMap.paths);
          } else {
            ...
            product(11351).open(obj5);
            const tmp4Result4 = product(11351);
          }
        }
        const obj2 = product(4960);
      }
    }, ORB_CHECKOUT_MODAL);
  }, items);
  if (null == price) {
