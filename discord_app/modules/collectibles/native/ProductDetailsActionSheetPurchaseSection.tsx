...
createStyles.containerFramesEA = {
  borderWidth: 1,
  borderStyle: "solid",
...
export default function ProductDetailsActionSheetPurchaseSection(product) {
  ...
  const tmp16 = require("useShouldShowPremiumProfileFrameCTA")({
    location: "ProductDetailsActionSheetPurchaseSection",
    product,
  });
  ...
  if (tmp21Result) {
    obj = {
      colors: ["rgba(160, 86, 242, 0.45)", "rgba(22, 26, 138, 0.45)"],
      locations: [0.0854, 0.7847],
      start: { x: 0, y: 0 },
      end: { x: 1, y: 1 },
      style: null,
      pointerEvents: "none",
    ...
    const items6 = [
      closure_15(tmp5(tmp3[50]).Defs, obj4),
      closure_15(tmp5(tmp3[50]).Rect, { x: "0", y: "0", width: "100", height: "100", fill: "url(#frameEAVignette)" }),
    ];
