// === Module 16164: FeaturedCategorySubblock ===
...
import VisibilitySensorDefault from "VisibilitySensor" /* 16159 */;
...
export default function _default(subblock) {
  ...
  dependencyMap = subblock(9052).useCollectiblesAnalyticsContext();
  const assetUrl = subblock.assetUrl;
  let obj2 = subblock(9052);
  ...
  let obj5 = { onChange: subblock(16152).useTrackProductCardImpression(subblock.categoryStoreListingId, "mobile_home", "featured_block").handleCardVisibilityChange, children: null };
  let obj4 = subblock(16152);
  ...
  let result = subblock(7799).shouldShowLimitedTimeBadge(date);
  if (result) {
    const obj11 = { style: tmp.limitedTimeBadge };
    result = closure_8(tmp2(9116).LimitedTimeBadge, obj11);
  }
  items1[1] = result;
  obj6.children = items1;
  obj5.children = closure_9(subblock(5341).PressableOpacity, obj6);
