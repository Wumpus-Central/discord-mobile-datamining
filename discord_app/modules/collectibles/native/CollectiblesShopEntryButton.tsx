...
function CoachmarkVariant(shopButtonRef) {
  ...
  obj = {
    ref: shopButtonRef,
    IconComponent: navigateToShop(12267).ShopIcon,
...
export default function CollectiblesShopEntryButton(navigateToShop) {
  ...
  const stateFromStores = obj.useStateFromStores(items, () =>
    marketingBySurface.getMarketingBySurface(navigateToShop(14073).CollectiblesMarketingSurface.MOBILE_SHOP_BUTTON),
  );
