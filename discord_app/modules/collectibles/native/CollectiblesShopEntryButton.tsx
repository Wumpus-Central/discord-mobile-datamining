...
function CoachmarkVariant(shopButtonRef) {
  ...
  obj = {
    ref: shopButtonRef,
    IconComponent: navigateToShop(12168).ShopIcon,
...
export default function CollectiblesShopEntryButton(navigateToShop) {
  ...
  const stateFromStores = obj.useStateFromStores(items, () =>
    marketingBySurface.getMarketingBySurface(navigateToShop(14012).CollectiblesMarketingSurface.MOBILE_SHOP_BUTTON),
  );
