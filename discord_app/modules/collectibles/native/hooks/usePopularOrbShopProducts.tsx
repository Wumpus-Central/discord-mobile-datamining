        ...
        try {
          ...
          if (0 === c5) {
            if (arg0 === 1) {
              ...
              let v0 = 2;
              const obj1 = { item_types: [], colors: [], themes: [], orbs_eligible: true, currency: enabled(15150).CollectibleSearchCurrencyFilter.ORBS, offset: 0, limit: 10, sort_type, sort_direction: enabled(1080).CollectibleSearchSortDirection.DESC };
              const obj2 = { timeout };
              c5 = 3;
              c6 = 1;
