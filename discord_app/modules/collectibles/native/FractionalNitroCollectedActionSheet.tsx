...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  let obj2 = { style: tmp.questionIconContainer, onPress: callback, children: tmp15(skuId(11137).CircleQuestionIcon, { style: tmp.questionIcon, color: consumed(576).colors.WHITE }) };
