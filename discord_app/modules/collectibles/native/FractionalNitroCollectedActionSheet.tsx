// === Module 13553: FractionalNitroCollectedActionSheet ===
...
let size = { width: fn(9201).FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET, height: fn(9201).FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET, position: "absolute", top: "50%", left: "50%", transform: null };
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  let obj = skuId(7915);
  obj5.children = tmp15(skuId(11453).CircleQuestionIcon, { style: tmp.questionIcon, color: consumed(576).colors.WHITE });
