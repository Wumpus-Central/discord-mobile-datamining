...
let size = {
  width: fn(8307).FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET,
  height: fn(8307).FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET,
  position: "absolute",
  top: "50%",
  left: "50%",
  transform: null,
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  let obj = skuId(7007);
  obj5.children = tmp15(skuId(10568).CircleQuestionIcon, {
