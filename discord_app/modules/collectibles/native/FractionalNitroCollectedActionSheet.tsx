// === Module 13471: FractionalNitroCollectedActionSheet ===
...
let size = { width: fn(9130).FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET, height: fn(9130).FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET, position: "absolute", top: "50%", left: "50%", transform: null };
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  let obj = skuId(7832);
  obj5.children = tmp15(skuId(11377).CircleQuestionIcon, { style: tmp.questionIcon, color: consumed(576).colors.WHITE });
