...
import _modDef10967 from "../../../../_runtime/metro/10967__.js";
import _modDef10968 from "../../../../_runtime/metro/10968__.js";
...
let size = {
  width: fn(9085).FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET,
  height: fn(9085).FRACTIONAL_NITRO_COIN_SIZE.COLLECTED_SHEET,
  position: "absolute",
  top: "50%",
  left: "50%",
  transform: null,
...
export default function FractionalNitroCollectedActionSheet(skuId) {
  ...
  const memo = noop.useMemo(() => {
    if (consumed) {
      ...
      if (obj2.isThemeDark(closure_3)) {
        let tmp8Result = _modDef10967;
      } else {
        tmp8Result = _modDef10968;
      }
  ...
  if (consumed) {
    ...
    let tmp12Result = closure_9(tmp2(7627), obj2);
    let tmp15 = closure_9;
  } else {
    let obj3 = { skuId };
  ...
  let obj = skuId(7783);
  obj5.children = tmp15(skuId(11359).CircleQuestionIcon, {
