...
function OrbsBadgeCoachmarkImg() {
  ...
  obj = { uri: require("../../../../discord_assets/assets/orbs/orbs_badge_asset.png.js") };
  obj[0] = obj;
  obj[1] = tmp.coachmarkImage;
  obj[1] = <closure_5 uri={require("../../../../discord_assets/assets/orbs/orbs_badge_asset.png.js")} />;
  return <closure_4 uri={require("../../../../discord_assets/assets/orbs/orbs_badge_asset.png.js")} />;
}
...
export default function OrbsBadgeCoachmark(badgeRef) {
  ...
  const coachmark = require("../../../design/components/Coachmark/native/useCoachmark.native.tsx") /* useCoachmark */.useCoachmark(badgeRef.badgeRef, merged);
  return null;
};
