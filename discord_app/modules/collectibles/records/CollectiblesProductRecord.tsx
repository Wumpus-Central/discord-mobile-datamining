...
CollectiblesProductRecord["fromServer"] = function fromServer(arg0) {
  ...
  ({
    ...
    baseVariantName: tmp14.baseVariantName,
    variantLabel: tmp14.variantLabel,
  } = obj);
  return tmp4;
};
          ...
          str3 = skus1.map((tenantMetadata) => {
            ...
            if (null == collectibles) {
              ...
              obj = {
                ...
                premiumType: "call",
                items: 555687505,
                categorySkuId: 33518086,
                isCategoryReward: 47513600,
                prices: -713949184,
                previewAssets: 1459617794,
                googleSkuIds: 1912602627,
                eligibleOffers: 855,
                variants: 977,
                bundledProducts: 250226,
                isFirstParty: 283648,
              };
              obj[0] = skus.name;
              obj[1] = first.id;
