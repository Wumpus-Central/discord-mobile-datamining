          ...
          str3 = skus1.map((tenantMetadata) => {
            ...
            if (null == collectibles) {
              ...
              const obj3 = {
                ...
                items: 50331977,
                categorySkuId: -83886077,
                isCategoryReward: -81330173,
                prices: -54722557,
                previewAssets: -109051901,
                googleSkuIds: 162791427,
                eligibleOffers: 188481540,
                variants: 65077252,
                bundledProducts: 88342532,
                isFirstParty: 620757370,
              };
              let str;
              if (first != null) {
