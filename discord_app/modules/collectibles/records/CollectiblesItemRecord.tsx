// === Module 7238: createCollectiblesItemsFromServerResponse ===

// Module 7238 (createCollectiblesItemsFromServerResponse)
import CollectiblesItemType from "CollectiblesItemType" /* 1951 */;
import closure_2 from "fromServer" /* 7239 */;
import closure_3 from "fromServer" /* 1949 */;
import closure_4 from "fromServer" /* 7240 */;
import closure_5 from "fromServer" /* 7241 */;
import closure_6 from "fromServer" /* 7242 */;
    ...
    if (productLine.type === constants2.BUNDLE) {
      ...
      if (null != item) {
        ...
        if (CollectiblesItemType.CollectiblesItemType.AVATAR_DECORATION === type) {
          ...
          obj[1] = tmp28;
          return obj;
        } else if (tmp4(1951).CollectiblesItemType.NAMEPLATE === type) {
          ...
          obj2[1] = tmp22;
          return obj2;
        } else if (tmp4(1951).CollectiblesItemType.PROFILE_EFFECT === type) {
          ...
          obj5[1] = tmp12;
          return obj5;
        } else if (tmp4(1951).CollectiblesItemType.PROFILE_FRAME === type) {
          obj = { type: "single", item: null };
