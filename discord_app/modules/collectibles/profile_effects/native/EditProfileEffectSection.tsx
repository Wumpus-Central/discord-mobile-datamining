// === Module 14905: EditProfileEffectSection ===
...
import ProfileEffectDefault from "ProfileEffect" /* 9082 */;
...
import useProfileEffectSections from "useProfileEffectSections" /* 14904 */;
...
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(13474).GUTTER_SIZE }, rowSpacer: null, profileEffect: null, sampleProfile: null };
...
obj.sampleProfile = { aspectRatio: fn(9079).SAMPLE_PROFILE_ASPECT_RATIO, width: "100%" };
