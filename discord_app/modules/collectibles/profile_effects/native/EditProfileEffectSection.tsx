...
import _modDef9104 from "../../../../../discord_assets/assets/collectibles/previews/sample_profile_small-2x.png.js";
...
let obj = {
  row: {
    ...
    paddingHorizontal: fn(13474).GUTTER_SIZE,
  },
  rowSpacer: null,
  profileEffect: null,
  sampleProfile: null,
...
const memoResult1 = noop.memo((isSelected) => {
  ...
  const items3 = [
    timestampProducer(FastImageDefault, obj3),
    timestampProducer(ProfileEffectDefault, {
      skuId: item.skuId,
      bannerAdjustment: 0,
      useThumbnail: true,
