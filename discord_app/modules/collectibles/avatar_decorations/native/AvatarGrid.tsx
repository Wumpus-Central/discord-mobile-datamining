...
export default function AvatarGrid(arg0) {
  ...
  obj = { size: require("../../../../design/void/native.tsx") /* Button */.AvatarSizes.NORMAL };
  const merged = Object.assign(arg0);
  const items = [callback(GridAvatar, obj), ];
  const merged1 = Object.assign(arg0);
  items[1] = callback(GridAvatar, { size: require("../../../../design/void/native.tsx") /* Button */.AvatarSizes.NORMAL, showStatus: true });
  obj[1] = items;
  const items1 = [callback2(View, obj), ];
  const obj2 = { style: tmp.avatarRow, children: null };
  const obj1 = { size: require("../../../../design/void/native.tsx") /* Button */.AvatarSizes.NORMAL, showStatus: true };
  const merged2 = Object.assign(arg0);
  const items2 = [callback(GridAvatar, { size: require("../../../../design/void/native.tsx") /* Button */.AvatarSizes.REFRESH_MEDIUM_32 }), ];
  const obj3 = { size: require("../../../../design/void/native.tsx") /* Button */.AvatarSizes.REFRESH_MEDIUM_32 };
  const merged3 = Object.assign(arg0);
  items2[1] = callback(GridAvatar, { size: require("../../../../design/void/native.tsx") /* Button */.AvatarSizes.REFRESH_MEDIUM_32, showStatus: true });
  obj2[1] = items2;
