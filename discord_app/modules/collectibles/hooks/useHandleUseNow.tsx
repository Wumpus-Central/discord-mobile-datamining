// === Module 11085: hooks/useHandleUseNow ===
        ...
        if (0 === c6) {
          if (arg0 === 1) {
            ...
            if (!memo) {
              ...
              c6 = 3;
              c7 = 1;
              const obj4 = { value: pendingProfileEffect(pendingProfileFrame[8]).saveProfileChanges(profileChangesForUpdateRequest), done: false };
              return obj4;
            }
          }
        } else if (1 !== tmp8) {
