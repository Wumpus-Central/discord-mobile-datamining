// === Module 14171: EditNameplateSection ===
...
import useNameplateSections from "useNameplateSections" /* 14170 */;
...
let obj = { row: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: fn(12727).GUTTER_SIZE }, rowSpacer: null, nameplate: null };
...
const memoResult1 = noop.memo((nameplate) => {
  ...
  obj2.style = items2;
  obj.children = closure_6(setSelectedNameplate(8273), obj2);
  return closure_6(nameplate(12728).EditCollectiblesListItemProduct, obj);
});
