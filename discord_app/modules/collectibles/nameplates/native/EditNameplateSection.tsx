...
const memoResult1 = importAllResult.memo((nameplate) => {
  ...
  obj[5] = callback(setSelectedNameplate(9436), { nameplate: memo, fullOpacity: true, isSquarePreview: true, style: items2 });
  return callback(nameplate(8331).EditCollectiblesListItemProduct, obj);
});
