...
createCacheKey[3] = {
  ...
  top: 0,
  bottom: 0,
  color: ThemesDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND,
};
...
const result = require("set").fileFinishedImporting(
  "modules/collectibles/nameplates/native/NameplateProductPreview.tsx",
);
