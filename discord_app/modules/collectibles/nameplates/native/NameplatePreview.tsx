...
export const NameplatePreview = function NameplatePreview(aria_hidden) {
  ...
  pendingAvatarDecoration = guildId(8416)({ guildId }).pendingAvatarDecoration;
  let obj2 = user(589);
  ...
  const items3 = [callback(guildId(9537), obj1), , ];
  ...
  if (tmp19Result) {
    ...
    obj4[4] = tmp4(9618).EffectDisplayType.STATIC;
    obj4[6] = pendingDisplayNameStyles;
    tmp19Result = tmp19(tmp7(9617), obj4);
    const tmp7Result = tmp7(9617);
  }
  ...
  if (tmp19Result) {
    ...
    tmp19Result = tmp19(tmp4(4376).Text, obj5);
  }
