...
export const NameplatePreview = function NameplatePreview(aria_hidden) {
  ...
  pendingAvatarDecoration = guildId(8483)({ guildId }).pendingAvatarDecoration;
  let obj2 = user(589);
  ...
  const items3 = [callback(guildId(9605), obj1), , ];
  ...
  if (tmp19Result) {
    ...
    obj4[4] = tmp4(9686).EffectDisplayType.STATIC;
    obj4[6] = pendingDisplayNameStyles;
    tmp19Result = tmp19(tmp7(9685), obj4);
    const tmp7Result = tmp7(9685);
  }
  ...
  if (tmp19Result) {
    ...
    tmp19Result = tmp19(tmp4(4440).Text, obj5);
  }
