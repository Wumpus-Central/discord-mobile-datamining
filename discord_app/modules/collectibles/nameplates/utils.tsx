...
export const getNameplateData = function getNameplateData(nameplate) {
  ...
  if (null != nameplate) {
    ...
    let INVALID_NAMEPLATE_PALETTE = require("constants.tsx") /* NAMEPLATE_PALETTES */.NAMEPLATE_PALETTES[nameplate.palette];
  ...
  if (0 === product.items.length) {
    ...
    if (isNameplateRecord(first)) {
      ...
      if (null != first) {
        ...
        let INVALID_NAMEPLATE_PALETTE = require("constants.tsx") /* NAMEPLATE_PALETTES */.NAMEPLATE_PALETTES[palette];
        if (INVALID_NAMEPLATE_PALETTE == null) {
          INVALID_NAMEPLATE_PALETTE = tmp2(1902).INVALID_NAMEPLATE_PALETTE;
        }
        obj[3] = INVALID_NAMEPLATE_PALETTE;
...
export const getBackgroundGradientColors = function getBackgroundGradientColors(palette, arg1) {
  let tmp3 = palette.name !== require("constants.tsx") /* NAMEPLATE_PALETTES */.INVALID_PALETTE_KEY;
  if (tmp3) {
...
export const isValidPalette = function isValidPalette(name) {
  let tmp3 = name.name !== require("constants.tsx") /* NAMEPLATE_PALETTES */.INVALID_PALETTE_KEY;
  if (tmp3) {
    let tmp4 = name.name !== require("constants.tsx") /* NAMEPLATE_PALETTES */.CUSTOM_PALETTE_KEY;
    if (!tmp4) {
...
export const getNameplatePalette = function getNameplatePalette(arg0) {
  let INVALID_NAMEPLATE_PALETTE = require("constants.tsx") /* NAMEPLATE_PALETTES */.NAMEPLATE_PALETTES[arg0];
  if (INVALID_NAMEPLATE_PALETTE == null) {
    INVALID_NAMEPLATE_PALETTE = require("constants.tsx") /* NAMEPLATE_PALETTES */.INVALID_NAMEPLATE_PALETTE;
  }
  return INVALID_NAMEPLATE_PALETTE;
};
export const parseFirstFrame = function parseFirstFrame(arg0) {
  const size = require("../../../../_runtime/01904_decodeImage.js").decode(arg0);
  const obj = require("../../../../_runtime/01904_decodeImage.js");
  const element = <canvas />;
  ({ width: obj3.width, height: obj3.height } = size);
  const context = element.getContext("2d");
  const uint8ClampedArray = new Uint8ClampedArray(require("../../../../_runtime/01904_decodeImage.js").toRGBA8(size)[0]);
...
export const getNameplateSampleUsers = function getNameplateSampleUsers() {
  ...
  obj[0] = intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.SbKDHi);
  obj[0] = obj;
  ...
  obj[0] = intl2.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["LMSo+F"]);
  obj[1] = obj;
  ...
  obj1[0] = intl3.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.g5Dumi);
  obj[2] = obj1;
  ...
  obj2[0] = intl4.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.p5Z3Ol);
  obj[3] = obj2;
  ...
  obj3[0] = intl5.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.ncslie);
  obj[4] = obj3;
  return obj;
};