...
const items = [
  fn(8337).ProfileFrameLayerType.STAPLE,
  fn(8337).ProfileFrameLayerType.RAIL,
  fn(8337).ProfileFrameLayerType.BORDER,
];
const set = new Set(items);
const items1 = [
  fn(8338).ProfileFrameLayerAnchor.TOP,
  fn(8338).ProfileFrameLayerAnchor.BOTTOM,
  fn(8338).ProfileFrameLayerAnchor.CENTER,
];
...
export const FOLDER_ORDER_MAP = {
  foreground: fn(8336).ProfileFrameLayerOrder.FRONT,
  background: fn(8336).ProfileFrameLayerOrder.BACK,
};
