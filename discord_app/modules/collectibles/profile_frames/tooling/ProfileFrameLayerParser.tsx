...
const items = [
  fn(8552).ProfileFrameLayerType.STAPLE,
  fn(8552).ProfileFrameLayerType.RAIL,
  fn(8552).ProfileFrameLayerType.BORDER,
];
const set = new Set(items);
const items1 = [
  fn(8553).ProfileFrameLayerAnchor.TOP,
  fn(8553).ProfileFrameLayerAnchor.BOTTOM,
  fn(8553).ProfileFrameLayerAnchor.CENTER,
];
...
export const FOLDER_ORDER_MAP = {
  foreground: fn(8551).ProfileFrameLayerOrder.FRONT,
  background: fn(8551).ProfileFrameLayerOrder.BACK,
};
