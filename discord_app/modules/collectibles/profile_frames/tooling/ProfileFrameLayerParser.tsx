...
const items = [
  fn(8481).ProfileFrameLayerType.STAPLE,
  fn(8481).ProfileFrameLayerType.RAIL,
  fn(8481).ProfileFrameLayerType.BORDER,
];
const set = new Set(items);
const items1 = [
  fn(8482).ProfileFrameLayerAnchor.TOP,
  fn(8482).ProfileFrameLayerAnchor.BOTTOM,
  fn(8482).ProfileFrameLayerAnchor.CENTER,
];
...
export const FOLDER_ORDER_MAP = {
  foreground: fn(8480).ProfileFrameLayerOrder.FRONT,
  background: fn(8480).ProfileFrameLayerOrder.BACK,
};
