...
const items = [
  fn(8476).ProfileFrameLayerType.STAPLE,
  fn(8476).ProfileFrameLayerType.RAIL,
  fn(8476).ProfileFrameLayerType.BORDER,
];
const set = new Set(items);
const items1 = [
  fn(8477).ProfileFrameLayerAnchor.TOP,
  fn(8477).ProfileFrameLayerAnchor.BOTTOM,
  fn(8477).ProfileFrameLayerAnchor.CENTER,
];
...
export const FOLDER_ORDER_MAP = {
  foreground: fn(8475).ProfileFrameLayerOrder.FRONT,
  background: fn(8475).ProfileFrameLayerOrder.BACK,
};
