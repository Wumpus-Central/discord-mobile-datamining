...
const items = [
  fn(8477).ProfileFrameLayerType.STAPLE,
  fn(8477).ProfileFrameLayerType.RAIL,
  fn(8477).ProfileFrameLayerType.BORDER,
];
const set = new Set(items);
const items1 = [
  fn(8478).ProfileFrameLayerAnchor.TOP,
  fn(8478).ProfileFrameLayerAnchor.BOTTOM,
  fn(8478).ProfileFrameLayerAnchor.CENTER,
];
...
export const FOLDER_ORDER_MAP = {
  foreground: fn(8476).ProfileFrameLayerOrder.FRONT,
  background: fn(8476).ProfileFrameLayerOrder.BACK,
};
