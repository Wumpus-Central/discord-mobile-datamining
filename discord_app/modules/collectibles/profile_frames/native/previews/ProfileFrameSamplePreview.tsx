...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  ({ overflowTop, overflowBottom, overflowHorizontal } = require("../../scaleProfileFrame.tsx")(profileFrame, result));
  ...
  const tmp5 = require("../../scaleProfileFrame.tsx")(profileFrame, result);
  const tmp6 = require;
  obj[3] = require("../../../../../../discord_common/js/shared/shared-constants/ProfileFrameLayerOrder.tsx") /* ProfileFrameLayerOrder */.ProfileFrameLayerOrder.BACK;
  obj[4] = result;
  obj[5] = previewHeight;
  let tmp12 = callback(require("../ProfileFrame.tsx"), obj);
  const xs = require("../../../../../../discord_common/js/packages/tokens/native.tsx").radii.xs;
  ...
  const tmp9 = require("../ProfileFrame.tsx");
  ...
  obj11[0] = require("../../../../../../discord_assets/assets/collectibles/previews/sample_profile_small-2x.png.js");
  obj10[0] = obj11;
