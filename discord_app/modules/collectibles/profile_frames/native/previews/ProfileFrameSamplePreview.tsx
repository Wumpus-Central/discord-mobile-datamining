...
createStyles.sampleProfile = { width: "100%", aspectRatio: fn(8832).SAMPLE_PROFILE_ASPECT_RATIO };
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  obj.children = timestampProducer(React4, { style: { marginTop: overflowTop, marginBottom: overflowBottom, marginHorizontal: overflowHorizontal, flex: 1 }, children: tmp12 });
