...
const createCacheKey = { flex: 1, overflow: "hidden", borderWidth: 1, borderColor: ThemesDefault.colors.BORDER_NORMAL, borderRadius: ThemesDefault.radii.xs };
createCacheKey[1] = createCacheKey;
createCacheKey[2] = { width: "100%", aspectRatio: require("SAMPLE_PROFILE_ASPECT_RATIO").SAMPLE_PROFILE_ASPECT_RATIO };
let closure_9 = createCacheKey.createStyles(createCacheKey);
let result = require("obj132").fileFinishedImporting("modules/collectibles/profile_frames/native/previews/ProfileFrameSamplePreview.tsx");
...
export default function ProfileFrameSamplePreview(previewWidth) {
  ...
  let tmp3Result = preloadDefault;
  obj11[0] = metadataDefault;
  obj10[0] = obj11;
  obj10[1] = tmp.sampleProfile;
  obj9[1] = callback(tmp3Result, obj10);
  items2[1] = callback(closure_4, obj9);
  const obj12 = { frame: profileFrame, filterLayer, profileThemeType: UserProfileThemeTypes.PREVIEW, frameOrder: null, containerWidth: null, containerHeight: null };
  tmp3Result = ProfileFrameLayerDefault;
