...
const result = obj132.fileFinishedImporting("modules/devtools/DevToolsGuildPowerupsConstants.tsx");
...
export const getGuildDCString = function getGuildDCString(arg0) {
  ...
  } else if (DismissibleContent.DismissibleGuildContent.GUILD_POWERUP_LEVEL_2_COACHMARK === arg0) {
    return "GUILD_POWERUP_LEVEL_2_COACHMARK";
  } else if (DismissibleContent.DismissibleGuildContent.GUILD_POWERUP_LEVEL_3_COACHMARK === arg0) {
    return "GUILD_POWERUP_LEVEL_3_COACHMARK";
  } else if (DismissibleContent.DismissibleGuildContent.GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK === arg0) {
    return "GUILD_POWERUP_SINGLE_SKU_PURCHASE_COACHMARK";
  } else if (DismissibleContent.DismissibleGuildContent.GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK === arg0) {
    return "GUILD_POWERUP_CHOICE_SKU_PURCHASE_COACHMARK";
  } else if (DismissibleContent.DismissibleGuildContent.ADOPT_CLAN_IDENTITY_NOTICE === arg0) {
