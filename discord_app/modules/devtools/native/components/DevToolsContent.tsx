// === Module 13716: DevToolsContentSortButtons ===
...
function DevToolsContentSortButtons(arg0) {
  ...
  items[1] = start;
  obj[2] = items;
  obj[5] = closure_10(require(14169) /* ArrowSmallUpIcon */.ArrowSmallUpIcon, {});
  const items1 = [closure_10(require(4783) /* PressableBase */.PressableOpacity, obj), ];
  obj = {
    onPress() {
      const result = outer1_0(outer1_2[14]).triggerHapticFeedback(outer1_0(outer1_2[14]).HapticFeedbackTypes.IMPACT_MEDIUM);
      const obj = outer1_0(outer1_2[14]);
  ...
  items2[1] = end;
  obj[2] = items2;
  obj[5] = closure_10(require(14920) /* ArrowSmallDownIcon */.ArrowSmallDownIcon, {});
  items1[1] = closure_10(require(4783) /* PressableBase */.PressableOpacity, obj);
  obj[1] = items1;
...
const memoResult = importAllResult.memo((arg0) => {
  ...
  const items = [label, callback2(require(4251) /* Text */.Text, { variant: "text-xs/semibold", children: value })];
  obj[2] = items;
  return callback3(require(4251) /* Text */.Text, obj);
});
...
const memoResult1 = importAllResult.memo(function DevToolsContent(arg0) {
  ...
  importDefault = importDefault(13717)().map((arg0) => {
    let tmp;
    [tmp] = arg0;
  ...
  const arr4 = importDefault(13717)();
  [c2, c3] = callback(arr5.useState(false), 2);
  arr5 = importDefault(13717)();
  ...
  const tmp8 = callback2(_require(5620).TableRowGroup, obj);
  let tmp7Result = tmp8;
  if (!embedded) {
