...
import useStateFromStoresPerformanceDebugging from "../../../../../../discord_common/js/packages/flux/useStateFromStoresPerformanceDebugging.tsx";
...
export const DevToolsProfilingUseStateFromStores = function DevToolsProfilingUseStateFromStores() {
  ...
  const children = [
    closure_4(value(str[5]).TableRowGroup, {
      title: "useStateFromStores Profiling",
      hasIcons: false,
      children: closure_4(value(str[6]).TableSwitchRow, {
  ...
  if (value) {
    ...
    const obj23 = {
      ...
      leadingIcon: tmp(tmp2[11]).LettersIcon,
      trailingIcon: tmp(tmp2[12]).TrashIcon,
