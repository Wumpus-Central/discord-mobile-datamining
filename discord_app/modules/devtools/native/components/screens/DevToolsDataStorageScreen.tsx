...
function DevToolsPersistedStoresActionSheet(store) {
  ...
  const obj3 = {
    hasIcons: false,
    children: jsx(store(7446).ActionSheetRow, {
      variant: "danger",
  ...
  obj.children = jsx(store(7446).ActionSheetRow.Group, {
    hasIcons: false,
    children: jsx(store(7446).ActionSheetRow, {
      variant: "danger",
      label: "Clear persisted store",
  ...
  return jsx(store(7444).ActionSheet, {
    header: jsx(store(7396).BottomSheetTitleHeader, { title: store.getName() }),
    children: null,
  });
}
