// === Module 15959: DevToolsDataStorageScreen ===
...
function DevToolsPersistedStoresActionSheet(store) {
  ...
  return jsx(store(7528).ActionSheet, { header: jsx(store(7480).BottomSheetTitleHeader, { title: store.getName() }), children: null });
}
