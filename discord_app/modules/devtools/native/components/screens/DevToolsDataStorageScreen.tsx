...
function DevToolsPersistedStoresActionSheet(store) {
  ...
  const obj = { header: jsx(store(7480).BottomSheetTitleHeader, { title: store.getName() }), children: null };
  const obj3 = {
    hasIcons: false,
    children: jsx(store(7530).ActionSheetRow, {
      variant: "danger",
  ...
  obj.children = jsx(store(7530).ActionSheetRow.Group, {
    hasIcons: false,
    children: jsx(store(7530).ActionSheetRow, {
      variant: "danger",
      label: "Clear persisted store",
  ...
  return jsx(store(7528).ActionSheet, {
    header: jsx(store(7480).BottomSheetTitleHeader, { title: store.getName() }),
    children: null,
  });
}
        ...
        const obj = {
          ...
          onPress() {
            ActionSheetActionCreatorsDefault.openLazy(
              Promise.resolve({ default: DevToolsPersistedStoresActionSheet }),
