// === Module 15905: DevToolsDataStorageScreen ===
...
function DevToolsPersistedStoresActionSheet(store) {
  ...
  return jsx(store(7444).ActionSheet, { header: jsx(store(7396).BottomSheetTitleHeader, { title: store.getName() }), children: null });
}
