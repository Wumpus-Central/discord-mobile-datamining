...
function DevToolsPersistedStoresActionSheet(store) {
  ...
  obj = { title: null };
  obj[0] = store.getName();
  obj[0] = jsx(store(5436).BottomSheetTitleHeader, { title: null });
  obj = { hasIcons: false, children: null };
  obj[1] = jsx(store(5806).ActionSheetRow, {
    variant: "danger",
  ...
  obj[1] = jsx(store(5806).ActionSheetRow.Group, { hasIcons: false, children: null });
  return jsx(store(5804).ActionSheet, { hasIcons: false, children: null });
}
...
let closure_12 = importAllResult.memo(() => jsx(TableRowInner.TableRow, {
  ...
  onPress() {
    ...
    callback(4062).open({ key: "disable_database_and_remove", content: "Database has been removed." });
  }
}));
let closure_13 = importAllResult.memo(() => {
  ...
  return jsx(_TableRowInner.TableRow, {
    label: "View Cache Stats",
    end: true,
    onPress() {
      navigation.navigate("cacheStats");
