// === Module 12070: DevToolsExperimentsScreen ===
...
import ExperimentDevToolsUtils from "ExperimentDevToolsUtils" /* 8140 */;
import useExperimentAssignments from "useExperimentAssignments" /* 12068 */;
...
function GuildExperimentDebugView(arg0) {
  ...
  obj6.subLabel = str;
  const items1 = [closure_11(obj3(5906).TableRowGroup, { title: "Overview", hasIcons: false, children: closure_11(obj3(5824).TableRow, obj6) }), closure_11(obj3(1177).Spacer, { size: 16 }), , , , , , , ];
  ...
  items1[4] = closure_11(obj3(5906).TableRowGroup, { title: "Server Descriptor", hasIcons: false, children: closure_11(obj3(5824).TableRow, { label: str3 }) });
  items1[5] = closure_11(obj3(1177).Spacer, { size: 16 });
  if (null != override) {
    const _JSON2 = JSON;
    str2 = JSON.stringify(override, undefined, 2);
  }
  const obj10 = { title: "Server Descriptor", hasIcons: false, children: closure_11(obj3(5824).TableRow, { label: str3 }) };
  items1[6] = closure_11(obj3(5906).TableRowGroup, { title: "Override Descriptor", hasIcons: false, children: closure_11(obj3(5824).TableRow, { label: str2 }) });
  ...
  constructor(arg0) {
    ...
    callback = closure_4.useCallback(() => {
      ClipboardUtils.copy(uRLForExperiment, () => {
        ...
        obj.open({ key: "experiment-link-copied", content: "Copied experiment link", IconComponent: onCopyLink(4716).CircleCheckIcon, iconColor: "status-positive" });
        if (closure_1_0 != null) {
          closure_1_0();
        }
      });
