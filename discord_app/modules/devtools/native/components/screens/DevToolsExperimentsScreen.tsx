...
function GuildExperimentDebugView(arg0) {
  ...
  obj6.subLabel = str;
  const items1 = [
    closure_11(obj3(5999).TableRowGroup, {
      title: "Overview",
      hasIcons: false,
      children: closure_11(obj3(5917).TableRow, obj6),
    }),
  ...
  items1[4] = closure_11(obj3(5999).TableRowGroup, {
    title: "Server Descriptor",
    hasIcons: false,
    children: closure_11(obj3(5917).TableRow, { label: str3 }),
  });
  ...
  items1[6] = closure_11(obj3(5999).TableRowGroup, {
    title: "Override Descriptor",
    hasIcons: false,
    children: closure_11(obj3(5917).TableRow, { label: str2 }),
  });
    ...
    callback = closure_4.useCallback(() => {
      ClipboardUtils.copy(uRLForExperiment, () => {
        ...
        obj.open({
          ...
          IconComponent: onCopyLink(4792).CircleCheckIcon,
