...
function GuildExperimentDebugView(arg0) {
  ...
  obj6.subLabel = str;
  const items1 = [
    closure_11(obj3(5992).TableRowGroup, {
      title: "Overview",
      hasIcons: false,
      children: closure_11(obj3(5910).TableRow, obj6),
    }),
  ...
  items1[4] = closure_11(obj3(5992).TableRowGroup, {
    title: "Server Descriptor",
    hasIcons: false,
    children: closure_11(obj3(5910).TableRow, { label: str3 }),
  });
  ...
  items1[6] = closure_11(obj3(5992).TableRowGroup, {
    title: "Override Descriptor",
    hasIcons: false,
    children: closure_11(obj3(5910).TableRow, { label: str2 }),
  });
  items1[7] = closure_11(obj3(1177).Spacer, { size: 16 });
  if (0 === mapped.length) {
    let mapped3 = closure_11(tmp20(5910).TableRow, { label: "none" });
  } else {
