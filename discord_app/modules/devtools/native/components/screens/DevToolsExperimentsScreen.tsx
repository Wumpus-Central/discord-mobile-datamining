...
function GuildExperimentDebugView(arg0) {
  ...
  obj6.subLabel = str;
  const items1 = [
    closure_11(obj3(5857).TableRowGroup, {
      title: "Overview",
      hasIcons: false,
      children: closure_11(obj3(5775).TableRow, obj6),
    }),
  ...
  items1[4] = closure_11(obj3(5857).TableRowGroup, {
    title: "Server Descriptor",
    hasIcons: false,
    children: closure_11(obj3(5775).TableRow, { label: str3 }),
  });
  ...
  items1[6] = closure_11(obj3(5857).TableRowGroup, {
    title: "Override Descriptor",
    hasIcons: false,
    children: closure_11(obj3(5775).TableRow, { label: str2 }),
  });
  items1[7] = closure_11(obj3(1177).Spacer, { size: 16 });
  if (0 === mapped.length) {
    let mapped3 = closure_11(tmp20(5775).TableRow, { label: "none" });
  } else {
    ...
    callback = closure_4.useCallback(() => {
      ClipboardUtils.copy(uRLForExperiment, () => {
        ...
        obj.open({
          ...
          IconComponent: onCopyLink(4681).CircleCheckIcon,
