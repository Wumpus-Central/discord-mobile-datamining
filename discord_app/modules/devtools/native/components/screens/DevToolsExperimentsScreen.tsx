// === Module 11608: UserExperimentDebugView ===
...
import useExperimentAssignment from "useExperimentAssignment" /* 11606 */;
...
function GuildExperimentDebugView(arg0) {
  ...
  const tmp18 = View;
  obj1[1] = str;
  const items1 = [closure_11(obj(6000).TableRowGroup, { title: "Overview", hasIcons: false, children: closure_11(obj(5607).TableRow, obj1) }), closure_11(obj(1296).Spacer, { size: 16 }), , , , , , , ];
  ...
  items1[4] = closure_11(obj(6000).TableRowGroup, { title: "Server Descriptor", hasIcons: false, children: closure_11(obj(5607).TableRow, { label: str3 }) });
  items1[5] = closure_11(obj(1296).Spacer, { size: 16 });
  if (null != override) {
    const _JSON2 = JSON;
    str2 = JSON.stringify(override, undefined, 2);
  }
  const obj5 = { title: "Server Descriptor", hasIcons: false, children: closure_11(obj(5607).TableRow, { label: str3 }) };
  items1[6] = closure_11(obj(6000).TableRowGroup, { title: "Override Descriptor", hasIcons: false, children: closure_11(obj(5607).TableRow, { label: str2 }) });
