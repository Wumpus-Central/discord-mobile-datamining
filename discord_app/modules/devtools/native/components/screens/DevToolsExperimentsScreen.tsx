...
function GuildExperimentDebugView(arg0) {
  ...
  obj1.subLabel = str;
  const items1 = [closure_11(obj(5701).TableRowGroup, { title: "Overview", hasIcons: false, children: closure_11(obj(5619).TableRow, obj1) }), closure_11(obj(1178).Spacer, { size: 16 }), , , , , , , ];
  obj3 = { title: "Guild Assignments", hasIcons: false, children: null };
  const obj2 = { title: "Overview", hasIcons: false, children: closure_11(obj(5619).TableRow, obj1) };
  obj3.children = closure_11(obj(5619).TableRow, { label: items.join("\n") });
  items1[2] = closure_11(obj(5701).TableRowGroup, obj3);
  ...
  items1[4] = closure_11(obj(5701).TableRowGroup, { title: "Server Descriptor", hasIcons: false, children: closure_11(obj(5619).TableRow, { label: str3 }) });
  items1[5] = closure_11(obj(1178).Spacer, { size: 16 });
  if (null != override) {
    const _JSON2 = JSON;
    str2 = JSON.stringify(override, undefined, 2);
  }
  const obj5 = { title: "Server Descriptor", hasIcons: false, children: closure_11(obj(5619).TableRow, { label: str3 }) };
  items1[6] = closure_11(obj(5701).TableRowGroup, { title: "Override Descriptor", hasIcons: false, children: closure_11(obj(5619).TableRow, { label: str2 }) });
  items1[7] = closure_11(obj(1178).Spacer, { size: 16 });
  if (0 === mapped.length) {
    mapped = closure_11(tmp20(5619).TableRow, { label: "none" });
  } else {
  ...
  items1[8] = closure_11(obj(5701).TableRowGroup, { title: "Recent Exposures", hasIcons: false, children: mapped });
  obj.children = items1;
  ...
  constructor(arg0) {
    ...
    callback = closure_4.useCallback(() => {
      ClipboardUtils.copy(uRLForExperiment, () => {
        uRLForExperiment(4272);
        const obj = { key: "experiment-link-copied", content: "Copied experiment link", IconComponent: onCopyLink(4534).CircleCheckIcon, iconColor: "status-positive" };
        obj.open(obj);
        if (closure_1_0 != null) {
          closure_1_0();
        }
