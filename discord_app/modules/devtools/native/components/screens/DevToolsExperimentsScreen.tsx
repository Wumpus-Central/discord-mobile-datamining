...
function UserExperimentDebugView(id) {
  ...
  obj6.subLabel = str4;
  const items = [
    closure_1_11(TableRowGroup.TableRowGroup, {
      title: "Overview",
      hasIcons: false,
      children: closure_1_11(TableRow.TableRow, obj6),
    }),
    closure_1_11(native.Spacer, { size: 16 }),
    ,
    ,
    ,
    ,
  ...
  items[2] = closure_1_11(TableRowGroup.TableRowGroup, {
    title: "Server Descriptor",
    hasIcons: false,
    children: closure_1_11(TableRow.TableRow, { label: str6 }),
  });
  ...
  items[4] = closure_1_11(TableRowGroup.TableRowGroup, {
    title: "Override Descriptor",
    hasIcons: false,
    children: closure_1_11(TableRow.TableRow, { label: json }),
  });
...
function GuildExperimentDebugView(arg0) {
  ...
  obj6.subLabel = str;
  const items1 = [
    closure_11(obj3(5994).TableRowGroup, {
      title: "Overview",
      hasIcons: false,
      children: closure_11(obj3(5912).TableRow, obj6),
    }),
    closure_11(obj3(1177).Spacer, { size: 16 }),
    ,
    ,
    ,
    ,
  ...
  const obj7 = { title: "Overview", hasIcons: false, children: closure_11(obj3(5912).TableRow, obj6) };
  obj8.children = closure_11(obj3(5912).TableRow, { label: items.join("\n") });
  items1[2] = closure_11(obj3(5994).TableRowGroup, obj8);
  ...
  items1[4] = closure_11(obj3(5994).TableRowGroup, {
    title: "Server Descriptor",
    hasIcons: false,
    children: closure_11(obj3(5912).TableRow, { label: str3 }),
  });
  ...
  items1[6] = closure_11(obj3(5994).TableRowGroup, {
    title: "Override Descriptor",
    hasIcons: false,
    children: closure_11(obj3(5912).TableRow, { label: str2 }),
  });
  items1[7] = closure_11(obj3(1177).Spacer, { size: 16 });
  if (0 === mapped.length) {
    let mapped3 = closure_11(tmp20(5912).TableRow, { label: "none" });
  } else {
    mapped3 = mapped.map((label) =>
      closure_1_11(obj3(dependencyMap[23]).TableRow, { label, labelLineClamp: 1 }, label),
    );
  }
  items1[8] = closure_11(obj3(5994).TableRowGroup, { title: "Recent Exposures", hasIcons: false, children: mapped3 });
  ...
  constructor(arg0) {
    ...
    callback = closure_4.useCallback(() => {
      ClipboardUtils.copy(uRLForExperiment, () => {
        const obj = uRLForExperiment(4525);
        obj.open({
          key: "experiment-link-copied",
          content: "Copied experiment link",
          IconComponent: onCopyLink(4788).CircleCheckIcon,
    ...
    obj10 = {
      ...
      children: options.map((item, index) => {
        ...
        return closure_1_11(onCopyLink(5912).TableRow, { variant, label, onPress }, index);
      }),
    };
    items1 = [, ,];
...
function ExperimentActionSheet(arg0) {
  ...
  const obj = {
    header: closure_1_11(BottomSheetTitleHeader.BottomSheetTitleHeader, { title: experiment.title, subtitle: id }),
    children: closure_1_11(ExperimentDetails, { experiment, override, id, options, onCopyLink }),
  };
...
let closure_14 = noop.memo((id) => {
  ...
  const callback = noop.useCallback(() => {
    ...
    override(experiment[22]).openLazy(
      Promise.resolve({ default: ExperimentActionSheet }),
      "UserSettingsExperimentBucket",
      {
        id: map,
        experiment,
        override: items,
...
export default noop.memo(() => {
  ...
  const bestMatches = obj3.getBestMatches(
    obj4.sortEntries(experiments(experiments2[14]).getEntries(memo), memo1),
    tmp3,
  );
