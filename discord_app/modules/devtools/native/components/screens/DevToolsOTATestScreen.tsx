...
function OtaVerificationActionSheet(result) {
  ...
  items1[4] = tmp2Result;
  obj[1] = items1;
  return closure_9(require("../../../../../design/components/Sheet/native/BottomSheet.native.tsx").BottomSheet, obj);
}
...
export default function DevToolsOTATestScreen() {
  ...
  const items2 = [
    callback2(first(5605).TableRow, {
      ...
      subLabel: str,
      icon: callback2(first(15562).WrenchIcon, {}),
    }),
  ];
  ...
  items1[2] = callback3(first(5687).TableRowGroup, {
  ...
  const items4 = [
    callback2(first(5605).TableRow, {
      ...
      icon: callback2(first(4509).DownloadIcon, {}),
