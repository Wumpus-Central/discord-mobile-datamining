...
export default function DevToolsOTATestScreen() {
  ...
  const items = [
    closure_8(subLabel(5912).TableRow, {
      label: "Status",
      subLabel: tmp8[0],
      icon: closure_8(subLabel(15089).WrenchIcon, {}),
    }),
    closure_8(subLabel(5912).TableRow, {
  ...
  if (tmp12Result) {
    const obj9 = { icon: closure_8(tmp15(15089).WrenchIcon, {}), label: null };
    const _JSON = JSON;
    obj9.label = JSON.stringify(tmp7, null, 2);
    tmp12Result = closure_8(tmp15(5912).TableRow, obj9);
  }
  items3[1] = tmp12Result;
  items1[2] = closure_9(subLabel(5994).TableRowGroup, {
