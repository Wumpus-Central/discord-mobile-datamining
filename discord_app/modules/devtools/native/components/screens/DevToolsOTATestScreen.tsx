...
function OtaVerificationActionSheet(result) {
  ...
  if (null !== result.totalFileCount) {
    ...
    const items4 = [closure_8(tmp3(4832).Text, { variant: "heading-md/bold", children: "File Counts" })];
    ...
    items4[1] = closure_9(tmp3(4832).Text, obj6);
  ...
  if (result.failures.length > 0) {
    ...
    const items6 = [closure_8(tmp3(4832).Text, { variant: "heading-md/bold", children: "Failures" })];
...
export default function DevToolsOTATestScreen() {
  ...
  items1[2] = closure_9(subLabel(5999).TableRowGroup, {
  ...
  const items4 = [
    closure_8(subLabel(5917).TableRow, {
      ...
      icon: closure_8(subLabel(4781).DownloadIcon, {}),
