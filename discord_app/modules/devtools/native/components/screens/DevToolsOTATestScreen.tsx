...
function OtaVerificationActionSheet(result) {
  ...
  if (null !== result.totalFileCount) {
    ...
    const items4 = [closure_8(tmp3(4825).Text, { variant: "heading-md/bold", children: "File Counts" })];
    ...
    items4[1] = closure_9(tmp3(4825).Text, obj6);
  ...
  if (result.failures.length > 0) {
    ...
    const items6 = [closure_8(tmp3(4825).Text, { variant: "heading-md/bold", children: "Failures" })];
...
export default function DevToolsOTATestScreen() {
  ...
  const items = [
    closure_8(subLabel(5910).TableRow, {
      label: "Status",
      subLabel: tmp8[0],
      icon: closure_8(subLabel(15919).WrenchIcon, {}),
    }),
    closure_8(subLabel(5910).TableRow, {
  ...
  if (tmp12Result) {
    const obj9 = { icon: closure_8(tmp15(15919).WrenchIcon, {}), label: null };
    const _JSON = JSON;
    obj9.label = JSON.stringify(tmp7, null, 2);
    tmp12Result = closure_8(tmp15(5910).TableRow, obj9);
  }
  items3[1] = tmp12Result;
  items1[2] = closure_9(subLabel(5992).TableRowGroup, {
  ...
  const items4 = [
    closure_8(subLabel(5910).TableRow, {
      ...
      icon: closure_8(subLabel(4777).DownloadIcon, {}),
