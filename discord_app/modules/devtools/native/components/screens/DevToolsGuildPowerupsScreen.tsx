...
function GuildDCSwitchRow(dc) {
  ...
  return callback4(dc(5961).TableSwitchRow, { label: callback2(dc), value: dc.isDismissed, onValueChange: callback });
}
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj[0] = items4;
    obj[1] = callback4(tmp5(4444).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
    ...
    obj2[2] = callback4(tmp5(5567).TableRow, obj3);
    const items6 = [callback4(tmp5(5960).TableRowGroup, obj2), , , , , , ];
    ...
    items6[3] = callback4(tmp5(5960).TableRowGroup, obj8);
    ...
    obj11[2] = callback4(tmp5(5567).TableRow, obj12);
    items6[6] = callback4(tmp5(5960).TableRowGroup, obj11);
    obj[2] = items6;
