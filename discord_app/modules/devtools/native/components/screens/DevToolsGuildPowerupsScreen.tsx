// === Module 16080: DevToolsGuildPowerupsScreen ===
...
import AppliedGuildBoostStore from "AppliedGuildBoostStore" /* 12902 */;
    ...
    try {
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          let addResult = null;
          if (!closure_2) {
            addResult = _modDef4414().add(1, "day");
...
function GuildDCSwitchRow(dc) {
  ...
  return closure_18(dc(7531).TableSwitchRow, { label: closure_15(dc), value: dc.isDismissed, onValueChange: callback });
}
get_ActivityIndicator = fn(17);
({ ScrollView: hasOwnProperty, View: metroRequire } = get_ActivityIndicator);
const DevToolsGuildPowerupsConstants = fn(16081);
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj5.style = items4;
    obj5.children = closure_18(tmp5(4823).Text, { variant: "heading-md/semibold", color: "text-muted", children: "No guild selected" });
    ...
    obj8.children = closure_18(tmp5(5908).TableRow, obj9);
    const items6 = [closure_18(tmp5(5990).TableRowGroup, obj8), , , , , , ];
    ...
    const items7 = [closure_18(tmp5(5908).TableRow, obj11), ];
    const obj12 = {
    ...
    items7[1] = closure_18(tmp5(5908).TableRow, obj12);
    obj10.children = items7;
    items6[1] = closure_19(tmp5(5990).TableRowGroup, obj10);
    const obj13 = { title: "User Level DCs", hasIcons: false, children: closure_13.map((dc) => closure_1_18(UserDCSwitchRow, { dc }, dc)) };
    items6[2] = closure_18(tmp5(5990).TableRowGroup, obj13);
    ...
    items6[3] = closure_18(tmp5(5990).TableRowGroup, obj14);
    ...
    obj17.children = closure_18(tmp5(5908).TableRow, obj18);
    items6[6] = closure_18(tmp5(5990).TableRowGroup, obj17);
