// === Module 16102: DevToolsGuildPowerupsScreen ===
...
import toggleDismissibleContentDismissStateDefault from "toggleDismissibleContentDismissState" /* 15976 */;
    ...
    try {
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          let addResult = null;
          if (!closure_2) {
            addResult = _modDef4416().add(1, "day");
            const obj4 = _modDef4416();
          }
...
function GuildDCSwitchRow(dc) {
  ...
  return closure_18(dc(7533).TableSwitchRow, { label: closure_15(dc), value: dc.isDismissed, onValueChange: callback });
}
get_ActivityIndicator = fn(17);
({ ScrollView: hasOwnProperty, View: metroRequire } = get_ActivityIndicator);
const DevToolsGuildPowerupsConstants = fn(16103);
...
export default function DevToolsGuildPowerupsScreen() {
  ...
  if (null == stateFromStores) {
    ...
    obj8.children = closure_18(tmp5(5910).TableRow, obj9);
    const items6 = [closure_18(tmp5(5992).TableRowGroup, obj8), , , , , , ];
    ...
    const items7 = [closure_18(tmp5(5910).TableRow, obj11), ];
    const obj12 = {
    ...
    items7[1] = closure_18(tmp5(5910).TableRow, obj12);
    obj10.children = items7;
    items6[1] = closure_19(tmp5(5992).TableRowGroup, obj10);
    const obj13 = { title: "User Level DCs", hasIcons: false, children: closure_13.map((dc) => closure_1_18(UserDCSwitchRow, { dc }, dc)) };
    items6[2] = closure_18(tmp5(5992).TableRowGroup, obj13);
    ...
    items6[3] = closure_18(tmp5(5992).TableRowGroup, obj14);
    ...
    obj17.children = closure_18(tmp5(5910).TableRow, obj18);
    items6[6] = closure_18(tmp5(5992).TableRowGroup, obj17);
