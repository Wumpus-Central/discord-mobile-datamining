...
import ComponentStateContext from "../../../../interaction_components/ComponentStateContext.tsx";
...
let obj6 = {
  type: fn(1979).ComponentType.STRING_SELECT,
  custom_id: "test",
  max_values: 1,
  min_values: 1,
  placeholder: "Choose...",
...
items1[1] = {
  type: fn(1979).ComponentType.TEXT_DISPLAY,
  content:
...
export default function DevToolsComponentsTestingScreen() {
  ...
  const obj3 = {
    modal: { customId: modal, channelId: SelectedChannelStore.getChannelId(), components: transformComponentsResult },
    children: null,
  };
  const obj4 = {
    customId: modal,
    channelId: SelectedChannelStore.getChannelId(),
    components: transformComponentsResult,
  };
  const obj5 = {};
