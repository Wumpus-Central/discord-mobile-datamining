...
function DevTogglesForCategory(title) {
  ...
  const stateFromStores = category(504).useStateFromStores(
    items,
    () =>
...
export default function DevToolsTogglesScreen() {
  ...
  items3[1] = closure_9(query(5691).TableRow, {
    label: closure_9(query(7160).SearchField, { size: "md", placeholder: "Search design toggles", onChange: tmp3[1] }),
  });
  ...
  if (stateFromStores.length > 0) {
    ...
    tmp7Result = closure_9(tmp5(5773).TableRowGroup, obj8);
  }
  ...
  obj3.children = closure_10(query(5058).Stack, obj9);
