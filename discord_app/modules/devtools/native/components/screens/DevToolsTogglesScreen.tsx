...
export default function DevToolsTogglesScreen() {
  ...
  items3[1] = closure_9(query(5908).TableRow, {
    label: closure_9(query(7381).SearchField, { size: "md", placeholder: "Search design toggles", onChange: tmp3[1] }),
  });
  ...
  if (stateFromStores.length > 0) {
    ...
    tmp7Result = closure_9(tmp5(5990).TableRowGroup, obj8);
  }
  ...
  obj3.children = closure_10(query(5269).Stack, obj9);
