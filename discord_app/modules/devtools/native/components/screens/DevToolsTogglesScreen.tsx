...
export default function DevToolsTogglesScreen() {
  ...
  items3[1] = closure_9(query(5912).TableRow, {
    label: closure_9(query(6466).SearchField, { size: "md", placeholder: "Search design toggles", onChange: tmp3[1] }),
  });
  ...
  if (stateFromStores.length > 0) {
    ...
    tmp7Result = closure_9(tmp5(5994).TableRowGroup, obj8);
  }
  ...
  obj3.children = closure_10(query(5272).Stack, obj9);
