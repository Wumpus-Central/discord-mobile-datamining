...
export default function DevToolsLocalMessageCache() {
  ...
  items[2] = callback(TableRowInner.TableRow, obj3);
  ...
  items[3] = callback(TableRowInner.TableRow, obj4);
  obj[2] = items;
