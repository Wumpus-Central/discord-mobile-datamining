// === Module 15505: handleNewUserOnboarding ===
...
import setNewUser from "setNewUser" /* 12520 */;
...
import closure_14 from "initialize" /* 7475 */;
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    ...
    obj8[2] = closure_17.map((arg0) => {
      ({ label, value } = arg0);
      locale = value;
      return closure_1_21(locale(6002).TableSwitchRow, {
        onValueChange(arg0) {
