...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    return closure_21(locale(15771).default, {});
  } else {
    ...
    obj7.children = closure_21(locale(7303).TableSwitchRow, obj8);
    const items5 = [closure_21(locale(5768).TableRowGroup, obj7), , , , , , , , , ];
    const obj9 = { size: tmp2(576).space.PX_16 };
    items5[1] = closure_21(locale(1176).Spacer, obj9);
    let str = "Light Theme";
    if (usingSystemTheme) {
      str = "(using system theme)";
    }
    const obj10 = { title: "Appearance", hasIcons: true, children: null };
    const obj11 = { label: str, disabled: usingSystemTheme, icon: closure_21(locale(15353).ThemeLightIcon, {}), value: locale(4488).isThemeLight(stateFromStoresObject.theme), onValueChange: handleThemeChange };
    const items6 = [closure_21(locale(7303).TableSwitchRow, obj11), ];
    const obj12 = { label: "Reduced Motion", icon: closure_21(locale(15413).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    items6[1] = closure_21(locale(7303).TableSwitchRow, obj12);
    obj10.children = items6;
    items5[2] = closure_22(locale(5768).TableRowGroup, obj10);
    const obj13 = { size: tmp2(576).space.PX_16 };
    items5[3] = closure_21(locale(1176).Spacer, obj13);
    const obj14 = {
    ...
    items5[4] = closure_21(locale(5768).TableRowGroup, obj14);
    const obj15 = { size: tmp2(576).space.PX_16 };
    items5[5] = closure_21(locale(1176).Spacer, obj15);
    const obj16 = { title: null, hasIcons: true, children: null };
    const intl = locale(1114).intl;
    obj16.title = intl.string(locale(1114).t["Aojq+L"]);
    let str2 = "Change to en-US";
    if ("en-US" === locale) {
      str2 = "Change to pt-BR";
    }
    const obj17 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp11, icon: closure_21(locale(15507).LanguageIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    const items7 = [closure_21(locale(5686).TableRow, obj17), , , , , , , , , ];
    const obj18 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[1] = closure_21(locale(5686).TableRow, obj18);
    ...
    obj19.label = intl2.string(locale(1114).t.yoWDXU);
    obj19.onPress = handleNewUserOnboarding;
    obj19.icon = closure_21(locale(15650).WrenchIcon, {});
    obj19.trailing = closure_21(locale(5693).TableRowArrow, {});
    items7[2] = closure_21(locale(5686).TableRow, obj19);
    const obj20 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[3] = closure_21(locale(5686).TableRow, obj20);
    const obj21 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[4] = closure_21(locale(5686).TableRow, obj21);
    const obj22 = { label: "Reset Launch Welcome", subLabel: "Resets launch welcome NUX flag, requires an app restart to take effect.", onPress: handleLaunchWelcomeReset, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[5] = closure_21(locale(5686).TableRow, obj22);
    const obj23 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[6] = closure_21(locale(5686).TableRow, obj23);
    const obj24 = { label: "Test captcha", onPress: locale(15773).showCaptchaTestModal, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[7] = closure_21(locale(5686).TableRow, obj24);
    const obj25 = {
      label: "Ignored Profile Speedbump Suppression",
      subLabel: "Suppresses the speedbump for ignored profiles.",
      icon: closure_21(locale(7069).EyeSlashIcon, {}),
      value: setting,
      onValueChange() {
    ...
    const items8 = [closure_21(locale(5686).TableRow, obj29), , , , , ];
    const obj30 = {
      icon: closure_21(locale(15650).WrenchIcon, {}),
    ...
    items8[1] = closure_21(locale(5686).TableRow, obj30);
    const obj31 = {
      icon: closure_21(locale(15650).WrenchIcon, {}),
    ...
    items8[2] = closure_21(locale(5686).TableRow, obj31);
    const obj32 = {
      icon: closure_21(locale(15650).WrenchIcon, {}),
    ...
    items8[3] = closure_21(locale(5686).TableRow, obj32);
    const obj33 = {
      icon: closure_21(locale(15650).WrenchIcon, {}),
    ...
    items8[4] = closure_21(locale(5686).TableRow, obj33);
    const obj34 = {
      icon: closure_21(locale(15650).WrenchIcon, {}),
    ...
    items8[5] = closure_21(locale(5686).TableRow, obj34);
    obj28.children = items8;
    items5[8] = closure_22(locale(5768).TableRowGroup, obj28);
    const tmp5Result = locale(4488);
    let isIOSResult = locale(1363).isIOS();
    if (isIOSResult) {
      const obj35 = { children: null };
      const obj36 = { size: tmp2(576).space.PX_16 };
      const items9 = [closure_21(locale(1176).Spacer, obj36), ];
      ...
      obj37.children = closure_21(locale(5686).TableRow, obj38);
      items9[1] = closure_21(locale(5768).TableRowGroup, obj37);
      obj35.children = items9;
      isIOSResult = closure_22(closure_23, obj35);
    }
    items5[9] = isIOSResult;
    obj5.children = items5;
    return closure_22(ScrollView, obj5);
  }
