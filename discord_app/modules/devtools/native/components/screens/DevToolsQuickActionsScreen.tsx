...
function showVibingWumpus() {
  ...
  obj.pushLazy(asyncRequireImpl(11535, dependencyMap.paths), obj, VIBING_WUMPUS_MODAL_KEY);
}
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    return closure_21(locale(15769).default, {});
  } else {
    ...
    obj1.children = closure_21(locale(7303).TableSwitchRow, obj2);
    const items5 = [closure_21(locale(5768).TableRowGroup, obj1), , , , , , , , , ];
    ...
    const obj5 = { label: str, disabled: usingSystemTheme, icon: closure_21(locale(15352).ThemeLightIcon, {}), value: null, onValueChange: null };
    let tmp5Result = locale(4488);
    obj5.value = tmp5Result.isThemeLight(stateFromStoresObject.theme);
    obj5.onValueChange = handleThemeChange;
    const items6 = [closure_21(locale(7303).TableSwitchRow, obj5), ];
    const obj6 = { label: "Reduced Motion", icon: closure_21(locale(15412).AccessibilityIcon, {}), value: stateFromStores, onValueChange: handleReducedMotionChange };
    items6[1] = closure_21(locale(7303).TableSwitchRow, obj6);
    obj4.children = items6;
    items5[2] = closure_22(locale(5768).TableRowGroup, obj4);
    ...
    items5[4] = closure_21(locale(5768).TableRowGroup, obj8);
    ...
    const obj11 = { label: str2, subLabel: "Toggle to a non-english locale for change log testing, etc.", onPress: tmp11, icon: closure_21(locale(15506).LanguageIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    const items7 = [closure_21(locale(5686).TableRow, obj11), , , , , , , , , ];
    const obj12 = { label: "Reset Double Tap Emoji State", subLabel: "Clears double tap emoji and resets dismissible content.", onPress: handleResetDoubleTapState, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[1] = closure_21(locale(5686).TableRow, obj12);
    ...
    obj13.icon = closure_21(locale(15649).WrenchIcon, {});
    obj13.trailing = closure_21(locale(5693).TableRowArrow, {});
    items7[2] = closure_21(locale(5686).TableRow, obj13);
    const obj14 = { label: "Launch MFA Challenge Modal", subLabel: "Dismisses dev tools when launching.", onPress: launchMFA, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[3] = closure_21(locale(5686).TableRow, obj14);
    const obj15 = { label: "Show TOTP Setup Success", subLabel: "Dismisses dev tools when launching.", onPress: launchTotpSetupSuccess, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[4] = closure_21(locale(5686).TableRow, obj15);
    const obj16 = { label: "Reset Launch Welcome", subLabel: "Resets launch welcome NUX flag, requires an app restart to take effect.", onPress: handleLaunchWelcomeReset, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[5] = closure_21(locale(5686).TableRow, obj16);
    const obj17 = { label: "Launch Vibing Wumpus", subLabel: "Vibe with the one and only", onPress: showVibingWumpus, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[6] = closure_21(locale(5686).TableRow, obj17);
    const obj18 = { label: "Test captcha", onPress: locale(15771).showCaptchaTestModal, icon: closure_21(locale(7059).KeyIcon, {}), trailing: closure_21(locale(5693).TableRowArrow, {}) };
    items7[7] = closure_21(locale(5686).TableRow, obj18);
    const obj19 = {
    ...
    const items8 = [closure_21(locale(5686).TableRow, obj23), , , , , ];
    const obj24 = {
      icon: closure_21(locale(15649).WrenchIcon, {}),
    ...
    items8[1] = closure_21(locale(5686).TableRow, obj24);
    const obj25 = {
      icon: closure_21(locale(15649).WrenchIcon, {}),
    ...
    items8[2] = closure_21(locale(5686).TableRow, obj25);
    const obj26 = {
      icon: closure_21(locale(15649).WrenchIcon, {}),
    ...
    items8[3] = closure_21(locale(5686).TableRow, obj26);
    const obj27 = {
      icon: closure_21(locale(15649).WrenchIcon, {}),
    ...
    items8[4] = closure_21(locale(5686).TableRow, obj27);
    const obj28 = {
      icon: closure_21(locale(15649).WrenchIcon, {}),
    ...
    items8[5] = closure_21(locale(5686).TableRow, obj28);
    obj22.children = items8;
    items5[8] = closure_22(locale(5768).TableRowGroup, obj22);
    tmp5Result = locale(1150);
    ...
    if (isIOSResult) {
      ...
      obj31.children = closure_21(locale(5686).TableRow, obj32);
      items9[1] = closure_21(locale(5768).TableRowGroup, obj31);
