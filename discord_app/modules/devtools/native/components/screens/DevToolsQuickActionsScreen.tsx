...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(
    asyncRequireImpl(11669, dependencyMap.paths),
    {
      onClose() {},
    },
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp9) {
    ...
    const obj12 = {
      ...
      icon: closure_21(locale(15550).ThemeLightIcon, {}),
      value: locale(4608).isThemeLight(stateFromStoresObject.theme),
      onValueChange: handleThemeChange,
    };
    const items6 = [closure_21(locale(7447).TableSwitchRow, obj12)];
    const obj13 = {
      label: "Reduced Motion",
      icon: closure_21(locale(15610).AccessibilityIcon, {}),
    ...
    const obj18 = {
      ...
      onPress: tmp12,
      icon: closure_21(locale(15706).LanguageIcon, {}),
    ...
    const obj25 = {
      label: "Test captcha",
      onPress: locale(16008).showCaptchaTestModal,
      icon: closure_21(locale(7203).KeyIcon, {}),
      trailing: closure_21(locale(5831).TableRowArrow, {}),
    };
