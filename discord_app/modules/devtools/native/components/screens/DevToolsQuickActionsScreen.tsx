...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(
    asyncRequireImpl(11665, dependencyMap.paths),
    {
      onClose() {},
    },
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp9) {
    ...
    const obj12 = {
      ...
      value: locale(4607).isThemeLight(stateFromStoresObject.theme),
    ...
    const obj18 = {
      ...
      onPress: tmp12,
      icon: closure_21(locale(15694).LanguageIcon, {}),
    ...
    const obj25 = {
      label: "Test captcha",
      onPress: locale(15996).showCaptchaTestModal,
      icon: closure_21(locale(7201).KeyIcon, {}),
      trailing: closure_21(locale(5829).TableRowArrow, {}),
    };
