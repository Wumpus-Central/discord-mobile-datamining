...
function showVibingWumpus() {
  ...
  obj.pushLazy(asyncRequireImpl(10654, dependencyMap.paths), obj, VIBING_WUMPUS_MODAL_KEY);
}
...
function launchTotpSetupSuccess() {
  let arr = _modDef5265;
  arr = arr.pop();
  const items = [asyncRequireImpl(14206, dependencyMap.paths), asyncRequireImpl(14208, dependencyMap.paths)];
...
function launchMFA() {
  let arr = _modDef5265;
  arr = arr.pop();
  asyncRequireImpl(15182, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  let IgnoreProfileSpeedbumpDisabled = locale(4069).IgnoreProfileSpeedbumpDisabled;
  ...
  if (tmp8) {
    return callback3(tmp5(15198).default, {});
  } else {
    ...
    obj2[2] = function onValueChange() {
      let obj = locale(14019);
      obj = { showDevWidget: !showDevWidget };
      return obj.updateDevToolsSettings(obj);
    };
    obj1[2] = callback3(tmp5(7216).TableSwitchRow, obj2);
    const items5 = [callback3(tmp5(6317).TableRowGroup, obj1), , , , , , , , , ];
    obj3 = { size: null };
    ...
    obj8[2] = closure_17.map((arg0) => {
      ({ label, value } = arg0);
      locale = value;
      return closure_1_21(locale(7216).TableSwitchRow, {
        onValueChange(arg0) {
          const result = locale(table[48]).updateClientPremiumTypeOverride(arg0 ? closure_0 : closure_2_18, closure_1_2);
        },
        label,
        icon: closure_1_21(locale(9964).PencilIcon, {}),
        value: value === closure_3
      }, label);
    });
    items5[4] = tmp14(tmp5(6317).TableRowGroup, obj8);
    ...
    obj11[0] = str2;
    obj11[2] = tmp11;
    obj11[3] = tmp14(tmp5(14793).LanguageIcon, {});
    obj11[4] = tmp14(tmp5(6328).TableRowArrow, {});
    const items7 = [tmp14(tmp5(6322).TableRow, obj11), , , , , , , , , ];
    ...
    obj12[3] = tmp14(tmp5(8634).KeyIcon, {});
    obj12[4] = tmp14(tmp5(6328).TableRowArrow, {});
    items7[1] = tmp14(tmp5(6322).TableRow, obj12);
    ...
    obj13[3] = tmp14(tmp5(14934).WrenchIcon, {});
    obj13[4] = tmp14(tmp5(6328).TableRowArrow, {});
    items7[2] = tmp14(tmp5(6322).TableRow, obj13);
    ...
    obj14[2] = launchMFA;
    obj14[3] = tmp14(tmp5(8634).KeyIcon, {});
    obj14[4] = tmp14(tmp5(6328).TableRowArrow, {});
    items7[3] = tmp14(tmp5(6322).TableRow, obj14);
    ...
    obj15[3] = tmp14(tmp5(8634).KeyIcon, {});
    obj15[4] = tmp14(tmp5(6328).TableRowArrow, {});
    items7[4] = tmp14(tmp5(6322).TableRow, obj15);
    ...
    obj16[3] = tmp14(tmp5(8634).KeyIcon, {});
    obj16[4] = tmp14(tmp5(6328).TableRowArrow, {});
    items7[5] = tmp14(tmp5(6322).TableRow, obj16);
    ...
    obj17[3] = tmp14(tmp5(8634).KeyIcon, {});
    obj17[4] = tmp14(tmp5(6328).TableRowArrow, {});
    items7[6] = tmp14(tmp5(6322).TableRow, obj17);
    const obj18 = { label: "Test captcha", onPress: null, icon: null, trailing: null };
    obj18[1] = tmp5(15200).showCaptchaTestModal;
    obj18[2] = tmp14(tmp5(8634).KeyIcon, {});
    obj18[3] = tmp14(tmp5(6328).TableRowArrow, {});
    items7[7] = tmp14(tmp5(6322).TableRow, obj18);
    ...
    obj19[2] = tmp14(tmp5(8642).EyeSlashIcon, {});
    obj19[3] = setting;
    obj19[4] = function onValueChange() {
      const IgnoreProfileSpeedbumpDisabled = locale(4069).IgnoreProfileSpeedbumpDisabled;
      return IgnoreProfileSpeedbumpDisabled.updateSetting(!setting);
    };
    items7[8] = tmp14(tmp5(7216).TableSwitchRow, obj19);
    ...
    obj20[3] = tmp14(tmp5(14934).WrenchIcon, {});
    items7[9] = tmp14(tmp5(6322).TableRow, obj20);
    obj10[2] = items7;
    items5[6] = closure_22(tmp5(6317).TableRowGroup, obj10);
    ...
    obj28[0] = tmp14(tmp5(14934).WrenchIcon, {});
    ...
    items8[5] = tmp14(tmp5(6322).TableRow, obj28);
    obj22[2] = items8;
    items5[8] = closure_22(tmp5(6317).TableRowGroup, obj22);
    tmp5Result = tmp5(500);
    ...
    if (isIOSResult) {
      ...
      obj32[0] = tmp14(tmp5(14934).WrenchIcon, {});
      obj32[3] = function onPress() {
        return showDevWidget(1208).triggerMemoryWarning();
      };
      obj31[2] = tmp14(tmp5(6322).TableRow, obj32);
      items9[1] = tmp14(tmp5(6317).TableRowGroup, obj31);
      obj29[0] = items9;
