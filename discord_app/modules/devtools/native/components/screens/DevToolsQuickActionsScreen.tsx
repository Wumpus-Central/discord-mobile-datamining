...
function showVibingWumpus() {
  ModalActionCreatorsDefault.pushLazy(
    asyncRequireImpl(11663, dependencyMap.paths),
    {
      onClose() {},
    },
...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp9) {
    ...
    const obj12 = {
      ...
      icon: closure_21(locale(15533).ThemeLightIcon, {}),
    ...
    const obj13 = {
      ...
      icon: closure_21(locale(15593).AccessibilityIcon, {}),
    ...
    const obj18 = {
      ...
      onPress: tmp12,
      icon: closure_21(locale(15688).LanguageIcon, {}),
    ...
    const obj25 = {
      label: "Test captcha",
      onPress: locale(15990).showCaptchaTestModal,
      icon: closure_21(locale(7196).KeyIcon, {}),
      trailing: closure_21(locale(5824).TableRowArrow, {}),
    };
