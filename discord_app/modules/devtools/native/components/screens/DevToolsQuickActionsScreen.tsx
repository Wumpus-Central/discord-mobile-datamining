...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    ...
    const obj5 = {
      ...
      icon: closure_21(locale(15352).ThemeLightIcon, {}),
      value: null,
      onValueChange: null,
    };
    ...
    const obj6 = {
      ...
      icon: closure_21(locale(15412).AccessibilityIcon, {}),
    ...
    const obj11 = {
      ...
      onPress: tmp11,
      icon: closure_21(locale(15506).LanguageIcon, {}),
    ...
    const obj18 = {
      label: "Test captcha",
      onPress: locale(15771).showCaptchaTestModal,
      icon: closure_21(locale(7059).KeyIcon, {}),
      trailing: closure_21(locale(5693).TableRowArrow, {}),
    };
