...
function showVibingWumpus() {
  ...
  obj.pushLazy(asyncRequireImpl(10301, dependencyMap.paths), obj, VIBING_WUMPUS_MODAL_KEY);
}
...
function launchTotpSetupSuccess() {
  ...
  arr = arr.pop();
  const items = [asyncRequireImpl(13942, dependencyMap.paths), asyncRequireImpl(13944, dependencyMap.paths)];
...
function launchMFA() {
  let arr = ModalActionCreators;
  arr = arr.pop();
  asyncRequireImpl(14899, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  let IgnoreProfileSpeedbumpDisabled = locale(3957).IgnoreProfileSpeedbumpDisabled;
  ...
  if (tmp8) {
    return callback3(tmp5(14915).default, {});
  } else {
    ...
    obj2[2] = function onValueChange() {
      let obj = locale(13762);
      obj = { showDevWidget: !showDevWidget };
      return obj.updateDevToolsSettings(obj);
    };
    obj1[2] = callback3(tmp5(5689).TableSwitchRow, obj2);
    const items5 = [callback3(tmp5(5688).TableRowGroup, obj1), , , , , , , , , ];
    obj3 = { size: null };
    ...
    obj5[2] = tmp14(tmp5(14415).ThemeLightIcon, {});
    let tmp5Result = tmp5(4130);
    obj5[3] = tmp5Result.isThemeLight(stateFromStoresObject.theme);
    obj5[4] = handleThemeChange;
    const items6 = [tmp14(tmp5(5689).TableSwitchRow, obj5), ];
    const obj6 = { label: "Reduced Motion", icon: null, value: null, onValueChange: null };
    obj6[1] = tmp14(tmp5(14475).AccessibilityIcon, {});
    obj6[2] = stateFromStores;
    obj6[3] = handleReducedMotionChange;
    items6[1] = tmp14(tmp5(5689).TableSwitchRow, obj6);
    obj4[2] = items6;
    items5[2] = closure_22(tmp5(5688).TableRowGroup, obj4);
    ...
    obj8[2] = closure_17.map((arg0) => {
      ...
      obj[3] = value === module_13942;
      return outer1_21(locale(5689).TableSwitchRow, obj, label);
    });
    items5[4] = tmp14(tmp5(5688).TableRowGroup, obj8);
    ...
    obj11[0] = str2;
    obj11[2] = tmp11;
    obj11[3] = tmp14(tmp5(14519).LanguageIcon, {});
    obj11[4] = tmp14(tmp5(5361).TableRowArrow, {});
    const items7 = [tmp14(tmp5(5354).TableRow, obj11), , , , , , , , , ];
    ...
    obj12[3] = tmp14(tmp5(8408).KeyIcon, {});
    obj12[4] = tmp14(tmp5(5361).TableRowArrow, {});
    items7[1] = tmp14(tmp5(5354).TableRow, obj12);
    ...
    obj13[3] = tmp14(tmp5(14660).WrenchIcon, {});
    obj13[4] = tmp14(tmp5(5361).TableRowArrow, {});
    items7[2] = tmp14(tmp5(5354).TableRow, obj13);
    ...
    obj14[2] = launchMFA;
    obj14[3] = tmp14(tmp5(8408).KeyIcon, {});
    obj14[4] = tmp14(tmp5(5361).TableRowArrow, {});
    items7[3] = tmp14(tmp5(5354).TableRow, obj14);
    ...
    obj15[3] = tmp14(tmp5(8408).KeyIcon, {});
    obj15[4] = tmp14(tmp5(5361).TableRowArrow, {});
    items7[4] = tmp14(tmp5(5354).TableRow, obj15);
    ...
    obj16[3] = tmp14(tmp5(8408).KeyIcon, {});
    obj16[4] = tmp14(tmp5(5361).TableRowArrow, {});
    items7[5] = tmp14(tmp5(5354).TableRow, obj16);
    ...
    obj17[3] = tmp14(tmp5(8408).KeyIcon, {});
    obj17[4] = tmp14(tmp5(5361).TableRowArrow, {});
    items7[6] = tmp14(tmp5(5354).TableRow, obj17);
    const obj18 = { label: "Test captcha", onPress: null, icon: null, trailing: null };
    obj18[1] = tmp5(14917).showCaptchaTestModal;
    obj18[2] = tmp14(tmp5(8408).KeyIcon, {});
    obj18[3] = tmp14(tmp5(5361).TableRowArrow, {});
    items7[7] = tmp14(tmp5(5354).TableRow, obj18);
    ...
    obj19[2] = tmp14(tmp5(8418).EyeSlashIcon, {});
    obj19[3] = setting;
    obj19[4] = function onValueChange() {
      const IgnoreProfileSpeedbumpDisabled = locale(3957).IgnoreProfileSpeedbumpDisabled;
      return IgnoreProfileSpeedbumpDisabled.updateSetting(!setting);
    };
    items7[8] = tmp14(tmp5(5689).TableSwitchRow, obj19);
    ...
    obj20[3] = tmp14(tmp5(14660).WrenchIcon, {});
    items7[9] = tmp14(tmp5(5354).TableRow, obj20);
    obj10[2] = items7;
    items5[6] = closure_22(tmp5(5688).TableRowGroup, obj10);
    ...
    obj28[0] = tmp14(tmp5(14660).WrenchIcon, {});
    ...
    items8[5] = tmp14(tmp5(5354).TableRow, obj28);
    obj22[2] = items8;
    items5[8] = closure_22(tmp5(5688).TableRowGroup, obj22);
    tmp5Result = tmp5(500);
    ...
    if (isIOSResult) {
      ...
      obj32[0] = tmp14(tmp5(14660).WrenchIcon, {});
      obj32[3] = function onPress() {
        return showDevWidget(1208).triggerMemoryWarning();
      };
      obj31[2] = tmp14(tmp5(5354).TableRow, obj32);
      items9[1] = tmp14(tmp5(5688).TableRowGroup, obj31);
      obj29[0] = items9;
