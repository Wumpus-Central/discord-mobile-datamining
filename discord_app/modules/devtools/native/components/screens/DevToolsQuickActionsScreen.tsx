...
function showVibingWumpus() {
  ...
  obj.pushLazy(asyncRequireImpl(10317, dependencyMap.paths), obj, VIBING_WUMPUS_MODAL_KEY);
}
...
function launchTotpSetupSuccess() {
  ...
  arr = arr.pop();
  const items = [asyncRequireImpl(13956, dependencyMap.paths), asyncRequireImpl(13958, dependencyMap.paths)];
...
function launchMFA() {
  let arr = ModalActionCreators;
  arr = arr.pop();
  asyncRequireImpl(14915, dependencyMap.paths).then((openMFAModal) => {
...
export default function DevToolsQuickActionsScreen() {
  ...
  const tmp4 = showDevWidget(1609)();
  [tmp8, _handleConnectionOpen] = callback(setting.useState(false), 2);
  let IgnoreProfileSpeedbumpDisabled = locale(3974).IgnoreProfileSpeedbumpDisabled;
  ...
  if (tmp8) {
    return callback3(tmp5(14931).default, {});
  } else {
    ...
    obj2[2] = function onValueChange() {
      let obj = locale(13776);
      obj = { showDevWidget: !showDevWidget };
      return obj.updateDevToolsSettings(obj);
    };
    obj1[2] = callback3(tmp5(5708).TableSwitchRow, obj2);
    const items5 = [callback3(tmp5(5707).TableRowGroup, obj1), , , , , , , , , ];
    obj3 = { size: null };
    ...
    obj5[2] = tmp14(tmp5(14431).ThemeLightIcon, {});
    let tmp5Result = tmp5(4147);
    obj5[3] = tmp5Result.isThemeLight(stateFromStoresObject.theme);
    obj5[4] = handleThemeChange;
    const items6 = [tmp14(tmp5(5708).TableSwitchRow, obj5), ];
    const obj6 = { label: "Reduced Motion", icon: null, value: null, onValueChange: null };
    obj6[1] = tmp14(tmp5(14491).AccessibilityIcon, {});
    obj6[2] = stateFromStores;
    obj6[3] = handleReducedMotionChange;
    items6[1] = tmp14(tmp5(5708).TableSwitchRow, obj6);
    obj4[2] = items6;
    items5[2] = closure_22(tmp5(5707).TableRowGroup, obj4);
    ...
    obj8[2] = closure_17.map((arg0) => {
      ...
      obj[2] = outer1_21(locale(9607).PencilIcon, {});
      obj[3] = value === module_13956;
      return outer1_21(locale(5708).TableSwitchRow, obj, label);
    });
    items5[4] = tmp14(tmp5(5707).TableRowGroup, obj8);
    ...
    obj11[0] = str2;
    obj11[2] = tmp11;
    obj11[3] = tmp14(tmp5(14535).LanguageIcon, {});
    obj11[4] = tmp14(tmp5(5380).TableRowArrow, {});
    const items7 = [tmp14(tmp5(5373).TableRow, obj11), , , , , , , , , ];
    ...
    obj12[3] = tmp14(tmp5(8425).KeyIcon, {});
    obj12[4] = tmp14(tmp5(5380).TableRowArrow, {});
    items7[1] = tmp14(tmp5(5373).TableRow, obj12);
    ...
    obj13[3] = tmp14(tmp5(14676).WrenchIcon, {});
    obj13[4] = tmp14(tmp5(5380).TableRowArrow, {});
    items7[2] = tmp14(tmp5(5373).TableRow, obj13);
    ...
    obj14[2] = launchMFA;
    obj14[3] = tmp14(tmp5(8425).KeyIcon, {});
    obj14[4] = tmp14(tmp5(5380).TableRowArrow, {});
    items7[3] = tmp14(tmp5(5373).TableRow, obj14);
    ...
    obj15[3] = tmp14(tmp5(8425).KeyIcon, {});
    obj15[4] = tmp14(tmp5(5380).TableRowArrow, {});
    items7[4] = tmp14(tmp5(5373).TableRow, obj15);
    ...
    obj16[3] = tmp14(tmp5(8425).KeyIcon, {});
    obj16[4] = tmp14(tmp5(5380).TableRowArrow, {});
    items7[5] = tmp14(tmp5(5373).TableRow, obj16);
    ...
    obj17[3] = tmp14(tmp5(8425).KeyIcon, {});
    obj17[4] = tmp14(tmp5(5380).TableRowArrow, {});
    items7[6] = tmp14(tmp5(5373).TableRow, obj17);
    const obj18 = { label: "Test captcha", onPress: null, icon: null, trailing: null };
    obj18[1] = tmp5(14933).showCaptchaTestModal;
    obj18[2] = tmp14(tmp5(8425).KeyIcon, {});
    obj18[3] = tmp14(tmp5(5380).TableRowArrow, {});
    items7[7] = tmp14(tmp5(5373).TableRow, obj18);
    ...
    obj19[2] = tmp14(tmp5(8435).EyeSlashIcon, {});
    obj19[3] = setting;
    obj19[4] = function onValueChange() {
      const IgnoreProfileSpeedbumpDisabled = locale(3974).IgnoreProfileSpeedbumpDisabled;
      return IgnoreProfileSpeedbumpDisabled.updateSetting(!setting);
    };
    items7[8] = tmp14(tmp5(5708).TableSwitchRow, obj19);
    ...
    obj20[3] = tmp14(tmp5(14676).WrenchIcon, {});
    items7[9] = tmp14(tmp5(5373).TableRow, obj20);
    obj10[2] = items7;
    items5[6] = closure_22(tmp5(5707).TableRowGroup, obj10);
    ...
    obj28[0] = tmp14(tmp5(14676).WrenchIcon, {});
    ...
    items8[5] = tmp14(tmp5(5373).TableRow, obj28);
    obj22[2] = items8;
    items5[8] = closure_22(tmp5(5707).TableRowGroup, obj22);
    tmp5Result = tmp5(500);
    ...
    if (isIOSResult) {
      ...
      obj32[0] = tmp14(tmp5(14676).WrenchIcon, {});
      obj32[3] = function onPress() {
        return showDevWidget(1208).triggerMemoryWarning();
      };
      obj31[2] = tmp14(tmp5(5373).TableRow, obj32);
      items9[1] = tmp14(tmp5(5707).TableRowGroup, obj31);
      obj29[0] = items9;
