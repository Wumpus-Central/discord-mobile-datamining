...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp9) {
    ...
    const obj12 = {
      ...
      icon: closure_21(locale(15478).ThemeLightIcon, {}),
      value: locale(4573).isThemeLight(stateFromStoresObject.theme),
      onValueChange: handleThemeChange,
    };
    const items6 = [closure_21(locale(7396).TableSwitchRow, obj12)];
    const obj13 = {
      label: "Reduced Motion",
      icon: closure_21(locale(15538).AccessibilityIcon, {}),
    ...
    const obj18 = {
      ...
      onPress: tmp12,
      icon: closure_21(locale(15633).LanguageIcon, {}),
    ...
    const obj25 = {
      label: "Test captcha",
      onPress: locale(15914).showCaptchaTestModal,
      icon: closure_21(locale(7152).KeyIcon, {}),
      trailing: closure_21(locale(5782).TableRowArrow, {}),
    };
