...
export default function DevToolsQuickActionsScreen() {
  ...
  if (tmp8) {
    ...
    const obj5 = {
      ...
      icon: tmp14(tmp5(15267).ThemeLightIcon, {}),
      value: null,
      onValueChange: null,
    };
    ...
    const obj6 = {
      ...
      icon: tmp14(tmp5(15327).AccessibilityIcon, {}),
    ...
    const obj11 = {
      ...
      onPress: tmp11,
      icon: tmp14(tmp5(15421).LanguageIcon, {}),
      trailing: tmp14(tmp5(5612).TableRowArrow, {}),
    };
    ...
    const obj18 = {
      label: "Test captcha",
      onPress: tmp5(15682).showCaptchaTestModal,
      icon: tmp14(tmp5(6958).KeyIcon, {}),
      trailing: tmp14(tmp5(5612).TableRowArrow, {}),
    };
