...
export default function DevToolsQuickActionsScreen() {
  ...
  let IgnoreProfileSpeedbumpDisabled = locale(3958).IgnoreProfileSpeedbumpDisabled;
  ...
  if (tmp8) {
    ...
    obj1[2] = callback3(tmp5(5650).TableSwitchRow, obj2);
    const items5 = [callback3(tmp5(5649).TableRowGroup, obj1), , , , , , , , , ];
    obj3 = { size: null };
    ...
    obj4[2] = items6;
    items5[2] = closure_22(tmp5(5649).TableRowGroup, obj4);
    ...
    obj12[3] = tmp14(tmp5(8296).KeyIcon, {});
    obj12[4] = tmp14(tmp5(5322).TableRowArrow, {});
    items7[1] = tmp14(tmp5(5315).TableRow, obj12);
    ...
    obj14[2] = launchMFA;
    obj14[3] = tmp14(tmp5(8296).KeyIcon, {});
    obj14[4] = tmp14(tmp5(5322).TableRowArrow, {});
    items7[3] = tmp14(tmp5(5315).TableRow, obj14);
    ...
    obj15[3] = tmp14(tmp5(8296).KeyIcon, {});
    obj15[4] = tmp14(tmp5(5322).TableRowArrow, {});
    items7[4] = tmp14(tmp5(5315).TableRow, obj15);
    ...
    obj16[3] = tmp14(tmp5(8296).KeyIcon, {});
    obj16[4] = tmp14(tmp5(5322).TableRowArrow, {});
    items7[5] = tmp14(tmp5(5315).TableRow, obj16);
    ...
    obj17[3] = tmp14(tmp5(8296).KeyIcon, {});
    ...
    obj19[2] = tmp14(tmp5(8306).EyeSlashIcon, {});
    obj19[3] = setting;
    obj19[4] = function onValueChange() {
      const IgnoreProfileSpeedbumpDisabled = locale(3958).IgnoreProfileSpeedbumpDisabled;
    ...
    items8[5] = tmp14(tmp5(5315).TableRow, obj28);
    obj22[2] = items8;
    items5[8] = closure_22(tmp5(5649).TableRowGroup, obj22);
    tmp5Result = tmp5(500);
    ...
    if (isIOSResult) {
      ...
      obj31[2] = tmp14(tmp5(5315).TableRow, obj32);
      items9[1] = tmp14(tmp5(5649).TableRowGroup, obj31);
      obj29[0] = items9;
