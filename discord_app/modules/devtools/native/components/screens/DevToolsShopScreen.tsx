...
const result = require("set").fileFinishedImporting(
  "modules/devtools/native/components/screens/DevToolsShopScreen.tsx",
);
...
export default function DevToolsShopScreen() {
  ...
  obj3 = {
    ...
    subLabelLineClamp: 1,
    trailing: callback(FormSwitch.FormSwitch, obj4),
  };
  ...
  items4[1] = callback(TableRowInner.TableRow, {
    label: "Show unpublished items in collectibles shop",
    subLabel: "shop_include_unpublished",
    subLabelLineClamp: 1,
    trailing: callback(FormSwitch.FormSwitch, obj6),
  });
  items4[2] = callback(TableSwitchRow.TableSwitchRow, {
  ...
  items4[3] = callback(TableRowInner.TableRow, {
    label: "Show debug log overlay in collectibles shop",
    subLabel: "shop_show_debug_overlay",
    subLabelLineClamp: 1,
    trailing: callback(FormSwitch.FormSwitch, obj8),
  });
  const obj7 = {
    label: "Show debug log overlay in collectibles shop",
    subLabel: "shop_show_debug_overlay",
