...
function DismissableContentsEmpty() {
  ...
  obj[0] = obj;
  const items = [callback2(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj), callback2(require("../../../../../design/components/Illustration/native/redesign/generated/SearchEmpty.tsx") /* getSearchEmptySource */.SearchEmpty, {})];
  obj[1] = items;
...
let closure_11 = importAllResult.memo((content) => {
  ...
  ({ start, end } = content);
  ({ isDismissed, handleToggleDismissState } = require("../../../../dismissible_content/utils/toggleDismissibleContentDismissState.tsx")(require("../../../../../../discord_common/js/packages/protos/discord_protos/discord_users/v1/dismissible_content.tsx") /* DismissibleContent */.DismissibleContent[label]));
  return callback2(require("../../../../../design/components/TableRow/native/TableSwitchRow.native.tsx") /* TableSwitchRow */.TableSwitchRow, { start, end, onValueChange, value, label });
});
let closure_12 = importAllResult.memo((arg0) => {
  ...
  obj1[0] = require("../../../../dismissible_content/DismissibleContentFrameworkActionCreators.tsx") /* handleDCShownToUser */.overrideDismissibleContentFramework;
  obj1[1] = dailyCapOverridden;
  const items = [callback2(require("../../../../../design/components/TableRow/native/TableSwitchRow.native.tsx") /* TableSwitchRow */.TableSwitchRow, obj1), , ];
  ...
  obj2[0] = require("../../../../dismissible_content/DismissibleContentFrameworkActionCreators.tsx") /* handleDCShownToUser */.overrideNewUserMinAgeRequired;
  obj2[1] = newUserMinAgeRequiredOverridden;
  items[1] = callback2(require("../../../../../design/components/TableRow/native/TableSwitchRow.native.tsx") /* TableSwitchRow */.TableSwitchRow, obj2);
  items[2] = callback2(require("../../../../../design/components/TableRow/native/TableSwitchRow.native.tsx") /* TableSwitchRow */.TableSwitchRow, { onValueChange: onForceBountiesSwipeUpNuxChange, value: forceBountiesSwipeUpNux, label: "Force bounties swipe-up NUX", subLabel: "When enabled, treat bounties swipe-up NUX as shown so scroll affordances always appear. Reopen the bounties modal after toggling." });
  obj[2] = items;
  obj[1] = callback3(require("../../../../../design/components/TableRow/native/TableRowGroup.native.tsx") /* TableRowGroupTitle */.TableRowGroup, obj);
  ...
  obj5[1] = require("../../../../user_settings/UserSettingsProtoActionCreators.tsx") /* updateUserGuildSettings */.clearDismissedContents;
  obj5[2] = callback2(require("../../../../../design/components/Icon/native/redesign/generated/TrashIcon.tsx") /* TrashIcon */.TrashIcon, {});
  obj5[3] = callback2(require("../../../../../design/components/TableRow/native/TableRowArrow.native.tsx") /* TableRowArrow */.TableRowArrow, {});
  const items2 = [callback2(require("../../../../../design/components/TableRow/native/TableRow.native.tsx") /* TableRowInner */.TableRow, obj5), , ];
  const obj6 = { label: "Clear all guild dismissed dismissible contents", onPress: null, icon: null, trailing: null };
  obj6[1] = require("../../../../user_settings/UserSettingsProtoActionCreators.tsx") /* updateUserGuildSettings */.clearGuildDismissedContents;
  obj6[2] = callback2(require("../../../../../design/components/Icon/native/redesign/generated/TrashIcon.tsx") /* TrashIcon */.TrashIcon, {});
  obj6[3] = callback2(require("../../../../../design/components/TableRow/native/TableRowArrow.native.tsx") /* TableRowArrow */.TableRowArrow, {});
  items2[1] = callback2(require("../../../../../design/components/TableRow/native/TableRow.native.tsx") /* TableRowInner */.TableRow, obj6);
  const obj7 = { label: "Dismiss all dismissible contents", onPress: null, icon: null, trailing: null };
  obj7[1] = require("../../../../user_settings/UserSettingsProtoActionCreators.tsx") /* updateUserGuildSettings */.checkAllDismissedContents;
  obj7[2] = callback2(require("../../../../../design/components/Icon/native/redesign/generated/DoubleCheckmarkIcon.tsx") /* DoubleCheckmarkIcon */.DoubleCheckmarkIcon, {});
  obj7[3] = callback2(require("../../../../../design/components/TableRow/native/TableRowArrow.native.tsx") /* TableRowArrow */.TableRowArrow, {});
  items2[2] = callback2(require("../../../../../design/components/TableRow/native/TableRow.native.tsx") /* TableRowInner */.TableRow, obj7);
  obj4[2] = items2;
  obj3[1] = callback3(require("../../../../../design/components/TableRow/native/TableRowGroup.native.tsx") /* TableRowGroupTitle */.TableRowGroup, obj4);
  items1[1] = callback2(View, obj3);
  items1[2] = callback2(View, { style: tmp.search, children: callback2(require("../../../../../design/components/TextField/native/SearchField.native.tsx") /* SearchField */.SearchField, { size: "md", defaultValue: initialSearchQuery, onChange: onSearchChange }) });
  items1[3] = callback2(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { style: tmp.sectionHeader, variant: "text-sm/semibold", color: "text-default", children: "Dismissible Contents" });
  obj[0] = items1;
...
export default function DevToolsDismissableContentsScreen() {
  ...
  let obj = ref(10703);
  let tmp2 = require("../../../../safe_area/useSafeAreaInsets.native.tsx")();
  ...
  obj1[0] = tmp2.bottom + require("../../../../../../discord_common/js/packages/tokens/native.tsx").space.PX_16;
  items5[1] = obj1;
  obj[2] = items5;
  obj[6] = memo;
  obj[7] = callback2;
  ...
  obj[9] = callback4;
  obj[10] = callback3;
  obj[1] = dailyCapOverridden(ref(7666).FlashList, obj);
