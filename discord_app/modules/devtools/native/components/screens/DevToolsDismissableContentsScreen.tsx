...
function DismissableContentsEmpty() {
  ...
  obj[0] = obj;
  const items = [callback2(Text /* Text */.Text, obj), callback2(getSearchEmptySource /* getSearchEmptySource */.SearchEmpty, {})];
  obj[1] = items;
...
let closure_11 = importAllResult.memo((content) => {
  ...
  ({ start, end } = content);
  ({ isDismissed, handleToggleDismissState } = useToggleDismissibleContentDismissState(DismissibleContent /* DismissibleContent */.DismissibleContent[label]));
  return callback2(TableSwitchRow /* TableSwitchRow */.TableSwitchRow, { start, end, onValueChange, value, label });
});
let closure_12 = importAllResult.memo((arg0) => {
  ...
  obj1[0] = handleDCShownToUser /* handleDCShownToUser */.overrideDismissibleContentFramework;
  obj1[1] = dailyCapOverridden;
  const items = [callback2(TableSwitchRow /* TableSwitchRow */.TableSwitchRow, obj1), , ];
  ...
  obj2[0] = handleDCShownToUser /* handleDCShownToUser */.overrideNewUserMinAgeRequired;
  obj2[1] = newUserMinAgeRequiredOverridden;
  items[1] = callback2(TableSwitchRow /* TableSwitchRow */.TableSwitchRow, obj2);
  items[2] = callback2(TableSwitchRow /* TableSwitchRow */.TableSwitchRow, { onValueChange: onForceBountiesSwipeUpNuxChange, value: forceBountiesSwipeUpNux, label: "Force bounties swipe-up NUX", subLabel: "When enabled, treat bounties swipe-up NUX as shown so scroll affordances always appear. Reopen the bounties modal after toggling." });
  obj[2] = items;
  obj[1] = callback3(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj);
  ...
  obj5[1] = updateUserGuildSettings /* updateUserGuildSettings */.clearDismissedContents;
  obj5[2] = callback2(TrashIcon /* TrashIcon */.TrashIcon, {});
  obj5[3] = callback2(TableRowArrow /* TableRowArrow */.TableRowArrow, {});
  const items2 = [callback2(TableRowInner /* TableRowInner */.TableRow, obj5), , ];
  const obj6 = { label: "Clear all guild dismissed dismissible contents", onPress: null, icon: null, trailing: null };
  obj6[1] = updateUserGuildSettings /* updateUserGuildSettings */.clearGuildDismissedContents;
  obj6[2] = callback2(TrashIcon /* TrashIcon */.TrashIcon, {});
  obj6[3] = callback2(TableRowArrow /* TableRowArrow */.TableRowArrow, {});
  items2[1] = callback2(TableRowInner /* TableRowInner */.TableRow, obj6);
  const obj7 = { label: "Dismiss all dismissible contents", onPress: null, icon: null, trailing: null };
  obj7[1] = updateUserGuildSettings /* updateUserGuildSettings */.checkAllDismissedContents;
  obj7[2] = callback2(DoubleCheckmarkIcon /* DoubleCheckmarkIcon */.DoubleCheckmarkIcon, {});
  obj7[3] = callback2(TableRowArrow /* TableRowArrow */.TableRowArrow, {});
  items2[2] = callback2(TableRowInner /* TableRowInner */.TableRow, obj7);
  obj4[2] = items2;
  obj3[1] = callback3(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj4);
  items1[1] = callback2(View, obj3);
  items1[2] = callback2(View, { style: tmp.search, children: callback2(SearchField /* SearchField */.SearchField, { size: "md", defaultValue: initialSearchQuery, onChange: onSearchChange }) });
  items1[3] = callback2(Text /* Text */.Text, { style: tmp.sectionHeader, variant: "text-sm/semibold", color: "text-default", children: "Dismissible Contents" });
  obj[0] = items1;
...
export default function DevToolsDismissableContentsScreen() {
  ...
  obj1[0] = tmp2.bottom + Themes.space.PX_16;
  items5[1] = obj1;
  obj[2] = items5;
  obj[6] = memo;
  obj[7] = callback2;
