...
export default function DevToolsAnalyticsScreen() {
  ...
  const obj1 = { icon: closure_8(trimmed(12221).ArrowsUpDownIcon, {}), label: "Reverse Events", value: first, onValueChange: tmp5[1] };
  ...
  const obj2 = { arrow: true, variant: "danger", icon: closure_8(trimmed(4563).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Analytics Log", onPress: trimmed(15656).clearAnalyticsLog };
