...
function LoggedEvent(arg0) {
  ...
  let obj = {
    arrow: !tmp2,
    icon: callback2(fingerprint(10384).AnalyticsIcon, {}),
    label: event,
    subLabel: null,
    onPress: null,
    start: null,
...
export default function DevToolsAnalyticsScreen() {
  ...
  const items2 = [
    callback2(trimmed(7201).TableSwitchRow, {
      icon: callback2(trimmed(12151).ArrowsUpDownIcon, {}),
  ...
  items2[1] = callback2(trimmed(5605).TableRow, {
    arrow: true,
    variant: "danger",
    icon: callback2(trimmed(4518).TrashIcon, { color: "text-feedback-critical" }),
  ...
  items3[1] = callback2(View, {
    ...
    children: callback2(trimmed(7050).SearchField, { placeholder: "Search by event name", onChange: tmp8 }),
  });
  ...
  items3[2] = callback2(trimmed(5687).TableRowGroup, {
