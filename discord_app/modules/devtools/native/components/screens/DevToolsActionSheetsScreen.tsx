...
let items = [
  ...
  },
  {
    ...
    show() {
      return ModalActionCreators.pushLazy(asyncRequireImpl(14972, dependencyMap.paths), { warningId: "test-warning-123", warningType: "inappropriate_conversation", senderId: "123456789", channelId: "987654321" }, "INAPPROPRIATE_CONVERSATION_TAKEOVER_MODAL");
    }
  }
];
