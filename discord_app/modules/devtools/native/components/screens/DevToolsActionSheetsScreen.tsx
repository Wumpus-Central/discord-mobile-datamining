...
import _modDef12946 from "../../../../suspicious_downloads/SuspiciousDownloadModalActionCreators.native.tsx";
import _modDef12948 from "../../../../blocked_domains/BlockedDomainModalActionCreators.native.tsx";
...
export default function DevToolsActionSheetsScreen() {
  ...
  obj = { children: null };
  const items1 = [
    callback2(first(4556).Text, { variant: "heading-lg/medium", children: "Action Sheets" }),
    callback2(first(5687).TableRowGroup, {
      description: "Tap an option to launch the action sheet immediately",
      hasIcons: false,
      children: callback2(first(5605).TableRow, obj2),
    }),
  ];
  obj[0] = items1;
