...
function TrialOfferSheetExample() {
  let obj = premiumTrialOffer(7499);
  ...
  obj = {
    ...
    onPress() {
      if (null != premiumTrialOffer) {
        ...
        obj.openLazy(asyncRequireImpl(15769, dependencyMap.paths), "PremiumTrialOfferActionSheet", obj);
      }
    },
  };
  items = [closure_17(premiumTrialOffer(5655).TableRow, obj)];
  ...
  obj.children = items;
  return closure_18(premiumTrialOffer(5737).TableRowGroup, obj);
}
