...
export default noop.memo(() => {
  ...
  if (null != stateFromStores) {
    ...
    const items1 = [
      jsx(tmp3(5917).TableRow, { icon: jsx(tmp3(4779).CopyIcon, {}), label: null, subLabel: null, onPress: null }),
      ,
    ];
    const obj6 = {
    ...
    const obj7 = {
      icon: jsx(tmp3(4790).TrashIcon, { color: "text-feedback-critical" }),
      label: "Clear Override",
      variant: "danger",
      onPress: tmp3(11267).clearBuildOverride,
      arrow: true,
    };
    items1[2] = jsx(tmp3(5917).TableRow, {
      icon: jsx(tmp3(4790).TrashIcon, { color: "text-feedback-critical" }),
      label: "Clear Override",
      variant: "danger",
      onPress: tmp3(11267).clearBuildOverride,
