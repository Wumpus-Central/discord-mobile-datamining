...
let obj2 = { label: "Branch Name", value: "branch", icon: jsx(fn(8931).TagIcon, {}) };
items[1] = { label: "Commit SHA", value: "id", icon: jsx(fn(15663).HashmarkIcon, {}) };
let obj3 = { label: "Commit SHA", value: "id", icon: jsx(fn(15663).HashmarkIcon, {}) };
const size = fn(2);
...
export default noop.memo(() => {
  ...
  obj.paddingBottom = tmp.contentContainer.padding + first(7033)({ includeKeyboardHeight: true }).insets.bottom;
  obj.contentContainerStyle = obj;
  let tmp10Result = null;
  if (null != stateFromStores) {
    const obj1 = { icon: jsx(tmp3(4552).CopyIcon, {}), label: null, subLabel: null, onPress: null };
    ...
    const items1 = [jsx(tmp3(5655).TableRow, { icon: jsx(tmp3(4552).CopyIcon, {}), label: null, subLabel: null, onPress: null }), , ];
    let obj3 = { icon: jsx(tmp3(15237).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(11860).refreshBuildOverride, arrow: true };
    items1[1] = jsx(tmp3(5655).TableRow, { icon: jsx(tmp3(15237).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(11860).refreshBuildOverride, arrow: true });
    const obj4 = { icon: jsx(tmp3(4563).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(11860).clearBuildOverride, arrow: true };
    items1[2] = jsx(tmp3(5655).TableRow, { icon: jsx(tmp3(4563).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(11860).clearBuildOverride, arrow: true });
    obj2.children = items1;
    tmp10Result = jsxs(tmp3(5737).TableRowGroup, { title: "Current Override", hasIcons: true, children: null });
  }
  ...
  obj7.label = jsx(first(6656).TextInput, {
    size: "md",
  ...
  obj6.children = jsx(first(5655).TableRow, { icon, label: null });
  ...
  obj.children = jsxs(first(5023).Stack, { spacing: 16, children: null });
  return <ScrollView />;
});