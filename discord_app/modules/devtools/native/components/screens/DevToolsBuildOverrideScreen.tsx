...
export default noop.memo(() => {
  ...
  if (null != stateFromStores) {
    ...
    const items1 = [jsx(tmp3(5822).TableRow, { icon: jsx(tmp3(4702).CopyIcon, {}), label: null, subLabel: null, onPress: null }), , ];
    const obj6 = { icon: jsx(tmp3(15425).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(12043).refreshBuildOverride, arrow: true };
    items1[1] = jsx(tmp3(5822).TableRow, { icon: jsx(tmp3(15425).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(12043).refreshBuildOverride, arrow: true });
    const obj7 = { icon: jsx(tmp3(4713).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(12043).clearBuildOverride, arrow: true };
    items1[2] = jsx(tmp3(5822).TableRow, { icon: jsx(tmp3(4713).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(12043).clearBuildOverride, arrow: true });
    obj5.children = items1;
    tmp10Result = jsxs(tmp3(5904).TableRowGroup, { title: "Current Override", hasIcons: true, children: null });
  }
