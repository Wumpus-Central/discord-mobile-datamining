...
export default noop.memo(() => {
  ...
  if (null != stateFromStores) {
    const obj4 = { icon: jsx(tmp3(4775).CopyIcon, {}), label: null, subLabel: null, onPress: null };
    first = stateFromStores;
    ...
    const items1 = [jsx(tmp3(5910).TableRow, { icon: jsx(tmp3(4775).CopyIcon, {}), label: null, subLabel: null, onPress: null }), , ];
    const obj6 = { icon: jsx(tmp3(15494).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(12131).refreshBuildOverride, arrow: true };
    items1[1] = jsx(tmp3(5910).TableRow, { icon: jsx(tmp3(15494).RefreshIcon, {}), label: "Refresh Override", onPress: tmp3(12131).refreshBuildOverride, arrow: true });
    const obj7 = { icon: jsx(tmp3(4786).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(12131).clearBuildOverride, arrow: true };
    items1[2] = jsx(tmp3(5910).TableRow, { icon: jsx(tmp3(4786).TrashIcon, { color: "text-feedback-critical" }), label: "Clear Override", variant: "danger", onPress: tmp3(12131).clearBuildOverride, arrow: true });
    obj5.children = items1;
    tmp10Result = jsxs(tmp3(5992).TableRowGroup, { title: "Current Override", hasIcons: true, children: null });
  }
