...
export default noop.memo(() => {
  ...
  if (null != stateFromStores) {
    ...
    const items1 = [
      jsx(tmp3(5619).TableRow, { icon: jsx(tmp3(4521).CopyIcon, {}), label: null, subLabel: null, onPress: null }),
      ,
    ];
    let obj3 = {
      icon: jsx(tmp3(15188).RefreshIcon, {}),
      label: "Refresh Override",
      onPress: tmp3(11820).refreshBuildOverride,
      arrow: true,
    };
    items1[1] = jsx(tmp3(5619).TableRow, {
      icon: jsx(tmp3(15188).RefreshIcon, {}),
      label: "Refresh Override",
      onPress: tmp3(11820).refreshBuildOverride,
      arrow: true,
    ...
    const obj4 = {
      icon: jsx(tmp3(4532).TrashIcon, { color: "text-feedback-critical" }),
      label: "Clear Override",
      variant: "danger",
      onPress: tmp3(11820).clearBuildOverride,
      arrow: true,
    };
    items1[2] = jsx(tmp3(5619).TableRow, {
      icon: jsx(tmp3(4532).TrashIcon, { color: "text-feedback-critical" }),
      label: "Clear Override",
      variant: "danger",
      onPress: tmp3(11820).clearBuildOverride,
