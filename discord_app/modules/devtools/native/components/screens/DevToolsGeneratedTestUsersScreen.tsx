...
function UserActionSheet(pool) {
  ...
  obj[0] = callback3(pool(5337).BottomSheetTitleHeader, obj);
  ...
  obj2[2] = usersForPool.map((id) => {
    ...
    obj[0] = outer1_10(pool(11136).UserIcon, { size: "md" });
    ...
    return outer1_10(pool(5315).TableRow, obj, id.id);
  });
  obj[1] = callback3(pool(5649).TableRowGroup, obj2);
  obj[1] = callback3(closure_6, obj);
  return callback3(pool(5338).BottomSheet, obj);
}
function PoolUsers(pool) {
  ...
  obj[5] = start;
  obj[6] = end;
  return callback3(pool(5315).TableRow, obj);
}
