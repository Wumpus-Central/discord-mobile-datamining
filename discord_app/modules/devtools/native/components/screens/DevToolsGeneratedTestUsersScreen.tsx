  ...
  obj3.children = closure_10(pool(5999).TableRowGroup, {
    ...
    children: usersForPool.map((id, index) => {
      ...
      if (id.id === dependencyMap) {
        tmp2Result = closure_1_10(pool(4783).CheckmarkLargeIcon, { size: "md", color: "text-feedback-positive" });
      }
...
let items = [
  ...
  fn(8705).ShieldIcon,
  fn(10496).GiftIcon,
  fn(15147).AchievementsIcon,
  fn(11403).PiggyBankIcon,
  fn(15149).TreehouseIcon,
  fn(9415).SpeedometerIcon,
  fn(15151).CompassIcon,
  fn(13387).SignPostIcon,
  fn(15153).CarIcon,
  fn(15155).TrainIcon,
  fn(15157).TeacupIcon,
  fn(15159).InventoryIcon,
  fn(9813).FoodIcon,
  fn(15161).BurgerIcon,
  fn(15163).MagicDoorIcon,
  fn(15165).PawPrintIcon,
  fn(15167).RecordPlayerIcon,
