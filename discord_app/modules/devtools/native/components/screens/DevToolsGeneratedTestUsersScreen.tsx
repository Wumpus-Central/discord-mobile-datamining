...
function UserActionSheet(pool) {
  ...
  let obj = {
    header: closure_10(pool(7394).BottomSheetTitleHeader, {
      title: pool.summary,
...
function PoolUsers(pool) {
  ...
  return closure_10(pool(5822).TableRow, {
...
let items = [
  ...
  fn(9516).ShieldIcon,
  fn(11299).GiftIcon,
  fn(15869).AchievementsIcon,
  fn(12179).PiggyBankIcon,
  fn(15871).TreehouseIcon,
  fn(10217).SpeedometerIcon,
  fn(15873).CompassIcon,
  fn(14110).SignPostIcon,
  fn(15875).CarIcon,
  fn(15877).TrainIcon,
  fn(15879).TeacupIcon,
  fn(15881).InventoryIcon,
  fn(10611).FoodIcon,
  fn(15883).BurgerIcon,
  fn(15885).MagicDoorIcon,
  fn(15887).PawPrintIcon,
  fn(15889).RecordPlayerIcon,
  fn(7622).SettingsIcon,
];
