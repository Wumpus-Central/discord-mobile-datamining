...
export default function OneTimeLoginModal(token) {
  ...
  obj = { dark: token(4425).OverlayOpacity.LEVEL_1 };
  obj.mixAmount = obj;
  ...
  items8[1] = closure_13(token(4602).Text, obj5);
  ...
  const items10 = [closure_13(token(4602).Text, obj7), ];
  ...
  items10[1] = closure_13(token(7013).LinkButton, obj8);
