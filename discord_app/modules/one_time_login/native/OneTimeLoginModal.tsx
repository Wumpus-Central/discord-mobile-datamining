...
fn(4605);
let createStyles = { container: null, centerContent: null, bottomContent: null, logo: null, loadingContainer: null, link: null, raisedIcon: null };
createStyles = { padding: 24, paddingTop: 128, paddingBottom: 96, borderRadius: nativeDefault.radii.md, alignItems: "center", flex: 1, justifyContent: "space-between" };
...
createStyles.loadingContainer = { display: "flex", flexDirection: "row", gap: nativeDefault.space.PX_8, alignItems: "center", marginBottom: 48 };
let obj2 = { display: "flex", flexDirection: "row", gap: nativeDefault.space.PX_8, alignItems: "center", marginBottom: 48 };
createStyles.link = { textDecorationLine: "underline", textDecorationColor: nativeDefault.colors.TEXT_DEFAULT, flexShrink: 1 };
...
export default function OneTimeLoginModal(token) {
  ...
  const callback2 = onPress.useCallback(() => {
    ...
    obj = { style: closure_1.raisedIcon, children: map1(CircleErrorIcon.CircleErrorIcon, { size: "custom", style: { width: 40, height: 40 } }) };
  ...
  obj = { absolute: true, wide: true, tall: true, gradientOverride: closure_12[5], mix: true, angleOverride: 0, mixAmount: null };
  obj = { dark: token(4423).OverlayOpacity.LEVEL_1 };
  obj.mixAmount = obj;
  ...
  items8[1] = closure_13(token(4601).Text, obj5);
  ...
  const items10 = [closure_13(token(4601).Text, obj7), ];
  ...
  items10[1] = closure_13(token(6992).LinkButton, obj8);
