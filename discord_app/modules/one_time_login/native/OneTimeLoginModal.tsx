...
export default function OneTimeLoginModal(token) {
  ...
  const callback3 = onPress.useCallback(() => {
    ...
    const obj3 = { style: closure_1.raisedIcon, children: map1(CircleErrorIcon.CircleErrorIcon, { size: "custom", style: { width: 40, height: 40 } }) };
  }, items3);
  ...
  let obj3 = { dark: token(4647).OverlayOpacity.LEVEL_1 };
  obj2.mixAmount = obj3;
