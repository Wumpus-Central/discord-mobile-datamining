...
function _handleAttachFile() {
  ...
  const tmp = callback((arg0) => {
    ...
    const iter = (function*(arg0) {
      ...
      yield lib(10098).handleDocumentSelection(obj3);
      if (2 === tmp5) {
        if (arg0 === 1) {
          let v02 = 3;
          throw arg1;
        ...
        resolved.then((arg0) => {
          if (arg0) {
            ...
            if (_undefined3 <= 1) {
                    ...
                    if (0 !== lib.length) {
                      ...
                      for (const item10018 of assets) {
                        ...
                        if (null != item10018.uri) {
                          ...
                          obj[8] = lib(4849).UploadPlatform.REACT_NATIVE;
              ...
              if (obj3.isIOS()) {
                let length = arr2.filter((origin) => origin.origin !== found(4849).UploadOrigin.IMAGE_PICKER).length;
              } else {
                length = arr2.length;
              }
