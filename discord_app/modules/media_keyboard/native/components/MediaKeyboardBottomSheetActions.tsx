...
let closure_8 = createCacheKey.createStyles((arg0, arg1, arg2) => {
  ...
  obj = {
    ...
    marginHorizontal: ThemesDefault.modules.mobile.MEDIA_KEYBOARD_BAR_MARGIN_HORIZONTAL,
    marginBottom: null,
    borderRadius: null,
  ...
  obj[1] = obj;
  obj[2] = {
    gap: ThemesDefault.modules.mobile.MEDIA_KEYBOARD_BAR_GAP,
    alignItems: "stretch",
    flexDirection: "row",
    marginHorizontal: ThemesDefault.modules.mobile.MEDIA_KEYBOARD_BAR_BUTTONS_MARGIN_HORIZONTAL,
  };
  obj1 = {
    gap: ThemesDefault.modules.mobile.MEDIA_KEYBOARD_BAR_GAP,
    alignItems: "stretch",
  ...
  obj[3] = {
    ...
    alignItems: "center",
    padding: ThemesDefault.modules.mobile.MEDIA_KEYBOARD_BUTTON_PADDING,
    borderRadius: ThemesDefault.modules.mobile.MEDIA_KEYBOARD_BUTTON_BORDER_RADIUS,
    gap: 4,
  };
  obj3 = {};
...
const memoResult = importAllResult.memo(function MediaKeyboardBottomSheetActions(onHeightChange) {
  ...
  const tmp6 = callback3(
    ...
    tmpResult.useToken(ThemesDefault.colors.MOBILE_FLOATINGBAR_BACKGROUND_HIGHER),
    hexResult,
  );
  importDefault = tmp6;
  tmpResult = tmp(4197);
