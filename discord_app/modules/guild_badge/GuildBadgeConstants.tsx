// === Module 10021: GuildBadgeConstants ===
...
export const getBadgeTooltip = function getBadgeTooltip(badgeCategory, visibility) {
  ...
  if (BadgeCategory.BadgeCategory.STAFF === badgeCategory) {
    ...
    obj2.tooltipTitle = intl14.string(util.t.lMrv96);
    const intl15 = util.intl;
    obj2.tooltipSubtitle = intl15.string(util.t.lMrv96);
    const intl16 = util.intl;
    obj2.tooltipDescription = intl16.string(util.t.lMrv96);
    return obj2;
    ...
    obj3.tooltipTitle = intl12.string(util.t.K7iRig);
    const intl13 = util.intl;
    obj3.tooltipSubtitle = intl13.string(util.t.iCehw9);
    ...
    obj4.tooltipTitle = intl10.string(util.t.K7iRig);
    const intl11 = util.intl;
    obj4.tooltipSubtitle = intl11.string(util.t.hfYfEE);
    ...
    obj5.tooltipTitle = intl8.string(util.t.K7iRig);
    const intl9 = util.intl;
    obj5.tooltipSubtitle = intl9.string(util.t["TX+iFC"]);
    ...
    obj6.tooltipTitle = intl7.string(util.t.K7iRig);
    ...
    obj7.tooltipTitle = intl5.string(util.t.K7iRig);
    const intl6 = util.intl;
    obj7.tooltipDescription = intl6.string(util.t.op2cJ6);
    return obj7;
  } else {
