...
export const getBadgeTooltip = function getBadgeTooltip(arg0, arg1) {
  ...
  } else if (arg1 === tmp(9155).GuildVisibility.APPLY_TO_JOIN) {
  ...
  if (BadgeCategory.BadgeCategory.STAFF === arg0) {
    ...
    return obj;
  } else if (tmp(9154).BadgeCategory.VERIFIED === arg0) {
    ...
    obj1[2] = stringResult;
    return obj1;
  } else if (tmp(9154).BadgeCategory.VERIFIED_AND_PARTNERED === arg0) {
