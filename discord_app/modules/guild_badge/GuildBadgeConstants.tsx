...
export const getBadgeTooltip = function getBadgeTooltip(arg0, arg1) {
  if (arg1 === require(5823) /* GuildVisibility */.GuildVisibility.PUBLIC) {
    const intl3 = tmp(1236).intl;
    let stringResult = intl3.string(tmp(1236).t.op2cJ6);
  } else if (arg1 === tmp(5823).GuildVisibility.APPLY_TO_JOIN) {
  ...
  if (require(5822) /* BadgeCategory */.BadgeCategory.STAFF === arg0) {
    ...
    return obj;
  } else if (tmp(5822).BadgeCategory.VERIFIED === arg0) {
    ...
    obj[2] = stringResult;
    return obj;
  } else if (tmp(5822).BadgeCategory.PARTNERED === arg0) {
    ...
    obj1[2] = stringResult;
    return obj1;
  } else if (tmp(5822).BadgeCategory.VERIFIED_AND_PARTNERED === arg0) {
