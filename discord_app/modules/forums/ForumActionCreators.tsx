// === Module 8146: ForumActionCreators ===

// Module 8146 (ForumActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import util from "util" /* 1115 */;
import HTTPUtils from "HTTPUtils" /* 1271 */;
import AnalyticsFeedItemSeenActionCreators from "AnalyticsFeedItemSeenActionCreators" /* 8147 */;
import ForumChannelSeenManager from "ForumChannelSeenManager" /* 8148 */;
import AnalyticsFeedItemSeenManager from "AnalyticsFeedItemSeenManager" /* 8149 */;
  ...
  searchForumPosts(guild_id, id, current2, c1, c2) {
    ...
    return (async () => {
      ...
      if (1 === tmp7) {
        ...
        closure_128_0 = value;
        guild_id(8012).trackForumSearched({ guildId: closure_129_0, channelId: closure_129_1, numSearchResults: closure_128_0.length });
        guild_id(8012);
