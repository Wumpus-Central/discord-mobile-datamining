// === Module 7319: ForumActionCreators ===
...
import ForumChannelSeenManager from "ForumChannelSeenManager" /* 7321 */;
import AnalyticsFeedItemSeenManager from "AnalyticsFeedItemSeenManager" /* 7322 */;
...
export default {
  ...
  updateForumPostTags(id, arg1) {
    ...
    closure_1 = arg1;
    return (async () => {
      await v1(7179).unarchiveThreadIfNecessary(tmp4);
  ...
  searchForumPosts(guild_id, id, current2, c1, c2) {
    ...
    return (async () => {
      ...
      await channelId(7179).searchThreads(closure_0, channelId, closure_2, closure_3, closure_4);
      if (1 === tmp7) {
        dependencyMap = 0;
        ...
        closure_128_0 = value;
        guild_id(7181).trackForumSearched({ guildId: closure_129_0, channelId: closure_129_1, numSearchResults: closure_128_0.length });
        guild_id(7181);
