...
const prototype = function ForumChannelSeenManager(channelId) {
  ...
  const FORUM_CHANNEL = require("../../../utils/AnalyticsFeedItemSeenManager.tsx") /* maybeMarkSeen */.AnalyticsFeedTypes.FORUM_CHANNEL;
  ...
  tmp.sessionId = require("TrackingUtils.tsx") /* collectForumAnalyticsMetadata */.getForumChannelSessionId(channelId);
  return tmp;
}.prototype;
...
export const getForumPostSeenManagerId = function getForumPostSeenManagerId(arg0) {
  return "" + require("../../../utils/AnalyticsFeedItemSeenManager.tsx") /* maybeMarkSeen */.AnalyticsFeedTypes.FORUM_CHANNEL + "_" + arg0;
};
export const markForumPostItemAsSeen = function markForumPostItemAsSeen(parent_id, item, timestampMillis) {
  const result = require("../../../utils/AnalyticsFeedItemSeenActionCreators.tsx") /* markAnalyticsFeedItemSeen */.markAnalyticsFeedItemSeen("" + require("../../../utils/AnalyticsFeedItemSeenManager.tsx") /* maybeMarkSeen */.AnalyticsFeedTypes.FORUM_CHANNEL + "_" + parent_id, item, timestampMillis);
};
export const markForumPostItemAsUnseen = function markForumPostItemAsUnseen(parent_id, item, timestampMillis) {
  const result = require("../../../utils/AnalyticsFeedItemSeenActionCreators.tsx") /* markAnalyticsFeedItemSeen */.markAnalyticsFeedItemUnseen("" + require("../../../utils/AnalyticsFeedItemSeenManager.tsx") /* maybeMarkSeen */.AnalyticsFeedTypes.FORUM_CHANNEL + "_" + parent_id, item, timestampMillis);
};