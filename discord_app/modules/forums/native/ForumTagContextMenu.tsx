// === Module 10154: ForumTagContextMenu ===
...
export default function ForumTagContextMenu(children) {
  ...
  const items = [obj];
  return jsx(tagId(8745).ContextMenu, { triggerOnLongPress: true, items, enabled, children: children.children });
};