...
export default function ForumTagContextMenu(children) {
  ...
  const items = [obj];
  return jsx(tagId(9310).ContextMenu, { triggerOnLongPress: true, items, enabled, children: children.children });
};