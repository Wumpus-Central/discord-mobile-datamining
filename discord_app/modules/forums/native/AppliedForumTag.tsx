// === Module 10263: AppliedForumTag ===

// Module 10263 (AppliedForumTag)
import noopAll from "noop" /* 19 */;
import initialize from "initialize" /* 589 */;
import ThemesDefault from "Themes" /* 712 */;
import ForumTagContextMenuDefault from "ForumTagContextMenu" /* 10264 */;
  ...
  constructor(arg0) {
    ...
    obj = {
      ...
      children(ref) {
            ...
            const items = [lib.container, closure_0];
            const intl = require(_undefined[9]).intl;
            let obj = { tagName: _undefined };
            obj[2] = intl.formatToPlainString(require(_undefined[9]).t.tXXD6v, obj);
            obj[3] = ref.ref;
            ...
            if (tmp11Result) {
              ...
              ({ textEmoji: obj3[0], emoji: obj3[1] } = lib);
              let emojiURL;
              if (null != closure_5) {
                obj1 = { id: null, animated: null, size: null };
                ({ id: obj5[0], animated: obj5[1] } = closure_5);
                obj1[2] = closure_5;
                emojiURL = lib(_undefined[11]).getEmojiURL(obj1);
                const tmp12Result = lib(_undefined[11]);
              }
              obj[2] = emojiURL;
              if (str == null) {
                str = "";
              ...
              obj[3] = str;
              tmp11Result = str(lib(_undefined[10]), obj);
              const tmp13 = lib(_undefined[10]);
            }
            const items1 = [tmp11Result, str(require(_undefined[12]).Text, { lineClamp: 1, style: lib.tagName, variant: "text-xs/semibold", color: str, children: _undefined })];
            obj.children = items1;
...
const createCacheKey = { height: 24, paddingHorizontal: 8, borderRadius: 20, backgroundColor: ThemesDefault.colors.BACKGROUND_MOD_NORMAL, borderWidth: 1, borderColor: ThemesDefault.colors.BORDER_SUBTLE, marginRight: 4, flexShrink: 1 };
...
const result = require("obj132").fileFinishedImporting("modules/forums/native/AppliedForumTag.tsx");
