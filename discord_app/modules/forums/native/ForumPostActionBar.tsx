// === Module 10608: ForumPostActionBar ===
...
export default function ForumPostActionBar(channel) {
  ...
  if (tmp11) {
    ...
    obj1[2] = firstMessage;
    obj1[3] = tmp7[0];
    obj[1] = callback(tmp2(10609).ForumPostActionBarReactions, obj1);
  ...
  if (stateFromStores2) {
    ...
    items7[1] = callback(tmp2(4783).PressableOpacity, obj3);
    obj2[2] = items7;
    ...
    let items9 = function handleFollow() {
      const result = channel(9492).handleToggleFollowForumPost(channel, stateFromStores1);
    };
    ...
    if (stateFromStores1) {
      ...
      obj4[2] = tmp.actionButton;
      obj4[3] = items9;
      const items11 = [callback(tmp2(10382).BellIcon, { size: "xs" }), ];
      ...
      items11[1] = callback(tmp2(4251).Text, obj6);
      obj4[4] = items11;
      tmp15 = obj4;
    }
    tmp9(tmp2(4783).PressableOpacity, tmp15);
  }
};