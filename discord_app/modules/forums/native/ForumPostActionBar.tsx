// === Module 11756: ForumPostActionBar ===
...
export default function ForumPostActionBar(channel) {
  ...
  let obj = channel(504);
  const firstMessage = channel(7632).useFirstForumPostMessage(channel).firstMessage;
  let obj2 = channel(7632);
  ...
  const items4 = [tmp.actionBarContainer, channel(8201).useGradientTop()];
  obj6.style = items4;
  ...
  if (tmp11) {
    ...
    obj7.children = closure_10(tmp2(11757).ForumPostActionBarReactions, obj8);
  ...
  if (stateFromStores2) {
    ...
    obj10.children = closure_10(tmp2(4769).LinkIcon, { size: "xs" });
    items7[1] = closure_10(tmp2(5425).PressableOpacity, obj10);
    ...
    obj11.children = closure_10(tmp2(11758).ArrowLargeUpIcon, { size: "xs" });
    items7[2] = closure_10(tmp2(5425).PressableOpacity, obj11);
    ...
    if (stateFromStores1) {
      ...
      intl = closure_10;
      items9 = [closure_10(tmp2(4777).CheckmarkLargeIcon, { size: "xs", color: "text-brand" }), ];
      Text = tmp2(4823).Text;
      ...
      obj12.style = tmp.actionButton;
      obj12.onPress = items9;
      const items11 = [closure_10(tmp2(9953).BellIcon, { size: "xs" }), ];
      ...
      items11[1] = closure_10(tmp2(4823).Text, obj14);
      obj12.children = items11;
      tmp15 = obj12;
    }
    closure_11(tmp2(5425).PressableOpacity, tmp15);
  }
  const obj5 = channel(8201);
};