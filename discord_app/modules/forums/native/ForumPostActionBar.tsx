...
fn(4605);
let createStyles = { actionBarContainer: null, actionRow: null, reactionRow: null, actionButton: null, actionButtonsContainer: null, lastActionButton: null, buttonText: null };
createStyles = { overflow: "hidden", paddingHorizontal: 12, paddingVertical: 8, display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWER, marginBottom: -1 };
...
createStyles.actionButton = { display: "flex", flexDirection: "row", alignItems: "center", paddingHorizontal: 8, height: 28, marginRight: 4, borderRadius: nativeDefault.radii.xs, borderWidth: 1, backgroundColor: nativeDefault.colors.CONTROL_SECONDARY_BACKGROUND_DEFAULT, borderColor: nativeDefault.colors.CONTROL_SECONDARY_BACKGROUND_DEFAULT };
...
export default function ForumPostActionBar(channel) {
  ...
  if (tmp11) {
    ...
    obj.children = closure_10(tmp2(11486).ForumPostActionBarReactions, obj1);
  ...
  if (stateFromStores2) {
    ...
    obj3.children = closure_10(tmp2(4548).LinkIcon, { size: "xs" });
    items7[1] = closure_10(tmp2(5173).PressableOpacity, obj3);
    ...
    obj4.children = closure_10(tmp2(11487).ArrowLargeUpIcon, { size: "xs" });
    items7[2] = closure_10(tmp2(5173).PressableOpacity, obj4);
    ...
    if (stateFromStores1) {
      ...
      items11[1] = closure_10(tmp2(4601).Text, obj7);
      obj5.children = items11;
      tmp15 = obj5;
    }
    closure_11(tmp2(5173).PressableOpacity, tmp15);
  }
};