...
export default noop.memo(() => {
  ...
  obj = {
    ...
    ROW_OPACITY_END,
    withDelay: stateFromStores(4341).withDelay,
    INITIAL_DELAY_MS: 1000,
    withRepeat: stateFromStores(4341).withRepeat,
    withSequence: stateFromStores(4341).withSequence,
    withTiming: stateFromStores(4606).withTiming,
    timingConfig,
  };
  fn.__closure = obj;
