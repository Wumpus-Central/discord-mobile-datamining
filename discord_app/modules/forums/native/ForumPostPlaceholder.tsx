...
export default noop.memo(() => {
  ...
  fn.__closure = {
    ...
    ROW_OPACITY_END,
    withDelay: stateFromStores(4374).withDelay,
    INITIAL_DELAY_MS: 1000,
    withRepeat: stateFromStores(4374).withRepeat,
    withSequence: stateFromStores(4374).withSequence,
    withTiming: stateFromStores(4639).withTiming,
    timingConfig,
  };
  ...
  let obj4 = {
    style: animatedStyle,
    pointerEvents: "none",
    children: jsx(stateFromStores(5693).Card, { variant: "secondary", style: tmp.postPlaceholder }),
  };
  return jsx(timingConfig(4374).View, {
    style: animatedStyle,
    pointerEvents: "none",
    children: jsx(stateFromStores(5693).Card, { variant: "secondary", style: tmp.postPlaceholder }),
  });
