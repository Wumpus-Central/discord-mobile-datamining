...
export default noop.memo(() => {
  ...
  fn.__closure = {
    ...
    ROW_OPACITY_END,
    withDelay: stateFromStores(4493).withDelay,
  ...
  let obj4 = {
    style: animatedStyle,
    pointerEvents: "none",
    children: jsx(stateFromStores(5826).Card, { variant: "secondary", style: tmp.postPlaceholder }),
  };
  return jsx(timingConfig(4493).View, {
    style: animatedStyle,
    pointerEvents: "none",
    children: jsx(stateFromStores(5826).Card, { variant: "secondary", style: tmp.postPlaceholder }),
  });
