...
const memoResult = importAllResult.memo(() => {
  ...
  const fn = function _() {
    ...
    if (stateFromStores) {
      ...
      obj[0] = obj2.withDelay(
        1000,
        obj3.withRepeat(
          obj4.withSequence(withTimingResult, stateFromStores(closure_1_2[8]).withTiming(1, timingConfig)),
          -1,
          true,
        ),
      );
  ...
  obj = {
    ...
    ROW_OPACITY_END: c8,
    withDelay: stateFromStores(4217).withDelay,
  ...
  return jsx(timingConfig(4217).View, {
    style: animatedStyle,
    pointerEvents: "none",
    children: jsx(stateFromStores(5610).Card, { variant: "secondary", style: callback2().postPlaceholder }),
  });
});
