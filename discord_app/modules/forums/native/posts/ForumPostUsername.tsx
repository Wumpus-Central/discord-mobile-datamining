...
import ForumPostGridBody from "ForumPostGridBody" /* 12036 */;
...
function ForumPostUsername(arg0) {
  ...
  if ("username" === stateFromStores) {
    ...
    if (null != authorName) {
      ...
      const obj4 = { variant: "text-sm/semibold", color: "mobile-text-heading-primary", gradientColors: tmp25, lineClamp: 1, style: null, children: null };
