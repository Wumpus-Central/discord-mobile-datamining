...
import _modDef12077 from "../../../../../../_runtime/metro/12077__.js";
import _modDef12078 from "../../../../../../_runtime/metro/12078__.js";
...
function ExtraMediaIcon(extraMediaCount) {
  ...
  obj = { source: _modDef11317, color: tmp.icon.color, size: native.Icon.Sizes.REFRESH_SMALL_16 };
  ...
  obj = {
    ...
    color: "text-default",
    children: "+" + extraMediaCount.extraMediaCount,
  };
...
let createStyles = {
  gifIcon: null,
  container: null,
  wideAspectRatioContainer: null,
  mediaIconContainer: null,
  headerLeftContainer: null,
  footerLeftContainer: null,
  footerRightContainer: null,
  extraMediaCountContainer: null,
  extraMediaCount: null,
  grid: null,
  wideAspectRatioGrid: null,
  column: null,
  columnSpacer: null,
  rowSpacer: null,
  icon: null,
...
createStyles.footerLeftContainer = {
  flexDirection: "row",
  position: "absolute",
  bottom: 4,
  left: 4,
...
createStyles.footerRightContainer = {
  position: "absolute",
  bottom: 4,
  right: 4,
  alignItems: "center",
...
createStyles.extraMediaCountContainer = {
  flexDirection: "row",
  alignItems: "center",
...
export default function ForumPostGridBody(thread) {
  ...
  if (tmp13Result) {
    ...
    obj1.children = closure_6(thread(12083).ForumPostAppliedTagPills, obj2);
