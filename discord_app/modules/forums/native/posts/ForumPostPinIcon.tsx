...
import _modDef12074 from "../../../../../_runtime/metro/12074__.js";
...
export default function ForumPostPinIcon(containerStyle) {
  ...
  obj.style = items;
  obj = { source: _modDef12074, style: tmp.pinIcon };
  obj.children = jsx(native.Icon, { source: _modDef12074, style: tmp.pinIcon });
  return <View source={_modDef12074} style={tmp.pinIcon} />;
}
