...
let createCacheKey = { tintColor: ThemesDefault.colors.ICON_MUTED, marginEnd: 4, marginTop: null };
let num = 0;
if (obj132.isAndroid()) {
  num = 2;
}
...
const result = obj132.fileFinishedImporting("modules/forums/native/posts/ForumPostMessageCount.tsx");
...
export default function ForumPostMessageCount(hasUnreads) {
  ...
  if (tmp5Result) {
    ...
    obj4[0] = unreadCount;
    const items2 = ["(", intl2.format(getSystemLocale.t.z3PEth, obj4), ")"];
    obj3[3] = items2;
    tmp5Result = callback2(Text.Text, obj3);
  }
  items1[2] = tmp5Result;
  obj[2] = items1;
