...
import ClientThemesOverrides from "ClientThemesOverrides" /* 8119 */;
...
import ForumPostDefault from "ForumPost" /* 12257 */;
import ForumPostPlaceholderDefault from "ForumPostPlaceholder" /* 12284 */;
import _modDef13026 from "module_13026" /* 13026 */;
import CreateGameInvitePostModalActionCreators from "CreateGameInvitePostModalActionCreators" /* 13027 */;
...
function GameInvitesChannelHeaderGameIcon(channel) {
  ...
  if (null != application) {
    ...
    tmp8Result = closure_14(tmp(tmp2[25]).PressableOpacity, obj3);
...
function SortAndViewOptions(channel) {
  ...
  const callback = noop.useCallback(() => {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(13020, dependencyMap.paths), combined, {
      channelId: id,
      onClose() {
  ...
  return closure_14(id(5187).Button, { variant: "secondary", text: stringResult, onPress: callback, size: "sm", icon: closure_14(id(12408).ArrowsUpDownIcon, { size: "xxs" }) });
}
function TagFilter(channel) {
  ...
  obj.onPress = function onPress() {
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(13021, dependencyMap.paths), "ForumTagFilterActionSheet", { channel });
  };
  obj.icon = closure_14(channel(9146).TagIcon, { size: "xxs" });
  return closure_14(channel(5187).Button, obj);
}
...
function ForumChannelContent(channel) {
  ...
  const items6 = [undefined, canViewArchivedPosts1, canSearchForumPosts, activeThreadIds, stateFromStores, archivedThreadIds, loading, isSearchLoading];
  ...
  if (tmp18) {
    ...
    return closure_14(tmp4(tmp5[40]), obj8);
  } else {
    ...
    obj14.children = closure_14(tmp8(tmp5[41]).FlashList, obj15);
    const obj17 = { children: null };
    const items9 = [closure_14(tmp4(tmp5[43]), { absolute: true, mix: true }), closure_14(archivedThreadIds, obj14)];
...
export default function ForumChannel(channel) {
  ...
  const callback1 = searchQuery.useCallback(() => {
    function startCreateForumPostFlow() {
      if (closure_1_1) {
        ...
        obj = closure_1(analyticsLocations[55]);
      }
  ...
  if (tmp25Result) {
    const obj9 = { channel };
    tmp25Result = closure_14(TagFilter, obj9);
  }
  ...
  obj12.icon = require("module_13030");
  ...
  if (null != channel.guild_id) {
    const obj13 = { channel };
    tmp25Result2 = closure_14(tmp2(tmp3[64]).MemberActionChatInputBannerGuarded, obj13);
  }
