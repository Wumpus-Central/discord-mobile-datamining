...
function SortAndViewOptions(channel) {
  ...
  return closure_14(id(5271).Button, {
    variant: "secondary",
    text: stringResult,
    onPress: callback,
    size: "sm",
    icon: closure_14(id(12484).ArrowsUpDownIcon, { size: "xxs" }),
  });
}
function TagFilter(channel) {
  ...
  obj.onPress = function onPress() {
    ActionSheetActionCreatorsDefault.openLazy(
      asyncRequireImpl(13103, dependencyMap.paths),
...
export default function ForumChannel(channel) {
  ...
  obj12.icon = require("../../../../_runtime/metro/13112__.js");
