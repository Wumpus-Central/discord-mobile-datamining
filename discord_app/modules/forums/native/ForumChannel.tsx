...
import _modDef12920 from "../../../../_runtime/metro/12920__.js";
...
function SortAndViewOptions(channel) {
  ...
  return closure_14(id(5062).Button, {
    variant: "secondary",
    text: stringResult,
    onPress: callback,
    size: "sm",
    icon: closure_14(id(12302).ArrowsUpDownIcon, { size: "xxs" }),
  });
}
function TagFilter(channel) {
  ...
  obj.onPress = function onPress() {
    ActionSheetActionCreatorsDefault.openLazy(
      asyncRequireImpl(12915, dependencyMap.paths),
...
export default function ForumChannel(channel) {
  ...
  obj12.icon = require("../../../../_runtime/metro/12924__.js");
