...
export default function ForumPostTagsActionSheet(thread) {
  ...
  obj.header = toggleTag(thread(7163).BottomSheetTitleHeader, obj);
  ...
  obj2.children = toggleTag(thread(4989).Button, obj3);
  items[1] = toggleTag(closure_5, obj2);
  obj.children = items;
  return closure_8(thread(7211).ActionSheet, obj);
}
