      ...
      if (0 === c8) {
        ...
        if (arg0 === 1) {
          ...
          closure_132_5.on("progress", (currentSize) => {
            const kestrelConfig = closure_0(5349).getKestrelConfig({
              location: "native.AddMediaToOriginalForumPostActionSheet",
            });
        ...
        if (arg0 === 1) {
          ...
          c9 = 1;
          const obj15 = {
            value: closure_133_1(closure_133_2[21]).unarchiveThreadIfNecessary(closure_132_0),
            done: false,
          };
          return obj15;
        }
        ...
        if (5 === tmp9) {
          ...
          if (closure_132_10.code === closure_133_11.EXPLICIT_CONTENT) {
            const result1 = closure_133_1(closure_133_2[24]).sendExplicitMediaClydeError(
              closure_132_0,
...
let obj2 = {
  ...
  postContent: { marginBottom: 0, padding: 8 },
...
export default function AddMediaToOriginalForumPostActionSheet(threadId) {
  ...
  const stateFromStores = threadId(sendMessage[28]).useStateFromStores(
    items,
  ...
  stateFromStores1 = threadId(sendMessage[28]).useStateFromStores(
    items2,
    () => {
      let guildId;
  ...
  const stateFromStores2 = threadId(sendMessage[28]).useStateFromStores(
    items4,
  ...
  const obj7 = {
    pointerEvents: "none",
    style: tmp.post,
    children: closure_13(threadId(sendMessage[33]).ForumPostListDisabled, {
      threadId,
      localDeviceMedia: tmp16,
      style: tmp.postContent,
    }),
  };
