          ...
          if (0 === c8) {
            ...
            if (arg0 === 1) {
              ...
              onResult = onResult.on("progress", (currentSize) => {
                ...
                const tmp3 = message;
                const effectiveKestrelLimit = _undefined(5131).getEffectiveKestrelLimit(
                  kestrelConfig,
                  maxFileSizeResult,
                );
            ...
            if (5 === tmp9) {
              ...
              if (store.code === closure_11.EXPLICIT_CONTENT) {
                ...
                const result1 = obj4.sendExplicitMediaClydeError(
                  callback,
                  store.attachments,
                  callback(7354).TrackMediaRedactionContext.EXPLICIT_MEDIA_ADD_MEDIA_TO_FORUM_POST_BLOCKED,
                );
              } else {
                onResult = c5;
                onResult = callback2;
