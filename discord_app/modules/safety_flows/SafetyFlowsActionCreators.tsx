...
let closure_5 = async function _getCurrentTask() {
  closure_0 = tmp4;
  await TrackedHTTPUtilsDefault.get({ url: constants.SAFETY_FLOWS_TASK, trackedActionData: { event: discord_common_AnalyticsUtils.NetworkActionNames.USER_VERIFY }, rejectWithError: true });
  closure_128_0 = value;
  let body = null;
