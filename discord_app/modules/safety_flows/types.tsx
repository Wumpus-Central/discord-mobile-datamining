...
const obj = {
  ...
  AGE_VERIFICATION: 9,
  [9]: "AGE_VERIFICATION",
  PARENTAL_CONSENT_CONNECTION: 10,
  [10]: "PARENTAL_CONSENT_CONNECTION",
  APP_STORE_PARENTAL_REVOCATION: 11,
  [11]: "APP_STORE_PARENTAL_REVOCATION",
};
const obj2 = {
...
obj4[obj.EMAIL_VERIFICATION] = intl.string(_modDef2781["Qm6K/s"]);
const intl2 = util.intl;
obj4[obj.AGE_VERIFICATION] = intl2.string(_modDef2781["dSkE/A"]);
const intl3 = util.intl;
obj4[obj.PARENTAL_CONSENT_CONNECTION] = intl3.string(_modDef2781.dMMSA0);
const intl4 = util.intl;
obj4[obj.APP_STORE_PARENTAL_REVOCATION] = intl4.string(_modDef2781.Z87TFb);
...
export const TASK_TYPE_TO_SCREENS = {
  ...
  [obj.AGE_VERIFICATION]: items3,
  [obj.PARENTAL_CONSENT_CONNECTION]: items4,
  [obj.APP_STORE_PARENTAL_REVOCATION]: items5,
};
