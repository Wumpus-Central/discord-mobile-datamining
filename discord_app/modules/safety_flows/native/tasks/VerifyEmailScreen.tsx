...
export default function _default() {
  ...
  obj.title = intl.string(require("../../SafetyFlows.messages.js")["Qm6K/s"]);
  const intl2 = onTaskComplete(value[8]).intl;
  obj.action = intl2.string(require("../../SafetyFlows.messages.js").wq2RDq);
  ...
  obj1.children = intl3.string(require("../../SafetyFlows.messages.js").aveKoG);
  ...
  obj3.placeholder = intl4.string(require("../../SafetyFlows.messages.js").d9Ykjr);
  obj3.value = value;
