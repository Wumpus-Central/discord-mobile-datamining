...
export default function _default() {
  ...
  const onAction = noop.useCallback(
  ...
  obj3.title = intl.string(require("../../SafetyFlows.messages.js")["Qm6K/s"]);
  const intl2 = onTaskComplete(value[8]).intl;
  obj3.action = intl2.string(require("../../SafetyFlows.messages.js").wq2RDq);
  ...
  obj5.children = intl3.string(require("../../SafetyFlows.messages.js").aveKoG);
  ...
  obj7.placeholder = intl4.string(require("../../SafetyFlows.messages.js").d9Ykjr);
  obj7.value = value;
