...
export default function PendingRequestList(arg0) {
  ...
  _require = tmp;
  require("../../../parent_tools/hooks/useRefreshLinkCodeOnExpiry.tsx")(expiresAt, onRefreshLinkCode);
  let obj = _require("../../usePendingParentRequests.tsx");
  obj = {
    pendingRequests,
  ...
  obj4[3] = intl.string(require("../../SafetyFlows.messages.js")["/SbB94"]);
  items1[1] = callback(_require("../../../../design/components/Text/native/Text.tsx").Text, obj4);
  ...
  const items3 = [callback(c5, { style: tmp.inviteIconContainer, children: callback(_require("../../../../design/assets/native.tsx").PlaneIllocon, { size: 32 }) }), , ];
  ...
  obj9[2] = intl2.string(require("../../SafetyFlows.messages.js").z9gkwZ);
  const items4 = [callback(_require("../../../../design/components/Text/native/Text.tsx").Text, obj9), ];
  const obj10 = { variant: "text-xs/medium", color: "text-default", children: null };
  const intl3 = tmp5(1236).intl;
  obj10[2] = intl3.string(require("../../SafetyFlows.messages.js")["9t4+vC"]);
  items4[1] = callback(_require("../../../../design/components/Text/native/Text.tsx").Text, obj10);
  obj8[1] = items4;
  ...
  obj12[1] = intl4.string(_require("../../../../intl/index.native.tsx").t.Ej3B3Y);
  obj12[2] = onShare;
  const items5 = [, ];
  ({ actionButton: arr6[0], inviteShareButton: arr6[1] } = tmp);
  obj12[3] = items5;
  obj12[4] = callback(_require("../../../../design/components/Icon/native/redesign/generated/ShareIcon.tsx").ShareIcon, { size: "sm", color: tmp.declineIcon.color });
  const items6 = [callback(_require("../../../../design/void/Pressables/native/Pressables.tsx").PressableOpacity, obj12), ];
  ...
  obj14[1] = intl5.string(require("../../SafetyFlows.messages.js").z9gkwZ);
  obj14[2] = onInviteAnotherGuardian;
  const items7 = [, ];
  ({ actionButton: arr8[0], inviteQrButton: arr8[1] } = tmp);
  obj14[3] = items7;
  obj14[4] = callback(_require("../../../../design/components/Icon/native/redesign/generated/QrCodeIcon.tsx").QrCodeIcon, { size: "sm", color: tmp.declineIcon.color });
  items6[1] = callback(_require("../../../../design/void/Pressables/native/Pressables.tsx").PressableOpacity, obj14);
  obj11[1] = items6;
  items3[2] = closure_8(c5, obj11);
  obj6[1] = items3;
  items[2] = closure_8(c5, obj6);
  obj[1] = items;
  return closure_8(_require("../../../../design/components/Stack/native/Stack.native.tsx").Stack, obj);
};
