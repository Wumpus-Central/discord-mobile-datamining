...
class PendingRequestRow {
  constructor(arg0) {
    ...
    items2 = [, ,];
    items2[0] = jsx(tmp2(tmp3[11]).Text, {
...
const size1 = {
  width: fn(1178).AVATAR_SIZE_MAP[fn(undefined, 1178).AvatarSizes.NORMAL],
  height: fn(1178).AVATAR_SIZE_MAP[fn(undefined, 1178).AvatarSizes.NORMAL],
  alignItems: "center",
  justifyContent: "center",
};
createStyles.inviteIconContainer = size1;
let obj8 = { color: nativeDefault.colors.INTERACTIVE_TEXT_DEFAULT };
createStyles.inviteQrButton = {
  backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST,
  borderWidth: 1,
  borderColor: nativeDefault.colors.BORDER_STRONG,
};
...
createStyles.inviteShareButton = {
  backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST,
  borderWidth: 1,
  borderColor: nativeDefault.colors.BORDER_STRONG,
  marginRight: nativeDefault.space.PX_8,
