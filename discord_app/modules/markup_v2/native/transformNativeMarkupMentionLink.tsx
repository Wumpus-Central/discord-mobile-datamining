// discord_app/modules/markup_v2/native/transformNativeMarkupMentionLink.tsx
...
export const transformNativeMentionLink = function transformNativeMentionLink(value, channelId) {
  ...
  if ("channel" !== type) {
    if ("message" !== type) {
      if ("attachment" === type) {
        ...
        const obj4 = { type: MarkupTypes.AST_KEY.TEXT, content: "" };
        return obj4;
      }
    }
  }
  ...
  if (null == channel) {
    ...
    let handleUnknownChannelResult = tmpResult4.handleUnknownChannel(
      str14,
      str19,
      str20,
