    ...
    return MarkupRules.hydrateUserMention(
      {
        fullMatch: "@everyone",
        id: "accessible",
        everyoneOrHere: 0.,
      },
      allowGameMentions,
    );
  } else if ("here" === type) {
    return MarkupRules.hydrateUserMention(
      {
        ...
        id: "accessible",
        everyoneOrHere:
          -0.,
      },
      allowGameMentions,
    );
  } else if ("role" === type) {
