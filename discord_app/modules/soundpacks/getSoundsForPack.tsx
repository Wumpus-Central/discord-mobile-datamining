...
let closure_0 = {
  ...
  [Soundpacks.RETRO]: { message1: "bit_message1" },
  [Soundpacks.BUBBLE]: { message1: "bop_message1" },
  [Soundpacks.DUCKY]: { message1: "ducky_message1" },
  [Soundpacks.LOFI]: { message1: "lofi_message1" },
  [Soundpacks.ASMR]: { message1: "asmr_message1" },
  [Soundpacks.DISCODO]: { message1: "discodo" },
  [Soundpacks.HALLOWEEN]: {
