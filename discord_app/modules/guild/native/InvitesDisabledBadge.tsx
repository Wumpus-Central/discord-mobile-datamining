...
import registerAssetDefault from "../../../../_runtime/12725_registerAsset.js";
...
obj = {
  ...
  padding: require("Button").BADGE_PADDING,
  height: 16,
  width: 16,
  alignContent: "center",
...
createCacheKey = {
  ...
  position: "absolute",
  bottom: -require("Button").BADGE_PADDING,
  right: -require("Button").BADGE_PADDING,
  padding: require("Button").BADGE_PADDING,
  height: 22,
  width: 22,
  alignContent: "center",
...
const memoResult = importAllResult.memo(function InvitesDisabledBadge(style) {
  ...
  obj[1] = jsx(Button.ThemedIcon, {
    style: tmp.pause,
    themedColor: ThemesDefault.colors.INTERACTIVE_TEXT_ACTIVE,
    source: registerAssetDefault,
  });
  obj[1] = (
    <View style={tmp.pause} themedColor={ThemesDefault.colors.INTERACTIVE_TEXT_ACTIVE} source={registerAssetDefault} />
  );
  return (
    <View style={tmp.pause} themedColor={ThemesDefault.colors.INTERACTIVE_TEXT_ACTIVE} source={registerAssetDefault} />
  );
