...
import _modDef12135 from "../../../../_runtime/metro/12135__.js";
import _modDef12136 from "../../../../_runtime/metro/12136__.js";
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    if (obj6.isThemeDark(ThemeStore.theme)) {
      let tmp13Result = _modDef12134;
    } else {
      tmp13Result = _modDef12135;
    }
...
prototype["renderUpload"] = function renderUpload() {
  ...
  if (null != props.icon) {
    ...
    const obj7 = { source: _modDef12137 };
...
GuildIconUploader.contextType = fn(4533).ThemeContext;
size = fn(2);
