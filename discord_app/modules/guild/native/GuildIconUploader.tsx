// === Module 12056: GuildIconUploader ===
...
prototype["renderIcon"] = function renderIcon() {
  ...
  if (null != icon) {
    ...
    if (obj6.isThemeDark(ThemeStore.theme)) {
      let tmp13Result = _modDef12057;
    } else {
      tmp13Result = _modDef12058;
    }
...
prototype["renderUpload"] = function renderUpload() {
  ...
  if (null != props.icon) {
    ...
    const obj7 = { source: _modDef12060 };
...
GuildIconUploader.contextType = fn(4467).ThemeContext;
size = fn(2);
