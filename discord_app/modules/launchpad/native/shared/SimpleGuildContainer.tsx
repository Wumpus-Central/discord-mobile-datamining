// === Module 16972: SimpleGuildContainer ===
...
import CutoutImageDefault from "CutoutImage" /* 16973 */;
...
export const SimpleGuildContainer = function SimpleGuildContainer(selected) {
  ...
  const memo = badge.useMemo(() => {
    ...
    if (!selected) {
      ...
      let obj = { style: { position: "absolute", top: -2, left: -2 }, cutoutTopRightSize: null, cutoutTopRightInsetX: 8, cutoutTopRightInsetY: 8, cutoutBottomRightSize: null, cutoutBottomRightInsetX: 6, cutoutBottomRightInsetY: 7, imageSize: null, imageBackgroundColor: null, imageBorderRadius: null, clipInnerAmount: null };
      let source;
  ...
  obj = { style, accessible: true, accessibilityState: { selected }, accessibilityRole: "button", accessibilityLabel, accessibilityActions: null, onAccessibilityAction, children: null };
...
export const SimpleGuildContainerAnimated = function SimpleGuildContainerAnimated(arg0) {
  ...
  obj = { withSpring: selected(tmp2[11]).withSpring, toRadius: derivedValue, springConfig, GUILD_SIZE: v48, iconBackground };
  H.__closure = obj;
  ...
  obj = { withSpring: selected(tmp2[11]).withSpring, toRadius: derivedValue, springConfig, interpolate: selected(tmp2[10]).interpolate, toStrokeWidth: derivedValue1, borderColor: BRAND_500, GUILD_SIZE: v48 };
  fn2.__closure = obj;
  ...
  obj1 = { withSpring: selected(tmp2[11]).withSpring, toRadius: derivedValue, springConfig, interpolate: selected(tmp2[10]).interpolate, toStrokeWidth: derivedValue1, backgroundColor, GUILD_SIZE: v48 };
  M.__closure = obj1;
  ...
  if (null != onPress) {
    let obj3 = { ref: guildIconRef, style, onPress, onLongPress, accessibilityRole: "button", accessible: true, accessibilityLabel, accessibilityState: null, onAccessibilityAction: null, onLayout: null, children: null };
    obj4 = { selected };
