...
let closure_20 = importAllResult.memo(function UnmemoedVoiceOrStageChannelBase(channel) {
  ...
  items2 = [channel.id];
  const arr5 = callback(11503)(channel);
  ...
  if (!channel.isGuildStageVoice()) {
    ...
    obj2[1] = tmp5(16139).renderChannelSubtitle(obj3);
    if (!unread) {
    ...
    if (arr5.length > 0) {
      ...
      obj6[0] = channel;
      obj6[1] = voiceStates;
      tmp32 = callback2(tmp5(11722).VocalChannelJoinButton, obj6);
    }
    obj2[7] = tmp32;
