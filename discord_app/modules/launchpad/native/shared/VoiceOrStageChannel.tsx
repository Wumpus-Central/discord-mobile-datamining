...
let closure_20 = noop.memo(function UnmemoedVoiceOrStageChannelBase(channel) {
  ...
  const baseChannelUnreadBadgeState = channel(15982).useBaseChannelUnreadBadgeState(
    channel,
  ...
  const channelAccessibilityProps = channel(16474).getChannelAccessibilityProps({
    channel,
    unread,
    mentionCount,
    voiceStates,
