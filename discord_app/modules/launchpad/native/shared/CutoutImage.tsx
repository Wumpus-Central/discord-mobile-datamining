...
import inlineStylesDefault from "../../../../../_runtime/08542_inlineStyles.js";
...
export default noop.memo(function CutoutImage(cutoutTopLeftSize) {
  ...
  if (imageBorderRadius === imageSize / 2) {
    ...
    let tmp16 = closure_6(imageTintColor(8542).Circle, obj);
    let tmp15 = closure_6;
  } else {
    tmp15 = closure_6;
    const size2 = {
  ...
  if (num14 <= 0) {
    ...
    if (null == v4Result) {
      ...
      if (null != imageBackgroundColor) {
        ...
        tmp15Result3 = tmp15(imageTintColor(8542).Rect, size3);
      }
      ...
      if (null == imageSource) {
        ...
        if (null != borderStroke) {
          ...
          tmp15Result4 = tmp15(imageTintColor(8542).Rect, size4);
        }
        ...
        if (typeof imageSource !== "number") {
          ...
          let tmp15Result5 = tmp15(imageTintColor(8542).Image, size5);
        }
        ...
        tmp15Result5 = tmp15(imageTintColor(8542).ForeignObject, size6);
      }
    } else {
      const obj6 = { id: v4Result, children: null };
      if (imageBorderRadius === imageSize / 2) {
        const obj7 = { cx: imageSize / 2, cy: imageSize / 2, r: imageSize / 4, fill: "white" };
        let tmp15Result6 = tmp15(imageTintColor(8542).Circle, obj7);
      } else {
        const size8 = {
          x: num15,
          y: num15,
        ...
        tmp15Result6 = tmp15(imageTintColor(8542).Rect, size8);
      }
      obj6.children = tmp15Result6;
      tmp15(imageTintColor(8542).ClipPath, obj6);
    }
  } else if (imageBorderRadius === imageSize / 2) {
    const obj8 = { cx: imageSize / 2, cy: imageSize / 2, r: num14 / 2, fill: "black" };
    let tmp15Result8 = tmp15(imageTintColor(8542).Circle, obj8);
  } else {
    const size9 = {
      x: (imageSize - num14) / 2,
      y: (imageSize - num14) / 2,
    ...
    tmp15Result8 = tmp15(imageTintColor(8542).Rect, size9);
  }
