...
import _modDef16693 from "../../../../../_runtime/metro/16693__.js";
...
export default noop.memo(function VoiceOrStageSummaryRow(arg0) {
  ...
  if (tmp8Result) {
    ...
    obj1.style = items3;
    let obj2 = { size: max(1178).Icon.Sizes.CUSTOM, style: { height: 14, width: 14 }, source: _modDef16693 };
    const items4 = [closure_4(max(1178).Icon, obj2)];
    let obj3 = { variant: "text-sm/bold", style: { marginLeft: 4 }, children: audienceCount };
    items4[1] = closure_4(max(4570).Text, obj3);
