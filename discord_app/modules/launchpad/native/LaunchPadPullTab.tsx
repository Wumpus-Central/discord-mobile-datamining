...
export default noop.memo(function LaunchPadPullTab(launchPadSharedState) {
        ...
        if (arg0 !== arg1) {
          if (arg0 < arg1) {
            ...
            if (0 < num2) {
              ...
              const result6 = gestureState.setLaunchPadPullTabPosition(diff2, launchPadPullTabState.get().offset + num2);
            }
          }
        }
      }
  ...
  obj = { launchPadSharedState, updaters, keyboardHeightOpened: sharedValue, launchPadPullTabState, CHAT_INPUT_HEIGHT, LAUNCH_PAD_MARGIN, getWindowDimensionsWorklet: launchPadSharedState(gestureState[9]).getWindowDimensionsWorklet, LAUNCH_PAD_PULL_TAB_HEIGHT: backgroundColor2, LAUNCH_PAD_PULL_TAB_SCALE_OFFSET };
  fn2.__closure = obj;
  ...
  obj1.children = <updaters accessibilityRole="button" accessibilityLabel={null} hitSlop={null} style={null} onTouchStart={null} onPress={null}>{null}</updaters>;
