...
function UserResult(user) {
  ...
  const obj7 = {
    ...
    isVROnline,
    status: null,
    streaming: "9b16dbb450fc7de4d4ed97b58cd6ea30",
    style: "ro.messages.9b16dbb450fc7de4d4ed97b58cd6ea30.compiled.messages",
    size: "jsona",
    animate: "authed",
    typing: null,
  ...
  if (null != lastMessage) {
    if (null != channel) {
      const obj9 = {
        ...
        color: str,
        muted: flag,
        layout: tmp6(8126).ChannelListLayoutTypes.COMPACT,
      };
      tmp14Result = closure_12(tmp6(10371).ChannelRowPreview, obj9);
    }
  }
