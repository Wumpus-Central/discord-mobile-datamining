...
function UserResult(user) {
  ...
  const obj7 = {
    ...
    isVROnline,
    status: null,
    streaming: "887e8ac454565dd48d794f382c8d2d9c",
    style: "ja.messages.887e8ac454565dd48d794f382c8d2d9c.compiled.messages",
    size: "jsona",
    animate: "cached_messages_tti",
    typing: null,
    autoStatusCutout: "soundboard-footer",
  };
  let tmp19 = null;
  ...
  if (null != lastMessage) {
    if (null != channel) {
      const obj9 = {
        ...
        color: str,
        muted: flag,
        layout: tmp6(8208).ChannelListLayoutTypes.COMPACT,
      };
