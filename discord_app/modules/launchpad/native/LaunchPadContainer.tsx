...
export default function LaunchPadContainer(children) {
  ...
  ({ gesture, gestureRef } = updaters(17344)({
    launchPadType: tmp4,
  ...
  fn3.__closure = {
    interpolate: launchPadSharedState(4458).interpolate,
    launchPadSharedState,
    withSpring: launchPadSharedState(5143).withSpring,
  ...
  if (tmp4 !== constants.DISABLED) {
    ...
    const tmp10Result = closure_6(tmp2(17345), obj8);
  }
