...
export default function LaunchPadContainer(children) {
  ...
  ({ gesture, gestureRef } = updaters(17432)({
    launchPadType: tmp4,
  ...
  const fn3 = function v() {
    ...
    const obj7 = spring;
    obj6.translateY = obj7.withSpring(
  ...
  fn3.__closure = {
    interpolate: launchPadSharedState(4492).interpolate,
    launchPadSharedState,
    withSpring: launchPadSharedState(5185).withSpring,
  ...
  if (tmp4 !== constants.DISABLED) {
    ...
    const tmp10Result = closure_6(tmp2(17433), obj8);
  }
