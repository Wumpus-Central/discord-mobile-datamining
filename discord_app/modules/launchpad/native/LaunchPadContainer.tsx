...
export default function LaunchPadContainer(children) {
  ...
  obj = { interpolate: launchPadSharedState(4296).interpolate, launchPadSharedState, withSpring: launchPadSharedState(4974).withSpring, windowDimensions: tmp7, LAUNCH_PAD_SPRING_CONFIG };
  fn3.__closure = obj;
