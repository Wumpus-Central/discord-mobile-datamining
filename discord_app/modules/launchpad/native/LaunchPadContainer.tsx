...
export default function LaunchPadContainer(children) {
  ...
  ({ gesture, gestureRef } = updaters(16760)({
    launchPadType: tmp4,
  ...
  fn3.__closure = {
    interpolate: launchPadSharedState(4563).interpolate,
    launchPadSharedState,
    withSpring: launchPadSharedState(5273).withSpring,
  ...
  if (tmp4 !== constants.DISABLED) {
    ...
    const tmp10Result = closure_6(tmp2(16761), obj8);
  }
