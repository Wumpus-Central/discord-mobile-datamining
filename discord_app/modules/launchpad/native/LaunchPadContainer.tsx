...
export default function LaunchPadContainer(children) {
  ...
  ({ gesture, gestureRef } = updaters(17214)({
    launchPadType: tmp4,
  ...
  fn3.__closure = {
    interpolate: launchPadSharedState(4376).interpolate,
    launchPadSharedState,
    withSpring: launchPadSharedState(5061).withSpring,
  ...
  if (tmp4 !== constants.DISABLED) {
    ...
    const tmp10Result = closure_6(tmp2(17215), obj8);
  }
