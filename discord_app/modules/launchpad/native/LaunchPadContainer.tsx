...
export default function LaunchPadContainer(children) {
  ...
  ({ gesture, gestureRef } = updaters(17174)({
    launchPadType: tmp4,
  ...
  fn3.__closure = {
    interpolate: launchPadSharedState(4374).interpolate,
    launchPadSharedState,
    withSpring: launchPadSharedState(5059).withSpring,
  ...
  if (tmp4 !== constants.DISABLED) {
    ...
    const tmp10Result = closure_6(tmp2(17175), obj8);
  }
