...
export default function LaunchPadContainer(children) {
  ...
  ({ gesture, gestureRef } = updaters(17536)({
    launchPadType: tmp4,
  ...
  fn3.__closure = {
    interpolate: launchPadSharedState(4561).interpolate,
    launchPadSharedState,
    withSpring: launchPadSharedState(5272).withSpring,
  ...
  if (tmp4 !== constants.DISABLED) {
    ...
    const tmp10Result = closure_6(tmp2(17537), obj8);
  }
