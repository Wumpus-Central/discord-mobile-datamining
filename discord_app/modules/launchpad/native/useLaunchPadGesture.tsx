...
export default function useLaunchPadGesture(launchPadType) {
  ...
  obj.gesture = gestureState.useMemo(() => {
    ...
    const fn = function w(arg0) {
      ...
      const result = gestureState.set({
        active: false,
        initialLaunchPadPosition: launchPadSharedState.get(),
        ...
        positionOffsetY: 0,
        startTime: Date.now(),
        requiresPop: 0 === launchPadSharedState.get(),
        startShown: 0 !== launchPadSharedState.get(),
      });
    };
    ...
    obj = {
      ...
      LAUNCH_PAD_PULL_TAB_HEIGHT,
      updaters,
      LAUNCH_PAD_PULL_TAB_SCALE_FACTOR,
    ...
    const onTouchesDownResult = maxPointersResult
      .manualActivation(PlatformUtils.isAndroid())
      .hitSlop(rect)
      .onTouchesDown(fn);
    class I {
      constructor(arg0) {
    ...
    const onTouchesMoveResult = maxPointersResult
      .manualActivation(PlatformUtils.isAndroid())
      .hitSlop(rect)
      .onTouchesDown(fn)
      .onTouchesMove(X);
    ...
    fn2.__closure = {
      ...
      launchPadType,
      LaunchPadTypes: constants,
      LAUNCH_PAD_END_TRANSLATION_THRESHOLD,
      LAUNCH_PAD_END_VELOCITY_THRESHOLD,
      updaters,
      launchPadSharedState,
    };
    ...
    const fn3 = function b() {
      ...
      launchPadSharedState(launchPadPullTabState[7])(gestureState, {
        active: false,
