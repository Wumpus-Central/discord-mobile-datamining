...
let result = require("obj132").fileFinishedImporting("modules/launchpad/native/useLaunchPadState.native.tsx");
...
export default function useLaunchPadState() {
  ...
  obj = {
    ...
    updaters: sharedValue3.useMemo(() => {
      ...
      function setLaunchPadPullTabBoundedPosition(closure_1_2) {
        const diff = setLaunchPadPullTabBoundedPosition(sharedValue2[4]).getWindowDimensionsWorklet().height - closure_1.get().offset - closure_1_4;
        obj = setLaunchPadPullTabBoundedPosition(sharedValue2[4]);
        const sum = setLaunchPadPullTabBoundedPosition(sharedValue2[5]).getSafeAreaInsetsWorklet().top + closure_1_5;
        const bound = Math.max(Math.min(closure_1_2, diff), sum);
        sharedValue1(sharedValue2[6])(closure_1, { position: bound });
        const obj2 = setLaunchPadPullTabBoundedPosition(sharedValue2[5]);
        setLaunchPadPullTabBoundedPosition(sharedValue2[3]).runOnJS(setLaunchPadPullTabBoundedPosition(sharedValue2[2]).persistLaunchPadPullTabPosition)(bound);
      }
      ...
      function setLaunchPadPullTabPosition(diff2, offset) {
        sharedValue1(sharedValue2[6])(closure_1, { position: diff2, offset });
      }
      ...
      function setLaunchPadPullTabScale(closure_1_9) {
        sharedValue1(sharedValue2[6])(closure_1, { scale: closure_1_9 });
      }
      ...
      function setLaunchPadPullTabMinimized(minimized) {
        sharedValue1(sharedValue2[6])(closure_1, { minimized });
      }
