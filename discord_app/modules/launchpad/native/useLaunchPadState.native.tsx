  ...
  obj = {
    ...
    updaters: sharedValue3.useMemo(() => {
      ...
      function setLaunchPadPullTabBoundedPosition(position) {
        const diff =
          setLaunchPadPullTabBoundedPosition(closure_1_2[4]).getWindowDimensionsWorklet().height -
          closure_1.get().offset -
          closure_1_4;
        ...
        setLaunchPadPullTabBoundedPosition(closure_1_2[3]).runOnJS(
          setLaunchPadPullTabBoundedPosition(closure_1_2[2]).persistLaunchPadPullTabPosition,
        )(bound);
      }
      obj = {
        getWindowDimensionsWorklet: sharedValue(sharedValue2[4]).getWindowDimensionsWorklet,
        launchPadPullTabState: sharedValue1,
        LAUNCH_PAD_PULL_TAB_MAX_POSITION: closure_1_4,
        getSafeAreaInsetsWorklet: sharedValue(sharedValue2[5]).getSafeAreaInsetsWorklet,
        LAUNCH_PAD_PULL_TAB_SCALE_OFFSET: closure_1_5,
      ...
      setLaunchPadPullTabTranslation = function setLaunchPadPullTabTranslation(translationY) {
        setLaunchPadPullTabBoundedPosition(
          setLaunchPadPullTabBoundedPosition.get().initialPullTabPosition + translationY,
        );
      };
