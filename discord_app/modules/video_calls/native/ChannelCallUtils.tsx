...
import registerAssetDefault3 from "../../../../_runtime/16706_registerAsset.js";
import registerAssetDefault4 from "../../../../_runtime/16707_registerAsset.js";
...
export const voiceSettings = function voiceSettings() {
  ...
  obj[2] = function onPress() {
    ...
    callback2(4412).hideActionSheet();
  };
  return obj;
};
...
export const invite = function invite(isPrivate) {
  ...
  if (isPrivate.isPrivate()) {
    onPress = function onPress() {
      return isPrivate(4299).navigateToNewGroupDM(isPrivate.id, closure_1_5.CHANNEL_CALL);
    };
  }
  let obj = { label: null, icon: null, onPress: null };
  const intl = require("../../../intl/index.native.tsx").intl;
