...
import _modDef17215 from "module_17215" /* 17215 */;
import _modDef17216 from "module_17216" /* 17216 */;
...
export const reportStreamIssue = function reportStreamIssue(stream) {
  ...
  obj.onPress = function onPress() {
    ...
    obj5.openLazy(asyncRequireImpl(17217, dependencyMap.paths), "StreamReportProblem" + stream.ownerId, { stream, analyticsData: obj });
  };
  return obj;
};
