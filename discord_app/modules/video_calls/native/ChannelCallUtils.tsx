...
import _modDef17691 from "module_17691" /* 17691 */;
...
export const openHideSelfStreamAndVideoConfirmDialog = function openHideSelfStreamAndVideoConfirmDialog(arg0, arg1) {
  ...
  actions_AlertActionCreatorsDefault.openLazy({
    importer() {
      return asyncRequireImpl(17688, dependencyMap.paths).then((result) => {
...
export const reportStreamIssue = function reportStreamIssue(stream) {
  ...
  obj.onPress = function onPress() {
    ...
    obj5.openLazy(asyncRequireImpl(17693, dependencyMap.paths), "StreamReportProblem" + stream.ownerId, { stream, analyticsData: obj3 });
    const tmp6 = asyncRequireImpl(17693, dependencyMap.paths);
  };
  return obj;
};
