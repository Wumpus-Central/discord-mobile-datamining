...
import _modDef17760 from "../../../../_runtime/metro/17760__.js";
...
export const openHideSelfStreamAndVideoConfirmDialog = function openHideSelfStreamAndVideoConfirmDialog(arg0, arg1) {
  ...
  actions_AlertActionCreatorsDefault.openLazy({
    importer() {
      return asyncRequireImpl(17757, dependencyMap.paths).then((result) => {
...
export const reportStreamIssue = function reportStreamIssue(stream) {
  ...
  obj.onPress = function onPress() {
    ...
    obj5.openLazy(asyncRequireImpl(17762, dependencyMap.paths), "StreamReportProblem" + stream.ownerId, {
      stream,
      analyticsData: obj3,
    });
    const tmp6 = asyncRequireImpl(17762, dependencyMap.paths);
  };
  return obj;
};
