...
import _modDef17249 from "../../../../_runtime/metro/17249__.js";
import _modDef17250 from "../../../../_runtime/metro/17250__.js";
...
export const reportStreamIssue = function reportStreamIssue(stream) {
  ...
  obj.onPress = function onPress() {
    ...
    obj5.openLazy(asyncRequireImpl(17251, dependencyMap.paths), "StreamReportProblem" + stream.ownerId, {
      stream,
      analyticsData: obj,
    });
    const tmp6 = asyncRequireImpl(17251, dependencyMap.paths);
  };
  return obj;
};
