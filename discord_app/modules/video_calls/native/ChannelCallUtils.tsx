...
import _modDef17462 from "../../../../_runtime/metro/17462__.js";
...
export const reportStreamIssue = function reportStreamIssue(stream) {
  ...
  obj.onPress = function onPress() {
    ...
    obj5.openLazy(asyncRequireImpl(17463, dependencyMap.paths), "StreamReportProblem" + stream.ownerId, {
      stream,
      analyticsData: obj3,
    });
    const tmp6 = asyncRequireImpl(17463, dependencyMap.paths);
  };
  return obj;
};
