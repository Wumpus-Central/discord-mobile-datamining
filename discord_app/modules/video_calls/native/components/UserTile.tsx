...
import _modDef8684 from "../../../../../_runtime/metro/08684__.js";
import _modDef9695 from "../../../../../_runtime/metro/09695__.js";
import _modDef9696 from "../../../../../_runtime/metro/09696__.js";
import _modDef9697 from "../../../../../_runtime/metro/09697__.js";
...
let closure_18 = noop.memo((guildId) => {
  ...
  obj.renderVideoDetails = function renderVideoDetails() {
    if (closure_3) {
      ...
      obj.style = items;
      obj = { source: _modDef9695, size: native.Icon.Sizes.SMALL, disableColor: true };
...
let closure_19 = noop.memo((userId) => {
  ...
  if (tmp5) {
    ...
    if (tmp5) {
      ...
      obj.style = items2;
      obj = { source: _modDef9698, size: tmp2(1178).Icon.Sizes.SMALL, disableColor: true };
