...
function FocusedControlsHeader(reveal) {
  ...
  __closure = { withTiming: reveal(4606).withTiming, offsetY: derivedValue, TIMING_CONFIG: __closure };
  ...
  const rect = { top: !derivedValue(9748)(), left: isTouchingLeftScreenEdge, right: true, children: null };
  obj1 = { style: tmp.headerContainer, children: header };
  rect.children = closure_7(closure_5, obj1);
  __closure.children = closure_7(reveal(7175).SafeAreaPaddingView, rect);
  return closure_7(derivedValue(4341).View, __closure);
}
...
export default noop.memo((disableGradient) => {
  ...
  analyticsLocations = globalStatusIndicatorHeightSharedValue(7214)(
    tmp5(7234).FOCUSED_VOICE_CONTROLS,
  ).analyticsLocations;
  closure_7 = tmp5(9703)();
  ...
  if (null != actionBar) {
    ...
    if (null != expandedControls) {
      ...
      tmp17Result = closure_7(tmp5(9761), obj1);
    }
  }
  items1[2] = tmp17Result;
  __closure.children = items1;
  return closure_8(globalStatusIndicatorHeightSharedValue(4341).View, __closure);
});
