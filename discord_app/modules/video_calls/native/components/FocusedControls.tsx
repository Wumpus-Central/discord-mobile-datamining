// === Module 10807: FocusedControlsHeader ===
...
function FocusedControlsHeader(reveal) {
  ...
  obj = { withTiming: reveal(4256).withTiming, offsetY: derivedValue, TIMING_CONFIG: obj };
  fn2.__closure = obj;
  fn2.__workletHash = 12710345257882;
  fn2.__initData = closure_12;
  const animatedStyle = obj1.useAnimatedStyle(fn2);
  obj = { style: animatedStyle, children: null };
  obj1 = { top: !derivedValue(10808)(), left: isTouchingLeftScreenEdge, right: true, children: null };
  obj1[3] = callback(closure_5, { style: tmp.headerContainer, children: header });
  obj[1] = callback(reveal(5243).SafeAreaPaddingView, obj1);
  return callback(derivedValue(4116).View, obj);
}
function FocusedControlsHeaderGradient() {
  ...
  const items1 = [callback(require(8196) /* inlineStyles */.Stop, { offset: "0%", stopColor: "black", stopOpacity: ".8" }), callback(require(8196) /* inlineStyles */.Stop, { offset: "66%", stopColor: "black", stopOpacity: ".51" }), callback(require(8196) /* inlineStyles */.Stop, { offset: "100%", stopColor: "black", stopOpacity: "0" })];
  obj1[5] = items1;
  obj[0] = callback2(require(8196) /* inlineStyles */.LinearGradient, obj1);
  const items2 = [callback(require(8196) /* inlineStyles */.Defs, obj), callback(require(8196) /* inlineStyles */.Rect, { height: "100%", width, fill: "url(#grad)" })];
  obj[2] = items2;
  obj[1] = callback2(require(8196) /* inlineStyles */.Svg, obj);
...
const memoResult = importAllResult.memo((disableGradient) => {
  ...
  let obj = require(10809) /* useGlobalStatusIndicatorState */;
  const globalStatusIndicatorState = obj.useGlobalStatusIndicatorState();
  let obj1 = require(10813) /* nativeEventEmitter */;
  globalStatusIndicatorHeightSharedValue = obj1.useGlobalStatusIndicatorHeightSharedValue(globalStatusIndicatorState);
  const tmp6 = globalStatusIndicatorHeightSharedValue(10808)();
  dependencyMap = tmp6;
  reveal = reveal.useContext(require(10708) /* useRevealProviderValue */.RevealContext).reveal;
  const isScreenReaderEnabled = require(4652) /* SCREEN_READER_ENABLED_GETTER */.useIsScreenReaderEnabled();
  if (!reveal) {
    reveal = forceReveal;
  }
  if (!reveal) {
  ...
  const obj3 = require(4652) /* SCREEN_READER_ENABLED_GETTER */;
  const fn = function y() {
  ...
  obj = { withTiming: tmp(4256).withTiming, top: derivedValue, TIMING_CONFIG: obj, revealOpacity: derivedValue1 };
  fn.__closure = obj;
  fn.__workletHash = 8532538341439;
  fn.__initData = closure_17;
  const animatedStyle = require(4116).useAnimatedStyle(fn);
  const tmpResult1 = require(4116);
  analyticsLocations = globalStatusIndicatorHeightSharedValue(5581)(tmp5(5601).FOCUSED_VOICE_CONTROLS).analyticsLocations;
  callback = tmp5(10777)();
  ...
  if (null != actionBar) {
    ...
    if (null != expandedControls) {
      ...
      obj1[6] = reveal;
      obj1[7] = children;
      tmp17Result = callback(tmp5(10819), obj1);
    }
  }
  items1[2] = tmp17Result;
  obj[2] = items1;
  return closure_8(globalStatusIndicatorHeightSharedValue(4116).View, obj);
});
