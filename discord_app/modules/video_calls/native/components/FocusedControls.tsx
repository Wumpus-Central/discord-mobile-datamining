...
import RevealProvider from "RevealProvider" /* 9727 */;
import useGlobalStatusIndicatorState from "useGlobalStatusIndicatorState" /* 9846 */;
import GlobalStatusIndicator from "GlobalStatusIndicator" /* 9851 */;
...
export default noop.memo((disableGradient) => {
  ...
  analyticsLocations = globalStatusIndicatorHeightSharedValue(7493)(tmp5(7513).FOCUSED_VOICE_CONTROLS).analyticsLocations;
  closure_7 = tmp5(9800)();
