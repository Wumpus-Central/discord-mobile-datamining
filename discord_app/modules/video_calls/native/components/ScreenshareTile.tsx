...
import useParticipantTileTapGestureDefault from "useParticipantTileTapGesture" /* 12436 */;
import registerAssetDefault from "registerAsset" /* 12437 */;
...
const createCacheKey = { alignItems: "center", justifyContent: "center", backgroundColor: ThemesDefault.colors.BLACK, overflow: "hidden", flex: 1 };
...
const result = require("obj132").fileFinishedImporting("modules/video_calls/native/components/ScreenshareTile.tsx");
...
export default function ScreenShareTile(onSingleTap) {
  ...
  const tmp = callback3();
  { gesture: useParticipantTileTapGestureDefault({ onSingleTapStart: onSingleTap, onDoubleTapStart: onDoubleTap }), children: null };
  const obj = { style: tmp.liveContainer, children: callback(Button.LiveTag, {}) };
