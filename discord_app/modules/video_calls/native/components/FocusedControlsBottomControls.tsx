...
function FocusedControlsBottomDrawerTooltip(positionY) {
  ...
  const tmp = closure_18();
  const canShowTooltip = positionY(9832).useCanShowTooltip(
  ...
  if (canShowTooltip) {
    ...
    const obj7 = {
      ...
      arrowPosition: tmp2(1177).TooltipArrowPositions.CENTER,
      arrowDirection: tmp2(1177).TooltipArrowDirections.DOWN,
      arrowWidth: 8,
      arrowHeight: 4,
      containerStyle: null,
      labelStyle: null,
...
function FocusedControlsAboveActionBarView(positionY) {
  ...
  const items = [
    ...
    closure_13(positionY(7264).ActionSheetHeaderBar, {}),
  ];
  ...
  if (tmp4Result) {
    ...
    tmp4Result = closure_13(offsetY(4374).View, obj5);
  }
  items[2] = tmp4Result;
  obj4.children = items;
