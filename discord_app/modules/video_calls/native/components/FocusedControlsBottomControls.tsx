...
function FocusedControlsBottomDrawerTooltip(positionY) {
  ...
  if (canShowTooltip) {
    ...
    const obj1 = { style: tmp.tooltipStyle, arrowPosition: tmp2(1178).TooltipArrowPositions.CENTER, arrowDirection: tmp2(1178).TooltipArrowDirections.DOWN, arrowWidth: 8, arrowHeight: 4, containerStyle: null, labelStyle: null, label: null };
...
function FocusedControlsAboveActionBarView(positionY) {
  ...
  if (tmp4Result) {
    ...
    tmp4Result = closure_13(offsetY(4343).View, obj2);
  }
  items[2] = tmp4Result;
  obj1.children = items;
  ...
  constructor(arg0) {
    ...
    if (typeof EXTENDED_CONTROLS_OFFSET_Y === "function") {
      ...
      if (typeof EXTENDED_CONTROLS_LANDSCAPE_OFFSET_Y === "function") {
        ...
        obj1 = { runOnJS: null, clearFocusTimer: null, drawerOpen: null, positionY: null, CLOSE_DRAWER_POSITION: 0, velocity: null, startY: null };
        ...
        obj4 = { reveal: null, controlHeightWithOffset: null, sheetHeight: null, isLandscapeMode: null, safeAreaRight: null, sheetWidth: null, withTiming: null, TIMING_CONFIG: null };
        obj4.reveal = reveal;
...
fn(4606);
let createStyles = { bottomDrawerContainer: null, visualEffectView: null, visualEffectViewBackground: null, expandedControlsContainer: null, aboveActionBarContainer: null, aboveActionBarChildrenContainer: null, ptbButton: null, tooltipStyle: null, containerStyle: null, labelStyle: null };
...
createStyles.aboveActionBarContainer = { position: "absolute", left: 0, right: 0, top: -32, paddingTop: 4, paddingBottom: 8 };
