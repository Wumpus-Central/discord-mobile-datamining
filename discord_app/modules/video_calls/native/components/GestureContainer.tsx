...
export default function GestureContainer(children) {
  ...
  fn.__closure = {
    ...
    runOnJS: height(4559).runOnJS,
    ModalActionCreators: sharedValue(5030),
    withTiming: height(4828).withTiming,
  ...
  obj4.children = jsx(height(6983).GestureDetector, {
    gesture: failOffsetXResult,
    children: jsx(sharedValue(4559).View, { style: animatedStyle, children: children.children }),
  });
