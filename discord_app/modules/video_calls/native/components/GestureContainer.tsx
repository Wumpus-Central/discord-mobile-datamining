...
export default function GestureContainer(children) {
  ...
  obj = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4341).runOnJS, ModalActionCreators: sharedValue(4808), withTiming: height(4606).withTiming, DECELERATED_EASING: height(1178).DECELERATED_EASING };
  fn.__closure = obj;
  ...
  obj1.children = jsx(height(6705).GestureDetector, { gesture: failOffsetXResult, children: jsx(sharedValue(4341).View, { style: animatedStyle, children: children.children }) });
