...
export default function GestureContainer(children) {
  ...
  fn.__closure = {
    ...
    runOnJS: height(4458).runOnJS,
    ModalActionCreators: sharedValue(4925),
    withTiming: height(4723).withTiming,
  ...
  obj4.children = jsx(height(6848).GestureDetector, {
    gesture: failOffsetXResult,
    children: jsx(sharedValue(4458).View, { style: animatedStyle, children: children.children }),
  });
