...
export default function GestureContainer(children) {
  ...
  fn.__closure = {
    ...
    runOnJS: height(4493).runOnJS,
    ModalActionCreators: sharedValue(4960),
    withTiming: height(4758).withTiming,
  ...
  obj4.children = jsx(height(6899).GestureDetector, {
    gesture: failOffsetXResult,
    children: jsx(sharedValue(4493).View, { style: animatedStyle, children: children.children }),
  });
