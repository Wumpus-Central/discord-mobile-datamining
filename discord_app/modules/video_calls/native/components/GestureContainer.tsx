...
export default function GestureContainer(children) {
  ...
  obj = { position: sharedValue, THRESHOLD_VELOCITY: 500, runOnJS: height(4310).runOnJS, ModalActionCreators: sharedValue(4777), withTiming: height(4575).withTiming, DECELERATED_EASING: height(1178).DECELERATED_EASING };
  fn.__closure = obj;
  ...
  obj1.children = jsx(height(6669).GestureDetector, { gesture: failOffsetXResult, children: jsx(sharedValue(4310).View, { style: animatedStyle, children: children.children }) });
