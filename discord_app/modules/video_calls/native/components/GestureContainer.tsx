...
export default function GestureContainer(children) {
  ...
  fn.__closure = {
    ...
    runOnJS: height(4561).runOnJS,
    ModalActionCreators: sharedValue(5032),
    withTiming: height(4830).withTiming,
  ...
  obj4.children = jsx(height(6985).GestureDetector, {
    gesture: failOffsetXResult,
    children: jsx(sharedValue(4561).View, { style: animatedStyle, children: children.children }),
  });
