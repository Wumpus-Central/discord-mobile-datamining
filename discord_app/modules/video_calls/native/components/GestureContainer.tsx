...
export default function GestureContainer(children) {
  ...
  obj4.children = jsx(height(6068).GestureDetector, {
    gesture: failOffsetXResult,
    children: jsx(sharedValue(4563).View, { style: animatedStyle, children: children.children }),
  });
