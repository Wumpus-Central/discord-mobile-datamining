...
export default function GestureContainer(children) {
  ...
  fn.__closure = {
    ...
    runOnJS: height(4492).runOnJS,
    ModalActionCreators: sharedValue(4959),
    withTiming: height(4757).withTiming,
  ...
  obj4.children = jsx(height(6892).GestureDetector, {
    gesture: failOffsetXResult,
    children: jsx(sharedValue(4492).View, { style: animatedStyle, children: children.children }),
  });
