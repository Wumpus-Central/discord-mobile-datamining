// === Module 10294: ChannelCallActionBar ===
...
import VoiceChatHooks from "VoiceChatHooks" /* 9727 */;
import CallBarActionAll from "CallBarAction" /* 9749 */;
import useIsFiveButtonLayout from "useIsFiveButtonLayout" /* 9752 */;
...
import useScreenshareUtilsDefault from "useScreenshareUtils" /* 10300 */;
...
import DisconnectRemoteButton from "DisconnectRemoteButton" /* 10359 */;
...
let obj2 = { container: { height: fn(9748).CALL_ACTION_BAR_HEIGHT, justifyContent: "center", alignItems: "center", flexDirection: "row" }, containerForFiveButtonLayout: null };
let obj3 = { height: fn(9748).CALL_ACTION_BAR_HEIGHT, justifyContent: "center", alignItems: "center", flexDirection: "row" };
obj2.containerForFiveButtonLayout = { height: fn(9748).FIVE_BUTTON_LAYOUT_ACTION_BAR_HEIGHT, paddingHorizontal: 16, paddingTop: fn(9748).FIVE_BUTTON_CONTAINER_PADDING_TOP, paddingBottom: fn(9748).FIVE_BUTTON_CONTAINER_PADDING_BOTTOM, justifyContent: "center", flexDirection: "row" };
