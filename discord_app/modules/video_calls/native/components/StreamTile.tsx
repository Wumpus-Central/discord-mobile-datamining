...
import _modDef9772 from "../../../../../_runtime/metro/09772__.js";
  ...
  if (null != stateFromStores) {
    ...
    if (ApplicationStreamStates.FAILED === state) {
      const obj2 = {
        ...
        type: tmp(9751).VideoEmptyTypes.STREAM_FAILED,
      ...
      const obj3 = {
        ...
        removeCloseButton: removeEmptyStateButton,
        removeSplashImage: removeEmptyStateImage,
        type: tmp(9751).VideoEmptyTypes.STREAM_ENDED,
        style: StyleSheet.absoluteFill,
      };
...
export default function StreamTile(participant) {
  ...
  if (tmp7Result) {
    ...
    tmp7Result = closure_1_10(closure_16, obj3);
  }
  items3[1] = tmp7Result;
