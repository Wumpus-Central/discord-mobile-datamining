// === Module 9497: CallBarAction ===

// Module 9497 (CallBarAction)
import nativeDefault from "native" /* 576 */;
import Text_Text from "Text/Text" /* 4556 */;
import Pressables from "Pressables" /* 5123 */;
import CircleWithCutoutUtilsDefault from "CircleWithCutoutUtils" /* 9499 */;
...
class ActionButton {
  constructor(arg0) {
    ...
    obj1 = { circleRadius: tmp6.buttonRadius, cutoutRadius: sum, enableCutout: showBadge, cutoutPositionInDegrees: 45, circleFillColor: null };
...
fn(4560);
ColorUtils = { buttonContainer: { position: "absolute" }, iconContainer: { position: "absolute", justifyContent: "center", alignItems: "center" }, badge: { backgroundColor: "white", position: "absolute" }, notificationArea: null, notificationText: null, notificationAreaMentioned: null, notificationAreaUnread: null };
...
export const NotifiedActionButton = function NotifiedActionButton(isMentioned) {
  ...
  if (true !== isMentioned) {
    ...
    obj.style = items;
    const obj1 = { style: tmp2.notificationText, variant: "text-xs/semibold", color: "text-overlay-light", children: isMentioned.notifications };
