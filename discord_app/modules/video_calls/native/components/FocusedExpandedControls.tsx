// === Module 10271: FocusedExpandedControls ===
...
import useDeafStatesDefault from "useDeafStates" /* 10275 */;
...
function ExpandedControlItemIcon(iconSource) {
  ...
  if (null == iconSource) {
    ...
    if (iconSource.showIconSparkle) {
      ...
      const items = [tmp10, , ];
      const obj3 = { style: tmp.sparkle2, source: _modDef10272 };
      items[1] = React6(React4, obj3);
      const obj4 = { style: tmp.sparkle, source: _modDef10273 };
...
export const DeafenButton = function DeafenButton(disabled) {
  ...
  const obj2 = { disabled: flag, onPress: deafHandler.onPress, iconSource: importDefault(deafHandler.deaf ? 10276 : 10277), label: null };
  const intl = util.intl;
