...
import { registerAsset } from "../../../../../_runtime/10819_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/10820_registerAsset.js";
...
function ExpandedControlItem(iconSource) {
  ...
  obj[2] = callback(Form.FormLabel, obj);
  obj[3] = onPress;
  obj[4] = trailing;
...
export const StreamVolumeItem = function StreamVolumeItem() {
  ...
  if (null != stateFromStores) {
    ...
    obj1[0] = tmp11;
    tmp9Result = tmp9(tmp2(7890).FormRow, obj1);
  }
  return tmp9Result;
};
...
export const DeafenButton = function DeafenButton(disabled) {
  ...
  obj = { disabled: flag, onPress: deafHandler.onPress, iconSource: importDefault(deafHandler.deaf ? 10823 : 10824), label: null };
