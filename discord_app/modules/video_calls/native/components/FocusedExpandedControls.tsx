...
import { registerAsset } from "../../../../../_runtime/10831_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/10832_registerAsset.js";
...
export const StreamVolumeItem = function StreamVolumeItem() {
  ...
  if (null != stateFromStores) {
    ...
    obj1[0] = tmp11;
    tmp9Result = tmp9(tmp2(7907).FormRow, obj1);
  }
  return tmp9Result;
};
...
export const DeafenButton = function DeafenButton(disabled) {
  ...
  obj = { disabled: flag, onPress: deafHandler.onPress, iconSource: importDefault(deafHandler.deaf ? 10835 : 10836), label: null };
