...
import _modDef10271 from "../../../../../_runtime/metro/10271__.js";
...
export const DeafenButton = function DeafenButton(disabled) {
  ...
  const obj2 = { disabled: flag, onPress: deafHandler.onPress, iconSource: importDefault(deafHandler.deaf ? 10275 : 10276), label: null };
  const intl = util.intl;
