...
export const ChannelCallMicButton = function ChannelCallMicButton(disableTint) {
  ...
  const muteHandler = mute(10870).createMuteHandler(tmp3, stateFromStores);
  ...
  obj[3] = importDefault(mute ? 10874 : 10875);
  if (!flag) {
    flag = mute;
  }
  obj[4] = flag;
  ...
  obj[7] = RED_400;
  return jsx(importAll(10668).ToggledActionButton, { appearsDisabled: stateFromStores, accessibilityLabel: null, onPress: null, source: null, isActive: null, isSmallSize: null, lottieComponent: null, tintColor: null });
};