...
import { registerAsset } from "../../../../../_runtime/10465_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/10865_registerAsset.js";
...
class TileOverlay {
  constructor(arg0) {
    ...
    obj2[2] = items1;
    return tmp7(require("module_4145").View, obj2);
  }
}
