...
import PictureInPicture from "PictureInPicture" /* 9740 */;
...
function CameraPreview(arg0) {
  ...
  obj16.trigger = closure_21(stateFromStores(9760), { channel, selfParticipant, pipParticipant: nonSelfPipParticipant });
  obj16.rows = items6;
