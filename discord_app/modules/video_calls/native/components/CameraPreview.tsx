...
function CameraPreview(arg0) {
  ...
  ee.__closure = {
    withTiming: participantScreenIsFocused(4641).withTiming,
  ...
  if (constants3.HIDE_PIP === tmp27) {
    ...
    obj9.onClick = participantScreenIsFocused(9739).openIgnoreThermalStateAlert;
    const items5 = [obj9];
    items6 = items5;
  } else {
    items6 = [];
  ...
  if (null != tmp27) {
    ...
    tmp32 = closure_21(participantScreenIsFocused(6766).GestureDetector, obj10);
  }
  const items7 = [tmp32];
  ...
  obj16.trigger = closure_21(stateFromStores(9742), {
    channel,
    selfParticipant,
