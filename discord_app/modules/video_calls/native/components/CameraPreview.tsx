...
import PictureInPicture from "PictureInPicture" /* 9493 */;
...
function CameraPreview(arg0) {
  ...
  __closure = { withTiming: participantScreenIsFocused(4561).withTiming, marginTopState: marginTop, TIMING_CONFIG: __closure, marginBottomState: first1 };
