...
export default noop.memo((channel) => {
  ...
  if (!flag) {
    ...
    obj6.barStyle = str2;
    tmp16Result = closure_6(tmp4(9733), obj6);
    const tmp19 = !tmp2;
  ...
  items3[3] = closure_6(guild_id(11689), { guildId: guild_id, channelId: id, chatInputRef: noop.useRef(null), screenIndex: "voice-panel" });
