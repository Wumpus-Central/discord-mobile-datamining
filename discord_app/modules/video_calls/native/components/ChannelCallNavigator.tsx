...
function MainCallScreen(channel) {
  ...
  return tmp11(tmp22, {
    forceHide: isConnectedToVoiceChannel(1150).isAndroid() || !isConnectedToVoiceChannel,
    showWhenParticipantOnScreen: !isConnectedToVoiceChannel,
    children: tmp11(isConnectedToVoiceChannel(4347).ThemeContextProvider, { gradient: tmp21, children: tmp14Result }),
  });
}
