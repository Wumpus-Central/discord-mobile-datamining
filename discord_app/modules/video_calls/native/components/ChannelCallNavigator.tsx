...
function MainCallScreen(channel) {
        ...
        try {
          ...
          if (0 === paths) {
            if (arg0 === 1) {
              ...
              c3 = 1;
              const obj7 = {
                value: obj6.pushLazy(closure_0(paths[19])(paths[18], paths.paths), obj4, closure_1_11),
                done: false,
              };
              return obj7;
            }
  ...
  return tmp11(tmp22, {
    forceHide: isConnectedToVoiceChannel(1363).isAndroid() || !isConnectedToVoiceChannel,
    showWhenParticipantOnScreen: !isConnectedToVoiceChannel,
    children: tmp11(isConnectedToVoiceChannel(4347).ThemeContextProvider, { gradient: tmp21, children: tmp14Result2 }),
  });
}
