...
function CallWithVoiceChat(channel) {
  ...
  if (tmp11[0]) {
    const obj9 = { channel };
    tmp18Result = closure_12(tmp2(10423), obj9);
  }
...
function MainCallScreen(channel) {
  ...
  if (isChannelContentGated) {
    ...
    if (channel.isGuildStageVoice()) {
      let obj7 = { channel };
      tmp14Result = closure_12(id(9831), obj7);
    }
  ...
  return tmp11(tmp22, {
    ...
    children: tmp11(isConnectedToVoiceChannel(4535).ThemeContextProvider, { gradient: tmp21, children: tmp14Result2 }),
  });
}
