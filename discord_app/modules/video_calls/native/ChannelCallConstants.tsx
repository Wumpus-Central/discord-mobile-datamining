...
({
  ...
  BOTTOM_LEFT: arr[2],
  BOTTOM_RIGHT: arr[3],
} = Constants.PictureInPicturePositions);
...
export const VoiceCallOverlayType = {
  VOICE_CONTROLS_TOGGLE_BUTTON: 0,
  [0]: "VOICE_CONTROLS_TOGGLE_BUTTON",
  CAMERA_PREVIEW_PICTURE_IN_PICTURE: 1,
  [1]: "CAMERA_PREVIEW_PICTURE_IN_PICTURE",
};
export const VoiceChatDrawerState = {
  OPENING: 0,
  [0]: "OPENING",
  OPEN: 1,
  [1]: "OPEN",
