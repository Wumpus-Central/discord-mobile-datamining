...
export default function BuildOverrideModal(overrideUrl) {
  ...
  if (obj.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(13148);
  } else {
    tmp2Result = tmp2(13149);
  }
  tmp4 = stateFromStores(4238)();
  ...
  if (override != null) {
    ...
    if (targetBuildOverride != null) {
      const tmp9 = targetBuildOverride[tmp5(undefined, 11119).DEVICE_FIELD];
      if (tmp9 != null) {
        id = tmp9.id;
      }
    }
  ...
  items2[1] = callback(str(4298).Text, obj2);
  if (null != id) {
    obj3 = { children: null };
    ...
    obj4[3] = id;
    const items3 = [tmp14(tmp5(4298).Text, obj4), ];
    ...
    items3[1] = tmp14(tmp5(4298).Text, obj5);
    obj3[0] = items3;
    ...
    tmp14Result = tmp14(tmp5(4298).Text, obj7);
  }
  ...
  if (null != id) {
    ...
    obj10[1] = tmp14(tmp5(4712).Button, obj11);
    ...
    obj12[3] = function onPress() {
      return stateFromStores(4507).pop();
    };
    items5[1] = tmp14(tmp5(4712).Button, obj12);
    obj9[0] = items5;
    ...
    tmp12Result = tmp14(tmp5(4712).Button, obj13);
  }
  obj8[1] = tmp12Result;
  items4[1] = callback(closure_4, obj8);
  obj[3] = items4;
  return closure_8(str(5327).SafeAreaPaddingView, obj);
};