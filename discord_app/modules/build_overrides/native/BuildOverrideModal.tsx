// === Module 14145: BuildOverrideModal ===
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  let stateFromStores;
  const tmp = closure_9();
  const tmp4 = stateFromStores(4691)();
  if (obj.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(14146);
  } else {
    tmp2Result = tmp2(14147);
  }
  obj = str(4608);
  ...
  if (override != null) {
    ...
    if (targetBuildOverride != null) {
      const tmp9 = targetBuildOverride[tmp5(undefined, 12047).DEVICE_FIELD];
      if (tmp9 != null) {
        id = tmp9.id;
      }
    }
  ...
  if (null != id) {
    ...
    items3[1] = closure_6(tmp5(4753).Text, obj8);
    ...
    tmp14Result = closure_6(tmp5(4753).Text, obj10);
  }
  ...
  if (null != id) {
    ...
    obj13.children = closure_6(tmp5(5187).Button, obj14);
    ...
    items5[1] = closure_6(tmp5(5187).Button, obj15);
    ...
    tmp12Result2 = closure_6(tmp5(5187).Button, obj16);
  }
  obj11.children = tmp12Result2;
  items4[1] = closure_6(closure_4, obj11);
  rect.children = items4;
  return closure_8(str(7370).SafeAreaPaddingView, rect);
};