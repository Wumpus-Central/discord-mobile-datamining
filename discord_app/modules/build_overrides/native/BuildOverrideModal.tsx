// === Module 13576: BuildOverrideModal ===

// Module 13576 (BuildOverrideModal)
import noopAll from "noop" /* 19 */;
import ThemesDefault from "Themes" /* 712 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import closure_5 from "getCurrentBuildOverride" /* 11022 */;
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  if (obj.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(13577);
  } else {
    tmp2Result = tmp2(13578);
  }
  tmp4 = stateFromStores(4383)();
  ...
  if (override != null) {
    ...
    if (targetBuildOverride != null) {
      const tmp9 = targetBuildOverride[tmp5(undefined, 11322).DEVICE_FIELD];
      if (tmp9 != null) {
        id = tmp9.id;
      }
    }
  }
  tmp2Result = tmp2(4045);
  let obj3 = tmp2(4045)();
  let expiresAt;
  if (override != null) {
  ...
  items2[1] = callback(str(4444).Text, obj2);
  if (null != id) {
    obj3 = { children: null };
    ...
    obj4[3] = id;
    const items3 = [tmp14(tmp5(4444).Text, obj4), ];
    ...
    items3[1] = tmp14(tmp5(4444).Text, obj5);
    obj3[0] = items3;
    ...
    tmp14Result = tmp14(tmp5(4444).Text, obj7);
  }
  ...
  if (null != id) {
    ...
    obj10[1] = tmp14(tmp5(4896).Button, obj11);
    ...
    items5[1] = tmp14(tmp5(4896).Button, obj12);
    obj9[0] = items5;
    ...
    tmp12Result = tmp14(tmp5(4896).Button, obj13);
  }
  obj8[1] = tmp12Result;
  items4[1] = callback(closure_4, obj8);
  obj[3] = items4;
  return closure_8(str(5521).SafeAreaPaddingView, obj);
};