// === Module 13091: BuildOverrideModal ===
...
export default function BuildOverrideModal(overrideUrl) {
  ...
  if (obj.isThemeDark(tmp4)) {
    let tmp2Result = tmp2(13092);
  } else {
    tmp2Result = tmp2(13093);
  }
  ...
  if (override != null) {
    ...
    if (targetBuildOverride != null) {
      const tmp9 = targetBuildOverride[tmp5(undefined, 11115).DEVICE_FIELD];
      if (tmp9 != null) {
        id = tmp9.id;
      }
    }
  ...
  if (null != id) {
    ...
    obj10[1] = tmp14(tmp5(4666).Button, obj11);
    ...
    obj12[3] = function onPress() {
      return stateFromStores(4461).pop();
    };
    items5[1] = tmp14(tmp5(4666).Button, obj12);
    obj9[0] = items5;
    ...
    tmp12Result = tmp14(tmp5(4666).Button, obj13);
  }
  obj8[1] = tmp12Result;
  items4[1] = callback(closure_4, obj8);
  obj[3] = items4;
  return closure_8(str(5243).SafeAreaPaddingView, obj);
};