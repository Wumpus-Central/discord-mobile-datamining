...
let size = {
  ...
  width: "100%",
  height: fn(8370).ACTION_SHEET_DRAG_HANDLE_HEIGHT,
  marginBottom: -fn(8370).ACTION_SHEET_DRAG_HANDLE_HEIGHT,
};
...
export default noop.forwardRef(function PortalKeyboardBottomSheet(animatedIndex, arg1) {
  ...
  closure_9 = tmp7;
  const bottomSheetImperativeHandle = animatedIndex(flag[13]).useBottomSheetImperativeHandle(arg1, ref);
  let items = [ref, tmp7];
  ...
  Y.__closure = {
    forceMaxHeight,
    runOnJS: animatedIndex(flag[10]).runOnJS,
    dismissGlobalKeyboard: animatedIndex(flag[19]).dismissGlobalKeyboard,
  };
  ...
  W.__closure = {
    interpolate: animatedIndex(flag[10]).interpolate,
    animatedIndex,
