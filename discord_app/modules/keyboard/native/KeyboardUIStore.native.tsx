...
import setIsAnyChatInputFocused from "ChatInputFocused.tsx";
...
KeyboardEvents.addListener(str, (height) => {
  ...
  require("../../../../discord_common/js/shared/utils/ReactBatchUpdates.native.tsx").batchUpdates(() => obj.setState((arg0) => {
    let tmp = closure_1;
    if (null != closure_1) {
      const items = [tmp];
