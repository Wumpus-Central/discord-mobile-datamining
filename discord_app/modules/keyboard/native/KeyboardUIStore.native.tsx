...
import _modDef1612 from "../../safe_area/SafeAreaStore.native.tsx";
...
import _modDef1873 from "../KeyboardStateDebugging.tsx";
...
function createInitialEntryState(main) {
  ...
  obj = {
    [tmp(1609).KeyboardTypes.SYSTEM]: { keyboardWillOpen: false },
    [tmp(1609).KeyboardTypes.EXPRESSION]: ExpressionPickerViewType.EMOJI,
    [tmp(1609).KeyboardTypes.MEDIA]: obj,
    [tmp(1609).KeyboardTypes.APP_LAUNCHER]: obj1,
  };
