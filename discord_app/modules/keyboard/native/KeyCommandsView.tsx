...
import KeyCommandsNativeComponentDefault from "../../../../discord_common/js/packages/rtn-codegen/js/KeyCommandsNativeComponent.tsx";
...
export default function KeyCommandsView(style) {
  ...
  let obj = {
    value: noop.useMemo(() => ({ keyCommands, addKeyCommand, removeKeyCommand: callback1 }), items),
    children: null,
  };
  obj = {};
