...
const require = fn;
const createCacheKey = { position: "absolute", bottom: 0, left: 0, right: 0, zIndex: 1, flex: 1, backgroundColor: ThemesDefault.colors.MOBILE_KEYBOARD_PANEL_BACKGROUND };
...
const result = require("obj132").fileFinishedImporting("modules/keyboard/native/PortalKeyboardFooterIOS.ios.tsx");
...
export default function PortalKeyboardFooterIOS(animatedSheetIndex) {
  ...
  const keyboardTypeSharedValue = animatedSheetIndex(4239).useKeyboardTypeSharedValue();
  ...
  obj = { style: memo, children: height(animatedSheetIndex(4244).PortalHost, { name: str }) };
