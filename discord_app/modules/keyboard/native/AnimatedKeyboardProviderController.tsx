...
const mutable1 = module_4042.makeMutable(require("module_4042").KeyboardState.UNKNOWN);
...
let closure_9 = require("noop").memo(() => {
  ...
  const fn = function o(height) {
    if (0 === height.height) {
      let OPEN = callback(4042).KeyboardState.CLOSED;
    } else {
      OPEN = callback(4042).KeyboardState.OPEN;
    }
...
let result = require("module_4042").fileFinishedImporting("modules/keyboard/native/AnimatedKeyboardProviderController.tsx");
