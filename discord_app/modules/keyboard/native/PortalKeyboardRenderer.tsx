...
export const PortalKeyboardRenderer = function PortalKeyboardRenderer(portal) {
  ...
  const tmp11 = jsx(id(4533).TransitionGroup, {
    items: memo,
  ...
  if (flag) {
    ...
    let tmp10Result = jsx(tmp5(4699).PortalKeyboard, { children: tmp11 });
  } else {
    const obj4 = { value: true, children: tmp11 };
    tmp10Result = jsx(tmp5(10663).PortalKeyboardInModalContext.Provider, { value: true, children: tmp11 });
  }
  return tmp10Result;
};
