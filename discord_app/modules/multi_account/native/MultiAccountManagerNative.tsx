...
import ME from "ME";
import "_initialize";
import { registerAsset } from "../../../../_runtime/16420_registerAsset.js";
...
prototype["onSwitchSuccess"] = function onSwitchSuccess(currentUser, navigateHome) {
  ...
  if (navigateHome) {
    ...
    const MobileHomeDrawerExperiment = obj(4158).MobileHomeDrawerExperiment;
    if (MobileHomeDrawerExperiment.getConfig({ location: "multi-account" }).enableHome) {
      tmp(4152).setHomeDrawerState(false);
