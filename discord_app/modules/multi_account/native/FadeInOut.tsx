...
const forwardRefResult = importAllResult.forwardRef((duration, ref) => {
  ...
  const imperativeHandle = importAllResult.useImperativeHandle(ref, () => ({
    ...
    componentWillLeave(current) {
      ...
      let obj = { runOnJS: duration(ref[2]).runOnJS, handleTransitionFinished: closure_3 };
      fn.__closure = obj;
...
let result = require("obj132").fileFinishedImporting("modules/multi_account/native/FadeInOut.tsx");
