...
const multiAccountSwitchStore = new MultiAccountSwitchStore(DispatcherDefault, {
  ...
  LOGOUT: function handleLogout(isSwitchingAccount) {
    ...
    if (isSwitchingAccount.isSwitchingAccount) {
      ...
      const obj2 = {
        current_user_id,
        expected_user_id: _null,
        fast_connect_user_id: fast_connect.getLastFastConnectIdentifyUserId(),
        switch_origin,
      };
    ...
    if (c11) {
      ...
      if (flag) {
        ...
        if (null != token && null != token1 && token !== token1) {
          ...
          let obj4 = {
            ...
            to_user_id: _null,
            actual_user_id: id,
            fast_connect_user_id: id2(15).getLastFastConnectIdentifyUserId(),
            linked_user_ids: null,
            has_ever_connected: null,
            switch_origin: null,
          };
      ...
      if (tmp45) {
        ...
        if (flag4) {
          ...
          if (0 !== found.length) {
            let tmp46 = TokenManagerAll.getToken(id2) === token2;
            const obj13 = {};
            const obj14 = {
              from_user_id,
              to_user_id: _null,
            ...
            const tmp41Result = TokenManagerAll;
        ...
        const tmp41Result2 = TokenManagerAll;
      }
      const id3 = user.id;
