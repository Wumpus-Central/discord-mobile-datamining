// discord_app/modules/roles/native/RoleName.tsx
...
export default function RoleName(dotBackground) {
  ...
  const isRoleStyleAndRoleColorsEligibleForERC =
    enhanced_role_colors_EnhancedRoleColorUtils.useIsRoleStyleAndRoleColorsEligibleForERC(
      guildId,
      undefined,
      stateFromStores,
