  ...
  if (navigation(16330).RemoteAuthStep.INITIALIZING !== step) {
    if (tmp2(16330).RemoteAuthStep.PENDING_REMOTE_INIT !== step) {
      if (tmp2(16330).RemoteAuthStep.PENDING_TICKET === step) {
        ...
        items2[1] = closure_7(tmp2(4753).Text, obj8);
        ...
        items2[2] = closure_7(tmp2(4753).Text, obj9);
        ...
        obj11.children = closure_7(tmp2(5187).Button, obj12);
        ...
        tmp11Result = closure_7(tmp2(5796).ActivityIndicator, {});
      }
    }
