  ...
  if (navigation(16098).RemoteAuthStep.INITIALIZING !== step) {
    if (tmp2(16098).RemoteAuthStep.PENDING_REMOTE_INIT !== step) {
      if (tmp2(16098).RemoteAuthStep.PENDING_TICKET === step) {
        ...
        items2[1] = closure_7(tmp2(4635).Text, obj8);
        ...
        items2[2] = closure_7(tmp2(4635).Text, obj9);
        ...
        obj11.children = closure_7(tmp2(5059).Button, obj12);
        ...
        tmp11Result = closure_7(tmp2(5662).ActivityIndicator, {});
      }
    }
