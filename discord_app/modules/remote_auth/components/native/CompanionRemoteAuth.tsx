  ...
  if (navigation(15587).RemoteAuthStep.INITIALIZING !== step) {
    if (tmp2(15587).RemoteAuthStep.PENDING_REMOTE_INIT !== step) {
      if (tmp2(15587).RemoteAuthStep.PENDING_TICKET === step) {
        ...
        items2[1] = closure_7(tmp2(4825).Text, obj8);
        ...
        items2[2] = closure_7(tmp2(4825).Text, obj9);
        ...
        obj11.children = closure_7(tmp2(5274).Button, obj12);
        ...
        tmp11Result = closure_7(tmp2(5884).ActivityIndicator, {});
      }
    }
