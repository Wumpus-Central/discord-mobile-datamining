                  ...
                  .catch((error) => {
                    ...
                    if (code === constants.TOO_MANY_SAVED_MESSAGES) {
                      ...
                      if (obj.isForLaterLimitUpgradable("addOrUpdateSavedMessage")) {
                        const items = [closure_1(6603).FOR_LATER_ROADBLOCK];
                        closure_1(11206)(tmp5, items);
                        const tmp8Result = closure_1(11206);
                      } else {
                        const obj2 = {
                          title: null,
                          body: null,
                        ...
                        const t = tmp6(1115).t;
                        const obj3 = { max: null };
                        const tmp8Result2 = closure_1(5203);
                        ...
                        obj2.onCancel = function onCancel() {
                          ...
                          return displayToast(7284).showForLaterModal(
                      ...
                      const obj4 = {
                        ...
                        IconComponent: closure_0(6028).CircleErrorIcon,
                        content: null,
                      };
                      let message;
                      if (error != null) {
  ...
  await closure_130_0(closure_130_2[7])
    ...
    .catch((error) => {
      const obj2 = {
        ...
        IconComponent: closure_1_0(6028).CircleErrorIcon,
        content: null,
      };
      let message;
      if (error != null) {
