            ...
            if (arg0 === 1) {
              ...
              obj3.value = obj3.upsertSavedMessage(closure_129_1).catch((error) => {
                ...
                if (code === constants.TOO_MANY_SAVED_MESSAGES) {
                  ...
                  const obj1 = { key: "SAVED_MESSAGE_CREATE_ERROR", IconComponent: closure_0(6660).CircleErrorIcon, content: null };
                  let message;
                  if (error != null) {
...
let closure_7 = async function _removeSavedMessage() {
  await closure_130_0(closure_130_2[7]).deleteSavedMessage(closure_129_2).catch((error) => {
    closure_1_1(4303);
    const obj = { key: "SAVED_MESSAGE_REMOVE_ERROR", IconComponent: closure_1_0(6660).CircleErrorIcon, content: null };
    let message;
    if (error != null) {
      const body = error.body;
      if (body != null) {
