...
const memoResult = importAllResult.memo((onClose) => {
  ...
  function handleOpenDatePicker(closure_5, arg1) {
    ...
    const obj4 = createReminder(3975)();
  }
  const tmp = callback();
  ...
  let obj = { title: null, headerTitle: null, headerTitleAlign: "center", headerStatusBarHeight: null, headerLeft: null, headerLeftContainerStyle: null, headerRightContainerStyle: null, headerRight: null };
  ...
  obj[7] = function headerRight() {
    const obj = { variant: "text-md/semibold", color: "control-brand-foreground", children: null };
    const intl = onClose(1236).intl;
  ...
  const items1 = [callback(onClose(6319).Header, obj), ];
  ...
  const items2 = [callback(onClose(4734).Text, obj3), ];
  let obj4 = { accessibilityRole: "button", accessibilityLabel: null, accessibilityValue: null, onPress: null, style: null, children: null };
  ...
  obj4[5] = callback(onClose(4734).Text, { variant: "text-md/medium", children: formatResult });
  items2[1] = callback(onClose(5433).PressableOpacity, obj4);
  obj2[0] = items2;
  ...
  const items4 = [callback(onClose(4734).Text, obj6), ];
  ...
  obj7[5] = callback(onClose(4734).Text, { variant: "text-md/medium", children: formatResult1 });
  items4[1] = callback(onClose(5433).PressableOpacity, obj7);
  obj5[0] = items4;
...
let result = require("obj132").fileFinishedImporting("modules/saved_messages/message_reminders/native/MessageRemindersCustomDurationModal.tsx");
