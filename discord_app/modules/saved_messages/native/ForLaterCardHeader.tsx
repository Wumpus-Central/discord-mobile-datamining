...
function HeaderIcon(channel) {
  ...
  if (null != stateFromStores) {
    obj = { guild: stateFromStores, size: tmp2(5598).GuildIconSizes.XSMALL };
    ...
    if (isGroupDMResult) {
      ...
      const obj1 = { style: tmp.dmIcon, children: closure_5(tmp2(5085).ChatIcon, { size: "xxs" }) };
