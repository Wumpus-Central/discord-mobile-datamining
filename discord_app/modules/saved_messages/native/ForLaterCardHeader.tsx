...
function HeaderIcon(channel) {
  ...
  if (null != stateFromStores) {
    obj = { guild: stateFromStores, size: tmp2(5635).GuildIconSizes.XSMALL };
    ...
    if (isGroupDMResult) {
      ...
      const obj1 = { style: tmp.dmIcon, children: closure_5(tmp2(5122).ChatIcon, { size: "xxs" }) };
