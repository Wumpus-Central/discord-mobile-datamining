...
export const ForLaterCardReminderHeader = function ForLaterCardReminderHeader(savedMessage) {
  ...
  const tmp = callback3();
  let obj = require(9955) /* _savedMessageJumpToMessage */;
  let dueAt;
  if (savedMessage != null) {
    dueAt = savedMessage.saveData.dueAt;
  }
  obj = { dueAt, now: throttledNow, type: tmp2(9955).DueInStringTypes.SHORT };
  ...
  if (null == savedMessage.saveData.dueAt) {
    ...
    obj1[1] = callback(tmp2(4157).ClockIcon, obj2);
