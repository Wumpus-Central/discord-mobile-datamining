...
import _modDef4714 from "../../../../_runtime/metro/04714__.js";
...
let obj = {
  ...
  deletedCard: { flexDirection: "row", alignItems: "center", gap: 8 },
  deletedText: { flex: 1 },
  deletedActionButton: { marginLeft: "auto" },
};
...
export default noop.memo(function ForLaterMessageCard(savedMessage) {
  ...
  const savedMessageChannel = savedMessage(11964).useSavedMessageChannel(savedMessage);
                  ...
                  try {
                    ...
                    if (0 === c1) {
                      if (arg0 === 1) {
                        ...
                        c1 = 1;
                        c2 = 1;
                        const obj5 = { value: v3(11964).savedMessageJumpToMessage(tmp4, c1), done: false };
                        return obj5;
                      }
                    } else if (arg0 === 1) {
                      c2 = 3;
                      ...
                      if (null != tmp4.saveData.dueAt) {
                        let BOOKMARK = v3(8104).SavedMessageSortTypes.REMINDER;
                      } else {
                        BOOKMARK = v3(8104).SavedMessageSortTypes.BOOKMARK;
                      }
                      obj8.type = BOOKMARK;
                      let diffResult;
                      if (null != tmp4.saveData.dueAt) {
  ...
  if (null != savedMessage.message) {
    if (null != savedMessageChannel) {
      if (
        ...
        const tmp8 = closure_10(savedMessageChannel(13595), obj3);
        let obj4 = {
          variant: "primary",
          border: "subtle",
          shadow: "none",
        ...
        if (null != savedMessage.saveData.dueAt) {
          ...
          tmp6Result = closure_10(tmp2(13598).ForLaterCardReminderHeader, obj5);
        }
        ...
        obj6.actions = tmp12;
        items2[1] = closure_10(tmp2(12468).ForLaterCardHeader, obj6);
        ...
        items2[3] = closure_10(tmp2(12469).ForLaterMessageRow, obj8);
