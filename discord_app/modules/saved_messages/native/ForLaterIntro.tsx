...
function IntroDemo(isReminder) {
  ...
  obj[0] = { uri: require("../../../../discord_assets/assets/premium/wumpus-avatar.png.js") };
  obj[1] = tmp.avatar;
  ...
  obj3[2] = intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.cqpybK);
  const items1 = [callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj3), , , ];
  const obj4 = { variant: "text-sm/normal", color: "text-default", children: null };
  const intl2 = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj4[2] = intl2.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["h+KPxy"]);
  ...
  obj5[2] = intl3.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["63EVpI"]);
  ...
  obj6[2] = intl4.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["KT/TDX"]);
  items1[3] = callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj6);
  obj2[1] = items1;
  ...
  const obj9 = { icon: require("../../../design/components/Icon/native/redesign/generated/BookmarkIcon.tsx") /* BookmarkIcon */.BookmarkIcon, label: null, highlighted: null };
  const intl5 = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj9[1] = intl5.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.tpxJto);
  obj9[2] = !isReminder;
  items3[1] = callback(SheetRow, obj9);
  const obj10 = { icon: require("../../../design/components/Icon/native/redesign/generated/ClockIcon.tsx") /* ClockIcon */.ClockIcon, label: null, highlighted: null, hasArrow: true };
  const intl6 = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj10[1] = intl6.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.mJ3P0N);
  obj10[2] = isReminder;
...
function SheetRow(hasArrow) {
  ...
  obj = { size: "sm", color: require("../../../../discord_common/js/packages/tokens/native.tsx").colors.INTERACTIVE_TEXT_DEFAULT };
  ...
  if (flag) {
    ...
    obj1[1] = require("../../../../discord_common/js/packages/tokens/native.tsx").colors.INTERACTIVE_TEXT_DEFAULT;
    tmp5Result = callback(require("../../../design/components/Icon/native/redesign/generated/ChevronSmallRightIcon.tsx") /* ChevronSmallRightIcon */.ChevronSmallRightIcon, obj1);
  }
  items1[2] = tmp5Result;
  obj[1] = items1;
...
obj[6] = { alignSelf: "stretch", backgroundColor: require("Themes").colors.BACKGROUND_SURFACE_HIGH, borderColor: require("Themes").colors.BORDER_SUBTLE, borderRadius: require("Themes").radii.md, borderWidth: 1, marginTop: require("Themes").space.PX_24, overflow: "hidden" };
let obj3 = { alignSelf: "stretch", backgroundColor: require("Themes").colors.BACKGROUND_SURFACE_HIGH, borderColor: require("Themes").colors.BORDER_SUBTLE, borderRadius: require("Themes").radii.md, borderWidth: 1, marginTop: require("Themes").space.PX_24, overflow: "hidden" };
...
obj[10] = { backgroundColor: require("Themes").colors.MOBILE_ACTIONSHEET_BACKGROUND, borderTopLeftRadius: ACTION_SHEET_BORDER_RADIUS, borderTopRightRadius: ACTION_SHEET_BORDER_RADIUS, marginTop: require("Themes").space.PX_8, paddingBottom: require("Themes").space.PX_8, paddingHorizontal: require("Themes").space.PX_8 };
let obj7 = { backgroundColor: require("Themes").colors.MOBILE_ACTIONSHEET_BACKGROUND, borderTopLeftRadius: ACTION_SHEET_BORDER_RADIUS, borderTopRightRadius: ACTION_SHEET_BORDER_RADIUS, marginTop: require("Themes").space.PX_8, paddingBottom: require("Themes").space.PX_8, paddingHorizontal: require("Themes").space.PX_8 };
...
export default function ForLaterIntro(type) {
  const tmp = callback3();
  const tmp4 = type.type === require("../SavedMessagesTypes.tsx") /* SavedMessageSortTypes */.SavedMessageSortTypes.REMINDER;
  let obj = { style: tmp.scrollView, contentContainerStyle: tmp.pageContainer, children: null };
  obj = { style: tmp.container, children: null };
  obj = { source: require("../../../../_runtime/12476_registerAsset.js"), style: tmp.upsellImage };
  const items = [callback(closure_3, obj), , ];
  ...
  const items1 = [callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Heading, obj2), ];
