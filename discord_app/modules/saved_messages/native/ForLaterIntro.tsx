...
import _modDef12872 from "../../../../discord_assets/assets/premium/wumpus-avatar.png.js";
...
function IntroDemo(isReminder) {
  ...
  const obj3 = { source: { uri: _modDef12872 }, style: tmp.avatar };
...
export default function ForLaterIntro(type) {
  ...
  const items = [timestampProducer(React3, { source: importDefault(tmp4 ? 12870 : 12871), style: tmp.upsellImage }), ,];
  ...
  const intl3 = util.intl;
  const t3 = util.t;
  const obj3 = { source: importDefault(tmp4 ? 12870 : 12871), style: tmp.upsellImage };
