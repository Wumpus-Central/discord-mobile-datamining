...
function IntroDemo(isReminder) {
  ...
  const obj9 = { icon: BookmarkIcon /* BookmarkIcon */.BookmarkIcon, label: null, highlighted: null };
  const intl5 = getSystemLocale /* getSystemLocale */.intl;
  obj9[1] = intl5.string(getSystemLocale /* getSystemLocale */.t.tpxJto);
  obj9[2] = !isReminder;
  items3[1] = callback(SheetRow, obj9);
  const obj10 = { icon: ClockIcon /* ClockIcon */.ClockIcon, label: null, highlighted: null, hasArrow: true };
  const intl6 = getSystemLocale /* getSystemLocale */.intl;
  obj10[1] = intl6.string(getSystemLocale /* getSystemLocale */.t.mJ3P0N);
  obj10[2] = isReminder;
...
function SheetRow(hasArrow) {
  ...
  if (flag) {
    ...
    tmp5Result = callback(ChevronSmallRightIcon /* ChevronSmallRightIcon */.ChevronSmallRightIcon, obj1);
  }
  items1[2] = tmp5Result;
  obj[1] = items1;
...
export default function ForLaterIntro(type) {
  const tmp = callback3();
  const tmp4 = type.type === SavedMessageSortTypes /* SavedMessageSortTypes */.SavedMessageSortTypes.REMINDER;
  ...
  const items1 = [callback(Text /* Text */.Heading, obj2), ];
