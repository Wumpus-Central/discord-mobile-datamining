...
function IntroDemo(isReminder) {
  ...
  obj = { source: { uri: _modDef13369 }, style: tmp.avatar };
...
obj = { flexGrow: 1, justifyContent: "center", alignItems: "center", paddingHorizontal: nativeDefault.space.PX_32, paddingBottom: nativeDefault.space.PX_32 };
...
let obj2 = { alignSelf: "stretch", backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWEST, borderColor: nativeDefault.colors.BORDER_NORMAL, borderRadius: nativeDefault.radii.md, borderWidth: 1, marginTop: nativeDefault.space.PX_24, overflow: "hidden" };
...
let obj6 = { alignItems: "center", borderRadius: nativeDefault.radii.sm, flexDirection: "row", gap: nativeDefault.space.PX_12, paddingHorizontal: nativeDefault.space.PX_12, paddingVertical: nativeDefault.space.PX_12 };
...
export default function ForLaterIntro(type) {
  ...
  obj = { source: importDefault(tmp4 ? 13367 : 13368), style: tmp.upsellImage };
  const items = [timestampProducer(React3, obj), , ];
  ...
  const intl3 = util.intl;
  const t3 = util.t;
  obj3.children = intl2.format(tmp4 ? t2.YI4UjI : t2["5TSj/g"], { itemName: intl3.string(tmp4 ? t3.mJ3P0N : t3.tpxJto) });
