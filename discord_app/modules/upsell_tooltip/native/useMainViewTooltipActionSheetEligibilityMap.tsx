...
import useGiftingPromotionAssetsReadyDefault from "useGiftingPromotionAssetsReady" /* 17065 */;
...
export const useMainViewTooltipActionSheetMap = function useMainViewTooltipActionSheetMap() {
  ...
  isEligibleToShowGiftingBadgeCoachmark = isEligibleToShowGiftingBadgeCoachmark(13657).useIsEligibleToShowGiftingBadgeCoachmark({ platform: "native", location: MainViewTooltipActionSheets });
  ...
  const nitroFileUploadAnnouncementEligible = isEligibleToShowGiftingBadgeCoachmark(17068).useNitroFileUploadAnnouncementEligible(MainViewTooltipActionSheets);
  const tmpResult11 = isEligibleToShowGiftingBadgeCoachmark(17068);
  const nitroFileUploadUpsellEligible = isEligibleToShowGiftingBadgeCoachmark(17068).useNitroFileUploadUpsellEligible(MainViewTooltipActionSheets);
  ...
  const shouldShowConnectionDeprecationBottomSheet1 = isEligibleToShowGiftingBadgeCoachmark(17053).useShouldShowConnectionDeprecationBottomSheet(obj);
  const tmpResult16 = isEligibleToShowGiftingBadgeCoachmark(17053);
  const isDisplayNameStylesFlywheelSettersEnabled = isEligibleToShowGiftingBadgeCoachmark(9306).useIsDisplayNameStylesFlywheelSettersEnabled(MainViewTooltipActionSheets);
