...
import useGiftingPromotionAssetsReadyDefault from "useGiftingPromotionAssetsReady" /* 17038 */;
...
export const useMainViewTooltipActionSheetMap = function useMainViewTooltipActionSheetMap() {
  ...
  isEligibleToShowGiftingBadgeCoachmark = isEligibleToShowGiftingBadgeCoachmark(13624).useIsEligibleToShowGiftingBadgeCoachmark({ platform: "native", location: MainViewTooltipActionSheets });
  ...
  const nitroFileUploadAnnouncementEligible = isEligibleToShowGiftingBadgeCoachmark(17041).useNitroFileUploadAnnouncementEligible(MainViewTooltipActionSheets);
  const tmpResult11 = isEligibleToShowGiftingBadgeCoachmark(17041);
  const nitroFileUploadUpsellEligible = isEligibleToShowGiftingBadgeCoachmark(17041).useNitroFileUploadUpsellEligible(MainViewTooltipActionSheets);
  ...
  const shouldShowConnectionDeprecationBottomSheet1 = isEligibleToShowGiftingBadgeCoachmark(17026).useShouldShowConnectionDeprecationBottomSheet(obj);
  const tmpResult16 = isEligibleToShowGiftingBadgeCoachmark(17026);
  const isDisplayNameStylesFlywheelSettersEnabled = isEligibleToShowGiftingBadgeCoachmark(9267).useIsDisplayNameStylesFlywheelSettersEnabled(MainViewTooltipActionSheets);
