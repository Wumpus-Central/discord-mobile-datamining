...
export const useMainViewTooltipActionSheetMap = function useMainViewTooltipActionSheetMap() {
  ...
  isEligibleToShowGiftingBadgeCoachmark = isEligibleToShowGiftingBadgeCoachmark(13575).useIsEligibleToShowGiftingBadgeCoachmark({ platform: "native", location: MainViewTooltipActionSheets });
  ...
  const shouldShowConnectionDeprecationBottomSheet1 = isEligibleToShowGiftingBadgeCoachmark(16943).useShouldShowConnectionDeprecationBottomSheet(obj);
  const tmpResult15 = isEligibleToShowGiftingBadgeCoachmark(16943);
  const isDisplayNameStylesFlywheelSettersEnabled = isEligibleToShowGiftingBadgeCoachmark(9182).useIsDisplayNameStylesFlywheelSettersEnabled(MainViewTooltipActionSheets);
