...
import useGiftingPromotionAssetsReadyDefault from "useGiftingPromotionAssetsReady" /* 17161 */;
...
export const useMainViewTooltipActionSheetMap = function useMainViewTooltipActionSheetMap() {
  ...
  isEligibleToShowGiftingBadgeCoachmark = isEligibleToShowGiftingBadgeCoachmark(10888).useIsEligibleToShowGiftingBadgeCoachmark({ platform: "native", location: MainViewTooltipActionSheets });
  ...
  const nitroFileUploadAnnouncementEligible = isEligibleToShowGiftingBadgeCoachmark(17164).useNitroFileUploadAnnouncementEligible(MainViewTooltipActionSheets);
  const tmpResult31 = isEligibleToShowGiftingBadgeCoachmark(17164);
  const nitroFileUploadUpsellEligible = isEligibleToShowGiftingBadgeCoachmark(17164).useNitroFileUploadUpsellEligible(MainViewTooltipActionSheets);
  ...
  const isDisplayNameStylesFlywheelSettersEnabled = isEligibleToShowGiftingBadgeCoachmark(9320).useIsDisplayNameStylesFlywheelSettersEnabled(MainViewTooltipActionSheets);
