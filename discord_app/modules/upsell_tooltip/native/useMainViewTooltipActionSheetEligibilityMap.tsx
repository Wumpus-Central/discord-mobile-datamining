...
export const useMainViewTooltipActionSheetMap = function useMainViewTooltipActionSheetMap() {
  ...
  const promotionMarketingComponent = isEligibleToShowGiftingBadgeCoachmark(13013).usePromotionMarketingComponent(
    tmp(10515).MarketingComponentType.MOBILE_BOTTOM_SHEET,
  );
  let oneofKind;
  ...
  const stateFromStores3 = isEligibleToShowGiftingBadgeCoachmark(589).useStateFromStores(items4, () => {
    const marketingComponentByType = store.getMarketingComponentByType(
      isEligibleToShowGiftingBadgeCoachmark(10515).MarketingComponentType.GIFT_ICON_COACHMARK,
    );
  ...
  const stateFromStores4 = isEligibleToShowGiftingBadgeCoachmark(589).useStateFromStores(items5, () => {
    const marketingComponentByType = store.getMarketingComponentByType(
      isEligibleToShowGiftingBadgeCoachmark(10515).MarketingComponentType.GIFT_REMINDER_COACHMARK,
    );
    let prop = null;
    if (null != marketingComponentByType) {
      prop = null;
  ...
  const stateFromStores5 = isEligibleToShowGiftingBadgeCoachmark(589).useStateFromStores(
    items7,
    () => null != badgeById.getBadgeById(isEligibleToShowGiftingBadgeCoachmark(8557).BadgeId.GIFTING),
  );
  if (isDismissed) {
    isDismissed = tmp(4298).UNSAFE_isSnowflakeBoundDismissibleContentDismissed(
      tmp(1373).DismissibleContent.GIFTING_PROMOTION_MOBILE_FIRST_TIME_HALFSHEET,
      stateFromStores2,
    ).isDismissed;
  ...
  const shouldShowRobloxConnectionCoachmark =
    isEligibleToShowGiftingBadgeCoachmark(16509).useShouldShowRobloxConnectionCoachmark();
  ...
  const isDisplayNameStylesFlywheelSettersEnabled =
    isEligibleToShowGiftingBadgeCoachmark(8925).useIsDisplayNameStylesFlywheelSettersEnabled(tmp5);
