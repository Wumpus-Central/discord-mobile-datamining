...
export const useMainViewTooltipActionSheetMap = function useMainViewTooltipActionSheetMap() {
  ...
  const promotionMarketingComponent = isEligibleToShowGiftingBadgeCoachmark(13687).usePromotionMarketingComponent(
    tmp(10999).MarketingComponentType.MOBILE_BOTTOM_SHEET,
  );
  let oneofKind;
  ...
  const stateFromStores3 = isEligibleToShowGiftingBadgeCoachmark(504).useStateFromStores(items4, () => {
    const marketingComponentByType = PromotionsStore.getMarketingComponentByType(
      isEligibleToShowGiftingBadgeCoachmark(10999).MarketingComponentType.GIFT_ICON_COACHMARK,
    );
  ...
  const stateFromStores4 = isEligibleToShowGiftingBadgeCoachmark(504).useStateFromStores(items5, () => {
    const marketingComponentByType = PromotionsStore.getMarketingComponentByType(
      isEligibleToShowGiftingBadgeCoachmark(10999).MarketingComponentType.GIFT_REMINDER_COACHMARK,
    );
    let prop = null;
    if (null != marketingComponentByType) {
      prop = null;
  ...
  const stateFromStores5 = isEligibleToShowGiftingBadgeCoachmark(504).useStateFromStores(
    items7,
    () => null != badgeById.getBadgeById(isEligibleToShowGiftingBadgeCoachmark(8453).BadgeId.GIFTING),
  );
  if (isDismissed) {
    isDismissed = tmp(4576).UNSAFE_isSnowflakeBoundDismissibleContentDismissed(
      tmp(2027).DismissibleContent.GIFTING_PROMOTION_MOBILE_FIRST_TIME_HALFSHEET,
      stateFromStores2,
    ).isDismissed;
  ...
  if (isDismissed2) {
    isDismissed2 = tmp(4576).UNSAFE_isSnowflakeBoundDismissibleContentDismissed(
      tmp(2027).DismissibleContent.GIFTING_PROMOTION_REMINDER,
      stateFromStores2,
    ).isDismissed;
  ...
  const nitroFileUploadAnnouncementEligible =
    isEligibleToShowGiftingBadgeCoachmark(17422).useNitroFileUploadAnnouncementEligible(MainViewTooltipActionSheets);
  const tmpResult30 = isEligibleToShowGiftingBadgeCoachmark(17422);
  const nitroFileUploadUpsellEligible =
    isEligibleToShowGiftingBadgeCoachmark(17422).useNitroFileUploadUpsellEligible(MainViewTooltipActionSheets);
  ...
  const shouldShowRobloxConnectionCoachmark =
    isEligibleToShowGiftingBadgeCoachmark(17397).useShouldShowRobloxConnectionCoachmark();
  ...
  const shouldShowConnectionDeprecationBottomSheet1 =
    isEligibleToShowGiftingBadgeCoachmark(17407).useShouldShowConnectionDeprecationBottomSheet(obj5);
  const tmpResult34 = isEligibleToShowGiftingBadgeCoachmark(17407);
  const isDisplayNameStylesFlywheelSettersEnabled =
    isEligibleToShowGiftingBadgeCoachmark(9997).useIsDisplayNameStylesFlywheelSettersEnabled(
  ...
  if (stateFromStores) {
    ...
    const obj14 = {
      isEligible: dismissibleContent === tmp(2027).DismissibleContent.PREMIUM_MARKETING_MOMENT_ANNOUNCEMENT_UPSELL,
      newSnowflakeId: null,
    ...
    const obj16 = {
      isEligible: dismissibleContent1 === tmp(2027).DismissibleContent.PREMIUM_MARKETING_MOMENT_REMINDER_UPSELL,
      newSnowflakeId: null,
      actionSheetProperties: null,
    };
    let promotionId2;
