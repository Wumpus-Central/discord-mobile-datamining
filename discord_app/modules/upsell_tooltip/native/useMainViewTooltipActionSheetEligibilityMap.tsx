...
import useGiftingPromotionAssetsReadyDefault from "useGiftingPromotionAssetsReady" /* 17201 */;
...
export const useMainViewTooltipActionSheetMap = function useMainViewTooltipActionSheetMap() {
  ...
  isEligibleToShowGiftingBadgeCoachmark = isEligibleToShowGiftingBadgeCoachmark(10896).useIsEligibleToShowGiftingBadgeCoachmark({ platform: "native", location: MainViewTooltipActionSheets });
  ...
  const nitroFileUploadAnnouncementEligible = isEligibleToShowGiftingBadgeCoachmark(17204).useNitroFileUploadAnnouncementEligible(MainViewTooltipActionSheets);
  const tmpResult31 = isEligibleToShowGiftingBadgeCoachmark(17204);
  const nitroFileUploadUpsellEligible = isEligibleToShowGiftingBadgeCoachmark(17204).useNitroFileUploadUpsellEligible(MainViewTooltipActionSheets);
  ...
  const isDisplayNameStylesFlywheelSettersEnabled = isEligibleToShowGiftingBadgeCoachmark(9331).useIsDisplayNameStylesFlywheelSettersEnabled(MainViewTooltipActionSheets);
