...
export default function MainViewTooltipActionSheetsV2() {
  ...
  if (null == actionSheetConfig) {
    ...
    if ("snowflake_bound" === str2) {
      ...
      return jsx(tmp(10657).SelectedSnowflakeBoundDismissibleContent, { contentType: actionSheetConfig.id, newSnowflakeId: null, groupName: null, children: null });
      ...
      return jsx(actionSheetConfig(10657), { contentTypes: null, groupName: null, children: null });
    } else {
      return null;
    }
  }
