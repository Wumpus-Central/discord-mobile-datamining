...
import handleOpenAgeGatedContentSupportArticle from "handleOpenAgeGatedContentSupportArticle" /* 14783 */;
...
function AccountStatusNotice(arg0) {
  ...
  if (shouldShowTinyBroncoAccountStatus) {
    ...
    if (null != tmp5[0]) {
      ...
      obj = { style: tmp.noticeIcon, children: closure_8(tmp2(4529).CircleInformationIcon, { size: "xs", color: "text-link" }) };
      ...
      items[1] = closure_8(tmp2(4570).Text, obj1);
      ...
      obj3.onPress = tmp7;
      obj3.children = closure_8(tmp2(5694).XSmallIcon, { size: "sm", color: "icon-strong" });
      items[2] = closure_8(tmp2(5137).PressableOpacity, obj3);
      obj.children = items;
...
function AgeGroupDescription(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    obj.children = intl3.format(_modDef14751.gi4ulu, obj);
    ...
    obj1.children = intl2.format(_modDef14751["221iML"], obj2);
    ...
    obj.children = intl.format(_modDef14751["W0/7DD"], obj3);
    return React6(Text_Text.Text, obj);
  }
}
function AgeGroupCallToAction(ageGroup) {
  ...
  if (useAgeGroupPresentation.AgeGroupState.ADULT === ageGroup) {
    ...
    const intl2 = util.intl;
    obj.text = intl2.string(_modDef14751["+7NlgO"]);
...
let closure_12 = [];
let obj3 = {};
obj3[fn(14745).AgeGroupState.ADULT] = _modDef14751["8TWztV"];
obj3[fn(14745).AgeGroupState.TEEN] = _modDef14751.qSkhZH;
obj3[fn(14745).AgeGroupState.UNVERIFIED] = _modDef14751.vGxRDB;
const obj4 = {};
obj4[fn(14745).AgeGroupState.ADULT] = _modDef14751.t5QjmQ;
obj4[fn(14745).AgeGroupState.TEEN] = _modDef14751["41MDhK"];
obj4[fn(14745).AgeGroupState.UNVERIFIED] = _modDef14751.m95jW8;
const size = fn(2);
