...
export const presentFriendRequestAcceptedToast = function presentFriendRequestAcceptedToast(dependencyMap) {
  ...
  obj = { key: "TOAST_FRIEND_REQUEST_ACCEPTED", content: stringResult, IconComponent: tmp2(4511).UserPlusIcon, iconColor: "status-positive" };
  obj.open(obj);
};
...
export const unverifiedVoiceGate = function unverifiedVoiceGate(check) {
  ...
  if (null != stringResult) {
    const obj1 = { key: "UNVERIFIED_VOICE_GATE", content: stringResult, IconComponent: CircleInformationIcon.CircleInformationIcon };
...
export const memberOrRoleAddedToast = function memberOrRoleAddedToast(count, count2) {
  if (count > 0) {
    ...
    if (null != stringResult) {
      let obj = { key: "MEMBER_OR_ROLE_ADDED", content: stringResult, IconComponent: CheckmarkLargeIcon.CheckmarkLargeIcon, iconColor: "status-positive" };
      ToastActionCreatorsDefault.open(obj);
    }
  }
  if (count > 0) {
