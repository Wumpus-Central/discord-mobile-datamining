...
import dispatcherDefault from "ToastActionCreators.tsx";
...
const result = obj132.fileFinishedImporting("modules/toast/native/ToastUtils.tsx");
...
export const presentGameFriendRequestAcceptedToast = function presentGameFriendRequestAcceptedToast() {
  const obj = { key: "TOAST_GAME_FRIEND_REQUEST_ACCEPTED", content: null, IconComponent: null, iconColor: "status-positive" };
  const intl = getSystemLocale.intl;
...
export const presentFriendRequestIgnoredToast = function presentFriendRequestIgnoredToast() {
  const obj = { key: "TOAST_FRIEND_REQUEST_IGNORED", content: null, IconComponent: null, iconColor: "icon-feedback-critical" };
  const intl = getSystemLocale.intl;
...
export const presentGameFriendRequestIgnoredToast = function presentGameFriendRequestIgnoredToast() {
  const obj = { key: "TOAST_GAME_FRIEND_REQUEST_IGNORED", content: null, IconComponent: null, iconColor: "icon-feedback-critical" };
  const intl = getSystemLocale.intl;
...
export const presentEmoji = function presentEmoji(closure_0) {
  let obj = { id: _require.id, animated: _require.animated, size: 48 };
  const emojiURL = obj.getEmojiURL(obj);
  obj = { key: "PRESENT_EMOJI-" + _require.id, content: ":" + _require.name + ":", icon: { uri: emojiURL } };
...
export const presentNoiseCancellationError = function presentNoiseCancellationError() {
  const obj = { key: "MOBILE_NOISE_CANCELLATION_CPU_OVERUSE", content: null, IconComponent: null, iconColor: "icon-feedback-critical" };
  const intl = getSystemLocale.intl;
...
export const presentError = function presentError(intl) {
  const obj = { key: "ERROR", content: intl, IconComponent: XLargeIcon2.XLargeIcon, iconColor: "icon-feedback-critical" };
  obj.open(obj);
};
export const presentVoiceActivityDetectionError = function presentVoiceActivityDetectionError() {
  const obj = { key: "MOBILE_ADVANCED_VOICE_ACTIVITY_CPU_OVERUSE", content: null, IconComponent: null, iconColor: "icon-feedback-critical" };
  const intl = getSystemLocale.intl;
...
export const roleIdCopied = function roleIdCopied(closure_2) {
  { key: "ROLE_ID_COPIED-" + closure_2, content: null, IconComponent: null };
  const intl = getSystemLocale.intl;
  const obj = { role: closure_2 };
...
export const communityRequirementSatisfied = function communityRequirementSatisfied() {
  const obj = { key: "ENABLE_COMMUNITY_MODAL_REQUIREMENT_SATISFIED_TOOLTIP", content: null, IconComponent: null, iconColor: "status-positive" };
  const intl = getSystemLocale.intl;
...
export const roleTemplateAppliedToast = function roleTemplateAppliedToast() {
  const obj = { key: "ROLE_PERMISSION_TEMPLATE_SELECT_CONFIRMATION_TOAST", content: null, IconComponent: null, iconColor: "status-positive" };
  const intl = getSystemLocale.intl;
...
export const presentFailedToast = function presentFailedToast(intl) {
  const obj = { key: "FAILED", content: intl, IconComponent: XLargeIcon2.XLargeIcon, iconColor: "icon-feedback-critical" };
  obj.open(obj);
};
...
export const presentGuildRoleSubscriptionTrialTierMonthCost = function presentGuildRoleSubscriptionTrialTierMonthCost() {
  const obj = { key: "GUILD_ROLE_SUBSCRIPTION_MANAGE_SUBSCRIPTION_PAGE_TRIAL_PRICE_INFO", content: null, IconComponent: null };
  const intl = getSystemLocale.intl;
...
export const showVoiceRecordingFailed = function showVoiceRecordingFailed() {
  const obj = { key: "VOICE_MESSAGES_RECORDING_FAILED", content: null, IconComponent: null, iconColor: "icon-feedback-critical" };
  const intl = getSystemLocale.intl;
...
export const showMaxGroupMembers = function showMaxGroupMembers() {
  const obj = { key: "GROUP_DM_INVITE_FULL_MAIN", content: null, IconComponent: null, iconColor: "icon-feedback-critical" };
  const intl = getSystemLocale.intl;
...
export const showSafetySuccess = function showSafetySuccess(BLOCK_SUCCESS, safetyToastTypeContent) {
  const obj = { key: BLOCK_SUCCESS, content: safetyToastTypeContent, IconComponent: CircleCheckIcon.CircleCheckIcon, iconColor: "status-positive" };
  obj.open(obj);
};
