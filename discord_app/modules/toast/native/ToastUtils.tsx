...
export const presentFriendRequestAcceptedToast = function presentFriendRequestAcceptedToast(username) {
  ...
  obj = { key: "TOAST_FRIEND_REQUEST_ACCEPTED", content: stringResult, IconComponent: tmp2(4240).UserPlusIcon, iconColor: "status-positive" };
  obj.open(obj);
};
...
export const presentNoiseCancellation = function presentNoiseCancellation(arg0) {
  ...
  if (arg0) {
    let XLargeIcon = tmp4(4254).CheckmarkLargeIcon;
  } else {
    XLargeIcon = tmp4(4256).XLargeIcon;
  }
  obj[2] = XLargeIcon;
