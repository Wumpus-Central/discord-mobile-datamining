...
const memoResult = importAllResult.memo(() => {
  ...
  return jsx(stateFromStoresArray(4172).TransitionGroup, { items: stateFromStoresArray, renderItem, getItemKey, wrapChildren });
});
