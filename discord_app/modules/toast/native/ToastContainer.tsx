...
import ToastStore from "ToastStore" /* 17436 */;
...
export default noop.memo(() => {
  ...
  return jsx(stateFromStoresArray(4467).TransitionGroup, { items: stateFromStoresArray, renderItem, getItemKey, wrapChildren });
});