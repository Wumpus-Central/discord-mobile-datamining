...
const memoResult = importAllResult.memo(() => {
  ...
  return jsx(stateFromStoresArray(4173).TransitionGroup, { items: stateFromStoresArray, renderItem, getItemKey, wrapChildren });
});
