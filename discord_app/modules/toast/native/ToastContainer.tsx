...
let obj = {
  container: {
    ...
    shadowColor: fn(5527).TOAST_CONTAINER_SHADOW_COLOR,
  },
};
...
export default noop.memo(() => {
  ...
  return jsx(stateFromStoresArray(4348).TransitionGroup, {
