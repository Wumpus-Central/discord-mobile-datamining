...
const memoResult = importAllResult.memo(() => {
  ...
  return jsx(stateFromStoresArray(4174).TransitionGroup, { items: stateFromStoresArray, renderItem, getItemKey, wrapChildren });
});
