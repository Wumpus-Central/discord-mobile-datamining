...
export default function SuspiciousDownloadActionSheet(href) {
  ...
  items1[1] = closure_3(href(4601).Text, obj1);
  ...
  items1[2] = closure_3(href(4601).Text, obj2);
  obj.children = items1;
  const items2 = [closure_4(href(5023).Stack, obj), ];
  ...
  const items3 = [closure_3(href(5025).Button, obj4), ];
  ...
  items3[1] = closure_3(href(5025).Button, obj5);
  obj3.children = items3;
  items2[1] = closure_4(href(5023).Stack, obj3);
  obj.children = items2;
  obj.children = closure_4(href(5023).Stack, obj);
