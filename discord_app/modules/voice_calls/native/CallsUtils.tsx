...
import AudioRouteStore from "AudioRouteStore" /* 9088 */;
import AudioManagerStore from "AudioManagerStore" /* 9091 */;
...
const audioDeviceToIconMap = { EARPIECE: _modDef9116, BLUETOOTH_HEADSET: _modDef9117, WIRED_HEADSET: _modDef9118, SPEAKERPHONE: _modDef9118, INVALID: _modDef9118 };
...
export const useMaskedSpeakerStates = PlatformUtils.isAndroid() ? (() => {
  ...
  const stateFromStoresObject = obj.useStateFromStoresObject(items, () => {
    isVideoMode = isEnabled(9470).isVideoMode(ChannelStore, SelectedChannelStore, ApplicationStreamingStore, VoiceStateStore, MediaEngineStore);
  ...
  obj = { isAudioRouteEnabled, toggleAudio: callback, routeSource: isVideoMode(stateFromStoresObject.isBluetoothRoute ? 9117 : 9118) };
  return obj;
});
export const useImmediateMaskedSpeakerStates = () => {
  ...
  obj = { isAudioRouteEnabled, toggleAudio: callback, routeSource: importDefault(tmp6 ? 9117 : 9118) };
  return obj;
};