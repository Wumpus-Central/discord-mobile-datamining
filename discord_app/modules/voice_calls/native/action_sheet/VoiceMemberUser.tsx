...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    obj.subLabel = closure_11(tmp3(8663).FormSubLabel, obj);
    ...
    if (tmp10Result) {
      ...
      obj1.children = closure_11(channel(10128), obj2);
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      tmp4Result = closure_11(channelId(5173).PressableOpacity, obj);
    }
  }
  return tmp3;
}
...
let closure_16 = noop.memo((user) => {
  ...
  obj1.speaking = channel(9548)(obj);
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        obj3 = { size: tmp8(1178).Icon.Sizes.REFRESH_SMALL_16, source: channel(13867), style: tmp19 };
      ...
      if (!tmp15) {
        ...
        tmp20Result = null;
        if (tmp14) {
          obj4 = { size: tmp8(1178).Icon.Sizes.REFRESH_SMALL_16, source: channel(13864), style: tmp19 };
        ...
        if (!tmp13) {
          ...
          if (localVideoDisabled) {
            const obj6 = { size: tmp8(1178).Icon.Sizes.REFRESH_SMALL_16, source: channel(13865), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj7 = obj6;
          } else {
            obj7 = { size: tmp8(1178).Icon.Sizes.REFRESH_SMALL_16, source: channel(13866), style: tmp19 };
          }
          closure_11(tmp8(1178).Icon, obj7);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = channel(13862);
        } else {
          tmp5Result = channel(13863);
        }
  ...
  if (stateFromStores1) {
    ...
    items4[1] = closure_12(tmp8(4601).Text, obj11);
  ...
  obj9.label = closure_11(user(8663).FormRow.Label, obj12);
  if (localVideoAutoDisabled) {
    const obj13 = { style: tmp2.autoDisabledVideo, children: null };
    const obj14 = { source: channel(9695), size: tmp8(1178).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    ...
    items6[1] = closure_11(tmp8(4601).Text, obj15);
  ...
  return closure_11(user(8663).FormRow, obj9);
});
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  obj.style = labelCallScreen;
  obj.label = closure_11(id(8663).FormRow.Label, obj);
  ...
  if (!canRing) {
    ...
    return closure_11(tmp2(8663).FormRow, obj2);
  } else {
