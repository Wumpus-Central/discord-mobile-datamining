...
function StreamingUserRow(user) {
  ...
  if (null != stateFromStores) {
    ...
    if (tmp10Result) {
      ...
      obj4.children = closure_11(channel(10187), obj5);
...
function RingButton(channelId) {
  ...
  if (null != userId) {
    ...
    if (null != channelId) {
      ...
      tmp4Result = closure_11(tmp5(1176).LegacyText, obj2);
...
let closure_16 = noop.memo((user) => {
  ...
  if (flag3) {
    ...
    if (!flag) {
      ...
      if (user.isSpectating) {
        const obj9 = { size: tmp8(1176).Icon.Sizes.REFRESH_SMALL_16, source: channel(13881), style: tmp19 };
        tmp20Result = closure_11(tmp8(1176).Icon, obj9);
      }
      ...
      if (!tmp15) {
        ...
        if (tmp14) {
          const obj10 = { size: tmp8(1176).Icon.Sizes.REFRESH_SMALL_16, source: channel(13878), style: tmp19 };
          tmp20Result5 = closure_11(tmp8(1176).Icon, obj10);
        }
        ...
        if (!tmp13) {
          ...
          if (flag2) {
            ...
            tmp20Result6 = closure_11(tmp8(1176).LiveTag, obj11);
          }
          ...
          if (localVideoDisabled) {
            const obj12 = { size: tmp8(1176).Icon.Sizes.REFRESH_SMALL_16, source: channel(13879), style: tmp2.voiceStatusIconMargin, disableColor: true };
            let obj13 = obj12;
          } else {
            obj13 = { size: tmp8(1176).Icon.Sizes.REFRESH_SMALL_16, source: channel(13880), style: tmp19 };
          }
          closure_11(tmp8(1176).Icon, obj13);
        }
      } else {
        if (tmp8Result.isThemeDark(stateFromStores)) {
          let tmp5Result = channel(13876);
        } else {
          tmp5Result = channel(13877);
        }
        ...
        closure_11(tmp8(1176).Icon, obj14);
  ...
  if (localVideoAutoDisabled) {
    ...
    const obj20 = { source: channel(9755), size: tmp8(1176).Icon.Sizes.EXTRA_SMALL, disableColor: true };
    const items6 = [closure_11(tmp8(1176).Icon, obj20), ];
    ...
    items6[1] = closure_11(tmp8(4632).Text, obj21);
...
const memoResult = noop.memo(function DisconnectedUserRow(user) {
  ...
  if (!canRing) {
    ...
    return closure_11(tmp2(8716).FormRow, obj7);
  } else {
  ...
  const obj6 = { user: id, guildId: id2.guild_id, size: id(1176).AvatarSizes.REFRESH_MEDIUM_32 };
});
const size = fn(2);
