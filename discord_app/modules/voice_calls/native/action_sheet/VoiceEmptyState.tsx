...
import { registerAsset } from "../../../../../_runtime/13115_registerAsset.js";
...
export default function VoiceEmptyState(channel) {
  ...
  const items1 = [callback(Button.ThemedEmptyState, obj), callback(JoinVoiceChannelButton, { channel: channel.channel, style: tmp.button })];
  obj[1] = items1;
