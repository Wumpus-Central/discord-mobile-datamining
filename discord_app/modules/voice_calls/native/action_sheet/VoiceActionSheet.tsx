...
export default function VoiceActionSheet(channel) {
  ...
  if (obj1.requiresVoiceChannelsOnboard()) {
    ...
    obj = { channel: null };
    obj[0] = channel;
    obj[0] = callback(tmp2(13431), obj);
    let children = callback(tmp5(5989).ActionSheet, obj);
    let tmp8 = callback;
    ...
    obj1[0] = items2;
    children = callback2(tmp5(5989).ActionSheet, obj1);
    tmp8 = callback;
  } else {
    tmp8 = callback;
