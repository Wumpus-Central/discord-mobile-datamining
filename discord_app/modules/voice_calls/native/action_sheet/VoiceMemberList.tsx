...
function ItemSeparator() {
  const tmp = callback4();
  return callback2(require("../../../../design/void/Form/native/index.tsx") /* Form */.FormDivider, { style: callback4().rowFormDivider });
}
...
let closure_25 = importAllResult.memo((channel) => callback2(require("../../../guild_scheduled_events/native/components/GuildEventVoiceBanner.tsx"), { channel: channel.channel }));
let closure_26 = importAllResult.memo((channel) => {
  ...
  if (!tmp3) {
    ...
    if (tmp6) {
      ...
      obj[2] = require("../../../../../_runtime/09638_registerAsset.js");
