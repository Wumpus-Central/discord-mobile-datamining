...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2.problemOptions = analyticsData(11700).getVideoFeedbackOptions();
  ...
  obj4.problemOptions = analyticsData(11700).getPeopleFeedbackOptions();
