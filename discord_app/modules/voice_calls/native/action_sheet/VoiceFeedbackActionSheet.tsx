...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2.problemOptions = analyticsData(11634).getVideoFeedbackOptions();
  ...
  obj4.problemOptions = analyticsData(11634).getPeopleFeedbackOptions();
