...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2.problemOptions = analyticsData(11722).getVideoFeedbackOptions();
  ...
  obj4.problemOptions = analyticsData(11722).getPeopleFeedbackOptions();
