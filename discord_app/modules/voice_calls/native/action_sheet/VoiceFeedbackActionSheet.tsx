...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2.problemOptions = analyticsData(11758).getVideoFeedbackOptions();
  ...
  obj4.problemOptions = analyticsData(11758).getPeopleFeedbackOptions();
