...
export default function VoiceFeedbackActionSheet(analyticsData) {
  ...
  obj2.problemOptions = analyticsData(11660).getVideoFeedbackOptions();
  ...
  obj4.problemOptions = analyticsData(11660).getPeopleFeedbackOptions();
