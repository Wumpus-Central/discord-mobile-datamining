...
export default function SelectedUserField(onPress) {
  ...
  if (null != selectedUser) {
    ...
    let obj3 = require("../../../../utils/UserUtils.tsx");
  ...
  obj[3] = combined;
  const items1 = [closure_5(require("../../../../design/components/Icon/native/redesign/generated/MagnifyingGlassIcon.tsx") /* MagnifyingGlassIcon */.MagnifyingGlassIcon, { style: tmp.searchIcon, size: "xs", color: "interactive-text-default" }), ];
  if (null != selectedUser) {
    ...
    obj4[2] = require("../../../../utils/UserUtils.tsx").getName(selectedUser);
  ...
  if (null != selectedUser) {
    ...
    obj7[0] = require("../../../../utils/UserUtils.tsx").getName(selectedUser);
    ...
    const obj13 = require("../../../../utils/UserUtils.tsx");
  }
  items3[1] = tmp2Result;
  obj[1] = items3;
  obj[1] = closure_5(require("../../../../design/components/Input/native/InputFieldContainer.native.tsx") /* useInputStyles */.InputFieldContainer, { children: closure_6(closure_4, obj) });
