...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_6(View, {
      ...
      children: closure_6(markAsDismissed(5773).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }),
    }),
    ,
  ];
  ...
  items3[1] = closure_6(markAsDismissed(4632).Text, obj2);
  ...
  items3[2] = closure_6(markAsDismissed(5056).Button, obj3);
  obj.children = items3;
  obj.children = closure_7(markAsDismissed(5054).Stack, obj);
