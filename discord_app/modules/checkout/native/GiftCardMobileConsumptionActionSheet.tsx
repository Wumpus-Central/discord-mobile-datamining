...
import _modDef2252 from "../messages/GiftCard.messages.js";
...
let obj2 = {
  sheet: { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW },
  container: null,
  illustration: null,
  body: null,
};
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [
    closure_6(View, {
      ...
      children: closure_6(markAsDismissed(5995).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }),
    }),
    ,
  ];
  ...
  items3[1] = closure_6(markAsDismissed(4823).Text, obj5);
  ...
  items3[2] = closure_6(markAsDismissed(5271).Button, obj6);
  obj3.children = items3;
  obj2.children = closure_7(markAsDismissed(5269).Stack, obj3);
  obj.children = closure_6(View, obj2);
  return closure_6(markAsDismissed(7481).BottomSheet, obj);
}
