// === Module 7720: GiftCardMobileConsumptionActionSheet ===
...
export default function GiftCardMobileConsumptionActionSheet(markAsDismissed) {
  ...
  const items3 = [closure_6(View, { style: tmp.illustration, children: closure_6(markAsDismissed(5995).LaptopSpotIllustration, { scale: 1, width: 150, height: 123 }) }), , ];
