// discord_app/modules/intelligence_layer/search/IntelligenceSearchActionCreators.tsx
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (1 === tmp7) {
              ...
              if (null != guildIdFromSearchContext) {
                if (obj18.isNlpSearchEnabled(guildIdFromSearchContext, "fetch_answer")) {
                  ...
                  if (null != intelligenceSearchQuery) {
                    searchTabFetchId = closure_130_0(closure_130_2[6]).getSearchTabFetchId(
                      closure_129_0,
                      closure_130_7.MESSAGES,
                      closure_129_1,
                    );
                    if (!closure_130_5.hasAnswer(guildIdFromSearchContext, searchTabFetchId)) {
                      ...
                      closure_129_5 = str;
                      const obj9 = {
                        type: "INTELLIGENCE_SEARCH_FETCH_START",
                        requestKey: searchTabFetchId,
                        guildId: guildIdFromSearchContext,
                        queryText: intelligenceSearchQuery.queryText,
                        channelIds: intelligenceSearchQuery.channelIds,
                      };
                      closure_130_1(closure_130_2[8]).dispatch(obj9);
                      c4 = 1;
                      const HTTP = closure_130_0(closure_130_2[9]).HTTP;
                      const request = {
                        url: closure_130_6.INTELLIGENCE_LAYER_SEARCH(guildIdFromSearchContext),
                        body: null,
                        oldFormErrors: true,
                        rejectWithError: true,
                      };
                      const obj10 = {
                        query_text: intelligenceSearchQuery.queryText,
                        channel_ids: intelligenceSearchQuery.channelIds,
                        extra_params_json: closure_129_5,
                      };
                      request.body = obj10;
                      c5 = 3;
                      c6 = 1;
          ...
          closure_129_8 = ERROR;
          const obj12 = {
            type: "INTELLIGENCE_SEARCH_FETCH_FAILURE",
            requestKey: searchTabFetchId,
            guildId: guildIdFromSearchContext,
            status: closure_129_8,
            queryText: intelligenceSearchQuery.queryText,
            channelIds: intelligenceSearchQuery.channelIds,
          };
          ...
          closure_129_6 = value;
          const obj13 = {
            type: "INTELLIGENCE_SEARCH_FETCH_SUCCESS",
            requestKey: searchTabFetchId,
            guildId: guildIdFromSearchContext,
            response: closure_129_6.body,
            messages: null,
            channelIds: null,
          };
