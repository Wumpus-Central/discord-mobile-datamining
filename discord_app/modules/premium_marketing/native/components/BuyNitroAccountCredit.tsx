...
require = fn;
let obj = { borderRadius: ThemesDefault.modules.mobile.TABLE_ROW_BORDER_RADIUS };
obj[0] = obj;
...
const result = require("obj132").fileFinishedImporting("modules/premium_marketing/native/components/BuyNitroAccountCredit.tsx");
