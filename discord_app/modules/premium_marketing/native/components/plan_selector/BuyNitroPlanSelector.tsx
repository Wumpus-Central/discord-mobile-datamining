...
createStyles.hrkWarning = { borderRadius: nativeDefault.modules.mobile.TABLE_ROW_BORDER_RADIUS, backgroundColor: fn(5491).DARK_PRIMARY_630_LIGHT_PRIMARY_230, marginTop: nativeDefault.space.PX_8, overflow: "hidden" };
