...
export default function BuyNitroGradient(selectedTier) {
  ...
  obj = { withTiming: selectedTier(4381).withTiming, selectedTier, PremiumTypes, timingStandard: selectedTier(4384).timingStandard };
  fn.__closure = obj;
