...
export default function BuyNitroGradient(selectedTier) {
  ...
  obj = { withTiming: selectedTier(4449).withTiming, selectedTier, PremiumTypes, timingStandard: selectedTier(4452).timingStandard };
  fn.__closure = obj;
