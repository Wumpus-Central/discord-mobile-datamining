...
export default function BuyNitroPurchaseButtonCrossfadeLayer(arg0) {
  ...
  obj.children = jsx(onDone(5025).Button, { text: snapshot.ctaText, variant: snapshot.variant, size: "lg", grow: true, onPress: "Boolean" });
  return jsx(sharedValue(4341).View, { text: snapshot.ctaText, variant: snapshot.variant, size: "lg", grow: true, onPress: "Boolean" });
};
