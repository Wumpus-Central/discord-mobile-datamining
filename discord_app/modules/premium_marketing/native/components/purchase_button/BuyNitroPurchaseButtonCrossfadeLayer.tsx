// === Module 13016: BuyNitroPurchaseButtonCrossfadeLayer ===
...
export default function BuyNitroPurchaseButtonCrossfadeLayer(arg0) {
  ...
  const animatedStyle = onDone(4187).useAnimatedStyle(fn);
  ...
  obj = { style: items1, pointerEvents: "none", children: jsx(onDone(4896).Button, obj) };
  ...
  return jsx(sharedValue(4187).View, { text: snapshot.ctaText, variant: snapshot.variant, size: "lg", grow: true, onPress: "Boolean" });
};
