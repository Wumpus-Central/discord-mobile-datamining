    ...
    analyticsLoadId = function _runPurchase() {
      ...
      const tmp = asyncGeneratorStep(async () => {
        ...
        obj6.track(
          ...
          sku_id(10733).getPaymentFlowStepAnalyticsFields(basePurchaseFlowAnalyticsFields, {
            from_step: sku_id(10733).PaymentFlowStep.PLAN_SELECT,
            to_step: sku_id(10733).PaymentFlowStep.EXTERNAL_PAYMENT,
