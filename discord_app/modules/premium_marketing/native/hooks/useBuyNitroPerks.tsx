...
import DoorEnterIcon from "DoorEnterIcon" /* 13447 */;
import _modDef13449 from "module_13449" /* 13449 */;
import _modDef13450 from "module_13450" /* 13450 */;
import ServerGridIcon from "ServerGridIcon" /* 13451 */;
...
import LettersIcon from "LettersIcon" /* 13457 */;
import SparklesIcon from "SparklesIcon" /* 13459 */;
...
export default function useBuyNitroPerks(arg0) {
  ...
  return noop.useMemo(() => {
    ...
    obj.detail = obj;
    let items = [obj, , , , , , , , , , , , , , , ];
    const obj1 = { id: "uploads", label: null, labelBasic: null, subLabel: null, IconComponent: null, includedInNitroBasic: true, detail: null };
    ...
    if (obj9.isAppIconsSupported()) {
      const obj5 = { id: "custom-app-icons", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: true, detail: null };
    ...
    const obj6 = { id: "profiles", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    if (closure_1) {
      ...
      const obj8 = { id: "boosts", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    const obj11 = { id: "streaming", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    const obj13 = { id: "super-reactions", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: true, detail: null };
    ...
    if (tmp7) {
      ...
      const obj15 = { id: "badge", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: true, detail: null };
    ...
    const obj16 = { id: "stickers", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: true, detail: null };
    ...
    const obj18 = { id: "custom-sounds", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    items[sum1] = obj18;
    const sum2 = sum1 + 1;
    const obj20 = { id: "entrance-sounds", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    items[sum2] = obj20;
    const sum3 = sum2 + 1;
    const obj21 = { id: "video-backgrounds", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: true, detail: null };
    ...
    items[sum3] = obj21;
    const sum4 = sum3 + 1;
    const obj23 = { id: "longer-messages", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    items[sum4] = obj23;
    const sum5 = sum4 + 1;
    const obj25 = { id: "more-servers", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    items[sum5] = obj25;
    const sum6 = sum5 + 1;
    const obj27 = { id: "client-themes", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    items[sum6] = obj27;
    const sum7 = sum6 + 1;
    const obj29 = { id: "display-name-styles", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    items[sum7] = obj29;
    const sum8 = sum7 + 1;
    const obj30 = { id: "permadecos", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    items[sum8] = obj30;
    const sum9 = sum8 + 1;
    const obj31 = { id: "early-access", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    items[sum9] = obj31;
    const obj32 = { id: "member-pricing", label: null, subLabel: null, IconComponent: null, includedInNitroBasic: false, detail: null };
    ...
    if (closure_0 === TIER_2.TIER_0) {
      ...
      if (0 === found1.length) {
        ...
        items6 = [obj33, ];
        const arraySpreadResult3 = HermesBuiltin.arraySpread(found.map((perk, index) => ({ kind: "perk", perk, start: 0 === index, end: index === mapped.length - 1 })), 1);
        ...
        mapped = found1;
        HermesBuiltin.arraySpread(found1.map((perk, index) => ({ kind: "perk", perk, start: 0 === index, end: index === mapped.length - 1 })), arraySpreadResult3 + 1);
      }
      return items6;
    } else {
      const items7 = [obj33];
