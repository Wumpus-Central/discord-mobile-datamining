...
import _modDef5417 from "../emoji_terms/EmojiTerms.tsx";
import closure_3 from "../../../_runtime/metro/00032__slicedToArray.js";
import closure_4 from "../../../_runtime/00005_asyncGeneratorStep.js";
import closure_5 from "../experiments/ExperimentStore.tsx";
import closure_6 from "../guild_role_subscriptions/SubscriptionRoleStore.tsx";
...
import closure_10 from "../../stores/GuildMembershipStore.tsx";
...
import closure_15 from "RawGuildEmojiStore.tsx";
import closure_16 from "top_emojis/TopEmojiStore.tsx";
          ...
          if (arg0 === 1) {
            ...
            if (Loading === closure_1_29.Unloaded) {
              ...
              if (null != databaseResult) {
                ...
                obj1[0] = obj2.tryLoadOrResetCacheGatewayAsync("EmojiStore.loadSavedEmojis", () =>
                  callback(table[25]).timeAsync("\u{1F4BE}", "loadSavedEmojis", () =>
                    closure_1_1(closure_1_2[26]).getAsync(closure_0),
                  ),
                );
                return obj1;
              }
...
function handleUserSettingsProtoStoreChange() {
  ...
  importDefaultResult2.overwriteHistory(
    applyDefault.mapValues(emojis, (recentUses) => {
      obj = {};
  ...
  let tmp = closure_8;
  importDefaultResult3.overwriteHistory(
    applyDefault.mapValues(emojis1, (recentUses) => {
      obj = {};
      const merged = Object.assign(recentUses);
      recentUses = recentUses.recentUses;
      const mapped = recentUses.map(Number);
