// === Module 7834: buildPlatformedThemedEmojiColorPalette ===

// Module 7834 (buildPlatformedThemedEmojiColorPalette)
import set from "set" /* 2 */;
import hexToRgba from "hexToRgba" /* 4296 */;
import hslToRgbDefault from "hslToRgb" /* 4297 */;
import getURLDefault from "getURL" /* 7495 */;
  ...
  if (null != colors) {
    ...
    if (colors.length >= 1) {
      ...
      if (null != parseStringResult) {
        ...
        const colorLightnessAdjusted = tmp2(4296).getColorLightnessAdjusted(parseStringResult, 0.6, true);
        ...
        const colorLightnessAdjusted1 = tmp2(4296).getColorLightnessAdjusted(parseStringResult, 0.6, false);
        ...
        const accessibleForegroundColor2 = tmp2(4296).getAccessibleForegroundColor(obj1);
        ...
        const accessibleForegroundColor3 = tmp2(4296).getAccessibleForegroundColor(obj2);
        let hexResult;
        ...
        obj6[1] = tmp2(4296).getSaturatedColorHex(obj7);
