...
import { 03944__ } from "../../../_runtime/metro/03944__.js";
import { 13261__ } from "../../../_runtime/metro/13261__.js";
...
function findInlineEmojisFromSurrogates(content, arg1) {
      ...
      if (null != ``) {
        if ("" !== ``) {
          ...
          if (tmp3 === module_917631) {
            ...
            let tmp18 = 03944__.surrogateToEmoji[`${tmp3}`];
            let tmp19 = null;
            if (null != tmp18) {
            ...
            if (regex2.test(tmp3)) {
              ...
              let tmp12 = 03944__.surrogateToEmoji[str];
              let tmp13 = null;
              if (null != tmp12) {
  ...
  if (!tmp23) {
    ...
    const tmp26 = 03944__.surrogateToEmoji[str2];
    let tmp27 = null;
    if (null != tmp26) {
...
Object.defineProperty(prototype, "url", {
  get: function url() {
    ...
    if (null != defaultDiversityChild) {
      let uRL = getEmojiUnavailableReason.getURL(defaultDiversityChild.surrogates);
      const obj2 = getEmojiUnavailableReason;
    } else {
      uRL = getEmojiUnavailableReason.getURL(tmp.surrogates);
...
Object.defineProperty(prototype, "name", {
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != c4) {
        const tmp6 = 03944__.surrogateToEmoji[c4];
        let tmp7 = null;
        if (null != tmp6) {
...
prototype["forEachDiversity"] = function forEachDiversity(arg0) {
  if (null != this.diversityChildren) {
    apply.each(tmp.diversityChildren, arg0);
    const obj = apply;
  }
};
prototype["forEachName"] = function forEachName(arg0) {
  apply.each(this.names, arg0);
};
const map = new Map();
const re15 = /^(?:\uDB40[\uDC61-\uDC7A])$/;
let obj = {
  ...
  getCategories() {
    return Object.keys(03944__.emojisByCategory);
  },
  getByName(arg0) {
    const tmp3 = 03944__.nameToEmoji[arg0];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 03944__.emojis[tmp3];
    }
    let tmp5 = null;
    if (null != tmp4) {
  ...
  getByCategory(name) {
    ...
    if (null == value) {
      const tmp4 = 03944__.emojisByCategory[name];
      const emojis = 03944__.emojis;
      const result = getEmojiUnavailableReason.filterUnsupportedEmojis(emojis.slice(tmp4[0], tmp4[1]));
  ...
  convertNameToSurrogate(emojiName) {
    ...
    const tmp3 = 03944__.nameToEmoji[emojiName];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 03944__.emojis[tmp3];
    }
  ...
  convertSurrogateToName(name, arg1) {
    ...
    const tmp3 = 03944__.surrogateToEmoji[name];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 03944__.emojis[tmp3];
    }
  ...
  convertSurrogateToBase(surrogates) {
    ...
    const tmp4 = 03944__.surrogateToEmoji[reduced];
    let tmp5 = null;
    if (null != tmp4) {
    ...
    const tmp6 = 03944__.nameToEmoji[str];
    let tmp7 = null;
    if (null != tmp6) {
  ...
  hasSurrogates(tags) {
    const obj = apply;
    return apply.toArray(tags).some((arg0) => null != callback(table[1]).surrogateToEmoji[arg0]);
  }
};
