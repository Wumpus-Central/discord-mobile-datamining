...
import _mod14072 from "../../../_runtime/metro/14072__.js";
...
function findInlineEmojisFromSurrogates(text, arg1) {
      ...
      if (null != ``) {
        if ("" !== ``) {
          if (tmp3 === closure_13) {
            text = `${tmp3}`;
            let str3 = "";
            let tmp18 = require("../../../_runtime/metro/04291__.js").surrogateToEmoji[`${tmp3}`];
            let tmp19 = null;
            if (null != tmp18) {
              tmp19 = require("../../../_runtime/metro/04291__.js").emojis[tmp18];
            }
            let first;
            if (tmp19 != null) {
              first = tmp19.names[0];
            ...
            let tmp12 = require("../../../_runtime/metro/04291__.js").surrogateToEmoji[str];
            let tmp13 = null;
            if (null != tmp12) {
              tmp13 = require("../../../_runtime/metro/04291__.js").emojis[tmp12];
            }
            let first1;
            if (tmp13 != null) {
  ...
  if (!tmp23) {
    ...
    const tmp26 = require("../../../_runtime/metro/04291__.js").surrogateToEmoji[str2];
    let tmp27 = null;
    if (null != tmp26) {
      tmp27 = require("../../../_runtime/metro/04291__.js").emojis[tmp26];
    }
    let first2;
    if (tmp27 != null) {
...
Object.defineProperty(prototype, "name", {
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != global) {
        const tmp6 = require("../../../_runtime/metro/04291__.js").surrogateToEmoji[global];
        let tmp7 = null;
        if (null != tmp6) {
          tmp7 = require("../../../_runtime/metro/04291__.js").emojis[tmp6];
        }
        let first;
        if (tmp7 != null) {
          first = tmp7.names[0];
...
export default {
  ...
  getCategories() {
    return Object.keys(require("../../../_runtime/metro/04291__.js").emojisByCategory);
  },
  getByName(arg0) {
    const tmp3 = require("../../../_runtime/metro/04291__.js").nameToEmoji[arg0];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04291__.js").emojis[tmp3];
    }
    let tmp5 = null;
    if (null != tmp4) {
  ...
  getByCategory(name) {
    value = map.get(name);
    if (null == value) {
      const tmp4 = require("../../../_runtime/metro/04291__.js").emojisByCategory[name];
      const emojis = require("../../../_runtime/metro/04291__.js").emojis;
  ...
  translateInlineEmojiToSurrogates(emojiName) {
    return emojiName.replace(re7, (arg0, arg1) => {
      ...
      const tmp3 = require("../../../_runtime/metro/04291__.js").nameToEmoji[arg1];
      let tmp4 = null;
      if (null != tmp3) {
        tmp4 = require("../../../_runtime/metro/04291__.js").emojis[tmp3];
      }
  ...
  convertNameToSurrogate(emojiName) {
    ...
    const tmp3 = require("../../../_runtime/metro/04291__.js").nameToEmoji[emojiName];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04291__.js").emojis[tmp3];
    }
  ...
  convertSurrogateToName(name, arg1) {
    ...
    const tmp3 = require("../../../_runtime/metro/04291__.js").surrogateToEmoji[name];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04291__.js").emojis[tmp3];
    }
  ...
  convertSurrogateToBase(surrogates) {
    ...
    const tmp4 = require("../../../_runtime/metro/04291__.js").surrogateToEmoji[reduced];
    let tmp5 = null;
    if (null != tmp4) {
      tmp5 = require("../../../_runtime/metro/04291__.js").emojis[tmp4];
    }
    let str;
    if (tmp5 != null) {
      str = tmp5.names[0];
    ...
    const tmp6 = require("../../../_runtime/metro/04291__.js").nameToEmoji[str];
    let tmp7 = null;
    if (null != tmp6) {
      tmp7 = require("../../../_runtime/metro/04291__.js").emojis[tmp6];
    }
  ...
  hasSurrogates(match) {
    return _modDef12
      .toArray(match)
      .some((item) => null != require("../../../_runtime/metro/04291__.js").surrogateToEmoji[item]);
  },
};
