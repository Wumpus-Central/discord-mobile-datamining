...
import { 03898__ } from "../../../_runtime/metro/03898__.js";
import { 13210__ } from "../../../_runtime/metro/13210__.js";
...
function findInlineEmojisFromSurrogates(content, arg1) {
      ...
      if (null != ``) {
        if ("" !== ``) {
          ...
          if (tmp3 === module_917631) {
            ...
            let tmp18 = 03898__.surrogateToEmoji[`${tmp3}`];
            let tmp19 = null;
            if (null != tmp18) {
            ...
            if (regex2.test(tmp3)) {
              ...
              let tmp12 = 03898__.surrogateToEmoji[str];
              let tmp13 = null;
              if (null != tmp12) {
  ...
  if (!tmp23) {
    ...
    const tmp26 = 03898__.surrogateToEmoji[str2];
    let tmp27 = null;
    if (null != tmp26) {
...
Object.defineProperty(prototype, "name", {
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != c4) {
        const tmp6 = 03898__.surrogateToEmoji[c4];
        let tmp7 = null;
        if (null != tmp6) {
...
let obj = {
  ...
  getCategories() {
    return Object.keys(03898__.emojisByCategory);
  },
  getByName(arg0) {
    const tmp3 = 03898__.nameToEmoji[arg0];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 03898__.emojis[tmp3];
    }
    let tmp5 = null;
    if (null != tmp4) {
  ...
  getByCategory(name) {
    ...
    if (null == value) {
      const tmp4 = 03898__.emojisByCategory[name];
      const emojis = 03898__.emojis;
  ...
  convertNameToSurrogate(emojiName) {
    ...
    const tmp3 = 03898__.nameToEmoji[emojiName];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 03898__.emojis[tmp3];
    }
  ...
  convertSurrogateToName(name, arg1) {
    ...
    const tmp3 = 03898__.surrogateToEmoji[name];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 03898__.emojis[tmp3];
    }
  ...
  convertSurrogateToBase(surrogates) {
    ...
    const tmp4 = 03898__.surrogateToEmoji[reduced];
    let tmp5 = null;
    if (null != tmp4) {
    ...
    const tmp6 = 03898__.nameToEmoji[str];
    let tmp7 = null;
    if (null != tmp6) {
