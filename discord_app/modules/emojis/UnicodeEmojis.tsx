...
import _mod13537 from "../../../_runtime/metro/13537__.js";
...
function findInlineEmojisFromSurrogates(content, arg1) {
      ...
      if (null != ``) {
        if ("" !== ``) {
          ...
          if (tmp3 === closure_13) {
            ...
            let tmp18 = require("../../../_runtime/metro/04040__.js").surrogateToEmoji[`${tmp3}`];
            let tmp19 = null;
            if (null != tmp18) {
            ...
            if (regex2.test(tmp3)) {
              ...
              let tmp12 = require("../../../_runtime/metro/04040__.js").surrogateToEmoji[str];
              let tmp13 = null;
              if (null != tmp12) {
  ...
  if (!tmp23) {
    ...
    const tmp26 = require("../../../_runtime/metro/04040__.js").surrogateToEmoji[str2];
    let tmp27 = null;
    if (null != tmp26) {
  ...
  constructor(arg0) {
    ...
    if (null != global.diversityChildren) {
      ...
      while (tmp15 !== undefined) {
        tmp5 = closure_0;
        tmp6 = closure_2;
        tmp7 = require("../../../_runtime/metro/04040__.js").emojis[tmp3];
        tmp8 = tmp7;
...
Object.defineProperty(prototype, "name", {
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != c4) {
        const tmp6 = require("../../../_runtime/metro/04040__.js").surrogateToEmoji[c4];
        let tmp7 = null;
        if (null != tmp6) {
...
let obj = {
  ...
  getCategories() {
    return Object.keys(require("../../../_runtime/metro/04040__.js").emojisByCategory);
  },
  getByName(arg0) {
    const tmp3 = require("../../../_runtime/metro/04040__.js").nameToEmoji[arg0];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04040__.js").emojis[tmp3];
    }
    let tmp5 = null;
    if (null != tmp4) {
  ...
  getByCategory(name) {
    ...
    if (null == value) {
      const tmp4 = require("../../../_runtime/metro/04040__.js").emojisByCategory[name];
      const emojis = require("../../../_runtime/metro/04040__.js").emojis;
  ...
  convertNameToSurrogate(emojiName) {
    ...
    const tmp3 = require("../../../_runtime/metro/04040__.js").nameToEmoji[emojiName];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04040__.js").emojis[tmp3];
    }
  ...
  convertSurrogateToName(name, arg1) {
    ...
    const tmp3 = require("../../../_runtime/metro/04040__.js").surrogateToEmoji[name];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04040__.js").emojis[tmp3];
    }
  ...
  convertSurrogateToBase(surrogates) {
    ...
    const tmp4 = require("../../../_runtime/metro/04040__.js").surrogateToEmoji[reduced];
    let tmp5 = null;
    if (null != tmp4) {
    ...
    const tmp6 = require("../../../_runtime/metro/04040__.js").nameToEmoji[str];
    let tmp7 = null;
    if (null != tmp6) {
  ...
  numDiversitySprites: require("../../../_runtime/metro/04040__.js").numDiversitySprites,
  numNonDiversitySprites: require("../../../_runtime/metro/04040__.js").numNonDiversitySprites,
