...
function parseRawEmojiObject(item10011) {
  const value = weakMap.get(item10011);
  if (null != value) {
    return value;
  } else {
...
function findInlineEmojisFromSurrogates(c2, arg1) {
  if (true !== arg1) {
    if (!regex.test(dependencyMap)) {
  ...
  let match = dependencyMap.match(closure_9);
  if (match == null) {
    match = [];
  }
  const items1 = [];
      ...
      if (null != ``) {
        if ("" !== ``) {
          if (tmp3 === closure_13) {
            let text = `${tmp3}`;
            let str3 = "";
            let tmp18 = require("../../../_runtime/metro/04036__.js").surrogateToEmoji[`${tmp3}`];
            let tmp19 = null;
            if (null != tmp18) {
              tmp19 = require("../../../_runtime/metro/04036__.js").emojis[tmp18];
            }
            let first;
            if (tmp19 != null) {
              first = tmp19.names[0];
            ...
            sum = str3;
          } else if (regex2.test(tmp3)) {
            sum = str + tmp3;
          } else {
            let tmp12 = require("../../../_runtime/metro/04036__.js").surrogateToEmoji[str];
            let tmp13 = null;
            if (null != tmp12) {
              tmp13 = require("../../../_runtime/metro/04036__.js").emojis[tmp12];
            }
            let first1;
            if (tmp13 != null) {
  ...
  if (!tmp23) {
    ...
    const tmp26 = require("../../../_runtime/metro/04036__.js").surrogateToEmoji[str2];
    let tmp27 = null;
    if (null != tmp26) {
      tmp27 = require("../../../_runtime/metro/04036__.js").emojis[tmp26];
    }
    let first2;
    if (tmp27 != null) {
  ...
  constructor(arg0) {
    ...
    if (null != global.diversityChildren) {
      ...
      while (tmp15 !== undefined) {
        tmp5 = closure_0;
        tmp6 = closure_2;
        tmp7 = require("../../../_runtime/metro/04036__.js").emojis[tmp3];
        tmp8 = tmp7;
...
Object.defineProperty(prototype, "names", {
  get: function names(dependencyMap) {
...
Object.defineProperty(prototype, "url", {
  get: function url() {
    ...
    if (null != defaultDiversityChild) {
      let uRL = require("../../utils/EmojiUtils.tsx").getURL(defaultDiversityChild.surrogates);
      const obj2 = getEmojiUnavailableReason;
    } else {
      uRL = require("../../utils/EmojiUtils.tsx").getURL(tmp.surrogates);
      const obj = getEmojiUnavailableReason;
    }
    return uRL;
  },
  set: undefined
...
Object.defineProperty(prototype, "name", {
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != c4) {
        const tmp6 = require("../../../_runtime/metro/04036__.js").surrogateToEmoji[c4];
        let tmp7 = null;
        if (null != tmp6) {
          tmp7 = require("../../../_runtime/metro/04036__.js").emojis[tmp6];
        }
        let first;
        if (tmp7 != null) {
          first = tmp7.names[0];
...
let obj = {
  ...
  getCategories() {
    return Object.keys(require("../../../_runtime/metro/04036__.js").emojisByCategory);
  },
  getByName(arg0) {
    const tmp3 = require("../../../_runtime/metro/04036__.js").nameToEmoji[arg0];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04036__.js").emojis[tmp3];
    }
    let tmp5 = null;
    if (null != tmp4) {
  ...
  getByCategory(name) {
    ...
    if (null == value) {
      const tmp4 = require("../../../_runtime/metro/04036__.js").emojisByCategory[name];
      const emojis = require("../../../_runtime/metro/04036__.js").emojis;
      const result = require("../../utils/EmojiUtils.tsx").filterUnsupportedEmojis(emojis.slice(tmp4[0], tmp4[1]));
  ...
  maybeTranslateSurrogatesToInlineEmoji(c2) {
    if (regex.test(c2)) {
      const mapped = findInlineEmojisFromSurrogates(c2, true).map((item, index) => "text" === item.type ? item.text : item.emojiName);
  ...
  translateSurrogatesToInlineEmoji(c2) {
    const mapped = findInlineEmojisFromSurrogates(c2).map((item, index) => "text" === item.type ? item.text : item.emojiName);
    return mapped.join("");
  },
  convertNameToSurrogate(emojiName) {
    ...
    const tmp3 = require("../../../_runtime/metro/04036__.js").nameToEmoji[emojiName];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04036__.js").emojis[tmp3];
    }
  ...
  convertSurrogateToName(name, arg1) {
    ...
    const tmp3 = require("../../../_runtime/metro/04036__.js").surrogateToEmoji[name];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = require("../../../_runtime/metro/04036__.js").emojis[tmp3];
    }
  ...
  convertSurrogateToBase(surrogates) {
    const reduced = items.reduce((acc, item, index) => acc.replace(item, ""), surrogates);
    const tmp4 = require("../../../_runtime/metro/04036__.js").surrogateToEmoji[reduced];
    let tmp5 = null;
    if (null != tmp4) {
      tmp5 = require("../../../_runtime/metro/04036__.js").emojis[tmp4];
    }
    let str;
    if (tmp5 != null) {
      str = tmp5.names[0];
    ...
    const tmp6 = require("../../../_runtime/metro/04036__.js").nameToEmoji[str];
    let tmp7 = null;
    if (null != tmp6) {
      tmp7 = require("../../../_runtime/metro/04036__.js").emojis[tmp6];
    }
  ...
  numDiversitySprites: require("../../../_runtime/metro/04036__.js").numDiversitySprites,
  numNonDiversitySprites: require("../../../_runtime/metro/04036__.js").numNonDiversitySprites,
  ...
  hasSurrogates(match) {
    return applyDefault.toArray(match).some((item, index) => null != callback(table[1]).surrogateToEmoji[item]);
  }
};
let result = require("obj132").fileFinishedImporting("modules/emojis/UnicodeEmojis.tsx");
