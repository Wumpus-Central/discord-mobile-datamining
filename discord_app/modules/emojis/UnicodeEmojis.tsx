...
import { 13399__ } from "../../../_runtime/metro/13399__.js";
...
function findInlineEmojisFromSurrogates(content, arg1) {
      ...
      if (null != ``) {
        if ("" !== ``) {
          ...
          if (tmp3 === module_917631) {
            ...
            let tmp18 = 04004__.surrogateToEmoji[`${tmp3}`];
            let tmp19 = null;
            if (null != tmp18) {
            ...
            if (regex2.test(tmp3)) {
              ...
              let tmp12 = 04004__.surrogateToEmoji[str];
              let tmp13 = null;
              if (null != tmp12) {
  ...
  if (!tmp23) {
    ...
    const tmp26 = 04004__.surrogateToEmoji[str2];
    let tmp27 = null;
    if (null != tmp26) {
...
Object.defineProperty(prototype, "name", {
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != c4) {
        const tmp6 = 04004__.surrogateToEmoji[c4];
        let tmp7 = null;
        if (null != tmp6) {
...
let obj = {
  ...
  getCategories() {
    return Object.keys(04004__.emojisByCategory);
  },
  getByName(arg0) {
    const tmp3 = 04004__.nameToEmoji[arg0];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 04004__.emojis[tmp3];
    }
    let tmp5 = null;
    if (null != tmp4) {
  ...
  getByCategory(name) {
    ...
    if (null == value) {
      const tmp4 = 04004__.emojisByCategory[name];
      const emojis = 04004__.emojis;
  ...
  convertNameToSurrogate(emojiName) {
    ...
    const tmp3 = 04004__.nameToEmoji[emojiName];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 04004__.emojis[tmp3];
    }
  ...
  convertSurrogateToName(name, arg1) {
    ...
    const tmp3 = 04004__.surrogateToEmoji[name];
    let tmp4 = null;
    if (null != tmp3) {
      tmp4 = 04004__.emojis[tmp3];
    }
  ...
  convertSurrogateToBase(surrogates) {
    ...
    const tmp4 = 04004__.surrogateToEmoji[reduced];
    let tmp5 = null;
    if (null != tmp4) {
    ...
    const tmp6 = 04004__.nameToEmoji[str];
    let tmp7 = null;
    if (null != tmp6) {
