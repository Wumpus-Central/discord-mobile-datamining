...
function findInlineEmojisFromSurrogates(text, arg1) {
      ...
      if (null != ``) {
        if ("" !== ``) {
          if (tmp3 === closure_13) {
            ...
            let tmp19 = null;
            if (null != tmp18) {
              tmp19 = require("module_4292").emojis[tmp18];
            }
            let first;
            if (tmp19 != null) {
              first = tmp19.names[0];
            ...
            let tmp13 = null;
            if (null != tmp12) {
              tmp13 = require("module_4292").emojis[tmp12];
            }
            let first1;
            if (tmp13 != null) {
  ...
  if (!tmp23) {
    ...
    let tmp27 = null;
    if (null != tmp26) {
      tmp27 = require("module_4292").emojis[tmp26];
    }
    let first2;
    if (tmp27 != null) {
  ...
  get: function name() {
    ...
    if (this.hasDiversity) {
      if (null != global) {
        ...
        let tmp7 = null;
        if (null != tmp6) {
          tmp7 = require("module_4292").emojis[tmp6];
        }
        let first;
        if (tmp7 != null) {
          first = tmp7.names[0];
...
export default {
  ...
  convertSurrogateToBase(surrogates) {
    ...
    let tmp5 = null;
    if (null != tmp4) {
      tmp5 = require("module_4292").emojis[tmp4];
    }
    let str;
    if (tmp5 != null) {
      str = tmp5.names[0];
