...
import _modDef9112 from "../../media_viewer/native/components/overlay/MediaViewerOverlayButton.tsx";
...
export default function SharePreparingModal(onCancel) {
  ...
  const items1 = [callback(onCancel(4728).Backdrop, { blur: "none", "aria-hidden": true }), , , ];
  ...
  obj1[1] = callback(onCancel(6399).XSmallIcon, { size: "md", color: "interactive-text-active" });
  obj1[2] = onCancel;
  obj[1] = callback(_modDef9112, obj1);
  obj[2] = callback(onCancel(9111).MediaModalOverlayHeaderWrapper, obj);
  items1[1] = callback(closure_4, obj);
  items1[2] = callback(onCancel(5451).ActivityIndicator, {});
  ...
  items1[3] = callback(onCancel(4739).Text, obj2);
  obj[1] = items1;
