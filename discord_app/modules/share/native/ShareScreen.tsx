...
export default function ShareScreen(sharedContent) {
      ...
      if (React === 2) {
        ...
        try {
          ...
          if (0 === closure_4) {
            ...
            lib(closure_2[22]).transitionToChannel(closure_4, {
  ...
  obj1[1] = function headerTitle(title) {
    ...
    return closure_1_16(sharedContent(first[30]).GenericHeaderTitle, {
  ...
  let obj2 = {
    ...
    initialSelectedDestinations: first,
