...
export default function AppShare(targetUserId) {
  ...
  const effect2 = obj.useEffect(() => {
    if (stateFromStores) {
      first(5827).startSession(outer1_7.getToken());
      const obj = first(5827);
      if (obj2.isAndroid()) {
  ...
  if (first) {
    ...
    obj1[0] = tmp18;
    items5[1] = tmp19(tmp9(15972).ActionSheetContainer, obj1);
    items5[2] = tmp19(tmp14(16020), {});
