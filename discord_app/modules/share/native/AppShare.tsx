...
export default function AppShare(targetUserId) {
  ...
  if (first) {
    ...
    const items5 = [closure_10(tmp9(7235).SceneLoadingIndicator, {}), , ,];
    const obj5 = { appEntryKey: share };
    items5[1] = closure_10(tmp9(17289).ActionSheetContainer, obj5);
    items5[2] = closure_10(ToastContainerDefault, {});
    items5[3] = closure_10(tmp9(5072).AlertModalContainer, {});
