...
export default function SearchableDestinationList(getRowIsUnavailable) {
  ...
  const shareSearchResults = obj1.useShareSearchResults({ selectedDestinations, originDestination, channelFilter, includeMissingDMs: true });
  ...
  const callback5 = obj.useCallback((arg0, arg1) => {
    ...
    if (type !== sortByMatchScore.AutocompleterResultTypes.HEADER) {
      ...
      let obj = { disabled: tmp11, selected: hasItem, mode: null, subLabel: null, subLabelLineClamp: null, start: null, end: null };
      if (null != tmp6) {
  ...
  if (someResult) {
    obj = { ref: ref1, sections: memo, getItemProps: callback5, getSectionProps: callback1, getItemSize: null, insetStart: null, insetEnd: null, disableStickySections: null };
    let tmp36;
