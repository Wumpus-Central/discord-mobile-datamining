...
export const RootThemeContextProvider = function RootThemeContextProvider(children) {
  ...
  manaTypeConsolidationExperiment =
    manaTypeConsolidationExperiment(7053).useManaTypeConsolidationExperiment("RootThemeContextProvider");
  ...
  if (null == tmp4) {
    ...
    if (1 === contrast) {
      ...
      obj.children = jsx(tmp(4611).PlainTextExperimentProvider, {
    ...
    let setThemeFlagResult1 = tmp(4317).setThemeFlag(
      0,
      tmp(4317).ThemeContextFlags.MOBILE_LIGHT_GRADIENT_THEME_ENABLED,
    );
