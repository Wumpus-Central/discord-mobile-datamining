...
export const RootThemeContextProvider = function RootThemeContextProvider(children) {
  ...
  manaTypeConsolidationExperiment =
    manaTypeConsolidationExperiment(7087).useManaTypeConsolidationExperiment("RootThemeContextProvider");
  ...
  if (null == tmp4) {
    ...
    if (1 === contrast) {
      ...
      obj4.children = jsx(tmp(4644).PlainTextExperimentProvider, {
        enabled: plainTextExperiment,
        children: children.children,
      });
      return jsx(tmp(10206).RootThemeContextProvider, {
        theme: stateFromStoresObject.theme,
        flags: num2,
        saturation,
        contrast,
  ...
  const obj3 = manaTypeConsolidationExperiment(14669);
};
