...
let items = [
  ...
  DisplayNameEffect.DisplayNameEffect.GRADIENT,
  DisplayNameEffect.DisplayNameEffect.NEON,
  DisplayNameEffect.DisplayNameEffect.TOON,
  DisplayNameEffect.DisplayNameEffect.POP,
];
const items1 = [
  DisplayNameFont.DisplayNameFont.PLAYPEN_SANS,
  DisplayNameFont.DisplayNameFont.ORBITRON,
  DisplayNameFont.DisplayNameFont.NEW_ROCKER,
...
const items5 = [
  [15313365, 11132400, 12167150, 12184267],
  [16740290, 16076712, 16751574, 14248631],
  [16758138, 16749423, 16743544, 15756170],
  [12905829, 10018400, 7130467, 4570214],
  [8173823, 9363664, 10327285, 6737904],
  [14121983, 11889663, 14965989, 9137407],
];
const items6 = [
