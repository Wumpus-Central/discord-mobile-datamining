...
require = arg1;
({
  DISPLAY_NAME_STYLES_GUMMY_HUE_LIGHTNESS: c4,
  DISPLAY_NAME_STYLES_GUMMY_HUE_SATURATION: c5,
  FLYWHEEL_EFFECTS: closure_6,
  FLYWHEEL_FONTS: error,
  getColorPresetsForEffect: closure_8,
} = items3);
let items = [
  require("DisplayNameEffect").DisplayNameEffect.NEON,
  require("DisplayNameEffect").DisplayNameEffect.TOON,
  require("DisplayNameEffect").DisplayNameEffect.POP,
...
export const buildGummyColors = function buildGummyColors(closure_1_11) {
  ...
  let obj = int2hslRaw;
  const tmp3 = callback(
    tmp(require("../../../discord_common/js/shared/utils/ColorUtils.tsx").int2hex(closure_1_11)).hsl(),
    3,
  );
  const first = tmp3[0];
  let num = 0;
  ...
  return items1.map((arg0) => {
    ...
    return closure_1_1(closure_1_2[3])
      .hsl((((closure_0 + hueShift) % 360) + 360) % 360, saturation, lightness)
      .num();
  });
};
...
export const generateRandomDisplayNameStyles = function generateRandomDisplayNameStyles(
  visibleFontOrder,
  visibleEffectOrder,
) {
...
export const hasNonLatinLetters = function hasNonLatinLetters(displayName) {
  if (null == displayName) {
    ...
    return /(?:[\0-@\[-`\{-\xA9\xAB-\xB9\xBB-\xBF\xD7\xF7\u02B9-\u02DF\u02E5-\u1CFF\u1D26-\u1D2B\u1D5D-\u1D61\u1D66-\u1D6A\u1D78\u1DBF-\u1DFF\u1F00-\u2070\u2072-\u207E\u2080-\u208F\u209D-\u2129\u212C-\u2131\u2133-\u214D\u214F-\u215F\u2189-\u2C5F\u2C80-\uA721\uA788-\uA78A\uA7CE\uA7CF\uA7D2\uA7D4\uA7DD-\uA7F1\uA800-\uAB2F\uAB5B\uAB65\uAB6A-\uD7FF\uE000-\uFAFF\uFB07-\uFF20\uFF3B-\uFF40\uFF5B-\uFFFF]|[\uD800\uD802-\uD836\uD838-\uDBFF][\uDC00-\uDFFF]|\uD801[\uDC00-\uDF7F\uDF86\uDFB1\uDFBB-\uDFFF]|\uD837[\uDC00-\uDEFF\uDF1F-\uDF24\uDF2B-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/.test(
      displayName.replace(
