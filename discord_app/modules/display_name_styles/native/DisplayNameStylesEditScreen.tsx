...
function ApplyButton(onPress) {
  ...
  obj = { visible, tokens: visible(stateFromStores[10]), reducedMotion: stateFromStores, withSpring: onPress(stateFromStores[54]).withSpring, MEDIA_PICKER_SEND_BUTTON_SPRING };
  fn2.__closure = obj;
...
fn(4605);
let createStyles = { container: null, contentContainer: null, fieldButtonGroup: null, fieldButton: null, fieldButtonBorder: null, fieldButtonLabel: null, fieldButtonChevron: null, fieldButtonTrailing: null, buttonContainer: null };
...
createStyles.fieldButtonGroup = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_MUTED, borderRadius: nativeDefault.radii.md };
let obj2 = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_MUTED, borderRadius: nativeDefault.radii.md };
createStyles.fieldButton = { padding: nativeDefault.space.PX_12, flexDirection: "row", alignItems: "center", justifyContent: "space-between" };
let obj3 = { padding: nativeDefault.space.PX_12, flexDirection: "row", alignItems: "center", justifyContent: "space-between" };
...
createStyles.buttonContainer = { marginVertical: nativeDefault.space.PX_16, paddingVertical: nativeDefault.space.PX_16, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, borderTopWidth: 1, borderTopColor: nativeDefault.colors.BORDER_MUTED, gap: nativeDefault.space.PX_16 };
...
export default function DisplayNameStylesEditScreen() {
  ...
  if (colors.length > 0) {
    ...
    const tmp16Result1 = tmp16(obj7.useState(() => Object.fromEntries(items.map((item) => {
      items = [item, ];
      let tmp = length;
      if (length.length <= 0) {
    ...
    const callback4 = obj7.useCallback(() => {
      ...
      obj.openLazy(asyncRequireImpl(15423, dependencyMap.paths), "DisplayNameStylesFontPickerSheet", obj);
    }, items6);
    if (stateFromStores != null) {
    ...
    const callback5 = obj7.useCallback(() => {
      ...
      obj.openLazy(asyncRequireImpl(15424, dependencyMap.paths), "DisplayNameStylesEffectPickerSheet", obj);
      const tmp3 = asyncRequireImpl(15424, dependencyMap.paths);
    }, items7);
    const callback6 = obj7.useCallback(() => {
      if (first1 === DisplayNameEffect.DisplayNameEffect.GUMMY) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15425, dependencyMap.paths), "DisplayNameStylesGummyColorPickerSheet", obj);
      } else {
        ...
        if (closure_10) {
          ...
          openLazy(tmp2Result(15430, dependencyMap.paths), "DisplayNameStylesGradientPickerSheet", obj);
        } else {
          obj = { selectedColor: first3, selectedEffectId: first1, onSelectColor };
          openLazy(tmp2Result(15433, dependencyMap.paths), "DisplayNameStylesColorPickerSheet", obj);
        }
      }
    }, items8);
    ...
    if (null != stateFromStores) {
      ...
      const obj6 = { user: stateFromStores, displayName: displayNameStylesPendingName, guildId, selectedFontId, selectedEffectId: first1, selectedColors: memo };
      const items9 = [closure_12(tmp9(tmp3[42]), obj6), , ];
      obj7 = { style: tmp.fieldButtonGroup, children: null };
      const obj8 = { onPress: callback4, style: tmp.fieldButton, accessibilityRole: "button", accessibilityLabel: null, children: null };
      ...
      const obj13 = { onPress: callback5, style: null, accessibilityRole: "button", accessibilityLabel: null, children: null };
      const items14 = [, ];
      ...
      const obj18 = { onPress: callback6, style: null, accessibilityRole: "button", accessibilityLabel: null, children: null };
      const items18 = [, ];
