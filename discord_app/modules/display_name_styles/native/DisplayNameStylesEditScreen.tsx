...
export default function DisplayNameStylesEditScreen() {
  ...
  if (colors.length > 0) {
    ...
    const callback4 = obj7.useCallback(() => {
      ...
      obj.openLazy(asyncRequireImpl(15374, dependencyMap.paths), "DisplayNameStylesFontPickerSheet", obj);
    }, items6);
    if (stateFromStores != null) {
    ...
    const callback5 = obj7.useCallback(() => {
      ...
      obj.openLazy(asyncRequireImpl(15375, dependencyMap.paths), "DisplayNameStylesEffectPickerSheet", obj);
      const tmp3 = asyncRequireImpl(15375, dependencyMap.paths);
    }, items7);
    const callback6 = obj7.useCallback(() => {
      if (first1 === DisplayNameEffect.DisplayNameEffect.GUMMY) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15376, dependencyMap.paths), "DisplayNameStylesGummyColorPickerSheet", obj);
      } else {
        ...
        if (closure_10) {
          ...
          openLazy(tmp2Result(15381, dependencyMap.paths), "DisplayNameStylesGradientPickerSheet", obj);
        } else {
          obj = { selectedColor: first3, selectedEffectId: first1, onSelectColor };
          openLazy(tmp2Result(15384, dependencyMap.paths), "DisplayNameStylesColorPickerSheet", obj);
        }
      }
    }, items8);
