...
function ChatPreview(arg0) {
  ...
  obj2[4] = require("../types.tsx") /* DisplayNameStyleColorPreset */.EffectDisplayType.PLAIN;
  obj2[6] = displayNameStyles;
  obj2[7] = tmp.chatUsername;
  const items1 = [callback(require("UsernameWithEffects.tsx"), obj2), callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-xs/medium", color: "text-muted", style: tmp.chatTimestamp, children: memo })];
  obj1[1] = items1;
  ...
  obj4[3] = intl.string(require("../intl/DisplayNameStyles.messages.js").h5Cuej);
