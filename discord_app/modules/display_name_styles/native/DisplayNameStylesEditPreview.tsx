...
function ChatPreview(arg0) {
  ...
  obj2[4] = DisplayNameStyleColorPreset.EffectDisplayType.PLAIN;
  obj2[6] = displayNameStyles;
  obj2[7] = tmp.chatUsername;
  const items1 = [callback(AVERAGE_FONT_WIDTH_RATIO, obj2), callback(Text.Text, { variant: "text-xs/medium", color: "text-muted", style: tmp.chatTimestamp, children: memo })];
  obj1[1] = items1;
