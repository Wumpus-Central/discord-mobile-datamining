...
function ChatPreview(arg0) {
  ...
  let obj = { user, size: Button.AvatarSizes.NORMAL, guildId };
...
const createCacheKey = { marginBottom: ThemesDefault.space.PX_24, alignItems: "center", alignSelf: "center", width: "100%", maxWidth: 360 };
...
const result = require("obj132").fileFinishedImporting("modules/display_name_styles/native/DisplayNameStylesEditPreview.tsx");
