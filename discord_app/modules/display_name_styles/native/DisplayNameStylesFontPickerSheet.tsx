...
export default function DisplayNameStylesFontPickerSheet(displayName) {
  ...
  obj3[1] = callback;
  obj2[1] = callback2(onSelectFont(4714).Button, obj3);
  obj1[1] = callback2(closure_5, obj2);
  obj[1] = callback2(onSelectFont(5396).BottomSheetTitleHeader, obj1);
  ...
  let items1 = [callback2(onSelectFont(4712).Stack, obj6), ];
  if (tmp14Result) {
  ...
  if (tmp14Result) {
    ...
    let items2 = [tmp11(tmp2(4259).CircleInformationIcon, { size: "sm" }), ];
    ...
    items2[1] = tmp11(tmp2(4299).Text, obj8);
    obj7[1] = items2;
  ...
  return callback2(onSelectFont(5397).BottomSheet, obj);
};