...
export default function DisplayNameStylesFontPickerSheet(displayName) {
  ...
  importDefault = tmp;
  let obj = onSelectFont(7325);
  let obj1 = onSelectFont(14472);
  const visibleFontOrder = obj1.useVisibleFontOrder();
  let obj2 = onSelectFont(14474);
  ...
  obj3[1] = callback;
  obj2[1] = callback2(onSelectFont(4695).Button, obj3);
  obj1[1] = callback2(closure_5, obj2);
  obj[1] = callback2(onSelectFont(5337).BottomSheetTitleHeader, obj1);
  ...
  let items1 = [callback2(onSelectFont(4693).Stack, obj6), ];
  if (tmp14Result) {
  ...
  if (tmp14Result) {
    ...
    let items2 = [tmp11(tmp2(4241).CircleInformationIcon, { size: "sm" }), ];
  ...
  return callback2(onSelectFont(5338).BottomSheet, obj);
};