// === Module 14863: DisplayNameStylesFontPickerSheet ===
...
import DisplayNameStylesSheetHeaderDefault from "DisplayNameStylesSheetHeader" /* 14864 */;
...
export default function DisplayNameStylesFontPickerSheet(displayName) {
  ...
  if (tmp15Result) {
    ...
    let items2 = [closure_8(onSelectFont(4783).CircleInformationIcon, { size: "sm" }), ];
    ...
    items2[1] = closure_8(onSelectFont(4825).Text, obj12);
