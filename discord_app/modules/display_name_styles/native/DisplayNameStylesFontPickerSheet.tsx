// === Module 14860: DisplayNameStylesFontPickerSheet ===
...
export default function DisplayNameStylesFontPickerSheet(displayName) {
  ...
  let tmp = callback3();
  importDefault = tmp;
  let obj = onSelectFont(7613);
  obj1 = onSelectFont(14855);
  const visibleFontOrder = obj1.useVisibleFontOrder();
  let obj2 = onSelectFont(14857);
  ...
  obj3[1] = callback;
  obj2[1] = callback2(onSelectFont(4879).Button, obj3);
  obj1[1] = callback2(closure_5, obj2);
  obj[1] = callback2(onSelectFont(5568).BottomSheetTitleHeader, obj1);
  ...
  let items1 = [
    callback2(onSelectFont(4877).Stack, {
  ...
  if (tmp14Result) {
    ...
    let items2 = [tmp11(tmp2(4399).CircleInformationIcon, { size: "sm" }), ];
    ...
    items2[1] = tmp11(tmp2(4440).Text, obj8);
    obj7[1] = items2;
  ...
  return callback2(onSelectFont(5569).BottomSheet, obj);
};