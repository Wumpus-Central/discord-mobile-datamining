// === Module 15631: DisplayNameStylesGummyCustomColorSheet ===
...
export default function DisplayNameStylesGummyCustomColorSheet(onSelect) {
  ...
  const callback = noop.useCallback(() => {
    const result = onSelect(4725).triggerHapticFeedback(onSelect(4725).HapticFeedbackTypes.IMPACT_LIGHT);
  }, []);
  ...
  obj5.trailing = closure_7(onSelect(5187).Button, obj6);
  obj4.header = closure_7(sharedValue(15626), obj5);
  const obj7 = { style: tmp.body, children: null };
  const obj8 = { style: tmp.previewWrapper, children: null };
  const tmp5 = sharedValue(15626);
  obj8.children = closure_7(View, { style: tmp.preview, children: closure_7(sharedValue(15632), { hue: sharedValue }) });
  const items1 = [closure_7(View, obj8), ];
  const obj10 = { style: tmp.huePickerInset, children: closure_7(sharedValue(14883), { hue: sharedValue, onPanFinalize: callback, saturation, lightness, fullWidth: true }) };
  items1[1] = closure_7(View, obj10);
  obj7.children = items1;
  obj4.children = closure_8(View, obj7);
  return closure_7(onSelect(7397).BottomSheet, obj4);
};