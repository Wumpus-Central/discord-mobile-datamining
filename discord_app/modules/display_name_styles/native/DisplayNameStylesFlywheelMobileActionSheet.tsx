...
export default function DisplayNameStylesFlywheelMobileActionSheet(markAsDismissed) {
  ...
  const typeConsolidationTextTransform =
    markAsDismissed(7093).useTypeConsolidationTextTransform("DisplayNameStylesFlywheel");
      ...
      () => {
        markAsDismissed(7152).runAfterInteractions(() => {
          markAsDismissed(7496).openUserSettings({ screen: constants.DISPLAY_NAME_STYLES }, () => {
            ...
            const result = closure_2_0(4460).UNSAFE_markDismissibleContentAsDismissed(
  ...
  if (enabled) {
    tmp15Result = closure_9(tmp2(5780).DisplayNameStylesV2AbstractUI, { resizeMode: "contain" });
  }
  ...
  if (enabled) {
    ...
    items4[2] = closure_9(tmp2(4636).Text, obj10);
    ...
    items4[3] = closure_9(tmp2(4636).Text, obj11);
    ...
    const items7 = [closure_9(tmp2(5062).Button, obj14)];
    ...
    items7[1] = closure_9(tmp2(5062).Button, obj15);
    obj13.children = items7;
    items4[4] = closure_10(View, obj13);
    obj7.children = items4;
    obj12.children = closure_10(View, obj7);
    obj6.children = closure_9(tmp2(7237).SafeAreaPaddingView, obj12);
    return closure_9(tmp2(7264).BottomSheet, obj6);
  } else {
    if (tmp2Result.isIOS()) {
      ...
      let tmp15Result2 = closure_9(tmp4(5675), obj16);
      const tmp4Result = tmp4(5675);
    } else {
      const obj18 = { url: tmp4(17186), style: tmp6.image, autoplay: true };
      tmp15Result2 = closure_9(tmp2(8965).APNGPlayer, obj18);
    }
