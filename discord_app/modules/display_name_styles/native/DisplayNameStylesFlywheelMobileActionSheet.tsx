...
export default function DisplayNameStylesFlywheelMobileActionSheet(markAsDismissed) {
  ...
  const typeConsolidationTextTransform =
    markAsDismissed(7175).useTypeConsolidationTextTransform("DisplayNameStylesFlywheel");
      ...
      () => {
        markAsDismissed(7234).runAfterInteractions(() => {
          markAsDismissed(7578).openUserSettings({ screen: constants.DISPLAY_NAME_STYLES }, () => {
            ...
            const result = closure_2_0(4542).UNSAFE_markDismissibleContentAsDismissed(
              closure_2_0(1944).DismissibleContent.DISPLAY_NAME_STYLES_FLYWHEEL_MOBILE_PROFILE_COACHMARK,
  ...
  if (enabled) {
    tmp15Result = closure_9(tmp2(5862).DisplayNameStylesV2AbstractUI, { resizeMode: "contain" });
  }
  ...
  if (enabled) {
    ...
    items4[2] = closure_9(tmp2(4718).Text, obj10);
    ...
    items4[3] = closure_9(tmp2(4718).Text, obj11);
    ...
    const items7 = [closure_9(tmp2(5144).Button, obj14)];
    ...
    items7[1] = closure_9(tmp2(5144).Button, obj15);
    obj13.children = items7;
    items4[4] = closure_10(View, obj13);
    obj7.children = items4;
    obj12.children = closure_10(View, obj7);
    obj6.children = closure_9(tmp2(7319).SafeAreaPaddingView, obj12);
    return closure_9(tmp2(7346).BottomSheet, obj6);
  } else {
    if (tmp2Result.isIOS()) {
      ...
      let tmp15Result2 = closure_9(tmp4(5757), obj16);
      const tmp4Result = tmp4(5757);
    } else {
      const obj18 = { url: tmp4(17316), style: tmp6.image, autoplay: true };
      tmp15Result2 = closure_9(tmp2(9049).APNGPlayer, obj18);
    }
