...
export default function DisplayNameStylesGummyColorPickerSheet(selectedColors) {
  ...
  obj[0] = callback2(selectedColors(5376).BottomSheetTitleHeader, obj);
  ...
  if (findIndexResult >= 0) {
    ...
    obj7[0] = first1;
    tmp16Result = tmp16(onSelectColors(13841), obj7);
  }
  ...
  return callback2(selectedColors(5377).BottomSheet, obj);
};