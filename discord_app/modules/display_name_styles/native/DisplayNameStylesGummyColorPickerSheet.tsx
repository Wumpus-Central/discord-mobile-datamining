...
export default function DisplayNameStylesGummyColorPickerSheet(selectedColors) {
  ...
  const displayNameStylesEffectConfig = selectedColors(11251).useDisplayNameStylesEffectConfig(
  ...
  obj11.children = closure_9(closure_5, {
    ...
    children: closure_9(selectedColors(10598).PencilIcon, { color: "white", size: "sm" }),
  });
