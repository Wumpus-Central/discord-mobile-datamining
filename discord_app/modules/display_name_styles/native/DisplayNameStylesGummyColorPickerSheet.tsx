...
export default function DisplayNameStylesGummyColorPickerSheet(selectedColors) {
  ...
  const displayNameStylesEffectConfig = selectedColors(11162).useDisplayNameStylesEffectConfig(
  ...
  obj11.children = closure_9(closure_5, {
    ...
    children: closure_9(selectedColors(10507).PencilIcon, { color: "white", size: "sm" }),
  });
