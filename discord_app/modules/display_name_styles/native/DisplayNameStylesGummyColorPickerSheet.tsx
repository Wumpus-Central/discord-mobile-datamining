// === Module 15696: DisplayNameStylesGummyColorPickerSheet ===
...
import showGummyCustomColorSheetDefault from "showGummyCustomColorSheet" /* 15698 */;
...
export default function DisplayNameStylesGummyColorPickerSheet(selectedColors) {
  ...
  const displayNameStylesEffectConfig = selectedColors(11251).useDisplayNameStylesEffectConfig(selectedColors(1391).DisplayNameEffect.GUMMY);
  if (tmp5) {
  ...
  let obj = selectedColors(11251);
  const tmp11 = onSelectColors;
  const tmp12Result = onSelectColors(15697)(selectedColors(1391).DisplayNameEffect.GUMMY);
  ...
  const tmp12 = onSelectColors(15697);
  ...
  obj3.trailing = closure_9(selectedColors(5273).Button, obj4);
  obj2.header = closure_9(onSelectColors(15694), obj3);
  ...
  if (findIndexResult >= 0) {
    ...
    tmp18Result = tmp18(tmp11(14988), obj10);
  }
  const items4 = [tmp18Result, ];
  const obj11 = { style: tmp.customIconOverlay, pointerEvents: "none", children: null };
  const tmp19 = onSelectColors(15694);
  const tmp22 = first1;
  obj11.children = closure_9(closure_5, { style: tmp.customIconScrim, children: closure_9(selectedColors(10598).PencilIcon, { color: "white", size: "sm" }) });
  ...
  items6[1] = closure_9(selectedColors(5273).Button, obj13);
  obj5.children = items6;
  obj2.children = closure_10(closure_5, obj5);
  return closure_9(selectedColors(7483).BottomSheet, obj2);
};