...
({
  View: closure_4,
  processColor: hasOwnProperty,
  PixelRatio: metroRequire,
...
const dependencyMap = {
  [fn(1390).DisplayNameEffect.NEON]: 1,
  [fn(1390).DisplayNameEffect.TOON]: 1.6,
  [fn(1390).DisplayNameEffect.POP]: 1.2,
};
...
export default noop.memo((userName) => {
  ...
  let tmp7Result = tmp7(4275);
  const token = tmp7Result.useToken(tmp4(576).colors.BACKGROUND_BASE_LOW);
  tmp7Result = tmp7(4275);
  const token1 = tmp7Result.useToken(tmp4(576).colors.WHITE);
  const displayNameStylesAccessibleColors = userName(10933).useDisplayNameStylesAccessibleColors({
    displayNameStyles: result,
  ...
  const tmp7Result3 = userName(4580);
  const tmp20 =
    userName(4570).TextStyleSheet[tmp7Result3.useTypographyVariantRemap(tmp7Result3, merged.variant, false)];
  ...
  if (displayNameStylesEnabled) {
    if (null != tmp6) {
        ...
        if (null != colorVariants) {
          ...
          if (effectId === tmp7(1390).DisplayNameEffect.GUMMY) {
            ...
            if (tmp7(1390).DisplayNameEffect.GRADIENT !== effectId) {
              if (tmp7(1390).DisplayNameEffect.PRISM !== effectId) {
                if (tmp7(1390).DisplayNameEffect.NEON === effectId) {
                  ...
                  if (null != colorVariants) {
                    ...
                    const items6 = [closure_9(tmp7(4570).Text, obj4)];
                    const obj5 = {};
                    ...
                    items6[1] = closure_9(tmp7(4570).Text, obj5);
                  ...
                  const items9 = [
                    closure_5(token1),
                    closure_5(colorVariants.light2),
                    closure_5(colorVariants.light1),
                    closure_5(colorVariants.main),
                  ];
              ...
              return closure_9(tmp7(4570).Text, obj7);
            }
      ...
      return closure_9(tmp7(4570).Text, obj8);
    }
  }
  const obj9 = {};
  ...
  return closure_9(userName(4570).Text, obj9);
});
