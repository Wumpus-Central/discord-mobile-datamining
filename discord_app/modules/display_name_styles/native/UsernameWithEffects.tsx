...
export default noop.memo((userName) => {
  ...
  const isDisplayNameStylesFlywheelViewersEnabled =
    userName(10081).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  ...
  const displayNameStylesFont = userName(10080).useDisplayNameStylesFont({
  ...
  const displayNameStylesAccessibleColors = userName(11250).useDisplayNameStylesAccessibleColors({
    displayNameStyles: result,
  ...
  const tmp20 =
    userName(4825).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
