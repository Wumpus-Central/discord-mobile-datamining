...
export default noop.memo((userName) => {
  ...
  const isDisplayNameStylesFlywheelViewersEnabled =
    userName(9415).useIsDisplayNameStylesFlywheelViewersEnabled("UsernameWithEffects");
  ...
  const displayNameStylesFont = userName(9414).useDisplayNameStylesFont({
  ...
  const displayNameStylesAccessibleColors = userName(11148).useDisplayNameStylesAccessibleColors({
    displayNameStyles: result,
  ...
  const tmp20 =
    userName(4718).TextStyleSheet[tmp7Result10.useTypographyVariantRemap(tmp7Result10, merged.variant, false)];
