// === Module 15349: DisplayNameStylesGradientPickerSheet ===
...
fn(4560);
let createStyles = { body: null, gradientContainer: null, dropperContainer: null, dropper: null, gradient: null, optionContainer: null, swatchWrapper: null, pressable: null, selected: null, option: null };
...
createStyles.gradientContainer = { flexDirection: "row", justifyContent: "center", alignItems: "center", paddingHorizontal: nativeDefault.space.PX_8 };
...
let obj1 = { flexDirection: "row", justifyContent: "center", alignItems: "center", paddingHorizontal: nativeDefault.space.PX_8 };
createStyles.dropper = { borderColor: "white", padding: nativeDefault.space.PX_8, borderRadius: nativeDefault.radii.round, borderWidth: 1 };
let size = { height: 50, width: "100%", borderRadius: nativeDefault.radii.sm };
createStyles.gradient = size;
let obj2 = { borderColor: "white", padding: nativeDefault.space.PX_8, borderRadius: nativeDefault.radii.round, borderWidth: 1 };
...
createStyles.pressable = { height: 40, borderRadius: nativeDefault.radii.sm, overflow: "hidden", borderWidth: 2, borderColor: "transparent" };
let obj4 = { height: 40, borderRadius: nativeDefault.radii.sm, overflow: "hidden", borderWidth: 2, borderColor: "transparent" };
...
export default function DisplayNameStylesColorPickerSheet(selectedColors) {
  ...
  const obj4 = { style: tmp.gradient, colors: colors.map((item) => onSelectColors(displayNameStylesEffectConfig[19]).int2hex(item)), start: { x: 0, y: 0 }, end: { x: 1, y: 0 } };
  ...
  items4[1] = closure_8(closure_5, {
    ...
    children: arr.map((accessibilityLabel, index) => {
      ...
      items[1] = selected;
      const obj1 = { style: closure_1.option, colors: colors.map((item) => colors(displayNameStylesEffectConfig[19]).int2hex(item)), start: { x: 0, y: 0 }, end: { x: 1, y: 0 } };
