...
export default function DisplayNameStylesEffectPickerSheet(userId) {
  ...
  if (null != userId) {
    ...
    obj3[1] = tmp8;
    obj2[1] = callback2(tmp2(4754).Button, obj3);
    obj1[1] = callback2(closure_5, obj2);
    obj[1] = callback2(tmp2(5435).BottomSheetTitleHeader, obj1);
    ...
    obj5[1] = callback2(tmp2(4752).Stack, obj6);
    obj4[1] = callback2(closure_5, obj5);
    obj[2] = callback2(closure_5, obj4);
    tmp9 = callback2(tmp2(5436).BottomSheet, obj);
  }
  return tmp9;
};