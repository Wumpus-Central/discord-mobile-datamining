// === Module 15339: useDisplayNameStylesNewItems ===

// Module 15339 (useDisplayNameStylesNewItems)
import noop from "module_19" /* 19 */;
import DisplayNameStylesSeenStore from "DisplayNameStylesSeenStore" /* 15340 */;
...
export const useDisplayNameStylesNewFonts = function useDisplayNameStylesNewFonts(visibleFontOrder) {
  ...
  obj.dotFontIds = noop.useMemo(() => new Set(visibleFontOrder.filter((item) => {
...
export const useDisplayNameStylesNewEffects = function useDisplayNameStylesNewEffects(visibleEffectOrder) {
  ...
  obj.dotEffectIds = noop.useMemo(() => new Set(visibleEffectOrder.filter((item) => {
