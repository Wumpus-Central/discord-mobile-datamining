// === Module 6847: ConfirmEmailChangeCode ===
...
require = fn;
const setEmailToken = fn(5842).setEmailToken;
const jsx = fn(21).jsx;
const size = fn(2);
...
export default function ConfirmEmailChangeCode(isChangeEmail) {
  ...
  return jsx(navigation(6848), { onFormSubmit: null, onSuccess: null, onResend: null, headerText: null, confirmButtonText: null });
};