...
export default function ResendEmail() {
  ...
  const result = verified(6835).isEmailReverification(stateFromStores1);
  let tmp16Result = !result;
  const obj4 = verified(6835);
  ...
  const items4 = [closure_9(navigation(5911).EnvelopeOpenSpotIllustration, { scale: 0.75 }), , , , ];
  ...
  items4[1] = closure_9(navigation(4753).Text, obj6);
  ...
  items4[2] = closure_9(navigation(4753).Text, obj7);
  ...
  obj9.children = closure_9(navigation(5187).Button, obj10);
  ...
  if (!result) {
    ...
    obj11.children = closure_9(tmp2(5187).Button, obj12);
