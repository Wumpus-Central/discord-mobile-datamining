...
export default function ResendEmail() {
  ...
  items4[1] = closure_9(navigation(4601).Text, obj);
  ...
  items4[2] = closure_9(navigation(4601).Text, obj1);
  ...
  obj3.children = closure_9(navigation(5025).Button, obj4);
  ...
  if (!result) {
    ...
    obj5.children = closure_9(tmp2(5025).Button, obj6);
