...
export default function ResendEmail() {
  ...
  const items4 = [callback2(navigation(5967).EnvelopeOpenSpotIllustration, { scale: 0.75 }), , , , ];
  obj = { style: tmp.title, accessibilityRole: "header", variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: null };
  let intl = navigation(1236).intl;
  obj[4] = intl.string(navigation(1236).t.fUtddV);
  items4[1] = callback2(navigation(4298).Text, obj);
  ...
  obj1[3] = formatResult;
  items4[2] = callback2(navigation(4298).Text, obj1);
  ...
  obj3[1] = callback2(navigation(4712).Button, obj4);
  ...
  if (!result) {
    ...
    obj6[2] = callback;
    obj5[1] = tmp16(tmp2(4712).Button, obj6);
