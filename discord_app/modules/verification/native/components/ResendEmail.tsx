...
export default function ResendEmail() {
  ...
  const items4 = [callback2(navigation(5921).EnvelopeOpenSpotIllustration, { scale: 0.75 }), , , , ];
  ...
  obj3[1] = callback2(navigation(4665).Button, obj4);
  ...
  if (!result) {
    ...
    obj6[2] = callback;
    obj5[1] = tmp16(tmp2(4665).Button, obj6);
