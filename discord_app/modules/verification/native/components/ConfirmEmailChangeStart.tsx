// === Module 6844: ConfirmEmailChangeStart ===
...
export default function ConfirmEmailChangeStart() {
  ...
  if (null == stateFromStores) {
    ...
    let obj6 = { style: tmp.image, source: navigation(6846) };
    ...
    items1[1] = closure_10(tmp2(4753).Text, obj7);
    ...
    obj9.onPress = tmp7;
    obj9.loading = tmp6[0];
    obj8.children = closure_10(tmp2(5187).Button, obj9);
