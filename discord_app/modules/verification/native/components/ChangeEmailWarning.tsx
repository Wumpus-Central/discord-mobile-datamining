...
export default function ChangeEmailWarning(changeEmailReason) {
  ...
  if (null != stateFromStores) {
    ...
    items2[1] = closure_9(tmp2(4570).Text, obj1);
    const obj2 = {
      style: tmp.body,
      accessibilityRole: "header",
    ...
    items2[2] = closure_10(tmp2(4570).Text, obj2);
    ...
    obj5.onPress = tmp6;
    const items4 = [closure_9(tmp2(4989).Button, obj5)];
    ...
    items4[1] = closure_9(tmp2(4989).Button, obj6);
