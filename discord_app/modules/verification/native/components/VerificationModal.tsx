...
function PhoneThenEmailInterstitial(navigation) {
  ...
  obj[0] = navigation(16365).VerifyPhone;
  ...
  obj[1] = jsx(navigation(4604).Button, { text: null, onPress: null });
...
export default function VerificationModal() {
  ...
  const effect = React.useEffect(() => {
    ...
    stateFromStores(4052).dismissKeyboard();
  }, []);
  ...
  obj[0] = React.useMemo(() => {
    ...
    obj3[6] = function render() {
      return callback3(callback2(16369), {});
    };
    ...
    obj5[1] = obj6;
    let obj12 = stateFromStores(5147);
    obj5[2] = obj12.getHeaderNoTitle();
    obj5[3] = function render() {
      return callback3(callback2(9193), {});
    };
    ...
    let obj15 = stateFromStores(5147);
    ...
    let obj18 = stateFromStores(5147);
    obj9[2] = obj18.getHeaderNoTitle();
    obj9[3] = function render() {
      return callback3(callback2(9198), { isChangeEmail: false });
    };
    ...
    obj11[1] = obj12;
    let obj21 = stateFromStores(5147);
    obj11[2] = obj21.getHeaderNoTitle();
    obj11[3] = function render() {
      return callback3(callback2(9195), {});
    };
    ...
    obj13[2] = stateFromStores(5147).getHeaderNoTitle();
    obj13[3] = function render() {
      return callback3(callback2(9233), { isChangeEmail: false });
    };
    ...
    const obj25 = stateFromStores(5147);
    ...
    obj15[2] = stateFromStores(5147).getHeaderNoTitle();
    obj15[3] = function render(arg0, arg1) {
      let callback = arg1;
      let obj = {};
      const merged = Object.assign(arg0);
      obj.reason = callback(9244).ChangePhoneReason.USER_ACTION_REQUIRED;
      obj.onComplete = function onComplete(phone) {
        return arr.push(outer1_10.VERIFY_PHONE, {
          ...
          onVerified(arg0) {
            ...
            let closure_2 = outer1_3(/* F119292 */ function() { ... });
            obj[1] = () => { ... };
            let closure_1 = outer1_3(/* F119294 */ function() { ... });
            obj[2] = () => { ... };
            arr = arr.push(outer1_10.VERIFY_PASSWORD, obj);
          }
        });
      };
      return callback3(callback2(9243), obj);
    };
    ...
    obj17[1] = obj18;
    const obj28 = stateFromStores(5147);
    obj17[2] = stateFromStores(5147).getHeaderNoTitle();
    obj17[3] = function render(arg0) {
      const merged = Object.assign(arg0);
      return callback3(callback2(9268), { disableKeyboardAvoidingView: true });
    };
    ...
    const obj31 = stateFromStores(5147);
    ...
    obj19[2] = stateFromStores(5147).getHeaderNoTitle();
    obj19[3] = function render(arg0) {
      const merged = Object.assign(arg0);
      return callback3(callback2(9238), {});
    };
    ...
    const obj34 = stateFromStores(5147);
    ...
    obj21[2] = stateFromStores(5147).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(5574).Navigator, { screens: null, initialRouteStack: null, headerBackTitle: null });
};