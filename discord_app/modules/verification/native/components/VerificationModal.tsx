...
function PhoneThenEmailInterstitial(navigation) {
  ...
  obj[1] = jsx(navigation(4755).Button, { text: null, onPress: null });
...
export default function VerificationModal() {
  ...
  obj[0] = React.useMemo(() => {
    ...
    obj5[1] = obj6;
    let obj12 = stateFromStores(5310);
    obj5[2] = obj12.getHeaderNoTitle();
    obj5[3] = function render() {
      return callback3(callback2(8507), {});
    };
    ...
    let obj15 = stateFromStores(5310);
    ...
    let obj18 = stateFromStores(5310);
    obj9[2] = obj18.getHeaderNoTitle();
    obj9[3] = function render() {
      return callback3(callback2(8512), { isChangeEmail: false });
    };
    ...
    obj11[1] = obj12;
    let obj21 = stateFromStores(5310);
    obj11[2] = obj21.getHeaderNoTitle();
    obj11[3] = function render() {
      return callback3(callback2(8509), {});
    };
    ...
    obj13[2] = stateFromStores(5310).getHeaderNoTitle();
    obj13[3] = function render() {
      return callback3(callback2(8557), { isChangeEmail: false });
    };
    ...
    const obj25 = stateFromStores(5310);
    ...
    obj15[2] = stateFromStores(5310).getHeaderNoTitle();
    obj15[3] = function render(arg0, arg1) {
      let callback = arg1;
      let obj = {};
      const merged = Object.assign(arg0);
      obj.reason = callback(8568).ChangePhoneReason.USER_ACTION_REQUIRED;
      ...
      return callback3(callback2(8567), obj);
    };
    ...
    obj17[1] = obj18;
    const obj28 = stateFromStores(5310);
    obj17[2] = stateFromStores(5310).getHeaderNoTitle();
    obj17[3] = function render(arg0) {
      const merged = Object.assign(arg0);
      return callback3(callback2(8594), { disableKeyboardAvoidingView: true });
    };
    ...
    const obj31 = stateFromStores(5310);
    ...
    obj19[2] = stateFromStores(5310).getHeaderNoTitle();
    obj19[3] = function render(arg0) {
      const merged = Object.assign(arg0);
      return callback3(callback2(8562), {});
    };
    ...
    const obj34 = stateFromStores(5310);
    ...
    obj21[2] = stateFromStores(5310).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(5823).Navigator, { screens: null, initialRouteStack: null, headerBackTitle: null });
};