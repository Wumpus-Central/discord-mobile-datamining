// === Module 17328: PhoneThenEmailInterstitial ===

// Module 17328 (PhoneThenEmailInterstitial)
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_6 from "getCountrySelectorOpened" /* 17329 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  let obj = { Illustration: navigation(17330).VerifyPhone, title: null, body: null, children: null };
...
export default function VerificationModal() {
  ...
  obj = {
    screens: React.useMemo(() => {
      ...
      obj3[6] = function render() {
        return callback3(callback2(17334), {});
      };
      ...
      obj5[1] = obj6;
      let obj12 = stateFromStores(5503);
      obj5[2] = obj12.getHeaderNoTitle();
      obj5[3] = function render() {
        return callback3(callback2(7706), {});
      };
      ...
      let obj15 = stateFromStores(5503);
      ...
      let obj18 = stateFromStores(5503);
      obj9[2] = obj18.getHeaderNoTitle();
      obj9[3] = function render() {
        return callback3(callback2(7711), { isChangeEmail: false });
      };
      ...
      obj11[1] = obj12;
      let obj21 = stateFromStores(5503);
      obj11[2] = obj21.getHeaderNoTitle();
      obj11[3] = function render() {
        return callback3(callback2(7708), {});
      };
      ...
      obj13[2] = stateFromStores(5503).getHeaderNoTitle();
      obj13[3] = function render() {
        return callback3(callback2(7763), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5503);
      ...
      obj15[2] = stateFromStores(5503).getHeaderNoTitle();
      obj15[3] = function render(arg0, arg1) {
        let callback = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = callback(7780).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return arr.push(closure_1_10.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F125053 */ function() { ... });
              obj[1] = () => { ... };
              closure_1 = closure_1_3(/* F125055 */ function() { ... });
              obj[2] = () => { ... };
              arr = arr.push(closure_1_10.VERIFY_PASSWORD, obj);
            }
          });
        };
        return callback3(callback2(7779), obj);
      };
      ...
      obj17[1] = obj18;
      const obj28 = stateFromStores(5503);
      obj17[2] = stateFromStores(5503).getHeaderNoTitle();
      obj17[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(7810), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5503);
      ...
      obj19[2] = stateFromStores(5503).getHeaderNoTitle();
      obj19[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(7774), {});
      };
      ...
      const obj34 = stateFromStores(5503);
      ...
      obj21[2] = stateFromStores(5503).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(6016).Navigator, {
    screens: React.useMemo(() => {
      let obj = {};
      obj = { impressionName: stateFromStores(500).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: null, headerTitle: null, render: null };
      obj = { impression_group: stateFromStores(500).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
