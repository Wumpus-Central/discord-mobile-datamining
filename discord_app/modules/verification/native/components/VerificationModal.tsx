...
function PhoneThenEmailInterstitial(navigation) {
  ...
  let obj = { Illustration: navigation(17544).VerifyPhone, title: null, body: null, children: null };
  ...
  obj.children = jsx(navigation(4989).Button, { text: null, onPress: null });
...
export default function VerificationModal() {
  ...
  obj = {
    screens: noop.useMemo(() => {
      ...
      let obj9 = stateFromStores(5638);
      obj3.headerTitle = obj9.getHeaderNoTitle();
      obj3.headerRight = function headerRight() {
        let obj = { source: closure_1_1(9832), accessibilityLabel: null, onPress: null };
      ...
      let obj12 = stateFromStores(5638);
      ...
      let obj15 = stateFromStores(5638);
      ...
      let obj18 = stateFromStores(5638);
      ...
      let obj21 = stateFromStores(5638);
      ...
      obj13.headerTitle = stateFromStores(5638).getHeaderNoTitle();
      ...
      obj15.headerTitle = stateFromStores(5638).getHeaderNoTitle();
      ...
      obj19.headerTitle = stateFromStores(5638).getHeaderNoTitle();
      ...
      obj21.headerTitle = stateFromStores(5638).getHeaderNoTitle();
