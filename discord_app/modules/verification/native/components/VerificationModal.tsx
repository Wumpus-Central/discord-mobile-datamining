// === Module 16822: PhoneThenEmailInterstitial ===

// Module 16822 (PhoneThenEmailInterstitial)
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_6 from "getCountrySelectorOpened" /* 16823 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  let obj = { Illustration: navigation(16824).VerifyPhone, title: null, body: null, children: null };
  ...
  obj[1] = jsx(navigation(4750).Button, { text: null, onPress: null });
...
export default function VerificationModal() {
  ...
  const effect = React.useEffect(() => {
    ...
    stateFromStores(4241).dismissKeyboard();
  }, []);
  obj = {
    screens: React.useMemo(() => {
      ...
      let obj9 = stateFromStores(6345);
      obj3[4] = obj9.getHeaderNoTitle();
      obj3[5] = function headerRight() {
        let obj = { source: callback2(8941), accessibilityLabel: null, onPress: null };
      ...
      obj5[1] = obj6;
      let obj12 = stateFromStores(6345);
      obj5[2] = obj12.getHeaderNoTitle();
      obj5[3] = function render() {
        return callback3(callback2(8607), {});
      };
      ...
      let obj15 = stateFromStores(6345);
      ...
      let obj18 = stateFromStores(6345);
      obj9[2] = obj18.getHeaderNoTitle();
      obj9[3] = function render() {
        return callback3(callback2(8612), { isChangeEmail: false });
      };
      ...
      obj11[1] = obj12;
      let obj21 = stateFromStores(6345);
      obj11[2] = obj21.getHeaderNoTitle();
      obj11[3] = function render() {
        return callback3(callback2(8609), {});
      };
      ...
      obj13[2] = stateFromStores(6345).getHeaderNoTitle();
      obj13[3] = function render() {
        return callback3(callback2(8655), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(6345);
      ...
      obj15[2] = stateFromStores(6345).getHeaderNoTitle();
      obj15[3] = function render(arg0, arg1) {
        let callback = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = callback(8666).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return arr.push(closure_1_10.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F121970 */ function() { ... });
              obj[1] = () => { ... };
              closure_1 = closure_1_3(/* F121972 */ function() { ... });
              obj[2] = () => { ... };
              arr = arr.push(closure_1_10.VERIFY_PASSWORD, obj);
            }
          });
        };
        return callback3(callback2(8665), obj);
      };
      ...
      obj17[1] = obj18;
      const obj28 = stateFromStores(6345);
      obj17[2] = stateFromStores(6345).getHeaderNoTitle();
      obj17[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(8692), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(6345);
      ...
      obj19[2] = stateFromStores(6345).getHeaderNoTitle();
      obj19[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(8660), {});
      };
      ...
      const obj34 = stateFromStores(6345);
      ...
      obj21[2] = stateFromStores(6345).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(6343).Navigator, {
    screens: React.useMemo(() => {
      let obj = {};
      obj = { impressionName: stateFromStores(503).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: null, headerTitle: null, render: null };
      obj = { impression_group: stateFromStores(503).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
