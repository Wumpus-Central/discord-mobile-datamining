...
import getCountrySelectorOpened from "../../../../stores/PhoneVerificationStore.tsx";
...
export default function VerificationModal() {
  ...
  const effect = React.useEffect(() => {
    ...
    stateFromStores(4237).dismissKeyboard();
  }, []);
  obj = {
    screens: React.useMemo(() => {
      ...
      let obj9 = stateFromStores(6314);
      obj3[4] = obj9.getHeaderNoTitle();
      obj3[5] = function headerRight() {
        let obj = { source: callback2(8904), accessibilityLabel: null, onPress: null };
      ...
      obj3[6] = function render() {
        return callback3(callback2(16735), {});
      };
      ...
      obj5[1] = obj6;
      let obj12 = stateFromStores(6314);
      obj5[2] = obj12.getHeaderNoTitle();
      obj5[3] = function render() {
        return callback3(callback2(8568), {});
      };
      ...
      let obj15 = stateFromStores(6314);
      ...
      let obj18 = stateFromStores(6314);
      obj9[2] = obj18.getHeaderNoTitle();
      obj9[3] = function render() {
        return callback3(callback2(8573), { isChangeEmail: false });
      };
      ...
      obj11[1] = obj12;
      let obj21 = stateFromStores(6314);
      obj11[2] = obj21.getHeaderNoTitle();
      obj11[3] = function render() {
        return callback3(callback2(8570), {});
      };
      ...
      obj13[2] = stateFromStores(6314).getHeaderNoTitle();
      obj13[3] = function render() {
        return callback3(callback2(8618), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(6314);
      ...
      obj15[2] = stateFromStores(6314).getHeaderNoTitle();
      obj15[3] = function render(arg0, arg1) {
        let callback = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = callback(8629).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return arr.push(closure_1_10.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F120940 */ function() { ... });
              obj[1] = () => { ... };
              closure_1 = closure_1_3(/* F120942 */ function() { ... });
              obj[2] = () => { ... };
              arr = arr.push(closure_1_10.VERIFY_PASSWORD, obj);
            }
          });
        };
        return callback3(callback2(8628), obj);
      };
      ...
      obj17[1] = obj18;
      const obj28 = stateFromStores(6314);
      obj17[2] = stateFromStores(6314).getHeaderNoTitle();
      obj17[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(8655), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(6314);
      ...
      obj19[2] = stateFromStores(6314).getHeaderNoTitle();
      obj19[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(8623), {});
      };
      ...
      const obj34 = stateFromStores(6314);
      ...
      obj21[2] = stateFromStores(6314).getHeaderNoTitle();
