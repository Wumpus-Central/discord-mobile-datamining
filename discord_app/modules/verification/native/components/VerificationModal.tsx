...
function PhoneThenEmailInterstitial(navigation) {
  ...
  let obj = { Illustration: navigation(17624).VerifyPhone, title: null, body: null, children: null };
  ...
  obj.children = jsx(navigation(5056).Button, { text: null, onPress: null });
...
export default function VerificationModal() {
  ...
  obj = {
    screens: noop.useMemo(() => {
      ...
      let obj9 = stateFromStores(5705);
      obj3.headerTitle = obj9.getHeaderNoTitle();
      obj3.headerRight = function headerRight() {
        let obj = { source: closure_1_1(9930), accessibilityLabel: null, onPress: null };
      ...
      let obj12 = stateFromStores(5705);
      ...
      let obj15 = stateFromStores(5705);
      ...
      let obj18 = stateFromStores(5705);
      ...
      let obj21 = stateFromStores(5705);
      ...
      obj13.headerTitle = stateFromStores(5705).getHeaderNoTitle();
      ...
      obj15.headerTitle = stateFromStores(5705).getHeaderNoTitle();
      ...
      obj19.headerTitle = stateFromStores(5705).getHeaderNoTitle();
      ...
      obj21.headerTitle = stateFromStores(5705).getHeaderNoTitle();
