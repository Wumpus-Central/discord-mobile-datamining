...
function PhoneThenEmailInterstitial(navigation) {
  ...
  obj[0] = navigation(16731).VerifyPhone;
...
export default function VerificationModal() {
      ...
      obj.onComplete = function onComplete(phone) {
        return arr.push(outer1_10.VERIFY_PHONE, {
          ...
          onVerified(arg0) {
            ...
            let closure_2 = outer1_3(/* F120940 */ function() { ... });
            obj[1] = () => { ... };
            let closure_1 = outer1_3(/* F120942 */ function() { ... });
            obj[2] = () => { ... };
  ...
  return jsx(stateFromStores(6312).Navigator, { screens: null, initialRouteStack: null, headerBackTitle: null });
};