// === Module 16939: PhoneThenEmailInterstitial ===

// Module 16939 (PhoneThenEmailInterstitial)
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_6 from "getCountrySelectorOpened" /* 16940 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  let obj = { Illustration: navigation(16941).VerifyPhone, title: null, body: null, children: null };
  ...
  obj[1] = jsx(navigation(4879).Button, { text: null, onPress: null });
...
export default function VerificationModal() {
  ...
  const effect = React.useEffect(() => {
    ...
    stateFromStores(4306).dismissKeyboard();
  }, []);
  obj = {
    screens: React.useMemo(() => {
      ...
      obj5[1] = obj6;
      let obj12 = stateFromStores(5442);
      obj5[2] = obj12.getHeaderNoTitle();
      obj5[3] = function render() {
        return callback3(callback2(8683), {});
      };
      ...
      let obj15 = stateFromStores(5442);
      ...
      let obj18 = stateFromStores(5442);
      obj9[2] = obj18.getHeaderNoTitle();
      obj9[3] = function render() {
        return callback3(callback2(8688), { isChangeEmail: false });
      };
      ...
      obj11[1] = obj12;
      let obj21 = stateFromStores(5442);
      obj11[2] = obj21.getHeaderNoTitle();
      obj11[3] = function render() {
        return callback3(callback2(8685), {});
      };
      ...
      obj13[2] = stateFromStores(5442).getHeaderNoTitle();
      obj13[3] = function render() {
        return callback3(callback2(8731), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5442);
      ...
      obj15[2] = stateFromStores(5442).getHeaderNoTitle();
      obj15[3] = function render(arg0, arg1) {
        let callback = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = callback(8742).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return arr.push(closure_1_10.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F122524 */ function() { ... });
              obj[1] = () => { ... };
              closure_1 = closure_1_3(/* F122526 */ function() { ... });
              obj[2] = () => { ... };
              arr = arr.push(closure_1_10.VERIFY_PASSWORD, obj);
            }
          });
        };
        return callback3(callback2(8741), obj);
      };
      ...
      obj17[1] = obj18;
      const obj28 = stateFromStores(5442);
      obj17[2] = stateFromStores(5442).getHeaderNoTitle();
      obj17[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(8768), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5442);
      ...
      obj19[2] = stateFromStores(5442).getHeaderNoTitle();
      obj19[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(8736), {});
      };
      ...
      const obj34 = stateFromStores(5442);
      ...
      obj21[2] = stateFromStores(5442).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(5955).Navigator, {
    screens: React.useMemo(() => {
      let obj = {};
      obj = { impressionName: stateFromStores(503).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: null, headerTitle: null, render: null };
      obj = { impression_group: stateFromStores(503).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
