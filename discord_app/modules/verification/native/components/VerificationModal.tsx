// === Module 17056: PhoneThenEmailInterstitial ===

// Module 17056 (PhoneThenEmailInterstitial)
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_6 from "getCountrySelectorOpened" /* 17057 */;
...
function PhoneThenEmailInterstitial(navigation) {
  ...
  let obj = { Illustration: navigation(17058).VerifyPhone, title: null, body: null, children: null };
  ...
  obj[1] = jsx(navigation(4896).Button, { text: null, onPress: null });
...
export default function VerificationModal() {
  ...
  const effect = React.useEffect(() => {
    ...
    stateFromStores(4310).dismissKeyboard();
  }, []);
  obj = {
    screens: React.useMemo(() => {
      ...
      obj3[6] = function render() {
        return callback3(callback2(17062), {});
      };
      ...
      obj5[1] = obj6;
      let obj12 = stateFromStores(5463);
      obj5[2] = obj12.getHeaderNoTitle();
      obj5[3] = function render() {
        return callback3(callback2(7665), {});
      };
      ...
      let obj15 = stateFromStores(5463);
      ...
      let obj18 = stateFromStores(5463);
      obj9[2] = obj18.getHeaderNoTitle();
      obj9[3] = function render() {
        return callback3(callback2(7670), { isChangeEmail: false });
      };
      ...
      obj11[1] = obj12;
      let obj21 = stateFromStores(5463);
      obj11[2] = obj21.getHeaderNoTitle();
      obj11[3] = function render() {
        return callback3(callback2(7667), {});
      };
      ...
      obj13[2] = stateFromStores(5463).getHeaderNoTitle();
      obj13[3] = function render() {
        return callback3(callback2(7722), { isChangeEmail: false });
      };
      ...
      const obj25 = stateFromStores(5463);
      ...
      obj15[2] = stateFromStores(5463).getHeaderNoTitle();
      obj15[3] = function render(arg0, arg1) {
        let callback = arg1;
        let obj = {};
        const merged = Object.assign(arg0);
        obj.reason = callback(7739).ChangePhoneReason.USER_ACTION_REQUIRED;
        obj.onComplete = function onComplete(phone) {
          return arr.push(closure_1_10.VERIFY_PHONE, {
            ...
            onVerified(arg0) {
              ...
              closure_2 = closure_1_3(/* F123019 */ function() { ... });
              obj[1] = () => { ... };
              closure_1 = closure_1_3(/* F123021 */ function() { ... });
              obj[2] = () => { ... };
              arr = arr.push(closure_1_10.VERIFY_PASSWORD, obj);
            }
          });
        };
        return callback3(callback2(7738), obj);
      };
      ...
      obj17[1] = obj18;
      const obj28 = stateFromStores(5463);
      obj17[2] = stateFromStores(5463).getHeaderNoTitle();
      obj17[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(7769), { disableKeyboardAvoidingView: true });
      };
      ...
      const obj31 = stateFromStores(5463);
      ...
      obj19[2] = stateFromStores(5463).getHeaderNoTitle();
      obj19[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(7733), {});
      };
      ...
      const obj34 = stateFromStores(5463);
      ...
      obj21[2] = stateFromStores(5463).getHeaderNoTitle();
  ...
  return jsx(stateFromStores(5976).Navigator, {
    screens: React.useMemo(() => {
      let obj = {};
      obj = { impressionName: stateFromStores(503).ImpressionNames.USER_VERIFICATION_MODAL, impressionProperties: null, headerTitle: null, render: null };
      obj = { impression_group: stateFromStores(503).ImpressionGroups.USER_VERIFICATION_MODAL_FLOW, step: constants.CHANGE_EMAIL_COLLECT_REASONS };
