...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  const obj2 = {
    ...
    children: closure_14(onDismiss(9613).BellSlashIcon, { size: "md", color: nativeDefault.colors.ICON_STRONG }),
  };
  ...
  obj9.onPress = function onPress() {
    const pushNotificationPermission = onDismiss(11904).requestPushNotificationPermission(
