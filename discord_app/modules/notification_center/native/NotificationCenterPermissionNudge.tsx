...
export default function NotificationCenterPermissionNudge() {
  ...
  const canSeePushNotificationNudge = _require(11583).useCanSeePushNotificationNudge();
  const obj2 = _require(11583);
  let prop = null;
  ...
  const tmp5 = callback(_require(7366).useSelectedTimeRecurringDismissibleContent(prop, { cooldownDurationMs: 604800000 }), 2);
  _require = tmp6;
  const items = [tmp5[1]];
  const obj3 = _require(7366);
  let tmp8 = null;
