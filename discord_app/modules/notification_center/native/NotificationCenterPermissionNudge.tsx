...
function NotificationCenterBannerImpl(onDismiss) {
  ...
  obj.children = closure_14(onDismiss(9149).BellSlashIcon, obj);
  ...
  const items1 = [closure_14(onDismiss(4602).Text, obj2), ,];
  const obj3 = {
  ...
  items1[1] = closure_14(onDismiss(4602).Text, obj3);
  ...
  obj5.children = closure_14(onDismiss(5026).Button, obj6);
  ...
  obj7.children = closure_14(onDismiss(5731).XSmallIcon, { size: "sm", color: "icon-strong" });
  items[2] = closure_14(onDismiss(5174).PressableHighlight, obj7);
  obj.children = items;
