...
import profile_customization_ProfileCustomizationUtils from "profile_customization/ProfileCustomizationUtils" /* 8247 */;
      ...
      if (null == memo) {
        if ("lifecycle_item" === item.type) {
          ...
          if (item_enum === tmp5(obj[9]).ItemEnum.UPDATE_PROFILE) {
            ...
            const obj4 = { source: tmp2(obj[18]), size: tmp5(obj[17]).IconSizes.SMALL_20, color: tmp2(obj[8]).unsafe_rawColors.WHITE };
          ...
          if (tmp5(obj[9]).NotificationCenterItems.MISSED_MESSAGES === type) {
            ...
            const obj10 = { icon: tmp2(obj[12]), color: tmp3.fallbackImageV2.color, backgroundStyle: tmp3.guildGridBackground };
            obj9 = obj10;
          }
