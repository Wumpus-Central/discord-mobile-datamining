...
export default function NotificationCenterActionSheet() {
  ...
  obj8.icon = closure_6(roleFilter(7302).ActionSheetRow.Icon, {
    IconComponent: roleFilter(5171).AtIcon,
    source: everyoneFilter(12552),
  });
  ...
  obj10.icon = closure_6(roleFilter(7302).ActionSheetRow.Icon, {
    IconComponent: roleFilter(9906).BellIcon,
    source: everyoneFilter(16506),
  });
  ...
  if (canUseScheduledMessages) {
    ...
    obj16.icon = closure_6(tmp(7302).ActionSheetRow.Icon, obj17);
    const intl7 = tmp(1114).intl;
    obj16.label = intl7.string(tmp(1114).t.SZVs3K);
    obj16.onPress = callback;
    tmp10Result4 = closure_6(tmp(7302).ActionSheetRow, obj16, "scheduled-messages");
  }
