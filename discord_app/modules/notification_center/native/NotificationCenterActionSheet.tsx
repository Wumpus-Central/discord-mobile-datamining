...
export default function NotificationCenterActionSheet() {
  ...
  obj8.icon = closure_6(roleFilter(7444).ActionSheetRow.Icon, {
    IconComponent: roleFilter(5308).AtIcon,
    source: everyoneFilter(12676),
  });
  ...
  obj10.icon = closure_6(roleFilter(7444).ActionSheetRow.Icon, {
    IconComponent: roleFilter(9874).BellIcon,
    source: everyoneFilter(16748),
  });
  ...
  if (canUseScheduledMessages) {
    ...
    obj16.icon = closure_6(tmp(7444).ActionSheetRow.Icon, obj17);
    const intl7 = tmp(1115).intl;
    obj16.label = intl7.string(tmp(1115).t.SZVs3K);
    obj16.onPress = callback;
    tmp10Result4 = closure_6(tmp(7444).ActionSheetRow, obj16, "scheduled-messages");
  }
