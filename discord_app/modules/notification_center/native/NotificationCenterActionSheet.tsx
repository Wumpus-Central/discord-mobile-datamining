...
export default function NotificationCenterActionSheet() {
  ...
  obj8.icon = closure_6(roleFilter(7446).ActionSheetRow.Icon, {
    IconComponent: roleFilter(5310).AtIcon,
    source: everyoneFilter(12680),
  });
  ...
  obj10.icon = closure_6(roleFilter(7446).ActionSheetRow.Icon, {
    IconComponent: roleFilter(9880).BellIcon,
    source: everyoneFilter(16760),
  });
  ...
  if (canUseScheduledMessages) {
    ...
    obj16.icon = closure_6(tmp(7446).ActionSheetRow.Icon, obj17);
    const intl7 = tmp(1115).intl;
    obj16.label = intl7.string(tmp(1115).t.SZVs3K);
    obj16.onPress = callback;
    tmp10Result4 = closure_6(tmp(7446).ActionSheetRow, obj16, "scheduled-messages");
  }
