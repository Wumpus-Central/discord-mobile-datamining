...
let closure_35 = noop.memo((item) => {
  ...
  const callback1 = str.useCallback(() => {
    ...
    callback();
    obj = { action_type: NotificationCenterItemsTypes.NotificationCenterActionTypes.CLICKED, notification_center_id: tmp5.id, item_type: tmp5.type, acked: notificationCenterItemAcked, item_index: rowIndex, deeplink: tmp5.deeplink };
