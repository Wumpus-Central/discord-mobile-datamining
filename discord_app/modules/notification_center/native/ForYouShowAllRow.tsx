...
function ForYouShowAllRow(panelVariant) {
  ...
  let obj2 = require("../../screen/native/useFontScale.tsx") /* getFontScale */;
  const fontScale = obj2.useFontScale();
  let obj3 = require("../../main_tabs_v2/native/shared_components/guild_channels/ChannelPressableWrapper.tsx") /* renderChannelPressableWrapper */;
  ...
  let obj5 = require("../../main_tabs_v2/native/shared_components/guild_channels/ChannelWrapper.tsx") /* renderChannelWrapper */;
  obj = { style: tmp4.avatar, children: null };
  const obj8 = require("../../main_tabs_v2/native/shared_components/guild_channels/layouts/ChannelListLayout.tsx") /* getLayoutStyles */;
  const tmp8 = closure_9;
  const tmp9 = closure_8;
  const AvatarSizes = require("../../../design/void/native.tsx") /* Button */.AvatarSizes;
  obj1 = { children: null };
  obj2 = { size: require("../../main_tabs_v2/native/shared_components/guild_channels/layouts/ChannelListLayout.tsx") /* getLayoutStyles */.isLayoutCompact(layout) ? AvatarSizes.XSMALL_20 : AvatarSizes.SMALL, "aria-label": "", children };
  obj[1] = closure_7(require("../../../design/components/Pile/native/AvatarDuoPile.native.tsx") /* AvatarDuoPile */.AvatarDuoPile, obj2);
  ...
  obj4[4] = intl.format(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.NrzztX, { count });
  obj3[1] = closure_7(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj4);
  items1[1] = closure_7(View, obj3);
  obj5 = { style: tmp4.icon, color: tmp4.iconColor.color, source: null, size: null };
  obj5[2] = require("../../../../_runtime/05324_registerAsset.js");
  obj5[3] = require("../../../design/void/native.tsx") /* Button */.IconSizes.CUSTOM;
  items1[2] = closure_7(require("../../../design/void/native.tsx") /* Button */.Icon, obj5);
  obj1[0] = items1;
  obj[4] = obj5.renderChannelWrapper(tmp8(tmp9, obj1), { layout, fontScale, panelVariant });
  return obj3.renderChannelPressableWrapper(closure_7(require("../../../design/void/Pressables/native/Pressables.tsx") /* PressableBase */.PressableHighlight, obj), { layout, panelVariant });
}
...
let closure_10 = createCacheKey.createStyles((layout) => {
  ...
  obj[5] = { width: 8, height: 32, paddingRight: require("../../../../discord_common/js/packages/tokens/native.tsx").space.PX_24 };
  const obj3 = { width: 8, height: 32, paddingRight: require("../../../../discord_common/js/packages/tokens/native.tsx").space.PX_24 };
  obj[6] = { color: require("../../../../discord_common/js/packages/tokens/native.tsx").colors.INTERACTIVE_TEXT_DEFAULT };
  return obj;
});
