...
function ForYouShowAllRow(panelVariant) {
  ...
  let obj2 = getFontScale /* getFontScale */;
  const fontScale = obj2.useFontScale();
  let obj3 = renderChannelPressableWrapper /* renderChannelPressableWrapper */;
  ...
  let obj5 = renderChannelWrapper /* renderChannelWrapper */;
  obj = { style: tmp4.avatar, children: null };
  const obj8 = getLayoutStyles /* getLayoutStyles */;
  const tmp8 = closure_9;
  const tmp9 = closure_8;
  const AvatarSizes = Button /* Button */.AvatarSizes;
  obj1 = { children: null };
  obj2 = { size: getLayoutStyles /* getLayoutStyles */.isLayoutCompact(layout) ? AvatarSizes.XSMALL_20 : AvatarSizes.SMALL, "aria-label": "", children };
  obj[1] = closure_7(AvatarDuoPile /* AvatarDuoPile */.AvatarDuoPile, obj2);
  ...
  obj4[4] = intl.format(getSystemLocale /* getSystemLocale */.t.NrzztX, { count });
  obj3[1] = closure_7(Text /* Text */.Text, obj4);
  items1[1] = closure_7(View, obj3);
  obj5 = { style: tmp4.icon, color: tmp4.iconColor.color, source: null, size: null };
  obj5[2] = registerAsset;
  obj5[3] = Button /* Button */.IconSizes.CUSTOM;
  items1[2] = closure_7(Button /* Button */.Icon, obj5);
  obj1[0] = items1;
  obj[4] = obj5.renderChannelWrapper(tmp8(tmp9, obj1), { layout, fontScale, panelVariant });
  return obj3.renderChannelPressableWrapper(closure_7(PressableBase /* PressableBase */.PressableHighlight, obj), { layout, panelVariant });
}
