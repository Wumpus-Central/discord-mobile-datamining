...
export const NotificationCenterActionTypes = {
  ...
  CLICKED: "clicked",
  FRIEND_REQUESTS_BUTTON_CLICK: "friend_requests_button_click",
...
export const NotificationCenterItems = {
  ...
  GAME_FRIEND_REQUEST_ACCEPTED: "game_friend_request_accepted",
  REACTION_SENT: "reaction_sent",
  REFERRAL_PROGRAM_ENTRYPOINT_REMINDER: "referral_program_entrypoint_reminder",
};
export const NotificationCenterLocalItems = {
  INCOMING_FRIEND_REQUESTS: "INCOMING_FRIEND_REQUESTS",
  INCOMING_FRIEND_REQUESTS_ACCEPTED: "INCOMING_FRIEND_REQUESTS_ACCEPTED",
  FRIEND_REQUESTS_GROUPED: "FRIEND_REQUESTS_GROUPED",
  MOBILE_NATIVE_UPDATE_AVAILABLE: "MOBILE_NATIVE_UPDATE_AVAILABLE",
  INCOMING_GAME_FRIEND_REQUESTS: "INCOMING_GAME_FRIEND_REQUESTS",
  INCOMING_GAME_FRIEND_REQUESTS_ACCEPTED: "INCOMING_GAME_FRIEND_REQUESTS_ACCEPTED",
};
