...
export default function GuildEnableCommunicationAlert(guildId) {
  ...
  const tmp12 = View;
  const tmp3 = userId;
  const tmp7 = userId(4732);
  let str = userId(4493).getName(guildId, null, user);
  if (str == null) {
    str = "";
  }
  ...
  const items = [closure_10(guildId(4299).Text, obj), ];
  ...
  items[1] = closure_10(guildId(4299).Text, obj2);
  obj[1] = items;
