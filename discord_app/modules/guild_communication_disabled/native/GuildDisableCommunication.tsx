// === Module 12100: GuildDisableCommunication ===
...
import useSafeAreaAvoidingInputsDefault from "useSafeAreaAvoidingInputs" /* 11417 */;
    ...
    if (c3 === 2) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          const obj8 = tmp4(4455);
          const name = tmp4(4909).getName(closure_129_1, null, closure_129_0);
          user = name;
          if (name == null) {
            user = "";
          }
