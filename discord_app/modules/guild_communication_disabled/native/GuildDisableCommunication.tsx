...
import _calculateScrollOffsetDefault from "_calculateScrollOffset" /* 9174 */;
      ...
      if (c3 === 2) {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            ...
            const obj8 = closure_1_1(4164);
            const name = closure_1_1(4641).getName(closure_1, null, c0);
            c0 = name;
            if (name == null) {
              c0 = "";
            }
