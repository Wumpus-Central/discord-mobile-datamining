...
const require = fn;
noopAll;
const result = require("obj132").fileFinishedImporting("modules/guild_communication_disabled/native/GuildDisableCommunicationModal.tsx");
...
export default function GuildDisableCommunicationModal(onBeforeGoBack) {
  ...
  obj[2] = function render() {
    return jsx(user(onGoBack[6]), { user, guildId, onClose: onGoBack });
  };
