...
function getFriendlyDurationString(arg0) {
  if (obj.DURATION_60_SEC === arg0) {
    ...
    return intl6.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["4zv/jq"], { secs: 60 });
  } else if (tmp.DURATION_5_MIN === arg0) {
    const intl5 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl5.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.opVZ9q, { mins: 5 });
  } else if (tmp.DURATION_10_MIN === arg0) {
    const intl4 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl4.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.opVZ9q, { mins: 10 });
  } else if (tmp.DURATION_1_HOUR === arg0) {
    const intl3 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl3.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.xCjYxK, { hours: 1 });
  } else if (tmp.DURATION_1_DAY === arg0) {
    const intl2 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl2.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["k2UNz+"], { days: 1 });
  } else if (tmp.DURATION_1_WEEK === arg0) {
    const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.EmoBD2, { weeks: 1 });
  }
}
