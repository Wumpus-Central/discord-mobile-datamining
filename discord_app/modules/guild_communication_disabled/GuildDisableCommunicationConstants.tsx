...
const result = require("obj132").fileFinishedImporting("modules/guild_communication_disabled/GuildDisableCommunicationConstants.tsx");
...
export const getDisableCommunicationDurationOptions = () => {
  ...
  return found.map((item, index) => {
    obj = { id: item, label: null, value: null };
    let str = callback(table[item]);
    if (str == null) {
      str = "";
    }
    obj[1] = str;
