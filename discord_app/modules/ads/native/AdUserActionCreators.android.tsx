...
import NativeAdsModuleDefault from "../../../../discord_common/js/packages/rtn-codegen/js/NativeAdsModule.tsx";
  ...
  if (c6 === 2) {
    ...
    try {
      ...
      if (0 === c5) {
        ...
        const obj10 = {
          platform: closure_130_5.ANDROID,
          success: false,
          duration_ms: closure_129_4,
          error_message: null,
        };
        const _Error = Error;
        ...
        const obj14 = {
          platform: closure_130_5.ANDROID,
          success: true,
          duration_ms: closure_129_3,
          has_advertising_id: null != closure_129_2.googleAdvertisingId,
          is_limit_ad_tracking_enabled: closure_129_2.isLimitAdTrackingEnabled,
        };
        ...
        const obj17 = {
          type: "FETCH_AD_USER_SUCCESS",
          advertisingId: closure_129_2.googleAdvertisingId,
          isLimitAdTrackingEnabled: closure_129_2.isLimitAdTrackingEnabled,
        };
