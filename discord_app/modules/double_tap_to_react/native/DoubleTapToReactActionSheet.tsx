...
export default function DoubleTapToReactActionSheet(emoji) {
      ...
      if (c3 === 2) {
        ...
        try {
          ...
          const obj7 = {
            ...
            location: tmp22(7513).DOUBLE_TAP_TO_REACT_ACTION_SHEET,
          };
  ...
  const items9 = [
    callback1(stateFromStores(selectedEmoji[12]).View, obj13),
    memo(require("Text/Text").Text, {
  ...
  items10[1] = memo(require("Text/Text").Text, {
