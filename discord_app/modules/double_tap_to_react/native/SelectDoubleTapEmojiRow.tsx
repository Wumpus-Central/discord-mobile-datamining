...
export default noop.memo((selectedEmoji) => {
  ...
  obj = {
    accessibilityRole: "button",
    onPress() {
      const obj = { onPressEmoji, channel: "r", pickerIntention: constants.DEFAULT_REACT_EMOJI, reactionType: MessageReactionsTypes.ReactionTypes.NORMAL, startExpanded: null };
