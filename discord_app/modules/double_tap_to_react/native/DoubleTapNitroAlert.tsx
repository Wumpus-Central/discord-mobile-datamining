...
export default function DoubleTapNitroAlert(emojiName) {
  ...
  obj[1] = callback(require("../../../design/components/Icon/native/redesign/generated/CircleErrorIcon.tsx") /* CircleErrorIcon */.CircleErrorIcon, { size: "custom", style: { width: 40, height: 40 } });
  obj[0] = callback(View, obj);
  const intl = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[1] = intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.HRAWfC);
  const intl2 = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[2] = intl2.format(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["3u/Je4"], { emojiName: emojiName.emojiName, onRenewNitro: callback1 });
  obj = { children: null };
  const obj1 = { onPress: callback, text: null };
  const intl3 = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[1] = intl3.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.LIIHRy);
  const items = [callback(require("../../../design/components/AlertModal/native/AlertModal.native.tsx") /* getAlertModalItemKey */.AlertActionButton, obj1, "confirm"), ];
  const obj2 = { variant: "secondary", text: null };
  const intl4 = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj2[1] = intl4.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["Nr6v2+"]);
  items[1] = callback(require("../../../design/components/AlertModal/native/AlertModal.native.tsx") /* getAlertModalItemKey */.AlertActionButton, obj2, "cancel");
  obj[0] = items;
