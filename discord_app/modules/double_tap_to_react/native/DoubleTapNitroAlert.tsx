...
export default function DoubleTapNitroAlert(emojiName) {
  ...
  obj[1] = callback(CircleErrorIcon /* CircleErrorIcon */.CircleErrorIcon, { size: "custom", style: { width: 40, height: 40 } });
  obj[0] = callback(View, obj);
  const intl = getSystemLocale /* getSystemLocale */.intl;
  obj[1] = intl.string(getSystemLocale /* getSystemLocale */.t.HRAWfC);
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj[2] = intl2.format(getSystemLocale /* getSystemLocale */.t["3u/Je4"], { emojiName: emojiName.emojiName, onRenewNitro: callback1 });
  obj = { children: null };
  const obj1 = { onPress: callback, text: null };
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj1[1] = intl3.string(getSystemLocale /* getSystemLocale */.t.LIIHRy);
  const items = [callback(getAlertModalItemKey /* getAlertModalItemKey */.AlertActionButton, obj1, "confirm"), ];
  const obj2 = { variant: "secondary", text: null };
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj2[1] = intl4.string(getSystemLocale /* getSystemLocale */.t["Nr6v2+"]);
  items[1] = callback(getAlertModalItemKey /* getAlertModalItemKey */.AlertActionButton, obj2, "cancel");
  obj[0] = items;
