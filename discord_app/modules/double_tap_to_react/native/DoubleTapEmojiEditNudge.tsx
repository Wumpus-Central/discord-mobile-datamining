...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const items3 = [closure_11(_location(4632).Text, obj), , ];
  ...
  obj1.name = str;
  items3[1] = closure_11(emoji(7233), obj1);
  ...
  obj2.children = closure_11(_location(4632).Text, obj3);
  items3[2] = closure_11(_location(5204).PressableOpacity, obj2);
  obj.children = items3;
