...
function DoubleTapEmojiEditNudgeInner(location) {
  ...
  const items3 = [closure_11(_location(4602).Text, obj), , ];
  ...
  obj1.name = str;
  items3[1] = closure_11(emoji(7203), obj1);
  ...
  obj2.children = closure_11(_location(4602).Text, obj3);
  items3[2] = closure_11(_location(5174).PressableOpacity, obj2);
  obj.children = items3;
...
let closure_14 = createStyles.createStyles((arg0) => {
  ...
  const obj1 = { marginTop: nativeDefault.space.PX_8, flexDirection: "row", alignItems: "center", justifyContent: "center", flexWrap: "wrap" };
