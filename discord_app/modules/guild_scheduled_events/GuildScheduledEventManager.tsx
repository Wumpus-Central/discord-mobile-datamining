          ...
          if (0 !== guildScheduledEventsForGuild.getGuildScheduledEventsForGuild(closure_0).length) {
            if (!set.has(closure_0)) {
              if (!set2.has(closure_0)) {
                ...
                c6 = 1;
                const obj5 = {
                  value: GuildScheduledEventsActionCreatorsDefault.getGuildEventsForCurrentUser(closure_0),
                  done: false,
                };
                return obj5;
              }
        ...
        if (0 === c6) {
          if (arg0 === 1) {
            ...
            if (null != lastSelectedGuildId) {
              guildScheduledEventsForGuild =
                guildScheduledEventsForGuild.getGuildScheduledEventsForGuild(lastSelectedGuildId);
    ...
    if (c9 === 2) {
      ...
      while (true) {
        ...
        if (guildId !== undefined) {
          ...
          c9 = 1;
          let obj10 = {
            value: closure_133_1.getGuildEventUserCounts(closure_133_0, closure_132_0.id, []),
            done: false,
          };
          return obj10;
        }
