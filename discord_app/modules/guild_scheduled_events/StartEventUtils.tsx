    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          const obj2 = { guildId: closure_131_0.id, type: closure_132_9.GUILD_STAGE_VOICE, name: closure_131_1.substring(0, 100), permissionOverwrites: closure_131_3 };
          c5 = 2;
          c6 = 1;
        ...
        if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            if (closure_131_7.STAGE_INSTANCE === entity_type) {
              ...
              c4 = 2;
              c5 = 1;
              const obj2 = { value: obj8.startStageInstance(channel_id, name, closure_131_8.GUILD_ONLY, closure_130_1, id), done: false };
              return obj2;
              ...
              c4 = 4;
              c5 = 1;
              const obj4 = { value: obj3.startEvent(id, guild_id), done: false };
              return obj4;
            }
          }
        } else if (2 === tmp5) {
