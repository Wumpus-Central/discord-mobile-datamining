          ...
          try {
            ...
            if (0 === c7) {
              ...
              if (arg0 === 1) {
                ...
                obj2[0] = callback2(9861).preStartEventActions(callback, permissionOverwrites);
                return obj2;
              }
            } else {
              if (2 === tmp7) {
                c6 = 0;
                aPIError = new callback(4346).APIError(closure_5);
                callback2(aPIError);
                callback(false);
                callback(false);
                c8 = 3;
