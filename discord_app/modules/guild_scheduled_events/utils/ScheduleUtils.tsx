...
import m from "../../../../_runtime/09667_m.js";
...
let items = [
  fn(9667).RRule.MO.weekday,
  fn(9667).RRule.TU.weekday,
  fn(9667).RRule.WE.weekday,
  fn(9667).RRule.TH.weekday,
  fn(9667).RRule.FR.weekday,
];
let items1 = [
  fn(9667).RRule.SU.weekday,
  fn(9667).RRule.MO.weekday,
  fn(9667).RRule.TU.weekday,
  fn(9667).RRule.WE.weekday,
  fn(9667).RRule.TH.weekday,
