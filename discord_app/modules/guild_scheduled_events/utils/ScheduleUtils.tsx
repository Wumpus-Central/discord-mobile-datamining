...
import m from "../../../../_runtime/09834_m.js";
...
let items = [
  fn(9834).RRule.MO.weekday,
  fn(9834).RRule.TU.weekday,
  fn(9834).RRule.WE.weekday,
  fn(9834).RRule.TH.weekday,
  fn(9834).RRule.FR.weekday,
];
let items1 = [
  fn(9834).RRule.SU.weekday,
  fn(9834).RRule.MO.weekday,
  fn(9834).RRule.TU.weekday,
  fn(9834).RRule.WE.weekday,
  fn(9834).RRule.TH.weekday,
...
export const getEventTimeData = function getEventTimeData(scheduled_start_time, toISOStringResult1, arg2) {
  ...
  if (null != toISOStringResult1) {
    if ("" !== toISOStringResult1) {
      const obj3 = _modDef4414(toISOStringResult1);
    }
  }
  ...
  if (result <= 1) {
    ...
    if (null == obj3) {
      ...
      obj5.upcomingEvent = obj2 <= _modDef4414().add(1, "hour");
      const obj10 = _modDef4414();
      obj5.withinStartWindow = obj2 <= _modDef4414().add(15, "minute");
...
export const getBaseScheduleForRecurrence = function getBaseScheduleForRecurrence(nextRecurrenceIdInEvent, guildEvent) {
  ...
  if (null != scheduled_start_time) {
    ...
    if (null != scheduled_end_time) {
      obj.endDate = _modDef4414(scheduled_end_time);
      tmp = obj;
    }
  }
...
export const getScheduleFromEventData = function getScheduleFromEventData(arg0) {
  ...
  if (null != scheduledStartTime) {
    ...
    if (null != scheduledEndTime) {
      obj.endDate = _modDef4414(scheduledEndTime);
      tmp = obj;
    }
  }
  return tmp;
