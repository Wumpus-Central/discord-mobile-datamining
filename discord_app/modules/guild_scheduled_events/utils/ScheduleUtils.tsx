...
import m from "../../../../_runtime/09799_m.js";
...
let items = [
  fn(9799).RRule.MO.weekday,
  fn(9799).RRule.TU.weekday,
  fn(9799).RRule.WE.weekday,
  fn(9799).RRule.TH.weekday,
  fn(9799).RRule.FR.weekday,
];
let items1 = [
  fn(9799).RRule.SU.weekday,
  fn(9799).RRule.MO.weekday,
  fn(9799).RRule.TU.weekday,
  fn(9799).RRule.WE.weekday,
  fn(9799).RRule.TH.weekday,
...
export const getEventTimeData = function getEventTimeData(scheduled_start_time, toISOStringResult1, arg2) {
  ...
  if (null != toISOStringResult1) {
    if ("" !== toISOStringResult1) {
      const obj3 = _modDef4231(toISOStringResult1);
    }
  }
  ...
  if (result <= 1) {
    ...
    if (null == obj3) {
      ...
      obj5.upcomingEvent = obj2 <= _modDef4231().add(1, "hour");
      const obj10 = _modDef4231();
      obj5.withinStartWindow = obj2 <= _modDef4231().add(15, "minute");
...
export const getBaseScheduleForRecurrence = function getBaseScheduleForRecurrence(nextRecurrenceIdInEvent, guildEvent) {
  ...
  if (null != scheduled_start_time) {
    ...
    if (null != scheduled_end_time) {
      obj.endDate = _modDef4231(scheduled_end_time);
      tmp = obj;
    }
  }
...
export const getScheduleFromEventData = function getScheduleFromEventData(arg0) {
  ...
  if (null != scheduledStartTime) {
    ...
    if (null != scheduledEndTime) {
      obj.endDate = _modDef4231(scheduledEndTime);
      tmp = obj;
    }
  }
  return tmp;
