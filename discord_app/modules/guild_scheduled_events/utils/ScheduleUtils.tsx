...
import m from "../../../../_runtime/09818_m.js";
...
let items = [
  fn(9818).RRule.MO.weekday,
  fn(9818).RRule.TU.weekday,
  fn(9818).RRule.WE.weekday,
  fn(9818).RRule.TH.weekday,
  fn(9818).RRule.FR.weekday,
];
let items1 = [
  fn(9818).RRule.SU.weekday,
  fn(9818).RRule.MO.weekday,
  fn(9818).RRule.TU.weekday,
  fn(9818).RRule.WE.weekday,
  fn(9818).RRule.TH.weekday,
