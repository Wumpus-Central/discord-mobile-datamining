...
import useGuildScheduledEventsDefault from "useGuildScheduledEvents" /* 9667 */;
...
export default function useEventsButtonProps(id) {
  ...
  const handleLongPress = noop.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(12379, dependencyMap.paths), "UpcomingEventsLongPress-" + user.id, obj);
  }, items4);
  if (arr4.length > 0) {
