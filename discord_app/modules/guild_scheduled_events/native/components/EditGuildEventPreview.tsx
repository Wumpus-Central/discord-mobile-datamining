...
let obj2 = {
  ...
  centerContainer: { flexGrow: 0, width: "100%" },
...
export default function EditGuildEventPreview(guild) {
  ...
  const items2 = [
    closure_6(tmp6(tmp5[19]).GuildEventCardImageHeader, { event: memo }),
    closure_6(tmp6(tmp5[19]).GuildEventCardHeader, { event: memo, isPreview: true }),
    closure_6(tmp6(tmp5[19]).GuildEventCardMetaInfo, { event: memo }),
    closure_6(tmp6(tmp5[19]).GuildEventSimpleLocation, { event: memo }),
  ];
  ...
  if (null != error) {
    ...
    tmp8Result = closure_6(tmp6(tmp5[15]).LegacyText, obj6);
  }
  const items5 = [
    tmp8Result,
