...
export default function GuildEventRecurrence(recurrenceId) {
  ...
  obj = guildEventId(9739)(recurrenceId, id);
  ...
  const tmp2Result1 = recurrenceId(9741);
  ...
  if (null == stateFromStores) {
    ...
    obj1.children = closure_8(tmp2(9842).GuildEventCardHeader, obj2);
    const items5 = [closure_8(tmp2(5173).PressableOpacity, obj1), ];
    ...
    if (tmp21Result) {
      ...
      tmp21Result = closure_8(tmp2(4601).Text, obj4);
    }
    ...
    const obj6 = { source: tmp5(9870), size: tmp2(1178).Icon.Sizes.REFRESH_SMALL_16, style: tmp.secondarySmallIcon };
    obj5.children = closure_8(tmp2(1178).Icon, obj6);
    items6[1] = closure_8(tmp2(5173).PressableOpacity, obj5);
    obj3.children = items6;
    items5[1] = closure_9(stateFromStores1, obj3);
    obj.children = items5;
    return closure_9(stateFromStores1, obj);
  }
  const tmp2Result2 = recurrenceId(9738);
};