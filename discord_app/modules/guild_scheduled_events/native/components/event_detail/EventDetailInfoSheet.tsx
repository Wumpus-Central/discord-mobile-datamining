...
export default function EventDetailInfoSheet(guildEvent) {
  ...
  obj6.style = items7;
  const items8 = [
    closure_12(guildEvent(9904).GuildEventCardHeader, {
      event: guildEvent,
    ...
    closure_12(guildEvent(9904).GuildEventCardTitle, {
      event: guildEvent,
      textStyle: tmp.eventTitle,
      style: tmp.eventTitleContainer,
    }),
    closure_12(guildEvent(9904).GuildEventCardSimpleGuildInfo, { event: guildEvent, textStyle: tmp.guildTextStyle }),
    closure_12(guildEvent(9904).GuildEventSimpleLocation, { event: guildEvent }),
    ,
    ,
    ,
    ,
  ...
  if (tmp11Result) {
    ...
    items10[1] = closure_12(tmp2(4635).Text, obj16);
    obj14.children = items10;
    tmp11Result = closure_13(tmp12, obj14);
  }
  items8[5] = tmp11Result;
  items8[6] = closure_12(guildEvent(9904).GuildEventCardDescription, {
    event: guildEvent,
  ...
  if (stateFromStores1) {
    ...
    tmp13Result = closure_12(tmp2(9904).GuildEventShareAction, obj22);
  }
