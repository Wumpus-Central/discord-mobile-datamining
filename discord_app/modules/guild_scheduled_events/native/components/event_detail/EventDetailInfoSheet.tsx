...
export default function EventDetailInfoSheet(guildEvent) {
  ...
  obj6.style = items7;
  const items8 = [
    closure_12(guildEvent(9062).GuildEventCardHeader, {
      event: guildEvent,
    ...
    closure_12(guildEvent(9062).GuildEventCardTitle, {
      event: guildEvent,
      textStyle: tmp.eventTitle,
      style: tmp.eventTitleContainer,
    }),
    closure_12(guildEvent(9062).GuildEventCardSimpleGuildInfo, { event: guildEvent, textStyle: tmp.guildTextStyle }),
    closure_12(guildEvent(9062).GuildEventSimpleLocation, { event: guildEvent }),
    ,
    ,
    ,
    ,
  ...
  if (tmp11Result) {
    ...
    items10[1] = closure_12(tmp2(4832).Text, obj16);
    obj14.children = items10;
    tmp11Result = closure_13(tmp12, obj14);
  }
  items8[5] = tmp11Result;
  items8[6] = closure_12(guildEvent(9062).GuildEventCardDescription, {
    event: guildEvent,
  ...
  if (stateFromStores1) {
    ...
    tmp13Result = closure_12(tmp2(9062).GuildEventShareAction, obj22);
  }
