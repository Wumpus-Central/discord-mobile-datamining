...
export default function EventDetailInfoSheet(guildEvent) {
  ...
  const effect = React.useEffect(() => {
    const guildEventUserCounts = closure_1_1(closure_1_2[17]).getGuildEventUserCounts(
      guildEvent.guild_id,
      guildEvent.id,
      [],
    );
  ...
  obj6[2] = intl.format(guildEvent(1233).t["+DLsD8"], {
  ...
  items8[6] = callback(guildEvent(9767).GuildEventCardDescription, {
    event: guildEvent,
