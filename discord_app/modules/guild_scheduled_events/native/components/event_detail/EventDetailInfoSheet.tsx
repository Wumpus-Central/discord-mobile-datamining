...
export default function EventDetailInfoSheet(guildEvent) {
  ...
  obj6.style = items7;
  const items8 = [
    closure_12(guildEvent(9868).GuildEventCardHeader, {
      event: guildEvent,
    ...
    closure_12(guildEvent(9868).GuildEventCardTitle, {
      event: guildEvent,
      textStyle: tmp.eventTitle,
      style: tmp.eventTitleContainer,
    }),
    closure_12(guildEvent(9868).GuildEventCardSimpleGuildInfo, { event: guildEvent, textStyle: tmp.guildTextStyle }),
    closure_12(guildEvent(9868).GuildEventSimpleLocation, { event: guildEvent }),
    ,
    ,
    ,
    ,
  ...
  items8[6] = closure_12(guildEvent(9868).GuildEventCardDescription, {
    event: guildEvent,
  ...
  if (stateFromStores1) {
    ...
    tmp13Result = closure_12(tmp2(9868).GuildEventShareAction, obj22);
  }
