...
import registerAssetDefault from "registerAsset" /* 9691 */;
...
const memoResult = importAllResult.memo((eventUser) => {
  ...
  return closure_7(eventUser(8295).FormRow, obj, eventUser.user_id);
});
