...
import EventDetailTypes from "EventDetailTypes" /* 9874 */;
...
function RemainingUsersRow(remainingUsersGroup) {
  ...
  obj = { source: _modDef9872, style: tmp.remainingUsersIcon };
...
const memoResult = noop.memo((eventUser) => {
  ...
  return closure_7(eventUser(8663).FormRow, obj, eventUser.user_id);
});
