...
export default function UpcomingEventsLongPressActionSheet(guildId) {
  ...
  obj1[1] = guildId(6004).GuildIconSizes.LARGE;
  obj[1] = callback(stateFromStores1(6004), obj1);
  ...
  obj2[1] = callback(guildId(8363).FormLabel, obj4);
  ...
  items2[1] = callback(guildId(8363).FormRow, obj2);
  ...
  obj5[1] = callback(guildId(8363).FormLabel, { text: stringResult });
