...
export default function UpcomingEventsLongPressActionSheet(guildId) {
  ...
  items2[1] = callback(guildId(8008).FormRow, obj2);
  const obj5 = { leading: null, label: null, onPress: null };
  const obj6 = { source: null };
  obj6[0] = tmp8(stateFromStores1 ? 11811 : 11812);
  ...
  obj5[1] = callback(guildId(8008).FormLabel, { text: stringResult });
  ...
  items2[2] = callback(guildId(8008).FormRow, obj5);
  obj7[0] = items2;
  return tmp6(guildId(5803).ActionSheet, obj7);
};