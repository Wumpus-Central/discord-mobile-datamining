...
export const GuildEventShareAction = function GuildEventShareAction(event) {
  ...
  obj.icon = importDefault(tmp3 ? 9144 : 4550);
  return closure_22(event(8172).IconButton, obj);
};
...
export const GuildEventCardHeader = function GuildEventCardHeader(event) {
  ...
  obj = {
    ...
    theme: tmp4,
    event,
    isCanceled: undefined !== is_canceled && is_canceled,
    recurrenceId,
  };
...
export const GuildEventCardMetaInfo = function GuildEventCardMetaInfo(textStyle) {
  ...
  const items = [
    __initData2(GuildEventCardTitle, obj),
...
export const GuildEventSimpleLocation = function GuildEventSimpleLocation(event) {
  ...
  if (null != stateFromStores) {
    ...
    let combined = stateFromStores(9861)(obj2);
  ...
  obj1.children = tmp7;
  items4[1] = closure_22(channel_id(4602).Text, obj1);
  obj.children = items4;
...
export const GuildEventCardSimpleGuildInfo = function GuildEventCardSimpleGuildInfo(arg0) {
  ...
  if (null != stateFromStores) {
    ...
    obj.style = items2;
    obj = { guild: stateFromStores, size: tmp2(5635).GuildIconSizes.XSMALL_20, style: tmp.guildIcon };
    ...
    obj1.children = closure_22(tmp2(4602).Text, obj2);
