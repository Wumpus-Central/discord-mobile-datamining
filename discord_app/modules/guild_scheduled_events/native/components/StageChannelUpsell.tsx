...
export default function StageChannelUpsell(arg0) {
  ...
  if (!tmp2[0]) {
    ...
    obj[3] = callback3(require("../../../../design/void/native.tsx") /* Button */.Icon, obj);
    const items = [callback3(require("../../../../design/void/Pressables/native/Pressables.tsx") /* PressableBase */.PressableOpacity, obj), , , , , ];
    const obj1 = { source: null, style: null };
    obj1[0] = require("../../../../../_runtime/08913_registerAsset.js");
    obj1[1] = tmp.image;
    ...
    obj2[3] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.Sx8Ezi);
    items[2] = callback3(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj2);
    const obj3 = { style: null, variant: "text-sm/medium", color: "text-default", children: null };
    obj3[0] = tmp.description;
    const intl2 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    obj3[3] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.JUzPhm);
    items[3] = callback3(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj3);
    ...
    obj4[3] = intl3.format(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.Vh7rP7, obj5);
    items[4] = callback3(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj4);
    const obj6 = { style: null, children: null };
    obj6[0] = tmp.button;
    const obj7 = { variant: "secondary", size: "md", text: null, onPress: null };
    const intl4 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    obj7[2] = intl4.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["X/3SyA"]);
    ...
    obj6[1] = callback3(require("../../../../design/components/Button/native/Button.native.tsx") /* Button */.Button, obj7);
