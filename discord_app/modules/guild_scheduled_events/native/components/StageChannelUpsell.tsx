...
export default function StageChannelUpsell(arg0) {
  ...
  if (!tmp2[0]) {
    ...
    obj = { source: null };
    obj[0] = registerAsset;
    obj[3] = callback3(Button /* Button */.Icon, obj);
    const items = [callback3(PressableBase /* PressableBase */.PressableOpacity, obj), , , , , ];
    ...
    obj2[3] = intl.string(getSystemLocale /* getSystemLocale */.t.Sx8Ezi);
    items[2] = callback3(Text /* Text */.Text, obj2);
    const obj3 = { style: null, variant: "text-sm/medium", color: "text-default", children: null };
    obj3[0] = tmp.description;
    const intl2 = getSystemLocale /* getSystemLocale */.intl;
    obj3[3] = intl2.string(getSystemLocale /* getSystemLocale */.t.JUzPhm);
    items[3] = callback3(Text /* Text */.Text, obj3);
    ...
    obj4[3] = intl3.format(getSystemLocale /* getSystemLocale */.t.Vh7rP7, obj5);
    items[4] = callback3(Text /* Text */.Text, obj4);
    const obj6 = { style: null, children: null };
    obj6[0] = tmp.button;
    const obj7 = { variant: "secondary", size: "md", text: null, onPress: null };
    const intl4 = getSystemLocale /* getSystemLocale */.intl;
    obj7[2] = intl4.string(getSystemLocale /* getSystemLocale */.t["X/3SyA"]);
    ...
    obj6[1] = callback3(Button /* Button */.Button, obj7);
