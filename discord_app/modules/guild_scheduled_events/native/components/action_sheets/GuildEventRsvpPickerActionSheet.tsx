...
export default function GuildEventRsvpPickerActionSheet(event) {
  ...
  obj = { header: closure_7(tmp2(7222).BottomSheetTitleHeader, { title: stringResult }), children: null };
  ...
  const items = [closure_7(event(5736).TableRadioGroup, obj1)];
  ...
  obj2.children = closure_7(event(5026).Button, obj3);
  items[1] = closure_7(closure_5, obj2);
  obj.children = items;
  obj.children = closure_8(event(7196).SafeAreaPaddingView, obj);
  return closure_7(event(7223).BottomSheet, obj);
}
