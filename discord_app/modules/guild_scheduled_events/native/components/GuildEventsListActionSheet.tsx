...
function GuildEventsListHeader(arg0) {
  ...
  if (tmp3Result) {
    ...
    tmp3Result = jsx(guild(9848).ActionSheetHeaderPressableText, { accessibilityLabel: null, label: null, onPress: null });
  }
...
export default function GuildEventsListActionSheet(guild) {
  ...
  obj.children = jsx(events(9936), { inActionSheet: true, events, onPressEvent: callback1, onCloseAction: callback, guild, lastAckedId: null });
