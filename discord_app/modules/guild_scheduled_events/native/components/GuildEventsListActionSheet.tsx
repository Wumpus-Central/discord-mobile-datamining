...
export default function GuildEventsListActionSheet(guild) {
  ...
  obj1.lastAckedId = events(5637)(ref);
  obj.children = jsx(events(9897), { inActionSheet: true, events, onPressEvent: callback1, onCloseAction: callback, guild, lastAckedId: null });
  obj.children = <View style={tmp.container}>{null}</View>;
  return jsx(guild(7223).BottomSheet, { style: tmp.container, children: null });
};