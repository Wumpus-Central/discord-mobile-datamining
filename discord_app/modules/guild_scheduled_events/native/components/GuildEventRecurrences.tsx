...
export default function GuildEventRecurrences(guildEventId) {
  ...
  items[1] = closure_6(closure_5, {
    ...
    children: recurrenceStartTimes.map((getTime) => {
      ...
      return timestampProducer(
        ...
        { recurrenceId: fromTimestampResult, guildEventId, onPress, isActive: fromTimestampResult === dependencyMap },
        fromTimestampResult,
      );
    }),
  });
  ...
  if (canViewMoreRecurrences) {
    ...
    canViewMoreRecurrences = closure_6(tmp8(5060).Button, obj4);
  }
