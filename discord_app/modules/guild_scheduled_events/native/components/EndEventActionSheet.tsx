...
export default function EndEventActionSheet(channel) {
  ...
  if (null == activeEvent) {
    ...
    items[1] = closure_5(tmp2(4601).Text, obj2);
    ...
    obj3.children = closure_5(tmp2(5025).Button, obj4);
    ...
    obj5.children = closure_5(tmp2(5025).Button, obj6);
    items[3] = closure_5(View, obj5);
    obj.children = items;
    obj.children = closure_6(View, obj);
    return closure_5(activeEvent(8661), obj);
  }
};