...
export const GuildEventRecurrence = function GuildEventRecurrence(startDate) {
  ...
  obj.children = closure_11(startDate(4601).Text, obj1);
  ...
  let obj2 = {
    onPress() {
      ...
      obj2.openLazy(asyncRequireImpl(9496, dependencyMap.paths), "SelectRecurrenceOption", obj);
    },
    text: null,
    value: null,
    icon: null,
...
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  obj.children = items1;
  obj.children = closure_12(time(5023).Stack, obj);
