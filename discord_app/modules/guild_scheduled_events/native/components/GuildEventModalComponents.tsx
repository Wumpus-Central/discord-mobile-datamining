...
export const GuildEventTopic = function GuildEventTopic(arg0) {
  ...
  obj[4] = topic;
  obj[5] = closure_9;
  obj[1] = callback(require(7701) /* TextInput */.TextInput, obj);
...
export const GuildEventRecurrence = function GuildEventRecurrence(startDate) {
  ...
  obj2[2] = label;
  obj2[3] = recurrenceRule(8558);
  const intl3 = tmp2(1236).intl;
  obj2[5] = intl3.string(startDate(1236).t["59TVxL"]);
  obj2[6] = label;
  items1[1] = callback(startDate(8547).InputButton, obj2);
  obj[1] = items1;
...
export const GuildEventEntityTypeSelection = function GuildEventEntityTypeSelection(arg0) {
  ...
  let obj = require(8559) /* useChannelsUserCanStartStageIn */;
  ...
  obj[3] = importDefault(8560);
  obj[4] = require(4781) /* VoiceNormalIcon */.VoiceNormalIcon;
  obj[5] = disabled;
  const items = [obj, ];
  obj = { name: null, value: null, description: null, icon: null, IconComponent: null, disabled: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  ...
  obj[3] = importDefault(8561);
  obj[4] = require(8562) /* LocationIcon */.LocationIcon;
  obj[5] = disabled;
  items[1] = obj;
  ...
  if (features.has(GuildFeatures.COMMUNITY)) {
    ...
    obj1[3] = importDefault(7811);
    obj1[4] = tmp(4777).StageIcon;
  ...
  return callback(require(7783) /* context */.TableRadioGroup, obj2);
};
export const GuildEventDescription = function GuildEventDescription(onFocus) {
  ...
  obj[5] = description;
  obj[2] = callback(onFocus(7774).TextArea, obj);
  return callback(View, obj);
};
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  obj3[2] = () => {
    if (!disabled) {
      ...
      openLazyResult = obj2.openLazy(require(1959) /* asyncRequireImpl */(8564, dependencyMap.paths), "DatePicker", obj);
      obj5 = outer1_3;
      const tmp8 = require(1959) /* asyncRequireImpl */(8564, dependencyMap.paths);
    }
  };
  obj3[3] = disabled;
  items[1] = callback(time(8547).InputButton, obj3);
  obj1[1] = items;
  ...
  obj6[3] = disabled;
  items2[1] = callback(time(8547).InputButton, obj6);
  obj4[1] = items2;
  items1[1] = callback2(disabled, obj4);
  obj[2] = items1;
  obj[1] = callback2(time(4664).Stack, obj);
