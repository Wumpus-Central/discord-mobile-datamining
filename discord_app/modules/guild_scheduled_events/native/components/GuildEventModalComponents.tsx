...
import _modDef9804 from "../../../../../_runtime/metro/09804__.js";
import _modDef9805 from "../../../../../_runtime/metro/09805__.js";
...
export const GuildEventRecurrence = function GuildEventRecurrence(startDate) {
  ...
  obj.children = closure_11(startDate(4602).Text, obj1);
  ...
  let obj2 = {
    onPress() {
      ...
      obj2.openLazy(asyncRequireImpl(9517, dependencyMap.paths), "SelectRecurrenceOption", obj);
    },
    text: null,
    value: null,
    icon: null,
...
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  obj.children = items1;
  obj.children = closure_12(time(5024).Stack, obj);
