...
export const GuildEventRecurrence = function GuildEventRecurrence(startDate) {
  ...
  obj.children = closure_11(startDate(4570).Text, obj1);
  ...
  let obj2 = {
    onPress() {
      ...
      obj2.openLazy(asyncRequireImpl(9458, dependencyMap.paths), "SelectRecurrenceOption", obj);
    },
    text: null,
    value: null,
    icon: null,
...
export const GuildEventDatetime = function GuildEventDatetime(dateLabel) {
  ...
  obj.children = items1;
  obj.children = closure_12(time(4987).Stack, obj);
