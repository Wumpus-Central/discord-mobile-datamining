...
export default function GuildEventSchedule(schedule) {
  ...
  const addResult = obj.add(schedule(9735).MAX_DAYS_AHEAD_AN_EVENT_CAN_START, "days");
  ...
  const children = [closure_4(schedule(9780).GuildEventDatetime, obj), ];
  ...
  if (tmp9Result) {
    ...
    tmp9Result = closure_4(tmp3(9780).GuildEventDatetime, obj);
  }
