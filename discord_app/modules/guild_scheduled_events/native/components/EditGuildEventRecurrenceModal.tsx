...
export default function EditGuildEventRecurrenceModal(guildEvent) {
  ...
  const scheduleForRecurrenceWithException = guildEvent(9832).getScheduleForRecurrenceWithException(
      ...
      screens: {
        [closure_11.TIME]: {
          ...
          render() {
            ...
            const items = [
              React6(GuildEventScheduleDefault, { guildEvent, recurrenceId, schedule, onChange: handleScheduleChange }),
            ];
            let tmp4Result = null;
            if (null != first) {
