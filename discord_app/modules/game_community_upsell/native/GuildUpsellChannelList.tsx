...
let items = [
  {
    ...
    Icon: fn(5778).BumpingFistsSpotIllustration,
  },
  ,
];
const obj14 = {
...
items[1] = {
  ...
  Icon: fn(5778).ChatControllersSpotIllustration,
};
const obj15 = {
  id: "gaming",
  title: fn(1115).t["F+MTAZ"],
...
items[2] = {
  ...
  Icon: fn(5778).MiniaturesSpotIllustration,
};
const size = fn(2);
...
export default function GuildUpsellChannelList(style) {
  ...
  const callback = youBarTotalHeight.useCallback((guild_id, game_id) => {
    ...
    stateFromStoresArray(callback2[13]).track(constants.GAME_COMMUNITY_MULTI_GUILD_UPSELL_CARD_DISMISSED, {
      game_id,
      guild_id,
    });
  }, []);
  ...
  const memo = youBarTotalHeight.useMemo(() => {
    ...
    items[2] = closure_2_10(hasOwnProperty, {
      ...
      children: items.map((Icon) => {
        ...
        items = [
          closure_2_10(closure_2_6, {
            style: closure_1_0.templateIconWrapper,
            children: closure_2_10(Icon.Icon, { width: 114, height: 64 }),
          }),
        ];
    ...
    if (tmpResult) {
      ...
      const items2 = [closure_2_10(Text_Text.Text, obj9)];
      const obj10 = {
      ...
      items2[1] = closure_2_10(Text_Text.Text, obj10);
      obj8.children = items2;
      tmpResult = closure_2_11(timestampProducer, obj8);
    }
    items[4] = tmpResult;
    obj.children = items;
