...
export const OneColumnGuildUpsellList = function OneColumnGuildUpsellList(cardAction) {
  ...
  let tmp = callback();
  analyticsLocations = analyticsLocations(5962)(
    analyticsLocations(5982).GAME_COMMUNITY_MULTI_GUILD_UPSELL_GUILDS_BAR_ENTRYPOINT,
  ).analyticsLocations;
  ...
  obj[10] = callback1;
  obj[12] = callback2;
  return jsx(stateFromStoresObject(8116).FlashList, {
    ref,
    style: null,
    onViewableItemsChanged: null,
    viewabilityConfig: null,
