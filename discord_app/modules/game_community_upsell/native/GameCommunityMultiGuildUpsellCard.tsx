...
import closure_9 from "../../lurker_mode/LurkingStore.tsx";
...
createCacheKey[12] = {
  ...
  height: 12,
  borderRadius: 6,
  backgroundColor: ThemesDefault.colors.TEXT_STATUS_OFFLINE,
};
...
createCacheKey[14] = {
  ...
  top: 8,
  right: 8,
  width: 2 * ThemesDefault.radii.lg,
  height: 2 * ThemesDefault.radii.lg,
  borderRadius: ThemesDefault.radii.lg,
...
const result = require("set").fileFinishedImporting(
  "modules/game_community_upsell/native/GameCommunityMultiGuildUpsellCard.tsx",
);
...
export default function GameCommunityMultiGuildUpsellCard(guild) {
  ...
  const items11 = [
    closure_14(tmp18(onDismiss[21]), obj9),
