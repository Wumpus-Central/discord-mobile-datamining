...
import ApplicationCollectionSurface from "../../../discord_common/js/shared/shared-constants/ApplicationCollectionSurface.tsx";
import ApplicationCollectionActiveState from "../../../discord_common/js/shared/shared-constants/ApplicationCollectionActiveState.tsx";
...
import ApplicationDirectoryApplicationsStore from "stores/ApplicationDirectoryApplicationsStore.tsx";
import ApplicationDirectoryCategoriesStore from "stores/ApplicationDirectoryCategoriesStore.tsx";
import ApplicationDirectoryCollectionsStore from "stores/ApplicationDirectoryCollectionsStore.tsx";
import ApplicationDirectorySearchStore from "stores/ApplicationDirectorySearchStore.tsx";
import ApplicationDirectorySimilarApplicationsStore from "stores/ApplicationDirectorySimilarApplicationsStore.tsx";
import MyGuildApplicationsStore from "stores/MyGuildApplicationsStore.tsx";
        ...
        if (0 === c6) {
          if (arg0 === 1) {
            ...
            if (applicationFetchState.getApplicationFetchState(applicationId) !== constants.FETCHING) {
              if (!applicationFetchState.isInvalidApplication(applicationId)) {
                if (timestamp >= tmp21 + closure_2_18) {
                  ...
                  const obj7 = {
                    url: Endpoints.APPLICATION_DIRECTORY_EMBED_APPLICATION(applicationId),
                    backoff: tmp44,
                    retries: 10,
                    interceptResponse,
        ...
        if (1 === tmp7) {
          if (arg0 === 1) {
            ...
            if (applicationFetchState !== closure_132_7.FETCHING) {
              ...
              const request = {
                url: closure_132_17.APPLICATION_DIRECTORY_APPLICATION(closure_131_0),
                query: null,
        ...
        if (1 === tmp7) {
          if (arg0 === 1) {
            ...
            if (fetchState !== closure_132_14.FETCHING) {
              ...
              const HTTP = closure_132_0(closure_132_2[13]).HTTP;
              const request = {
                url: closure_132_17.APPLICATION_DIRECTORY_SIMILAR(closure_131_0),
                query: null,
                rejectWithError: true,
              };
          ...
          if (2 === tmp7) {
            ...
            const obj13 = {
              ...
              applicationId: closure_131_0,
              guildId: closure_131_1,
              similarApplications: closure_131_7.body.applications,
              loadId: closure_131_7.body.load_id,
              page: page2,
              totalPages: closure_131_7.body.num_pages,
            };
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          ({
            query: closure_131_0,
            guildId: closure_131_1,
            options: closure_131_2,
            onSuccessCallback: closure_131_3,
          } = closure_0);
          closure_131_4 = undefined;
          let page;
          let pageSize;
        ...
        if (1 === tmp7) {
          if (arg0 === 1) {
            ...
            if (fetchState !== closure_132_12.FETCHING) {
              const obj9 = {
                ...
                categoryId,
                integrationType,
                minUserInstallCommandCount: closure_131_9,
                excludeAppsWithCustomInstallUrl: closure_131_10,
                excludeNonEmbeddedApps: closure_131_11,
                excludeEmbeddedAppsWithoutPrimaryEntryPointAppCommand: closure_131_12,
                source: closure_131_14,
              };
              closure_132_1(closure_132_2[11]).dispatch(obj9);
              c6 = 1;
              const HTTP = closure_132_0(closure_132_2[13]).HTTP;
              ...
              const obj10 = {
                query: closure_131_0,
                guild_id: closure_131_1,
                page,
                page_size: pageSize,
                category_id: categoryId,
                locale: closure_132_5.locale,
                integration_type: integrationType,
                min_user_install_command_count: closure_131_9,
                exclude_apps_with_custom_install_url: closure_131_10,
                exclude_non_embedded_apps: closure_131_11,
                exclude_embedded_apps_without_primary_entry_point_app_command: closure_131_12,
                source: closure_131_14,
              };
              request.query = obj10;
              c7 = 3;
          ...
          if (2 === tmp7) {
            ...
            const obj15 = {
              results: closure_131_18.body.results,
              countsByCategory: closure_131_18.body.counts_by_category,
              totalCount: closure_131_18.body.result_count,
              totalPages: closure_131_18.body.num_pages,
              type: closure_131_18.body.type,
              loadId: closure_131_18.body.load_id,
            };
            obj13.result = obj15;
        ...
        if (1 === tmp7) {
          if (arg0 === 1) {
            ...
            if (fetchState !== closure_130_10.FETCHING) {
              ...
              const obj11 = {
                ...
                surface: closure_129_0,
                activeState: closure_129_1,
              };
              ...
              let get = HTTP.get;
              const request = {
                url: closure_130_17.APPLICATION_DIRECTORY_COLLECTIONS,
                query: null,
                rejectWithError: true,
              };
              const obj12 = {
                surface: closure_129_0,
                active_state: closure_129_1,
                platform: null,
                locale: null,
                cache: null,
              };
          ...
          if (2 === tmp7) {
            ...
            const obj14 = {
              ...
              collections: closure_129_7.body,
              surface: closure_129_0,
              activeState: closure_129_1,
            };
    ...
    try {
      ...
      if (0 === c4) {
        ...
        const obj10 = {
          ...
          guildIdToApplicationIds: closure_128_0.body,
        };
