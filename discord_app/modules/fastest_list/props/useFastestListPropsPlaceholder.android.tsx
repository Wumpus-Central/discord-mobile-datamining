...
function createNativePlaceholderConfig(listFooter) {
  ...
  const size = {
    ...
    placeholderFeedLabelSecondarySize: "PX_8",
    placeholderFeedPadding: "Path",
    placeholderFeedShape: "ref",
