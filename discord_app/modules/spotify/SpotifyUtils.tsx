...
import UserActivityActionCreators from "../../actions/UserActivityActionCreators.tsx";
...
import SpotifyStore from "SpotifyStore.tsx";
...
({
  SPOTIFY_APP_PROTOCOL: closure_7,
  SpotifyResourceTypes: closure_8,
  getSpotifyResourceType: closure_9,
} = SpotifyConstants);
