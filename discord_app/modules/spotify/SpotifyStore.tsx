    ...
    if (null != context) {
      ...
      if (items.includes(context.type)) {
        ...
        if (context.type === tmp12.ALBUM) {
          ...
          const SpotifyAPI = _require(11310).SpotifyAPI;
          const obj2 = { url: null };
          obj2[0] = context.href;
