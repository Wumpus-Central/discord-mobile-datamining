...
const result = require("set").fileFinishedImporting(
  "modules/user_profile/native/UserProfileWidgetsBoardEditNotice.tsx",
);
...
export default function UserProfileWidgetsBoardEditNotice() {
  ...
  let items = [
    require("../../../../discord_common/js/packages/protos/discord_protos/discord_users/v1/dismissible_content.tsx")
      .DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE,
  ];
  obj[0] = items;
  obj[2] = function children(markAsDismissed) {
    ...
    if (
      ...
      callback(closure_1_2[8]).DismissibleContent.USER_PROFILE_WIDGETS_BOARD_MOBILE_EDIT_NOTICE
    ) {
