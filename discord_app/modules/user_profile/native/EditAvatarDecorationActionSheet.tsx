...
function AvatarDecorationSectionPreview(previewSkuId) {
  ...
  const items1 = [
    closure_10(purchase(8385), obj3),
    closure_10(purchase(13323), { user, guildId, pendingAvatarSrc, pendingAvatarDecoration: memo }),
  ];
  obj.children = items1;
...
export default function EditAvatarDecorationActionSheet(arg0) {
  ...
  const pendingAvatarSrc = setPendingAvatarDecoration(8298).getPendingAvatarSrc({
    userId: user.id,
  ...
  const analyticsLocations2 = selectedAvatarDecoration(7272)(
    analyticsLocations,
    tmp2(7292).EDIT_AVATAR_DECORATION_SHEET,
  ).analyticsLocations;
  ...
  obj5.children = closure_11(setPendingAvatarDecoration(7260).BottomSheet, obj6);
