...
function AvatarDecorationSectionPreview(previewSkuId) {
  ...
  const items1 = [
    closure_10(purchase(8487), obj3),
    closure_10(purchase(13422), { user, guildId, pendingAvatarSrc, pendingAvatarDecoration: memo }),
  ];
  obj.children = items1;
...
export default function EditAvatarDecorationActionSheet(arg0) {
  ...
  const pendingAvatarSrc = setPendingAvatarDecoration(8399).getPendingAvatarSrc({
    userId: user.id,
  ...
  const analyticsLocations2 = selectedAvatarDecoration(7358)(
    analyticsLocations,
    tmp2(7378).EDIT_AVATAR_DECORATION_SHEET,
  ).analyticsLocations;
  ...
  obj5.children = closure_11(setPendingAvatarDecoration(7346).BottomSheet, obj6);
