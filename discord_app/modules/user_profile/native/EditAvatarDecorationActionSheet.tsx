...
function EditAvatarDecorationInner(pendingAvatarSrc) {
  ...
  const callback = React.useCallback((arg0) => {
    ...
    return closure_1_10(user(guildId[26]).EditAvatarDecorationRow, {
      items,
      size,
      selectedSkuId,
...
function AvatarDecorationSectionPreview(previewSkuId) {
  ...
  const items1 = [
    callback2(purchase(8257), obj),
    callback2(purchase(13176), { user, guildId, pendingAvatarSrc, pendingAvatarDecoration: memo }),
  ];
  obj[4] = items1;
...
export default function EditAvatarDecorationActionSheet(arg0) {
  ...
  const analyticsLocations2 = first(7162)(
    analyticsLocations,
    tmp2(7182).EDIT_AVATAR_DECORATION_SHEET,
  ).analyticsLocations;
