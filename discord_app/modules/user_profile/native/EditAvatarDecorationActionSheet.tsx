// === Module 8079: EditAvatarDecorationInner ===
...
function AvatarDecorationSectionPreview(previewSkuId) {
  ...
  const items1 = [callback2(purchase(8117), obj), callback2(purchase(8132), { user, guildId, pendingAvatarSrc, pendingAvatarDecoration: memo })];
  obj[4] = items1;
...
export default function EditAvatarDecorationActionSheet(arg0) {
  ...
  const analyticsLocations2 = first(5962)(analyticsLocations, tmp2(5982).EDIT_AVATAR_DECORATION_SHEET).analyticsLocations;
