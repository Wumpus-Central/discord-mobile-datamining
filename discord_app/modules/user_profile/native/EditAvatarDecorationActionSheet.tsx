...
function AvatarDecorationSectionPreview(previewSkuId) {
  ...
  const items1 = [
    closure_10(purchase(8404), obj3),
    closure_10(purchase(13331), { user, guildId, pendingAvatarSrc, pendingAvatarDecoration: memo }),
  ];
  obj.children = items1;
...
export default function EditAvatarDecorationActionSheet(arg0) {
  ...
  const pendingAvatarSrc = setPendingAvatarDecoration(8317).getPendingAvatarSrc({
    userId: user.id,
  ...
  const analyticsLocations2 = selectedAvatarDecoration(7276)(
    analyticsLocations,
    tmp2(7296).EDIT_AVATAR_DECORATION_SHEET,
  ).analyticsLocations;
  ...
  obj5.children = closure_11(setPendingAvatarDecoration(7264).BottomSheet, obj6);
