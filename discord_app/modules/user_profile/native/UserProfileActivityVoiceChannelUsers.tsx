...
function UserRow(user) {
  ...
  const stateFromStoresObject = user(589).useStateFromStoresObject(items, () => ({
  ...
  obj = {
    user,
    avatarDecoration,
    size: user(1297).AvatarSizes.REFRESH_MEDIUM_32,
