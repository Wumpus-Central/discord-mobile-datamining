...
import BotReportChooser from "BotReportChooser" /* 12991 */;
    ...
    if (!tmp14) {
      ...
      if (result) {
        ...
        obj2.action = function action() {
          ...
          obj2.openLazy(asyncRequireImpl(12991, dependencyMap.paths), BotReportChooser.BOT_REPORT_CHOOSER_KEY, obj, "replaceAll");
