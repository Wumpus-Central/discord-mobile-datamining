...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(5649)(analyticsLocations, tmp4(5669).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  obj = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(5649);
  ({ cardWidth: c5, rowWidth } = analyticsContext(12397)(obj));
  if (null != rowWidth) {
    obj = { width: null };
    obj[0] = rowWidth;
    let tmp7 = obj;
  ...
  let tmp6 = analyticsContext(12397)(obj);
  ...
  isEligibleForSocialLayerStorefrontMobilePurchasing = wishlistId(8136).useIsEligibleForSocialLayerStorefrontMobilePurchasing({ location: "edit_wishlist_action_sheet" });
  ...
  const tmp2Result2 = wishlistId(8136);
  ...
  obj6[2] = first;
  obj6[3] = callback;
  obj5[1] = callback2(wishlistId(5689).TableSwitchRow, obj6);
  obj4[1] = callback2(wishlistId(5688).TableRowGroup, obj5);
  ...
  if (stateFromStores1) {
    ...
    obj1[3] = tmp17(tmp2(5379).BottomSheetScrollView, obj2);
