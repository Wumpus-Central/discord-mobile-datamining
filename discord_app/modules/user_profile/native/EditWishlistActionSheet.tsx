...
createStyles.loadingContainer = { flex: 1, justifyContent: "center", alignItems: "center", paddingTop: nativeDefault.space.PX_48 };
...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7176)(analyticsLocations, tmp4(7196).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  obj = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  const tmp5 = analyticsContext(7176);
  ({ cardWidth: c5, rowWidth } = analyticsContext(13116)(obj));
  if (null != rowWidth) {
    obj = { width: rowWidth };
    let tmp7 = obj;
  }
  ...
  let tmp6 = analyticsContext(13116)(obj);
  ...
  obj5.children = closure_14(wishlistId(7214).TableSwitchRow, obj6);
  obj4.children = closure_14(wishlistId(5701).TableRowGroup, obj5);
  ...
  if (stateFromStores1) {
    ...
    obj1.children = closure_14(tmp2(6641).BottomSheetScrollView, obj2);
  ...
  tmp4Result = analyticsContext(11183);
};