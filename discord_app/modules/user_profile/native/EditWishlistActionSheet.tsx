...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(5595)(analyticsLocations, tmp4(5615).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET).analyticsLocations;
  obj = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  let tmp5 = analyticsContext(5595);
  ({ cardWidth: c5, rowWidth } = analyticsContext(12360)(obj));
  if (null != rowWidth) {
    obj = { width: null };
    obj[0] = rowWidth;
    let tmp7 = obj;
  ...
  let tmp6 = analyticsContext(12360)(obj);
  ...
  isEligibleForSocialLayerStorefrontMobilePurchasing = wishlistId(7995).useIsEligibleForSocialLayerStorefrontMobilePurchasing({ location: "edit_wishlist_action_sheet" });
  ...
  const tmp2Result2 = wishlistId(7995);
  ...
  obj6[2] = first;
  obj6[3] = callback;
  obj5[1] = callback2(wishlistId(5635).TableSwitchRow, obj6);
  obj4[1] = callback2(wishlistId(5634).TableRowGroup, obj5);
  ...
  if (stateFromStores1) {
    ...
    obj1[3] = tmp17(tmp2(5325).BottomSheetScrollView, obj2);
