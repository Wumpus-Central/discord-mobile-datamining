...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7265)(
    analyticsLocations1,
    tmp4(7285).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET,
  ).analyticsLocations;
  ...
  if (stateFromStores1) {
    ...
    obj4.children = closure_14(tmp2(6728).BottomSheetScrollView, obj5);
  ...
  tmp4Result = analyticsContext(11286);
}
