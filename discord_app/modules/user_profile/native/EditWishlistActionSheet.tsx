...
export default function EditWishlistActionSheet(wishlistId) {
  ...
  analyticsLocations = analyticsContext(7407)(
    analyticsLocations1,
    tmp4(7427).USER_PROFILE_EDIT_WISHLIST_ACTION_SHEET,
  ).analyticsLocations;
  let obj2 = { maxWidth: ACTION_SHEET_MAX_WIDTH };
  const tmp5 = analyticsContext(7407);
  ...
  if (stateFromStores1) {
    ...
    obj4.children = closure_14(tmp2(6869).BottomSheetScrollView, obj5);
  ...
  tmp4Result = analyticsContext(11418);
}
