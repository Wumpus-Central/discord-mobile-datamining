...
import registerAssetDefault from "../../../../_runtime/08185_registerAsset.js";
...
function InformationTable(speedBumpType) {
  ...
  obj[1] = intl.string(items(1114).t.kcuWva);
  items = [obj];
  ...
  return callback2(items(5687).TableRowGroup, obj);
}
