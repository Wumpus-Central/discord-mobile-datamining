...
function InformationTable(speedBumpType) {
  ...
  items = [obj];
  obj = { icon: _modDef8248, text: null };
  ...
  return closure_12(items(5737).TableRowGroup, obj);
}
const View = fn(17).View;
let UserProfileAnalyticsTypes = fn(8246).UserProfileAnalyticsTypes;
...
export default noop.memo(function UserProfileSpeedBumpActionSheet(userId) {
  ...
  createUserProfileAnalyticsContext = tmp2Result.useCreateUserProfileAnalyticsContext({
    layout: "ACTION_SHEET",
  ...
  const tmp18 = channelId(onClose[23])({
    userId,
    ...
    type: UserProfileAnalyticsTypes.IGNORED_USER_SHEET,
  });
  closure_12 = tmp18;
  ...
  if (null == stateFromStores) {
    ...
    const obj3 = {
      ...
      guildId: guild_id,
      animate: false,
      size: tmp2(tmp3[15]).AvatarSizes.XLARGE,
      style: tmp.avatar,
    };
