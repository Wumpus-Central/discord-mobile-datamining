...
export default function AddFriendNicknameModal(arg0) {
  ...
  const stateFromStores1 = require("../../../../discord_common/js/packages/flux/index.tsx") /* initialize */.useStateFromStores(items1, () => outer1_8.getUser(closure_0));
  ...
  obj = { children: null };
  const tmp3Result = require("../../../../discord_common/js/packages/flux/index.tsx") /* initialize */;
  obj1 = { confirmText: null, onConfirm: null, cancelText: null, onCancel: null, children: null };
  const tmp11 = showUserProfile(5733);
  const intl3 = tmp3(1236).intl;
  obj1[0] = intl3.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["R3BPH+"]);
  ...
  obj1[2] = intl4.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["ETE/oC"]);
  obj1[3] = callback1;
  const items3 = [callback2(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, { style: tmp.title, accessibilityRole: "header", variant: "heading-lg/extrabold", color: "mobile-text-heading-primary", children: stringResult }), , ];
  const obj3 = { style: tmp.description, variant: "text-sm/medium", color: "text-default", children: null };
  const intl5 = tmp3(1236).intl;
  obj3[3] = intl5.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["NdQ+lP"]);
  items3[1] = callback2(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj3);
  ...
  items3[2] = callback2(require("../../../design/components/TextField/native/TextField.native.tsx") /* TextField */.TextField, obj4);
  obj1[4] = items3;
