...
let closure_9 = createCacheKey.createStyles((arg0) => {
  ...
  obj[12] = { paddingHorizontal: closure_7, marginBottom: Themes.space.PX_16 };
  obj[13] = { rowGap: 16 };
  ...
  const obj7 = { paddingHorizontal: closure_7, marginBottom: Themes.space.PX_16 };
  const tmp = importDefault;
  obj[14] = { borderRadius: arg0 ? radii.md : radii.lg, padding: closure_5, borderWidth: 1, borderColor: Themes.colors.BORDER_MUTED };
  return obj;
});
...
export default function useSharedStyles() {
  return callback(useIsMobileVisualRefreshExperimentEnabled("UserProfileSharedStyles"));
};