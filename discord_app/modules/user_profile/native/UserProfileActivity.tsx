...
function ActivityCard(user) {
  ...
  obj = {
    ...
    source: user(8827).GameProfileSources.UserProfile,
              ...
              if (null != activity.buttons) {
                ...
                if (activity.buttons.length > 0) {
                  ...
                  obj14[1] = buttons.map((arg0, index) =>
                    closure_1_21(
                      user(9445).CustomActivityButton,
...
function VoiceCallActivityCard(arg0) {
  ...
  ({ newestAnalyticsLocation: c2, analyticsLocations } = stateFromStores(5961)(
    stateFromStores(5981).USER_PROFILE_VOICE_ACTIVITY_CARD,
  ));
