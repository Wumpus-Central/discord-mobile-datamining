...
function ActivityCard(user) {
  ...
  obj = {
    ...
    source: user(8719).GameProfileSources.UserProfile,
...
function VoiceCallActivityCard(arg0) {
  ...
  ({ newestAnalyticsLocation: c2, analyticsLocations } = stateFromStores(7176)(
    stateFromStores(7196).USER_PROFILE_VOICE_ACTIVITY_CARD,
  ));
