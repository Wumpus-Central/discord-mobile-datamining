...
function ActivityCard(user) {
  ...
  const tmp2ResultResult = tmp2Result({
    ...
    source: user(9033).GameProfileSources.UserProfile,
  ...
  if (activity.type !== constants.CUSTOM_STATUS) {
    ...
    if (activity.type !== tmp14.HANG_STATUS) {
      ...
      if (activity(13387)(activity)) {
        ({ start, end } = activity.timestamps);
        const obj12 = { start, end };
        tmp33Result5 = closure_21(activity(13402), obj12);
      }
      ...
      if (null != voiceChannel) {
        ...
        if (null != stateFromStores) {
          ...
          tmp33Result6 = closure_21(activity(13404), obj13);
        }
      }
      items4[2] = tmp33Result6;
      let tmp33Result7 = null;
      if (user.id !== currentUser.id) {
        if (activity(11235)(activity)) {
        ...
        } else if (activity(8066)(activity)) {
          const obj14 = { user, currentUser, activity, application: stateFromStores1, onAction: tmp5Result };
          tmp33Result7 = closure_21(PlayOnSpotifyButton(13412).JoinActivityButton, obj14);
        } else {
          if (activity(11230)(activity)) {
                ...
                if (null != deepLinkUri) {
                  if (null != activity.session_id) {
                    if (null != stateFromStores1) {
                      ...
                      tmp33Result7 = closure_21(PlayOnSpotifyButton(13412).JoinGameActivityButton, obj15);
                    }
                  }
                }
              }
          ...
          if (activity(8603)(activity)) {
            const obj16 = { activity, onAction: tmp5Result };
            tmp33Result7 = closure_21(PlayOnSpotifyButton(13412).WatchActivityButton, obj16);
          } else {
            ...
            tmp33Result7 = null;
            if (!activity(4868)(activity)) {
              if (!activity(13382)(activity)) {
                tmp33Result7 = null;
                if (activity(13383)(activity)) {
                  const obj18 = { type: constants3.PLAYSTATION, onAction: tmp5Result };
                  tmp33Result7 = closure_21(PlayOnSpotifyButton(13412).ConnectPlatformButton, obj18);
                }
              }
            }
            const obj19 = { type: constants3.XBOX, onAction: tmp5Result };
            tmp33Result7 = closure_21(PlayOnSpotifyButton(13412).ConnectPlatformButton, obj19);
          }
        }
      }
      items4[3] = tmp33Result7;
      obj9.children = items4;
      obj9 = closure_22(activity(7538), obj9);
      obj7.children = obj9;
      obj7 = closure_21(PlayOnSpotifyButton(5425).PressableOpacity, obj7);
      obj6.children = obj7;
      closure_21(PlayOnSpotifyButton(7493).AnalyticsLocationProvider, obj6);
      const tmp2Result2 = activity(7538);
    }
  }
  return tmp15;
}
...
function VoiceCallActivityCard(arg0) {
  ...
  ({ newestAnalyticsLocation: c2, analyticsLocations } = stateFromStores(7493)(
    stateFromStores(7513).USER_PROFILE_VOICE_ACTIVITY_CARD,
  ));
  const tmp11 = stateFromStores(13400)({
    display: "voice",
    activity: { type: "VOICE" },
  ...
  if (!channel.isDM()) {
    ...
    if (stateFromStores1) {
      ...
      obj12.children = closure_21(tmp2(11237), obj13);
      const items4 = [closure_21(closure_7, obj12), tmp5];
      obj11.children = items4;
      obj9.children = closure_22(channel(4823).Text, obj11);
      let tmp13Result = closure_21(channel(5425).PressableOpacity, obj9);
    } else {
      ...
      obj15.children = closure_21(tmp2(11237), obj16);
      const items5 = [closure_21(closure_7, obj15), tmp5];
      obj14.children = items5;
      tmp13Result = closure_22(channel(4823).Text, obj14);
    }
    ...
    if (null != stateFromStores) {
      ...
      obj17.children = closure_21(channel(4823).Text, obj19);
      tmp18Result2 = closure_21(channel(5425).PressableOpacity, obj17);
    }
    ...
    items7[1] = closure_21(channel(13412).VoiceChannelButtons, obj21);
    obj5.children = items7;
    return closure_22(tmp14, obj5);
  }
  const intl2 = channel(1115).intl;
  stringResult = intl2.string(channel(1115).t["9FaEzi"]);
  tmp14 = stateFromStores(7538);
}
