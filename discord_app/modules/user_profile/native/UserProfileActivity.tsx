...
function ActivityCard(user) {
  ...
  const tmp2ResultResult = tmp2Result({
    ...
    source: user(8833).GameProfileSources.UserProfile,
  ...
  if (activity.type !== constants.CUSTOM_STATUS) {
    ...
    if (activity.type !== tmp14.HANG_STATUS) {
      ...
      if (activity(13162)(activity)) {
        ({ start, end } = activity.timestamps);
        const obj12 = { start, end };
        tmp33Result5 = closure_21(activity(13177), obj12);
      }
      ...
      if (null != voiceChannel) {
        ...
        if (null != stateFromStores) {
          ...
          tmp33Result6 = closure_21(activity(13179), obj13);
        }
      }
      items4[2] = tmp33Result6;
      let tmp33Result7 = null;
      if (user.id !== currentUser.id) {
        if (activity(11045)(activity)) {
        ...
        } else if (activity(7859)(activity)) {
          const obj14 = { user, currentUser, activity, application: stateFromStores1, onAction: tmp5Result };
          tmp33Result7 = closure_21(PlayOnSpotifyButton(13187).JoinActivityButton, obj14);
        } else {
          if (activity(11040)(activity)) {
                ...
                if (null != deepLinkUri) {
                  if (null != activity.session_id) {
                    if (null != stateFromStores1) {
                      ...
                      tmp33Result7 = closure_21(PlayOnSpotifyButton(13187).JoinGameActivityButton, obj15);
                    }
                  }
                }
              }
          ...
          if (activity(8406)(activity)) {
            const obj16 = { activity, onAction: tmp5Result };
            tmp33Result7 = closure_21(PlayOnSpotifyButton(13187).WatchActivityButton, obj16);
          } else {
            ...
            tmp33Result7 = null;
            if (!activity(4681)(activity)) {
              if (!activity(13157)(activity)) {
                tmp33Result7 = null;
                if (activity(13158)(activity)) {
                  const obj18 = { type: constants3.PLAYSTATION, onAction: tmp5Result };
                  tmp33Result7 = closure_21(PlayOnSpotifyButton(13187).ConnectPlatformButton, obj18);
                }
              }
            }
            const obj19 = { type: constants3.XBOX, onAction: tmp5Result };
            tmp33Result7 = closure_21(PlayOnSpotifyButton(13187).ConnectPlatformButton, obj19);
          }
        }
      }
      items4[3] = tmp33Result7;
      obj9.children = items4;
      obj9 = closure_22(activity(7321), obj9);
      obj7.children = obj9;
      obj7 = closure_21(PlayOnSpotifyButton(5210).PressableOpacity, obj7);
      obj6.children = obj7;
      closure_21(PlayOnSpotifyButton(7276).AnalyticsLocationProvider, obj6);
      const tmp2Result2 = activity(7321);
    }
  }
  return tmp15;
}
...
function VoiceCallActivityCard(arg0) {
  ...
  ({ newestAnalyticsLocation: c2, analyticsLocations } = stateFromStores(7276)(
    stateFromStores(7296).USER_PROFILE_VOICE_ACTIVITY_CARD,
  ));
  const tmp11 = stateFromStores(13175)({
    display: "voice",
    activity: { type: "VOICE" },
  ...
  if (!channel.isDM()) {
    ...
    if (stateFromStores1) {
      ...
      obj12.children = closure_21(tmp2(11048), obj13);
      const items4 = [closure_21(closure_7, obj12), tmp5];
      obj11.children = items4;
      obj9.children = closure_22(channel(4636).Text, obj11);
      let tmp13Result = closure_21(channel(5210).PressableOpacity, obj9);
    } else {
      ...
      obj15.children = closure_21(tmp2(11048), obj16);
      const items5 = [closure_21(closure_7, obj15), tmp5];
      obj14.children = items5;
      tmp13Result = closure_22(channel(4636).Text, obj14);
    }
    ...
    if (null != stateFromStores) {
      ...
      obj17.children = closure_21(channel(4636).Text, obj19);
      tmp18Result2 = closure_21(channel(5210).PressableOpacity, obj17);
    }
    ...
    items7[1] = closure_21(channel(13187).VoiceChannelButtons, obj21);
    obj5.children = items7;
    return closure_22(tmp14, obj5);
  }
  const intl2 = channel(1115).intl;
  stringResult = intl2.string(channel(1115).t["9FaEzi"]);
  tmp14 = stateFromStores(7321);
}
