...
export default function UserProfileApplicationWidgetCard(userId) {
  ...
  const tmp10Result = tmp10({
    ...
    applicationId: id,
    source: userId(8821).GameProfileSources.UserProfileApplicationWidget,
    sourceUserId: userId,
  ...
  if (null != tmp15) {
    if (tmp2(9067).ApplicationWidgetLayoutName.WIDGET_TOP_HERO === layout) {
      ...
      tmp30Result = closure_9(tmp9(9068), obj13);
    } else {
      tmp30Result = null;
      if (tmp2(9067).ApplicationWidgetLayoutName.WIDGET_TOP_CONTAINED === layout) {
        ...
        tmp30Result = closure_9(tmp9(9160), obj14);
      }
    }
  }
  if (tmp16 != null) {
  ...
  if (null != tmp16) {
    if (tmp2(9067).ApplicationWidgetLayoutName.WIDGET_BOTTOM_STATS === layout2) {
      ...
      tmp30Result2 = closure_9(tmp9(9161), obj15);
      ...
      tmp30Result2 = closure_9(tmp9(9162), obj16);
    } else {
      tmp30Result2 = null;
      if (tmp2(9067).ApplicationWidgetLayoutName.WIDGET_BOTTOM_COLLECTION === layout2) {
        ...
        tmp30Result2 = closure_9(tmp9(9163), obj17);
      }
    }
  }
  ...
  if (null != tmp30Result) {
    ...
    if (null != tmp30Result2) {
      ...
      tmp29Result = closure_10(tmp9(7317), obj18);
