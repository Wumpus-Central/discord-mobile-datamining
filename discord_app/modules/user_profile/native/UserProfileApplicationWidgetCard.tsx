...
export default function UserProfileApplicationWidgetCard(userId) {
  ...
  const tmp10Result = tmp10({
    ...
    applicationId: id,
    source: userId(8957).GameProfileSources.UserProfileApplicationWidget,
    sourceUserId: userId,
  ...
  if (null != tmp17) {
    if (tmp2(9202).ApplicationWidgetLayoutName.WIDGET_TOP_HERO === layout) {
      ...
      tmp32Result = closure_9(tmp9(9203), obj13);
    } else {
      tmp32Result = null;
      if (tmp2(9202).ApplicationWidgetLayoutName.WIDGET_TOP_CONTAINED === layout) {
        ...
        tmp32Result = closure_9(tmp9(9295), obj14);
      }
    }
  }
  if (tmp18 != null) {
  ...
  if (null != tmp18) {
    if (tmp2(9202).ApplicationWidgetLayoutName.WIDGET_BOTTOM_STATS === layout2) {
      ...
      tmp32Result2 = closure_9(tmp9(9296), obj15);
      ...
      tmp32Result2 = closure_9(tmp9(9297), obj16);
    } else {
      tmp32Result2 = null;
      if (tmp2(9202).ApplicationWidgetLayoutName.WIDGET_BOTTOM_COLLECTION === layout2) {
        ...
        tmp32Result2 = closure_9(tmp9(9298), obj17);
      }
    }
  }
  ...
  if (null != tmp32Result) {
    ...
    if (null != tmp32Result2) {
      ...
      if (true === tmp15) {
        ...
        const items6 = [closure_9(tmp2(10437).RetryIcon, obj21)];
        ...
        tmp31Result = closure_10(tmp2(5339).PressableOpacity, obj20);
      }
      items5[3] = tmp31Result;
      obj18.children = items5;
      tmp31Result2 = closure_10(tmp9(7452), obj18);
