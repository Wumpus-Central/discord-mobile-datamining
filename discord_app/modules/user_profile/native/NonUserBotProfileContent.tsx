...
export default noop.memo(function NonUserBotProfileContent(scrollPosition) {
  ...
  if (null == user) {
    ...
    const items = [closure_7(tmp(8270), obj), ];
    ...
    const items1 = [closure_7(tmp4(8282).OpenableUserProfileAvatar, obj1), ];
    ...
    items4[1] = obj9;
    obj8.style = items4;
    obj7.children = closure_7(tmp(11239), obj8);
    items3[1] = closure_7(View, obj7);
    obj2.children = items3;
    items1[1] = closure_8(View, obj2);
    obj.children = items1;
    items[1] = closure_8(tmp(4310).View, obj);
    obj6.children = items;
