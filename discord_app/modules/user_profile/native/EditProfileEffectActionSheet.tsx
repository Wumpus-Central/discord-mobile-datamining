...
function ProfileEffectSectionPreview(arg0) {
  ...
  const tmp2 = purchase(8278)(previewSkuId);
  ...
  const items1 = [callback(purchase(9446), { user, guildId, profileEffect: memo, maxWidth: 250 }), ];
