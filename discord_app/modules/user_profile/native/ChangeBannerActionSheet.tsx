...
function ChangeBannerColorRow(user) {
  ...
  items2[2] = callback(require("../../../design/void/native.tsx").Icon, { style: tmp.rowArrow, size: require("../../../design/void/native.tsx").Icon.Sizes.CUSTOM, source: pendingAccentColor(14223) });
  obj2[1] = items2;
