...
function ProfileBadge(source) {
  ...
  if (showToastOnPress) {
    ...
    if (null != source) {
      ...
      if (null != catalogBadge) {
        ...
        tmp24Result = closure_14(id(tmp4[24]), obj10);
      }
    }
    ...
    if (null != source) {
      ...
      if (null != catalogBadge) {
        ...
        tmp24Result2 = closure_14(id(tmp4[24]), obj13);
      }
    }
  ...
  const tmp3Result = source(label[20]);
}
...
const getBadgeName = fn(8527).getBadgeName;
...
const DEFAULT_PREMIUM_BADGE_ID = fn(8538).DEFAULT_PREMIUM_BADGE_ID;
const jsxProd = fn(21);
...
export default function UserProfilePrimaryInfo(arg0) {
  ...
  const items2 = [
    closure_1_14(UserTagAndPronouns, {
      userTag: tmp11,
      pronouns,
      themeType,
      onPressUserTag,
    ...
    closure_1_14(GuildTag, { user, themeType, style: obj, showToastOnPress: showBadgeToastOnPress }),
    closure_1_14(ProfileBadgeRows, {
      userId: user.id,
      badges,
      catalogBadges,
      canOpenBadgeDirectory,
