...
export default function UserProfileFrameEditButton(arg0) {
  ...
  if (fetchCollectiblesProduct.isFetching) {
    ...
    if (null != first1) {
      ...
      obj9.children = jsx(guildId(8285), { profileFrame: first1, previewWidth: COLLECTIBLES_PREVIEW_SIZE - 2 * guildId(576).space.PX_8, previewHeight: COLLECTIBLES_PREVIEW_SIZE - 2 * PX_4, profileBackgroundColor: guildId(576).colors.BACKGROUND_SURFACE_HIGH });
