...
export default function UserProfileFrameEditButton(arg0) {
  ...
  if (fetchCollectiblesProduct.isFetching) {
    ...
    obj5.onPress = NOOP;
    obj5.leading = jsx(user(5880).ActivityIndicator, { animating: true, size: "large" });
    let obj6 = obj5;
  } else {
    ...
    obj6.labelTrailing = jsx(user(14980).UserProfileEditFormLabelBadges, { showNewBadge: tmp4[0] === user(2028).DismissibleContent.PROFILE_FRAME_USER_PROFILE_NEW_BADGE });
    ...
    if (null != first1) {
      ...
      obj9.children = jsx(guildId(9179), { profileFrame: first1, previewWidth: COLLECTIBLES_PREVIEW_SIZE - 2 * guildId(576).space.PX_8, previewHeight: COLLECTIBLES_PREVIEW_SIZE - 2 * PX_4, profileBackgroundColor: guildId(576).colors.BACKGROUND_SURFACE_HIGH });
      ...
      tmp18Result = jsx(user(1177).Icon, { source: guildId(13566), style: tmp.noneIcon });
    }
