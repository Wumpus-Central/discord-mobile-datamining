  ...
  if (!stateFromStores1) {
    ...
    if (0 !== memo1.length) {
      ...
      if (tmp10) {
        ...
        obj.children = mapped;
        tmp10 = closure_14(stateFromStores(11675), obj);
      ...
      obj1.children = tmp8;
      items6[1] = closure_14(stateFromStores(11675), obj1);
      obj.children = items6;
