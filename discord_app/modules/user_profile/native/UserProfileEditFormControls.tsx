...
function FormControlText(children) {
  ...
  return callback2(require(4251) /* Text */.Text, { variant: "text-sm/medium", color: "text-default", style: createCacheKey().formControlText, children: children.text });
}
function FormControlSubtext(text) {
  ...
  if (null != text) {
    ...
    obj[3] = text;
    tmp2 = callback2(require(4251) /* Text */.Text, obj);
  }
  return tmp2;
}
...
export const UserProfileEditFormButton = function UserProfileEditFormButton(loading) {
  ...
  tmp2Result = !flag2;
  if (!flag2) {
    tmp2Result = tmp2(require(5293) /* TableRowArrow */.TableRowArrow, {});
  }
  items[3] = tmp2Result;
  obj[8] = items;
  obj[2] = closure_7(require(4783) /* PressableBase */.PressableHighlight, obj);
  return closure_6(require(7702) /* Input */.Input, obj);
};
export const UserProfileEditFormSwitch = function UserProfileEditFormSwitch(arg0) {
  ...
  if (isAndroidResult) {
    let PressableHighlight = tmp2(4783).PressableHighlight;
  } else {
  ...
  obj[7] = disabled;
  const items1 = [closure_6(FormControlText, { text: subLabel }), closure_6(require(5622) /* FormSwitch */.FormSwitch, { "aria-hidden": true, value, onValueChange: handleOnPress, disabled })];
  obj[8] = items1;
