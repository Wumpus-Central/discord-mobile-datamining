...
export default function UserProfileUpsellCard(headerText) {
  ...
  const tmp = callback();
  const _require = tmp;
  { borderWidth: 1, style: items, direction: _require(1297).GradientBorder.Direction.HORIZONTAL, colors: Gradients.PREMIUM_TIER_2, borderRadius: ThemesDefault.radii.lg, children: null };
  ...
  obj3[5] = fn;
  items4[2] = callback(_require(1297).ShinyButton, obj3);
  obj[3] = items4;
  obj[5] = callback2(closure_4, obj);
  return callback(_require(1297).GradientBorder, obj);
};