...
export default noop.memo(function UserProfileActionSheet(userId) {
  ...
  const memo = isPreviewingChanges.useMemo(() => {
    ...
    return (animatedRef, sharedValue, lockableScrollableContentOffsetY) => {
      const scrollEventsHandlersDefault = animatedScrollableState(6820).useScrollEventsHandlersDefault(
        animatedRef,
        sharedValue,
      ...
      fn.__closure = {
        ...
        SCROLLABLE_STATE: animatedScrollableState(6820).SCROLLABLE_STATE,
      };
