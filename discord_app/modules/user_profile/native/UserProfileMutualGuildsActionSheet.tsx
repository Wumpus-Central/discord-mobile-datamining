...
export default function UserProfileMutualGuildsActionSheet(user) {
  ...
  const mutualGuilds = onPressMutualGuild(11710)(user).mutualGuilds;
  let length;
  const tmp4 = onPressMutualGuild(11711);
  if (mutualGuilds != null) {
    length = mutualGuilds.length;
  }
  let obj = { scrollable: true, title: onPressMutualGuild(11712)(length), children: null };
  ...
  if (null == mutualGuilds) {
    ...
    obj1[1] = tmp3(user(11713).NoMutualServers, {});
    ...
    tmp3Result = tmp3(user(11711).UserProfileStackedActionSheetList, obj2);
  }
  obj[1] = tmp3Result;
