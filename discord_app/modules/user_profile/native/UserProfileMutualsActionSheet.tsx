// === Module 12947: UserProfileMutualsActionSheet ===
...
import UserProfileStackedActionSheetDefault from "UserProfileStackedActionSheet" /* 11498 */;
import useUserProfileMutualsDefault from "useUserProfileMutuals" /* 12941 */;
import getMutualGuildsLabelDefault from "getMutualGuildsLabel" /* 12942 */;
import getMutualFriendsLabelDefault from "getMutualFriendsLabel" /* 12948 */;
...
function MutualFriendRow(mutualFriend) {
  ...
  const avatarDecoration = user(8560).useAvatarDecoration(user);
  const obj = user(8560);
  ...
  obj3.start = start;
  obj3.end = end;
  return closure_9(user(5908).TableRow, obj3, user.id);
}
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  if (null == mutualFriends) {
    ...
    const obj6 = { style: tmp.emptyState, children: closure_9(tmp6(12949).NoMutualFriends, {}) };
    ...
    tmp10 = closure_9(tmp6(11498).UserProfileStackedActionSheetList, obj7);
  }
  obj4.page = tmp10;
  const items = [obj4, ];
  let length1;
  ...
  if (null == mutualGuilds) {
    ...
    const obj10 = { style: tmp.emptyState, children: tmp9(tmp6(12943).NoMutualServers, {}) };
    ...
    tmp9Result = tmp9(tmp6(11498).UserProfileStackedActionSheetList, obj11);
  }
  ...
  const items1 = [tmp9(closure_5, { children: tmp9(user(12953).Tabs, { state: segmentedControlState }) }), tmp9(user(12955).SegmentedControlPages, { state: segmentedControlState })];
