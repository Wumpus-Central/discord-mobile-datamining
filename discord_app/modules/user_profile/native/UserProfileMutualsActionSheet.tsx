...
function MutualFriendRow(mutualFriend) {
  ...
  const obj2 = user(504);
  obj3.icon = closure_9(user(1177).Avatar, {
    user,
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  const items1 = [
    tmp9(closure_5, { children: tmp9(user(12962).Tabs, { state: segmentedControlState }) }),
    tmp9(user(12964).SegmentedControlPages, { state: segmentedControlState }),
  ];
