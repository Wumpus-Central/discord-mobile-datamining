// === Module 12865: UserProfileMutualsActionSheet ===
...
import UserProfileStackedActionSheetDefault from "UserProfileStackedActionSheet" /* 11422 */;
import useUserProfileMutualsDefault from "useUserProfileMutuals" /* 12859 */;
import getMutualGuildsLabelDefault from "getMutualGuildsLabel" /* 12860 */;
import getMutualFriendsLabelDefault from "getMutualFriendsLabel" /* 12866 */;
...
function MutualFriendRow(mutualFriend) {
  ...
  const avatarDecoration = user(8489).useAvatarDecoration(user);
  const obj = user(8489);
  ...
  obj3.start = start;
  obj3.end = end;
  return closure_9(user(5824).TableRow, obj3, user.id);
}
...
export default function UserProfileMutualsActionSheet(user) {
  ...
  if (null == mutualFriends) {
    ...
    const obj6 = { style: tmp.emptyState, children: closure_9(tmp6(12867).NoMutualFriends, {}) };
    ...
    tmp10 = closure_9(tmp6(11422).UserProfileStackedActionSheetList, obj7);
  }
  obj4.page = tmp10;
  const items = [obj4, ];
  let length1;
  ...
  if (null == mutualGuilds) {
    ...
    const obj10 = { style: tmp.emptyState, children: tmp9(tmp6(12861).NoMutualServers, {}) };
    ...
    tmp9Result = tmp9(tmp6(11422).UserProfileStackedActionSheetList, obj11);
  }
  ...
  const items1 = [tmp9(closure_5, { children: tmp9(user(12871).Tabs, { state: segmentedControlState }) }), tmp9(user(12873).SegmentedControlPages, { state: segmentedControlState })];
