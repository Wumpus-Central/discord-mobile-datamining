...
export default function UserProfileActivityTab(user) {
  ...
  ({ recent, isCurrentUser, hasCurrentActivity, hasRecentActivity } = cardStyle(13370)({
    userId: user.id,
  ...
  const tmp3 = cardStyle(13370)({ userId: user.id, currentUserId: currentUser.id, guildId });
}
