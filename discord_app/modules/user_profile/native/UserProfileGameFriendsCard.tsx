// === Module 12294: UserProfileGameFriendsCard ===
...
export default function UserProfileGameFriendsCard(arg0) {
  ...
  found = importDefault(5587)(applicationIds).filter((arg0) => null != arg0);
  if (0 === found.length) {
    return null;
  } else {
    ...
    if (1 === found.length) {
      ...
      obj[0] = function applicationName() {
        return lib(textmdnormal(11838), { application: found[0], textVariant: textmdnormal, iconSize: 16 }, found[0].id);
      };
      ...
      obj[1] = function applicationName2() {
        return lib(textmdnormal(11838), { application: found[1], textVariant: textmdnormal, iconSize: 16 }, found[1].id);
      };
      ...
      obj[1] = function applicationNameLast() {
        return lib(textmdnormal(11838), { application: dependencyMap, textVariant: textmdnormal, iconSize: 16 });
      };
    ...
    return jsx(tmp2(5628), { style: null, title: null, children: null });
  }
  const arr = importDefault(5587)(applicationIds);
};