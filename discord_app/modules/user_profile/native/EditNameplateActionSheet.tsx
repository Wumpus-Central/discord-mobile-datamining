...
function EditNameplateInner(user) {
  ...
  const callback = React.useCallback((arg0) => {
    ...
    return closure_1_10(user(guildId[24]).EditNameplateRow, {
      items,
      size,
      selectedSkuId,
...
function NameplateActionSheetPreview(arg0) {
  ...
  const items1 = [
    callback2(tmp10(8817).NameplateDummyUserPreview, { width: 100 }),
    callback2(tmp10(8817).NameplateDummyUserPreview, { width: 140 }),
  ];
  ...
  const items3 = [
    closure_11(View, obj),
    callback2(tmp10(11220).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }),
  ];
