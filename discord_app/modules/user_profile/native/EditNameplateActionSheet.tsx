...
function NameplateActionSheetPreview(arg0) {
  ...
  const items3 = [
    ...
    closure_10(tmp10(11354).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }),
  ];
...
export default function EditNameplateActionSheet(arg0) {
  ...
  obj3.children = closure_11(guildId(7253).BottomSheet, obj4);
