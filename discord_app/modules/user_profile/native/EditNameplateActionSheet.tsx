...
import { isNameplateRecord } from "../../collectibles/records/NameplateRecord.tsx";
...
function EditNameplateInner(user) {
  ...
  const items3 = [callback(NameplateActionSheetPreview, { previewSkuId: skuId, user, guildId }), , ];
  ...
  items3[1] = callback(setSelectedNameplate(guildId[24]), obj);
  ...
  items3[2] = callback(user(guildId[25]).EditCollectiblesPickerList, obj1);
  obj2[0] = items3;
...
function NameplateActionSheetPreview(arg0) {
  ...
  if (null != memo) {
    ...
    obj = { a11y_text: null };
    obj[0] = memo.label;
    let formatToPlainStringResult = intl2.formatToPlainString(require("../../../intl/index.native.tsx").t.YJig7C, obj);
    let tmp10 = _require;
  } else {
    const intl = require("../../../intl/index.native.tsx").intl;
    formatToPlainStringResult = intl.string(require("../../../intl/index.native.tsx").t.aqlsGS);
    tmp10 = _require;
  }
  ...
  obj[1] = items1;
  const items3 = [callback2(View, obj), callback2(tmp10(10418).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }), ];
...
const result = require("obj132").fileFinishedImporting("modules/user_profile/native/EditNameplateActionSheet.tsx");
...
export default function EditNameplateActionSheet(arg0) {
  ...
  callback = obj1.useCallback(() => {
    first(698);
    const obj = { type: first(7159).EDIT_NAMEPLATE_SHEET, is_fullscreen: true };
  ...
  obj[4] = items2;
  obj[1] = callback3(guildId(6950).BottomSheet, obj);
