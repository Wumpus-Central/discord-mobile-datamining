...
import EditNameplateSection from "../../collectibles/nameplates/native/EditNameplateSection.tsx";
...
function EditNameplateInner(user) {
  ...
  const callback = noop.useCallback((arg0) => {
    ...
    return closure_2_10(EditNameplateSection.EditNameplateRow, {
      items,
      size,
      selectedSkuId,
...
function NameplateActionSheetPreview(arg0) {
  ...
  let obj = {
    style: tmp.nameplatePreviewContainer,
  ...
  const items1 = [
    closure_10(tmp10(8888).NameplateDummyUserPreview, { width: 100 }),
    closure_10(tmp10(8888).NameplateDummyUserPreview, { width: 140 }),
  ];
  ...
  const items3 = [
    closure_11(View, obj),
    closure_10(tmp10(11292).NameplatePreview, { nameplate: memo, user, guildId, animate: true, "aria-hidden": true }),
  ];
...
let createStyles = {
  ...
  bounceOffset: null,
  title: null,
  nameplatePreviewContainer: null,
  nameplateGradientContainer: null,
  nameplatePreviewGradient: null,
};
...
createStyles.nameplatePreviewContainer = {
  width: "80%",
  alignSelf: "center",
...
export default function EditNameplateActionSheet(arg0) {
  ...
  const callback = obj1.useCallback(() => {
    first(1242);
    const obj = { type: first(7234).EDIT_NAMEPLATE_SHEET, is_fullscreen: true };
  ...
  items1[1] = closure_10(guildId(4601).Text, obj3);
  ...
  obj4.analyticsSource = tmp7(7234).EDIT_NAMEPLATE_SHEET;
  items2[1] = closure_10(first(8235), obj4);
  obj.children = items2;
  obj.children = closure_11(guildId(7202).BottomSheet, obj);
  return closure_10(guildId(7214).AnalyticsLocationProvider, obj);
}
