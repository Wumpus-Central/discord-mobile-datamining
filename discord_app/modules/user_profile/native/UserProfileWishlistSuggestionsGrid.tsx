...
import MobileWishlistSuggestionsExperiment from "MobileWishlistSuggestionsExperiment" /* 13162 */;
...
import AddToWishlistGridDefault from "AddToWishlistGrid" /* 13171 */;
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  let obj3 = trackUserProfileWishlistAction(13169);
  obj = { userId, wishlist, numWishlistItemsToRecommend: 15, maxWishlistItemsToShow: 9, source: trackUserProfileWishlistAction(8846).WishlistFetchSource.USER_PROFILE };
  ...
  if (0 === items2.length) {
    ...
    let obj2 = { size: "md", variant: "secondary", icon: closure_12(tmp(12208).ShopIcon, { size: "sm" }), text: null, onPress: null };
    const intl3 = tmp(1114).intl;
    obj2.text = intl3.string(tmp(1114).t.RSyoZu);
    obj2.onPress = callback;
    obj1.children = closure_12(tmp(5025).Button, obj2);
    ...
    const items4 = [closure_12(tmp(4601).Text, obj7), ];
    ...
    obj9.icon = closure_12(tmp(5730).XSmallIcon, obj10);
    obj9.onPress = markAsDismissed;
    const intl = tmp(1114).intl;
    obj9.accessibilityLabel = intl.string(tmp(1114).t.WAI6xu);
    obj8.children = closure_12(tmp(8150).IconButton, obj9);
    ...
    const obj13 = { size: "md", variant: "secondary", icon: closure_12(tmp(12208).ShopIcon, { size: "sm" }), text: null, onPress: null };
    const intl2 = tmp(1114).intl;
    obj13.text = intl2.string(tmp(1114).t.RSyoZu);
    obj13.onPress = callback;
    obj12.children = closure_12(tmp(5025).Button, obj13);
    items6[2] = closure_12(View, obj12);
    obj5.children = items6;
    obj3.children = closure_13(ReanimatedRexportDefault.View, obj5);
    tmp12Result = closure_12(tmp(13170).WishlistAnalyticsProvider, obj3);
  }
  return tmp12Result;
}
