// === Module 12495: UserProfileWishlistSuggestionsGridContent ===

// Module 12495 (UserProfileWishlistSuggestionsGridContent)
import ThemesDefault from "Themes" /* 712 */;
import useIsMobileVisualRefreshExperimentEnabledDefault from "useIsMobileVisualRefreshExperimentEnabled" /* 1367 */;
import contextDefault from "context" /* 5905 */;
import useIsMobileWishlistSuggestionsEnabled from "useIsMobileWishlistSuggestionsEnabled" /* 12434 */;
import useCardGridLayoutDefault from "useCardGridLayout" /* 12435 */;
import useWishlistSuggestionsDismissibleContentDefault from "useWishlistSuggestionsDismissibleContent" /* 12496 */;
import closure_3 from "noop" /* 19 */;
import { View } from "get ActivityIndicator" /* 17 */;
import closure_5 from "maybeApplyNoTextColorForLightCustomTheme" /* 4437 */;
import closure_6 from "get" /* 10377 */;
import { TrackUserProfileWishlistActions as closure_7 } from "USER_PROFILE_TOOLTIP_DELAY" /* 8488 */;
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  let obj3 = stateFromStores(12497);
  obj = { userId, wishlist, numWishlistItemsToRecommend: 15, maxWishlistItemsToShow: 9, source: stateFromStores(10376).WishlistFetchSource.USER_PROFILE };
  ...
  if (0 === items2.length) {
    ...
    obj2[2] = callback(tmp4(11626).ShopIcon, { size: "sm" });
    const intl4 = tmp4(1236).intl;
    obj2[3] = intl4.string(tmp4(1236).t.RSyoZu);
    obj2[4] = callback;
    obj1[1] = callback(tmp4(4880).Button, obj2);
    ...
    const items4 = [callback(tmp4(4441).Text, obj7), ];
    ...
    obj9[2] = callback(tmp4(5503).XSmallIcon, obj10);
    obj9[3] = markAsDismissed;
    const intl2 = tmp4(1236).intl;
    obj9[4] = intl2.string(tmp4(1236).t.WAI6xu);
    obj8[4] = callback(tmp4(7938).IconButton, obj9);
    ...
    items6[1] = callback(tmp(12500), obj11);
    const obj12 = { style: null, children: null };
    obj12[0] = tmp5.shopButtonContainer;
    const obj13 = { size: "md", variant: "secondary", icon: null, text: null, onPress: null };
    obj13[2] = callback(tmp4(11626).ShopIcon, { size: "sm" });
    const intl3 = tmp4(1236).intl;
    obj13[3] = intl3.string(tmp4(1236).t.RSyoZu);
    obj13[4] = callback;
    obj12[1] = callback(tmp4(4880).Button, obj13);
    items6[2] = callback(View, obj12);
    obj5[4] = items6;
    obj3[1] = closure_13(tmp(4185).View, obj5);
    tmp13Result = tmp13(tmp4(12499).WishlistAnalyticsProvider, obj3);
  }
  return tmp13Result;
}
