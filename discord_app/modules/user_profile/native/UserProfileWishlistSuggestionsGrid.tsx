...
function WishlistSuggestionsGridContents(arg0) {
  ...
  let obj3 = stateFromStores(12486);
  ...
  if (0 === items2.length) {
    ...
    obj2[2] = callback(tmp4(11525).ShopIcon, { size: "sm" });
    ...
    tmp13Result = tmp13(tmp4(12488).WishlistAnalyticsProvider, obj3);
  }
  return tmp13Result;
}
