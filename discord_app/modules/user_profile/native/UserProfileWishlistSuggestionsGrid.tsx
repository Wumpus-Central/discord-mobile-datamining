...
function WishlistSuggestionsGridContents(arg0) {
  ...
  trackUserProfileWishlistAction =
    trackUserProfileWishlistAction(7635).useUserProfileAnalyticsContext().trackUserProfileWishlistAction;
  ...
  const items2 = obj4.useAddToWishlistGridItems({
    ...
    source: trackUserProfileWishlistAction(8238).WishlistFetchSource.USER_PROFILE,
  }).items;
  ...
  if (0 === items2.length) {
    ...
    const obj7 = {
      size: "md",
      variant: "secondary",
      icon: closure_12(tmp(11620).ShopIcon, { size: "sm" }),
      text: null,
      onPress: null,
    };
