...
import MobileWishlistSuggestionsExperiment from "MobileWishlistSuggestionsExperiment" /* 13115 */;
...
import AddToWishlistGridDefault from "AddToWishlistGrid" /* 13124 */;
...
function WishlistSuggestionsGridContents(arg0) {
  ...
  obj = { userId, wishlist, numWishlistItemsToRecommend: 15, maxWishlistItemsToShow: 9, source: trackUserProfileWishlistAction(8809).WishlistFetchSource.USER_PROFILE };
  ...
  if (0 === items2.length) {
    ...
    let obj2 = { size: "md", variant: "secondary", icon: closure_12(tmp(12168).ShopIcon, { size: "sm" }), text: null, onPress: null };
    ...
    const obj13 = { size: "md", variant: "secondary", icon: closure_12(tmp(12168).ShopIcon, { size: "sm" }), text: null, onPress: null };
