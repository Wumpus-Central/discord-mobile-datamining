...
function WishlistSuggestionsGridContents(arg0) {
  ...
  let obj3 = stateFromStores(12491);
  obj = { userId, wishlist, numWishlistItemsToRecommend: 15, maxWishlistItemsToShow: 9, source: stateFromStores(9362).WishlistFetchSource.USER_PROFILE };
  ...
  if (0 === items2.length) {
    ...
    obj2[2] = callback(tmp4(11529).ShopIcon, { size: "sm" });
    ...
    obj8[4] = callback(tmp4(7753).IconButton, obj9);
    ...
    obj5[4] = items6;
    obj3[1] = closure_13(tmp(4042).View, obj5);
    tmp13Result = tmp13(tmp4(12493).WishlistAnalyticsProvider, obj3);
  }
  return tmp13Result;
}
