...
export default function UserProfilePreview(hideFrame) {
  ...
  const stateFromStoresObject = guildId(set[8]).useStateFromStoresObject(items, () =>
  ...
  if (tmp27Result) {
    const obj9 = {
      ...
      frameOrder: guildId(tmp2[21]).ProfileFrameLayerOrder.BACK,
      containerWidth: null,
  ...
  if (null == str) {
    ...
    if (tmp27Result7) {
      const obj21 = {
        ...
        filterLayer,
        profileThemeType: constants.PREVIEW,
        frameOrder: guildId(tmp2[21]).ProfileFrameLayerOrder.FRONT,
        containerWidth: null,
        containerHeight: null,
      };
