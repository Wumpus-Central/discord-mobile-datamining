...
function GameFriendApplicationRow(application) {
  ...
  let obj = { trailing: closure_10(application(userDisplayName[11]).XSmallIcon, { size: "md", color: "redesign-button-tertiary-text" }), label: null, onPress: null };
  ...
  obj.source = { uri: str };
  const items1 = [closure_10(application(userDisplayName[12]).Icon, obj, application.id), closure_10(application(userDisplayName[13]).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: application.name })];
  obj.children = items1;
