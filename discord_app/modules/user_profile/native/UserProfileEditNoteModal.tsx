// === Module 12158: UserProfileEditNoteModal ===
...
const require = arg1;
const result = require("module_4461").fileFinishedImporting("modules/user_profile/native/UserProfileEditNoteModal.tsx");
...
export default function UserProfileEditNoteModal(arg0) {
  ...
  obj2[1] = function headerTitle() {
    ...
    return handleClose(callback(4251).Text, obj);
  };
  ...
  obj1[0] = obj2;
  obj[3] = obj1;
  return handleClose(require(5636) /* NavigationStack */.Navigator, obj);
};