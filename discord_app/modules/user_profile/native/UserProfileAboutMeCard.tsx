...
function MemberJoinDates(userId) {
  ...
  obj1 = { themeType, icon: callback(tmp4(9468).ClydeIcon, { size: "xs" }), accessibilityLabel: null, children: null };
...
function FriendsSinceDate(themeType) {
  ...
  if (null != friendsSinceDate) {
    ...
    items[1] = callback(tmp3(4298).Text, obj1);
    obj[0] = items;
