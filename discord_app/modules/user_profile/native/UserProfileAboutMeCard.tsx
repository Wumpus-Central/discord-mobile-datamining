...
function MemberJoinDates(userId) {
  ...
  obj1 = { themeType, icon: callback(tmp4(9422).ClydeIcon, { size: "xs" }), accessibilityLabel: null, children: null };
  ...
  if (tmp13Result) {
    ...
    obj5[1] = tmp4(5646).GuildIconSizes.XXSMALL;
