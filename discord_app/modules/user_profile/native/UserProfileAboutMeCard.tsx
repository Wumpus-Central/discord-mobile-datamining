...
function MemberJoinDates(userId) {
  ...
  obj1 = { themeType, icon: callback(tmp4(9451).ClydeIcon, { size: "xs" }), accessibilityLabel: null, children: null };
...
function FriendsSinceDate(themeType) {
  ...
  if (null != friendsSinceDate) {
    ...
    items[1] = callback(tmp3(4281).Text, obj1);
    obj[0] = items;
