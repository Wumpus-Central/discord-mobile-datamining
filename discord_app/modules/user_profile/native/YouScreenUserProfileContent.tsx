...
function EditSection(navigateToProfileCustomization) {
  ...
  obj3 = {
    targetRef: ref,
    visible: first === tmp4(tmp2[24]).DismissibleContent.DISPLAY_NAME_STYLES_FLYWHEEL_MOBILE_PROFILE_COACHMARK,
    markAsDismissed: tmp18,
  };
  items3[1] = closure_14(trackUserProfileAction(first[31]), obj3);
  obj4 = {
    targetRef: ref,
    visible: first === tmp4(tmp2[24]).DismissibleContent.BADGE_CUSTOMIZATION_COACHMARK,
    markAsDismissed: tmp18,
...
export default function YouScreenUserProfileContent(user) {
  ...
  obj = {
    ...
    itemSpacing: tmp(tmp2[29]).space.PX_24,
    items: memo,
  ...
  obj5.displayNameAccessibilityHint =
    "" +
    intl.formatToPlainString(user(navigateToPremium[30]).t["er+FRD"], obj6) +
    ", " +
  ...
  obj12 = {
    ...
    children: tmp41(tmp4(tmp2[66]).SegmentedControlPages, { state: segmentedControlState }),
  };
