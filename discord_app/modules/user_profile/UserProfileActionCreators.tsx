// === Module 8167: UserProfileActionCreators ===
...
import useShouldConvertBioEmoji from "useShouldConvertBioEmoji" /* 8168 */;
  ...
  if (c9 === 2) {
    ...
    try {
      ...
      if (0 === c8) {
        if (arg0 === 1) {
          ...
          if (null != id) {
            ...
            if (null != bannerSurface) {
              const obj2 = { url: React5.USER_GUILD_PROFILE(bannerSurface, React6), bannerSurface: safetyScannedUploadSurfaces.SafetyScannedUploadSurface.USER_GUILD_PROFILE_BANNER };
              let obj3 = obj2;
            } else {
              obj3 = { url: React5.USER_PROFILE(React6), bannerSurface: safetyScannedUploadSurfaces.SafetyScannedUploadSurface.USER_DEFAULT_PROFILE_BANNER };
            }
            bannerSurface = obj3.bannerSurface;
            const HTTP = HTTPUtils.HTTP;
            const request = { url: obj3.url, body: headersForMd5, headers: null, oldFormErrors: true, rejectWithError: false };
            let obj4 = {};
        ...
        const obj5 = { type: "USER_PROFILE_UPDATE_FAILURE", guildId: closure_132_0, errors: closure_132_4, apiError: closure_132_3 };
        obj4.dispatch(obj5);
        c9 = 3;
