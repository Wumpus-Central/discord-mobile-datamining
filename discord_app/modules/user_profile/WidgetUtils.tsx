...
import _modDef7382 from "WidgetActionCreators.tsx";
  ...
  if (
    ...
    if (
      ...
      const result = tmp16Result.UNSAFE_markDismissibleContentAsDismissed(
        tmp16(1372).DismissibleContent.USER_PROFILE_PERSONAL_WIDGET_COACHMARK,
        obj,
      );
      ...
      const result1 = tmp16Result.UNSAFE_markDismissibleContentAsDismissed(
        tmp16(1372).DismissibleContent.USER_PROFILE_PERSONAL_WIDGET_NEW_BADGE,
        obj,
      );
    }
    const items = [type];
