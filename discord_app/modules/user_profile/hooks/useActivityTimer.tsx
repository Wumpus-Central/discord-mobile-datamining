...
export default function useActivityTimer(start) {
  ...
  let first;
  let importDefault;
  const interval = new first(4140).Interval();
...
export const formatTimeForA11yLabel = function formatTimeForA11yLabel(arg0) {
  ...
  return require(8036) /* calculateTimestampDurations */.formatTimestampToA11yLabel({ hours, minutes, seconds });
};