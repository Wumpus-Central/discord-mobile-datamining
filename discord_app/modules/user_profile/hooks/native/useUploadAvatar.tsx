...
({
  AnalyticsPages: closure_6,
  UPLOAD_MEDIUM_SIZE: error,
...
export default function useUploadAvatar(guildId) {
  ...
  const tmp2 = useCallback(() => {
    ...
    obj = {
      initialUpsellKey: closure_1_10.ANIMATED_AVATAR,
        ...
        try {
          ...
          if (0 === originalMd5) {
            if (arg0 === 1) {
              ...
              c3 = undefined;
              closure_4 = undefined;
              closure_1_1(4445).hideActionSheet();
              const obj13 = closure_1_1(4445);
              obj1 = { size: null };
              obj1[0] = closure_1_7;
              originalMd5 = 1;
              c3 = 1;
