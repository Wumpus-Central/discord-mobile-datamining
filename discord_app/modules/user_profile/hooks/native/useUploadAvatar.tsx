...
export default function useUploadAvatar(guildId) {
  ...
  const tmp2 = useCallback(() => {
    let obj = { initialUpsellKey: constants3.ANIMATED_AVATAR, analyticsLocation: null, analyticsProperties: null, analyticsLocations };
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            dependencyMap = 1;
            c3 = 1;
            const obj2 = { value: tmp22(5219).openImagePicker(obj1), done: false };
            return obj2;
          }
        } else if (arg0 === 1) {
          c3 = 3;
          ...
          if (closure_129_1) {
            let tmp28Result = tmp2(8284);
            tmp28Result.setTryItOutAvatar(closure_128_4);
          } else {
            tmp28Result = tmp2(8281);
