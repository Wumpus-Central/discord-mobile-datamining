// === Module 8416: useUserProfileColors ===
...
export const useUserProfileColors = function useUserProfileColors(arg0) {
  ...
  let obj = require(5603) /* useProfileThemeValues */;
  ...
  obj[0] = require(3959) /* map */.useToken(importDefault(712).colors.USER_PROFILE_GRADIENT_BACKGROUND, tmp3);
  const obj4 = require(3959) /* map */;
  obj[1] = require(3959) /* map */.useToken(importDefault(712).colors.USER_PROFILE_GRADIENT_BACKGROUND, tmp3);
  const obj5 = require(3959) /* map */;
  const colors = importDefault(712).colors;
  obj[2] = require(3959) /* map */.useToken(tmp7 ? colors.CARD_MUTED_BG : colors.USER_PROFILE_CONTAINER_BACKGROUND, tmp3);
  ...
  const obj6 = require(3959) /* map */;
  obj[5] = require(3959) /* map */.useToken(importDefault(712).colors.BACKGROUND_SURFACE_HIGH, tmp3);
  const tmp4Result1 = require(3959) /* map */;
  let containerBackground = require(3959) /* map */.useToken(tmp(712).colors.BACKGROUND_MOD_NORMAL, theme);
  ...
  if (null != primaryColor) {
    if (null != secondaryColor) {
      if (null != profileThemeValues) {
        ...
        const result = tmp4(8111).calculateOverlayedColor(primaryColor, tmp8);
        obj = {};
        const merged = Object.assign(obj);
        obj.containerBackground = containerBackground;
        const tmp4Result3 = tmp4(8111);
        const tmp4Result4 = tmp4(688);
        obj.gradientSecondaryBackground = tmp4Result4.int2hex(tmp4(8111).calculateOverlayedColor(secondaryColor, overlay));
        const tmp4Result5 = tmp4(8111);
        obj.avatarBackground = tmp4(688).int2hex(result);
        const tmp4Result6 = tmp4(688);
        const tmp4Result7 = tmp4(688);
        obj.statusBackground = tmp4Result7.int2hex(tmp4(8111).calculateOverlayedColor(result, sectionBox));
        return obj;
      }
    }
  }
