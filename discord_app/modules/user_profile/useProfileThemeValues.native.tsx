...
export const useProfileThemeValues = function useProfileThemeValues(theme) {
  ...
  return useMemo(() => {
    if (null == closure_0) {
      ...
      obj.overlaySyncedWithUserTheme = internal3.resolveSemanticColor(tmp, nativeDefault.colors.PROFILE_GRADIENT_OVERLAY_SYNCED_WITH_USER_THEME, obj);
      ...
      obj.rolePillBackgroundColor = internal2.resolveSemanticColor(tmp, nativeDefault.colors.PROFILE_GRADIENT_ROLE_PILL_BACKGROUND, obj);
      return obj;
    }
  }, items1);
};