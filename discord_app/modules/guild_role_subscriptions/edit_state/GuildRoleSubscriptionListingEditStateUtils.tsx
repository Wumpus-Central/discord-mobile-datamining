...
export const useRole = function useRole(listingId, guildId) {
  ...
  return React.useMemo(() => {
    ...
    if (closure_1 == null) {
      DEFAULT_PREVIEW_ROLE = listingId(14576).DEFAULT_PREVIEW_ROLE;
    }
    const obj = {};
...
export const useEditStateIds = function useEditStateIds(groupListingId, guildId, arg2) {
  ...
  let subscriptionListingsForGroup = _require(14558).useSubscriptionListingsForGroup(groupListingId, obj);
