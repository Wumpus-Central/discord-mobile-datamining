...
let closure_21 = async function _createListingFromEditState(arg0) {
    ...
    if (arg0 === 1) {
      ...
      if (null == id) {
        ...
        if (tmp9) {
          c6 = 3;
          c7 = 1;
          let obj3 = { value: closure_133_0(closure_133_3[25]).createChannelsFromTemplateTierBenefits(closure_132_0, channelBenefits), done: false };
          return obj3;
        }
      }
    }
  ...
  const templateTierCreationAnalyticsContext = obj2.getTemplateTierCreationAnalyticsContext(closure_132_1, closure_132_0);
  obj3 = closure_133_2(closure_133_3[22]);
  return obj3.createSubscriptionListing({ guildId: closure_132_0, groupListingId: id, data: { can_access_all_channels: closure_132_12, image, name, description, benefits: closure_132_14, priceTier }, analyticsContext: templateTierCreationAnalyticsContext, onBeforeDispatchNewListing: closure_132_3 });
};
