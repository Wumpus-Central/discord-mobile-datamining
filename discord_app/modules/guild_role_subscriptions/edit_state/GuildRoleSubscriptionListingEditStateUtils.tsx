// === Module 15227: GuildRoleSubscriptionListingEditStateUtils ===
...
import Contants from "Contants" /* 15230 */;
import useTrialIntervalOptionsDefault from "useTrialIntervalOptions" /* 15232 */;
    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (tmp25) {
          ...
          c3 = 4;
          c4 = 1;
          const obj8 = { value: closure_130_2(closure_130_3[22]).updateSubscriptionTrial(closure_129_0, id, obj7), done: false };
          return obj8;
        }
      }
    } catch (tmp71) {
  ...
  if (c7 === 2) {
    ...
    try {
      ...
      if (0 === c6) {
        ...
        if (1 === tmp4) {
          if (arg0 === 1) {
            ...
            if (null == id) {
              c6 = 2;
              c7 = 1;
              let obj2 = { value: closure_133_2(closure_133_3[22]).createSubscriptionGroupListing(closure_132_0, {}), done: false };
              return obj2;
            } else {
              ...
              if (tmp9) {
                ...
                c6 = 3;
                c7 = 1;
                let obj3 = { value: obj7.createChannelsFromTemplateTierBenefits(closure_132_0, channelBenefits), done: false };
                return obj3;
              }
            }
          }
        ...
        templateTierCreationAnalyticsContext = obj2.getTemplateTierCreationAnalyticsContext(closure_132_1, closure_132_0);
        obj3 = closure_133_2(closure_133_3[22]);
        const obj5 = { guildId: closure_132_0, groupListingId: id, data: null, analyticsContext: null, onBeforeDispatchNewListing: null };
        const obj6 = { can_access_all_channels: closure_132_12, image, name, description, benefits: closure_132_14, priceTier };
        obj5.data = obj6;
        ...
        if (0 === c5) {
          ...
          if (arg0 === 1) {
            ...
            if (null != subscriptionListing2) {
              ...
              const obj4 = { guildId: closure_129_0, editStateId: closure_129_5, groupListingId: closure_129_2, onBeforeDispatchNewListing: closure_129_3 };
              c5 = 5;
              c6 = 1;
              const obj5 = {
  ...
  obj.addNewEditStateFromTemplate = noop.useCallback((listings) => {
    ...
    const item = listings.forEach((item) => {
      closure_1_4(closure_1, () => {
        let obj = { name: item.name, description: item.description, priceTier: item.price_tier, image: item.image, intangibleBenefits: item.additional_perks, channelBenefits: null, roleIcon: null, roleColor: item.role_color, usedTemplate: item.category };
