...
export const showEditBenefitModal = function showEditBenefitModal(benefit) {
  ...
  obj.pushLazy(asyncRequireImpl(17839, dependencyMap.paths), obj, GuildRoleSubscriptionBenefitEditorModal);
};
export const showEditEmojisModal = function showEditEmojisModal(initialTierEmojiIds) {
  ...
  obj.onSave = onSave;
  obj.pushLazy(asyncRequireImpl(17845, dependencyMap.paths), obj, "GuildRoleSubscriptionEmojiEditorModal");
};
