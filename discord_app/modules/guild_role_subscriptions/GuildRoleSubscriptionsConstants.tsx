...
export const GuildRoleSubscriptionsTierScenes = {
  GATING: "GATING",
  GROUP: "GROUP",
  DETAILS: "DETAILS",
  BENEFITS: "BENEFITS",
  CHANNEL_BENEFITS: "CHANNEL_BENEFITS",
...
export const GuildRoleSubscriptionFormat = {
  SOME_CHANNELS: 0,
  [0]: "SOME_CHANNELS",
  ALL_CHANNELS: 1,
  [1]: "ALL_CHANNELS",
...
export const UserGuildRoleSubscriptionRelationship = {
  NONE: 0,
  [0]: "NONE",
  IN_SUBSCRIPTION_SERVER: 1,
  [1]: "IN_SUBSCRIPTION_SERVER",
  SUBSCRIBED: 2,
  [2]: "SUBSCRIBED",
};
