...
export const openTierCreationModal = function openTierCreationModal(arg0) {
  ...
  obj2.pushLazy(asyncRequireImpl(16741, dependencyMap.paths), obj, closure_5);
};
export const openGroupSetupModal = function openGroupSetupModal(guildId) {
  ...
  ModalActionCreators.pushLazy(asyncRequireImpl(16773, dependencyMap.paths), obj, closure_6);
};