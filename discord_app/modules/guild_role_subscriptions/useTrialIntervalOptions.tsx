    ...
    const options = TIER_TRIAL_INTERVALS.map((value) => {
      ...
      if (value.interval === constants.DAY) {
        if (7 === value.interval_count) {
          ...
          const obj3 = { defaultLimit: active_trial(14750).formatPlanIntervalDuration(value) };
          let formatToPlainStringResult = intl.formatToPlainString(active_trial(1115).t.XfSsr1, obj3);
          const obj4 = active_trial(14750);
        }
      ...
      formatToPlainStringResult = active_trial(14750).formatPlanIntervalDuration(value);
      const obj2 = active_trial(14750);
    });
