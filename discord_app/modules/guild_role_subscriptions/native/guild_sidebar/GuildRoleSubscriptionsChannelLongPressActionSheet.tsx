...
export default function GuildRoleSubscriptionsChannelLongPressActionSheet(arg0) {
  ...
  obj[1] = callback(Button /* Button */.Icon, obj1);
  obj[0] = callback(View, obj);
  const intl = getSystemLocale /* getSystemLocale */.intl;
  obj[1] = intl.string(getSystemLocale /* getSystemLocale */.t["KzCF/6"]);
  ...
  obj4[0] = intl2.string(getSystemLocale /* getSystemLocale */.t.WqhZss);
  obj2[1] = callback(Form /* Form */.FormLabel, obj4);
  obj2[2] = function onPress() {
    callback();
    const result = outer1_0(outer1_2[13]).copyGuildChannelOrThreadLink(closure_0, outer1_4.ROLE_SUBSCRIPTIONS);
  };
  items[1] = callback(Form /* Form */.FormRow, obj2);
  obj[0] = items;
