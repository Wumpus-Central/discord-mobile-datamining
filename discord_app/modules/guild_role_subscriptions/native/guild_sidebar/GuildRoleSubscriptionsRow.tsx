...
export default function GuildRoleSubscriptionsRow(selected) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(16209, dependencyMap.paths), c1, obj);
  }, items1);
  ...
  obj = { disableColor: true, mode: DEFAULT, source: _modDef12783 };
  obj.icon = jsx(tmp6(12383).BaseChannelIcon, { disableColor: true, mode: DEFAULT, source: _modDef12783 });
  return jsx(BaseChannelItemDefault, { disableColor: true, mode: DEFAULT, source: _modDef12783 });
};