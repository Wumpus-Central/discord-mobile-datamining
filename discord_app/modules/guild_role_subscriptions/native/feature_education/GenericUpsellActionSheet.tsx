...
export default function GenericUpsellActionSheet(markAsDismissed) {
  ...
  const items = [
    ...
    closure_5(markAsDismissed(7154).ActionSheetHeaderBar, { variant: "floating", onPress: bottomSheetClose }),
  ];
  obj.children = items;
  ...
  const items1 = [
    ...
    closure_5(markAsDismissed(4975).Button, { variant: "primary", grow: true, onPress: onCTAPress, text: cta }),
  ];
