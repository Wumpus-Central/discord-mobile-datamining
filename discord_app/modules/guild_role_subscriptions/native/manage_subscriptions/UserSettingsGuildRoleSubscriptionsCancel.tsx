...
import _modDef15444 from "../../../../../_runtime/metro/15444__.js";
...
function WhatYouLose(subscription) {
  ...
  const formatResult1 = intl.format(util.t.EtAXzC, {
    subscriptionEndDate: _modDef4314(subscription.subscription.currentPeriodEnd).format(c12),
  });
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  const analyticsLocations = subscription(7358)(
    subscription(7378).GUILD_ROLE_SUBSCRIPTION_CANCELLATION_MODAL,
  ).analyticsLocations;
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj6.body =
                ...
                tmp3(4314)(subscription.currentPeriodEnd).format(closure_1_12) +
                ".";
...
let obj2 = {
  ...
  heroImage: { width: "100%", height: "w", aspectRatio: "<string:2353406737>" },
