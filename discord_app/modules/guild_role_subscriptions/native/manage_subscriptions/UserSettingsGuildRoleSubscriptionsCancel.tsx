...
import registerAssetDefault from "../../../../../_runtime/15075_registerAsset.js";
...
function WhatYouLose(subscription) {
  ...
  obj = {
    numEmojis: callback(obj.useTierEmojiIds(listingId, guild.id), 1)[0].size,
    numChannels: callback(obj1.useChannelBenefits(listingId), 1)[0].length,
    numIntangibles: callback(obj2.useIntangibleBenefits(listingId), 1)[0].length,
  };
  ...
  const items1 = [
    callback2(Text.Text, {
      ...
      children: callback(obj3.useName(listingId), 1)[0],
    }),
    callback2(Button.Spacer, { size: 2 }),
  ];
  ...
  obj1[1] = items;
  const items2 = [
    callback3(closure_7, obj1),
    callback2(FormSeparatorDefault, { style: { marginVertical: 16 } }),
    ,
    ,
    ,
    ,
  ...
  items2[5] = callback2(Text.Text, {
    variant: "text-sm/medium",
    color: "text-default",
    children: intl2.formatToPlainString(getSystemLocale.t.OVlNGT, obj),
  });
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  analyticsLocations = subscription(5962)(
    subscription(5982).GUILD_ROLE_SUBSCRIPTION_CANCELLATION_MODAL,
  ).analyticsLocations;
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj1[1] =
                "You can resubscribe any time before " + lib2(4074)(lib2.currentPeriodEnd).format(closure_1_12) + ".";
