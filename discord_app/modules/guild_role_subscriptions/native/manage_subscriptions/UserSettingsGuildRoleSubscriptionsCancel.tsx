...
function WhatYouLose(subscription) {
  ...
  let obj4 = require("../../../../../_runtime/03867_t.js")(subscription.subscription.currentPeriodEnd);
  ...
  const formatResult1 = intl.format(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.EtAXzC, { subscriptionEndDate: obj4.format(c12) });
  const items = [callback2(require("../../../guild/native/GuildIcon.tsx"), { guild }), callback2(require("../../../../design/void/native.tsx") /* Button */.Spacer, { size: 16 }), ];
  obj2 = { children: null };
  const items1 = [callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-md/semibold", color: "interactive-text-active", children: callback(obj3.useName(listingId), 1)[0] }), callback2(require("../../../../design/void/native.tsx") /* Button */.Spacer, { size: 2 }), ];
  obj3 = { variant: "text-sm/medium", color: "interactive-text-default", children: guild.name };
  items1[2] = callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj3);
  obj2[0] = items1;
  items[2] = callback3(closure_7, obj2);
  obj1[1] = items;
  const items2 = [callback3(closure_7, obj1), callback2(require("../components/FormSeparator.tsx"), { style: { marginVertical: 16 } }), , , , , ];
  obj4 = { variant: "text-md/semibold", color: "interactive-text-active", children: null };
  const intl3 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj4[2] = intl3.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["9SgXmT"]);
  items2[2] = callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj4);
  items2[3] = callback2(require("../../../../design/void/native.tsx") /* Button */.Spacer, { size: 12 });
  const items3 = [formatResult1, "\n"];
  items2[4] = callback3(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-sm/normal", color: "text-default", children: items3 });
  items2[5] = callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-sm/medium", color: "text-default", children: intl2.formatToPlainString(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.OVlNGT, obj) });
  const obj5 = { source: null, style: null };
  const formatToPlainStringResult = intl2.formatToPlainString(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.OVlNGT, obj);
  obj5[0] = require("../../../../../_runtime/14371_registerAsset.js");
  obj5[1] = tmp.cactus;
  items2[6] = callback2(require("../../../../components_native/common/FastImage.tsx"), obj5);
  obj[1] = items2;
...
function Content(subscription) {
  ...
  const tmp = createCacheKey();
  ({ listing, guild } = require("../../manage_subscriptions/useManageSubscriptionCardData.tsx")(subscription));
  ...
  if (null != listing) {
    ...
    if (null != guild) {
      ...
      const items = [callback2(require("../components/FastAssetImage.tsx"), obj1), ];
