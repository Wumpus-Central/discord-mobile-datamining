...
import registerAssetDefault from "../../../../../_runtime/15235_registerAsset.js";
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  analyticsLocations = subscription(7162)(
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj1[1] =
                "You can resubscribe any time before " + lib2(4153)(lib2.currentPeriodEnd).format(closure_1_12) + ".";
