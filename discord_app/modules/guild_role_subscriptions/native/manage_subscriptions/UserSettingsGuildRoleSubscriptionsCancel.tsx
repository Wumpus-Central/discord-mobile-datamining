...
import _modDef15584 from "../../../../../_runtime/metro/15584__.js";
...
function WhatYouLose(subscription) {
  ...
  const formatResult1 = intl.format(util.t.EtAXzC, {
    subscriptionEndDate: _modDef4416(subscription.subscription.currentPeriodEnd).format(c12),
  });
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  const analyticsLocations = subscription(7495)(
    subscription(7515).GUILD_ROLE_SUBSCRIPTION_CANCELLATION_MODAL,
  ).analyticsLocations;
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj6.body =
                ...
                tmp3(4416)(subscription.currentPeriodEnd).format(closure_1_12) +
                ".";
