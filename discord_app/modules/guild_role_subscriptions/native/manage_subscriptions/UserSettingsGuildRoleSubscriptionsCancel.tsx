...
function WhatYouLose(subscription) {
  ...
  const formatResult1 = intl.format(util.t.EtAXzC, {
    subscriptionEndDate: _modDef4418(subscription.subscription.currentPeriodEnd).format(c12),
  });
...
function CancelSubscriptionButtonFooter(guild) {
  ...
  const analyticsLocations = subscription(6578)(
    subscription(6598).GUILD_ROLE_SUBSCRIPTION_CANCELLATION_MODAL,
  ).analyticsLocations;
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              obj6.body =
                ...
                tmp3(4418)(subscription.currentPeriodEnd).format(closure_1_12) +
                ".";
