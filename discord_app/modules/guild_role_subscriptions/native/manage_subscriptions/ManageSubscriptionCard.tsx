...
import _modDef8978 from "../../../../../_runtime/metro/08978__.js";
...
function Header(arg0) {
  ...
  items3[1] = expanded;
  items1[2] = closure_1_11(native.Icon, { style: items3, size: native.Icon.Sizes.MEDIUM, source: _modDef8978 });
...
function CardBody(isTrial) {
          ...
          if (arg0 === 1) {
            ...
            if (isTrial) {
              ...
              if (tmp46) {
                ...
                c4 = 2;
                c5 = 1;
                const obj8 = { value: tmp38(5167).resubscribeToSubscription(tmp45, analyticsLocations), done: false };
                return obj8;
              }
            }
          }
  ...
  const tmp = closure_14();
  dependencyMap = tmp;
  let resubscribeSubscription = subscription(8659).useResubscribeSubscription(subscription.id);
  resubscribeSubscription = resubscribeSubscription.resubscribeSubscription;
  let obj = subscription(8659);
  [tmp6, c5] = analyticsLocations.useState(false);
  analyticsLocations = subscription(6578)().analyticsLocations;
  ...
  let tmp2Result7;
  if (isTrial) {
    tmp2Result7 = tmp2(12267);
  }
  obj6.icon = tmp2Result7;
  let prop;
  if (isTrial) {
    prop = tmp15(4524).presentGuildRoleSubscriptionTrialTierMonthCost;
  }
  obj6.onPressIcon = prop;
  obj6.children = subscriptionPrice;
  items2[1] = closure_11(subscription(14739), obj6);
  items2[2] = closure_11(isTrial(1177).Spacer, { size: 16 });
  let obj7 = { style: tmp.cardRow, children: null };
  const items3 = [closure_11(subscription(14739), { title: nextRenewalLabel, children: nextRenewalDate }), closure_11(isTrial(1177).Spacer, { size: 8 }), ];
  let obj8 = { title: null, children: null };
  const tmp2Result = subscription(14739);
  const intl3 = tmp15(1115).intl;
  obj8.title = intl3.string(isTrial(1115).t.AOcwWB);
  obj8.children = memberSince;
  items3[2] = closure_11(subscription(14739), obj8);
  ...
  const tmp2Result8 = subscription(14739);
  ...
  const items4 = [closure_11(subscription(14740), obj12), , ];
  const obj13 = { text: null, onPress: null };
  const tmp2Result9 = subscription(14740);
  ...
  items4[1] = closure_11(subscription(14740), obj13);
  if (isCancelled) {
    ...
    obj15.loading = tmp6;
    obj14.children = closure_11(tmp2(9750), obj15);
    let tmp13Result = closure_11(tmp8, obj14);
    const tmp2Result11 = tmp2(9750);
  } else {
    ...
    tmp13Result = closure_11(tmp2(14740), obj16);
    const tmp2Result12 = tmp2(14740);
  }
  items4[2] = tmp13Result;
  obj11.children = items4;
  obj10.children = closure_12(isTrial(9796).GappedList, obj11);
  obj9.children = closure_11(closure_7, obj10);
  items2[4] = closure_11(isTrial(8045).FormSection, obj9);
