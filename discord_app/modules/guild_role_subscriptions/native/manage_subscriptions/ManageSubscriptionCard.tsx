...
import _modDef8989 from "../../../../../_runtime/metro/08989__.js";
...
function Header(arg0) {
  ...
  items3[1] = expanded;
  items1[2] = closure_1_11(native.Icon, { style: items3, size: native.Icon.Sizes.MEDIUM, source: _modDef8989 });
...
function CardBody(isTrial) {
          ...
          if (arg0 === 1) {
            ...
            if (isTrial) {
              ...
              if (tmp46) {
                ...
                c4 = 2;
                c5 = 1;
                const obj8 = { value: tmp38(5174).resubscribeToSubscription(tmp45, analyticsLocations), done: false };
                return obj8;
              }
            }
          }
  ...
  const tmp = closure_14();
  dependencyMap = tmp;
  let resubscribeSubscription = subscription(8667).useResubscribeSubscription(subscription.id);
  ...
  if (isCancelled) {
    ...
    obj15.loading = tmp6;
    obj14.children = closure_11(tmp2(9761), obj15);
    let tmp13Result = closure_11(tmp8, obj14);
    const tmp2Result11 = tmp2(9761);
  } else {
  ...
  obj10.children = closure_12(isTrial(9807).GappedList, obj11);
  obj9.children = closure_11(closure_7, obj10);
  items2[4] = closure_11(isTrial(8053).FormSection, obj9);
...
export default function ManageSubscriptionCard(subscription) {
  ...
  const tmp = closure_14();
  importDefault = subscription(1485).useNavigation();
  let tmp4Result = null;
