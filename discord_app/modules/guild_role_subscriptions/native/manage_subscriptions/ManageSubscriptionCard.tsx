...
function CardBody(isTrial) {
  ...
  if (isPastDue) {
    ...
    obj4.children = items;
    const items1 = [closure_12(tmp8, obj4), closure_11(isTrial(1176).Spacer, { size: 12 })];
  ...
  if (isCancelled) {
    ...
    obj15.loading = tmp6;
    obj14.children = closure_11(tmp2(10430), obj15);
    ...
    tmp13Result = closure_11(tmp2(15305), obj16);
