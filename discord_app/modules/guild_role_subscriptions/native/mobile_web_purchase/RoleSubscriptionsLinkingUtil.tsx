    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          c5 = 3;
          c6 = 1;
          obj3 = { value: closure_129_1.redirectWithHandoffToken(closure_129_0, { forceExternalBrowser: true }), done: false };
          return obj3;
        }
      } else if (arg0 === 1) {
        c6 = 3;
    ...
    try {
      ...
      if (0 === c1) {
        if (arg0 === 1) {
          ...
          c1 = 1;
          c0 = 1;
          const obj1 = { value: performDeveloperPortalRedirectWithTokenHandoff(constants.DEVELOPER_PORTAL_TEAMS), done: false };
          return obj1;
        }
      } else if (arg0 === 1) {
        c0 = 3;
    ...
    try {
      ...
      if (0 === c2) {
        if (arg0 === 1) {
          ...
          c2 = 1;
          c1 = 1;
          const obj1 = { value: performDeveloperPortalRedirectWithTokenHandoff(React4.DEVELOPER_PORTAL_EDIT_PAYOUTS(closure_0)), done: false };
          return obj1;
        }
      } else if (arg0 === 1) {
        c1 = 3;
