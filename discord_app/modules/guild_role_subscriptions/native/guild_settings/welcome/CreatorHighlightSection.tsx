// === Module 16636: GuildServerSubscriberCount ===
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp4 = guild_id(16637)(guild_id, 3, 60);
  dependencyMap = tmp4;
  ...
  if (tmp4.isLoading) {
    ...
    obj1[1] = obj2;
    const items1 = [callback(tmp2(5207), obj1), ];
    ...
    obj14[2] = tmp5;
    obj13[1] = callback(_require(4667).BaseTextButton, obj14);
