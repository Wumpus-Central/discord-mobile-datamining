...
function GuildServerSubscriberCount(arg0) {
  ...
  obj = { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10430 };
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp6.isLoading) {
    obj = { style: tmp.cardContainer, children: closure_6(tmp5(17796), {}) };
    ...
    obj2.source = obj3;
    const items1 = [closure_6(tmp5(5668), obj2), ];
    ...
    const items2 = [closure_6(tmp2(4632).Text, obj5), ];
    ...
    items3[1] = closure_6(tmp2(4632).Text, obj7);
    ...
    items3[2] = closure_6(tmp2(4632).Text, obj8);
    ...
    if (tmp9Result) {
      ...
      const items5 = [closure_6(tmp2(4632).Text, obj11), ];
      ...
      if (tmp11Result) {
        ...
        tmp11Result = closure_6(tmp2(4632).Text, obj13);
      }
    ...
    obj15.onPress = tmp7;
    obj14.children = closure_6(tmp2(5057).BaseTextButton, obj15);
