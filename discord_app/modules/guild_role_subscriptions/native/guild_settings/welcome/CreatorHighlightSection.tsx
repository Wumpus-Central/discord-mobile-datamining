...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp4 = guild_id(17256)(guild_id, 3, 60);
  dependencyMap = tmp4;
  ...
  if (tmp4.isLoading) {
    ...
    obj1[1] = obj2;
    const items1 = [callback(tmp2(5461), obj1), ];
    ...
    if (tmp7Result) {
      ...
      const items4 = [tmp9(tmp10(4444).Text, obj10), ];
      ...
      if (tmp9Result) {
        ...
        tmp9Result = tmp9(tmp10(4444).Text, obj12);
      }
      items6[1] = tmp9Result;
      obj11[1] = items6;
