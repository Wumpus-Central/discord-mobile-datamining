...
function GuildServerSubscriberCount(arg0) {
  ...
  obj = { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10334 };
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  if (tmp4.isLoading) {
    let obj = { style: tmp.cardContainer, children: closure_6(tmp2(17716), {}) };
    ...
    obj1.source = obj2;
    const items1 = [closure_6(tmp2(5601), obj1), ];
    ...
    if (tmp7Result) {
      ...
      const items4 = [closure_6(tmp10(4570).Text, obj10), ];
      ...
      if (tmp9Result) {
        ...
        tmp9Result = closure_6(tmp10(4570).Text, obj12);
      }
      items6[1] = tmp9Result;
