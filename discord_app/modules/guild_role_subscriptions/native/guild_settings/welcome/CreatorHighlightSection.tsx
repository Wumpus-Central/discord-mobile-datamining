...
import { registerAsset } from "../../../../../../_runtime/08733_registerAsset.js";
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp4 = guild_id(16865)(guild_id, 3, 60);
  dependencyMap = tmp4;
  ...
  if (tmp4.isLoading) {
    ...
    obj1[1] = obj2;
    const items1 = [callback(tmp2(5307), obj1), ];
    ...
    obj4[4] = guildName;
    const items2 = [callback(_Text.Text, obj4), ];
    ...
    obj6[3] = quote;
    items3[1] = callback(_Text.Text, obj6);
    ...
    obj7[5] = intl.format(_getSystemLocale.t.m0b6Kj, obj8);
    items3[2] = callback(_Text.Text, obj7);
    ...
    if (tmp7Result) {
      ...
      const items4 = [tmp9(tmp10(4340).Text, obj10), ];
      ...
      if (tmp9Result) {
        ...
        tmp9Result = tmp9(tmp10(4340).Text, obj12);
      }
      items6[1] = tmp9Result;
      obj11[1] = items6;
    ...
    obj14[1] = intl4.string(_getSystemLocale.t.mQ2IGa);
    obj14[2] = tmp5;
    obj13[1] = callback(_CollapsingText.BaseTextButton, obj14);
