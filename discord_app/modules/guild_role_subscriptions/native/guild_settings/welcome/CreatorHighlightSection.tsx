// === Module 18178: CreatorHighlightSection ===
...
function GuildServerSubscriberCount(arg0) {
  ...
  items[2] = style;
  obj.style = items;
  const items1 = [timestampProducer(Text_Text.Text, { style: tmp.subscriberCount, variant: "text-sm/medium", color: "text-overlay-light", children: subscriberCount }), timestampProducer(native.Icon, { size: native.Icon.Sizes.SMALL, color: nativeDefault.unsafe_rawColors.WHITE, style: tmp.subscriberCountIcon, source: _modDef10566 }), ];
...
function CreatorGuildCard(highlightedCreatorGuild) {
  ...
  const tmp6 = guild_id(18179)(guild_id, 3, 60);
  dependencyMap = tmp6;
  const hasAllImperativeDetails = tmp6.hasAllImperativeDetails;
  let items = [hasAllImperativeDetails, tmp6];
  if (tmp6.isLoading) {
    const obj2 = { style: tmp.cardContainer, children: closure_6(tmp5(18151), {}) };
    ...
    obj5.source = obj6;
    const items1 = [closure_6(tmp5(5806), obj5), ];
    ...
    const items2 = [closure_6(tmp2(4753).Text, obj8), ];
    let tmp11Result = null != subscriberCount;
    if (tmp11Result) {
      const obj9 = { subscriberCount, style: tmp.serverSubscriberCount };
      tmp11Result = closure_6(GuildServerSubscriberCount, obj9);
    }
    ...
    items3[1] = closure_6(tmp2(4753).Text, obj10);
    ...
    items3[2] = closure_6(tmp2(4753).Text, obj11);
    ...
    if (tmp9Result) {
      ...
      const items5 = [closure_6(tmp2(4753).Text, obj14), ];
      ...
      if (tmp11Result2) {
        ...
        tmp11Result2 = closure_6(tmp2(4753).Text, obj16);
      }
      items7[1] = tmp11Result2;
      obj15.children = items7;
      items5[1] = closure_7(closure_4, obj15);
      obj13.children = items5;
      tmp9Result = closure_7(closure_4, obj13);
    }
    items3[3] = tmp9Result;
    ...
    obj18.onPress = tmp7;
    obj17.children = closure_6(tmp2(5188).BaseTextButton, obj18);
