...
function StartEarningButton(isTermsAccepted) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    return obj.openLazy(asyncRequireImpl(17781, dependencyMap.paths), EligibilityActionSheet.ELIGIBILITY_ACTION_SHEET_KEY, obj);
  }, items1);
  obj = {
    style: tmp.tos,
  ...
  if (eligibleForMonetization) {
    ...
    const obj7 = { source: require("module_9695"), color: require("native").unsafe_rawColors.WHITE, size: tmp5(tmp3[21]).Icon.Sizes.SMALL_20 };
