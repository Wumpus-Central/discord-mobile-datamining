...
function HowItWorksCard(iconSource) {
  ...
  obj = { style: tmp.container, children: callback(require("../../../../../components_native/common/FastImage.tsx"), obj1) };
  items[1] = callback(View, obj);
  items[2] = callback(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { style: tmp.howItWorksCardDescription, variant: "text-sm/normal", color: "mobile-text-heading-primary", children: description });
  obj[3] = items;
...
export default function HowItWorksSection() {
  ...
  obj[1] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.lT0ZNS);
  obj[2] = require("../../../../../../_runtime/16655_registerAsset.js");
  const items = [callback(HowItWorksCard, obj), callback(require("../../../../../design/void/native.tsx") /* Button */.Spacer, { size: 12 }), ];
  const obj1 = { cardNumber: 2, description: null, iconSource: null };
  const intl2 = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[1] = intl2.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.ihN2Wb);
  obj1[2] = require("../../../../../../_runtime/16656_registerAsset.js");
  items[2] = callback(HowItWorksCard, obj1);
  obj[1] = items;
  const items1 = [callback2(View, obj), ];
  const obj2 = { cardNumber: 3, description: null, iconSource: null };
  const intl3 = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj2[1] = intl3.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.c8krDQ);
  obj2[2] = require("../../../../../../_runtime/16657_registerAsset.js");
