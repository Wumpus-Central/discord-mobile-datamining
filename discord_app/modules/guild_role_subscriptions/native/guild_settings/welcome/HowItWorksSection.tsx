...
function HowItWorksCard(iconSource) {
  ...
  obj = { style: tmp.container, children: callback(preload, obj1) };
  items[1] = callback(View, obj);
  items[2] = callback(Text /* Text */.Text, { style: tmp.howItWorksCardDescription, variant: "text-sm/normal", color: "mobile-text-heading-primary", children: description });
  obj[3] = items;
...
export default function HowItWorksSection() {
  ...
  obj[1] = intl.string(getSystemLocale /* getSystemLocale */.t.lT0ZNS);
  obj[2] = registerAsset;
  const items = [callback(HowItWorksCard, obj), callback(Button /* Button */.Spacer, { size: 12 }), ];
  const obj1 = { cardNumber: 2, description: null, iconSource: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj1[1] = intl2.string(getSystemLocale /* getSystemLocale */.t.ihN2Wb);
  ...
  obj2[1] = intl3.string(getSystemLocale /* getSystemLocale */.t.c8krDQ);
