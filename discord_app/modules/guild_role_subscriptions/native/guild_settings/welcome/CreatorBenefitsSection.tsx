...
function EarningPreview() {
  ...
  obj1[2] = intl.string(getSystemLocale /* getSystemLocale */.t.TXPK7B);
  const items2 = [closure_5(Text /* Text */.Text, obj1), ];
  ...
  obj3[2] = intl2.string(getSystemLocale /* getSystemLocale */.t.LdjJG5);
  items2[1] = closure_5(Text /* Text */.Text, obj3);
  obj2[0] = items2;
  ...
  items3[1] = closure_5(preload, obj4);
  obj[1] = items3;
...
function ConsistentEarningBenefit() {
  ...
  obj[3] = intl.string(getSystemLocale /* getSystemLocale */.t["9CdmS8"]);
  const items = [callback(Text /* Text */.Text, obj), callback(EarningPreview, {}), ];
  ...
  items2[1] = callback(BenefitAvatar, { avatarSource: registerAsset });
  const obj1 = { avatarSource: registerAsset };
  items2[2] = callback(BenefitAvatar, { avatarSource: registerAsset });
  obj[1] = items2;
...
function RevenueShareBenefit() {
  ...
  items1[1] = obj1.isThemeDark(useTheme()) ? tmp4.greenTextDarkMode : tmp4.greenTextLightMode;
  obj[0] = items1;
  obj[3] = `${closure_4}%`;
  const items2 = [closure_5(Text /* Text */.Text, obj), , ];
  ...
  obj[3] = intl.string(getSystemLocale /* getSystemLocale */.t.AewsXD);
  items2[1] = closure_5(Text /* Text */.Text, obj);
  obj1 = { style: tmp4.revenueShareIllo, source: null };
  const tmp3 = useTheme();
  const tmp5 = closure_6;
  const tmp6 = View;
  obj1[1] = registerAsset;
  items2[2] = closure_5(preload, obj1);
  obj[1] = items2;
  return tmp5(tmp6, obj);
}
function BenefitAvatar(avatarSource) {
  const tmp = createCacheKey();
  obj = { style: tmp.benefitAvatarContainer, children: callback(preload, obj) };
