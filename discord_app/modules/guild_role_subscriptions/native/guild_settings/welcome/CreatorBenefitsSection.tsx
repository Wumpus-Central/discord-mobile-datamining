...
function ConsistentEarningBenefit() {
  ...
  if (obj4.isThemeDark(tmp3)) {
    let tmpResult = _modDef17736;
  } else {
    tmpResult = _modDef17737;
  }
  ...
  const obj1 = { avatarSource: _modDef17738 };
