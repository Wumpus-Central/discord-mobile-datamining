...
function EarningPreview() {
  ...
  obj1[2] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.TXPK7B);
  const items2 = [closure_5(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj1), ];
  ...
  obj3[2] = intl2.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.LdjJG5);
  items2[1] = closure_5(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj3);
  obj2[0] = items2;
  ...
  obj4[1] = require("../../../../../../_runtime/16659_registerAsset.js");
  items3[1] = closure_5(require("../../../../../components_native/common/FastImage.tsx"), obj4);
  obj[1] = items3;
...
function ConsistentEarningBenefit() {
  ...
  obj[3] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t["9CdmS8"]);
  const items = [callback(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj), callback(EarningPreview, {}), ];
  ...
  items2[1] = callback(BenefitAvatar, { avatarSource: require("../../../../../../_runtime/16662_registerAsset.js") });
  const obj1 = { avatarSource: require("../../../../../../_runtime/16662_registerAsset.js") };
  items2[2] = callback(BenefitAvatar, { avatarSource: require("../../../../../../_runtime/16663_registerAsset.js") });
  obj[1] = items2;
...
function FollowerAwardBenefit() {
  ...
  const intl = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[3] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.qsKRUQ);
  const items = [callback(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj), , ];
  obj = { style: tmp.socialIllo, source: null };
  obj[1] = require("../../../../../../_runtime/16664_registerAsset.js");
  items[1] = callback(require("../../../../../components_native/common/FastImage.tsx"), obj);
  const obj1 = { style: tmp.lanyardIllo, source: null };
  const tmp2 = require("../../../../../components_native/common/FastImage.tsx");
  obj1[1] = require("../../../../../../_runtime/16665_registerAsset.js");
  items[2] = callback(require("../../../../../components_native/common/FastImage.tsx"), obj1);
  obj[1] = items;
...
function RevenueShareBenefit() {
  ...
  items1[1] = obj1.isThemeDark(require("../../../../../hooks/useTheme.tsx")()) ? tmp4.greenTextDarkMode : tmp4.greenTextLightMode;
  obj[0] = items1;
  obj[3] = `${closure_4}%`;
  const items2 = [closure_5(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj), , ];
  ...
  obj[3] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.AewsXD);
  items2[1] = closure_5(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj);
  obj1 = { style: tmp4.revenueShareIllo, source: null };
  const tmp3 = require("../../../../../hooks/useTheme.tsx")();
  const tmp5 = closure_6;
  const tmp6 = View;
  obj1[1] = require("../../../../../../_runtime/16666_registerAsset.js");
  items2[2] = closure_5(require("../../../../../components_native/common/FastImage.tsx"), obj1);
  obj[1] = items2;
  return tmp5(tmp6, obj);
}
function BenefitAvatar(avatarSource) {
  const tmp = createCacheKey();
  obj = { style: tmp.benefitAvatarContainer, children: callback(require("../../../../../components_native/common/FastImage.tsx"), obj) };
