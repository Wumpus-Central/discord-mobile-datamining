// === Module 16448: HasCreatedListingsSection ===
...
function HasCreatedListingsSection(arg0) {
  ...
  obj1[0] = importDefault(16449);
  obj[2] = callback(require(5286) /* TableRowInner */.TableRow.Icon, obj1);
  obj[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_BASIC);
  };
  const items1 = [callback(require(5286) /* TableRowInner */.TableRow, obj, "guild-role-subscriptions-basic"), , , ];
  ...
  obj3[0] = importDefault(16450);
  obj2[2] = callback(require(5286) /* TableRowInner */.TableRow.Icon, obj3);
  obj2[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_TIERS);
  };
  items1[1] = callback(require(5286) /* TableRowInner */.TableRow, obj2, "guild-role-subscriptions-tiers");
  if (stateFromStores) {
    ...
    obj5[0] = tmp6(16451);
    obj4[2] = tmp5(tmp(5286).TableRow.Icon, obj5);
    obj4[3] = function onPress() {
      return callback(outer1_6.ROLE_SUBSCRIPTIONS_PAYMENTS, { guildId: id.id });
    };
    stateFromStores = tmp5(tmp(5286).TableRow, obj4, "guild-role-subscriptions-payments");
  }
  ...
  obj7[0] = importDefault(16452);
  obj6[2] = callback(require(5286) /* TableRowInner */.TableRow.Icon, obj7);
  obj6[3] = function onPress() {
    return callback(outer1_6.ROLE_SUBSCRIPTIONS_EMOJIS);
  };
  items1[3] = callback(require(5286) /* TableRowInner */.TableRow, obj6, "guild-role-subscriptions-emojis");
  obj[2] = items1;
  return closure_8(require(5620) /* TableRowGroupTitle */.TableRowGroup, obj);
}
