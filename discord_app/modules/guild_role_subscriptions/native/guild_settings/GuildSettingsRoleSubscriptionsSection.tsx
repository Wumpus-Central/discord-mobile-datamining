...
import { registerAsset } from "../../../../../_runtime/16625_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/16626_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/16628_registerAsset.js";
...
function HasCreatedListingsSection(arg0) {
  ...
  if (stateFromStores) {
    ...
    obj5[0] = tmp6(16627);
    obj4[2] = tmp5(tmp(5374).TableRow.Icon, obj5);
    obj4[3] = function onPress() {
      return callback(outer1_6.ROLE_SUBSCRIPTIONS_PAYMENTS, { guildId: id.id });
    };
    stateFromStores = tmp5(tmp(5374).TableRow, obj4, "guild-role-subscriptions-payments");
  }
