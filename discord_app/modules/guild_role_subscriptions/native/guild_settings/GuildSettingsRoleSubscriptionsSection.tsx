...
function HasCreatedListingsSection(arg0) {
  ...
  const items1 = [callback(require(5315) /* TableRowInner */.TableRow, obj, "guild-role-subscriptions-basic"), , , ];
  ...
  items1[1] = callback(require(5315) /* TableRowInner */.TableRow, obj2, "guild-role-subscriptions-tiers");
  if (stateFromStores) {
  ...
  items1[3] = callback(require(5315) /* TableRowInner */.TableRow, obj6, "guild-role-subscriptions-emojis");
  obj[2] = items1;
  return closure_8(require(5649) /* TableRowGroupTitle */.TableRowGroup, obj);
}
