// === Module 17289: ArchiveOrDeleteTierSection ===
...
import useEditStateContext from "useEditStateContext" /* 17256 */;
import AddBenefitButton from "AddBenefitButton" /* 17259 */;
import MemberPreviews from "MemberPreviews" /* 17282 */;
import Content from "Content" /* 17284 */;
import registerAssetDefault from "registerAsset" /* 17290 */;
...
import closure_10 from "usePriceTiers" /* 17244 */;
import { GuildRoleSubscriptionsTierScenes } from "MAX_SUBSCRIPTION_TIERS" /* 14734 */;
    ...
    if (null != subscriptionListing) {
      ...
      if (!subscriptionListing.published) {
        if (null != error) {
          ...
          tmp13 = callback2(groupListingId(17291), obj1);
          const tmp17 = groupListingId(17291);
        }
      }
    }
  }
