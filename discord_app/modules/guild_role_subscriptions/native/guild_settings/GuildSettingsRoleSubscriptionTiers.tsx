...
function EditListingButton(editStateId) {
  ...
  if (undefined === first) {
    const obj5 = {
      ...
      onLongPress() {
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(18299, dependencyMap.paths), "TierArchiveOrDelete", {
          editStateId,
          guildId,
          groupListingId,
        });
    ...
    const items2 = [closure_17(tmp2(4825).Text, obj9)];
    ...
    items3[3] = closure_17(tmp2(4825).Text, obj12);
        ...
        return closure_1_17(
          EditListingButton,
          {
            ...
            onPress() {
              ...
              let obj = guildEligibleForTierTemplates(18301);
              const obj2 = {
                groupListingId: id,
                initialEditStateId,
                onBeforeDispatchNewListing(id) {
