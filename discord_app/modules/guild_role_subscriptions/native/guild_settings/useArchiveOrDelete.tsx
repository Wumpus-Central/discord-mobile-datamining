// === Module 17252: useArchiveOrDelete ===
...
export default function useArchiveOrDelete(guildId, groupListingId, editStateId) {
  ...
  const deleteSubscriptionListing = _require(14741).useDeleteSubscriptionListing();
  ({ error, deleteSubscriptionListing: closure_8, submitting } = deleteSubscriptionListing);
  let obj3 = _require(14741);
  const archiveSubscriptionListing = _require(14741).useArchiveSubscriptionListing();
