...
export default function GuildRoleSubscriptionTierTemplateUpsellActionSheet(arg0) {
  ...
  obj1[2] = callback2(markAsDismissed(8146), { style: tmp.videoContainer, src: closure_12, width: tmp3, height: tmp3 / 1.7289156626506024, muted: true, paused: stateFromStores, ariaHidden: true });
  ...
  const items3 = [callback2(require(4189) /* Text */.Text, obj4), ];
  ...
  items3[1] = callback2(require(4189) /* Text */.Text, obj5);
  obj3[1] = items3;
