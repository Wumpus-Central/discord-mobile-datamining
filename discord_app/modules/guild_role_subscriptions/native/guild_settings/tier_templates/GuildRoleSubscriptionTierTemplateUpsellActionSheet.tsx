...
export default function GuildRoleSubscriptionTierTemplateUpsellActionSheet(arg0) {
  ...
  obj1[1] = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.gCgirr);
  ...
  obj4[3] = intl2.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.gCgirr);
  const items3 = [callback2(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj4), ];
  const obj5 = { variant: "text-md/normal", color: "text-default", style: tmp.subtitle, children: null };
  const intl3 = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj5[3] = intl3.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.fLMZFw);
  items3[1] = callback2(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj5);
  obj3[1] = items3;
  ...
  obj8[0] = intl4.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.BQq86h);
  ...
  obj10[0] = intl5.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.WAI6xu);
