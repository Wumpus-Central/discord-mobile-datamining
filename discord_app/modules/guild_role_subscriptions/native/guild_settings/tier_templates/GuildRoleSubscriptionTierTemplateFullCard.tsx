...
export default function GuildRoleSubscriptionTierTemplateFullCard(template) {
  ...
  const obj3 = { scrollsToTop: false, style: tmp.content, contentContainerStyle: { paddingBottom: 32 + useSafeAreaInsetsDefault().bottom }, children: null };
  ...
  const items2 = [closure_4(require("Text/Text").Text, obj5), closure_4(require("native").Spacer, { size: 4 }), , , , , , , , , ];
  ...
  const obj1 = { template, handleSelectTemplateInPreview, subscriptionPlanTextStyle: tmp.subscriptionPlanTextStyle, descriptionTextStyle: tmp.descriptionPlanTextStyle, closeActionSheet: true };
