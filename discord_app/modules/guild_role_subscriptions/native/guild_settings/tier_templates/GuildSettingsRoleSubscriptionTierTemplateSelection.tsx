...
import GuildRoleSubscriptionTierTemplatePreviewCardDefault from "GuildRoleSubscriptionTierTemplatePreviewCard.tsx";
import _slicedToArray from "../../../../../../_runtime/metro/00032__.js";
import noop from "../../../../../../_runtime/metro/00019__.js";
import GuildRoleSubscriptionTierTemplatesStore from "../../../tier_templates/GuildRoleSubscriptionTierTemplatesStore.tsx";
...
function GuildSettingsRoleSubscriptionTierTemplateSelectionComponent(guildId) {
  ...
  const stateFromStores = guildId(groupListingId[11]).useStateFromStores(items, () =>
    GuildRoleSubscriptionTierTemplatesStore.getTemplates(guildId),
  );
  ...
  const layoutEffect = navigation.useLayoutEffect(() => {
    let obj = {
      headerRight() {
        ...
        const obj2 = {
          style: closure_1_1.editIcon,
          children: closure_2_14(guildId(groupListingId[21]).PencilIcon, {
            color: closure_1_1.editIcon.color,
            size: "xs",
          }),
        };
  ...
  const items7 = [
    closure_14(guildId(groupListingId[9]).Text, obj7),
    closure_14(guildId(groupListingId[27]).Spacer, { size: 8 }),
    ,
    ,
    ,
    ,
  ...
  obj9.children = intl3.format(guildId(groupListingId[22]).t.iQML2g, {
...
let obj2 = {
  ...
  text: { marginLeft: 16, marginRight: 16 },
