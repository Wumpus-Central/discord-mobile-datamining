...
export default function GuildRoleSubscriptionTierTemplateSelectedActionSheet(markAsDismissed) {
  ...
  const items = [closure_5(markAsDismissed(4632).Text, obj1), closure_5(markAsDismissed(1178).Spacer, { size: 12 }), , , ];
  ...
  items[2] = closure_5(markAsDismissed(4632).Text, obj2);
  ...
  items[4] = closure_5(markAsDismissed(5057).BaseTextButton, obj3);
  obj.children = items;
