...
export default noop.forwardRef((benefitType) => {
  ...
  if (!tmp13) {
    ...
    if (benefitType.benefitType === constants.CHANNEL) {
      ...
      tmp25 = closure_13(tmp20(8663).FormInput, obj);
      tmp26 = closure_13;
    }
    ...
    const items = [tmp26(tmp2(17851), obj1)];
    let obj2 = {
    ...
    const items2 = [tmp26(tmp2(9886), obj4), tmp25, , , , ,];
    ...
    items2[3] = tmp26(tmp2(17852), obj6);
    const obj8 = { style: tmp4.header, children: null };
    tmp2Result = tmp2(9886);
    ...
    items2[5] = tmp26(tmp20(8663).FormInput, obj9);
