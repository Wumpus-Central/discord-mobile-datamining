...
const createCacheKey = { alignItems: "center", backgroundColor: ThemesDefault.colors.BACKGROUND_BASE_LOWEST, flexDirection: "row", justifyContent: "space-between", paddingBottom: 8, paddingHorizontal: 16 };
...
const result = require("obj132").fileFinishedImporting("modules/guild_role_subscriptions/native/components/GuildRoleSubscriptionBenefitModalHeader.tsx");
...
export default function GuildRoleSubscriptionBenefitModalHeader(canSave) {
  ...
  const tmp = callback4();
  const obj = { style: items, accessibilityRole: "button", onPress: onClose, children: null };
  items = [, ];
