...
createStyles.containerYellow = { backgroundColor: nativeDefault.colors.BACKGROUND_FEEDBACK_WARNING, borderColor: nativeDefault.colors.STATUS_WARNING };
let obj1 = { backgroundColor: nativeDefault.colors.BACKGROUND_FEEDBACK_WARNING, borderColor: nativeDefault.colors.STATUS_WARNING };
...
export default function WarningNotice(arg0) {
  ...
  obj = { style: tmp.alertIcon, source: _modDef5647 };
