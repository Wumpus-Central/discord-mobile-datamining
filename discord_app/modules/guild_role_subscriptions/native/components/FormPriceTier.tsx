...
require = fn;
const RoleTierEditStore = fn(18269);
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9619, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
          const tmp2 = asyncRequireImpl(9619, dependencyMap.paths);
        },
      placeholder: null
    };
