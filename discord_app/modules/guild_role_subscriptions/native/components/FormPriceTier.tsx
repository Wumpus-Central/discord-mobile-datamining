  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9546, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
          const tmp2 = asyncRequireImpl(9546, dependencyMap.paths);
        },
      placeholder: null
    };
