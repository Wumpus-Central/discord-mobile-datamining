...
require = fn;
const RoleTierEditStore = fn(18292);
  ...
  if (null == tiers) {
    ...
    const obj3 = {
      ...
      onPress() {
          ...
          obj.openLazy(asyncRequireImpl(9623, dependencyMap.paths), "GuildRoleSubscriptionPriceTierSelect", obj2);
          const tmp2 = asyncRequireImpl(9623, dependencyMap.paths);
        },
      placeholder: null
    };
