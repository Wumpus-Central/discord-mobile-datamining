// === Module 18230: GuildRoleSubscriptionEmojiEditorModal ===
...
import EmojiAliasDefault from "EmojiAlias" /* 18217 */;
    ...
    renderItem(item) {
      ...
      obj.label = function label() {
        ...
        if (closure_1) {
          ...
          const items1 = [React7(Text_Text.Text, obj3), ];
          ...
          tmpResult = closure_3_11(closure_3_10, obj2);
        }
