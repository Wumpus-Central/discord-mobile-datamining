...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    if (tmp13Result) {
      ...
      obj3[2] = first;
      obj2[1] = callback3(tmp3(5308), obj3);
  ...
  const items3 = [flag, callback3(onDone(16933).GuildRoleSubscriptionListingPreview, { guildId, listingId: editStateId })];
  obj.children = items3;
