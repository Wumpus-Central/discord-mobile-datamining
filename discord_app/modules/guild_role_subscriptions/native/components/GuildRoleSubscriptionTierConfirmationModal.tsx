...
export default function GuildRoleSubscriptionTierConfirmationModal(onDone) {
  ...
  if (flag) {
    ...
    if (tmp13Result) {
      ...
      obj3[2] = first;
      obj2[1] = callback3(tmp3(5307), obj3);
    ...
    items2[2] = callback3(tmp6(4340).Text, obj6);
    obj4[0] = items2;
    flag = tmp13(tmp16, obj4);
  }
  const items3 = [flag, callback3(onDone(16922).GuildRoleSubscriptionListingPreview, { guildId, listingId: editStateId })];
  obj.children = items3;
