...
function MemberPreviews(role) {
  ...
  const token = obj.useToken(require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.BACKGROUND_BASE_LOW, require("../../../../../discord_common/js/packages/tokens/native.tsx").themes.DARK);
  const token1 = require("../../../../design/tokens/native/useToken.tsx") /* map */.useToken(require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.BACKGROUND_BASE_LOW, require("../../../../../discord_common/js/packages/tokens/native.tsx").themes.LIGHT);
  const obj2 = require("../../../../design/tokens/native/useToken.tsx") /* map */;
  const token2 = require("../../../../design/tokens/native/useToken.tsx") /* map */.useToken(require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.TEXT_DEFAULT, require("../../../../../discord_common/js/packages/tokens/native.tsx").themes.DARK);
  const obj3 = require("../../../../design/tokens/native/useToken.tsx") /* map */;
  obj = { style: tmp.memberPreviews, children: null };
  const token3 = require("../../../../design/tokens/native/useToken.tsx") /* map */.useToken(require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.TEXT_DEFAULT, require("../../../../../discord_common/js/packages/tokens/native.tsx").themes.LIGHT);
  const items = [, , ];
  ({ member: arr[0], memberLight: arr[1] } = tmp);
  items[2] = { backgroundColor: token1 };
  const items1 = [callback2(require("listing_elements/GuildRoleSubscriptionMemberPreview.tsx") /* GuildRoleSubscriptionMemberPreview */.GuildRoleSubscriptionMemberPreview, { style: items, textStyle: { color: token3 }, role }), ];
  const items2 = [, , ];
  ({ member: arr3[0], memberDark: arr3[1] } = tmp);
  items2[2] = { backgroundColor: token };
  items1[1] = callback2(require("listing_elements/GuildRoleSubscriptionMemberPreview.tsx") /* GuildRoleSubscriptionMemberPreview */.GuildRoleSubscriptionMemberPreview, { style: items2, textStyle: { color: token2 }, role });
  obj[1] = items1;
...
function Content() {
  ...
  const roleSubscriptionSettingsDisabled = _require("../../RoleSubscriptionSettingsDisabledContext.tsx").useRoleSubscriptionSettingsDisabled();
  obj = { children: null };
  const items1 = [callback2(MemberPreviews, { role }), , , , ];
  obj1 = { style: tmp3.header, children: null };
  let tmpResult = tmp(8982);
  const intl = tmp4(1236).intl;
  obj1[1] = intl.string(_require("../../../../intl/index.native.tsx").t.sEr1zr);
  ...
  obj2[0] = intl2.string(_require("../../../../intl/index.native.tsx").t.Glqj9m);
  obj2[1] = tmp10;
  obj2[2] = UPLOAD_SMALL_SIZE;
  obj2[3] = _require("FormImagePicker.tsx").PreviewShape.SQUIRCLE;
  ...
  const tmp4Result = _require("../../RoleSubscriptionSettingsDisabledContext.tsx");
  const intl3 = tmp4(1236).intl;
  obj3[1] = intl3.string(_require("../../../../intl/index.native.tsx").t["W7hH+z"]);
  items1[3] = callback2(role(8982), obj3);
  items1[4] = callback2(role(16728), { color: tmp7, onChange: tmp8, disabled: roleSubscriptionSettingsDisabled });
  obj[0] = items1;
...
export default function GuildRoleSubscriptionTierDesignModal(arg0) {
  ...
  obj[0] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.AbcgTx);
  const intl2 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[1] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.YAUjGn);
