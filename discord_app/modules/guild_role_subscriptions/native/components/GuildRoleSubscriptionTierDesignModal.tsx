...
function Content() {
  ...
  const roleSubscriptionSettingsDisabled = _require(17272).useRoleSubscriptionSettingsDisabled();
  obj = { children: null };
  ...
  obj2[3] = _require(17278).PreviewShape.SQUIRCLE;
  ...
  const tmp4Result = _require(17272);
