...
export default function FormEmojiPicker(emoji) {
  ...
  if (null != emojiId) {
    ...
    tmp2Result = tmp2(5638);
    obj.source = tmp2(17844);
  ...
  const items = [tmp.container, onChange(13951)().textInput];
  obj1.style = items;
  const items1 = [tmp9, , ];
  ...
  const tmp2Result1 = onChange(9140);
