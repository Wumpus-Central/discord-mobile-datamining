...
export default function FormEmojiPicker(emoji) {
  ...
  if (null != emojiId) {
    ...
    tmp2Result = tmp2(5637);
    obj.source = tmp2(17853);
  ...
  const items = [tmp.container, onChange(13973)().textInput];
  obj1.style = items;
  const items1 = [tmp9, ,];
  ...
  const tmp2Result1 = onChange(9119);
