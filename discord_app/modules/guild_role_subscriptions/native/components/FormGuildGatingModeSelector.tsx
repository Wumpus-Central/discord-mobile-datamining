...
export default function FormGuildGatingModeSelector(isFullServerGating) {
  ...
  obj = { icon: onChange(11835), title: null, description: null, selected: null, onPress: null, disabled: null };
  ...
  const items2 = [closure_5(onChange(17762), obj), closure_5(View, { style: tmp.space })];
  ...
  items2[2] = closure_5(onChange(17762), obj2);
  obj.children = items2;
