...
function ChannelRow(channel) {
  ...
  if (selected) {
    ...
    selected = closure_11(tmp2(5672), obj2);
...
export default function ChannelSelectorActionSheet(guildId) {
  ...
  obj3.children = closure_11(guildId(4635).Text, {
  ...
  if (!hideCreateChannel) {
    const obj6 = {
      ...
      onPress() {
        ...
        obj2.pushLazy(
          asyncRequireImpl(9864, dependencyMap.paths),
          obj3,
    ...
    items3[1] = closure_11(tmp5(4635).Text, obj8);
    obj6.children = items3;
    tmp9Result = closure_13(tmp5(5207).PressableOpacity, obj6);
  }
  items2[2] = tmp9Result;
