...
function ChannelRow(channel) {
  ...
  const children = [closure_11(onChannelSelected(15442), obj), ];
  if (selected) {
    obj = { style: null, source: null };
    obj[0] = tmp.selectedIcon;
    obj[1] = tmp2(17006);
    selected = tmp8(tmp2(5454), obj);
    const tmp2Result = tmp2(5454);
  }
  children[1] = selected;
...
export default function ChannelSelectorActionSheet(guildId) {
  ...
  obj[1] = closure_11(guildId(4739).Text, { accessibilityRole: "header", variant: "text-md/bold", color: "mobile-text-heading-primary", children: title });
  ...
  obj1[1] = closure_11(guildId(7375).SearchField, obj2);
  ...
  if (!hideCreateChannel) {
    ...
    items3[1] = tmp8(tmp5(4739).Text, obj5);
    obj3[3] = items3;
    tmp9Result = tmp9(tmp5(5438).PressableOpacity, obj3);
  }
  items2[2] = tmp9Result;
  obj[2] = closure_13(closure_12, { children: items2 });
  obj[3] = closure_11(guildId(6990).BottomSheetFlatList, {
  ...
  return closure_11(guildId(7213).ActionSheet, obj);
};