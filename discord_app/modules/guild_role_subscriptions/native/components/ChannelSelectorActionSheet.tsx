...
function ChannelRow(channel) {
  ...
  if (selected) {
    ...
    selected = closure_11(tmp2(5806), obj2);
...
export default function ChannelSelectorActionSheet(guildId) {
  ...
  obj3.children = closure_11(guildId(4753).Text, {
  ...
  if (!hideCreateChannel) {
    ...
    items3[1] = closure_11(tmp5(4753).Text, obj8);
    obj6.children = items3;
    tmp9Result = closure_13(tmp5(5341).PressableOpacity, obj6);
  }
  items2[2] = tmp9Result;
