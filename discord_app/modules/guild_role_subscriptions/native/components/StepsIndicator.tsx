...
function StepNode(isCurrent) {
  ...
  let obj2 = { interpolate: isCurrent(num2[6]).interpolate, state: sharedValue, withTiming: isCurrent(num2[7]).withTiming, duration: num2, Easing: isCurrent(num2[6]).Easing };
}
