...
import _modDef18255 from "../../../../../_runtime/metro/18255__.js";
import _modDef18256 from "../../../../../_runtime/metro/18256__.js";
...
function EligibilityChecklistRow(item) {
  ...
  if (item.checked) {
    let tmp6Result = _modDef18255;
  } else {
    tmp6Result = _modDef18256;
  }
