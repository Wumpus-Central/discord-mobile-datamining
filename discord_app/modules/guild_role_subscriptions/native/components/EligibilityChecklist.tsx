...
import _modDef17728 from "../../../../../_runtime/metro/17728__.js";
import _modDef17729 from "../../../../../_runtime/metro/17729__.js";
...
function EligibilityChecklistRow(item) {
  ...
  if (item.checked) {
    let tmp6Result = _modDef17728;
  } else {
    tmp6Result = _modDef17729;
  }
