// === Module 16912: EligibilityChecklistRow ===
...
function EligibilityChecklistRow(item) {
  ...
  if (tmp5Result) {
    ...
    obj3[1] = tmp5(tmp10(4745).Button, { text: null, onPress: null, grow: true });
  ...
  if (item.isLast) {
    ...
    obj5[0] = tmp.divider;
    tmp5Result = tmp5(tmp6(14563), obj5);
  }
