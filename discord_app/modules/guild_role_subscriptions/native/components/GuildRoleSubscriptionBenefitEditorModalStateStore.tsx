// === Module 18211: GuildRoleSubscriptionBenefitEditorModalStateStore ===
...
let closure_2 = Object.freeze({ name: "", emojiId: "paddingHorizontal", emojiName: "limit", description: "it", refId: "Array" });
