// === Module 18292: GuildRoleSubscriptionBenefitEditorModalStateStore ===
...
let closure_2 = Object.freeze({ name: "", emojiId: "add", emojiName: "runOnJS", description: "it", refId: "Array" });
