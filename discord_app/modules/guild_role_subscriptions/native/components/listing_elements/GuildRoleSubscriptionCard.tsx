...
export const Content = function Content(arg0) {
  ...
  const items = [
    ...
    closure_6(guildId(15502).GuildRoleSubscriptionMemberPreview, { guildId, role }),
  ];
  obj6.children = items;
  ...
  if (first1.length > 0) {
    ...
    items4[2] = closure_6(guildId(10604).GappedList, obj15);
  ...
  if (first2.length > 0) {
    ...
    items5[2] = closure_6(guildId(10604).GappedList, obj19);
