// === Module 15242: GuildRoleSubscriptionBenefitRow ===
...
export const ChannelBenefitRow = function ChannelBenefitRow(benefit) {
  ...
  if (null != stateFromStores) {
    ...
    const obj1 = { style: tmp.channelIcon, size: tmp2(1178).Icon.Sizes.CUSTOM, source: tmp2(5028).getChannelIcon(stateFromStores) };
