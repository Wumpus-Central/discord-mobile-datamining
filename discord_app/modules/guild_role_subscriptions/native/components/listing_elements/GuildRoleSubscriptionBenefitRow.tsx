// === Module 15577: GuildRoleSubscriptionBenefitRow ===
...
export const ChannelBenefitRow = function ChannelBenefitRow(benefit) {
  ...
  let tmp8 = closure_5(benefit(4823).Text, obj2);
  if (null != stateFromStores) {
    const obj3 = { style: tmp.channelTitle, children: null };
    const obj4 = { style: tmp.channelIcon, size: tmp2(1177).Icon.Sizes.CUSTOM, source: tmp2(5325).getChannelIcon(stateFromStores) };
    ...
    items2[1] = closure_5(tmp2(4823).Text, obj5);
