...
function Row(arg0) {
  ...
  obj[5] = items;
  return closure_6(importDefault(8649), obj);
}
...
export default function AllChannelsSwitch(style) {
  ...
  obj = { icon: importDefault(16691), label: null, selected: null, onPress: null, disabled: null };
  ...
  const obj1 = { icon: importDefault(16692), label: null, selected: null, onPress: null, disabled: null };
