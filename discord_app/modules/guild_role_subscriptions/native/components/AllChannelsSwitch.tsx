...
export default function AllChannelsSwitch(style) {
  ...
  obj.style = items;
  obj = { icon: _modDef17878, label: null, selected: null, onPress: null, disabled: null };
  ...
  const obj1 = { icon: _modDef17879, label: null, selected: null, onPress: null, disabled: null };
