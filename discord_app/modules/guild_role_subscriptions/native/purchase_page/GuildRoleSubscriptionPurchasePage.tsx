...
function SocialBadge(onPress) {
  ...
  const items = [
    ...
    callback(Text.Text, { variant: "text-sm/medium", color: "text-default", children: text }),
  ];
  if (tmp5Result) {
          ...
          if (null != gatedChannelId) {
            if (null != stateFromStores1) {
              ...
              obj[0] = function unlockHook() {
                ...
                obj = {
                  size: guildId(stateFromStores1[11]).Icon.Sizes.SMALL_20,
                  style: closure_2.gatedChannelIcon,
                  source: guildId(stateFromStores1[22]).getChannelIcon(stateFromStores1),
                };
            ...
            obj15[1] = mapped.map((listingId) =>
              closure_1_14(gatedChannelId(stateFromStores1[30]), { listingId, guildId }, listingId),
            );
