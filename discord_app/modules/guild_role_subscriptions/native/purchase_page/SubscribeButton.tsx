...
function SwitchTiersButton(activeSubscription) {
  ...
  obj4.children = intl.format(activeSubscription(1115).t.lA7ztO, {
    ...
    billingEndDate: activeListingId(4348)(activeSubscription.currentPeriodEnd).format("MMMM Do"),
    emphasisHook,
  });
  const items = [
    closure_12(activeSubscription(4753).Text, obj4),
  ...
  obj6.onPress = function onPress() {
    ...
    obj.openLazy(asyncRequireImpl(16909, dependencyMap.paths), "ChangeSubscriptionCard:" + changeToListingId, {
      activeSubscription,
      activeListingId,
      changeToListingId,
    });
