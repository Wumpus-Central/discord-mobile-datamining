...
export default function GuildRoleSubscriptionPurchaseCard(guildId) {
  ...
  let obj2 = require("Elements.tsx") /* TruncatedText */;
  ...
  const items = [callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "heading-md/semibold", color: "mobile-text-heading-primary", children: callback(obj1.useName(listingId), 1)[0] }), callback2(View, { style: tmp.headerDot }), callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "heading-md/semibold", color: "mobile-text-heading-primary", children: formattedSubscriptionPlan })];
  obj2[1] = items;
  const items1 = [callback3(View, obj2), callback2(require("../../../../design/void/native.tsx") /* Button */.Spacer, { size: 16 }), callback2(require("Elements.tsx") /* TruncatedText */.TruncatedText, { variant: "text-sm/normal", color: "text-default", lineClamp: 2, children: callback(obj.useDescription(listingId), 1)[0] }), callback2(require("../../../../design/void/native.tsx") /* Button */.Spacer, { size: 24 }), callback2(require("SubscribeButton.tsx"), { listingId })];
  obj1[1] = items1;
  ...
  obj7[3] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.UdEvUi);
  const items3 = [callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj7), callback2(require("../../../../design/void/native.tsx") /* Button */.Spacer, { size: 24 }), callback2(require("../components/listing_elements/GuildRoleSubscriptionCard.tsx") /* SectionTitle */.Content, { listingId, guildId: guildId.guildId })];
  obj5[3] = items3;
  items2[2] = callback3(require("../../../../../_runtime/05340_BottomSheetModal.js") /* BottomSheetModal */.BottomSheetScrollView, obj5);
  obj[1] = items2;
