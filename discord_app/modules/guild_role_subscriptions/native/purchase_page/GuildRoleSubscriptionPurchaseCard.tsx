...
export default function GuildRoleSubscriptionPurchaseCard(guildId) {
  ...
  obj2[1] = items;
  const items1 = [callback3(View, obj2), callback2(Button.Spacer, { size: 16 }), callback2(TruncatedText.TruncatedText, { variant: "text-sm/normal", color: "text-default", lineClamp: 2, children: callback(obj.useDescription(listingId), 1)[0] }), callback2(Button.Spacer, { size: 24 }), callback2(emphasisHook, { listingId })];
  obj1[1] = items1;
