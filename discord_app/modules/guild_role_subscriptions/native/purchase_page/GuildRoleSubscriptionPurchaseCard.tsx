...
export default function GuildRoleSubscriptionPurchaseCard(guildId) {
  ...
  let obj2 = require(15530) /* TruncatedText */;
  ...
  obj2[1] = items;
  const items1 = [callback3(View, obj2), callback2(require(1297) /* Button */.Spacer, { size: 16 }), callback2(require(15530) /* TruncatedText */.TruncatedText, { variant: "text-sm/normal", color: "text-default", lineClamp: 2, children: callback(obj.useDescription(listingId), 1)[0] }), callback2(require(1297) /* Button */.Spacer, { size: 24 }), callback2(importDefault(15536), { listingId })];
  obj1[1] = items1;
  ...
  const items3 = [callback2(require(4281) /* Text */.Text, obj7), callback2(require(1297) /* Button */.Spacer, { size: 24 }), callback2(require(14373) /* SectionTitle */.Content, { listingId, guildId: guildId.guildId })];
  obj5[3] = items3;
