...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  const items = [
    closure_8(guildId(5672), { source: { uri: str }, style: tmp.image }),
    closure_8(listingId(1177).Spacer, { size: 16 }),
  ];
  const obj10 = { children: null };
  const items1 = [
    closure_8(listingId(4635).Text, {
  ...
  const items2 = [
    ...
    closure_8(listingId(1177).Spacer, { size: 16 }),
    closure_8(tmp11(16663), { listingId }),
  ];
  ...
  if (tmp8Result6) {
    ...
    obj11.children = closure_9(tmp4(10478).GappedList, obj12);
