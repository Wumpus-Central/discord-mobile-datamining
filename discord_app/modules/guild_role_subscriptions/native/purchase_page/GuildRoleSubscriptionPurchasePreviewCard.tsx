...
export default function GuildRoleSubscriptionPurchasePreviewCard(listingId) {
  ...
  const items = [
    closure_8(guildId(5806), { source: { uri: str }, style: tmp.image }),
    closure_8(listingId(1177).Spacer, { size: 16 }),
  ];
  const obj10 = { children: null };
  const items1 = [
    closure_8(listingId(4753).Text, {
      variant: "heading-md/semibold",
      color: "mobile-text-heading-primary",
      children: _slicedToArray(obj2.useName(listingId), 1)[0],
    }),
    closure_8(listingId(1177).Spacer, { size: 4 }),
    closure_8(listingId(4753).Text, {
  ...
  const items2 = [
    ...
    closure_8(listingId(1177).Spacer, { size: 16 }),
    closure_8(tmp11(16908), { listingId }),
  ];
