...
export default function ChangeSubscriptionCard(activeSubscription) {
  ...
  const items1 = [
    closure_7(activeSubscription(4634).Text, obj6),
  ...
  if (activeSubscription.status !== SubscriptionStatusTypes.CANCELED) {
    ...
    obj11.onPress = function onPress() {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(16685, dependencyMap.paths), {
        subscriptionId: activeSubscription.id,
      });
      const obj2 = { subscriptionId: activeSubscription.id };
      ActionSheetActionCreatorsDefault.hideActionSheet();
    };
    items3[1] = closure_7(tmp6(16677).ArrowButton, obj11);
  ...
  return closure_7(activeSubscription(7260).BottomSheet, { startExpanded: true, children: closure_8(View, obj4) });
}
