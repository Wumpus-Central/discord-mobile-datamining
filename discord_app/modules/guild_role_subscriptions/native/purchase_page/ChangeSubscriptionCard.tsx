// === Module 16909: ChangeSubscriptionCard ===
...
export default function ChangeSubscriptionCard(activeSubscription) {
  ...
  const items1 = [closure_7(activeSubscription(4753).Text, obj6), closure_7(activeSubscription(1177).Spacer, { size: 16 }), , ];
  ...
  if (activeSubscription.status !== SubscriptionStatusTypes.CANCELED) {
    ...
    obj11.onPress = function onPress() {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(16910, dependencyMap.paths), { subscriptionId: activeSubscription.id });
