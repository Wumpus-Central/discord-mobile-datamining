// === Module 17789: GuildRoleSubscriptionTierTemplateActionCreators ===
    ...
    try {
      ...
      if (0 === c3) {
        if (arg0 === 1) {
          ...
          const obj1 = { url: Endpoints.GUILD_ROLE_SUBSCRIPTION_LISTING_TEMPLATES(closure_0), rejectWithError: HTTPUtils.rejectWithMigratedError() };
          c3 = 1;
          c4 = 1;
        ...
        if (null != body.templates) {
          ...
          const obj4 = { type: "GUILD_ROLE_SUBSCRIPTIONS_FETCH_TEMPLATES", templates: body.templates, guildId: closure_129_0 };
          obj.dispatch(obj4);
        }
        c4 = 3;
        return { value: "HermesInternal", done: null };
