...
function ReactionTab(arg0) {
  ...
  items5[2] = tmp19;
  items4[1] = closure_1_17(Text_Text.Text, {
...
function EmojiOptionsButton(channelId) {
  ...
  const tmp = closure_20();
  items3[1] = closure_17(channelId(7282).ChevronSmallRightIcon, {
...
function ReactionTabs(setReactionSelectedIndex) {
  ...
  const items = [
    closure_17(setReactionSelectedIndex(11356), obj),
    closure_17(setReactionSelectedIndex(8690), { outer: true }),
  ];
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  obj = {
    scrollable: true,
    backdropOpacity: tmp10(7856).BACKDROP_OPACITY,
