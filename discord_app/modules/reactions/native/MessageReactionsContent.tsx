...
function EmojiOptionsButton(channelId) {
  ...
  const tmp = closure_20();
  items3[1] = closure_17(channelId(7261).ChevronSmallRightIcon, {
...
function ReactionTabs(setReactionSelectedIndex) {
  ...
  const items = [
    closure_17(setReactionSelectedIndex(11334), obj),
    closure_17(setReactionSelectedIndex(8669), { outer: true }),
  ];
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  obj = {
    scrollable: true,
    backdropOpacity: tmp10(7835).BACKDROP_OPACITY,
