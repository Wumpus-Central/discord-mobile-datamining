...
function EmojiOptionsButton(channelId) {
  ...
  const obj2 = {
    onPress: noop.useCallback(() => {
      ActionSheetActionCreatorsDefault.openLazy(
        asyncRequireImpl(11415, dependencyMap.paths),
  ...
  items3[1] = closure_17(channelId(7323).ChevronSmallRightIcon, {
...
function ReactionTabs(setReactionSelectedIndex) {
  ...
  const items = [
    closure_17(setReactionSelectedIndex(11416), obj4),
    closure_17(setReactionSelectedIndex(8754), { outer: true }),
  ];
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  let obj3 = {
    scrollable: true,
    backdropOpacity: tmp10(7904).BACKDROP_OPACITY,
