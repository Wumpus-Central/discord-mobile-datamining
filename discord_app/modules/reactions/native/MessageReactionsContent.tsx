...
function EmojiOptionsButton(channelId) {
  ...
  items3[1] = closure_17(channelId(7449).ChevronSmallRightIcon, {
...
function ReactionTabs(setReactionSelectedIndex) {
  ...
  const items = [
    closure_17(setReactionSelectedIndex(11526), obj4),
    closure_17(setReactionSelectedIndex(8876), { outer: true }),
  ];
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  let obj3 = {
    scrollable: true,
    backdropOpacity: tmp10(8024).BACKDROP_OPACITY,
