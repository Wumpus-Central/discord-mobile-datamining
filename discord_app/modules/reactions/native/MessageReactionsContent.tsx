...
function EmojiOptionsButton(channelId) {
  ...
  const tmp = closure_20();
  items3[1] = closure_17(channelId(7223).ChevronSmallRightIcon, {
...
function ReactionTabs(setReactionSelectedIndex) {
  ...
  const items = [
    closure_17(setReactionSelectedIndex(11294), obj),
    closure_17(setReactionSelectedIndex(8632), { outer: true }),
  ];
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  obj = {
    scrollable: true,
    backdropOpacity: tmp10(7798).BACKDROP_OPACITY,
