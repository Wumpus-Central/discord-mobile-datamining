...
function EmojiOptionsButton(channelId) {
  ...
  items3[1] = closure_17(channelId(7454).ChevronSmallRightIcon, {
...
function ReactionTabs(setReactionSelectedIndex) {
  ...
  const items = [
    closure_17(setReactionSelectedIndex(11528), obj4),
    closure_17(setReactionSelectedIndex(8877), { outer: true }),
  ];
...
export const MessageReactionsContent = function MessageReactionsContent(channelId) {
  ...
  let obj3 = {
    scrollable: true,
    backdropOpacity: tmp10(8026).BACKDROP_OPACITY,
