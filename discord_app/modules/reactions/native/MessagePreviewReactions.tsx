...
export default function MessagePreviewReactions(emoji) {
  ...
  if (stateFromStores.length > 0) {
    ...
    let tmp4Result = jsx(channelId(10813).MessageReactionsContent, {
      channelId,
      messageId,
      emoji: emoji.emoji,
    ...
    tmp4Result = jsx(channelId(10813).MessageReactionsEmpty, {});
  }
  obj2.children = tmp4Result;
  return jsx(channelId(6578).AnalyticsLocationProvider, {
    value: messageId(6578)(messageId(6598).MESSAGE_PREVIEW_REACTIONS).analyticsLocations,
    children: null,
  });
}
