...
export default function MessagePreviewReactions(emoji) {
  ...
  if (stateFromStores.length > 0) {
    ...
    let tmp4Result = jsx(channelId(11608).MessageReactionsContent, {
      channelId,
      messageId,
      emoji: emoji.emoji,
    ...
    tmp4Result = jsx(channelId(11608).MessageReactionsEmpty, {});
  }
  obj2.children = tmp4Result;
  return jsx(channelId(7495).AnalyticsLocationProvider, {
    value: messageId(7495)(messageId(7515).MESSAGE_PREVIEW_REACTIONS).analyticsLocations,
    children: null,
  });
}
