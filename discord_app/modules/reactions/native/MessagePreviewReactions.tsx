...
export default function MessagePreviewReactions(emoji) {
  ...
  obj = { value: messageId(7235)(messageId(7255).MESSAGE_PREVIEW_REACTIONS).analyticsLocations, children: null };
  if (stateFromStores.length > 0) {
    obj = { channelId, messageId, emoji: emoji.emoji, reactions: stateFromStores };
    let tmp4Result = jsx(channelId(11350).MessageReactionsContent, {
      channelId,
      messageId,
      emoji: emoji.emoji,
    ...
    tmp4Result = jsx(channelId(11350).MessageReactionsEmpty, {});
  }
  obj.children = tmp4Result;
  return jsx(channelId(7235).AnalyticsLocationProvider, {
    value: messageId(7235)(messageId(7255).MESSAGE_PREVIEW_REACTIONS).analyticsLocations,
    children: null,
  });
}
