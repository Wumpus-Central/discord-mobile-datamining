...
export default function MessagePreviewReactions(emoji) {
  ...
  if (stateFromStores.length > 0) {
    ...
    let tmp4Result = jsx(channelId(11602).MessageReactionsContent, {
      channelId,
      messageId,
      emoji: emoji.emoji,
    ...
    tmp4Result = jsx(channelId(11602).MessageReactionsEmpty, {});
  }
  obj2.children = tmp4Result;
  return jsx(channelId(7493).AnalyticsLocationProvider, {
    value: messageId(7493)(messageId(7513).MESSAGE_PREVIEW_REACTIONS).analyticsLocations,
    children: null,
  });
}
