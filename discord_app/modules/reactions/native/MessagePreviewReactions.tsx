...
export default function MessagePreviewReactions(emoji) {
  ...
  if (stateFromStores.length > 0) {
    ...
    let tmp4Result = jsx(channelId(11394).MessageReactionsContent, {
      channelId,
      messageId,
      emoji: emoji.emoji,
    ...
    tmp4Result = jsx(channelId(11394).MessageReactionsEmpty, {});
  }
  obj2.children = tmp4Result;
  return jsx(channelId(7269).AnalyticsLocationProvider, {
    value: messageId(7269)(messageId(7289).MESSAGE_PREVIEW_REACTIONS).analyticsLocations,
    children: null,
  });
}
