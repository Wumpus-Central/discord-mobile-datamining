...
export default function MessagePreviewReactions(emoji) {
  ...
  if (stateFromStores.length > 0) {
    ...
    let tmp4Result = jsx(channelId(11402).MessageReactionsContent, {
      channelId,
      messageId,
      emoji: emoji.emoji,
    ...
    tmp4Result = jsx(channelId(11402).MessageReactionsEmpty, {});
  }
  obj2.children = tmp4Result;
  return jsx(channelId(7272).AnalyticsLocationProvider, {
    value: messageId(7272)(messageId(7292).MESSAGE_PREVIEW_REACTIONS).analyticsLocations,
    children: null,
  });
}
