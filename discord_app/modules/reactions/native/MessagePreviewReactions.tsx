...
export default function MessagePreviewReactions(emoji) {
  ...
  if (stateFromStores.length > 0) {
    ...
    let tmp4Result = jsx(channelId(11520).MessageReactionsContent, {
      channelId,
      messageId,
      emoji: emoji.emoji,
    ...
    tmp4Result = jsx(channelId(11520).MessageReactionsEmpty, {});
  }
  obj2.children = tmp4Result;
  return jsx(channelId(7402).AnalyticsLocationProvider, {
    value: messageId(7402)(messageId(7422).MESSAGE_PREVIEW_REACTIONS).analyticsLocations,
    children: null,
  });
}
