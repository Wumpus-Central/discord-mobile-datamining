...
obj = {};
obj[fn(7763).ReactionTypes.NORMAL] = fn(8762).ReactionIcon;
obj[fn(7763).ReactionTypes.BURST] = fn(9378).SuperReactionIcon;
const size = fn(2);
...
export const handleOutOfSuperReactions = function handleOutOfSuperReactions(onDismiss) {
  ...
  if (null != currentUser) {
    ...
    if (!obj.isPremium(currentUser)) {
      obj = { onDismiss };
      openLazyResult = ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11141, dependencyMap.paths), "SuperReactionUpsellActionSheet", obj);
    }
...
export const handleViewReactions = function handleViewReactions(isPoll) {
  ...
  if (!isForumLikeChannelResult) {
    ...
    const tmp19 = asyncRequireImpl(11260, dependencyMap.paths);
  }
