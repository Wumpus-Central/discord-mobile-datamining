// === Module 7131: checkReactionResponse ===
...
function optimisticDispatch(type, channelId, messageId, arg3, userId) {
  ...
  obj[6] = colors;
  const ReactionTypes = require(7130) /* ReactionTypes */.ReactionTypes;
        ...
        try {
          ...
          if (0 === c3) {
            ...
            if (arg0 === 1) {
              ...
              if (c5 === callback(7130).ReactionTypes.VOTE) {
        ...
        try {
          ...
          if (0 === c7) {
            ...
            if (arg0 === 1) {
              ...
              obj6[0] = callback2(7132).unarchiveThreadIfNecessary(callback);
              return obj6;
            }
          } else if (arg0 === 1) {
            c8 = 3;
            ...
            obj[0] = MESSAGE;
            let fn = callback(7130).ReactionTypes;
            if (burst) {
              let NORMAL = fn.BURST;
            } else {
              NORMAL = fn.NORMAL;
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === c4) {
            ...
            obj5[3] = callback2;
            let ReactionTypes = callback(7130).ReactionTypes;
            if (burst) {
              let NORMAL = ReactionTypes.BURST;
            } else {
              NORMAL = ReactionTypes.NORMAL;
