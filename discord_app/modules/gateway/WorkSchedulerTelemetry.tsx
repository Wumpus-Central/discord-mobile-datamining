...
require = fn;
let obj = { COUNT_DISPATCHES_LEFT_AFTER_YIELD: "count_dispatches_left_after_yield", COUNT_FLUSH_BEFORE_QUEUE_EMPTY: "count_flush_before_queue_empty", COUNT_INITIAL_DISPATCHS_LENGTH: "count_initial_dispatches_length" };
...
const result = require("obj132").fileFinishedImporting("modules/gateway/WorkSchedulerTelemetry.tsx");
...
prototype["generateTelemetry"] = function generateTelemetry() {
  ...
  const merged = Object.assign(entries2.reduce((acc, item, index) => {
    [tmp, tmp2] = item;
