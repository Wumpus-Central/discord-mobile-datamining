...
import ActionBatcher from "ActionBatcher.tsx";
...
function dispatchGuildMemberAdd(guild_id, author, member) {
  ...
  const obj2 = obj(1388);
  const tmp2 = obj;
  const result2 = obj(4234).parseServerMemberGamingLeaderboardData(member_gaming_leaderboard_data);
...
new ActionBatcher(fn(13683).socket, (arg0, id) => {
  let tmp = arg0;
  if (arg0 == null) {
...
new ActionBatcher(fn(13683).socket, (arg0, guildId) => {
  let tmp = arg0;
  if (null == arg0) {
...
new ActionBatcher(fn(13683).socket, (arg0, arg1) => {
  let tmp = arg0;
  if (arg0 == null) {
...
ActionBatcher = new ActionBatcher(fn(13683).socket, (arg0, arg1) => {
  let tmp = arg0;
  if (null == arg0) {
...
let result = definePreloadableDispatch(["INITIAL_GUILD"], (data_mode) => {
  ...
  initialGuild.measure(() => {
    ...
    Emitter.batched(() => {
      ...
      const hydrateInitialGuildResult = obj.hydrateInitialGuild(closure_1_0, closure_0(13683).socket.identifyStartTime);
    ...
    ready.measure(() => {
      ...
      Emitter.batched(() => {
        ...
        const measureResult = hydrateReady.measure(() => {
          obj = closure_2_2(13733);
          return obj.hydrateReadyPayloadPrioritized(obj, user(13683).socket.identifyStartTime, closure_1);
        });
        ...
        let result1;
        if (null != prop) {
          result1 = user(13734).b64ToDeclarativeSettingsProto(obj.notification_settings.declarative_settings_proto);
          const obj2 = user(13734);
        }
        closure_1_1(7565)("AllGatewayConnectionStores", () => obj(geoRestrictedGuilds[20]));
