// === Module 17639: GuildConfigGates ===

// Module 17639 (GuildConfigGates)
import HTTPUtils from "HTTPUtils" /* 1272 */;
import asyncGeneratorStep from "asyncGeneratorStep" /* 5 */;
import GuildConfigGatesStore from "GuildConfigGatesStore" /* 17640 */;
  ...
  if (c6 === 2) {
    ...
    try {
      ...
      if (0 === c5) {
        ...
        body = value.body;
        const obj2 = { type: "GUILD_CONFIG_GATES_FETCH_SUCCESS", guildId: closure_131_0, guildVerificationRoleEnabled: null, applicationIdentityLinkedRolesEnabled: null };
