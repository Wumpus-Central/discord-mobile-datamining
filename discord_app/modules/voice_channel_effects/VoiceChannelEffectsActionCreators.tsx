// === Module 7344: VoiceChannelEffectSentLocation ===

// Module 7344 (VoiceChannelEffectSentLocation)
import closure_3 from "getEmojiToGroupId" /* 6764 */;
import closure_4 from "handleConnectionOpen" /* 1980 */;
import closure_5 from "initialize" /* 7345 */;
import { VoiceChannelEffectAnimationType as closure_6 } from "VoiceChannelEffectAnimationType" /* 7346 */;
...
export const sendVoiceChannelCustomCallSoundEffect = function sendVoiceChannelCustomCallSoundEffect(id, c4, arg2) {
  ...
  obj[1] = abortController(7347).sampleAnimationId(BASIC, abortController(7347).CUSTOM_CALL_SOUND_ANIMATION_RANGE);
  ...
  const tmp2Result = abortController(7347);
  HTTP.post(obj).then(closure_8, () => {

  });
  const postResult = HTTP.post(obj);
  const items = [abortController(7197).CHANNEL_CALL];
  abortController(7370)(items, arg2, c4, abortController(6862).AnalyticsSoundType.ENTRY);
};
export const sendVoiceChannelSoundboardEffect = function sendVoiceChannelSoundboardEffect(channelId, emojiId, arg2, arg3, arg4) {
  ...
  abortController(7370)(items, arg2, emojiId, abortController(6862).AnalyticsSoundType.DEFAULT, arg4);
};