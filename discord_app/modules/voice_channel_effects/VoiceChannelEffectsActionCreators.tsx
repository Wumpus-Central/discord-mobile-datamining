// === Module 6070: VoiceChannelEffectSentLocation ===

// Module 6070 (VoiceChannelEffectSentLocation)
import closure_3 from "getEmojiToGroupId" /* 5282 */;
import closure_4 from "handleConnectionOpen" /* 1981 */;
import closure_5 from "initialize" /* 6071 */;
import { VoiceChannelEffectAnimationType as closure_6 } from "VoiceChannelEffectAnimationType" /* 6072 */;
...
export const sendVoiceChannelCustomCallSoundEffect = function sendVoiceChannelCustomCallSoundEffect(id, c4, arg2) {
  ...
  obj[1] = abortController(6073).sampleAnimationId(BASIC, abortController(6073).CUSTOM_CALL_SOUND_ANIMATION_RANGE);
  ...
  const tmp2Result = abortController(6073);
  HTTP.post(obj).then(closure_8, () => {

  });
  const postResult = HTTP.post(obj);
  const items = [abortController(5854).CHANNEL_CALL];
  abortController(6096)(items, arg2, c4, abortController(4858).AnalyticsSoundType.ENTRY);
};
export const sendVoiceChannelSoundboardEffect = function sendVoiceChannelSoundboardEffect(channelId, emojiId, arg2, arg3, arg4) {
  ...
  abortController(6096)(items, arg2, emojiId, abortController(4858).AnalyticsSoundType.DEFAULT, arg4);
};