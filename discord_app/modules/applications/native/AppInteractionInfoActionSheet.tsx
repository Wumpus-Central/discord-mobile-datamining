// === Module 11984: AppInteractionInfoActionSheet ===
...
import ContextMenuSubmenuActionSheetHeaderDefault from "ContextMenuSubmenuActionSheetHeader" /* 11985 */;
...
export default function AppInteractionInfoActionSheet(message) {
  ...
  if (interactionMetadata != null) {
    tmp5 = interactionMetadata.authorizing_integration_owners[message(undefined, 9324).ApplicationIntegrationType.USER_INSTALL];
  }
  dependencyMap = tmp5;
  const interactionMetadata2 = message.interactionMetadata;
  let tmp7;
  if (interactionMetadata2 != null) {
    tmp7 = interactionMetadata2.authorizing_integration_owners[message(undefined, 9324).ApplicationIntegrationType.GUILD_INSTALL];
  }
  noop = tmp7;
  ...
  if (null != stateFromStores1) {
    ...
    const obj6 = { guild: stateFromStores1, size: tmp10(5803).GuildIconSizes.SMALL_32 };
    const items5 = [closure_8(onBack(5803), obj6), ];
    ...
    const items6 = [closure_8(tmp10(4753).Text, obj8), ];
    ...
    items6[1] = closure_8(tmp10(4753).Text, obj9);
    obj7.children = items6;
    items5[1] = closure_9(id, obj7);
    obj5.children = items5;
    let tmp26 = closure_9(id, obj5);
    const tmp2Result = onBack(5803);
  } else {
    tmp26 = null;
    if (null != stateFromStores) {
      ...
      const items8 = [closure_8(tmp10(4753).Text, obj15), ];
      ...
      items8[1] = closure_8(tmp10(4753).Text, obj16);
  ...
  if (null != tmp15) {
    ...
    const items11 = [closure_8(tmp10(4753).Text, obj23), ];
    ...
    items11[1] = closure_8(tmp10(4753).Text, obj24);
