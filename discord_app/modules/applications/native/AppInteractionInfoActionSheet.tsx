...
export default function AppInteractionInfoActionSheet(message) {
  ...
  if (interactionMetadata != null) {
    tmp5 =
      interactionMetadata.authorizing_integration_owners[
        message(undefined, 9318).ApplicationIntegrationType.USER_INSTALL
      ];
  }
  dependencyMap = tmp5;
  ...
  if (interactionMetadata2 != null) {
    tmp7 =
      interactionMetadata2.authorizing_integration_owners[
        message(undefined, 9318).ApplicationIntegrationType.GUILD_INSTALL
      ];
  }
  noop = tmp7;
  ...
  if (null != stateFromStores1) {
    ...
    const items5 = [closure_8(onBack(5801), obj6)];
