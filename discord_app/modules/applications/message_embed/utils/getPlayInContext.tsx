...
export const getPlayInContext = function getPlayInContext(id, channel_id) {
  ...
  if (null == channelId) {
    ...
    if (null != channelId) {
      ...
      tmp3 = _require;
      NO_CHANNEL = _require(9447).EmbeddedActivityLaunchability.NO_CHANNEL;
    }
    ...
    obj[3] = tmp11;
    obj[4] = NO_CHANNEL === tmp3(9447).EmbeddedActivityLaunchability.CAN_LAUNCH;
    return obj;
  }
};