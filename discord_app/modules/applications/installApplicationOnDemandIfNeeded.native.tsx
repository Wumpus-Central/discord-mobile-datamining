// === Module 10775: _installApplicationOnDemandIfNeeded ===
      ...
      if (application === 2) {
        ...
        try {
          ...
          if (0 === c3) {
            ...
            USER_INSTALL = callback(9759).ApplicationIntegrationType.USER_INSTALL;
            scopes = undefined;
            if (application != null) {
