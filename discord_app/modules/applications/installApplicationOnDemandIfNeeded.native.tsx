...
let closure_6 = async function _installApplicationOnDemandIfNeeded(arg0) {
    ...
    if (arg0 === 1) {
      ...
      if (obj11.shouldInstallApplicationOnDemand(obj2)) {
        ...
        if (null == application) {
          ...
          c3 = 2;
          c4 = 1;
          return { value: obj5.fetchApplication(closure_129_0), done: false };
        }
      } else {
        c4 = 3;
  ...
  if (null != closure_129_3) {
    ...
    obj5 = { application_id: closure_129_0, location: closure_129_3.location, section_name: closure_129_3.sectionName, source: closure_129_3.entrypoint };
  ...
  return new Promise((arg0) => {
    ...
    closure_1_0(9664).openOAuth2Modal(obj);
  });
};
