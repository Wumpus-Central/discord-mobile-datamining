// === Module 15250: FamilyCenterActivityGiftRowUtils ===
...
export const formatGiftDate = function formatGiftDate(claimedAt) {
  ...
  return dateTimeFormat.format(_mod4059.parseISO(claimedAt));
};
