...
const items = [
  user.DayOfWeek.SUNDAY,
  user.DayOfWeek.MONDAY,
  user.DayOfWeek.TUESDAY,
  user.DayOfWeek.WEDNESDAY,
  user.DayOfWeek.THURSDAY,
  user.DayOfWeek.FRIDAY,
  user.DayOfWeek.SATURDAY,
];
