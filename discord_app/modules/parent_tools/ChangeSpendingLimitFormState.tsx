          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (closure_6) {
                ...
                c3 = 1;
                if (closure_5) {
                  const ParentalControlledSpendingLimit2 = tmp3(15110).ParentalControlledSpendingLimit;
                  dependencyMap = 2;
                  c4 = 1;
                  const obj4 = {
                  ...
                  const ParentalControlledSpendingLimit = tmp3(15110).ParentalControlledSpendingLimit;
                  const obj5 = { amount: tmp16, currency: formatted };
                  dependencyMap = 3;
                  c4 = 1;
                  const obj6 = {
                    value: ParentalControlledSpendingLimit.updateControlledSetting(tmp3, obj5),
                    done: false,
                  };
                  return obj6;
                }
