...
export default function FamilyCenterActivityBanner() {
  ...
  const ageSpecificText1 = obj3.useAgeSpecificText(
    intl3.format(_modDef2480.MXjDSv, { articleLink: "https://support.discord.com/hc/articles/14155060633623" }),
    intl4.format(_modDef2480.EMCf6j, { articleLink: "https://support.discord.com/hc/articles/14155043715735" }),
  );
  obj5.source = importDefault(tmp3 ? 15101 : 15102);
  obj5.style = tmp4.art;
  const items = [
