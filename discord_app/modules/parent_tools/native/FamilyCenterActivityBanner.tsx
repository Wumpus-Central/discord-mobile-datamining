...
import FamilyCenterTeenQRCodeButtonInner from "FamilyCenterTeenQRCodeButtonInner" /* 14233 */;
...
function FamilyCenterActivityBannerButton() {
  ...
  if (!obj2.useHasMaxConnections()) {
    ...
    tmp7Result = callback(tmp5 ? tmp7Result.FamilyCenterParentQRCodeButton : tmp7Result.FamilyCenterTeenQRCodeButton, {});
    obj[1] = tmp7Result;
    tmp7Result = callback(closure_3, obj);
  }
  return tmp6;
}
noopAll;
...
const result = require("obj132").fileFinishedImporting("modules/parent_tools/native/FamilyCenterActivityBanner.tsx");
...
export default function FamilyCenterActivityBanner() {
  ...
  obj[0] = importDefault(tmp3 ? 14240 : 14241);
  obj[1] = tmp4.art;
  ...
  if (!hasMaxConnections) {
    tmp13Result = callback(FamilyCenterActivityBannerButton, {});
  }
  items[3] = tmp13Result;
  obj[1] = items;
