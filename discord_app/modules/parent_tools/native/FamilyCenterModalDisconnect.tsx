...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  const ageSpecificText = obj4.useAgeSpecificText(
    intl.format(_modDef2487.F2lccv, { username: name }),
    intl2.string(_modDef2487["WH+Gba"]),
  );
  ...
  const ageSpecificText1 = obj5.useAgeSpecificText(
    intl3.string(_modDef2487.hOEHFn),
    intl4.format(_modDef2487.Or6hgl, { username: name }),
  );
  ...
  const ageSpecificText2 = obj6.useAgeSpecificText(
    intl5.format(_modDef2487.XyRW4c, { username: name }),
    intl6.format(_modDef2487.PlrZal, { username: name }),
  );
  ...
  const ageSpecificText4 = obj8.useAgeSpecificText(
    intl9.string(_modDef2487.sCbKs4),
    intl10.string(_modDef2487["0ki7+P"]),
  );
  ...
  items3[2] = closure_6(otherUser(4832).Text, {
    style: tmp.subtitle,
  ...
  items4[2] = closure_6(otherUser(4832).Text, {
    style: tmp.body,
  ...
  const items5 = [
    closure_6(otherUser(8732).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }),
    closure_6(otherUser(8732).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 }),
  ];
