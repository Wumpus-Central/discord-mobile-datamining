// === Module 15206: FamilyCenterModalDisconnect ===
...
import FamilyCenterAvatarPairDefault from "FamilyCenterAvatarPair" /* 15207 */;
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  items3[2] = closure_6(otherUser(4753).Text, { style: tmp.subtitle, variant: "text-sm/bold", color: "text-default", children: ageSpecificText });
  ...
  items4[2] = closure_6(otherUser(4753).Text, { style: tmp.body, variant: "text-md/normal", color: "text-default", children: ageSpecificText2 });
  const obj16 = { spacing: nativeDefault.space.PX_12, children: null };
  const items5 = [closure_6(otherUser(9549).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), closure_6(otherUser(9549).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
