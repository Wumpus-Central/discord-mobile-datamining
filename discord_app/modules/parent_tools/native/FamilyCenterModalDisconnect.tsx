// === Module 14921: FamilyCenterModalDisconnect ===
...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  const items5 = [closure_6(otherUser(9429).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), closure_6(otherUser(9429).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
