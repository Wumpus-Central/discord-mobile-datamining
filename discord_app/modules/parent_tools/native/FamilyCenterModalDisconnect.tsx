...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  const ageSpecificText = obj3.useAgeSpecificText(intl.format(_modDef2396.F2lccv, { username: name }), intl2.string(_modDef2396["WH+Gba"]));
  let obj4 = otherUser(11990);
  ...
  const ageSpecificText1 = obj4.useAgeSpecificText(intl3.string(_modDef2396.hOEHFn), intl4.format(_modDef2396.Or6hgl, { username: name }));
  let obj5 = otherUser(11990);
  const intl5 = otherUser(1114).intl;
  const stringResult = intl3.string(_modDef2396.hOEHFn);
  const intl6 = otherUser(1114).intl;
  const ageSpecificText2 = obj5.useAgeSpecificText(intl5.format(_modDef2396.XyRW4c, { username: name }), intl6.format(_modDef2396.PlrZal, { username: name }));
  let obj6 = otherUser(11990);
  ...
  const ageSpecificText4 = obj7.useAgeSpecificText(intl9.string(_modDef2396.sCbKs4), intl10.string(_modDef2396["0ki7+P"]));
  ...
  items4[3] = closure_7(otherUser(5023).Stack, obj6);
  obj4.children = items4;
  const items6 = [closure_7(otherUser(8487).ModalContent, obj4), ];
  let tmp31 = !tmp9;
  if (tmp9) {
    tmp31 = !tmp11;
  }
  ...
  const items7 = [closure_6(otherUser(5025).Button, obj10), ];
  ...
  items7[1] = closure_6(otherUser(5025).Button, obj11);
  obj9.children = items7;
  obj8.children = closure_7(otherUser(5483).ButtonGroup, obj9);
  items6[1] = closure_6(otherUser(11997).ModalFooter, obj8);
  obj7.children = items6;
  return closure_7(otherUser(8486).ModalScreen, obj7);
}
