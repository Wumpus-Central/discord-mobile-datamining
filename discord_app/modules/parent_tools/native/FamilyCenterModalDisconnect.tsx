...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = closure_6(tmp3(14877), obj3);
  }
  obj4 = { children: null };
  ...
  const items5 = [closure_6(otherUser(9434).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }), closure_6(otherUser(9434).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 })];
  ...
  items6[1] = closure_6(otherUser(11931).ModalFooter, obj8);
