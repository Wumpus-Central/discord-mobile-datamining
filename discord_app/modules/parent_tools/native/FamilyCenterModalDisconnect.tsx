...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  items3[2] = closure_6(otherUser(4636).Text, {
    style: tmp.subtitle,
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = closure_6(tmp3(14998), obj13);
  }
  const obj14 = { children: null };
  items4[1] = tmp28Result;
  items4[2] = closure_6(otherUser(4636).Text, {
    style: tmp.body,
  ...
  const items5 = [
    closure_6(otherUser(9583).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }),
    closure_6(otherUser(9583).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 }),
  ];
