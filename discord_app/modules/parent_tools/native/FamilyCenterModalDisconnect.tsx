...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  items4[3] = closure_7(otherUser(4987).Stack, obj6);
  obj4.children = items4;
  const items6 = [closure_7(otherUser(8450).ModalContent, obj4), ];
  let tmp31 = !tmp9;
  if (tmp9) {
    tmp31 = !tmp11;
  }
  ...
  const items7 = [closure_6(otherUser(4989).Button, obj10), ];
  ...
  items7[1] = closure_6(otherUser(4989).Button, obj11);
  obj9.children = items7;
  obj8.children = closure_7(otherUser(5447).ButtonGroup, obj9);
  items6[1] = closure_6(otherUser(11957).ModalFooter, obj8);
  obj7.children = items6;
  return closure_7(otherUser(8449).ModalScreen, obj7);
}
