...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  const ageSpecificText = obj3.useAgeSpecificText(intl.format(require("../FamilyCenter.messages.js").F2lccv, { username: name }), intl2.string(require("../FamilyCenter.messages.js")["WH+Gba"]));
  let obj4 = otherUser(11239);
  const intl3 = otherUser(1236).intl;
  const formatResult = intl.format(require("../FamilyCenter.messages.js").F2lccv, { username: name });
  const intl4 = otherUser(1236).intl;
  const ageSpecificText1 = obj4.useAgeSpecificText(intl3.string(require("../FamilyCenter.messages.js").hOEHFn), intl4.format(require("../FamilyCenter.messages.js").Or6hgl, { username: name }));
  let obj5 = otherUser(11239);
  const intl5 = otherUser(1236).intl;
  const stringResult = intl3.string(require("../FamilyCenter.messages.js").hOEHFn);
  const intl6 = otherUser(1236).intl;
  const ageSpecificText2 = obj5.useAgeSpecificText(intl5.format(require("../FamilyCenter.messages.js").XyRW4c, { username: name }), intl6.format(require("../FamilyCenter.messages.js").PlrZal, { username: name }));
  let obj6 = otherUser(11239);
  const intl7 = otherUser(1236).intl;
  const formatResult1 = intl5.format(require("../FamilyCenter.messages.js").XyRW4c, { username: name });
  const intl8 = otherUser(1236).intl;
  const ageSpecificText3 = obj6.useAgeSpecificText(intl7.string(require("../FamilyCenter.messages.js").eiABQz), intl8.string(require("../FamilyCenter.messages.js").PGQBnk));
  let obj7 = otherUser(11239);
  const intl9 = otherUser(1236).intl;
  const stringResult1 = intl7.string(require("../FamilyCenter.messages.js").eiABQz);
  const intl10 = otherUser(1236).intl;
  const items = [disconnectLinkRequest, otherUser.id];
  const ageSpecificText4 = obj7.useAgeSpecificText(intl9.string(require("../FamilyCenter.messages.js").sCbKs4), intl10.string(require("../FamilyCenter.messages.js")["0ki7+P"]));
  ...
  const stringResult2 = intl9.string(require("../FamilyCenter.messages.js").sCbKs4);
  obj[1] = require("../../../../_runtime/07837_registerAsset.js");
  const items3 = [callback(require("FamilyCenterAvatarPair.tsx"), obj), , ];
  obj1 = { style: tmp.title, variant: "text-lg/bold", children: null };
  const intl11 = otherUser(1236).intl;
  obj1[2] = intl11.format(require("../FamilyCenter.messages.js").o0JXuK, { username: name });
  ...
  obj6[0] = require("../../../../discord_common/js/packages/tokens/native.tsx").space.PX_12;
  ...
  obj10[3] = intl12.string(require("../FamilyCenter.messages.js")["c5L+sl"]);
  obj10[4] = callback2;
  ...
  obj11[2] = require("../../../actions/ModalActionCreators.tsx").pop;
