...
function FamilyCenterModalDisconnectScreen(otherUser) {
  ...
  if (requiresParentalConsent) {
    ...
    tmp28Result = closure_6(tmp3(15146), obj13);
  }
  ...
  const items5 = [
    closure_6(otherUser(9542).Checkbox, { label: ageSpecificText3, checked: tmp9, onToggle: callback3 }),
    closure_6(otherUser(9542).Checkbox, { label: ageSpecificText4, checked: tmp11, onToggle: callback4 }),
  ];
