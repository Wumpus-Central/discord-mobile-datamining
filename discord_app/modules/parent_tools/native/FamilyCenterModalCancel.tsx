...
function FamilyCenterModalCancelScreen(otherUser) {
  ...
  const callback = noop.useCallback(() => {
    let arr = cancelLinkRequest(4808);
    arr = arr.pop();
  }, []);
  ...
  cancelLinkRequest(38)(cancelLinkRequest(8716)(), "FamilyCenterCancelModal should only be rendered for parents.");
  obj = { children: null };
  obj = { children: null };
  const obj1 = { style: tmp.header, children: null };
  const obj2 = { otherUser, iconSrc: null };
  const tmp2 = cancelLinkRequest(8716)();
  obj2.iconSrc = cancelLinkRequest(7044);
  const items1 = [closure_5(cancelLinkRequest(15000), obj2), ,];
  ...
  const items2 = [closure_5(otherUser(8487).ModalContent, obj)];
  ...
  const items3 = [closure_5(otherUser(5025).Button, obj6)];
  ...
  obj7.onPress = cancelLinkRequest(4808).pop;
  items3[1] = closure_5(otherUser(5025).Button, obj7);
  obj5.children = items3;
  obj4.children = closure_6(otherUser(5483).ButtonGroup, obj5);
  items2[1] = closure_5(otherUser(11997).ModalFooter, obj4);
  obj.children = items2;
