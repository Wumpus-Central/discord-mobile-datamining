...
import _modDef15108 from "../../../../_runtime/metro/15108__.js";
...
function FamilyCenterActivityCardPrefaceText() {
  ...
  const ageSpecificText = obj4.useAgeSpecificText(
    intl.formatToPlainString(_modDef2480.tazvHQ, { activeLinks: activeLinkUserIds.length }),
    intl2.string(_modDef2480.KrLnkE),
  );
  const obj6 = { style: tmp.container, children: null };
  let tmp12 = null;
  if (!tmp4) {
    const obj7 = { color: tmp.icon.color, source: _modDef15108, style: tmp.icon };
  ...
  const formatToPlainStringResult = intl.formatToPlainString(_modDef2480.tazvHQ, {
