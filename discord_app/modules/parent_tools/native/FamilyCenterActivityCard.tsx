...
import _modDef14980 from "../../../../_runtime/metro/14980__.js";
...
function FamilyCenterActivityCardPrefaceText() {
  ...
  const ageSpecificText = obj4.useAgeSpecificText(
    intl.formatToPlainString(_modDef2396.tazvHQ, { activeLinks: activeLinkUserIds.length }),
    intl2.string(_modDef2396.KrLnkE),
  );
  const obj6 = { style: tmp.container, children: null };
  let tmp12 = null;
  if (!tmp4) {
    const obj7 = { color: tmp.icon.color, source: _modDef14980, style: tmp.icon };
  ...
  const formatToPlainStringResult = intl.formatToPlainString(_modDef2396.tazvHQ, {
