...
import _modDef14968 from "module_14968" /* 14968 */;
...
function FamilyCenterActivityCardPrefaceText() {
  ...
  obj3.children = React6(native.Icon, { color: tmp.icon.color, source: _modDef12839, size: native.Icon.Sizes.EXTRA_SMALL, style: tmp.icon });
