...
function FamilyCenterActivityCardPrefaceText() {
  ...
  const ageSpecificText = obj4.useAgeSpecificText(
    intl.formatToPlainString(_modDef2487.tazvHQ, { activeLinks: activeLinkUserIds.length }),
    intl2.string(_modDef2487.KrLnkE),
  );
  ...
  const formatToPlainStringResult = intl.formatToPlainString(_modDef2487.tazvHQ, {
