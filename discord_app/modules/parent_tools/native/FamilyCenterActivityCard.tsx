...
import _modDef15014 from "../../../../_runtime/metro/15014__.js";
...
function FamilyCenterActivityCardPrefaceText() {
  ...
  const ageSpecificText = obj4.useAgeSpecificText(
    intl.formatToPlainString(_modDef2397.tazvHQ, { activeLinks: activeLinkUserIds.length }),
    intl2.string(_modDef2397.KrLnkE),
  );
  const obj6 = { style: tmp.container, children: null };
  let tmp12 = null;
  if (!tmp4) {
    const obj7 = { color: tmp.icon.color, source: _modDef15014, style: tmp.icon };
  ...
  const formatToPlainStringResult = intl.formatToPlainString(_modDef2397.tazvHQ, {
