...
function RowGroup(children) {
  ...
  const items = [React3(Text_Text.Text, { accessibilityRole: "header", variant: "text-sm/semibold", color: "text-muted", children: children.title }), ];
  obj = {
    hasIcons: true,
...
export default function FamilyCenterDataConfirmation() {
  ...
  const ageSpecificText2 = obj2.useAgeSpecificText(intl8.string(_modDef2396["dES/2r"]), intl9.string(_modDef2396.ep6mdN));
  let obj3 = useAgeSpecificText;
  const intl10 = util.intl;
  const stringResult5 = intl8.string(_modDef2396["dES/2r"]);
  const intl11 = util.intl;
  const ageSpecificText3 = obj3.useAgeSpecificText(intl10.string(_modDef2396.GWPcQg), intl11.string(_modDef2396.yFnKIg));
  let obj4 = useAgeSpecificText;
  const intl12 = util.intl;
  const stringResult6 = intl10.string(_modDef2396.GWPcQg);
  const intl13 = util.intl;
  const ageSpecificText4 = obj4.useAgeSpecificText(intl12.string(_modDef2396["30+sih"]), intl13.string(_modDef2396["0cuLn1"]));
  let obj5 = useAgeSpecificText;
  const intl14 = util.intl;
  const stringResult7 = intl12.string(_modDef2396["30+sih"]);
  const intl15 = util.intl;
  const ageSpecificText5 = obj5.useAgeSpecificText(intl14.string(_modDef2396.tHTyRh), intl15.string(_modDef2396.TeNlMb));
  let obj6 = useAgeSpecificText;
  const intl16 = util.intl;
  const stringResult8 = intl14.string(_modDef2396.tHTyRh);
  const intl17 = util.intl;
  const ageSpecificText6 = obj6.useAgeSpecificText(intl16.string(_modDef2396.PfveQ6), intl17.string(_modDef2396["f7ofm/"]));
  let obj7 = useAgeSpecificText;
  const intl18 = util.intl;
  const stringResult9 = intl16.string(_modDef2396.PfveQ6);
  const intl19 = util.intl;
  const ageSpecificText7 = obj7.useAgeSpecificText(intl18.string(_modDef2396.MKeCj3), intl19.string(_modDef2396.HdcGGl));
  let obj8 = useAgeSpecificText;
  const intl20 = util.intl;
  const stringResult10 = intl18.string(_modDef2396.MKeCj3);
  const intl21 = util.intl;
  const ageSpecificText8 = obj8.useAgeSpecificText(intl20.string(_modDef2396.wZejZr), intl21.string(_modDef2396.tdgcf1));
  let obj9 = useAgeSpecificText;
  const intl22 = util.intl;
  const stringResult11 = intl20.string(_modDef2396.wZejZr);
  const intl23 = util.intl;
  const ageSpecificText9 = obj9.useAgeSpecificText(intl22.string(_modDef2396.ASf7XN), intl23.string(_modDef2396["82y87X"]));
  ...
  const ageSpecificText10 = obj10.useAgeSpecificText(intl24.string(_modDef2396["0QDVFN"]), intl25.string(_modDef2396["1xBHHV"]));
