...
export default function FamilyCenterDataConfirmation() {
  ...
  const ageSpecificText2 = obj3.useAgeSpecificText(
    intl8.string(_modDef2487["dES/2r"]),
    intl9.string(_modDef2487.ep6mdN),
  );
  ...
  const ageSpecificText3 = obj4.useAgeSpecificText(
    intl10.string(_modDef2487.GWPcQg),
    intl11.string(_modDef2487.yFnKIg),
  );
  ...
  const ageSpecificText4 = obj5.useAgeSpecificText(
    intl12.string(_modDef2487["30+sih"]),
    intl13.string(_modDef2487["0cuLn1"]),
  );
  ...
  const ageSpecificText5 = obj6.useAgeSpecificText(
    intl14.string(_modDef2487.tHTyRh),
    intl15.string(_modDef2487.TeNlMb),
  );
  ...
  const ageSpecificText6 = obj7.useAgeSpecificText(
    intl16.string(_modDef2487.PfveQ6),
    intl17.string(_modDef2487["f7ofm/"]),
  );
  ...
  const ageSpecificText7 = obj8.useAgeSpecificText(
    intl18.string(_modDef2487.MKeCj3),
    intl19.string(_modDef2487.HdcGGl),
  );
  ...
  const ageSpecificText8 = obj9.useAgeSpecificText(
    intl20.string(_modDef2487.wZejZr),
    intl21.string(_modDef2487.tdgcf1),
  );
  ...
  const ageSpecificText9 = obj10.useAgeSpecificText(
    intl22.string(_modDef2487.ASf7XN),
    intl23.string(_modDef2487["82y87X"]),
  );
  ...
  const ageSpecificText10 = obj11.useAgeSpecificText(
    intl24.string(_modDef2487["0QDVFN"]),
    intl25.string(_modDef2487["1xBHHV"]),
  );
