...
function RowGroup(children) {
  ...
  const items = [callback(Text /* Text */.Text, { accessibilityRole: "header", variant: "text-sm/semibold", color: "text-muted", children: children.title }), ];
...
export default function FamilyCenterDataConfirmation() {
  ...
  let obj4 = useAgeSpecificText /* useAgeSpecificText */;
  ...
  let obj5 = useAgeSpecificText /* useAgeSpecificText */;
  ...
  let obj6 = useAgeSpecificText /* useAgeSpecificText */;
  ...
  let obj7 = useAgeSpecificText /* useAgeSpecificText */;
  ...
  let obj8 = useAgeSpecificText /* useAgeSpecificText */;
  ...
  let obj9 = useAgeSpecificText /* useAgeSpecificText */;
  ...
  let obj10 = useAgeSpecificText /* useAgeSpecificText */;
  ...
  obj1[2] = ForumIcon /* ForumIcon */.ForumIcon;
  items[2] = obj1;
  ...
  obj2[2] = PhoneIcon /* PhoneIcon */.PhoneIcon;
  items[3] = obj2;
  ...
  obj3[2] = CreditCardIcon /* CreditCardIcon */.CreditCardIcon;
  items[4] = obj3;
  ...
  obj4[2] = GiftIcon /* GiftIcon */.GiftIcon;
  items[5] = obj4;
  obj5 = { header: ageSpecificText4, description: ageSpecificText5, IconComponent: FlagIcon /* FlagIcon */.FlagIcon };
  items[6] = obj5;
  ...
  obj6[2] = ClockIcon /* ClockIcon */.ClockIcon;
  const items1 = [obj6, , ];
  ...
  obj7[2] = PiggyBankIcon /* PiggyBankIcon */.PiggyBankIcon;
  items1[1] = obj7;
  ...
  obj8[2] = SettingsIcon /* SettingsIcon */.SettingsIcon;
  items1[2] = obj8;
  ...
  const items3 = [{ header: ageSpecificText9, description: ageSpecificText10, IconComponent: XSmallIcon /* XSmallIcon */.XSmallIcon, negative: true }];
  obj10[1] = items3;
  items2[2] = callback(RowGroup, obj10);
  obj9[1] = items2;
  return callback2(Stack /* Stack */.Stack, obj9);
};