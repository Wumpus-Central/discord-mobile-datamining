...
export default function FamilyCenterDataConfirmation() {
  ...
  const ageSpecificText2 = obj3.useAgeSpecificText(
    intl8.string(_modDef2486["dES/2r"]),
    intl9.string(_modDef2486.ep6mdN),
  );
  const stringResult5 = intl8.string(_modDef2486["dES/2r"]);
  const intl10 = util.intl;
  const obj4 = useAgeSpecificText;
  const intl11 = util.intl;
  const ageSpecificText3 = obj4.useAgeSpecificText(
    intl10.string(_modDef2486.GWPcQg),
    intl11.string(_modDef2486.yFnKIg),
  );
  const stringResult6 = intl10.string(_modDef2486.GWPcQg);
  const intl12 = util.intl;
  const obj5 = useAgeSpecificText;
  const intl13 = util.intl;
  const ageSpecificText4 = obj5.useAgeSpecificText(
    intl12.string(_modDef2486["30+sih"]),
    intl13.string(_modDef2486["0cuLn1"]),
  );
  const stringResult7 = intl12.string(_modDef2486["30+sih"]);
  const intl14 = util.intl;
  const obj6 = useAgeSpecificText;
  const intl15 = util.intl;
  const ageSpecificText5 = obj6.useAgeSpecificText(
    intl14.string(_modDef2486.tHTyRh),
    intl15.string(_modDef2486.TeNlMb),
  );
  const stringResult8 = intl14.string(_modDef2486.tHTyRh);
  const intl16 = util.intl;
  const obj7 = useAgeSpecificText;
  const intl17 = util.intl;
  const ageSpecificText6 = obj7.useAgeSpecificText(
    intl16.string(_modDef2486.PfveQ6),
    intl17.string(_modDef2486["f7ofm/"]),
  );
  const stringResult9 = intl16.string(_modDef2486.PfveQ6);
  const intl18 = util.intl;
  const obj8 = useAgeSpecificText;
  const intl19 = util.intl;
  const ageSpecificText7 = obj8.useAgeSpecificText(
    intl18.string(_modDef2486.MKeCj3),
    intl19.string(_modDef2486.HdcGGl),
  );
  const stringResult10 = intl18.string(_modDef2486.MKeCj3);
  const intl20 = util.intl;
  const obj9 = useAgeSpecificText;
  const intl21 = util.intl;
  const ageSpecificText8 = obj9.useAgeSpecificText(
    intl20.string(_modDef2486.wZejZr),
    intl21.string(_modDef2486.tdgcf1),
  );
  const stringResult11 = intl20.string(_modDef2486.wZejZr);
  const intl22 = util.intl;
  const obj10 = useAgeSpecificText;
  const intl23 = util.intl;
  const ageSpecificText9 = obj10.useAgeSpecificText(
    intl22.string(_modDef2486.ASf7XN),
    intl23.string(_modDef2486["82y87X"]),
  );
  ...
  const ageSpecificText10 = obj11.useAgeSpecificText(
    intl24.string(_modDef2486["0QDVFN"]),
    intl25.string(_modDef2486["1xBHHV"]),
  );
