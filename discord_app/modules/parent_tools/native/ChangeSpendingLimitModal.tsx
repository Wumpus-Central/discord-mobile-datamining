...
function ChangeSpendingLimitScreen(teenId) {
  ...
  if (null == formatPriceResult) {
    ...
    items[1] = closure_7(tmp2(5142).Stack, obj4);
    obj2.children = items;
    obj8.children = closure_7(tmp2(5142).Stack, obj2);
    const items3 = [closure_6(tmp2(8655).ModalContent, obj8)];
    if (isClearingCap) {
    ...
    const items4 = [closure_6(tmp2(5144).Button, obj10)];
    ...
    items4[1] = closure_6(tmp2(5144).Button, obj14);
    obj13.children = items4;
    obj12.children = closure_7(tmp2(5603).ButtonGroup, obj13);
    items3[1] = closure_6(tmp2(12170).ModalFooter, obj12);
    obj11.children = items3;
    return closure_7(tmp2(8654).ModalScreen, obj11);
    ...
    const items5 = [closure_6(tmp2(8826).WarningIcon, obj16)];
    ...
    items5[1] = closure_6(tmp2(4718).Text, obj17);
    ...
    tmp9Result1 = closure_6(tmp2(4718).Text, obj19);
  }
