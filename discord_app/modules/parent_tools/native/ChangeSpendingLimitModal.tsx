...
function ChangeSpendingLimitScreen(teenId) {
  ...
  if (null == formatPriceResult) {
    ...
    items[1] = closure_7(tmp2(5057).Stack, obj4);
    obj2.children = items;
    obj8.children = closure_7(tmp2(5057).Stack, obj2);
    const items3 = [closure_6(tmp2(8543).ModalContent, obj8)];
    if (isClearingCap) {
    ...
    const items4 = [closure_6(tmp2(5059).Button, obj10)];
    ...
    items4[1] = closure_6(tmp2(5059).Button, obj14);
    obj13.children = items4;
    obj12.children = closure_7(tmp2(5518).ButtonGroup, obj13);
    items3[1] = closure_6(tmp2(12061).ModalFooter, obj12);
    obj11.children = items3;
    return closure_7(tmp2(8542).ModalScreen, obj11);
    ...
    const items5 = [closure_6(tmp2(8714).WarningIcon, obj16)];
    ...
    items5[1] = closure_6(tmp2(4635).Text, obj17);
    ...
    tmp9Result1 = closure_6(tmp2(4635).Text, obj19);
  }
