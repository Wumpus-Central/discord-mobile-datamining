...
function ChangeSpendingLimitScreen(teenId) {
  ...
  importDefault = async function _handleSave(dependencyMap) {
    ...
    if (1 === tmp7) {
      ...
      tmp3(4527).presentFailedToast(intl.string(v2(2487).Wu8BK2));
      c3 = 3;
      tmp3(4527);
      ...
      obj7.content = intl2.string(v2(2487)["2WKfG1"]);
      obj7.IconComponent = tmp3(4792).CircleCheckIcon;
      v2(4528).open(obj7);
      v2(4528);
      v2(5039).pop();
      dependencyMap = 0;
  ...
  const changeSpendingLimitFormState = require("ChangeSpendingLimitFormState").useChangeSpendingLimitFormState(
    teenId.teenId,
  );
  ...
  obj3.children = intl.string(_modDef2487.IFguF2);
  ...
  obj5.children = intl2.string(_modDef2487["1fHSu2"]);
  ...
  obj6.accessibilityLabel = intl3.string(_modDef2487["1fHSu2"]);
  ...
  obj6.placeholder = intl4.string(_modDef2487.DjSv82);
  let str = "number-pad";
  if (exponent > 0) {
    str = "decimal-pad";
  }
  ...
  if (isOverspending) {
    ...
    tmp9Result = closure_6(closure_5, obj7);
  }
  items2[1] = tmp9Result;
  ...
  if (null == formatPriceResult) {
    ...
    items[1] = closure_7(tmp2(5279).Stack, obj4);
    obj2.children = items;
    obj8.children = closure_7(tmp2(5279).Stack, obj2);
    const items3 = [closure_6(tmp2(7871).ModalContent, obj8)];
    if (isClearingCap) {
      const obj9 = { variant: "destructive", text: null, onPress: null, disabled: null, loading: null };
      const intl8 = tmp2(1115).intl;
      obj9.text = intl8.string(tmp10(2487).JZDGJ8);
    ...
    const items4 = [closure_6(tmp2(5281).Button, obj10)];
    ...
    items4[1] = closure_6(tmp2(5281).Button, obj14);
    obj13.children = items4;
    obj12.children = closure_7(tmp2(5745).ButtonGroup, obj13);
    items3[1] = closure_6(tmp2(11405).ModalFooter, obj12);
    obj11.children = items3;
    return closure_7(tmp2(7870).ModalScreen, obj11);
    ...
    const items5 = [closure_6(tmp2(8048).WarningIcon, obj16)];
    ...
    formatToPlainStringResult = intl6.formatToPlainString(tmp10(2487).Tk6x4X, obj18);
    obj17.children = formatToPlainStringResult;
    items5[1] = closure_6(tmp2(4832).Text, obj17);
    obj15.children = items5;
    let tmp9Result1 = closure_7(closure_5, obj15);
  } else {
    const obj19 = { variant: "text-sm/normal", color: "text-muted", children: null };
    const intl5 = tmp2(1115).intl;
    const obj20 = { amount: formatPriceResult };
    obj19.children = intl5.formatToPlainString(tmp10(2487).pfAlRY, obj20);
    tmp9Result1 = closure_6(tmp2(4832).Text, obj19);
  }
  const obj = require("ChangeSpendingLimitFormState");
  ...
  const memo = noop.useMemo(() => {
    ...
    const obj2 = {
      ...
      headerTitle() {
        ...
        obj.children = intl.string(closure_1_1(2487).xMRO6A);
        return closure_1_6(teenId(4832).Text, obj);
      },
      render() {
