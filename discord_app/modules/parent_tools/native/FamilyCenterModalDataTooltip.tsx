...
let obj = {
  [USER_INTERACTION]: fn(5291).ChatIcon,
  [USER_CALLED]: fn(12179).PhoneIcon,
  [USER_ADD]: fn(4456).FriendsIcon,
  [GUILD_ADD]: fn(13859).ServerGridIcon,
  [GUILD_INTERACTION]: fn(5293).ThreadIcon,
  [PURCHASES]: fn(12181).CreditCardIcon,
  [TOTAL_VOICE_MINUTES]: fn(4719).ClockIcon,
  [GIFTS]: fn(11305).GiftIcon,
};
({ USER_INTERACTION, USER_CALLED, USER_ADD, GUILD_ADD, GUILD_INTERACTION, PURCHASES, TOTAL_VOICE_MINUTES, GIFTS } =
  fn(7783).TeenActionDisplayType);
