...
let obj = {
  [USER_INTERACTION]: fn(5155).ChatIcon,
  [USER_CALLED]: fn(12055).PhoneIcon,
  [USER_ADD]: fn(4339).FriendsIcon,
  [GUILD_ADD]: fn(13681).ServerGridIcon,
  [GUILD_INTERACTION]: fn(5157).ThreadIcon,
  [PURCHASES]: fn(12057).CreditCardIcon,
  [TOTAL_VOICE_MINUTES]: fn(4602).ClockIcon,
  [GIFTS]: fn(11169).GiftIcon,
};
({ USER_INTERACTION, USER_CALLED, USER_ADD, GUILD_ADD, GUILD_INTERACTION, PURCHASES, TOTAL_VOICE_MINUTES, GIFTS } =
  fn(7645).TeenActionDisplayType);
