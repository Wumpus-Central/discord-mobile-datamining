...
fn(4560);
let createStyles = { container: { flex: 1 }, scrollContent: null, section: null, sectionHeader: null, daysContainer: null, dayButton: null, dayButtonSelected: null, overlapWarningContent: null, footer: null };
createStyles = { paddingHorizontal: nativeDefault.space.PX_16, paddingTop: nativeDefault.space.PX_24, gap: nativeDefault.space.PX_24 };
...
createStyles.dayButton = { flex: 1, aspectRatio: 1, borderRadius: nativeDefault.radii.round, alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.REDESIGN_BUTTON_TERTIARY_BACKGROUND, borderWidth: 1, borderColor: "transparent" };
createStyles.dayButtonSelected = { backgroundColor: "rgba(88, 101, 242, 0.16)", borderColor: "rgba(88, 101, 242, 1)" };
let obj4 = { flex: 1, aspectRatio: 1, borderRadius: nativeDefault.radii.round, alignItems: "center", justifyContent: "center", backgroundColor: nativeDefault.colors.REDESIGN_BUTTON_TERTIARY_BACKGROUND, borderWidth: 1, borderColor: "transparent" };
createStyles.overlapWarningContent = { marginTop: nativeDefault.space.PX_24 };
let obj5 = { marginTop: nativeDefault.space.PX_24 };
createStyles.footer = { paddingHorizontal: nativeDefault.space.PX_16, paddingVertical: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_8 };
...
export default function ScheduleDowntimeScreen() {
          ...
          if (arg0 === 1) {
            ...
            if (timestampProducer) {
              ...
              if (null != ruleId) {
                ...
                c1 = 3;
                c4 = 1;
                const obj2 = { value: tmp27Result.updateRestrictedScheduleRule(tmp45, tmp34.ruleId, obj1), done: false };
                return obj2;
              }
            }
  ...
  const memo2 = obj2.useMemo(() => FamilyCenterRestrictedHoursUtils.computeOverlappingInfo(first3, memo1, memo), items2);
  const items3 = [teenId, , ];
  let ruleId1;
  ...
  const layoutEffect = obj2.useLayoutEffect(() => {
    if (closure_6) {
      let obj = {
        headerRight() {
            let obj = { onPress, accessibilityRole: "button", accessibilityLabel: null, hitSlop: 8, disabled: null, children: null };
