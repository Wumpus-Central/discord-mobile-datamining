...
import FamilyCenterActivityGiftRowUtils from "FamilyCenterActivityGiftRowUtils" /* 15189 */;
...
const memoResult1 = noop.memo((action) => {
  ...
  if (undefined === stateFromStores) {
    ...
    if (undefined !== stateFromStores.approximateMemberCount) {
      ...
      obj10.children = intl.format(_modDef2482["5JmNgg"], obj19);
      tmp11Result2 = closure_8(tmp2(4753).Text, obj10);
    }
