...
import FamilyCenterActivityGiftRowUtils from "FamilyCenterActivityGiftRowUtils" /* 15122 */;
...
const memoResult1 = noop.memo((action) => {
  ...
  if (undefined === stateFromStores) {
    ...
    if (undefined !== stateFromStores.approximateMemberCount) {
      ...
      obj10.children = intl.format(_modDef2480["5JmNgg"], obj19);
      tmp11Result2 = closure_8(tmp2(4718).Text, obj10);
    }
