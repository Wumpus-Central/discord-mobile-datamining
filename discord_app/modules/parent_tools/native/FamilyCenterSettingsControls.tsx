...
function SpendingLimitRow(teenId) {
  ...
  if (null != teenId) {
    fn = () => {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(14997, dependencyMap.paths), { teenId }, undefined, {
...
function FamilyCenterSettingsTeenControls() {
  ...
  let isFamilyCenterV3Enabled = activeLinkUserIds(handleOpenSettings[17]).useIsFamilyCenterV3Enabled({
    location: "FamilyCenterSettingsControls",
  });
  ...
  obj7.children = intl.string(require("../FamilyCenter.messages.js").ahKIJO);
  ...
  obj8.children = intl2.format(require("../FamilyCenter.messages.js").X9rW0j, {
  ...
  if (isFamilyCenterV3Enabled) {
    ...
    const items2 = [closure_7(SpendingLimitRow, obj11)];
    ...
    items2[1] = closure_7(tmp2(tmp3[14]).TableRow, obj12);
    obj13.children = items2;
    obj10.children = closure_8(tmp2(tmp3[21]).TableRowGroup, obj13);
    isFamilyCenterV3Enabled = closure_7(View, obj10);
  }
  ...
  obj14.text = intl4.formatToPlainString(require("../FamilyCenter.messages.js").w0JA3P, {
...
function FamilyCenterSettingsParentalControls() {
  ...
  const isFamilyCenterV3Enabled = selectedTeenUser(7696).useIsFamilyCenterV3Enabled({
    location: "FamilyCenterSettingsControls",
  });
  ...
  if (tmp15Result) {
    ...
    tmp15Result = closure_7(SpendingLimitRow, obj11);
  }
  ...
  if (tmp15Result2) {
    ...
    tmp15Result2 = closure_7(tmp2(5686).TableRow, obj12);
  }
