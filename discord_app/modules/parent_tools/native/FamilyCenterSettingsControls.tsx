...
function SpendingLimitRow(teenId) {
  ...
  if ("off" === kind) {
    ...
    obj.trailing = closure_7(tmp2(4632).Text, obj);
    let tmp8 = obj;
    ...
    obj1.trailing = closure_7(tmp2(4632).Text, obj2);
    tmp8 = obj1;
    ...
    obj3.trailing = closure_7(tmp2(4632).Text, obj4);
    const obj5 = {
      variant: "text-sm/normal",
      style: tmp.subLabelWarning,
      children: spendingLimitDisplayState.remainingText,
    };
    obj3.subLabel = closure_7(tmp2(4632).Text, obj5);
    tmp8 = obj3;
  } else if ("spent" === kind) {
    ...
    const obj11 = {
      ...
      children: intl5.string(_modDef2396.FUu2b0),
    };
  ...
  if (null != teenId) {
    fn = () => {
      const obj = { teenId };
      obj.pushLazy(asyncRequireImpl(14996, dependencyMap.paths), obj, undefined, { animation: "slide_from_right" });
    };
  }
  obj12.onPress = fn;
  obj12.arrow = null != teenId;
  obj12.disabled = null == teenId;
  return closure_7(teenId(5686).TableRow, obj12);
}
function FamilyCenterSettingsTeenControls() {
  ...
  obj1.children = intl.string(require("../FamilyCenter.messages.js").ahKIJO);
  ...
  obj2.children = intl2.format(require("../FamilyCenter.messages.js").X9rW0j, obj3);
  ...
  obj8.text = intl4.formatToPlainString(require("../FamilyCenter.messages.js").w0JA3P, {
...
function FamilyCenterSettingsParentalControls() {
  ...
  const items1 = [closure_7(selectedTeenUser(4632).Text, obj), ,];
  ...
  items1[1] = closure_7(selectedTeenUser(4632).Text, obj1);
  ...
  const items2 = [closure_7(selectedTeenUser(5686).TableRow, obj3), , ,];
  ...
  items2[1] = closure_7(selectedTeenUser(5686).TableRow, obj4);
  ...
  if (tmp15Result) {
    ...
    tmp15Result = closure_7(tmp2(5686).TableRow, obj6);
  }
  items2[3] = tmp15Result;
  obj2.children = closure_8(selectedTeenUser(5768).TableRowGroup, { hasIcons: false, children: items2 });
  items1[2] = closure_7(View, obj2);
  obj.children = items1;
  return closure_8(selectedTeenUser(5054).Stack, obj);
}
