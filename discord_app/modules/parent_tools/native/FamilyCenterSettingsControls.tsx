...
function SpendingLimitRow(teenId) {
  ...
  if ("off" === kind) {
    ...
    obj1[0] = callback(tmp2(4281).Text, obj2);
    tmp8 = obj1;
    ...
    obj3[0] = callback(tmp2(4281).Text, obj4);
    ...
    obj6[0] = callback(tmp2(4281).Text, obj7);
  ...
  obj12[4] = null != teenId;
  obj12[5] = null == teenId;
  return callback(teenId(5354).TableRow, obj12);
}
...
function FamilyCenterSettingsParentalControls() {
  ...
  const ParentalControlledSpendingLimit = tmp2(13986).ParentalControlledSpendingLimit;
  let id;
  if (selectedTeenUser != null) {
  ...
  ({ subLabel, trailing } = shouldLoadSettingsForSelectedTeenUser(14071)(rules));
  ...
  const items1 = [callback(selectedTeenUser(4281).Text, obj), , ];
  ...
  items1[1] = callback(selectedTeenUser(4281).Text, obj1);
  ...
  const items2 = [callback(selectedTeenUser(5354).TableRow, obj3), , , ];
  ...
  items2[1] = callback(selectedTeenUser(5354).TableRow, obj4);
  ...
  if (tmp15Result) {
    ...
    tmp15Result = tmp15(tmp2(5354).TableRow, obj6);
  }
  items2[3] = tmp15Result;
  obj2[1] = closure_8(selectedTeenUser(5688).TableRowGroup, { hasIcons: false, children: items2 });
  items1[2] = callback(View, obj2);
  obj[1] = items1;
  return closure_8(selectedTeenUser(4693).Stack, obj);
}
