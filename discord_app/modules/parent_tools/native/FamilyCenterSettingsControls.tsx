// === Module 15191: FamilyCenterSettingsControls ===
...
import useUserIsTeenAgeGroupDefault from "useUserIsTeenAgeGroup" /* 15196 */;
...
function SpendingLimitRow(teenId) {
  ...
  if (null != teenId) {
    fn = () => {
      ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(15192, dependencyMap.paths), { teenId }, undefined, { animation: "slide_from_right" });
    };
  }
  obj15.onPress = fn;
