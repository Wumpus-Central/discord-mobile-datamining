...
export default function ParentalConsentWarningModal(daysRemaining) {
  ...
  obj8.text = intl3.string(require("module_2396").Kp7sjX);
  ...
  obj9.text = intl4.string(require("module_2396").hST5o8);
  const intl5 = tmp4(tmp3[15]).intl;
  obj9.accessibilityHint = intl5.string(require("module_2396")["4fZtHa"]);
