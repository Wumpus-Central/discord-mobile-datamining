...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  const callback = noop.useCallback(() => {
    let arr = acceptLinkRequest(4777);
    arr = arr.pop();
  }, []);
  ...
  const obj2 = { otherUser, iconSrc: acceptLinkRequest(4518), iconStyles: tmp.icon };
  const items1 = [closure_5(acceptLinkRequest(14951), obj2), ,];
  ...
  const items2 = [closure_6(View, obj1), closure_5(acceptLinkRequest(11949), {})];
  ...
  items2[2] = closure_5(otherUser(4570).Text, obj4);
  obj.children = items2;
  const items3 = [closure_6(otherUser(8450).ModalContent, obj)];
  ...
  const items4 = [closure_5(otherUser(4989).Button, obj8)];
  ...
  obj9.onPress = acceptLinkRequest(4777).pop;
  items4[1] = closure_5(otherUser(4989).Button, obj9);
  obj7.children = items4;
  obj6.children = closure_6(otherUser(5447).ButtonGroup, obj7);
  items3[1] = closure_5(otherUser(11957).ModalFooter, obj6);
  obj.children = items3;
