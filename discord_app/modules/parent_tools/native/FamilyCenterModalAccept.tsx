...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  const callback = noop.useCallback(() => {
    let arr = acceptLinkRequest(4839);
    arr = arr.pop();
  }, []);
  ...
  const obj2 = { otherUser, iconSrc: acceptLinkRequest(4580), iconStyles: tmp.icon };
  const items1 = [closure_5(acceptLinkRequest(15011), obj2), ,];
  ...
  const items2 = [closure_6(View, obj1), closure_5(acceptLinkRequest(12048), {})];
  ...
  items2[2] = closure_5(otherUser(4632).Text, obj4);
  obj.children = items2;
  const items3 = [closure_6(otherUser(8540).ModalContent, obj)];
  ...
  const items4 = [closure_5(otherUser(5056).Button, obj8)];
  ...
  obj9.onPress = acceptLinkRequest(4839).pop;
  items4[1] = closure_5(otherUser(5056).Button, obj9);
  obj7.children = items4;
  obj6.children = closure_6(otherUser(5514).ButtonGroup, obj7);
  items3[1] = closure_5(otherUser(12056).ModalFooter, obj6);
  obj.children = items3;
