...
function FamilyCenterModalAcceptScreen(otherUser) {
  ...
  const callback = noop.useCallback(() => {
    let arr = acceptLinkRequest(4809);
    arr = arr.pop();
  }, []);
  ...
  const obj2 = { otherUser, iconSrc: acceptLinkRequest(4550), iconStyles: tmp.icon };
  const items1 = [closure_5(acceptLinkRequest(14977), obj2), , ];
  ...
  const items2 = [closure_6(View, obj1), closure_5(acceptLinkRequest(12012), {}), ];
  ...
  items2[2] = closure_5(otherUser(4602).Text, obj4);
  obj.children = items2;
  const items3 = [closure_6(otherUser(8508).ModalContent, obj), ];
  ...
  const items4 = [closure_5(otherUser(5026).Button, obj8), ];
  ...
  obj9.onPress = acceptLinkRequest(4809).pop;
  items4[1] = closure_5(otherUser(5026).Button, obj9);
  obj7.children = items4;
  obj6.children = closure_6(otherUser(5484).ButtonGroup, obj7);
  items3[1] = closure_5(otherUser(12020).ModalFooter, obj6);
  obj.children = items3;
