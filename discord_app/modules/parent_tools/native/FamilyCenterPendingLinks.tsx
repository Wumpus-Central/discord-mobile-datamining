  ...
  if (undefined === otherUser.otherUser) {
    ...
    if (tmp4) {
      ...
      if (!tmp7) {
        ...
        obj.style = items;
        const obj6 = { size: tmp5(1177).Icon.Sizes.SMALL, disableColor: true, source: _modDef8810 };
        obj.children = closure_5(tmp5(1177).Icon, obj6);
        tmp12Result = closure_5(tmp5(5435).PressableOpacity, obj);
      }
