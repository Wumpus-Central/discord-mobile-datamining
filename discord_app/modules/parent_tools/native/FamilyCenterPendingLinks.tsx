...
function FamilyCenterPendingLinkRow(otherUser) {
  ...
  if (undefined === otherUser.otherUser) {
    ...
    if (tmp4) {
      ...
      obj2.accessibilityLabel = intl3.formatToPlainString(_modDef2480.oUpA6X, obj3);
      ...
      const obj4 = { size: tmp5(1177).Icon.Sizes.SMALL, disableColor: true, source: _modDef15141 };
      obj2.children = closure_5(tmp5(1177).Icon, obj4);
      let tmp8Result = closure_5(tmp5(5292).PressableOpacity, obj2);
      let tmp14 = closure_5;
    } else {
      ...
      if (!tmp7) {
        ...
        obj.accessibilityLabel = intl.formatToPlainString(_modDef2480.jc1Ip7, obj5);
        ...
        obj.style = items;
        const obj6 = { size: tmp5(1177).Icon.Sizes.SMALL, disableColor: true, source: _modDef9814 };
        obj.children = closure_5(tmp5(1177).Icon, obj6);
        tmp12Result = closure_5(tmp5(5292).PressableOpacity, obj);
      }
      ...
      obj8.accessibilityLabel = intl2.formatToPlainString(_modDef2480["4GtllP"], obj9);
      ...
      const obj10 = { size: tmp5(1177).Icon.Sizes.SMALL, disableColor: true, source: _modDef15141 };
