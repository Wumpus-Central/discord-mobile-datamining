// === Module 14438: FamilyCenterModalDecline ===
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  const callback = noop.useCallback(() => {
    declineLinkRequest(5032).pop();
  }, []);
  const callback1 = noop.useCallback(() => {
    const intl = otherUser(1115).intl;
    otherUser(4524).presentFailedToast(intl.string(otherUser(1115).t.R0RpRX));
  }, []);
  const tmp2 = declineLinkRequest(8098)();
  const familyCenterActions = otherUser(11381).useFamilyCenterActions({ onSuccess: callback, onError: callback1 });
  ...
  const obj = otherUser(11381);
  obj5.iconSrc = declineLinkRequest(6408);
  const items1 = [closure_5(declineLinkRequest(14434), obj5), , ];
  ...
  items1[1] = closure_5(otherUser(4825).Text, obj6);
  items1[2] = closure_5(declineLinkRequest(14404), { user: otherUser });
  ...
  const items3 = [closure_5(otherUser(4825).Text, obj8), ];
  ...
  items3[1] = closure_5(otherUser(4825).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(7863).ModalContent, obj3), ];
  ...
  const items5 = [closure_5(otherUser(5274).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(5032).pop;
  items5[1] = closure_5(otherUser(5274).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5740).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(11391).ModalFooter, obj10);
  obj2.children = items4;
  return closure_6(otherUser(7862).ModalScreen, obj2);
}
...
export default function FamilyCenterModalDecline(otherUser) {
  ...
  return closure_5(otherUser(10756).Modal, obj);
};