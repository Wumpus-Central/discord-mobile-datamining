...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  const callback = noop.useCallback(() => {
    let arr = declineLinkRequest(4839);
    arr = arr.pop();
  }, []);
  ...
  declineLinkRequest(38)(!declineLinkRequest(8769)(), "FamilyCenterDeclineLinkModal should only be rendered for teens.");
  obj = { children: null };
  obj = { children: null };
  const obj1 = { style: tmp.header, children: null };
  const obj2 = { otherUser, iconSrc: null };
  const tmp2 = declineLinkRequest(8769)();
  obj2.iconSrc = declineLinkRequest(7095);
  const items1 = [closure_5(declineLinkRequest(15011), obj2), , ];
  ...
  const items3 = [closure_5(otherUser(4632).Text, obj5), ];
  ...
  items3[1] = closure_5(otherUser(4632).Text, obj6);
  obj4.children = items3;
  items2[1] = closure_6(View, obj4);
  obj.children = items2;
  const items4 = [closure_6(otherUser(8540).ModalContent, obj), ];
  ...
  const items5 = [closure_5(otherUser(5056).Button, obj9), ];
  ...
  obj10.onPress = declineLinkRequest(4839).pop;
  items5[1] = closure_5(otherUser(5056).Button, obj10);
  obj8.children = items5;
  obj7.children = closure_6(otherUser(5514).ButtonGroup, obj8);
  items4[1] = closure_5(otherUser(12056).ModalFooter, obj7);
  obj.children = items4;
