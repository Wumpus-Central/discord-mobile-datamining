...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  const callback = noop.useCallback(() => {
    let arr = declineLinkRequest(4777);
    arr = arr.pop();
  }, []);
  ...
  declineLinkRequest(38)(!declineLinkRequest(8679)(), "FamilyCenterDeclineLinkModal should only be rendered for teens.");
  obj = { children: null };
  obj = { children: null };
  const obj1 = { style: tmp.header, children: null };
  const obj2 = { otherUser, iconSrc: null };
  const tmp2 = declineLinkRequest(8679)();
  obj2.iconSrc = declineLinkRequest(7006);
  const items1 = [closure_5(declineLinkRequest(14951), obj2), , ];
  ...
  items1[1] = closure_5(otherUser(4570).Text, obj3);
  ...
  const items3 = [closure_5(otherUser(4570).Text, obj5), ];
  ...
  items3[1] = closure_5(otherUser(4570).Text, obj6);
  obj4.children = items3;
  items2[1] = closure_6(View, obj4);
  obj.children = items2;
  const items4 = [closure_6(otherUser(8450).ModalContent, obj), ];
  ...
  const items5 = [closure_5(otherUser(4989).Button, obj9), ];
  ...
  obj10.onPress = declineLinkRequest(4777).pop;
  items5[1] = closure_5(otherUser(4989).Button, obj10);
  obj8.children = items5;
  obj7.children = closure_6(otherUser(5447).ButtonGroup, obj8);
  items4[1] = closure_5(otherUser(11957).ModalFooter, obj7);
  obj.children = items4;
  return closure_6(otherUser(8449).ModalScreen, obj);
}
...
let obj2 = { padding: nativeDefault.space.PX_24, borderRadius: nativeDefault.radii.md, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH };
