// === Module 15211: FamilyCenterModalDecline ===
...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  obj5.iconSrc = declineLinkRequest(7239);
  const items1 = [closure_5(declineLinkRequest(15207), obj5), , ];
  ...
  items1[2] = closure_5(declineLinkRequest(15177), { user: otherUser });
  ...
  const items3 = [closure_5(otherUser(4753).Text, obj8), ];
  ...
  items3[1] = closure_5(otherUser(4753).Text, obj9);
  obj7.children = items3;
  items2[1] = closure_6(View, obj7);
  obj3.children = items2;
  const items4 = [closure_6(otherUser(8698).ModalContent, obj3), ];
  ...
  const items5 = [closure_5(otherUser(5187).Button, obj12), ];
  ...
  obj13.onPress = declineLinkRequest(4960).pop;
  items5[1] = closure_5(otherUser(5187).Button, obj13);
  obj11.children = items5;
  obj10.children = closure_6(otherUser(5652).ButtonGroup, obj11);
  items4[1] = closure_5(otherUser(12185).ModalFooter, obj10);
