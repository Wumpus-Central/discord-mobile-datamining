...
function FamilyCenterModalDeclineScreen(otherUser) {
  ...
  declineLinkRequest(38)(!declineLinkRequest(7260)(), "FamilyCenterDeclineLinkModal should only be rendered for teens.");
  obj = { children: null };
  obj = { children: null };
  ...
  obj5[3] = intl2.string(declineLinkRequest(2285).cXgKMD);
  ...
  obj6[2] = intl3.string(declineLinkRequest(2285).LcM8BS);
  items3[1] = callback(otherUser(4281).Text, obj6);
  obj4[1] = items3;
  items2[1] = callback2(View, obj4);
  obj[0] = items2;
  const items4 = [callback2(otherUser(7758).ModalContent, obj), ];
  ...
  obj9[3] = intl4.string(declineLinkRequest(2285).dKxFcn);
  obj9[4] = callback2;
  ...
  obj8[0] = items5;
  obj7[0] = callback2(otherUser(5117).ButtonGroup, obj8);
  items4[1] = callback(otherUser(11246).ModalFooter, obj7);
  obj[0] = items4;
