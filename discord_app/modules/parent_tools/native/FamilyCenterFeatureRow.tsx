...
import _modDef15223 from "../../../../_runtime/metro/15223__.js";
...
export default function FamilyCenterFeatureRows() {
  ...
  const ageSpecificText1 = obj2.useAgeSpecificText(
    intl3.string(_modDef2484.t7SkFy),
    intl4.string(_modDef2484["68zfxD"]),
  );
  ...
  const ageSpecificText2 = obj3.useAgeSpecificText(
    intl5.string(_modDef2484["+pi4Yt"]),
    intl6.string(_modDef2484["1xPTwE"]),
  );
