...
export default function FamilyCenterFeatureRows() {
  ...
  obj[0] = registerAsset;
  obj[1] = ChatCheckIcon /* ChatCheckIcon */.ChatCheckIcon;
  const intl7 = getSystemLocale /* getSystemLocale */.intl;
  obj[2] = intl7.string(messagesProxy["001l3m"]);
  obj[3] = ageSpecificText;
  const items = [obj, , ];
  obj = { icon: registerAsset, IconComponent: EyeIcon /* EyeIcon */.EyeIcon, header: null, description: null };
  const intl8 = getSystemLocale /* getSystemLocale */.intl;
  obj[2] = intl8.string(messagesProxy.yipAeP);
  obj[3] = ageSpecificText1;
  items[1] = obj;
  obj1 = { icon: registerAsset, IconComponent: QrCodeIcon /* QrCodeIcon */.QrCodeIcon, header: null, description: null };
  ...
  const items1 = [callback(Text /* Text */.Text, obj4), ];
  ...
  items1[1] = callback(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, obj5);
  obj3[1] = items1;
