...
import registerAssetDefault from "../../../../_runtime/09861_registerAsset.js";
import useAgeSpecificText from "../hooks/useAgeSpecificText.tsx";
import registerAssetDefault2 from "../../../../_runtime/12376_registerAsset.js";
import QrCodeIcon from "../../../design/components/Icon/native/redesign/generated/QrCodeIcon.tsx";
import registerAssetDefault3 from "../../../../_runtime/14886_registerAsset.js";
    ...
    children: items.map((header) => {
      ...
      return callback2(
        callback(5605).TableRow,
        {
          ...
          icon: callback2(callback(5605).TableRow.Icon, { source: icon, IconComponent }),
        },
        header,
      );
    }),
