...
import _modDef12505 from "../../../../_runtime/metro/12505__.js";
...
export default function FamilyCenterFeatureRows() {
  ...
  const items = [obj, ,];
  obj = { icon: _modDef12505, IconComponent: EyeIcon.EyeIcon, header: null, description: null };
  const intl8 = util.intl;
  obj.header = intl8.string(_modDef2396.yipAeP);
  obj.description = ageSpecificText1;
  items[1] = obj;
  obj1 = { icon: _modDef9991, IconComponent: QrCodeIcon.QrCodeIcon, header: null, description: null };
