...
import registerAssetDefault2 from "../../../../_runtime/12174_registerAsset.js";
import QrCodeIcon from "../../../design/components/Icon/native/redesign/generated/QrCodeIcon.tsx";
import registerAssetDefault3 from "../../../../_runtime/14730_registerAsset.js";
    ...
    children: items.map((header) => {
      ...
      return callback2(
        callback(5608).TableRow,
        {
          ...
          icon: callback2(callback(5608).TableRow.Icon, { source: icon, IconComponent }),
        },
        header,
      );
    }),
