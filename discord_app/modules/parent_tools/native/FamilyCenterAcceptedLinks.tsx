...
import FamilyCenterEmptyDefault from "FamilyCenterEmpty" /* 15134 */;
...
export default function FamilyCenterAcceptedLinks() {
  ...
  const ageSpecificText = tmp5Result.useAgeSpecificText(intl.formatToPlainString(_modDef2480["+tnO34"], obj2), intl2.formatToPlainString(_modDef2480["pu6/U0"], obj2));
  ...
  if (0 === activeLinkUsers.length) {
    ...
    obj7.text = intl3.string(_modDef2480.C4ScLD);
