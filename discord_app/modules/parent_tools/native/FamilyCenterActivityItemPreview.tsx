...
function AvatarDecorationPreviewImage(arg0) {
  ...
  let styles;
  ({ product, styles } = arg0);
  let obj = require(14053) /* getCollectibleTypeName */;
...
function NameplatePreviewImage(styles) {
  ...
  let obj = require(9309) /* getNameplateAssets */;
...
function ProfileFramePreviewImage(arg0) {
  ...
  let styles;
  ({ product, styles } = arg0);
  const tmp3 = importDefault(8719)(product.skuId, "FamilyCenterActivityItemPreview");
  let tmp4 = null;
  if (null != tmp3) {
    ...
    obj[0] = tmp3;
    obj[1] = require(14053) /* getCollectibleTypeName */.PREVIEW_SIZE * closure_5;
    obj[2] = require(14053) /* getCollectibleTypeName */.PREVIEW_SIZE;
...
function SubscriptionPreview(arg0) {
  ...
  if (null == subscriptionPlanId) {
    ...
    obj[1] = jsx(require(11438) /* ShopIcon */.ShopIcon, { size: "custom", style: null });
