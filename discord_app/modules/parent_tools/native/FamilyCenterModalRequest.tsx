...
function FamilyCenterConfirmAgeScreen(teenIdentity) {
  ...
  const tmp7 = stateFromStores(8776)(stateFromStores);
  dependencyMap = tmp7;
  ...
  obj[1] = callback(navigation(5948).FamilyShieldSpotIllustration, {});
  ...
  obj5[0] = items4;
  obj4[0] = closure_13(navigation(5132).ButtonGroup, obj5);
  items3[1] = callback(navigation(11252).ModalFooter, obj4);
  obj2[0] = items3;
  return closure_13(navigation(7730).ModalScreen, obj2);
}
...
function FamilyCenterPrereqMustBeAdultScreen() {
  ...
  const tmp3 = stateFromStores(8776)(stateFromStores);
...
export default function FamilyCenterRequestModal(userId) {
  ...
  const FamilyCenterConnectionPrereqExperiment = userId(11253).FamilyCenterConnectionPrereqExperiment;
  ...
  const FamilyCenterModalRequestSections = userId(11241).FamilyCenterModalRequestSections;
  ...
  return callback(userId(11254).Modal, obj);
};
