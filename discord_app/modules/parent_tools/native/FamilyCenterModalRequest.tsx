...
function FamilyCenterConfirmAgeScreen(teenIdentity) {
  ...
  const callback = noop.useCallback(() => {
    ...
    const result = obj.showAgeVerificationGetStartedModal({
      entryPoint: navigation(8531).AgeVerificationModalEntryPoint.FAMILY_CENTER_CONNECTION,
    });
  }, []);
  const obj3 = { style: tmp.content, children: null };
  const obj2 = navigation(563);
  const items2 = [
    closure_12(closure_6, { style: tmp.art, children: closure_12(navigation(5773).FamilyShieldSpotIllustration, {}) }),
    ,
  ];
  ...
  obj7.children = intl2.format(stateFromStores(2396)["0o3yg8"], {
