...
class FamilyCenterModalRequestConfirm {
  constructor(arg0) {
    ...
    obj23[3] = require("module_4507").pop;
...
function FamilyCenterConfirmAgeScreen(teenIdentity) {
  ...
  const tmp7 = stateFromStores(8793)(stateFromStores);
  dependencyMap = tmp7;
  ...
  obj[1] = callback(navigation(5967).FamilyShieldSpotIllustration, {});
  ...
  items2[1] = callback(navigation(4298).Text, obj1);
  ...
  items2[2] = callback(navigation(4298).Text, obj3);
  obj[1] = items2;
  ...
  obj6[2] = callback;
  const items4 = [callback(navigation(4712).Button, obj6), ];
  ...
  items4[1] = callback(navigation(4712).Button, obj7);
  obj5[0] = items4;
  obj4[0] = closure_13(navigation(5149).ButtonGroup, obj5);
  items3[1] = callback(navigation(11267).ModalFooter, obj4);
  obj2[0] = items3;
  return closure_13(navigation(7747).ModalScreen, obj2);
}
...
function FamilyCenterPrereqMustBeAdultScreen() {
  ...
  const tmp3 = stateFromStores(8793)(stateFromStores);
  ...
  obj[1] = stateFromStores(4507).pop;
  obj[2] = obj;
  return callback(FamilyCenterPrereqScreen, obj);
}
...
createCacheKey[1] = HeaderBackImage.getHeaderCloseButton(require("module_4507").pop);
...
export default function FamilyCenterRequestModal(userId) {
  ...
  const FamilyCenterConnectionPrereqExperiment = userId(11268).FamilyCenterConnectionPrereqExperiment;
  ...
  const FamilyCenterModalRequestSections = userId(11256).FamilyCenterModalRequestSections;
  ...
  return callback(userId(11269).Modal, obj);
};
