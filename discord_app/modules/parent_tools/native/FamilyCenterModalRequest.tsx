// === Module 12250: FamilyCenterModalRequest ===
...
import NavigatorHeader2 from "NavigatorHeader" /* 5927 */;
...
import FamilyCenterModalRequestRouting from "FamilyCenterModalRequestRouting" /* 12251 */;
...
function FamilyCenterConfirmAgeScreen(teenIdentity) {
  ...
  const callback = noop.useCallback(() => {
    ...
    const result = obj.showAgeVerificationGetStartedModal({ entryPoint: navigation(8759).AgeVerificationModalEntryPoint.FAMILY_CENTER_CONNECTION });
  }, []);
  const obj3 = { style: tmp.content, children: null };
  const obj2 = navigation(563);
  const items2 = [closure_12(closure_6, { style: tmp.art, children: closure_12(navigation(5995).FamilyShieldSpotIllustration, {}) }), , ];
  ...
  obj7.children = intl2.format(stateFromStores(2484)["0o3yg8"], { link: "https://support.discord.com/hc/articles/14155060633623" });
...
export default function FamilyCenterRequestModal(userId) {
  ...
  let obj = { initialRouteName: userId(12251).FamilyCenterModalRequestSections.PREREQ_LOADING, screens: memo, headerBackTitle: null };
