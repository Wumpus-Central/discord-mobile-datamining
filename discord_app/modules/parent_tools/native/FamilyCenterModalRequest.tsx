...
class FamilyCenterModalRequestConfirm {
  constructor(arg0) {
    ...
    callback1 = closure_4.useCallback((arg0) => {
      ...
      navigation.push(FamilyCenterModalRequestRouting.FamilyCenterModalRequestSections.ERROR, {
...
function FamilyCenterPrereqLoading(arg0) {
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              c3 = 1;
              const obj5 = {
                value: FamilyCenterModalRequestRouting.resolveConnectionPrereqTarget(closure_0, closure_1),
                done: false,
              };
              return obj5;
            }
            ...
            if (closure_129_0) {
              ...
              closure_128_0.section !== FamilyCenterModalRequestRouting.FamilyCenterModalRequestSections.ERROR
            ) {
              if (closure_128_0.section !== FamilyCenterModalRequestRouting.FamilyCenterModalRequestSections.REQUEST) {
                if (
                  closure_128_0.section !== FamilyCenterModalRequestRouting.FamilyCenterModalRequestSections.CONFIRM_AGE
                ) {
  ...
  obj2.children = closure_12(closure_6, {
    style: tmp.container,
    children: closure_12(ActivityIndicator_ActivityIndicator.ActivityIndicator, {}),
  });
...
function FamilyCenterPrereqScreen(primaryButton) {
  ...
  const obj5 = {
    children: closure_1_12(components_Button_Button.Button, {
...
function FamilyCenterConfirmAgeScreen(teenIdentity) {
  ...
  const tmp7 = stateFromStores(8618)(stateFromStores);
  dependencyMap = tmp7;
  ...
  const callback = noop.useCallback(() => {
    const obj = stateFromStores(8757);
    const result = obj.showAgeVerificationGetStartedModal({
      entryPoint: navigation(8759).AgeVerificationModalEntryPoint.FAMILY_CENTER_CONNECTION,
    });
  }, []);
  const obj3 = { style: tmp.content, children: null };
  const obj2 = navigation(563);
  const items2 = [
    closure_12(closure_6, { style: tmp.art, children: closure_12(navigation(5995).FamilyShieldSpotIllustration, {}) }),
    ,
  ];
  ...
  obj5.children = intl.formatToPlainString(stateFromStores(2484).pQQMJ7, { username: str });
  items2[1] = closure_12(navigation(4823).Text, obj5);
  const obj7 = { variant: "text-sm/medium", color: "text-muted", style: tmp.description, children: null };
  const intl2 = tmp2(1115).intl;
  obj7.children = intl2.format(stateFromStores(2484)["0o3yg8"], {
    link: "https://support.discord.com/hc/articles/14155060633623",
  });
  items2[2] = closure_12(navigation(4823).Text, obj7);
  ...
  obj10.text = intl3.string(stateFromStores(2484)["3oUE4o"]);
  obj10.onPress = callback;
  const items4 = [closure_12(navigation(5271).Button, obj10)];
  const obj11 = { variant: "tertiary", text: null, onPress: null };
  const intl4 = tmp2(1115).intl;
  obj11.text = intl4.string(navigation(1115).t.oEAioF);
  obj11.onPress = function onPress() {
    return stateFromStores(5030).pop();
  };
  items4[1] = closure_12(navigation(5271).Button, obj11);
  obj9.children = items4;
  obj8.children = closure_13(navigation(5736).ButtonGroup, obj9);
  items3[1] = closure_12(navigation(12262).ModalFooter, obj8);
  obj6.children = items3;
  return closure_13(navigation(8768).ModalScreen, obj6);
}
function FamilyCenterVerifyingScreen() {
    ...
    if (isAgeVerified) {
      if (!ref.current) {
        ...
        const replaced = navigation.replace(
          FamilyCenterModalRequestRouting.FamilyCenterModalRequestSections.PREREQ_LOADING,
        );
      }
  ...
  const effect1 = noop.useEffect(() => {
    const timeout = setTimeout(() => {
      const replaced = closure_0.replace(navigation(stateFromStores[11]).FamilyCenterModalRequestSections.ERROR, {
        failureCode: constants.GENERIC_ERROR,
      });
    }, closure_1_8);
  ...
  obj4.children = closure_12(closure_6, {
    style: tmp.container,
    children: closure_12(navigation(stateFromStores[32]).ActivityIndicator, {}),
  });
...
function FamilyCenterPrereqInvalidCodeScreen() {
  ...
  obj.title = intl.string(_modDef2484.ewSb6o);
  const intl2 = util.intl;
  obj.description = intl2.string(_modDef2484.jcUN2F);
...
function FamilyCenterPrereqMustBeAdultScreen() {
  ...
  const tmp3 = stateFromStores(8618)(stateFromStores);
  dependencyMap = tmp3;
  ...
  const intl = navigation(1115).intl;
  obj3.title = intl.string(stateFromStores(2484).BQFHXW);
  const intl2 = navigation(1115).intl;
  obj3.description = intl2.format(stateFromStores(2484).WDjaKn, { link: { onClick: callback } });
  const obj5 = { text: null, onPress: null };
  const intl3 = navigation(1115).intl;
  obj5.text = intl3.string(navigation(1115).t["NX+WJN"]);
  obj5.onPress = stateFromStores(5030).pop;
...
({
  ...
  FamilyCenterIconType: closure_11,
...
export default function FamilyCenterRequestModal(userId) {
  ...
  let obj = {
    initialRouteName: userId(12251).FamilyCenterModalRequestSections.PREREQ_LOADING,
    screens: memo,
    headerBackTitle: null,
  };
  const intl = userId(1115).intl;
  obj.headerBackTitle = intl.string(userId(1115).t["13/7kX"]);
  return closure_12(userId(11545).Modal, obj);
}
