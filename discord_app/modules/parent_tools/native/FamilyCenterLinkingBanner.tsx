...
import createCacheKey from "createCacheKey";
import createCacheKey from "createCacheKey";
import { registerAsset } from "../../../../_runtime/14226_registerAsset.js";
...
function FamilyCenterLinkingBannerTeenContent() {
  return callback(closure_3, { style: createCacheKey().container, children: callback(FamilyCenterTeenQRCodeButtonInner.FamilyCenterTeenQRCodeButton, {}) });
}
