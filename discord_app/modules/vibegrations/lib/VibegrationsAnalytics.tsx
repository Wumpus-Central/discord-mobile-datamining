// discord_app/modules/vibegrations/lib/VibegrationsAnalytics.tsx
...
function vibegrationLocation(closure_0, isPreview) {
  ...
  if (null != guild_id) {
    ...
    if (null != application_id) {
      result = require(5686) /* vibegrationsAppIdFromTopic */.findVibegrationChannelId(guild_id, application_id);
      const obj2 = require(5686) /* vibegrationsAppIdFromTopic */;
    }
  }
  obj[1] = result;
  return obj;
}
let result = require("ME").fileFinishedImporting("modules/vibegrations/lib/VibegrationsAnalytics.tsx");
...
export const trackVibegrationDeployed = function trackVibegrationDeployed(closure_0, isPreview) {
  ...
  importDefault(698).track(AnalyticEvents.VIBEGRATION_DEPLOYED, obj);
};
