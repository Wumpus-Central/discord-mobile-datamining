// discord_app/modules/vibegrations/lib/vibegrationsDesignFeedbackStore.tsx
import VibegrationsDesignFeedback from "VibegrationsDesignFeedback.tsx";
...
export const addVibegrationsDesignAnnotation = function addVibegrationsDesignAnnotation(
  arg0,
  authorId,
  target,
  comment,
  ...
  const merged = Object.assign(value);
  const items = [];
  items[HermesBuiltin.arraySpread(value.annotations, 0)] = {
    id: text,
    authorId,
    target,
    anchor: VIBEGRATIONS_DESIGN_ANCHOR_CENTER,
    comment,
  };
...
export const updateVibegrationsDesignAnnotation = function updateVibegrationsDesignAnnotation(
  arg0,
  arg1,
  arg2,
  comment,
