// discord_app/modules/vibegrations/lib/VibegrationsInstallTarget.tsx
        ...
        if (0 === c3) {
          if (arg0 === 1) {
            ...
            if (!tmp5) {
              ...
              c3 = 1;
              c2 = 1;
              const obj6 = { value: VibegrationsActionCreators.setGuildHints(guild_id.id, obj5), done: false };
              return obj6;
            }
          }
        } else if (arg0 === 1) {
