...
function callNativePreviewFrame(arg0, arg1, id) {
  ...
  return new Promise((arg0, arg1) => {
    ...
    const timeout = setTimeout(() => {
      ...
      closure_4.remove();
      const previewFrameCallTimeout = new vibegrationsPreviewCall.PreviewFrameCallTimeout(
        closure_0,
        closure_1.timeoutMs,
      );
...
let closure_16 = async function _relayPreviewCapture(arg0) {
  if (c9 === 2) {
    c9 = 3;
      ...
      if (0 === c8) {
        if (arg0 === 1) {
          ...
          if (true === probe.probe) {
            ...
            c9 = 1;
            const obj6 = {
              value: waitForLaunchedPreviewFrame(closure_0, require("vibegrationsPreviewCall").PREVIEW_FRAME_WAIT_MS),
              done: false,
            };
            return obj6;
          }
        ...
        if (null == closure_132_3) {
          ...
          const obj20 = {
            id: closure_132_0,
            timeoutMs: closure_133_0(closure_133_3[11]).CAPTURE_NOW_ACCEPT_TIMEOUT_MS,
            retryMs: closure_133_0(closure_133_3[11]).CAPTURE_NOW_RETRY_MS,
          };
    ...
    try {
      ...
      if (0 === c8) {
        if (arg0 === 1) {
          ...
          closure_132_4 = undefined;
          if (previewFrameHeld(closure_0)) {
            closure_132_3 = require("vibegrationsPreviewControlLease").acquireVibegrationsControlLease(closure_0);
            c7 = 2;
            c8 = 3;
            c9 = 1;
            const obj4 = {
        ...
        if (arg0 === 1) {
          ...
          const obj15 = {
            id: closure_132_0,
            timeoutMs: closure_133_0(closure_133_3[11]).controlAnswerTimeoutMs(closure_132_1),
            retryMs: closure_133_0(closure_133_3[11]).CONTROL_RETRY_MS,
          };
          c8 = 5;
          c9 = 1;
