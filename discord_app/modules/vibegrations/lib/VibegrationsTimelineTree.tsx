...
let obj = {
  assembling: _modDef3678["9G3ZmA"],
  installing_deps: _modDef3678.VZuRug,
  building: _modDef3678["s+ylXP"],
  bundling: _modDef3678.rEQlMx,
  committing: _modDef3678.Yvyw1H,
  built: _modDef3678.hOcVAj,
  build_error: _modDef3678["6L9Vwt"],
  healthchecking: _modDef3678.sz8yAj,
  awaiting_auth: _modDef3678["orD+xo"],
  healthcheck_passed: _modDef3678["x+sqTG"],
  healthcheck_failed: _modDef3678.FUWbq1,
  deploying: _modDef3678.wcXX8Z,
  preview_ready: _modDef3678["78YNh7"],
  working: _modDef3678.nv6pUM,
  error: _modDef3678.j3hBoA,
};
let size = fn(2);
