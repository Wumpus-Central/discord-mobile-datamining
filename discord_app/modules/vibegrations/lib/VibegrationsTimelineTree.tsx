...
let obj = {
  assembling: _modDef3676["9G3ZmA"],
  installing_deps: _modDef3676.VZuRug,
  building: _modDef3676["s+ylXP"],
  bundling: _modDef3676.rEQlMx,
  committing: _modDef3676.Yvyw1H,
  built: _modDef3676.hOcVAj,
  build_error: _modDef3676["6L9Vwt"],
  healthchecking: _modDef3676.sz8yAj,
  awaiting_auth: _modDef3676["orD+xo"],
  healthcheck_passed: _modDef3676["x+sqTG"],
  healthcheck_failed: _modDef3676.FUWbq1,
  deploying: _modDef3676.wcXX8Z,
  preview_ready: _modDef3676["78YNh7"],
  working: _modDef3676.nv6pUM,
  error: _modDef3676.j3hBoA,
};
let size = fn(2);
