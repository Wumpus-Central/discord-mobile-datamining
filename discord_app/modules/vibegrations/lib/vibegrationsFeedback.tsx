// discord_app/modules/vibegrations/lib/vibegrationsFeedback.tsx
...
export const markFeedbackShownForProject = function markFeedbackShownForProject(projectId) {
  const Storage = Storage3.Storage;
...
export const submitVibegrationsFeedback = function submitVibegrationsFeedback(
  projectId,
  promptCount,
  dontShowAgain,
