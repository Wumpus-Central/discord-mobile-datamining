// discord_app/modules/vibegrations/VibegrationsChangelog.tsx
...
const items = [
  ...
  },
  {
    ...
    time: "00:00",
    platforms: ["desktop", "mobile"],
    summary: "Checklist items Conjure is still working on show a spinner, so running and done tell apart at a glance.",
  },
  {
    date: "2026-09-05",
    time: "00:00",
  ...
  },
  {
    ...
    time: "00:01",
    platforms: ["desktop", "mobile"],
    summary: "Your project gets a real name as soon as Conjure lands on a plan, instead of sitting as Untitled App.",
  },
  {
    date: "2026-09-03",
    time: "00:00",
    platforms: ["desktop", "mobile"],
    summary: "Your published app stays playable while Conjure drives the preview, instead of both freezing at once.",
  },
];
const items1 = [...items];
...
const result = size.fileFinishedImporting("modules/vibegrations/VibegrationsChangelog.tsx");

export const VIBEGRATIONS_CHANGELOG_VISIBLE_COUNT = 3;
export const VIBEGRATIONS_CHANGELOG = items;
export const recentVibegrationsChangelog = function recentVibegrationsChangelog(mobile) {
  closure_0 = mobile;
  const found = closure_0.filter((platforms) => {
...
export const allVibegrationsChangelog = function allVibegrationsChangelog(mobile) {
  closure_0 = mobile;
  return closure_0.filter((platforms) => {
    platforms = platforms.platforms;
    return platforms.includes(closure_0);
  });
};
