...
import VibegrationsModelLabels from "../lib/VibegrationsModelLabels.tsx";
  ...
  constructor(arg0) {
    ...
    obj13 = {
      ...
      onChange(arg0) {
        ...
        if (null != tmp3) {
          const result = VibegrationsEffortPresets.vibegrationsPresetTier(tmp3);
          ...
          closure_1_3(VibegrationsEffortPresets.vibegrationsSettingsForTier(tmp7));
          const tmpResult2 = VibegrationsEffortPresets;
        }
      },
      title: null,
    ...
    if (tmp2) {
      ...
      main = choices.main;
      obj17.children = main.map((label) =>
        React6(
          TableRadioRow.TableRadioRow,
          {
            label: label.label,
            subLabel: VibegrationsModelLabels.PROVIDER_LABELS[label.provider],
            value: label.id,
            disabled,
          },
          label.id,
