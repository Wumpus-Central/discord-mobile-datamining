...
export default function VibegrationsClarificationCard(clarification) {
  ...
  if (clarification.questions.length > 1) {
    ...
    tmp14 = closure_6(clarification(4825).Text, obj3);
  }
  const items4 = [tmp14, closure_6(clarification(4825).Text, { variant: "text-md/semibold", color: "text-default", children: clarification.questions[bound].question }), , ];
