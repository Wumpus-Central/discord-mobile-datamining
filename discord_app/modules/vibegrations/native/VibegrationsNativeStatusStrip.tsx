...
function ThinkingIndicator(line) {
  ...
  const obj2 = {
    style: tmp.label,
    children: closure_7(line(14401).AIShimmer, {
      ref,
      text,
      variant: "text-xs/medium",
      color: "text-subtle",
      duration: line(17041).INDICATOR_PASS_MS,
      delay: null,
    }),
  };
...
export default function VibegrationsNativeStatusStrip(projectId) {
  ...
  if (thinking) {
    ...
    tmp10Result = closure_7(tmp2(5334).PressableOpacity, obj4);
  }
  ...
  if (null != runesUsedLabelsResult) {
    ...
    tmp8Result = closure_8(tmp2(5334).PressableOpacity, obj8);
  }
  items1[2] = tmp8Result;
