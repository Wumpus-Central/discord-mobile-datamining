...
import VibegrationsNativeTurnTimerDefault from "VibegrationsNativeTurnTimer.tsx";
...
function ThinkingIndicator(line) {
  ...
  const obj2 = {
    style: tmp.label,
    children: closure_7(line(13940).AIShimmer, {
      ref,
      text,
      variant: "text-xs/medium",
      color: "text-subtle",
      duration: line(16388).INDICATOR_PASS_MS,
      delay: null,
    }),
  };
...
let obj2 = {
  row: {
    ...
    minHeight: nativeDefault.space.PX_4 + nativeDefault.space.PX_24,
  },
  activity: null,
  live: null,
  indicator: null,
...
export default function VibegrationsNativeStatusStrip(projectId) {
  ...
  const callback = noop.useCallback(() => {
    const obj2 = {
      content: React5(VibegrationsUsageSheetDefault, { projectId }),
  ...
  if (thinking) {
    ...
    tmp10Result = closure_7(tmp2(5435).PressableOpacity, obj5);
  }
  ...
  if (thinking) {
    ...
    if (null != turnStartedAt) {
      ...
      tmp10Result3 = closure_7(VibegrationsNativeTurnTimerDefault, obj8);
    }
  }
  ...
  if (null != connLabel) {
    ...
    tmp10Result4 = closure_7(tmp2(4832).Text, obj9);
  }
  ...
  if (null != runesUsedLabelsResult) {
    const obj10 = {
      ...
      accessibilityLabel: runesUsedLabelsResult.aria,
      hitSlop: 8,
      style: tmp.runes,
      onPress: callback,
      children: null,
