...
export default function VibegrationsCreateSheet(guildId) {
  ...
  closure_16 = obj.useCallback((wizard) => {
    if (null == wizard.wizard) {
      ...
      const obj4 = {
        template: wizard,
        guildId,
        modelSettings: VIBEGRATIONS_DEFAULT_TIER_SETTINGS,
        onCreated: callback3,
      };
  ...
  obj14.children = require("VibegrationsEffortTiers").vibegrationsTierDescription(
    VIBEGRATIONS_DEFAULT_TIER_SETTINGS.tier,
  );
