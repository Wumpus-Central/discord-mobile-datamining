...
import VibegrationsTemplates from "../VibegrationsTemplates.tsx";
...
export default function VibegrationsCreateSheet(guildId) {
  ...
  const tmp7 = _slicedToArray(
    first1.useState(require("VibegrationsEffortPresets").VIBEGRATIONS_DEFAULT_MODEL_SETTINGS),
    2,
  );
  first1 = tmp7[0];
            ...
            if (2 === tmp9) {
              ...
              if (4 === tmp9) {
                ...
                if (arg0 === 1) {
                  ...
                  c5 = 1;
                  const obj15 = {
                    value: guildId(tmp86[12]).sendVibegrationsArchiveImport(
                      closure_128_2,
                      closure_128_0,
                      intl3.string(tmp4(tmp86[14]).KjEtrZ),
                    ),
                    done: false,
                  };
                  return obj15;
  ...
  const callback2 = first1.useCallback(() => {
    const obj2 = {
      key: VibegrationsEffortPicker.VIBEGRATIONS_EFFORT_PICKER_SHEET_KEY,
      stackingBehavior: "stack",
      content: closure_2_10(VibegrationsEffortPicker.VibegrationsEffortPickerSheet, {
        initialSettings: first1,
        choices,
        onChange,
      }),
    };
  ...
  closure_16 = first1.useCallback((wizard) => {
    if (null == wizard.wizard) {
      ...
      const obj3 = {
        key: VibegrationsTemplateWizardSheet.VIBEGRATIONS_TEMPLATE_WIZARD_SHEET_KEY,
        stackingBehavior: "stack",
        content: null,
      };
  ...
  const obj9 = {
    label: stringResult,
    trailing: callback(require("Text/Text").Text, {
