...
export default function VibegrationsNativeComposer(projectId) {
  ...
  const tmp5 = _slicedToArray(onChange.useState(projectId), 2);
  if (tmp5[0] !== projectId) {
    tmp5[1](projectId);
  ...
  _require = str(function* (arg0, arg1, arg2, arg3) {
    closure_5 = tmp3;
      ...
      const mapped = arr2.map((name) => {
        ...
        if (tmp) {
          ...
          obj3.size = obj4.formatVibegrationsAttachmentLimit(
            closure_0(onSend[12]).vibegrationsAttachmentLimit(name.contentType),
          );
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              const obj5 = {
                mediaType: "any",
                selectionLimit: tmp2(7352).VIBEGRATIONS_MAX_ATTACHMENTS_PER_MESSAGE,
                skipProcessing: true,
              };
              dependencyMap = 1;
              c3 = 1;
  ...
  if (arr2.length > 0) {
    let obj4 = {
      ...
      children: arr2.map((children) => {
        ...
        const items1 = [
          closure_11(localId(onSend[16]).Text, {
        ...
        if (null != children.errorText) {
          ...
          tmp10Result = closure_11(tmp11(onSend[16]).Text, obj6);
        }
        ...
        const intl2 = tmp11(onSend[10]).intl;
  ...
  const obj8 = {
    ...
    style: tmp18.input,
    inputTextStyle: tmp18.inputText,
  ...
  if (running) {
    const obj9 = {
      style: tmp18.trailingButton,
      IconComponent: tmp43(tmp44[23]).StopIcon,
      onPress: onInterrupt,
  ...
  const obj10 = {
    active: true,
    style: tmp18.trailingButton,
    activeStyle: tmp18.sendButtonActive,
    activeIconStyle: tmp18.sendIconActive,
    IconComponent: null,
    accessibilityLabel: null,
    onPress: null,
    disabled: null,
