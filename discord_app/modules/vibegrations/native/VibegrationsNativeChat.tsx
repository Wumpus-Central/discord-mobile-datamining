...
function ProposalCard(proposal) {
  ...
  obj.children = intl.string(_modDef3560["60htw+"]);
  const items1 = [closure_1_14(Text_Text.Text, obj), , , , , ];
  if ("" === trimmed) {
    const intl2 = util.intl;
    let stringResult = intl2.string(_modDef3560.IHCafX);
  } else {
  ...
  if (proposal.changes.length > 0) {
    ...
    obj1.children = intl3.string(_modDef3560.KLyB8Y);
  ...
  if (bot_permissions.length > 0) {
    ...
    obj3.children = intl4.string(_modDef3560.ieqTtP);
  ...
  if (privileged_intents.length > 0) {
    ...
    obj6.children = intl5.string(_modDef3560.Cn9qix);
  ...
  if (actionable) {
    ...
    obj8.text = intl6.string(_modDef3560.GYoWRk);
...
function IdeaCards(arg0) {
  ...
  let intl = util.intl;
  obj.children = intl.string(_modDef3560.DAvYsi);
  let items = [
    ...
    ideas.map((title) => {
      ...
      obj.accessibilityLabel = intl.formatToPlainString(_modDef3560.pztRGi, obj);
  ...
  return closure_14(closure_5, {
    ...
    children: attachments.map((id, index) => {
      if (null != id.id) {
        ...
        obj = { name: id.name };
        obj.accessibilityLabel = intl.formatToPlainString(closure_1(3560).QUFLUq, obj);
        obj = { variant: "text-xs/medium", color: "text-default", children: id.name };
        obj.children = closure_1_14(projectId(4570).Text, obj);
        ...
        obj2.children = intl2.formatToPlainString(closure_1(3560).OBr7WW, obj3);
        obj1.children = closure_1_14(projectId(4570).Text, obj2);
...
function IdeasOffer(onAsk) {
  ...
  const intl = util.intl;
  obj.children = intl.string(_modDef3560.tG5PBo);
  ...
  const intl2 = util.intl;
  obj1.text = intl2.string(_modDef3560.cwTe5o);
  ...
  if (0 !== tree.steps.length) {
    ...
    items1[1] = tasks.map((task) => {
      ...
      if (null != task.labelText) {
        ...
        const _HermesInternal = HermesInternal;
        obj.children = "\u203A " + labelText + " \u2014 " + require("VibegrationsTimelineTree").describeTaskStatus(task.task.status);
        return closure_1_14(tmp4, obj, task.taskId);
      }
      const intl = require("util").intl;
      labelText = intl.string(_modDef3560.MdXWEK);
    });
    obj.children = items1;
...
function TodoList(todos) {
  ...
  obj.children = intl.formatToPlainString(_modDef3560.bQvqly, obj);
  let items = [
...
let obj2 = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_SUBTLE, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.md, padding: nativeDefault.space.PX_12 };
...
let obj10 = { flexDirection: "row", flexWrap: "wrap", gap: nativeDefault.space.PX_4, marginTop: nativeDefault.space.PX_4 };
...
let obj11 = { backgroundColor: nativeDefault.colors.BACKGROUND_MOD_SUBTLE, borderRadius: nativeDefault.radii.round, paddingHorizontal: nativeDefault.space.PX_8, paddingVertical: nativeDefault.space.PX_4 };
...
let obj12 = { flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8, marginTop: nativeDefault.space.PX_8 };
...
let obj13 = { flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8, paddingHorizontal: nativeDefault.space.PX_16, paddingVertical: nativeDefault.space.PX_4 };
...
let obj14 = { flexDirection: "row", alignItems: "center", gap: nativeDefault.space.PX_8, paddingVertical: nativeDefault.space.PX_4 };
...
let closure_25 = noop.memo((isNewest) => {
  ...
  if ("user" === message.role) {
    if ("" !== trimmed) {
      ...
      if ("" !== trimmed) {
        ...
        tmp51Result = closure_14(message(4570).Text, obj1);
      }
  ...
  ,
    ...
    items7[2] = memo2.map((content) => {
      let obj = { style: closure_1.surface, children: null };
      obj = { variant: "text-md/normal", color: "text-default", children: MarkupUtilsDefault.parse(content.content, true, closure_16) };
      obj.children = closure_2_14(Text_Text.Text, obj);
    ...
    if (null == proposal) {
      ...
      if ("" !== trimmed) {
        ...
        if (!tmp14) {
          ...
          obj4.children = closure_14(message(4570).Text, obj5);
    ...
    if (null != found) {
      ...
      if ("message" in found) {
        ...
        tmp19Result8 = closure_14(message(4570).Text, obj15);
      }
    }
...
export default function VibegrationsNativeChat(projectId) {
  ...
  const stateFromStores4 = obj5.useStateFromStores(items8, () => VibegrationsConnectionStore.getConnState(projectId), items9);
  render_id = null;
  ...
  if (!stateFromStores2) {
    ...
    const obj7 = { variant: "text-sm/medium", color: "text-subtle", children: intl4.string(stateFromStores3 ? tmp18Result["0vH/5G"] : tmp18Result.QDGuNS) };
