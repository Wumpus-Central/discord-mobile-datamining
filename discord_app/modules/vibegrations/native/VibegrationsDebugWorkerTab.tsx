  ...
  if (bot.ever_started) {
    ...
    if (null != bot.last_close_code) {
      if (null != bot.last_close_at) {
        ...
        formatToPlainStringResult = intl6.formatToPlainString(_modDef3678.bSzLue, obj10);
    ...
    if (bot.dispatch_errors > 0) {
      ...
      obj11.label = intl7.string(_modDef3678.N4l504);
...
function OutboundEnvBlock(metrics) {
  ...
  if (null != metrics.last_failure) {
    ...
    let formatToPlainStringResult = intl3.formatToPlainString(_modDef3678["0ayoy+"], obj6);
    const tmp3Result = VibegrationsDebugFormat;
  } else {
    const intl2 = util.intl;
    const obj7 = { time: VibegrationsDebugFormat.formatObservedAt(metrics.since) };
    formatToPlainStringResult = intl2.formatToPlainString(_modDef3678["1PdrB1"], obj7);
...
function RuntimeEnvBlock(env) {
  ...
  items[1] = schedules.map((id) => {
    ...
    if (null != id.pending_state) {
      ...
      let formatToPlainStringResult = intl3.formatToPlainString(_modDef3678.P8lBrO, obj3);
    } else if (null != id.next_run_at) {
      const intl2 = util.intl;
      const obj4 = { time: VibegrationsDebugFormat.formatObservedAt(id.next_run_at) };
      formatToPlainStringResult = intl2.formatToPlainString(_modDef3678["7ecbr3"], obj4);
  ...
  if (null != metrics) {
    if (0 !== metrics.requests) {
      ...
      if (metrics.cpu_ms_total > 0) {
        ...
        const intl4 = util.intl;
        obj7.label = intl4.string(_modDef3678["V/nNbs"]);
        ...
        const intl5 = util.intl;
        obj8.label = intl5.string(_modDef3678["+rYPHD"]);
        ...
        obj8.hint = intl6.formatToPlainString(_modDef3678["+LxC7W"], obj9);
        ...
        const obj = { label: null, value: null, hint: null };
        const intl = util.intl;
        obj.label = intl.string(_modDef3678["V/nNbs"]);
        const intl2 = util.intl;
        obj.value = intl2.string(_modDef3678.YKWIxp);
        const intl3 = util.intl;
        obj.hint = intl3.string(_modDef3678["8GAiDk"]);
      ...
      if (metrics.cpu_ms_total <= 0) {
        ...
        if (metrics.wall_ms_total > 0) {
          ...
          const intl7 = util.intl;
          obj10.label = intl7.string(_modDef3678.ueEMPa);
      ...
      if (metrics.exceeded_cpu > 0) {
        ...
        obj11.label = intl8.string(_modDef3678.vM2krr);
      ...
      if (null != metrics.build) {
        ...
        obj14.label = intl11.string(_modDef3678.JUZs7g);
  ...
  obj6.children = items1.map((item) => {
    ...
    if (null == metrics) {
      ...
      if (null != metrics.db_bytes) {
        ...
        obj6.label = intl.formatToPlainString(_modDef3678["0OIswI"], obj7);
...
export default function VibegrationsDebugWorkerTab(status) {
  ...
  if (null != status) {
    ...
    if (null != status.bot) {
      ...
      const intl3 = util.intl;
      obj5.title = intl3.string(_modDef3678.rx1pBg);
    ...
    if (null != status.outbound) {
      ...
      const intl4 = util.intl;
      obj6.title = intl4.string(_modDef3678["t2+yv/"]);
    ...
    if (null != status.runtime) {
      ...
      const intl5 = util.intl;
      obj7.title = intl5.string(_modDef3678.QifItp);
    ...
    if (null != status.ai) {
      ...
      const intl6 = util.intl;
      obj8.title = intl6.string(_modDef3678.SWKshl);
