...
function EnvSection(title) {
  ...
  if (items.length <= 0) {
    ...
    obj4.children = intl.string(_modDef3714.W4hcKL);
...
function BotEnvBlock(arg0) {
  ...
  if (bot.ever_started) {
    ...
    obj3.label = intl2.formatToPlainString(_modDef3714.f8ix3w, obj4);
    ...
    obj7.label = intl3.string(_modDef3714["0AB7l3"]);
    ...
    obj8.label = intl4.string(_modDef3714.ElaQ0A);
    ...
    obj9.label = intl5.string(_modDef3714.SJtBTN);
    ...
    if (null != bot.last_close_code) {
      if (null != bot.last_close_at) {
        ...
        formatToPlainStringResult = intl6.formatToPlainString(_modDef3714.bSzLue, obj10);
    ...
    if (bot.dispatch_errors > 0) {
      ...
      obj11.label = intl7.string(_modDef3714.N4l504);
    ...
    const intl = util.intl;
    obj.value = intl.string(_modDef3714.C6xjtD);
...
function OutboundEnvBlock(metrics) {
  ...
  obj.value = intl.formatToPlainString(_modDef3714.Yur5Zm, obj3);
  ...
  if (null != metrics.last_failure) {
    ...
    let formatToPlainStringResult = intl3.formatToPlainString(_modDef3714["0ayoy+"], obj6);
    const tmp3Result = VibegrationsDebugFormat;
  } else {
    const intl2 = util.intl;
    const obj7 = { time: VibegrationsDebugFormat.formatObservedAt(metrics.since) };
    formatToPlainStringResult = intl2.formatToPlainString(_modDef3714["1PdrB1"], obj7);
...
function RuntimeEnvBlock(env) {
  ...
  items[1] = schedules.map((id) => {
    ...
    const intl = util.intl;
    obj.label = intl.formatToPlainString(_modDef3714.NQxkhU, { id: id.id });
    ...
    if (null != id.pending_state) {
      ...
      let formatToPlainStringResult = intl3.formatToPlainString(_modDef3714.P8lBrO, obj3);
    } else if (null != id.next_run_at) {
      const intl2 = util.intl;
      const obj4 = { time: VibegrationsDebugFormat.formatObservedAt(id.next_run_at) };
      formatToPlainStringResult = intl2.formatToPlainString(_modDef3714["7ecbr3"], obj4);
...
function AiEnvBlock(metrics) {
  ...
  obj.value = intl.formatToPlainString(_modDef3714.voXL2a, obj3);
...
function EnvMetricsSection(arg0) {
  ...
  if (null != metrics) {
    if (0 !== metrics.requests) {
      ...
      obj3.label = intl13.string(_modDef3714.KOnL3g);
      ...
      obj3.hint = intl14.formatToPlainString(_modDef3714["1PdrB1"], obj4);
      const items = [hasOwnProperty(VibegrationsDebugPrimitives.DebugStatRow, obj3), , , , , ,];
      const obj5 = { label: null, value: null, critical: null };
      const intl15 = util.intl;
      obj5.label = intl15.string(_modDef3714.CjPhyY);
      ...
      if (metrics.cpu_ms_total > 0) {
        ...
        const intl4 = util.intl;
        obj7.label = intl4.string(_modDef3714["V/nNbs"]);
        ...
        const intl5 = util.intl;
        obj8.label = intl5.string(_modDef3714["+rYPHD"]);
        ...
        obj8.hint = intl6.formatToPlainString(_modDef3714["+LxC7W"], obj9);
        ...
        const obj = { label: null, value: null, hint: null };
        const intl = util.intl;
        obj.label = intl.string(_modDef3714["V/nNbs"]);
        const intl2 = util.intl;
        obj.value = intl2.string(_modDef3714.YKWIxp);
        const intl3 = util.intl;
        obj.hint = intl3.string(_modDef3714["8GAiDk"]);
      ...
      if (metrics.cpu_ms_total <= 0) {
        ...
        if (metrics.wall_ms_total > 0) {
          ...
          const intl7 = util.intl;
          obj10.label = intl7.string(_modDef3714.ueEMPa);
      ...
      if (metrics.exceeded_cpu > 0) {
        ...
        obj11.label = intl8.string(_modDef3714.vM2krr);
      ...
      obj12.label = intl9.string(_modDef3714.g1O88C);
      ...
      obj12.hint = intl10.formatToPlainString(_modDef3714["5iALNP"], obj13);
      ...
      if (null != metrics.build) {
        ...
        obj14.label = intl11.string(_modDef3714.JUZs7g);
  ...
  obj16.children = intl12.string(_modDef3714["v/fbnv"]);
...
function StorageSection(status) {
  ...
  if (storage.shared_data) {
    ...
    obj3.label = intl.string(_modDef3714.Vrh0rD);
    obj3.metrics = stable;
    let items = [obj3];
    let tmp4 = limits;
    let items1 = items;
  ...
  obj6.title = intl2.string(_modDef3714.i91625);
  obj6.children = items1.map((item) => {
    ...
    if (null == metrics) {
      ...
      obj4.label = intl2.formatToPlainString(_modDef3714["9TpIQg"], obj5);
      obj4.value = VibegrationsDebugFormat.formatBytes(metrics.r2_bytes);
      const intl3 = util.intl;
      const tmp32 = _modDef3714;
      ...
      if (null != metrics.db_bytes) {
        ...
        obj6.label = intl.formatToPlainString(_modDef3714["0OIswI"], obj7);
...
export default function VibegrationsDebugWorkerTab(status) {
  ...
  if (null != status) {
    ...
    const intl = util.intl;
    obj2.title = intl.string(_modDef3714["+dpDma"]);
    ...
    const intl2 = util.intl;
    obj3.title = intl2.string(_modDef3714.NQHyed);
    ...
    if (null != status.bot) {
      ...
      const intl3 = util.intl;
      obj5.title = intl3.string(_modDef3714.rx1pBg);
    ...
    if (null != status.outbound) {
      ...
      const intl4 = util.intl;
      obj6.title = intl4.string(_modDef3714["t2+yv/"]);
    ...
    if (null != status.runtime) {
      ...
      const intl5 = util.intl;
      obj7.title = intl5.string(_modDef3714.QifItp);
    ...
    if (null != status.ai) {
      ...
      const intl6 = util.intl;
      obj8.title = intl6.string(_modDef3714.SWKshl);
    ...
    const intl7 = util.intl;
    obj10.title = intl7.string(_modDef3714["HHe+8E"]);
