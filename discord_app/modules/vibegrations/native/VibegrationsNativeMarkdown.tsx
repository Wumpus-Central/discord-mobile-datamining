// discord_app/modules/vibegrations/native/VibegrationsNativeMarkdown.tsx
      ...
      children: memo.map((kind, index) => {
        if ("text" === kind.kind) {
          ...
          obj.children = items.map((children, index) => {
            ...
            const obj3 = {
              style: list.marker,
              children: closure_2_5(source(4823).Text, {
                variant: "text-md/normal",
                color: "text-default",
            ...
            const obj6 = {
              variant: "text-md/normal",
              color: "text-default",
              children: closure_1(4817).parse(children.text, true, obj2),
            };
