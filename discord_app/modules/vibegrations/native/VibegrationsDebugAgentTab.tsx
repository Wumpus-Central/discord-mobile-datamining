...
export default function VibegrationsDebugAgentTab(projectId) {
  ...
  const items12 = [
    closure_7(tmp2(17140).DebugSnapshotToolbar, { generatedAt: generated_at, fetchState, onRefresh }),
    ,
    ,
    ,
    ,
  ...
  if (null == lifetime) {
    ...
    obj8.children = intl3.string(traceVisible(3712).gPabB9);
    let tmp16Result5 = closure_7(tmp2(17140).DebugNote, obj8);
  } else {
    const obj9 = { label: null, value: null, hint: null };
    const intl35 = tmp2(1115).intl;
    obj9.label = intl35.string(traceVisible(3712)["8MSJDH"]);
    ...
    obj9.hint = intl36.formatToPlainString(traceVisible(3712)["6Z2KhK"], obj10);
    const items13 = [closure_7(tmp2(17140).DebugStatRow, obj9), , , ,];
    const intl37 = tmp2(1115).intl;
    const orchestrator = lifetime.orchestrator;
    const tmp2Result45 = tmp2(17137);
    const obj11 = { label: intl37.string(traceVisible(3712).hk4jJr), value: null, hint: null };
    const intl38 = tmp2(1115).intl;
    const obj12 = { count: null };
    const stringResult = intl37.string(traceVisible(3712).hk4jJr);
    const tmp2Result46 = tmp2(17137);
    obj12.count = tmp2Result46.formatCount(tmp2(5361).runeCount(orchestrator));
    obj11.value = intl38.formatToPlainString(traceVisible(3712).U98VaN, obj12);
    ...
    obj11.hint =
      ...
      formatCountResult1 +
      " out \u00B7 " +
      tmp2(17137).formatCount(orchestrator.cache_read_input_tokens) +
      " cache read";
    items13[1] = closure_7(tmp2(17140).DebugStatRow, obj11);
    const intl39 = tmp2(1115).intl;
    const codegen = lifetime.codegen;
    const tmp2Result50 = tmp2(17137);
    const obj13 = { label: intl39.string(traceVisible(3712).R9aduM), value: null, hint: null };
    const intl40 = tmp2(1115).intl;
    const obj14 = { count: null };
    const stringResult1 = intl39.string(traceVisible(3712).R9aduM);
    const tmp2Result51 = tmp2(17137);
    obj14.count = tmp2Result51.formatCount(tmp2(5361).runeCount(codegen));
    obj13.value = intl40.formatToPlainString(traceVisible(3712).U98VaN, obj14);
    ...
    obj13.hint =
      ...
      formatCountResult3 +
      " out \u00B7 " +
      tmp2(17137).formatCount(codegen.cache_read_input_tokens) +
      " cache read";
    items13[2] = closure_7(tmp2(17140).DebugStatRow, obj13);
    const intl41 = tmp2(1115).intl;
    const tmp2Result55 = tmp2(17137);
    const stringResult2 = intl41.string(traceVisible(3712).Tj6b30);
    ...
    obj15.value = intl42.formatToPlainString(traceVisible(3712).U98VaN, obj16);
    ...
    obj15.hint =
      ...
      formatCountResult5 +
      " out \u00B7 " +
      tmp2(17137).formatCount(usageOrEmptyResult.cache_read_input_tokens) +
      " cache read";
    items13[3] = closure_7(tmp2(17140).DebugStatRow, obj15);
    let outcomes;
    if (status != null) {
    ...
    if (null != outcomes) {
      ...
      if (Object.keys(status.agent.outcomes).length > 0) {
        ...
        obj17.label = intl2.string(traceVisible(3712).Q2OlgI);
        ...
        tmp18Result9 = closure_7(tmp2(17140).DebugStatRow, obj17);
      }
    }
  ...
  if (null == stateFromStores) {
    ...
    obj20.children = intl5.string(traceVisible(3712).uyPveL);
    let tmp18Result10 = closure_7(tmp2(17140).DebugNote, obj20);
  } else {
    const intl43 = tmp2(1115).intl;
    const total = stateFromStores.total;
    const obj21 = { label: intl43.string(traceVisible(3712)["VwF+oY"]), value: null, hint: null };
    const intl44 = tmp2(1115).intl;
    const obj22 = { count: null };
    const stringResult3 = intl43.string(traceVisible(3712)["VwF+oY"]);
    const tmp2Result62 = tmp2(17137);
    obj22.count = tmp2Result62.formatCount(tmp2(5361).runeCount(total));
    obj21.value = intl44.formatToPlainString(traceVisible(3712).U98VaN, obj22);
    ...
    obj21.hint =
      ...
      formatCountResult7 +
      " out \u00B7 " +
      tmp2(17137).formatCount(total.cache_read_input_tokens) +
      " cache read";
    const items14 = [closure_7(tmp2(17140).DebugStatRow, obj21)];
    const obj23 = { label: null, value: null };
    const intl45 = tmp2(1115).intl;
    obj23.label = intl45.string(traceVisible(3712)["kILb+R"]);
    ...
    items14[1] = closure_7(tmp2(17140).DebugStatRow, obj23);
  ...
  if (null != stateFromStores1) {
    if (null != promptCeiling) {
      ...
      obj28.hint = intl11.formatToPlainString(traceVisible(3712).jA05ru, obj29);
      items15[1] = closure_7(tmp2(17140).DebugStatRow, obj28);
    ...
    if (null != stateFromStores2) {
      ...
      obj30.label = intl12.string(traceVisible(3712)["se+2ls"]);
      ...
      obj30.hint = intl13.formatToPlainString(traceVisible(3712).KHK44U, obj31);
      tmp18Result11 = closure_7(tmp2(17140).DebugStatRow, obj30);
    ...
    obj33.text = intl14.string(traceVisible(3712).B0KV7p);
    obj33.disabled = "pending" === stateFromStores3;
    obj33.onPress = callback;
    const items17 = [closure_7(tmp2(5271).Button, obj33), ,];
    let str9 = "text-muted";
    if (null != tmp15) {
      str9 = "text-muted";
    ...
    const obj34 = {
      ...
      color: str9,
      children: tmp2(17138).forceCompactionStatus(stateFromStores3),
    };
    items17[1] = closure_7(tmp2(4823).Text, obj34);
    let pendingTurn;
    if (tmp15 != null) {
    ...
    if (true === pendingTurn) {
      ...
      obj36.text = intl46.string(traceVisible(3712)["044+ju"]);
      obj36.onPress = callback1;
      const items18 = [closure_7(tmp2(5271).Button, obj36)];
      const obj37 = { variant: "text-xs/normal", color: "text-muted", children: null };
      const intl47 = tmp2(1115).intl;
      obj37.children = intl47.string(traceVisible(3712)["8D32H6"]);
      items18[1] = closure_7(tmp2(4823).Text, obj37);
    ...
    if (traceVisible) {
      ...
      if (null != session) {
        ...
        if (null != analytics) {
          ...
          tmp18Result13 = closure_7(tmp2(17151).VibegrationsDebugAgentAnalyticsRows, obj44);
        }
        items20[1] = tmp18Result13;
        obj38.children = items20;
        let tmp16Result8 = closure_8(tmp2(17140).DebugSection, obj38);
      } else {
        let analytics1;
        if (status != null) {
      ...
      if (null != limits) {
        ...
        obj48.value = intl29.formatToPlainString(traceVisible(3712).U98VaN, obj49);
        items21[2] = closure_7(tmp2(17140).DebugStatRow, obj48);
        const obj50 = { label: null, value: null };
        const intl30 = tmp2(1115).intl;
        obj50.label = intl30.string(traceVisible(3712).iEAvzu);
      ...
      obj55.title = intl15.string(traceVisible(3712).F5eP7e);
      if (0 === stateFromStores4.length) {
        const obj56 = { children: null };
        const intl17 = tmp2(1115).intl;
        obj56.children = intl17.string(traceVisible(3712).j8NMgl);
        let tmp18Result14 = closure_7(tmp2(17140).DebugNote, obj56);
      } else {
        ...
        if (stateFromStores4.length > tmp2(17138).MAX_MODEL_CALL_ROWS) {
          ...
          obj57.children = intl16.formatToPlainString(traceVisible(3712)["3hYhpp"], obj58);
          tmp18Result15 = closure_7(tmp2(4823).Text, obj57);
        }
      ...
      closure_7(tmp2(17140).DebugSection, obj55);
    }
  ...
  if (null != promptCeiling) {
    ...
    let formatToPlainStringResult = intl8.formatToPlainString(traceVisible(3712).LKGmsP, obj60);
    const tmp2Result86 = tmp2(17137);
  } else {
    const intl7 = tmp2(1115).intl;
    formatToPlainStringResult = intl7.string(traceVisible(3712).gPabB9);
  }
  tmp18Result17 = closure_7(tmp2(17140).DebugNote, { children: formatToPlainStringResult });
