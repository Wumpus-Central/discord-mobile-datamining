...
export default function VibegrationsTemplateWizardSheet(template) {
  ...
  const stateFromStores = template(504).useStateFromStores(items, () =>
    template(17037).vibegrationsTemplateWizardGuilds(first.getGuildsArray(), "VibegrationsTemplateWizardSheet"),
  );
  ...
  const obj7 = {
    ...
    onDismiss: callback,
    header: tmp31(template(7482).BottomSheetTitleHeader, { title: name }),
    children: null,
  };
  ...
  const tmp2Result8 = template(17037);
}
