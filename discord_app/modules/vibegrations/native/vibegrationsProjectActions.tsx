...
export const vibegrationsProjectActions = function vibegrationsProjectActions(project) {
  ...
  if (tmp) {
    ...
    obj3.label = intl3.string(_modDef3591.lf8HqE);
  ...
  if (null != onConnectTool) {
    ...
    obj4.label = intl4.string(_modDef3591["3qelzD"]);
  ...
  if (null != onVersionHistory) {
    ...
    obj5.label = intl5.string(_modDef3591.jAWwzi);
  ...
  if (null != onRestorePoints) {
    ...
    obj6.label = intl6.string(_modDef3591.FRjicO);
  ...
  if (tmp16) {
    ...
    obj9.label = intl9.string(_modDef3591["xhcY+n"]);
