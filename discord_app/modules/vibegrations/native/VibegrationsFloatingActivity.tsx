// === Module 17125: VibegrationsFloatingActivity ===
...
export default function VibegrationsFloatingActivity(arg0) {
  ...
  const animatedStyle = sharedValue(4559).useAnimatedStyle(S);
  ...
  if (tmp8) {
    ...
    if (null != todos) {
      ...
      obj4.children = closure_6(tmp11(17109), obj5);
  ...
  obj7.accessibilityLabel = intl.formatToPlainString(_modDef3712.Sk4CzQ, { activity: line });
  obj7.onPress = onJumpToActivity;
  const tmp7 = _slicedToArray(noop.useState(false), 2);
  const items3 = [closure_6(sharedValue(10493).MagicWandIcon, { size: "xs", color: nativeDefault.colors.TEXT_BRAND }), ];
  const obj8 = { size: "xs", color: nativeDefault.colors.TEXT_BRAND };
  items3[1] = closure_6(View, { style: tmp.label, children: closure_6(sharedValue(4823).Text, { variant: "text-sm/medium", color: "text-default", lineClamp: 1, children: line }) });
  obj7.children = items3;
  const items4 = [closure_7(sharedValue(5425).PressableOpacity, obj7), ];
  if (null == todos) {
    items4[1] = null;
    ...
    obj10.accessibilityLabel = intl2.string(tmp11(3712).OZIOl8);
    obj10.onPress = callback;
    let colors = tmp11(576).colors;
    const obj12 = { size: "xs", color: tmp8 ? colors.TEXT_BRAND : colors.TEXT_MUTED };
    colors = closure_6(tmp2(5841).ClipboardListIcon, obj12);
    obj10.children = colors;
    closure_6(tmp2(5425).PressableOpacity, obj10);
  }
  const obj9 = { style: tmp.label, children: closure_6(sharedValue(4823).Text, { variant: "text-sm/medium", color: "text-default", lineClamp: 1, children: line }) };
};