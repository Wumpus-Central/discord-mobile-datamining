...
export default function VibegrationsFloatingActivity(arg0) {
  ...
  if (null == todos) {
    ...
    colors = closure_6(tmp2(5624).ClipboardListIcon, obj12);
    obj10.children = colors;
    closure_6(tmp2(5208).PressableOpacity, obj10);
  }
  const obj9 = { style: tmp.label, children: closure_6(sharedValue(4634).Text, { variant: "text-sm/medium", color: "text-default", lineClamp: 1, children: line }) };
};