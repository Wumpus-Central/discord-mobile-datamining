...
export default function VibegrationsModelSettingsSheet(projectId) {
  ...
  if (null == stateFromStores) {
    ...
    const stringResult = intl2.string(require("module_3547")["9FRudW"]);
    const intl3 = tmp(tmp2[6]).intl;
    const stringResult1 = intl3.string(require("module_3547")["4AsQHS"]);
    obj = { scrollable: true, header: null, children: null };
    obj = { title: null };
    const intl4 = tmp(tmp2[6]).intl;
    obj.title = intl4.string(require("module_3547")["2NWMqY"]);
    ...
    obj7.children = intl.string(require("module_3547").ICU5aW);
