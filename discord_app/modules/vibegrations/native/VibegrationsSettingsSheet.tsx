...
function SettingsTabStrip(tabs) {
  ...
  if (tabs.length > 3) {
    ...
    let tmp8Result = closure_10(tmp5(12962).Tabs, obj4);
  } else {
    const obj5 = { state: segmentedControlState };
    tmp8Result = closure_10(tmp5(9975).SegmentedControl, obj5);
  }
...
export default function VibegrationsSettingsSheet(projectId) {
  ...
  obj5.header = found(projectId(7482).BottomSheetTitleHeader, {
  ...
  const tmp24 = loaded;
  items9[6] = found(projectId(5273).Button, {
