...
export default function VibegrationsVersionHistorySheet(projectId) {
  ...
  if ("loading" === tmp5.status) {
    ...
    obj.children = entries.map((subject) => {
      ...
      return jsx(
        projectId(_undefined[15]).TableRow,
        { label: subject.subject.replace(/^Build: /, ""), subLabel: null, arrow: true, onPress: null },
        subject.sha,
      );
    });
  ...
  obj7.children = tmp7(projectId(6040).BottomSheetScrollView, {
