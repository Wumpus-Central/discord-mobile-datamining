...
function ProjectRow(project) {
  ...
  obj4.icon = icon;
  obj3.icon = __initData(timestampProducer, {
...
function ProjectList(guildId) {
  ...
  const stateFromStoresArray = guildId(navigation[22]).useStateFromStoresArray(
    items,
  ...
  const stateFromStoresArray1 = guildId(navigation[22]).useStateFromStoresArray(
    items1,
  ...
  const stateFromStores = guildId(navigation[22]).useStateFromStores(
    items3,
  ...
  const memo = stateFromStoresArray1.useMemo(() => {
    const found = stateFromStoresArray.filter((item) =>
      guildId(navigation[23]).isVibegrationsProjectInGuild(item, closure_1_0),
    );
  ...
  const callback1 = stateFromStoresArray1.useCallback(() => {
    const obj2 = {
      ...
      content: __initData(VibegrationsCreateSheetDefault, { guildId, onCreated }),
    };
  ...
  if (tmp12) {
    ...
    if (result.length > 0) {
      ...
      const items10 = [closure_21(tmp4(tmp2[29]).Text, obj12)];
      ...
      items10[1] = closure_21(tmp4(tmp2[29]).Text, obj13);
      obj11.children = items10;
      const items11 = [closure_22(closure_8, obj11)];
      const obj14 = {
        ...
        children: result.map((children) => {
          ...
          items[1] = combined;
          const items1 = [
            __initData2(Text_Text.Text, { variant: "text-xs/bold", color: "text-muted", children: items }),
            __initData(Text_Text.Text, { variant: "text-sm/normal", color: "text-subtle", children: children.summary }),
          ];
          obj.children = items1;
          return __initData2(React6, obj, "" + children.date + "-" + children.summary);
        }),
      };
      items11[1] = closure_21(closure_8, obj14);
      obj10.children = items11;
      tmp21Result = closure_22(closure_8, obj10);
    }
    ...
    if (memo.length > 0) {
      ...
      const items13 = [closure_21(tmp4(tmp2[29]).Text, obj17)];
      ...
      items13[1] = closure_21(tmp4(tmp2[29]).Text, obj18);
      obj16.children = items13;
      const items14 = [closure_22(closure_8, obj16)];
      const obj19 = {
        hasIcons: true,
      ...
      items14[1] = closure_21(tmp4(tmp2[34]).TableRowGroup, obj19);
      obj15.children = items14;
      tmp21Result3 = closure_22(closure_8, obj15);
    }
    ...
    if (memo1.length > 0) {
      ...
      const items15 = [closure_21(tmp4(tmp2[29]).Text, obj22)];
      ...
      items15[1] = closure_21(tmp4(tmp2[29]).Text, obj23);
      obj21.children = items15;
      const items16 = [closure_22(closure_8, obj21)];
      const obj24 = {
        hasIcons: true,
      ...
      items16[1] = closure_21(tmp4(tmp2[34]).TableRowGroup, obj24);
      obj20.children = items16;
      tmp21Result4 = closure_22(closure_8, obj20);
    }
    ...
    if (null != stateFromStores) {
      if ("loading" !== stateFromStores.type) {
        if ("error" === stateFromStores.type) {
          ...
          const items17 = [closure_21(tmp4(tmp2[29]).Text, obj27)];
          ...
          items17[1] = closure_21(tmp4(tmp2[30]).Button, obj28);
          obj26.children = items17;
          let tmp13Result2 = closure_22(closure_8, obj26);
        } else {
          ...
          const items18 = [closure_21(tmp4(tmp2[29]).Text, obj30)];
          ...
          items18[1] = closure_21(tmp4(tmp2[30]).Button, obj31);
          obj29.children = items18;
          tmp13Result2 = closure_22(closure_8, obj29);
        }
      }
      obj25.children = tmp13Result2;
      closure_21(closure_8, obj25);
    }
    tmp13Result2 = closure_21(onCreated, {});
  }
  const obj5 = guildId(navigation[28]);
  tmp12 = memo.length > 0 || memo1.length > 0;
}
function ChatScene(guildId) {
  ...
  const stateFromStoresObject = guildId(navigation[22]).useStateFromStoresObject(
    items,
    () => {
  ...
  const stateFromStores1 = guildId(navigation[22]).useStateFromStores(
    items5,
  ...
  const stateFromStores2 = guildId(navigation[22]).useStateFromStores(
    items7,
  ...
  const tmp15 =
    null != previewAppId && stateFromStores && null != previewAppId && null != projectId(navigation[37])(previewAppId);
  closure_12 = tmp15;
          ...
          if (integrationStatus.integration_installed) {
            if (!integrationStatus.bot_permissions_changed) {
              ...
              if ("user" !== project.install_scope) {
                ...
                obj3.content = __initData(VibegrationsPublishNotesSheetDefault, obj6);
  ...
  const callback2 = obj3.useCallback(() => {
    const obj2 = {
      content: __initData(VibegrationsModelSettingsSheetDefault, { projectId }),
  ...
  const callback3 = obj3.useCallback(() => {
    const obj2 = {
      content: __initData(VibegrationsUsageSheetDefault, { projectId }),
  ...
  callback4 = obj3.useCallback(() => {
    const obj2 = {
      content: __initData(VibegrationsProjectSettingsSheetDefault, { projectId, guildId: projectGuildId }),
      key: VibegrationsProjectSettingsSheet.VIBEGRATIONS_PROJECT_SETTINGS_SHEET_KEY,
    };
    ActionSheetActionCreators.showActionSheet(obj2);
  }, items14);
  const tmp14 = null != previewAppId && null != projectId(navigation[37])(previewAppId);
  const items15 = [tmp10];
  const items16 = [projectId];
  stateFromStores3 = guildId(navigation[22]).useStateFromStores(
    items15,
  ...
  callback5 = obj3.useCallback(() => {
    const obj2 = {
      content: __initData(VibegrationsSettingsSheetDefault, { projectId, isPreview: true }),
  ...
  const effect2 = obj3.useEffect(() => {
    ...
    navigation.setOptions({
      headerTitle() {
        ...
        const obj = {
          style: prop,
          children: __initData(NavigatorHeader.NavigatorHeader, { title: stringResult, subtitle }),
        };
      ...
      headerRight() {
        ...
        items[1] = callback5(guildId(navigation[53]).ContextMenu, {
          ...
          children(arg0) {
            ...
            const obj = {
              ref,
              IconComponent: closure_1_0(8798).MoreHorizontalIcon,
              onPress,
...
export default function VibegrationsStandaloneScreen(guildId) {
  ...
  const isVibegrationsGuildEnabled = guildId(stateFromStores[56]).useIsVibegrationsGuildEnabled({
    guildId,
  ...
  const stateFromStoresArray = guildId(stateFromStores[22]).useStateFromStoresArray(
    items2,
    () => {
  ...
  const items6 = [
    ...
    guildId(stateFromStores[22]).useStateFromStores(
      items4,
      () => {
