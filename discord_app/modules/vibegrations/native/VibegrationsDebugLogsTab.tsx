...
let closure_11 = noop.memo((entry) => {
  ...
  items1[1] = closure_7(tmp6(4823).Text, {
  ...
  if (entry.showSource) {
    ...
    if (null != entry.source) {
      ...
      tmp9Result = closure_7(tmp6(4823).Text, obj5);
    }
  }
  items1[2] = tmp9Result;
  ...
  if (null != entry.kind) {
    ...
    tmp9Result4 = closure_7(tmp6(4823).Text, obj6);
  }
  ...
  if (null != memo) {
    ...
    if ("" !== memo.prefix) {
      ...
      tmp9Result5 = closure_7(tmp6(4823).Text, obj7);
    }
    ...
    if ("[\u2026]" === memo.marker) {
      let wkbYxG = _modDef3712.lXkB6Z;
    } else {
      wkbYxG = _modDef3712.wkbYxG;
    }
    ...
    items4[1] = closure_8(tmp6(4823).Text, obj11);
    obj8.children = items4;
    items3[1] = closure_8(tmp6(5425).PressableOpacity, obj8);
    ...
    if (expanded) {
      ...
      obj13.children = closure_7(tmp6(4823).Text, obj14);
      tmp9Result6 = closure_7(tmp6(5910).Card, obj13);
    }
    ...
    tmp9Result7 = closure_7(tmp6(4823).Text, obj16);
  }
