// discord_app/modules/vibegrations/native/VibegrationsDebugLogsTab.tsx
import nativeDefault from "../../../../discord_common/js/packages/tokens/native.tsx";
import _modDef3593 from "../intl/VibegrationsUntranslated.messages.js";
import VibegrationsDebugJson from "../lib/VibegrationsDebugJson.tsx";
...
let closure_11 = noop.memo((entry) => {
  ...
  items1[1] = closure_7(tmp6(4636).Text, {
  ...
  if (entry.showSource) {
    ...
    if (null != entry.source) {
      ...
      tmp9Result = closure_7(tmp6(4636).Text, obj5);
    }
  }
  items1[2] = tmp9Result;
  ...
  if (null != entry.kind) {
    ...
    tmp9Result4 = closure_7(tmp6(4636).Text, obj6);
  }
  ...
  if (null != memo) {
    ...
    if ("" !== memo.prefix) {
      ...
      tmp9Result5 = closure_7(tmp6(4636).Text, obj7);
    }
    ...
    if ("[\u2026]" === memo.marker) {
      let wkbYxG = _modDef3593.lXkB6Z;
    } else {
      wkbYxG = _modDef3593.wkbYxG;
    }
    ...
    items4[1] = closure_8(tmp6(4636).Text, obj11);
    obj8.children = items4;
    items3[1] = closure_8(tmp6(5210).PressableOpacity, obj8);
    ...
    if (expanded) {
      ...
      obj13.children = closure_7(tmp6(4636).Text, obj14);
      tmp9Result6 = closure_7(tmp6(5695).Card, obj13);
    }
    ...
    tmp9Result7 = closure_7(tmp6(4636).Text, obj16);
  }
...
export default function VibegrationsDebugLogsTab(projectId) {
  ...
  const stateFromStores = projectId(first[17]).useStateFromStores(
    items,
    () => VibegrationsProjectStore.getLogs(projectId),
    items1,
  );
  let obj = projectId(first[17]);
  const items2 = [first2];
  const items3 = [projectId];
  const stateFromStores1 = projectId(first[17]).useStateFromStores(
    items2,
    () => VibegrationsProjectStore.getHistoryState(projectId, "logs"),
    items3,
  );
  ...
  const items6 = [
    closure_7(projectId(first[20]).SegmentedControl, { state: segmentedControlState, variant: "experimental_Small" }),
    ,
  ];
  ...
  items6[2] = closure_7(projectId(first[22]).VibegrationsHistoryNotice, {
