...
export default function VibegrationsConnectToolSheet(projectId) {
  ...
  if (null != first) {
    ...
    const items5 = [closure_8(tmp12(4823).Text, obj6), , ,];
    ...
    obj7.children = closure_8(tmp12(4823).Text, obj8);
    items5[1] = closure_8(tmp12(5910).Card, obj7);
    ...
    obj10.children = closure_8(tmp12(5271).Button, obj11);
    ...
    obj12.children = closure_8(tmp12(5271).Button, obj13);
    ...
    items5[3] = closure_8(tmp12(4823).Text, obj14);
    ...
    if (tmp5) {
      ...
      tmp11Result = closure_8(tmp12(4823).Text, obj15);
    }
  }
  ...
  if (tmp6[0]) {
    ...
    obj17.children = closure_8(tmp12(4823).Text, obj18);
    ...
    items7[1] = closure_8(tmp12(5271).Button, obj19);
