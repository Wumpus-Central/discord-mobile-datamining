          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null != tmp2) {
                ...
                if (null == enrolledAt) {
                  const obj5 = {
                    questContent: tmp2(5754).QuestContent.QUEST_BAR_MOBILE,
                    questContentCTA: tmp2(7136).QuestContentCTA.START_QUEST,
  ...
  if (tmp17) {
    if (null != tmp29) {
      ...
      const url = tmp2Result13.getQuestAsset(
        tmp29,
        tmp2(10676).QuestAssetType.GAME_TILE,
        tmp2(4535).isThemeDark(stateFromStores1) ? ThemeTypes.DARK : ThemeTypes.LIGHT,
      ).url;
