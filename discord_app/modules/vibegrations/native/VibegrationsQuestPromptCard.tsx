...
export default function VibegrationsQuestPromptCard(open) {
  ...
  if (tmp17) {
    if (null != tmp29) {
      ...
      const url = tmp2Result13.getQuestAsset(tmp29, tmp2(11634).QuestAssetType.GAME_TILE, tmp2(4533).isThemeDark(stateFromStores1) ? ThemeTypes.DARK : ThemeTypes.LIGHT).url;
