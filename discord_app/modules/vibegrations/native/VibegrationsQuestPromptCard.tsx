          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (null != tmp2) {
                ...
                if (null == enrolledAt) {
                  const obj5 = {
                    questContent: tmp2(5535).QuestContent.QUEST_BAR_MOBILE,
                    questContentCTA: tmp2(7842).QuestContentCTA.START_QUEST,
  ...
  if (tmp17) {
    if (null != tmp29) {
      ...
      const url = tmp2Result13.getQuestAsset(
        tmp29,
        tmp2(11439).QuestAssetType.GAME_TILE,
        tmp2(4348).isThemeDark(stateFromStores1) ? ThemeTypes.DARK : ThemeTypes.LIGHT,
      ).url;
