...
export default function VibegrationsQuestPromptCard(open) {
  ...
  if (tmp17) {
    if (null != tmp29) {
      ...
      const url = tmp2Result13.getQuestAsset(tmp29, tmp2(11537).QuestAssetType.GAME_TILE, tmp2(4430).isThemeDark(stateFromStores1) ? ThemeTypes.DARK : ThemeTypes.LIGHT).url;
