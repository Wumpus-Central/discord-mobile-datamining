...
export const DebugSnapshotToolbar = function DebugSnapshotToolbar(onRefresh) {
  ...
  if ("loading" === fetchState) {
    let tmp4Result = hasOwnProperty(React3, { size: "small" });
...
export const DebugSection = function DebugSection(arg0) {
  ...
  const items = [
    hasOwnProperty(Text_Text.Text, { variant: "text-xs/semibold", color: "text-muted", children: title }),
    children,
  ];
  obj.children = items;
  return timestampProducer(React4, obj);
...
export const DebugStatRow = function DebugStatRow(arg0) {
  ...
  const items = [
    hasOwnProperty(React4, {
      style: tmp.statLabel,
      children: hasOwnProperty(Text_Text.Text, { variant: "text-sm/normal", color: "text-muted", children: label }),
    }),
  ];
  ...
  if (null != hint) {
    ...
    tmp4Result = hasOwnProperty(Text_Text.Text, obj5);
  }
  items1[1] = tmp4Result;
  obj.children = items1;
  return timestampProducer(React4, obj);
