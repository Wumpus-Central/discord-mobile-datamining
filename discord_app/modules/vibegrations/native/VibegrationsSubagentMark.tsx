...
import VibegrationsSubagentMarks from "../lib/VibegrationsSubagentMarks.tsx";
...
let obj = {
  snail: { Illocon: fn(16353).SnailIllocon, tint: nativeDefault.unsafe_rawColors.ILLO_YELLOW_40 },
  goat: null,
  frog: null,
  bunny: null,
  cat: null,
