...
let closure_14 = createStyles.createStyles((paddingBottom) => {
  ...
  obj.container = obj;
  obj = { flex: 1, alignItems: "center", justifyContent: "center", padding: nativeDefault.space.PX_24, gap: nativeDefault.space.PX_12 };
  obj.centered = obj;
...
export default function VibegrationsAppChannelView(channel) {
  ...
  const memo = noop.useMemo(() => ({ type: constants.APP_CHANNEL, channelId: user.id, guildId: disallowGesture }), items);
