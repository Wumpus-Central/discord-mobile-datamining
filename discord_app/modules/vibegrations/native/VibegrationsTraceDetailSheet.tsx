...
export default function VibegrationsTraceDetailSheet(projectId) {
  ...
  const traceDetailSectionsResult = tmp2(17174).traceDetailSections(findTraceEntryResult, {
    childCount: length,
  ...
  const obj5 = {
    scrollable: true,
    header: closure_5(tmp2(7482).BottomSheetTitleHeader, { title: tmp12 }),
    children: null,
  };
  ...
  if (traceDetailSectionsResult.includes("usage")) {
    ...
    if ("model" === findTraceEntryResult.kind) {
      ...
      if (null != findTraceEntryResult.systemTokens) {
        ...
        const obj26 = {
          system: tmp2(17169).formatTokens(findTraceEntryResult.systemTokens),
          tools: null,
          toolCount: null,
          messages: null,
          messageCount: null,
