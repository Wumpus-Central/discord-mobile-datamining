...
export default function VibegrationsTraceDetailSheet(projectId) {
  ...
  const traceDetailSectionsResult = tmp2(16418).traceDetailSections(findTraceEntryResult, {
    childCount: length,
  ...
  const obj5 = {
    scrollable: true,
    header: closure_5(tmp2(6570).BottomSheetTitleHeader, { title: tmp12 }),
    children: null,
  };
  ...
  if (null == findTraceEntryResult.durationMs) {
    ...
    let stringResult = intl.string(_modDef3715.HpKDyl);
  } else {
  ...
  if (null != findTraceEntryResult.error) {
    ...
    tmp16Result = closure_5(tmp2(4832).Text, obj12);
  }
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      obj13.title = intl25.string(_modDef3715.jXY3mm);
      ...
      if (null != traceRichStatusLabelResult) {
        ...
        tmp16Result19 = closure_5(tmp2(4832).Text, obj15);
      }
  ...
  if (traceDetailSectionsResult.includes("result")) {
    ...
    if ("tool" === findTraceEntryResult.kind) {
      ...
      obj16.title = intl26.string(_modDef3715.KXrf5F);
      const obj17 = { label: null, value: null };
      const intl27 = tmp2(1115).intl;
      obj17.label = intl27.string(_modDef3715["2Aii2k"]);
      ...
      obj17.value = intl28.formatToPlainString(_modDef3715.DdXP0P, obj18);
      ...
      if (null != findTraceEntryResult.resultAdded) {
        ...
        obj19.label = intl2.string(_modDef3715.hpGFzS);
      ...
      if (true === findTraceEntryResult.resultTruncated) {
        ...
        obj20.label = intl3.string(_modDef3715["UV2R1/"]);
        const intl4 = tmp2(1115).intl;
        obj20.value = intl4.string(_modDef3715["1kBG9Z"]);
  ...
  if (traceDetailSectionsResult.includes("usage")) {
    ...
    if ("model" === findTraceEntryResult.kind) {
      ...
      if (null != findTraceEntryResult.systemTokens) {
        ...
        obj25.label = intl7.string(_modDef3715.vPIcyv);
        const intl8 = tmp2(1115).intl;
        const obj26 = {
          system: tmp2(16413).formatTokens(findTraceEntryResult.systemTokens),
          tools: null,
          toolCount: null,
          messages: null,
          messageCount: null,
        ...
        obj25.value = intl8.formatToPlainString(_modDef3715.Qy2iTq, obj26);
      ...
      if (null != findTraceEntryResult.inputTokens) {
        ...
        obj27.label = intl9.string(_modDef3715["/703Yk"]);
      ...
      if (null != findTraceEntryResult.outputTokens) {
        ...
        obj28.label = intl10.string(_modDef3715["6+W0dJ"]);
      ...
      if (null != findTraceEntryResult.cacheReadTokens) {
        ...
        obj29.label = intl11.string(_modDef3715.VyAl6j);
        ...
        obj29.value = intl12.formatToPlainString(_modDef3715.lkMc23, obj30);
      ...
      if (null != findTraceEntryResult.costUsd) {
        ...
        obj31.label = intl13.string(_modDef3715.l9YFEQ);
      ...
      obj32.children = intl14.string(_modDef3715.F9jaUF);
      items6[6] = closure_5(tmp2(4832).Text, obj32);
  ...
  if (traceDetailSectionsResult.includes("arguments")) {
    ...
    obj33.children = intl15.string(_modDef3715["ppv+97"]);
    let tmp16Result29 = closure_5(tmp2(4832).Text, obj33);
  } else {
    tmp16Result29 = null;
  }
  ...
  if (traceDetailSectionsResult.includes("diagnostics")) {
    ...
    obj34.title = intl16.string(_modDef3715.T7SFyZ);
    if (null == findTraceEntryResult1) {
      ...
      if (length > 0) {
        ...
        obj35.label = intl18.string(_modDef3715.fI6mzD);
        const intl19 = tmp2(1115).intl;
        const obj36 = { count: length };
        obj35.value = intl19.formatToPlainString(_modDef3715.hO8FYp, obj36);
      ...
      if (null != findTraceEntryResult.turnId) {
        ...
        obj37.label = intl20.string(_modDef3715.I7cJP0);
      ...
      obj38.label = intl21.string(_modDef3715["XVTP/S"]);
      ...
      if (null != formatClockTimeResult) {
        ...
        obj39.label = intl22.string(_modDef3715.rD7bm0);
      ...
      if ("model" === findTraceEntryResult.kind) {
        ...
        if (null != findTraceEntryResult.stopReason) {
          ...
          obj41.label = intl23.string(_modDef3715.rxmzYT);
      ...
      if ("tool" === findTraceEntryResult.kind) {
        ...
        if (null != findTraceEntryResult.schema) {
          ...
          if (findTraceEntryResult.schema.length > 0) {
            ...
            obj43.children = intl24.string(_modDef3715["6oILKx"]);
            const items8 = [closure_5(tmp2(4832).Text, obj43)];
      ...
      obj44.label = intl17.string(_modDef3715.NnBqcd);
