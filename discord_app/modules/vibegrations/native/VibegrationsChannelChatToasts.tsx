// discord_app/modules/vibegrations/native/VibegrationsChannelChatToasts.tsx
...
import useVibegrationsChatToastMessagesDefault from "../lib/useVibegrationsChatToastMessages.tsx";
...
export default function VibegrationsChannelChatToasts(onOpenChat) {
  ...
  if (0 !== arr.length) {
    const obj = {
      ...
      children: arr.map((message) => hasOwnProperty(ChatToast, { message, onOpenChat }, message.id)),
    };
