...
export default function VibegrationsSecretsSheet(projectId) {
  ...
  obj.title = intl.string(require("module_3590").ACvhVC);
  ...
  obj2.children = intl2.string(require("module_3590").p0Ay4J);
  ...
  obj5.text = intl5.string(require("module_3590")["8SWZaW"]);
  obj5.loading = first1;
