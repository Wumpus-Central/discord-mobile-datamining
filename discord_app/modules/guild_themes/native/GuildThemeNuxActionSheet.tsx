...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  [tmp5, c2] = _slicedToArray(noop.useState(guildId(16244).getInitialGuildThemeNuxSelection), 2);
  ...
  items7[1] = closure_10(guildId(4601).Text, obj);
  ...
  items7[2] = closure_10(guildId(4601).Text, obj1);
  ...
  obj4.value = guildId(4536).GuildThemeSourcePreference.GUILD;
  const items8 = [closure_10(guildId(5738).TableRadioRow, obj4), ];
  const obj5 = { label: null, value: null };
  const intl6 = tmp2(1114).intl;
  obj5.label = intl6.string(guildId(1114).t.js8y7t);
  obj5.value = guildId(4536).GuildThemeSourcePreference.PERSONAL;
  items8[1] = closure_10(guildId(5738).TableRadioRow, obj5);
  obj3.children = items8;
  obj2.children = closure_11(guildId(5735).TableRadioGroup, obj3);
  ...
  obj10.children = closure_10(guildId(5025).Button, obj11);
  items7[6] = closure_10(closure_6, obj10);
  obj.children = items7;
  return closure_11(guildId(7202).BottomSheet, obj);
};
