// === Module 16587: GuildThemeNuxActionSheet ===
...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  const tmp10 = tmp5 === guildId(4759).GuildThemeSourcePreference.PERSONAL;
  closure_6 = tmp10;
  ...
  const items7 = [closure_10(markAsDismissed(16589), { themeSettings: stateFromStores1, isPersonal: tmp10 }), , , , , , ];
  ...
  items7[1] = closure_10(guildId(4825).Text, obj4);
  ...
  items7[2] = closure_10(guildId(4825).Text, obj5);
