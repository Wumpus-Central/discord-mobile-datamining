...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  [tmp5, c2] = _slicedToArray(noop.useState(guildId(16233).getInitialGuildThemeNuxSelection), 2);
  ...
  items7[1] = closure_10(guildId(4602).Text, obj);
  ...
  items7[2] = closure_10(guildId(4602).Text, obj1);
  ...
  obj4.value = guildId(4537).GuildThemeSourcePreference.GUILD;
  const items8 = [closure_10(guildId(5739).TableRadioRow, obj4), ];
  const obj5 = { label: null, value: null };
  const intl6 = tmp2(1114).intl;
  obj5.label = intl6.string(guildId(1114).t.js8y7t);
  obj5.value = guildId(4537).GuildThemeSourcePreference.PERSONAL;
  items8[1] = closure_10(guildId(5739).TableRadioRow, obj5);
  obj3.children = items8;
  obj2.children = closure_11(guildId(5736).TableRadioGroup, obj3);
  ...
  obj10.children = closure_10(guildId(5026).Button, obj11);
  items7[6] = closure_10(closure_6, obj10);
  obj.children = items7;
  return closure_11(guildId(7223).BottomSheet, obj);
};
