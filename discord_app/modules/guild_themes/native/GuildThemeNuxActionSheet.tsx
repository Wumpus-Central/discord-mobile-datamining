...
export default function GuildThemeNuxActionSheet(guildId) {
  ...
  const items7 = [
    closure_10(markAsDismissed(16260), { themeSettings: stateFromStores1, isPersonal: tmp10 }),
    ,
    ,
    ,
    ,
  ...
  if (null != tmp7) {
    ...
    obj12.children = closure_10(tmp2(1176).HelpMessage, obj13);
