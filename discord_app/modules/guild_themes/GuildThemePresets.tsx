...
obj = {
  id: obj.TWILIGHT,
  darkAppearance: { color: "#69426A", angle: 0, baseMix: 100, colors: items1 },
  lightAppearance: { color: "#FA9EFF", angle: 0, baseMix: 100, colors: items2 },
};
items1 = [
  { hex: "#69426A", stop: 0 },
  { hex: "#111731", stop: 100 },
...
obj = {
  id: obj.DENIM,
  darkAppearance: { color: "#5359AD", angle: 0, baseMix: 100, colors: items3 },
  lightAppearance: { color: "#DBDBFF", angle: 0, baseMix: 100, colors: items4 },
};
items3 = [
  { hex: "#5359AD", stop: 0 },
  { hex: "#121238", stop: 100 },
...
let closure_4 = {
  ...
  [obj.OCEAN]: {
    id: obj.OCEAN,
    darkAppearance: { color: "#245B92", angle: 0, baseMix: 100, colors: items5 },
    lightAppearance: { color: "#9ADBF7", angle: 0, baseMix: 100, colors: items6 },
  },
  [obj.BLURPLE]: {
    id: obj.BLURPLE,
    darkAppearance: { color: "#533D9E", angle: 0, baseMix: 100, colors: items7 },
    lightAppearance: { color: "#C3BFFF", angle: 0, baseMix: 100, colors: items8 },
  },
  [obj.OBSIDIAN]: {
    id: obj.OBSIDIAN,
    darkAppearance: { color: "#5E4C85", angle: 0, baseMix: 100, colors: items9 },
    lightAppearance: { color: "#B59DF2", angle: 0, baseMix: 100, colors: items10 },
  },
  [obj.PLUM]: {
    id: obj.PLUM,
    darkAppearance: { color: "#8A3F7F", angle: 0, baseMix: 100, colors: items11 },
    lightAppearance: { color: "#E893FF", angle: 0, baseMix: 100, colors: items12 },
  },
  [obj.FIRE]: {
    id: obj.FIRE,
    darkAppearance: { color: "#9B2C2C", angle: 0, baseMix: 50, colors: items13 },
    lightAppearance: { color: "#FFEBCA", angle: 0, baseMix: 50, colors: items14 },
  },
  [obj.GOLD_DUST]: {
    id: obj.GOLD_DUST,
    darkAppearance: { color: "#6C523D", angle: 0, baseMix: 50, colors: items15 },
    lightAppearance: { color: "#FFE7DA", angle: 0, baseMix: 50, colors: items16 },
  },
  [obj.MOSS]: {
    id: obj.MOSS,
    darkAppearance: { color: "#58694E", angle: 0, baseMix: 50, colors: items17 },
    lightAppearance: { color: "#B7D19F", angle: 0, baseMix: 50, colors: items18 },
  },
  [obj.JADE]: {
    id: obj.JADE,
    darkAppearance: { color: "#297071", angle: 0, baseMix: 50, colors: items19 },
    lightAppearance: { color: "#C5F0D2", angle: 0, baseMix: 50, colors: items20 },
  },
};
...
export const getSingleColorGuildThemeGradientColors = function getSingleColorGuildThemeGradientColors(first, theme) {
  ...
  const result = obj.set(
    "hsl.l",
    (minTone + ((Math.max(15, Math.min(75, 100 * obj.get("hsl.l"))) - 15) / 60) * (tmp2.maxTone - minTone)) / 100,
  );
...
export const getThemeAdjustedToneColor = function getThemeAdjustedToneColor(arg0, arg1) {
  ...
  const result = obj.set(
    "hsl.l",
    (minTone + ((Math.max(15, Math.min(75, 100 * obj.get("hsl.l"))) - 15) / 60) * (tmp.maxTone - minTone)) / 100,
  );
  return result.hex();
};
