...
function ActivitySounds() {
  ...
  const f106860 = () => {
    ...
    const embeddedActivityLocationChannelId = items(f106860[24]).getEmbeddedActivityLocationChannelId(
    ...
    if (result1) {
      result1 = items(f106860[26]).isVibegrationsChannelCandidate(
    ...
    return {
      ...
      hasFrame: closure_1_25(mainFrame),
...
({
  InputModes: closure_20,
  ApplicationStreamStates: closure_21,
...
export default function SoundPlayer() {
  ...
  const items = [
    dependencyMap(MuteDeafen, {}),
    dependencyMap(Camera, {}),
    dependencyMap(RTCConnect, {}),
    dependencyMap(Speaking, {}),
    dependencyMap(SelfMutedTemporarily, {}),
    dependencyMap(UserHasBeenMoved, {}),
    dependencyMap(VoiceChannel, {}),
    dependencyMap(UserInvitedToSpeak, {}),
    dependencyMap(ActivitySounds, {}),
    dependencyMap(PriorityVAD, {}),
  ];
  obj.children = items;
