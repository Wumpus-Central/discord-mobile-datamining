...
function MuteDeafen() {
  ...
  const f106727 = () => ({ inVoiceChannel: null != voiceChannelId.getVoiceChannelId(), selfMute: MediaEngineStore.isSelfMute(), selfDeaf: MediaEngineStore.isSelfDeaf(), audioPermissionReady: MediaEngineStore.isNativeAudioPermissionReady(), shouldSkipMuteUnmuteSound: MediaEngineStore.shouldSkipMuteUnmuteSound() });
  const f106728 = (selfDeaf, arg1) => {
  ...
  const effect = f106728.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function Camera() {
  const items = [MediaEngineStore, SelectedChannelStore];
  const f106729 = () => ({ videoEnabled: videoEnabled.isVideoEnabled(), inVoiceChannel: null != voiceChannelId.getVoiceChannelId() });
  const f106730 = (videoEnabled, videoEnabled2) => {
  ...
  const effect = f106730.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function RTCConnect() {
  ...
  const f106732 = (channelType, arg1) => {
  ...
  const effect = f106732.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function Speaking() {
  ...
  const f106733 = () => currentUserPTTActive.isCurrentUserPTTActive();
  const f106734 = (arg0, arg1) => {
    if (arg0 !== arg1) {
  ...
  const effect = f106734.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function SelfMutedTemporarily() {
  ...
  const f106735 = () => MediaEngineStore.isSelfMutedTemporarily();
  const f106736 = (arg0, arg1) => {
    if (arg0 !== arg1) {
  ...
  const effect = f106736.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function PriorityVAD() {
  const items = [SpeakingStore];
  const f106737 = () => currentUserPrioritySpeaker.isCurrentUserPrioritySpeaker();
  const f106738 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      if (MediaEngineStore.getMode() === constants.VOICE_ACTIVITY) {
        if (!isSelfMuteResult) {
          let str = "ptt_stop";
  ...
  const effect = f106738.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function UserHasBeenMoved() {
  ...
  const f106739 = () => VoiceStateStore.userHasBeenMovedVersion;
  const f106740 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      return "user_moved";
    }
  };
  const effect = f106740.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function UserInvitedToSpeak() {
  ...
  const f106741 = () => {
    ...
    if (null == voiceChannelId) {
      return items(f106741[22]).RequestToSpeakStates.NONE;
    } else {
      voiceStateForChannel = voiceStateForChannel.getVoiceStateForChannel(voiceChannelId);
      return items(f106741[22]).getAudienceRequestToSpeakState(voiceStateForChannel);
    }
  };
  const f106742 = (arg0, arg1) => {
    if (arg0 !== arg1) {
      if (arg1 === items(f106741[22]).RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK) {
        return "reconnect";
      }
    }
  };
  const effect = f106742.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function VoiceChannel() {
  ...
  const f106743 = () => {
    ...
    if (null != first) {
      const encodeStreamKeyResult = items(f106743[23]).encodeStreamKey(first);
  ...
  const f106744 = (voiceChannelId, arg1) => {
    ({ channelType, voiceChannelId, voiceChannelUserCount, streamingUserIds } = arg1);
    ({ singleActiveStreamKey, singleActiveStreamViewerCount, currentUserId: f106744 } = arg1);
    closure_3 = undefined;
  ...
  const effect = f106744.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
...
function ActivitySounds() {
  ...
  const f106745 = () => {
    ...
    const embeddedActivityLocationChannelId = items(f106745[24]).getEmbeddedActivityLocationChannelId(connectedActivityLocation);
    id = id.getId();
    const obj2 = items(f106745[24]);
    ...
    if (result1) {
      result1 = items(f106745[26]).isVibegrationsChannelCandidate(ChannelStore.getChannel(tmp13Result), "ActivitySounds");
      const tmp4Result6 = items(f106745[26]);
    }
    if (!result1) {
      result1 = result;
    }
  ...
  const f106746 = (isGuildSpaceActivity, arg1) => {
    ...
    if (obj.isNotNullish(voiceChannelId)) {
      ...
      if (isNotNullishResult) {
        isNotNullishResult = items(f106745[25]).isNotNullish(isGuildSpaceActivity.voiceChannelId);
        const tmp2Result = items(f106745[25]);
      }
      let str2;
      if (isNotNullishResult) {
      ...
      if (isNotNullishResult1) {
        isNotNullishResult1 = items(f106745[25]).isNotNullish(found);
        const tmp2Result8 = items(f106745[25]);
      }
      if (isNotNullishResult1) {
        str2 = "activity_end";
      }
      ...
      if (isNotNullishResult2) {
        isNotNullishResult2 = items(f106745[25]).isNotNullish(found1);
        const tmp2Result9 = items(f106745[25]);
      }
      if (isNotNullishResult2) {
      ...
      let isNotNullishResult3 = items(f106745[25]).isNotNullish(found1);
      if (isNotNullishResult3) {
        isNotNullishResult3 = items(f106745[25]).isNotNullish(found);
        const tmp2Result11 = items(f106745[25]);
      }
      str = str2;
      if (isNotNullishResult3) {
      ...
      const tmp2Result10 = items(f106745[25]);
    }
    let str3 = str;
    if (!someResult) {
      str3 = str;
      if (!isGuildSpaceActivity) {
        ...
        if (isNotNullishResult4) {
          isNotNullishResult4 = items(f106745[25]).isNotNullish(userConnectedActivity2);
          const tmp2Result12 = items(f106745[25]);
        }
        if (isNotNullishResult4) {
          str = "activity_end";
        }
        let isNotNullishResult5 = items(f106745[25]).isNotNullish(userConnectedActivity);
        if (isNotNullishResult5) {
          isNotNullishResult5 = items(f106745[25]).isNotNullish(userConnectedActivity2);
          const tmp2Result14 = items(f106745[25]);
        }
        str3 = str;
        if (isNotNullishResult5) {
        ...
        const tmp2Result13 = items(f106745[25]);
      }
    }
  ...
  const effect = f106746.useEffect(() => {
    closure_0 = batchedStoreListener();
    batchedStoreListener = new items(f106745[20]).BatchedStoreListener(closure_0, () => {
      const tmp = f106745();
      const tmp2 = f106746(closure_0, tmp);
