...
import ReportMenuType from "../../../discord_common/js/shared/shared-constants/ReportMenuType.tsx";
...
function genSubmitData(version, name, arr, email_token) {
  ...
  let obj2 = { channel_id: "Button", message_id: "ip", stage_instance_id: "Array", guild_id: "isArray", guild_scheduled_event_id: "isArray", user_id: "isArray", email_token: "channelId", application_id: "guild", entrypoint: "accessibilityLabel", widget_id: "guild" };
  obj.language = str;
...
export const submitReport = function submitReport(language, name, arr) {
  if (DevSettingsStore.get("iar_skip_api_report_submit")) {
    ...
    const REPORT_TO_MOD = obj4(8990).ReportMenuTypeSets.REPORT_TO_MOD;
    if (REPORT_TO_MOD.has(name.name)) {
      ...
      let tmp15 = null;
      if (name.name === tmp4(8988).ModeratorReportNames.MESSAGE) {
        let obj2 = { channel_id: "isArray", message_id: "padding", guild_id: "op" };
        obj4 = {};
      ...
      const REPORT_TO_MOD2 = tmp4(8990).ReportMenuTypeSets.REPORT_TO_MOD;
      ...
      if (name.name === tmp4(8988).ModeratorReportNames.MESSAGE) {
        ...
        resolved = HTTP2.post(request).then((result) => {
          ...
          let channel_id;
          if (obj4 != null) {
            channel_id = obj4.channel_id;
          }
          let tmp6 = null != channel_id;
          if (tmp6) {
            let message_id;
            if (obj4 != null) {
              message_id = obj4.message_id;
            }
      ...
      name = name.name;
      let _Object = Object;
      const values = Object.values(tmp4(8988).ReportNames);
