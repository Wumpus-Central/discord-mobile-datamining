...
const require = fn;
const result = require("obj132").fileFinishedImporting("modules/in_app_reports/native/components/InAppReportsLeaveGuildElement.tsx");
...
export default function LeaveGuildElement(guild) {
  ...
  closure_5 = React.useCallback(() => {
    if (null != guild) {
      ...
      addCallback(reportId[5]);
      const obj = { guild_id: null, report_id: null };
      obj[0] = tmp.id;
      obj[1] = reportId;
