...
export default function GuildPreview(guild) {
  ...
  obj2[1] = guild;
  const items2 = [callback(GuildIconSizes, obj2), callback(Text.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", style: tmp.guildInfo, children: guild.name })];
  obj1[1] = items2;
