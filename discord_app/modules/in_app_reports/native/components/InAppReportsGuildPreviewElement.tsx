...
export default function GuildPreview(guild) {
  ...
  obj2.guild = guild;
  const items2 = [React4(GuildIconDefault, obj2), React4(Text_Text.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", style: tmp.guildInfo, children: guild.name })];
