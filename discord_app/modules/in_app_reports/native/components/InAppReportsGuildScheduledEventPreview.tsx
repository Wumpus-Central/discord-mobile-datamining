...
export default function GuildScheduledEventPreview(event) {
  ...
  if (null == stateFromStores) {
    ...
    obj2[0] = tmp2(4128).hexWithOpacity(tmp.borderColor.color, 0.08);
    items2[1] = obj2;
    obj1[0] = items2;
    ...
    const hexWithOpacityResult = tmp2(4128).hexWithOpacity(tmp.borderColor.color, 0.08);
    obj4[1] = tmp2(5700).GuildIconSizes.XXSMALL;
