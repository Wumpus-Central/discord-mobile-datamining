// === Module 12806: GuildScheduledEventPreview ===
...
const result = require("obj132").fileFinishedImporting("modules/in_app_reports/native/components/InAppReportsGuildScheduledEventPreview.tsx");
...
export default function GuildScheduledEventPreview(event) {
  ...
  if (null == stateFromStores) {
    ...
    items3[1] = callback(tmp2(4734).Text, obj5);
    obj3[1] = items3;
    ...
    obj6[3] = event.name;
    items4[1] = callback(tmp2(4734).Text, obj6);
    obj1[1] = items4;
