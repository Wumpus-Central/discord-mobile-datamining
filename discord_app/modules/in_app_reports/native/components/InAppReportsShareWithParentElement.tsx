...
import FamilyCenterActionCreators from "../../../parent_tools/FamilyCenterActionCreators.tsx";
...
export default function _default(parents) {
  ...
  if (0 === parents.length) {
    ...
    obj.icon = jsx(parents(9058).ShareIcon, {});
    const intl2 = tmp15(1114).intl;
    obj.description = intl2.string(parents(1114).t["5l/hlt"]);
    obj.disabled = tmp[0];
    obj.onPress = tmp2;
    return jsx(InAppReportsUpsellsTableRowDefault, {
      count: parents.length,
      parent1: parents[0].username,
      parent2: null,
      parent3: null,
    });
  }
