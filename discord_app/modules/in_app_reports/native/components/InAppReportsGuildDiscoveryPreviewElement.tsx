...
export default function GuildDiscoveryPreviewElement(guild) {
  ...
  obj3[1] = fromGuildPropertiesWithAdditionalFields /* fromGuildPropertiesWithAdditionalFields */.fromClientDiscoverableGuild(guild);
  obj3[2] = !stateFromStores;
  const items3 = [callback(tmp4, obj3), callback(Text /* Text */.Text, { style: tmp.guildName, variant: "text-sm/medium", color: "text-default", children: guild.name })];
  obj2[1] = items3;
