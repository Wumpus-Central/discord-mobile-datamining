...
export default function GuildDiscoveryPreviewElement(guild) {
  ...
  let obj1 = require("../../../../utils/ColorUtils.tsx") /* hexToRgba */;
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.title, accessibilityRole: "header", variant: "text-xs/bold", children: null };
  const intl = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[3] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.nTe4HC);
  ...
  const tmp4 = require("../../../guild/native/GuildIcon.tsx");
  obj3[1] = require("../../../../utils/GuildRecordUtils.tsx") /* fromGuildPropertiesWithAdditionalFields */.fromClientDiscoverableGuild(guild);
  obj3[2] = !stateFromStores;
  const items3 = [callback(tmp4, obj3), callback(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { style: tmp.guildName, variant: "text-sm/medium", color: "text-default", children: guild.name })];
  obj2[1] = items3;
