      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          if (null != frame) {
            ...
            c6 = 1;
            const obj13 = {
              value: closure_130_0(closure_130_2[6]).createProxyTicket(closure_129_0, closure_130_7(closure_129_1)),
              done: false,
            };
            return obj13;
          }
        ...
        c6 = 1;
        const obj14 = {
          value: closure_130_0(closure_130_2[8]).getActivityLaunchErrorInfo(closure_129_11, closure_129_0),
          done: false,
        };
        return obj14;
      } else if (3 === tmp7) {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            if (null == frame) {
              ...
              c6 = 1;
              const obj7 = {
                value: EmbeddedActivitiesActionCreators.createProxyTicket(applicationId, closure_2_7(frame.surface)),
                done: false,
              };
              return obj7;
            }
          ...
          c6 = 1;
          const obj10 = {
            value: closure_130_0(closure_130_2[8]).getActivityLaunchErrorInfo(closure_129_5, closure_129_1),
            done: false,
          };
          return obj10;
        } else if (3 === tmp9) {
