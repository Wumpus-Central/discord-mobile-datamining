...
import _modDef16607 from "../../../activities/panel/native/InviteActivityButton.tsx";
import _modDef16611 from "../../../activities/panel/native/MinimizeActivityButton.tsx";
import QuestActivityButtonInnerDefault from "QuestActivityButton.tsx";
import contextDefault from "FramePanelStateContext.tsx";
import _modDef16627 from "LeaveActivityButton.tsx";
...
function FramePanelHeaderContentInner(arg0) {
  ...
  items3[1] = tmp18;
  items3[2] = closure_7(_modDef16627, { frame, setMode });
  obj[5] = items3;
