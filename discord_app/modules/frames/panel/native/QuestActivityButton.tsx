...
function QuestActivityButtonInner(quest) {
  ...
  obj1[1] = quest(14452);
  obj[2] = callback(stateFromStores(5780), obj1);
  ...
  const tmp20 = stateFromStores(5780);
  obj3[0] = stateFromStores(14320);
  obj3[1] = callback;
  const intl = tmp(1236).intl;
  obj3[2] = intl.string(quest(1236).t.JALI2K);
  obj2[1] = callback(stateFromStores(16204), obj3);
  ...
  obj6[6] = result;
  obj5[2] = callback(quest(7901).Circle, obj6);
  obj4[2] = callback(quest(7901).Svg, obj5);
  ...
  obj7[2] = callback(quest(7901).Svg, obj8);
