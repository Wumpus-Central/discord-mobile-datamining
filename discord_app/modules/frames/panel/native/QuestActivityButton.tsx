// === Module 16847: QuestActivityButtonInner ===
...
import closure_7 from "set" /* 16848 */;
import { QuestVariants } from "QuestsExperimentLocations" /* 5395 */;
...
function QuestActivityButtonInner(quest) {
  ...
  obj5[2] = callback(quest(8250).Circle, { cx: 16, cy: 16, r: 14.3, fill: "none", stroke: stateFromStores(709).unsafe_rawColors.OPACITY_32, strokeWidth: 3.4, strokeDasharray: result });
