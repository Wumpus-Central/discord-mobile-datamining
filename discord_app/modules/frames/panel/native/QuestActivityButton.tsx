...
import jsxProd from "module_16026";
...
function QuestActivityButtonInner(quest) {
  ...
  const animatedProps = quest(4162).useAnimatedProps(fn2);
  ...
  const tmpResult2 = quest(4162);
  obj1[1] = quest(14302);
  obj[2] = callback(stateFromStores(5659), obj1);
  ...
  const tmp20 = stateFromStores(5659);
  obj3[0] = stateFromStores(14170);
  obj3[1] = callback;
  const intl = tmp(1236).intl;
  obj3[2] = intl.string(quest(1236).t.JALI2K);
  obj2[1] = callback(stateFromStores(16026), obj3);
  ...
  obj6[6] = result;
  obj5[2] = callback(quest(7775).Circle, obj6);
  obj4[2] = callback(quest(7775).Svg, obj5);
  ...
  obj7[2] = callback(quest(7775).Svg, obj8);
  items6[3] = callback(c4, obj7);
  obj[2] = items6;
  return callback2(stateFromStores(4162).View, obj);
}
