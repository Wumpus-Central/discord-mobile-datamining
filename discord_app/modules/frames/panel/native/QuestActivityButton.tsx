...
import jsxProd from "module_15960";
...
function QuestActivityButtonInner(quest) {
  ...
  obj1[1] = quest(14248);
  obj[2] = callback(stateFromStores(5586), obj1);
  ...
  const tmp20 = stateFromStores(5586);
  obj3[0] = stateFromStores(14119);
  obj3[1] = callback;
  const intl = tmp(1236).intl;
  obj3[2] = intl.string(quest(1236).t.JALI2K);
  obj2[1] = callback(stateFromStores(15960), obj3);
  ...
  obj6[6] = result;
  obj5[2] = callback(quest(8409).Circle, obj6);
  obj4[2] = callback(quest(8409).Svg, obj5);
  ...
  obj7[2] = callback(quest(8409).Svg, obj8);
