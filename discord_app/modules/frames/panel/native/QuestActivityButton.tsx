...
import jsxProd from "module_16000";
...
function QuestActivityButtonInner(quest) {
  ...
  const animatedStyle = quest(4145).useAnimatedStyle(fn);
  ...
  const animatedProps = quest(4145).useAnimatedProps(fn2);
  ...
  const tmpResult2 = quest(4145);
  obj1[1] = quest(14285);
  obj[2] = callback(stateFromStores(5640), obj1);
  ...
  const tmp20 = stateFromStores(5640);
  obj3[0] = stateFromStores(14156);
  obj3[1] = callback;
  const intl = tmp(1236).intl;
  obj3[2] = intl.string(quest(1236).t.JALI2K);
  obj2[1] = callback(stateFromStores(16000), obj3);
  ...
  obj6[6] = result;
  obj5[2] = callback(quest(7758).Circle, obj6);
  obj4[2] = callback(quest(7758).Svg, obj5);
  ...
  obj7[2] = callback(quest(7758).Svg, obj8);
  items6[3] = callback(c4, obj7);
  obj[2] = items6;
  return callback2(stateFromStores(4145).View, obj);
}
