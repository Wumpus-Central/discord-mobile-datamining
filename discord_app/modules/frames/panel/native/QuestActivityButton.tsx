// === Module 16612: QuestActivityButtonInner ===
...
import closure_7 from "set" /* 16613 */;
import { QuestVariants } from "QuestsExperimentLocations" /* 5387 */;
...
function QuestActivityButtonInner(quest) {
  ...
  obj5[2] = callback(quest(8241).Circle, { cx: 16, cy: 16, r: 14.3, fill: "none", stroke: stateFromStores(712).unsafe_rawColors.OPACITY_32, strokeWidth: 3.4, strokeDasharray: result });
