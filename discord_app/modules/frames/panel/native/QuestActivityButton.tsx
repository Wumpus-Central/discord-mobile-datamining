...
function QuestActivityButtonInner(quest) {
  ...
  const animatedProps = quest(4036).useAnimatedProps(fn2);
  ...
  obj6[6] = result;
  obj5[2] = callback(quest(7835).Circle, obj6);
  obj4[2] = callback(quest(7835).Svg, obj5);
  ...
  obj7[2] = callback(quest(7835).Svg, obj8);
  items6[3] = callback(c4, obj7);
  obj[2] = items6;
  return callback2(stateFromStores(4036).View, obj);
}
