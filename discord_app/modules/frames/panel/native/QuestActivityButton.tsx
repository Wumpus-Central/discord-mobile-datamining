// === Module 16379: QuestActivityButtonInner ===
...
import closure_7 from "set" /* 16380 */;
import { QuestVariants } from "QuestsExperimentLocations" /* 5268 */;
...
function QuestActivityButtonInner(quest) {
  ...
  const animatedProps = quest(4120).useAnimatedProps(fn2);
  ...
  const tmpResult2 = quest(4120);
  obj1[1] = quest(14582);
  obj[2] = callback(stateFromStores(5825), obj1);
  ...
  const tmp20 = stateFromStores(5825);
  obj3[0] = stateFromStores(14450);
  obj3[1] = callback;
  const intl = tmp(1236).intl;
  obj3[2] = intl.string(quest(1236).t.JALI2K);
  obj2[1] = callback(stateFromStores(16383), obj3);
  ...
  const tmp21 = stateFromStores(16383);
  obj5[2] = callback(quest(7985).Circle, { cx: 16, cy: 16, r: 14.3, fill: "none", stroke: stateFromStores(712).unsafe_rawColors.OPACITY_32, strokeWidth: 3.4, strokeDasharray: result });
  obj4[2] = callback(quest(7985).Svg, obj5);
  ...
  obj7[2] = callback(quest(7985).Svg, { height: c11, width: c11, children: callback(closure_12, obj9) });
  items6[3] = callback(closure_4, obj7);
  obj[2] = items6;
  return callback2(stateFromStores(4120).View, obj);
}
