...
function useIOSCompletionStates(guild) {
  ...
  if (stateFromStores) {
    const ServerSetupBoostCtaExperiment = tmp(12026).ServerSetupBoostCtaExperiment;
...
export const openActionSheet = function openActionSheet(guild) {
  ...
  obj = { guild };
  obj.openLazy(asyncRequireImpl(11916, dependencyMap.paths), "guild-progress-" + guild.id, obj);
};
