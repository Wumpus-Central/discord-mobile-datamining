...
function useIOSCompletionStates(guild) {
  ...
  if (stateFromStores) {
    const ServerSetupBoostCtaExperiment = tmp(11865).ServerSetupBoostCtaExperiment;
...
export const openActionSheet = function openActionSheet(guild) {
  ...
  obj = { guild };
  obj.openLazy(asyncRequireImpl(11755, dependencyMap.paths), "guild-progress-" + guild.id, obj);
};
