...
function useIOSCompletionStates(guild) {
  ...
  if (stateFromStores) {
    const ServerSetupBoostCtaExperiment = tmp(11880).ServerSetupBoostCtaExperiment;
...
export const openActionSheet = function openActionSheet(guild) {
  ...
  obj = { guild };
  obj.openLazy(asyncRequireImpl(11770, dependencyMap.paths), "guild-progress-" + guild.id, obj);
};
