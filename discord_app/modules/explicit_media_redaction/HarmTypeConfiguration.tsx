...
obj[obj.EXPLICIT] = {
  ...
  getProtoUserSettings(textAndImages) {
    ...
    const obj = {};
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = prop1;
    let prop2;
    if (prop != null) {
      prop2 = prop.explicitContentFriendDm;
    }
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = prop2;
    let prop3;
    if (prop != null) {
      prop3 = prop.explicitContentNonFriendDm;
    }
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop3;
    return obj;
  },
  getUserSettingsWithDefaults(arg0) {
    let tmp = arg0;
    if (arg0 == null) {
      const ExplicitContentSettings3 = require(3866) /* explicitContentFromProto */.ExplicitContentSettings;
      ...
      let obj = {};
      obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = prop;
      const ExplicitContentSettings = tmp12(3866).ExplicitContentSettings;
      const setting1 = ExplicitContentSettings.getSetting();
      let prop1;
      if (setting1 != null) {
        prop1 = setting1.explicitContentFriendDm;
      }
      obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = prop1;
      const ExplicitContentSettings2 = tmp12(3866).ExplicitContentSettings;
      const setting2 = ExplicitContentSettings2.getSetting();
      let prop2;
      if (setting2 != null) {
        prop2 = setting2.explicitContentNonFriendDm;
      }
      obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop2;
      tmp = obj;
    }
    let tmp9;
    if (tmp != null) {
      tmp9 = tmp[tmp7(undefined, 5883).ContentHarmTypeChannel.GUILD];
    }
    obj = { [closure_0(closure_1[3]).ContentHarmTypeChannel.GUILD]: require(5884) /* resolveExplicitContentSettingWithDefaults */.resolveExplicitContentSettingWithDefaults({ setting: tmp9 }) };
    let tmp7Result = tmp7(5884);
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 5883).ContentHarmTypeChannel.FRIEND_DM];
    }
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = tmp7Result.resolveExplicitContentSettingWithDefaults({ setting: tmp10, isDm: true, isFriend: true });
    tmp7Result = tmp7(5884);
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 5883).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = tmp7Result.resolveExplicitContentSettingWithDefaults({ setting: tmp11, isDm: true });
    return obj;
  }
};
const obj1 = {
...
obj[obj.GORE] = {
  ...
  getProtoUserSettings(textAndImages) {
    ...
    const obj = {};
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = goreContentGuilds;
    let goreContentFriendDm;
    if (goreContentSettings != null) {
      goreContentFriendDm = goreContentSettings.goreContentFriendDm;
    }
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = goreContentFriendDm;
    let prop;
    if (goreContentSettings != null) {
      prop = goreContentSettings.goreContentNonFriendDm;
    }
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = prop;
    return obj;
  },
  getUserSettingsWithDefaults(arg0) {
    let tmp = arg0;
    if (arg0 == null) {
      const GoreContentSettings3 = require(3866) /* explicitContentFromProto */.GoreContentSettings;
      ...
      let obj = {};
      obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = goreContentGuilds;
      const GoreContentSettings = tmp12(3866).GoreContentSettings;
      ...
      obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = goreContentFriendDm;
      const GoreContentSettings2 = tmp12(3866).GoreContentSettings;
    ...
    obj = { [closure_0(closure_1[3]).ContentHarmTypeChannel.GUILD]: require(5886) /* resolveGoreSettingWithDefaults */.resolveGoreSettingWithDefaults({ setting: tmp9 }) };
    let tmp7Result = tmp7(5886);
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 5883).ContentHarmTypeChannel.FRIEND_DM];
    }
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = tmp7Result.resolveGoreSettingWithDefaults({ setting: tmp10, isDm: true, isFriend: true });
    tmp7Result = tmp7(5886);
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 5883).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = tmp7Result.resolveGoreSettingWithDefaults({ setting: tmp11, isDm: true });
    return obj;
  }
};
const obj2 = {
...
obj[obj.SELF_HARM] = {
  ...
  getUserSettingsWithDefaults() {
    const obj = {};
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.GUILD] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.FRIEND_DM] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    obj[require(5883) /* ContentHarmTypeChannel */.ContentHarmTypeChannel.NON_FRIEND_DM] = require(1306) /* create */.ExplicitContentRedaction.UNSET_EXPLICIT_CONTENT_REDACTION;
    return obj;
  }
};
const obj3 = {
