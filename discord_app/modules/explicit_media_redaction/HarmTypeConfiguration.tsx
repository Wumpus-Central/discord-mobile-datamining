...
obj[obj.EXPLICIT] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    let tmp9;
    if (tmp != null) {
      tmp9 = tmp[ContentHarmTypeChannel.ContentHarmTypeChannel.GUILD];
    }
    ...
    let tmp7Result = resolveExplicitContentSettingWithDefaults;
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[ContentHarmTypeChannel.ContentHarmTypeChannel.FRIEND_DM];
    }
    ...
    tmp7Result = resolveExplicitContentSettingWithDefaults;
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[ContentHarmTypeChannel.ContentHarmTypeChannel.NON_FRIEND_DM];
    }
...
obj[obj.GORE] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    let tmp7Result = resolveGoreSettingWithDefaults;
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[ContentHarmTypeChannel.ContentHarmTypeChannel.FRIEND_DM];
    }
    ...
    tmp7Result = resolveGoreSettingWithDefaults;
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[ContentHarmTypeChannel.ContentHarmTypeChannel.NON_FRIEND_DM];
    }
...
const result = obj132.fileFinishedImporting("modules/explicit_media_redaction/HarmTypeConfiguration.tsx");
