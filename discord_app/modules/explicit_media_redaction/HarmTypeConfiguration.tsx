...
obj[obj.EXPLICIT] = {
  ...
  getUserSettingsWithDefaults(arg0) {
    ...
    let tmp9;
    if (tmp != null) {
      tmp9 = tmp[tmp7(undefined, 5976).ContentHarmTypeChannel.GUILD];
    }
    ...
    let tmp7Result = tmp7(5977);
    let tmp10;
    if (tmp != null) {
      tmp10 = tmp[tmp7(undefined, 5976).ContentHarmTypeChannel.FRIEND_DM];
    }
    ...
    tmp7Result = tmp7(5977);
    let tmp11;
    if (tmp != null) {
      tmp11 = tmp[tmp7(undefined, 5976).ContentHarmTypeChannel.NON_FRIEND_DM];
    }
