...
export const getShouldObscureForSetting = function getShouldObscureForSetting(tmp10Result) {
  return tmp10Result === create /* create */.ExplicitContentRedaction.BLUR || tmp10Result === create /* create */.ExplicitContentRedaction.BLOCK;
};
export const areSettingsEqual = function areSettingsEqual(arg0, arg1) {
  return apply /* apply */.isEqual(arg0, arg1);
};