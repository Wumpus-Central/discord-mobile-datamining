...
function ExplicitMediaFalsePositivePreview(url) {
  ...
  let obj = require(4735) /* openImagePickerUnhandled */;
  ...
  if (obj.isVideo(url)) {
    ...
    obj1[0] = url;
    obj[4] = obj1;
    let tmp3Result = tmp3(importDefault(8147), obj);
  } else {
...
export const handleSuccess = function handleSuccess(arg0) {
  ...
  obj = { key: "explicit_media_report_false_positive_success", icon: importDefault(9038), IconComponent: require(9037) /* ShieldIcon */.ShieldIcon, iconColor: "text-brand", content: null };
...
export const handleError = function handleError() {
  const intl = require(1236) /* getSystemLocale */.intl;
  require(3893) /* presentAddedFriendToast */.presentError(intl.string(require(1236) /* getSystemLocale */.t.R0RpRX));
};
