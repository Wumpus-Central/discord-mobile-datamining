...
export default function ExplicitMediaObscuredFalsePositiveActionSheet(channelId) {
  ...
  return jsx(channelId(9514).ExplicitMediaFalsePositiveActionSheet, {
    channelId,
    messageId,
    isReportFalsePositiveLoading: explicitMediaActions.isReportFalsePositiveLoading,
    onConfirmPress: callback,
    analyticsContext: channelId(7842).TrackMediaRedactionContext.EXPLICIT_MEDIA_SENDER_FALSE_POSITIVE_FLOW,
  });
}
