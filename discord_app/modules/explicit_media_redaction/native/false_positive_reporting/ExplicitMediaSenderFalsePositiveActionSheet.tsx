...
export default function ExplicitMediaObscuredFalsePositiveActionSheet(channelId) {
  ...
  return jsx(channelId(9543).ExplicitMediaFalsePositiveActionSheet, {
    channelId,
    messageId,
    isReportFalsePositiveLoading: explicitMediaActions.isReportFalsePositiveLoading,
    onConfirmPress: callback,
    analyticsContext: channelId(7708).TrackMediaRedactionContext.EXPLICIT_MEDIA_SENDER_FALSE_POSITIVE_FLOW,
  });
}
