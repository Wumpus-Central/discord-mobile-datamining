// === Module 15173: ExplicitMediaSettingsActionSheet ===
...
export default function ExplicitMediaSettingsActionSheet(options) {
  ...
  const items1 = [closure_5(options(7482).BottomSheetTitleHeader, { title, subtitle }), ];
  ...
  const tmp = closure_7();
  tmp4 = options;
  obj.children = closure_5(options(5990).TableRadioGroup, { defaultValue: SHOW, onChange: callback, hasIcons: false, children: options.map((label) => closure_1_5(options(dependencyMap[10]).TableRadioRow, { label: label.label, value: label.value }, label.value)) });
  items1[1] = closure_5(View, obj);
  obj2.children = items1;
  return closure_6(options(7483).BottomSheet, obj2);
};