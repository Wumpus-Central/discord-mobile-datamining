// === Module 15175: GuildHomeChannelRow ===
...
export default function GuildHomeChannelRow(selected) {
  ...
  obj[1] = tmp5(13064).SignPostIcon;
  obj[7] = jsx(tmp5(11602).BaseChannelIcon, { mode: DEFAULT, IconComponent: null });
  return jsx(importDefault(11602), { mode: DEFAULT, IconComponent: null });
};