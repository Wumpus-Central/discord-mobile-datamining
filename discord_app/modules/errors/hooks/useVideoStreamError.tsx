    ...
    () => {
      if (closure_1_2.getId() !== dependencyMap) {
        ...
        let arraySpreadResult = HermesBuiltin.arraySpread(
          closure_1_3.getActiveErrorsOfType(callback(9582).AVError.VIDEO_STREAM_RECEIVER_READY_TIMEOUT),
          0,
        );
        arraySpreadResult = HermesBuiltin.arraySpread(
          closure_1_3.getActiveErrorsOfType(callback(9582).AVError.VIDEO_STREAM_RECEIVER_READY_TIMEOUT_NO_STREAM),
          arraySpreadResult,
        );
