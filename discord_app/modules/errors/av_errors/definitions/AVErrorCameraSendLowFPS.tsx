// === Module 17282: AVErrorCameraSendLowFPSDefinition ===

// Module 17282 (AVErrorCameraSendLowFPSDefinition)
import setDefault from "set" /* 687 */;
import getReportInboundErrors from "getReportInboundErrors" /* 17268 */;
        ...
        if (rTCConnection.hasActiveRemoteWants()) {
          ...
          if (null != accumulatedStatsWithMinDatapoints) {
            if (accumulatedStatsWithMinDatapoints.short.frameRate < 10) {
              ...
              obj[0] = tmp4(9385).AVError.CAMERA_SEND_LOW_FPS;
              obj[1] = id.getId();
              const merged = Object.assign(tmp4(17265).getVoiceChannelErrorContext());
              const items = [obj];
              const tmp4Result = tmp4(17265);
              const tmp8 = items;
            }
            tmp7 = tmp8;
          }
