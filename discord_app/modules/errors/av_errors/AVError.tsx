...
let obj = {
  ...
  VIDEO_STREAM_SENDER_READY_TIMEOUT_NO_STREAM: "video-stream-sender-ready-timeout-no-stream",
  VIDEO_STREAM_RECEIVER_READY_TIMEOUT_NO_STREAM: "video-stream-receiver-ready-timeout-no-stream",
...
if (mapped.length !== set.size) {
  ...
  exports.AVUnderlyingError = {
    ...
    UploadErrorNoFile: "UploadErrorCodes.NO_FILE",
    UploadErrorProgress: "UploadErrorCodes.PROGRESS",
    UploadErrorUpload: "UploadErrorCodes.UPLOAD",
    UploadErrorRead: "UploadErrorCodes.READ",
    KrispCpuOveruse: "NoiseCancellerError.CPU_OVERUSE",
    KrispFailed: "NoiseCancellerError.FAILED",
    KrispVadCpuOveruse: "NoiseCancellerError.VAD_CPU_OVERUSE",
    KrispInitError: "NoiseCancellerError.INIT_ERROR",
    KrispInitErrorNative: "NoiseCancellerError.INIT_ERROR_NATIVE",
    KrispInitErrorSse4NotSupported: "NoiseCancellerError.KRISP_INIT_ERROR_SSE4_NOT_SUPPORTED",
    KrispInitErrorAvx2NotSupported: "NoiseCancellerError.KRISP_INIT_ERROR_AVX2_NOT_SUPPORTED",
    KrispInitErrorUnsigned: "NoiseCancellerError.KRISP_INIT_ERROR_UNSIGNED",
    KrispInitErrorGlobalInit: "NoiseCancellerError.KRISP_INIT_ERROR_GLOBAL_INIT",
    KrispInitErrorWeight8k: "NoiseCancellerError.KRISP_INIT_ERROR_WEIGHT_8K",
    KrispInitErrorWeight16k: "NoiseCancellerError.KRISP_INIT_ERROR_WEIGHT_16K",
    KrispInitErrorWeight32k: "NoiseCancellerError.KRISP_INIT_ERROR_WEIGHT_32K",
    KrispInitErrorWeightVad: "NoiseCancellerError.KRISP_INIT_ERROR_WEIGHT_VAD",
    VideoBackgroundUnsupported: "VideoBackgroundError.UNSUPPORTED",
    VideoBackgroundInitFailed: "VideoBackgroundError.INIT_FAILED",
  };
