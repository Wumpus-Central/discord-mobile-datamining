...
import ReleaseChannelUtils from "ReleaseChannelUtils" /* 7717 */;
import MetricEvents from "MetricEvents" /* 7721 */;
import AppCrashedReasons2 from "AppCrashedReasons" /* 14195 */;
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          _mod675.setTag("buildNumber", "6445");
