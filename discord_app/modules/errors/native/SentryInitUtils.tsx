...
import ReleaseChannelUtils from "ReleaseChannelUtils" /* 7799 */;
import MetricEvents from "MetricEvents" /* 7803 */;
import AppCrashedReasons2 from "AppCrashedReasons" /* 14290 */;
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          _mod675.setTag("buildNumber", "6453");
