...
import ReleaseChannelUtils from "ReleaseChannelUtils" /* 7711 */;
import MetricEvents from "MetricEvents" /* 7715 */;
import AppCrashedReasons2 from "AppCrashedReasons" /* 14187 */;
    ...
    const isUserStaffForCrashReporting = CrashReportingManager.getIsUserStaffForCrashReporting((arg0) => {
      ...
      if (-1 === ReleaseChannel.indexOf("debug")) {
        if (-1 === ReleaseChannel.indexOf("developer")) {
          ...
          _mod675.setTag("buildNumber", "6437");
