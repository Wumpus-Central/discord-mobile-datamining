...
export default function AgeVerificationGetStartedModal(entryPoint) {
  ...
  const memo1 = classificationId.useMemo(() => {
    ...
    obj[3] = function render() {
      return closeModal(callback(7734), { onClose: closeModal, modalSessionId: closure_0, entryPoint: callback });
    };
    obj[memo.INTRO] = obj;
    obj = {
      headerStyle: closeModalWithOnComplete.headerStyle,
    ...
    obj[3] = function render() {
      return closeModal(callback(7739), { onClose: closeModal, modalSessionId: closure_0 });
    };
    obj[memo.RETRY] = obj;
    const obj1 = {
      headerStyle: closeModalWithOnComplete.headerStyle,
    ...
    obj1[3] = function render(arg0, navigation) {
      return closeModal(callback(7740), { onClose: closeModalWithOnComplete, modalSessionId: closure_0, classificationId: dependencyMap, entryPoint: callback, navigation });
    };
    ...
    obj2[3] = function render() {
      return closeModal(callback(7731), { onClose: closeModalWithOnComplete, modalSessionId: closure_0 });
    };
