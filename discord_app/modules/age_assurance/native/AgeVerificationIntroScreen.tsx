...
export default function GetStartedScreen(onComplete) {
  ...
  const isManualAgeVerificationHidden = modalSessionId(8027).useIsManualAgeVerificationHidden(
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const result = v3(7853).trackAgeVerificationModalClicked(
              modalSessionId,
              v3(7853).AgeVerificationModalVersion.PRIMARY,
              v3(7853).AgeVerificationModalCta.GET_STARTED,
            );
            v1 = 1;
            v3 = 1;
