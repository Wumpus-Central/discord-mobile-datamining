...
export default function GetStartedScreen(onComplete) {
  ...
  const initiateAgeVerification = modalSessionId(4851).useInitiateAgeVerification({
    onComplete: onComplete.onClose,
    entryPoint,
  });
  ({ initiateAgeVerification: c1, loading } = initiateAgeVerification);
  let obj = modalSessionId(4851);
  const isManualAgeVerificationHidden = modalSessionId(8711).useIsManualAgeVerificationHidden(
  ...
  obj10.children = closure_6(modalSessionId).map((children, index) => {
    ...
    const obj = {
      index: index + 1,
      tip: closure_1_9(modalSessionId(4634).Text, {
    ...
    if (null != description) {
      ...
      tmpResult = closure_1_9(modalSessionId(4634).Text, obj2);
    }
  ...
  if (!isManualAgeVerificationHidden) {
    ...
    obj15.children = closure_9(tmp4(4634).Text, obj16);
      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const result = v3(8543).trackAgeVerificationModalClicked(
              modalSessionId,
              v3(8543).AgeVerificationModalVersion.PRIMARY,
              v3(8543).AgeVerificationModalCta.GET_STARTED,
            );
            v1 = 1;
            v3 = 1;
