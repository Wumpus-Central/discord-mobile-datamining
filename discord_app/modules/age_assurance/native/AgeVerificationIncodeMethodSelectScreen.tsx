...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    obj = {
      ...
      children: closure_9(tmp7(5591).ActivityIndicator, { size: "large" }),
    };
    obj.children = closure_9(tmp7(4987).Stack, obj);
    ...
    const items1 = [closure_9(tmp7(5706).ShieldSpotIllustration, { height: 100, width: 177 })];
    ...
    const items2 = [closure_9(tmp7(4570).Text, obj4)];
    ...
    items2[1] = closure_9(tmp7(4570).Text, obj5);
    obj3.children = items2;
    items1[1] = closure_10(tmp7(4987).Stack, obj3);
    obj2.children = items1;
    const items3 = [closure_10(tmp7(4987).Stack, obj2), ,];
    if (tmp6Result) {
      ...
      tmp6Result = closure_9(tmp7(4570).Text, obj6);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [closure_9(tmp7(5619).TableRow, obj8)];
    ...
    items4[1] = closure_9(tmp7(5619).TableRow, obj9);
    obj7.children = items4;
    items3[2] = closure_10(tmp7(5701).TableRowGroup, obj7);
    obj1.children = items3;
    obj.children = closure_10(tmp7(4987).Stack, obj1);
    obj.children = closure_9(ModalContent, obj);
    tmp11 = obj;
  }
