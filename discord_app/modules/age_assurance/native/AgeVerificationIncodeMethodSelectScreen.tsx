// === Module 8763: AgeVerificationIncodeMethodSelectScreen ===
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = { align: "center", justify: "center", spacing: 16, style: tmp5.loadingContainer, children: closure_9(tmp7(5880).ActivityIndicator, { size: "large" }) };
