...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = {
      ...
      children: closure_9(tmp7(5794).ActivityIndicator, { size: "large" }),
    };
    ...
    const items2 = [closure_9(tmp7(4752).Text, obj7)];
    ...
    items2[1] = closure_9(tmp7(4752).Text, obj8);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = closure_9(tmp7(4752).Text, obj9);
    }
    items3[1] = tmp6Result;
