...
const require = fn;
const VerificationMethod = fn(8758).VerificationMethod;
let closure_8 = fn(8761).buildIncodeParamsInjection;
const jsxProd = fn(21);
...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
        ...
        if (0 === c5) {
          ...
          if (2 === tmp8) {
            ...
            if (null != closure_129_1) {
              const obj7 = {
                apiUrl: closure_129_1.apiUrl,
                sessionToken: closure_129_1.sessionToken,
                consentId: closure_129_1.consentId,
                interviewId: closure_129_1.interviewId,
                theme: theme.theme,
                method: closure_129_0,
              };
  ...
  if (tmp2) {
    const obj3 = {
      ...
      children: closure_9(tmp7(5880).ActivityIndicator, { size: "large" }),
    };
    obj2.children = closure_9(tmp7(5269).Stack, obj3);
    ...
    const items1 = [closure_9(tmp7(5995).ShieldSpotIllustration, { height: 100, width: 177 })];
    ...
    obj7.children = intl.string(trustedOrigin(3036).eZvwAe);
    const items2 = [closure_9(tmp7(4823).Text, obj7)];
    const obj8 = { variant: "text-md/medium", color: "text-strong", style: tmp5.header, children: null };
    const intl2 = tmp7(1115).intl;
    obj8.children = intl2.string(trustedOrigin(3036)["5yWXmT"]);
    items2[1] = closure_9(tmp7(4823).Text, obj8);
    obj6.children = items2;
    items1[1] = closure_10(tmp7(5269).Stack, obj6);
    obj5.children = items1;
    const items3 = [closure_10(tmp7(5269).Stack, obj5), ,];
    if (tmp6Result) {
      ...
      tmp6Result = closure_9(tmp7(4823).Text, obj9);
    }
    items3[1] = tmp6Result;
    const obj10 = { hasIcons: false, children: null };
    const obj11 = { arrow: true, label: null, subLabel: null, onPress: null };
    const intl4 = tmp7(1115).intl;
    obj11.label = intl4.string(trustedOrigin(3036).rgXXcW);
    const intl5 = tmp7(1115).intl;
    obj11.subLabel = intl5.string(trustedOrigin(3036).fm7qBC);
    obj11.onPress = function onPress() {
      closure_4(VerificationMethod.FACIAL_AGE_ESTIMATION);
    };
    const items4 = [closure_9(tmp7(5908).TableRow, obj11)];
    const obj12 = { arrow: true, label: null, subLabel: null, onPress: null };
    const intl6 = tmp7(1115).intl;
    obj12.label = intl6.string(trustedOrigin(3036)["NeVlw/"]);
    const intl7 = tmp7(1115).intl;
    obj12.subLabel = intl7.string(trustedOrigin(3036).ARmJ0M);
    obj12.onPress = function onPress() {
      closure_4(VerificationMethod.ID_VERIFICATION);
    };
    items4[1] = closure_9(tmp7(5908).TableRow, obj12);
    obj10.children = items4;
    items3[2] = closure_10(tmp7(5990).TableRowGroup, obj10);
    obj4.children = items3;
    obj2.children = closure_10(tmp7(5269).Stack, obj4);
    obj.children = closure_9(ModalContent, obj2);
    tmp11 = obj;
  }
