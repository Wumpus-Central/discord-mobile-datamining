...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = {
      ...
      children: closure_9(tmp7(5662).ActivityIndicator, { size: "large" }),
    };
    obj2.children = closure_9(tmp7(5057).Stack, obj3);
    ...
    const items1 = [closure_9(tmp7(5777).ShieldSpotIllustration, { height: 100, width: 177 })];
    ...
    const items2 = [closure_9(tmp7(4635).Text, obj7)];
    ...
    items2[1] = closure_9(tmp7(4635).Text, obj8);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = closure_9(tmp7(4635).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [closure_9(tmp7(5690).TableRow, obj11)];
    ...
    items4[1] = closure_9(tmp7(5690).TableRow, obj12);
