...
export default function AgeVerificationIncodeMethodSelectScreen(onMethodSelected) {
  ...
  if (tmp2) {
    const obj3 = {
      ...
      children: closure_9(tmp7(5663).ActivityIndicator, { size: "large" }),
    };
    obj2.children = closure_9(tmp7(5058).Stack, obj3);
    ...
    const items1 = [closure_9(tmp7(5778).ShieldSpotIllustration, { height: 100, width: 177 })];
    ...
    const items2 = [closure_9(tmp7(4634).Text, obj7)];
    ...
    items2[1] = closure_9(tmp7(4634).Text, obj8);
    ...
    if (tmp6Result) {
      ...
      tmp6Result = closure_9(tmp7(4634).Text, obj9);
    }
    items3[1] = tmp6Result;
    ...
    const items4 = [closure_9(tmp7(5691).TableRow, obj11)];
    ...
    items4[1] = closure_9(tmp7(5691).TableRow, obj12);
