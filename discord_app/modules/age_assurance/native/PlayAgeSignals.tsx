// === Module 8572: PlayAgeSignals ===

// Module 8572 (PlayAgeSignals)
import NativePlayAgeSignalsModuleDefault from "NativePlayAgeSignalsModule" /* 8573 */;
...
let closure_4 = async function _getAgeSignals() {
  ...
  (function applyFakeAgeSignalsScenarioFromExperiment() {
    if (null != closure_1_1(dependencyMap[1])) {
      const fakePlayAgeSignalsConfig = closure_1_0(dependencyMap[2]).getFakePlayAgeSignalsConfig("PlayAgeSignals.getAgeSignals");
