...
import AppStoreAgeSignalSupport from "AppStoreAgeSignalSupport.tsx";
import AppStoreAgeSignalAttestation from "AppStoreAgeSignalAttestation.tsx";
import AppStoreAgeAssurance from "AppStoreAgeAssurance.android.tsx";
    ...
    try {
      ...
      if (0 === c4) {
        if (arg0 === 1) {
          ...
          c3 = 1;
          const obj6 = {
            firstAgeGate: AppStoreAgeSignalSupport.MIN_AGE_GATE,
            secondAgeGate: AppStoreAgeSignalSupport.ADULT_AGE_GATE,
          };
          c4 = 2;
          c5 = 1;
...
let closure_11 = async function _performAgeCheck(arg0) {
  ...
  if (1 === tmp7) {
    ...
    closure_130_1(closure_130_2[6]).captureException(closure_129_6, {
    ...
    if (arg0 === 1) {
      ...
      c6 = 1;
      return {
        value: closure_130_0(closure_130_2[9]).submitAgeSignal(closure_129_3, closure_129_5, closure_129_0),
        done: false,
      };
    }
  } else if (arg0 === 1) {
