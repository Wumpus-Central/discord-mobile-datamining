...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  const watchAgeVerificationStatusChange = modalSessionId(5041).useWatchAgeVerificationStatusChange(
  ...
  if ("loading" === tmp5.type) {
    ...
    items3[1] = closure_7(tmp(4825).Text, obj4);
    ...
    const items4 = [closure_7(tmp(4825).Text, obj6)];
