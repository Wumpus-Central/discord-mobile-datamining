...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  if ("loading" === tmp5.type) {
    ...
    obj4[3] = function onPress() {
      const result = modalSessionId(_undefined[21]).trackAgeVerificationModalClicked(
        modalSessionId,
        modalSessionId(_undefined[21]).AgeVerificationModalVersion.EXPRESSIVE_V2,
        modalSessionId(_undefined[21]).AgeVerificationModalCta.METHOD_SELECT,
      );
      callback();
    };
  ...
  obj5[0] = closure_7(modalSessionId(8422).ModalContent, {
    children: closure_7(modalSessionId(4973).Stack, {
      align: "center",
      justify: "center",
      spacing: 16,
      children: tmp15,
