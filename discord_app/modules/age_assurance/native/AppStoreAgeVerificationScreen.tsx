...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
          ...
          if (0 === c5) {
            ...
            if (1 === tmp7) {
              ...
              if (arg0 === 1) {
                ...
                c6 = 1;
                const obj7 = {
                  value: obj1.submitAgeSignal(closure_129_2, closure_129_4, false, "user_initiated"),
                  done: false,
                };
                return obj7;
              }
  ...
  if ("loading" === tmp5.type) {
    ...
    items3[1] = closure_7(tmp(4570).Text, obj);
    obj.children = items3;
    ...
    const items4 = [closure_7(tmp(4570).Text, obj2)];
    ...
    obj3.children = closure_7(tmp(4989).Button, obj4);
    items4[1] = closure_7(tmp(5447).ButtonGroup, obj3);
    obj1.children = items4;
    tmp15 = closure_9(closure_8, obj1);
  }
  let obj5 = { children: null };
  const tmp4 = callback1(noop.useState({ type: "loading" }), 2);
  obj5.children = closure_7(modalSessionId(8450).ModalContent, {
    children: closure_7(modalSessionId(4987).Stack, {
      align: "center",
      justify: "center",
      spacing: 16,
      children: tmp15,
  ...
  return closure_7(modalSessionId(8449).ModalScreen, obj5);
}
