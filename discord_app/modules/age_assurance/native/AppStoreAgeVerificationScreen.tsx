...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  let callback1;
  noop = undefined;
  let navigation = modalSessionId(1485).useNavigation();
  ...
  const watchAgeVerificationStatusChange = modalSessionId(5048).useWatchAgeVerificationStatusChange(
  ...
  if ("loading" === tmp5.type) {
    ...
    items3[1] = closure_7(tmp(4832).Text, obj4);
    ...
    const items4 = [closure_7(tmp(4832).Text, obj6)];
    ...
    obj7.children = closure_7(tmp(5281).Button, obj8);
    items4[1] = closure_7(tmp(5745).ButtonGroup, obj7);
    obj5.children = items4;
    tmp15 = closure_9(closure_8, obj5);
  }
  let obj9 = { children: null };
  let obj2 = modalSessionId(5048);
  obj9.children = closure_7(modalSessionId(7871).ModalContent, {
    children: closure_7(modalSessionId(5279).Stack, {
      align: "center",
      justify: "center",
      spacing: 16,
      children: tmp15,
