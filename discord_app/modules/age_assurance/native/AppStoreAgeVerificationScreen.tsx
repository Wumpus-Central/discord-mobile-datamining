...
export default function AppStoreAgeVerificationScreen(modalSessionId) {
  ...
  obj5.children = closure_7(modalSessionId(8450).ModalContent, { children: closure_7(modalSessionId(4987).Stack, { align: "center", justify: "center", spacing: 16, children: tmp15 }) });
