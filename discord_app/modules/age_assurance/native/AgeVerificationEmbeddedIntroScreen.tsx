...
export default function AgeVerificationEmbeddedIntroScreen(arg0) {
  ...
  const obj5 = {
    ...
    color: "text-strong",
    style: tmp.header,
    children: navigation(4818).getAgeVerificationGetStartedSubtitle(entryPoint, undefined, isSuspendedUser),
  };
  ...
  const items3 = [
    closure_6(navigation(5023).Stack, obj2),
    closure_5(navigation(8654).AgeVerificationMethodsContainer, {
