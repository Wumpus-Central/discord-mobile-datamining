...
export default function AgeVerificationEmbeddedIntroScreen(arg0) {
  ...
  obj2[3] = items1;
  const items3 = [callback2(navigation(4733).Stack, obj2), callback(navigation(6699).AgeVerificationMethodsContainer, { ageVerificationMethods: useAgeVerificationMethods({ onClose, classificationId, onGoogleWalletSelect: callback }).ageVerificationMethods, modalSessionId })];
  obj1[3] = items3;
