...
export default function AgeVerificationEmbeddedIntroScreen(arg0) {
  ...
  const obj5 = {
    ...
    color: "text-strong",
    style: tmp.header,
    children: navigation(4787).getAgeVerificationGetStartedSubtitle(entryPoint, undefined, isSuspendedUser),
  };
  ...
  const items3 = [
    closure_6(navigation(4987).Stack, obj2),
    closure_5(navigation(8617).AgeVerificationMethodsContainer, {
