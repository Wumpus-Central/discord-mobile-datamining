...
function MethodsScreen(onClose) {
  ...
  const initiateAgeVerificationV2 = obj2.useInitiateAgeVerificationV2({ onComplete, entryPoint, onMethodUnavailable: refetch }).initiateAgeVerificationV2;
  ...
  if (isAgeVerificationCustomTabOpen) {
    ...
    tmp23Result = loading;
    if (loading) {
      obj5 = { align: "center", justify: "center", style: tmp.loadingContainer, children: tmp23(closure_6, { size: "large" }) };
