...
function MethodsScreen(onClose) {
  ...
  const shouldShowExpressiveModalSubtitleAlt =
    require("ShowExpressiveModalSubtitleAltFlag").useShouldShowExpressiveModalSubtitleAlt(
  ...
  const callback1 = onComplete.useCallback(() => {
    if (obj.isAgeVerified()) {
      ...
      let isAgeVerificationAuthSessionAwaitingResult =
        AgeVerificationAuthSession.getIsAgeVerificationAuthSessionAwaitingResult();
  ...
  const watchAgeVerificationStatusChange =
    require("AgeVerificationUtils").useWatchAgeVerificationStatusChange(callback1);
  ...
  if (isAgeVerificationCustomTabOpen) {
    ...
    obj12.children = tmp2Result2.getAgeVerificationGetStartedSubtitle(
      entryPoint,
      () => {
