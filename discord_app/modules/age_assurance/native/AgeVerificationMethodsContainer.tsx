...
export const AgeVerificationMethodsContainer = function AgeVerificationMethodsContainer(ageVerificationMethods) {
  ...
  if (null != prop) {
    ...
    obj.children = items1;
    const items2 = [closure_7(prop(5023).Stack, obj)];
    ...
    if (isSuspendedUser) {
      ...
      tmp7Result = closure_6(tmp2(4601).Text, obj2);
    }
    const obj4 = { spacing: 8, align: "center", children: null };
    items2[1] = tmp7Result;
    obj4.children = items2;
    return closure_7(prop(5023).Stack, obj4);
  }
  ...
  const items3 = [closure_6(prop(4601).Text, obj6)];
  ...
  obj8.onPress = prop(8482).getAgeVerificationMethods;
  obj7.children = closure_6(prop(5025).Button, obj8);
  items3[1] = closure_6(prop(5483).ButtonGroup, obj7);
  obj5.children = items3;
  mapped = closure_7(tmp2(5023).Stack, obj5);
};
