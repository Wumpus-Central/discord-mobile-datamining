...
import AppStoreAgeSignalActionCreators from "AppStoreAgeSignalActionCreators.tsx";
import NativeAppAttestModuleDefault from "../../../../discord_common/js/packages/rtn-codegen/js/NativeAppAttestModule.tsx";
import NativePlayIntegrityModuleDefault from "../../../../discord_common/js/packages/rtn-codegen/js/NativePlayIntegrityModule.tsx";
...
let closure_11 = async function _registerAttestKey(arg0) {
  if (c4 === 2) {
    c4 = 3;
      ...
      if (0 === c3) {
        if (arg0 === 1) {
          ...
          if (null != NativeAppAttestModuleDefault) {
            c3 = 1;
            c4 = 1;
            const obj5 = { value: NativeAppAttestModuleDefault.generateAndAttestKey(closure_0), done: false };
            return obj5;
          }
        }
      } else if (1 === tmp5) {
        if (arg0 === 1) {
          ...
          c4 = 1;
          const obj7 = {
            value: closure_130_0(closure_130_2[2]).registerAgeSignalAttestKey(keyId, attestation),
            done: false,
          };
          return obj7;
        }
...
let closure_12 = async function _getAppStoreAgeSignalAssertion(arg0) {
  if (c9 === 2) {
    c9 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp6 === 3) {
            ...
            if (null == closure_133_3) {
              ...
              if (null != closure_133_4) {
                if (closure_133_3.attestKeyRegistered) {
                  ...
                  const assertion = closure_134_1(closure_134_2[4]).generateAssertion(
                    closure_133_4,
                    closure_134_7(nonce, closure_133_0, closure_133_1),
                  );
                  c8 = 4;
                  c9 = 1;
...
let closure_13 = async function _requestPlayIntegrityToken() {
  ...
  if (null != tmp20) {
    if (null != NativePlayIntegrityModuleDefault) {
      c3 = 1;
      const items = [NativePlayIntegrityModuleDefault.requestIntegrityToken(closure_0, tmp20)];
      NativePlayIntegrityModuleDefault;
      TimeUtils;
      items[1] = TimeUtils.sleep(15000).then(() => {});
      c2 = 2;
      c1 = 1;
...
let closure_14 = async function _getAgeSignalChallenge() {
  if (c0 === 2) {
    c0 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp5 === 3) {
      ...
      if (0 === c1) {
        if (arg0 === 1) {
          ...
          if (obj3.isAndroid()) {
            ...
            c1 = 2;
            c0 = 1;
            const obj5 = { value: AppStoreAgeSignalActionCreators.requestAgeSignalChallenge("android"), done: false };
            return obj5;
          } else {
            c0 = 3;
            return { value: "HermesInternal", done: null };
...
let closure_15 = async function _getAgeSignalIntegrityToken(arg0) {
  if (c2 === 2) {
    c2 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp3 === 3) {
