  ...
  const callback2 = callback.useCallback(navigation(function*() {
    ...
    if (1 === tmp7) {
      ...
      if ("CANCELLED" === code) {
        ...
        let obj2 = { name: onClose(tmp51[10]).MetricEvents.GOOGLE_WALLET_VERIFICATION_FAILED, tags: ["reason:user_cancelled"] };
        ...
        if ("unsupported_issuing_country" === reason) {
          ...
          obj8.increment({ name: onClose(tmp51[10]).MetricEvents.GOOGLE_WALLET_VERIFICATION_FAILED, tags: ["reason:unsupported_issuing_country"] });
