// === Module 8701: AgeVerificationAuthSession ===

// Module 8701 (AgeVerificationAuthSession)
import LoggerDefault from "Logger" /* 3 */;
import PlatformUtils from "PlatformUtils" /* 1364 */;
import NativeBrowserManagerModuleIOSDefault from "NativeBrowserManagerModuleIOS" /* 4723 */;
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          if (obj8.isIOS()) {
            ...
            c5 = 2;
            c6 = 1;
            const obj5 = { value: NativeBrowserManagerModuleIOSDefault.openAuthSessionURL(closure_0, true), done: false };
            return obj5;
          } else {
            c6 = 3;
