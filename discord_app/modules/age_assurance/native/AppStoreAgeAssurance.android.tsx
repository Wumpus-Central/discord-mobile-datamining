...
require = fn;
let closure_3 = {
  [fn(8696).AgeSignalsStatus.SHARED]: "SHARED",
  [fn(8696).AgeSignalsStatus.NOT_SHARED]: "NOT_SHARED",
  [fn(8696).AgeSignalsStatus.VERIFICATION_REQUIRED]: "VERIFICATION_REQUIRED",
};
let closure_4 = {
  [fn(8696).AgeRangeSource.TIER_A]: "TIER_A",
  [fn(8696).AgeRangeSource.TIER_B]: "TIER_B",
  [fn(8696).AgeRangeSource.TIER_C]: "TIER_C",
  [fn(8696).AgeRangeSource.TIER_D]: "TIER_D",
};
let closure_5 = {
  [fn(8696).SignificantChangeStatus.APPROVED]: "APPROVED",
  [fn(8696).SignificantChangeStatus.PENDING]: "PENDING",
  [fn(8696).SignificantChangeStatus.DECLINED]: "DECLINED",
};
const size = fn(2);
