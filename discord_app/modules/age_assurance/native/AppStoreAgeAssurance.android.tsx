...
require = fn;
let closure_3 = {
  [fn(8575).AgeSignalsStatus.SHARED]: "SHARED",
  [fn(8575).AgeSignalsStatus.NOT_SHARED]: "NOT_SHARED",
  [fn(8575).AgeSignalsStatus.VERIFICATION_REQUIRED]: "VERIFICATION_REQUIRED",
};
let closure_4 = {
  [fn(8575).AgeRangeSource.TIER_A]: "TIER_A",
  [fn(8575).AgeRangeSource.TIER_B]: "TIER_B",
  [fn(8575).AgeRangeSource.TIER_C]: "TIER_C",
  [fn(8575).AgeRangeSource.TIER_D]: "TIER_D",
};
let closure_5 = {
  [fn(8575).SignificantChangeStatus.APPROVED]: "APPROVED",
  [fn(8575).SignificantChangeStatus.PENDING]: "PENDING",
  [fn(8575).SignificantChangeStatus.DECLINED]: "DECLINED",
};
const size = fn(2);
