...
let closure_11 = fn(8414).AGE_VERIFICATION_INCODE_PATH;
    ...
    if (obj.isMetaQuest()) {
      ...
      if (tmpResult2.isAgeVerificationIncodeEnabled(entryPoint)) {
        ...
        if (tmpResult3.isExpressiveModalV2Enabled(entryPoint)) {
          ...
          UserStore = tmp(8578).isAgeVerificationExpressiveModalEverywhereEnabled(entryPoint);
