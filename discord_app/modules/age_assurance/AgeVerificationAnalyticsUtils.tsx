...
const result = require("obj132").fileFinishedImporting("modules/age_assurance/AgeVerificationAnalyticsUtils.tsx");
...
export const trackAgeVerificationModalClicked = function trackAgeVerificationModalClicked(modalSessionId, PRIMARY, METHOD_SELECT, GOOGLE_WALLET) {
  const obj = { modal_session_id: modalSessionId, modal_version: PRIMARY, cta: METHOD_SELECT, method: GOOGLE_WALLET };
