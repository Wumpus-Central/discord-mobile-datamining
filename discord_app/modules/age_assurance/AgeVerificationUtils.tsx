...
let items = [
  fn(8478).AgeVerificationModalEntryPoint.STAGE_CHANNEL_AGE_VERIFICATION_PROMPT,
  fn(8478).AgeVerificationModalEntryPoint.START_STAGE_PROMPT,
  fn(8478).AgeVerificationModalEntryPoint.STAGE_CHANNEL_RAISE_HAND,
];
