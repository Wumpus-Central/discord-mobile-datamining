...
function useShouldCallReactiveCheck() {
  ...
  const isFeatureAgeGated = require("RegionalFeatureConfigUtils").useIsFeatureAgeGated(
    tmp(5512).AgeGatedFeature.REACTIVE_CHECK,
  );
...
let items = [
  fn(8562).AgeVerificationModalEntryPoint.STAGE_CHANNEL_AGE_VERIFICATION_PROMPT,
  fn(8562).AgeVerificationModalEntryPoint.START_STAGE_PROMPT,
  fn(8562).AgeVerificationModalEntryPoint.STAGE_CHANNEL_RAISE_HAND,
];
