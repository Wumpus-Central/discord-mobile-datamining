...
function useShouldCallReactiveCheck() {
  ...
  const isFeatureAgeGated = require("RegionalFeatureConfigUtils").useIsFeatureAgeGated(
    tmp(5727).AgeGatedFeature.REACTIVE_CHECK,
  );
...
let items = [
  fn(8759).AgeVerificationModalEntryPoint.STAGE_CHANNEL_AGE_VERIFICATION_PROMPT,
  fn(8759).AgeVerificationModalEntryPoint.START_STAGE_PROMPT,
  fn(8759).AgeVerificationModalEntryPoint.STAGE_CHANNEL_RAISE_HAND,
];
