...
export const useAgeVerificationMethodsV2 = function useAgeVerificationMethodsV2() {
  ...
  [tmp4, importDefault] = _slicedToArray(
    noop.useState(() => callback.methodsV2FooterMessage),
    2,
  );
  ...
  [tmp6, dependencyMap] = _slicedToArray(
    noop.useState(() => callback.methodsV2OutageBannerMessage),
    2,
  );
  const tmp7 = _slicedToArray(
    noop.useState(() => null == callback.methodsV2),
    2,
  );
        ...
        if (0 === c5) {
          ...
          if (2 === tmp9) {
            ...
            obj5 = {
              ...
              methods: closure_129_0.methods,
              footerMessage: closure_129_0.footerMessage,
              outageBannerMessage: closure_129_0.outageBannerMessage,
            };
            obj1.dispatch(obj5);
            if (c5.current) {
