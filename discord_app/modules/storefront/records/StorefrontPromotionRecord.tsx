...
prototype["createFromServer"] = function createFromServer(display_name) {
  ...
  if (tmp14 != display_name.tenant_metadata) {
    ...
    if (tmp14 == tenant_metadata.collectibles) {
      ...
      const obj10 = { type: obj27(8822).StorefrontPromotionCollectiblesType.COLLECT_AND_CLAIM, subtype: obj27(8822).StorefrontPromotionCollectAndClaimSubtype.TAKEOVER, collectionId: collectibles.collection_id, shopHome: null, indexPage: null, shared: null };
