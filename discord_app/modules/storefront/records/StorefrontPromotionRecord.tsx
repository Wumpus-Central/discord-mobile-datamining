...
prototype["createFromServer"] = function createFromServer(display_name) {
  ...
  if (tmp14 != display_name.tenant_metadata) {
    ...
    if (tmp14 == tenant_metadata.collectibles) {
      ...
      const obj10 = { type: obj31(8915).StorefrontPromotionCollectiblesType.COLLECT_AND_CLAIM, subtype: obj31(8915).StorefrontPromotionCollectAndClaimSubtype.TAKEOVER, collectionId: collectibles.collection_id, shopHome: null, indexPage: null, shared: null };
      ...
      const obj29 = { hiddenAssetPath: progress_indicator.assets.reward_preview.hidden_asset_path, revealedAssetPath: progress_indicator.assets.reward_preview.revealed_asset_path };
  ...
  if (typeof prototype === "function") {
    const tmp54 = new prototype(tmp22, tmp12, tmp11, tmp10, tmp9, tmp8, tmp7, tmp6, tmp5, tmp4, tmp3, tmp2, tmp, _Date2, _Date, prototype, new.target, id);
    tmp54.id = id;
