...
export const GuildBadgeForce = function GuildBadgeForce(width) {
  ...
  obj = {
    ...
    primaryTintColor,
    primaryTintLuminances: closure_7,
    primaryLuminanceWeights: items,
    secondaryBaseColors: closure_6,
    secondaryTintColor,
    secondaryTintLuminances: closure_9,
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M7 1H4v1h3V1ZM11 2H7v1h4V2Z", fill: secondaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M15 3h-4v1h4V3Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M7 15H4v1h3v-1Z", fill: "#000" }),
    callback(inlineStyles.Path, {
      d: "M6 14v-1H5v-2H4V5h1V3h1V2H4v1H2v4H1v4h1v2h1v1h1v1h3v-1H6Z",
      fill: secondaryColorsTransformed[1],
    }),
    callback(inlineStyles.Path, { d: "M7 14H4v1h3v-1Z", fill: secondaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M11 14H7v1h4v-1Z", fill: "#000" }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M2 5H1v2h1V5ZM6 5H5v2h1V5Z", fill: secondaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M5 3H4v2h1V3Z", fill: secondaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M11 3h-1v1h1V3Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M4 2H3v1h1V2Z", fill: secondaryColorsTransformed[2] }),
    callback(inlineStyles.Path, {
  ...
  items[19] = callback(inlineStyles.Path, {
