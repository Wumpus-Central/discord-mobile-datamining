...
export const GuildBadgeMoon = function GuildBadgeMoon(primaryTintColor) {
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M6 0H4v1h2V0ZM2 3H1v2h1V3ZM5 3H4v4h1V3ZM10 8H6v1h4V8Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M10 9H6v1h4V9Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M1 5H0v6h1V5ZM11 15H5v1h6v-1Z", fill: "#000" }),
    callback(inlineStyles.Path, {
      d: "M2 10H1v1h1v-1ZM13 12h-2v1H5v-1H3v-1H2v2h1v1h2v1h6v-1h2v-1h1v-2h-1v1ZM15 10h-1v1h1v-1Z",
      fill: primaryColorsTransformed[0],
    }),
    callback(inlineStyles.Path, { d: "M4 1H3v1h1V1ZM3 2H2v1h1V2Z", fill: "#000" }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M5 2H4v1h1V2Z", fill: primaryColorsTransformed[1] }),
  ];
  obj.children = items;
