...
export const GuildBadgeWind = function GuildBadgeWind(width) {
  ...
  items = [
    ...
    React2(inlineStyles.Path, { d: "M9 6v1H8v2h1v2h2v1h3v-1h1V6H9Z", fill: secondaryColorsTransformed[1] }),
    React2(inlineStyles.Path, { d: "M4 10v4h1v1h3v-1h1v-4H4Z", fill: secondaryColorsTransformed[1] }),
    React2(inlineStyles.Path, {
      d: "M8 14H5v1h3v-1ZM14 11h-3v1h3v-1ZM15 10h-1v1h1v-1ZM9 13H8v1h1v-1Z",
      fill: secondaryColorsTransformed[0],
    }),
    React2(inlineStyles.Path, { d: "M9 7H8v1h1V7ZM11 8h-1v1h1V8ZM14 6H9v1h5V6Z", fill: secondaryColorsTransformed[2] }),
    React2(inlineStyles.Path, { d: "M8 1H7v1h1V1ZM15 3h-1v1h1V3ZM14 8h-1v2h1V8ZM9 6H8v1h1V6Z", fill: "#000" }),
    React2(inlineStyles.Path, { d: "M9 5H8v1h1V5Z", fill: primaryColorsTransformed[0] }),
    React2(inlineStyles.Path, { d: "M3 9H2v1h1V9ZM7 13H6v1h1v-1ZM6 12H5v1h1v-1Z", fill: "#000" }),
    React2(inlineStyles.Path, {
    ...
    React2(inlineStyles.Path, { d: "M8 2H7v1h1V2ZM12 1H8v1h4V1Z", fill: primaryColorsTransformed[2] }),
    React2(inlineStyles.Path, { d: "M14 5H9v1h5V5Z", fill: "#000" }),
    React2(inlineStyles.Path, { d: "M14 4V3h-1v1H9v1h5v1h1V4h-1Z", fill: primaryColorsTransformed[0] }),
    React2(inlineStyles.Path, { d: "M5 11H4v1h1v-1Z", fill: secondaryColorsTransformed[2] }),
    React2(inlineStyles.Path, { d: "M7 6v1H3v1h5V6H7Z", fill: primaryColorsTransformed[0] }),
    React2(inlineStyles.Path, { d: "M7 7v1H3v1h5V7H7Z", fill: "#000" }),
    React2(inlineStyles.Path, { d: "M3 8H2v1h1V8ZM2 9H1v1h1V9Z", fill: primaryColorsTransformed[0] }),
    React2(inlineStyles.Path, { d: "M3 9v1H2v1H1v4h1v-1h1v-3h1v-1h4V9H3Z", fill: secondaryColorsTransformed[1] }),
    React2(inlineStyles.Path, { d: "M3 10H2v1h1v-1ZM2 11H1v1h1v-1Z", fill: secondaryColorsTransformed[2] }),
    React2(inlineStyles.Path, { d: "M3 13H2v1h1v-1ZM2 14H1v1h1v-1Z", fill: secondaryColorsTransformed[0] }),
    React2(inlineStyles.Path, { d: "M8 9H3v1h5V9Z", fill: secondaryColorsTransformed[2] }),
  ];
  obj.children = items;
