...
export const GuildBadgeLightning = function GuildBadgeLightning(primaryTintColor) {
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M1 7H0v2h1V7Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M2 7H1v2h1V7Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M16 7h-1v2h1V7ZM3 6H1v1h2V6ZM6 4H4v1h2V4ZM4 5H3v1h1V5Z", fill: "#000" }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M15 7h-1v1h1V7Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, {
      d: "M11 3h-1v1h1V3ZM10 4H9v1h1V4ZM9 5H8v1h1V5ZM8 6H7v1h1V6Z",
      fill: primaryColorsTransformed[0],
    }),
    callback(inlineStyles.Path, { d: "M10 2H9v1h1V2Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M9 2H7v1h2V2ZM7 3H6v1h1V3ZM13 0h-3v1h3V0Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M13 1h-3v1h3V1Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M11 2h-1v1h1V2Z", fill: primaryColorsTransformed[1] }),
  ];
  obj.children = items;
