...
export const GuildBadgeCompass = function GuildBadgeCompass(width) {
  ...
  items = [
    ...
    React2(inlineStyles.Path, { d: "M7 0v1h2V0H7Z", fill: "#000" }),
    React2(inlineStyles.Path, { d: "M7 1v1h2V1H7Z", fill: secondaryColorsTransformed[2] }),
    React2(inlineStyles.Path, { d: "M7 6v1h2V6H7Z", fill: secondaryColorsTransformed[0] }),
    React2(inlineStyles.Path, { d: "M7 1H6v2h1V1ZM1 7H0v2h1V7ZM3 7V6H1v1h2ZM6 3H5v1h1V3Z", fill: "#000" }),
    React2(inlineStyles.Path, { d: "M6 4H5v1h1V4ZM7 3H6v1h1V3Z", fill: secondaryColorsTransformed[2] }),
    React2(inlineStyles.Path, { d: "M7 9v1h2V9H7Z", fill: secondaryColorsTransformed[2] }),
    React2(inlineStyles.Path, {
      d: "M7 14v1h2v-1H7ZM7 12H6v1h1v-1ZM6 11H5v1h1v-1Z",
      fill: primaryColorsTransformed[0],
    }),
    React2(inlineStyles.Path, { d: "M7 10H6v1h1v-1Z", fill: secondaryColorsTransformed[2] }),
    React2(inlineStyles.Path, {
      d: "M9 13h1v-1H9v1ZM10 12h1v-1h-1v1ZM9 11h1v-1H9v1Z",
      fill: primaryColorsTransformed[0],
    }),
    React2(inlineStyles.Path, { d: "M8 4H7v1h1V4Z", fill: secondaryColorsTransformed[2] }),
    React2(inlineStyles.Path, { d: "M10 5H9v1h1V5ZM11 4h-1v1h1V4Z", fill: secondaryColorsTransformed[0] }),
    React2(inlineStyles.Path, { d: "M12 10h1V9h2V7h-2V6h-1V5h-1v1h-1v1H9v2h1v1h1v1h1v-1Z", fill: "#C7C7C7" }),
    React2(inlineStyles.Path, { d: "M15 7h-1v2h1V7Z", fill: "#707070" }),
    React2(inlineStyles.Path, { d: "M12 6V5h-1v1h1ZM11 7V6h-1v1h1Z", fill: "#fff" }),
    React2(inlineStyles.Path, {
      d: "M11 10V9h-1v1h1ZM10 9V8H9v1h1ZM13 10V9h-1v1h1ZM12 11v-1h-1v1h1Z",
      fill: "#707070",
    }),
    React2(inlineStyles.Path, { d: "M4 10H3V9H1V7h2V6h1V5h1v1h1v1h1v2H6v1H5v1H4v-1Z", fill: "#C7C7C7" }),
    React2(inlineStyles.Path, { d: "M1 9h1V7H1v2Z", fill: "#fff" }),
    React2(inlineStyles.Path, { d: "M6 9h1V7H6v2Z", fill: "#707070" }),
    React2(inlineStyles.Path, { d: "M5 6V5H4v1h1ZM4 7V6H3v1h1ZM5 8V7H4v1h1Z", fill: "#fff" }),
    React2(inlineStyles.Path, { d: "M6 10V9H5v1h1ZM5 11v-1H4v1h1Z", fill: "#707070" }),
    React2(inlineStyles.Path, {
