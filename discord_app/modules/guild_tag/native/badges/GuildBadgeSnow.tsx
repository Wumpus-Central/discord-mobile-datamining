...
export const GuildBadgeSnow = function GuildBadgeSnow(width) {
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M9 4H8v2h1V4ZM13 4h-2v1h2V4Z", fill: "#000" }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M9 6H8V5H4v1H3v4h1v1h4v-1h1V6Z", fill: secondaryColorsTransformed[1] }),
    callback(inlineStyles.Path, {
      d: "M8 10H4v1h4v-1ZM4 9H3v1h1V9ZM9 9H8v1h1V9Z",
      fill: secondaryColorsTransformed[0],
    }),
    callback(inlineStyles.Path, { d: "M4 6H3v1h1V6ZM6 7H5v1h1V7ZM8 5H4v1h4V5Z", fill: secondaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M8 13H7v1h1v-1Z", fill: "#000" }),
    callback(inlineStyles.Path, {
