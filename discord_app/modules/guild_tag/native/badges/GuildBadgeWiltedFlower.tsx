...
export const GuildBadgeWiltedFlower = function GuildBadgeWiltedFlower(width) {
  ...
  items = [
    ...
    React2(inlineStyles.Path, { d: "M2 10H1v-1h1v1ZM8 10h-1v-1h1v1ZM9 7h-1V4h1v3ZM10 4h-1v-1h1v1Z", fill: "white" }),
    React2(inlineStyles.Path, {
    ...
    React2(inlineStyles.Path, { d: "M11 9h1v1h-1v1H8v-1h1v-1h1v-1h1v1Z", fill: primaryColorsTransformed[1] }),
    React2(inlineStyles.Path, {
  ...
  items[7] = React2(inlineStyles.Path, {
