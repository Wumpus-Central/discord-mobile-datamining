...
export const GuildBadgeSkull = function GuildBadgeSkull(primaryTintColor) {
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M7 8H5v2h2V8Z", fill: primaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M12 7H9v3h3V7Z", fill: primaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M12 8h-2v2h2V8Z", fill: primaryColorsTransformed[0] }),
    callback(inlineStyles.Path, {
      d: "M12 12.01h1v-1h-1v1ZM11 14.01h1v-1h-1v1ZM13 11.01h1v-1h-1v1Z",
      fill: primaryColorsTransformed[1],
    }),
    callback(inlineStyles.Path, { d: "M1 4H0v6h1V4Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M2 4H1v6h1V4Z", fill: "#fff" }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M14 10.01h1v-6h-1v6Z", fill: primaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M4 0v1h8V0H4Z", fill: "#000" }),
    callback(inlineStyles.Path, {
      d: "M4 2H3v1h1V2ZM3 3H2v1h1V3ZM4 4H3v1h1V4ZM12 3.01h1v-1h-1v1ZM13 4.01h1v-1h-1v1ZM4 1v1h8V1H4Z",
      fill: "#fff",
    }),
    callback(inlineStyles.Path, { d: "M5 15v1h6v-1H5Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M5 14v1h6v-1H5Z", fill: primaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M7 13H6v2h1v-2ZM10 13H9v2h1v-2Z", fill: primaryColorsTransformed[0] }),
  ];
  obj.children = items;
