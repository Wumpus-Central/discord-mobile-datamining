...
export const GuildBadgeSound = function GuildBadgeSound(width) {
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M11 7H9V6H7v1H5v2h2v1h2V9h2V7Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M3 0H1v1h2V0ZM5 1H3v1h2V1ZM4 5H2v1h2V5ZM1 1H0v2h1V1Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M3 1H1v2h1V2h1V1Z", fill: secondaryColorsTransformed[2] }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M3 15v-1h2v-2H4v-1H2v2H1v2h2Z", fill: secondaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M2 13H1v1h1v-1Z", fill: secondaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M5 4H4v1h1V4Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M5 2H2v3h2V4h1V2ZM14 5V2h-3v2h1v1h2Z", fill: secondaryColorsTransformed[1] }),
    callback(inlineStyles.Path, {
      d: "M5 2H4v2h1V2ZM4 4H3v1h1V4ZM14 3h-1v2h1V3ZM15 2h-1v1h1V2Z",
      fill: secondaryColorsTransformed[0],
    }),
    callback(inlineStyles.Path, { d: "M13 15v-1h-2v-2h1v-1h2v2h1v2h-2Z", fill: secondaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M15 13h-1v1h1v-1ZM14 11h-1v1h1v-1Z", fill: secondaryColorsTransformed[0] }),
    callback(inlineStyles.Path, {
      d: "M2 6H1v1h1V6ZM16 7h-1v2h1V7ZM15 6h-1v1h1V6ZM10 1H9v1h1V1ZM12 4h-1v1h1V4ZM9 0H7v1h2V0Z",
      fill: "#000",
    }),
    callback(inlineStyles.Path, { d: "M9 1H7v1h2V1ZM9 7H7v2h2V7Z", fill: primaryColorsTransformed[3] }),
    callback(inlineStyles.Path, { d: "M15 1h-2v1h2V1ZM13 2h-2v1h2V2Z", fill: secondaryColorsTransformed[2] }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M5 12H4v2h1v-2ZM4 11H3v1h1v-1Z", fill: secondaryColorsTransformed[0] }),
    callback(inlineStyles.Path, {
