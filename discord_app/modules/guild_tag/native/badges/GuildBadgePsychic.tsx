...
export const GuildBadgePsychic = function GuildBadgePsychic(width) {
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M15 1h-2v1h2V1Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M3 13H1v1h2v-1Z", fill: primaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M4 14H1v1h3v-1Z", fill: primaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M15 8h-1v2h1V8Z", fill: secondaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M12 1H6v1h6V1Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M12 2H6v1h6V2Z", fill: secondaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M10 14H5v1h5v-1Z", fill: secondaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M15 2h-1v1h1V2Z", fill: primaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M6 5H5v1h1V5ZM3 4H2v1h1V4ZM4 3H3v1h1V3Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M6 3H5v1h1V3ZM13 3h-1v1h1V3Z", fill: secondaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M5 2H4v1h1V2ZM7 6H6v1h1V6ZM2 12H1v1h1v-1Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M12 2h1V1h2V0H6v1h6v1ZM5 15v-1H4v1H1v1h9v-1H5Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M2 6H1v2h1V6Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, {
