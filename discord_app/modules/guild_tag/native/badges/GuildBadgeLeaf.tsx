...
export const GuildBadgeLeaf = function GuildBadgeLeaf(primaryTintColor) {
  ...
  obj.fill = "none";
  items = [
    React2(inlineStyles.Path, { d: "M15 2V1H9v1H3v5H1v5h12V7h2V2Z", fill: primaryColorsTransformed[2] }),
    React2(inlineStyles.Path, { d: "M11 13v-1H5v1h6Z", fill: primaryColorsTransformed[1] }),
    React2(inlineStyles.Path, { d: "M15 2V1H9v1h6ZM9 3V2H5v1h4Z", fill: "#fff" }),
    React2(inlineStyles.Path, {
      d: "M3 11v1h2v-1H3ZM13 10h-1v2h1v-2ZM15 5h-1v2h1V5ZM14 7h-1v3h1V7Z",
      fill: primaryColorsTransformed[1],
    }),
    React2(inlineStyles.Path, { d: "M16 1h-1v6h1V1Z", fill: "#000" }),
    React2(inlineStyles.Path, { d: "M3 9H2v6h1V9Z", fill: primaryColorsTransformed[0] }),
    React2(inlineStyles.Path, {
    ...
    React2(inlineStyles.Path, { d: "M2 7h1V5H2v2ZM1 9h1V7H1v2ZM5 3H3v2h1V4h1V3Z", fill: "#fff" }),
    React2(inlineStyles.Path, {
      d: "M4 8h2V7H4v1ZM6 7h2V6H6v1ZM8 6h2V5H8v1ZM10 5h1V4h-1v1ZM11 4h1V3h-1v1Z",
      fill: primaryColorsTransformed[0],
    }),
    React2(inlineStyles.Path, { d: "M5 4v1h1V4H5Z", fill: "#fff" }),
    React2(inlineStyles.Path, { d: "M3 8v1h1V8H3Z", fill: primaryColorsTransformed[0] }),
  ];
  obj.children = items;
