...
export const GuildBadgeGem = function GuildBadgeGem(width) {
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M7 1v1H6v1H5v8H3v-1H1v4h1v1h6V1H7Z", fill: primaryColorsTransformed[1] }),
    callback(inlineStyles.Path, { d: "M9 0H7v1h2V0ZM7 1H6v1h1V1Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M9 1H7v1h2V1ZM7 2H6v1h1V2ZM7 6H6v1h1V6Z", fill: primaryColorsTransformed[3] }),
    callback(inlineStyles.Path, { d: "M5 12H4v1h1v-1Z", fill: primaryColorsTransformed[2] }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M14 8h-1v1h1V8ZM13 9h-1v1h1V9Z", fill: secondaryColorsTransformed[3] }),
    callback(inlineStyles.Path, { d: "M5 11H3v1h2v-1ZM3 10H1v1h2v-1Z", fill: primaryColorsTransformed[3] }),
    callback(inlineStyles.Path, { d: "M2 12v-2H1v2h1Z", fill: primaryColorsTransformed[3] }),
    callback(inlineStyles.Path, { d: "M11 3h-1v1h1V3Z", fill: secondaryColorsTransformed[2] }),
    callback(inlineStyles.Path, { d: "M6 3H5v3h1V3Z", fill: primaryColorsTransformed[3] }),
    callback(inlineStyles.Path, {
