...
export const GuildBadgeBee = function GuildBadgeBee(primaryTintColor) {
  ...
  items = [
    ...
    React2(inlineStyles.Path, { d: "M9 6h-1v-1H5v-1h-1V1h2v1h1v1h1v1h1v2ZM13 7h1v1h-1z", fill: "white" }),
    React2(inlineStyles.Path, { d: "M13 8h1v1h-2v-2h1v1Z", fill: "#B7DBF6" }),
    React2(inlineStyles.Path, {
    ...
    React2(inlineStyles.Path, { d: "M5 16h-1v-1h1v1ZM8 16h-1v-1h1v1Z", fill: "black" }),
    React2(inlineStyles.Path, {
