...
export const GuildBadgeLava = function GuildBadgeLava(width) {
  ...
  items = [
    ...
    callback(inlineStyles.Path, { d: "M10 1H9v1h1V1ZM1 7H0v2h1V7Z", fill: "#000" }),
    callback(inlineStyles.Path, {
      d: "M5 4v1H3v1h3V4H5ZM12 4v1h-2v1h3V4h-1ZM5 11v1H3v1h3v-2H5ZM12 11v1h-2v1h3v-2h-1Z",
      fill: secondaryColorsTransformed[0],
    }),
    callback(inlineStyles.Path, { d: "M2 9H1v1h1V9ZM2 6H1v1h1V6ZM16 7h-1v2h1V7Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M15 7h-1v2h1V7Z", fill: primaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M2 7H1v2h1V7Z", fill: primaryColorsTransformed[3] }),
    callback(inlineStyles.Path, { d: "M15 6h-1v1h1V6ZM15 9h-1v1h1V9Z", fill: "#000" }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M6 8H3v1h3V8ZM13 8h-3v1h3V8Z", fill: primaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M7 14H6v1h1v-1ZM10 14H9v1h1v-1Z", fill: "#000" }),
    callback(inlineStyles.Path, { d: "M9 14H7v1h2v-1Z", fill: primaryColorsTransformed[0] }),
    callback(inlineStyles.Path, { d: "M9 1H7v1h2V1ZM7 2H6v1h1V1Z", fill: primaryColorsTransformed[3] }),
    callback(inlineStyles.Path, { d: "M10 13H9v1h1v-1Z", fill: primaryColorsTransformed[0] }),
    callback(inlineStyles.Path, {
    ...
    callback(inlineStyles.Path, { d: "M7 6H6v1h1V6ZM3 7H2v1h1V7ZM5 7H4v1h1V7Z", fill: primaryColorsTransformed[1] }),
  ];
  obj.children = items;
