        ...
        if (arg0 === 1) {
          ...
          if (constants.STAGE_INSTANCE === NumberResult) {
            ...
            if (null == channel_id2) {
              ...
              c3 = 2;
              c4 = 1;
              const obj6 = { value: _connectToStage(_require.guild_id, channel_id2), done: false };
              return obj6;
            }
            ...
            require("transitionToGuild").transitionToGuild(_require.guild_id);
            c3 = 1;
            c4 = 1;
      ...
      if (0 === c3) {
        ...
        if (arg0 === 1) {
          ...
          if (closure_129_1 === closure_130_13.PENDING_INCOMING) {
            ...
            c4 = 1;
            const obj10 = {
              value: closure_130_21(closure_130_9, () => null != user.getUser(closure_1_2)),
              done: false,
            };
            return obj10;
          } else {
    ...
    try {
      ...
      if (0 === c3) {
        ...
        const merged = Object.assign(
          closure_130_0(closure_130_3[29]).collectChannelAnalyticsMetadataFromId(closure_129_0.channel_id),
        );
...
function receiveNotification_(data) {
  ...
  if ("MESSAGE_CREATE" === data.type) {
    ...
    const messages = MessageManagerDefault.fetchMessages({
      guildId: null,
      channelId: null,
      messageId: null,
      isPreload: true,
            ...
            if (payload.type === tmp(1094).LinkingTypes.ICYMI) {
              if (null != data.channel_id) {
                if (null != data.message_id) {
                  ...
                  flag = false;
                  flag2 = false;
                  const tmp80Result3 = ICYMIActionCreatorsDefault;
                }
              }
            }
            flag = false;
              ...
              if (null != data.user_id) {
                ...
                if (null != data.notification_center_id) {
                  ...
                  const obj5 = {
                    ...
                    type: tmp(8580).ICYMIItemTypes.CUSTOM_STATUS,
                    score: 1000,
                    data: null,
                  };
                  ...
                  obj5.data = obj6;
                  const forStatusNotification = ICYMIActionCreatorsDefault.fetchForStatusNotification(obj5);
                  flag = false;
                  flag2 = false;
                  const tmp80Result4 = ICYMIActionCreatorsDefault;
                }
              }
            }
          }
...
const constants = fn(12657).MultiAccountSwitchLocation;
    ...
    if (null != data.receiving_user_id) {
      if (null != AuthenticationStore.getId()) {
        if (data.receiving_user_id !== AuthenticationStore.getId()) {
          ...
          receiving_user_id = tmp7(12660).switchAccount(
            receiving_user_id,
            false,
