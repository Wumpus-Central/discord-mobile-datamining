...
let items = [
  ...
  fn(1379).TypingSuggestion.VENTING,
  fn(1379).TypingSuggestion.OVERSHARING,
  fn(1379).TypingSuggestion.BARKING,
  fn(1379).TypingSuggestion.BABBLING,
  fn(1379).TypingSuggestion.DAYDREAMING,
  fn(1379).TypingSuggestion.MEOWING,
];
let items1 = [
  fn(1379).TypingIndicatorAnimation.PULSE,
  fn(1379).TypingIndicatorAnimation.RING,
  fn(1379).TypingIndicatorAnimation.WAVE,
];
let size = fn(2);
