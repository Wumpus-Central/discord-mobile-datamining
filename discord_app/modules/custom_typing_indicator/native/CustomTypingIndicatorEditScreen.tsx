...
export default function CustomTypingIndicatorEditScreen() {
  ...
  const memo1 = React.useMemo(
    () => ({ emojis: closure_11 ? memo : [], typingSuggestion: first2, animation: first3 }),
    items2,
  );
  ...
  const callback1 = React.useCallback(() => {
    ...
    obj.openLazy(
      nativeStackNavigation(analyticsLocations[22])(analyticsLocations[21], analyticsLocations.paths),
  ...
  const callback2 = React.useCallback(() => {
    ...
    obj.openLazy(
      nativeStackNavigation(analyticsLocations[22])(analyticsLocations[23], analyticsLocations.paths),
  ...
  let callback5 = React.useCallback(
    first(function* () {
      if (c4 === 2) {
        c4 = 3;
  ...
  const items8 = [
    memo1(nativeStackNavigation(tmp3[33]).Text, obj5),
    memo1(mode(tmp3[34]), { emojis: first1, onChange: callback }),
  ];
  ...
  const obj16 = {
    variant: "secondary",
    size: "lg",
    icon: memo1(nativeStackNavigation(tmp3[40]).DiceIcon, {}),
    text: null,
    onPress: null,
  };
  ...
  const obj17 = {
    variant: "secondary",
    size: "lg",
    icon: memo1(nativeStackNavigation(tmp3[41]).DenyIcon, {}),
    text: null,
    onPress: null,
  };
