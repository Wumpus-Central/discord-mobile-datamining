        ...
        if (stateFromStores) {
          ...
          if (tmp5(1379).TypingIndicatorAnimation.PULSE === tmp4) {
            ...
            const result5 = obj.set(
              tmp5Result.withDelay(
                ...
                tmp5Result.withRepeat(
                  tmp5Result1.withSequence(withTimingResult, withTimingResult1, tmp5(4561).withTiming(1, obj1)),
                  -1,
                ),
              ),
            );
            ...
            const result7 = obj1.set(
              tmp5Result5.withDelay(result3, tmp5Result6.withRepeat(tmp5(4561).withTiming(result6, obj2), -1)),
            );
            ...
            const result8 = obj2.set(
              tmp5Result8.withDelay(
                ...
                tmp5Result9.withRepeat(
                  tmp5Result10.withSequence(withTimingResult2, withTimingResult3, tmp5(4561).withTiming(0, obj5)),
                  -1,
                ),
              ),
            );
