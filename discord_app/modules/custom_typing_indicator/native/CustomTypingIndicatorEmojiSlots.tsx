...
let c7 = 28;
let items = [
  fn(15364).EmojiAngryFaceWithHornsIcon,
  fn(15366).EmojiColdFaceIcon,
  fn(15368).EmojiCowboyHatFaceIcon,
  fn(15370).EmojiCryingFaceIcon,
  fn(15372).EmojiDisguisedFaceIcon,
  fn(15374).EmojiFaceVomitingIcon,
  fn(15376).EmojiFaceWithMonocleIcon,
  fn(15378).EmojiFaceWithSpiralEyesIcon,
  fn(15380).EmojiMeltingFaceIcon,
  fn(15382).EmojiMoneyMouthFaceIcon,
  fn(15384).EmojiNerdFaceIcon,
  fn(15386).EmojiPartyingFaceIcon,
  fn(15388).EmojiSalutingFaceIcon,
  fn(15390).EmojiSkullIcon,
  fn(15392).EmojiSmilingFaceWithHornsIcon,
  fn(15394).EmojiSmilingFaceWithSunglassesIcon,
  fn(15396).EmojiSquintingFaceWithTongueIcon,
  fn(15398).EmojiUpsideDownFaceIcon,
  fn(15400).EmojiWoozyFaceIcon,
  fn(15402).EmojiZanyFaceIcon,
  fn(15404).EmojiRollingOnTheFloorLaughingIcon,
  fn(15406).EmojiSmilingFaceWithHeartsIcon,
];
