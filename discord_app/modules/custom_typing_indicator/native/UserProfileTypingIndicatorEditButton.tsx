...
export default function UserProfileTypingIndicatorEditButton(isTryItOut) {
  ...
  const stringResult = intl.string(
    isTryItOut(11439).getCustomTypingIndicatorSuggestionMessage(currentCustomTypingIndicatorConfig.typingSuggestion),
  );
  const obj5 = {
    label: null,
    labelTrailing: null,
  ...
  obj5.labelTrailing = jsx(isTryItOut(14151).UserProfileEditFormLabelBadges, {
  ...
  obj5.onPress = tmp5;
  return jsx(isTryItOut(14151).UserProfileEditFormButton, {
    label: null,
    labelTrailing: null,
    leading: null,
    buttonText: null,
