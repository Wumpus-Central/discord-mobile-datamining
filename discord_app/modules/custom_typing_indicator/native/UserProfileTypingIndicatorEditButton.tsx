...
export default function UserProfileTypingIndicatorEditButton(isTryItOut) {
  ...
  const stringResult = intl.string(
    isTryItOut(12213).getCustomTypingIndicatorSuggestionMessage(currentCustomTypingIndicatorConfig.typingSuggestion),
  );
  const obj5 = {
    label: null,
    labelTrailing: null,
  ...
  obj5.labelTrailing = jsx(isTryItOut(14834).UserProfileEditFormLabelBadges, {
    showPremiumIcon: true,
    showNewBadge: tmp3[0] === isTryItOut(1944).DismissibleContent.CUSTOM_TYPING_INDICATOR_MOBILE_NEW_BADGE_PROFILE_PAGE,
  });
  ...
  obj5.onPress = tmp5;
  return jsx(isTryItOut(14834).UserProfileEditFormButton, {
    label: null,
    labelTrailing: null,
    leading: null,
    buttonText: null,
