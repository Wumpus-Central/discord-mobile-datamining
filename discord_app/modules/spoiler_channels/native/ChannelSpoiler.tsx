...
import GatedContentDefault from "GatedContent" /* 13005 */;
...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = noop.useContext(tmp6(12605)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != stateFromStores1) {
    channelIconComponent = tmp(5325).getChannelIconComponent(stateFromStores1);
  ...
  if (null != channelIconComponent) {
    ...
    items4[1] = closure_10(tmp(4823).Text, obj5);
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      obj8.children = tmp6(4817).parseTopic(stateFromStores1.topic, true, obj9);
      obj7.children = closure_10(tmp(4823).Text, obj8);
      ...
      const tmp6Result = tmp6(4817);
      const obj11 = { channelId: stateFromStores1.id };
      obj10.children = tmp6(4817).parseTopic(stateFromStores1.topic, true, obj11);
      items5[1] = closure_10(tmp(4823).Text, obj10);
      ...
      if (tmp5[0]) {
        ...
        obj12.children = closure_10(tmp(4823).Text, obj13);
        tmp24Result = closure_10(tmp(5425).PressableHighlight, obj12);
      }
      items5[2] = tmp24Result;
      const obj14 = { style: tmp4.divider };
      items5[3] = closure_10(View, obj14);
      obj6.children = items5;
      tmp23Result = closure_11(tmp(5269).Stack, obj6);
      const tmp6Result3 = tmp6(4817);
    }
