...
fn(4606);
const createStyles = { subtitle: { textAlign: "center", lineHeight: 22 }, subtitleContainer: { alignItems: "center" }, divider: null, subtitleMeasure: null };
...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = obj3.useContext(tmp6(12365)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != channelIconComponent) {
    ...
    obj = { variant: "heading-xxl/bold", color: "mobile-text-heading-primary", lineClamp: 1, style: { flexShrink: 1 }, children: tmp7 };
    items4[1] = closure_10(tmp(4602).Text, obj);
    obj.children = items4;
