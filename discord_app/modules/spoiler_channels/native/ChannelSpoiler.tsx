...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = obj3.useContext(tmp6(11529)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != stateFromStores1) {
    channelIconComponent = tmp(4715).getChannelIconComponent(stateFromStores1);
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        tmp24Result = tmp24(tmp(4797).PressableHighlight, obj7);
      }
      ...
      obj1[2] = items5;
      tmp23Result = callback2(tmp(4663).Stack, obj1);
