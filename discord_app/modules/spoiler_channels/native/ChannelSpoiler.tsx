// === Module 12295: ChannelSpoiler ===

// Module 12295 (ChannelSpoiler)
import ThemesDefault from "Themes" /* 712 */;
import computeChannelNameDefault from "computeChannelName" /* 4638 */;
import GatedContentDefault from "GatedContent" /* 11118 */;
...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = obj3.useContext(tmp6(11913)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != stateFromStores1) {
    channelIconComponent = tmp(4932).getChannelIconComponent(stateFromStores1);
  ...
  if (null != channelIconComponent) {
    ...
    obj[3] = { flexShrink: 1 };
    obj[4] = tmp7;
    items4[1] = callback(tmp(4440).Text, obj);
    obj[1] = items4;
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        obj7[2] = tmp24(tmp(4440).Text, obj8);
        tmp24Result = tmp24(tmp(5015).PressableHighlight, obj7);
      }
      ...
      obj1[2] = items5;
      tmp23Result = callback2(tmp(4877).Stack, obj1);
  ...
  obj10[0] = _require(8011).NsfwSpaceWarningModalType.SPOILER_CHANNEL;
