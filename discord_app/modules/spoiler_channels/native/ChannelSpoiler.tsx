// === Module 12119: ChannelSpoiler ===

// Module 12119 (ChannelSpoiler)
import ThemesDefault from "Themes" /* 712 */;
import computeChannelNameDefault from "computeChannelName" /* 4639 */;
import GatedContentDefault from "GatedContent" /* 12118 */;
...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = obj3.useContext(tmp6(11756)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != stateFromStores1) {
    channelIconComponent = tmp(4933).getChannelIconComponent(stateFromStores1);
  ...
  if (null != channelIconComponent) {
    ...
    obj[3] = { flexShrink: 1 };
    obj[4] = tmp7;
    items4[1] = callback(tmp(4441).Text, obj);
    obj[1] = items4;
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        obj7[2] = tmp24(tmp(4441).Text, obj8);
        tmp24Result = tmp24(tmp(5020).PressableHighlight, obj7);
      }
      ...
      obj1[2] = items5;
      tmp23Result = callback2(tmp(4878).Stack, obj1);
  ...
  obj10[0] = _require(8615).NsfwSpaceWarningModalType.SPOILER_CHANNEL;
