// === Module 12172: ChannelSpoiler ===

// Module 12172 (ChannelSpoiler)
import ThemesDefault from "Themes" /* 712 */;
import computeChannelNameDefault from "computeChannelName" /* 4642 */;
import GatedContentDefault from "GatedContent" /* 12171 */;
...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = obj3.useContext(tmp6(11806)).setControlsMode;
  const items2 = [, , , ];
  ...
  if (null != stateFromStores1) {
    channelIconComponent = tmp(4949).getChannelIconComponent(stateFromStores1);
  ...
  if (null != channelIconComponent) {
    ...
    obj[3] = { flexShrink: 1 };
    obj[4] = tmp7;
    items4[1] = callback(tmp(4444).Text, obj);
    obj[1] = items4;
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        obj7[2] = tmp24(tmp(4444).Text, obj8);
        tmp24Result = tmp24(tmp(5036).PressableHighlight, obj7);
      }
      ...
      obj1[2] = items5;
      tmp23Result = callback2(tmp(4894).Stack, obj1);
  ...
  obj10[0] = _require(8652).NsfwSpaceWarningModalType.SPOILER_CHANNEL;
