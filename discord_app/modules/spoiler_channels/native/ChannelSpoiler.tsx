...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = noop.useContext(tmp6(12529)).setControlsMode;
  const items2 = [, , ,];
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        obj12.children = closure_10(tmp(4753).Text, obj13);
        tmp24Result = closure_10(tmp(5341).PressableHighlight, obj12);
      }
      items5[2] = tmp24Result;
      const obj14 = { style: tmp4.divider };
      items5[3] = closure_10(View, obj14);
      obj6.children = items5;
      tmp23Result = closure_11(tmp(5185).Stack, obj6);
