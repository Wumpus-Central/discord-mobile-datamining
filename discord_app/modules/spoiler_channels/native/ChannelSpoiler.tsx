...
export default function ChannelSpoiler(channelId) {
  ...
  setControlsMode = noop.useContext(tmp6(12514)).setControlsMode;
  const items2 = [, , ,];
  ...
  if (null != topic) {
    ...
    if ("" !== str.trim()) {
      ...
      if (tmp5[0]) {
        ...
        obj12.children = closure_10(tmp(4718).Text, obj13);
        tmp24Result = closure_10(tmp(5292).PressableHighlight, obj12);
      }
      items5[2] = tmp24Result;
      const obj14 = { style: tmp4.divider };
      items5[3] = closure_10(View, obj14);
      obj6.children = items5;
      tmp23Result = closure_11(tmp(5142).Stack, obj6);
