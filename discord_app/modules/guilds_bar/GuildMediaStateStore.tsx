...
import closure_15 from "updateUserGuildSettingsInternal" /* 5048 */;
...
function computeGuildMediaState(closure_0) {
  ...
  if (tmp2.selectedVoiceGuildId === closure_0) {
    ...
    const guildActiveEvent = _require(8928).getGuildActiveEvent(closure_0);
    let channel_id;
