...
import closure_15 from "updateUserGuildSettingsInternal" /* 4589 */;
import closure_16 from "updateVoiceState" /* 4399 */;
...
function computeGuildMediaState(closure_0) {
  ...
  if (tmp2.selectedVoiceGuildId === closure_0) {
    ...
    const guildActiveEvent = _require(9185).getGuildActiveEvent(closure_0);
    let channel_id;
