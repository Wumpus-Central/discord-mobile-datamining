  ...
  constructor(arg0) {
    ...
    fn = function h(targetOriginY) {
      if (closure_6) {
        ...
        const obj1 = { originY: spring.withSpring(targetOriginY.targetOriginY, closure_11, "animate-always"), originX: null, height: null };
    ...
    fn2 = function p(height) {
      ...
      obj = { originY: spring.withSpring(height.targetOriginY, closure_11, "animate-always"), originX: null, height: null };
