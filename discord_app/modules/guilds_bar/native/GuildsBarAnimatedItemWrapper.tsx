...
class UnreadIndicator {
  constructor(arg0) {
    ...
    return c7(require("module_7819"), { collapsable: false, entering: callback, layout: callback1, style: memo, pointerEvents: "none" });
  }
}
...
export const useGuildsBarAnimatedWrapperStyles = function useGuildsBarAnimatedWrapperStyles(arg0) {
  ...
  const token = require(3989) /* map */.useToken(importDefault(712).modules.mobile.GUILD_BAR_ITEM_SIZE);
