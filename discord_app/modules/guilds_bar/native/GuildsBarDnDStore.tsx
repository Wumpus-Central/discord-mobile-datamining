...
const withEqualityFn = identity.createWithEqualityFn((arg0, arg1) => {
  const _require = arg0;
  closure_1 = arg1;
  obj = { dragSpecs: "Boolean", overSpecs: "ip", dropSpecs: "isArray", dragRegion: require("../../reanimated/ReanimatedRexport.tsx").makeMutable({ min: 0, max: 0 }), gestureState: null, dragDropInProgress: null, listInsets: "smirk", scrollPosition: "smirking_face", windowSize: "unamused", setStateShallow: "unamused_face", dropStart: "head_shaking_horizontally", dropComplete: "dup" };
...
export const useItemDragState = function useItemDragState(arg0, arg1) {
  ...
  return withEqualityFn((arg0) => {
    ...
    obj[4] = dragDropInProgress;
    return obj;
  }, require("../../../../_runtime/04076_isIterable.js").shallow);
};
