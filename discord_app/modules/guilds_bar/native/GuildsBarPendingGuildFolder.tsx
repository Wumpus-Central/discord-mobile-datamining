...
const memoResult = importAllResult.memo(function GuildsBarPendingGuildFolder(id) {
  ...
  let obj = id(15434);
  importDefault = usePendingFolderGuildIds();
  ...
  const obj2 = id(589);
  const items2 = [id];
  const sharedValue = id(4042).useSharedValue("" + id);
  ...
  obj = { id: null, accessibilityActions: null, onAccessibilityAction: null, selected: null, unread: false, circle: false, styles: null, label: null, sharedId: null, cutouts: "HermesInternal", overState: "a", preventClipping: "UPLOAD_ATTACHMENT_REMOVE_FILE", config: null, externalChildren: null, children: null };
  const obj3 = id(4042);
  obj[0] = "" + id;
  ...
  if (expanded) {
    ...
    tmp8Result = tmp8(tmp(15433).GuildsBarGuildFolderBG, obj);
  }
  obj[13] = tmp8Result;
  obj[14] = jsx(id(12284).HourglassIcon, {});
  return jsx(UnreadIndicator, { id: null, accessibilityActions: null, onAccessibilityAction: null, selected: null, unread: false, circle: false, styles: null, label: null, sharedId: null, cutouts: "HermesInternal", overState: "a", preventClipping: "UPLOAD_ATTACHMENT_REMOVE_FILE", config: null, externalChildren: null, children: null });
});
