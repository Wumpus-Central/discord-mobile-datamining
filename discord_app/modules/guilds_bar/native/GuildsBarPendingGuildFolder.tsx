...
export default noop.memo(function GuildsBarPendingGuildFolder(id) {
  ...
  const guildsBarAnimatedWrapperStyles = id(16644).useGuildsBarAnimatedWrapperStyles({
  ...
  if (expanded) {
    ...
    tmp8Result = jsx(tmp(16643).GuildsBarGuildFolderBG, { folderId: id, totalItems: childNodes.length });
  }
