...
export default noop.memo(function GuildsBarGeoRestrictedGuild(restrictedGuild) {
  ...
  const obj3 = {
    ...
    unread: false,
    circle: false,
    styles: restrictedGuild(16720).useGuildsBarAnimatedWrapperStyles({
  ...
  const guildsBarAnimatedWrapperStyles = restrictedGuild(16720).useGuildsBarAnimatedWrapperStyles({
    disableSelectedColor: true,
    disableBGColor: true,
  });
  ...
  if (null != animatableSourceWithFallback) {
    ...
    const obj7 = {
      ...
      selected: false,
      animate: false,
      size: tmp2(5889).GuildIconSizes.LARGE,
    };
