...
export default noop.memo(function GuildsBarGeoRestrictedGuild(restrictedGuild) {
  ...
  const obj3 = {
    ...
    unread: false,
    circle: false,
    styles: restrictedGuild(16404).useGuildsBarAnimatedWrapperStyles({
    ...
    cutouts: items,
    overState: "a",
    externalChildren: 0.721,
    expandedChildren: 0.721,
    children: 0.167,
  };
  const guildsBarAnimatedWrapperStyles = restrictedGuild(16404).useGuildsBarAnimatedWrapperStyles({
    disableSelectedColor: true,
    disableBGColor: true,
  });
  ...
  if (null != animatableSourceWithFallback) {
    ...
    const obj7 = {
      ...
      selected: false,
      animate: false,
      size: tmp2(5669).GuildIconSizes.LARGE,
    };
