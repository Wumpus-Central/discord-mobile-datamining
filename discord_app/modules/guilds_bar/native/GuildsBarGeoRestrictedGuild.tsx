...
export default noop.memo(function GuildsBarGeoRestrictedGuild(restrictedGuild) {
  ...
  const obj3 = {
    ...
    unread: false,
    circle: false,
    styles: restrictedGuild(16551).useGuildsBarAnimatedWrapperStyles({
    ...
    cutouts: items,
    overState: "a",
    externalChildren: "searchParams",
    expandedChildren: null,
    children: "\u{1F634}",
  };
  const guildsBarAnimatedWrapperStyles = restrictedGuild(16551).useGuildsBarAnimatedWrapperStyles({
    disableSelectedColor: true,
    disableBGColor: true,
  });
  ...
  if (null != animatableSourceWithFallback) {
    ...
    const obj7 = {
      ...
      selected: false,
      animate: false,
      size: tmp2(5754).GuildIconSizes.LARGE,
    };
