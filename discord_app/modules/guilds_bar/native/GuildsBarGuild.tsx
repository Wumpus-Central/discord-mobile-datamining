...
export default noop.memo(function GuildsBarGuild(guildId) {
  ...
  const guildsBarAnimatedWrapperStyles = guildId(drawerOpen[14]).useGuildsBarAnimatedWrapperStyles({
  ...
  const stateFromStoresObject = guildId(drawerOpen[18]).useStateFromStoresObject(
    items,
    () => ({
  ...
  const stateFromStores = guildId(drawerOpen[18]).useStateFromStores(
    items2,
    () => {
  ...
  const stateFromStores1 = guildId(drawerOpen[18]).useStateFromStores(
    items6,
