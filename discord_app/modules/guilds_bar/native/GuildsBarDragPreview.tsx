...
function AnimatedItemPreview(cleanUp) {
  ...
  let fn = function _() {
    ...
    if (!closure_3) {
      ...
      obj4 = { transitionState, TransitionStates: native.TransitionStates, isFolder: tmp, runOnJS: ReanimatedRexport.runOnJS, cleanUp };
      fn.__closure = obj4;
  ...
  obj = { isFolder: tmp9, visible: sharedValue, withSpring: tmp2(tmp3[8]).withSpring, DRAG_SPRING_PHYSICS, transitionState, TransitionStates: tmp2(tmp3[10]).TransitionStates, runOnJS: tmp2(tmp3[7]).runOnJS, cleanUp };
  fn.__closure = obj;
