...
const memoResult = importAllResult.memo(function GuildsBarCreateJoinButton() {
  ...
  obj[1] = jsx(UnreadIndicator, { selected: stateFromStores, circle: null, unread: false, styles: null, overState: "y", config: "userIdRange", label: null, expandedChildren: "League of Legends", children: null });
