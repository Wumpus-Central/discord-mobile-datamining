// === Module 16779: GuildsBarCreateJoinButton ===
...
export default noop.memo(function GuildsBarCreateJoinButton() {
  ...
  let obj = enabled(16720);
  const GameCommunityAddServerEntryExperiment = enabled(14082).GameCommunityAddServerEntryExperiment;
  enabled = GameCommunityAddServerEntryExperiment.useConfig({ location: "GuildsBarCreateJoinButton" }).enabled;
  const guildsBarAnimatedWrapperStyles = enabled(16720).useGuildsBarAnimatedWrapperStyles();
  ...
  const obj4 = { selected: stateFromStores, circle: false, unread: false, styles: guildsBarAnimatedWrapperStyles, overState: "y", config: memo, label: "feb", expandedChildren: "mar", children: "apr" };
  obj2 = enabled(504);
  const intl = tmp2(1115).intl;
  obj4.label = intl.string(enabled(1115).t.l5WIbf);
  obj4.expandedChildren = jsx(enabled(16780).HomeDrawerAddServerRowExpandedChildren, {});
  const colors = nativeDefault.colors;
  obj4.children = jsx(enabled(11556).CirclePlusIcon, { size: "md", color: stateFromStores ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT });
  obj3.children = jsx(GuildsBarAnimatedItemWrapperDefault, { selected: stateFromStores, circle: false, unread: false, styles: guildsBarAnimatedWrapperStyles, overState: "y", config: memo, label: "feb", expandedChildren: "mar", children: "apr" });
