...
export default noop.memo(function GuildsBarMessages() {
  ...
  obj = { selected: stateFromStores, circle: false, unread: false, styles: guildsBarAnimatedWrapperStyles, cutouts, config, overState: "y", label: "EMBEDDED_ACTIVITIES_DEV_SHELF_URL_OVERRIDE_ENABLED", externalChildren: null, expandedChildren: null, children: "status-positive" };
