...
const memoResult = require("noop").memo(function GuildsBarMessages() {
  ...
  return jsx(UnreadIndicator, { selected: stateFromStores, circle: null, unread: false, styles: null, cutouts: null, config: null, overState: "y", label: "addition", externalChildren: null, expandedChildren: null, children: 0 });
});
