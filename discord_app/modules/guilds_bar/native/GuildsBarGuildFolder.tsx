...
function MiniGuildIcon(arg0) {
  ...
  return closure_16(GuildIconDefault, obj, "" + selected);
}
function TransitionWrapper(children) {
  ...
  obj = {
    ...
    state,
    TransitionStates: tmp(tmp2[19]).TransitionStates,
    runOnJS: tmp(tmp2[18]).runOnJS,
    cleanUp,
    fromTop: flag,
    guildItemSize: token,
  };
  ...
  obj.style = items1;
  return closure_16(tmp3(state[17]), obj);
}
...
function renderGuildFolderContent(arg0, type, state, cleanUp) {
  ...
  if ("icon" === type) {
    ...
    obj = { item: type };
    obj.children = closure_16(GuildFolderIcon, obj);
...
let closure_18 = createStyles.createStyles(() => {
  ...
  let obj = {
    ...
    folderScaleContainer: null,
    guildPreviewIcon: null,
    guildPreviewIconUnselected: null,
    guildPreview0: null,
    guildPreview1: null,
    guildPreview2: null,
    guildPreview3: null,
    guildPreviewWrapper: null,
  };
  const rect = {
    position: "absolute",
    top: nativeDefault.modules.mobile.GUILD_BAR_ITEM_MARGIN,
    left: nativeDefault.modules.mobile.GUILD_FOLDER_BACKGROUND_LEFT,
    backgroundColor: nativeDefault.colors.GUILD_FOLDER_BACKGROUND,
    borderTopLeftRadius: nativeDefault.modules.mobile.GUILD_FOLDER_BACKGROUND_RADIUS,
    borderTopRightRadius: nativeDefault.modules.mobile.GUILD_FOLDER_BACKGROUND_RADIUS,
    borderBottomLeftRadius: nativeDefault.modules.mobile.GUILD_FOLDER_BACKGROUND_RADIUS,
    borderBottomRightRadius: nativeDefault.modules.mobile.GUILD_FOLDER_BACKGROUND_RADIUS,
    width: num + num2,
  };
  obj.folderBackground = rect;
  obj.folderScaleContainer = {
    position: "absolute",
    top: 0,
    left: 0,
    width: num,
...
const __initData = {
  code: "function GuildsBarGuildFolderTsx1(values){const{withSpring,TRANSITION_PHYSICS}=this.__closure;return{animations:{height:withSpring(values.targetHeight,TRANSITION_PHYSICS,'animate-always')},initialValues:{height:values.currentHeight}};}",
};
const memoResult = noop.memo(function FolderBGInner(color) {
  ...
  obj.withSpring = color(5025).withSpring;
  ...
  items1[2] = obj1;
  obj.style = items1;
  return closure_16(token2(7146), obj);
});
const __initData2 = {
...
export default noop.memo(function GuildsBarGuildFolder(id) {
  ...
  const stateFromStoresObject1 = obj3.useStateFromStoresObject(
    items1,
    () => {
      let num = 0;
  ...
  const memo = color.useMemo(() => {
    ...
    const int2hexResult = obj.int2hex(tmp4);
    obj = { tintStyle: { tintColor: int2hexResult }, folderPreviewStyle: null };
    ...
    obj.folderPreviewStyle = { backgroundColor: hexWithOpacityResult };
    return obj;
  }, items5);
  ...
  obj = {
    ...
    id,
    isDragTarget,
    withSpring: id(name[14]).withSpring,
  ...
  obj.label = obj5.useStateFromStores(
    items3,
    () => {
      if (null != name) {
  ...
  if (expanded) {
    ...
    if (!flag) {
      ...
      tmp19Result = closure_16(closure_21, obj1);
    }
  }
  obj.externalChildren = tmp19Result;
  tmp19Result = undefined;
  if (!flag2) {
    obj2 = { folderId: id, expanded };
    tmp19Result = closure_16(tmp3(tmp2[30]), obj2);
  }
  obj.expandedChildren = tmp19Result;
  obj3 = { renderItem: renderGuildFolderContent, getItemKey, items: memo2, wrapChildren: callback };
  obj.children = closure_16(tmp(name[19]).TransitionGroup, obj3);
  return closure_16(expanded(name[22]), obj);
});
