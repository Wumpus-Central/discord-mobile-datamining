...
export default function useGuildsBarGesture() {
  ...
  handleGestureEnd = fastListRef.useCallback((event) => {
              ...
              if (node.type === GuildsNodeType.FOLDER) {
                if (node2.type === GuildsNodeType.GUILD) {
                  ...
                  ReactBatchUpdates.batchUpdates(() => {
                    ...
                    obj = { dragNode: node, overNode: node2, dropPosition, dragRecyclerKey: null, itemSize: null, overState: null };
    ...
    state.setStateShallow({ dragSpecs: "call", overSpecs: "accessibilityLabel" });
