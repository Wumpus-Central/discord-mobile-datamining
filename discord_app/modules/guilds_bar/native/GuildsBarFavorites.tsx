...
export default noop.memo(function GuildsBarFavorites() {
  ...
  const obj5 = {
    ...
    label: null,
    externalChildren: "handled",
    expandedChildren: null,
    children: "USER_CONNECTIONS_INTEGRATION_JOINING_ERROR",
  };
  ...
  obj5.children = closure_8(shouldShowPopover(10382).StarIcon, {
    color: isFavoritesGuildSelected ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT,
  });
  const children = [
    closure_8(markPopoverAsDismissed(16454), obj5),
  ...
  if (shouldShowPopover) {
    ...
    shouldShowPopover = closure_8(tmp5(16474), obj8);
  }
