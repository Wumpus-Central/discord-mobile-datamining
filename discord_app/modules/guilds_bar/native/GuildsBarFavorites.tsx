...
export default noop.memo(function GuildsBarFavorites() {
  ...
  const obj5 = {
    ...
    label: "MEDIA_ENGINE_INTERACTION_REQUIRED",
    externalChildren: false,
    expandedChildren: "AUDIO_SET_KRISP_MODEL_OVERRIDE",
    children: null,
  };
  ...
  obj5.children = closure_8(shouldShowPopover(10476).StarIcon, {
    color: isFavoritesGuildSelected ? colors.WHITE : colors.MOBILE_GUILDBAR_ICON_DEFAULT,
  });
  const children = [
    closure_8(markPopoverAsDismissed(16551), obj5),
  ...
  if (shouldShowPopover) {
    ...
    shouldShowPopover = closure_8(tmp5(16571), obj8);
  }
