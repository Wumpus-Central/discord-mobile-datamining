...
import { useIsFavoritesGuildVisible } from "../../favorites/hooks/useIsFavoritesGuildVisible.tsx";
...
const memoResult = importAllResult.memo(function GuildsBarFavorites() {
  ...
  const tmp12 = useIsFavoritesGuildVisible("GuildsBarFavorites");
  ...
  if (shouldShowPopover) {
    ...
    tmp16Result = tmp16(tmp(15510), obj2);
  }
