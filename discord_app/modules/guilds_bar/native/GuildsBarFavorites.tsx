...
export default noop.memo(function GuildsBarFavorites() {
  ...
  let obj1 = shouldShowPopover(10256);
  ...
  obj.expandedChildren = closure_8(shouldShowPopover(16346).HomeDrawerFavoritesRowExpandedChildren, {});
  ...
  obj.children = closure_8(shouldShowPopover(10267).StarIcon, obj);
  const children = [closure_8(markPopoverAsDismissed(16327), obj), , ];
  ...
  if (shouldShowPopover) {
    ...
    shouldShowPopover = closure_8(tmp5(16347), obj2);
  }
