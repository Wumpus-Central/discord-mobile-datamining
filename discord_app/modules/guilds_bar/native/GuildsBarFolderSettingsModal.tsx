// === Module 16691: GuildsBarFolderSettingsModal ===
...
import UserSettingsActionCreators from "UserSettingsActionCreators" /* 9549 */;
import GuildsBarFolderSettingsModalActionCreators from "GuildsBarFolderSettingsModalActionCreators" /* 16690 */;
...
function GuildFolderSettingsScene(color) {
  ...
  const callback = noop.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(16693, dependencyMap.paths), "RoleColorPicker", { color: tmp3, defaultColor, onSelect: onColorChange });
  }, items);
