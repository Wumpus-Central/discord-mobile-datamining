// === Module 16176: checkNodeAndIterate ===
        ...
        if (tmp4.layoutStart > diff) {
          ...
          if (tmp4.section < constants.GUILDS) {
            ...
            if (0 !== tmp4.layoutSize) {
              ...
              let tmp8 = nextResult;
              let type = tmp4.type;
              if (tmp41(7804).FastListItemTypes.SECTION === type) {
                ...
                if (tmp41(7804).FastListItemTypes.ITEM === type) {
...
let closure_17 = { beforeItem: "disabled", afterItem: "Date" };
