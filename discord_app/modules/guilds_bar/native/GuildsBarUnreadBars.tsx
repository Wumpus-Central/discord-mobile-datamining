...
function findFirstOrLastMentionedItem(scrollPosValue) {
  ...
  while (iter !== undefined) {
    ...
    if (nextResult.layoutStart >= layoutStart) {
      ...
      if (tmp4.type === require(7683) /* renderDefaultEmpty */.FastListItemTypes.ITEM) {
        let tmp6 = nextResult;
        if (tmp4.layoutStart > diff) {
          ...
          if (tmp4.section < constants.GUILDS) {
            ...
            if (0 !== tmp4.layoutSize) {
              ...
              let tmp8 = nextResult;
              let type = tmp4.type;
              if (tmp41(7683).FastListItemTypes.SECTION === type) {
                ...
                if (tmp41(7683).FastListItemTypes.ITEM === type) {
