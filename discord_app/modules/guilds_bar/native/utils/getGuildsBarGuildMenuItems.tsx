...
import _modDef12408 from "../../../../../_runtime/metro/12408__.js";
...
export default function getGuildsBarGuildMenuItems(guildId) {
  ...
  if (result) {
    ...
    if (isMutedResult) {
      ...
      obj2.iconSource = _modDef12407;
      const intl4 = tmp(1114).intl;
      obj2.label = intl4.string(tmp(1114).t.vRzp7P);
      obj2.action = function action() {
        const obj = { guildId };
        obj.openLazy(asyncRequireImpl(10176, dependencyMap.paths), "muteSettings" + guildId, obj);
      };
      splice(1, 0, obj2);
    }
  }
