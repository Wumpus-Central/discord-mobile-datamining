// === Module 16331: GuildMediaStateShadowCompare ===
...
export const compareGuildMediaState = function compareGuildMediaState(guildId, fromHook, stateFromStores) {
  ...
  if (0 !== found.length) {
    ...
    if (flag) {
      obj = { guildId, lastAction: str, mismatchedFields: found, fromHook, fromStore: stateFromStores, isTransient: tmp };
      if (obj.isTransient) {
        str3 = "transient";
      }
      ...
      obj.tags = obj1;
      ({ guildId: obj7.guildId, mismatchedFields: obj7.mismatchedFields, fromHook: obj7.fromHook, fromStore: obj7.fromStore } = obj);
