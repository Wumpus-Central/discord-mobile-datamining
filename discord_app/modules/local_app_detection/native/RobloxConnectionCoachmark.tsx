...
export default function RobloxConnectionActionSheet(markAsDismissed) {
  ...
  obj2.header = closure_13(markAsDismissed(7263).BottomSheetTitleHeader, {
    title: null,
    leading: closure_13(markAsDismissed(7312).ActionSheetCloseButton, { onPress: handleCancel }),
  });
...
export const useShouldShowRobloxConnectionCoachmark = function useShouldShowRobloxConnectionCoachmark() {
  ...
  stateFromStores = stateFromStores(504).useStateFromStores(items, () =>
    appInstalled.isAppInstalled(stateFromStores(13828).DetectableAppNames.ROBLOX),
  );
