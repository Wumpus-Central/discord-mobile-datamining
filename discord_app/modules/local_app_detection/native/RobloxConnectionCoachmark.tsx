...
export default function RobloxConnectionActionSheet(markAsDismissed) {
  ...
  obj2.header = closure_13(markAsDismissed(7396).BottomSheetTitleHeader, {
    title: null,
    leading: closure_13(markAsDismissed(7445).ActionSheetCloseButton, { onPress: handleCancel }),
  });
...
export const useShouldShowRobloxConnectionCoachmark = function useShouldShowRobloxConnectionCoachmark() {
  ...
  stateFromStores = stateFromStores(504).useStateFromStores(items, () =>
    appInstalled.isAppInstalled(stateFromStores(13990).DetectableAppNames.ROBLOX),
  );
