...
export default function RobloxConnectionActionSheet(markAsDismissed) {
  ...
  obj = { title: null, leading: closure_13(markAsDismissed(7250).ActionSheetCloseButton, { onPress: handleCancel }) };
  obj.header = closure_13(markAsDismissed(7201).BottomSheetTitleHeader, obj);
  ...
  obj2.children = items;
  const items1 = [closure_14(markAsDismissed(5023).Stack, obj2), , ];
  ...
  const items2 = [closure_13(markAsDismissed(4601).Text, obj4), ];
  ...
  items2[1] = closure_13(markAsDismissed(4601).Text, obj5);
  obj3.children = items2;
  items1[1] = closure_14(markAsDismissed(5023).Stack, obj3);
  ...
  obj7.icon = closure_13(markAsDismissed(13026).WindowLaunchIcon, { size: "sm", color: nativeDefault.colors.WHITE });
  ...
  const items3 = [closure_13(markAsDismissed(5025).Button, obj7), ];
  ...
  items3[1] = closure_13(markAsDismissed(5025).Button, obj9);
  obj6.children = items3;
  items1[2] = closure_14(markAsDismissed(5023).Stack, obj6);
  obj1.children = items1;
  obj.children = closure_14(markAsDismissed(5023).Stack, obj1);
  return closure_13(markAsDismissed(7202).BottomSheet, obj);
};
export { UnionIcon };
