...
export default function RobloxConnectionActionSheet(markAsDismissed) {
  ...
  obj2.header = closure_13(markAsDismissed(7480).BottomSheetTitleHeader, {
    title: null,
    leading: closure_13(markAsDismissed(7529).ActionSheetCloseButton, { onPress: handleCancel }),
  });
...
export const useShouldShowRobloxConnectionCoachmark = function useShouldShowRobloxConnectionCoachmark() {
  ...
  stateFromStores = stateFromStores(504).useStateFromStores(items, () =>
    appInstalled.isAppInstalled(stateFromStores(14071).DetectableAppNames.ROBLOX),
  );
