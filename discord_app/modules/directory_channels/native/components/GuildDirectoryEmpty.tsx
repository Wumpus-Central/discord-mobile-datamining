...
createStyles = { flex: 1, justifyContent: "flex-end", padding: 16, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW };
createStyles.container = createStyles;
createStyles.header = { marginBottom: 16, alignSelf: "center" };
createStyles.title = { fontFamily: Fonts.PRIMARY_BOLD, color: nativeDefault.colors.MOBILE_TEXT_HEADING_PRIMARY, fontSize: 24, textAlign: "center", marginBottom: 8, alignSelf: "center" };
...
export default function GuildDirectoryEmpty(guild) {
  ...
  items2[2] = closure_7(guild(4601).Text, obj4);
  let tmp8Result = null;
  if (canCreateOrAddGuildInDirectory) {
    ...
    tmp8Result = closure_7(tmp4(8663).FormCTA, obj5);
  }
  items2[3] = tmp8Result;
  const obj6 = {
    style: tmp.ctaContainer,
  ...
  items2[4] = closure_7(guild(8663).FormCTA, obj6);
  obj.children = items2;
