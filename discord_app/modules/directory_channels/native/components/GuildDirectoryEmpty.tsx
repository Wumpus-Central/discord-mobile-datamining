// === Module 13011: GuildDirectoryEmpty ===
...
export default function GuildDirectoryEmpty(guild) {
  ...
  items2[2] = closure_7(guild(4753).Text, obj8);
  let tmp8Result = null;
  if (canCreateOrAddGuildInDirectory) {
    const obj9 = {
      ...
      iconSource: tmp2(13013),
      title: null
    };
    const intl3 = tmp4(1115).intl;
    obj9.title = intl3.string(tmp4(1115).t.hyK15i);
    tmp8Result = closure_7(tmp4(8876).FormCTA, obj9);
  }
  items2[3] = tmp8Result;
  const obj10 = {
    style: tmp.ctaContainer,
