...
export default function GuildDirectoryAddAlert(arg0) {
  ...
  obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t["X0WK+6"]);
  obj[1] = onClose;
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.guildIcon, guild, size: null };
  const tmp2 = componentDidMount;
  obj[2] = GuildIconSizes /* GuildIconSizes */.GuildIconSizes.XLARGE;
  ...
  obj1[4] = intl2.string(getSystemLocale /* getSystemLocale */.t.CueiPY);
  ...
  obj2[3] = intl3.format(getSystemLocale /* getSystemLocale */.t.R7Pqn5, { guildName: directoryGuildName });
