...
function GuildDirectoryNicknameUpsell(arg0) {
  ...
  obj = { paddingBottom: insets.bottom + Themes.space.PX_16, paddingTop: insets.top };
  items1[1] = obj;
  obj[1] = items1;
  ...
  obj1[2] = GuildIconSizes /* GuildIconSizes */.GuildIconSizes.XLARGE;
  const items2 = [callback(GuildIconSizes, obj1), , , , ];
  ...
  obj3[4] = intl.format(getSystemLocale /* getSystemLocale */.t["d+6kzl"], { guildName: name });
  const items3 = [callback(Text /* Text */.Text, obj3), ];
  const obj4 = { style: tmp.description, variant: "text-sm/medium", color: "text-default", children: null };
  const intl2 = tmp2(1236).intl;
  obj4[3] = intl2.string(getSystemLocale /* getSystemLocale */.t.b3L8yx);
  items3[1] = callback(Text /* Text */.Text, obj4);
  obj2[1] = items3;
  ...
  obj5[0] = intl3.string(getSystemLocale /* getSystemLocale */.t.ilDlmW);
  const intl4 = tmp2(1236).intl;
  obj5[1] = intl4.string(getSystemLocale /* getSystemLocale */.t.RfWvWI);
  obj5[2] = first;
  obj5[3] = tmp7[1];
  ({ input: obj9[4], redesignTextInput: obj9[5] } = tmp);
  obj5[6] = Button /* Button */.ClearButtonVisibility.WITH_CONTENT;
  ...
  obj8[1] = intl5.string(getSystemLocale /* getSystemLocale */.t.Np4yXU);
  ...
  obj7[1] = callback(Button /* Button */.Button, obj8);
