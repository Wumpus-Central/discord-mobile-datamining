...
function EmptyState(channel) {
  ...
  items1[1] = callback(channel(4299).Text, obj2);
  items1[2] = callback(channel(4299).Text, { style: tmp.emptyStateText, variant: "text-sm/medium", color: "text-default", children: formatResult });
  obj[1] = items1;
  return callback2(closure_6, obj);
}
