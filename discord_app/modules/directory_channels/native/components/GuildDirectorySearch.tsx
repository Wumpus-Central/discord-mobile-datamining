// === Module 12560: GuildDirectorySearch ===

// Module 12560 (GuildDirectorySearch)
import nativeDefault from "native" /* 576 */;
import native from "native" /* 1177 */;
import AnalyticsUtilsDefault from "AnalyticsUtils" /* 1241 */;
import GuildDirectorySearchModalActionCreatorsDefault from "GuildDirectorySearchModalActionCreators" /* 12558 */;
import _modDef12564 from "module_12564" /* 12564 */;
...
function DefaultState() {
  ...
  let items = [closure_12(closure_7, { style: tmp.emptyStateImage, source: _modDef12564 }), ];
...
function EmptyState(channel) {
  ...
  const canCreateOrAddGuildInDirectory = channel(12565).useCanCreateOrAddGuildInDirectory(channel);
  ...
  const obj2 = channel(12565);
  const items1 = [closure_12(closure_7, { style: tmp.emptyStateImage, source: _modDef12564 }), , ];
  ...
  items1[1] = closure_12(channel(4753).Text, obj6);
  items1[2] = closure_12(channel(4753).Text, { style: tmp.emptyStateText, variant: "text-sm/medium", color: "text-default", children: formatResult });
