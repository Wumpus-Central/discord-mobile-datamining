...
import closure_10 from "getSearchState" /* 11806 */;
...
function DefaultState() {
  ...
  items[1] = callback(_require(4442).Text, obj);
  obj[1] = items;
...
function EmptyState(channel) {
  ...
  items1[1] = callback(channel(4442).Text, obj2);
  items1[2] = callback(channel(4442).Text, { style: tmp.emptyStateText, variant: "text-sm/medium", color: "text-default", children: formatResult });
  obj[1] = items1;
  return callback2(closure_6, obj);
}
