...
import get_ActivityIndicator from "module_11767";
import createGuildRecordFromRust from "createGuildRecordFromRust";
import getSearchState from "getSearchState";
import ME from "ME";
import jsxProd from "_addDirectoryGuildEntry";
import createCacheKey from "createCacheKey";
import ArrayResult from "module_6032";
import { registerAsset } from "../../../../../_runtime/11738_registerAsset.js";
...
function EmptyState(channel) {
  ...
  items1[1] = callback(channel(4340).Text, obj2);
  items1[2] = callback(channel(4340).Text, { style: tmp.emptyStateText, variant: "text-sm/medium", color: "text-default", children: formatResult });
  obj[1] = items1;
  return callback2(closure_6, obj);
}
...
let closure_17 = require("module_6032").fill(null);
