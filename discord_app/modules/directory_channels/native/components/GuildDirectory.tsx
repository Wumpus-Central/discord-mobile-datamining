...
import useCanManageGuildDirectoryEntry from "useCanManageGuildDirectoryEntry" /* 12337 */;
...
export default function GuildDirectory(channel) {
  ...
  if (null == onPressSearch) {
    ...
    if (!directoryIsFetching) {
      if (0 === allEntriesCount) {
        ...
        items9[1] = closure_19(tmp4(12784), obj2);
  ...
  const tmp2Result1 = channel(4406);
  tmp4 = guildId;
};