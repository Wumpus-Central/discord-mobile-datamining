...
import GuildDirectoryMoreMenuDefault from "GuildDirectoryMoreMenu" /* 11529 */;
...
const memoResult = importAllResult.memo(function GuildDirectoryRow(entry) {
  ...
  const items2 = [closure_10(entry(4739).Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", lineClamp: 1, children: entry.name }), ];
  ...
  if (null != approximatePresenceCount) {
    ...
    items3[1] = tmp9(tmp2(4739).Text, obj9);
    obj7[0] = items3;
  ...
  if (null != approximateMemberCount) {
    ...
    items5[1] = tmp9(tmp2(4739).Text, obj13);
    obj11[0] = items5;
  ...
  items7[3] = closure_10(entry(4750).Button, obj18);
  obj1[1] = items7;
  obj[1] = closure_12(View, obj1);
  return closure_10(entry(6323).Card, obj);
});
