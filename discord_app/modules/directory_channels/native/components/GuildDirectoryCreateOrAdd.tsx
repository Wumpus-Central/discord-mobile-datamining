...
let closure_13 = importAllResult.memo((guild) => {
  ...
  obj[1] = callback(directoryChannelId(5700), obj);
  obj[2] = callback(directoryChannelId(11603), { entry: stateFromStores });
  obj[3] = start;
  obj[4] = end;
  return callback(guild(5354).TableRow, obj);
});
let closure_14 = importAllResult.memo((guild) => {
  ...
  obj = { style: callback3().guildIcon, guild };
  obj[2] = callback(handleItemPress(5700), obj);
  obj[3] = callback(guild(5354).TableRow.Arrow, {});
  obj[4] = start;
  obj[5] = end;
  return callback(guild(5354).TableRow, obj);
});
