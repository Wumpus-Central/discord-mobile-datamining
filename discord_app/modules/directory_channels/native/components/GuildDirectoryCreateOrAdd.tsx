// === Module 12565: GuildDirectoryCreateOrAdd ===
...
let closure_13 = noop.memo((guild) => {
  ...
  const obj2 = { label: guild.name, icon: closure_10(directoryChannelId(5801), { style: tmp.guildIcon, guild }), trailing: closure_10(directoryChannelId(12567), { entry: stateFromStores }), start, end };
