...
function GuildDirectoryCreateOrAddHeader(arg0) {
  ...
  const tmp = callback3();
  let obj = useSegmentedControlState /* useSegmentedControlState */;
  obj = { pageWidth: 0, defaultIndex: tabIndex, onSetActiveIndex: setTabIndex, items: null };
  const intl = getSystemLocale /* getSystemLocale */.intl;
  const items = [intl.string(getSystemLocale /* getSystemLocale */.t.FTe8HS), ];
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  items[1] = intl2.string(getSystemLocale /* getSystemLocale */.t.epOumr);
  ...
  obj1[4] = intl3.format(getSystemLocale /* getSystemLocale */.t["9SKJdF"], { guildName: directoryGuildName });
  ...
  obj2[3] = intl4.string(getSystemLocale /* getSystemLocale */.t.pYFZ9p);
  items1[1] = callback(Text /* Text */.Text, obj2);
  items1[2] = callback(closure_5, { style: tmp.segmentedControl, children: callback(SegmentedControl /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) });
  obj[1] = items1;
...
function GuildDirectoryCreateOrAddFooter(handleFooterPress) {
  ...
  const intl = getSystemLocale /* getSystemLocale */.intl;
  obj1[3] = intl.string(getSystemLocale /* getSystemLocale */.t.pgCZRP);
  const items1 = [callback(Text /* Text */.Text, obj1), ];
  const obj2 = { variant: "secondary", text: null, onPress: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj2[1] = intl2.string(getSystemLocale /* getSystemLocale */.t.WqJbLi);
  obj2[2] = handleFooterPress.handleFooterPress;
  items1[1] = callback(Button /* Button */.Button, obj2);
  obj[1] = items1;
