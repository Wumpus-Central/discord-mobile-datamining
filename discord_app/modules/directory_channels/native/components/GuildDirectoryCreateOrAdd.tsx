...
function GuildDirectoryCreateOrAddHeader(arg0) {
  ...
  const tmp = callback3();
  let obj = require("../../../../design/components/SegmentedControl/native/SegmentedControlState.native.tsx") /* useSegmentedControlState */;
  obj = { pageWidth: 0, defaultIndex: tabIndex, onSetActiveIndex: setTabIndex, items: null };
  const intl = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  const items = [intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.FTe8HS), ];
  const intl2 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  items[1] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.epOumr);
  ...
  obj1[4] = intl3.format(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["9SKJdF"], { guildName: directoryGuildName });
  ...
  obj2[3] = intl4.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.pYFZ9p);
  items1[1] = callback(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj2);
  items1[2] = callback(closure_5, { style: tmp.segmentedControl, children: callback(require("../../../../design/components/SegmentedControl/native/SegmentedControl.native.tsx") /* SegmentedControl */.SegmentedControl, { state: segmentedControlState }) });
  obj[1] = items1;
...
function GuildDirectoryCreateOrAddFooter(handleFooterPress) {
  ...
  const intl = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[3] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.pgCZRP);
  const items1 = [callback(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj1), ];
  const obj2 = { variant: "secondary", text: null, onPress: null };
  const intl2 = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj2[1] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.WqJbLi);
  obj2[2] = handleFooterPress.handleFooterPress;
  items1[1] = callback(require("../../../../design/components/Button/native/Button.native.tsx") /* Button */.Button, obj2);
  obj[1] = items1;
