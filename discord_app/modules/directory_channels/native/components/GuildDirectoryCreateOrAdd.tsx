...
let closure_13 = noop.memo((guild) => {
  ...
  const obj2 = {
    label: guild.name,
    icon: closure_10(directoryChannelId(5803), { style: tmp.guildIcon, guild }),
    trailing: closure_10(directoryChannelId(12571), { entry: stateFromStores }),
    start,
    end,
  };
