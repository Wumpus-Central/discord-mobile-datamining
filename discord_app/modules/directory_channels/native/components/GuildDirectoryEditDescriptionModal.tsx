...
import _modDef11848 from "GuildDirectoryEditDescriptionModalActionCreators.tsx";
...
export default function GuildDirectoryEditDescriptionModal(arg0) {
  ...
  obj = {
    fullscreen: true,
    headerLeft: require("../../../../design/components/Navigator/native/NavigatorHeader.native.tsx").getHeaderCloseButton(_modDef11848.close),
    headerTitle() {
      return null;
    },
    render() {
