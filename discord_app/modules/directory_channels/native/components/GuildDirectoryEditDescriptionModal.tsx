...
import _modDef11798 from "GuildDirectoryEditDescriptionModalActionCreators.tsx";
...
function GuildDirectoryEditDescription(entry) {
  ...
  obj[1] = callback(entry(4441).Text, obj1);
  ...
  items[1] = callback(_onSubmit(11801), obj3);
  obj[2] = items;
  obj[2] = callback2(closure_6, obj);
  return callback(entry(5505).SafeAreaPaddingView, obj);
}
noopAll;
...
export default function GuildDirectoryEditDescriptionModal(arg0) {
  ...
  obj = {
    fullscreen: true,
    headerLeft: require("../../../../design/components/Navigator/native/NavigatorHeader.native.tsx").getHeaderCloseButton(_modDef11798.close),
    headerTitle() {
      return null;
    },
    render() {
