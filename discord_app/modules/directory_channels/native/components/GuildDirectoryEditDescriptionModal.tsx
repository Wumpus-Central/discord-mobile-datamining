// === Module 11784: GuildDirectoryEditDescriptionModal ===
...
function GuildDirectoryEditDescription(entry) {
  ...
  obj3.children = closure_7(entry(4825).Text, obj4);
...
let obj2 = { safeArea: { marginTop: fn(5989).NAV_BAR_HEIGHT, flex: 1 }, container: { flex: 1 }, title: { marginBottom: 8, textAlign: "center" }, header: { alignItems: "center", justifyContent: "center", padding: 16 } };
