...
class GuildTemplatesItem {
  constructor(arg0) {
    ...
    obj = {
      Icon(qXtNtS) {
        return closure_1_9(guildTemplate(closure_1_2[7]).Icon, {
          source: guildTemplate(closure_1_2[8]).GUILD_TEMPLATE_ICONS[guildTemplate.id],
          disableColor: true,
...
export default function GuildDirectoryTemplates(directoryGuildName) {
  ...
  const items3 = [
    callback2(GuildTemplatesItem, { guildTemplate: tmp3[constants.HUB_STUDY], onGuildTemplatePress: callback }),
    callback2(GuildTemplatesItem, { guildTemplate: tmp3[constants.HUB_SCHOOL_CLUB], onGuildTemplatePress: callback }),
    callback2(GuildTemplatesItem, { guildTemplate: tmp3[constants.HUB_CLASS], onGuildTemplatePress: callback }),
    callback2(GuildTemplatesItem, { guildTemplate: tmp3[constants.HUB_SOCIAL], onGuildTemplatePress: callback }),
    callback2(GuildTemplatesItem, { guildTemplate: tmp3[constants.HUB_MAJOR], onGuildTemplatePress: callback }),
    callback2(GuildTemplatesItem, { guildTemplate: tmp3[constants.HUB_DORM], onGuildTemplatePress: callback }),
  ];
  obj12[1] = items3;
