    ...
    try {
      ...
      if (0 === c6) {
        ...
        if (arg0 === 1) {
          ...
          const obj2 = { description: closure_132_2, primary_category_id: closure_132_3 };
          request.body = obj2;
          const obj3 = { event: closure_133_0(closure_133_2[8]).NetworkActionNames.DIRECTORY_GUILD_ENTRY_CREATE, properties: null };
          const obj4 = { directory_channel_id: closure_132_0, guild_id: closure_132_1, primary_category_id: closure_132_3 };
          ...
          c6 = 2;
          c7 = 1;
          const obj5 = { value: obj7.post(request), done: false };
          return obj5;
        }
      } else if (arg0 === 1) {
        c7 = 3;
  ...
  if (c7 === 2) {
    ...
    try {
      ...
      if (0 === c6) {
        ...
        closure_132_4 = value;
        obj = closure_133_1(closure_133_2[5]);
        const obj5 = { type: "GUILD_DIRECTORY_ENTRY_UPDATE", channelId: closure_132_0, entry: closure_132_4.body };
        obj.dispatch(obj5);
        c7 = 3;
        return { value: "HermesInternal", done: null };
      }
