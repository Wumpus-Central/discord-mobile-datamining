...
import experiment from "../../../../discord_common/js/packages/protos/discord_protos/discord_experimentation/v1/experiment.tsx";
      ...
      if (0 === c5) {
        ...
        if (1 === tmp7) {
          ...
          const obj10 = {
            ...
            unitId: closure_130_0(closure_130_2[7]).INSTALLATION_UNIT_ID,
          };
          closure_130_1(closure_130_2[5]).dispatch(obj10);
          ...
          if (null != body) {
            ...
            Emitter.batched(() => {
              ...
              obj3.dispatch({
                type: "APEX_EXPERIMENTS_FETCH_SUCCESS",
                unitId: closure_0(installation[7]).INSTALLATION_UNIT_ID,
                experiments,
              });
              const obj4 = {
                type: "APEX_EXPERIMENTS_FETCH_SUCCESS",
