...
const result = obj132.fileFinishedImporting("modules/user_application_identity/UserApplicationIdentityConstants.tsx");
...
export const getMigratedApplicationIdentityConnectionsScreenApplications = function getMigratedApplicationIdentityConnectionsScreenApplications(arg0) {
  closure_0 = arg0;
  const found = items.filter((item, index) => item.getMigrationExperimentEnabled(closure_0));
  return found.map((item, index) => item.applicationId);
};