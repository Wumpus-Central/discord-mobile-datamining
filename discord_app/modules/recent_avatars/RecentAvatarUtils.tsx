...
export const generateAvatarDescription = function generateAvatarDescription(maxSettingsForPreset) {
  ...
  if (assetOrigin !== AssetOriginTypes.AssetOriginTypes.ARCHIVED_ASSET) {
    ...
    if (assetOrigin === tmp3(8216).AssetOriginTypes.EDITED_ARCHIVED_ASSET) {
...
export const createPendingImage = function createPendingImage(assetOrigin) {
  ...
  if (AssetOriginTypes.AssetOriginTypes.NEW_ASSET === NEW_ASSET) {
    ...
    obj[3] = originalMd5;
    return obj;
  } else if (tmp3(8216).AssetOriginTypes.EDITED_ARCHIVED_ASSET === NEW_ASSET) {
    ...
    obj[4] = originalMd5;
    return obj;
  } else if (tmp3(8216).AssetOriginTypes.ARCHIVED_ASSET === NEW_ASSET) {
