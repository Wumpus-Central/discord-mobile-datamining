...
function CreateGameInvitePostContent(parentChannel) {
  ...
  obj2.children = closure_7(parentChannel(5730).XSmallIcon, {});
  const items4 = [closure_7(parentChannel(5173).PressableOpacity, obj2), ];
  ...
  items4[1] = closure_7(parentChannel(4601).Text, obj3);
  ...
  obj5.value = tmp5;
  obj5.onChange = tmp6;
  obj5.maxLength = parentChannel(7324).GAME_INVITE_POST_MESSAGE_MAX_LENGTH;
  const items6 = [closure_7(parentChannel(7137).TextArea, obj5), ];
  ...
  if (tmp15Result) {
    ...
    obj7.children = closure_7(tmp9(4601).Text, obj8);
    obj6.trailing = closure_7(View, obj7);
    obj6.onPress = callback1;
    tmp15Result = closure_7(tmp9(5655).TableRow, obj6);
  }
  ...
  items7[1] = closure_7(parentChannel(7252).TableSwitchRow, obj10);
  obj9.children = items7;
  items6[1] = closure_8(parentChannel(5737).TableRowGroup, obj9);
  ...
  obj11.children = closure_7(parentChannel(5025).Button, obj12);
...
export default function CreateGameInvitePostModal(parentChannelId) {
  ...
  if (null != stateFromStores) {
    ...
    if (stateFromStores.isGameInvitesChannel()) {
      ...
      tmp4 = closure_7(parentChannelId(7214).AnalyticsLocationProvider, obj);
    }
  }
  return tmp4;
};