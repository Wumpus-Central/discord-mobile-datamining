...
export default {
      ...
      if (c5 === 2) {
        ...
        try {
          ...
          if (0 === constants) {
            ...
            obj = offset(tmp24[3]);
            const obj4 = { type: "LOAD_ICYMI_POPULAR_GUILDS", categoryIds: closure_129_0, guilds, offset: closure_129_1 };
            obj.dispatch(obj4);
            c3 = 0;
            c5 = 3;
          ...
          if (0 === constants) {
            ...
            if (1 === tmp8) {
              ...
              if (arg0 === 1) {
                ...
                closure_128_1 = value;
                obj4 = { type: "LOAD_ICYMI_DEHYDRATED", items: closure_128_1.body.items, loadId: closure_128_1.body.load_id, startTime: closure_128_0, isReloading: closure_129_1, isInitialLoad: closure_129_0 };
                constants = 3;
                c5 = 1;
        ...
        try {
          ...
          if (0 === constants) {
              ...
              if (obj15.icymiEnabled("fetchHydrated")) {
                ...
                if (0 === messageItems.length) {
                  if (0 === activityItems.length) {
                    ...
                    let obj1 = { type: "LOAD_ICYMI_HYDRATED", requestMessageItems: [], requestActivityItems: [], messageItems: [], activityItems: [], startingIndex, endingIndex };
                    obj5.dispatch(obj1);
                  }
                }
                c3 = 1;
            ...
            if (1 === tmp7) {
              ...
              closure_128_2 = value;
              obj5 = { type: "LOAD_ICYMI_HYDRATED", requestMessageItems: closure_128_0, requestActivityItems: closure_128_1, messageItems: closure_128_2.body.message_items, activityItems: closure_128_2.body.activity_items, startingIndex: closure_129_0, endingIndex: closure_129_1 };
        ...
        try {
          ...
          if (0 === c4) {
            ...
            if (1 === tmp8) {
              ...
              closure_128_1 = value;
              obj = closure_129_1(closure_129_2[3]);
              obj3 = { type: "LOAD_ICYMI_CURRENT_STATUS_MEDIA", attachments: closure_128_1.body.attachments, createdAtMs: null };
  ...
  itemInteracted(id, hotwheels_gaming_activity, open_profile) {
    const obj = { type: "ICYMI_ITEM_INTERACTED", itemId: id, itemType: hotwheels_gaming_activity, actionType: open_profile };
    obj.dispatch(obj);
  },
