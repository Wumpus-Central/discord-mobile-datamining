...
import _modDef16531 from "../../../../../_runtime/metro/16531__.js";
import _modDef16532 from "../../../../../_runtime/metro/16532__.js";
...
function ContentSettingsControl(initialValue) {
  ...
  obj = { source: _modDef16531, style: null };
  ...
  const obj1 = { source: _modDef16532, style: null };
  ...
  const obj3 = { source: _modDef16533, style: null };
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  const items3 = [closure_8(id(4602).Text, obj), , , ,];
  ...
  items3[1] = closure_8(id(4602).Text, obj);
  ...
  obj5.children = closure_8(id(7273).TableSwitchRow, obj6);
  ...
  items3[4] = closure_8(id(4602).Text, obj7);
