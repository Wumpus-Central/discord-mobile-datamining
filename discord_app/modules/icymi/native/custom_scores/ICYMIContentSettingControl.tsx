...
import _modDef16555 from "../../../../../_runtime/metro/16555__.js";
import _modDef16556 from "../../../../../_runtime/metro/16556__.js";
...
function ContentSettingsControl(initialValue) {
  ...
  obj = { source: _modDef16555, style: null };
  ...
  const obj1 = { source: _modDef16556, style: null };
  ...
  const obj3 = { source: _modDef16557, style: null };
  ...
  obj6.children = closure_8(SegmentedControl.SegmentedControl, {
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  const items3 = [closure_8(id(4632).Text, obj), , , ,];
  ...
  items3[1] = closure_8(id(4632).Text, obj);
  ...
  obj5.children = closure_8(id(7303).TableSwitchRow, obj6);
  ...
  items3[4] = closure_8(id(4632).Text, obj7);
