...
import _modDef16544 from "../../../../../_runtime/metro/16544__.js";
...
function ContentSettingsControl(initialValue) {
  ...
  obj = { source: _modDef16543, style: null };
  ...
  const obj1 = { source: _modDef16544, style: null };
  ...
  const obj3 = { source: _modDef16545, style: null };
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  const items3 = [closure_8(id(4601).Text, obj), , , ,];
  ...
  items3[1] = closure_8(id(4601).Text, obj);
  ...
  obj5.children = closure_8(id(7252).TableSwitchRow, obj6);
  ...
  items3[4] = closure_8(id(4601).Text, obj7);
