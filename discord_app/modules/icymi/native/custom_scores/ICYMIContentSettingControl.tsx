...
import _modDef16620 from "../../../../../_runtime/metro/16620__.js";
import _modDef16621 from "../../../../../_runtime/metro/16621__.js";
import _modDef16622 from "../../../../../_runtime/metro/16622__.js";
...
function ContentSettingsControl(initialValue) {
  ...
  obj9.children = closure_8(SegmentedControl.SegmentedControl, {
...
export const GuildScoreSettings = function GuildScoreSettings(guild) {
  ...
  if (!tmp5) {
    ...
    obj6.children = closure_8(ContentSettingsControl, obj7);
    tmp11Result = closure_8(View, obj6);
  }
...
export const ChannelScoreSettings = function ChannelScoreSettings(channel) {
  ...
  const tmp7 =
    id(stateFromStores[8]).numberToCustomScore(stateFromStores1) === id(stateFromStores[8]).ICYMICustomScore.MUTED;
  ...
  if (!tmp8) {
    ...
    obj6.children = closure_8(ContentSettingsControl, obj7);
    tmp14Result = closure_8(View, obj6);
  }
