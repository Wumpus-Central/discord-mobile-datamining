// === Module 15412: CardHeightMeasurer ===
...
const memoResult = importAllResult.memo((children) => {
  ...
  }, items)} pointerEvents="box-none" style={{ width: importAllResult.useContext(itemId(15345).ICYMIContext).width, alignSelf: "center" }}>{arg0.children}</View>;
});
