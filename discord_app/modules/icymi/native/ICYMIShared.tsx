...
export const SimplePost = function SimplePost(arg0) {
  ...
  fn.__closure = { interpolateColor: highlight(4559).interpolateColor, progress: sharedValue, bgColor: token, bgColorHighlighted: hexWithOpacityResult };
