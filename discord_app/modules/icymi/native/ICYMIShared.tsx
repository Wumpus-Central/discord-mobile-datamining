...
export const SimplePost = function SimplePost(arg0) {
  ...
  token = highlight(4526).useToken(token(576).colors.MESSAGE_HIGHLIGHT_BACKGROUND_DEFAULT, tmp4);
  let obj = highlight(4526);
  const hexWithOpacityResult = highlight(4678).hexWithOpacity(token(576).unsafe_rawColors.BRAND_360, 0.25);
  dependencyMap = hexWithOpacityResult;
  let obj2 = highlight(4678);
  const sharedValue = highlight(4561).useSharedValue(0);
  let obj3 = highlight(4561);
  const fn = function c() {
  ...
  let obj4 = highlight(4561);
  fn.__closure = {
    interpolateColor: highlight(4561).interpolateColor,
  ...
  if (highlight) {
    ...
    const items2 = [closure_18(tmp2(4561).View, obj7)];
  ...
  if (
    ...
    if (null != thread) {
      if (null != mostRecentMessage) {
        ...
        const items5 = [closure_18(parentMessage(5377).ChatIcon, obj8), ,];
        ...
        items5[2] = closure_18(parentMessage(7542).ChevronSmallRightIcon, obj10);
        obj7.children = items5;
        items4[2] = closure_19(View, obj7);
        obj3.children = items4;
        return closure_19(parentMessage(5427).PressableHighlight, obj3);
      }
    }
    ...
    const items8 = [closure_18(parentMessage(5377).ChatIcon, obj14)];
    const obj15 = { style: tmp.chevron, size: "xxs" };
    items8[1] = closure_18(parentMessage(7542).ChevronSmallRightIcon, obj15);
    obj13.children = items8;
    items7[1] = closure_19(View, obj13);
    obj11.children = items7;
    return closure_19(parentMessage(5427).PressableHighlight, obj11);
  } else {
    return null;
  }
