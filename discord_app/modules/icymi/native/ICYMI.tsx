...
import generateHydrationId from "generateHydrationId" /* 8589 */;
import FiltersHorizontalIcon from "FiltersHorizontalIcon" /* 14572 */;
import goBack from "goBack" /* 15954 */;
import IconWithBadge from "IconWithBadge" /* 15956 */;
...
import closure_10 from "initialize" /* 8586 */;
import closure_11 from "filterStaffGuild" /* 8574 */;
import { NUM_GUILDS_EXTENDED_ONBOARDING as closure_12 } from "NUM_GUILDS_EXTENDED_ONBOARDING" /* 16004 */;
...
export const ICYMITab = function ICYMITab(route) {
  ...
  items2[1] = closure_14(_require(4174).ThemeContextProvider, { gradient: tmp3, children: closure_14(ICYMI, { inNestedNavigator }, "" + stateFromStores) });
  obj3.children = items2;
  obj2[0] = tmp14(tmp11, obj3);
  obj1[0] = closure_14(_require(16006).ICYMIContextProvider, obj2);
