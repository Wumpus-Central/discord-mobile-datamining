...
import ICYMIFiltersStore from "ICYMIFiltersStore" /* 8347 */;
...
function ICYMI(inNestedNavigator) {
  ...
  obj3 = { ref, scrollEnabled: !loading, extraData: { endVisible }, contentContainerStyle: memo, accessibilityLabel: null, data: null, refreshing: null, refreshControl: null, onEndReachedThreshold: 3, onEndReached: null, keyExtractor: null, renderItem: null, getItemType: null, drawDistance: 100, stickyHeaderIndices: null, viewabilityConfigCallbackPairs: null };
...
let closure_17 = createStyles.createStyles((paddingTop) => {
  ...
  obj = { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWEST, paddingHorizontal: nativeDefault.space.PX_8, overflow: "hidden", flex: 1, paddingTop };
...
let closure_18 = createICYMIStyles.createICYMIStyles((margin) => {
  ...
  const obj3 = { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, position: "relative", overflow: "hidden", width: "100%" };
  const obj4 = { height: 56, marginHorizontal: margin.margin, flexDirection: "row", alignItems: "center", justifyContent: "space-between" };
...
let closure_22 = noop.memo((inNestedNavigator) => {
  ...
  const obj1 = { dark: client_themes_ClientThemesUtils.OverlayOpacity.LEVEL_7, light: client_themes_ClientThemesUtils.OverlayOpacity.LEVEL_8 };
  obj.mixAmount = obj1;
