...
class MessageRowContent {
  constructor(arg0) {
    ...
    result = obj.extractMediaSourcesFromMessage(
      message,
      message,
      channel.guild_id,
      message(closure_2[16]).GRAVITY_VALID_EMBED_TYPES,
    );
...
function ReplyMessageContent(message) {
  ...
  if (null != stateFromStores) {
    ...
    const items2 = [closure_14(tmp2(4570).Text, obj)];
    ...
    obj5.style = obj6;
    obj5.children = tmp2(4726).getName(guild.id, channel.id, stateFromStores);
    const items4 = [closure_14(tmp2(4570).Text, obj5)];
    ...
    items4[1] = closure_14(tmp2(16487).ICYMIContext.Provider, obj7);
...
let closure_21 = noop.memo((message) => {
  ...
  obj = {
    ...
    accessibilityLabel: channel(tmp2[33])({ channel }),
  ...
  const obj3 = {
    style: tmp10.footer,
    children: closure_14(tmp15(guild[34]), {
      message,
      channel,
      guild,
