...
let closure_6 = createICYMIStyles.createICYMIStyles((marginLeft) => {
  ...
  obj.separator = size;
  obj = { flex: 1, alignItems: "center", justifyContent: "center", flexDirection: "row", marginHorizontal: marginLeft.margin, marginBottom: marginLeft.margin, gap: nativeDefault.space.PX_12 };
  obj.container = obj;
  ...
  const obj1 = { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: nativeDefault.space.PX_12, height: nativeDefault.space.PX_40 };
  ...
  const obj4 = { borderRadius: 20, width: "100%", minHeight: 40, backgroundColor: nativeDefault.colors.REDESIGN_CHAT_INPUT_BACKGROUND, justifyContent: "center" };
