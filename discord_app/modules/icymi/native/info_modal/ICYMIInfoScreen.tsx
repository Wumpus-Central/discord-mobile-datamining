...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  const obj14 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9318).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  ...
  const obj18 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13039).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
