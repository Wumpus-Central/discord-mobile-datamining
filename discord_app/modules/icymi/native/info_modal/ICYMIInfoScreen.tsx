...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  const items9 = [
    closure_9(closure_6, {
      style: tmp.infoIcon,
      children: closure_9(extendedOnboarding(9399).ServerIcon, { size: "sm", color: "interactive-text-active" }),
    }),
  ];
  const obj18 = {
  ...
  const items11 = [
    closure_9(closure_6, {
      style: tmp.infoIcon,
      children: closure_9(extendedOnboarding(13300).NewUserIcon, { size: "sm", color: "interactive-text-active" }),
    }),
  ];
  const obj22 = {
    variant: "text-md/medium",
