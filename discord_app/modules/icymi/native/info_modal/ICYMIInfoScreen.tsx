...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  const obj14 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(9415).ServerIcon, { size: "sm", color: "interactive-text-active" }) };
  ...
  const obj18 = { style: tmp.infoIcon, children: closure_9(extendedOnboarding(13139).NewUserIcon, { size: "sm", color: "interactive-text-active" }) };
