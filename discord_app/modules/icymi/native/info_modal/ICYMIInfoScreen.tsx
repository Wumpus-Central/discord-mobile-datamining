// discord_app/modules/icymi/native/info_modal/ICYMIInfoScreen.tsx
...
export default function ICYMIInfoScreen(extendedOnboarding) {
  ...
  obj.children = closure_9(extendedOnboarding(7936).HeaderIconButton, obj);
  ...
  obj3.uri = navigation(16542);
  obj2.source = obj3;
  obj2.style = tmp.bgImage;
  const items5 = [closure_9(navigation(5638), obj2)];
  ...
  items7[2] = closure_9(extendedOnboarding(4602).Text, obj9);
  ...
  items7[3] = closure_9(extendedOnboarding(4602).Text, obj10);
  ...
  const items9 = [
    closure_9(closure_6, {
      style: tmp.infoIcon,
      children: closure_9(extendedOnboarding(9376).ServerIcon, { size: "sm", color: "interactive-text-active" }),
    }),
  ];
  const obj15 = {
  ...
  items9[1] = closure_9(extendedOnboarding(4602).Text, obj15);
  ...
  const items11 = [
    closure_9(closure_6, {
      style: tmp.infoIcon,
      children: closure_9(extendedOnboarding(13102).NewUserIcon, { size: "sm", color: "interactive-text-active" }),
    }),
  ];
  const obj19 = {
    variant: "text-md/medium",
  ...
  items11[1] = closure_9(extendedOnboarding(4602).Text, obj19);
  ...
  const items12 = [
    closure_9(closure_6, {
      style: tmp.infoIcon,
      children: closure_9(extendedOnboarding(4566).CircleCheckIcon, { size: "sm", color: "interactive-text-active" }),
    }),
  ];
  const obj23 = {
    variant: "text-md/medium",
  ...
  items12[1] = closure_9(extendedOnboarding(4602).Text, obj23);
  ...
  obj24.children = intl7.format(extendedOnboarding(1114).t["jVS/hc"], {
    feedbackHook(children, arg1) {
      return closure_1_9(
        extendedOnboarding(4602).Text,
        {
          variant: "text-xs/medium",
          color: "text-link",
          onPress() {
            return navigation(paths[27]).openLazy(
              extendedOnboarding(paths[29])(paths[28], paths.paths),
              "ICYMIFeedbackSheet",
              {},
            );
          },
  ...
  items13[1] = closure_9(extendedOnboarding(4602).Text, obj24);
  ...
  obj26.children = closure_9(extendedOnboarding(5026).Button, obj27);
