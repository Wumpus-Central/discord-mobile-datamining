...
function SelectedServersRow(selectedGuilds) {
  ...
  fn.__closure = {
    withTiming: selectedGuilds(4640).withTiming,
    selectedGuilds,
...
function FeaturedServer(guild) {
  ...
  if (selected) {
    ...
    tmp7Result = closure_12(tmp2(4599).CircleCheckIcon, obj8);
  }
  ...
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj7.variant = str;
      obj6.children = closure_12(guild(5059).Button, obj7);
      items3[2] = closure_12(closure_6, obj6);
      obj3.children = items3;
      items2[1] = closure_13(closure_6, obj3);
      obj2.children = items2;
      return closure_13(guild(5207).PressableHighlight, obj2);
    }
  }
        ...
        try {
          ...
          if (0 === v3) {
            ...
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              const obj11 = {
                value: tmp51(8472).fetchDehydrated({ isReloading: true, forceRefresh: true }),
                done: false,
              };
              return obj11;
            } else {
