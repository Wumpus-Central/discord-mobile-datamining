...
function SelectedServersRow(selectedGuilds) {
  ...
  let obj = { withTiming: selectedGuilds(4607).withTiming, selectedGuilds, SELECTED_SERVER_SIZE_WITH_BORDER: v50, tokens: first(576) };
  fn.__closure = obj;
...
export default function ICYMIJoinGuildsScreen() {
  ...
  const callback1 = noop.useCallback(extraData(function*() {
    if (dependencyMap === 2) {
      dependencyMap = 3;
