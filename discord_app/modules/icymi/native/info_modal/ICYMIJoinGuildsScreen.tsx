...
function SelectedServersRow(selectedGuilds) {
  ...
  let obj = {
    withTiming: selectedGuilds(4606).withTiming,
    selectedGuilds,
  ...
  obj.children = closure_12(first(7107), obj1);
  return closure_12(first(4341).View, obj);
}
...
function FeaturedServer(guild) {
  ...
  if (selected) {
    ...
    tmp7Result = closure_12(tmp2(4565).CircleCheckIcon, obj5);
  }
  ...
  if (stateFromStores) {
    if (!guild.loading) {
      ...
      obj4.variant = str;
      obj3.children = closure_12(guild(5025).Button, obj4);
      items3[2] = closure_12(closure_6, obj3);
      obj.children = items3;
      items2[1] = closure_13(closure_6, obj);
      obj.children = items2;
      return closure_13(guild(5173).PressableHighlight, obj);
    }
  }
        ...
        try {
          ...
          if (0 === v3) {
            if (arg0 === 1) {
              ...
              v3 = 1;
              dependencyMap = 1;
              let obj1 = { value: v3(8416).gravityJoinGuild(Array.from(first), "icymi_info_modal"), done: false };
              return obj1;
            }
          } else if (1 === tmp4) {
            if (arg0 === 1) {
