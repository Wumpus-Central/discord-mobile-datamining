...
const require = fn;
let result = require("obj132").fileFinishedImporting("modules/icymi/native/info_modal/ICYMIInfoModal.tsx");
...
export default function ICYMIInfoModal(extendedOnboarding) {
  ...
  const navigatorScreens = obj.useNavigatorScreens(() => {
    let obj = { headerLeft: null, render: null, impressionName: null, impressionProperties: null };
    let obj2 = extendedOnboarding(dependencyMap[4]);
    obj[0] = obj2.getHeaderCloseButton();
    obj[1] = function render() {
      return closure_1_4(skipIntro(closure_1_2[5]), { extendedOnboarding: closure_0 });
    };
    obj[2] = extendedOnboarding(dependencyMap[6]).ImpressionNames.ICYMI_ONBOARDING_OVERVIEW;
    obj = { extended_onboarding: extendedOnboarding };
    obj[3] = obj;
    obj[extendedOnboarding(dependencyMap[3]).ICYMIInfoScreens.DEFAULT] = obj;
    ...
    obj[extendedOnboarding(dependencyMap[3]).ICYMIInfoScreens.TOPICS_CLOUD] = {
      headerLeft: headerCloseButton,
      headerRight() {
        let tmp = null;
        if (!closure_1) {
          const obj = { text: null, onPress: null };
          const intl = extendedOnboarding(closure_1_2[9]).intl;
          obj[0] = intl.string(extendedOnboarding(closure_1_2[9]).t["5Wxrcd"]);
          ...
          tmp = closure_1_4(extendedOnboarding(closure_1_2[8]).HeaderActionButton, obj);
        }
        return tmp;
      },
      render() {
      ...
      impressionName: extendedOnboarding(dependencyMap[6]).ImpressionNames.ICYMI_ONBOARDING_TOPICS
    };
    ...
    obj2[0] = extendedOnboarding(dependencyMap[4]).getHeaderBackButton();
    ...
    obj2[3] = extendedOnboarding(dependencyMap[6]).ImpressionNames.ICYMI_ONBOARDING_SELECT_GUILDS;
    obj[extendedOnboarding(dependencyMap[3]).ICYMIInfoScreens.JOIN_GUILDS] = obj2;
    return obj;
  }, items);
  ...
  if (extendedOnboarding) {
    ...
    jsx(tmp(13538).StepModal, { screens: null, steps: null, initialRouteName: null });
  } else {
    obj = { screens: null, initialRouteName: null };
    obj[0] = navigatorScreens;
    obj[1] = tmp(15723).ICYMIInfoScreens.DEFAULT;
    return jsx(tmp(11115).Modal, { screens: null, initialRouteName: null });
  }
};