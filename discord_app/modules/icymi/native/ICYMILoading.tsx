...
function ICYMILoadingItem() {
  ...
  let title;
  const tmp = callback3();
  const tmp2 = useChatPlaceholderAnimatedStyles({ visible: true, animated: true });
  ...
  items[2] = tmp2;
  const items1 = [callback(ReanimatedRexport.View, { style: items }), ];
  ...
  items2[3] = obj2;
  obj1[0] = items2;
  items1[1] = callback(ReanimatedRexport.View, obj1);
  obj[1] = items1;
  ...
  items4[3] = obj4;
  obj3[0] = items4;
  items3[1] = callback(ReanimatedRexport.View, obj3);
  ...
  items5[3] = obj6;
  obj5[0] = items5;
  items3[2] = callback(ReanimatedRexport.View, obj5);
  const items6 = [, , ];
...
let closure_8 = createICYMIStyles.createICYMIStyles((marginBottom) => {
  ...
  obj = { backgroundColor: Themes.colors.BACKGROUND_MOD_SUBTLE };
  obj[0] = obj;
  obj[1] = { padding: marginBottom.margin };
  obj[2] = { flexDirection: "row", alignItems: "center", marginBottom: marginBottom.margin };
  obj = { width: 40, height: 40, borderRadius: Themes.radii.md, marginRight: Themes.space.PX_12 };
  obj[3] = obj;
  obj[4] = { height: 18, borderRadius: 10, flexShrink: 1 };
  obj[5] = { height: Themes.space.PX_16, marginBottom: Themes.space.PX_12, borderRadius: 10, flexShrink: 1 };
  const obj1 = { height: Themes.space.PX_16, marginBottom: Themes.space.PX_12, borderRadius: 10, flexShrink: 1 };
  obj[6] = { height: Themes.space.PX_16, marginBottom: marginBottom.margin, borderRadius: 10, flexShrink: 1 };
  const obj2 = { height: Themes.space.PX_16, marginBottom: marginBottom.margin, borderRadius: 10, flexShrink: 1 };
  obj[7] = { width: "100%", height: 240, borderRadius: Themes.radii.lg };
  obj[8] = {};
  return obj;
});
