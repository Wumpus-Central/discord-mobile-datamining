                        ...
                        if (null != guildId) {
                          ...
                          if (null == closure_2_3) {
                            ...
                            if (tmp14) {
                              ...
                              const obj2 = { uri: originalUri, originalUri, id: closure_3_0(tmp9[33]).v4(), platform: closure_3_0(tmp9[34]).UploadPlatform.REACT_NATIVE };
                              obj1.file = obj2;
                            ...
                            c2 = 1;
                            c1 = 1;
                            const obj4 = { value: tmp8Result1.sendMessage(tmp32.id, parsed, false, obj3), done: false };
                            return obj4;
                          } else {
                            tmp11(tmp32);
                          }
