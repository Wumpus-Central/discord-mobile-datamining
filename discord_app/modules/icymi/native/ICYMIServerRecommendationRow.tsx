...
function FeaturedServer(guild) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            closure_1(8437).feedItemActioned(obj1);
            const obj18 = closure_1(8437);
            const items = [guild.id];
            dependencyMap = 1;
            c3 = 1;
            let obj2 = { value: closure_1(8437).gravityJoinGuild(items, "recommended_guilds"), done: false };
            return obj2;
          }
        } else if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            const obj6 = { page: constants2.ICYMI, section: constants3.ICYMI_RECOMMENDED_SERVERS, object: constants.LIST_ITEM };
            obj5.analyticsSource = obj6;
            obj4.state = obj5;
            closure_128_0 = obj4;
            let obj7 = closure_1(8437);
                ...
                try {
                  ...
                  if (0 === v2) {
                    if (arg0 === 1) {
                      ...
                      v2 = 1;
                      dependencyMap = 1;
                      const obj1 = { value: v2(8437).reloadICYMITab(), done: false };
                      return obj1;
                    }
                  } else if (1 === tmp4) {
                    if (arg0 === 1) {
  ...
  obj3.children = closure_14(guild(5026).Button, obj4);
...
export const ICYMIServerRecommendationRow = function ICYMIServerRecommendationRow() {
  ...
  if (0 !== stateFromStoresArray.length) {
    ...
    const obj1 = { style: tmp3.title, variant: "heading-lg/semibold", color: "mobile-text-heading-primary", children: null };
