...
function FeaturedServer(guild) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            closure_1(8469).feedItemActioned(obj1);
            const obj18 = closure_1(8469);
            const items = [guild.id];
            dependencyMap = 1;
            c3 = 1;
            let obj2 = { value: closure_1(8469).gravityJoinGuild(items, "recommended_guilds"), done: false };
            return obj2;
          }
        } else if (1 === tmp5) {
          if (arg0 === 1) {
                ...
                try {
                  ...
                  if (0 === v2) {
                    if (arg0 === 1) {
                      ...
                      v2 = 1;
                      dependencyMap = 1;
                      const obj1 = { value: v2(8469).reloadICYMITab(), done: false };
                      return obj1;
                    }
                  } else if (1 === tmp4) {
                    if (arg0 === 1) {
  ...
  obj3.children = closure_14(guild(5056).Button, obj4);
