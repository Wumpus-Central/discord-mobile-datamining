...
let closure_7 = createICYMIStyles.createICYMIStyles((margin) => {
  const obj = { height: 1, width: "100%", backgroundColor: ThemesDefault.colors.BORDER_SUBTLE, marginBottom: ThemesDefault.space.PX_16 };
  obj[1] = obj;
  return obj;
});
const result = require("obj132").fileFinishedImporting("modules/icymi/native/ICYMIHeader.tsx");

export default function ICYMIHeader() {
  const tmp = callback3();
  let obj = { style: tmp.separator };
