...
function ICYMIGuildEventRow(event) {
  ...
  obj1.children = closure_11(event(4570).Text, {
  ...
  items3[1] = closure_11(event(4570).Text, obj2);
  ...
  items4[1] = closure_11(event(4570).Text, obj9);
