...
function ICYMIGuildEventRow(event) {
  ...
  let React;
  const tmp = callback4();
  const tmp4 = guild(8997)(event, null);
  ...
  const items4 = [closure_11(event(4858).GroupIcon, { size: "xs", style: tmp.eventsChannelIcon }), ];
