    ...
    let obj5 = {
      ...
      onPress() {
        ...
        const item = dehydratedItems.forEach((type) => {
          ...
          if (tmp3) {
            tmp3 =
              closure_1_1(paths[20]).compare(closure_1_5.ackMessageId(type.data.channel_id), type.data.message_id) >= 0;
          ...
          if (tmp3) {
            ...
            const obj2 = {
              object: constants2.ACK_GRAVITY_CLEAR_READ_STATES_BUTTON,
          ...
          try {
            ...
            if (0 === v1) {
              if (arg0 === 1) {
                ...
                dependencyMap = 1;
                const obj5 = {
                  value: tmp4(8582).regenerateFeedAndClearReadStates(
