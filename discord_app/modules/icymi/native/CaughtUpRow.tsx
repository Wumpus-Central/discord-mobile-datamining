...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(7791).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  fn.__closure = {
    ...
    withDelay: visible(4563).withDelay,
    withSequence: visible(4563).withSequence,
    withTiming: visible(4830).withTiming,
    Easing: visible(4563).Easing,
  };
  ...
  const obj12 = {
    style: null,
    children: closure_7(visible(12550).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }),
  };
