...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(8472).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  fn.__closure = {
    ...
    withDelay: visible(4376).withDelay,
    withSequence: visible(4376).withSequence,
    withTiming: visible(4640).withTiming,
    Easing: visible(4376).Easing,
  };
  ...
  const obj12 = {
    style: null,
    children: closure_7(visible(13147).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }),
  };
