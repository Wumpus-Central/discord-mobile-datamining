...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(8481).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  fn.__closure = {
    ...
    withDelay: visible(4374).withDelay,
    withSequence: visible(4374).withSequence,
    withTiming: visible(4639).withTiming,
    Easing: visible(4374).Easing,
  };
  ...
  const obj12 = {
    style: null,
    children: closure_7(visible(13158).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }),
  };
