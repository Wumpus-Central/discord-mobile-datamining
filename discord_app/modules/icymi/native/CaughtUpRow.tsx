...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(8469).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  obj = {
    ...
    withDelay: visible(4373).withDelay,
    withSequence: visible(4373).withSequence,
    withTiming: visible(4637).withTiming,
    Easing: visible(4373).Easing,
  };
  fn.__closure = obj;
  ...
  obj5 = {
    style: null,
    children: closure_7(visible(13141).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }),
  };
