...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(8621).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  fn.__closure = {
    ...
    withDelay: visible(4492).withDelay,
    withSequence: visible(4492).withSequence,
    withTiming: visible(4757).withTiming,
    Easing: visible(4492).Easing,
  };
  ...
  const obj12 = {
    style: null,
    children: closure_7(visible(13302).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }),
  };
