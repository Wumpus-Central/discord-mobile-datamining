...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(8697).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  fn.__closure = {
    ...
    withDelay: visible(4559).withDelay,
    withSequence: visible(4559).withSequence,
    withTiming: visible(4828).withTiming,
    Easing: visible(4559).Easing,
  };
  ...
  const obj12 = {
    style: null,
    children: closure_7(visible(13391).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }),
  };
