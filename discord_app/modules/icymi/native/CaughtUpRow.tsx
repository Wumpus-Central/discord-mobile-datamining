...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(8626).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  fn.__closure = {
    ...
    withDelay: visible(4493).withDelay,
    withSequence: visible(4493).withSequence,
    withTiming: visible(4758).withTiming,
    Easing: visible(4493).Easing,
  };
  ...
  const obj12 = {
    style: null,
    children: closure_7(visible(13309).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }),
  };
