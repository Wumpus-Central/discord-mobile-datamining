...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(7799).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  fn.__closure = {
    ...
    withDelay: visible(4566).withDelay,
    withSequence: visible(4566).withSequence,
    withTiming: visible(4837).withTiming,
    Easing: visible(4566).Easing,
  };
