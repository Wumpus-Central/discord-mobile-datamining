...
export default function ExploreServersRow(visible) {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    sharedValue(8379).feedItemActioned({
      itemId: "caught_up",
      itemType: "caught_up",
      actionParameters: {
        actionGestureType: "press",
  ...
  obj = {
    ...
    withDelay: visible(4310).withDelay,
    withSequence: visible(4310).withSequence,
    withTiming: visible(4575).withTiming,
    Easing: visible(4310).Easing,
  };
  fn.__closure = obj;
  ...
  obj5 = {
    style: null,
    children: closure_7(visible(13041).FlashIcon, { size: "custom", style: tmp.icon, color: "background-brand" }),
  };
