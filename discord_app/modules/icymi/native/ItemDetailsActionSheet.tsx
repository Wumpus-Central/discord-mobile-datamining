...
export default function ItemDetailsActionSheet(arg0) {
  ...
  if (null != stateFromStores1) {
    ...
    let tmp9 = callback(tmp5(5818), obj);
    const tmp5Result = tmp5(5818);
  ...
  if (result) {
    result = tmp(8957).isChannelCustomScoreEligible(stateFromStores);
    const tmpResult = tmp(8957);
  }
  ...
  if (null != stateFromStores2) {
    ...
    if (tmp8) {
      ...
      obj7[2] = tmp16(tmp(5413).TableRow, obj8);
      tmp16Result = tmp16(tmp(5806).TableRowGroup, obj7);
    }
  }
