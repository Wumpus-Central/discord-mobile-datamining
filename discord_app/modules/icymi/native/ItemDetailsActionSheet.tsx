...
export default function ItemDetailsActionSheet(arg0) {
  ...
  if (result) {
    result = tmp(8918).isChannelCustomScoreEligible(stateFromStores);
    const tmpResult = tmp(8918);
  }
  ...
  obj2 = { showGradient: true, startExpanded: true, header: tmp16(tmp(10202).ActionSheetIconHeader, obj1), children: null };
  obj1[2] = str;
  ...
  if (result) {
    ...
    tmp16Result = tmp16(tmp(15591).ChannelScoreSettings, obj3);
  }
  ...
  if (tmp15Result) {
    ...
    items4[1] = tmp16(tmp(15591).GuildScoreSettings, obj6);
    obj5[0] = items4;
