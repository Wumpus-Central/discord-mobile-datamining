...
export default function ICYMIFeedbackSheet() {
  ...
  obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t["ppfH9+"]);
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj[3] = intl2.string(getSystemLocale /* getSystemLocale */.t["ePk/Cf"]);
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj[4] = intl3.string(getSystemLocale /* getSystemLocale */.t.sBOuOf);
  obj = { label: null, value: "irrelevant_content" };
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj[0] = intl4.string(getSystemLocale /* getSystemLocale */.t.F6TmZA);
  let items = [obj, , , , ];
  obj = { label: null, value: "not_enough_content" };
  const intl5 = getSystemLocale /* getSystemLocale */.intl;
  obj[0] = intl5.string(getSystemLocale /* getSystemLocale */.t.voWAzi);
  items[1] = obj;
  const obj1 = { label: null, value: "too_much_content" };
  const intl6 = getSystemLocale /* getSystemLocale */.intl;
  obj1[0] = intl6.string(getSystemLocale /* getSystemLocale */.t.Ay8iwx);
  items[2] = obj1;
  const obj2 = { label: null, value: "laggy" };
  const intl7 = getSystemLocale /* getSystemLocale */.intl;
  obj2[0] = intl7.string(getSystemLocale /* getSystemLocale */.t["Yu+52W"]);
  items[3] = obj2;
  items[4] = { label: "Other", value: "other" };
  obj[5] = items;
  obj[7] = DEFAULT_UX_VARIATION /* DEFAULT_UX_VARIATION */.ICYMIAnalytics.trackFeedFeedbackPromptViewed;
  obj[8] = ["other"];
