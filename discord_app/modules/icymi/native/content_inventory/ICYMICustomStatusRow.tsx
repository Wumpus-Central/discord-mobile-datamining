...
let closure_13 = createICYMIStyles.createICYMIStyles((gap, arg1) => {
  ...
  const obj = {
    bubbles: { position: "absolute", top: num },
    middleBubble: null,
    bottomBubble: null,
    title: null,
    timestamp: null,
  ...
  obj.uploadContainer = {
    marginHorizontal: gap.margin,
    marginBottom: gap.margin,
    alignItems: "center",
    justifyContent: "center",
    minHeight: nativeDefault.space.PX_48,
    width: "100%",
    borderStyle: "dashed",
...
export default function GravityCustomStatusEntryRow(id) {
  ...
  const stateFromStores2 = id(renderForScreenshot[15]).useStateFromStores(
    items3,
    () => {
  ...
  if (null == stateFromStores) {
    ...
    if (renderForScreenshot) {
      ...
      const size1 = {
        shape: tmp2(renderForScreenshot[32]).CutoutShape.RoundedRect,
        x: size.width - tmp14(renderForScreenshot[6]).space.PX_16 - 40 - 3,
        y: size.height - 14 - 3,
        width: 46,
        height: 34,
        cornerRadius: tmp14(renderForScreenshot[6]).radii.md + 3,
      };
      items12 = [size1];
      const size2 = {
        shape: tmp2(renderForScreenshot[32]).CutoutShape.RoundedRect,
        x: size.width - tmp14(renderForScreenshot[6]).space.PX_16 - 86 - PX_8,
        y: size.height - 14 - 3,
        width: 46,
        height: 34,
        cornerRadius: tmp14(renderForScreenshot[6]).radii.md + 3,
