...
export const ICYMIAnalytics = {
  ...
  trackFeedShown(homeSessionId) {
    const obj = { load_id: ICYMIStore.getLoadId(), home_session_id: homeSessionId.homeSessionId, variant: homeSessionId.variant };
  ...
  trackFeedEmptyLoadingComplete(dwellTimeMs) {
    const obj = { load_id: ICYMIStore.getLoadId(), dwell_time_ms: dwellTimeMs.dwellTimeMs, version: ICYMIStore.getVersion() };
