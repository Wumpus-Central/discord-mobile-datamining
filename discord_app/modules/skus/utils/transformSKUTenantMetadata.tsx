// === Module 4297: transformProfileEffectKeyFrameFromServer ===
    ...
    if (null != collectibles) {
      ...
      if (null != item) {
        ...
        if (require(1901) /* CollectiblesItemType */.CollectiblesItemType.AVATAR_DECORATION === type) {
          ...
          obj1[4] = item.label;
          tmp7 = obj1;
        } else if (tmp8(1901).CollectiblesItemType.NAMEPLATE === type) {
          ...
          tmp7 = obj3;
        } else if (tmp8(1901).CollectiblesItemType.PROFILE_EFFECT === type) {
          ...
          obj5[9] = mapped1;
          tmp7 = obj5;
        } else if (tmp8(1901).CollectiblesItemType.PROFILE_FRAME === type) {
