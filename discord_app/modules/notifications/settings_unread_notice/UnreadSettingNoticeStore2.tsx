          ...
          if (UserGuildSettingsStore.isGuildOrCategoryOrChannelMuted(basicChannel.guild_id, basicChannel.id)) {
            ...
            if (flag2) {
              ...
              if (flag3) {
                ...
                return UserGuildSettingsStore.getChannelUnreadSetting(basicChannel.guild_id, basicChannel.id) === UnreadSetting.UNSET && unreadSetting !== UnreadSetting.ALL_MESSAGES;
              }
            }
          }
        }
