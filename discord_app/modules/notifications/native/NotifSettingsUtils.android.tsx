...
function buildChannelsAndMapping() {
  const assignedNotifSettingsAndMappings = map(14012).getAssignedNotifSettingsAndMappings();
...
({
  NOTIF_CATEGORIES: c3,
  NOTIF_SETTING_MAPPING: closure_4,
  NOTIF_SETTINGS: hasOwnProperty,
} = NotificationSettingsConstants);
const constants = {
  NONE: 0,
  [0]: "NONE",
  MIN: 1,
