...
export const updateChannelPreset = function updateChannelPreset(guild_id, id, arg2) {
  ...
  if (arg2 === notificationSettingsPresetUtils.Presets.ALL_MESSAGES) {
    ...
    const obj2 = { message_notifications: UserNotificationSettings.ALL_MESSAGES, flags: notificationSettingsFlagUtils.withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ALL_MESSAGES) };
    const result = obj7.updateChannelOverrideSettings(guild_id, id, obj2, NotificationSettingsUtils.NotificationLabels.PresetAll);
    ...
    const obj3 = { message_notifications: UserNotificationSettings.ONLY_MENTIONS, flags: notificationSettingsFlagUtils.withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ALL_MESSAGES) };
    const result1 = obj4.updateChannelOverrideSettings(guild_id, id, obj3, NotificationSettingsUtils.NotificationLabels.PresetHybrid);
    const tmp2Result4 = notificationSettingsFlagUtils;
  } else if (arg2 === notificationSettingsPresetUtils.Presets.MENTIONS) {
    const obj = NotificationSettingsModalActionCreatorsDefault;
    const obj5 = { message_notifications: UserNotificationSettings.ONLY_MENTIONS, flags: notificationSettingsFlagUtils.withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ONLY_MENTIONS) };
    const result2 = obj.updateChannelOverrideSettings(guild_id, id, obj5, NotificationSettingsUtils.NotificationLabels.PresetMentions);
    ...
    const obj6 = { message_notifications: UserNotificationSettings.NO_MESSAGES, flags: notificationSettingsFlagUtils.withChannelUnreadFlags(channelIdFlags, constants.UNREADS_ONLY_MENTIONS) };
    const result3 = obj10.updateChannelOverrideSettings(guild_id, id, obj6, NotificationSettingsUtils.NotificationLabels.PresetNothing);
