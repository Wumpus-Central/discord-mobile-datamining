...
export default function NotificationSettingsMessageUnreadActionSheet(defaultValue) {
  ...
  obj6[0] = intl3.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["HVah/3"]);
  obj6[1] = UnreadSetting.ALL_MESSAGES;
  const items2 = [callback(require("../../../../design/components/TableRow/native/TableRadioRow.native.tsx") /* TableRadioRow */.TableRadioRow, obj6), ];
  ...
  obj7[2] = intl4.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["tu+ZWJ"]);
  obj7[3] = UnreadSetting.ONLY_MENTIONS;
  items2[1] = callback(require("../../../../design/components/TableRow/native/TableRadioRow.native.tsx") /* TableRadioRow */.TableRadioRow, obj7);
  obj5[3] = items2;
  obj4[1] = callback2(require("../../../../design/components/TableRow/native/TableRadioGroup.native.tsx") /* context */.TableRadioGroup, obj5);
