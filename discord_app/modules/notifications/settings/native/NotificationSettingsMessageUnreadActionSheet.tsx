...
export default function NotificationSettingsMessageUnreadActionSheet(defaultValue) {
  ...
  obj[1] = callback(NotificationSettingsMockChannels, obj);
  const items = [callback(View, obj), ];
  const obj1 = { style: tmp.content, children: null };
  const obj2 = { variant: "text-sm/semibold", children: null };
  const intl = getSystemLocale /* getSystemLocale */.intl;
  obj2[1] = intl.string(getSystemLocale /* getSystemLocale */.t.Tqd1Af);
  const items1 = [callback(Text /* Text */.Text, obj2), , ];
  const obj3 = { variant: "text-xs/medium", color: "text-muted", children: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj3[2] = intl2.string(getSystemLocale /* getSystemLocale */.t.RpQgm5);
  ...
  obj6[0] = intl3.string(getSystemLocale /* getSystemLocale */.t["HVah/3"]);
  obj6[1] = UnreadSetting.ALL_MESSAGES;
  const items2 = [callback(TableRadioRow /* TableRadioRow */.TableRadioRow, obj6), ];
  ...
  obj7[2] = intl4.string(getSystemLocale /* getSystemLocale */.t["tu+ZWJ"]);
  obj7[3] = UnreadSetting.ONLY_MENTIONS;
  items2[1] = callback(TableRadioRow /* TableRadioRow */.TableRadioRow, obj7);
  obj5[3] = items2;
  obj4[1] = callback2(context /* context */.TableRadioGroup, obj5);
