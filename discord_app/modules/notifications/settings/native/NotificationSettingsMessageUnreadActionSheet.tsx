...
export default function NotificationSettingsMessageUnreadActionSheet(defaultValue) {
  ...
  obj[1] = callback(importDefault(9756), obj);
  ...
  const items2 = [callback(require(7794) /* TableRadioRow */.TableRadioRow, obj6), ];
  ...
  items2[1] = callback(require(7794) /* TableRadioRow */.TableRadioRow, obj7);
  obj5[3] = items2;
  obj4[1] = callback2(require(7795) /* context */.TableRadioGroup, obj5);
