...
export default function NotificationSettingsMockMessage(notificationSetting) {
  ...
  obj = { withTiming: tmp2(4575).withTiming, opacity: sharedValue, timingStandard: tmp2(4578).timingStandard };
  fn.__closure = obj;
  ...
  if (notificationSetting.notificationSetting === UserNotificationSettings.ALL_MESSAGES) {
    ...
    let tmp11 = closure_7(tmp2(4570).Text, obj);
    let tmp12 = closure_7;
  } else {
    obj1 = { children: null };
    ...
    const items2 = [closure_8(tmp2(4570).Text, obj3), ];
  ...
  const obj6 = { children: tmp12(require("native").Avatar, { source: sharedValue(10191), size: require("native").AvatarSizes.LARGE_48 }) };
  ...
  obj10.style = items7;
  items6[1] = tmp12(sharedValue(4310).View, obj10);
