...
export default function NotificationSettingsMockMessage(notificationSetting) {
  ...
  obj = { withTiming: tmp2(4607).withTiming, opacity: sharedValue, timingStandard: tmp2(4610).timingStandard };
  fn.__closure = obj;
  ...
  if (notificationSetting.notificationSetting === UserNotificationSettings.ALL_MESSAGES) {
    ...
    let tmp11 = closure_7(tmp2(4602).Text, obj);
    let tmp12 = closure_7;
  } else {
    obj1 = { children: null };
    ...
    const items2 = [closure_8(tmp2(4602).Text, obj3), ];
    const intl3 = tmp2(1114).intl;
    items2[1] = intl3.string(tmp2(1114).t.WYyzI5);
    obj2.children = items2;
    obj1.children = closure_8(tmp2(4602).Text, obj2);
  ...
  const obj6 = { children: tmp12(require("native").Avatar, { source: sharedValue(10248), size: require("native").AvatarSizes.LARGE_48 }) };
  ...
  obj10.style = items7;
  items6[1] = tmp12(sharedValue(4343).View, obj10);
