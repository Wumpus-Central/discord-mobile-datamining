// === Module 10421: NotificationSettingsMockMessage ===
...
export default function NotificationSettingsMockMessage(notificationSetting) {
  ...
  let str = sharedValue(4601).getName(stateFromStores);
  if (str == null) {
    str = "Roka";
  }
  _require = tmp7;
  const obj2 = sharedValue(4601);
  let num = 0;
  ...
  if (notificationSetting.notificationSetting === UserNotificationSettings.ALL_MESSAGES) {
    ...
    let tmp11 = closure_7(tmp2(4753).Text, obj4);
    let tmp12 = closure_7;
  } else {
    ...
    const items2 = [closure_8(tmp2(4753).Text, obj7), ];
    const intl3 = tmp2(1115).intl;
    items2[1] = intl3.string(tmp2(1115).t.WYyzI5);
    obj6.children = items2;
    obj5.children = closure_8(tmp2(4753).Text, obj6);
  ...
  obj10.children = tmp12(require("native").Avatar, { source: sharedValue(10422), size: require("native").AvatarSizes.LARGE_48 });
  ...
  obj14.style = items7;
  items6[1] = tmp12(sharedValue(4493).View, obj14);
