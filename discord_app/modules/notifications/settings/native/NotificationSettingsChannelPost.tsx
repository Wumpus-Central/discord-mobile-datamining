...
export const NotificationSettingsChannelPost = function NotificationSettingsChannelPost(channel) {
  ...
  obj[0] = intl.string(_require("../../../../intl/index.native.tsx").t.bK11jO);
  const obj1 = { label: null, checked: null, disabled: null, onPress: null };
  const intl2 = _require("../../../../intl/index.native.tsx").intl;
  obj1[0] = intl2.string(_require("../../../../intl/index.native.tsx").t.Rkgjph);
  ...
  obj[2] = jsx(_require("../../../../design/components/TableRow/native/TableCheckboxRow.native.tsx").TableCheckboxRow, { label: null, checked: null, disabled: null, onPress: null });
  obj[1] = jsx(_require("../../../../design/components/TableRow/native/TableRowGroup.native.tsx").TableRowGroup, { title: null, hasIcons: false, children: null });
