...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj1[2] = callback(BellIcon.BellIcon, { size: "md", color: "interactive-text-default" });
  ...
  obj2[3] = intl.string(getSystemLocale.t.uAmAiL);
  ...
  obj6[1] = intl4.string(getSystemLocale.t.WAI6xu);
