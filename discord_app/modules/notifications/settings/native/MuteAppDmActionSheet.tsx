...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj = { style: tmp.iconContainer, children: callback(View, { style: tmp.iconBackground, "aria-hidden": true, children: callback(_BellIcon.BellIcon, { size: "md", color: "interactive-text-default" }) }) };
  ...
  obj2[3] = intl.string(_getSystemLocale.t.uAmAiL);
  ...
  obj3[3] = intl2.string(_getSystemLocale.t.mscFJU);
  items[2] = callback(_Text.Text, obj3);
  const obj4 = { variant: "destructive", text: null, onPress: null };
  const intl3 = _getSystemLocale.intl;
  obj4[1] = intl3.string(_getSystemLocale.t.uAmAiL);
  ...
  items[3] = callback(_Button.Button, obj4);
  ...
  obj6[1] = intl4.string(_getSystemLocale.t.WAI6xu);
  obj6[2] = function onPress() {
    channel(table[12]).hideActionSheet();
  };
  obj5[1] = callback(_Button.Button, obj6);
