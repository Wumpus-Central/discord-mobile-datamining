...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj2[3] = intl2.string(getSystemLocale.t.uAmAiL);
  ...
  obj6[1] = intl5.string(getSystemLocale.t.WAI6xu);
