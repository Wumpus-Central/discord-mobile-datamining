...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj1[1] = BellIcon /* BellIcon */.BellIcon;
  let intl = getSystemLocale /* getSystemLocale */.intl;
  obj1[3] = intl.string(getSystemLocale /* getSystemLocale */.t.uAmAiL);
  ...
  obj2[3] = intl2.string(getSystemLocale /* getSystemLocale */.t.uAmAiL);
  ...
  obj3[3] = intl3.string(getSystemLocale /* getSystemLocale */.t.mscFJU);
  items[2] = callback(Text /* Text */.Text, obj3);
  const obj4 = { variant: "destructive", text: null, onPress: null };
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj4[1] = intl4.string(getSystemLocale /* getSystemLocale */.t.uAmAiL);
  ...
  obj6[1] = intl5.string(getSystemLocale /* getSystemLocale */.t.WAI6xu);
