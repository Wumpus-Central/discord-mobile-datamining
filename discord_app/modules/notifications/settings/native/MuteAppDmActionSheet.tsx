...
createCacheKey = {
  ...
  headerText: null,
  infoText: null,
  dismissButtonContainer: null,
  mutedNotificationContainer: null,
  mutedNotification: null,
};
createCacheKey = {
  width: 48,
  height: 48,
...
export default function MuteAppDMActionSheet(channel) {
  ...
  obj = {
    ...
    children: callback(View, {
      style: tmp.iconBackground,
      "aria-hidden": true,
      children: callback(
        require("../../../../design/components/Icon/native/redesign/generated/BellIcon.tsx").BellIcon,
        { size: "md", color: "interactive-text-default" },
      ),
    }),
  };
  ...
  obj4[2] = function onPress() {
    ...
    const result = obj.updateChannelOverrideSettings(
      ...
      channel.id,
      { muted: true },
      callback(closure_1_2[11]).NotificationLabels.Muted,
    );
    ...
    obj[2] = function icon() {
      ...
      obj = {
        source: closure_1_1(closure_1_2[15]),
        color: closure_1_1(closure_1_2[4]).unsafe_rawColors.WHITE,
        style: closure_0.mutedNotification,
      };
