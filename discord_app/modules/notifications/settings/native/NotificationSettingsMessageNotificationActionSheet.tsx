...
export default function NotificationSettingsMessageNotificationActionSheet(defaultValue) {
  ...
  obj[1] = callback(NotificationSettingsMockMessage, obj);
  const items = [callback(View, obj), ];
  const obj1 = { style: tmp.content, children: null };
  const obj2 = { variant: "text-sm/semibold", children: null };
  const intl = getSystemLocale /* getSystemLocale */.intl;
  obj2[1] = intl.string(getSystemLocale /* getSystemLocale */.t["1m22ZB"]);
  const items1 = [callback(Text /* Text */.Text, obj2), callback(Text /* Text */.Text, { variant: "text-xs/medium", color: "text-muted" }), ];
  ...
  obj5[0] = intl2.string(getSystemLocale /* getSystemLocale */.t["HVah/3"]);
  obj5[1] = UserNotificationSettings.ALL_MESSAGES;
  obj5[2] = defaultValue.allMessagesSubLabel;
  const items2 = [callback(TableRadioRow /* TableRadioRow */.TableRadioRow, obj5), , ];
  const obj6 = { label: null, value: null };
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj6[0] = intl3.string(getSystemLocale /* getSystemLocale */.t["tu+ZWJ"]);
  obj6[1] = UserNotificationSettings.ONLY_MENTIONS;
  items2[1] = callback(TableRadioRow /* TableRadioRow */.TableRadioRow, obj6);
  const obj7 = { label: null, value: null };
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj7[0] = intl4.string(getSystemLocale /* getSystemLocale */.t.X4wWUi);
  obj7[1] = UserNotificationSettings.NO_MESSAGES;
  items2[2] = callback(TableRadioRow /* TableRadioRow */.TableRadioRow, obj7);
  obj4[3] = items2;
  obj3[1] = callback2(context /* context */.TableRadioGroup, obj4);
