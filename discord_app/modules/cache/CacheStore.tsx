          ...
          if (null == closure_0) {
            ...
            if ("private-channels" !== page) {
              ...
              if (c22) {
                c6 = 1;
                c7 = 1;
                const obj2 = { value: TryLoad.tryLoadAsync(async () => closure_1(10).timeAsync("\u{1F4BE}", "cache: guilds", async () => closure_2_1(7701).getAsync(closure_1_0))), done: false };
                return obj2;
              } else {
        ...
        if (arg0 === 1) {
          ...
          if (null != closure_132_2) {
            if ("@me" !== closure_132_2) {
              ...
              c6 = 3;
              c7 = 1;
              obj7 = { value: obj1.tryLoadAsync(async () => closure_1(7701).getOneAsync(closure_1_0, dependencyMap)), done: false };
              return obj7;
            }
          }
          c7 = 3;
