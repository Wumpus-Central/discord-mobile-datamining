        ...
        if (arg0 === 1) {
          ...
          if (null == closure_0) {
            ...
            resolved = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: user_settings", async () =>
              closure_1(7817).getAll(closure_1_0),
            );
          }
          if (null == closure_0) {
            ...
            resolved1 = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: read_states", async () =>
              closure_1(7818).getAll(closure_1_0),
            );
          }
          if (null == closure_0) {
            ...
            resolveResult = AppStartPerformanceDefault.timeAsync("\u{1F4BE}", "cache: user_guild_settings", async () =>
              closure_1(7819).getAll(closure_1_0),
            );
          }
          timeRequireDefault("AllCacheStores", () => closure_1_0(7821));
          timeRequireDefault("MobileAppDatabaseManager", () => closure_1_0(7965));
          let items = [
            result,
            measureAsyncResult,
                ...
                const obj6 = {
                  value: TryLoad.tryLoadAsync(async () =>
                    closure_1(10).timeAsync("\u{1F4BE}", "cache: guilds", async () =>
                      closure_2_1(7971).getAsync(closure_1_0),
                    ),
                  ),
                  done: false,
                };
            ...
            if ("@me" !== closure_132_2) {
              ...
              const obj13 = {
                value: closure_133_0(closure_133_2[24]).tryLoadAsync(async () =>
                  closure_1(7971).getOneAsync(closure_1_0, dependencyMap),
                ),
                done: false,
              };
              return obj13;
                ...
                closure_0(initialGuildId[24]).tryLoadAsync(async () => {
                  if (null != closure_1_0) {
                    let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync(
                      "\u{1F4BE}",
                      "cache: cache_version",
                      async () => closure_2_1(7975).okAsync(closure_1_0),
                    );
                ...
                if (null != closure_1_0) {
                  if (!closure_2_22) {
                    let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync(
                      "\u{1F4BE}",
                      "cache: lazy guilds",
                      async () => closure_2_1(7971).getAsync(closure_1_0),
                    );
                    const obj = closure_2_1(initialGuildId[13]);
                  }
                  return timeAsyncResult;
              ...
              items[2] = closure_0(initialGuildId[24]).tryLoadAsync(async () => {
                if (null != closure_1_0) {
                  let timeAsyncResult = closure_2_1(initialGuildId[13]).timeAsync(
                    ...
                    async () => closure_2_1(7969).getAsync(closure_1_0),
                  );
              ...
              if (closure_128_5) {
                ...
                const obj11 = {
                  value: (function dontLoadLateLazyCache() {
                    const f127948 = () => closure_1(_true[23]).dispatch({ type: "CACHE_LOADED_LAZY_NO_CACHE" });
