...
export default function CustomColorPickerActionSheet(arg0) {
  ...
  let obj3 = onSelect(4310);
  sharedValue = obj3.useSharedValue(h);
  let obj5 = onSelect(4310);
  ...
  obj.trailing = sharedValue2(onSelect(4989).Button, obj1);
  obj.header = sharedValue2(onSelect(7163).BottomSheetTitleHeader, obj);
  ...
  const items3 = [sharedValue2(onSelect(6620).TextInput, obj3), , ];
  ...
  items3[2] = sharedValue2(tmp16(14627), obj5);
  obj2.children = items3;
  obj.children = tmp13(tmp14, obj2);
  return sharedValue2(onSelect(7164).BottomSheet, obj);
};