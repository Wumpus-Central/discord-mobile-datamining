...
function ColorBox(hue) {
  ...
  obj = { hslToRgbWorklet: hue(14685).hslToRgbWorklet, hue };
  S.__closure = obj;
  ...
  obj = { runOnJS: hue(4373).runOnJS, setColor: tmp3 };
  fn.__closure = obj;
...
export default function SaturationValueColorPicker(hue) {
  ...
  obj = { onPanFinalize, runOnJS: hue(4373).runOnJS };
  fn3.__closure = obj;
  ...
  let obj1 = { hsvToRgbWorklet: hue(14685).hsvToRgbWorklet, hue, saturation, value, colorBoxWidth, colorBoxHeight: first1 };
