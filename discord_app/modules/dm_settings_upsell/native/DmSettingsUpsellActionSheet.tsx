...
export default function DmSettingsUpsellActionSheet(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj1 = { source: stateFromStores(11446), style: tmp.headerImage };
    ...
    items2[1] = closure_7(tmp2(4601).Text, obj2);
    ...
    items2[2] = closure_7(tmp2(4601).Text, obj3);
    ...
    const items3 = [closure_7(tmp2(4601).Text, obj6), ];
    const obj7 = { style: tmp.guildInfo, children: null };
    const obj8 = { guild: stateFromStores, size: tmp2(5634).GuildIconSizes.SMALL_32 };
    const items4 = [closure_7(stateFromStores(5634), obj8), ];
    const obj9 = { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: stateFromStores.name };
    items4[1] = closure_7(tmp2(4601).Text, obj9);
    ...
    const obj10 = {
      ...
      onPress() {
          ...
          RestrictedGuildIds.updateSetting(Array.from(sanitizedRestrictedGuilds)).then(() => {
            stateFromStores(4303);
            const obj = { key: "DM_SETTINGS_UPSELL_SUCCESS_TOAST", icon: stateFromStores(9636), content: null };
    ...
    items2[4] = closure_7(tmp2(5025).Button, obj10);
    const obj11 = {
      size: "lg",
      variant: "secondary",
      onPress() {
    ...
    items2[5] = closure_7(tmp2(5025).Button, obj11);
    ...
    items2[6] = closure_7(tmp2(4601).Text, obj12);
    obj.children = items2;
    obj.children = closure_8(closure_4, obj);
    tmp6 = closure_7(tmp2(7249).ActionSheet, obj);
