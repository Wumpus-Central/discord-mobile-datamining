          ...
          postResult
            .then((body) => {
              ...
              let obj = {
                ...
                classifications: mapped.concat(guild_classifications),
                accountStanding: account_standing,
                isDsaEligible: is_dsa_eligible,
                username,
      ...
      try {
        ...
        if (0 === c2) {
          if (arg0 === 1) {
            ...
            const HTTP = HTTPUtils.HTTP;
            const request = {
              url: constants.SAFETY_HUB_REQUEST_SUSPENDED_AGE_VERIFICATION,
              body: null,
    ...
    try {
      ...
      if (0 === c1) {
        if (arg0 === 1) {
          ...
          const HTTP = HTTPUtils.HTTP;
          const request = {
            url: constants.SAFETY_HUB_CHECK_SUSPENDED_AGE_VERIFICATION,
            body: null,
            rejectWithError: null,
          };
      ...
      try {
        ...
        if (0 === c2) {
          if (arg0 === 1) {
            ...
            const HTTP = HTTPUtils.HTTP;
            const request = {
              url: Endpoints.SAFETY_HUB_CHECK_SUSPENDED_AGE_VERIFICATION_V2,
              body: null,
              rejectWithError: null,
            };
