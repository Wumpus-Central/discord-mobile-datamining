...
function ClassificationPolicyCard(classificationDescription) {
  ...
  obj3[2] = intl.format(policyExplainerLink(1236).t.zxUdpj, {
...
({
  SafetyHubAnalyticsActionSource: c9,
  SafetyHubAnalyticsActions: c10,
  SafetyHubLinks: unpackModuleId,
} = SafetyHubView);
...
createCacheKey[5] = {
  display: "flex",
  paddingLeft: ThemesDefault.space.PX_4,
  flexDirection: "column",
  gap: ThemesDefault.space.PX_8,
};
let obj4 = {
