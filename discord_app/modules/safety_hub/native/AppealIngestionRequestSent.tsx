// === Module 11544: AppealIngestionRequestSent ===

// Module 11544 (AppealIngestionRequestSent)
import noopAll from "noop" /* 19 */;
import AppealIngestionExternalLinkDefault from "AppealIngestionExternalLink" /* 11539 */;
import registerAssetDefault from "registerAsset" /* 11545 */;
...
export default function AppealIngestionRequestSent() {
  ...
  const items = [callback(closure_4, { source: registerAssetDefault, style: tmp.checkboxPng }), callback(_require(11534).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: stringResult1 }), , , ];
  ...
  items[2] = callback(_require(4440).Text, obj2);
  ...
  return callback(_require(11534).AppealIngestionModalScreen, obj);
};