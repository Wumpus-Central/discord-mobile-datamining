...
import _modDef12000 from "../../../../_runtime/metro/12000__.js";
...
export default function AppealIngestionRequestSent() {
  ...
  const items = [
    closure_7(closure_4, { source: _modDef12000, style: tmp.checkboxPng }),
  ...
  const obj1 = { source: _modDef12000, style: tmp.checkboxPng };
