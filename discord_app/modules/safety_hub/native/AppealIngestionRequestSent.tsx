...
import registerAssetDefault from "../../../../_runtime/11131_registerAsset.js";
...
export default function AppealIngestionRequestSent() {
  ...
  const items = [callback(closure_4, { source: registerAssetDefault, style: tmp.checkboxPng }), callback(require("AppealIngestionModal.tsx").AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: stringResult1 }), , , ];
