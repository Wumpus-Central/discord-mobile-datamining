// === Module 11227: AppealIngestionRequestSent ===
...
export default function AppealIngestionRequestSent() {
  ...
  const items = [callback(closure_4, obj1), callback(_require(11217).AppealIngestionModalHeader, { headerText: stringResult, subHeaderText: intl2.string(_require(1236).t.Qdx8AP) }), , , ];
  ...
  items[2] = callback(_require(4251).Text, obj2);
  ...
  items[3] = callback(importDefault(11222), obj3);
  const obj4 = { text: null, url: null, onPress: null };
  const tmp4 = importDefault(11222);
  ...
  items[4] = callback(importDefault(11222), obj4);
  obj[1] = items;
  obj[0] = callback2(closure_3, obj);
  return callback(_require(11217).AppealIngestionModalScreen, obj);
};