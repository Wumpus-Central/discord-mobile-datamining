...
function ClassificationDetail(classification) {
  ...
  obj = {
    onPress() {
      ...
      obj.pushLazy(asyncRequireImpl(11909, dependencyMap.paths), obj);
    },
    children: null,
  };
...
class SafetyHubViolationsContainer {
  constructor(arg0) {
    ...
    effect = closure_4.useEffect(() => {
      if (first) {
        const obj = {
          action: React7.ViewViolationsDropdown,
...
createStyles.detailContainerOuter = {
...
createStyles.detailContainerOuterNew = {
