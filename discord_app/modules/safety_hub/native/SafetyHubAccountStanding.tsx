...
export default function SafetyHubAccountStanding() {
  ...
  memo = memo.useMemo(() => {
    ...
    obj1 = {
      title: accountStanding(1236).t.epkcmS,
      description: null,
      status: null,
      style: null,
      CustomIcon: null,
    ...
    const obj2 = {
      title: accountStanding(1236).t.crzE2X,
      description: null,
      status: null,
      style: null,
      CustomIcon: null,
    ...
    const obj3 = {
      title: accountStanding(1236).t.XRNVzO,
      description: null,
      status: null,
      style: null,
      CustomIcon: null,
    ...
    const obj4 = {
      title: accountStanding(1236).t.MExFkz,
      description: null,
      status: null,
      style: null,
      CustomIcon: null,
  ...
  const items5 = [
    closure_9(accountStanding(4474).Text, obj4),
    closure_9(accountStanding(4474).Text, {
