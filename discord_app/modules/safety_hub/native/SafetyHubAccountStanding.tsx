...
export default function SafetyHubAccountStanding() {
  ...
  memo = memo.useMemo(() => {
    ...
    obj[2] =
      accountStanding(14766).ACCOUNT_STANDING_SHORT_STATUS[
        accountStanding(undefined, 8420).AccountStandingState.ALL_GOOD
      ];
    obj[3] = closure_3.good;
    obj[4] = accountStanding(4520).CircleCheckIcon;
    obj[accountStanding(8420).AccountStandingState.ALL_GOOD] = obj;
    obj1 = {
      title: accountStanding(1114).t.epkcmS,
      description: null,
      status: null,
      style: null,
      CustomIcon: null,
    ...
    obj1[2] =
      accountStanding(14766).ACCOUNT_STANDING_SHORT_STATUS[
        accountStanding(undefined, 8420).AccountStandingState.LIMITED
      ];
    ...
    const obj2 = {
      title: accountStanding(1114).t.crzE2X,
      description: null,
      status: null,
      style: null,
      CustomIcon: null,
    ...
    obj2[2] =
      accountStanding(14766).ACCOUNT_STANDING_SHORT_STATUS[
        accountStanding(undefined, 8420).AccountStandingState.VERY_LIMITED
      ];
    ...
    const obj3 = {
      title: accountStanding(1114).t.XRNVzO,
      description: null,
      status: null,
      style: null,
      CustomIcon: null,
    ...
    obj3[2] =
      accountStanding(14766).ACCOUNT_STANDING_SHORT_STATUS[
        accountStanding(undefined, 8420).AccountStandingState.AT_RISK
      ];
    ...
    const obj4 = {
      title: accountStanding(1114).t.MExFkz,
      description: null,
      status: null,
      style: null,
      CustomIcon: null,
    ...
    obj4[2] =
      accountStanding(14766).ACCOUNT_STANDING_SHORT_STATUS[
        accountStanding(undefined, 8420).AccountStandingState.SUSPENDED
      ];
