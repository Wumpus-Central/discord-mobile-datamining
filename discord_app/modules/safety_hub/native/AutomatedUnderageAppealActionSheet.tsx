...
export default function AutomatedUnderageAppealActionSheet(onClose) {
  ...
  obj6[0] = callback(onClose(5649).TableRowGroup, obj7);
  ...
  obj9[2] = callback(onClose(5315).TableRow, obj10);
  obj8[1] = callback(onClose(5649).TableRowGroup, obj9);
  ...
  obj[2] = callback(onClose(5340).BottomSheetScrollView, obj);
  return callback(onClose(5338).BottomSheet, obj);
};