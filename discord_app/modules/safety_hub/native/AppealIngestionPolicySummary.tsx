...
export default function AppealIngestionPolicySummary(classification) {
  ...
  let obj = require("../SafetyHubUtils.tsx") /* parseMessageEmbedForProps */;
  let description;
  ...
  const tmp2Result = require("../../../utils/ColorUtils.tsx") /* hexToRgba */;
  obj = { style: tmp.sectionTitle, variant: "text-sm/bold", children: null };
  const intl = tmp2(1236).intl;
  obj[2] = intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.xsdcxh);
  const items = [callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj), ];
  const hexWithOpacityResult = require("../../../utils/ColorUtils.tsx") /* hexToRgba */.hexWithOpacity(tmp.borderColor.color, 0.08);
  const items1 = [tmp.userContainer, { borderColor: hexWithOpacityResult }];
  items[1] = callback(View, { style: items1, children: callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-md/semibold", children: capitalizeTextResult }) });
  obj[1] = items;
