...
import useSafetyHubLoadingDefault from "useSafetyHubLoading" /* 14769 */;
...
export default function SafetyHubErrorActionSheet(arg0) {
  if (arg0 == null) {
    ...
    obj.style = items1;
    const obj1 = { size: "custom", color: nativeDefault.colors.CONTROL_CRITICAL_PRIMARY_BACKGROUND_DEFAULT, style: null };
