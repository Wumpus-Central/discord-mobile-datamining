...
export const SafetyHubAnalyticsActions = {
  ...
  ViewViolationsDropdown: 1,
  [1]: "ViewViolationsDropdown",
  ClickLetUsKnow: 2,
  [2]: "ClickLetUsKnow",
  ClickAgeVerificationLink: 3,
  [3]: "ClickAgeVerificationLink",
  ClickSpamWebformLink: 4,
  [4]: "ClickSpamWebformLink",
  ClickLearnMoreLink: 5,
  [5]: "ClickLearnMoreLink",
  ClickCommunityGuidelinesLink: 6,
  [6]: "ClickCommunityGuidelinesLink",
  ClickWarningSystemHelpcenterLink: 7,
  [7]: "ClickWarningSystemHelpcenterLink",
  ClickAppAppealLink: 8,
  [8]: "ClickAppAppealLink",
};
export const SafetyHubAnalyticsActionSource = {
  SystemDM: 0,
  [0]: "SystemDM",
  StandingTab: 1,
  [1]: "StandingTab",
