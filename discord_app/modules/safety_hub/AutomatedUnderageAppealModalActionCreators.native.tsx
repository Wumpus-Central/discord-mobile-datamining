// === Module 12142: AutomatedUnderageAppealModalActionCreators ===
...
const ModalActionCreatorsDefault = tmp(4960);
require = fn;
...
let closure_6 = fn(8687).AGE_VERIFICATION_GET_STARTED_MODAL_KEY;
const jsx = fn(21).jsx;
let obj = {
  open(classificationId, onClose) {
    DispatcherDefault.dispatch({ type: "SAFETY_HUB_AUTOMATED_UNDERAGE_APPEAL_MODAL_OPEN" });
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12143, dependencyMap.paths), React4, { classificationId, onClose });
  },
  openV2(classificationId, onClose) {
    ...
    if (obj2.isCurrentUserSuspended()) {
      if (tmp4Result.isExpressiveModalV2Enabled(tmp4(8688).AgeVerificationModalEntryPoint.AUTOMATED_UNDERAGE_APPEALS)) {
        const _Math = Math;
        const _Date = Date;
            ...
            try {
              ...
              if (0 === dependencyMap) {
                if (arg0 === 1) {
                  ...
                  dependencyMap = 1;
                  v3 = 1;
                  const obj6 = { value: classificationId(8711).shouldShowManualReviewFallback(classificationId(8688).AgeVerificationModalEntryPoint.AUTOMATED_UNDERAGE_APPEALS), done: false };
                  return obj6;
                }
              } else if (arg0 === 1) {
                v3 = 3;
                ...
                if (value) {
                  const result = onClose(8686).showManualReviewFallbackModal(classificationId(8688).AgeVerificationModalEntryPoint.AUTOMATED_UNDERAGE_APPEALS, closure_129_1);
                  const obj3 = onClose(8686);
                } else {
                  const obj8 = { onClose: closure_129_1 };
                  onClose(4960).pushLazy(v3(async () => {
                    ...
                    return () => closure_3_7(closure_1_0, {
                      ...
                      onComplete() {
                        ...
                        closure_2_0(12140).resetAgeCheckStatus();
                        obj = closure_2_0(12140);
