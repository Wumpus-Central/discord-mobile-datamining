...
import { AGE_VERIFICATION_GET_STARTED_MODAL_KEY as closure_6 } from "set" /* 8614 */;
...
let obj = {
  open(classificationId, onClose) {
    ...
    ACTION_SHEET_HEIGHT_HALFDefault.openLazy(asyncRequireImpl(11386, dependencyMap.paths), closure_4, obj);
  },
  openV2(arg0, onClose) {
    closure_0 = arg0;
