...
export default function CustomizeBadgesSheet(analyticsLocations) {
  ...
  closure_22 = tmp2(7746)((badge_id) => {
    ...
    if (mapped.includes(badge_id.badge_id)) {
      ...
      const result1 = tenureBadgeHideable(12722).setPendingBadgeHiddenBadges(
        ...
        if (timeSincePreviousFrame > 0) {
          ...
          if (value >= sharedValue1) {
            ...
            obj2.scrollTo(
              animatedRef,
              0,
              Math.max(first(10951)(scrollViewOffset.get() + (700 * value * value) / 1000), 0),
              false,
            );
  ...
  obj = {
    ...
    roundToNearestPixel: tmp2(10951),
  ...
  obj10[5] = memo2(tenureBadgeHideable(5632).BottomSheetScrollView, {
    ref: animatedRef,
