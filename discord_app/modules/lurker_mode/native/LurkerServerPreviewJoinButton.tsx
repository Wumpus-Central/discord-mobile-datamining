...
const memoResult = importAllResult.memo(function LurkerServerPreviewJoinButton(guildId) {
              ...
              if (closure_1_2) {
                ...
                if (type === closure_1_8.DIRECTORY_ENTRY) {
                  ...
                  if (null != channel) {
                    ...
                    const result = closure_1_0(closure_1_2[7]).setHubProgressActionComplete(
                      guildId,
                      closure_1_0(closure_1_2[8]).HubProgressStep.JOIN_GUILD,
                    );
  ...
  obj[5] = callback;
  return jsx(guildId(first[10]).Button, {
    grow: true,
    variant: "primary",
    size: "md",
    loading: first,
