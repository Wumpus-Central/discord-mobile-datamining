...
function _getUserProfileRuleHeaderText(arg0, arg1, arg2) {
  if (AutomodQuarantineUserActionMessageEmbedKeys.AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_PROFILE_UPDATE === arg1) {
    if (tmp(5235).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_UPDATE === arg0) {
      const intl6 = tmp(1236).intl;
      let stringResult = intl6.string(tmp(1236).t.t98DPb);
    } else if (tmp(5235).AutomodBlockProfileUpdateMessageEmbedKeys.NICKNAME_RESET === arg0) {
      const intl5 = tmp(1236).intl;
      stringResult = intl5.string(tmp(1236).t["7u/rlU"]);
    }
    return stringResult;
  } else if (tmp(5234).AutomodQuarantineUserActionMessageEmbedKeys.QUARANTINE_USER === arg1) {
    if (tmp(5236).AutomodQuarantineEventMessageEmbedKeys.MESSAGE_SEND === arg2) {
      const intl4 = tmp(1236).intl;
      let stringResult1 = intl4.string(tmp(1236).t.PmSMMS);
    } else if (tmp(5236).AutomodQuarantineEventMessageEmbedKeys.GUILD_JOIN === arg2) {
      const intl3 = tmp(1236).intl;
      stringResult1 = intl3.string(tmp(1236).t.m9wWzo);
    } else if (tmp(5236).AutomodQuarantineEventMessageEmbedKeys.USERNAME_UPDATE === arg2) {
      const intl2 = tmp(1236).intl;
      stringResult1 = intl2.string(tmp(1236).t.KNSkC6);
    } else if (tmp(5236).AutomodQuarantineEventMessageEmbedKeys.CLAN_TAG_UPDATE === arg2) {
      const intl7 = tmp(1236).intl;
      stringResult1 = intl7.string(tmp(1236).t.qV4K6j);
    }
    return stringResult1;
  } else if (tmp(5234).AutomodQuarantineUserActionMessageEmbedKeys.BLOCK_GUEST_JOIN === arg1) {
...
export const getActionHeaderTextMobile = function getActionHeaderTextMobile(message, author, interactionUserId) {
  ...
  APPLICATION_NAME = Xy2Iw_(5233).AutomodMessageEmbedKeys.APPLICATION_NAME;
  let embeds1 = message.embeds;
  if (embeds1 == null) {
    embeds1 = [];
  }
  ...
  if (null != tmp15) {
    ...
    if (tmp9 === Xy2Iw_(5237).AutomodInteractionCallbackTypeEmbedKeys.MODAL) {
      if (null != username2) {
        if (tmp6 !== Xy2Iw_(5238).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
...
export const getActionHeaderText = function getActionHeaderText(embeds, channel) {
  ...
  _require = _4xL9Sk(5233).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  _require = _4xL9Sk(5233).AutomodMessageEmbedKeys.APPLICATION_NAME;
...
export const getQuarantineReasonString = function getQuarantineReasonString(quarantineType) {
  ...
  } else if (tmp(5239).AutomodQuarantineUserMessageEmbedKeys.USERNAME === quarantineType) {
    const intl4 = tmp(1236).intl;
    return intl4.string(tmp(1236).t.pJQVnr);
  } else if (tmp(5239).AutomodQuarantineUserMessageEmbedKeys.GLOBAL_NAME === quarantineType) {
    const intl3 = tmp(1236).intl;
    return intl3.string(tmp(1236).t.V9eJ85);
  } else if (tmp(5239).AutomodQuarantineUserMessageEmbedKeys.CLAN_TAG === quarantineType) {
    const intl2 = tmp(1236).intl;
...
export const getRaidAlertResolveCTAText = function getRaidAlertResolveCTAText(resolvedReason) {
  ...
  } else if (tmp3(5242).RaidResolutionType.DM_SPAM === resolvedReason) {
    const intl3 = tmp3(1236).intl;
    return intl3.string(tmp3(1236).t.j5V0ij);
  } else if (tmp3(5242).RaidResolutionType.JOIN_RAID === resolvedReason) {
