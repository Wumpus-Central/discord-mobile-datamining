// === Module 7836: AutomodMessageUtils ===

// Module 7836 (AutomodMessageUtils)
import util from "util" /* 1115 */;
import useChannelName from "useChannelName" /* 4980 */;
import AutomodMessageEmbedKeys from "AutomodMessageEmbedKeys" /* 7837 */;
import AutomodQuarantineUserActionMessageEmbedKeys from "AutomodQuarantineUserActionMessageEmbedKeys" /* 7838 */;
import AutomodBlockProfileUpdateMessageEmbedKeys from "AutomodBlockProfileUpdateMessageEmbedKeys" /* 7839 */;
import AutomodQuarantineEventMessageEmbedKeys from "AutomodQuarantineEventMessageEmbedKeys" /* 7840 */;
import AutomodQuarantineUserMessageEmbedKeys from "AutomodQuarantineUserMessageEmbedKeys" /* 7843 */;
import AutomodNotificationEmbedKeys from "AutomodNotificationEmbedKeys" /* 7844 */;
import AutomodAlert from "AutomodAlert" /* 7845 */;
...
const AutomodInteractionCallbackTypeEmbedKeys = prop(7841);
const AutomodDecisionOutcomeEmbedKeys = prop(7842);
require = fn;
...
export const getActionHeaderText = function getActionHeaderText(embeds, channel, arg2) {
  ...
  let GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7837).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7837).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  GUILD_ROOM_NOTE_OUTCOME = format(7837).AutomodMessageEmbedKeys.VOICE_CHANNEL_STATUS_OUTCOME;
  ...
  if (null == tmp32) {
    if (null != null) {
      ...
      GUILD_ROOM_NOTE_OUTCOME = format(7837).AutomodMessageEmbedKeys.GUILD_ROOM_NOTE_OUTCOME;
      ...
      if (null == tmp39) {
        if (null != null) {
          ...
          if (null == tmp22) {
            if (tmp13 !== v4xL9Sk(7842).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
          ...
          if (tmp16 !== v4xL9Sk(7841).AutomodInteractionCallbackTypeEmbedKeys.MODAL) {
            if (tmp13 !== v4xL9Sk(7842).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
