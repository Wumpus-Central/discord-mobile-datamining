// === Module 7838: AutomodMessageUtils ===

// Module 7838 (AutomodMessageUtils)
import util from "util" /* 1115 */;
import useChannelName from "useChannelName" /* 4982 */;
import AutomodMessageEmbedKeys from "AutomodMessageEmbedKeys" /* 7839 */;
import AutomodQuarantineUserActionMessageEmbedKeys from "AutomodQuarantineUserActionMessageEmbedKeys" /* 7840 */;
import AutomodBlockProfileUpdateMessageEmbedKeys from "AutomodBlockProfileUpdateMessageEmbedKeys" /* 7841 */;
import AutomodQuarantineEventMessageEmbedKeys from "AutomodQuarantineEventMessageEmbedKeys" /* 7842 */;
import AutomodQuarantineUserMessageEmbedKeys from "AutomodQuarantineUserMessageEmbedKeys" /* 7845 */;
import AutomodNotificationEmbedKeys from "AutomodNotificationEmbedKeys" /* 7846 */;
import AutomodAlert from "AutomodAlert" /* 7847 */;
...
const AutomodInteractionCallbackTypeEmbedKeys = prop(7843);
const AutomodDecisionOutcomeEmbedKeys = prop(7844);
require = fn;
...
export const getActionHeaderText = function getActionHeaderText(embeds, channel, arg2) {
  ...
  let GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7839).AutomodMessageEmbedKeys.INTERACTION_CALLBACK_TYPE;
  embeds = embeds.embeds;
  if (embeds == null) {
    embeds = [];
  }
  ...
  GUILD_ROOM_NOTE_OUTCOME = v4xL9Sk(7839).AutomodMessageEmbedKeys.APPLICATION_NAME;
  ...
  GUILD_ROOM_NOTE_OUTCOME = format(7839).AutomodMessageEmbedKeys.VOICE_CHANNEL_STATUS_OUTCOME;
  ...
  if (null == tmp32) {
    if (null != null) {
      ...
      GUILD_ROOM_NOTE_OUTCOME = format(7839).AutomodMessageEmbedKeys.GUILD_ROOM_NOTE_OUTCOME;
      ...
      if (null == tmp39) {
        if (null != null) {
          ...
          if (null == tmp22) {
            if (tmp13 !== v4xL9Sk(7844).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
          ...
          if (tmp16 !== v4xL9Sk(7843).AutomodInteractionCallbackTypeEmbedKeys.MODAL) {
            if (tmp13 !== v4xL9Sk(7844).AutomodDecisionOutcomeEmbedKeys.BLOCKED) {
