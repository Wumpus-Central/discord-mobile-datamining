...
function ChatBlockedAlert(arg0) {
  ...
  obj = { source: _modDef11901, size: native.Icon.Sizes.CUSTOM, style: tmp2.mainIcon };
  const items = [
...
function PerServerProfileAlert(arg0) {
  ...
  [require, tmp8] = _slicedToArray(tmp2(11902).useOpenFixQuarantinedProfileModal({ guildId }), 2);
  if (!tmp8) {
