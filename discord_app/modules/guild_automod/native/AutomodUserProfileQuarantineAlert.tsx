...
import _modDef12123 from "../../../../_runtime/metro/12123__.js";
...
function ChatBlockedAlert(arg0) {
  ...
  const items = [
    value2(native.Icon, { source: _modDef12123, size: native.Icon.Sizes.CUSTOM, style: tmp2.mainIcon }),
...
export default function AutomodUserProfileQuarantineAlert(guildId) {
  ...
  const stateFromStores2 = tmp(563).useStateFromStores(
    items3,
    () => {
      if (null == guildId) {
        return null;
