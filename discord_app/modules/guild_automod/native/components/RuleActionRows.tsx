        ...
        RuleActionRow,
        {
          ...
          onPress() {
            if (constants.FLAG_TO_CHANNEL === actionType) {
              ...
              const intl = tmp19(closure_1_2[9]).intl;
              ...
              obj5.onSelect = function onSelect(id) {
                if (null != id) {
                  ...
                  const merged = Object.assign(
                    closure_0(closure_2_2[7]).setRuleAction(closure_0, constants.FLAG_TO_CHANNEL, obj3),
                  );
            ...
            } else if (constants.BLOCK_MESSAGE === tmp) {
              actionType = rule;
              closure_1 = onChangeRule;
              ...
              obj3.openLazy(
                actionType(closure_1_2[12])(closure_1_2[13], closure_1_2.paths),
                "AutomodBlockMessage",
                obj8,
              );
              const tmp15 = actionType(closure_1_2[12])(closure_1_2[13], closure_1_2.paths);
            } else if (constants.USER_COMMUNICATION_DISABLED === tmp) {
              actionType = rule;
              closure_1 = onChangeRule;
              ...
              obj9.onSelectDuration = function onSelectDuration(durationSeconds) {
                ...
                return closure_1(
                  closure_0(closure_2_2[7]).setRuleAction(closure_0, constants.USER_COMMUNICATION_DISABLED, obj2),
                );
              };
              obj9.onRemove = function onRemove() {
                return closure_1(
                  closure_0(closure_2_2[7]).setRuleAction(closure_0, constants.USER_COMMUNICATION_DISABLED, null),
                );
              };
              obj.openLazy(
                actionType(closure_1_2[12])(closure_1_2[11], closure_1_2.paths),
                "AutomodTimeoutDuration",
                obj9,
              );
              const tmp8 = actionType(closure_1_2[12])(closure_1_2[11], closure_1_2.paths);
            } else {
              const QUARANTINE_USER = constants.QUARANTINE_USER;
            }
          },
        },
        actionType,
