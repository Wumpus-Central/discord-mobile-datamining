...
const GuildSidebarConstants = fn(6954);
...
let obj = {
  ...
  liveChannelNotice: {
    marginTop: fn(15822).LIVE_CHANNEL_NOTICE_MARGIN_TOP,
    marginBottom: fn(15822).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM,
    marginHorizontal: 16,
  },
...
obj.gameClaimNotice = {
  marginTop: fn(15824).GAME_CLAIM_NOTICE_MARGIN_TOP,
  marginBottom: fn(15824).GAME_CLAIM_NOTICE_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
let obj3 = {
  marginTop: fn(15824).GAME_CLAIM_NOTICE_MARGIN_TOP,
...
obj.applicationAccountLinkNotice = {
  marginTop: fn(15828).ACCOUNT_LINK_BANNER_MARGIN_TOP,
  marginBottom: fn(15828).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
let obj4 = {
  marginTop: fn(15828).ACCOUNT_LINK_BANNER_MARGIN_TOP,
...
export const renderChannelListItem = function renderChannelListItem(arg0) {
  ...
  if (channel(6948).SECTION_INDEX_CHANNEL_NOTICES === section) {
    const channelNoticeSection = guildChannels.getChannelNoticeSection();
    ...
    return tmp65;
  } else if (tmp(6948).SECTION_INDEX_GUILD_ACTIONS === section) {
    const guildActionSection = guildChannels.getGuildActionSection();
