// === Module 15778: getFastListRecyclerKey ===
...
import renderDefaultEmpty from "renderDefaultEmpty" /* 7795 */;
import Divider from "Divider" /* 11862 */;
import DividerDefault from "Divider" /* 11862 */;
import CategoryChannel from "CategoryChannel" /* 15694 */;
import VOICE_USER_SUMMARY_HEIGHT from "VOICE_USER_SUMMARY_HEIGHT" /* 15719 */;
import isFavoritesSection from "isFavoritesSection" /* 15772 */;
import _modDef15784 from "module_15784" /* 15784 */;
    ...
    if (null != channelFromSectionRow) {
      ...
      if (type === type) {
        ...
        if (record.type === tmp(692).ChannelTypes.GUILD_STAGE_VOICE) {
          let participantCount = store.getParticipantCount(record.id, tmp(5368).StageChannelParticipantNamedIndex.SPEAKER);
        } else {
