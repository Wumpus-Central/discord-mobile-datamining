// === Module 15795: renderRedesignChannelListItem ===
...
import CategoryChannel from "CategoryChannel" /* 15711 */;
import ThreadChannelDefault from "ThreadChannel" /* 15719 */;
import VoiceUsers from "VoiceUsers" /* 15727 */;
import VoiceUserItem from "VoiceUserItem" /* 15729 */;
import VoiceUserSummary from "VoiceUserSummary" /* 15736 */;
import channel_list_v2_ChannelListUtils from "channel_list_v2/ChannelListUtils" /* 15789 */;
import GameClaimCoachmark from "GameClaimCoachmark" /* 15796 */;
import AccountLinkBanner from "AccountLinkBanner" /* 15800 */;
import ShowAllVoiceChannelsButtonDefault from "ShowAllVoiceChannelsButton" /* 15801 */;
import GuildProgressButton from "GuildProgressButton" /* 15803 */;
import GuildMFAWarning from "GuildMFAWarning" /* 15805 */;
import GuildPowerupsProgressBar from "GuildPowerupsProgressBar" /* 15826 */;
import VoiceChannel from "VoiceChannel" /* 15841 */;
import SectionFooterHelpers from "SectionFooterHelpers" /* 15846 */;
...
let obj = { nonChannelContainer: { marginHorizontal: 16 }, liveChannelNotice: { marginTop: fn(15794).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(15794).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 }, gameClaimNotice: null, applicationAccountLinkNotice: null, showAllVoiceChannelsButtonLastShownChannelActive: null, showAllVoiceChannelsButtonLastShownChannelInactive: null };
let obj2 = { marginTop: fn(15794).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(15794).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.gameClaimNotice = { marginTop: fn(15796).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(15796).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj3 = { marginTop: fn(15796).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(15796).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
obj.applicationAccountLinkNotice = { marginTop: fn(15800).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(15800).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj4 = { marginTop: fn(15800).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(15800).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
