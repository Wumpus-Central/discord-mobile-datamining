...
gameClaimNotice = {
  marginTop: fn(16221).LIVE_CHANNEL_NOTICE_MARGIN_TOP,
  marginBottom: fn(16221).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
gameClaimNotice.liveChannelNotice = gameClaimNotice;
gameClaimNotice = {
  marginTop: fn(16223).GAME_CLAIM_NOTICE_MARGIN_TOP,
  marginBottom: fn(16223).GAME_CLAIM_NOTICE_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
gameClaimNotice.gameClaimNotice = gameClaimNotice;
gameClaimNotice.applicationAccountLinkNotice = {
  marginTop: fn(16227).ACCOUNT_LINK_BANNER_MARGIN_TOP,
  marginBottom: fn(16227).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
let obj1 = {
  marginTop: fn(16227).ACCOUNT_LINK_BANNER_MARGIN_TOP,
  ...
  if (channel(7542).SECTION_INDEX_CHANNEL_NOTICES === section) {
    ...
    if (null != row) {
      if (constants.SPACER === row) {
        ...
        const obj2 = { guild };
        obj1.children = closure_18(selectedChannelId(16230), obj2);
        tmp65 = closure_18(View, obj1);
      } else if (constants.MFA_WARNING === row) {
        const obj3 = { style: style.nonChannelContainer, children: closure_18(selectedChannelId(16232), {}) };
        tmp65 = closure_18(View, obj3);
      } else if (constants.LIVE_CHANNEL_NOTICE === row) {
        const obj4 = { style: style.liveChannelNotice, guild };
        tmp65 = closure_18(selectedChannelId(16221), obj4);
        ...
        if (null != gameClaimMarkAsDismissed) {
          ...
          obj5.children = closure_18(selectedChannelId(16223), obj6);
        ...
        if (null != applicationAccountLinkMarkAsDismissed) {
          ...
          if (null != startApplicationAccountLinkAuthorization) {
            ...
            if (null != accountLinkApplication) {
              ...
              obj7.children = closure_18(selectedChannelId(16227), obj8);
    ...
    if (null != row1) {
      if (constants2.GUILD_ROLE_SUBSCRIPTIONS === row1) {
        ...
        obj14.children = closure_18(tmp(16243).NewMemberActionsProgress, obj15);
        const items = [closure_18(View, obj14), closure_18(selectedChannelId(12325), {})];
        obj13.children = items;
        tmp55Result = closure_19(View, obj13);
      } else if (constants2.GUILD_HUB_HEADER_OPTIONS === row1) {
        const obj16 = { guild };
        tmp55Result = closure_18(selectedChannelId(16244), obj16);
    ...
    if (null != channelFromSectionRow) {
      ...
      if (tmp(1094).ChannelTypes.GUILD_APP === type) {
        ...
        const items2 = [closure_18(selectedChannelId(16257), obj23)];
        ...
        const items3 = [closure_18(selectedChannelId(16258), obj24)];
        ...
        tmp13 = closure_18(selectedChannelId(16268), obj26);
      } else if (tmp(1094).ChannelTypes.GUILD_STAGE_VOICE === type) {
        const obj27 = { channel: record, selected: tmp5 };
        tmp13 = closure_18(selectedChannelId(16270), obj27);
      } else {
          ...
          if (tmp(1094).ChannelTypes.GROUP_DM !== type) {
            if (section === guildChannels.voiceChannelsSectionNumber) {
              if (record.isCategory()) {
                ...
                let tmp9 = closure_18(tmp(16138).CategoryChannel, obj28);
              }
              tmp13 = tmp9;
            }
            if (tmpResult.isFavoritesGuildId(guildChannels.id)) {
              if (set2.has(record.type)) {
                ...
                tmp9 = closure_18(selectedChannelId(16258), obj29);
              }
            }
            const obj30 = { channel: record, selected: tmp5 };
            tmp9 = closure_18(selectedChannelId(16257), obj30);
            tmpResult = tmp(1982);
          }
        }
        const obj31 = { channel: record, selected: tmp5 };
        tmp13 = closure_18(selectedChannelId(16272), obj31);
      }
    }
    return tmp13;
  }
