// === Module 16025: getFastListRecyclerKey ===
...
import Divider from "Divider" /* 12091 */;
import DividerDefault from "Divider" /* 12091 */;
import CategoryChannel from "CategoryChannel" /* 15941 */;
import VOICE_USER_SUMMARY_HEIGHT from "VOICE_USER_SUMMARY_HEIGHT" /* 15966 */;
import isFavoritesSection from "isFavoritesSection" /* 16019 */;
    ...
    if (null != channelFromSectionRow) {
      ...
      if (type === type) {
        ...
        if (record.type === tmp(689).ChannelTypes.GUILD_STAGE_VOICE) {
          let participantCount = store.getParticipantCount(record.id, tmp(5377).StageChannelParticipantNamedIndex.SPEAKER);
        } else {
