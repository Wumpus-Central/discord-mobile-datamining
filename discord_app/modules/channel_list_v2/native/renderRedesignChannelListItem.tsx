...
let obj = {
  ...
  liveChannelNotice: {
    marginTop: fn(16521).LIVE_CHANNEL_NOTICE_MARGIN_TOP,
    marginBottom: fn(16521).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM,
    marginHorizontal: 16,
  },
...
obj.gameClaimNotice = {
  marginTop: fn(16523).GAME_CLAIM_NOTICE_MARGIN_TOP,
  marginBottom: fn(16523).GAME_CLAIM_NOTICE_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
let obj3 = {
  marginTop: fn(16523).GAME_CLAIM_NOTICE_MARGIN_TOP,
...
obj.applicationAccountLinkNotice = {
  marginTop: fn(16527).ACCOUNT_LINK_BANNER_MARGIN_TOP,
  marginBottom: fn(16527).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
let obj4 = {
  marginTop: fn(16527).ACCOUNT_LINK_BANNER_MARGIN_TOP,
