...
import VoiceUsers from "VoiceUsers" /* 16154 */;
import VoiceUserItem from "VoiceUserItem" /* 16156 */;
...
import GameClaimCoachmark from "GameClaimCoachmark" /* 16223 */;
import AccountLinkBanner from "AccountLinkBanner" /* 16227 */;
import ShowAllVoiceChannelsButtonDefault from "ShowAllVoiceChannelsButton" /* 16228 */;
import GuildProgressButton from "GuildProgressButton" /* 16230 */;
import GuildMFAWarning from "GuildMFAWarning" /* 16232 */;
import GuildPowerupsProgressBar from "GuildPowerupsProgressBar" /* 16253 */;
import VoiceChannel from "VoiceChannel" /* 16268 */;
...
gameClaimNotice = { marginTop: fn(16221).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16221).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
gameClaimNotice.liveChannelNotice = gameClaimNotice;
gameClaimNotice = { marginTop: fn(16223).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16223).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
gameClaimNotice.gameClaimNotice = gameClaimNotice;
gameClaimNotice.applicationAccountLinkNotice = { marginTop: fn(16227).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16227).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj1 = { marginTop: fn(16227).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16227).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
