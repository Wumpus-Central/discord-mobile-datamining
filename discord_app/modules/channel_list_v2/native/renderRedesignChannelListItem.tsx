...
import VoiceUsers from "VoiceUsers" /* 16216 */;
import VoiceUserItem from "VoiceUserItem" /* 16218 */;
...
import GameClaimCoachmark from "GameClaimCoachmark" /* 16285 */;
import AccountLinkBanner from "AccountLinkBanner" /* 16289 */;
import ShowAllVoiceChannelsButtonDefault from "ShowAllVoiceChannelsButton" /* 16290 */;
import GuildProgressButton from "GuildProgressButton" /* 16292 */;
import GuildMFAWarning from "GuildMFAWarning" /* 16294 */;
import GuildPowerupsProgressBar from "GuildPowerupsProgressBar" /* 16315 */;
import VoiceChannel from "VoiceChannel" /* 16330 */;
...
gameClaimNotice = { marginTop: fn(16283).LIVE_CHANNEL_NOTICE_MARGIN_TOP, marginBottom: fn(16283).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
gameClaimNotice.liveChannelNotice = gameClaimNotice;
gameClaimNotice = { marginTop: fn(16285).GAME_CLAIM_NOTICE_MARGIN_TOP, marginBottom: fn(16285).GAME_CLAIM_NOTICE_MARGIN_BOTTOM, marginHorizontal: 16 };
gameClaimNotice.gameClaimNotice = gameClaimNotice;
gameClaimNotice.applicationAccountLinkNotice = { marginTop: fn(16289).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16289).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
let obj1 = { marginTop: fn(16289).ACCOUNT_LINK_BANNER_MARGIN_TOP, marginBottom: fn(16289).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM, marginHorizontal: 16 };
