...
gameClaimNotice = {
  marginTop: fn(16259).LIVE_CHANNEL_NOTICE_MARGIN_TOP,
  marginBottom: fn(16259).LIVE_CHANNEL_NOTICE_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
gameClaimNotice.liveChannelNotice = gameClaimNotice;
gameClaimNotice = {
  marginTop: fn(16261).GAME_CLAIM_NOTICE_MARGIN_TOP,
  marginBottom: fn(16261).GAME_CLAIM_NOTICE_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
gameClaimNotice.gameClaimNotice = gameClaimNotice;
gameClaimNotice.applicationAccountLinkNotice = {
  marginTop: fn(16265).ACCOUNT_LINK_BANNER_MARGIN_TOP,
  marginBottom: fn(16265).ACCOUNT_LINK_BANNER_MARGIN_BOTTOM,
  marginHorizontal: 16,
};
let obj1 = {
  marginTop: fn(16265).ACCOUNT_LINK_BANNER_MARGIN_TOP,
