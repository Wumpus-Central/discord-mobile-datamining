...
export default function ChannelListStickyHeader(guild) {
  ...
  items2[1] = closure_6(closure_4, {
    ...
    collapsable: false,
    style: tmp.flex,
    children: closure_6(guild(4718).Text, {
  ...
  if (flag2) {
    ...
    tmp24Result = closure_6(tmp6(7405).ChevronSmallRightIcon, obj8);
  }
  ...
  if (null != tmp10) {
    ...
    if (tmp10 > 0) {
      ...
      const items4 = [closure_6(tmp6(4718).Text, obj10), ,];
      ...
      items4[2] = closure_6(tmp6(4718).Text, obj13);
  ...
  if (isFavoritesGuildIdResult) {
    tmp24Result5 = closure_6(tmp6(16407).FavoritesGuildHeaderActionButton, {});
  }
  ...
  if (flag) {
    ...
    tmp24Result6 = closure_6(tmp2(12540), obj16);
  }
  ...
  if (tmp24Result7) {
    ...
    obj17.children = closure_6(tmp2(16412), obj18);
  ...
  if (flag3) {
    ...
    tmp24Result8 = closure_6(tmp2(16413), obj20);
  }
