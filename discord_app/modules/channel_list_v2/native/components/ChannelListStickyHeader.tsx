...
export default function ChannelListStickyHeader(guild) {
  ...
  items2[1] = closure_6(closure_4, {
    ...
    collapsable: false,
    style: tmp.flex,
    children: closure_6(guild(4635).Text, {
  ...
  if (flag2) {
    ...
    tmp24Result = closure_6(tmp6(7316).ChevronSmallRightIcon, obj8);
  }
  ...
  if (null != tmp10) {
    ...
    if (tmp10 > 0) {
      ...
      const items4 = [closure_6(tmp6(4635).Text, obj10), ,];
      ...
      items4[2] = closure_6(tmp6(4635).Text, obj13);
  ...
  if (isFavoritesGuildIdResult) {
    tmp24Result5 = closure_6(tmp6(16260).FavoritesGuildHeaderActionButton, {});
  }
  ...
  if (flag) {
    ...
    tmp24Result6 = closure_6(tmp2(12432), obj16);
  }
  ...
  if (tmp24Result7) {
    ...
    obj17.children = closure_6(tmp2(16265), obj18);
  ...
  if (flag3) {
    ...
    tmp24Result8 = closure_6(tmp2(16266), obj20);
  }
