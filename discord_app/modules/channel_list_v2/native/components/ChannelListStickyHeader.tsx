...
export default function ChannelListStickyHeader(guild) {
  ...
  if (flag2) {
    ...
    tmp24Result = closure_6(tmp6(7449).ChevronSmallRightIcon, obj8);
  }
  ...
  if (isFavoritesGuildIdResult) {
    tmp24Result5 = closure_6(tmp6(16483).FavoritesGuildHeaderActionButton, {});
  }
  ...
  if (flag) {
    ...
    tmp24Result6 = closure_6(tmp2(12549), obj16);
  }
  ...
  if (tmp24Result7) {
    ...
    obj17.children = closure_6(tmp2(16488), obj18);
  ...
  if (flag3) {
    ...
    tmp24Result8 = closure_6(tmp2(16489), obj20);
  }
