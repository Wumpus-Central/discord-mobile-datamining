...
import openFavoritesGuildActionSheetDefault from "openFavoritesGuildActionSheet" /* 16207 */;
...
export default function ChannelListStickyHeader(guild) {
  ...
  if (isFavoritesGuildIdResult) {
    ...
    tmp22 = closure_6(tmp6(10324).StarIcon, obj1);
  }
  const items2 = [tmp22, , , ];
  const tmp6Result2 = guild(4308);
  ...
  const obj2 = { ref, collapsable: false, style: tmp.flex, children: closure_6(guild(4602).Text, { experimental_useNativeText: true, color: "mobile-text-heading-primary", variant: token, lineClamp: 1, children: favoritesAwareGuildName }) };
  ...
  if (flag2) {
    ...
    tmp24Result = closure_6(tmp6(7282).ChevronSmallRightIcon, obj4);
  }
  ...
  if (null != tmp10) {
    ...
    if (tmp10 > 0) {
      ...
      const items4 = [closure_6(tmp6(4602).Text, obj6), , ];
      ...
      items4[2] = closure_6(tmp6(4602).Text, obj9);
  ...
  tmp24Result = null;
  if (isFavoritesGuildIdResult) {
    tmp24Result = closure_6(tmp6(16221).FavoritesGuildHeaderActionButton, {});
  }
  ...
  if (flag) {
    ...
    tmp24Result1 = closure_6(tmp2(12390), obj12);
  }
  ...
  if (tmp24Result2) {
    ...
    obj13.children = closure_6(tmp2(16226), obj14);
  ...
  if (flag3) {
    ...
    tmp24Result3 = closure_6(tmp2(16227), obj16);
  }
