...
const memoResult = importAllResult.memo((channel) => {
  ...
  ({ isIncomingCall, isOngoingCall } = require("../../../calls/useCallA11yState.tsx")(channel.id));
  ...
  const tmp6 = require("../../../calls/useCallA11yState.tsx")(channel.id);
  obj[5] = require("../../../channel/getChannelA11yLabel.tsx")({ channel, unread: hasUnread, mentionCount, isIncomingCall, isOngoingCall });
  obj[6] = { selected };
  obj[7] = channel;
  obj[8] = selected;
  obj[9] = hasUnread;
  ...
  return jsx(require("../../../guild_sidebar/native/ChannelItem.tsx"), { onPress: callback1, onLongPress: callback, style: tmp.container, accessible: true, accessibilityRole: "button", accessibilityLabel: null, accessibilityState: null, channel: null, selected: null, unread: null, resolvedUnreadSetting: null, mentionCount: null, muted: null });
});
