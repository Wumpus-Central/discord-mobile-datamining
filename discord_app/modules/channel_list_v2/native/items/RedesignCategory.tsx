  ...
  if (null == trailingAction) {
    ...
    if (null == note) {
      ...
      if (tmp) {
        ...
        let tmp28Result = closure_11(trailingAction(5208).PressableHighlight, obj7);
      } else {
    ...
    obj10 = closure_11(trailingAction(5208).PressableOpacity, obj10);
    obj9.children = obj10;
...
export const CategoryChannel = function CategoryChannel(channel) {
  ...
  obj7.icon = closure_11(channel(11306).ChevronSmallDownIcon, {
    size: "xxs",
...
export const RecentlyActiveCategory = function RecentlyActiveCategory(guildId) {
  ...
  obj3 = {};
  const merged1 = Object.assign(merged);
  obj3.icon = closure_11(tmp2(11306).ChevronSmallDownIcon, {
    size: "xxs",
    color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE,
