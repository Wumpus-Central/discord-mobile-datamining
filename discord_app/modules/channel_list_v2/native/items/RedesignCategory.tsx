...
function renderCategoryItem(muted) {
  ...
  if (typeof name === "string") {
    ...
    tmp34Result = closure_11(trailingAction(4570).Text, obj);
  }
  let tmp3 = null;
  if (null != icon) {
  ...
  if (null == trailingAction) {
    ...
    if (null == note) {
      ...
      if (tmp) {
        ...
        let tmp28Result = closure_11(trailingAction(5137).PressableHighlight, obj4);
      } else {
    ...
    obj7 = closure_11(trailingAction(5137).PressableOpacity, obj7);
    obj6.children = obj7;
...
export const CategoryChannel = function CategoryChannel(channel) {
  ...
  if (null != tmp10) {
    ...
    tmp13 = closure_11(tmp2(4570).Text, obj);
  }
  obj.note = tmp13;
  ...
  obj1.icon = closure_11(channel(11185).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed2 ? createStyles : obj1 });
...
export const RecentlyActiveCategory = function RecentlyActiveCategory(guildId) {
  ...
  obj = {};
  const merged1 = Object.assign(merged);
  obj.icon = closure_11(guildId(11185).ChevronSmallDownIcon, { size: "xxs", color: merged.muted ? colors.ICON_MUTED : colors.TEXT_SUBTLE, style: collapsed ? createStyles : obj1 });
