...
let closure_15 = createCacheKey.createStyles((arg0, arg1) => {
  ...
  obj = { position: "relative", marginVertical: closure_11, marginHorizontal: 8, borderRadius: Themes.modules.mobile.CHANNEL_ITEM_RADIUS, flexGrow: 1 };
  obj[0] = obj;
  obj = { backgroundColor: Themes.colors.MOBILE_CHANNEL_ITEM_BACKGROUND_SELECTED };
  obj[1] = obj;
  ...
  obj1[6] = BORDER_MUTED;
  obj1[7] = Themes.modules.mobile.CHANNEL_ITEM_RADIUS;
  obj[2] = obj1;
