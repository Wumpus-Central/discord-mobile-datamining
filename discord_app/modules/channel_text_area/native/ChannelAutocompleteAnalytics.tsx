...
export const iOSTrackAutocompleteOpen = function iOSTrackAutocompleteOpen(autocomplete_type, guild_id, arg2) {
  ...
  obj = {};
  const merged = Object.assign(require("../../app_analytics/AppAnalyticsUtils.tsx") /* collectGuildAnalyticsMetadata */.collectChannelAnalyticsMetadata(guild_id));
  const obj3 = require("../../app_analytics/AppAnalyticsUtils.tsx") /* collectGuildAnalyticsMetadata */;
  const merged1 = Object.assign(require("../../app_analytics/AppAnalyticsUtils.tsx") /* collectGuildAnalyticsMetadata */.collectGuildAnalyticsMetadata(guild_id.guild_id));
