...
export default function AppChannelApplicationActionSheet(arg0) {
  ...
  obj.children = jsx(onChange(5736).TableRadioGroup, { accessibilityLabel: null, value: null, onChange: null, hasIcons: true, children: null });
  return jsx(onChange(7270).ActionSheet, { title: null });
};
