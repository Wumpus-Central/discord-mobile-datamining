...
export default function AppChannelApplicationActionSheet(arg0) {
  ...
  obj.children = jsx(onChange(5699).TableRadioGroup, { accessibilityLabel: null, value: null, onChange: null, hasIcons: true, children: null });
  return jsx(onChange(7211).ActionSheet, { title: null });
};
