// === Module 11234: UserActivitySpotify ===
...
export const SpotifyPlayButton = function SpotifyPlayButton(activity) {
  ...
  let obj2 = { icon: closure_9(activity(5274).Button.Icon, { source: _modDef7591 }), text: null, size: "sm", onPress: null, grow: true };
  ...
  obj.children = closure_9(activity(5274).Button, obj2);
