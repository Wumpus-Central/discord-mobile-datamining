...
import { registerAsset } from "../../../../_runtime/08026_registerAsset.js";
...
prototype["render"] = function render() {
  ...
  return callback(_Button.LegacyText, obj);
};
...
export const openUrl = function openUrl(arg0, ALBUM, album_id) {
  if (arg0) {
    ...
    catchPromise = Linking.openURL(closure_7.WEB_OPEN(ALBUM, album_id, "mobile"));
    const obj = Linking;
  }
  return catchPromise;
};
...
export const SpotifyPlayButton = function SpotifyPlayButton(activity) {
  ...
  obj = { source: null };
  obj[0] = registerAsset;
  obj[0] = callback(activity(4665).Button.Icon, obj);
  ...
  obj[1] = callback(activity(4665).Button, obj);
