...
import _modDef8497 from "../../../../_runtime/metro/08497__.js";
...
export const attributeInstall = function attributeInstall() {
  ...
  value = HTTP.get({
    url: React5.INSTALL_ATTRIBUTION(ClientInfoUtilsAll.getConstants().Identifier),
...
export const SpotifyPlayButton = function SpotifyPlayButton(activity) {
  ...
  let obj2 = {
    icon: closure_9(activity(5271).Button.Icon, { source: _modDef8497 }),
    text: null,
    size: "sm",
    onPress: null,
    grow: true,
  ...
  obj.children = closure_9(activity(5271).Button, obj2);
