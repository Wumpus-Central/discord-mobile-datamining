// === Module 12005: UserActivitySpotify ===
...
export const SpotifyPlayButton = function SpotifyPlayButton(activity) {
  ...
  let obj2 = { icon: closure_9(activity(5187).Button.Icon, { source: _modDef8415 }), text: null, size: "sm", onPress: null, grow: true };
  ...
  obj.children = closure_9(activity(5187).Button, obj2);
