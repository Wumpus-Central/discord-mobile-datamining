...
import _modDef8501 from "../../../../_runtime/metro/08501__.js";
...
export const SpotifyPlayButton = function SpotifyPlayButton(activity) {
  ...
  let obj2 = {
    icon: closure_9(activity(5273).Button.Icon, { source: _modDef8501 }),
    text: null,
    size: "sm",
    onPress: null,
    grow: true,
  ...
  obj.children = closure_9(activity(5273).Button, obj2);
