// === Module 17021: useMorphablePanelGesture ===
...
import triggerIOSHapticDefault from "triggerIOSHaptic" /* 17022 */;
...
export default function useMorphablePanelGesture(mode) {
  ...
  return flag.useMemo(() => {
    ...
    const obj2 = { updateSharedValueIfChanged: updateSharedValueIfChangedDefault, initialGestureOffset: sharedValue, wrapperOffset };
    class X {
      constructor(arg0) {
        obj = closure_1_10;
        if (!closure_1_10.get().cancel) {
