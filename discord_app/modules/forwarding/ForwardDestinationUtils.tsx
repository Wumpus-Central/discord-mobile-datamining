      ...
      if (tmp) {
        if (closure_6(type.type)) {
          ...
          if (tmp5) {
            ...
            tmp11Result2 = tmp11(4942);
          }
          const items = [];
          const messageSnapshots3 = components.messageSnapshots;
          let arraySpreadResult = HermesBuiltin.arraySpread(tmp11(4944).getMessageStickers(components), 0);
