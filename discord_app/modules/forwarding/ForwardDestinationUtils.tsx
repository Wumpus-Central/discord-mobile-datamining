      ...
      if (tmp) {
        if (closure_6(type.type)) {
          ...
          if (tmp5) {
            ...
            tmp11Result2 = tmp11(4943);
          }
          const items = [];
          const messageSnapshots3 = components.messageSnapshots;
          let arraySpreadResult = HermesBuiltin.arraySpread(tmp11(4945).getMessageStickers(components), 0);
