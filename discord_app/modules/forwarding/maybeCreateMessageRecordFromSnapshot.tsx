...
export default function maybeCreateMessageRecordFromSnapshot(merge, arg1) {
  ...
  if (null != tmp) {
    const obj = {
      content: tmp.message.content,
      attachments: tmp.message.attachments,
      embeds: tmp.message.embeds,
      flags: tmp.message.flags,
      components: tmp.message.components,
      editedTimestamp: null,
      timestamp: tmp.message.timestamp,
      codedLinks: tmp.message.codedLinks,
      reactions: [],
      messageSnapshots: [],
      stickers: tmp.message.stickers,
      stickerItems: tmp.message.stickerItems,
