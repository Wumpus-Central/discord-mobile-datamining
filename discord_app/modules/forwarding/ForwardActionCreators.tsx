        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (prop) {
                let guild_id = outer1_0(7225).GAME_CONTENT_GUILD_ID;
              ...
              if (null == channel) {
                ...
                const parsed = outer1_1(7063).parse(channel, "");
                ...
                let num9 = 0;
                if (null != withMessage) {
                  const tmp39 = v0(outer1_1(7064)(withMessage), 2);
                  num9 = 0;
                  if (tmp39[0]) {
