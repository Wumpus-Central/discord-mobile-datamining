...
let obj = {
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              if (prop) {
                let guild_id = outer1_0(7212).GAME_CONTENT_GUILD_ID;
              ...
              if (null == channel) {
                ...
                const parsed = outer1_1(7050).parse(channel, "");
                ...
                let num9 = 0;
                if (null != withMessage) {
                  const tmp39 = v0(outer1_1(7051)(withMessage), 2);
                  num9 = 0;
                  if (tmp39[0]) {
  ...
  sendForwards(outer1_8, c1, arg2) {
    ...
    return importDefault(4494)(c1.map((alsoForwardToChannelId) => outer1_9.sendForward(closure_0, alsoForwardToChannelId, closure_1)));
  }
};
