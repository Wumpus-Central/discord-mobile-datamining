...
export default function ForwardModal(message) {
  ...
  const callback2 = obj.useCallback(() => {
    ForwardingAnalyticsUtils.trackForwardCancel({
      channelId: channel_id,
      messageId: id,
      numDestinationChanges: ref.current,
      numQueryChanges: ref2.current,
    });
    const obj2 = {
      channelId: channel_id,
      messageId: id,
          ...
          if (arg0 === 1) {
            ...
            if (null == c3) {
              if (null != message) {
                ...
                c4 = 1;
                const obj6 = {
                  value: Promise.all(first1.map(closure_0(source[16]).getOrResolveChannelIdFromDestinationId)),
                  done: false,
                };
                return obj6;
              } else {
            ...
            if (2 === tmp6) {
              if (arg0 === 1) {
                ...
                if (forwardOptions(source[25])(message, closure_129_1)) {
                  const promise = new Promise((arg0) => {
                    closure_0 = arg0;
                    closure_1_0(5198).openAlert(
                      "staff-to-non-staff-forward",
                      closure_1_15(forwardOptions(11169), {
                        onConfirm() {
              ...
              if (3 === tmp6) {
                ...
                if (arg0 === 1) {
                  ...
                  closure_0(source[29]).transitionToChannel(closure_129_1[0], {
  ...
  let obj5 = { style: memo1, children: null };
  ...
  const items14 = [
    first(forwardOptions(source[41]), { absolute: true }),
    first(forwardOptions(source[42]), {
      ...
      disableSelection: first1.length >= ref,
    }),
  ];
  if (null != stateFromStores) {
    let obj10 = {
