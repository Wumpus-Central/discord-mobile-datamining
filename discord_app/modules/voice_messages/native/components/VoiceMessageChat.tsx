...
function Duration(animationValue) {
  ...
  importDefault = tmp2;
  const tmp3 = _slicedToArray(first1.useState(() => {
    let num = 0;
    if (null != closure_1) {
      const _Date = Date;
      num = Date.now() - tmp;
...
let obj1 = { backgroundColor: nativeDefault.colors.MOBILE_VOICE_MESSAGE_RECORDING_WAVEFORM_BAR_BACKGROUND, borderRadius: 1 };
size = fn(2);
