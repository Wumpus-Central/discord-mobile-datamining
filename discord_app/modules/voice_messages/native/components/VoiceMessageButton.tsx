...
export default noop.memo((disabled) => {
        ...
        if (0 === c3) {
          ...
          if (closure_129_0) {
            ...
            const result1 = obj1.emitVoiceMessageRecorded(
              closure_0(11967).VoiceMessageRecordingResult.CANCELLED_DURATION,
              data.durationSecs,
              startTimeMillis,
            );
            __initData();
            ...
            const result2 = closure_0(12349).emitVoiceMessageRecorded(
              closure_0(11967).VoiceMessageRecordingResult.SENT,
              data.durationSecs,
              startTimeMillis,
            );
        ...
        try {
          ...
          if (0 === c2) {
            ...
            const result = obj.emitVoiceMessageRecorded(
              cancel(11967).VoiceMessageRecordingResult.CANCELLED_GESTURE_CONFLICT,
  ...
  obj1 = {
    ref: sharedValue1(12351)().tooltipTargetRef,
    IconComponent: null,
    active: false,
  ...
  obj.children = jsx(sharedValue1(12332), {
    ref: sharedValue1(12351)().tooltipTargetRef,
    IconComponent: null,
    active: false,
    accessibilityLabel: null,
