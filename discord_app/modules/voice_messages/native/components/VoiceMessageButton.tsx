...
export default noop.memo((disabled) => {
  ...
  _require = sharedValue(function* (arg0) {
    ...
    if (data.durationSecs < closure_2_20 / 1000) {
      const result1 = closure_0(12286).emitVoiceMessageRecorded(
        closure_0(11904).VoiceMessageRecordingResult.CANCELLED_DURATION,
        data.durationSecs,
        startTimeMillis,
      );
      __initData();
    }
    const result2 = closure_0(12286).emitVoiceMessageRecorded(
      closure_0(11904).VoiceMessageRecordingResult.SENT,
      data.durationSecs,
      startTimeMillis,
    );
        ...
        try {
          ...
          if (0 === c2) {
            ...
            const result = obj.emitVoiceMessageRecorded(
              cancel(11904).VoiceMessageRecordingResult.CANCELLED_GESTURE_CONFLICT,
  ...
  obj1 = {
    ref: sharedValue1(12288)().tooltipTargetRef,
    IconComponent: null,
    active: false,
  ...
  obj.children = jsx(sharedValue1(12269), {
    ref: sharedValue1(12288)().tooltipTargetRef,
    IconComponent: null,
    active: false,
    accessibilityLabel: null,
