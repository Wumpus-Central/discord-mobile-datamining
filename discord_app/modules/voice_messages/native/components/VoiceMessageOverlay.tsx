...
let closure_21 = require("Button").memoize(() => require("../../../reanimated/ReanimatedRexport.tsx").createAnimatedComponent(require("../../../../../_runtime/08437_inlineStyles.js") /* inlineStyles */.Ellipse));
let c22 = 68;
let c23 = 56;
let closure_24 = createCacheKey.createStyles((width) => {
  ...
  obj.overflow = "hidden";
  obj[0] = obj;
  obj = { flexDirection: "row", alignItems: "flex-end", paddingTop: 8, paddingHorizontal: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_CONTAINER_PADDING_HORIZONTAL, paddingBottom: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_CONTAINER_PADDING_BOTTOM };
  obj[1] = obj;
  ...
  obj[4] = { width, height: width, borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.button.BORDER_RADIUS, alignItems: "center", justifyContent: "center" };
  const obj1 = { width, height: width, borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.button.BORDER_RADIUS, alignItems: "center", justifyContent: "center" };
  obj[5] = { width, height: width, borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.button.BORDER_RADIUS, alignItems: "center", justifyContent: "center" };
  const obj2 = { width, height: width, borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.button.BORDER_RADIUS, alignItems: "center", justifyContent: "center" };
  obj[6] = { width: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.CHAT_INPUT_SEND_BUTTON_WIDTH, height: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.CHAT_INPUT_SEND_BUTTON_HEIGHT };
  const obj3 = { width: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.CHAT_INPUT_SEND_BUTTON_WIDTH, height: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.CHAT_INPUT_SEND_BUTTON_HEIGHT };
  obj[7] = { backgroundColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.CHAT_INPUT_SEND_BUTTON_ACTIVE_BACKGROUND };
  const obj4 = { backgroundColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.CHAT_INPUT_SEND_BUTTON_ACTIVE_BACKGROUND };
  obj[8] = { tintColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.CHAT_INPUT_SEND_BUTTON_ICON_ACTIVE_TINT };
  const obj5 = { tintColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.CHAT_INPUT_SEND_BUTTON_ICON_ACTIVE_TINT };
  obj[9] = { flex: 1, height: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_CHAT_CONTAINER_HEIGHT, marginRight: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_CHAT_CONTAINER_MARGIN_RIGHT, alignItems: "flex-end" };
  const obj6 = { flex: 1, height: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_CHAT_CONTAINER_HEIGHT, marginRight: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_CHAT_CONTAINER_MARGIN_RIGHT, alignItems: "flex-end" };
  obj[10] = { height: c22, width: c23, borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.button.BORDER_RADIUS, display: "flex", alignItems: "center", flexDirection: "column", elevation: 12, shadowColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.BLACK, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.12, shadowRadius: 36, borderWidth: require("../../../../design/migrations/native/LegacyTokens.tsx") /* result */.DARK_0_LIGHT_1, borderStyle: "solid", borderColor: "rgba(0, 0, 0, 0.08)" };
  const obj7 = { height: c22, width: c23, borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.button.BORDER_RADIUS, display: "flex", alignItems: "center", flexDirection: "column", elevation: 12, shadowColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.BLACK, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.12, shadowRadius: 36, borderWidth: require("../../../../design/migrations/native/LegacyTokens.tsx") /* result */.DARK_0_LIGHT_1, borderStyle: "solid", borderColor: "rgba(0, 0, 0, 0.08)" };
  obj[11] = { position: "absolute", right: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_LOCK_PILL_OFFSET_RIGHT, width: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_LOCK_PILL_WIDTH };
  const obj8 = { position: "absolute", right: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_LOCK_PILL_OFFSET_RIGHT, width: require("../../../../../discord_common/js/packages/tokens/native.tsx").modules.mobile.VOICE_MESSAGE_RECORDING_LOCK_PILL_WIDTH };
  obj[12] = { height: 16, width: 16, marginTop: 8, tintColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.ICON_SUBTLE };
  return obj;
});
