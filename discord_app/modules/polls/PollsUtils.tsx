...
function formatVoterTooltipText(arr, arg1) {
  ...
  if (1 === arr.length) {
    if (bound > 0) {
      ...
      obj[0] = first;
      obj[1] = bound;
      let formatToPlainStringResult = intl6.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["SV/iZn"], obj);
    } else {
    ...
    if (bound > 0) {
      ...
      [obj5[0], obj5[1]] = first;
      obj[2] = bound;
      let formatToPlainStringResult1 = intl5.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.YBnZK0, obj);
    } else {
      const intl4 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
      [obj4[0], obj4[1]] = first;
      formatToPlainStringResult1 = intl4.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["O5+f5c"], { a: null, b: null });
    ...
    if (bound > 0) {
      ...
      obj2[3] = bound;
      let formatToPlainStringResult2 = intl3.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["ThXp+N"], obj2);
    } else {
      const intl2 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
      const obj3 = { a: null, b: null, c: null };
      [obj2[0], obj2[1], obj2[2]] = first;
      formatToPlainStringResult2 = intl2.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["0UzBM3"], obj3);
    }
  } else {
    const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    obj = { n: null };
    obj[0] = bound;
    return intl.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.yVX6kE, obj);
  }
}
...
export const generateEmptyPollAnswer = function generateEmptyPollAnswer() {
  ...
  obj[2] = require("../../../_runtime/00514_v1.js") /* v1 */.v4();
  return obj;
};
...
export const createPollExpiryTimestamp = function createPollExpiryTimestamp(arg0) {
  ...
  return new Date(timestamp + arg0 * require("../../utils/Durations.tsx").Millis.HOUR).toISOString();
};
export const createPollServerDataFromCreateRequest = function createPollServerDataFromCreateRequest(poll) {
  if (null != poll) {
    ...
    if (null != duration) {
      ...
      const _Date2 = Date;
      const timestamp = Date.now();
      const date = new Date(timestamp + poll.duration * require("../../utils/Durations.tsx").Millis.HOUR);
...
export const getPollResultsReplyPreview = function getPollResultsReplyPreview(message) {
  let obj = require("../messages/useMessageAuthor.tsx") /* useNullableMessageAuthor */;
  ...
  return intl.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t.Vn97Ka, obj);
};
export const getPollResultsReplyPreviewMobile = function getPollResultsReplyPreviewMobile(message2) {
  if ("author" in message2) {
    ...
    return intl.formatToParts(require("../../intl/index.native.tsx") /* getSystemLocale */.t.Vn97Ka, obj);
  } else {
    return null;
  }
};
...
export const formatPollResultNotificationCenterText = function formatPollResultNotificationCenterText(totalVotes) {
  ...
  if (0 === totalVotes) {
    ...
    obj[0] = questionText;
    let formatToPlainStringResult = intl3.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["8anM0l"], obj);
    ...
    obj[2] = "" + num + "%";
    formatToPlainStringResult = intl2.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["8yEgvE"], obj);
  } else {
    const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    ...
    obj[1] = "" + num + "%";
    formatToPlainStringResult = intl.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.XVk6Zv, obj);
  }
