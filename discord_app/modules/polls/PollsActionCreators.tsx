...
function getPollVoteEventProperties(answers, set) {
  ...
  return {
    analyticsSelectedAnswerIds: items,
    selectedTextAnswersCount: importDefault,
    selectedEmojiAnswersCount: importAll,
  };
}
      ...
      if (0 === c4) {
        ...
        if (1 === tmp5) {
          if (arg0 === 1) {
            ...
            const obj2 = { channelId: closure_130_0, messageId: closure_130_1 };
            closure_130_3 = closure_131_21(obj2);
            ...
            let messageId = 0;
            const items = [];
            messageId = HermesBuiltin.arraySpread(
              closure_130_4.map((id) => ({ type: "MESSAGE_REACTION_REMOVE", id })),
              messageId,
            );
            messageId = HermesBuiltin.arraySpread(
              closure_130_5.map((id) => ({ type: "MESSAGE_REACTION_ADD", id })),
              messageId,
            );
            closure_130_7 = items;
            ...
            closure_130_8 = Emitter.batched(() => {
              ...
              for (const item10006 of closure_1_7) {
                ...
                obj.emoji = obj;
                obj.userId = userId;
                obj.reactionType = channelId(7835).ReactionTypes.VOTE;
            ...
            if (null != closure_130_8) {
              c4 = 2;
              c5 = 1;
              const obj3 = { value: closure_130_8, done: false };
              return obj3;
            }
...
let closure_25 = async function _handlePollSubmitVote(arg0) {
  ...
  if (1 === tmp7) {
    if (arg0 === 1) {
      ...
      if (null != channel) {
        if (closure_133_5.isLurking(channel.guild_id)) {
          ...
          c9 = 1;
          return {
            value: closure_133_22({ channelId: closure_132_0, messageId: closure_132_1, answerIds: closure_132_5 }),
            done: false,
          };
        } else {
    ...
    c9 = 1;
    return {
      value: closure_133_22({ channelId: closure_132_0, messageId: closure_132_1, answerIds: closure_132_4 }),
      done: false,
    };
  } else if (3 === tmp7) {
    if (arg0 === 1) {
      ...
      c9 = 1;
      return {
        value: obj2.submitPollVote({ channelId: closure_132_0, messageId: closure_132_1, answerIds: closure_132_5 }),
        done: false,
      };
    }
  } else if (4 === tmp7) {
...
let closure_28 = async function _createPoll(arg0) {
  closure_2 = tmp3;
  ({
    channel: closure_129_0,
    question: closure_129_1,
    answers: closure_129_2,
    allowMultiSelect: closure_129_3,
    duration: closure_129_4,
    layout: closure_129_5,
  ...
  closure_129_10 = {
    question: { text: closure_129_1.trim() },
    answers: closure_129_9,
    allow_multiselect: closure_129_3,
    duration: closure_129_4,
    layout_type: closure_129_5,
  };
    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (arg0 === 1) {
          ...
          c3 = 2;
          c4 = 1;
          const obj3 = { value: closure_130_1(closure_130_3[12]).confirm(obj2), done: false };
          return obj3;
        }
      } else {
        if (2 === tmp5) {
          if (arg0 === 1) {
            ...
            obj1 = closure_130_2(closure_130_3[22]);
            const obj5 = { channelId: closure_129_0, messageId: closure_129_1 };
            c3 = 3;
            c4 = 1;
            const obj6 = { value: obj1.endPollEarly(obj5), done: false };
            return obj6;
          }
        } else if (arg0 === 1) {
          c4 = 3;
    ...
    if (true !== basicPollChatData.tapShouldOpenVotersModal) {
      ...
      closure_14(channelId2, messageId2, (arg0) => {
        if (null == arg0) {
          ...
          ({
            analyticsSelectedAnswerIds: analyticsSelectedAnswerIds2,
            selectedTextAnswersCount: selectedTextAnswersCount2,
            selectedEmojiAnswersCount: selectedEmojiAnswersCount2,
          } = getPollVoteEventProperties(answers, set));
          let obj2 = AppAnalyticsUtilsDefault;
          let obj = {
            channel_id: channelId2,
            message_id: messageId2,
            selected_answer_ids: analyticsSelectedAnswerIds2,
            selected_text_answers_count: selectedTextAnswersCount2,
            selected_emoji_answers_count: selectedEmojiAnswersCount2,
          };
          ...
          ({ analyticsSelectedAnswerIds, selectedTextAnswersCount, selectedEmojiAnswersCount } =
            getPollVoteEventProperties(answers1, set1));
          obj = AppAnalyticsUtilsDefault;
          obj2 = {
            channel_id: channelId2,
            message_id: messageId2,
            selected_answer_ids: analyticsSelectedAnswerIds,
            selected_text_answers_count: selectedTextAnswersCount,
            selected_emoji_answers_count: selectedEmojiAnswersCount,
          };
