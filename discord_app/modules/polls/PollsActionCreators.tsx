// === Module 11297: getPollVoteEventProperties ===

// Module 11297 (getPollVoteEventProperties)
import setDefault from "set" /* 4857 */;
import showVotesForAnswerAll from "showVotesForAnswer" /* 11298 */;
...
import closure_10 from "recomputeGuild" /* 5357 */;
import closure_11 from "reinjectEphemerals" /* 4735 */;
import closure_12 from "map" /* 4853 */;
import useMessagePollInteractions from "useMessagePollInteractions" /* 8128 */;
              ...
              if (arg0 === 1) {
                ...
                closure_8 = Emitter.batched(() => {
                  ...
                  for (const item10006 of items) {
                    ...
                    obj[4] = closure_6;
                    let tmp7 = _undefined;
                    obj[6] = _undefined(7507).ReactionTypes.VOTE;
    ...
    const iter = (function*(arg0) {
      ...
      if (1 === tmp7) {
        if (arg0 === 1) {
          ...
          let message = channel.getChannel(callback);
...
function _createPoll() {
  ...
  const tmp = callback((arg0) => {
    ...
    const iter = (function*(arg0) {
      ...
      yield "PX_16";
      const uploads2 = uploads.getUploads(lib.id, Poll.Poll);
      Poll = c2.map((text) => {
        closure_0 = text;
      ...
      yield lib2(7201).sendPollMessage(lib.id, obj2, obj4);
      if (2 === tmp7) {
        c4 = 0;
