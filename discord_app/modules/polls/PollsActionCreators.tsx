    ...
    if (arg0 === 1) {
      ...
      closure_130_8 = Emitter.batched(() => {
        ...
        for (const item10006 of closure_1_7) {
          ...
          obj2.emoji = obj3;
          obj2.userId = userId;
          obj2.reactionType = channelId(8090).ReactionTypes.VOTE;
          ...
          if (arg0 === 1) {
            ...
            if (null != channel) {
              if (closure_133_5.isLurking(channel.guild_id)) {
                ...
                closure_133_1(closure_133_3[11])(
                  null != closure_132_3,
                  "Must not be able to vote without existing state!",
                );
            ...
            if ("showVotes" === tmp39) {
              ...
              (function handleShowVotes(channelId) {
                ...
                closure_14(channelId, messageId, (showResults) => {
                  ...
                  closure_2_1(dependencyMap[17]).trackWithMetadata(constants.POLL_SHOW_RESULTS_CLICKED, {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          closure_129_9 = closure_129_2.map((text) => {
            ...
            if (closure_1_5 === guildId(12054).PollLayoutTypes.DEFAULT) {
              let trimmed;
              if (text.text != null) {
                trimmed = str2.trim();
              }
          ...
          c6 = 1;
          const obj8 = {
            value: closure_130_1(closure_130_3[25]).sendPollMessage(closure_129_0.id, closure_129_10, obj7),
            done: false,
          };
          return obj8;
        }
...
let closure_29 = async function _endPollEarly(arg0) {
  ...
  if (2 === tmp5) {
    if (arg0 === 1) {
      ...
      c4 = 1;
      return {
        value: closure_130_2(closure_130_3[22]).endPollEarly({ channelId: closure_129_0, messageId: closure_129_1 }),
        done: false,
      };
    }
  } else if (arg0 === 1) {
...
const PollsInteractionStore = fn(11770);
