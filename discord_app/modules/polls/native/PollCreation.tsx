...
import _modDef11681 from "../../../../_runtime/metro/11681__.js";
...
function AddAnswerButton(onPress) {
  ...
  const items = [
    React7(native.Icon, { source: _modDef11681, size: native.Icon.Sizes.LARGE, color: tmp.addAnswerIcon.color }),
  ];
...
function PollDurationSelectionRow(selectedDuration) {
  ...
  obj.onPress = function onPress() {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11683, dependencyMap.paths), React6, {
      selectedDuration,
      onChange,
    });
  };
  obj.trailing = closure_9(selectedDuration(4832).Text, {
