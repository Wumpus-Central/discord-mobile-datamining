...
import _modDef12532 from "../../../../_runtime/metro/12532__.js";
...
function AddAnswerButton(onPress) {
  ...
  const items = [
    React7(native.Icon, { source: _modDef12532, size: native.Icon.Sizes.LARGE, color: tmp.addAnswerIcon.color }),
  ];
...
function PollDurationSelectionRow(selectedDuration) {
  ...
  obj.onPress = function onPress() {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12534, dependencyMap.paths), React6, {
      selectedDuration,
      onChange,
    });
  };
  obj.trailing = closure_9(selectedDuration(4823).Text, {
