...
import _modDef12441 from "../../../../_runtime/metro/12441__.js";
...
function AddAnswerButton(onPress) {
  ...
  const items = [
    React7(native.Icon, { source: _modDef12441, size: native.Icon.Sizes.LARGE, color: tmp.addAnswerIcon.color }),
  ];
...
function PollDurationSelectionRow(selectedDuration) {
  ...
  obj.onPress = function onPress() {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12443, dependencyMap.paths), React6, {
      selectedDuration,
      onChange,
    });
  };
  obj.trailing = closure_9(selectedDuration(4718).Text, {
