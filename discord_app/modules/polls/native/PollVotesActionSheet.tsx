...
function PollVotesHeader(message) {
  ...
  if (null != message.poll) {
    ...
    const obj3 = { ref, style: null, contentContainerStyle: null, horizontal: true, showsHorizontalScrollIndicator: false, accessibilityRole: "tablist", accessibilityLabel: null, children: null };
...
function VotersList(channelId) {
  ...
  obj = { style: animatedStyle, children: closure_14(channelId(analyticsLocations[33]).BottomSheetFlashList, { contentContainerStyle: tmp.list, data: reactors, renderItem: callback, onScroll: reactorsOnScrollNative }) };
...
function NoResults() {
  ...
  if (obj3.isThemeDark(tmp4)) {
    let tmp2Result = _modDef11795;
  } else {
    tmp2Result = _modDef11796;
  }
