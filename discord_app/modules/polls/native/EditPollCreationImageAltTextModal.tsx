...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const obj1 = { onPress: onSave(12232).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
