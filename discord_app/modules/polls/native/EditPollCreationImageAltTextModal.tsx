...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const obj1 = { onPress: onSave(12321).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
  const intl = onSave(1114).intl;
  obj1.accessibilityLabel = intl.string(onSave(1114).t.cpT0Cq);
  obj1.children = closure_8(onSave(1178).Icon, { source: value(7065) });
  ...
  items1[1] = closure_8(onSave(4602).Text, obj3);
  ...
  obj4.children = closure_8(onSave(4602).Text, obj5);
  ...
  items4[2] = closure_8(onSave(8684).FormInput, obj11);
  ...
  obj.children = items2;
  return closure_9(onSave(7196).SafeAreaPaddingView, obj);
};