// === Module 12486: EditPollCreationImageAltTextModal ===
...
const MAX_POLL_ANSWER_LENGTH = fn(8074).MAX_POLL_ANSWER_LENGTH;
const jsxProd = fn(21);
...
export default function EditPollCreationImageAltTextModal(imageSize) {
  ...
  const tmp4 = value(12483)(channelId, answer.localCreationAnswerId, answer.image, imageSize, imageSize);
  ...
  const obj4 = { onPress: onSave(12485).closeEditPollCreationImageAltTextModal, activeOpacity: 0.5, accessibilityRole: "button", accessibilityLabel: null, children: null };
  const intl = onSave(1115).intl;
  obj4.accessibilityLabel = intl.string(onSave(1115).t.cpT0Cq);
  obj4.children = closure_8(onSave(1177).Icon, { source: value(7239) });
  ...
  items1[1] = closure_8(onSave(4753).Text, obj6);
  ...
  obj7.children = closure_8(onSave(4753).Text, obj8);
  ...
  return closure_9(onSave(7370).SafeAreaPaddingView, obj2);
};