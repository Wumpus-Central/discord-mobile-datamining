...
function PollDurationRadioGroup(onChange) {
  ...
  return jsx(onChange(5988).TableRadioGroup, { title: null, hasIcons: false, onChange: null, defaultValue: null, children: null });
}
const jsx = fn(21).jsx;
const size = fn(2);
