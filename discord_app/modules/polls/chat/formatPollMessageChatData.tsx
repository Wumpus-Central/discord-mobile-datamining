...
function computeBasicPollChatData(message, arg1, arg2) {
  obj = arg2;
  if (arg2 === undefined) {
    obj = {};
  }
...
const getPollState = fn(11694).getPollState;
      ...
      if (null != tmp9) {
        ...
        const mapped = answers.map((answer_id) => {
          ...
          if (null == name) {
            ...
            const match1 = _mod4942.match(layout_type);
            obj2.votes = match1
        ...
        obj9.answersInteraction = match3
          .with({ tapShouldOpenVotersModal: true }, () => flag(layout_type[21]).PollChatAnswerInteractionType.LIST)
          .with({ canTapAnswers: false }, () => flag(layout_type[21]).PollChatAnswerInteractionType.LIST)
          .with(
            { canSelectMultipleAnswers: false },
