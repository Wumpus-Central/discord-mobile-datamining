...
let closure_6 = {
  [fn(11089).StorefrontPlatform.DESKTOP]: "PC",
  [fn(11089).StorefrontPlatform.XBOX]: "Xbox",
  [fn(11089).StorefrontPlatform.PLAYSTATION]: "PlayStation",
  [fn(11089).StorefrontPlatform.SWITCH]: "Switch",
  [fn(11089).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade",
  [fn(11089).StorefrontPlatform.NETFLIX]: "Netflix",
  [fn(11089).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+",
};
