...
let closure_6 = {
  [fn(10891).StorefrontPlatform.DESKTOP]: "PC",
  [fn(10891).StorefrontPlatform.XBOX]: "Xbox",
  [fn(10891).StorefrontPlatform.PLAYSTATION]: "PlayStation",
  [fn(10891).StorefrontPlatform.SWITCH]: "Switch",
  [fn(10891).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade",
  [fn(10891).StorefrontPlatform.NETFLIX]: "Netflix",
  [fn(10891).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+",
};
