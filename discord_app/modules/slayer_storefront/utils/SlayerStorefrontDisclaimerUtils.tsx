...
let closure_6 = {
  [fn(11083).StorefrontPlatform.DESKTOP]: "PC",
  [fn(11083).StorefrontPlatform.XBOX]: "Xbox",
  [fn(11083).StorefrontPlatform.PLAYSTATION]: "PlayStation",
  [fn(11083).StorefrontPlatform.SWITCH]: "Switch",
  [fn(11083).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade",
  [fn(11083).StorefrontPlatform.NETFLIX]: "Netflix",
  [fn(11083).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+",
};
