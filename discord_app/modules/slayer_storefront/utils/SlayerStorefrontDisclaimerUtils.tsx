...
let closure_6 = {
  [fn(11165).StorefrontPlatform.DESKTOP]: "PC",
  [fn(11165).StorefrontPlatform.XBOX]: "Xbox",
  [fn(11165).StorefrontPlatform.PLAYSTATION]: "PlayStation",
  [fn(11165).StorefrontPlatform.SWITCH]: "Switch",
  [fn(11165).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade",
  [fn(11165).StorefrontPlatform.NETFLIX]: "Netflix",
  [fn(11165).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+",
};
