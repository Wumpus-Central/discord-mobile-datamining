...
let closure_6 = {
  [fn(10954).StorefrontPlatform.DESKTOP]: "PC",
  [fn(10954).StorefrontPlatform.XBOX]: "Xbox",
  [fn(10954).StorefrontPlatform.PLAYSTATION]: "PlayStation",
  [fn(10954).StorefrontPlatform.SWITCH]: "Switch",
  [fn(10954).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade",
  [fn(10954).StorefrontPlatform.NETFLIX]: "Netflix",
  [fn(10954).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+",
};
