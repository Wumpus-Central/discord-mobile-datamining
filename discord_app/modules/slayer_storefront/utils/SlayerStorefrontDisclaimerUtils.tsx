...
let closure_6 = {
  [fn(10950).StorefrontPlatform.DESKTOP]: "PC",
  [fn(10950).StorefrontPlatform.XBOX]: "Xbox",
  [fn(10950).StorefrontPlatform.PLAYSTATION]: "PlayStation",
  [fn(10950).StorefrontPlatform.SWITCH]: "Switch",
  [fn(10950).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade",
  [fn(10950).StorefrontPlatform.NETFLIX]: "Netflix",
  [fn(10950).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+",
};
