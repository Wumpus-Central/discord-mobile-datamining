...
let closure_6 = {
  [fn(10967).StorefrontPlatform.DESKTOP]: "PC",
  [fn(10967).StorefrontPlatform.XBOX]: "Xbox",
  [fn(10967).StorefrontPlatform.PLAYSTATION]: "PlayStation",
  [fn(10967).StorefrontPlatform.SWITCH]: "Switch",
  [fn(10967).StorefrontPlatform.APPLE_ARCADE]: "Apple Arcade",
  [fn(10967).StorefrontPlatform.NETFLIX]: "Netflix",
  [fn(10967).StorefrontPlatform.AMAZON_KIDS_PLUS]: "Amazon Kids+",
};
