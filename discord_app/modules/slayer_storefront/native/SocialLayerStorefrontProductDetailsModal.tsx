...
function SocialLayerStorefrontProductDetailsModal(skuId) {
  ...
  if (tmp30) {
    ...
    tmp43Result = closure_14(tmp2(11148), obj6, skuId);
  ...
  if (null == stateFromStores) {
    ...
    if (!result) {
      ...
      tmp65Result = closure_14(tmp4(4823).Text, obj18);
    }
    ...
    if (result1) {
      ...
      obj22.onPress = tmp48;
      result1 = closure_14(tmp4(8265).IconButton, obj22);
    }
    items14[1] = result1;
    ...
    if (result) {
      ...
      const mobileFinePrintMessageForApplication = tmp4(11164).getMobileFinePrintMessageForApplication(
    ...
    if (exclusive) {
      ...
      exclusive = closure_14(tmp2(5283), obj31);
    }
...
obj.hero = {
  ...
  height: fn(11145).MOBILE_HERO_HEIGHT_PX,
