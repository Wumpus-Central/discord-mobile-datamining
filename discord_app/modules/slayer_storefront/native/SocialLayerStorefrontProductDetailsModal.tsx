...
function SocialLayerStorefrontProductDetailsModal(skuId) {
  ...
  trackPDPClick = stateFromStores.useCallback((cta_type) => {
    const obj2 = {
      ...
      guild_id: true,
      application_id: true,
      cta_type: "RTCConnection",
      location_stack: "media_engine_connect",
    };
    let applicationId;
    if (stateFromStores != null) {
      applicationId = stateFromStores.applicationId;
  ...
  if (tmp30) {
    ...
    tmp43Result = closure_14(tmp2(10269), obj6, skuId);
  ...
  if (null == stateFromStores) {
    ...
    if (!result) {
      ...
      tmp65Result = closure_14(tmp4(4832).Text, obj18);
    }
    ...
    if (result1) {
      ...
      obj22.onPress = tmp48;
      result1 = closure_14(tmp4(7363).IconButton, obj22);
    }
    items14[1] = result1;
    ...
    if (result) {
      ...
      const mobileFinePrintMessageForApplication = tmp4(10280).getMobileFinePrintMessageForApplication(
    ...
    if (exclusive) {
      ...
      exclusive = closure_14(tmp2(5293), obj31);
    }
