...
function SocialLayerStorefrontProductDetailsModal(skuId) {
  ...
  trackPDPClick = stateFromStores.useCallback((cta_type) => {
    const obj2 = {
      ...
      guild_id: true,
      application_id: true,
      cta_type: "minDurationMs",
      location_stack: "maxDist",
    };
    let applicationId;
    if (stateFromStores != null) {
      applicationId = stateFromStores.applicationId;
  ...
  if (tmp30) {
    ...
    tmp43Result = closure_14(tmp2(10937), obj6, skuId);
  ...
  if (null == stateFromStores) {
    ...
    if (!result) {
      ...
      tmp65Result = closure_14(tmp4(4635).Text, obj18);
    }
    ...
    if (result1) {
      ...
      obj22.onPress = tmp48;
      result1 = closure_14(tmp4(8205).IconButton, obj22);
    }
    items14[1] = result1;
    ...
    if (result) {
      ...
      const mobileFinePrintMessageForApplication = tmp4(10953).getMobileFinePrintMessageForApplication(
    ...
    if (exclusive) {
      ...
      exclusive = closure_14(tmp2(5071), obj31);
    }
...
obj.hero = {
  ...
  height: fn(10934).MOBILE_HERO_HEIGHT_PX,
