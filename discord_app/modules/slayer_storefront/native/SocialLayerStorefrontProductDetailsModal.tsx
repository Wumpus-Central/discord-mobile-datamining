...
function SocialLayerStorefrontProductDetailsModal(skuId) {
  ...
  if (tmp30) {
    ...
    tmp43Result = closure_14(tmp2(11065), obj6, skuId);
  ...
  if (null == stateFromStores) {
    ...
    if (!result) {
      ...
      tmp65Result = closure_14(tmp4(4752).Text, obj18);
    }
    ...
    if (result1) {
      ...
      obj22.onPress = tmp48;
      result1 = closure_14(tmp4(8178).IconButton, obj22);
    }
    items14[1] = result1;
    ...
    if (result) {
      ...
      const mobileFinePrintMessageForApplication = tmp4(11081).getMobileFinePrintMessageForApplication(
    ...
    if (exclusive) {
      ...
      exclusive = closure_14(tmp2(5198), obj31);
    }
...
obj.hero = {
  ...
  height: fn(11062).MOBILE_HERO_HEIGHT_PX,
