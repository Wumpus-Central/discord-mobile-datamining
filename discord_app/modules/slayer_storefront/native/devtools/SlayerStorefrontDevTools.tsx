...
export default function SlayerStorefrontDevTools() {
  ...
  obj1 = { style: tmp.inputRow, children: closure_10(require("TextInput").TextInput, { label: "SKU ID", value: str, onChange: tmp4, placeholder: "1234567890123456789", autoCapitalize: "none", autoCorrect: false, keyboardType: "number-pad" }) };
