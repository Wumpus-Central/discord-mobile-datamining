...
export default function SocialLayerStorefrontGiftProductDetails(sku) {
  ...
  const userPrice = getOrFetchApplication(10956).useFormattedSKUPrice({
    sku,
  ...
  const items3 = [
    tmp6Result,
    closure_7(getOrFetchApplication(4636).Text, { variant: "text-md/semibold", children: sku.name }),
  ];
  ...
  if (tmp8Result2) {
    ...
    tmp8Result2 = closure_7(tmp2(4636).Text, obj11);
  }
