...
export default function SocialLayerStorefrontGiftProductDetails(sku) {
  ...
  const userPrice = getOrFetchApplication(10935).useFormattedSKUPrice({
    sku,
  ...
  const items3 = [
    tmp6Result,
    closure_7(getOrFetchApplication(4635).Text, { variant: "text-md/semibold", children: sku.name }),
  ];
  ...
  if (tmp8Result2) {
    ...
    tmp8Result2 = closure_7(tmp2(4635).Text, obj11);
  }
