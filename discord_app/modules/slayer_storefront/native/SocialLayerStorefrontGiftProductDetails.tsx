...
export default function SocialLayerStorefrontGiftProductDetails(sku) {
  ...
  const userPrice = getOrFetchApplication(10948).useFormattedSKUPrice({
    sku,
  ...
  const items3 = [
    tmp6Result,
    closure_7(getOrFetchApplication(4634).Text, { variant: "text-md/semibold", children: sku.name }),
  ];
  ...
  if (tmp8Result2) {
    ...
    tmp8Result2 = closure_7(tmp2(4634).Text, obj11);
  }
