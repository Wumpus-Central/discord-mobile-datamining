...
const createCacheKey = { borderRadius: ThemesDefault.radii.md, overflow: "hidden", shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 8 };
...
const result = require("obj132").fileFinishedImporting("modules/slayer_storefront/native/SlayerStorefrontItemCard.tsx");
  ...
  if (null != sku) {
    ...
    if (null != str) {
      ...
      if (null != str2) {
        ...
        obj5[4] = jsx(bound(tmp7Result[8]), { source: null, style: null });
        tmp7Result = <tmp15 colors={null} start={null} end={null} style={null}>{null}</tmp15>;
