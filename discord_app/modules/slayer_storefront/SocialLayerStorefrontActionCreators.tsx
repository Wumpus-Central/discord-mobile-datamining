// === Module 10798: SocialLayerStorefrontActionCreators ===
    ...
    try {
      ...
      if (0 === c8) {
        ...
        if (1 === tmp7) {
          ...
          c7 = 0;
          const obj5 = { type: "SOCIAL_LAYER_STOREFRONT_LOAD_FAILURE", guildOrApplicationId: closure_132_0, eager: closure_132_4 };
          ...
          if (3 === tmp7) {
            if (arg0 === 1) {
              ...
              let obj9 = { type: "SOCIAL_LAYER_STOREFRONT_LOAD_SUCCESS", guildOrApplicationId: closure_132_0, storefront: closure_132_17 };
              obj4.dispatch(obj9);
              obj6 = closure_133_1(closure_133_2[5]);
              const obj10 = { type: "SOCIAL_LAYER_STOREFRONT_METADATA_LOAD_SUCCESS", applicationId: closure_132_17.applicationId, storefrontMetadata: null };
      ...
      if (0 === c7) {
        ...
        if (2 === tmp7) {
          ...
          if (null != closure_131_9.body) {
            ...
            obj7.assets = Object.fromEntries(assets.map((id) => {
            ...
            if (null != storefront_metadata) {
              ...
              obj8 = { type: "SOCIAL_LAYER_STOREFRONT_METADATA_LOAD_SUCCESS", applicationId: store_listing.sku.application_id, storefrontMetadata: null };
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            if ("loading" !== state) {
              ...
              if ("error" !== state1) {
                ...
                const obj2 = { url: Endpoints.SOCIAL_LAYER_STOREFRONTS_ALL(applicationId), rejectWithError: true, retries: 3 };
                c5 = 2;
                c6 = 1;
          ...
          if (1 === tmp8) {
            ...
            const obj5 = { type: "SOCIAL_LAYER_STOREFRONT_ENTRIES_LOAD_SUCCESS", applicationId: closure_129_0, entries: body.map(closure_130_0(closure_130_2[6]).transformSlayerApplicationStorefrontSummaryServer) };
        ...
        if (0 === c7) {
          if (arg0 === 1) {
            ...
            if ("loading" !== state) {
              ...
              const HTTP = require("HTTPUtils").HTTP;
              const request = { url: Endpoints.SOCIAL_LAYER_STOREFRONT_BY_ID(closure_0, storefrontId), query: obj2, rejectWithError: true, retries: 3 };
              c7 = 2;
              c8 = 1;
          ...
          if (1 === tmp8) {
            ...
            obj3 = closure_132_1(closure_132_2[5]);
            let obj7 = { type: "SOCIAL_LAYER_STOREFRONT_BY_ID_LOAD_SUCCESS", storefrontId: closure_131_1, storefront: closure_131_5 };
            obj3.dispatch(obj7);
            obj5 = closure_132_1(closure_132_2[5]);
            let obj8 = { type: "SOCIAL_LAYER_STOREFRONT_METADATA_LOAD_SUCCESS", applicationId: closure_131_5.applicationId, storefrontMetadata: null };
...
let closure_25 = async function _fetchSocialLayerStorefrontAnnouncement() {
  ...
  return (async (arg0) => {
    ...
    if (1 === tmp7) {
      ...
      obj2.dispatch({ type: "SOCIAL_LAYER_STOREFRONT_ANNOUNCEMENT_FETCH_SUCCESS", guildId: closure_129_0, announcement: closure_129_2 });
      c4 = 0;
    }
    return value;
  })();
    ...
    try {
      ...
      if (0 === c4) {
        ...
        if (1 === tmp7) {
          ...
          const obj4 = { promotionalSkuIds: body.promotional_sku_ids, promotionEndDatetime: closure_129_1, storefronts: closure_129_3, announcementModalConfig: closure_129_4 };
          obj3.config = obj4;
          obj1.dispatch(obj3);
          c3 = 0;
        }
...
let closure_27 = async function _fetchSocialLayerStorefrontLaunchAnnouncement() {
  ...
  if (1 === tmp7) {
    ...
    if (null != closure_136_0) {
      obj3 = { applicationId: closure_136_0.application_id, lightThemeLogoUrl: null, darkThemeLogoUrl: null, backgroundUrl: null, titles: null, subtitle: null, features: null, buttonText: null };
  ...
  if (tmp2) {
    ...
    const timerId = setTimeout(() => {
      if ("checking" === SocialLayerStorefrontStore.getSKUEligibility(skuId)) {
        const obj = { type: "SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY_CHECK_FAILURE", skuId, reason: "interaction_deadline" };
        obj.dispatch(obj);
      }
    }, closure_11);
    const HTTP = require("HTTPUtils").HTTP;
    ...
    HTTP.post(obj).then((body) => {
      const obj = { type: "SOCIAL_LAYER_SKU_PURCHASE_ELIGIBILITY_CHECK_CREATE", skuId, interactionId: body.body.interaction_id };
      obj.dispatch(obj);
    }).catch((error) => {
