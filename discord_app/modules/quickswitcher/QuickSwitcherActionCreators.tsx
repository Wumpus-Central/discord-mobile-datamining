...
const regExp = new RegExp(
  "^" +
    fn(10097).AutocompleterQuerySymbols.USER +
    "|" +
    fn(10097).AutocompleterQuerySymbols.TEXT_CHANNEL +
    "|" +
    fn(10097).AutocompleterQuerySymbols.VOICE_CHANNEL +
    "|\\" +
    fn(10097).AutocompleterQuerySymbols.GUILD +
    "|\\" +
    fn(10097).AutocompleterQuerySymbols.GAME_PROFILE,
);
const size = fn(2);
