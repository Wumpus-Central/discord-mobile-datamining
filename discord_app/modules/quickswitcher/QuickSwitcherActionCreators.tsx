...
const regExp = new RegExp(
  "^" +
    fn(9986).AutocompleterQuerySymbols.USER +
    "|" +
    fn(9986).AutocompleterQuerySymbols.TEXT_CHANNEL +
    "|" +
    fn(9986).AutocompleterQuerySymbols.VOICE_CHANNEL +
    "|\\" +
    fn(9986).AutocompleterQuerySymbols.GUILD +
    "|\\" +
    fn(9986).AutocompleterQuerySymbols.GAME_PROFILE,
);
const size = fn(2);
