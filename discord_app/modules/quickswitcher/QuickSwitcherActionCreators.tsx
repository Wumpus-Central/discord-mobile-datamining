...
const regExp = new RegExp(
  "^" +
    fn(10080).AutocompleterQuerySymbols.USER +
    "|" +
    fn(10080).AutocompleterQuerySymbols.TEXT_CHANNEL +
    "|" +
    fn(10080).AutocompleterQuerySymbols.VOICE_CHANNEL +
    "|\\" +
    fn(10080).AutocompleterQuerySymbols.GUILD +
    "|\\" +
    fn(10080).AutocompleterQuerySymbols.GAME_PROFILE,
);
const size = fn(2);
