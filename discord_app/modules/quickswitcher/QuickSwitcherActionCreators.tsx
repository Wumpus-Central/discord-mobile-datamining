...
const regExp = new RegExp(
  "^" +
    fn(10177).AutocompleterQuerySymbols.USER +
    "|" +
    fn(10177).AutocompleterQuerySymbols.TEXT_CHANNEL +
    "|" +
    fn(10177).AutocompleterQuerySymbols.VOICE_CHANNEL +
    "|\\" +
    fn(10177).AutocompleterQuerySymbols.GUILD +
    "|\\" +
    fn(10177).AutocompleterQuerySymbols.GAME_PROFILE,
);
const size = fn(2);
