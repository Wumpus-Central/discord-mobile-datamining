...
function handleUserSearchUpdate(arr, str) {
  ...
  if (!flag) {
    ...
    if (sortByMatchScore.AutocompleterResultTypes.USER_GLOBAL !== queryMode) {
      if (DOWN(9290).AutocompleterResultTypes.USER !== queryMode) {
        if (DOWN(9290).AutocompleterResultTypes.TEXT_CHANNEL === queryMode) {
        ...
        } else if (DOWN(9290).AutocompleterResultTypes.VOICE_CHANNEL === queryMode) {
        ...
        } else if (DOWN(9290).AutocompleterResultTypes.GUILD === queryMode) {
        ...
        } else if (DOWN(9290).AutocompleterResultTypes.APPLICATION === queryMode) {
        ...
        } else if (DOWN(9290).AutocompleterResultTypes.GAME_PROFILE === queryMode) {
