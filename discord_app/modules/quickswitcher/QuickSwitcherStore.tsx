...
function handleUserSearchUpdate(arr, str) {
  ...
  if (!flag) {
    ...
    if (sortByMatchScore.AutocompleterResultTypes.USER_GLOBAL !== queryMode) {
      if (DOWN(9279).AutocompleterResultTypes.USER !== queryMode) {
        if (DOWN(9279).AutocompleterResultTypes.TEXT_CHANNEL === queryMode) {
        ...
        } else if (DOWN(9279).AutocompleterResultTypes.VOICE_CHANNEL === queryMode) {
        ...
        } else if (DOWN(9279).AutocompleterResultTypes.GUILD === queryMode) {
        ...
        } else if (DOWN(9279).AutocompleterResultTypes.APPLICATION === queryMode) {
        ...
        } else if (DOWN(9279).AutocompleterResultTypes.GAME_PROFILE === queryMode) {
