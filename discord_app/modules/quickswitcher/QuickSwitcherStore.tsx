...
function handleUserSearchUpdate(arr, str) {
  ...
  if (!flag) {
    ...
    if (sortByMatchScore.AutocompleterResultTypes.USER_GLOBAL !== queryMode) {
      if (DOWN(9975).AutocompleterResultTypes.USER !== queryMode) {
        if (DOWN(9975).AutocompleterResultTypes.TEXT_CHANNEL === queryMode) {
        ...
        } else if (DOWN(9975).AutocompleterResultTypes.VOICE_CHANNEL === queryMode) {
        ...
        } else if (DOWN(9975).AutocompleterResultTypes.GUILD === queryMode) {
        ...
        } else if (DOWN(9975).AutocompleterResultTypes.APPLICATION === queryMode) {
        ...
        } else if (DOWN(9975).AutocompleterResultTypes.GAME_PROFILE === queryMode) {
