...
import _modDef4070 from "../../../_runtime/metro/04070__.js";
...
const dependencyMap = {
  [fn(13835).RewardProgram.NITRO]: canFetchNitroProgramReward,
  [fn(13835).RewardProgram.XBOX]: canFetchXboxProgramReward,
};
const size = fn(2);
