...
import _modDef4189 from "../../../_runtime/metro/04189__.js";
...
const dependencyMap = {
  [fn(13990).RewardProgram.NITRO]: canFetchNitroProgramReward,
  [fn(13990).RewardProgram.XBOX]: canFetchXboxProgramReward,
};
const size = fn(2);
