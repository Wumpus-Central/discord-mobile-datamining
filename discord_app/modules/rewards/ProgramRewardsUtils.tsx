...
import _modDef4155 from "../../../_runtime/metro/04155__.js";
...
const dependencyMap = {
  [fn(13936).RewardProgram.NITRO]: canFetchNitroProgramReward,
  [fn(13936).RewardProgram.XBOX]: canFetchXboxProgramReward,
};
const size = fn(2);
