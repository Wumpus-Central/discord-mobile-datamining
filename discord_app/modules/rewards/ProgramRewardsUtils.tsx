...
import _modDef4255 from "../../../_runtime/metro/04255__.js";
...
const dependencyMap = {
  [fn(14085).RewardProgram.NITRO]: canFetchNitroProgramReward,
  [fn(14085).RewardProgram.XBOX]: canFetchXboxProgramReward,
};
const size = fn(2);
