...
import _modDef3993 from "../../../_runtime/metro/03993__.js";
import _modDef4010 from "../../../_runtime/metro/04010__.js";
import differenceInMillisecondsDefault from "../../../_runtime/04038_differenceInMilliseconds.js";
      ...
      while (obj7 !== undefined) {
        ...
        if (!isNaN(date1.getTime())) {
          ...
          if (date >= tmp11) {
            ...
            obj7.return();
            return obj3;
          } else if (date >= _modDef3993(tmp7, -1)) {
            let obj4 = {
              state: closure_1_8.LESS_THAN_24H_BEFORE_REWARD,
              msUntilReward: differenceInMillisecondsDefault(tmp12, date),
            };
...
let c6 = 86400000;
const networkTtlCache = new fn(14002).NetworkTtlCache({ ttlMs: 86400000 });
let closure_8 = {
