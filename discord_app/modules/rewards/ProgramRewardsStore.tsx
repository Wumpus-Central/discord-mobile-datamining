// === Module 14091: ProgramRewardsStore ===

// Module 14091 (ProgramRewardsStore)
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import DurationsDefault from "Durations" /* 1091 */;
import _modDef4061 from "module_4061" /* 4061 */;
import _modDef4078 from "module_4078" /* 4078 */;
import differenceInMillisecondsDefault from "differenceInMilliseconds" /* 4106 */;
import ProgramRewardsUtils from "ProgramRewardsUtils" /* 14093 */;
      ...
      while (obj7 !== undefined) {
        ...
        if (!isNaN(date1.getTime())) {
          ...
          if (date >= tmp11) {
            ...
            obj7.return();
            return obj3;
          } else if (date >= _modDef4061(tmp7, -1)) {
...
let c6 = 86400000;
const networkTtlCache = new fn(14092).NetworkTtlCache({ ttlMs: 86400000 });
