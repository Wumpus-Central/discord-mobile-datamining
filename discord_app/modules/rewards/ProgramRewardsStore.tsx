// === Module 13252: ProgramRewardsStore ===

// Module 13252 (ProgramRewardsStore)
import initializeDefault from "initialize" /* 504 */;
import DispatcherDefault from "Dispatcher" /* 573 */;
import DurationsDefault from "Durations" /* 1091 */;
import _modDef4063 from "module_4063" /* 4063 */;
import _modDef4080 from "module_4080" /* 4080 */;
import differenceInMillisecondsDefault from "differenceInMilliseconds" /* 4108 */;
import ProgramRewardsUtils from "ProgramRewardsUtils" /* 13254 */;
      ...
      while (obj7 !== undefined) {
        ...
        if (!isNaN(date1.getTime())) {
          ...
          if (date >= tmp11) {
            ...
            obj7.return();
            return obj3;
          } else if (date >= _modDef4063(tmp7, -1)) {
...
let c6 = 86400000;
const networkTtlCache = new fn(13253).NetworkTtlCache({ ttlMs: 86400000 });
