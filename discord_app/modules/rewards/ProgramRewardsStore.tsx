...
import _modDef3959 from "../../../_runtime/metro/03959__.js";
import _modDef3976 from "../../../_runtime/metro/03976__.js";
import differenceInMillisecondsDefault from "../../../_runtime/04004_differenceInMilliseconds.js";
      ...
      while (obj7 !== undefined) {
        ...
        if (!isNaN(date1.getTime())) {
          ...
          if (date >= tmp11) {
            ...
            obj7.return();
            return obj3;
          } else if (date >= _modDef3959(tmp7, -1)) {
            let obj4 = {
              state: closure_1_8.LESS_THAN_24H_BEFORE_REWARD,
              msUntilReward: differenceInMillisecondsDefault(tmp12, date),
            };
