...
import _modDef4059 from "../../../_runtime/metro/04059__.js";
import _modDef4076 from "../../../_runtime/metro/04076__.js";
import differenceInMillisecondsDefault from "../../../_runtime/04104_differenceInMilliseconds.js";
      ...
      while (obj7 !== undefined) {
        ...
        if (!isNaN(date1.getTime())) {
          ...
          if (date >= tmp11) {
            ...
            obj7.return();
            return obj3;
          } else if (date >= _modDef4059(tmp7, -1)) {
            let obj4 = {
              state: closure_1_8.LESS_THAN_24H_BEFORE_REWARD,
              msUntilReward: differenceInMillisecondsDefault(tmp12, date),
            };
