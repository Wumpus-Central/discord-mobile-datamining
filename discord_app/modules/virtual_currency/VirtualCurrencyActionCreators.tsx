          ...
          if (0 === c5) {
            ...
            if (arg0 === 1) {
              ...
              callback2(709).wait(() => {
                ...
                const obj = { type: "VIRTUAL_CURRENCY_REDEEM_START", skuId: c0 };
                obj.dispatch(obj);
              });
...
let result = require("obj132").fileFinishedImporting("modules/virtual_currency/VirtualCurrencyActionCreators.tsx");
