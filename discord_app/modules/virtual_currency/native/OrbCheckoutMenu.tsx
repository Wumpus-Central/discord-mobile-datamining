...
export default function OrbCheckoutMenu() {
  ...
  items1[2] = closure_5(value(4632).Text, { style: tmp.title, variant: "text-md/bold", children: "Checkout will open with the orb price of the product, if it exists" });
  items1[3] = closure_5(value(5056).Button, { text: "Open Orbs Checkout", variant: "primary", onPress: callback, disabled: null == value });
  obj.children = items1;
