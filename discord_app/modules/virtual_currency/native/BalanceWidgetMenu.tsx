...
import _mod9129 from "../hooks/index.tsx";
  ...
  constructor() {
    ...
    obj.children = function children(markAsDismissed) {
      ...
      if (
        ...
        markAsDismissed(2027).DismissibleContent.VIRTUAL_CURRENCY_MOBILE_ONBOARDING_PILL
      ) {
  ...
  const callback = noop.useCallback(() => {
    ...
    obj5.onButtonPress = function onButtonPress() {
      ...
      obj4.openQuestHome({
        ...
        filter: constants3.VIRTUAL_CURRENCY,
        fromContent: str(5664).QuestContent.ORBS_BALANCE_MENU,
      });
    };
