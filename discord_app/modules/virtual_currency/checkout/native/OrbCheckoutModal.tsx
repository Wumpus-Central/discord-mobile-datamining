...
import OrbCheckoutModalComponents from "OrbCheckoutModalComponents.tsx";
import "module_19";
...
function OrbCheckoutModalContent(orbBalance) {
  ...
  items[2] = closure_1_11(OrbCheckoutModalComponents.OrbCheckoutPaymentSourceDetails, {
...
function OrbCheckoutModalFooter(onPress) {
  ...
  const items = [
    ...
    closure_1_11(OrbCheckoutModalComponents.OrbCheckoutPurchaseButton, { onPress: onPress.onPress }),
  ];
  obj.children = items;
...
function OrbCheckoutModalScreen(startTime) {
  ...
  let ref;
  const orbCheckoutModalContext = onRedeemVirtualCurrency(13558).useOrbCheckoutModalContext();
  ...
  let obj = onRedeemVirtualCurrency(13558);
  const orbCheckoutModalContext1 = onRedeemVirtualCurrency(13558).useOrbCheckoutModalContext();
  ...
  dependencyMap = tmp7;
  let obj2 = onRedeemVirtualCurrency(13558);
  const virtualCurrencyBalance = onRedeemVirtualCurrency(13560).useVirtualCurrencyBalance();
  ...
  let obj3 = onRedeemVirtualCurrency(13560);
  const obj4 = { children: null };
  ...
  const items5 = [
    closure_11(onRedeemVirtualCurrency(8773).ModalContent, {
  ...
  items5[1] = closure_11(onRedeemVirtualCurrency(12269).ModalFooter, {
    children: closure_11(OrbCheckoutModalFooter, { onPress: tmp6Result }),
  });
  obj4.children = items5;
  return closure_12(onRedeemVirtualCurrency(8772).ModalScreen, obj4);
}
const size = fn(2);
...
export default function _default(skuId) {
  ...
  obj3.render = function render() {
    const obj = {
      ...
      onCheckoutSuccess,
      analyticsLocations,
      children: closure_2_11(OrbCheckoutModalScreen, { startTime: current2 }),
    };
