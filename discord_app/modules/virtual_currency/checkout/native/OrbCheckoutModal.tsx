...
import useFetchCollectiblesProduct from "useFetchCollectiblesProduct" /* 11393 */;
import VirtualCurrencyUtils from "VirtualCurrencyUtils" /* 11623 */;
import OrbCheckoutModalContext from "OrbCheckoutModalContext" /* 13549 */;
import OrbCheckoutModalComponents from "OrbCheckoutModalComponents" /* 13550 */;
import "module_19";
...
function OrbCheckoutModalScreen(startTime) {
  ...
  let ref;
  const orbCheckoutModalContext = onRedeemVirtualCurrency(13549).useOrbCheckoutModalContext();
  ...
  let obj = onRedeemVirtualCurrency(13549);
  const orbCheckoutModalContext1 = onRedeemVirtualCurrency(13549).useOrbCheckoutModalContext();
  ...
  dependencyMap = tmp7;
  let obj2 = onRedeemVirtualCurrency(13549);
  const virtualCurrencyBalance = onRedeemVirtualCurrency(13551).useVirtualCurrencyBalance();
  ...
  let obj3 = onRedeemVirtualCurrency(13551);
  const obj4 = { children: null };
  const tmp6Result = closure_6(() => {
    ...
    onRedeemVirtualCurrency(() => {
      ...
      orbRedemptionError(5030).pop();
    });
  }, items4);
  const items5 = [closure_11(onRedeemVirtualCurrency(8769).ModalContent, { children: closure_11(OrbCheckoutModalContent, { orbBalance: current }) }), ];
  let obj5 = { children: closure_11(OrbCheckoutModalContent, { orbBalance: current }) };
  items5[1] = closure_11(onRedeemVirtualCurrency(12262).ModalFooter, { children: closure_11(OrbCheckoutModalFooter, { onPress: tmp6Result }) });
  obj4.children = items5;
  return closure_12(onRedeemVirtualCurrency(8768).ModalScreen, obj4);
}
const size = fn(2);
