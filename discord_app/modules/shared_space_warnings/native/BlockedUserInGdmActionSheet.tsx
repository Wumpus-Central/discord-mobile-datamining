...
function UserCalloutAvatars(userIds) {
  ...
  const stateFromStoresArray = userIds(504).useStateFromStoresArray(
    items,
...
let obj2 = {
  ...
  description: { textAlign: "center", alignSelf: "center" },
  tableGroup: null,
  buttons: null,
  icon: null,
};
...
export default function BlockedUserInGdmActionSheet(channelId) {
  ...
  const effect = noop.useEffect(() => {
    AnalyticsUtilsDefault.track(AnalyticEvents.GDM_BLOCKED_USER_WARNING_VIEWED, {
  ...
  if (blockedUserIds.length > 0) {
    if (tmp5) {
      ...
      obj4.icon = closure_11(UserCalloutAvatars, obj3);
    ...
    const items3 = [closure_11(closure_4, obj8), , ,];
    ...
    const items4 = [closure_11(tmp7(tmp8[9]).Text, obj10)];
    ...
    obj11.children = closure_11(BlockedUserInGDMDescription, obj12);
    items4[1] = closure_11(tmp7(tmp8[9]).Text, obj11);
    ...
    obj13.children = closure_11(tmp7(tmp8[22]).TableRowGroup, obj14);
    ...
    const items5 = [closure_11(tmp7(tmp8[24]).Button, obj16)];
    const obj17 = {
      size: "lg",
      variant: "secondary",
      onPress() {
    ...
    items5[1] = closure_11(tmp7(tmp8[24]).Button, obj17);
    obj15.children = items5;
    items3[3] = closure_13(closure_5, obj15);
    obj7.children = items3;
    obj6.children = closure_13(closure_5, obj7);
    return closure_11(tmp7(tmp8[20]).ActionSheet, obj6);
  }
  const items6 = [];
  if (blockedUserIds.length > 0) {
