...
export default function LeaderboardWinnerBadge(guildId) {
  ...
  if (null != stateFromStores) {
    obj = { style: tmp.container, accessible: true, accessibilityLabel: tmp2(10979).getLeaderboardWinnerBadgeText(stateFromStores), children: null };
    obj = { size: "xs", color: userId(576).colors.TEXT_FEEDBACK_WARNING };
    obj.children = jsx(tmp2(8787).TrophyIcon, { size: "xs", color: userId(576).colors.TEXT_FEEDBACK_WARNING });
