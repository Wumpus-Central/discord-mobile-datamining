...
import ApplicationCommandActionCreators from "../application_commands/ApplicationCommandActionCreators.tsx";
...
import ThreadSummaryStore from "ThreadSummaryStore.tsx";
...
export default {
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              const request = {
                url: closure_1_12.THREAD_MEMBER(closure_0.id, tmp3),
                query: null,
  ...
  openThreadCreationForMobile(channel, id, Message) {
    AppAnalyticsUtils.trackWithMetadata(constants.THREAD_CREATION_STARTED, {
      location: Message,
      channel_id: channel.id,
      guild_id: channel.guild_id,
    });
    const obj2 = { location: Message, channel_id: channel.id, guild_id: channel.guild_id };
    DraftActionCreatorsDefault.changeThreadSettings(channel.id, {
      parentMessageId: id,
      isPrivate: false,
      location: Message,
    });
        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              const result = tmp4(7195).trackThreadNotificationSettingsUpdated(tmp4, closure_1);
  ...
  searchThreads(arg0, channelId, arg2, arg3, arg4) {
    ...
    return (async () => {
      ...
      const request = {
        url: closure_1_12.THREAD_SEARCH(tmp3),
        query: { name, tag: joined, tag_setting: MATCH_SOME },
      ...
      tmp3(name[11]).dispatch({
        type: "LOAD_THREADS_SUCCESS",
        threads,
        members,
        guildId: closure_129_0,
        firstMessages: first_messages,
        mostRecentMessages: most_recent_messages,
      });
