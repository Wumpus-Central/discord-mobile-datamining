...
export default function getTimestampString(arg0, fn) {
  ...
  let time;
  const diffResult = require("../../../_runtime/metro/04228__.js")().diff(
    require("../../../_runtime/metro/04228__.js")(arg0),
    "s",
  );
  let tmp4;
  if (null != fn) {
  ...
  let obj = require("../../../_runtime/metro/04228__.js")();
  return require("../../../_runtime/metro/04228__.js")(arg0).format("LL");
}
