// === Module 10888: ThreadNotificationsBottomSheet ===
...
export default function ThreadNotificationsBottomSheet(channel) {
  ...
  obj[0] = jsx(channel(5586).BottomSheetTitleHeader, { title: null });
  obj1 = {
    hasIcons: false,
  ...
  obj[1] = jsx(channel(7639).TableRadioGroup, {
    hasIcons: false,
    value: threadNotificationSetting,
    onChange(flags) {
      let obj = closure_1_1(closure_1_2[7]);
  ...
  return jsx(channel(5954).ActionSheet, { title: null });
};