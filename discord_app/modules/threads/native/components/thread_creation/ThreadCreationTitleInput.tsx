...
export default noop.memo(
  noop.forwardRef((chatInputRef, ref) => {
    ...
    const renderErrorResult = chatInputRef(17185).renderError(chatInputRef.threadNameError, {
    ...
    const obj4 = {
      defaultValue: threadSettingsDraft(5891)(ref),
    ...
    obj4.ref = ref;
    return jsx(chatInputRef(6936).TextInput, {
      defaultValue: threadSettingsDraft(5891)(ref),
      errorMessage: renderErrorResult,
      label: stringResult,
      accessibilityHint: null,
