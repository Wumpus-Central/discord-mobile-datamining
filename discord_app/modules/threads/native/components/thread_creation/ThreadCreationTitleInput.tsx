...
export default noop.memo(
  noop.forwardRef((chatInputRef, ref) => {
    ...
    const renderErrorResult = chatInputRef(17159).renderError(chatInputRef.threadNameError, {
    ...
    const obj4 = {
      defaultValue: threadSettingsDraft(5889)(ref),
    ...
    obj4.ref = ref;
    return jsx(chatInputRef(6934).TextInput, {
      defaultValue: threadSettingsDraft(5889)(ref),
      errorMessage: renderErrorResult,
      label: stringResult,
      accessibilityHint: null,
