...
export default noop.memo(
  noop.forwardRef((chatInputRef, ref) => {
    ...
    const renderErrorResult = chatInputRef(17101).renderError(chatInputRef.threadNameError, {
    ...
    const obj4 = {
      defaultValue: threadSettingsDraft(5805)(ref),
    ...
    obj4.ref = ref;
    return jsx(chatInputRef(6850).TextInput, {
      defaultValue: threadSettingsDraft(5805)(ref),
      errorMessage: renderErrorResult,
      label: stringResult,
      accessibilityHint: null,
