...
function CreateThreadViewInner(screenIndex) {
  ...
  items4 = [
    ...
    {
      marginBottom:
        threadSettingsDraft(6981)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom -
        tmp16.bottom,
    },
  ];
  ...
  const items6 = [
    ...
    callback2(threadSettingsDraft(16620), {
      ref: ref1,
      chatInputRef: ref,
      threadSettingsDraft,
  ...
  items5[3] = callback2(threadSettingsDraft(11958), {
    ref,
