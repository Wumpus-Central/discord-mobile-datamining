...
function CreateThreadViewInner(screenIndex) {
  ...
  items4 = [
    ...
    {
      marginBottom:
        threadSettingsDraft(5602)({ isKeyboardAwareOnAndroid: false, includeKeyboardHeight: true }).insets.bottom -
        tmp16.bottom,
    },
  ];
  ...
  const items6 = [
    callback2(closure_6, {
      ...
      children: callback2(
        require("../../../../../design/components/Icon/native/redesign/generated/ThreadIcon.tsx").ThreadIcon,
        { size: "lg" },
      ),
    }),
    callback2(threadSettingsDraft(16436), {
      ref: ref1,
      chatInputRef: ref,
      threadSettingsDraft,
  ...
  items5[3] = callback2(threadSettingsDraft(11754), {
    ref,
    channel: parentChannel,
    onJumpToPresent: closure_12,
  ...
  obj[1] = items3;
  return closure_14(require("../../../../app_analytics/useAnalyticsLocations.tsx").AnalyticsLocationProvider, obj);
}
