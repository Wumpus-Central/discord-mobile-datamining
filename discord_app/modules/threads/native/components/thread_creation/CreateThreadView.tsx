...
function CreateThreadViewInner(screenIndex) {
  ...
  const items6 = [callback2(closure_6, { style: tmp.threadIconContainer, children: callback2(_require(6869).ThreadIcon, { size: "lg" }) }), callback2(threadSettingsDraft(15842), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
