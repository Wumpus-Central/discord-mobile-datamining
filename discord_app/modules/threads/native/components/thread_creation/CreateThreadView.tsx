...
function CreateThreadViewInner(screenIndex) {
  ...
  const items6 = [callback2(closure_6, { style: tmp.threadIconContainer, children: callback2(require("../../../../../design/components/Icon/native/redesign/generated/ThreadIcon.tsx").ThreadIcon, { size: "lg" }) }), callback2(threadSettingsDraft(15971), { ref: ref1, chatInputRef: ref, threadSettingsDraft, threadNameError: tmp6[0], optional: tmp20 }), ];
