...
function ThreadLongPressActionSheetConnected(channel) {
  ...
  if (null != stateFromStores) {
    ...
    let tmp19 = closure_13(tmp13(5634), obj);
  ...
  if (MarkChannelUnreadExperiment.getConfig({ location: "thread_action_sheet" }).enabled) {
    if (!stateFromStores1) {
      if (canMarkChannelUnread) {
        ...
        obj2.IconComponent = tmp(10314).ChatMarkUnreadIcon;
        ...
        if (null == tmp23) {
          ...
          if (isThreadModerator) {
            ...
            if (isLockedThreadResult) {
              ...
              obj9.IconComponent = tmp(10318).LockUnlockedIcon;
          ...
          if (!isThreadModerator) {
            ...
            obj10.IconComponent = tmp(4548).LinkIcon;
            ...
            if (isMuted) {
              ...
              obj12.IconComponent = tmp(9846).BellIcon;
              ...
              obj12[1] = tmp(9128).BellSlashIcon;
              ...
              obj13.IconComponent = tmp(11033).ChannelNotificationIcon;
              ...
              obj14.header = tmp18(tmp(11070).ActionSheetIconHeader, obj15);
              const items8 = [
                items5.map((buttons) => {
              ...
              if (setting) {
                ...
                const obj18 = { IconComponent: tmp(10699).IdIcon };
                obj17.icon = tmp18(tmp(7251).ActionSheetRow.Icon, obj18);
                ...
                obj16.children = tmp18(tmp(7251).ActionSheetRow, obj17);
                setting = tmp18(tmp(7251).ActionSheetRow.Group, obj16, "developer-actions");
              }
              items8[1] = setting;
              obj14.children = items8;
              return closure_14(tmp(7249).ActionSheet, obj14);
            }
          } else {
          ...
          const obj20 = { label: string3Result, IconComponent: tmp(7932).PhoneCallIcon, onPress: tmp23 };
  ...
  obj21.IconComponent = tmp(7020).EyeIcon;
  ...
  tmp17 = onClose(11046)(channel, "ThreadLongPressActionSheet");
}
