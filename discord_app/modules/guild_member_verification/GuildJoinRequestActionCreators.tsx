    ...
    try {
      ...
      if (0 === c7) {
        ...
        if (arg0 === 1) {
          ...
          const obj2 = { guildId: closure_133_0, actionType: closure_133_3, applicationUserId: closure_133_1 };
          const result = closure_134_0(closure_134_2[8]).trackMemberApplicationAction(obj2);
          ...
          const obj3 = { action: closure_133_3, rejection_reason: closure_133_4 };
          request.body = obj3;
        ...
        const obj6 = { type: "GUILD_JOIN_REQUEST_UPDATE", guildId: closure_133_0, status: closure_133_5.body.application_status, request: closure_133_5.body };
        obj.dispatch(obj6);
        c8 = 3;
        return { value: "HermesInternal", done: null };
      }
...
let closure_17 = async function _createOrEnterJoinRequestInterview() {
  ...
  await "PX_16";
  const HTTP = closure_131_0(closure_131_2[7]).HTTP;
  await HTTP.post({ url: closure_131_8.JOIN_REQUEST_INTERVIEW(closure_130_0), rejectWithError: closure_131_0(closure_131_2[7]).rejectWithMigratedError() });
  closure_130_2 = value;
