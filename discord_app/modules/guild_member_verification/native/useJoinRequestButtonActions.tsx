...
export const useJoinRequestButtonActions = function useJoinRequestButtonActions(
                  ...
                  if (null != c4) {
                    if (null != c5) {
                      ...
                      if (null != channel) {
                        ...
                        obj1[0] = closure_1_1(closure_1_2[8])(closure_1_7.CHANNEL(null, channel.id), {
                          openChannel: true,
              ...
              if (4 === tmp8) {
                if (arg0 === 1) {
                  ...
                  if (null != closure_0) {
                    ...
                    obj6[0] = closure_1_1(closure_1_2[8])(closure_1_7.CHANNEL(null, closure_0), {
                      openChannel: true,
                      navigationReplace: false,
                    });
                    return obj6;
  ...
  obj[0] = joinRequestId.useCallback(
    guildId(function* () {
      if (c5 === 2) {
        c5 = 3;
        HermesBuiltin.throwTypeError();
          ...
          if (0 === c4) {
                ...
                if (null != c3) {
                  if (null != c4) {
                    if (null != c5) {
                      ...
                      c5 = 1;
                      obj1 = { value: null, done: false };
                      obj1[0] = obj5.updateGuildJoinRequest(
                        tmp32,
                        tmp63,
                        tmp33,
                        closure_1_0(closure_1_2[11]).GuildJoinRequestApplicationStatuses.APPROVED,
                      );
                      return obj1;
                    }
                  }
            ...
            if (2 === tmp8) {
              ...
              obj3[2] = function icon() {
                return callback(tmp4(tmp44[12]).CircleCheckIcon, {
                  color: tmp42(tmp44[13]).colors.STATUS_POSITIVE_BACKGROUND,
                  secondaryColor: tmp42(tmp44[13]).colors.STATUS_POSITIVE_TEXT,
                });
              };
