...
const require = fn;
const result = require("obj132").fileFinishedImporting("modules/guild_member_verification/native/useJoinRequestButtonActions.tsx");
...
export const useJoinRequestButtonActions = function useJoinRequestButtonActions(joinRequest, interviewChannelId, callback) {
      ...
      try {
        ...
        if (0 === c4) {
          if (arg0 === 1) {
            ...
            if (!first) {
              if (null != c3) {
                if (null != c4) {
                  if (null != c5) {
                    const channel = first.getChannel(interviewChannelId);
                    if (null != channel) {
                      c4 = 1;
                      c5 = 1;
                      obj1 = { value: null, done: false };
                      obj1[0] = interviewChannelId(closure_1_2[8])(closure_1_7.CHANNEL(null, channel.id), { openChannel: true, navigationReplace: false });
                      return obj1;
                    } else {
                      closure_1_7(true);
                      c3 = 2;
                      ...
                      obj2[0] = interviewChannelId(closure_1_2[10]).createOrEnterJoinRequestInterview(tmp71, false);
                      return obj2;
                    }
                  }
                }
          ...
          if (arg0 === 1) {
            ...
            let obj7 = interviewChannelId(closure_1_2[9]);
          ...
          if (3 === tmp8) {
            ...
            if (4 === tmp8) {
              if (arg0 === 1) {
                ...
                c3 = 0;
                closure_1_7(false);
                obj3 = interviewChannelId(closure_1_2[9]);
                ...
                if (null != closure_0) {
                  ...
                  obj6[0] = interviewChannelId(closure_1_2[8])(closure_1_7.CHANNEL(null, closure_0), { openChannel: true, navigationReplace: false });
                  return obj6;
                }
              }
            } else if (arg0 === 1) {
              ...
              c3 = 0;
              callback(false);
              obj = interviewChannelId(closure_1_2[9]);
              obj.hideActionSheet();
              c5 = 3;
          ...
          c3 = 0;
          closure_1_7(false);
          obj5 = interviewChannelId(closure_1_2[9]);
          obj5.hideActionSheet();
        }
        c3 = 0;
        closure_1_7(false);
        obj6 = interviewChannelId(closure_1_2[9]);
      ...
      try {
        ...
        if (0 === c4) {
              ...
              if (null != c3) {
                if (null != c4) {
                  if (null != c5) {
                    closure_1_7(true);
                    c3 = 2;
                    const obj5 = interviewChannelId(closure_1_2[10]);
                    c4 = 3;
                    c5 = 1;
                    obj1 = { value: null, done: false };
                    obj1[0] = obj5.updateGuildJoinRequest(tmp32, tmp63, tmp33, joinRequest(closure_1_2[11]).GuildJoinRequestApplicationStatuses.APPROVED);
                    return obj1;
                  }
                }
              }
          ...
          if (2 === tmp8) {
            ...
            const intl = joinRequest(closure_1_2[7]).intl;
            obj3[1] = intl.string(joinRequest(closure_1_2[7]).t.WXHcq5);
            ...
            interviewChannelId(closure_1_2[6]).open(obj3);
            c3 = 1;
            const obj9 = interviewChannelId(closure_1_2[6]);
          }
          c3 = 0;
          closure_1_7(false);
          obj2 = interviewChannelId(closure_1_2[9]);
  ...
  obj[1] = joinRequestId.useCallback(() => {
    ...
    if (tmp2) {
      interviewChannelId(paths[9]);
      const _HermesInternal = HermesInternal;
      const obj = { joinRequest: null, onError: null, onDismiss: null };
      obj[0] = joinRequest;
      obj[1] = callback;
      obj[2] = paths;
