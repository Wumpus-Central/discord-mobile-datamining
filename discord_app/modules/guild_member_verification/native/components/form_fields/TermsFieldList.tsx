...
function TermsFieldListItem(rowNumber) {
  ...
  obj = { style: tmp.termsRowContent, variant: "text-md/medium", children: MarkupUtilsDefault.parseGuildVerificationFormRule(rule, true, { channelId: rulesChannelId }) };
...
createStyles.lastItem = { borderBottomLeftRadius: nativeDefault.radii.sm, borderBottomRightRadius: nativeDefault.radii.sm, marginBottom: 12 };
...
export default function TermsFieldList(rules) {
  ...
  let items = [closure_5(rules(4601).Text, obj), ];
  obj = {
