...
export default function UserVerification(arg0) {
  ...
  if (null == field.platform) {
    ...
    let tmp5 = platform === MAX_RESULTS_PER_PAGE /* MAX_RESULTS_PER_PAGE */.UserVerificationFieldPlatforms.PHONE;
    if (tmp5) {
    ...
    obj[1] = MAX_RESULTS_PER_PAGE /* MAX_RESULTS_PER_PAGE */.UserVerificationFieldPlatforms.EMAIL;
    ...
    if (platform === MAX_RESULTS_PER_PAGE /* MAX_RESULTS_PER_PAGE */.UserVerificationFieldPlatforms.PHONE) {
