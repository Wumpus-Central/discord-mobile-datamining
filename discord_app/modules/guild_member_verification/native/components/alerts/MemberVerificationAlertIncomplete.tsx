// === Module 7601: MemberVerificationAlertIncomplete ===
...
export default function MemberVerificationAlertIncomplete(guildId) {
  ...
  obj.icon = guildId(7602).ListViewIcon;
