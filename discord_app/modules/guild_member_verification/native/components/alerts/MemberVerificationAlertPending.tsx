// === Module 7589: MemberVerificationAlertPending ===
...
export default function MemberVerificationAlertPending(guildId) {
  ...
  obj.icon = guildId(7591).ClipboardListIcon;
