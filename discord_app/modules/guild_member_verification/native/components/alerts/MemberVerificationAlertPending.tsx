// === Module 7665: MemberVerificationAlertPending ===
...
export default function MemberVerificationAlertPending(guildId) {
  ...
  obj.icon = guildId(7667).ClipboardListIcon;
  ...
  obj1[2] = callback;
  items1[1] = callback(guildId(4928).Button, obj1);
  obj[0] = items1;
  obj.buttons = callback2(closure_5, obj);
  return callback(onClose(7666), obj);
};