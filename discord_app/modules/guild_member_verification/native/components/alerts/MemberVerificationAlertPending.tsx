// === Module 5841: MemberVerificationAlertPending ===
...
export default function MemberVerificationAlertPending(guildId) {
  ...
  obj.icon = guildId(5843).ClipboardListIcon;
  ...
  const items1 = [closure_4(guildId(5273).Button, obj3), ];
  ...
  items1[1] = closure_4(guildId(5273).Button, obj4);
