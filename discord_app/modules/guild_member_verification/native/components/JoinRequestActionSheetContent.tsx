...
import HourglassIcon from "HourglassIcon" /* 13191 */;
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  return closure_9(joinRequest(5645).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
