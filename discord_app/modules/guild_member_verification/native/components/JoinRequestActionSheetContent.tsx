...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const obj1 = { variant: "destructive", icon: closure_8(joinRequest(4558).XLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" }), label: null, onPress: null, disabled: null };
  ...
  return closure_9(joinRequest(5483).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
