...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const obj1 = { variant: "destructive", icon: closure_8(joinRequest(4589).XLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" }), label: null, onPress: null, disabled: null };
