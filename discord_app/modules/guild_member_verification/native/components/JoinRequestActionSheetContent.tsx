...
import HourglassIcon from "HourglassIcon" /* 9184 */;
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  return closure_9(joinRequest(5521).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
