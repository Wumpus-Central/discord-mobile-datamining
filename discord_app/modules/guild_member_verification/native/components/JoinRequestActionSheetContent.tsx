...
function OpenInterviewButton(arg0) {
  ...
  const joinRequestButtonActions = interviewChannelId(12726).useJoinRequestButtonActions(
    joinRequest,
    interviewChannelId,
  );
  ...
  if (!obj3.isActionedApplicationStatus(joinRequest.applicationStatus)) {
    ...
    obj.icon = closure_8(tmp(5122).ChatIcon, obj);
    if (label == null) {
    ...
    let tmp6Result = closure_8(tmp(5026).Button, obj);
  } else {
    tmp6Result = null;
  }
  return tmp6Result;
...
let closure_12 = noop.memo((user) => {
  ...
  if (null != user) {
    ...
    const items1 = [closure_8(joinRequest(8330), obj)];
    ...
    obj2.onPress = tmp8;
    const items2 = [closure_8(joinRequest(8340), obj2)];
    const obj4 = {
    ...
    const items4 = [closure_8(user(13153).PrimaryInfo, obj7)];
    const obj8 = { user };
    items4[1] = closure_8(joinRequest(13217), obj8);
    obj6.children = items4;
    obj4.children = closure_9(View, obj6);
    items2[1] = closure_8(joinRequest(11206), obj4);
    obj1.children = items2;
    items1[1] = closure_9(View, obj1);
    obj.children = items1;
    tmp9 = closure_9(closure_10, obj);
    const tmpResult = joinRequest(11206);
  }
  return tmp9;
});
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  obj.icon = closure_8(joinRequest(4557).CheckmarkLargeIcon, obj);
  const intl = joinRequest(1114).intl;
  obj.label = intl.string(joinRequest(1114).t.BzjDQJ);
  obj.onPress = approveRequest;
  obj.disabled = submitting;
  const children = [closure_8(joinRequest(8172).IconButton, obj), ,];
  const obj1 = {
    variant: "destructive",
    icon: closure_8(joinRequest(4559).XLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" }),
    label: null,
    onPress: null,
    disabled: null,
  };
  ...
  children[1] = closure_8(joinRequest(8172).IconButton, obj1);
  ...
  if (tmp6Result) {
    ...
    obj3.icon = closure_8(tmp2(5122).ChatIcon, obj4);
    const intl3 = tmp2(1114).intl;
    obj3.label = intl3.string(tmp2(1114).t.KQeYoC);
    obj3.onPress = handleOpenInterview;
    obj3.disabled = submitting;
    tmp6Result = closure_8(tmp2(8172).IconButton, obj3);
  }
  children[2] = tmp6Result;
  return closure_9(joinRequest(5484).ButtonGroup, {
