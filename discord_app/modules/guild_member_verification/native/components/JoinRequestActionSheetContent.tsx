...
import HourglassIcon from "HourglassIcon" /* 9173 */;
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  return closure_9(joinRequest(5519).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
