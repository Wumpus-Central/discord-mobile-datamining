...
import HourglassIcon from "HourglassIcon" /* 9159 */;
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  return closure_9(joinRequest(5514).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
