...
function OpenInterviewButton(arg0) {
  ...
  const joinRequestButtonActions = interviewChannelId(12663).useJoinRequestButtonActions(
    joinRequest,
    interviewChannelId,
  );
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const obj1 = {
    variant: "destructive",
    icon: closure_8(joinRequest(4527).XLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" }),
    label: null,
    onPress: null,
    disabled: null,
  };
  ...
  return closure_9(joinRequest(5447).ButtonGroup, {
