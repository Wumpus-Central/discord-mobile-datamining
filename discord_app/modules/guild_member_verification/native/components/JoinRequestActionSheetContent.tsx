...
function OpenInterviewButton(arg0) {
  ...
  const joinRequestButtonActions = interviewChannelId(12130).useJoinRequestButtonActions(
    joinRequest,
    interviewChannelId,
  );
...
let closure_12 = noop.memo((user) => {
  ...
  if (null != user) {
    ...
    const items1 = [closure_8(joinRequest(7692), obj3)];
    ...
    obj5.onPress = tmp8;
    const items2 = [closure_8(joinRequest(7702), obj5)];
    const obj7 = {
    ...
    const tmpResult = joinRequest(10573);
  }
  return tmp9;
});
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const joinRequestButtonActions = joinRequest(12130).useJoinRequestButtonActions(
    joinRequest,
  ...
  if (tmp6Result) {
    ...
    obj6.icon = closure_8(tmp2(5385).ChatIcon, obj7);
    const intl3 = tmp2(1115).intl;
    obj6.label = intl3.string(tmp2(1115).t.KQeYoC);
    obj6.onPress = handleOpenInterview;
    obj6.disabled = submitting;
    tmp6Result = closure_8(tmp2(7363).IconButton, obj6);
  }
  children[2] = tmp6Result;
  return closure_9(joinRequest(5745).ButtonGroup, {
