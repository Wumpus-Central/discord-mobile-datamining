...
import HourglassIcon from "HourglassIcon" /* 12438 */;
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  return closure_9(joinRequest(5740).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
