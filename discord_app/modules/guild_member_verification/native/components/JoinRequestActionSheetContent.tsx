...
import HourglassIcon from "HourglassIcon" /* 9268 */;
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  return closure_9(joinRequest(5603).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
