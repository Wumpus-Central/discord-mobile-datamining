...
import HourglassIcon from "HourglassIcon" /* 9162 */;
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  return closure_9(joinRequest(5518).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
