...
function OpenInterviewButton(arg0) {
  ...
  const joinRequestButtonActions = interviewChannelId(12875).useJoinRequestButtonActions(
    joinRequest,
    interviewChannelId,
  );
...
let closure_12 = noop.memo((user) => {
  ...
  if (null != user) {
    ...
    const items1 = [closure_8(joinRequest(8476), obj3)];
    ...
    obj5.onPress = tmp8;
    const items2 = [closure_8(joinRequest(8486), obj5)];
    const obj7 = {
    ...
    const obj11 = { user };
    items4[1] = closure_8(joinRequest(13366), obj11);
    obj9.children = items4;
    obj7.children = closure_9(View, obj9);
    items2[1] = closure_8(joinRequest(11364), obj7);
    obj4.children = items2;
    items1[1] = closure_9(View, obj4);
    obj2.children = items1;
    tmp9 = closure_9(closure_10, obj2);
    const tmpResult = joinRequest(11364);
  }
  return tmp9;
});
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const joinRequestButtonActions = joinRequest(12875).useJoinRequestButtonActions(
    joinRequest,
  ...
  if (tmp6Result) {
    ...
    obj6.icon = closure_8(tmp2(5240).ChatIcon, obj7);
    const intl3 = tmp2(1115).intl;
    obj6.label = intl3.string(tmp2(1115).t.KQeYoC);
    obj6.onPress = handleOpenInterview;
    obj6.disabled = submitting;
    tmp6Result = closure_8(tmp2(8140).IconButton, obj6);
  }
  children[2] = tmp6Result;
  return closure_9(joinRequest(5603).ButtonGroup, {
