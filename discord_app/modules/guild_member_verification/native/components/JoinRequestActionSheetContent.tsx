...
import HourglassIcon from "HourglassIcon" /* 9120 */;
...
let closure_15 = noop.memo((joinRequest) => {
  ...
  const obj1 = { variant: "destructive", icon: closure_8(joinRequest(4559).XLargeIcon, { color: nativeDefault.colors.WHITE, size: "lg" }), label: null, onPress: null, disabled: null };
  ...
  return closure_9(joinRequest(5484).ButtonGroup, { direction: "horizontal", align: "flex-start", justify: "space-evenly", children });
});
