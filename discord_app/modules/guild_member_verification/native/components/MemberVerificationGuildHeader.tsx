...
export default function MemberVerificationGuildHeader(hasManualFormFields) {
  ...
  obj = { interpolate: scrollTop(tmp3[9]).interpolate, scrollTopNegative: derivedValue, height: tmp8, ANIMATION_GOLDEN_RATIO, AVATAR_SIZE };
  fn.__closure = obj;
  ...
  let items = [closure_6(tmp5(tmp3[9]).Image, { style: { width: "100%", height: tmp8 }, resizeMode: "cover", source: guildBannerSource }), ];
  ...
  let items3 = [closure_6(tmp5(tmp3[11]), obj7), closure_6(tmp5(tmp3[12]), { style: tmp.featureIcon, guild, disableColor: true })];
  obj6.children = items3;
  let items4 = [closure_7(tmp5(tmp3[9]).View, obj6), , ];
  const obj9 = { style: tmp.headerTitle, variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: null };
