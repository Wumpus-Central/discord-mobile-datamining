...
export default function MemberVerificationGuildHeader(hasManualFormFields) {
  ...
  let items3 = [
    callback(tmp5(tmp3[11]), obj6),
    callback(tmp5(tmp3[12]), { style: tmp.featureIcon, guild, disableColor: true }),
  ];
  obj5[1] = items3;
