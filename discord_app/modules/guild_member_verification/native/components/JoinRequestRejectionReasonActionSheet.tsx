          ...
          try {
            ...
            if (0 === c4) {
              if (arg0 === 1) {
                ...
                obj1[0] = obj8.updateGuildJoinRequest(
                  closure_1_2,
                  closure_1_1,
                  c3,
                  closure_1_0(closure_1_2[7]).GuildJoinRequestApplicationStatuses.REJECTED,
                  c4,
                );
                return obj1;
              }
              ...
              if (2 === tmp8) {
                ...
                obj2[2] = function icon() {
                  return callback(tmp4(tmp24[10]).CircleXIcon, {
                    color: tmp42(tmp24[11]).colors.BACKGROUND_FEEDBACK_CRITICAL,
                    secondaryColor: tmp42(tmp24[11]).colors.ICON_FEEDBACK_CRITICAL,
                  });
                };
