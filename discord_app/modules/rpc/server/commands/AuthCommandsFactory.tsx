              ...
              if (null == closure_136_8.getCurrentUser()) {
                ...
                if (null != closure_135_13) {
                  ...
                  if (!closure_135_32(application)) {
                    ...
                    c12 = 1;
                    const obj9 = {
                      value: closure_136_0(closure_136_3[13]).fetchApplication(closure_135_0, closure_135_15),
                      done: false,
                    };
                    return obj9;
                  }
...
function authenticate(authorization, access_token) {
  ...
  if (authorization.authorization.accessToken) {
    ...
    let obj = {
      url: OAUTH2_CURRENT_AUTH.OAUTH2_CURRENT_AUTH,
      headers: null,
      oldFormErrors: true,
      ...
      if (client_id) {
        if (null != socket.authorization.accessToken) {
          ...
          if ("token" === args.response_type) {
            ...
            return authorizeWithPrompt(obj6, closure_0, hasItem)
              .then((location) => {
                socket.authorization.authing = false;
                if (null == location) {
