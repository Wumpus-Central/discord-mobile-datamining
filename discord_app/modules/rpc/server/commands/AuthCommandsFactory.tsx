    ...
    handler(socket) {
      ...
      if (null == access_token) {
        if (socket.transport === constants.IPC) {
          ...
          if (null == id) {
            let obj = { errorCode: constants2.INVALID_COMMAND };
            const tmp29 = new closure_1(9684)(obj, "No application.");
            throw tmp29;
          } else {
        ...
        if (null != socket.authorization.accessToken) {
          ...
          if ("token" === args.response_type) {
            ...
            return authorizeWithPrompt(obj3, closure_0, hasItem).then((location) => {
              ...
              if (null == location) {
                let obj = { errorCode: constants2.UNKNOWN_ERROR };
                const tmp25 = new hasItem(9684)(obj, "Unknown error occurred");
                throw tmp25;
              } else {
                const _URL = URL;
                ...
                if (hasItem) {
                  ...
                  if (null == value) {
                    ...
                    const tmp8 = new hasItem(9684)(obj2, "OAuth2 Error: Unable to find auth code");
                    throw tmp8;
                  } else {
                    obj = { code: value };
                    return obj;
