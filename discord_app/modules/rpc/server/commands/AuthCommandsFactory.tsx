...
import LeakyBucket from "LeakyBucket" /* 9566 */;
            ...
            if (aborted) {
              ...
              if (!closure_135_16) {
                if (null != closure_135_2) {
                  ...
                  const tmp146 = new closure_136_1(closure_136_3[10])(obj4, "Redirect URI cannot be used in the RPC OAuth2 Authorization flow");
                  throw tmp146;
                }
              }
              closure_135_23 = [];
              ...
              if (null == closure_136_8.getCurrentUser()) {
                ...
                c9 = 1;
                const obj7 = { clientId: closure_135_0, scopes: closure_135_23, responseType: closure_135_1, redirectUri: closure_135_2, codeChallenge: closure_135_3, codeChallengeMethod: closure_135_4, state: closure_135_5, integrationType: closure_135_19, signal: closure_135_15 };
                ...
                if (null != closure_135_20) {
                  if (closure_135_20.authorized) {
                    if (allAcked) {
                      ...
                      obj11 = { authorize: true, clientId: closure_135_0, scopes: closure_135_23, responseType: closure_135_1, redirectUri: closure_135_2, codeChallenge: closure_135_3, codeChallengeMethod: closure_135_4, state: closure_135_5, nonce: closure_135_6, integrationType: closure_135_19 };
                      c11 = 6;
                      c12 = 1;
    ...
    handler(socket) {
      ...
      if (null == access_token) {
        if (socket.transport === constants.IPC) {
          ...
          if (null == id) {
            let obj = { errorCode: constants2.INVALID_COMMAND };
            const tmp29 = new closure_1(9559)(obj, "No application.");
            throw tmp29;
          } else {
                ...
                if (typeof _authorize === "function") {
                  ...
                  return authorizeWithPrompt(obj, closure_0, closure_1).then((result) => {
                    if (null == result) {
                      ...
                      const tmp22 = new closure_1(9559)(obj, "Unknown error occurred");
                      throw tmp22;
                    } else {
      ...
      if (null == access_token) {
        obj = { errorCode: constants2.INVALID_TOKEN };
        const tmp11 = new closure_1(9559)(obj, "No access token provided");
        throw tmp11;
      } else {
      ...
      if (client_id) {
        if (null != socket.authorization.accessToken) {
          ...
          if ("token" === args.response_type) {
            ...
            return authorizeWithPrompt(obj3, closure_0, hasItem).then((location) => {
              socket.authorization.authing = false;
              if (null == location) {
                let obj = { errorCode: constants2.UNKNOWN_ERROR };
                const tmp25 = new hasItem(9559)(obj, "Unknown error occurred");
                throw tmp25;
              } else {
                const _URL = URL;
                ...
                if (hasItem) {
                  ...
                  if (null == value) {
                    ...
                    const tmp8 = new hasItem(9559)(obj2, "OAuth2 Error: Unable to find auth code");
                    throw tmp8;
                  } else {
                    obj = { code: value };
                    return obj;
