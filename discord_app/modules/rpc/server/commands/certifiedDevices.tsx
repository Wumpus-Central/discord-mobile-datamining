...
obj[1] = function validation(array) {
  let obj = importDefault(10546)(array);
  obj = { devices: null };
  ...
  const obj5 = importDefault(10546)(array);
  ...
  const obj11 = importDefault(10546)(array);
  const obj1 = { name: null, url: null };
  const requiredResult3 = importDefault(10546)(array).required();
  ...
  const obj16 = importDefault(10546)(array);
  const obj2 = { name: null, url: null };
  const requiredResult4 = importDefault(10546)(array).required();
