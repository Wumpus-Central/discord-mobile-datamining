...
obj = {
  ...
  handler(arg0) {
    ...
    const value = connection_redirect(4951).get(provider);
    dependencyMap = value;
    if (null == value) {
      obj = { errorCode: null };
      obj[0] = constants2.INVALID_PROVIDER;
      const _HermesInternal = HermesInternal;
      let tmp4Result = tmp4(10515);
      ...
      const tmp22 = new tmp4(10515)(obj, "Command not available for this application");
      throw tmp22;
              ...
              if (0 === c6) {
                if (arg0 === 1) {
                  ...
                  if (null == account) {
                    ...
                    obj1[2] = callback2;
                    connection_redirect(10378)(obj1);
                    const obj6 = connection_redirect(709);
                  } else {
                    let c5 = 1;
                    let obj3 = connection_redirect(5075);
                    c6 = 2;
                    c7 = 1;
                ...
                const tmp19 = new connection_redirect(10515)(obj4, "Refreshing access token did not return a new access token");
                throw tmp19;
              }
              c7 = 3;
            } catch (tmp42) {
      ...
      const tmp10 = new tmp4(10515)(obj1, "Command not available for this application");
      throw tmp10;
    }
    let obj3 = connection_redirect(4951);
  }
};
      ...
      try {
        ...
        if (0 === type) {
          ...
          if (arg0 === 1) {
            ...
            const result = socket(10520).validatePostMessageTransport(socket.transport);
            const obj14 = socket(10520);
            dependencyMap = socket(10520).validateApplication(socket.application);
            const obj15 = socket(10520);
            type = provider(4951).get(provider);
            if (null == type) {
              const obj2 = { errorCode: null };
              obj2[0] = closure_9.INVALID_PROVIDER;
              const _HermesInternal = HermesInternal;
              let tmp59 = provider(10515);
              ...
              const tmp53 = new provider(10515)(obj3, "Command not available for this application");
              throw tmp53;
              ...
              if (null == id) {
                ...
                const tmp44 = new provider(10515)(obj4, "No connection found");
                throw tmp44;
              } else {
                let obj5 = provider(5075);
                type = 2;
                id = 1;
              ...
              const tmp24 = new provider(10515)(obj6, "Command not available for this application");
              throw tmp24;
            }
            const obj16 = provider(4951);
          }
        } else if (arg0 === 1) {
          id = 3;
          throw arg1;
          ...
          if (null == account) {
            ...
            const tmp15 = new provider(10515)(obj8, "Refreshing access token did not return a new access token");
            throw tmp15;
          } else {
            obj = { access_token: null };
            obj[0] = account;
