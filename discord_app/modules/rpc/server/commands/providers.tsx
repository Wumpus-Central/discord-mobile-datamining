...
obj = {
  ...
  handler(arg0) {
    ...
    if (null == value) {
      ...
      const tmp22 = new tmp4(9624)(obj, "Command not available for this application");
      throw tmp22;
          ...
          if (c7 === 2) {
            ...
            try {
              ...
              if (0 === c6) {
                if (arg0 === 1) {
                  ...
                  if (null == account) {
                    ...
                    function handleConnectionsCallbackError() {
                      let tmp = connection_redirect(9624);
                      tmp = new tmp(
                    ...
                    const subscription = connection_redirect(dependencyMap[10]).subscribe(
                    ...
                    const obj1 = {
                      platformType: dependencyMap.type,
                      location: constants.ACTIVITY_RPC,
                      successRedirect,
                    };
                ...
                const tmp21 = new connection_redirect(dependencyMap[9])(
                  obj4,
      ...
      const tmp10 = new tmp4(9624)(obj1, "Command not available for this application");
      throw tmp10;
    }
