...
prototype["init"] = function init() {
  ...
  const subscription = require("../../../Dispatcher.tsx").subscribe("MESSAGE_CREATE", this.handleMessage);
  const obj2 = require("../../../Dispatcher.tsx");
  const subscription1 = require("../../../Dispatcher.tsx").subscribe("MESSAGE_UPDATE", this.handleMessage);
  const obj3 = require("../../../Dispatcher.tsx");
  const subscription2 = require("../../../Dispatcher.tsx").subscribe("MESSAGE_DELETE", this.handleMessage);
  const obj4 = require("../../../Dispatcher.tsx");
  const subscription3 = require("../../../Dispatcher.tsx").subscribe("SPEAKING", this.handleSpeaking);
  const obj5 = require("../../../Dispatcher.tsx");
  const subscription4 = require("../../../Dispatcher.tsx").subscribe("OAUTH2_TOKEN_REVOKE", this.handleOAuth2TokenRevoke);
  const obj6 = require("../../../Dispatcher.tsx");
  const subscription5 = require("../../../Dispatcher.tsx").subscribe("GUILD_CREATE", this.handleGuildCreate);
  const obj7 = require("../../../Dispatcher.tsx");
  const subscription6 = require("../../../Dispatcher.tsx").subscribe("CHANNEL_CREATE", this.handleChannelCreate);
  const obj8 = require("../../../Dispatcher.tsx");
  const subscription7 = require("../../../Dispatcher.tsx").subscribe("LOGOUT", this.handleLogout);
  const obj9 = require("../../../Dispatcher.tsx");
  const subscription8 = require("../../../Dispatcher.tsx").subscribe("VOICE_CHANNEL_SELECT", this.handleVoiceChannelSelect);
  const obj10 = require("../../../Dispatcher.tsx");
  const subscription9 = require("../../../Dispatcher.tsx").subscribe("RPC_NOTIFICATION_CREATE", this.handleNotificationCreate);
  const obj11 = require("../../../Dispatcher.tsx");
  const subscription10 = require("../../../Dispatcher.tsx").subscribe("ACTIVITY_JOIN", this.handleActivityJoin);
  const obj12 = require("../../../Dispatcher.tsx");
  const subscription11 = require("../../../Dispatcher.tsx").subscribe("ACTIVITY_LAYOUT_MODE_UPDATE", this.handleActivityLayoutModeUpdate);
  const obj13 = require("../../../Dispatcher.tsx");
  const subscription12 = require("../../../Dispatcher.tsx").subscribe("FRAME_UPDATE_LAYOUT_MODE", this.handleFrameUpdateLayoutMode);
  const obj14 = require("../../../Dispatcher.tsx");
  const subscription13 = require("../../../Dispatcher.tsx").subscribe("THERMAL_STATE_CHANGE", this.handleThermalStateChange);
  const obj15 = require("../../../Dispatcher.tsx");
  const subscription14 = require("../../../Dispatcher.tsx").subscribe("ACTIVITY_SCREEN_ORIENTATION_UPDATE", this.handleScreenOrientationUpdate);
  const obj16 = require("../../../Dispatcher.tsx");
  const subscription15 = require("../../../Dispatcher.tsx").subscribe("EMBEDDED_ACTIVITY_UPDATE", this.handleEmbeddedActivityUpdate);
  const obj17 = require("../../../Dispatcher.tsx");
  const subscription16 = require("../../../Dispatcher.tsx").subscribe("RELATIONSHIP_ADD", this.handleRelationshipAdd);
  const obj18 = require("../../../Dispatcher.tsx");
  const subscription17 = require("../../../Dispatcher.tsx").subscribe("RELATIONSHIP_UPDATE", this.handleRelationshipUpdate);
  const obj19 = require("../../../Dispatcher.tsx");
  const subscription18 = require("../../../Dispatcher.tsx").subscribe("RELATIONSHIP_REMOVE", this.handleRelationshipRemove);
  const obj20 = require("../../../Dispatcher.tsx");
  const subscription19 = require("../../../Dispatcher.tsx").subscribe("PRESENCE_UPDATES", this.handlePresenceUpdates);
  const obj21 = require("../../../Dispatcher.tsx");
  const subscription20 = require("../../../Dispatcher.tsx").subscribe("PRESENCES_REPLACE", this.handlePresencesReplace);
  const obj22 = require("../../../Dispatcher.tsx");
  const subscription21 = require("../../../Dispatcher.tsx").subscribe("USER_UPDATE", this.handleUserUpdate);
  const obj23 = require("../../../Dispatcher.tsx");
  const subscription22 = require("../../../Dispatcher.tsx").subscribe("ENTITLEMENT_CREATE", this.handleEntitlementCreate);
  const obj24 = require("../../../Dispatcher.tsx");
  const subscription23 = require("../../../Dispatcher.tsx").subscribe("ENTITLEMENT_DELETE", this.handleEntitlementDelete);
  const obj25 = require("../../../Dispatcher.tsx");
  const subscription24 = require("../../../Dispatcher.tsx").subscribe("QUESTS_ENROLL_SUCCESS", this.handleQuestEnrollSuccess);
};
prototype["terminate"] = function terminate() {
  require("../../../Dispatcher.tsx").unsubscribe("MESSAGE_CREATE", this.handleMessage);
  const obj = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("MESSAGE_UPDATE", this.handleMessage);
  const obj2 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("MESSAGE_DELETE", this.handleMessage);
  const obj3 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("SPEAKING", this.handleSpeaking);
  const obj4 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("OAUTH2_TOKEN_REVOKE", this.handleOAuth2TokenRevoke);
  const obj5 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("GUILD_CREATE", this.handleGuildCreate);
  const obj6 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("CHANNEL_CREATE", this.handleChannelCreate);
  const obj7 = require("../../../Dispatcher.tsx");
  ...
  const obj9 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("RPC_NOTIFICATION_CREATE", this.handleNotificationCreate);
  const obj10 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("ACTIVITY_JOIN", this.handleActivityJoin);
  const obj11 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("ACTIVITY_LAYOUT_MODE_UPDATE", this.handleActivityLayoutModeUpdate);
  const obj12 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("FRAME_UPDATE_LAYOUT_MODE", this.handleFrameUpdateLayoutMode);
  const obj13 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("THERMAL_STATE_CHANGE", this.handleThermalStateChange);
  const obj14 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("ACTIVITY_SCREEN_ORIENTATION_UPDATE", this.handleScreenOrientationUpdate);
  const obj15 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("EMBEDDED_ACTIVITY_UPDATE", this.handleEmbeddedActivityUpdate);
  const obj16 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("RELATIONSHIP_ADD", this.handleRelationshipAdd);
  const obj17 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("RELATIONSHIP_UPDATE", this.handleRelationshipUpdate);
  const obj18 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("RELATIONSHIP_REMOVE", this.handleRelationshipRemove);
  const obj19 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("PRESENCE_UPDATES", this.handlePresenceUpdates);
  const obj20 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("PRESENCES_REPLACE", this.handlePresencesReplace);
  const obj21 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("USER_UPDATE", this.handleUserUpdate);
  const obj22 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("ENTITLEMENT_CREATE", this.handleEntitlementCreate);
  const obj23 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("ENTITLEMENT_DELETE", this.handleEntitlementDelete);
  const obj24 = require("../../../Dispatcher.tsx");
  require("../../../Dispatcher.tsx").unsubscribe("QUESTS_ENROLL_SUCCESS", this.handleQuestEnrollSuccess);
};
