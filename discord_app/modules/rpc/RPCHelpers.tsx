          ...
          if (0 === name) {
            if (arg0 === 1) {
              ...
              if (typeof dependencyMap === "string") {
                if (tmp67.transport === outer1_16.POST_MESSAGE) {
                  const tmp21 = callback(10527)(tmp68);
                  if (null != tmp21) {
                    const items = [tmp21];
                  }
                  const obj1 = { closeCode: null };
                  obj1[0] = outer1_21.INVALID_ORIGIN;
                  const tmp52 = new callback(10670)(obj1, "Invalid Origin");
                  throw tmp52;
                } else {
                  name = 1;
                  icon = 1;
            ...
            if (arg0 === 1) {
              ...
              if (!callback3(dependencyMap, rpc_origins.rpc_origins)) {
                ...
                const tmp16 = new callback(10670)(obj6, "Invalid Origin");
                throw tmp16;
              }
            }
          } else if (arg0 === 1) {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              if (null == obj2) {
                ...
                const tmp24 = new callback(10677)(num5, outer1_25);
                tmp38[tmp35] = tmp24;
                obj2 = tmp24;
              }
              let c6 = 1;
            ...
            const tmp16 = new callback(10670)(obj2, "Socket closed during throttle");
            throw tmp16;
          } else if (arg0 === 1) {
            c7 = 3;
            throw arg1;
