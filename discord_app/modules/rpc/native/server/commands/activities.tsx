      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (arg0 === 1) {
            ...
            c3 = 1;
            const obj8 = {
              value: tmp2(5462).launchImageLibraryAsync({
                mediaType: "photo",
                includeBase64: false,
                selectionLimit: 1,
              }),
            ...
            const tmp42 = new tmp2(8770)(obj9, "Missing photo permissions");
            throw tmp42;
          }
        } else if (2 === tmp6) {
          if (arg0 === 1) {
            ...
            if (null == closure_128_2) {
              ...
              c3 = 1;
              const obj14 = {
                value: tmp3(8782).uploadImageAttachment(closure_128_0, closure_128_1, obj13),
                done: false,
              };
              return obj14;
            }
          ...
          if (null != closure_128_3) {
            if (null != closure_128_3.url) {
              if (!(closure_128_3 instanceof tmp2(4736))) {
