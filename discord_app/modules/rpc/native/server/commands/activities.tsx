      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (arg0 === 1) {
            ...
            c3 = 1;
            const obj8 = {
              value: tmp2(5368).launchImageLibraryAsync({
                mediaType: "photo",
                includeBase64: false,
                selectionLimit: 1,
              }),
            ...
            const tmp42 = new tmp2(9587)(obj9, "Missing photo permissions");
            throw tmp42;
          }
        } else if (2 === tmp6) {
          if (arg0 === 1) {
            ...
            if (null == closure_128_2) {
              ...
              c3 = 1;
              const obj14 = {
                value: tmp3(9599).uploadImageAttachment(closure_128_0, closure_128_1, obj13),
                done: false,
              };
              return obj14;
            }
