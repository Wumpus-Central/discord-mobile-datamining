        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null == id) {
              ...
              const tmp62 = new tmp2(9624)(obj1, "No application.");
              throw tmp62;
            } else {
              ...
              if (null == id) {
                ...
                const tmp54 = new tmp2(9624)(obj2, "Unable to find selected channel");
                throw tmp54;
              } else {
                let obj11 = tmp2(5189);
          ...
          if (arg0 === 1) {
            ...
            c3 = 1;
            const obj5 = {
              value: tmp2(5200).launchImageLibraryAsync({
                mediaType: "photo",
                includeBase64: false,
                selectionLimit: 1,
              }),
            ...
            const tmp42 = new tmp2(9624)(obj6, "Missing photo permissions");
            throw tmp42;
          }
        } else if (2 === tmp6) {
          if (arg0 === 1) {
            ...
            if (null == closure_128_2) {
              ...
              const tmp36 = new tmp2(9624)(obj8, "No image selected");
              throw tmp36;
            } else {
              ...
              c3 = 1;
              const obj10 = {
                value: tmp3(9574).uploadImageAttachment(closure_128_0, closure_128_1, obj9),
                done: false,
              };
              return obj10;
            }
