      ...
      try {
        ...
        if (0 === dependencyMap) {
              ...
              if (null == id1) {
                ...
                const obj6 = {
                  value: permission.catch(() => {
                    throw new closure_1_1(dependencyMap[6])(
                      { errorCode: constants.UNKNOWN_ERROR },
                      "Failed requesting photo permissions",
                    );
                  }),
                  done: false,
                };
          ...
          if (arg0 === 1) {
            ...
            c3 = 1;
            const obj8 = {
              value: tmp2(5455).launchImageLibraryAsync({
                mediaType: "photo",
                includeBase64: false,
                selectionLimit: 1,
              }),
          ...
          if (arg0 === 1) {
            ...
            if (null == closure_128_2) {
              ...
              c3 = 1;
              const obj14 = {
                value: tmp3(8774).uploadImageAttachment(closure_128_0, closure_128_1, obj13),
                done: false,
              };
              return obj14;
            }
