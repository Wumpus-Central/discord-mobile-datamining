// === Module 14889: commands/activities ===
...
import validateOpenInviteDialog from "validateOpenInviteDialog" /* 14856 */;
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          if (arg0 === 1) {
            ...
            dependencyMap = 2;
            c3 = 1;
            const obj8 = { value: tmp2(5454).launchImageLibraryAsync({ mediaType: "photo", includeBase64: false, selectionLimit: 1 }), done: false };
            return obj8;
          } else {
          ...
          if (arg0 === 1) {
            ...
            if (null == closure_128_2) {
              ...
              dependencyMap = 3;
              c3 = 1;
              const obj14 = { value: tmp3(9676).uploadImageAttachment(closure_128_0, closure_128_1, obj13), done: false };
              return obj14;
            }
          }
        } else if (arg0 === 1) {
