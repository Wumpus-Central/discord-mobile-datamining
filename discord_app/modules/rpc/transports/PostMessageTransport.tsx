...
class PostMessageTransport extends EventEmitter {
  constructor(arg0, arg1, arg2, arg3) {
    ...
    tmp4.disconnectSocket = function disconnectSocket(closure_0, closure_1, arg2) {
      ...
      let found = Array.from(map.entries()).find((item, index) => {
        [, tmp] = item;
    ...
    tmp4.handleIFrameMount = function handleIFrameMount(id) {
      ...
      closure_0.handshakeFailureTimeoutId = setTimeout(() => {
        ...
        const item = Array.from(selfEmbeddedActivities.entries()).forEach((item, index) => {
          [tmp, tmp2] = item;
          callback2(698);
          const obj = { application_id: tmp, channel_id: callback(4011).getEmbeddedActivityLocationChannelId(tmp2.location), guild_id: null, timeout_ms: null };
    ...
    tmp4.handleIFrameUnmount = function handleIFrameUnmount(id) {
      ...
      const tmp2 = closure_1_4(found, 2);
    ...
    tmp4.handleMessage = function handleMessage(arg0, iframeId) {
      ...
      try {
        ...
        if (tmp12 instanceof callback(dependencyMap[11])) {
    ...
    tmp4.handleFrame = function handleFrame(origin, source, str) {
      if (origin.origin !== source.source.origin) {
        ...
        const tmp24 = new callback(dependencyMap[11])(obj, "Origin has changed");
        throw tmp24;
      } else {
        try {
          let parsed = str;
          ...
          const tmp16 = new callback(dependencyMap[11])(obj, "Payload not recognized encoding");
          throw tmp16;
        }
      }
    };
            ...
            if (0 === c8) {
              if (arg0 === 1) {
                ...
                if (null != lib2.handshakeFailureTimeoutId) {
                  ...
                  clearTimeout(lib2.handshakeFailureTimeoutId);
                }
                c8 = 1;
                c9 = 1;
              ...
              if (arg0 === 1) {
                ...
                json.assert(lib2, requiredResult.keys(obj3));
                c7 = 0;
                closure_5 = lib2;
                ...
                logger6.error("Unrecognized iframe ID: reported " + frame_id + ", expected " + lib.iframeId);
                const obj7 = { closeCode: null };
                obj7[0] = c9.CLOSE_UNSUPPORTED;
                const _HermesInternal8 = HermesInternal;
                let tmp109 = lib2(paths[11]);
              ...
              obj9[0] = arg1;
              return obj9;
            } else if (closure_1_13.has(lib.iframeId)) {
  ...
  if (Array.isArray(arg2)) {
    ...
    if (HANDSHAKEDefault.HANDSHAKE === tmp5) {
      if (null != value) {
        ...
        const tmp35 = new prototypeDefault(obj, "Already connected");
        throw tmp35;
      } else {
        return self.handleHandshake(iframeId, tmp6, arg3);
      }
    } else if (HANDSHAKEDefault.FRAME === tmp5) {
      if (null == value) {
        obj = { closeCode: null };
        obj[0] = constants2.CLOSE_UNSUPPORTED;
        const tmp27 = new prototypeDefault(obj, "Not connected");
        throw tmp27;
      } else {
        return self.handleFrame(iframeId, value, tmp6);
      }
    } else if (HANDSHAKEDefault.CLOSE === tmp5) {
      if (null == value) {
        obj1 = { closeCode: null };
        obj1[0] = constants2.CLOSE_UNSUPPORTED;
        const tmp20 = new prototypeDefault(obj1, "Not connected");
        throw tmp20;
      } else {
      ...
      obj = { closeCode: null };
      obj[0] = constants2.CLOSE_UNSUPPORTED;
      const tmp13 = new prototypeDefault(obj, "Invalid opcode");
      throw tmp13;
    }
    const tmp4 = callback2(arg2, 2);
  }
};
let result = require("obj132").fileFinishedImporting("modules/rpc/transports/PostMessageTransport.tsx");
