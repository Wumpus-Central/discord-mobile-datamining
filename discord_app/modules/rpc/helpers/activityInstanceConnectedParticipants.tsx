  ...
  handler() {
    return (arg0) => {
      ...
      if (null == currentEmbeddedActivity) {
        ...
        embeddedActivityLocationGuildId = embeddedActivityLocationGuildId(4385).getEmbeddedActivityLocationGuildId(
          currentEmbeddedActivity.location,
        );
        const obj4 = embeddedActivityLocationGuildId(4385);
        embeddedActivityLocationChannelId = embeddedActivityLocationGuildId(4385).getEmbeddedActivityLocationChannelId(
          currentEmbeddedActivity.location,
        );
