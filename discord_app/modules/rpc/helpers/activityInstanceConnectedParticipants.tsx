  ...
  handler() {
    return (arg0) => {
      ...
      if (null == currentEmbeddedActivity) {
        ...
        embeddedActivityLocationGuildId = embeddedActivityLocationGuildId(4351).getEmbeddedActivityLocationGuildId(
          currentEmbeddedActivity.location,
        );
        const obj4 = embeddedActivityLocationGuildId(4351);
        embeddedActivityLocationChannelId = embeddedActivityLocationGuildId(4351).getEmbeddedActivityLocationChannelId(
          currentEmbeddedActivity.location,
        );
