  ...
  handler() {
    return (arg0) => {
      ...
      if (null == currentEmbeddedActivity) {
        ...
        embeddedActivityLocationGuildId = embeddedActivityLocationGuildId(4451).getEmbeddedActivityLocationGuildId(
          currentEmbeddedActivity.location,
        );
        const obj4 = embeddedActivityLocationGuildId(4451);
        embeddedActivityLocationChannelId = embeddedActivityLocationGuildId(4451).getEmbeddedActivityLocationChannelId(
          currentEmbeddedActivity.location,
        );
