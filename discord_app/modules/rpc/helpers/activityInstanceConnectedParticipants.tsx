  ...
  handler() {
    return (arg0) => {
      ...
      if (null == currentEmbeddedActivity) {
        ...
        embeddedActivityLocationGuildId = embeddedActivityLocationGuildId(4266).getEmbeddedActivityLocationGuildId(
          currentEmbeddedActivity.location,
        );
        const obj4 = embeddedActivityLocationGuildId(4266);
        embeddedActivityLocationChannelId = embeddedActivityLocationGuildId(4266).getEmbeddedActivityLocationChannelId(
          currentEmbeddedActivity.location,
        );
