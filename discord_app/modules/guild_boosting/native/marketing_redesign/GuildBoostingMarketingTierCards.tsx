...
import registerAssetDefault from "registerAsset" /* 13026 */;
import registerAssetDefault2 from "registerAsset" /* 13027 */;
...
export default function GuildBoostingMarketingTierCards(guild) {
  ...
  return callback(_require(11733).MarketingCardsScroller, obj);
};