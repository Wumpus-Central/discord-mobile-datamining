// === Module 13132: ProgressBarMarkerInnerContent ===

// Module 13132 (ProgressBarMarkerInnerContent)
import ThemesDefault from "Themes" /* 712 */;
import useThemeDefault from "useTheme" /* 4379 */;
import registerAssetDefault from "registerAsset" /* 13133 */;
import registerAssetDefault2 from "registerAsset" /* 13134 */;
import registerAssetDefault3 from "registerAsset" /* 13135 */;
...
function ProgressBarMarkerInnerContent(arg0) {
  ...
  if (tier === BoostedGuildTiers.NONE) {
    ...
    let tmp18Result = tmp18(tmp3(12215).BoostGemSlashIcon, { size: "xxs", color: "currentColor" });
  } else {
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items2[2] = obj2;
    obj1[0] = items2;
    const items3 = [tmp15(tmp2(4184).View, obj1), , ];
    ...
    items5[1] = tmp15(tmp5(4440).Text, obj6);
    obj4[1] = items5;
  ...
  const hexWithOpacity = sharedValue(4292).hexWithOpacity;
