...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items1[1] = obj4;
    obj3.style = items1;
    const animatedStyle = useReducedMotion(4563).useAnimatedStyle(P);
    ...
    const tmp5Result = useReducedMotion(4563);
    obj9.children = useReducedMotion(4724).getTierName(tier, { useLevels: false });
  ...
  const tmp5Result6 = useReducedMotion(4680);
}
