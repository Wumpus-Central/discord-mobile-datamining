...
import registerAssetDefault from "../../../../../_runtime/13175_registerAsset.js";
import registerAssetDefault2 from "../../../../../_runtime/13176_registerAsset.js";
import registerAssetDefault3 from "../../../../../_runtime/13177_registerAsset.js";
...
function ProgressBarMarkerInnerContent(arg0) {
  ...
  if (tier === BoostedGuildTiers.NONE) {
    ...
    let tmp18Result = tmp18(tmp3(12082).BoostGemSlashIcon, { size: "xxs", color: "currentColor" });
  } else {
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items2[2] = obj2;
    obj1[0] = items2;
    const items3 = [tmp15(tmp2(4186).View, obj1), , ];
    ...
    items5[1] = tmp15(tmp5(4442).Text, obj6);
    obj4[1] = items5;
  ...
  const hexWithOpacity = sharedValue(4294).hexWithOpacity;
