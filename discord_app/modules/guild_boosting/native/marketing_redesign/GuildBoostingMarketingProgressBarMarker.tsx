...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items1[1] = obj4;
    obj3.style = items1;
    const animatedStyle = useReducedMotion(4374).useAnimatedStyle(P);
    ...
    const tmp5Result = useReducedMotion(4374);
    obj9.children = useReducedMotion(4531).getTierName(tier, { useLevels: false });
    items5[1] = closure_7(useReducedMotion(4634).Text, obj9);
  ...
  const tmp5Result6 = useReducedMotion(4487);
};
