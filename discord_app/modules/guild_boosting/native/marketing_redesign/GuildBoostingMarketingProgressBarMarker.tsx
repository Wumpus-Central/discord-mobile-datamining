...
import _modDef13949 from "../../../../../_runtime/metro/13949__.js";
...
export default function ProgressBarMarker(arg0) {
  ...
  if (tier === guild.premiumTier) {
    ...
    items1[1] = obj4;
    obj3.style = items1;
    const animatedStyle = useReducedMotion(4561).useAnimatedStyle(P);
    ...
    const tmp5Result = useReducedMotion(4561);
    obj9.children = useReducedMotion(4722).getTierName(tier, { useLevels: false });
    items5[1] = closure_7(useReducedMotion(4825).Text, obj9);
  ...
  const tmp5Result6 = useReducedMotion(4678);
}
