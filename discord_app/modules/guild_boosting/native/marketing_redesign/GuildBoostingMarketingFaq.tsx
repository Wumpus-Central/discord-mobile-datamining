// === Module 13130: GuildBoostingMarketingFaq ===
...
let obj2 = { wrapper: { alignSelf: "center", marginTop: 50, marginBottom: fn(6816).VISIBILITY_OFFSET, maxWidth: 800, paddingHorizontal: 16, width: "100%" }, content: null, heading: null, list: null, listItem: null, questionWrapper: null, questionWrapperExpanded: null, question: null, questionIcon: null, questionIconExpanded: null, answer: null };
let obj3 = { alignSelf: "center", marginTop: 50, marginBottom: fn(6816).VISIBILITY_OFFSET, maxWidth: 800, paddingHorizontal: 16, width: "100%" };
...
export default function GuildBoostingMarketingFaq() {
  ...
  items[1] = closure_7(View, {
    ...
    children: items1.map((getQuestion, index) => {
      ...
      items1 = [closure_1_7(closure_0(4825).Text, { color: str, style: closure_0.question, variant: "text-md/normal", children: getQuestion.getQuestion() }), ];
      const obj4 = { source: _modDef13131, style: null };
