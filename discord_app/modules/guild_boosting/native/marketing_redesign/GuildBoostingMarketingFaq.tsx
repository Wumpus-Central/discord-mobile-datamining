// === Module 13971: GuildBoostingMarketingFaq ===
...
let obj2 = { wrapper: { alignSelf: "center", marginTop: 50, marginBottom: fn(7731).VISIBILITY_OFFSET, maxWidth: 800, paddingHorizontal: 16, width: "100%" }, content: null, heading: null, list: null, listItem: null, questionWrapper: null, questionWrapperExpanded: null, question: null, questionIcon: null, questionIconExpanded: null, answer: null };
let obj3 = { alignSelf: "center", marginTop: 50, marginBottom: fn(7731).VISIBILITY_OFFSET, maxWidth: 800, paddingHorizontal: 16, width: "100%" };
...
export default function GuildBoostingMarketingFaq() {
  ...
  items[1] = closure_7(View, {
    ...
    children: items1.map((getQuestion, index) => {
      ...
      const obj4 = { source: _modDef13972, style: null };
      ...
      const items3 = [closure_1_8(closure_0(5427).PressableOpacity, obj2), ];
      if (tmp) {
