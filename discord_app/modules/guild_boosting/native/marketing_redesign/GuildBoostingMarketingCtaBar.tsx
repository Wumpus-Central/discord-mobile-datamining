...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  obj21.children = intl2.format(guild(1115).t["pob/cL"], {
    subscriptions: isVisible(4735)(premiumGroupRole.guild.id).total,
  });
  ...
  if (isPremiumResult) {
    ...
    const obj29 = { size: guild(1177).Icon.Sizes.SMALL, source: tmp4(13937), style: tmp.giftIcon };
