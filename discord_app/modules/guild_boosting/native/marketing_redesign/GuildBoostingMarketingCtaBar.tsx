...
fn(4606);
let createStyles = {
  heading: { alignSelf: "center", marginBottom: 24, maxWidth: 395, paddingHorizontal: 16, textAlign: "center" },
  headerContent: { paddingHorizontal: 16, paddingTop: 32, position: "relative", zIndex: 2 },
  guildIcon: null,
  guildIconText: null,
  guildName: null,
  guildBoostCountWrapper: null,
  totalBoostCountWrapper: null,
  guildBoostCountIcon: null,
  guildBoostCount: null,
  guildBoostCurrentUserCountWrapper: null,
  guildBoostCurrentUserCount: null,
  cta: null,
  ctaPrimary: null,
  ctaSecondary: null,
  giftIcon: null,
...
createStyles.totalBoostCountWrapper = {
  display: "flex",
  flexDirection: "row",
...
const __initData = {
  code: "function GuildBoostingMarketingCtaBarTsx1(){const{withTiming,isVisible}=this.__closure;return{opacity:withTiming(isVisible?1:0,{duration:250})};}",
};
size = fn(2);
...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  obj = { withTiming: guild(4607).withTiming, isVisible };
  fn.__closure = obj;
  ...
  obj = { withTiming: guild(4607).withTiming, isVisible: tmp12 };
  fn2.__closure = obj;
  ...
  if (premiumGroupRole === guild(1379).PremiumSubscriptionGroupRole.MEMBER) {
    ...
    let tmp20 = closure_12(tmp4(13568), obj1);
  } else {
    tmp20 = null;
    if (fractionalPremiumInfo.fractionalState !== FractionalPremiumStates.NONE) {
      ...
      tmp20 = closure_12(tmp4(13570), obj2);
    }
  }
  const obj3 = {
    onLayout,
  ...
  tmp4(5038);
  const items4 = [
    isVisible(576).unsafe_rawColors.PREMIUM_TIER_0_HEADER_GRADIENT_1,
    isVisible(576).unsafe_rawColors.PREMIUM_TIER_0_HEADER_GRADIENT_2,
    isVisible(576).unsafe_rawColors.PREMIUM_TIER_0_HEADER_GRADIENT_3,
    isVisible(576).unsafe_rawColors.PREMIUM_TIER_0_HEADER_GRADIENT_4,
    isVisible(576).unsafe_rawColors.PREMIUM_TIER_0_HEADER_GRADIENT_5,
  ];
  obj3.colors = items4;
  ...
  const items6 = [closure_12(guild(4602).Heading, obj6), , , ,];
  ...
  items6[1] = closure_12(isVisible(5635), obj7);
  const obj8 = {
    onPress() {
      window.clearTimeout(ref.current);
      closure_2((arg0) => !arg0);
  ...
  const tmp4Result1 = isVisible(5635);
  const items9 = [
    closure_12(guild(1178).Icon, {
      style: tmp.guildBoostCountIcon,
      source: isVisible(13555),
      color: isVisible(576).unsafe_rawColors.GUILD_BOOSTING_PINK,
      size: guild(1178).Icon.Sizes.SMALL,
    }),
  ];
  const obj13 = {
    style: tmp.guildBoostCount,
  ...
  obj13.children = intl2.format(guild(1114).t["pob/cL"], {
    subscriptions: isVisible(4515)(premiumGroupRole.guild.id).total,
  });
  items9[1] = closure_12(guild(4602).Text, obj13);
  obj11.children = items9;
  const items10 = [closure_13(isVisible(4343).View, obj11)];
  ...
  obj14.children = closure_12(guild(4602).Text, obj15);
  items10[1] = closure_12(isVisible(4343).View, obj14);
  obj10.children = items10;
  items7[1] = closure_13(memo, obj10);
  obj8.children = items7;
  items6[2] = closure_13(guild(5174).PressableOpacity, obj8);
  items6[3] = tmp20;
  const obj16 = {
    styles: null,
    guild,
    previousGuildSubscriptionSlot,
    analyticsSection: constants3.HEADER,
    fractionalPremiumState: fractionalPremiumInfo.fractionalState,
    premiumGroupRole,
    intent,
    onResult,
  };
  ...
  items6[4] = closure_12(isVisible(7475), obj16);
  ...
  if (isPremiumResult) {
    ...
    obj20.text = intl5.string(guild(1114).t["8MYSQw"]);
    ...
    const obj21 = { size: guild(1178).Icon.Sizes.SMALL, source: tmp4(13634), style: tmp.giftIcon };
    obj20.icon = closure_12(guild(1178).Icon, obj21);
    let obj22 = obj20;
  } else {
    obj22 = { variant: "secondary", text: null, onPress: null, grow: true };
    const intl4 = guild(1114).intl;
    obj22.text = intl4.string(guild(1114).t.pj0XBN);
  ...
  obj19.children = closure_12(guild(5026).Button, obj22);
  items14[1] = closure_12(memo, obj19);
  obj23.children = items14;
  return closure_13(memo, obj23);
}
