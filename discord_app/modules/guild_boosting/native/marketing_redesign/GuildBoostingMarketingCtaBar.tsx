...
export default function GuildBoostingMarketingCtaBar(premiumGroupRole) {
  ...
  obj = { withTiming: guild(4606).withTiming, isVisible };
  fn.__closure = obj;
  ...
  obj = { withTiming: guild(4606).withTiming, isVisible: tmp12 };
  fn2.__closure = obj;
  ...
  if (premiumGroupRole === guild(1379).PremiumSubscriptionGroupRole.MEMBER) {
    ...
    let tmp20 = closure_12(tmp4(13591), obj1);
  } else {
    tmp20 = null;
    if (fractionalPremiumInfo.fractionalState !== FractionalPremiumStates.NONE) {
      ...
      tmp20 = closure_12(tmp4(13593), obj2);
    }
  }
  const obj3 = {
    onLayout,
  ...
  const items6 = [closure_12(guild(4601).Heading, obj6), , , ,];
  ...
  items6[1] = closure_12(isVisible(5634), obj7);
  const obj8 = {
    onPress() {
      window.clearTimeout(ref.current);
      closure_2((arg0) => !arg0);
  ...
  obj13.children = intl2.format(guild(1114).t["pob/cL"], {
    subscriptions: isVisible(4514)(premiumGroupRole.guild.id).total,
  });
  items9[1] = closure_12(guild(4601).Text, obj13);
  obj11.children = items9;
  const items10 = [closure_13(isVisible(4341).View, obj11)];
  ...
  obj14.children = closure_12(guild(4601).Text, obj15);
  items10[1] = closure_12(isVisible(4341).View, obj14);
  obj10.children = items10;
  items7[1] = closure_13(memo, obj10);
  obj8.children = items7;
  items6[2] = closure_13(guild(5173).PressableOpacity, obj8);
  items6[3] = tmp20;
  const obj16 = {
    styles: null,
    guild,
  ...
  items6[4] = closure_12(isVisible(7454), obj16);
  ...
  if (isPremiumResult) {
    ...
    const obj21 = { size: guild(1178).Icon.Sizes.SMALL, source: tmp4(13657), style: tmp.giftIcon };
  ...
  obj19.children = closure_12(guild(5025).Button, obj22);
