...
export default function GuildBoostingMarketingOverview(guildId) {
  ...
  const effect = obj3.useEffect(() => () => {
    ...
    const obj = { type: constants2.PREMIUM_GUILD_USER_MODAL, location_stack, guild_id, duration_open_ms: Date.now() - closure_1_9 };
  ...
  if (null != stateFromStores) {
    ...
    obj = {
      ...
      onScroll(nativeEvent) {
          ...
          if (tmp3) {
            const obj = { type: constants2.PREMIUM_GUILD_USER_MODAL, location_stack: analyticsLocations, guild_id: stateFromStores.id };
    ...
    const obj4 = { guild: stateFromStores, previousGuildSubscriptionSlot: first, isVisible: tmp9[0], fractionalPremiumState: tmp12.fractionalState, premiumGroupRole: UNSPECIFIED };
