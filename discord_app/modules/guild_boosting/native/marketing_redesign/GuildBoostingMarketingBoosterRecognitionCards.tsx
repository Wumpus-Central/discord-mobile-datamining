...
function Card(arg0) {
  ...
  obj = { size: "lg", color: Themes.unsafe_rawColors.GUILD_BOOSTING_PINK };
  ({ IconComponent, children } = arg0);
  obj[1] = callback(IconComponent, obj);
  const items = [callback(View, obj), callback(Text /* Text */.Text, { style: tmp.description, variant: "text-sm/medium", children })];
  obj[1] = items;
...
export default function GuildBoostingMarketingBoosterRecognitionCards() {
  ...
  obj[2] = intl.string(getSystemLocale /* getSystemLocale */.t.IzKs3o);
  const items = [callback(Text /* Text */.Heading, obj), ];
  obj = { style: tmp.recognitionCardsContainer, children: null };
  const obj1 = { icon: registerAsset, IconComponent: BoostGemIcon /* BoostGemIcon */.BoostGemIcon, children: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj1[2] = intl2.string(getSystemLocale /* getSystemLocale */.t.TZigSO);
  const items1 = [callback(Card, obj1), , , ];
  const obj2 = { icon: registerAsset, IconComponent: BoostTier3Icon /* BoostTier3Icon */.BoostTier3Icon, children: null };
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj2[2] = intl3.string(getSystemLocale /* getSystemLocale */.t.hjQuV2);
  items1[1] = callback(Card, obj2);
  const obj3 = { icon: registerAsset, IconComponent: ShieldUserIcon /* ShieldUserIcon */.ShieldUserIcon, children: null };
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj3[2] = intl4.string(getSystemLocale /* getSystemLocale */.t["2RUcaM"]);
  items1[2] = callback(Card, obj3);
  const obj4 = { icon: registerAsset, IconComponent: HeartIcon /* HeartIcon */.HeartIcon, children: null };
  const intl5 = getSystemLocale /* getSystemLocale */.intl;
  obj4[2] = intl5.string(getSystemLocale /* getSystemLocale */.t.bJoZKV);
