...
import createCacheKey from "createCacheKey";
import { registerAsset } from "../../../../../_runtime/13029_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/13030_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/13031_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/13032_registerAsset.js";
...
export default function GuildBoostingMarketingBoosterRecognitionCards() {
  ...
  const obj1 = { icon: registerAsset, IconComponent: BoostGemIcon.BoostGemIcon, children: null };
  const intl2 = getSystemLocale.intl;
  obj1[2] = intl2.string(getSystemLocale.t.TZigSO);
  const items1 = [callback(Card, obj1), , , ];
  const obj2 = { icon: registerAsset, IconComponent: BoostTier3Icon.BoostTier3Icon, children: null };
  const intl3 = getSystemLocale.intl;
  obj2[2] = intl3.string(getSystemLocale.t.hjQuV2);
  items1[1] = callback(Card, obj2);
  const obj3 = { icon: registerAsset, IconComponent: ShieldUserIcon.ShieldUserIcon, children: null };
  const intl4 = getSystemLocale.intl;
  obj3[2] = intl4.string(getSystemLocale.t["2RUcaM"]);
  items1[2] = callback(Card, obj3);
  const obj4 = { icon: registerAsset, IconComponent: HeartIcon.HeartIcon, children: null };
