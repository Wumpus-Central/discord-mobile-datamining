...
export default function GuildBoostingMarketingPersistentCta(arg0) {
  ...
  obj = { useReducedMotion: stateFromStores, VISIBILITY_OFFSET: 120, withSpring: isVisible(4974).withSpring, isVisible, SPRING_CONFIG };
  fn.__closure = obj;
  ...
  const items3 = [closure_6(stateFromStores(5584), obj4), closure_6(isVisible(4556).Text, { style: tmp.guildName, variant: "text-md/bold", lineClamp: 1, children: guild.name })];
  obj3.children = items3;
  const items4 = [closure_7(View, obj3), ];
  const obj6 = { style: tmp.buttonContainer, children: closure_6(stateFromStores(7402), { guild, previousGuildSubscriptionSlot, useShortenedCTA: true, styles: tmp.button, analyticsSection: AnalyticsSections.PREMIUM_GUILD_USER_MODAL_FLOATING_CTA_BAR, fractionalPremiumState, premiumGroupRole }) };
