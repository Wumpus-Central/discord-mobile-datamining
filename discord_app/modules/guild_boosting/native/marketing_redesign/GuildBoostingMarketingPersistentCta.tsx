...
export default function GuildBoostingMarketingPersistentCta(arg0) {
  ...
  obj = { useReducedMotion: stateFromStores, VISIBILITY_OFFSET: 120, withSpring: isVisible(5025).withSpring, isVisible, SPRING_CONFIG };
  fn.__closure = obj;
  ...
  obj4.size = isVisible(5635).GuildIconSizes.LARGE;
  const items3 = [closure_6(stateFromStores(5635), obj4), closure_6(isVisible(4602).Text, { style: tmp.guildName, variant: "text-md/bold", lineClamp: 1, children: guild.name })];
  obj3.children = items3;
  const items4 = [closure_7(View, obj3), ];
  const obj6 = { style: tmp.buttonContainer, children: closure_6(stateFromStores(7475), { guild, previousGuildSubscriptionSlot, useShortenedCTA: true, styles: tmp.button, analyticsSection: AnalyticsSections.PREMIUM_GUILD_USER_MODAL_FLOATING_CTA_BAR, fractionalPremiumState, premiumGroupRole }) };
  items4[1] = closure_6(View, obj6);
  obj2.children = items4;
  obj1.children = closure_7(View, obj2);
  obj.children = closure_6(tmp4, obj1);
  return closure_6(stateFromStores(4343).View, obj);
};
