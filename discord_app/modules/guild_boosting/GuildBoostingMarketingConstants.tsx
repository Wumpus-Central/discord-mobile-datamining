...
obj = {
  ...
  getCopy() {
    const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t["v+MIfo"], { numSoundboardSlots: BoostedGuildFeatures[BoostedGuildTiers.TIER_1].limits.soundboardSounds });
  },
  isNew: true
};
items[1] = obj;
...
items[3] = {
  ...
  getCopy() {
    const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["WH+OeI"]);
  }
};
obj[1] = items;
const items1 = [obj, , ];
...
items2[1] = {
  ...
  getCopy() {
    ...
    obj[0] = intl2.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.M6qV8j);
...
items3[1] = {
  ...
  getCopy() {
    ...
    const obj = { uploadSizeLimit: null };
    const intl2 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    obj[0] = intl2.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.yMOW8D);
    return intl.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.aFRl53, obj);
  }
};
const obj10 = {
...
items3[2] = {
  ...
  getCopy() {
    const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.Tsljqo);
  }
};
const obj11 = {
  perkIcon: require("getGuildTierFromGuild").PerkIcons.AUDIO,
...
items3[3] = {
  ...
  getCopy() {
    const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.nRKlmC);
  }
};
const obj12 = {
  perkIcon: require("getGuildTierFromGuild").PerkIcons.ANIMATED,
...
items3[4] = {
  ...
  getCopy() {
    const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
    return intl.formatToPlainString(require("../../intl/index.native.tsx") /* getSystemLocale */.t.hsZ88d, { numStageSeats: closure_3 });
  }
};
obj8[1] = items3;
items1[2] = obj8;
