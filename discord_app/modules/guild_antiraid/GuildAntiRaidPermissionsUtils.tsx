...
export const useCanReportRaid = function useCanReportRaid(guild) {
  ...
  if (hasDetectedActivityResult) {
    hasDetectedActivityResult = tmp(7932).hasDetectedActivity(stateFromStores1);
    const tmpResult = tmp(7932);
  }
...
export const useShowMentionRaidLimitUpsell = function useShowMentionRaidLimitUpsell(id) {
  ...
  const obj2 = _require("../guild_automod/ExperimentUtils.tsx");
  return _require("../guild_automod/ExperimentUtils.tsx").useIsMentionRaidExperimentEnabled(id, false) && stateFromStores;
};