...
export const getTimeframes = () => {
  ...
  obj[2] = intl.string(getSystemLocale /* getSystemLocale */.t["GA/d4I"]);
  const items = [obj, , , , , ];
  obj = { id: "2", value: 2, label: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj[2] = intl2.string(getSystemLocale /* getSystemLocale */.t["+rHFej"]);
  items[1] = obj;
  obj = { id: "4", value: 4, label: null };
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj[2] = intl3.string(getSystemLocale /* getSystemLocale */.t["5CNt/M"]);
  items[2] = obj;
  const obj1 = { id: "6", value: 6, label: null };
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj1[2] = intl4.string(getSystemLocale /* getSystemLocale */.t.oQ4PNE);
  items[3] = obj1;
  const obj2 = { id: "12", value: 12, label: null };
  const intl5 = getSystemLocale /* getSystemLocale */.intl;
  obj2[2] = intl5.string(getSystemLocale /* getSystemLocale */.t.LOQ0j6);
  items[4] = obj2;
  const obj3 = { id: "24", value: 24, label: null };
  const intl6 = getSystemLocale /* getSystemLocale */.intl;
  obj3[2] = intl6.string(getSystemLocale /* getSystemLocale */.t["W0+LsV"]);
  items[5] = obj3;
  return items;
};
