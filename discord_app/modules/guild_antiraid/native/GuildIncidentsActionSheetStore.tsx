...
const obj = keys.create(() => ({
  time: DEFAULT_LOCKDOWN_DURATION,
  pauseInvites: true,
  pauseDms: true,
...
export const setTime = function setTime(arg0) {
  ...
  require("../../../../discord_common/js/shared/utils/ReactBatchUpdates.native.tsx").batchUpdates(() =>
    closure_1_3.setState({ time: closure_0, hasTimeChanges: true }),
  );
};
export const setInitialTime = function setInitialTime(arg0) {
  const _require = arg0;
  require("../../../../discord_common/js/shared/utils/ReactBatchUpdates.native.tsx").batchUpdates(() =>
    closure_1_3.setState({ time: closure_0, hasTimeChanges: false }),
  );
};
export const setPauseInvites = function setPauseInvites(arg0) {
  const _require = arg0;
  require("../../../../discord_common/js/shared/utils/ReactBatchUpdates.native.tsx").batchUpdates(() =>
    closure_1_3.setState({ pauseInvites: closure_0 }),
  );
};
export const setPauseDms = function setPauseDms(arg0) {
  const _require = arg0;
  require("../../../../discord_common/js/shared/utils/ReactBatchUpdates.native.tsx").batchUpdates(() =>
    closure_1_3.setState({ pauseDms: closure_0 }),
  );
};
