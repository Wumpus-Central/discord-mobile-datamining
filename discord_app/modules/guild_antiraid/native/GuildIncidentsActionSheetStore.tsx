...
export const setTime = function setTime(arg0) {
  const _require = arg0;
  _batchUpdates.batchUpdates(() => closure_1_3.setState({ time: closure_0, hasTimeChanges: true }));
};
export const setInitialTime = function setInitialTime(arg0) {
  const _require = arg0;
  _batchUpdates.batchUpdates(() => closure_1_3.setState({ time: closure_0, hasTimeChanges: false }));
};
export const setPauseInvites = function setPauseInvites(arg0) {
  const _require = arg0;
  _batchUpdates.batchUpdates(() => closure_1_3.setState({ pauseInvites: closure_0 }));
};
export const setPauseDms = function setPauseDms(arg0) {
  const _require = arg0;
  _batchUpdates.batchUpdates(() => closure_1_3.setState({ pauseDms: closure_0 }));
};
