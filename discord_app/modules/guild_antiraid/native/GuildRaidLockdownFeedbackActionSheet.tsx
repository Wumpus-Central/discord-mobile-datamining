...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  obj5.header = closure_6(guildId(7163).BottomSheetTitleHeader, obj6);
  ...
  if (hasItem) {
    ...
    hasItem = closure_6(tmp5(7099).TextArea, obj9);
  }
  items1[1] = hasItem;
  const obj10 = {
    onPress() {
  ...
  items1[2] = closure_6(guildId(4989).Button, obj10);
  obj7.children = items1;
  obj5.children = closure_7(tmp9, obj7);
  return closure_6(guildId(7211).ActionSheet, obj5);
}
