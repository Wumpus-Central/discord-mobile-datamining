...
export default function GuildRaidLockdownFeedbackActionSheet(guildId) {
  ...
  if (hasItem) {
    ...
    hasItem = closure_6(tmp5(7325).TextArea, obj11);
  }
  items1[1] = hasItem;
  const obj12 = {
    onPress() {
      AppAnalyticsUtils.trackWithMetadata(AnalyticEvents.GUILD_RAID_LOCKDOWN_FEEDBACK, {
        raid_lockdown_feedback_type,
        raid_lockdown_feedback_other_reason: first1,
        guild_id: guildId,
      });
