// discord_app/modules/tti_analytics/native/navigation/debug/NavigationTTIRegionDebugOverlay.tsx
import nativeDefault from "../../../../../../discord_common/js/packages/tokens/native.tsx";
import Text_Text from "../../../../../design/components/Text/native/Text.tsx";
import NavigationSpanTrackerDefault from "../NavigationSpanTracker.tsx";
import NavigationTTIDebugFreeze from "NavigationTTIDebugFreeze.tsx";
import NavigationTTIRegionDebugState from "NavigationTTIRegionDebugState.tsx";
...
function NavigationTTIDebugFreezeControl(arg0) {
  ...
  let obj = {
    ...
    onPress() {
      ...
      if (null != closure_1_0) {
        activeTraceId = NavigationSpanTrackerDefault.getActiveTraceId(
          closure_1_0.definition,
          closure_1_0.navigationKey,
        );
      }
      if (null == name) {
      ...
      if (null == tmp8) {
        ...
        let navigationKey;
        if (closure_1_0 != null) {
          navigationKey = closure_1_0.navigationKey;
        }
  ...
  obj.children = closure_7(Text_Text.Text, {
...
let obj2 = {
  ...
  excludedOutline: null,
  mixedOutline: null,
  violationOutline: null,
  badge: null,
  expandedBadge: null,
  badgeText: null,
  includedBadge: null,
...
obj3.borderWidth = 2;
obj2.outline = obj3;
obj2.includedOutline = {
  borderColor: nativeDefault.colors.STATUS_POSITIVE,
...
obj2.violationOutline = {
  borderColor: nativeDefault.colors.STATUS_DANGER,
...
let result = size.fileFinishedImporting(
  "modules/tti_analytics/native/navigation/debug/NavigationTTIRegionDebugOverlay.tsx",
);
...
export const NavigationTTIRegionDebugOverlay = function NavigationTTIRegionDebugOverlay(name) {
  ...
  const syncExternalStore = noop.useSyncExternalStore(
    name(16942).subscribeNavigationTTIDebugFreezeTarget,
    name(16942).getNavigationTTIDebugFreezeTarget,
    name(16942).getNavigationTTIDebugFreezeTarget,
  );
  closure_129_0 = name;
  ...
  const callback1 = noop.useCallback(() => {
    let activeTraceId = null;
    if (null != closure_3) {
      activeTraceId = NavigationSpanTrackerDefault.getActiveTraceId(closure_3.definition, closure_3.navigationKey);
    }
    let str = "none";
  ...
  if (!tmp6) {
      ...
      fn = () => {
        if (closure_3) {
          ...
          if (null != navTTISurface) {
            activeTraceId = NavigationSpanTrackerDefault.getActiveTraceId(
              navTTISurface.definition,
              navTTISurface.navigationKey,
            );
          }
          const obj4 = { armedDuringTraceId: activeTraceId, destinationKey: null };
          let navigationKey;
    ...
    if (0 === hierarchyDepth) {
      ...
      tmp44Result = closure_7(NavigationTTIDebugFreezeControl, obj7);
    }
