// discord_app/modules/tti_analytics/native/navigation/debug/NavigationTTIRegionHierarchy.tsx
import LoggerDefault from "../../../../debug/Logger.tsx";
import _slicedToArray from "../../../../../../_runtime/metro/00032__.js";
import noop from "../../../../../../_runtime/metro/00019__.js";

function getNavigationTTIRegionHierarchyViolation(
  tracking,
  descendantTracking,
  hasChildren,
  includedDescendants,
...
let result = size.fileFinishedImporting(
  "modules/tti_analytics/native/navigation/debug/NavigationTTIRegionHierarchy.tsx",
);
...
export const useNavigationTTIRegionHierarchy = function useNavigationTTIRegionHierarchy(name) {
  ...
  violation = null;
  if (tmp4[0]) {
    violation = getNavigationTTIRegionHierarchyViolation(
      tracking,
      descendantTracking,
      hasChildren,
      includedDescendants,
