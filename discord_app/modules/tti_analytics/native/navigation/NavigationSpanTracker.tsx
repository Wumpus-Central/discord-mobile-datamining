...
prototype["flush"] = function flush(arg0) {
  ...
  if (null != str) {
    ...
    if ("deadline_exceeded" === arg0) {
      let INTERRUPTED = require("NavigationSpanTypes.tsx").NavigationSpanStatus.DEADLINE_EXCEEDED;
    } else {
      INTERRUPTED = require("NavigationSpanTypes.tsx").NavigationSpanStatus.INTERRUPTED;
    }
