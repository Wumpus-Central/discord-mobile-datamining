...
export const NATIVE_REQUIRED_ASSETS_MISC = {
  ...
  PoopDark: _modDef18029,
  PoopLight: _modDef18030,
  RoleSubscriptionBadge: _modDef18031,
  RoleSubscriptionLanyard: _modDef18032,
  RoleSubscriptionPurchaseCard: _modDef18033,
  SummaryIndicatorEnd: _modDef18034,
  SummaryIndicatorStart: _modDef18035,
};
