...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj[1] = onClose(5223).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(5223);
    obj1[1] = onClose(5223).getHeaderBackButton(onClose);
    ...
    return callback2(onClose(5650).Navigator, obj2);
  }
};