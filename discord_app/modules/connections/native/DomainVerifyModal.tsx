...
function DomainScreen(onClose) {
  ...
  function verify() {
    ...
    const postResult = HTTP.post({
      url: closure_1_6.CONNECTION(closure_1_7.DOMAIN, first),
      body: {},
      rejectWithError: false,
    });
    const nextPromise = HTTP.post({
      url: closure_1_6.CONNECTION(closure_1_7.DOMAIN, first),
      body: {},
      rejectWithError: false,
    }).then(() => {
    ...
    HTTP.post({ url: closure_1_6.CONNECTION(closure_1_7.DOMAIN, first), body: {}, rejectWithError: false })
      .then(() => {
        callback();
      })
      .catch((body) => {
...
function DNSProofScreen(proof) {
  ...
  items1[3] = callback2(require(proof[10]).Text, {
  ...
  items1[5] = callback2(require(proof[10]).Text, {
    variant: "text-md/normal",
    selectable: true,
    style: tmp.code,
    children: proof,
  ...
  obj10[2] = function onPress() {
    ...
    const postResult = HTTP.post({
      url: closure_1_6.CONNECTION(closure_1_7.DOMAIN, domain),
      body: {},
      rejectWithError: false,
    });
    const nextPromise = HTTP.post({
    ...
    HTTP.post({ url: closure_1_6.CONNECTION(closure_1_7.DOMAIN, domain), body: {}, rejectWithError: false })
      .then(() => {
        callback();
      })
      .catch((body) => {
