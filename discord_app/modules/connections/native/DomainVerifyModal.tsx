...
function HTTPProofScreen(children) {
  ...
  const items1 = [callback2(require(4251) /* Text */.Text, obj2), , , ];
  const obj3 = { variant: "text-md/normal", selectable: true, style: tmp.code, children: null };
  let obj6 = require(9186) /* EXAMPLE_DOMAIN */;
  obj3[3] = obj6.getHttpName(domain);
  items1[1] = callback2(require(4251) /* Text */.Text, obj3);
  const obj4 = { variant: "text-md/normal", children: null };
  const intl3 = require(1236) /* getSystemLocale */.intl;
  obj4[1] = intl3.string(require(1236) /* getSystemLocale */.t.PVLriT);
  items1[2] = callback2(require(4251) /* Text */.Text, obj4);
  items1[3] = callback2(require(4251) /* Text */.Text, { variant: "text-md/normal", selectable: true, style: tmp.code, children: children.proof });
  obj1[1] = items1;
  ...
  obj7[1] = callback2(require(4666) /* Button */.Button, obj8);
  ...
  obj9[1] = callback2(require(4666) /* Button */.Button, obj10);
  items[4] = callback2(View, obj9);
  obj[2] = items;
  return callback3(require(5243) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj);
}
...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj[1] = onClose(5209).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(5209);
    obj1[1] = onClose(5209).getHeaderBackButton(onClose);
    ...
    return callback2(onClose(5636).Navigator, obj2);
  }
};