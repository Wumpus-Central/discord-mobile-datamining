...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj[1] = onClose(5270).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(5270);
    obj1[1] = onClose(5270).getHeaderBackButton(onClose);
    ...
    return callback2(onClose(5783).Navigator, obj2);
  }
};