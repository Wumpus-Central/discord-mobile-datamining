...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj.headerLeft = onClose(5674).getHeaderBackButton(onClose);
    ...
    obj1.headerLeft = onClose(5674).getHeaderBackButton(onClose);
    ...
    return closure_8(onClose(7052).Navigator, obj2);
  }
};