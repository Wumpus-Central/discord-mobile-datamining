...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj[1] = onClose(5253).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(5253);
    obj1[1] = onClose(5253).getHeaderBackButton(onClose);
    ...
    return callback2(onClose(5704).Navigator, obj2);
  }
};