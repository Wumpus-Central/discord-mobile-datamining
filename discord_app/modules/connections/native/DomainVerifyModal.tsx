...
import EXAMPLE_DOMAIN from "EXAMPLE_DOMAIN" /* 9848 */;
...
export default function DomainVerifyModal(arg0) {
  if (arg0 == null) {
    ...
    obj[1] = onClose(6345).getHeaderBackButton(onClose);
    ...
    const obj5 = onClose(6345);
    obj1[1] = onClose(6345).getHeaderBackButton(onClose);
    ...
    return callback2(onClose(6343).Navigator, obj2);
  }
};