...
export default function GuildRoleConnectionsScreen(guildId) {
  ...
  if (null == stateFromStores1) {
    ...
    obj3[1] = found.map((children) => {
      ...
      const items1 = [tmp12, closure_1_14(onCloseModal(7182), { style: found.verifiedRoleIcon, guildId: id, role: children, size: 24 }), closure_1_14(guildId(4734).Text, { variant: "text-md/medium", color: "mobile-text-heading-primary", lineClamp: 1, style: found.verifiedRoleName, children: children.name }), ];
