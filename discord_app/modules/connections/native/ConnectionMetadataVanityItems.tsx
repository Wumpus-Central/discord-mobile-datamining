...
function VanityItem(style) {
  ...
  const items1 = [timestampProducer(native.Icon, obj), timestampProducer(Text_Text.Text, { variant: "text-xs/normal", color: "text-muted", style, children: label })];
  obj.children = items1;
