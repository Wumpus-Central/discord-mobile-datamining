...
import closure_10 from "_getSystemLocale";
...
function PlatformIcon(platformType) {
  ...
  const source = obj2.makeSource(require(4131) /* AccessibilityAnnouncer */.isThemeLight(tmp3) ? icon.lightPNG : icon.darkPNG);
...
function ChannelName(channel) {
  ...
  const items1 = [tmp8, ];
  const tmp5 = importDefault(4475)(channel);
  const tmp6 = closure_30;
  const tmp7 = closure_8;
  items1[1] = callback2(require(4281) /* Text */.Text, { variant: "heading-lg/semibold", color: "text-default", style: tmp.channelNameText, lineClamp: 1, children: importDefault(4475)(channel) });
  obj[1] = items1;
...
function ConnectionsCheck(result) {
  ...
  if (connectionType === closure_20) {
    ...
    if (null != formatResult) {
      ...
      obj2[3] = formatResult;
      tmp21Result = closure_29(require(4281) /* Text */.Text, obj2);
...
function IdentityConnectionsCheckGroup(eligibilityState) {
  ...
  if (!officialApplicationIds.includes(str)) {
    ...
    if (null != memo) {
      const obj4 = { style: null, user: null, size: null, guildId: "add" };
      obj4[0] = tmp.appIcon;
      obj4[1] = memo;
...
function ConnectionsChecks(eligibilityStatesGroups) {
  ...
  ({ onPlatformIdentityAuthorize: apply, initialAttemptedPlatformType, initialAttemptedApplicationId } = eligibilityStatesGroups);
  let React;
  c6 = undefined;
  c7 = undefined;
  c8 = undefined;
  ...
  first1 = tmpResult[0];
  ensureGuildLoaded = tmpResult[1];
  let items = [eligibilityStatesGroups];
  memo = obj.useMemo(() => outer1_1(outer1_2[32]).flatten(eligibilityStatesGroups), items);
  let items1 = [memo];
  memo1 = obj.useMemo(() => outer1_1(outer1_2[32]).groupBy(memo, (application_id) => {
    let str = "";
  ...
  getUncachedChannelPermissions = eligibilityStatesGroups(3989).useToken(importDefault(712).unsafe_rawColors.GREEN_330);
  obj = { children: null };
  ...
  obj[0] = sorted.map((str) => {
    if (str.startsWith("" + outer1_20 + ":")) {
      if (null != arr[0]) {
        ...
        obj[2] = apply;
        return outer1_29(outer1_36, obj, str);
      }
    }
    ...
    let tmp11 = null;
    if (null != bot) {
      tmp11 = new createdAt(application.bot);
    }
    ...
    if (tmp3) {
      obj = { source: null, style: null };
      obj[0] = tmp5(tmp6[30]);
      obj[1] = getAvatarURL.connectionsChecksGroupCheckmark;
      ...
      obj2[0] = tmp5(tmp6[31]);
      obj2[1] = getAvatarURL.connectionsChecksGroupCaret;
    ...
    if (null != value) {
      ...
      obj9[0] = value.type;
      tmp24Result1 = tmp24(outer1_33, obj9);
    }
    items1[1] = tmp24Result1;
    let tmp24Result2 = null;
    if (null != tmp11) {
      const obj10 = { style: null, user: null, size: null, guildId: "add" };
    ...
    const obj11 = { style: getAvatarURL.connectionsChecksGroupTextContainer, children: null };
    const obj12 = { style: getAvatarURL.connectionsChecksGroupTextNameContainer, children: null };
    let name;
    if (value != null) {
      name = value.name;
    }
    ...
    const items2 = [tmp24(eligibilityStatesGroups(outer1_2[24]).Text, { variant: "text-md/medium", color: "mobile-text-heading-primary", children: name }), tmp24Result, ];
    ...
    obj11[1] = items3;
    items1[3] = outer1_30(c8, obj11);
    items1[4] = tmp22Result;
    obj6[4] = items1;
    return outer1_30(c7, obj6, str);
  });
...
function ConnectedUserAccountOptions(account) {
  ...
  if (set.has(account.type)) {
    ...
    tmp12 = callback2(account(7777).FormSwitchRow, obj);
  }
  let tmp15;
  if (set2.has(account.type)) {
    obj = { label: null, value: null, onValueChange: null };
    const intl2 = account(1236).intl;
    const obj1 = { platform: null };
    obj1[0] = value.name;
    ...
    tmp15 = callback2(account(7777).FormSwitchRow, obj);
  }
  let tmp18;
  if (true === value.hasMetadata) {
    ...
    tmp18 = callback2(account(7777).FormSwitchRow, obj2);
  }
  ...
  const items = [callback2(account(7777).FormSwitchRow, obj4), tmp18, tmp15, tmp12];
  obj3[1] = items;
  return callback3(closure_8, obj3);
}
({ ActivityIndicator: closure_6, Pressable: error, View: metroImportAll } = get_ActivityIndicator);
...
createCacheKey = { flexDirection: "row", borderColor: require("Themes").colors.BORDER_SUBTLE, borderWidth: 2, borderRadius: require("Themes").radii.md, paddingHorizontal: 16, paddingVertical: 20, marginBottom: 16, width: "100%", alignItems: "center", position: "relative" };
createCacheKey[2] = createCacheKey;
createCacheKey[3] = { borderColor: require("Themes").colors.BACKGROUND_BASE_LOWEST, backgroundColor: require("Themes").colors.BACKGROUND_BASE_LOWEST };
let obj1 = { borderColor: require("Themes").colors.BACKGROUND_BASE_LOWEST, backgroundColor: require("Themes").colors.BACKGROUND_BASE_LOWEST };
createCacheKey[4] = { backgroundColor: require("Themes").colors.BORDER_SUBTLE };
let obj2 = { backgroundColor: require("Themes").colors.BORDER_SUBTLE };
createCacheKey[5] = { paddingVertical: 4, paddingHorizontal: 12, borderRadius: require("Themes").radii.md, backgroundColor: require("Themes").colors.BACKGROUND_FEEDBACK_CRITICAL, position: "absolute", top: -8, right: 20 };
createCacheKey[6] = { flex: 1 };
createCacheKey[7] = { flexDirection: "row", alignItems: "center" };
let obj3 = { paddingVertical: 4, paddingHorizontal: 12, borderRadius: require("Themes").radii.md, backgroundColor: require("Themes").colors.BACKGROUND_FEEDBACK_CRITICAL, position: "absolute", top: -8, right: 20 };
createCacheKey[8] = { marginLeft: 4, tintColor: require("Themes").colors.TEXT_FEEDBACK_WARNING };
let obj4 = { marginLeft: 4, tintColor: require("Themes").colors.TEXT_FEEDBACK_WARNING };
createCacheKey[9] = { tintColor: require("Themes").colors.TEXT_FEEDBACK_POSITIVE, width: 24, height: 24 };
let obj5 = { tintColor: require("Themes").colors.TEXT_FEEDBACK_POSITIVE, width: 24, height: 24 };
createCacheKey[10] = { tintColor: require("Themes").colors.INTERACTIVE_TEXT_DEFAULT, width: 24, height: 24 };
...
let obj6 = { tintColor: require("Themes").colors.INTERACTIVE_TEXT_DEFAULT, width: 24, height: 24 };
createCacheKey[14] = { tintColor: require("Themes").colors.TEXT_MUTED, marginRight: 8, width: 24, height: 24 };
...
let obj7 = { tintColor: require("Themes").colors.TEXT_MUTED, marginRight: 8, width: 24, height: 24 };
createCacheKey[21] = { marginTop: 8, borderRadius: require("Themes").radii.xs, borderWidth: 1, borderColor: require("Themes").colors.BORDER_SUBTLE };
createCacheKey[22] = { marginTop: 16, width: "100%" };
let obj8 = { marginTop: 8, borderRadius: require("Themes").radii.xs, borderWidth: 1, borderColor: require("Themes").colors.BORDER_SUBTLE };
createCacheKey[23] = { marginTop: 8, borderWidth: 1, borderColor: require("Themes").colors.BORDER_SUBTLE, borderRadius: require("Themes").radii.xs, padding: 8, flexDirection: "column" };
let obj9 = { marginTop: 8, borderWidth: 1, borderColor: require("Themes").colors.BORDER_SUBTLE, borderRadius: require("Themes").radii.xs, padding: 8, flexDirection: "column" };
createCacheKey[24] = { flexDirection: "row", alignItems: "center", backgroundColor: require("Themes").colors.BACKGROUND_BASE_LOWEST, paddingVertical: 12, paddingHorizontal: 8, borderTopStartRadius: 4, borderTopEndRadius: 4, marginTop: 16 };
createCacheKey[25] = { overflow: "hidden", marginRight: 24 };
createCacheKey[26] = { marginRight: 8 };
let obj10 = { flexDirection: "row", alignItems: "center", backgroundColor: require("Themes").colors.BACKGROUND_BASE_LOWEST, paddingVertical: 12, paddingHorizontal: 8, borderTopStartRadius: 4, borderTopEndRadius: 4, marginTop: 16 };
createCacheKey[27] = { flexDirection: "column", backgroundColor: require("Themes").colors.BACKGROUND_MOD_NORMAL, padding: 16, borderBottomStartRadius: 4, borderBottomEndRadius: 4, marginBottom: 24 };
...
let obj11 = { flexDirection: "column", backgroundColor: require("Themes").colors.BACKGROUND_MOD_NORMAL, padding: 16, borderBottomStartRadius: 4, borderBottomEndRadius: 4, marginBottom: 24 };
let result = require("noop").fileFinishedImporting("modules/connections/native/GuildRoleConnectionsConnectAccountsActionSheet.tsx");
class GuildRoleConnectionsConnectAccountsActionSheet {
  constructor(arg0) {
    ...
    ({ initialAttemptedApplicationId: ConnectedUserAccountOptions, onCloseModal } = global);
    ...
    tmp = Fragment();
    tmp2 = Fragment;
    tmp3 = onCloseModal(CHECKS_REQUIRED.useState(Fragment.CHECKS_REQUIRED), 2);
    [tmp4, CHECKS_REQUIRED] = tmp3;
    tmp5 = onCloseModal(CHECKS_REQUIRED.useState(null), 2);
    [arr, useState] = tmp5;
    tmp6 = onCloseModal(CHECKS_REQUIRED.useState(false), 2);
    useState = tmp6[1];
    tmp7 = onCloseModal(CHECKS_REQUIRED.useState(true), 2);
    [tmp8, useState] = tmp7;
    tmp9 = onCloseModal(CHECKS_REQUIRED.useState(false), 2);
    first = tmp9[0];
    c9 = first;
    useState = tmp9[1];
    tmp11 = onCloseModal(CHECKS_REQUIRED.useState(true), 2);
    [tmp12, tmp13] = tmp11;
    tmp14 = onCloseModal(CHECKS_REQUIRED.useState(false), 2);
    tmp17 = guildId;
    tmp18 = closure_2;
    [tmp15, tmp16] = tmp14;
    ...
    c11 = stateFromStores2;
    tmp21 = onCloseModal(CHECKS_REQUIRED.useState(null), 2);
    first1 = tmp21[0];
    c12 = first1;
    useState = tmp21[1];
    tmp23 = onCloseModal(CHECKS_REQUIRED.useState(null), 2);
    first2 = tmp23[0];
    c14 = first2;
    useState = tmp23[1];
    tmp25 = onCloseModal(CHECKS_REQUIRED.useState(() => {
      let tmp2 = null;
      if (null != initialAttemptedPlatformType) {
        const obj = { platformType: null, applicationId: null };
        obj[0] = tmp;
        let tmp3 = _getSystemLocale;
        if (_getSystemLocale == null) {
          tmp3 = null;
        }
        obj[1] = tmp3;
        tmp2 = obj;
    ...
    found = values.filter((arg0) => {
      let hasItem = _undefined2.can(outer1_27.VIEW_CHANNEL, arg0) && _undefined2.can(outer1_27.SEND_MESSAGES, arg0);
      if (hasItem) {
    ...
    effect = CHECKS_REQUIRED.useEffect(() => {
    ...
    items7[1] = role.id;
    items7[2] = guildId;
    effect1 = CHECKS_REQUIRED.useEffect(() => {
      if (null == initialAttemptedPlatformType) {
        ...
        obj.track(outer1_23.PASSPORT_CHALLENGE_VIEWED, obj);
    ...
    items8[3] = guildId;
    items8[4] = role.id;
    effect2 = CHECKS_REQUIRED.useEffect(() => {
      let hasItem = first;
      if (first) {
      ...
      if (hasItem) {
        lib(false);
        if (found.length > 0) {
          _undefined(outer1_39.ROLE_GRANTED);
        } else {
        ...
        const merged = Object.assign(guildId(initialAttemptedPlatformType[45]).collectGuildAnalyticsMetadata(guildId));
        obj2.track(outer1_23.PASSPORT_CHALLENGE_FINISHED, obj);
    ...
    if (Fragment.CHECKS_REQUIRED === tmp4) {
    ...
    handleManageConnections = function handleManageConnections() {
      ...
      let obj = role(initialAttemptedPlatformType[46]);
      obj.hideActionSheet();
      obj = { screen: outer1_22.CONNECTIONS };
    ...
    handleManageAuthorizedApplications = function handleManageAuthorizedApplications() {
      ...
      let obj = role(initialAttemptedPlatformType[46]);
      obj.hideActionSheet();
      obj = { screen: outer1_22.AUTHORIZED_APPS };
      guildId(initialAttemptedPlatformType[47]).openUserSettings(obj);
    };
    items9 = [, , ];
    ...
    if (tmp2.CHECKS_REQUIRED === tmp4) {
      ...
      if (!tmp8) {
        if (null != arr) {
          ...
          handlePlatformAttempt = function handlePlatformAttempt() {
            ...
            obj = { role_id: role.id };
            const merged = Object.assign(guildId(initialAttemptedPlatformType[45]).collectGuildAnalyticsMetadata(guildId));
            obj.track(outer1_23.PASSPORT_CHALLENGE_STARTED, obj);
          };
          handlePlatformConnect = function handlePlatformConnect(platformType, role_connections_verification_url) {
            ...
            let obj = {
              ...
              onClose() {
                ...
                let obj = lib(outer1_2[46]);
                obj = { default: outer1_40 };
                ...
                let tmp7 = null;
                const guildRoleConnectionsConnectAccountsActionSheetKey = platformType(outer1_2[48]).makeGuildRoleConnectionsConnectAccountsActionSheetKey(lib.id);
          ...
          handlePlatformConnected = function handlePlatformConnected(arg0, arg1) {
            ...
            member(arg1);
            _undefined(outer1_39.ACCOUNT_CONNECTED);
            _undefined2(null);
            if (null != arg1) {
      ...
      obj13[1] = tmp.loading;
      tmp37Result = tmp36(useState, obj13);
    } else {
      if (tmp2.ACCOUNT_CONNECTED === tmp4) {
        ...
        if (null == found1) {
          if (null == found2) {
            ...
            obj16[1] = tmp.loading;
            tmp36Result1 = tmp36(useState, obj16);
          }
      ...
      if (tmp2.CHECKS_REQUIRED === tmp4) {
        ...
        obj36[1] = function onPress() {
          return _undefined(outer1_39.CHECKS_REQUIRED);
        };
