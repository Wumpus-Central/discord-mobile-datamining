...
import OfficialConnectionIconDefault from "OfficialConnectionIcon" /* 11708 */;
...
function ConnectionsChecks(eligibilityStatesGroups) {
  ...
  obj3.children = sorted.map((item) => {
    ...
    if (null != tmp28) {
      ...
      const obj17 = { source: _modDef11399, size: tmp15(1177).Icon.Sizes.SMALL_20, style: closure_5.connectionsChecksGroupTextNameInfoIcon };
