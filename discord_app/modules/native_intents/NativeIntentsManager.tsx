...
import experimentDefault from "experiment" /* 17205 */;
import setDefault from "set" /* 17206 */;
...
function setChannelActivity(channelId) {
  ...
  if (obj.getCurrentConfig({ location: "NativeIntentsManager" }, obj).activityEnabled) {
    ...
    if (null != channel) {
      ...
      obj[5] = items3;
      obj[6] = sum;
      tmp(17206).setActivity(obj);
      obj6 = closure_7;
      tmp10 = require;
      tmp11 = closure_9;
      const tmpResult1 = tmp(17206);
    } else {
      tmp(17206).resignActivity();
      const tmpResult2 = tmp(17206);
    }
  }
}
