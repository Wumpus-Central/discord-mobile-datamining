...
function ConnectedNotificationSettings(guildId) {
  ...
  obj = {
    ...
    channels: memo,
    navigation,
    shouldUseNewNotificationSystem: guildId(10152).useShouldUseNewNotificationSystem("NotificationSettingsModalNative"),
  };
  ...
  constructor() {
    ...
    applyArgumentsResult.handleMutePress = function handleMutePress() {
      ...
      if (muted) {
        ...
        obj = { guildId };
        tmpResult.openLazy(asyncRequireImpl(10149, dependencyMap.paths), "muteSettings" + guildId, obj);
...
prototype["renderMuteSection"] = function renderMuteSection() {
  ...
  if (props.shouldUseNewNotificationSystem) {
    ...
    if (muted) {
      const obj3 = { muteConfig, type: tmp7(10151).MuteSettingType.SERVER };
