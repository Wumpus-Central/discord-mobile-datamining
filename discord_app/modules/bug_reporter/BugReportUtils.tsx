...
export const getPriorities = function getPriorities() {
  ...
  obj[0] = intl.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.VwIij9);
  const intl2 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[1] = intl2.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t.DOP8yY, {});
  const items = [obj, , , ];
  obj = { title: null, description: null, emoji: "410336837563973632", value: 1 };
  const intl3 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[0] = intl3.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.rYfJop);
  const intl4 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[1] = intl4.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t["+LEfDL"], {});
  items[1] = obj;
  obj = { title: null, description: null, emoji: "841420679643529296", value: 2 };
  const intl5 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[0] = intl5.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["9LSuy3"]);
  const intl6 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[1] = intl6.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t.nC7pvx, {});
  items[2] = obj;
  ...
  obj1[0] = intl7.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.Ia0ska);
  const intl8 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[1] = intl8.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t.D4rbgX, {});
  items[3] = obj1;
  return items;
};
