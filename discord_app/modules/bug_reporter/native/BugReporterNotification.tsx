...
export const BugReporterNotification = function BugReporterNotification(notification) {
  ...
  obj[1] = jsx(notification(10048).SystemMessageText, { text: "Bzzz! Found a bug? Tap to submit." });
  ...
  obj[5] = notification;
  return jsx(notification(10113).NotificationPressable, { header: memo, children: null, rightAccessory: null, onPress: null, onSettingsPress: null, notification: null });
};