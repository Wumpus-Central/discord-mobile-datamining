...
let items = [
  fn(1895).ApplicationCommandType.PRIMARY_ENTRY_POINT,
  fn(1895).ApplicationCommandType.CHAT,
  fn(1895).ApplicationCommandType.MESSAGE,
  fn(1895).ApplicationCommandType.USER,
];
const size = fn(2);
