// === Module 18345: MidjourneyOnboardingManager ===
...
const require = fn;
const MIDJOURNEY_GUILD_ID = fn(14218).MIDJOURNEY_GUILD_ID;
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            if (obj6.isEligibleForMidjourneyRedirect(channel)) {
              v1 = 1;
              dependencyMap = 1;
              const obj4 = { value: tmp2(14217).hasRedirectedToGuild(MIDJOURNEY_GUILD_ID), done: false };
              return obj4;
            } else {
              dependencyMap = 3;
            }
          ...
          v1(7575)(Routes.CHANNEL(null, closure_128_0.id));
          const tmp9 = v1(7575);
        }
        dependencyMap = 3;
