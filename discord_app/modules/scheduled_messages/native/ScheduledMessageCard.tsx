...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    if (isPendingRemoval) {
      const obj6 = { style: tmp.pendingRemoval, children: closure_7(tmp2(5880).ActivityIndicator, { size: "small" }) };
      ...
      if (length > 0) {
        ...
        const items2 = [closure_7(tmp2(10453).AttachmentIcon, obj9)];
        ...
        items2[1] = closure_7(tmp2(4823).Text, obj10);
        obj8.children = items2;
        tmp9Result = closure_8(View, obj8);
      }
      obj7.footer = tmp9Result;
      tmp10Result = closure_7(tmp2(12549).ForLaterMessageRow, obj7);
    }
