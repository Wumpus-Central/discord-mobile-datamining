...
export default noop.memo(function ScheduledMessageCard(scheduledMessage) {
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_7(tmp2(12308).ForLaterCardHeader, obj1);
    let obj2 = { style: tmp.cardDivider };
    items1[2] = closure_7(View, obj2);
    if (isPendingRemoval) {
      const obj3 = { style: tmp.pendingRemoval, children: closure_7(tmp2(5628).ActivityIndicator, { size: "small" }) };
      ...
      if (length > 0) {
        ...
        const items2 = [closure_7(tmp2(10201).AttachmentIcon, obj6), ];
        ...
        items2[1] = closure_7(tmp2(4602).Text, obj7);
        obj5.children = items2;
        tmp9Result = closure_8(View, obj5);
      }
      obj4.footer = tmp9Result;
      tmp10Result = closure_7(tmp2(12309).ForLaterMessageRow, obj4);
    }
    items1[3] = tmp10Result;
    obj.children = items1;
    return closure_8(tmp2(5658).Card, obj);
  }
});