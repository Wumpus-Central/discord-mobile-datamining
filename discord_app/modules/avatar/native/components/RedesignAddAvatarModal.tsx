...
fn(4636);
let createStyles = { container: null, contentContainer: null, growContainer: null, headerContainer: null, buttonContainer: null, title: null, subtitle: null, errorContainer: null };
...
export default function RedesignAddAvatarModal(route) {
  ...
  const items4 = [closure_11(closure_6, obj2), closure_10(require("PresetAvatarSelect"), { onAvatarSelect: tmp4[1], selectedAvatar }), closure_10(closure_6, { style: tmp.growContainer }), ];
