// === Module 12290: HubEmailConnectionWaitlist ===
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  obj = { source: navigation(12291), style: tmp.header };
  ...
  items1[2] = callback(onClose(4376).Text, obj2);
  ...
  obj4[2] = onClose;
  obj3[1] = callback(onClose(4815).Button, obj4);
