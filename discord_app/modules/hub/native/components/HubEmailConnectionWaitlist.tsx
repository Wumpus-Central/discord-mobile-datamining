// === Module 11961: HubEmailConnectionWaitlist ===
...
export default function HubEmailConnectionWaitlist(school) {
  ...
  obj = { source: navigation(11962), style: tmp.header };
  ...
  items1[2] = callback(onClose(4739).Text, obj2);
  ...
  obj4[2] = onClose;
  obj3[1] = callback(onClose(4750).Button, obj4);
