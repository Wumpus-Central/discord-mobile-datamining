...
export default function HubSidebar(guild) {
  ...
  if (null != stateFromStores) {
    ...
    obj = { guild };
    const items4 = [closure_7(stateFromStores(16216), obj), , , ];
    obj1 = { active: stateFromStores1, IconComponent: tmp(15596).CompassIcon, label: null, handleItemClick: null, unreadCount: null };
    ...
    obj2 = { IconComponent: tmp(12757).PlusMediumIcon, label: null, handleItemClick: null };
