...
import jsxProd from "module_9004";
...
export default function HubEmailConnectionContent(arg0) {
  ...
  obj1[0] = invite(5219)().insets.bottom + invite(712).space.PX_16;
  items[1] = obj1;
  obj[1] = items;
  obj2 = { style: tmp.container, children: null };
  const tmp16 = _signup;
  const tmp7 = callback(React.useState(null), 2);
  const items1 = [callback2(ref, { style: tmp.header, children: callback2(require(6790) /* AccountAgeTier10LargeBadge */.StudyGroupsSpotIllustration, { scale: 0.75 }) }), callback2(require(4189) /* Text */.Text, { variant: "heading-xl/bold", color: "mobile-text-heading-primary", style: tmp.title, accessibilityRole: "header", children: formatToPlainStringResult }), , ];
  ...
  items1[2] = callback2(require(4189) /* Text */.Text, obj5);
  ...
  let obj3 = { style: tmp.header, children: callback2(require(6790) /* AccountAgeTier10LargeBadge */.StudyGroupsSpotIllustration, { scale: 0.75 }) };
  ...
  items1[3] = callback2(invite(9004), obj7);
  obj2[1] = items1;
  ...
  obj12[3] = tmp6[0];
  obj11[1] = callback2(require(4604) /* Button */.Button, obj12);
  items2[2] = callback2(ref, obj11);
  obj[2] = items2;
  obj9[0] = closure_13(tmp16, obj);
  return callback2(require(11843) /* HubEmailConnectionModal */.HubEmailConnectionScreen, obj9);
};