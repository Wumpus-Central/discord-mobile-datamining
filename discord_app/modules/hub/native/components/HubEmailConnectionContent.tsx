...
fn(4605);
let createStyles = { container: { paddingHorizontal: 16 }, header: { marginTop: 16, marginBottom: 16, alignSelf: "center" }, scrollViewContainer: { flexGrow: 2 }, title: { textAlign: "center", marginBottom: 8 }, description: { textAlign: "center", marginBottom: 24 }, input: { marginBottom: 32 }, textInput: null, growSpacing: null, buttonContainer: null };
...
export default function HubEmailConnectionContent(arg0) {
      ...
      try {
        ...
        if (0 === c6) {
          if (arg0 === 1) {
            ...
            c6 = 3;
            c7 = 1;
            const obj1 = { value: guildId(tmp6[12]).sendVerificationEmail(asyncGeneratorStep, true, _undefined), done: false };
            return obj1;
          }
        } else if (1 === tmp9) {
          c5 = 0;
            ...
            if (3 === tmp9) {
              if (arg0 === 1) {
                ...
                if (0 === guilds_info.length) {
                  ...
                  c6 = 4;
                  c7 = 1;
                  const obj4 = { value: obj3.sendVerificationEmail(closure_131_3, true, guilds_info[0].id), done: false };
                  return obj4;
                } else {
  ...
  let obj1 = { paddingBottom: invite(7033)().insets.bottom + invite(576).space.PX_16 };
  items[1] = obj1;
  ...
  items1[3] = closure_12(invite(6655), obj7);
