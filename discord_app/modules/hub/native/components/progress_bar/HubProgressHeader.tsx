...
const jsx = fn(21).jsx;
fn(4636);
let createStyles = { container: { overflow: "hidden", height: fn(12439).GUILD_DIRECTORY_PROGRESS_BAR_HEIGHT, padding: 16 }, icon: { width: 48, height: 48 }, innerContainer: null };
  ...
  if (null == nextHubProgressStep) {
    ...
    obj1.onPress = function onPress() {
      ...
      if (!tmp) {
        ...
        obj.openLazy(asyncRequireImpl(12802, dependencyMap.paths), React4, obj);
      }
    };
