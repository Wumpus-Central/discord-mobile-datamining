...
export default function HubEmailConnectionStudentPrompt(onClose) {
  ...
  const obj3 = { source: invite(12858) };
  obj2.leading = closure_7(closure_4, obj3);
  obj2.trailing = invite(7240).Arrow;
  ...
  items[1] = closure_7(invite(7240), obj2);
