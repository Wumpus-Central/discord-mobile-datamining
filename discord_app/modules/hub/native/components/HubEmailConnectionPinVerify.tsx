...
function presentResendToast(content) {
  ...
  obj.open({ key: "HUB_EMAIL_RESET", content, icon: _modDef9338 });
}
...
export default function HubEmailConnectionPinVerify(email) {
  ...
  const tmp7 = email;
  const items1 = [closure_9(closure_7, { source: require("../../../../../_runtime/metro/12256__.js") }), , , , ,];
  const obj5 = {
    style: tmp.title,
  ...
  const obj4 = { source: require("../../../../../_runtime/metro/12256__.js") };
