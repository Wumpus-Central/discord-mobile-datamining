...
export const getSortValueForMember = function getSortValueForMember(joinedAt, ORDER_BY_UNSPECIFIED) {
  const joinedAtTimestamp = require("DateUtils.tsx") /* getJoinedAtDateFormatter */.getJoinedAtTimestamp(joinedAt.joinedAt);
  if (require("MemberSafetyElasticSearchQueryTypes.tsx") /* result */.OrderBy.ORDER_BY_GUILD_JOINED_AT_ASC === ORDER_BY_UNSPECIFIED) {
  ...
  const obj = require("DateUtils.tsx") /* getJoinedAtDateFormatter */;
};