// === Module 7764: GuildMemberSafetySearch ===
...
prototype["updateSearchState"] = function updateSearchState(arg0) {
  ...
  this._searchState = {};
  this.hasDefaultQuery = _modDef4876(this._searchState, closure_4);
  return true;
};
