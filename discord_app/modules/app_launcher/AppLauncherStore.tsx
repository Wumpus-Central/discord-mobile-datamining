...
const obj = {
  show: false,
  entrypoint: fn(9647).AppLauncherEntrypoint.NONE,
  lastShownEntrypoint: fn(9647).AppLauncherEntrypoint.NONE,
  activeViewType: null,
  activeChannelId: null,
  closeReason: fn(9647).AppLauncherCloseReason.DISMISSED,
