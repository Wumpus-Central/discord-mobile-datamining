...
const obj = {
  show: false,
  entrypoint: fn(9522).AppLauncherEntrypoint.NONE,
  lastShownEntrypoint: fn(9522).AppLauncherEntrypoint.NONE,
  activeViewType: null,
  activeChannelId: null,
  closeReason: fn(9522).AppLauncherCloseReason.DISMISSED,
