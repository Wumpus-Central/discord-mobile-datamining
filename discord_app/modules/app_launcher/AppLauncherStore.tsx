...
let obj = {
  show: false,
  entrypoint: fn(9409).AppLauncherEntrypoint.NONE,
  lastShownEntrypoint: fn(9409).AppLauncherEntrypoint.NONE,
  activeViewType: null,
  activeChannelId: null,
  closeReason: fn(9409).AppLauncherCloseReason.DISMISSED,
