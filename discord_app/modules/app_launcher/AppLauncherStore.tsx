...
const obj = {
  show: false,
  entrypoint: fn(9552).AppLauncherEntrypoint.NONE,
  lastShownEntrypoint: fn(9552).AppLauncherEntrypoint.NONE,
  activeViewType: null,
  activeChannelId: null,
  closeReason: fn(9552).AppLauncherCloseReason.DISMISSED,
