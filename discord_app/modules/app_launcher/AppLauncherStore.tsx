...
const obj = {
  show: false,
  entrypoint: fn(9541).AppLauncherEntrypoint.NONE,
  lastShownEntrypoint: fn(9541).AppLauncherEntrypoint.NONE,
  activeViewType: null,
  activeChannelId: null,
  closeReason: fn(9541).AppLauncherCloseReason.DISMISSED,
