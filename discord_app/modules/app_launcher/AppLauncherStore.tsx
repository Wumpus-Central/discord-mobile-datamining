...
const obj = {
  show: false,
  entrypoint: fn(9563).AppLauncherEntrypoint.NONE,
  lastShownEntrypoint: fn(9563).AppLauncherEntrypoint.NONE,
  activeViewType: null,
  activeChannelId: null,
  closeReason: fn(9563).AppLauncherCloseReason.DISMISSED,
