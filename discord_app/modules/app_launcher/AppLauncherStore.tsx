...
const obj = {
  show: false,
  entrypoint: fn(9523).AppLauncherEntrypoint.NONE,
  lastShownEntrypoint: fn(9523).AppLauncherEntrypoint.NONE,
  activeViewType: null,
  activeChannelId: null,
  closeReason: fn(9523).AppLauncherCloseReason.DISMISSED,
