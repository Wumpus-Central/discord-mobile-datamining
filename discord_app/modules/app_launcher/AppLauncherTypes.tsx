...
export const AppLauncherEmptyStateType = {
  HOME_EMPTY: "home_empty",
  SEARCH_EMPTY: "search_empty",
  HOME_NO_PERMISSIONS: "home_no_permissions",
  COMMAND_NO_PERMISSIONS: "command_no_permissions",
  COMMAND_NOT_FOUND: "command_not_found",
};
export const AppLauncherCloseReason = {
  DISMISSED: 0,
  [0]: "DISMISSED",
  COMMAND: 1,
  [1]: "COMMAND",
