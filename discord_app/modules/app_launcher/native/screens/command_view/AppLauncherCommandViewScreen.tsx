...
import _modDef12244 from "../../../../../../_runtime/metro/12244__.js";
import _modDef12245 from "../../../../../../_runtime/metro/12245__.js";
...
import _modDef12323 from "../../../../../../_runtime/metro/12323__.js";
import _modDef12324 from "../../../../../../_runtime/metro/12324__.js";
  ...
  let fn = function h() {
    if (stateFromStores) {
      ...
      const fn = function e() {
        ...
        return closure_1_0(4373).runOnJS(closure_1_0(4604).triggerHapticFeedback)(
          closure_1_0(4604).HapticFeedbackTypes.IMPACT_LIGHT,
        );
      };
      const obj7 = {
...
function NotFoundState(onPress) {
  ...
  const obj3 = {
    ...
    lightSource: _modDef12323,
    darkSource: _modDef12324,
    title: null,
    body: null,
    children: null,
  };
...
function NoPermsState(command) {
  ...
  const obj6 = {
    style: tmp.emptyState,
    lightSource: _modDef12244,
    darkSource: _modDef12245,
    title: null,
    body: null,
    children: null,
  };
...
obj2.optionsContainer = {
  paddingTop: fn(12284).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4,
