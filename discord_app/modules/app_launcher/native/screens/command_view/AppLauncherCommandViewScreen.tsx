...
import registerAssetDefault from "../../../../../../_runtime/11771_registerAsset.js";
import registerAssetDefault2 from "../../../../../../_runtime/11772_registerAsset.js";
import registerAssetDefault3 from "../../../../../../_runtime/11848_registerAsset.js";
import registerAssetDefault4 from "../../../../../../_runtime/11849_registerAsset.js";
...
function AppLauncherCommandViewFooter(arg0) {
  ...
  let fn = function h() {
    if (stateFromStores) {
      ...
      const fn = function e() {
        const obj = callback(4184);
        return callback(4184).runOnJS(callback(4412).triggerHapticFeedback)(callback(4412).HapticFeedbackTypes.IMPACT_LIGHT);
      };
