...
import _modDef12536 from "../../../../../../_runtime/metro/12536__.js";
  ...
  let fn = function h() {
    if (stateFromStores) {
      ...
      const fn = function e() {
        ...
        return closure_1_0(4561).runOnJS(closure_1_0(4797).triggerHapticFeedback)(
          closure_1_0(4797).HapticFeedbackTypes.IMPACT_LIGHT,
        );
      };
      const obj7 = {
...
function NotFoundState(onPress) {
  ...
  const obj3 = {
    ...
    lightSource: _modDef12535,
    darkSource: _modDef12536,
    title: null,
    body: null,
    children: null,
  };
...
function NoPermsState(command) {
  ...
  const obj6 = {
    style: tmp.emptyState,
    lightSource: _modDef12456,
    darkSource: _modDef12457,
    title: null,
    body: null,
    children: null,
  };
...
obj2.optionsContainer = {
  paddingTop: fn(12496).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4,
