...
import _modDef11661 from "../../../../../../_runtime/metro/11661__.js";
  ...
  let fn = function h() {
    if (stateFromStores) {
      ...
      const fn = function e() {
        ...
        return closure_1_0(4563).runOnJS(closure_1_0(4797).triggerHapticFeedback)(
...
function NotFoundState(onPress) {
  ...
  const obj3 = {
    ...
    lightSource: _modDef11661,
    darkSource: _modDef11662,
    title: null,
    body: null,
    children: null,
  };
...
function NoPermsState(command) {
  ...
  const obj6 = {
    style: tmp.emptyState,
    lightSource: _modDef11582,
    darkSource: _modDef11583,
    title: null,
    body: null,
    children: null,
  };
...
obj2.optionsContainer = {
  paddingTop: fn(11622).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4,
