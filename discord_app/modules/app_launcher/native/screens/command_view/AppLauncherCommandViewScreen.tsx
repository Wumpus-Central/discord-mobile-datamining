...
import _modDef12248 from "../../../../../../_runtime/metro/12248__.js";
import _modDef12249 from "../../../../../../_runtime/metro/12249__.js";
  ...
  let fn = function h() {
    if (stateFromStores) {
      ...
      const fn = function e() {
        ...
        return closure_1_0(4376).runOnJS(closure_1_0(4607).triggerHapticFeedback)(
          closure_1_0(4607).HapticFeedbackTypes.IMPACT_LIGHT,
        );
      };
      const obj7 = {
...
function NotFoundState(onPress) {
  ...
  const obj3 = {
    ...
    lightSource: _modDef12327,
    darkSource: _modDef12328,
    title: null,
    body: null,
    children: null,
  };
...
function NoPermsState(command) {
  ...
  const obj6 = {
    style: tmp.emptyState,
    lightSource: _modDef12248,
    darkSource: _modDef12249,
    title: null,
    body: null,
    children: null,
  };
...
obj2.optionsContainer = {
  paddingTop: fn(12288).EXPANDED_HEADER_TOTAL_CONSUMED_SPACE_IN_PARENT + nativeDefault.space.PX_4,
