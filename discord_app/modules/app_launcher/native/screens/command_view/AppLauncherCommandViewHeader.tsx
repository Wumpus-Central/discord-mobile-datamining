...
let obj2 = {
  ...
  loadingHeaderContainer: { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWEST },
  appIconMask: null,
  appIcon: null,
  loadingIcon: null,
  appSmallName: null,
...
const rect = {
  ...
  bottom: -36,
  left: "50%",
  backgroundColor: AppLauncherNativeConstants.SCREEN_BACKGROUND_COLOR,
...
export const AppLauncherCommandViewHeader = function AppLauncherCommandViewHeader(onPress) {
  ...
  E.__closure = {
    ...
    interpolate: scrollOffsetY(4563).interpolate,
    scrollOffsetY,
    TOTAL_SCROLL_RANGE,
  };
