...
fn(4605);
let createStyles = { optionDescription: { marginTop: 4 }, optionErrorContainer: { flexDirection: "row", alignItems: "center", marginTop: 4 }, optionErrorIcon: null, labelText: null };
...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    if (hasItem1) {
      ...
      tmp17Result = closure_5(tmp2(4601).Text, obj4);
    }
    ...
    const obj6 = { style: tmp.optionDescription, variant: "text-xs/medium", color: "text-muted", children: option.displayDescription };
    items2[2] = closure_5(tmp2(4601).Text, obj6);
    if (hasItem) {
      ...
      const obj8 = { style: tmp.optionErrorIcon, source: _modDef10485, size: tmp2(1178).IconSizes.REFRESH_SMALL_16 };
      ...
      items3[1] = closure_5(tmp2(4601).Text, obj9);
    ...
    obj.children = closure_5(tmp2(12232).AwaitAnimationContext, obj1);
    return closure_5(tmp2(4341).LayoutAnimationConfig, obj);
  } else {
    return null;
  }
