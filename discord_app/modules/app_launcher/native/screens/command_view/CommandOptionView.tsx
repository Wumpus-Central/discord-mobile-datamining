...
let items = [
  fn(1979).ApplicationCommandOptionType.STRING,
  fn(1979).ApplicationCommandOptionType.INTEGER,
  fn(1979).ApplicationCommandOptionType.ATTACHMENT,
  fn(1979).ApplicationCommandOptionType.BOOLEAN,
  fn(1979).ApplicationCommandOptionType.MENTIONABLE,
  fn(1979).ApplicationCommandOptionType.USER,
  fn(1979).ApplicationCommandOptionType.ROLE,
  fn(1979).ApplicationCommandOptionType.CHANNEL,
  fn(1979).ApplicationCommandOptionType.NUMBER,
];
...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    if (hasItem1) {
      ...
      tmp17Result = closure_5(tmp2(4832).Text, obj7);
    }
