...
export default function CommandOptionView(option) {
  ...
  const optionEnteringAnimation = option(11433).useOptionEnteringAnimation();
  ...
  if (set.has(option.type)) {
    ...
    obj2[2] = tmp2(11433).ExitingAnimation;
    obj2[3] = tmp2(11433).LayoutAnimation;
    ...
    obj[1] = closure_5(tmp2(11434).AwaitAnimationContext, obj1);
    return closure_5(tmp2(4116).LayoutAnimationConfig, obj);
  } else {
    return null;
  }
  const tmp2Result = option(11433);
};