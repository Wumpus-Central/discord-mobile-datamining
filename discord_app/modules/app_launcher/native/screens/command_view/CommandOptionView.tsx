...
export default function CommandOptionView(option) {
  ...
  if (set.has(option.type)) {
    ...
    if (hasItem1) {
      ...
      tmp17Result = closure_5(tmp2(4634).Text, obj7);
    }
    ...
    if (hasItem) {
      ...
      const obj11 = { style: tmp.optionErrorIcon, source: _modDef10555, size: tmp2(1177).IconSizes.REFRESH_SMALL_16 };
      ...
      items3[1] = closure_5(tmp2(4634).Text, obj12);
