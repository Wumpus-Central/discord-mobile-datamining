...
let size = {
  width: fn(12131).BACK_BUTTON_SIZE,
  height: fn(12131).BACK_BUTTON_SIZE,
  alignItems: "center",
...
export default function AppLauncherViewAllScreen(route) {
  ...
  const memo = applications.useMemo(() => {
    ...
    const items = [
      React5(Pressables.PressableOpacity, obj),
      ...
      React5(native.Spacer, { size: AppLauncherBackButton.BACK_BUTTON_SIZE }),
    ];
    obj.children = items;
