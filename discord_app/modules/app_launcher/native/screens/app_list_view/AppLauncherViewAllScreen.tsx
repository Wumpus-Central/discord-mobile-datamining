...
createCacheKey[3] = {
  width: require("AppLauncherBackButton").BACK_BUTTON_SIZE,
  height: require("AppLauncherBackButton").BACK_BUTTON_SIZE,
  alignItems: "center",
...
export default function AppLauncherViewAllScreen(route) {
  ...
  callback1 = applications.useCallback((arg0) => {
    ...
    if (analyticsLocation == null) {
      APP_LAUNCHER_APPLICATION_VIEW_FRECENCT = context(sectionOverallPosition[10]).ApplicationCommandTriggerLocations
  ...
  const memo = applications.useMemo(() => {
    ...
    const items = [
      promotedApplicationIds(context(sectionOverallPosition[11]).PressableOpacity, obj),
      promotedApplicationIds(context(sectionOverallPosition[14]).Text, {
      ...
      promotedApplicationIds(context(sectionOverallPosition[15]).Spacer, {
        size: context(sectionOverallPosition[6]).BACK_BUTTON_SIZE,
      }),
    ];
    obj[1] = items;
        ...
        onViewableItemsChanged(viewableItems) {
          ...
          let item = viewableItems.forEach((item) => {
            ...
            callback({
              ...
              sectionName: closure_9,
              sectionPosition: item.index,
              sectionOverallPosition: closure_2,
