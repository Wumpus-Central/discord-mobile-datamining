// === Module 11653: FrecencyCommandsSection ===

// Module 11653 (FrecencyCommandsSection)
import useFilterAndSortToOnlyFrecentCommandsDefault from "useFilterAndSortToOnlyFrecentCommands" /* 11654 */;
...
export default function FrecencyCommandsSection(commands) {
  ...
  if (0 !== arr.length) {
    ...
    obj[1] = arr(context(4442).Heading, obj);
