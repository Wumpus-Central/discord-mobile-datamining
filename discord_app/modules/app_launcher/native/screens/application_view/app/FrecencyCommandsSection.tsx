// === Module 11684: FrecencyCommandsSection ===

// Module 11684 (FrecencyCommandsSection)
import useFilterAndSortToOnlyFrecentCommandsDefault from "useFilterAndSortToOnlyFrecentCommands" /* 11685 */;
...
export default function FrecencyCommandsSection(commands) {
  ...
  if (0 !== arr.length) {
    ...
    obj[1] = arr(context(4444).Heading, obj);
