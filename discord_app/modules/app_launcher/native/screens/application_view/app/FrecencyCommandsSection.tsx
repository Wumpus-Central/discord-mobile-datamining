// === Module 11634: FrecencyCommandsSection ===

// Module 11634 (FrecencyCommandsSection)
import useFilterAndSortToOnlyFrecentCommandsDefault from "useFilterAndSortToOnlyFrecentCommands" /* 11635 */;
...
export default function FrecencyCommandsSection(commands) {
  ...
  if (0 !== arr.length) {
    ...
    obj[1] = arr(context(4441).Heading, obj);
