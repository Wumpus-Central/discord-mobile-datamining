...
export default function CommandListSortButton(sortOrder) {
  ...
  const obj = {
    ...
    onPress() {
      ActionSheetActionCreatorsDefault.openLazy(
        asyncRequireImpl(12292, dependencyMap.paths),
  ...
  const items = [
    closure_6(sortOrder(4634).Text, { variant: "text-sm/medium", color: "text-default", children: stringResult }),
    closure_6(sortOrder(11306).ChevronSmallDownIcon, { size: "xs", color: onSortOptionPress(576).colors.TEXT_DEFAULT }),
  ];
  obj2.children = items;
