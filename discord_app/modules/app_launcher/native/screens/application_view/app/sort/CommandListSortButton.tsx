...
export default function CommandListSortButton(sortOrder) {
  ...
  let obj = {
    ...
    onPress() {
      ...
      obj.openLazy(asyncRequireImpl(12180, dependencyMap.paths), "CommandListSortActionSheet", obj);
    },
    children: null
  };
  obj = { style: tmp.button, children: null };
  const items = [closure_6(sortOrder(4570).Text, { variant: "text-sm/medium", color: "text-default", children: stringResult }), ];
  obj = { size: "xs", color: onSortOptionPress(576).colors.TEXT_DEFAULT };
  items[1] = closure_6(sortOrder(11185).ChevronSmallDownIcon, obj);
  obj.children = items;
