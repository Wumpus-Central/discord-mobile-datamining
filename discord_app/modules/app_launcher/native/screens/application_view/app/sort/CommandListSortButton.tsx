...
export default function CommandListSortButton(sortOrder) {
  ...
  const items = [
    closure_6(sortOrder(4632).Text, { variant: "text-sm/medium", color: "text-default", children: stringResult }),
    closure_6(sortOrder(11288).ChevronSmallDownIcon, { size: "xs", color: onSortOptionPress(576).colors.TEXT_DEFAULT }),
  ];
  obj2.children = items;
