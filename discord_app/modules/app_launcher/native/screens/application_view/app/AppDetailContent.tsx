...
let obj2 = {
  headerSpacer: { height: fn(12383).EXPANDED_HEADER_HEIGHT - fn(12383).SHEET_HANDLE_CONTAINER_HEIGHT },
...
let obj3 = { height: fn(12383).EXPANDED_HEADER_HEIGHT - fn(12383).SHEET_HANDLE_CONTAINER_HEIGHT };
