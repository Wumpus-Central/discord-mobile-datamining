    ...
    obj = {
      ...
      beforeExecuteCommand() {
        const obj = {
          command,
          location: _location,
          triggerSection: ApplicationCommandUtils.getCommandTriggerSection(dependencyMap),
          sectionName,
        };
          ...
          try {
            ...
            if (0 === context) {
              if (arg0 === 1) {
                ...
                c3 = 1;
                const obj3 = {
                  value: command(dependencyMap[16]).installApplicationOnDemandIfNeeded(obj1),
                  done: false,
                };
                return obj3;
              }
...
createStyles = { height: fn(12160).EXPANDED_HEADER_HEIGHT - fn(12160).SHEET_HANDLE_CONTAINER_HEIGHT };
...
createStyles.mainContainerStyle = {
...
createStyles.monetizationDisclosureContainerStyle = {
  flexDirection: "row",
  alignItems: "center",
...
createStyles.loadingTextPlaceholder = {
