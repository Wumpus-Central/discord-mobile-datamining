...
import CommandRowButtonDefault from "../../../base_components/CommandRowButton.tsx";
import BillIcon from "../../../../../../design/components/Icon/native/redesign/generated/BillIcon.tsx";
          ...
          try {
            ...
            if (0 === context) {
              if (arg0 === 1) {
                ...
                c3 = 1;
                const obj7 = {
                  value: command(dependencyMap[16]).installApplicationOnDemandIfNeeded(obj4),
                  done: false,
                };
                return obj7;
              }
...
let closure_12 = fn(5297).DISCOVERY_COMMANDS_QUERY_LIMIT;
const jsxProd = fn(21);
({ jsx: map1, jsxs: closure_14, Fragment: closure_15 } = jsxProd);
const createStyles = fn(4829);
let obj2 = {
  headerSpacer: { height: fn(12472).EXPANDED_HEADER_HEIGHT - fn(12472).SHEET_HANDLE_CONTAINER_HEIGHT },
  ...
  commandsHeaderTextContainer: { alignItems: "center", flexDirection: "row", gap: 8 },
...
let obj3 = { height: fn(12472).EXPANDED_HEADER_HEIGHT - fn(12472).SHEET_HANDLE_CONTAINER_HEIGHT };
...
obj2.monetizationDisclosureContainerStyle = {
  flexDirection: "row",
  alignItems: "center",
...
export default function AppDetailContent(context) {
  ...
  onPressCommand = onCommandExecuted.useCallback((command, section) => {
    ...
    if (arg2 === undefined) {
      APP_LAUNCHER_APPLICATION_VIEW =
        ApplicationCommandTypes.ApplicationCommandTriggerLocations.APP_LAUNCHER_APPLICATION_VIEW;
    }
    const result = AppLauncherNativeUtils.handleApplicationCommandSelected({
  ...
  const callback2 = onCommandExecuted.useCallback((arg0) => {
    ...
    if (obj10.PLACEHOLDER === type) {
      ...
      const obj = {
        ...
        onPressCommand,
        isFirstRow: 0 === index,
        isLastRow: index === commands.length - 1,
        context,
        onExecuteCommand: callback1,
        section: found,
        location: ApplicationCommandTypes.ApplicationCommandTriggerLocations.APP_LAUNCHER_APPLICATION_VIEW,
        installOnDemand,
        sectionName,
      };
  ...
  const items11 = [
    c13(
      tmp2Result,
      {
        ListHeaderComponent: commands(navigation, { children: items9 }),
    ...
    c13(application(sectionName[9]), {
      ...
      onAddAppMenuClick(installAppProps) {
        ...
        obj2 = {
          location: context(sectionName[23]).ApplicationCommandTriggerLocations.APP_LAUNCHER_APPLICATION_VIEW_MORE_MENU,
