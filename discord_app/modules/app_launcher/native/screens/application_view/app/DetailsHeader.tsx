...
export default noop.memo(function DetailsHeader(viewContainerStyle) {
  ...
  let obj4 = sharedValue(9358);
  const sectionName = obj4.getSectionName(application);
  let obj5 = sharedValue(9358);
  ...
  if (!hideName) {
    ...
    tmp30Result = tmp30(tmp2(4601).Heading, obj2);
  }
  ...
  if (isPartnerApplicationResult) {
    ...
    obj3.children = tmp30(tmp2(4601).Text, obj4);
  ...
  if (tmp28Result1) {
    ...
    obj14.children = tmp30(tmp2(4601).Text, obj15);
    ...
    if (tmp27) {
      ...
      obj16.children = tmp28(tmp2(4601).Text, obj17);
    ...
    if (first) {
      ...
      if (first1) {
        ...
        tmp30Result3 = tmp30(tmp2(4601).Text, obj18);
      }
    }
  ...
  const children = [num2(first(4341).View, obj), ];
  ...
  if (!first2) {
    ...
    if (!hideName) {
      ...
      tmp30Result4 = tmp30(tmp2(4601).Heading, obj20);
    }
    ...
    if (tmp28Result1) {
      ...
      const items15 = [tmp30(tmp2(4601).Text, obj22), ];
      ...
      items15[1] = tmp30(tmp2(4601).Text, obj23);
