    ...
    obj5[1] = function onPress() {
      if (first) {
        ...
        if (first1) {
          ...
          const result1 = sharedValue.set(obj.withTiming(ref2.current, sharedValue(4482).timingStandard));
        }
        callback(!first1);
        const tmp2 = first1;
      }
