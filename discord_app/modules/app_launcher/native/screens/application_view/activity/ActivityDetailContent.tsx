// === Module 12140: ActivityDetailContent ===
...
import DeveloperActivityShelfActionCreatorsAll from "DeveloperActivityShelfActionCreators" /* 9549 */;
  ...
  const callback = noop.useCallback(asyncGeneratorStep(async (arg0, value) => {
    ...
    if (1 === tmp7) {
      ...
      if (arg0 === 1) {
        ...
        c4 = 3;
        c5 = 1;
        return { value: tmp3(9548)({ targetApplicationId: closure_129_1, channelId: closure_128_0, analyticsLocations: closure_129_2 }), done: false };
      }
    } else if (arg0 === 1) {
      c5 = 3;
      throw value;
