// === Module 11598: application_view/Header ===
...
import useAvatarColorDefault from "useAvatarColor" /* 7581 */;
import AppLauncherUtils from "AppLauncherUtils" /* 8582 */;
import AppLauncherBackButtonDefault from "AppLauncherBackButton" /* 11599 */;
...
export default function Header(application) {
  ...
  const tmp23 = id;
  items6[2] = tmp13(ReanimatedRexportDefault.View, { style: animatedStyle2, pointerEvents: "none", children: tmp13(application(4825).Heading, { variant: "heading-lg/bold", color: "text-overlay-light", children: str2 }) });
