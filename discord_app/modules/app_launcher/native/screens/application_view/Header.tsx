// === Module 12463: application_view/Header ===
...
import useAvatarColorDefault from "useAvatarColor" /* 8487 */;
import AppLauncherUtils from "AppLauncherUtils" /* 9480 */;
import AppLauncherBackButtonDefault from "AppLauncherBackButton" /* 12464 */;
import getApplicationInstallURL from "getApplicationInstallURL" /* 12465 */;
...
export default function Header(application) {
  ...
  if (null != application) {
    appLauncherIconSource = tmp(12384).getAppLauncherIconSource(application);
    const tmpResult = tmp(12384);
  }
  let obj = application(504);
  let str = application(4524).useToken(nativeDefault.colors.BACKGROUND_BASE_LOW);
  let tmp7 = appLauncherIconSource;
  const tmpResult9 = application(4524);
  ...
  if (null != appLauncherIconSource) {
    ...
    let tmp12 = closure_8(tmp5(12389), obj2);
    let tmp13 = closure_8;
  } else {
  ...
  const tmpResult10 = application(4559);
  fn.__closure = { interpolate: application(4559).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn.__workletHash = 2572905048492;
  fn.__initData = __initData;
  closure_130_0 = scrollOffsetY;
  const animatedStyle = tmpResult10.useAnimatedStyle(fn);
  let obj4 = { interpolate: application(4559).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult11 = application(4559);
  fn2.__closure = { interpolate: application(4559).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn2.__workletHash = 8190094903650;
  fn2.__initData = __initData2;
  const animatedStyle1 = tmpResult11.useAnimatedStyle(fn2);
  let obj5 = { interpolate: application(4559).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult12 = application(4559);
  fn3.__closure = { interpolate: application(4559).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn3.__workletHash = 14190901941859;
  fn3.__initData = __initData3;
  closure_131_0 = scrollOffsetY;
  const animatedStyle2 = tmpResult12.useAnimatedStyle(fn3);
  let obj6 = { interpolate: application(4559).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult13 = application(4559);
  fn4.__closure = { interpolate: application(4559).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn4.__workletHash = 9589752719246;
  fn4.__initData = __initData4;
  let str2 = "";
  const animatedStyle3 = tmpResult13.useAnimatedStyle(fn4);
  if (null != application) {
    str2 = tmp(9480).getSectionName(application);
    const tmpResult14 = tmp(9480);
  }
  ...
  if (hasApplicationFlagResult) {
    hasApplicationFlagResult = tmp(9211).hasApplicationFlag(application, constants2.EMBEDDED);
    const tmpResult15 = tmp(9211);
  }
  ...
  const obj7 = { interpolate: application(4559).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  const tmp23 = id;
  items6[2] = tmp13(ReanimatedRexportDefault.View, { style: animatedStyle2, pointerEvents: "none", children: tmp13(application(4823).Heading, { variant: "heading-lg/bold", color: "text-overlay-light", children: str2 }) });
  ...
  if (null != application) {
    ...
    if (tmpResult16.isRealApplication(application)) {
      ...
      const items7 = [tmp13(tmp(8265).IconButton, obj15), ];
      const obj16 = { application, onAddAppMenuClick };
      items7[1] = tmp13(tmp5(12466), obj16);
      obj14.children = items7;
      tmp22Result = closure_9(tmp23, obj14);
    }
    tmpResult16 = tmp(9480);
  }
