...
export default function Header(application) {
  ...
  if (null != appLauncherIconSource) {
    ...
    obj[1] = xl;
    let tmp12 = callback(tmp5(12056), obj);
    let tmp13 = callback;
  } else {
    obj = { style: null };
  ...
  if (hasApplicationFlagResult) {
    hasApplicationFlagResult = tmp(8856).hasApplicationFlag(application, constants.EMBEDDED);
  ...
  const items6 = [
    tmp13(_modDef4296.View, { style: items5, pointerEvents: "none" }),
  ...
  items6[2] = tmp13(_modDef4296.View, {
    style: animatedStyle2,
    pointerEvents: "none",
    children: tmp13(scrollOffsetY(4556).Heading, {
  ...
  if (null != application) {
    ...
    if (tmpResult7.isRealApplication(application)) {
      ...
      items7[1] = tmp13(tmp5(12133), obj12);
      obj10[1] = items7;
