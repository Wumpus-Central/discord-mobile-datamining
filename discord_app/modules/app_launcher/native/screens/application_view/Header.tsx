// === Module 12387: application_view/Header ===
...
import useAvatarColorDefault from "useAvatarColor" /* 8405 */;
import AppLauncherUtils from "AppLauncherUtils" /* 9409 */;
import AppLauncherBackButtonDefault from "AppLauncherBackButton" /* 12388 */;
import getApplicationInstallURL from "getApplicationInstallURL" /* 12389 */;
...
export default function Header(application) {
  ...
  if (null != application) {
    appLauncherIconSource = tmp(12308).getAppLauncherIconSource(application);
    const tmpResult = tmp(12308);
  }
  let obj = application(504);
  let str = application(4458).useToken(nativeDefault.colors.BACKGROUND_BASE_LOW);
  let tmp7 = appLauncherIconSource;
  const tmpResult9 = application(4458);
  ...
  if (null != appLauncherIconSource) {
    ...
    let tmp12 = closure_8(tmp5(12313), obj2);
    let tmp13 = closure_8;
  } else {
  ...
  const tmpResult10 = application(4493);
  fn.__closure = { interpolate: application(4493).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn.__workletHash = 2572905048492;
  fn.__initData = __initData;
  closure_130_0 = scrollOffsetY;
  const animatedStyle = tmpResult10.useAnimatedStyle(fn);
  let obj4 = { interpolate: application(4493).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult11 = application(4493);
  fn2.__closure = { interpolate: application(4493).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn2.__workletHash = 8190094903650;
  fn2.__initData = __initData2;
  const animatedStyle1 = tmpResult11.useAnimatedStyle(fn2);
  let obj5 = { interpolate: application(4493).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult12 = application(4493);
  fn3.__closure = { interpolate: application(4493).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn3.__workletHash = 14190901941859;
  fn3.__initData = __initData3;
  closure_131_0 = scrollOffsetY;
  const animatedStyle2 = tmpResult12.useAnimatedStyle(fn3);
  let obj6 = { interpolate: application(4493).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult13 = application(4493);
  fn4.__closure = { interpolate: application(4493).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  fn4.__workletHash = 9589752719246;
  fn4.__initData = __initData4;
  let str2 = "";
  const animatedStyle3 = tmpResult13.useAnimatedStyle(fn4);
  if (null != application) {
    str2 = tmp(9409).getSectionName(application);
    const tmpResult14 = tmp(9409);
  }
  ...
  if (hasApplicationFlagResult) {
    hasApplicationFlagResult = tmp(9140).hasApplicationFlag(application, constants2.EMBEDDED);
    const tmpResult15 = tmp(9140);
  }
  ...
  const obj7 = { interpolate: application(4493).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  const tmp23 = id;
  items6[2] = tmp13(ReanimatedRexportDefault.View, { style: animatedStyle2, pointerEvents: "none", children: tmp13(application(4753).Heading, { variant: "heading-lg/bold", color: "text-overlay-light", children: str2 }) });
  ...
  if (null != application) {
    ...
    if (tmpResult16.isRealApplication(application)) {
      ...
      const items7 = [tmp13(tmp(8183).IconButton, obj15), ];
      const obj16 = { application, onAddAppMenuClick };
      items7[1] = tmp13(tmp5(12390), obj16);
      obj14.children = items7;
      tmp22Result = closure_9(tmp23, obj14);
    }
    tmpResult16 = tmp(9409);
  }
