...
export default function Header(application) {
  ...
  if (null != appLauncherIconSource) {
    ...
    obj[1] = xl;
    let tmp12 = callback(tmp5(11376), obj);
    let tmp13 = callback;
  } else {
    obj = { style: null };
  ...
  const tmpResult1 = scrollOffsetY(4162);
  fn.__closure = { interpolate: scrollOffsetY(4162).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  fn.__workletHash = 2572905048492;
  fn.__initData = closure_13;
  const animatedStyle = tmpResult1.useAnimatedStyle(fn);
  let obj1 = { interpolate: scrollOffsetY(4162).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  ...
  const tmpResult2 = scrollOffsetY(4162);
  fn2.__closure = { interpolate: scrollOffsetY(4162).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  fn2.__workletHash = 8190094903650;
  fn2.__initData = closure_14;
  const animatedStyle1 = tmpResult2.useAnimatedStyle(fn2);
  const obj2 = { interpolate: scrollOffsetY(4162).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  ...
  const tmpResult3 = scrollOffsetY(4162);
  fn3.__closure = { interpolate: scrollOffsetY(4162).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  fn3.__workletHash = 14190901941859;
  fn3.__initData = closure_15;
  const animatedStyle2 = tmpResult3.useAnimatedStyle(fn3);
  let obj3 = { interpolate: scrollOffsetY(4162).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  ...
  const tmpResult4 = scrollOffsetY(4162);
  fn4.__closure = { interpolate: scrollOffsetY(4162).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE: c11 };
  fn4.__workletHash = 9589752719246;
  fn4.__initData = closure_16;
  let str2 = "";
  const animatedStyle3 = tmpResult4.useAnimatedStyle(fn4);
  if (null != application) {
    str2 = tmp(8278).getSectionName(application);
    const tmpResult5 = tmp(8278);
  }
  ...
  if (hasApplicationFlagResult) {
    hasApplicationFlagResult = tmp(7529).hasApplicationFlag(application, constants.EMBEDDED);
    const tmpResult6 = tmp(7529);
  }
  ...
  obj9[2] = tmp13(scrollOffsetY(4298).Heading, { variant: "heading-lg/bold", color: "text-overlay-light", children: str2 });
