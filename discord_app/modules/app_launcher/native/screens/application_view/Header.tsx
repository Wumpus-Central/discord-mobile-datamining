...
export default function Header(application) {
  ...
  if (null != appLauncherIconSource) {
    ...
    let tmp12 = closure_8(tmp5(12086), obj);
    let tmp13 = closure_8;
  } else {
  ...
  const tmpResult1 = application(4310);
  ...
  let obj1 = { interpolate: application(4310).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult2 = application(4310);
  ...
  const obj2 = { interpolate: application(4310).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult3 = application(4310);
  ...
  let obj3 = { interpolate: application(4310).interpolate, scrollOffsetY, HEADER_SCROLL_RANGE };
  ...
  const tmpResult4 = application(4310);
  ...
  items6[2] = tmp13(ReanimatedRexportDefault.View, {
    ...
    pointerEvents: "none",
    children: tmp13(application(4570).Heading, {
  ...
  if (null != application) {
    ...
    if (tmpResult7.isRealApplication(application)) {
      ...
      const items7 = [tmp13(tmp(8113).IconButton, obj12)];
      const obj13 = { application, onAddAppMenuClick };
      items7[1] = tmp13(tmp5(12163), obj13);
