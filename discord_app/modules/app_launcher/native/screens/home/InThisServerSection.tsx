...
function AppInThisServer(onAppSelected) {
  ...
  if (null != appLauncherIconSource) {
    ...
    tmp6 = closure_5(application(12086), obj);
  }
  const items = [
    tmp6,
    closure_5(onAppSelected(4570).Text, {
  ...
  obj.children = items;
  return closure_6(onAppSelected(8934).PressableScale, obj, application.id);
}
