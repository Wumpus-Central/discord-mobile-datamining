...
export default function LearnMoreAboutAppsSection(visible) {
  ...
  const stringResult = intl.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t["kw8/Ec"]);
  const intl2 = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  const stringResult1 = intl2.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.GZoV1O);
  const intl3 = require("../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  let obj = { sectionName: null, numItems: 1, numVisibleItems: 1, viewed: null, children: null };
  const formatToPlainStringResult = intl3.formatToPlainString(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.xx5Sug, { sectionTitle: stringResult, sectionBody: stringResult1 });
  obj[0] = require("../../../AppLauncherTypes.tsx") /* AppLauncherEntrypoint */.AppLauncherSectionName.NEW_TO_APPS;
  obj[3] = visible.visible;
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.divider };
  const items = [callback(View, obj), callback(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { accessibilityRole: "header", variant: "heading-lg/bold", color: "mobile-text-heading-primary", children: stringResult }), callback(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-xs/normal", color: "text-default", style: tmp.body, children: stringResult1 }), callback(View, { style: tmp.divider }), , ];
  ...
  obj4[2] = intl4.string(require("../../../../../intl/index.native.tsx") /* getSystemLocale */.t.Ye51oT);
  obj3[4] = callback(require("../../../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj4);
  items[4] = callback(require("../../../../../design/void/Pressables/native/Pressables.tsx") /* PressableBase */.PressableHighlight, obj3);
  items[5] = callback(View, { style: tmp.divider });
  obj[1] = items;
  obj[4] = callback2(View, obj);
  return callback(require("TrackSectionHeader.tsx"), obj);
};