...
export default function LearnMoreAboutAppsSection(visible) {
  ...
  const stringResult = intl.string(getSystemLocale /* getSystemLocale */.t["kw8/Ec"]);
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  const stringResult1 = intl2.string(getSystemLocale /* getSystemLocale */.t.GZoV1O);
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  let obj = { sectionName: null, numItems: 1, numVisibleItems: 1, viewed: null, children: null };
  const formatToPlainStringResult = intl3.formatToPlainString(getSystemLocale /* getSystemLocale */.t.xx5Sug, { sectionTitle: stringResult, sectionBody: stringResult1 });
  obj[0] = AppLauncherEntrypoint /* AppLauncherEntrypoint */.AppLauncherSectionName.NEW_TO_APPS;
  obj[3] = visible.visible;
  obj = { style: tmp.container, children: null };
  obj = { style: tmp.divider };
  const items = [callback(View, obj), callback(Text /* Text */.Text, { accessibilityRole: "header", variant: "heading-lg/bold", color: "mobile-text-heading-primary", children: stringResult }), callback(Text /* Text */.Text, { variant: "text-xs/normal", color: "text-default", style: tmp.body, children: stringResult1 }), callback(View, { style: tmp.divider }), , ];
  ...
  obj4[2] = intl4.string(getSystemLocale /* getSystemLocale */.t.Ye51oT);
  obj3[4] = callback(Text /* Text */.Text, obj4);
  items[4] = callback(PressableBase /* PressableBase */.PressableHighlight, obj3);
