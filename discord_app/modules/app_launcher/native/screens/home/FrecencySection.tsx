...
function FrecentApp(app) {
  ...
  if (null == app.section) {
    ...
    if (tmp3) {
      ...
      tmp3 = closure_11(onAppSelected(5668), obj);
    }
    const items = [tmp3];
    obj = { submitting, style: tmp.submittingOverlay };
    items[1] = closure_11(app(12189).SubmittingOverlay, obj);
    obj.children = items;
...
createStyles.appContainerDisabled = {
  backgroundColor: nativeDefault.colors.BACKGROUND_APP_LAUNCHER_ROW_DEFAULT,
  borderRadius: nativeDefault.radii.lg,
  opacity: 0.4,
};
