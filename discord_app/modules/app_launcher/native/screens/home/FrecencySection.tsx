...
import initialize from "FrecencySectionStore.tsx";
...
function FrecentApp(app) {
  ...
  if (null == app.section) {
    ...
    const appLauncherIconSource = app(11224).getAppLauncherIconSource(app.section.application);
    ...
    if (tmp3) {
      ...
      tmp3 = callback2(onAppSelected(5449), obj);
    }
    const items = [tmp3, ];
