...
import RecommendationsBannerDefault from "RecommendationsBanner" /* 12243 */;
  ...
  if (isLandscape) {
    ...
    if (showsPromoted) {
      ...
      if (showsPromoted) {
        ...
        obj13.children = closure_6(tmp4(4636).Text, obj14);
    ...
    tmp12Result2 = closure_7(tmp4(5210).PressableOpacity, obj7);
