...
import RecommendationsBannerDefault from "RecommendationsBanner" /* 12185 */;
...
export default function RecommendationsBannerCard(application) {
  ...
  if (isLandscape) {
    ...
    let tmp12Result = closure_6(tmp4(12176).BaseAppRow, obj);
  } else {
    ...
    obj4.applicationEmbedded = tmp4(9379).isEmbeddedApp(application);
    ...
    if (showsPromoted) {
      ...
      if (showsPromoted) {
        ...
        obj7.children = closure_6(tmp4(4602).Text, obj8);
    ...
    tmp12Result = closure_7(tmp4(5174).PressableOpacity, obj2);
