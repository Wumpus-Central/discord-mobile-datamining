...
import EntityBorderAppIconDefault from "EntityBorderAppIcon" /* 11229 */;
...
import getLastFetchTimeMs from "getLastFetchTimeMs" /* 11249 */;
import getUncachedChannelPermissions from "getUncachedChannelPermissions" /* 4021 */;
import initialize from "initialize" /* 11217 */;
...
function getRecommendationItemsWithViewAll(arr) {
  ...
  if (arg3 === undefined) {
    COLLAPSED_LIST_ITEM_MAX = _require(11285).COLLAPSED_LIST_ITEM_MAX;
  }
  closure_1 = tmp3;
  let bound;
  ...
  if (0 === arr.length) {
    ...
    obj[0] = _require(11265).AppLauncherHomeListItemType.RECOMMENDATION_SECTION_HEADER;
    obj[1] = arg2;
    obj[2] = arg1;
    obj[3] = length;
    obj[4] = bound;
    ...
    if (bound < length) {
      ...
      obj[0] = _require(11265).AppLauncherHomeListItemType.VIEW_ALL;
