...
export default function EmptyState() {
  ...
  const tmp4Result = importDefault(obj.isThemeLight(useTheme()) ? 11504 : 11505);
  const logAppLauncherEmptyStateView = handleApplicationSelected.useLogAppLauncherEmptyStateView(tmp2(9555).AppLauncherEmptyStateType.HOME_NO_PERMISSIONS);
