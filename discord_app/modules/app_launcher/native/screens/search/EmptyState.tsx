...
export default function EmptyState(showsGenericMessage) {
  ...
  const tmp = closure_5();
  let obj = flag(12121);
  const logAppLauncherEmptyStateView = obj.useLogAppLauncherEmptyStateView(flag(9479).AppLauncherEmptyStateType.SEARCH_EMPTY, showsGenericMessage.query);
  const items = [flag];
  ...
  obj.children = jsx(flag(4601).Text, { style: tmp.text, variant: "text-sm/medium", color: "text-default", children: null });
