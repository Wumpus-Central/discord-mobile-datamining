...
export default function EmptyState(showsGenericMessage) {
  ...
  const tmp = closure_5();
  const logAppLauncherEmptyStateView = flag(12308).useLogAppLauncherEmptyStateView(
    flag(9529).AppLauncherEmptyStateType.SEARCH_EMPTY,
  ...
  obj3.children = jsx(flag(4753).Text, {
    style: tmp.text,
