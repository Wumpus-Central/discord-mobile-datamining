...
import AppRowLabelDefault from "AppRowLabel" /* 11739 */;
import AppLauncherApplicationViewScreenInnerDefault from "AppLauncherApplicationViewScreenInner" /* 11785 */;
import AppLauncherCommandViewFooterDefault from "AppLauncherCommandViewFooter" /* 11811 */;
import DEFAULT_CONTENT_PADDINGDefault from "DEFAULT_CONTENT_PADDING" /* 11850 */;
...
const memoResult = importAllResult.memo(function AppLauncherNavigator(arg0) {
  ...
  let obj = entrypoint(4308);
  if (overrideParams == null) {
    overrideParams = obj.useKeyboardContextForType(entrypoint(1627).KeyboardTypes.APP_LAUNCHER);
  }
  const tmp4 = callback2();
  const accessibilityNativeStackOptions = entrypoint(5955).useAccessibilityNativeStackOptions();
  ...
  obj14[0] = closure_8(entrypoint(5900).AnalyticsLocationProvider, obj);
  ...
  return closure_8(entrypoint(9766).AppLauncherContext.Provider, { value: { bottomSheetExpandReasonRef, bottomSheetIndex, bottomSheetPosition, chatInputRef, entrypoint, entrypointParams, keyboardCloseReasonRef, onActivityItemSelected, width }, children });
});
