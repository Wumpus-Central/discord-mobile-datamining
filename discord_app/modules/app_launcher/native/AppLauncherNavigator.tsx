...
export default noop.memo(function AppLauncherNavigator(arg0) {
  ...
  obj14.children = closure_8(entrypoint(7214).AnalyticsLocationProvider, obj);
  ...
  return closure_8(entrypoint(11287).AppLauncherContext.Provider, { value: { bottomSheetExpandReasonRef, bottomSheetIndex, bottomSheetPosition, chatInputRef, entrypoint, entrypointParams: tmp20, keyboardCloseReasonRef, onActivityItemSelected, width }, children: closure_8(entrypoint(1484).NavigationIndependentTree, obj13) });
});