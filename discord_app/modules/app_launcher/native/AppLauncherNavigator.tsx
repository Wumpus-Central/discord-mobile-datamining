...
const memoResult = importAllResult.memo(function AppLauncherNavigator(arg0) {
  ...
  const accessibilityNativeStackOptions = entrypoint(5636).useAccessibilityNativeStackOptions();
  ...
  obj = { value: tmp3(importDefault(5601).APP_LAUNCHER).analyticsLocations, children: null };
  ...
  const obj2 = { name: AppLauncherRouteName.HOME, component: importDefault(11381), initialParams: null };
  ...
  const obj4 = { name: AppLauncherRouteName.APPLICATION_VIEW, component: importDefault(11425), initialParams: null };
  const obj5 = { context };
  let obj6 = obj12;
  ...
  const obj7 = { name: AppLauncherRouteName.COMMAND_VIEW, component: importDefault(11454), initialParams: null };
  let tmp15;
  ...
  const obj10 = { name: AppLauncherRouteName.APP_LIST_VIEW, component: importDefault(11493), initialParams: null };
  ...
  obj13[1] = closure_8(entrypoint(5581).AnalyticsLocationProvider, obj);
  ...
  return closure_8(entrypoint(11060).AppLauncherContext.Provider, { value: { bottomSheetExpandReasonRef, bottomSheetIndex, bottomSheetPosition, chatInputRef, entrypoint, entrypointParams, keyboardCloseReasonRef, onActivityItemSelected, width }, children });
});
