...
export default function useAppLauncherOnboardingContent(channelId) {
  ...
  if (tmp3.canShowAppsOrActivitiesBanner) {
    ...
    if (
      (function useHasUsedActivities(channel) {
        ...
        const activityApplications = channelId(12172).useActivityApplications(obj4);
        let flag = false;
        ...
        const tmpResult = channelId(12172);
  ...
  const tmp7 = _slicedToArray(
    channelId(7495).useSelectedDismissibleContent(items, constants.APP_LAUNCHER_ONBOARDING),
    2,
  );
