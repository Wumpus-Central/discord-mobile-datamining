...
export default function useCanShowAppLauncherOnboarding(channelId) {
  ...
  const tmp2Result2 = channelId(7440);
  ...
  result = channelId(4425).useIsDismissibleContentDismissed_UNSAFE(
    tmp2(1943).DismissibleContent.APP_LAUNCHER_ONBOARDING_BOTS_BANNER,
  );
  const tmp2Result5 = channelId(4425);
  let result1 = channelId(4425).useIsDismissibleContentDismissed_UNSAFE(
    tmp2(1943).DismissibleContent.APP_LAUNCHER_ONBOARDING_APPS_BANNER,
  );
  const tmp2Result6 = channelId(4425);
  let tmp30 = null != stateFromStores4;
  const result2 = channelId(4425).useIsDismissibleContentDismissed_UNSAFE(
