...
export default function useCanShowAppLauncherOnboarding(channelId) {
  ...
  result = channelId(4649).useIsDismissibleContentDismissed_UNSAFE(
    tmp2(2028).DismissibleContent.APP_LAUNCHER_ONBOARDING_BOTS_BANNER,
  );
  const tmp2Result14 = channelId(4649);
  let result1 = channelId(4649).useIsDismissibleContentDismissed_UNSAFE(
  ...
  const result2 = channelId(4649).useIsDismissibleContentDismissed_UNSAFE(
