...
import initialize2 from "initialize" /* 11218 */;
...
export default function useCanShowAppLauncherOnboarding(channelId) {
  ...
  result = guild_id(4196).useIsDismissibleContentDismissed_UNSAFE(tmp2(1377).DismissibleContent.APP_LAUNCHER_ONBOARDING_BOTS_BANNER);
