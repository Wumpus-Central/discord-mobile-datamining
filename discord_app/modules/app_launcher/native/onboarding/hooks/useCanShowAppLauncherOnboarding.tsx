...
export default function useCanShowAppLauncherOnboarding(channelId) {
  ...
  result = channelId(4458).useIsDismissibleContentDismissed_UNSAFE(
    tmp2(1944).DismissibleContent.APP_LAUNCHER_ONBOARDING_BOTS_BANNER,
  );
  const tmp2Result14 = channelId(4458);
  let result1 = channelId(4458).useIsDismissibleContentDismissed_UNSAFE(
  ...
  const result2 = channelId(4458).useIsDismissibleContentDismissed_UNSAFE(
  ...
  if (null != stateFromStores) {
    ...
    if (
      ...
      tmp2(1944).DismissibleContent.APP_LAUNCHER_GLOBAL_SEARCH_ONBOARDING
    ) {
