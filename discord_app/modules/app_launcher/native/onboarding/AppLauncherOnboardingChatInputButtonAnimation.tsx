...
let closure_9 = createCacheKey.createStyles(() => {
  const sum = require("../../../../design/components/Button/native/ButtonConstants.native.tsx") /* MINIMUM_HIT_AREA */.SMALL_BUTTON_HEIGHT + require("../../../../design/components/Button/native/ButtonConstants.native.tsx") /* MINIMUM_HIT_AREA */.SMALL_BUTTON_PADDING + 2;
  let obj = { fakeButton: null, glowMask: null, glowLottie: null, trinketsLottie: null, glowAnimation: null };
  obj = { zIndex: 3, borderWidth: 1.5, borderColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.BACKGROUND_BRAND, borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").radii.round, alignItems: "center", justifyContent: "center", width: sum, height: sum, marginLeft: 4 };
  obj[0] = obj;
  obj = { zIndex: 1, position: "absolute", borderRadius: require("../../../../../discord_common/js/packages/tokens/native.tsx").radii.round, top: 0, left: 0, width: sum, height: sum, backgroundColor: require("../../../../../discord_common/js/packages/tokens/native.tsx").colors.BACKGROUND_BASE_LOW, marginLeft: 4 };
  obj[1] = obj;
...
export const AppLauncherOnboardingChatInputButtonAnimation = function AppLauncherOnboardingChatInputButtonAnimation(channelId) {
  ...
  let obj1 = require("../../../client_themes/native/ClientThemesOverrides.tsx") /* useGradientBottom */;
  const gradientBottom = obj1.useGradientBottom();
  require("hooks/useAppLauncherOnboardingContent.tsx")({ channelId: channelId.channelId });
  obj = { children: null };
  ...
  obj1[2] = require("../../../../../_runtime/metro/11526__.js");
  obj1[3] = !stateFromStores;
  const items2 = [callback(require("../../../../components_native/common/LottieAnimationView.tsx"), obj1), , ];
  ...
  obj[4] = items2;
  const items4 = [callback2(require("../../../reanimated/ReanimatedRexport.tsx").View, obj), ];
  ...
  const tmp5 = require("../../../../components_native/common/LottieAnimationView.tsx");
  obj3[2] = require("../../../../../_runtime/metro/11361__.js");
  obj3[3] = !stateFromStores;
  items4[1] = callback(require("../../../../components_native/common/LottieAnimationView.tsx"), obj3);
  obj[0] = items4;
