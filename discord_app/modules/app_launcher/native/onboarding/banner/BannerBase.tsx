...
createStyles.trinketsLottie = { width: 175, height: 175, position: "absolute", top: -38, left: -27, zIndex: 1, pointerEvents: "none" };
...
export default function BannerBase(arg0) {
  ...
  obj = { bannerMeasured: sharedValue, withDelay: require("ReanimatedRexport").withDelay, withSpring: require("spring").withSpring, SPRING_CONFIG };
  fn.__closure = obj;
  ...
  obj.children = items4;
  return closure_8(sharedValue(4373).View, obj);
};