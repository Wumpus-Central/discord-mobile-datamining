...
export default function ExpandableList(items) {
  ...
  obj = { collapsedListHeight: sharedValue, withTiming: memo1(4304).withTiming, containerHeight: derivedValue, timingStandard: memo1(4307).timingStandard };
  A.__closure = obj;
  ...
  if (!showsExpandCTAOverride) {
    ...
    obj6[1] = tmp16(tmp9(4299).Text, obj8);
    ...
    obj5 = tmp16(tmp9(5374).TableRow, obj5);
    obj7[0] = obj5;
