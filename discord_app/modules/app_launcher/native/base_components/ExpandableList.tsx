...
export default function ExpandableList(onExpand) {
  ...
  obj = { collapsedListHeight: sharedValue, withTiming: memo1(4606).withTiming, containerHeight: derivedValue, timingStandard: memo1(4609).timingStandard };
  A.__closure = obj;
  ...
  if (!showsExpandCTAOverride) {
    ...
    obj6.children = tmp16(tmp9(4601).Text, obj8);
    ...
    obj5 = tmp16(tmp9(5655).TableRow, obj5);
    obj7.children = obj5;
