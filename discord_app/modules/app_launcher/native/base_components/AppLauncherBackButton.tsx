...
export default function AppLauncherBackButton(onPress) {
  ...
  obj = { size: "sm", variant: "secondary-overlay", icon: importDefault(canGoBackResult ? 5710 : 5762), onPress: onPress.onPress, accessibilityLabel: null, maxFontSizeMultiplier: 1.5 };
