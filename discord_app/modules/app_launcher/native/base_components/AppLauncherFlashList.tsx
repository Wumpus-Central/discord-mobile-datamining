...
const forwardRefResult = noop.forwardRef((simultaneousHandlers, ref) => {
  ...
  if (
    ...
    simultaneousHandlers.simultaneousHandlers(9602).AppLauncherEntrypoint.VOICE
  ) {
    const obj5 = {
    ...
    obj5.ref = ref;
    let tmp5 = jsx(tmp(9073).AnimatedFlashList, {
      renderScrollComponent: memo,
      ListHeaderComponent: null,
      onScroll: null,
      contentContainerStyle: null,
    ...
    obj6.ref = ref;
    tmp5 = jsx(tmp(9073).BottomSheetFlashList, {
      ListHeaderComponent: null,
      onScroll: null,
      contentContainerStyle: null,
      scrollIndicatorInsets: null,
