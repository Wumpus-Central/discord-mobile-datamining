...
import AppLauncherAutocompleteOptionDefault from "AppLauncherAutocompleteOption" /* 12240 */;
import AppLauncherTextInputOptionDefault from "AppLauncherTextInputOption" /* 12242 */;
...
fn(4605);
let createStyles = { dismissableOptionWrapper: { flexDirection: "row", alignItems: "center" }, optionViewContainer: { flex: 1 }, dismissButton: null, option: null };
...
export default function AppLauncherCommandOption(option) {
    ...
    if (tmp2(1894).ApplicationCommandOptionType.INTEGER !== type) {
      if (tmp2(1894).ApplicationCommandOptionType.NUMBER !== type) {
        if (tmp2(1894).ApplicationCommandOptionType.ATTACHMENT === type) {
          ...
          const obj1 = { option: name, initialValue: null, onMentionablePress: null, onActionSheetDismiss: null, channel: null, autoFocus: null, hasError: null, onPress: null };
          let first1;
          if (optionValues.current[name.name] != null) {
            first1 = tmp31[0];
          }
          ...
          const obj2 = { style: tmp.option, option: name, initialValue: null, onRolePress: null, onActionSheetDismiss: null, channel: null, autoFocus: null, hasError: null, onPress: null };
          let first2;
          if (optionValues.current[name.name] != null) {
            first2 = tmp24[0];
          }
          ...
          const obj3 = { style: tmp.option, option: name, initialValue: null, onUserPress: null, onActionSheetDismiss: null, channel: null, autoFocus: null, hasError: null, onPress: null };
          let first3;
          if (optionValues.current[name.name] != null) {
            first3 = tmp17[0];
          }
          ...
          obj = { style: tmp.option, option: name, initialValue: null, onChannelPress: null, onActionSheetDismiss: null, channel: null, autoFocus: null, hasError: null, onPress: null };
          let first4;
          if (optionValues.current[name.name] != null) {
            first4 = tmp8[0];
          }
        ...
        if (null != onDismiss) {
          ...
          items[1] = tmp13(tmp2(5173).PressableOpacity, obj6);
          obj4.children = items;
  ...
  if (null != name.choices) {
    const obj7 = { style: tmp.option, option: name, initialValue: null, onSelect: null, onOpenChoicesSheet: null, onDismissChoicesSheet: null, autoFocus: null, hasError: null };
    let first5;
