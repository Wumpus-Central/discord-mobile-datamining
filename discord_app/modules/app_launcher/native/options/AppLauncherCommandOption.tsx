...
export default function AppLauncherCommandOption(option) {
    ...
    if (tmp2(1906).ApplicationCommandOptionType.INTEGER !== type) {
      if (tmp2(1906).ApplicationCommandOptionType.NUMBER !== type) {
        if (tmp2(1906).ApplicationCommandOptionType.ATTACHMENT === type) {
          ...
          let tmp28Result = onDismiss(importDefault(11366), obj, name.name);
          let tmp13 = onDismiss;
          ...
          obj[4] = hasError;
          tmp28Result = tmp35(importDefault(11368), obj, name.name);
          tmp13 = tmp35;
          const tmp37 = importDefault(11368);
          ...
          obj1[6] = hasError;
          obj1[7] = onPress;
          tmp28Result = tmp28(importDefault(11369), obj1);
          tmp13 = tmp28;
          const tmp30 = importDefault(11369);
          ...
          obj2[7] = hasError;
          obj2[8] = onPress;
          tmp28Result = tmp21(importDefault(11374), obj2, name.name);
          tmp13 = tmp21;
          const tmp23 = importDefault(11374);
          ...
          obj3[7] = hasError;
          obj3[8] = onPress;
          tmp28Result = tmp14(importDefault(11375), obj3, name.name);
          tmp13 = tmp14;
          const tmp16 = importDefault(11375);
          ...
          obj[7] = hasError;
          obj[8] = onPress;
          tmp28Result = tmp5(importDefault(11378), obj, name.name);
          tmp13 = tmp5;
          const tmp7 = importDefault(11378);
        } else {
          return null;
        }
        ...
        if (null != onDismiss) {
          ...
          obj6[2] = tmp13(tmp2(6739).CircleXIcon, { size: "md" });
          items[1] = tmp13(tmp2(4721).PressableOpacity, obj6);
          obj4[1] = items;
  ...
  if (null != name.choices) {
    ...
    obj7[7] = hasError;
    name = name.name;
    onDismiss(importDefault(11355), obj7, name);
    const tmp57 = importDefault(11355);
