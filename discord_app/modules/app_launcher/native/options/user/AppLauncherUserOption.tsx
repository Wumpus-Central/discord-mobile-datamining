...
export default function AppLauncherUserOption(option) {
  ...
  const tmp = c7();
  [tmp6, c6] = _slicedToArray(channel.useState(() => {
    let userId = null;
  ...
  obj.onPress = function onPress() {
    ...
    obj2.openLazy(asyncRequireImpl(12255, dependencyMap.paths), AppLauncherUserListActionSheet.APP_LAUNCHER_USER_LIST_ACTION_SHEET_KEY, obj);
  };
  if (null != tmp8) {
    ...
    const obj1 = { icon: tmp9(tmp2(10989).UserCircleIcon, { size: "sm", color: "interactive-text-default" }), wrapperStyle: tmp.iconWrapper };
  ...
  if (null != tmp8) {
    ...
    if (null != tmp6) {
      ...
      tmp9Result = tmp9(tmp2(4601).Text, obj3);
    }
  }
