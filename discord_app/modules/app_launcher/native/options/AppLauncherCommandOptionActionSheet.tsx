// === Module 12423: AppLauncherCommandOptionActionSheet ===
...
export const AppLauncherCommandOptionActionSheet = function AppLauncherCommandOptionActionSheet(startExpanded) {
  ...
  const obj4 = {
    ...
    children: jsx(merged(7445).ActionSheetCloseButton, {
      onPress() {
  ...
  obj3.leading = <View style={{ alignSelf: "flex-start" }}>{jsx(merged(7445).ActionSheetCloseButton, {
    onPress() {
      ActionSheetActionCreatorsDefault.hideActionSheet();
      const onDismiss = merged.onDismiss;
      if (onDismiss != null) {
