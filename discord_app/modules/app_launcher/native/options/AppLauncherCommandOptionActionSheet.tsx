...
export const AppLauncherCommandOptionActionSheet = function AppLauncherCommandOptionActionSheet(startExpanded) {
  ...
  obj.leading = <View style={{ alignSelf: "flex-start" }}>{jsx(merged(7271).ActionSheetCloseButton, {
    onPress() {
      ActionSheetActionCreatorsDefault.hideActionSheet();
      const onDismiss = merged.onDismiss;
      if (onDismiss != null) {
  ...
  obj.header = jsx(merged(7222).BottomSheetTitleHeader, {
    style: { alignSelf: "flex-start" },
    children: jsx(merged(7271).ActionSheetCloseButton, {
      onPress() {
        ActionSheetActionCreatorsDefault.hideActionSheet();
  ...
  return jsx(merged(7223).BottomSheet, {
    style: { alignSelf: "flex-start" },
    children: jsx(merged(7271).ActionSheetCloseButton, {
      onPress() {
        ActionSheetActionCreatorsDefault.hideActionSheet();
