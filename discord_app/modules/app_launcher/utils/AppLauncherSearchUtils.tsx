...
export const useLocalSearchResults = function useLocalSearchResults(context) {
  ...
  const memo3 = obj2.useMemo(() => {
    ...
    const items3 = [
      context2(1954).ApplicationCommandType.CHAT,
      context2(1954).ApplicationCommandType.PRIMARY_ENTRY_POINT,
    ];
...
export const useGlobalSearchResults = function useGlobalSearchResults(fetches) {
  ...
  const stateFromStoresObject = substr(586).useStateFromStoresObject(
    items,
    () => {
      ...
      obj = {
        ...
        guildId: guild_id,
        page: first,
        integrationType: substr(8442).ApplicationIntegrationType.USER_INSTALL,
        ...
        source: substr(11864).SearchAppsRequestSource.APP_LAUNCHER,
      };
