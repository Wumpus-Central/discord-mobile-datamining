...
export const useMessageRequestActions = function useMessageRequestActions(user) {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            if (!isUserProfileLoading) {
              ...
              mutualGuilds = 1;
              let obj6 = {
                value: onAcceptSuccess(onRejectSuccess[10])(channel_id.id, channel_id.getAvatarURL(undefined, 80), {
  ...
  const markAsNotSpam = obj.useCallback((channel, arg1, arg2) => {
    ...
    function onConfirm(setting, is_dont_show_again_checked) {
      ...
      AnalyticsUtilsDefault.track(AnalyticEvents.MESSAGE_REQUEST_ACTION, {
    ...
    if (null == setting) {
      let obj = {
        ...
        onCancel() {
          AnalyticsUtilsDefault.track(AnalyticEvents.MESSAGE_REQUEST_ACTION, {
            action: constants.DISMISS_HAM_CONFIRMATION_PROMPT,
            channel_id: user.id,
          });
        },
      };
