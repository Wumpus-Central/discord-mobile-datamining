// === Module 17452: MessageRequestMutualServers ===
...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (iconSize === undefined) {
    iconSize = iconSize(5889).GuildIconSizes.XXSMALL_12;
  }
  ...
  const mutualGuildsForMessageRequests = iconSize(17453).useMutualGuildsForMessageRequests(userId);
  ...
  if (tmp9) {
    ...
    tmp9 = closure_4(tmp4(12966).GuildIconPile, obj4);
  }
  const items1 = [tmp9, ];
  ...
  if (null != onPress) {
    ...
    if (length > 0) {
      ...
      tmp11Result = closure_4(tmp4(5427).PressableOpacity, obj6);
    }
  }
  return tmp11Result;
};