...
export default function MessageRequestMutualServers(textVariant) {
  ...
  if (tmp9) {
    ...
    tmp9 = closure_4(tmp4(12711).GuildIconPile, obj1);
  }
  const items1 = [tmp9];
  ...
  items1[1] = closure_4(iconSize(4602).Text, obj2);
  obj.children = items1;
  ...
  if (null != onPress) {
    ...
    if (length > 0) {
      ...
      tmp11Result = closure_4(tmp4(5174).PressableOpacity, obj3);
    }
  }
  return tmp11Result;
}
