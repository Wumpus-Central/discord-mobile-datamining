...
import MessageRequestPreviewDefault from "MessageRequestPreview" /* 17359 */;
import MessageRequestMutualServersDefault from "MessageRequestMutualServers" /* 17360 */;
...
export default function MessageRequestRowSenderDetails(isRestricted) {
  ...
  if (tmp9Result) {
    ...
    const items3 = [" ", otherUser(4601).getUserTag(otherUser)];
    obj10.children = items3;
    tmp9Result = closure_6(otherUser(4753).Text, obj10);
    const tmp2Result = otherUser(4601);
  }
  items2[1] = tmp9Result;
