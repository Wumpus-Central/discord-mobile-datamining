...
import MessageRequestPreviewDefault from "MessageRequestPreview" /* 17128 */;
import MessageRequestMutualServersDefault from "MessageRequestMutualServers" /* 17129 */;
...
export default function MessageRequestRowSenderDetails(isRestricted) {
  ...
  if (tmp9Result) {
    ...
    tmp9Result = closure_6(otherUser(4636).Text, obj10);
