// === Module 15790: MessageRequestRowSenderDetails ===
...
export default function MessageRequestRowSenderDetails(isRestricted) {
  ...
  if (!flag) {
    ...
    obj8[1] = channel;
    tmp11Result = tmp11(tmp7(15792), obj8);
  }
  ...
  if (flag) {
    ...
    flag = tmp11(tmp7(15793), obj9);
    const tmp7Result = tmp7(15793);
  }
