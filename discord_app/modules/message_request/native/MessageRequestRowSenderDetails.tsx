...
import MessageRequestPreviewDefault from "MessageRequestPreview" /* 17088 */;
import MessageRequestMutualServersDefault from "MessageRequestMutualServers" /* 17089 */;
...
export default function MessageRequestRowSenderDetails(isRestricted) {
  ...
  if (tmp9Result) {
    ...
    const items3 = [" ", otherUser(4482).getUserTag(otherUser)];
    obj10.children = items3;
    tmp9Result = closure_6(otherUser(4634).Text, obj10);
    const tmp2Result = otherUser(4482);
  }
  items2[1] = tmp9Result;
