...
export default function MessageRequestRowSenderDetails(isRestricted) {
  ...
  if (tmp9Result) {
    ...
    const items3 = [" ", tmp2(4124).getUserTag(otherUser)];
    obj6[2] = items3;
  ...
  if (!flag) {
    ...
    obj8[1] = channel;
    tmp11Result = tmp11(tmp7(15823), obj8);
  }
  ...
  if (flag) {
    ...
    flag = tmp11(tmp7(15824), obj9);
    const tmp7Result = tmp7(15824);
  }
