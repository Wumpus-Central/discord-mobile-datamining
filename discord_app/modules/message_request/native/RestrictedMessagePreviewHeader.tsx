...
export default function RestrictedMessagePreviewHeader(channel) {
  ...
  const callback2 = userTag.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(12671, dependencyMap.paths), "MutualGuildsActionSheet", obj);
  }, items2);
  ...
  obj2.children = closure_6(channel(analyticsLocations[20]).Text, { variant: "heading-xxl/extrabold", color: "mobile-text-heading-primary", children: name });
