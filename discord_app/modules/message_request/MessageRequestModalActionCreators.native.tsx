...
export const openAcceptMessageRequestConfirmModal = function openAcceptMessageRequestConfirmModal(arg0) {
  ...
  obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t["66tnno"]);
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj[1] = intl2.string(getSystemLocale /* getSystemLocale */.t["c/k4SW"]);
  const intl3 = getSystemLocale /* getSystemLocale */.intl;
  obj[2] = intl3.string(getSystemLocale /* getSystemLocale */.t["ETE/oC"]);
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj[3] = intl4.string(getSystemLocale /* getSystemLocale */.t["cY+Oob"]);
  obj[4] = onConfirm;
  obj[5] = onCancel;
...
export const onMarkAsNotSpamConfirmationModal = function onMarkAsNotSpamConfirmationModal(arg0) {
  ...
  ACTION_SHEET_HEIGHT_HALF.openLazy(asyncRequireImpl /* asyncRequireImpl */(11720, dependencyMap.paths), "SpamMessageHamActionSheet", { channel, onConfirm, onCancel });
};