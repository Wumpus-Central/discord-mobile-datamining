// discord_app/modules/jank_stats/native/getJankScreenName.tsx
import RootNavigationRef from "../../main_tabs_v2/RootNavigationRef.native.tsx";
import getScreenAnalyticsName from "../../tti_analytics/native/getScreenAnalyticsName.tsx";
...
({
  CHANNEL_DETAILS_SCREEN: c2,
  CREATE_THREAD_SCREEN: c3,
  EMPTY_CHAT_SCREEN: closure_4,
  SURFACE_SEPARATOR: hasOwnProperty,
  UNKNOWN_SCREEN: metroRequire,
} = JankScreenConstants);
  ...
  if (null != rootState) {
    while (true) {
      ...
      if (null == tmp3) {
        ...
        if (0 === focused.length) {
          let obj9 = { screen, expectedScreenIds: "", focusedRoute: "accessible" };
          let obj15 = obj9;
        } else {
