...
import _modDef17761 from "../../../../_runtime/metro/17761__.js";
...
let obj3 = {
  [ALL]: fn(17757).ListBulletsIcon,
  [CHANNEL]: fn(17730).ChannelListIcon,
  [CHANNEL_OVERWRITE]: fn(17730).ChannelListIcon,
  [EMOJI]: fn(8897).ReactionIcon,
  [GUILD]: fn(4592).CircleInformationIcon,
  [GUILD_PROFILE]: fn(4592).CircleInformationIcon,
  [INTEGRATION]: fn(15070).PuzzlePieceIcon,
  [INVITE]: fn(4580).LinkIcon,
  [ROLE]: fn(8799).FlagIcon,
  [USER]: fn(5174).GroupIcon,
  [WEBHOOK]: fn(16935).WebhookIcon,
  [STAGE_INSTANCE]: fn(5182).StageIcon,
  [GUILD_SCHEDULED_EVENT]: fn(9925).CalendarIcon,
  [GUILD_SCHEDULED_EVENT_EXCEPTION]: fn(9925).CalendarIcon,
  [THREAD]: fn(5158).ThreadIcon,
  [STICKER]: fn(10252).StickerIcon,
  [APPLICATION_COMMAND]: fn(11359).SlashBoxIcon,
  [AUTO_MODERATION_RULE]: fn(16935).WebhookIcon,
  [GUILD_SOUNDBOARD]: fn(12671).SoundboardIcon,
  [ONBOARDING_PROMPT]: fn(5174).GroupIcon,
  [GUILD_ONBOARDING]: fn(5174).GroupIcon,
  [HOME_SETTINGS]: fn(5174).GroupIcon,
  [GUILD_MEMBER_VERIFICATION]: fn(5174).GroupIcon,
  [VOICE_CHANNEL_STATUS]: fn(17730).ChannelListIcon,
  [GUILD_HOME]: fn(17759).HomeIcon,
  [UNKNOWN]: fn(11258).CircleQuestionIcon,
};
({
  ALL,
  CHANNEL,
