...
function AuditIcons(action) {
  ...
  let obj = { size: "custom", style: tmp.iconComponent };
...
const createCacheKey = { borderRadius: ThemesDefault.radii.round, width: 13, height: 13, bottom: 0, right: 0, backgroundColor: ThemesDefault.colors.BACKGROUND_SURFACE_HIGH };
...
const result = require("obj132").fileFinishedImporting("modules/guild_moderation/native/AuditLogActionIcon.tsx");

export default function AuditLogActionIcon(action) {
  { style: callback4().actionImageContainer, children: callback2(AuditIcons, obj) };
