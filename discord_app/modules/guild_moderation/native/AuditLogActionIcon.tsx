...
import _modDef17555 from "../../../../_runtime/metro/17555__.js";
import _modDef17556 from "../../../../_runtime/metro/17556__.js";
import _modDef17557 from "../../../../_runtime/metro/17557__.js";
...
createStyles = {
  [ALL]: fn(17551).ListBulletsIcon,
  [CHANNEL]: fn(17524).ChannelListIcon,
  [CHANNEL_OVERWRITE]: fn(17524).ChannelListIcon,
  [EMOJI]: fn(8762).ReactionIcon,
  [GUILD]: fn(4515).CircleInformationIcon,
  [GUILD_PROFILE]: fn(4515).CircleInformationIcon,
  [INTEGRATION]: fn(14957).PuzzlePieceIcon,
  [INVITE]: fn(4503).LinkIcon,
  [ROLE]: fn(8669).FlagIcon,
  [USER]: fn(5089).GroupIcon,
  [WEBHOOK]: fn(16729).WebhookIcon,
  [STAGE_INSTANCE]: fn(5097).StageIcon,
  [GUILD_SCHEDULED_EVENT]: fn(9790).CalendarIcon,
  [GUILD_SCHEDULED_EVENT_EXCEPTION]: fn(9790).CalendarIcon,
  [THREAD]: fn(5073).ThreadIcon,
  [STICKER]: fn(10119).StickerIcon,
  [APPLICATION_COMMAND]: fn(11218).SlashBoxIcon,
  [AUTO_MODERATION_RULE]: fn(16729).WebhookIcon,
  [GUILD_SOUNDBOARD]: fn(12532).SoundboardIcon,
  ...
  [VOICE_CHANNEL_STATUS]: fn(17524).ChannelListIcon,
  [GUILD_HOME]: fn(17553).HomeIcon,
  [UNKNOWN]: fn(11110).CircleQuestionIcon,
};
({
  ALL,
  CHANNEL,
