...
let items = [obj, , , , , , ];
obj = {
  value: obj132Default.Seconds.HOUR,
  getLabel() {
    const intl = getSystemLocale.intl;
...
items[1] = obj;
items[2] = {
  value: 6 * obj132Default.Seconds.HOUR,
  getLabel() {
    const intl = getSystemLocale.intl;
...
items[3] = {
  value: 12 * obj132Default.Seconds.HOUR,
  getLabel() {
    const intl = getSystemLocale.intl;
...
items[4] = {
  value: obj132Default.Seconds.DAY,
  getLabel() {
    const intl = getSystemLocale.intl;
...
items[5] = {
  value: 3 * obj132Default.Seconds.DAY,
  getLabel() {
    const intl = getSystemLocale.intl;
...
items[6] = {
  value: 7 * obj132Default.Seconds.DAY,
  getLabel() {
    const intl = getSystemLocale.intl;
...
const memoResult = importAllResult.memo(function BanConfirm(arg0) {
  ...
  if (null != stateFromStores1) {
    ...
    if (null != stateFromStores) {
      ...
      obj[0] = importDefault(onBan[9]).space.PX_24;
      obj[1] = insets.bottom;
      obj[2] = obj;
      ...
      let tmp4Result = importDefault(onBan[16]);
      obj4[0] = tmp4Result.getName(stateFromStores1);
      obj3[2] = intl.format(require(onBan[6]).t.Qd6w7T, obj4);
      items4[1] = callback(require(onBan[15]).Text, obj3);
      const obj5 = { variant: "text-lg/bold", color: "text-feedback-warning", children: null };
      obj5[2] = stateFromStores.name;
      items4[2] = callback(require(onBan[15]).Text, obj5);
      obj1[1] = items4;
      ...
      tmp4Result = importDefault(onBan[16]);
      obj7[0] = tmp4Result.getName(stateFromStores1);
      obj6[3] = intl2.format(require(onBan[6]).t["8jV9fx"], obj7);
      items5[1] = callback(require(onBan[15]).Text, obj6);
      const obj8 = { title: null, defaultValue: null, onChange: null, hasIcons: false, children: null };
      const intl3 = require(onBan[6]).intl;
      obj8[0] = intl3.string(require(onBan[6]).t["8l3W0y"]);
      obj8[1] = items[0].value;
      obj8[2] = function onChange(current) {
        closure_5.current = current;
      };
      obj8[4] = items.map((item, index) => callback2(callback(onBan[18]).TableRadioRow, { value: index, label: item.getLabel() }, index));
      items5[2] = callback(require(onBan[17]).TableRadioGroup, obj8);
      const obj9 = { ref: null, containerStyle: null, label: null, maxLength: 512, onChange: null };
      obj9[0] = ref1;
      const obj10 = { marginVertical: null };
      obj10[0] = importDefault(onBan[9]).space.PX_16;
      obj9[1] = obj10;
      const intl4 = require(onBan[6]).intl;
      obj9[2] = intl4.string(require(onBan[6]).t.w4Ivys);
      obj9[4] = function onChange(current) {
        closure_6.current = current;
      };
      items5[3] = callback(require(onBan[19]).TextArea, obj9);
      const obj11 = { style: null, children: null };
      const obj12 = { marginBottom: null };
      obj12[0] = importDefault(onBan[9]).space.PX_16;
      obj11[0] = obj12;
      const obj13 = { variant: "destructive", text: null, onPress: null, disabled: null };
      const intl5 = require(onBan[6]).intl;
      obj13[1] = intl5.string(require(onBan[6]).t["5MBJ5M"]);
      obj13[2] = tmp12;
      obj13[3] = tmp11.banning;
      obj11[1] = callback(require(onBan[20]).Button, obj13);
      ...
      if (tmp11.banError) {
        ...
        obj15[0] = importDefault(onBan[16]).getName(stateFromStores1);
        obj14[3] = intl6.format(require(onBan[6]).t["/K6eer"], obj15);
        tmp14Result = callback(require(onBan[15]).Text, obj14);
        const tmp4Result1 = importDefault(onBan[16]);
      }
      const obj16 = { children: null };
      items5[5] = tmp14Result;
      obj16[0] = items5;
      obj[3] = callback2(closure_12, obj16);
      tmp14Result = callback(c7, obj);
    }
  }
  return tmp14Result;
});
const result = require("obj132").fileFinishedImporting("modules/guild_moderation/native/BanConfirm.tsx");
