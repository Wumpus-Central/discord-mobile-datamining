...
export default function ApplicationEducation(arg0) {
  ...
  if (accountScopes.includes(set.OAuth2Scopes.SDK_SOCIAL_LAYER)) {
    ...
    obj3[0] = tmp4(10413).ChatSmileIcon;
    ...
    obj4[0] = tmp4(8656).GameControllerIcon;
    ...
    if (accountScopes.includes(tmp4(8796).OAuth2Scopes.SDK_SOCIAL_LAYER_PRESENCE)) {
      ...
      obj9[0] = tmp4(8656).GameControllerIcon;
      ...
      obj10[0] = tmp4(5905).SettingsIcon;
    ...
    if (0 !== items.length) {
      ...
      obj11[1] = items1;
      const items2 = [closure_6(View, obj11), callback(tmp4(10415).AuthorizeFormSeparator, {})];
      obj13[0] = items2;
