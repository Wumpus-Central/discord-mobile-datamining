// === Module 9285: IntegrationTypeSelector ===
...
fn(4560);
let createStyles = { container: { alignItems: "center", flexDirection: "column" }, header: { justifyContent: "center", alignItems: "center", gap: 16, marginTop: 24, marginBottom: 32, width: "100%" }, rows: null, divider: null, learnMore: null, descriptionContainer: null, descriptionMainContainer: null, appIcon: null, appIconMask: null, loadingIcon: null };
createStyles = { alignSelf: "stretch", borderRadius: nativeDefault.radii.sm };
createStyles.rows = createStyles;
createStyles.divider = { height: StyleSheet.hairlineWidth, backgroundColor: nativeDefault.colors.BORDER_SUBTLE, marginTop: -1 * StyleSheet.hairlineWidth };
createStyles.learnMore = { marginVertical: 16 };
let obj1 = { height: StyleSheet.hairlineWidth, backgroundColor: nativeDefault.colors.BORDER_SUBTLE, marginTop: -1 * StyleSheet.hairlineWidth };
createStyles.descriptionContainer = { backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, width: "100%", borderRadius: nativeDefault.radii.sm };
...
const obj2 = { backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, width: "100%", borderRadius: nativeDefault.radii.sm };
...
export default function IntegrationTypeSelector(application) {
  ...
  const memo1 = noop.useMemo(() => {
    let obj = { type: ApplicationIntegrationType.ApplicationIntegrationType.USER_INSTALL, icon: UserPlusIcon.UserPlusIcon, label: null, subLabel: null, beta: false };
    const intl = util.intl;
    obj.label = intl.string(util.t.aCg60P);
    const intl2 = util.intl;
    obj.subLabel = intl2.string(util.t.YeiIUZ);
    const items = [obj, ];
    obj = { type: ApplicationIntegrationType.ApplicationIntegrationType.GUILD_INSTALL, icon: ServerIcon.ServerIcon, label: null, subLabel: null, beta: false };
