...
export default function OAuth2AuthorizeModal(arg0) {
  ...
  obj2[3] = tmp11Result;
  const items2 = [callback(_require(5433).PressableOpacity, obj2), , ];
  ...
  obj5[1] = callback(_require(4734).Text, obj6);
  ...
  items4[1] = callback(_require(6803).SafeAreaPaddingView, obj7);
  obj[1] = items4;
