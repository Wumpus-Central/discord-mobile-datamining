...
export default function OAuth2AuthorizeModal(arg0) {
  ...
  if (null != tmp4.backStep) {
    ...
    let tmp11Result = closure_5(tmp5(9709).ArrowSmallLeftIcon, obj3);
  } else {
    const obj4 = { color: tmp2(576).colors.INTERACTIVE_TEXT_DEFAULT };
    tmp11Result = closure_5(tmp5(5761).XSmallIcon, obj4);
  }
  ...
  obj7.style = items3;
  items2[2] = closure_5(sharedValue(4373).View, obj7);
  obj.children = items2;
  ...
  obj8.children = closure_5(sharedValue(9711), obj9);
