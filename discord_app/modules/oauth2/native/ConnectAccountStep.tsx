...
export const ConnectedAccountCard = function ConnectedAccountCard(arg0) {
  ...
  if (null == value) {
    ...
    obj1[0] = platformName;
    obj[2] = intl.format(require("../../../intl/index.native.tsx") /* getSystemLocale */.t["+oaRw3"], obj1);
    ...
    obj6[2] = intl2.format(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.Dkd7sE, obj7);
    ...
    obj8[0] = require("../../../../discord_common/js/packages/tokens/native.tsx").colors.TEXT_FEEDBACK_POSITIVE;
    items1[2] = callback(require("../../../design/components/Icon/native/redesign/generated/CheckmarkLargeIcon.tsx") /* CheckmarkLargeIcon */.CheckmarkLargeIcon, obj8);
    obj2[1] = items1;
    ...
    obj9[2] = intl3.format(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.pyRNXJ, obj10);
    items[2] = callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj9);
    ...
    obj1 = require("../../../utils/AvatarUtils.tsx") /* getAvatarURL */;
    obj2 = require("../../../design/shared.tsx") /* AccessibilityAnnouncer */;
    const icon = value.icon;
