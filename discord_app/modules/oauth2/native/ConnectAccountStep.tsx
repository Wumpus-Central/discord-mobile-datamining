...
export default function ConnectAccountStep(clientId) {
  ...
  if (null == value) {
    ...
    items4[1] = closure_8(tmp5(8742).MoreHorizontalIcon, obj4);
    ...
    items6[1] = closure_8(tmp5(4601).Text, obj8);
    ...
    items7[1] = closure_8(tmp5(4601).Text, obj12);
    const obj13 = {
      variant: "primary",
      size: "sm",
      onPress() {
    ...
    items7[2] = closure_8(tmp5(5025).Button, obj13);
    ...
    const items8 = [closure_8(tmp5(4560).CircleInformationIcon, obj15), ];
    ...
    items8[1] = closure_8(tmp5(4601).Text, obj16);
