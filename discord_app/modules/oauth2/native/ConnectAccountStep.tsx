...
export const ConnectedAccountCard = function ConnectedAccountCard(arg0) {
  ...
  if (null == value) {
    ...
    obj1[0] = platformName;
    obj[2] = intl.format(getSystemLocale /* getSystemLocale */.t["+oaRw3"], obj1);
    ...
    obj6[2] = intl2.format(getSystemLocale /* getSystemLocale */.t.Dkd7sE, obj7);
    ...
    items1[2] = callback(CheckmarkLargeIcon /* CheckmarkLargeIcon */.CheckmarkLargeIcon, obj8);
    obj2[1] = items1;
    ...
    obj9[2] = intl3.format(getSystemLocale /* getSystemLocale */.t.pyRNXJ, obj10);
    items[2] = callback(Text /* Text */.Text, obj9);
    ...
    obj1 = getAvatarURL /* getAvatarURL */;
    obj2 = AccessibilityAnnouncer /* AccessibilityAnnouncer */;
    const icon = value.icon;
