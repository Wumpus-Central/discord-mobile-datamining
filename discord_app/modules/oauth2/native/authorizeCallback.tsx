      ...
      if (tmp8Result.isDiscordHostname(host)) {
        if (null != pathname) {
          if (null != pathname.match(re5)) {
            ...
            ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(8511, dependencyMap.paths), obj3, React3);
            ...
            if (!canceled) {
              ...
              tmp8Result5.pushLazy(asyncRequireImpl(8509, dependencyMap.paths), obj4, React4);
              const tmp17 = asyncRequireImpl(8509, dependencyMap.paths);
            }
          }
        }
      }
