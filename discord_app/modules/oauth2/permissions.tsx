...
({
  ...
  MANAGE_GUILD: arr[1],
  MANAGE_ROLES: arr[2],
  MANAGE_CHANNELS: arr[3],
  KICK_MEMBERS: arr[4],
  BAN_MEMBERS: arr[5],
  CREATE_INSTANT_INVITE: arr[6],
  MANAGE_NICKNAMES: arr[7],
  CHANGE_NICKNAME: arr[8],
  MANAGE_GUILD_EXPRESSIONS: arr[9],
  CREATE_GUILD_EXPRESSIONS: arr[10],
  MANAGE_WEBHOOKS: arr[11],
  VIEW_AUDIT_LOG: arr[12],
  VIEW_CHANNEL: arr[13],
  MANAGE_EVENTS: arr[14],
  CREATE_EVENTS: arr[15],
  MODERATE_MEMBERS: arr[16],
  VIEW_GUILD_ANALYTICS: arr[17],
  VIEW_CREATOR_MONETIZATION_ANALYTICS: arr[18],
  USE_EXTERNAL_APPS: arr[19],
  SEND_MESSAGES: arr[20],
  SEND_MESSAGES_IN_THREADS: arr[21],
  CREATE_PUBLIC_THREADS: arr[22],
  CREATE_PRIVATE_THREADS: arr[23],
  SEND_TTS_MESSAGES: arr[24],
  MANAGE_MESSAGES: arr[25],
  MANAGE_THREADS: arr[26],
  EMBED_LINKS: arr[27],
  ATTACH_FILES: arr[28],
  READ_MESSAGE_HISTORY: arr[29],
  MENTION_EVERYONE: arr[30],
  ADD_REACTIONS: arr[31],
  USE_EXTERNAL_EMOJIS: arr[32],
  USE_EXTERNAL_STICKERS: arr[33],
  USE_APPLICATION_COMMANDS: arr[34],
  SEND_VOICE_MESSAGES: arr[35],
  SEND_POLLS: arr[36],
  PIN_MESSAGES: arr[37],
  BYPASS_SLOWMODE: arr[38],
  MANAGE_OFFICIAL_MESSAGES: arr[39],
  CONNECT: arr[40],
  SPEAK: arr[41],
  MUTE_MEMBERS: arr[42],
  DEAFEN_MEMBERS: arr[43],
  MOVE_MEMBERS: arr[44],
  USE_VAD: arr[45],
  PRIORITY_SPEAKER: arr[46],
  REQUEST_TO_SPEAK: arr[47],
  STREAM: arr[48],
  USE_EMBEDDED_ACTIVITIES: arr[49],
  USE_SOUNDBOARD: arr[50],
