...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj.trailing = closure_5(credential(7250).ActionSheetCloseButton, { onPress: handleClose });
  const items = [closure_5(credential(7201).BottomSheetTitleHeader, obj), , , ];
  ...
  items1[1] = closure_5(credential(4601).Text, obj3);
  ...
  obj4.children = closure_5(credential(5025).Button, obj5);
  ...
  obj7.onPress = function onPress() {
    ...
    result.then(() => {
      ...
      closure_1_1(4303);
      const obj = { key: "WEBAUTHN_CREDENTIAL_DELETE_ERROR_TOAST_KEY", content: error.message, icon: closure_1_1(9695), IconComponent: credential(8658).WarningIcon, iconColor: "icon-feedback-critical" };
      obj.open(obj);
    }).finally(() => {
      closure_1_1(false);
    });
  ...
  obj6.children = closure_5(credential(5025).Button, obj7);
