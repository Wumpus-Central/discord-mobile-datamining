...
export default function WebAuthnDeleteActionSheet(credential) {
  ...
  obj6.onPress = function onPress() {
    ...
    result.then(() => {
      ...
      closure_1_1(4305);
      const obj = { key: "WEBAUTHN_CREDENTIAL_DELETE_ERROR_TOAST_KEY", content: error.message, icon: closure_1_1(9716), IconComponent: credential(8679).WarningIcon, iconColor: "icon-feedback-critical" };
      obj.open(obj);
    }).finally(() => {
      closure_1_1(false);
    });
