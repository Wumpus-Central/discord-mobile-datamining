...
export const getScreens = function getScreens(isModal) {
  ...
  obj = {
    title: "",
    render() {
      return callback2(callback(13972), {});
    }
  };
  ...
  obj[1] = function render() {
    return callback2(callback(13979), {});
  };
  ...
  const obj1 = {
    render(arg0) {
      ...
      return callback2(callback(13984), {});
    },
    title: null
  };
  ...
  const obj2 = {
    render() {
      return callback2(callback(13985), {});
    },
    title: null
  };
  ...
  const obj3 = {
    render(arg0) {
      const merged = Object.assign(arg0);
      return callback2(callback(13988), {});
    },
    title: null,
    headerLeft: null
  };
  ...
  const obj4 = {
    render() {
      return callback2(callback(13989), {});
    },
    title: null
  };
