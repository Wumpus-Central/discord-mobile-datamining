...
export const getScreens = function getScreens(isModal) {
  ...
  obj = {
    title: "",
    render() {
      return callback2(callback(13980), {});
    }
  };
  ...
  const obj1 = {
    render(arg0) {
      ...
      return callback2(callback(13992), {});
    },
    title: null
  };
  ...
  const obj2 = {
    render() {
      return callback2(callback(13993), {});
    },
    title: null
  };
  ...
  const obj3 = {
    render(arg0) {
      const merged = Object.assign(arg0);
      return callback2(callback(13996), {});
    },
    title: null,
    headerLeft: null
  };
  ...
  const obj4 = {
    render() {
      return callback2(callback(13997), {});
    },
    title: null
  };
