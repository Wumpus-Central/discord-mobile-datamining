...
import { registerAsset } from "../../../../../_runtime/13891_registerAsset.js";
...
export default function PasskeyUpsellView() {
  ...
  function onCancel() {
    callback(13887).markDismissed(constants.USER_DISMISS);
    const obj = callback(13887);
    const result = callback(13888).closePasskeyUpsellModal();
  }
  ...
  return callback(navigation(5311).SafeAreaPaddingView, obj);
};