...
import registerAssetDefault from "../../../../../_runtime/14257_registerAsset.js";
...
export default function PasskeyUpsellView() {
  ...
  function onCancel() {
    callback(14253).markDismissed(constants.USER_DISMISS);
    const obj = callback(14253);
    const result = callback(14254).closePasskeyUpsellModal();
  }
  ...
  items1[1] = callback(navigation(4440).Text, obj3);
  ...
  obj4[3] = stringResult;
  items1[2] = callback(navigation(4440).Text, obj4);
  obj1[1] = items1;
  ...
  items3[1] = callback(navigation(4440).Text, obj8);
  obj6[1] = items3;
  ...
  items5[1] = callback(navigation(4440).Text, obj11);
  obj9[1] = items5;
  ...
  const items6 = [callback(navigation(4440).Text, obj13), , ];
  ...
  items6[1] = callback(navigation(4879).Button, {
    text: string3Result,
    onPress() {
  ...
  items6[2] = callback(navigation(4879).Button, { text: string4Result, onPress: onCancel, size: "lg", variant: "secondary", grow: true });
  obj12[1] = items6;
  items2[2] = closure_12(closure_5, obj12);
  obj[1] = items2;
  obj[2] = closure_12(tmp12, obj);
  return callback(navigation(5500).SafeAreaPaddingView, obj);
};