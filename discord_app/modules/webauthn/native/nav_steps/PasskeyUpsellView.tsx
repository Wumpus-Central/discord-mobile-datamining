// === Module 14082: PasskeyUpsellView ===

// Module 14082 (PasskeyUpsellView)
import ThemesDefault from "Themes" /* 712 */;
import combinedDefault from "combined" /* 1993 */;
import _promptForRegisterCredentialDefault from "_promptForRegisterCredential" /* 8586 */;
import handlePasskeyUpsellShowDefault from "handlePasskeyUpsellShow" /* 14083 */;
import registerAssetDefault from "registerAsset" /* 14087 */;
...
export default function PasskeyUpsellView() {
  ...
  function onCancel() {
    ...
    const obj = callback(14083);
    const result = callback(14084).closePasskeyUpsellModal();
  }
  ...
  const items6 = [callback(navigation(4734).Text, obj13), , ];
