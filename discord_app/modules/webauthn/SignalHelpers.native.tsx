      ...
      try {
        ...
        if (0 === v1) {
          if (arg0 === 1) {
            ...
            const result = credentials(6926).encodeUserIdForWebAuthn(closure_1);
            ...
            const obj5 = credentials(6926);
            const result1 = v1(6927).signalAllAcceptedCredentials(rpId, result, found);
            v1 = 1;
            credentials = 1;
