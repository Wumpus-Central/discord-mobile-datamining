...
function openAndWaitForOnboarding(guildId) {
  ...
  return new Promise((arg0) => {
    ...
    obj.pushLazy(asyncRequireImpl(7224, dependencyMap.paths), obj, closure_7).then(() => {
    ...
    const pushLazyResult = obj.pushLazy(asyncRequireImpl(7224, dependencyMap.paths), obj, closure_7);
  });
}
