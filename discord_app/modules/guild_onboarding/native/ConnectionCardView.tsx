...
export default function ConnectionCardView(description) {
  ...
  const items1 = [callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-md/medium", color: "text-strong", children: displayName }), ];
  ...
  if (tmp4Result) {
    ...
    obj2[2] = description;
    tmp4Result = tmp4(tmp5(4281).Text, obj2);
  }
  items1[1] = tmp4Result;
  obj1[1] = items1;
  ...
  if (isLoading) {
    ...
    const items3 = [tmp4(tmp5(4281).Text, obj4), tmp4(tmp5(4246).CircleCheckIcon, { size: "sm", color: "status-positive" })];
    obj3[1] = items3;
    ...
    obj5[4] = !canConnect;
    tmp4Result = tmp4(tmp5(4695).Button, obj5);
  }
  items2[1] = tmp4Result;
  obj[1] = items2;
