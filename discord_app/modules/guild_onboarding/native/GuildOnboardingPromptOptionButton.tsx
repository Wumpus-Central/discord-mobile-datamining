...
export default function PromptOptionButton(option) {
  ...
  R.__closure = {
    selected,
    withTiming: option(4758).withTiming,
    Easing: option(4493).Easing,
    useReducedMotion: stateFromStores1,
    withSequence: option(4493).withSequence,
    withSpring: option(5186).withSpring,
  };
  ...
  V.__closure = {
    showMemberCount,
    withDelay: option(4493).withDelay,
    withTiming: option(4758).withTiming,
    Easing: option(4493).Easing,
    useReducedMotion: stateFromStores1,
  };
  ...
  W.__closure = {
    interpolateColor: option(4493).interpolateColor,
