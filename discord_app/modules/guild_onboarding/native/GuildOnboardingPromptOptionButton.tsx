...
export default function PromptOptionButton(option) {
  ...
  __closure = {
    selected,
    withTiming: option(4575).withTiming,
    Easing: option(4310).Easing,
    useReducedMotion: stateFromStores1,
    withSequence: option(4310).withSequence,
    withSpring: option(4988).withSpring,
  };
  ...
  __closure = {
    showMemberCount,
    withDelay: tmp2(4310).withDelay,
    withTiming: tmp2(4575).withTiming,
    Easing: tmp2(4310).Easing,
    useReducedMotion: stateFromStores1,
  };
  ...
  W.__closure = {
    interpolateColor: option(4310).interpolateColor,
