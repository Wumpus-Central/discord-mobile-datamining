...
export default function PromptOptionButton(option) {
  ...
  __closure = { selected, withTiming: option(4561).withTiming, Easing: option(4296).Easing, useReducedMotion: stateFromStores1, withSequence: option(4296).withSequence, withSpring: option(4974).withSpring };
  ...
  __closure = { showMemberCount, withDelay: tmp2(4296).withDelay, withTiming: tmp2(4561).withTiming, Easing: tmp2(4296).Easing, useReducedMotion: stateFromStores1 };
