...
export default function PromptOptionButton(option) {
  ...
  R.__closure = {
    selected,
    withTiming: option(4830).withTiming,
    Easing: option(4563).Easing,
    useReducedMotion: stateFromStores1,
    withSequence: option(4563).withSequence,
    withSpring: option(5273).withSpring,
  };
  ...
  V.__closure = {
    showMemberCount,
    withDelay: option(4563).withDelay,
    withTiming: option(4830).withTiming,
    Easing: option(4563).Easing,
    useReducedMotion: stateFromStores1,
  };
  ...
  W.__closure = {
    interpolateColor: option(4563).interpolateColor,
