...
export default function PromptOptionButton(option) {
  ...
  __closure = {
    selected,
    withTiming: option(4606).withTiming,
    Easing: option(4341).Easing,
    useReducedMotion: stateFromStores1,
    withSequence: option(4341).withSequence,
    withSpring: option(5024).withSpring,
  };
  ...
  __closure = {
    showMemberCount,
    withDelay: tmp2(4341).withDelay,
    withTiming: tmp2(4606).withTiming,
    Easing: tmp2(4341).Easing,
    useReducedMotion: stateFromStores1,
  };
  ...
  W.__closure = {
    interpolateColor: option(4341).interpolateColor,
