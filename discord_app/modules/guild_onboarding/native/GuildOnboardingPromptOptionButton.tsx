...
export default function PromptOptionButton(option) {
  ...
  R.__closure = {
    ...
    Easing: option(4561).Easing,
    useReducedMotion: stateFromStores1,
    withSequence: option(4561).withSequence,
    withSpring: option(5272).withSpring,
  };
  ...
  V.__closure = {
    showMemberCount,
    withDelay: option(4561).withDelay,
    withTiming: option(4830).withTiming,
    Easing: option(4561).Easing,
    useReducedMotion: stateFromStores1,
  };
  ...
  W.__closure = {
    interpolateColor: option(4561).interpolateColor,
