...
export default function PromptOptionButton(option) {
  ...
  R.__closure = {
    selected,
    withTiming: option(4723).withTiming,
    Easing: option(4458).Easing,
    useReducedMotion: stateFromStores1,
    withSequence: option(4458).withSequence,
    withSpring: option(5143).withSpring,
  };
  ...
  V.__closure = {
    showMemberCount,
    withDelay: option(4458).withDelay,
    withTiming: option(4723).withTiming,
    Easing: option(4458).Easing,
    useReducedMotion: stateFromStores1,
  };
  ...
  W.__closure = {
    interpolateColor: option(4458).interpolateColor,
