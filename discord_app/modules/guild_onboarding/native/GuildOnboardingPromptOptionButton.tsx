...
export default function PromptOptionButton(option) {
  ...
  R.__closure = {
    selected,
    withTiming: option(4828).withTiming,
    Easing: option(4559).Easing,
    useReducedMotion: stateFromStores1,
    withSequence: option(4559).withSequence,
    withSpring: option(5270).withSpring,
  };
  ...
  V.__closure = {
    showMemberCount,
    withDelay: option(4559).withDelay,
    withTiming: option(4828).withTiming,
    Easing: option(4559).Easing,
    useReducedMotion: stateFromStores1,
  };
  ...
  W.__closure = {
    interpolateColor: option(4559).interpolateColor,
