...
export default function PromptOptionButton(option) {
  ...
  R.__closure = {
    selected,
    withTiming: option(4757).withTiming,
    Easing: option(4492).Easing,
    useReducedMotion: stateFromStores1,
    withSequence: option(4492).withSequence,
    withSpring: option(5185).withSpring,
  };
  ...
  V.__closure = {
    showMemberCount,
    withDelay: option(4492).withDelay,
    withTiming: option(4757).withTiming,
    Easing: option(4492).Easing,
    useReducedMotion: stateFromStores1,
  };
  ...
  W.__closure = {
    interpolateColor: option(4492).interpolateColor,
