...
function DropdownOptionRow(option) {
  ...
  if (null != id) {
    ...
    if (null != stateFromStores) {
      ...
      emojiURL = onSelect(tmp3[9]).getEmojiURL(obj6);
    ...
    let leading = closure_8(View, obj2);
...
export default function DropdownOptionsActionSheet(arg0) {
  ...
  const responses = useStateFromStores.useStateFromStoresArray(items1, () =>
  ...
  if (null == stateFromStores) {
    ...
    obj3.title = intl.string(util.t.E2ICbC);
    const obj4 = {
      scrollable: true,
      header: closure_8(BottomSheetTitleHeader.BottomSheetTitleHeader, obj3),
      children: null,
    };
