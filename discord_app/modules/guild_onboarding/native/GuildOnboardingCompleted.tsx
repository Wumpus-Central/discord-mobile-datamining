...
createStyles.card = { marginTop: 24, padding: 16, paddingBottom: 32, borderRadius: nativeDefault.radii.sm, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH };
...
let obj1 = { marginTop: 24, padding: 16, paddingBottom: 32, borderRadius: nativeDefault.radii.sm, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH };
createStyles.roleOverflow = { paddingHorizontal: 8, height: 28, borderRadius: nativeDefault.radii.xs, display: "flex", justifyContent: "center", borderWidth: StyleSheet.hairlineWidth, borderColor: nativeDefault.colors.BORDER_SUBTLE };
let obj2 = { paddingHorizontal: 8, height: 28, borderRadius: nativeDefault.radii.xs, display: "flex", justifyContent: "center", borderWidth: StyleSheet.hairlineWidth, borderColor: nativeDefault.colors.BORDER_SUBTLE };
createStyles.animation = { marginTop: 24, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderWidth: 2, borderRadius: nativeDefault.radii.sm, padding: 12, display: "flex", flexDirection: "row", alignItems: "center" };
...
export default function GuildOnboardingCompleted(guildId) {
  ...
  const stateFromStoresArray = tmp2Result.useStateFromStoresArray(items5, () => GuildRoleStore.getManyRoles(guildId, allSelectedRoleIds), items6);
  ...
  if (null != stateFromStores) {
    if (null != stateFromStores1) {
      ...
      items11[1] = prop;
      obj4.style = items11;
      const obj5 = { style: tmp.title, accessibilityRole: "header", variant: "heading-xxl/extrabold", color: null, children: null };
      ...
      let obj6 = { style: tmp.subtitle, accessibilityRole: "header", variant: "text-md/medium", color: null, children: null };
      if (null == guildSplashURL) {
        str = "text-muted";
      }
      obj6.color = str;
      ...
      let obj9 = { style: tmp.username, variant: "heading-xl/semibold", color: "mobile-text-heading-primary", children: stateFromStores.username };
