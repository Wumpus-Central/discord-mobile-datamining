...
function PromptFooter(onPress) {
  ...
  ({ helpText, helpTextAdditional } = selectedOptionIds(found[27])({
    guild: stateFromStores,
    prompt: currentPrompt,
    selectedRoleIds: memo,
    selectedChannelIds: memo1,
  ...
  const tmp16 = selectedOptionIds(found[27])({
    guild: stateFromStores,
    prompt: currentPrompt,
    selectedRoleIds: memo,
    selectedChannelIds: memo1,
...
function DropdownOption(option) {
  ...
  const items1 = [
    ...
    closure_15(tmp2(4823).Text, { variant: "text-md/semibold", children: option.title }),
  ];
...
let closure_13 = fn(7428).GuildOnboardingModalStates;
...
export const RulesPrompt = function RulesPrompt(guildId) {
  ...
  stateFromStores = guildId(stateFromStores[14]).useStateFromStores(items, () =>
  ...
  const obj6 = require("../../../../_runtime/metro/00672__.js")(token);
  const items3 = [require("../../../../_runtime/metro/00672__.js")(token).alpha(0).hex()];
  const alphaResult = require("../../../../_runtime/metro/00672__.js")(token).alpha(0);
  const obj8 = require("../../../../_runtime/metro/00672__.js")(token);
  items3[1] = require("../../../../_runtime/metro/00672__.js")(token).alpha(1).hex();
  if (null == stateFromStores) {
    return null;
  } else {
    const sum1 = sum + 8;
  ...
  const alphaResult1 = require("../../../../_runtime/metro/00672__.js")(token).alpha(1);
};
export const MultipleChoicePrompt = function MultipleChoicePrompt(guildId) {
  ...
  const stateFromStoresArray = guildId(selectOption[14]).useStateFromStoresArray(
    items,
    () => {
