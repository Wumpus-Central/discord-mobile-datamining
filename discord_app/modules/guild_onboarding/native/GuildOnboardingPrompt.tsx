...
function DropdownOption(option) {
  ...
  const items1 = [
    ...
    closure_15(option(4570).Text, { variant: "text-md/semibold", children: option.title }),
  ];
  obj.children = items1;
  return closure_16(closure_6, obj);
}
...
createStyles = {
  ...
  flex: 1,
  flexGrow: 1,
  marginTop: fn(5696).NAV_BAR_HEIGHT,
  marginBottom: 16,
  backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWER,
};
createStyles.container = createStyles;
createStyles.scrollContainer = {
  display: "flex",
  flexGrow: 1,
...
export const RulesPrompt = function RulesPrompt(guildId) {
  ...
  let obj5 = require("../../../../_runtime/metro/00672__.js")(token);
  const tmp5 = _slicedToArray(noop.useState(false), 2);
  const items3 = [obj5.alpha(0).hex()];
  let obj7 = require("../../../../_runtime/metro/00672__.js")(token);
...
export const DropdownPrompt = function DropdownPrompt(guildId) {
  ...
  const obj5 = {
    ...
    children: closure_15(closure_5, { style: tmp.dropdownIcon, source: currentPrompt(selectOption[35]) }),
  };
