// === Module 7457: GuildOnboardingPrompt ===
...
let obj3 = { display: "flex", flex: 1, flexGrow: 1, marginTop: fn(5987).NAV_BAR_HEIGHT, marginBottom: 16, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWER };
