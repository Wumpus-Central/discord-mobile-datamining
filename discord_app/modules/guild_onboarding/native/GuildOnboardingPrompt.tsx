...
import closure_9 from "../../emojis/EmojiStore.tsx";
import closure_10 from "../../guild_member_verification/MemberVerificationFormStore.tsx";
import closure_11 from "../../../stores/GuildStore.tsx";
import closure_12 from "../GuildOnboardingPromptsStore.tsx";
import { GuildOnboardingModalStates as closure_13 } from "GuildOnboardingConstants.tsx";
...
function PromptHeader(currentPrompt) {
  ...
  obj[1] = items;
  const items2 = [
    closure_16(closure_6, obj),
    callback2(Text2.Text, {
      style: tmp.title,
...
function PromptFooter(onPress) {
  ...
  items6[2] = callback2(require(found[22]).Button, {
    variant: str4,
    size: "md",
    grow: true,
    text: combined,
...
function DropdownOption(option) {
  ...
  const items1 = [
    ...
    closure_15(option(4474).Text, { variant: "text-md/semibold", children: option.title }),
  ];
  obj[1] = items1;
  return closure_16(closure_6, obj);
}
...
createCacheKey[5] = {
  flexShrink: 0,
  marginHorizontal: 8,
  color: ThemesDefault.colors.BORDER_SUBTLE,
...
export const DropdownPrompt = function DropdownPrompt(guildId) {
  ...
  const obj5 = {
    ...
    children: callback2(closure_5, { style: tmp.dropdownIcon, source: currentPrompt(selectOption[35]) }),
  };
