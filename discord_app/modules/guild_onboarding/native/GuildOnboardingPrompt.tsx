...
function DropdownOption(option) {
  ...
  const items1 = [
    ...
    closure_15(tmp2(4753).Text, { variant: "text-md/semibold", children: option.title }),
  ];
...
let closure_13 = fn(7344).GuildOnboardingModalStates;
...
let obj2 = {
  ...
  container: {
    ...
    flex: 1,
    flexGrow: 1,
    marginTop: fn(5901).NAV_BAR_HEIGHT,
    marginBottom: 16,
