...
export const ContentInventoryInteractionTypes = {
  CARD_POPOUT_OPEN: 2,
  [2]: "CARD_POPOUT_OPEN",
  REACTION_EMOJI_REACT_SENT: 3,
  [3]: "REACTION_EMOJI_REACT_SENT",
  DM_REACTION_MESSAGE_SENT: 4,
  [4]: "DM_REACTION_MESSAGE_SENT",
  CHANNEL_REACTION_MESSAGE_SENT: 5,
  [5]: "CHANNEL_REACTION_MESSAGE_SENT",
  VOICE_CHANNEL_JOINED: 6,
  [6]: "VOICE_CHANNEL_JOINED",
  VOICE_CHANNEL_PREVIEWED: 7,
  [7]: "VOICE_CHANNEL_PREVIEWED",
  OPENED_GAME_PROFILE: 8,
  [8]: "OPENED_GAME_PROFILE",
  COPIED_LEADERBOARD_ROW: 9,
  [9]: "COPIED_LEADERBOARD_ROW",
  APPLICATION_WIDGET_PREVIEW_VIEW_MORE: 10,
  [10]: "APPLICATION_WIDGET_PREVIEW_VIEW_MORE",
};
...
export const ContentInventoryEntryProviderTypes = {
  SPOTIFY: 1,
  [1]: "SPOTIFY",
  CRUNCHYROLL: 2,
  [2]: "CRUNCHYROLL",
