...
export default noop.memo(function VEVOOPropTintColor() {
  ...
  obj = { style: null, labelStyle: visualEffectViewOverrideSharedStyles.zeroHeight, leadingStyle: visualEffectViewOverrideSharedStyles.enabledSwitchStyle, leading: null, subLabel: null, disabled: null, onPress: null };
  ...
  const obj3 = { style: visualEffectViewOverrideSharedStyles.zeroPaddingHorizontal, disabled: !tmp7, label: null, subLabel: null };
  let str2;
  if (first1 != null) {
  ...
  obj3.subLabel = closure_8(backgroundColor(16023), {
    disabled: !tmp7,
