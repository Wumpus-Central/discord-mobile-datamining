...
import VisualEffectViewOverrideOverlay_ from "VisualEffectViewOverrideOverlay_" /* 15431 */;
...
const memoResult = importAllResult.memo(function VEVOOPropTintColor() {
  ...
  obj = { style: items, labelStyle: visualEffectViewOverrideSharedStyles.zeroHeight, leadingStyle: visualEffectViewOverrideSharedStyles.enabledSwitchStyle, leading: callback2(tmp2(5946).FormSwitch, obj), subLabel: null, disabled: null, onPress: null };
