...
const memoResult = importAllResult.memo(function VEVOOPropBlurTintRgba() {
  let require;
  let tmp7;
  let obj = require("VEVOO.tsx") /* VisualEffectViewOverrideOverlay_ */;
  ...
  obj[3] = callback2(require("../../../../design/components/Forms/native/FormSwitch.native.tsx") /* FormSwitch */.FormSwitch, obj);
  ...
  const items2 = [callback2(require("../../../../design/void/Form/native/index.tsx") /* Form */.FormRow, obj1), ];
  ...
  items2[1] = callback2(require("../../../../design/void/Form/native/index.tsx") /* Form */.FormRow, obj2);
  obj3[0] = items2;
  ...
  return callback2(require("../../../../design/void/Form/native/index.tsx") /* Form */.FormRow, obj);
});
