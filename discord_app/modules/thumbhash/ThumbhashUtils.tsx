...
import { thumbHashToRGBA } from "../../../_runtime/14442_thumbHashToRGBA.js";
function thumbHashToRGBA(arg0) {
  ...
  const result9 = thumbHashToRGBA.thumbHashToApproximateAspectRatio(arg0);
  let num17 = 32;
  if (result9 <= 1) {
    num17 = 32 * result9;
  }
...
export const createThumbhashImageFromPlaceholder = function createThumbhashImageFromPlaceholder(placeholder) {
  ...
  return thumbHashToRGBA.rgbaToDataURL(tmp.w, tmp.h, tmp.rgba);
};
