                ...
                result = link(inlineStoreParams[13]).openPlayStoreInlineInstall(
                  ...
                  (arg0) => {
                    ...
                    closure_0(
                      ...
                      str,
                      closure_0(7790).AppStoreOverlayVariant.NATIVE,
                      arg0,
                    );
                      ...
                      const obj = {
                        trackOverlayEvent(arg0, arg1) {
                          return closure_1_0(
                            ...
                            closure_0(7790).AppStoreOverlayVariant.NATIVE,
                            arg1,
                            closure_0(7790).AppStoreOverlaySurfaces.MAIN_CTA,
                          );
                        },
                      };
                      dependencyMap(obj);
...
function openAdGameLinkDirectlyImpl(adContentId, impressionId, preferExternalAppStore) {
  ...
  let obj = adContentId(11286);
  if (
    obj.shouldMigrateToAdAnalyticsInterface(
      adContentId(11286).AdAnalyticsInterfaceExperimentStep.STEP_3_CLICKED_EXTERNAL,
      "open_ad_game_link_directly",
    )
  ) {
    let tmp2Result = tmp2(11287);
    obj = {
      type: tmp2(11291).AdUserActionType.CLICK_EXTERNAL_ADVERTISER_CTA,
      adCreativeType,
  ...
  if (null != impressionId) {
    ...
    iosAttributionClickFramework = tmp2(11582).getIosAttributionClickFramework(
      null != iosAppId,
      impressionId.sourceQuestContent,
      adContentId,
    );
    const tmp2Result1 = tmp2(11582);
  }
  let fn;
