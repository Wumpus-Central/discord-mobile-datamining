...
function questMatchesActivity(arg0, id) {
  ...
  if (null == arg0) {
      ...
      if (!tmp9) {
        ...
        if (!tmp10) {
          ...
          if (tmp13) {
            ...
            const allApplicationIds = application_id(7251).getAllApplicationIds(id);
            const obj = application_id(7251);
    ...
    const consoleApplicationId = application_id(7251).getConsoleApplicationId(id);
    let flag = false;
    ...
    tmp10 = flag;
    const obj3 = application_id(7251);
