// === Module 10746: questMatchesActivity ===
...
import { XBOX_ACTIVITY_APPLICATION_ID as closure_8 } from "items3" /* 4472 */;
...
function questMatchesActivity(arg0, id) {
  ...
  if (null == arg0) {
      ...
      if (!tmp9) {
        ...
        if (!tmp10) {
          ...
          if (tmp13) {
            ...
            const allApplicationIds = application_id(7394).getAllApplicationIds(id);
            const obj = application_id(7394);
    ...
    const consoleApplicationId = application_id(7394).getConsoleApplicationId(id);
    let flag = false;
    ...
    tmp10 = flag;
    const obj3 = application_id(7394);
...
function questMatchesApplicationId(arg0, quest) {
  const _require = arg0;
  const allApplicationIds = _require(7394).getAllApplicationIds(quest);
  const obj = _require(7394);
