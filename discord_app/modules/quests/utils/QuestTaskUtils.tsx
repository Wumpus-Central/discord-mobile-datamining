// === Module 7480: getApplicationIdsByTaskTypes ===
...
export const getConsoleApplicationId = function getConsoleApplicationId(id) {
  const items = [items5(5403).FirstPartyQuestTaskTypes.PLAY_ON_XBOX, items5(5403).FirstPartyQuestTaskTypes.PLAY_ON_PLAYSTATION];
...
export const getActivityApplicationId = function getActivityApplicationId(quest) {
  const items = [items5(5403).FirstPartyQuestTaskTypes.PLAY_ACTIVITY, items5(5403).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_ACTIVITY];
  const tmp = getApplicationIdsByTaskTypes(quest, items);
  let first;
  if (tmp != null) {
    first = tmp[0];
...
export const hasStreamOnDesktopTask = function hasStreamOnDesktopTask(arg0) {
  return null != arg0.quest.config.taskConfigV2.tasks[items5(undefined, 5403).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP];
};
export const hasAchievementActivityTask = function hasAchievementActivityTask(quest) {
  return null != quest.config.taskConfigV2.tasks[items5(undefined, 5403).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_ACTIVITY];
};
...
export const isInGameQuest = function isInGameQuest(quest) {
  items5 = quest;
  return Array.from(items5(5403).FirstPartyQuestTaskTypesSets.IN_GAME).some((arg0) => null != lib.config.taskConfigV2.tasks[arg0]);
};
  ...
  if (arr.some((arg0) => null != lib.config.taskConfigV2.tasks[arg0])) {
    ...
    if (items5.some((arg0) => null != config.config.taskConfigV2.tasks[arg0])) {
      ...
      if (items5.some((arg0) => null != config.config.taskConfigV2.tasks[arg0])) {
        ...
        if (tmp8) {
          tmp8 = null != closure_0.config.taskConfigV2.tasks[tmp(undefined, 5403).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP];
        }
        if (tmp8) {
        ...
        } else if (null != closure_0.config.taskConfigV2.tasks[tmp(undefined, 5403).FirstPartyQuestTaskTypes.PLAY_ACTIVITY]) {
