...
const items4 = [
  fn(5671).FirstPartyQuestTaskTypes.PLAY_ON_DESKTOP,
  fn(5671).FirstPartyQuestTaskTypes.STREAM_ON_DESKTOP,
  fn(5671).FirstPartyQuestTaskTypes.PLAY_ON_PLAYSTATION,
  fn(5671).FirstPartyQuestTaskTypes.PLAY_ON_XBOX,
  fn(5671).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_GAME,
];
let closure_133_0 = items4;
const items5 = [
  fn(5671).FirstPartyQuestTaskTypes.ACHIEVEMENT_IN_ACTIVITY,
  fn(5671).FirstPartyQuestTaskTypes.PLAY_ACTIVITY,
];
