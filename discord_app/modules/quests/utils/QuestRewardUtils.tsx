...
import QuestOrbMultiplierUtils from "QuestOrbMultiplierUtils.tsx";
...
let items = [
  fn(10682).QuestRewardExpirationMode.PREMIUM_EXTENSION,
  fn(10682).QuestRewardExpirationMode.PREMIUM_PERMANENT,
];
  ...
  if (null != tmp5) {
    if ("expiresAt" in tmp5) {
      if (null != tmp5.expiresAt) {
        ...
        const differenceInDaysResult = _mod4061.differenceInDays(date1, date);
        const _Math3 = Math;
        let num = 0;
        ...
        if (sum >= 12) {
          ...
          const differenceInDaysResult1 = _mod4061.differenceInDays(date1, date);
          ...
          const tmp3Result2 = _mod4061;
        }
        const tmp3Result = _mod4061;
      }
    }
  }
  return null;
