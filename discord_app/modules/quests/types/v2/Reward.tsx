// === Module 7466: _rewardRedemptionInstructionsFromServer ===
...
function _questRewardV2FromServer(type) {
  ...
  if (QuestRewardTypes.QuestRewardTypes.REWARD_CODE === type) {
    ...
    obj[0] = QuestRewardTypes.QuestRewardTypes.REWARD_CODE;
    ...
    obj1[0] = QuestRewardTypes.QuestRewardTypes.COLLECTIBLE;
    ...
    obj3[0] = QuestRewardTypes.QuestRewardTypes.VIRTUAL_CURRENCY;
    obj3[1] = type.sku_id;
    ...
    obj5[0] = QuestRewardTypes.QuestRewardTypes.FRACTIONAL_PREMIUM;
    ...
    obj[0] = QuestRewardTypes.QuestRewardTypes.IN_GAME;
...
const result = obj132.fileFinishedImporting("modules/quests/types/v2/Reward.tsx");
