          ...
          if (0 === dependencyMap) {
            ...
            const item = adContentIds.forEach((item, index) => {
              ...
              if (adUser.migrateQuestContentViewedToCaptureAdUserAction) {
                ...
                const result = tmp(8020).isBillableQuestContent(adUser.questContent, adUser.entity.adCreativeType);
                ...
                if (adUser.entity.adCreativeType === tmp(5754).AdCreativeType.QUEST) {
                  const obj4 = {};
                ...
                questLogger.info("" + item + " ad content viewed for at least " + adUser.minViewTimeSeconds + "s at " + tmp(8049).getQuestContentName(adUser.questContent), obj7);
                const tmpResult24 = tmp(8049);
                ...
                questLogger1.info("" + questName + " Quest viewed for at least " + adUser.minViewTimeSeconds + "s at " + tmp(8049).getQuestContentName(adUser.questContent), obj8);
                ...
                let adTrafficMetadataSealed = tmp(8020).getAdTrafficMetadataSealed(adUser.sourceQuestContent, id);
                ...
                questLogger2.info("" + adUser.entity.adContentIds[index] + " ad content viewed for at least " + adUser.minViewTimeSeconds + "s at " + tmp(8049).getQuestContentName(adUser.questContent), obj11);
