...
class QuestContentImpression {
  constructor(arg0) {
    ...
    obj.trackViewedPlacement = function trackViewedPlacement(item) {
      ...
      if (result) {
        result = tmp(dependencyMap[8]).isBillableQuestContent(tmp3.questContent);
        const tmpResult = tmp(dependencyMap[8]);
      }
      if (result) {
    ...
    obj.shouldExtendSession = function shouldExtendSession(item) {
      ...
      if (result) {
        result = obj(dependencyMap[8]).isBillableQuestContent(obj.questContent);
        ...
        try {
          ...
          if (0 === obj4) {
            ...
            const item = adContentIds.forEach((item, index) => {
              ...
              obj1 = closure_0;
              let adMetadataSealed = obj.getAdMetadataSealed(closure_0.sourceQuestContent, item);
              const shouldExtendSessionResult = closure_0.shouldExtendSession(item);
              closure_0.trackViewedPlacement(item);
              ...
              if (closure_0.migrateQuestContentViewedToCaptureAdUserAction) {
                if (adCreativeType === QUEST) {
                  ...
                  if (!isQuestExpiredResult) {
                    let tmpResult = closure_2_0(tmp2[8]);
                    isQuestExpiredResult = tmpResult.isQuestExpired(quest);
                  }
                  if (!isQuestExpiredResult) {
                    tmpResult = closure_2_0(tmp2[15]);
                    const items = [tmp30];
                    tmpResult.markAdContentSeen(closure_2_0(tmp2[9]).AdCreativeType.QUEST, items);
                  }
                }
                const adCreativeType2 = obj1.entity.adCreativeType;
                const QUEST2 = closure_2_0(tmp2[9]).AdCreativeType.QUEST;
                obj = { adCreativeType: null, adCreativeId: null };
                obj[0] = obj1.entity.adCreativeType;
                obj[1] = obj1.entity.adContentIds[index];
                const tmpResult1 = closure_2_0(tmp2[16]);
                const result = closure_2_0(tmp2[8]).isBillableQuestContent(obj1.questContent);
                const AdUserActionType = closure_2_0(tmp2[17]).AdUserActionType;
                ...
                const tmpResult2 = closure_2_0(tmp2[8]);
                const questLogger = closure_2_0(tmp2[18]).getQuestLogger();
                const tmpResult3 = closure_2_0(tmp2[18]);
                const _HermesInternal2 = HermesInternal;
                obj1 = { impressionId: null };
                obj1[0] = obj1.id;
                questLogger.info("" + item + " ad content viewed for at least " + obj1.minViewTimeSeconds + "s at " + closure_2_0(tmp2[11]).getQuestContentName(obj1.questContent), obj1);
                const tmpResult4 = closure_2_0(tmp2[11]);
                ...
                if (!isQuestExpiredResult1) {
                  isQuestExpiredResult1 = closure_2_0(tmp2[8]).isQuestExpired(quest1);
                  const tmpResult5 = closure_2_0(tmp2[8]);
                }
                if (!isQuestExpiredResult1) {
                  const items1 = [tmp6];
                  closure_2_0(tmp2[15]).markAdContentSeen(closure_2_0(tmp2[9]).AdCreativeType.QUEST, items1);
                  const tmpResult6 = closure_2_0(tmp2[15]);
                }
                const questLogger1 = closure_2_0(tmp2[18]).getQuestLogger();
                let questName;
                if (quest1 != null) {
                ...
                const tmpResult7 = closure_2_0(tmp2[18]);
                const _HermesInternal = HermesInternal;
                const obj2 = { impressionId: null };
                obj2[0] = obj1.id;
                questLogger1.info("" + questName + " Quest viewed for at least " + obj1.minViewTimeSeconds + "s at " + closure_2_0(tmp2[11]).getQuestContentName(obj1.questContent), obj2);
                const tmpResult8 = closure_2_0(tmp2[11]);
                obj3 = {};
                const merged1 = Object.assign(obj3);
                obj3.shouldExtendSession = shouldExtendSessionResult;
                obj3.questId = obj1.entity.adContentIds[index];
                ...
                const tmpResult9 = closure_2_0(tmp2[19]);
                const currentQuestHomeSearchSession = closure_2_0(tmp2[20]).getCurrentQuestHomeSearchSession();
                let uuid;
                ...
                const tmpResult10 = closure_2_0(tmp2[20]);
                let id;
                if (quest1 != null) {
                  id = quest1.id;
                }
                let adTrafficMetadataSealed = closure_2_0(tmp2[8]).getAdTrafficMetadataSealed(obj1.sourceQuestContent, id);
                ...
                const tmpResult11 = closure_2_0(tmp2[8]);
              } else {
                const questLogger2 = closure_2_0(tmp2[18]).getQuestLogger();
                const tmpResult12 = closure_2_0(tmp2[18]);
                const _HermesInternal3 = HermesInternal;
                const obj5 = { impressionId: null };
                obj5[0] = obj1.id;
                questLogger2.info("" + obj1.entity.adContentIds[index] + " ad content viewed for at least " + obj1.minViewTimeSeconds + "s at " + closure_2_0(tmp2[11]).getQuestContentName(obj1.questContent), obj5);
                const tmpResult13 = closure_2_0(tmp2[11]);
                const obj6 = {};
                const merged4 = Object.assign(obj3);
                obj6.shouldExtendSession = shouldExtendSessionResult;
                obj6.adContentId = obj1.entity.adContentIds[index];
                ...
                closure_2_0(tmp2[19]).trackAdContentEvent(obj6);
                const tmpResult14 = closure_2_0(tmp2[19]);
              }
            });
    ...
    obj.beat = function beat(arg0) {
      ...
      if (null != flag.lastBeatTime) {
        ...
        const item = adContentIds.forEach((item, index) => {
          obj = flag;
          if (flag.entity.adCreativeType === obj(dependencyMap[9]).AdCreativeType.QUEST) {
            const quest = closure_2_5.getQuest(tmp18);
            let tmpResult = tmp(dependencyMap[18]);
            ...
            tmpResult = tmp(dependencyMap[19]);
            obj = {};
            const merged = Object.assign(obj);
            ...
            const questLogger1 = tmp(dependencyMap[18]).getQuestLogger();
            let str = "";
            if (flag) {
              str = "terminal ";
            }
            ...
            const tmpResult1 = tmp(dependencyMap[18]);
            const obj3 = {};
            ...
            obj3.properties = obj4;
            tmp(dependencyMap[19]).trackAdContentEvent(obj3);
            const tmpResult2 = tmp(dependencyMap[19]);
          }
        });
      }
    ...
    obj.commonProperties = function commonProperties() {
      ...
      const merged = Object.assign(obj(dependencyMap[11]).getContentProperties(obj.questContent, obj.questContentPosition, obj.questContentRowIndex));
      return obj;
    };
    ...
    obj.start = function start() {
      ...
      const item = adContentIds.forEach((item, index) => {
        ...
        if (closure_0.migrateQuestContentLoadedToCaptureAdUserAction) {
          ...
          obj[0] = obj1.entity.adCreativeType;
          obj[1] = obj1.entity.adContentIds[index];
          let tmpResult = tmp(dependencyMap[16]);
          ...
          obj[0] = tmp(dependencyMap[17]).AdUserActionType.END_CONTENT_LOAD;
          ...
          tmpResult = tmp(dependencyMap[18]);
          const questLogger = tmpResult.getQuestLogger();
          let questName;
          if (quest != null) {
            questName = quest.config.messages.questName;
          ...
          obj1 = { impressionId: null };
          obj1[0] = obj1.id;
          questLogger.info("" + questName + " Quest became visible at " + tmp(dependencyMap[11]).getQuestContentName(obj1.questContent), obj1);
          const tmpResult1 = tmp(dependencyMap[11]);
          const obj2 = {};
          const merged1 = Object.assign(closure_0);
          obj2.questId = obj1.entity.adContentIds[index];
          obj2.event = AnalyticEvents.QUEST_CONTENT_LOADED;
          const obj3 = {};
          ...
          let adTrafficMetadataSealed = tmp(dependencyMap[8]).getAdTrafficMetadataSealed(obj1.sourceQuestContent, id);
          if (adTrafficMetadataSealed == null) {
            adTrafficMetadataSealed = null;
          }
          ...
          const questLogger1 = tmp(dependencyMap[18]).getQuestLogger();
          const tmpResult4 = tmp(dependencyMap[18]);
          const _HermesInternal2 = HermesInternal;
          const obj4 = { impressionId: null };
          obj4[0] = obj1.id;
          questLogger1.info("" + obj1.entity.adContentIds[index] + " ad content became visible at " + tmp(dependencyMap[11]).getQuestContentName(obj1.questContent), obj4);
          const tmpResult5 = tmp(dependencyMap[11]);
          const obj5 = {};
          const merged4 = Object.assign(closure_0);
          obj5.adContentId = obj1.entity.adContentIds[index];
          obj5.adCreativeType = obj1.entity.adCreativeType;
          obj5.event = AnalyticEvents.QUEST_CONTENT_LOADED;
          const obj6 = {};
          const merged5 = Object.assign(closure_1);
          const merged6 = Object.assign(obj1.commonProperties());
          obj5.properties = obj6;
          tmp(dependencyMap[19]).trackAdContentEvent(obj5);
          const tmpResult6 = tmp(dependencyMap[19]);
        }
      });
      obj = setDefault;
      obj = { name: obj(dependencyMap[22]).MetricEvents.QUEST_CONTENT_IMPRESSION, tags: null };
      const items = ["quest_content:" + obj(dependencyMap[11]).getQuestContentName(obj.questContent)];
      obj[1] = items;
      obj.increment(obj);
      obj.isRunning = true;
    };
...
let result = require("obj132").fileFinishedImporting("modules/quests/lib/analytics/ContentImpressionTracker.tsx");
