...
export const getContentProperties = function getContentProperties(
  questContent,
...
export const QuestContentCTA = {
  ...
  OPEN_ACCOUNT_LINK_MODAL: "OPEN_ACCOUNT_LINK_MODAL",
  OPEN_ACCOUNT_LINK_INSTRUCTIONS: "OPEN_ACCOUNT_LINK_INSTRUCTIONS",
  SELECT_IN_GAME_AUTH_METHOD: "SELECT_IN_GAME_AUTH_METHOD",
  SELECT_WEB_AUTH_METHOD: "SELECT_WEB_AUTH_METHOD",
  START_WEB_AUTHORIZATION: "START_WEB_AUTHORIZATION",
  ...
  OPEN_QUEST_HOME_TO_CLAIM: "OPEN_QUEST_HOME_TO_CLAIM",
  ...
  GAME_STORE_OPEN_REVIEWS: "GAME_STORE_OPEN_REVIEWS",
  MOBILE_ORBS_ONBOARDING_DC: "MOBILE_ORBS_ONBOARDING_DC",
  LAUNCH_MOBILE_ACTIVITY: "LAUNCH_MOBILE_ACTIVITY",
  OPEN_NITRO_CHECKOUT: "OPEN_NITRO_CHECKOUT",
  OPEN_NITRO_HOME: "OPEN_NITRO_HOME",
  START_BOUNTY: "START_BOUNTY",
  BACK_TO_BOUNTIES: "BACK_TO_BOUNTIES",
  QUEST_ACCESS_SUSPENDED: "QUEST_ACCESS_SUSPENDED",
};
