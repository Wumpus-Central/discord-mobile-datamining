...
const module_4698 = fn(4698);
obj4.storage = module_4698.createJSONStorage(() => require("LocalStorageWrapper"));
...
const withEqualityFnResult = identity(module_4698.persist((arg0, arg1) => {
  _require = arg0;
  closure_1 = arg1;
  return {
