...
const module_4628 = fn(4628);
obj4.storage = module_4628.createJSONStorage(() => require("LocalStorageWrapper"));
...
const withEqualityFnResult = identity(module_4628.persist((arg0, arg1) => {
  _require = arg0;
  closure_1 = arg1;
  return {
