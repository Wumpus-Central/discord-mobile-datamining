...
const module_4702 = fn(4702);
obj4.storage = module_4702.createJSONStorage(() => require("LocalStorageWrapper"));
...
const withEqualityFnResult = identity(module_4702.persist((arg0, arg1) => {
  _require = arg0;
  closure_1 = arg1;
  return {
