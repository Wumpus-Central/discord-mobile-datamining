...
const module_4700 = fn(4700);
obj4.storage = module_4700.createJSONStorage(() => require("LocalStorageWrapper"));
...
const withEqualityFnResult = identity(module_4700.persist((arg0, arg1) => {
  _require = arg0;
  closure_1 = arg1;
  return {
