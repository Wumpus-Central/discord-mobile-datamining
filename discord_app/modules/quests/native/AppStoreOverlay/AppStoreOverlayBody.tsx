// === Module 11761: AppStoreOverlayBody ===
...
import AppStoreOverlayStatsCarouselDefault from "AppStoreOverlayStatsCarousel" /* 11762 */;
import AppStoreOverlayMediaCarouselDefault from "AppStoreOverlayMediaCarousel" /* 11765 */;
import AppStoreOverlayAboutSectionDefault from "AppStoreOverlayAboutSection" /* 11770 */;
...
export const AppStoreOverlayBody = function AppStoreOverlayBody(arg0) {
  ...
  const items4 = [closure_7(onOverlaySurfaceClick(4753).Text, { variant: "heading-xl/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", children: metadata.title }), ];
...
export const AppStoreOverlayFooter = function AppStoreOverlayFooter(arg0) {
  ...
  const items2 = [closure_7(token(5199), { pointerEvents: "none", style: tmp.footerGradient, colors: memo, start: VerticalGradient.START, end: VerticalGradient.END }), ];
