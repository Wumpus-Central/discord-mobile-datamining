...
fn(4605);
let createStyles = { container: null, containerWithHeader: null, iconContainer: null, icon: null, textBlock: null, mediaSection: null, header: null, footer: null, footerGradient: null };
createStyles = { paddingTop: nativeDefault.space.PX_16, paddingHorizontal: nativeDefault.space.PX_16, gap: nativeDefault.space.PX_16 };
...
createStyles.header = { width: "100%", height: 156, overflow: "hidden", position: "absolute", top: 0, left: 0, right: 0 };
let obj2 = { gap: nativeDefault.space.PX_8 };
createStyles.footer = { backgroundColor: nativeDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND, paddingHorizontal: nativeDefault.space.PX_16 };
...
export const AppStoreOverlayFooter = function AppStoreOverlayFooter(arg0) {
  ...
  const items2 = [closure_7(token(5037), obj), ];
  ...
  obj1.children = closure_7(bottom(5025).Button, obj2);
