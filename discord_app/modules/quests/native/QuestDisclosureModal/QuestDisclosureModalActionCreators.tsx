...
export default {
  showModal(isTargetedDisclosure) {
    ...
    if (obj1.shouldMigrateToAdAnalyticsInterface(apexExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_disclosure_modal")) {
      ...
      obj[0] = tmp(9527).AdUserActionType.CLICK_INTERNAL;
      obj[1] = tmp(7189).AdCreativeType.QUEST;
      obj[2] = quest.id;
    ...
    obj7.pushLazy(asyncRequireImpl(14356, tmp2.paths), obj1, QUEST_DISCLOSURE_MODAL);
  },
  hideModal() {
