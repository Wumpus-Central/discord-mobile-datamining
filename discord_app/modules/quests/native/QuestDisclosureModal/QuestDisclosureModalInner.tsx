// === Module 14942: QuestDisclosureModalInner ===
...
export default function QuestDisclosureModalInner(isTargetedDisclosure) {
  ...
  const items2 = [tmp6(closure_4, { style: tmp.illustration, children: tmp6(_require(6265).WumpusCouchSpotIllustration, {}) }), , , , ];
  const obj3 = { variant: "text-md/normal", color: "mobile-text-heading-primary", children: null };
  const obj2 = { style: tmp.illustration, children: tmp6(_require(6265).WumpusCouchSpotIllustration, {}) };
  const tmp7 = closure_7;
  const tmp8 = closure_3;
  const tmp9 = closure_4;
  obj3[2] = _require(11152).getDisclosureText({ adCreativeType, gamePublisher, gameTitle, isTargetedDisclosure, isContextualDisclosure: setting, cosponsorName, isVideoQuest });
  ...
  const tmp2Result = _require(11152);
  obj6[0] = items1(1994).getArticleURL(HelpdeskArticles.QUESTS_PRIVACY_CONTROLS);
  obj5[2] = intl5.format(_require(1233).t.tzq9Wa, obj6);
  ...
  obj8[3] = intl6.string(_require(1233).t.cpT0Cq);
  obj8[4] = onClose;
