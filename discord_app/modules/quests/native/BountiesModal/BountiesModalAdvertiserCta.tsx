...
function BountiesModalAdvertiserCtaContent(bounty) {
  ...
  const obj2 = { style: tmp.ctaLogoContainer, children: closure_10(sourceQuestContent(getQuestImpressionId[20]), { source: { uri: scaledImageUrl }, style: tmp.ctaLogo, resizeMode: "cover" }) };
  ...
  const obj7 = { accessible: false, importantForAccessibility: "no-hide-descendants", children: closure_10(bounty(getQuestImpressionId[22]).Button, { variant: "primary-overlay", text: bountyCtaInfo.buttonLabel, size: "sm", onPress: callback2 }) };
...
let closure_13 = createStyles.createStyles(() => {
  ...
  obj = { flexDirection: "row", alignItems: "center", paddingLeft: nativeDefault.space.PX_12, paddingRight: nativeDefault.space.PX_16, paddingVertical: nativeDefault.space.PX_12, gap: nativeDefault.space.PX_12 };
  obj.cta = obj;
...
obj = { withTiming: fn(4606).withTiming, timingFast: fn(4609).timingFast };
fn2.__closure = obj;
...
export default function BountiesModalAdvertiserCta(visible) {
  ...
  entering = function s() {
    ...
    obj = { translateY: obj.withTiming(ReanimatedRexport2.interpolate(num, [0, 1], [8, 0]), visible ? tmp2.timingStandard : tmp2.timingFast) };
    const items = [obj];
    obj.transform = items;
    return obj;
  };
