// === Module 15013: useBountiesRecapOrbCount ===
...
export const useBountiesRecapOrbCount = function useBountiesRecapOrbCount(scrollY) {
  ...
  obj = { runOnJS: scrollY(lastBountyScrollOffset[2]).runOnJS, resetDisplayCount: callback1, setDisplayCountMonotonic: __initData };
  fn2.__closure = obj;
