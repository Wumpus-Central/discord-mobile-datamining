...
export const BountiesScrollRecapPage = function BountiesScrollRecapPage(orbAmount) {
  ...
  const items2 = [callback(VideoComponent /* VideoComponent */.VideoComponent, obj1), callback(BountiesRecapOrbsBackground, { style: tmp.orbsBackground, reducedMotion: stateFromStores })];
  obj[2] = items2;
  ...
  obj6[3] = intl.string(getSystemLocale /* getSystemLocale */.t.d6Rrn6);
  const items4 = [callback(Text /* Text */.Text, obj6), , ];
  ...
  const items5 = [callback(OrbsIcon /* OrbsIcon */.OrbsIcon, { size: "lg", color: "icon-strong", accessible: false }), ];
  const obj9 = { variant: "display-lg", color: "text-strong", accessible: false, style: tmp.orbAmount, children: null };
  obj9[4] = "+" + orbAmount;
  items5[1] = callback(Text /* Text */.Text, obj9);
  obj8[1] = items5;
  ...
  obj10[3] = intl2.string(getSystemLocale /* getSystemLocale */.t.x0Ffz3);
  items4[2] = callback(Text /* Text */.Text, obj10);
  obj5[2] = items4;
  ...
  obj13[2] = intl3.string(getSystemLocale /* getSystemLocale */.t.i4jeWR);
  obj13[4] = onClose;
  obj11[1] = callback(Button /* Button */.Button, obj13);
