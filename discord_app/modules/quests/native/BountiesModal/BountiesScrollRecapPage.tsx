...
import _modDef15386 from "../../../../../discord_assets/assets/quests/bounties/_3d_orbs.png.js";
import _modDef15387 from "../../../../../discord_assets/assets/quests/bounties/_3d_orbs.mov.js";
...
function BountiesRecapOrbsBackground(arg0) {
  ...
  if (obj.isAndroid()) {
    ...
    tmp3Result = timestampProducer(common_Video.VideoComponent, obj4);
  }
  return tmp3Result;
}
...
export const BountiesScrollRecapPage = function BountiesScrollRecapPage(orbAmount) {
  ...
  const items2 = [
    timestampProducer(common_Video.VideoComponent, obj5),
