...
function BountiesModalContentInner(bounty) {
  ...
  items10[1] = videoDuration(flushProgress, {
    style: memo1,
    children: videoDuration(sourceQuestContent(15140), { onPress: callback2 }),
  });
  let rect = {
    ...
    children: videoDuration(tmp2(15133), { bounty, visible: isEndCardVisible, sourceQuestContent, onClose: callback3 }),
  };
