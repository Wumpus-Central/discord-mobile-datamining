...
let closure_10 = createCacheKey.createStyles(() => {
  ...
  obj = { position: "absolute", left: 0, right: 0, bottom: 0, height: "45%", alignItems: "center", justifyContent: "center", paddingHorizontal: Themes.space.PX_16 };
  obj[0] = obj;
  obj = { position: "absolute", bottom: 124, left: 0, right: 0, alignItems: "center", justifyContent: "flex-start", gap: Themes.space.PX_8 };
  obj[1] = obj;
