...
export const BountiesScrollVideoItem = function BountiesScrollVideoItem(bounty) {
  ...
  obj[1] = bounty(7228).AdCreativeType.BOUNTY;
  obj[2] = bounty(5206).QuestContent.VIDEO_MODAL_MOBILE;
  ...
  return flag3(bounty(11234).BillableAdPlacementImpressionTrackerNative, obj);
};