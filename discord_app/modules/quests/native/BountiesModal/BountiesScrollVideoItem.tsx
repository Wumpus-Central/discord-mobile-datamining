...
function BountiesScrollVideoItemInner(bounty) {
  ...
  const BountyVideoEndMode = tmp2(14621).BountyVideoEndMode;
  if (loopingEnabled) {
  ...
  if (!stage1Enabled) {
    ...
    obj[8] = index;
    obj[9] = isActive;
    const bountiesModalVideoAnalytics = tmp2(14625).useBountiesModalVideoAnalytics(obj);
    ...
    obj1[12] = duration;
    const bountiesModalTiming = tmp2(14621).useBountiesModalTiming(obj1);
    ...
    obj3[33] = function renderEndCard() {
      return handleProgress(isActive(ref[17]).QuestContentImpressionTrackerNative, {
        ...
        children() {
          return closure_1_10(closure_1_1(closure_1_2[20]), {
            bounty: closure_0,
            visible: closure_17,
            onReplay: closure_20,
            isActive: closure_4,
    ...
    obj2[1] = handleProgress(tmp2(14627).BountyVideo, obj3);
...
export const BountiesScrollVideoItem = function BountiesScrollVideoItem(bounty) {
  ...
  return flag3(bounty(11345).BillableAdPlacementImpressionTrackerNative, {
    adContentId: bounty.id,
    adCreativeType: bounty(7446).AdCreativeType.BOUNTY,
    questContent: bounty(5392).QuestContent.VIDEO_MODAL_MOBILE,
    sourceQuestContent,
