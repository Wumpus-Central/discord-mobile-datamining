...
function BountiesScrollVideoItemInner(bounty) {
  ...
  const BountyVideoEndMode = tmp2(14270).BountyVideoEndMode;
  if (loopingEnabled) {
  ...
  if (!stage1Enabled) {
    ...
    obj[8] = index;
    obj[9] = isActive;
    const bountiesModalVideoAnalytics = tmp2(14274).useBountiesModalVideoAnalytics(obj);
    ...
    obj1[12] = duration;
    const bountiesModalTiming = tmp2(14270).useBountiesModalTiming(obj1);
    ...
    obj2[1] = handleProgress(tmp2(14276).BountyVideo, obj3);
...
export const BountiesScrollVideoItem = function BountiesScrollVideoItem(bounty) {
  ...
  obj[1] = bounty(7189).AdCreativeType.BOUNTY;
  ...
  return flag3(bounty(11181).BillableAdPlacementImpressionTrackerNative, obj);
};