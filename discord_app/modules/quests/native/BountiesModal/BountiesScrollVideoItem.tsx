...
function BountiesScrollVideoItemInner(bounty) {
  ...
  if (!stage1Enabled) {
    ...
    const tmp47 =
      config.enabled &&
      tmp48 === tmp2(tmp3[18]).BountiesCtrExperiment1Variant.ENTIRE_VIDEO_CLICKABLE &&
      isActive &&
      !isEndCardVisible;
    closure_25 = tmp47;
    ...
    size.renderEndCard = function renderEndCard() {
      return jsx(QuestContentImpressionTracker.QuestContentImpressionTrackerNative, {
        ...
        children() {
          return c10(sourceQuestContent(width[26]), {
            bounty,
            visible,
            onReplay,
            isActive,
    ...
    children() {
      ...
      return (
        <BountiesScrollVideoItemInner
          ...
          isScrollIndicatorOverlayEnabled={isScrollIndicatorOverlayEnabled}
          shouldLoadHls={flag3}
          scrollAffordance={scrollAffordance}
          peekScale={peekScale}
