...
export default function BountiesModalProgress(progress) {
  ...
  obj = { withTiming: progress(shouldSkipAnimation[7]).withTiming, visible, timingFast: progress(shouldSkipAnimation[8]).timingFast };
  O.__closure = obj;
  ...
  obj = { withTiming: progress(shouldSkipAnimation[7]).withTiming, progress, shouldSkipAnimation, timingNone: progress(shouldSkipAnimation[8]).timingNone, timingFast: progress(shouldSkipAnimation[8]).timingFast };
  B.__closure = obj;
