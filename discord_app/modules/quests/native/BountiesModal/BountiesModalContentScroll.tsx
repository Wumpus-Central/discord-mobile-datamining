...
function BountiesModalContentScrollInner(initialBountyId) {
  ...
  let obj6 = initialBountyId(14547);
  const handleRecapMomentumEnd = initialBountyId(14548).useBountiesRecapScroll({
    listRef: ref,
    enabled: tmp28,
    offsets: memo4,
  ...
  __initData7 = initialBountyId(14549).useBountiesRecapOrbCount({
  ...
  Et.__closure = {
    ...
    runOnJS: initialBountyId(4566).runOnJS,
    handleRecapMomentumEnd,
    isScrollingInBoundsSharedValue: sharedValue2,
  };
  ...
  Tt.__closure = {
    ...
    scrollY: sharedValue4,
    lastBountyScrollOffset: result,
    RECAP_SNAP_EPSILON: initialBountyId(14548).RECAP_SNAP_EPSILON,
  };
  ...
  Jt.__closure = {
    getRevealProgress: initialBountyId(14548).getRevealProgress,
    scrollY: sharedValue4,
    lastBountyScrollOffset: result,
    recapRevealHeight: height3,
  };
  ...
  Ut.__closure = {
    interpolate: initialBountyId(4566).interpolate,
    recapPullProgress: derivedValue,
    Extrapolation: initialBountyId(4566).Extrapolation,
  };
...
export default function BountiesModalContentScroll(arg0) {
  ...
  return __initData(native.ThemeContextProvider, {
