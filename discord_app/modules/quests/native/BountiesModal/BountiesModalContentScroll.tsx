...
function BountiesModalContentScrollInner(initialBountyId) {
  ...
  let obj6 = initialBountyId(15347);
  const handleRecapMomentumEnd = initialBountyId(15348).useBountiesRecapScroll({
    listRef: ref,
    enabled: tmp28,
    offsets: memo4,
  ...
  __initData7 = initialBountyId(15349).useBountiesRecapOrbCount({
  ...
  Et.__closure = {
    ...
    runOnJS: initialBountyId(4559).runOnJS,
    handleRecapMomentumEnd,
    isScrollingInBoundsSharedValue: sharedValue2,
  };
  ...
  Tt.__closure = {
    ...
    scrollY: sharedValue4,
    lastBountyScrollOffset: result,
    RECAP_SNAP_EPSILON: initialBountyId(15348).RECAP_SNAP_EPSILON,
  };
  ...
  Jt.__closure = {
    getRevealProgress: initialBountyId(15348).getRevealProgress,
    scrollY: sharedValue4,
    lastBountyScrollOffset: result,
    recapRevealHeight: height3,
  };
  ...
  Ut.__closure = {
    interpolate: initialBountyId(4559).interpolate,
    recapPullProgress: derivedValue,
    Extrapolation: initialBountyId(4559).Extrapolation,
  };
