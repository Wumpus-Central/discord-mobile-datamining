...
function BountiesModalContentScrollInner(initialBountyId) {
  ...
  const stateFromStores = obj4.useStateFromStores(items7, () => BountyStore.getCompletedBountyCount(first) * closure_9, items8);
  ...
  const handleRecapMomentumEnd = obj6.useBountiesRecapScroll({ listRef: ref, enabled: tmp28, offsets: memo4 }).handleRecapMomentumEnd;
  ...
  __initData7 = obj10.useBountiesRecapOrbCount({ scrollY: sharedValue4, lastBountyScrollOffset: result, recapRevealHeight: height3, targetOrbAmount: stateFromStores, enabled: tmp28 });
  ...
  const callback5 = noop.useCallback(() => {
    if (null != first[first3]) {
      ...
      let obj = { adContentId: tmp.id, adCreativeType: AdCreativeType.AdCreativeType.BOUNTY, event: constants.AD_VIDEO_MODAL_CLOSED, properties: null, sourceQuestContent: null };
  ...
  obj = { scrollY: sharedValue4, isDraggingSharedValue: sharedValue3, isScrollingInBoundsSharedValue: sharedValue2, isScrollEventInBounds: handleRecapMomentumEnd };
  ft.__closure = obj;
  ...
  obj2 = { showRecapPullZone: tmp28, runOnJS: initialBountyId(4373).runOnJS, handleRecapMomentumEnd, isScrollingInBoundsSharedValue: sharedValue2 };
  Et.__closure = obj2;
  ...
  obj4 = { showRecapPullZone: tmp28, scrollY: sharedValue4, lastBountyScrollOffset: result, RECAP_SNAP_EPSILON: initialBountyId(15100).RECAP_SNAP_EPSILON };
  Tt.__closure = obj4;
  ...
  obj7 = { showRecapPullZone: tmp28, scrollY: sharedValue4, fullRecapScrollOffset: sum1, RECAP_SNAP_EPSILON: initialBountyId(15100).RECAP_SNAP_EPSILON };
  Ct.__closure = obj7;
  ...
  obj10 = { getRevealProgress: initialBountyId(15100).getRevealProgress, scrollY: sharedValue4, lastBountyScrollOffset: result, recapRevealHeight: height3 };
  Jt.__closure = obj10;
  ...
  obj11 = { interpolate: initialBountyId(4373).interpolate, recapPullProgress: derivedValue, Extrapolation: initialBountyId(4373).Extrapolation };
  Ut.__closure = obj11;
  ...
  const obj12 = { interpolate: initialBountyId(4373).interpolate, recapPullProgress: derivedValue, FOOTER_FADE_START_PROGRESS: height3, FOOTER_FADE_END_PROGRESS, Extrapolation: initialBountyId(4373).Extrapolation };
  ...
  const obj13 = { scrollY: sharedValue4, lastBountyScrollOffset: result, slotHeight: sum, recapPullProgress: derivedValue, getRevealProgress: initialBountyId(15100).getRevealProgress, recapRevealHeight: height3, interpolate: initialBountyId(4373).interpolate, FOOTER_FADE_START_PROGRESS: height3, FOOTER_FADE_END_PROGRESS, Extrapolation: initialBountyId(4373).Extrapolation };
  ...
  const obj14 = { interpolate: initialBountyId(4373).interpolate, scrollY: sharedValue4, slotHeight: sum, Extrapolation: initialBountyId(4373).Extrapolation };
  ...
  if (0 === data.length) {
    ...
    tmp86Result = null;
    if (null != tmp16) {
      obj23 = { metadata: tmp16.metadata, sheetHeight: memo2, revealProgress: sharedValue1, onDismiss: callback2, onInstallPress: tmp16.onInstallPress };
    ...
    const obj28 = { visible: tmp43, onContentLayout: callback, zIndex: height3, opacityStyle: animatedStyle3, children: tmp85 };
