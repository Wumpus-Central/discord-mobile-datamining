// === Module 15389: BountyVideoEndAppStorePanel ===
...
const ACTION_SHEET_BORDER_RADIUS = fn(7482).ACTION_SHEET_BORDER_RADIUS;
const jsxProd = fn(21);
...
obj2.scrollContent = { paddingBottom: fn(11837).APP_STORE_OVERLAY_FOOTER_GRADIENT_HEIGHT };
