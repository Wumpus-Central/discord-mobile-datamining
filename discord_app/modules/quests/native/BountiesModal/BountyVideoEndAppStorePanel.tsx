// === Module 14564: BountyVideoEndAppStorePanel ===
...
const ACTION_SHEET_BORDER_RADIUS = fn(6567).ACTION_SHEET_BORDER_RADIUS;
const jsxProd = fn(21);
...
obj2.scrollContent = { paddingBottom: fn(10712).APP_STORE_OVERLAY_FOOTER_GRADIENT_HEIGHT };
