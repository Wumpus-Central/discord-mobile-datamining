// === Module 15398: BountyVideoEndAppStorePanel ===
...
const ACTION_SHEET_BORDER_RADIUS = fn(7484).ACTION_SHEET_BORDER_RADIUS;
const jsxProd = fn(21);
...
obj2.scrollContent = { paddingBottom: fn(11843).APP_STORE_OVERLAY_FOOTER_GRADIENT_HEIGHT };
