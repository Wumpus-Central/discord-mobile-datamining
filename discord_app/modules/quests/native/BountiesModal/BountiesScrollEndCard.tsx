...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const obj = isActive(4563);
  S.__closure = {
    isScrollingInBoundsSharedValue,
    withTiming: isActive(4830).withTiming,
    isActive,
    timingStandard: isActive(4833).timingStandard,
  };
  ...
  const items1 = [
    ...
    closure_8(isScrollingInBoundsSharedValue(5286), {
  ...
  obj6.style = items2;
  const items3 = [
    closure_8(isScrollingInBoundsSharedValue(14556), { bounty, sourceQuestContent, disabled: !isActive }),
  ];
  const obj8 = {
