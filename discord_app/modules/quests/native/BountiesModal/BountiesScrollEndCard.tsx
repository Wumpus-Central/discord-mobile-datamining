...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const obj = isActive(4493);
  S.__closure = {
    isScrollingInBoundsSharedValue,
    withTiming: isActive(4758).withTiming,
    isActive,
    timingStandard: isActive(4761).timingStandard,
  };
  ...
  const items1 = [
    ...
    closure_8(isScrollingInBoundsSharedValue(5199), {
  ...
  obj6.style = items2;
  const items3 = [
    closure_8(isScrollingInBoundsSharedValue(15329), { bounty, sourceQuestContent, disabled: !isActive }),
  ];
  const obj8 = {
