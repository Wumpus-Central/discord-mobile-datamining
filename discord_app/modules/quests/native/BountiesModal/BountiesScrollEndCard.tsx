...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const obj = isActive(4566);
  S.__closure = {
    isScrollingInBoundsSharedValue,
    withTiming: isActive(4837).withTiming,
    isActive,
    timingStandard: isActive(4840).timingStandard,
  };
  ...
  const items1 = [
    ...
    closure_8(isScrollingInBoundsSharedValue(5293), {
  ...
  obj6.style = items2;
  const items3 = [
    closure_8(isScrollingInBoundsSharedValue(14581), { bounty, sourceQuestContent, disabled: !isActive }),
  ];
  const obj8 = {
