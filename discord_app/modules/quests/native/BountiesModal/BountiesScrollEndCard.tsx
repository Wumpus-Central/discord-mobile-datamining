...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const obj = isActive(4559);
  S.__closure = {
    isScrollingInBoundsSharedValue,
    withTiming: isActive(4828).withTiming,
    isActive,
    timingStandard: isActive(4831).timingStandard,
  };
  ...
  const items1 = [
    ...
    closure_8(isScrollingInBoundsSharedValue(5283), {
  ...
  obj6.style = items2;
  const items3 = [
    closure_8(isScrollingInBoundsSharedValue(15381), { bounty, sourceQuestContent, disabled: !isActive }),
  ];
  const obj8 = {
