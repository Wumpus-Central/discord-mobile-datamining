...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const obj = isActive(4458);
  S.__closure = {
    isScrollingInBoundsSharedValue,
    withTiming: isActive(4723).withTiming,
    isActive,
    timingStandard: isActive(4726).timingStandard,
  };
  ...
  const items1 = [
    ...
    closure_8(isScrollingInBoundsSharedValue(5156), {
  ...
  obj6.style = items2;
  const items3 = [
    closure_8(isScrollingInBoundsSharedValue(15260), { bounty, sourceQuestContent, disabled: !isActive }),
  ];
  const obj8 = {
