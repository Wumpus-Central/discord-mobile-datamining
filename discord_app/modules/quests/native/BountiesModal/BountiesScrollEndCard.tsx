...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  const items1 = [
    ...
    closure_8(isScrollingInBoundsSharedValue(5285), {
  ...
  obj6.style = items2;
  const items3 = [
    closure_8(isScrollingInBoundsSharedValue(15390), { bounty, sourceQuestContent, disabled: !isActive }),
  ];
  const obj8 = {
