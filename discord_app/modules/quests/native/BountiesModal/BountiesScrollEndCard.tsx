...
function BountiesScrollEndCardContent(isScrollingInBoundsSharedValue) {
  ...
  S.__closure = {
    ...
    withTiming: isActive(4640).withTiming,
    isActive,
    timingStandard: isActive(4643).timingStandard,
  };
  ...
  const items1 = [
    ...
    closure_8(isScrollingInBoundsSharedValue(5071), {
  ...
  obj6.style = items2;
  const items3 = [
    closure_8(isScrollingInBoundsSharedValue(15142), { bounty, sourceQuestContent, disabled: !isActive }),
  ];
  const obj8 = {
