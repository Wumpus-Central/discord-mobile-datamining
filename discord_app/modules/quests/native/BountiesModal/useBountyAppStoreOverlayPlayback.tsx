// discord_app/modules/quests/native/BountiesModal/useBountyAppStoreOverlayPlayback.tsx
...
import useBountyPauseAppStoreSheet from "useBountyPauseAppStoreSheet.tsx";
...
export const useBountyAppStoreOverlayPlayback = function useBountyAppStoreOverlayPlayback(handleVideoPaused) {
  ...
  const onVideoEndForAppStore = useBountyVideoEndAppStoreOverlay.useBountyVideoEndAppStoreOverlay({
    bounty,
    sourceQuestContent,
    isActive,
    endMode,
  ...
  handleVideoPausedForAppStore = useBountyPauseAppStoreSheet.useBountyPauseAppStoreSheet({
    bounty,
    sourceQuestContent,
    isActive,
    playerRef,
  ...
  const obj3 = {
    isVideoEndAppStoreOverlayVisible: flag,
    shouldRepeatVideo: null,
    handlePaused: null,
    handleResumed: null,
    handleVideoEndWithAppStore: null,
  };
