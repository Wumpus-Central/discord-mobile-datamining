...
export const BountyVideo = function BountyVideo(bounty) {
  ...
  obj = { isScrollingInBoundsSharedValue, withTiming: tmp7(tmp8[11]).withTiming, isActive, timingStandard: tmp7(tmp8[12]).timingStandard };
  Pe.__closure = obj;
  ...
  const obj14 = { style: null, children: tmp41(handleVideoProgress(handleVideoError[8]), { progress: normalizedProgress, visible: isProgressBarVisible }) };
