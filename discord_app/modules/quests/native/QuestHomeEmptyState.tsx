// === Module 14176: QuestHomeEmptyState ===
...
export default function QuestHomeEmptyState(subtitle) {
  ...
  const items = [callback(require(4251) /* Text */.Text, { variant: "heading-xl/bold", color: "mobile-text-heading-primary", style: tmp5.emptyStateContentTitle, children: title }), callback(require(4251) /* Text */.Text, { variant: "text-md/normal", color: "text-default", style: tmp5.emptyStateContentDescription, children: subtitle }), ];
