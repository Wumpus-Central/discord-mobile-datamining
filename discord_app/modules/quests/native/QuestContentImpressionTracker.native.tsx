...
function AdContentImpressionTrackerBaseNative(skipRemountKey) {
  ...
  obj = { visible: overrideVisibility, visibleChanged: overrideVisibility !== tmp5(8300)(overrideVisibility) };
  obj1 = {};
  ...
  if (tmp17) {
    obj2.adCreativeType = tmp(5465).AdCreativeType.QUEST;
    let tmp19 = obj2;
  } else {
