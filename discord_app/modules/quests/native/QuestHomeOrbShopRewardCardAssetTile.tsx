...
import _modDef9172 from "../../../../_runtime/metro/09172__.js";
...
function CompactAvatarDecorationPreview(arg0) {
  ...
  const items = [
    React6(hasOwnProperty, { style: tmp.avatar, resizeMode: "contain", source: _modDef9172, accessible: false }),
  ];
...
function ProductPreviewInner(cardHeight) {
  ...
  const tmp5 =
    cardWidth < cardWidth(9124).COLLECTIBLES_SHOP_CARD_WIDTH ||
    cardHeight < cardWidth(9124).COLLECTIBLES_SHOP_CARD_HEIGHT;
  dependencyMap = tmp5;
