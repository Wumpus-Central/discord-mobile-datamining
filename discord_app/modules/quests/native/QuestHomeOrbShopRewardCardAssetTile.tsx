...
import _modDef8266 from "../../../../_runtime/metro/08266__.js";
...
function CompactAvatarDecorationPreview(arg0) {
  ...
  const items = [
    React6(hasOwnProperty, { style: tmp.avatar, resizeMode: "contain", source: _modDef8266, accessible: false }),
  ];
...
function ProductPreviewInner(cardHeight) {
  ...
  const tmp5 =
    cardWidth < cardWidth(8218).COLLECTIBLES_SHOP_CARD_WIDTH ||
    cardHeight < cardWidth(8218).COLLECTIBLES_SHOP_CARD_HEIGHT;
  dependencyMap = tmp5;
