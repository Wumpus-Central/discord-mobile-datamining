...
function CompactAvatarDecorationPreview(arg0) {
  ...
  const items = [
    React6(hasOwnProperty, { style: tmp.avatar, resizeMode: "contain", source: _modDef8938, accessible: false }),
  ];
    ...
    if (ALL.has(product.skuId)) {
      ...
      if (cardWidth(1889).CollectiblesItemType.AVATAR_DECORATION === type) {
        if (flag) {
          ...
          tmp24Result = closure_8(cardHeight(8937), obj6);
        }
        return tmp24Result;
        ...
        if (flag) {
          ...
          obj9.children = closure_8(cardHeight(8949), obj10);
