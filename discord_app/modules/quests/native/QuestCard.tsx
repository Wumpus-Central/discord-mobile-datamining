...
export const QuestCard = noop.memo((questContent) => {
  ...
  const tmp15 = product();
  let items1 = [quest.id];
  const tmp16 = sourceQuestContent(require("module_9002").useRecyclingState(null, items1), 2);
  first = tmp16[0];
  onPress = tmp18;
  let items2 = [tmp16[1]];
  ...
  const tmpResult48 = require("module_9002");
        ...
        if (hasWatchVideoTasksResult) {
          ...
          obj10.onPress = function onPress() {
            ...
            if (hasWatchVideoOnMobileTasks) {
              ...
              ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(15395, dependencyMap.paths), "QuestBottomSheet", obj2);
          ...
          try {
            ...
            if (0 === v1) {
              if (arg0 === 1) {
                ...
                if (!isMobileActivityQuest) {
                  if (!hasWatchVideoTasksResult) {
                    let START_QUEST = tmp2(7967).QuestContentCTA.ACCEPT_QUEST;
                  }
                ...
                START_QUEST = tmp2(7967).QuestContentCTA.START_QUEST;
              }
            } else if (arg0 === 1) {
              dependencyMap = 3;
              throw value;
