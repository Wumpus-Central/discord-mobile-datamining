// === Module 15067: QuestHomeBounties ===
...
import BountyCard from "BountyCard" /* 15068 */;
import BountiesCtaHeaderDefault from "BountiesCtaHeader" /* 15079 */;
import QuestHomeOrbShopCarouselDefault from "QuestHomeOrbShopCarousel" /* 15084 */;
...
function QuestHomeBountiesCarousel(bounties) {
  ...
  const callback7 = first1.useCallback((bountyId, questContentPosition) => {
    ...
    if (obj.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "quest_home_bounties")) {
      ...
      obj = { type: captureAdUserActionTypes.AdUserActionType.CLICK_INTERNAL, adCreativeType: AdCreativeType.AdCreativeType.BOUNTY, adCreativeId: bountyId.id, questContentCTA: AnalyticsTypes.QuestContentCTA.START_BOUNTY, surfaceId: QuestTypes.QuestContent.QUEST_HOME_MOBILE_CAROUSEL, sourceQuestContent: QuestTypes.QuestContent.QUEST_HOME_MOBILE_CAROUSEL, questContentPosition };
      tmpResult.captureAdUserAction(obj);
    } else {
      tmpResult = AnalyticsActions;
      obj = { adContentId: bountyId.id, adCreativeType: AdCreativeType.AdCreativeType.BOUNTY, questContent: QuestTypes.QuestContent.QUEST_HOME_MOBILE_CAROUSEL, questContentCTA: AnalyticsTypes.QuestContentCTA.START_BOUNTY, sourceQuestContent: QuestTypes.QuestContent.QUEST_HOME_MOBILE_CAROUSEL, questContentPosition };
    ...
    if (!stateFromStores) {
      if (verticalScrollEnabled) {
        ...
        if (!tmp14) {
          ...
          obj = { bounties: questHomeBounties, shopCarouselButtonVariant: buttonVariant, footer: null, replaceHeaderMediaWith: null };
          let tmp26;
          if ("inside" === placement) {
            tmp26 = null;
          }
          ...
          const obj1 = { embedded: "inside" === placement, replacesHeaderMedia: "replace_media" === placement, listEdgeSpacing: null, orbShopProducts: null, obtainableOrbRewards: null, showOrbShopPlaceholderCarousel: null, clickable: null };
          if ("outside" === placement) {
            let PX_20 = PX_16;
          } else {
