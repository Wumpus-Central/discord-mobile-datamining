...
function QuestActivityUnenrolledModalInner(quest) {
  ...
  obj = {
    ...
    sourceQuestContent: quest(5461).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL,
  };
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              const obj1 = {
                questContent: tmp4(5461).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL,
                questContentCTA: tmp4(7742).QuestContentCTA.START_QUEST,
                sourceQuestContent: tmp4(5461).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL,
              };
              v1 = 1;
              dependencyMap = 1;
