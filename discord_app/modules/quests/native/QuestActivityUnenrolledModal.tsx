...
function QuestActivityUnenrolledModalInner(quest) {
  ...
  obj = {
    ...
    sourceQuestContent: quest(5399).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL,
  };
  ...
  const callback1 = React.useCallback(() => {
    trackQuestContentClickedWithImpression({
      questId: quest.id,
      questContent: quest(5399).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL,
      questContentCTA: quest(7484).QuestContentCTA.QUEST_ACCESS_SUSPENDED,
      sourceQuestContent: quest(5399).QuestContent.QUEST_ACTIVITY_UNENROLLED_MODAL,
    });
    first(14960)();
  }, items3);
