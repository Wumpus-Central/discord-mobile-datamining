...
function QuestHomeHeaderRight(isVirtualCurrencyEnabled) {
  ...
  if (isVirtualCurrencyEnabled) {
    ...
    isVirtualCurrencyEnabled = closure_8(balance(11185).BalanceWidgetPillButton, obj);
  }
...
function FiltersButton(setSelectedSortMethod) {
  ...
  const callback = selectedSortMethod.useCallback(() => {
    ...
    obj.openLazy(asyncRequireImpl(15053, dependencyMap.paths), "QuestHomeSortingFilteringBottomSheet", obj);
  }, items);
