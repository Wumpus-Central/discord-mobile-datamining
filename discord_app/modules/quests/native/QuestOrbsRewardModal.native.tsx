...
function CancelButton() {
  ...
  return callback3(require("../../../../_runtime/05510_Background.js").HeaderBackButton, obj);
}
function StaticOrb() {
...
let closure_23 = importAllResult.memo((animate) => {
  ...
  aPNGPlayerControls = flag(8530).useAPNGPlayerControls(ref);
  ...
  return callback3(flag(8530).APNGPlayer, {
    ref,
    url,
    autoplay: false,
    style: { width: "100%", height: "100%" },
...
export default function QuestOrbsRewardModal(quest) {
  ...
  if (num2 == null) {
    num2 = tmp2(11147).getQuestOrbRewardQuantityForUser(quest.config, stateFromStores2);
    const tmp2Result = tmp2(11147);
  }
  ...
  if (!tmp6) {
    ...
    items5[3] = obj7;
    obj3[5] = items5;
    tmp15(tmp2(5561).SafeAreaPaddingView, obj3);
  }
}
