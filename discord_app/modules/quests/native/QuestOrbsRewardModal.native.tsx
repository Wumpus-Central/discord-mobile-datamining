...
function CancelButton() {
  ...
  return callback3(require("../../../../_runtime/05511_Background.js").HeaderBackButton, obj);
}
function StaticOrb() {
...
let closure_23 = importAllResult.memo((animate) => {
  ...
  aPNGPlayerControls = flag(8534).useAPNGPlayerControls(ref);
  ...
  return callback3(flag(8534).APNGPlayer, {
    ref,
    url,
    autoplay: false,
    style: { width: "100%", height: "100%" },
...
let closure_24 = importAllResult.memo((animate) => {
  ...
  obj = {
    ...
    children: callback3(obj.isAndroid() ? closure_23 : closure_22, { uri, onLoad, animate: flag }),
  };
  return callback3(closure_8, obj);
});
...
export default function QuestOrbsRewardModal(quest) {
  ...
  if (num2 == null) {
    num2 = tmp2(11151).getQuestOrbRewardQuantityForUser(quest.config, stateFromStores2);
    const tmp2Result = tmp2(11151);
  }
  ...
  obj = {
    style: closure_7.absoluteFill,
    accessible: false,
    accessibilityElementsHidden: true,
    importantForAccessibility: "no-hide-descendants",
    children: callback3(closure_25, obj1),
  };
  obj1 = {
  ...
  if (!tmp6) {
    ...
    items5[3] = obj7;
    obj3[5] = items5;
    tmp15(tmp2(5562).SafeAreaPaddingView, obj3);
  }
}
