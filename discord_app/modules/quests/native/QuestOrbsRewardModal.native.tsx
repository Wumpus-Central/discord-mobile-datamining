...
import _modDef11811 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_bg_static.png.js";
import _modDef11812 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_bg.mp4.js";
import _modDef11813 from "../../../../discord_assets/assets/orbs/static_idle_orb.png.js";
import _modDef11814 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_idle_dark.png.js";
import _modDef11815 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_entry_dark.png.js";
...
function CancelButton() {
  ...
  return closure_13(require("../../../../_runtime/metro/05645__.js").HeaderBackButton, obj);
}
function StaticOrb() {
...
function AnimatedOrbContainer(isAppActive) {
  ...
  const items1 = [tmp13, ,];
  obj = { uri: _modDef11814, style: null, onLoad: null, animate: null };
  ...
  if (tmp15Result) {
    const obj2 = { uri: _modDef11815, style: null, onLoad: null, animate: null };
...
let closure_24 = noop.memo((animate) => {
  ...
  obj = {
    ...
    children: map1(obj.isAndroid() ? closure_23 : closure_22, { uri, onLoad, animate: flag }),
  };
  return map1(React6, obj);
});
...
export default function QuestOrbsRewardModal(quest) {
  ...
  obj1 = {
    ...
    onStaticBgLoad: callback,
    onAnimatedBgLoad: callback1,
    isAppActive: tmp11,
  };
  ...
  if (!tmp6) {
    ...
    let items6 = [closure_13(tmp2(4570).Heading, obj7)];
    ...
    items6[1] = closure_13(tmp2(4570).Text, obj9);
    ...
    closure_15(tmp2(7137).SafeAreaPaddingView, rect);
  }
