// === Module 12036: QuestOrbsRewardModal ===
...
function CancelButton() {
  ...
  return closure_13(require("module_5850").HeaderBackButton, obj);
}
function StaticOrb() {
...
export default function QuestOrbsRewardModal(quest) {
  ...
  const obj7 = { style: absoluteFill.absoluteFill, accessible: false, accessibilityElementsHidden: true, importantForAccessibility: "no-hide-descendants", children: closure_13(num(12041).OrbsRewardBackground, { style: tmp.background, onReady: callback }) };
