...
import _modDef12121 from "../../../../discord_assets/assets/orbs/static_idle_orb.png.js";
import _modDef12122 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_idle_dark.png.js";
import _modDef12123 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_entry_dark.png.js";
...
function OrbsBalance(balance) {
  ...
  const items = [
    map1(OrbsIcon.OrbsIcon, { size: "xs", color: nativeDefault.colors.WHITE, style: tmp.orbsIcon }),
    map1(React6, { style: tmp.spacer }),
    balance.balance,
  ];
  obj.children = items;
...
function CancelButton() {
  ...
  return closure_13(require("../../../../_runtime/metro/05936__.js").HeaderBackButton, obj);
}
function StaticOrb() {
...
function AnimatedOrbContainer(isAppActive) {
  ...
  if (tmp13) {
    ...
    tmp13 = map1(React6, obj2);
  }
  const items1 = [tmp13, ,];
  const obj3 = { uri: _modDef12122, style: null, onLoad: null, animate: null };
  ...
  if (tmp15Result) {
    const obj5 = { uri: _modDef12123, style: null, onLoad: null, animate: null };
...
let obj = {
  closeButton: { alignSelf: "flex-start", marginHorizontal: nativeDefault.space.PX_16, zIndex: 999 },
...
let closure_18 = createStyles.createStyles(() => {
  const obj = {
    ...
    background: React5.absoluteFillObject,
    loading: null,
    header: null,
    main: null,
    animation: null,
...
let closure_24 = noop.memo((animate) => {
  ...
  return map1(React6, {
    ...
    children: map1(utils_PlatformUtils.isAndroid() ? closure_23 : closure_22, { uri, onLoad, animate: flag }),
  });
});
createStyles = fn(4829);
...
export default function QuestOrbsRewardModal(quest) {
  ...
  let obj = num(504);
  num = num(9209).useFetchVirtualCurrencyBalance().balance;
  let obj2 = num(9209);
  ...
  if (num2 == null) {
    num2 = tmp2(11639).getQuestOrbRewardQuantityForUser(quest.config, stateFromStores2);
    const tmp2Result = tmp2(11639);
  }
  const effect = noop.useEffect(() => {
    num(12124).applyOrientationLock("PORTRAIT");
    return () => {
  ...
  let string = noop.useCallback(() => {
    _undefined(5032).popWithKey(QuestOrbsRewardModal);
    const obj = _undefined(5032);
    const obj2 = num(12108);
    obj2.openQuestHome({ filter: constants.VIRTUAL_CURRENCY, fromContent: num(5752).QuestContent.REWARD_MODAL });
  }, []);
  ...
  const obj7 = {
    ...
    children: closure_13(num(12125).OrbsRewardBackground, { style: tmp.background, onReady: callback }),
  };
  ...
  if (!tmp6) {
    ...
    if (stateFromStores) {
      let tmp13Result2 = closure_13(StaticOrb, {});
    } else {
      const obj12 = { isAppActive: stateFromStores1 === num(1094).AppStates.ACTIVE };
      tmp13Result2 = closure_13(AnimatedOrbContainer, obj12);
    }
    ...
    let items6 = [closure_13(tmp2(4825).Heading, obj14)];
    ...
    if (num >= 4100) {
      ...
      const obj17 = {
        ...
        profileDecoHook() {
          ...
          return closure_1_13(num(4825).Text, obj, "profileDeco");
        },
      };
    ...
    closure_15(tmp2(7456).SafeAreaPaddingView, rect);
  }
  const obj5 = num(504);
