...
import _modDef10742 from "../../../../discord_assets/assets/orbs/static_idle_orb.png.js";
import _modDef10743 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_idle_dark.png.js";
import _modDef10744 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_entry_dark.png.js";
...
function CancelButton() {
  ...
  return closure_13(require("../../../../_runtime/metro/05938__.js").HeaderBackButton, obj);
}
function StaticOrb() {
...
function AnimatedOrbContainer(isAppActive) {
  ...
  const items1 = [tmp13, ,];
  const obj3 = { uri: _modDef10743, style: null, onLoad: null, animate: null };
  ...
  if (tmp15Result) {
    const obj5 = { uri: _modDef10744, style: null, onLoad: null, animate: null };
...
export default function QuestOrbsRewardModal(quest) {
  ...
  let obj = num(504);
  num = num(8307).useFetchVirtualCurrencyBalance().balance;
  let obj2 = num(8307);
  ...
  if (num2 == null) {
    num2 = tmp2(10681).getQuestOrbRewardQuantityForUser(quest.config, stateFromStores2);
    const tmp2Result = tmp2(10681);
  }
  const effect = noop.useEffect(() => {
    num(10745).applyOrientationLock("PORTRAIT");
    return () => {
  ...
  let string = noop.useCallback(() => {
    ...
    const obj2 = num(10665);
    obj2.openQuestHome({ filter: constants.VIRTUAL_CURRENCY, fromContent: num(5754).QuestContent.REWARD_MODAL });
  }, []);
  ...
  const obj7 = {
    ...
    children: closure_13(num(10746).OrbsRewardBackground, { style: tmp.background, onReady: callback }),
  };
  ...
  if (!tmp6) {
    ...
    closure_15(tmp2(6539).SafeAreaPaddingView, rect);
  }
  const obj5 = num(504);
