...
import _modDef10755 from "../../../../discord_assets/assets/orbs/static_idle_orb.png.js";
import _modDef10756 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_idle_dark.png.js";
import _modDef10757 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_entry_dark.png.js";
...
function CancelButton() {
  ...
  return closure_13(require("../../../../_runtime/metro/05943__.js").HeaderBackButton, obj);
}
function StaticOrb() {
...
export default function QuestOrbsRewardModal(quest) {
  ...
  const obj7 = {
    ...
    children: closure_13(num(10759).OrbsRewardBackground, { style: tmp.background, onReady: callback }),
  };
  ...
  if (!tmp6) {
    ...
    let items6 = [closure_13(tmp2(4832).Heading, obj14)];
    ...
    items6[1] = closure_13(tmp2(4832).Text, obj16);
    ...
    closure_15(tmp2(6544).SafeAreaPaddingView, rect);
  }
  const obj5 = num(504);
