...
import _modDef12031 from "../../../../discord_assets/assets/orbs/static_idle_orb.png.js";
import _modDef12032 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_idle_dark.png.js";
import _modDef12033 from "../../../../discord_assets/assets/orbs/quest_reward_mobile_entry_dark.png.js";
...
function CancelButton() {
  ...
  return closure_13(require("../../../../_runtime/metro/05843__.js").HeaderBackButton, obj);
}
function StaticOrb() {
...
export default function QuestOrbsRewardModal(quest) {
  ...
  const obj7 = {
    ...
    children: closure_13(num(12035).OrbsRewardBackground, { style: tmp.background, onReady: callback }),
  };
  ...
  if (!tmp6) {
    ...
    closure_15(tmp2(7363).SafeAreaPaddingView, rect);
  }
  const obj5 = num(504);
