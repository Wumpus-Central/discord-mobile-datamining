...
function QuestRewardDetailsBottomSheet(quest) {
  ...
  const items4 = [
    closure_6(quest(4753).Text, obj6),
    closure_6(quest(4753).Text, { variant: "heading-lg/semibold", color: "text-strong", children: defaultRewardName }),
  ];
  ...
  if (tmp9Result) {
    ...
    items6[1] = closure_6(tmp4(4753).Text, obj9);
