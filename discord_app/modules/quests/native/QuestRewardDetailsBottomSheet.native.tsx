...
function QuestRewardDetailsBottomSheet(quest) {
  ...
  const items4 = [closure_6(quest(4602).Text, obj2), closure_6(quest(4602).Text, { variant: "heading-lg/semibold", color: "text-strong", children: defaultRewardName })];
  obj1.children = items4;
  items3[1] = closure_7(quest(5024).Stack, obj1);
  obj.children = items3;
  const items5 = [closure_7(quest(5024).Stack, obj), ];
  ...
  if (tmp9Result) {
    ...
    items6[1] = closure_6(quest(4602).Text, obj5);
    obj3.children = items6;
    tmp9Result = closure_7(closure_8, obj3);
  }
  items5[1] = tmp9Result;
  obj.children = items5;
  return closure_6(quest(7223).BottomSheet, { startExpanded: true, children: closure_7(quest(5024).Stack, obj) });
}
