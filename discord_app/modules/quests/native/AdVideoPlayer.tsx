...
import _modDef8583 from "../../../../_runtime/metro/08583__.js";
...
const _isNativeReflectConstruct = noop.memo(_modDef8583);
...
export const AdVideoPlayer = noop.memo((initialProgress) => {
  ...
  shouldShowControls.__closure = {
    ...
    playerState: first2,
    PlayerState: onBuffer(tmp9[10]).PlayerState,
    isVideoEnded: tmp15,
  };
  ...
  if (tmp66Result) {
    const obj9 = {
      ...
      onBuffer: callback18,
      onPlaybackStalled: callback19,
      onPlaybackResume: callback20,
      onLoad: callback5,
      onSeek: callback11,
  ...
  if (!tmp57) {
    ...
    if (flag7) {
      const obj18 = {
        disabled: first2 === tmp8(tmp9[10]).PlayerState.ERRORED,
        accessibilityRole: "button",
        accessibilityLabel: null,
        onPress: null,
        children: null,
    ...
    if (!tmp15) {
      ...
      const obj19 = {
        accessibilityRole: "button",
        accessibilityLabel: tmp80(K0e7M9),
        onPress: callback7,
        children: null,
      };
      if (!tmp15) {
