...
import QuestOrbsRewardModal from "QuestOrbsRewardModal" /* 12113 */;
import openQuestCollectibleRewardModal from "openQuestCollectibleRewardModal" /* 12121 */;
import CloudIcon from "CloudIcon" /* 12122 */;
...
function openRewardClaimBottomSheet(arg0) {
  ...
  return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12106, dependencyMap.paths), timestampProducer, { questId, questContent, questContentPosition, sourceQuestContent });
}
function viewReward(quest) {
  ...
  if (obj.hasQuestRewardCode(quest.config)) {
    ...
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12106, dependencyMap.paths), timestampProducer, obj2);
  } else {
...
export const openRewardDetailsBottomSheet = function openRewardDetailsBottomSheet(questId) {
  return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12103, dependencyMap.paths), React5, { questId: questId.questId });
};
export { viewReward };
