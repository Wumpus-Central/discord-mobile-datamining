...
import QuestOrbsRewardModal from "QuestOrbsRewardModal" /* 11779 */;
import openQuestCollectibleRewardModal from "openQuestCollectibleRewardModal" /* 11786 */;
import CloudIcon from "CloudIcon" /* 11787 */;
...
function openRewardClaimBottomSheet(arg0) {
  ...
  return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11772, dependencyMap.paths), timestampProducer, { questId, questContent, questContentPosition, sourceQuestContent });
}
    ...
    try {
      ...
      if (0 === c5) {
        if (arg0 === 1) {
          ...
          c5 = 2;
          c6 = 1;
          const obj2 = { value: QuestActionCreators.claimQuestReward(_require.id, defaultPlatform, QuestTypes.QuestContent.QUEST_HOME_MOBILE), done: false };
          return obj2;
        }
      } else if (1 === tmp8) {
        c4 = 0;
  ...
  if (c4 === 2) {
    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (arg0 === 1) {
          ...
          if (closure_129_5) {
            ...
            if (obj9.hasQuestRewardCode(closure_129_0.config)) {
              const obj2 = { questId: closure_129_0.id, questContent: closure_129_1, questContentPosition: closure_129_2, sourceQuestContent: closure_129_8 };
              closure_130_13(obj2);
              c4 = 3;
              return { value: true, done: true };
            } else {
        ...
        closure_129_9 = value;
        if (closure_129_9) {
          obj = { quest: closure_129_0, product: closure_129_3, questContent: closure_129_1, questContentPosition: closure_129_2, onSuccess: closure_129_7, sourceQuestContent: closure_129_8 };
          closure_130_14(obj);
        }
        c4 = 3;
...
export const openRewardDetailsBottomSheet = function openRewardDetailsBottomSheet(questId) {
  return ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(11769, dependencyMap.paths), React5, { questId: questId.questId });
};
export { viewReward };
