// === Module 14998: QuestHomeSortingFilteringBottomSheet ===
...
export default function QuestHomeSortingFilteringBottomSheet(onSortMethodChange) {
  ...
  obj5.children = questHomeSortOptions.map((label, index) => ref(onSortMethodChange(first[20]).TableRadioRow, { label: label.label, value: label.value }, index));
  const items2 = [
