...
export const QuestOrbMultiplierPerkPill = function QuestOrbMultiplierPerkPill(questId) {
  ...
  let obj2 = useToken;
  const token = obj2.useToken(orbMultiplierEligibility(576).colors.EXPRESSIVE_GRADIENT_PINK_START, questOrbRewardMultiplier.DARK);
  let obj3 = useToken;
  const token1 = obj3.useToken(orbMultiplierEligibility(576).colors.EXPRESSIVE_GRADIENT_TENURE_BADGE_DIAMOND_END, questOrbRewardMultiplier.DARK);
  let obj4 = useToken;
  const token2 = obj4.useToken(orbMultiplierEligibility(576).colors.BACKGROUND_BASE_LOWEST, questOrbRewardMultiplier.DARK);
  let obj5 = ColorUtils;
