// === Module 14273: QuestOrbMultiplierPerkPill ===
...
export const QuestOrbMultiplierPerkPill = function QuestOrbMultiplierPerkPill(questId) {
  ...
  questOrbRewardMultiplier = require(10643) /* useQuests */.useQuestOrbRewardMultiplier(questId.questId);
  const obj9 = require(10643) /* useQuests */;
  const tmp6 = orbMultiplierEligibility;
  const result = require(9645) /* items */.shouldReceiveQuestOrbMultiplier(orbMultiplierEligibility);
  const tmp13 = orbMultiplierEligibility === require(9645) /* items */.QuestOrbMultiplierEligibilityType.CREPE;
  c6 = tmp13;
  ...
  if (null == questOrbRewardMultiplier) {
    ...
    if (!tmp13) {
      tmp19 = questOrbRewardMultiplier(tmp2(7613).NitroWheelIcon, { size: "xs", color: "white" });
    }
    obj1 = { children: null };
    const items2 = [tmp19, ];
    ...
    if (!tmp13) {
      ...
      obj6[2] = closure_8;
      obj6[3] = closure_9;
      tmp21Result = tmp21(tmp6(4677), obj6);
    }
    ...
    return questOrbRewardMultiplier(tmp2(4783).PressableOpacity, obj3);
  }
  const obj10 = require(9645) /* items */;
};