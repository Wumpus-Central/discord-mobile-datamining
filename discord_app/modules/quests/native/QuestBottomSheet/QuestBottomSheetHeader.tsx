...
export default function QuestBottomSheetHeader(arg0) {
  ...
  const defaultRewardNameWithArticle = isScreenReaderEnabled(10694).getDefaultRewardNameWithArticle(quest.config, stateFromStores);
  ...
  if (tmp24Result) {
    ...
    obj4.style = items5;
    obj4.children = memo1;
    tmp24Result = closure_7(tmp2(4832).Text, obj4);
  }
