...
export default function QuestBottomSheetHeader(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(15171);
  closure_129_0 = quest;
  closure_129_1 = step;
  ...
  const tmp2Result1 = isScreenReaderEnabled(7775);
  ...
  closure_129_8 = memo;
  const tmp2Result2 = isScreenReaderEnabled(11555);
  ...
  const tmp2Result3 = isScreenReaderEnabled(15170);
  ...
  const tmp2Result5 = isScreenReaderEnabled(11362);
  ...
  const tmp2Result6 = isScreenReaderEnabled(7773);
  ...
  if (tmp24Result) {
    ...
    obj.style = items5;
    obj.children = memo1;
    tmp24Result = closure_7(tmp2(4601).Text, obj);
  }
  ...
  if (withActionSheet) {
    ...
    obj1.children = closure_7(tmp2(8742).MoreHorizontalIcon, obj2);
    withActionSheet = closure_7(tmp2(5173).PressableOpacity, obj1);
  }
