...
fn(4606);
let createStyles = { container: null, containerWithActionSheet: null, title: null, titleWithActionSheet: null, actionSheetButton: null };
createStyles = { display: "flex", gap: 6, paddingHorizontal: nativeDefault.space.PX_16, paddingTop: nativeDefault.space.PX_8 };
createStyles.container = createStyles;
createStyles.containerWithActionSheet = { alignItems: "center", flexDirection: "row", paddingHorizontal: nativeDefault.space.PX_8 };
...
export default function QuestBottomSheetHeader(arg0) {
  ...
  let obj1 = isScreenReaderEnabled(15150);
  closure_129_0 = quest;
  closure_129_1 = step;
  ...
  const tmp2Result1 = isScreenReaderEnabled(7796);
  ...
  closure_129_8 = memo;
  const tmp2Result2 = isScreenReaderEnabled(11577);
  ...
  const tmp2Result3 = isScreenReaderEnabled(15149);
  ...
  const tmp2Result5 = isScreenReaderEnabled(11384);
  ...
  const tmp2Result6 = isScreenReaderEnabled(7794);
  ...
  if (tmp24Result) {
    obj = { ref, variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", style: null, children: null };
    ...
    obj.style = items5;
    obj.children = memo1;
    tmp24Result = closure_7(tmp2(4602).Text, obj);
  }
  ...
  if (withActionSheet) {
    ...
    obj1.children = closure_7(tmp2(8763).MoreHorizontalIcon, obj2);
    withActionSheet = closure_7(tmp2(5174).PressableOpacity, obj1);
  }
