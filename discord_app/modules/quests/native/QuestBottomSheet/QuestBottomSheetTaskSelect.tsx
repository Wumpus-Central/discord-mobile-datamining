...
export default function QuestBottomSheetTaskSelect(onTaskSelect) {
  ...
  obj = { arrow: true, icon: closure_3(onTaskSelect(8911).ScreenIcon, {}), label: null, onPress: null };
  ...
  const items = [closure_3(onTaskSelect(5619).TableRow, obj)];
  obj = { arrow: true, icon: closure_3(onTaskSelect(9255).GameControllerIcon, {}), label: null, onPress: null };
  ...
  items[1] = closure_3(onTaskSelect(5619).TableRow, obj);
  obj.children = items;
