// === Module 15429: QuestBottomSheetTaskSelect ===

// Module 15429 (QuestBottomSheetTaskSelect)
import noop from "module_19" /* 19 */;

const require = fn;
const QuestTaskPlatform = fn(5661).QuestTaskPlatform;
const jsxProd = fn(21);
...
export default function QuestBottomSheetTaskSelect(onTaskSelect) {
  ...
  const obj2 = { arrow: true, icon: closure_3(onTaskSelect(9161).ScreenIcon, {}), label: null, onPress: null };
  ...
  const items = [closure_3(onTaskSelect(5822).TableRow, obj2), ];
  const obj3 = { arrow: true, icon: closure_3(onTaskSelect(9348).GameControllerIcon, {}), label: null, onPress: null };
  ...
  items[1] = closure_3(onTaskSelect(5822).TableRow, obj3);
  obj.children = items;
  return closure_4(onTaskSelect(5904).TableRowGroup, obj);
};