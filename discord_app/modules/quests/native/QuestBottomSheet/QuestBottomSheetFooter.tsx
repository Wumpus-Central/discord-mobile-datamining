...
export default function QuestBottomSheetFooter(quest) {
  ...
  const mobileActivityPressHandler = quest(15384).useMobileActivityPressHandler({
    questId: quest.id,
    sourceQuestContent,
  ...
  if (step !== quest(15381).QuestBottomSheetStep.TASK_SELECT) {
      ...
      if (tmp2(15381).QuestBottomSheetStep.TASK_STATUS === step) {
        if (tmp11) {
          ...
          const obj15 = {
            ...
            text: primaryCtaCopy,
            icon: tmp2(12018).getPrimaryCtaIcon(quest),
          };
          let tmp23 = null;
          if (isQuestAccessSuspended) {
            tmp23 = obj10;
          ...
          if (
            ...
            tmp2(5659).TaskPlatformScreen.CONSOLE
          ) {
    ...
    if (tmp40Result5) {
      ...
      obj18.icon = closure_10(tmp2(5840).ArrowLargeLeftIcon, {});
      obj18.onPress = onBack;
      tmp40Result5 = closure_10(tmp2(8178).IconButton, obj18);
    }
