// === Module 14964: useQuestRewardClaimHandler ===

// Module 14964 (useQuestRewardClaimHandler)
import ThemesDefault from "Themes" /* 709 */;
import getSystemLocale from "getSystemLocale" /* 1233 */;
import Button from "Button" /* 4929 */;
import useAdContentImpressionTrackerProps from "useAdContentImpressionTrackerProps" /* 11310 */;
import formatWatchRemainingDurationShort from "formatWatchRemainingDurationShort" /* 11337 */;
import useTrackQuestEventWithImpression from "useTrackQuestEventWithImpression" /* 11569 */;
import useWatchTaskPressHandler from "useWatchTaskPressHandler" /* 14965 */;
import RefreshIcon from "RefreshIcon" /* 15000 */;
...
import { ACTION_SHEET_MINIMUM_BOTTOM_PADDING as closure_9 } from "ACTION_SHEET_START_HEIGHT_RATIO" /* 5632 */;
    ...
    if (tmp2(14962).QuestBottomSheetStep.CONSOLE_CONNECT === step) {
      ...
      if (tmp2(14962).QuestBottomSheetStep.TASK_STATUS === step) {
        if (tmp11) {
          ...
          if (callback(obj2.useTaskPlatformScreen(quest, questTaskDetails), 1)[0] === tmp2(5399).TaskPlatformScreen.CONSOLE) {
