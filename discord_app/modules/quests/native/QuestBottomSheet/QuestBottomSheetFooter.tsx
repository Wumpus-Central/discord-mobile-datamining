...
export default function QuestBottomSheetFooter(quest) {
  ...
  const mobileActivityPressHandler = quest(15235).useMobileActivityPressHandler({
    questId: quest.id,
    sourceQuestContent,
  ...
  if (step !== quest(15232).QuestBottomSheetStep.TASK_SELECT) {
      ...
      if (tmp2(15232).QuestBottomSheetStep.TASK_STATUS === step) {
        if (tmp11) {
          ...
          const obj15 = {
            ...
            text: primaryCtaCopy,
            icon: tmp2(11918).getPrimaryCtaIcon(quest),
          };
          let tmp23 = null;
          if (isQuestAccessSuspended) {
            tmp23 = obj10;
    ...
    if (tmp40Result5) {
      ...
      obj18.icon = closure_10(tmp2(5716).ArrowLargeLeftIcon, {});
      obj18.onPress = onBack;
      tmp40Result5 = closure_10(tmp2(8057).IconButton, obj18);
    }
