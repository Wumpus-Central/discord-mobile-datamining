...
export const useWatchTaskPressHandler = function useWatchTaskPressHandler(questId) {
  ...
  setRestingQuestDockMode = React.useContext(
    setRestingQuestDockMode(callback[3]).QuestDockExternalCoordinationContext,
  ).setRestingQuestDockMode;
  isInQuestBottomSheet = React.useContext(
    setRestingQuestDockMode(callback[4]).QuestBottomSheetContext,
  ...
  return React.useCallback(() => {
    ...
    if (
      obj3.shouldMigrateToAdAnalyticsInterface(
        setRestingQuestDockMode(callback[8]).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL,
...
export const useMobileActivityPressHandler = function useMobileActivityPressHandler(questId) {
  ...
  setRestingQuestDockMode = undefined;
  isInQuestBottomSheet = undefined;
  setRestingQuestDockMode = questImpression.useContext(
    setRestingQuestDockMode(launchMobileActivity[3]).QuestDockExternalCoordinationContext,
  ).setRestingQuestDockMode;
  isInQuestBottomSheet = questImpression.useContext(
    setRestingQuestDockMode(launchMobileActivity[4]).QuestBottomSheetContext,
  ).isInQuestBottomSheet;
  const items = [isInQuestBottomSheet, setRestingQuestDockMode];
          ...
          if (0 === c1) {
            ...
            if (
              obj12.shouldMigrateToAdAnalyticsInterface(
                closure_1_0(8998).AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL,
                "quest_bottom_sheet_mobile_activity",
              )
            ) {
              captureAdUserAction = captureAdUserAction(8999).captureAdUserAction;
              let obj3 = {
                type: null,
                adCreativeType: null,
                adCreativeId: null,
              ...
              obj3[0] = closure_1_0(9003).AdUserActionType.CLICK_INTERNAL;
              obj3[1] = closure_1_0(7446).AdCreativeType.QUEST;
              obj3[2] = closure_0;
              obj3[3] = closure_1_0(7473).QuestContentCTA.LAUNCH_MOBILE_ACTIVITY;
              obj3[4] = closure_1_0(5390).QuestContent.QUEST_BOTTOM_SHEET;
              obj3[5] = c1;
              let id;
              if (closure_4 != null) {
                id = obj6.getId();
              ...
              const captureAdUserActionResult = captureAdUserAction(8999);
              obj6 = closure_4;
              obj7 = closure_1_4;
            } else {
              const obj4 = {
              ...
              obj4[0] = closure_0;
              obj4[1] = closure_1_0(5390).QuestContent.QUEST_BOTTOM_SHEET;
              obj4[2] = closure_1_0(7473).QuestContentCTA.LAUNCH_MOBILE_ACTIVITY;
              obj2 = closure_4;
              let questContentPosition1;
              if (closure_4 != null) {
                questContentPosition1 = obj2.getQuestContentPosition();
              ...
              obj4[4] = id1;
              obj4[5] = c1;
              const result = captureAdUserAction(7463).trackQuestContentClicked(obj4);
              const captureAdUserActionResult2 = captureAdUserAction(7463);
            }
            dependencyMap = 3;
            obj12 = closure_1_0(8998);
          }
        } catch (tmp36) {
          dependencyMap = tmp;
          throw tmp36;
