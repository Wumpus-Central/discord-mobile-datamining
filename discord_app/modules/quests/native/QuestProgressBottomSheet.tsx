...
function QuestProgressBottomSheet(quest) {
  ...
  const url = claim(10684)({ applicationId: id, size: 600, names: ["embedded_cover"] }).url;
  ...
  const tmp7 = claim(10684);
  tmpResult = tmp(10981);
  obj = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_BOTTOM_SHEET, sourceQuestContent: tmp(5040).QuestContent.RUNNING_ACTIVITY };
  ...
  obj1 = { quest, questContent: tmp(5040).QuestContent.RUNNING_ACTIVITY, sourceQuestContent: tmp(5040).QuestContent.RUNNING_ACTIVITY };
  const questRewardClaimHandler = quest(14164).useQuestRewardClaimHandler(obj1);
  ...
  const items5 = [callback2(quest(6685).IconButton, obj9), ];
  const obj10 = { quest, showShareLink: true, location: tmp11.QUEST_ACTIVITY_BOTTOM_SHEET, sourceQuestContent: null, children: null };
  const tmpResult1 = quest(14164);
  obj10[3] = quest(5040).QuestContent.RUNNING_ACTIVITY;
  obj10[4] = contextMenuButton;
  items5[1] = callback2(claim(14194), obj10);
  obj8[1] = items5;
  ...
  const items7 = [callback2(quest(4189).Text, { variant: str, color: "mobile-text-heading-primary", children: formatToPlainStringResult }), ];
  ...
  items7[1] = callback2(quest(4189).Text, obj13);
  obj12[3] = items7;
  const items8 = [closure_11(quest(4602).Stack, obj12), ];
  ...
  obj15[3] = isClaiming;
  const items9 = [callback2(quest(4604).Button, obj15), ];
  const obj17 = { size: "lg", text: null, onPress: null, variant: "secondary", grow: true };
  const intl4 = tmp(1236).intl;
  obj17[1] = intl4.string(quest(1236).t.cpT0Cq);
  obj17[2] = callback3;
  items9[1] = callback2(quest(4604).Button, obj17);
  obj14[3] = items9;
  items8[1] = closure_11(quest(4602).Stack, obj14);
  obj11[1] = items8;
  items6[1] = closure_11(closure_5, obj11);
  obj16[2] = items6;
  return closure_11(quest(5247).BottomSheet, obj16);
}
...
export default function QuestProgressBottomSheetConnected(questId) {
  ...
  if (null != stateFromStores) {
    ...
    obj[2] = tmp(5040).QuestContent.RUNNING_ACTIVITY;
    obj[3] = tmp(5040).QuestContent.RUNNING_ACTIVITY;
    obj[4] = function children() {
      return outer1_10(outer1_15, { quest: stateFromStores });
    };
    tmp4 = callback2(tmp(10984).QuestContentImpressionTrackerNative, obj);
  }
  return tmp4;
};