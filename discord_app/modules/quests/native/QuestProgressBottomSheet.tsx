...
function QuestProgressBottomSheet(quest) {
  ...
  tmpResult = tmp(11868);
  obj = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_BOTTOM_SHEET, sourceQuestContent: tmp(5498).QuestContent.RUNNING_ACTIVITY };
  ...
  const tmpResult1 = quest(11577);
  obj1 = { quest, questContent: tmp(5498).QuestContent.RUNNING_ACTIVITY, sourceQuestContent: tmp(5498).QuestContent.RUNNING_ACTIVITY };
  const questRewardClaimHandler = quest(15180).useQuestRewardClaimHandler(obj1);
  ...
  const obj8 = { icon: claim(9144), onPress: callback2, variant: "secondary-overlay", size: "sm", accessibilityLabel: null };
  const intl2 = tmp(1114).intl;
  obj8.accessibilityLabel = intl2.string(quest(1114).t.RDE0Sc);
  const items5 = [closure_11(quest(8172).IconButton, obj8), ];
  ...
  const tmpResult2 = quest(15180);
  obj9.sourceQuestContent = quest(5498).QuestContent.RUNNING_ACTIVITY;
  obj9.children = contextMenuButton;
  items5[1] = closure_11(claim(15209), obj9);
  ...
  items7[1] = closure_11(quest(4602).Text, obj12);
  obj11.children = items7;
  const items8 = [closure_12(quest(5024).Stack, obj11), ];
  ...
  items9[1] = closure_11(quest(5026).Button, obj16);
  obj13.children = items9;
  items8[1] = closure_12(quest(5024).Stack, obj13);
  obj10.children = items8;
  items6[1] = closure_12(closure_5, obj10);
  obj15.children = items6;
  return closure_12(quest(7223).BottomSheet, obj15);
}
...
export default function QuestProgressBottomSheetConnected(questId) {
  ...
  if (null != stateFromStores) {
    ...
    tmp4 = closure_11(tmp(11871).QuestContentImpressionTrackerNative, obj);
  }
  return tmp4;
};