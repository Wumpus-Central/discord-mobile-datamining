...
import registerAssetDefault from "../../../../_runtime/08818_registerAsset.js";
...
function QuestProgressBottomSheet(quest) {
  ...
  obj = {
    ...
    sourceQuestContent: tmp(5399).QuestContent.RUNNING_ACTIVITY,
  };
  ...
  obj1 = {
    quest,
    questContent: tmp(5399).QuestContent.RUNNING_ACTIVITY,
    sourceQuestContent: tmp(5399).QuestContent.RUNNING_ACTIVITY,
  };
  ...
  const obj10 = {
    quest,
    showShareLink: true,
    location: tmp11.QUEST_ACTIVITY_BOTTOM_SHEET,
...
let closure_14 = createCacheKey.createStyleProperties(() => ({
  gradientEnd: ThemesDefault.colors.MOBILE_ACTIONSHEET_GRADIENT_BACKGROUND_DEFAULT,
}));
