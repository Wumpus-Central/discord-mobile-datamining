// === Module 15946: contextMenuButton ===
...
function QuestProgressBottomSheet(quest) {
  ...
  const url = claim(10792)({ applicationId: id, size: 600, names: ["embedded_cover"] }).url;
  ...
  const tmp7 = claim(10792);
  tmpResult = tmp(11102);
  obj = { quest, taskDetails: questTaskDetails, location: QuestsExperimentLocations.QUEST_ACTIVITY_BOTTOM_SHEET, sourceQuestContent: tmp(5102).QuestContent.RUNNING_ACTIVITY };
  ...
  obj1 = { quest, questContent: tmp(5102).QuestContent.RUNNING_ACTIVITY, sourceQuestContent: tmp(5102).QuestContent.RUNNING_ACTIVITY };
  const questRewardClaimHandler = quest(14231).useQuestRewardClaimHandler(obj1);
    ...
    if (table === 2) {
      ...
      try {
        ...
        if (0 === v0) {
          ...
          if (arg1) {
            obj = v0(table[22]);
            obj.updateFramePanelMode(outer1_9.PIP);
          }
          table = 3;
          return { value: "HermesInternal", done: null };
        }
  ...
  const callback2 = React.useCallback(() => {
    ...
    obj[0] = quest(outer1_2[26]).getQuestUrl(quest.id);
    obj2.showShareActionSheet(obj);
  }, items2);
  callback3 = React.useCallback(() => {
    claim(table[23]).hideActionSheet();
  }, []);
  ...
  const items5 = [callback2(quest(7660).IconButton, obj9), ];
  const obj10 = { quest, showShareLink: true, location: tmp11.QUEST_ACTIVITY_BOTTOM_SHEET, sourceQuestContent: null, children: null };
  const tmpResult1 = quest(14231);
  obj10[3] = quest(5102).QuestContent.RUNNING_ACTIVITY;
  obj10[4] = contextMenuButton;
  items5[1] = callback2(claim(14261), obj10);
  obj8[1] = items5;
  ...
  const items7 = [callback2(quest(4251).Text, { variant: str, color: "mobile-text-heading-primary", children: formatToPlainStringResult }), ];
  ...
  items7[1] = callback2(quest(4251).Text, obj13);
  obj12[3] = items7;
  const items8 = [closure_11(quest(4664).Stack, obj12), ];
  ...
  const t = tmp(1236).t;
  const obj15 = { size: "lg", text: intl3.string(tmp14 ? t.cfY4PE : t.LLLLPD), onPress: null, loading: null, grow: true };
  if (tmp14) {
    callback1 = callback;
  }
  obj15[2] = callback1;
  ...
  obj15[3] = isClaiming;
  const items9 = [callback2(quest(4666).Button, obj15), ];
  const obj17 = { size: "lg", text: null, onPress: null, variant: "secondary", grow: true };
  const intl4 = tmp(1236).intl;
  obj17[1] = intl4.string(quest(1236).t.cpT0Cq);
  obj17[2] = callback3;
  items9[1] = callback2(quest(4666).Button, obj17);
  obj14[3] = items9;
  items8[1] = closure_11(quest(4664).Stack, obj14);
  obj11[1] = items8;
  items6[1] = closure_11(closure_5, obj11);
  obj16[2] = items6;
  return closure_11(quest(5309).BottomSheet, obj16);
}
...
let closure_13 = createCacheKey.createStyleProperties(() => ({ gradientEnd: importDefault(712).colors.MOBILE_ACTIONSHEET_GRADIENT_BACKGROUND_DEFAULT }));
...
export default function QuestProgressBottomSheetConnected(questId) {
  ...
  stateFromStores = obj.useStateFromStores(items, () => outer1_7.getQuest(questId));
  let tmp4 = null;
  if (null != stateFromStores) {
    obj = { overrideVisibility: true, questOrQuests: null, questContent: null, sourceQuestContent: null, children: null };
    obj[1] = stateFromStores;
    obj[2] = tmp(5102).QuestContent.RUNNING_ACTIVITY;
    obj[3] = tmp(5102).QuestContent.RUNNING_ACTIVITY;
    obj[4] = function children() {
      return outer1_10(outer1_15, { quest: stateFromStores });
    };
    tmp4 = callback2(tmp(11105).QuestContentImpressionTrackerNative, obj);
  }
  return tmp4;
};