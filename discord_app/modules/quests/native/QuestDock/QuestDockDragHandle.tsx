...
const memoResult = importAllResult.memo(function QuestDockDragHandle(arg0) {
  ...
  const tmp = callback();
  const context = youBarHorizontalMargin.useContext(activeQuestDockMode(14646).QuestDockGestureContext);
  activeQuestDockMode = context.activeQuestDockMode;
  const windowDimensions = context.windowDimensions;
  dependencyMap = tmp5;
  let obj = activeQuestDockMode(14647);
  youBarHorizontalMargin = obj.useYouBarHorizontalMargin();
  obj1 = activeQuestDockMode(4185);
  const fn = function n() {
  ...
  let obj4 = activeQuestDockMode(4185);
  ...
  let obj6 = activeQuestDockMode(4185);
  class M {
    constructor() {
  ...
  obj1 = { withSpring: activeQuestDockMode(4879).withSpring, isDefaultVariant: tmp5, activeQuestDockMode, QuestDockMode: enabled, QUEST_DOCK_MODE_CHANGE_PHYSICS: closure_5 };
  M.__closure = obj1;
  ...
  const obj9 = activeQuestDockMode(4185);
  const tmp2 = activeQuestDockMode;
  O.__closure = { withSpring: activeQuestDockMode(4879).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode: enabled, QUEST_DOCK_MODE_CHANGE_PHYSICS: closure_5 };
  ...
  const obj2 = { withSpring: activeQuestDockMode(4879).withSpring, isDefaultVariant: "default" === variant, activeQuestDockMode, QuestDockMode: enabled, QUEST_DOCK_MODE_CHANGE_PHYSICS: closure_5 };
  const tmp12 = windowDimensions;
  obj4 = { style: animatedStyle1, layout: null, children: null };
  const tmp13 = windowDimensions(7729);
  const tmp14 = closure_8;
  obj4[1] = activeQuestDockMode(14644).dimensionsLayoutTransition;
  const obj5 = { style: items1, children: null };
  items1 = [tmp.dragHandleOverlay, animatedStyle3];
  const tmp15 = windowDimensions(7729);
  ...
  obj5[1] = closure_7(activeQuestDockMode(5889).ActionSheetHeaderBar, { variant: "overlay", accessibilityLabel: stringResult });
  const items2 = [closure_7(windowDimensions(7729), obj5), ];
  ...
  const tmp16 = windowDimensions(7729);
  obj6[4] = closure_7(tmp2(5889).ActionSheetHeaderBar, { variant: "default" });
  items2[1] = closure_7(tmp12(7729), obj6);
  obj4[2] = items2;
