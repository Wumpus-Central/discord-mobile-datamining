...
function QuestDockBackgroundMediaFade(arg0) {
  ...
  let __closure = { withSpring: activeQuestDockMode(5055).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
...
export default noop.memo(function QuestDockVideoBackground(gradientBaseColor) {
  ...
  let obj2 = gradientBaseColor(4373);
  const fn = function v() {
    obj = spring;
  ...
  __closure = { withSpring: gradientBaseColor(5055).withSpring, activeQuestDockMode, QuestDockMode: top, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: isRendered, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, windowDimensions };
  fn.__closure = __closure;
  ...
  __closure = { withSpring: tmp4(5055).withSpring, shouldShowVideo: isRendered, videoLoaded: first1, isMediaHiddenWhenCollapsed: tmp2, activeQuestDockMode, QuestDockMode: tmp12, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn2.__closure = __closure;
  fn2.__workletHash = 10281907446713;
  fn2.__initData = __initData3;
  let tmp31 = null;
  const animatedStyle1 = gradientBaseColor(4373).useAnimatedStyle(fn2);
  if (isRendered) {
    ...
    tmp31 = closure_11(tmp4(8425).VideoComponent, obj1);
  }
  const items4 = [tmp31, ];
  let tmp33 = null;
  if (null != imageUrl) {
    ...
    obj4.source = obj5;
    obj3.children = closure_11(tmp7(5668), obj4);
  ...
  obj8.style = items9;
  items8[1] = closure_11(expandedHeight(5068), obj8);
