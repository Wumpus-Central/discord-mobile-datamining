...
function QuestDockBackgroundMediaFade(children) {
  ...
  let __closure = { withSpring: activeQuestDockMode(4988).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
...
fn(4574);
QuestDockBackgroundCollapsedMediaMode = { backgroundWrapper: null, backgroundImage: null, backgroundVideo: null, fullHeightMedia: null, backgroundGradient: null };
let obj1 = {};
...
export default noop.memo(function QuestDockVideoBackground(gradientBaseColor) {
  ...
  __closure = { withSpring: gradientBaseColor(activeQuestDockMode[11]).withSpring, activeQuestDockMode, QuestDockMode: first1, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_9, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, windowDimensions };
  ...
  __closure = { withSpring: tmp4(tmp5[11]).withSpring, shouldShowVideo: isRendered, videoLoaded: first1, isMediaHiddenWhenCollapsed: tmp2, activeQuestDockMode, QuestDockMode: tmp11, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED };
  fn.__closure = __closure;
