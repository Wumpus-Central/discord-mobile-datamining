...
export default noop.memo(function QuestDockVideoBackground(gradientBaseColor) {
  ...
  const setRestingQuestDockMode = windowDimensions.useContext(
    gradientBaseColor(15426).QuestDockExternalCoordinationContext,
  ...
  fn.__closure = {
    withSpring: gradientBaseColor(5270).withSpring,
    activeQuestDockMode,
    QuestDockMode,
  ...
  if (null != imageUrl) {
    ...
    obj9.source = obj10;
    obj8.children = closure_12(expandedHeight(5890), obj9);
    tmp33 = closure_12(expandedHeight(7404), obj8);
    const tmp7Result = expandedHeight(7404);
  }
  items4[1] = tmp33;
