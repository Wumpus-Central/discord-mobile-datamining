...
export default noop.memo(function QuestDockBackgroundBlurHeader(promotedLabelLeading) {
  ...
  if (tmpResult.isAndroid()) {
    ...
    if (flag) {
      ...
      const obj25 = { animatedProps, style: animatedStyle3, layout: questDockHeaderLayoutAnimation, children: tmp19Result };
  ...
  tmp22Result = tmp22(tmp7(15497), { layoutAnimatedStyle: animatedStyle5, opacityAnimatedStyle: animatedStyle6, layoutAnimation: questDockHeaderLayoutAnimation });
