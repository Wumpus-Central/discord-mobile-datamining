...
questDockHeaderLayoutAnimation.__closure = {
...
const memoResult = importAllResult.memo(function QuestDockBackgroundBlurHeader(arg0) {
  ...
  class G {
    constructor() {
      ...
      tmp = closure_1_7;
      obj = {
        borderTopLeftRadius: activeQuestDockMode.get() === closure_1_7.EXPANDED ? closure_1_9 : closure_3,
        borderTopRightRadius: obj.get() === tmp.EXPANDED ? closure_1_9 : closure_3,
  ...
  class V {
    constructor() {
      ...
      tmp = closure_1_7;
      obj = {
        borderRadius: activeQuestDockMode.get() === closure_1_7.EXPANDED ? closure_1_9 : closure_3,
        borderBottomLeftRadius: null,
        borderBottomRightRadius: null,
        width: null,
      };
