...
function QuestDockPreviewTools(quest) {
  ...
  obj = {
    icon: closure_5(quest(7272).ActionSheetRow.Icon, { IconComponent: quest(8808).TrophyIcon }),
    label: null,
    onPress: null,
  };
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (tmp2(5502).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = tmp2(11370).dismissQuestContent(
                creative.quest.id,
                tmp2(5498).QuestContent.QUEST_BAR_MOBILE,
              );
