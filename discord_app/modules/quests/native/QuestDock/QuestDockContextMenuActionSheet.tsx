...
function QuestDockPreviewTools(quest) {
  ...
  obj = {
    icon: closure_5(quest(7251).ActionSheetRow.Icon, { IconComponent: quest(8787).TrophyIcon }),
    label: null,
    onPress: null,
  };
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (tmp2(5501).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = tmp2(11348).dismissQuestContent(
                creative.quest.id,
                tmp2(5497).QuestContent.QUEST_BAR_MOBILE,
              );
