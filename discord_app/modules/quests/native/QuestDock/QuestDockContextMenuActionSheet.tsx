...
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = {
    icon: closure_6(quest(7313).ActionSheetRow.Icon, { IconComponent: quest(4586).CopyIcon }),
    label: null,
    onPress: null,
  };
...
function QuestDockDisclosureRow(creative) {
  ...
  let obj = {
    icon: closure_6(creative(7313).ActionSheetRow.Icon, { IconComponent: creative(11266).CircleQuestionIcon }),
    label: null,
    onPress: null,
  };
  let obj3 = { text: null };
...
export default function QuestDockContextMenuActionSheet(creative) {
  ...
  const tmp3 =
    creative.type === creative(obj3[7]).AdCreativeType.BOUNTY &&
  ...
  obj3 = {
    content: tmp(tmp2[10]).QuestContent.QUEST_BAR_MOBILE,
    ctaContent: tmp(tmp2[11]).QuestContentCTA.CONTEXT_MENU_OPEN_GAME_LINK,
  ...
  obj4.icon = closure_6(creative(obj3[16]).ActionSheetRow.Icon, {
    IconComponent: creative(obj3[17]).LinkExternalMediumIcon,
  });
  ...
  if (creative.type === creative(obj3[7]).AdCreativeType.QUEST) {
    ...
    if (tmpResult2.isShareableQuest(creative.quest.config)) {
      ...
      tmp5Result = closure_6(QuestDockShareRow, obj6);
    }
  ...
  if (!tmp3) {
    ...
    obj7.icon = closure_6(tmp(tmp2[16]).ActionSheetRow.Icon, obj8);
    let obj9 = { text: stringResult };
    obj7.label = closure_6(tmp(tmp2[18]).FormLabel, obj9);
    ...
    tmp5Result3 = closure_6(tmp(tmp2[16]).ActionSheetRow, obj7);
  }
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (tmp2(5539).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = tmp2(11430).dismissQuestContent(
                creative.quest.id,
                tmp2(5535).QuestContent.QUEST_BAR_MOBILE,
              );
              ...
              const dismissAdContentResult = tmp2(11675).dismissAdContent(
                closure_1,
                tmp2(5535).QuestContent.QUEST_BAR_MOBILE,
              );
              v2(4607).hideActionSheet();
  ...
  if (creative.type === creative(obj3[7]).AdCreativeType.QUEST) {
    ...
    if (creative.quest.preview) {
      ...
      tmp5Result4 = closure_6(QuestDockPreviewTools, obj14);
    }
  }
