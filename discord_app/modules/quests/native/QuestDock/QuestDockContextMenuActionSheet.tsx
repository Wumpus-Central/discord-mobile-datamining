...
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = {
    icon: closure_6(quest(7395).ActionSheetRow.Icon, { IconComponent: quest(4668).CopyIcon }),
    label: null,
    onPress: null,
  };
...
function QuestDockDisclosureRow(creative) {
  ...
  let obj = {
    icon: closure_6(creative(7395).ActionSheetRow.Icon, { IconComponent: creative(11359).CircleQuestionIcon }),
    label: null,
    onPress: null,
  };
  let obj3 = { text: null };
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (tmp2(5621).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = tmp2(11528).dismissQuestContent(
                creative.quest.id,
                tmp2(5617).QuestContent.QUEST_BAR_MOBILE,
              );
              ...
              const dismissAdContentResult = tmp2(11765).dismissAdContent(
                closure_1,
                tmp2(5617).QuestContent.QUEST_BAR_MOBILE,
              );
              v2(4689).hideActionSheet();
