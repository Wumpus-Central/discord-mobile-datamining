...
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = {
    icon: closure_6(quest(7309).ActionSheetRow.Icon, { IconComponent: quest(4584).CopyIcon }),
    label: null,
    onPress: null,
  };
...
function QuestDockDisclosureRow(creative) {
  ...
  let obj = {
    icon: closure_6(creative(7309).ActionSheetRow.Icon, { IconComponent: creative(11258).CircleQuestionIcon }),
    label: null,
    onPress: null,
  };
  let obj3 = { text: null };
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (tmp2(5537).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = tmp2(11422).dismissQuestContent(
                creative.quest.id,
                tmp2(5533).QuestContent.QUEST_BAR_MOBILE,
              );
              ...
              const dismissAdContentResult = tmp2(11667).dismissAdContent(
                closure_1,
                tmp2(5533).QuestContent.QUEST_BAR_MOBILE,
              );
              v2(4605).hideActionSheet();
