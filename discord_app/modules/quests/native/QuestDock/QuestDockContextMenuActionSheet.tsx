...
function QuestDockPreviewTools(quest) {
  ...
  obj = {
    icon: callback(quest(5999).ActionSheetRow.Icon, { IconComponent: quest(8858).TrophyIcon }),
    label: null,
    onPress: null,
  };
        ...
        if (0 === v0) {
          if (arg0 === 1) {
            ...
            if (closure_1_0(7456).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = closure_1_0(11133).dismissQuestContent(
                tmp37.quest.id,
                closure_1_0(5398).QuestContent.QUEST_BAR_MOBILE,
              );
