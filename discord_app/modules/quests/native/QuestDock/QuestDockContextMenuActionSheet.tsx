// === Module 15103: QuestDockContextMenuActionSheet ===
...
function QuestDockPreviewTools(quest) {
  ...
  obj = { icon: closure_5(quest(7200).ActionSheetRow.Icon, { IconComponent: quest(8717).TrophyIcon }), label: null, onPress: null };
