...
function QuestDockShareRow(quest) {
  quest = quest.quest;
  let obj = {
    icon: closure_6(quest(7302).ActionSheetRow.Icon, { IconComponent: quest(4583).CopyIcon }),
    label: null,
    onPress: null,
  };
...
function QuestDockDisclosureRow(creative) {
  ...
  let obj = {
    icon: closure_6(creative(7302).ActionSheetRow.Icon, { IconComponent: creative(11240).CircleQuestionIcon }),
    label: null,
    onPress: null,
  };
  let obj3 = { text: null };
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (tmp2(5532).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = tmp2(11410).dismissQuestContent(
                creative.quest.id,
                tmp2(5528).QuestContent.QUEST_BAR_MOBILE,
              );
              ...
              const dismissAdContentResult = tmp2(11655).dismissAdContent(
                closure_1,
                tmp2(5528).QuestContent.QUEST_BAR_MOBILE,
              );
              v2(4603).hideActionSheet();
