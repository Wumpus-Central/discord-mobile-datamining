...
function QuestDockPreviewTools(quest) {
  ...
  obj = {
    icon: closure_6(quest(7302).ActionSheetRow.Icon, { IconComponent: quest(8842).TrophyIcon }),
    label: null,
    onPress: null,
  };
...
export default function QuestDockContextMenuActionSheet(creative) {
  ...
  const tmp3 =
    creative.type === creative(obj[7]).AdCreativeType.BOUNTY &&
    !QuestHomeBountiesFeatureGateExperiment.useConfig(obj).enabled;
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (tmp2(5532).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = tmp2(11409).dismissQuestContent(
                creative.quest.id,
