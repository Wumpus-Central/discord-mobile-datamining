...
function QuestDockPreviewTools(quest) {
  ...
  obj = {
    icon: closure_5(quest(7213).ActionSheetRow.Icon, { IconComponent: quest(8750).TrophyIcon }),
    label: null,
    onPress: null,
  };
        ...
        if (0 === v2) {
          if (arg0 === 1) {
            ...
            if (tmp2(5465).AdCreativeType.QUEST === type) {
              ...
              const dismissQuestContentResult = tmp2(11308).dismissQuestContent(
                creative.quest.id,
                tmp2(5461).QuestContent.QUEST_BAR_MOBILE,
              );
