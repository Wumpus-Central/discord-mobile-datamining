...
export default noop.memo(function QuestDockBountyHeader() {
  ...
  fn.__closure = {
    withSpring: activeQuestDockMode(5059).withSpring,
    activeQuestDockMode,
    QuestDockMode,
  ...
  const obj3 = {
    onSubmenuPress: activeQuestDockMode(15199).useActionSheetPressHandler(bountyCreative),
    children: null,
  };
  const obj4 = {
    style: tmp4.wrapper,
  ...
  obj8.children = closure_7(activeQuestDockMode(4634).Text, {
