...
export default noop.memo(function QuestDockBountyHeader() {
  ...
  obj = {
    withSpring: tmp(5024).withSpring,
    activeQuestDockMode,
    QuestDockMode,
  ...
  const tmpResult1 = activeQuestDockMode(15181);
  const tmpResult2 = activeQuestDockMode(15171);
  const obj1 = {
    onSubmenuPress: activeQuestDockMode(15171).useActionSheetPressHandler(bountyCreative),
    children: null,
  };
  const obj2 = {
    style: tmp4.wrapper,
  ...
  const items2 = [
    closure_7(activeQuestDockMode(4601).Text, {
  ...
  const items6 = [
    closure_7(activeQuestDockMode(5742).BountiesPosterIllocon, { size: 32, accessible: false }),
    closure_7(activeQuestDockMode(4601).Text, {
