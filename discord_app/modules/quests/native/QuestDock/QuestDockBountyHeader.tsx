...
export default noop.memo(function QuestDockBountyHeader() {
  ...
  fn.__closure = {
    withSpring: activeQuestDockMode(5061).withSpring,
    activeQuestDockMode,
    QuestDockMode,
  ...
  const obj3 = {
    onSubmenuPress: activeQuestDockMode(15204).useActionSheetPressHandler(bountyCreative),
    children: null,
  };
  const obj4 = {
    style: tmp4.wrapper,
  ...
  obj8.children = closure_7(activeQuestDockMode(4636).Text, {
