...
({
  ...
  QUEST_DOCK_EXTERNAL_OFFSET_CLOSED: c9,
  QUEST_DOCK_EXTERNAL_OFFSET_COLLAPSED_WITH_YOU_BAR: c10,
  QUEST_DOCK_EXTERNAL_OFFSET_EXPANDED_WITH_YOU_BAR: unpackModuleId,
...
export const useQuestDockDismissalReset = function useQuestDockDismissalReset() {
  ...
  const effect = React.useEffect(() => {
    ...
    setRestingQuestDockMode = setInterval(
      maybeResetSoftDismissal,
      5 * activeQuestDockMode(closure_1_2[14]).Millis.MINUTE,
    );
    return () => {
