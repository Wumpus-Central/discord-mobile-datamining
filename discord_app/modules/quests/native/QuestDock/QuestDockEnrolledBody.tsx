...
import QuestBottomSheetFooterDefault from "../QuestBottomSheet/QuestBottomSheetFooter.tsx";
...
function EnrolledBodyWatchTask(quest) {
  ...
  const context = hasWatchVideoOnMobileTasks.useContext(
    quest(questDockWrapperSpecs[10]).QuestDockExternalCoordinationContext,
  );
  const setRestingQuestDockMode = context.setRestingQuestDockMode;
  questDockWrapperSpecs = hasWatchVideoOnMobileTasks.useContext(
    quest(questDockWrapperSpecs[11]).QuestDockGestureContext,
  ...
  obj5.children = closure_12(quest(questDockWrapperSpecs[17]).QuestBottomSheetContent, {
    quest,
    location: constants.QUESTS_BAR_MOBILE,
    step: quest(questDockWrapperSpecs[17]).QuestBottomSheetStep.TASK_STATUS,
    sourceQuestContent: quest(questDockWrapperSpecs[15]).QuestContent.QUEST_BAR_MOBILE,
  });
...
function EnrolledBodyPlayStreamTask(quest) {
  ...
  const enrolledQuestContentProps = obj.useEnrolledQuestContentProps({
    quest,
    location: constants.QUESTS_BAR_MOBILE,
  ...
  const obj4 = {
    ...
    children: closure_1_12(QuestBottomSheetHeaderDefault, {
      quest,
      step,
      withActionSheet: true,
      location: constants.QUESTS_BAR_MOBILE,
    }),
  };
  ...
  obj6.children = closure_1_12(QuestBottomSheet.QuestBottomSheetContent, {
    defibrillator,
    quest,
    handleTaskSelect,
    location: constants.QUESTS_BAR_MOBILE,
...
let obj = {
  wrapper: {
    ...
    paddingTop: QUEST_DOCK_EXPANDED_ENROLLED_PADDING_TOP,
    paddingHorizontal: QUEST_DOCK_EXPANDED_PADDING_HORIZONTAL,
  },
  headerWrapper: { marginBottom: nativeDefault.space.PX_16 },
  contentWrapper: null,
  footer: null,
  footerWrapper: null,
};
...
obj.footerWrapper = {
  marginLeft: -1 * QUEST_DOCK_EXPANDED_PADDING_HORIZONTAL,
...
export default noop.memo(function QuestDockEnrolledBody() {
  ...
  minExpandedContentHeight = noop.useContext(
    minExpandedContentHeight(14600).QuestDockGestureContext,
  ...
  if (obj4.hasWatchVideoTasks(questDockQuest)) {
    ...
    let tmp5Result = closure_12(EnrolledBodyWatchTask, obj5);
  } else {
    const obj6 = { quest: questDockQuest };
    tmp5Result = closure_12(EnrolledBodyPlayStreamTask, obj6);
  }
