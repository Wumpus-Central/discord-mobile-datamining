...
function EnrolledBodyWatchTask(quest) {
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              if (tmp12) {
                const obj1 = { questId: tmp2.id, sourceQuestContent: quest(5497).QuestContent.QUEST_BAR_MOBILE };
                v1 = 1;
                c2 = 1;
                const obj2 = { value: setRestingQuestDockMode(15203)(obj1), done: false };
                return obj2;
              } else {
                c2 = 3;
              }
  ...
  let obj2 = {
    style: tmp.contentWrapper,
    children: closure_12(quest(questDockWrapperSpecs[17]).QuestBottomSheetContent, {
      quest,
...
function EnrolledBodyPlayStreamTask(quest) {
  ...
  const obj3 = {
    style: tmp.contentWrapper,
    children: closure_1_12(QuestBottomSheet.QuestBottomSheetContent, {
      defibrillator,
      quest,
      handleTaskSelect,
      location: constants.QUESTS_BAR_MOBILE,
...
export default noop.memo(function QuestDockEnrolledBody() {
  let obj = minExpandedContentHeight(15181);
  const questDockQuest = obj.useQuestDockQuest();
  minExpandedContentHeight = noop.useContext(
    minExpandedContentHeight(15175).QuestDockGestureContext,
