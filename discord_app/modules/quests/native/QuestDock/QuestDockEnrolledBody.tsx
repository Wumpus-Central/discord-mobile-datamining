...
function EnrolledBodyPlayStreamTask(quest) {
  ...
  quest = quest.quest;
  const tmp = callback3();
  let obj = require("../QuestBottomSheet/QuestBottomSheet.tsx") /* QuestBottomSheet */;
  obj = { quest, location: constants.QUESTS_BAR_MOBILE, sourceQuestContent: require("../../QuestTypes.tsx") /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE };
  ...
  const items = [callback(View, { style: tmp.headerWrapper, children: callback(require("../QuestBottomSheet/QuestBottomSheetHeader.tsx"), obj2) }), , ];
  ...
  obj4[6] = require("../../QuestTypes.tsx") /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE;
  obj3[1] = callback(require("../QuestBottomSheet/QuestBottomSheet.tsx") /* QuestBottomSheet */.QuestBottomSheetContent, obj4);
  ...
  const obj1 = { style: tmp.headerWrapper, children: callback(require("../QuestBottomSheet/QuestBottomSheetHeader.tsx"), obj2) };
  obj6[8] = require("../../QuestTypes.tsx") /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE;
  obj5[1] = callback(require("../QuestBottomSheet/QuestBottomSheetFooter.tsx"), obj6);
...
const memoResult = importAllResult.memo(function QuestDockEnrolledBody() {
  ...
  obj = { paddingBottom: Math.max(require("../../../safe_area/useSafeAreaInsets.native.tsx")().bottom, QUEST_DOCK_EXPANDED_PADDING_BOTTOM) };
  items2[1] = obj;
  obj[0] = items2;
  obj[1] = callback;
