...
const memoResult = require("noop").memo(function QuestDockEnrolledHeader() {
  let obj = require("QuestDockCreativeContext.tsx") /* getDeliveredQuest */;
  const questCreative = obj.useQuestCreative();
  const tmp2 = callback4();
  let obj1 = require("../../hooks/QuestHooks.tsx") /* useQuests */;
  const questTaskDetails = obj1.useQuestTaskDetails(questCreative);
  let obj2 = require("../../hooks/QuestHooks.tsx") /* useQuests */;
  let obj3 = require("../../hooks/QuestCopyHooks.tsx") /* _getQuestsInstructionsToWinReward */;
  const questBarTitle = obj3.useQuestBarTitle(questCreative);
  obj = { quest: questCreative, isExpanded: false, activeScreen: callback(obj2.useTaskPlatformScreen(questCreative, questTaskDetails), 1)[0], sourceQuestContent: require("../../QuestTypes.tsx") /* QuestsVisibleMessagesChangedSource */.QuestContent.QUEST_BAR_MOBILE };
  obj = { style: tmp2.wrapper, children: null };
  obj1 = { style: tmp2.progressIndicatorWrapper, children: null };
  const questBarSubtitle = require("../../hooks/QuestCopyHooks.tsx") /* _getQuestsInstructionsToWinReward */.useQuestBarSubtitle(obj);
  obj2 = { quest: questCreative, size: "x-sm", progress: questTaskDetails.percentComplete, loading: false, hasConfetti: true };
  obj1[1] = callback2(require("../QuestProgressIndicator.tsx"), obj2);
  const items = [callback2(View, obj1), ];
  obj3 = { style: tmp2.copy, children: null };
  const items1 = [callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "heading-md/semibold", color: "mobile-text-heading-primary", children: questBarTitle }), callback2(require("../../../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-sm/medium", color: "text-muted", children: questBarSubtitle })];
  obj3[1] = items1;
