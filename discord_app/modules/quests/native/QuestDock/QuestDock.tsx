...
function QuestDockWithGestureAnimation(backgroundColor) {
  ...
  const token = backgroundColor(questDockExpandHandler[22]).useToken(
  ...
  obj34.children = closure_23(backgroundColor(questDockExpandHandler[34]).Backdrop, {
    onDismiss: callback,
...
function QuestDockWithEntranceAnimation(arg0) {
  ...
  if (!tmp14) {
    ...
    tmp16 = closure_23(identifierMetricTag(4374).View, obj6);
  }
  return tmp16;
}
