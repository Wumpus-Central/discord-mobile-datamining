...
function QuestDockWithGestureAnimation(appThemedBackgroundColor) {
  ...
  obj2 = { withSpring: appThemedBackgroundColor(questDockExpandHandler[24]).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS, windowDimensions };
  J.__closure = obj2;
  ...
  obj3 = { withSpring: appThemedBackgroundColor(questDockExpandHandler[24]).withSpring, activeQuestDockMode, QuestDockMode, QUEST_DOCK_MODE_CHANGE_PHYSICS };
  te.__closure = obj3;
  ...
  obj4 = { hasInsetHeaderTile: tmp, activeQuestDockMode, QuestDockMode, QUEST_DOCK_CONTENT_BORDER_RADII, questDockBorderRadius: token, bottomBorderRadius: tmp20, withSpring: appThemedBackgroundColor(questDockExpandHandler[24]).withSpring, QUEST_DOCK_MODE_CHANGE_PHYSICS_CLAMPED, QUEST_DOCK_COLLAPSED_HEIGHT, questDockWrapperSpecs, QUEST_DOCK_UNENROLLED_HEADER_INSET_EXPANDED: closure_17 };
  oe.__closure = obj4;
...
function QuestDockWithEntranceAnimation(arg0) {
  ...
  const tmp4Result = tmp4(obj.useState(constants2.PENDING), 2);
  ...
  if (!tmp18) {
    ...
    obj1 = {
      children() {
          ...
          obj = { children: null };
          const obj1 = { theme, children: __initData(QuestDockWithGestureAnimation, { appThemedBackgroundColor: backgroundColor, layoutVariant, collapsedContent, expandedContent, backgroundContent }) };
    ...
    tmp20 = closure_21(tmp(4296).View, obj);
  }
  return tmp20;
}
