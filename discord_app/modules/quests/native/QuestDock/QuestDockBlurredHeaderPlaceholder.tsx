// === Module 15193: QuestDockBlurredHeaderPlaceholder ===

// Module 15193 (QuestDockBlurredHeaderPlaceholder)
import thumbHashToRGBA from "thumbHashToRGBA" /* 15194 */;
...
export default noop.memo(function QuestDockBlurredContentBackground(placeholder) {
  ...
  obj1.style = items1;
  const items2 = [closure_7(questDockWrapperSpecs(activeQuestDockMode[8]).Image, obj1), closure_7(closure_4, { style: tmp3.overlay })];
  obj.children = items2;
