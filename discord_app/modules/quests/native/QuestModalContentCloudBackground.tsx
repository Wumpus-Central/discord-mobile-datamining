...
let closure_7 = createCacheKey.createStyles((arg0) => {
  ...
  let obj = { wrapper: null, cloudsImage: null, cloudsImageLight: null, gradient: null, solidBackground: null };
...
const result = require("obj132").fileFinishedImporting("modules/quests/native/QuestModalContentCloudBackground.tsx");
...
export default function QuestModalContentCloudBackground(align) {
  ...
  if (isThemeDarkResult) {
    ...
    const items1 = [callback(closure_3, obj1), ];
    ...
    obj2[2] = str2;
    items1[1] = callback(preloadDefault, obj2);
    obj[1] = items1;
