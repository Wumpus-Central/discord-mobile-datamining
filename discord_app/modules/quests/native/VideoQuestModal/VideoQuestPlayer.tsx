...
const memoResult = importAllResult.memo((onLoad) => {
  ...
  if (null != url) {
    let VIDEO_PLAYER_VIDEO = tmp3(10405).QuestAssetType.VIDEO_PLAYER_VIDEO_HLS;
  } else {
    VIDEO_PLAYER_VIDEO = tmp3(10405).QuestAssetType.VIDEO_PLAYER_VIDEO;
  }
  ...
  obj = { shouldShowControls, withSpring: tmp3(4711).withSpring, SUBTLE_SPRING: tmp3(4715).SUBTLE_SPRING };
  G.__closure = obj;
  ...
  sharedValue1 = handleBufferAnalytics(4162).useSharedValue(0);
  const tmp3Result1 = handleBufferAnalytics(4162);
  class U {
    constructor() {
      obj = { width: null };
  ...
  obj = { withTiming: tmp3(4303).withTiming, progress: sharedValue1, timingFast: tmp3(4306).timingFast };
  U.__closure = obj;
  U.__workletHash = 4647711667921;
  U.__initData = closure_23;
  const animatedStyle1 = handleBufferAnalytics(4162).useAnimatedStyle(U);
  ...
  const tmp3Result2 = handleBufferAnalytics(4162);
  const defaultWatchVideoTask = handleBufferAnalytics(7123).getDefaultWatchVideoTask(quest.config);
  ...
  const tmp3Result3 = handleBufferAnalytics(7123);
  ...
  if (null == memo2) {
    ...
    obj7[3] = num6;
    obj6[3] = obj7;
    items29[1] = targetSeconds(tmp3(14315).VideoQuestCaptions, obj6);
    if (!tmp72) {
      items29[2] = tmp72;
      tmp80Result = !tmp39;
      if (!tmp39) {
      ...
      if (tmp80Result4) {
        ...
        if (!hasCaptionAsset) {
          ...
          if (flag2) {
            ...
            obj11[4] = tmp80(tmp3(14201).TranscriptOutlineIcon, obj12);
            flag2 = tmp80(tmp3(4844).PressableOpacity, obj11);
          }
          items32[1] = flag2;
          obj10[1] = items32;
          ...
          obj14[0] = color;
          obj13[4] = tmp80(tmp3(14199).ClosedCaptionsOutlineIcon, obj14);
          tmp80(tmp3(4844).PressableOpacity, obj13);
        }
      }
      ...
      obj16[4] = tmp80(tmp3(14204).SkipBackwardIcon, obj17);
      const items34 = [tmp80(tmp3(14203).VideoQuestPlayerControlButton, obj16), , ];
      if (!tmp22) {
        ...
        if (!tmp22) {
          if (first1 !== tmp17.ERRORED) {
            if (tmp70) {
              let PauseIcon = tmp3(8795).PlayIcon;
            } else {
              PauseIcon = tmp3(8797).PauseIcon;
            }
            let tmp80Result2 = tmp80(PauseIcon, { size: "lg" });
          }
          obj18[3] = tmp80Result2;
          items34[1] = tmp80(tmp3(14203).VideoQuestPlayerControlButton, obj18);
          ...
          obj19[4] = tmp80(tmp3(14205).SkipForwardIcon, obj20);
          items34[2] = tmp80(tmp3(14203).VideoQuestPlayerControlButton, obj19);
          obj15[1] = items34;
          ...
          if (tmp80Result4) {
            ...
            obj22[4] = tmp80(tmp3(14206).FullscreenEnterIcon, {});
            obj21[1] = tmp80(tmp3(4844).PressableOpacity, obj22);
            tmp80Result3 = tmp80(tmp81, obj21);
          }
          items33[2] = tmp80Result3;
          obj9[2] = items33;
          items29[4] = tmp82(tmp29(4162).View, obj9);
          if (tmp80Result4) {
            ...
            obj24[0] = items36;
            obj23[1] = tmp80(tmp29(4162).View, obj24);
        ...
        tmp80Result2 = tmp80(tmp3(9795).RetryIcon, { size: "lg" });
      }
