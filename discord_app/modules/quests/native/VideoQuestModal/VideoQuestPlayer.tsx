...
const memoResult = importAllResult.memo((onLoad) => {
  ...
  if (null != url) {
    let VIDEO_PLAYER_VIDEO = tmp3(10358).QuestAssetType.VIDEO_PLAYER_VIDEO_HLS;
  } else {
    VIDEO_PLAYER_VIDEO = tmp3(10358).QuestAssetType.VIDEO_PLAYER_VIDEO;
  }
  ...
  obj = { shouldShowControls, withSpring: tmp3(4664).withSpring, SUBTLE_SPRING: tmp3(4668).SUBTLE_SPRING };
  G.__closure = obj;
  ...
  const defaultWatchVideoTask = handleBufferAnalytics(7077).getDefaultWatchVideoTask(quest.config);
  ...
  const tmp3Result3 = handleBufferAnalytics(7077);
  ...
  if (null == memo2) {
    ...
    obj7[3] = num6;
    obj6[3] = obj7;
    items29[1] = targetSeconds(tmp3(14261).VideoQuestCaptions, obj6);
    if (!tmp72) {
      items29[2] = tmp72;
      tmp80Result = !tmp39;
      if (!tmp39) {
      ...
      if (tmp80Result4) {
        ...
        if (!hasCaptionAsset) {
          ...
          if (flag2) {
            ...
            obj11[4] = tmp80(tmp3(14150).TranscriptOutlineIcon, obj12);
            flag2 = tmp80(tmp3(4797).PressableOpacity, obj11);
          }
          items32[1] = flag2;
          obj10[1] = items32;
          ...
          obj14[0] = color;
          obj13[4] = tmp80(tmp3(14148).ClosedCaptionsOutlineIcon, obj14);
          tmp80(tmp3(4797).PressableOpacity, obj13);
        }
      }
      ...
      obj16[4] = tmp80(tmp3(14153).SkipBackwardIcon, obj17);
      const items34 = [tmp80(tmp3(14152).VideoQuestPlayerControlButton, obj16), , ];
      if (!tmp22) {
        ...
        if (!tmp22) {
          if (first1 !== tmp17.ERRORED) {
            if (tmp70) {
              let PauseIcon = tmp3(8749).PlayIcon;
            } else {
              PauseIcon = tmp3(8751).PauseIcon;
            }
            let tmp80Result2 = tmp80(PauseIcon, { size: "lg" });
          }
          obj18[3] = tmp80Result2;
          items34[1] = tmp80(tmp3(14152).VideoQuestPlayerControlButton, obj18);
          ...
          obj19[4] = tmp80(tmp3(14154).SkipForwardIcon, obj20);
          items34[2] = tmp80(tmp3(14152).VideoQuestPlayerControlButton, obj19);
          obj15[1] = items34;
          ...
          if (tmp80Result4) {
            ...
            obj22[4] = tmp80(tmp3(14155).FullscreenEnterIcon, {});
            obj21[1] = tmp80(tmp3(4797).PressableOpacity, obj22);
        ...
        tmp80Result2 = tmp80(tmp3(9748).RetryIcon, { size: "lg" });
      }
