...
const memoResult = importAllResult.memo(function VideoQuestModalContentCompleted(onRestartVideo) {
  ...
  obj = { withDelay: tmp2(4145).withDelay, ANIMATION_DELAY: 125, withSpring: tmp2(4694).withSpring, isComponentMounted: sharedValue, ANIMATED_CONTENT_SPRING_CONFIG: closure_10, interpolate: tmp2(4145).interpolate, ANIMATED_CONTENT_OFFSET_Y: 75 };
  fn.__closure = obj;
  ...
  let isShareableQuestResult = quest(7102).isShareableQuest(quest.config);
  ...
  const windowDimensions = obj1.useContext(tmp2(14252).QuestDockGestureContext).windowDimensions;
  const tmp2Result1 = quest(7102);
  let str = "md";
  ...
  if (tmp18 == null) {
    tmp18 = tmp2(14284).QUEST_PROGRESS_DIAMETER_BY_SIZE[str];
  }
  ...
  const items3 = [callback2(quest(4281).Heading, obj3), callback2(sharedValue(14302), { onClose, style: tmp.closeButton })];
  obj2[4] = items3;
  ...
  if (isLoading) {
    if (!isClaiming) {
      ...
      obj15[3] = tmp22(tmp2(9779).RetryIcon, obj16);
      items11[1] = tmp22(tmp2(4827).PressableOpacity, obj15);
      obj11[3] = items11;
      ...
      if (tmp22Result) {
        ...
        obj20[0] = memo.url;
        obj19[1] = obj20;
        obj17[3] = tmp22(tmp6(5251), obj19);
        tmp22Result = tmp22(tmp2(4827).PressableOpacity, obj17);
      }
      ...
      obj22[3] = tmp2(10399).getExternalCtaLabel(quest);
      ...
      if (isShareableQuestResult) {
        ...
        obj23[3] = tmp22(tmp2(12148).ShareIcon, obj24);
        isShareableQuestResult = tmp22(tmp2(4827).PressableOpacity, obj23);
      }
      ...
      obj1[2] = items4;
      return tmp21(tmp2(5311).SafeAreaPaddingView, obj1);
    }
  }
  const obj25 = { style: tmp.contentRewards, onLayout: callback1, children: null };
  const items14 = [callback2(sharedValue(14303), { withQuestName: false, withRewardAvailableCopy: false, size: str, withRewardTileAnimation: true }), ];
