...
let obj = {
  ...
  content: null,
  contentRewardsAnimatedWrapper: null,
...
const createStyles = { flexGrow: 1, flexShrink: 0, paddingTop: fn(15211).COMPLETION_GLOW_CLEARANCE };
...
export default noop.memo(function VideoQuestModalContentCompleted(onRestartVideo) {
  ...
  const items3 = [
    closure_8(quest(tmp3[23]).Heading, obj3),
