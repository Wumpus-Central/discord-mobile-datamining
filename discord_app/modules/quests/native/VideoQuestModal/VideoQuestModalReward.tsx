...
export default noop.memo(function VideoQuestModalReward(style) {
  ...
  if (tmp) {
    ...
    tmp = closure_4(tmp3(4602).Text, obj2);
  }
  const items2 = [tmp, ];
  if (tmp9Result) {
    ...
    tmp9Result = closure_4(tmp3(4602).Text, obj4);
  }
  items2[1] = tmp9Result;
  obj1.children = items2;
  items1[1] = closure_5(quest(5024).Stack, obj1);
  obj.children = items1;
  return closure_5(quest(5024).Stack, obj);
});