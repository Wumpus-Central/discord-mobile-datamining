...
export default function VideoQuestTranscriptActionSheet(quest) {
  ...
  obj.header = closure_7(quest(7201).BottomSheetTitleHeader, obj);
  ...
  obj.children = closure_8(quest(5023).Stack, obj1);
  obj.children = closure_7(quest(6677).BottomSheetScrollView, obj);
