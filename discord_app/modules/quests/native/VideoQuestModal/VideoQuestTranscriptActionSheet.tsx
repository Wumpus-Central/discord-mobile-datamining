...
const VideoQuestUIStore = fn(8028);
...
export default function VideoQuestTranscriptActionSheet(quest) {
  ...
  obj.header = closure_7(quest(7482).BottomSheetTitleHeader, obj2);
  ...
  obj3.children = closure_8(quest(5271).Stack, obj4);
  obj.children = closure_7(quest(6957).BottomSheetScrollView, obj3);
  return closure_7(quest(7530).ActionSheet, obj);
}
