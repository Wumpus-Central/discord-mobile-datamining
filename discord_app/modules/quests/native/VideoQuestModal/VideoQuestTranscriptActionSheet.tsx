// === Module 14705: VideoQuestTranscriptActionSheet ===
...
import _toPropertyKey from "_toPropertyKey" /* 7383 */;
...
export default function VideoQuestTranscriptActionSheet(quest) {
  ...
  obj[1] = callback2(quest(5573).BottomSheetTitleHeader, obj);
  ...
  obj1[2] = items2;
  obj[1] = closure_8(quest(4878).Stack, obj1);
  obj[2] = callback2(quest(5576).BottomSheetScrollView, obj);
  return callback2(quest(5941).ActionSheet, obj);
};