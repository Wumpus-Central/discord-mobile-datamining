...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11771).getVideoQuestProgressRemainingAccessibilityLabel(
      questTaskDetails,
      tmp8,
    );
  ...
  const items2 = [
    closure_6(View, obj4),
    closure_5(questTaskDetails(15423), { iconColor: closeButtonIconColor, onClose }),
  ];
