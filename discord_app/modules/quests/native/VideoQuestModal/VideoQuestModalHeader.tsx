...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11544).getVideoQuestProgressRemainingAccessibilityLabel(
      questTaskDetails,
      tmp8,
    );
  ...
  const items1 = [closure_5(quest(4570).Text, obj1)];
  const obj3 = {
  ...
  items1[1] = closure_5(quest(4570).Text, obj3);
  obj.children = items1;
  const items2 = [
    closure_6(View, obj),
    closure_5(questTaskDetails(15178), { iconColor: closeButtonIconColor, onClose }),
  ];
  obj.children = items2;
