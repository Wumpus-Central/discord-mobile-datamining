...
export default function VideoQuestModalHeader(showCurrentVideoTime) {
  ...
  if (null == completedAt) {
    const videoQuestProgressRemainingAccessibilityLabel = tmp3(11758).getVideoQuestProgressRemainingAccessibilityLabel(
      questTaskDetails,
      tmp8,
    );
  ...
  const items2 = [
    closure_6(View, obj4),
    closure_5(questTaskDetails(15354), { iconColor: closeButtonIconColor, onClose }),
  ];
