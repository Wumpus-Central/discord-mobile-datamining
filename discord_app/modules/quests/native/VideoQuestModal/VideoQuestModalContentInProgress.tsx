...
let closure_23 = noop.memo((quest) => {
  ...
  if (!isFullscreen) {
    ...
    const obj16 = { direction: "vertical", spacing: tmp15(tmp2[7]).space.PX_24, style: tmp3.questDetailsLandscape, children: null };
    const obj17 = { direction: "horizontal", justify: "space-between", spacing: tmp15(tmp2[7]).space.PX_8, children: null };
...
let closure_24 = noop.memo((arg0) => {
  ...
  if (null != completedAt) {
    ...
    const obj18 = { icon: tmp18(tmp(tmp2[40]).ArrowSmallRightIcon, { size: "sm" }), iconPosition: "end", onPress: onNavigateToPostWatchVideo, variant: "secondary", size: "sm", text: null };
