...
import _modDef3482 from "../../partner_perks/xbox/game_pass_perks/XboxGamePassPerks.messages.js";
...
export default function QuestOrbMultiplierPerkInfoActionSheet(multiplier) {
  ...
  let obj3 = {
    visible:
      orbMultiplierEligibility === multiplier(11545).QuestOrbMultiplierEligibilityType.NITRO ||
      orbMultiplierEligibility === multiplier(11545).QuestOrbMultiplierEligibilityType.UPSELL,
    children: null,
  };
  const tmp4 =
    orbMultiplierEligibility === multiplier(11545).QuestOrbMultiplierEligibilityType.NITRO ||
