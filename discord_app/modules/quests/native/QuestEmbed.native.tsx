...
export const createQuestsEmbed = function createQuestsEmbed(questId) {
  ...
  if (obj.isMetaQuest()) {
    ...
    obj2.thumbnailUrl = Image.resolveAssetSource(_modDef12798).uri;
    ...
    if (null == result) {
      if (null == value) {
        ...
        obj8.thumbnailUrl = Image.resolveAssetSource(_modDef12798).uri;
      ...
      obj10.thumbnailUrl = Image.resolveAssetSource(_modDef12798).uri;
      ...
      if (tmp2Result22.isShareableQuest(result.config)) {
        ...
        if (result.config.expiresAt < date1.toISOString()) {
          ...
          const obj15 = { quest: result, taskDetails: questTaskDetails, location: constants.EMBED_MOBILE, sourceQuestContent: QuestTypes.QuestContent.QUEST_EMBED_MOBILE, thirdPartyTaskDetails, withoutMarkdown: true, currentUser };
        ...
        obj20.thumbnailUrl = Image.resolveAssetSource(_modDef12798).uri;
