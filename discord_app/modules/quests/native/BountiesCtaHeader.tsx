...
function BountiesCtaHeaderInner(bounties) {
  ...
  const QuestContent = bounties(5131).QuestContent;
...
const memoResult = importAllResult.memo(function BountiesCtaHeader(isEmptyOrCompleted) {
  ...
  if (!tmp3) {
    ...
    if (tmp3) {
      ...
      obj1[0] = closure_8;
      obj1[1] = tmp7(7108).AdCreativeType.BOUNTY;
      obj1[2] = tmp7(5131).QuestContent.QUEST_HOME_ENTRYPOINT_MOBILE;
      obj1[4] = tmp2.isInView;
      obj1[5] = tmp7(5131).QuestContent.QUEST_HOME_ENTRYPOINT_MOBILE;
