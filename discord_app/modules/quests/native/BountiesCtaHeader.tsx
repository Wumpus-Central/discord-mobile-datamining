...
import _modDef15322 from "../../../../discord_assets/assets/quests/bounties/starfield_bg.mp4.js";
...
import _modDef15344 from "../../../../discord_assets/assets/quests/bounties/bounty_banner.mp4.js";
...
export default noop.memo(function BountiesCtaHeader(isEmptyOrCompleted) {
  ...
  if (!tmp3) {
    ...
    if (tmp3) {
      ...
      tmp9Result = closure_10(tmp7(12029).QuestContentImpressionTrackerNative, obj4);
    }
