...
import _modDef15388 from "../../../../discord_assets/assets/quests/bounties/starfield_bg.mp4.js";
...
import _modDef15410 from "../../../../discord_assets/assets/quests/bounties/bounty_banner.mp4.js";
...
function BountiesCtaDescription(arg0) {
  ...
  if (!isEmptyOrCompleted) {
    if (!inlineLearnMore) {
      ...
      items[1] = closure_1_10(tmp5(4823).Text, obj4);
      obj3.children = items;
...
export default noop.memo(function BountiesCtaHeader(isEmptyOrCompleted) {
  ...
  if (!tmp3) {
    ...
    if (tmp3) {
      ...
      tmp9Result = closure_10(tmp7(12112).QuestContentImpressionTrackerNative, obj4);
    }
