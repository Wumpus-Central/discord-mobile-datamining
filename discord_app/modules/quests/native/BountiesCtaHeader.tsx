...
import _modDef14563 from "../../../../discord_assets/assets/quests/bounties/starfield_bg.mp4.js";
...
import _modDef14587 from "../../../../discord_assets/assets/quests/bounties/bounty_banner.mp4.js";
...
function BountiesCtaDescription(arg0) {
  ...
  if (!isEmptyOrCompleted) {
    if (!inlineLearnMore) {
      ...
      items[1] = closure_1_10(tmp5(4825).Text, obj4);
      obj3.children = items;
...
function BountiesCtaHeaderInner(bounties) {
  ...
  const bountiesEntryPointButtonVariant = bounties(14585).getBountiesEntryPointButtonVariant(shopCarouselButtonVariant);
  let obj = bounties(14585);
  const items = [AdContentSeenStore];
  const items1 = [bounties];
  let stateFromStores = bounties(504).useStateFromStores(
    items,
  ...
  const callback = noop.useCallback(() => {
    ...
    const result = obj.trackAdContentClicked({
      adContentId,
  ...
  if (null != replaceHeaderMediaWith) {
    ...
    if (stateFromStores) {
      ...
      stateFromStores = closure_10(tmp4(1177).NewTag, {
    ...
    obj10.children = closure_10(BountiesCtaDescription, obj11);
    ...
    if (tmp11Result) {
      ...
      obj13.children = closure_10(StartEarningOrbsButton, obj14);
    ...
    const obj15 = { uri: _modDef14587, style: null, children: null };
    ...
    if (stateFromStores) {
      ...
      tmp11Result4 = closure_10(tmp4(1177).NewTag, { variant: "text-xs/bold", containerStyle: null, textStyle: null });
    ...
    const items10 = [closure_10(BountiesCtaDescription, obj18)];
    ...
    if (tmp11Result5) {
      ...
      tmp11Result5 = closure_10(StartEarningOrbsButton, obj19);
    }
  ...
  if (tmp9Result2) {
    ...
    if (!flag) {
      ...
      obj38.children = closure_10(StartEarningOrbsButton, obj39);
...
const minHeight = 472 - (sum + fn(5279).MEDIUM_BUTTON_HEIGHT + PX_20 + 170);
...
export default noop.memo(function BountiesCtaHeader(isEmptyOrCompleted) {
  ...
  if (!tmp3) {
    ...
    if (tmp3) {
      ...
      let tmp9Result = closure_10(BountiesCtaHeaderInner, obj3);
    } else {
      const obj4 = {
        adContentId,
        adCreativeType: tmp7(5758).AdCreativeType.BOUNTY,
        questContent: tmp7(5754).QuestContent.QUEST_HOME_ENTRYPOINT_MOBILE,
        questContentPosition: 0,
        overrideVisibility: tmp2.isInView,
        sourceQuestContent: tmp7(5754).QuestContent.QUEST_HOME_ENTRYPOINT_MOBILE,
        children() {
          const obj = {};
      ...
      tmp9Result = closure_10(tmp7(10740).QuestContentImpressionTrackerNative, obj4);
    }
