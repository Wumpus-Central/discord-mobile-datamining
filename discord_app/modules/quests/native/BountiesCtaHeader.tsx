...
import _modDef15173 from "../../../../discord_assets/assets/quests/bounties/starfield_bg.mp4.js";
...
import _modDef15195 from "../../../../discord_assets/assets/quests/bounties/bounty_banner.mp4.js";
...
function BountiesCtaDescription(arg0) {
  ...
  if (!isEmptyOrCompleted) {
    if (!inlineLearnMore) {
      ...
      items[1] = closure_1_10(tmp5(4636).Text, obj4);
      obj3.children = items;
...
export default noop.memo(function BountiesCtaHeader(isEmptyOrCompleted) {
  ...
  if (!tmp3) {
    ...
    if (tmp3) {
      ...
      tmp9Result = closure_10(tmp7(11929).QuestContentImpressionTrackerNative, obj4);
    }
