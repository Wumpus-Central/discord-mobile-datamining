...
import _modDef15082 from "BountiesBannerBackground.tsx";
...
import closure_7 from "../AdContentSeenStore.tsx";
...
function BountiesCtaHeaderInner(bounties) {
  ...
  const stateFromStores = obj1.useStateFromStores(
    items,
    () => bounties.some((id) => !closure_7.hasSeen(callback(table[17]).AdCreativeType.BOUNTY, id.id)),
    items1,
  );
  ...
  const callback = importAllResult.useCallback(() => {
    ...
    obj = {
      ...
      adCreativeType: bounties(closure_1_2[17]).AdCreativeType.BOUNTY,
      questContent: bounties(closure_1_2[19]).QuestContent.QUEST_HOME_ENTRYPOINT_MOBILE,
      questContentCTA: bounties(closure_1_2[21]).QuestContentCTA.START_BOUNTY,
      sourceQuestContent: bounties(closure_1_2[19]).QuestContent.QUEST_HOME_ENTRYPOINT_MOBILE,
...
let closure_17 = createCacheKey.createStyles(() => {
  ...
  obj[17] = {
    ...
    paddingBottom: ThemesDefault.space.PX_20,
    paddingHorizontal: ThemesDefault.space.PX_20,
  };
  return obj;
});
