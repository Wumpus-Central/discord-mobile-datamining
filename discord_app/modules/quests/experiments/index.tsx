...
const obj1 = { name: "2026-05-app-store-overlay-feature-gate", kind: "user", defaultConfig: { enabled: false }, variations: null };
let obj2 = { 1: null };
obj2[1] = { enabled: true };
obj1.variations = obj2;
const apexExperiment1 = ApexExperiment.createApexExperiment(obj1);
const obj3 = { name: "2026-07-custom-app-store-overlay", kind: "user", defaultConfig: { enabled: false }, variations: null };
const obj4 = { 1: null };
obj4[1] = { enabled: true };
obj3.variations = obj4;
const obj5 = { CONTROL: 0, [0]: "CONTROL", LOOP_SQUEEZED_BACK_APP_STORE_OVERLAY: 1, [1]: "LOOP_SQUEEZED_BACK_APP_STORE_OVERLAY", ENTIRE_VIDEO_CLICKABLE: 2, [2]: "ENTIRE_VIDEO_CLICKABLE", OPEN_APP_SHEET_ON_PAUSE: 3, [3]: "OPEN_APP_SHEET_ON_PAUSE" };
const apexExperiment2 = ApexExperiment.createApexExperiment(obj3);
const obj6 = { name: "2026-08-bounties-ctr-experiment-1", kind: "user", defaultConfig: { enabled: false, variant: obj5.CONTROL }, variations: { 0: { enabled: false, variant: obj5.CONTROL }, 1: { enabled: true, variant: obj5.LOOP_SQUEEZED_BACK_APP_STORE_OVERLAY }, 2: { enabled: true, variant: obj5.ENTIRE_VIDEO_CLICKABLE }, 3: { enabled: true, variant: obj5.OPEN_APP_SHEET_ON_PAUSE } } };
...
const obj10 = { DEFAULT: 0, [0]: "DEFAULT", AUTO_ENABLE_CAPTIONS: 1, [1]: "AUTO_ENABLE_CAPTIONS", AUTO_UNMUTE: 2, [2]: "AUTO_UNMUTE" };
const apexExperiment4 = ApexExperiment.createApexExperiment(obj8);
const obj11 = { name: "2026-03-muted-video-quest-new-defaults", kind: "user", defaultConfig: { enabled: false, variant: obj10.DEFAULT }, variations: { 0: { enabled: false, variant: obj10.DEFAULT }, 1: { enabled: true, variant: obj10.AUTO_ENABLE_CAPTIONS }, 2: { enabled: true, variant: obj10.AUTO_UNMUTE } } };
...
const obj14 = { name: "2026-04-composed-quest-player", kind: "user", defaultConfig: { enabled: false }, variations: null };
const obj15 = { 1: null };
