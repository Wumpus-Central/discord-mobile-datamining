// === Module 9627: _manuallyStartConsoleQuest ===
        ...
        try {
          ...
          if (0 === body) {
            ...
            if (arg0 === 1) {
              ...
              obj6[0] = callback2(5065).post(obj2);
              return obj6;
            }
          } else {
            if (2 === tmp7) {
      ...
      if (c7 === 2) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            const obj23 = lib(709);
            obj12[1] = callback(7075).questUserStatusFromServer(lib.body);
          ...
          try {
            ...
            if (0 === guildsTree) {
              ...
              if (1 === tmp8) {
                ...
                throwTypeErrorResult = dependencyMap;
                obj3[1] = dependencyMap;
                throwTypeErrorResult = callback2(9632).recordQuestRequestApiResponse("/quests/decision", obj3);
                throwTypeErrorResult = callback2;
                throwTypeErrorResult = dependencyMap;
                const obj20 = callback2(9632);
                throwTypeErrorResult = result;
                const obj4 = {};
                throwTypeErrorResult = callback2;
                throwTypeErrorResult = dependencyMap;
                throwTypeErrorResult = obj4;
                throwTypeErrorResult = Object.assign(callback2(7045)());
                throwTypeErrorResult = undefined;
                if (message != null) {
                ...
                if (arg0 === 1) {
                  ...
                  throwTypeErrorResult = callback;
                  throwTypeErrorResult = dependencyMap;
                  const LessPersonalizedAdsExperiment = callback(9633).LessPersonalizedAdsExperiment;
                ...
                if (null != creative) {
                  if (creative.creative_type === callback(7096).AdCreativeType.QUEST) {
                    obj1 = callback(7075);
                ...
                if (null != result) {
                  ...
                  throwTypeErrorResult = callback;
                  throwTypeErrorResult = dependencyMap;
                  if (callback === callback(5102).AdPlacement.DESKTOP_ACCOUNT_PANEL_AREA) {
                    obj7 = callback2(9634);
                    obj7.startTracking(result.id);
                  }
                  obj8 = callback2(698);
                  const obj17 = {};
                  const merged = Object.assign(callback2(7045)());
            ...
            if (arg0 === 1) {
              ...
              if (!fetchingEarnedQuestToDeliverByPlacement.isFetchingEarnedQuestToDeliverByPlacement(prop)) {
                ...
                if (0 !== found.length) {
                  const _Date = Date;
                  c3 = Date.now();
                  const result = callback2(9636).recordEarnedRequestAttempt(tmp74, tmp75);
                  const obj16 = callback2(9636);
                  ...
                  c9 = 1;
                  const obj2 = { value: null, done: false };
                  obj2[0] = callback(6820).getSession();
                  return obj2;
                }
              }
              arr2 = callback;
