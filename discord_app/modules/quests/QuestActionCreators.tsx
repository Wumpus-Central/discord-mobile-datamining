// === Module 11622: QuestActionCreators ===
...
import VirtualCurrencyUtils from "VirtualCurrencyUtils" /* 11623 */;
import QuestDecisionRoundtripTrackerDefault from "QuestDecisionRoundtripTracker" /* 11624 */;
import EarnedDecisionRoundtripTrackerDefault from "EarnedDecisionRoundtripTracker" /* 11644 */;
...
let closure_17 = async function _manualStopConsoleQuest(arg0) {
  if (c1 === 2) {
    c1 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp3 === 3) {
...
let closure_18 = async function _resetRecentQuestCompletions() {
  if (c0 === 2) {
    c0 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp3 === 3) {
...
let closure_19 = async function _fetchCurrentQuests() {
  if (c6 === 2) {
    c6 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp7 === 3) {
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (1 === tmp8) {
          ...
          const found = quests2.filter((item) => closure_1_0(8031).isQuestWithKnownConfigVersion(item));
          closure_129_3 = found.map((item) => closure_1_0(8031).questWithUserStatusFromServer(item));
          ...
          closure_129_13 = excluded_quests.map((item) => closure_1_0(8031).excludedQuestFromServer(item));
          ...
          if (arg0 === 1) {
            ...
            if (null != questContentCTA.questContentCTA) {
              ...
              if (obj27.shouldMigrateToAdAnalyticsInterface(AdAnalyticsInterfaceExperiment.AdAnalyticsInterfaceExperimentStep.STEP_2_CLICKED_INTERNAL, "enroll_in_quest")) {
                ...
                const obj6 = { questId, questContent: tmp68.questContent, questContentCTA, questContentPosition: null, questContentRowIndex: null, sourceQuestContent: null };
...
let closure_23 = async function _claimQuestReward() {
  c7 = 0;
  c8 = 0;
  c6 = 0;
...
let closure_24 = async function _fetchQuestRewardCode() {
  c5 = 0;
  c6 = 0;
  c4 = 0;
  return (async (arg0) => {
...
let closure_25 = async function _dismissQuestContent() {
  c6 = 0;
  c7 = 0;
  c5 = 0;
  return (async (arg0, value) => {
...
let closure_28 = async function _resetQuestDismissibilityStatus(arg0) {
  closure_2 = tmp3;
  closure_129_0 = closure_0;
...
let closure_29 = async function _fetchClaimedQuests() {
  if (c5 === 2) {
    c5 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp6 === 3) {
...
let closure_31 = async function _fetchEarnedQuestToDeliver(arg0) {
  closure_0 = arg0;
  closure_2 = arg2;
  c8 = 0;
  c9 = 0;
          ...
          if (arg0 === 1) {
            ...
            if (!fetchingEarnedQuestToDeliverByPlacement.isFetchingEarnedQuestToDeliverByPlacement(content)) {
              ...
              const found = closure_0.filter((item) => {
                ...
                return !closure_0(8020).earnedDecisionIsValid(value);
              });
              closure_132_2 = found;
              if (0 !== found.length) {
                const _Date = Date;
...
let closure_32 = async function _updateVideoProgress() {
  c4 = 0;
  c3 = 0;
  return (async (arg0, value) => {
    if (c3 === 2) {
...
let closure_33 = async function _fetchVideoTranscript(arg0) {
  if (c7 === 2) {
    c7 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp6 === 3) {
...
let closure_37 = async function _fetchQuestHomeHero() {
  if (c7 === 2) {
    c7 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp7 === 3) {
...
let closure_38 = async function _fetchQuestHomeHeroPreview(arg0) {
  if (c8 === 2) {
    c8 = 3;
    throw new TypeError("Generator functions may not be called on executing generators");
  } else if (tmp7 === 3) {
...
const getVisibleGuildIdsMethod = fn(8053).getVisibleGuildIdsMethod;
const FetchStatus = fn(8026).FetchStatus;
const ORBS_INTRO_QUEST_ID = fn(5747).ORBS_INTRO_QUEST_ID;
const Constants = fn(1074);
({ AnalyticEvents: map1, Endpoints: closure_14 } = Constants);
let items = [fn(5750).QuestContent.QUEST_BAR, fn(5750).QuestContent.QUEST_BAR_V2, fn(5750).QuestContent.QUEST_BAR_MOBILE];
