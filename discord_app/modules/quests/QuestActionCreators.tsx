// === Module 10516: _manuallyStartConsoleQuest ===

// Module 10516 (_manuallyStartConsoleQuest)
import setDefault from "set" /* 687 */;
import dispatcherDefault from "dispatcher" /* 709 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import { getVisibleGuildIdsMethod } from "SidebarVisibilityMethodStore" /* 9542 */;
import closure_5 from "set" /* 5084 */;
import closure_6 from "handleConnectionInfoChange" /* 4569 */;
import closure_7 from "insertUnsortedGuilds" /* 5083 */;
import closure_8 from "initializeState" /* 7491 */;
import closure_9 from "_toPropertyKey" /* 7493 */;
import { FetchStatus } from "_toPropertyKey" /* 7493 */;
import { ORBS_INTRO_QUEST_ID } from "QuestsExperimentLocations" /* 6753 */;
      ...
      if (c8 === 2) {
        ...
        try {
          ...
          if (0 === c7) {
            ...
            c6 = 0;
            const tmp25 = new flag(body[11])(closure_5);
        ...
        try {
          ...
          if (0 === table) {
            if (arg0 === 1) {
              ...
              obj1[0] = closure_1_13.QUEST_ON_CONSOLE_STOP(callback);
              table = 1;
              c1 = 1;
      ...
      try {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            const HTTP = v0(closure_1_2[9]).HTTP;
            obj1 = { url: null, rejectWithError: false };
            obj1[0] = closure_1_13.QUESTS_RESET_RECENT_QUEST_COMPLETIONS;
            c1 = 1;
            v0 = 1;
            const obj2 = { value: null, done: false };
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            if (!closure_1_8.isFetchingCurrentQuests) {
              items = 0;
              quests = tmp71.quests;
              items = [];
              ...
              obj1 = { url: null, rejectWithError: false };
              obj1[0] = closure_1_13.QUESTS_CURRENT_QUESTS;
              c5 = 2;
              c6 = 1;
              const obj2 = { value: null, done: false };
        ...
        try {
          ...
          if (0 === body) {
            ...
            if (arg0 === 1) {
              ...
              obj6[0] = callback2(5232).post(obj2);
              return obj6;
            }
          } else {
            if (2 === tmp7) {
              ...
              const tmp29 = new callback2(4278)(c7);
              obj7[1] = tmp29;
              obj7[2] = callback;
              obj7[3] = callback2;
              obj4.dispatch(obj7);
          ...
          if (0 === c6) {
            if (arg0 === 1) {
              ...
              if (null != lib.questContentCTA) {
                ...
                obj27 = callback(closure_1_2[19]);
              }
              if (callback === closure_1_11) {
                let obj9 = callback(closure_1_2[24]);
                const result1 = obj9.dismissOrbsOnboardingExperience();
              }
              if (closure_1_8.isEnrolling(callback)) {
                const obj3 = { type: null };
                obj3[0] = closure_1_19.PREVIOUS_IN_FLIGHT_REQUEST;
                c7 = 3;
            ...
            const obj23 = lib(709);
            obj12[1] = callback(7498).questUserStatusFromServer(lib.body);
      ...
      if (claimingReward === 2) {
        ...
        try {
          ...
          if (0 === c7) {
            ...
            const tmp35 = new lib(closure_2[11])(closure_3);
            obj5[1] = tmp35;
            obj5[2] = callback;
            obj5.dispatch(obj5);
            throw closure_3;
        ...
        try {
          ...
          if (0 === c5) {
            if (arg0 === 1) {
              ...
              let lib = tmp7;
              lib = undefined;
              if (closure_1_8.isFetchingRewardCode(callback)) {
                c6 = 3;
              } else {
            ...
            const tmp28 = new lib(4278)(dependencyMap);
            obj4[1] = tmp28;
            obj4[2] = callback;
            obj4.dispatch(obj4);
            throw dependencyMap;
        ...
        try {
          ...
          if (0 === c6) {
            if (arg0 === 1) {
              ...
              dependencyMap = tmp7;
              let lib;
              const isDismissingContentResult = closure_1_8.isDismissingContent(callback);
            ...
            if (1 === tmp7) {
              ...
              const tmp27 = new lib(4278)(dependencyMap);
              obj5[1] = tmp27;
              obj5[2] = callback;
              obj4.dispatch(obj5);
            } else if (arg0 === 1) {
        ...
        try {
          ...
          if (0 === c6) {
            ...
            if (2 === tmp7) {
              ...
              const tmp27 = new num7(body[11])(closure_3);
              obj5[1] = tmp27;
              obj5[2] = callback;
              obj4.dispatch(obj5);
              c7 = 3;
...
function _resetQuestPreviewStatus() {
  ...
  const tmp = callback((arg0) => {
    ...
    return (function*(arg0) {
      ...
      obj1[0] = closure_1_13.QUESTS_PREVIEW_STATUS(callback);
      obj1[1] = {};
      yield HTTP.del(obj1);
      if (1 === tmp7) {
        c4 = 0;
...
function _resetQuestDismissibilityStatus() {
  ...
  const tmp = callback((arg0) => {
    ...
    return (function*(arg0) {
      dependencyMap = tmp3;
      c4 = 1;
      closure_1_1(closure_1_2[10]).dispatch({ type: "QUESTS_DOCK_RESET_SOFT_DISMISSAL" });
      const HTTP = callback(closure_1_2[9]).HTTP;
      obj1 = { url: null, body: null, rejectWithError: false };
      obj1[0] = closure_1_13.QUESTS_PREVIEW_DISMISSIBILITY(callback);
      obj1[1] = {};
      yield HTTP.del(obj1);
      if (1 === tmp7) {
        c4 = 0;
      ...
      try {
        ...
        if (0 === c4) {
          if (arg0 === 1) {
            ...
            closure_0 = tmp7;
            closure_0 = undefined;
            if (!closure_1_8.isFetchingClaimedQuests) {
              let obj5 = closure_1_1(closure_1_2[10]);
              obj5.dispatch({ type: "QUESTS_FETCH_CLAIMED_QUESTS_BEGIN" });
              c3 = 1;
              const HTTP = closure_1_0(closure_1_2[9]).HTTP;
              obj1 = { url: null, rejectWithError: false };
              obj1[0] = closure_1_13.QUESTS_CLAIMED_QUESTS;
              c4 = 2;
              c5 = 1;
              const obj2 = { value: null, done: false };
              obj2[0] = HTTP.get(obj1);
          ...
          if (1 === tmp7) {
            ...
            const tmp25 = new callback(4278)(callback);
            obj3[1] = tmp25;
            obj3.dispatch(obj3);
          } else if (arg0 === 1) {
            c5 = 3;
          ...
          try {
            ...
            if (0 === c7) {
              ...
              if (1 === tmp8) {
                ...
                throwTypeErrorResult = Object.assign(callback2(7469)());
                ...
                throwTypeErrorResult = new.target;
                const obj24 = new callback2(4278)(message);
                ...
                throwTypeErrorResult = new.target;
                throwTypeErrorResult = new.target;
                throwTypeErrorResult = new callback2(4278)(message);
                ...
                if (arg0 === 1) {
                  ...
                  throwTypeErrorResult = callback;
                  throwTypeErrorResult = dependencyMap;
                  const LessPersonalizedAdsExperiment = callback(10522).LessPersonalizedAdsExperiment;
                ...
                if (creative_type !== callback(7507).AdCreativeType.BOUNTY) {
                  creative = body.creative;
                } else {
                  const BountiesMobileQuestBarExperiment = callback(10523).BountiesMobileQuestBarExperiment;
                  creative = null;
                }
                obj16 = null;
                if (null != creative) {
                  creative_type = creative.creative_type;
                  if (callback(7507).AdCreativeType.QUEST === creative_type) {
                    obj = callback(7498);
                    user = obj.questConfigFromServer(creative.creative_content);
                    const obj14 = { type: null, questId: null };
                    obj14[0] = callback(7507).AdCreativeType.QUEST;
                    obj14[1] = user.id;
                    obj16 = obj14;
                  } else {
                    throwTypeErrorResult = lib;
                    throwTypeErrorResult = callback;
                    throwTypeErrorResult = dependencyMap;
                    if (callback(7507).AdCreativeType.BOUNTY === creative_type) {
                      throwTypeErrorResult = closure_3;
                      throwTypeErrorResult = lib;
                      throwTypeErrorResult = callback;
                      throwTypeErrorResult = dependencyMap;
                      throwTypeErrorResult = creative;
                      closure_16 = callback(10524).bountyFromServer(creative.creative_content);
                      const obj15 = { type: null, bounty: null };
                      throwTypeErrorResult = callback;
                      throwTypeErrorResult = dependencyMap;
                      obj15[0] = callback(7507).AdCreativeType.BOUNTY;
                      throwTypeErrorResult = closure_16;
                      obj15[1] = closure_16;
                      obj16 = obj15;
                      const obj32 = callback(10524);
                    }
                  }
                } else {
                  throwTypeErrorResult = closure_3;
                  ...
                  if (null != quest) {
                    ...
                    throwTypeErrorResult = dependencyMap;
                    throwTypeErrorResult = quest;
                    user = callback(7498).questConfigFromServer(quest);
                    obj16 = { type: null, questId: null };
                    throwTypeErrorResult = callback;
                    throwTypeErrorResult = dependencyMap;
                    obj16[0] = callback(7507).AdCreativeType.QUEST;
                    throwTypeErrorResult = user;
                    obj16[1] = user.id;
                    const obj30 = callback(7498);
                  }
                }
                obj2 = callback2(709);
                ...
                if (null != user) {
                  ...
                  throwTypeErrorResult = callback;
                  throwTypeErrorResult = dependencyMap;
                  if (callback === callback(6756).AdPlacement.DESKTOP_ACCOUNT_PANEL_AREA) {
                    obj7 = callback2(10539);
                    obj7.startTracking(user.id);
                  }
                  obj8 = callback2(698);
                  const obj20 = {};
                  const merged = Object.assign(callback2(7469)());
          ...
          if (0 === response_ttl_seconds) {
            if (arg0 === 1) {
              ...
              if (!fetchingEarnedQuestToDeliverByPlacement.isFetchingEarnedQuestToDeliverByPlacement(prop)) {
                ...
                if (0 !== found.length) {
                  const _Date = Date;
                  c3 = Date.now();
                  const result = callback2(10541).recordEarnedRequestAttempt(tmp74, tmp75);
                  const obj16 = callback2(10541);
                  ...
                  c9 = 1;
                  const obj2 = { value: null, done: false };
                  obj2[0] = callback(5059).getSession();
                  return obj2;
                }
              }
              arr2 = callback;
            ...
            if (1 === tmp8) {
              ...
              if (arg0 === 1) {
                ...
                obj6[0] = closure_13.QUEST_EARNED_DECISION(closure_5, callback, uuid);
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              let obj4 = lib(closure_1_2[16]);
              obj1 = { url: null, body: null, trackedActionData: null, rejectWithError: false };
              obj1[0] = closure_1_13.QUESTS_VIDEO_PROGRESS(callback);
              const obj2 = { timestamp: null };
              obj2[0] = lib;
              obj1[1] = obj2;
              const obj3 = { event: null, properties: null };
              obj3[0] = callback(closure_1_2[17]).NetworkActionNames.QUEST_VIDEO_PROGRESS;
          ...
          if (0 === c6) {
            ...
            if (1 === tmp7) {
              if (arg0 === 1) {
                ...
                const obj15 = lib(questAsset[37]);
                questAsset = obj15.getQuestAsset(lib, lib(questAsset[37]).QuestAssetType.VIDEO_PLAYER_TRANSCRIPT, undefined, flag);
                if (null != questAsset) {
        ...
        try {
          ...
          if (0 === c5) {
            if (arg0 === 1) {
              ...
              let lib = tmp7;
              lib = undefined;
              if (closure_1_8.isFetchingQuestPreview(callback)) {
                c6 = 3;
              } else {
                let obj6 = closure_1_1(closure_1_2[10]);
        ...
        try {
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              creative_type = undefined;
              closure_5 = undefined;
              QUEST_HOME_BANNER_DESKTOP = callback(closure_1_2[12]).AdPlacement.QUEST_HOME_BANNER_DESKTOP;
              const _Date = Date;
              callback2 = Date.now();
              obj1 = { type: "QUESTS_FETCH_QUEST_HOME_HERO_BEGIN", placement: null };
              obj1[1] = QUEST_HOME_BANNER_DESKTOP;
              ...
              const _HermesInternal = HermesInternal;
              obj2[0] = "" + closure_1_13.QUESTS_CREATIVE_PREVIEW + "?" + str5.toString();
              c7 = 2;
              c8 = 1;
              const obj3 = { value: null, done: false };
              obj3[0] = HTTP.get(obj2);
            ...
            if (tmp16) {
              obj = QUEST_HOME_BANNER_DESKTOP(body[39]);
...
export const fetchQuestToDeliver = function fetchQuestToDeliver(QUEST_HOME_BANNER_DESKTOP, arg1) {
  const self = this;
