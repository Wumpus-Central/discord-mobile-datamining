...
import QuestType from "QuestType" /* 7829 */;
...
function _getQuestsInstructionsToWinReward(arg0) {
  ...
  if (isSponsoredPlayQuestResult) {
    ...
    if (withoutMarkdown) {
      ...
      obj = { quest, sourceQuestContent, applications: null, popoutTargetElementRef: null, onGameSheetOpened: null, onGameSheetClosed: null };
    ...
    if (!result) {
      if (null == collectibleQuestRewardDuration) {
        ...
        obj2 = { gameTitle: quest.config.messages.gameTitle, streamingDurationRequirement: targetMinutes3, rewardNameWithArticle: defaultRewardNameWithArticle, duration: collectibleQuestRewardDuration, targetMinutes: targetMinutes3, onGameTitleClick };
    ...
    if (v1votF6Result6.isConsoleQuest(quest)) {
      ...
      if (!result2) {
        if (null == collectibleQuestRewardDuration) {
          ...
          obj3 = { gameTitle: quest.config.messages.gameTitle, targetMinutes: targetMinutes2, rewardNameWithArticle: defaultRewardNameWithArticle, duration: collectibleQuestRewardDuration, streamingDurationRequirement: targetMinutes2, onGameTitleClick };
      ...
      if (v1votF6Result9.shouldUsePlayOnDesktopTask(quest)) {
        ...
        if (!result3) {
          if (null == collectibleQuestRewardDuration) {
            ...
            const obj4 = { gameTitle: quest.config.messages.gameTitle, streamingDurationRequirement: taskDetails.targetMinutes, rewardNameWithArticle: defaultRewardNameWithArticle, duration: collectibleQuestRewardDuration, questReward: defaultRewardNameWithArticle, onGameTitleClick };
        ...
        if (v1votF6Result12.isTieredRewardCodeQuest(obj5)) {
          ...
          const obj6 = { gameTitle: quest.config.messages.gameTitle, streamingDurationRequirement: taskDetails.targetMinutes, onGameTitleClick };
          ...
          if (hasWatchVideoTasksResult) {
            ...
            if (!result5) {
              ...
              const obj7 = { videoTitle: str, rewardNameWithArticle: defaultRewardNameWithArticle, duration: collectibleQuestRewardDuration };
            ...
            if (!v1votF6Result17.isPlayAnyActivityQuest(quest)) {
              ...
              if (features.includes(constants2.CLOUD_GAMING_ACTIVITY)) {
                ...
                if (features2.includes(constants2.CLOUD_GAMING_PROVIDER_NVIDIA)) {
                  ...
                  const obj8 = { activityName: quest.config.messages.gameTitle, providerName: "NVIDIA GeForce NOW", providerLink: HelpdeskUtilsDefault.getArticleURL(HelpdeskArticles.NVIDIA_GEFORCE_CLOUD_GAMING_QUEST), streamingDurationRequirement: targetMinutes, questReward: defaultRewardNameWithArticle };
              ...
              const obj9 = { activityName: quest.config.messages.gameTitle, streamingDurationRequirement: targetMinutes, questReward: defaultRewardNameWithArticle };
                ...
                if (needsToConnect) {
                  ...
                  if (!result6) {
                    if (null == collectibleQuestRewardDuration) {
                      ...
                      const obj11 = { gameTitle: quest.config.messages.gameTitle, objective: thirdPartyTaskDetails.description, duration: collectibleQuestRewardDuration, questReward: defaultRewardNameWithArticle, onGameTitleClick };
            ...
            if (null != thirdPartyTaskDetails) {
              ...
              if (!result7) {
                if (null == collectibleQuestRewardDuration) {
                  ...
                  const obj12 = { gameTitle: quest.config.messages.gameTitle, streamingDurationRequirement: taskDetails.targetMinutes, duration: collectibleQuestRewardDuration, questReward: defaultRewardNameWithArticle, onGameTitleClick };
  ...
  const v1votF6Result2 = QuestRewardUtils;
}
...
export const useQuestInstructionTitle = function useQuestInstructionTitle(quest, arg1, questContent, sourceQuestContent) {
  ...
  if (obj5.isConsoleQuest(quest)) {
    ...
    if (!tmpResult.hasPlayOnDesktopTask(obj)) {
      ...
      return intl.format(util.t["l4S+cQ"], obj1);
    }
  }
  ...
  if (tmpResult.isConsoleQuest(quest)) {
    ...
    const intl6 = util.intl;
    obj4 = { targetMinutes };
    return intl6.format(util.t.Hu8SKW, obj4);
  } else {
    if (tmpResult1.hasWatchVideoTasks(quest)) {
      ...
      if (null == videoTitle) {
        const intl5 = util.intl;
        let stringResult = intl5.string(util.t["o+e9yh"]);
      } else {
        const intl4 = util.intl;
        obj5 = { videoTitle };
        stringResult = intl4.formatToPlainString(util.t["9m9Mna"], obj5);
      }
      return stringResult;
      ...
      if (tmpResult3.hasPlayActivityTask(quest)) {
        const result = utils_QuestUtils.isPlayAnyActivityQuest(quest);
        const intl3 = util.intl;
        ...
        if (!tmpResult5.hasPlayOnDesktopTask(obj8)) {
          ...
          return intl2.format(util.t["6zWtV8"], obj9);
        } else {
          const features = quest.config.features;
          const hasItem = features.includes(constants2.NON_GAMING_PLAY_QUEST);
          const t = util.t;
        }
        tmpResult5 = QuestTaskUtils;
      }
      tmpResult3 = QuestTaskUtils;
    }
    tmpResult1 = QuestTaskUtils;
  }
};
...
export const useQuestDescription = function useQuestDescription(quest, sourceQuestContent, QUEST_HOME_MOBILE, QuestHome, popoutTargetElementRef) {
  let obj = { quest, taskDetails: hooks_QuestHooks.useQuestTaskDetails(quest), location: QUEST_HOME_MOBILE, sourceQuestContent, popoutTargetElementRef, gameProfileSource: QuestHome };
  ...
  if (tmp5) {
    const intl = util.intl;
    obj = { claimDate: tmp7 };
    formatToPlainStringResult = intl.formatToPlainString(util.t.lOVr0O, obj);
  }
...
export const useQuestBarSubtitle = function useQuestBarSubtitle(arg0) {
  ...
  let tmpResult = hooks_QuestHooks;
  ...
  if (tmp8) {
    ...
    return intl9.formatToPlainString(util.t.APddvF, obj);
  } else {
    tmpResult = QuestTaskUtils;
    if (tmpResult.hasAchievementInGameTask(quest)) {
      if (false === hasAlreadyLinked) {
        const intl8 = util.intl;
        return intl8.string(util.t.mAdqf7);
      }
    }
      ...
      if (tmpResult1.hasAchievementInGameTask(quest)) {
        if (true === hasAlreadyLinked) {
          ...
          if (null != onClickGameTitle) {
            ...
            let formatResult = intl7.format(util.t.X8hBDz, obj1);
          } else {
            const intl6 = util.intl;
            obj2 = { gameTitle };
            formatResult = intl6.format(util.t.u3mdpP, obj2);
          }
          return formatResult;
        }
      }
        ...
        if (tmpResult2.isSponsoredPlayQuest(quest)) {
          if (tmp10) {
            if (!tmp11) {
              ...
              return intl5.format(util.t["1votF6"], obj3);
            }
          }
        }
        tmpResult2 = utils_QuestUtils;
      }
      return tmp13;
    } else {
      if (tmpResult1.hasWatchVideoTasks(quest)) {
        const intl4 = util.intl;
        let stringResult = intl4.string(util.t["o+e9yh"]);
      } else if (tmp14 > 0) {
        if (!tmpResult4.hasAchievementInGameTask(quest)) {
          if (isQuestProgressing) {
            const obj4 = { quest, taskDetails: questTaskDetails, thirdPartyTaskDetails };
            let contextualEntrypointHeading = QuestCopyUtils.getContextualEntrypointHeading(obj4);
            const tmpResult5 = QuestCopyUtils;
          } else {
            const intl2 = util.intl;
            contextualEntrypointHeading = intl2.string(util.t.mOrpXG);
          }
        }
        const intl3 = util.intl;
        contextualEntrypointHeading = intl3.string(util.t.JkyCIO);
        tmpResult4 = QuestTaskUtils;
      } else {
        const intl = util.intl;
        stringResult = intl.string(util.t.S6UUc5);
      }
      return stringResult;
    }
  }
...
export const useQuestBarTitle = function useQuestBarTitle(questDockQuest, arg1) {
  ...
  if (null != completedAt) {
    const intl6 = util.intl;
    return intl6.string(util.t["ij5E/5"]);
  } else {
    let tmpResult = QuestTaskUtils;
    if (tmpResult.hasAchievementInGameTask(questDockQuest)) {
      if (false === arg1) {
        const intl5 = util.intl;
        return intl5.string(util.t.s9r2a1);
      }
    }
    tmpResult = QuestTaskUtils;
    if (tmpResult.hasAchievementInGameTask(questDockQuest)) {
      if (true === arg1) {
        if (0 === tmp7) {
          const intl4 = util.intl;
          return intl4.string(util.t["2+opCy"]);
        }
      }
    }
    ...
    if (null != enrolledAt) {
      if (tmp7 > 0) {
        const tmpResult1 = NumberUtils;
        const intl3 = util.intl;
        obj = { percent: NumberUtils.formatPercent(stateFromStores, tmp7, { roundingMode: "floor" }) };
        return intl3.formatToPlainString(util.t.lVZaXD, obj);
      }
    }
    if (_slicedToArray(obj3.useTaskPlatformScreen(questDockQuest, questTaskDetails), 1)[0] === QuestTypes.TaskPlatformScreen.SELECT) {
      const intl2 = util.intl;
      let stringResult = intl2.string(util.t.EMrUHQ);
    } else {
      ...
      isConsoleQuestResult = QuestTaskUtils.isConsoleQuest(questDockQuest);
    }
    return stringResult;
  }
};
export const usePrimaryCtaCopy = function usePrimaryCtaCopy(arg0) {
  ...
  const memo = noop.useMemo(() => {
    ...
    if (!obj.isConsoleQuest(quest)) {
      let tmp2Result = QuestTaskUtils;
      if (!tmp2Result.hasPlayActivityTask(quest)) {
        tmp2Result = QuestTaskUtils;
        obj = { quest };
        if (tmp2Result.hasStreamOnDesktopTask(obj)) {
          ...
          if (tmp2Result1.hasWatchVideoOnMobileTasks(quest)) {
            ...
            PLAY = QuestTaskUtils.isInGameQuest(quest) ? constants.IN_GAME : constants.PLAY;
            const tmp2Result2 = QuestTaskUtils;
          }
          tmp2Result1 = QuestTaskUtils;
        }
      }
      return PLAY;
    }
  ...
  if (constants3.PLAY === memo) {
    ...
    return intl4.string(quest(1114).t.l7E81v);
...
export const getRewardCodeRedemptionInstructions = function getRewardCodeRedemptionInstructions(arg0) {
  ...
  if (platform == null) {
    platform = QuestTypes.QuestRewardCodePlatforms.CROSS_PLATFORM;
  }
...
export const useModalCtaConfig = function useModalCtaConfig(quest) {
  ...
  noop = async function _defaultOnClickCta() {
    if (dependencyMap === 2) {
      dependencyMap = 3;
      ...
      try {
        ...
        if (0 === c1) {
          ...
          const obj2 = { content: closure_128_1, ctaContent: tmp4(7830).QuestContentCTA.OPEN_GAME_LINK, impressionId: null, sourceQuestContent: null };
          let tmp5;
          ...
          tmp4(11629).openGameLinkDirectly(closure_128_0, obj2);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp11) {
  ...
  const memo = noop.useMemo(() => {
    ...
    if (null != subtitle) {
      ...
      if (obj3.hasAchievementInGameTask(messages)) {
        ...
        let tmp5Result = utils_QuestUtils;
        ...
        if (questType === QuestType.QuestType.GAMEPLAY) {
          ...
          if (!features.includes(constants2.NON_GAMING_PLAY_QUEST)) {
            tmp5Result = utils_QuestUtils;
            if (!tmp5Result.isSponsoredPlayQuest(messages)) {
              const intl = util.intl;
              taskTitle = intl.string(util.t["wirwN+"]);
            }
          }
        }
        const intl2 = util.intl;
        taskTitle = intl2.string(util.t.y8Xf3k);
      }
      obj3 = QuestTaskUtils;
    }
  }, items);
