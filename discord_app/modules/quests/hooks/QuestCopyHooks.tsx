...
import QuestType from "QuestType" /* 7135 */;
...
import useInGameQuestConnectState from "useInGameQuestConnectState" /* 10739 */;
...
const utils_QuestUtils = v1votF6(7130);
const SponsoredQuestUtils = v1votF6(10738);
require = fn;
...
export const usePrimaryCtaCopy = function usePrimaryCtaCopy(arg0) {
  ...
  if (constants3.PLAY === memo) {
    ...
    return quest(10723).getVideoQuestWatchCtaText(tmp5);
...
export const useModalCtaConfig = function useModalCtaConfig(quest) {
    ...
    if (dependencyMap === 2) {
      ...
      try {
        ...
        if (0 === c1) {
          ...
          const obj6 = { content: closure_128_1, ctaContent: tmp4(7136).QuestContentCTA.OPEN_GAME_LINK, impressionId: null, sourceQuestContent: null };
          let tmp5;
          ...
          tmp4(10706).openGameLinkDirectly(closure_128_0, obj6);
          dependencyMap = 3;
          return { value: "HermesInternal", done: null };
        }
      } catch (tmp11) {
  ...
  obj.ctaText = quest(10686).getExternalCtaLabel(quest);
