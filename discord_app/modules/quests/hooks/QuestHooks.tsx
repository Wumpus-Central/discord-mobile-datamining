...
function useQuests(arg0) {
  ...
  const stateFromStoresObject = obj(586).useStateFromStoresObject(items2, () => ({
  ...
  const items8 = [
    obj2.useMemo(() => {
      ...
      const withResult1 = match
        .with(obj, () => callback(5398).TaskPlatformScreen.CONSOLE)
        .with(obj, () => callback(5398).TaskPlatformScreen.DESKTOP);
      ...
      const withResult2 = match
        ...
        .with(
          ...
          () => callback(5398).TaskPlatformScreen.CONSOLE,
        );
      const obj3 = {
      ...
      const withResult3 = match
        ...
        .with(
          ...
          () => callback(5398).TaskPlatformScreen.DESKTOP,
        );
      const obj4 = {
        currentProgressingPlatform: null,
        lastPlatformProgress: null,
...
export const useConnectedConsoleLinkOnClick = function useConnectedConsoleLinkOnClick(quest) {
  ...
  const stateFromStoresObject = accounts(586).useStateFromStoresObject(items, () => ({
...
export const useQuestHowToHelpArticle = function useQuestHowToHelpArticle() {
  ...
  const formatResult = intl.format(accounts(1233).t.beN4DG, {
  ...
  if (tmp12) {
    if (!hasItem) {
      hasItem =
        ...
        callback(useTaskPlatformScreen(userStatus, tmp4), 1)[0] === tmp8(5398).TaskPlatformScreen.DESKTOP;
      const tmp16 =
        0 === tmp4.percentComplete &&
        callback(useTaskPlatformScreen(userStatus, tmp4), 1)[0] === tmp8(5398).TaskPlatformScreen.DESKTOP;
    }
