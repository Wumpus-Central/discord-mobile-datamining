            ...
            if (arg0 === 1) {
              ...
              if (null != closure_0) {
                if (arr.length > 0) {
                  c1 = 3;
                  v3 = 1;
                  const obj1 = { value: previewAdCreativeIds(11596).fetchBountyPreview(arr, c3), done: false };
                  return obj1;
                }
              }
              let obj2 = previewAdCreativeIds(11596);
              c1 = 2;
              v3 = 1;
