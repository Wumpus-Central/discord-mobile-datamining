  ...
  const items8 = [
    obj2.useMemo(() => {
      ...
      const withResult1 = match
        .with(obj, () => quest(5461).TaskPlatformScreen.CONSOLE)
        .with(obj, () => quest(5461).TaskPlatformScreen.DESKTOP);
      ...
      const withResult2 = match
        ...
        .with(
          ...
          () => quest(5461).TaskPlatformScreen.CONSOLE,
        );
      const obj3 = {
      ...
      const withResult3 = match
        ...
        .with(
          ...
          () => quest(5461).TaskPlatformScreen.DESKTOP,
        );
      const obj4 = {
        currentProgressingPlatform: null,
        lastPlatformProgress: null,
    ...
    if (tmp17) {
      if (!hasItem) {
        hasItem =
          ...
          _slicedToArray(useTaskPlatformScreen(userStatus, tmp5), 1)[0] === tmp11(5461).TaskPlatformScreen.DESKTOP;
        const tmp21 =
          0 === tmp5.percentComplete &&
          _slicedToArray(useTaskPlatformScreen(userStatus, tmp5), 1)[0] === tmp11(5461).TaskPlatformScreen.DESKTOP;
      }
