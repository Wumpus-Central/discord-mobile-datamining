...
import set2 from "../BountyStore.tsx";
...
function useIsQuestProgressing(quest) {
  ...
  obj = initialize;
  const items2 = [closure_12];
  const items3 = [quest, require("../../../../discord_common/js/packages/flux/index.tsx").useStateFromStores(items2, () => closure_1_12.getOptimisticProgress(quest.id, quest(dependencyMap[31]).FirstPartyQuestTaskTypes.WATCH_VIDEO))];
...
export const useIsQuestProgressingVideoQuest = function useIsQuestProgressingVideoQuest(arg0) {
  const _require = arg0;
  const items = [closure_12];
  const items1 = [arg0, require("../../../../discord_common/js/packages/flux/index.tsx").useStateFromStores(items, () => closure_1_12.getOptimisticProgress(quest.id, quest(dependencyMap[31]).FirstPartyQuestTaskTypes.WATCH_VIDEO))];
