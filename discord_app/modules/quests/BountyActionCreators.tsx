...
import SessionAdGenerator from "../analytics_sessions/SessionAdGenerator.tsx";
...
let closure_11 = async function _fetchBountiesAndDispatch(arg0) {
  ...
  if (1 === tmp8) {
      ...
      if (null != creative.creative) {
        if (creative.creative.creative_type === closure_0(request_id[8]).AdCreativeType.BOUNTY) {
          ...
          const result = closure_1_3.set(
            ...
            closure_0(request_id[10]).questAdDecisionFromAdDecision(creative, obj),
          );
    ...
    closure_131_1(closure_131_2[7]).dispatch({
      type: "BOUNTIES_FETCH_QUEST_HOME_BOUNTIES_SUCCESS",
      bounties: closure_130_4,
      placement: closure_130_0,
      adDecisionsByAdCreativeId: closure_130_3,
      fetchedAt: closure_130_1,
    });
    c5 = 0;
    closure_131_1(closure_131_2[7]);
    new Map();
        ...
        if (arg0 === 1) {
          ...
          if (obj16.isDismissible(closure_1)) {
            if (!dismissingContent.isDismissingContent(adCreativeId)) {
              ...
              const adTrafficMetadataSealed = QuestDataUtils.getAdTrafficMetadataSealed(
                closure_1,
                undefined,
                adCreativeId,
              );
              ...
              const obj7 = {
                decision_metadata_sealed: tmp42,
                traffic_metadata_sealed: null,
                placement: null,
      ...
      try {
        ...
        if (0 === c4) {
          if (arg0 === 1) {
            ...
            const HTTP = HTTPUtils.HTTP;
            const request = {
              url: Endpoints.ADS_CREATIVES_PREVIEW_DELIVERY_STATE(closure_0),
              query: null,
              rejectWithError: false,
            };
            if (null != placement) {
      ...
      try {
        ...
        if (0 === c2) {
          if (arg0 === 1) {
            ...
            const HTTP = HTTPUtils.HTTP;
            const request = {
              url: constants.ADS_CREATIVES_PREVIEW_DELIVERY_STATE_LOOKBACK,
              query: null,
              rejectWithError: false,
            };
