...
function CodeFieldInner(loading) {
  ...
  const items1 = [callback2(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj), callback2(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, { style: tmp2.subtitle, variant: "text-sm/medium", color: "text-default", children: description }), , ];
  ...
  items1[3] = actions;
  obj[1] = items1;
  const items2 = [callback3(closure_5, obj), callback2(require("../../keyboard/native/KeyboardAwareView.tsx"), { children: footer })];
  obj[4] = items2;
...
export default function CodeField(disableKeyboardAvoidingView) {
  if (disableKeyboardAvoidingView.disableKeyboardAvoidingView) {
    ...
    tmp2Result = tmp2(require("../../keyboard/native/KeyboardAwareView.tsx"), obj);
    const tmp5 = require("../../keyboard/native/KeyboardAwareView.tsx");
  }
  return tmp2Result;
};
