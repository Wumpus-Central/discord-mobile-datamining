      ...
      if (null == closure_130_1) {
        ...
        if (closure_131_11(closure_130_1)) {
          if (closure_131_12.VIBEGRATIONS === closure_130_1) {
            ...
            c5 = 3;
            let obj8 = { value: closure_131_0(closure_131_2[13]).canReviewGuildMemberApplications(closure_130_0), done: true };
            return obj8;
          } else if (closure_131_12.GUILD_HOME === tmp31) {
            let obj20 = closure_131_0(closure_131_2[14]);
            c5 = 3;
            return { value: obj20.canSeeOnboardingHome(closure_130_0), done: true };
            ...
            c5 = 3;
            return { value: obj15.canAccessMemberSafetyPage(closure_130_0), done: true };
            ...
            c5 = 3;
            return { value: obj10.isGuildOfficialMessagesEnabled(guild, "isAccessibleChannelOrThreadPath"), done: true };
          } else if (closure_131_12.GUILD_SPACE === tmp31) {
            obj8 = closure_131_0(closure_131_2[19]);
            c5 = 3;
            return { value: obj8.canUseGuildSpace(guild, "isAccessibleChannelOrThreadPath"), done: true };
          } else {
        ...
        if (!tmp15) {
          ...
          c4 = 2;
          c5 = 1;
          return { value: obj4.loadThread(closure_130_1), done: false };
        }
      }
    }
  } else {
