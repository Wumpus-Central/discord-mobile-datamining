          ...
          closure_131_4 = function openInBrowser() {
            if (null != obj.sanitizeUrl(closure_1_0)) {
              ...
              if (constants.IN_APP === SAFARI) {
                const result = closure_0(4720).browserManagerOpenUrl(closure_1_0, constants.IN_APP);
                result.catch(() => {
                  const intl = closure_2_0(1115).intl;
                  closure_2_0(4453).presentFailedToast(
                ...
                const result1 = closure_0(4720).browserManagerOpenUrl(closure_1_0, constants.CHROME);
                result1.catch(() => {
                  const intl = closure_2_0(1115).intl;
                  closure_2_0(4453).presentFailedToast(
                    "" + intl.string(closure_2_0(1115).t.HryVrx) + " " + closure_1_0,
                ...
                const result2 = closure_0(4720).browserManagerOpenUrl(closure_1_0, constants.SAFARI);
