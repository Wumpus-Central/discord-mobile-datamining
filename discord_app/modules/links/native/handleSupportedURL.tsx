              ...
              if (tmp.ACCOUNT_STANDING === type) {
                ...
                pathname(() => {
                  if (null != payload.questId) {
                    let obj = { questId: arr.questId, event: constants.QUEST_SHARE_LINK_DEEP_LINKED_INTO_MOBILE_CLIENT, sourceQuestContent: QuestContent.QuestContent.QUEST_EMBED_MOBILE, properties: null };
