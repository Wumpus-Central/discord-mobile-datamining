...
import { OAUTH2_AUTHORIZE_MODAL_KEY as closure_21 } from "../../oauth2/native/Constants.tsx";
import { FAMILY_CENTER_LINK_REQUEST_REGEX as closure_22 } from "../../parent_tools/FamilyCenterConstants.tsx";
import { MobileWebRedirectCheckoutDeepLinkActions as closure_23 } from "../../payments/PaymentConstants.tsx";
    ...
    if (result.CHANNEL !== type) {
      if (result.MESSAGE !== type) {
        if (result.SESSION_MANAGEMENT === type) {
          ...
          result = rootNavigationRef1(inviteCode[17]).pushLazy(
            ...
            if (result.SEND_VOICE_HANGOUT_WAVE !== type) {
              if (result.ACCOUNT_STANDING === type) {
                ...
                addPostConnectionCallback(() => {
                  ...
                  obj = {
                    gameId,
                    source: payload(inviteCode[78]).GameProfileSources.Deeplink,
