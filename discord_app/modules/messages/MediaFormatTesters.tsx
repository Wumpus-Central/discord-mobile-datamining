...
function isWebPlayerVideoUrl(mediaUrl) {
  let isIOSWithWebMResult = require("WebViewWebmSupportTest.native.tsx") /* isIOSWithWebM */.isIOSWithWebM();
...
function isWebPlayerVideoFile(filename) {
  ...
  if (isIOSWithWebMResult) {
    isIOSWithWebMResult = require("WebViewWebmSupportTest.native.tsx") /* isIOSWithWebM */.isIOSWithWebM();
    const obj = require("WebViewWebmSupportTest.native.tsx") /* isIOSWithWebM */;
  }
  if (isIOSWithWebMResult) {
...
export const isVideoUrl = function isVideoUrl(url) {
  ...
  if (!flag) {
    ...
    const obj2 = require("WebViewWebmSupportTest.native.tsx") /* isIOSWithWebM */;
  }
  return flag;
};
