// === Module 11462: isNewMessageGroup ===
              ...
              if (!tmp11) {
                ...
                if (!tmp13) {
                  ...
                  if (tmp16) {
                    ...
                    if (isSameDayResult) {
                      const isWithinIntervalResult = tmp18(4132).isWithinInterval(content.timestamp, type.timestamp, closure_6);
