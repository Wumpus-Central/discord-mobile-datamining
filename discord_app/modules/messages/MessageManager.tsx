      ...
      if (type !== constants.GUILD_STORE) {
        ...
        if (null == type1) {
          ...
          if (isPreload) {
            ...
            if (flag) {
              tmp9(4989).commit(obj10.mutate({ loadingMore: true }));
              if (null == messageId) {
                let isThreadResult;
                if (channel != null) {
                ...
                obj5[1] = tmp11(9746).getMessageLimit("MessageManager.initialFetch");
                obj5[2] = isPreload;
                obj5[3] = skipLocalFetch;
                const obj6 = { jumpType: null };
                obj6[0] = tmp11(4235).JumpType.ANIMATED;
                obj5[4] = obj6;
