          ...
          if (id.author.id !== AuthenticationStore.getId()) {
            ...
            if (null == id.activity) {
              ...
              if (!tmpResult.hasFlag(num, tmp(11954).ChannelRecipientPrivateUserDataFlags.DISMISSED_IN_GAME_MESSAGE_NUX)) {
                tmp4 = null;
                if (!obj.has(id2.id)) {
                  obj = { channelId: id2.id, type: constants3.IN_GAME_MESSAGE_NUX, content: "", author: id.author, flags: tmp3.EPHEMERAL, state: constants2.SENT };
                  tmpResult = tmp(4783);
                  ...
                  const result1 = tmp6(11955).updatePrivateChannelRecipientFlags(id2.id, setFlagResult);
                  tmp4 = messageRecord1;
