...
import ChannelRecipientPrivateUserDataFlags from "ChannelRecipientPrivateUserDataFlags" /* 12047 */;
import PrivateChannelRecipientActionCreatorsDefault from "PrivateChannelRecipientActionCreators" /* 12048 */;
...
export const tryCreateInjectedMessage = function tryCreateInjectedMessage(id, id2) {
  ...
  if (map.get(id2.id) === id.id) {
    obj = { channelId: id2.id, type: constants3.IN_GAME_MESSAGE_NUX, content: "", author: id.author, flags: constants.EPHEMERAL, state: constants2.SENT };
