                                                ...
                                                if (intl47.string(tmp(1114).t.RpE9k7) === label) {
                                                  ...
                                                  if (intl48.string(tmp(1114).t["S/xNKV"]) === label) {
                                                    ...
                                                    if (intl49.string(tmp(1114).t.JVuuz3) === label) {
                                                      ...
                                                      if (null != mediaUrl1) {
                                                        const result8 = tmp(8263).downloadMediaAssetWithContentType(selectedMedia.mediaUrl, constants6.VIDEO, selectedMedia.contentType);
                                                        result8.then(() => {
                                                                ...
                                                                if (intl55.string(tmp(1114).t.rBIGBL) === label) {
                                                                  ...
                                                                  if (intl56.string(tmp(1114).t["39d0Wj"]) === label) {
                                                                    ...
                                                                    if (intl57.string(tmp(1114).t.PHjkRE) === label) {
                                                                      ...
                                                                      const obj17 = { channel, commandType: tmp(1894).ApplicationCommandType.MESSAGE, commandTargetId: message.id };
                                                                      const result11 = tmp(4417).navigateToContextMenuCommands(obj17);
                                                                      const tmpResult24 = tmp(4417);
                                                                    } else {
                                                                      const intl58 = tmp(1114).intl;
                                                                      if (intl58.string(tmp(1114).t.tpxJto) === label) {
                                                                        const obj18 = { channelId: id, messageId: id2, displayToast: true, source: tmp(11709).SavedMessageSources.LONG_PRESS_ACTION_SHEET };
                                                                        const result12 = tmp(11704).addOrUpdateSavedMessage(obj18);
                                                                        ...
                                                                        if (intl59.string(tmp(1114).t.SvXS1Z) === label) {
                                                                          ...
                                                                          if (intl60.string(tmp(1114).t.mJ3P0N) === label) {
                                                                            ...
                                                                            obj20.onBack = onBack;
                                                                            tmp130(4527).openLazy(tmp(1896)(11710, tmp2.paths), "MessageReminderDurationActionSheet", obj20);
                                                                            ...
                                                                            if (intl61.string(tmp(1114).t.vrbqs1) === label) {
                                                                              ...
                                                                              obj21.onBack = onBack;
                                                                              tmp130(4527).openLazy(tmp(1896)(11710, tmp2.paths), "MessageReminderDurationActionSheet", obj21);
                                                                              ...
                                                                              if (intl62.string(tmp(1114).t.ZH7P2h) === label) {
                                                                                if (null != selectedMedia) {
                                                                                  ...
                                                                                  if (result13) {
                                                                                    ...
                                                                                    obj22.embedId = id1;
                                                                                    tmp130(4527).openLazy(tmp(1896)(11677, tmp2.paths), closure_20, obj22);
                                                                                ...
                                                                                if (intl63.string(tmp(1114).t.grdwwt) === label) {
                                                                                  ...
                                                                                  if (intl64.string(tmp(1114).t.Rjezbz) === label) {
                                                                                    ...
                                                                                    tmp130(4527).openLazy(tmp(1896)(11727, tmp2.paths), "AppInteractionInfoActionSheet", obj24);
                                                                                      ...
                                                                                      if (intl66.string(tmp(1114).t.wUIMqa) !== label) {
                                                                                        ...
                                                                                        if (intl67.string(tmp(1114).t.kFwAsa) === label) {
                                                                                          ...
                                                                                          if ("attachment" === sourceType) {
                                                                                            ...
                                                                                            obj25.title = intl3.string(tmp(1114).t.CbTIEo);
                                                                                            const intl4 = tmp(1114).intl;
                                                                                            obj25.body = intl4.string(tmp(1114).t.faHmO3);
                                                                                            const intl5 = tmp(1114).intl;
                                                                                            obj25.cancelText = intl5.string(tmp(1114).t["ETE/oC"]);
                                                                                            const intl6 = tmp(1114).intl;
                                                                                            obj25.confirmText = intl6.string(tmp(1114).t.kFwAsa);
                                                                                    ...
                                                                                    obj26.title = intl7.string(tmp(1114).t.VL1KOk);
                                                                                    const intl8 = tmp(1114).intl;
                                                                                    obj26.body = intl8.string(tmp(1114).t["vXZ+Fo"]);
                                                                                    const intl9 = tmp(1114).intl;
                                                                                    obj26.cancelText = intl9.string(tmp(1114).t["ETE/oC"]);
                                                                                    const intl10 = tmp(1114).intl;
                                                                                    obj26.confirmText = intl10.string(tmp(1114).t.YEHppG);
