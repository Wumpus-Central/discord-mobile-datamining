// === Module 11922: LongPressMessageActionSheetUtils ===
...
import ForumComposerModalActionCreators from "ForumComposerModalActionCreators" /* 10515 */;
import PendingReplyActionCreators from "PendingReplyActionCreators" /* 11924 */;
import ChannelPinActionCreatorsDefault from "ChannelPinActionCreators" /* 11929 */;
import SavedMessageHelpers from "SavedMessageHelpers" /* 11961 */;
import SavedMessageSources from "SavedMessageSources" /* 11966 */;
import noop from "module_19" /* 19 */;
import PendingReplyStore from "PendingReplyStore" /* 7919 */;
import EditMessageStore from "EditMessageStore" /* 7920 */;
import UploadStore from "UploadStore" /* 8083 */;
import UserStore from "UserStore" /* 1372 */;
import SendMessageOptionsStore from "SendMessageOptionsStore" /* 11923 */;
                    ...
                    if (intl33.string(channel(1115).t.fsBWmS) === label) {
                      ...
                      if (intl34.string(channel(1115).t.Y8ujqr) === label) {
                        ...
                        if ("attachment" === sourceType) {
                          ...
                          tmp131(4724).openLazy(channel(1980)(11934, dependencyMap.paths), "EditAttachmentActionSheet", obj3);
                              ...
                              if (intl38.string(channel(1115).t["lE/PG3"]) === label) {
                                ...
                                if (intl39.string(channel(1115).t["2km5Gf"]) === label) {
                                  ...
                                  if (intl40.string(channel(1115).t.xwMqD7) === label) {
                                    ...
                                    tmp131(4937).trackWithMetadata(constants.MESSAGE_ACTION_SHEET_OPTION_PRESSED, obj15);
                                    ...
                                    if (intl41.string(channel(1115).t["5911Lb"]) === label) {
                                      ...
                                      tmp131(11931)(channel, message, items, SendMessageOptionsStore.getOptions(message.id));
                                      ...
                                      tmp131(4937).trackWithMetadata(constants.MESSAGE_ACTION_SHEET_OPTION_PRESSED, obj17);
                                      ...
                                      if (intl42.string(channel(1115).t.JrGD7E) === label) {
                                        ...
                                        if (isMessageComponentsV2(contentMessage)) {
                                          const allTextDisplayContent = channel(4981).getAllTextDisplayContent(contentMessage.components);
                                            ...
                                            if (intl45.string(channel(1115).t.ZbtGBm) === label) {
                                              ...
                                              if (intl46.string(channel(1115).t["g33r/P"]) === label) {
                                                ...
                                                if (intl47.string(channel(1115).t.Xrt5Po) === label) {
                                                  ...
                                                  const channelPermalink = channel(4902).getChannelPermalink(channel.guild_id, channel.id, id2);
                                                  if (null != channelPermalink) {
                                                  ...
                                                  if (intl48.string(channel(1115).t.RpE9k7) === label) {
                                                    ...
                                                    if (intl49.string(channel(1115).t["S/xNKV"]) === label) {
                                                      ...
                                                      if (null != mediaUrl) {
                                                        closure_131_2 = channel(4907).urlMatchesFileExtension(selectedMedia.mediaUrl, closure_15);
                                                        ...
                                                        if (null != toURLSafeResult) {
                                                          if (obj40.isRefreshableAttachmentUrl(toURLSafeResult)) {
                                                            let result7 = tmp53(10206).maybeRefreshAttachmentUrl(selectedMedia.mediaUrl);
                                                      ...
                                                      if (intl50.string(channel(1115).t.JVuuz3) === label) {
                                                        ...
                                                        if (null != mediaUrl1) {
                                                          const result8 = channel(8540).downloadMediaAssetWithContentType(selectedMedia.mediaUrl, constants6.VIDEO, selectedMedia.contentType);
                                                          result8.then(() => {
                                                          ...
                                                          if (intl52.string(channel(1115).t["92CPQ+"]) !== label) {
                                                            ...
                                                            if (intl53.string(channel(1115).t["8xHmxo"]) !== label) {
                                                              ...
                                                              if (intl54.string(channel(1115).t["5IEsGx"]) === label) {
                                                                ...
                                                                tmp131(11935)(obj23);
                                                                if ("Preview" === actionSheetSource) {
                                                                  channel(4768).transitionToMessage(channel.id, message.id);
                                                                ...
                                                                if (intl55.string(channel(1115).t.I3ltXO) === label) {
                                                                  ...
                                                                  if (intl56.string(channel(1115).t.rBIGBL) === label) {
                                                                    ...
                                                                    const result9 = tmp131(8010).openThreadCreationForMobile(channel, id1, "Message");
                                                                    ...
                                                                    if (intl57.string(channel(1115).t["39d0Wj"]) === label) {
                                                                      ...
                                                                      if (intl58.string(channel(1115).t.PHjkRE) === label) {
                                                                        ...
                                                                        const result11 = channel(4614).navigateToContextMenuCommands(obj25);
                                                                        const tmpResult58 = channel(4614);
                                                                      } else {
                                                                        const intl59 = channel(1115).intl;
                                                                        if (intl59.string(channel(1115).t.tpxJto) === label) {
                                                                          const obj26 = { channelId: id, messageId: id2, displayToast: true, source: channel(11966).SavedMessageSources.LONG_PRESS_ACTION_SHEET };
                                                                          const result12 = channel(11961).addOrUpdateSavedMessage(obj26);
                                                                          ...
                                                                          if (intl60.string(channel(1115).t.SvXS1Z) === label) {
                                                                            ...
                                                                            if (intl61.string(channel(1115).t.mJ3P0N) === label) {
                                                                              ...
                                                                              obj28.onBack = onBack;
                                                                              tmp131(4724).openLazy(channel(1980)(11967, dependencyMap.paths), "MessageReminderDurationActionSheet", obj28);
                                                                              ...
                                                                              if (intl62.string(channel(1115).t.vrbqs1) === label) {
                                                                                ...
                                                                                obj29.onBack = onBack;
                                                                                tmp131(4724).openLazy(channel(1980)(11967, dependencyMap.paths), "MessageReminderDurationActionSheet", obj29);
                                                                                ...
                                                                                if (intl63.string(channel(1115).t.ZH7P2h) === label) {
                                                                                  if (null != selectedMedia) {
                                                                                    ...
                                                                                    if (!result13) {
                                                                                      result13 = channel(7536).messageHasObscurableMedia(message);
                                                                                    ...
                                                                                    if (result13) {
                                                                                      ...
                                                                                      obj30.embedId = id3;
                                                                                      tmp131(4724).openLazy(channel(1980)(11932, dependencyMap.paths), closure_20, obj30);
                                                                                      const tmp131Result53 = tmp131(4724);
                                                                                    }
                                                                                  }
                                                                                } else {
                                                                                  ...
                                                                                  if (intl64.string(channel(1115).t.grdwwt) === label) {
                                                                                    ...
                                                                                    tmp131(11971).endPollEarly({ channelId: null, messageId: null });
                                                                                    const obj31 = { channelId: null, messageId: null };
                                                                                    const tmp131Result54 = tmp131(11971);
                                                                                  } else {
                                                                                    const intl65 = channel(1115).intl;
                                                                                    if (intl65.string(channel(1115).t.Rjezbz) === label) {
                                                                                      const obj32 = { message, guildId: guild_id, onBack };
                                                                                      tmp131(4724).openLazy(channel(1980)(11984, dependencyMap.paths), "AppInteractionInfoActionSheet", obj32);
                                                                                      const tmp131Result55 = tmp131(4724);
                                                                                    } else {
                                                                                        ...
                                                                                        if (intl67.string(channel(1115).t.wUIMqa) !== label) {
                                                                                          ...
                                                                                          if (intl68.string(channel(1115).t.kFwAsa) === label) {
                                                                                            ...
                                                                                            if ("attachment" === sourceType1) {
                                                                                              ...
                                                                                              const tmp131Result56 = tmp131(5109);
                                                                                            }
                                                                                          }
                                                                                        }
                                                                                      }
                                                                                      ...
                                                                                      const tmp131Result57 = tmp131(5109);
                                                                                    }
                                                                                  }
                                                                                }
                                                                              }
