...
import _modDef7961 from "../../../../../_runtime/metro/07961__.js";
        ...
        if (null != count) {
          if (count > 0) {
            ...
            if (tmp15Result.isChannelSpoilerGated(channel1)) {
              let obj = {
                title: channelName,
                messageCountLabel: intl5,
                messageCountAccessibilityLabel: string2,
              ...
              if (archived) {
                ...
                obj.archivedIconUrl = tmp15Result.getAssetUriForEmbed(_modDef7961);
                obj.backgroundColor = backgroundColor;
                obj1 = obj;
              } else {
  ...
  if (null != tmp16) {
    ...
    if (null != message2.content) {
      if ("" !== message2.content) {
        ...
        let parseMessageMarkupResult = tmp13Result3.parseMessageMarkup(
          message,
          message2,
          forceHideSimpleEmbedContent,
          isInlineReplyPreview,
      ...
      if (tmp7) {
        ...
        obj6.transformComponents = function transformComponents(arg0) {
          return transformMessageComponentsDefault(
            {
              message,
              guildId,
              interaction,
              ...
              if (renderReplies) {
                ...
                if (ReferencedMessageState.LOADED === state) {
                  ...
                  if (RelationshipStore.isBlockedForMessage(message3)) {
                    ...
                    obj16.options = obj17;
                    const tmp73 = createMessageContent(obj16);
                    if (null == tmp73) {
                      ...
                      const obj19 = { state: ReferencedMessageRowState.LOADED, message: tmp73 };
                      tmp61 = obj19;
            ...
            if (tmp102) {
              ...
              if (renderAttachments) {
                const obj24 = {
                  ...
                  uploadAttachments: obj13.getUploadAttachments(message.nonce),
                  shouldInlineAttachmentMedia: tmp10,
                  gifAutoPlay,
                  viewImageDescriptions: setting,
                  useReducedMotion,
                  shouldObscureSpoiler,
                ...
                const tmp2Result2 = tmp2(tmp3[64]);
              }
            }
            if (tmp102) {
              ...
              if (tmp102) {
                ...
                if (renderPolls) {
                  ...
                  const tmp113 = tmp2(tmp3[66])(message, undefined, obj25);
                }
                ...
                if (tmp13Result25.shouldDisplayGuildTag(author.id, tmp115)) {
                  ...
                  if (null != userPrimaryGuild.guildId) {
                    guildTagBadgeUrl = tmp13(tmp3[68]).getGuildTagBadgeUrl(
                  ...
                  if (null != guild) {
                    if (tmp13Result30.isGuildOfficialMessagesEnabled(guild, "createMessageContent")) {
                      ...
                      if (tmp13Result32.showGuildOfficialMessageTextColor(officialMessageStyle)) {
                        ...
                        const accessibleGuildOfficialTextColor = tmp13Result33.getAccessibleGuildOfficialTextColor(
                ...
                const hasFlagResult = tmp13(tmp3[34]).hasFlag(tmp128.flags, constants3.IS_VOICE_MESSAGE);
                const obj27 = {
                  id: null,
                  channelId: null,
                  guildId: null,
                ...
                if (null != message.nonce) {
                  ...
                  obj27.referencedMessage = tmp155;
                  obj27.threadEmbed = tmp84;
                  let forwardInfo;
                  if (null != messageForward) {
                  ...
                  obj27.officialMessageColor = tmp135;
                  ...
                  obj27.avatarDecorationURL = tmp159;
                  ...
                  if (!tmp21) {
                    ...
                    obj27.forceRevealSpoilers = !shouldObscureSpoiler;
                    if (tmp21) {
                    ...
                    obj27.timestampAccessibilityLabel = tmp173;
                    ...
                    if (renderExecutedCommands) {
                      ...
                      executedCommand = tmp13Result41.createExecutedCommand(
                        message,
                        channel,
                        roleStyle,
                        tmp6,
                    ...
                    if (message2.components.length > 0) {
                      if (renderComponents) {
                        ...
                        tmp181 = tmp2(tmp3[49])(obj28, message2.components);
                      }
                    }
                    obj27.components = tmp181;
                    let num9 = 0;
                    if (!renderContentOnly) {
                    ...
                    if (renderActivityInviteEmbed) {
                      activityRichPresenceInviteEmbed = tmp13(tmp3[80]).createActivityRichPresenceInviteEmbed(
                        message,
                        channel,
                      );
                    ...
                    obj27.useAttachmentUploadPreview = tmp44;
                    ...
                    if (restrictedPreview) {
                      ...
                      const tmp2Result4 = tmp2(tmp3[81]);
                    }
                        ...
                        if (message.id === message.channel_id) {
                          ...
                          if (null == guildId1) {
                            ...
                            if (0 === message.reactions.length) {
                              ...
                              if (null != emojiId) {
                                usableCustomEmojiById = enabledHarmTypesForMessage.getUsableCustomEmojiById(
                            ...
                            const obj31 = {
                              isFollowing: hasJoinedResult,
                              hasReactions: 0 !== message.reactions.length,
                              defaultReaction,
                    ...
                    const merged4 = Object.assign(
                      tmp13(tmp3[87]).createCtaButtons(message.id, message.channel_id, tmp4),
                    );
                    ...
                    obj27.clanTagGuildId = tmp118;
                    obj27.clanTag = tag;
                    obj27.clanBadgeUrl = tmp116;
                    obj27.lobbyAdditionalName = additionalName;
                    obj27.lobbyTagIconUrl = tmp123;
