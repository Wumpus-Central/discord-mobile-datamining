...
import { registerAsset } from "../../../../../../_runtime/07645_registerAsset.js";
  ...
  if (null == referralTrialOfferId) {
    ...
    if (referrer_id === id) {
      ...
      if (null == referralTrialEmbedRedeemable) {
        ...
        obj.iconUrl = tmp8(7995).getAssetUriForEmbed(registerAsset);
      ...
      if (null == referralTrialEmbedRedesign) {
        ...
        obj.iconUrl = tmp23(7995).getAssetUriForEmbed(registerAsset);
