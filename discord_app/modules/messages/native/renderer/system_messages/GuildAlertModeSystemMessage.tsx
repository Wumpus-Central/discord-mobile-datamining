// === Module 7937: nativeStyleProperties ===
...
export const createGuildAlertModeEnabledSystemMessage = function createGuildAlertModeEnabledSystemMessage(roleStyle) {
  ...
  obj = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: importDefault(7869)({ message, author: messageAuthorWithProcessedColor, roleStyle: roleStyle.roleStyle }), time: null };
  let str = "";
  if ("" !== message.content) {
    const _Date = Date;
  ...
  const tmp12 = importDefault(7938)({ message, channel, isSystemDM: true, colors: importDefault(7860)(theme) });
...
export const createGuildAlertModeDisabledSystemMessage = function createGuildAlertModeDisabledSystemMessage(roleStyle) {
  ...
  obj[3] = importDefault(7860)(theme);
  ...
  const tmp6 = importDefault(7938)(obj);
