...
export const createGuildAlertModeEnabledSystemMessage = function createGuildAlertModeEnabledSystemMessage(roleStyle) {
  ...
  obj = { username: messageAuthorWithProcessedColor.nick, usernameOnClick: importDefault(7881)({ message, author: messageAuthorWithProcessedColor, roleStyle: roleStyle.roleStyle }), time: null };
  let str = "";
  if ("" !== message.content) {
    const _Date = Date;
  ...
  const tmp12 = importDefault(7950)({ message, channel, isSystemDM: true, colors: importDefault(7872)(theme) });
...
export const createGuildAlertModeDisabledSystemMessage = function createGuildAlertModeDisabledSystemMessage(roleStyle) {
  ...
  obj[3] = importDefault(7872)(theme);
  ...
  const tmp6 = importDefault(7950)(obj);
