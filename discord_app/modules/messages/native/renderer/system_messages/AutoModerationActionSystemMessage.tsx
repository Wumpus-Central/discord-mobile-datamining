...
import AutomodRaidAlertTypes from "AutomodRaidAlertTypes" /* 8233 */;
import GuildAntiRaidUtils from "GuildAntiRaidUtils" /* 8234 */;
import _modDef8238 from "module_8238" /* 8238 */;
import getRoleIcon from "getRoleIcon" /* 8239 */;
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (null == guildId) {
      ...
      obj12.actionsIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(importDefault(result1 ? 8240 : 8241))).uri;
