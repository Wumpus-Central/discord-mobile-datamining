...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (result1) {
      ...
      if (tmp(5232).IS_BACKWARDS_COMPAT_RAID_TYPE !== notificationType) {
        if (tmp(8210).AutomodNotificationEmbedTypeKeys.RAID !== notificationType) {
          if (tmp(8210).AutomodNotificationEmbedTypeKeys.MENTION_RAID === notificationType) {
            ...
            obj[2] = tmp(8161).processColorOrThrow(internal3.resolveSemanticColor(theme, Themes.colors.TEXT_FEEDBACK_CRITICAL));
            ...
            obj[4] = tmp(8161).processColorOrThrow(internal4.resolveSemanticColor(theme, Themes.colors.TEXT_FEEDBACK_CRITICAL));
            ...
            if (null != avatar) {
              ...
              obj1[1] = tmp(8161).processColorOrThrow(internal.resolveSemanticColor(theme, Themes.colors.TEXT_FEEDBACK_POSITIVE));
              ...
              obj1[3] = tmp(8161).processColorOrThrow(internal2.resolveSemanticColor(theme, Themes.colors.TEXT_FEEDBACK_POSITIVE));
            ...
            obj2[1] = tmp(8161).processColorOrThrow(internal7.resolveSemanticColor(theme, Themes.colors.TEXT_SUBTLE));
            ...
            obj2[3] = tmp(8161).processColorOrThrow(internal8.resolveSemanticColor(theme, Themes.colors.TEXT_SUBTLE));
      ...
      obj5[5] = tmp(8161).processColorOrThrow(internal5.resolveSemanticColor(theme, Themes.colors.TEXT_FEEDBACK_CRITICAL));
      ...
      obj5[7] = tmp(8161).processColorOrThrow(internal6.resolveSemanticColor(theme, Themes.colors.TEXT_FEEDBACK_CRITICAL));
      intl9 = tmp(1236).intl;
