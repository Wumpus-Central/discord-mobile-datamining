...
import AutomodRaidAlertTypes from "AutomodRaidAlertTypes" /* 8150 */;
import GuildAntiRaidUtils from "GuildAntiRaidUtils" /* 8151 */;
import _modDef8155 from "module_8155" /* 8155 */;
import getRoleIcon from "getRoleIcon" /* 8156 */;
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (null == guildId) {
      ...
      obj12.actionsIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(importDefault(result1 ? 8157 : 8158))).uri;
