...
import AutomodRaidAlertTypes from "AutomodRaidAlertTypes" /* 8271 */;
import GuildAntiRaidUtils from "GuildAntiRaidUtils" /* 8272 */;
import _modDef8276 from "module_8276" /* 8276 */;
import getRoleIcon from "getRoleIcon" /* 8277 */;
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (null == guildId) {
      ...
      obj12.actionsIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(importDefault(result1 ? 8278 : 8279))).uri;
