...
import AutomodRaidAlertTypes from "AutomodRaidAlertTypes" /* 8118 */;
import GuildAntiRaidUtils from "GuildAntiRaidUtils" /* 8119 */;
import _modDef8123 from "module_8123" /* 8123 */;
import getRoleIcon from "getRoleIcon" /* 8124 */;
...
export const createAutoModerationActionSystemMessage = function createAutoModerationActionSystemMessage(message) {
  ...
  if (obj.isAutomodMessageRecord(message)) {
    ...
    if (result1) {
      ...
      if (AutomodMessageUtils.IS_BACKWARDS_COMPAT_RAID_TYPE !== notificationType) {
        if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.RAID !== notificationType) {
          if (AutomodNotificationEmbedTypeKeys.AutomodNotificationEmbedTypeKeys.MENTION_RAID === notificationType) {
            ...
            obj = { subtitleLeft: fromNowResult, header: null, headerColor: null, headerIconURL: null, headerIconColor: null, body: null, shouldShowActions: false };
            const intl5 = util.intl;
            obj.header = intl5.string(util.t.C2uIXE);
            const internal3 = nativeDefault.internal;
            obj.headerColor = RowGeneratorStyleSheet.processColorOrThrow(internal3.resolveSemanticColor(theme, nativeDefault.colors.TEXT_FEEDBACK_CRITICAL));
            const tmpResult4 = RowGeneratorStyleSheet;
            obj.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef6713)).uri;
            const tmpResult5 = AvatarUtils;
            const internal4 = nativeDefault.internal;
            obj.headerIconColor = RowGeneratorStyleSheet.processColorOrThrow(internal4.resolveSemanticColor(theme, nativeDefault.colors.TEXT_FEEDBACK_CRITICAL));
            ...
            if (null != avatar) {
              ...
              obj1.headerColor = RowGeneratorStyleSheet.processColorOrThrow(internal.resolveSemanticColor(theme, nativeDefault.colors.TEXT_FEEDBACK_POSITIVE));
              const tmpResult10 = RowGeneratorStyleSheet;
              obj1.headerIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(_modDef8123)).uri;
              const tmpResult11 = AvatarUtils;
              const internal2 = nativeDefault.internal;
              obj1.headerIconColor = RowGeneratorStyleSheet.processColorOrThrow(internal2.resolveSemanticColor(theme, nativeDefault.colors.TEXT_FEEDBACK_POSITIVE));
              const intl3 = util.intl;
              obj1.body = intl3.string(util.t["QV/8u5"]);
              const tmpResult12 = RowGeneratorStyleSheet;
              obj1.subtitleRight = _modDef4228(message.timestamp).fromNow();
            ...
            obj2.headerColor = RowGeneratorStyleSheet.processColorOrThrow(internal7.resolveSemanticColor(theme, nativeDefault.colors.TEXT_SUBTLE));
            ...
            obj2.headerIconColor = RowGeneratorStyleSheet.processColorOrThrow(internal8.resolveSemanticColor(theme, nativeDefault.colors.TEXT_SUBTLE));
      ...
      const obj5 = { subtitleLeft: formatToPlainStringResult, severity: formatToPlainStringResult, subtitleRight: fromNowResult1, startTime: fromNowResult1, header: null, headerColor: null, headerIconURL: null, headerIconColor: null, body: null, shouldShowActions: true };
      ...
      obj5.headerColor = RowGeneratorStyleSheet.processColorOrThrow(internal5.resolveSemanticColor(theme, nativeDefault.colors.TEXT_FEEDBACK_CRITICAL));
      let getRaidAlertResolveCTAText = React4.resolveAssetSource;
      let internal6 = AvatarUtils;
      let intl9 = internal6.makeSource;
      obj5.headerIconURL = getRaidAlertResolveCTAText(intl9(importDefault(tmp42 ? 8122 : 6713))).uri;
      const tmpResult16 = RowGeneratorStyleSheet;
      internal6 = nativeDefault.internal;
      obj5.headerIconColor = RowGeneratorStyleSheet.processColorOrThrow(internal6.resolveSemanticColor(theme, nativeDefault.colors.TEXT_FEEDBACK_CRITICAL));
      intl9 = util.intl;
    ...
    if (null == guildId) {
      ...
      if (null != iconRoleId) {
        if (null != guildId) {
          ...
          roleIcon = getRoleIcon.getRoleIcon(obj7);
          const tmpResult19 = getRoleIcon;
        }
      }
      const obj8 = {};
      ...
      obj8.avatarURL = tmpResult20.ensureAvatarSource(tmpResult21.makeSource(utils_AvatarUtils.getAutomodAvatarURL())).uri;
      obj8.colorString = React3(colorString);
      const obj9 = { headerText: str, headerBadgeText: null, keywordDisplayText: null, message: null, notification: null, ruleDisplayText: null, reasonDisplayText: null, actionsIconURL: null, actionsText: null, feedbackText: null };
      ...
      const obj11 = { id: flaggedMessageId, channelId: null, guildId: null, userId: null, channelName: null, username: null, usernameColor: null, roleColor: null, shouldShowRoleDot: null, colorString: null, avatarURL: null, content: null, communicationDisabled: null, timestamp: null };
      let id;
      ...
      obj9.actionsIconURL = React4.resolveAssetSource(AvatarUtils.makeSource(importDefault(result1 ? 8125 : 8126))).uri;
