// === Module 7855: createRemoveRecipientSystemMessage ===
...
export const createRemoveRecipientSystemMessage = function createRemoveRecipientSystemMessage(message) {
  ...
  if (message.author.id === first) {
    ...
    const merged = Object.assign(tmp8(7841)(message));
    return obj;
  } else {
    user = user.getUser(first);
    const userAuthorWithProcessedColor = tmp5(7837).getUserAuthorWithProcessedColor(user, channel);
    obj1 = {};
    ...
    obj2[3] = roleStyle;
    obj1.otherUsernameOnClick = tmp8(7839)(obj2);
    ...
    const merged2 = Object.assign(tmp8(7841)(message));
    return obj3;
  }
};