...
export const getAttachmentObscurityProps = function getAttachmentObscurityProps(shouldAgeVerify) {
  ...
  obj = { type: tmp(6143).ObscuredMediaTypes.Attachment, media: obj };
  ...
  obj2[3] = str;
  obj2[4] = tmpResult.isMediaScanPending(
    { type: ContentHarmTypeChannel.ObscuredMediaTypes.Attachment, media: obj },
