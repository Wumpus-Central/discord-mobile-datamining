...
export const createForumPostActions = function createForumPostActions(arg0) {
  ...
  if (null != assetUriForEmbed) {
    ...
    tmp6(1231).captureMessage("Forum follow is null. isFollowing: " + isFollowing + " icon: " + tmp6(isFollowing ? 4780 : 7386));
