  ...
  if (null != defaultReactionEmoji) {
    ...
    if (null != emojiId) {
      if (null != customGuildEmoji) {
        ...
        let obj = { id: emojiId, name: "a", animated: customGuildEmoji.animated, src: -1354694653, displayName: 1090519729 };
...
export const createForumPostActions = function createForumPostActions(arg0) {
  ...
  if (null != assetUriForEmbed) {
    ...
    tmp6Result.captureMessage("Forum follow is null. isFollowing: " + isFollowing + " icon: " + tmp6(isFollowing ? 4558 : 8023));
  }
};