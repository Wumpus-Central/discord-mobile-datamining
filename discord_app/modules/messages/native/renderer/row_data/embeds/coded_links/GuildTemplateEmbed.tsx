...
export const createGuildTemplateEmbed = function createGuildTemplateEmbed(code, closure_2) {
  ...
  if (null == guildTemplate) {
    ...
    obj[0] = intl3.string(getSystemLocale /* getSystemLocale */.t.Xj87Yf).toUpperCase();
    ...
    obj.headerText = intl.string(getSystemLocale /* getSystemLocale */.t.C7ZRNw).toUpperCase();
    let obj1 = processColorOrThrow /* processColorOrThrow */;
    obj.titleColor = obj1.processColorOrThrow(tmp(712).unsafe_rawColors.RED_400);
    const intl2 = getSystemLocale /* getSystemLocale */.intl;
    obj.titleText = intl2.string(getSystemLocale /* getSystemLocale */.t.A6MwXE);
    const str = intl.string(getSystemLocale /* getSystemLocale */.t.C7ZRNw);
    ...
    const formatToPlainStringResult = intl4.formatToPlainString(getSystemLocale /* getSystemLocale */.t.L8Awgh, obj);
    const str3 = guildTemplate.usageCount;
    obj1.headerText = intl5.string(getSystemLocale /* getSystemLocale */.t.kAvFkO).toUpperCase();
    ...
    obj1.acceptLabelText = intl6.string(getSystemLocale /* getSystemLocale */.t["a3Gl+e"]);
