...
export const createGuildTemplateEmbed = function createGuildTemplateEmbed(code, closure_2) {
  ...
  if (null == guildTemplate) {
    ...
    obj[0] = intl3.string(require("../../../../../../../intl/index.native.tsx") /* getSystemLocale */.t.Xj87Yf).toUpperCase();
    ...
    obj.headerText = intl.string(require("../../../../../../../intl/index.native.tsx") /* getSystemLocale */.t.C7ZRNw).toUpperCase();
    let obj1 = require("../../../RowGeneratorStyleSheet.tsx") /* processColorOrThrow */;
    obj.titleColor = obj1.processColorOrThrow(tmp(712).unsafe_rawColors.RED_400);
    const intl2 = require("../../../../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
    obj.titleText = intl2.string(require("../../../../../../../intl/index.native.tsx") /* getSystemLocale */.t.A6MwXE);
    const str = intl.string(require("../../../../../../../intl/index.native.tsx") /* getSystemLocale */.t.C7ZRNw);
    ...
    const formatToPlainStringResult = intl4.formatToPlainString(require("../../../../../../../intl/index.native.tsx") /* getSystemLocale */.t.L8Awgh, obj);
    const str3 = guildTemplate.usageCount;
    obj1.headerText = intl5.string(require("../../../../../../../intl/index.native.tsx") /* getSystemLocale */.t.kAvFkO).toUpperCase();
    ...
    obj1.acceptLabelText = intl6.string(require("../../../../../../../intl/index.native.tsx") /* getSystemLocale */.t["a3Gl+e"]);
