...
export const createGuildProfileInvite = function createGuildProfileInvite(invite, theme) {
  ...
  const tmp4Result1 = id(9319);
  let memberCount;
  [tmp11, tmp12] = _slicedToArray(id(9319).getBackgroundForProfile(theme, profilePrimaryColor), 2);
  ...
  obj4.bannerColor = id(8040).processColorOrThrow(tmp11);
  const tmp4Result6 = id(8040);
  obj4.bannerColorSecondary = id(8040).processColorOrThrow(tmp12);
  if (found == null) {
    found = [];
  }
