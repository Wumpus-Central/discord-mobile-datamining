...
import validateBuildOverrideDefault from "validateBuildOverride" /* 13523 */;
...
export const createBuildOverrideEmbed = function createBuildOverrideEmbed(code, theme) {
  ...
  if (buildOverride.state === State.Resolving) {
        ...
        if (null != buildOverride.override) {
          if (null != id) {
            if (tmpResultResult.valid) {
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(_modDef13521).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
    ...
    if (tmp20Result.isThemeDark(theme)) {
      let tmpResult2 = _modDef12060;
    } else {
      tmpResult2 = _modDef12061;
    }
