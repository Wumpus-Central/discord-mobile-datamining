...
import validateBuildOverrideDefault from "validateBuildOverride" /* 13248 */;
...
export const createBuildOverrideEmbed = function createBuildOverrideEmbed(code, theme) {
  ...
  if (buildOverride.state === State.Resolving) {
        ...
        if (null != buildOverride.override) {
          if (null != id) {
            if (tmpResultResult.valid) {
              ...
              obj.thumbnailUrl = Image.resolveAssetSource(_modDef13246).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
    ...
    obj1.titleColor = RowGeneratorStyleSheet.processColorOrThrow(nativeDefault.unsafe_rawColors.RED_400);
    if (tmpResultResult.valid) {
