// === Module 12777: BuildOverrideEmbed ===
...
import BuildOverrideStore2 from "BuildOverrideStore" /* 10956 */;
...
import validateBuildOverrideDefault from "validateBuildOverride" /* 12778 */;
        ...
        if (null != buildOverride.override) {
          if (null != id) {
            if (tmpResultResult.valid) {
              ...
              obj3.thumbnailUrl = Image.resolveAssetSource(_modDef12776).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
