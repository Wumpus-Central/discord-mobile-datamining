// === Module 13108: createBuildOverrideEmbed ===
...
import getCurrentBuildOverride from "getCurrentBuildOverride" /* 11279 */;
            ...
            if (tmpResultResult.valid) {
              ...
              if (override != null) {
                ...
                if (targetBuildOverride2 != null) {
                  const tmp30 = targetBuildOverride2[tmp28(undefined, 11583).DEVICE_FIELD];
                  if (tmp30 != null) {
                    type = tmp30.type;
                  }
                }
              ...
              obj.thumbnailUrl = Image.resolveAssetSource(tmp(13107)).uri;
              let str2 = "primary";
              if (tmp10) {
                str2 = "destructive";
              }
