// === Module 7975: createGiftIntentEmbed ===
...
export const createGiftIntentEmbed = function createGiftIntentEmbed(message, theme) {
  ...
  if (null == giftingPrompt) {
    ...
    if (null == user) {
      ...
      const name = importDefault(4094).getName(user);
      if (GiftIntentType.FRIEND_ANNIVERSARY === giftIntentType) {
        ...
        if (tmp13.UNSPECIFIED !== giftIntentType) {
          require(7980) /* _sendGiftMessage */.unhandledGiftIntent(giftIntentType);
          tmp = null;
          const obj11 = require(7980) /* _sendGiftMessage */;
        }
      }
      if (null == tmp) {
        return null;
        ...
        obj1[11] = require(7853) /* frozen */.getAssetUriForEmbed(tmp8(4192));
        const intl3 = require(1236) /* getSystemLocale */.intl;
        obj1[12] = intl3.string(require(1236) /* getSystemLocale */.t.ilhtIa);
        const obj5 = require(7853) /* frozen */;
        obj1[13] = require(7853) /* frozen */.getAssetUriForEmbed(tmp8(7981));
        const obj6 = require(7853) /* frozen */;
        obj1[14] = require(7853) /* frozen */.getAssetUriForEmbed(tmp8(7982));
        const intl4 = require(1236) /* getSystemLocale */.intl;
        obj1[15] = intl4.string(require(1236) /* getSystemLocale */.t.I5gL2H);
        return obj1;
      }
      const obj10 = importDefault(4094);
    }
    obj8 = user;
  }
};