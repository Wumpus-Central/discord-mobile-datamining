...
import _modDef8271 from "../../../../../../../_runtime/metro/08271__.js";
...
import _modDef8288 from "../../../../../../../_runtime/metro/08288__.js";
    ...
    if (null != channel) {
      if (channel.isDM()) {
        const obj = {
          ...
          headerLogoUrl: renderer_EmbedUtils.getAssetUriForEmbed(_modDef8287),
          headerText: null,
          headerColor: null,
          thumbnailUrl: null,
        };
        ...
        obj.thumbnailUrl = renderer_EmbedUtils.getAssetUriForEmbed(_modDef8288);
        let userId;
          ...
          if (null != user1) {
            ...
            if (null == relevantUserTrialOffer) {
              ...
              if (!tmp14) {
                ...
                const referralTrialOfferExpirationCopy = ReferralProgramUtils.getReferralTrialOfferExpirationCopy(
                  expiresAt.getTime(),
                );
              ...
              if (tmp10) {
                if (!tmp20) {
                  if (!tmp13) {
                    ...
                    const obj9 = {
                      action: "bindOpenUrl",
                      url: HelpdeskUtilsDefault.getArticleURL(HelpdeskArticles.REFERRAL_PROGRAM),
                    };
                  ...
                  if (tmp29) {
                    ...
                    obj11.acceptLabelIconUrl = renderer_EmbedUtils.getAssetUriForEmbed(_modDef8271);
                    tmp33 = obj11;
