  ...
  if (null != message.author) {
    if (null != message.activity) {
      ...
      if (null != channel) {
        ...
        if (intl(11281).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          _require = channel;
          const application2 = message.application;
          let id;
          const applicationFromMessage = intl(12550).getApplicationFromMessage(message);
          ...
          if (tmp14) {
            const application1 = intl(5669).fetchApplication(id, false);
            const intlResult1 = intl(5669);
          }
          if (application == null) {
            ...
            if (null != application) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != application.icon) {
                  appIconSrc = intl(11284).getAppIconSrc(application.id, application.icon, application.bot);
                  const intlResult2 = intl(11284);
                }
                id2 = appIconSrc;
                let string2 = intl(11284).getAppGradientColors(id2);
                id2 = obj4.getId();
                if (null != message.application) {
                  ...
                  id2 = intl(12551).getRequestToStreamText(message, channel, obj4.getId());
                  ...
                  obj[17] = application;
                  id2 = obj;
                  const intlResult4 = intl(12551);
                }
                const intlResult3 = intl(11284);
              } else {
                id2 = importDefault;
                ...
                let name_override;
                id2 = intl(11091).getIsAskToJoin(message);
                if (activity9 != null) {
                ...
                if (null != icon_override) {
                  assetImage = intl(8181).getAssetImage(application.id, message.activity.icon_override);
                  const intlResult6 = intl(8181);
                }
                const intlResult5 = intl(11091);
                const activity5 = message.activity;
                let type3;
                if (activity5 != null) {
                  type3 = activity5.type;
                }
                const headerText = intl(12551).getHeaderText(name_override, type3, id2);
                if (null != findActivityResult) {
                  ...
                  let length = intl(11087).getPartySize(findActivityResult).maxPartySize;
                  const intlResult8 = intl(11087);
                  const currentActivityGamePlatform = intl(12243).getCurrentActivityGamePlatform();
                  const tmp40 = id2(11093)(updateActivities, filterPlayingActivities, application.id);
                  const intlResult9 = intl(12243);
                  const isInParty = intl(11090).getIsInParty(tmp40, findActivityResult);
                  const intlResult11 = intl(12552);
                  ...
                  const intlResult10 = intl(11090);
                  const intlResult12 = intl(10528);
                  const canLaunchFrameResult = intl(10528).canLaunchFrame(application);
                  const intlResult13 = intl(8278);
                  const isEmbeddedAppResult = intl(8278).isEmbeddedApp(application);
                  ...
                  obj[7] = hasItem;
                  const canJoin = intl(11085).getCanJoin(obj);
                  ...
                  if (null != start) {
                    ...
                    obj1[1] = end;
                    const _Date = Date;
                    str2 = intl(8178).formatActiveTimestamp(obj1, Date.now());
                    const intlResult15 = intl(8178);
                  }
                  if (assetImage == null) {
                    let appIconSrc1 = null;
                    if (null != application.icon) {
                      appIconSrc1 = intl(11284).getAppIconSrc(application.id, application.icon, application.bot);
                      const intlResult16 = intl(11284);
                    }
                  ...
                  if (tmp57Result) {
                    if (null != findActivityResult) {
                      if (null != findActivityResult.details) {
                        ...
                        if (id2) {
                          const tmp95 = id2(12553)(findActivityResult, application.id);
                    ...
                    obj4[2] = type4;
                    let details;
                    const partyText = intl(12551).getPartyText(obj4);
                    if (findActivityResult != null) {
                    ...
                    const intlResult17 = intl(12551);
                    tmp84 = null != details && "" !== details;
                    const supportsRemoteJoin = intl(11094).getSupportsRemoteJoin(findActivityResult);
                    intl(11095);
                    if (canJoin.canJoin) {
                      let remoteJoinFooterLabel;
                      if (null != remoteJoinPlatform) {
                        remoteJoinFooterLabel = intl(12549).getRemoteJoinFooterLabel(remoteJoinPlatform);
                        const intlResult20 = intl(12549);
                      }
                      ...
                      const obj8 = { label: "PX_8", disabled: null, footerLabel: "PAYPAL_START_VAULT_INITIATED_CHECKOUT_POPUP_OPEN_FAILED" };
                      ...
                      obj11 = { label: "PX_8", disabled: null, footerLabel: "PAYPAL_START_VAULT_INITIATED_CHECKOUT_POPUP_OPEN_FAILED" };
                  ...
                  if (null != remoteJoinPlatform) {
                    items = [];
                    id2 = intl(12555).ACTIVITY_GAME_PLATFORM_TO_ICON_KEY[remoteJoinPlatform];
                    id2 = items;
                    if (null != id2) {
                      id2 = items.push(id2);
                      id2 = items;
                    ...
                    obj12[2] = hasItem;
                    id2 = intl(12555).getJoinFromSupportedPlatformsIconKeys(obj12);
                    const intlResult23 = intl(12555);
                  }
                  id2 = tmp72;
                  const intlResult14 = intl(11085);
                  const tmp57 = closure_18;
                  id2 = intl(11284).getAppGradientColors(id2);
                  const intlResult24 = intl(11284);
                  const obj13 = { messageId: null, presenceActivity: null, application: null };
                  obj13[0] = message.id;
                  obj13[1] = findActivityResult;
                  obj13[2] = application;
                  id2 = obj;
                  id2 = intl(12556).getPresenceActivityInviteCoverImageURL(obj13);
                  if (flag4) {
                  ...
                  obj14[17] = name;
                  tmp27 = obj14;
                  const intlResult25 = intl(12556);
                }
                items = [];
                const intlResult7 = intl(12551);
              }
            }
            return tmp27;
          }
          const intlResult = intl(12550);
        } else {
          if (intl(11281).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (intl(11281).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility) {
              return null;
            }
          }
          const obj15 = { displayType: null, headerText: null, subtitle: null, ctaButtonEnabled: false, ctaButtonText: "PX_8", ctaButtonIsLoading: "Array", footerLabel: "Path", gradientColors: 0, iconSrc: null, isPlatformSupported: "Array", isSpotifyParty: "channelId", maxPartySize: "Math", partyMemberAvatarURIs: "Array", partySizeText: false, platformIconKeys: false, coverImageUrl: false, detailsText: false, title: false };
          obj15[0] = obj.BLOCKED;
          const intl2 = intl(1236).intl;
          obj15[1] = intl2.string(intl(1236).t.pkq6Vq);
          if (contentClassificationVisibility === intl(11281).ContentClassificationVisibility.BLOCK_UNDERAGE) {
