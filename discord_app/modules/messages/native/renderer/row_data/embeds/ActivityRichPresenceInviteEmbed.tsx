      ...
      if (null != channel) {
        ...
        if (intl(11742).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
                  ...
                  if (tmp57Result) {
                    ...
                    if (canJoin.canJoin) {
                      ...
                      const obj8 = {
                        label: "PX_16",
                        disabled: null,
                        footerLabel: "PAYPAL_START_VAULT_INITIATED_CHECKOUT_SETUP_FAILED",
                      };
          ...
          if (intl(11742).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (
              intl(11742).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility
            ) {
              return null;
            }
          }
          const obj15 = {
            ...
            maxPartySize: "default",
            partyMemberAvatarURIs: "exports",
            partySizeText: null,
