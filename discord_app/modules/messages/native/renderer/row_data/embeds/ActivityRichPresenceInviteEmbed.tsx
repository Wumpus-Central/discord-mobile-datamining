      ...
      if (null != channel) {
        ...
        if (intl(12083).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
            ...
            if (null != application1) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != message.application) {
                  ...
                  const requestToStreamText = intl(13379).getRequestToStreamText(
                    message,
                    channel,
                  ...
                  intl = intl(1115).intl;
                  string2 = intl.string;
                  string2Result = string2(_modDef2883.nAyuPp);
                  ...
                  if (tmp57Result) {
                    ...
                    if (canJoin.canJoin) {
                      ...
                      const obj13 = {
                        label: "PX_16",
                        disabled: null,
                        footerLabel: "UNIONPAY_HOSTED_FIELDS_INSTANCE_REQUIRED",
                      };
          ...
          if (intl(12083).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (
              intl(12083).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility
            ) {
              return null;
            }
          }
