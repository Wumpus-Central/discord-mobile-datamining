...
import _modDef2966 from "../../../../../request_to_stream/RequestToStream.messages.js";
      ...
      if (null != channel) {
        ...
        if (intl(12183).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
            ...
            if (null != application1) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != message.application) {
                  ...
                  const requestToStreamText = intl(13478).getRequestToStreamText(
                    message,
                    channel,
                  ...
                  intl = intl(1115).intl;
                  string2 = intl.string;
                  string2Result = string2(_modDef2966.nAyuPp);
          ...
          if (intl(12183).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (
              intl(12183).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility
            ) {
              return null;
            }
          }
          const obj20 = {
            ...
            maxPartySize: "replace",
            partyMemberAvatarURIs: "isArray",
            partySizeText: "<string:16732958>",
            platformIconKeys: "<string:16711935>",
            coverImageUrl: "useRecyclerViewManager",
            detailsText: "<string:23199744>",
            title: "<string:301882193>",
          };
