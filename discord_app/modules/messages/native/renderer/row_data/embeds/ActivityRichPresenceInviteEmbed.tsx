...
import getCoverImageFromActivityDefault from "getCoverImageFromActivity" /* 13370 */;
            ...
            if (null != application1) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != message.application) {
                  ...
                  const requestToStreamText = intl(13368).getRequestToStreamText(message, channel, AuthenticationStore.getId());
