      ...
      if (null != channel) {
        ...
        if (intl(11941).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          ...
          if (null != message.application) {
            ...
            const findActivityResult = PresenceStore.findActivity(
              message.author.id,
            ...
            if (null != application) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != message.application) {
                  ...
                  const findActivityResult1 = obj5.findActivity(
                    message.author.id,
                    (type) => type.type === constants.LISTENING,
                  );
                  const tmp131 = importDefault;
                  const tmp132 = isInviteActiveDefault(
                    obj5.findActivity(message.author.id, (type) => type.type === constants.LISTENING),
                    message,
                    application.id,
                  );
                  ...
                  obj = {
                    ...
                    ctaButtonText: null,
                    ctaButtonIsLoading: false,
                    footerLabel: null,
                    gradientColors: null,
                    headerText: null,
                    iconSrc: null,
                    isSpotifyParty: false,
                ...
                if (null != findActivityResult) {
                  ...
                  if (tmp57Result) {
                    if (null != findActivityResult) {
                      if (null != findActivityResult.details) {
                        if (null != findActivityResult.state) {
                          ...
                          let name2 = intl14
                            .formatToPlainString(intl(1114).t.JCvHtx, { track: null, artist: null })
                            .replace("\n", " ");
                    ...
                    if (tmp91) {
                      tmp91 =
                        ActivityLauncherStore.getState(findActivityResult.application_id, tmp29.JOIN) ===
                        constants.LOADING;
                    }
                    flag4 = false;
                    flag3 = tmp91;
                  ...
                  if (null != remoteJoinPlatform) {
                    ...
                    const obj12 = {
                      platforms: supported_platforms1,
                  ...
                  const obj14 = {
                    ...
                    ctaButtonEnabled: flag5,
                    ctaButtonText: label,
                    ctaButtonIsLoading: flag3,
                    footerLabel,
          ...
          if (intl(11941).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (
              intl(11941).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility
            ) {
              return null;
            }
          }
          const obj15 = {
            displayType: obj.BLOCKED,
            headerText: null,
            subtitle: null,
            ...
            isSpotifyParty: "call",
            maxPartySize: "IconComponent",
            partyMemberAvatarURIs: "getCurrentUser",
            partySizeText: null,
            platformIconKeys: "\u{1F948}",
            coverImageUrl: 9,
            detailsText: 633,
            title: true,
          };
