// === Module 12833: EmbedDisplayType ===

// Module 12833 (EmbedDisplayType)
import resultDefault from "result" /* 10956 */;
import getRequestToStreamCTAAndIsDisabledDefault from "getRequestToStreamCTAAndIsDisabled" /* 12846 */;
import closure_3 from "addApplication" /* 4482 */;
import closure_4 from "upsertAccount" /* 7279 */;
import { SpotifyApplication } from "getIconURL" /* 12834 */;
import closure_6 from "createdAt" /* 1930 */;
import closure_7 from "fetchFingerprint" /* 1218 */;
import closure_8 from "updateParty" /* 12835 */;
import closure_9 from "updateActivities" /* 7289 */;
import closure_10 from "reinjectEphemerals" /* 4999 */;
import closure_11 from "sortActivity" /* 4564 */;
import closure_12 from "filterPlayingActivities" /* 7288 */;
import closure_13 from "mergeGuildAvatar" /* 1922 */;
import closure_14 from "handleActivityStateChanged" /* 10702 */;
  ...
  if (null != message.author) {
    if (null != message.activity) {
      ...
      if (null != channel) {
        ...
        if (intl(11166).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          _require = channel;
          const application2 = message.application;
          let id;
          const applicationFromMessage = intl(12837).getApplicationFromMessage(message);
          ...
          if (tmp14) {
            const application1 = intl(7178).fetchApplication(id, false);
            const intlResult1 = intl(7178);
          }
          if (application == null) {
            ...
            if (null != application) {
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != application.icon) {
                  appIconSrc = intl(11170).getAppIconSrc(application.id, application.icon, application.bot);
                  const intlResult2 = intl(11170);
                }
                id2 = appIconSrc;
                let string2 = intl(11170).getAppGradientColors(id2);
                id2 = obj4.getId();
                if (null != message.application) {
                  ...
                  id2 = intl(12838).getRequestToStreamText(message, channel, obj4.getId());
                  ...
                  intl = intl(1236).intl;
                  string2 = intl.string;
                  string2Result = string2(id2(2790).nAyuPp);
                  obj[6] = string2Result;
                  obj[7] = appIconSrc;
                  appIconSrc = [];
                  obj[13] = appIconSrc;
                  ...
                  obj[17] = application;
                  id2 = obj;
                  const intlResult4 = intl(12838);
                }
                const intlResult3 = intl(11170);
              } else {
                id2 = importDefault;
                ...
                let name_override;
                id2 = intl(10961).getIsAskToJoin(message);
                if (activity9 != null) {
                ...
                if (null != icon_override) {
                  assetImage = intl(7285).getAssetImage(application.id, message.activity.icon_override);
                  const intlResult6 = intl(7285);
                }
                const intlResult5 = intl(10961);
                const activity5 = message.activity;
                let type3;
                if (activity5 != null) {
                  type3 = activity5.type;
                }
                const headerText = intl(12838).getHeaderText(name_override, type3, id2);
                if (null != findActivityResult) {
                  ...
                  let length = intl(10957).getPartySize(findActivityResult).maxPartySize;
                  const intlResult8 = intl(10957);
                  const currentActivityGamePlatform = intl(12184).getCurrentActivityGamePlatform();
                  const tmp40 = id2(10963)(closure_9, closure_12, application.id);
                  const intlResult9 = intl(12184);
                  const isInParty = intl(10960).getIsInParty(tmp40, findActivityResult);
                  const intlResult11 = intl(12839);
                  ...
                  const intlResult10 = intl(10960);
                  const intlResult12 = intl(8741);
                  const canLaunchFrameResult = intl(8741).canLaunchFrame(application);
                  const intlResult13 = intl(8486);
                  const isEmbeddedAppResult = intl(8486).isEmbeddedApp(application);
                  ...
                  obj[7] = hasItem;
                  const canJoin = intl(10955).getCanJoin(obj);
                  ...
                  if (null != start) {
                    ...
                    obj1[1] = end;
                    const _Date = Date;
                    str2 = intl(8387).formatActiveTimestamp(obj1, Date.now());
                    const intlResult15 = intl(8387);
                  }
                  if (assetImage == null) {
                    let appIconSrc1 = null;
                    if (null != application.icon) {
                      appIconSrc1 = intl(11170).getAppIconSrc(application.id, application.icon, application.bot);
                      const intlResult16 = intl(11170);
                    }
                  ...
                  if (tmp57Result) {
                    if (null != findActivityResult) {
                      if (null != findActivityResult.details) {
                        ...
                        if (id2) {
                          const tmp95 = id2(12840)(findActivityResult, application.id);
                    ...
                    obj4[2] = type4;
                    let details;
                    const partyText = intl(12838).getPartyText(obj4);
                    if (findActivityResult != null) {
                    ...
                    const intlResult17 = intl(12838);
                    tmp84 = null != details && "" !== details;
                    const supportsRemoteJoin = intl(10964).getSupportsRemoteJoin(findActivityResult);
                    intl(10965);
                    if (canJoin.canJoin) {
                      let remoteJoinFooterLabel;
                      if (null != remoteJoinPlatform) {
                        remoteJoinFooterLabel = intl(12836).getRemoteJoinFooterLabel(remoteJoinPlatform);
                        const intlResult20 = intl(12836);
                      }
                      ...
                      const obj8 = { label: "ct", disabled: null, footerLabel: "sentry-feedback-screenshot-button" };
                      ...
                      obj11 = { label: "ct", disabled: null, footerLabel: "sentry-feedback-screenshot-button" };
                  ...
                  if (null != remoteJoinPlatform) {
                    items = [];
                    id2 = intl(12842).ACTIVITY_GAME_PLATFORM_TO_ICON_KEY[remoteJoinPlatform];
                    id2 = items;
                    if (null != id2) {
                      id2 = items.push(id2);
                      id2 = items;
                    ...
                    obj12[2] = hasItem;
                    id2 = intl(12842).getJoinFromSupportedPlatformsIconKeys(obj12);
                    const intlResult23 = intl(12842);
                  }
                  id2 = tmp72;
                  const intlResult14 = intl(10955);
                  const tmp57 = closure_18;
                  id2 = intl(11170).getAppGradientColors(id2);
                  const intlResult24 = intl(11170);
                  const obj13 = { messageId: null, presenceActivity: null, application: null };
                  obj13[0] = message.id;
                  obj13[1] = findActivityResult;
                  obj13[2] = application;
                  id2 = obj;
                  id2 = intl(12843).getPresenceActivityInviteCoverImageURL(obj13);
                  if (flag4) {
                  ...
                  obj14[17] = name;
                  tmp27 = obj14;
                  const intlResult25 = intl(12843);
                }
                items = [];
                const intlResult7 = intl(12838);
              }
            }
            return tmp27;
          }
          const intlResult = intl(12837);
        } else {
          if (intl(11166).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (intl(11166).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility) {
              return null;
            }
          }
          const obj15 = { displayType: null, headerText: null, subtitle: null, ctaButtonEnabled: false, ctaButtonText: "ct", ctaButtonIsLoading: "Array", footerLabel: "PX_16", gradientColors: 0, iconSrc: null, isPlatformSupported: "Array", isSpotifyParty: "x", maxPartySize: "text", partyMemberAvatarURIs: "T", partySizeText: "failOffsetX", platformIconKeys: "man_pouting_medium_light_skin_tone", coverImageUrl: "ROBLOX_GAME_ID", detailsText: "Array", title: "isArray" };
          obj15[0] = obj.BLOCKED;
          const intl2 = intl(1236).intl;
          obj15[1] = intl2.string(intl(1236).t.pkq6Vq);
          if (contentClassificationVisibility === intl(11166).ContentClassificationVisibility.BLOCK_UNDERAGE) {
