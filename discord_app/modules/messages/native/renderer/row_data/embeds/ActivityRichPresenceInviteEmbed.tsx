...
import closure_9 from "../../../../../../stores/GamePartyStore.tsx";
import closure_10 from "../../../../../../stores/LocalActivityStore.tsx";
import closure_11 from "../../../../../../stores/MessageStore.tsx";
import closure_12 from "../../../../../../stores/PresenceStore.tsx";
import closure_13 from "../../../../../../stores/SelfPresenceStore.tsx";
import closure_14 from "../../../../../../stores/UserStore.tsx";
import closure_15 from "../../../../../../stores/views/ActivityLauncherStore.tsx";
  ...
  if (null != message.author) {
    if (null != message.activity) {
      ...
      if (null != channel) {
        ...
        obj = ContentClassificationVisibility;
        ...
        if (intl(11737).ContentClassificationVisibility.DISPLAY === contentClassificationVisibility) {
          ...
          if (null != message.application) {
            ...
            let obj5 = closure_12;
            const findActivityResult = closure_12.findActivity(
              message.author.id,
              ...
              if (type2 === constants2.STREAM_REQUEST) {
                ...
                if (null != findActivityResult) {
                  ...
                  obj = {
                    ...
                    currentUserPresenceActivity: null,
                    currentUserId: null,
                    message: null,
                    application: null,
                    isEmbeddedApplication: null,
                    isFrameApplication: null,
                    isGameLaunchable: null,
                  };
                    ...
                    if (null != findActivityResult) {
                      if (null != findActivityResult.details) {
                        if (null != findActivityResult.state) {
                          ...
                          let name2 = intl14
                            .formatToPlainString(intl(1233).t.JCvHtx, { track: null, artist: null })
                            .replace("\n", " ");
                    ...
                    if (null != application.deepLinkUri) {
                      if (null != messages) {
                        ...
                        if (
                          ...
                          stringResult1 = intlResult22.getDeadGameInviteText(
                            message,
                            name_override,
                            channel,
                            id1,
                  ...
                  const obj14 = {
                    ...
                    ctaButtonEnabled: null,
                    ctaButtonText: null,
                    ctaButtonIsLoading: null,
                    footerLabel: null,
                    gradientColors: null,
                    headerText: null,
                    iconSrc: null,
                    isPlatformSupported: null,
                    isSpotifyParty: null,
                    maxPartySize: null,
                    partyMemberAvatarURIs: null,
                    partySizeText: null,
          ...
          if (intl(11737).ContentClassificationVisibility.BLOCK_UNDERAGE !== contentClassificationVisibility) {
            if (
              intl(11737).ContentClassificationVisibility.BLOCK_CHANNEL_RESTRICTION !== contentClassificationVisibility
            ) {
              return null;
            }
          }
