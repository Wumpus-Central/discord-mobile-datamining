...
export const createReferralTrialEmbedRedesign = function createReferralTrialEmbedRedesign(message, theme, id, relevantUserTrialOffer) {
  ...
  if (null != message.author) {
    ...
    const tmp42 = _require(4285).createNativeStyleProperties(obj)(theme);
        ...
        if (null != user) {
          if (null != user1) {
            ...
            if (null == relevantUserTrialOffer) {
              ...
              const values = Object.values(tmp39(5770).TrialIdToProductOfferId[closure_9]);
              id = undefined;
              ...
              const isPremiumResult = tmp41(3931).isPremium(user);
              ...
              if (!tmp15) {
                ...
                obj6[0] = tmp39(3931).formatIntervalDuration(obj5);
                const tmp39Result1 = tmp39(3931);
              ...
              if (tmp10) {
                if (!tmp21) {
                  ...
                  if (tmp27) {
                    ...
                    obj10.acceptLabelIconUrl = tmp39(7865).getAssetUriForEmbed(tmp41(7626));
                    tmp31 = obj10;
                    const tmp39Result2 = tmp39(7865);
                  }
                  return tmp31;
                }
              }
