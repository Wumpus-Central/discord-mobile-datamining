        ...
        if (null != user) {
          if (null != user1) {
            ...
            if (null == relevantUserTrialOffer) {
              ...
              const name1 = tmp41(4146).getName(user);
              if (!tmp15) {
                tmp15 = result;
              }
              if (!tmp15) {
              ...
              if (tmp10) {
                if (!tmp21) {
                  ...
                  if (tmp27) {
                    ...
                    obj10.acceptLabelIconUrl = tmp39(8055).getAssetUriForEmbed(tmp41(7705));
                    tmp31 = obj10;
                    const tmp39Result2 = tmp39(8055);
                  }
                  return tmp31;
                }
              }
