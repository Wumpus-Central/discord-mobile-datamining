        ...
        if (null != user) {
          if (null != user1) {
            ...
            if (null == relevantUserTrialOffer) {
              ...
              const values = Object.values(tmp39(5755).TrialIdToProductOfferId[closure_9]);
              id = undefined;
              ...
              if (tmp10) {
                if (!tmp21) {
                  ...
                  if (tmp27) {
                    ...
                    obj10.acceptLabelIconUrl = tmp39(7837).getAssetUriForEmbed(tmp41(7598));
                    tmp31 = obj10;
                    const tmp39Result2 = tmp39(7837);
                  }
                  return tmp31;
                }
              }
