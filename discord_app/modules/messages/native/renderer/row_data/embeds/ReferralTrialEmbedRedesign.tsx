        ...
        if (null != user) {
          if (null != user1) {
            ...
            if (null == relevantUserTrialOffer) {
              ...
              const values = Object.values(tmp39(5902).TrialIdToProductOfferId[closure_9]);
              id = undefined;
              ...
              if (tmp10) {
                if (!tmp21) {
                  ...
                  if (tmp27) {
                    ...
                    obj10.acceptLabelIconUrl = tmp39(8100).getAssetUriForEmbed(tmp41(7750));
                    tmp31 = obj10;
                    const tmp39Result2 = tmp39(8100);
                  }
                  return tmp31;
                }
              }
