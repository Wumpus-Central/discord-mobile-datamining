...
import metadataDefault from "../../../../../../../discord_assets/assets/premium/referral_program/trialExchange.png.js";
          ...
          if (null != user1) {
            ...
            if (null == relevantUserTrialOffer) {
              ...
              if (!tmp15) {
                ...
                obj6[0] = tmp39(4039).formatIntervalDuration(obj5);
                const tmp39Result1 = tmp39(4039);
