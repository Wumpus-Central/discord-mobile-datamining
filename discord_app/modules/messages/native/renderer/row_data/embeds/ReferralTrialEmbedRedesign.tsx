        ...
        if (null != user) {
          if (null != user1) {
            ...
            if (null == relevantUserTrialOffer) {
              ...
              const values = Object.values(tmp39(5900).TrialIdToProductOfferId[closure_9]);
              id = undefined;
              ...
              const isPremiumResult = tmp41(4007).isPremium(user);
              ...
              if (!tmp15) {
                ...
                obj6[0] = tmp39(4007).formatIntervalDuration(obj5);
                const tmp39Result1 = tmp39(4007);
              ...
              if (tmp10) {
                if (!tmp21) {
                  ...
                  if (tmp27) {
                    ...
                    obj10.acceptLabelIconUrl = tmp39(8096).getAssetUriForEmbed(tmp41(7746));
                    tmp31 = obj10;
                    const tmp39Result2 = tmp39(8096);
                  }
                  return tmp31;
                }
              }
