      ...
      if (null != fields) {
        ...
        if (type === MessageEmbedTypes.SAFETY_SYSTEM_NOTIFICATION) {
          ...
          if (null != parseMessageForPropsResult) {
            ...
            const obj2 = { titleText: str, titleIcon: renderer_EmbedUtils.getAssetUriForEmbed(Image.resolveAssetSource(importDefault("danger" === parseMessageForPropsResult.icon ? 8827 : 5205))), subtitleText: null, descriptionText: null, primaryCtaText: null, primaryCtaType: null, primaryCtaKey: null, secondaryCtaText: null, secondaryCtaType: null, secondaryCtaKey: null, footerTheme: null };
