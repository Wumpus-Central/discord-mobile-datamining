...
import registerAssetDefault2 from "../../../../../_runtime/08058_registerAsset.js";
import registerAssetDefault3 from "../../../../../_runtime/08063_registerAsset.js";
        ...
        if (tmp(8051).ContentInventoryEntryType.WATCHED_MEDIA === content_type) {
          ...
          if (null != image_url2) {
            if (tmpResult4.hasFetchedColors(image_url2)) {
              ...
              const trait = tmp(8056).getTrait(
                contentInventoryEntry,
                tmp(8057).ContentInventoryTraitType.AGGREGATE_COUNT,
              );
              let count;
              if (trait != null) {
                count = trait.count;
      ...
      if (tmp54 != tmp60) {
        ...
        if (tmpResult24.isEntryTopGame(contentInventoryEntry)) {
          ...
          if (!tmp54) {
            ...
            const combined =
              "" + intl2.string(tmp(1233).t["/50eHi"]) + " - " + intl3.formatToPlainString(tmp(1233).t.C0AxoR, obj14);
