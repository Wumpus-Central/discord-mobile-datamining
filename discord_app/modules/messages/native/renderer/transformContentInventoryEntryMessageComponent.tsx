...
import _modDef8254 from "../../../../../_runtime/metro/08254__.js";
import _modDef8255 from "../../../../../_runtime/metro/08255__.js";
import ApplicationAssetUtils from "../../../../utils/ApplicationAssetUtils.tsx";
import _modDef8258 from "../../../../../_runtime/metro/08258__.js";
    ...
    if (ContentInventoryEntryType.ContentInventoryEntryType.PLAYED_GAME !== content_type) {
      if (ContentInventoryEntryType.ContentInventoryEntryType.TOP_GAME !== content_type) {
        if (ContentInventoryEntryType.ContentInventoryEntryType.WATCHED_MEDIA === content_type) {
          ...
          const assetImage = ApplicationAssetUtils.getAssetImage(
          ...
          if (null != tmp47) {
            ...
            const obj4 = {
              ...
              platformIconUrl: Image.resolveAssetSource(_modDef8258).uri,
            };
            tmp49 = obj4;
            const obj33 = /\w+ (\d+), \w+ (\d+)/;
          }
          ...
          if (null != image_url2) {
            if (tmpResult33.hasFetchedColors(image_url2)) {
              ...
              if (null != count) {
                ...
                const obj5 = { count };
                const obj6 = {
                  badgeUrl: Image.resolveAssetSource(_modDef8254).uri,
                  text: intl.formatToPlainString(util.t.HtifnG, obj5),
                };
                items4.push(obj6);
                const obj7 = {
                  imageUrl: image_url2,
                  ...
                  platformIconUrl: Image.resolveAssetSource(_modDef8259).uri,
                };
                tmp30 = obj7;
          ...
          if (null != application1) {
            ...
            if (null != tmp7) {
              const items8 = [];
              const obj10 = { badgeUrl: Image.resolveAssetSource(_modDef5114).uri };
              ...
              obj11.ariaDescription = tmpResult47.formatEntryTimestamp(
                contentInventoryEntry,
                LocaleStore.locale,
                time,
                obj12,
      ...
      if (tmp54 != tmp60) {
        ...
        if (tmpResult53.isEntryTopGame(contentInventoryEntry)) {
          ...
          if (!tmp54) {
            ...
            const combined =
              "" + intl2.string(util.t["/50eHi"]) + " - " + intl3.formatToPlainString(util.t.C0AxoR, obj17);
            obj18.badgeUrl = Image.resolveAssetSource(_modDef8254).uri;
            obj18.text = combined;
            items10.push(obj18);
          ...
          const obj19 = { badgeUrl: Image.resolveAssetSource(_modDef8255).uri };
          ...
          obj20.ariaDescription = tmpResult56.formatEntryTimestamp(
            contentInventoryEntry,
            LocaleStore.locale,
            time1,
            obj21,
