        ...
        if (tmp(8130).ContentInventoryEntryType.WATCHED_MEDIA === content_type) {
          ...
          if (null != tmp47) {
            ...
            const obj1 = {
              ...
              platformIconUrl: obj28.resolveAssetSource(tmp46(8141)).uri,
            };
            tmp49 = obj1;
            const obj33 = /\w+ (\d+), \w+ (\d+)/;
          }
          ...
          if (null != image_url2) {
            if (tmpResult4.hasFetchedColors(image_url2)) {
              ...
              const trait = tmp(8135).getTrait(
                contentInventoryEntry,
                tmp(8136).ContentInventoryTraitType.AGGREGATE_COUNT,
              );
              let count;
              if (trait != null) {
                count = trait.count;
              ...
              if (null != count) {
                ...
                const obj3 = {
                  ...
                  text: intl.formatToPlainString(tmp(1114).t.HtifnG, obj2),
                };
                items4.push(obj3);
                const obj4 = {
                  imageUrl: image_url2,
      ...
      if (tmp54 != tmp60) {
        ...
        if (tmpResult24.isEntryTopGame(contentInventoryEntry)) {
          ...
          if (!tmp54) {
            ...
            const combined =
              "" + intl2.string(tmp(1114).t["/50eHi"]) + " - " + intl3.formatToPlainString(tmp(1114).t.C0AxoR, obj14);
