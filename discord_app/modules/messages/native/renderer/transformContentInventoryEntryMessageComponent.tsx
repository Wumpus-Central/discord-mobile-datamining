    ...
    if (ContentInventoryEntryType.ContentInventoryEntryType.TOP_GAME !== content_type) {
      if (ContentInventoryEntryType.ContentInventoryEntryType.WATCHED_MEDIA === content_type) {
        ...
        if (null != tmp47) {
          ...
          const obj4 = { imageUrl: tmp45, title: contentInventoryEntry.extra.media_title, subtitles: items2, gradientColors: tmp47, platformIconUrl: Image.resolveAssetSource(_modDef8414).uri };
          tmp49 = obj4;
          const obj33 = /\w+ (\d+), \w+ (\d+)/;
        }
        let tmp20 = tmp49;
        ...
        if (null != image_url2) {
          if (tmpResult33.hasFetchedColors(image_url2)) {
            ...
            if (null != count) {
              ...
              const obj5 = { count };
              const obj6 = { badgeUrl: Image.resolveAssetSource(_modDef8410).uri, text: intl.formatToPlainString(util.t.HtifnG, obj5) };
              items4.push(obj6);
