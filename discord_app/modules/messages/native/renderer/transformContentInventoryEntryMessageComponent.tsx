        ...
        if (ContentInventoryEntryType.ContentInventoryEntryType.WATCHED_MEDIA === content_type) {
          ...
          if (null != tmp47) {
            ...
            const obj4 = {
              ...
              platformIconUrl: Image.resolveAssetSource(_modDef7597).uri,
            };
            tmp49 = obj4;
            const obj33 = /\w+ (\d+), \w+ (\d+)/;
          }
          ...
          if (null != image_url2) {
            if (tmpResult33.hasFetchedColors(image_url2)) {
              ...
              if (null != count) {
                ...
                const obj5 = { count };
                const obj6 = {
                  badgeUrl: Image.resolveAssetSource(_modDef7533).uri,
                ...
                const obj7 = {
                  ...
                  platformIconUrl: Image.resolveAssetSource(_modDef7598).uri,
                };
                tmp30 = obj7;
