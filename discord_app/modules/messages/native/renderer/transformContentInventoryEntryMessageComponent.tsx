        ...
        if (ContentInventoryEntryType.ContentInventoryEntryType.WATCHED_MEDIA === content_type) {
          ...
          if (null != tmp47) {
            ...
            const obj1 = {
              ...
              platformIconUrl: Image.resolveAssetSource(_modDef8204).uri,
            };
            tmp49 = obj1;
            const obj33 = /\w+ (\d+), \w+ (\d+)/;
          }
          ...
          if (null != image_url2) {
            if (tmpResult4.hasFetchedColors(image_url2)) {
              ...
              if (null != count) {
                ...
                const obj2 = { count };
                const obj3 = {
                  badgeUrl: Image.resolveAssetSource(_modDef8200).uri,
                ...
                const obj4 = {
                  ...
                  platformIconUrl: Image.resolveAssetSource(_modDef8205).uri,
                };
                tmp30 = obj4;
