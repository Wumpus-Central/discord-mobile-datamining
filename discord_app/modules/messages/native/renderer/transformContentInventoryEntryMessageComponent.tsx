...
import _modDef8257 from "../../../../../_runtime/metro/08257__.js";
        ...
        if (ContentInventoryEntryType.ContentInventoryEntryType.WATCHED_MEDIA === content_type) {
          ...
          if (null != tmp47) {
            ...
            const obj4 = {
              ...
              platformIconUrl: Image.resolveAssetSource(_modDef8261).uri,
            };
            tmp49 = obj4;
            const obj33 = /\w+ (\d+), \w+ (\d+)/;
          }
          ...
          if (null != image_url2) {
            if (tmpResult33.hasFetchedColors(image_url2)) {
              ...
              if (null != count) {
                ...
                const obj5 = { count };
                const obj6 = {
                  badgeUrl: Image.resolveAssetSource(_modDef8257).uri,
                ...
                const obj7 = {
                  ...
                  platformIconUrl: Image.resolveAssetSource(_modDef8262).uri,
                };
                tmp30 = obj7;
          ...
          if (null != application1) {
            ...
            if (null != tmp7) {
              const items8 = [];
              const obj10 = { badgeUrl: Image.resolveAssetSource(_modDef5117).uri };
      ...
      if (tmp54 != tmp60) {
        ...
        if (tmpResult53.isEntryTopGame(contentInventoryEntry)) {
          ...
          if (!tmp54) {
            ...
            obj18.badgeUrl = Image.resolveAssetSource(_modDef8257).uri;
            obj18.text = combined;
            items10.push(obj18);
          ...
          const obj19 = { badgeUrl: Image.resolveAssetSource(_modDef8258).uri };
