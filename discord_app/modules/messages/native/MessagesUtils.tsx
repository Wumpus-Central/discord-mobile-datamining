// === Module 11522: messages/MessagesUtils ===
...
import MediaPlaybackFacts from "MediaPlaybackFacts" /* 11545 */;
import QuestActionCreators from "QuestActionCreators" /* 11546 */;
import MessageImpressionAnalyticsHelpers from "MessageImpressionAnalyticsHelpers" /* 11571 */;
      ...
      if (null != tmp2) {
        if (null != jumpTargetId.current) {
          ...
          if (findMessageIndexResult) {
            const obj = { scrollToMessageId, jumpTargetId: scrollToMessageId, jumpType, focusTargetId: scrollToMessageId, overrideScrollJumpType: Client.JumpType.INSTANT, isRescrolling: true };
            animated(obj);
            flag = true;
          }
          if (!flag) {
