...
import ChannelInfoActionCreators from "ChannelInfoActionCreators" /* 11818 */;
import ChatUpdatesQueueDefault from "ChatUpdatesQueue" /* 11819 */;
...
let closure_7 = fn(9737).updateShouldShowJumpToPresentButton;
const size = fn(2);
