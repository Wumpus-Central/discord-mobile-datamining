...
import ChannelInfoActionCreators from "ChannelInfoActionCreators" /* 11812 */;
import ChatUpdatesQueueDefault from "ChatUpdatesQueue" /* 11813 */;
...
let closure_7 = fn(9733).updateShouldShowJumpToPresentButton;
const size = fn(2);
