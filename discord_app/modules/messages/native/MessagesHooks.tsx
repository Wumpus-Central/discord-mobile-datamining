...
import ChannelInfoActionCreators from "ChannelInfoActionCreators" /* 11736 */;
import ChatUpdatesQueueDefault from "ChatUpdatesQueue" /* 11737 */;
...
let closure_7 = fn(9660).updateShouldShowJumpToPresentButton;
const size = fn(2);
