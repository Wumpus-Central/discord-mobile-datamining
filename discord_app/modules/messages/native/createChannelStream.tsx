...
export default function createChannelStream(forceRender) {
    ...
    if (!hasMoreAfter) {
      ...
      function processHiddenMessageRow(changeType) {
        ...
        while (iter !== undefined) {
          ...
          message = { rowType: constants2.MESSAGE, changeType: constants.NOOP, roleStyle, message: null, isSystemDM: null, isFirst: null, canAddNewReactions: null };
      ...
      if (message.hasFlag(updateMessageIds.HIDDEN_SUSPENDED_USER)) {
        ...
        while (iter !== undefined) {
          ...
          if (tmp68) {
            obj6 = { rowType: forceRender.SUMMARY, changeType: null, roleStyle: null, summary: null, isBeforeContent: false };
          ...
          arr1 = items;
          obj7 = { roleStyle, message: null, isSystemDM: null, isFirst: null, isEditing: null, separatorBefore: null, canAddNewReactions: null, alwaysShowAddReaction: null, renderContentOnly: null, pushFeedbackType: null, canReply: null, canEdit: null, rowType: null, changeType: null, showContentInventoryEntryFallbackEmbed: null };
          obj7.message = obj5;
          ...
          if (tmp111) {
            obj8 = { rowType: forceRender.SUMMARY, changeType: null, roleStyle: null, summary: null, isBeforeContent: true };
      ...
      if (flag) {
        if (!renderContentOnly) {
          ...
          const obj9 = { rowType: forceRender.DAY, changeType: NOOP, roleStyle, text: require("DateUtils").dateFormat(message.timestamp, "LL") };
          items.push(obj9);
      ...
      if (tmp17) {
        let obj11 = { rowType: closure_1_7.LOAD_BEFORE, changeType: forceRender ? constants.UPDATE : constants.NOOP, roleStyle, isLoading: message.loadingMore, text: null };
  ...
  if (!tmp12) {
    ...
    arr = { rowType: messages.hasMoreBefore ? constants.LOAD_BEFORE : constants.LOAD_AFTER, changeType: forceRender ? constants.UPDATE : constants.NOOP, roleStyle, isLoading: messages.loadingMore, text: null };
