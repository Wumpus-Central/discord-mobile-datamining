...
const forwardRefResult = noop.forwardRef((messages, arg1) => {
  ...
  function handleVisibleMessagesChange(arg0) {
    ...
    if (visibleMessages.length > 0) {
      ...
      const result2 = tmpResult6.handleOfficialMessageViewTracking(
        visibleMessages,
      ...
      const result3 = tmpResult7.handleRichPresenceInviteEmbedViewTracking(
        visibleMessages,
      ...
      const result4 = tmpResult8.handleVoiceInviteEmbedViewTracking(
        visibleMessages,
  ...
  ({ startOrCancelLatestMessagesLoad: closure_15, channelLatestMessageLoadingStatsManager } = first(11791)({
    channelId: messages.channelId,
    jumpTargetId: messages.messages.jumpTargetId,
    oldestUnreadMessageId: messages.oldestUnreadMessageId,
    shouldJumpToOriginalPost: callback3,
  ...
  ({ updateRows: closure_33, scrollToMessageId: closure_34 } = first(12203)({
    chatManager: first,
    rowGenerator: first1(
      noop.useState(() => new first(hasJumpedToOriginalPost[16])()),
      1,
