// === Module 11133: handleTapShowAltText ===

// Module 11133 (handleTapShowAltText)
import shallowEqualDefault from "shallowEqual" /* 643 */;
import getVisibleMessages from "getVisibleMessages" /* 10890 */;
import openMediaModalOverlayAltTextSheetDefault from "openMediaModalOverlayAltTextSheet" /* 11134 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "_slicedToArray" /* 32 */;
import importAllResult from "noop" /* 19 */;
import { updateShouldShowJumpToPresentButton as closure_6 } from "updateChatInputContainerHeight" /* 9534 */;
...
const forwardRefResult = importAllResult.forwardRef((messages, ref) => {
  ...
  const items4 = [
    ...
    findMessageIndex(_require(11530).ChatTTITracker, { messages: messages.messages })
  ];
  obj3[0] = items4;
