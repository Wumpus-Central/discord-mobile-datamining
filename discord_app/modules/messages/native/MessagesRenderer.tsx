...
const forwardRefResult = importAllResult.forwardRef((messages, ref) => {
  ...
  let first = first1(importAllResult.useState(() => new first(8671)()), 1)[0];
  ...
  ({ startOrCancelLatestMessagesLoad: closure_15, channelLatestMessageLoadingStatsManager } = first(11002)(obj));
  obj = {
    chatRef: ref5,
    chatManager: first,
    chatUpdatesQueue,
