          ...
          case "bindGuildMenu":
            if (null != data.messageReference) {
              ...
              if (null != guild_id) {
                ...
                obj19.openLazy(asyncRequireImpl(9190, dependencyMap.paths), "GuildProfileActionSheet:" + guild_id, obj);
                const tmp97 = asyncRequireImpl(9190, dependencyMap.paths);
              }
            }
            break;
          case "bindJoinStream":
          ...
          case "bindUserSurvey":
            ...
            if (null != guild_id1) {
              ...
              if (NotificationTypes.TRENDING_CONTENT_PUSH === notificationType2) {
                ...
                const result4 = obj2.openGuildHighlightNotificationForPush(
                  guild_id1,
                  message2,
                  notificationType,
                  MESSAGE_EMBED,
