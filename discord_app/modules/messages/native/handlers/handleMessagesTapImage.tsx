          ...
          if (null != embedId) {
            ...
            if (null != components) {
              if (0 !== components.length) {
                ...
                const result1 = tmp10Result2.extractMediaSourcesFromComponent(tmp7, components, messageChannel.guild_id, embedId(4792).asComponentId(componentId), componentMediaIndex);
                if (null != result1) {
