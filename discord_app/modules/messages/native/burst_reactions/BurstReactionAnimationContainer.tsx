  ...
  if (null != animationData) {
    ...
    obj3.children = function children(markAsDismissed) {
      ...
      if (first1) {
        ...
        tmpResult = closure_1_8(first(7245), obj7);
      }
      obj5.children = tmpResult;
      items1[1] = closure_1_8(handleComponentFinish, obj5);
      let tmp6Result = markAsDismissed.visibleContent === closure_0(2029).DismissibleContent.SUPER_REACTIONS_MOBILE_FULLSCREEN_TAP_TO_DISMISS;
      if (tmp6Result) {
        ...
        const items2 = [closure_1_8(closure_0(4832).Text, obj9), ];
