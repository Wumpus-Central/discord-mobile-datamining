// === Module 7453: _generateAnimationSource ===
        ...
        try {
          ...
          if (0 === c9) {
            ...
            if (3 === tmp8) {
              ...
              obj9[1] = c10;
              obj9[2] = closure_11;
              closure_6 = lib(7491).replaceAnimationColors(closure_6, obj9);
              const _JSON2 = JSON;
              dependencyMap2 = 0;
              c10 = 3;
              obj = { value: null, done: true };
      ...
      if (c6 === 2) {
        ...
        try {
          ...
          if (0 === c5) {
            ...
            obj6[1] = closure_9;
            obj6[2] = closure_10;
            c5 = lib(7491).replaceAnimationColors(c5, obj6);
            const _JSON = JSON;
            c4 = 0;
            c6 = 3;
            obj = { value: null, done: true };
