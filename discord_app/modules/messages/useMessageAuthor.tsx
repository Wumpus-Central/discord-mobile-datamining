...
function useNullableMessageAuthor(message) {
  ...
  let tmp16 = null;
  if (null != message) {
    obj = { user: message.author, channel: stateFromStores, guild: stateFromStores3, memberColorRole: stateFromStores4, userName: name, member: stateFromStores1, friendNickname: stateFromStores5, displayNameStyles: tmp15 };
  ...
  if (null != id) {
    if (null != channel.channel) {
      ...
      if (null == id1) {
        ...
        obj1 = { nick, colorString: null, colorStrings: null, colorRoleName: null, colorRoleId: null, iconRoleId: null, guildMemberAvatar: null, guildMemberAvatarDecoration: null, primaryGuild: null, guildId: null, authorId: null, displayNameStyles: null };
