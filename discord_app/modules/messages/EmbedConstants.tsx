...
({
  ...
  AUTO_MODERATION_NOTIFICATION: arr[1],
  RICH: arr[2],
  SAFETY_POLICY_NOTICE: arr[3],
  SAFETY_SYSTEM_NOTIFICATION: arr[4],
  AGE_VERIFICATION_SYSTEM_NOTIFICATION: arr[5],
  VOICE_CHANNEL: arr[6],
  POLL_RESULT: arr[7],
} = MessageEmbedTypes);
const items1 = [, , , , , , , ,];
({
  ...
  AUTO_MODERATION_NOTIFICATION: arr2[1],
  AGE_VERIFICATION_SYSTEM_NOTIFICATION: arr2[2],
  APPLICATION_NEWS: arr2[3],
  POST_PREVIEW: arr2[4],
  SAFETY_POLICY_NOTICE: arr2[5],
  SAFETY_SYSTEM_NOTIFICATION: arr2[6],
