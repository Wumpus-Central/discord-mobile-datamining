// === Module 5921: useStartAuthorize ===

// Module 5921 (useStartAuthorize)
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "noop" /* 19 */;
import { AuthorizeFlow } from "AuthorizeFlow" /* 5922 */;
...
export default function useStartAuthorize(getOfficialApplicationId) {
  ...
  const authorizationApp = _require(5923).useAuthorizationApp(getOfficialApplicationId);
  ...
  const authorizedAppsToken = _require(5925).useAuthorizedAppsToken(parentId);
