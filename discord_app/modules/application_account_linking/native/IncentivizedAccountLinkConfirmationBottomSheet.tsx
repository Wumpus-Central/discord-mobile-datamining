...
import _modDef15914 from "../../../../discord_assets/assets/orbs/orb_coachmark_asset_2x.png.js";
import _modDef15915 from "../../../../discord_assets/assets/orbs/orb_coachmark_asset_2x_animated.png.js";
...
export default function IncentivizedAccountLinkConfirmationBottomSheet() {
  ...
  if (obj.useStateFromStores(items, () => useReducedMotion.useReducedMotion)) {
    ...
    obj = { uri: _modDef15914 };
    obj.source = obj;
    const size = { width: v150, height: v150 };
    obj.style = size;
    let tmp3Result = <Image uri={_modDef15914} />;
