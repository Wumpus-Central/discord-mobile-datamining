// === Module 11417: useSafeAreaAvoidingInputs ===

// Module 11417 (useSafeAreaAvoidingInputs)
import nativeDefault from "native" /* 576 */;
import useKeyboardDuration from "useKeyboardDuration" /* 5799 */;
import ViewMeasureUtils from "ViewMeasureUtils" /* 11418 */;
...
export default function useSafeAreaAvoidingInputs(insets) {
  ...
  onFocus = onFocus.useCallback(asyncGeneratorStep(async () => {
    if (c3 === 2) {
      c3 = 3;
      throw new TypeError("Generator functions may not be called on executing generators");
    } else if (tmp4 === 3) {
      ...
      try {
        ...
        if (0 === dependencyMap) {
          if (arg0 === 1) {
            ...
            if (null != found) {
              if (null != current2) {
                dependencyMap = 1;
                c3 = 1;
                const obj4 = { value: tmp2(11418).measureViewRefInWindow(found.ref), done: false };
                return obj4;
              }
            }
          }
          ...
          if (arg0 === 1) {
            ...
            dependencyMap = 2;
            c3 = 1;
            const obj6 = { value: tmp2(11418).measureViewRefInView(closure_128_1.ref, closure_128_0), done: false };
            return obj6;
          }
        } else {
          if (2 === tmp5) {
            if (arg0 === 1) {
              ...
              if (null != closure_128_2) {
                if (null != closure_128_3) {
                  dependencyMap = 3;
                  c3 = 1;
                  const obj9 = { value: tmp2(11418).measureViewInWindow(closure_128_0), done: false };
                  return obj9;
                }
              }
            }
