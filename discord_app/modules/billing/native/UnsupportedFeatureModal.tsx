...
export default function UnsupportedFeatureModal(onDismiss) {
  ...
  obj[1] = onDismiss(5269).getHeaderCloseButton(() => {
  ...
  obj[2] = function render() {
    ...
    obj[1] = callback(onDismiss(4298).Text, obj);
    return callback(closure_3, obj);
  };
  obj[0] = obj;
  obj[1] = obj;
  return jsx(onDismiss(5723).Navigator, { title: onDismiss.title, headerLeft: null, render: null });
};