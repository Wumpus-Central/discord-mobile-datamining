// === Module 10320: UnsupportedFeatureModal ===
...
export default function UnsupportedFeatureModal(onDismiss) {
  ...
  obj = {
    ...
    headerLeft: onDismiss(5442).getHeaderCloseButton(() => {
    ...
    render() {
      ...
      obj[1] = callback(onDismiss(4440).Text, obj);
      return callback(closure_3, obj);
    }
  };
  obj[0] = obj;
  obj[1] = obj;
  return jsx(onDismiss(5955).Navigator, {
    title: onDismiss.title,
    headerLeft: onDismiss(5442).getHeaderCloseButton(() => {
      let arr = closure_1_1(closure_1_2[5]);
      arr = arr.pop();
