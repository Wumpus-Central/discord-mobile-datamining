...
createStyles = { padding: 10, marginVertical: 5, borderRadius: nativeDefault.radii.xs, display: "flex", flexDirection: "row", alignItems: "center", backgroundColor: fn(5522).DARK_PRIMARY_630_LIGHT_PRIMARY_230 };
