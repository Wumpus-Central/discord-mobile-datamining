...
const apexExperiment = ApexExperiment.createApexExperiment({
  name: "2026-03-nitro-acom-subscription",
  kind: "user",
...
const apexExperiment1 = ApexExperiment.createApexExperiment({
  name: "2026-03-acom-modify-dark-launch",
  kind: "user",
  defaultConfig: { enabled: false },
  variations: obj,
});
...
const apexExperiment4 = ApexExperiment.createApexExperiment({
  name: "2026-07-nitro-acom-trials",
  kind: "user",
  defaultConfig: { enabled: false },
  variations: obj3,
});
...
const apexExperiment5 = ApexExperiment.createApexExperiment({
  name: "2026-07-nitro-acom-discounts",
  kind: "user",
  defaultConfig: { enabled: false },
  variations: obj4,
});
