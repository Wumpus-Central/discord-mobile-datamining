// === Module 13347: BillingInformation ===
...
export const getBillingInformationStringNative = function getBillingInformationStringNative(subscription, subscriptionPeriodStart) {
  let tmp = first1;
  if (first1 === undefined) {
    tmp = null;
  }
