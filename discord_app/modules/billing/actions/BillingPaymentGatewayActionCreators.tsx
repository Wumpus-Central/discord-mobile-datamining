...
function _confirmEPS() {
  ...
  const tmp = callback((arg0, arg1, arg2, arg3) => {
    ...
    return (function* (arg0, arg1, arg2, arg3) {
      ...
      c4 = tmp2;
      if (null == lib) {
        throw lib(4838).dispatchConfirmationError("Stripe not loaded");
      }
      if (null == tmp62) {
        throw lib(4838).dispatchConfirmationError("Bank required for EPS");
      }
      ({ email: c4, name } = tmp63);
...
function _createExpressCheckoutPaymentMethod() {
  ...
  const tmp = callback((arg0) => {
    ...
    const iter = (function* (arg0) {
      ...
      yield "PX_16";
      let obj4 = callback(4838);
      dependencyMap = yield obj4.validatePaymentSourceBillingAddress(c1);
      const obj = callback(4838);
      obj4 = { billingAddressToken: null, analyticsLocation: null };
      obj4[0] = dependencyMap;
      obj4[1] = c2;
      return obj.createPaymentSource(constants.STRIPE, callback, c1, obj4);
    })();
    iter.next();
    return iter;
  });
            ...
            switch (client_secret) {
              case 0:
                if (arg0 === 1) {
                  ...
                  closure_11 = 2;
                  ({
                    billingAddress: closure_2,
                    paymentSourceType: closure_3,
                    lastConfirmedSetupIntentRef: closure_4,
                    createSetupIntent: closure_5,
                  } = ref);
                  closure_11 = 0;
                  ref = undefined;
                        ...
                        if (dependencyMap === closure_10.PAYMENT_REQUEST) {
                          ...
                          v0 = callback2(closure_10.setupIntent, closure_10.error, (error) => {
                            ...
                            return obj.dispatchConfirmationError(
                              error,
                              true,
                              intl.string(callback(throwTypeErrorResult[5]).t.khEaRI),
                              obj,
                            );
                          }).setupIntent;
                          throwTypeErrorResult = ref;
        ...
        try {
          ...
          if (0 === setupIntent) {
            if (arg0 === 1) {
              ...
              throw lib(4838).dispatchConfirmationError("Stripe or token not loaded");
            }
          } else if (1 === tmp7) {
            closure_7 = 0;
            c9 = constants;
            ...
            if (arg0 === 1) {
              ...
              constants = callback2(4843).parseBillingAddressInfoToStripeBillingDetails(callback2);
            ...
            setupIntent = callback3(closure_7.setupIntent, closure_7.error, (error) =>
              callback(table[6]).dispatchConfirmationError(error),
            ).setupIntent;
            const obj15 = lib(4838);
        ...
        try {
          ...
          if (0 === c12) {
            ...
            if (arg0 === 1) {
              ...
              closure_8 =
                aPIBaseURL + closure_5.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(callback2, constants, "success");
              c10 = 1;
              closure_7 = {};
            ...
            if (c10.code !== callback(paymentMethod[12]).ErrorCodes.CONFIRMATION_REQUIRED) {
              ...
              const billingError = new callback(paymentMethod[13]).BillingError(
                combined,
                callback(paymentMethod[13]).BillingError.ErrorCodes.UNKNOWN,
              );
              obj9[1] = billingError;
              obj4.dispatch(obj9);
              throw c10;
          ...
          try {
            ...
            if (0 === name) {
              ...
              if (arg0 === 1) {
                ...
                let tmp84 = null;
                if (null == lib2) {
                  const billingError = new lib(email[13]).BillingError(
                    "Stripe not loaded",
                    lib(email[13]).BillingError.ErrorCodes.UNKNOWN,
                  );
                  throw billingError;
                } else {
                  throwTypeErrorResult = billingAddress;
                      ...
                      if (country.BANCONTACT === type) {
                        ...
                        if (country.IDEAL === type) {
                          ...
                          if (country.PRZELEWY24 === type) {
                            if (tmp84 == lib.bank) {
                              const billingError1 = new lib(email[13]).BillingError(
                                "p24 missing bank information",
                                lib(email[13]).BillingError.ErrorCodes.UNKNOWN_PAYMENT_SOURCE,
                              );
                              throw billingError1;
                            } else {
                              obj3.type = "p24";
                        ...
                        if (tmp84 == lib.bank) {
                          const billingError2 = new lib(email[13]).BillingError(
              ...
              const _HermesInternal = HermesInternal;
              const combined = "Unable to create payment source token: code: " + code + " message: " + message;
              const billingError3 = new lib(email[13]).BillingError(
                combined,
                lib(email[13]).BillingError.ErrorCodes.UNKNOWN,
              );
              throw billingError3;
