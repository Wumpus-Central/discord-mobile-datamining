      ...
      if (0 === c13) {
        if (arg0 === 1) {
          ...
          if (null != importDefault.paymentSource) {
            c13 = 2;
            c14 = 1;
            const obj5 = { value: BillingPaymentGatewayActionCreators.createPaymentSourceToken(importDefault.paymentSource), done: false };
            return obj5;
          }
        }
      } else if (1 === tmp8) {
...
export const deleteRenewalMutation = function deleteRenewalMutation(currency, analyticsLocations) {
  return updateSubscription(currency, { items: currency.items }, { amount: 0, currency: currency.currency }, PremiumUtils.getItemPlansTotalServerPrice(currency.items, currency.currency, currency.paymentSourceId), analyticsLocations);
};
...
export const resubscribeToSubscription = function resubscribeToSubscription(currency, analyticsLocations, id, arg3, arg4) {
  ...
  return updateSubscription(currency, { status: constants.ACTIVE, paymentSource: id, currency: arg3 }, { amount: 0, currency: currency.currency }, PremiumUtils.getItemPlansTotalServerPrice(items, currency, id), analyticsLocations, arg4);
};
export const upgradeSubscription = function upgradeSubscription(renewalMutations, basePlanId, arg2, itemPlansTotalServerPrice, analyticsLocations, arg5) {
  return updateSubscription(renewalMutations, { status: constants.ACTIVE, items: PremiumUtils.getItemsWithUpsertedPremiumPlanId(renewalMutations, basePlanId) }, arg2, itemPlansTotalServerPrice, analyticsLocations, arg5);
};
export const changeSubscriptionCurrency = function changeSubscriptionCurrency(currency, currency, itemPlansTotalServerPrice, analyticsLocations, arg4) {
  return updateSubscription(currency, { currency }, { amount: 0, currency: currency.toLowerCase() }, itemPlansTotalServerPrice, analyticsLocations, arg4);
};
export const changePaymentSource = function changePaymentSource(currency, paymentSource, currency, analyticsLocations, arg4) {
  return updateSubscription(currency, { paymentSource }, { amount: 0, currency: currency.currency }, currency, analyticsLocations, arg4);
};
