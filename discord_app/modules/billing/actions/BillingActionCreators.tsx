      ...
      try {
        ...
        if (0 === c6) {
          if (arg0 === 1) {
            ...
            ({
              expiresMonth: obj12.expires_month,
              expiresYear: obj12.expires_year,
              isDefault: obj12.default,
            } = billingAddress);
            request.body = obj6;
            c6 = 2;
            c7 = 1;
        ...
        if (arg0 === 1) {
          ...
          if (BillingInfoStore.isPaymentSourceFetching) {
            ...
            DispatcherDefault.wait(() =>
              closure_1(closure_2[8]).dispatch({ type: "BILLING_PAYMENT_SOURCES_FETCH_START", request }),
            );
            c4 = 2;
            c5 = 1;
      ...
      try {
        ...
        if (0 === c5) {
          if (arg0 === 1) {
            ...
            const HTTP = HTTPUtils.HTTP;
            const request = {
              url: closure_2_10.BILLING_WALLET_INFORMATION(paymentSourceId),
              query: { get_history: false },
          ...
          const obj12 = {
            ...
            currency: closure_129_2.currency,
            amount: closure_129_2.amount,
          };
    ...
    try {
      ...
      if (0 === c6) {
        ...
        if (arg0 === 1) {
          ...
          const request = {
            url: closure_131_10.BILLING_PAYMENTS,
            query: null,
            oldFormErrors: true,
            rejectWithError: false,
          };
    ...
    try {
      ...
      if (0 === c4) {
        ...
        if (null == closure_128_1.body) {
          ...
          const billingError = new closure_129_0(closure_129_2[10]).BillingError(
            "response body is null, response: " + JSON.stringify(closure_128_1),
            closure_128_1.status,
          );
          throw billingError;
        } else {
          const obj9 = {
            type: "BILLING_SUBSCRIPTION_FETCH_SUCCESS",
            subscriptions: closure_128_1.body,
            lastLazyPerkSync: closure_128_0,
          };
          closure_129_1(closure_129_2[8]).dispatch(obj9);
          c3 = 0;
          c5 = 3;
...
let closure_29 = async function _getPerksRelevance() {
  ...
  if (1 === tmp7) {
    ...
    closure_128_0 = value;
    closure_129_1(closure_129_2[8]).dispatch({
      type: "BILLING_PERKS_RELEVANCE_FETCH_SUCCESS",
      res: closure_128_0.body,
    });
    c3 = 0;
    closure_129_1(closure_129_2[8]);
  }
...
let closure_30 = async function _fetchMostRecentSubscription() {
  ...
  const request = {
    url: constants.BILLING_SUBSCRIPTIONS,
    query: { include_inactive: true, limit: 2, exclude_unpaid_statuses: true, subscription_type: constants2.PREMIUM },
    oldFormErrors: true,
    rejectWithError: true,
  };
    ...
    try {
      ...
      if (0 === c10) {
        if (arg0 === 1) {
          ...
          ({
            items: closure_135_0,
            paymentSource: closure_135_1,
            trialId: closure_135_2,
            code: closure_135_3,
            currency: closure_135_4,
            metadata: closure_135_5,
            referralCode: closure_135_6,
            loadId: closure_135_7,
            expectedInvoicePrice: closure_135_8,
            expectedRenewalPrice: closure_135_9,
          } = closure_0);
        ...
        if (1 === tmp6) {
          if (arg0 === 1) {
            ...
            if (null != closure_135_1) {
              if (closure_134_15.has(closure_135_1.type)) {
                ...
                c11 = 1;
                const obj5 = {
                  value: closure_134_0(closure_134_2[14]).popupBridgeState(closure_135_1.type),
                  done: false,
                };
                return obj5;
              }
          ...
          if (2 === tmp6) {
            if (arg0 === 1) {
              ...
              closure_135_10 =
                aPIBaseURL +
                closure_134_10.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(closure_135_1.type, c1, "success");
            ...
            if (closure_135_13.code !== closure_134_0(closure_134_2[11]).ErrorCodes.CONFIRMATION_REQUIRED) {
              ...
              throw closure_134_0(closure_134_2[14]).dispatchConfirmationError(
        ...
        if (null != closure_135_1) {
          ...
          c11 = 1;
          const obj24 = {
            value: closure_134_0(closure_134_2[15]).createPaymentSourceToken(closure_135_1),
            done: false,
          };
          return obj24;
        }
      ...
      if (0 === c14) {
        if (arg0 === 1) {
          ...
          if (null != dependencyMap) {
            if (set.has(dependencyMap.type)) {
              c14 = 1;
              c15 = 1;
              const obj5 = { value: BillingSharedActionCreators.popupBridgeState(dependencyMap.type), done: false };
              return obj5;
            }
          }
        }
        ...
        if (1 === tmp8) {
          if (arg0 === 1) {
            ...
            closure_139_5 =
              aPIBaseURL +
              closure_138_10.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(closure_139_2.type, c5, "success");
          ...
          if (closure_139_8.code !== closure_138_0(closure_138_2[11]).ErrorCodes.CONFIRMATION_REQUIRED) {
            ...
            throw closure_138_0(closure_138_2[14]).dispatchConfirmationError(
              "payment id cannot be null on redirected confirmations.",
            );
          }
        } else if (3 === tmp8) {
          ...
          const obj17 = {
            subscription: closure_139_7.body,
            redirectConfirmation: closure_138_12.has(closure_139_2.type),
          };
          c12 = 0;
          c15 = 3;
...
function handlePaymentConfirmation(body, type) {
  if (null != type) {
    if (set.has(type.type)) {
      const adyenPaymentConfirmationHandler = new HandleConfirmPaymentRegistry.AdyenPaymentConfirmationHandler(
        type,
        body,
      );
  ...
  const stripePaymentConfirmationHandler = new HandleConfirmPaymentRegistry.StripePaymentConfirmationHandler(
    type,
    body,
  );
}
      ...
      try {
        ...
        if (0 === c7) {
          if (arg0 === 1) {
            ...
            const HTTP = HTTPUtils.HTTP;
            const request = {
              url: closure_2_10.BILLING_SUBSCRIPTION(closure_0),
              query: null,
              oldFormErrors: true,
              rejectWithError: false,
            };
...
let closure_37 = async function _updateSubscription(arg0) {
  if (c14 === 2) {
    ...
    try {
      ...
      if (0 === c13) {
        if (arg0 === 1) {
          ...
          if (null != importDefault.paymentSource) {
            ...
            c14 = 1;
            const obj5 = {
              value: BillingPaymentGatewayActionCreators.createPaymentSourceToken(importDefault.paymentSource),
              done: false,
            };
            return obj5;
          }
        ...
        if (3 === tmp8) {
          if (arg0 === 1) {
            ...
            if (null != closure_137_1.paymentSource) {
              if (closure_138_15.has(closure_137_1.paymentSource.type)) {
                ...
                c14 = 1;
                const obj13 = {
                  value: closure_138_0(closure_138_2[14]).popupBridgeState(closure_137_1.paymentSource.type),
                  done: false,
                };
                return obj13;
              }
          ...
          if (arg0 === 1) {
            ...
            closure_137_7.return_url =
              aPIBaseURL +
              closure_138_10.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(
                closure_137_1.paymentSource.type,
                c7,
                "success",
              );
        ...
        const HTTP = closure_138_0(closure_138_2[9]).HTTP;
        const request = {
          url: closure_138_10.BILLING_SUBSCRIPTION(closure_137_0.id),
          query: null,
          body: null,
          oldFormErrors: true,
          rejectWithError: false,
      ...
      c14 = 1;
      const obj25 = {
        value: closure_138_0(closure_138_2[16]).createGatewayCheckoutContext(closure_137_1.paymentSource),
        done: false,
      };
      return obj25;
    } catch (tmp99) {
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          closure_130_1(closure_130_2[8]).wait(() =>
            request(closure_2[8]).dispatch({ type: "BILLING_IP_COUNTRY_CODE_FETCH_START", request }),
          );
          c5 = 3;
          c6 = 1;
    ...
    try {
      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          closure_130_1(closure_130_2[8]).wait(() =>
            request(closure_2[8]).dispatch({ type: "BILLING_IP_LOCATION_FETCH_START", request }),
          );
          c5 = 3;
          c6 = 1;
...
export const deleteRenewalMutation = function deleteRenewalMutation(currency, analyticsLocations) {
  return updateSubscription(
    ...
    { amount: 0, currency: currency.currency },
    PremiumUtils.getItemPlansTotalServerPrice(currency.items, currency.currency, currency.paymentSourceId),
    analyticsLocations,
  );
};
export { updateSubscription };
export const resubscribeToSubscription = function resubscribeToSubscription(
  currency,
  analyticsLocations,
  id,
  arg3,
  ...
  return updateSubscription(
    currency,
    { status: constants.ACTIVE, paymentSource: id, currency: arg3 },
    { amount: 0, currency: currency.currency },
    PremiumUtils.getItemPlansTotalServerPrice(items, currency, id),
    analyticsLocations,
    arg4,
  );
};
export const upgradeSubscription = function upgradeSubscription(
  ...
  return updateSubscription(
    renewalMutations,
    { status: constants.ACTIVE, items: PremiumUtils.getItemsWithUpsertedPremiumPlanId(renewalMutations, basePlanId) },
    arg2,
    itemPlansTotalServerPrice,
    analyticsLocations,
    arg5,
...
export const changeSubscriptionCurrency = function changeSubscriptionCurrency(
  ...
  return updateSubscription(
    currency,
    { currency },
    { amount: 0, currency: currency.toLowerCase() },
    itemPlansTotalServerPrice,
    analyticsLocations,
    arg4,
  );
};
export const changePaymentSource = function changePaymentSource(
  currency,
  paymentSource,
  currency,
  analyticsLocations,
