      ...
      try {
        ...
        if (0 === stripe) {
          ...
          if (arg0 === 1) {
            ...
            obj5[0] = outer1_2(outer1_0, obj4, { handleActions: false });
            return obj5;
          }
        } else if (arg0 === 1) {
          c4 = 3;
          ...
          c4 = arg1;
          paymentIntent = c4.paymentIntent;
          error = c4.error;
          if (null != error) {
      ...
      try {
        ...
        if (0 === stripe) {
          ...
          if (arg0 === 1) {
            ...
            stripe = outer1_1.stripeConfirmPayment;
            paymentMethod = outer1_1.paymentMethod;
