  ...
  if (flag) {
    ...
    if (null != isFetching.currentUser) {
      ...
      if (null == first) {
        ...
        if (null != first) {
          let tmp11 = _modDef4196(first.startsAt);
        } else {
          tmp11 = _modDef4196(0);
        }
        obj2.startsAt = tmp11;
        if (null != first) {
          ...
          let tmp2ResultResult = _modDef4196(
          ...
          const tmp2Result = _modDef4196;
        } else {
          tmp2ResultResult = _modDef4196(0);
        }
        ...
        if (null != first) {
          let tmp18 = _modDef4196(first.endsAt);
        } else {
          tmp18 = _modDef4196(0);
        }
