  ...
  if (flag) {
    ...
    if (null != isFetching.currentUser) {
      ...
      if (null == first) {
        ...
        if (null != first) {
          let tmp11 = _modDef4166(first.startsAt);
        } else {
          tmp11 = _modDef4166(0);
        }
        obj2.startsAt = tmp11;
        if (null != first) {
          ...
          let tmp2ResultResult = _modDef4166(
          ...
          const tmp2Result = _modDef4166;
        } else {
          tmp2ResultResult = _modDef4166(0);
        }
        ...
        if (null != first) {
          let tmp18 = _modDef4166(first.endsAt);
        } else {
          tmp18 = _modDef4166(0);
        }
