...
export const useHomeGesture = function useHomeGesture() {
  ...
  const memo = obj11.useMemo(() => {
    ...
    settleDrawer = function settleDrawer(flag) {
      ...
      const result1 = settleDrawer.set(landOnHome(snapX[10]).withTiming(num, landOnHome(snapX[11]).HOME_DRAWER_SETTLE_TIMING, "animate-always"));
      const obj = landOnHome(snapX[10]);
      const result2 = fireThrow.set(landOnHome(snapX[10]).withTiming(0, landOnHome(snapX[11]).HOME_DRAWER_SETTLE_TIMING, "animate-always"));
    ...
    fn3.__closure = { gestureState: shouldOpenFromPosition, dragOffsetX: sharedValue, panelX: settleDrawer, snapX: fireThrow, INITIAL_OPEN_WIDTH: sharedValue, DRAWER_RESISTANCE: 3, SNAP_OPEN_DISTANCE: sharedValue1, MAX_HOME_DRAWER_ANIMATING_WIDTH: sharedValue2, FLING_THROW_MIN_VELOCITY: 400, snappedByDrag: sharedValue6, fireThrow };
    fn3.__workletHash = 7401507013781;
    fn3.__initData = derivedValue1;
    const obj7 = { gestureState: shouldOpenFromPosition, dragOffsetX: sharedValue, panelX: settleDrawer, snapX: fireThrow, INITIAL_OPEN_WIDTH: sharedValue, DRAWER_RESISTANCE: 3, SNAP_OPEN_DISTANCE: sharedValue1, MAX_HOME_DRAWER_ANIMATING_WIDTH: sharedValue2, FLING_THROW_MIN_VELOCITY: 400, snappedByDrag: sharedValue6, fireThrow };
