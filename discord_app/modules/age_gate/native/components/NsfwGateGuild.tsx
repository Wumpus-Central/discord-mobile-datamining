...
const NsfwGateSource = fn(10560).NsfwGateSource;
...
export default function NsfwGateGuild(guildId) {
  ...
  const items1 = [closure_11(currentUser(7220), {}), , , , , ];
  const formatResult = intl3.format(guildId(1115).t.Z12LNW, obj);
  items1[1] = closure_11(closure_5, { source: currentUser(10561), style: tmp.image });
  items1[2] = closure_11(guildId(4753).Text, { style: tmp.header, variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: stringResult });
  items1[3] = closure_11(guildId(4753).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: stringResult1 });
  items1[4] = closure_11(guildId(4753).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: formatResult });
  ...
  items1[5] = closure_11(guildId(5187).Button, obj8);
