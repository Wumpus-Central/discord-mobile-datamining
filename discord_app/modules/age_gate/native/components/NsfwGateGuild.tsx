...
export default function NsfwGateGuild(guildId) {
  ...
  obj = { source: currentUser(10367), style: tmp.image };
  ...
  items1[2] = closure_11(guildId(4601).Text, obj1);
  ...
  items1[4] = closure_11(guildId(4601).Text, { style: tmp.description, variant: "text-md/normal", color: "text-default", children: intl3.format(guildId(1114).t.Z12LNW, obj) });
  ...
  items1[5] = closure_11(guildId(5025).Button, obj4);
  obj.children = items1;
