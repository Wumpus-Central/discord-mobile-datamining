...
export default noop.forwardRef((date, arg1) => {
  ...
  function openDatePicker() {
    ...
    obj.openLazy(asyncRequireImpl(9808, dependencyMap.paths), "DatePicker", obj);
  ...
  let tmp4 = label;
  const tmp5 = require("../../../../../_runtime/metro/04198__.js");
  const formatResult1 = require("../../../../../_runtime/metro/04198__.js")(obj.toDate()).format("L");
  obj = {
    style,
    ref,
    value: null,
  ...
  const tmp5Result = require("../../../../../_runtime/metro/04198__.js")(obj.toDate());
