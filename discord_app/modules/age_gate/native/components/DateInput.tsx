...
export default noop.forwardRef((date, arg1) => {
  ...
  function openDatePicker() {
    ...
    obj.openLazy(asyncRequireImpl(9749, dependencyMap.paths), "DatePicker", obj);
    const tmp4 = asyncRequireImpl(9749, dependencyMap.paths);
  }
  ({ style, error } = date);
  ref = ref.useRef(null);
  ...
  let obj = require("../../../../../_runtime/metro/04166__.js")();
  let result = obj.set("year", obj.year() - 10);
  let tmp4 = label;
  const tmp5 = require("../../../../../_runtime/metro/04166__.js");
  const formatResult1 = require("../../../../../_runtime/metro/04166__.js")(obj.toDate()).format("L");
  obj = {
    style,
    ref,
    value: null,
  ...
  const tmp5Result = require("../../../../../_runtime/metro/04166__.js")(obj.toDate());
