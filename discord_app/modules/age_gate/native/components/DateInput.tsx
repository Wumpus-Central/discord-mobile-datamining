...
export default noop.forwardRef((date, arg1) => {
  ...
  let obj = require("../../../../../_runtime/metro/04314__.js")();
  let result = obj.set("year", obj.year() - 10);
  let tmp4 = label;
  const tmp5 = require("../../../../../_runtime/metro/04314__.js");
  const formatResult1 = require("../../../../../_runtime/metro/04314__.js")(obj.toDate()).format("L");
  let obj2 = {
    style,
    ref,
    value: null,
  ...
  const tmp5Result = require("../../../../../_runtime/metro/04314__.js")(obj.toDate());
