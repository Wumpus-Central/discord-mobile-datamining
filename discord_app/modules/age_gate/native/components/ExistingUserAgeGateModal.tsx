...
export default function ExistingUserAgeGateModal(source) {
  ...
  const items = [source];
  const watchAgeVerificationStatusChange = source(4500).useWatchAgeVerificationStatusChange(React.useCallback(() => {
    if (ref.current) {
    ...
    if (outer1_6.NSFW_SERVER_INVITE !== closure_0) {
      ...
      obj[5] = function render(arg0, arg1) {
        ...
        fn = () => {
          ...
          obj = { key: "AGE_GATE_AGE_VERIFIED", icon: callback(16265), content: null };
          const intl = arr(1236).intl;
          obj[2] = intl.string(arr(1236).t.gUiIGZ);
          callback(3985).open(obj);
        };
      };
      ...
      obj2[3] = function render(arg0) {
        const merged = Object.assign(arg0);
        return callback3(callback2(15035), {});
      };
      ...
      obj3[2] = function render() {
        return callback3(callback2(8603), { onClose: closure_10 });
      };
  ...
  return jsx(source(5704).Navigator, { screens: null, initialRouteName: null, headerBackTitle: null });
};