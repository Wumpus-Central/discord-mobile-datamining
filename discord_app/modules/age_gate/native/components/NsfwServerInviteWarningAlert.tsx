// discord_app/modules/age_gate/native/components/NsfwServerInviteWarningAlert.tsx
...
class NsfwServerInviteWarningAlert {
  constructor(arg0) {
    ...
    tmp8Result = tmp8(
      tmp(tmp2[7]).AlertActionButton,
      { variant: str, text: confirmText, onPress: callback },
      "confirm",
    );
    str2 = "secondary";
    if (goBackIsPrimary) {
