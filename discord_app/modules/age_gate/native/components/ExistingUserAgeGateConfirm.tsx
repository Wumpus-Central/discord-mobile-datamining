// === Module 16650: ExistingUserAgeGateConfirm ===
...
export default function ExistingUserAgeGateConfirm(age) {
  ...
  const items = [callback2(onConfirm(4376).Text, obj), , ];
  ...
  items[1] = callback2(onConfirm(4376).Text, obj1);
  ...
  obj3[1] = callback2(onConfirm(4815).Button, obj4);
  items[2] = callback2(View, obj3);
  obj[2] = items;
  return callback3(onConfirm(5434).SafeAreaPaddingView, obj);
};