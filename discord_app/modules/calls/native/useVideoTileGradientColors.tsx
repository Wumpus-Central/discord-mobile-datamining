  ...
  if (null != modalV2BackgroundColor) {
    if (null != modalV2BackgroundColor) {
      ...
      const int2rgbArrayResult = tmp9Result.int2rgbArray(
        UserProfileGradientUtils.calculateModalV2BackgroundColor(modalV2BackgroundColor, modalV2BackgroundColor, DARK),
      );
      ...
      const valueInColorGradientByPercentage2 = UserProfileGradientUtils.getValueInColorGradientByPercentage(
        items2,
        items3,
        60,
      );
