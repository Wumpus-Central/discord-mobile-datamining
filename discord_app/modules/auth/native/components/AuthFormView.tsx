...
export default function AuthFormView(arg0) {
  ...
  _require = React.useContext(_require(7693).WideAuthScrollContext);
  if (tmp3) {
    ...
    const items3 = [callback(tmp(7695), obj2), callback(tmp(7698), {}), ];
