// === Module 14970: UsernameStatusMessage ===
...
function UsernameStatusMessage(arg0) {
  ...
  if (type === require(13876) /* NameValidationState */.NameValidationState.ERROR) {
    ...
    const items = [callback3(tmp3(7704).CircleErrorIcon, obj), ];
    ...
    obj[3] = items;
    let tmp6 = callback4(tmp3(4664).Stack, obj);
  } else {
    if (isUsernameFocused) {
      ...
      if (type1 === tmp3(13876).NameValidationState.AVAILABLE) {
        const obj2 = {};
...
export const RegisterUsernameInput = function RegisterUsernameInput(setUsername) {
  ...
  const tmp3 = importDefault(14962);
  ...
  let str2;
  if (type === tmp14(13876).NameValidationState.ERROR) {
    str2 = "error";
  }
  const obj1 = { children: null };
  obj[16] = str2;
  obj[17] = submitBehavior;
  const items3 = [closure_9(setUsername(7701).TextInput, obj), closure_9(UsernameStatusMessage, { usernameStatus, isUsernameFocused: tmp5[0] })];
  obj1[0] = items3;
