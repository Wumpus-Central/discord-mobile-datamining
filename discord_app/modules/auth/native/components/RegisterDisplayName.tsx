...
export default function RegisterDisplayName() {
  ...
  tmp12(
    require("RegistrationStepsUtils").getPreviousRegistrationTransitionStep(
      require("ConstantsIOS").AuthStates.REGISTER_DISPLAY_NAME,
    ),
  );
        ...
        try {
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const result = globalName(str[15]).handleNextOrSubmitRegistration(
                globalName(str[16]).AuthStates.REGISTER_DISPLAY_NAME,
                globalName,
                context,
              );
              c3 = 3;
