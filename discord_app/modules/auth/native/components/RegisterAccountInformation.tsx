...
export default function RegisterAccountInformation() {
  ...
  obj3 = { style: tmp4.container, children: closure_17(tmp5(16043).RegisterUsernameInput, { username, setUsername, onSubmitEditing: callback, usernameStatus, submitBehavior: "submit", autoFocus: true }) };
  ...
  obj4.children = closure_17(context(16044).RegisterPasswordInput, obj5);
  ...
  const items5 = [closure_17(context(5026).Button, obj7), ];
