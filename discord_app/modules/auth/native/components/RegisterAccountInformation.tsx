...
export default function RegisterAccountInformation() {
  ...
  const result = context(16349).hasAllRegistrationFieldsCompleted(obj6, {
  ...
  const items4 = [
    closure_17(closure_6, {
      ...
      children: closure_17(context(16367).RegisterUsernameInput, {
        username,
        setUsername,
  ...
  if (null != tmp11.message) {
    ...
    if ("" !== tmp11.message) {
      ...
      tmp27Result = closure_17(FreeFormErrorLabelDefault, obj15);
    }
  }
  ...
  if (!tmp3) {
    ...
    tmp27Result4 = closure_17(KeyboardAwareViewDefault, obj16);
  }
  return tmp27Result4;
}
