// === Module 15566: usePasswordRegistrationStep ===
...
const require = fn;
const useRegistrationUIStore = fn(15543).useRegistrationUIStore;
const size = fn(2);
...
export const usePasswordRegistrationStep = function usePasswordRegistrationStep() {
  ...
  return {
    ...
    validatePassword: noop.useCallback(asyncGeneratorStep(async () => {
      if (c4 === 2) {
        c4 = 3;
              ...
              if (null != first) {
                if ("" !== first) {
                  if (first.length < 8) {
                    ...
                    c1 = 2;
                    c4 = 1;
                    const obj7 = { value: tmp3(tmp25[7]).scorePassword(first), done: false };
                    return obj7;
                  }
                }
              }
