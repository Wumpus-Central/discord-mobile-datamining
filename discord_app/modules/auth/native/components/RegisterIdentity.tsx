...
function RegisterIdentityBase(inputMode) {
  ...
  const identityRegistrationStep = inputMode(16298).useIdentityRegistrationStep(
    inputMode(1094).AuthStates.REGISTER_IDENTITY,
    inputMode,
  );
  ...
  items1[1] = closure_14(inputMode(16305).RegisterPhoneOrEmailInput, {
    loginPhone,
    loginEmail,
...
export const RegisterIdentity = function RegisterIdentity() {
  ...
  obj4.controlComponent = closure_14(closure_6, {
    ...
    children: closure_14(hasItem(9897).SegmentedControl, {
