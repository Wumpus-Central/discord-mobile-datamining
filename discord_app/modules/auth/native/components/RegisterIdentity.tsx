...
function RegisterIdentityBase(inputMode) {
        ...
        if (0 === c1) {
          if (arg0 === 1) {
            ...
            if (inputMode === tmp3(tmp31[18]).PhoneOrEmailSelectorForceMode.EMAIL) {
              const obj2 = { email, phoneToken: "Array" };
              closure_1_10(obj2);
              const tmp26 = React5();
              if (null != tmp26) {
  ...
  setInputMode(16044)(obj3.getPreviousRegistrationTransitionStep(inputMode(1093).AuthStates.REGISTER_IDENTITY));
  setInputMode(5042)(() => {
  ...
  obj1.children = closure_14(inputMode(5025).Button, obj2);
...
let closure_16 = createStyles.createStyles((minHeight) => {
  let obj = { container: { marginTop: 24, flex: 1 }, page: { flex: 1 }, button: { width: "100%", marginTop: 24 }, errors: { marginTop: 4 }, segmentedControl: null, scrollContent: { paddingBottom: 128 } };
...
export const RegisterIdentity = function RegisterIdentity() {
  ...
  const segmentedControlState = hasItem(9862).useSegmentedControlState(obj);
  ...
  obj1 = { style: tmp3.segmentedControl, children: closure_14(tmp(9863).SegmentedControl, { state: segmentedControlState, keyboardShouldPersistTaps: "handled" }) };
