...
function RegisterIdentityBase(inputMode) {
  ...
  const identityRegistrationStep = inputMode(15553).useIdentityRegistrationStep(
  ...
  items1[1] = closure_14(inputMode(15560).RegisterPhoneOrEmailInput, {
    loginPhone,
    loginEmail,
...
export const RegisterIdentity = function RegisterIdentity() {
  ...
  obj4.controlComponent = closure_14(closure_6, {
    ...
    children: closure_14(hasItem(9073).SegmentedControl, {
