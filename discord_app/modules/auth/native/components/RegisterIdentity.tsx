...
function RegisterIdentityBase(inputMode) {
  ...
  const tmp2 = closure_16(45 * Math.min(2, inputMode(5288).useFontScale()));
  let obj = inputMode(5288);
  const tmp4 = setInputMode(6363)();
  dependencyMap = inputMode(1485).useNavigation();
  ...
  obj7.children = closure_14(inputMode(5281).Button, obj8);
...
export const RegisterIdentity = function RegisterIdentity() {
  ...
  obj4.controlComponent = closure_14(closure_6, { style: tmp3.segmentedControl, children: closure_14(hasItem(9084).SegmentedControl, { state: segmentedControlState, keyboardShouldPersistTaps: "handled" }) });
