...
function RegisterIdentityBase(inputMode) {
  ...
  let obj3 = inputMode(15978);
  setInputMode(15995)(obj3.getPreviousRegistrationTransitionStep(inputMode(1093).AuthStates.REGISTER_IDENTITY));
  setInputMode(5006)(() => {
  ...
  obj1.children = closure_14(inputMode(4989).Button, obj2);
...
export const RegisterIdentity = function RegisterIdentity() {
  ...
  const segmentedControlState = hasItem(9824).useSegmentedControlState(obj);
  ...
  obj1 = { style: tmp3.segmentedControl, children: closure_14(tmp(9825).SegmentedControl, { state: segmentedControlState, keyboardShouldPersistTaps: "handled" }) };
