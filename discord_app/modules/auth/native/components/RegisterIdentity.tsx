...
export const RegisterIdentity = function RegisterIdentity() {
  ...
  obj1 = { style: tmp3.segmentedControl, children: closure_14(tmp(9798).SegmentedControl, { state: segmentedControlState, keyboardShouldPersistTaps: "handled" }) };
