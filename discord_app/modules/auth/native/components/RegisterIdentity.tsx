...
function RegisterIdentityBase(inputMode) {
  ...
  items1[1] = closure_14(inputMode(15963).RegisterPhoneOrEmailInput, { loginPhone, loginEmail, setLoginPhone: updateLoginPhone, setLoginEmail, inputMode, onSubmit: handleSubmit, inputError: identityError, autoFocus: true });
...
export const RegisterIdentity = function RegisterIdentity() {
  ...
  obj1 = { style: tmp3.segmentedControl, children: closure_14(tmp(9793).SegmentedControl, { state: segmentedControlState, keyboardShouldPersistTaps: "handled" }) };
