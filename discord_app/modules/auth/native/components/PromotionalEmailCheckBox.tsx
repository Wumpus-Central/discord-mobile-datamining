...
export default function PromotionalEmailCheckBox(style) {
  ...
  if (tmp2) {
    ...
    obj = { accessibilityRole: tmp7, accessibilityLabel: null, accessibilityState: null, onPress: null, style: null, children: null };
    ...
    const items = [closure_6(tmp4(5668).FormCheckbox, obj1), ];
    ...
    items[1] = closure_6(tmp4(4602).Text, obj2);
    obj.children = items;
