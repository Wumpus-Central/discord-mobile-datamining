...
import createCacheKey from "createCacheKey";
import { registerAsset } from "../../../../../_runtime/12538_registerAsset.js";
import { registerAsset } from "../../../../../_runtime/13139_registerAsset.js";
...
function InviteCard(invite) {
  ...
  if (invite.state !== constants.RESOLVED) {
    ...
    obj3[2] = stringResult;
    const items2 = [tmp18(tmp17(4298).Text, obj3), ];
    const obj4 = { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: null };
    obj4[2] = name;
    items2[1] = tmp18(tmp17(4298).Text, obj4);
    obj2[1] = items2;
