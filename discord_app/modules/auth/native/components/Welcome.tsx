...
import registerAssetDefault from "registerAsset" /* 12817 */;
import registerAsset from "registerAsset" /* 13534 */;
import closure_3 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import closure_7 from "isUnderageAnonymous" /* 15471 */;
import closure_8 from "getHash" /* 4359 */;
import closure_9 from "handleGuildTemplateResolveSuccess" /* 7150 */;
import closure_10 from "initialize" /* 11915 */;
import closure_11 from "createdAt" /* 1931 */;
import closure_12 from "updateInvite" /* 4430 */;
import closure_13 from "getDisplayedInviteCode" /* 8805 */;
import ME from "ME" /* 676 */;
import { GuildTemplateStates } from "GUILD_TEMPLATES_MEMBER_COUNT_PROMOTION_THRESHOLD" /* 6136 */;
...
function InviteCard(invite) {
  ...
  if (invite.state !== constants.RESOLVED) {
    ...
    obj3[2] = stringResult;
    const items2 = [tmp18(tmp17(4442).Text, obj3), ];
    const obj4 = { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: null };
    obj4[2] = name;
    items2[1] = tmp18(tmp17(4442).Text, obj4);
    obj2[1] = items2;
