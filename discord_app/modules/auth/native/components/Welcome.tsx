...
function GuildTemplateCard(arg0) {
  ...
  const items2 = [closure_1_20(Text_Text.Text, obj1), closure_1_20(Text_Text.Text, { variant: "text-md/semibold", color: "mobile-text-heading-primary", children: guildTemplate.name })];
  obj.children = items2;
