...
createStyles = { height: fn(10333).AUTOCOMPLETE_ROW_HEIGHT, paddingVertical: 0, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH };
...
export default {
  User(user) {
    ...
    obj.trailing = closure_9(guildId(9873), obj1);
    return closure_9(user(8663).FormRow, obj);
  },
  Global(arg0) {
    ({ text, badge } = arg0);
