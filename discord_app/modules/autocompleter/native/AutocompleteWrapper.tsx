  ...
  const memo1 = onChangeAutoCompleteVisibility.useMemo(() => {
    ...
    if (null != text) {
      if (0 !== str.trim().length) {
        if (null != activeOption) {
          let applicationCommandOptionQueryOptions = analyticsLocations(canMentionEveryone[37]).getApplicationCommandOptionQueryOptions(activeOption);
            ...
            if (null != tmp5) {
              ...
              if (null == activeOption.choices) {
                ...
                if (flag) {
                  ...
                  const obj8 = { activeCommand, optionValues, isActiveApplicationCommand: flag, option: activeOption, choices, channelTypes };
        ...
        if (setting1) {
          if (null != anchor) {
            const obj9 = { query: str.slice(anchor + text.length, selectionEnd).toLowerCase(), autocompleteType: selectionEnd.GAME_MENTIONS, autocompleteSelectionStart: anchor, queryOptions: null };
            const obj10 = {};
        ...
        if (null != anchor2) {
          if (null == activeCommand) {
            const obj11 = { query: str.slice(anchor2 + selectionStart.length, selectionEnd), autocompleteType: selectionEnd.TIMESTAMPS, autocompleteSelectionStart: anchor2, queryOptions: null };
            const obj12 = {};
