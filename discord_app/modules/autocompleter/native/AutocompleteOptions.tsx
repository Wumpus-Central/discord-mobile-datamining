...
let c20 = false;
const executeCommand = apply.debounce(executeCommandDefault, fn(5297).AUTOCOMPLETE_OPTION_DEBOUNCE_TIME, {
  leading: true,
  trailing: true,
});
const size = fn(2);
        ...
        if (prop) {
          if (queryEmojiResultsResult.emojis.locked.length > 0) {
            ...
            if (tmp) {
              ...
              const items2 = [query];
              const items3 = [channel, (arg0, arg1) => arg1 === channel(7667).StickerSendability.SENDABLE];
