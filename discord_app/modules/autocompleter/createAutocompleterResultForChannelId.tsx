...
export default function createAutocompleterResultForChannelId(arg0, arg1, closure_9, closure_7) {
  ...
  if (null == channel) {
    ...
    const channelName = require("../channel/useChannelName.tsx") /* computeChannelName */.computeChannelName(channel, obj1, tmp);
    ...
    const obj8 = require("../channel/useChannelName.tsx") /* computeChannelName */;
  }
};