...
import { GUILD_FOLLOW_DESTINATION_CHANNEL_TYPES as closure_7 } from "../../../../records/ChannelRecord.tsx";
import closure_8 from "../../../../stores/ChannelStore.tsx";
import closure_9 from "../../../../stores/GuildChannelStore.tsx";
import { GUILD_SELECTABLE_CHANNELS_KEY as closure_10 } from "../../../../stores/GuildChannelStore.tsx";
import closure_11 from "../../../../stores/GuildStore.tsx";
import closure_12 from "../../../../stores/PermissionStore.tsx";
import closure_13 from "../../../../stores/SortedGuildStore.tsx";
...
export default function NewChannelFollower(targetChannelId) {
  ...
  const stateFromStoresObject = obj1.useStateFromStoresObject(items, () => ({
    sourceGuild: closure_1_11.getGuild(closure_0),
    targetGuild: closure_1_11.getGuild(targetGuildId),
  }));
  ...
  const stateFromStoresObject1 = obj2.useStateFromStoresObject(items1, () => ({
    sourceChannel: bottomSheetRef.getChannel(closure_1),
    targetChannel: bottomSheetRef.getChannel(targetChannelId),
  }));
  ...
  const items3 = [
    callback(require(targetGuildId[24]).Icon, obj5),
    callback(require(targetGuildId[26]).Text, {
      lineClamp: 1,
      variant: "text-sm/medium",
      children: importDefault(targetGuildId[16])(sourceChannel),
    }),
  ];
  obj4[1] = items3;
  ...
  obj10[3] = function onPress() {
    ...
    obj.openLazy(
      closure_1_0(targetGuildId[33])(targetGuildId[32], targetGuildId.paths),
  ...
  obj18[0] = items4;
  const items8 = [
    closure_17(require(targetGuildId[22]).BottomSheetScrollView, obj18),
    callback(require(targetGuildId[39]).ActionSheetHeaderBar, {
      variant: "floating",
