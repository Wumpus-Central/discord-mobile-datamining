...
export default function NewChannelFollower(targetChannelId) {
  ...
  if (tmp5Result.isThemeDark(tmp9)) {
    let tmp8Result = require("../../../../../_runtime/metro/11359__.js");
  } else {
    tmp8Result = require("../../../../../_runtime/metro/11360__.js");
  }
  ...
  const items3 = [
    closure_16(require("native").Icon, obj5),
    closure_16(require("Text/Text").Text, {
      lineClamp: 1,
      variant: "text-sm/medium",
      children: require("useChannelName")(sourceChannel),
    }),
  ];
  ...
  obj10.onPress = function onPress() {
    ...
    obj.openLazy(asyncRequireImpl(9458, dependencyMap.paths), "NewChannelFollowerGuildPicker", obj);
  ...
  const items8 = [
    closure_17(require("BottomSheetModal").BottomSheetScrollView, obj18),
