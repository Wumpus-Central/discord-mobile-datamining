...
let closure_10 = fn(4462).GUILD_SELECTABLE_CHANNELS_KEY;
...
export default function NewChannelFollower(targetChannelId) {
  ...
  const stateFromStoresObject = require("initialize").useStateFromStoresObject(items, () => ({
    sourceGuild: GuildStore.getGuild(require),
    targetGuild: GuildStore.getGuild(targetGuildId),
  }));
  ...
  if (tmp5Result.isThemeDark(tmp9)) {
    let tmp8Result = require("../../../../../_runtime/metro/11676__.js");
  } else {
    tmp8Result = require("../../../../../_runtime/metro/11677__.js");
  }
  ...
  const items3 = [
    closure_16(require("native").Icon, obj10),
    closure_16(require("Text/Text").Text, { lineClamp: 1, variant: "text-sm/medium", children: tmp12 }),
  ];
  ...
  obj15.onPress = function onPress() {
    ...
    obj.openLazy(asyncRequireImpl(9623, dependencyMap.paths), "NewChannelFollowerGuildPicker", obj2);
  ...
  if (null != targetChannel) {
    const obj19 = {
      ...
      source: require("utils/ChannelUtils").getChannelIcon(targetChannel),
  ...
  const items8 = [
    closure_17(require("BottomSheetModal").BottomSheetScrollView, obj23),
    closure_16(require("ActionSheetHeaderBar").ActionSheetHeaderBar, {
      variant: "floating",
      onPress: bottomSheetRef1.bottomSheetClose,
    }),
  ];
