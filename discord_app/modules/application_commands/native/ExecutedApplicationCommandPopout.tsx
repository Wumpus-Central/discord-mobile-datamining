      ...
      if (null != iter.value) {
        ...
        if (tmp6(1894).ApplicationCommandOptionType.USER === type) {
          ...
          if (null != channel) {
            ...
            const items1 = [closure_20, tmp6(4759).computeChannelName(channel, UserStore, RelationshipStore)];
            obj.children = items1;
...
export default function ExecutedCommandPopout(channelId) {
  ...
  obj = { value: messageId(7235)(messageId(7255).EXECUTED_COMMAND).analyticsLocations, children: null };
  ...
  obj.children = closure_23(channelId(7223).BottomSheet, obj);
  return closure_23(channelId(7235).AnalyticsLocationProvider, obj);
};