...
obj2.applicationTopWrapperScrollView = {
  flexDirection: "row",
  alignItems: "center",
...
obj2.applicationDescriptionDivider = {
  marginLeft: 0,
...
obj2.applicationCommandOption = {
  marginHorizontal: 4,
  padding: 8,
  fontSize: 12,
  alignItems: "center",
  borderRadius: nativeDefault.radii.xs,
  backgroundColor: fn(5744).DARK_PRIMARY_800_LIGHT_PRIMARY_300,
};
let obj5 = {
  marginHorizontal: 4,
  padding: 8,
...
obj2.optionDescriptionContainer = {
  overflow: "hidden",
  paddingHorizontal: 16,
  paddingVertical: 8,
  flexDirection: "row",
...
export default function _default(command) {
  ...
  const items8 = [
    c10(closure_6, obj3),
    ref(command(8947).FormDivider, { style: tmp.applicationDescriptionDivider }),
