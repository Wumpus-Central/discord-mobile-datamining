...
createStyles.applicationCommandOption = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5491).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
let obj2 = { marginHorizontal: 4, padding: 8, fontSize: 12, alignItems: "center", borderRadius: nativeDefault.radii.xs, backgroundColor: fn(5491).DARK_PRIMARY_800_LIGHT_PRIMARY_300 };
...
createStyles.completeCommandOption = { backgroundColor: fn(5491).DARK_PRIMARY_660_LIGHT_PRIMARY_300 };
...
export default function _default(command) {
  ...
  if (tmp4) {
    ...
    items7[1] = tmp25(tmp12(4601).Text, obj4);
  ...
  obj.children = items5;
  const items8 = [c10(closure_6, obj), ref(command(8663).FormDivider, { style: tmp.applicationDescriptionDivider }), ref(stateFromStores, { command, option: currentOption, optionState: tmp17 }), ref(command(8663).FormDivider, { style: tmp.applicationDescriptionDivider })];
  obj.children = items8;
