...
obj2.applicationCommandOption = {
  ...
  backgroundColor: fn(5746).DARK_PRIMARY_800_LIGHT_PRIMARY_300,
};
let obj5 = {
  marginHorizontal: 4,
  padding: 8,
...
export default function _default(command) {
  ...
  if (tmp4) {
    ...
    items7[1] = tmp25(tmp12(4825).Text, obj7);
  ...
  const items8 = [
    c10(closure_6, obj3),
    ref(command(8951).FormDivider, { style: tmp.applicationDescriptionDivider }),
