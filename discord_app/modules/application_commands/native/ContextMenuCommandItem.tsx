...
export default function ContextMenuCommandItem(item) {
  ...
  if (tmp8Result) {
    ...
    tmp8Result = tmp8(section(5145), obj);
  }
  obj[3] = tmp8Result;
  obj[4] = jsx(item(4139).SendMessageIcon, {});
  obj[5] = start;
  obj[6] = end;
  return jsx(item(5224).TableRow, { accessibilityLabel: memo, onPress, label: item.displayName, icon: null, trailing: null, start: null, end: null });
};
export const ContextMenuCommandLoadingItem = function ContextMenuCommandLoadingItem(arg0) {
  ...
  obj[2] = start;
  obj[3] = end;
  return jsx(require(5224) /* TableRowInner */.TableRow, { width: null });
};
export const ContextMenuCommandEmptyItem = function ContextMenuCommandEmptyItem(arg0) {
  ...
  obj[2] = start;
  obj[3] = end;
  return jsx(require(5224) /* TableRowInner */.TableRow, { label: null, icon: null, start: null, end: null });
};
export const ContextMenuCommandAppItem = function ContextMenuCommandAppItem(section) {
  ...
  let obj = require(11405) /* getApplicationCommandsIconSource */;
  const applicationCommandsIconSource = obj.getApplicationCommandsIconSource(section);
  ...
  if (tmp4Result) {
    ...
    obj[0] = tmp.commandIcon;
    obj[1] = applicationCommandsIconSource;
    tmp4Result = tmp4(importDefault(5145), obj);
  }
  obj[2] = tmp4Result;
  obj[3] = start;
  obj[4] = end;
  return jsx(require(5224) /* TableRowInner */.TableRow, { onPress, label: section.name, icon: null, start: null, end: null, arrow: true });
};