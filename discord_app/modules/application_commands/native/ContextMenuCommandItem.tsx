// === Module 16684: ContextMenuCommandItem ===
...
import getApplicationCommandsIconSource from "getApplicationCommandsIconSource" /* 12021 */;
...
export default function ContextMenuCommandItem(item) {
  ...
  obj[5] = start;
  obj[6] = end;
  return jsx(item(5607).TableRow, { accessibilityLabel: memo, onPress, label: item.displayName, icon: null, trailing: null, start: null, end: null });
};
