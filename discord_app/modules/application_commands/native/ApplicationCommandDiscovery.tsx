// === Module 12734: ApplicationCommandDiscovery ===
...
import ApplicationSectionHeader from "ApplicationSectionHeader" /* 12736 */;
import ApplicationCommandDiscoveryManager from "ApplicationCommandDiscoveryManager" /* 12737 */;
import ApplicationCommandsCategoriesDefault from "ApplicationCommandsCategories" /* 12738 */;
...
export default function ApplicationCommandDiscovery(channel) {
  ...
  obj9.renderSectionHeader = function renderSectionHeader(section) {
    ...
    if (tmp3Result) {
      const obj3 = { lightSource: _modDef10760, darkSource: _modDef10760, body: null, containerStyle: null, imageStyle: null };
      const intl = util.intl;
