// === Module 12652: ApplicationCommandDiscovery ===
...
import ApplicationCommandQueryTypes from "ApplicationCommandQueryTypes" /* 9418 */;
import _modDef10684 from "module_10684" /* 10684 */;
import ApplicationSectionHeader from "ApplicationSectionHeader" /* 12654 */;
import ApplicationCommandDiscoveryManager from "ApplicationCommandDiscoveryManager" /* 12655 */;
import ApplicationCommandsCategoriesDefault from "ApplicationCommandsCategories" /* 12656 */;
...
const ITEM_HEIGHT = fn(12653).ITEM_HEIGHT;
...
export default function ApplicationCommandDiscovery(channel) {
  ...
  const discovery = channel(9536).useDiscovery(obj5);
  ...
  obj9.renderItem = function renderItem(item) {
    ...
    if (item.inputType === ApplicationCommandTypes.ApplicationCommandInputType.PLACEHOLDER) {
      return filteredSectionId(onHeightChange(12657), {});
    } else {
      ...
      return filteredSectionId(onHeightChange(12658), obj);
    }
  };
  obj9.renderSectionHeader = function renderSectionHeader(section) {
    ...
    if (tmp3Result) {
      const obj3 = { lightSource: _modDef10684, darkSource: _modDef10684, body: null, containerStyle: null, imageStyle: null };
      const intl = util.intl;
