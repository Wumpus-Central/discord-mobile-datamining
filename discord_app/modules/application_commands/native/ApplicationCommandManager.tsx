  ...
  constructor(arg0) {
    ...
    obj.setCommand = function setCommand(arg0) {
      ...
      obj = {
        ...
        section,
        location: _location,
        triggerSection: ApplicationCommandUtils.getCommandTriggerSection(visualSection),
        queryLength: null,
      };
      let length;
      if (query != null) {
    ...
    obj.addCommandOptionParserRules = function addCommandOptionParserRules() {
      ...
      obj = {
        ...
        matchFunction(arg0, activeCommand) {
          return preferredCommand(12061).getMatchedOptions(arg0, activeCommand);
        },
        style() {
          const styles = preferredCommand.styles;
      ...
      obj = {
        ...
        matchFunction(length2, activeCommand) {
          return preferredCommand(12061).getMatchedOptionsWithValue(length2, activeCommand);
        },
        style() {
          const styles = preferredCommand.styles;
          return styles.commandOption();
      ...
      parser7.addRule({
        ...
        matchFunction(arg0) {
          return preferredCommand(12061).getSilentHighlightNodes(arg0);
        },
        style() {
          const styles = preferredCommand.styles;
          return styles.autocomplete();
      ...
      parser9.addRule({
        ...
        matchFunction(arr) {
          return preferredCommand(12061).getGameMentionInputNodes(arr);
        },
        style() {
          const styles = preferredCommand.styles;
          return styles.commandOption();
      ...
      parser11.addRule({
        ...
        matchFunction(arr) {
          return preferredCommand(12061).getTimestampMentionInputNodes(arr);
        },
        style() {
          const styles = preferredCommand.styles;
          return styles.commandOption();
                    ...
                    function _loop() {
                      ...
                      if (found.length > 0) {
                        ...
                        const cachedApplicationSection = ApplicationCommandQueryApiAll.getCachedApplicationSection(
                          obj,
                          obj(1894).ApplicationCommandType.CHAT,
                          first.applicationId,
                        );
                        if (null == cachedApplicationSection) {
                          obj = { v: null };
        ...
        while (iter !== undefined) {
          ...
          if (!tmp60) {
            ...
            if (tmp63) {
              ...
              tmp63 =
                str2.substring(value1.location + tmp56.displayName.length + 1, value1.location + value1.length) ===
                tmp59.displayText;
            }
            tmp60 = tmp63;
          }
