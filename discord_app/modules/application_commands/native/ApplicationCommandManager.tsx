// === Module 11881: ApplicationCommandManager ===
...
import ApplicationCommandActionCreators from "ApplicationCommandActionCreators" /* 7192 */;
import UploadAttachmentActionCreatorsDefault from "UploadAttachmentActionCreators" /* 8600 */;
import ApplicationCommandOptionUtils from "ApplicationCommandOptionUtils" /* 8707 */;
...
import ChatInputParser from "ChatInputParser" /* 11460 */;
import ApplicationCommandOptionValueParser from "ApplicationCommandOptionValueParser" /* 11461 */;
import DraftCommandUtils from "DraftCommandUtils" /* 11462 */;
import useCommandContext from "useCommandContext" /* 11496 */;
import application_commands_ApplicationCommandValidationUtils from "application_commands/ApplicationCommandValidationUtils" /* 11625 */;
  ...
  constructor(arg0) {
    ...
    obj.setPastedCommand = function setPastedCommand(arg0, channel) {
      ...
      if (null != command) {
        let tmp8 = null;
        if (null != application) {
          const obj5 = { type: ApplicationCommandTypes.ApplicationCommandSectionType.APPLICATION, id: null, icon: null, name: null, application: null };
        ...
        const obj6 = { channelId: channel.id, command, section: tmp8, location: ApplicationCommandTypes.ApplicationCommandTriggerLocations.PASTE, commandText: null };
            ...
            if (null == tmp.contextCommands) {
              ...
              if (preferredCommandType === constants.PARTIAL_COMMAND) {
                ...
                if (null != found) {
                  ...
                  let cachedApplicationSection = ApplicationCommandQueryApiAll.getCachedApplicationSection(obj4, Server.ApplicationCommandType.CHAT, found.applicationId);
                  let tmp20 = null;
                ...
                const draftCommand = DraftCommandUtils.resolveDraftCommand(channel, text, DraftStore.getDraftCommand(channel.id, DraftType.ChannelMessage));
