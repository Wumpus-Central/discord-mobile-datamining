...
let obj4 = {
  ...
  inputType: fn(7719).ApplicationCommandInputType.BUILT_IN_TEXT,
...
const obj16 = {
  ...
  displayName: "nick",
  type: fn(1895).ApplicationCommandType.CHAT,
  inputType: fn(7719).ApplicationCommandInputType.BUILT_IN,
  applicationId: BuiltInSectionId.BUILT_IN,
};
            ...
            const obj6 = {
              value: v1(4735)
                ...
                .then((result) => {
                  ...
                  const obj = c1(7652);
                  obj.sendMessage(channel.id, c1(7878).parse(channel, dependencyMap), true, {
