...
import _modDef8507 from "../../actions/ChangeNicknameActionCreators.tsx";
...
Object.defineProperty(obj17, "maxLength", { get: () => useMessageMaxLength /* useMessageMaxLength */.getMaxMessageLength(), set: undefined });
obj17.required = true;
items8[1] = obj17;
    ...
    if (c7 === 2) {
      ...
      try {
        ...
        if (0 === c6) {
          ...
          id = arg1;
          const obj8 = channel(7063);
          id = id.id;
          const obj3 = { location: null };
          obj3[0] = constants.THREAD_CREATION;
          obj8.sendMessage(id, channel(7287).parse(id, closure_3), true, obj3);
          c7 = 3;
          return { value: "HermesInternal", done: "HermesInternal" };
        }
      } catch (tmp27) {
...
obj31.required = true;
Object.defineProperty(obj31, "maxLength", { get: () => useMessageMaxLength /* useMessageMaxLength */.getMaxMessageLength(), set: undefined });
items12[1] = obj31;
...
obj32.execute = function execute(arr, channel) {
  ...
  if (null != channel) {
    ...
    size(5973).startDiceRoll(channel.id, NumberResult, NumberResult1);
    const obj = size(5973);
  }
};
items[sum10 + 1] = obj32;
