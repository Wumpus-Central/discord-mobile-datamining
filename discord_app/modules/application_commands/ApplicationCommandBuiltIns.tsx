...
let obj1 = { id: "-1", untranslatedName: "shrug", displayName: "shrug", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[tmp5] = obj1;
const sum = tmp5 + 1;
let obj3 = { id: "-2", untranslatedName: "tableflip", displayName: "tableflip", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum] = obj3;
const sum1 = sum + 1;
let obj5 = { id: "-3", untranslatedName: "unflip", displayName: "unflip", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum1] = obj5;
const sum2 = sum1 + 1;
let obj7 = { id: "-4", untranslatedName: "tts", displayName: "tts", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum2] = obj7;
const sum3 = sum2 + 1;
const obj9 = { id: "-5", untranslatedName: "me", displayName: "me", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum3] = obj9;
const sum4 = sum3 + 1;
const obj11 = { id: "-6", untranslatedName: "spoiler", displayName: "spoiler", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum4] = obj11;
const sum5 = sum4 + 1;
const obj13 = { id: "-7", untranslatedName: "nick", displayName: "nick", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum5] = obj13;
const sum6 = sum5 + 1;
const obj15 = { id: "-10", untranslatedName: "thread", displayName: "thread", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
      ...
      try {
        ...
        if (0 === c6) {
          ...
          if (arg0 === 1) {
            ...
            obj2.value = obj1.createThread(channel2, closure_132_2, closure_133_0(closure_133_2[18]).ChannelTypes.PUBLIC_THREAD, obj2.getAutoArchiveDuration(channel2, null), "Slash Command");
            return obj2;
          }
        } else if (arg0 === 1) {
          c7 = 3;
...
items[sum6] = obj15;
const sum7 = sum6 + 1;
const obj18 = { id: "-11", untranslatedName: "kick", displayName: "kick", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum7] = obj18;
const sum8 = sum7 + 1;
const obj21 = { id: "-12", untranslatedName: "ban", displayName: "ban", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum8] = obj21;
const sum9 = sum8 + 1;
const obj25 = { id: "-13", untranslatedName: "timeout", displayName: "timeout", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum9] = obj25;
const sum10 = sum9 + 1;
const obj29 = { id: "-14", untranslatedName: "msg", displayName: "msg", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum10] = obj29;
const obj32 = { id: "-18", untranslatedName: "roll-dice", displayName: "roll-dice", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7596).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
