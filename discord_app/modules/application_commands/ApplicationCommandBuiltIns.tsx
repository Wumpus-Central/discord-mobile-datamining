...
let obj4 = {
  ...
  inputType: fn(7851).ApplicationCommandInputType.BUILT_IN_TEXT,
...
const obj16 = {
  ...
  displayName: "nick",
  type: fn(1978).ApplicationCommandType.CHAT,
  inputType: fn(7851).ApplicationCommandInputType.BUILT_IN,
  applicationId: BuiltInSectionId.BUILT_IN,
};
            ...
            const obj6 = {
              value: v1(4840)
                ...
                .then((result) => {
                  ...
                  const obj = c1(7784);
                  obj.sendMessage(channel.id, c1(8003).parse(channel, dependencyMap), true, {
