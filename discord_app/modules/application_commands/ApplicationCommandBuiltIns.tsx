// === Module 9429: ApplicationCommandBuiltIns ===
...
let obj = {};
obj = { id: BuiltInSectionId.BUILT_IN, type: fn(7626).ApplicationCommandSectionType.BUILT_IN };
...
obj = { id: BuiltInSectionId.FRECENCY, type: fn(7626).ApplicationCommandSectionType.BUILT_IN };
Object.defineProperty(obj, "name", {
  get: () => {
    const intl = require("util").intl;
...
let items = [...fn(9431).default];
let obj1 = { id: "-1", untranslatedName: "shrug", displayName: "shrug", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[tmp5] = obj1;
const sum = tmp5 + 1;
let obj3 = { id: "-2", untranslatedName: "tableflip", displayName: "tableflip", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum] = obj3;
const sum1 = sum + 1;
let obj5 = { id: "-3", untranslatedName: "unflip", displayName: "unflip", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum1] = obj5;
const sum2 = sum1 + 1;
let obj7 = { id: "-4", untranslatedName: "tts", displayName: "tts", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum2] = obj7;
const sum3 = sum2 + 1;
const obj9 = { id: "-5", untranslatedName: "me", displayName: "me", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum3] = obj9;
const sum4 = sum3 + 1;
const obj11 = { id: "-6", untranslatedName: "spoiler", displayName: "spoiler", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN_TEXT, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum4] = obj11;
const sum5 = sum4 + 1;
const obj13 = { id: "-7", untranslatedName: "nick", displayName: "nick", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum5] = obj13;
const sum6 = sum5 + 1;
const obj15 = { id: "-10", untranslatedName: "thread", displayName: "thread", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
Object.defineProperty(obj17, "maxLength", { get: () => require("useMessageMaxLength").getMaxMessageLength(), set: undefined });
obj17.required = true;
items8[1] = obj17;
...
let closure_14 = asyncGeneratorStep(async (arg0, arg1) => {
  ...
  const iter = (async (arg0, value) => {
    ...
    closure_132_3 = c3;
    await closure_133_0(closure_133_2[17]).createThread(channel2, closure_132_2, closure_133_0(closure_133_2[18]).ChannelTypes.PUBLIC_THREAD, closure_133_0(closure_133_2[19]).getAutoArchiveDuration(channel2, null), "Slash Command");
    closure_132_4 = value;
...
items[sum6] = obj15;
const sum7 = sum6 + 1;
const obj18 = { id: "-11", untranslatedName: "kick", displayName: "kick", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
items[sum7] = obj18;
const sum8 = sum7 + 1;
const obj21 = { id: "-12", untranslatedName: "ban", displayName: "ban", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
obj22.required = true;
const items10 = [obj22, , ];
const obj23 = { name: "delete_messages", displayName: "delete_messages", type: fn(1894).ApplicationCommandOptionType.INTEGER };
...
items[sum8] = obj21;
const sum9 = sum8 + 1;
const obj25 = { id: "-13", untranslatedName: "timeout", displayName: "timeout", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
            ...
            if (null != guild) {
              if (null != channel) {
                ...
                if (null == user) {
                  ...
                  const obj1 = { guildId: tmp40.id, userId, communicationDisabledUntilTimestamp: null, duration: null, reason: null };
...
items[sum9] = obj25;
const sum10 = sum9 + 1;
const obj29 = { id: "-14", untranslatedName: "msg", displayName: "msg", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
obj31.required = true;
Object.defineProperty(obj31, "maxLength", { get: () => require("useMessageMaxLength").getMaxMessageLength(), set: undefined });
items12[1] = obj31;
          ...
          if (arg0 === 1) {
            ...
            const obj2 = {
              value: obj1.openPrivateChannel(obj1).then((result) => {
                        ...
                        obj.sendMessage(channel.id, c1(7784).parse(channel, dependencyMap), true, obj);
                      }),
              done: false
            };
            return obj2;
...
items[sum10] = obj29;
const obj32 = { id: "-18", untranslatedName: "roll-dice", displayName: "roll-dice", type: fn(1894).ApplicationCommandType.CHAT, inputType: fn(7626).ApplicationCommandInputType.BUILT_IN, applicationId: BuiltInSectionId.BUILT_IN };
...
export const PLATFORM_COMMANDS = fn(9431).default;
