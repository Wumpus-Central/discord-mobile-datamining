// === Module 11814: validateNumericOptionRange ===
...
import getStringAll from "getString" /* 10213 */;
import toChoiceBooleanValue from "toChoiceBooleanValue" /* 10215 */;
  ...
  [arg1(1955).ApplicationCommandOptionType.CHANNEL]: (type, arg1, id, throwTypeErrorResult) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        ...
        const applicationCommandOption = tmp(10216).resolveApplicationCommandOption(type.text, throwTypeErrorResult, id);
        type = undefined;
        if (applicationCommandOption != null) {
          type = applicationCommandOption.type;
        }
  ...
  [arg1(1955).ApplicationCommandOptionType.MENTIONABLE]: (type, arg1, id, throwTypeErrorResult) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        ...
        const applicationCommandOption = tmp4(10216).resolveApplicationCommandOption(type.text, throwTypeErrorResult, id);
