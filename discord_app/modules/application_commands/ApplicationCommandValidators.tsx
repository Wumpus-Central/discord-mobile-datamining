// === Module 11334: validateNumericOptionRange ===
...
import resolvePlaintextInlineVoid from "resolvePlaintextInlineVoid" /* 10259 */;
...
function validateNumericOptionRange(NumberResult, minValue, _8Y5zsp, CyRLmH, VD3Q_S) {
  ...
  if (null != minValue.maxValue) {
    if (null != minValue.minValue) {
      ...
      let obj = { minimum: null, maximum: null };
...
let obj = {
  [fn(1954).ApplicationCommandOptionType.SUB_COMMAND]: () => ({ success: false }),
  [fn(1954).ApplicationCommandOptionType.SUB_COMMAND_GROUP]: () => ({ success: false }),
  [fn(1954).ApplicationCommandOptionType.BOOLEAN]: (type) => {
    if ("text" !== type.type) {
  ...
  [fn(1954).ApplicationCommandOptionType.STRING]: (type, type2, id) => {
        ...
        if (null == surrogate) {
          ...
          if (undefined !== type2.maxLength) {
            if (undefined !== type2.minLength) {
              if (type2.minLength === type2.maxLength) {
                ...
                obj2[0] = minLength3.toLocaleString(getSystemLocale.intl.currentLocale, { useGrouping: false });
                obj1[1] = intl4.formatToPlainString(getSystemLocale.t["e+9/SY"], obj2);
                obj = obj1;
              }
            }
          }
          if (undefined !== type2.maxLength) {
            if (undefined !== type2.minLength) {
              ...
              obj4[0] = minLength2.toLocaleString(getSystemLocale.intl.currentLocale, { useGrouping: false });
              const maxLength2 = type2.maxLength;
              obj4[1] = maxLength2.toLocaleString(getSystemLocale.intl.currentLocale, { useGrouping: false });
              obj3[1] = intl3.formatToPlainString(getSystemLocale.t.IE1sTh, obj4);
              obj = obj3;
            }
          }
          if (undefined !== type2.minLength) {
            ...
            obj6[0] = minLength.toLocaleString(getSystemLocale.intl.currentLocale, { useGrouping: false });
            obj5[1] = intl2.formatToPlainString(getSystemLocale.t.rXAFQD, obj6);
            obj = obj5;
            ...
            obj8[0] = maxLength.toLocaleString(getSystemLocale.intl.currentLocale, { useGrouping: false });
            obj7[1] = intl.formatToPlainString(getSystemLocale.t["ycEPx/"], obj8);
            obj = obj7;
          }
        }
      }
  ...
  [fn(1954).ApplicationCommandOptionType.INTEGER]: (type, type2, id) => {
            ...
            if (!isNaN(NumberResult)) {
              ...
              if (Number.isInteger(NumberResult)) {
                ...
                if (Number.isSafeInteger(NumberResult)) {
                  obj = validateNumericOptionRange(NumberResult, type2, getSystemLocale.t["8Y5zsp"], getSystemLocale.t.CyRLmH, getSystemLocale.t["VD3Q+S"]);
                }
                return obj;
              }
            }
  ...
  [fn(1954).ApplicationCommandOptionType.NUMBER]: (type, type2, id) => {
  ...
  [fn(1954).ApplicationCommandOptionType.USER]: (type, arg1, id2, id) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        return { success: true };
      } else {
        const tmpResult = resolvePlaintextInlineVoid;
  ...
  [fn(1954).ApplicationCommandOptionType.CHANNEL]: (type, arg1, id2, id) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        return { success: true };
      } else {
        const applicationCommandOption = resolvePlaintextInlineVoid.resolveApplicationCommandOption(type.text, id, id2);
        type = undefined;
        if (applicationCommandOption != null) {
          type = applicationCommandOption.type;
        }
  ...
  [fn(1954).ApplicationCommandOptionType.ROLE]: (type, arg1, id2, id) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        return { success: true };
      } else {
        const tmp3Result = resolvePlaintextInlineVoid;
  ...
  [fn(1954).ApplicationCommandOptionType.MENTIONABLE]: (type, arg1, id2, id) => {
    if ("text" === type.type) {
      if (obj2.isSnowflake(type.text)) {
        return { success: true };
      } else {
  ...
  [fn(1954).ApplicationCommandOptionType.ATTACHMENT]: (type, name, channelId, arg3, closure_10) => {
    if ("text" !== type.type) {
      return { success: false };
    } else {
...
const result = require("obj132").fileFinishedImporting("modules/application_commands/ApplicationCommandValidators.tsx");
