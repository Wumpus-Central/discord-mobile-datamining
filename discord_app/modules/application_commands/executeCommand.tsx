...
function enqueueCommandInteraction(interactionLifecycleOptions) {
  ...
  if (null != context.channel) {
    ...
    if (nonce == null) {
      let obj1 = onMessageSuccess(7804);
    ...
    obj1 = { type: onMessageSuccess(7885).MessageDataType.COMMAND, message };
    message(7885).enqueue(obj1, (ok) => {
      ({ nonce, applicationId, channelId, guildId } = closure_0);
      if (guildId == null) {
        guildId = null;
      }
