...
function enqueueCommandInteraction(interactionLifecycleOptions) {
  ...
  if (null != context.channel) {
    ...
    const obj7 = {
      interactionType: onMessageSuccess(1895).InteractionTypes.APPLICATION_COMMAND,
      applicationId,
      channelId: id,
    };
    obj5.data = obj7;
    ...
    const obj10 = { type: onMessageSuccess(7948).MessageDataType.COMMAND, message };
      ...
      if (0 === c7) {
        ...
        if (2 === tmp8) {
          ...
          closure_133_2(closure_133_3[24]).setFailed(
            closure_132_1,
            undefined,
            intl.formatToPlainString(closure_133_0(closure_133_3[33]).t["9h1/1p"], obj8),
          );
