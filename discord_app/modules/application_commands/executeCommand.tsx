      ...
      while (true) {
        ...
        if (0 === c15) {
          if (arg0 === 1) {
            ...
            let source2;
            ({ command: closure_139_0, optionValues: closure_139_1, context: closure_139_2, commandTargetId: closure_139_3, maxSizeCallback: closure_139_4, commandOrigin } = source);
...
function enqueueCommandInteraction(interactionLifecycleOptions) {
  ...
  if (null != context.channel) {
    ...
    if (nonce == null) {
      let obj1 = onMessageSuccess(7825);
    ...
    obj1 = { type: onMessageSuccess(7906).MessageDataType.COMMAND, message };
    message(7906).enqueue(obj1, (ok) => {
      ({ nonce, applicationId, channelId, guildId } = closure_0);
      if (guildId == null) {
        guildId = null;
      }
