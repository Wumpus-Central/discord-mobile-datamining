...
function handleFetchSuccess(arg0, flag) {
  ...
  if (null == id) {
    ...
    if (tmp32) {
      ...
      const membersById = showTooManyUserGuildsAlert.requestMembersById(target.guildId, items);
...
function queryIndexSection(descriptor, builtInCommands, arg2, arg3, arg4) {
  ...
  if (0 !== arr2.length) {
    ...
    obj[1] = arr2;
    let tmp36 = obj;
    tmp39 = scoreMethod !== ScoreMethod.ScoreMethod.NONE && scoreMethod !== tmp27(8391).ScoreMethod.APPLICATION_ONLY;
  } else {
    tmp36 = null;
  }
  return tmp36;
