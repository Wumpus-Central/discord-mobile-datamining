...
export default function NUFChannelIllustration() {
  ...
  const fn = function b() {
    ...
    obj = { translateY: null };
    obj[0] = tmp(4145).interpolate(sharedValue.get(), [0, 1], [50, 0]);
    const items = [obj];
    obj[0] = items;
    return obj;
  };
  ...
  obj2 = { source: first(12955), style: items4 };
  items4 = [, ];
  ({ starMedium: arr6[0], starPink: arr6[1] } = tmp);
  items3[1] = callback(closure_6, obj2);
  const items5 = [, ];
  ({ starMedium: arr7[0], starGreen: arr7[1] } = tmp);
  items3[2] = callback(closure_6, { source: first(12956), style: items5 });
  const obj3 = { source: first(12956), style: items5 };
  const items6 = [, ];
  ({ starSmall: arr8[0], starPurple: arr8[1] } = tmp);
  items3[3] = callback(closure_6, { source: first(12957), style: items6 });
  ...
  obj9[1] = callback(first(4145).View, obj10);
