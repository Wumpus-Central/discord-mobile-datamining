...
export default function NUFChannelIllustration() {
  ...
  const obj9 = {
    style: tmp.content,
    children: closure_7(first(4343).View, {
      style: animatedStyle,
