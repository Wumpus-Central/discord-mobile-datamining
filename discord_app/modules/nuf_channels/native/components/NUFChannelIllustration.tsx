...
export default function NUFChannelIllustration() {
  ...
  obj9[1] = callback(first(4217).View, {
    ...
    children: first.map((children) => {
      ...
      const items1 = [
        closure_1_7(lib(4474).Text, { variant: "text-md/semibold", allowFontScaling: false, children: children.name }),
        closure_1_7(lib(4474).Text, { variant: "text-md/medium", allowFontScaling: false, children: children.message }),
      ];
      obj[1] = items1;
