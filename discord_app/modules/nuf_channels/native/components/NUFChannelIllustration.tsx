...
export default function NUFChannelIllustration() {
  ...
  obj = { interpolate: _require(4115).interpolate, messageListAnimation: sharedValue };
  fn.__closure = obj;
  ...
  const items7 = [callback(_require(6876).TextIcon, { size: "sm" }), ];
  ...
  obj8[2] = items8;
  items7[1] = callback2(_require(4734).Text, obj8);
  obj7[1] = items7;
  ...
  obj6[3] = items9;
  items3[5] = callback2(_require(6292).Card, obj6);
  obj[1] = items3;
