// === Module 12909: NUFChannelIllustration ===
...
export default function NUFChannelIllustration() {
  ...
  obj = { interpolate: require(4116).interpolate, messageListAnimation: sharedValue };
  fn.__closure = obj;
  ...
  obj2 = { source: first(12913), style: items4 };
  items4 = [, ];
  ({ starMedium: arr6[0], starPink: arr6[1] } = tmp);
  items3[1] = callback(closure_6, obj2);
  const items5 = [, ];
  ({ starMedium: arr7[0], starGreen: arr7[1] } = tmp);
  items3[2] = callback(closure_6, { source: first(12914), style: items5 });
  const obj3 = { source: first(12914), style: items5 };
  const items6 = [, ];
  ({ starSmall: arr8[0], starPurple: arr8[1] } = tmp);
  items3[3] = callback(closure_6, { source: first(12915), style: items6 });
  ...
  const items7 = [callback(require(4761) /* TextIcon */.TextIcon, { size: "sm" }), ];
  ...
  obj8[2] = items8;
  items7[1] = callback2(require(4251) /* Text */.Text, obj8);
  obj7[1] = items7;
  ...
  obj6[3] = items9;
  items3[5] = callback2(require(5288) /* PressableCard */.Card, obj6);
  obj[1] = items3;
