// === Module 13315: NUFChannelIllustration ===
...
export default function NUFChannelIllustration() {
  ...
  obj14.children = closure_7(first(4566).View, {
    style: animatedStyle,
