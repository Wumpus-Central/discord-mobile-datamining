// === Module 13298: NUFChannelIllustration ===
...
export default function NUFChannelIllustration() {
  ...
  obj14.children = closure_7(first(4563).View, {
    style: animatedStyle,
