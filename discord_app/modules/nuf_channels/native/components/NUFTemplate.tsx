...
const createCacheKey = { padding: 16, alignItems: "center", backgroundColor: ThemesDefault.colors.BACKGROUND_BASE_LOW };
...
const result = require("obj132").fileFinishedImporting("modules/nuf_channels/native/components/NUFTemplate.tsx");
