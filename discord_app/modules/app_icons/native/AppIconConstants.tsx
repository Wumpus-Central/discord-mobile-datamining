...
export const getIconById = function getIconById(currentAppIcon) {
  ...
  if (null == found) {
    const obj2 = { id: AppIconTypes.FreemiumAppIconIds.DEFAULT, iconSource: _modDef9457, name: null, isPremium: false };
