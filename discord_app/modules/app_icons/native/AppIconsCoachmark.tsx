// === Module 15840: AppIconsCoachmarkActionSheet ===
...
export default function AppIconsCoachmarkActionSheet(markAsDismissed) {
  ...
  const items5 = [callback(markAsDismissed(4666).Button, obj7), ];
  const obj8 = { variant: "secondary", text: null, onPress: null };
  const intl4 = tmp2(1236).intl;
  obj8[1] = intl4.string(markAsDismissed(1236).t.iSrIIZ);
  obj8[2] = callback;
  items5[1] = callback(markAsDismissed(4666).Button, obj8);
  obj6[1] = items5;
  items4[1] = callback2(closure_5, obj6);
  obj[2] = items4;
  return callback2(markAsDismissed(5309).BottomSheet, obj);
};