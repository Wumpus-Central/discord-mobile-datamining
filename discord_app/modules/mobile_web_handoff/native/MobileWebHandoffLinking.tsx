...
import MobileWebHandoffUtilsDefault from "../MobileWebHandoffUtils.tsx";
      ...
      try {
        ...
        if (0 === c4) {
          ...
          const uRL = new URL(
            "" +
              location.protocol +
              closure_131_6.DEVELOPER_PORTAL_LOGIN_HANDOFF(closure_130_1, closure_130_2, closure_130_0),
          );
          closure_130_3 = uRL;
