  ...
  return allSounds.useMemo(() => {
    ...
    if (flag2) {
      ...
      if (undefined !== stateFromStores1) {
        ...
        const tmp29 = value6.length < tmp13(4720).getMaxSoundboardSlots(stateFromStores1) && stateFromStores2;
        let tmp31 = !tmp29;
        if (!tmp29) {
          tmp31 = !tmp30;
        }
        ...
        if (!tmp31) {
          const obj8 = { type: tmp13(5318).SoundboardSoundItemType.ADD_SOUND, guild: stateFromStores1 };
          mapped.push(obj8);
        }
        if (tmp33) {
          tmp33 = tmp30;
        ...
        if (!tmp33) {
          ...
          const obj10 = { type: tmp13(5318).SoundboardSoundGridSectionType.GUILD, guild: stateFromStores1, isNitroLocked: false };
