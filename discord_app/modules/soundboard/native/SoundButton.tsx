...
function SoundButtonEmoji(arg0) {
  ...
  fn.__closure = {
    animationConfig,
    withDelay: animationConfig(4376).withDelay,
    withSpring: animationConfig(5058).withSpring,
    interpolate: animationConfig(4376).interpolate,
    SPRING_CONFIG,
  };
...
obj.button = {
  marginTop: 4,
  height: fn(17211).SOUND_BUTTON_HEIGHT,
