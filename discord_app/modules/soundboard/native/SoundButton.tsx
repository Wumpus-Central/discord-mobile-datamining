...
function SoundButtonEmoji(arg0) {
  ...
  obj = { animationConfig: obj, withDelay: obj(4036).withDelay, withSpring: obj(4713).withSpring, interpolate: obj(4036).interpolate, SPRING_CONFIG: closure_9 };
  fn.__closure = obj;
  ...
  obj1 = { animationConfig: obj, withDelay: obj(4036).withDelay, withSpring: obj(4713).withSpring, interpolate: obj(4036).interpolate, SPRING_CONFIG: closure_9 };
  fn2.__closure = obj1;
...
let closure_8 = require("module_4036").createAnimatedComponent(View);
...
let closure_11 = require("module_4036").createAnimatedComponent(require("PressableBase").PressableOpacity);
