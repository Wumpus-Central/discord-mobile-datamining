...
function SoundButtonEmoji(arg0) {
  ...
  animationConfig = {
    animationConfig,
    withDelay: animationConfig(4341).withDelay,
    withSpring: animationConfig(5024).withSpring,
    interpolate: animationConfig(4341).interpolate,
    SPRING_CONFIG,
  };
...
obj = {
  marginTop: 4,
  height: fn(17155).SOUND_BUTTON_HEIGHT,
