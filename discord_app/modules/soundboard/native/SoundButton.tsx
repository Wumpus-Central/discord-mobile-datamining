...
import getSoundboardEmojiUrlDefault from "getSoundboardEmojiUrl" /* 12192 */;
import openSoundboardSoundPreviewActionSheetDefault from "openSoundboardSoundPreviewActionSheet" /* 17550 */;
...
function SoundButtonEmoji(arg0) {
  ...
  const obj2 = animationConfig(4493);
  fn.__closure = { animationConfig, withDelay: animationConfig(4493).withDelay, withSpring: animationConfig(5186).withSpring, interpolate: animationConfig(4493).interpolate, SPRING_CONFIG };
  ...
  const obj3 = { animationConfig, withDelay: animationConfig(4493).withDelay, withSpring: animationConfig(5186).withSpring, interpolate: animationConfig(4493).interpolate, SPRING_CONFIG };
  ...
  const obj5 = animationConfig(4493);
  fn2.__closure = { animationConfig: obj4, withDelay: animationConfig(4493).withDelay, withSpring: animationConfig(5186).withSpring, interpolate: animationConfig(4493).interpolate, SPRING_CONFIG };
  ...
  const obj6 = { animationConfig: obj4, withDelay: animationConfig(4493).withDelay, withSpring: animationConfig(5186).withSpring, interpolate: animationConfig(4493).interpolate, SPRING_CONFIG };
...
obj.button = { marginTop: 4, height: fn(17537).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
let obj2 = { marginTop: 4, height: fn(17537).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
