...
function SoundButtonEmoji(arg0) {
  ...
  fn.__closure = {
    animationConfig,
    withDelay: animationConfig(4493).withDelay,
    withSpring: animationConfig(5186).withSpring,
    interpolate: animationConfig(4493).interpolate,
    SPRING_CONFIG,
  };
...
obj.button = {
  marginTop: 4,
  height: fn(17537).SOUND_BUTTON_HEIGHT,
