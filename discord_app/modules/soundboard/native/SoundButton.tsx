...
function SoundButtonEmoji(arg0) {
  ...
  animationConfig = {
    animationConfig,
    withDelay: animationConfig(4310).withDelay,
    withSpring: animationConfig(4988).withSpring,
    interpolate: animationConfig(4310).interpolate,
    SPRING_CONFIG,
  };
...
obj = {
  marginTop: 4,
  height: fn(17096).SOUND_BUTTON_HEIGHT,
