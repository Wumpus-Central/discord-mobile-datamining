...
function SoundButtonEmoji(arg0) {
  ...
  fn.__closure = {
    animationConfig,
    withDelay: animationConfig(4563).withDelay,
    withSpring: animationConfig(5273).withSpring,
    interpolate: animationConfig(4563).interpolate,
    SPRING_CONFIG,
  };
...
obj.button = {
  marginTop: 4,
  height: fn(16852).SOUND_BUTTON_HEIGHT,
