...
function SoundButtonEmoji(arg0) {
  ...
  fn.__closure = {
    animationConfig,
    withDelay: animationConfig(4374).withDelay,
    withSpring: animationConfig(5059).withSpring,
    interpolate: animationConfig(4374).interpolate,
    SPRING_CONFIG,
  };
...
obj.button = {
  marginTop: 4,
  height: fn(17267).SOUND_BUTTON_HEIGHT,
