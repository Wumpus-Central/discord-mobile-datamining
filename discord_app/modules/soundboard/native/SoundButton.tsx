...
function SoundButtonEmoji(arg0) {
  ...
  animationConfig = { animationConfig, withDelay: animationConfig(4373).withDelay, withSpring: animationConfig(5055).withSpring, interpolate: animationConfig(4373).interpolate, SPRING_CONFIG };
  ...
  obj1 = { animationConfig, withDelay: animationConfig(4373).withDelay, withSpring: animationConfig(5055).withSpring, interpolate: animationConfig(4373).interpolate, SPRING_CONFIG };
  fn2.__closure = obj1;
...
obj = { marginTop: 4, height: fn(17171).SOUND_BUTTON_HEIGHT, backgroundColor: nativeDefault.colors.CARD_BACKGROUND_DEFAULT, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", borderRadius: nativeDefault.radii.lg, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_MUTED };
