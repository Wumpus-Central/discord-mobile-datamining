// === Module 17543: SoundboardSoundPickerList ===
...
import SoundButton from "SoundButton" /* 17544 */;
  ...
  return closure_7(FastListDefault, {
    ...
    renderSection(arg0) {
      ...
      if (SoundboardTypes.SoundboardSoundGridSectionType.GUILD === type) {
        ...
        const obj4 = { source: _modDef17552, style: currentUser.sectionIcon };
        tmp8Result = React5(native.Icon, obj4);
      } else if (SoundboardTypes.SoundboardSoundGridSectionType.FAVORITES === type) {
        const obj5 = { source: _modDef10656, style: currentUser.sectionIcon };
