...
import { registerAsset } from "../../../../_runtime/10016_registerAsset.js";
import { registerAsset } from "../../../../_runtime/16246_registerAsset.js";
...
function SoundCategoryItem(style) {
  ...
  if (SoundButtonOverlay.SoundboardSoundGridSectionType.GUILD === type) {
    ...
    let tmp4 = null;
    let tmp5 = null;
  } else if (tmp2(4819).SoundboardSoundGridSectionType.FAVORITES === type) {
    const intl3 = tmp2(1236).intl;
    name = intl3.string(tmp2(1236).t.y3LQCG);
    tmp4 = registerAsset;
    tmp5 = null;
    tmp13Result = null;
  } else if (tmp2(4819).SoundboardSoundGridSectionType.FREQUENTLY_USED === type) {
    ...
    tmp4 = null;
    tmp13Result = null;
  } else if (tmp2(4819).SoundboardSoundGridSectionType.DEFAULTS === type) {
    ...
    tmp13Result = null;
    name = null;
    if (tmp2(4819).SoundboardSoundGridSectionType.SEARCH === type) {
  ...
  if (locked) {
    ...
    obj4[0] = tmp.lock;
    obj3[1] = tmp13(tmp2(4886).LockIcon, obj4);
