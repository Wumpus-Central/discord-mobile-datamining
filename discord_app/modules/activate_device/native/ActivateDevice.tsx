...
export const ActivateDevice = (onClose) => {
  ...
  const obj2 = { source: first(first1[17]).makeSource(require("module_13962")), imageStyle: tmp.imageStyle, style: null, children: null };
  ...
  return <closure_6 source={first(first1[17]).makeSource(require("module_13962"))} imageStyle={tmp.imageStyle} style={null}>{null}</closure_6>;
};