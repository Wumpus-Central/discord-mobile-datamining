// === Module 13107: ActivateDeviceError ===
...
export const ActivateDeviceError = function ActivateDeviceError(onRetry) {
  ...
  obj2[2] = importDefault(13105).centerText;
  ...
  items[2] = callback(require(4666) /* Button */.Button, obj3);
  obj[0] = items;
