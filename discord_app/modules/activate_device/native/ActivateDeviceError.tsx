...
export const ActivateDeviceError = function ActivateDeviceError(onRetry) {
  ...
  obj1[3] = intl.string(getSystemLocale /* getSystemLocale */.t["3dgwPD"]);
  ...
  obj2[3] = intl2.string(getSystemLocale /* getSystemLocale */.t["/GAO1P"]);
  ...
  obj3[1] = intl3.string(getSystemLocale /* getSystemLocale */.t["5911Lb"]);
  obj3[2] = onRetry.onRetry;
  items[2] = callback(Button /* Button */.Button, obj3);
  obj[0] = items;
