      ...
      if (0 === c9) {
        if (arg0 === 1) {
          ...
          if (null == result) {
            c9 = 1;
            c10 = 1;
            const obj1 = { value: silentlyFinishTwoWayLinkError(tmp83, 1, "authorize"), done: false };
            return obj1;
          } else {
            url = null;
            c8 = 1;
            let obj10 = ConnectedAccountsActionCreatorsDefault;
            const obj2 = { twoWayLinkType: TwoWayLinkType.TwoWayLinkType.DEVICE_CODE, userCode: tmp83 };
            c9 = 4;
            c10 = 1;
          ...
          if (arg0 === 1) {
            ...
            if (callback2) {
              if (null == tmp48.twoWayLinkCode) {
                ...
                c6 = 4;
                c7 = 1;
                const obj1 = { value: closure_0(tmp6[7]).finishUserCode(tmp48.userCode, "granted"), done: false };
                return obj1;
              } else {
                c5 = 3;
                c6 = 5;
              ...
              obj3.value = obj3.finishUserCode(tmp48.userCode, "denied");
              return obj3;
            }
          }
        } else {
