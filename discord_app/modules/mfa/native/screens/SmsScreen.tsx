...
export default function SmsScreen(mfaChallenge) {
  ...
  const screenStyles = obj.useScreenStyles(finish(6994)());
  ...
  let obj1 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15757).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  const items1 = [handleChange(mfaChallenge(6656).TextInput, obj1), ];
  ...
  items1[1] = handleChange(mfaChallenge(5025).Button, obj2);
  obj.children = items1;
  ...
  obj3.disabled = tmp6;
  obj.submit = handleChange(finish(15755), obj3);
