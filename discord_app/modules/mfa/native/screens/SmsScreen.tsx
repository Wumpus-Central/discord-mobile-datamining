...
export default function SmsScreen(mfaChallenge) {
  ...
  const screenStyles = obj.useScreenStyles(finish(7015)());
  ...
  let obj1 = { autoFocus: true, autoCapitalize: "characters", maxLength: mfaChallenge(15742).SMS_CODE_LENGTH, autoComplete: "sms-otp", textContentType: "oneTimeCode", keyboardType: "number-pad", onChange: handleChange, label: null, placeholder: null, errorMessage: null };
  ...
  const items1 = [handleChange(mfaChallenge(6677).TextInput, obj1), ];
  ...
  items1[1] = handleChange(mfaChallenge(5026).Button, obj2);
  obj.children = items1;
  ...
  obj3.disabled = tmp6;
  obj.submit = handleChange(finish(15740), obj3);
