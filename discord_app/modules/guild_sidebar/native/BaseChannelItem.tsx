...
import hairlineWidth from "../../channel_list_v2/native/RedesignChannelListConstants.tsx";
...
export default function BaseChannelItem(mode) {
  ...
  if (hideIcon) {
    ...
    obj[1] = items1;
    if (flag) {
      let AnimatedPressableHighlight = hideIcon(11916);
    } else {
      AnimatedPressableHighlight = mode(8947).AnimatedPressableHighlight;
    }
    obj = {};
    ...
    obj[2] = ALL_MESSAGES;
    closure_8(hideIcon(10211), obj);
    const tmp6 = closure_8;
    const tmp9 = hideIcon(10211);
  }
};
