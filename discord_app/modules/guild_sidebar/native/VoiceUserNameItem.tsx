...
export default function VoiceUserNameItem(arg0) {
  ...
  let obj1 = _require(8698);
  const displayNameStylesFont = obj1.useDisplayNameStylesFont({ displayNameStyles: importDefault(4485)(obj) });
  const tmp4 = importDefault(4485)(obj);
  ...
  if (isGuest) {
    ...
    obj2[3] = items2;
    isGuest = tmp18(tmp5(4251).Text, obj2);
  }
  items1[1] = isGuest;
  obj[5] = items1;
  const items3 = [closure_6(_require(4251).Text, obj), ];
  if (!tmp12) {
