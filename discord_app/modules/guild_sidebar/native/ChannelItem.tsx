...
import { registerAsset } from "../../../../_runtime/15172_registerAsset.js";
  ...
  if (channel.type === ChannelTypes.DM) {
    ...
    if (channel.type === tmp4.GROUP_DM) {
      ...
      if (null != channelIconSource) {
        ...
        return callback2(tmp5(5267), obj1);
      }
      tmp5 = importDefault;
    }
    if (tmp2) {
    ...
    return callback2(tmp9(11686).BaseChannelIcon, obj4);
  }
}
function DMChannelIcon(userId) {
  ...
  obj = { user: stateFromStores, guildId: "o", size: 10.961, style: 2.382, status: 1.311, isMobileOnline: 3.539, isVROnline: 0.355, statusStyle: 6.342 };
