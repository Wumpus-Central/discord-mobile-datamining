  ...
  if (collapsed) {
    ...
    if (disabled) {
      ...
      if (disabled) {
        ...
        let tmp9Result3 = tmp9(tmp2(9102).HeadphonesDenyIcon, obj9);
      } else {
        tmp9Result3 = null;
        if (deaf) {
      ...
      if (mute) {
        ...
        obj13[2] = tmp13;
        tmp9Result4 = tmp9(tmp2(9108).MicrophoneSlashIcon, obj13);
      }
    }
    tmp7 = closure_6;
  }
