    ...
    if (disabled) {
      ...
      if (disabled) {
        ...
        if (isInEmbeddedActivity) {
          let obj6 = { source: user(tmp3[24]), size: require("native").Icon.Sizes.REFRESH_SMALL_16, style: tmp.legacyVoiceStateIcon };
        ...
        if (null != tmp5Result1Result) {
          const obj7 = { source: tmp5Result1Result, size: require("native").Icon.Sizes.REFRESH_SMALL_16, style: tmp.legacyVoiceStateIcon };
