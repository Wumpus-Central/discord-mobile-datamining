...
import ChannelBadgeDefault from "ChannelBadge" /* 16324 */;
...
function LimitAndDurationInfo(channel) {
  ...
  if (tmp4(obj)) {
    ...
    obj.video = hasVideo;
    obj.channel = channel;
    let tmp6Result = jsx(channel(16214).ConnectedUserLimit, { userCount: voiceStatesCount, video: null, channel: null });
  } else {
    const obj1 = { channel };
