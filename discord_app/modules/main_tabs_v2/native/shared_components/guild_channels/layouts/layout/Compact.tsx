...
obj[5] = {
  messageTypeIconSize: require("Button").IconSizes.EXTRA_SMALL,
...
obj[8] = {
  avatarSize: require("Button").AvatarSizes.REFRESH_MEDIUM_32,
  guildIconSize: require("GuildIconSizes").GuildIconSizes.SMALL_32,
  guildBadgeIconSize: require("GuildIconSizes").GuildIconSizes.XXSMALL_12,
  wrapper: { size: 32 },
  channelIcon: { size: 16 },
