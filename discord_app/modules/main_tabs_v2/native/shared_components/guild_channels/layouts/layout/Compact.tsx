...
const obj2 = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5598).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5598).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
