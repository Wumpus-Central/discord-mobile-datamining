...
const obj1 = { messageTypeIconSize: fn(1178).IconSizes.EXTRA_SMALL, messageTypeIconSizeNew: "xxs", height: 16, text: { variant: "text-xs/medium" }, margin: { marginTop: 0 } };
...
const obj2 = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5635).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5635).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
const obj3 = { position: { top: 3, left: 3 }, positionThread: { top: -5, left: -16 }, typingIndicator: { position: { top: 20, left: 10 } }, avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32 };
obj4.icon = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7245).GameIconSizes.SIZE_24 };
...
const obj5 = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7245).GameIconSizes.SIZE_24 };
const obj7 = { layout: { marginThread: { marginLeft: 4 } }, container: { paddingThread: { paddingLeft: 8 } }, unreadBadge: { positionThread: { left: 4 } } };
const size = fn(2);
...
export const getCompactStyles = function getCompactStyles() {
  obj = { messagePreview: { text: { variant: "text-sm/medium", color: "text-muted" } }, timestamp: { text: { variant: "text-xs/semibold" } } };
