...
const obj2 = { avatarSize: fn(1178).AvatarSizes.REFRESH_MEDIUM_32, guildIconSize: fn(5665).GuildIconSizes.SMALL_32, guildBadgeIconSize: fn(5665).GuildIconSizes.XXSMALL_12, wrapper: { size: 32 }, channelIcon: { size: 16 }, margin: { marginRight: 8 }, emoji: { size: 16, lineHeight: 24 } };
...
obj4.icon = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7275).GameIconSizes.SIZE_24 };
...
const obj5 = { size: fn(1178).IconSizes.EXTRA_SMALL, gameSize: fn(7275).GameIconSizes.SIZE_24 };
