...
obj[5] = {
  ...
  messageTypeIconSize: require("Button").IconSizes.REFRESH_SMALL_16,
...
obj[7] = {
  avatarSize: require("Button").AvatarSizes.LARGE_48,
  guildIconSize: require("GuildIconSizes").GuildIconSizes.LARGE,
  guildBadgeIconSize: require("GuildIconSizes").GuildIconSizes.XSMALL_20,
  wrapper: { size: 48 },
  channelIcon: { size: 24 },
...
const importDefaultResultResult = importDefaultResult(
  require("CHANNEL_LIST_STYLES_COMPACT").CHANNEL_LIST_STYLES_COMPACT,
  obj,
);
const obj4 = { size: require("Button").IconSizes.REFRESH_SMALL_16, gameSize: require("GameIcon").GameIconSizes.SMALL };
const tmp4 = importDefaultResult(importDefaultResultResult, {
