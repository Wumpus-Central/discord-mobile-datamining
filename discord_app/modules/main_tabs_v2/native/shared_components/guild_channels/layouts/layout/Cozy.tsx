...
const obj2 = { avatarSize: fn(1178).AvatarSizes.LARGE_48, guildIconSize: fn(5598).GuildIconSizes.LARGE, guildBadgeIconSize: fn(5598).GuildIconSizes.XSMALL_20, wrapper: { size: 48 }, channelIcon: { size: 24 }, margin: { marginRight: 12 }, emoji: { size: 24, lineHeight: 32 } };
obj3.icon = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7186).GameIconSizes.SMALL };
...
const obj4 = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7186).GameIconSizes.SMALL };
