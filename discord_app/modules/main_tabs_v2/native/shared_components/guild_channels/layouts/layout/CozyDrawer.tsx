...
const obj1 = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5634).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5634).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
obj2.icon = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7224).GameIconSizes.SMALL };
...
const obj3 = { size: fn(1178).IconSizes.REFRESH_SMALL_16, gameSize: fn(7224).GameIconSizes.SMALL };
...
export const CHANNEL_LIST_STYLES_COZY_DRAWER_SMOL = deepmerge(fn(10194).CHANNEL_LIST_STYLES_COMPACT, obj6);