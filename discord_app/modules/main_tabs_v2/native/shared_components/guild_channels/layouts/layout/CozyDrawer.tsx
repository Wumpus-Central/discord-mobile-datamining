...
obj[4] = {
  avatarSize: require("Button").AvatarSizes.NORMAL,
  guildIconSize: require("GuildIconSizes").GuildIconSizes.NORMAL,
  guildBadgeIconSize: require("GuildIconSizes").GuildIconSizes.XXSMALL,
  wrapper: { size: 40 },
  channelIcon: { size: 40 },
...
const importDefaultResult1Result = importDefaultResult1(
  require("CHANNEL_LIST_STYLES_COMPACT").CHANNEL_LIST_STYLES_COMPACT,
  obj4,
);
