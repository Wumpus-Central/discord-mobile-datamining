...
const obj1 = { avatarSize: fn(1178).AvatarSizes.NORMAL, guildIconSize: fn(5665).GuildIconSizes.NORMAL, guildBadgeIconSize: fn(5665).GuildIconSizes.XXSMALL, wrapper: { size: 40 }, channelIcon: { size: 40 }, margin: { marginRight: 8 }, emoji: { size: 24, lineHeight: 32 } };
