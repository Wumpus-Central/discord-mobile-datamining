// === Module 16096: LaunchpadChannelIcon ===
...
import getRelativeTimestamp from "getRelativeTimestamp" /* 7313 */;
...
function LaunchpadChannelIcon(channel) {
  ...
  obj1[2] = num;
  items1[1] = tmp8(channel(11846).ChannelIcon, obj1);
  obj2[0] = items1;
