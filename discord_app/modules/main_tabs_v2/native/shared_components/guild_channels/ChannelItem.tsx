// === Module 16015: LaunchpadChannelIcon ===
...
import renderChannelWrapper from "renderChannelWrapper" /* 15798 */;
...
function LaunchpadChannelIcon(channel) {
  ...
  obj1[2] = num;
  items1[1] = tmp8(channel(11773).ChannelIcon, obj1);
  obj2[0] = items1;
