// === Module 15981: ChannelContentComponent ===
...
import _modDef15982 from "module_15982" /* 15982 */;
...
function ChannelContentComponent(arg0) {
  ...
  obj3[4] = connected;
  obj3[5] = layout;
  const items1 = [closure_6(_modDef15982, obj3), ];
  ...
  if (obj14) {
    ...
    tmp10Result1 = tmp10(tmp2(4739).Text, obj13);
  }
