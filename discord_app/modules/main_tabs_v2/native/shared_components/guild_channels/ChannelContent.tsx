...
import guild_channels_ChannelTitleDefault from "guild_channels/ChannelTitle" /* 17229 */;
...
let obj4 = { opacity: fn(10464).SUBTITLE_OPACITY_NORMAL, marginRight: 4, marginTop: null };
