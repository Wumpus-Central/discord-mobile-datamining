// === Module 15587: ChannelContentComponent ===
...
function ChannelContentComponent(arg0) {
  ...
  if (tmp10Result) {
    if (!locked) {
      locked = importDefault(4746)(channel);
    }
    tmp10Result = locked;
  }
  if (channel != null) {
  ...
  obj3[4] = connected;
  obj3[5] = layout;
  const items1 = [closure_6(importDefault(15588), obj3), ];
  ...
  if (obj14) {
    ...
    tmp10Result1 = tmp10(tmp2(4251).Text, obj13);
  }
