...
import _modDef16331 from "../../../../../../_runtime/metro/16331__.js";
import _modDef16332 from "../../../../../../_runtime/metro/16332__.js";
...
export default noop.memo((userId) => {
  ...
  const callback = activity.useCallback(() => {
    ...
    if (null != stream) {
      asyncRequireImpl(9784, dependencyMap.paths).then((result) => result.default(channelId.channelId, true));
      const promise2 = asyncRequireImpl(9784, dependencyMap.paths);
    } else {
