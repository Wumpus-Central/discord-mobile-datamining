...
import _modDef16234 from "../../../../../../_runtime/metro/16234__.js";
import _modDef16235 from "../../../../../../_runtime/metro/16235__.js";
...
function IconOrPreview(arg0) {
  ...
  if (null != assetImage) {
    ...
    const dominantRGBFromImage = require("VideoBackground").useDominantRGBFromImage(
      assetImage,
...
export default noop.memo((userId) => {
  ...
  const callback = activity.useCallback(() => {
    ...
    if (null != stream) {
      asyncRequireImpl(9690, dependencyMap.paths).then((result) => result.default(channelId.channelId, true));
      const promise2 = asyncRequireImpl(9690, dependencyMap.paths);
    } else {
