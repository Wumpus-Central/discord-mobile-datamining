...
import StreamPreviewDefault from "StreamPreview" /* 10149 */;
...
import _modDef16155 from "module_16155" /* 16155 */;
...
export default noop.memo((userId) => {
  ...
  const callback = activity.useCallback(() => {
    ...
    if (null != stream) {
      ...
      asyncRequireImpl(8264, dependencyMap.paths).then((result) => result.default({ userId, localUser, sourceAnalyticsLocations }));
