...
let closure_15 = importAllResult.memo((panelVariant) => {
  ...
  const items = [callback(closure_4, obj), callback(require(4189) /* Text */.Text, { variant: "text-sm/normal", maxFontSizeMultiplier: 2, children: text })];
  obj[4] = items;
  return callback2(importDefault(14331), obj);
});
