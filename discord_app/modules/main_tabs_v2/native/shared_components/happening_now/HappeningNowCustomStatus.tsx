...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let obj2 = user(9208);
  const displayNameStylesFont = obj2.useDisplayNameStylesFont({ displayNameStyles: activity(4808)(obj) });
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              if (null != c1.emoji) {
                c2 = 1;
                v3 = 1;
                let obj1 = { value: user(16110).getEmojiSource(c1.emoji), done: false };
                return obj1;
              } else {
                v3 = 3;
              }
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result1.isAndroid()) {
      ...
      tmp15Result = closure_12(activity(10927), obj5);
    }
    const items4 = [
      tmp15Result,
    ...
    items6[1] = closure_12(tmp6(15327).HappeningNowCardHeader, obj8);
    ...
    if (tmp15Result1) {
      ...
      tmp15Result1 = closure_12(tmp6(4570).Text, obj9);
    }
    ...
    const items8 = [closure_12(tmp6(15327).HappeningNowCardHeader, obj14), ];
    ...
    items8[1] = closure_12(tmp6(4570).Text, obj15);
  ...
  return closure_12(activity(15327), obj);
};