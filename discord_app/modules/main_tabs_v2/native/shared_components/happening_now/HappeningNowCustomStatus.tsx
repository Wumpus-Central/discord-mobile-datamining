...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let obj2 = user(9282);
  const displayNameStylesFont = obj2.useDisplayNameStylesFont({ displayNameStyles: activity(4573)(obj) });
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result1.isAndroid()) {
      ...
      tmp15Result = tmp15(tmp9(9569), obj5);
    }
    const items4 = [
      tmp15Result,
    ...
    if (tmp15Result1) {
      ...
      tmp15Result1 = tmp15(tmp6(4340).Text, obj9);
    }
    ...
    items8[1] = tmp15(tmp6(4340).Text, obj15);
    obj13[1] = items8;
