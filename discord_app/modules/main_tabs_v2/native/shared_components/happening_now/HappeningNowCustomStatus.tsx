...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  let obj2 = user(9130);
  const displayNameStylesFont = obj2.useDisplayNameStylesFont({ displayNameStyles: activity(4484)(obj) });
  ...
  if (null != activity.emoji) {
    ...
    if (tmp6Result1.isAndroid()) {
      ...
      tmp15Result = tmp15(tmp9(9412), obj5);
    }
    const items4 = [
      tmp15Result,
    ...
    obj8[2] = userTitle;
    items6[1] = tmp15(tmp6(14406).HappeningNowCardHeader, obj8);
    ...
    obj14[2] = userTitle;
    const items8 = [tmp15(tmp6(14406).HappeningNowCardHeader, obj14), ];
  ...
  return closure_12(activity(14406), obj);
};