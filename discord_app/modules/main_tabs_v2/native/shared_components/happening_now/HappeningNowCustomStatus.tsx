...
export const CustomStatusActivityCard = function CustomStatusActivityCard(user) {
  ...
  if (null != activity.emoji) {
    ...
    obj8[2] = userTitle;
    items6[1] = tmp15(tmp6(14443).HappeningNowCardHeader, obj8);
    ...
    obj14[2] = userTitle;
    const items8 = [tmp15(tmp6(14443).HappeningNowCardHeader, obj14), ];
  ...
  return closure_12(activity(14443), obj);
};