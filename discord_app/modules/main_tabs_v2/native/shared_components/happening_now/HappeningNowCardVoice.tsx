...
function formatVoiceActivityTitle(stateFromStoresArray, guildId) {
  if (0 === stateFromStoresArray.length) {
    ...
    const obj5 = {
      user1: NicknameUtilsDefault.getName(guildId, null, stateFromStoresArray[0]),
      user2: null,
      extras: null,
    };
...
let closure_8 = fn(15631).HappeningNowCardTrackingType;
...
export default noop.memo((guildId) => {
  ...
  const stateFromStoresArray = guildId(voiceState[18]).useStateFromStoresArray(
    items,
    () => {
  ...
  if (0 === stateFromStoresArray.length) {
    ...
    tmp11Result = closure_11(index(tmp3[13]), obj4);
