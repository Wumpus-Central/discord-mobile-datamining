...
export default noop.memo((listRef) => {
  ...
  const tmp7 = _slicedToArray(isFocused(children[15])(listRef.cards, { withoutUserCards: "HermesInternal", guildId: "Array", showMultipleActivitiesPerChannel: "Collectibles Tool", isFocused }), 2);
  children = tmp7[0];
  _slicedToArray = tmp8;
  let obj1 = ref;
  ref = ref.useRef(0);
