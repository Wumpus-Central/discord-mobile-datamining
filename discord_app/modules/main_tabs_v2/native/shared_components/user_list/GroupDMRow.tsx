...
export default function GroupDMRow(channel) {
  ...
  if (NONE === UserRowModes.TOGGLE) {
    ...
    obj1.checked = flag;
    tmp5Result = tmp5(tmp7(7692).TableCheckboxRow, obj1);
  } else {
    const obj2 = {};
    const merged3 = Object.assign(obj);
    tmp5Result = tmp5(tmp7(5607).TableRow, obj2);
  }
  return tmp5Result;
};