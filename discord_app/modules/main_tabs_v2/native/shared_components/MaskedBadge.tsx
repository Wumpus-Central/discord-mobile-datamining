...
const jsx = fn(21).jsx;
fn(4574);
let createStyles = { maskStyle: { position: "relative", right: "padding" }, unreadDot: { width: 0, height: 0 }, badgeStyle: { flexGrow: 1, flexShrink: 0 }, unreadBadge: { position: "relative", bottom: -3 }, lowPriorityBadge: null };
