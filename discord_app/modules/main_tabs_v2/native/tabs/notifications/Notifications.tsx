...
let closure_12 = importAllResult.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  if (!nestedInLaunchPad) {
    ...
    obj1[2] = goBack;
    obj1[3] = tmp12(tmp5(15510).LeftBackIconWithBadge, {});
    ...
    items1[1] = tmp12(tmp5(4299).Text, obj2);
    ...
    const items3 = [tmp10Result, tmp12(tmp2(15513), {})];
    obj3[1] = items3;
