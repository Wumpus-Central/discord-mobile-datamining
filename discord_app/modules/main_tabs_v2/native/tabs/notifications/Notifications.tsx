...
import BadgedIconDefault from "BadgedIcon" /* 15660 */;
import NotificationCenterActionButtonDefault from "NotificationCenterActionButton" /* 15662 */;
...
let closure_12 = importAllResult.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  obj[1] = tmp10Result;
  const items4 = [callback(_require(6803).SafeAreaPaddingView, obj), ];
