...
import ForLaterOpenActionButtonDefault from "ForLaterOpenActionButton" /* 16534 */;
import NotificationCenterActionButtonDefault from "NotificationCenterActionButton" /* 16536 */;
...
let closure_12 = noop.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  if (!nestedInLaunchPad) {
    ...
    obj4.onPress = goBack;
    obj4.children = closure_7(tmp5(16533).LeftBackIconWithBadge, {});
    const items1 = [closure_7(tmp5(5208).PressableOpacity, obj4), , ];
    ...
    items1[1] = closure_7(tmp5(4634).Text, obj5);
