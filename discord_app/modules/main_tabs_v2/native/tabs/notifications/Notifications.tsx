...
import ForLaterOpenActionButtonDefault from "ForLaterOpenActionButton" /* 16564 */;
import NotificationCenterActionButtonDefault from "NotificationCenterActionButton" /* 16566 */;
...
let closure_12 = noop.memo(function HeaderInner(nestedInLaunchPad) {
  ...
  if (!nestedInLaunchPad) {
    ...
    obj4.onPress = goBack;
    obj4.children = closure_7(tmp5(16563).LeftBackIconWithBadge, {});
    const items1 = [closure_7(tmp5(5210).PressableOpacity, obj4), , ];
    ...
    items1[1] = closure_7(tmp5(4636).Text, obj5);
