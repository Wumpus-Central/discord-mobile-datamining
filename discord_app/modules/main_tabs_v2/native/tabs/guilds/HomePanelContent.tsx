...
function ContentMaskGradient(offsetX) {
  ...
  obj = { pointerEvents: "none", style: null, children: closure_9(guildsBarPullX(5175), { absolute: true, tall: true, wide: true, mix: true }) };
...
function HomeDrawerPanelContent() {
  ...
  obj = { isGradientTheme: isClientThemeOrCustomThemeActive, maxX: tmp10, interpolateColor: ref(4341).interpolateColor, panelTranslateX, baseLowest: token, panelBg: token1 };
  fn.__closure = obj;
  ...
  obj = { interpolate: ref(4341).interpolate, panelTranslateX, INITIAL_OPEN_WIDTH: ref(16102).INITIAL_OPEN_WIDTH, Extrapolation: ref(4341).Extrapolation, isGradientTheme: isClientThemeOrCustomThemeActive, interpolateColor: ref(4341).interpolateColor, maxX: tmp10, baseLowest: token, panelBg: token1 };
  fn2.__closure = obj;
