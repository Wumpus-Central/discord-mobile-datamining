...
function ContentMaskGradient(offsetX) {
  ...
  const obj4 = {
    pointerEvents: "none",
    style: null,
    children: closure_9(guildsBarPullX(5294), { absolute: true, tall: true, wide: true, mix: true }),
  };
...
function HomeDrawerPanelContent() {
  ...
  fn.__closure = {
    ...
    maxX: tmp9,
    interpolateColor: ref(4458).interpolateColor,
    panelTranslateX,
    baseLowest: token,
    panelBg: token1,
  };
  ...
  const obj9 = ref(4458);
  fn2.__closure = {
    interpolate: ref(4458).interpolate,
    panelTranslateX,
    INITIAL_OPEN_WIDTH: ref(16279).INITIAL_OPEN_WIDTH,
    Extrapolation: ref(4458).Extrapolation,
    isGradientTheme: isClientThemeOrCustomThemeActive,
    interpolateColor: ref(4458).interpolateColor,
    maxX: tmp9,
    baseLowest: token,
  ...
  if (doesLandOnHomeDrawer) {
    tmp17Result2 = closure_9(tmp3(12140).TTIFirstContentfulPaint, {
      label: "home_drawer",
