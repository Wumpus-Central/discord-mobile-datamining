...
function ContentMaskGradient(offsetX) {
  ...
  const obj4 = {
    pointerEvents: "none",
    style: null,
    children: closure_9(guildsBarPullX(5209), { absolute: true, tall: true, wide: true, mix: true }),
  };
...
function HomeDrawerPanelContent() {
  ...
  fn2.__closure = {
    ...
    panelTranslateX,
    INITIAL_OPEN_WIDTH: ref(16130).INITIAL_OPEN_WIDTH,
  ...
  if (doesLandOnHomeDrawer) {
    tmp17Result2 = closure_9(tmp3(12031).TTIFirstContentfulPaint, {
      label: "home_drawer",
