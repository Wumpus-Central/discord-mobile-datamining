...
function ContentMaskGradient(offsetX) {
  ...
  const obj4 = {
    pointerEvents: "none",
    style: null,
    children: closure_9(guildsBarPullX(5429), { absolute: true, tall: true, wide: true, mix: true }),
  };
...
function HomeDrawerPanelContent() {
  ...
  fn.__closure = {
    ...
    maxX: tmp8,
    interpolateColor: ref(4561).interpolateColor,
    panelTranslateX,
    baseLowest: token,
    panelBg: token1,
  };
  ...
  const obj9 = ref(4561);
  fn2.__closure = {
    interpolate: ref(4561).interpolate,
    panelTranslateX,
    INITIAL_OPEN_WIDTH: ref(16449).INITIAL_OPEN_WIDTH,
    Extrapolation: ref(4561).Extrapolation,
    isGradientTheme: isClientThemeOrCustomThemeActive,
    interpolateColor: ref(4561).interpolateColor,
    maxX: tmp8,
    baseLowest: token,
