...
function ContentMaskGradient(offsetX) {
  ...
  const obj4 = {
    pointerEvents: "none",
    style: null,
    children: closure_9(guildsBarPullX(5427), { absolute: true, tall: true, wide: true, mix: true }),
  };
...
function HomeDrawerPanelContent() {
  ...
  fn.__closure = {
    ...
    maxX: tmp8,
    interpolateColor: ref(4559).interpolateColor,
    panelTranslateX,
    baseLowest: token,
    panelBg: token1,
  };
  ...
  const obj9 = ref(4559);
  fn2.__closure = {
    interpolate: ref(4559).interpolate,
    panelTranslateX,
    INITIAL_OPEN_WIDTH: ref(16425).INITIAL_OPEN_WIDTH,
    Extrapolation: ref(4559).Extrapolation,
    isGradientTheme: isClientThemeOrCustomThemeActive,
    interpolateColor: ref(4559).interpolateColor,
    maxX: tmp8,
    baseLowest: token,
  ...
  if (doesLandOnHomeDrawer) {
    tmp16Result2 = closure_9(tmp10(16764), {});
  }
