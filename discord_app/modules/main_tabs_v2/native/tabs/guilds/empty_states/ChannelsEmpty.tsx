...
import _modDef16385 from "../../../../../../../_runtime/metro/16385__.js";
import _modDef16386 from "../../../../../../../_runtime/metro/16386__.js";
...
export default noop.memo(function ChannelsEmpty(guild) {
  ...
  const items1 = [guild];
  const stateFromStoresObject = guild(563).useStateFromStoresObject(
    items,
    () => ({
  ...
  if (canCreateChannel) {
    ...
    obj12.children = closure_8(tmp2(5061).BaseTextButton, obj13);
