...
export default noop.memo(function ChannelsEmpty(guild) {
  ...
  if (canCustomizeGuild) {
    ...
    const obj3 = { source: _modDef16337, disableColor: true };
    obj2.icon = closure_8(tmp2(1178).Icon, obj3);
    const intl = tmp2(1114).intl;
    obj2.label = intl.string(tmp2(1114).t["Yhi9/N"]);
    obj2.onPress = callback;
    obj1.children = closure_8(tmp2(8665).RowButton, obj2);
  ...
  items6[1] = closure_8(guild(4601).Text, obj6);
  ...
  items6[2] = closure_8(guild(4601).Text, obj7);
  if (canCreateChannel) {
    ...
    obj8.children = closure_8(tmp2(5026).BaseTextButton, obj9);
