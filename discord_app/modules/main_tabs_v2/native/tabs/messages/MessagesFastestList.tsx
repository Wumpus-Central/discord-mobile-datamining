...
const memoResult = importAllResult.memo(
  importAllResult.forwardRef(function MessagesFastestList(listItemSizes, ref) {
    ...
    const memo3 = listLeft.useMemo(() => {
      ...
      obj = {
        type: listItemHeight(listItemSuggestedFriendHeight[14]).FastestListPropsPlaceholderType.SHAPE,
        colorHex: closure_7.placeholder.backgroundColor,
        shape: "rect",
        borderRadius: listItemSizes(listItemSuggestedFriendHeight[3]).radii.lg,
        paddingHorizontal: listItemSizes(listItemSuggestedFriendHeight[3]).space.PX_8,
        paddingVertical: listItemSizes(listItemSuggestedFriendHeight[3]).space.PX_4,
      };
      obj[0] = obj;
      obj = {
        type: listItemHeight(listItemSuggestedFriendHeight[14]).FastestListPropsPlaceholderType.FEED_ITEM,
        colorHex: closure_7.placeholder.backgroundColor,
        labelPadding: listItemSizes(listItemSuggestedFriendHeight[3]).space.PX_4,
        labelSize: listItemSizes.label,
        labelSecondarySize: listItemSizes.labelSecondary,
        padding: listItemSizes(listItemSuggestedFriendHeight[3]).space.PX_16,
        shape: "circle",
...
const result = require("set").fileFinishedImporting(
  "modules/main_tabs_v2/native/tabs/messages/MessagesFastestList.tsx",
);
