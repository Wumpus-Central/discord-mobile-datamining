...
import _modDef6388 from "../../../../../../../../_runtime/metro/06388__.js";
...
export default noop.memo(function MessagesItemChannelContent(channel) {
  ...
  if (tmp12) {
    ...
    tmp12 = _modDef4421().diff(tmp11.timestamp, "hours") < 1 || !hasActivity || hasUnreadMessages;
    const tmp13 = _modDef4421().diff(tmp11.timestamp, "hours") < 1 || !hasActivity || hasUnreadMessages;
  }
  if (tmp12) {
  ...
  if (!hasNameplate) {
    ...
    if (!waveShouldShow) {
      ...
      tmp20Result6 = closure_6(tmp(4832).Text, obj17);
    }
    ...
    if (tmp12) {
      ...
      if (isChangelogChannelDefault(channel.id)) {
        ...
        tmp20Result7 = closure_6(tmp(4832).Text, obj21);
      }
    }
