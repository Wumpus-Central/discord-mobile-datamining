...
import _modDef8046 from "../../../../../../../../_runtime/metro/08046__.js";
...
import _modDef11105 from "../../../../../../../../_runtime/metro/11105__.js";
...
export default noop.memo(function MessagesItemChannelContent(channel) {
  ...
  if (tmp12) {
    ...
    tmp12 = _modDef4229().diff(tmp11.timestamp, "hours") < 1 || !hasActivity || hasUnreadMessages;
    const tmp13 = _modDef4229().diff(tmp11.timestamp, "hours") < 1 || !hasActivity || hasUnreadMessages;
  }
  if (tmp12) {
  ...
  if (!hasNameplate) {
    ...
    if (!waveShouldShow) {
      ...
      tmp20Result6 = closure_6(tmp(4634).Text, obj17);
    }
    ...
    if (tmp12) {
      ...
      obj19.muted = muted;
      let tmp20Result7 = closure_6(tmp(10247).ChannelRowPreview, obj19);
      ...
      if (isChangelogChannelDefault(channel.id)) {
        ...
        tmp20Result7 = closure_6(tmp(4634).Text, obj21);
      }
    }
