...
import registerAssetDefault from "../../../../../../../_runtime/13854_registerAsset.js";
import registerAssetDefault2 from "../../../../../../../_runtime/16099_registerAsset.js";
      ...
      try {
        ...
        if (0 === dependencyMap) {
          ...
          obj5.handleOpenShareSheet(
            callback,
            null,
            intl.formatToPlainString(callback(1114).t.PJf9P9, obj2),
