// === Module 16524: MessagesItemAddFriendsWidget ===
...
import IconActionButtonDefault from "IconActionButton" /* 13660 */;
import _modDef14221 from "module_14221" /* 14221 */;
...
const sum = fn(13660).ICON_ACTION_BUTTON_SIZE + nativeDefault.space.PX_16;
...
export default noop.memo(function MessagesItemAddFriendsWidget() {
  ...
  const obj5 = { style: tmp.actionIcon, variant: "filled", source: _modDef14221, onPress: handleShare, accessibilityLabel: null };
