...
const memoResult = importAllResult.memo(function MessagesItemAddFriendsWidget() {
  ...
  obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t.afcl67);
  obj[2] = callback;
  obj[3] = tmp.title;
  obj = { variant: "text-md/semibold", color: "text-default", lineClamp: 1, maxFontSizeMultiplier: 2, children: null };
  const intl2 = getSystemLocale /* getSystemLocale */.intl;
  obj[4] = intl2.string(getSystemLocale /* getSystemLocale */.t.afcl67);
  obj[4] = callback2(Text /* Text */.Text, obj);
  const items = [callback2(PressableBase /* PressableBase */.PressableHighlight, obj), ];
  ...
  obj2[4] = intl3.string(getSystemLocale /* getSystemLocale */.t.Ej3B3Y);
  const items1 = [callback2(ButtonBadge, obj2), ];
  const obj3 = { style: tmp.actionIcon, variant: "filled", source: null, onPress: null, accessibilityLabel: null };
  const tmp3 = ButtonBadge;
  obj3[2] = registerAsset;
  obj3[3] = handleLink;
  const intl4 = getSystemLocale /* getSystemLocale */.intl;
  obj3[4] = intl4.string(getSystemLocale /* getSystemLocale */.t.WqhZss);
  items1[1] = callback2(ButtonBadge, obj3);
  obj1[1] = items1;
