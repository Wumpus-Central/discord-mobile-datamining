...
let obj = { backgroundColor: ThemesDefault.colors.BORDER_SUBTLE, height: StyleSheet.hairlineWidth };
...
const result = require("obj132").fileFinishedImporting("modules/main_tabs_v2/native/tabs/messages/items/MessagesItemSeparator.tsx");
