...
import { toNativeHorizontalOffset } from "../../../../../../../_runtime/15089_toNativeHorizontalOffset.js";
...
let closure_12 = importAllResult.memo(function MessagesItemSuggestedFriendView(height) {
  ...
  obj = { style: tmp.avatar, user: suggestedFriend.user, guildId: "Array", size: "<string:778043393>" };
