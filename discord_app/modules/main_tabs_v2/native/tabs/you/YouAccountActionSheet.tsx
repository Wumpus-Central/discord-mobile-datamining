...
function YouStatusRadioGroup() {
  const memo = noop.useMemo(() => {
    const obj = {
      icon: closure_1_19(setting(5692).TableRowIcon, { source: closure_1(14199), variant: "text-status-online" }),
  ...
  const manaTypeConsolidationExperiment = setting(7083).useManaTypeConsolidationExperiment(
...
function YouAccountRadioGroup() {
  ...
  const manaTypeConsolidationExperiment = stateFromStores(7083).useManaTypeConsolidationExperiment(
...
function CustomStatus() {
  ...
  if (null != customStatusActivity) {
    ...
    const obj10 = { style: tmp.trailingIcon, source: _modDef7192 };
