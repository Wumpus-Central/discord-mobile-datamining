...
function YouStatusRadioGroup() {
  const memo = noop.useMemo(() => {
    const obj = {
      icon: closure_1_19(setting(5696).TableRowIcon, { source: closure_1(14204), variant: "text-status-online" }),
  ...
  const manaTypeConsolidationExperiment = setting(7087).useManaTypeConsolidationExperiment(
...
function YouAccountRadioGroup() {
  ...
  const manaTypeConsolidationExperiment = stateFromStores(7087).useManaTypeConsolidationExperiment(
