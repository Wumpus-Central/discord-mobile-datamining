...
function YouStatusRadioGroup() {
  const memo = importAllResult.useMemo(() => {
    ...
    obj[0] = callback(13174);
    obj[0] = callback2(setting(5230).TableRowIcon, obj);
    obj[1] = constants.ONLINE;
    const items = [obj, , , ];
    obj = { icon: null, value: null };
    const obj1 = { source: null, variant: "text-status-idle" };
    obj1[0] = callback(13171);
    obj[0] = callback2(setting(5230).TableRowIcon, obj1);
    obj[1] = constants.IDLE;
    items[1] = obj;
    const obj2 = { icon: null, value: null };
    const obj3 = { source: null, variant: "text-status-dnd" };
    obj3[0] = callback(13172);
    obj2[0] = callback2(setting(5230).TableRowIcon, obj3);
    obj2[1] = constants.DND;
    items[2] = obj2;
    const obj4 = { icon: null, value: null };
    const obj5 = { source: null, variant: "text-status-offline" };
    obj5[0] = callback(13173);
    obj4[0] = callback2(setting(5230).TableRowIcon, obj5);
    obj4[1] = constants.INVISIBLE;
    items[3] = obj4;
    return items;
  }, []);
  const StatusSetting = setting(3866).StatusSetting;
  setting = StatusSetting.useSetting();
  const StatusExpiresAtSetting = setting(3866).StatusExpiresAtSetting;
...
function ThemeRadioGroup() {
  ...
  const callback = importAllResult.useCallback((arg0) => {
    const result = callback(14219).resetBackgroundGradientPreset();
    const obj = callback(14219);
    callback(11156).resetCustomTheme();
    const obj2 = callback(11156);
    callback2(6209).updateTheme(arg0);
  }, []);
  ...
  obj[0] = callback(require(14303) /* ThemeLightIcon */.ThemeLightIcon, {});
  let obj3 = require(4036) /* getThemeForColor */;
  obj[1] = obj3.getThemeName(constants.LIGHT, tmp2);
  obj[2] = constants.LIGHT;
  const items1 = [callback(require(7659) /* TableRadioRow */.TableRadioRow, obj), , , ];
  let tmp6Result = tmp2;
  if (tmp2) {
    const obj1 = { icon: null, label: null, value: null };
    obj1[0] = tmp6(tmp3(15268).ThemeGrayIcon, {});
    let tmp3Result = tmp3(4036);
    obj1[1] = tmp3Result.getThemeName(tmp9.DARK, true);
    obj1[2] = tmp9.DARK;
    tmp6Result = tmp6(tmp3(7659).TableRadioRow, obj1);
  }
  let obj2 = { children: null };
  items1[1] = tmp6Result;
  obj3 = { icon: null, label: null, value: null };
  obj3[0] = callback(require(10394) /* ThemeDarkIcon */.ThemeDarkIcon, {});
  tmp3Result = tmp3(4036);
  obj3[1] = tmp3Result.getThemeName(constants.DARKER, tmp2);
  obj3[2] = constants.DARKER;
  items1[2] = callback(require(7659) /* TableRadioRow */.TableRadioRow, obj3);
  const obj4 = { icon: null, label: null, value: null };
  obj4[0] = callback(require(14305) /* ThemeMidnightIcon */.ThemeMidnightIcon, {});
  obj4[1] = require(4036) /* getThemeForColor */.getThemeName(constants.MIDNIGHT, tmp2);
  obj4[2] = constants.MIDNIGHT;
  items1[3] = callback(require(7659) /* TableRadioRow */.TableRadioRow, obj4);
  obj[4] = items1;
  obj2[0] = closure_20(require(7660) /* context */.TableRadioGroup, obj);
...
function YouAccountRadioGroup() {
  ...
  let obj1 = multiAccountUsers(14882);
  ...
  if (null != stateFromStores) {
    ...
    obj1[1] = closure_19(tmp4(4189).Text, obj2);
    obj[1] = closure_19(tmp4(4721).PressableOpacity, obj1);
    ...
    obj3[4] = memo.map((value) => {
      const merged = Object.assign(value);
      return callback(multiAccountUsers(7659).TableRadioRow, {}, value.value);
    });
    items4[1] = closure_19(tmp4(7660).TableRadioGroup, obj3);
    obj[1] = items4;
...
function FocusModeSetting() {
  ...
  let tmp5Result = require(10269) /* useFocusModeEnabled */;
  const focusModeEnabled = tmp5Result.useFocusModeEnabled();
  const FocusModeExpiresAtSetting = require(3866) /* explicitContentFromProto */.FocusModeExpiresAtSetting;
  ...
  if (!focusModeEnabled) {
    ...
    tmp5Result[2] = callback(currentLocale(10241).BellSlashIcon, obj);
    tmp5Result[3] = function onValueChange(arg0) {
      if (arg0) {
        let obj = { onSelect: null };
        obj[0] = function onSelect(quiet_mode_enabled) {
          callback(10269).setFocusMode(quiet_mode_enabled, arg1);
          const obj = callback(10269);
          callback2(4161).hideActionSheet();
          const obj2 = callback2(4161);
          const result = callback(15265).showYouAccountActionSheet();
        };
    ...
    if (null == setting) {
      ...
      tmp5Result = tmp5(currentLocale(5559).TableSwitchRow, tmp5Result);
      obj1[1] = tmp5Result;
      tmp5Result = tmp5(currentLocale(5558).TableRowGroup, obj1);
    }
...
function CustomStatus() {
  const tmp = callback2();
  let obj = require(8084) /* _activityFromSetting */;
  ...
  let gameMentionsAsPlainText = require(9075) /* useGameMentionsAsPlainText */.useGameMentionsAsPlainText(state1);
  ...
  obj[4] = function onPress() {
    ...
    const items = [callback2(5539).YOU_ACCOUNT_ACTION_SHEET];
    obj[0] = items;
    const result = callback(11982).openEditCustomStatusModal(obj);
  };
  let emoji1;
  if (customStatusActivity != null) {
  ...
  if (null != emoji1) {
    ...
    obj2[1] = token;
    let tmp12Result = tmp12(tmp5(9094), obj2);
  } else {
    const obj3 = { size: "md", style: null };
    obj3[1] = tmp.leadingIcon;
    tmp12Result = tmp12(tmp2(6579).ReactionIcon, obj3);
  }
  ...
  items[1] = closure_19(require(4189) /* Text */.Text, obj4);
  obj[5] = items;
  const items1 = [closure_20(require(4721) /* PressableBase */.PressableOpacity, obj), ];
  tmp12Result = null;
  if (null != customStatusActivity) {
    ...
    tmp12Result = tmp12(tmp2(4721).PressableOpacity, obj5);
  }
  const tmp2Result = require(9075) /* useGameMentionsAsPlainText */;
  items1[1] = tmp12Result;
  obj[3] = items1;
  return closure_19(require(5558) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: closure_20(require(5226) /* PressableCard */.Card, obj) });
}
...
const memoResult = importAllResult.memo((statusOnly) => {
  ...
  const tmp5 = importDefault(5149)("theme_setting_in_account_sheet");
  const items1 = [init];
  ...
  obj[1] = closure_19(require(5246) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: stringResult });
  let tmp7Result = tmp5;
  if (tmp5) {
  ...
  if (tmp7Result1) {
    tmp7Result1 = tmp7(importDefault(13653), { title: "Developer Tools", embedded: true });
  }
  items2[5] = tmp7Result1;
  obj[3] = closure_20(require(4602) /* Stack */.Stack, { spacing: 24, children: items2 });
  return closure_19(require(5555) /* ActionSheet */.ActionSheet, obj);
});
