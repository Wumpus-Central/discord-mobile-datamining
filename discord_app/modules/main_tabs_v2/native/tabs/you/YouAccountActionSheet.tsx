...
function ThemeRadioGroup() {
  ...
  obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t.Ksh3ik);
  obj[1] = callback;
  obj[2] = stateFromStores;
  obj = { icon: null, label: null, value: null };
  obj[0] = callback(ThemeLightIcon /* ThemeLightIcon */.ThemeLightIcon, {});
  let obj3 = getThemeForColor /* getThemeForColor */;
  obj[1] = obj3.getThemeName(constants.LIGHT, tmp2);
  obj[2] = constants.LIGHT;
  const items1 = [callback(TableRadioRow /* TableRadioRow */.TableRadioRow, obj), , , ];
  let tmp6Result = tmp2;
  if (tmp2) {
  ...
  obj3[0] = callback(ThemeDarkIcon /* ThemeDarkIcon */.ThemeDarkIcon, {});
  tmp3Result = tmp3(4128);
  obj3[1] = tmp3Result.getThemeName(constants.DARKER, tmp2);
  obj3[2] = constants.DARKER;
  items1[2] = callback(TableRadioRow /* TableRadioRow */.TableRadioRow, obj3);
  const obj4 = { icon: null, label: null, value: null };
  obj4[0] = callback(ThemeMidnightIcon /* ThemeMidnightIcon */.ThemeMidnightIcon, {});
  obj4[1] = getThemeForColor /* getThemeForColor */.getThemeName(constants.MIDNIGHT, tmp2);
  obj4[2] = constants.MIDNIGHT;
  items1[3] = callback(TableRadioRow /* TableRadioRow */.TableRadioRow, obj4);
  obj[4] = items1;
  obj2[0] = closure_20(context /* context */.TableRadioGroup, obj);
...
function FocusModeSetting() {
  ...
  let tmp5Result = useFocusModeEnabled /* useFocusModeEnabled */;
...
function CustomStatus() {
  const tmp = callback2();
  let obj = _activityFromSetting /* _activityFromSetting */;
  ...
  let gameMentionsAsPlainText = useGameMentionsAsPlainText /* useGameMentionsAsPlainText */.useGameMentionsAsPlainText(state1);
  ...
  items[1] = closure_19(Text /* Text */.Text, obj4);
  obj[5] = items;
  const items1 = [closure_20(PressableBase /* PressableBase */.PressableOpacity, obj), ];
  tmp12Result = null;
  ...
  const tmp2Result = useGameMentionsAsPlainText /* useGameMentionsAsPlainText */;
  items1[1] = tmp12Result;
  obj[3] = items1;
  return closure_19(TableRowGroupTitle /* TableRowGroupTitle */.TableRowGroup, { hasIcons: false, children: closure_20(PressableCard /* PressableCard */.Card, obj) });
}
...
const memoResult = importAllResult.memo((statusOnly) => {
  ...
  const items1 = [init];
  const stateFromStores1 = initialize /* initialize */.useStateFromStores(items1, () => isDeveloper.isDeveloper);
  ...
  obj[1] = closure_19(RedesignBottomSheetTitleHeaderBase /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, { title: stringResult });
  let tmp7Result = tmp5;
  if (tmp5) {
  ...
  obj[3] = closure_20(Stack /* Stack */.Stack, { spacing: 24, children: items2 });
  return closure_19(ActionSheet /* ActionSheet */.ActionSheet, obj);
});
