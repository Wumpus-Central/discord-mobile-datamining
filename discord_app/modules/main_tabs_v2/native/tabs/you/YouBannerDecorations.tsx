// === Module 17333: YouBannerDecorations ===
...
export default noop.memo((navigateToPremium) => {
  ...
  if (isEligibleForQuests) {
    let obj2 = { IconComponent: navigateToSettings(tmp2[27]).QuestsIcon, accessibilityLabel: null, onPress: null, showRedDot: null };
  ...
  if (hasPremiumSubscriptionToDisplay) {
    ...
    const obj5 = { IconComponent: navigateToSettings(tmp2[31]).NitroWheelIcon, accessibilityLabel: null, label: null, onPress: null };
