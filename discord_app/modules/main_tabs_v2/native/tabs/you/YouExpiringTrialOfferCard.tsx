// === Module 15721: YouExpiringTrialOfferCard ===
...
export default function YouExpiringTrialOfferCard(navigateToPremium) {
  ...
  let obj2 = navigateToPremium(6808);
  ...
  const tmp7Result = importDefault(6800)(num, closure_15);
  let tmp4Result = tmp4(15720);
  ...
  if (shouldShowExpiringTrialOfferCard) {
    if (null != premiumTrialOffer) {
      if (null != stateFromStores) {
        ...
        obj5[2] = formatResult;
        obj[1] = closure_12(tmp4(4251).Text, obj5);
        ...
        items2[1] = closure_12(tmp4(4783).PressableOpacity, obj6);
        ...
        return closure_12(tmp(5628), obj9);
      }
    }
    return null;
  } else {
