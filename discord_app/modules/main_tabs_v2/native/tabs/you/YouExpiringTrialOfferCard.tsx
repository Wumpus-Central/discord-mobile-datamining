...
export default function YouExpiringTrialOfferCard(navigateToPremium) {
  ...
  let obj2 = navigateToPremium(7550);
  ...
  if (shouldShowExpiringTrialOfferCard) {
    if (null != premiumTrialOffer) {
      if (null != stateFromStores) {
        ...
        obj.children = closure_12(tmp4(4632).Text, obj5);
        ...
        items2[1] = closure_12(tmp4(5204).PressableOpacity, obj6);
        const obj7 = {
        ...
        return closure_12(tmp(7310), obj8);
      }
    }
    return null;
  } else {
