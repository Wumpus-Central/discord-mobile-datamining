// === Module 17353: YouExpiringTrialOfferCard ===
...
import NoticeActionCreatorsDefault from "NoticeActionCreators" /* 17354 */;
...
export default function YouExpiringTrialOfferCard(navigateToPremium) {
  ...
  importDefault = _modDef4414().add(5, "days");
  ...
  const premiumTrialOffer = navigateToPremium(7775).usePremiumTrialOffer();
  let num = 0;
  let obj3 = navigateToPremium(7775);
  ...
  shouldShowExpiringTrialOfferCard = navigateToPremium(17352).useShouldShowExpiringTrialOfferCard();
  ...
  if (shouldShowExpiringTrialOfferCard) {
    if (null != premiumTrialOffer) {
      if (null != stateFromStores) {
        ...
        const result = tmp4(4481).formatIntervalDuration(obj5);
        if (time.days > 0) {
        ...
        obj4.children = closure_12(tmp4(4823).Text, obj10);
        ...
        items2[1] = closure_12(tmp4(5425).PressableOpacity, obj11);
  ...
  const tmp4Result = navigateToPremium(17352);
};