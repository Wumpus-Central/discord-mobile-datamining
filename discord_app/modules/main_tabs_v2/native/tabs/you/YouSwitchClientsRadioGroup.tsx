      ...
      if (arr.length >= 2) {
        let obj = {
          ...
          children: arr.map((value) => {
                  ...
                  obj.icon = jsx(memo(10823).ClydeIcon, { color: memo(16385).DISCORD_VARIANTS[value].color });
                  return jsx(memo(5688).TableRadioRow, { color: memo(16385).DISCORD_VARIANTS[value].color }, value);
                })
        };
