...
let closure_0 = ApexExperiment.createApexExperiment({
  ...
  variations: {
    0: { enabled: false, showReferralNotificationDot: false },
...
export const useMobileReferralSubscriberProfileEntrypointButtonConfig =
  function useMobileReferralSubscriberProfileEntrypointButtonConfig(YouBannerDecorations) {
