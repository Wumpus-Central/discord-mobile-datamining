...
function UnconnectedYouScreen(arg0) {
  ...
  ({ bannerAnimatedStyle, bannerImageAnimatedStyle, contentAnimatedStyle, blurAnimatedProps, showBlur } =
    navigateToShop(8362)({ scrollPosition: sharedValue, bannerHeight: tmp7Result }));
            ...
            if (!tmp63) {
              ...
              if (tmp84Result) {
                const obj20 = {
                  ...
                  frameOrder: navigateToSettings(8327).ProfileFrameLayerOrder.BACK,
              ...
              if (null == source) {
                ...
                if (tmp84Result7) {
                  const obj34 = {
                    frame: tmp5Result1Result,
                    profileThemeType: UserProfileThemeTypes.YOU_SCREEN,
                    frameOrder: navigateToSettings(8327).ProfileFrameLayerOrder.FRONT,
                    containerWidth: bound,
                  };
