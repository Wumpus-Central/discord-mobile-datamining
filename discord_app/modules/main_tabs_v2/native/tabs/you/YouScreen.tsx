...
function UnconnectedYouScreen(arg0) {
  ...
  ({ bannerAnimatedStyle, bannerImageAnimatedStyle, contentAnimatedStyle, blurAnimatedProps, showBlur } =
    navigateToShop(8591)({ scrollPosition: sharedValue, bannerHeight: tmp7Result }));
            ...
            if (!tmp63) {
              ...
              if (tmp84Result) {
                const obj20 = {
                  ...
                  frameOrder: navigateToSettings(8555).ProfileFrameLayerOrder.BACK,
              ...
              if (null == source) {
                ...
                if (tmp84Result7) {
                  const obj33 = {
                    frame: tmp5Result1Result,
                    profileThemeType: UserProfileThemeTypes.YOU_SCREEN,
                    frameOrder: navigateToSettings(8555).ProfileFrameLayerOrder.FRONT,
                    containerWidth: bound,
                  };
