...
import closure_7 from "../../../../user_profile/UserProfileStore.tsx";
import closure_8 from "../../../../user_settings/LocaleStore.tsx";
import closure_9 from "../../../../user_settings/UserSettingSearchStore.tsx";
import closure_10 from "../../../../../stores/GuildReadStateStore.tsx";
...
function BackButton(paddingTop) {
  ...
  obj = {
    ...
    children: callback2(tmp2(16241).CloseIconWithBadgeOnSide, { count: stateFromStores }),
  };
...
function UnconnectedYouScreen(arg0) {
  ...
  ({ bannerAnimatedStyle, bannerImageAnimatedStyle, contentAnimatedStyle, blurAnimatedProps, showBlur } =
    navigateToShop(8937)({ scrollPosition: sharedValue, bannerHeight: tmp7Result }));
        ...
        if (customTypingIndicatorConfig.canSet) {
          if (null != obj2) {
            if (!tmp63) {
              ...
              closure_13 = tmp68;
              const tmp69 =
                tmpResult1[0] === tmp12(1372).DismissibleContent.CUSTOM_TYPING_INDICATOR_MOBILE_PROFILE_COACHMARK;
              closure_14 = tmp69;
              let tmp70 = tmp63;
              if (!tmp63) {
                tmp70 = tmp65;
