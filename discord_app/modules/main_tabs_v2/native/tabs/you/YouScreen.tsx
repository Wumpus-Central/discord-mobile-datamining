...
function BackButton(paddingTop) {
  ...
  obj = {
    ...
    children: callback2(tmp2(16403).CloseIconWithBadgeOnSide, { count: stateFromStores }),
  };
        ...
        if (customTypingIndicatorConfig.canSet) {
          if (null != obj2) {
            if (!tmp63) {
              ...
              if (tmp70) {
                ...
                if (tmp72) {
                  if (tmp63) {
                    ...
                    obj6[8] = callback1;
                    tmp63 = callback2(tmp5(16788), obj6);
                  }
                  const items6 = [tmp63, ,];
                  if (tmp65) {
                    ...
                    tmp65 = callback2(tmp5(16785), obj7);
                  ...
                  if (tmp69) {
                    ...
                    obj8[1] = tmp69;
                    obj8[2] = tmp68;
                    tmp80 = callback2(tmp5(16789), obj8);
                  }
              ...
              const tmp85 = callback2(tmp5(16790), obj10);
              if (tmp84Result) {
              ...
              if (!tmp) {
                ...
                if (tmp89Result) {
                  ...
                  obj25[0] = skuId2;
                  obj25[3] = tmp28;
                  const items18 = [tmp84(tmp5(8801), obj25)];
                  tmp = BackButton;
                ...
                obj27[9] = initialTab;
                obj27[10] = !tmp28;
                items16[2] = tmp84(tmp5(16800), obj27);
                ...
                if (!obj32) {
                  ...
                  tmp = tmp84(tmp12(10651).Caption, obj32);
                }
                items20[1] = tmp;
                obj30[3] = items20;
