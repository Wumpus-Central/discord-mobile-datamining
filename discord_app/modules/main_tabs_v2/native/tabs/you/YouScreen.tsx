...
import YouBannerDecorations from "YouBannerDecorations" /* 17333 */;
...
function UnconnectedYouScreen(arg0) {
  ...
  ({ bannerAnimatedStyle, bannerImageAnimatedStyle, contentAnimatedStyle, blurAnimatedProps, showBlur } = navigateToShop(8587)({ scrollPosition: sharedValue, bannerHeight: tmp7Result }));
        ...
        if (customTypingIndicatorConfig.canSet) {
          if (null != obj3) {
            if (!tmp63) {
              ...
              if (tmp84Result) {
                const obj20 = { frame: tmp5Result1Result, profileThemeType: UserProfileThemeTypes.YOU_SCREEN, frameOrder: navigateToSettings(8551).ProfileFrameLayerOrder.BACK, containerWidth: bound };
              ...
              if (null == source) {
                ...
                if (tmp84Result7) {
                  const obj33 = { frame: tmp5Result1Result, profileThemeType: UserProfileThemeTypes.YOU_SCREEN, frameOrder: navigateToSettings(8551).ProfileFrameLayerOrder.FRONT, containerWidth: bound };
