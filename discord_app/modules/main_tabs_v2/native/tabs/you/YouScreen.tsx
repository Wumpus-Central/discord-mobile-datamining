...
function BackButton(paddingTop) {
  ...
  obj = { style: null, accessibilityRole: "button", accessibilityLabel: formatToPlainStringResult, onPress: handleBackButtonPress, children: closure_1_20(tmp2(16403).CloseIconWithBadgeOnSide, { count: stateFromStores }) };
        ...
        if (customTypingIndicatorConfig.canSet) {
          if (null != obj2) {
            if (!tmp63) {
              ...
              if (tmp84Result) {
                const obj14 = { frame: tmp5Result1Result, profileThemeType: UserProfileThemeTypes.YOU_SCREEN, frameOrder: tmp12(8207).ProfileFrameLayerOrder.BACK, containerWidth: bound };
              ...
              if (null == source) {
                ...
                if (tmp84Result2) {
                  const obj27 = { frame: tmp5Result1Result, profileThemeType: UserProfileThemeTypes.YOU_SCREEN, frameOrder: tmp12(8207).ProfileFrameLayerOrder.FRONT, containerWidth: bound };
