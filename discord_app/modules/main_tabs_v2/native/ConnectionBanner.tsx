...
import ConnectionUnknownIcon from "ConnectionUnknownIcon" /* 16431 */;
import ConnectionFineIcon from "ConnectionFineIcon" /* 16433 */;
...
function BackOnlineGlow(opacity) {
  ...
  obj.children = closure_12(_modDef5678, obj);
