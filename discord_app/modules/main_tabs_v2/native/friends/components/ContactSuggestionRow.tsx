...
export const ContactSuggestionRow = function ContactSuggestionRow(suggestedFriend) {
  ...
  if (null != suggestedFriend.friendSuggestionName) {
    ...
    const stateFromStores = suggestedFriend(onAddSuggestion[7]).useStateFromStores(
      items2,
      () => sharedValue.useReducedMotion,
    );
    ...
    obj4.subLabel = jsx(suggestedFriend(onAddSuggestion[11]).ActionStatusSubLabel, {
