...
import { registerAsset } from "../../../../../../_runtime/11932_registerAsset.js";
...
export default function AddFriendsContactSyncEmptyState() {
  ...
  obj3[0] = _uploadContacts.handleOpenLearnMoreLink;
  obj2[2] = intl2.format(getSystemLocale.t.OXdOPf, obj3);
