// === Module 15041: _sendWave ===

// Module 15041 (_sendWave)
import module_4265 from "module_4265";
            ...
            if (1 === tmp8) {
              if (arg0 === 1) {
                ...
                if (null == dMFromUserId2) {
                  ...
                  obj2[0] = flag(4265).getDMChannel(callback);
                  return obj2;
                } else {
                  constants = 2;
                  if (null != dMFromUserId2) {
                    let obj7 = callback(11549);
