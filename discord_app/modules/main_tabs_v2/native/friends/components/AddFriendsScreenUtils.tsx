    ...
    if (arg0 === 1) {
      ...
      if (null == dMFromUserId) {
        ...
        if (null != dMFromUserId) {
          ...
          obj7.trackWaveCtaClicked({ channelId: dMFromUserId, source: closure_131_2 });
          let obj4 = { location: closure_132_6.SEND_WAVE };
          c7 = 5;
          c8 = 1;
          let obj5 = { value: closure_132_1(closure_132_2[9]).sendStickers(dMFromUserId, ["749054660769218631"], "", obj4), done: false };
          return obj5;
        } else {
          c6 = 0;
        }
    ...
    if (2 !== tmp8) {
      if (3 === tmp8) {
        ...
        if (closure_131_1) {
          ...
          closure_132_1(closure_132_2[5]).openPrivateChannel(obj7);
