...
let closure_21 = async function _handleOneRecipientInDM(arg0, onBeforeTransition) {
  ...
  return (async (arg0, value) => {
    ...
    closure_130_1 = await ChannelActionCreatorsDefault.openPrivateChannel({
      recipientIds: [],
              ...
              if (closure_132_10.getChannelId() === closure_131_0.id) {
                if (closure_131_0.isDM()) {
                  ...
                  obj10.showGuardCallAlert(
                    closure_132_4(async (arg0, value) => {
                      if (dependencyMap === 2) {
                        dependencyMap = 3;
                        throw new TypeError("Generator functions may not be called on executing generators");
                      } else if (tmp3 === 3) {
                          ...
                          if (0 === v3) {
                            if (arg0 === 1) {
                              ...
                              if (1 === length.length) {
                                ...
                                dependencyMap = 1;
                                let obj2 = {
                                  value: obj5.addRecipients(id.id, tmp32, undefined, closure_2_2),
                                  done: false,
                                };
                                return obj2;
                              }
