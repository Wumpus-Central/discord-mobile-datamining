...
import GroupDMRecipientLimitTitleDefault from "GroupDMRecipientLimitTitle" /* 16755 */;
          ...
          if (arg0 === 1) {
            ...
            if (null != closure_131_0) {
              if (closure_132_10.getChannelId() !== closure_131_0.id) {
                ...
                c5 = 2;
                c6 = 1;
                let obj3 = { value: obj13.addRecipients(closure_131_0.id, closure_131_1, undefined, closure_131_2), done: false };
                return obj3;
              }
            }
            if (null != closure_131_0) {
              if (closure_132_10.getChannelId() === closure_131_0.id) {
                if (closure_131_0.isDM()) {
                  ...
                  c5 = 5;
                  c6 = 1;
                  let obj4 = { value: obj8.addRecipients(closure_131_0.id, closure_131_1, undefined, closure_131_2), done: false };
                  return obj4;
                }
              }
            }
