...
export default function AddFriendScreen(navigation) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(8105).getRenderHeaderTextButton(
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !navigation(12931).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = navigation(12931);
      }
      dependencyMap(tmp5);
  ...
  items2[2] = closure_10(contactSyncAccount(14118), {
    style: tmp.input,
