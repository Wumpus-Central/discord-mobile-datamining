...
export default function AddFriendScreen(navigation) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(7283).getRenderHeaderTextButton(
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !navigation(12159).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = navigation(12159);
      }
      dependencyMap(tmp5);
  ...
  items2[2] = closure_10(contactSyncAccount(13383), {
    style: tmp.input,
