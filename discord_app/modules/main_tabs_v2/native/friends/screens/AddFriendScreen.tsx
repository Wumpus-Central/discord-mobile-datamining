...
export default function AddFriendScreen(navigation) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(8110).getRenderHeaderTextButton(
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !navigation(12937).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = navigation(12937);
      }
      dependencyMap(tmp5);
  ...
  items2[2] = closure_10(contactSyncAccount(14131), {
    style: tmp.input,
