...
export default function AddFriendScreen(navigation) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(8192).getRenderHeaderTextButton(
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !navigation(13019).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = navigation(13019);
      }
      dependencyMap(tmp5);
  ...
  items2[2] = closure_10(contactSyncAccount(14213), {
    style: tmp.input,
