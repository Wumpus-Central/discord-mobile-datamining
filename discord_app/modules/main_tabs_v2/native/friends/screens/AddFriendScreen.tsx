...
export default function AddFriendScreen(navigation) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(8194).getRenderHeaderTextButton(
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !navigation(13028).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = navigation(13028);
      }
      dependencyMap(tmp5);
  ...
  items2[2] = closure_10(contactSyncAccount(14222), {
    style: tmp.input,
