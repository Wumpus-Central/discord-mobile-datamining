  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    navigation.setOptions({
      headerRight(arg0) {
        ...
        const renderHeaderTextButton = navigation(7288).getRenderHeaderTextButton(
    ...
    result.then((result) => {
      ...
      if (!tmp5) {
        tmp5 = !navigation(12177).isContactSyncEnabled(contactSyncAccount);
        const tmp2Result = navigation(12177);
      }
      dependencyMap(tmp5);
