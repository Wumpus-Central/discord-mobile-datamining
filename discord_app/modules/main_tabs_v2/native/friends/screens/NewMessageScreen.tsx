...
export default function NewMessageScreen(navigation) {
    ...
    if (null == source_page) {
      if (null == findLocalMatchingPrivateChannelId(recipients)) {
        ...
        return () => {
          ...
          obj = { id: navigation(7273).FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID, guild_id: "Array", parent_id: "toLowerCase" };
          obj.channel = obj;
          obj.dispatch(obj);
        };
      }
  ...
  const memo = obj.useMemo(() => {
    ...
    if (constants) {
      if (stateFromStores1) {
        let obj = { icon: _modDef10101, IconComponent: GroupPlusIcon.GroupPlusIcon, label: null, iconVariant: "default", onPress: null };
      ...
      obj = { icon: _modDef4543, IconComponent: UserPlusIcon.UserPlusIcon, label: null, iconVariant: "default", onPress: null };
