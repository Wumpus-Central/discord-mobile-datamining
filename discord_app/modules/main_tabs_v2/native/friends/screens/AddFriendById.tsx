...
export default noop.forwardRef((arg0, ref) => {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        const obj6 = {
          ...
          errorUxConfig: sourcePage(9185).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED,
          note: null,
        };
        let tmp9;
  ...
  if (!enabled) {
    ...
    items6[2] = closure_9(sourcePage(5060).Button, obj7);
    ...
    const items8 = [closure_9(sourcePage(4634).Text, obj9), ,];
    const obj10 = {
      returnKeyType: "done",
    ...
    obj10.status = str2;
    items8[1] = closure_9(sourcePage(7195).TextArea, obj10);
    if (first1.status !== constants2.ERROR) {
      ...
      let tmp17Result = closure_9(sourcePage(4634).Text, obj11);
