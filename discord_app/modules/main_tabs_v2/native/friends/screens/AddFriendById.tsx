...
export default noop.forwardRef((arg0, ref) => {
  ...
  function handleSubmitEditing() {
    ...
    if (trimmed.length <= 0) {
      ...
      if (null != validateDiscordTagResult) {
        ...
        closure_6(obj1);
        const obj2 = { discordTag: tmp2, context: { location: "Search - Add Friend Search" }, errorUxConfig: sourcePage(9074).RelationshipErrorUXConfig.SHOW_ONLY_IF_ACTION_NEEDED, note: null };
        let tmp9;
        ...
        obj2.note = tmp9;
        const obj5 = ref(9074);
        ref(9074).sendRequest(obj2).then(() => {
        ...
        const sendRequestResult = ref(9074).sendRequest(obj2);
      }
    }
  }
  ...
  if (!enabled) {
    ...
    items6[2] = closure_9(sourcePage(4989).Button, obj3);
    ...
    const items8 = [closure_9(sourcePage(4570).Text, obj5), , ];
    ...
    obj6.status = str2;
    items8[1] = closure_9(sourcePage(7099).TextArea, obj6);
    if (first1.status !== constants2.ERROR) {
      ...
      let tmp17Result = closure_9(sourcePage(4570).Text, obj7);
