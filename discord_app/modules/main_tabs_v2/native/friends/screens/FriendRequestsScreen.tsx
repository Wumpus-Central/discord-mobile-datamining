...
let obj2 = {
  container: { flex: 1 },
  noResultsContainer: { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWER, flex: 1 },
  clearAllContainer: null,
  clearAll: null,
  tabs: null,
};
let obj3 = { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWER, flex: 1 };
obj2.clearAllContainer = {
...
export default function FriendRequestsScreen() {
  ...
  const tmp9 = gameRelationshipsByType(
    analyticsLocations(563).useStateFromStoresArray(items2, () => {
  ...
  const stateFromStores = analyticsLocations(563).useStateFromStores(
    items5,
    () => {
  ...
  const memo2 = gameRelationshipsByType1.useMemo(() => {
    const obj = {
      incomingData: { items: incoming, relationship: constants.PENDING_INCOMING },
  ...
  const items12 = [
    outgoingData(pendingIncomingIds, {
      style: tmp.tabs,
      children: outgoingData(analyticsLocations(10038).SegmentedControl, { state: segmentedControlState }),
    }),
    ,
  ];
