// === Module 15686: handleFindFriends ===
...
function handleFindFriends() {
  require(11883) /* handleNameInputScreenOrSuggestions */.openContactSyncModal({}, constants.FRIENDS_ADD_FRIENDS_MODAL);
}
