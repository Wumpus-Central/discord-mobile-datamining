...
require = fn;
const YOU_BAR_SPRING_CONFIG = fn(15365).YOU_BAR_SPRING_CONFIG;
const jsx = fn(21).jsx;
const __initData = {
...
export default noop.memo(function YouBarNameplate(isQuestRendered) {
  ...
  fn.__closure = {
    withSpring: isQuestRendered(5185).withSpring,
    isQuestRendered,
  ...
  obj6.animate = str;
  obj5.children = jsx(tmp2(9099), { nameplate, isFocused: true, animate: null });
