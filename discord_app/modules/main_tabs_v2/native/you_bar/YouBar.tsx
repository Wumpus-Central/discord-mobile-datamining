...
let closure_26 = noop.memo(() => {
  ...
  isMobileQuestDockRenderedBase =
    isMobileQuestDockRenderedBase(15172).useIsMobileQuestDockRenderedBase(mobileQuestDock);
  ...
  fn.__closure = {
    withSpring: isMobileQuestDockRenderedBase(5055).withSpring,
  ...
  const youBarCoachmark = isMobileQuestDockRenderedBase(16461).useYouBarCoachmark({
    isQuestRendered: isMobileQuestDockRenderedBase,
  });
  ...
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(14804).useShowTinyBroncoPromoSheet({
    visibleContent,
    markAsDismissed,
  });
  ...
  obj6.style = items9;
  const items10 = [
    closure_19(youBarHorizontalMargin(16480), {
  ...
  if (null != nameplate) {
    ...
    tmp40Result = closure_19(tmp2(16481), obj7);
  }
  ...
  obj9.children = closure_19(youBarHorizontalMargin(16482), {
    isQuestRendered: isMobileQuestDockRenderedBase,
    onAvatarPress: memo1,
  });
  ...
  if (iCYMIEnabled) {
    ...
    tmp40Result2 = closure_19(tmp2(16487), obj11);
  }
