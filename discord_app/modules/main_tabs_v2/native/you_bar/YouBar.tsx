...
import _modDef16214 from "YouBarFloatingShade.tsx";
...
let closure_26 = importAllResult.memo(() => {
  ...
  const youBarCoachmark = isMobileQuestDockRenderedBase(16185).useYouBarCoachmark({
    isQuestRendered: isMobileQuestDockRenderedBase,
  });
  ...
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(16186).useShowTinyBroncoPromoSheet({
    visibleContent,
    markAsDismissed,
  });
  ...
  const items10 = [
    callback(youBarHorizontalMargin(16202), {
  ...
  obj3[10] = callback;
  obj3[11] = closure_16;
  obj3[12] = callback(youBarHorizontalMargin(16204), {
    isQuestRendered: isMobileQuestDockRenderedBase,
    onAvatarPress: memo1,
  });
