...
let closure_26 = noop.memo(() => {
  ...
  isMobileQuestDockRenderedBase =
    isMobileQuestDockRenderedBase(15182).useIsMobileQuestDockRenderedBase(mobileQuestDock);
  ...
  const tmp10 = youBarHorizontalMargin(4500)().isChatBesideChannelList
    ? drawerWidth - result
  ...
  fn.__closure = {
    withSpring: isMobileQuestDockRenderedBase(5058).withSpring,
  ...
  const youBarCoachmark = isMobileQuestDockRenderedBase(16474).useYouBarCoachmark({
    isQuestRendered: isMobileQuestDockRenderedBase,
  });
  ...
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(14814).useShowTinyBroncoPromoSheet({
    visibleContent,
    markAsDismissed,
  });
  ...
  obj6.style = items9;
  const items10 = [
    closure_19(youBarHorizontalMargin(16493), {
  ...
  if (null != nameplate) {
    ...
    tmp40Result = closure_19(tmp2(16494), obj7);
  }
  ...
  obj9.children = closure_19(youBarHorizontalMargin(16495), {
    isQuestRendered: isMobileQuestDockRenderedBase,
    onAvatarPress: memo1,
  });
  ...
  if (iCYMIEnabled) {
    ...
    tmp40Result2 = closure_19(tmp2(16500), obj11);
  }
