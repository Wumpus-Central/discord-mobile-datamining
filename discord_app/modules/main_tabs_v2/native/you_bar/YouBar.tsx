...
let closure_26 = noop.memo(() => {
  ...
  isMobileQuestDockRenderedBase =
    isMobileQuestDockRenderedBase(15203).useIsMobileQuestDockRenderedBase(mobileQuestDock);
  ...
  fn.__closure = {
    withSpring: isMobileQuestDockRenderedBase(5061).withSpring,
  ...
  const youBarCoachmark = isMobileQuestDockRenderedBase(16524).useYouBarCoachmark({
    isQuestRendered: isMobileQuestDockRenderedBase,
  });
  ...
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(14838).useShowTinyBroncoPromoSheet({
    visibleContent,
    markAsDismissed,
  });
  ...
  obj6.style = items9;
  const items10 = [
    closure_19(youBarHorizontalMargin(16543), {
  ...
  if (null != nameplate) {
    ...
    tmp40Result = closure_19(tmp2(16544), obj7);
  }
  ...
  obj9.children = closure_19(youBarHorizontalMargin(16545), {
    isQuestRendered: isMobileQuestDockRenderedBase,
    onAvatarPress: memo1,
  });
  ...
  if (iCYMIEnabled) {
    ...
    tmp40Result2 = closure_19(tmp2(16550), obj11);
  }
