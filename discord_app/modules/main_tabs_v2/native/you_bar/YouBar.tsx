...
let closure_26 = noop.memo(() => {
  ...
  isMobileQuestDockRenderedBase =
    isMobileQuestDockRenderedBase(15297).useIsMobileQuestDockRenderedBase(mobileQuestDock);
  ...
  const tmp10 = youBarHorizontalMargin(4582)().isChatBesideChannelList
    ? drawerWidth - result
  ...
  fn.__closure = {
    withSpring: isMobileQuestDockRenderedBase(5143).withSpring,
  ...
  const youBarCoachmark = isMobileQuestDockRenderedBase(16621).useYouBarCoachmark({
    isQuestRendered: isMobileQuestDockRenderedBase,
  });
  ...
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(14932).useShowTinyBroncoPromoSheet({
    visibleContent,
    markAsDismissed,
  });
  ...
  obj6.style = items9;
  const items10 = [
    closure_19(youBarHorizontalMargin(16640), {
  ...
  if (null != nameplate) {
    ...
    tmp40Result = closure_19(tmp2(16641), obj7);
  }
  ...
  obj9.children = closure_19(youBarHorizontalMargin(16642), {
    isQuestRendered: isMobileQuestDockRenderedBase,
    onAvatarPress: memo1,
  });
  ...
  if (iCYMIEnabled) {
    ...
    tmp40Result2 = closure_19(tmp2(16647), obj11);
  }
