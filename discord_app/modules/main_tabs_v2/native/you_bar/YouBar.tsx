...
let closure_26 = noop.memo(() => {
  ...
  isMobileQuestDockRenderedBase =
    isMobileQuestDockRenderedBase(15198).useIsMobileQuestDockRenderedBase(mobileQuestDock);
  ...
  const tmp10 = youBarHorizontalMargin(4498)().isChatBesideChannelList
    ? drawerWidth - result
  ...
  fn.__closure = {
    withSpring: isMobileQuestDockRenderedBase(5059).withSpring,
  ...
  const youBarCoachmark = isMobileQuestDockRenderedBase(16494).useYouBarCoachmark({
    isQuestRendered: isMobileQuestDockRenderedBase,
  });
  ...
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(14830).useShowTinyBroncoPromoSheet({
    visibleContent,
    markAsDismissed,
  });
  ...
  obj6.style = items9;
  const items10 = [
    closure_19(youBarHorizontalMargin(16513), {
  ...
  if (null != nameplate) {
    ...
    tmp40Result = closure_19(tmp2(16514), obj7);
  }
  ...
  obj9.children = closure_19(youBarHorizontalMargin(16515), {
    isQuestRendered: isMobileQuestDockRenderedBase,
    onAvatarPress: memo1,
  });
  ...
  if (iCYMIEnabled) {
    ...
    tmp40Result2 = closure_19(tmp2(16520), obj11);
  }
