...
let closure_26 = noop.memo(() => {
  ...
  isMobileQuestDockRenderedBase =
    isMobileQuestDockRenderedBase(15418).useIsMobileQuestDockRenderedBase(mobileQuestDock);
  ...
  const tmp10 = youBarHorizontalMargin(4687)().isChatBesideChannelList
    ? drawerWidth - result
  ...
  fn.__closure = {
    withSpring: isMobileQuestDockRenderedBase(5270).withSpring,
  ...
  const youBarCoachmark = isMobileQuestDockRenderedBase(16767).useYouBarCoachmark({
    isQuestRendered: isMobileQuestDockRenderedBase,
  });
  ...
  const showTinyBroncoPromoSheet = isMobileQuestDockRenderedBase(15076).useShowTinyBroncoPromoSheet({
    visibleContent,
    markAsDismissed,
  });
  ...
  obj6.style = items9;
  const items10 = [
    closure_19(youBarHorizontalMargin(16786), {
  ...
  obj9.children = closure_19(youBarHorizontalMargin(16788), {
    isQuestRendered: isMobileQuestDockRenderedBase,
    onAvatarPress: memo1,
  });
