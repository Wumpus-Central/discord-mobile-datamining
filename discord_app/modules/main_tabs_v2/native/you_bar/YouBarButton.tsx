...
function YouBarButtonIcon(hasBadge) {
  ...
  const memo1 = obj1.useMemo(() => ({ position: "absolute", left: size2 - badgeSize + num3, top: size2 - badgeSize + num4, right: "channel", bottom: "skuId", padding: "find", minWidth: "accessible" }), items1);
