...
export default noop.memo(function YouBarUser(isQuestRendered) {
  ...
  if (null != stateFromStores) {
    if (null != name) {
      ...
      const items2 = [closure_9(tmp9(16421), obj)];
      obj1 = { style: null, children: null };
      const items3 = [tmp.userText, animatedStyle, { flexShrink: 1 }];
      obj1.style = items3;
      const obj2 = { userId: stateFromStores.id, username: name };
      obj1.children = closure_9(tmp9(16422), obj2);
      items2[1] = closure_9(tmp9(4310).View, obj1);
      obj.children = items2;
    }
  ...
  obj4.style = items6;
  items5[1] = closure_9(sharedValue(4310).View, obj4);
