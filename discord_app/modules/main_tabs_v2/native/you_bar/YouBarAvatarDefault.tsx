...
function AvatarDefault() {
  ...
  const items3 = [callback(importDefault(8103), obj2), callback(require(1297) /* Button */.Status, { size: num, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: obj6 })];
  obj[1] = items3;
...
function AvatarDefaultLarge() {
  ...
  obj = { shape: require(8103) /* SolidCutout */.CutoutShape.Circle, x: diff + closure_10, y: diff + closure_10, size: 2 * sum };
  obj = { style: null, children: null };
  ...
  const items4 = [callback(importDefault(8103), obj4), callback(require(1297) /* Button */.Status, { size: closure_8, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: obj10 })];
  obj2[1] = items4;
