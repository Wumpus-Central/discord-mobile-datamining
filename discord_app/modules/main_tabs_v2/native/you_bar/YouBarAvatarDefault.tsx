// === Module 16386: YouBarAvatarDefault ===
...
function AvatarDefault() {
  ...
  obj1.style = items1;
  const items2 = [closure_1_12(View, { style: tmp.placeholderAvatarBackground }), closure_1_12(ReactionIcon.ReactionIcon, { size: "custom", style: { width: tmp7, height: tmp7 }, color: "background-mod-strong" })];
  obj1.children = items2;
  obj.children = map1(View, obj1);
  const items3 = [closure_1_12(ClipViewDefault, obj), ];
  const obj4 = { size: num, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: null };
...
obj = { borderRadius: nativeDefault.radii.round, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, justifyContent: "center", alignItems: "center" };
