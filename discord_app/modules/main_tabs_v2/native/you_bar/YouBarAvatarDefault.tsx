...
function AvatarDefault() {
  ...
  obj = { shape: tmp2(8402).CutoutShape.Circle, x: diff, y: diff, size: 2 * sum };
  ...
  const items3 = [callback(SolidCutout, obj2), callback(Button.Status, { size: num, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: obj6 })];
  obj[1] = items3;
...
function AvatarDefaultLarge() {
  ...
  obj = { style: null, children: null };
  obj[0] = { height: Button.AVATAR_SIZE_MAP[closure_5], width: Button.AVATAR_SIZE_MAP[closure_5], position: "relative" };
  const obj2 = { style: null, children: null };
  const items = [tmp.avatarShadow, ];
  const obj1 = { height: Button.AVATAR_SIZE_MAP[closure_5], width: Button.AVATAR_SIZE_MAP[closure_5], position: "relative" };
  ...
  obj8[0] = Button.AVATAR_SIZE_MAP[closure_5];
  obj8[1] = Button.AVATAR_SIZE_MAP[closure_5];
  obj7[1] = obj8;
  items3[1] = callback(ReactionIcon.ReactionIcon, obj7);
  obj5[1] = items3;
  obj4[1] = callback2(View, obj5);
  const items4 = [callback(SolidCutout, obj4), callback(Button.Status, { size: closure_8, status: StatusTypes.OFFLINE, isMobileOnline: false, isVROnline: false, streaming: false, style: obj10 })];
  obj2[1] = items4;
