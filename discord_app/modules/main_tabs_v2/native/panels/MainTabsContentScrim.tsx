// === Module 16144: MainTabsContentScrim ===
...
export const MainTabsContentScrim = function MainTabsContentScrim(translateX) {
  ...
  let obj = translateX(4563);
  fn.__closure = { interpolate: translateX(4563).interpolate, translateX, maxWidth, Extrapolation: translateX(4563).Extrapolation };
  ...
  obj3.style = items;
  return jsx(maxWidth(4563).View, { style: null, pointerEvents: "none" });
};