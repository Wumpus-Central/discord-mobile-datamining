...
export const MainTabsContentScrim = function MainTabsContentScrim(translateX) {
  ...
  obj = { interpolate: translateX(4042).interpolate, translateX, maxWidth, Extrapolation: translateX(4042).Extrapolation };
  fn.__closure = obj;
  fn.__workletHash = 7933670426250;
  fn.__initData = closure_5;
  const animatedStyle = obj.useAnimatedStyle(fn);
  const style = [callback().scrim, animatedStyle];
  return jsx(maxWidth(4042).View, { style, pointerEvents: "none" });
};