...
export default function useMainTabsPanelsGesture(canDrag) {
  ...
  const effect = onPreMovement.useEffect(() => {
    ...
    let obj = { isDragging: sharedValue1, translateX: sharedValue, IS_ANDROID: PlatformUtils, withTiming: timing.withTiming, timingInstant: timingPresets.timingInstant };
    fn.__closure = obj;
  ...
  memo = onPreMovement.useMemo(() => {
    ...
    let obj2 = { disallowGesture: sharedValue2, translateX: sharedValue, width: openWidth, didJustAllowGesture: sharedValue3 };
