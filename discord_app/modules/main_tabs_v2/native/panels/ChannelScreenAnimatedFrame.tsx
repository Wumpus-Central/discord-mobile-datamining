...
export default function ChannelScreenAnimatedFrame(translateX) {
  ...
  S.__closure = {
    ...
    maxWidth,
    isChatLockedOpen,
    withTiming: translateX(isChatLockedOpen[5]).withTiming,
    STANDARD_EASING: translateX(isChatLockedOpen[6]).STANDARD_EASING,
    SIDE_PANEL_CLOSE_DURATION_MS: translateX(isChatLockedOpen[7]).SIDE_PANEL_CLOSE_DURATION_MS,
    SIDE_PANEL_OPEN_DURATION_MS: translateX(isChatLockedOpen[7]).SIDE_PANEL_OPEN_DURATION_MS,
  };
  ...
  const obj4 = {
    pointerEvents: "none",
    style: null,
    children: jsx(translateX(isChatLockedOpen[9]).SafeAreaPaddingView, { top: true }),
  };
  const items = [, , ,];
  ...
  obj4.style = items;
  return jsx(maxWidth(isChatLockedOpen[4]).View, {
    pointerEvents: "none",
    style: null,
    children: jsx(translateX(isChatLockedOpen[9]).SafeAreaPaddingView, { top: true }),
  });
