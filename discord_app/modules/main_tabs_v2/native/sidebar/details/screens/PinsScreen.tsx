...
const memoResult = importAllResult.memo(() => {
  ...
  { style: callback().container, children: jsx(InitialPinsScreenDefault, obj) };
...
const result = require("obj132").fileFinishedImporting("modules/main_tabs_v2/native/sidebar/details/screens/PinsScreen.tsx");
