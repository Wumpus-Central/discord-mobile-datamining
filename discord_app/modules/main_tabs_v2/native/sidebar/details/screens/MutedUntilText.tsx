...
export default function MutedUntilText(arg0) {
  ...
  if (null != muteConfig) {
    if (null != muteConfig.end_time) {
      ...
      obj.endTime = date.toLocaleString(tmp15(1114).intl.currentLocale, { month: "numeric", day: "numeric", hour: "numeric", minute: "2-digit" });
      ...
      return jsx(tmp15(4602).Text, { endTime: null, endTimeHook: null });
    }
  }
  if (obj.SERVER === type) {
