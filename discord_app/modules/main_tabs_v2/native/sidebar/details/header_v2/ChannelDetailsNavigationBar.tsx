...
import { registerAsset } from "../../../../../../../_runtime/06007_registerAsset.js";
...
function SearchButton(channelId) {
  ...
  const token = channelId(4005).useToken(Themes.modules.mobile.CHANNEL_DETAILS_NAV_ICON_BUTTON_SIZE);
  const obj3 = channelId(4005);
  const token1 = channelId(4005).useToken(Themes.modules.mobile.CHANNEL_DETAILS_NAV_ICON_BUTTON_VARIANT);
