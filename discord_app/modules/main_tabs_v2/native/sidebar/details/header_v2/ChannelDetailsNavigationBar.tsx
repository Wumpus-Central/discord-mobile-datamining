...
import { registerAsset } from "../../../../../../../_runtime/05901_registerAsset.js";
...
function SearchButton(channelId) {
  ...
  const token = channelId(3959).useToken(Themes.modules.mobile.CHANNEL_DETAILS_NAV_ICON_BUTTON_SIZE);
  const obj3 = channelId(3959);
  const token1 = channelId(3959).useToken(Themes.modules.mobile.CHANNEL_DETAILS_NAV_ICON_BUTTON_VARIANT);
