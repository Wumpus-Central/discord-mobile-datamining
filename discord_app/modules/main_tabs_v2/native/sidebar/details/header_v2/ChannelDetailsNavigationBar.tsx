...
function SearchButton(channelId) {
  ...
  const token = channelId(3988).useToken(Themes.modules.mobile.CHANNEL_DETAILS_NAV_ICON_BUTTON_SIZE);
  const obj3 = channelId(3988);
  const token1 = channelId(3988).useToken(Themes.modules.mobile.CHANNEL_DETAILS_NAV_ICON_BUTTON_VARIANT);
