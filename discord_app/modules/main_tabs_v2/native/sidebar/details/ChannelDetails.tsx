// discord_app/modules/main_tabs_v2/native/sidebar/details/ChannelDetails.tsx
...
export default noop.memo(function ChannelDetails(channelId) {
  ...
  obj = {
    ...
    isSearchActive: tmp9,
    withTiming: obj(tmp2[25]).withTiming,
    timingFast: obj(tmp2[26]).timingFast,
    withSpring: obj(tmp2[27]).withSpring,
    SPRING_CHANNEL_HEADER: context,
  };
  fn.__closure = obj;
  ...
  if (null == stateFromStores) {
    ...
    if (isSearchLocked) {
      ...
      const obj6 = {
        ...
        onBackPress,
        onSuggestionsLayoutMeasure: onLayoutMeasure,
        suggestionsDismissed: dismissed,
        setSuggestionsDismissed: setDismissed,
        componentWidth,
      };
