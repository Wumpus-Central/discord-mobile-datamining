...
export default noop.memo(function StandaloneChannelScreen(arg0) {
  ...
  const isVibegrationsChannelCandidate = channelId(7484).useIsVibegrationsChannelCandidate(
    stateFromStores,
  ...
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === StaticChannelRoute.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              const obj7 = { guildId };
              tmp32Result = closure_12(frame(16893), obj7);
            }
            ...
            const obj8 = { guildId };
            return closure_12(frame(16911), obj8);
          } else if (channelId === StaticChannelRoute.VIBEGRATIONS) {
            const obj9 = { guildId };
            return closure_12(frame(16928), obj9);
          } else {
            if (isVibegrationsChannelCandidate) {
              if (!tmp18) {
                if (null != stateFromStores) {
                  ...
                  obj12.children = closure_12(frame(17075), obj13);
            ...
            if (showCreateThread) {
              ...
              items6[1] = closure_12(channelId(17076).CreateThreadView, obj16);
              ...
              obj19.children = closure_12(frame(11601), obj20);
              items7[1] = closure_12(channelId(16867).NavTTIView, obj19);
              ...
              if (isSwipeToMemberListEnabled) {
                ...
                let tmp21Result = closure_12(frame(17080), obj21);
              } else {
                const obj22 = {
                  name: "channel_screen",
                  navigationKey: channelId,
                  definition: channelId(17082).CHANNEL_NAVIGATION_TTI,
                ...
                tmp21Result = closure_12(channelId(17081).NavTTISurfaceProvider, obj22);
              }
              return tmp21Result;
            }
          }
      ...
      const items9 = [closure_12(frame(5336), { absolute: true })];
      ...
      items9[1] = closure_12(frame(16876), obj26);
