...
export default noop.memo(function StandaloneChannelScreen(arg0) {
  ...
  const isVibegrationsChannelCandidate = channelId(7358).useIsVibegrationsChannelCandidate(
    stateFromStores,
  ...
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === StaticChannelRoute.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              const obj7 = { guildId };
              tmp32Result = closure_12(frame(16716), obj7);
            }
            ...
            const obj8 = { guildId };
            return closure_12(frame(16734), obj8);
          } else if (channelId === StaticChannelRoute.VIBEGRATIONS) {
            const obj9 = { guildId };
            return closure_12(frame(16751), obj9);
          } else {
            if (isVibegrationsChannelCandidate) {
              if (!tmp18) {
                if (null != stateFromStores) {
                  ...
                  obj12.children = closure_12(frame(16852), obj13);
            ...
            if (showCreateThread) {
              ...
              items6[1] = closure_12(channelId(16860).CreateThreadView, obj16);
              ...
              obj19.children = closure_12(frame(11494), obj20);
              items7[1] = closure_12(channelId(16694).NavTTIView, obj19);
              ...
              if (isSwipeToMemberListEnabled) {
                ...
                let tmp21Result = closure_12(frame(16864), obj21);
              } else {
                const obj22 = {
                  navigationKey: channelId,
                  definition: channelId(16866).CHANNEL_NAVIGATION_TTI,
                ...
                tmp21Result = closure_12(channelId(16865).NavTTISurfaceProvider, obj22);
              }
              return tmp21Result;
            }
          }
      ...
      const items9 = [closure_12(frame(5212), { absolute: true })];
      ...
      items9[1] = closure_12(frame(16699), obj26);
