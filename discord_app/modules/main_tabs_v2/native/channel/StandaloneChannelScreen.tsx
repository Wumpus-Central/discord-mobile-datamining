...
const memoResult = importAllResult.memo(function StandaloneChannelScreen(arg0) {
  ...
  const isChatLockedOpen = tmp5(4202)().isChatLockedOpen;
  ...
  if (null != channelId) {
    if (null != guildId) {
      ...
      obj12[0] = memo1;
      const items6 = [callback(tmp5(4888), { absolute: true }), ];
