// === Module 16936: StandaloneChannelScreen ===

// Module 16936 (StandaloneChannelScreen)
import nativeDefault from "native" /* 576 */;
import NavigationRouteUtils from "NavigationRouteUtils" /* 4684 */;
import PressableNavigatorBackIcon from "PressableNavigatorBackIcon" /* 8194 */;
...
function Header(channelId) {
  ...
  if (memo1) {
    ...
    let tmp13Result1 = closure_12(tmp(tmp2[18]).ContextMenu, obj5);
    let tmp13 = closure_12;
  } else {
    const obj6 = { onPress };
    tmp13Result1 = closure_12(tmp(tmp2[19]).PressableNavigatorBackIcon, obj6);
    tmp13 = closure_12;
  }
...
const MainTabsV2Constants = fn(8193);
...
export default noop.memo(function StandaloneChannelScreen(arg0) {
  ...
  const isSwipeToMemberListEnabled = channelId(11803).useIsSwipeToMemberListEnabled();
  const needSubscriptionToAccess = frame(5304)(channelId).needSubscriptionToAccess;
  const obj2 = channelId(11803);
  let tmp6 = guildId;
  if (guildId == null) {
    tmp6 = closure_8;
  }
  const canSeeOnboardingHome = channelId(7553).useCanSeeOnboardingHome(tmp6);
  const obj3 = channelId(7553);
  const tmp9 = frame(4761)() === constants.ONYX;
  closure_4 = tmp9;
  const tmp10 = frame(4687)();
  ...
  const isForumChannelSearchActive = channelId(13673).useIsForumChannelSearchActive(channelId);
  if (isChatLockedOpen) {
  ...
  closure_6 = tmp14;
  const tmp2Result = channelId(13673);
  ...
  const isVibegrationsChannelCandidate = channelId(5360).useIsVibegrationsChannelCandidate(stateFromStores, "StandaloneChannelScreen");
  channelId(504);
  [][0] = channelId;
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === StaticChannelRoute.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              const obj7 = { guildId };
              tmp32Result = closure_12(frame(16963), obj7);
            }
            ...
            const obj8 = { guildId };
            return closure_12(frame(16981), obj8);
          } else if (channelId === StaticChannelRoute.VIBEGRATIONS) {
            const obj9 = { guildId };
            return closure_12(frame(16998), obj9);
          } else {
            if (isVibegrationsChannelCandidate) {
              if (!tmp18) {
                if (null != stateFromStores) {
                  ...
                  obj12.children = closure_12(frame(17153), obj13);
            ...
            if (showCreateThread) {
              ...
              items6[1] = closure_12(channelId(17157).CreateThreadView, obj16);
              ...
              obj19.children = closure_12(frame(11683), obj20);
              items7[1] = closure_12(channelId(16937).NavTTIView, obj19);
              ...
              if (isSwipeToMemberListEnabled) {
                ...
                let tmp21Result = closure_12(frame(17161), obj21);
              } else {
                const obj22 = {
                  name: "channel_screen",
                  navigationKey: channelId,
                  definition: channelId(17163).CHANNEL_NAVIGATION_TTI,
                ...
                tmp21Result = closure_12(channelId(17162).NavTTISurfaceProvider, obj22);
              }
              return tmp21Result;
            }
          }
      ...
      const items9 = [closure_12(frame(5427), { absolute: true }), ];
      ...
      items9[1] = closure_12(frame(16946), obj26);
