...
const memoResult = importAllResult.memo(function StandaloneChannelScreen(arg0) {
  ...
  const isForumChannelSearchActive = frame(12460).useIsForumChannelSearchActive(channelId);
  ...
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === tmp30.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              obj2 = { guildId: null };
              obj2[0] = guildId;
              tmp27Result = tmp27(tmp5(15540), obj2);
            }
            obj1[1] = tmp27Result;
            ...
            obj5[0] = channelId;
            obj5[1] = screenIndex;
            items3[1] = tmp27(tmp2(15575).CreateThreadView, obj5);
            obj4[1] = items3;
            ...
            if (isSwipeToMemberListEnabled) {
              ...
              obj9[3] = tmp14;
              obj9[4] = tmp31Result;
              tmp27Result = tmp27(tmp5(15579), obj9);
            } else {
      ...
      obj13[1] = tmp26;
      items6[1] = callback(tmp5(15523), obj13);
      obj12[1] = items6;
