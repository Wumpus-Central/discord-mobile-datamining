...
const memoResult = importAllResult.memo(function StandaloneChannelScreen(arg0) {
  ...
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === tmp36.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              obj2 = { guildId: null };
              obj2[0] = guildId;
              tmp33Result = tmp33(tmp5(16369), obj2);
            }
            obj1[1] = tmp33Result;
            ...
            if (showCreateThread) {
              ...
              obj9[0] = channelId;
              obj9[1] = screenIndex;
              items6[1] = tmp33(tmp2(16435).CreateThreadView, obj9);
              obj8[1] = items6;
              ...
              obj12[2] = ref;
              obj12[3] = screenIndex;
              obj11[1] = tmp33(tmp5(11197), obj12);
              ...
              if (isSwipeToMemberListEnabled) {
                ...
                obj13[3] = tmp14;
                obj13[4] = tmp18Result;
                tmp33Result = tmp33(tmp5(16439), obj13);
              } else {
      ...
      obj16[0] = memo1;
      const items9 = [callback(tmp5(5078), { absolute: true })];
      ...
      obj17[1] = tmp32;
      items9[1] = callback(tmp5(16352), obj17);
      obj16[1] = items9;
