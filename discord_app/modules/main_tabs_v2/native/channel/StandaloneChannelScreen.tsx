...
import MIN_HEADER_HEIGHT from "../shared_components/MainTabsV2Constants.tsx";
...
function Header(channelId) {
  ...
  const items7 = [
    tmp13Result,
    tmp13(guildId(isNavigationScreen[20]), { channelId, isNavigationScreen, screenIndex, showCreateThread }),
    tmp13(guildId(isNavigationScreen[21]), { containerStyle: tmp4.actions, channelId, screenIndex, showCreateThread }),
  ];
  obj6[0] = items7;
...
obj = {
  borderLeftWidth: MIDNIGHT_BORDER_WIDTH,
  borderLeftColor: ThemesDefault.colors.APP_FRAME_BORDER,
  borderTopWidth: MIDNIGHT_BORDER_WIDTH,
...
obj[4] = {
  zIndex: 1,
  backgroundColor: ThemesDefault.colors.STANDALONE_CHANNEL_CONTENT_BACKGROUND,
  flexDirection: "row",
  alignItems: "center",
  flexShrink: 0,
};
...
obj[8] = {
  borderTopWidth: ThemesDefault.modules.mobile.CHANNEL_DRAWER_DIVIDER_WIDTH,
  borderTopColor: ThemesDefault.colors.APP_FRAME_BORDER,
};
let obj7 = {
  borderTopWidth: ThemesDefault.modules.mobile.CHANNEL_DRAWER_DIVIDER_WIDTH,
  borderTopColor: ThemesDefault.colors.APP_FRAME_BORDER,
...
const memoResult = importAllResult.memo(function StandaloneChannelScreen(arg0) {
  ...
  obj1 = channelId(11290);
  const isSwipeToMemberListEnabled = obj1.useIsSwipeToMemberListEnabled();
  const needSubscriptionToAccess = frame(4961)(channelId).needSubscriptionToAccess;
  let obj2 = channelId(6078);
  let tmp6 = guildId;
  if (guildId == null) {
    tmp6 = closure_7;
  }
  const canSeeOnboardingHome = obj2.useCanSeeOnboardingHome(tmp6);
  const tmp9 = frame(4413)() === constants.MIDNIGHT;
  closure_4 = tmp9;
  const tmp10 = frame(4335)();
  ...
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === tmp36.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              obj2 = { guildId: null };
              obj2[0] = guildId;
              tmp33Result = tmp33(tmp5(16388), obj2);
            }
            obj1[1] = tmp33Result;
            ...
            if (showCreateThread) {
              ...
              obj9[0] = channelId;
              obj9[1] = screenIndex;
              items6[1] = tmp33(tmp2(16456).CreateThreadView, obj9);
              obj8[1] = items6;
              ...
              obj12[2] = ref;
              obj12[3] = screenIndex;
              obj11[1] = tmp33(tmp5(11201), obj12);
              ...
              if (isSwipeToMemberListEnabled) {
                ...
                obj13[3] = tmp14;
                obj13[4] = tmp18Result;
                tmp33Result = tmp33(tmp5(16460), obj13);
              } else {
      ...
      obj16[0] = memo1;
      const items9 = [callback(tmp5(5079), { absolute: true })];
      ...
      obj17[1] = tmp32;
      items9[1] = callback(tmp5(16371), obj17);
      obj16[1] = items9;
