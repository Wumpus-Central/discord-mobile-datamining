...
export default noop.memo(function StandaloneChannelScreen(arg0) {
  ...
  const isVibegrationsChannelCandidate = channelId(7354).useIsVibegrationsChannelCandidate(
    stateFromStores,
  ...
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === StaticChannelRoute.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              const obj7 = { guildId };
              tmp32Result = closure_12(frame(16686), obj7);
            }
            ...
            const obj8 = { guildId };
            return closure_12(frame(16704), obj8);
          } else if (channelId === StaticChannelRoute.VIBEGRATIONS) {
            const obj9 = { guildId };
            return closure_12(frame(16721), obj9);
          } else {
            if (isVibegrationsChannelCandidate) {
              if (!tmp18) {
                if (null != stateFromStores) {
                  ...
                  obj12.children = closure_12(frame(16813), obj13);
            ...
            if (showCreateThread) {
              ...
              items6[1] = closure_12(channelId(16821).CreateThreadView, obj16);
              ...
              obj19.children = closure_12(frame(11486), obj20);
              items7[1] = closure_12(channelId(16663).NavTTIView, obj19);
              ...
              if (isSwipeToMemberListEnabled) {
                ...
                let tmp21Result = closure_12(frame(16825), obj21);
              } else {
                const obj22 = {
                  navigationKey: channelId,
                  definition: channelId(16827).CHANNEL_NAVIGATION_TTI,
                  accessible: false,
                ...
                tmp21Result = closure_12(channelId(16826).NavTTISurfaceProvider, obj22);
              }
              return tmp21Result;
            }
          }
      ...
      const items9 = [closure_12(frame(5210), { absolute: true })];
      ...
      items9[1] = closure_12(frame(16669), obj26);
