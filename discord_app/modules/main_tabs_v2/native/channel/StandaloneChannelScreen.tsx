...
export default noop.memo(function StandaloneChannelScreen(arg0) {
  ...
  const isVibegrationsChannelCandidate = channelId(7440).useIsVibegrationsChannelCandidate(
    stateFromStores,
  ...
  if (null != channelId) {
    if (null != guildId) {
        ...
        if (!needSubscriptionToAccess) {
          if (channelId === StaticChannelRoute.GUILD_HOME) {
            ...
            if (canSeeOnboardingHome) {
              const obj7 = { guildId };
              tmp32Result = closure_12(frame(16813), obj7);
            }
            ...
            const obj8 = { guildId };
            return closure_12(frame(16831), obj8);
          } else if (channelId === StaticChannelRoute.VIBEGRATIONS) {
            const obj9 = { guildId };
            return closure_12(frame(16848), obj9);
          } else {
            if (isVibegrationsChannelCandidate) {
              if (!tmp18) {
                if (null != stateFromStores) {
                  ...
                  obj12.children = closure_12(frame(16999), obj13);
            ...
            if (showCreateThread) {
              ...
              items6[1] = closure_12(channelId(17000).CreateThreadView, obj16);
              ...
              obj19.children = closure_12(frame(11592), obj20);
              items7[1] = closure_12(channelId(16791).NavTTIView, obj19);
              ...
              if (isSwipeToMemberListEnabled) {
                ...
                let tmp21Result = closure_12(frame(17004), obj21);
              } else {
                const obj22 = {
                  navigationKey: channelId,
                  definition: channelId(17006).CHANNEL_NAVIGATION_TTI,
                ...
                tmp21Result = closure_12(channelId(17005).NavTTISurfaceProvider, obj22);
              }
              return tmp21Result;
            }
          }
      ...
      const items9 = [closure_12(frame(5294), { absolute: true })];
      ...
      items9[1] = closure_12(frame(16796), obj26);
