...
import SafetyToolsButton from "SafetyToolsButton" /* 13282 */;
...
export default noop.memo(function PrivateChannelButtons(channelId) {
  ...
  const tmp17 = screenIndex(13265)(obj);
  ...
  const callback3 = obj8.useCallback(() => {
    ...
    if (tmp2) {
      ...
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(13281, dependencyMap.paths), "AppDMOptionsBottomSheet", obj);
    }
  }, items11);
  ...
  if (screenIndex(8374)(channelId)) {
    ...
    obj.children = closure_20(tmp2(12960).WindowLaunchIcon, { size: "sm" });
    ...
    if (!tmp15) {
      ...
      if (tmp15) {
        ...
        let tmp30Result = closure_20(tmp2(5101).VoiceNormalIcon, unsafe_rawColors);
        ...
        if (stateFromStores1) {
          ...
          tmp30Result = closure_20(tmp2(7882).PhoneHangUpIcon, obj7);
          ...
          tmp30Result = closure_20(tmp2(7880).PhoneCallIcon, obj8);
          tmp33 = closure_20;
        }
        const items15 = [
          tmp30Result,
        ...
        if (tmp33Result) {
          ...
          obj9.children = closure_21(tmp2(4556).Text, obj10);
          tmp33Result = tmp33(tmp26, obj9);
        }
        items15[2] = tmp33Result;
        obj5.children = items15;
        const items17 = [closure_21(tmp2(5123).PressableOpacity, obj5), , ];
        let tmp38 = null;
        if (!isMultiUserDMResult) {
          tmp38 = null;
          if (!stateFromStores1) {
