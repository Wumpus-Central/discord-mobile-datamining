...
export default noop.memo(function PrivateChannelButtons(channelId) {
  ...
  inappropriateConversationSafetyToolsWarningForChannel =
    channelId(11656).useInappropriateConversationSafetyToolsWarningForChannel(channelId);
  closure_6 = tmp7;
  ...
  const callback3 = obj9.useCallback(() => {
    ...
    if (tmp2) {
      ...
      ActionSheetActionCreatorsDefault.openLazy(
        asyncRequireImpl(13580, dependencyMap.paths),
  ...
  if (screenIndex(8644)(channelId)) {
    ...
    if (!tmp15) {
      ...
      if (tmp15) {
        ...
        closure_20(tmp2(5312).VoiceNormalIcon, unsafe_rawColors1);
        ...
        if (stateFromStores1) {
          ...
          let tmp30Result2 = closure_20(tmp2(8125).PhoneHangUpIcon, obj11);
          ...
          tmp30Result2 = closure_20(tmp2(8123).PhoneCallIcon, obj12);
          tmp33 = closure_20;
        }
        const items15 = [
          tmp30Result2,
        ...
        const items17 = [closure_21(tmp2(5334).PressableOpacity, obj8), ,];
        let tmp38 = null;
        if (!isMultiUserDMResult) {
          tmp38 = null;
          if (!stateFromStores1) {
