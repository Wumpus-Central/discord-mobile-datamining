// discord_app/modules/main_tabs_v2/native/channel/useChannelSafeAreaHeightSharedValue.android.tsx
...
export default function useChannelSafeAreaHeightSharedValue() {
  ...
  const token = _require(keyboardOpenedHeight[5]).useToken(
    keyboardOpenOrOpening(keyboardOpenedHeight[6]).modules.mobile.CHAT_INPUT_FLOATING_OFFSET_MINIMUM,
  );
  ...
  obj = {
    ...
    insets: tmp,
    keyboardTypeSharedValue,
    KeyboardTypes: _require(keyboardOpenedHeight[7]).KeyboardTypes,
