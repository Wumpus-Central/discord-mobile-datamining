...
const memoResult = require("noop").memo(function ShareLogsButton() {
  ...
  obj[0] = intl.string(getSystemLocale /* getSystemLocale */.t["Aw+09z"]);
  ...
  obj[2] = jsx(ShareIcon /* ShareIcon */.ShareIcon, {});
  return jsx(PressableBase /* PressableBase */.PressableOpacity, { accessibilityLabel: null, onPress: null, children: null });
});
