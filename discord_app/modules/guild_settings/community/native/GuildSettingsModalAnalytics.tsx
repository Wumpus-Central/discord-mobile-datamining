            ...
            if (arg0 === 1) {
              ...
              const obj6 = {
                value: v1(7556).redirectDeveloperPortalWithHandoffToken(
                  result,
                  v3(7560).LoginHandoffSource.GUILD_ANALYTICS_SETTING,
                ),
                done: false,
              };
              return obj6;
  ...
  if (null == notice) {
    ...
    if (null != analytics) {
      ...
      const merged = Object.assign(
        tmp2(18104).getGuildAnalyticsCardProps(analytics.visitors, analytics.visitorsChange, stateFromStores),
      );
      ...
      const merged1 = Object.assign(
        tmp2(18104).getGuildAnalyticsCardProps(analytics.communicators, analytics.communicatorsChange, stateFromStores),
      );
      ...
      const merged2 = Object.assign(
        tmp2(18104).getGuildAnalyticsCardProps(analytics.newMembers, analytics.newMembersChange, stateFromStores),
      );
    ...
    const items5 = [closure_9(ScrollView, obj3), closure_9(tmp2(7280).NavScrim, {})];
