            ...
            if (arg0 === 1) {
              ...
              const obj6 = {
                value: v1(7561).redirectDeveloperPortalWithHandoffToken(
                  result,
                  v3(7565).LoginHandoffSource.GUILD_ANALYTICS_SETTING,
                ),
                done: false,
              };
              return obj6;
  ...
  if (null == notice) {
    ...
    if (null != analytics) {
      ...
      const merged = Object.assign(
        tmp2(18127).getGuildAnalyticsCardProps(analytics.visitors, analytics.visitorsChange, stateFromStores),
      );
      ...
      const merged1 = Object.assign(
        tmp2(18127).getGuildAnalyticsCardProps(analytics.communicators, analytics.communicatorsChange, stateFromStores),
      );
      ...
      const merged2 = Object.assign(
        tmp2(18127).getGuildAnalyticsCardProps(analytics.newMembers, analytics.newMembersChange, stateFromStores),
      );
