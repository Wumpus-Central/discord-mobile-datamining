            ...
            if (arg0 === 1) {
              ...
              const obj6 = {
                value: v1(7558).redirectDeveloperPortalWithHandoffToken(
                  result,
                  v3(7562).LoginHandoffSource.GUILD_ANALYTICS_SETTING,
                ),
                done: false,
              };
              return obj6;
  ...
  if (null == notice) {
    ...
    if (null != analytics) {
      ...
      const merged = Object.assign(
        tmp2(18115).getGuildAnalyticsCardProps(analytics.visitors, analytics.visitorsChange, stateFromStores),
      );
      ...
      const merged1 = Object.assign(
        tmp2(18115).getGuildAnalyticsCardProps(analytics.communicators, analytics.communicatorsChange, stateFromStores),
      );
      ...
      const merged2 = Object.assign(
        tmp2(18115).getGuildAnalyticsCardProps(analytics.newMembers, analytics.newMembersChange, stateFromStores),
      );
      ...
      tmp7Result = closure_10(tmp2(5184).Stack, obj8);
      const tmp11Result6 = GuildSettingsAnalyticsCardDefault;
    }
    const obj13 = { children: null };
    items3[4] = tmp7Result;
    obj4.children = items3;
    obj3.children = closure_10(guildId(5184).Stack, obj4);
    const items5 = [closure_9(ScrollView, obj3), closure_9(tmp2(7285).NavScrim, {})];
