...
export default function GuildSettingsAnalyticsCard(metricKey) {
  ...
  const items1 = [
    closure_6(metricKey(4825).Text, { variant: "text-md/medium", color: "text-subtle", children: title }),
  ];
  let tmp7Result = null;
  if (null != description) {
    const obj3 = {
    ...
    obj3.children = closure_6(tmp4(4783).CircleInformationIcon, obj4);
  ...
  if (null != subtext) {
    ...
    if (isTrendingUp) {
      const obj7 = {
        size: "xxs",
        color: description(576).colors.TEXT_FEEDBACK_POSITIVE,
        accessible: true,
        accessibilityLabel: null,
      };
      const intl2 = tmp4(1115).intl;
      obj7.accessibilityLabel = intl2.string(tmp4(1115).t["8mcccd"]);
      tmp7Result3 = closure_6(tmp4(10946).ArrowLargeUpIcon, obj7);
    }
