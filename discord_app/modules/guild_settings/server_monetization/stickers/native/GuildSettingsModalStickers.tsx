...
obj.IconComponent = fn(17577).BoostGemOutlineIcon;
items[1] = obj;
...
obj1.IconComponent = fn(9380).BoostGemIcon;
items[2] = obj1;
...
obj2.IconComponent = fn(13529).BoostTier3Icon;
items[3] = obj2;
        ...
        items = [
          ...
          Array.from({ length: incrementalStickerCountForTier }).map((item, index) => {
            ...
            if (null == closure_5[+closure_6]) {
              ...
              obj.children = closure_1_12(closure_1_1(10181), obj1);
              ...
              if (null != user) {
                ...
                const obj4 = {
                  ...
                  color: "text-subtle",
                  children: closure_1_1(4404).getName(user),
                };
