...
obj3.IconComponent = fn(8678).BoostGemIcon;
items[2] = obj3;
      ...
      children: items.map((label) => {
        ...
        items[1] = Array.from({ length: incrementalStickerCountForTier }).map((item, index) => {
          ...
          if (null == closure_5[+closure_6]) {
            ...
            obj3.children = closure_1_12(closure_1_1(9636), obj4);
            ...
            if (null != user) {
              ...
              const obj7 = {
                ...
                color: "text-subtle",
                children: closure_1_1(4988).getName(guildId, undefined, user),
              };
              items1[1] = closure_1_12(tmp10(4832).Text, obj7);
              obj.children = items1;
            ...
            let tmp9Result;
            if (tmp8) {
              tmp9Result = closure_1_12(tmp10(5924).TableRowArrow, {});
            }
            ...
            obj2.onPress = fn;
            return closure_1_12(guildId(5917).TableRow, obj2, index);
          }
        });
        obj7.children = items;
