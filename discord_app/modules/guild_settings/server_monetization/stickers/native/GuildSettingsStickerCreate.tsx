...
export default noop.forwardRef((stickerId, arg1) => {
  ...
  if (null == stickerId) {
    ...
    const items2 = [onPressEmoji(stickerId(4602).Text, obj3), , ,];
    ...
    items2[2] = onPressEmoji(stickerId(4602).Text, obj6);
    ...
    obj8.variant = str;
    items2[3] = onPressEmoji(stickerId(5026).Button, obj8);
  ...
  const items4 = [onPressEmoji(stickerId(4602).Text, obj11), , , , , ,];
  const obj12 = {
  ...
  items4[1] = onPressEmoji(stickerId(5174).PressableHighlight, obj12);
  ...
  items4[2] = onPressEmoji(stickerId(4602).Text, obj16);
  const obj17 = {
  ...
  if (null != first1) {
    ...
    tmp32Result = tmp32(tmp31(8848).ReactionIcon, { size: "md", color: "text-subtle" });
  }
  ...
  items5[1] = onPressEmoji(stickerId(4602).Text, {
    variant: "text-md/semibold",
    color: "input-placeholder-text-default",
    children: combined,
  });
  obj17.children = items5;
  items4[3] = closure_17(stickerId(5174).PressableHighlight, obj17);
  const obj20 = {
    ref: ref1,
    label: null,
    placeholder: null,
  ...
  items4[4] = onPressEmoji(stickerId(6677).TextInput, obj20);
  ...
  items4[5] = onPressEmoji(stickerId(7158).TextArea, obj21);
  const obj22 = {
  ...
  items4[6] = onPressEmoji(stickerId(5026).Button, obj22);
  obj10.children = items4;
  items3[1] = closure_17(stickerId(5024).Stack, obj10);
