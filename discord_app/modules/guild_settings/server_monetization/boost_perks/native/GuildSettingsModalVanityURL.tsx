// === Module 18159: GuildSettingsModalVanityURL ===
...
import GuildSettingsVanityURLUtils from "GuildSettingsVanityURLUtils" /* 18006 */;
import ChangeVanityURLActionCreatorsDefault from "ChangeVanityURLActionCreators" /* 18161 */;
import _modDef18162 from "module_18162" /* 18162 */;
import noop from "module_19" /* 19 */;
import ChangeVanityURLModalStore from "ChangeVanityURLModalStore" /* 18160 */;
...
prototype["updateNavigator"] = function updateNavigator(submitting, isEditing) {
  ...
  if (!tmp) {
    if (submitting) {
      ...
      fn = self(5927).getHeaderConditionalBackButton(this.handleCancel);
      let obj = self(5927);
    }
...
prototype["render"] = function render() {
  ...
  if (isEditing) {
    ...
    const obj13 = { source: _modDef18162, style: styles.image, resizeMode: "contain" };
...
export default function ConnectedGuildSettingsModalVanityURL(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const items3 = [closure_9(GuildSettingsModalVanityURL, obj6), closure_9(tmp2(7371).NavScrim, {})];
