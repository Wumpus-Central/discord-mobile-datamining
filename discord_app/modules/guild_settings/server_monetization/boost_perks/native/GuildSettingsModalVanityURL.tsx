...
import { registerAsset } from "../../../../../../_runtime/16820_registerAsset.js";
...
prototype["render"] = function render() {
  ...
  if (isEditing) {
    ...
    if (tmp17Result) {
      ...
      tmp17Result = tmp17(tmp18(4338).Text, obj8);
    }
...
export default function ConnectedGuildSettingsModalVanityURL(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const items3 = [callback(GuildSettingsModalVanityURL, obj), callback(tmp2(5775).NavScrim, {})];
    obj[0] = items3;
