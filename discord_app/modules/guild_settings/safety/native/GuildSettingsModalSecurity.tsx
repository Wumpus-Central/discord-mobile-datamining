...
export default function GuildSettingsModalSecurity(guildId) {
  ...
  const items4 = [closure_12(guildId(4601).Text, obj1), , ];
  ...
  obj2.children = closure_12(guildId(5025).Button, obj3);
  ...
  if (hasItem) {
    ...
    tmp17Result = closure_12(tmp2(4601).Text, obj4);
  }
  ...
  obj8.children = closure_12(guildId(4601).Text, obj9);
  items6[1] = closure_12(closure_4, obj8);
  obj6.children = items6;
  items5[1] = closure_13(closure_4, obj6);
  obj.children = items5;
  const items7 = [closure_13(closure_4, obj), closure_12(guildId(7092).NavScrim, {})];
