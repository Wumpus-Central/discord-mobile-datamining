// === Module 11480: TransferOwnership ===
...
export default function TransferOwnership(guild) {
  ...
  obj3 = { source: toUser(11481), style: tmp5.arrow };
  ...
  items1[2] = callback2(guild(4440).Text, { variant: "text-xs/medium", color: "text-default", children: guild.name });
  if (null == nickname) {
    if (!hasAvatarForGuildResult) {
      const intl = tmp(1236).intl;
      const obj9 = { GuildHook: null, user: null };
      obj9[0] = GuildWithSmallIcon;
      let tmp3Result = tmp3(4288);
    ...
    obj11[2] = tmp11(tmp(8673).TableCheckboxRow, obj12);
    items3[1] = tmp11(tmp(5939).TableRowGroup, obj11);
    ...
    obj14[2] = !tmp8;
    items3[2] = tmp11(tmp(4879).Button, obj14);
    obj[1] = items3;
  ...
  obj15[1] = toUser(4288).getUserTag(toUser);
  obj15[2] = function NicknameAKA() {
    ...
    const items = [closure_1_15(guild(4440).Text, obj), , ];
    let tmp6 = null;
    if (c7) {
    ...
    obj = { children: null };
    items[2] = closure_1_13(guild(4440).Text, { variant: "text-md/medium", children: str });
    obj[0] = items;
