...
export default function TransferOwnership(guild) {
  ...
  obj3 = { source: toUser(11879), style: tmp5.arrow };
  ...
  if (null == nickname) {
    ...
    obj11.children = closure_13(tmp(5618).TableCheckboxRow, obj12);
    items3[1] = closure_13(tmp(5701).TableRowGroup, obj11);
    const obj14 = {
    ...
    obj14.disabled = !tmp8;
    items3[2] = closure_13(tmp(4989).Button, obj14);
    obj.children = items3;
  ...
  obj15.user = toUser(4418).getUserTag(toUser);
