...
export default function TransferOwnership(guild) {
  ...
  if (null == nickname) {
    ...
    obj17.children = closure_13(tmp(5821).TableCheckboxRow, obj18);
    items3[1] = closure_13(tmp(5904).TableRowGroup, obj17);
    const obj20 = {
    ...
    obj20.disabled = !tmp8;
    items3[2] = closure_13(tmp(5186).Button, obj20);
