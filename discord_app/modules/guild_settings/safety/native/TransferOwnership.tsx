...
export default function TransferOwnership(guild) {
  ...
  const items2 = [
    closure_13(guild(1177).Avatar, { user: stateFromStores, guildId: guild.id, size: guild(1177).AvatarSizes.XXLARGE }),
  ];
  ...
  if (null == nickname) {
    ...
    obj17.children = closure_13(tmp(5916).TableCheckboxRow, obj18);
    items3[1] = closure_13(tmp(5999).TableRowGroup, obj17);
    const obj20 = {
    ...
    obj20.disabled = !tmp8;
    items3[2] = closure_13(tmp(5281).Button, obj20);
