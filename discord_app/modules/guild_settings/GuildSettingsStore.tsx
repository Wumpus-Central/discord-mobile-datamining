...
import GuildSettingsFetchActionCreators from "GuildSettingsFetchActionCreators.tsx";
...
import PublicGuildsConstants from "../public_guilds/PublicGuildsConstants.tsx";
...
function handleIntegrationsUpdate(type) {
  ...
  if (tmp) {
    ...
    if (tmp5) {
      const guildIntegrationsApplications = GuildSettingsFetchActionCreators.fetchGuildIntegrationsApplications(
        guild.id,
      );
    }
    tmp = tmp5;
            ...
            if (tmp12) {
              ...
              if (tmp13) {
                const guildIntegrationsApplications =
                  GuildSettingsFetchActionCreators.fetchGuildIntegrationsApplications(guild.id);
              }
              tmp12 = tmp13;
            }
            return tmp12;
