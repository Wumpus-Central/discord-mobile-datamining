...
function Header(arg0) {
  ...
  obj2[1] = intl.format(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.Nj0a3j, { platformName: name1 });
  const obj3 = { "aria-label": null, onPress: null, disabled: null, children: null };
  const intl2 = tmp3(1236).intl;
  obj3[0] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.N86XcP);
  obj3[1] = onRemove;
  obj3[2] = locked;
  obj3[3] = callback2(require("../../../../design/components/Icon/native/redesign/generated/XSmallIcon.tsx") /* XSmallIcon */.XSmallIcon, {});
  obj2[2] = callback2(require("../../../../design/void/Pressables/native/Pressables.tsx") /* PressableBase */.PressableOpacity, obj3);
  return callback2(require("../../../../design/components/TableRow/native/TableRow.native.tsx") /* TableRowInner */.TableRow, obj2);
}
...
function BlueskyMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["REyUZ/"], metadataField: closure_7.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(closure_7.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [callback2(NumericalConfigRule, obj), callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["/w/EYk"], metadataField: closure_7.BLUESKY_FOLLOWERS_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.BLUESKY_FOLLOWERS_COUNT), platform: value, onConfigurationChange, locked }), ];
  const obj1 = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["/w/EYk"], metadataField: closure_7.BLUESKY_FOLLOWERS_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.BLUESKY_FOLLOWERS_COUNT), platform: value, onConfigurationChange, locked };
  items[2] = callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["5I4mVS"], metadataField: closure_7.BLUESKY_STATUSES_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.BLUESKY_STATUSES_COUNT), platform: value, onConfigurationChange, locked });
  obj[0] = items;
...
function SteamMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["REyUZ/"], metadataField: closure_7.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(closure_7.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [callback2(NumericalConfigRule, obj), callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.zVJxqj, metadataField: closure_7.STEAM_GAME_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.STEAM_GAME_COUNT), platform: value, onConfigurationChange, locked }), , ];
  const obj1 = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.zVJxqj, metadataField: closure_7.STEAM_GAME_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.STEAM_GAME_COUNT), platform: value, onConfigurationChange, locked };
  items[2] = callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["ZCNdD/"], metadataField: closure_7.STEAM_ITEM_COUNT_DOTA2, existingPendingConfiguration: configMetadataMap.get(closure_7.STEAM_ITEM_COUNT_DOTA2), platform: value, onConfigurationChange, locked });
  const obj2 = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["ZCNdD/"], metadataField: closure_7.STEAM_ITEM_COUNT_DOTA2, existingPendingConfiguration: configMetadataMap.get(closure_7.STEAM_ITEM_COUNT_DOTA2), platform: value, onConfigurationChange, locked };
  items[3] = callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["MCHnK+"], metadataField: closure_7.STEAM_ITEM_COUNT_TF2, existingPendingConfiguration: configMetadataMap.get(closure_7.STEAM_ITEM_COUNT_TF2), platform: value, onConfigurationChange, locked });
  obj[0] = items;
  return callback3(closure_14, obj);
}
function TwitterMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["REyUZ/"], metadataField: closure_7.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(closure_7.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [callback2(NumericalConfigRule, obj), callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["/w/EYk"], metadataField: closure_7.TWITTER_FOLLOWERS_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.TWITTER_FOLLOWERS_COUNT), platform: value, onConfigurationChange, locked }), , ];
  const obj1 = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["/w/EYk"], metadataField: closure_7.TWITTER_FOLLOWERS_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.TWITTER_FOLLOWERS_COUNT), platform: value, onConfigurationChange, locked };
  items[2] = callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["+NFH7k"], metadataField: closure_7.TWITTER_STATUSES_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.TWITTER_STATUSES_COUNT), platform: value, onConfigurationChange, locked });
  ...
  obj3[0] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.E2iT8K);
...
function RedditMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["REyUZ/"], metadataField: closure_7.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(closure_7.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [callback2(NumericalConfigRule, obj), callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.TLgZhv, metadataField: closure_7.REDDIT_TOTAL_KARMA, existingPendingConfiguration: configMetadataMap.get(closure_7.REDDIT_TOTAL_KARMA), platform: value, onConfigurationChange, locked }), , ];
  ...
  const intl = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj2[0] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["0cKdka"]);
  ...
  obj3[0] = intl2.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.kCAN58);
...
function PaypalMetadataRules(arg0) {
  ...
  const intl = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[0] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["0JyE8I"]);
...
function EbayMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["REyUZ/"], metadataField: closure_7.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(closure_7.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [callback2(NumericalConfigRule, obj), callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.oTFOe5, metadataField: closure_7.EBAY_POSITIVE_FEEDBACK_PERCENTAGE, existingPendingConfiguration: configMetadataMap.get(closure_7.EBAY_POSITIVE_FEEDBACK_PERCENTAGE), platform: value, onConfigurationChange, locked }), , , ];
  const obj1 = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.oTFOe5, metadataField: closure_7.EBAY_POSITIVE_FEEDBACK_PERCENTAGE, existingPendingConfiguration: configMetadataMap.get(closure_7.EBAY_POSITIVE_FEEDBACK_PERCENTAGE), platform: value, onConfigurationChange, locked };
  items[2] = callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["v5a2+Q"], metadataField: closure_7.EBAY_UNIQUE_POSITIVE_FEEDBACK_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.EBAY_UNIQUE_POSITIVE_FEEDBACK_COUNT), platform: value, onConfigurationChange, locked });
  const obj2 = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["v5a2+Q"], metadataField: closure_7.EBAY_UNIQUE_POSITIVE_FEEDBACK_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.EBAY_UNIQUE_POSITIVE_FEEDBACK_COUNT), platform: value, onConfigurationChange, locked };
  items[3] = callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.yYbR2r, metadataField: closure_7.EBAY_UNIQUE_NEGATIVE_FEEDBACK_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.EBAY_UNIQUE_NEGATIVE_FEEDBACK_COUNT), platform: value, onConfigurationChange, locked, operator: constants.LESS_THAN });
  ...
  const intl = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj4[0] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["39wASN"]);
...
function TikTokMetadataRules(arg0) {
  ...
  const intl = require("../../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[0] = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.E2iT8K);
  obj[1] = closure_7.TIKTOK_VERIFIED;
  obj[2] = configMetadataMap.get(closure_7.TIKTOK_VERIFIED);
  obj[3] = value;
  obj[4] = onConfigurationChange;
  obj[5] = locked;
  const items = [callback2(BooleanConfigRule, obj), callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["/w/EYk"], metadataField: closure_7.TIKTOK_FOLLOWER_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.TIKTOK_FOLLOWER_COUNT), platform: value, onConfigurationChange, locked }), , ];
  const obj1 = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["/w/EYk"], metadataField: closure_7.TIKTOK_FOLLOWER_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.TIKTOK_FOLLOWER_COUNT), platform: value, onConfigurationChange, locked };
  items[2] = callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.JHEsYw, metadataField: closure_7.TIKTOK_FOLLOWING_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.TIKTOK_FOLLOWING_COUNT), platform: value, onConfigurationChange, locked });
  const obj2 = { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.JHEsYw, metadataField: closure_7.TIKTOK_FOLLOWING_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.TIKTOK_FOLLOWING_COUNT), platform: value, onConfigurationChange, locked };
  items[3] = callback2(NumericalConfigRule, { fieldTextHook: require("../../../../intl/index.native.tsx") /* getSystemLocale */.t.tEFCYA, metadataField: closure_7.TIKTOK_LIKES_COUNT, existingPendingConfiguration: configMetadataMap.get(closure_7.TIKTOK_LIKES_COUNT), platform: value, onConfigurationChange, locked });
  obj[0] = items;
  return callback3(closure_14, obj);
}
