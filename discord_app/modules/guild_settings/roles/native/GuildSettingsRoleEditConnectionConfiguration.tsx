...
function Header(arg0) {
  ...
  if (null != application1) {
    ...
    const obj1 = { source: tmp3Result.makeSource(tmp3Result.isThemeDark(tmp2) ? icon.darkPNG : icon.lightPNG), disableColor: true };
...
function NumericalConfigRule(existingPendingConfiguration) {
  ...
  let tmpResult = metadataField(17673);
  ...
  if (undefined !== fieldTextHook) {
    ...
    obj = {
      metadataHook() {
          ...
          obj = { keyboardType: "number-pad", style: items1, editable: !closure_11, value, onChangeText: onInputValueChange, hitSlop: 8 };
    ...
    if (undefined !== fieldText) {
      ...
      items1[1] = onInputValueChange(metadataField(4570).Text, obj4);
    ...
    return onInputValueChange(metadataField(7214).TableSwitchRow, obj5, metadataField);
  }
}
function BlueskyMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: util.t["REyUZ/"], metadataField: React5.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(React5.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [closure_1_12(NumericalConfigRule, obj), closure_1_12(NumericalConfigRule, { fieldTextHook: util.t["/w/EYk"], metadataField: React5.BLUESKY_FOLLOWERS_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.BLUESKY_FOLLOWERS_COUNT), platform: value, onConfigurationChange, locked }), ];
  const obj1 = { fieldTextHook: util.t["/w/EYk"], metadataField: React5.BLUESKY_FOLLOWERS_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.BLUESKY_FOLLOWERS_COUNT), platform: value, onConfigurationChange, locked };
...
function SteamMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: util.t["REyUZ/"], metadataField: React5.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(React5.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [closure_1_12(NumericalConfigRule, obj), closure_1_12(NumericalConfigRule, { fieldTextHook: util.t.zVJxqj, metadataField: React5.STEAM_GAME_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.STEAM_GAME_COUNT), platform: value, onConfigurationChange, locked }), , ];
  const obj1 = { fieldTextHook: util.t.zVJxqj, metadataField: React5.STEAM_GAME_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.STEAM_GAME_COUNT), platform: value, onConfigurationChange, locked };
  ...
  const obj2 = { fieldTextHook: util.t["ZCNdD/"], metadataField: React5.STEAM_ITEM_COUNT_DOTA2, existingPendingConfiguration: configMetadataMap.get(React5.STEAM_ITEM_COUNT_DOTA2), platform: value, onConfigurationChange, locked };
...
function TwitterMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: util.t["REyUZ/"], metadataField: React5.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(React5.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [closure_1_12(NumericalConfigRule, obj), closure_1_12(NumericalConfigRule, { fieldTextHook: util.t["/w/EYk"], metadataField: React5.TWITTER_FOLLOWERS_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.TWITTER_FOLLOWERS_COUNT), platform: value, onConfigurationChange, locked }), , ];
  const obj1 = { fieldTextHook: util.t["/w/EYk"], metadataField: React5.TWITTER_FOLLOWERS_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.TWITTER_FOLLOWERS_COUNT), platform: value, onConfigurationChange, locked };
...
function RedditMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: util.t["REyUZ/"], metadataField: React5.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(React5.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [closure_1_12(NumericalConfigRule, obj), closure_1_12(NumericalConfigRule, { fieldTextHook: util.t.TLgZhv, metadataField: React5.REDDIT_TOTAL_KARMA, existingPendingConfiguration: configMetadataMap.get(React5.REDDIT_TOTAL_KARMA), platform: value, onConfigurationChange, locked }), , ];
...
function EbayMetadataRules(arg0) {
  ...
  obj = { children: null };
  obj = { fieldTextHook: util.t["REyUZ/"], metadataField: React5.CREATED_AT, existingPendingConfiguration: configMetadataMap.get(React5.CREATED_AT), platform: value, onConfigurationChange, locked };
  const items = [closure_1_12(NumericalConfigRule, obj), closure_1_12(NumericalConfigRule, { fieldTextHook: util.t.oTFOe5, metadataField: React5.EBAY_POSITIVE_FEEDBACK_PERCENTAGE, existingPendingConfiguration: configMetadataMap.get(React5.EBAY_POSITIVE_FEEDBACK_PERCENTAGE), platform: value, onConfigurationChange, locked }), , , ];
  const obj1 = { fieldTextHook: util.t.oTFOe5, metadataField: React5.EBAY_POSITIVE_FEEDBACK_PERCENTAGE, existingPendingConfiguration: configMetadataMap.get(React5.EBAY_POSITIVE_FEEDBACK_PERCENTAGE), platform: value, onConfigurationChange, locked };
  ...
  const obj2 = { fieldTextHook: util.t["v5a2+Q"], metadataField: React5.EBAY_UNIQUE_POSITIVE_FEEDBACK_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.EBAY_UNIQUE_POSITIVE_FEEDBACK_COUNT), platform: value, onConfigurationChange, locked };
...
function TikTokMetadataRules(arg0) {
  ...
  obj.locked = locked;
  const items = [closure_1_12(BooleanConfigRule, obj), closure_1_12(NumericalConfigRule, { fieldTextHook: util.t["/w/EYk"], metadataField: React5.TIKTOK_FOLLOWER_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.TIKTOK_FOLLOWER_COUNT), platform: value, onConfigurationChange, locked }), , ];
  const obj1 = { fieldTextHook: util.t["/w/EYk"], metadataField: React5.TIKTOK_FOLLOWER_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.TIKTOK_FOLLOWER_COUNT), platform: value, onConfigurationChange, locked };
  ...
  const obj2 = { fieldTextHook: util.t.JHEsYw, metadataField: React5.TIKTOK_FOLLOWING_COUNT, existingPendingConfiguration: configMetadataMap.get(React5.TIKTOK_FOLLOWING_COUNT), platform: value, onConfigurationChange, locked };
...
fn(4574);
let createStyles = { numericalInputContainerIOSInline: { marginTop: -2 }, numericalInputContainerAndroidInline: null, numericalInputContainerBase: null, numericalInput: null, appNumericalInput: null, appNumericalInputContainer: null, appNumericalInputText: null, numericalInputDisabled: null, metadataRow: null, metadataRowText: null };
...
createStyles.numericalInputContainerBase = { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, borderRadius: nativeDefault.radii.sm };
