...
function NumericalConfigRule(existingPendingConfiguration) {
  ...
  if (undefined !== fieldTextHook) {
    ...
    if (undefined !== fieldText) {
      ...
      items1[1] = onInputValueChange(metadataField(4823).Text, obj7);
    ...
    return onInputValueChange(metadataField(7531).TableSwitchRow, obj8, metadataField);
  }
  const str = metadataField(18154).displayedValueFor(value, realizedOperatorForResult);
}
