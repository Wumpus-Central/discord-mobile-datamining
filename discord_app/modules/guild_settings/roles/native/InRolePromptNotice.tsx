...
import { registerAsset } from "../../../../../_runtime/09108_registerAsset.js";
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      ...
      items1[1] = tmp6(tmp(4340).Text, obj3);
      obj[1] = items1;
      tmp4Result = tmp4(tmp5, obj);
    }
    isRolePowerfulResult = tmp(16788).isRolePowerful(role);
  }
};