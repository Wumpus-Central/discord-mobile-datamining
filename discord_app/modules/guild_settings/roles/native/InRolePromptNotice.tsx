// === Module 18078: InRolePromptNotice ===
...
import GuildSettingsUtils from "GuildSettingsUtils" /* 18079 */;
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      const obj3 = { style: string.icon, source: _modDef9719, color: nativeDefault.unsafe_rawColors.YELLOW_300 };
      ...
      const obj5 = { style: string.icon, source: _modDef9719 };
