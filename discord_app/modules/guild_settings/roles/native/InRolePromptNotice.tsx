...
import GuildSettingsUtils from "GuildSettingsUtils" /* 17726 */;
...
export default function InRolePromptNotice(role) {
  ...
  if (!obj.hasFlag(role.flags, RoleFlags.IN_PROMPT)) {
    ...
    if (isRolePowerfulResult) {
      obj = { style: string.icon, source: _modDef9695, color: nativeDefault.unsafe_rawColors.YELLOW_300 };
      ...
      const obj2 = { style: string.icon, source: _modDef9695 };
