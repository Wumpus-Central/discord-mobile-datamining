// === Module 17603: GuildSettingsRoles ===
...
import SortableListViewDefault from "SortableListView" /* 16377 */;
import GuildSettingsRolesManager from "GuildSettingsRolesManager" /* 17606 */;
...
import actions_GuildActionCreators from "actions/GuildActionCreators" /* 17616 */;
import GuildSettingsModalRolesActionCreatorsDefault from "GuildSettingsModalRolesActionCreators" /* 17617 */;
import _modDef17619 from "module_17619" /* 17619 */;
import _modDef17620 from "module_17620" /* 17620 */;
import _modDef17621 from "module_17621" /* 17621 */;
import GuildSettingsRoleItemDefault from "GuildSettingsRoleItem" /* 17622 */;
...
import GuildSettingsModalRolesStore from "GuildSettingsModalRolesStore" /* 17604 */;
...
createStyles.emptyIlloContainer = { backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOW, width: "100%", flex: 1, alignItems: "center" };
...
export default function ConnectedGuildSettingsModalRoles(guildId) {
  ...
  const callback8 = obj.useCallback(() => {
    ...
    if (!first) {
      ...
      if (!closure_16) {
        ...
        obj1.accessibilityLabel = intl2.string(util.t["0dOFq+"]);
        obj1.onPress = callback5;
        obj1.style = closure_1.reorderButton;
        const obj2 = { color: nativeDefault.colors.TEXT_LINK, size: "sm" };
        const items2 = [__initData(ArrowsUpDownIcon.ArrowsUpDownIcon, obj2), ];
        const obj3 = { style: closure_1.reorderButtonText, variant: "text-sm/medium", color: "text-link", children: null };
        const intl3 = util.intl;
        obj3.children = intl3.string(util.t["0dOFq+"]);
        items2[1] = __initData(Text_Text.Text, obj3);
        obj1.children = items2;
        tmpResult = __initData2(Pressables.PressableOpacity, obj1);
      }
    }
    items1[1] = tmpResult;
    obj.children = items1;
    ...
    let tmp6Result = null;
    if (first) {
      const obj4 = { style: closure_1.rolesBody, variant: "text-sm/medium", color: "interactive-text-default", children: null };
      const intl4 = util.intl;
      obj4.children = intl4.string(util.t.nHcwVl);
      tmp6Result = __initData(Text_Text.Text, obj4);
    }
  ...
  const callback9 = obj.useCallback(() => {
    ...
    if (closure_3) {
      ...
      if (hasRoles) {
        ...
        items[1] = obj1;
        obj.style = items;
        const obj2 = { style: closure_1.subheaderDescription, variant: "text-sm/medium", color: "interactive-text-default", children: null };
        const intl4 = util.intl;
        ...
        obj.children = items1;
        let tmp9Result = __initData2(__initData3, obj);
      } else {
        ...
        const obj8 = { style: closure_1.subheader, variant: "heading-xl/extrabold", color: "mobile-text-heading-primary", children: null };
        const intl = util.intl;
        obj8.children = intl.string(util.t.ALlnbi);
        const items4 = [__initData(Text_Text.Heading, obj8), , ];
        const obj9 = { style: closure_1.subheaderBody, variant: "text-sm/medium", color: "text-default", children: null };
        const intl2 = util.intl;
        ...
        tmp9Result = __initData2(timestampProducer, obj4);
      }
      return tmp9Result;
    }
  }, items17);
  ...
  const callback10 = obj.useCallback(() => {
    if (null != guild) {
      if (null != guildEveryoneRole) {
        ...
        obj = { role: guildEveryoneRole, locked: null, onPress: null, guildId: null, sorting: false, numMembers: 0, isEveryoneRole: true, isLastRole: true, isFirstRole: true };
  ...
  const callback11 = obj.useCallback((role, from) => {
    if (null == guild) {
      ...
      const obj = { sorting, isEveryoneRole: null, role: null, locked: null, guildId: null, numMembers: null, isFirstRole: null, isLastRole: null, onPress: null, onLongPress: null, onMoveUp: null, onMoveDown: null };
      let tmp3 = null != guild;
