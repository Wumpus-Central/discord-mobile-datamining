...
import _modDef17964 from "../../../../../_runtime/metro/17964__.js";
...
export default function ConnectedGuildSettingsModalRoles(guildId) {
  ...
  const guildSettingsRolesManagerState = guildId(17949).useGuildSettingsRolesManagerState(
  ...
  const callback9 = obj.useCallback(() => {
    ...
    if (closure_3) {
      if (isThemeDarkResult) {
        ...
        tmp3Result = _modDef17962;
      }
    } else {
      if (isThemeDarkResult) {
        let tmp3Result2 = _modDef17963;
      } else {
        tmp3Result2 = _modDef17964;
      }
      if (hasRoles) {
  ...
  const callback11 = obj.useCallback((role, from) => {
    if (null == guild) {
      ...
      obj2.onMoveDown = fn2;
      return hasRoles(closure_1(17965), obj2, role.id);
    }
  }, items19);
