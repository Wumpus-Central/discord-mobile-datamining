...
import _modDef18042 from "../../../../../_runtime/metro/18042__.js";
import _modDef18043 from "../../../../../_runtime/metro/18043__.js";
import _modDef18044 from "../../../../../_runtime/metro/18044__.js";
...
export default function ConnectedGuildSettingsModalRoles(guildId) {
  ...
  const guildSettingsRolesManagerState = guildId(18029).useGuildSettingsRolesManagerState(
  ...
  const callback9 = obj.useCallback(() => {
    ...
    if (closure_3) {
      if (isThemeDarkResult) {
        ...
        tmp3Result = _modDef18042;
      }
    } else {
      if (isThemeDarkResult) {
        let tmp3Result2 = _modDef18043;
      } else {
        tmp3Result2 = _modDef18044;
      }
      if (hasRoles) {
  ...
  const callback11 = obj.useCallback((role, from) => {
    if (null == guild) {
      ...
      obj2.onMoveDown = fn2;
      return hasRoles(closure_1(18045), obj2, role.id);
    }
  }, items19);
