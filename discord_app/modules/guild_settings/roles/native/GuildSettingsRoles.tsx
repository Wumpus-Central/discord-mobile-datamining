...
import _modDef17871 from "../../../../../_runtime/metro/17871__.js";
...
export default function ConnectedGuildSettingsModalRoles(guildId) {
  ...
  const guildSettingsRolesManagerState = guildId(17856).useGuildSettingsRolesManagerState(
  ...
  const callback9 = obj.useCallback(() => {
    ...
    if (closure_3) {
      if (isThemeDarkResult) {
        ...
        tmp3Result = _modDef17869;
      }
    } else {
      if (isThemeDarkResult) {
        let tmp3Result2 = _modDef17870;
      } else {
        tmp3Result2 = _modDef17871;
      }
      if (hasRoles) {
  ...
  const callback11 = obj.useCallback((role, from) => {
    if (null == guild) {
      ...
      obj2.onMoveDown = fn2;
      return hasRoles(closure_1(17872), obj2, role.id);
    }
  }, items19);
