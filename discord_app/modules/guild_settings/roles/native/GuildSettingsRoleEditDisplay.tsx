// === Module 17740: GuildSettingsRoleEditDisplay ===
...
const STYLE_CONFIGS = fn(17724).STYLE_CONFIGS;
const Constants = fn(1074);
({ DEFAULT_ROLE_COLOR: closure_9, MAX_ROLE_LENGTH: c10 } = Constants);
let closure_11 = fn(17727).DEFAULT_GRADIENT_ROLE_COLORS;
const jsxProd = fn(21);
...
export default function GuildSettingsRoleEditDisplay(guild) {
  ...
  if (null != stateFromStores) {
    ...
    const callback = SOLID.useCallback(() => {
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(17742, dependencyMap.paths), "RoleIcon", { guildId: guild.id, roleId: id });
    }, items1);
    ...
    const callback1 = SOLID.useCallback(() => {
      if (SOLID === RoleColorsStyle.SOLID) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16388, dependencyMap.paths), "RoleColorPicker", obj2);
        ...
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(17744, dependencyMap.paths), "RoleColorPicker", obj4);
      }
    }, items2);
    const callback2 = SOLID.useCallback(() => {
      ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(17745, dependencyMap.paths), "EnhancedRoleColorsSelectStyleModal", {
        guildId: guild.id,
        role,
        roleStyle: SOLID,
    ...
    if (SOLID === RoleColorsStyle.HOLOGRAPHIC) {
      ...
      items4[2] = closure_13(tmp4(tmp5[27]).TableRowGroup, obj9);
      ...
      if (tmp30Result) {
        ...
        tmp30Result = closure_13(primary_color, obj10);
      }
      ...
      items4[5] = closure_13(tmp4(tmp5[27]).TableRowGroup, obj18);
      obj17.children = items4;
      return closure_13(closure_14, obj17);
    } else {
