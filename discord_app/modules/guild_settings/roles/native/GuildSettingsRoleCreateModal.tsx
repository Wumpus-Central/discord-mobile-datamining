// === Module 18146: GuildSettingsRoleCreateModal ===
...
function RoleCreateScene() {
  ...
  const callback2 = onSelect.useCallback(() => {
    React6.dismiss();
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16717, dependencyMap.paths), "RoleColorPicker", { color, onSelect });
  }, items3);
