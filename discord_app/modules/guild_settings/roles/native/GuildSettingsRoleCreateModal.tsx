          ...
          if (null != selectedRoleId) {
            if (null != role) {
              if (null != guild) {
                ...
                const merged = Object.assign(closure_0(4902).collectGuildAnalyticsMetadata(guild.id));
...
let obj = {
  container: { marginTop: fn(5852).NAV_BAR_HEIGHT, flexGrow: 1, paddingBottom: nativeDefault.space.PX_16 },
