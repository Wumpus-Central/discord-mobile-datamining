          ...
          if (null != selectedRoleId) {
            if (null != role) {
              if (null != guild) {
                ...
                const merged = Object.assign(closure_0(4785).collectGuildAnalyticsMetadata(guild.id));
...
function RolePermissionTemplate() {
  ...
  onSelect = noop.useCallback((arg0) => {
    ...
    obj = {
      flow_type: constants2.GUILD_ROLE_CREATION_MODAL,
      from_step: constants4[obj4.STEP_PERMISSIONS],
      to_step: constants4[obj4.STEP_MEMBERS],
      skip: false,
    };
...
function RoleMembers() {
  ...
  const callback1 = noop.useCallback(() => {
    ...
    obj = {
      flow_type: constants2.GUILD_ROLE_CREATION_MODAL,
      from_step: constants4[obj4.STEP_MEMBERS],
...
obj = { marginTop: fn(5732).NAV_BAR_HEIGHT, flexGrow: 1, paddingBottom: nativeDefault.space.PX_16 };
obj.container = obj;
...
export default function GuildSettingsRoleCreateModal() {
  ...
  useMountEffectDefault(() => {
    const obj = {
      ...
      to_step: constants[obj4.STEP_DISPLAY],
      skip: false,
    };
  ...
  return closure_21(stateFromStores(7052).Navigator, obj);
}
