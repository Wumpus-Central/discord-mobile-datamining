          ...
          if (null != selectedRoleId) {
            if (null != role) {
              if (null != guild) {
                ...
                const merged = Object.assign(closure_0(4786).collectGuildAnalyticsMetadata(guild.id));
...
obj = { marginTop: fn(5733).NAV_BAR_HEIGHT, flexGrow: 1, paddingBottom: nativeDefault.space.PX_16 };
obj.container = obj;
...
export default function GuildSettingsRoleCreateModal() {
  ...
  return closure_21(stateFromStores(7073).Navigator, obj);
}
