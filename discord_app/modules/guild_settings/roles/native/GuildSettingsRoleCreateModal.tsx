// === Module 18123: GuildSettingsRoleCreateModal ===
...
function RoleCreateScene() {
  ...
  const callback2 = onSelect.useCallback(() => {
    React6.dismiss();
    ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(16693, dependencyMap.paths), "RoleColorPicker", { color, onSelect });
  }, items3);
