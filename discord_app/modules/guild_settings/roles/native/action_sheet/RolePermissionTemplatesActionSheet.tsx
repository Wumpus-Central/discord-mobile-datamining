...
export default function RolePermissionTemplatesActionSheet(guildId) {
  ...
  const tmp = closure_8();
  let obj2 = {
    header: jsx(BottomSheetTitleHeader.BottomSheetTitleHeader, { title: null }),
    startExpanded: true,
    children: null,
  };
  let obj3 = {
      ...
      onSelect(arg0) {
        ...
        if (closure_0) {
          ...
          obj4.onConfirm = function onConfirm() {
            ...
            closure_1_1(4794).hideActionSheet();
            const obj = closure_1_1(4794);
            const result = closure_0(4520).roleTemplateAppliedToast();
          };
  ...
  obj2.children = (
    <View style={tmp.templateContainer}>
      {jsx(GuildSettingsRoleTemplateDefault, {
        onSelect(arg0) {
          closure_0 = arg0;
          if (closure_0) {
            const obj4 = {
