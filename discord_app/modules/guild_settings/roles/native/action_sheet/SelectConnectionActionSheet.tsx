...
function IdentityApplicationRow(arg0) {
  ...
  if (null == getOrFetchApplicationBatched) {
    ...
    obj[2] = description;
    obj[3] = onPress;
    return closure_6(tmp(5224).TableRow, obj);
  }
}
...
export default function SelectConnectionActionSheet(arg0) {
  ...
  obj = { scrollable: true, header: callback2(require(5246) /* RedesignBottomSheetTitleHeaderBase */.BottomSheetTitleHeader, obj), startExpanded: true, children: null };
  if (num > 0) {
    const obj1 = { children: null };
    const obj2 = { state: null };
    obj2[0] = segmentedControlState;
    obj1[0] = tmp2(tmp3(8764).SegmentedControl, obj2);
  ...
  obj4[1] = callback2(require(5558) /* TableRowGroupTitle */.TableRowGroup, { hasIcons: true, children: tmp15 });
  obj3[0] = callback2(require(5181) /* SafeAreaPaddingView */.SafeAreaPaddingView, obj4);
  items1[1] = callback2(require(5249) /* BottomSheetModal */.BottomSheetScrollView, obj3);
  obj[3] = items1;
  return closure_7(require(5555) /* ActionSheet */.ActionSheet, obj);
};