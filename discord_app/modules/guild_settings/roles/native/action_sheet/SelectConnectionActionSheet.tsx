...
function IdentityApplicationRow(arg0) {
  ...
  if (null == getOrFetchApplicationBatched) {
    ...
    obj[2] = description;
    obj[3] = onPress;
    return closure_6(tmp(5354).TableRow, obj);
  }
}
...
export default function SelectConnectionActionSheet(arg0) {
  ...
  if (num > 0) {
    ...
    obj1[0] = tmp2(tmp3(9064).SegmentedControl, obj2);
  ...
  obj4[1] = callback2(TableRowGroupTitle.TableRowGroup, { hasIcons: true, children: tmp15 });
  obj3[0] = callback2(SafeAreaPaddingView.SafeAreaPaddingView, obj4);
