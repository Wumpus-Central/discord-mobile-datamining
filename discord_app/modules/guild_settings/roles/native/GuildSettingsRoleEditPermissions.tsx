...
export default function GuildSettingsRoleEditPermission(guild) {
  ...
  if (tmp18Result) {
    ...
    const obj2 = {
      onClick() {
          ...
          obj.openLazy(asyncRequireImpl(17719, dependencyMap.paths), "role-permission-templates-" + guild.id + "-" + role.id, obj);
        },
      accessibilityRole: "button"
    };
    obj1.onTemplateOpen = obj2;
    obj.children = intl.format(guild(1114).t.ZhSOBy, obj1);
    tmp18Result = closure_14(guild(4602).Text, obj);
  }
  ...
  if (tmp24) {
    ...
    const obj6 = { Illustration: tmp27(9851).NoResultsAlt, style: null, bodyStyle: null, body: null };
