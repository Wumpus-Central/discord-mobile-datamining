...
let obj = { tintColor: ThemesDefault.colors.INTERACTIVE_TEXT_DEFAULT, backgroundColor: ThemesDefault.colors.BACKGROUND_BASE_LOWEST, borderRadius: 20, padding: 8 };
obj[1] = obj;
let prop = require("Text").TextStyleSheet["text-md/semibold"];
let num;
if (prop != null) {
  num = prop.lineHeight;
}
...
const memoResult = importAllResult.memo(function GuildSettingsRoleItem(guildId) {
  ...
  if (null != onMoveUp) {
    ...
    obj[1] = intl.string(tmp5(onMoveUp[11]).t.Yl8E4h);
    items.push(obj);
  }
  if (null != onMoveDown) {
    obj1 = { name: "movedown", label: null };
    let intl2 = tmp5(onMoveUp[11]).intl;
    obj1[1] = intl2.string(tmp5(onMoveUp[11]).t["5PbXSy"]);
    items.push(obj1);
  }
  ...
  if (sorting) {
    if (!locked) {
      ...
      obj2[1] = intl3.string(tmp5(onMoveUp[11]).t["0dOFq+"]);
      let intl4 = tmp5(onMoveUp[11]).intl;
      obj2[2] = intl4.string(tmp5(onMoveUp[11]).t.BGMUFB);
      obj2[3] = items;
      obj2[4] = tmp11;
      obj2[7] = importDefault(onMoveUp[6]).space.PX_4;
      ...
      if (!tmp15) {
        ...
        obj4[1] = importDefault(onMoveUp[6]).colors.CONTROL_CRITICAL_PRIMARY_TEXT_DEFAULT;
        obj3[0] = callback(tmp5(onMoveUp[16]).TrashIcon, obj4);
        const intl5 = tmp5(onMoveUp[11]).intl;
        const obj5 = { name: null };
        obj5[0] = role.name;
        obj3[1] = intl5.formatToPlainString(tmp5(onMoveUp[11]).t.FiMFTZ, obj5);
        obj3[4] = function handleDeleteRow() {
          importDefault(onMoveUp[10]);
                ...
                if (0 === c1) {
                  if (arg0 === 1) {
                    ...
                    if (closure_1_5) {
                      ...
                      obj1[0] = callback(onMoveUp[12]).putRoleConnectionsConfigurations(closure_1_4, closure_1_0.id, []);
                      return obj1;
                    }
                  }
                } else if (arg0 === 1) {
          ...
          obj[5] = importDefault(onMoveUp[14]).Colors.RED;
          obj.show(obj);
        };
        flag = false;
        flag2 = true;
        tmp16 = obj2;
        const tmp17 = callback(tmp5(onMoveUp[15]).IconButton, obj3);
      }
    ...
    if (null != roleIcon) {
      ...
      if (isEveryoneRole) {
        ...
        obj7[1] = callback(tmp5(onMoveUp[23]).GroupIcon, {});
        let obj8 = obj7;
      } else {
        obj8 = { children: null };
        obj8[0] = roleIcon;
      ...
      obj10[2] = c9;
      obj10[4] = role.name;
      const items2 = [callback(tmp5(onMoveUp[7]).Text, obj10), , ];
      ...
      if (null != prop) {
        ...
        obj11[0] = tmp5(onMoveUp[24]).Icon.Sizes.REFRESH_SMALL_16;
        obj11[1] = importDefault(onMoveUp[25]);
        const intl6 = tmp5(onMoveUp[11]).intl;
        obj11[2] = intl6.string(tmp5(onMoveUp[11]).t.a2Ak8b);
        obj11[3] = tmp4.sparkleIcon;
        tmp30Result = callback(tmp5(onMoveUp[24]).Icon, obj11);
      }
      items2[1] = tmp30Result;
      tmp30Result = null;
      if (locked) {
        tmp30Result = callback(tmp5(onMoveUp[26]).LockIcon, { size: "xxs", color: "icon-subtle" });
      }
      ...
      if (isEveryoneRole) {
        ...
        obj12[0] = "" + numMembers;
        stringResult = intl7.formatToPlainString(tmp5(onMoveUp[11]).t.AWmdd9, obj12);
      }
      obj6[9] = stringResult;
      obj6[10] = isFirstRole;
      obj6[11] = isLastRole;
      return callback(tmp5(onMoveUp[22]).TableRow, obj6);
    } else {
      ...
      if (null === guild_connections1) {
        ...
        obj13[1] = guildId;
        obj13[2] = role;
        let tmp21Result = callback(importDefault(onMoveUp[17]), obj13);
      } else {
        if (tmp3) {
          if (null != role.colors) {
            if (null != role.colors.secondary_color) {
              ...
              const found = items3.filter(tmp5(onMoveUp[19]).isNotNullish);
              obj15[0] = found.map((item, index) => role(onMoveUp[20]).int2hex(item));
              obj15[1] = { x: 0, y: 0 };
              obj15[2] = { x: 1, y: 0 };
              ...
              obj16[1] = tmp4.image;
              items4[1] = callback(tmp5(onMoveUp[21]).ShieldUserIcon, obj16);
              obj14[1] = items4;
              tmp21Result = callback2(closure_5, obj14);
              const tmpResult = importDefault(onMoveUp[18]);
            }
          }
        }
        ...
        obj19[1] = tmp4.image;
        obj17[1] = callback(tmp5(onMoveUp[21]).ShieldUserIcon, obj19);
        tmp21Result = callback(closure_5, obj17);
      }
    }
  }
  flag = false;
  ...
  tmp3 = importDefault(onMoveUp[8])(guildId.guildId, null);
});
const result = require("obj132").fileFinishedImporting("modules/guild_settings/roles/native/GuildSettingsRoleItem.tsx");
