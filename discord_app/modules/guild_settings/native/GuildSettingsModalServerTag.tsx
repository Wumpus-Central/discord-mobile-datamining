    ...
    if (c2) {
      if (closure_12) {
        if (c7) {
          let obj = {
            headerRight: first
              ? () => closure_1_13(guildId(5624).HeaderSubmittingIndicator, {})
              : () => {
  ...
  if (result) {
    if (tmp24) {
      if (null == stateFromStores) {
        ...
        return closure_13(navigation(9208), obj);
