// === Module 14270: ServerTagPreviewActionSheet ===

// Module 14270 (ServerTagPreviewActionSheet)
import nativeDefault from "native" /* 576 */;
import ActionSheetActionCreatorsDefault from "ActionSheetActionCreators" /* 4794 */;
import GuildProfileActionCreators from "GuildProfileActionCreators" /* 9916 */;
import GuildSettingsServerTagPreviewDefault from "GuildSettingsServerTagPreview" /* 14271 */;
import noop from "module_19" /* 19 */;

require = fn;
const View = fn(17).View;
const GuildProfileFetchStatus = fn(9914).GuildProfileFetchStatus;
const jsxProd = fn(21);
...
export default function ServerTagPreviewActionSheet(guildId) {
  ...
  const tmp = closure_8();
  const guildProfile1 = guildId(9915).useGuildProfile(guildId);
  ...
  if (null != guildProfile) {
    ...
    const items1 = [closure_6(tmp2(4823).Text, obj4), ];
    ...
    items1[1] = closure_6(tmp2(5271).Button, obj6);
    obj3.children = items1;
    tmp7 = closure_7(View, obj3);
    tmp8 = closure_6;
  } else {
    tmp7 = closure_6(tmp2(7370).SceneLoadingIndicator, {});
    tmp8 = closure_6;
  }
  ...
  const items2 = [tmp8(guildId(7480).BottomSheetTitleHeader, obj13), tmp7];
  obj7.children = items2;
  return closure_7(guildId(7528).ActionSheet, obj7);
};