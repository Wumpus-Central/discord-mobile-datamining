// === Module 13465: ServerTagPreviewActionSheet ===

// Module 13465 (ServerTagPreviewActionSheet)
import ThemesDefault from "Themes" /* 712 */;
import GuildSettingsServerTagPreviewDefault from "GuildSettingsServerTagPreview" /* 13466 */;
...
export default function ServerTagPreviewActionSheet(guildId) {
  ...
  if (null != guildProfile) {
    ...
    const items1 = [callback(tmp2(4376).Text, obj1), ];
    ...
    items1[1] = callback(tmp2(4815).Button, obj2);
    obj[1] = items1;
    tmp7 = callback2(View, obj);
    tmp8 = callback;
  } else {
    tmp7 = callback(tmp2(5928).SceneLoadingIndicator, {});
    tmp8 = callback;
  }
  ...
  const items2 = [tmp8(guildId(5502).BottomSheetTitleHeader, obj4), tmp7];
  obj3[0] = items2;
  return callback2(guildId(5870).ActionSheet, obj3);
};