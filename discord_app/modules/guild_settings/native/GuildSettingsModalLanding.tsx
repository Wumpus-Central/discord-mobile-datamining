...
function SettingsSection(guild) {
  ...
  obj.icon = closure_15(guild(5824).TableRow.Icon, { IconComponent: guild(4711).CircleInformationIcon });
  obj.onPress = function onPress() {
    return importDefault(constants2.OVERVIEW);
  };
  const items = [closure_15(guild(5824).TableRow, obj, "overview")];
  ...
  if (canManageChannels) {
    ...
    const obj5 = { IconComponent: tmp2(17935).ChannelListIcon };
    obj4.icon = closure_15(tmp2(5824).TableRow.Icon, obj5);
    obj4.onPress = function onPress() {
      guild = GuildSettingsModalChannelsStore.initGuild(guild.id);
      importDefault(constants2.CHANNELS);
    };
    items.push(closure_15(tmp2(5824).TableRow, obj4, "channels"));
  }
  if (!canManageGuild) {
  ...
  if (canManageGuild) {
    ...
    const obj7 = { IconComponent: tmp2(15239).PuzzlePieceIcon };
    obj6.icon = closure_15(tmp2(5824).TableRow.Icon, obj7);
    obj6.onPress = function onPress() {
      return importDefault(constants2.INTEGRATIONS);
    };
    items.push(closure_15(tmp2(5824).TableRow, obj6, "integrations"));
  }
  const obj2 = { IconComponent: guild(4711).CircleInformationIcon };
  if (tmp2Result.canUseMobileServerTagSettings(guild.id)) {
    ...
    const obj9 = { IconComponent: tmp2(9146).TagIcon };
    obj8.icon = closure_15(tmp2(5824).TableRow.Icon, obj9);
    obj8.onPress = function onPress() {
      return importDefault(constants2.TAG);
    };
    items.push(closure_15(tmp2(5824).TableRow, obj8, "server-tag"));
  }
  if (isGuildAdmin) {
    isGuildAdmin = tmp2(17937).canSeeVanityUrlSettings(guild);
    const tmp2Result2 = tmp2(17937);
  }
  if (isGuildAdmin) {
    const obj10 = { label: null, arrow: true, icon: null, onPress: null };
    const intl5 = tmp2(1115).intl;
    obj10.label = intl5.string(tmp2(1115).t["5XZKy/"]);
    const obj11 = { IconComponent: tmp2(4699).LinkIcon };
    obj10.icon = closure_15(tmp2(5824).TableRow.Icon, obj11);
    obj10.onPress = function onPress() {
      return importDefault(constants2.VANITY_URL);
    };
    items.push(closure_15(tmp2(5824).TableRow, obj10, "vanity"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    tmpResult = closure_15(tmp2(5906).TableRowGroup, obj12);
  }
  return tmpResult;
}
function ExpressionSection(pushScreen) {
  ...
  if (pushScreen.canManageGuildExpressions) {
    ...
    const obj2 = { IconComponent: pushScreen(9042).ReactionIcon };
    obj.icon = closure_15(pushScreen(5824).TableRow.Icon, obj2);
    obj.onPress = function onPress() {
      return pushScreen(constants2.EMOJI);
    };
    items.push(closure_15(pushScreen(5824).TableRow, obj, "emoji"));
    ...
    const obj4 = { IconComponent: pushScreen(10376).StickerIcon };
    obj3.icon = closure_15(pushScreen(5824).TableRow.Icon, obj4);
    obj3.onPress = function onPress() {
      return pushScreen(constants2.STICKERS);
    };
    items.push(closure_15(pushScreen(5824).TableRow, obj3, "stickers"));
  }
  if (pushScreen.canConfigureOfficialMessages) {
    ...
    const obj6 = { IconComponent: pushScreen(11997).StampIcon };
    obj5.icon = closure_15(pushScreen(5824).TableRow.Icon, obj6);
    obj5.onPress = function onPress() {
      return pushScreen(constants2.OFFICIAL_MESSAGES);
    };
    items.push(closure_15(pushScreen(5824).TableRow, obj5, "official-messages"));
  }
  let tmp10 = null;
  if (0 !== items.length) {
    ...
    obj7.children = items;
    tmp10 = closure_15(pushScreen(5906).TableRowGroup, obj7);
  }
  return tmp10;
}
function PeopleSection(pushScreen) {
  ...
  obj.icon = closure_15(pushScreen(5824).TableRow.Icon, { IconComponent: pushScreen(5309).GroupIcon });
  obj.onPress = function onPress() {
    return pushScreen(constants2.MEMBERS);
  };
  const items = [closure_15(pushScreen(5824).TableRow, obj, "members")];
  if (canManageRoles) {
    const obj3 = { label: null, arrow: true, icon: null, onPress: null };
    const intl2 = tmp2(1115).intl;
    obj3.label = intl2.string(tmp2(1115).t["LPJmL/"]);
    const obj4 = { IconComponent: tmp2(9846).ShieldUserIcon };
    obj3.icon = closure_15(tmp2(5824).TableRow.Icon, obj4);
    obj3.onPress = function onPress() {
      return pushScreen(constants2.ROLES);
    };
    items.push(closure_15(tmp2(5824).TableRow, obj3, "roles"));
  }
  if (canManageGuild) {
    const obj5 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1115).intl;
    obj5.label = intl3.string(tmp2(1115).t.ngRFjZ);
    const obj6 = { IconComponent: tmp2(4699).LinkIcon };
    obj5.icon = closure_15(tmp2(5824).TableRow.Icon, obj6);
    obj5.onPress = function onPress() {
      return pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(closure_15(tmp2(5824).TableRow, obj5, "invites"));
  }
  const obj7 = { title: null, hasIcons: true, children: null };
  const intl4 = tmp2(1115).intl;
  obj7.title = intl4.string(pushScreen(1115).t.bMAKMK);
  obj7.children = items;
  return closure_15(pushScreen(5906).TableRowGroup, obj7);
}
...
function CommunitySection(pushScreen) {
  ...
  if (!canManageGuild) {
    ...
    if (hasItem) {
      ...
      const obj3 = { IconComponent: pushScreen(10649).AnalyticsIcon };
      obj2.icon = closure_15(pushScreen(5824).TableRow.Icon, obj3);
      obj2.onPress = function onPress() {
        return pushScreen(constants2.ANALYTICS);
      };
      items.push(closure_15(pushScreen(5824).TableRow, obj2, "analytics"));
    }
    let tmp9 = null;
    if (0 !== items.length) {
      ...
      obj4.children = items;
      tmp9 = closure_15(pushScreen(5906).TableRowGroup, obj4);
    }
    return tmp9;
  } else {
    let TreehouseIcon = dependencyMap;
    const TableRow = pushScreen(5824).TableRow;
    const obj = { label: null, arrow: true, icon: null, onPress: null };
    const intl = pushScreen(1115).intl;
    ...
    if (hasItem) {
      ...
      Icon = tmp3(5824).TableRow.Icon;
      const obj5 = { IconComponent: null };
      TreehouseIcon = tmp3(15883).TreehouseIcon;
      ...
      const obj6 = { IconComponent: tmp3(15883).TreehouseIcon };
      obj.icon = closure_15(tmp3(5824).TableRow.Icon, obj6);
      obj.onPress = function onPress() {
...
function GuildSettingsModalLandingInner(guild) {
  ...
  const token = guild(4458).useToken(updateErrors(576).modules.mobile.TABLE_ROW_PADDING);
  ...
  const obj6 = guild(17940);
  const tmp11 = guild(17940).useChannelsAllowedToUnlink(guild.id).length > 0;
  ...
  if (canManageGuildRoleSubscriptions) {
    ...
    tmp17Result = closure_15(tmp3(17941), obj11);
  }
  const obj12 = { children: null };
  items5[6] = tmp17Result;
  obj9.children = items5;
  obj8.children = closure_16(guild(5185).Stack, obj9);
  const items6 = [closure_15(guild(8876).Form, obj8), closure_15(guild(7287).NavScrim, {})];
