...
function SettingsSection(guild) {
  ...
  obj = { IconComponent: guild(4591).CircleInformationIcon };
  obj.icon = closure_15(guild(5686).TableRow.Icon, obj);
  ...
  if (canManageGuild) {
    ...
    const obj1 = { IconComponent: tmp2(17633).ModerationIcon };
    obj.icon = closure_15(tmp2(5686).TableRow.Icon, obj1);
    obj.onPress = function onPress() {
      return importDefault(constants2.MODERATION);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj, "moderation"));
  }
  if (canViewAuditLog) {
    const obj2 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1114).intl;
    obj2.label = intl3.string(tmp2(1114).t.SPWLyT);
    const obj3 = { IconComponent: tmp2(5619).ClipboardListIcon };
    obj2.icon = closure_15(tmp2(5686).TableRow.Icon, obj3);
    obj2.onPress = function onPress() {
      return importDefault(constants2.AUDIT_LOG);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj2, "auditlogs"));
  }
  ...
  if (canManageChannels) {
    ...
    const obj5 = { IconComponent: tmp2(17635).ChannelListIcon };
    obj4.icon = closure_15(tmp2(5686).TableRow.Icon, obj5);
    obj4.onPress = function onPress() {
      guild = GuildSettingsModalChannelsStore.initGuild(guild.id);
      importDefault(constants2.CHANNELS);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj4, "channels"));
  }
  ...
  if (tmp11) {
    ...
    const obj7 = { IconComponent: tmp2(15043).PuzzlePieceIcon };
    obj6.icon = closure_15(tmp2(5686).TableRow.Icon, obj7);
    obj6.onPress = function onPress() {
      return importDefault(constants2.INTEGRATIONS);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj6, "integrations"));
  }
  if (canManageGuildExpressions) {
    ...
    const obj9 = { IconComponent: tmp2(8883).ReactionIcon };
    obj8.icon = closure_15(tmp2(5686).TableRow.Icon, obj9);
    obj8.onPress = function onPress() {
      return importDefault(constants2.EMOJI);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj8, "emoji"));
    ...
    const obj11 = { IconComponent: tmp2(10242).StickerIcon };
    obj10.icon = closure_15(tmp2(5686).TableRow.Icon, obj11);
    obj10.onPress = function onPress() {
      return importDefault(constants2.STICKERS);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj10, "stickers"));
  }
  if (canConfigureOfficialMessages) {
    ...
    const obj13 = { IconComponent: tmp2(11869).StampIcon };
    obj12.icon = closure_15(tmp2(5686).TableRow.Icon, obj13);
    obj12.onPress = function onPress() {
      return importDefault(constants2.OFFICIAL_MESSAGES);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj12, "official-messages"));
  }
  let tmp2Result = tmp2(9196);
  if (tmp2Result.canUseMobileServerTagSettings(guild.id)) {
    ...
    const obj15 = { IconComponent: tmp2(8987).TagIcon };
    obj14.icon = closure_15(tmp2(5686).TableRow.Icon, obj15);
    obj14.onPress = function onPress() {
      return importDefault(constants2.TAG);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj14, "server-tag"));
  }
  if (canManageGuild) {
    ...
    const obj17 = { IconComponent: tmp2(9882).ShieldUserIcon };
    obj16.icon = closure_15(tmp2(5686).TableRow.Icon, obj17);
    obj16.onPress = function onPress() {
      return importDefault(constants2.SECURITY);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj16, "security"));
  }
  if (isGuildAdmin) {
    tmp2Result = tmp2(17637);
  ...
  if (isGuildAdmin) {
    ...
    const obj19 = { IconComponent: tmp2(4579).LinkIcon };
    obj18.icon = closure_15(tmp2(5686).TableRow.Icon, obj19);
    obj18.onPress = function onPress() {
      return importDefault(constants2.VANITY_URL);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj18, "vanity"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    tmpResult = closure_15(tmp2(5768).TableRowGroup, obj20);
  }
  return tmpResult;
}
function CommunitySection(pushScreen) {
  ...
  if (hasItem) {
    ...
    obj = { IconComponent: tmp3(15678).TreehouseIcon };
    obj.icon = closure_15(tmp3(5686).TableRow.Icon, obj);
    obj.onPress = function onPress() {
    ...
    const obj1 = { IconComponent: tmp3(15678).TreehouseIcon };
    obj.icon = closure_15(tmp3(5686).TableRow.Icon, obj1);
    obj.onPress = function onPress() {
...
function UserManagementSection(pushScreen) {
  ...
  obj = { IconComponent: pushScreen(5170).GroupIcon };
  obj.icon = closure_15(pushScreen(5686).TableRow.Icon, obj);
  obj.onPress = function onPress() {
  ...
  if (canManageRoles) {
    ...
    const obj1 = { IconComponent: tmp2(9882).ShieldUserIcon };
    obj.icon = closure_15(tmp2(5686).TableRow.Icon, obj1);
    obj.onPress = function onPress() {
      return pushScreen(constants2.ROLES);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj, "roles"));
  }
  if (canManageGuild) {
    const obj2 = { label: null, arrow: true, icon: null, onPress: null };
    const intl3 = tmp2(1114).intl;
    obj2.label = intl3.string(tmp2(1114).t.ngRFjZ);
    const obj3 = { IconComponent: tmp2(4579).LinkIcon };
    obj2.icon = closure_15(tmp2(5686).TableRow.Icon, obj3);
    obj2.onPress = function onPress() {
      return pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj2, "invites"));
  }
  if (canManageBans) {
    const obj4 = { label: null, arrow: true, icon: null, onPress: null };
    const intl4 = tmp2(1114).intl;
    obj4.label = intl4.string(tmp2(1114).t.ZbeITS);
    const obj5 = { IconComponent: tmp2(9563).HammerIcon };
    obj4.icon = closure_15(tmp2(5686).TableRow.Icon, obj5);
    obj4.onPress = function onPress() {
      return pushScreen(constants2.BANS);
    };
    items.push(closure_15(tmp2(5686).TableRow, obj4, "bans"));
  }
  let tmpResult = null;
  if (0 !== items.length) {
    ...
    obj6.children = items;
    tmpResult = closure_15(tmp2(5768).TableRowGroup, obj6);
  }
  return tmpResult;
}
function GuildSettingsModalLandingInner(guild) {
  ...
  const items5 = [closure_15(updateErrors(16964), obj1), closure_15(SettingsSection, { guild, categories: stateFromStores, isGuildAdmin, canManageGuild, canManageGuildExpressions, canManageChannels, canUnlinkChannelLobbies: tmp11, canViewAuditLog, canManageWebhooks, canConfigureOfficialMessages: result, pushScreen: callback }), , , ];
  ...
  if (canManageGuildRoleSubscriptions) {
    ...
    tmp17Result = closure_15(tmp3(17639), obj3);
  }
  obj4 = { children: null };
  ...
  obj.children = items5;
  obj.children = closure_16(guild(5054).Stack, obj);
  const items6 = [closure_15(guild(8716).Form, obj), closure_15(guild(7143).NavScrim, {})];
