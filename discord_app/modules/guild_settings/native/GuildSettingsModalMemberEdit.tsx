...
RolesList.prototype["render"] = function render() {
  ...
  if (props.isEditing) {
    ...
    const found = require("../../../../_runtime/metro/00012__.js")(sortedGuildRoles).filter(
      (item) => !isEveryoneRole(item),
    );
    ...
    const arr4 = require("../../../../_runtime/metro/00012__.js")(sortedGuildRoles);
    let valueResult = found2
      .map((id) => {
        ...
        const obj = {
          checked: tmp,
          label: closure_1_18(require("RoleName"), {
            role: id,
  ...
  constructor() {
    ...
    applyArgumentsResult.handleSaveNickname = function handleSaveNickname() {
      if (null != applyArgumentsResult.state.nick) {
        ...
        GuildSettingsModalMembersActionCreatorsDefault.changeNickname(
    ...
    applyArgumentsResult.handleStartEditingRoles = function handleStartEditingRoles() {
      GuildSettingsModalMembersActionCreatorsDefault.startEditingRoles(
        applyArgumentsResult.props.guild.id,
    ...
    applyArgumentsResult.handleSaveMemberRoles = function handleSaveMemberRoles() {
      if (null != applyArgumentsResult.props.editRoles) {
        GuildSettingsModalMembersActionCreatorsDefault.updateMemberRoles(
          applyArgumentsResult.props.guild.id,
          applyArgumentsResult.props.user.id,
          applyArgumentsResult.props.editRoles,
        );
      }
    };
...
prototype["updateNavigator"] = function updateNavigator(submitting) {
  ...
  tmp =
    ...
    isEditing === submitting.isEditing &&
