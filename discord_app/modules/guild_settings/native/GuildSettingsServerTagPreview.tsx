...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  const items4 = [
    closure_10(closure_6, { source: onAdopted(9619), style: tmp.avatar, importantForAccessibility: "no" }),
  ];
  const obj8 = { style: tmp.messageBody, children: null };
  const items5 = [
    closure_10(guildId(4832).Text, { variant: "text-md/semibold", color: "text-default", children: "Locke" }),
  ];
  ...
  const items8 = [
    closure_10(guildId(4832).Text, { variant: "text-md/semibold", color: "text-default", children: name }),
  ];
  ...
  const items12 = [
    closure_10(guildId(4832).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }),
  ];
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result4 = closure_10(tmp2(5919).Card, obj23);
  }
  return tmp15Result4;
}
