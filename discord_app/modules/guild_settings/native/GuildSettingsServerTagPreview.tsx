...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  const items8 = [
    closure_10(guildId(4570).Text, { variant: "text-md/semibold", color: "text-default", children: name }),
  ];
  ...
  if (tmp15Result) {
    ...
    if (null != badge) {
      ...
      tmp15Result = closure_10(tmp2(13941).GuildBadge, size);
    }
    obj9.guildBadge = tmp15Result;
    tmp15Result = closure_10(tmp2(9216).BaseGuildTagChiplet, obj9);
  }
  ...
  items9[1] = closure_10(guildId(4570).Text, obj10);
  ...
  const items11 = [
    closure_10(closure_6, { source: onAdopted(13985), style: tmp.avatar, importantForAccessibility: "no" }),
  ];
  const obj13 = { style: tmp.messageBody, children: null };
  const items12 = [
    closure_10(guildId(4570).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }),
  ];
  ...
  items12[1] = closure_10(guildId(4570).Text, obj14);
  ...
  items6[3] = closure_10(guildId(4989).Button, obj15);
  obj.children = items6;
  items2[1] = closure_11(guildId(4987).Stack, obj);
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result1 = closure_10(tmp2(5621).Card, obj17);
  }
  return tmp15Result1;
}
