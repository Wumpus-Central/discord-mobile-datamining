...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  const items4 = [
    closure_10(closure_6, { source: onAdopted(10416), style: tmp.avatar, importantForAccessibility: "no" }),
  ];
  const obj8 = { style: tmp.messageBody, children: null };
  const items5 = [
    closure_10(guildId(4752).Text, { variant: "text-md/semibold", color: "text-default", children: "Locke" }),
  ];
  ...
  const items8 = [
    closure_10(guildId(4752).Text, { variant: "text-md/semibold", color: "text-default", children: name }),
  ];
  ...
  const items11 = [
    closure_10(closure_6, { source: onAdopted(14228), style: tmp.avatar, importantForAccessibility: "no" }),
  ];
  const obj19 = { style: tmp.messageBody, children: null };
  const items12 = [
    closure_10(guildId(4752).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }),
  ];
