...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  const items8 = [
    closure_10(guildId(4602).Text, { variant: "text-md/semibold", color: "text-default", children: name }),
  ];
  ...
  if (tmp15Result) {
    ...
    tmp15Result = closure_10(tmp2(9274).BaseGuildTagChiplet, obj9);
  }
  ...
  items9[1] = closure_10(guildId(4602).Text, obj10);
  ...
  const items12 = [
    closure_10(guildId(4602).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }),
  ];
  ...
  items12[1] = closure_10(guildId(4602).Text, obj14);
  ...
  items6[3] = closure_10(guildId(5026).Button, obj15);
  obj.children = items6;
  items2[1] = closure_11(guildId(5024).Stack, obj);
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result1 = closure_10(tmp2(5658).Card, obj17);
  }
  return tmp15Result1;
}
