...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  const items4 = [
    closure_10(closure_6, { source: onAdopted(10399), style: tmp.avatar, importantForAccessibility: "no" }),
  ];
  const obj8 = { style: tmp.messageBody, children: null };
  const items5 = [
    closure_10(guildId(4718).Text, { variant: "text-md/semibold", color: "text-default", children: "Locke" }),
  ];
  ...
  const items8 = [
    closure_10(guildId(4718).Text, { variant: "text-md/semibold", color: "text-default", children: name }),
  ];
  ...
  if (tmp15Result3) {
    ...
    if (null != badge) {
      ...
      tmp15Result = closure_10(tmp2(14124).GuildBadge, size);
    }
    obj14.guildBadge = tmp15Result;
    tmp15Result3 = closure_10(tmp2(9422).BaseGuildTagChiplet, obj14);
  }
  ...
  const items11 = [
    closure_10(closure_6, { source: onAdopted(14168), style: tmp.avatar, importantForAccessibility: "no" }),
  ];
  const obj19 = { style: tmp.messageBody, children: null };
  const items12 = [
    closure_10(guildId(4718).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }),
  ];
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result4 = closure_10(tmp2(5777).Card, obj23);
  }
  return tmp15Result4;
}
