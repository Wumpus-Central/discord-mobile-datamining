...
export default function GuildSettingsServerTagPreview(guildId) {
  ...
  const items4 = [
    closure_10(closure_6, { source: onAdopted(10297), style: tmp.avatar, importantForAccessibility: "no" }),
  ];
  const obj8 = { style: tmp.messageBody, children: null };
  const items5 = [
    closure_10(guildId(4634).Text, { variant: "text-md/semibold", color: "text-default", children: "Locke" }),
  ];
  ...
  const items8 = [
    closure_10(guildId(4634).Text, { variant: "text-md/semibold", color: "text-default", children: name }),
  ];
  ...
  if (tmp15Result3) {
    ...
    if (null != badge) {
      ...
      tmp15Result = closure_10(tmp2(14021).GuildBadge, size);
    }
    obj14.guildBadge = tmp15Result;
    tmp15Result3 = closure_10(tmp2(9327).BaseGuildTagChiplet, obj14);
  }
  ...
  const items11 = [
    closure_10(closure_6, { source: onAdopted(14065), style: tmp.avatar, importantForAccessibility: "no" }),
  ];
  const obj19 = { style: tmp.messageBody, children: null };
  const items12 = [
    closure_10(guildId(4634).Text, { variant: "text-md/semibold", color: "text-default", children: "Phibi" }),
  ];
  ...
  if ("plain" !== variant) {
    ...
    tmp15Result4 = closure_10(tmp2(5693).Card, obj23);
  }
  return tmp15Result4;
}
