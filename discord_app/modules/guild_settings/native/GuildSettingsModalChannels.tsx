...
import _modDef12047 from "../../../../_runtime/metro/12047__.js";
import _modDef15508 from "../../../../_runtime/metro/15508__.js";
...
function ChannelItem(isFavoritesGuild) {
  ...
  if (null != channelIconComponent) {
    ...
    tmp7Result = closure_16(channel(8831).FormRow.Icon, obj8);
  }
  const obj9 = {
    leading: tmp7Result,
  ...
  if (stateFromStores) {
    ...
    if (sortingEnabled) {
      ...
      tmp7Result2 = closure_16(channel(8831).FormRow.Icon, obj10);
    }
  }
...
obj2.floatingActionButtonContainer = {
  position: "absolute",
  bottom: 16,
  right: 0,
  left: 0,
  ...
  constructor() {
    ...
    applyArgumentsResult.handleSortStart = function handleSortStart() {
      ...
      obj2.onPress = function onPress() {
        closure_1_1(16401).startReordering(
                          ...
                          if (PermissionStore.can(constants2.MANAGE_ROLES, localChannel)) {
                            if (PermissionStore.can(constants2.MANAGE_ROLES, channel)) {
                              const appChannelBotUserId =
                                applyArgumentsResult(11850).getAppChannelBotUserId(localChannel);
