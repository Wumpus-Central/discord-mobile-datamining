...
import _modDef16551 from "../../../../_runtime/metro/16551__.js";
...
function ChannelItem(isFavoritesGuild) {
  ...
  if (null != channelIconComponent) {
    ...
    tmp7Result = closure_16(channel(8947).FormRow.Icon, obj8);
  }
  const obj9 = {
    leading: tmp7Result,
  ...
  if (stateFromStores) {
    ...
    if (sortingEnabled) {
      ...
      tmp7Result2 = closure_16(channel(8947).FormRow.Icon, obj10);
    }
  }
  ...
  constructor() {
    ...
    applyArgumentsResult.handleSortStart = function handleSortStart() {
      ...
      obj2.onPress = function onPress() {
        closure_1_1(16546).startReordering(
                          ...
                          if (PermissionStore.can(constants2.MANAGE_ROLES, localChannel)) {
                            if (PermissionStore.can(constants2.MANAGE_ROLES, channel)) {
                              const appChannelBotUserId =
                                applyArgumentsResult(11941).getAppChannelBotUserId(localChannel);
