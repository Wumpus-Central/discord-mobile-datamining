...
import ChannelSettingsActionCreators from "ChannelSettingsActionCreators" /* 8630 */;
                        ...
                        if (null != channel) {
                          if (PermissionStore.can(constants2.MANAGE_ROLES, localChannel)) {
                            if (PermissionStore.can(constants2.MANAGE_ROLES, channel)) {
                              const appChannelBotUserId = applyArgumentsResult(11615).getAppChannelBotUserId(localChannel);
