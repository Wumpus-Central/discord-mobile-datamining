...
let obj = { marginRight: ThemesDefault.space.PX_4 };
obj[1] = obj;
const createCacheKey = { color: ThemesDefault.colors.INTERACTIVE_TEXT_DEFAULT, fontSize: 12 };
...
const memoResult = importAllResult.memo((height) => {
  ...
  if (nickname == null) {
    nickname = nameFromUserDefault.getGlobalName(user);
    const tmp2Result = nameFromUserDefault;
  }
  ...
  if (hasAvatarForGuildResult) {
    ...
    if (hasAvatarForGuildResult) {
      ...
      obj1[2] = user;
      tmp8Result = callback(Button.Avatar, obj1);
    }
    const items1 = [tmp8Result, ];
    const obj2 = { user: null, usernameStyle: null, hideBotTag: true };
    obj2[0] = user;
    obj2[1] = tmp.mainTag;
    items1[1] = callback(DiscordTagDefault, obj2);
    obj[1] = items1;
...
const memoResult1 = importAllResult.memo(function DetailedGuildIdentityUserRow(arrow) {
  ...
  if (null == stateFromStores) {
    ...
    if (leading == null) {
      ...
      SMALL = Button.AvatarSizes.SMALL;
      disabled[1] = SMALL;
      leading = callback(Button.Avatar, disabled);
    }
    obj[2] = leading;
    leading = closure_8;
    ...
    obj[2] = guildId;
    obj[3] = callback(closure_8, obj);
    obj[4] = onPress;
    obj[5] = subLabel;
    obj[6] = trailing;
    obj[7] = accessibilityRole;
    obj[8] = accessibilityState;
    let tmp2Result = callback(Form.FormRow, obj);
  } else {
    ...
    if (leading == null) {
      ...
      obj2[1] = Button.AvatarSizes.SMALL;
      tmp2Result = callback(Button.Avatar, obj2);
    }
    obj1[4] = tmp2Result;
    ...
    obj3[2] = guildId;
    obj1[5] = callback(closure_8, obj3);
    obj1[6] = onPress;
    obj1[7] = start;
    obj1[8] = subLabel;
    obj1[9] = trailing;
    ...
    tmp2Result = callback(TableRowInner.TableRow, obj1);
  }
});
const result = require("obj132").fileFinishedImporting("modules/guild_settings/native/DetailedGuildIdentityUserRow.tsx");
