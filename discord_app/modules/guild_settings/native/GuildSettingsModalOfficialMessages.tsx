...
createStyles.segmentedControlContainer = { gap: nativeDefault.space.PX_16, alignItems: "center", paddingHorizontal: nativeDefault.space.PX_16, marginBottom: nativeDefault.space.PX_16 };
...
export default function GuildSettingsModalOfficialMessages(guildId) {
  ...
  obj = { bgBaseLow: closure_15(activeIndex), borderStrong: closure_16(activeIndex), textStrong: closure_17(activeIndex), textMuted: closure_18(activeIndex) };
  ...
  const obj3 = { style: tmp.trailingColorContainer, children: closure_12(navigation(submitting[28]), { color: officialMessageColor, style: tmp.colorBlock }) };
  ...
  const items7 = [closure_12(guildId(submitting[30]).Text, obj6), closure_12(MessagePreview, { animatedStyles: obj, selectedColor: officialMessageColor, theme: memo[tmp9].id }), ];
