...
import closure_8 from "initialize" /* 17110 */;
...
let closure_15 = importDefaultResult.memoize((arr, stateFromStores) => {
  ...
  const maxEmojiSlots = _require(4339).getMaxEmojiSlots(stateFromStores);
  const obj2 = _require(4339);
