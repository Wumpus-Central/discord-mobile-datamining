...
export default function GuildSettingsServerTagUpsellCard(guildId) {
  ...
  obj = { style: tmp.backgroundLayer, colors: null, locations: [0, 0.7], start: { x: 0.5, y: 0 }, end: { x: 0.5, y: 1 }, pointerEvents: "none" };
  const items3 = ["rgba(41, 41, 45, 0)", c12];
  obj.colors = items3;
  const items4 = [closure_6(LinearGradientDefault, obj), closure_6(LinearGradientDefault, { style: tmp.backgroundLayer, colors, start, end, pointerEvents: "none" }), closure_6(LinearGradientDefault, { style: tmp.backgroundLayer, colors: colors2, start, end, pointerEvents: "none" }), ];
  ...
  const items6 = [closure_6(guildId(4632).Text, obj7), ];
  ...
  items6[1] = closure_6(guildId(4632).Text, obj8);
  obj6.children = items6;
  items5[1] = closure_7(guildId(5054).Stack, obj6);
  ...
  obj9.icon = closure_6(guildId(16313).BoostTier2Icon, { color: "white" });
  obj9.onPress = guildId.onUnlockPress;
  items5[2] = closure_6(guildId(5056).Button, obj9);
  obj3.children = items5;
  items4[3] = closure_7(guildId(5054).Stack, obj3);
  obj.children = items4;
