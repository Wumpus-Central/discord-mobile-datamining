...
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  if (hasFlagResult) {
    ...
    hasFlagResult = closure_1_19(tmp(7307).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = closure_1_19(tmp(7307).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = closure_1_19(tmp(7307).TableSwitchRow, obj10);
    const tmpResult22 = tmp(1385);
  }
  items[7] = result1;
  obj2.children = items;
  return closure_1_20(tmp(5772).TableRowGroup, obj2);
};
