// === Module 17266: GuildSettingsModalOverview ===
...
import GuildProfileLimits from "GuildProfileLimits" /* 5856 */;
...
import AssetChooserDefault from "AssetChooser" /* 17267 */;
...
const GuildChannelStore = fn(4464);
...
class GuildSettingsModalOverview extends PureComponent {
  constructor() {
    ...
    applyArgumentsResult.handleAFKTimeoutChange = function handleAFKTimeoutChange() {
      const obj = applyArgumentsResult(6610);
...
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj4.trailing = closure_1_20(tmp4(5912).TableRow.TrailingText, { text: channelName });
  obj4.onPress = self.handleAfkChannelChange;
  const items = [closure_1_20(tmp4(5912).TableRow, obj4), ];
  ...
  obj5.disabled = tmp15;
  obj5.trailing = closure_1_20(tmp4(5912).TableRow.TrailingText, { text: labelResult });
  obj5.onPress = self.handleAFKTimeoutChange;
  items[1] = closure_1_20(tmp4(5912).TableRow, obj5);
  obj3.children = items;
  return __initData(tmp4(5994).TableRowGroup, obj3);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  const result = tmp(7429).isEligibleForRoleSubscriptionPurchaseSystemMessageSettings(guild);
  ...
  const tmpResult = tmp(7429);
  let result1 = tmp(17087).isPastVcActivityMessagesEnabled(guild.id, "GuildSettingsModalOverview");
  if (!result1) {
  ...
  const tmpResult15 = tmp(17087);
  let guildSpaceExperimentEnabled = tmp(6641).getGuildSpaceExperimentEnabled(guild.id, "GuildSettingsModalOverview");
  ...
  items[1] = closure_1_20(tmp(6616).TableSwitchRow, obj4);
  ...
  items[2] = closure_1_20(tmp(6616).TableSwitchRow, obj5);
  ...
  items[3] = closure_1_20(tmp(6616).TableSwitchRow, obj6);
  ...
  items[4] = closure_1_20(tmp(6616).TableSwitchRow, obj7);
  if (hasFlagResult) {
    ...
    hasFlagResult = closure_1_20(tmp(6616).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = closure_1_20(tmp(6616).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    result1 = closure_1_20(tmp(6616).TableSwitchRow, obj10);
  ...
  if (guildSpaceExperimentEnabled) {
    ...
    guildSpaceExperimentEnabled = closure_1_20(tmp(5912).TableRow, obj11);
  }
  items[8] = guildSpaceExperimentEnabled;
  obj2.children = items;
  return __initData(tmp(5994).TableRowGroup, obj2);
};
...
GuildSettingsModalOverview.contextType = fn(4537).ThemeContext;
const size = fn(2);
