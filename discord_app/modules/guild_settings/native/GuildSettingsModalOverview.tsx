...
import MobileBoostProgressBarExperiment from "MobileBoostProgressBarExperiment" /* 16190 */;
...
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj.trailing = closure_1_19(tmp4(5619).TableRow.TrailingText, { text: channelName });
  obj.onPress = self.handleAfkChannelChange;
  const items = [closure_1_19(tmp4(5619).TableRow, obj), ];
  ...
  obj1.disabled = tmp15;
  obj1.trailing = closure_1_19(tmp4(5619).TableRow.TrailingText, { text: labelResult });
  obj1.onPress = self.handleAFKTimeoutChange;
  items[1] = closure_1_19(tmp4(5619).TableRow, obj1);
  obj.children = items;
  return closure_1_20(tmp4(5701).TableRowGroup, obj);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  if (!result) {
    tmpResult = tmp(1384);
    hasFlagResult = tmpResult.hasFlag(guild.systemChannelFlags, constants5.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATIONS);
  }
  ...
  obj.disabled = !canManage;
  obj.trailing = closure_1_19(tmp(5619).TableRow.TrailingText, { text: channelName });
  obj.onPress = self.handleSystemChannelChange;
  const items = [closure_1_19(tmp(5619).TableRow, obj), , , , , , , ];
  ...
  items[1] = closure_1_19(tmp(7214).TableSwitchRow, obj1);
  ...
  items[2] = closure_1_19(tmp(7214).TableSwitchRow, obj2);
  ...
  items[3] = closure_1_19(tmp(7214).TableSwitchRow, obj3);
  ...
  items[4] = closure_1_19(tmp(7214).TableSwitchRow, obj4);
  if (hasFlagResult) {
    ...
    hasFlagResult = closure_1_19(tmp(7214).TableSwitchRow, obj5);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = closure_1_19(tmp(7214).TableSwitchRow, obj6);
  ...
  if (result1) {
    ...
    result1 = closure_1_19(tmp(7214).TableSwitchRow, obj7);
    const tmpResult10 = tmp(1384);
  }
  items[7] = result1;
  obj.children = items;
  return closure_1_20(tmp(5701).TableRowGroup, obj);
};
