...
import MobileBoostProgressBarExperiment from "MobileBoostProgressBarExperiment" /* 16239 */;
...
prototype["renderAFKSettings"] = function renderAFKSettings() {
  ...
  obj.trailing = closure_1_19(tmp4(5655).TableRow.TrailingText, { text: channelName });
  obj.onPress = self.handleAfkChannelChange;
  const items = [closure_1_19(tmp4(5655).TableRow, obj), ];
  ...
  obj1.disabled = tmp15;
  obj1.trailing = closure_1_19(tmp4(5655).TableRow.TrailingText, { text: labelResult });
  obj1.onPress = self.handleAFKTimeoutChange;
  items[1] = closure_1_19(tmp4(5655).TableRow, obj1);
  obj.children = items;
  return closure_1_20(tmp4(5737).TableRowGroup, obj);
};
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  obj.disabled = !canManage;
  obj.trailing = closure_1_19(tmp(5655).TableRow.TrailingText, { text: channelName });
  obj.onPress = self.handleSystemChannelChange;
  const items = [closure_1_19(tmp(5655).TableRow, obj), , , , , , , ];
  ...
  items[1] = closure_1_19(tmp(7252).TableSwitchRow, obj1);
  ...
  items[2] = closure_1_19(tmp(7252).TableSwitchRow, obj2);
  ...
  items[3] = closure_1_19(tmp(7252).TableSwitchRow, obj3);
  ...
  items[4] = closure_1_19(tmp(7252).TableSwitchRow, obj4);
  if (hasFlagResult) {
    ...
    hasFlagResult = closure_1_19(tmp(7252).TableSwitchRow, obj5);
  ...
  if (hasFlagResult1) {
    ...
    hasFlagResult1 = closure_1_19(tmp(7252).TableSwitchRow, obj6);
  ...
  if (result1) {
    ...
    result1 = closure_1_19(tmp(7252).TableSwitchRow, obj7);
    const tmpResult10 = tmp(1384);
  }
  items[7] = result1;
  obj.children = items;
  return closure_1_20(tmp(5737).TableRowGroup, obj);
};
