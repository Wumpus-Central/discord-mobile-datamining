...
prototype["renderSystemMessageSettings"] = function renderSystemMessageSettings() {
  ...
  if (hasFlagResult) {
    ...
    obj8.value = !tmp(1384).hasFlag(guild.systemChannelFlags, constants5.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATIONS);
    obj8.onValueChange = self.handleSystemGuildRoleSubscriptionPurchaseMessages;
    hasFlagResult = closure_1_19(tmp(7303).TableSwitchRow, obj8);
  ...
  if (hasFlagResult1) {
    ...
    obj9.value = !tmp(1384).hasFlag(guild.systemChannelFlags, constants5.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATION_REPLIES);
    obj9.onValueChange = self.handleSystemGuildRoleSubscriptionPurchaseMessageReplies;
    hasFlagResult1 = closure_1_19(tmp(7303).TableSwitchRow, obj9);
  ...
  if (result1) {
    ...
    obj10.value = !tmp(1384).hasFlag(guild.systemChannelFlags, constants5.SUPPRESS_VOICE_SESSION_NOTIFICATIONS);
    obj10.onValueChange = self.handleSystemVoiceSessionMessages;
    result1 = closure_1_19(tmp(7303).TableSwitchRow, obj10);
    const tmpResult22 = tmp(1384);
  }
  items[7] = result1;
  obj2.children = items;
  return closure_1_20(tmp(5768).TableRowGroup, obj2);
};
