...
const memoResult = require("noop").memo((guildId) => {
  ...
  return jsx(importDefault(require("../../guild_member_verification/canReviewGuildMemberApplications.tsx") /* canReviewGuildMemberApplications */.useCanReviewGuildMemberApplications(guildId) ? 15558 : 15560), { guildId });
});
