// === Module 18105: GuildSettingsServerTagBadgeGrid ===

// Module 18105 (GuildSettingsServerTagBadgeGrid)
import nativeDefault from "native" /* 576 */;
import openGuildPowerupsModalDefault from "openGuildPowerupsModal" /* 12819 */;
import useGuildTagBadgeCollectionDefault from "useGuildTagBadgeCollection" /* 18106 */;
import GuildSettingsServerTagPickerCellDefault from "GuildSettingsServerTagPickerCell" /* 18107 */;
import getGuildTagBadgeLabelDefault from "getGuildTagBadgeLabel" /* 18108 */;
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  const items1 = [closure_7(guildId(4823).Text, obj2), , ];
  ...
  items1[1] = closure_7(closure_5, {
    ...
    children: unlockedBadges.map((badge) => {
      ...
      obj.children = closure_1_7(guildId(14273).GuildBadge, size);
  ...
  if (tmp6Result) {
    ...
    obj5.children = substr.map((badge) => {
      ...
      return closure_1_7(guildId(14273).GuildBadge, size, badge.kind);
    });
    ...
    items2[1] = closure_7(tmp7(4823).Text, obj6);
    const obj7 = { size: "md", color: nativeDefault.colors.ICON_SUBTLE };
    items2[2] = closure_7(tmp7(7540).ChevronSmallRightIcon, obj7);
    obj4.children = items2;
    tmp6Result = closure_8(closure_4, obj4);
  }
  items1[2] = tmp6Result;
  obj.children = items1;
  return closure_8(guildId(5269).Stack, obj);
};