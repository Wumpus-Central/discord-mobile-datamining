// === Module 17356: GuildSettingsServerTagBadgeGrid ===

// Module 17356 (GuildSettingsServerTagBadgeGrid)
import nativeDefault from "native" /* 576 */;
import openGuildPowerupsModalDefault from "openGuildPowerupsModal" /* 11957 */;
import useGuildTagBadgeCollectionDefault from "useGuildTagBadgeCollection" /* 17357 */;
import GuildSettingsServerTagPickerCellDefault from "GuildSettingsServerTagPickerCell" /* 17358 */;
import getGuildTagBadgeLabelDefault from "getGuildTagBadgeLabel" /* 17359 */;
...
export default function GuildSettingsServerTagBadgeGrid(guildId) {
  ...
  const items1 = [closure_7(guildId(4825).Text, obj2), , ];
