...
function HeaderRow(guild) {
            ...
            if (arg0 === 1) {
              ...
              if (null != base64) {
                upload = function upload(image, originalMd5, roles) {
                  ...
                  const uploadEmojiResult = closure_1_0(10465).uploadEmoji({
                    guildId: image.id,
                    image,
                    name: combined,
                    roles,
                  ...
                  closure_1_0(10465)
                    ...
                    .then(() =>
                      closure_2_1(1240).track(constants.EMOJI_UPLOAD_COMPLETED, { guild_id: image.id, upload_id }),
                    )
                    .catch((error) => {
  ...
  if (canCreateExpressions) {
    ...
    canCreateExpressions = closure_14(tmp7(5056).Button, obj8);
  }
  ...
  if (tmp13Result) {
    ...
    tmp13Result = closure_14(tmp7(4632).Text, obj9);
  }
  const obj10 = { children: null };
  items1[1] = tmp13Result;
  let obj11 = { style: tmp.uploadInstructionsContainer, children: null };
  const items2 = [
    closure_14(guild(4632).Text, { variant: "text-sm/medium", color: "text-muted", children: description }),
    ,
  ];
  ...
  items2[2] = closure_14(c7, {
    ...
    renderItem: function renderUploadInstructionsListItem(item) {
      item = item.item;
      const obj = {
        style: uploadListItem.uploadListItem,
  ...
  return closure_14(closure_15, obj10);
}
