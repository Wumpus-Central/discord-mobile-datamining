...
function HeaderRow(guild) {
            ...
            if (arg0 === 1) {
              ...
              if (null != base64) {
                upload = function upload(image, originalMd5, roles) {
                  ...
                  const uploadEmojiResult = closure_1_0(10594).uploadEmoji({
                    guildId: image.id,
                    image,
                    name: combined,
                    roles,
  ...
  if (canCreateExpressions) {
    ...
    canCreateExpressions = closure_14(tmp7(5186).Button, obj8);
  }
  ...
  if (tmp13Result) {
    ...
    tmp13Result = closure_14(tmp7(4752).Text, obj9);
  }
  const obj10 = { children: null };
  items1[1] = tmp13Result;
  let obj11 = { style: tmp.uploadInstructionsContainer, children: null };
  const items2 = [
    closure_14(guild(4752).Text, { variant: "text-sm/medium", color: "text-muted", children: description }),
    ,
  ];
