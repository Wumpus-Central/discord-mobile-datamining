...
prototype["renderTitle"] = function renderTitle() {
  ...
  if (null == changeTitle) {
    ...
    obj[0] = tmp.title;
    let intl = _require(tmp2[18]).intl;
    ...
    obj[2] = function userHook() {
      ...
      if (null != user) {
        ...
        if (!hasUniqueUsernameResult) {
          ...
          tmp22 = closure_1_14(lib(target[20]).LegacyText, obj);
        }
        ...
        if (name == null) {
          const intl2 = lib(target[18]).intl;
          name = intl2.string(lib(target[18]).t["n+olu7"]);
        }
            ...
            if (log.action === closure_1_12.INVITE_CREATE) {
              ...
              if (null == tmp19Result) {
                ...
                obj2[5] = function newColorsHook(arg0, arg1) {
                  let obj = { style: closure_1_2.colorsHook, children: null };
                  let items = [, , ];
                ...
                obj2[7] = function oldTagHook(arg0, arg1) {
                  return closure_2_14(lib(log[27]).AppliedForumTagPill, { tag: closure_0, containerStyle: closure_1_2.forumTag, disableEndMargin: true }, arg1);
                };
                obj2[8] = function newTagHook(arg0, arg1) {
                  return closure_2_14(lib(log[27]).AppliedForumTagPill, { tag: newValue, containerStyle: closure_1_2.forumTag, disableEndMargin: true }, arg1);
                };
                ...
                if (null == formatResult) {
                  ...
                  obj7[0] = lib.changeItemTextContainer;
