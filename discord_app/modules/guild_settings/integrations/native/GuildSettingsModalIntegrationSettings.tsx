// === Module 18111: GuildSettingsModalIntegrationSettings ===
...
import _modDef18113 from "module_18113" /* 18113 */;
...
function ForceSyncIcon(isSyncing) {
  if (isSyncing.isSyncing) {
    ...
    obj.onPress = tmp;
    const obj2 = { source: _modDef18113 };
...
GuildSettingsModalIntegrationSettings.prototype["render"] = function render() {
  ...
  if (null != tmp) {
    ...
    obj.trailing = closure_7(integration(4823).Text, obj2);
    const tmp2 = closure_7(integration(5908).TableRow, obj);
  }
  ...
  value = self(5586).get(integration.type);
  if (null == value) {
    const _Object = Object;
    const values = Object.values(tmp12(18112).IntegrationExpireGracePeriodTypes);
    ...
    obj7.children = closure_7(tmp15(5908).TableRow, obj8);
    const items1 = [closure_7(tmp15(5990).TableRowGroup, obj7), , , , ];
    ...
    const obj12 = { datetime: tmp16(4414)(integration.synced_at).calendar() };
    ...
    const items2 = [closure_7(tmp15(5908).TableRow, obj10), tmp2];
    obj9.children = items2;
    items1[1] = closure_8(tmp15(5990).TableRowGroup, obj9);
    ...
    const obj17 = { value: tmp15(18114).IntegrationExpireBehaviorTypes.REMOVE_ROLE, label: null };
    const intl6 = tmp15(1115).intl;
    obj17.label = intl6.string(tmp15(1115).t["6kpw4i"]);
    const items3 = [closure_7(tmp15(5991).TableRadioRow, obj17), ];
    const obj18 = { value: tmp15(18114).IntegrationExpireBehaviorTypes.KICK, label: null };
    const intl7 = tmp15(1115).intl;
    obj18.label = intl7.string(tmp15(1115).t.fQUQIJ);
    items3[1] = closure_7(tmp15(5991).TableRadioRow, obj18);
    obj16.children = items3;
    items1[2] = closure_8(tmp15(5988).TableRadioGroup, obj16);
    ...
    items1[3] = closure_7(tmp15(5990).TableRowGroup, obj19);
    items1[4] = tmp13;
    obj6.children = items1;
    obj5.children = closure_8(tmp15(5269).Stack, obj6);
    const items4 = [closure_7(tmp15(8947).Form, obj5), closure_7(tmp15(7371).NavScrim, {})];
    obj13.children = items4;
    return closure_8(closure_9, obj13);
  } else {
    const tmp15Result = tmp15(1397);
    const tmp15Result2 = tmp15(4678);
    const icon = { source: null, style: null };
    icon.source = tmp15Result.makeSource(tmp15(4678).isThemeDark(props.theme) ? icon.darkPNG : icon.lightPNG);
    icon.style = iter.integrationIcon;
    closure_7(closure_3, icon);
    const tmp20 = tmp15(4678).isThemeDark(props.theme) ? icon.darkPNG : icon.lightPNG;
  }
  const obj3 = self(5586);
};
GuildSettingsModalIntegrationSettings.contextType = fn(4533).ThemeContext;
const size = fn(2);
