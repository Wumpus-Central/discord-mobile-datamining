...
({
  GuildSettingsSections: closure_7,
  HelpdeskArticles: closure_8,
  PlatformTypes: closure_9,
...
export default function GuildSettingsModalIntegrationPlatform(platformType) {
  ...
  if (null == guild) {
    ...
    items2[1] = closure_11(tmp(4570).Text, obj6);
    obj3.children = items2;
    obj2.children = closure_12(tmp(4987).Stack, obj3);
    const items3 = [closure_11(tmp(8626).Form, obj2), closure_11(tmp(7054).NavScrim, {})];
