...
function SyncingToGamesItem(channels) {
  ...
  const getOrFetchApplication = channels(5601).useGetOrFetchApplication(channels.applicationId);
  let tmp5Result = null;
  if (0 !== channels.length) {
    ...
    obj[2] = channels.map((id) => {
      ...
      obj[0] = channels(4445).computeChannelName(id, outer1_4, outer1_3);
      obj = { IconComponent: null };
      const obj2 = channels(4445);
      obj[0] = channels(4715).getChannelIconComponent(id);
      obj[1] = outer1_6(channels(5300).TableRow.Icon, obj);
      ...
      return outer1_6(channels(5300).TableRow, obj, id.id);
    });
    tmp5Result = closure_6(channels(5634).TableRowGroup, obj);
