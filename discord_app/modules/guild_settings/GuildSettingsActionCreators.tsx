...
let body = {
  ...
  saveGuild(id, arg1, arg2) {
    ...
    const request = {
      url: closure_10.GUILD(id),
      query: { for_discovery: obj.isForDiscovery },
      body: obj2,
  ...
  updateGuildModeration(id, verification_level) {
    ...
    const request = {
      url: closure_10.GUILD(id),
      body: {
        verification_level: verification_level.verificationLevel,
            ...
            if (arg0 === 1) {
              ...
              const obj6 = {
                value: HTTP.del(request).then(() => {
                  const AccessibilityAnnouncer = closure_1_0(4679).AccessibilityAnnouncer;
