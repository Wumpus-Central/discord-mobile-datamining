          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              obj3[0] = HTTP.del(obj1).then(() => {
                const AccessibilityAnnouncer = _undefined(4116).AccessibilityAnnouncer;
            ...
            if (arg0 === 1) {
              ...
              if (outer1_4.isFullServerPreview(outer1_0)) {
                if (outer1_1 === outer1_6.getId()) {
                  const result = outer1_0(5247).updateImpersonatedRoles(tmp29, dependencyMap);
                  c3 = 3;
                  const obj6 = outer1_0(5247);
                }
              }
              const HTTP = outer1_0(530).HTTP;
              const obj1 = { url: null, body: null, oldFormErrors: true, rejectWithError: null };
