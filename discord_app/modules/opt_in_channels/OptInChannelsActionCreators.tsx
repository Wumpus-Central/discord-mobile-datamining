  ...
  if (null != id) {
    if (initialize.isFullServerPreview(id)) {
      ...
      if (flag) {
        ...
        obj[0] = setFlagResult;
        obj[1] = obj;
        const result2 = obj(5245).updateGuildAndChannelNotificationSettings(id, obj, _UserNotificationSettings.NotificationLabels.OptedIn);
        const obj7 = obj(5245);
        obj = {};
        const obj9 = obj(698);
...
export const bulkOptOutChannels = function bulkOptOutChannels(closure_0, arr, location) {
  ...
  if (null != closure_0) {
    if (initialize.isFullServerPreview(closure_0)) {
      ...
      const result1 = obj(5245).updateChannelOverrideSettingsBulk(closure_0, obj, _UserNotificationSettings.NotificationLabels.OptedOut);
      const obj2 = obj(5245);
      obj = {};
      const obj3 = obj(698);
