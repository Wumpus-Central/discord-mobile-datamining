  ...
  if (null != id) {
    if (ImpersonateStore.isFullServerPreview(id)) {
      ...
      if (flag) {
        ...
        const result2 = channel_overrides(7222).updateGuildAndChannelNotificationSettings(
          id,
          obj4,
        ...
        const result3 = channel_overrides(7222).updateChannelOverrideSettingsBulk(
          id,
          channel_overrides,
          require("NotificationSettingsUtils").NotificationLabels.OptedIn,
        );
...
export const bulkOptOutChannels = function bulkOptOutChannels(id, arr, location) {
  ...
  if (null != id) {
    if (ImpersonateStore.isFullServerPreview(id)) {
      ...
      const result1 = obj(7222).updateChannelOverrideSettingsBulk(
        id,
        obj,
  ...
  const result2 = require("UserSettingsProtoActionCreators").updateUserGuildSettings(
    ...
    (guildOnboardingProgress) => {
      guildOnboardingProgress.guildOnboardingProgress = guildId(1384).setFlag(
        guildOnboardingProgress.guildOnboardingProgress,
        guildId(1185).GuildOnboardingProgress.GUILD_NOTICE_SHOWN,
        false,
      );
      obj = guildId(1384);
      guildOnboardingProgress.guildOnboardingProgress = guildId(1384).setFlag(
        guildOnboardingProgress.guildOnboardingProgress,
        guildId(1185).GuildOnboardingProgress.GUILD_NOTICE_CLEARED,
        false,
      );
      return true;
    },
