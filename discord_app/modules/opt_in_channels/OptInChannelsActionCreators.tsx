  ...
  if (null != id) {
    if (closure_4.isFullServerPreview(id)) {
      ...
      if (flag) {
        ...
        obj[0] = setFlagResult;
        obj[1] = obj;
        const result2 = obj(5368).updateGuildAndChannelNotificationSettings(id, obj, require("../../utils/NotificationSettingsUtils.tsx").NotificationLabels.OptedIn);
        const obj7 = obj(5368);
        obj = {};
        const obj9 = obj(698);
...
export const bulkOptOutChannels = function bulkOptOutChannels(closure_0, arr, location) {
  ...
  if (null != closure_0) {
    if (closure_4.isFullServerPreview(closure_0)) {
      ...
      const result1 = obj(5368).updateChannelOverrideSettingsBulk(closure_0, obj, require("../../utils/NotificationSettingsUtils.tsx").NotificationLabels.OptedOut);
      const obj2 = obj(5368);
      obj = {};
      const obj3 = obj(698);
