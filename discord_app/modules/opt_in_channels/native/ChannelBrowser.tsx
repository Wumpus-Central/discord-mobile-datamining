...
let closure_17 = noop.memo((channel) => {
  ...
  const items1 = [
    closure_12(channel(5773).TableRowGroupTitle, { style: tmp.categoryTitle, title: tmp3, lineClamp: 1 }),
  ];
  ...
  if ("null" !== channel.id) {
    ...
    obj6.children = closure_12(tmp4(5703).FormCheckbox, obj7);
    ...
    items2[1] = closure_12(tmp4(4634).Text, obj8);
