                ...
                update(favoriteChannels) {
                  ...
                  while (iter !== undefined) {
                    ...
                    let tmp11 = closure_2_21(
                      ...
                      closure_0(1186).FavoriteChannelType.REFERENCE_ORIGINAL,
                    );
                    if (null != tmp11) {
                      if (!closure_1_3) {
                      ...
                      let obj = {
                        nickname: "",
                        type: closure_0(1186).FavoriteChannelType.REFERENCE_ORIGINAL,
                        channelType: null,
                        position: null,
                        parentId: null,
                      };
            ...
            let obj5 = {
              update(favoriteChannels) {
                ...
                if (obj.size(favoriteChannels) >= closure_2_13) {
                  ...
                  const favoritesAccess = closure_0(10371).getFavoritesAccess();
                  const favoriteLimit = favoritesAccess.favoriteLimit;
                  tmp6 = null;
                  if (favoriteLimit > 0) {
                    tmp6 = null;
                  ...
                  const tmpResult = closure_0(10371);
                }
                if (null != tmp6) {
                  const limit = tmp6.limit;
                  if (tmp6.canUpsell) {
                    closure_1(10374)(limit);
                  } else {
                    ...
                    closure_1(4984).show(obj4);
                    const tmp4Result2 = closure_1(4984);
                  }
                  return false;
                } else {
