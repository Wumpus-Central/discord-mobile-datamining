                            ...
                            if (null != tmp11) {
                              ...
                              if ("categoryName" in closure_1_1) {
                                if (!flag) {
                                  ...
                                  tmp4 = tmp16;
                                  let tmp8Result = closure_2_21(favoriteChannels.favoriteChannels, closure_0(1187).FavoriteChannelType.REFERENCE_ORIGINAL);
                                  if (null != tmp8Result) {
                                    if (!closure_1_3) {
                              ...
                              let obj = { nickname: "", type: closure_0(1187).FavoriteChannelType.REFERENCE_ORIGINAL, channelType: null, position: null, parentId: null };
                              obj = undefined;
                              if (null != channel) {
    ...
    try {
      ...
      if (0 === c4) {
        ...
        if (arg0 === 1) {
          ...
          c4 = 2;
          c5 = 1;
          const obj3 = { value: closure_131_27(closure_130_0, obj2, closure_130_2), done: false };
          return obj3;
        }
      } else if (arg0 === 1) {
        c5 = 3;
            ...
            let obj1 = {
              update(favoriteChannels) {
                          ...
                          if (obj.size(favoriteChannels) >= closure_2_13) {
                            ...
                            const favoritesAccess = closure_0(10313).getFavoritesAccess();
                            const favoriteLimit = favoritesAccess.favoriteLimit;
                            tmp6 = null;
                            if (favoriteLimit > 0) {
                              tmp6 = null;
                              if (closure_0(1187).FavoriteChannelType.CATEGORY !== closure_0(1187).FavoriteChannelType.CATEGORY) {
                                let tmp4Result = closure_1(12);
                                tmp6 = null;
                            ...
                            const tmpResult = closure_0(10313);
                          }
                          if (null != tmp6) {
                            const limit = tmp6.limit;
                            if (tmp6.canUpsell) {
                              closure_1(10316)(limit);
                            } else {
                              tmp4Result = closure_1(4950);
                              ...
                              obj1.body = intl2.formatToPlainString(closure_0(1114).t.JaIyFi, obj2);
    ...
    try {
      ...
      if (0 === c3) {
        ...
        if (arg0 === 1) {
          ...
          const obj2 = { categoryName: closure_129_1 };
          c3 = 2;
          c4 = 1;
          const obj3 = { value: closure_130_27(closure_129_0, obj2, closure_129_2), done: false };
          return obj3;
        }
      } else if (arg0 === 1) {
        c4 = 3;
            ...
            if (null != channel) {
              if (channel.isThread()) {
                ...
                if (hasAccess) {
                  ...
                  c2 = 1;
                  c1 = 1;
                  obj2 = { value: addFavoriteChannelsToParent(items, obj1, "auto_thread_join", { silent: true }), done: false };
                  return obj2;
                }
              }
            }
            ...
            if (obj5.size(favoriteChannels) >= map1) {
              ...
              if (favoriteLimit > 0) {
                ...
                if (preloaded_user_settings.FavoriteChannelType.CATEGORY !== favoritesAccess) {
                  ...
                  favoritesAccess = tmp7Result.filter(favoriteChannels, (type) => type.type !== closure_1_0(dependencyMap[11]).FavoriteChannelType.CATEGORY).length;
                  tmp11 = null;
