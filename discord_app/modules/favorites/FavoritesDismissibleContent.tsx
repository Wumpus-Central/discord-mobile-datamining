...
let items = [
  fn(2029).DismissibleContent.FAVORITES_SERVER_ONBOARDING_INTRO,
  fn(2029).DismissibleContent.FAVORITES_SERVER_ONBOARDING_MENU_ITEM,
  fn(2029).DismissibleContent.FAVORITES_GUILD_NEW_BADGE,
  fn(2029).DismissibleContent.FAVORITES_GUILD_SUGGESTIONS,
];
const items1 = [
  fn(2029).DismissibleContent.FAVORITES_SERVER_ONBOARDING_INTRO,
  fn(2029).DismissibleContent.FAVORITES_SERVER_ONBOARDING_MENU_ITEM,
