// === Module 10631: useFavoritesGuildChannelActions ===
...
export default function useFavoritesGuildChannelActions(channelId, FavoritesGuildActionSheet) {
  ...
  const isFavoritesGuildSelected = _require(10226).useIsFavoritesGuildSelected();
  const obj4 = _require(10226);
  ...
  const favoritesBetaTagDismissibleContent = tmp(10238).useFavoritesBetaTagDismissibleContent(tmp7);
