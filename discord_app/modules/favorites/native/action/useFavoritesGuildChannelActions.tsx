// === Module 10649: useFavoritesGuildChannelActions ===
...
export default function useFavoritesGuildChannelActions(channelId, FavoritesGuildActionSheet) {
  ...
  const isFavoritesGuildSelected = _require(10244).useIsFavoritesGuildSelected();
  const obj4 = _require(10244);
  ...
  const favoritesBetaTagDismissibleContent = tmp(10256).useFavoritesBetaTagDismissibleContent(tmp7);
