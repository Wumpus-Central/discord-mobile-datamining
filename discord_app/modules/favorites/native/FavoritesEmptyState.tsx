...
import PlusMediumIcon from "PlusMediumIcon" /* 11932 */;
...
const createCacheKey = { flex: 1, alignItems: "center", justifyContent: "center", gap: ThemesDefault.space.PX_16, paddingHorizontal: ThemesDefault.space.PX_48 };
createCacheKey[0] = createCacheKey;
createCacheKey[1] = { textAlign: "center" };
let closure_7 = createCacheKey.createStyles(createCacheKey);
const result = require("obj132").fileFinishedImporting("modules/favorites/native/FavoritesEmptyState.tsx");
...
export default function FavoritesEmptyState() {
  ...
  let obj = { spacing: ThemesDefault.space.PX_8, align: "center", children: null };
  ...
  if (obj.useFavoritesAccess("favorites_empty_state").hasAccess) {
    ...
    obj3[1] = intl4.string(messagesProxyDefault["6kk0gM"]);
    obj3[2] = tmp8(PlusMediumIcon.PlusMediumIcon, {});
    obj3[3] = callback;
    let obj4 = obj3;
  } else {
    obj4 = { variant: "primary", text: null, onPress: null };
    const intl3 = getSystemLocale.intl;
    obj4[1] = intl3.string(messagesProxyDefault.yYVbdv);
    obj4[2] = callback1;
  }
