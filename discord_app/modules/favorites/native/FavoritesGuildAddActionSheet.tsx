...
function handleAddToFavorites() {
  ...
  const result = AddFavoriteChannelModal.openAddFavoriteChannelModal({ source: "favorites_header_add_button_context_menu" });
}
...
function FavoritesGuildAddActionSheet() {
  ...
  obj2[0] = StarOutlineIcon.StarOutlineIcon;
  obj1[1] = callback(ActionSheetRowIcon.ActionSheetRow.Icon, obj2);
  obj1[2] = handleAddToFavorites;
  obj[1] = callback(ActionSheetRowIcon.ActionSheetRow, obj1);
  const items = [callback(ActionSheetRowIcon.ActionSheetRow.Group, obj), ];
  const obj3 = { hasIcons: true, children: null };
  const obj4 = { label: null, icon: null, onPress: null };
  const intl3 = getSystemLocale.intl;
  obj4[0] = intl3.string(getSystemLocale.t["ISN+NM"]);
  const obj5 = { IconComponent: null };
  obj5[0] = FolderPlusIcon.FolderPlusIcon;
  obj4[1] = callback(ActionSheetRowIcon.ActionSheetRow.Icon, obj5);
  obj4[2] = handleCreateCategory;
  obj3[1] = callback(ActionSheetRowIcon.ActionSheetRow, obj4);
  items[1] = callback(ActionSheetRowIcon.ActionSheetRow.Group, obj3);
  obj[1] = items;
