// === Module 15774: FavoritesGuildChannels ===

// Module 15774 (FavoritesGuildChannels)
import noopAll from "noop" /* 19 */;
import getFontScale from "getFontScale" /* 4887 */;
import useScaledRowHeightDefault from "useScaledRowHeight" /* 7708 */;
import ChannelListStickyHeaderDefault from "ChannelListStickyHeader" /* 15636 */;
import PX_8Default from "PX_8" /* 15702 */;
import ChannelListPanelBackdropDefault from "ChannelListPanelBackdrop" /* 15742 */;
import getMissingFavoriteThreadIds from "getMissingFavoriteThreadIds" /* 15775 */;
import FavoritesGuildSuggestionsLoaderInnerDefault from "FavoritesGuildSuggestionsLoaderInner" /* 15776 */;
import EmptyBodyDefault from "EmptyBody" /* 15781 */;
import { useFavoritesGuildSuggestionCount as closure_3 } from "items" /* 15703 */;
...
export default function FavoritesGuildChannels(arg0) {
  ...
  if (!obj5.useShouldRenderChannelList()) {
    ...
    if (hasNoChannels) {
      ...
      obj2.favoritesSuggestionsNoticeHeight = tmp4(15702).getFavoritesSuggestionsNoticeHeight(fontScale, tmp3, tmp);
      tmp10Result = tmp10(tmp4(15604).ChannelList, obj2);
      const tmp4Result = tmp4(15702);
    }
