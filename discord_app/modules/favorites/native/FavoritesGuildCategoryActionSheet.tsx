...
function FavoritesGuildCategoryActionSheetConnected(category) {
  ...
  obj[0] = callback(category(5436).BottomSheetTitleHeader, { title: onClose(4535)(category, true) });
  let tmp7Result = null;
  if (null != tmp3) {
    ...
    obj1[0] = tmp4(9755).PlusLargeIcon;
    obj[1] = tmp7(tmp4(5806).ActionSheetRow.Icon, obj1);
    obj[2] = function onPress() {
      _undefined.perform();
      onClose();
    };
    obj[1] = tmp7(tmp4(5806).ActionSheetRow, obj);
    tmp7Result = tmp7(tmp4(5806).ActionSheetRow.Group, obj);
  }
  ...
  obj4[0] = category(6054).SettingsIcon;
  obj3[1] = callback(category(5806).ActionSheetRow.Icon, obj4);
  obj3[2] = function onPress() {
    onClose(_undefined[12])(category.id);
    onClose();
  };
  obj2[1] = callback(category(5806).ActionSheetRow, obj3);
  items[1] = callback(category(5806).ActionSheetRow.Group, obj2);
  tmp7Result = null;
  if (setting) {
    ...
    obj7[0] = tmp4(9596).IdIcon;
    obj6[1] = tmp7(tmp4(5806).ActionSheetRow.Icon, obj7);
    ...
    obj5[1] = tmp7(tmp4(5806).ActionSheetRow, obj6);
    tmp7Result = tmp7(tmp4(5806).ActionSheetRow.Group, obj5);
  }
  items[2] = tmp7Result;
  obj[1] = items;
  return closure_6(category(5804).ActionSheet, obj);
}
