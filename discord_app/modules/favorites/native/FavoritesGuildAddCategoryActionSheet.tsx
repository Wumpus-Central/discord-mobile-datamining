// === Module 15478: FavoritesGuildAddCategoryActionSheet ===

// Module 15478 (FavoritesGuildAddCategoryActionSheet)
import ThemesDefault from "Themes" /* 712 */;
import ACTION_SHEET_HEIGHT_HALF from "ACTION_SHEET_HEIGHT_HALF" /* 4346 */;
...
function FavoritesGuildAddCategoryActionSheet() {
  ...
  obj[3] = callback2(first(6987).BottomSheetTitleHeader, obj);
  ...
  obj1[4] = closure_5;
  obj1[8] = callback;
  const items1 = [callback2(first(8110).TextInput, obj1), ];
  let obj2 = { text: null, onPress: null, disabled: null };
  const intl4 = first(1236).intl;
  obj2[0] = intl4.string(first(1236).t.CumH4u);
  obj2[1] = callback;
  obj2[2] = !result;
  items1[1] = callback2(first(4750).Button, obj2);
  obj[4] = items1;
  return callback3(first(6988).BottomSheet, obj);
}
