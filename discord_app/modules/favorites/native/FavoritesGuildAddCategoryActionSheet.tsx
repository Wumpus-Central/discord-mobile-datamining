// === Module 16555: FavoritesGuildAddCategoryActionSheet ===
...
function FavoritesGuildAddCategoryActionSheet() {
  ...
  obj2.header = closure_6(value(7480).BottomSheetTitleHeader, obj3);
  ...
  const items1 = [closure_6(value(6934).TextInput, obj4), ];
  ...
  items1[1] = closure_6(value(5271).Button, obj5);
  obj2.children = items1;
  return closure_7(value(7481).BottomSheet, obj2);
}
