// === Module 16491: openFavoritesGuildChannelSortModal ===
...
export default function openFavoritesGuildChannelSortModal() {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(16492, dependencyMap.paths), undefined, FavoritesGuildChannelSortModal);
};
