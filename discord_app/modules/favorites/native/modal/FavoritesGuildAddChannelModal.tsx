...
export default function FavoritesGuildAddChannelModal(parentId) {
      ...
      try {
        ...
        if (0 === c3) {
          if (arg0 === 1) {
            ...
            c3 = 1;
            c4 = 1;
            let obj1 = { value: Promise.all(first.map(parentId(11113).getOrResolveChannelIdFromDestinationId)), done: false };
            return obj1;
          }
        } else if (arg0 === 1) {
          c4 = 3;
  ...
  obj.onClose = parentId(11108).closeFavoritesGuildAddChannelModal;
  const items2 = [closure_9(first(11115), obj), ];
  ...
  items3[1] = closure_9(first(11116), obj1);
  ...
  obj2.text = parentId(11129).getFavoritesAddButtonLabel(first.length);
  obj2.onPress = callback1;
  items3[2] = closure_9(parentId(11127).ModalFloatingAction, obj2);
  obj.children = items3;
