...
export default function FavoritesGuildActionSheet(onClose) {
  ...
  obj.header = closure_4(onClose(7222).BottomSheetTitleHeader, obj);
  let tmp8Result = null;
  if (tmp4.isAvailable) {
    ...
    const obj3 = { IconComponent: tmp5(5124).ThreadIcon };
    obj2.icon = closure_4(tmp5(7272).ActionSheetRow.Icon, obj3);
    ({ isEnabled: obj6.value, toggle: obj6.onValueChange } = tmp4);
    obj1.children = closure_4(tmp5(7272).ActionSheetSwitchRow, obj2);
    tmp8Result = closure_4(tmp5(7272).ActionSheetRow.Group, obj1);
  }
  ...
  if (obj.useFavoritesAccess("FavoritesGuildActionSheet").hasAccess) {
    ...
    if (stateFromStores) {
      ...
      const obj6 = { IconComponent: tmp5(12244).ArrowsUpDownIcon };
      obj5.icon = closure_4(tmp5(7272).ActionSheetRow.Icon, obj6);
      obj5.onPress = function onPress() {
        onClose();
        openFavoritesGuildChannelSortModalDefault();
      };
      obj4.children = closure_4(tmp5(7272).ActionSheetRow, obj5);
      tmp8Result = closure_4(tmp5(7272).ActionSheetRow.Group, obj4);
    }
  }
  items1[1] = tmp8Result;
  ...
  obj7.icon = closure_4(onClose(7272).ActionSheetRow.Icon, { IconComponent: EyeSlashIcon });
  let str = "danger";
  if (tmp2.isPreview) {
    str = "default";
  }
  ...
  const items2 = [closure_4(onClose(7272).ActionSheetRow, obj7), ];
  ...
  if (tmp3.isAvailable) {
    ...
    const obj9 = { IconComponent: tmp5(4564).TrashIcon };
    obj8.icon = closure_4(tmp5(7272).ActionSheetRow.Icon, obj9);
    obj8.onPress = function onPress() {
      onClose();
      closure_2.perform();
    };
    tmp8Result1 = closure_4(tmp5(7272).ActionSheetRow, obj8);
  }
  items2[1] = tmp8Result1;
  items1[2] = closure_5(onClose(7272).ActionSheetRow.Group, { hasIcons: true, children: items2 });
  obj.children = items1;
  return closure_5(onClose(7270).ActionSheet, obj);
};