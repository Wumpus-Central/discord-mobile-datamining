...
export default function FavoritesGuildActionSheet(onClose) {
  ...
  if (tmp4.isAvailable) {
    ...
    obj7.icon = closure_4(tmp5(7306).ActionSheetRow.Icon, obj8);
    ({ isEnabled: obj6.value, toggle: obj6.onValueChange } = tmp4);
    obj5.children = closure_4(tmp5(7306).ActionSheetSwitchRow, obj7);
    tmp8Result = closure_4(tmp5(7306).ActionSheetRow.Group, obj5);
  }
  ...
  if (obj.useFavoritesAccess("FavoritesGuildActionSheet").hasAccess) {
    ...
    if (stateFromStores) {
      ...
      obj10.icon = closure_4(tmp5(7306).ActionSheetRow.Icon, obj11);
      obj10.onPress = function onPress() {
        onClose();
        openFavoritesGuildChannelSortModalDefault();
      };
      obj9.children = closure_4(tmp5(7306).ActionSheetRow, obj10);
      tmp8Result3 = closure_4(tmp5(7306).ActionSheetRow.Group, obj9);
    }
  }
  ...
  if (tmp3.isAvailable) {
    ...
    obj24.icon = closure_4(tmp5(7306).ActionSheetRow.Icon, obj25);
    obj24.onPress = function onPress() {
      onClose();
      closure_2.perform();
    };
    tmp8Result4 = closure_4(tmp5(7306).ActionSheetRow, obj24);
  }
