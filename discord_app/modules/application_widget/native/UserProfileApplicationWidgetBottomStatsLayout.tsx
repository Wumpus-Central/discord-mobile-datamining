...
createCacheKey = {
  ...
  columnGap: ThemesDefault.space.PX_12,
};
...
export default function UserProfileApplicationWidgetBottomStatsLayout(arg0) {
  ...
  const mapped = items.map((arg0) =>
    closure_1_0(closure_1_1[5]).resolveStatComponentValues(
      components.components["stat_" + arg0],
      closure_1,
      closure_2,
      closure_1_0(closure_1_1[6]).formatDurationNarrow,
      true,
    ),
  );
