...
createStyles.heroImagePositioner = { position: "absolute", left: "50%", right: -CARD_PADDING, top: -CARD_PADDING, bottom: 0, overflow: "hidden" };
...
export default function UserProfileApplicationWidgetTopHeroLayout(header) {
  ...
  if (tmp15Result1) {
    ...
    if (tmp15Result) {
      ...
      tmp15Result = React6(_modDef5745, obj6);
    }
