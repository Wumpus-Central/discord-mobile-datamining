...
createStyles.progress = { height: 6, borderRadius: nativeDefault.radii.md, backgroundColor: nativeDefault.colors.ICON_STRONG };
...
export default function UserProfileApplicationWidgetBottomProgressLayout(arg0) {
  ...
  if ("value" === singleStringOrSkeleton1.status) {
    const obj10 = { variant: "text-xs/medium", color: "text-subtle", lineClamp: 2, children: singleStringOrSkeleton1.text };
