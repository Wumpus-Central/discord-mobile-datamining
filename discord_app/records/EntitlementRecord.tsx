...
EntitlementRecord["createFromServer"] = function createFromServer(user) {
  ...
  if (typeof EntitlementRecord === "function") {
    const tmp27 = new EntitlementRecord(tmp4, EntitlementRecord, new.target, id, sku_id, application_id, tmp2, user_id, gifter_user_id, type, branches, date, date1, subscription_id, id1, parent_id, consumed, gift_code_batch_id, gift_style, guild_id, deleted, source_type, fulfillment_status, orbs_reward);
    tmp27.id = id;
    tmp27.skuId = sku_id;
