      ...
      if (0 === c5) {
        ...
        if (arg0 === 1) {
          ...
          if (null == closure_129_5) {
            ...
            c6 = 1;
            const obj3 = {
              value: closure_129_2.getImageData(0, 0, closure_129_1.width, closure_129_1.height),
              done: false,
            };
            return obj3;
          }
        ...
        if (arg0 === 1) {
          ...
          if (closure_129_13) {
            ...
            const obj10 = {
              success: false,
              reason: closure_130_5.PIXEL_HASH_MISMATCH,
              pixelHashTimeMs: closure_129_14,
            };
          }
          c6 = 3;
        }
        ...
        if (closure_130_5.success) {
          if (null != closure_130_5.webpBlob) {
            ...
            if (closure_130_8 < 0) {
              const _Math = Math;
              const _HermesInternal = HermesInternal;
              closure_131_4.verbose(
                "[WebP] Insufficient savings: " +
                  Math.round(100 * closure_130_8) +
                  "% < 0% (" +
                  closure_130_0.size +
                  " -> " +
                  webpBlob.size +
              ...
              closure_131_4.verbose(
                "[WebP] Conversion successful: " + name + " to WebP in " + Math.round(closure_130_1) + "ms",
              );
              const obj7 = {
                success: true,
                originalFile: closure_130_0,
                convertedBlob: webpBlob,
                sizeBefore: closure_130_0.size,
                sizeAfter: webpBlob.size,
                compressionRatio: closure_130_7,
                hashTimeMs: closure_130_5.pixelHashTimeMs,
                compressTimeMs: null,
              };
              const _Math3 = Math;
