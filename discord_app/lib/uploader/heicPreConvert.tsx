...
let closure_5 = async function _maybePreConvertHeicItem() {
  c7 = 0;
  c8 = 0;
  c6 = 0;
  return (async (arg0) => {
      ...
      try {
        ...
        if (0 === c7) {
          if (arg0 === 1) {
            ...
            if (itemNeedsHeicPreConversion(value)) {
              c6 = 1;
          ...
          if (arg0 === 1) {
            ...
            if (null != closure_132_11) {
              ...
              const obj11 = { convertedMimeType: null, conversionFailureReason: UNKNOWN_ERROR, compressTimeMs: closure_132_11.compressTimeMs };
              tmp39 = obj11;
            }
