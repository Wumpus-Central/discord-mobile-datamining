      ...
      try {
        ...
        if (0 === constants) {
          if (arg0 === 1) {
            ...
            let uploadTarget;
            closure_130_0 = files(8082).backgroundTaskIdentifierInvalid;
            self.once(
              "start",
              tmp4(function* () {
                if (c2 === 2) {
                  ...
                  try {
                    ...
                    if (0 === length) {
                      if (arg0 === 1) {
                        ...
                        c2 = 1;
                        const obj7 = { value: files(8082).startBackgroundTask(obj4), done: false };
                        return obj7;
                      }
                    } else if (arg0 === 1) {
                      c2 = 3;
                      ...
                      closure_128_0 = value;
                      if (tmp2._aborted) {
                        files(8082).endBackgroundTask(closure_128_0);
                        const obj = files(8082);
                      }
                      c2 = 3;
                      return { value: "HermesInternal", done: null };
                    }
          ...
          uploadTarget = _self(5478).getUploadTarget(closure_130_4.item.target);
          if (closure_130_5 > uploadTarget.getMaxFileSize(closure_130_4.channelId)) {
            ...
            if (_self === undefined) {
              ...
              constants = 3;
              logger = 1;
              const obj14 = { value: _self(8168).getPreCompressionFileSize(closure_130_4.item), done: false };
              return obj14;
            }
          }
          const obj15 = _self(5478);
        }
      } catch (tmp61) {
        if (tmp5 === c5) {
          logger = tmp3;
