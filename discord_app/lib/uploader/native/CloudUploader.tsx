                ...
                try {
                  ...
                  if (0 === length) {
                    if (arg0 === 1) {
                      ...
                      c2 = 1;
                      const obj3 = { value: files(7827).startBackgroundTask(obj1), done: false };
                      return obj3;
                    }
                  } else if (arg0 === 1) {
                    c2 = 3;
      ...
      try {
        ...
        if (0 === c4) {
          ...
          if (1 === tmp7) {
            ...
            c4 = 2;
            c5 = 1;
            obj = { value: tmp3(tmp59[13])(closure_129_0.files, true, _recomputeProgress.bind(closure_129_0)), done: false };
            return obj;
          } else {
            c3 = 0;
            c5 = 3;
