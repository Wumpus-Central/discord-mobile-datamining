// discord_app/lib/uploader/heicConversion.tsx
  ...
  if (c8 === 2) {
    ...
    try {
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          closure_131_5 = function fail(reason) {
            return {
              ...
              sizeAfter: originalFile.size,
              reason,
              compressTimeMs: Math.round(performance.now() - closure_1_3),
            };
          };
          c7 = 1;
          c8 = 1;
        ...
        closure_132_4.log(
          "converted " + name + ": " + size + " -> " + closure_131_10.size + " bytes in " + closure_131_4() + "ms",
        );
        const obj13 = {
          success: true,
          originalFile: closure_131_0,
          convertedBlob: closure_131_10,
          sizeBefore: closure_131_0.size,
          sizeAfter: closure_131_10.size,
          compressTimeMs: closure_131_4(),
        };
        c6 = 0;
        c8 = 3;
...
const HeicConversionFailureReason = {
