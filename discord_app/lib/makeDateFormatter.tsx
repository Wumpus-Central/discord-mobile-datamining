...
function getLocaleData() {
  ...
  if (typeof months === "function") {
    closure_2 = months.bind(_modDef4416.localeData());
    let fn = (arg0, arg1) => {
      closure_0 = arg0;
  ...
  if (typeof monthsShort === "function") {
    closure_2 = monthsShort.bind(_modDef4416.localeData());
    let fn2 = (arg0, arg1) => {
      closure_0 = arg0;
      return closure_2({ [closure_1_0]: () => closure_0 }, arg1);
    };
  ...
  if (typeof weekdays === "function") {
    closure_2 = weekdays.bind(_modDef4416.localeData());
    let fn3 = (arg0, arg1) => {
      closure_0 = arg0;
      return closure_2({ [closure_1_0]: () => closure_0 }, arg1);
    };
  ...
  if (typeof weekdaysShort === "function") {
    closure_2 = weekdaysShort.bind(_modDef4416.localeData());
    let fn4 = (arg0, arg1) => {
      closure_0 = arg0;
      return closure_2({ [closure_1_0]: () => closure_0 }, arg1);
    };
    const tmpResult7 = _modDef4416;
  } else {
    const _Array4 = Array;
  ...
  if (typeof weekdaysMin === "function") {
    closure_2 = weekdaysMin.bind(_modDef4416.localeData());
    let fn5 = (arg0, arg1) => {
      closure_0 = arg0;
      return closure_2({ [closure_1_0]: () => closure_0 }, arg1);
    };
