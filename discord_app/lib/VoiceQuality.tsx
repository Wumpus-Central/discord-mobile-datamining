          ...
          const item = _modDef12.forEach(arg0, (type) => {
            if ("audio" === type.type) {
              ...
              if (null != closure_0.inboundStats[closure_0]) {
                ...
                obj7.preemptiveExpandRateSum = closure_0.periodicInboundStats[closure_0].preemptiveExpandRateSum + num22;
