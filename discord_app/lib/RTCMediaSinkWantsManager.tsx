...
import BrowserInvertedWantsExperiment from "../modules/media_engine/BrowserInvertedWantsExperiment.tsx";
            ...
            if (closure_0.supportsSeamless) {
              if (!tmp62.framesReceived[ssrc]) {
                ...
                for (const item10152 of arr2) {
                  ...
                  if (tmp70) {
                    tmp70 = closure_0.framesReceived[item10152.ssrc];
                  }
                  if (!tmp70) {
                    continue;
                  } else {
                    if (item10152.quality === c7) {
