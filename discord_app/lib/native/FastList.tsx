          ...
          if (obj.HEADER === type4) {
            ...
            if (null == tmp23.uniform) {
              if (isVisible(tmp23.layoutStart, tmp23.layoutSize)) {
                ...
                let arr1 = items.push(
                  obj3.get(tmp224.ITEM, tmp23.layoutStart, tmp23.layoutSize, tmp86, tmp23.section, tmp23.item),
                );
              }
              result1 = tmp23.layoutStart + tmp23.layoutSize;
            } else {
            ...
            if (isVisible(tmp23.layoutStart, tmp23.layoutSize)) {
              ...
              let arr3 = items.push(
                obj3.get(
                  ...
                  layoutStart,
                  tmp23.layoutSize,
                  getRecyclerKey(tmp224.SECTION_FOOTER, tmp23.section),
                  tmp23.section,
                ),
              );
            }
              ...
              if (true === tmp7.uniform) {
                if (tmp7.section === arg1) {
                  if (arg2 > tmp7.items) {
                    ...
                    obj.scrollPosition =
                      tmp7.sectionData.layoutStart + tmp7.sectionData.layoutSize + tmp7.itemSize * arg2;
