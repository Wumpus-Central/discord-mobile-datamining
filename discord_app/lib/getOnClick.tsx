      ...
      try {
        ...
        if (0 === c3) {
          if (arg0 === 1) {
            ...
            obj1 = { type: "DISPLAYED_INVITE_SHOW", code, username: "Array", deeplinkAttemptId: "channel", invite_instance_id };
            c3 = 1;
            c2 = 1;
