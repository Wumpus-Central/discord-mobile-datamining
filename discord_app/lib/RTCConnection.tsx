// === Module 4329: getEventHistoryString ===
...
class RTCConnection extends tmp4 {
  constructor(arg0) {
    ...
    obj.reconnect = function reconnect() {
      ...
      if (null != _socket) {
        if (obj._hasEverConnected) {
          obj._connectStartTime = obj(outer1_3[18]).now();
          const obj3 = obj(outer1_3[18]);
        }
        if (!obj._connecting) {
    ...
    obj._mlsFailureReconnectBackoff = tmp22;
    ...
    tmp25 = Features;
    tmp26 = getEventHistoryString.supports(Features.FIRST_FRAME_CALLBACK) && obj3.supports(tmp25.REMOTE_USER_MULTI_STREAM);
    if (MediaEngineContextTypes.DEFAULT === context) {
      tmp28 = getEventHistoryString;
      ...
      tmp34 = userId;
      tmp35 = tmp26;
      tmp36 = new require("getDefaultWants")(userId, type === ChannelTypes.GUILD_STAGE_VOICE, tmp26);
      tmp37 = tmp36;
      obj._localMediaSinkWantsManager = tmp36;
    ...
    } else if (tmp27.STREAM === context) {
      tmp47 = new.target;
      tmp48 = new.target;
      tmp49 = new require("setUserID")();
      tmp50 = tmp49;
      obj._goLiveQualityManager = tmp49;
...
prototype["connect"] = function connect(endpoint, token) {
  ...
  if (this._destroyed) {
    ...
    if (null != self.endpoint) {
      ...
      const obj5 = new importDefault(12947)(self.endpoint, self.context);
      self._socket = obj5;
      const _handleConnecting = self._handleConnecting;
      obj5.on(require(12947) /* noop */.SocketEvent.Connecting, _handleConnecting.bind(self, obj5));
      const _handleConnect = self._handleConnect;
      obj5.on(require(12947) /* noop */.SocketEvent.Connect, _handleConnect.bind(self, obj5));
      const _handleDisconnect = self._handleDisconnect;
      obj5.on(require(12947) /* noop */.SocketEvent.Disconnect, _handleDisconnect.bind(self, obj5));
      const _handleResuming = self._handleResuming;
      obj5.on(require(12947) /* noop */.SocketEvent.Resuming, _handleResuming.bind(self, obj5));
      const _handleReady = self._handleReady;
      obj5.on(require(12947) /* noop */.SocketEvent.Ready, _handleReady.bind(self, obj5));
      const _handleSfuUpdate = self._handleSfuUpdate;
      obj5.on(require(12947) /* noop */.SocketEvent.SfuUpdate, _handleSfuUpdate.bind(self, obj5));
      const _handleSpeaking = self._handleSpeaking;
      obj5.on(require(12947) /* noop */.SocketEvent.Speaking, _handleSpeaking.bind(self, obj5));
      const _handleVideo = self._handleVideo;
      obj5.on(require(12947) /* noop */.SocketEvent.Video, _handleVideo.bind(self, obj5));
      const _handleControlPing = self._handleControlPing;
      obj5.on(require(12947) /* noop */.SocketEvent.Ping, _handleControlPing.bind(self));
      const _handleClientDisconnect = self._handleClientDisconnect;
      obj5.on(require(12947) /* noop */.SocketEvent.ClientDisconnect, _handleClientDisconnect.bind(self));
      const _handleClientConnect = self._handleClientConnect;
      obj5.on(require(12947) /* noop */.SocketEvent.ClientConnect, _handleClientConnect.bind(self));
      const _handleCodecs = self._handleCodecs;
      obj5.on(require(12947) /* noop */.SocketEvent.Codecs, _handleCodecs.bind(self));
      const _handleMediaSessionId = self._handleMediaSessionId;
      obj5.on(require(12947) /* noop */.SocketEvent.MediaSessionId, _handleMediaSessionId.bind(self));
      const _handleMediaSinkWants = self._handleMediaSinkWants;
      obj5.on(require(12947) /* noop */.SocketEvent.MediaSinkWants, _handleMediaSinkWants.bind(self));
      const _handleCodeVersion = self._handleCodeVersion;
      obj5.on(require(12947) /* noop */.SocketEvent.VoiceBackendVersion, _handleCodeVersion.bind(self));
      const _handleKeyframeInterval = self._handleKeyframeInterval;
      obj5.on(require(12947) /* noop */.SocketEvent.KeyframeInterval, _handleKeyframeInterval.bind(self));
      const handleFlags = self.handleFlags;
      obj5.on(require(12947) /* noop */.SocketEvent.Flags, handleFlags.bind(self));
      const handlePlatform = self.handlePlatform;
      obj5.on(require(12947) /* noop */.SocketEvent.Platform, handlePlatform.bind(self));
      const _handleBandwidthEstimationExperiment = self._handleBandwidthEstimationExperiment;
      obj5.on(require(12947) /* noop */.SocketEvent.BandwidthEstimationExperiment, _handleBandwidthEstimationExperiment.bind(self));
      const _handleSecureFramesInit = self._handleSecureFramesInit;
      obj5.on(require(12947) /* noop */.SocketEvent.SecureFramesInit, _handleSecureFramesInit.bind(self));
      const _handleSecureFramesPrepareTransition = self._handleSecureFramesPrepareTransition;
      obj5.on(require(12947) /* noop */.SocketEvent.SecureFramesPrepareTransition, _handleSecureFramesPrepareTransition.bind(self));
      const _handleSecureFramesPrepareEpoch = self._handleSecureFramesPrepareEpoch;
      obj5.on(require(12947) /* noop */.SocketEvent.SecureFramesPrepareEpoch, _handleSecureFramesPrepareEpoch.bind(self));
      const _handleSecureFramesExecuteTransition = self._handleSecureFramesExecuteTransition;
      obj5.on(require(12947) /* noop */.SocketEvent.SecureFramesExecuteTransition, _handleSecureFramesExecuteTransition.bind(self));
      const _handleMLSExternalSenderPackage = self._handleMLSExternalSenderPackage;
      obj5.on(require(12947) /* noop */.SocketEvent.MLSExternalSenderPackage, _handleMLSExternalSenderPackage.bind(self));
      const _handleMLSProposals = self._handleMLSProposals;
      obj5.on(require(12947) /* noop */.SocketEvent.MLSProposals, _handleMLSProposals.bind(self, obj5));
      const _handleMLSPrepareCommitTransition = self._handleMLSPrepareCommitTransition;
      obj5.on(require(12947) /* noop */.SocketEvent.MLSPrepareCommitTransition, _handleMLSPrepareCommitTransition.bind(self));
      const _handleMLSWelcome = self._handleMLSWelcome;
      obj5.on(require(12947) /* noop */.SocketEvent.MLSWelcome, _handleMLSWelcome.bind(self));
      const _recordMessageEvent = self._recordMessageEvent;
      obj5.on(require(12947) /* noop */.SocketEvent.ReceiveMessage, _recordMessageEvent.bind(self, tmp3.MESSAGE_RECEIVE));
      const _recordMessageEvent2 = self._recordMessageEvent;
      obj5.on(require(12947) /* noop */.SocketEvent.SendMessage, _recordMessageEvent2.bind(self, tmp3.MESSAGE_SEND));
      self._connectStartTime = require(4331) /* sleep */.now();
...
prototype["destroy"] = function destroy() {
  ...
  self.recordEvent(obj);
  const WindowVisibilityVideoManager = tmp5(10757).WindowVisibilityVideoManager;
  ...
  const WindowVisibilityVideoManager2 = tmp5(10757).WindowVisibilityVideoManager;
  WindowVisibilityVideoManager2.off(require(10757) /* isIncomingVideoEnabled */.WindowVisibilityEvent.WindowVisibilityChanged, self.windowVisibilityChanged);
  self._cancelReconnect();
  self._cleanupSocket();
...
prototype["getDuration"] = function getDuration() {
  ...
  if (this._connectCompletedTime > 0) {
    num = require(4331) /* sleep */.now() - tmp._connectCompletedTime;
...
prototype["setState"] = function setState(s) {
  ...
  this.emit(require(4351) /* RTCConnectionEvent */.RTCConnectionEvent.State, s, obj, obj);
};
...
prototype["_chooseExperiments"] = function _chooseExperiments(items) {
  ...
  const config = importDefault(5076).getConfig({ location: "_chooseExperiments" });
  if (config.enabled) {
  ...
  const obj = importDefault(5076);
  const tmp3 = importDefault;
  let enabled = require(500) /* set */.isWeb();
  if (enabled) {
    const BrowserTransceiverPaddingRemovalExperiment = tmp8(12949).BrowserTransceiverPaddingRemovalExperiment;
  ...
  if (tmp8Result.isIOS()) {
    const mode = tmp3(12950).getConfig({ location: "_chooseExperiments" }).mode;
    if ("standard" === mode) {
      items.push("ios_video_stabilization_standard");
    } else if ("low_latency" === mode) {
      items.push("ios_video_stabilization_low_latency");
    }
    const tmp3Result = tmp3(12950);
  }
  tmp8Result = tmp8(500);
  let isAndroidResult = tmp8Result.isAndroid();
  if (isAndroidResult) {
    isAndroidResult = tmp8(10753).isSurfaceDirectRendererExperimentEnabled();
    const tmp8Result1 = tmp8(10753);
  }
  if (isAndroidResult) {
    items.push(tmp8(10753).ANDROID_SURFACE_DIRECT_RENDERER_EXPERIMENT);
  }
...
prototype["_connectMediaEngineWithEndpoint"] = function _connectMediaEngineWithEndpoint(_sfuEndpoint, _readyData) {
  ...
  let self = this;
  self = this;
  const importDefault = _sfuEndpoint;
  ...
  const ProcessBoostExperiment = _require(12953).ProcessBoostExperiment;
  ...
  fetchFingerprint = premiumTier === TIER_1.TIER_1;
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.Speaking, (arg0, _lastSentSpeakingStatus, _lastSentSSRC) => {
    if (self.userId === arg0) {
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.NativeMuteChanged, (arg0) => {
    if (self.context === outer1_25.DEFAULT) {
      _sfuEndpoint(_undefined[49]).nativeMuteChanged(arg0);
      const obj = _sfuEndpoint(_undefined[49]);
    }
  });
  connectResult.on(_require(4352).BaseConnectionEvent.Video, (userId, streamId, audioSsrc, arg3, arg4, arr) => {
      ...
      if (arr != null) {
        const item = arr.forEach((quality) => {
          if (100 === quality.quality) {
            outer1_5.emit(userId(table[35]).RTCConnectionEvent.VideoSourceQualityChanged, outer1_5.guildId, outer1_5.channelId, userId, quality.maxResolution, quality.maxFrameRate, outer1_5.context);
          }
        });
      }
    }
  });
  connectResult.on(_require(4352).BaseConnectionEvent.FirstFrame, (arg0, arg1, arg2) => {
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.Silence, (arg0) => {
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.Connected, (protocol, sdp) => {
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.VideoEncoderFallback, (arr) => {
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.VideoDecoderFallback, (arr) => {
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.VideoCodecError, (codecStandard) => {
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.Error, (error) => {
    let obj = self;
    if (socket === self._socket) {
      let preferredRegion = null;
      ...
      _sfuEndpoint(_undefined[41]).track(outer1_17.VOICE_CONNECTION_FAILURE, obj);
      const obj2 = _sfuEndpoint(_undefined[41]);
      obj4 = outer1_15;
    }
  });
  connectResult.on(_require(4352).BaseConnectionEvent.ConnectionStateChange, (arg0) => {
    const logger = self.logger;
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.SecureFramesUpdate, (_secureFramesState) => {
  ...
  connectResult.on(_require(4352).BaseConnectionEvent.Ping, _handlePing.bind(self));
  const _handlePingTimeout = self._handlePingTimeout;
  connectResult.on(_require(4352).BaseConnectionEvent.PingTimeout, _handlePingTimeout.bind(self));
  const _handleOutboundLossRate = self._handleOutboundLossRate;
  connectResult.on(_require(4352).BaseConnectionEvent.OutboundLossRate, _handleOutboundLossRate.bind(self));
  const _handleLocalVideoDisabled = self._handleLocalVideoDisabled;
  connectResult.on(_require(4352).BaseConnectionEvent.LocalVideoDisabled, _handleLocalVideoDisabled.bind(self));
  tmp14 = constants5;
  const tmp2Result1 = _require(500);
  connectResult.on(_require(4352).BaseConnectionEvent.Stats, importDefault(6830).create());
  const _handleRemoteStreamsReady = self._handleRemoteStreamsReady;
  connectResult.on(_require(4352).BaseConnectionEvent.RemoteStreamsReady, _handleRemoteStreamsReady.bind(self));
  const handleUsersMerged = self.handleUsersMerged;
  connectResult.on(_require(4352).BaseConnectionEvent.UsersMerged, handleUsersMerged.bind(self));
  connectResult.on(_require(4352).BaseConnectionEvent.NoiseCancellationError, (_noiseCancellationError) => {
    self._noiseCancellationError = _noiseCancellationError;
  });
  const _handleMLSFailure = self._handleMLSFailure;
  connectResult.on(_require(4352).BaseConnectionEvent.MLSFailure, _handleMLSFailure.bind(self));
...
prototype["handleFlags"] = function handleFlags(arg0, arg1) {
  this.emit(require(4351) /* RTCConnectionEvent */.RTCConnectionEvent.Flags, arg0, arg1);
};
prototype["handlePlatform"] = function handlePlatform(arg0, arg1) {
  this.emit(require(4351) /* RTCConnectionEvent */.RTCConnectionEvent.Platform, arg0, arg1, this.channelId);
};
prototype["handleUsersMerged"] = function handleUsersMerged(arr) {
  this.emit(require(4351) /* RTCConnectionEvent */.RTCConnectionEvent.UsersMerged, arr.map((id) => id.id), this.context);
};
prototype["getOrCreateVideoQuality"] = function getOrCreateVideoQuality() {
  ...
  if (null != this._connection) {
    if (null == self._videoQuality) {
      const videoQuality = new self(12961).VideoQuality(self._connection);
      ...
      const defaultConfig = self(12962).VideoHealthManager.defaultConfig;
      ({ windowLength, allowedPoorFpsRatio, fpsThreshold, backoffTimeSec } = defaultConfig);
      if (defaultConfig.featureEnabled) {
        const videoHealthManager = new tmp10(12962).VideoHealthManager(windowLength, allowedPoorFpsRatio, fpsThreshold, backoffTimeSec);
        self._videoHealthManager = videoHealthManager;
        if (null != self._localMediaSinkWantsManager) {
          self._localMediaSinkWantsManager.videoHealthManager = self._videoHealthManager;
        }
        const _videoQuality = self._videoQuality;
        _videoQuality.on(tmp10(12961).VideoQualityEvent.FpsUpdate, (arg0, arg1, arg2) => {
          const _localMediaSinkWantsManager = self._localMediaSinkWantsManager;
          let result;
          if (_localMediaSinkWantsManager != null) {
...
prototype["_handleVideoStreamId"] = function _handleVideoStreamId(arg0) {
  ...
  this.emit(self(4351).RTCConnectionEvent.Video, this.guildId, this.channelId, userId, streamId, this.streamServerId);
  if (tmp2) {
    const logger = self.logger;
...
prototype["_handlePing"] = function _handlePing(arg0) {
  ...
  if (undefined !== arg0) {
    ...
    self.emit(require(4351) /* RTCConnectionEvent */.RTCConnectionEvent.Ping, self._pings, self.quality);
  }
};
...
prototype["_handleOutboundLossRate"] = function _handleOutboundLossRate(_outboundLossRate) {
  ...
  this.emit(require(4351) /* RTCConnectionEvent */.RTCConnectionEvent.OutboundLossRate, _outboundLossRate);
};
...
prototype["_handleClientConnect"] = function _handleClientConnect(arr) {
  ...
  this.emit(self(4351).RTCConnectionEvent.ClientConnect, arr);
...
prototype["_handleClientDisconnect"] = function _handleClientDisconnect(sender_user_id) {
  ...
  if (null != _videoQuality) {
    if (self.context === constants6.DEFAULT) {
      ...
      if (tmp) {
        ...
        obj = {};
        const merged = Object.assign(self._getAnalyticsProperties());
        obj.app_hardware_acceleration_enabled = importDefault(4249).getAppHardwareAccelerationEnabled();
        obj.media_session_id = self.getMediaSessionId();
        obj.sender_user_id = sender_user_id;
  ...
  self.emit(require(4351) /* RTCConnectionEvent */.RTCConnectionEvent.ClientDisconnect, sender_user_id);
  const _localMediaSinkWantsManager2 = self._localMediaSinkWantsManager;
  ...
  if (1 === self._userIds.size) {
    self._secureFramesLastBecameAloneTime = require(4331) /* sleep */.now();
    const tmp22Result = require(4331) /* sleep */;
  }
};
  ...
  if (!this._voiceConnectionSuccessTracked) {
    if (self.state === constants3.RTC_CONNECTED) {
      if (self._hasCodecs) {
        ...
        obj.connect_time = require(4331) /* sleep */.now() - (1 === self._connectCount ? self._createdTime : self._connectStartTime);
...
prototype["_handleBandwidthEstimationExperiment"] = function _handleBandwidthEstimationExperiment(_bandwidthEstimationExperiment) {
  ...
  const mediaEngineExperiments = importDefault(12964).getMediaEngineExperiments(_bandwidthEstimationExperiment);
...
prototype["_handleSecureFramesInit"] = function _handleSecureFramesInit(v) {
  ...
  if (v > 0) {
    ...
    const tmpResult = require(4331) /* sleep */;
  } else {
    ...
    if (_connection != null) {
      let result2 = _connection.prepareSecureFramesTransition(0, v, () => {
        try {
          ...
          obj[0] = closure_0;
          obj[1] = nowResult(outer1_3[18]).now();
          obj[2] = v;
          obj[3] = flag;
...
prototype["_handleMLSPrepareCommitTransition"] = function _handleMLSPrepareCommitTransition(arg0, arg1) {
  ...
  const dependencyMap = _connection(4331).now();
