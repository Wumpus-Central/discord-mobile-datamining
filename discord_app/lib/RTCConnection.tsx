...
({
  ...
  ConnectionStates: closure_26,
  Codecs: closure_27,
  MediaTypes: closure_28,
  SpeakingFlags: closure_29,
  DISABLED_DEVICE_ID: closure_30,
} = DesktopSources);
let str = "ws:";
if (obj.test("https:")) {
  str = "wss:";
  ...
  if (null == token) {
    ...
    prop.finally(() => {
      closure_1.identify({
        ...
        video: closure_1_12.supports(closure_1_24.VIDEO),
