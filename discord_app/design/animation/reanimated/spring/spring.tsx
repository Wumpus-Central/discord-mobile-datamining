// === Module 4749: CONFIG_NEVER_ANIMATE ===

// Module 4749 (CONFIG_NEVER_ANIMATE)
import set from "set" /* 2 */;
import _mod4119 from "module_4119" /* 4119 */;
import CONFIG_NEVER_ANIMATE2 from "CONFIG_NEVER_ANIMATE" /* 4672 */;
...
function withSpring(value, SUBTLE_SPRING, fn, fn2) {
  ...
  return _mod4119.withSpring(value, tmp5, fn2);
}
withSpring.__closure = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE, ReduceMotion: _mod4119.ReduceMotion, REAwithSpring: _mod4119.withSpring };
...
let obj = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE, ReduceMotion: _mod4119.ReduceMotion, REAwithSpring: _mod4119.withSpring };
