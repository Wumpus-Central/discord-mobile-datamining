// === Module 4879: CONFIG_NEVER_ANIMATE ===

// Module 4879 (CONFIG_NEVER_ANIMATE)
import set from "set" /* 2 */;
import _mod4185 from "module_4185" /* 4185 */;
import CONFIG_NEVER_ANIMATE2 from "CONFIG_NEVER_ANIMATE" /* 4447 */;
...
function withSpring(value, SUBTLE_SPRING, fn, fn2) {
  ...
  return _mod4185.withSpring(value, tmp5, fn2);
}
withSpring.__closure = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE, ReduceMotion: _mod4185.ReduceMotion, REAwithSpring: _mod4185.withSpring };
...
let obj = { accessibilityPreferencesSharedValue: mutable.accessibilityPreferencesSharedValue, CONFIG_NEVER_ANIMATE, ReduceMotion: _mod4185.ReduceMotion, REAwithSpring: _mod4185.withSpring };
