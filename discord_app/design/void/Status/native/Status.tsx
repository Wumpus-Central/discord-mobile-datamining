...
import _modDef14211 from "../../../../../_runtime/metro/14211__.js";
import _modDef14212 from "../../../../../_runtime/metro/14212__.js";
import _modDef14213 from "../../../../../_runtime/metro/14213__.js";
...
export default function Status(isMobileOnline) {
  ...
  if (streaming) {
    let tmp4Result = _modDef14211;
  } else if (flag2) {
    tmp4Result = _modDef14212;
  } else if (flag) {
    tmp4Result = _modDef14213;
  } else if (StatusTypes.IDLE === status) {
    tmp4Result = _modDef14214;
  } else if (StatusTypes.DND === status) {
    tmp4Result = _modDef14215;
  } else {
    if (StatusTypes.OFFLINE !== status) {
      if (StatusTypes.INVISIBLE !== status) {
        const ONLINE = StatusTypes.ONLINE;
        tmp4Result = _modDef14217;
      }
    }
    tmp4Result = _modDef14216;
  }
