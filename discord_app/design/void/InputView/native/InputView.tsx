...
createStyles.inputView = { fontSize: 16, paddingBottom: 0, paddingTop: 0, textAlignVertical: "top", flex: 1, color: fn(5455).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
createStyles.inputViewBorder = { marginTop: 8, height: 2 };
let obj2 = { fontSize: 16, paddingBottom: 0, paddingTop: 0, textAlignVertical: "top", flex: 1, color: fn(5455).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
...
createStyles.charactersLength = { alignSelf: "flex-end", fontFamily: Fonts.CODE_BOLD, color: fn(5455).DARK_PRIMARY_400_LIGHT_PRIMARY_300 };
