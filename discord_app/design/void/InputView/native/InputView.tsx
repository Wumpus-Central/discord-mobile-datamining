...
createStyles.inputView = {
  ...
  flex: 1,
  color: fn(5492).DARK_PRIMARY_100_LIGHT_PRIMARY_500,
};
...
createStyles.charactersLength = {
  ...
  color: fn(5492).DARK_PRIMARY_400_LIGHT_PRIMARY_300,
};
let obj4 = { alignSelf: "flex-end", fontFamily: Fonts.CODE_BOLD, color: fn(5492).DARK_PRIMARY_400_LIGHT_PRIMARY_300 };
