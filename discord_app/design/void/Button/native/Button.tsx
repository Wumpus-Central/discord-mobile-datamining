...
import StylesheetUtils from "StylesheetUtils" /* 12999 */;
...
obj2.buttonOutlined = { backgroundColor: "transparent", borderWidth: 1, borderStyle: "solid", borderColor: fn(5744).BUTTON_OUTLINED_BORDER };
obj2.buttonXsmall = { minHeight: 24 };
obj2.buttonSmall = { minHeight: 32 };
obj2.buttonMedium = { minHeight: 40 };
obj2.buttonLarge = { minHeight: 46 };
const obj33 = { backgroundColor: "transparent", borderWidth: 1, borderStyle: "solid", borderColor: fn(5744).BUTTON_OUTLINED_BORDER };
