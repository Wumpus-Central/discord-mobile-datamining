...
function getTextStyles(disabled, text) {
  ...
  const items = [
    text.text,
    {
      [closure_1_13.BRAND]: text.textBrand,
      [closure_1_13.RED]: text.textRed,
      [closure_1_13.GREEN]: text.textGreen,
      [closure_1_13.PRIMARY]: text.textPrimary,
      [closure_1_13.TRANSPARENT]: text.textTransparent,
      [closure_1_13.GREY]: text.textGrey,
      [closure_1_13.LIGHTGREY]: text.textLightgrey,
      [closure_1_13.WHITE]: text.textWhite,
      [closure_1_13.LINK]: text.textLink,
    }[color],
    {
      [closure_1_12.FILLED]: text.textFilled,
      [closure_1_12.LINK]: text.textLink,
      [closure_1_12.OUTLINED]: text.textOutlined,
    }[look],
    flag ? text.textDisabled : text.textDefault,
    {
      [closure_1_15.XSMALL]: text.textXsmall,
      [closure_1_15.SMALL]: text.textSmall,
      [closure_1_15.MEDIUM]: text.textMedium,
      [closure_1_15.LARGE]: text.textLarge,
    }[size],
  ];
  return items;
}
...
let obj2 = {
  ...
  buttonBrandDefault: { backgroundColor: nativeDefault.colors.BACKGROUND_BRAND },
...
obj2.buttonOutlined = {
  ...
  borderWidth: 1,
  borderStyle: "solid",
  borderColor: fn(5744).BUTTON_OUTLINED_BORDER,
};
...
obj2.textOutlined = { color: fn(5744).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.faded = { opacity: 0.5 };
const obj41 = { color: fn(5744).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
...
obj2.buttonPrimaryDefault = { backgroundColor: fn(5744).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
const obj44 = { backgroundColor: fn(5744).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.buttonPrimaryDarkDefault = { backgroundColor: fn(5744).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
const obj45 = { backgroundColor: fn(5744).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.buttonGreyDefault = { backgroundColor: fn(5744).DARK_PRIMARY_500_LIGHT_PRIMARY_430 };
const obj46 = { backgroundColor: fn(5744).DARK_PRIMARY_500_LIGHT_PRIMARY_430 };
obj2.textPrimary = { color: fn(5744).DARK_PRIMARY_500_LIGHT_PRIMARY_100 };
const obj47 = { color: fn(5744).DARK_PRIMARY_500_LIGHT_PRIMARY_100 };
obj2.textTransparent = { color: fn(5744).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
const obj48 = { color: fn(5744).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
obj2.buttonPrimaryDisabled = { backgroundColor: fn(5744).BUTTON_PRIMARY_DISABLED_BACKGROUND };
const obj49 = { backgroundColor: fn(5744).BUTTON_PRIMARY_DISABLED_BACKGROUND };
obj2.buttonPrimaryDarkDisabled = { backgroundColor: fn(5744).BUTTON_PRIMARY_DISABLED_BACKGROUND };
const obj50 = { backgroundColor: fn(5744).BUTTON_PRIMARY_DISABLED_BACKGROUND };
obj2.buttonGreyDisabled = { backgroundColor: fn(5744).BUTTON_GREY_DISABLED_BACKGROUND };
