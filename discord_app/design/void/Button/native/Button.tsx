...
ColorUtils = { backgroundColor: "transparent", borderWidth: 1, borderStyle: "solid", borderColor: fn(5491).BUTTON_OUTLINED_BORDER };
...
ColorUtils = { color: fn(5491).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
...
ColorUtils = { backgroundColor: fn(5491).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
createStyles.buttonPrimaryDefault = ColorUtils;
const obj30 = { color: nativeDefault.colors.TEXT_LINK };
createStyles.buttonPrimaryDarkDefault = { backgroundColor: fn(5491).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
const obj32 = { backgroundColor: fn(5491).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
createStyles.buttonGreyDefault = { backgroundColor: fn(5491).DARK_PRIMARY_500_LIGHT_PRIMARY_430 };
const obj33 = { backgroundColor: fn(5491).DARK_PRIMARY_500_LIGHT_PRIMARY_430 };
createStyles.textPrimary = { color: fn(5491).DARK_PRIMARY_500_LIGHT_PRIMARY_100 };
const obj34 = { color: fn(5491).DARK_PRIMARY_500_LIGHT_PRIMARY_100 };
createStyles.textTransparent = { color: fn(5491).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
const obj35 = { color: fn(5491).DARK_PRIMARY_100_LIGHT_PRIMARY_500 };
createStyles.buttonPrimaryDisabled = { backgroundColor: fn(5491).BUTTON_PRIMARY_DISABLED_BACKGROUND };
const obj36 = { backgroundColor: fn(5491).BUTTON_PRIMARY_DISABLED_BACKGROUND };
createStyles.buttonPrimaryDarkDisabled = { backgroundColor: fn(5491).BUTTON_PRIMARY_DISABLED_BACKGROUND };
const obj37 = { backgroundColor: fn(5491).BUTTON_PRIMARY_DISABLED_BACKGROUND };
createStyles.buttonGreyDisabled = { backgroundColor: fn(5491).BUTTON_GREY_DISABLED_BACKGROUND };
