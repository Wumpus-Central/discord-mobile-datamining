...
const inlineStyles = Circle(8803);
const inlineStylesDefault = tmp9(8803);
require = fn;
...
function AnimatedNativeCutoutAvatarImage(cutout) {
  ...
  obj2 = { cutout, CutoutShape: cutout(9170).CutoutShape, withSpring: cutout(5270).withSpring, CHANNEL_SPRING_CONFIG };
  fn.__closure = obj2;
  fn.__workletHash = 12529564164821;
  fn.__initData = __initData;
  const animatedProps = cutout(4559).useAnimatedProps(fn);
  let obj = cutout(4559);
  ...
  return closure_7(cutout(9170).ClipViewAnimated, obj3);
}
