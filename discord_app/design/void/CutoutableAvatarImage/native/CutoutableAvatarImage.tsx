...
function AnimatedNativeCutoutAvatarImage(cutout) {
  ...
  const fn = function h() {
    ...
    if (cutout.shape === ClipView.CutoutShape.RoundedRect) {
      size = { shape: ClipView.CutoutShape.RoundedRect, x: null, y: null, width: null, height: null, cornerRadius: null };
  ...
  let __closure = { cutout, CutoutShape: cutout(8940).CutoutShape, withSpring: cutout(5055).withSpring, CHANNEL_SPRING_CONFIG };
  ...
  return closure_7(cutout(8940).ClipViewAnimated, __closure);
}
