...
const forwardRefResult = importAllResult.forwardRef((keyboardShouldPersistTaps, ref) => {
  ...
  const tmp = callback();
  let redesign = importAllResult.useContext(require(5314) /* context */.RedesignCompatContext);
  ...
  items[2] = redesign;
  obj[3] = items;
  obj = { paddingBottom: 38 + importDefault(5310)().insets.bottom };
  ...
  obj[9] = onScroll;
  obj[10] = children;
  obj[1] = <ScrollView paddingBottom={38 + importDefault(5310)().insets.bottom} />;
  return <context.Provider paddingBottom={38 + importDefault(5310)().insets.bottom} />;
});
