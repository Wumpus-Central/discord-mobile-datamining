...
const forwardRefResult = importAllResult.forwardRef((keyboardShouldPersistTaps, ref) => {
  ...
  const tmp = callback();
  let redesign = importAllResult.useContext(require("../../../components/RedesignCompat/native/RedesignCompat.native.tsx") /* context */.RedesignCompatContext);
  ...
  items[2] = redesign;
  obj[3] = items;
  obj = { paddingBottom: 38 + require("../../../../modules/safe_area/useSafeAreaInsetsKeyboardAware.native.tsx")().insets.bottom };
  ...
  obj[9] = onScroll;
  obj[10] = children;
  obj[1] = <ScrollView paddingBottom={38 + require("../../../../modules/safe_area/useSafeAreaInsetsKeyboardAware.native.tsx")().insets.bottom} />;
  return <context.Provider paddingBottom={38 + require("../../../../modules/safe_area/useSafeAreaInsetsKeyboardAware.native.tsx")().insets.bottom} />;
});
