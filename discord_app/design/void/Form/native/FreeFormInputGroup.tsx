...
import FreeFormLabelDefault from "FreeFormLabel" /* 8691 */;
import ClearButtonDefault from "ClearButton" /* 8692 */;
import LabelDefault from "Label" /* 8694 */;
...
const forwardRefResult = importAllResult.forwardRef((accessibilityLabel, ref) => {
  ...
  if (context) {
    ...
    return callback(tmp8(8002).TextInput, obj);
  } else {
    ...
    if (null != hint) {
      ...
      obj4[0] = tmp2.hint;
      obj4[3] = hint;
      tmp17Result = tmp17(tmp8(4440).Text, obj4);
    }
    items[3] = tmp17Result;
    obj[1] = items;
