...
import FreeFormLabelDefault from "FreeFormLabel" /* 7679 */;
import ClearButtonDefault from "ClearButton" /* 7680 */;
import LabelDefault from "Label" /* 7682 */;
...
const forwardRefResult = importAllResult.forwardRef((accessibilityLabel, ref) => {
  ...
  if (context) {
    ...
    return callback(tmp8(7673).TextInput, obj);
  } else {
    ...
    if (null != hint) {
      ...
      obj4[0] = tmp2.hint;
      obj4[3] = hint;
      tmp17Result = tmp17(tmp8(4444).Text, obj4);
    }
    items[3] = tmp17Result;
    obj[1] = items;
