...
createStyles.title = { fontSize: nativeDefault.space.PX_16, lineHeight: 18, color: nativeDefault.colors.MOBILE_TEXT_HEADING_PRIMARY, fontFamily: Fonts.PRIMARY_SEMIBOLD };
let obj1 = { fontSize: nativeDefault.space.PX_16, lineHeight: 18, color: nativeDefault.colors.MOBILE_TEXT_HEADING_PRIMARY, fontFamily: Fonts.PRIMARY_SEMIBOLD };
createStyles.description = { fontSize: 12, lineHeight: 18, color: nativeDefault.colors.TEXT_SUBTLE, fontFamily: Fonts.PRIMARY_MEDIUM };
...
export default function FormCTA(arg0) {
  ...
  if ("row-button" === variant) {
    ...
    const obj1 = { arrow: false, onPress, onLongPress, accessibilityState: null, label: null, subLabel: null, trailing: null, icon: null };
    ...
    const obj5 = { start: true, end: true, variant, onPress, onLongPress, DEPRECATED_style: null, accessibilityState: null, label: null, subLabel: null, trailing: null, leading: null };
