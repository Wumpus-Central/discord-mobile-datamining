...
obj = {
  ...
  paddingVertical: ThemesDefault.space.PX_32,
};
obj[0] = obj;
createCacheKey = {
  width: 8,
...
let closure_8 = importAllResult.memo((active) => {
  ...
  const fn2 = function u() {
    const obj = {
      width: active(BRAND_500[5]).interpolate(derivedValue.get(), [0, 1], [8, 16]),
...
export default function CarouselPagination(currentIndex) {
  ...
  obj[0] = items;
  obj[4] = Array.from({ length: numberOfItems }, (arg0, arg1) =>
    closure_1_4(closure_1_8, { active: arg1 === currentIndex }, arg1),
  );
  return (
