...
const require = fn;
let obj = { position: "relative", top: -16, marginBottom: -16, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: ThemesDefault.space.PX_20, paddingVertical: ThemesDefault.space.PX_32 };
obj[0] = obj;
const createCacheKey = { width: 8, height: 8, borderRadius: ThemesDefault.radii.xs, marginHorizontal: 4, backgroundColor: ThemesDefault.colors.ICON_STRONG };
...
let closure_8 = importAllResult.memo((active) => {
  ...
  let obj = { withTiming: active(BRAND_500[6]).withTiming, active, STANDARD_EASING: active(BRAND_500[7]).STANDARD_EASING };
  fn.__closure = obj;
...
const result = require("obj132").fileFinishedImporting("design/void/CarouselPagination/native/CarouselPagination.tsx");
...
export default function CarouselPagination(currentIndex) {
  ...
  obj[0] = items;
  obj[4] = Array.from({ length: numberOfItems }, (arg0, arg1) => <closure_1_8 key={arg1} active={arg1 === currentIndex} />);
