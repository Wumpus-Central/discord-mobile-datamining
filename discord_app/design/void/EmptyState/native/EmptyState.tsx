...
export default function EmptyState(Illustration) {
  ...
  if (null != title) {
    ...
    let tmp25 = null;
    if (null != title) {
      const obj3 = { variant: "heading-lg/semibold", color: "mobile-text-heading-primary", maxFontSizeMultiplier: 2, style: null, children: null };
    ...
    let tmp27 = null;
    if (null != body) {
      const obj4 = { variant: "text-md/medium", color: "text-muted", maxFontSizeMultiplier: 2, style: null, children: null };
