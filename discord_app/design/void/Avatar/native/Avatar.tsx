...
export default noop.memo((isMobileOnline) => {
  ...
  const memo = NORMAL.useMemo(() => {
    if (null != autoStatusCutout) {
      ...
      obj2 = { cutout, decorationCutout: avatar_decorations_AvatarDecorationUtils.getDecorationCutoutForAvatarCutout(cutout, -decoration.decoration.top) };
      return obj2;
    }
  }, items);
      ...
      if (null == user) {
        if (null == channel) {
          ...
          if (null != status) {
            ...
            if (status !== autoStatusCutout.UNKNOWN) {
              ...
              if (null != statusSizeOverride) {
                let obj1 = { size: statusSizeOverride, isMobileOnline: flag, isVROnline: flag2, status, streaming, style: null };
          ...
          if (deaf) {
            ...
            obj4.style = items4;
            const obj5 = { size: flag2(tmp7[15]).Sizes.REFRESH_SMALL_16, source: flag2(tmp7[16]), color: flag2(tmp7[6]).unsafe_rawColors.WHITE };
            ...
            obj6.style = items5;
            const obj7 = { size: flag2(tmp7[15]).Sizes.REFRESH_SMALL_16, source: flag2(tmp7[17]), color: flag2(tmp7[6]).unsafe_rawColors.WHITE };
