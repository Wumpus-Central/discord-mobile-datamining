...
function CollapsableButton(arg0) {
  ...
  B.__closure = {
    FAB_BUTTON_SIZE: collapseText(5286).FAB_BUTTON_SIZE,
    withSpring: collapseText(5280).withSpring,
    interpolate: collapseText(4566).interpolate,
    collapseText,
    FAB_PADDING_HORIZONTAL: 20,
    FAB_PADDING_VERTICAL: buttonPadding,
    SUBTLE_SPRING: collapseText(5284).SUBTLE_SPRING,
  };
