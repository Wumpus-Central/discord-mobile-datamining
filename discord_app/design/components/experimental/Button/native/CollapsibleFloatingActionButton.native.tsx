...
function CollapsableButton(arg0) {
  ...
  B.__closure = {
    FAB_BUTTON_SIZE: collapseText(5191).FAB_BUTTON_SIZE,
    withSpring: collapseText(5185).withSpring,
    interpolate: collapseText(4492).interpolate,
    collapseText,
    FAB_PADDING_HORIZONTAL: 20,
    FAB_PADDING_VERTICAL: buttonPadding,
    SUBTLE_SPRING: collapseText(5189).SUBTLE_SPRING,
  };
