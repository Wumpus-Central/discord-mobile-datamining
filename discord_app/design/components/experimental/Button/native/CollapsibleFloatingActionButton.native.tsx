...
function CollapsableButton(arg0) {
  ...
  B.__closure = {
    FAB_BUTTON_SIZE: collapseText(5065).FAB_BUTTON_SIZE,
    withSpring: collapseText(5059).withSpring,
    interpolate: collapseText(4374).interpolate,
    collapseText,
    FAB_PADDING_HORIZONTAL: 20,
    FAB_PADDING_VERTICAL: buttonPadding,
    SUBTLE_SPRING: collapseText(5063).SUBTLE_SPRING,
  };
