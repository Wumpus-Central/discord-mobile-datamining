// === Module 8884: CollapsableButton ===

// Module 8884 (CollapsableButton)
import ThemesDefault from "Themes" /* 712 */;
import styles2 from "styles" /* 8885 */;
...
function CollapsableButton(arg0) {
  ...
  obj = { FAB_BUTTON_SIZE: collapseText(4884).FAB_BUTTON_SIZE, withSpring: collapseText(4878).withSpring, interpolate: collapseText(4184).interpolate, collapseText, FAB_PADDING_HORIZONTAL: 20, FAB_PADDING_VERTICAL: buttonPadding, SUBTLE_SPRING: collapseText(4882).SUBTLE_SPRING };
  B.__closure = obj;
  ...
  return jsx(collapseText(4880).BaseTextButton, {});
}
...
export const CollapsibleFloatingActionButton = function CollapsibleFloatingActionButton(arg0) {
  ...
  if (positionRight == null) {
    positionRight = tmp3(8885).DEFAULT_POSITION_OFFSET;
  }
  obj = { position: "absolute", right: positionRight, bottom: null };
  if (positionBottom == null) {
    positionBottom = tmp3(8885).DEFAULT_POSITION_OFFSET;
  }
  ...
  if (null != state) {
    ...
    tmp12 = jsx(tmp3(4880).BaseTextButton, {});
  }
  return tmp12;
};