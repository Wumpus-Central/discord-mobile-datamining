...
function CollapsableButton(arg0) {
  ...
  B.__closure = {
    FAB_BUTTON_SIZE: collapseText(5192).FAB_BUTTON_SIZE,
    withSpring: collapseText(5186).withSpring,
    interpolate: collapseText(4493).interpolate,
    collapseText,
    FAB_PADDING_HORIZONTAL: 20,
    FAB_PADDING_VERTICAL: buttonPadding,
    SUBTLE_SPRING: collapseText(5190).SUBTLE_SPRING,
  };
