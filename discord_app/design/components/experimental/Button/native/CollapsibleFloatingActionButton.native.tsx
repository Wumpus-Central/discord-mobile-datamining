...
function CollapsableButton(arg0) {
  ...
  obj = { FAB_BUTTON_SIZE: collapseText(4994).FAB_BUTTON_SIZE, withSpring: collapseText(4988).withSpring, interpolate: collapseText(4310).interpolate, collapseText, FAB_PADDING_HORIZONTAL: 20, FAB_PADDING_VERTICAL: buttonPadding, SUBTLE_SPRING: collapseText(4992).SUBTLE_SPRING };
  B.__closure = obj;
