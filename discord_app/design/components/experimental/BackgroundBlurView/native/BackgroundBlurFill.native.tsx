...
export const BackgroundBlurFillWithPress = function BackgroundBlurFillWithPress(style) {
  ...
  obj = { withSpring: tmp2(5025).withSpring, interpolateColor: tmp2(4343).interpolateColor, pressed, fallbackColor: token, fallbackColorPressed: token1, ON_PRESS_SPRING: tmp2(5029).ON_PRESS_SPRING };
  fn.__closure = obj;
  ...
  obj = { shouldUseFallback: isBlurDisabledResult, withSpring: tmp2(5025).withSpring, interpolateColor: tmp2(4343).interpolateColor, pressed, restingTint: tmp6, pressedTint: tmp7, ON_PRESS_SPRING: tmp2(5029).ON_PRESS_SPRING };
  C.__closure = obj;
