...
export const BackgroundBlurFill = function BackgroundBlurFill(arg0) {
  ...
  obj = blurTheme(4347);
  const tmpResult = blurTheme(4338);
...
export const BackgroundBlurFillWithPress = function BackgroundBlurFillWithPress(style) {
  ...
  const tmp2Result13 = pressed(4373);
  fn.__closure = { withSpring: pressed(5055).withSpring, interpolateColor: pressed(4373).interpolateColor, pressed, fallbackColor: token, fallbackColorPressed: token1, ON_PRESS_SPRING: pressed(5059).ON_PRESS_SPRING };
  fn.__workletHash = 10497618157620;
  fn.__initData = __initData;
  let animatedStyle = tmp2Result13.useAnimatedStyle(fn);
  let obj2 = { withSpring: pressed(5055).withSpring, interpolateColor: pressed(4373).interpolateColor, pressed, fallbackColor: token, fallbackColorPressed: token1, ON_PRESS_SPRING: pressed(5059).ON_PRESS_SPRING };
  class C {
    constructor() {
  ...
  const tmp2Result14 = pressed(4373);
  C.__closure = { shouldUseFallback: isBlurDisabledResult, withSpring: pressed(5055).withSpring, interpolateColor: pressed(4373).interpolateColor, pressed, restingTint: tmp6, pressedTint: tmp7, ON_PRESS_SPRING: pressed(5059).ON_PRESS_SPRING };
  ...
  let obj3 = { shouldUseFallback: isBlurDisabledResult, withSpring: pressed(5055).withSpring, interpolateColor: pressed(4373).interpolateColor, pressed, restingTint: tmp6, pressedTint: tmp7, ON_PRESS_SPRING: pressed(5059).ON_PRESS_SPRING };
  const tmp12 = c5;
