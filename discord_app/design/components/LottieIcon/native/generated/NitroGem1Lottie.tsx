...
import { registerAsset } from "../../../../../../_runtime/13304_registerAsset.js";
...
const forwardRefResult = require("noop").forwardRef((arg0, arg1) => {
  ...
  return jsx(LottieIcon /* LottieIcon */.LottieIcon, { dotLottie: null, animation: "all", ref: null, layers: null, markers: null });
});
