...
export const LottieIcon = noop.forwardRef((color, arg1) => {
  ...
  obj.style = items4;
  obj.children = jsx(_modDef5544, { ref, source: color.dotLottie, colorFilters: null, hardwareAccelerationAndroid: true, loop: false, onAnimationLoaded: null, resizeMode: "cover", style: null });
