...
export const DiscordQuestsLockupLogo = function DiscordQuestsLockupLogo(color) {
  ...
  const obj1 = { fadeDuration: 0, source: { uri: _modDef5960 }, style: null, accessible, accessibilityLabel, resizeMode };
  const size = { width: num * num3, height: num2 * num3 };
  const items = [size, tmp6];
  obj1.style = items;
  return <Image fadeDuration={0} source={{ uri: _modDef5960 }} style={null} accessible={accessible} accessibilityLabel={accessibilityLabel} resizeMode={resizeMode} />;
};