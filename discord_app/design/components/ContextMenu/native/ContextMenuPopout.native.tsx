...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = {
    withSpring: visible(5058).withSpring,
    visible,
    CONTEXT_MENU_SPRING: visible(8794).CONTEXT_MENU_SPRING,
  };
  ...
  return closure_6(visible(5047).Backdrop, obj3);
}
...
obj2.container = {
  ...
  minWidth: fn(8794).CONTEXT_MENU_MIN_WIDTH,
};
let obj3 = {
  position: "absolute",
  backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST,
...
obj2.divider = {
  borderBottomWidth: fn(8794).CONTEXT_MENU_DIVIDER_HEIGHT,
