...
function ContextMenuBackdrop(onDismiss) {
  ...
  obj = { withSpring: visible(4694).withSpring, visible, CONTEXT_MENU_SPRING: visible(8523).CONTEXT_MENU_SPRING };
  fn.__closure = obj;
  ...
  obj[4] = stringResult;
  return tmp3(visible(4683).Backdrop, obj);
}
