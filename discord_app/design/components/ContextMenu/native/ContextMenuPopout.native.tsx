...
function ContextMenuBackdrop(onDismiss) {
  ...
  let obj = { withSpring: visible(4988).withSpring, visible, CONTEXT_MENU_SPRING: visible(8701).CONTEXT_MENU_SPRING };
  fn.__closure = obj;
  ...
  return closure_6(visible(4977).Backdrop, obj);
}
...
createStyles = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8701).CONTEXT_MENU_MIN_WIDTH };
const merged = Object.assign(nativeDefault.shadows.SHADOW_HIGH);
createStyles.container = createStyles;
createStyles.titleContainer = { padding: fn(8701).CONTEXT_MENU_ITEM_PADDING };
let obj1 = { padding: fn(8701).CONTEXT_MENU_ITEM_PADDING };
createStyles.divider = { borderBottomWidth: fn(8701).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
