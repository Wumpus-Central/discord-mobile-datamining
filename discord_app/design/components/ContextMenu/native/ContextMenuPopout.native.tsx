// === Module 14534: ContextMenuPopout ===
...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = { withSpring: visible(5270).withSpring, visible, CONTEXT_MENU_SPRING: visible(8262).CONTEXT_MENU_SPRING };
  ...
  const obj2 = { withSpring: visible(5270).withSpring, visible, CONTEXT_MENU_SPRING: visible(8262).CONTEXT_MENU_SPRING };
...
obj2.container = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8262).CONTEXT_MENU_MIN_WIDTH };
let obj3 = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8262).CONTEXT_MENU_MIN_WIDTH };
obj2.titleContainer = { padding: fn(8262).CONTEXT_MENU_ITEM_PADDING };
let obj4 = { padding: fn(8262).CONTEXT_MENU_ITEM_PADDING };
obj2.divider = { borderBottomWidth: fn(8262).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
