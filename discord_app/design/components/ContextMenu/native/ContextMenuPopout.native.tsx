...
function ContextMenuBackdrop(onDismiss) {
  ...
  obj = { withSpring: visible(4713).withSpring, visible, CONTEXT_MENU_SPRING: visible(8600).CONTEXT_MENU_SPRING };
  fn.__closure = obj;
  ...
  obj[4] = stringResult;
  return tmp3(visible(4702).Backdrop, obj);
}
