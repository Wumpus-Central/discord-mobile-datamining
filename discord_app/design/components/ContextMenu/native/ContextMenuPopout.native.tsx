...
function ContextMenuBackdrop(onDismiss) {
  ...
  obj = { withSpring: visible(4711).withSpring, visible, CONTEXT_MENU_SPRING: visible(8540).CONTEXT_MENU_SPRING };
  fn.__closure = obj;
  ...
  obj[4] = stringResult;
  return tmp3(visible(4700).Backdrop, obj);
}
