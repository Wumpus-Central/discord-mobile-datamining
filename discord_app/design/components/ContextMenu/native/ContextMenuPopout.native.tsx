// === Module 14454: ContextMenuPopout ===
...
import ContextMenuConstants from "ContextMenuConstants" /* 8180 */;
...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = { withSpring: visible(5186).withSpring, visible, CONTEXT_MENU_SPRING: visible(8180).CONTEXT_MENU_SPRING };
  ...
  const obj2 = { withSpring: visible(5186).withSpring, visible, CONTEXT_MENU_SPRING: visible(8180).CONTEXT_MENU_SPRING };
  ...
  return closure_6(visible(5173).Backdrop, obj3);
}
...
obj2.container = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8180).CONTEXT_MENU_MIN_WIDTH };
let obj3 = { position: "absolute", backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST, borderWidth: 1, borderColor: nativeDefault.colors.BORDER_SUBTLE, borderRadius: nativeDefault.radii.lg, minWidth: fn(8180).CONTEXT_MENU_MIN_WIDTH };
obj2.titleContainer = { padding: fn(8180).CONTEXT_MENU_ITEM_PADDING };
let obj4 = { padding: fn(8180).CONTEXT_MENU_ITEM_PADDING };
obj2.divider = { borderBottomWidth: fn(8180).CONTEXT_MENU_DIVIDER_HEIGHT, borderBottomColor: nativeDefault.colors.BORDER_SUBTLE };
