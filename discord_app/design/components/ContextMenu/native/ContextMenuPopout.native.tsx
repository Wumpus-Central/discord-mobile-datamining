...
function ContextMenuBackdrop(onDismiss) {
  ...
  fn.__closure = {
    withSpring: visible(5186).withSpring,
    visible,
    CONTEXT_MENU_SPRING: visible(8180).CONTEXT_MENU_SPRING,
  };
...
obj2.container = {
  ...
  minWidth: fn(8180).CONTEXT_MENU_MIN_WIDTH,
};
let obj3 = {
  position: "absolute",
  backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGHEST,
...
obj2.divider = {
  borderBottomWidth: fn(8180).CONTEXT_MENU_DIVIDER_HEIGHT,
