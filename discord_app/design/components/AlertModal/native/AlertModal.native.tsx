...
function AlertModalBackdrop() {
  ...
  __closure = { withAlertModalSpring, sharedVisible: tmp4, sharedTransitionState, TransitionStates: context(4317).TransitionStates, runOnJS: context(4343).runOnJS, cleanUp: context };
