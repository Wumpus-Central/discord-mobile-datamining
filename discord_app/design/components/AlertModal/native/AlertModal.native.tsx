...
function AlertModalBackdrop() {
  ...
  dependencyMap = tmp4;
  const alertStore = context(5197).useAlertStore((arg0) => {
  ...
  let obj2 = context(4561);
  fn.__closure = {
    withAlertModalSpring,
    sharedVisible: tmp2[1],
    sharedTransitionState,
    TransitionStates: context(4535).TransitionStates,
    runOnJS: context(4561).runOnJS,
    cleanUp: context,
  };
  ...
  return closure_10(context(5259).Backdrop, obj4);
}
class AlertModal {
  constructor(arg0) {
...
let context = noop.createContext(fn(4535).TransitionStates.YEETED);
...
let obj4 = { withSpring: fn(5272).withSpring, MODAL_SPRING: obj3 };
