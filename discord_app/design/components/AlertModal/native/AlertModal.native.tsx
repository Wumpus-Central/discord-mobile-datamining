...
function AlertModalBackdrop() {
  ...
  fn.__closure = { withAlertModalSpring, sharedVisible: tmp2[1], sharedTransitionState, TransitionStates: context(4540).TransitionStates, runOnJS: context(4566).runOnJS, cleanUp: context };
