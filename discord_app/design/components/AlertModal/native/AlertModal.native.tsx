...
function dismissTopAlert() {
  const useAlertStore = _require("useAlertStore.native.tsx").useAlertStore;
...
function AlertModalBackdrop() {
  ...
  obj = { withAlertModalSpring, sharedVisible: tmp4, sharedTransitionState: first, TransitionStates: context(4629).TransitionStates, runOnJS: context(4146).runOnJS, cleanUp: context };
  fn.__closure = obj;
  fn.__workletHash = 4470729133936;
  fn.__initData = closure_22;
  const animatedStyle = context(4146).useAnimatedStyle(fn);
  ...
  return closure_10(context(4683).Backdrop, obj);
}
class AlertModal {
  constructor(arg0) {
    ...
    return tmp16(require("module_4146").View, obj1);
  }
}
...
function withAlertModalSpring(value, fn2) {
  return require("../../../animation/reanimated/spring/spring.tsx") /* CONFIG_NEVER_ANIMATE */.withSpring(value, createCacheKey, "animate-always", fn2);
}
...
export const showConfirmModal = function showConfirmModal(arg0) {
  ...
  if (cancelText === undefined) {
    ...
    cancelText = intl.string(require("../../../../intl/index.native.tsx") /* getSystemLocale */.t["ETE/oC"]);
  }
  ...
  let obj = require("useAlertStore.native.tsx") /* useAlertStore */;
