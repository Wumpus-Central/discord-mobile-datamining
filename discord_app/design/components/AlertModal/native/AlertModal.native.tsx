...
function AlertModalBackdrop() {
  ...
  obj = { withAlertModalSpring, sharedVisible: tmp4, sharedTransitionState: first, TransitionStates: context(4599).TransitionStates, runOnJS: context(4116).runOnJS, cleanUp: context };
  fn.__closure = obj;
  ...
  return closure_10(context(4653).Backdrop, obj);
}
class AlertModal {
  constructor(arg0) {
...
class AlertActionButton {
  constructor(arg0) {
    ({ onPress: f104356, loading } = global);
