...
function AlertModalBackdrop() {
  ...
  __closure = { withAlertModalSpring, sharedVisible: tmp4, sharedTransitionState, TransitionStates: context(4284).TransitionStates, runOnJS: context(4310).runOnJS, cleanUp: context };
