...
function AlertModalBackdrop() {
  ...
  __closure = { withAlertModalSpring, sharedVisible: tmp4, sharedTransitionState, TransitionStates: context(4315).TransitionStates, runOnJS: context(4341).runOnJS, cleanUp: context };
