...
function AlertModalBackdrop() {
  ...
  fn.__closure = { withAlertModalSpring, sharedVisible: tmp2[1], sharedTransitionState, TransitionStates: context(4467).TransitionStates, runOnJS: context(4493).runOnJS, cleanUp: context };
