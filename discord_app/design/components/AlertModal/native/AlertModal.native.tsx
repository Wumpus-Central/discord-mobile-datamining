...
function AlertModalBackdrop() {
  ...
  fn.__closure = { withAlertModalSpring, sharedVisible: tmp2[1], sharedTransitionState, TransitionStates: context(4535).TransitionStates, runOnJS: context(4561).runOnJS, cleanUp: context };
