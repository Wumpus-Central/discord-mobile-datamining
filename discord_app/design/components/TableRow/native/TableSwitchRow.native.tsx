...
export const TableSwitchRow = function TableSwitchRow(value) {
  ...
  if (null != trailing) {
    ...
    if (!noop.isValidElement(label)) {
      ...
      tmp10Result = hasOwnProperty(tmp3(4602).Text, obj1);
    }
  ...
  obj.trailing = hasOwnProperty(FormSwitch.FormSwitch, { "aria-hidden": true, value, onValueChange: handleOnPress, disabled });
