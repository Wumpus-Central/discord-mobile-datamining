...
function RowButtonWrapper(isRefreshEnabled) {
  ...
  if (isRefreshEnabled.experimental_withBlurBackground) {
    ...
    obj[0] = sharedValue;
    obj[1] = children;
    obj.children = jsx(tmp3(7894).BackgroundBlurView, { pressed: null, children: null });
    return jsx(tmp3(5356).InternalCard, { pressed: null, children: null });
  } else {
    let str = "subtle";
    if (flag) {
    ...
    return jsx(tmp3(5356).InternalCard, { shadow: "low", start: true, end: true, onPress: null, style: null, disabled: null });
  }
}
