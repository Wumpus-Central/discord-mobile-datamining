...
const result = require("obj132").fileFinishedImporting("design/components/TableRow/native/TableRowIcon.native.tsx");
  ...
  switch (variant) {
    ...
    case "text":
      ...
      if (null != IconComponent) {
        ...
        obj[0] = str3;
        obj[1] = color;
        let tmp11Result = <IconComponent size={null} color={null} />;
      } else {
        obj = { color: null, source: null, size: null };
        obj[0] = color;
        obj[1] = source;
        obj[2] = REFRESH_SMALL_16;
        tmp11Result = jsx(IconSizesDefault, { color: null, source: null, size: null });
      }
      obj[1] = tmp11Result;
