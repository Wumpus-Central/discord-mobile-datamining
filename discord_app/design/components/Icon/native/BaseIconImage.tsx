...
require = arg1;
noopAll;
let closure_4 = { xxs: { width: 12, height: 12 }, xs: { width: 16, height: 16 }, sm: { width: 18, height: 18 }, md: { width: 24, height: 24 }, lg: { width: 32, height: 32 }, custom: { width: "disabled", height: "Date" }, refresh_sm: { width: 18, height: 18 } };
