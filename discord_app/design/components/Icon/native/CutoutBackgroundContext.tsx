...
const result = require("obj132").fileFinishedImporting("design/components/Icon/native/CutoutBackgroundContext.tsx");
...
export const CutoutBackgroundProvider = function CutoutBackgroundProvider(children) {
  ...
  const context = importAllResult.useContext(redux);
