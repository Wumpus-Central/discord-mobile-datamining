...
import _mod15918 from "../../../../../../../_runtime/metro/15918__.js";
...
export const FileWarningIcon = function FileWarningIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod15918, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
