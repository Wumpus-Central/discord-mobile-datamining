...
const result = size.fileFinishedImporting(
  "design/components/Icon/native/redesign/generated/VoiceNormalSpoilerIcon.tsx",
);
...
export const VoiceNormalSpoilerIcon = function VoiceNormalSpoilerIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod5341, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
