...
import _mod8738 from "../../../../../../../_runtime/metro/08738__.js";
import _mod8739 from "../../../../../../../_runtime/metro/08739__.js";
import _mod8740 from "../../../../../../../_runtime/metro/08740__.js";
...
export const MinecraftNeutralIcon = function MinecraftNeutralIcon(secondaryColor) {
  ...
  obj = { source: _mod8738, color, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj), ,];
  obj = { source: _mod8739, color: str, style: null };
  const items1 = [style];
  const items2 = [];
  ...
  const obj1 = { source: _mod8740, color: str2, style: null };
  const items3 = [style];
  const items4 = [];
