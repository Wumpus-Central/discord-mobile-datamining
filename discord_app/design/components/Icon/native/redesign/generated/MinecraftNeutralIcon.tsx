...
import _mod8981 from "../../../../../../../_runtime/metro/08981__.js";
import _mod8982 from "../../../../../../../_runtime/metro/08982__.js";
import _mod8983 from "../../../../../../../_runtime/metro/08983__.js";
...
export const MinecraftNeutralIcon = function MinecraftNeutralIcon(secondaryColor) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod8981, color, style }), ,];
  const obj3 = { source: _mod8982, color: str, style: null };
  const items1 = [style];
  const items2 = [];
  ...
  const obj4 = { source: _mod8983, color: str2, style: null };
  const items3 = [style];
  const items4 = [];
