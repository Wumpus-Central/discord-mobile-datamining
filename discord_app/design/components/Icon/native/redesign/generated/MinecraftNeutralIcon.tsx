...
import _mod8976 from "../../../../../../../_runtime/metro/08976__.js";
import _mod8977 from "../../../../../../../_runtime/metro/08977__.js";
import _mod8978 from "../../../../../../../_runtime/metro/08978__.js";
...
export const MinecraftNeutralIcon = function MinecraftNeutralIcon(secondaryColor) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod8976, color, style }), ,];
  const obj3 = { source: _mod8977, color: str, style: null };
  const items1 = [style];
  const items2 = [];
  ...
  const obj4 = { source: _mod8978, color: str2, style: null };
  const items3 = [style];
  const items4 = [];
