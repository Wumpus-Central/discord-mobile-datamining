// === Module 8804: MinecraftNeutralIcon ===
...
export const MinecraftNeutralIcon = function MinecraftNeutralIcon(secondaryColor) {
  ...
  obj1[0] = require(8807) /* registerAsset */;
  obj1[1] = str2;
  const items3 = [style];
  const items4 = [];
  ...
  items[2] = callback(require(3958) /* BaseIconImage */.BaseIconImage, obj1);
  obj[0] = items;
