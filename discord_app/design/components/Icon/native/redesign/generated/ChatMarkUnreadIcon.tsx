// === Module 9696: ChatMarkUnreadIcon ===

// Module 9696 (ChatMarkUnreadIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4527 */;
import _mod9697 from "module_9697" /* 9697 */;
...
export const ChatMarkUnreadIcon = function ChatMarkUnreadIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod9697, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};