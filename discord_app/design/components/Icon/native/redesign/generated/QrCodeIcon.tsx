...
const require = arg1;
const result = require("Themes").fileFinishedImporting("design/components/Icon/native/redesign/generated/QrCodeIcon.tsx");
...
export const QrCodeIcon = function QrCodeIcon(color) {
  ...
  obj[0] = require("../../../../../../../_runtime/09018_registerAsset.js") /* registerAsset */;
