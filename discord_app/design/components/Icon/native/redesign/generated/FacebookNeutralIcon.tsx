...
const require = arg1;
const result = require("Themes").fileFinishedImporting("design/components/Icon/native/redesign/generated/FacebookNeutralIcon.tsx");
...
export const FacebookNeutralIcon = function FacebookNeutralIcon(color) {
  ...
  obj[0] = require("../../../../../../../_runtime/08008_registerAsset.js") /* registerAsset */;
