...
import _mod4530 from "../../../../../../../_runtime/metro/04530__.js";
import _mod4531 from "../../../../../../../_runtime/metro/04531__.js";
...
export const CircleInformationIcon = function CircleInformationIcon(color) {
  ...
  obj = { source: _mod4530, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod4531, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
