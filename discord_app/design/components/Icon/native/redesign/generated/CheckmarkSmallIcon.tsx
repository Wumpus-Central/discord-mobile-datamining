// === Module 6549: CheckmarkSmallIcon ===

// Module 6549 (CheckmarkSmallIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4527 */;
import _mod6550 from "module_6550" /* 6550 */;
...
export const CheckmarkSmallIcon = function CheckmarkSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod6550, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};