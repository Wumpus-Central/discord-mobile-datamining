// === Module 7464: CheckmarkSmallIcon ===

// Module 7464 (CheckmarkSmallIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4523 */;
import _mod7465 from "module_7465" /* 7465 */;
...
export const CheckmarkSmallIcon = function CheckmarkSmallIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7465, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};