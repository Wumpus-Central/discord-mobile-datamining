...
import _mod6859 from "../../../../../../../_runtime/metro/06859__.js";
import _mod6860 from "../../../../../../../_runtime/metro/06860__.js";
...
export const CircleXIcon = function CircleXIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6859, color: secondaryColor, style })];
  const obj3 = { source: _mod6860, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
