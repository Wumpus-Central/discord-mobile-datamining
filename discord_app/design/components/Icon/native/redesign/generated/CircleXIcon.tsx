...
import _mod6667 from "../../../../../../../_runtime/metro/06667__.js";
import _mod6668 from "../../../../../../../_runtime/metro/06668__.js";
...
export const CircleXIcon = function CircleXIcon(color) {
  ...
  obj = { source: _mod6667, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod6668, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
