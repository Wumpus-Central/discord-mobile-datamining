...
import _mod11240 from "../../../../../../../_runtime/metro/11240__.js";
...
export const CircleQuestionIcon = function CircleQuestionIcon(color) {
  ...
  obj = { source: _mod11240, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod11241, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
