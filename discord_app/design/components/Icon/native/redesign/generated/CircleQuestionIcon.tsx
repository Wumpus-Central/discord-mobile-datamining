...
import _mod11138 from "../../../../../../../_runtime/metro/11138__.js";
import _mod11139 from "../../../../../../../_runtime/metro/11139__.js";
...
export const CircleQuestionIcon = function CircleQuestionIcon(color) {
  ...
  obj = { source: _mod11138, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod11139, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
