...
import _mod4597 from "../../../../../../../_runtime/metro/04597__.js";
import _mod4598 from "../../../../../../../_runtime/metro/04598__.js";
...
export const CircleCheckIcon = function CircleCheckIcon(color) {
  ...
  obj = { source: _mod4597, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod4598, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
