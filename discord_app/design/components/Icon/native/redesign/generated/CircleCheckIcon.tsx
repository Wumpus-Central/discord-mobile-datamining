...
import _mod4566 from "../../../../../../../_runtime/metro/04566__.js";
...
export const CircleCheckIcon = function CircleCheckIcon(color) {
  ...
  obj = { source: _mod4566, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod4567, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
