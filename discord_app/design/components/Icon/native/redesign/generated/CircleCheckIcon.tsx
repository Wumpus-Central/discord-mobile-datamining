...
import _mod4535 from "../../../../../../../_runtime/metro/04535__.js";
import _mod4536 from "../../../../../../../_runtime/metro/04536__.js";
...
export const CircleCheckIcon = function CircleCheckIcon(color) {
  ...
  obj = { source: _mod4535, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod4536, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
