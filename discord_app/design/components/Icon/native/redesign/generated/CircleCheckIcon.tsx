...
import _mod4567 from "../../../../../../../_runtime/metro/04567__.js";
import _mod4568 from "../../../../../../../_runtime/metro/04568__.js";
...
export const CircleCheckIcon = function CircleCheckIcon(color) {
  ...
  obj = { source: _mod4567, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod4568, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
