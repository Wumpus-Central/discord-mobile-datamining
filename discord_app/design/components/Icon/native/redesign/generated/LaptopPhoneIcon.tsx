...
import _mod14484 from "../../../../../../../_runtime/metro/14484__.js";
...
export const LaptopPhoneIcon = function LaptopPhoneIcon(color) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod14484, color: INTERACTIVE_ICON_DEFAULT, style: color.style });
};
