...
const require = arg1;
const result = require("Themes").fileFinishedImporting("design/components/Icon/native/redesign/generated/TrainIcon.tsx");
...
export const TrainIcon = function TrainIcon(color) {
  ...
  obj[0] = require("../../../../../../../_runtime/13774_registerAsset.js") /* registerAsset */;
