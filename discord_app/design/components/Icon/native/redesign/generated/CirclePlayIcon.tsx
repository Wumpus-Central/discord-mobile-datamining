...
import _mod10261 from "../../../../../../../_runtime/metro/10261__.js";
...
export const CirclePlayIcon = function CirclePlayIcon(color) {
  ...
  obj = { source: _mod10261, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod10262, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
