...
const require = arg1;
const result = require("Themes").fileFinishedImporting("design/components/Icon/native/redesign/generated/DownloadIcon.tsx");
...
export const DownloadIcon = function DownloadIcon(color) {
  ...
  obj[0] = require("../../../../../../../_runtime/04236_registerAsset.js") /* registerAsset */;
