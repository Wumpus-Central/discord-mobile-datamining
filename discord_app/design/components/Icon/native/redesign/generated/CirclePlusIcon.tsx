...
import _mod11551 from "../../../../../../../_runtime/metro/11551__.js";
import _mod11552 from "../../../../../../../_runtime/metro/11552__.js";
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod11551, color: secondaryColor, style })];
  const obj3 = { source: _mod11552, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
