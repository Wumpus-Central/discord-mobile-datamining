...
import _mod11210 from "../../../../../../../_runtime/metro/11210__.js";
import _mod11211 from "../../../../../../../_runtime/metro/11211__.js";
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  obj = { source: _mod11210, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod11211, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
