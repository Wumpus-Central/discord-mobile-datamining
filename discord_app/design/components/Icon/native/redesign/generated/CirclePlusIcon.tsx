...
import _mod11299 from "../../../../../../../_runtime/metro/11299__.js";
import _mod11300 from "../../../../../../../_runtime/metro/11300__.js";
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  obj = { source: _mod11299, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod11300, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
