...
import _mod11277 from "../../../../../../../_runtime/metro/11277__.js";
import _mod11278 from "../../../../../../../_runtime/metro/11278__.js";
...
export const CirclePlusIcon = function CirclePlusIcon(color) {
  ...
  obj = { source: _mod11277, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod11278, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
