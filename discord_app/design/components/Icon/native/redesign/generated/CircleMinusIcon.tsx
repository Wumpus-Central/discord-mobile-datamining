...
import _mod15596 from "../../../../../../../_runtime/metro/15596__.js";
import _mod15597 from "../../../../../../../_runtime/metro/15597__.js";
...
export const CircleMinusIcon = function CircleMinusIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod15596, color: secondaryColor, style })];
  const obj3 = { source: _mod15597, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
