...
import _mod15345 from "../../../../../../../_runtime/metro/15345__.js";
...
export const CircleMinusIcon = function CircleMinusIcon(color) {
  ...
  obj = { source: _mod15345, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod15346, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
