...
import _mod6853 from "../../../../../../../_runtime/metro/06853__.js";
import _mod6854 from "../../../../../../../_runtime/metro/06854__.js";
...
export const CircleErrorIcon = function CircleErrorIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6853, color: secondaryColor, style })];
  const obj3 = { source: _mod6854, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
