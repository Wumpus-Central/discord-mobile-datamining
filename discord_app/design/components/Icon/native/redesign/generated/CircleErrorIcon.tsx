...
import _mod6625 from "../../../../../../../_runtime/metro/06625__.js";
import _mod6626 from "../../../../../../../_runtime/metro/06626__.js";
...
export const CircleErrorIcon = function CircleErrorIcon(color) {
  ...
  obj = { source: _mod6625, color: secondaryColor, style };
  const merged1 = Object.assign(merged);
  const items = [React4(BaseIconImage.BaseIconImage, obj)];
  obj = { source: _mod6626, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
