...
import _mod6939 from "../../../../../../../_runtime/metro/06939__.js";
import _mod6940 from "../../../../../../../_runtime/metro/06940__.js";
...
export const CircleErrorIcon = function CircleErrorIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6939, color: secondaryColor, style })];
  const obj3 = { source: _mod6940, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
