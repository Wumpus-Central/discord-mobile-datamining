...
import _mod6029 from "../../../../../../../_runtime/metro/06029__.js";
import _mod6030 from "../../../../../../../_runtime/metro/06030__.js";
...
export const CircleErrorIcon = function CircleErrorIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6029, color: secondaryColor, style })];
  const obj3 = { source: _mod6030, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
