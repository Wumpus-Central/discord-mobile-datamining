...
import _mod6855 from "../../../../../../../_runtime/metro/06855__.js";
import _mod6856 from "../../../../../../../_runtime/metro/06856__.js";
...
export const CircleErrorIcon = function CircleErrorIcon(color) {
  ...
  const items = [React4(BaseIconImage.BaseIconImage, { source: _mod6855, color: secondaryColor, style })];
  const obj3 = { source: _mod6856, color: INTERACTIVE_ICON_DEFAULT, style: null };
  const items1 = [style];
  const items2 = [];
