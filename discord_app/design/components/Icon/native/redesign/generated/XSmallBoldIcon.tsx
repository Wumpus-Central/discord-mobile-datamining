// === Module 8321: XSmallBoldIcon ===

// Module 8321 (XSmallBoldIcon)
import nativeDefault from "native" /* 576 */;
import BaseIconImage from "BaseIconImage" /* 4525 */;
import _mod7535 from "module_7535" /* 7535 */;
...
export const XSmallBoldIcon = function XSmallBoldIcon(WHITE) {
  ...
  return jsx(BaseIconImage.BaseIconImage, { source: _mod7535, color: INTERACTIVE_ICON_DEFAULT, style: WHITE.style });
};