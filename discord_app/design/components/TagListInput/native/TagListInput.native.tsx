...
let closure_10 = createStyles.createStyles(() => {
  ...
  const obj3 = { flex: 1, minHeight: nativeDefault.space.PX_24, minWidth: nativeDefault.space.PX_48, color: nativeDefault.colors.TEXT_DEFAULT };
  ...
  const obj2 = { marginHorizontal: nativeDefault.space.PX_4, alignItems: "center", flexDirection: "row", flexWrap: "wrap", flex: 1 };
...
export default noop.memo(function TagListInput(accessibilityHint) {
  ...
  obj.wrap = callback3;
  obj1 = { style: null, contentContainerStyle: null, ref: null, bounces: false, onScroll: null, onLayout: null, scrollEventThrottle: null, horizontal: null, snapToInterval: null, overScrollMode: "never", keyboardShouldPersistTaps: "handled", children: null };
