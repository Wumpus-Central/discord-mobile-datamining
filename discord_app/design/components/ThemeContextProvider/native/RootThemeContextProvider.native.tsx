// === Module 10096: RootThemeContextProvider ===
...
export const DisableCustomTheme = function DisableCustomTheme(children) {
  ...
  return jsx(themeContext(4173).ThemeContext.Provider, { value: memo, children: children.children });
};