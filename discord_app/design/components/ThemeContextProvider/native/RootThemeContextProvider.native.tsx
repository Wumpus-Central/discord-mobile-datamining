// === Module 10119: RootThemeContextProvider ===
...
export const DisableCustomTheme = function DisableCustomTheme(children) {
  ...
  return jsx(themeContext(4174).ThemeContext.Provider, { value: memo, children: children.children });
};