...
createStyles = { backgroundColor: nativeDefault.colors.CHECKBOX_BACKGROUND_DEFAULT, borderColor: nativeDefault.colors.CHECKBOX_BORDER_DEFAULT };
createStyles.unselected = createStyles;
createStyles.selected = { borderColor: nativeDefault.colors.CHECKBOX_BORDER_SELECTED_DEFAULT, backgroundColor: nativeDefault.colors.CHECKBOX_BACKGROUND_SELECTED_DEFAULT };
let obj1 = { borderColor: nativeDefault.colors.CHECKBOX_BORDER_SELECTED_DEFAULT, backgroundColor: nativeDefault.colors.CHECKBOX_BACKGROUND_SELECTED_DEFAULT };
...
export const FormCheckbox = function FormCheckbox(checked) {
  ...
  const fn = function _() {
    ...
    obj = { borderColor: obj.withSpring(borderColor, springPresets.SUBTLE_SPRING, "animate-always"), backgroundColor: null };
    if (checked) {
  ...
  let obj = { withSpring: checked(unselected[8]).withSpring, checked, selected, unselected, SUBTLE_SPRING: checked(unselected[9]).SUBTLE_SPRING };
  fn.__closure = obj;
  ...
  obj = { useReducedMotion: enabled, withSpring: checked(unselected[8]).withSpring, checked, SUBTLE_SPRING: checked(unselected[9]).SUBTLE_SPRING };
  fn2.__closure = obj;
