...
export const ActionSheetIconHeader = function ActionSheetIconHeader(subtitle) {
  ...
  const items1 = [callback(require("../../Text/native/Text.tsx") /* Text */.Text, { variant: "redesign/heading-18/bold", color: "mobile-text-heading-primary", accessibilityRole: "header", lineClamp: 2, children: title }), ];
  let tmp4Result = null;
  if (null != subtitle) {
    obj = { variant: "text-xs/medium", color: "text-default", children: null };
    obj[2] = subtitle;
    tmp4Result = callback(require("../../Text/native/Text.tsx") /* Text */.Text, obj);
  }
  items1[1] = tmp4Result;
  obj[1] = items1;
