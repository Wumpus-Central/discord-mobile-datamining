...
let closure_9 = noop.forwardRef((sheetKey, arg1) => {
  ...
  return jsx(transitionState(7266).Provider, {
    value: memo,
    children: jsx(sheetKey(5043).Dialog, { dialogKey: sheetKey, onDismiss: callback2, zIndex, children: content }),
  });
});
const size = fn(2);
...
export const ActionSheetPresenter = function ActionSheetPresenter(appEntryKey) {
  ...
  return jsx(appEntryKey(12575).TransitionGroup, {
    style: StyleSheet.absoluteFill,
    component: appEntryKey(4991).TransitionGroupOverlayView,
    children: mapped,
  });
};
