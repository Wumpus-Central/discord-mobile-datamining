...
export const PromoSheet = function PromoSheet(arg0) {
    ...
    () =>
      null != gradientColor
        ? (arg0) => {
            ...
            obj.children = closure_2_7(gradientColor(10301).ExpressiveGradient, obj);
  ...
  if (null != graphic) {
    ...
    let tmp4Result = closure_7(gradientColor(10302).Graphic, obj);
  } else {
    tmp4Result = null;
  ...
  const items2 = [
    closure_7(gradientColor(4601).Text, {
  ...
  if (null != description) {
    ...
    tmp4Result = closure_7(gradientColor(4601).Text, obj2);
  }
  ...
  obj.children = closure_8(gradientColor(5023).Stack, obj3);
