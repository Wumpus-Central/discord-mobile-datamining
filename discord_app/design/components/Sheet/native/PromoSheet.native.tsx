...
export const PromoSheet = function PromoSheet(arg0) {
    ...
    () =>
      null != gradientColor
        ? (arg0) => {
            ...
            obj.children = closure_2_7(gradientColor(10370).ExpressiveGradient, {
              offsetBottom: 0.25,
              color,
  ...
  if (null != graphic) {
    ...
    let tmp4Result = closure_7(gradientColor(10371).Graphic, obj2);
  } else {
    tmp4Result = null;
  ...
  const items2 = [
    closure_7(gradientColor(4634).Text, {
  ...
  if (null != description) {
    ...
    tmp4Result2 = closure_7(gradientColor(4634).Text, obj5);
  }
