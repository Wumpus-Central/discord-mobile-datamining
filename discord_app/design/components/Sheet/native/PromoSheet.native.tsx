...
let obj2 = {
  ...
  graphic: { alignSelf: "center", maxWidth: nativeDefault.modules.mobile.PROMO_SHEET_GRAPHIC_MAX_WIDTH },
};
...
export const PromoSheet = function PromoSheet(arg0) {
    ...
    () =>
      null != gradientColor
        ? (arg0) => {
            ...
            obj.children = closure_2_7(gradientColor(10495).ExpressiveGradient, {
              offsetBottom: 0.25,
              color,
  ...
  const items2 = [
    closure_7(gradientColor(4753).Text, {
