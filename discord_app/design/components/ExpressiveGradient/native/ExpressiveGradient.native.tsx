...
let obj = { start: ThemesDefault.colors.EXPRESSIVE_GRADIENT_PURPLE_START, end: ThemesDefault.colors.EXPRESSIVE_GRADIENT_PURPLE_END };
obj[0] = obj;
...
const result = require("obj132").fileFinishedImporting("design/components/ExpressiveGradient/native/ExpressiveGradient.native.tsx");
...
export const ExpressiveGradient = function ExpressiveGradient(color) {
  ...
  obj1[1] = items3;
  const items5 = [callback(closure_3, obj1), children];
  obj[1] = items5;
