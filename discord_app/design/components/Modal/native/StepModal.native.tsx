...
export const StepModal = function StepModal(steps) {
  ...
  obj = { height: steps(5206).NAV_BAR_HEIGHT + tmp3.top };
  obj.headerStyle = obj;
  obj.hideTitle = true;
  const items1 = [callback2(steps(11249).Modal, obj), ];
  ...
  obj2[1] = num;
  obj1[2] = callback2(steps(13300).ModalStepIndicator, obj2);
