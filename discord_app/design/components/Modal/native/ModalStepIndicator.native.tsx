...
import _modDef2122 from "../../../intl/Mana.messages.js";
...
function StepPill(isActive) {
  ...
  I.__closure = {
    interpolate: isActive(sharedValue[5]).interpolate,
    sharedValue,
    WIDTH_INACTIVE: 12,
    WIDTH_ACTIVE: 36,
    interpolateColor: isActive(sharedValue[5]).interpolateColor,
  ...
  if (totalSteps <= 0) {
    ...
    if (currentStep < 0) {
      ...
      const obj4 = {
        ...
        accessibilityLabel: intl.string(_modDef2122.KUwsC0),
