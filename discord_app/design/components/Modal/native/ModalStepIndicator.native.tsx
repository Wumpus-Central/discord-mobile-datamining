// === Module 14175: ModalStepIndicator ===
...
export const ModalStepIndicator = function ModalStepIndicator(arg0) {
  ...
  if (totalSteps <= 0) {
    ...
    if (currentStep < 0) {
      ...
      const obj1 = { accessible: true, accessibilityRole: "progressbar", accessibilityLabel: intl.string(_modDef2038.KUwsC0), accessibilityValue: null, importantForAccessibility: "yes", style: null, children: null };
