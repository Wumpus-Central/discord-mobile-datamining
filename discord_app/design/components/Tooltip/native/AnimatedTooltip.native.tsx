...
export const AnimatedTooltip = function AnimatedTooltip(visible) {
  ...
  return jsx(AnimatedRenderItem, { useReducedMotion: React.useContext(visible(4003).AccessibilityPreferencesContext).reducedMotion.enabled, item: null, entering: null, exiting: null, renderItem: null });
};