...
export const AnimatedTooltip = function AnimatedTooltip(visible) {
  ...
  return jsx(AnimatedRenderItem, { useReducedMotion: React.useContext(visible(4020).AccessibilityPreferencesContext).reducedMotion.enabled, item: null, entering: null, exiting: null, renderItem: null });
};