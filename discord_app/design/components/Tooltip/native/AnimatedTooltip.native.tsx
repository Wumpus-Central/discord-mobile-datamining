...
export const AnimatedTooltip = function AnimatedTooltip(visible) {
  ...
  return jsx(AnimatedRenderItem, { useReducedMotion: React.useContext(visible(3974).AccessibilityPreferencesContext).reducedMotion.enabled, item: null, entering: null, exiting: null, renderItem: null });
};