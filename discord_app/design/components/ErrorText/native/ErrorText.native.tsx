...
export const ErrorText = function ErrorText(children) {
  ...
  const items1 = [
    closure_3(nodeText(6854).CircleErrorIcon, { size: "xs", color: "text-feedback-critical" }),
    closure_3(nodeText(4753).Text, { variant: "text-xs/medium", color: "text-feedback-critical", children }),
  ];
