...
function WrappedNavigationStack(arg0) {
  ...
  navigationTheme = require("useNavigationTheme.native.tsx") /* useNavigationTheme */.useNavigationTheme(tmp4);
  ...
  return jsx(require("../../../../../_runtime/01481_Link.js") /* Link */.NavigationContainer, { initialRouteName });
}
