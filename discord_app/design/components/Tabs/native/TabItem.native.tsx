...
function TabItemCount(arg0) {
  ...
  T.__closure = {
    withSpring: sharedValue(5270).withSpring,
    countAnimationState: sharedValue,
    COUNT_SPRING_CONFIG,
    interpolate: sharedValue(4559).interpolate,
  };
  ...
  const obj5 = {
    style: null,
    children: closure_4(sharedValue(4823).Text, {
      animated: true,
...
export const TabItem = function TabItem(arg0) {
  ...
  fn2.__closure = {
    ...
    index,
    activeIndex,
    withSpring: index(setItemDimensions[6]).withSpring,
    TEXT_SPRING_CONFIG,
  };
  ...
  const items1 = [
    closure_4(index(setItemDimensions[7]).Text, {
      animated: true,
