...
function TabItemCount(arg0) {
  ...
  obj = { withSpring: sharedValue(4988).withSpring, countAnimationState: sharedValue, COUNT_SPRING_CONFIG, interpolate: sharedValue(4310).interpolate };
  T.__closure = obj;
  ...
  obj1 = { style: null, children: closure_4(tmp2(4570).Text, { animated: true, variant: "text-sm/medium", style: animatedStyle1, lineClamp: 1, children: count }) };
