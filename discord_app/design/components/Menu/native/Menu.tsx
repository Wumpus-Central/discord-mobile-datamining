...
measureButtonRef.__closure = { measure: require("module_4217").measure, runOnJS: require("module_4217").runOnJS };
...
let obj3 = { measure: require("module_4217").measure, runOnJS: require("module_4217").runOnJS };
