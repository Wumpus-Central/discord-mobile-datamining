...
function measureButtonRef(arg0, arg1) {
  const measureResult = _mod4119.measure(arg0);
  if (null != measureResult) {
    _mod4119.runOnJS(arg1)(measureResult);
    const tmpResult = _mod4119;
  }
}
measureButtonRef.__closure = { measure: require("module_4119").measure, runOnJS: require("module_4119").runOnJS };
...
let obj3 = { measure: require("module_4119").measure, runOnJS: require("module_4119").runOnJS };
