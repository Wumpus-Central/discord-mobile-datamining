...
measureButtonRef.__closure = { measure: require("module_4145").measure, runOnJS: require("module_4145").runOnJS };
...
let obj3 = { measure: require("module_4145").measure, runOnJS: require("module_4145").runOnJS };
