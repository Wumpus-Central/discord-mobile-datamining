...
measureButtonRef.__closure = { measure: require("module_4036").measure, runOnJS: require("module_4036").runOnJS };
...
let obj3 = { measure: require("module_4036").measure, runOnJS: require("module_4036").runOnJS };
