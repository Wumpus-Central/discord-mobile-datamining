...
function measureButtonRef(arg0, arg1) {
  const measureResult = _mod4187.measure(arg0);
  if (null != measureResult) {
    _mod4187.runOnJS(arg1)(measureResult);
    const tmpResult = _mod4187;
  }
}
measureButtonRef.__closure = { measure: require("module_4187").measure, runOnJS: require("module_4187").runOnJS };
...
let obj3 = { measure: require("module_4187").measure, runOnJS: require("module_4187").runOnJS };
