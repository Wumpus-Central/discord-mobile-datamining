...
function measureButtonRef(arg0, arg1) {
  const measureResult = require(4116).measure(arg0);
  if (null != measureResult) {
    require(4116).runOnJS(arg1)(measureResult);
    const tmpResult = require(4116);
  }
}
measureButtonRef.__closure = { measure: require("module_4116").measure, runOnJS: require("module_4116").runOnJS };
...
let obj3 = { measure: require("module_4116").measure, runOnJS: require("module_4116").runOnJS };
