...
function measureButtonRef(arg0, arg1) {
  const measureResult = _mod4120.measure(arg0);
  if (null != measureResult) {
    _mod4120.runOnJS(arg1)(measureResult);
    const tmpResult = _mod4120;
  }
}
measureButtonRef.__closure = { measure: require("module_4120").measure, runOnJS: require("module_4120").runOnJS };
...
let obj3 = { measure: require("module_4120").measure, runOnJS: require("module_4120").runOnJS };
