...
function measureButtonRef(arg0, arg1) {
  const measureResult = _mod4184.measure(arg0);
  if (null != measureResult) {
    _mod4184.runOnJS(arg1)(measureResult);
    const tmpResult = _mod4184;
  }
}
measureButtonRef.__closure = { measure: require("module_4184").measure, runOnJS: require("module_4184").runOnJS };
...
let obj3 = { measure: require("module_4184").measure, runOnJS: require("module_4184").runOnJS };
