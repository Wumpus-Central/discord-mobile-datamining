...
measureButtonRef.__closure = { measure: require("module_4042").measure, runOnJS: require("module_4042").runOnJS };
...
let obj3 = { measure: require("module_4042").measure, runOnJS: require("module_4042").runOnJS };
