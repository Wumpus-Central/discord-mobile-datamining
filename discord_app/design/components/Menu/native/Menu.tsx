...
measureButtonRef.__closure = { measure: require("module_4162").measure, runOnJS: require("module_4162").runOnJS };
...
let obj3 = { measure: require("module_4162").measure, runOnJS: require("module_4162").runOnJS };
