...
const LARGE_BUTTON_HEIGHT = fn(5276).LARGE_BUTTON_HEIGHT;
const bound = Math.max((fn(5276).MINIMUM_HIT_AREA - fn(5276).SMALL_BUTTON_HEIGHT) / 2, 0);
const rect = { top: bound, left: "Array", right: "isArray", bottom: bound };
obj6.sm = rect;
const LARGE_BUTTON_HEIGHT2 = fn(5276).LARGE_BUTTON_HEIGHT;
const bound1 = Math.max((fn(5276).MINIMUM_HIT_AREA - fn(5276).MEDIUM_BUTTON_HEIGHT) / 2, 0);
const rect1 = { top: bound1, left: "Array", right: "isArray", bottom: bound1 };
obj6.md = rect1;
const bound2 = Math.max((fn(5276).MINIMUM_HIT_AREA - fn(5276).LARGE_BUTTON_HEIGHT) / 2, 0);
...
let merged = Object.assign(
  ...
  }),
  {
    Icon: function TextButtonIcon(source) {
      ...
      const tmp4 = React5(Icon, {
        source: source.source,
        disableColor: flag,
        style: ButtonHooks.useIconSizeStyles(context),
      });
      let tmp3Result = tmp4;
      if ("entity" === str) {
