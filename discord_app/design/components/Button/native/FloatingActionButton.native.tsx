...
export const FloatingActionButton = function FloatingActionButton(positionRight) {
  ...
  obj = { withSpring: positionBottom(5024).withSpring, positionBottom, DEFAULT_POSITION_OFFSET: 16, SPRING_CONFIG, positionRight };
  F.__closure = obj;
  ...
  obj.children = jsx(positionBottom(8151).BaseIconButton, {});
