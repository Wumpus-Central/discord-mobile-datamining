...
export const useProfileThemedButtonStyles = function useProfileThemedButtonStyles(arg0) {
  ...
  return React.useMemo(() => {
    if (null == memo) {
      ...
      obj[0] = WHITE;
      obj[1] = variant(4107).WCAGContrastRatios.HighContrastText;
      const contrastingColor = variant(4107).getContrastingColor(tmp, obj);
      const obj8 = variant(4107);
      const darkenColorResult = variant(4107).darkenColor(contrastingColor, 0.5);
      ...
      const setColorOpacity2 = variant(4107).setColorOpacity;
      ...
      const setColorOpacity = variant(4107).setColorOpacity;
      ...
      obj1 = variant(1363);
      const tmp8 = variant(4107);
      let obj2 = variant(4107);
...
export const useButtonPillStyles = function useButtonPillStyles(variant, pressed) {
  ...
  const fn = function s() {
    ...
    const obj = { backgroundColor: variant(4119).interpolateColor(variant.get(), [0, 1], backgroundColor), borderColor: null };
    const obj2 = variant(4119);
    obj[1] = variant(4119).interpolateColor(variant.get(), [0, 1], borderColor);
    return obj;
  };
...
export const useButtonPressAnimationProps = function useButtonPressAnimationProps(sharedValue, scaleAmountInPx, onLayout, onPressIn, onPressOut) {
  ...
  obj = { width: sharedValue1, scaleAmountInPx: num, withSpring: tmp(4749).withSpring, interpolate: tmp(4119).interpolate, pressed: sharedValue, ON_PRESS_SPRING: tmp(4753).ON_PRESS_SPRING };
  fn.__closure = obj;
  fn.__workletHash = 17256006845494;
  fn.__initData = closure_10;
