...
export const useProfileThemedButtonStyles = function useProfileThemedButtonStyles(arg0) {
  ...
  return React.useMemo(() => {
    if (null == memo) {
      ...
      obj[0] = WHITE;
      obj[1] = variant(4174).WCAGContrastRatios.HighContrastText;
      const contrastingColor = variant(4174).getContrastingColor(tmp, obj);
      const obj8 = variant(4174);
      const darkenColorResult = variant(4174).darkenColor(contrastingColor, 0.5);
      ...
      const setColorOpacity2 = variant(4174).setColorOpacity;
      ...
      const setColorOpacity = variant(4174).setColorOpacity;
      ...
      obj1 = variant(1363);
      const tmp8 = variant(4174);
      let obj2 = variant(4174);
...
export const useButtonPillStyles = function useButtonPillStyles(variant, pressed) {
  ...
  const fn = function s() {
    ...
    const obj = { backgroundColor: variant(4187).interpolateColor(variant.get(), [0, 1], backgroundColor), borderColor: null };
    const obj2 = variant(4187);
    obj[1] = variant(4187).interpolateColor(variant.get(), [0, 1], borderColor);
    return obj;
  };
...
export const useButtonPressAnimationProps = function useButtonPressAnimationProps(sharedValue, scaleAmountInPx, onLayout, onPressIn, onPressOut) {
  ...
  obj = { width: sharedValue1, scaleAmountInPx: num, withSpring: tmp(4895).withSpring, interpolate: tmp(4187).interpolate, pressed: sharedValue, ON_PRESS_SPRING: tmp(4899).ON_PRESS_SPRING };
  fn.__closure = obj;
  fn.__workletHash = 17256006845494;
  fn.__initData = closure_10;
