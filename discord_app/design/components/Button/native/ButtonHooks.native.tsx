...
export const useButtonPillStyles = function useButtonPillStyles(variant, pressed) {
  ...
  obj = { themedStyles: memo, colors: tmp3, interpolateColor: _require(4115).interpolateColor, pressed };
  fn.__closure = obj;
  fn.__workletHash = 2383933325137;
  fn.__initData = closure_9;
  return _require(4115).useAnimatedStyle(fn);
};
export const useButtonScaleStyles = function useButtonScaleStyles(pressed, width, scaleAmountInPx) {
  ...
  const obj = { width, scaleAmountInPx, withSpring: _require(4744).withSpring, interpolate: _require(4115).interpolate, pressed, ON_PRESS_SPRING: _require(4748).ON_PRESS_SPRING };
  fn.__closure = obj;
