  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        tmp11(
          tmp5Result.withDelay(result1, tmp5Result3.withRepeat(timing.withTiming(1, tmp8, "animate-always"), -1, true)),
        );
        return () => {
...
withEllipsisAnimation.__closure = {
  ...
  withDelay: fn(4561).withDelay,
  withRepeat: fn(4561).withRepeat,
