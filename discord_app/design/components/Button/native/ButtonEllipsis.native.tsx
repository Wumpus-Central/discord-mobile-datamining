...
__closure = { ELLIPSIS_APPEAR_DURATION: 500, withDelay: fn(4343).withDelay, withRepeat: fn(4343).withRepeat, withTiming: fn(4607).withTiming, ELLIPSIS_APPEAR_TIMING: __closure };
