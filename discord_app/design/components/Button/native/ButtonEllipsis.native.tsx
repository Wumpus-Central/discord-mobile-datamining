  ...
  const mountLayoutEffect = offset(sharedValue1[7]).useMountLayoutEffect(() => {
    if (typeof withEllipsisAnimation === "function") {
      ...
      if (typeof tmp3 === "function") {
        ...
        tmp11(
          tmp5Result.withDelay(result1, tmp5Result.withRepeat(timing.withTiming(1, tmp8, "animate-always"), -1, true)),
        );
        return () => {
...
__closure.easing = Easing.inOut(fn(4343).Easing.quad);
...
__closure = {
  ...
  withDelay: fn(4343).withDelay,
  withRepeat: fn(4343).withRepeat,
