...
import ButtonShine from "ButtonShine" /* 4986 */;
  ...
  if ("experimental_premium-primary" !== variant) {
    if ("experimental_premium-basic" !== variant) {
      ...
      if (tmp11Result) {
        ...
        obj.style = items2;
        obj1 = { withReducedMotion: "short-loop", ref: expressiveRiveRef, fit: "layout", artboard: null, dataBinding: null };
...
function useLoadingStyles(flag, DEFAULT_BUTTON_SIZE) {
  ...
  obj = { withSpring: tmp(tmp2[16]).withSpring, loading: flag, SUBTLE_SPRING: tmp(tmp2[17]).SUBTLE_SPRING, useReducedMotion: enabled, withDelay: tmp(tmp2[12]).withDelay, FADE_DELAY, offsetY: num };
  fn2.__closure = obj;
...
const value = createStyles.createStyles((arg0, arg1) => {
  if ("sm" === arg1) {
    let obj = { minHeight: ButtonConstants2.SMALL_BUTTON_HEIGHT, minWidth: ButtonConstants2.SMALL_BUTTON_HEIGHT, paddingHorizontal: ButtonConstants2.SMALL_BUTTON_HORIZONTAL_PADDING, paddingVertical };
  } else if ("md" === arg1) {
    obj = { minHeight: ButtonConstants2.MEDIUM_BUTTON_HEIGHT, minWidth: ButtonConstants2.MEDIUM_BUTTON_HEIGHT, paddingHorizontal: ButtonConstants2.MEDIUM_BUTTON_HORIZONTAL_PADDING, paddingVertical: paddingVertical2 };
  } else {
    obj = {};
    if ("lg" === arg1) {
      const obj1 = { minHeight: ButtonConstants2.LARGE_BUTTON_HEIGHT, minWidth: ButtonConstants2.LARGE_BUTTON_HEIGHT, paddingHorizontal: ButtonConstants2.LARGE_BUTTON_HORIZONTAL_PADDING, paddingVertical: paddingVertical3 };
      obj = obj1;
    }
  }
  ...
  obj3 = { flexDirection: "row", alignItems: "center", justifyContent: "center", overflow: "hidden", borderWidth: ButtonConstants2.BUTTON_BORDER_WIDTH, borderRadius: buttonBorderRadius };
