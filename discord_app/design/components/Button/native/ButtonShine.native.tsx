...
function useShineEffectStyles(width, variant) {
  ...
  const fn = function o() {
    if (null == width) {
      ...
      if (enabled) {
        ...
        obj1[0] = obj.withRepeat(
          obj1.withSequence(
            withTimingResult,
            obj4.withDelay(750, width(closure_1_2[7]).withTiming(tmp + 120, { duration: 2000 }, "animate-always")),
          ),
          -1,
        );
        const items2 = [obj1];
  ...
  obj = {
    width,
    SHINE_OFFSCREEN_OFFSET: 120,
    useReducedMotion: enabled,
    SHINE_WIDTH: 56,
    withRepeat: require("../../../../modules/reanimated/ReanimatedRexport.tsx").withRepeat,
    withSequence: require("../../../../modules/reanimated/ReanimatedRexport.tsx").withSequence,
    withTiming: require("../../../animation/reanimated/timing/timing.tsx").withTiming,
    withDelay: require("../../../../modules/reanimated/ReanimatedRexport.tsx").withDelay,
    SHINE_INITIAL_ANIMATION_DELAY: 750,
    SHINE_ANIMATION_DURATION: 2000,
  };
  fn.__closure = obj;
  ...
  obj[0] = require("../../Styles/native/createStyles.tsx").createStyles({
