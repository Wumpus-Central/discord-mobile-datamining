...
import ConstantsIOS2 from "ConstantsIOS.tsx";
...
const items1 = [
  ...
  15,
  30,
  DurationsDefault.Seconds.MINUTE,
  2 * DurationsDefault.Seconds.MINUTE,
  5 * DurationsDefault.Seconds.MINUTE,
  10 * DurationsDefault.Seconds.MINUTE,
  15 * DurationsDefault.Seconds.MINUTE,
  30 * DurationsDefault.Seconds.MINUTE,
  DurationsDefault.Seconds.HOUR,
...
export const KeybindActions = {
  ...
  CLOSE_CHANNEL_TAB: "CLOSE_CHANNEL_TAB",
...
export const AbortCodes = {
  ...
  TOO_MANY_VIBEGRATIONS_PROJECTS: 30081,
  [30081]: "TOO_MANY_VIBEGRATIONS_PROJECTS",
  UNAUTHORIZED: 40001,
  [40001]: "UNAUTHORIZED",
...
export const AnalyticEvents = {
  ...
  NOTIFICATION_SETTING_SYSTEM_SETTINGS_OPENED: "notification_setting_system_settings_opened",
  NOTIFICATION_SETTING_SYSTEM_REENABLED: "notification_setting_system_reenabled",
  ...
  DAVE_DOWNGRADE_REFUSED: "dave_downgrade_refused",
  ...
  HARDWARE_MUTE_DETECTED: "hardware_mute_detected",
...
export const HelpdeskArticles = {
  ...
  MANAGE_SPONSORED_CONTENT: "43335916914071",
