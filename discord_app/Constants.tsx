...
import set7 from "../discord_common/js/shared/shared-constants/MessageTypes.tsx";
...
import set8 from "../discord_common/js/shared/shared-constants/ChannelTypes.tsx";
...
import INVITE from "modules/routing/RouteConstants.tsx";
...
import powResult from "../_runtime/00002_set.js";
import powResult1 from "../_runtime/00002_set.js";
import powResult2 from "../_runtime/00002_set.js";
...
const items = [
  set7.MessageTypes.REPLY,
  set7.MessageTypes.THREAD_STARTER_MESSAGE,
  set7.MessageTypes.CONTEXT_MENU_COMMAND,
];
...
obj = {
  ...
  GUILD_ROLE_SUBSCRIPTION_GROUP_LISTING_ARCHIVE(closure_0, closure_1, closure_2) {
    return (
      "/guilds/" +
      closure_0 +
      "/role-subscriptions/group-listings/" +
      closure_1 +
  ...
  GUILD_ROLE_SUBSCRIPTION_TRIAL_ELIGIBILITY(closure_0, closure_1, closure_2) {
    return (
      "/guilds/" +
      closure_0 +
      "/role-subscriptions/subscription-listings/" +
      closure_1 +
      "/trial/" +
      closure_2 +
      "/eligibility"
...
const items1 = [
  ...
  15,
  30,
  setDefault.Seconds.MINUTE,
  2 * setDefault.Seconds.MINUTE,
  5 * setDefault.Seconds.MINUTE,
  10 * setDefault.Seconds.MINUTE,
  15 * setDefault.Seconds.MINUTE,
  30 * setDefault.Seconds.MINUTE,
  setDefault.Seconds.HOUR,
  2 * setDefault.Seconds.HOUR,
  result,
];
obj = {
...
const obj2 = {
  ...
  PRIVATE_CHANNEL_LIST: "Private Channel List",
  CHANNEL_SETTINGS: "Channel Settings",
  CREATE_CHANNEL_MODAL: "Create Channel Modal",
  ...
  PREMIUM_UPSELL_BURST_REACTIONS: "Premium Upsell Modal - Burst Reactions",
  ...
  PREMIUM_UPSELL_DISPLAY_NAME_STYLES: "Premium Upsell Modal - Display Name Styles",
  PREMIUM_DOWNGRADE_TO_TIER_0_MODAL: "Premium Downgrade To Tier 0 Modal",
  ...
  ACTIVITY_UPSELL_MODAL: "Activity Upsell Modal",
  ACTIVITY_UPSELL_ACTION_SHEET: "Activity Upsell Action Sheet",
  PREMIUM_TRIAL_TUTORIAL_COACHMARK: "Premium Tutorial Coachmark",
  GUILD_BOOSTING_USER_SETTINGS: "Guild Boosting User Settings",
  COLLECTIBLES_SHOP: "Collectibles Shop",
  NITRO_HOME: "Nitro Home",
  TIERED_TENURE_BADGES_MODAL: "Tiered Tenure Badges Modal",
  TIERED_TENURE_BADGES_ACTION_SHEET: "Tiered Tenure Badges Action Sheet",
  SHOP_ORBS_TAB: "Shop Orbs Tab",
  ORBS_ANNOUNCEMENT_MODAL: "Orbs Announcement Modal",
  QUEST_ORB_MULTIPLIER_PERK_INFO: "Quest Orb Multiplier Action Sheet",
  GLOBAL_DISCOVERY_QUESTS: "Global Discovery Quests",
  BOGO_PROMOTION_ACTION_SHEET: "Bogo Promotion Action Sheet",
...
const obj3 = {
  ...
  VOICE_CHANNEL_EFFECT_EMOJI_PICKER_POPOUT: "Voice Channel Effect Emoji Picker Popout",
  ...
  PREMIUM_CUSTOM_NOTIFICATION_SOUND_UPSELL_MODAL: "Premium Custom Notification Sound Upsell",
  ...
  CHANNEL_ACTION_SHEET: "Channel Action Sheet",
  CHANNEL_CONTEXT_MENU: "Channel Context Menu",
  CUSTOM_STATUS_MODAL: "Custom Status Modal",
  ...
  FILE_UPLOAD_UPSELL_MODAL: "File Upload Upsell Modal",
  MESSAGE_LENGTH_UPSELL_MODAL: "Message Length Upsell Modal",
  USER_PROFILE: "User Profile",
  USER_PROFILE_MUTUAL_FRIENDS: "User Profile Mutual Friends",
  PERSONAL_WIDGET: "Personal Widget",
  INBOX: "Inbox",
  CHANNEL: "Channel",
  MANAGE_ACCOUNTS_MODAL: "Manage Accounts Modal",
  VOICE_CHANNEL_EFFECTS_UPSELL_MODAL: "Voice Channel Effects Upsell Modal",
  PREMIUM_TIER_0_ANNOUNCEMENT_MODAL: "Premium Tier 0 Announcement Modal",
  BURST_REACTIONS_UPSELL_MODAL: "Burst Reactions Upsell Modal",
  BURST_REACTIONS_TOOLTIP: "Burst Reactions Tooltip",
  CONTACT_SYNC_NC_MODAL: "Contact Sync Notification Center Modal",
  MEDIA_VIEWER: "Media Viewer",
  MARKETING_FLOATING_CTA: "Marketing Floating CTA",
  PREMIUM_GIFT_SUCCESS_MODAL: "Premium Gifting Success Modal",
  CLOSE_ACTIVITY_JOIN_REQUEST_RPC_COMMAND: "Close Activity Join Request RPC Commands",
  CHANNEL_TEXT_AREA: "Channel Text Area",
  THREAD_TEXT_AREA: "THREAD_TEXT_AREA",
  TEXT_IN_VOICE: "TEXT_IN_VOICE",
  FORUM_CHANNEL_TEXT_AREA: "FORUM_CHANNEL_TEXT_AREA",
  ...
  DM_INVITE: "DM_INVITE",
  NEW_MESSAGES_BANNER: "New Messages Banner",
  NEW_MESSAGES_PILL: "New Messages Pill",
  NEW_TOPICS_BAR: "New Topics Bar",
  ...
  QUESTS: "Quests",
  GIFT_BANNER: "Gift Banner",
  STORE_LISTING_BUY_GAME: "Buy Game",
  STORE_LISTING_BUY: "Buy",
  CHANNEL_NAME: "Channel Name",
  CHANNEL_DEFAULT_REACTION: "Channel Default Reaction",
  SETTINGS_TEXT_PLAYGROUND: "Text Playground",
  SETTINGS_DESIGN_SYSTEMS: "Design Systems",
  SETTINGS_INTL_TESTING: "Intl Testing",
  ...
  SETTINGS_REQUEST_DATA: "Request Your Data",
  SETTINGS_CUSTOMIZE_PROFILE: "Profile Customization",
  SETTINGS_CUSTOMIZE_PROFILE_TRY_IT_OUT: "Profile Customization Try It Out",
  SETTINGS_DISPLAY_NAME_STYLES: "Display Name Styles",
  SETTINGS_TYPING_INDICATOR: "Typing Indicator",
  SETTINGS_CUSTOMIZE_PROFILE_AVATAR: "Profile Customization Avatar",
  ...
  SETTINGS_CONTENT_AND_SOCIAL: "Content & Social",
  SETTINGS_SENSITIVE_MEDIA_FILTERS: "Sensitive Media Filters",
  SETTINGS_CONNECTED_GAMES: "Connected Games",
  SETTINGS_DATA_AND_PRIVACY: "Data & Privacy",
  SETTINGS_SPONSORED_CONTENT_PREFERENCES: "Sponsored Content Preferences",
  SETTINGS_MANAGE_SPONSORED_CONTENT: "Manage Sponsored Content",
  SETTINGS_ACCOUNT_STANDING: "Account Standing",
  SETTINGS_AGE_GROUP: "Age Group",
  SETTINGS_AUTHORIZED_APPS: "Authorized Apps",
  SETTINGS_AUTHORIZED_APP: "Authorized App - Detail Page",
  SETTINGS_AUTHORIZED_APP_PERMISSIONS: "Authorized App - Permissions",
  SETTINGS_CONNECTIONS: "Connections",
  SETTINGS_FRIEND_REQUESTS: "Friend Requests",
  ...
  SETTINGS_MOBILE_PREMIUM_BANNER: "Mobile Nitro Upsell Banner",
  SETTINGS_APP_DMS_MENU: "App DMs Menu",
  SETTINGS_PREMIUM_MANAGE_PLAN: "Manage Nitro Plan",
  ...
  GUILD_ROLE_SUBSCRIPTION_CANCEL: "Guild Role Subscription Cancel",
  SETTINGS_DATA: "Data",
  SETTINGS_VOICE_AND_VIDEO: "Voice & Video",
  SETTINGS_OVERLAY: "Overlay",
  SETTINGS_NOTIFICATIONS: "Notifications",
  SETTINGS_APP_ICONS: "App Icons",
  SETTINGS_EMAILS: "Email Settings",
  SETTINGS_KEYBINDS: "Keybinds",
  SETTINGS_ACTIVITY_PRIVACY: "Activity Privacy",
  SETTINGS_GAME_ACTIVITY: "Game Activity",
  SETTINGS_TEXT_AND_IMAGES: "Text & Images",
  SETTINGS_APPEARANCE: "Appearance",
  SETTINGS_APPEARANCE_THEME_PICKER: "Appearance Theme Picker",
  SETTINGS_APPEARANCE_LIGHT_MODE_THEME_PICKER: "Appearance Light Mode Theme Picker",
  SETTINGS_APPEARANCE_DARK_MODE_THEME_PICKER: "Appearance Dark Mode Theme Picker",
  SETTINGS_APPEARANCE_APP_ICON_PICKER: "Appearance App Icon Picker",
  ...
  SETTINGS_BLOCKED_USERS_V2: "Blocked Users V2",
  SETTINGS_IGNORED_USERS: "Ignored Users",
  SETTINGS_INVENTORY: "Library Inventory",
  SETTINGS_SWIPE_RIGHT_TO_LEFT: "Swipe Right to Left Setting",
  ...
  SETTINGS_FAMILY_CENTER: "Family Center",
  SETTINGS_FAMILY_CENTER_PARENTAL_CONTROLS: "Family Center Parental Controls",
  ...
  SETTINGS_FAMILY_CENTER_SCHEDULE_DOWNTIME: "Family Center Schedule Downtime",
  SETTINGS_CONTEXT_MENU: "Settings Context Menu",
  SETTINGS_CLIPS: "Settings Clips",
  ...
  SETTINGS_CHECK_NATIVE_UPDATE: "Check For Native Update",
  SETTINGS_INSTALL_NATIVE_UPDATE: "Install Native Build",
  SETTINGS_CHANGELOG_OVERRIDE: "Changelog Override",
  SETTINGS_SOUNDS: "Sounds",
  SETTINGS_CLIENT_THEMES: "Client Themes",
  CUSTOM_THEMES_FOOTER: "Custom Themes Footer",
  ...
  GUILD_SETTINGS_EMOJI_ADD_BUTTON: "Guild Emoji Settings Add Button",
  GUILD_SETTINGS_EMOJI_DRAG_DROP: "Guild Emoji Settings Drag and Drop",
  GUILD_SETTINGS_VANITY_URL: "Guild Vanity Url",
  GUILD_SETTINGS_ONBOARDING: "Guild Onboarding Settings",
  GUILD_SETTINGS_SOUNDBOARD: "Guild Soundboard Settings",
  ...
  GIFT_CODE_ROW: "Gift Code Row",
  PREMIUM_GIFT_AVAILABLE_ALERT: "Premium Gift Available Alert",
  GUILD_LIST: "Guild List",
  ...
  PREMIUM_GUILD_USER_MODAL_FLOATING_CTA_BAR: "Floating CTA Bar",
  PREMIUM_GUILD_USER_MODAL_PROGRESS_BAR: "Progress Bar",
  GUILD_BOOSTING_BOOST_ANY_GUILD_CTA: "Boost Any Guild CTA",
  GUILD_BOOSTING_RECOMMENDED_SERVER_BOOST_THIS_SERVER_CTA: "Recommended Server Boost This Server CTA",
  GUILD_BOOSTING_RECOMMENDED_SERVER_GO_TO_SERVER_CTA: "Recommended Server Go To Server CTA",
  ICYMI_RECOMMENDED_SERVERS: "Recommended Servers",
  REGISTER: "Register",
  LOGIN: "Login",
  OVERLAY: "Overlay",
  ...
  SUPER_REACTION_PICKER: "Super Reaction Picker",
  SOUNDBOARD_SOUND_PICKER: "Soundboard Sound Picker",
  SOUNDBOARD_SOUND_PICKER_UPSELL: "Soundboard Sound Picker Upsell",
  ...
  THREAD_ACTION_SHEET: "Thread Action Sheet",
  ...
  FRIENDS_LIST: "Friends List",
  FRIENDS_ADD_FRIENDS_MODAL: "Add Friends Modal",
  FRIENDS_ADD_FRIENDS_MODAL_SEARCH: "Add Friends Modal Search",
  FRIENDS_ADD_BY_USERNAME_MODAL: "Add by Username Modal",
  FRIENDS_REQUESTS_MODAL: "Friend Requests Modal",
  FRIENDS_SUGGESTED_FRIENDS_MODAL: "Suggested Friends Modal",
  FRIENDS_LIST_FRIEND_ROW: "Friend Row",
  FRIENDS_LIST_FRIEND_ROW_GIFT_POPOUT: "Friend Row Gift Popout",
  ...
  FOCUS_EXPANDED_CONTROLS: "Focus Expanded Controls",
  CHANNEL_CALL_ACTION_BAR: "Channel Call Action Bar",
  ACTIVITY_SHELF: "Activity Shelf",
  ACTIVITY_UPSELL_ACTION_SHEET: "Activity Upsell Action Sheet",
  AGGREGATE_PREMIUM_UPSELL_MODAL: "Aggregate Premium Upsell Modal",
  VOICE_CHANNEL_EFFECTS_BAR: "Voice Channel Effect Emoji Hotbar",
  VOICE_CHANNEL_EFFECTS_EMOJI_PICKER: "Voice Channel Effect Emoji Picker",
  PREMIUM_MARKETING_SURFACE_SIDEBAR: "Premium Marketing Surface Sidebar",
  CHANNEL_BROWSER: "Channel Browser",
  FORUM_CHANNEL_POST: "Forum Channel Post",
  FORUM_CHANNEL_HEADER: "Forum Channel Header",
  FORUM_CHANNEL_FOOTER: "Forum Channel Footer",
  FORUM_CHANNEL_GUIDELINES: "Forum Channel Guidelines",
  FORUM_POST_HEADER: "Forum Post Header",
  ...
  SUMMARY_ACTION_SHEET: "Summary Action Sheet",
  COLLECTIBLES_SHOP_DETAILS_MODAL: "Collectibles Shop Details Modal",
  COLLECTIBLES_SHOP_COLLECTED_MODAL: "Collectibles Shop Collected Modal",
  AVATAR_DECORATION_CUSTOMIZATION: "Edit Avatar Decoration Modal",
  PROFILE_EFFECT_CUSTOMIZATION: "Profile Effect Customization",
  PROFILE_FRAME_CUSTOMIZATION: "Profile Frame Customization",
  NAMEPLATE_CUSTOMIZATION: "Nameplate Customization",
  COLLECTIBLES_SHOP: "Shop",
  REFERRAL_MESSAGE_EMBED: "Message Embed",
  ...
  APPEAL_INGESTION_SPEED_BUMP: "Appeal Ingestion Speed Bump",
  APPEAL_INGESTION_COLLECT_SIGNAL: "Appeal Ingestion Collect Signal",
  APPEAL_INGESTION_REQUEST_REVIEW: "Appeal Ingestion Request a Review",
  APPEAL_INGESTION_WHY_DISAGREE: "Appeal Ingestion Why do you Disagree?",
  APPEAL_INGESTION_FREE_TEXT: "Appeal Ingestion Free Text",
  APPEAL_INGESTION_CONFIRM_SUBMISSION: "Appeal Ingestion Confirm Submission",
  APPEAL_INGESTION_REQUEST_SENT: "Appeal Ingestion Request Sent",
  APPEAL_INGESTION_THANKS: "Appeal Ingestion Thanks",
  APPEAL_INGESTION_SPAM: "Appeal Ingestion Spam",
  SETTINGS_SURVEY_OVERRIDE: "Survey Override",
  QUEST_PREVIEW_TOOL: "Quest Preview Tool",
  QUEST_PREVIEW_TOOL_2: "Quest Preview Tool 2",
  QUEST_TILE_CTA: "Quest Tile CTA",
  QUEST_MINOR_REWARD_CAPPING_CONFIG: "Quest Minor Reward Capping Config",
  ATT_PREPROMPT_MODAL: "ATT Pre Prompt Modal",
  GUILD_POWERUPS_MARKETING_PERKS_SECTION: "Guild Powerups Marketing Perks Section",
  GUILD_POWERUPS_OVERVIEW_SIDEBAR: "Guild Powerups Overview Sidebar",
  GUILD_POWERUPS_OVERVIEW_CARD: "Powerups Overview Card",
  GUILD_POWERUPS_NEW_PERKS_COACHMARK: "Guild Powerups New Perks Coachmark",
  GAME_SERVERS_EMPTY_STATE: "Game Servers Empty State",
  SECURE_FRAMES_STREAM_BOTTOM_SHEET: "Secure Frames Stream Bottom Sheet",
  SECURE_FRAMES_VOICE_BOTTOM_SHEET: "Secure Frames Voice Bottom Sheet",
  ...
  EDIT_CUSTOM_STATUS_MODAL: "Edit Custom Status Modal",
  EDIT_CUSTOM_STATUS_MODAL_WITH_PREVIEW: "Edit Custom Status Modal With Preview",
  PERMADECOS_MARKETING_UPSELL: "Permadecos Marketing Upsell",
  ORBS_ANNOUNCEMENT_MODAL: "Orbs Announcement Modal",
  ORBS_BADGE_REDEMPTION_MODAL: "Orbs Badge Redemption Modal",
  ORBS_DISCOVERY_ONBOARDING_COACHMARK: "Orbs Discovery Onboarding Coachmark",
  ORBS_DISCOVERY_REHEAT_COACHMARK: "Orbs Discovery Reheat Coachmark",
  ORBS_SHOP_ONBOARDING_COACHMARK: "Orbs Shop Onboarding Coachmark",
  ORBS_BALANCE_MENU: "Orbs Balance Menu",
  ORBS_REWARD_MODAL: "Orbs Reward Modal",
  ORBS_SHOP_HERO_BLOCK: "Orbs Shop Hero Block",
...
const obj4 = {
  ...
  STICKER: "Sticker",
  EMOJI: "Emoji",
  SOUNDBOARD_SOUND: "Soundboard Sound",
  ...
  BOOST_UPSELL_NEXT_LEVEL_HEADER: "Boost Upsell Next Level Header",
  ...
  PREMIUM_UPSELL_BANNER: "Nitro upsell banner",
  ...
  GIFTING_PROMOTION_BUTTON: "Gifting promotion icon",
  SERVER_BANNER_TOOLTIP: "Server Banner Tooltip",
  ...
  ACTIVITIES_COACH_MARK: "ACTIVITIES_COACH_MARK",
  VOICE_CHANNEL_EFFECTS_COACH_MARK: "VOICE_CHANNEL_EFFECTS_COACHMARK",
  VOICE_CHANNEL_EFFECTS_TOGGLE: "VOICE_CHANNEL_EFFECTS_TOGGLE",
  BURST_REACTION_TOGGLE: "BURST_REACTION_TOGGLE",
  ONBOARDING_EDIT: "ONBOARDING_EDIT",
  ONBOARDING_REVIEW: "ONBOARDING_REVIEW",
  FORUM_ACTION_BAR: "FORUM_ACTION_BAR",
  FORUM_GRID_ITEM_FOOTER: "FORUM_GRID_ITEM_FOOTER",
  FORUM_LIST_ITEM_FOOTER: "FORUM_LIST_ITEM_FOOTER",
  MESSAGE_ACTION_SHEET: "MESSAGE_ACTION_SHEET",
  MESSAGE: "MESSAGE",
  CHANNEL_PIN: "CHANNEL_PIN",
  CHANNEL_SEARCH: "CHANNEL_SEARCH",
  CHANNEL_SETTINGS: "CHANNEL_SETTINGS",
  EMOJI_PICKER_BUTTON: "EMOJI_PICKER_BUTTON",
  REACTION_RAIL: "REACTION_RAIL",
  EMOJI_REACTION_PICKER_POPOUT: "EMOJI_REACTION_PICKER_POPOUT",
  EMOJI_REACTION_UPSELL: "EMOJI_REACTION_UPSELL",
  EMOJI_REACTION_TOOLTIP_UPSELL: "EMOJI_REACTION_TOOLTIP_UPSELL",
  EMOJI_PICKER_FLOATING_UPSELL: "EMOJI_PICKER_FLOATING_UPSELL",
  INLINE_REACTION_PICKER_UPSELL: "INLINE_REACTION_PICKER_UPSELL",
  EMOJI_REACTION_PICKER_POPOUT_UPSELL: "EMOJI_REACTION_PICKER_POPOUT_UPSELL",
  REACTION_RIGHT_CLICK_MENU_UPSELL: "REACTION_RIGHT_CLICK_MENU_UPSELL",
  NOTIFICATION_SETTING_UNREAD_NOTICE: "NOTIFICATION_SETTING_UNREAD_NOTICE",
  FORWARD_BREADCRUMB: "FORWARD_BREADCRUMB",
  GUILD_PROFILE: "GUILD_PROFILE",
  GIFT_CATEGORY_OPTION: "Gift Category Option",
  GUILD_POWERUPS_CHANNEL_LIST_ITEM: "GUILD_POWERUPS_CHANNEL_LIST_ITEM",
  GUILD_POWERUPS_LEARN_MORE: "GUILD_POWERUPS_LEARN_MORE",
  REMIXING_ACTION_SHEET_UPSELL: "REMIXING_ACTION_SHEET_UPSELL",
  MESSAGE_REMIX_BUTTON: "MESSAGE_REMIX_BUTTON",
  CUSTOM_STATUS_MANAGER: "CUSTOM_STATUS_MANAGER",
  APP_COMMAND: "APP_COMMAND",
  CTA_TO_ORB_INTRO_QUEST: "CTA to Orb Intro Quest",
  CTA_TO_QUEST_HOME: "CTA to Quest Home",
  CTA_TO_ORBS_SHOP: "CTA_TO_ORBS_SHOP",
  DISCOVERY_BUTTON_TO_ORB_INTRO_QUEST: "Discovery Button to Orb Intro Quest",
  SHOP_BUTTON_TO_SHOP_ORBS_TAB: "Shop Button to Shop Orbs Tab",
  OPEN_ORB_BALANCE_MENU_FROM_PILL: "Open Orb Balance Menu from Pill",
  ORBS_LEARN_MORE_LINK: "Orbs Learn More Link",
  ORBS_QUESTS_BALANCE_MENU_CTA: "ORBS_QUESTS_BALANCE_MENU_CTA",
  ORBS_QUESTS_TILE_SHOP_CTA: "ORBS_QUESTS_TILE_SHOP_CTA",
  ORBS_QUESTS_REWARD_MODAL_SHOP_CTA: "ORBS_QUESTS_REWARD_MODAL_SHOP_CTA",
  MARK_CHANNEL_AS_READ_BUTTON: "Mark Channel as Read Button",
  MARK_CHANNEL_AS_READ_KEYBIND: "Mark Channel as Read Keybind",
  MARK_FORUM_POST_AS_READ_BUTTON: "Mark Forum Post as Read Button",
  MARK_THREAD_AS_READ_BUTTON: "Mark Thread as Read Button",
  MARK_MESSAGE_AS_READ_BUTTON: "Mark Message as Read Button",
  MARK_CHANNEL_AS_READ_FROM_NOTIFICATION: "Mark Channel as Read from Notification",
  ...
  ACK_INLINE_REPLY: "Ack - Inline Reply",
  ACK_TEXT_CHAT_NOTIFICATION: "Ack - Text Chat Notification",
  ACK_MESSAGE_VIEWED: "Ack - Message Viewed",
  ACK_MEDIA_VIEWED: "Ack - Media Viewed",
  ACK_IN_APP_NOTIFICATION_ACTION: "Ack - In App Notification Action",
  ACK_FORUM_ACTIVE_THREADS: "Ack - Forum Active Threads",
  ACK_GUILD_DIRECTORY_CHANNEL_VIEWED: "Ack - Guild Directory Channel Viewed",
  ACK_RECENT_CHANNEL_NEW_CHANNEL_VIEWED: "Ack - Recent Channel New Channel Viewed",
  ACK_INBOX_CHANNEL_NO_MESSAGES: "Ack - Inbox Channel No Messages",
  ACK_INBOX_FORUM_NO_POSTS: "Ack - Inbox Forum No Posts",
  ACK_INBOX_NEWEST_UNREAD_MESSAGE: "Ack - Inbox Newest Unread Message",
  ACK_FORUM_CHANNEL_NO_UNREAD_POSTS: "Ack - Forum Channel No Unread Posts",
  ACK_INCOMING_MESSAGE: "Ack - Incoming Message",
  ACK_RESORT_THREADS: "Ack - Resort Threads",
  ACK_CHANNEL_SELECT_SAME_CHANNEL: "Ack - Channel Select Same Channel",
  ACK_CHANNEL_SELECT_SAME_CHANNEL_SIDEBAR: "Ack - Channel Select Same Channel Sidebar",
  ACK_CHANNEL_SELECT_SAME_CHANNEL_DISPATCH: "Ack - Channel Select Same Channel Dispatch",
  ACK_CHANNEL_RTC_UPDATE_CHAT_OPEN: "Ack - Channel RTC Update Chat Open",
  ACK_CHANNEL_SCROLL: "Ack - Channel Scroll",
...
obj13[0] = require("modules/debug/logAppStart.tsx");
obj13[1] = require("modules/debug/Logger.tsx");
const importAllResult1 = importAllResult;
obj13[2] = require("../discord_common/js/packages/logger/LoggerPIIRestrictedObjects.tsx");
const importAllResult2 = importAllResult;
obj13[3] = require("modules/debug/LogAggregator.tsx");
const importAllResult3 = importAllResult;
obj13[4] = require("modules/tti_analytics/TTITracker.tsx");
const importAllResult4 = importAllResult;
obj13[5] = require("../discord_common/js/packages/app-start-performance/AppStartPerformance.tsx");
const importAllResult5 = importAllResult;
obj13[6] = require("utils/SnowflakeUtils.tsx");
const importAllResult6 = importAllResult;
obj13[7] = require("../_runtime/00012_apply.js");
const importAllResult7 = importAllResult;
obj13[8] = require("../discord_common/js/shared/utils/SnowflakeUtils.tsx");
const importAllResult8 = importAllResult;
obj13[9] = require("../_runtime/00014_Integer.js");
const importAllResult9 = importAllResult;
obj13[10] = require("modules/gateway/native/fast_connect.tsx");
const importAllResult10 = importAllResult;
obj13[11] = require("../_runtime/00017_get_ActivityIndicator.js");
const importAllResult11 = importAllResult;
obj13[12] = require("../_runtime/00018_ActivityIndicator.js");
const importAllResult12 = importAllResult;
obj13[13] = require("../_runtime/00019_noop.js");
const importAllResult13 = importAllResult;
obj13[14] = require("../_runtime/00020_noop.js");
const importAllResult14 = importAllResult;
obj13[15] = require("../_runtime/00023_ProgressBarAndroid.js");
const importAllResult15 = importAllResult;
obj13[16] = require("../_runtime/00027_javaScriptFlagGetter.js");
const importAllResult16 = importAllResult;
obj13[17] = require("../_runtime/00029_NativeReactNativeFeatureFlagsCxx.js");
const importAllResult17 = importAllResult;
obj13[18] = require("../_runtime/00030_get.js");
const importAllResult18 = importAllResult;
obj13[19] = require("../_runtime/00033__arrayWithHoles.js");
const importAllResult19 = importAllResult;
obj13[20] = require("../_runtime/00034__iterableToArrayLimit.js");
...
export const KeybindActions = {
  ...
  SEARCH_SOUNDBOARD: "SEARCH_SOUNDBOARD",
  ...
  OPEN_CHANNEL_TAB: "OPEN_CHANNEL_TAB",
  TOGGLE_CHANNEL_TAB_PIN: "TOGGLE_CHANNEL_TAB_PIN",
  ZOOM_IN: "ZOOM_IN",
  ZOOM_OUT: "ZOOM_OUT",
  ...
  OPEN_APP_DIRECTORY: "OPEN_APP_DIRECTORY",
  BROWSER_DEVTOOLS: "BROWSER_DEVTOOLS",
  VIBE_WITH_WUMPUS: "VIBE_WITH_WUMPUS",
  OPEN_CONTEXT_MENU: "OPEN_CONTEXT_MENU",
  COPY_CHANNEL_LINK: "COPY_CHANNEL_LINK",
};
export const GlobalKeybindActions = {
...
export const GuildSettingsSections = {
  ...
  ROLE_SUBSCRIPTIONS_STORE_PAGE: "ROLE_SUBSCRIPTIONS_STORE_PAGE",
  ...
  GUILD_THEME: "GUILD_THEME",
  ENGAGEMENT: "ENGAGEMENT",
  INVITES: "INVITES",
  BOOST_PERKS: "BOOST_PERKS",
  WEBHOOKS: "WEBHOOKS",
  EDIT_WEBHOOK: "EDIT_WEBHOOK",
  INTEGRATION_PLATFORM: "INTEGRATION_PLATFORM",
  LOBBIES_LINKED: "LOBBIES_LINKED",
  EDIT_LINKED_LOBBY: "EDIT_LINKED_LOBBY",
  CHANNELS_FOLLOWED: "CHANNELS_FOLLOWED",
  ...
  ROLE_SUBSCRIPTIONS_EMOJIS: "ROLE_SUBSCRIPTIONS_EMOJIS",
  ROLE_SUBSCRIPTIONS_TIER_TEMPLATE_SELECTION: "ROLE_SUBSCRIPTIONS_TIER_TEMPLATE_SELECTION",
};
export const GuildSettingsSubsections = {
  DISPLAY: "DISPLAY",
  INVITE: "INVITE",
  DEFAULT_NOTIFICATIONS: "DEFAULT_NOTIFICATIONS",
  ROLE_SUBSCRIPTION_TIERS: "ROLE_SUBSCRIPTION_TIERS",
  ROLE_SUBSCRIPTION_EMOJI: "ROLE_SUBSCRIPTION_EMOJI",
  ROLE_SUBSCRIPTION_TIER_TEMPLATE: "ROLE_SUBSCRIPTION_TIER_TEMPLATE",
  AUTOMOD_MENTION_SPAM: "AUTOMOD_MENTION_SPAM",
  SERVER_GUIDE: "SERVER_GUIDE",
  SAFETY_OVERVIEW: "SAFETY_OVERVIEW",
  SAFETY_AUTOMOD: "SAFETY_AUTOMOD",
  SAFETY_DM_AND_SPAM_PROTECTION: "SAFETY_DM_AND_SPAM_PROTECTION",
  SAFETY_CAPTCHA_AND_RAID_PROTECTION: "SAFETY_CAPTCHA_AND_RAID_PROTECTION",
  SAFETY_PERMISSIONS: "SAFETY_PERMISSIONS",
  ACCESS_DISCOVERABLE: "ACCESS_DISCOVERABLE",
  PROFILE_VISIBILITY: "PROFILE_VISIBILITY",
  BOOST_PERKS_VANITY_URL: "BOOST_PERKS_VANITY_URL",
};
export const ChannelSettingsSections = {
  OVERVIEW: "OVERVIEW",
  ...
  INSTANT_INVITES_MANAGEMENT: "INSTANT_INVITES_MANAGEMENT",
...
export const TTSNotificationTypes = {
  NEVER: "NEVER",
...
export const NoticeTypes = {
  ...
  QUEST_APP_UPSELL: "QUEST_APP_UPSELL",
  VOICE_DISABLED: "VOICE_DISABLED",
  SCHEDULED_MAINTENANCE: "SCHEDULED_MAINTENANCE",
  NO_INPUT_DETECTED: "NO_INPUT_DETECTED",
  NO_INPUT_DEVICES_DETECTED: "NO_INPUT_DEVICES_DETECTED",
  VIDEO_BACKGROUND_UNAVAILABLE: "VIDEO_BACKGROUND_UNAVAILABLE",
  ...
  PREMIUM_TIER_0_TRIAL_ENDING: "PREMIUM_TIER_0_TRIAL_ENDING",
  PREMIUM_TIER_2_DISCOUNT_ENDING: "PREMIUM_TIER_2_DISCOUNT_ENDING",
  ...
  PREMIUM_TIER_0: "PREMIUM_TIER_0",
  PREMIUM_PAST_DUE_ONE_TIME_PAYMENT: "PREMIUM_PAST_DUE_ONE_TIME_PAYMENT",
  BOUNCED_EMAIL_DETECTED: "BOUNCED_EMAIL_DETECTED",
  AUTO_MODERATION_MENTION_RAID_DETECTION: "AUTO_MODERATION_MENTION_RAID_DETECTION",
  AUTOMOD_QUARANTINED_USER_PROFILE: "AUTOMOD_QUARANTINED_USER_PROFILE",
  GUILD_RAID_NOTIFICATION: "GUILD_RAID_NOTIFICATION",
  WIN32_DEPRECATED_MESSAGE: "WIN32_DEPRECATED_MESSAGE",
  VOICE_CONNECTED_LAST_SESSION: "VOICE_CONNECTED_LAST_SESSION",
  HABITUAL_DND: "HABITUAL_DND",
  WIN7_8_DEPRECATED_MESSAGE: "WIN7_8_DEPRECATED_MESSAGE",
  WIN_COMPAT_MODE_MESSAGE: "WIN_COMPAT_MODE_MESSAGE",
  QUESTS_PROGRESS_INTERRUPTION: "QUESTS_PROGRESS_INTERRUPTION",
  CHECKOUT_RECOVERY_NAGBAR: "CHECKOUT_RECOVERY_NAGBAR",
  BLOCK_USER_FEEDBACK_NAGBAR: "BLOCK_USER_FEEDBACK_NAGBAR",
  IGNORE_USER_FEEDBACK_NAGBAR: "IGNORE_USER_FEEDBACK_NAGBAR",
  GIFTING_PROMOTION_REMINDER: "GIFTING_PROMOTION_REMINDER",
  COLLECTIBLES_SHOP_NAGBAR: "COLLECTIBLES_SHOP_NAGBAR",
  LOGIN: "LOGIN",
  REGISTER: "REGISTER",
  MACOS_DEPRECATED_MESSAGE: "MACOS_DEPRECATED_MESSAGE",
  SYSTEM_SERVICE_WARNING: "SYSTEM_SERVICE_WARNING",
  SAFETY_SUSPENDED_USER_WARNING: "SAFETY_SUSPENDED_USER_WARNING",
  VOICE_DARE_OFFER: "VOICE_DARE_OFFER",
  PTT_NO_KEYBIND_WARNING: "PTT_NO_KEYBIND_WARNING",
...
export const GuildFeatures = {
  ...
  CONVERSATIONS_EXTRACTION_PROCESSING: "CONVERSATIONS_EXTRACTION_PROCESSING",
  ...
  MEMBER_VERIFICATION_ROLLOUT_TEST: "MEMBER_VERIFICATION_ROLLOUT_TEST",
  ...
  MAX_FILE_SIZE_100_MB: "MAX_FILE_SIZE_100_MB",
  MAX_FILE_SIZE_250_MB: "MAX_FILE_SIZE_250_MB",
  GUILD_TAGS: "GUILD_TAGS",
  ENHANCED_ROLE_COLORS: "ENHANCED_ROLE_COLORS",
  GUILD_THEME: "GUILD_THEME",
  PREMIUM_TIER_3_OVERRIDE: "PREMIUM_TIER_3_OVERRIDE",
  REPORT_TO_MOD_SURVEY: "REPORT_TO_MOD_SURVEY",
  REPORT_TO_MOD_PILOT: "REPORT_TO_MOD_PILOT",
  ...
  BYPASS_SLOWMODE_PERMISSION_MIGRATION_COMPLETE: "BYPASS_SLOWMODE_PERMISSION_MIGRATION_COMPLETE",
  GUILD_TAGS_BADGE_PACK_PETS: "GUILD_TAGS_BADGE_PACK_PETS",
  GUILD_TAGS_BADGE_PACK_FLEX: "GUILD_TAGS_BADGE_PACK_FLEX",
  GUILD_TAGS_BADGE_PACK_PLANT: "GUILD_TAGS_BADGE_PACK_PLANT",
  GUILD_TAGS_BADGE_PACK_CREEPY_CRAWLIES: "GUILD_TAGS_BADGE_PACK_CREEPY_CRAWLIES",
  GAME_SERVERS: "GAME_SERVERS",
  AGE_VERIFICATION_LARGE_GUILD: "AGE_VERIFICATION_LARGE_GUILD",
...
export const PageAnalyticsLocations = {
  LOGIN: "Login",
  REGISTER: "Register",
  ...
  REPORT_SECOND_LOOK: "Report Second Look",
...
export const MessageFlags = {
  ...
  [1024]: "SHOULD_SHOW_LINK_NOT_DISCORD_WARNING",
  ...
  [32768]: "IS_COMPONENTS_V2",
  SENT_BY_SOCIAL_LAYER_INTEGRATION: 65536,
  [65536]: "SENT_BY_SOCIAL_LAYER_INTEGRATION",
  HIDDEN_SUSPENDED_USER: 131072,
  [131072]: "HIDDEN_SUSPENDED_USER",
  IS_FIRST_BOOSTER: 262144,
  [262144]: "IS_FIRST_BOOSTER",
  IS_GUILD_OFFICIAL: 524288,
  [524288]: "IS_GUILD_OFFICIAL",
  IS_SCHEDULED: 1048576,
  [1048576]: "IS_SCHEDULED",
};
export const MessageAttachmentFlags = {
  ...
  [16]: "CONTAINS_EXPLICIT_MEDIA",
  IS_ANIMATED: 32,
  [32]: "IS_ANIMATED",
  CONTAINS_GORE_CONTENT: 64,
  [64]: "CONTAINS_GORE_CONTENT",
  CONTAINS_SELF_HARM_CONTENT: 128,
  [128]: "CONTAINS_SELF_HARM_CONTENT",
  HAS_TIMELINE_COMMENTS: 256,
  [256]: "HAS_TIMELINE_COMMENTS",
};
export const MessageEmbedMediaFlags = { IS_ANIMATED: 32, [32]: "IS_ANIMATED" };
export const MessageEmbedFlags = {
  CONTAINS_EXPLICIT_MEDIA: 16,
  [16]: "CONTAINS_EXPLICIT_MEDIA",
  IS_CONTENT_INVENTORY_ENTRY: 32,
  [32]: "IS_CONTENT_INVENTORY_ENTRY",
  CONTAINS_GORE_CONTENT: 64,
  [64]: "CONTAINS_GORE_CONTENT",
  CONTAINS_SELF_HARM_CONTENT: 128,
  [128]: "CONTAINS_SELF_HARM_CONTENT",
...
export const OverlayNotificationStatus = {
  ACTIVE: 0,
  [0]: "ACTIVE",
  TIMED_OUT: 1,
  [1]: "TIMED_OUT",
...
export const OverlayNotificationPositions = {
  TOP_LEFT: "topLeft",
  TOP_RIGHT: "topRight",
...
export const ActivityFlags = {
  ...
  [1024]: "SUPPORTS_REMOTE_ACTIVITY_ACTION_JOIN",
  SUPPORTS_JOIN_URL: 2048,
  [2048]: "SUPPORTS_JOIN_URL",
};
...
export const ChannelStreamTypes = {
  MESSAGE: "MESSAGE",
  ...
  MESSAGE_GROUP_SUSPENDED_USER: "MESSAGE_GROUP_SUSPENDED_USER",
...
export const GuildDiscoverySections = {
  FEATURED: "featured",
...
export const SearchTypes = {
  ...
  EMOJI_AUTO_SUGGESTION: "EMOJI_AUTO_SUGGESTION",
  DMS: "DMS",
  THREAD: "THREAD",
  SOUNDBOARD: "SOUNDBOARD",
};
...
export const AbortCodes = {
  ...
  [10009]: "UNKNOWN_OVERWRITE",
  UNKNOWN_PLATFORM: 10010,
  [10010]: "UNKNOWN_PLATFORM",
  UNKNOWN_ROLE: 10011,
  [10011]: "UNKNOWN_ROLE",
  UNKNOWN_TOKEN: 10012,
  [10012]: "UNKNOWN_TOKEN",
  ...
  [20040]: "VANITY_URL_REQUIRED_FOR_PUBLISHED_GUILDS",
  VANITY_URL_EMPLOYEE_ONLY_GUILD_DISABLED: 20044,
  [20044]: "VANITY_URL_EMPLOYEE_ONLY_GUILD_DISABLED",
  ...
  [30001]: "TOO_MANY_BOT_GUILDS",
  TOO_MANY_FRIENDS: 30002,
  [30002]: "TOO_MANY_FRIENDS",
  TOO_MANY_PINS_IN_CHANNEL: 30003,
  [30003]: "TOO_MANY_PINS_IN_CHANNEL",
  TOO_MANY_RECIPIENTS: 30004,
  [30004]: "TOO_MANY_RECIPIENTS",
  TOO_MANY_GUILD_ROLES: 30005,
  [30005]: "TOO_MANY_GUILD_ROLES",
  TOO_MANY_USING_USERNAME: 30006,
  [30006]: "TOO_MANY_USING_USERNAME",
  TOO_MANY_WEBHOOKS: 30007,
  [30007]: "TOO_MANY_WEBHOOKS",
  TOO_MANY_EMOJI: 30008,
  [30008]: "TOO_MANY_EMOJI",
  TOO_MANY_CONNECTIONS: 30009,
  [30009]: "TOO_MANY_CONNECTIONS",
  TOO_MANY_REACTIONS: 30010,
  [30010]: "TOO_MANY_REACTIONS",
  TOO_MANY_ATTACHMENTS: 30015,
  [30015]: "TOO_MANY_ATTACHMENTS",
  TOO_MANY_INVITES: 30016,
  [30016]: "TOO_MANY_INVITES",
  TOO_MANY_ANIMATED_EMOJI: 30018,
  [30018]: "TOO_MANY_ANIMATED_EMOJI",
  GUILD_AT_CAPACITY: 30019,
  [30019]: "GUILD_AT_CAPACITY",
  NOT_ENOUGH_GUILD_MEMBERS: 30029,
  [30029]: "NOT_ENOUGH_GUILD_MEMBERS",
  TOTAL_ATTACHMENT_SIZE_TOO_LARGE: 30053,
  [30053]: "TOTAL_ATTACHMENT_SIZE_TOO_LARGE",
  TOO_MANY_BLOCKED_USERS: 30059,
  [30059]: "TOO_MANY_BLOCKED_USERS",
  TOO_MANY_PUBLISHED_PRODUCT_LISTINGS: 30065,
  [30065]: "TOO_MANY_PUBLISHED_PRODUCT_LISTINGS",
  TOO_MANY_SAVED_MESSAGES: 30074,
  [30074]: "TOO_MANY_SAVED_MESSAGES",
  TOO_MANY_PENDING_OUTGOING: 30078,
  [30078]: "TOO_MANY_PENDING_OUTGOING",
  UNAUTHORIZED: 40001,
  [40001]: "UNAUTHORIZED",
  ...
  [40004]: "SEND_MESSAGE_TEMPORARILY_DISABLED",
  ...
  [50009]: "INVALID_MESSAGE_VERIFICATION_LEVEL",
  INVALID_OAUTH_APP_BOT: 50010,
  [50010]: "INVALID_OAUTH_APP_BOT",
  INVALID_OAUTH_APP_LIMIT: 50011,
  [50011]: "INVALID_OAUTH_APP_LIMIT",
  INVALID_OAUTH_STATE: 50012,
  [50012]: "INVALID_OAUTH_STATE",
  INVALID_PERMISSIONS: 50013,
  [50013]: "INVALID_PERMISSIONS",
  INVALID_TOKEN: 50014,
  [50014]: "INVALID_TOKEN",
  INVALID_NOTE: 50015,
  [50015]: "INVALID_NOTE",
  INVALID_BULK_DELETE_COUNT: 50016,
  [50016]: "INVALID_BULK_DELETE_COUNT",
  INVALID_MFA_LEVEL: 50017,
  [50017]: "INVALID_MFA_LEVEL",
  INVALID_PASSWORD: 50018,
  [50018]: "INVALID_PASSWORD",
  INVALID_PIN_MESSAGE_CHANNEL: 50019,
  [50019]: "INVALID_PIN_MESSAGE_CHANNEL",
  INVALID_INVITE_CODE: 50020,
  [50020]: "INVALID_INVITE_CODE",
  INVALID_ACTION_SYSTEM_MESSAGE: 50021,
  [50021]: "INVALID_ACTION_SYSTEM_MESSAGE",
  INVALID_PHONE_NUMBER: 50022,
  [50022]: "INVALID_PHONE_NUMBER",
  INVALID_CLIENT_ID: 50023,
  [50023]: "INVALID_CLIENT_ID",
  ...
  [50026]: "INVALID_OAUTH2_MISSING_SCOPE",
  INVALID_WEBHOOK_TOKEN: 50027,
  [50027]: "INVALID_WEBHOOK_TOKEN",
  INVALID_FORM_BODY: 50035,
  [50035]: "INVALID_FORM_BODY",
  INVALID_FILE_ASSET_SIZE: 50045,
  [50045]: "INVALID_FILE_ASSET_SIZE",
  INVALID_FILE_ASSET: 50046,
  [50046]: "INVALID_FILE_ASSET",
  INVALID_FILE_ASSET_SIZE_RESIZE_ANIMATED: 50138,
  [50138]: "INVALID_FILE_ASSET_SIZE_RESIZE_ANIMATED",
  INVALID_GIFT_REDEMPTION_EXHAUSTED: 50050,
  [50050]: "INVALID_GIFT_REDEMPTION_EXHAUSTED",
  ...
  CLOUD_UPLOAD_NOT_FOUND: 50146,
  [50146]: "CLOUD_UPLOAD_NOT_FOUND",
  INVALID_ACTIVITY_LAUNCH_AFK_CHANNEL: 50148,
  [50148]: "INVALID_ACTIVITY_LAUNCH_AFK_CHANNEL",
  INVALID_GIFT_REDEMPTION_INCORRECT_USER: 50194,
  [50194]: "INVALID_GIFT_REDEMPTION_INCORRECT_USER",
  INVALID_GIFT_REDEMPTION_CLIENT_UPDATE_REQUIRED: 50283,
  [50283]: "INVALID_GIFT_REDEMPTION_CLIENT_UPDATE_REQUIRED",
  INVALID_GIFT_REDEMPTION_SUBSCRIPTION_MANAGED: 100021,
  [100021]: "INVALID_GIFT_REDEMPTION_SUBSCRIPTION_MANAGED",
  ...
  [100024]: "INVALID_GIFT_REDEMPTION_INVOICE_OPEN",
  INVALID_USER_SETTINGS_DATA: 50105,
  [50105]: "INVALID_USER_SETTINGS_DATA",
  INVALID_ACTIVITY_LAUNCH_AGE_GATED: 50165,
  [50165]: "INVALID_ACTIVITY_LAUNCH_AGE_GATED",
  INVALID_SKU_ATTACHMENT_NO_ARCHIVES: 50186,
  [50186]: "INVALID_SKU_ATTACHMENT_NO_ARCHIVES",
  INVALID_ACTIVITY_LAUNCH_DEV_PREVIEW_GUILD_SIZE: 50209,
  [50209]: "INVALID_ACTIVITY_LAUNCH_DEV_PREVIEW_GUILD_SIZE",
  ACTIVITY_CONFIGURATION_DOES_NOT_SUPPORT_PLATFORM: 50231,
  [50231]: "ACTIVITY_CONFIGURATION_DOES_NOT_SUPPORT_PLATFORM",
  INVALID_MESSAGE_SEND_GAME_FRIEND_DM: 50251,
  [50251]: "INVALID_MESSAGE_SEND_GAME_FRIEND_DM",
  INVALID_MESSAGE_SEND_PROVISIONAL_ACCOUNT_OFFLINE: 50252,
  [50252]: "INVALID_MESSAGE_SEND_PROVISIONAL_ACCOUNT_OFFLINE",
  INVALID_MESSAGE_SEND_NO_MUTUAL_GUILDS: 50278,
  [50278]: "INVALID_MESSAGE_SEND_NO_MUTUAL_GUILDS",
  INVALID_CONNECTION_WHITESPACE_NAME: 50279,
  [50279]: "INVALID_CONNECTION_WHITESPACE_NAME",
  CONNECTION_RATE_LIMITED: 50280,
  [50280]: "CONNECTION_RATE_LIMITED",
  AGE_VERIFICATION_METHOD_UNAVAILABLE: 50603,
  [50603]: "AGE_VERIFICATION_METHOD_UNAVAILABLE",
  MFA_ENABLED: 60001,
  [60001]: "MFA_ENABLED",
  MFA_DISABLED: 60002,
  [60002]: "MFA_DISABLED",
  ...
  [60004]: "MFA_UNVERIFIED",
  MFA_INVALID_SECRET: 60005,
  [60005]: "MFA_INVALID_SECRET",
  MFA_INVALID_TICKET: 60006,
  [60006]: "MFA_INVALID_TICKET",
  MFA_INVALID_CODE: 60008,
  [60008]: "MFA_INVALID_CODE",
  MFA_INVALID_SESSION: 60009,
  [60009]: "MFA_INVALID_SESSION",
  MFA_REQUIRED_FOR_CREATOR_MONETIZATION: 60015,
  [60015]: "MFA_REQUIRED_FOR_CREATOR_MONETIZATION",
  PHONE_NUMBER_UNABLE_TO_SEND: 70003,
  [70003]: "PHONE_NUMBER_UNABLE_TO_SEND",
  PHONE_CARRIER_TYPE_NOT_MOBILE: 70005,
  [70005]: "PHONE_CARRIER_TYPE_NOT_MOBILE",
  PHONE_VERIFICATION_REQUIRED: 70007,
  [70007]: "PHONE_VERIFICATION_REQUIRED",
  PHONE_ALREADY_CLAIMED_GENERIC: 70011,
  [70011]: "PHONE_ALREADY_CLAIMED_GENERIC",
  RELATIONSHIP_INCOMING_DISABLED: 80000,
  [80000]: "RELATIONSHIP_INCOMING_DISABLED",
  RELATIONSHIP_INCOMING_BLOCKED: 80001,
  [80001]: "RELATIONSHIP_INCOMING_BLOCKED",
  RELATIONSHIP_INVALUD_USER_BOT: 80002,
  [80002]: "RELATIONSHIP_INVALUD_USER_BOT",
  RELATIONSHIP_INVALID_SELF: 80003,
  [80003]: "RELATIONSHIP_INVALID_SELF",
  RELATIONSHIP_INVALID_DISCORD_TAG: 80004,
  [80004]: "RELATIONSHIP_INVALID_DISCORD_TAG",
  RELATIONSHIP_ALREADY_FRIENDS: 80007,
  [80007]: "RELATIONSHIP_ALREADY_FRIENDS",
  RELATIONSHIP_INVALID_NO_CONFIRMATION: 80013,
  [80013]: "RELATIONSHIP_INVALID_NO_CONFIRMATION",
  REACTION_BLOCKED: 90001,
  [90001]: "REACTION_BLOCKED",
  LISTING_ALREADY_JOINED: 120000,
  [120000]: "LISTING_ALREADY_JOINED",
  LISTING_TOO_MANY_MEMBERS: 120001,
  [120001]: "LISTING_TOO_MANY_MEMBERS",
  LISTING_JOIN_BLOCKED: 120002,
  [120002]: "LISTING_JOIN_BLOCKED",
  REQUEST_TO_JOIN_USER_INELIGIBLE: 150023,
  [150023]: "REQUEST_TO_JOIN_USER_INELIGIBLE",
  STAGE_CHANNEL_USER_NOT_ALLOWED_TO_SPEAK: 150027,
  [150027]: "STAGE_CHANNEL_USER_NOT_ALLOWED_TO_SPEAK",
  TOO_MANY_THREAD_MEMBERS: 30033,
  [30033]: "TOO_MANY_THREAD_MEMBERS",
  TOO_MANY_THREADS: 160006,
  [160006]: "TOO_MANY_THREADS",
  TOO_MANY_ANNOUNCEMENT_THREADS: 160007,
  [160007]: "TOO_MANY_ANNOUNCEMENT_THREADS",
  POGGERMODE_TEMPORARILY_DISABLED: 170008,
  [170008]: "POGGERMODE_TEMPORARILY_DISABLED",
  AUTOMOD_MESSAGE_BLOCKED: 200000,
  [200000]: "AUTOMOD_MESSAGE_BLOCKED",
  AUTOMOD_TITLE_BLOCKED: 200001,
  [200001]: "AUTOMOD_TITLE_BLOCKED",
  AUTOMOD_INVALID_RUST_SERVICE_RESPONSE: 200002,
  [200002]: "AUTOMOD_INVALID_RUST_SERVICE_RESPONSE",
  MONETIZATION_TERMS_NOT_ACCEPTED: 210003,
  [210003]: "MONETIZATION_TERMS_NOT_ACCEPTED",
  TWO_FA_NOT_ENABLED: 210011,
  [210011]: "TWO_FA_NOT_ENABLED",
  ...
  [210026]: "CREATOR_MONETIZATION_PAYMENT_TEAM_REQUIRED",
  ...
  [240000]: "HARMFUL_LINK_MESSAGE_BLOCKED",
  HARMFUL_URL_BLOCKED: 240001,
  [240001]: "HARMFUL_URL_BLOCKED",
  USER_LIMITED_ACCESS_DEFAULT: 340000,
  [340000]: "USER_LIMITED_ACCESS_DEFAULT",
  USER_GUILD_UPLOAD_ATTACHMENT_LIMITED_ACCESS: 340004,
  [340004]: "USER_GUILD_UPLOAD_ATTACHMENT_LIMITED_ACCESS",
  USER_DM_UPLOAD_ATTACHMENT_LIMITED_ACCESS: 340005,
  [340005]: "USER_DM_UPLOAD_ATTACHMENT_LIMITED_ACCESS",
  USER_GDM_UPLOAD_ATTACHMENT_LIMITED_ACCESS: 340006,
  [340006]: "USER_GDM_UPLOAD_ATTACHMENT_LIMITED_ACCESS",
  USER_FRIEND_REQUEST_LIMITED_ACCESS: 340007,
  [340007]: "USER_FRIEND_REQUEST_LIMITED_ACCESS",
  USER_GUILD_UPLOAD_ATTACHMENT_LIMITED_ACCESS_V2: 340014,
  [340014]: "USER_GUILD_UPLOAD_ATTACHMENT_LIMITED_ACCESS_V2",
  USER_LIMITED_ACCESS_MAX: 349999,
  [349999]: "USER_LIMITED_ACCESS_MAX",
  GUILD_LIMITED_ACCESS_DEFAULT: 400000,
  [400000]: "GUILD_LIMITED_ACCESS_DEFAULT",
  GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS: 400001,
  [400001]: "GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS",
  GUILD_JOIN_INVITE_LIMITED_ACCESS: 400002,
  [400002]: "GUILD_JOIN_INVITE_LIMITED_ACCESS",
  GUILD_FILE_UPLOAD_RESOURCE_LIMITED_ACCESS: 400003,
  [400003]: "GUILD_FILE_UPLOAD_RESOURCE_LIMITED_ACCESS",
  GUILD_GO_LIVE_RATE_LIMITED_ACCESS: 400004,
  [400004]: "GUILD_GO_LIVE_RATE_LIMITED_ACCESS",
  GUILD_MESSAGE_UPDATE_RATE_LIMIT_EXCEEDED: 400005,
  [400005]: "GUILD_MESSAGE_UPDATE_RATE_LIMIT_EXCEEDED",
  GUILD_LIMITED_ACCESS_MAX: 409999,
  [409999]: "GUILD_LIMITED_ACCESS_MAX",
  PARTNER_PROMOTIONS_USER_CLAIMED_PROMOTION: 420002,
  [420002]: "PARTNER_PROMOTIONS_USER_CLAIMED_PROMOTION",
  ...
  [420006]: "PARTNER_PROMOTIONS_NEW_SUBSCRIPTION_REQUIRED",
  PARTNER_PROMOTIONS_UNKNOWN_GIFT: 420007,
  [420007]: "PARTNER_PROMOTIONS_UNKNOWN_GIFT",
  DSA_RSL_REPORT_NOT_FOUND: 521001,
  [521001]: "DSA_RSL_REPORT_NOT_FOUND",
  DSA_RSL_ALREADY_REQUESTED: 521002,
  [521002]: "DSA_RSL_ALREADY_REQUESTED",
  DSA_RSL_LIMITED_TIME: 521003,
  [521003]: "DSA_RSL_LIMITED_TIME",
  DSA_RSL_REPORT_INELIGIBLE: 521004,
  [521004]: "DSA_RSL_REPORT_INELIGIBLE",
  DSA_APPEAL_REQUEST_DEFLECTION: 522001,
  [522001]: "DSA_APPEAL_REQUEST_DEFLECTION",
  CONTENT_INVENTORY_ENTRY_INVALID_PERMISSION: 560006,
  [560006]: "CONTENT_INVENTORY_ENTRY_INVALID_PERMISSION",
  GIFT_CARD_ALREADY_REDEEMED: 590009,
  [590009]: "GIFT_CARD_ALREADY_REDEEMED",
  ACCOUNT_REVERT_INVALID_TOKEN: 620000,
  [620000]: "ACCOUNT_REVERT_INVALID_TOKEN",
  ACCOUNT_REVERT_EMAIL_ALREADY_TAKEN: 620001,
  [620001]: "ACCOUNT_REVERT_EMAIL_ALREADY_TAKEN",
  ACCOUNT_REVERT_ACCOUNT_NOT_FOUND: 620002,
  [620002]: "ACCOUNT_REVERT_ACCOUNT_NOT_FOUND",
  TOO_MANY_SCHEDULED_MESSAGES: 640003,
  [640003]: "TOO_MANY_SCHEDULED_MESSAGES",
  USER_GUILD_JOIN_LARGE_GUILD_UNDERAGE_DISALLOWED: 700000,
...
export const AnalyticsLocations = {
  ...
  FRIENDS_POPOUT: "Friends Popout",
  ROBLOX_CONNECTION_ACTION_SHEET: "Roblox Connection Action Sheet",
  GIFT_SELECTION_MODAL: "Gift Selection Modal",
};
export const AnalyticsGameOpenTypes = {
  JOIN: "join",
...
export const AnalyticsObjectTypes = {
  ...
  ACTIVITY: "activity",
  REACTION: "reaction",
  CANT_ADD_OR_REMOVE: "cant_add_or_remove",
  REACTION_OVERFLOW: "reaction_overflow",
  NITRO_STANDARD: "nitro_standard",
  NITRO_BASIC: "nitro_basic",
  NITRO_SKU_SELECTION: "nitro_sku_selection",
  ACK_AUTOMATIC: "ack_automatic",
  ACK_SEMI_AUTOMATIC: "ack_semi_automatic",
...
export const JoinGuildSources = {
  ...
  GUILD_PROFILE_LURKER: "Guild Profile - Lurker Mode",
  CHANNEL_LIST_STICKY_HEADER_LURKER: "Channel List Sticky Header - Lurker Mode",
  ...
  POLL_ALERT: "Poll Alert",
  ICYMI: "ICYMI",
  GUILD_EVENT_EMBED: "Guild Event Embed",
...
export const LoginSuccessfulSources = {
  QR_CODE: "QR Code Login",
  MOBILE_WEB_HANDOFF: "Mobile Web Handoff",
  DEFAULT: "The default username password Login",
  MFA: "MFA Login",
  PASSWORDLESS_CONDITIONAL_UI: "Passwordless Conditional UI",
};
export const InstantInviteSources = {
  ...
  GUILD_HEADER: "Guild Header",
  GUILD_HEADER_INVITE_BUTTON: "Guild Header Invite Button",
  GUILD_EVENTS: "Guild Events",
  GUILD_CONTEXT_MENU: "Guild Context Menu",
  GUILD_CREATE: "Guild Create",
  GUILD_SCHEDULED_EVENT: "Guild Scheduled Event",
  ...
  HUB_PROGRESS: "Hub Progress",
  HUB_EMPTY_STATE: "Hub Empty State",
  STAGE_CHANNEL: "Stage Channel",
  GROUP_DM: "Group DM Invite Create",
  GUILD_HOME: "Guild Home",
  ACTIVITY_ENTRY_POINT_TILE: "Activity Entry Point Tile",
  ...
  VOICE_CHANNEL_UI_INVITE_BUTTON: "Voice Channel UI Invite Button",
  VOICE_CHANNEL_CALL_MENU_ITEM: "Voice Channel Call Menu Item",
};
export const ChannelNoticeCtaSources = {
  ...
  CHANNEL_OPT_IN: "Channel Opt-In Customize",
...
export const LoggingInviteTypes = {
...
export const InviteOptionsType = {
  SHARE: "Share",
  COPY: "Copy",
  CONTACTS: "Contacts",
  GMAIL: "Gmail",
...
export const ComponentActions = {
  ...
  POPOUT_CLOSE_AFTER_MODALS: "POPOUT_CLOSE_AFTER_MODALS",
  ...
  GUILD_ROOM_NOTE_PLACEMENT_CANCEL: "GUILD_ROOM_NOTE_PLACEMENT_CANCEL",
  ...
  CHANNEL_TEXT_AREA_FOCUSED: "CHANNEL_TEXT_AREA_FOCUSED",
  ...
  PREMIUM_PAYMENT_MODAL_CLOSED: "PREMIUM_PAYMENT_MODAL_CLOSED",
  MEDIA_MODAL_CLOSE: "MEDIA_MODAL_CLOSE",
  GUILD_ROOM_VIDEO_OVERLAY_CLOSE: "GUILD_ROOM_VIDEO_OVERLAY_CLOSE",
  CONVERSATIONS_FOCUS_MODE_CLOSE: "CONVERSATIONS_FOCUS_MODE_CLOSE",
  ...
  VOICE_PANEL_OPEN_CHAT_TAB: "VOICE_PANEL_OPEN_CHAT_TAB",
  ...
  INBOX_MARK_ALL_UNREADS_READ: "INBOX_MARK_ALL_UNREADS_READ",
  SHOW_CHANNEL_DETAILS: "SHOW_CHANNEL_DETAILS",
  HIDE_CHANNEL_DETAILS: "HIDE_CHANNEL_DETAILS",
  CHANNEL_DETAILS_HIDDEN: "CHANNEL_DETAILS_HIDDEN",
  CHANNEL_DETAILS_SHOWN: "CHANNEL_DETAILS_SHOWN",
  MEDIA_KEYBOARD_GIFT_SELECTED: "MEDIA_KEYBOARD_GIFT_SELECTED",
  SHOW_ACCOUNT_PROFILE_POPOUT: "SHOW_ACCOUNT_PROFILE_POPOUT",
  QUEST_GAME_LINK_OPENED: "QUEST_GAME_LINK_OPENED",
  QUEST_APP_STORE_OVERLAY_FINISHED: "QUEST_APP_STORE_OVERLAY_FINISHED",
  SHAKE_PROFILE_MODAL: "SHAKE_PROFILE_MODAL",
...
export const SearchTokenTypes = {
  ...
  FILTER_LINK_FROM: "FILTER_LINK_FROM",
  ANSWER_LINK_FROM: "ANSWER_LINK_FROM",
  ...
  ANSWER_AUTHOR_TYPE: "ANSWER_AUTHOR_TYPE",
};
...
export const PriceTypes = {
  ...
  MOBILE: 4,
  [4]: "MOBILE",
  MOBILE_PREMIUM_TIER_2: 5,
  [5]: "MOBILE_PREMIUM_TIER_2",
  GIFT: 6,
  [6]: "GIFT",
};
export const PriceSetAssignmentPurchaseTypes = {
  DEFAULT: 0,
  [0]: "DEFAULT",
  GIFT: 1,
  [1]: "GIFT",
...
export const AutoCompleteResultTypes = {
  USER: "USER",
  GLOBAL: "GLOBAL",
  ROLE: "ROLE",
  CHANNEL: "CHANNEL",
...
export const ChatInputComponentViewedTypes = {
  ...
  CAMERA: "camera",
  NATIVE_MEDIA_PICKER: "native media picker",
  NITRO_GIFTING: "nitro gifting",
  ...
  APPS_BUTTON: "apps button",
  APPS: "apps",
  POLLS: "polls",
};
export const AnalyticsOverlayLocations = {
...
export const AnalyticEvents = {
  ...
  APP_UI_VIEWED2: "app_ui_viewed2",
  TOUCH_EVENT: "touch_event",
  HTTP_REQUEST: "http_request",
  WEBSOCKET_MESSAGE_RECEIVED: "websocket_message_received",
  APP_WEB_PERF_STARTUP_METRICS: "app_web_perf_startup_metrics",
  ...
  RPC_OPEN_EXTERNAL_LINK_CALLED: "rpc_open_external_link_called",
  ...
  APP_USER_DEAUTHENTICATED: "app_user_deauthenticated",
  ...
  MOBILE_OTA_CHECK_ATTEMPT: "mobile_ota_check_attempt",
  MOBILE_OTA_ASSET_DOWNLOAD_ATTEMPT: "mobile_ota_asset_download_attempt",
  APP_DISK_USAGE_UPDATED: "app_disk_usage_updated",
  DEVICE_EVENT: "device_event",
  REACT_SOFT_EXCEPTION: "react_soft_exception",
  NETWORK_CAPABILITIES_CHANGED: "network_capabilities_changed",
  APP_LIFECYCLE: "app_lifecycle",
  UI_LIFECYCLE: "ui_lifecycle",
  FOREGROUND_SERVICE: "foreground_service",
  IOS_METRIC_KIT_PAYLOAD_RECEIVED: "ios_metric_kit_payload_received",
  ...
  LIBDISCORE_DISPATCH_BRIDGE_TELEMETRY: "libdiscore_dispatch_bridge_telemetry",
  QUEST_APP_STORE_OVERLAY_OPEN_SUCCEEDED: "quest_app_store_overlay_open_succeeded",
  QUEST_APP_STORE_OVERLAY_OPEN_FAILED: "quest_app_store_overlay_open_failed",
  ...
  APP_BACK_FORWARD_NAVIGATED: "app_back_forward_navigated",
  MAIN_VIEW_ACTION_SHEET_SELECTED: "main_view_action_sheet_selected",
  ...
  EXTERNAL_INSTALLATION_ID_RECEIVED: "external_installation_id_received",
  ...
  INVITE_APP_INVOKE_FAILED: "invite_app_invoke_failed",
  INVITE_APP_OPENED: "invite_app_opened",
  INVITE_ACCEPT_BUTTON_RENDERED: "invite_accept_button_rendered",
  INVITE_LEARN_MORE: "invite_learn_more",
  INVITE_FRIEND_MEMBERS_VIEWED: "invite_friend_members_viewed",
  ...
  PERMANENT_INVITE_COMMUNITY_UPSELL_CLICKED: "guild_permanent_links_community_upsell_clicked",
  INVITE_SERVER_CLICKED: "invite_server_clicked",
  INVITE_EMBED_ACTIONED: "invite_embed_actioned",
  VOICE_INVITE_EMBED_BREADCRUMB_CLICKED: "voice_invite_embed_breadcrumb_clicked",
  VOICE_INVITE_SUGGESTIONS_ENTRYPOINT_CLOSED: "voice_invite_suggestions_entrypoint_closed",
  INVITE_CTA_CLICKED: "invite_cta_clicked",
  NATIVE_SHARE_SHEET_APP_CLICKED: "native_share_sheet_app_clicked",
  CHANNEL_LINK_PREVIEW_JOINED: "channel_link_preview_joined",
  CLIENT_HEARTBEAT: "client_heartbeat",
  CLIENT_HEARTBEAT_SKIPPED: "client_heartbeat_skipped",
  CLIENT_AD_HEARTBEAT: "client_ad_heartbeat",
  ATT_ELIGIBILITY_CHECKED: "att_eligibility_checked",
  ATT_APP_STATE_CHECKED: "att_app_state_checked",
  ATT_APP_STATE_CHECKED_OVERRIDE: "att_app_state_checked_override",
  ATT_PROMPT_ERROR: "att_prompt_error",
  AD_IDENTIFIER_FETCHED: "ad_identifier_fetched",
  AD_USER_FETCH_DURATION: "ad_user_fetch_duration",
  HEADLESS_TASK_INVOKED: "headless_task_invoked",
  HEADLESS_TASK_COMPLETED: "headless_task_completed",
  ...
  NOTIFICATION_CENTER_ACTION: "notification_center_action",
  NOTIFICATION_CENTER_LOADED: "notification_center_loaded",
  NOTIFICATION_MIGRATION_COMPLETED: "notification_migration_completed",
  NOTIFICATION_MIGRATION_GUILD_CHANGED: "notification_migration_guild_changed",
  NOTIFICATION_MIGRATION_OPTOUT: "notification_migration_optout",
  CALLKIT_CLICKED: "callkit_clicked",
  PUSH_NOTIFICATION_RECEIVED: "push_notification_received",
  ANDROID_NOTIFICATION_CHANNELS_SYNCED: "android_notification_channels_synced",
  GAME_MENTIONS_NOTIFICATION_SETTING_UPDATED: "game_mentions_notification_settings_updated",
  OVERLAY_DISABLED_SURVEY: "overlay_disabled_survey",
  OVERLAY_BUG_REPORT: "overlay_bug_report",
  NOTIFICATION_REPORT_SUBMITTED: "notification_report_submitted",
  ...
  VIEW_VOICE_CHANNEL: "view_voice_channel",
  VOICE_BOTTOM_SHEET_EXPANDED: "voice_bottom_sheet_expanded",
  VOICE_CONNECTION_CONNECTING: "voice_connection_connecting",
  VOICE_CONNECTION_FAILURE: "voice_connection_failure",
  VOICE_CONNECTION_SOCKET_FAILURE: "voice_connection_socket_failure",
  VOICE_CONNECTION_SUCCESS: "voice_connection_success",
  VOICE_CONNECTION_TTC_COLLECTED: "voice_connection_ttc_collected",
  VOICE_CONNECTION_REMOTE_STREAMS_CREATED: "voice_connection_remote_streams_created",
  VOICE_DISCONNECT: "voice_disconnect",
  START_SPEAKING: "start_speaking",
  START_LISTENING: "start_listening",
  VOICE_WATCHDOG_TIMEOUT: "voice_watchdog_timeout",
  DEVICE_ENUMERATION_TIMEOUT: "device_enumeration_timeout",
  VOICE_PROCESSING: "voice_processing",
  CALL_REPORT_PROBLEM: "call_report_problem",
  LIVE_ACTIVITY_INTERACTED: "live_activity_interacted",
  ...
  CHANNEL_SIDEBAR_VIEWED: "channel_sidebar_viewed",
  CHANNEL_SIDEBAR_RESIZED: "channel_sidebar_resized",
  MEMBER_LIST_VIEWED: "member_list_viewed",
  MEMBER_LIST_TOGGLED: "member_list_toggled",
  MEMBER_LIST_SWIPE_PEEK: "member_list_swipe_peek",
  MEMBER_LIST_SWIPE_TOGGLED: "member_list_swipe_toggled",
  DM_LIST_VIEWED: "dm_list_viewed",
  DM_EMPTY_ACTION: "dm_empty_action",
  DM_SAFETY: "dm_safety",
  NITRO_HOME_NAVIGATION: "nitro_home_navigation",
  SUMMARIES_SIDEBAR_VIEWED: "summaries_sidebar_viewed",
  SUMMARIES_SIDEBAR_TOGGLED: "summaries_sidebar_toggled",
  SUMMARIES_TOPIC_CLICKED: "summaries_topic_clicked",
  SUMMARIES_TOPICS_PILL_TOGGLED: "summaries_topics_pill_toggled",
  SUMMARIES_TOPICS_PILL_VIEWED: "summaries_topics_pill_viewed",
  SUMMARIES_REPORT_PROBLEM: "summaries_report_problem",
  SUMMARIES_UNREAD_BAR_VIEWED: "summaries_unread_bar_viewed",
  SUMMARIES_NOTICE_MANAGE_SETTINGS_CTA_CLICKED: "summaries_notice_manage_settings_cta_clicked",
  SUMMARY_DELETED: "summary_deleted",
  SETTINGS_PANE_VIEWED: "settings_pane_viewed",
  PREVIEW_MARKDOWN_TOGGLED: "preview_markdown_toggled",
  LEGACY_CHAT_INPUT_TOGGLED: "legacy_chat_input_toggled",
  ...
  RECURRING_PROMOTION_MODAL_OPENED: "recurring_promotion_modal_opened",
  THIRD_PARTY_PROMOTION_MODAL_OPENED: "third_party_promotion_modal_opened",
  RECURRING_PROMOTION_CLAIMED: "recurring_promotion_claimed",
  OUTBOUND_PROMOTION_CLAIMED: "outbound_promotion_claimed",
  ...
  TRY_IT_OUT_PRESET_CLICKED: "try_it_out_preset_clicked",
  TRY_IT_OUT_PRESET_SELECTED: "try_it_out_preset_selected",
  TRY_IT_OUT_PRESET_SHUFFLED: "try_it_out_preset_shuffled",
  CUSTOM_NOTIFICATION_SOUND_SETTINGS_UPDATED: "custom_notification_sound_settings_updated",
  CUSTOM_NOTIFICATION_SOUND_OPTION_PLAYED: "custom_notification_sound_option_played",
  ...
  APP_NOTICE_ANCHOR_CLICKED: "app_notice_anchor_clicked",
  VIDEO_LAYOUT_TOGGLED: "video_layout_toggled",
  VIDEO_INPUT_TOGGLED: "video_input_toggled",
  VIDEO_STREAM_ZOOM_CHANGED: "video_stream_zoom_changed",
  ...
  ROBLOX_SUBGAME_DETECTED: "roblox_subgame_detected",
  RUNNING_GAME_HEARTBEAT: "running_game_heartbeat",
  GAME_DETECTION_COMPARISON: "game_detection_comparison",
  ...
  ACTIVITY_DEEP_LINK_ATTEMPTED: "activity_deep_link_attempted",
  ACTIVITY_DEEP_LINK_RECEIVED: "activity_deep_link_received",
  ACTIVITY_INTERACTION_CALLBACK_ERROR: "activity_interaction_callback_error",
  ACTIVITY_VOICE_CONTROLS_TOGGLE_BUTTON_PRESSED: "activity_voice_controls_toggle_button_pressed",
  ACTIVITY_VOICE_CONTROLS_TOGGLE_MOVED: "activity_voice_controls_toggle_moved",
  ACTIVITY_WEB_VIEW_CONTENT_PROCESS_TERMINATED: "activity_web_view_content_process_terminated",
  ACTIVITY_VIDEO_PIP_SHOWN: "activity_video_pip_shown",
  ACTIVITY_VIDEO_PIP_HIDDEN: "activity_video_pip_hidden",
  ACTIVITY_DEVICE_THERMAL_STATE_CHANGED: "activity_device_thermal_state_changed",
  ACTIVITY_THERMAL_STATE_NOTICE_SHOWN: "activity_thermal_state_notice_shown",
  ACTIVITY_HANDSHAKE_TIMED_OUT: "activity_handshake_timed_out",
  ACTIVITY_BOOKMARK_COPY_URL: "activity_bookmark_copy_url",
  ACTIVITY_BOOKMARK_SHARED: "activity_bookmark_shared",
  ACTIVITIES_PAGE_CELEBRATE_TILE_CLICKED: "activities_page_celebrate_tile_clicked",
  ACTIVITIES_PAGE_FEELING_LUCKY_CLICKED: "activities_page_feeling_lucky_clicked",
  ACTIVITY_SHARE_MOMENT_SEND: "activity_share_moment_send",
  ACTIVITY_SHARE_MOMENT_COPY: "activity_share_moment_copy",
  ACTIVITY_SHELF_CLOSE: "activity_shelf_close",
  ACTIVITY_IFRAME_MOUNT: "activity_iframe_mount",
  ACTIVITY_IFRAME_UNMOUNT: "activity_iframe_unmount",
  ACTIVITY_HANDSHAKE: "activity_handshake",
  ACTIVITY_INSTANCE_EMBED_CLICKED: "activity_instance_embed_clicked",
  ACTIVITY_CLOSED_RPC_ERROR: "activity_closed_rpc_error",
  APP_PROFILE_OPEN_APP_BUTTON_CLICKED: "app_profile_open_app_button_clicked",
  APP_DETAIL_PAGE_ENTRY_POINT_COMMAND_BUTTON_CLICKED: "app_detail_page_entry_point_command_button_clicked",
  APP_LAUNCHER_PEP_BUTTON_NOT_RENDERED: "app_launcher_pep_button_not_rendered",
  EMBEDDED_APPLICATION_INVITE_EMBED_VIEWED: "embedded_application_invite_embed_viewed",
  NITRO_TAB_VISITED: "nitro_tab_visited",
  NITRO_TAB_BADGE_SHOWN: "nitro_tab_badge_shown",
  ...
  ACTIVITY_CARD_CLICKED: "activity_card_clicked",
  ACTIVITY_CARDS_VIEWED: "activity_cards_viewed",
  ACTIVITY_DEFAULT_ICON_SHOWN: "activity_default_icon_shown",
  ...
  OVERLAY_HOOK_CRASHED: "overlay_hook_crashed",
  ...
  OVERLAY_USAGE_STATS: "overlay_usage_stats",
  OVERLAY_USAGE_NOTIFICATION_STATS: "overlay_usage_notification_stats",
  OVERLAY_GAME_INVITE_SENT: "overlay_game_invite_sent",
  OVERLAY_GAME_INVITE_NOTIFICATION_SHOWN: "overlay_game_invite_notification_shown",
  OVERLAY_GAME_INVITE_SETTINGS_UPDATED: "overlay_game_invite_settings_updated",
  OVERLAY_STATE_CHANGED: "overlay_state_changed",
  OVERLAY_NOTIFICATION_SETTING_UPDATED: "overlay_notification_setting_updated",
  WIDGET_CONTENT_SHOWN: "widget_content_shown",
  WIDGET_SETTING_UPDATED: "widget_setting_updated",
  ...
  HOME_DRAWER_GUILD_CLICKED: "home_drawer_guild_clicked",
  GUILD_VIEWED: "guild_viewed",
  GUILD_VIEWED_CLICKSTREAM: "guild_viewed_clickstream",
  WAVE_CTA_CLICKED: "wave_cta_clicked",
  FRIENDS_LIST_CLICKED: "friends_list_clicked",
  FRIENDS_LIST_ITEM_ACTION: "friends_list_item_action",
  FRIENDS_LIST_ITEM_CLICKED: "friends_list_item_clicked",
  FRIENDS_LIST_ITEM_CONTEXT_MENU_INTERACTED: "friends_list_item_context_menu_interacted",
  FRIENDS_LIST_ITEM_MESSAGE_CLICKED: "friends_list_item_message_clicked",
  FRIENDS_LIST_ITEM_REMOVE_FRIEND_CLICKED: "friends_list_item_remove_friend_clicked",
  FRIENDS_LIST_ITEM_VIDEO_CALL_CLICKED: "friends_list_item_video_call_clicked",
  FRIENDS_LIST_ITEM_VOICE_CALL_CLICKED: "friends_list_item_voice_call_clicked",
  FRIENDS_LIST_VIEWED: "friends_list_viewed",
  FRIENDS_LIST_VIEWED_CLICKSTREAM: "friends_list_viewed_clickstream",
  ...
  FRIEND_SUGGESTIONS_TAB_VIEWED: "friend_suggestions_tab_viewed",
  CONTACT_INVITE_IOS_SENT: "contact_invite_ios_sent",
  CONTACT_INVITE_TAPPED: "contact_invite_tapped",
  CONTACT_INVITE_OVERLAY_DISMISSED: "contact_invite_overlay_dismissed",
  FRIEND_SUGGESTION_ADDED: "friend_suggestion_added",
  FRIEND_FINDER_SECTION_EXPANDED: "friend_finder_section_expanded",
  FRIEND_FINDER_INITIAL_LOADED: "friend_finder_initial_loaded",
  USERNAME_SEARCH_TAPPED: "username_search_tapped",
  NOW_PLAYING_CARD_HOVERED: "now_playing_card_hovered",
  FRIEND_REQUEST_ACCEPT_MESSAGE_CLICKED: "friend_request_accept_message_clicked",
  CONNECTIONS_XBOX_RELINK_COACHMARK_VIEWED: "connections_xbox_relink_coachmark_viewed",
  CONNECTIONS_XBOX_RELINK_COACHMARK_CLICKED: "connections_xbox_relink_coachmark_clicked",
  CONNECTIONS_NEW_CONSOLE_COACHMARK_VIEWED: "connections_new_console_coachmark_viewed",
  CONNECTIONS_NEW_CONSOLE_COACHMARK_CLICKED: "connections_new_console_coachmark_clicked",
  CONNECTIONS_EMPTY_STATE_CARD_CLICKED: "connections_empty_state_card_clicked",
  CONNECTIONS_XBOX_RELINK_CLICKED: "connections_xbox_relink_clicked",
  MESSAGE_REQUESTS_INITIALIZED: "message_requests_initialized",
  GUILD_DEFAULT_MESSAGE_REQUEST_UPDATED: "guild_default_message_request_updated",
  SPAM_MESSAGE_REQUESTS_VIEWED: "spam_message_requests_viewed",
  MESSAGE_REQUESTS_VIEWED: "message_requests_viewed",
  MESSAGE_REQUEST_PREVIEW_VIEWED: "message_request_preview_viewed",
  EXPLICIT_MEDIA_OBSCURITY_TOGGLE_V2: "explicit_media_obscurity_toggle_v2",
  EXPLICIT_MEDIA_ACTION: "explicit_media_action",
  EXPLICIT_MEDIA_SCAN_CLIENT_TIMED_OUT: "explicit_media_scan_client_timed_out",
  EXPLICIT_MEDIA_REDACTABLE_MESSAGES_LOADED: "explicit_media_redactable_messages_loaded",
  REDACTABLE_MESSAGE_LOADED: "redactable_message_loaded",
  ...
  SAFETY_WARNING_VIEWED: "safety_warning_viewed",
  SAFETY_WARNING_MODAL_VIEWED: "safety_warning_modal_viewed",
  SAFETY_WARNING_CTA_CLICKED: "safety_warning_cta_clicked",
  VIBING_WUMPUS_VIEWED: "vibing_wumpus_viewed",
  VIBING_WUMPUS_ACTION: "vibing_wumpus_action",
  VIBING_WUMPUS_CLOSED: "vibing_wumpus_closed",
  DOWNLOAD_APP: "download_app",
  APPLE_RETRY_PENDING_PURCHASE_STARTED: "apple_retry_pending_purchase_started",
  APPLE_RETRY_PENDING_PURCHASE_SUCCEEDED: "apple_retry_pending_purchase_succeeded",
  APPLE_RETRY_PENDING_PURCHASE_FAILED: "apple_retry_pending_purchase_failed",
  PAYMENT_ELEMENT_CHANGED: "payment_element_changed",
  ...
  PAYMENT_FLOW_ADD_SOURCE_COMPLETED: "payment_flow_add_source_completed",
  PAYMENT_FLOW_ADD_SOURCE_ERROR: "payment_flow_add_source_error",
  PAYMENT_FLOW_SUCCEEDED: "payment_flow_succeeded",
  PAYMENT_FLOW_FAILED: "payment_flow_failed",
  PAYMENT_FLOW_CANCELED: "payment_flow_canceled",
  PAYMENT_FLOW_LOADED: "payment_flow_loaded",
  PAYMENT_FLOW_ERROR: "payment_flow_error",
  PAYMENT_REQUEST_LOADED: "payment_request_loaded",
  PAYMENT_REQUEST_COMPLETED: "payment_request_completed",
  GIFT_CATEGORY_SELECT_MODAL_OPENED: "gift_category_select_modal_opened",
  GIFT_SELECTION_MODAL_OPENED: "gift_selection_modal_opened",
  GIFT_SELECTION_TAB_SELECTED: "gift_selection_tab_selected",
  GIFT_SELECTION_SEE_WISHLIST_CTA_CLICKED: "gift_selection_see_wishlist_cta_clicked",
  IMPRESSION_GIFT_SELECTION_WISHLIST_SECTION_VIEWED: "impression_gift_selection_wishlist_section_viewed",
  IMPRESSION_GIFTING_BADGE_PROGRESS_BANNER: "impression_gifting_badge_progress_banner",
  COLLECTIBLES_GIFTING_SHOP_ITEM_CLICKED: "collectibles_gifting_shop_item_clicked",
  GIFTING_ITEM_CLICKED: "gifting_item_clicked",
  GIFTING_BADGE_INFO_ACTION_SHEET_OPENED: "gifting_badge_info_action_sheet_opened",
  GIFT_CARD_REDEMPTION_START: "gift_card_redemption_start",
  GIFT_CARD_REDEMPTION_EMBED_CLICKED: "gift_card_redemption_embed_clicked",
  GIFT_CARD_REDEMPTION_COMPLETED: "gift_card_redemption_completed",
  GIFT_CARD_REDEMPTION_FAILED: "gift_card_redemption_failed",
  IMPRESSION_GIFT_CARD_REDEMPTION_SUCCEEDED_MODAL: "impression_gift_card_redemption_succeeded_modal",
  ...
  APPLE_PAYMENT_LINK_DISCOUNT_OFFER_PROMPT_VIEWED: "apple_payment_link_discount_offer_prompt_viewed",
  CHANNEL_MEMBER_KICKED: "channel_member_kicked",
  CHANNEL_OPENED: "channel_opened",
  CHANNEL_OPENED_CLICKSTREAM: "channel_opened_clickstream",
  ...
  PERK_DISCOVERABILITY_CARD_CTA_CLICKED: "perk_discoverability_card_cta_clicked",
  THIRD_PARTY_PARTNER_CTA_CLICKED: "third_party_partner_cta_clicked",
  PREMIUM_TENURE_REWARDS_ORBS_CTA_CLICKED: "premium_tenure_rewards_orbs_cta_clicked",
  PREMIUM_TENURE_REWARDS_ORBS_SECTION_IMPRESSION: "premium_tenure_rewards_orbs_section_impression",
  PREMIUM_MARKETING_BENTO_BOX_IMPRESSION: "premium_marketing_bento_box_impression",
  PREMIUM_WHATS_NEW_BOX_CTA_CLICKED: "premium_whats_new_box_cta_clicked",
  PREMIUM_WHATS_NEW_VIEW_TIME: "premium_whats_new_view_time",
  PREMIUM_BEST_OF_VIEW_TIME: "premium_best_of_view_time",
  VIDEO_STREAM_ENDED: "video_stream_ended",
  VIDEO_STREAM_STARTED: "video_stream_started",
  RECEIVER_FIRST_FRAME_DELIVERED: "receiver_first_frame_delivered",
  STREAMER_FIRST_FRAME_ENCRYPTED: "streamer_first_frame_encrypted",
  ...
  AUDIO_INPUT_INITIALIZED: "audio_input_initialized",
  AUDIO_EFFECTS_PROBE_COMPLETED: "audio_effects_probe_completed",
  NOTIFY_STREAM_SETTING_UPDATE: "notify_stream_setting_update",
  SECURE_FRAMES_TRANSITION: "secure_frames_transition",
  MLS_FAILURES: "mls_failures",
  AV_ERROR_REPORTED: "av_error_reported",
  DEBUG_LOG_UPLOADED: "debug_log_uploaded",
  VIDEO_CALL_ENDED: "video_call_ended",
  VIDEO_SPINNER_SHOWN_V2: "video_spinner_shown_v2",
  VIDEO_TOGGLED: "video_toggled",
  IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED: "ios_invalid_token_workaround_triggered",
  ...
  AUDIO_LOCAL_SOUNDBOARD_MUTE_TOGGLED: "audio_local_soundboard_mute_toggled",
  INPUT_MUTE_TOGGLED: "input_mute_toggled",
  SELF_DEAFEN_TOGGLED: "self_deafen_toggled",
  ...
  CHANGE_LOG_VIDEO_PLAYED: "change_log_video_played",
  CHANGE_LOG_VIDEO_UNMUTE: "change_log_video_unmute",
  CHANGE_LOG_DM_REMOVED: "change_log_dm_removed",
  ACCOUNT_LINK_STEP: "account_link_step",
  ACCOUNT_LINK_FAILED: "account_link_failed",
  DEVICE_LINK_STEP: "device_link_step",
  CONNECTED_ACCOUNT_VIEWED: "connected_account_viewed",
  SERVER_DRAWER_OPENED: "server_drawer_opened",
  MESSAGE_COMPOSER_OPENED: "message_composer_opened",
  LAUNCHPAD_SEARCHED: "launchpad_searched",
  LAUNCHPAD_OPENED: "launchpad_opened",
  MEDIA_DEVICE_CHANGED: "media_device_changed",
  DEVICES_LIST_SHOW_MORE_CLICKED: "devices_list_show_more_clicked",
  IMAGE_VIDEO_DATA_SETTINGS_UPDATED: "image_video_data_settings_updated",
  QUEST_HOVER: "quest_hover",
  QUEST_HOVER_OFF: "quest_hover_off",
  QUEST_CONTENT_CLICKED: "quest_content_clicked",
  ...
  QUEST_DECISION_ROUNDTRIP: "quest_decision_roundtrip",
  QUEST_DECISION_ROUNDTRIP_ERROR: "quest_decision_roundtrip_error",
  QUEST_DECISION_RECEIVED: "quest_decision_received",
  EARNED_DECISION_ROUNDTRIP: "earned_decision_roundtrip",
  QUEST_ASSET_LOADING_FAILURE: "quest_asset_loading_failure",
  QUEST_CONTENT_RENDERING_FAILURE: "quest_content_rendering_failure",
  QUEST_BAR_RENDER_PERFORMANCE_MEASURED: "quest_bar_render_performance_measured",
  QUEST_SHARE_LINK_DEEP_LINKED_INTO_DESKTOP_CLIENT: "quest_share_link_deep_linked_into_desktop_client",
  QUEST_SHARE_LINK_DEEP_LINKED_INTO_MOBILE_CLIENT: "quest_share_link_deep_linked_into_mobile_client",
  QUEST_SURVEY_DISMISSED: "quest_survey_dismissed",
  QUEST_SURVEY_DISPLAYED: "quest_survey_displayed",
  QUEST_SURVEY_SUBMITTED: "quest_survey_submitted",
  QUEST_BAR_MODE_CHANGED: "quest_bar_mode_changed",
  QUEST_EMBED_FALLBACK_VIEWED: "quest_embed_fallback_viewed",
  QUEST_THIRD_PARTY_LINK_CLICKED: "quest_third_party_link_clicked",
  DISCOVERY_QUEST_TAB_CLICKED: "discovery_quest_tab_clicked",
  QUEST_BAR_RENDER_DELAY: "quest_bar_render_delay",
  QUEST_HOME_ROUNDTRIP: "quest_home_roundtrip",
  QUEST_HOME_SORT_METHOD_CHANGED: "quest_home_sort_method_changed",
  QUEST_HOME_FILTERS_CHANGED: "quest_home_filters_changed",
  QUEST_GAME_SHEET_ERROR: "quest_game_sheet_error",
  QUEST_HOME_ONBOARDING_POPOVER_RENDERED: "quest_home_onboarding_popover_rendered",
  QUEST_HOME_MOBILE_DEEP_LINK_MISSING_QUEST: "quest_home_mobile_deep_link_missing_quest",
  QUEST_HOME_CAROUSEL_SCROLL: "quest_home_carousel_scroll",
  QUEST_HOME_SEARCH_ENTERED: "quest_home_search_entered",
  QUEST_HOME_SEARCH_CLOSED: "quest_home_search_closed",
  QUEST_HOME_SEARCH_QUERY_SUBMITTED: "quest_home_search_query_submitted",
  QUEST_HOME_HERO_MISSING_QUESTS: "quest_home_hero_missing_quests",
  QUEST_VIDEO_APP_FOCUSED: "quest_video_app_focused",
  QUEST_VIDEO_APP_UNFOCUSED: "quest_video_app_unfocused",
  QUEST_VIDEO_BUFFERING_ENDED: "quest_video_buffering_ended",
  QUEST_VIDEO_BUFFERING_STARTED: "quest_video_buffering_started",
  QUEST_VIDEO_ERROR: "quest_video_error",
  QUEST_VIDEO_FULLSCREEN_ENTERED: "quest_video_fullscreen_entered",
  QUEST_VIDEO_FULLSCREEN_EXITED: "quest_video_fullscreen_exited",
  QUEST_VIDEO_LOADING_ENDED: "quest_video_loading_ended",
  QUEST_VIDEO_LOADING_STARTED: "quest_video_loading_started",
  QUEST_VIDEO_MODAL_CLOSED: "quest_video_modal_closed",
  QUEST_VIDEO_PAUSED: "quest_video_paused",
  QUEST_VIDEO_PROGRESSED: "quest_video_progressed",
  QUEST_VIDEO_RESUMED: "quest_video_resumed",
  QUEST_VIDEO_SEEKED: "quest_video_seeked",
  QUEST_VIDEO_SEGMENT_WATCHED: "quest_video_segment_watched",
  QUEST_VIDEO_TIME_TO_FIRST_FRAME: "quest_video_time_to_first_frame",
  QUEST_VIDEO_VOLUME_CHANGED: "quest_video_volume_changed",
  QUEST_VIDEO_ENROLLMENT_RETRY_ATTEMPTED: "quest_video_enrollment_retry_attempted",
  ATT_PROMPT_RESULT: "att_prompt_result",
  AD_VIDEO_MODAL_CLOSED: "ad_video_modal_closed",
  AD_VIDEO_PROGRESSED: "ad_video_progressed",
  AD_VIDEO_LOOPED: "ad_video_looped",
  AD_VIDEO_PAUSED: "ad_video_paused",
  AD_VIDEO_RESUMED: "ad_video_resumed",
  AD_VIDEO_ERROR: "ad_video_error",
  AD_VIDEO_TIME_TO_FIRST_FRAME: "ad_video_time_to_first_frame",
  AD_VIDEO_BUFFERING_STARTED: "ad_video_buffering_started",
  AD_VIDEO_BUFFERING_ENDED: "ad_video_buffering_ended",
  AD_ASSET_LOADING_FAILURE: "ad_asset_loading_failure",
  BOUNTY_CAROUSEL_SCROLL: "bounty_carousel_scroll",
  BOUNTY_CAROUSEL_EMPTY_STATE_VIEWED: "bounty_carousel_empty_state_viewed",
  BOUNTY_VERTICAL_SCROLL: "bounty_vertical_scroll",
  BOUNTY_AUTO_SCROLL_DISMISSED: "bounty_auto_scroll_dismissed",
  QUEST_HOME_ORB_SHOP_CAROUSEL_VIEWED: "quest_home_orb_shop_carousel_viewed",
  QUEST_HOME_ORB_SHOP_CAROUSEL_SCROLL: "quest_home_orb_shop_carousel_scroll",
  ...
  USER_FINGERPRINT_CHANGED: "user_fingerprint_changed",
  ...
  PREMIUM_MARKETING_PERK_CARD_FLIPPED: "premium_marketing_perk_card_flipped",
  PREMIUM_MARKETING_WHAT_IS_NEW_CARD_HOVERED: "premium_marketing_what_is_new_card_hovered",
  PREMIUM_MARKETING_PERKS_SEE_ALL_CLICKED: "premium_marketing_perks_see_all_clicked",
  ...
  GIFT_ACCEPT_STEP: "gift_accept_step",
  GIFT_INTENT_BADGE_CLICKED: "gift_intent_badge_clicked",
  GIFT_INTENT_ACTION_BUTTON_CLICKED: "gift_intent_action_button_clicked",
  GIFT_INTENT_CARD_SECONDARY_CTA_CLICKED: "gift_intent_card_secondary_cta_clicked",
  GIFT_INTENT_MESSAGE_SENT: "gift_intent_message_sent",
  GIFT_INTENT_DISMISSED: "gift_intent_dismissed",
  GIFT_INFO_OPTIONS_MISSING: "gift_info_options_missing",
  GIFT_PROMOTION_REWARD_SELECTED: "gift_promotion_reward_selected",
  ...
  SEARCH_RESULT_PAGE_CHANGED: "search_result_page_changed",
  SEARCH_RESULT_EMPTY: "search_result_empty",
  SEARCH_OPENED: "search_opened",
  SEARCH_STARTED: "search_started",
  SEARCH_CLOSED: "search_closed",
  SEARCH_INPUT_CLEARED: "search_input_cleared",
  SEARCH_RESULTS_FEEDBACK_SUBMITTED: "search_results_feedback_submitted",
  SEARCH_RESULTS_FEEDBACK_MODAL_VIEWED: "search_results_feedback_modal_viewed",
  SEARCH_RESULTS_FEEDBACK_ENTRYPOINT_VIEWED: "search_results_feedback_entrypoint_viewed",
  SEARCH_MESSAGES_CHANNEL_PREFILL: "search_messages_channel_prefill",
  SEARCH_MESSAGES_AUTOCOMPLETE_CLICKED: "search_messages_autocomplete_clicked",
  SEARCH_MESSAGES_SELECTED_CHANNEL_FILTER_CLICKED: "search_messages_selected_channel_filter_clicked",
  SEARCH_HISTORY_CLICKED: "search_history_clicked",
  SEARCH_BAR_VIEWED: "search_bar_viewed",
  SEARCH_CROSS_DM_SETTING_UPDATE: "search_cross_dm_setting_update",
  SEARCH_FILTERS_MODAL_OPENED: "search_filters_modal_opened",
  MESSAGES_SEARCH_STARTED: "messages_search_started",
  SEARCH_V2_OPENED: "search_v2_opened",
  SEARCH_V2_CLOSED: "search_v2_closed",
  SEARCH_V2_FILTER_ADD: "search_v2_filter_add",
  SEARCH_V2_FILTER_REMOVE: "search_v2_filter_remove",
  SEARCH_V2_INDEXING_VIEWED: "search_v2_indexing_viewed",
  SEARCH_V2_RESULT_EMPTY: "search_v2_result_empty",
  SEARCH_V2_RESULT_MESSAGES_EMPTY: "search_v2_result_messages_empty",
  SEARCH_V2_RESULT_CLICKED: "search_v2_result_clicked",
  SEARCH_V2_RESULTS_VIEWED_AGGREGATE: "search_v2_results_viewed_aggregate",
  SEARCH_V2_HISTORY_CLICKED: "search_v2_history_clicked",
  SEARCH_V2_SUGGESTED_CLICKED: "search_v2_suggested_clicked",
  SEARCH_V2_FILTERS_OPENED: "search_v2_filters_opened",
  SEARCH_V2_FILTERS_APPLIED: "search_v2_filters_applied",
  SEARCH_V2_TAB_SELECTED: "search_v2_tab_selected",
  SEARCH_V2_JUMP_TO_MESSAGE: "search_v2_jump_to_message",
  SEARCH_V2_STARTED: "search_v2_started",
  SEARCH_V2_RESULT_COUNTS_VIEWED: "search_v2_result_counts_viewed",
  SEARCH_V2_RESULTS_VIEWED: "search_v2_results_viewed",
  SEARCH_OPENED_MOBILE: "search_opened_mobile",
  SEARCH_STARTED_MOBILE: "search_started_mobile",
  SEARCH_RESULT_CLICKED_MOBILE: "search_result_clicked_mobile",
  SEARCH_RESULT_RETURNED_MOBILE: "search_result_returned_mobile",
  SEARCH_EMPTY_RESULT_MOBILE: "search_empty_result_mobile",
  SEARCH_EMPTY_MESSAGE_RESULT_MOBILE: "search_empty_message_result_mobile",
  GLOBAL_DISCOVERY_VIEWED: "global_discovery_viewed",
  GLOBAL_DISCOVERY_ENTRYPOINT_CLICKED: "global_discovery_entrypoint_clicked",
  GLOBAL_DISCOVERY_SERVERS_CARD_CLICKED: "global_discovery_servers_card_clicked",
  GLOBAL_DISCOVERY_SERVERS_VIEWED: "global_discovery_servers_viewed",
  ...
  JUMP: "jump",
  GAME_DISPLAY_MODE_ADJUSTMENT_RESPONSE: "game_display_mode_adjustment_response",
  GIF_FAVORITED: "gif_favorited",
  GIF_UNFAVORITED: "gif_unfavorited",
  MESSAGE_SENT_WITH_GIF: "message_sent_with_gif",
  GUILD_DISCOVERY_VIEWED: "guild_discovery_viewed",
  GUILD_DISCOVERY_SEARCH_FAILED: "guild_discovery_search_failed",
  GUILD_DISCOVERY_SEARCH_START: "guild_discovery_search_start",
  GUILD_DISCOVERY_GET_FEATURED_GUILDS_FAILED: "guild_discovery_get_featured_guilds_failed",
  ...
  MOBILE_LURKER_PREVIEW_LURK_STARTED: "mobile_lurker_preview_lurk_started",
  MOBILE_LURKER_PREVIEW_JOIN_CLICKED: "mobile_lurker_preview_join_clicked",
  MOBILE_LURKER_PREVIEW_LEAVE_PROMPT_LEAVE_CLICKED: "mobile_lurker_preview_leave_prompt_leave_clicked",
  MOBILE_LURKER_PREVIEW_GUILD_ICON_CLICKED: "mobile_lurker_preview_guild_icon_clicked",
  MOBILE_LURKER_PREVIEW_LONG_PRESS_LEAVE_CLICKED: "mobile_lurker_preview_long_press_leave_clicked",
  ...
  CUSTOM_STATUS_RANDOMIZER_CLICKED: "custom_status_randomizer_clicked",
  ...
  SERVER_DRAWER_INTERACT: "server_drawer_interact",
  EXPERIMENT_USER_TRIGGERED: "experiment_user_triggered",
  EXPERIMENT_GUILD_TRIGGERED: "experiment_guild_triggered",
  EXPERIMENT_USER_TRIGGERED_FALLBACK: "experiment_user_triggered_fallback",
  EXPERIMENT_GUILD_TRIGGERED_FALLBACK: "experiment_guild_triggered_fallback",
  EXPERIMENT_USER_TRIGGERED_IGNORED: "experiment_user_triggered_ignored",
  EXPERIMENT_GUILD_TRIGGERED_IGNORED: "experiment_guild_triggered_ignored",
  ...
  EXPERIMENT_FETCH_IGNORED: "experiment_fetch_ignored",
  ...
  EXPERIMENT_APEX_DEBUGGING_EVENT: "experiment_apex_debugging_event",
  ...
  MOD_DASH_SEARCH_MEMBERS: "mod_dash_search_members",
  MOD_DASH_FILTER_ROLES: "mod_dash_filter_roles",
  MOD_DASH_FILTER_SAFETY_FLAGS: "mod_dash_filter_safety_flags",
  MODERATION_ACTION: "moderation_action",
  MOD_DASH_MEMBERS_TABLE_VIEWED: "mod_dash_members_table_viewed",
  GUILD_MOD_VIEW_OPENED: "guild_mod_view_opened",
  OAUTH2_AUTHORIZE_VIEWED: "oauth2_authorize_viewed",
  OAUTH2_AUTHORIZE_SUCCESS_VIEWED: "oauth2_authorize_success_viewed",
  OAUTH2_AUTHORIZE_SUCCESS_GO_TO_GUILD_CLICKED: "oauth2_authorize_success_go_to_guild_clicked",
  OAUTH2_AUTHORIZE_SUCCESS_OPEN_APP_CLICKED: "oauth2_authorize_success_open_app_clicked",
  OAUTH2_AUTHORIZE_SUCCESS_CLOSE_CLICKED: "oauth2_authorize_success_close_clicked",
  OAUTH2_AUTHORIZE_STEP_VIEWED: "oauth2_authorize_step_viewed",
  ...
  ONE_TIME_LOGIN_PAGE_VIEWED: "one_time_login_page_viewed",
  ONE_TIME_LOGIN_APP_DETECTION_ATTEMPTED: "one_time_login_app_detection_attempted",
  ONE_TIME_LOGIN_CONTINUE_IN_BROWSER_CLICKED: "one_time_login_continue_in_browser_clicked",
  ONE_TIME_LOGIN_BACK_TO_LOGIN_CLICKED: "one_time_login_back_to_login_clicked",
  ONE_TIME_LOGIN_ATTEMPTED: "one_time_login_attempted",
  ONE_TIME_LOGIN_ERROR: "one_time_login_error",
  ONE_TIME_LOGIN_MODAL_OPENED: "one_time_login_modal_opened",
  ONE_TIME_LOGIN_MODAL_CANCEL_CLICKED: "one_time_login_modal_cancel_clicked",
  ...
  ACTIVITY_FEED_VIEWED: "af_viewed",
  AGE_GATE_SUBMITTED: "age_gate_submitted",
  AGE_GATE_ACTION: "age_gate_action",
  REGISTER_SUBMIT_ERRORED: "register_submit_errored",
  ...
  EXPRESSION_PICKER_KAOMOJI_SELECTED: "expression_picker_kaomoji_selected",
  ...
  EXPRESSION_PICKER_SOUNDBOARD_SOUND_PREVIEWED: "expression_picker_soundboard_sound_previewed",
  EXPRESSION_PICKER_SOUNDBOARD_SOUNDS_LOADED: "expression_picker_soundboard_sounds_loaded",
  EXPRESSION_PICKER_STICKER_SHOP_VIEWED: "expression_picker_sticker_shop_viewed",
  EXPRESSION_PICKER_EXPRESSION_FOCUS: "expression_picker_expression_focus",
  EXPRESSION_PICKER_EXPRESSION_SELECTED: "expression_picker_expression_selected",
  EXPRESSION_PICKER_LOCKED_EXPRESSION_SELECTED: "expression_picker_locked_expression_selected",
  EMOJI_PICKER_THREE_ROW_COLLAPSE_TOGGLED: "emoji_picker_three_row_collapse_toggled",
  EXPRESSION_FAVORITED: "expression_favorited",
  REACTION_PICKER_OPENED: "reaction_picker_opened",
  REACTION_PICKER_TAB_CLICKED: "reaction_picker_tab_clicked",
  SUPER_REACTION_BALANCE_VIEWED: "super_reaction_balance_viewed",
  SUPER_REACTION_NOTIFICATIONS_ENABLED: "super_reaction_notifications_enabled",
  DOUBLE_TAP_REACT_EMOJI_UPDATED: "double_tap_react_emoji_updated",
  ...
  STICKERS_IN_AUTOCOMPLETE_TOGGLED: "stickers_in_autocomplete_toggled",
  ...
  EXPRESSION_TOOLTIP_VIEWED: "expression_tooltip_viewed",
  CHAT_INPUT_COMPONENT_VIEWED: "chat_input_component_viewed",
  TEXT_AREA_CTA_CLICKED: "text_area_cta_clicked",
  CHAT_INPUT_ACTIVITY_BUTTON_CLICKED: "chat_input_activity_button_clicked",
  CHAT_INPUT_OMNI_BUTTON_ACTION: "chat_input_omni_button_action",
  IN_APP_CAMERA_USED: "in_app_camera_used",
  MEDIA_PICKER_ACTION_SHEET_ENGAGED: "media_picker_action_sheet_engaged",
  ...
  USER_CUSTOM_CALL_SOUND_SETTING_UPDATED: "user_custom_call_sound_setting_updated",
  ...
  MOBILE_REDESIGN_TOGGLED: "mobile_redesign_toggled",
  MOBILE_REDESIGN_FEEDBACK: "mobile_redesign_feedback",
  GUILDS_DOCK_TAB_SELECTED: "guilds_dock_tab_selected",
  GUILDS_DOCK_OPENED: "guilds_dock_opened",
  GUILDS_DOCK_ITEM_CLICKED: "guilds_dock_item_clicked",
  GUILDS_DOCK_TAB_SCROLL_STARTED: "guilds_dock_tab_scroll_started",
  ...
  GUILDS_DOCK_SUMMARIES_VIEWED: "guilds_dock_summaries_viewed",
  GUILD_FOLDER_CLICKED: "guild_folder_clicked",
  GUILD_FOLDER_CREATED: "guild_folder_created",
  ...
  ACTIVITIES_CENTER_CONTROL_TRAY_BUTTON_HOVERED: "activities_center_control_tray_button_hovered",
  ACTIVITIES_MINI_SHELF_HOVERED: "activities_mini_shelf_hovered",
  ACTIVITIES_WHATS_NEW_OPENED: "activities_whats_new_opened",
  ACTIVITIES_WHATS_NEW_CLICKED: "activities_whats_new_clicked",
  ROLE_PAGE_VIEWED: "role_page_viewed",
  DROPS_ACTIVITY_PANEL_BUTTON_CLICK: "drops_activity_panel_button_click",
  DROPS_ACTIVITY_PANEL_POPOVER_CTA_CLICK: "drops_activity_panel_popover_cta_click",
  ...
  APPLICATION_COMMAND_SECTION_SELECTED: "application_command_section_selected",
  APPLICATION_COMMAND_SELECTED: "application_command_selected",
  APPLICATION_COMMAND_OPTION_PRESSED: "application_command_option_pressed",
  APPLICATION_COMMAND_OPTIONAL_OPTION_ADDED: "application_command_optional_option_added",
  APPLICATION_COMMAND_OPTIONAL_OPTION_REMOVED: "application_command_optional_option_removed",
  ...
  APPLICATION_COMMAND_SEARCH_OPEN_TIMING: "application_command_search_open_timing",
  APPLICATION_COMMAND_OPTION_STRING_AUTOCOMPLETE_PERFORMANCE:
    "application_command_option_string_autocomplete_performance",
  APPLICATION_COMMAND_PERFORMANCE: "application_command_performance",
  APPLICATION_COMMAND_CACHE_FETCH: "application_command_cache_fetch",
  APPLICATION_COMMAND_TOP_OF_FUNNEL: "application_command_top_of_funnel",
  APPLICATION_ADD_TO_SERVER_CLICKED: "application_add_to_server_clicked",
  PREMIUM_APPLICATION_SUBSCRIPTION_MANAGE_CTA_CLICKED: "premium_application_subscription_manage_cta_clicked",
  CLOUD_PLAY_CTA_CLICKED: "cloud_play_cta_clicked",
  PLAY_CTA_DISPLAYED: "play_cta_displayed",
  PLAY_CTA_IMPRESSION: "play_cta_impression",
  PLAY_CTA_CLICKED: "play_cta_clicked",
  CHANNEL_ATTACH_MENU_USE_APPS_CLICKED: "channel_attach_menu_use_apps_clicked",
  FORTNITE_GFNJOIN_CLICKED: "fortnite_gfnjoin_clicked",
  FORTNITE_DOWNLOAD_CLICKED: "fortnite_download_clicked",
  APP_LAUNCHER_ENTRYPOINT_BUTTON_CLICKED: "app_launcher_entrypoint_button_clicked",
  APP_LAUNCHER_SEARCH_QUERY_TYPED: "app_launcher_search_query_typed",
  APP_LAUNCHER_EMPTY_STATE_ENCOUNTERED: "app_launcher_empty_state_encountered",
  APP_LAUNCHER_CLOSED: "app_launcher_closed",
  APP_LAUNCHER_COMMAND_CLOSED: "app_launcher_command_closed",
  APP_LAUNCHER_FRECENTS_SEEN: "app_launcher_frecents_seen",
  APP_LAUNCHER_FRECENTS_TOGGLED: "app_launcher_frecents_toggled",
  APP_LAUNCHER_OAUTH2_AUTHORIZE_OPENED: "app_launcher_oauth2_authorize_opened",
  APP_LAUNCHER_OAUTH2_AUTHORIZE_SUCCEEDED: "app_launcher_oauth2_authorize_succeeded",
  APP_LAUNCHER_SECTION_VIEW_MORE: "app_launcher_section_view_more",
  APP_LAUNCHER_ACTIVITY_ITEM_SELECTED: "app_launcher_activity_item_selected",
  APP_LAUNCHER_SEARCH_FOCUSED: "app_launcher_search_focused",
  APP_LAUNCHER_EXPANDED: "app_launcher_expanded",
  APP_LAUNCHER_APPLICATION_LINK_COPIED: "app_launcher_application_link_copied",
  APP_OAUTH2_LINK_EMBED_URL_SENT: "app_oauth2_link_embed_url_sent",
  APP_OAUTH2_LINK_EMBED_CTA_CLICKED: "app_oauth2_link_embed_cta_clicked",
  APP_OAUTH2_LINK_EMBED_URL_CLICKED: "app_oauth2_link_embed_url_clicked",
  COMMANDS_MIGRATION_TOOLTIP_DISMISSED: "commands_migration_tooltip_dismissed",
  COMMANDS_MIGRATION_TOOLTIP_VIEWED: "commands_migration_tooltip_viewed",
  POPULAR_APPLICATION_COMMAND_CLICKED: "popular_application_command_clicked",
  APP_MANAGE_CTA_CLICKED: "app_manage_cta_clicked",
  REPORT_APPLICATION_CLICKED: "report_application_clicked",
  CAPTCHA_SERVED: "captcha_served",
  CAPTCHA_EVENT: "captcha_event",
  RECAPTCHA_MODAL_EVENT: "recaptcha_modal_event",
  ...
  YOU_TAB_AVATAR_PRESS: "you_tab_avatar_press",
  YOU_TAB_SETTINGS_ICON_PRESS: "you_tab_settings_icon_press",
  YOU_TAB_NITRO_ICON_PRESS: "you_tab_nitro_icon_press",
  YOU_TAB_CUSTOM_STATUS_PRESS: "you_tab_custom_status_press",
  YOU_TAB_EDIT_PROFILE_PRESS: "you_tab_edit_profile_press",
  USER_SETTINGS_SEARCH_PRESS: "user_settings_search_press",
  USER_SETTINGS_SEARCH_QUERY_ENTERED: "user_settings_search_query_entered",
  USER_SETTINGS_SEARCH_RESULT_PRESS: "user_settings_search_result_press",
  USER_SETTINGS_SEARCH_CLOSED: "user_settings_search_closed",
  USER_SETTINGS_GAME_DETECTION_TOGGLE: "user_settings_game_detection_toggle",
  USER_SETTINGS_MERCH_LINK_CLICKED: "user_settings_merch_link_clicked",
  USER_SETTINGS_MERCH_LINK_CONFIRMED: "user_settings_merch_link_confirmed",
  USER_SETTINGS_REPORT_INCORRECT_GAME_DETECTION: "user_settings_report_incorrect_game_detection",
  USER_SETTINGS_SWIPE_TO_REPLY_TOGGLE: "user_settings_swipe_to_reply_toggle",
  USER_SETTINGS_URL_PARSED: "user_settings_url_parsed",
  USER_SETTINGS_URL_PARSING_FAILED: "user_settings_url_parsing_failed",
  ...
  MESSAGE_ALSO_SEND_TO_CHANNEL_SENT: "message_also_send_to_channel_sent",
  MESSAGE_ALSO_SEND_TO_CHANNEL_TOGGLED: "message_also_send_to_channel_toggled",
  REPLY_MESSAGE_STARTED: "reply_message_started",
  REPLIED_MESSAGE_CLICKED: "replied_message_clicked",
  MESSAGE_SHORTCUT_ACTION_SENT: "message_shortcut_action_sent",
  FORUM_CHANNEL_POSTS_SORTED: "forum_channel_posts_sorted",
  FORUM_CHANNEL_LAYOUT_UPDATED: "forum_channel_layout_updated",
  FORUM_POST_LINK_COPIED: "forum_post_link_copied",
  FORUM_CHANNEL_ONBOARDING_CLICKED: "forum_channel_onboarding_clicked",
  FORUM_CHANNEL_ENABLE_AUTOMOD_CLICKED: "forum_channel_enable_automod_clicked",
  FORUM_CHANNEL_ENABLE_PREVIEW_CLICKED: "forum_channel_enable_preview_clicked",
  FORUM_UPSELL_MODAL_CLICKED: "forum_upsell_modal_clicked",
  FORUM_ADD_MEDIA_TO_ORIGINAL_POST_CLICKED: "forum_add_media_to_original_post_clicked",
  FORUM_CHANNEL_MEDIA_UPLOADER_CLICKED: "forum_channel_media_uploader_clicked",
  FORUM_CHANNEL_SEARCHED: "forum_channel_searched",
  FORUM_CHANNEL_SEARCH_CLEARED: "forum_channel_search_cleared",
  FORUM_CHANNEL_CREATE_NEW_POST_CLICKED: "forum_channel_create_new_post_clicked",
  FORUM_CHANNEL_CREATE_NEW_POST_KEYBIND_USED: "forum_channel_create_new_post_keybind_used",
  FORUM_CHANNEL_NEW_POST_DRAFT_CREATED: "forum_channel_new_post_draft_created",
  FORUM_CHANNEL_NEW_POST_DRAFT_CLEARED: "forum_channel_new_post_draft_cleared",
  FORUM_CHANNEL_TAG_FILTER_CLICKED: "forum_channel_tag_filter_clicked",
  FORUM_CHANNEL_POST_CREATED: "forum_channel_post_created",
  FORUM_CHANNEL_SCROLLED: "forum_channel_scrolled",
  FORUM_CHANNEL_MORE_POSTS_LOADED: "forum_channel_more_posts_loaded",
  FORUM_CHANNEL_POST_CLICKED: "forum_channel_post_clicked",
  FORUM_CHANNEL_SEEN_BATCH: "forum_channel_seen_batch",
  FORUM_CHANNEL_GRID_UPSELL_VIEWED: "forum_channel_grid_upsell_viewed",
  MESSAGE_DISPATCH_SESSION_METADATA_FOUND: "message_dispatch_session_metadata_found",
  MEDIA_POST_PREVIEW_EMBED_CLICKED: "media_post_preview_embed_clicked",
  MEDIA_POST_SHARE_PROMPT_CLICKED: "media_post_share_prompt_clicked",
  ...
  ADD_FRIEND_OTHER_PLACES_HUB_CLICKED: "add_friend_other_places_hub_clicked",
  ADD_FRIEND_OTHER_PLACES_DISCOVERY_CLICKED: "add_friend_other_places_discovery_clicked",
  ...
  CANCELLATION_FLOW_COMPLETED: "cancellation_flow_completed",
  ...
  MESSAGE_LINK_COPIED: "message_link_copied",
  IMAGE_HOVERED: "image_hovered",
  APP_IMAGE_RECS_MENU_VIEWED: "app_image_recs_menu_viewed",
  MESSAGE_SWIPE_ACTION_SENT: "message_swipe_action_sent",
  CHAT_CONTEXT_BAR_ACTION_CANCELED: "chat_context_bar_action_canceled",
  SHARE_SHEET_ACTION: "share_sheet_action",
  SHARE_MESSAGE_SENT: "share_message_sent",
  EXTERNAL_SHARE_OPENED: "external_share_opened",
  MESSAGE_POPOUT_MENU_OPENED_MOBILE: "message_popout_menu_opened_mobile",
  MESSAGE_POPOUT_MENU_OPENED_DESKTOP: "message_popout_menu_opened_desktop",
  VOICE_CODEC_DETECTED: "voice_codec_detected",
  VOICE_SETTINGS_CHANGED: "voice_settings_changed",
  SYSTEM_CAMERA_SETTINGS_OPENED: "system_camera_settings_opened",
  VOICE_AND_VIDEO_SETTINGS_UPDATED: "voice_and_video_settings_updated",
  CALL_BUTTON_CLICKED: "call_button_clicked",
  CALL_MENU_ITEM_INTERACTED: "call_menu_item_interacted",
  CALL_TILE_POPPED_OUT: "call_tile_popped_out",
  USER_VOLUME_SETTING_UPDATED: "user_volume_setting_updated",
  VIDEO_OPENH264_DOWNLOADED: "video_openh264_downloaded",
  CLIP_SAVE_KEYBIND_PRESSED: "clip_save_keybind_pressed",
  CLIP_SAVED: "clip_saved",
  CLIP_SAVE_FAILURE: "clip_save_failure",
  CLIPS_INIT_FAILURE: "clips_init_failure",
  CLIP_DELETED: "clip_deleted",
  CLIP_GALLERY_CARD_CLICKED: "clip_gallery_card_clicked",
  CLIP_GALLERY_CARD_BUTTON_CLICKED: "clip_gallery_card_button_clicked",
  CLIPS_FILTER_CHANGED: "clips_filter_changed",
  CLIP_EDITED: "clip_edited",
  CLIP_SHARED: "clip_shared",
  CLIPS_HARDWARE_CLASSIFICATION: "clips_hardware_classification",
  CLIPS_ENABLED_TOGGLED: "clips_enabled_toggled",
  CLIPS_SETTINGS_UPDATED: "clips_settings_updated",
  CLIP_TIMELINE_TRIMMED: "clip_timeline_trimmed",
  CLIP_REMOTE_TRIGGER_SENT: "clip_remote_trigger_sent",
  CLIPS_SESSION_STARTED: "clips_session_started",
  CLIPS_SESSION_ENDED: "clips_session_ended",
  CLIP_PROMOTED: "clip_promoted",
  CLIP_EXPORTED: "clip_exported",
  STANDALONE_BILLING_FLOW_STARTED: "standalone_billing_flow_started",
  DUNNING_EMAIL_LANDING_VIEWED: "dunning_email_landing_viewed",
  PAST_DUE_CHECKOUT_INVOICE_LOAD_FAILED: "past_due_checkout_invoice_load_failed",
  PAST_DUE_CHECKOUT_STANDALONE_BOUNCED: "past_due_checkout_standalone_bounced",
  PAST_DUE_CHECKOUT_STANDALONE_PAGE_VIEWED: "past_due_checkout_standalone_page_viewed",
  MOBILE_OPEN_STANDALONE_MANAGE_SUBSCRIPTION_PAGE: "mobile_open_standalone_manage_subscription_page",
  MOBILE_OPEN_STANDALONE_GUILD_BOOST_CHECKOUT_PAGE: "mobile_open_standalone_guild_boost_checkout_page",
  STANDALONE_MANAGE_SUBSCRIPTION_PAGE_VIEWED: "standalone_manage_subscription_page_viewed",
  INBOUND_PROMOTION_VIEWED: "inbound_promotion_viewed",
  INBOUND_PROMOTION_ELIGIBILITY_CHECKED: "inbound_promotion_eligibility_checked",
  ...
  CONTEXT_MENU_MEDIA_LINK_COPIED: "context_menu_media_link_copied",
  MEDIA_DOWNLOAD_BUTTON_TAPPED: "media_download_button_tapped",
  MEDIA_VIEWER_SESSION_COMPLETED: "media_viewer_session_completed",
  MEDIA_VIEWER_SHARE_BUTTON_TAPPED: "media_viewer_share_button_tapped",
  MEDIA_VIEWER_DOWNLOAD_BUTTON_TAPPED: "media_viewer_download_button_tapped",
  MEDIA_VIEWER_AFFORDANCE_CLICKED: "media_viewer_affordance_clicked",
  MEDIA_VIEWER_IMAGE_COPIED: "media_viewer_image_copied",
  MEDIA_VIEWER_IMAGE_SAVED: "media_viewer_image_saved",
  MEDIA_VIEWER_LINK_COPIED: "media_viewer_link_copied",
  MEDIA_VIEWER_LINK_OPENED: "media_viewer_link_opened",
  FILE_SIZE_LIMIT_EXCEEDED: "file_size_limit_exceeded",
  MOBILE_FILE_PICKER_ERROR: "mobile_file_picker_error",
  PREMIUM_UNCANCEL_WINBACK_CTA_CLICKED: "premium_uncancel_winback_cta_clicked",
  EASTER_EGG_INTERACTED: "easter_egg_interacted",
  APRIL_FOOLS_2026_OPENED: "april_fools_2026_opened",
  APRIL_FOOLS_2026_VIDEO_CLICKED: "april_fools_2026_video_clicked",
  RPC_COMMAND_SENT: "rpc_command_sent",
  RPC_SERVER_ERROR_CAUGHT: "rpc_server_error_caught",
  ...
  ROLE_SUBSCRIPTION_PURCHASE_SYSTEM_MESSAGE_CTA_CLICKED: "role_subscription_purchase_system_message_cta_clicked",
  ROLE_SUBSCRIPTION_PURCHASE_SYSTEM_MESSAGE_CLICKED: "role_subscription_purchase_system_message_clicked",
  ROLE_SUBSCRIPTION_LISTING_CREATED: "role_subscription_listing_created_v2",
  ROLE_SUBSCRIPTION_LISTING_TEMPLATE_SELECTOR_EXITED: "role_subscription_listing_template_selector_exited",
  ...
  MULTI_ACCOUNT_SWITCH_TIMEOUT: "multi_account_switch_timeout",
  MULTI_ACCOUNT_SWITCH_TOKEN_COLLISION_WRITE: "multi_account_switch_token_collision_write",
  MULTI_ACCOUNT_SWITCH_TOKEN_COLLISION: "multi_account_switch_token_collision",
  MULTI_ACCOUNT_SWITCH_READY_MISMATCH: "multi_account_switch_ready_mismatch",
  MULTI_ACCOUNT_VALIDATE_TOKEN_USER_MISMATCH: "multi_account_validate_token_user_mismatch",
  ...
  FEED_ITEM_SEEN_LONG: "feed_item_seen_long",
  FEED_ITEM_CONTENT_GEN_FEEDBACK: "feed_item_content_gen_feedback",
  ...
  HOME_BACKGROUNDED: "home_backgrounded",
  HOME_EXITED: "home_exited",
  HOME_EVENT_CLICKED: "home_event_clicked",
  HOME_EVENTS_LOADED: "home_events_loaded",
  HOME_REPORT_PROBLEM: "home_report_problem",
  HOME_FEEDBACK_PROMPT_VIEWED: "home_feedback_prompt_viewed",
  HOME_FEEDBACK_SUBMITTED: "home_feedback_submitted",
  HOME_FIRST_SCROLL_STARTED: "home_first_scroll_started",
  HOME_PANEL_VIEWED: "home_panel_viewed",
  ICYMI_ONBOARDING_SCREEN_SKIPPED: "icymi_onboarding_screen_skipped",
  ICYMI_ONBOARDING_CATEGORY_TOGGLED: "icymi_onboarding_category_toggled",
  ICYMI_ONBOARDING_GUILD_TOGGLED: "icymi_onboarding_guild_toggled",
  ICYMI_FEED_EMPTY_LOADING_SEEN: "feed_empty_loading_seen",
  ICYMI_FEED_EMPTY_LOADING_ABANDONED: "feed_empty_loading_abandoned",
  ICYMI_FEED_EMPTY_LOADING_COMPLETE: "feed_empty_loading_complete",
  FEED_SESSION_STARTED: "feed_session_started",
  FEED_SESSION_COMPLETED: "feed_session_completed",
  FEED_ITEM_1S_DWELLED: "feed_item_1s_dwelled",
  FEED_ITEM_DWELLED: "feed_item_dwelled",
  FEED_ITEM_ACTIONED: "feed_item_actioned",
  FEED_FILTER_ACTIONED: "feed_filter_actioned",
  FEED_PAGE_ACTIONED: "feed_page_actioned",
  TOPICAL_NAV_ENTRYPOINT_IMPRESSION: "topical_nav_entrypoint_impression",
  TOPICAL_NAV_TOPICS_UNIT_IMPRESSION: "topical_nav_topics_unit_impression",
  TOPICAL_NAV_PREVIEW_IMPRESSION: "topical_nav_preview_impression",
  TOPICAL_NAV_TOPICS_UNIT_CLICKED: "topical_nav_topics_unit_clicked",
  TOPICAL_NAV_FOCUS_MODE_IMPRESSION: "topical_nav_focus_mode_impression",
  TOPICAL_NAV_FOCUS_MODE_DISMISSED: "topical_nav_focus_mode_dismissed",
  TOPICAL_NAV_THUMBS_CLICKED: "topical_nav_thumbs_clicked",
  ...
  PREMIUM_FEATURE_TRY_OUT: "premium_feature_try_out",
  TEXT_IN_VOICE_OPENED: "text_in_voice_opened",
  TEXT_IN_VOICE_CLOSED: "text_in_voice_closed",
  GUILD_AUTOMOD_FEEDBACK: "guild_automod_feedback",
  GUILD_RAID_REPORTED: "guild_raid_reported",
  GUILD_RAID_FEEDBACK: "guild_raid_feedback",
  GUILD_RAID_ALERTS_SETUP: "guild_raid_alerts_setup",
  GUILD_RAID_ALERT_SENT: "guild_raid_alert_sent",
  GUILD_SAFETY_MENTION_RAID_SETUP_CTA_CLICKED: "guild_safety_mention_raid_setup_cta_clicked",
  GUILD_RAID_LOCKDOWN_FEEDBACK: "guild_raid_lockdown_feedback",
  GUILD_RAID_INTERVENTION_STATE_CHANGE: "guild_raid_intervention_state_change",
  BULK_MODERATION_ACTION_STARTED: "bulk_moderation_action_started",
  BULK_MODERATION_ACTION_COMPLETED: "bulk_moderation_action_completed",
  ...
  IAR_IGNORE_USER_BUTTON_CLICKED: "iar_ignore_user_button_clicked",
  IAR_BLOCK_USER_BUTTON_CLICKED: "iar_block_user_button_clicked",
  IAR_MUTE_USER_BUTTON_CLICKED: "iar_mute_user_button_clicked",
  IAR_LEAVE_GUILD_BUTTON_CLICKED: "iar_leave_guild_button_clicked",
  IAR_DELETE_MESSAGE_BUTTON_CLICKED: "iar_delete_message_button_clicked",
  IAR_CLICK_DONT_LIKE: "iar_click_dont_like",
  IAR_NAVIGATE: "iar_navigate",
  IAR_MODAL_OPEN: "iar_modal_open",
  IAR_MODAL_CLOSE: "iar_modal_close",
  IAR_FEEDBACK_MODAL_VIEWED: "iar_feedback_modal_viewed",
  IAR_FEEDBACK_SUBMITTED: "iar_feedback_submitted",
  IAR_SETTINGS_UPSELLS_ACTION: "iar_settings_upsells_action",
  IAR_DEAUTHORIZE_APP_BUTTON_CLICKED: "iar_deauthorize_app_button_clicked",
  IAR_REMOVE_APP_BUTTON_CLICKED: "iar_remove_app_button_clicked",
  BLOCK_USER_FEEDBACK_SUBMITTED: "block_user_feedback_submitted",
  ...
  STICKER_FILE_RESIZED: "sticker_file_resized",
  STICKER_UPLOAD_STARTED: "sticker_upload_started",
  STICKER_UPLOAD_COMPLETED: "sticker_upload_completed",
  STICKER_UPLOAD_FILE_SIZE_LIMIT_EXCEEDED: "sticker_upload_file_size_limit_exceeded",
  APP_DIRECTORY_OPENED: "app_directory_opened",
  APP_DIRECTORY_PAGE_VIEWED: "app_directory_page_viewed",
  APP_DIRECTORY_SEARCH_STARTED: "app_directory_search_started",
  APP_DIRECTORY_SEARCHED: "app_directory_searched",
  APP_DIRECTORY_CTA_CLICKED: "app_directory_cta_clicked",
  APP_DIRECTORY_CATEGORY_CLICKED: "app_directory_category_clicked",
  APP_DIRECTORY_COLLECTION_VIEWED: "app_directory_collection_viewed",
  APP_DIRECTORY_COLLECTION_ITEM_CLICKED: "app_directory_collection_item_clicked",
  APP_DIRECTORY_COLLECTION_SCROLLED: "app_directory_collection_scrolled",
  APP_DIRECTORY_SUPPORT_SERVER_JOINED: "app_directory_support_server_joined",
  APP_DIRECTORY_APPLICATION_EXTERNAL_LINK_CLICKED: "app_directory_application_external_link_clicked",
  APP_DIRECTORY_APPLICATION_LINK_COPIED: "app_directory_application_link_copied",
  APP_DIRECTORY_RECOMMENDATION_CLICKED: "app_directory_recommendation_clicked",
  APP_DIRECTORY_RECOMMENDATIONS_VIEWED: "app_directory_recommendations_viewed",
  APP_DIRECTORY_SEARCH_RESULT_CLICKED: "app_directory_search_result_clicked",
  APP_DIRECTORY_PROFILE_TAB_CLICKED: "app_directory_profile_tab_clicked",
  APP_DIRECTORY_CAROUSEL_IMAGE_LOADED: "app_directory_carousel_image_loaded",
  APP_DIRECTORY_PROFILE_EMBED_APP_INFO_CLICKED: "app_directory_profile_embed_app_info_clicked",
  APP_DIRECTORY_PROFILE_EMBED_VIEWED: "app_directory_profile_embed_viewed",
  APP_DIRECTORY_PROFILE_INVALID_EMBED_VIEWED: "app_directory_profile_invalid_embed_viewed",
  APP_DIRECTORY_PROFILE_EMBED_URL_CLICKED: "app_directory_profile_embed_url_clicked",
  APP_DIRECTORY_PROFILE_EMBED_SENT: "app_directory_profile_embed_sent",
  APP_DIRECTORY_PAGE_SCROLLED: "app_directory_page_scrolled",
  APP_DIRECTORY_INSTALL_CLICKED: "app_directory_install_clicked",
  APP_DIRECTORY_LAUNCH_CLICKED: "app_directory_launch_clicked",
  APP_DIRECTORY_MANAGE_APP_CLICKED: "app_directory_manage_app_clicked",
  POPULAR_CHANNEL_CLICKED: "popular_channel_clicked",
  URL_CLICKED: "url_clicked",
  LINK_CLICKED: "link_clicked",
  ROLE_STYLE_SETTING_UPDATED: "role_style_setting_updated",
  OFFICIAL_MESSAGE_STYLE_SETTING_UPDATED: "official_message_style_setting_updated",
  PREMIUM_MARKETING_SURFACE_SIDE_BAR_SELECT: "premium_marketing_surface_side_bar_select",
  PREMIUM_MARKETING_SURFACE_VIEWED: "premium_marketing_surface_viewed",
  PREMIUM_MARKETING_SURFACE_EXITED: "premium_marketing_surface_exited",
  PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM: "premium_marketing_surface_reached_bottom",
  PREMIUM_MARKETING_COMPONENT_BOTTOM_VIEWED: "premium_marketing_component_bottom_viewed",
  ...
  PREMIUM_SETTINGS_INTERACTED: "premium_settings_interacted",
  MOBILE_NITRO_HOME_TAB_SWITCHED: "mobile_nitro_home_tab_switched",
  MOBILE_NITRO_HOME_PERKS_CAROUSEL_SCROLLED: "mobile_nitro_home_perks_carousel_scrolled",
  TIERED_TENURE_BADGE_CLICKED: "tiered_tenure_badge_clicked",
  TIERED_TENURE_BADGE_LEVEL_UP_REPLAY_CLICKED: "tiered_tenure_badge_level_up_replay_clicked",
  TIERED_TENURE_BADGE_PERK_CARD_CLICKED: "tiered_tenure_badge_perk_card_clicked",
  VOICE_CALL_TRANSFER: "voice_call_transfer",
  DM_SAFETY_COACHMARK_ACTION: "dm_safety_coachmark_action",
  MESSAGE_REQUEST_ACTION: "message_request_action",
  VOICE_CHANNEL_EFFECT_BAR_VIEWED: "voice_channel_effect_bar_viewed",
  VOICE_CHANNEL_EFFECT_SENT: "voice_channel_effect_sent",
  VOICE_CHANNEL_EFFECT_VIEWED: "voice_channel_effect_viewed",
  ...
  VOICE_CHANNEL_GAME_ACTIVITY_INDICATOR_SET: "voice_channel_game_activity_indicator_set",
  VOICE_CHANNEL_GAME_ACTIVITY_INDICATOR_VIEWED: "voice_channel_game_activity_indicator_viewed",
  VOICE_CHANNEL_GAME_ACTIVITY_INDICATOR_HOVERED: "voice_channel_game_activity_indicator_hovered",
  LOCAL_VOICE_SETTINGS_LOADED: "local_voice_settings_loaded",
  HIGHLIGHTS_TEST_LOADED: "highlights_test_loaded",
  CHANNEL_LIST_UPDATED: "channel_list_updated",
  CHANNEL_BANNER_VIEWED: "channel_banner_viewed",
  CHANNEL_BANNER_CTA_CLICKED: "channel_banner_cta_clicked",
  CHANNEL_LIST_UNREAD_BADGE_VIEWED: "channel_list_unread_badge_viewed",
  CHANNEL_LIST_UNREAD_BADGE_CLICKED: "channel_list_unread_badge_clicked",
  USER_CONTINUE_IN_BROWSER_CLICKED: "user_continue_in_browser_clicked",
  ...
  IN_APP_NOTIFICATION_SUPPRESSED: "in_app_notification_suppressed",
  ...
  IN_APP_NOTIFICATION_EXPANDED: "in_app_notification_expanded",
  PASSPORT_CHALLENGE_VIEWED: "passport_challenge_viewed",
  PASSPORT_CHALLENGE_STARTED: "passport_challenge_started",
  PASSPORT_CHALLENGE_FINISHED: "passport_challenge_finished",
  PASSPORT_ENTRY_VIEWED: "passport_entry_viewed",
  PASSPORT_ROLE_POPOUT_VIEWED: "passport_role_popout_viewed",
  GUILD_ONBOARDING_LOADED: "guild_onboarding_loaded",
  GUILD_ONBOARDING_STEP_VIEWED: "guild_onboarding_step_viewed",
  GUILD_ONBOARDING_STEP_COMPLETED: "guild_onboarding_step_completed",
  GUILD_ONBOARDING_CONNECTION_CLICKED: "guild_onboarding_connection_clicked",
  GUILD_SETTINGS_ONBOARDING_WIZARD_PROGRESS_CTA_CLICKED: "guild_settings_onboarding_wizard_progress_cta_clicked",
  GUILD_SETTINGS_ONBOARDING_EDIT_PAGE_CLICKED: "guild_settings_onboarding_edit_page_clicked",
  GUILD_SETTINGS_GUIDE_UPDATED: "guild_settings_guide_updated",
  SERVER_GUIDE_VIEWED: "server_guide_viewed",
  SERVER_GUIDE_CHANNEL_SELECTED: "server_guide_channel_selected",
  SERVER_GUIDE_ACTION_COMPLETED: "server_guide_action_completed",
  ASSISTANT_STEP_COMPLETED: "assistant_step_completed",
  FOR_LATER_SAVED_MESSAGES_CREATE: "for_later_saved_messages_create",
  FOR_LATER_SAVED_MESSAGES_DELETE: "for_later_saved_messages_delete",
  FOR_LATER_SAVED_MESSAGE_JUMP: "for_later_saved_message_jump",
  FOR_LATER_REMINDER_NOTIFICATION_CLICKED: "for_later_reminder_notification_clicked",
  MEDIA_PICKER_INFINITE_SCROLL_PAGED: "media_picker_infinite_scroll_paged",
  MESSAGE_MENU_GOOGLE_SEARCHED: "message_menu_google_searched",
  MESSAGE_MENU_TIME_TO_CLOSE: "message_menu_time_to_close",
  MESSAGE_MENU_TIME_TO_SELECT: "message_menu_time_to_select",
  EVENT_RINGTONE_TOGGLED: "event_ringtone_toggled",
  USER_PROFILE_ACTION: "user_profile_action",
  USER_PROFILE_UI_VIEWED: "user_profile_ui_viewed",
  USER_PROFILE_ACTIVITY_JOINED: "user_profile_activity_joined",
  USER_PROFILE_ACTIVITY_ACTION: "user_profile_activity_action",
  USER_PROFILE_BADGE_PRESSED: "user_profile_badge_pressed",
  USER_PROFILE_RECENT_GAMES_VIEWED: "user_profile_recent_games_viewed",
  USER_PROFILE_RECENT_GAMES_SETTING_DISABLED: "user_profile_recent_games_setting_disabled",
  USER_PROFILE_BADGE_HOVERED: "user_profile_badge_hovered",
  USER_PROFILE_BADGE_ACTION: "user_profile_badge_action",
  BADGE_DIRECTORY_ACTION: "badge_directory_action",
  USER_PROFILE_EDIT_ACTION: "user_profile_edit_action",
  USER_PROFILE_EDIT_SAVED: "user_profile_edit_saved",
  ...
  PREMIUM_WOW_MOMENT_VIEWED: "premium_wow_moment_viewed",
  PREMIUM_WOW_MOMENT_MEDIA_PREFETCH_TRIGGER: "premium_wow_moment_media_prefetch_trigger",
  PREMIUM_BRAND_REFRESH_WOW_MOMENT_VIEWED: "premium_brand_refresh_wow_moment_viewed",
  PREMIUM_BRAND_REFRESH_WOW_MOMENT_ASSETS_PREFETCHING: "premium_brand_refresh_wow_moment_assets_prefetching",
  PREMIUM_BRAND_REFRESH_WOW_MOMENT_ASSETS_PREFETCH_SUCCESS: "premium_brand_refresh_wow_moment_assets_prefetch_success",
  PREMIUM_BRAND_REFRESH_WOW_MOMENT_ASSETS_NOT_LOADED_ON_CONFIRMATION:
    "premium_brand_refresh_wow_moment_assets_not_loaded_on_confirmation",
  PREMIUM_FEATURE_HELPER_ACTIONS: "premium_feature_helper_actions",
  PREMIUM_FEATURE_TUTORIAL_STEPS: "premium_feature_tutorial_steps",
  PREMIUM_FEATURE_TUTORIAL_STEPS_NEXT: "premium_feature_tutorial_steps_next",
  PREMIUM_FEATURE_TUTORIAL_FLOW_DISABLED: "premium_feature_tutorial_flow_disabled",
  PREMIUM_APP_CANCELLATION_SURVEY_SUBMITTED: "premium_app_cancellation_survey_submitted",
  GUILD_ROLE_SUBSCRIPTION_STORE_PAGE_TOGGLED: "guild_role_subscription_store_page_toggled",
  GUILD_ROLE_SUBSCRIPTION_TEAM_SETUP_CLICKED: "guild_role_subscription_team_setup_clicked",
  GUILD_ROLE_SUBSCRIPTION_SETUP_MODAL_CLOSED: "guild_role_subscription_setup_modal_closed",
  GUILD_SHOP_PREVIEW_CLICK: "guild_shop_preview_click",
  GUILD_SHOP_COPY_LINK: "guild_shop_copy_link",
  GUILD_SHOP_EMBED_CLICKED: "guild_shop_embed_clicked",
  MESSAGE_ACTION_SHEET_OPENED: "message_action_sheet_opened",
  MESSAGE_ACTION_SHEET_OPTION_PRESSED: "message_action_sheet_option_pressed",
  SNOWSGIVING_PAGE_CTA_CLICKED: "snowsgiving_page_cta_clicked",
  REACTION_ACTION_SHEET_OPENED: "reaction_action_sheet_opened",
  MESSAGE_EMBEDS_ACTION_COMPLETED: "message_embeds_action_completed",
  ...
  CLIENT_THEME_UPDATED: "client_theme_updated",
  CLIENT_THEME_PREVIEW_VIEWED: "client_theme_preview_viewed",
  CLIENT_THEME_PREVIEW_CLOSED: "client_theme_preview_closed",
  CUSTOM_THEME_RESET_BUTTON_CLICKED: "custom_theme_reset_button_clicked",
  CUSTOM_THEMES_EDITOR_CONTROLS_CHANGED: "custom_themes_editor_controls_changed",
  ...
  CUSTOM_THEMES_UPDATED: "custom_themes_updated",
  CUSTOM_THEMES_COACHMARK_NOT_SHOWN_REASON: "custom_themes_coachmark_not_shown_reason",
  CUSTOM_THEMES_BANNER_CLICKED: "custom_themes_banner_clicked",
  CUSTOM_THEME_SHARED: "custom_theme_shared",
  CUSTOM_THEME_SHARE_APPLIED: "custom_theme_share_applied",
  CUSTOM_THEME_SHARE_PREVIEWED: "custom_theme_share_previewed",
  GUILD_DROPDOWN_MENU_VIEWED: "guild_dropdown_menu_viewed",
  VOICE_MESSAGE_PLAYBACK_ENDED: "voice_message_playback_ended",
  VOICE_MESSAGE_PLAYBACK_FAILED: "voice_message_playback_failed",
  VOICE_MESSAGE_PLAYBACK_STARTED: "voice_message_playback_started",
  VOICE_MESSAGE_RECORDED: "voice_message_recorded",
  FAMILY_CENTER_VIEWED: "family_center_viewed",
  FAMILY_CENTER_ACTION: "family_center_action",
  SAFETY_HUB_VIEWED: "safety_hub_viewed",
  SAFETY_HUB_ACTION: "safety_hub_action",
  AGE_VERIFICATION_MODAL_VIEWED: "age_verification_modal_viewed",
  AGE_VERIFICATION_MODAL_CLICKED: "age_verification_modal_clicked",
  AGE_VERIFICATION_DM_CLICKED: "age_verification_dm_clicked",
  AGE_VERIFICATION_TOAST_VIEWED: "age_verification_toast_viewed",
  NSFW_SPACE_WARNING_MODAL_VIEWED: "nsfw_space_warning_modal_viewed",
  NSFW_SPACE_WARNING_MODAL_CLICKED: "nsfw_space_warning_modal_clicked",
  BOOSTING_UPSELL_VIEWED: "boosting_upsell_viewed",
  BOOSTING_UPSELL_CLICKED: "boosting_upsell_clicked",
  BOOSTING_MARKETING_VIDEO_PLAYED: "boosting_marketing_video_played",
  BOOSTING_MARKETING_VIDEO_COMPLETED: "boosting_marketing_video_completed",
  BOOST_PLAN_ROW_SELECTED: "boost_plan_row_selected",
  GUILD_BOOST_PAST_DUE_CANCELLATION_FLOW_COMPLETED: "guild_boost_past_due_cancellation_flow_completed",
  GUILD_BOOST_PAST_DUE_CANCEL_MODAL_VIEWED: "guild_boost_past_due_cancel_modal_viewed",
  TNS_SKU_REPORT_SUBMITTED: "tns_sku_report_submitted",
  TNS_USER_REPORT_SUBMITTED: "tns_user_report_submitted",
  MJ_CHAT_BAR_CTA_CLICKED: "mj_chat_bar_cta_clicked",
  MJ_CHAT_BAR_VIEWED: "mj_chat_bar_viewed",
  PREMIUM_TRIAL_OFFER_ACTION_SHEET_VIEWED: "premium_trial_offer_action_sheet_viewed",
  PREMIUM_TRIAL_OFFER_ACTION_SHEET_CTA_CLICKED: "premium_trial_offer_action_sheet_cta_clicked",
  PREMIUM_TRIAL_OFFER_ACTION_SHEET_DISMISSED: "premium_trial_offer_action_sheet_dismissed",
  PREMIUM_DISCOUNT_OFFER_ACTION_SHEET_VIEWED: "premium_discount_offer_action_sheet_viewed",
  PREMIUM_DISCOUNT_OFFER_ACTION_SHEET_DISMISSED: "premium_discount_offer_action_sheet_dismissed",
  PREMIUM_DISCOUNT_OFFER_ACTION_SHEET_CTA_CLICKED: "premium_discount_offer_action_sheet_cta_clicked",
  PREMIUM_GROUP_INVITE_FRIENDS_MODAL_VIEWED: "premium_group_invite_friends_modal_viewed",
  PREMIUM_GROUP_INVITE_FRIENDS_CTA_CLICKED: "premium_group_invite_friends_cta_clicked",
  PREMIUM_GROUP_INVITE_FRIENDS_RESULT: "premium_group_invite_friends_result",
  PREMIUM_GROUP_INVITE_EMBED_ACCEPT_CLICKED: "premium_group_invite_embed_accept_clicked",
  PREMIUM_GROUP_INVITE_EMBED_CANCEL_CLICKED: "premium_group_invite_embed_cancel_clicked",
  PREMIUM_GROUP_ACCEPT_INVITE_MODAL_VIEWED: "premium_group_accept_invite_modal_viewed",
  PREMIUM_GROUP_ACCEPT_INVITE_CTA_CLICKED: "premium_group_accept_invite_cta_clicked",
  PREMIUM_GROUP_ACCEPT_INVITE_ERROR: "premium_group_accept_invite_error",
  PREMIUM_GROUP_MEMBER_CANCELLATION_STARTED: "premium_group_member_cancellation_started",
  PREMIUM_GROUP_MEMBER_CANCELLATION_STEP: "premium_group_member_cancellation_step",
  PREMIUM_GROUP_MEMBER_CANCELLATION_COMPLETED: "premium_group_member_cancellation_completed",
  PREMIUM_GROUP_REMOVE_MEMBER_MODAL_VIEWED: "premium_group_remove_member_modal_viewed",
  PREMIUM_GROUP_REMOVE_MEMBER_CTA_CLICKED: "premium_group_remove_member_cta_clicked",
  PREMIUM_GROUP_SUBSCRIPTION_CARD_INVITE_CLICKED: "premium_group_subscription_card_invite_clicked",
  PREMIUM_GROUP_SUBSCRIPTION_CARD_REMOVE_MEMBER_CLICKED: "premium_group_subscription_card_remove_member_clicked",
  PREMIUM_GROUP_SUBSCRIPTION_CARD_CANCEL_INVITE_CLICKED: "premium_group_subscription_card_cancel_invite_clicked",
  PREMIUM_GROUP_CANCEL_INVITE_MODAL_VIEWED: "premium_group_cancel_invite_modal_viewed",
  PREMIUM_GROUP_CANCEL_INVITE_CTA_CLICKED: "premium_group_cancel_invite_cta_clicked",
  PREMIUM_GROUP_PURCHASE_CONFIRMATION_VIEWED: "premium_group_purchase_confirmation_viewed",
  PREMIUM_GROUP_PURCHASE_FRIEND_SELECTOR_OPENED: "premium_group_purchase_friend_selector_opened",
  PREMIUM_GROUP_PURCHASE_FRIEND_SELECTOR_SKIPPED: "premium_group_purchase_friend_selector_skipped",
  FETCH_USER_OFFER_STARTED: "fetch_user_offer_started",
  SHARE_NITRO_FLOW_STEPS: "share_nitro_flow_steps",
  REFERRAL_PROGRAM_SHARE_MODAL_CTA_CLICKED: "referral_program_share_modal_cta_clicked",
  REFERRAL_PROGRAM_SHARE_CTA_CLICKED: "referral_program_share_cta_clicked",
  CACHE_STORE_CACHE_SKIPPED: "cache_store_cache_skipped",
  GATEWAY_BRIDGE_TIMEOUT: "gateway_bridge_timeout",
  ...
  MESSAGE_COMPOSER_SEARCH_RESULT_CLICKED: "message_composer_search_result_clicked",
  MESSAGE_COMPOSER_MAX_USERS_ADDED: "message_composer_max_users_added",
  REMIX_SENT: "remix_sent",
  REMIX_DOWNLOADED: "remix_downloaded",
  REMIX_SURFACE_EXIT_MODAL: "remix_surface_exit_modal",
  REMIXING_ACTION_REDONE: "remixing_action_redone",
  REMIXING_ACTION_UNDONE: "remixing_action_undone",
  REMIXING_SURFACE_EXIT_CANCELED: "remixing_surface_exit_canceled",
  REMIXING_SURFACE_EXITED: "remixing_surface_exited",
  REMIXING_SURFACE_OPENED: "remixing_surface_opened",
  ROUTE_UNMOUNT: "route_unmount",
  REMIXING_COMPONENT_ADDED: "remixing_component_added",
  REMIXING_COMPONENT_TOOL_CANCELED: "remixing_component_tool_canceled",
  REMIXING_COMPONENT_TOOL_OPENED: "remixing_component_tool_opened",
  REMIXING_BADGE_PRESSED: "remixing_badge_pressed",
  REMIXING_UPSELL_ACCEPTED: "remixing_upsell_accepted",
  REMIXING_UPSELL_DISMISSED: "remixing_upsell_dismissed",
  CONSOLE_LAN_DETECTION_OPT_IN: "console_lan_detection_opt_in",
  CONSOLE_LAN_DETECTION_CONSOLE_DETECTED: "console_lan_detection_console_detected",
  GDM_STARTER_APPS_VIEWED: "gdm_starter_apps_viewed",
  DCF_CAP_EXCEEDED: "dcf_cap_exceeded",
  ACK_COMMUNITY_MESSAGES: "ack_community_messages",
  VOICE_PANEL_TAB_OPENED: "voice_panel_tab_opened",
  VOICE_PANEL_SCREENSHARE_BUTTON_TAPPED: "voice_panel_screenshare_button_tapped",
  VOICE_PANEL_LAYOUT_DESYNC: "voice_panel_layout_desync",
  ANNOUNCEMENT_MESSAGE_LINK_CLICKED: "announcement_message_link_clicked",
  ANNOUNCEMENT_MESSAGE_VIEWED: "announcement_message_viewed",
  OFFICIAL_MESSAGE_VIEWED: "official_message_viewed",
  REDESIGN_NAV_BAR_CLICKED: "redesign_nav_bar_clicked",
  REDESIGN_NAV_BAR_RENDERED: "redesign_nav_bar_rendered",
  CHANNEL_BACK_NAVIGATED: "channel_back_navigated",
  ...
  MEDIA_ATTACHMENT_PLAYBACK_ENDED: "media_attachment_playback_ended",
  MEDIA_PIP_ENDED: "media_pip_ended",
  FEEDBACK_FORM_VIEWED: "feedback_form_viewed",
  FEEDBACK_FORM_SUBMITTED: "feedback_form_submitted",
  HOTSPOT_HIDDEN: "hotspot_hidden",
  USER_SETTINGS_IN_APP_FEEDBACK_OPTED_OUT: "user_settings_in_app_feedback_opted_out",
  APP_ICON_UPDATED: "app_icon_updated",
  APP_ICON_PREVIEW_VIEWED: "app_icon_preview_viewed",
  APP_ICON_AUTO_RESET: "app_icon_auto_reset",
  CHANNEL_LIST_END_REACHED: "channel_list_end_reached",
  COLLECTIBLES_SHOP_VIEWED: "collectibles_shop_viewed",
  COLLECTIBLES_SHOP_SCROLLED: "collectibles_shop_scrolled",
  COLLECTIBLES_EXPIRY_MODAL_CLOSED: "collectibles_expiry_modal_closed",
  COLLECTIBLES_TILE_IMPRESSION: "collectibles_tile_impression",
  COLLECTIBLES_SHARE_LINK_BUTTON_CLICKED: "collectibles_share_link_button_clicked",
  COLLECTIBLES_SHOP_ELEMENT_CLICKED: "collectibles_shop_element_clicked",
  SHOP_THIS_LOOK_MENU_ACTION: "shop_this_look_menu_action",
  SHOP_THIS_LOOK_ROW_ACTION: "shop_this_look_row_action",
  COLLECTIBLES_SHOP_PERF_TRACKED: "collectibles_shop_perf_tracked",
  COLLECTIBLES_SHOP_FEED_SHUFFLE_CLICKED: "collectibles_shop_feed_shuffle_clicked",
  COLLECTIBLES_SHOP_FEED_SORT_CHANGED: "collectibles_shop_feed_sort_changed",
  ...
  UPDATER_METRICS_DOWNLOAD: "updater_metrics_download",
  UPDATER_METRICS_INSTALL: "updater_metrics_install",
  UPDATER_METRICS_COMBINED: "updater_metrics_combined",
  UPDATER_METRICS_TRANSITION_STATUS: "updater_metrics_transition_status",
  HANGOUT_WINDOW_CLICKED: "hangout_window_clicked",
  HANGOUT_WINDOW_CONTENT_CLEARED: "hangout_window_content_cleared",
  HANGOUT_WINDOW_CONTENT_SET: "hangout_window_content_set",
  HANGOUT_WINDOW_GIF_CATEGORY_CLICKED: "hangout_window_gif_category_clicked",
  MEMBER_VERIFICATION_APPLICATION_VIEWED: "member_verification_application_viewed",
  GUILD_MEMBER_APPLICATION_REPORTED: "guild_member_application_reported",
  GUILD_APPLICATION_ABANDONED: "guild_application_abandoned",
  GUILD_MEMBER_APPLICATION_ACTION: "guild_member_application_action",
  GUILD_MEMBER_APPLICATION_VIEWED: "guild_member_application_viewed",
  GUILD_MEMBER_APPLICATION_INTERVIEW_MESSAGE: "guild_member_application_interview_message",
  GUILD_PROFILE_VIEWED: "guild_profile_viewed",
  CHANNEL_PROMPT_ACTION_CLICKED: "channel_prompt_action_clicked",
  GPLAY_PURCHASE_FAILED: "gplay_purchase_failed",
  LIVE_ACTIVITY_SETTINGS_UPDATED: "live_activity_settings_updated",
  GUILD_BAN_REMOVED: "guild_ban_removed",
  POLL_CREATION_CANCELLED: "poll_creation_cancelled",
  POLL_SHOW_RESULTS_CLICKED: "poll_show_results_clicked",
  POLL_VOTE_SELECTED: "poll_vote_selected",
  ACTIVITY_REACTOR_INTERACTED: "activity_reactor_interacted",
  GUILD_TOOLTIP_SHOWN: "guild_tooltip_shown",
  GUILD_TOOLTIP_CARD_CLICKED: "guild_tooltip_card_clicked",
  MEMBERLIST_CONTENT_FEED_TOGGLED: "memberlist_content_feed_expander_toggled",
  MEMBERLIST_CONTENT_FEED_HIDDEN: "memberlist_content_feed_hidden_toggled",
  CONTENT_POPOUT_EMOJI_CLICKED: "content_inventory_reaction_popout_emoji_clicked",
  MEMBERLIST_POPOUT_SHARE_TO_CHANNEL_TOGGLED: "memberlist_popout_share_to_channel_toggled",
  RANKING_ITEMS_SEEN_MUST_BE_SAMPLED: "ranking_items_seen",
  RANKING_ITEM_INTERACTED_MUST_BE_SAMPLED: "ranking_item_interacted",
  LEAGUE_OF_LEGENDS_MATCH_DATA_NOT_FETCHING: "league_of_legends_match_data_not_fetching",
  GAME_PROFILE_ACTION: "game_profile_action",
  GAME_PROFILE_EMBED_ACTION: "game_profile_embed_action",
  GAME_PROFILE_OPEN: "game_profile_open",
  GAME_PROFILE_CLOSE: "game_profile_close",
  GAME_PROFILE_ENTRY_POINT_AVAILABLE: "game_profile_entry_point_available",
  VOICE_CHANNEL_GAME_ACTIVITY_SHOWN: "voice_channel_game_activity_shown",
  GAME_PROFILE_FOLLOW_SURVEY: "game_profile_follow_survey",
  GAME_PROFILE_FEEDBACK: "game_profile_feedback",
  GAME_PROFILE_LINK_EMBED_SENT: "game_profile_link_embed_sent",
  USER_NITRO_TENURE_REWARD_ACKNOWLEDGED: "user_nitro_tenure_reward_acknowledged",
  REVIEW_REQUEST_DEFERRED: "review_request_deferred",
  REVIEW_REQUEST_ELIGIBILITY_CHECKED: "review_request_eligibility_checked",
  REVIEW_REQUEST_SHOW_ATTEMPTED: "review_request_show_attempted",
  DM_SETTINGS_UPSELL_ACTION: "dm_settings_upsell_action",
  STOREFRONT_PURCHASE_CLICKED: "storefront_purchase_clicked",
  VIEW_PREMIUM_APP_STOREFRONT: "view_premium_app_storefront",
  VIEW_PREMIUM_APP_EXPANDED_PRODUCT_CARD: "view_premium_app_expanded_product_card",
  STOREFRONT_STORE_MESSAGE_EMBED_CLICKED: "storefront_store_message_embed_clicked",
  STOREFRONT_SKU_MESSAGE_EMBED_CLICKED: "storefront_sku_message_embed_clicked",
  STOREFRONT_COPY_LINK_CLICKED: "storefront_copy_link_clicked",
  PAYMENT_HISTORY_CONNECT_ACCOUNT_BUTTON_CLICKED: "payment_history_connect_account_button_clicked",
  SLAYER_STOREFRONT_GAME_LAUNCH_CLICKED: "slayer_storefront_game_launch_clicked",
  SLAYER_STOREFRONT_CLAIM_MODAL_CLOSE_BUTTON_CLICKED: "slayer_storefront_claim_modal_close_button_clicked",
  SLAYER_STOREFRONT_MODAL_CLOSED: "slayer_storefront_modal_closed",
  SLAYER_STOREFRONT_LINK_ACCOUNT_STEP_VIEWED: "slayer_storefront_link_account_step_viewed",
  SLAYER_STOREFRONT_ACCOUNT_LINK_CLICKED: "slayer_storefront_account_link_clicked",
  SLAYER_STOREFRONT_GIFT_CODE_CLAIM_CLICKED: "slayer_storefront_gift_code_claim_clicked",
  SLAYER_STOREFRONT_PAGE_VIEWED: "slayer_storefront_page_viewed",
  SLAYER_STOREFRONT_PAGE_SCROLLED: "slayer_storefront_page_scrolled",
  SLAYER_STOREFRONT_CARD_HOVERED: "slayer_storefront_card_hovered",
  SLAYER_STOREFRONT_CARD_IMPRESSION: "slayer_storefront_card_impression",
  SLAYER_STOREFRONT_CARD_ELEMENT_CLICKED: "slayer_storefront_card_element_clicked",
  SLAYER_STOREFRONT_PDP_ELEMENT_CLICKED: "slayer_storefront_pdp_element_clicked",
  ...
  COMMERCE_SHOP_VC_GIFT_BUTTON_VIEWED: "commerce_shop_vc_gift_button_viewed",
  COMMERCE_SHOP_GIFTING_BREADCRUMB_VIEWED: "commerce_shop_gifting_breadcrumb_viewed",
  USER_SERVER_PRIVACY_SETTINGS_ACTION: "user_server_privacy_settings_action",
  RUNNING_GAME_OVERRIDE_ADDED: "running_game_override_added",
  GUILD_NSFW_GATE_VIEWED: "guild_nsfw_gate_viewed",
  FORWARD_MESSAGE_STARTED: "forward_message_started",
  FORWARD_MESSAGE_CANCELLED: "forward_message_cancelled",
  FORWARD_MESSAGE_SENT: "forward_message_sent",
  FORWARD_COPY_LINK: "forward_copy_link",
  FORWARD_ADD_RECIPIENT: "forward_add_recipient",
  FORWARD_EDIT_SEARCH: "forward_edit_search",
  FORWARD_EDIT_CONTEXT_MESSAGE: "forward_edit_context_message",
  FORWARD_ONE_TAP_UNDO: "forward_one_tap_undo",
  FORWARD_ONE_TAP_VIEW: "forward_one_tap_view",
  FORWARD_BREADCRUMB_CLICKED: "forward_breadcrumb_clicked",
  CDM_LOAD_STATUS: "cdm_load_status",
  CDM_READY_COMPLETE: "cdm_ready_complete",
  DESKTOP_TTI: "desktop_tti",
  DESKTOP_TTI_V2: "desktop_tti_v2",
  DESKTOP_PERF_ATTRIBUTED_MODULE_MEMORY: "desktop_perf_attributed_module_memory",
  DESKTOP_PERF_ATTRIBUTED_MODULE_MEMORY_CALLSTACK: "desktop_perf_attributed_module_memory_callstack",
  DESKTOP_PERF_CPU_PROFILE: "desktop_perf_cpu_profile",
  DESKTOP_PERF_HEARTBEAT: "desktop_perf_heartbeat",
  RTC_PANEL_VIEWED: "rtc_panel_viewed",
  E2EE_USER_VERIFICATION_VIEWED: "e2ee_user_verification_viewed",
  E2EE_USER_VERIFIED: "e2ee_user_verified",
  E2EE_USER_VERIFICATION_FAILED: "e2ee_user_verification_failed",
  E2EE_PUBLIC_KEY_MISMATCH: "e2ee_public_key_mismatch",
  E2EE_USER_VERIFICATION_SHARE_CLICKED: "e2ee_user_verification_share_clicked",
  E2EE_USER_VERIFICATION_CODE_COPIED: "e2ee_user_verification_code_copied",
  E2EE_CALL_VERIFICATION_CODE_COPIED: "e2ee_call_verification_code_copied",
  E2EE_CALL_VERIFICATION_SHARE_CLICKED: "e2ee_call_verification_share_clicked",
  E2EE_STREAM_VERIFICATION_SHARE_CLICKED: "e2ee_stream_verification_share_clicked",
  E2EE_STREAM_VERIFICATION_CODE_COPIED: "e2ee_stream_verification_code_copied",
  E2EE_SETTINGS_USER_DELETE: "e2ee_settings_user_delete",
  E2EE_SETTINGS_DEVICE_DELETE: "e2ee_settings_device_delete",
  RTC_GAME_SHOP_BUTTON_VIEWED: "rtc_game_shop_button_viewed",
  RTC_GAME_SHOP_BUTTON_CLICKED: "rtc_game_shop_button_clicked",
  GAME_DETECTION_DEBUGGING_KEYWORD_MATCH: "game_detection_debugging_keyword_match",
  GDM_BLOCKED_USER_WARNING_ENGAGEMENT: "gdm_blocked_user_warning_engagement",
  GDM_BLOCKED_USER_WARNING_VIEWED: "gdm_blocked_user_warning_viewed",
  VOICE_CHANNEL_BLOCKED_USER_WARNING_ENGAGEMENT: "voice_channel_blocked_user_warning_engagement",
  CREATE_DM_USER_LIST_CLICKED: "create_dm_user_list_clicked",
  SEARCH_USER_LIST_STARTED: "search_user_list_started",
  CREATE_DM_USER_ROW_INTERACTED: "create_dm_user_row_interacted",
  USER_ACCOUNT_EMAIL_CHANGE_ATTEMPTED: "user_account_email_change_attempted",
  USER_ACCOUNT_EMAIL_CHANGE_REASON_CONTINUE: "user_account_email_change_reason_continue",
  USER_ACCOUNT_EMAIL_CHANGE_REASON_SELECTED: "user_account_email_change_reason_selected",
  USER_ACCOUNT_EMAIL_CHANGE_SAVE_NEW_EMAIL: "user_account_email_change_save_new_email",
  USER_ACCOUNT_EMAIL_CHANGE_WARNING_CONTINUE: "user_account_email_change_warning_continue",
  HD_STREAMING_POPOUT_DISMISSED: "hd_streaming_popout_dismissed",
  EMOJI_PICKER_BUTTON_HOVERED: "emoji_picker_button_hovered",
  NITRO_BASIC_UPSELL_PERK_HOVERED: "nitro_basic_upsell_perk_hovered",
  POST_ACTION_UPSELL_SHOWN: "post_action_upsell_shown",
  POST_ACTION_UPSELL_DISMISSED: "post_action_upsell_dismissed",
  POST_ACTION_UPSELL_PRIMARY_ACTION_CLICKED: "post_action_upsell_primary_action_clicked",
  POST_ACTION_UPSELL_SECONDARY_ACTION_CLICKED: "post_action_upsell_secondary_action_clicked",
  FRIEND_ANNIVERSARIES_CHANNEL_VIEWED: "friend_anniversaries_channel_viewed",
  MEDIA_INPUT_VOLUME_CHANGED: "media_input_volume_changed",
  MEDIA_OUTPUT_VOLUME_CHANGED: "media_output_volume_changed",
  VOICE_ACTIVATION_MODE_CHANGED: "voice_activation_mode_changed",
  VOICE_ACTIVITY_THRESHOLD_CHANGED: "voice_activity_threshold_changed",
  GUILD_GAME_DISCOVERY_ENTRYPOINT_VIEWED: "guild_game_discovery_entrypoint_viewed",
  GUILD_GAME_DISCOVERY_ENTRYPOINT_DEEP_LINK_TO_DESKTOP: "guild_game_discovery_entrypoint_deep_link_to_desktop",
  GLOBAL_DISCOVERY_WITH_GAME_VIEWED: "global_discovery_with_game_viewed",
  APP_DMS_QUICK_LAUNCHER_IMPRESSION: "app_dms_quick_launcher_impression",
  APP_DMS_QUICK_LAUNCHER_CLICKED: "app_dms_quick_launcher_clicked",
  APP_DMS_QUICK_LAUNCHER_HIDDEN: "app_dms_quick_launcher_hidden",
  MY_ACCOUNT_PAGE_TAB_NAVIGATE: "my_account_page_tab_navigate",
  USER_VOICE_ACTIVITY_VIEWED: "user_voice_activity_viewed",
  PARTY_VOICE_ACTIVITY_VIEWED: "party_voice_activity_viewed",
  SOUNDMOJI_PLAY: "soundmoji_play",
  SOUNDMOJI_SELECT: "soundmoji_select",
  SOUNDMOJI_IN_AUTOCOMPLETE_TOGGLED: "soundmoji_in_autocomplete_toggled",
  SOUNDMOJI_EMOJI_PICKER_VIEW_ALL_CLICK: "soundmoji_emoji_picker_view_all_click",
  SOUNDMOJI_EMOJI_PICKER_SECTION_TOGGLED: "soundmoji_emoji_picker_section_toggled",
  BLOCK_USER_CONFIRMED: "block_user_confirmed",
  IGNORE_USER_CONFIRMED: "ignore_user_confirmed",
  USER_REMEDIATION_ACTION: "user_remediation_action",
  INVITE_ACCEPT_JOIN_SETTINGS_SET: "invite_accept_join_settings_set",
  INVITE_ACCEPT_JOIN_SETTINGS_EXPANDED: "invite_accept_join_settings_expanded",
  INVITE_ACCEPT_DISMISSED: "invite_accept_dismissed",
  INVITE_ACCEPT_DETAILS_VIEWED: "invite_accept_details_viewed",
  INVITE_ACCEPT_SOCIAL_LINK_CLICKED: "invite_accept_social_link_clicked",
  ACTIVITY_PANEL_GAME_CARD_ACTIVITY_POPOUT_REFOCUS_CLICKED: "activity_panel_game_card_activity_popout_refocus_clicked",
  ACTIVITY_POPOUT_POP_OUT_BUTTON_CLICKED: "activity_popout_pop_out_button_clicked",
  ACTIVITY_POPOUT_POP_IN_BUTTON_CLICKED: "activity_popout_pop_in_button_clicked",
  APP_EMBED_VIEWED: "app_embed_viewed",
  APP_EMBED_CLICKED: "app_embed_clicked",
  APP_EMBED_LINK_COPIED: "app_embed_link_copied",
  APP_EMBED_LINK_SENT: "app_embed_link_sent",
  CHAT_WALLPAPER_DM_CONTEXT_MENU_ENTRY_POINT_CLICKED: "chat_wallpaper_dm_context_menu_entry_point_clicked",
  CHAT_WALLPAPER_TOOLBAR_ENTRY_POINT_CLICKED: "chat_wallpaper_toolbar_entry_point_clicked",
  CHAT_WALLPAPER_PICKER_BLUR_TOGGLED: "chat_wallpaper_picker_blur_toggled",
  CHAT_WALLPAPER_PICKER_CANCEL_CLICKED: "chat_wallpaper_picker_cancel_clicked",
  CHAT_WALLPAPER_PICKER_APPLY_CLICKED: "chat_wallpaper_picker_apply_clicked",
  CHAT_WALLPAPER_USER_SIDE_CLEAR_TOGGLED: "chat_wallpaper_user_side_clear_toggled",
  CHAT_WALLPAPER_NITRO_LINK_CLICKED: "chat_wallpaper_nitro_link_clicked",
  CHAT_WALLPAPER_WALLPAPER_OPTION_SELECTED: "chat_wallpaper_wallpaper_option_selected",
  CHAT_WALLPAPER_DOWNLOADED: "chat_wallpaper_downloaded",
  CHAT_WALLPAPER_PICKER_COACHMARK_NOT_SHOW_REASON: "chat_wallpaper_picker_coachmark_not_show_reason",
  DISPLAY_NAME_STYLES_FROM_SETTINGS: "display_name_styles_from_settings",
  DISPLAY_NAME_STYLES_APPLIED: "display_name_styles_applied",
  DISPLAY_NAME_STYLES_CLOSED: "display_name_styles_closed",
  DISPLAY_NAME_STYLES_REMOVED: "display_name_styles_removed",
  DISPLAY_NAME_STYLES_COLOR_SELECTED: "display_name_styles_color_selected",
  DISPLAY_NAME_STYLES_SURPRISE_ME: "display_name_styles_surprise_me",
  DISPLAY_NAME_STYLES_THEME_TOGGLE: "display_name_styles_theme_toggle",
  DISPLAY_NAME_STYLES_ACCESSIBILITY_TOGGLE: "display_name_styles_accessibility_toggle",
  DISPLAY_NAME_STYLES_NITRO_CLICKED: "display_name_styles_nitro_clicked",
  ...
  RING_CALL_ACCEPTED: "ring_call_accepted",
  CHANNEL_ICON_EDIT_PROGRESSED: "channel_icon_edit_progressed",
  GDM_EDIT_INTERACTED: "gdm_edit_interacted",
  PRIVATE_CHANNEL_INVITE_MODAL_OPENED: "private_channel_invite_modal_opened",
  CAN_OPEN_URL_REQUESTED: "can_open_url_requested",
  MODERATOR_REPORT_ORIGINAL_MESSAGE_LINK_CLICKED: "moderator_report_original_message_link_clicked",
  MODERATOR_QUEUE_ACTION: "moderator_queue_action",
  NOTIFICATIONS_INBOX_OPENED: "notifications_inbox_opened",
  NOTIFICATIONS_INBOX_READY: "notifications_inbox_ready",
  NOTIFICATIONS_INBOX_ITEM_INTERACTED: "notifications_inbox_item_interacted",
  NOTIFICATIONS_INBOX_SECTION_INTERACTED: "notifications_inbox_section_interacted",
  NOTIFICATIONS_INBOX_UNMOUNTED: "notifications_inbox_unmounted",
  NOTIFICATIONS_INBOX_LOADED: "notifications_inbox_loaded",
  NOTIFICATIONS_INBOX_DATA_LOADED: "notifications_inbox_data_loaded",
  CONTEXTUAL_REMINDER_ACTION: "contextual_reminder_action",
  MASKED_LINK_MODAL_CLICKED: "masked_link_modal_clicked",
  GAME_STORE_BUTTON_CLICKED: "game_store_button_clicked",
  ACTIVITY_SHARING_SETTINGS_INTERACTED: "activity_sharing_settings_interacted",
  RUNNING_GAME_CARD_STATE_CHANGED: "running_game_card_state_changed",
  BILLING_IP_LOCATION_FETCH_ERROR: "network_action_billing_ip_location_fetch_error",
  NITRO_PRIVATE_BROWSING_SURVEY_RESPONDED: "nitro_privatebrowsing_surveyresponded",
  NITRO_PRIVACY_UPSELL_PERKS_CLICKED: "nitro_privacy_upsell_perks_clicked",
  NITRO_PRIVACY_UPSELL_SETTINGS_CLICKED: "nitro_privacy_upsell_settings_clicked",
  PREMIUM_FEATURE_ERROR: "premium_feature_error",
  EMOJI_STUDIO_ENDED: "emoji_studio_ended",
  ...
  GUILD_CHANNEL_RESYNC_REQUESTED: "guild_channel_resync_requested",
  GUILD_CHANNEL_RESYNC_EXECUTED: "guild_channel_resync_executed",
  GUILD_CHANNEL_RESYNC_COMPLETED: "guild_channel_resync_completed",
  GUILD_CHANNEL_RESYNC_FAILED: "guild_channel_resync_failed",
  GUILD_CHANNEL_RESYNC_CANCELED: "guild_channel_resync_canceled",
  GUILD_CHANNEL_INTEGRITY_CHECK_REQUESTED: "guild_channel_integrity_check_requested",
  ...
  GUILD_CHANNEL_INTEGRITY_CHECK_CANCELED: "guild_channel_integrity_check_canceled",
  SYSTEM_SERVICE_INITIALIZE_ATTEMPTED: "system_service_initialize_attempted",
  SYSTEM_SERVICE_INSTALL_ATTEMPTED: "system_service_install_attempted",
  SYSTEM_SERVICE_UNINSTALL_ATTEMPTED: "system_service_uninstall_attempted",
  ACTIVITY_PANEL_BUTTON_CLICKED: "activity_panel_button_clicked",
  ACTIVITY_PANEL_SDK_LINK_VIEWED: "activity_panel_sdk_link_viewed",
  PROMOTION_REWARD_REDEMPTION_ATTEMPTED: "promotion_reward_redemption_attempted",
  CHECKPOINT_STARTED: "checkpoint_started",
  CHECKPOINT_CLOSED: "checkpoint_closed",
  CHECKPOINT_STEP_VIEWED: "checkpoint_step_viewed",
  CHECKPOINT_SCREENSHOT_TAKEN: "checkpoint_screenshot_taken",
  CHECKPOINT_CARD_CLICKED: "checkpoint_card_clicked",
  CHECKPOINT_SIDEKICK_MESSAGE_SENT: "checkpoint_sidekick_message_sent",
  GAME_SERVER_HOSTING_THIRD_PARTY_CONSENT_ACCEPTED: "game_server_hosting_third_party_consent_accepted",
  GAME_SERVER_GAME_SELECT_OPENED: "game_server_game_select_opened",
  GAME_SERVER_GAME_CLICKED: "game_server_game_clicked",
  GAME_SERVER_SETTINGS_OPENED: "game_server_settings_opened",
  GAME_SERVER_SKU_SELECTED: "game_server_sku_selected",
  GAME_SERVER_JOIN_CLICKED: "game_server_join_clicked",
  GAME_SERVER_COPY_IP_CLICKED: "game_server_copy_ip_clicked",
  GAME_SERVER_VIEW_GAME_PANEL_CLICKED: "game_server_view_game_panel_clicked",
  GAME_SERVER_SHARE_FORWARDED: "game_server_share_forwarded",
  IMPRESSION_GAME_SERVERS_TAB_VIEWED: "impression_game_servers_tab_viewed",
  IMPRESSION_GAME_SERVER_ACTIVITY_BUTTON: "impression_game_server_activity_button",
  GAME_SERVER_ACTIVITY_BUTTON_CLICKED: "game_server_activity_button_clicked",
  GAME_SERVER_ACTIVITY_BUTTON_GUILD_SELECTED: "game_server_activity_button_guild_selected",
  MEDIA_PICKER_ASSETS_DEBUG: "media_picker_assets_debug",
  ORB_BALANCE_ACTION_SHEET_ACTION: "orb_balance_action_sheet_action",
  SESSION_START_PAGE_VIEWED: "session_start_page_viewed",
  IMPRESSION_GIFT_OPTION_WISHLIST_BANNER_VIEWED: "impression_gift_option_wishlist_banner_viewed",
  IMPRESSION_WISHLIST_ITEM: "impression_wishlist_item",
  GAME_COMMUNITY_UPSELL_VIEWED: "game_community_upsell_viewed",
  GAME_COMMUNITY_UPSELL_DISMISSED: "game_community_upsell_dismissed",
  GAME_COMMUNITY_UPSELL_ACCEPTED: "game_community_upsell_accepted",
  GAME_COMMUNITY_MULTI_GUILD_UPSELL_CARD_JOINED: "game_community_multi_guild_upsell_card_joined",
  GAME_COMMUNITY_MULTI_GUILD_UPSELL_CARD_DISMISSED: "game_community_multi_guild_upsell_card_dismissed",
  ON_PLATFORM_ACCOUNT_LINK_FLOW_STARTED: "on_platform_account_link_flow_started",
  CONNECTION_INDICATOR_SHOWN: "connection_indicator_shown",
  CACHE_STATS_RECORDED: "cache_stats_recorded",
  CHANNEL_LATEST_MESSAGES_LOADED_CLICKSTREAM: "channel_latest_messages_loaded_clickstream",
  CHANNEL_WITH_UNREAD_MENTIONS_LOADED: "channel_with_unread_mentions_loaded",
  REPLY_NUDGES_CREATED: "reply_nudges_created",
  REPLY_NUDGE_OPENED: "reply_nudge_opened",
  REPLY_NUDGE_DISMISSED: "reply_nudge_dismissed",
  REPLY_NUDGES_SHOWN: "reply_nudges_shown",
  GUILD_ROOM_OBJECT_INTERACTED: "guild_room_object_interacted",
  GUILD_ROOM_INTERACTED: "guild_room_interacted",
  GUILD_ROOM_LAYOUT_TOGGLED: "guild_room_layout_toggled",
  GUILD_ROOM_OPENED: "guild_room_opened",
  GUILD_ROOM_SEAT_SELECTED: "guild_room_seat_selected",
  GUILD_ROOM_USER_INTERACTED: "guild_room_user_interacted",
  GUILD_ROOM_USER_CONNECTED: "guild_room_user_connected",
  ...
  PARENTAL_CONSENT_WARNING_SURFACE_SHOWN: "parental_consent_warning_surface_shown",
  PARENTAL_CONSENT_WARNING_SURFACE_DISMISSED: "parental_consent_warning_surface_dismissed",
  SEO_PAGE_CWV_MEASURED: "seo_page_cwv_measured",
  UI_SETTING_INTERACTED: "ui_setting_interacted",
  FAVORITES_GUILD_VIEWED: "favorites_guild_viewed",
  FAVORITES_GUILD_ADD_TO_FAVORITES: "favorites_guild_add_to_favorites",
  FAVORITES_GUILD_REMOVE_FROM_FAVORITES: "favorites_guild_remove_from_favorites",
  FAVORITES_GUILD_ORDER_UPDATED: "favorites_guild_order_updated",
  FAVORITES_GUILD_SETTING_TOGGLED: "favorites_guild_setting_toggled",
  FAVORITES_GUILD_UPSELL_MODAL_OPENED: "favorites_guild_upsell_modal_opened",
  FAVORITES_GUILD_ADD_MODAL_OPENED: "favorites_guild_add_modal_opened",
...
export const AuditLogTargetTypes = {
  ...
  GUILD_SCHEDULED_EVENT_EXCEPTION: "GUILD_SCHEDULED_EVENT_EXCEPTION",
  THREAD: "THREAD",
  STICKER: "STICKER",
  ...
  GUILD_SOUNDBOARD: "GUILD_SOUNDBOARD",
  HOME_SETTINGS: "HOME_SETTINGS",
  VOICE_CHANNEL_STATUS: "VOICE_CHANNEL_STATUS",
  GUILD_MEMBER_VERIFICATION: "GUILD_MEMBER_VERIFICATION",
  GUILD_PROFILE: "GUILD_PROFILE",
};
export const AuditLogChangeKeys = {
  ...
  AUTO_MODERATION_ADD_KEYWORDS: "$add_keyword_filter",
  AUTO_MODERATION_REMOVE_KEYWORDS: "$remove_keyword_filter",
  AUTO_MODERATION_ADD_REGEX_PATTERNS: "$add_regex_patterns",
  AUTO_MODERATION_REMOVE_REGEX_PATTERNS: "$remove_regex_patterns",
  AUTO_MODERATION_ADD_ALLOW_LIST: "$add_allow_list",
  AUTO_MODERATION_REMOVE_ALLOW_LIST: "$remove_allow_list",
  TITLE: "title",
  DISABLED: "disabled",
  REQUIRED: "required",
  OPTIONS: "options",
  ...
  AVAILABLE_TAG_ADD: "available_tag_add",
  AVAILABLE_TAG_EDIT: "available_tag_edit",
  AVAILABLE_TAG_DELETE: "available_tag_delete",
  SOUND_ID: "sound_id",
  VOLUME: "volume",
  ...
  LINKED_LOBBY: "linked_lobby",
  VERIFICATION_ENABLED: "verification_enabled",
  MANUAL_APPROVAL_ENABLED: "manual_approval_enabled",
  BRAND_COLOR_PRIMARY: "brand_color_primary",
  CUSTOM_BANNER_HASH: "custom_banner_hash",
  GAME_APPLICATION_IDS: "game_application_ids",
...
export const UserRequiredActions = {
  ...
  REQUIRE_VERIFIED_EMAIL_OR_VERIFIED_PHONE: "REQUIRE_VERIFIED_EMAIL_OR_VERIFIED_PHONE",
  ...
  REQUIRE_SAFETY_FLOWS: "REQUIRE_SAFETY_FLOWS",
};
...
export const HelpdeskArticles = {
  ...
  GDPR_PACKAGE_CONTENTS: "360004957991",
  ...
  REFUND_POLICY: "360012668071",
  PAYMENT_AUTHORIZATION_CHARGE: "4402712000663",
  PUBLIC_GUILD_GUILDLINES: "360035969312",
  FRIEND_COMMUNITY_DISCOVERABLE_GUILD_TYPES: "14078261239831",
  ...
  EPHEMERAL_MESSAGES: "26501839512855",
  ...
  PREMIUM_DETAILS: "115000435108",
  PREMIUM_DETAILS_CANCEL_SUB: "115000435108#h_01GFV3PNMEJEF92W0XX69MEE2W",
  ...
  GUILD_AUTOMOD_REGEX: "10069840290711",
  GUILD_RAID: "10989121220631",
  INVITE_DISABLED: "8458903738647",
  ...
  GUILD_PROFILES: "4409388345495",
  XBOX_CONNECTION: "360003953831",
  PS_CONNECTION: "4419534960919",
  QUEST_HOW_TO_XBOX: "360003953831#h_01J1TYJ22SN8Q4YND06JAGPA57",
  QUEST_HOW_TO_PLAYSTATION: "4419534960919#h_01J1TXNAT4RFSX9R7HQ30MHFCC",
  VERIFICATION_FAQ: "6181726888215",
  ACTIVITY_STATUS_SETTINGS: "7931156448919",
  MESSAGE_REQUESTS: "7924992471191",
  RNA_CHANGELOG: "8537198296727",
  CONNECTION_DETAILS: "8063233404823",
  CONNECTION_DETAILS_ADMIN: "10388356626711",
  APPS_LEARN_MORE: "26592957841303-How-to-Discover-and-Add-Apps",
  BOT_DATA_ACCESS: "7933951485975",
  HIGHLIGHTS_NOTIFICATIONS: "5304469213079",
  CRUNCHYROLL_CONNECTION: "9929188048023",
  ACTIVE_NITRO_BOGO_PROMOTION: "10167328543127",
  APPLICATION_COMMAND_PERMISSION_V3_WHAT_CHANGED: "10952896421783",
  APPLICATION_COMMAND_PERMISSIONS_LOCKOUT: "10952702911639",
  SUPER_REACTIONS: "12102061808663",
  ...
  CONVERSATION_SUMMARIES: "12926016807575",
  SHARE_NITRO_FAQ: "13771635451415",
  POMELO_FAQ: "12620128861463",
  CONTACT_SYNC: "360061878534",
  PRIVATE_CHANNEL_INTEGRATIONS: "15104189280151",
  MEDIA_CHANNEL: "14346342766743",
  SUMMER_2023_BOGO: "15089153846551",
  MEMBER_SAFETY_DASHBOARD: "15946797617431",
  CLIPS: "16861982215703",
  REMIXING_TEXT_SUPPORT: "15145601963031-Remix-FAQ#h_01H2Y1F86HNTVKWNVJJSB4C6A5",
  SERVER_SUBSCRIPTION_AND_PRODUCTS: "10423011974551",
  SERVER_PRODUCTS: "10423011974551#docs-internal-guid-918e991a-7fff-03d5-8326-5d065e5edeb1",
  WIN32_DEPRECATE: "17997797368471",
  PROFILE_BADGES: "360035962891",
  EXPLICIT_MEDIA_REDACTION: "18210995019671",
  EXPLICIT_MEDIA_REDACTION_UK_ONLY: "32806366426135",
  SAFETY_ALERTS: "18210977897239",
  KEYWORD_FILTERS: "24269903094167",
  COPYRIGHT_AND_IP_POLICY: "4410339349655",
  NVIDIA_DRIVER_ISSUES: "18621944634391",
  ROLE_SUBSCRIPTION_CANCEL: "19580873036695#h_01HGXEYG130EZKGQQ03A3ZHFEY",
  SUBSCRIPTION_CANCEL: "19580873036695",
  WIN7_8_DEPRECATE: "20470973046295",
  QUESTS_LEARN_MORE: "22225719947543",
  DATA_USED_TO_IMPROVE_DISCORD: "21864805694999",
  DATA_USED_FOR_RECOMMENDED: "21865322754327",
  USING_APPS_FAQ: "21334461140375#h_01HRQSA6C8H2XBF34NSSQH7ZFH",
  LAUNCHING_APPS_WITH_SHAPES_BUTTON: "21334461140375",
  MEMBER_LIST_ACTIVITY_FEED: "22045487931799",
  POLLS_FAQ: "22163184112407",
  QUESTS_PRIVACY_CONTROLS: "22225542459415",
  USER_PROFILE_RECENT_GAMES: "22489665250327",
  REFERRAL_PROGRAM: "22567595858327",
  PREMIUM_APRIL_2024_MARKETING_MOMENT: "22484323261463",
  SUMMER_BOGO_2024: "24485661785495",
  NITRO_FAQ: "115000435108#h_01GFV3PWAGD4EGTD91ERBZ5R4S",
  END_TO_END_ENCRYPTION: "25968222946071",
  SCREEN_SHARING_MACOS: "26459694693783",
  SOCIAL_LAYER_CONNECTIONS: "27893392334359",
  SOCIAL_LAYER_SPEND_ORBS_LEARN_MORE: "40102783004311#h_01KQJNEWWGZ6CB48FP9VBE2MD1",
  FRACTIONAL_PREMIUM_ABOUT: "26362805097623",
  STEALTH_REMEDIATION_FEATURE_GUIDE: "28084948873623",
  ...
  TIGGER_PAWTECT_SYSTEM_DMS: "360036118732-Discord-Official-Messages",
  TIGGER_PAWTECT_LEARN_MORE: "30326565624343",
  PERMADECOS: "29790581779735",
  VIRTUAL_CURRENCY_LEARN_MORE: "30593690165783",
  VIRTUAL_CURRENCY_ORB_MULTIPLIER_LEARN_MORE: "30593690165783#h_01KKYTZQ8C3VZN6SPPHS7ZPGHQ",
  AV_ERROR_CODES: "30952914470807",
  SERVER_TAGS: "31444248479639",
  NSFW_SERVER_AGE_RESTRICTION: "1500005292701",
  SUMMER_BOGO_2025: "32702667550743",
  FLAG_TO_MOD: "360044103651",
  CUSTOM_THEMES: "207260127#h_01JWYFJDVN6E9G80JTN2N86876",
  DISPLAY_NAME_STYLES: "33833879643927",
  SYSTEM_SERVICE: "34853435033367",
  IN_GAME_FEATURES: "27893392334359",
  SLOWMODE: "360016150952",
  CUSTOM_PROFILES_WISHLIST: "4403147417623#h_01K6DY1CJBBQHBFPETCDTJHE9B",
  NVIDIA_GEFORCE_CLOUD_GAMING_QUEST: "35372187686295",
...
export const LibraryApplicationFlags = {
  HIDDEN: 1,
  [1]: "HIDDEN",
  PRIVATE: 2,
  [2]: "PRIVATE",
  ...
  PREMIUM: 16,
  [16]: "PREMIUM",
  OVERLAY_V3_DISABLED: 32,
  [32]: "OVERLAY_V3_DISABLED",
};
export const CloudSyncStateTypes = {
  DONE: "DONE",
  PLANNING: "PLANNING",
  PREPARING: "PREPARING",
  PUSHING: "PUSHING",
...
export const LocalDispatchApplicationStates = {
...
export const LibraryApplicationActions = {
  PLAY: "play",
  INSTALL: "install",
  UPDATE: "update",
  PAUSE: "pause",
...
export const EntitlementSourceTypes = {
  ...
  [8]: "FRACTIONAL_PREMIUM_GIVEBACK",
  SUBSCRIPTION: 9,
  [9]: "SUBSCRIPTION",
  SUBSCRIPTION_MEMBER: 11,
  [11]: "SUBSCRIPTION_MEMBER",
};
...
export const SKUTypes = {
  ...
  [6]: "SUBSCRIPTION_GROUP",
};
export const SKUAccessTypes = {
  FULL: 1,
  [1]: "FULL",
  EARLY_ACCESS: 2,
  [2]: "EARLY_ACCESS",
...
export const MessageRestrictionTypes = {
...
export const StoreRecommendationTypes = {
  NOW_PLAYING: "1",
  RECENTLY_PLAYED: "2",
  EVER_PLAYED: "3",
  FLAVOR_TEXT: "4",
...
export const InAppNotificationTypes = {
  ...
  RESTRICTED_HOURS_WARNING: "RESTRICTED_HOURS_WARNING",
  RESTRICTED_SCHEDULE_UPDATED: "RESTRICTED_SCHEDULE_UPDATED",
  MESSAGE_REQUEST: "MESSAGE_REQUEST",
};
export const GIFPickerResultTypes = {
...
export const PopoutWindowKeys = {
  CHANNEL_CALL_POPOUT: "DISCORD_CHANNEL_CALL_POPOUT",
  CALL_TILE_POPOUT: "DISCORD_CALL_TILE_POPOUT",
  SOUNDBOARD: "DISCORD_SOUNDBOARD",
  RTC_DEBUG_POPOUT: "DISCORD_RTC_DEBUG_POPOUT",
  CHANNEL_POPOUT: "DISCORD_CHANNEL_POPOUT",
  ACTIVITY_POPOUT: "DISCORD_ACTIVITY_POPOUT",
  DEVTOOLS_POPOUT: "DISCORD_DEVTOOLS_POPOUT",
  STATS_POPOUT: "DISCORD_STATS_POPOUT",
};
export const PopoutEventTypes = { LOADED: "loaded", UNLOADED: "unloaded" };
export const ApplicationStreamStates = {
  CONNECTING: "CONNECTING",
  ACTIVE: "ACTIVE",
...
export const ApplicationStreamDeleteReasons = {
...
export const NetworkConnectionSpeeds = {
  UNKNOWN: "unknown",
  SLOW_TWO_G: "slow-2g",
  TWO_G: "2g",
  THREE_G: "3g",
...
export const SettingsPaneTypes = {
  APP_DMS_MENU: "App DMs Menu",
  CHANNEL_SETTINGS: "Channel Settings",
...
export const IntegrationSettingsSections = {
  APPLICATION: 0,
  [0]: "APPLICATION",
  OVERVIEW: 1,
  [1]: "OVERVIEW",
...
export const SERVER_MONETIZATION_OWNERSHIP_TRANSFER_URL =
  "https://creator-support.discord.com/hc/en-us/articles/12653663868823";
export const VoiceFlags = {
  CLIPS_ENABLED: 1,
  [1]: "CLIPS_ENABLED",
  ALLOW_VOICE_RECORDING: 2,
  [2]: "ALLOW_VOICE_RECORDING",
  ALLOW_ANY_VIEWER_CLIPS: 4,
