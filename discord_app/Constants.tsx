...
let ActivityActionTypes = { JOIN: 1, [1]: "JOIN", LISTEN: 3, [3]: "LISTEN", WATCH: 4, [4]: "WATCH", JOIN_REQUEST: 5, [5]: "JOIN_REQUEST", STREAM_REQUEST: 6, [6]: "STREAM_REQUEST" };
ActivityActionTypes = {
  USER(arg0) {
    return "/users/" + arg0;
  },
...
const obj11 = { UNPAID: 0, [0]: "UNPAID", ACTIVE: 1, [1]: "ACTIVE", PAST_DUE: 2, [2]: "PAST_DUE", CANCELED: 3, [3]: "CANCELED", ENDED: 4, [4]: "ENDED", ACCOUNT_HOLD: 6, [6]: "ACCOUNT_HOLD", BILLING_RETRY: 7, [7]: "BILLING_RETRY", PAUSED: 8, [8]: "PAUSED", PAUSE_PENDING: 9, [9]: "PAUSE_PENDING" };
