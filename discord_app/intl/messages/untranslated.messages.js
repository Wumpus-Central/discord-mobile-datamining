...
const loader = module_1274.createLoader({
  () => {
    const jsonAsset = require("../../modules/asset_json/native/AssetJsonUtils.tsx") /* loadJsonAsset */.loadJsonAsset(require("../../../_runtime/13355_registerAsset.js") /* registerAsset */);
