...
export const momentLocales = {
  ...
  () => asyncRequireImpl(4421, dependencyMap.paths),
  () => asyncRequireImpl(4422, dependencyMap.paths),
  () => asyncRequireImpl(4422, dependencyMap.paths),
  fi() {
  ...
  () => asyncRequireImpl(4442, dependencyMap.paths),
  () => asyncRequireImpl(4443, dependencyMap.paths),
  hi() {
