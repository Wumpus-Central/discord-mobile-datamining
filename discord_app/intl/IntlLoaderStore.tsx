...
import _modDef2114 from "../../_runtime/metro/02114__.js";
...
import index.native from "../../discord_common/js/shared/i18n/index.native.tsx";
              ...
              try {
                ...
                if (0 === c1) {
                  if (arg0 === 1) {
                    ...
                    c1 = 1;
                    dependencyMap = 1;
                    const obj6 = { value: closure_0(2124).preloadAllIntlMessageFiles(), done: false };
                    return obj6;
                  }
                } else if (1 === tmp4) {
                  if (arg0 === 1) {
      ...
      if (0 === c2) {
        if (arg0 === 1) {
          ...
          if (null != tmp20) {
            ...
            state.setLocaleData(_modDef2114);
            c3 = 3;
          }
        }
      } else if (arg0 === 1) {
