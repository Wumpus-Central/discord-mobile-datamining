// === Module 5860: ContextMenuActionCreators ===
...
function openContextMenu(stopPropagation, render, enableSpellCheck, renderLazy) {
  ...
  if (null == stopPropagation.currentTarget.contains) {
    ...
    let APP = contextMenu(5861).getCurrentlyInteractingAppContext();
    if (APP == null) {
      APP = AppContext.APP;
    }
