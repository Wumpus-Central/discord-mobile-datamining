// === Module 5858: ContextMenuActionCreators ===
...
function openContextMenu(stopPropagation, render, enableSpellCheck, renderLazy) {
  ...
  if (null == stopPropagation.currentTarget.contains) {
    ...
    let APP = contextMenu(5859).getCurrentlyInteractingAppContext();
    if (APP == null) {
      APP = AppContext.APP;
    }
