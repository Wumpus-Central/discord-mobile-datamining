...
function trackDeviceChanged(inputDevices, inputDeviceId, found, Video) {
  if (inputDeviceId !== found) {
    ...
    const obj = { device_from_name: CertifiedDeviceStore.getCertifiedDeviceName(inputDeviceId, str2), device_to_name: null, device_type: null, device_is_certified: null, location: null, location_stack: null, voice_channel_type: null, audio_subsystem: null, audio_layer: null };
...
let closure_15 = debounceDefault((target_user_id, context, volume) => {
  const obj = { target_user_id, context, volume, media_session_id: RTCConnectionStore.getMediaSessionId(), rtc_connection_id: RTCConnectionStore.getRTCConnectionId() };
...
settings = {
  ...
  setDisableLocalVideo(id, MANUAL_ENABLED) {
    ...
    if (typeof isNotSupported === "function") {
      const obj = { type: "AUDIO_SET_LOCAL_VIDEO_DISABLED", context: DEFAULT, userId: id, videoToggleState: MANUAL_ENABLED, persist: flag, isAutomatic: flag2 };
      obj.dispatch(obj);
    } else {
      throw new TypeError("Trying to call a non-function");
    }
  ...
  setAttenuation(attenuation, attenuateWhileSpeakingSelf, attenuateWhileSpeakingOthers) {
    if (typeof isNotSupported === "function") {
      ...
      const obj = { type: "AUDIO_SET_ATTENUATION", attenuation, attenuateWhileSpeakingSelf, attenuateWhileSpeakingOthers };
      obj.dispatch(obj);
    } else {
      throw new TypeError("Trying to call a non-function");
    }
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              dependencyMap = 1;
              const obj1 = { value: v1(9163)("debug_logging_enabled", closure_0, debugLogging.getDebugLogging()), done: false };
              return obj1;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
        ...
        try {
          ...
          if (0 === v1) {
            if (arg0 === 1) {
              ...
              v1 = 1;
              dependencyMap = 1;
              const obj1 = { value: v1(9163)("audio_subsystem", closure_0, audioSubsystem.getAudioSubsystem()), done: false };
              return obj1;
            }
          } else if (arg0 === 1) {
            dependencyMap = 3;
