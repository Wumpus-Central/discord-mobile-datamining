    ...
    function chain() {
      ...
      if (arr.length > 0) {
        ...
        if (null == arr) {
          ...
          const result = chain(4770).updatePermissionOverwrite(callback, arr);
        ...
        if (null == arr) {
          ...
          const result1 = chain(4770).clearPermissionOverwrite(callback, arr);
          result1.then(chain, chain);
          const obj = chain(4770);
        }
      }
    }
    !chain();
