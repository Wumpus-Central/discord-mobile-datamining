// === Module 9744: ChannelSettingsPermissionsActionCreators ===

// Module 9744 (ChannelSettingsPermissionsActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import ChannelActionCreatorsDefault from "ChannelActionCreators" /* 4573 */;
import DefaultChannelThresholdUtils from "DefaultChannelThresholdUtils" /* 9745 */;
          ...
          if (arg0 === 1) {
            ...
            if (null != guildId) {
              if (closure_1 === guildId) {
                c6 = 1;
                c7 = 1;
                let obj1 = { value: DefaultChannelThresholdUtils.checkChattableChannelThresholdMetAfterChannelPermissionDeny(tmp21, closure_3, closure_2), done: false };
                return obj1;
              }
            }
            tmp21 = guildId;
