// === Module 9903: ChannelSettingsPermissionsActionCreators ===

// Module 9903 (ChannelSettingsPermissionsActionCreators)
import DispatcherDefault from "Dispatcher" /* 573 */;
import ChannelActionCreatorsDefault from "ChannelActionCreators" /* 4840 */;
import DefaultChannelThresholdUtils from "DefaultChannelThresholdUtils" /* 9904 */;
          ...
          if (arg0 === 1) {
            ...
            if (null != guildId) {
              if (closure_1 === guildId) {
                c6 = 1;
                c7 = 1;
                const obj6 = { value: DefaultChannelThresholdUtils.checkChattableChannelThresholdMetAfterChannelPermissionDeny(tmp21, closure_3, closure_2), done: false };
                return obj6;
              }
            }
            tmp21 = guildId;
