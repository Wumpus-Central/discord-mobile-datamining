...
import UserSettingsModalActionCreatorsDefault from "UserSettingsModalActionCreators.tsx";
...
export const saveProfileAndAccountChanges = function saveProfileAndAccountChanges(accountUpdateForUpdateRequest) {
  ...
  obj4.headers = avatarId(5253).buildHeadersForMd5({
    [avatar(7092).SafetyScannedUploadSurface.USER_DEFAULT_PROFILE_AVATAR]: avatarOriginalMd5,
  });
