...
export default {
  ...
  show(hideActionSheet) {
    ...
    if (!tmp7) {
      if (flag) {
        let obj3 = merged(4541);
        obj3.hideActionSheet();
      }
      if (null != c6) {
        let obj4 = confirmText(4920);
      ...
      const tmp31 = c5;
      const tmp32 = c4;
      obj.variant = confirmText(5008).getAlertButtonVariant(confirmColor);
      ...
      const items = [c3(confirmText(4924).AlertActionButton, obj)];
      ...
      if (null != cancelText) {
        ...
        tmp30Result = tmp30(tmp29(4924).AlertActionButton, obj1);
      }
      ...
      obj7.openAlert(
        text,
        c3(confirmText(4924).AlertModal, obj),
        () => {
          if (!c5) {
            if (c4 != null) {
              tmp();
