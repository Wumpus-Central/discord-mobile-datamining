...
export default {
  ...
  show(hideActionSheet) {
    ...
    let merged = Object.assign(
      hideActionSheet,
      Object.assign({ hideActionSheet: 0, isDismissable: 0, confirmText: 0 }),
    );
    ...
    if (!tmp7) {
      if (flag) {
        let obj3 = merged(4603);
        obj3.hideActionSheet();
      }
      if (null != c6) {
        let obj4 = confirmText(4982);
      ...
      const tmp31 = c5;
      const tmp32 = c4;
      obj.variant = confirmText(5075).getAlertButtonVariant(confirmColor);
      ...
      const items = [c3(confirmText(4986).AlertActionButton, obj)];
      ...
      if (null != cancelText) {
        ...
        tmp30Result = tmp30(tmp29(4986).AlertActionButton, obj1);
      }
      ...
      obj7.openAlert(
        text,
        c3(confirmText(4986).AlertModal, obj),
        () => {
          if (!c5) {
            if (c4 != null) {
              tmp();
