// === Module 11695: actions/GiftCodeActionCreators ===
...
function openGiftCodeRedeemModal(code) {
  ModalActionCreatorsDefault.pushLazy(asyncRequireImpl(11701, dependencyMap.paths), { code }, "GIFT_CODE_REDEEM_MODAL_KEY");
}
