      ...
      if (paymentSource === 2) {
        ...
        try {
          ...
          if (0 === constants) {
            ...
            channelId = 0;
            let closure_10 = c3;
            billingError = new callback(4092).BillingError(closure_10);
            obj3 = options(709);
...
function openGiftCodeRedeemModal(code) {
  ...
  obj = { code };
  obj.pushLazy(require(1959) /* asyncRequireImpl */(8041, dependencyMap.paths), obj, "GIFT_CODE_REDEEM_MODAL_KEY");
}
