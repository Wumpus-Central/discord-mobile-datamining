// === Module 9562: GPlayActionCreators ===
      ...
      try {
        ...
        if (0 === c7) {
          if (arg0 === 1) {
            ...
            closure_131_1 = tmp77;
            id = id.getId();
            const SubscriptionProductIds = closure_2_0(7573).SubscriptionProductIds;
...
const GPlayAnalyticsStore = fn(9563);
  ...
  if (c8 === 2) {
    ...
    try {
      ...
      if (0 === v2) {
        ...
        obj7.tags = obj8;
        const result = closure_0(4498).captureBillingException(closure_131_4, obj7);
