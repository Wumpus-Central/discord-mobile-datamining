// === Module 9558: GPlayActionCreators ===
      ...
      try {
        ...
        if (0 === c7) {
          if (arg0 === 1) {
            ...
            closure_131_1 = tmp77;
            id = id.getId();
            const SubscriptionProductIds = closure_2_0(7571).SubscriptionProductIds;
...
const GPlayAnalyticsStore = fn(9559);
    ...
    try {
      ...
      if (0 === v2) {
        if (arg0 === 1) {
          ...
          v2 = 2;
          c8 = 1;
          const obj6 = { value: BillingManager.purchase(closure_0, _true), done: false };
          return obj6;
        }
      } else if (1 === tmp8) {
        c6 = 0;
        ...
        obj7.tags = obj8;
        const result = closure_0(4496).captureBillingException(closure_131_4, obj7);
        ...
        if (null != tmp) {
          if (null != tmp2.billingPeriod) {
            if (null != tmp.billingPeriod) {
              closure_0(getUserCountry[19]);
            }
          }
        }
      }
      const obj3 = { type: "GPLAY_UPDATE_PENDING_DOWNGRADE", pendingDowngrade: null };
      const obj4 = { purchaseToken, subscriptionId, newSubscriptionSkuId: tmp.identifier };
