...
import _modDef4676 from "../ModalActionCreators.tsx";
...
export default {
  open() {
    ...
    _modDef4676.pushLazy(asyncRequireImpl(7621, dependencyMap.paths), { isChangeEmail: flag }, EMAIL_VERIFICATION_MODAL_KEY);
  },
  close() {
