...
export const openApplyBoostModal = function openApplyBoostModal(guildId) {
  ...
  obj = { guildId };
  obj.pushLazy(asyncRequireImpl(5104, dependencyMap.paths), obj, PREMIUM_GUILD_SUBSCRIBE_MODAL_KEY);
};
export const openTransferModal = function openTransferModal(arg0) {
  ...
  ModalActionCreators.pushLazy(asyncRequireImpl(5104, dependencyMap.paths), { guildId, guildBoostSlots, intent, onResult }, PREMIUM_GUILD_SUBSCRIBE_MODAL_KEY);
};
