...
function trackInvite(channelId) {
  ...
  if (null != channel) {
    ...
    let inviteInstanceId = tmp3(4328).getInviteInstanceId(result.baseCode, messageId);
    ...
    if (tmp12) {
      ...
      let inviteInstanceId1 = tmp3(4328).getInviteInstanceId(result.baseCode, messageId);
