...
function trackInvite(channelId) {
  ...
  if (null != channel) {
        ...
        if (null != invite.channel) {
          ...
          if (null != lastActiveStream) {
            ...
            if (lastActiveStream.channelId === channel.id) {
              ...
              const streamerApplication = tmp3(7138).getStreamerApplication(lastActiveStream, sortActivity);
              let id3 = null;
    ...
    let inviteInstanceId = tmp3(4288).getInviteInstanceId(result.baseCode, messageId);
    ...
    if (tmp12) {
      ...
      let inviteInstanceId1 = tmp3(4288).getInviteInstanceId(result.baseCode, messageId);
        ...
        try {
          ...
          if (0 === closure_2) {
            if (arg0 === 1) {
              ...
              const orCreate = outer1_1(4987).getOrCreate(outer1_0);
              const obj13 = outer1_1(4987);
              ...
              if (null != databaseResult) {
                if (null != basicChannel) {
                  ...
                  if (!orCreate.hasMoreAfter) {
                    ...
                    obj1[0] = obj2.tryLoadAsync(() => outer2_1(6876).load(c1, basicChannel, c1));
                    return obj1;
                  }
                }
              }
      ...
      if (dependencyMap === 2) {
        ...
        try {
          ...
          if (0 === obj2) {
            ...
            obj3[0] = outer1_0(7233).MessageDataType.EDIT;
            obj3[1] = obj2;
            outer1_1(7233).enqueue(obj3, (hasErr) => {
              hasErr = hasErr.hasErr;
              let hasItem = !hasErr;
              if (!hasErr) {
                const AUTOMOD_ERROR_CODES = outer2_0(7263).AUTOMOD_ERROR_CODES;
                hasItem = AUTOMOD_ERROR_CODES.has(hasErr.body.code);
              }
              if (hasItem) {
                let obj = { type: null, message: null };
                obj[0] = outer2_0(7233).MessageDataType.EDIT;
                obj[1] = obj2;
              ...
              const AccessibilityAnnouncer = outer2_0(4147).AccessibilityAnnouncer;
