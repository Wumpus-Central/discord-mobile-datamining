...
import t2 from "../../_runtime/04673_t.js";
...
import closure_7 from "../modules/guild_member_verification/GuildJoinRequestStore.tsx";
import closure_8 from "../modules/guild_templates/GuildTemplateStore.tsx";
import closure_9 from "../modules/messages/MessageRoundtripTrackerStore.tsx";
import closure_10 from "../modules/poggermode/PoggermodeSettingsStore.tsx";
import closure_11 from "../modules/replies/PendingReplyStore.tsx";
import closure_12 from "../modules/replies/ReferencedMessageStore.tsx";
import { ReferencedMessageState } from "../modules/replies/ReferencedMessageStore.tsx";
import closure_14 from "../modules/stickers/StickersStore.tsx";
import closure_15 from "../stores/ApplicationStreamingStore.tsx";
import closure_16 from "../stores/AuthenticationStore.tsx";
import closure_17 from "../stores/ChannelStore.tsx";
import closure_18 from "../stores/EditMessageStore.tsx";
import closure_19 from "../stores/GuildStore.tsx";
import closure_20 from "../stores/InviteStore.tsx";
import closure_21 from "../stores/MessageStore.tsx";
import closure_22 from "../stores/PresenceStore.tsx";
import closure_23 from "../stores/ReadStateStore.tsx";
import { SlowmodeType } from "../stores/SlowmodeStore.tsx";
import closure_25 from "../stores/UserStore.tsx";
...
function trackInvite(channelId) {
  ...
  if (null != channel) {
        ...
        if (null != invite.channel) {
          ...
          if (null != lastActiveStream) {
            ...
            if (lastActiveStream.channelId === channel.id) {
              ...
              const streamerApplication = tmp3(7451).getStreamerApplication(lastActiveStream, closure_22);
              let id3 = null;
    ...
    let inviteInstanceId = tmp3(4433).getInviteInstanceId(result.baseCode, messageId);
    ...
    if (tmp12) {
      ...
      let inviteInstanceId1 = tmp3(4433).getInviteInstanceId(result.baseCode, messageId);
        ...
        try {
          ...
          if (0 === closure_2) {
            if (arg0 === 1) {
              ...
              const orCreate = closure_1_1(5184).getOrCreate(closure_1_0);
              const obj13 = closure_1_1(5184);
              ...
              if (null != databaseResult) {
                if (null != basicChannel) {
                  ...
                  if (!orCreate.hasMoreAfter) {
                    ...
                    c3 = 1;
                    obj1 = { value: null, done: false };
                    obj1[0] = obj2.tryLoadAsync(() => closure_2_1(7190).load(c1, basicChannel, c1));
                    return obj1;
                  }
                }
              }
      ...
      if (dependencyMap === 2) {
        ...
        try {
          ...
          if (0 === obj2) {
            ...
            obj3[0] = closure_1_0(7546).MessageDataType.EDIT;
            obj3[1] = obj2;
            closure_1_1(7546).enqueue(obj3, (hasErr) => {
              hasErr = hasErr.hasErr;
              let hasItem = !hasErr;
              if (!hasErr) {
                const AUTOMOD_ERROR_CODES = closure_2_0(7816).AUTOMOD_ERROR_CODES;
                hasItem = AUTOMOD_ERROR_CODES.has(hasErr.body.code);
              }
              if (hasItem) {
                let obj = { type: null, message: null };
                obj[0] = closure_2_0(7546).MessageDataType.EDIT;
                obj[1] = obj2;
        ...
        try {
          ...
          if (0 === c2) {
            ...
            if (null != flags) {
              ...
              obj3[0] = closure_1_0(1399).setFlag(flags.flags, closure_1_33.SUPPRESS_EMBEDS, true);
              obj2[1] = obj3;
              const obj8 = closure_1_0(1399);
        ...
        try {
          ...
          if (0 === c2) {
            ...
            if (null != flags) {
              ...
              obj2[0] = closure_1_28.MESSAGE(flags, closure_1);
              const obj3 = { flags: null };
              obj3[0] = closure_1_0(1399).setFlag(flags.flags, closure_1_33.IS_GUILD_OFFICIAL, c2);
              obj2[1] = obj3;
              const obj8 = closure_1_0(1399);
              obj2[3] = closure_1_0(530).rejectWithMigratedError();
              HTTP.patch(obj2);
