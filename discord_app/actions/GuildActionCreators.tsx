        ...
        try {
          ...
          if (0 === c5) {
            if (arg0 === 1) {
              ...
              c6 = 1;
              const obj5 = {
                value: self.banMultipleUsers(closure_0, closure_1, closure_2, tmp45, usePubSub),
                done: false,
              };
              return obj5;
            }
            ...
            if (1 === tmp7) {
              ...
              if (!closure_129_0) {
                ...
                if (closure_129_0) {
                  ...
                  const obj11 = {
                    bannedUsers: closure_129_4,
                    failedUsers: closure_129_6,
                    targetUserIds: closure_130_1,
                  };
                  obj10.bulkBan = obj11;
          ...
          if (0 === c7) {
            if (arg0 === 1) {
              ...
              const request = {
                ...
                oldFormErrors: true,
                body: obj5,
                rejectWithError: color(1270).rejectWithMigratedError(),
              };
              c7 = 2;
              c8 = 1;
