        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj1 = { value: closure_0(6668).fetchWebAuthnPasswordlessChallenge(), done: false };
              return obj1;
            }
          } else if (1 === tmp8) {
            dependencyMap = 0;
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj3 = { value: tmp3(4799).post(request), done: false };
              return obj3;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
