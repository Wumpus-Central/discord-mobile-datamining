...
PasswordResetResult = {
    ...
    return obj1.post(request).then(
      ...
      (body) => {
        ...
        if (code === constants.ACCOUNT_SCHEDULED_FOR_DELETION) {
          if (null != password) {
            if ("" !== password) {
              const obj1 = { type: "LOGIN_ACCOUNT_SCHEDULED_FOR_DELETION", credentials: null };
              let obj2 = { login, password };
              obj1.credentials = obj2;
        ...
        if (code === constants.ACCOUNT_DISABLED) {
          if (null != password) {
            if ("" !== password) {
              ...
              const obj3 = { type: "LOGIN_ACCOUNT_DISABLED", credentials: null };
              const obj4 = { login, password };
              obj3.credentials = obj4;
              obj5.dispatch(obj3);
            }
          }
        }
        if (code === constants.PHONE_VERIFICATION_REQUIRED) {
          ...
          obj5 = { type: "LOGIN_PHONE_IP_AUTHORIZATION_REQUIRED", credentials: null };
          const obj6 = { login, password };
          obj5.credentials = obj6;
          obj2.dispatch(obj5);
        } else {
          obj = DispatcherDefault;
  ...
  loginMFAv2(arg0) {
    ...
    let trackedActionData = {
      ...
      ticket,
      login_source: source,
      gift_code_sku_id: giftCodeSKUId,
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj1 = { value: closure_0(6647).fetchWebAuthnPasswordlessChallenge(), done: false };
              return obj1;
            }
          } else if (1 === tmp8) {
            dependencyMap = 0;
            ...
            if (arg0 === 1) {
              ...
              const obj6 = {
                ticket,
                credential: closure_128_3,
                source: closure_129_2,
                giftCodeSKUId: closure_129_3,
                isMultiAccount: closure_129_4,
              };
              c4 = 5;
              c5 = 1;
        ...
        try {
          ...
          if (0 === c4) {
            if (arg0 === 1) {
              ...
              c4 = 2;
              c5 = 1;
              const obj3 = { value: tmp3(4798).post(request), done: false };
              return obj3;
            }
          } else if (1 === tmp7) {
            dependencyMap = 0;
  ...
  verify(arg0) {
    ...
    return (async () => {
      ...
      const request = {
        ...
        body: { token },
        trackedActionData: { event: token(1250).NetworkActionNames.USER_VERIFY },
  ...
  resetPasswordMFAv2(arg0) {
    ...
    return (async () => {
      ...
      const request = {
        ...
        oldFormErrors: true,
        trackedActionData: { event: v3(1250).NetworkActionNames.USER_RESET_PASSWORD, properties: { mfa: true } },
        rejectWithError: true,
      };
        ...
        (body) => {
          ...
          if (null != prop) {
            ...
            ({
              ...
              pre_checked: obj4.checked,
              pre_checked: obj4.preChecked,
            } = body.body.promotional_email_opt_in);
