  ...
  verify(arg0) {
    ...
    return (async () => {
      ...
      const request = {
        ...
        body: { token },
        trackedActionData: { event: token(1248).NetworkActionNames.USER_VERIFY },
  ...
  resetPasswordMFAv2(arg0) {
    ...
    return (async () => {
      ...
      const request = {
        ...
        oldFormErrors: true,
        trackedActionData: { event: v3(1248).NetworkActionNames.USER_RESET_PASSWORD, properties: { mfa: true } },
        rejectWithError: true,
      };
