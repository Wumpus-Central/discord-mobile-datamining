...
import makeDateFormatterDefault from "makeDateFormatter" /* 4326 */;
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, _modDef4231(timestamp), _modDef4231(date));
    const tmp6 = _modDef4231(timestamp);
  }
