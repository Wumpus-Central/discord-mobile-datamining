...
import makeDateFormatterDefault from "makeDateFormatter" /* 4409 */;
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, _modDef4314(timestamp), _modDef4314(date));
    const tmp6 = _modDef4314(timestamp);
  }
