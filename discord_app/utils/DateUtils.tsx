...
import makeDateFormatterDefault from "makeDateFormatter" /* 4291 */;
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, _modDef4196(timestamp), _modDef4196(date));
    const tmp6 = _modDef4196(timestamp);
  }
