...
import makeDateFormatterDefault from "makeDateFormatter" /* 4324 */;
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, _modDef4229(timestamp), _modDef4229(date));
    const tmp6 = _modDef4229(timestamp);
  }
