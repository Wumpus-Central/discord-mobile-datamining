...
import makeDateFormatterDefault from "makeDateFormatter" /* 4260 */;
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, _modDef4166(timestamp), _modDef4166(date));
    const tmp6 = _modDef4166(timestamp);
  }
