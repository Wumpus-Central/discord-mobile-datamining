...
import makeDateFormatterDefault from "makeDateFormatter" /* 4512 */;
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, _modDef4416(timestamp), _modDef4416(date));
    const tmp6 = _modDef4416(timestamp);
  }
