...
import makeDateFormatterDefault from "makeDateFormatter" /* 4510 */;
...
export const accessibilityLabelCalendarFormat = function accessibilityLabelCalendarFormat(timestamp) {
  ...
  let str5 = "LLL";
  if ("sameElse" !== str) {
    str5 = localeDataResult.calendar(str, _modDef4414(timestamp), _modDef4414(date));
    const tmp6 = _modDef4414(timestamp);
  }
