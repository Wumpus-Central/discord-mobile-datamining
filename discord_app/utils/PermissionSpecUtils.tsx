// === Module 16410: getPermissionOptions ===
...
import isGuildEligibleForStageChannels from "isGuildEligibleForStageChannels" /* 16411 */;
import experiment from "experiment" /* 16412 */;
import getGuildPermissionSpecAll from "getGuildPermissionSpec" /* 16414 */;
  ...
  generateChannelPermissionSpec(guild_id, closure_5, arg2) {
    ...
    if (constants2.GUILD_CATEGORY === type) {
      ...
      if (tmp16.GUILD_VOICE === type) {
        ...
        items4[6] = tmp27(16414).generateChannelAppsSection(tmp3, intl15.string(tmp4(1236).t["rrh/W6"]), { showActivities: false });
        items5 = items4;
