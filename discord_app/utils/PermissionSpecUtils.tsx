...
export default {
  generateChannelPermissionSpec(guild_id, closure_5, arg2) {
    ...
    if (constants2.GUILD_CATEGORY === type) {
      ...
      const items = [
        getGuildPermissionSpecAll.generateChannelGeneralSection(tmp3, intl23.string(tmp4(1114).t["AkPxc+"])),
        ,
        ,
        ,
        ,
      ...
      if (tmp16.GUILD_VOICE === type) {
        ...
        const items3 = [
          getGuildPermissionSpecAll.generateChannelGeneralSection(tmp3, intl16.string(tmp4(1114).t.ouHggI), {
        ...
        const items4 = [
          getGuildPermissionSpecAll.generateChannelGeneralSection(tmp3, intl8.string(tmp4(1114).t.ouHggI), {
        ...
        items4[6] = tmp27(16834).generateChannelAppsSection(tmp3, intl15.string(tmp4(1114).t["rrh/W6"]), {
          showActivities: false,
        });
        items5 = items4;
        const tmp27Result = tmp27(16834);
      } else {
        if (tmp16.GUILD_FORUM !== type) {
          if (tmp16.GUILD_MEDIA !== type) {
            const intl30 = tmp4(1114).intl;
            items5 = [
              getGuildPermissionSpecAll.generateChannelGeneralSection(tmp3, intl30.string(tmp4(1114).t.ouHggI)),
              ,
              ,
            ];
            ...
            if (enabled) {
              ...
              const items6 = [tmp38(16834).generateChannelVoiceSection(tmp3, intl.string(tmp4(1114).t["46Ra1b"]))];
              let items7 = items6;
              const tmp38Result = tmp38(16834);
            } else {
              items7 = [];
            }
