...
export default {
  generateChannelPermissionSpec(guild_id, closure_5, arg2) {
    ...
    const VoiceInThreadsExperiment = set(6124).VoiceInThreadsExperiment;
    ...
    let tmp4Result = tmp4(5369);
    tmp4Result = tmp4(16648);
    ...
    if (constants2.GUILD_CATEGORY === type) {
      ...
      const items = [
        getGuildPermissionSpecAll.generateChannelGeneralSection(tmp3, intl23.string(tmp4(1233).t["AkPxc+"])),
        ,
        ,
        ,
        ,
      ...
      if (tmp.showStageChannelPermissions) {
        ...
        const items1 = [obj33(16649).generateChannelStageSection(tmp3, intl28.string(tmp4(1233).t.yniauk))];
        let items2 = items1;
        const obj33Result = obj33(16649);
      } else {
        items2 = [];
      }
      ...
      if (tmp16.GUILD_VOICE === type) {
        ...
        const items3 = [
          getGuildPermissionSpecAll.generateChannelGeneralSection(tmp3, intl16.string(tmp4(1233).t.ouHggI), {
        ...
        items3[1] = getGuildPermissionSpecAll.generateChannelMembershipSection(
          tmp3,
          intl17.string(tmp4(1233).t.Ny49TN),
        );
        ...
        const items4 = [
          getGuildPermissionSpecAll.generateChannelGeneralSection(tmp3, intl8.string(tmp4(1233).t.ouHggI), {
        ...
        items4[2] = getGuildPermissionSpecAll.generateChannelStageVoiceSection(
          tmp3,
          intl10.string(tmp4(1233).t["46Ra1b"]),
        ...
        items4[6] = tmp27(16649).generateChannelAppsSection(tmp3, intl15.string(tmp4(1233).t["rrh/W6"]), {
          showActivities: false,
        });
        items5 = items4;
        const tmp27Result = tmp27(16649);
      } else {
        if (tmp16.GUILD_FORUM !== type) {
          if (tmp16.GUILD_MEDIA !== type) {
            const intl30 = tmp4(1233).intl;
            items5 = [
              getGuildPermissionSpecAll.generateChannelGeneralSection(tmp3, intl30.string(tmp4(1233).t.ouHggI)),
              ,
              ,
            ];
            ...
            items5[1] = getGuildPermissionSpecAll.generateChannelMembershipSection(
              tmp3,
              intl31.string(tmp4(1233).t.Ny49TN),
            );
            ...
            items5[2] = getGuildPermissionSpecAll.generateChannelTextSection(
              tmp3,
              intl32.string(tmp4(1233).t.cKobO5),
              obj6,
            );
            const obj43 = getGuildPermissionSpecAll;
            const intl33 = tmp4(1233).intl;
            items5[3] = getGuildPermissionSpecAll.generateChannelAppsSection(
              tmp3,
              intl33.string(tmp4(1233).t["rrh/W6"]),
            );
            if (enabled) {
              const intl = tmp4(1233).intl;
              const items6 = [tmp38(16649).generateChannelVoiceSection(tmp3, intl.string(tmp4(1233).t["46Ra1b"]))];
              let items7 = items6;
              const tmp38Result = tmp38(16649);
            } else {
              items7 = [];
            }
  ...
  generateGuildPermissionSpec(features) {
    ...
    const guildPermissionSpec = getGuildPermissionSpecAll.generateGuildPermissionSpec(
