// === Module 16645: getPermissionOptions ===
...
import isGuildEligibleForStageChannels from "isGuildEligibleForStageChannels" /* 16646 */;
import experiment from "experiment" /* 16647 */;
import getGuildPermissionSpecAll from "getGuildPermissionSpec" /* 16649 */;
  ...
  generateChannelPermissionSpec(guild_id, closure_5, arg2) {
    ...
    if (constants2.GUILD_CATEGORY === type) {
      ...
      if (tmp16.GUILD_VOICE === type) {
        ...
        items4[6] = tmp27(16649).generateChannelAppsSection(tmp3, intl15.string(tmp4(1233).t["rrh/W6"]), { showActivities: false });
        items5 = items4;
