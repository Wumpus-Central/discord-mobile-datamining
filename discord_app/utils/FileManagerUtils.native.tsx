// discord_app/utils/FileManagerUtils.native.tsx
...
const require = fn;
let closure_5 = async function _readFile(arg0) {
  if (c8 === 2) {
    c8 = 3;
      ...
      if (0 === c7) {
        if (arg0 === 1) {
          ...
          if (null == tmp41) {
            ...
            c7 = 1;
            c8 = 1;
            const obj6 = { value: require("NativeFileModule").fileExists(tmp41 + "/" + closure_1), done: false };
            return obj6;
          }
        }
      } else if (1 === tmp8) {
        if (arg0 === 1) {
          ...
          c8 = 1;
          const obj9 = {
            value: closure_132_1(closure_132_2[2]).readFile(closure_131_2 + "/" + closure_131_0, closure_131_1),
            done: false,
          };
          return obj9;
        } else {
