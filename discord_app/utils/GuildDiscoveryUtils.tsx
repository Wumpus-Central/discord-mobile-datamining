      ...
      if (0 === c7) {
        ...
        if (1 === tmp5) {
            ...
            if (null != guild) {
              if (closure_134_4.isLurking(closure_133_0)) {
                if (closure_133_9) {
                  ...
                  c7 = 2;
                  c8 = 1;
                  const obj7 = { value: obj12.transitionToGuildSync(closure_133_0, obj6, channelId, closure_133_2.messageId), done: false };
                  return obj7;
                }
              }
            }
          ...
          if (arg0 === 1) {
            ...
            c7 = 4;
            c8 = 1;
            const obj13 = { value: obj1.transitionToGuildSync(closure_133_0, obj12, channelId, closure_133_2.messageId), done: false };
            return obj13;
          }
        } else if (arg0 === 1) {
          c8 = 3;
