  ...
  if (c8 === 2) {
    ...
    try {
      ...
      if (0 === c7) {
        ...
        body = value.body;
        const obj6 = { resolved: true, gift_code: body.code, gift_code_max_uses: body.max_uses, sku_id: body.store_listing.sku.id, sku_type: body.store_listing.sku.type, application_id: body.store_listing.sku.application_id, store_title: body.store_listing.sku.name };
...
export const trackStep = function trackStep(giftCode) {
  ...
  const obj = { to_step: step, has_custom_message: null != giftCode.giftStyle, is_custom_message_edited: null, gift_style: null, gift_code: null, emoji_name: null, sound_id: null, product_line: null };
