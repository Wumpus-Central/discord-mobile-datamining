...
function getSystemMessageUserJoinMobile(id) {
  const items = [getSystemLocale /* getSystemLocale */.t.Jm6e0x, getSystemLocale /* getSystemLocale */.t.MGRnRT, getSystemLocale /* getSystemLocale */.t.EXOEGh, getSystemLocale /* getSystemLocale */.t["5uCTFN"], getSystemLocale /* getSystemLocale */.t.rl45Qo, getSystemLocale /* getSystemLocale */.t.Bh9zpQ, getSystemLocale /* getSystemLocale */.t.RdEy1J, getSystemLocale /* getSystemLocale */.t.qcdp00, getSystemLocale /* getSystemLocale */.t.F7w2Ru, getSystemLocale /* getSystemLocale */.t.gSyOgK, getSystemLocale /* getSystemLocale */.t.uYgqv7, getSystemLocale /* getSystemLocale */.t["b/1SBX"], getSystemLocale /* getSystemLocale */.t.LhebZF];
...
export default {
    ...
    if (null == first) {
      ...
      if (constants.RECIPIENT_ADD === type) {
        if (null != null) {
          ...
          obj[3] = closure_12;
          return reactParserFor /* reactParserFor */.astToString(intl18.formatToParts(getSystemLocale /* getSystemLocale */.t["7/Xl0S"], obj));
        }
        ...
        if (null != null) {
          ...
          if (null != author) {
            if (author.id !== null.id) {
              ...
              obj[2] = tmp6Result.getName(null, channel_id, null);
              obj[3] = closure_12;
              let astToStringResult = reactParserFor /* reactParserFor */.astToString(intl17.formatToParts(getSystemLocale /* getSystemLocale */.t.QtZ0RD, obj));
              const obj58 = reactParserFor /* reactParserFor */;
            }
          ...
          obj1[0] = name;
          obj1[1] = closure_12;
          astToStringResult = reactParserFor /* reactParserFor */.astToString(intl16.formatToParts(getSystemLocale /* getSystemLocale */.t["Qn5+Lf"], obj1));
          const obj56 = reactParserFor /* reactParserFor */;
        }
        ...
        if (null != call) {
          ...
          if (-1 === participants.indexOf(id.getId())) {
            ...
            obj2[0] = name;
            obj2[1] = closure_12;
            astToStringResult1 = reactParserFor /* reactParserFor */.astToString(intl15.formatToParts(getSystemLocale /* getSystemLocale */.t.DbgSA0, obj2));
            const obj54 = reactParserFor /* reactParserFor */;
          }
        }
        return astToStringResult1;
      } else if (tmp9.CHANNEL_NAME_CHANGE === type) {
        const intl14 = getSystemLocale /* getSystemLocale */.intl;
        const obj52 = reactParserFor /* reactParserFor */;
        ...
        obj4[0] = name;
        obj4[1] = closure_12;
        return reactParserFor /* reactParserFor */.astToString(intl13.formatToParts(getSystemLocale /* getSystemLocale */.t.wypJZ0, obj4));
        ...
        obj5[0] = name;
        obj5[1] = closure_12;
        return reactParserFor /* reactParserFor */.astToString(intl12.formatToParts(getSystemLocale /* getSystemLocale */.t["/M60j0"], obj5));
        ...
        obj6[0] = name;
        obj6[1] = closure_12;
        return reactParserFor /* reactParserFor */.astToString(intl11.formatToParts(getSystemMessageUserJoinMobile(mentions.id), obj6));
        ...
        obj7[0] = name;
        obj7[1] = closure_12;
        return reactParserFor /* reactParserFor */.astToString(intl10.formatToParts(getSystemLocale /* getSystemLocale */.t.ihxM9x, obj7));
      } else {
          ...
          if (tmp9.GUILD_BOOST_TIER_2 !== type) {
            if (tmp9.GUILD_BOOST_TIER_3 !== type) {
              if (tmp9.GUILD_INVITE_REMINDER === type) {
                ...
                return intl7.string(getSystemLocale /* getSystemLocale */.t.gxyKvr);
              } else if (tmp9.THREAD_STARTER_MESSAGE === type) {
                const intl6 = getSystemLocale /* getSystemLocale */.intl;
                const obj8 = { username: null, threadName: null };
                obj8[0] = name;
                obj8[1] = computeChannelName /* computeChannelName */.computeChannelName(isForumPost, authStore, upsertRelationship);
                return intl6.formatToPlainString(getSystemLocale /* getSystemLocale */.t["B8H+Cl"], obj8);
              } else if (tmp9.ROLE_SUBSCRIPTION_PURCHASE === type) {
                let astToStringResult2 = null;
                if (!(mentions instanceof hasFlag)) {
                  const obj34 = reactParserFor /* reactParserFor */;
                  ...
                  astToStringResult2 = obj34.astToString(identityHook /* identityHook */.getRoleSubscriptionPurchaseSystemMessageContentMobile(obj9));
                  const obj35 = identityHook /* identityHook */;
                }
                ...
                if (!(mentions instanceof hasFlag)) {
                  ...
                  if (null != product_name) {
                    const obj31 = reactParserFor /* reactParserFor */;
                    const obj10 = { username: null, productName: null };
                    obj10[0] = name;
                    obj10[1] = mentions.purchase_notification.guild_product_purchase.product_name;
                    astToStringResult3 = obj31.astToString(getGuildProductPurchaseSystemMessageContentMobile /* getGuildProductPurchaseSystemMessageContentMobile */.getGuildProductPurchaseSystemMessageContentMobile(obj10));
                    const obj32 = getGuildProductPurchaseSystemMessageContentMobile /* getGuildProductPurchaseSystemMessageContentMobile */;
                  }
                }
                ...
                if (mentions instanceof hasFlag) {
                  ...
                  const obj26 = useNullableMessageAuthor /* useNullableMessageAuthor */;
                  const messageAuthor = obj26.getMessageAuthor(createMinimalMessageRecord /* createMinimalMessageRecord */.createMessageRecord(mentions));
                  const obj27 = createMinimalMessageRecord /* createMinimalMessageRecord */;
                  const obj28 = reactParserFor /* reactParserFor */;
                  const obj11 = { application: null, username: null };
                  obj11[0] = mentions.application;
                  obj11[1] = messageAuthor.nick;
                  return obj28.astToString(getApplicationSubscriptionSystemMessageASTContent /* getApplicationSubscriptionSystemMessageASTContent */.getApplicationSubscriptionSystemMessageASTContent(obj11));
                }
              } else if (tmp9.PRIVATE_CHANNEL_INTEGRATION_ADDED === type) {
                let astToStringResult4 = null;
                if (!(mentions instanceof hasFlag)) {
                  let obj20 = reactParserFor /* reactParserFor */;
                  const obj12 = { application: null, username: null };
                  obj12[0] = mentions.application;
                  const obj22 = getPrivateChannelIntegrationAddedSystemMessageContent /* getPrivateChannelIntegrationAddedSystemMessageContent */;
                  const obj24 = useNullableMessageAuthor /* useNullableMessageAuthor */;
                  obj12[1] = obj24.getMessageAuthor(createMinimalMessageRecord /* createMinimalMessageRecord */.createMessageRecord(mentions)).nick;
                  astToStringResult4 = obj20.astToString(obj22.getPrivateChannelIntegrationAddedSystemMessageASTContent(obj12));
                  const obj25 = createMinimalMessageRecord /* createMinimalMessageRecord */;
                }
                return astToStringResult4;
              } else if (tmp9.PRIVATE_CHANNEL_INTEGRATION_REMOVED === type) {
                let astToStringResult5 = null;
                if (!(mentions instanceof hasFlag)) {
                  let obj15 = reactParserFor /* reactParserFor */;
                  let obj16 = getPrivateChannelIntegrationAddedSystemMessageContent /* getPrivateChannelIntegrationAddedSystemMessageContent */;
                  const obj13 = { application: null, username: null };
                  obj13[0] = mentions.application;
                  let obj18 = useNullableMessageAuthor /* useNullableMessageAuthor */;
                  let obj19 = createMinimalMessageRecord /* createMinimalMessageRecord */;
                ...
                if (someResult) {
                  ...
                  if (null != channel) {
                    ...
                    if (null != guild) {
                      if (AutomodNotificationEmbedTypeKeys /* AutomodNotificationEmbedTypeKeys */.AutomodNotificationEmbedTypeKeys.ACTIVITY_ALERTS_ENABLED === value) {
                ...
                if (null != channel1) {
                  ...
                  if (null != guild1) {
                    obj5 = reactParserFor /* reactParserFor */;
                    ...
                    obj17[2] = str;
                    astToStringResult7 = obj5.astToString(intl2.formatToParts(getSystemLocale /* getSystemLocale */.t.iOuWPk, obj17));
                    tmp21 = require;
                  }
                ...
                if (null != channel2) {
                  ...
                  if (null != guild2) {
                    obj2 = reactParserFor /* reactParserFor */;
                    const intl = getSystemLocale /* getSystemLocale */.intl;
                    obj18 = { username: null, guildName: null };
                    obj18[0] = name;
                    obj18[1] = guild2.name;
                    astToStringResult8 = obj2.astToString(intl.formatToParts(getSystemLocale /* getSystemLocale */.t.axmbpm, obj18));
                  }
        ...
        if (null != channel3) {
          if (null != store2.getGuild(channel3.getGuildId())) {
            ...
            obj19[0] = name;
            obj19[1] = closure_12;
            let astToStringResult9 = reactParserFor /* reactParserFor */.astToString(intl8.formatToParts(getSystemLocale /* getSystemLocale */.t.ihxM9x, obj19));
            const obj40 = reactParserFor /* reactParserFor */;
          }
        ...
        obj20[0] = name;
        obj20[1] = closure_12;
        astToStringResult9 = reactParserFor /* reactParserFor */.astToString(intl9.formatToParts(getSystemLocale /* getSystemLocale */.t.ihxM9x, obj20));
        const obj42 = reactParserFor /* reactParserFor */;
      }
  ...
  getSystemMessageUserJoin(id) {
    const items = [getSystemLocale /* getSystemLocale */.t["0cuj7l"], getSystemLocale /* getSystemLocale */.t["MuW+CN"], getSystemLocale /* getSystemLocale */.t.osqpHX, getSystemLocale /* getSystemLocale */.t["5ToSh2"], getSystemLocale /* getSystemLocale */.t.JEB8ps, getSystemLocale /* getSystemLocale */.t.pkOV5T, getSystemLocale /* getSystemLocale */.t["kRb1J+"], getSystemLocale /* getSystemLocale */.t["EmKLY+"], getSystemLocale /* getSystemLocale */.t.rPtBnb, getSystemLocale /* getSystemLocale */.t["5B/ekS"], getSystemLocale /* getSystemLocale */.t.ESNC3Y, getSystemLocale /* getSystemLocale */.t.Iw6d8w, getSystemLocale /* getSystemLocale */.t["WecSZ/"]];
    const obj = DISCORD_EPOCH;
    return items[obj.extractTimestamp(obj, id) % items.length];
  },
