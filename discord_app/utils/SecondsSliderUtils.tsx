...
export const getSecondsSliderLabel = function getSecondsSliderLabel(rateLimitPerUser, arg1, intl) {
  ...
  if (intl === undefined) {
    ...
    stringResult = intl.string(getSystemLocale /* getSystemLocale */.t.Yl1D84);
  }
  ...
  if (durationResult.days() > 0) {
    ...
    let t1 = getSystemLocale /* getSystemLocale */.t;
    t1 = { hours: null };
    ...
    let t2 = getSystemLocale /* getSystemLocale */.t;
    t2 = { minutes: null };
    ...
    let t3 = getSystemLocale /* getSystemLocale */.t;
    t3 = { seconds: null };
    ...
    if (flag) {
      ...
      stringResult = intl2.string(getSystemLocale /* getSystemLocale */.t.Yl1D84);
    }
    return stringResult;
  }
};