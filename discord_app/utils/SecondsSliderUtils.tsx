...
export const getSecondsSliderLabel = function getSecondsSliderLabel(rateLimitPerUser, arg1, intl) {
  ...
  if (intl === undefined) {
    ...
    stringResult = intl.string(require("../intl/index.native.tsx") /* getSystemLocale */.t.Yl1D84);
  }
  const durationResult = require("../../_runtime/03867_t.js").duration(rateLimitPerUser, "seconds");
  if (durationResult.days() > 0) {
    ...
    let t1 = require("../intl/index.native.tsx") /* getSystemLocale */.t;
    t1 = { hours: null };
    ...
    let t2 = require("../intl/index.native.tsx") /* getSystemLocale */.t;
    t2 = { minutes: null };
    ...
    let t3 = require("../intl/index.native.tsx") /* getSystemLocale */.t;
    t3 = { seconds: null };
    ...
    if (flag) {
      ...
      stringResult = intl2.string(require("../intl/index.native.tsx") /* getSystemLocale */.t.Yl1D84);
    }
    return stringResult;
  }
};