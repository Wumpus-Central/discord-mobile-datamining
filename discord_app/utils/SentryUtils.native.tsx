...
let obj = {
  ...
  captureException(arg0, extra) {
    const _require = arg0;
    importAll = _require(13815).getUpdatedOptions(extra);
    const obj = _require(13815);
  ...
  captureCrash(error, extra) {
    ...
    const updatedOptions = _require(13815).getUpdatedOptions(extra);
    let tags;
