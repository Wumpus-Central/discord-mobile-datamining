...
import LinkAnalyticsUtilsDefault from "../modules/links/LinkAnalyticsUtils.tsx";
import BlockedDomainStore from "../modules/blocked_domains/BlockedDomainStore.tsx";
import ChannelStore from "../stores/ChannelStore.tsx";
import GuildStore from "../stores/GuildStore.tsx";
import MaskedLinkStore from "../stores/MaskedLinkStore.tsx";
      ...
      if (null !== guild_id.isBlockedDomain(tmp8)) {
        ...
        if (!tmp55) {
          ...
          if (tmp56) {
            obj4 = {
              url: tmp8,
              trustUrl: tmp53(13048).trustProtocol,
              onConfirm: handleConfirm,
              onCancel,
              isProtocol: true,
              contextKey,
            };
            tmp3(13046).show(obj4);
            const tmp3Result4 = tmp3(13046);
          } else {
            ...
            const obj5 = {
              url: displayTarget,
              trustUrl: tmp53(13048).trustDomain,
              onConfirm: handleConfirm,
              onCancel,
              isProtocol: false,
              contextKey,
            };
            tmp3(13046).show(obj5);
            const tmp3Result5 = tmp3(13046);
          }
        }
        if (null == preventDefault) {
          handleConfirm();
          ...
          let result = tmp3(8461).trackAnnouncementMessageLinkClicked(obj6);
          const tmp3Result6 = tmp3(8461);
        }
        const obj10 = require("MaskedLinkStoreMethodsAdditional");
      }
      const tmp3Result2 = tmp3(8461);
    } catch (err) {
