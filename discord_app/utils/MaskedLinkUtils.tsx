    ...
    try {
      ...
      if (null !== guild_id.isBlockedDomain(tmp8)) {
        ...
        if (!tmp55) {
          ...
          if (tmp56) {
            obj4 = { url: tmp8, trustUrl: tmp53(13025).trustProtocol, onConfirm: handleConfirm, onCancel, isProtocol: true, contextKey };
            ...
            const obj5 = { url: displayTarget, trustUrl: tmp53(13025).trustDomain, onConfirm: handleConfirm, onCancel, isProtocol: false, contextKey };
