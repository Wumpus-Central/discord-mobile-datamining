...
const never = "never";
const dependencyMap = {
  [fn(9963).INVITE_OPTIONS_30_MINUTES.value]: { value: 30, type: "minutes" },
  [fn(9963).INVITE_OPTIONS_1_HOUR.value]: { value: 1, type: "hours" },
  [fn(9963).INVITE_OPTIONS_6_HOURS.value]: { value: 6, type: "hours" },
  [fn(9963).INVITE_OPTIONS_12_HOURS.value]: { value: 12, type: "hours" },
  [fn(9963).INVITE_OPTIONS_1_DAY.value]: { value: 1, type: "days" },
  [fn(9963).INVITE_OPTIONS_7_DAYS.value]: { value: 7, type: "days" },
  [fn(9963).INVITE_OPTIONS_14_DAYS.value]: { value: 14, type: "days" },
  [fn(9963).INVITE_OPTIONS_30_DAYS.value]: { value: 30, type: "days" },
  [fn(9963).INVITE_OPTIONS_60_DAYS.value]: { value: 60, type: "days" },
  [fn(9963).INVITE_OPTIONS_FOREVER.value]: { value: 0, type: "never" },
};
