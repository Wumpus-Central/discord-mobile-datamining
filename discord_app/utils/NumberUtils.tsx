...
export const shortenAndLocalizeNumber = function shortenAndLocalizeNumber(count) {
  if (count < c2) {
    ...
    let obj = { value: null };
    obj[0] = count;
    return intl2.formatToPlainString(getSystemLocale /* getSystemLocale */.t.OiHat3, obj);
  } else {
    const result = count / tmp;
    const intl = getSystemLocale /* getSystemLocale */.intl;
    obj = { value: null };
    obj[0] = result.toFixed(1);
    return intl.formatToPlainString(getSystemLocale /* getSystemLocale */.t.Iku48I, obj);
  }
};
export const humanizeValue = function humanizeValue(newPostCount, stateFromStores) {
  if (newPostCount < 1000) {
    ...
    return intl.formatToPlainString(getSystemLocale /* getSystemLocale */.t["84R4Tc"], obj);
  } else {
    const _Math3 = Math;
    const _Intl = Intl;
    ...
    return intl3.formatToPlainString(getSystemLocale /* getSystemLocale */.t.Iku48I, obj);
  }
};
