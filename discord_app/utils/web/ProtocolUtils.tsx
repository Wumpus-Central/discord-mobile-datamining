...
import _modDef5079 from "../../../_runtime/metro/05079__.js";

const os = _modDef5079.os;
let family;
if (os != null) {
  family = os.family;
}
...
if ("Android" !== family) {
  ...
  if ("iOS" !== family1) {
    ...
    if ("Gecko" !== _modDef5079.layout) {
      ...
      if (null != _modDef5079.ua) {
        const ua = _modDef5079.ua;
