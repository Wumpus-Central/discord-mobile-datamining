...
import regExpDefault from "regExp" /* 5025 */;
import _modDef5026 from "module_5026" /* 5026 */;

const require = arg1;
function defaultRules(uri) {
  let obj = {};
  const merged = Object.assign(_require(8094).baseRules);
  if (null != _require(8094).customRules.strong) {
    obj = {};
...
export default {
  ...
  getSpecialRules(uri) {
    ...
    if (typeof _require(8094).customRules.lheading === "function") {
