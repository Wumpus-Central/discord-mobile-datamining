...
import regExpDefault from "regExp" /* 4946 */;
import _modDef4947 from "module_4947" /* 4947 */;

const require = arg1;
function defaultRules(uri) {
  let obj = {};
  const merged = Object.assign(_require(7971).baseRules);
  if (null != _require(7971).customRules.strong) {
    obj = {};
...
export default {
  ...
  getSpecialRules(uri) {
    ...
    if (typeof _require(7971).customRules.lheading === "function") {
