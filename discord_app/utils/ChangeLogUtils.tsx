...
import regExpDefault from "regExp" /* 4929 */;
import _modDef4930 from "module_4930" /* 4930 */;

const require = arg1;
function defaultRules(uri) {
  let obj = {};
  const merged = Object.assign(_require(8414).baseRules);
  if (null != _require(8414).customRules.strong) {
    obj = {};
...
export default {
  ...
  getSpecialRules(uri) {
    ...
    if (typeof _require(8414).customRules.lheading === "function") {
