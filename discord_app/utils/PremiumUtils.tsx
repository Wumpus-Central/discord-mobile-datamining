...
import _modDef3196 from "../modules/premium/premium_group/PremiumGroup.messages.js";
...
function getBillingGracePeriodDaysAndExpiresDate(subscription) {
  ...
  if (subscription.isPurchasedExternally) {
    ...
    if (null != prop3) {
      ...
      obj8.expiresDate = _modDef4414(subscription.metadata.grace_period_expires_date);
      return obj8;
    } else {
...
function getBillingInformationString(status, subscriptionPeriodStart, arg2) {
  let tmp = arg2;
  if (arg2 === undefined) {
    tmp = null;
  }
  ...
  if (fractionalPremiumInfo === undefined) {
    obj = {
      ...
      startsAt: _modDef4414(0),
      endsAt: _modDef4414(0),
      currentEntitlementId: "",
      currentEntitlementEndsAt: _modDef4414(0),
      unactivatedUnits: [],
    };
    tmp2 = obj;
  }
