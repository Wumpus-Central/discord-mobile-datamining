...
function getBillingGracePeriodDaysAndExpiresDate(subscription) {
  ...
  if (subscription.isPurchasedExternally) {
    ...
    if (null != prop3) {
      ...
      obj8.expiresDate = _modDef4229(subscription.metadata.grace_period_expires_date);
      return obj8;
    } else {
...
function getBillingInformationString(status, subscriptionPeriodStart) {
  ...
  if (fractionalPremiumInfo === undefined) {
    obj = {
      ...
      startsAt: _modDef4229(0),
      endsAt: _modDef4229(0),
      currentEntitlementId: "",
      currentEntitlementEndsAt: _modDef4229(0),
      unactivatedUnits: [],
    };
    tmp2 = obj;
  }
