...
function getBillingGracePeriodDaysAndExpiresDate(subscription) {
  ...
  if (subscription.isPurchasedExternally) {
    ...
    if (null != prop3) {
      ...
      obj8.expiresDate = _modDef4416(subscription.metadata.grace_period_expires_date);
      return obj8;
    } else {
...
function getBillingInformationString(status, subscriptionPeriodStart, arg2) {
  ...
  if (fractionalPremiumInfo === undefined) {
    obj = {
      ...
      startsAt: _modDef4416(0),
      endsAt: _modDef4416(0),
      currentEntitlementId: "",
      currentEntitlementEndsAt: _modDef4416(0),
      unactivatedUnits: [],
    };
    tmp2 = obj;
  }
