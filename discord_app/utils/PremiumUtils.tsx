...
import _modDef3162 from "../modules/premium/premium_group/PremiumGroup.messages.js";
...
function getBillingGracePeriodDaysAndExpiresDate(subscription) {
  ...
  if (subscription.isPurchasedExternally) {
    ...
    if (null != prop3) {
      ...
      obj8.expiresDate = _modDef4348(subscription.metadata.grace_period_expires_date);
      return obj8;
    } else {
...
function getBillingInformationString(status, subscriptionPeriodStart) {
  ...
  if (fractionalPremiumInfo === undefined) {
    obj = {
      ...
      startsAt: _modDef4348(0),
      endsAt: _modDef4348(0),
      currentEntitlementId: "",
      currentEntitlementEndsAt: _modDef4348(0),
      unactivatedUnits: [],
    };
    tmp2 = obj;
  }
