              ...
              if (SubscriptionPlans.PREMIUM_YEAR_TIER_1 !== planId) {
                ...
                if (constants4.CANCELED === CANCELED) {
                  ...
                  if (null != subscription.pauseEndsAt) {
                    let obj18 = _modDef4198(subscription.pauseEndsAt);
                  ...
                  let obj15 = _modDef4198(subscription.currentPeriodStart);
...
function getBillingGracePeriodDaysAndExpiresDate(subscription) {
  if (subscription.isPurchasedViaApple) {
    ...
    if (null != prop) {
      ...
      obj.days = _modDef4198.duration(obj11.diff(subscription.currentPeriodStart)).days();
  ...
  if (subscription.isPurchasedViaGoogle) {
    ...
    if (null != prop1) {
      ...
      if (null != prop2) {
        ...
        obj.days = _modDef4198.duration(obj7.diff(tmp20)).days();
  ...
  if (subscription.isPurchasedExternally) {
    ...
    let obj1 = { days: tmp15, expiresDate: _modDef4198(subscription.currentPeriodStart).add(tmp15, "days") };
    return obj1;
  } else {
    ...
    if (null != prop3) {
      ...
      obj2.days = _modDef4198(prop4).diff(subscription.currentPeriodStart, "days");
      obj2.expiresDate = _modDef4198(subscription.metadata.grace_period_expires_date);
      return obj2;
    } else {
      const tmp8 = null == subscription.paymentSourceId ? closure_1_19 : __initData8;
      obj = { days: tmp8, expiresDate: null };
      obj1 = _modDef4198(subscription.currentPeriodStart);
...
function getBillingInformationString(status, subscriptionPeriodStart) {
  ...
  if (fractionalPremiumInfo === undefined) {
    obj = {
      ...
      startsAt: _modDef4198(0),
      endsAt: _modDef4198(0),
      currentEntitlementId: "",
      currentEntitlementEndsAt: _modDef4198(0),
      unactivatedUnits: [],
    };
    tmp2 = obj;
  }
  ...
  if (isOnReverseTrialResult) {
    ...
    obj8.endDate = _modDef4198(status.currentPeriodStart).add(__initData7, "days").toDate();
    ...
    if (status.isPurchasedViaGoogle) {
      if (!tmp14Result.isGooglePlayBillingSupported()) {
        ...
        let obj11 = _modDef4198(status.currentPeriodStart);
    ...
    let obj14 = _modDef4198(status.currentPeriodStart);
