...
import siteKeyDefault from "../../../_runtime/17066_siteKey.js";
...
export default {
  ...
  showHcaptcha(arg0, rqdata) {
    ...
    return new Promise((sitekey, arg1) => {
      ...
      rqdata(paths[6]).track(constants.CAPTCHA_EVENT, {
      ...
      rqdata(paths[14]).pushLazy(
        sitekey(paths[16])(paths[15], paths.paths),
        {
          siteKey: sitekey,
  ...
  showRecaptcha() {
    ...
    return new Promise((arg0, arg1) => {
      ...
      nativeEventEmitter.addListener(constants.SOLVED, (arg0) => {
        ...
        AnalyticsUtilsDefault.track(constants.CAPTCHA_EVENT, {
          captcha_event_name: "verify",
