// === Module 10861: _handleDocumentSelection ===
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (obj3.isErrorWithCode(c4)) {
              if (c4.code === flag(10862).errorCodes.OPERATION_CANCELED) {
                c6 = 3;
                return { value: "HermesInternal", done: null };
              }
            }
