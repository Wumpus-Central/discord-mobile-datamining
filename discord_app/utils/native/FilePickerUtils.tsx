// === Module 10781: _handleDocumentSelection ===
        ...
        try {
          ...
          if (0 === c5) {
            ...
            if (obj3.isErrorWithCode(c4)) {
              if (c4.code === flag(10782).errorCodes.OPERATION_CANCELED) {
                c6 = 3;
                return { value: "HermesInternal", done: null };
              }
            }
