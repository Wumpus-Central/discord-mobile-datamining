...
function usePremiumUpsellConfig(initialUpsellKey, analyticsLocations2, analyticsLocation) {
  ...
  let obj = _require("../../modules/premium/hooks/usePremiumTrialOffer.android.tsx");
...
export const getUpsellItems = function getUpsellItems() {
  let obj = { key: constants.GLOBAL_EMOJI, image: require("../../../_runtime/08174_registerAsset.js"), activeTitle: null, passiveTitle: null, description: null };
  const intl = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[2] = intl.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.gKtr8N);
  const intl2 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[3] = intl2.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.N8ZRNb);
  const intl3 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[4] = intl3.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t.rf7Ixp, {});
  const items = [obj, , , , , ];
  obj = { key: constants.ANIMATED_EMOJI, image: require("../../../_runtime/08175_registerAsset.js"), activeTitle: null, passiveTitle: null, description: null };
  const intl4 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[2] = intl4.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.F6rmyq);
  const intl5 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[3] = intl5.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.e4cKNt);
  const intl6 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[4] = intl6.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t.JxTzzb, {});
  items[1] = obj;
  obj = { key: constants.ANIMATED_AVATAR, image: require("../../../_runtime/08176_registerAsset.js"), activeTitle: null, passiveTitle: null, description: null };
  const intl7 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[2] = intl7.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["tQh+gF"]);
  const intl8 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[3] = intl8.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.HGSXTM);
  const intl9 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj[4] = intl9.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t["Tso/Fn"], {});
  items[2] = obj;
  const obj1 = { key: constants.UPLOAD, image: require("../../../_runtime/08177_registerAsset.js"), activeTitle: null, passiveTitle: null, description: null };
  const intl10 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[2] = intl10.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["1EOZqw"]);
  const intl11 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj1[3] = intl11.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.tB51W4);
  ...
  obj2[0] = intl13.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.Ll40SK);
  const intl14 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj2[1] = intl14.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.EaBfeq);
  obj1[4] = intl12.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t.DUT5IC, obj2);
  items[3] = obj1;
  const obj3 = { key: constants.BADGE, image: require("../../../_runtime/08178_registerAsset.js"), activeTitle: null, passiveTitle: null, description: null };
  const intl15 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj3[2] = intl15.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["602BK4"]);
  const intl16 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj3[3] = intl16.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.j0TXTX);
  const intl17 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj3[4] = intl17.format(require("../../intl/index.native.tsx") /* getSystemLocale */.t["p7i+li"], {});
  items[4] = obj3;
  const obj4 = { key: constants.APP_ICONS, image: require("../../../_runtime/08179_registerAsset.js"), activeTitle: null, passiveTitle: null, description: null };
  const intl18 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj4[2] = intl18.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["1B1Cyn"]);
  const intl19 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj4[3] = intl19.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["1B1Cyn"]);
  const intl20 = require("../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj4[4] = intl20.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.VL5TYT);
  items[5] = obj4;
  return items;
};
