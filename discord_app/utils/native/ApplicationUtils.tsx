...
export const installApplication = function installApplication(arg0) {
  ...
  if (null != customInstallUrl) {
    ...
    return obj5(8855).handleClick(obj);
  } else {
    if (null != integrationTypesConfig) {
      ...
      if (values.some((oauth2_install_params) => {
        ...
        obj10.pushLazy(obj5(1988)(10561, dependencyMap.paths), obj3, closure_5);
      }
    }
    if (null != installParams) {
      ...
      tmp32Result.pushLazy(obj5(1988)(10561, dependencyMap.paths), obj6, closure_5);
      const tmp10 = obj5(1988)(10561, dependencyMap.paths);
    }
  }
};
export const openOAuth2Modal = function openOAuth2Modal(arg0) {
  ...
  obj2.pushLazy(_asyncRequireImpl(10561, dependencyMap.paths), obj, closure_5);
};
export const installPrivateChannelIntegration = function installPrivateChannelIntegration(arg0) {
  ...
  obj[5] = callback;
  obj.pushLazy(asyncRequireImpl(10561, dependencyMap.paths), obj, closure_5);
};