...
export const useShowWelcomeModal = function useShowWelcomeModal(guildId, channelId) {
  ...
  welcomeModalChannelId = require("../../../_runtime/metro/04659__.js").useLocation().welcomeModalChannelId;
...
export const openWelcomeActionSheet = function openWelcomeActionSheet(onHide) {
  ...
  obj.openLazy(asyncRequireImpl(12996, dependencyMap.paths), "GuildWelcomeActionSheet" + guildId, {
    guildId,
