...
function ChangeLogParagraph(state) {
  ...
  if (Paragraph == null) {
    Paragraph = require("../../design/components/Text/native/Text.tsx") /* Text */.Text;
  }
  const tmp = createCacheKey();
...
function ChangeLogImage(arg0) {
  ...
  obj = { uri: null };
  obj[0] = require("../../../_runtime/03984_t.js").sanitizeUrl(node.target);
  obj[1] = obj;
...
function ChangeLogBlockQuote(state) {
  ...
  obj[1] = jsx(require("../../design/components/Text/native/Text.tsx") /* Text */.Text, { variant: "text-sm/normal", style: tmp.text, children: null });
