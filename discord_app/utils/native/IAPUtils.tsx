      ...
      if (0 === c4) {
        if (arg0 === 1) {
          ...
          if (isStorekit2Available()) {
            ...
            c4 = 2;
            c5 = 1;
            let obj1 = { value: require("../../../_runtime/metro/11080__.js").getStorefront(), done: false };
            return obj1;
          } else {
            c5 = 3;
            ...
            if (0 === c6) {
              if (arg0 === 1) {
                ...
                if (null != currentUser.getCurrentUser()) {
                  ...
                  c6 = 2;
                  c7 = 1;
                  let obj1 = { value: sku(11080).clearTransactionIOS(), done: false };
                  return obj1;
                } else {
                  const _Error2 = Error;
        ...
        try {
          ...
          if (0 === c6) {
            if (arg0 === 1) {
              ...
              if (null != currentUser) {
                c5 = 1;
                let obj3 = requestJSONString(11080);
                const obj1 = {
                  requestJSONString,
                  sku,
