...
import useVirtualCurrencyMobileEnabled from "useVirtualCurrencyMobileEnabled" /* 13075 */;
import QRLoginUtils from "QRLoginUtils" /* 13936 */;
import urlPartToSettingsEnumDefault from "urlPartToSettingsEnum" /* 13937 */;
                ...
                if (null != result3) {
                  ...
                  if (null != match6) {
                    ...
                    if (null != match7) {
                      ...
                      const obj82 = { type: React5.USER_CONNECTIONS_CALLBACK, provider: tmp84[1], searchParams: parseQuery(decodeURIComponent(str19)) };
                      obj81.payload = obj82;
                      return obj81;
                    } else {
                      ...
                      if (null != match8) {
                        ...
                        const obj84 = { type: React5.GUILD_SETTINGS, guildId: tmp79[1], settingsSection: urlPartToSettingsEnumDefault(hasOwnProperty, tmp79[2]), settingsSubsection: urlPartToSettingsEnumDefault(timestampProducer, tmp79[3]) };
                        obj83.payload = obj84;
                        return obj83;
                      } else {
                        ...
                        if (null != match9) {
                          ...
                          const obj86 = { type: React5.GUILD_SETTINGS_PICKER, settingsSection: urlPartToSettingsEnumDefault(hasOwnProperty, tmp74[1]), settingsSubsection: urlPartToSettingsEnumDefault(timestampProducer, tmp74[2]), feature: parseQuery(str18).feature };
                          obj85.payload = obj86;
                          return obj85;
                          ...
                          const obj88 = { type: React5.ACTIVATE_DEVICE, userCode: parseQuery(decodeURIComponent(str17)).user_code };
                          obj87.payload = obj88;
                          return obj87;
                        }
                      }
