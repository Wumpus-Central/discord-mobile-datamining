...
prototype2["canHaveMentions"] = function canHaveMentions() {
  ...
  if (tmp) {
    ...
    if (!(self._isThread && !self._isJoinedThread)) {
      ...
      let tmp9 = !result;
      if (!result) {
        let result1 = tmp4(7064).isOptInEnabledForGuild(self._guildId);
        if (result1) {
  ...
  if (null != outgoingAck) {
    ...
    _networkAwareRetry(() => {
      ...
      if (null != body) {
        ...
        if (dependencyMap) {
          tmp4(2007)(13269, tmp5.paths).then((arg0) => {
            let obj = closure_1;
            if (closure_1 == null) {
              obj = {};
            }
          ...
          const promise = tmp4(2007)(13269, tmp5.paths);
        }
