...
import _modDef10857 from "../modules/app_state/DiscordAppState.native.tsx";
...
prototype2["canHaveMentions"] = function canHaveMentions() {
  ...
  if (tmp) {
    ...
    if (!(self._isThread && !self._isJoinedThread)) {
      ...
      let tmp9 = !result;
      if (!result) {
        let result1 = tmp4(7213).isOptInEnabledForGuild(self._guildId);
        if (result1) {
  ...
  if (null != outgoingAck) {
    ...
    _networkAwareRetryDefault(() => {
      ...
      if (null != body) {
        ...
        if (dependencyMap) {
          recalculateFlagsResult(2009)(13491, tmp5.paths).then((arg0) => {
            obj = closure_1;
            if (closure_1 == null) {
              obj = {};
            }
          ...
          const promise = recalculateFlagsResult(2009)(13491, tmp5.paths);
        }
        obj = callback(709);
        tmp5 = dependencyMap;
      }
