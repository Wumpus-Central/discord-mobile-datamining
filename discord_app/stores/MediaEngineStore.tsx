...
import trackVideoToggleDefault from "trackVideoToggle" /* 13916 */;
...
import WGCDirtyRegionsExperiment2 from "WGCDirtyRegionsExperiment" /* 14093 */;
import WGCDirtyRegionsAllExperiment2 from "WGCDirtyRegionsAllExperiment" /* 14094 */;
import VideoHookDX12Experiment2 from "VideoHookDX12Experiment" /* 14095 */;
import UpscaleSmallCapturedFramesExperiment2 from "UpscaleSmallCapturedFramesExperiment" /* 14096 */;
import GlobalFramePoolLockExperiment from "GlobalFramePoolLockExperiment" /* 14097 */;
import AudioFidelityExperiment from "AudioFidelityExperiment" /* 14098 */;
import SystemwideEchoCancellationExperiment from "SystemwideEchoCancellationExperiment" /* 14099 */;
import _modDef14101 from "module_14101" /* 14101 */;
import AudioEffectsExperimentDefault from "AudioEffectsExperiment" /* 14156 */;
import queryAudioEffectsDefault from "queryAudioEffects" /* 14157 */;
import IOSAudioInterruptExperiment from "IOSAudioInterruptExperiment" /* 14159 */;
import KrispNCModels from "KrispNCModels" /* 14160 */;
...
import VideoCaptureDeviceNoReuse from "VideoCaptureDeviceNoReuse" /* 14164 */;
...
prototype["initialize"] = function initialize() {
  ...
  closure_73.on(pollMetrics(4691).MediaEngineEvent.Connection, (setAttenuation) => {
    ...
    if (tmp9Result26.isWeb()) {
      setAttenuation.setExperimentFlag(closure_45.BROWSER_HEVC, closure_1(14147).getConfig({ location: "MediaEngineStore" }).enabled);
