...
import set from "module_4394";
import { apply } from "../../_runtime/00012_apply.js";
import { 13181__ } from "../../_runtime/metro/13181__.js";
        ...
        if (null != tmp2) {
          ...
          if (null != tmp2.desktopSource) {
            ...
            if (isWindowsResult) {
              ...
              isWindowsResult = 13181__.satisfies(release, closure_29);
              const obj6 = 13181__;
            }
            if (!isWindowsResult) {
              ...
              if (!isWindowsResult1) {
                ...
                if (videoHook2) {
                  const DisableHookFramePacerExperiment = tmp70(13173).DisableHookFramePacerExperiment;
                  tmp55 = !DisableHookFramePacerExperiment.getConfig({ location: "updateVideo" }).enabled;
                }
                let enabled2 = videoHook2;
                if (videoHook2) {
                  const VideoHookDX12Experiment = tmp70(13174).VideoHookDX12Experiment;
                  enabled2 = VideoHookDX12Experiment.getConfig({ location: "updateVideo" }).enabled;
                }
                const UpscaleSmallCapturedFramesExperiment = tmp70(13175).UpscaleSmallCapturedFramesExperiment;
                ...
                if (isMacResult) {
                  ...
                  isMacResult = 13181__.satisfies(release1, closure_24);
                  const obj14 = 13181__;
                }
                ...
                obj[13] = tmp70(13176).getGlobalFramePoolLockExperimentConfig({ location: "updateVideo" }).enabled;
                obj[14] = false;
                obj[15] = enabled2;
                ...
                const tmp70Result2 = tmp70(13176);
              } else if (true === c131) {
                const WGCDirtyRegionsExperiment = tmp70(13171).WGCDirtyRegionsExperiment;
                let enabled = WGCDirtyRegionsExperiment.getConfig({ location: "updateVideo" }).enabled;
              } else {
                const WGCDirtyRegionsAllExperiment = tmp70(13172).WGCDirtyRegionsAllExperiment;
              ...
              if (isWindowsResult2) {
                ...
                isWindowsResult2 = 13181__.satisfies(release2, closure_27);
                const obj8 = 13181__;
              }
...
function handleVideoFilterError(arg0, arg1) {
  ...
  if (arg1 !== constants10.LIVE) {
    ...
    if (constants9.UNSUPPORTED === arg0) {
      AVUnderlyingError = tmp4(9219).AVUnderlyingError;
      let VideoBackgroundInitFailed = AVUnderlyingError.VideoBackgroundUnsupported;
    } else if (tmp5.INIT_FAILED === arg0) {
      VideoBackgroundInitFailed = tmp4(9219).AVUnderlyingError.VideoBackgroundInitFailed;
    }
...
function updateConnectionVoiceProcessing(setEchoCancellation) {
  ...
  if (isWindowsResult) {
    ...
    isWindowsResult = tmp12(13181).satisfies(release, c152);
    const tmp12Result1 = tmp12(13181);
  }
  if (isWindowsResult) {
    if (setEchoCancellation.context === MediaEngineContextTypes.DEFAULT) {
      const systemwideEchoCancellationExperimentConfig = tmp8(13178).getSystemwideEchoCancellationExperimentConfig({ location: "updateConnectionVoiceProcessing" });
      ...
      const tmp8Result2 = tmp8(13178);
    }
  }
  const tmp8Result1 = set;
  if (tmp8Result3.isDesktop()) {
    const result5 = setEchoCancellation.setNoiseCancellationCpuDisablement(tmp8(13179).getKrispCpuDisablementConfig({ location: "updateConnectionVoiceProcessing" }).consecutiveFailures);
    const tmp8Result4 = tmp8(13179);
  }
  tmp8Result3 = set;
...
function applySettings() {
  ...
  if (obj2.isWindows()) {
    if (obj3.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
      ...
      if (null != guid) {
        tmp5(13237)(tmp7.guid, inputDeviceId, obj);
      }
    }
    obj3 = apexExperiment;
    tmp5 = importDefault;
...
function maybeTryHookProcess(pidFromDesktopSource, sound) {
  ...
  if (sound) {
    ...
    if (null != soundshareId) {
      ...
      if (isWindowsResult) {
        ...
        const obj8 = importAll(13170);
        importAll(13170).attachToProcess(soundshareId, obj1).then((closure_0) => {
        ...
        const attachToProcessResult = importAll(13170).attachToProcess(soundshareId, obj1);
      }
  ...
  if (videoHook) {
    importAll(13170).attachToProcess(pidFromDesktopSource);
    const obj6 = importAll(13170);
  }
...
function setLoopback() {
  ...
  const voiceFidelityCaps = tmp8(13177).getVoiceFidelityCaps({ location: "updateVoiceFidelityCaps" }, { krispEnabled: tmp15Result, noiseSuppressionEnabled: tmp14, echoCancellationEnabled: tmp13 });
        ...
        if (0 === c5) {
          ...
          if (2 === tmp8) {
            ...
            if (arg0 === 1) {
              ...
              lib = lib2(5391).requireModule("discord_krisp");
              let c109 = true;
...
let c85 = null;
let closure_86 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Input Devices", disabled: true, guid: "accessible", hardwareId: "IconComponent", containerId: "l" } };
let closure_87 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Output Devices", disabled: true, guid: "call", hardwareId: "warn", containerId: "has" } };
let closure_88 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Video Devices", disabled: true, guid: "add", hardwareId: "Number", containerId: "gap" } };
...
prototype["initialize"] = function initialize() {
  let self = this;
  if (navigation == null) {
    const tmp7 = new _pollMetrics(13243)(store3, self);
    navigation = tmp7;
  }
  ...
  let obj = store3;
  store3.on(pollMetrics(4441).MediaEngineEvent.Connection, (setAttenuation) => {
    ...
    if (enabled) {
      enabled = tmp9(13228).getWmfGpuEncode("MediaEngineStore").enabled;
      const tmp9Result10 = tmp9(13228);
    }
    if (enabled) {
    ...
    if (enabled2) {
      enabled2 = tmp9(13229).getWmfGpuEncodeIntel("MediaEngineStore").enabled;
      const tmp9Result12 = tmp9(13229);
    }
    if (enabled2) {
      setAttenuation.setExperimentFlag(tmp22.WMF_GPU_ENCODE, true);
    ...
    if (enabled3) {
      enabled3 = tmp9(13230).getWmfCpuEncodeIntel("MediaEngineStore").enabled;
      const tmp9Result14 = tmp9(13230);
    }
    if (enabled3) {
      setAttenuation.setExperimentFlag(tmp22.INTEL_GPU_DISABLE, true);
    }
    ...
    if (enabled4) {
      enabled4 = tmp9(13228).getWmfGpuEncode("MediaEngineStore").enabled;
      const tmp9Result16 = tmp9(13228);
    }
    if (enabled4) {
      setAttenuation.setExperimentFlag(tmp22.WMF_GPU_ENCODE, true);
    }
    const result2 = store3.setHasFullbandPerformance(tmp25(13231)());
    const result3 = setAttenuation.setRemoteAudioHistory(1000);
    if (_pollMetrics(4405)(closure_69)) {
    ...
    setAttenuation.on(pollMetrics(4441).BaseConnectionEvent.Speaking, (userId, speakingFlags, arg2, voiceDb) => {
      let obj = outer1_1(outer1_3[43]);
    ...
    if (setAttenuation.context === constants4.DEFAULT) {
      let c98 = false;
      setAttenuation.on(tmp86(4441).BaseConnectionEvent.SpeakingWhileMuted, () => {
        let c98 = true;
        if (!c98) {
          closure_69.emitChange();
        }
    ...
    setAttenuation.on(pollMetrics(4441).BaseConnectionEvent.DesktopSourceEnd, (endReason, errorCode) => {
      let obj = outer1_1(outer1_3[43]);
      obj = { type: "MEDIA_ENGINE_SET_GO_LIVE_SOURCE", settings: obj, endReason, errorCode };
      obj = { context: setAttenuation.context };
      obj.dispatch(obj);
    });
    setAttenuation.on(pollMetrics(4441).BaseConnectionEvent.InteractionRequired, (required) => {
      let obj = callback(709);
      obj = { type: "MEDIA_ENGINE_INTERACTION_REQUIRED", required };
      obj.dispatch(obj);
    });
    setAttenuation.on(pollMetrics(4441).BaseConnectionEvent.VideoHookInitialize, (arg0, arg1, arg2, arg3, arg4, arg5) => {
      let desktopSource;
      if (closure_74 != null) {
      ...
      if (null != desktopSource) {
        ...
        const merged = Object.assign(callback(4520)(desktopSource1));
        obj.track(constants.VIDEOHOOK_INITIALIZED, obj);
        const tmp15 = callback(4520);
      }
    });
    setAttenuation.on(pollMetrics(4441).BaseConnectionEvent.NoiseCancellationError, closure_149);
    setAttenuation.on(pollMetrics(4441).BaseConnectionEvent.VoiceActivityDetectorError, closure_149);
    setAttenuation.on(pollMetrics(4441).BaseConnectionEvent.SdpError, (operation, error, type, sdp) => {
      let obj = callback(698);
      obj = { operation, error, type, sdp };
      obj.track(constants.SDP_ERROR, obj);
    });
    setAttenuation.on(pollMetrics(4441).BaseConnectionEvent.VideoState, (videoState) => {
      let obj = outer1_1(outer1_3[43]);
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.DeviceChange, (inputDevices, outputDevices, videoDevices) => {
    closure_89.stop();
    let obj = _pollMetrics(709);
    obj = { type: "MEDIA_ENGINE_DEVICES", inputDevices, outputDevices, videoDevices };
    obj.dispatch(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.VolumeChange, (inputVolume, outputVolume) => {
    let obj = _pollMetrics(709);
    obj = { type: "AUDIO_VOLUME_CHANGE", inputVolume, outputVolume };
    obj.dispatch(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.DesktopSourceEnd, (endReason, errorCode) => {
    let obj = _pollMetrics(709);
    obj = { type: "MEDIA_ENGINE_SET_GO_LIVE_SOURCE", settings: null, endReason, errorCode };
    obj.dispatch(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.AudioPermission, (granted) => {
    let c124 = true;
    let obj = _pollMetrics(709);
    obj = { type: "MEDIA_ENGINE_PERMISSION", kind: "audio", granted };
    obj.dispatch(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.VideoPermission, (granted) => {
    let obj = _pollMetrics(709);
    obj = { type: "MEDIA_ENGINE_PERMISSION", kind: "video", granted };
    obj.dispatch(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.WatchdogTimeout, callback2(function*() {
    if (c6 === 2) {
      c6 = 3;
      HermesBuiltin.throwTypeError();
    } else if (tmp6 === 3) {
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.VideoInputInitialized, (description) => {
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.AudioInputInitialized, (description) => {
    let obj = _pollMetrics(698);
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.ClipsRecordingRestartNeeded, () => {
    _pollMetrics(709).dispatch({ type: "CLIPS_RESTART" });
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.ClipsInitFailure, (arg0, arg1) => {
    let closure_0 = arg0;
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.ClipsRecordingHealthy, () => {
    if (0 !== c82) {
      const _HermesInternal = HermesInternal;
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.ClipsRecordingReadyChanged, (arg0) => {
    if (closure_83 !== arg0) {
      const _HermesInternal = HermesInternal;
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.ClipsBridgeIdleShutdown, () => {
    logger.info("Clips bridge idle shutdown");
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.ClipsRecordingEnded, (arg0, soundshareId) => {
    let id;
    ...
    if (id === arg0) {
      ...
      if (tmp3) {
        const result = callback(13170).cancelAttachToProcess(soundshareId);
        const obj = callback(13170);
      }
      desktopSource2 = null;
    }
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.NativeScreenSharePickerUpdate, (existing, content) => {
    let obj = _pollMetrics(709);
    obj = { type: "NATIVE_SCREEN_SHARE_PICKER_UPDATE", existing, content };
    obj.dispatch(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.NativeScreenSharePickerCancel, (existing) => {
    let obj = _pollMetrics(709);
    obj = { type: "NATIVE_SCREEN_SHARE_PICKER_CANCEL", existing };
    obj.dispatch(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.NativeScreenSharePickerError, (error) => {
    let obj = _pollMetrics(709);
    obj = { type: "NATIVE_SCREEN_SHARE_PICKER_ERROR", error };
    obj.dispatch(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.AudioDeviceModuleError, (audio_device_module, code, device_name) => {
    let obj = _pollMetrics(698);
    obj = { audio_device_module, code, device_name };
    obj.track(constants.AUDIO_DEVICE_MODULE_ERROR, obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.VideoCodecError, (mode) => {
    if ("encode" === mode.mode) {
      let VIDEO_DECODE_ERROR = pollMetrics(9219).AVError.VIDEO_ENCODE_ERROR;
      let tmp3 = pollMetrics;
    } else {
      VIDEO_DECODE_ERROR = pollMetrics(9219).AVError.VIDEO_DECODE_ERROR;
      tmp3 = pollMetrics;
    }
    let obj = { videoCodec: mode.codecStandard, errorMessage: mode.message };
    if (VIDEO_DECODE_ERROR === tmp3(9219).AVError.VIDEO_ENCODE_ERROR) {
      obj = { type: null };
    ...
    tmp3(9219).reportAVError(obj);
  });
  store3.on(pollMetrics(4441).MediaEngineEvent.ConnectionStats, (arr) => {
    let obj = _pollMetrics(709);
    obj = {
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.VoiceProcessingError, handleVoiceProcessingError);
  store3.on(pollMetrics(4441).MediaEngineEvent.VideoFilterError, handleVideoFilterError);
  store3.on(pollMetrics(4441).MediaEngineEvent.VoiceQueueMetrics, (arg0) => {
  ...
  store3.on(pollMetrics(4441).MediaEngineEvent.SystemMicrophoneModeChange, (arg0) => {
...
prototype["supportsExperimentalSoundshare"] = function supportsExperimentalSoundshare() {
  ...
  if (supportsResult) {
    ...
    supportsResult = 13181__.satisfies(release, closure_31);
    const obj = 13181__;
  }
  return supportsResult;
};
prototype["supportsHookSoundshare"] = function supportsHookSoundshare() {
  ...
  if (isWindowsResult) {
    ...
    isWindowsResult = 13181__.satisfies(release, closure_30);
    const obj2 = 13181__;
  }
...
prototype["getVideoEncoderExperiments"] = function getVideoEncoderExperiments(STREAM, streamer) {
  ...
  if (isWindowsResult) {
    ...
    const VideoCaptureDeviceNoReuseExperiment = tmp6(13245).VideoCaptureDeviceNoReuseExperiment;
...
prototype["supportsScreenSoundshare"] = function supportsScreenSoundshare() {
  if (obj.isMac()) {
    ...
    if (supportsResult) {
      ...
      supportsResult = 13181__.satisfies(release, closure_25);
      const obj5 = 13181__;
    }
    if (supportsResult) {
      ...
      if (satisfiesResult) {
        ...
        satisfiesResult = 13181__.satisfies(release1, closure_24);
        const obj7 = 13181__;
      }
...
const mediaEngineStore = new MediaEngineStore(require("dispatcher"), {
  ...
  CONNECTION_OPEN: function handleConnectionOpen(sessionId) {
    ...
    if (tmp17) {
      ...
      if (setMklZenOverrideEnabled != null) {
        const result1 = setMklZenOverrideEnabled(tmp2(13240).getMklZenOverrideExperimentConfig("handleConnectionOpen").enabled);
        const tmp2Result2 = tmp2(13240);
      }
    ...
    if (tmp2Result3.isIOS()) {
      ...
      if (setNcModels != null) {
        setNcModels(tmp2(13241).getKrispV9iOSModels());
        const tmp2Result4 = tmp2(13241);
      }
      mediaEngineStore.emitChange();
    }
    const inputDeviceId = tmp.inputDeviceId;
    ...
    if (tmp2Result5.isWindows()) {
      if (obj12.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
        ...
        if (null != guid) {
          tmp26(13237)(tmp28.guid, inputDeviceId, obj3);
        }
      }
  ...
  AUDIO_SET_LOCAL_VIDEO_DISABLED: function handleSetLocalVideoDisabled(arg0) {
    ...
    if (!tmp22) {
      ...
      if (isAutomatic) {
        tmp3(13163)(userId, tmp12 ? constants12.AUTO_DISABLE : constants12.AUTO_ENABLE, tmp11);
        if (tmp12) {
          obj.add(userId);
        } else {
          obj.delete(userId);
        ...
        if (hasItem) {
          if (!tmp12) {
            ...
            tmp3(13163)(userId, constants12.MANUAL_REENABLE, tmp11);
          }
        }
        tmp3(13163)(userId, tmp12 ? constants12.MANUAL_DISABLE : constants12.MANUAL_ENABLE, tmp11);
      }
      if (tmp19) {
        tmp19 = !tmp12;
      }
  ...
  AUDIO_SET_INPUT_DEVICE: function handleSetInputDevice(id) {
    ...
    if (obj6.isWindows()) {
      if (obj7.getConfig({ location: "MediaEngineStore.setInputDevice" }).probeAudioEffects) {
        ...
        if (null != guid) {
          tmp20(13237)(tmp22.guid, id, obj5);
        }
      }
      obj7 = apexExperiment;
      tmp20 = importDefault;
  ...
  MEDIA_ENGINE_DEVICES: function handleDevices(videoDevices) {
    ...
    if (0 === arr.length) {
      let obj = { id: null, index: 0, name: null, disabled: true, guid: "call", hardwareId: "set", containerId: "isArray" };
    ...
    if (0 === arr3.length) {
      const obj1 = { id: null, index: 0, name: null, disabled: true, guid: "call", hardwareId: "set", containerId: "isArray" };
    ...
    if (c94) {
      if (!tmp9Result1.isEqual(valueResult1, tmp40)) {
        ...
        let tmp52 = "Firefox" === tmp9(4663).name;
        if (tmp52) {
  ...
  AUDIO_SET_BYPASS_SYSTEM_INPUT_PROCESSING: function handleBypassSystemInputProcessing(bypassEnabled) {
    ...
    const voiceFidelityCaps = tmp12(13177).getVoiceFidelityCaps({ location: "updateVoiceFidelityCaps" }, { krispEnabled: tmp19Result, noiseSuppressionEnabled: tmp18, echoCancellationEnabled: tmp17 });
  ...
  CLIPS_INIT: function handleClipsInit(applicationName) {
    ...
    if (obj.isDecoupledClipsEnabled()) {
      if (null != set) {
        ...
        if (videoHook2) {
          const DisableHookFramePacerExperiment = tmp(13173).DisableHookFramePacerExperiment;
          tmp21 = !DisableHookFramePacerExperiment.getConfig({ location: "handleClipsInit" }).enabled;
        }
        let enabled = videoHook2;
        if (videoHook2) {
          const VideoHookDX12Experiment = tmp(13174).VideoHookDX12Experiment;
          enabled = VideoHookDX12Experiment.getConfig({ location: "handleClipsInit" }).enabled;
        }
        const UpscaleSmallCapturedFramesExperiment = tmp(13175).UpscaleSmallCapturedFramesExperiment;
        ...
        if (isMacResult) {
          ...
          isMacResult = tmp3(13181).satisfies(release1, closure_24);
          const tmp3Result2 = tmp3(13181);
        }
