...
let c85 = null;
let closure_86 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Input Devices", disabled: true, guid: "accessible", hardwareId: "st", containerId: "l" } };
let closure_87 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Output Devices", disabled: true, guid: "round", hardwareId: "a", containerId: "get" } };
let closure_88 = { [DEFAULT_DEVICE_ID]: { id: DEFAULT_DEVICE_ID, index: 0, name: "No Video Devices", disabled: true, guid: "add", hardwareId: "tag", containerId: "getChannel" } };
...
const mediaEngineStore = new MediaEngineStore(dispatcherDefault, {
  ...
  MEDIA_ENGINE_DEVICES: function handleDevices(videoDevices) {
    ...
    if (0 === arr.length) {
      obj = { id: null, index: 0, name: null, disabled: true, guid: "call", hardwareId: "content", containerId: "hd" };
    ...
    if (0 === arr3.length) {
      obj1 = { id: null, index: 0, name: null, disabled: true, guid: "call", hardwareId: "content", containerId: "hd" };
    ...
    if (0 === arr5.length) {
      obj3 = { id: null, index: 0, name: null, disabled: true, guid: "call", hardwareId: "content", containerId: "hd" };
