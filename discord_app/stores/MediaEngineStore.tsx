...
import _modDef14222 from "../../_runtime/metro/14222__.js";
...
function updateConnectionVoiceProcessing(setEchoCancellation) {
  ...
  let supportsResult =
    true === tmp2.audioMixerSettings.enabled && tmp10(14035).getConfig({ location: "MediaEngineStore" }).enabled;
  if (supportsResult) {
...
const outputDevices = {
  [DEFAULT_DEVICE_ID]: {
    ...
    disabled: true,
    guid: "channelId",
    hardwareId: "useCallback",
    containerId: "registerAsset",
  },
};
let dependencyMap = {
  [DEFAULT_DEVICE_ID]: {
...
prototype["initialize"] = function initialize() {
  ...
  closure_73.on(pollMetrics(4777).MediaEngineEvent.Connection, (setAttenuation) => {
    ...
    if (tmp9Result20.isWindows()) {
      ...
      if (tmp9Result21.isMac()) {
        ...
        if (satisfiesResult) {
          ...
          satisfiesResult = closure_1(14222).satisfies(release, closure_39);
          const tmp25Result = closure_1(14222);
        }
    ...
    if (tmp9Result26.isWeb()) {
      setAttenuation.setExperimentFlag(
        ...
        closure_1(14268).getConfig({ location: "MediaEngineStore" }).enabled,
      );
      const tmp25Result2 = closure_1(14268);
    }
    ...
    const result2 = closure_73.setHasFullbandPerformance(closure_1(14272)());
    ...
    setAttenuation.on(
      pollMetrics(4777).BaseConnectionEvent.VideoHookInitialize,
  ...
  closure_73.on(
    pollMetrics(4777).MediaEngineEvent.WatchdogTimeout,
  ...
  closure_73.on(pollMetrics(4777).MediaEngineEvent.VoiceQueueMetrics, (taskMetrics) => {
  ...
  _modDef12.each(value2, (modeOptions) => {
    ...
    if (tmp8) {
      modeOptions.modeOptions.shortcut = pollMetrics(14273).toCombo(modeOptions.modeOptions.shortcut);
      const tmp2Result = pollMetrics(14273);
    }
  ...
  MEDIA_ENGINE_DEVICES: function handleDevices(videoDevices) {
    ...
    if (0 === arr.length) {
      let obj = {
        ...
        disabled: true,
        guid: "accessible",
        hardwareId: "__packager_asset",
        containerId: "__packager_asset",
      };
      obj2 = {};
      obj2[obj.id] = obj;
    ...
    if (obj.isClipsEnabled()) {
      if (null != DiscordNativeDefault) {
        ...
        if (isWindowsResult) {
          ...
          isWindowsResult = _modDef14222.satisfies(release, __initData7);
          const tmp3Result5 = _modDef14222;
        }
        ...
        if (isMacResult) {
          ...
          isMacResult = _modDef14222.satisfies(release1, __initData4);
          const tmp3Result7 = _modDef14222;
        }
        const obj9 = {
