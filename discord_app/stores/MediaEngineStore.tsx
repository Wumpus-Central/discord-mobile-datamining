...
import _modDef14277 from "../../_runtime/metro/14277__.js";
...
function updateConnectionVoiceProcessing(setEchoCancellation) {
  ...
  let supportsResult =
    true === tmp2.audioMixerSettings.enabled && tmp10(14089).getConfig({ location: "MediaEngineStore" }).enabled;
  if (supportsResult) {
...
prototype["initialize"] = function initialize() {
  ...
  closure_73.on(pollMetrics(4811).MediaEngineEvent.Connection, (setAttenuation) => {
    ...
    if (tmp9Result20.isWindows()) {
      ...
      if (tmp9Result21.isMac()) {
        ...
        if (satisfiesResult) {
          ...
          satisfiesResult = closure_1(14277).satisfies(release, closure_39);
          const tmp25Result = closure_1(14277);
        }
    ...
    if (tmp9Result26.isWeb()) {
      setAttenuation.setExperimentFlag(
        ...
        closure_1(14323).getConfig({ location: "MediaEngineStore" }).enabled,
      );
      const tmp25Result2 = closure_1(14323);
    }
    ...
    const result2 = closure_73.setHasFullbandPerformance(closure_1(14327)());
  ...
  _modDef12.each(value2, (modeOptions) => {
    ...
    if (tmp8) {
      modeOptions.modeOptions.shortcut = pollMetrics(14328).toCombo(modeOptions.modeOptions.shortcut);
      const tmp2Result = pollMetrics(14328);
    }
    ...
    if (obj.isClipsEnabled()) {
      if (null != DiscordNativeDefault) {
        ...
        if (isWindowsResult) {
          ...
          isWindowsResult = _modDef14277.satisfies(release, __initData7);
          const tmp3Result5 = _modDef14277;
        }
        ...
        if (isMacResult) {
          ...
          isMacResult = _modDef14277.satisfies(release1, __initData4);
          const tmp3Result7 = _modDef14277;
        }
        const obj9 = {
