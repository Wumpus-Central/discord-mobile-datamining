...
import trackVideoToggleDefault from "trackVideoToggle" /* 14036 */;
...
import WGCDirtyRegionsExperiment2 from "WGCDirtyRegionsExperiment" /* 14214 */;
import WGCDirtyRegionsAllExperiment2 from "WGCDirtyRegionsAllExperiment" /* 14215 */;
import VideoHookDX12Experiment2 from "VideoHookDX12Experiment" /* 14216 */;
import UpscaleSmallCapturedFramesExperiment2 from "UpscaleSmallCapturedFramesExperiment" /* 14217 */;
import GlobalFramePoolLockExperiment from "GlobalFramePoolLockExperiment" /* 14218 */;
import AudioFidelityExperiment from "AudioFidelityExperiment" /* 14219 */;
import SystemwideEchoCancellationExperiment from "SystemwideEchoCancellationExperiment" /* 14220 */;
import _modDef14222 from "module_14222" /* 14222 */;
import AudioEffectsExperimentDefault from "AudioEffectsExperiment" /* 14277 */;
import queryAudioEffectsDefault from "queryAudioEffects" /* 14278 */;
import IOSAudioInterruptExperiment from "IOSAudioInterruptExperiment" /* 14280 */;
import KrispNCModels from "KrispNCModels" /* 14281 */;
...
import VideoCaptureDeviceNoReuse from "VideoCaptureDeviceNoReuse" /* 14285 */;
...
prototype["initialize"] = function initialize() {
  ...
  closure_73.on(pollMetrics(4777).MediaEngineEvent.Connection, (setAttenuation) => {
    ...
    if (tmp9Result26.isWeb()) {
      setAttenuation.setExperimentFlag(closure_45.BROWSER_HEVC, closure_1(14268).getConfig({ location: "MediaEngineStore" }).enabled);
  ...
  closure_73.on(pollMetrics(4777).MediaEngineEvent.WatchdogTimeout, asyncGeneratorStep(async () => {
    if (c6 === 2) {
      c6 = 3;
      throw new TypeError("Generator functions may not be called on executing generators");
    } else if (tmp6 === 3) {
