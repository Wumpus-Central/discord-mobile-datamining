...
import { 13042__ } from "../../_runtime/metro/13042__.js";
        ...
        if (null != tmp2) {
          ...
          if (null != tmp2.desktopSource) {
            ...
            if (isWindowsResult) {
              ...
              isWindowsResult = 13042__.satisfies(release, closure_29);
              const obj6 = 13042__;
            }
            if (!isWindowsResult) {
              ...
              if (!isWindowsResult1) {
                ...
                if (isMacResult) {
                  ...
                  isMacResult = 13042__.satisfies(release1, closure_24);
                  const obj14 = 13042__;
                }
              ...
              if (isWindowsResult2) {
                ...
                isWindowsResult2 = 13042__.satisfies(release2, closure_27);
                const obj8 = 13042__;
              }
...
prototype["supportsExperimentalSoundshare"] = function supportsExperimentalSoundshare() {
  ...
  if (supportsResult) {
    ...
    supportsResult = 13042__.satisfies(release, closure_31);
    const obj = 13042__;
  }
  return supportsResult;
};
prototype["supportsHookSoundshare"] = function supportsHookSoundshare() {
  ...
  if (isWindowsResult) {
    ...
    isWindowsResult = 13042__.satisfies(release, closure_30);
    const obj2 = 13042__;
  }
...
prototype["supportsScreenSoundshare"] = function supportsScreenSoundshare() {
  if (obj.isMac()) {
    ...
    if (supportsResult) {
      ...
      supportsResult = 13042__.satisfies(release, closure_25);
      const obj5 = 13042__;
    }
    if (supportsResult) {
      ...
      if (satisfiesResult) {
        ...
        satisfiesResult = 13042__.satisfies(release1, closure_24);
        const obj7 = 13042__;
      }
