...
import trackVideoToggleDefault from "trackVideoToggle" /* 13921 */;
...
import WGCDirtyRegionsExperiment2 from "WGCDirtyRegionsExperiment" /* 14098 */;
import WGCDirtyRegionsAllExperiment2 from "WGCDirtyRegionsAllExperiment" /* 14099 */;
import VideoHookDX12Experiment2 from "VideoHookDX12Experiment" /* 14100 */;
import UpscaleSmallCapturedFramesExperiment2 from "UpscaleSmallCapturedFramesExperiment" /* 14101 */;
import GlobalFramePoolLockExperiment from "GlobalFramePoolLockExperiment" /* 14102 */;
import AudioFidelityExperiment from "AudioFidelityExperiment" /* 14103 */;
import SystemwideEchoCancellationExperiment from "SystemwideEchoCancellationExperiment" /* 14104 */;
import _modDef14106 from "module_14106" /* 14106 */;
import AudioEffectsExperimentDefault from "AudioEffectsExperiment" /* 14161 */;
import queryAudioEffectsDefault from "queryAudioEffects" /* 14162 */;
import IOSAudioInterruptExperiment from "IOSAudioInterruptExperiment" /* 14164 */;
import KrispNCModels from "KrispNCModels" /* 14165 */;
...
import VideoCaptureDeviceNoReuse from "VideoCaptureDeviceNoReuse" /* 14169 */;
...
prototype["initialize"] = function initialize() {
  ...
  closure_73.on(pollMetrics(4694).MediaEngineEvent.Connection, (setAttenuation) => {
    ...
    if (tmp9Result26.isWeb()) {
      setAttenuation.setExperimentFlag(closure_45.BROWSER_HEVC, closure_1(14152).getConfig({ location: "MediaEngineStore" }).enabled);
  ...
  closure_73.on(pollMetrics(4694).MediaEngineEvent.WatchdogTimeout, asyncGeneratorStep(async () => {
    if (c6 === 2) {
      c6 = 3;
      throw new TypeError("Generator functions may not be called on executing generators");
    } else if (tmp6 === 3) {
