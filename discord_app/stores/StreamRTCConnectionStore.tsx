...
if (importDefaultResult.isSupported()) {
  ...
  obj[10] = function handleStreamCreate(arg0) {
    ...
    if (tmp7) {
      ...
      if (tmp11) {
        tmp10[streamKey] = tmp4(7092).getStreamerApplication(decodeStreamKeyResult, sortActivity);
        const tmp4Result = tmp4(7092);
      }
      ...
      const streamRTCAnalyticsContext = new tmp4(4343).StreamRTCAnalyticsContext(obj);
