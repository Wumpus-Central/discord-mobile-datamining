...
import StoreListingRecord from "../../records/StoreListingRecord.tsx";
...
function addRegularStoreListing(id) {
  ...
  tmp2 =
    null != dependencyMap[id] && !dependencyMap[id].isSlimDirectoryVersion() && fromServer.isSlimDirectoryVersion();
}
