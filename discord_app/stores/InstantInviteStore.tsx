...
import headDefault from "../../_runtime/08583_head.js";
import reverseDefault from "../../_runtime/08585_reverse.js";
import _modDef8586 from "../../_runtime/metro/08586__.js";
...
const instantInviteStore = new InstantInviteStore(dispatcherDefault, {
  ...
  FRIEND_INVITE_CREATE_SUCCESS: function handleFriendInviteCreateSuccess(invite) {
    ...
    let tmpResult = tmp(tmp2(_modDef8586(Object.values(closure_8), "createdAt")));
    if (tmpResult == null) {
      tmpResult = null;
    }
    c2 = tmpResult;
  ...
  FRIEND_INVITE_REVOKE_SUCCESS: function handleFriendInviteRevokeSuccess(invites) {
    ...
    let tmp2Result = tmp2(tmp3(_modDef8586(Object.values(closure_8), "createdAt")));
    if (tmp2Result == null) {
      tmp2Result = null;
    }
    c2 = tmp2Result;
