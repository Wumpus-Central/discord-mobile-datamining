...
import { head } from "../../_runtime/07761_head.js";
import { reverse } from "../../_runtime/07763_reverse.js";
import { 07764__ } from "../../_runtime/metro/07764__.js";
...
const instantInviteStore = new InstantInviteStore(require("dispatcher"), {
  ...
  FRIEND_INVITE_CREATE_SUCCESS: function handleFriendInviteCreateSuccess(invite) {
    ...
    const tmp = head;
    const tmp2 = reverse;
    let tmpResult = tmp(tmp2(07764__(Object.values(closure_8), "createdAt")));
    if (tmpResult == null) {
      tmpResult = null;
    }
  ...
  FRIEND_INVITE_REVOKE_SUCCESS: function handleFriendInviteRevokeSuccess(invites) {
    ...
    const tmp2 = head;
    const tmp3 = reverse;
    let tmp2Result = tmp2(tmp3(07764__(Object.values(closure_8), "createdAt")));
    if (tmp2Result == null) {
      tmp2Result = null;
    }
