...
function convertNodeToGuildFolder(type) {
  ...
  if (obj42(5528).GuildsNodeType.FOLDER === type) {
    ...
    return obj3;
  } else if (obj42(5528).GuildsNodeType.GUILD === type) {
...
function handleMoveById(sourceId) {
  ...
  if (null != node) {
    if (null != node1) {
      ...
      const tmp14 = node.type === obj42(5528).GuildsNodeType.FOLDER && null != node1.parentId;
    }
  }
  return false;
}
