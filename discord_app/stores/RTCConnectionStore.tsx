    ...
    _default.on(_default(4578).RTCConnectionEvent.Video, (arg0, arg1, arg2, arg3, arg4) => {
      ...
      closure_1_1(closure_1_2[8]).wait(() => {
        ...
        obj = {
          ...
          guildId: mediaEngineConnectionId,
          channelId: closure_1,
          userId: closure_2,
          streamId: closure_3,
          rtcServerId: closure_4,
          context: closure_2_11.DEFAULT,
...
function destroyRTCConnection(arg0) {
  ...
  if (null == redux) {
    ...
    let obj = {
      ...
      wasEverMultiParticipant: null,
      wasEverRtcConnected: null,
...
const rTCConnectionStore = new RTCConnectionStore(dispatcherDefault, {
  ...
  VOICE_CHANNEL_SELECT: function handleVoiceChannelSelect(channelId) {
    ...
    if (null != channelId.channelId) {
      ...
      timeout.start(30000, () => {
        closure_1_12.warn("No VOICE_STATE_UPDATE received within 30000ms of VOICE_CHANNEL_SELECT", {
