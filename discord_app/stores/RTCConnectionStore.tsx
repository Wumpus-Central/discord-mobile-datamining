    ...
    _default.on(_default(4614).RTCConnectionEvent.Flags, (userId, flags) => {
      DispatcherDefault.wait(() => {
        obj = {
          ...
          flags,
          userId,
          guildId: _default.guildId,
          channelId: _default.channelId,
...
function destroyRTCConnection(arg0) {
  ...
  if (null == redux) {
    ...
    obj = {
      ...
      mediaEngineConnectionId: redux.getMediaEngineConnectionId(),
    };
    obj.dispatch(obj);
    redux.destroy();
    redux = null;
...
obj = {
  ...
  VOICE_CHANNEL_SELECT: function handleVoiceChannelSelect(channelId) {
    ...
    if (null != channelId.channelId) {
      ...
      timeout.start(30000, () => {
        logger.warn("No VOICE_STATE_UPDATE received within 30000ms of VOICE_CHANNEL_SELECT", {
          joinVoiceId: channelId.joinVoiceId,
