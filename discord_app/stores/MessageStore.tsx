    ...
    return (function*(arg0, arg1, arg2) {
      if (c7 === 2) {
        ...
        try {
          ...
          lib(4955).commit(orCreate.receivePushNotification(lib, dependencyMap));
...
function receiveMediaMentionMessage(item10037) {
  ...
  if (null != message_id) {
    ...
    tmp5(4955).commit(mutation);
    const tmp5Result = tmp5(4955);
  }
}
      ...
      if (orCreate.has(id)) {
        ...
        if (null != message_id) {
          if ("content" in message) {
            ...
            tmp(4955).commit(updateResult1);
            const tmpResult1 = tmp(4955);
          }
        }
      }
    }
