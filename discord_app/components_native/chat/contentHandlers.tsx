  ...
  if (null != userId) {
    ...
    if (null != roleId) {
      if (null != guildId) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(
          parsedUserId(1980)(11836, dependencyMap.paths),
    ...
    if ("@everyone" === roleName) {
      if (null != guildId) {
        ...
        const tmp10 = parsedUserId(1980)(11836, dependencyMap.paths);
...
obj.onTapEmoji = function onTapEmoji(emojiNode) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10587, dependencyMap.paths), "MessageEmojiActionSheet", {
