  ...
  if (null != userId) {
    ...
    if (null != roleId) {
      if (null != guildId) {
        ...
        ActionSheetActionCreatorsDefault.openLazy(
          parsedUserId(1897)(11827, dependencyMap.paths),
    ...
    if ("@everyone" === roleName) {
      if (null != guildId) {
        ...
        const tmp10 = parsedUserId(1897)(11827, dependencyMap.paths);
...
obj.onTapEmoji = function onTapEmoji(emojiNode) {
  ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(10571, dependencyMap.paths), "MessageEmojiActionSheet", {
