  ...
  if (null != userId) {
    ...
    if (null != roleId) {
      if (null != guildId) {
        ...
        obj[1] = roleId;
        obj[2] = channelId;
        ACTION_SHEET_HEIGHT_HALFDefault.openLazy(tmp(2009)(11186, tmp2.paths), "RoleMembersActionSheet", obj);
    ...
    if ("@everyone" === roleName) {
      if (null != guildId) {
        ...
        const tmp10 = tmp(2009)(11186, tmp2.paths);
