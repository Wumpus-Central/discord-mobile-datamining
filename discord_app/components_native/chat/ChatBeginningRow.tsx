...
function ChatBeginningRowHeader(arg0) {
  ...
  if (!isGameInvitesPost) {
    ...
    obj1.style = items1;
    obj1.children = title;
    items[1] = closure_44(subtitleLink(4570).Text, obj1);
    obj.children = items;
  ...
  if (tmp11Result) {
    ...
    tmp11Result = closure_44(subtitleLink(4570).Text, obj3);
  }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj.style = items;
    const obj1 = { source: _modDef12500, size: native.IconSizes.REFRESH_SMALL_16, color: token };
...
function ChatBeginningRowThread(channel) {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp12Result = closure_44(tmp4(4570).Text, obj1);
    }
    items[2] = tmp12Result;
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp8) {
        ...
        tmp12Result1 = closure_44(tmp4(4570).Text, obj3);
      }
    }
...
function DMSpamButton(channel) {
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return closure_44(tmp(4989).Button, obj);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      obj = { size: tmp2(1178).Icon.Sizes.SMALL, source: _modDef12626, style: tmp.appDMButtonIcon };
      ...
      tmp4 = closure_44(tmp2(4989).Button, obj);
    }
  }
  return tmp4;
}
  ...
  if (channel.user.bot) {
    ...
    obj.onPress = function onPress() {
      if (stateFromStores) {
        ...
        obj = { channel };
        tmpResult.openLazy(asyncRequireImpl(12629, dependencyMap.paths), "MessageNotificationChannelActionSheet", obj);
      }
    };
...
function ChatBeginningRowDM(channel) {
  ...
  if (null == user) {
    ...
    const items5 = [closure_44(tmp7(5137).PressableOpacity, obj1), , , , , ,];
    ...
    obj3.children = closure_44(tmp7(4570).Text, obj4);
    items5[1] = closure_44(tmp7(5137).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj5.children = closure_44(tmp7(4570).Text, obj6);
      tmp15Result = closure_44(tmp7(5137).PressableOpacity, obj5);
    }
    ...
    items5[3] = closure_44(tmp7(4570).Text, obj7);
    tmp15Result = null;
    if (user.isProvisional) {
      let obj8 = { style: tmp.provisionalAccountExplainer, userId: user.id, iconSize: 14 };
      tmp15Result = closure_44(tmp7(12657).ChatProvisionalAccountExplainerCard, obj8);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        const items6 = [closure_44(tmp7(12648).GuildIconPile, obj10)];
        ...
        items6[1] = closure_44(tmp7(4570).Text, obj11);
        obj9.children = items6;
        tmp18Result = closure_46(tmp7(5137).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowGroupDM(channel) {
  ...
  let obj1 = first(11625);
  obj = { location: GroupDMChatBeginning };
  let obj3 = channel(11622);
  ...
  tmp2(11629);
  obj.acquisitionStrategy = channel(11622).GroupDMNitroAcquisitionStrategy.MARKETING;
  ...
  obj3.variant = str;
  obj3.children = arr;
  items5[1] = closure_44(channel(4570).Text, obj3);
  ...
  items5[2] = closure_44(channel(4570).Text, obj4);
  ...
  if (!tmp23) {
    if (enabled) {
      const obj6 = {
        ...
        IconComponent: tmp7(8695).NitroWheelIcon,
        iconVariant: "default",
        title: null,
        subtitle: null,
      };
    ...
    obj9.IconComponent = tmp7(4517).LinkIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      tmp21Result1 = closure_44(tmp2(12661), obj10);
    }
    const obj11 = { children: null };
