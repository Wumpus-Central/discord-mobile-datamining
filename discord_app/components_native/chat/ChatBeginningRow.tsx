...
import ChannelAccessInfoDefault from "ChannelAccessInfo" /* 12811 */;
  ...
  if (channel.user.bot) {
    ...
    obj2.onPress = function onPress() {
      if (stateFromStores) {
        ...
        const obj3 = { channel };
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12938, dependencyMap.paths), "MessageNotificationChannelActionSheet", obj3);
