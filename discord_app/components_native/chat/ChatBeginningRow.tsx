...
import _modDef12599 from "../../../_runtime/metro/12599__.js";
...
function ChatBeginningRowHeader(arg0) {
  ...
  if (!isGameInvitesPost) {
    ...
    obj1.style = items1;
    obj1.children = title;
    items[1] = closure_44(subtitleLink(4632).Text, obj1);
    obj.children = items;
  ...
  if (tmp11Result) {
    ...
    tmp11Result = closure_44(subtitleLink(4632).Text, obj3);
  }
...
function LinkManageButtons(arg0) {
  ...
  if (isPrivate) {
    ...
    obj.style = items;
    const obj1 = { source: _modDef12599, size: native.IconSizes.REFRESH_SMALL_16, color: token };
...
function ChatBeginningRowThread(channel) {
  ...
  if (null != channel.threadMetadata) {
    ...
    if (!isForumPostResult) {
      ...
      tmp12Result = closure_44(tmp4(4632).Text, obj1);
    }
    items[2] = tmp12Result;
    ...
    if (channel.isForumPost()) {
      ...
      if (null == tmp8) {
        ...
        tmp12Result1 = closure_44(tmp4(4632).Text, obj3);
      }
    }
...
function DMSpamButton(channel) {
  ...
  if (!channel.showingSpamBanner) {
    if (dMMessageToReport.isReportable) {
      ...
      return closure_44(tmp(5056).Button, obj);
    }
  }
  return null;
}
function ManageAppButton(application) {
  ...
  if (application.user.bot) {
    ...
    if (null != application) {
      ...
      obj = { size: tmp2(1178).Icon.Sizes.SMALL, source: _modDef12725, style: tmp.appDMButtonIcon };
      ...
      tmp4 = closure_44(tmp2(5056).Button, obj);
    }
  }
  return tmp4;
}
  ...
  if (channel.user.bot) {
    ...
    obj.onPress = function onPress() {
      if (stateFromStores) {
        ...
        obj = { channel };
        tmpResult.openLazy(asyncRequireImpl(12728, dependencyMap.paths), "MessageNotificationChannelActionSheet", obj);
      }
    };
...
function ChatBeginningRowDM(channel) {
  ...
  if (null == user) {
    ...
    const items5 = [closure_44(tmp7(5204).PressableOpacity, obj1), , , , , ,];
    ...
    obj3.children = closure_44(tmp7(4632).Text, obj4);
    items5[1] = closure_44(tmp7(5204).PressableOpacity, obj3);
    let tmp15Result = null;
    if (!user.isProvisional) {
      ...
      obj5.children = closure_44(tmp7(4632).Text, obj6);
      tmp15Result = closure_44(tmp7(5204).PressableOpacity, obj5);
    }
    ...
    items5[3] = closure_44(tmp7(4632).Text, obj7);
    tmp15Result = null;
    if (user.isProvisional) {
      let obj8 = { style: tmp.provisionalAccountExplainer, userId: user.id, iconSize: 14 };
      tmp15Result = closure_44(tmp7(12756).ChatProvisionalAccountExplainerCard, obj8);
    }
    ...
    if (null != stateFromStores) {
      if (stateFromStores.length >= 1) {
        ...
        const items6 = [closure_44(tmp7(12747).GuildIconPile, obj10)];
        ...
        items6[1] = closure_44(tmp7(4632).Text, obj11);
        obj9.children = items6;
        tmp18Result = closure_46(tmp7(5204).PressableOpacity, obj9);
      }
    }
...
function ChatBeginningRowGroupDM(channel) {
  ...
  let obj1 = first(11723);
  obj = { location: GroupDMChatBeginning };
  let obj3 = channel(11720);
  ...
  tmp2(11727);
  obj.acquisitionStrategy = channel(11720).GroupDMNitroAcquisitionStrategy.MARKETING;
  ...
  obj3.variant = str;
  obj3.children = arr;
  items5[1] = closure_44(channel(4632).Text, obj3);
  ...
  items5[2] = closure_44(channel(4632).Text, obj4);
  ...
  if (!tmp23) {
    if (enabled) {
      const obj6 = {
        ...
        IconComponent: tmp7(8785).NitroWheelIcon,
        iconVariant: "default",
        title: null,
        subtitle: null,
      };
    ...
    obj9.IconComponent = tmp7(4579).LinkIcon;
    ...
    if (channel.hasFlag(ChannelFlags.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) {
      ...
      tmp21Result1 = closure_44(tmp2(12760), obj10);
    }
    const obj11 = { children: null };
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj2 = { value: tmp5(5219).openImagePicker(obj1), done: false };
              return obj2;
            }
          } else if (arg0 === 1) {
            c3 = 3;
