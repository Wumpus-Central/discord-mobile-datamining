...
import ChannelAccessInfoDefault from "ChannelAccessInfo" /* 12501 */;
...
function ChatBeginningRowGroupDM(channel) {
  ...
  if (!tmp23) {
    if (enabled) {
      const obj6 = { style: tmp.gdmInviteFriends, onPress: tmp2ResultResult, IconComponent: tmp7(8695).NitroWheelIcon, iconVariant: "default", title: null, subtitle: null };
      ...
      tmp21Result = null;
      if (stateFromStores) {
        const obj8 = { style: tmp.gdmInviteFriends, onPress: callback2, IconComponent: tmp7(10064).GroupPlusIcon, iconVariant: "default", title: null };
