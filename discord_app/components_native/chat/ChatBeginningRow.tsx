...
import ChannelAccessInfoDefault from "ChannelAccessInfo" /* 12729 */;
  ...
  if (channel.user.bot) {
    ...
    obj2.onPress = function onPress() {
      if (stateFromStores) {
        ...
        const obj2 = { channel };
        ActionSheetActionCreatorsDefault.openLazy(asyncRequireImpl(12856, dependencyMap.paths), "MessageNotificationChannelActionSheet", obj2);
