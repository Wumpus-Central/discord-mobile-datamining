// === Module 12609: JumpToPresentButton ===

// Module 12609 (JumpToPresentButton)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4526 */;
import noop from "module_19" /* 19 */;
import useChatBottomManagerUIStore_mod from "useChatBottomManagerUIStore" /* 9737 */;
...
export default function JumpToPresentButton(channelId) {
  ...
  if (tmp5) {
    ...
    let tmp12Result = jsx(screenIndex(12610), { accessibilityLabel: stringResult, icon: screenIndex(12611), onPress: channelId.onJumpToPresent });
