// === Module 11735: JumpToPresentButton ===

// Module 11735 (JumpToPresentButton)
import nativeDefault from "native" /* 576 */;
import useToken from "useToken" /* 4528 */;
import noop from "module_19" /* 19 */;
import useChatBottomManagerUIStore_mod from "useChatBottomManagerUIStore" /* 8835 */;
...
export default function JumpToPresentButton(channelId) {
  ...
  if (tmp5) {
    ...
    let tmp12Result = jsx(screenIndex(11736), { accessibilityLabel: stringResult, icon: screenIndex(11737), onPress: channelId.onJumpToPresent });
