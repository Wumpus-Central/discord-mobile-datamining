// === Module 16828: ChannelSettingsPermissionsList ===
...
export default noop.memo(function ChannelSettingsPermissionsList(channelId) {
  ...
  if (0 !== (type === constants.ROLE ? rows1.length : rows.length)) {
    ...
    obj2 = { sections, itemSize: scaledRowHeightData.rowHeight, estimatedListSize: "windowSize", renderItem: callback1, wrapChildren: true, insetStart: tmp7(tmp3[10]).space.PX_8, insetEnd: tmp7(tmp3[10]).space.PX_8 + type(stateFromStores[14])().bottom, keyboardShouldPersistTaps: "always" };
