...
function ChannelPermissionSyncModule(channel) {
  ...
  const callback = noop.useCallback(() => {
    ...
    obj = {
      channelName: channel(4758).computeChannelName(closure_0, UserStore, RelationshipStore, true),
      categoryName: null,
    };
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const syncedPermissionOverwrites = obj8.getSyncedPermissionOverwrites(
                tmp5,
                tmp2(11681).getAppChannelBotUserId(tmp2),
              );
              ...
              c3 = 1;
              const obj1 = {
                value: tmp2(9810).checkChattableChannelThresholdMetAfterChannelPermissionDeny(
                  tmp2,
