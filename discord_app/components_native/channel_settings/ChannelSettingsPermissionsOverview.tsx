...
function ChannelPermissionSyncModule(channel) {
  ...
  const callback = noop.useCallback(() => {
    ...
    obj = {
      channelName: channel(4727).computeChannelName(closure_0, UserStore, RelationshipStore, true),
      categoryName: null,
    };
          ...
          if (0 === c2) {
            if (arg0 === 1) {
              ...
              const syncedPermissionOverwrites = obj8.getSyncedPermissionOverwrites(
                tmp5,
                tmp2(11641).getAppChannelBotUserId(tmp2),
              );
              ...
              c3 = 1;
              const obj1 = {
                value: tmp2(9772).checkChattableChannelThresholdMetAfterChannelPermissionDeny(
                  tmp2,
