...
import TextInput2 from "TextInput" /* 6620 */;
...
fn(4574);
createStyles = { screenContainer: { flex: 1, backgroundColor: nativeDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND, paddingTop: nativeDefault.space.PX_16 }, slider: { marginHorizontal: 15 }, stackPadding: null, alertText: null, tagsWrapper: null, addTagIconButtonWrapper: null, createTagButton: null, createTagButtonText: null };
let obj1 = { flex: 1, backgroundColor: nativeDefault.colors.MOBILE_ACTIONSHEET_BACKGROUND, paddingTop: nativeDefault.space.PX_16 };
...
class ChannelSettingsOverview extends PureComponent {
  constructor(arg0) {
    ...
    tmp.handleThreadSpoilerChange = function handleThreadSpoilerChange(setting) {
    ...
    tmp.handleAnnouncementChange = function handleAnnouncementChange(arg0) {
      const obj = { type: arg0 ? constants3.GUILD_TEXT : constants3.GUILD_ANNOUNCEMENT };
      obj.updateChannel(obj);
      closure_0.setState({ hasChanges: true });
    };
    ...
    closure_129_0 = tmp;
    tmp.handleDeleteChannel = closure_3(async () => {
      if (c3 === 2) {
        c3 = 3;
        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              dependencyMap = 1;
              c3 = 1;
              const obj1 = { value: tmp2(9772).isDefaultChannelThresholdMetAfterDelete(channel.getGuildId(), channel.id), done: false };
              return obj1;
            }
          } else if (arg0 === 1) {
            c3 = 3;
            ...
            if (null != guild2) {
              ...
              if (features.has(constants.COMMUNITY)) {
                if (guild2.rulesChannelId === closure_128_1.id) {
                  ...
                  const items = [closure_1_47(tmp2(4570).Text, obj5), ];
                  ...
                  items[1] = closure_1_47(tmp2(4570).Text, obj6);
                  obj4.children = items;
            ...
            if (null != guild2) {
              if (!closure_128_3) {
                ...
                const items1 = [closure_1_47(tmp2(4570).Text, obj10), ];
                ...
                items1[1] = closure_1_47(tmp2(4570).Text, obj11);
            ...
            obj13 = { title: stringResult1, body: null, cancelText: null, confirmText: null, onConfirm: null, confirmColor: null };
            ...
            obj13.confirmColor = tmp5(5008).Colors.RED;
            obj13.show(obj13);
          }
        } catch (tmp129) {
          c3 = tmp;
...
prototype["renderChannelInfo"] = function renderChannelInfo() {
  ...
  if (!hasItem) {
    ...
    const obj1 = { label: stringResult1, value: null, onChange: null, isDisabled: null, autoCorrect: true, maxLength: null, errorMessage: null };
    ...
    closure_1_47(TextArea.TextArea, obj1);
  }
  ...
  if (set5.has(channel.type)) {
    ...
    if (canManageChannels) {
      ...
      if (!obj.isIOS()) {
        ...
        const intl = util.intl;
        obj.helperText = intl.string(util.t["9eUgwR"]);
        obj = { label: null, value: null, onValueChange: null, disabled: null, subLabel: null };
        const intl2 = util.intl;
        obj.label = intl2.string(util.t.Es25Yf);
        obj.value = AgeGateUtils.isChannelOrGuildNSFW(channel);
        ...
        tmp = closure_1_47(TableRowGroup.TableRowGroup, obj, "nsfw-section");
...
prototype["renderBitrateSettings"] = function renderBitrateSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (canManageChannels) {
      ...
      const obj2 = { style: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" }, children: null };
      const obj3 = { variant: "text-md/semibold", color: "mobile-text-heading-primary", style: { flexShrink: 1 }, children: null };
      const intl2 = util.intl;
...
prototype["renderUserLimitSettings"] = function renderUserLimitSettings() {
  ...
  if (this.showVoiceSettings()) {
    if (props.canManageChannels) {
      ...
      const items1 = [closure_1_47(tmp7(4570).Text, obj2), ];
      const obj3 = { variant: "text-md/medium", color: "text-muted", children: stringResult };
      items1[1] = closure_1_47(tmp7(4570).Text, obj3);
      obj1.children = items1;
      const items2 = [__V(View, obj1), ];
      ...
      items2[1] = closure_1_47(tmp7(14206).Slider, obj4);
      obj.children = items2;
      obj.children = __V(tmp7(5621).Card, obj);
      items.push(closure_1_47(tmp7(5701).TableRowGroup, obj, "channel-user-limit"));
      return items;
    }
  }
  return null;
    ...
    if (self.showVoiceSettings()) {
      if (tmp) {
        if (!channel.isGuildStageVoice()) {
          ...
          obj = { text: name };
          obj.trailing = closure_47(channel(5619).TableRow.TrailingText, obj);
          obj.disabled = tmp2;
          obj.onPress = function onPress() {
            return self.pushScreen(constants2.CHANGE_RTC_REGION);
          };
          obj.children = closure_47(channel(5619).TableRow, obj);
...
prototype["renderPermissions"] = function renderPermissions() {
  ...
  if (!this.props.canManageRoles) {
    ...
    obj.children = closure_47(self(5619).TableRow, obj);
    tmp2Result = closure_47(self(5701).TableRowGroup, obj);
  }
};
...
prototype["renderCommonSettingsSection"] = function renderCommonSettingsSection() {
  ...
  if (closure_8(channel.type)) {
    ...
    items.push(closure_47(channel(5619).TableRow, obj, "rowPinnedMessages"));
  }
  if (canManageChannels) {
  ...
  if (canManageChannels) {
    ...
    obj1.icon = closure_47(channel(4517).LinkIcon, {});
    obj1.onPress = function onPress() {
      return self.pushScreen(constants2.INSTANT_INVITES);
    };
    items.push(closure_47(channel(5619).TableRow, obj1, "rowInstantInvites"));
  }
...
prototype["renderDefaultForumLayout"] = function renderDefaultForumLayout() {
  ...
  if (!channel.isForumChannel()) {
    ...
    obj.trailing = closure_47(self(5619).TableRow.TrailingText, obj1);
    if (channel.defaultForumLayout === GridSquareIcon(1967).ForumLayout.GRID) {
      ...
      tmpResult = closure_47(GridSquareIcon(7107).ListViewIcon, {});
    }
    obj.icon = tmpResult;
    obj.onPress = function onPress() {
      return self.pushScreen(constants2.DEFAULT_FORUM_LAYOUT);
    };
    obj.children = closure_47(self(5619).TableRow, obj, "forumDefaultLayout");
    tmpResult = closure_47(self(5701).TableRowGroup, obj, "default-forum-layout");
  }
};
  ...
  if (hasJoinedThread) {
    ...
    if (isArchivedThread) {
      ...
      if (canUnarchiveThread) {
        let obj = { icon: closure_47(ClockIcon.ClockIcon, {}), label: null, onPress: null };
        const intl2 = util.intl;
    ...
    if (!isArchivedThread) {
      tmp12 = null;
      if (canManageThread) {
        obj = { icon: closure_47(XLargeIcon.XLargeIcon, {}), label: null, onPress: null };
        const intl3 = util.intl;
    ...
    if (isThreadModerator) {
      tmp16 = null;
      if (isLockedThread) {
        const obj1 = { icon: closure_47(LockIcon.LockIcon, {}), label: null, onPress: null };
        const intl4 = util.intl;
        ...
        closure_47(TableRow.TableRow, obj1);
      }
    }
    items[3] = tmp16;
    let tmp21 = null;
    if (isThreadModerator) {
      tmp21 = null;
      if (!isLockedThread) {
        const obj2 = { icon: closure_47(LockIcon.LockIcon, {}), label: null, onPress: null };
        const intl5 = util.intl;
    ...
    items[4] = tmp21;
    const obj4 = { icon: closure_47(LinkIcon.LinkIcon, {}), label: null, onPress: null };
    const intl6 = util.intl;
    obj4.label = intl6.string(util.t.WqhZss);
    obj4.onPress = function onPress() {
      return ChannelActionSheetUtils.copyGuildChannelOrThreadLink(closure_1_0.guild_id, closure_1_0.id);
    };
    items[5] = closure_47(TableRow.TableRow, obj4);
    obj3.children = items;
    return closure_48(tmp4, obj3);
  } else {
    obj = { icon: closure_47(GroupPlusIcon.GroupPlusIcon, {}), label: null, onPress: null };
    const intl = util.intl;
    const string = intl.string;
    let ihLPiO = util.t;
    if (isForumPost) {
...
prototype["renderDeleteButton"] = function renderDeleteButton() {
  ...
  if (canManageChannels) {
    ...
    if (!hasJoinedThread) {
      ...
      const items = [null, ];
      obj = { variant: "danger", icon: closure_47(tmp8(4532).TrashIcon, { color: "text-feedback-critical" }), label: stringResult, onPress: this.handleDeleteChannel };
      items[1] = closure_47(tmp8(5619).TableRow, obj);
      obj.children = items;
      tmp = closure_48(tmp14, obj);
    } else {
      obj = { variant: "danger", icon: closure_47(tmp8(4515).UserMinusIcon, { color: "text-feedback-critical" }), label: null, onPress: null };
...
prototype["renderForumTags"] = function renderForumTags() {
  ...
  if (channel.isForumLikeChannel()) {
    ...
    if (channel.availableTags.length <= 0) {
      const intl2 = canManageChannels(1114).intl;
      stringResult = intl2.string(canManageChannels(1114).t["3v8kZH"]);
    }
    obj.description = stringResult;
    ...
    if (channel.availableTags.length > 0) {
      ...
      const items = [availableTags.map((tag) => closure_2_47(AvailableForumTagDefault, { tag, onPress: self.handlePressTag, disabled: !canManageChannels }, tag.id)), ];
      ...
      if (tmp3) {
        ...
        obj2.icon = closure_47(canManageChannels(8899).PlusSmallIcon, obj3);
        obj2.onPress = function onPress() {
          return self.handlePressTag();
        };
        const intl3 = canManageChannels(1114).intl;
        obj2.accessibilityLabel = intl3.string(canManageChannels(1114).t["/jubeD"]);
        obj1.children = closure_47(canManageChannels(8113).IconButton, obj2);
        tmp10Result = closure_47(View, obj1);
      }
      const obj4 = { children: null };
      items[1] = tmp10Result;
      obj4.children = items;
      tmp6Result = closure_48(closure_49, obj4);
    }
    obj.children = tmp6Result;
    obj.children = closure_47(View, obj);
    const items1 = [closure_47(canManageChannels(5701).TableRowGroup, obj), , , ];
    tmp10Result = null;
    if (channel.availableTags.length <= 0) {
      const obj5 = {
      ...
      const intl4 = canManageChannels(1114).intl;
      obj6.children = intl4.string(canManageChannels(1114).t.F4is7L);
      obj5.children = closure_47(canManageChannels(4570).Text, obj6);
      tmp10Result = closure_47(canManageChannels(5137).PressableOpacity, obj5);
    }
    ...
    if (tmp10Result1) {
      ...
      tmp10Result1 = closure_47(canManageChannels(4570).Text, obj7);
    }
    ...
    const intl5 = canManageChannels(1114).intl;
    ...
    obj8.children = closure_47(canManageChannels(7214).TableSwitchRow, obj9);
    items1[3] = closure_47(canManageChannels(5701).TableRowGroup, obj8);
    obj.children = items1;
...
prototype["renderCategory"] = function renderCategory() {
  ...
  if (props.hasCategories) {
    if (props.channel.type !== constants3.GUILD_CATEGORY) {
      ...
      obj = { icon: closure_47(tmp7(16187).FolderPlusIcon, {}), label: null, trailing: null, arrow: null, onPress: null };
      const intl2 = tmp7(1114).intl;
      obj.label = intl2.string(tmp7(1114).t.vHCZwr);
      obj = { text: stringResult };
      obj.trailing = closure_47(tmp7(5619).TableRow.TrailingText, obj);
      ...
      obj.onPress = fn;
      obj1.children = closure_47(tmp7(5619).TableRow, obj);
      return closure_47(tmp7(5701).TableRowGroup, obj1);
    }
  }
  return null;
};
...
export default function ConnectedChannelSettingsOverview(arg0) {
  ...
  const stateFromStoresObject1 = require("initialize").useStateFromStoresObject(items3, () => {
    ...
    if (null == stateFromStores) {
      ...
      obj = { isThread: hasItem, guild, category: channel, hasCategories: null, pinDisabled: null, canManageChannels: null, isChannelOwner: null, canManageParent: null, canManageRoles: null, canSendMessages: null, canManageWebhooks: null, canUnarchiveThread: null, regions: null, submitting: null, errors: null, isNSFWDisabled: null };
