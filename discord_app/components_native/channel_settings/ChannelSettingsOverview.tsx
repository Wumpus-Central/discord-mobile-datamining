        ...
        try {
          ...
          if (0 === dependencyMap) {
            if (arg0 === 1) {
              ...
              c3 = 1;
              const obj1 = {
                value: tmp2(9870).isDefaultChannelThresholdMetAfterDelete(channel.getGuildId(), channel.id),
                done: false,
              };
              return obj1;
            }
...
prototype["renderDeleteButton"] = function renderDeleteButton() {
  ...
  if (canManageChannels) {
    ...
    if (!hasJoinedThread) {
      ...
      obj = {
        variant: "danger",
        icon: closure_47(tmp8(4594).TrashIcon, { color: "text-feedback-critical" }),
        label: stringResult,
      ...
      obj = {
        variant: "danger",
        icon: closure_47(tmp8(4577).UserMinusIcon, { color: "text-feedback-critical" }),
        label: null,
        onPress: null,
      };
...
prototype["renderCategory"] = function renderCategory() {
  ...
  if (props.hasCategories) {
    if (props.channel.type !== constants3.GUILD_CATEGORY) {
      ...
      obj = {
        icon: closure_47(tmp7(16249).FolderPlusIcon, {}),
        label: null,
        trailing: null,
        arrow: null,
        onPress: null,
