...
createStyles.containerContent = { paddingTop: nativeDefault.space.PX_16, paddingBottom: nativeDefault.space.PX_16, paddingHorizontal: nativeDefault.space.PX_12 };
let obj1 = { paddingTop: nativeDefault.space.PX_16, paddingBottom: nativeDefault.space.PX_16, paddingHorizontal: nativeDefault.space.PX_12 };
...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
            ...
            if (closure_1 === closure_0(tmp5[20]).ALLOW) {
              ...
              if (null != stateFromStores.guild_id) {
                if (tmp126) {
                  c4 = 1;
                  stateFromStores = 1;
                  const obj2 = { value: closure_0(tmp5[22]).checkChattableChannelThresholdMetAfterChannelPermissionDeny(stateFromStores, closure_0), done: false };
                  return obj2;
                }
              }
            }
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    let tmp12Result = closure_19(id(11034), obj);
  } else {
    ...
    tmp12Result = closure_19(tmp2(5656).TableRow, obj1);
  }
      ...
      children: permissions.map((description, index) => {
        ...
        if (false !== tmp) {
          ...
          if ("" !== tmp) {
            ...
            tmp5Result = closure_1_19(closure_1_0(4602).Text, obj);
          }
        }
        items[1] = tmp5Result;
        const tmp3Result = closure_1_21(closure_1_20, { children: items });
        const tmp6Result = closure_1_0(1115);
        obj = { accessible: closure_1_0(1115).isAndroid() || undefined, disabled: tmp2, label: title, subLabel: tmp3Result, trailing: null };
        ...
        obj.trailing = closure_1_19(id(16921), obj1);
        return closure_1_19(closure_1_0(5656).TableRow, obj, "row-" + index);
      })
    };
