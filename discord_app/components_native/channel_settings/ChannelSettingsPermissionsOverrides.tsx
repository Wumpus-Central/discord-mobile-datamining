// === Module 17309: ChannelSettingsPermissionsOverrides ===
...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
            ...
            if (closure_1 === closure_0(tmp5[20]).ALLOW) {
              ...
              if (null != stateFromStores.guild_id) {
                if (tmp126) {
                  c4 = 1;
                  stateFromStores = 1;
                  const obj15 = { value: closure_0(tmp5[22]).checkChattableChannelThresholdMetAfterChannelPermissionDeny(stateFromStores, closure_0), done: false };
                  return obj15;
                }
              }
            }
    ...
    if (fromCreate) {
      let obj = {
        headerRight() {
            ...
            return closure_2_19(closure_0(8110).HeaderTextButton, obj);
          }
      };
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    let tmp12Result = closure_19(id(11213), obj6);
  } else {
    ...
    tmp12Result = closure_19(tmp2(5824).TableRow, obj7);
  }
  ...
  items6[2] = first.map((permissions, index) => {
    ...
    obj.children = closure_2_19(TableRowGroup.TableRowGroup, {
      ...
      children: permissions.map((description, index) => {
        ...
        const obj = { variant: "text-xs/medium", color: "text-subtle", children: closure_1_0(17314).renderDescription(description.description) };
        const items = [closure_1_19(closure_1_0(4753).Text, obj), ];
        let tmp5Result = null;
        if (false !== tmp) {
          tmp5Result = null;
          if ("" !== tmp) {
            const obj3 = { variant: "text-xs/medium", color: "text-feedback-critical", children: tmp };
            tmp5Result = closure_1_19(closure_1_0(4753).Text, obj3);
          }
        }
        items[1] = tmp5Result;
        const obj2 = closure_1_0(17314);
        ...
        obj4.trailing = closure_1_19(id(17315), obj5);
        return closure_1_19(closure_1_0(5824).TableRow, obj4, "row-" + index);
      })
    });
