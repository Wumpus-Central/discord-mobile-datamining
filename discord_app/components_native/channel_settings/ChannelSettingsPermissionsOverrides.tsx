// === Module 17297: ChannelSettingsPermissionsOverrides ===
...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
    ...
    if (fromCreate) {
      let obj = {
        headerRight() {
            ...
            return closure_2_19(closure_0(8107).HeaderTextButton, obj);
          }
      };
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    let tmp12Result = closure_19(id(11207), obj6);
  } else {
    ...
    tmp12Result = closure_19(tmp2(5822).TableRow, obj7);
  }
  ...
  items6[2] = first.map((permissions, index) => {
    ...
    obj.children = closure_2_19(TableRowGroup.TableRowGroup, {
      ...
      children: permissions.map((description, index) => {
        ...
        const obj = { variant: "text-xs/medium", color: "text-subtle", children: closure_1_0(17302).renderDescription(description.description) };
        ...
        if (false !== tmp) {
          ...
          if ("" !== tmp) {
            ...
            tmp5Result = closure_1_19(closure_1_0(4752).Text, obj3);
          }
        }
        items[1] = tmp5Result;
        const obj2 = closure_1_0(17302);
        ...
        obj4.trailing = closure_1_19(id(17303), obj5);
