...
export default function ChannelSettingsPermissionsOverrides(fromCreate) {
            ...
            if (0 === name) {
              if (guild_id === 1) {
                  ...
                  if (throwTypeErrorResult === callback(3917).DENY) {
                    ...
                    if (null != c5.guild_id) {
                      if (throwTypeErrorResult) {
                        ...
                        obj2[0] = callback(8922).checkChattableChannelThresholdMetAfterChannelPermissionDeny(c5, throwTypeErrorResult);
                        return obj2;
                      }
                    }
                  }
                ...
                if (outer2_13.can(callback, c5, obj3)) {
                  ...
                  throwTypeErrorResult = id(4295).updatePermissionOverwrite(c5.id, outer1_3);
                  c5 = 3;
                  const obj17 = id(4295);
                  ...
                  if (!closure_1) {
                    if (!obj11.has(outer1_2.allow, callback)) {
                      if (!obj12.has(outer1_2.deny, callback)) {
                        outer1_6(callback, callback(3917).ALLOW);
                      }
                ...
                if (callback(1935).PermissionOverwriteType.MEMBER === type) {
                  ...
                  if (null != stateFromStores) {
                    const navigation = id(4123).getName(stateFromStores);
                    const obj13 = id(4123);
                  }
                } else {
                ...
                throwTypeErrorResult = id(4623).show(obj4);
                const obj14 = id(4623);
              }
            } else if (guild_id === 1) {
              c5 = 3;
  ...
  if (fromCreate.type === constants.MEMBER) {
    ...
    obj[4] = tmp10;
    let tmp9Result = tmp9(id(9614), obj);
  } else {
