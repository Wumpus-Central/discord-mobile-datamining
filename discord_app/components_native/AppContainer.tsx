...
import MemoryRouter from "../../_runtime/12853_MemoryRouter.js";
...
import ReanimatedScreenProvider from "../../_runtime/14638_ReanimatedScreenProvider.js";
...
try {
  ...
  let obj6 = fn(4957);
  let obj2 = { useTrackNavigatorScreenImpression: fn(14634).useTrackNavigatorScreenImpression };
  fn(7088).setDesignConfig(obj2);
  let c22 = false;
  let closure_23 = {
