...
import BoostedGuildTierProgressCircleDefault from "BoostedGuildTierProgressCircle" /* 13599 */;
...
function GuildBoostingGuildListItem(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    const obj7 = { source: _modDef10542, style: tmp.premiumGuildImage, resizeMode: "contain", resizeMethod: "resize" };
