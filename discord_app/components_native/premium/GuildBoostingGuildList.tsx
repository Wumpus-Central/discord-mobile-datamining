...
function GuildBoostingGuildListItem(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    tmp2Result = tmp2(5719);
    obj[1] = tmp5(5719).GuildIconSizes.LARGE;
    obj[2] = tmp.guildIcon;
    ...
    const items2 = [callback(tmp5(4298).Text, obj2), ];
    ...
    items3[1] = callback(tmp5(4298).Text, obj5);
    obj3[1] = items3;
    ...
    obj7[1] = tmp4;
    items1[2] = callback(tmp2(12707), obj7);
    obj[4] = items1;
