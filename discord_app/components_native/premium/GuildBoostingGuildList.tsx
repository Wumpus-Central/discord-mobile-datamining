// === Module 13086: GuildBoostingGuildListItem ===
...
function GuildBoostingGuildListItem(guildId) {
  ...
  if (null != stateFromStores) {
    ...
    tmp2Result = tmp2(5951);
    obj[1] = tmp5(5951).GuildIconSizes.LARGE;
    obj[2] = tmp.guildIcon;
    ...
    const items2 = [callback(tmp5(4440).Text, obj2), ];
    ...
    items3[1] = callback(tmp5(4440).Text, obj5);
    obj3[1] = items3;
    ...
    obj7[1] = tmp4;
    items1[2] = callback(tmp2(13055), obj7);
    obj[4] = items1;
