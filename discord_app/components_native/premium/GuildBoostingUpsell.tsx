...
import PremiumSubscriptionPricingUpsellDefault from "PremiumSubscriptionPricingUpsell" /* 13809 */;
import GuildBoostingGuildListDefault from "GuildBoostingGuildList" /* 13810 */;
import PremiumSubscriptionUpsellDefault from "PremiumSubscriptionUpsell" /* 13811 */;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  if (tmp2Result.isThemeDark(tmp8)) {
    let tmp7Result = _modDef13652;
  } else {
    tmp7Result = _modDef13653;
  }
