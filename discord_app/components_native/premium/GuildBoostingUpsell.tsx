...
export default function GuildBoostingUpsell(arg0) {
  ...
  let obj1 = getSubscriptionPlansLoaded /* getSubscriptionPlansLoaded */;
  const subscriptionPlansLoaded = obj1.useSubscriptionPlansLoaded();
  let obj2 = getGuildSubscriptionNoGuildsSource /* getGuildSubscriptionNoGuildsSource */;
  ...
  obj3[4] = intl.string(getSystemLocale /* getSystemLocale */.t.hw6WTd);
  items1[2] = callback(Text /* Text */.Text, obj3);
  const obj4 = { style: tmp.cardText, variant: "text-md/medium", children: null };
  const intl2 = tmp2(1236).intl;
  obj4[2] = intl2.string(getSystemLocale /* getSystemLocale */.t.K5jBdG);
  items1[3] = callback(Text /* Text */.Text, obj4);
  obj[1] = items1;
  ...
  obj5[4] = intl3.string(getSystemLocale /* getSystemLocale */.t.RvfRTB);
  ...
  obj7[4] = intl4.string(getSystemLocale /* getSystemLocale */.t["/pVhjb"]);
  items2[3] = callback(Text /* Text */.Text, obj7);
  const obj8 = { style: tmp.features, features: null };
  const obj9 = { icon: null, label: null, IconComponent: null, color: null };
  tmp2Result = AccessibilityAnnouncer /* AccessibilityAnnouncer */;
  obj9[0] = registerAsset;
  const intl5 = tmp2(1236).intl;
  obj9[1] = intl5.string(getSystemLocale /* getSystemLocale */.t.Ts7BVI);
  obj9[2] = ReactionIcon /* ReactionIcon */.ReactionIcon;
  obj9[3] = Themes.unsafe_rawColors.PREMIUM_PERK_YELLOW;
  const items3 = [obj9, , , , ];
  const obj10 = { icon: registerAsset, label: null, IconComponent: null, color: null };
  const intl6 = tmp2(1236).intl;
  obj10[1] = intl6.string(getSystemLocale /* getSystemLocale */.t.QcJbt6);
  obj10[2] = StickerIcon /* StickerIcon */.StickerIcon;
  obj10[3] = Themes.unsafe_rawColors.PREMIUM_PERK_PURPLE;
  items3[1] = obj10;
  const obj11 = { icon: registerAsset, label: null, color: "#4173da", IconComponent: null };
  const intl7 = tmp2(1236).intl;
  obj11[1] = intl7.string(getSystemLocale /* getSystemLocale */.t.rFNkf5);
  obj11[3] = HeadphonesIcon /* HeadphonesIcon */.HeadphonesIcon;
  items3[2] = obj11;
  const obj12 = { icon: registerAsset, label: null, IconComponent: null, color: null };
  const intl8 = tmp2(1236).intl;
  obj12[1] = intl8.string(getSystemLocale /* getSystemLocale */.t["BpjjS/"]);
  obj12[2] = UploadIcon /* UploadIcon */.UploadIcon;
  obj12[3] = Themes.unsafe_rawColors.GUILD_BOOSTING_PINK;
  items3[3] = obj12;
  const obj13 = { icon: registerAsset, label: null, IconComponent: null, color: null };
  const intl9 = tmp2(1236).intl;
  obj13[1] = intl9.string(getSystemLocale /* getSystemLocale */.t["9g5Lgb"]);
  obj13[2] = StarIcon /* StarIcon */.StarIcon;
  obj13[3] = Themes.unsafe_rawColors.PREMIUM_PERK_GOLD;
  items3[4] = obj13;
  obj8[1] = items3;
  items2[4] = callback(PremiumFeatureList, obj8);
