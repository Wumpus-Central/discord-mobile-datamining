...
export default function GuildBoostingUpsell(arg0) {
  ...
  let obj1 = require("../../modules/billing/hooks/useSubscriptionPlansLoaded.tsx") /* getSubscriptionPlansLoaded */;
  const subscriptionPlansLoaded = obj1.useSubscriptionPlansLoaded();
  let obj2 = require("../../design/components/Illustration/native/redesign/generated/GuildSubscriptionNoGuilds.tsx") /* getGuildSubscriptionNoGuildsSource */;
  ...
  const tmp8 = require("../../hooks/useTheme.tsx")();
  ...
  obj3[4] = intl.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.hw6WTd);
  ...
  obj4[2] = intl2.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.K5jBdG);
  items1[3] = callback(require("../../design/components/Text/native/Text.tsx") /* Text */.Text, obj4);
  obj[1] = items1;
  ...
  obj5[4] = intl3.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.RvfRTB);
  ...
  obj7[4] = intl4.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["/pVhjb"]);
  items2[3] = callback(require("../../design/components/Text/native/Text.tsx") /* Text */.Text, obj7);
  const obj8 = { style: tmp.features, features: null };
  const obj9 = { icon: null, label: null, IconComponent: null, color: null };
  tmp2Result = require("../../design/shared.tsx") /* AccessibilityAnnouncer */;
  obj9[0] = require("../../../_runtime/12704_registerAsset.js");
  const intl5 = tmp2(1236).intl;
  obj9[1] = intl5.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.Ts7BVI);
  obj9[2] = require("../../design/components/Icon/native/redesign/generated/ReactionIcon.tsx") /* ReactionIcon */.ReactionIcon;
  obj9[3] = require("../../../discord_common/js/packages/tokens/native.tsx").unsafe_rawColors.PREMIUM_PERK_YELLOW;
  const items3 = [obj9, , , , ];
  const obj10 = { icon: require("../../../_runtime/12705_registerAsset.js"), label: null, IconComponent: null, color: null };
  const intl6 = tmp2(1236).intl;
  obj10[1] = intl6.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.QcJbt6);
  obj10[2] = require("../../design/components/Icon/native/redesign/generated/StickerIcon.tsx") /* StickerIcon */.StickerIcon;
  obj10[3] = require("../../../discord_common/js/packages/tokens/native.tsx").unsafe_rawColors.PREMIUM_PERK_PURPLE;
  items3[1] = obj10;
  const obj11 = { icon: require("../../../_runtime/12706_registerAsset.js"), label: null, color: "#4173da", IconComponent: null };
  const intl7 = tmp2(1236).intl;
  obj11[1] = intl7.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t.rFNkf5);
  obj11[3] = require("../../design/components/Icon/native/redesign/generated/HeadphonesIcon.tsx") /* HeadphonesIcon */.HeadphonesIcon;
  items3[2] = obj11;
  const obj12 = { icon: require("../../../_runtime/12707_registerAsset.js"), label: null, IconComponent: null, color: null };
  const intl8 = tmp2(1236).intl;
  obj12[1] = intl8.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["BpjjS/"]);
  obj12[2] = require("../../design/components/Icon/native/redesign/generated/UploadIcon.tsx") /* UploadIcon */.UploadIcon;
  obj12[3] = require("../../../discord_common/js/packages/tokens/native.tsx").unsafe_rawColors.GUILD_BOOSTING_PINK;
  items3[3] = obj12;
  const obj13 = { icon: require("../../../_runtime/12708_registerAsset.js"), label: null, IconComponent: null, color: null };
  const intl9 = tmp2(1236).intl;
  obj13[1] = intl9.string(require("../../intl/index.native.tsx") /* getSystemLocale */.t["9g5Lgb"]);
  obj13[2] = require("../../design/components/Icon/native/redesign/generated/StarIcon.tsx") /* StarIcon */.StarIcon;
  obj13[3] = require("../../../discord_common/js/packages/tokens/native.tsx").unsafe_rawColors.PREMIUM_PERK_GOLD;
  items3[4] = obj13;
  obj8[1] = items3;
  items2[4] = callback(require("PremiumFeatureList.tsx"), obj8);
