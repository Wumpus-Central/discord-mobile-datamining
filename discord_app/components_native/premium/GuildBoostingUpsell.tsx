...
import PremiumSubscriptionPricingUpsellDefault from "PremiumSubscriptionPricingUpsell" /* 13624 */;
import GuildBoostingGuildListDefault from "GuildBoostingGuildList" /* 13625 */;
import PremiumSubscriptionUpsellDefault from "PremiumSubscriptionUpsell" /* 13626 */;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  if (tmp2Result.isThemeDark(tmp8)) {
    let tmp7Result = _modDef13462;
  } else {
    tmp7Result = _modDef13463;
  }
