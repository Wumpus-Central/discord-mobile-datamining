...
import PremiumSubscriptionPricingUpsellDefault from "PremiumSubscriptionPricingUpsell" /* 13649 */;
import GuildBoostingGuildListDefault from "GuildBoostingGuildList" /* 13650 */;
import PremiumSubscriptionUpsellDefault from "PremiumSubscriptionUpsell" /* 13651 */;
...
export default function GuildBoostingUpsell(arg0) {
  ...
  if (tmp2Result.isThemeDark(tmp8)) {
    let tmp7Result = _modDef13486;
  } else {
    tmp7Result = _modDef13487;
  }
