...
import SubscriptionRenewalMutationsNoticeDefault from "SubscriptionRenewalMutationsNotice" /* 13371 */;
import SubscriptionAccountHoldNoticeDefault from "SubscriptionAccountHoldNotice" /* 13372 */;
...
const __initData4 = { [fn(4231).Branding.BUNDLE]: { [obj3.ACTIVE]: size, [obj3.ERROR]: size, [obj3.RESUB]: size }, [fn(4231).Branding.TIER_0]: { [obj3.ACTIVE]: { height: 35, width: 29 }, [obj3.ERROR]: size1, [obj3.RESUB]: size1 }, [fn(4231).Branding.TIER_1]: { [obj3.ACTIVE]: { height: 35, width: 49 }, [obj3.ERROR]: size1, [obj3.RESUB]: size1 }, [fn(4231).Branding.TIER_2]: { [obj3.ACTIVE]: { height: 37, width: 49 }, [obj3.ERROR]: size1, [obj3.RESUB]: size1 }, [fn(4231).Branding.PREMIUM_GUILD]: { [obj3.ACTIVE]: { width: 51, height: 36 }, [obj3.ERROR]: size2, [obj3.RESUB]: size2 } };
const obj16 = {};
const obj17 = {};
