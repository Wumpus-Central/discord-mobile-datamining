...
import registerAssetDefault3 from "../../../_runtime/08175_registerAsset.js";
import registerAssetDefault4 from "../../../_runtime/08176_registerAsset.js";
import closure_3 from "../../../_runtime/metro/00032__slicedToArray.js";
import importAllResult from "../../../_runtime/00019_noop.js";
import get_ActivityIndicator from "../../../_runtime/00017_get_ActivityIndicator.js";
import closure_7 from "../../modules/user_settings/UnsyncedUserSettingsStore.tsx";
...
function GlobalEmojiUpsell(arg0) {
  ...
  if (null != skuId) {
    ...
    if (useTier0Description) {
      ...
      obj1 = { planName: null };
      obj1[0] = tmp(4109).getPremiumTypeDisplayName(closure_13.TIER_0);
...
function PremiumGuildIdentityUpsell(alertWidth) {
  ...
  if (obj3.isThemeDark(tmp5)) {
    let tmp4Result = tmp4(8173);
  } else {
    tmp4Result = tmp4(8174);
  }
...
function LongerMessageUpsell(alertWidth) {
  ...
  if (obj3.isThemeDark(tmp5)) {
    let tmp4Result = tmp4(8177);
  } else {
    tmp4Result = tmp4(8178);
  }
  obj = { image: tmp4Result, title: null, description: null };
  const intl = tmp(1236).intl;
...
function GuildCapUpsell(alertWidth) {
  ...
  const tmp7 = PremiumUpsellItem;
  if (obj3.isThemeDark(tmp5)) {
    let tmp4Result = tmp4(8179);
  } else {
    tmp4Result = tmp4(8180);
  }
  obj = { image: tmp4Result, title: null, description: null };
  const intl = tmp(1236).intl;
...
function UploadUpsell(arg0) {
  ...
  if (callback(importAllResult.useState(!stateFromStores), 1)[0]) {
    ...
    tmp6Result = callback2(tmp(5961).TableSwitchRow, obj);
  }
