...
import showShareActionSheet from "../../modules/action_sheet/native/showShareActionSheet.tsx";
...
prototype["render"] = function render() {
  ...
  if (null != giftCode.expiresAt) {
    ...
    obj11.hours = expiresAt.diff(require("../../../_runtime/metro/04421__.js")(), "h");
...
GiftCodeRow.contextType = fn(4540).ThemeContext;
const size = fn(2);
