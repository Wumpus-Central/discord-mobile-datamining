...
export default noop.memo(function ShineAnimation(arg0) {
  ...
  const effect = noop.useEffect(() => {
    ...
    const result = sharedValue.set(
      obj.withDelay(400, obj2.withRepeat(timing.withTiming(1, { duration: 1000 }), -1, false)),
    );
  }, items);
  ...
  const tmp5 = require("../../../_runtime/metro/00672__.js");
  const tmp5Result = require("../../../_runtime/metro/00672__.js")(require("native").unsafe_rawColors.BRAND_360);
  const hexResult = require("../../../_runtime/metro/00672__.js")(require("native").unsafe_rawColors.BRAND_360)
    .alpha(0.2)
    .hex();
  importDefault = hexResult;
  const alphaResult = require("../../../_runtime/metro/00672__.js")(require("native").unsafe_rawColors.BRAND_360).alpha(
    0.2,
  );
  const tmp7 = require("../../../_runtime/metro/00672__.js");
  const tmp7Result = require("../../../_runtime/metro/00672__.js")(require("native").unsafe_rawColors.BRAND_360);
  hexResult1 = require("../../../_runtime/metro/00672__.js")(require("native").unsafe_rawColors.BRAND_360)
    .alpha(1)
    .hex();
  const alphaResult1 = require("../../../_runtime/metro/00672__.js")(
    require("native").unsafe_rawColors.BRAND_360,
  ).alpha(1);
  class E {
    constructor() {
