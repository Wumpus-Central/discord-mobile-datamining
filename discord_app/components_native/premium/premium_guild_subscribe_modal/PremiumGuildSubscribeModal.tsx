        ...
        const obj7 = {
          ...
          headerRight() {
                if (obj.isThemeDark(theme.theme)) {
                  let tmp4Result = guildBoostSlots(7488);
                } else {
                  tmp4Result = guildBoostSlots(7489);
                }
                let obj2 = { source: tmp4Result, IconComponent: guildId(7490).SettingsIcon, accessibilityLabel: null, accessibilityHint: null, onPress: null };
                ...
                return closure_1_8(guildId(7487).HeaderActionButton, obj2);
              },
          headerTitle(children) {
                ...
                return closure_1_8(guildId(5710).NavigatorHeader, obj);
              },
          render(arg0) {
                const merged = Object.assign(arg0);
