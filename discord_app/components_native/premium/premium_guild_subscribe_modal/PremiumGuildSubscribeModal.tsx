        ...
        const obj7 = {
          ...
          headerRight() {
                if (obj.isThemeDark(theme.theme)) {
                  let tmp4Result = guildBoostSlots(7618);
                } else {
                  tmp4Result = guildBoostSlots(7619);
                }
                let obj2 = { source: tmp4Result, IconComponent: guildId(7620).SettingsIcon, accessibilityLabel: null, accessibilityHint: null, onPress: null };
                ...
                return closure_1_8(guildId(7617).HeaderActionButton, obj2);
              },
          headerTitle(children) {
                ...
                return closure_1_8(guildId(5836).NavigatorHeader, obj);
              },
          render(arg0) {
                const merged = Object.assign(arg0);
