        ...
        const obj7 = {
          ...
          headerRight() {
                if (obj.isThemeDark(theme.theme)) {
                  let tmp4Result = guildBoostSlots(7485);
                } else {
                  tmp4Result = guildBoostSlots(7486);
                }
                let obj2 = { source: tmp4Result, IconComponent: guildId(7487).SettingsIcon, accessibilityLabel: null, accessibilityHint: null, onPress: null };
                ...
                return closure_1_8(guildId(7484).HeaderActionButton, obj2);
              },
          headerTitle(children) {
                ...
                return closure_1_8(guildId(5709).NavigatorHeader, obj);
              },
          render(arg0) {
                const merged = Object.assign(arg0);
