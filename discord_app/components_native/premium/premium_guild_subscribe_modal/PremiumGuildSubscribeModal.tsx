        ...
        const obj7 = {
          ...
          headerRight() {
                if (obj.isThemeDark(theme.theme)) {
                  let tmp4Result = guildBoostSlots(7620);
                } else {
                  tmp4Result = guildBoostSlots(7621);
                }
                let obj2 = { source: tmp4Result, IconComponent: guildId(7622).SettingsIcon, accessibilityLabel: null, accessibilityHint: null, onPress: null };
                ...
                return closure_1_8(guildId(7619).HeaderActionButton, obj2);
              },
          headerTitle(children) {
                ...
                return closure_1_8(guildId(5841).NavigatorHeader, obj);
              },
          render(arg0) {
                const merged = Object.assign(arg0);
