// === Module 13197: PendingCancellationWarning ===
...
import PremiumGuildTierPillDefault from "PremiumGuildTierPill" /* 13199 */;
import closure_3 from "asyncGeneratorStep" /* 5 */;
import closure_4 from "noop" /* 19 */;
import get_ActivityIndicator from "get ActivityIndicator" /* 17 */;
import closure_9 from "handleModifyingAppliedBoostStart" /* 12060 */;
import closure_10 from "createGuildRecordFromRust" /* 1910 */;
import closure_11 from "handleGuildBoostsUpdate" /* 4338 */;
import closure_12 from "reset" /* 4114 */;
import ME from "ME" /* 676 */;
import { Gradients } from "items" /* 7124 */;
import { BoostPurchaseIntent } from "BoostedGuildTiers" /* 4333 */;
...
function TransferConfirmation(previousGuildSubscriptionSlots) {
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = callback(tmp2(4442).Text, obj2);
    ...
    items1[2] = callback(tmp2(4442).Text, obj3);
    ...
    const items2 = [callback(tmp2(4442).Text, obj6), , , ];
    const obj7 = { style: null, guild: null };
    obj7[0] = tmp.guildPreview;
    obj7[1] = stateFromStores;
    items2[1] = callback(onPremiumGuildSubscribe(13199), obj7);
    ...
    items2[2] = callback(tmp2(4442).Text, obj8);
    ...
    obj11[0] = guild;
    obj10[4] = callback(onPremiumGuildSubscribe(13199), obj11);
    items2[3] = callback(onPremiumGuildSubscribe(4905), obj10);
    obj5[1] = items2;
    ...
    obj13[1] = callback(tmp2(4893).Button, obj14);
    items1[5] = callback(closure_7, obj13);
    obj[0] = items1;
    tmp8 = callback2(closure_21, obj);
    const tmp15 = onPremiumGuildSubscribe(4905);
  }
  return tmp8;
}
