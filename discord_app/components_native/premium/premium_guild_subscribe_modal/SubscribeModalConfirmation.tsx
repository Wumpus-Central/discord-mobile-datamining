...
import { registerAsset } from "../../../../_runtime/08490_registerAsset.js";
import { registerAsset } from "../../../../_runtime/12944_registerAsset.js";
...
function TransferConfirmation(previousGuildSubscriptionSlots) {
  ...
  if (null == stateFromStores) {
    ...
    items2[1] = callback(onPremiumGuildSubscribe(12945), obj7);
