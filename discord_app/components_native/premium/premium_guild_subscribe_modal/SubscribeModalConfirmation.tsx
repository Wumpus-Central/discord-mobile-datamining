...
function SubscribeConfirmation(arg0) {
  ...
  obj = { style: tmp.subscribeImage, source: importDefault(12689) };
  ...
  items[2] = callback(importDefault(12690), { style: tmp.guildPreview, guild });
  ...
  items[3] = callback(require(4189) /* Text */.Text, obj2);
  ...
  obj4[1] = callback(require(4604) /* Button */.Button, obj5);
...
function TransferConfirmation(previousGuildSubscriptionSlots) {
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = callback(tmp2(4189).Text, obj2);
    ...
    items1[2] = callback(tmp2(4189).Text, obj3);
    ...
    const items2 = [callback(tmp2(4189).Text, obj6), , , ];
    const obj7 = { style: null, guild: null };
    obj7[0] = tmp.guildPreview;
    obj7[1] = stateFromStores;
    items2[1] = callback(onPremiumGuildSubscribe(12690), obj7);
    ...
    items2[2] = callback(tmp2(4189).Text, obj8);
    ...
    obj11[0] = guild;
    obj10[4] = callback(onPremiumGuildSubscribe(12690), obj11);
    items2[3] = callback(onPremiumGuildSubscribe(4615), obj10);
    obj5[1] = items2;
    ...
    obj13[1] = callback(tmp2(4604).Button, obj14);
    items1[5] = callback(closure_7, obj13);
    obj[0] = items1;
    tmp8 = callback2(closure_21, obj);
    const tmp15 = onPremiumGuildSubscribe(4615);
  }
  return tmp8;
}
