...
function PendingCancellationWarning(slots) {
  ...
  if (0 !== found.length) {
    ...
    if (null != stateFromStores) {
      ...
      obj = { style: tmp.pendingCancellationIcon, source: _modDef5648 };
...
function SubscribeConfirmation(arg0) {
  ...
  obj = { style: tmp.subscribeImage, source: _modDef13662 };
...
function TransferConfirmation(previousGuildSubscriptionSlots) {
  ...
  if (null == stateFromStores) {
    ...
    items1[1] = closure_19(tmp2(4602).Text, obj2);
    ...
    items1[2] = closure_19(tmp2(4602).Text, obj3);
    ...
    const items2 = [closure_19(tmp2(4602).Text, obj6), , , ];
    const obj7 = { style: tmp.guildPreview, guild: stateFromStores };
    items2[1] = closure_19(onPremiumGuildSubscribe(13663), obj7);
    ...
    items2[2] = closure_19(tmp2(4602).Text, obj8);
    ...
    const obj11 = { guild };
    obj10.children = closure_19(onPremiumGuildSubscribe(13663), obj11);
    items2[3] = closure_19(onPremiumGuildSubscribe(5038), obj10);
    ...
    obj13.children = closure_19(tmp2(5026).Button, obj14);
