...
function SubscribeConfirmation(arg0) {
  ...
  obj[3] = intl.string(getSystemLocale /* getSystemLocale */.t.yTlZV0);
  ...
  obj2[2] = intl2.format(getSystemLocale /* getSystemLocale */.t.KPnDlu, { days: closure_16, slotCount: slots.length });
  items[3] = callback(Text /* Text */.Text, obj2);
  ...
  obj5[1] = intl3.formatToPlainString(getSystemLocale /* getSystemLocale */.t.ZU5x5w, { slotCount: slots.length });
