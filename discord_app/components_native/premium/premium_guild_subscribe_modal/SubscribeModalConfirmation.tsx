...
function SubscribeConfirmation(arg0) {
  ...
  obj = { style: tmp.subscribeImage, source: require("../../../../_runtime/12785_registerAsset.js") };
  ...
  obj[3] = intl.string(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.yTlZV0);
  items[1] = callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj);
  items[2] = callback(require("PremiumGuildPreview.tsx"), { style: tmp.guildPreview, guild });
  const obj2 = { style: items1, variant: "text-sm/medium", children: null };
  items1 = [, ];
  ({ blurb: arr2[0], warning: arr2[1] } = tmp);
  const intl2 = require("../../../intl/index.native.tsx") /* getSystemLocale */.intl;
  obj2[2] = intl2.format(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.KPnDlu, { days: closure_16, slotCount: slots.length });
  items[3] = callback(require("../../../design/components/Text/native/Text.tsx") /* Text */.Text, obj2);
  ...
  obj5[1] = intl3.formatToPlainString(require("../../../intl/index.native.tsx") /* getSystemLocale */.t.ZU5x5w, { slotCount: slots.length });
