...
createStyles.guildName = { marginLeft: 32, fontSize: 16, lineHeight: 20, color: fn(5492).DARK_WHITE_500_LIGHT_PRIMARY_660 };
...
export default function SubscribeModalGuildSelect(guildBoostSlots) {
  ...
  obj1.children = closure_10(guildBoostSlots(7196).SafeAreaPaddingView, {
    bottom: true,
  ...
  obj.children = items3;
  return closure_11(guildBoostSlots(7196).SafeAreaPaddingView, obj);
};