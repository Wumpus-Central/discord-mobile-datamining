...
let obj1 = {};
obj1[ChannelTypes.GUILD_TEXT] = { IconComponent: fn(5094).TextIcon };
let obj2 = { IconComponent: fn(5094).TextIcon };
obj1[ChannelTypes.GUILD_FORUM] = { IconComponent: fn(5102).ForumIcon };
let obj3 = { IconComponent: fn(5102).ForumIcon };
obj1[ChannelTypes.GUILD_VOICE] = { IconComponent: fn(5115).VoiceNormalIcon };
let obj4 = { IconComponent: fn(5115).VoiceNormalIcon };
obj1[ChannelTypes.GUILD_STAGE_VOICE] = { IconComponent: fn(5111).StageIcon };
let obj5 = { IconComponent: fn(5111).StageIcon };
obj1[ChannelTypes.GUILD_ANNOUNCEMENT] = { IconComponent: fn(5108).AnnouncementsIcon };
let obj6 = { IconComponent: fn(5108).AnnouncementsIcon };
obj1[ChannelTypes.GUILD_MEDIA] = { IconComponent: fn(5101).ImageIcon };
let obj7 = { IconComponent: fn(5101).ImageIcon };
obj1[ChannelTypes.GUILD_APP] = { IconComponent: fn(5120).AppsIcon };
let obj9 = {};
let obj8 = { IconComponent: fn(5120).AppsIcon };
obj9[ChannelTypes.GUILD_TEXT] = { IconComponent: fn(5092).TextLockIcon };
let obj10 = { IconComponent: fn(5092).TextLockIcon };
obj9[ChannelTypes.GUILD_FORUM] = { IconComponent: fn(5100).ForumLockIcon };
let obj11 = { IconComponent: fn(5100).ForumLockIcon };
obj9[ChannelTypes.GUILD_VOICE] = { IconComponent: fn(5112).VoiceLockIcon };
let obj12 = { IconComponent: fn(5112).VoiceLockIcon };
obj9[ChannelTypes.GUILD_STAGE_VOICE] = { IconComponent: fn(5110).StageLockIcon };
let obj13 = { IconComponent: fn(5110).StageLockIcon };
obj9[ChannelTypes.GUILD_ANNOUNCEMENT] = { IconComponent: fn(5107).AnnouncementsLockIcon };
let obj14 = { IconComponent: fn(5107).AnnouncementsLockIcon };
obj9[ChannelTypes.GUILD_MEDIA] = { IconComponent: fn(5099).ImageLockIcon };
let obj15 = { IconComponent: fn(5099).ImageLockIcon };
obj9[ChannelTypes.GUILD_APP] = { IconComponent: fn(5119).AppsLockIcon };
