...
function ChannelTypeRow(selected) {
  ...
  const obj10 = {
    ...
    accessibilityRole,
    accessibilityState,
    icon: closure_1_20(timestampProducer, {
      style: tmp.flexRow,
      children: closure_1_20(isPrivate ? obj9 : obj1[channelType].IconComponent, {}),
    }),
...
class CreateChannel {
  constructor(arg0) {
    ...
    obj1 = {
      padding: tmp2(tmp3[14]).space.PX_16,
      paddingBottom: tmp2(tmp3[14]).space.PX_16 + cloneChannelId(createMode[37])().insets.bottom,
    };
    tmp35 = closure_5;
...
function AddMembers(guildId) {
  ...
  const layoutEffect = noop.useLayoutEffect(() => {
    ...
    if (Object.keys(first).length <= 0) {
      const obj = {
        headerRight: first1
          ? () => closure_1_20(stringResult(navigation[47]).HeaderSubmittingIndicator, {})
...
let obj1 = {};
obj1[ChannelTypes.GUILD_TEXT] = { IconComponent: fn(5131).TextIcon };
let obj2 = { IconComponent: fn(5131).TextIcon };
obj1[ChannelTypes.GUILD_FORUM] = { IconComponent: fn(5139).ForumIcon };
let obj3 = { IconComponent: fn(5139).ForumIcon };
obj1[ChannelTypes.GUILD_VOICE] = { IconComponent: fn(5152).VoiceNormalIcon };
let obj4 = { IconComponent: fn(5152).VoiceNormalIcon };
obj1[ChannelTypes.GUILD_STAGE_VOICE] = { IconComponent: fn(5148).StageIcon };
let obj5 = { IconComponent: fn(5148).StageIcon };
obj1[ChannelTypes.GUILD_ANNOUNCEMENT] = { IconComponent: fn(5145).AnnouncementsIcon };
let obj6 = { IconComponent: fn(5145).AnnouncementsIcon };
obj1[ChannelTypes.GUILD_MEDIA] = { IconComponent: fn(5138).ImageIcon };
let obj7 = { IconComponent: fn(5138).ImageIcon };
obj1[ChannelTypes.GUILD_APP] = { IconComponent: fn(5157).AppsIcon };
let obj9 = {};
let obj8 = { IconComponent: fn(5157).AppsIcon };
obj9[ChannelTypes.GUILD_TEXT] = { IconComponent: fn(5129).TextLockIcon };
let obj10 = { IconComponent: fn(5129).TextLockIcon };
obj9[ChannelTypes.GUILD_FORUM] = { IconComponent: fn(5137).ForumLockIcon };
let obj11 = { IconComponent: fn(5137).ForumLockIcon };
obj9[ChannelTypes.GUILD_VOICE] = { IconComponent: fn(5149).VoiceLockIcon };
let obj12 = { IconComponent: fn(5149).VoiceLockIcon };
obj9[ChannelTypes.GUILD_STAGE_VOICE] = { IconComponent: fn(5147).StageLockIcon };
let obj13 = { IconComponent: fn(5147).StageLockIcon };
obj9[ChannelTypes.GUILD_ANNOUNCEMENT] = { IconComponent: fn(5144).AnnouncementsLockIcon };
let obj14 = { IconComponent: fn(5144).AnnouncementsLockIcon };
obj9[ChannelTypes.GUILD_MEDIA] = { IconComponent: fn(5136).ImageLockIcon };
let obj15 = { IconComponent: fn(5136).ImageLockIcon };
obj9[ChannelTypes.GUILD_APP] = { IconComponent: fn(5156).AppsLockIcon };
