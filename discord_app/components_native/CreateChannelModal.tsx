...
let obj1 = {};
obj1[ChannelTypes.GUILD_TEXT] = { IconComponent: fn(5130).TextIcon };
let obj2 = { IconComponent: fn(5130).TextIcon };
obj1[ChannelTypes.GUILD_FORUM] = { IconComponent: fn(5138).ForumIcon };
let obj3 = { IconComponent: fn(5138).ForumIcon };
obj1[ChannelTypes.GUILD_VOICE] = { IconComponent: fn(5151).VoiceNormalIcon };
let obj4 = { IconComponent: fn(5151).VoiceNormalIcon };
obj1[ChannelTypes.GUILD_STAGE_VOICE] = { IconComponent: fn(5147).StageIcon };
let obj5 = { IconComponent: fn(5147).StageIcon };
obj1[ChannelTypes.GUILD_ANNOUNCEMENT] = { IconComponent: fn(5144).AnnouncementsIcon };
let obj6 = { IconComponent: fn(5144).AnnouncementsIcon };
obj1[ChannelTypes.GUILD_MEDIA] = { IconComponent: fn(5137).ImageIcon };
let obj7 = { IconComponent: fn(5137).ImageIcon };
obj1[ChannelTypes.GUILD_APP] = { IconComponent: fn(5156).AppsIcon };
let obj9 = {};
let obj8 = { IconComponent: fn(5156).AppsIcon };
obj9[ChannelTypes.GUILD_TEXT] = { IconComponent: fn(5128).TextLockIcon };
let obj10 = { IconComponent: fn(5128).TextLockIcon };
obj9[ChannelTypes.GUILD_FORUM] = { IconComponent: fn(5136).ForumLockIcon };
let obj11 = { IconComponent: fn(5136).ForumLockIcon };
obj9[ChannelTypes.GUILD_VOICE] = { IconComponent: fn(5148).VoiceLockIcon };
let obj12 = { IconComponent: fn(5148).VoiceLockIcon };
obj9[ChannelTypes.GUILD_STAGE_VOICE] = { IconComponent: fn(5146).StageLockIcon };
let obj13 = { IconComponent: fn(5146).StageLockIcon };
obj9[ChannelTypes.GUILD_ANNOUNCEMENT] = { IconComponent: fn(5143).AnnouncementsLockIcon };
let obj14 = { IconComponent: fn(5143).AnnouncementsLockIcon };
obj9[ChannelTypes.GUILD_MEDIA] = { IconComponent: fn(5135).ImageLockIcon };
let obj15 = { IconComponent: fn(5135).ImageLockIcon };
obj9[ChannelTypes.GUILD_APP] = { IconComponent: fn(5155).AppsLockIcon };
