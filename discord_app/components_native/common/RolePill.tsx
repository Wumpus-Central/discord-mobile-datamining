...
createStyles.pill = { flexDirection: "row", alignItems: "center", paddingHorizontal: 8, paddingVertical: 6, borderRadius: nativeDefault.radii.xs, backgroundColor: nativeDefault.colors.BACKGROUND_BASE_LOWEST };
...
export default function RolePill(role) {
  ...
  if (undefined !== guild_connections) {
    const obj2 = { style: tmp9.verifiedContainer, roleId: role.id, guildId: null, roleColor: null, size: 14, displayRoleIcon: false };
    if (guildId == null) {
      guildId = closure_4;
    }
    obj2.guildId = guildId;
    obj2.roleColor = color;
    let tmp10Result = closure_6(combined(7306), obj2);
  ...
  if (null != roleIconProps) {
    ...
    obj6.children = closure_6(combined(7308), obj7);
  ...
  return closure_6(role(5204).PressableHighlight, obj);
};