...
export default function ItemSelectorActionSheet(arg0) {
  ...
  if (null != onClose) {
    obj = { onPress: onClose };
    tmp6Result = closure_3(tmp(7212).ActionSheetCloseButton, obj);
  }
  const obj1 = { scrollable: true, header: closure_3(items(7163).BottomSheetTitleHeader, obj), children: null };
  ...
  items[1] = closure_3(items(5699).TableRadioGroup, {
    value: num,
  ...
  obj2.children = items;
  obj1.children = closure_4(items(6641).BottomSheetScrollView, obj2);
  return closure_3(items(7164).BottomSheet, obj1);
}
