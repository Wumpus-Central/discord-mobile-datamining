  ...
  constructor(arg0) {
    ...
    tmp2.renderActive = function renderActive() {
      ...
      if (null == active) {
        ...
        obj = { pan: tmp3, rowData: null, shouldDisplayHovering: null, wrapperLayout: null, frameHeight: null, listPageY: null, wrapperPageY: null, renderRow: null };
