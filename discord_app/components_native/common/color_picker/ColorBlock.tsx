...
export default noop.memo((color) => {
  ...
  if (null != onSelect) {
    ...
    if (!selected) {
      ...
      const obj5 = { source: _modDef11819, color: null };
      if (v < 0.5) {
      ...
      obj5.color = BLACK2;
      jsx(native.Icon, { source: _modDef11819, color: null });
    }
    ...
    if (!selected) {
      ...
      const obj8 = { source: _modDef11819, color: null };
      if (v < 0.5) {
