        ...
        try {
          ...
          if (0 === c1) {
            if (arg0 === 1) {
              ...
              c2 = 1;
              const obj4 = {
                value: onThresholdChange(5357).hasPermission(constants.AUDIO, { showAuthorizationError: false }),
                done: false,
              };
              return obj4;
            }
            ...
            if (tmp5) {
              ...
              mediaEngine.on(auto(4812).MediaEngineEvent.VoiceActivity, callback);
            }
            c2 = 3;
            return { value: "HermesInternal", done: null };
          }
