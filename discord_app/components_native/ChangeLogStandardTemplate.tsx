...
obj.footer = { flexDirection: "row", justifyContent: "center", borderTopWidth: StyleSheet.hairlineWidth, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH, borderTopColor: nativeDefault.colors.BORDER_STRONG, gap: nativeDefault.space.PX_12, paddingHorizontal: 18, paddingVertical: nativeDefault.space.PX_12 };
obj.scrollViewContainer = { flex: 1 };
obj.lheading = { marginBottom: 14, flexDirection: "row", alignItems: "center" };
obj.lheadingText = { fontSize: 16, fontFamily: Fonts.PRIMARY_SEMIBOLD };
...
obj.bulletPoint = size;
obj.listItem = { flexDirection: "row", marginLeft: 4, marginBottom: 8 };
createStyles = { color: nativeDefault.colors.TEXT_DEFAULT, fontSize: 14, lineHeight: 18, flex: 1 };
obj.listText = createStyles;
...
let obj2 = { flexDirection: "row", justifyContent: "center", borderTopWidth: StyleSheet.hairlineWidth, backgroundColor: nativeDefault.colors.BACKGROUND_SURFACE_HIGH, borderTopColor: nativeDefault.colors.BORDER_STRONG, gap: nativeDefault.space.PX_12, paddingHorizontal: 18, paddingVertical: nativeDefault.space.PX_12 };
size = fn(2);
...
export default noop.memo((video) => {
  ...
  obj3 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: closure_10(onScroll(8152).XNeutralIcon, { size: "sm", color: "interactive-icon-default" }), accessibilityLabel: null, onPress: null };
  ...
  const items3 = [closure_10(onScroll(8150).IconButton, obj3), , ];
  const obj4 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: closure_10(onScroll(8154).FacebookNeutralIcon, { size: "sm", color: "interactive-icon-default" }), accessibilityLabel: null, onPress: null };
  ...
  items3[1] = closure_10(onScroll(8150).IconButton, obj4);
  const obj5 = { size: "sm", variant: "tertiary", accessibilityRole: "link", icon: closure_10(onScroll(8156).InstagramNeutralIcon, { size: "sm", color: "interactive-icon-default" }), accessibilityLabel: null, onPress: null };
  ...
  items3[2] = closure_10(onScroll(8150).IconButton, obj5);
  obj2.children = items3;
  items2[1] = closure_11(onScroll(7175).SafeAreaPaddingView, obj2);
  obj.children = items2;
...
export const changelogRules = function changelogRules(astParserForResultResult, arg1) {
  ...
  if (flag) {
    ...
    obj.ListItem = ListItem;
    obj.LHeading = LHeading;
    obj.Heading = LHeading;
    obj.components = obj;
