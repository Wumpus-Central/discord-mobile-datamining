...
const memoResult1 = importAllResult.memo((video) => {
  ...
  obj3 = {
    ...
    variant: "tertiary",
    accessibilityRole: "link",
    icon: callback(id(8099).XNeutralIcon, { size: "sm", color: "interactive-icon-default" }),
  ...
  const obj4 = {
    ...
    variant: "tertiary",
    accessibilityRole: "link",
    icon: callback(id(8101).FacebookNeutralIcon, { size: "sm", color: "interactive-icon-default" }),
    accessibilityLabel: null,
    onPress: null,
  };
  ...
  const obj5 = {
    ...
    variant: "tertiary",
    accessibilityRole: "link",
    icon: callback(id(8103).InstagramNeutralIcon, { size: "sm", color: "interactive-icon-default" }),
    accessibilityLabel: null,
    onPress: null,
  };
