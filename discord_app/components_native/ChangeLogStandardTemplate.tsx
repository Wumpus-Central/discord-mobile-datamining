...
import defaultRulesDefault from "defaultRules" /* 8305 */;
...
function LHeading(children) {
  ...
  const items = [callback(_require(1297).LegacyText, { accessibilityRole: "header", style: combined, children: children.children }), ];
  _require = false;
  let combined1;
  if (null != children.className) {
