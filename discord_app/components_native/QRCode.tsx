// === Module 9869: components_native/QRCode ===
...
createStyles = { display: "flex", alignSelf: "flex-start", padding: nativeDefault.space.PX_8, borderRadius: nativeDefault.radii.xs };
createStyles.qrCode = createStyles;
createStyles.qrCodeContainer = { display: "flex", alignSelf: "flex-start", alignItems: "center", justifyContent: "center", position: "relative" };
...
QRCode.prototype["render"] = function render() {
  ...
  let obj = { accessible: null != accessibilityLabel, accessibilityRole: "image", accessibilityLabel, style: null, children: null };
  let tmp3Result = null;
...
QRCodeWithOverlay.prototype["render"] = function render() {
  ...
  obj.style = items1;
  obj1 = { style: tmp[frozen[SIZE_40]], source: _mod9884 };
