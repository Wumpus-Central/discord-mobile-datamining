...
prototype["renderVideo"] = function renderVideo() {
  ...
  if (null != video) {
    ...
    const obj10 = { accessibilityLabel: "Play Video", accessibilityRole: "button", source: _modDef10529, onPress: self.playVideo, style: tmp.playButton, iconSize: tmp18(1177).IconSizes.CUSTOM, iconStyle: tmp.playIcon };
    obj9.children = closure_7(TouchableHitBoxDefault, obj10);
    tmp12Result = closure_7(tmp18(5207).PressableOpacity, obj9);
