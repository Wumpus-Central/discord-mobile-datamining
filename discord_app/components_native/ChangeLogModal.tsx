...
import ChangeLogStandardTemplateDefault from "ChangeLogStandardTemplate" /* 8353 */;
...
ListItem.contextType = fn(4467).ThemeContext;
...
prototype["renderVideo"] = function renderVideo() {
  ...
  if (null != video) {
    ...
    if (null != youtube_video_id) {
      ...
      const items = [closure_7(_modDef15832, obj4), ];
      let tmp6Result = null;
      if (!tmp2) {
  ...
  if (null != video) {
    ...
    const obj10 = { accessibilityLabel: "Play Video", accessibilityRole: "button", source: _modDef10662, onPress: self.playVideo, style: tmp.playButton, iconSize: tmp18(1177).IconSizes.CUSTOM, iconStyle: tmp.playIcon };
    obj9.children = closure_7(TouchableHitBoxDefault, obj10);
    tmp12Result = closure_7(tmp18(5341).PressableOpacity, obj9);
...
ChangeLog.contextType = fn(4467).ThemeContext;
size = fn(2);
