...
prototype["renderVideo"] = function renderVideo() {
  ...
  if (null != video) {
    ...
    const obj10 = { accessibilityLabel: "Play Video", accessibilityRole: "button", source: _modDef10526, onPress: self.playVideo, style: tmp.playButton, iconSize: tmp18(1176).IconSizes.CUSTOM, iconStyle: tmp.playIcon };
