...
PlatformUtils = { scanner: { position: "absolute", height: "100%", width: "100%" }, closeButton: { marginLeft: 8 }, emptyView: null, showHelp: null, text: null };
PlatformUtils = { backgroundColor: nativeDefault.unsafe_rawColors.BLACK };
PlatformUtils.emptyView = PlatformUtils;
PlatformUtils.showHelp = { marginLeft: 16, marginRight: 16, marginTop: "auto", borderRadius: 16, backgroundColor: nativeDefault.unsafe_rawColors.BRAND_500, paddingTop: 4, paddingBottom: 4, paddingLeft: 16, paddingRight: 16 };
let obj1 = { marginLeft: 16, marginRight: 16, marginTop: "auto", borderRadius: 16, backgroundColor: nativeDefault.unsafe_rawColors.BRAND_500, paddingTop: 4, paddingBottom: 4, paddingLeft: 16, paddingRight: 16 };
      ...
      if (constants.SUCCEEDED === nativeEvent.nativeEvent.status) {
        if (undefined !== onScanSuccess) {
          ...
          if (null != result) {
            ...
            tmp21Result.pushLazy(asyncRequireImpl(13889, dependencyMap.paths), obj);
          } else {
            let match;
            if (str != null) {
