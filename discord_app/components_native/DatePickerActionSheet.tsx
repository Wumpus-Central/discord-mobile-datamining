...
function DateRangeError(children) {
  ...
  obj = { STANDARD_EASING: show(1178).STANDARD_EASING, show, withTiming: show(4607).withTiming };
  A.__closure = obj;
  ...
  obj.children = closure_6(View, {
    ref,
    accessible: true,
    accessibilityRole: "alert",
    style: tmp.rangeError,
    children: closure_6(show(4602).Text, {
      variant: "text-md/medium",
      color: "text-feedback-critical",
      children: children.errorText,
    }),
  });
  return closure_6(ref(4343).View, obj);
}
...
const __initData = {
  code: "function DatePickerActionSheetTsx1(){const{STANDARD_EASING,show,withTiming}=this.__closure;const animationSettings={easing:STANDARD_EASING,duration:show?200:150};return{opacity:withTiming(show?1:0,animationSettings),maxHeight:withTiming(show?500:0,animationSettings),paddingVertical:withTiming(show?12:0,animationSettings)};}",
};
const size = fn(2);
...
export default function DatePickerActionSheet(mode) {
  ...
  let obj4 = tmp13(4198)(minimumDate);
  let str2 = "lll";
  let str3 = "lll";
  if ("date" === str) {
    str3 = "L";
  ...
  obj2.errorText = intl3.formatToPlainString(maximumDate(1114).t.R7r9VN, {
    maxDate: minimumDate(4198)(maximumDate).format(str2),
  });
  items1[1] = closure_6(ref, obj2);
  obj4 = { style: tmp3.datetimePickerContainer, children: null };
  const obj3 = { maxDate: minimumDate(4198)(maximumDate).format(str2) };
  const tmp38 = date;
  ...
  obj4.children = closure_6(tmp13Result, {
    theme: str4,
    date,
    onDateChange: tmp27,
    maximumDate: date,
  ...
  obj.children = items1;
  return tmp28(maximumDate(7223).BottomSheet, obj);
}
