...
function DateRangeError(children) {
  ...
  obj3.children = closure_6(View, {
    ...
    children: closure_6(tmp4(4632).Text, {
...
export default function DatePickerActionSheet(mode) {
  ...
  obj3.errorText = intl2.formatToPlainString(maximumDate(1114).t.FsJO55, {
    minDate: minimumDate(4228)(minimumDate).format(str3),
  });
  ...
  obj6.errorText = intl3.formatToPlainString(maximumDate(1114).t.R7r9VN, {
