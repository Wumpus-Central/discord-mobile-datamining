...
function DateRangeError(children) {
  ...
  obj3.children = closure_6(View, {
    ...
    children: closure_6(tmp4(4634).Text, {
...
export default function DatePickerActionSheet(mode) {
  ...
  obj3.errorText = intl2.formatToPlainString(maximumDate(1115).t.FsJO55, {
    minDate: minimumDate(4229)(minimumDate).format(str3),
  });
  ...
  obj6.errorText = intl3.formatToPlainString(maximumDate(1115).t.R7r9VN, {
    maxDate: minimumDate(4229)(maximumDate).format(str2),
  });
  ...
  obj9.children = closure_6(tmp13Result, {
    theme: str4,
    date,
    onDateChange: tmp27,
    maximumDate: date,
