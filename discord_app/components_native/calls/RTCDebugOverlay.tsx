...
function RTCDebugGeneral() {
  ...
  const obj6 = { obj: null };
  const tmp4 = channelId(4980)(stateFromStores1);
  obj4.name = name;
  obj6.obj = { guild: obj4, channel: { id: channelId, name: channelId(4980)(stateFromStores1) } };
...
export default function RTCDebugOverlay(arg0) {
  ...
  const effect = noop.useEffect(() => {
    ...
    return () => closure_1_1(573).wait(closure_1_2(10381).close);
  }, []);
