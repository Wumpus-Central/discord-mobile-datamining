...
export default function ReportProblem(arg0) {
  ...
  const mapped = getStreamIssueReportOptionsDefault({ isStreamer: false, isEndStream: false }).map((label) => {
    ...
    return closure_1_5(
      closure_1_0(closure_1_2[13]).ActionSheetRow,
      {
        label: label.label,
        arrow: true,
        onPress() {
  ...
  obj = {
    style: tmp.container,
    children: jsx(ActionSheetRowIcon.ActionSheetRow.Group, { hasIcons: false, children: mapped }),
  };
  obj[2] = jsx(BottomSheetModal.BottomSheetScrollView, {
    style: tmp.container,
    children: jsx(ActionSheetRowIcon.ActionSheetRow.Group, { hasIcons: false, children: mapped }),
  });
