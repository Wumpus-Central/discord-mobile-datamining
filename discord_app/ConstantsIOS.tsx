...
export const DrawerSourceTypes = {
  BACK_BUTTON: "Back Button",
  SWIPE: "Swipe",
  MUTUAL_GUILD_ITEM: "Mutual Guild Item",
  MEMBER_LIST_ICON: "Member List Icon",
  CHANNEL_DRAWER_ICON: "Channel Drawer Icon",
  CHANNEL_TITLE: "Channel Title",
  PREMIUM_GUILD_SUBSCRIPTION_GUILD_LIST_UPSELL: "Premium Guild Subscription Guild List Upsell",
};
...
export const AuthStates = {
  ...
  COMPANION_REMOTE_AUTH: "COMPANION_REMOTE_AUTH",
};
...
export const VerificationModalScenes = {
  ...
  CHANGE_EMAIL_COMPLETE: "CHANGE_EMAIL_COMPLETE",
  CHANGE_EMAIL_COLLECT_REASONS: "CHANGE_EMAIL_COLLECT_REASONS",
...
export const LinkingTypes = {
  ...
  GUILD_HOME: "guild-home",
  USER_CONNECTIONS_LINK_CALLBACK: "user-connections-link-callback",
  SESSION_MANAGEMENT: "session-management",
  CONNECTIONS: "connections",
  GUILD_SETTINGS: "guild-settings",
  GUILD_SETTINGS_PICKER: "guild-settings-picker",
  ACTIVATE_DEVICE: "activate-device",
  FAMILY_CENTER: "family-center",
  SHARE: "share",
  CREATE_VOICE_INVITE: "create_voice_invite",
  SEND_VOICE_HANGOUT_WAVE: "send_voice_hangout_wave",
  ACCOUNT_STANDING: "account-standing",
  MOBILE_NATIVE_UPDATE: "mobile-native-update",
  SHOP: "shop",
  MOBILE_WEB_REDIRECT_CHECKOUT: "mobile-web-redirect-checkout",
  AUTHORIZED_APPS: "authorized-apps",
  DAVE_PROTOCOL_VERIFICATION: "dave-protocol-verification",
  ICYMI: "icymi",
  QUESTS: "quests",
  GIFT: "gift",
  NITRO_HOME: "store",
