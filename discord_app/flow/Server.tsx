...
export const AgeVerificationStatusUkAndAusOnly = {
  UNVERIFIED: 1,
  [1]: "UNVERIFIED",
  VERIFIED_TEEN: 2,
  [2]: "VERIFIED_TEEN",
  ...
  [99999]: "CLIENT_ONLY_PENDING",
};
export const GameCompanyRole = {
  UNKNOWN: 0,
  [0]: "UNKNOWN",
  PUBLISHER: 1,
  [1]: "PUBLISHER",
...
export const ApplicationDirectoryEntryCarouselItemType = {
  MEDIA_PROXY: 1,
  [1]: "MEDIA_PROXY",
  YOUTUBE: 2,
  [2]: "YOUTUBE",
...
export const InvoiceDiscountTypes = {
  SUBSCRIPTION_PLAN: 1,
  [1]: "SUBSCRIPTION_PLAN",
  ENTITLEMENT: 2,
  [2]: "ENTITLEMENT",
  PREMIUM_LEGACY_UPGRADE_PROMOTION: 3,
  [3]: "PREMIUM_LEGACY_UPGRADE_PROMOTION",
  PREMIUM_TRIAL: 4,
  [4]: "PREMIUM_TRIAL",
  DEFAULT: 5,
  [5]: "DEFAULT",
